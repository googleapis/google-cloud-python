...
from google.cloud.talent_v4.services.job_service import JobServiceAsyncClient, JobServiceClient, pagers, transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert JobServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert JobServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert JobServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert JobServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert JobServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(JobServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(JobServiceClient))
@mock.patch.object(JobServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(JobServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = JobServiceClient._DEFAULT_UNIVERSE
    default_endpoint = JobServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = JobServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert JobServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert JobServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == JobServiceClient.DEFAULT_MTLS_ENDPOINT
    assert JobServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert JobServiceClient._get_api_endpoint(None, None, default_universe, "always") == JobServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert JobServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert JobServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        JobServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert JobServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert JobServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert JobServiceClient._get_universe_domain(None, None) == JobServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (JobServiceAsyncClient, transports.JobServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_job_service_client_client_options_from_dict():
    with mock.patch("google.cloud.talent_v4.services.job_service.transports.JobServiceGrpcTransport.__init__") as grpc_transport:
...
def test_batch_create_jobs_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.batch_create_jobs), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.batch_create_jobs(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_batch_create_jobs_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = JobServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.batch_create_jobs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_create_jobs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_create_jobs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = JobServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_create_jobs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_create_jobs] = mock_rpc
...
def test_batch_update_jobs_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.batch_update_jobs), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.batch_update_jobs(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_batch_update_jobs_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = JobServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.batch_update_jobs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_update_jobs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_update_jobs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = JobServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_update_jobs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_update_jobs] = mock_rpc
...
def test_batch_delete_jobs_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_batch_delete_jobs_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = JobServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.batch_delete_jobs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_delete_jobs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_delete_jobs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = JobServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_delete_jobs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_delete_jobs] = mock_rpc
...
def test_search_jobs_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.search_jobs), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.search_jobs(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_search_jobs_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = JobServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.search_jobs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.search_jobs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_search_jobs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = JobServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_jobs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_jobs] = mock_rpc
...
def test_search_jobs_for_alert_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.search_jobs_for_alert), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.search_jobs_for_alert(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == job_service.SearchJobsRequest(
            parent="parent_value",
...
def test_search_jobs_for_alert_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = JobServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.search_jobs_for_alert in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.search_jobs_for_alert] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_search_jobs_for_alert_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = JobServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_jobs_for_alert in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_jobs_for_alert] = mock_rpc
...
def test_create_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v4/{parent=projects/*/tenants/*}/jobs" % client.transport._host, args[1])
...
def test_batch_create_jobs_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = JobServiceClient(
...
def test_batch_create_jobs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v4/{parent=projects/*/tenants/*}/jobs:batchCreate" % client.transport._host, args[1])
...
def test_get_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v4/{name=projects/*/tenants/*/jobs/*}" % client.transport._host, args[1])
...
def test_update_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v4/{job.name=projects/*/tenants/*/jobs/*}" % client.transport._host, args[1])
...
def test_batch_update_jobs_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = JobServiceClient(
...
def test_batch_update_jobs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v4/{parent=projects/*/tenants/*}/jobs:batchUpdate" % client.transport._host, args[1])
...
def test_batch_delete_jobs_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = JobServiceClient(
...
def test_batch_delete_jobs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v4/{parent=projects/*/tenants/*}/jobs:batchDelete" % client.transport._host, args[1])
...
def test_search_jobs_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = JobServiceClient(
...
def test_search_jobs_for_alert_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = JobServiceClient(
...
def test_search_jobs_for_alert_rest_required_fields(request_type=job_service.SearchJobsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_jobs_for_alert._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = JobServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_job_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.create_job), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = job_service.CreateJobRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_create_jobs_empty_call_grpc():
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.batch_create_jobs), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.batch_create_jobs(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = job_service.BatchCreateJobsRequest()
...
def test_get_job_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.get_job), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = job_service.GetJobRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_jobs_empty_call_grpc():
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.batch_update_jobs), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.batch_update_jobs(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = job_service.BatchUpdateJobsRequest()
...
def test_delete_job_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.delete_job), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = job_service.DeleteJobRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_jobs_empty_call_grpc():
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.batch_delete_jobs), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.batch_delete_jobs(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = job_service.BatchDeleteJobsRequest()
...
def test_list_jobs_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.list_jobs), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = job_service.ListJobsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_jobs_empty_call_grpc():
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.search_jobs), "__call__") as call:
        call.return_value = job_service.SearchJobsResponse()
        client.search_jobs(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = job_service.SearchJobsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_jobs_for_alert_empty_call_grpc():
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.search_jobs_for_alert), "__call__") as call:
        call.return_value = job_service.SearchJobsResponse()
        client.search_jobs_for_alert(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = JobServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = JobServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_create_jobs_empty_call_grpc_asyncio():
    client = JobServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.batch_create_jobs), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.batch_create_jobs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_update_jobs_empty_call_grpc_asyncio():
    client = JobServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.batch_update_jobs), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.batch_update_jobs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_delete_jobs_empty_call_grpc_asyncio():
    client = JobServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.batch_delete_jobs), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.batch_delete_jobs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_jobs_empty_call_grpc_asyncio():
    client = JobServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.search_jobs), "__call__") as call:
        ...
        await client.search_jobs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_jobs_for_alert_empty_call_grpc_asyncio():
    client = JobServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.search_jobs_for_alert), "__call__") as call:
        ...
        await client.search_jobs_for_alert(request=None)
...
def test_transport_kind_rest():
    transport = JobServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_job_rest_bad_request(request_type=job_service.CreateJobRequest):
...
def test_create_job_rest_call_success(request_type):
    ...
    request_init["job"] = {
            ...
            "entries": [
                {
                    "type_": 1,
                    "unit": 1,
                    "amount": {"currency_code": "currency_code_value", "units": 563, "nanos": 543},
        ...
        "processing_options": {"disable_street_address_resolution": True, "html_sanitization": 1},
    }
    ...
    test_field = job_service.CreateJobRequest.meta.fields["job"]
...
def test_create_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.JobServiceRestInterceptor, "post_create_job") as post, mock.patch.object(
        transports.JobServiceRestInterceptor, "post_create_job_with_metadata"
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gct_job.Job.to_json(gct_job.Job())
        ...
        post_with_metadata.return_value = gct_job.Job(), metadata
...
def test_batch_create_jobs_rest_bad_request(request_type=job_service.BatchCreateJobsRequest):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/tenants/sample2"}
    request = request_type(**request_init)
...
def test_batch_create_jobs_rest_call_success(request_type):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_batch_create_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.JobServiceRestInterceptor, "post_batch_create_jobs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_job_rest_bad_request(request_type=job_service.GetJobRequest):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.JobServiceRestInterceptor, "post_get_job") as post, mock.patch.object(
...
def test_update_job_rest_bad_request(request_type=job_service.UpdateJobRequest):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_job_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = job_service.UpdateJobRequest.meta.fields["job"]
...
def test_update_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.JobServiceRestInterceptor, "post_update_job") as post, mock.patch.object(
        transports.JobServiceRestInterceptor, "post_update_job_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_update_jobs_rest_bad_request(request_type=job_service.BatchUpdateJobsRequest):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/tenants/sample2"}
    request = request_type(**request_init)
...
def test_batch_update_jobs_rest_call_success(request_type):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_batch_update_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.JobServiceRestInterceptor, "post_batch_update_jobs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_job_rest_bad_request(request_type=job_service.DeleteJobRequest):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/tenants/sample2/jobs/sample3"}
    request = request_type(**request_init)
...
def test_delete_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.JobServiceRestInterceptor, "pre_delete_job") as pre:
        pre.assert_not_called()
...
def test_batch_delete_jobs_rest_bad_request(request_type=job_service.BatchDeleteJobsRequest):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/tenants/sample2"}
    request = request_type(**request_init)
...
def test_batch_delete_jobs_rest_call_success(request_type):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_batch_delete_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.JobServiceRestInterceptor, "post_batch_delete_jobs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_jobs_rest_bad_request(request_type=job_service.ListJobsRequest):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/tenants/sample2"}
    request = request_type(**request_init)
...
def test_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.JobServiceRestInterceptor, "post_list_jobs") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = job_service.ListJobsResponse.to_json(job_service.ListJobsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = job_service.ListJobsResponse(), metadata
...
def test_search_jobs_rest_bad_request(request_type=job_service.SearchJobsRequest):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/tenants/sample2"}
    request = request_type(**request_init)
...
def test_search_jobs_rest_call_success(request_type):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_search_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.JobServiceRestInterceptor, "post_search_jobs") as post, mock.patch.object(
        transports.JobServiceRestInterceptor, "post_search_jobs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = job_service.SearchJobsResponse.to_json(job_service.SearchJobsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = job_service.SearchJobsResponse(), metadata
...
def test_search_jobs_for_alert_rest_bad_request(request_type=job_service.SearchJobsRequest):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/tenants/sample2"}
    request = request_type(**request_init)
...
def test_search_jobs_for_alert_rest_call_success(request_type):
    client = JobServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_search_jobs_for_alert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.JobServiceRestInterceptor, "post_search_jobs_for_alert") as post, mock.patch.object(
        transports.JobServiceRestInterceptor, "post_search_jobs_for_alert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_create_jobs_empty_call_rest():
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_jobs_empty_call_rest():
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_jobs_empty_call_rest():
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_jobs_empty_call_rest():
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_jobs_for_alert_empty_call_rest():
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_job_service_base_transport():
    ...
    with mock.patch("google.cloud.talent_v4.services.job_service.transports.JobServiceTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.JobServiceGrpcTransport, grpc_helpers), (transports.JobServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_job_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "jobs.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://jobs.googleapis.com:8000"
    )

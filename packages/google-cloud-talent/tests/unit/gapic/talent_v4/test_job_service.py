...
from google.cloud.talent_v4.types import common, filters, histogram, job, job_service
...
@pytest.mark.asyncio
async def test_batch_create_jobs_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_create_jobs
            in client._client._transport._wrapped_methods
        )
...
async def test_batch_create_jobs_async(request_type, transport: str = "grpc_asyncio"):
    client = JobServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_batch_update_jobs_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_update_jobs
            in client._client._transport._wrapped_methods
        )
...
async def test_batch_update_jobs_async(request_type, transport: str = "grpc_asyncio"):
    client = JobServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_batch_delete_jobs_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_delete_jobs
            in client._client._transport._wrapped_methods
        )
...
async def test_batch_delete_jobs_async(request_type, transport: str = "grpc_asyncio"):
    client = JobServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_search_jobs_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.search_jobs
            in client._client._transport._wrapped_methods
        )
...
async def test_search_jobs_async(request_type, transport: str = "grpc_asyncio"):
    client = JobServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_search_jobs_for_alert_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.search_jobs_for_alert
            in client._client._transport._wrapped_methods
        )
...
def test_batch_create_jobs_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchCreateJobs,
...
def test_update_job_rest_required_fields(request_type=job_service.UpdateJobRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpdateJob,
...
def test_batch_update_jobs_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchUpdateJobs,
...
def test_batch_delete_jobs_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchDeleteJobs,
...
def test_search_jobs_rest_required_fields(request_type=job_service.SearchJobsRequest):
    ...
    default_values = getattr(
        transport_class._BaseSearchJobs,
...
def test_search_jobs_for_alert_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSearchJobsForAlert,
...
def test_get_job_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.JobServiceRestInterceptor, "post_get_job") as post,
        mock.patch.object(
            transports.JobServiceRestInterceptor, "post_get_job_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.JobServiceRestInterceptor, "pre_get_job") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_jobs_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.JobServiceRestInterceptor, "pre_list_jobs") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = job_service.ListJobsResponse.to_json(
            job_service.ListJobsResponse()
        )
        req.return_value.content = return_value
...
def test_search_jobs_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = job_service.SearchJobsResponse.to_json(
            job_service.SearchJobsResponse()
        )
        req.return_value.content = return_value

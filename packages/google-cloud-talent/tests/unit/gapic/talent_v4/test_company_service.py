...
from google.cloud.talent_v4.services.company_service import CompanyServiceAsyncClient, CompanyServiceClient, pagers, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert CompanyServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert CompanyServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                CompanyServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        CompanyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CompanyServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        CompanyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
...
async def test_list_companies_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_companies), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_companies(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_transport_kind_grpc():
    transport = CompanyServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = CompanyServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CompanyServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = CompanyServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_company_rest_call_success(request_type):
    ...
    request_init["company"] = {
        ...
        "keyword_searchable_job_custom_attributes": [
            "keyword_searchable_job_custom_attributes_value1",
            "keyword_searchable_job_custom_attributes_value2",
        ],
        "derived_info": {
...
def test_create_company_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.CompanyServiceRestInterceptor, "post_create_company") as post, mock.patch.object(
        transports.CompanyServiceRestInterceptor, "post_create_company_with_metadata"
...
def test_get_company_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CompanyServiceRestInterceptor, "post_get_company") as post, mock.patch.object(
        transports.CompanyServiceRestInterceptor, "post_get_company_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_company_rest_call_success(request_type):
    ...
    request_init = {"company": {"name": "projects/sample1/tenants/sample2/companies/sample3"}}
    request_init["company"] = {
        "name": "projects/sample1/tenants/sample2/companies/sample3",
        "display_name": "display_name_value",
        "external_id": "external_id_value",
        "size": 1,
        "headquarters_address": "headquarters_address_value",
...
def test_update_company_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CompanyServiceRestInterceptor, "post_update_company") as post, mock.patch.object(
        transports.CompanyServiceRestInterceptor, "post_update_company_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_company_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CompanyServiceRestInterceptor, "pre_delete_company") as pre:
        pre.assert_not_called()
...
def test_list_companies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CompanyServiceRestInterceptor, "post_list_companies") as post, mock.patch.object(
        transports.CompanyServiceRestInterceptor, "post_list_companies_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.CompanyServiceGrpcTransport, grpc_helpers), (transports.CompanyServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

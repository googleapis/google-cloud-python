...
from google.cloud.talent_v4.services.company_service import (
...
def test_create_company_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v4/{parent=projects/*/tenants/*}/companies" % client.transport._host,
            args[1],
        )
...
def test_get_company_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v4/{name=projects/*/tenants/*/companies/*}" % client.transport._host,
            args[1],
        )
...
def test_update_company_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v4/{company.name=projects/*/tenants/*/companies/*}"

...
from google.cloud.talent_v4.services.event_service import EventServiceAsyncClient, EventServiceClient, transports
...
def test__read_environment_variables():
    assert EventServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert EventServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert EventServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert EventServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert EventServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert EventServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert EventServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert EventServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                EventServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert EventServiceClient._get_client_cert_source(None, False) is None
    assert EventServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert EventServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert EventServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert EventServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(EventServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EventServiceClient))
@mock.patch.object(EventServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EventServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = EventServiceClient._DEFAULT_UNIVERSE
    default_endpoint = EventServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = EventServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert EventServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert EventServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == EventServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EventServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert EventServiceClient._get_api_endpoint(None, None, default_universe, "always") == EventServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EventServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EventServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EventServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert EventServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        EventServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert EventServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert EventServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert EventServiceClient._get_universe_domain(None, None) == EventServiceClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        EventServiceClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = EventServiceClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (EventServiceClient, "grpc"),
        (EventServiceAsyncClient, "grpc_asyncio"),
        (EventServiceClient, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.EventServiceRestTransport, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (EventServiceClient, transports.EventServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(EventServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EventServiceClient))
@mock.patch.object(EventServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EventServiceAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (EventServiceClient, transports.EventServiceRestTransport, "rest", "true"),
        (EventServiceClient, transports.EventServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(EventServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EventServiceClient))
@mock.patch.object(EventServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EventServiceAsyncClient))
...
@mock.patch.object(EventServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EventServiceClient))
@mock.patch.object(EventServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EventServiceAsyncClient))
def test_event_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (EventServiceClient, transports.EventServiceGrpcTransport, "grpc", grpc_helpers),
        (EventServiceAsyncClient, transports.EventServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (EventServiceClient, transports.EventServiceRestTransport, "rest", None),
    ],
)
...
def test_event_service_client_client_options_from_dict():
    with mock.patch("google.cloud.talent_v4.services.event_service.transports.EventServiceGrpcTransport.__init__") as grpc_transport:
...
def test_create_client_event_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.create_client_event), "__call__") as call:
        ...
        client.create_client_event(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_create_client_event_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_client_event in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_client_event] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_client_event_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_client_event in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_client_event] = mock_rpc
...
def test_create_client_event_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EventServiceClient(
...
def test_create_client_event_rest_required_fields(request_type=event_service.CreateClientEventRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_client_event._get_unset_required_fields(
        jsonified_request
    )
...
def test_create_client_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v4/{parent=projects/*/tenants/*}/clientEvents" % client.transport._host, args[1])
...
def test_transport_kind_grpc():
    transport = EventServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_client_event_empty_call_grpc():
    client = EventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_client_event), "__call__") as call:
        call.return_value = event.ClientEvent()
        client.create_client_event(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = EventServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = EventServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_client_event_empty_call_grpc_asyncio():
    client = EventServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.create_client_event), "__call__") as call:
        ...
        await client.create_client_event(request=None)
...
def test_transport_kind_rest():
    transport = EventServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_client_event_rest_bad_request(request_type=event_service.CreateClientEventRequest):
...
def test_create_client_event_rest_call_success(request_type):
    client = EventServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")

    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/tenants/sample2"}
    request_init["client_event"] = {
        "request_id": "request_id_value",
        "event_id": "event_id_value",
        "create_time": {"seconds": 751, "nanos": 543},
        "job_event": {"type_": 1, "jobs": ["jobs_value1", "jobs_value2"]},
        "event_notes": "event_notes_value",
    }
    ...
    test_field = event_service.CreateClientEventRequest.meta.fields["client_event"]
    ...
    for field, value in request_init["client_event"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["client_event"][field])):
                    del request_init["client_event"][field][i][subfield]
            else:
                del request_init["client_event"][field][subfield]
    request = request_type(**request_init)
...
def test_create_client_event_rest_interceptors(null_interceptor):
    transport = transports.EventServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.EventServiceRestInterceptor(),
    )
    client = EventServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EventServiceRestInterceptor, "post_create_client_event") as post, mock.patch.object(
        transports.EventServiceRestInterceptor, "post_create_client_event_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.EventServiceRestInterceptor, "pre_create_client_event"
    ) as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = event.ClientEvent.to_json(event.ClientEvent())
        ...
        post_with_metadata.return_value = event.ClientEvent(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_client_event_empty_call_rest():
    client = EventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_event_service_base_transport():
    ...
    with mock.patch("google.cloud.talent_v4.services.event_service.transports.EventServiceTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.EventServiceGrpcTransport, grpc_helpers), (transports.EventServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_event_service_client_transport_session_collision(transport_name):
    ...
    client1 = EventServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = EventServiceClient(
        credentials=creds2,
        transport=transport_name,
    )

...
from google.cloud.talent_v4.services.event_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        EventServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        EventServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        EventServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                EventServiceClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                EventServiceClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(EventServiceClient),
)
@mock.patch.object(
    EventServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(EventServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = EventServiceClient._DEFAULT_UNIVERSE
    default_endpoint = EventServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = EventServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        EventServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == EventServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        EventServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        EventServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == EventServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        EventServiceClient._get_api_endpoint(
    ...
    assert (
        EventServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        EventServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        EventServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        EventServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        EventServiceClient._get_universe_domain(None, None)
        == EventServiceClient._DEFAULT_UNIVERSE
    )
...
def test_create_client_event_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.create_client_event in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.create_client_event] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_create_client_event_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_client_event
...
async def test_create_client_event_async(request_type, transport: str = "grpc_asyncio"):
    client = EventServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_client_event_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_client_event._get_unset_required_fields(jsonified_request)
...
def test_create_client_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v4/{parent=projects/*/tenants/*}/clientEvents" % client.transport._host,
            args[1],
        )
...
def test_transport_kind_grpc_asyncio():
    transport = EventServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = EventServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_client_event_rest_bad_request(
    request_type=event_service.CreateClientEventRequest,
):
    client = EventServiceClient(
...
def test_create_client_event_rest_interceptors(null_interceptor):
    transport = transports.EventServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.EventServiceRestInterceptor(),
    )
    client = EventServiceClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.EventServiceRestInterceptor, "post_create_client_event"
        ) as post,
        mock.patch.object(
            transports.EventServiceRestInterceptor,
        ...
        pb_message = event_service.CreateClientEventRequest.pb(
            event_service.CreateClientEventRequest()
        )

        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v4beta1/{parent=projects/*/tenants/*}/companies",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v4beta1/{parent=projects/*}/companies",
                    "body": "*",
                },
            ]
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v4beta1/{name=projects/*/tenants/*/companies/*}",
                },
                {
                    "method": "delete",
                    "uri": "/v4beta1/{name=projects/*/companies/*}",
                },
            ]
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v4beta1/{company.name=projects/*/tenants/*/companies/*}",
                    "body": "*",
                },
                {
                    "method": "patch",
                    "uri": "/v4beta1/{company.name=projects/*/companies/*}",
                    "body": "*",
                },
            ]

...
class CompanyServiceClient(metaclass=CompanyServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = CompanyServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CompanyServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = CompanyServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = CompanyServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or CompanyServiceClient._get_api_endpoint(

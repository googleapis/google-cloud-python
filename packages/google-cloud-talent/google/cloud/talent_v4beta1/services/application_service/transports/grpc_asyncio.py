...
from .base import DEFAULT_CLIENT_INFO, ApplicationServiceTransport
from .grpc import ApplicationServiceGrpcTransport


class ApplicationServiceGrpcAsyncIOTransport(ApplicationServiceTransport):
    """gRPC AsyncIO backend transport for ApplicationService.

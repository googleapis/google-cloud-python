...
class TenantServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = TenantServiceClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(TenantServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            TenantServiceAsyncClient: The constructed client.
        """
        sa_file_func = TenantServiceClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(TenantServiceAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.talent_v4beta1.TenantServiceAsyncClient`.",
                extra={
    ...
    async def create_tenant(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.talent_v4beta1.types.CreateTenantRequest, dict]]):
    ...
    async def update_tenant(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.talent_v4beta1.types.UpdateTenantRequest, dict]]):

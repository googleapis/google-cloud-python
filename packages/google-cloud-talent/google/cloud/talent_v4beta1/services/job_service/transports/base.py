...
class JobServiceTransport(abc.ABC):
    ...
    @property
    def create_job(self) -> Callable[[job_service.CreateJobRequest], Union[gct_job.Job, Awaitable[gct_job.Job]]]:
        raise NotImplementedError()

    @property
    def batch_create_jobs(
        self,
    ) -> Callable[[job_service.BatchCreateJobsRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def get_job(self) -> Callable[[job_service.GetJobRequest], Union[job.Job, Awaitable[job.Job]]]:
        raise NotImplementedError()

    @property
    def update_job(self) -> Callable[[job_service.UpdateJobRequest], Union[gct_job.Job, Awaitable[gct_job.Job]]]:
        raise NotImplementedError()

    @property
    def batch_update_jobs(
        self,
    ) -> Callable[[job_service.BatchUpdateJobsRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_job(self) -> Callable[[job_service.DeleteJobRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def batch_delete_jobs(self) -> Callable[[job_service.BatchDeleteJobsRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def list_jobs(self) -> Callable[[job_service.ListJobsRequest], Union[job_service.ListJobsResponse, Awaitable[job_service.ListJobsResponse]]]:
        raise NotImplementedError()

    @property
    def search_jobs(
        self,
    ) -> Callable[[job_service.SearchJobsRequest], Union[job_service.SearchJobsResponse, Awaitable[job_service.SearchJobsResponse]]]:
        raise NotImplementedError()

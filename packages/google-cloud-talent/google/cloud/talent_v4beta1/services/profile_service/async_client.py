...
from google.cloud.talent_v4beta1.types import common, histogram
...
from .transports.base import DEFAULT_CLIENT_INFO, ProfileServiceTransport
...
class ProfileServiceAsyncClient:
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return ProfileServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore

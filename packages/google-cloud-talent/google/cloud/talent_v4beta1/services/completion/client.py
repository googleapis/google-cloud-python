...
class CompletionClient(metaclass=CompletionClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = CompletionClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = CompletionClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = CompletionClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CompletionClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = CompletionClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, CompletionTransport, Callable[..., CompletionTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,CompletionTransport,Callable[..., CompletionTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CompletionTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CompletionClient._read_environment_variables()
        self._client_cert_source = CompletionClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CompletionClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, CompletionTransport)
        if transport_provided:
            ...
            self._transport = cast(CompletionTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or CompletionClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CompletionTransport], Callable[..., CompletionTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.talent_v4beta1.CompletionClient`.",
                    extra={

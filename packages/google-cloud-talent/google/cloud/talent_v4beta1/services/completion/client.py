...
class CompletionClient(metaclass=CompletionClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CompletionClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, CompletionTransport, Callable[..., CompletionTransport]]
        ] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            CompletionClient._read_environment_variables()
        )
        self._client_cert_source = CompletionClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = CompletionClient._get_universe_domain(

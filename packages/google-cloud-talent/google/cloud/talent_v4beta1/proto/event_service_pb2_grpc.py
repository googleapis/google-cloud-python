...
class EventService(object):
    ...
    def CreateClientEvent(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/google.cloud.talent.v4beta1.EventService/CreateClientEvent",
            google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_event__service__pb2.CreateClientEventRequest.SerializeToString,
            google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_event__pb2.ClientEvent.FromString,
            options,
            channel_credentials,
            call_credentials,
            compression,

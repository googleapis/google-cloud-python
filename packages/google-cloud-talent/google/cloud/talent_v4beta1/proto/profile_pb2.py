...
Profile = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          profile by the API.  The format is “projects/{project_id}/tena
          nts/{tenant_id}/profiles/{profile_id}”, for example,
      ...
      external_id:
          ...
          another profile with the same external_id is created.  The
      ...
      group_id:
          ...
          [group_id][google.cloud.talent.v4beta1.Profile.group_id], and
          assign it when the second profile is created, indicating these
          two profiles are referring to the same candidate.
      is_hirable:
      ...
      candidate_update_time:
          ...
          [recruiting_notes][google.cloud.talent.v4beta1.Profile.recruit
      ...
      additional_contact_info:
          ...
          mail_addresses][google.cloud.talent.v4beta1.Profile.email_addr
          esses], [phone_numbers][google.cloud.talent.v4beta1.Profile.ph
          one_numbers] and [personal_uris][google.cloud.talent.v4beta1.P
          rofile.personal_uris]. For example, Hang-out, Skype.
      employment_records:
          ...
          _current][google.cloud.talent.v4beta1.EmploymentRecord.is_curr
          ent]    for the current employment if possible. If not, it’s
      ...
      education_records:
          ...
          different degrees. -  Provide    [EducationRecord.is_current][
          google.cloud.talent.v4beta1.EducationRecord.is_current]    for
          the current education if possible. If not, it’s inferred from
          user inputs.  The limitation for max number of education
          records is 100.
      skills:
      ...
      activities:
          ...
          assignments that aren’t listed in [employment_records][google.
          cloud.talent.v4beta1.Profile.employment_records].  The
      ...
      derived_addresses:
          ...
          es].  [derived_addresses][google.cloud.talent.v4beta1.Profile.
          derived_addresses] are exactly matched to [Profile.addresses][
...
AvailabilitySignal = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      last_update_time:
          ...
          happened.
      filter_satisfied:
          Indicates if the [last_update_time][google.cloud.talent.v4beta
          1.AvailabilitySignal.last_update_time] is within [Availability
          Filter.range][google.cloud.talent.v4beta1.AvailabilityFilter.r
          ange].  Returned only in a search response when there is an [A
          vailabilityFilter][google.cloud.talent.v4beta1.AvailabilityFil
          ter] in [ProfileQuery.availability_filters][google.cloud.talen
          t.v4beta1.ProfileQuery.availability_filters] where [signal_typ
          e][google.cloud.talent.v4beta1.AvailabilityFilter.signal_type]
          matches
...
Resume = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      structured_resume:
          ...
          any SLA.
      resume_type:
          The format of [structured_resume][google.cloud.talent.v4beta1.
...
PersonName = _reflection.GeneratedProtocolMessageType(
    ...
    Attributes:
        given_name:
            ...
            loud.talent.v4beta1.PersonName.formatted_name] if not
            provided.  Number of characters allowed is 100.
        preferred_name:
            Preferred given/first name or nickname.  Number of characters
            allowed is 100.
        middle_initial:
            Middle initial.  It’s derived from [formatted_name][google.clo
            ud.talent.v4beta1.PersonName.formatted_name] if not provided.
            Number of characters allowed is 20.
        family_name:
            Family/last name.  It’s derived from [formatted_name][google.c
            loud.talent.v4beta1.PersonName.formatted_name] if not
            provided.  Number of characters allowed is 100.
        suffixes:
  ...
  Attributes:
      person_name:
          ...
          .cloud.talent.v4beta1.PersonName.formatted_name] or [structure
          d_name][google.cloud.talent.v4beta1.PersonName.structured_name
          ].
      formatted_name:
          A string represents a person’s full name. For example,
          “Dr. John Smith”.  Number of characters allowed is 100.
      structured_name:
...
Address = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      address:
          The address of a person. It can be one of [unstructured_addres
          s][google.cloud.talent.v4beta1.Address.unstructured_address]
          or [structured_address][google.cloud.talent.v4beta1.Address.st
          ructured_address].
      unstructured_address:
...
EmploymentRecord = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      job_title_snippet:
          Output only. The job title snippet shows how the [job_title][g
          oogle.cloud.talent.v4beta1.EmploymentRecord.job_title] is
          related to a search query. It’s empty if the [job_title][googl
          e.cloud.talent.v4beta1.EmploymentRecord.job_title] isn’t
          related to the search query.
      job_description_snippet:
          Output only. The job description snippet shows how the [job_de
          scription][google.cloud.talent.v4beta1.EmploymentRecord.job_de
          scription] is related to a search query. It’s empty if the [jo
          b_description][google.cloud.talent.v4beta1.EmploymentRecord.jo
          b_description] isn’t related to the search query.
      employer_name_snippet:
          Output only. The employer name snippet shows how the [employer
          _name][google.cloud.talent.v4beta1.EmploymentRecord.employer_n
          ame] is related to a search query. It’s empty if the [employer
          _name][google.cloud.talent.v4beta1.EmploymentRecord.employer_n
          ame] isn’t related to the search query.
  """,
...
EducationRecord = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      degree:
          The degree information. It can be one of [degree_description][
          google.cloud.talent.v4beta1.EducationRecord.degree_description
          ] or [structured_degree][google.cloud.talent.v4beta1.Education
          Record.structured_degree].
      degree_description:
      ...
      school_name_snippet:
          Output only. The school name snippet shows how the [school_nam
          e][google.cloud.talent.v4beta1.EducationRecord.school_name] is
          related to a search query in search result. It’s empty if the 
          [school_name][google.cloud.talent.v4beta1.EducationRecord.scho
          ol_name] isn’t related to the search query.
      degree_snippet:
...
Activity = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      activity_name_snippet:
          Output only. Activity name snippet shows how the [display_name
          ][google.cloud.talent.v4beta1.Activity.display_name] is
          related to a search query. It’s empty if the [display_name][go
          ogle.cloud.talent.v4beta1.Activity.display_name] isn’t related
          to the search query.
      ...
      skills_used_snippet:
          ...
          kills_used][google.cloud.talent.v4beta1.Activity.skills_used]
          are related to a search query. It’s empty if the corresponding

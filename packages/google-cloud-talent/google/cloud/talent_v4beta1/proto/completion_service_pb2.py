...
CompleteQueryRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      language_codes:
          ...
          <https://tools.ietf.org/html/bcp47>`__.  The maximum number of
...
CompleteQueryResponse = _reflection.GeneratedProtocolMessageType(
    ...
    Attributes:
        ...
        image_uri:
            The URI of the company image for [COMPANY_NAME][google.cloud.t
            alent.v4beta1.CompleteQueryRequest.CompletionType.COMPANY_NAME
            ].
    """,

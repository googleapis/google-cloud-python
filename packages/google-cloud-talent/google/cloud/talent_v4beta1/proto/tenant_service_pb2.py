...
CreateTenantRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      parent:
          ...
          is created.  The format is “projects/{project_id}”, for
...
UpdateTenantRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      update_mask:
          ...
          ate_mask][google.cloud.talent.v4beta1.UpdateTenantRequest.upda
          te_mask] is provided, only the specified fields in [tenant][go
          ogle.cloud.talent.v4beta1.UpdateTenantRequest.tenant] are
...
DeleteTenantRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          format is “projects/{project_id}/tenants/{tenant_id}”, for
          example, “projects/foo/tenants/bar”.
  """,

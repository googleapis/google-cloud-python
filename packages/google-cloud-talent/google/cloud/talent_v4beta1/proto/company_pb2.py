...
Company = _reflection.GeneratedProtocolMessageType(
    ...
    Attributes:
        headquarters_location:
            ...
            from [Company.headquarters_address][google.cloud.talent.v4beta
            1.Company.headquarters_address] if provided.
    """,
  ...
  Attributes:
      name:
          ...
          created.  The format is “projects/{project_id}/tenants/{tenant
          _id}/companies/{company_id}”, for example,
      ...
      headquarters_address:
          ...
          rs_location][google.cloud.talent.v4beta1.Company.DerivedInfo.h
          eadquarters_location].
      hiring_agency:
      ...
      keyword_searchable_job_custom_attributes:
          A list of keys of filterable [Job.custom_attributes][google.cl
          oud.talent.v4beta1.Job.custom_attributes], whose corresponding
          ``string_values`` are used in keyword searches. Jobs with
          ``string_values`` under these specified field keys are
          returned if any of the values match the search keyword. Custom
          field values with parenthesis, brackets and special symbols
          are not searchable as-is, and those keyword queries must be

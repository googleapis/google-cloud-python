...
class EventServiceClient(metaclass=EventServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = EventServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        ) = EventServiceClient._read_environment_variables()
        self._client_cert_source = EventServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = EventServiceClient._get_universe_domain(

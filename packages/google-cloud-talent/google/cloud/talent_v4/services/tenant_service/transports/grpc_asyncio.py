...
class TenantServiceGrpcAsyncIOTransport(TenantServiceTransport):
    ...
    @property
    def create_tenant(self) -> Callable[[tenant_service.CreateTenantRequest], Awaitable[gct_tenant.Tenant]]:
    ...
    @property
    def get_tenant(self) -> Callable[[tenant_service.GetTenantRequest], Awaitable[tenant.Tenant]]:
    ...
    @property
    def update_tenant(self) -> Callable[[tenant_service.UpdateTenantRequest], Awaitable[gct_tenant.Tenant]]:
    ...
    @property
    def delete_tenant(self) -> Callable[[tenant_service.DeleteTenantRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def list_tenants(self) -> Callable[[tenant_service.ListTenantsRequest], Awaitable[tenant_service.ListTenantsResponse]]:

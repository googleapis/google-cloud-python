...
from google.cloud.talent_v4.types import common, company, company_service
...
class CompanyServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            CompanyServiceClient.from_service_account_info.__func__  # type: ignore
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            CompanyServiceClient.from_service_account_file.__func__  # type: ignore
        )

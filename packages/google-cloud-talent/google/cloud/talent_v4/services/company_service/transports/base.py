...
class CompanyServiceTransport(abc.ABC):
    ...
    @property
    def create_company(self) -> Callable[[company_service.CreateCompanyRequest], Union[gct_company.Company, Awaitable[gct_company.Company]]]:
        raise NotImplementedError()

    @property
    def get_company(self) -> Callable[[company_service.GetCompanyRequest], Union[company.Company, Awaitable[company.Company]]]:
        raise NotImplementedError()

    @property
    def update_company(self) -> Callable[[company_service.UpdateCompanyRequest], Union[gct_company.Company, Awaitable[gct_company.Company]]]:
        raise NotImplementedError()

    @property
    def delete_company(self) -> Callable[[company_service.DeleteCompanyRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

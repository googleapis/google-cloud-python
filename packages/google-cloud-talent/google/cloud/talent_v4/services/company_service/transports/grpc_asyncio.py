...
class CompanyServiceGrpcAsyncIOTransport(CompanyServiceTransport):
    ...
    @property
    def create_company(self) -> Callable[[company_service.CreateCompanyRequest], Awaitable[gct_company.Company]]:
    ...
    @property
    def get_company(self) -> Callable[[company_service.GetCompanyRequest], Awaitable[company.Company]]:
    ...
    @property
    def update_company(self) -> Callable[[company_service.UpdateCompanyRequest], Awaitable[gct_company.Company]]:
    ...
    @property
    def delete_company(self) -> Callable[[company_service.DeleteCompanyRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def list_companies(self) -> Callable[[company_service.ListCompaniesRequest], Awaitable[company_service.ListCompaniesResponse]]:

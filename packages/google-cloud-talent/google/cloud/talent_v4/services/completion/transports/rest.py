        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.talent_v4.CompletionClient.CompleteQuery",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.talent_v4.CompletionClient.complete_query",
                    extra={
                        "serviceName": "google.cloud.talent.v4.Completion",
                        "rpcName": "CompleteQuery",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.talent_v4.CompletionClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.talent.v4.Completion",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.talent_v4.CompletionAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.talent.v4.Completion",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,

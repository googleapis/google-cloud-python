...
from .base import DEFAULT_CLIENT_INFO, CompletionTransport
...
class CompletionGrpcAsyncIOTransport(CompletionTransport):
    ...
    @property
    def complete_query(self) -> Callable[[completion_service.CompleteQueryRequest], Awaitable[completion_service.CompleteQueryResponse]]:
        ...
        if "complete_query" not in self._stubs:
            self._stubs["complete_query"] = self._logged_channel.unary_unary(

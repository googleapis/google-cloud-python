...
from google.cloud.talent_v4.types import common, completion_service
...
class CompletionAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = CompletionClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = CompletionClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(CompletionAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            CompletionAsyncClient: The constructed client.
        """
        sa_file_func = CompletionClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(CompletionAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return CompletionClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    get_transport_class = CompletionClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.talent_v4.CompletionAsyncClient`.",
                extra={
    ...
    async def complete_query(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.talent_v4.types.CompleteQueryRequest, dict]]):
    ...
    async def __aenter__(self) -> "CompletionAsyncClient":
        return self

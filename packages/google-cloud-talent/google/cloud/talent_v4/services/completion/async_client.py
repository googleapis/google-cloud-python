...
class CompletionAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, CompletionTransport, Callable[..., CompletionTransport]]] = "grpc_asyncio",
    ...
    async def complete_query(
        ...
        *,
        ...
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("tenant", request.tenant),)),)

...
__lazy_modules__ = {
    "google.cloud.alloydb_v1beta.services.alloy_db_admin",
    "google.cloud.alloydb_v1beta.services.alloy_dbcsql_admin",
    "google.cloud.alloydb_v1beta.types.csql_resources",
    "google.cloud.alloydb_v1beta.types.csql_service",
    "google.cloud.alloydb_v1beta.types.data_model",
    "google.cloud.alloydb_v1beta.types.gemini",
    "google.cloud.alloydb_v1beta.types.resources",
    "google.cloud.alloydb_v1beta.types.service",
}
...
api_core.check_python_version("google.cloud.alloydb_v1beta")
api_core.check_dependency_versions("google.cloud.alloydb_v1beta")

...
from google.cloud.alloydb_v1beta.types import csql_resources, data_model, gemini, resources, service
...
class AlloyDBAdminAsyncClient:
    """Service describing handlers for resources"""

    _client: AlloyDBAdminClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = AlloyDBAdminClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = AlloyDBAdminClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = AlloyDBAdminClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = AlloyDBAdminClient._DEFAULT_UNIVERSE

    backup_path = staticmethod(AlloyDBAdminClient.backup_path)
    parse_backup_path = staticmethod(AlloyDBAdminClient.parse_backup_path)
    cluster_path = staticmethod(AlloyDBAdminClient.cluster_path)
    parse_cluster_path = staticmethod(AlloyDBAdminClient.parse_cluster_path)
    connection_info_path = staticmethod(AlloyDBAdminClient.connection_info_path)
    parse_connection_info_path = staticmethod(AlloyDBAdminClient.parse_connection_info_path)
    ...
    parse_crypto_key_version_path = staticmethod(AlloyDBAdminClient.parse_crypto_key_version_path)
    ...
    parse_service_attachment_path = staticmethod(AlloyDBAdminClient.parse_service_attachment_path)
    supported_database_flag_path = staticmethod(AlloyDBAdminClient.supported_database_flag_path)
    parse_supported_database_flag_path = staticmethod(AlloyDBAdminClient.parse_supported_database_flag_path)
    user_path = staticmethod(AlloyDBAdminClient.user_path)
    parse_user_path = staticmethod(AlloyDBAdminClient.parse_user_path)
    common_billing_account_path = staticmethod(AlloyDBAdminClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(AlloyDBAdminClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(AlloyDBAdminClient.common_folder_path)
    parse_common_folder_path = staticmethod(AlloyDBAdminClient.parse_common_folder_path)
    common_organization_path = staticmethod(AlloyDBAdminClient.common_organization_path)
    parse_common_organization_path = staticmethod(AlloyDBAdminClient.parse_common_organization_path)
    common_project_path = staticmethod(AlloyDBAdminClient.common_project_path)
    parse_common_project_path = staticmethod(AlloyDBAdminClient.parse_common_project_path)
    common_location_path = staticmethod(AlloyDBAdminClient.common_location_path)
    parse_common_location_path = staticmethod(AlloyDBAdminClient.parse_common_location_path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return AlloyDBAdminClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    get_transport_class = AlloyDBAdminClient.get_transport_class

    def __init__(
        self,
        *,
        credentials: Optional[ga_credentials.Credentials] = None,
        transport: Optional[Union[str, AlloyDBAdminTransport, Callable[..., AlloyDBAdminTransport]]] = "grpc_asyncio",
        ...
        """
        self._client = AlloyDBAdminClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.alloydb_v1beta.AlloyDBAdminAsyncClient`.",
                extra={
    ...
    async def list_clusters(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.ListClustersRequest, dict]]):
    ...
    async def update_cluster(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.UpdateClusterRequest, dict]]):
    ...
    async def export_cluster(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_cluster]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_import_cluster():
                ...
                # Initialize request argument(s)
                request = alloydb_v1beta.ImportClusterRequest(
                    name="name_value",
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.ImportClusterRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.alloydb_v1beta.types.ImportClusterResponse`
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_cluster]
    ...
    async def upgrade_cluster(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.UpgradeClusterRequest, dict]]):
            ...
            name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            version (:class:`google.cloud.alloydb_v1beta.types.DatabaseVersion`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.alloydb_v1beta.types.UpgradeClusterResponse`
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.upgrade_cluster]
    ...
    async def delete_cluster(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.DeleteClusterRequest, dict]]):
    ...
    async def promote_cluster(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.PromoteClusterRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.promote_cluster]
    ...
    async def switchover_cluster(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.SwitchoverClusterRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.switchover_cluster]
    ...
    async def restore_cluster(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.restore_cluster]
    ...
    async def create_secondary_cluster(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_secondary_cluster]
    ...
    async def list_instances(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.ListInstancesRequest, dict]]):
                The request object. Message for requesting list of
                Instances
            parent (:class:`str`):
                Required. The name of the parent resource. For the
    ...
    async def create_instance(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.CreateInstanceRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            instance (:class:`google.cloud.alloydb_v1beta.types.Instance`):
                Required. The resource being created
    ...
    async def create_secondary_instance(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.CreateSecondaryInstanceRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_secondary_instance]
    ...
    async def batch_create_instances(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.BatchCreateInstancesRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_create_instances]
    ...
    async def update_instance(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.UpdateInstanceRequest, dict]]):
    ...
    async def delete_instance(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.DeleteInstanceRequest, dict]]):
    ...
    async def failover_instance(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.FailoverInstanceRequest, dict]]):
    ...
    async def inject_fault(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.inject_fault]
    ...
    async def restart_instance(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.RestartInstanceRequest, dict]]):
                The request object.
            name (:class:`str`):
                Required. The name of the resource.
                For the required format, see the comment
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.restart_instance]
    ...
    async def execute_sql(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.ExecuteSqlRequest, dict]]):
    ...
    async def list_backups(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.ListBackupsRequest, dict]]):
                The request object. Message for requesting list of
                Backups
            parent (:class:`str`):
    ...
    async def create_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.CreateBackupRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            backup (:class:`google.cloud.alloydb_v1beta.types.Backup`):
                Required. The resource being created
    ...
    async def update_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.UpdateBackupRequest, dict]]):
    ...
    async def delete_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.DeleteBackupRequest, dict]]):
    ...
    async def list_supported_database_flags(
        self,
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListSupportedDatabaseFlagsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.ListSupportedDatabaseFlagsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_supported_database_flags]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListSupportedDatabaseFlagsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def generate_client_certificate(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.alloydb_v1beta.types.GenerateClientCertificateRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.generate_client_certificate]
    ...
    async def get_connection_info(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_connection_info]
...
__all__ = ("AlloyDBAdminAsyncClient",)

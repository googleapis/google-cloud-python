    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = get_universe_domain(
            ...
            default_universe=AlloyDBCSQLAdminClient._DEFAULT_UNIVERSE,
        )
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=AlloyDBCSQLAdminClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[AlloyDBCSQLAdminTransport],
                Callable[..., AlloyDBCSQLAdminTransport],
            ] = (

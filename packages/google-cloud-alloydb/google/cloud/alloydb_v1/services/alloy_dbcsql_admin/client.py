...
class AlloyDBCSQLAdminClient(metaclass=AlloyDBCSQLAdminClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AlloyDBCSQLAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, AlloyDBCSQLAdminTransport, Callable[..., AlloyDBCSQLAdminTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AlloyDBCSQLAdminClient._read_environment_variables()
        self._client_cert_source = AlloyDBCSQLAdminClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AlloyDBCSQLAdminClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or AlloyDBCSQLAdminClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AlloyDBCSQLAdminTransport], Callable[..., AlloyDBCSQLAdminTransport]] = (
                AlloyDBCSQLAdminClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AlloyDBCSQLAdminTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.alloydb_v1.AlloyDBCSQLAdminClient`.",
                    extra={
    ...
    def restore_from_cloud_sql(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_restore_from_cloud_sql():
                # Create a client
                client = alloydb_v1.AlloyDBCSQLAdminClient()
                ...
                # Make the request
                operation = client.restore_from_cloud_sql(request=request)
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.RestoreFromCloudSQLRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.restore_from_cloud_sql]
    ...
    def __enter__(self) -> "AlloyDBCSQLAdminClient":
        return self
...
__all__ = ("AlloyDBCSQLAdminClient",)

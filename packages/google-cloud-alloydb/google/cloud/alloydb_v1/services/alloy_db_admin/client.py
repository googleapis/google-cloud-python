...
from google.cloud.alloydb_v1.services.alloy_db_admin import pagers
...
class AlloyDBAdminClient(metaclass=AlloyDBAdminClientMeta):
    ...
    def parse_connection_info_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/instances/(?P<instance>.+?)/connectionInfo$", path
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = AlloyDBAdminClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or AlloyDBAdminClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.alloydb_v1.AlloyDBAdminClient`.",
                    extra={
    ...
    def list_clusters(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.ListClustersRequest, dict]):
    ...
    def get_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.GetClusterRequest, dict]):
    ...
    def update_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.UpdateClusterRequest, dict]):
    ...
    def export_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.ExportClusterRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.alloydb_v1.types.ExportClusterResponse`
    ...
    def import_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.ImportClusterRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.alloydb_v1.types.ImportClusterResponse`
    ...
    def upgrade_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.UpgradeClusterRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.alloydb_v1.types.UpgradeClusterResponse`
    ...
    def delete_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.DeleteClusterRequest, dict]):
    ...
    def switchover_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.SwitchoverClusterRequest, dict]):
    ...
    def list_instances(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.ListInstancesRequest, dict]):
                The request object. Message for requesting list of
                Instances
            parent (str):
                Required. The name of the parent resource. For the
    ...
    def get_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.GetInstanceRequest, dict]):
    ...
    def create_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.CreateInstanceRequest, dict]):
    ...
    def batch_create_instances(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.BatchCreateInstancesRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.alloydb_v1.types.BatchCreateInstancesResponse`
    ...
    def update_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.UpdateInstanceRequest, dict]):
    ...
    def delete_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.DeleteInstanceRequest, dict]):
    ...
    def failover_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.FailoverInstanceRequest, dict]):
    ...
    def restart_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.RestartInstanceRequest, dict]):
                The request object.
            name (str):
                Required. The name of the resource.
                For the required format, see the comment
    ...
    def execute_sql(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.ExecuteSqlRequest, dict]):
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("instance", request.instance),)),)
    ...
    def list_backups(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.ListBackupsRequest, dict]):
                The request object. Message for requesting list of
                Backups
            parent (str):
    ...
    def get_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.GetBackupRequest, dict]):
    ...
    def create_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.CreateBackupRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.alloydb_v1.types.Backup` Message
                describing Backup object
    ...
    def update_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.UpdateBackupRequest, dict]):
    ...
    def delete_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.DeleteBackupRequest, dict]):
    ...
    def list_supported_database_flags(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1.types.ListSupportedDatabaseFlagsRequest, dict]):
    ...
    def update_user(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("user.name", request.user.name),)),)

...
class AlloyDBAdminClient(metaclass=AlloyDBAdminClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AlloyDBAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = AlloyDBAdminClient._get_client_cert_source(
    ...
    def update_user(
        ...
        *,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                Optional. Field mask is used to specify
                the fields to be overwritten in the User

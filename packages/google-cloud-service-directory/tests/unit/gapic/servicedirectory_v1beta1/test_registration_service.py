...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert RegistrationServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert RegistrationServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                RegistrationServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        RegistrationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        RegistrationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == RegistrationServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_create_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*/locations/*/namespaces/*/services/*}/endpoints" % client.transport._host, args[1]
        )
...
def test_get_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/namespaces/*/services/*/endpoints/*}" % client.transport._host, args[1]
        )
...
def test_update_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{endpoint.name=projects/*/locations/*/namespaces/*/services/*/endpoints/*}" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc():
    transport = RegistrationServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = RegistrationServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = RegistrationServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = RegistrationServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_namespace_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_create_namespace") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_create_namespace_with_metadata"
...
def test_list_namespaces_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_list_namespaces") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_list_namespaces_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_namespace_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_get_namespace") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_get_namespace_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_namespace_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_update_namespace") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_update_namespace_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_namespace_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_delete_namespace") as pre:
        pre.assert_not_called()
...
def test_create_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_create_service") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_create_service_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_services_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_list_services") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_list_services_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_get_service") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_get_service_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_update_service") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_update_service_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_delete_service") as pre:
        pre.assert_not_called()
...
def test_create_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_create_endpoint") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_create_endpoint_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_list_endpoints") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_list_endpoints_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_get_endpoint") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_get_endpoint_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_update_endpoint") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_update_endpoint_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_delete_endpoint") as pre:
        pre.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_get_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_set_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.RegistrationServiceRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.RegistrationServiceGrpcTransport, grpc_helpers), (transports.RegistrationServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
async def test_get_location_field_headers_async():
    client = RegistrationServiceAsyncClient(credentials=async_anonymous_credentials())

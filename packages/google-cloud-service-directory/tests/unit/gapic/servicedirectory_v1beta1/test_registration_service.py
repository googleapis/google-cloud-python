...
async def test_create_namespace_async(request_type, transport: str = "grpc_asyncio"):
    client = RegistrationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_namespaces_async(request_type, transport: str = "grpc_asyncio"):
    client = RegistrationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_namespace_async(request_type, transport: str = "grpc_asyncio"):
    client = RegistrationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_namespace_async(request_type, transport: str = "grpc_asyncio"):
    client = RegistrationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_namespace_async(request_type, transport: str = "grpc_asyncio"):
    client = RegistrationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_namespace_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateNamespace,
    ...
    assert not set(unset_fields) - set(("namespaceId",))
...
def test_list_namespaces_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListNamespaces,
...
def test_get_namespace_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetNamespace,
...
def test_update_namespace_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateNamespace,
...
def test_delete_namespace_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteNamespace,
...
def test_create_service_rest_required_fields(
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("serviceId",))
...
def test_create_namespace_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.RegistrationServiceRestInterceptor,
...
def test_list_namespaces_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = registration_service.ListNamespacesResponse.to_json(
            registration_service.ListNamespacesResponse()
        )
        req.return_value.content = return_value
...
def test_list_services_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = registration_service.ListServicesResponse.to_json(
            registration_service.ListServicesResponse()
        )
        req.return_value.content = return_value
...
def test_list_endpoints_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = registration_service.ListEndpointsResponse.to_json(
            registration_service.ListEndpointsResponse()
        )
        req.return_value.content = return_value

...
from google.cloud.servicedirectory_v1.services.lookup_service import LookupServiceAsyncClient, LookupServiceClient, transports
...
def test__read_environment_variables():
    assert LookupServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert LookupServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                LookupServiceClient._read_environment_variables()
            assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"
        else:
            assert LookupServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert LookupServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert LookupServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert LookupServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert LookupServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert LookupServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                LookupServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert LookupServiceClient._get_client_cert_source(None, False) is None
    assert LookupServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert LookupServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert LookupServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert LookupServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(LookupServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LookupServiceClient))
@mock.patch.object(LookupServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LookupServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = LookupServiceClient._DEFAULT_UNIVERSE
    default_endpoint = LookupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = LookupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert LookupServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert LookupServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == LookupServiceClient.DEFAULT_MTLS_ENDPOINT
    assert LookupServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert LookupServiceClient._get_api_endpoint(None, None, default_universe, "always") == LookupServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        LookupServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == LookupServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert LookupServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert LookupServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        LookupServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert LookupServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert LookupServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert LookupServiceClient._get_universe_domain(None, None) == LookupServiceClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        LookupServiceClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = LookupServiceClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (LookupServiceClient, "grpc"),
        (LookupServiceAsyncClient, "grpc_asyncio"),
        (LookupServiceClient, "rest"),
    ],
)
def test_lookup_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "servicedirectory.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://servicedirectory.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.LookupServiceRestTransport, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (LookupServiceClient, transports.LookupServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(LookupServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LookupServiceClient))
@mock.patch.object(LookupServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LookupServiceAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (LookupServiceClient, transports.LookupServiceRestTransport, "rest", "true"),
        (LookupServiceClient, transports.LookupServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(LookupServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LookupServiceClient))
@mock.patch.object(LookupServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LookupServiceAsyncClient))
...
@mock.patch.object(LookupServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LookupServiceClient))
@mock.patch.object(LookupServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LookupServiceAsyncClient))
def test_lookup_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (LookupServiceClient, transports.LookupServiceGrpcTransport, "grpc", grpc_helpers),
        (LookupServiceAsyncClient, transports.LookupServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (LookupServiceClient, transports.LookupServiceRestTransport, "rest", None),
    ],
)
...
def test_resolve_service_non_empty_request_with_auto_populated_field():
...
def test_resolve_service_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.resolve_service in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.resolve_service] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_resolve_service_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.resolve_service in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.resolve_service] = mock_rpc
...
def test_resolve_service_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = LookupServiceClient(
...
def test_transport_kind_grpc():
    transport = LookupServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_resolve_service_empty_call_grpc():
    client = LookupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.resolve_service), "__call__") as call:
        call.return_value = lookup_service.ResolveServiceResponse()
        client.resolve_service(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = LookupServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = LookupServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_resolve_service_empty_call_grpc_asyncio():
    client = LookupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.resolve_service), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(lookup_service.ResolveServiceResponse())
        await client.resolve_service(request=None)
...
def test_transport_kind_rest():
    transport = LookupServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_resolve_service_rest_bad_request(request_type=lookup_service.ResolveServiceRequest):
...
def test_resolve_service_rest_call_success(request_type):
    client = LookupServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_resolve_service_rest_interceptors(null_interceptor):
    transport = transports.LookupServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.LookupServiceRestInterceptor(),
    )
    client = LookupServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LookupServiceRestInterceptor, "post_resolve_service") as post, mock.patch.object(
        transports.LookupServiceRestInterceptor, "post_resolve_service_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.LookupServiceRestInterceptor, "pre_resolve_service"
    ) as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = lookup_service.ResolveServiceResponse.to_json(lookup_service.ResolveServiceResponse())
        ...
        post_with_metadata.return_value = lookup_service.ResolveServiceResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resolve_service_empty_call_rest():
    client = LookupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_lookup_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.servicedirectory_v1.services.lookup_service.transports.LookupServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.LookupServiceGrpcTransport, grpc_helpers), (transports.LookupServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_lookup_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "servicedirectory.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://servicedirectory.googleapis.com:8000"
    )
...
def test_lookup_service_client_transport_session_collision(transport_name):
    ...
    client1 = LookupServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = LookupServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
async def test_get_location_field_headers_async():
    client = LookupServiceAsyncClient(credentials=async_anonymous_credentials())
...
@pytest.mark.parametrize(
    ...
    [
        (LookupServiceClient, transports.LookupServiceGrpcTransport),
        (LookupServiceAsyncClient, transports.LookupServiceGrpcAsyncIOTransport),
    ],
)

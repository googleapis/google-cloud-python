...
def test_update_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{endpoint.name=projects/*/locations/*/namespaces/*/services/*/endpoints/*}" % client.transport._host, args[1]
        )
...
def test_create_service_rest_call_success(request_type):
    ...
    request_init["service"] = {
        ...
        "annotations": {},
        "endpoints": [
            {"name": "name_value", "address": "address_value", "port": 453, "annotations": {}, "network": "network_value", "uid": "uid_value"}
        ],
        "uid": "uid_value",
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.

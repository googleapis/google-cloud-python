...
class LookupServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = LookupServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = LookupServiceClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(LookupServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            LookupServiceAsyncClient: The constructed client.
        """
        sa_file_func = LookupServiceClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(LookupServiceAsyncClient, filename, *args, **kwargs)
    ...
    get_transport_class = LookupServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.servicedirectory_v1beta1.LookupServiceAsyncClient`.",
                extra={

    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[LookupServiceRestInterceptor]): Interceptor used
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseLookupServiceRestTransport._BaseResolveService,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.servicedirectory_v1beta1.LookupServiceClient.ResolveService",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.servicedirectory_v1beta1.LookupServiceClient.resolve_service",
                    extra={
                        "serviceName": "google.cloud.servicedirectory.v1beta1.LookupService",
                        "rpcName": "ResolveService",
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseLookupServiceRestTransport._BaseGetLocation,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.servicedirectory_v1beta1.LookupServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.servicedirectory.v1beta1.LookupService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.servicedirectory_v1beta1.LookupServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.servicedirectory.v1beta1.LookupService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseLookupServiceRestTransport._BaseListLocations,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.servicedirectory_v1beta1.LookupServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.servicedirectory.v1beta1.LookupService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.servicedirectory_v1beta1.LookupServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.servicedirectory.v1beta1.LookupService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,

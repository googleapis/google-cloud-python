...
class LookupServiceGrpcAsyncIOTransport(LookupServiceTransport):
    ...
    @property
    def resolve_service(self) -> Callable[[lookup_service.ResolveServiceRequest], Awaitable[lookup_service.ResolveServiceResponse]]:
        ...
        if "resolve_service" not in self._stubs:
            self._stubs["resolve_service"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.resolve_service: self._wrap_method(

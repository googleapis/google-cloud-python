...
class _BaseLookupServiceRestTransport(LookupServiceTransport):
    """Base REST backend transport for LookupService.
    ...
    class _BaseResolveService:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseLookupServiceRestTransport._BaseResolveService._get_unset_required_fields(query_params))
...
__all__ = ("_BaseLookupServiceRestTransport",)

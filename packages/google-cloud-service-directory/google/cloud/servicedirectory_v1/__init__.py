...
__lazy_modules__ = {
    ...
    "google.cloud.servicedirectory_v1.services.registration_service",
    "google.cloud.servicedirectory_v1.types.endpoint",
    "google.cloud.servicedirectory_v1.types.lookup_service",
    "google.cloud.servicedirectory_v1.types.namespace",
    "google.cloud.servicedirectory_v1.types.registration_service",
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.servicedirectory_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.servicedirectory_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.servicedirectory_v1"

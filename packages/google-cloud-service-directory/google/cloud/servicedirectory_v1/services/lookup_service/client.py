...
class LookupServiceClient(metaclass=LookupServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "servicedirectory.{UNIVERSE_DOMAIN}"
    ...
    def transport(self) -> LookupServiceTransport:
        ...
        Returns:
            LookupServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = LookupServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = LookupServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = LookupServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = LookupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = LookupServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, LookupServiceTransport, Callable[..., LookupServiceTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,LookupServiceTransport,Callable[..., LookupServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the LookupServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = LookupServiceClient._read_environment_variables()
        self._client_cert_source = LookupServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = LookupServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, LookupServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(LookupServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or LookupServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[LookupServiceTransport], Callable[..., LookupServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.servicedirectory_v1.LookupServiceClient`.",
                    extra={

...
class LookupServiceClient(metaclass=LookupServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = LookupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, LookupServiceTransport, Callable[..., LookupServiceTransport]]
        ] = None,
        ...
        self._client_cert_source = LookupServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = LookupServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or LookupServiceClient._get_api_endpoint(

...
async def test_get_instance_os_policies_compliance_async(
    transport: str = "grpc_asyncio", request_type=instance_os_policies_compliance.GetInstanceOSPoliciesComplianceRequest
):
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_list_instance_os_policies_compliances_async(
    transport: str = "grpc_asyncio", request_type=instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesRequest
):
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_update_os_policy_assignment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{os_policy_assignment.name=projects/*/locations/*/osPolicyAssignments/*}" % client.transport._host, args[1]
        )
...
def test_list_os_policy_assignment_revisions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*/locations/*/osPolicyAssignments/*}:listRevisions" % client.transport._host, args[1]
        )
...
def test_get_instance_os_policies_compliance_rest_required_fields(
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_instance_os_policies_compliance._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_instance_os_policies_compliances_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_instance_os_policies_compliances._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_os_policy_assignment_report_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*/locations/*/instances/*/osPolicyAssignments/*/report}" % client.transport._host, args[1]
        )
...
def test_list_os_policy_assignment_reports_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*/instances/*/osPolicyAssignments/*}/reports" % client.transport._host, args[1]
        )
        ...
        "os_policies": [
            {
                ...
                "resource_groups": [
                    {
                        "os_filter": {"os_short_name": "os_short_name_value", "os_version": "os_version_value"},
...
def test_get_instance_os_policies_compliance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OsConfigZonalServiceRestInterceptor, "post_get_instance_os_policies_compliance"
    ) as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_get_instance_os_policies_compliance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "pre_get_instance_os_policies_compliance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = instance_os_policies_compliance.GetInstanceOSPoliciesComplianceRequest.pb(
            instance_os_policies_compliance.GetInstanceOSPoliciesComplianceRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = instance_os_policies_compliance.InstanceOSPoliciesCompliance.to_json(
            instance_os_policies_compliance.InstanceOSPoliciesCompliance()
        )
        req.return_value.content = return_value
...
def test_list_instance_os_policies_compliances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OsConfigZonalServiceRestInterceptor, "post_list_instance_os_policies_compliances"
    ) as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_list_instance_os_policies_compliances_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "pre_list_instance_os_policies_compliances"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

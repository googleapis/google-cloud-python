...
from google.cloud.osconfig_v1.services.os_config_zonal_service import OsConfigZonalServiceAsyncClient, OsConfigZonalServiceClient, pagers, transports
from google.cloud.osconfig_v1.types import inventory, os_policy, os_policy_assignment_reports, os_policy_assignments, osconfig_common, vulnerability
...
def test__read_environment_variables():
    assert OsConfigZonalServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert OsConfigZonalServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert OsConfigZonalServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert OsConfigZonalServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert OsConfigZonalServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert OsConfigZonalServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert OsConfigZonalServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                OsConfigZonalServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert OsConfigZonalServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert OsConfigZonalServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert OsConfigZonalServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert OsConfigZonalServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(OsConfigZonalServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OsConfigZonalServiceClient))
@mock.patch.object(OsConfigZonalServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OsConfigZonalServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = OsConfigZonalServiceClient._DEFAULT_UNIVERSE
    default_endpoint = OsConfigZonalServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = OsConfigZonalServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert OsConfigZonalServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        OsConfigZonalServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == OsConfigZonalServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert OsConfigZonalServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert OsConfigZonalServiceClient._get_api_endpoint(None, None, default_universe, "always") == OsConfigZonalServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        OsConfigZonalServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == OsConfigZonalServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert OsConfigZonalServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert OsConfigZonalServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        OsConfigZonalServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert OsConfigZonalServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert OsConfigZonalServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert OsConfigZonalServiceClient._get_universe_domain(None, None) == OsConfigZonalServiceClient._DEFAULT_UNIVERSE
...
def test_os_config_zonal_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "osconfig.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://osconfig.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (OsConfigZonalServiceClient, transports.OsConfigZonalServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(OsConfigZonalServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OsConfigZonalServiceClient))
@mock.patch.object(OsConfigZonalServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OsConfigZonalServiceAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (OsConfigZonalServiceClient, transports.OsConfigZonalServiceRestTransport, "rest", "true"),
        (OsConfigZonalServiceClient, transports.OsConfigZonalServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(OsConfigZonalServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OsConfigZonalServiceClient))
@mock.patch.object(OsConfigZonalServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OsConfigZonalServiceAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        (OsConfigZonalServiceClient, transports.OsConfigZonalServiceGrpcTransport, "grpc", grpc_helpers),
        (OsConfigZonalServiceAsyncClient, transports.OsConfigZonalServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (OsConfigZonalServiceClient, transports.OsConfigZonalServiceRestTransport, "rest", None),
    ],
)
...
def test_os_config_zonal_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.osconfig_v1.services.os_config_zonal_service.transports.OsConfigZonalServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_create_os_policy_assignment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_os_policy_assignment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_os_policy_assignment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_os_policy_assignment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_os_policy_assignment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_os_policy_assignment] = mock_rpc
...
def test_update_os_policy_assignment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_os_policy_assignment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_os_policy_assignment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_os_policy_assignment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_os_policy_assignment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_os_policy_assignment] = mock_rpc
...
def test_get_os_policy_assignment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_os_policy_assignment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_os_policy_assignment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_os_policy_assignment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_os_policy_assignment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_os_policy_assignment] = mock_rpc
...
def test_list_os_policy_assignments_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_os_policy_assignments in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_os_policy_assignments] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_os_policy_assignments_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_os_policy_assignments in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_os_policy_assignments] = mock_rpc
...
def test_list_os_policy_assignments_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignments), "__call__") as call:
        ...
        pager = client.list_os_policy_assignments(request={}, retry=retry, timeout=timeout)
...
async def test_list_os_policy_assignments_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignments), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_os_policy_assignments(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_list_os_policy_assignment_revisions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_os_policy_assignment_revisions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_os_policy_assignment_revisions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_os_policy_assignment_revisions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_os_policy_assignment_revisions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_os_policy_assignment_revisions] = mock_rpc
...
async def test_list_os_policy_assignment_revisions_async(
    transport: str = "grpc_asyncio", request_type=os_policy_assignments.ListOSPolicyAssignmentRevisionsRequest
):
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_os_policy_assignment_revisions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignment_revisions), "__call__") as call:
        ...
        pager = client.list_os_policy_assignment_revisions(request={}, retry=retry, timeout=timeout)
...
async def test_list_os_policy_assignment_revisions_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignment_revisions), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_os_policy_assignment_revisions(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_delete_os_policy_assignment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_os_policy_assignment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_os_policy_assignment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_os_policy_assignment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_os_policy_assignment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_os_policy_assignment] = mock_rpc
...
def test_get_os_policy_assignment_report_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_os_policy_assignment_report in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_os_policy_assignment_report] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_os_policy_assignment_report_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_os_policy_assignment_report in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_os_policy_assignment_report] = mock_rpc
...
async def test_get_os_policy_assignment_report_async(
    transport: str = "grpc_asyncio", request_type=os_policy_assignment_reports.GetOSPolicyAssignmentReportRequest
):
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_os_policy_assignment_reports_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_os_policy_assignment_reports in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_os_policy_assignment_reports] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_os_policy_assignment_reports_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_os_policy_assignment_reports in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_os_policy_assignment_reports] = mock_rpc
...
async def test_list_os_policy_assignment_reports_async(
    transport: str = "grpc_asyncio", request_type=os_policy_assignment_reports.ListOSPolicyAssignmentReportsRequest
):
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_os_policy_assignment_reports_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignment_reports), "__call__") as call:
        ...
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("parent", ""),)),)
        pager = client.list_os_policy_assignment_reports(request={}, retry=retry, timeout=timeout)
...
async def test_list_os_policy_assignment_reports_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignment_reports), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_os_policy_assignment_reports(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_inventory_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_inventory in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_inventory] = mock_rpc
...
def test_list_inventories_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_inventories] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_inventories_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_inventories in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_inventories] = mock_rpc
...
async def test_list_inventories_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_inventories), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_inventories(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_vulnerability_report(request_type, transport: str = "grpc"):
    ...
    assert response.name == "name_value"
    assert response.highest_upgradable_cve_severity == vulnerability.VulnerabilityReport.VulnerabilitySeverityLevel.NONE
...
def test_get_vulnerability_report_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_vulnerability_report in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_vulnerability_report] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_vulnerability_report_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_vulnerability_report in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_vulnerability_report] = mock_rpc
...
def test_list_vulnerability_reports_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_vulnerability_reports in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_vulnerability_reports] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_vulnerability_reports_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_vulnerability_reports in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_vulnerability_reports] = mock_rpc
...
def test_list_vulnerability_reports_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_vulnerability_reports), "__call__") as call:
        ...
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("parent", ""),)),)
        pager = client.list_vulnerability_reports(request={}, retry=retry, timeout=timeout)
...
async def test_list_vulnerability_reports_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_vulnerability_reports), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_vulnerability_reports(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_os_policy_assignment_rest_required_fields(request_type=os_policy_assignments.CreateOSPolicyAssignmentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_os_policy_assignment._get_unset_required_fields(
        jsonified_request
    )
...
def test_create_os_policy_assignment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/osPolicyAssignments" % client.transport._host, args[1])
...
def test_update_os_policy_assignment_rest_required_fields(request_type=os_policy_assignments.UpdateOSPolicyAssignmentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_os_policy_assignment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_os_policy_assignment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{os_policy_assignment.name=projects/*/locations/*/osPolicyAssignments/*}" % client.transport._host, args[1]
        )
...
def test_get_os_policy_assignment_rest_required_fields(request_type=os_policy_assignments.GetOSPolicyAssignmentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_os_policy_assignment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_os_policy_assignment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/osPolicyAssignments/*}" % client.transport._host, args[1])
...
def test_list_os_policy_assignments_rest_required_fields(request_type=os_policy_assignments.ListOSPolicyAssignmentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_os_policy_assignments._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_os_policy_assignment_revisions_rest_required_fields(request_type=os_policy_assignments.ListOSPolicyAssignmentRevisionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_os_policy_assignment_revisions._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_os_policy_assignment_revisions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/osPolicyAssignments/*}:listRevisions" % client.transport._host, args[1])
...
def test_delete_os_policy_assignment_rest_required_fields(request_type=os_policy_assignments.DeleteOSPolicyAssignmentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_os_policy_assignment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_os_policy_assignment_report_rest_required_fields(request_type=os_policy_assignment_reports.GetOSPolicyAssignmentReportRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_os_policy_assignment_report._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_os_policy_assignment_report_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/instances/*/osPolicyAssignments/*/report}" % client.transport._host, args[1]
        )
...
def test_list_os_policy_assignment_reports_rest_required_fields(request_type=os_policy_assignment_reports.ListOSPolicyAssignmentReportsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_os_policy_assignment_reports._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_os_policy_assignment_reports_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/instances/*/osPolicyAssignments/*}/reports" % client.transport._host, args[1]
        )
...
def test_get_inventory_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/instances/*/inventory}" % client.transport._host, args[1])
...
def test_list_inventories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/instances/*}/inventories" % client.transport._host, args[1])
...
def test_get_vulnerability_report_rest_required_fields(request_type=vulnerability.GetVulnerabilityReportRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_vulnerability_report._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_vulnerability_report_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/instances/*/vulnerabilityReport}" % client.transport._host, args[1])
...
def test_list_vulnerability_reports_rest_required_fields(request_type=vulnerability.ListVulnerabilityReportsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_vulnerability_reports._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_vulnerability_reports_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/instances/*}/vulnerabilityReports" % client.transport._host, args[1])
...
def test_transport_kind_grpc():
    transport = OsConfigZonalServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_os_policy_assignment_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_os_policy_assignment), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_os_policy_assignment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_os_policy_assignment_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_os_policy_assignment), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.update_os_policy_assignment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_os_policy_assignment_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_os_policy_assignment), "__call__") as call:
        call.return_value = os_policy_assignments.OSPolicyAssignment()
        client.get_os_policy_assignment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_os_policy_assignments_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignments), "__call__") as call:
        call.return_value = os_policy_assignments.ListOSPolicyAssignmentsResponse()
        client.list_os_policy_assignments(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_os_policy_assignment_revisions_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignment_revisions), "__call__") as call:
        call.return_value = os_policy_assignments.ListOSPolicyAssignmentRevisionsResponse()
        client.list_os_policy_assignment_revisions(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_os_policy_assignment_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_os_policy_assignment), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_os_policy_assignment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_os_policy_assignment_report_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_os_policy_assignment_report), "__call__") as call:
        call.return_value = os_policy_assignment_reports.OSPolicyAssignmentReport()
        client.get_os_policy_assignment_report(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_os_policy_assignment_reports_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignment_reports), "__call__") as call:
        call.return_value = os_policy_assignment_reports.ListOSPolicyAssignmentReportsResponse()
        client.list_os_policy_assignment_reports(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_inventory_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_inventory), "__call__") as call:
        call.return_value = inventory.Inventory()
        client.get_inventory(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_inventories_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_inventories), "__call__") as call:
        call.return_value = inventory.ListInventoriesResponse()
        client.list_inventories(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_vulnerability_report_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_vulnerability_report), "__call__") as call:
        call.return_value = vulnerability.VulnerabilityReport()
        client.get_vulnerability_report(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_vulnerability_reports_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_vulnerability_reports), "__call__") as call:
        call.return_value = vulnerability.ListVulnerabilityReportsResponse()
        client.list_vulnerability_reports(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = OsConfigZonalServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_os_policy_assignment_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.create_os_policy_assignment), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_os_policy_assignment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_os_policy_assignment_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_os_policy_assignment), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.update_os_policy_assignment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_os_policy_assignment_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_os_policy_assignment), "__call__") as call:
        ...
        await client.get_os_policy_assignment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_os_policy_assignments_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignments), "__call__") as call:
        ...
        await client.list_os_policy_assignments(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_os_policy_assignment_revisions_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignment_revisions), "__call__") as call:
        ...
        await client.list_os_policy_assignment_revisions(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_os_policy_assignment_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_os_policy_assignment), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_os_policy_assignment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_os_policy_assignment_report_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_os_policy_assignment_report), "__call__") as call:
        ...
        await client.get_os_policy_assignment_report(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_os_policy_assignment_reports_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_os_policy_assignment_reports), "__call__") as call:
        ...
        await client.list_os_policy_assignment_reports(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_inventory_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_inventory), "__call__") as call:
        ...
        await client.get_inventory(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_inventories_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_inventories), "__call__") as call:
        ...
        await client.list_inventories(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_vulnerability_report_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_vulnerability_reports_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_vulnerability_reports), "__call__") as call:
        ...
        await client.list_vulnerability_reports(request=None)
...
def test_transport_kind_rest():
    transport = OsConfigZonalServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_os_policy_assignment_rest_bad_request(request_type=os_policy_assignments.CreateOSPolicyAssignmentRequest):
...
def test_create_os_policy_assignment_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["os_policy_assignment"] = {
        ...
        "os_policies": [
            {
                ...
                "resource_groups": [
                    {
                        "inventory_filters": [{"os_short_name": "os_short_name_value", "os_version": "os_version_value"}],
                        "resources": [
                            {
                                "id": "id_value",
                                "pkg": {
                                    ...
                                    "deb": {
                                        "source": {
                                            "remote": {"uri": "uri_value", "sha256_checksum": "sha256_checksum_value"},
                                            "gcs": {"bucket": "bucket_value", "object_": "object__value", "generation": 1068},
                                    ...
                                    "msi": {"source": {}, "properties": ["properties_value1", "properties_value2"]},
                                },
                                "repository": {
                                    "apt": {
                                        "archive_type": 1,
                                    ...
                                    "yum": {
                                        ...
                                        "gpg_keys": ["gpg_keys_value1", "gpg_keys_value2"],
                                    },
                                    "zypper": {
                                        "id": "id_value",
                                        "display_name": "display_name_value",
        ...
        "instance_filter": {
            ...
            "exclusion_labels": {},
            "inventories": [{"os_short_name": "os_short_name_value", "os_version": "os_version_value"}],
        },
        "rollout": {"disruption_budget": {"fixed": 528, "percent": 753}, "min_wait_duration": {"seconds": 751, "nanos": 543}},
        "revision_id": "revision_id_value",
    ...
    for field, value in request_init["os_policy_assignment"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_os_policy_assignment_rest_interceptors(null_interceptor):
    transport = transports.OsConfigZonalServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.OsConfigZonalServiceRestInterceptor(),
    )
    client = OsConfigZonalServiceClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OsConfigZonalServiceRestInterceptor, "post_create_os_policy_assignment"
    ) as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_create_os_policy_assignment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "pre_create_os_policy_assignment"
    ) as pre:
...
def test_update_os_policy_assignment_rest_bad_request(request_type=os_policy_assignments.UpdateOSPolicyAssignmentRequest):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_os_policy_assignment_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_update_os_policy_assignment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OsConfigZonalServiceRestInterceptor, "post_update_os_policy_assignment"
    ) as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_update_os_policy_assignment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "pre_update_os_policy_assignment"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_os_policy_assignment_rest_bad_request(request_type=os_policy_assignments.GetOSPolicyAssignmentRequest):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_os_policy_assignment_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_os_policy_assignment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_os_policy_assignment") as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_get_os_policy_assignment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = os_policy_assignments.OSPolicyAssignment.to_json(os_policy_assignments.OSPolicyAssignment())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = os_policy_assignments.OSPolicyAssignment(), metadata
...
def test_list_os_policy_assignments_rest_bad_request(request_type=os_policy_assignments.ListOSPolicyAssignmentsRequest):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_os_policy_assignments_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_os_policy_assignments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignments") as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignments_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = os_policy_assignments.ListOSPolicyAssignmentsResponse.to_json(os_policy_assignments.ListOSPolicyAssignmentsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = os_policy_assignments.ListOSPolicyAssignmentsResponse(), metadata
...
def test_list_os_policy_assignment_revisions_rest_bad_request(request_type=os_policy_assignments.ListOSPolicyAssignmentRevisionsRequest):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/osPolicyAssignments/sample3"}
    request = request_type(**request_init)
...
def test_list_os_policy_assignment_revisions_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_os_policy_assignment_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignment_revisions"
    ) as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignment_revisions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "pre_list_os_policy_assignment_revisions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = os_policy_assignments.ListOSPolicyAssignmentRevisionsResponse.to_json(
            os_policy_assignments.ListOSPolicyAssignmentRevisionsResponse()
        )
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = os_policy_assignments.ListOSPolicyAssignmentRevisionsResponse(), metadata
...
def test_delete_os_policy_assignment_rest_bad_request(request_type=os_policy_assignments.DeleteOSPolicyAssignmentRequest):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/osPolicyAssignments/sample3"}
    request = request_type(**request_init)
...
def test_delete_os_policy_assignment_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_os_policy_assignment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OsConfigZonalServiceRestInterceptor, "post_delete_os_policy_assignment"
    ) as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_delete_os_policy_assignment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "pre_delete_os_policy_assignment"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_os_policy_assignment_report_rest_bad_request(request_type=os_policy_assignment_reports.GetOSPolicyAssignmentReportRequest):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_os_policy_assignment_report_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_os_policy_assignment_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OsConfigZonalServiceRestInterceptor, "post_get_os_policy_assignment_report"
    ) as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_get_os_policy_assignment_report_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "pre_get_os_policy_assignment_report"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = os_policy_assignment_reports.OSPolicyAssignmentReport.to_json(os_policy_assignment_reports.OSPolicyAssignmentReport())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = os_policy_assignment_reports.OSPolicyAssignmentReport(), metadata
...
def test_list_os_policy_assignment_reports_rest_bad_request(request_type=os_policy_assignment_reports.ListOSPolicyAssignmentReportsRequest):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_os_policy_assignment_reports_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_os_policy_assignment_reports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignment_reports"
    ) as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignment_reports_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "pre_list_os_policy_assignment_reports"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = os_policy_assignment_reports.ListOSPolicyAssignmentReportsRequest.pb(
            os_policy_assignment_reports.ListOSPolicyAssignmentReportsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = os_policy_assignment_reports.ListOSPolicyAssignmentReportsResponse.to_json(
            os_policy_assignment_reports.ListOSPolicyAssignmentReportsResponse()
        )
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = os_policy_assignment_reports.ListOSPolicyAssignmentReportsResponse(), metadata
...
def test_get_inventory_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_inventory_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_inventory") as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_get_inventory_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_inventories_rest_bad_request(request_type=inventory.ListInventoriesRequest):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_inventories_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_inventories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_inventories") as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_list_inventories_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = inventory.ListInventoriesResponse.to_json(inventory.ListInventoriesResponse())
        req.return_value.content = return_value
...
def test_get_vulnerability_report_rest_bad_request(request_type=vulnerability.GetVulnerabilityReportRequest):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_vulnerability_report_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_vulnerability_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_vulnerability_report") as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_get_vulnerability_report_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = vulnerability.VulnerabilityReport.to_json(vulnerability.VulnerabilityReport())
        req.return_value.content = return_value
...
def test_list_vulnerability_reports_rest_bad_request(request_type=vulnerability.ListVulnerabilityReportsRequest):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/instances/sample3"}
    request = request_type(**request_init)
...
def test_list_vulnerability_reports_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_vulnerability_reports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_vulnerability_reports") as post, mock.patch.object(
        transports.OsConfigZonalServiceRestInterceptor, "post_list_vulnerability_reports_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = vulnerability.ListVulnerabilityReportsResponse.to_json(vulnerability.ListVulnerabilityReportsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = vulnerability.ListVulnerabilityReportsResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_os_policy_assignment_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_os_policy_assignment_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_os_policy_assignment_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_os_policy_assignments_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_os_policy_assignment_revisions_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_os_policy_assignment_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_os_policy_assignment_report_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_os_policy_assignment_reports_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_inventory_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_inventories_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_vulnerability_report_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_vulnerability_reports_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_os_config_zonal_service_base_transport():
    ...
    with mock.patch("google.cloud.osconfig_v1.services.os_config_zonal_service.transports.OsConfigZonalServiceTransport.__init__") as Transport:
...
def test_os_config_zonal_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.osconfig_v1.services.os_config_zonal_service.transports.OsConfigZonalServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.OsConfigZonalServiceGrpcTransport, grpc_helpers), (transports.OsConfigZonalServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_os_config_zonal_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "osconfig.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://osconfig.googleapis.com:8000"
    )
...
def test_instance_path():
    ...
    actual = OsConfigZonalServiceClient.instance_path(project, zone, instance)

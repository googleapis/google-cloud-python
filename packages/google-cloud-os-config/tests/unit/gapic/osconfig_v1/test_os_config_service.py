...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert OsConfigServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert OsConfigServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                OsConfigServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        OsConfigServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        OsConfigServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == OsConfigServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_list_patch_job_instance_details_rest_required_fields(request_type=patch_jobs.ListPatchJobInstanceDetailsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_patch_job_instance_details._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_patch_deployment_rest_required_fields(request_type=patch_deployments.CreatePatchDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_patch_deployment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_patch_deployment_rest_required_fields(request_type=patch_deployments.GetPatchDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_patch_deployment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_patch_deployments_rest_required_fields(request_type=patch_deployments.ListPatchDeploymentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_patch_deployments._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_patch_deployment_rest_required_fields(request_type=patch_deployments.DeletePatchDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_patch_deployment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_patch_deployment_rest_required_fields(request_type=patch_deployments.UpdatePatchDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_patch_deployment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = OsConfigServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = OsConfigServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = OsConfigServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = OsConfigServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_execute_patch_job_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "post_execute_patch_job") as post, mock.patch.object(
        transports.OsConfigServiceRestInterceptor, "post_execute_patch_job_with_metadata"
...
def test_get_patch_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "post_get_patch_job") as post, mock.patch.object(
...
def test_cancel_patch_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "post_cancel_patch_job") as post, mock.patch.object(
...
def test_list_patch_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "post_list_patch_jobs") as post, mock.patch.object(
...
def test_list_patch_job_instance_details_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "post_list_patch_job_instance_details") as post, mock.patch.object(
        transports.OsConfigServiceRestInterceptor, "post_list_patch_job_instance_details_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_patch_deployment_rest_call_success(request_type):
    ...
    request_init["patch_deployment"] = {
        ...
        "instance_filter": {
            ...
            "instance_name_prefixes": ["instance_name_prefixes_value1", "instance_name_prefixes_value2"],
        },
        "patch_config": {
            "reboot_config": 1,
            "apt": {
                ...
                "exclusive_packages": ["exclusive_packages_value1", "exclusive_packages_value2"],
            },
            "yum": {
                "security": True,
                "minimal": True,
            ...
            "zypper": {
                ...
                "excludes": ["excludes_value1", "excludes_value2"],
                "exclusive_patches": ["exclusive_patches_value1", "exclusive_patches_value2"],
            },
            "windows_update": {
                "classifications": [1],
                "excludes": ["excludes_value1", "excludes_value2"],
            ...
            "pre_step": {
                "linux_exec_step_config": {
                    ...
                    "gcs_object": {"bucket": "bucket_value", "object_": "object__value", "generation_number": 1812},
        ...
        "recurring_schedule": {
            ...
            "monthly": {"week_day_of_month": {"week_ordinal": 1268, "day_of_week": 1, "day_offset": 1060}, "month_day": 963},
            "last_execute_time": {},
            "next_execute_time": {},
        },
        "create_time": {},
...
def test_create_patch_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "post_create_patch_deployment") as post, mock.patch.object(
        transports.OsConfigServiceRestInterceptor, "post_create_patch_deployment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_patch_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "post_get_patch_deployment") as post, mock.patch.object(
        transports.OsConfigServiceRestInterceptor, "post_get_patch_deployment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_patch_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "post_list_patch_deployments") as post, mock.patch.object(
        transports.OsConfigServiceRestInterceptor, "post_list_patch_deployments_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_patch_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "pre_delete_patch_deployment") as pre:
        pre.assert_not_called()
...
def test_update_patch_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "post_update_patch_deployment") as post, mock.patch.object(
        transports.OsConfigServiceRestInterceptor, "post_update_patch_deployment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_pause_patch_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "post_pause_patch_deployment") as post, mock.patch.object(
        transports.OsConfigServiceRestInterceptor, "post_pause_patch_deployment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_resume_patch_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsConfigServiceRestInterceptor, "post_resume_patch_deployment") as post, mock.patch.object(
        transports.OsConfigServiceRestInterceptor, "post_resume_patch_deployment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.OsConfigServiceGrpcTransport, grpc_helpers), (transports.OsConfigServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

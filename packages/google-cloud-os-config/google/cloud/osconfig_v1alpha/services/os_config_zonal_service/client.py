...
class OsConfigZonalServiceClient(metaclass=OsConfigZonalServiceClientMeta):
    ...
    def get_instance_os_policies_compliance(
        ...
        *,
        ...
        """
        warnings.warn("OsConfigZonalServiceClient.get_instance_os_policies_compliance is deprecated", DeprecationWarning)
    ...
    def list_instance_os_policies_compliances(
        ...
        *,
        ...
        """
        warnings.warn("OsConfigZonalServiceClient.list_instance_os_policies_compliances is deprecated", DeprecationWarning)

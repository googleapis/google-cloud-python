...
from .types.config_common import OSPolicyComplianceState, OSPolicyResourceCompliance, OSPolicyResourceConfigStep
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.osconfig_v1alpha")  # type: ignore
    api_core.check_dependency_versions("google.cloud.osconfig_v1alpha")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.osconfig_v1alpha"

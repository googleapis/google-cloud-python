...
from google.cloud.osconfig_v1.types import inventory, os_policy, os_policy_assignment_reports, os_policy_assignments, vulnerability
...
class OsConfigZonalServiceClient(metaclass=OsConfigZonalServiceClientMeta):
    ...
    def parse_instance_os_policy_assignment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/osPolicyAssignments/(?P<assignment>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_vulnerability_report_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/vulnerabilityReport$", path)
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = OsConfigZonalServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = OsConfigZonalServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, OsConfigZonalServiceTransport, Callable[..., OsConfigZonalServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = OsConfigZonalServiceClient._read_environment_variables()
        self._client_cert_source = OsConfigZonalServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = OsConfigZonalServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or OsConfigZonalServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[OsConfigZonalServiceTransport], Callable[..., OsConfigZonalServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.osconfig_v1.OsConfigZonalServiceClient`.",
                    extra={
    ...
    def create_os_policy_assignment(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_os_policy_assignment]
    ...
    def update_os_policy_assignment(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_os_policy_assignment]
    ...
    def list_os_policy_assignments(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_os_policy_assignments]
    ...
    def list_os_policy_assignment_revisions(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_os_policy_assignment_revisions]
    ...
    def delete_os_policy_assignment(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_os_policy_assignment]
    ...
    def get_os_policy_assignment_report(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_os_policy_assignment_report]
    ...
    def list_os_policy_assignment_reports(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_os_policy_assignment_reports]
    ...
    def list_vulnerability_reports(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_vulnerability_reports]

...
from .services.os_config_service import OsConfigServiceAsyncClient, OsConfigServiceClient
from .services.os_config_zonal_service import OsConfigZonalServiceAsyncClient, OsConfigZonalServiceClient
from .types.inventory import GetInventoryRequest, Inventory, InventoryView, ListInventoriesRequest, ListInventoriesResponse
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.osconfig_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.osconfig_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.osconfig_v1"

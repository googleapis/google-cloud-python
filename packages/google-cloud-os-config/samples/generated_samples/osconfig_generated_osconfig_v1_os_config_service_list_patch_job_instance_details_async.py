...
# [START osconfig_generated_osconfig_v1_OsConfigService_ListPatchJobInstanceDetails_async]
...
# [END osconfig_generated_osconfig_v1_OsConfigService_ListPatchJobInstanceDetails_async]

...
# [START osconfig_generated_osconfig_v1alpha_OsConfigZonalService_UpdateOSPolicyAssignment_sync]
...
# [END osconfig_generated_osconfig_v1alpha_OsConfigZonalService_UpdateOSPolicyAssignment_sync]

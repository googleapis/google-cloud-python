...
# [START osconfig_generated_osconfig_v1_OsConfigService_ListPatchJobInstanceDetails_sync]
...
# [END osconfig_generated_osconfig_v1_OsConfigService_ListPatchJobInstanceDetails_sync]

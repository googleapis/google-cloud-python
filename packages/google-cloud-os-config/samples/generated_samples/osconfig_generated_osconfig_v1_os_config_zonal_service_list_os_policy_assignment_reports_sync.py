...
# [START osconfig_generated_osconfig_v1_OsConfigZonalService_ListOSPolicyAssignmentReports_sync]
...
# [END osconfig_generated_osconfig_v1_OsConfigZonalService_ListOSPolicyAssignmentReports_sync]

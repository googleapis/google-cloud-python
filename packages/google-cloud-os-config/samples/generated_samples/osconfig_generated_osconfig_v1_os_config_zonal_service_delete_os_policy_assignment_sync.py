...
# [START osconfig_generated_osconfig_v1_OsConfigZonalService_DeleteOSPolicyAssignment_sync]
...
# [END osconfig_generated_osconfig_v1_OsConfigZonalService_DeleteOSPolicyAssignment_sync]

...
# [START osconfig_generated_osconfig_v1alpha_OsConfigZonalService_DeleteOSPolicyAssignment_sync]
...
# [END osconfig_generated_osconfig_v1alpha_OsConfigZonalService_DeleteOSPolicyAssignment_sync]

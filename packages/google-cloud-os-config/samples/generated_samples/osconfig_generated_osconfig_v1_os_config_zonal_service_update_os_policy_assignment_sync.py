...
# [START osconfig_generated_osconfig_v1_OsConfigZonalService_UpdateOSPolicyAssignment_sync]
...
# [END osconfig_generated_osconfig_v1_OsConfigZonalService_UpdateOSPolicyAssignment_sync]

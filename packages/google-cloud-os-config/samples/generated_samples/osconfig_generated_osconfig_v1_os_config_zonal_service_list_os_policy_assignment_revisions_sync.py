...
# [START osconfig_generated_osconfig_v1_OsConfigZonalService_ListOSPolicyAssignmentRevisions_sync]
...
# [END osconfig_generated_osconfig_v1_OsConfigZonalService_ListOSPolicyAssignmentRevisions_sync]

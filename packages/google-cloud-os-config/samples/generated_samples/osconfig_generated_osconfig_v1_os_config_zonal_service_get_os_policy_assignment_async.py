...
# [START osconfig_generated_osconfig_v1_OsConfigZonalService_GetOSPolicyAssignment_async]
...
# [END osconfig_generated_osconfig_v1_OsConfigZonalService_GetOSPolicyAssignment_async]

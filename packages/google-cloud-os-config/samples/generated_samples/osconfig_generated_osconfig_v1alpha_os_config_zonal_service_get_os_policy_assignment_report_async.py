...
# [START osconfig_generated_osconfig_v1alpha_OsConfigZonalService_GetOSPolicyAssignmentReport_async]
...
# [END osconfig_generated_osconfig_v1alpha_OsConfigZonalService_GetOSPolicyAssignmentReport_async]

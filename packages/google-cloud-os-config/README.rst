Python Client for OS Config
===========================

|stable| |pypi| |versions|

`OS Config`_: provides OS management tools that can be used for patch management, patch compliance, and configuration management on VM instances.
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-os-config/samples
...
-  Read the `Client Library Documentation`_ for OS Config
   to see other available methods on the client.
-  Read the `OS Config Product documentation`_ to learn

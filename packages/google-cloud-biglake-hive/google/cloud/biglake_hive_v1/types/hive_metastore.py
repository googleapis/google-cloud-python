...
__protobuf__ = proto.module(
    package="google.cloud.biglake.hive.v1",
    manifest={
        "HiveCatalog",
...
class HiveCatalog(proto.Message):
    ...
    Attributes:
        ...
        location_uri (str):
            ...
            is 4000 characters.
        replicas (MutableSequence[google.cloud.biglake_hive_v1.types.HiveCatalog.Replica]):
    ...
    class Replica(proto.Message):
        ...
        Attributes:
            region (str):
                ...
                ``us-east1``.
            state (google.cloud.biglake_hive_v1.types.HiveCatalog.Replica.State):
...
class ListHiveCatalogsResponse(proto.Message):
    ...
    Attributes:
        catalogs (MutableSequence[google.cloud.biglake_hive_v1.types.HiveCatalog]):
...
class ListHiveDatabasesResponse(proto.Message):
    ...
    Attributes:
        databases (MutableSequence[google.cloud.biglake_hive_v1.types.HiveDatabase]):
...
class HiveTable(proto.Message):
    ...
    Attributes:
        ...
        storage_descriptor (google.cloud.biglake_hive_v1.types.StorageDescriptor):
            Required. Storage descriptor of the table.
        create_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The creation time of the table.
        partition_keys (MutableSequence[google.cloud.biglake_hive_v1.types.FieldSchema]):
...
class StorageDescriptor(proto.Message):
    ...
    Attributes:
        columns (MutableSequence[google.cloud.biglake_hive_v1.types.FieldSchema]):
        ...
        serde_info (google.cloud.biglake_hive_v1.types.SerdeInfo):
        ...
        sort_cols (MutableSequence[google.cloud.biglake_hive_v1.types.StorageDescriptor.Order]):
            Optional. Sort order of the data in each
            bucket
        parameters (MutableMapping[str, str]):
            Optional. Key-value pairs for the storage
            descriptor. The maximum size is 10Kib.
        skewed_info (google.cloud.biglake_hive_v1.types.StorageDescriptor.SkewedInfo):
    ...
    class SkewedInfo(proto.Message):
        ...
        Attributes:
            skewed_col_names (MutableSequence[str]):
                ...
                name.
            skewed_col_values (MutableSequence[google.cloud.biglake_hive_v1.types.StorageDescriptor.SkewedInfo.SkewedColumnValue]):
                Required. The skewed column values.
            skewed_key_values_locations (MutableSequence[google.cloud.biglake_hive_v1.types.StorageDescriptor.SkewedInfo.SkewedKeyValuesLocation]):
...
class SerdeInfo(proto.Message):
    ...
    Attributes:
        ...
        deserializer_class (str):
            ...
            characters.
        serde_type (google.cloud.biglake_hive_v1.types.SerdeInfo.SerdeType):
...
class ListHiveTablesResponse(proto.Message):
    ...
    Attributes:
        tables (MutableSequence[google.cloud.biglake_hive_v1.types.HiveTable]):
...
class Partition(proto.Message):
    ...
    Attributes:
        ...
        parameters (MutableMapping[str, str]):
            ...
            KiB.
        fields (MutableSequence[google.cloud.biglake_hive_v1.types.FieldSchema]):
...
class CreatePartitionRequest(proto.Message):
    ...
    Attributes:
        ...
        partition (google.cloud.biglake_hive_v1.types.Partition):
...
class BatchCreatePartitionsRequest(proto.Message):
    ...
    Attributes:
        ...
        requests (MutableSequence[google.cloud.biglake_hive_v1.types.CreatePartitionRequest]):
...
class BatchCreatePartitionsResponse(proto.Message):
    ...
    Attributes:
        partitions (MutableSequence[google.cloud.biglake_hive_v1.types.Partition]):
...
class BatchDeletePartitionsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            projects/{project}/catalogs/{catalogs}/databases/{database}/tables/{table}.
        partition_values (MutableSequence[google.cloud.biglake_hive_v1.types.PartitionValues]):
...
class BatchUpdatePartitionsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            these partitions belong, in the format of
            projects/{project}/catalogs/{catalogs}/databases/{database}/tables/{table}.
        requests (MutableSequence[google.cloud.biglake_hive_v1.types.UpdatePartitionRequest]):

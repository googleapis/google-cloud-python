...
class HiveMetastoreServiceGrpcTransport(HiveMetastoreServiceTransport):
    """gRPC backend transport for HiveMetastoreService.
...
__all__ = ("HiveMetastoreServiceGrpcTransport",)

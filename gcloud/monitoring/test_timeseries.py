...
class TestAligner(unittest2.TestCase):
    ...
    def _getTargetClass(self):
        from gcloud.monitoring.timeseries import Aligner
        return Aligner
...
class TestReducer(unittest2.TestCase):
    ...
    def _getTargetClass(self):
        from gcloud.monitoring.timeseries import Reducer
        return Reducer
...
class TestQuery(unittest2.TestCase):
    ...
    def test_constructor_default_end_time(self):
        ...
        from gcloud.monitoring import timeseries as MUT
...
class Test_Filter(unittest2.TestCase):
    ...
    def _getTargetClass(self):
        from gcloud.monitoring.timeseries import _Filter
        return _Filter
...
class Test__build_label_filter(unittest2.TestCase):
    ...
    def _callFUT(self, *args, **kwargs):
        from gcloud.monitoring.timeseries import _build_label_filter
...
class Test__sorted_resource_labels(unittest2.TestCase):
    ...
    def _callFUT(self, labels):
        from gcloud.monitoring.timeseries import _sorted_resource_labels
    ...
    def test_sorted(self):
        from gcloud.monitoring.timeseries import TOP_RESOURCE_LABELS
...
class Test__format_timestamp(unittest2.TestCase):
    ...
    def _callFUT(self, timestamp):
        from gcloud.monitoring.timeseries import _format_timestamp

...
class StorageObjectsComposeRequest(messages.Message):
  ...
  Fields:
    ...
    encryptionKey: Provides a base64-encoded 256-bit key that was used to
      encrypt the object, if any. Algorithm, key, and key hash must be
      supplied together.
  ...
  encryptionAlgorithm = messages.StringField(5)
  encryptionKey = messages.StringField(6)
  encryptionKeyHash = messages.StringField(7)
  ifGenerationMatch = messages.IntegerField(8)
  ifMetagenerationMatch = messages.IntegerField(9)
...
class StorageObjectsCopyRequest(messages.Message):
  ...
  encryptionAlgorithm = messages.StringField(4)
  encryptionKey = messages.StringField(5)
  encryptionKeyHash = messages.StringField(6)
  ifGenerationMatch = messages.IntegerField(7)
  ifGenerationNotMatch = messages.IntegerField(8)
  ifMetagenerationMatch = messages.IntegerField(9)
  ifMetagenerationNotMatch = messages.IntegerField(10)
  ifSourceGenerationMatch = messages.IntegerField(11)
  ifSourceGenerationNotMatch = messages.IntegerField(12)
  ifSourceMetagenerationMatch = messages.IntegerField(13)
  ifSourceMetagenerationNotMatch = messages.IntegerField(14)
  object = messages.MessageField('Object', 15)
  projection = messages.EnumField('ProjectionValueValuesEnum', 16)
  sourceBucket = messages.StringField(17, required=True)
  sourceGeneration = messages.IntegerField(18)
  sourceObject = messages.StringField(19, required=True)
...
class StorageObjectsGetRequest(messages.Message):
  ...
  Fields:
    bucket: Name of the bucket in which the object resides.
    encryptionAlgorithm: Specifies the encryption algorithm that would be used
      to decrypt the object. Only 'AES256' is supported currently. Algorithm,
      key, and key hash must be supplied together.
  ...
  bucket = messages.StringField(1, required=True)
  encryptionAlgorithm = messages.StringField(2)
  encryptionKey = messages.StringField(3)
  encryptionKeyHash = messages.StringField(4)
  generation = messages.IntegerField(5)
  ifGenerationMatch = messages.IntegerField(6)
  ifGenerationNotMatch = messages.IntegerField(7)
  ifMetagenerationMatch = messages.IntegerField(8)
  ifMetagenerationNotMatch = messages.IntegerField(9)
  object = messages.StringField(10, required=True)
  projection = messages.EnumField('ProjectionValueValuesEnum', 11)
...
class StorageObjectsInsertRequest(messages.Message):
  ...
  Fields:
    ...
    contentEncoding: If set, sets the contentEncoding property of the final
      ...
      being uploaded.
    encryptionAlgorithm: Specifies the encryption algorithm that would be used
      to encrypt the object. Only 'AES256' is supported currently. Algorithm,
      key, and key hash must be supplied together.
  ...
  encryptionAlgorithm = messages.StringField(3)
  encryptionKey = messages.StringField(4)
  encryptionKeyHash = messages.StringField(5)
  ifGenerationMatch = messages.IntegerField(6)
  ifGenerationNotMatch = messages.IntegerField(7)
  ifMetagenerationMatch = messages.IntegerField(8)
  ifMetagenerationNotMatch = messages.IntegerField(9)
  name = messages.StringField(10)
  object = messages.MessageField('Object', 11)
  predefinedAcl = messages.EnumField('PredefinedAclValueValuesEnum', 12)
...
class StorageObjectsPatchRequest(messages.Message):
  ...
  Fields:
    ...
    encryptionKeyHash: For downloading encrypted objects, provides the digest
      of the key for error-checking transmission. A digest is in the format of
      '='. Algorithm, key, and key hash must be supplied together.
    generation: If present, selects a specific revision of this object (as
      opposed to the latest version, the default).
    ifGenerationMatch: Makes the operation conditional on whether the object's
  ...
  ifMetagenerationNotMatch = messages.IntegerField(9)
  object = messages.StringField(10, required=True)
  objectResource = messages.MessageField('Object', 11)
  predefinedAcl = messages.EnumField('PredefinedAclValueValuesEnum', 12)
  projection = messages.EnumField('ProjectionValueValuesEnum', 13)

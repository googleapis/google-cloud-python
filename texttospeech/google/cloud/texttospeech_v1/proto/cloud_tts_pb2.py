...
SynthesizeSpeechRequest = _reflection.GeneratedProtocolMessageType('SynthesizeSpeechRequest', (_message.Message,), dict(
...
SynthesisInput = _reflection.GeneratedProtocolMessageType('SynthesisInput', (_message.Message,), dict(
...
SynthesizeSpeechResponse = _reflection.GeneratedProtocolMessageType('SynthesizeSpeechResponse', (_message.Message,), dict(
...
_TEXTTOSPEECH = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\030\"\023/v1/text:synthesize:\001*')),
  ),
])

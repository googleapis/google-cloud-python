...
from google.cloud.dataproc_v1.proto import clusters_pb2 as google_dot_cloud_dot_dataproc__v1_dot_proto_dot_clusters__pb2
from google.cloud.dataproc_v1.proto import jobs_pb2 as google_dot_cloud_dot_dataproc__v1_dot_proto_dot_jobs__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_cloud_dot_dataproc__v1_dot_proto_dot_clusters__pb2.DESCRIPTOR,google_dot_cloud_dot_dataproc__v1_dot_proto_dot_jobs__pb2.DESCRIPTOR,google_dot_longrunning_dot_operations__pb2.DESCRIPTOR,google_dot_protobuf_dot_empty__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,])
...
_ORDEREDJOB = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='spark_sql_job', full_name='google.cloud.dataproc.v1.OrderedJob.spark_sql_job', index=6,
      number=7, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='labels', full_name='google.cloud.dataproc.v1.OrderedJob.labels', index=7,
      number=8, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='scheduling', full_name='google.cloud.dataproc.v1.OrderedJob.scheduling', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='prerequisite_step_ids', full_name='google.cloud.dataproc.v1.OrderedJob.prerequisite_step_ids', index=9,
...
_MANAGEDCLUSTER.fields_by_name['config'].message_type = google_dot_cloud_dot_dataproc__v1_dot_proto_dot_clusters__pb2._CLUSTERCONFIG
...
_ORDEREDJOB.fields_by_name['hadoop_job'].message_type = google_dot_cloud_dot_dataproc__v1_dot_proto_dot_jobs__pb2._HADOOPJOB
_ORDEREDJOB.fields_by_name['spark_job'].message_type = google_dot_cloud_dot_dataproc__v1_dot_proto_dot_jobs__pb2._SPARKJOB
_ORDEREDJOB.fields_by_name['pyspark_job'].message_type = google_dot_cloud_dot_dataproc__v1_dot_proto_dot_jobs__pb2._PYSPARKJOB
_ORDEREDJOB.fields_by_name['hive_job'].message_type = google_dot_cloud_dot_dataproc__v1_dot_proto_dot_jobs__pb2._HIVEJOB
_ORDEREDJOB.fields_by_name['pig_job'].message_type = google_dot_cloud_dot_dataproc__v1_dot_proto_dot_jobs__pb2._PIGJOB
_ORDEREDJOB.fields_by_name['spark_sql_job'].message_type = google_dot_cloud_dot_dataproc__v1_dot_proto_dot_jobs__pb2._SPARKSQLJOB
_ORDEREDJOB.fields_by_name['labels'].message_type = _ORDEREDJOB_LABELSENTRY
_ORDEREDJOB.fields_by_name['scheduling'].message_type = google_dot_cloud_dot_dataproc__v1_dot_proto_dot_jobs__pb2._JOBSCHEDULING
...
_WORKFLOWTEMPLATESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\202\001\"5/v1/{parent=projects/*/locations/*}/workflowTemplates:\010templateZ?\"3/v1/{parent=projects/*/regions/*}/workflowTemplates:\010template')),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=_WORKFLOWTEMPLATE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002n\0225/v1/{name=projects/*/locations/*/workflowTemplates/*}Z5\0223/v1/{name=projects/*/regions/*/workflowTemplates/*}')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\214\001\"A/v1/{name=projects/*/locations/*/workflowTemplates/*}:instantiate:\001*ZD\"?/v1/{name=projects/*/regions/*/workflowTemplates/*}:instantiate:\001*')),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\246\001\"G/v1/{parent=projects/*/locations/*}/workflowTemplates:instantiateInline:\010templateZQ\"E/v1/{parent=projects/*/regions/*}/workflowTemplates:instantiateInline:\010template')),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=_WORKFLOWTEMPLATE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\224\001\032>/v1/{template.name=projects/*/locations/*/workflowTemplates/*}:\010templateZH\032</v1/{template.name=projects/*/regions/*/workflowTemplates/*}:\010template')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002n\0225/v1/{parent=projects/*/locations/*}/workflowTemplatesZ5\0223/v1/{parent=projects/*/regions/*}/workflowTemplates')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002n*5/v1/{name=projects/*/locations/*/workflowTemplates/*}Z5*3/v1/{name=projects/*/regions/*/workflowTemplates/*}')),
  ),
])

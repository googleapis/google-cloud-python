...
class ClusterControllerClient(object):
    ...
    def __init__(self,
        ...
        self.cluster_controller_stub = (
            clusters_pb2.ClusterControllerStub(channel))
        ...
        self._create_cluster = google.api_core.gapic_v1.method.wrap_method(
            self.cluster_controller_stub.CreateCluster,
        ...
        self._update_cluster = google.api_core.gapic_v1.method.wrap_method(
            self.cluster_controller_stub.UpdateCluster,
        ...
        self._delete_cluster = google.api_core.gapic_v1.method.wrap_method(
            self.cluster_controller_stub.DeleteCluster,
        ...
        self._get_cluster = google.api_core.gapic_v1.method.wrap_method(
            self.cluster_controller_stub.GetCluster,
        ...
        self._list_clusters = google.api_core.gapic_v1.method.wrap_method(
            self.cluster_controller_stub.ListClusters,
            default_retry=method_configs['ListClusters'].retry,
            default_timeout=method_configs['ListClusters'].timeout,
            client_info=client_info,
        )
        self._diagnose_cluster = google.api_core.gapic_v1.method.wrap_method(
            self.cluster_controller_stub.DiagnoseCluster,
            default_retry=method_configs['DiagnoseCluster'].retry,
            default_timeout=method_configs['DiagnoseCluster'].timeout,
            client_info=client_info,
        )
    ...
    def create_cluster(self,
        ...
        operation = self._create_cluster(request, retry=retry, timeout=timeout)
    ...
    def delete_cluster(self,
        ...
        operation = self._delete_cluster(request, retry=retry, timeout=timeout)
        return google.api_core.operation.from_gapic(
            operation,
            self.operations_client,
            empty_pb2.Empty,
    ...
    def list_clusters(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            ...
            method=functools.partial(
                self._list_clusters, retry=retry, timeout=timeout),
            request=request,
    ...
    def diagnose_cluster(self,
        ...
        operation = self._diagnose_cluster(

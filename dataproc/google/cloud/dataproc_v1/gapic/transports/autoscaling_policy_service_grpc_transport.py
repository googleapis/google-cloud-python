...
class AutoscalingPolicyServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.cloud.dataproc.v1 AutoscalingPolicyService API.
    ...
    def get_autoscaling_policy(self):
        """Return the gRPC stub for :meth:`AutoscalingPolicyServiceClient.get_autoscaling_policy`.
    ...
    def list_autoscaling_policies(self):
        """Return the gRPC stub for :meth:`AutoscalingPolicyServiceClient.list_autoscaling_policies`.
    ...
    def delete_autoscaling_policy(self):
        """Return the gRPC stub for :meth:`AutoscalingPolicyServiceClient.delete_autoscaling_policy`.

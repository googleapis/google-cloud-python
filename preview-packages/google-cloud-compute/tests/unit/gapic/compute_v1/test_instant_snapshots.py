...
from google.cloud.compute_v1.services.instant_snapshots import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        InstantSnapshotsClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        InstantSnapshotsClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        InstantSnapshotsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        InstantSnapshotsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
...
def test__read_environment_variables():
    assert InstantSnapshotsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert InstantSnapshotsClient._read_environment_variables() == (
            True,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert InstantSnapshotsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert InstantSnapshotsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                InstantSnapshotsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert InstantSnapshotsClient._get_client_cert_source(None, False) is None
    assert (
        InstantSnapshotsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        InstantSnapshotsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                InstantSnapshotsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                InstantSnapshotsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(InstantSnapshotsClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = InstantSnapshotsClient._DEFAULT_UNIVERSE
    default_endpoint = InstantSnapshotsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = InstantSnapshotsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == InstantSnapshotsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        InstantSnapshotsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        InstantSnapshotsClient._get_api_endpoint(None, None, default_universe, "always")
        == InstantSnapshotsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        InstantSnapshotsClient._get_api_endpoint(
    ...
    assert (
        InstantSnapshotsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        InstantSnapshotsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        InstantSnapshotsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        InstantSnapshotsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        InstantSnapshotsClient._get_universe_domain(None, None)
        == InstantSnapshotsClient._DEFAULT_UNIVERSE
    )
...
@pytest.mark.parametrize(
    ...
    [
        (InstantSnapshotsClient, "rest"),
    ],
)
def test_instant_snapshots_client_from_service_account_info(
    client_class, transport_name
):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.InstantSnapshotsRestTransport, "rest"),
    ],
)
def test_instant_snapshots_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_instant_snapshots_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_instant_snapshots_client_get_transport_class():
    transport = InstantSnapshotsClient.get_transport_class()
    available_transports = [
        transports.InstantSnapshotsRestTransport,
    ]
    assert transport in available_transports

    transport = InstantSnapshotsClient.get_transport_class("rest")
    assert transport == transports.InstantSnapshotsRestTransport


@pytest.mark.parametrize(
    "client_class,transport_class,transport_name",
    [
        (InstantSnapshotsClient, transports.InstantSnapshotsRestTransport, "rest"),
    ],
)
@mock.patch.object(
    InstantSnapshotsClient,
...
def test_instant_snapshots_client_client_options(
    client_class, transport_class, transport_name
):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(InstantSnapshotsClient, "get_transport_class") as gtc:
...
def test_instant_snapshots_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize("client_class", [InstantSnapshotsClient])
@mock.patch.object(
    InstantSnapshotsClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(InstantSnapshotsClient),
)
def test_instant_snapshots_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_instant_snapshots_client_client_api_endpoint(client_class):
...
def test_instant_snapshots_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_instant_snapshots_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_aggregated_list_rest_required_fields(
    request_type=compute.AggregatedListInstantSnapshotsRequest,
):
    transport_class = transports.InstantSnapshotsRestTransport
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = compute.InstantSnapshotAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.InstantSnapshotsRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/instantSnapshots"
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            compute.InstantSnapshotAggregatedList(
                items={
                    "a": compute.InstantSnapshotsScopedList(),
            ...
            compute.InstantSnapshotAggregatedList(
                items={
                    "g": compute.InstantSnapshotsScopedList(),
                },
                next_page_token="ghi",
            ),
            compute.InstantSnapshotAggregatedList(
                items={
                    "h": compute.InstantSnapshotsScopedList(),
                    "i": compute.InstantSnapshotsScopedList(),
                },
            ),
        )
        ...
        response = tuple(
            compute.InstantSnapshotAggregatedList.to_json(x) for x in response
        )
        ...
        for result in results:
            ...
            assert tuple(type(t) for t in result) == (
                str,
                compute.InstantSnapshotsScopedList,
            )

        assert pager.get("a") is None
        assert isinstance(pager.get("h"), compute.InstantSnapshotsScopedList)
...
def test_delete_rest_required_fields(request_type=compute.DeleteInstantSnapshotRequest):
    transport_class = transports.InstantSnapshotsRestTransport
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/instantSnapshots/{instant_snapshot}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_unary_rest_required_fields(
    request_type=compute.DeleteInstantSnapshotRequest,
):
    transport_class = transports.InstantSnapshotsRestTransport
...
def test_get_rest_required_fields(request_type=compute.GetInstantSnapshotRequest):
    transport_class = transports.InstantSnapshotsRestTransport
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/instantSnapshots/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_required_fields(request_type=compute.InsertInstantSnapshotRequest):
    transport_class = transports.InstantSnapshotsRestTransport
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/instantSnapshots"
            % client.transport._host,
            args[1],
        )
...
def test_insert_unary_rest_required_fields(
    request_type=compute.InsertInstantSnapshotRequest,
):
    transport_class = transports.InstantSnapshotsRestTransport
...
def test_list_rest_required_fields(request_type=compute.ListInstantSnapshotsRequest):
    transport_class = transports.InstantSnapshotsRestTransport
...
def test_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.InstantSnapshot) for i in results)
...
def test_set_iam_policy_rest_required_fields(
    request_type=compute.SetIamPolicyInstantSnapshotRequest,
):
    transport_class = transports.InstantSnapshotsRestTransport
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/instantSnapshots/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_rest_required_fields(
    request_type=compute.SetLabelsInstantSnapshotRequest,
):
    transport_class = transports.InstantSnapshotsRestTransport
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/instantSnapshots/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/instantSnapshots/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.InstantSnapshotsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.InstantSnapshotsRestInterceptor(),
    )
    client = InstantSnapshotsClient(transport=transport)
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InstantSnapshotAggregatedList.to_json(
            compute.InstantSnapshotAggregatedList()
        )
...
def test_insert_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2"}
    request_init["instant_snapshot_resource"] = {
        "architecture": "architecture_value",
        "creation_timestamp": "creation_timestamp_value",
        "description": "description_value",
        "disk_size_gb": 1261,
    ...
    test_field = compute.InsertInstantSnapshotRequest.meta.fields[
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyInstantSnapshotRequest.meta.fields[
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsInstantSnapshotRequest.meta.fields[
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsInstantSnapshotRequest.meta.fields[
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.aggregated_list), "__call__") as call:
        ...
        request_msg = compute.AggregatedListInstantSnapshotsRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteInstantSnapshotRequest()
        assert args[0] == request_msg
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetInstantSnapshotRequest()
        assert args[0] == request_msg
...
def test_get_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetIamPolicyInstantSnapshotRequest()
        assert args[0] == request_msg
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertInstantSnapshotRequest()
        assert args[0] == request_msg
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListInstantSnapshotsRequest()
        assert args[0] == request_msg
...
def test_set_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.set_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetIamPolicyInstantSnapshotRequest()
        assert args[0] == request_msg
...
def test_set_labels_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.set_labels), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetLabelsInstantSnapshotRequest()
        assert args[0] == request_msg
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsInstantSnapshotRequest()
        assert args[0] == request_msg


def test_instant_snapshots_base_transport_error():
...
def test_instant_snapshots_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.instant_snapshots.transports.InstantSnapshotsTransport.__init__"
    ) as Transport:
...
def test_instant_snapshots_auth_adc():
...
def test_instant_snapshots_http_transport_client_cert_source_for_mtls():
...
def test_instant_snapshots_host_no_port(transport_name):
    client = InstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_instant_snapshots_host_with_port(transport_name):
    client = InstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
...
def test_instant_snapshots_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = InstantSnapshotsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = InstantSnapshotsClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_common_billing_account_path():
    ...
    actual = InstantSnapshotsClient.common_billing_account_path(billing_account)
...
def test_parse_common_billing_account_path():
    ...
    path = InstantSnapshotsClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = InstantSnapshotsClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = InstantSnapshotsClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = InstantSnapshotsClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = InstantSnapshotsClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = InstantSnapshotsClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = InstantSnapshotsClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = InstantSnapshotsClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = InstantSnapshotsClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = InstantSnapshotsClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = InstantSnapshotsClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = InstantSnapshotsClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = InstantSnapshotsClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = InstantSnapshotsClient.parse_common_location_path(path)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.InstantSnapshotsTransport, "_prep_wrapped_messages"
    ) as prep:
        client = InstantSnapshotsClient(
            credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        transport_class = InstantSnapshotsClient.get_transport_class()
...
@pytest.mark.parametrize(
    ...
    [
        (InstantSnapshotsClient, transports.InstantSnapshotsRestTransport),
    ],
)

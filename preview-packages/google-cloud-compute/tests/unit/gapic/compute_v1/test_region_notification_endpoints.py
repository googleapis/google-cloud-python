...
from google.cloud.compute_v1.services.region_notification_endpoints import (
...
def test__get_default_mtls_endpoint():
    ...
    assert RegionNotificationEndpointsClient._get_default_mtls_endpoint(None) is None
    assert (
        RegionNotificationEndpointsClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        RegionNotificationEndpointsClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        RegionNotificationEndpointsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        RegionNotificationEndpointsClient._get_default_mtls_endpoint(
            sandbox_mtls_endpoint
        )
        == sandbox_mtls_endpoint
    )
    assert (
        RegionNotificationEndpointsClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        RegionNotificationEndpointsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert RegionNotificationEndpointsClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                RegionNotificationEndpointsClient._read_environment_variables()
            assert (
                str(excinfo.value)
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                RegionNotificationEndpointsClient._use_client_cert_effective() is True
            )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                RegionNotificationEndpointsClient._use_client_cert_effective() is False
            )
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                RegionNotificationEndpointsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        RegionNotificationEndpointsClient._get_client_cert_source(None, False) is None
    )
    assert (
        RegionNotificationEndpointsClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                RegionNotificationEndpointsClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(RegionNotificationEndpointsClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionNotificationEndpointsClient._DEFAULT_UNIVERSE
    default_endpoint = (
        RegionNotificationEndpointsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
            UNIVERSE_DOMAIN=default_universe
        )
    )
    mock_universe = "bar.com"
    mock_endpoint = RegionNotificationEndpointsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        RegionNotificationEndpointsClient._get_api_endpoint(
    ...
    assert (
        ...
        == RegionNotificationEndpointsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        RegionNotificationEndpointsClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        RegionNotificationEndpointsClient._get_universe_domain(
    ...
    assert (
        RegionNotificationEndpointsClient._get_universe_domain(None, None)
        == RegionNotificationEndpointsClient._DEFAULT_UNIVERSE
    )

    with pytest.raises(ValueError) as excinfo:
        RegionNotificationEndpointsClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = RegionNotificationEndpointsClient(credentials=cred)
...
def test_region_notification_endpoints_client_get_transport_class():
    transport = RegionNotificationEndpointsClient.get_transport_class()
    available_transports = [
        transports.RegionNotificationEndpointsRestTransport,
    ]
    assert transport in available_transports

    transport = RegionNotificationEndpointsClient.get_transport_class("rest")
    assert transport == transports.RegionNotificationEndpointsRestTransport
...
def test_region_notification_endpoints_client_client_options(
    client_class, transport_class, transport_name
):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(
        RegionNotificationEndpointsClient, "get_transport_class"
    ) as gtc:
...
def test_region_notification_endpoints_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize("client_class", [RegionNotificationEndpointsClient])
@mock.patch.object(
    RegionNotificationEndpointsClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(RegionNotificationEndpointsClient),
)
def test_region_notification_endpoints_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
    mock_client_cert_source = mock.Mock()
...
def test_region_notification_endpoints_client_client_api_endpoint(client_class):
...
def test_region_notification_endpoints_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_region_notification_endpoints_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_aggregated_list_rest_required_fields(
    request_type=compute.AggregatedListRegionNotificationEndpointsRequest,
):
    ...
    return_value = compute.NotificationEndpointAggregatedList()
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = compute.NotificationEndpointAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/notificationEndpoints"
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            compute.NotificationEndpointAggregatedList(
                items={
                    "a": compute.NotificationEndpointsScopedList(),
                    "b": compute.NotificationEndpointsScopedList(),
                    "c": compute.NotificationEndpointsScopedList(),
                },
                next_page_token="abc",
            ),
            compute.NotificationEndpointAggregatedList(
            ...
            compute.NotificationEndpointAggregatedList(
                items={
                    "g": compute.NotificationEndpointsScopedList(),
                },
                next_page_token="ghi",
            ),
            compute.NotificationEndpointAggregatedList(
                items={
                    "h": compute.NotificationEndpointsScopedList(),
                    "i": compute.NotificationEndpointsScopedList(),
                },
            ),
        )
        ...
        response = tuple(
            compute.NotificationEndpointAggregatedList.to_json(x) for x in response
        )
        ...
        assert isinstance(pager.get("a"), compute.NotificationEndpointsScopedList)
        ...
        for result in results:
            ...
            assert tuple(type(t) for t in result) == (
                str,
                compute.NotificationEndpointsScopedList,
            )

        assert pager.get("a") is None
        assert isinstance(pager.get("h"), compute.NotificationEndpointsScopedList)
...
def test_get_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.NotificationEndpoint.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_rest_required_fields(
    ...
    # Designate an appropriate value for the returned response.
    return_value = compute.NotificationEndpointList()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.NotificationEndpointList.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(compute.NotificationEndpointList.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.NotificationEndpoint) for i in results)
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsRegionNotificationEndpointRequest,
):
    transport_class = transports.RegionNotificationEndpointsRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/notificationEndpoints/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.RegionNotificationEndpointsRestInterceptor,
            "post_aggregated_list",
        ) as post,
        mock.patch.object(
            transports.RegionNotificationEndpointsRestInterceptor,
        ...
        mock.patch.object(
            transports.RegionNotificationEndpointsRestInterceptor, "pre_aggregated_list"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListRegionNotificationEndpointsRequest.pb(
            compute.AggregatedListRegionNotificationEndpointsRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NotificationEndpointAggregatedList.to_json(
            compute.NotificationEndpointAggregatedList()
        )
        req.return_value.content = return_value

        request = compute.AggregatedListRegionNotificationEndpointsRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
        pre.return_value = request, metadata
        post.return_value = compute.NotificationEndpointAggregatedList()
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteRegionNotificationEndpointRequest.pb(
            compute.DeleteRegionNotificationEndpointRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRegionNotificationEndpointRequest.pb(
            compute.GetRegionNotificationEndpointRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NotificationEndpoint.to_json(
            compute.NotificationEndpoint()
        )
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.NotificationEndpoint(), metadata
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertRegionNotificationEndpointRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["notification_endpoint_resource"][field])
                ):
                    del request_init["notification_endpoint_resource"][field][i][
                        subfield
                    ]
            else:
                del request_init["notification_endpoint_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertRegionNotificationEndpointRequest.pb(
            compute.InsertRegionNotificationEndpointRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionNotificationEndpointsRestInterceptor, "post_list"
        ) as post,
        mock.patch.object(
            transports.RegionNotificationEndpointsRestInterceptor,
        ...
        mock.patch.object(
            transports.RegionNotificationEndpointsRestInterceptor, "pre_list"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListRegionNotificationEndpointsRequest.pb(
            compute.ListRegionNotificationEndpointsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NotificationEndpointList.to_json(
            compute.NotificationEndpointList()
        )
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.NotificationEndpointList(), metadata
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = (
        compute.TestIamPermissionsRegionNotificationEndpointRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRegionNotificationEndpointRequest.pb(
            compute.TestIamPermissionsRegionNotificationEndpointRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        request = compute.TestIamPermissionsRegionNotificationEndpointRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.aggregated_list), "__call__") as call:
        ...
        request_msg = compute.AggregatedListRegionNotificationEndpointsRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteRegionNotificationEndpointRequest()
        assert args[0] == request_msg
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetRegionNotificationEndpointRequest()
        assert args[0] == request_msg
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertRegionNotificationEndpointRequest()
        assert args[0] == request_msg
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListRegionNotificationEndpointsRequest()
        assert args[0] == request_msg
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsRegionNotificationEndpointRequest()
        assert args[0] == request_msg
...
def test_region_notification_endpoints_base_transport():
    # Instantiate the base transport.
    with mock.patch(
        "google.cloud.compute_v1.services.region_notification_endpoints.transports.RegionNotificationEndpointsTransport.__init__"
    ) as Transport:
...
def test_region_notification_endpoints_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.compute_v1.services.region_notification_endpoints.transports.RegionNotificationEndpointsTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_region_notification_endpoints_auth_adc():
...
def test_region_notification_endpoints_client_transport_session_collision(
    transport_name,
):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = RegionNotificationEndpointsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = RegionNotificationEndpointsClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_common_billing_account_path():
    ...
    actual = RegionNotificationEndpointsClient.common_billing_account_path(
        billing_account
    )
...
def test_parse_common_billing_account_path():
    ...
    path = RegionNotificationEndpointsClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionNotificationEndpointsClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = RegionNotificationEndpointsClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionNotificationEndpointsClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = RegionNotificationEndpointsClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionNotificationEndpointsClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = RegionNotificationEndpointsClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionNotificationEndpointsClient.parse_common_project_path(path)
    assert expected == actual

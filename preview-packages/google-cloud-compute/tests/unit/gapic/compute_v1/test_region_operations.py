...
from google.cloud.compute_v1.services.region_operations import (
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/operations/{operation}"
...
def test_wait_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/operations/{operation}/wait"
            % client.transport._host,
            args[1],
        )
...
def test_region_operations_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.region_operations.transports.RegionOperationsTransport.__init__"
    ) as Transport:
...
def test_region_operations_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.compute_v1.services.region_operations.transports.RegionOperationsTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

...
from google.cloud.compute_v1.services.forwarding_rules import (
...
def test_aggregated_list_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = compute.ForwardingRuleAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ForwardingRuleAggregatedList.to_json(
            compute.ForwardingRuleAggregatedList()
        )
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertForwardingRuleRequest.meta.fields[
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchForwardingRuleRequest.meta.fields[
        "forwarding_rule_resource"
    ]
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsForwardingRuleRequest.meta.fields[
...
def test_set_target_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetTargetForwardingRuleRequest.meta.fields[

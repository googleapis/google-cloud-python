...
def test__get_default_mtls_endpoint():
    ...
    assert (
        MachineTypesClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert MachineTypesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert MachineTypesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                MachineTypesClient._use_client_cert_effective()
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = MachineTypesClient(credentials=cred)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.MachineTypesRestInterceptor, "post_aggregated_list_with_metadata"
        ...
        post_with_metadata.return_value = compute.MachineTypeAggregatedList(), metadata
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.MachineTypesRestInterceptor, "post_get") as post,
        mock.patch.object(
            transports.MachineTypesRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.MachineTypesRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        post_with_metadata.return_value = compute.MachineType(), metadata
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.MachineTypesRestInterceptor, "post_list") as post,
        mock.patch.object(
            transports.MachineTypesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.MachineTypesRestInterceptor, "pre_list") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        post_with_metadata.return_value = compute.MachineTypeList(), metadata

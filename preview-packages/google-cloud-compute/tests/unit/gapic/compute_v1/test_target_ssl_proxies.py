...
def test__get_client_cert_source():
    ...
    assert (
        TargetSslProxiesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        TargetSslProxiesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                TargetSslProxiesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                TargetSslProxiesClient._get_client_cert_source(
...
def test_set_certificate_map_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.set_certificate_map] = (
            mock_rpc
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsTargetSslProxyRequest,
):
    transport_class = transports.TargetSslProxiesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/targetSslProxies/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TargetSslProxiesRestInterceptor, "post_delete_with_metadata"
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TargetSslProxiesRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TargetSslProxiesRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TargetSslProxiesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
...
def test_set_backend_service_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TargetSslProxiesRestInterceptor,
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsTargetSslProxyRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.TargetSslProxiesRestInterceptor, "post_test_iam_permissions"
        ) as post,
        mock.patch.object(
            transports.TargetSslProxiesRestInterceptor,
        ...
        mock.patch.object(
            transports.TargetSslProxiesRestInterceptor, "pre_test_iam_permissions"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsTargetSslProxyRequest.pb(
            compute.TestIamPermissionsTargetSslProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_ssl_policy_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.set_ssl_policy), "__call__") as call:

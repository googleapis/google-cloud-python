...
from google.cloud.compute_v1.services.region_snapshots import (
...
def test__get_client_cert_source():
    ...
    assert (
        RegionSnapshotsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        RegionSnapshotsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                RegionSnapshotsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                RegionSnapshotsClient._get_client_cert_source(
...
def test_region_snapshots_client_from_service_account_info(
    client_class, transport_name
):
...
def test_region_snapshots_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_region_snapshots_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_region_snapshots_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_region_snapshots_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize("client_class", [RegionSnapshotsClient])
@mock.patch.object(
    RegionSnapshotsClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(RegionSnapshotsClient),
)
...
def test_region_snapshots_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_region_snapshots_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/snapshots/{snapshot}"
...
def test_get_iam_policy_rest_required_fields(
    request_type=compute.GetIamPolicyRegionSnapshotRequest,
):
    transport_class = transports.RegionSnapshotsRestTransport
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/snapshots/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/snapshots"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_required_fields(
    request_type=compute.SetIamPolicyRegionSnapshotRequest,
):
    transport_class = transports.RegionSnapshotsRestTransport
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/snapshots/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_rest_required_fields(
    request_type=compute.SetLabelsRegionSnapshotRequest,
):
    transport_class = transports.RegionSnapshotsRestTransport
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/snapshots/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/snapshots/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_update_kms_key_rest_required_fields(
    request_type=compute.UpdateKmsKeyRegionSnapshotRequest,
):
    transport_class = transports.RegionSnapshotsRestTransport
...
def test_update_kms_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            ...
            region="region_value",
            snapshot="snapshot_value",
            region_snapshot_update_kms_key_request_resource=compute.RegionSnapshotUpdateKmsKeyRequest(
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/snapshots/{snapshot}/updateKmsKey"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.RegionSnapshotsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.RegionSnapshotsRestInterceptor(),
    )
    client = RegionSnapshotsClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_delete"
        ) as post,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_delete_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "pre_delete"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteRegionSnapshotRequest.pb(
            compute.DeleteRegionSnapshotRequest()
        )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_get"
        ) as post,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRegionSnapshotRequest.pb(
            compute.GetRegionSnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_get_iam_policy"
        ) as post,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor,
            "post_get_iam_policy_with_metadata",
        ) as post_with_metadata,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "pre_get_iam_policy"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyRegionSnapshotRequest.pb(
            compute.GetIamPolicyRegionSnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_insert"
        ) as post,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "pre_insert"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertRegionSnapshotRequest.pb(
            compute.InsertRegionSnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_list"
        ) as post,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListRegionSnapshotsRequest.pb(
            compute.ListRegionSnapshotsRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyRegionSnapshotRequest.meta.fields[
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_set_iam_policy"
        ) as post,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor,
        ...
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "pre_set_iam_policy"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyRegionSnapshotRequest.pb(
            compute.SetIamPolicyRegionSnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsRegionSnapshotRequest.meta.fields[
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_set_labels"
        ) as post,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_set_labels_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "pre_set_labels"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetLabelsRegionSnapshotRequest.pb(
            compute.SetLabelsRegionSnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsRegionSnapshotRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_test_iam_permissions"
        ) as post,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor,
        ...
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "pre_test_iam_permissions"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRegionSnapshotRequest.pb(
            compute.TestIamPermissionsRegionSnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_kms_key_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "snapshot": "sample3"}
    request_init["region_snapshot_update_kms_key_request_resource"] = {
        "kms_key_name": "kms_key_name_value"
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.UpdateKmsKeyRegionSnapshotRequest.meta.fields[
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    ...
                    del request_init["region_snapshot_update_kms_key_request_resource"][
                        field
                    ][i][subfield]
            else:
                del request_init["region_snapshot_update_kms_key_request_resource"][
...
def test_update_kms_key_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "post_update_kms_key"
        ) as post,
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor,
        ...
        mock.patch.object(
            transports.RegionSnapshotsRestInterceptor, "pre_update_kms_key"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.UpdateKmsKeyRegionSnapshotRequest.pb(
            compute.UpdateKmsKeyRegionSnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        request = compute.UpdateKmsKeyRegionSnapshotRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_update_kms_key_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.update_kms_key), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.UpdateKmsKeyRegionSnapshotRequest()
        assert args[0] == request_msg
...
def test_region_snapshots_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.region_snapshots.transports.RegionSnapshotsTransport.__init__"
    ) as Transport:
...
def test_region_snapshots_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.compute_v1.services.region_snapshots.transports.RegionSnapshotsTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.RegionSnapshotsTransport, "_prep_wrapped_messages"
    ) as prep:
        client = RegionSnapshotsClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        InterconnectAttachmentsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert InterconnectAttachmentsClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                InterconnectAttachmentsClient._read_environment_variables()
            assert (
                str(excinfo.value)
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert InterconnectAttachmentsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert InterconnectAttachmentsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                InterconnectAttachmentsClient._use_client_cert_effective()
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": ""}):
            with mock.patch.dict(os.environ, {"GOOGLE_API_CERTIFICATE_CONFIG": ""}):
                assert (
                    InterconnectAttachmentsClient._use_client_cert_effective() is False
                )
...
def test__get_client_cert_source():
    ...
    assert InterconnectAttachmentsClient._get_client_cert_source(None, False) is None
    assert (
        InterconnectAttachmentsClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                InterconnectAttachmentsClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(InterconnectAttachmentsClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = InterconnectAttachmentsClient._DEFAULT_UNIVERSE
    default_endpoint = InterconnectAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = InterconnectAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        InterconnectAttachmentsClient._get_api_endpoint(
    ...
    assert (
        ...
        == InterconnectAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        InterconnectAttachmentsClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        InterconnectAttachmentsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        InterconnectAttachmentsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        InterconnectAttachmentsClient._get_universe_domain(None, None)
        == InterconnectAttachmentsClient._DEFAULT_UNIVERSE
    )

    with pytest.raises(ValueError) as excinfo:
        InterconnectAttachmentsClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = InterconnectAttachmentsClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (InterconnectAttachmentsClient, "rest"),
    ],
)
...
def test_interconnect_attachments_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_interconnect_attachments_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
    mock_client_cert_source = mock.Mock()
...
def test_interconnect_attachments_client_client_api_endpoint(client_class):
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/interconnectAttachments"
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            compute.InterconnectAttachmentAggregatedList(
                items={
                    "a": compute.InterconnectAttachmentsScopedList(),
                    "b": compute.InterconnectAttachmentsScopedList(),
                    "c": compute.InterconnectAttachmentsScopedList(),
                },
                next_page_token="abc",
            ),
            compute.InterconnectAttachmentAggregatedList(
            ...
            compute.InterconnectAttachmentAggregatedList(
                items={
                    "g": compute.InterconnectAttachmentsScopedList(),
                },
                next_page_token="ghi",
            ),
            compute.InterconnectAttachmentAggregatedList(
                items={
                    "h": compute.InterconnectAttachmentsScopedList(),
                    "i": compute.InterconnectAttachmentsScopedList(),
                },
            ),
        )
        ...
        response = tuple(
            compute.InterconnectAttachmentAggregatedList.to_json(x) for x in response
        )
        ...
        for result in results:
            ...
            assert tuple(type(t) for t in result) == (
                str,
                compute.InterconnectAttachmentsScopedList,
            )
...
def test_set_labels_rest_required_fields(
    request_type=compute.SetLabelsInterconnectAttachmentRequest,
):
    transport_class = transports.InterconnectAttachmentsRestTransport
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/interconnectAttachments/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.InterconnectAttachmentsRestInterceptor, "post_aggregated_list"
        ) as post,
        mock.patch.object(
            transports.InterconnectAttachmentsRestInterceptor,
            "post_aggregated_list_with_metadata",
        ) as post_with_metadata,
        mock.patch.object(
            transports.InterconnectAttachmentsRestInterceptor, "pre_aggregated_list"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListInterconnectAttachmentsRequest.pb(
            compute.AggregatedListInterconnectAttachmentsRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectAttachmentAggregatedList.to_json(
            compute.InterconnectAttachmentAggregatedList()
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteInterconnectAttachmentRequest.pb(
            compute.DeleteInterconnectAttachmentRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_rest_bad_request(request_type=compute.GetInterconnectAttachmentRequest):
    client = InterconnectAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.InterconnectAttachmentsRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetInterconnectAttachmentRequest.pb(
            compute.GetInterconnectAttachmentRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectAttachment.to_json(
            compute.InterconnectAttachment()
        )
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.InterconnectAttachment(), metadata
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["interconnect_attachment_resource"] = {
        ...
        "candidate_subnets": ["candidate_subnets_value1", "candidate_subnets_value2"],
        "cloud_router_ip_address": "cloud_router_ip_address_value",
        "cloud_router_ipv6_address": "cloud_router_ipv6_address_value",
        "cloud_router_ipv6_interface_id": "cloud_router_ipv6_interface_id_value",
        ...
        "ipsec_internal_addresses": [
            "ipsec_internal_addresses_value1",
    ...
    test_field = compute.InsertInterconnectAttachmentRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["interconnect_attachment_resource"][field])
                ):
                    del request_init["interconnect_attachment_resource"][field][i][
                        subfield
                    ]
            else:
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertInterconnectAttachmentRequest.pb(
            compute.InsertInterconnectAttachmentRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_bad_request(request_type=compute.ListInterconnectAttachmentsRequest):
    client = InterconnectAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.InterconnectAttachmentsRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListInterconnectAttachmentsRequest.pb(
            compute.ListInterconnectAttachmentsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectAttachmentList.to_json(
            compute.InterconnectAttachmentList()
        )
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.InterconnectAttachmentList(), metadata
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchInterconnectAttachmentRequest.meta.fields[
        "interconnect_attachment_resource"
    ]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchInterconnectAttachmentRequest.pb(
            compute.PatchInterconnectAttachmentRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsInterconnectAttachmentRequest.meta.fields[
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.InterconnectAttachmentsRestInterceptor, "post_set_labels"
        ) as post,
        mock.patch.object(
            transports.InterconnectAttachmentsRestInterceptor,
        ...
        mock.patch.object(
            transports.InterconnectAttachmentsRestInterceptor, "pre_set_labels"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetLabelsInterconnectAttachmentRequest.pb(
            compute.SetLabelsInterconnectAttachmentRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.aggregated_list), "__call__") as call:
        ...
        request_msg = compute.AggregatedListInterconnectAttachmentsRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteInterconnectAttachmentRequest()
        assert args[0] == request_msg
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetInterconnectAttachmentRequest()
        assert args[0] == request_msg
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertInterconnectAttachmentRequest()
        assert args[0] == request_msg
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListInterconnectAttachmentsRequest()
        assert args[0] == request_msg
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.patch), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchInterconnectAttachmentRequest()
        assert args[0] == request_msg
...
def test_set_labels_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.set_labels), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetLabelsInterconnectAttachmentRequest()
        assert args[0] == request_msg
...
def test_interconnect_attachments_client_transport_session_collision(transport_name):
    ...
    client1 = InterconnectAttachmentsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = InterconnectAttachmentsClient(
        credentials=creds2,
        transport=transport_name,
    )

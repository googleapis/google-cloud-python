...
def test__get_client_cert_source():
    ...
    assert (
        ImagesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    )
    assert (
        ImagesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ImagesClient._get_client_cert_source(None, True)
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImagesRestInterceptor, "post_delete_with_metadata"
...
def test_deprecate_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImagesRestInterceptor, "post_deprecate_with_metadata"
        ) as post_with_metadata,
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImagesRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
...
def test_get_from_family_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImagesRestInterceptor, "post_get_from_family_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImagesRestInterceptor, "post_get_iam_policy_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImagesRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImagesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImagesRestInterceptor, "post_patch_with_metadata"
        ) as post_with_metadata,
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImagesRestInterceptor, "post_set_iam_policy_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImagesRestInterceptor, "post_set_labels_with_metadata"
        ) as post_with_metadata,
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImagesRestInterceptor, "post_test_iam_permissions_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
...
def test_get_from_family_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.get_from_family), "__call__") as call:

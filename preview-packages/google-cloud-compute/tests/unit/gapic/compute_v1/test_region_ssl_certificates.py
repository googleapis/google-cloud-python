...
def test__get_default_mtls_endpoint():
    ...
    assert (
        RegionSslCertificatesClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert RegionSslCertificatesClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert RegionSslCertificatesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert RegionSslCertificatesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                RegionSslCertificatesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        RegionSslCertificatesClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                RegionSslCertificatesClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(RegionSslCertificatesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionSslCertificatesClient._DEFAULT_UNIVERSE
    default_endpoint = RegionSslCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = RegionSslCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        RegionSslCertificatesClient._get_api_endpoint(
    ...
    assert (
        ...
        == RegionSslCertificatesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        RegionSslCertificatesClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        RegionSslCertificatesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        RegionSslCertificatesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        RegionSslCertificatesClient._get_universe_domain(None, None)
        == RegionSslCertificatesClient._DEFAULT_UNIVERSE
    )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.RegionSslCertificatesRestInterceptor, "post_delete_with_metadata"
        ...
        pb_message = compute.DeleteRegionSslCertificateRequest.pb(
            compute.DeleteRegionSslCertificateRequest()
        )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.RegionSslCertificatesRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRegionSslCertificateRequest.pb(
            compute.GetRegionSslCertificateRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["ssl_certificate_resource"] = {
        ...
        "subject_alternative_names": [
            "subject_alternative_names_value1",
            "subject_alternative_names_value2",
        ],
        "type_": "type__value",
    }
    ...
    test_field = compute.InsertRegionSslCertificateRequest.meta.fields[
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.RegionSslCertificatesRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertRegionSslCertificateRequest.pb(
            compute.InsertRegionSslCertificateRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.RegionSslCertificatesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListRegionSslCertificatesRequest.pb(
            compute.ListRegionSslCertificatesRequest()
        )
        transcode.return_value = {
            "method": "post",

...
from google.cloud.compute_v1.services.backend_services import (
...
def test__read_environment_variables():
    assert BackendServicesClient._read_environment_variables() == (False, "auto", None)
...
def test__get_client_cert_source():
    ...
    assert BackendServicesClient._get_client_cert_source(None, False) is None
    assert (
        BackendServicesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        BackendServicesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                BackendServicesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                BackendServicesClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(BackendServicesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BackendServicesClient._DEFAULT_UNIVERSE
    default_endpoint = BackendServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = BackendServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == BackendServicesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        BackendServicesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        BackendServicesClient._get_api_endpoint(None, None, default_universe, "always")
        == BackendServicesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        BackendServicesClient._get_api_endpoint(
    ...
    assert (
        BackendServicesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        BackendServicesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        BackendServicesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        BackendServicesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        BackendServicesClient._get_universe_domain(None, None)
        == BackendServicesClient._DEFAULT_UNIVERSE
    )
...
def test_backend_services_client_client_api_endpoint(client_class):
...
def test_get_iam_policy_rest_required_fields(
    request_type=compute.GetIamPolicyBackendServiceRequest,
):
    transport_class = transports.BackendServicesRestTransport
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/backendServices/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_list_usable_rest_required_fields(
    request_type=compute.ListUsableBackendServicesRequest,
):
    transport_class = transports.BackendServicesRestTransport
...
def test_list_usable_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/backendServices/listUsable"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/backendServices/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsBackendServiceRequest,
):
    transport_class = transports.BackendServicesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/backendServices/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_add_signed_url_key_rest_call_success(request_type):
    ...
    test_field = compute.AddSignedUrlKeyBackendServiceRequest.meta.fields[
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.BackendServiceAggregatedList.to_json(
            compute.BackendServiceAggregatedList()
        )
        req.return_value.content = return_value
...
def test_get_health_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.GetHealthBackendServiceRequest.meta.fields[
...
def test_insert_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.InsertBackendServiceRequest.meta.fields[
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchBackendServiceRequest.meta.fields[
        "backend_service_resource"
    ]
...
def test_set_edge_security_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetEdgeSecurityPolicyBackendServiceRequest.meta.fields[
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyBackendServiceRequest.meta.fields[
...
def test_set_security_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetSecurityPolicyBackendServiceRequest.meta.fields[
        "security_policy_reference_resource"
    ]
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsBackendServiceRequest.meta.fields[
...
def test_update_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.UpdateBackendServiceRequest.meta.fields[
        "backend_service_resource"
    ]

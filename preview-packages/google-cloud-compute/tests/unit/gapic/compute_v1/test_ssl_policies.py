...
from google.cloud.compute_v1.services.ssl_policies import (
    SslPoliciesClient,
    pagers,
    transports,
)
...
def test__get_client_cert_source():
    ...
    assert SslPoliciesClient._get_client_cert_source(None, False) is None
    assert (
        SslPoliciesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        SslPoliciesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SslPoliciesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                SslPoliciesClient._get_client_cert_source(
...
@pytest.mark.parametrize(
    ...
    [
        (transports.SslPoliciesRestTransport, "rest"),
    ],
)
...
def test_ssl_policies_client_get_transport_class():
    ...
    available_transports = [
        transports.SslPoliciesRestTransport,
    ]
...
def test_ssl_policies_client_client_options(
    client_class, transport_class, transport_name
):
...
@pytest.mark.parametrize(
    ...
    [
        (SslPoliciesClient, transports.SslPoliciesRestTransport, "rest", "true"),
        (SslPoliciesClient, transports.SslPoliciesRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(
    SslPoliciesClient,
...
def test_ssl_policies_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    SslPoliciesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SslPoliciesClient)
)
...
def test_ssl_policies_client_client_api_endpoint(client_class):
...
def test_ssl_policies_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_aggregated_list_rest_required_fields(
    request_type=compute.AggregatedListSslPoliciesRequest,
):
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/sslPolicies"
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            compute.SslPoliciesAggregatedList(
                items={
                    "a": compute.SslPoliciesScopedList(),
                    "b": compute.SslPoliciesScopedList(),
                    "c": compute.SslPoliciesScopedList(),
                },
                next_page_token="abc",
            ),
            compute.SslPoliciesAggregatedList(
            ...
            compute.SslPoliciesAggregatedList(
                items={
                    "g": compute.SslPoliciesScopedList(),
                },
                next_page_token="ghi",
            ),
            compute.SslPoliciesAggregatedList(
                items={
                    "h": compute.SslPoliciesScopedList(),
                    "i": compute.SslPoliciesScopedList(),
                },
            ),
        )
...
def test_list_available_features_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SslPoliciesClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_available_features
...
def test_list_available_features_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.SslPoliciesListAvailableFeaturesResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SslPoliciesAggregatedList.to_json(
            compute.SslPoliciesAggregatedList()
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.SslPoliciesRestInterceptor, "post_delete") as post,
        mock.patch.object(
            transports.SslPoliciesRestInterceptor, "post_delete_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.SslPoliciesRestInterceptor, "pre_delete") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.SslPoliciesRestInterceptor, "post_get") as post,
        mock.patch.object(
            transports.SslPoliciesRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.SslPoliciesRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SslPolicy.to_json(compute.SslPolicy())
        req.return_value.content = return_value
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["ssl_policy_resource"] = {
        "creation_timestamp": "creation_timestamp_value",
        "custom_features": ["custom_features_value1", "custom_features_value2"],
        "description": "description_value",
        "enabled_features": ["enabled_features_value1", "enabled_features_value2"],
        "fingerprint": "fingerprint_value",
        "id": 205,
        "kind": "kind_value",
        "min_tls_version": "min_tls_version_value",
    ...
    for field, value in request_init["ssl_policy_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.SslPoliciesRestInterceptor, "post_insert") as post,
        mock.patch.object(
            transports.SslPoliciesRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.SslPoliciesRestInterceptor, "pre_insert") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.SslPoliciesRestInterceptor, "post_list") as post,
        mock.patch.object(
            transports.SslPoliciesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.SslPoliciesRestInterceptor, "pre_list") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SslPoliciesList.to_json(compute.SslPoliciesList())
        req.return_value.content = return_value
...
def test_list_available_features_rest_call_success(request_type):
    client = SslPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_list_available_features_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SslPoliciesListAvailableFeaturesResponse.to_json(
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.SslPoliciesRestInterceptor, "post_patch") as post,
        mock.patch.object(
            transports.SslPoliciesRestInterceptor, "post_patch_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.SslPoliciesRestInterceptor, "pre_patch") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.aggregated_list), "__call__") as call:
        ...
        request_msg = compute.AggregatedListSslPoliciesRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteSslPolicyRequest()
        assert args[0] == request_msg
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetSslPolicyRequest()
        assert args[0] == request_msg
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertSslPolicyRequest()
        assert args[0] == request_msg
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListSslPoliciesRequest()
        assert args[0] == request_msg


# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_available_features_empty_call_rest():
    client = SslPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
        type(client.transport.list_available_features), "__call__"
    ) as call:
        client.list_available_features(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListAvailableFeaturesSslPoliciesRequest()
        assert args[0] == request_msg
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.patch), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchSslPolicyRequest()
        assert args[0] == request_msg
...
def test_ssl_policies_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.ssl_policies.transports.SslPoliciesTransport.__init__"
    ) as Transport:
...
def test_ssl_policies_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.compute_v1.services.ssl_policies.transports.SslPoliciesTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_ssl_policies_client_transport_session_collision(transport_name):
    ...
    client1 = SslPoliciesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = SslPoliciesClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.SslPoliciesTransport, "_prep_wrapped_messages"
    ) as prep:
        client = SslPoliciesClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize(
    ...
    [
        (SslPoliciesClient, transports.SslPoliciesRestTransport),
    ],
)

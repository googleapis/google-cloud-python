...
def test__get_default_mtls_endpoint():
    ...
    assert (
        NetworkFirewallPoliciesClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": ""}):
            with mock.patch.dict(os.environ, {"GOOGLE_API_CERTIFICATE_CONFIG": ""}):
                assert (
                    NetworkFirewallPoliciesClient._use_client_cert_effective() is False
                )
...
def test_network_firewall_policies_client_get_transport_class():
    transport = NetworkFirewallPoliciesClient.get_transport_class()
    ...
    assert transport == transports.NetworkFirewallPoliciesRestTransport
...
def test_network_firewall_policies_auth_adc():
...
def test_network_firewall_policies_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = NetworkFirewallPoliciesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = NetworkFirewallPoliciesClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_common_billing_account_path():
    ...
    actual = NetworkFirewallPoliciesClient.common_billing_account_path(billing_account)
...
def test_parse_common_billing_account_path():
    ...
    path = NetworkFirewallPoliciesClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = NetworkFirewallPoliciesClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = NetworkFirewallPoliciesClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = NetworkFirewallPoliciesClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = NetworkFirewallPoliciesClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = NetworkFirewallPoliciesClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = NetworkFirewallPoliciesClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = NetworkFirewallPoliciesClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = NetworkFirewallPoliciesClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = NetworkFirewallPoliciesClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = NetworkFirewallPoliciesClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = NetworkFirewallPoliciesClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = NetworkFirewallPoliciesClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = NetworkFirewallPoliciesClient.parse_common_location_path(path)
    assert expected == actual

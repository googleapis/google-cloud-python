...
from google.cloud.compute_v1.services.target_tcp_proxies import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        TargetTcpProxiesClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert TargetTcpProxiesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert TargetTcpProxiesClient._read_environment_variables() == (
            True,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TargetTcpProxiesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TargetTcpProxiesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                TargetTcpProxiesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert TargetTcpProxiesClient._get_client_cert_source(None, False) is None
    assert (
        TargetTcpProxiesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        TargetTcpProxiesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                TargetTcpProxiesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                TargetTcpProxiesClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(TargetTcpProxiesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TargetTcpProxiesClient._DEFAULT_UNIVERSE
    default_endpoint = TargetTcpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = TargetTcpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        TargetTcpProxiesClient._get_api_endpoint(
    ...
    assert (
        ...
        == TargetTcpProxiesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TargetTcpProxiesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        TargetTcpProxiesClient._get_api_endpoint(None, None, default_universe, "always")
        == TargetTcpProxiesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TargetTcpProxiesClient._get_api_endpoint(
    ...
    assert (
        TargetTcpProxiesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        TargetTcpProxiesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        TargetTcpProxiesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        TargetTcpProxiesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        TargetTcpProxiesClient._get_universe_domain(None, None)
        == TargetTcpProxiesClient._DEFAULT_UNIVERSE
    )

    with pytest.raises(ValueError) as excinfo:
        TargetTcpProxiesClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = TargetTcpProxiesClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (TargetTcpProxiesClient, "rest"),
    ],
)
def test_target_tcp_proxies_client_from_service_account_info(
    client_class, transport_name
):
...
def test_target_tcp_proxies_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_target_tcp_proxies_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_target_tcp_proxies_client_client_api_endpoint(client_class):
...
def test_aggregated_list_rest_required_fields(
    request_type=compute.AggregatedListTargetTcpProxiesRequest,
):
    transport_class = transports.TargetTcpProxiesRestTransport
    ...
    return_value = compute.TargetTcpProxyAggregatedList()
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = compute.TargetTcpProxyAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/targetTcpProxies"
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            compute.TargetTcpProxyAggregatedList(
                items={
                    "a": compute.TargetTcpProxiesScopedList(),
                    "b": compute.TargetTcpProxiesScopedList(),
                    "c": compute.TargetTcpProxiesScopedList(),
                },
                next_page_token="abc",
            ),
            compute.TargetTcpProxyAggregatedList(
            ...
            compute.TargetTcpProxyAggregatedList(
                items={
                    "g": compute.TargetTcpProxiesScopedList(),
                },
                next_page_token="ghi",
            ),
            compute.TargetTcpProxyAggregatedList(
                items={
                    "h": compute.TargetTcpProxiesScopedList(),
                    "i": compute.TargetTcpProxiesScopedList(),
                },
            ),
        )
        ...
        response = tuple(
            compute.TargetTcpProxyAggregatedList.to_json(x) for x in response
        )
        ...
        for result in results:
            ...
            assert tuple(type(t) for t in result) == (
                str,
                compute.TargetTcpProxiesScopedList,
            )

        assert pager.get("a") is None
        assert isinstance(pager.get("h"), compute.TargetTcpProxiesScopedList)
...
def test_delete_rest_required_fields(request_type=compute.DeleteTargetTcpProxyRequest):
    transport_class = transports.TargetTcpProxiesRestTransport
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/targetTcpProxies/{target_tcp_proxy}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_unary_rest_required_fields(
    request_type=compute.DeleteTargetTcpProxyRequest,
):
    transport_class = transports.TargetTcpProxiesRestTransport
...
def test_get_rest_required_fields(request_type=compute.GetTargetTcpProxyRequest):
    transport_class = transports.TargetTcpProxiesRestTransport
...
def test_insert_rest_required_fields(request_type=compute.InsertTargetTcpProxyRequest):
    transport_class = transports.TargetTcpProxiesRestTransport
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/targetTcpProxies"
            % client.transport._host,
            args[1],
        )
...
def test_insert_unary_rest_required_fields(
    request_type=compute.InsertTargetTcpProxyRequest,
):
    transport_class = transports.TargetTcpProxiesRestTransport
...
def test_list_rest_required_fields(request_type=compute.ListTargetTcpProxiesRequest):
    transport_class = transports.TargetTcpProxiesRestTransport
...
def test_set_backend_service_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetTcpProxiesClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.set_backend_service in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.set_backend_service] = (
            mock_rpc
        )
...
def test_set_backend_service_rest_required_fields(
...
def test_set_backend_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/targetTcpProxies/{target_tcp_proxy}/setBackendService"
            % client.transport._host,
            args[1],
        )
...
def test_set_backend_service_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetTcpProxiesClient(
...
def test_set_proxy_header_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetTcpProxiesClient(
        ...
        # Ensure method has been cached
        assert client._transport.set_proxy_header in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.set_proxy_header] = (
            mock_rpc
        )
...
def test_set_proxy_header_rest_required_fields(
    request_type=compute.SetProxyHeaderTargetTcpProxyRequest,
):
    transport_class = transports.TargetTcpProxiesRestTransport
...
def test_set_proxy_header_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetTcpProxiesClient(
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsTargetTcpProxyRequest,
):
    transport_class = transports.TargetTcpProxiesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/targetTcpProxies/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.TargetTcpProxiesRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.TargetTcpProxiesRestInterceptor(),
    )
    client = TargetTcpProxiesClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_aggregated_list"
        ) as post,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor,
            "post_aggregated_list_with_metadata",
        ) as post_with_metadata,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "pre_aggregated_list"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListTargetTcpProxiesRequest.pb(
            compute.AggregatedListTargetTcpProxiesRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.TargetTcpProxyAggregatedList.to_json(
            compute.TargetTcpProxyAggregatedList()
        )
        ...
        post.return_value = compute.TargetTcpProxyAggregatedList()
...
def test_delete_rest_bad_request(request_type=compute.DeleteTargetTcpProxyRequest):
    client = TargetTcpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_delete"
        ) as post,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_delete_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "pre_delete"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteTargetTcpProxyRequest.pb(
            compute.DeleteTargetTcpProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_rest_bad_request(request_type=compute.GetTargetTcpProxyRequest):
    client = TargetTcpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_get"
        ) as post,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.TargetTcpProxiesRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetTargetTcpProxyRequest.pb(
            compute.GetTargetTcpProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_bad_request(request_type=compute.InsertTargetTcpProxyRequest):
    client = TargetTcpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertTargetTcpProxyRequest.meta.fields[
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_insert"
        ) as post,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "pre_insert"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertTargetTcpProxyRequest.pb(
            compute.InsertTargetTcpProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_bad_request(request_type=compute.ListTargetTcpProxiesRequest):
    client = TargetTcpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_list"
        ) as post,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "pre_list"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListTargetTcpProxiesRequest.pb(
            compute.ListTargetTcpProxiesRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_backend_service_rest_call_success(request_type):
    client = TargetTcpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "target_tcp_proxy": "sample2"}
    request_init["target_tcp_proxies_set_backend_service_request_resource"] = {
        "service": "service_value"
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetBackendServiceTargetTcpProxyRequest.meta.fields[
...
def test_set_backend_service_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_set_backend_service"
        ) as post,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor,
        ...
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "pre_set_backend_service"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetBackendServiceTargetTcpProxyRequest.pb(
            compute.SetBackendServiceTargetTcpProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_proxy_header_rest_call_success(request_type):
    client = TargetTcpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "target_tcp_proxy": "sample2"}
    request_init["target_tcp_proxies_set_proxy_header_request_resource"] = {
        "proxy_header": "proxy_header_value"
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetProxyHeaderTargetTcpProxyRequest.meta.fields[
...
def test_set_proxy_header_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_set_proxy_header"
        ) as post,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor,
        ...
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "pre_set_proxy_header"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetProxyHeaderTargetTcpProxyRequest.pb(
            compute.SetProxyHeaderTargetTcpProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsTargetTcpProxyRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "post_test_iam_permissions"
        ) as post,
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor,
        ...
        mock.patch.object(
            transports.TargetTcpProxiesRestInterceptor, "pre_test_iam_permissions"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsTargetTcpProxyRequest.pb(
            compute.TestIamPermissionsTargetTcpProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.aggregated_list), "__call__") as call:
        ...
        request_msg = compute.AggregatedListTargetTcpProxiesRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteTargetTcpProxyRequest()
        assert args[0] == request_msg
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetTargetTcpProxyRequest()
        assert args[0] == request_msg
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertTargetTcpProxyRequest()
        assert args[0] == request_msg
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListTargetTcpProxiesRequest()
        assert args[0] == request_msg


# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_backend_service_unary_empty_call_rest():
    client = TargetTcpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(
        ...
        client.set_backend_service_unary(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetBackendServiceTargetTcpProxyRequest()
        assert args[0] == request_msg
...
def test_set_proxy_header_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.set_proxy_header), "__call__") as call:
        client.set_proxy_header_unary(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetProxyHeaderTargetTcpProxyRequest()
        assert args[0] == request_msg
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsTargetTcpProxyRequest()
        assert args[0] == request_msg
...
def test_target_tcp_proxies_host_no_port(transport_name):
    client = TargetTcpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_target_tcp_proxies_host_with_port(transport_name):
    client = TargetTcpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
...
def test_target_tcp_proxies_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = TargetTcpProxiesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = TargetTcpProxiesClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize(
    ...
    [
        (TargetTcpProxiesClient, transports.TargetTcpProxiesRestTransport),
    ],
)

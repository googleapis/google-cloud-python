...
from google.cloud.compute_v1.services.resource_policies import (
...
def test__get_client_cert_source():
    ...
    assert ResourcePoliciesClient._get_client_cert_source(None, False) is None
    assert (
        ResourcePoliciesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        ResourcePoliciesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ResourcePoliciesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                ResourcePoliciesClient._get_client_cert_source(
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ResourcePoliciesClient(credentials=cred)
...
def test_resource_policies_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_resource_policies_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    ResourcePoliciesClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ResourcePoliciesClient),
)
...
def test_resource_policies_client_client_api_endpoint(client_class):
...
def test_aggregated_list_rest_required_fields(
    request_type=compute.AggregatedListResourcePoliciesRequest,
):
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/resourcePolicies"
...
def test_set_iam_policy_rest_required_fields(
    request_type=compute.SetIamPolicyResourcePolicyRequest,
):
    transport_class = transports.ResourcePoliciesRestTransport
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "post_aggregated_list"
        ) as post,
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor,
            "post_aggregated_list_with_metadata",
        ) as post_with_metadata,
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "pre_aggregated_list"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListResourcePoliciesRequest.pb(
            compute.AggregatedListResourcePoliciesRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ResourcePolicyAggregatedList.to_json(
            compute.ResourcePolicyAggregatedList()
        )
...
def test_delete_rest_bad_request(request_type=compute.DeleteResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "post_delete_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteResourcePolicyRequest.pb(
            compute.DeleteResourcePolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_rest_bad_request(request_type=compute.GetResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetResourcePolicyRequest.pb(
            compute.GetResourcePolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ResourcePolicy.to_json(compute.ResourcePolicy())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.ResourcePolicy(), metadata
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyResourcePolicyRequest.pb(
            compute.GetIamPolicyResourcePolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_bad_request(request_type=compute.InsertResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertResourcePolicyRequest.meta.fields[
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertResourcePolicyRequest.pb(
            compute.InsertResourcePolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_bad_request(request_type=compute.ListResourcePoliciesRequest):
    client = ResourcePoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "post_list"
        ) as post,
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "pre_list"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListResourcePoliciesRequest.pb(
            compute.ListResourcePoliciesRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ResourcePolicyList.to_json(compute.ResourcePolicyList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.ResourcePolicyList(), metadata
...
def test_patch_rest_bad_request(request_type=compute.PatchResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchResourcePolicyRequest.meta.fields[
        "resource_policy_resource"
    ]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "post_patch_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyResourcePolicyRequest.meta.fields[
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "post_set_iam_policy"
        ) as post,
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor,
        ...
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "pre_set_iam_policy"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyResourcePolicyRequest.pb(
            compute.SetIamPolicyResourcePolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsResourcePolicyRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "post_test_iam_permissions"
        ) as post,
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor,
        ...
        mock.patch.object(
            transports.ResourcePoliciesRestInterceptor, "pre_test_iam_permissions"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsResourcePolicyRequest.pb(
            compute.TestIamPermissionsResourcePolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.aggregated_list), "__call__") as call:
        ...
        request_msg = compute.AggregatedListResourcePoliciesRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteResourcePolicyRequest()
        assert args[0] == request_msg
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetResourcePolicyRequest()
        assert args[0] == request_msg
...
def test_get_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetIamPolicyResourcePolicyRequest()
        assert args[0] == request_msg
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertResourcePolicyRequest()
        assert args[0] == request_msg
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListResourcePoliciesRequest()
        assert args[0] == request_msg
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.patch), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchResourcePolicyRequest()
        assert args[0] == request_msg
...
def test_set_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.set_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetIamPolicyResourcePolicyRequest()
        assert args[0] == request_msg
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsResourcePolicyRequest()
        assert args[0] == request_msg
...
def test_resource_policies_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.resource_policies.transports.ResourcePoliciesTransport.__init__"
    ) as Transport:
...
def test_resource_policies_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.compute_v1.services.resource_policies.transports.ResourcePoliciesTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_resource_policies_client_transport_session_collision(transport_name):
    ...
    client1 = ResourcePoliciesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = ResourcePoliciesClient(
        credentials=creds2,
        transport=transport_name,
    )

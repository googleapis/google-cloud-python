...
from google.cloud.compute_v1.services.accelerator_types import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AcceleratorTypesClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        AcceleratorTypesClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        AcceleratorTypesClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        AcceleratorTypesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        AcceleratorTypesClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        AcceleratorTypesClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert AcceleratorTypesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert AcceleratorTypesClient._read_environment_variables() == (
            True,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AcceleratorTypesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AcceleratorTypesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                AcceleratorTypesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert AcceleratorTypesClient._get_client_cert_source(None, False) is None
    assert (
        AcceleratorTypesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        AcceleratorTypesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                AcceleratorTypesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                AcceleratorTypesClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(AcceleratorTypesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AcceleratorTypesClient._DEFAULT_UNIVERSE
    default_endpoint = AcceleratorTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = AcceleratorTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == AcceleratorTypesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        AcceleratorTypesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        AcceleratorTypesClient._get_api_endpoint(None, None, default_universe, "always")
        == AcceleratorTypesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        AcceleratorTypesClient._get_api_endpoint(
    ...
    assert (
        AcceleratorTypesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        AcceleratorTypesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        AcceleratorTypesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        AcceleratorTypesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        AcceleratorTypesClient._get_universe_domain(None, None)
        == AcceleratorTypesClient._DEFAULT_UNIVERSE
    )

    with pytest.raises(ValueError) as excinfo:
        AcceleratorTypesClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = AcceleratorTypesClient(credentials=cred)
...
def test_accelerator_types_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_accelerator_types_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    AcceleratorTypesClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(AcceleratorTypesClient),
)
...
def test_accelerator_types_client_client_api_endpoint(client_class):
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/acceleratorTypes"
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/acceleratorTypes/{accelerator_type}"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/acceleratorTypes"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.AcceleratorTypesRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.AcceleratorTypesRestInterceptor(),
    )
    client = AcceleratorTypesClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.AcceleratorTypesRestInterceptor, "post_aggregated_list"
        ) as post,
        mock.patch.object(
            transports.AcceleratorTypesRestInterceptor,
            "post_aggregated_list_with_metadata",
        ) as post_with_metadata,
        mock.patch.object(
            transports.AcceleratorTypesRestInterceptor, "pre_aggregated_list"
        ) as pre,
    ):
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.AcceleratorTypeAggregatedList.to_json(
            compute.AcceleratorTypeAggregatedList()
        )
...
def test_get_rest_bad_request(request_type=compute.GetAcceleratorTypeRequest):
    client = AcceleratorTypesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.AcceleratorTypesRestInterceptor, "post_get"
        ) as post,
        mock.patch.object(
            transports.AcceleratorTypesRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.AcceleratorTypesRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.AcceleratorType.to_json(compute.AcceleratorType())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.AcceleratorType(), metadata
...
def test_list_rest_bad_request(request_type=compute.ListAcceleratorTypesRequest):
    client = AcceleratorTypesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.AcceleratorTypesRestInterceptor, "post_list"
        ) as post,
        mock.patch.object(
            transports.AcceleratorTypesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.AcceleratorTypesRestInterceptor, "pre_list"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.AcceleratorTypeList.to_json(
            compute.AcceleratorTypeList()
        )
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.AcceleratorTypeList(), metadata
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.aggregated_list), "__call__") as call:
        ...
        request_msg = compute.AggregatedListAcceleratorTypesRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetAcceleratorTypeRequest()
        assert args[0] == request_msg
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListAcceleratorTypesRequest()
        assert args[0] == request_msg
...
def test_accelerator_types_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.accelerator_types.transports.AcceleratorTypesTransport.__init__"
    ) as Transport:
...
def test_accelerator_types_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.compute_v1.services.accelerator_types.transports.AcceleratorTypesTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_accelerator_types_client_transport_session_collision(transport_name):
    ...
    client1 = AcceleratorTypesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = AcceleratorTypesClient(
        credentials=creds2,
        transport=transport_name,
    )

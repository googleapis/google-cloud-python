...
def test__get_client_cert_source():
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                RegionTargetHttpsProxiesClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(RegionTargetHttpsProxiesClient),
)
...
def test_region_target_https_proxies_client_client_api_endpoint(client_class):
    ...
    default_endpoint = RegionTargetHttpsProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = RegionTargetHttpsProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
...
def test_set_ssl_certificates_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.set_ssl_certificates] = (
            mock_rpc
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.RegionTargetHttpsProxiesRestInterceptor,
        ...
        pb_message = compute.DeleteRegionTargetHttpsProxyRequest.pb(
            compute.DeleteRegionTargetHttpsProxyRequest()
        )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.RegionTargetHttpsProxiesRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRegionTargetHttpsProxyRequest.pb(
            compute.GetRegionTargetHttpsProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertRegionTargetHttpsProxyRequest.meta.fields[
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertRegionTargetHttpsProxyRequest.pb(
            compute.InsertRegionTargetHttpsProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListRegionTargetHttpsProxiesRequest.pb(
            compute.ListRegionTargetHttpsProxiesRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchRegionTargetHttpsProxyRequest.meta.fields[
        "target_https_proxy_resource"
    ]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchRegionTargetHttpsProxyRequest.pb(
            compute.PatchRegionTargetHttpsProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_ssl_certificates_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetSslCertificatesRegionTargetHttpsProxyRequest.meta.fields[
        "region_target_https_proxies_set_ssl_certificates_request_resource"
    ]
...
def test_set_ssl_certificates_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.RegionTargetHttpsProxiesRestInterceptor,
            "pre_set_ssl_certificates",
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetSslCertificatesRegionTargetHttpsProxyRequest.pb(
            compute.SetSslCertificatesRegionTargetHttpsProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_url_map_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetUrlMapRegionTargetHttpsProxyRequest.meta.fields[
...
def test_set_url_map_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetUrlMapRegionTargetHttpsProxyRequest.pb(
            compute.SetUrlMapRegionTargetHttpsProxyRequest()
        )
        transcode.return_value = {
            "method": "post",

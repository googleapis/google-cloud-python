...
class RegionDisksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_update_kms_key(
        ...
        compute.UpdateKmsKeyRegionDiskRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
...
class RegionDisksRestTransport(_BaseRegionDisksRestTransport):
    ...
    class _UpdateKmsKey(
        _BaseRegionDisksRestTransport._BaseUpdateKmsKey, RegionDisksRestStub
    ):
        def __hash__(self):
            return hash("RegionDisksRestTransport.UpdateKmsKey")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionDisksClient.UpdateKmsKey",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionDisks",
            ...
            # Send the request
            response = RegionDisksRestTransport._UpdateKmsKey._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionDisksClient.update_kms_key",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionDisks",
                        "rpcName": "UpdateKmsKey",
                        "metadata": http_response["headers"],
    ...
    def update_kms_key(
        self,
    ) -> Callable[[compute.UpdateKmsKeyRegionDiskRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

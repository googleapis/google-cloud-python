        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.UrlMapsClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.UrlMaps",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.UrlMapsClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.UrlMaps",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],

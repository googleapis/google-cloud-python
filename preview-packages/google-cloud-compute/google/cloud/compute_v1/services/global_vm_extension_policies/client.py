...
class GlobalVmExtensionPoliciesClient(metaclass=GlobalVmExtensionPoliciesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=GlobalVmExtensionPoliciesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=GlobalVmExtensionPoliciesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=GlobalVmExtensionPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1.AggregatedListGlobalVmExtensionPoliciesRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.AggregatedListGlobalVmExtensionPoliciesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1.services.global_vm_extension_policies.pagers.AggregatedListPager:
        ...
        if not isinstance(
            ...
            request = compute.AggregatedListGlobalVmExtensionPoliciesRequest(request)
    ...
    def delete_unary(
        self,
        request: Optional[
            Union[compute.DeleteGlobalVmExtensionPolicyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        global_vm_extension_policy: Optional[str] = None,
        global_vm_extension_policy_rollout_operation_rollout_input_resource: Optional[
            compute.GlobalVmExtensionPolicyRolloutOperationRolloutInput
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        r"""Purge scoped resources (zonal policies) from a global
        VM extension policy, and then delete the global VM
        extension policy. Purge of the scoped resources is a
        pre-condition of the global VM extension policy
        deletion. The deletion of the global VM extension policy
        happens after the purge rollout is done, so it's not a
        part of the LRO. It's an automatic process that triggers
        in the backend.
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.DeleteGlobalVmExtensionPolicyRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            global_vm_extension_policy (str):
                Name of the global VM extension
                policy to purge scoped resources for.

                This corresponds to the ``global_vm_extension_policy`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            global_vm_extension_policy_rollout_operation_rollout_input_resource (google.cloud.compute_v1.types.GlobalVmExtensionPolicyRolloutOperationRolloutInput):
                The body resource for this request
                This corresponds to the ``global_vm_extension_policy_rollout_operation_rollout_input_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.DeleteGlobalVmExtensionPolicyRequest):
            request = compute.DeleteGlobalVmExtensionPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            if global_vm_extension_policy is not None:
                request.global_vm_extension_policy = global_vm_extension_policy
            if (
                global_vm_extension_policy_rollout_operation_rollout_input_resource
                is not None
            ):
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata(
                (
                    ...
                    ("global_vm_extension_policy", request.global_vm_extension_policy),
                )
            ),
        )
    ...
    def get(
        self,
        request: Optional[
            Union[compute.GetGlobalVmExtensionPolicyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        global_vm_extension_policy: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.GetGlobalVmExtensionPolicyRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                should not be set.
            global_vm_extension_policy (str):
                Name of the GlobalVmExtensionPolicy
                resource to return.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, global_vm_extension_policy]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetGlobalVmExtensionPolicyRequest):
            request = compute.GetGlobalVmExtensionPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def insert_unary(
        self,
        request: Optional[
            Union[compute.InsertGlobalVmExtensionPolicyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        global_vm_extension_policy_resource: Optional[
            compute.GlobalVmExtensionPolicy
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1.InsertGlobalVmExtensionPolicyRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.InsertGlobalVmExtensionPolicyRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            global_vm_extension_policy_resource (google.cloud.compute_v1.types.GlobalVmExtensionPolicy):
                The body resource for this request
                This corresponds to the ``global_vm_extension_policy_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.InsertGlobalVmExtensionPolicyRequest):
            request = compute.InsertGlobalVmExtensionPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            if global_vm_extension_policy_resource is not None:
                request.global_vm_extension_policy_resource = (
    ...
    def list(
        self,
        request: Optional[
            Union[compute.ListGlobalVmExtensionPoliciesRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1.ListGlobalVmExtensionPoliciesRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.ListGlobalVmExtensionPoliciesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1.services.global_vm_extension_policies.pagers.ListPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListGlobalVmExtensionPoliciesRequest):
            request = compute.ListGlobalVmExtensionPoliciesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def update_unary(
        self,
        request: Optional[
            Union[compute.UpdateGlobalVmExtensionPolicyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        global_vm_extension_policy: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_update():
                ...
                # Initialize request argument(s)
                request = compute_v1.UpdateGlobalVmExtensionPolicyRequest(
                    global_vm_extension_policy="global_vm_extension_policy_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.UpdateGlobalVmExtensionPolicyRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.UpdateGlobalVmExtensionPolicyRequest):
            request = compute.UpdateGlobalVmExtensionPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def __enter__(self) -> "GlobalVmExtensionPoliciesClient":
        return self
...
__all__ = ("GlobalVmExtensionPoliciesClient",)

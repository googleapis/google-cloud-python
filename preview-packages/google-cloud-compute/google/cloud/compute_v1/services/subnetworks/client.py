...
class SubnetworksClient(metaclass=SubnetworksClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = SubnetworksClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = SubnetworksClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = SubnetworksClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SubnetworksClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = SubnetworksClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, SubnetworksTransport, Callable[..., SubnetworksTransport]]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,SubnetworksTransport,Callable[..., SubnetworksTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the SubnetworksTransport constructor.
        ...
        self._client_cert_source = SubnetworksClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = SubnetworksClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, SubnetworksTransport)
        if transport_provided:
            ...
            self._transport = cast(SubnetworksTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or SubnetworksClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[SubnetworksTransport], Callable[..., SubnetworksTransport]
            ] = (
                SubnetworksClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., SubnetworksTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.SubnetworksClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, subnetwork]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.Subnetwork:
                ...
                A subnetwork (also known as a subnet) is
                a logical partition of a Virtual Private
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, subnetwork_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def patch_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, subnetwork, subnetwork_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:

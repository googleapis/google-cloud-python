...
class RoutersClient(metaclass=RoutersClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=RoutersClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=RoutersClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=RoutersClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def delete_named_set_unary(
        self,
        request: Optional[Union[compute.DeleteNamedSetRouterRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        router: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_delete_named_set():
                ...
                # Initialize request argument(s)
                request = compute_v1.DeleteNamedSetRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.DeleteNamedSetRouterRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.DeleteNamedSetRouterRequest):
            request = compute.DeleteNamedSetRouterRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_named_set]
    ...
    def get_named_set(
        self,
        request: Optional[Union[compute.GetNamedSetRouterRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        router: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_get_named_set():
                ...
                # Initialize request argument(s)
                request = compute_v1.GetNamedSetRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
                ...
                # Make the request
                response = client.get_named_set(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.compute_v1.types.GetNamedSetRouterRequest, dict]):
                The request object. A request message for
            ...
            router (str):
                ...
                for the named set. The name should
                conform to RFC1035.
        ...
        Returns:
            google.cloud.compute_v1.types.RoutersGetNamedSetResponse:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetNamedSetRouterRequest):
            request = compute.GetNamedSetRouterRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_named_set]
    ...
    def list_named_sets(
        self,
        request: Optional[Union[compute.ListNamedSetsRoutersRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        router: Optional[str] = None,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListNamedSetsPager:
        r"""Retrieves a list of router named set subresources
        ...
        .. code-block:: python
            ...
            def sample_list_named_sets():
                # Create a client
                client = compute_v1.RoutersClient()

                # Initialize request argument(s)
                request = compute_v1.ListNamedSetsRoutersRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
                ...
                # Make the request
                page_result = client.list_named_sets(request=request)
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.ListNamedSetsRoutersRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1.services.routers.pagers.ListNamedSetsPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListNamedSetsRoutersRequest):
            request = compute.ListNamedSetsRoutersRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_named_sets]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListNamedSetsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def patch_named_set_unary(
        self,
        request: Optional[Union[compute.PatchNamedSetRouterRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        router: Optional[str] = None,
        named_set_resource: Optional[compute.NamedSet] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_patch_named_set():
                # Create a client
                client = compute_v1.RoutersClient()

                # Initialize request argument(s)
                request = compute_v1.PatchNamedSetRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
                ...
                # Make the request
                response = client.patch_named_set(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.compute_v1.types.PatchNamedSetRouterRequest, dict]):
                The request object. A request message for
            ...
            router (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            named_set_resource (google.cloud.compute_v1.types.NamedSet):
                The body resource for this request
                This corresponds to the ``named_set_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, router, named_set_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.PatchNamedSetRouterRequest):
            request = compute.PatchNamedSetRouterRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            ...
            if router is not None:
                request.router = router
            if named_set_resource is not None:
                request.named_set_resource = named_set_resource

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.patch_named_set]
    ...
    def update_named_set_unary(
        self,
        request: Optional[Union[compute.UpdateNamedSetRouterRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        router: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_update_named_set():
                ...
                # Initialize request argument(s)
                request = compute_v1.UpdateNamedSetRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.UpdateNamedSetRouterRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.UpdateNamedSetRouterRequest):
            request = compute.UpdateNamedSetRouterRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_named_set]

...
from .rest_base import _BaseLicenseCodesRestTransport
...
class LicenseCodesRestInterceptor:
    """Interceptor for LicenseCodes.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the LicenseCodesRestTransport.
    ...
    ) -> Tuple[compute.GetLicenseCodeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class LicenseCodesRestStub:
    ...
    _host: str
    _interceptor: LicenseCodesRestInterceptor


class LicenseCodesRestTransport(_BaseLicenseCodesRestTransport):
    """REST backend synchronous transport for LicenseCodes.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[LicenseCodesRestInterceptor] = None,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[LicenseCodesRestInterceptor]): Interceptor used
        ...
        self._interceptor = interceptor or LicenseCodesRestInterceptor()
        self._prep_wrapped_messages(client_info)

    class _Get(_BaseLicenseCodesRestTransport._BaseGet, LicenseCodesRestStub):
        def __hash__(self):
            return hash("LicenseCodesRestTransport.Get")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseLicenseCodesRestTransport._BaseGet._get_http_options()
            request, metadata = self._interceptor.pre_get(request, metadata)
            transcoded_request, body, query_params = transcode_request(
                http_options,
                request,
                required_fields_default_values=getattr(
                    _BaseLicenseCodesRestTransport._BaseGet,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.LicenseCodesClient.Get",
                    extra={
            ...
            # Send the request
            response = LicenseCodesRestTransport._Get._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            # Return the response
            resp = compute.LicenseCode()
            pb_resp = compute.LicenseCode.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = compute.LicenseCode.to_json(response)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.LicenseCodesClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.LicenseCodes",
                        "rpcName": "Get",
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseLicenseCodesRestTransport._BaseGetIamPolicy,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseLicenseCodesRestTransport._BaseSetIamPolicy,
    ...
    class _TestIamPermissions(
        ...
        def __hash__(self):
            return hash("LicenseCodesRestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseLicenseCodesRestTransport._BaseTestIamPermissions._get_http_options()
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseLicenseCodesRestTransport._BaseTestIamPermissions,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.LicenseCodesClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.LicenseCodes",
            ...
            # Send the request
            response = LicenseCodesRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.LicenseCodesClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.LicenseCodes",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],

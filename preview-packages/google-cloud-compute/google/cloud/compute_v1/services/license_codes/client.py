...
from .transports.base import DEFAULT_CLIENT_INFO, LicenseCodesTransport
from .transports.rest import LicenseCodesRestTransport


class LicenseCodesClientMeta(type):
    """Metaclass for the LicenseCodes client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[LicenseCodesTransport]]
    _transport_registry["rest"] = LicenseCodesRestTransport
...
class LicenseCodesClient(metaclass=LicenseCodesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            LicenseCodesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> LicenseCodesTransport:
        """Returns the transport used by the client instance.

        Returns:
            LicenseCodesTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, LicenseCodesTransport, Callable[..., LicenseCodesTransport]]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,LicenseCodesTransport,Callable[..., LicenseCodesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the LicenseCodesTransport constructor.
        ...
        self._client_cert_source = LicenseCodesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = get_universe_domain(
            universe_domain_opt,
            self._universe_domain_env,
            default_universe=LicenseCodesClient._DEFAULT_UNIVERSE,
        )
        ...
        transport_provided = isinstance(transport, LicenseCodesTransport)
        if transport_provided:
            # transport is a LicenseCodesTransport instance.
            ...
            self._transport = cast(LicenseCodesTransport, transport)
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=LicenseCodesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=LicenseCodesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=LicenseCodesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[LicenseCodesTransport], Callable[..., LicenseCodesTransport]
            ] = (
                LicenseCodesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., LicenseCodesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.LicenseCodesClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                request = compute_v1.GetLicenseCodeRequest(
        ...
        Args:
            ...
            project (str):
                ...
                should not be set.
            license_code (str):
                Number corresponding to the License
        ...
        flattened_params = [project, license_code]
    ...
    def get_iam_policy(
        self,
        request: Optional[Union[compute.GetIamPolicyLicenseCodeRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1.GetIamPolicyLicenseCodeRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.GetIamPolicyLicenseCodeRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetIamPolicyLicenseCodeRequest):
            request = compute.GetIamPolicyLicenseCodeRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def set_iam_policy(
        self,
        request: Optional[Union[compute.SetIamPolicyLicenseCodeRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_set_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1.SetIamPolicyLicenseCodeRequest(
                    project="project_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.SetIamPolicyLicenseCodeRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.SetIamPolicyLicenseCodeRequest):
            request = compute.SetIamPolicyLicenseCodeRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        *Caution* This resource is intended for use only by third-party
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1.TestIamPermissionsLicenseCodeRequest(
                    project="project_value",
                    resource="resource_value",
                )

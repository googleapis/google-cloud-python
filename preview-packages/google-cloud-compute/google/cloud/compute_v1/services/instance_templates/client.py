...
from .transports.base import DEFAULT_CLIENT_INFO, InstanceTemplatesTransport
from .transports.rest import InstanceTemplatesRestTransport


class InstanceTemplatesClientMeta(type):
    """Metaclass for the InstanceTemplates client.
...
class InstanceTemplatesClient(metaclass=InstanceTemplatesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            InstanceTemplatesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> InstanceTemplatesTransport:
        """Returns the transport used by the client instance.

        Returns:
            InstanceTemplatesTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = InstanceTemplatesClient._get_client_cert_source(
        ...
        transport_provided = isinstance(transport, InstanceTemplatesTransport)
        if transport_provided:
            # transport is a InstanceTemplatesTransport instance.
            ...
            self._transport = cast(InstanceTemplatesTransport, transport)
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_mtls_endpoint=InstanceTemplatesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=InstanceTemplatesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                InstanceTemplatesClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.InstanceTemplatesClient`.",
                    extra={
    ...
    def aggregated_list(
        self,
        request: Optional[
            Union[compute.AggregatedListInstanceTemplatesRequest, dict]
        ] = None,
        *,
    ...
    def delete_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, instance_template]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, instance_template_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
...
__all__ = ("InstanceTemplatesClient",)

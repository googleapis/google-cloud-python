...
from .transports.base import DEFAULT_CLIENT_INFO, InterconnectAttachmentsTransport
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=InterconnectAttachmentsClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=InterconnectAttachmentsClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=InterconnectAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE,

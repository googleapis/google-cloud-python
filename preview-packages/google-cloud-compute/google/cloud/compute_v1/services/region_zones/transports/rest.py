...
from .rest_base import _BaseRegionZonesRestTransport
...
class RegionZonesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[compute.ListRegionZonesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.ZoneList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the RegionZones server but before it is returned to user code.
...
class RegionZonesRestTransport(_BaseRegionZonesRestTransport):
    """REST backend synchronous transport for RegionZones.
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RegionZonesRestInterceptor]): Interceptor used
    ...
    class _List(_BaseRegionZonesRestTransport._BaseList, RegionZonesRestStub):
        def __hash__(self):
            return hash("RegionZonesRestTransport.List")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseRegionZonesRestTransport._BaseList._get_http_options()

            request, metadata = self._interceptor.pre_list(request, metadata)
            transcoded_request = (
                _BaseRegionZonesRestTransport._BaseList._get_transcoded_request(
            ...
            query_params = (
                _BaseRegionZonesRestTransport._BaseList._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionZonesClient.List",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionZonesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionZones",
                        "rpcName": "List",

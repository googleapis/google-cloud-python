...
class NetworksClient(metaclass=NetworksClientMeta):
    ...
    def cancel_request_remove_peering_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.CancelRequestRemovePeeringNetworkRequest, dict]):
                The request object. A request message for
            ...
            network (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            networks_cancel_request_remove_peering_request_resource (google.cloud.compute_v1.types.NetworksCancelRequestRemovePeeringRequest):
                The body resource for this request

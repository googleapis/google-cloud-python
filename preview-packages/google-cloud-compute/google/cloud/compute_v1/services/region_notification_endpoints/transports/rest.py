        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionNotificationEndpointsClient.AggregatedList",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionNotificationEndpointsClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionNotificationEndpoints",
                        "rpcName": "AggregatedList",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionNotificationEndpointsClient.Delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionNotificationEndpoints",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionNotificationEndpointsClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionNotificationEndpoints",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionNotificationEndpointsClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionNotificationEndpoints",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionNotificationEndpointsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionNotificationEndpoints",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionNotificationEndpointsClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionNotificationEndpoints",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionNotificationEndpointsClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionNotificationEndpoints",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionNotificationEndpointsClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionNotificationEndpoints",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionNotificationEndpointsClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionNotificationEndpoints",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionNotificationEndpointsClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionNotificationEndpoints",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionNotificationEndpointsClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionNotificationEndpoints",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],

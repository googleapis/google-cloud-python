...
class GlobalPublicDelegatedPrefixesClient(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = get_universe_domain(
            ...
            default_universe=GlobalPublicDelegatedPrefixesClient._DEFAULT_UNIVERSE,
        )
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=GlobalPublicDelegatedPrefixesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=GlobalPublicDelegatedPrefixesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=GlobalPublicDelegatedPrefixesClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def get(
        self,
        request: Optional[
            Union[compute.GetGlobalPublicDelegatedPrefixeRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        public_delegated_prefix: Optional[str] = None,
    ...
    def insert_unary(
        self,
        request: Optional[
            Union[compute.InsertGlobalPublicDelegatedPrefixeRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
    ...
    def list(
        self,
        request: Optional[
            Union[compute.ListGlobalPublicDelegatedPrefixesRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def patch_unary(
        self,
        request: Optional[
            Union[compute.PatchGlobalPublicDelegatedPrefixeRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        public_delegated_prefix: Optional[str] = None,
...
__all__ = ("GlobalPublicDelegatedPrefixesClient",)

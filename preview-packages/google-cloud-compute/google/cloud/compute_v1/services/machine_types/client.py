...
from .transports.base import DEFAULT_CLIENT_INFO, MachineTypesTransport
from .transports.rest import MachineTypesRestTransport


class MachineTypesClientMeta(type):
    """Metaclass for the MachineTypes client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[MachineTypesTransport]]
    _transport_registry["rest"] = MachineTypesRestTransport
...
class MachineTypesClient(metaclass=MachineTypesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            MachineTypesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> MachineTypesTransport:
        """Returns the transport used by the client instance.

        Returns:
            MachineTypesTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, MachineTypesTransport, Callable[..., MachineTypesTransport]]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,MachineTypesTransport,Callable[..., MachineTypesTransport]]]):
                ...
                arguments as used in the MachineTypesTransport constructor.
        ...
        self._client_cert_source = MachineTypesClient._get_client_cert_source(
        ...
        transport_provided = isinstance(transport, MachineTypesTransport)
        if transport_provided:
            # transport is a MachineTypesTransport instance.
            ...
            self._transport = cast(MachineTypesTransport, transport)
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=MachineTypesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=MachineTypesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=MachineTypesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.MachineTypesClient`.",
                    extra={
    ...
    def get(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, machine_type]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:

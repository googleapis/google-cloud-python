...
class HostsTransport(abc.ABC):
    """Abstract transport class for Hosts."""
    ...
    def get(
        ...
        [compute.GetHostRequest], Union[compute.Host, Awaitable[compute.Host]]
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.HostsListResponse, Awaitable[compute.HostsListResponse]],
    ]:
        raise NotImplementedError()

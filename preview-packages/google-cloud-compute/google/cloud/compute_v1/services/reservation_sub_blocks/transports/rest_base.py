...
from .base import DEFAULT_CLIENT_INFO, ReservationSubBlocksTransport


class _BaseReservationSubBlocksRestTransport(ReservationSubBlocksTransport):
    """Base REST backend transport for ReservationSubBlocks.
    ...
    class _BaseGet:
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = compute.GetReservationSubBlockRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReservationSubBlocksRestTransport._BaseGet._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseGetIamPolicy:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.GetIamPolicyReservationSubBlockRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReservationSubBlocksRestTransport._BaseGetIamPolicy._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseList:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.ListReservationSubBlocksRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReservationSubBlocksRestTransport._BaseList._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BasePerformMaintenance:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.PerformMaintenanceReservationSubBlockRequest.pb(
                request
            )
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReservationSubBlocksRestTransport._BasePerformMaintenance._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseReportFaulty:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.ReportFaultyReservationSubBlockRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReservationSubBlocksRestTransport._BaseReportFaulty._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseSetIamPolicy:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.SetIamPolicyReservationSubBlockRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReservationSubBlocksRestTransport._BaseSetIamPolicy._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseTestIamPermissions:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.TestIamPermissionsReservationSubBlockRequest.pb(
                request
            )
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReservationSubBlocksRestTransport._BaseTestIamPermissions._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BaseReservationSubBlocksRestTransport",)

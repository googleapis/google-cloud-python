...
from .transports.base import DEFAULT_CLIENT_INFO, LicensesTransport
...
class LicensesClient(metaclass=LicensesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = LicensesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = LicensesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = LicensesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = LicensesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = LicensesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, LicensesTransport, Callable[..., LicensesTransport]]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,LicensesTransport,Callable[..., LicensesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the LicensesTransport constructor.
        ...
        self._client_cert_source = LicensesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = LicensesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, LicensesTransport)
        if transport_provided:
            ...
            self._transport = cast(LicensesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or LicensesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.LicensesClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        flattened_params = [project, license_]
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, license_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def update_unary(
        self,
        request: Optional[Union[compute.UpdateLicenseRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        license_: Optional[str] = None,
        license_resource: Optional[compute.License] = None,
        ...
        .. code-block:: python
            ...
            def sample_update():
                ...
                # Initialize request argument(s)
                request = compute_v1.UpdateLicenseRequest(
                    license_="license__value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.UpdateLicenseRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, license_, license_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.UpdateLicenseRequest):
            request = compute.UpdateLicenseRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

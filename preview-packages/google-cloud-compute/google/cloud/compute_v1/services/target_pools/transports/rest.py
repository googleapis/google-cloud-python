        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[TargetPoolsRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.TargetPoolsClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetPools",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.TargetPoolsClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetPools",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],

...
class RegionOperationsClientMeta(type):
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[RegionOperationsTransport]]
...
class RegionOperationsClient(metaclass=RegionOperationsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RegionOperationsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = RegionOperationsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = RegionOperationsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = RegionOperationsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str, RegionOperationsTransport, Callable[..., RegionOperationsTransport]
            ]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionOperationsTransport,Callable[..., RegionOperationsTransport]]]):
        ...
        self._client_cert_source = RegionOperationsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionOperationsClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, RegionOperationsTransport)
        if transport_provided:
            ...
            self._transport = cast(RegionOperationsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or RegionOperationsClient._get_api_endpoint(
    ...
    def delete(
        ...
        *,
        ...
        flattened_params = [project, region, operation]

...
class InterconnectLocationsTransport(abc.ABC):
    """Abstract transport class for InterconnectLocations."""
    ...
    def get(
        ...
        Union[compute.InterconnectLocation, Awaitable[compute.InterconnectLocation]],
    ]:
        raise NotImplementedError()

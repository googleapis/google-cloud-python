    ...
    class _GetHealth(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseRegionHealthSourcesRestTransport._BaseGetHealth._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseRegionHealthSourcesRestTransport._BaseGetHealth._get_query_params_json(
                transcoded_request
            )

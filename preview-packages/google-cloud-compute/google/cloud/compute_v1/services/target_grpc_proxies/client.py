    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            TargetGrpcProxiesClient._read_environment_variables()
        )
        self._client_cert_source = TargetGrpcProxiesClient._get_client_cert_source(
        ...
        transport_provided = isinstance(transport, TargetGrpcProxiesTransport)
        if transport_provided:
            ...
            self._transport = cast(TargetGrpcProxiesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            api_override=self._client_options.api_endpoint,
            universe_domain=self._universe_domain,
            default_universe=TargetGrpcProxiesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=TargetGrpcProxiesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=TargetGrpcProxiesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.TargetGrpcProxiesClient`.",
                    extra={

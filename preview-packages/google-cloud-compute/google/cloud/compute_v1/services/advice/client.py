        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_capacity():
                ...
                # Initialize request argument(s)
                request = compute_v1.CapacityAdviceRpcRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.CapacityAdviceRpcRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1.types.CapacityAdviceResponse:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_capacity_history():
                ...
                # Initialize request argument(s)
                request = compute_v1.CapacityHistoryAdviceRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.CapacityHistoryAdviceRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1.types.CapacityHistoryResponse:

...
from .transports.base import DEFAULT_CLIENT_INFO, FirewallsTransport
from .transports.rest import FirewallsRestTransport


class FirewallsClientMeta(type):
    """Metaclass for the Firewalls client.
...
class FirewallsClient(metaclass=FirewallsClientMeta):
    ...
    @property
    def transport(self) -> FirewallsTransport:
        """Returns the transport used by the client instance.

        Returns:
            FirewallsTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            FirewallsClient._read_environment_variables()
        )
        self._client_cert_source = FirewallsClient._get_client_cert_source(
        ...
        transport_provided = isinstance(transport, FirewallsTransport)
        if transport_provided:
            # transport is a FirewallsTransport instance.
            ...
            self._transport = cast(FirewallsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            api_override=self._client_options.api_endpoint,
            universe_domain=self._universe_domain,
            default_universe=FirewallsClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=FirewallsClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=FirewallsClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.FirewallsClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        flattened_params = [project, firewall]
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, firewall_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def patch_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, firewall, firewall_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsFirewallRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1.TestIamPermissionsFirewallRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsFirewallRequest, dict]):
                The request object. A request message for
                Firewalls.TestIamPermissions. See the
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsFirewallRequest):
            request = compute.TestIamPermissionsFirewallRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

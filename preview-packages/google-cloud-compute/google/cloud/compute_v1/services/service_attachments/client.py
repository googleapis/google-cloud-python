...
from .transports.base import DEFAULT_CLIENT_INFO, ServiceAttachmentsTransport
...
class ServiceAttachmentsClient(metaclass=ServiceAttachmentsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ServiceAttachmentsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = ServiceAttachmentsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = ServiceAttachmentsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ServiceAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ServiceAttachmentsClient._DEFAULT_UNIVERSE
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,ServiceAttachmentsTransport,Callable[..., ServiceAttachmentsTransport]]]):
                ...
                arguments as used in the ServiceAttachmentsTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            ServiceAttachmentsClient._read_environment_variables()
        )
        self._client_cert_source = ServiceAttachmentsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ServiceAttachmentsClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, ServiceAttachmentsTransport)
        if transport_provided:
            ...
            self._transport = cast(ServiceAttachmentsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ServiceAttachmentsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.ServiceAttachmentsClient`.",
                    extra={
    ...
    def aggregated_list(
        ...
        *,
        ...
        r"""Retrieves the list of all ServiceAttachment resources, regional
    ...
    def delete_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, service_attachment]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.ServiceAttachment:
                ...
                resource.
                A service attachment represents a
                service that a producer has exposed. It
                encapsulates the load balancer which
                fronts the service runs and a list of
                NAT IP ranges that the producers uses to
                represent the consumers connecting to
                the service.
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, service_attachment_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:

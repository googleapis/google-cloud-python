    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = get_universe_domain(
            ...
            default_universe=ServiceAttachmentsClient._DEFAULT_UNIVERSE,
        )
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=ServiceAttachmentsClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=ServiceAttachmentsClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=ServiceAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE,

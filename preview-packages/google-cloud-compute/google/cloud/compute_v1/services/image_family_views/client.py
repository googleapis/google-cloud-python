...
class ImageFamilyViewsClient(metaclass=ImageFamilyViewsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = get_universe_domain(
            ...
            default_universe=ImageFamilyViewsClient._DEFAULT_UNIVERSE,
        )
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=ImageFamilyViewsClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=ImageFamilyViewsClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=ImageFamilyViewsClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def get(
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.ImageFamilyView:

        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, family]
        ...
        if not isinstance(request, compute.GetImageFamilyViewRequest):
            request = compute.GetImageFamilyViewRequest(request)
...
__all__ = ("ImageFamilyViewsClient",)

...
_GENERATEIDENTITYBINDINGACCESSTOKENREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.iam.credentials.v1.GenerateIdentityBindingAccessTokenRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='scope', full_name='google.iam.credentials.v1.GenerateIdentityBindingAccessTokenRequest.scope', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='jwt', full_name='google.iam.credentials.v1.GenerateIdentityBindingAccessTokenRequest.jwt', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERATEIDENTITYBINDINGACCESSTOKENRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='access_token', full_name='google.iam.credentials.v1.GenerateIdentityBindingAccessTokenResponse.access_token', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='expire_time', full_name='google.iam.credentials.v1.GenerateIdentityBindingAccessTokenResponse.expire_time', index=1,
...
_GENERATEIDENTITYBINDINGACCESSTOKENRESPONSE.fields_by_name['expire_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
DESCRIPTOR.message_types_by_name['GenerateIdentityBindingAccessTokenRequest'] = _GENERATEIDENTITYBINDINGACCESSTOKENREQUEST
DESCRIPTOR.message_types_by_name['GenerateIdentityBindingAccessTokenResponse'] = _GENERATEIDENTITYBINDINGACCESSTOKENRESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

GenerateAccessTokenRequest = _reflection.GeneratedProtocolMessageType('GenerateAccessTokenRequest', (_message.Message,), dict(
...
GenerateAccessTokenResponse = _reflection.GeneratedProtocolMessageType('GenerateAccessTokenResponse', (_message.Message,), dict(
...
GenerateIdTokenRequest = _reflection.GeneratedProtocolMessageType('GenerateIdTokenRequest', (_message.Message,), dict(
...
GenerateIdTokenResponse = _reflection.GeneratedProtocolMessageType('GenerateIdTokenResponse', (_message.Message,), dict(
...
GenerateIdentityBindingAccessTokenRequest = _reflection.GeneratedProtocolMessageType('GenerateIdentityBindingAccessTokenRequest', (_message.Message,), dict(
...
GenerateIdentityBindingAccessTokenResponse = _reflection.GeneratedProtocolMessageType('GenerateIdentityBindingAccessTokenResponse', (_message.Message,), dict(

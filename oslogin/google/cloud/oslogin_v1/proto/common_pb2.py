...
PosixAccount = _reflection.GeneratedProtocolMessageType('PosixAccount', (_message.Message,), dict(
...
SshPublicKey = _reflection.GeneratedProtocolMessageType('SshPublicKey', (_message.Message,), dict(

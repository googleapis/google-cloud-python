...
from .transports.base import ManagedSchemaRegistryTransport, DEFAULT_CLIENT_INFO
...
class ManagedSchemaRegistryAsyncClient:
    ...
    **Mode** represents the mode of a schema registry or a specific
    ...
    parse_schema_config_path = staticmethod(ManagedSchemaRegistryClient.parse_schema_config_path)
    schema_context_path = staticmethod(ManagedSchemaRegistryClient.schema_context_path)
    parse_schema_context_path = staticmethod(ManagedSchemaRegistryClient.parse_schema_context_path)
    schema_mode_path = staticmethod(ManagedSchemaRegistryClient.schema_mode_path)
    parse_schema_mode_path = staticmethod(ManagedSchemaRegistryClient.parse_schema_mode_path)
    schema_registry_path = staticmethod(ManagedSchemaRegistryClient.schema_registry_path)
    parse_schema_registry_path = staticmethod(ManagedSchemaRegistryClient.parse_schema_registry_path)
    schema_subject_path = staticmethod(ManagedSchemaRegistryClient.schema_subject_path)
    parse_schema_subject_path = staticmethod(ManagedSchemaRegistryClient.parse_schema_subject_path)
    schema_version_path = staticmethod(ManagedSchemaRegistryClient.schema_version_path)
    parse_schema_version_path = staticmethod(ManagedSchemaRegistryClient.parse_schema_version_path)
    common_billing_account_path = staticmethod(ManagedSchemaRegistryClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ManagedSchemaRegistryClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ManagedSchemaRegistryClient.common_folder_path)
    parse_common_folder_path = staticmethod(ManagedSchemaRegistryClient.parse_common_folder_path)
    common_organization_path = staticmethod(ManagedSchemaRegistryClient.common_organization_path)
    parse_common_organization_path = staticmethod(ManagedSchemaRegistryClient.parse_common_organization_path)
    common_project_path = staticmethod(ManagedSchemaRegistryClient.common_project_path)
    parse_common_project_path = staticmethod(ManagedSchemaRegistryClient.parse_common_project_path)
    common_location_path = staticmethod(ManagedSchemaRegistryClient.common_location_path)
    parse_common_location_path = staticmethod(ManagedSchemaRegistryClient.parse_common_location_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ManagedSchemaRegistryTransport, Callable[..., ManagedSchemaRegistryTransport]]] = "grpc_asyncio",
    ...
    async def get_schema_registry(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_schema_registry]
    ...
    async def list_schema_registries(self,
            request: Optional[Union[schema_registry.ListSchemaRegistriesRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_schema_registries]
    ...
    async def create_schema_registry(self,
            request: Optional[Union[gcms_schema_registry.CreateSchemaRegistryRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_schema_registry]
    ...
    async def delete_schema_registry(self,
            request: Optional[Union[schema_registry.DeleteSchemaRegistryRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_schema_registry]
    ...
    async def get_context(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_context]
    ...
    async def list_contexts(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_contexts]
    ...
    async def get_raw_schema(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_raw_schema]
    ...
    async def list_schema_versions(self,
            request: Optional[Union[schema_registry.ListSchemaVersionsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_schema_versions]
    ...
    async def list_schema_types(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_schema_types]
    ...
    async def list_subjects(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_subjects]
    ...
    async def list_subjects_by_schema_id(self,
            request: Optional[Union[schema_registry.ListSubjectsBySchemaIdRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_subjects_by_schema_id]
    ...
    async def delete_subject(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_subject]
    ...
    async def lookup_version(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.lookup_version]
    ...
    async def get_raw_schema_version(self,
            request: Optional[Union[schema_registry.GetVersionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_raw_schema_version]
    ...
    async def create_version(self,
            ...
            *,
            ...
            schema: Optional[str] = None,
            references: Optional[MutableSequence[schema_registry_resources.Schema.SchemaReference]] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, version, id, schema_type, schema, references, normalize]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
    ...
    async def list_referenced_schemas(self,
            request: Optional[Union[schema_registry.ListReferencedSchemasRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_referenced_schemas]
    ...
    async def check_compatibility(self,
            request: Optional[Union[schema_registry.CheckCompatibilityRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            schema: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    async def get_schema_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_schema_config]
    ...
    async def update_schema_config(self,
            request: Optional[Union[schema_registry.UpdateSchemaConfigRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            compatibility: Optional[schema_registry_resources.SchemaConfig.CompatibilityType] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> schema_registry_resources.SchemaConfig:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_schema_config]
    ...
    async def delete_schema_config(self,
            request: Optional[Union[schema_registry.DeleteSchemaConfigRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_schema_config]
    ...
    async def get_schema_mode(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_schema_mode]
    ...
    async def update_schema_mode(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_schema_mode]
    ...
    async def delete_schema_mode(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_schema_mode]

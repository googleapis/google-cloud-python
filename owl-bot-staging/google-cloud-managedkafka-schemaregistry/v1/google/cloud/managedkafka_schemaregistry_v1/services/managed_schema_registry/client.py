...
class ManagedSchemaRegistryClient(metaclass=ManagedSchemaRegistryClientMeta):
    ...
    **Mode** represents the mode of a schema registry or a specific
    ...
    @staticmethod
    def schema_path(project: str,location: str,schema_registry: str,schema: str,) -> str:
        """Returns a fully-qualified schema string."""
        return "projects/{project}/locations/{location}/schemaRegistries/{schema_registry}/schemas/ids/{schema}".format(project=project, location=location, schema_registry=schema_registry, schema=schema, )

    @staticmethod
    def parse_schema_path(path: str) -> Dict[str,str]:
        """Parses a schema path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/schemaRegistries/(?P<schema_registry>.+?)/schemas/ids/(?P<schema>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def schema_config_path(project: str,location: str,schema_registry: str,) -> str:
        """Returns a fully-qualified schema_config string."""
        return "projects/{project}/locations/{location}/schemaRegistries/{schema_registry}/config".format(project=project, location=location, schema_registry=schema_registry, )

    @staticmethod
    def parse_schema_config_path(path: str) -> Dict[str,str]:
        """Parses a schema_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/schemaRegistries/(?P<schema_registry>.+?)/config$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def schema_context_path(project: str,location: str,schema_registry: str,context: str,) -> str:
        """Returns a fully-qualified schema_context string."""
        return "projects/{project}/locations/{location}/schemaRegistries/{schema_registry}/contexts/{context}".format(project=project, location=location, schema_registry=schema_registry, context=context, )

    @staticmethod
    def parse_schema_context_path(path: str) -> Dict[str,str]:
        """Parses a schema_context path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/schemaRegistries/(?P<schema_registry>.+?)/contexts/(?P<context>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def schema_mode_path(project: str,location: str,schema_registry: str,) -> str:
        """Returns a fully-qualified schema_mode string."""
        return "projects/{project}/locations/{location}/schemaRegistries/{schema_registry}/mode".format(project=project, location=location, schema_registry=schema_registry, )

    @staticmethod
    def parse_schema_mode_path(path: str) -> Dict[str,str]:
        """Parses a schema_mode path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/schemaRegistries/(?P<schema_registry>.+?)/mode$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def schema_registry_path(project: str,location: str,schema_registry: str,) -> str:
        """Returns a fully-qualified schema_registry string."""
        return "projects/{project}/locations/{location}/schemaRegistries/{schema_registry}".format(project=project, location=location, schema_registry=schema_registry, )

    @staticmethod
    def parse_schema_registry_path(path: str) -> Dict[str,str]:
        """Parses a schema_registry path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/schemaRegistries/(?P<schema_registry>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def schema_subject_path(project: str,location: str,schema_registry: str,subject: str,) -> str:
        """Returns a fully-qualified schema_subject string."""
        return "projects/{project}/locations/{location}/schemaRegistries/{schema_registry}/subjects/{subject}".format(project=project, location=location, schema_registry=schema_registry, subject=subject, )

    @staticmethod
    def parse_schema_subject_path(path: str) -> Dict[str,str]:
        """Parses a schema_subject path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/schemaRegistries/(?P<schema_registry>.+?)/subjects/(?P<subject>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def schema_version_path(project: str,location: str,schema_registry: str,subject: str,version: str,) -> str:
        """Returns a fully-qualified schema_version string."""
        return "projects/{project}/locations/{location}/schemaRegistries/{schema_registry}/subjects/{subject}/versions/{version}".format(project=project, location=location, schema_registry=schema_registry, subject=subject, version=version, )

    @staticmethod
    def parse_schema_version_path(path: str) -> Dict[str,str]:
        """Parses a schema_version path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/schemaRegistries/(?P<schema_registry>.+?)/subjects/(?P<subject>.+?)/versions/(?P<version>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ManagedSchemaRegistryClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ManagedSchemaRegistryTransport, Callable[..., ManagedSchemaRegistryTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ManagedSchemaRegistryClient._read_environment_variables()
        self._client_cert_source = ManagedSchemaRegistryClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ManagedSchemaRegistryClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ManagedSchemaRegistryTransport], Callable[..., ManagedSchemaRegistryTransport]] = (
    ...
    def list_schema_registries(self,
    ...
    def delete_schema_registry(self,
    ...
    def list_subjects_by_schema_id(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_subjects_by_schema_id]
    ...
    def get_raw_schema_version(self,
            request: Optional[Union[schema_registry.GetVersionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def list_referenced_schemas(self,

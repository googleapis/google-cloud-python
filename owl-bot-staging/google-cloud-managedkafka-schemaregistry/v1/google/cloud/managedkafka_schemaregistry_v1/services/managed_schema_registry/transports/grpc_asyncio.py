...
class ManagedSchemaRegistryGrpcAsyncIOTransport(ManagedSchemaRegistryTransport):
    ...
    **Mode** represents the mode of a schema registry or a specific
    ...
    @property
    def get_schema_registry(self) -> Callable[
    ...
    @property
    def list_schema_registries(self) -> Callable[
    ...
    @property
    def create_schema_registry(self) -> Callable[
    ...
    @property
    def delete_schema_registry(self) -> Callable[
    ...
    @property
    def get_raw_schema(self) -> Callable[
            [schema_registry.GetSchemaRequest],
            Awaitable[httpbody_pb2.HttpBody]]:
    ...
    @property
    def list_schema_versions(self) -> Callable[
    ...
    @property
    def list_schema_types(self) -> Callable[
    ...
    @property
    def list_subjects(self) -> Callable[
    ...
    @property
    def list_subjects_by_schema_id(self) -> Callable[
    ...
    @property
    def delete_subject(self) -> Callable[
    ...
    @property
    def lookup_version(self) -> Callable[
    ...
    @property
    def get_raw_schema_version(self) -> Callable[
            [schema_registry.GetVersionRequest],
            Awaitable[httpbody_pb2.HttpBody]]:
    ...
    @property
    def list_referenced_schemas(self) -> Callable[
    ...
    @property
    def get_schema_config(self) -> Callable[
    ...
    @property
    def update_schema_config(self) -> Callable[
    ...
    @property
    def delete_schema_config(self) -> Callable[
    ...
    @property
    def get_schema_mode(self) -> Callable[
    ...
    @property
    def update_schema_mode(self) -> Callable[
    ...
    @property
    def delete_schema_mode(self) -> Callable[

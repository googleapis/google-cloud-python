...
description = "Google Cloud Managedkafka Schemaregistry API client library"
...
url = "https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-managedkafka-schemaregistry"

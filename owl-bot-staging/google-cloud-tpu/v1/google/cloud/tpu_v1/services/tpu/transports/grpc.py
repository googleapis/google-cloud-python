...
class TpuGrpcTransport(TpuTransport):
    ...
    def reimage_node(self) -> Callable[
        ...
        if 'reimage_node' not in self._stubs:
            self._stubs['reimage_node'] = self._logged_channel.unary_unary(
    ...
    def list_tensor_flow_versions(self) -> Callable[
        ...
        if 'list_tensor_flow_versions' not in self._stubs:
            self._stubs['list_tensor_flow_versions'] = self._logged_channel.unary_unary(
    ...
    def get_tensor_flow_version(self) -> Callable[
        ...
        if 'get_tensor_flow_version' not in self._stubs:
            self._stubs['get_tensor_flow_version'] = self._logged_channel.unary_unary(

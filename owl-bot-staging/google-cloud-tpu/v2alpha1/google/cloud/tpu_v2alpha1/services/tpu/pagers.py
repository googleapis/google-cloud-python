...
class ListReservationsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.tpu_v2alpha1.types.ListReservationsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``reservations`` field.
    ...
    All the usual :class:`google.cloud.tpu_v2alpha1.types.ListReservationsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
            method: Callable[..., cloud_tpu.ListReservationsResponse],
            request: cloud_tpu.ListReservationsRequest,
            response: cloud_tpu.ListReservationsResponse,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = ()):
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.tpu_v2alpha1.types.ListReservationsRequest):
                The initial request object.
            response (google.cloud.tpu_v2alpha1.types.ListReservationsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
        ...
        """
        self._method = method
        self._request = cloud_tpu.ListReservationsRequest(request)
        self._response = response
        self._retry = retry
        self._timeout = timeout
        self._metadata = metadata
    ...
    @property
    def pages(self) -> Iterator[cloud_tpu.ListReservationsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
    ...
    def __iter__(self) -> Iterator[cloud_tpu.Reservation]:
        for page in self.pages:
...
class ListReservationsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[cloud_tpu.ListReservationsResponse]],
            request: cloud_tpu.ListReservationsRequest,
            response: cloud_tpu.ListReservationsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[cloud_tpu.ListReservationsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
            yield self._response
    def __aiter__(self) -> AsyncIterator[cloud_tpu.Reservation]:
        async def async_generator():
            async for page in self.pages:

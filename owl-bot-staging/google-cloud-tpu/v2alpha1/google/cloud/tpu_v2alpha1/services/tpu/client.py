...
class TpuClient(metaclass=TpuClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.tpu_v2alpha1.TpuClient`.",
                    extra = {
    ...
    def perform_maintenance(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2alpha1.types.PerformMaintenanceRequest, dict]):
                The request object. Request for
    ...
    def perform_maintenance_queued_resource(self,
            request: Optional[Union[cloud_tpu.PerformMaintenanceQueuedResourceRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            def sample_perform_maintenance_queued_resource():
                # Create a client
                client = tpu_v2alpha1.TpuClient()
        ...
        Args:
            request (Union[google.cloud.tpu_v2alpha1.types.PerformMaintenanceQueuedResourceRequest, dict]):
                The request object. Request for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.perform_maintenance_queued_resource]
    ...
    def list_reservations(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2alpha1.types.ListReservationsRequest, dict]):
                The request object. Request for
        ...
        Returns:
            google.cloud.tpu_v2alpha1.services.tpu.pagers.ListReservationsPager:
                Response for
                   [ListReservations][google.cloud.tpu.v2alpha1.Tpu.ListReservations].

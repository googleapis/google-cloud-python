...
def test_list_queued_resources_rest_required_fields(request_type=cloud_tpu.ListQueuedResourcesRequest):
    transport_class = transports.TpuRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_queued_resources._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_queued_resources_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/locations/*}/queuedResources" % client.transport._host, args[1])
...
def test_list_queued_resources_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(cloud_tpu.ListQueuedResourcesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_queued_resource_rest_required_fields(request_type=cloud_tpu.GetQueuedResourceRequest):
    transport_class = transports.TpuRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_queued_resource._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_queued_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/queuedResources/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/locations/*/queuedResources/*}" % client.transport._host, args[1])
...
def test_create_queued_resource_rest_required_fields(request_type=cloud_tpu.CreateQueuedResourceRequest):
    transport_class = transports.TpuRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_queued_resource._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_queued_resource._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("queued_resource_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_queued_resource_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("queuedResourceId", "requestId", )) & set(("parent", "queuedResource", )))
...
def test_delete_queued_resource_rest_required_fields(request_type=cloud_tpu.DeleteQueuedResourceRequest):
    transport_class = transports.TpuRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_queued_resource._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reset_queued_resource_rest_required_fields(request_type=cloud_tpu.ResetQueuedResourceRequest):
    transport_class = transports.TpuRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).reset_queued_resource._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reset_queued_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/locations/*/queuedResources/*}:reset" % client.transport._host, args[1])
...
def test_list_nodes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_list_nodes_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_tpu.ListNodesResponse.to_json(cloud_tpu.ListNodesResponse())
...
def test_get_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_get_node_with_metadata") as post_with_metadata, \
...
def test_create_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_create_node_with_metadata") as post_with_metadata, \
...
def test_delete_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_delete_node_with_metadata") as post_with_metadata, \
...
def test_stop_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_stop_node_with_metadata") as post_with_metadata, \
...
def test_start_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_start_node_with_metadata") as post_with_metadata, \
...
def test_update_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_update_node_with_metadata") as post_with_metadata, \
...
def test_list_queued_resources_rest_bad_request(request_type=cloud_tpu.ListQueuedResourcesRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_queued_resources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TpuRestInterceptor, "post_list_queued_resources") as post, \
        mock.patch.object(transports.TpuRestInterceptor, "post_list_queued_resources_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TpuRestInterceptor, "pre_list_queued_resources") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_tpu.ListQueuedResourcesRequest.pb(cloud_tpu.ListQueuedResourcesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_tpu.ListQueuedResourcesResponse.to_json(cloud_tpu.ListQueuedResourcesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = cloud_tpu.ListQueuedResourcesResponse(), metadata

        client.list_queued_resources(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_queued_resource_rest_bad_request(request_type=cloud_tpu.GetQueuedResourceRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/queuedResources/sample3'}
    request = request_type(**request_init)
...
def test_get_queued_resource_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TpuRestInterceptor, "post_get_queued_resource") as post, \
        mock.patch.object(transports.TpuRestInterceptor, "post_get_queued_resource_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TpuRestInterceptor, "pre_get_queued_resource") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_tpu.GetQueuedResourceRequest.pb(cloud_tpu.GetQueuedResourceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_queued_resource(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_queued_resource_rest_bad_request(request_type=cloud_tpu.CreateQueuedResourceRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_queued_resource_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.TpuRestInterceptor, "post_create_queued_resource") as post, \
        mock.patch.object(transports.TpuRestInterceptor, "post_create_queued_resource_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TpuRestInterceptor, "pre_create_queued_resource") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_tpu.CreateQueuedResourceRequest.pb(cloud_tpu.CreateQueuedResourceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_queued_resource(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_queued_resource_rest_bad_request(request_type=cloud_tpu.DeleteQueuedResourceRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_queued_resource_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.TpuRestInterceptor, "post_delete_queued_resource") as post, \
        mock.patch.object(transports.TpuRestInterceptor, "post_delete_queued_resource_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TpuRestInterceptor, "pre_delete_queued_resource") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_tpu.DeleteQueuedResourceRequest.pb(cloud_tpu.DeleteQueuedResourceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_queued_resource(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_reset_queued_resource_rest_bad_request(request_type=cloud_tpu.ResetQueuedResourceRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_reset_queued_resource_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.TpuRestInterceptor, "post_reset_queued_resource") as post, \
        mock.patch.object(transports.TpuRestInterceptor, "post_reset_queued_resource_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TpuRestInterceptor, "pre_reset_queued_resource") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_tpu.ResetQueuedResourceRequest.pb(cloud_tpu.ResetQueuedResourceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.reset_queued_resource(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_generate_service_identity_rest_bad_request(request_type=cloud_tpu.GenerateServiceIdentityRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_service_identity_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_generate_service_identity_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_tpu.GenerateServiceIdentityResponse.to_json(cloud_tpu.GenerateServiceIdentityResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = cloud_tpu.GenerateServiceIdentityResponse(), metadata
...
def test_list_accelerator_types_rest_bad_request(request_type=cloud_tpu.ListAcceleratorTypesRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_accelerator_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_list_accelerator_types_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_tpu.ListAcceleratorTypesResponse.to_json(cloud_tpu.ListAcceleratorTypesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = cloud_tpu.ListAcceleratorTypesResponse(), metadata
...
def test_get_accelerator_type_rest_bad_request(request_type=cloud_tpu.GetAcceleratorTypeRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_accelerator_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_get_accelerator_type_with_metadata") as post_with_metadata, \
...
def test_list_runtime_versions_rest_bad_request(request_type=cloud_tpu.ListRuntimeVersionsRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_runtime_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_list_runtime_versions_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_tpu.ListRuntimeVersionsResponse.to_json(cloud_tpu.ListRuntimeVersionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = cloud_tpu.ListRuntimeVersionsResponse(), metadata
...
def test_get_runtime_version_rest_bad_request(request_type=cloud_tpu.GetRuntimeVersionRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_runtime_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_get_runtime_version_with_metadata") as post_with_metadata, \
...
def test_get_guest_attributes_rest_bad_request(request_type=cloud_tpu.GetGuestAttributesRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_guest_attributes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TpuRestInterceptor, "post_get_guest_attributes_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_tpu.GetGuestAttributesResponse.to_json(cloud_tpu.GetGuestAttributesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = cloud_tpu.GetGuestAttributesResponse(), metadata

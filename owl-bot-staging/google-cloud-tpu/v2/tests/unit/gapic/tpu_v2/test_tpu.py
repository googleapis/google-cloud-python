...
def test_list_nodes_rest_unset_required_fields():
    transport = transports.TpuRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_node_rest_required_fields(request_type=cloud_tpu.GetNodeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_node_rest_required_fields(request_type=cloud_tpu.CreateNodeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_node_rest_required_fields(request_type=cloud_tpu.DeleteNodeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_stop_node_rest_required_fields(request_type=cloud_tpu.StopNodeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).stop_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_node_rest_required_fields(request_type=cloud_tpu.StartNodeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).start_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_node_rest_required_fields(request_type=cloud_tpu.UpdateNodeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_service_identity_rest_required_fields(request_type=cloud_tpu.GenerateServiceIdentityRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_service_identity._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_accelerator_types_rest_required_fields(request_type=cloud_tpu.ListAcceleratorTypesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_accelerator_types._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_accelerator_type_rest_required_fields(request_type=cloud_tpu.GetAcceleratorTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_accelerator_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_runtime_versions_rest_required_fields(request_type=cloud_tpu.ListRuntimeVersionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_runtime_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_runtime_version_rest_required_fields(request_type=cloud_tpu.GetRuntimeVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_runtime_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_guest_attributes_rest_required_fields(request_type=cloud_tpu.GetGuestAttributesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_guest_attributes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

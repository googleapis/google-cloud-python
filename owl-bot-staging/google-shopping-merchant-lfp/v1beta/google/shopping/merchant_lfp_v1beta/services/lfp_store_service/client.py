...
class LfpStoreServiceClient(metaclass=LfpStoreServiceClientMeta):
    ...
    @staticmethod
    def lfp_store_path(account: str,target_merchant: str,store_code: str,) -> str:
        """Returns a fully-qualified lfp_store string."""
        return "accounts/{account}/lfpStores/{target_merchant}~{store_code}".format(account=account, target_merchant=target_merchant, store_code=store_code, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            LfpStoreServiceClient._compare_universes(self.universe_domain, self.transport._credentials))

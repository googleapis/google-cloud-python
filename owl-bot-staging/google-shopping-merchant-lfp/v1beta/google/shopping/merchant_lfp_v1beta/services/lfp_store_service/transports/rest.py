...
class LfpStoreServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_lfp_store(self, request: lfpstore.DeleteLfpStoreRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[lfpstore.DeleteLfpStoreRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_lfp_store(self, request: lfpstore.GetLfpStoreRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[lfpstore.GetLfpStoreRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_lfp_store_with_metadata(self, response: lfpstore.LfpStore, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[lfpstore.LfpStore, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_lfp_store
    ...
    def pre_insert_lfp_store(self, request: lfpstore.InsertLfpStoreRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[lfpstore.InsertLfpStoreRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_insert_lfp_store_with_metadata(self, response: lfpstore.LfpStore, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[lfpstore.LfpStore, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for insert_lfp_store
    ...
    def pre_list_lfp_stores(self, request: lfpstore.ListLfpStoresRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[lfpstore.ListLfpStoresRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_lfp_stores_with_metadata(self, response: lfpstore.ListLfpStoresResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[lfpstore.ListLfpStoresResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_lfp_stores
...
class LfpStoreServiceRestTransport(_BaseLfpStoreServiceRestTransport):
    ...
    class _DeleteLfpStore(_BaseLfpStoreServiceRestTransport._BaseDeleteLfpStore, LfpStoreServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LfpStoreServiceRestTransport._DeleteLfpStore._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetLfpStore(_BaseLfpStoreServiceRestTransport._BaseGetLfpStore, LfpStoreServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LfpStoreServiceRestTransport._GetLfpStore._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _InsertLfpStore(_BaseLfpStoreServiceRestTransport._BaseInsertLfpStore, LfpStoreServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LfpStoreServiceRestTransport._InsertLfpStore._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListLfpStores(_BaseLfpStoreServiceRestTransport._BaseListLfpStores, LfpStoreServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LfpStoreServiceRestTransport._ListLfpStores._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

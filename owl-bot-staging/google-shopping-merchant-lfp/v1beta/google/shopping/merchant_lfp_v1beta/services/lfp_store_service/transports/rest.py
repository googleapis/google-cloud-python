...
class LfpStoreServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_lfp_store(self, request: lfpstore.DeleteLfpStoreRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[lfpstore.DeleteLfpStoreRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_lfp_store(self, request: lfpstore.GetLfpStoreRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[lfpstore.GetLfpStoreRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert_lfp_store(self, request: lfpstore.InsertLfpStoreRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[lfpstore.InsertLfpStoreRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_lfp_stores(self, request: lfpstore.ListLfpStoresRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[lfpstore.ListLfpStoresRequest, Sequence[Tuple[str, str]]]:

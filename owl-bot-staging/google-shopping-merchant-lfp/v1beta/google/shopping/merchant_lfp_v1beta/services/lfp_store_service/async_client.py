...
from .transports.base import LfpStoreServiceTransport, DEFAULT_CLIENT_INFO
...
class LfpStoreServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(LfpStoreServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(LfpStoreServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(LfpStoreServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(LfpStoreServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(LfpStoreServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(LfpStoreServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(LfpStoreServiceClient.common_project_path)
    parse_common_project_path = staticmethod(LfpStoreServiceClient.parse_common_project_path)
    common_location_path = staticmethod(LfpStoreServiceClient.common_location_path)
    parse_common_location_path = staticmethod(LfpStoreServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(LfpStoreServiceClient).get_transport_class, type(LfpStoreServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, LfpStoreServiceTransport, Callable[..., LfpStoreServiceTransport]]] = "grpc_asyncio",
    ...
    async def get_lfp_store(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_lfp_store]
    ...
    async def insert_lfp_store(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.insert_lfp_store]
    ...
    async def delete_lfp_store(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_lfp_store]
    ...
    async def list_lfp_stores(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_lfp_stores]

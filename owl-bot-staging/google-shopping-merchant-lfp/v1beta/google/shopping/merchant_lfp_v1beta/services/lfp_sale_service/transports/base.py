...
class LfpSaleServiceTransport(abc.ABC):
    """Abstract transport class for LfpSaleService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.insert_lfp_sale: gapic_v1.method.wrap_method(

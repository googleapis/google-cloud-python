...
class LfpStoreServiceGrpcAsyncIOTransport(LfpStoreServiceTransport):
    """gRPC AsyncIO backend transport for LfpStoreService.
    ...
    def list_lfp_stores(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListLfpStoresRequest],
                    Awaitable[~.ListLfpStoresResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_lfp_store: self._wrap_method(
                self.get_lfp_store,
                default_timeout=None,
                client_info=client_info,
            ),
            self.insert_lfp_store: self._wrap_method(
                self.insert_lfp_store,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_lfp_store: self._wrap_method(
                self.delete_lfp_store,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_lfp_stores: self._wrap_method(
...
__all__ = (
    'LfpStoreServiceGrpcAsyncIOTransport',
)

...
@mock.patch.object(EssentialContactsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EssentialContactsServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert EssentialContactsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == EssentialContactsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EssentialContactsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert EssentialContactsServiceClient._get_api_endpoint(None, None, default_universe, "always") == EssentialContactsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EssentialContactsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EssentialContactsServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_create_contact_rest_required_fields(request_type=service.CreateContactRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_contact._get_unset_required_fields(jsonified_request)
...
def test_create_contact_rest_unset_required_fields():
    transport = transports.EssentialContactsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_contact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "post_create_contact") as post, \
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "pre_create_contact") as pre:
...
def test_update_contact_rest_required_fields(request_type=service.UpdateContactRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_contact._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_contact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "post_update_contact") as post, \
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "pre_update_contact") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_contacts_rest_required_fields(request_type=service.ListContactsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_contacts._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_contacts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "post_list_contacts") as post, \
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "pre_list_contacts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_contact_rest_required_fields(request_type=service.GetContactRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_contact._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_contact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "post_get_contact") as post, \
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "pre_get_contact") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_contact_rest_required_fields(request_type=service.DeleteContactRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_contact._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_contact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "pre_delete_contact") as pre:
        pre.assert_not_called()
...
def test_compute_contacts_rest_required_fields(request_type=service.ComputeContactsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).compute_contacts._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_compute_contacts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "post_compute_contacts") as post, \
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "pre_compute_contacts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_send_test_message_rest_required_fields(request_type=service.SendTestMessageRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).send_test_message._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_send_test_message_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "pre_send_test_message") as pre:
        pre.assert_not_called()

...
def test_create_contact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "post_create_contact_with_metadata") as post_with_metadata, \
...
def test_update_contact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "post_update_contact_with_metadata") as post_with_metadata, \
...
def test_list_contacts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "post_list_contacts_with_metadata") as post_with_metadata, \
...
def test_get_contact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "post_get_contact_with_metadata") as post_with_metadata, \
...
def test_compute_contacts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EssentialContactsServiceRestInterceptor, "post_compute_contacts_with_metadata") as post_with_metadata, \

...
class EssentialContactsServiceClient(metaclass=EssentialContactsServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            EssentialContactsServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._client_cert_source = EssentialContactsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)

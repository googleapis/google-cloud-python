...
class Promotion(proto.Message):
    ...
    Attributes:
        ...
        data_source (str):
            ...
            promotion.
        attributes (google.shopping.merchant_promotions_v1.types.Attributes):
...
class InsertPromotionRequest(proto.Message):
    ...
    Attributes:
        ...
        promotion (google.shopping.merchant_promotions_v1.types.Promotion):
...
class ListPromotionsRequest(proto.Message):
    ...
    Attributes:
        ...
        page_size (int):
            Optional. The maximum number of promotions to
            return. The service may return fewer than this
            value. The maximum value is 250; values above
            250 will be coerced to 250. If unspecified, the
...
class ListPromotionsResponse(proto.Message):
    ...
    Attributes:
        promotions (MutableSequence[google.shopping.merchant_promotions_v1.types.Promotion]):

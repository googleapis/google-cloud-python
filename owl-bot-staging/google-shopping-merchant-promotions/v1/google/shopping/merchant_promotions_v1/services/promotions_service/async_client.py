...
class PromotionsServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(PromotionsServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(PromotionsServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(PromotionsServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(PromotionsServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(PromotionsServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(PromotionsServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(PromotionsServiceClient.common_project_path)
    parse_common_project_path = staticmethod(PromotionsServiceClient.parse_common_project_path)
    common_location_path = staticmethod(PromotionsServiceClient.common_location_path)
    parse_common_location_path = staticmethod(PromotionsServiceClient.parse_common_location_path)
    ...
    get_transport_class = PromotionsServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, PromotionsServiceTransport, Callable[..., PromotionsServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.shopping.merchant.promotions_v1.PromotionsServiceAsyncClient`.",
                extra = {
    ...
    async def insert_promotion(self,
        ...
        .. code-block:: python
            ...
            async def sample_insert_promotion():
                # Create a client
                client = merchant_promotions_v1.PromotionsServiceAsyncClient()

                # Initialize request argument(s)
                promotion = merchant_promotions_v1.Promotion()
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_promotions_v1.types.InsertPromotionRequest, dict]]):
        ...
        Returns:
            google.shopping.merchant_promotions_v1.types.Promotion:
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.insert_promotion]
    ...
    async def get_promotion(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_promotions_v1.types.GetPromotionRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_promotion]
    ...
    async def list_promotions(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_promotions():
                ...
                # Initialize request argument(s)
                request = merchant_promotions_v1.ListPromotionsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_promotions_v1.types.ListPromotionsRequest, dict]]):
        ...
        Returns:
            google.shopping.merchant_promotions_v1.services.promotions_service.pagers.ListPromotionsAsyncPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_promotions]

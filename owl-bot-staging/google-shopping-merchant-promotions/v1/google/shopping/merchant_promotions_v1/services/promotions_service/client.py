...
class PromotionsServiceClient(metaclass=PromotionsServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.promotions_v1.PromotionsServiceClient`.",
                    extra = {
    ...
    def insert_promotion(self,
        ...
        Args:
            request (Union[google.shopping.merchant_promotions_v1.types.InsertPromotionRequest, dict]):
    ...
    def get_promotion(self,
        ...
        Args:
            request (Union[google.shopping.merchant_promotions_v1.types.GetPromotionRequest, dict]):
    ...
    def list_promotions(self,
        ...
        Args:
            request (Union[google.shopping.merchant_promotions_v1.types.ListPromotionsRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_promotions_v1.services.promotions_service.pagers.ListPromotionsPager:

...
from google.shopping.merchant_promotions_v1beta.services.promotions_service import pagers
...
from .transports.base import PromotionsServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import PromotionsServiceGrpcTransport
from .transports.grpc_asyncio import PromotionsServiceGrpcAsyncIOTransport
from .transports.rest import PromotionsServiceRestTransport


class PromotionsServiceClientMeta(type):
    """Metaclass for the PromotionsService client.
...
class PromotionsServiceClient(metaclass=PromotionsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            PromotionsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> PromotionsServiceTransport:
        ...
        Returns:
            PromotionsServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def promotion_path(account: str,promotion: str,) -> str:
        """Returns a fully-qualified promotion string."""
        return "accounts/{account}/promotions/{promotion}".format(account=account, promotion=promotion, )

    @staticmethod
    def parse_promotion_path(path: str) -> Dict[str,str]:
        """Parses a promotion path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/promotions/(?P<promotion>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = PromotionsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = PromotionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = PromotionsServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            PromotionsServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PromotionsServiceTransport, Callable[..., PromotionsServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the promotions service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PromotionsServiceClient._read_environment_variables()
        self._client_cert_source = PromotionsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = PromotionsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, PromotionsServiceTransport)
        if transport_provided:
            # transport is a PromotionsServiceTransport instance.
            ...
            self._transport = cast(PromotionsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            PromotionsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[PromotionsServiceTransport], Callable[..., PromotionsServiceTransport]] = (
    ...
    def insert_promotion(self,
        ...
        .. code-block:: python
            ...
            def sample_insert_promotion():
                ...
                # Make the request
                response = client.insert_promotion(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.shopping.merchant_promotions_v1beta.types.InsertPromotionRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.insert_promotion]
    ...
    def get_promotion(self,
        ...
        Args:
            request (Union[google.shopping.merchant_promotions_v1beta.types.GetPromotionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_promotion]
    ...
    def list_promotions(self,
        ...
        Args:
            request (Union[google.shopping.merchant_promotions_v1beta.types.ListPromotionsRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_promotions_v1beta.services.promotions_service.pagers.ListPromotionsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_promotions]
        ...
        response = pagers.ListPromotionsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def __enter__(self) -> "PromotionsServiceClient":
        return self

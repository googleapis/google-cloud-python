...
class PromotionsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_promotion(self, request: promotions.GetPromotionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[promotions.GetPromotionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_promotion_with_metadata(self, response: promotions.Promotion, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[promotions.Promotion, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_promotion
    ...
    def pre_insert_promotion(self, request: promotions.InsertPromotionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[promotions.InsertPromotionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_insert_promotion_with_metadata(self, response: promotions.Promotion, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[promotions.Promotion, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for insert_promotion
    ...
    def pre_list_promotions(self, request: promotions.ListPromotionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[promotions.ListPromotionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_promotions_with_metadata(self, response: promotions.ListPromotionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[promotions.ListPromotionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_promotions
...
class PromotionsServiceRestTransport(_BasePromotionsServiceRestTransport):
    ...
    class _GetPromotion(_BasePromotionsServiceRestTransport._BaseGetPromotion, PromotionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PromotionsServiceRestTransport._GetPromotion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _InsertPromotion(_BasePromotionsServiceRestTransport._BaseInsertPromotion, PromotionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PromotionsServiceRestTransport._InsertPromotion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListPromotions(_BasePromotionsServiceRestTransport._BaseListPromotions, PromotionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PromotionsServiceRestTransport._ListPromotions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

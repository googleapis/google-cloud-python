...
class PromotionsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_promotion(self, request: promotions.GetPromotionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[promotions.GetPromotionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert_promotion(self, request: promotions.InsertPromotionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[promotions.InsertPromotionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_promotions(self, request: promotions.ListPromotionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[promotions.ListPromotionsRequest, Sequence[Tuple[str, str]]]:

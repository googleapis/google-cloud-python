...
class PromotionsServiceGrpcAsyncIOTransport(PromotionsServiceTransport):
    """gRPC AsyncIO backend transport for PromotionsService.
    ...
    @property
    def insert_promotion(self) -> Callable[
            [promotions.InsertPromotionRequest],
            Awaitable[promotions.Promotion]]:
        r"""Return a callable for the insert promotion method over gRPC.
        ...
        Returns:
            Callable[[~.InsertPromotionRequest],
                    Awaitable[~.Promotion]]:
        ...
        return self._stubs['insert_promotion']

    @property
    def get_promotion(self) -> Callable[
            [promotions.GetPromotionRequest],
            Awaitable[promotions.Promotion]]:
        r"""Return a callable for the get promotion method over gRPC.

        Retrieves the promotion from your Merchant Center
        account.
        ...
        return self._stubs['get_promotion']

    @property
    def list_promotions(self) -> Callable[
            [promotions.ListPromotionsRequest],
            Awaitable[promotions.ListPromotionsResponse]]:
        r"""Return a callable for the list promotions method over gRPC.
        ...
        Returns:
            Callable[[~.ListPromotionsRequest],
                    Awaitable[~.ListPromotionsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        return self._stubs['list_promotions']
...
__all__ = (
    'PromotionsServiceGrpcAsyncIOTransport',
)

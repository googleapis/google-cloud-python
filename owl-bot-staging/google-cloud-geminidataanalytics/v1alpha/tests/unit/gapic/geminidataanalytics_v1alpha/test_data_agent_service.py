...
from google.cloud.geminidataanalytics_v1alpha.services.data_agent_service import DataAgentServiceAsyncClient
from google.cloud.geminidataanalytics_v1alpha.services.data_agent_service import DataAgentServiceClient
from google.cloud.geminidataanalytics_v1alpha.services.data_agent_service import pagers
from google.cloud.geminidataanalytics_v1alpha.services.data_agent_service import transports
from google.cloud.geminidataanalytics_v1alpha.types import context
from google.cloud.geminidataanalytics_v1alpha.types import credentials
...
from google.cloud.geminidataanalytics_v1alpha.types import data_analytics_agent
...
def test_data_agent_service_client_client_options_from_dict():
    with mock.patch('google.cloud.geminidataanalytics_v1alpha.services.data_agent_service.transports.DataAgentServiceGrpcTransport.__init__') as grpc_transport:
...
def test_data_agent_service_base_transport():
    ...
    with mock.patch('google.cloud.geminidataanalytics_v1alpha.services.data_agent_service.transports.DataAgentServiceTransport.__init__') as Transport:
...
def test_data_agent_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.geminidataanalytics_v1alpha.services.data_agent_service.transports.DataAgentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_data_agent_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.geminidataanalytics_v1alpha.services.data_agent_service.transports.DataAgentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataAgentServiceTransport()
        adc.assert_called_once()

...
class DataChatServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_chat(self, request: data_chat_service.ChatRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[data_chat_service.ChatRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_chat_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for chat
    ...
    def pre_create_conversation(self, request: gcg_conversation.CreateConversationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcg_conversation.CreateConversationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_conversation_with_metadata(self, response: gcg_conversation.Conversation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcg_conversation.Conversation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_conversation
    ...
    def pre_list_messages(self, request: data_chat_service.ListMessagesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[data_chat_service.ListMessagesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_messages_with_metadata(self, response: data_chat_service.ListMessagesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[data_chat_service.ListMessagesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_messages
    ...
    def pre_update_conversation(self, request: gcg_conversation.UpdateConversationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcg_conversation.UpdateConversationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_conversation(self, response: gcg_conversation.Conversation) -> gcg_conversation.Conversation:
    ...
    def post_update_conversation_with_metadata(self, response: gcg_conversation.Conversation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcg_conversation.Conversation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_conversation
...
class DataChatServiceRestTransport(_BaseDataChatServiceRestTransport):
    ...
    class _Chat(_BaseDataChatServiceRestTransport._BaseChat, DataChatServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.Chat",
                    extra = {
            ...
            # Send the request
            response = DataChatServiceRestTransport._Chat._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CreateConversation(_BaseDataChatServiceRestTransport._BaseCreateConversation, DataChatServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.CreateConversation",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
            ...
            # Send the request
            response = DataChatServiceRestTransport._CreateConversation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.create_conversation",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
                        "rpcName": "CreateConversation",
                        "metadata": http_response["headers"],
    ...
    class _GetConversation(_BaseDataChatServiceRestTransport._BaseGetConversation, DataChatServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.GetConversation",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
            ...
            # Send the request
            response = DataChatServiceRestTransport._GetConversation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.get_conversation",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
                        "rpcName": "GetConversation",
                        "metadata": http_response["headers"],
    ...
    class _ListConversations(_BaseDataChatServiceRestTransport._BaseListConversations, DataChatServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.ListConversations",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
            ...
            # Send the request
            response = DataChatServiceRestTransport._ListConversations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.list_conversations",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
                        "rpcName": "ListConversations",
                        "metadata": http_response["headers"],
    ...
    class _ListMessages(_BaseDataChatServiceRestTransport._BaseListMessages, DataChatServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.ListMessages",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
            ...
            # Send the request
            response = DataChatServiceRestTransport._ListMessages._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.list_messages",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
                        "rpcName": "ListMessages",
                        "metadata": http_response["headers"],
    ...
    class _UpdateConversation(_BaseDataChatServiceRestTransport._BaseUpdateConversation, DataChatServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseDataChatServiceRestTransport._BaseUpdateConversation._get_transcoded_request(http_options, request)

            body = _BaseDataChatServiceRestTransport._BaseUpdateConversation._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDataChatServiceRestTransport._BaseUpdateConversation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DataChatServiceRestTransport._UpdateConversation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetLocation(_BaseDataChatServiceRestTransport._BaseGetLocation, DataChatServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = DataChatServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1alpha.DataChatServiceAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(_BaseDataChatServiceRestTransport._BaseListLocations, DataChatServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
            ...
            # Send the request
            response = DataChatServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1alpha.DataChatServiceAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseDataChatServiceRestTransport._BaseCancelOperation, DataChatServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
            ...
            # Send the request
            response = DataChatServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteOperation(_BaseDataChatServiceRestTransport._BaseDeleteOperation, DataChatServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.DeleteOperation",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
            ...
            # Send the request
            response = DataChatServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseDataChatServiceRestTransport._BaseGetOperation, DataChatServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
            ...
            # Send the request
            response = DataChatServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1alpha.DataChatServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseDataChatServiceRestTransport._BaseListOperations, DataChatServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
            ...
            # Send the request
            response = DataChatServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1alpha.DataChatServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.geminidataanalytics.v1alpha.DataChatService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

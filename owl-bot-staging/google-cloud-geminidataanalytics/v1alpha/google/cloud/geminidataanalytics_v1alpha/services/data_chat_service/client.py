...
from .transports.base import DataChatServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import DataChatServiceGrpcTransport
from .transports.grpc_asyncio import DataChatServiceGrpcAsyncIOTransport
from .transports.rest import DataChatServiceRestTransport


class DataChatServiceClientMeta(type):
    """Metaclass for the DataChatService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[DataChatServiceTransport]]
    _transport_registry["grpc"] = DataChatServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = DataChatServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = DataChatServiceRestTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[DataChatServiceTransport]:
...
class DataChatServiceClient(metaclass=DataChatServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DataChatServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> DataChatServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            DataChatServiceTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def data_agent_path(project: str,location: str,data_agent: str,) -> str:
        """Returns a fully-qualified data_agent string."""
        return "projects/{project}/locations/{location}/dataAgents/{data_agent}".format(project=project, location=location, data_agent=data_agent, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = DataChatServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = DataChatServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DataChatServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = DataChatServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DataChatServiceTransport, Callable[..., DataChatServiceTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,DataChatServiceTransport,Callable[..., DataChatServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the DataChatServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DataChatServiceClient._read_environment_variables()
        self._client_cert_source = DataChatServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DataChatServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DataChatServiceTransport)
        if transport_provided:
            # transport is a DataChatServiceTransport instance.
            ...
            self._transport = cast(DataChatServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DataChatServiceTransport], Callable[..., DataChatServiceTransport]] = (
                DataChatServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., DataChatServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.geminidataanalytics_v1alpha.DataChatServiceClient`.",
                    extra = {
    ...
    def chat(self,
            request: Optional[Union[data_chat_service.ChatRequest, dict]] = None,
            *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1alpha.types.ChatRequest, dict]):
        ...
        if not isinstance(request, data_chat_service.ChatRequest):
            request = data_chat_service.ChatRequest(request)
    ...
    def create_conversation(self,
            request: Optional[Union[gcg_conversation.CreateConversationRequest, dict]] = None,
            *,
        ...
        r"""Creates a new conversation to persist the
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1alpha.types.CreateConversationRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcg_conversation.CreateConversationRequest):
            request = gcg_conversation.CreateConversationRequest(request)
    ...
    def update_conversation(self,
            request: Optional[Union[gcg_conversation.UpdateConversationRequest, dict]] = None,
            *,
            conversation: Optional[gcg_conversation.Conversation] = None,
    ...
    def get_conversation(self,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1alpha.types.GetConversationRequest, dict]):
    ...
    def list_conversations(self,
        ...
        r"""Lists all conversations for a given parent.
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1alpha.types.ListConversationsRequest, dict]):
    ...
    def list_messages(self,
            request: Optional[Union[data_chat_service.ListMessagesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Lists all messages for a given conversation.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, data_chat_service.ListMessagesRequest):
            request = data_chat_service.ListMessagesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
    ...
    def __enter__(self) -> "DataChatServiceClient":
        return self

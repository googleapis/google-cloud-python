...
class DataChatServiceAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.geminidataanalytics_v1alpha.DataChatServiceAsyncClient`.",
                extra = {
    ...
    def chat(self,
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1alpha.types.ChatRequest, dict]]):
    ...
    async def get_conversation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1alpha.types.GetConversationRequest, dict]]):
    ...
    async def list_conversations(self,
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1alpha.types.ListConversationsRequest, dict]]):
        ...
        Returns:
            google.cloud.geminidataanalytics_v1alpha.services.data_chat_service.pagers.ListConversationsAsyncPager:
    ...
    async def list_messages(self,
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1alpha.types.ListMessagesRequest, dict]]):

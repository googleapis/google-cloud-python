...
from google.cloud.geminidataanalytics_v1alpha.types.conversation import UpdateConversationRequest
...
from google.cloud.geminidataanalytics_v1alpha.types.data_chat_service import ExampleQueries

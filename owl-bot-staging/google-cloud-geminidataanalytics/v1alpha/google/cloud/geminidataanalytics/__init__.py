...
from google.cloud.geminidataanalytics_v1alpha.types.context_retrieval_service import RetrieveBigQueryTableContextRequest
from google.cloud.geminidataanalytics_v1alpha.types.context_retrieval_service import RetrieveBigQueryTableContextResponse

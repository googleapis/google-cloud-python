...
from google.cloud.geminidataanalytics_v1beta.services.data_agent_service import DataAgentServiceAsyncClient
from google.cloud.geminidataanalytics_v1beta.services.data_agent_service import DataAgentServiceClient
from google.cloud.geminidataanalytics_v1beta.services.data_agent_service import pagers
from google.cloud.geminidataanalytics_v1beta.services.data_agent_service import transports
...
from google.cloud.geminidataanalytics_v1beta.types import data_analytics_agent
...
def test__get_api_endpoint():
    ...
    assert DataAgentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DataAgentServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert DataAgentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DataAgentServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    DataAgentServiceClient, DataAgentServiceAsyncClient
])
...
def test_data_agent_service_client_client_options_from_dict():
    with mock.patch('google.cloud.geminidataanalytics_v1beta.services.data_agent_service.transports.DataAgentServiceGrpcTransport.__init__') as grpc_transport:
...
def test_list_data_agents(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.list_data_agents),
            '__call__') as call:
...
def test_list_data_agents_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, data_agent.DataAgent)
                   for i in results)
...
async def test_list_data_agents_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_data_agents(request={},)
...
async def test_list_accessible_data_agents_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_accessible_data_agents(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_data_agent(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_agent),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_data_agent(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_data_agent),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_data_agent_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_data_agent(
            parent='parent_value',
            data_agent=gcg_data_agent.DataAgent(data_analytics_agent=data_analytics_agent.DataAnalyticsAgent(staging_context=context.Context(system_instruction='system_instruction_value'))),
            data_agent_id='data_agent_id_value',
        )
        ...
        mock_val = gcg_data_agent.DataAgent(data_analytics_agent=data_analytics_agent.DataAnalyticsAgent(staging_context=context.Context(system_instruction='system_instruction_value')))
        assert arg == mock_val
...
def test_update_data_agent(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_data_agent),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_data_agent(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_data_agent),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_data_agents_rest_required_fields(request_type=data_agent_service.ListDataAgentsRequest):
    ...
    assert not set(unset_fields) - set(("filter", "order_by", "page_size", "page_token", "show_deleted", ))
    jsonified_request.update(unset_fields)
...
def test_list_data_agents_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "orderBy", "pageSize", "pageToken", "showDeleted", )) & set(("parent", )))
...
def test_list_data_agents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*}/dataAgents" % client.transport._host, args[1])
...
def test_list_accessible_data_agents_rest_required_fields(request_type=data_agent_service.ListAccessibleDataAgentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_accessible_data_agents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_accessible_data_agents._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("creator_filter", "filter", "order_by", "page_size", "page_token", "show_deleted", ))
    jsonified_request.update(unset_fields)
...
def test_list_accessible_data_agents_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("creatorFilter", "filter", "orderBy", "pageSize", "pageToken", "showDeleted", )) & set(("parent", )))
...
def test_list_accessible_data_agents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*}/dataAgents:listAccessible" % client.transport._host, args[1])
...
def test_get_data_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/dataAgents/*}" % client.transport._host, args[1])
...
def test_create_data_agent_rest_required_fields(request_type=data_agent_service.CreateDataAgentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_data_agent._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("data_agent_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_data_agent_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("dataAgentId", "requestId", )) & set(("parent", "dataAgent", )))
...
def test_update_data_agent_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("dataAgent", )))
...
def test_update_data_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{data_agent.name=projects/*/locations/*/dataAgents/*}" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{resource=projects/*/locations/*/dataAgents/*}:getIamPolicy" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{resource=projects/*/locations/*/dataAgents/*}:setIamPolicy" % client.transport._host, args[1])
...
def test_list_data_agents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_list_data_agents") as post, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_list_data_agents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "pre_list_data_agents") as pre:
        ...
        client.list_data_agents(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_accessible_data_agents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_list_accessible_data_agents") as post, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_list_accessible_data_agents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "pre_list_accessible_data_agents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_accessible_data_agents(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_data_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_get_data_agent") as post, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_get_data_agent_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "pre_get_data_agent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_data_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_data_agent_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["data_agent"] = {'data_analytics_agent': {'staging_context': {'system_instruction': 'system_instruction_value', 'datasource_references': {'bq': {'table_references': [{'project_id': 'project_id_value', 'dataset_id': 'dataset_id_value', 'table_id': 'table_id_value'}]}, 'studio': {'studio_references': [{'datasource_id': 'datasource_id_value'}]}, 'looker': {'explore_references': [{'looker_instance_uri': 'looker_instance_uri_value', 'private_looker_instance_info': {'looker_instance_id': 'looker_instance_id_value', 'service_directory_name': 'service_directory_name_value'}, 'lookml_model': 'lookml_model_value', 'explore': 'explore_value', 'schema': {'fields': [{'name': 'name_value', 'type_': 'type__value', 'description': 'description_value', 'mode': 'mode_value', 'display_name': 'display_name_value', 'subfields': {}, 'category': 'category_value'}], 'display_name': 'display_name_value'}}], 'credentials': {'oauth': {'secret': {'client_id': 'client_id_value', 'client_secret': 'client_secret_value'}, 'token': {'access_token': 'access_token_value'}}}}}, 'options': {'chart': {'image': {'no_image': {}, 'svg': {}}}, 'analysis': {'python': {'enabled': True}}}}, 'published_context': {}, 'last_published_context': {}}, 'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'labels': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'purge_time': {}}
...
def test_create_data_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_create_data_agent") as post, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_create_data_agent_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "pre_create_data_agent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_data_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_data_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_update_data_agent") as post, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_update_data_agent_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "pre_update_data_agent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_data_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_data_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_delete_data_agent") as post, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_delete_data_agent_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "pre_delete_data_agent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_data_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataAgentServiceRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_data_agent_service_base_transport():
    ...
    with mock.patch('google.cloud.geminidataanalytics_v1beta.services.data_agent_service.transports.DataAgentServiceTransport.__init__') as Transport:
...
def test_data_agent_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.geminidataanalytics_v1beta.services.data_agent_service.transports.DataAgentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_data_agent_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.geminidataanalytics_v1beta.services.data_agent_service.transports.DataAgentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataAgentServiceTransport()
        adc.assert_called_once()
...
def test_data_agent_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DataAgentServiceGrpcTransport, transports.DataAgentServiceGrpcAsyncIOTransport])
def test_data_agent_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

...
from .base import ContextRetrievalServiceTransport, DEFAULT_CLIENT_INFO
from .grpc import ContextRetrievalServiceGrpcTransport
...
class ContextRetrievalServiceGrpcAsyncIOTransport(ContextRetrievalServiceTransport):
    """gRPC AsyncIO backend transport for ContextRetrievalService.
    ...
    @property
    def retrieve_big_query_table_context(self) -> Callable[
        ...
        Returns:
            Callable[[~.RetrieveBigQueryTableContextRequest],
                    Awaitable[~.RetrieveBigQueryTableContextResponse]]:
        ...
        if 'retrieve_big_query_table_context' not in self._stubs:
            self._stubs['retrieve_big_query_table_context'] = self._logged_channel.unary_unary(
    ...
    @property
    def retrieve_big_query_table_contexts(self) -> Callable[
        ...
        if 'retrieve_big_query_table_contexts' not in self._stubs:
            self._stubs['retrieve_big_query_table_contexts'] = self._logged_channel.unary_unary(
    ...
    @property
    def retrieve_big_query_table_contexts_from_recent_tables(self) -> Callable[
            [context_retrieval_service.RetrieveBigQueryTableContextsFromRecentTablesRequest],
            Awaitable[context_retrieval_service.RetrieveBigQueryTableContextsFromRecentTablesResponse]]:
        r"""Return a callable for the retrieve big query table
        contexts from recent tables method over gRPC.

        Retrieves BigQuery table contextual data from
        recently accessed tables. Contextual data includes table
        schema information as well as sample values.

        Returns:
            Callable[[~.RetrieveBigQueryTableContextsFromRecentTablesRequest],
                    Awaitable[~.RetrieveBigQueryTableContextsFromRecentTablesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'retrieve_big_query_table_contexts_from_recent_tables' not in self._stubs:
            self._stubs['retrieve_big_query_table_contexts_from_recent_tables'] = self._logged_channel.unary_unary(
                '/google.cloud.geminidataanalytics.v1beta.ContextRetrievalService/RetrieveBigQueryTableContextsFromRecentTables',
                request_serializer=context_retrieval_service.RetrieveBigQueryTableContextsFromRecentTablesRequest.serialize,
                response_deserializer=context_retrieval_service.RetrieveBigQueryTableContextsFromRecentTablesResponse.deserialize,
            )
        return self._stubs['retrieve_big_query_table_contexts_from_recent_tables']

    @property
    def retrieve_big_query_table_suggested_descriptions(self) -> Callable[
            [context_retrieval_service.RetrieveBigQueryTableSuggestedDescriptionsRequest],
            Awaitable[context_retrieval_service.RetrieveBigQueryTableSuggestedDescriptionsResponse]]:
        r"""Return a callable for the retrieve big query table
        suggested descriptions method over gRPC.

        Retrieves BigQuery table schema with suggested table
        and column descriptions.

        Returns:
            Callable[[~.RetrieveBigQueryTableSuggestedDescriptionsRequest],
                    Awaitable[~.RetrieveBigQueryTableSuggestedDescriptionsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'retrieve_big_query_table_suggested_descriptions' not in self._stubs:
            self._stubs['retrieve_big_query_table_suggested_descriptions'] = self._logged_channel.unary_unary(
                '/google.cloud.geminidataanalytics.v1beta.ContextRetrievalService/RetrieveBigQueryTableSuggestedDescriptions',
                request_serializer=context_retrieval_service.RetrieveBigQueryTableSuggestedDescriptionsRequest.serialize,
                response_deserializer=context_retrieval_service.RetrieveBigQueryTableSuggestedDescriptionsResponse.deserialize,
            )
        return self._stubs['retrieve_big_query_table_suggested_descriptions']

    @property
    def retrieve_big_query_table_suggested_examples(self) -> Callable[
            [context_retrieval_service.RetrieveBigQueryTableSuggestedExamplesRequest],
            Awaitable[context_retrieval_service.RetrieveBigQueryTableSuggestedExamplesResponse]]:
        r"""Return a callable for the retrieve big query table
        ...
        if 'retrieve_big_query_table_suggested_examples' not in self._stubs:
            self._stubs['retrieve_big_query_table_suggested_examples'] = self._logged_channel.unary_unary(
    ...
    @property
    def retrieve_big_query_recent_relevant_tables(self) -> Callable[
            [context_retrieval_service.RetrieveBigQueryRecentRelevantTablesRequest],
            Awaitable[context_retrieval_service.RetrieveBigQueryRecentRelevantTablesResponse]]:
        r"""Return a callable for the retrieve big query recent
        relevant tables method over gRPC.

        Retrieves BigQuery table references from recently
        accessed tables.

        Returns:
            Callable[[~.RetrieveBigQueryRecentRelevantTablesRequest],
                    Awaitable[~.RetrieveBigQueryRecentRelevantTablesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'retrieve_big_query_recent_relevant_tables' not in self._stubs:
            self._stubs['retrieve_big_query_recent_relevant_tables'] = self._logged_channel.unary_unary(
                '/google.cloud.geminidataanalytics.v1beta.ContextRetrievalService/RetrieveBigQueryRecentRelevantTables',
                request_serializer=context_retrieval_service.RetrieveBigQueryRecentRelevantTablesRequest.serialize,
                response_deserializer=context_retrieval_service.RetrieveBigQueryRecentRelevantTablesResponse.deserialize,
            )
        return self._stubs['retrieve_big_query_recent_relevant_tables']

    def _prep_wrapped_messages(self, client_info):
        """ Precompute the wrapped methods, overriding the base class method to use async wrappers."""
        self._wrapped_methods = {
            self.retrieve_big_query_table_context: self._wrap_method(
            ...
            self.retrieve_big_query_recent_relevant_tables: self._wrap_method(
                self.retrieve_big_query_recent_relevant_tables,
                default_timeout=None,
                client_info=client_info,
            ),
...
__all__ = (
    'ContextRetrievalServiceGrpcAsyncIOTransport',
)

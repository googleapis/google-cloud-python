...
from .base import DataChatServiceTransport, DEFAULT_CLIENT_INFO
from .grpc import DataChatServiceGrpcTransport
...
class DataChatServiceGrpcAsyncIOTransport(DataChatServiceTransport):
    ...
    def chat(self) -> Callable[
            ...
            Awaitable[data_chat_service.Message]]:
        ...
        if 'chat' not in self._stubs:
            self._stubs['chat'] = self._logged_channel.unary_stream(
                '/google.cloud.geminidataanalytics.v1beta.DataChatService/Chat',
                request_serializer=data_chat_service.ChatRequest.serialize,
                response_deserializer=data_chat_service.Message.deserialize,
            )
    ...
    def create_conversation(self) -> Callable[
        ...
        if 'create_conversation' not in self._stubs:
            self._stubs['create_conversation'] = self._logged_channel.unary_unary(
                ...
                request_serializer=gcg_conversation.CreateConversationRequest.serialize,
    ...
    def list_messages(self) -> Callable[
        ...
        if 'list_messages' not in self._stubs:
            self._stubs['list_messages'] = self._logged_channel.unary_unary(
                ...
                request_serializer=data_chat_service.ListMessagesRequest.serialize,
                response_deserializer=data_chat_service.ListMessagesResponse.deserialize,
            )
...
__all__ = (
    'DataChatServiceGrpcAsyncIOTransport',
)

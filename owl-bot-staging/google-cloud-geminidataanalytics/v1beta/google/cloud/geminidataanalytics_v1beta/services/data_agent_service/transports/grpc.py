...
from .base import DataAgentServiceTransport, DEFAULT_CLIENT_INFO
...
class DataAgentServiceGrpcTransport(DataAgentServiceTransport):
    """gRPC backend transport for DataAgentService.
    ...
    @property
    def list_data_agents(self) -> Callable[
    ...
    @property
    def list_accessible_data_agents(self) -> Callable[
        ...
        if 'list_accessible_data_agents' not in self._stubs:
            self._stubs['list_accessible_data_agents'] = self._logged_channel.unary_unary(
    ...
    @property
    def get_data_agent(self) -> Callable[
    ...
    @property
    def update_data_agent(self) -> Callable[
    ...
    @property
    def delete_data_agent(self) -> Callable[

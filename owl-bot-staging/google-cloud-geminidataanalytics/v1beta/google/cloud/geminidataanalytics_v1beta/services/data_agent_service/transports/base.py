...
class DataAgentServiceTransport(abc.ABC):
    """Abstract transport class for DataAgentService."""

    AUTH_SCOPES = (
        'https://www.googleapis.com/auth/cloud-platform',
    )

    DEFAULT_HOST: str = 'geminidataanalytics.googleapis.com'
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_data_agents: gapic_v1.method.wrap_method(
            ...
            self.create_data_agent: gapic_v1.method.wrap_method(
    ...
    def get_data_agent(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[data_agent.DataAgent]
            ]]:
        raise NotImplementedError()

...
class ListDataAgentsPager:
    ...
    :class:`google.cloud.geminidataanalytics_v1beta.types.ListDataAgentsResponse` object, and
    ...
    All the usual :class:`google.cloud.geminidataanalytics_v1beta.types.ListDataAgentsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.geminidataanalytics_v1beta.types.ListDataAgentsRequest):
                The initial request object.
            response (google.cloud.geminidataanalytics_v1beta.types.ListDataAgentsResponse):
...
class ListAccessibleDataAgentsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.geminidataanalytics_v1beta.types.ListAccessibleDataAgentsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``data_agents`` field.
    ...
    All the usual :class:`google.cloud.geminidataanalytics_v1beta.types.ListAccessibleDataAgentsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.geminidataanalytics_v1beta.types.ListAccessibleDataAgentsRequest):
                The initial request object.
            response (google.cloud.geminidataanalytics_v1beta.types.ListAccessibleDataAgentsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListAccessibleDataAgentsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[data_agent_service.ListAccessibleDataAgentsResponse]],
            request: data_agent_service.ListAccessibleDataAgentsRequest,
            response: data_agent_service.ListAccessibleDataAgentsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[data_agent_service.ListAccessibleDataAgentsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)

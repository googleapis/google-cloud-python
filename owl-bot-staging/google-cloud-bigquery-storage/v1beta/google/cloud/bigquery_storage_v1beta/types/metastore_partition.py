...
class BatchDeleteMetastorePartitionsRequest(proto.Message):
    ...
    partition_values: MutableSequence[partition.MetastorePartitionValues] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class StreamMetastorePartitionsRequest(proto.Message):
    ...
    metastore_partitions: MutableSequence[partition.MetastorePartition] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
        message=partition.MetastorePartition,
    )

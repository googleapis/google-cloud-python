...
class MetastorePartitionServiceClient(metaclass=MetastorePartitionServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = MetastorePartitionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, MetastorePartitionServiceTransport, Callable[..., MetastorePartitionServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = MetastorePartitionServiceClient._read_environment_variables()
        self._client_cert_source = MetastorePartitionServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = MetastorePartitionServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[MetastorePartitionServiceTransport], Callable[..., MetastorePartitionServiceTransport]] = (
    ...
    def batch_create_metastore_partitions(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.batch_create_metastore_partitions]
    ...
    def batch_delete_metastore_partitions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_delete_metastore_partitions]
    ...
    def batch_update_metastore_partitions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_update_metastore_partitions]
    ...
    def list_metastore_partitions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_metastore_partitions]
    ...
    def stream_metastore_partitions(self,
            requests: Optional[Iterator[metastore_partition.StreamMetastorePartitionsRequest]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.stream_metastore_partitions]

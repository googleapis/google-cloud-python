...
class BigQueryReadAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BigQueryReadTransport, Callable[..., BigQueryReadTransport]]] = "grpc_asyncio",
    ...
    async def create_read_session(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_read_session]
    ...
    async def split_read_stream(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.split_read_stream]

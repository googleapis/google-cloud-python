...
from google.cloud.bigquery_storage_v1.types.storage import BatchCommitWriteStreamsRequest
from google.cloud.bigquery_storage_v1.types.storage import BatchCommitWriteStreamsResponse

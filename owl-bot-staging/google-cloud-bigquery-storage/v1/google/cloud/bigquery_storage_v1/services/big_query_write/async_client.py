...
class BigQueryWriteAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BigQueryWriteTransport, Callable[..., BigQueryWriteTransport]]] = "grpc_asyncio",
    ...
    async def create_write_stream(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_write_stream]
    ...
    def append_rows(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.append_rows]
    ...
    async def get_write_stream(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_write_stream]
    ...
    async def finalize_write_stream(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.finalize_write_stream]
    ...
    async def batch_commit_write_streams(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_commit_write_streams]
    ...
    async def flush_rows(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.flush_rows]

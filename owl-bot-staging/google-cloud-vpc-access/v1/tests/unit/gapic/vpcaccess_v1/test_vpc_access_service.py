...
from google.cloud.vpcaccess_v1.services.vpc_access_service import VpcAccessServiceAsyncClient
...
def test__get_api_endpoint():
    ...
    assert VpcAccessServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == VpcAccessServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert VpcAccessServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == VpcAccessServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    VpcAccessServiceClient, VpcAccessServiceAsyncClient
])
...
def test_list_connectors_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, vpc_access.Connector)
                   for i in results)
...
def test_create_connector_rest_required_fields(request_type=vpc_access.CreateConnectorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_connector._get_unset_required_fields(jsonified_request)
...
def test_create_connector_rest_unset_required_fields():
    transport = transports.VpcAccessServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.VpcAccessServiceRestInterceptor, "post_create_connector") as post, \
         mock.patch.object(transports.VpcAccessServiceRestInterceptor, "pre_create_connector") as pre:
...
def test_get_connector_rest_required_fields(request_type=vpc_access.GetConnectorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_connector._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VpcAccessServiceRestInterceptor, "post_get_connector") as post, \
         mock.patch.object(transports.VpcAccessServiceRestInterceptor, "pre_get_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_connectors_rest_required_fields(request_type=vpc_access.ListConnectorsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_connectors._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_connectors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VpcAccessServiceRestInterceptor, "post_list_connectors") as post, \
         mock.patch.object(transports.VpcAccessServiceRestInterceptor, "pre_list_connectors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_connector_rest_required_fields(request_type=vpc_access.DeleteConnectorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_connector._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VpcAccessServiceRestInterceptor, "post_delete_connector") as post, \
         mock.patch.object(transports.VpcAccessServiceRestInterceptor, "pre_delete_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_vpc_access_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.VpcAccessServiceGrpcTransport, transports.VpcAccessServiceGrpcAsyncIOTransport])
def test_vpc_access_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

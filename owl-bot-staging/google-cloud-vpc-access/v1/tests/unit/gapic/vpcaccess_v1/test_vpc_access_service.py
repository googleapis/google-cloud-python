...
def test_create_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VpcAccessServiceRestInterceptor, "post_create_connector_with_metadata") as post_with_metadata, \
...
def test_get_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VpcAccessServiceRestInterceptor, "post_get_connector_with_metadata") as post_with_metadata, \
...
def test_list_connectors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VpcAccessServiceRestInterceptor, "post_list_connectors_with_metadata") as post_with_metadata, \
...
def test_delete_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VpcAccessServiceRestInterceptor, "post_delete_connector_with_metadata") as post_with_metadata, \

...
class VpcAccessServiceClient(metaclass=VpcAccessServiceClientMeta):
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = VpcAccessServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            VpcAccessServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            VpcAccessServiceClient._get_api_endpoint(

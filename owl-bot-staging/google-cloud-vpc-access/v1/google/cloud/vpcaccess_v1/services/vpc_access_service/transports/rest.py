...
class VpcAccessServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_connector(self, request: vpc_access.CreateConnectorRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[vpc_access.CreateConnectorRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_connector_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_connector

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the VpcAccessService server but before it is returned to user code.
    ...
    def pre_delete_connector(self, request: vpc_access.DeleteConnectorRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[vpc_access.DeleteConnectorRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_connector(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the VpcAccessService server but before
        it is returned to user code. This `post_delete_connector` interceptor runs
        before the `post_delete_connector_with_metadata` interceptor.
        """
        return response

    def post_delete_connector_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_connector

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the VpcAccessService server but before it is returned to user code.

        We recommend only using this `post_delete_connector_with_metadata`
        interceptor in new development instead of the `post_delete_connector` interceptor.
        When both interceptors are used, this `post_delete_connector_with_metadata` interceptor runs after the
        `post_delete_connector` interceptor. The (possibly modified) response returned by
        `post_delete_connector` will be passed to
        `post_delete_connector_with_metadata`.
        """
        return response, metadata

    def pre_get_connector(self, request: vpc_access.GetConnectorRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[vpc_access.GetConnectorRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_connector_with_metadata(self, response: vpc_access.Connector, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[vpc_access.Connector, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_connector
    ...
    def pre_list_connectors(self, request: vpc_access.ListConnectorsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[vpc_access.ListConnectorsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_connectors_with_metadata(self, response: vpc_access.ListConnectorsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[vpc_access.ListConnectorsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_connectors
...
class VpcAccessServiceRestTransport(_BaseVpcAccessServiceRestTransport):
    ...
    class _CreateConnector(_BaseVpcAccessServiceRestTransport._BaseCreateConnector, VpcAccessServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = VpcAccessServiceRestTransport._CreateConnector._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteConnector(_BaseVpcAccessServiceRestTransport._BaseDeleteConnector, VpcAccessServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = VpcAccessServiceRestTransport._DeleteConnector._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetConnector(_BaseVpcAccessServiceRestTransport._BaseGetConnector, VpcAccessServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = VpcAccessServiceRestTransport._GetConnector._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListConnectors(_BaseVpcAccessServiceRestTransport._BaseListConnectors, VpcAccessServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = VpcAccessServiceRestTransport._ListConnectors._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseVpcAccessServiceRestTransport._BaseListLocations, VpcAccessServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = VpcAccessServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseVpcAccessServiceRestTransport._BaseGetOperation, VpcAccessServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = VpcAccessServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseVpcAccessServiceRestTransport._BaseListOperations, VpcAccessServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = VpcAccessServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

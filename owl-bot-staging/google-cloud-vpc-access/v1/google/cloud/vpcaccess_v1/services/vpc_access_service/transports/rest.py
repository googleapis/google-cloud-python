...
class VpcAccessServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_connector(self, request: vpc_access.CreateConnectorRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[vpc_access.CreateConnectorRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_connector(self, request: vpc_access.DeleteConnectorRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[vpc_access.DeleteConnectorRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_connector(self, request: vpc_access.GetConnectorRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[vpc_access.GetConnectorRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_connectors(self, request: vpc_access.ListConnectorsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[vpc_access.ListConnectorsRequest, Sequence[Tuple[str, str]]]:

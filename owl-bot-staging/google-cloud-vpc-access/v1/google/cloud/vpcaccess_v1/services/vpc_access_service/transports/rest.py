...
from .base import VpcAccessServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class VpcAccessServiceRestTransport(VpcAccessServiceTransport):
    """REST backend transport for VpcAccessService.
    ...
    class _CreateConnector(VpcAccessServiceRestStub):
        def __hash__(self):
            return hash("CreateConnector")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=projects/*/locations/*}/connectors',
                'body': 'connector',
            },
            ]
            request, metadata = self._interceptor.pre_create_connector(request, metadata)
            pb_request = vpc_access.CreateConnectorRequest.pb(request)
    ...
    class _DeleteConnector(VpcAccessServiceRestStub):
        def __hash__(self):
            return hash("DeleteConnector")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1/{name=projects/*/locations/*/connectors/*}',
            },
            ]
            request, metadata = self._interceptor.pre_delete_connector(request, metadata)
            pb_request = vpc_access.DeleteConnectorRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetConnector(VpcAccessServiceRestStub):
        def __hash__(self):
            return hash("GetConnector")
        ...
        def __call__(self,
            ...
            pb_request = vpc_access.GetConnectorRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListConnectors(VpcAccessServiceRestStub):
        def __hash__(self):
            return hash("ListConnectors")
        ...
        def __call__(self,
            ...
            pb_request = vpc_access.ListConnectorsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListLocations(VpcAccessServiceRestStub):
        def __call__(self,
    ...
    class _GetOperation(VpcAccessServiceRestStub):
        def __call__(self,
    ...
    class _ListOperations(VpcAccessServiceRestStub):
        def __call__(self,

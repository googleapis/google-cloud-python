...
class PolicyBasedRoutingServiceGrpcTransport(PolicyBasedRoutingServiceTransport):
    """gRPC backend transport for PolicyBasedRoutingService.
    ...
    @property
    def list_policy_based_routes(self) -> Callable[
    ...
    @property
    def get_policy_based_route(self) -> Callable[
    ...
    @property
    def create_policy_based_route(self) -> Callable[
    ...
    @property
    def delete_policy_based_route(self) -> Callable[

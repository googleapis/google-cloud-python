...
class PolicyBasedRoutingServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(PolicyBasedRoutingServiceClient).get_transport_class, type(PolicyBasedRoutingServiceClient))
    ...
    async def list_policy_based_routes(self,
    ...
    async def get_policy_based_route(self,
    ...
    async def create_policy_based_route(self,
    ...
    async def delete_policy_based_route(self,

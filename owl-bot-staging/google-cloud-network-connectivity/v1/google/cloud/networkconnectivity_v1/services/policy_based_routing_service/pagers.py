...
class ListPolicyBasedRoutesAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[policy_based_routing.ListPolicyBasedRoutesResponse]],
            request: policy_based_routing.ListPolicyBasedRoutesRequest,
            response: policy_based_routing.ListPolicyBasedRoutesResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[policy_based_routing.ListPolicyBasedRoutesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

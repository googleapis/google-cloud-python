...
from .transports.grpc import PolicyBasedRoutingServiceGrpcTransport
from .transports.grpc_asyncio import PolicyBasedRoutingServiceGrpcAsyncIOTransport


class PolicyBasedRoutingServiceClientMeta(type):
    """Metaclass for the PolicyBasedRoutingService client.
...
class PolicyBasedRoutingServiceClient(metaclass=PolicyBasedRoutingServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            PolicyBasedRoutingServiceClient: The constructed client.
        """
    ...
    def transport(self) -> PolicyBasedRoutingServiceTransport:
        ...
        Returns:
            PolicyBasedRoutingServiceTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def policy_based_route_path(project: str,policy_based_route: str,) -> str:
        """Returns a fully-qualified policy_based_route string."""
        return "projects/{project}/locations/global/PolicyBasedRoutes/{policy_based_route}".format(project=project, policy_based_route=policy_based_route, )

    @staticmethod
    def parse_policy_based_route_path(path: str) -> Dict[str,str]:
        """Parses a policy_based_route path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/global/PolicyBasedRoutes/(?P<policy_based_route>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = PolicyBasedRoutingServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = PolicyBasedRoutingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = PolicyBasedRoutingServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            PolicyBasedRoutingServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PolicyBasedRoutingServiceTransport, Callable[..., PolicyBasedRoutingServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PolicyBasedRoutingServiceClient._read_environment_variables()
        self._client_cert_source = PolicyBasedRoutingServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = PolicyBasedRoutingServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, PolicyBasedRoutingServiceTransport)
        if transport_provided:
            # transport is a PolicyBasedRoutingServiceTransport instance.
            ...
            self._transport = cast(PolicyBasedRoutingServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[PolicyBasedRoutingServiceTransport], Callable[..., PolicyBasedRoutingServiceTransport]] = (
    ...
    def list_policy_based_routes(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_policy_based_routes]
        ...
        response = pagers.ListPolicyBasedRoutesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_policy_based_route(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_policy_based_route]
    ...
    def create_policy_based_route(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_policy_based_route]
    ...
    def delete_policy_based_route(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_policy_based_route]

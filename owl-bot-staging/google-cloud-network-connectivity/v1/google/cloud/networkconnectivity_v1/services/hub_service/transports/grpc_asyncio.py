...
class HubServiceGrpcAsyncIOTransport(HubServiceTransport):
    ...
    def list_hub_spokes(self) -> Callable[
            ...
            Awaitable[hub.ListHubSpokesResponse]]:
    ...
    def query_hub_status(self) -> Callable[
            ...
            Awaitable[hub.QueryHubStatusResponse]]:
    ...
    def list_routes(self) -> Callable[
            ...
            Awaitable[hub.ListRoutesResponse]]:
    ...
    def list_route_tables(self) -> Callable[
            ...
            Awaitable[hub.ListRouteTablesResponse]]:
    ...
    def list_groups(self) -> Callable[
            ...
            Awaitable[hub.ListGroupsResponse]]:

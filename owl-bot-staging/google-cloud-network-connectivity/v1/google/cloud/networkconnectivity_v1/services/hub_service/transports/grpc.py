...
class HubServiceGrpcTransport(HubServiceTransport):
    ...
    @property
    def list_hub_spokes(self) -> Callable[
    ...
    @property
    def query_hub_status(self) -> Callable[
            [hub.QueryHubStatusRequest],
            hub.QueryHubStatusResponse]:
    ...
    @property
    def reject_hub_spoke(self) -> Callable[
    ...
    @property
    def accept_hub_spoke(self) -> Callable[
    ...
    @property
    def accept_spoke_update(self) -> Callable[
    ...
    @property
    def reject_spoke_update(self) -> Callable[
    ...
    @property
    def get_route_table(self) -> Callable[
    ...
    @property
    def list_route_tables(self) -> Callable[

...
class HubServiceClient(metaclass=HubServiceClientMeta):
    ...
    @staticmethod
    def group_path(project: str,hub: str,group: str,) -> str:
        """Returns a fully-qualified group string."""
        return "projects/{project}/locations/global/hubs/{hub}/groups/{group}".format(project=project, hub=hub, group=group, )

    @staticmethod
    def parse_group_path(path: str) -> Dict[str,str]:
        """Parses a group path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/global/hubs/(?P<hub>.+?)/groups/(?P<group>.+?)$", path)
    ...
    @staticmethod
    def hub_route_path(project: str,hub: str,route_table: str,route: str,) -> str:
        """Returns a fully-qualified hub_route string."""
        return "projects/{project}/locations/global/hubs/{hub}/routeTables/{route_table}/routes/{route}".format(project=project, hub=hub, route_table=route_table, route=route, )

    @staticmethod
    def parse_hub_route_path(path: str) -> Dict[str,str]:
        """Parses a hub_route path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/global/hubs/(?P<hub>.+?)/routeTables/(?P<route_table>.+?)/routes/(?P<route>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def route_table_path(project: str,hub: str,route_table: str,) -> str:
        """Returns a fully-qualified route_table string."""
        return "projects/{project}/locations/global/hubs/{hub}/routeTables/{route_table}".format(project=project, hub=hub, route_table=route_table, )

    @staticmethod
    def parse_route_table_path(path: str) -> Dict[str,str]:
        """Parses a route_table path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/global/hubs/(?P<hub>.+?)/routeTables/(?P<route_table>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.networkconnectivity_v1.HubServiceClient`.",
                    extra = {
    ...
    def list_hub_spokes(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.ListHubSpokesRequest, dict]):
                The request object. The request for
    ...
    def query_hub_status(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.QueryHubStatusRequest, dict]):
                The request object. The request for
    ...
    def reject_hub_spoke(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.RejectHubSpokeRequest, dict]):
                The request object. The request for
    ...
    def accept_hub_spoke(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.AcceptHubSpokeRequest, dict]):
                The request object. The request for
    ...
    def accept_spoke_update(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.AcceptSpokeUpdateRequest, dict]):
                The request object. The request for
    ...
    def reject_spoke_update(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.RejectSpokeUpdateRequest, dict]):
                The request object. The request for
    ...
    def get_route_table(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.GetRouteTableRequest, dict]):
                The request object. The request for
    ...
    def get_route(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.GetRouteRequest, dict]):
                The request object. The request for
    ...
    def list_routes(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.ListRoutesRequest, dict]):
                The request object. Request for
    ...
    def list_route_tables(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.ListRouteTablesRequest, dict]):
                The request object. Request for
    ...
    def get_group(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.GetGroupRequest, dict]):
                The request object. The request for
    ...
    def list_groups(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.ListGroupsRequest, dict]):
                The request object. Request for
    ...
    def update_group(self,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1.types.UpdateGroupRequest, dict]):
                The request object. Request for

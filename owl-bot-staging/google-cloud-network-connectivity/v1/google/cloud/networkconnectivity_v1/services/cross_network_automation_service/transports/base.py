...
class CrossNetworkAutomationServiceTransport(abc.ABC):
    ...
    @property
    def list_service_connection_maps(self) -> Callable[
    ...
    @property
    def get_service_connection_map(self) -> Callable[
    ...
    @property
    def create_service_connection_map(self) -> Callable[
    ...
    @property
    def update_service_connection_map(self) -> Callable[
    ...
    @property
    def delete_service_connection_map(self) -> Callable[
    ...
    @property
    def list_service_connection_policies(self) -> Callable[
    ...
    @property
    def get_service_connection_policy(self) -> Callable[
    ...
    @property
    def create_service_connection_policy(self) -> Callable[
    ...
    @property
    def update_service_connection_policy(self) -> Callable[
    ...
    @property
    def delete_service_connection_policy(self) -> Callable[
    ...
    @property
    def list_service_classes(self) -> Callable[
    ...
    @property
    def get_service_class(self) -> Callable[
    ...
    @property
    def update_service_class(self) -> Callable[
    ...
    @property
    def delete_service_class(self) -> Callable[
    ...
    @property
    def get_service_connection_token(self) -> Callable[
    ...
    @property
    def list_service_connection_tokens(self) -> Callable[
    ...
    @property
    def create_service_connection_token(self) -> Callable[
    ...
    @property
    def delete_service_connection_token(self) -> Callable[

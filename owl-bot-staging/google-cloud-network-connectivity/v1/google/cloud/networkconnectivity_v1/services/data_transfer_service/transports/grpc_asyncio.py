...
class DataTransferServiceGrpcAsyncIOTransport(DataTransferServiceTransport):
    ...
    @property
    def list_multicloud_data_transfer_configs(self) -> Callable[
    ...
    @property
    def get_multicloud_data_transfer_config(self) -> Callable[
    ...
    @property
    def create_multicloud_data_transfer_config(self) -> Callable[
    ...
    @property
    def update_multicloud_data_transfer_config(self) -> Callable[
    ...
    @property
    def delete_multicloud_data_transfer_config(self) -> Callable[
    ...
    @property
    def list_destinations(self) -> Callable[
    ...
    @property
    def get_destination(self) -> Callable[
            [data_transfer.GetDestinationRequest],
            Awaitable[data_transfer.Destination]]:
    ...
    @property
    def create_destination(self) -> Callable[
    ...
    @property
    def update_destination(self) -> Callable[
    ...
    @property
    def delete_destination(self) -> Callable[
    ...
    @property
    def get_multicloud_data_transfer_supported_service(self) -> Callable[
    ...
    @property
    def list_multicloud_data_transfer_supported_services(self) -> Callable[

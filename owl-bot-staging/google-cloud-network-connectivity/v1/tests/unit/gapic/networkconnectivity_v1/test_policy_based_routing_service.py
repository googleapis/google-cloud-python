...
@mock.patch.object(PolicyBasedRoutingServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PolicyBasedRoutingServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert PolicyBasedRoutingServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == PolicyBasedRoutingServiceClient.DEFAULT_MTLS_ENDPOINT
    assert PolicyBasedRoutingServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert PolicyBasedRoutingServiceClient._get_api_endpoint(None, None, default_universe, "always") == PolicyBasedRoutingServiceClient.DEFAULT_MTLS_ENDPOINT
    assert PolicyBasedRoutingServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == PolicyBasedRoutingServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = PolicyBasedRoutingServiceClient(credentials=cred)
...
def test_list_policy_based_routes_non_empty_request_with_auto_populated_field():
...
def test_get_policy_based_route_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = PolicyBasedRoutingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_policy_based_route_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = PolicyBasedRoutingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_delete_policy_based_route_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = PolicyBasedRoutingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_policy_based_routes_empty_call_grpc():
    client = PolicyBasedRoutingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_policy_based_route_empty_call_grpc():
    client = PolicyBasedRoutingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_policy_based_route_empty_call_grpc():
    client = PolicyBasedRoutingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_policy_based_route_empty_call_grpc():
    client = PolicyBasedRoutingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_transport_kind_grpc_asyncio():
    transport = PolicyBasedRoutingServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_policy_based_routes_empty_call_grpc_asyncio():
    client = PolicyBasedRoutingServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_policy_based_routes(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_policy_based_route_empty_call_grpc_asyncio():
    client = PolicyBasedRoutingServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_policy_based_route(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_policy_based_route_empty_call_grpc_asyncio():
    client = PolicyBasedRoutingServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_policy_based_route_empty_call_grpc_asyncio():
    client = PolicyBasedRoutingServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )

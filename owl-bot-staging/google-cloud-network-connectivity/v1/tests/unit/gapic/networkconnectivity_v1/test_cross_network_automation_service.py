...
from google.cloud.networkconnectivity_v1.services.cross_network_automation_service import CrossNetworkAutomationServiceAsyncClient
from google.cloud.networkconnectivity_v1.services.cross_network_automation_service import CrossNetworkAutomationServiceClient
from google.cloud.networkconnectivity_v1.services.cross_network_automation_service import pagers
from google.cloud.networkconnectivity_v1.services.cross_network_automation_service import transports
...
@mock.patch.object(CrossNetworkAutomationServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CrossNetworkAutomationServiceClient))
@mock.patch.object(CrossNetworkAutomationServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CrossNetworkAutomationServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert CrossNetworkAutomationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CrossNetworkAutomationServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CrossNetworkAutomationServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CrossNetworkAutomationServiceClient._get_api_endpoint(None, None, default_universe, "always") == CrossNetworkAutomationServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CrossNetworkAutomationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CrossNetworkAutomationServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_cross_network_automation_service_client_client_options_from_dict():
    with mock.patch('google.cloud.networkconnectivity_v1.services.cross_network_automation_service.transports.CrossNetworkAutomationServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_list_service_connection_maps_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.ListServiceConnectionMapsRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_service_connection_maps_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, cross_network_automation.ServiceConnectionMap)
                   for i in results)
...
async def test_list_service_connection_maps_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_service_connection_maps(request={},)
...
def test_get_service_connection_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_service_connection_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_service_connection_map_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.GetServiceConnectionMapRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_service_connection_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_service_connection_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_service_connection_map_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.CreateServiceConnectionMapRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_service_connection_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_service_connection_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_service_connection_map_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.UpdateServiceConnectionMapRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_service_connection_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_service_connection_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_service_connection_map_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.DeleteServiceConnectionMapRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_service_connection_policies_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.ListServiceConnectionPoliciesRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_service_connection_policies_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, cross_network_automation.ServiceConnectionPolicy)
                   for i in results)
...
async def test_list_service_connection_policies_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_service_connection_policies(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_service_connection_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_service_connection_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_service_connection_policy_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.GetServiceConnectionPolicyRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_service_connection_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_service_connection_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_service_connection_policy_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.CreateServiceConnectionPolicyRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_service_connection_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_service_connection_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_service_connection_policy_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.UpdateServiceConnectionPolicyRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_service_connection_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_service_connection_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_service_connection_policy_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.DeleteServiceConnectionPolicyRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_service_classes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, cross_network_automation.ServiceClass)
                   for i in results)
...
async def test_list_service_classes_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_service_classes(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_service_class(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_service_class),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_service_class(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_service_class),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_service_class(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_service_class),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_service_connection_token(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_service_connection_token),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_service_connection_token_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.GetServiceConnectionTokenRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_service_connection_tokens_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.ListServiceConnectionTokensRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_service_connection_tokens_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, cross_network_automation.ServiceConnectionToken)
                   for i in results)
...
async def test_list_service_connection_tokens_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_service_connection_tokens(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_create_service_connection_token(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_service_connection_token),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_service_connection_token_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.CreateServiceConnectionTokenRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_service_connection_token(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_service_connection_token),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_service_connection_token_async(transport: str = 'grpc_asyncio', request_type=cross_network_automation.DeleteServiceConnectionTokenRequest):
    client = CrossNetworkAutomationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_transport_kind_grpc_asyncio():
    transport = CrossNetworkAutomationServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_cross_network_automation_service_base_transport():
    ...
    with mock.patch('google.cloud.networkconnectivity_v1.services.cross_network_automation_service.transports.CrossNetworkAutomationServiceTransport.__init__') as Transport:
...
def test_cross_network_automation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.networkconnectivity_v1.services.cross_network_automation_service.transports.CrossNetworkAutomationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cross_network_automation_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.networkconnectivity_v1.services.cross_network_automation_service.transports.CrossNetworkAutomationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CrossNetworkAutomationServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.CrossNetworkAutomationServiceGrpcTransport, transports.CrossNetworkAutomationServiceGrpcAsyncIOTransport])
...
def test_service_class_path():
    ...
    location = "clam"
    service_class = "whelk"
    expected = "projects/{project}/locations/{location}/serviceClasses/{service_class}".format(project=project, location=location, service_class=service_class, )
...
def test_service_connection_map_path():
    ...
    expected = "projects/{project}/locations/{location}/serviceConnectionMaps/{service_connection_map}".format(project=project, location=location, service_connection_map=service_connection_map, )
...
def test_service_connection_policy_path():
    ...
    expected = "projects/{project}/locations/{location}/serviceConnectionPolicies/{service_connection_policy}".format(project=project, location=location, service_connection_policy=service_connection_policy, )
...
def test_service_connection_token_path():
    ...
    expected = "projects/{project}/locations/{location}/serviceConnectionTokens/{service_connection_token}".format(project=project, location=location, service_connection_token=service_connection_token, )

...
class ImageServiceClient(metaclass=ImageServiceClientMeta):
    ...
    @staticmethod
    def generated_image_path(account: str,generated_image: str,) -> str:
        """Returns a fully-qualified generated_image string."""
        return "accounts/{account}/generatedImages/{generated_image}".format(account=account, generated_image=generated_image, )
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            ImageServiceClient._get_api_endpoint(
    ...
    def generate_product_image_background(self,
    ...
    def remove_product_image_background(self,
    ...
    def upscale_product_image(self,

...
class ImageServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_generate_product_image_background(self, request: image.GenerateProductImageBackgroundRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[image.GenerateProductImageBackgroundRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_generate_product_image_background(self, response: image.GenerateProductImageBackgroundResponse) -> image.GenerateProductImageBackgroundResponse:
    ...
    def post_generate_product_image_background_with_metadata(self, response: image.GenerateProductImageBackgroundResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[image.GenerateProductImageBackgroundResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for generate_product_image_background
    ...
    def pre_remove_product_image_background(self, request: image.RemoveProductImageBackgroundRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[image.RemoveProductImageBackgroundRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_remove_product_image_background(self, response: image.RemoveProductImageBackgroundResponse) -> image.RemoveProductImageBackgroundResponse:
    ...
    def post_remove_product_image_background_with_metadata(self, response: image.RemoveProductImageBackgroundResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[image.RemoveProductImageBackgroundResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for remove_product_image_background
    ...
    def pre_upscale_product_image(self, request: image.UpscaleProductImageRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[image.UpscaleProductImageRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_upscale_product_image_with_metadata(self, response: image.UpscaleProductImageResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[image.UpscaleProductImageResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for upscale_product_image
...
class ImageServiceRestTransport(_BaseImageServiceRestTransport):
    ...
    class _GenerateProductImageBackground(_BaseImageServiceRestTransport._BaseGenerateProductImageBackground, ImageServiceRestStub):
        ...
        background method over HTTP.
            ...
            # Send the request
            response = ImageServiceRestTransport._GenerateProductImageBackground._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _RemoveProductImageBackground(_BaseImageServiceRestTransport._BaseRemoveProductImageBackground, ImageServiceRestStub):
        ...
        background method over HTTP.
            ...
            # Send the request
            response = ImageServiceRestTransport._RemoveProductImageBackground._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpscaleProductImage(_BaseImageServiceRestTransport._BaseUpscaleProductImage, ImageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ImageServiceRestTransport._UpscaleProductImage._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class DataTransferServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_unenroll_data_sources(self, request: datatransfer.UnenrollDataSourcesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[datatransfer.UnenrollDataSourcesRequest, Sequence[Tuple[str, str]]]:

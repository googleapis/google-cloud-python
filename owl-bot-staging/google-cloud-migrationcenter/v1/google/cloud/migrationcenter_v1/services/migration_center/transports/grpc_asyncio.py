...
class MigrationCenterGrpcAsyncIOTransport(MigrationCenterTransport):
    ...
    def get_asset(self) -> Callable[
            ...
            Awaitable[migrationcenter.Asset]]:
    ...
    @property
    def batch_update_assets(self) -> Callable[
    ...
    @property
    def batch_delete_assets(self) -> Callable[
    ...
    @property
    def report_asset_frames(self) -> Callable[
    ...
    @property
    def aggregate_assets_values(self) -> Callable[
    ...
    def get_import_job(self) -> Callable[
            ...
            Awaitable[migrationcenter.ImportJob]]:
    ...
    @property
    def delete_import_job(self) -> Callable[
    ...
    @property
    def update_import_job(self) -> Callable[
    ...
    @property
    def validate_import_job(self) -> Callable[
    ...
    @property
    def run_import_job(self) -> Callable[
    ...
    @property
    def get_import_data_file(self) -> Callable[
    ...
    @property
    def list_import_data_files(self) -> Callable[
    ...
    @property
    def create_import_data_file(self) -> Callable[
    ...
    @property
    def delete_import_data_file(self) -> Callable[
    ...
    def get_group(self) -> Callable[
            ...
            Awaitable[migrationcenter.Group]]:
    ...
    @property
    def add_assets_to_group(self) -> Callable[
    ...
    @property
    def remove_assets_from_group(self) -> Callable[
    ...
    @property
    def list_error_frames(self) -> Callable[
    ...
    @property
    def get_error_frame(self) -> Callable[
            [migrationcenter.GetErrorFrameRequest],
            Awaitable[migrationcenter.ErrorFrame]]:
    ...
    def get_source(self) -> Callable[
            ...
            Awaitable[migrationcenter.Source]]:
    ...
    @property
    def list_preference_sets(self) -> Callable[
    ...
    @property
    def get_preference_set(self) -> Callable[
    ...
    @property
    def create_preference_set(self) -> Callable[
    ...
    @property
    def update_preference_set(self) -> Callable[
    ...
    @property
    def delete_preference_set(self) -> Callable[
    ...
    def get_settings(self) -> Callable[
            ...
            Awaitable[migrationcenter.Settings]]:
    ...
    def get_report(self) -> Callable[
            ...
            Awaitable[migrationcenter.Report]]:
    ...
    @property
    def delete_report(self) -> Callable[
...
__all__ = (
    'MigrationCenterGrpcAsyncIOTransport',
)

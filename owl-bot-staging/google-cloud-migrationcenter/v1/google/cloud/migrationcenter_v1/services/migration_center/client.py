...
class MigrationCenterClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[MigrationCenterTransport]]
...
class MigrationCenterClient(metaclass=MigrationCenterClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "migrationcenter.{UNIVERSE_DOMAIN}"
    ...
    def asset_path(project: str,location: str,asset: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/assets/{asset}".format(project=project, location=location, asset=asset, )
    ...
    @staticmethod
    def error_frame_path(project: str,location: str,source: str,error_frame: str,) -> str:
        """Returns a fully-qualified error_frame string."""
        return "projects/{project}/locations/{location}/sources/{source}/errorFrames/{error_frame}".format(project=project, location=location, source=source, error_frame=error_frame, )

    @staticmethod
    def parse_error_frame_path(path: str) -> Dict[str,str]:
        """Parses a error_frame path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/sources/(?P<source>.+?)/errorFrames/(?P<error_frame>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def group_path(project: str,location: str,group: str,) -> str:
        """Returns a fully-qualified group string."""
        return "projects/{project}/locations/{location}/groups/{group}".format(project=project, location=location, group=group, )
    ...
    @staticmethod
    def import_data_file_path(project: str,location: str,import_job: str,import_data_file: str,) -> str:
        """Returns a fully-qualified import_data_file string."""
        return "projects/{project}/locations/{location}/importJobs/{import_job}/importDataFiles/{import_data_file}".format(project=project, location=location, import_job=import_job, import_data_file=import_data_file, )

    @staticmethod
    def parse_import_data_file_path(path: str) -> Dict[str,str]:
        """Parses a import_data_file path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/importJobs/(?P<import_job>.+?)/importDataFiles/(?P<import_data_file>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def import_job_path(project: str,location: str,import_job: str,) -> str:
        """Returns a fully-qualified import_job string."""
        return "projects/{project}/locations/{location}/importJobs/{import_job}".format(project=project, location=location, import_job=import_job, )

    @staticmethod
    def parse_import_job_path(path: str) -> Dict[str,str]:
        """Parses a import_job path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/importJobs/(?P<import_job>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def preference_set_path(project: str,location: str,preference_set: str,) -> str:
        """Returns a fully-qualified preference_set string."""
        return "projects/{project}/locations/{location}/preferenceSets/{preference_set}".format(project=project, location=location, preference_set=preference_set, )

    @staticmethod
    def parse_preference_set_path(path: str) -> Dict[str,str]:
        """Parses a preference_set path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/preferenceSets/(?P<preference_set>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def report_path(project: str,location: str,report_config: str,report: str,) -> str:
        """Returns a fully-qualified report string."""
        return "projects/{project}/locations/{location}/reportConfigs/{report_config}/reports/{report}".format(project=project, location=location, report_config=report_config, report=report, )

    @staticmethod
    def parse_report_path(path: str) -> Dict[str,str]:
        """Parses a report path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/reportConfigs/(?P<report_config>.+?)/reports/(?P<report>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def report_config_path(project: str,location: str,report_config: str,) -> str:
        """Returns a fully-qualified report_config string."""
        return "projects/{project}/locations/{location}/reportConfigs/{report_config}".format(project=project, location=location, report_config=report_config, )

    @staticmethod
    def parse_report_config_path(path: str) -> Dict[str,str]:
        """Parses a report_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/reportConfigs/(?P<report_config>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def source_path(project: str,location: str,source: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/sources/{source}".format(project=project, location=location, source=source, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = MigrationCenterClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = MigrationCenterClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = MigrationCenterClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            MigrationCenterClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, MigrationCenterTransport, Callable[..., MigrationCenterTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = MigrationCenterClient._read_environment_variables()
        self._client_cert_source = MigrationCenterClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = MigrationCenterClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, MigrationCenterTransport)
        if transport_provided:
            ...
            self._transport = cast(MigrationCenterTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[MigrationCenterTransport], Callable[..., MigrationCenterTransport]] = (
    ...
    def aggregate_assets_values(self,
    ...
    def list_import_data_files(self,
    ...
    def create_import_data_file(self,
    ...
    def delete_import_data_file(self,
    ...
    def remove_assets_from_group(self,
    ...
    def create_preference_set(self,
    ...
    def update_preference_set(self,
    ...
    def delete_preference_set(self,

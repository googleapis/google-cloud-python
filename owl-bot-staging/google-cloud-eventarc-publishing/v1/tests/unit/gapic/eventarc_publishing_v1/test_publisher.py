...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert PublisherClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert PublisherClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert PublisherClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert PublisherClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert PublisherClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(PublisherClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PublisherClient))
@mock.patch.object(PublisherAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PublisherAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = PublisherClient._DEFAULT_UNIVERSE
    default_endpoint = PublisherClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = PublisherClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert PublisherClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert PublisherClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == PublisherClient.DEFAULT_MTLS_ENDPOINT
    assert PublisherClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert PublisherClient._get_api_endpoint(None, None, default_universe, "always") == PublisherClient.DEFAULT_MTLS_ENDPOINT
    assert PublisherClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == PublisherClient.DEFAULT_MTLS_ENDPOINT
    assert PublisherClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert PublisherClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        PublisherClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert PublisherClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert PublisherClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert PublisherClient._get_universe_domain(None, None) == PublisherClient._DEFAULT_UNIVERSE
...
def test_publish_channel_connection_events_non_empty_request_with_auto_populated_field():
...
def test_publish_channel_connection_events_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.publish_channel_connection_events in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.publish_channel_connection_events] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_publish_channel_connection_events_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.publish_channel_connection_events in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.publish_channel_connection_events] = mock_rpc
...
def test_publish_events_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_publish_events_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.publish_events in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.publish_events] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_publish_events_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PublisherAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.publish_events in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.publish_events] = mock_rpc
...
def test_publish(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = publisher.PublishResponse(
        )
...
async def test_publish_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.publish in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.publish] = mock_rpc
...
async def test_publish_async(transport: str = 'grpc_asyncio', request_type=publisher.PublishRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(publisher.PublishResponse(
        ))
...
def test_publish_field_headers():
    ...
    request.message_bus = 'message_bus_value'
...
def test_publish_channel_connection_events_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = PublisherClient(
...
def test_publish_events_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = PublisherClient(
...
def test_publish_rest_required_fields(request_type=publisher.PublishRequest):
    ...
    jsonified_request["messageBus"] = 'message_bus_value'

    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).publish._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with non-default values are left alone
    assert "messageBus" in jsonified_request
    assert jsonified_request["messageBus"] == 'message_bus_value'
    ...
    return_value = publisher.PublishResponse()
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = publisher.PublishResponse.pb(return_value)
...
def test_publish_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("messageBus", )))
...
def test_publish_channel_connection_events_empty_call_grpc():
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = publisher.PublishChannelConnectionEventsResponse()
        client.publish_channel_connection_events(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_publish_events_empty_call_grpc():
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = publisher.PublishEventsResponse()
        client.publish_events(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_publish_channel_connection_events_empty_call_grpc_asyncio():
    client = PublisherAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.publish_channel_connection_events(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_publish_events_empty_call_grpc_asyncio():
    client = PublisherAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.publish_events(request=None)
...
def test_publish_channel_connection_events_rest_bad_request(request_type=publisher.PublishChannelConnectionEventsRequest):
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'channel_connection': 'projects/sample1/locations/sample2/channelConnections/sample3'}
    request = request_type(**request_init)
...
def test_publish_channel_connection_events_rest_call_success(request_type):
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # Convert return value to protobuf type
        return_value = publisher.PublishChannelConnectionEventsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_publish_channel_connection_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PublisherRestInterceptor, "post_publish_channel_connection_events") as post, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_publish_channel_connection_events_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PublisherRestInterceptor, "pre_publish_channel_connection_events") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = publisher.PublishChannelConnectionEventsRequest.pb(publisher.PublishChannelConnectionEventsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = publisher.PublishChannelConnectionEventsResponse.to_json(publisher.PublishChannelConnectionEventsResponse())
        ...
        post_with_metadata.return_value = publisher.PublishChannelConnectionEventsResponse(), metadata

        client.publish_channel_connection_events(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_publish_events_rest_call_success(request_type):
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # Convert return value to protobuf type
        return_value = publisher.PublishEventsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
        response_value.content = json_return_value.encode('UTF-8')
        req.return_value = response_value
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
...
def test_publish_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_publish_events") as post, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_publish_events_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PublisherRestInterceptor, "pre_publish_events") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = publisher.PublishEventsResponse.to_json(publisher.PublishEventsResponse())
        req.return_value.content = return_value
        ...
        client.publish_events(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_publish_rest_bad_request(request_type=publisher.PublishRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'message_bus': 'projects/sample1/locations/sample2/messageBuses/sample3'}
    request = request_type(**request_init)
...
def test_publish_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PublisherRestInterceptor, "post_publish_with_metadata") as post_with_metadata, \
        ...
        client.publish(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_publish_channel_connection_events_empty_call_rest():
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_publish_events_empty_call_rest():
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

...
@pytest.mark.asyncio
async def test_publish_channel_connection_events_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    ...
    with mock.patch.object(
        ...
        response = await client.publish_channel_connection_events()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == publisher.PublishChannelConnectionEventsRequest()
...
async def test_publish_channel_connection_events_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.publish_channel_connection_events] = mock_object
...
@pytest.mark.asyncio
async def test_publish_events_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = PublisherAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.publish_events()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == publisher.PublishEventsRequest()
...
async def test_publish_events_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.publish_events] = mock_object
...
def test_publish_channel_connection_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = publisher.PublishChannelConnectionEventsResponse.to_json(publisher.PublishChannelConnectionEventsResponse())
...
def test_publish_channel_connection_events_rest_bad_request(transport: str = 'rest', request_type=publisher.PublishChannelConnectionEventsRequest):
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_publish_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = publisher.PublishEventsResponse.to_json(publisher.PublishEventsResponse())
...
def test_publish_events_rest_bad_request(transport: str = 'rest', request_type=publisher.PublishEventsRequest):
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

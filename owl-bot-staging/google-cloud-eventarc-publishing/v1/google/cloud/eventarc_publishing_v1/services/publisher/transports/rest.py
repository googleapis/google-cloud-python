...
class PublisherRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_publish(self, request: publisher.PublishRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[publisher.PublishRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_publish_with_metadata(self, response: publisher.PublishResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[publisher.PublishResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for publish
    ...
    def pre_publish_channel_connection_events(self, request: publisher.PublishChannelConnectionEventsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[publisher.PublishChannelConnectionEventsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_publish_channel_connection_events_with_metadata(self, response: publisher.PublishChannelConnectionEventsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[publisher.PublishChannelConnectionEventsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for publish_channel_connection_events
    ...
    def pre_publish_events(self, request: publisher.PublishEventsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[publisher.PublishEventsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_publish_events_with_metadata(self, response: publisher.PublishEventsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[publisher.PublishEventsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for publish_events
...
class PublisherRestTransport(_BasePublisherRestTransport):
    ...
    class _Publish(_BasePublisherRestTransport._BasePublish, PublisherRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PublisherRestTransport._Publish._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _PublishChannelConnectionEvents(_BasePublisherRestTransport._BasePublishChannelConnectionEvents, PublisherRestStub):
        ...
        connection events method over HTTP.
            ...
            # Send the request
            response = PublisherRestTransport._PublishChannelConnectionEvents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _PublishEvents(_BasePublisherRestTransport._BasePublishEvents, PublisherRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PublisherRestTransport._PublishEvents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
from google.cloud.modelarmor_v1.services.model_armor import ModelArmorAsyncClient
from google.cloud.modelarmor_v1.services.model_armor import ModelArmorClient
from google.cloud.modelarmor_v1.services.model_armor import pagers
from google.cloud.modelarmor_v1.services.model_armor import transports
...
def test_model_armor_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.modelarmor_v1.services.model_armor.transports.ModelArmorTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_model_armor_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.modelarmor_v1.services.model_armor.transports.ModelArmorTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ModelArmorTransport()
        adc.assert_called_once()

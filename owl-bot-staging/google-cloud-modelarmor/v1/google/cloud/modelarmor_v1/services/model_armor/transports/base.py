...
class ModelArmorTransport(abc.ABC):
    """Abstract transport class for ModelArmor."""

    AUTH_SCOPES = (
        'https://www.googleapis.com/auth/cloud-platform',
    )

    DEFAULT_HOST: str = 'modelarmor.googleapis.com'
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.get_floor_setting: gapic_v1.method.wrap_method(
            ...
            self.update_floor_setting: gapic_v1.method.wrap_method(
                self.update_floor_setting,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.sanitize_user_prompt: gapic_v1.method.wrap_method(
            ...
            self.sanitize_model_response: gapic_v1.method.wrap_method(
    ...
    def list_templates(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[service.ListTemplatesResponse]
            ]]:
        raise NotImplementedError()
    ...
    def get_floor_setting(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[service.FloorSetting]
            ]]:
        raise NotImplementedError()

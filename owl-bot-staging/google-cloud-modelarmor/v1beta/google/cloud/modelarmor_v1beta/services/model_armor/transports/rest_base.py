...
class _BaseModelArmorRestTransport(ModelArmorTransport):
    ...
    class _BaseCreateTemplate:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{parent=projects/*/locations/*}/templates',
                'body': 'template',
            },
            ]
            return http_options
    ...
    class _BaseDeleteTemplate:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1beta/{name=projects/*/locations/*/templates/*}',
            },
            ]
            return http_options
    ...
    class _BaseGetFloorSetting:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1beta/{name=projects/*/locations/*/floorSetting}',
            },
        {
                'method': 'get',
                'uri': '/v1beta/{name=folders/*/locations/*/floorSetting}',
            },
        {
                'method': 'get',
                'uri': '/v1beta/{name=organizations/*/locations/*/floorSetting}',
            },
            ]
            return http_options
    ...
    class _BaseSanitizeModelResponse:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{name=projects/*/locations/*/templates/*}:sanitizeModelResponse',
                'body': '*',
            },
            ]
            return http_options
    ...
    class _BaseSanitizeUserPrompt:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{name=projects/*/locations/*/templates/*}:sanitizeUserPrompt',
                'body': '*',
            },
            ]
            return http_options
    ...
    class _BaseUpdateFloorSetting:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1beta/{floor_setting.name=projects/*/locations/*/floorSetting}',
                'body': 'floor_setting',
            },
        {
                'method': 'patch',
                'uri': '/v1beta/{floor_setting.name=folders/*/locations/*/floorSetting}',
                'body': 'floor_setting',
            },
        {
                'method': 'patch',
                'uri': '/v1beta/{floor_setting.name=organizations/*/locations/*/floorSetting}',
                'body': 'floor_setting',
            },
            ]
            return http_options
    ...
    class _BaseUpdateTemplate:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1beta/{template.name=projects/*/locations/*/templates/*}',
                'body': 'template',
            },
            ]
            return http_options

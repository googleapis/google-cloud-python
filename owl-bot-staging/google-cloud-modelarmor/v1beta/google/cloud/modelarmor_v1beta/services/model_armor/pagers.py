...
class ListTemplatesPager:
    ...
    :class:`google.cloud.modelarmor_v1beta.types.ListTemplatesResponse` object, and
    ...
    All the usual :class:`google.cloud.modelarmor_v1beta.types.ListTemplatesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.modelarmor_v1beta.types.ListTemplatesRequest):
                The initial request object.
            response (google.cloud.modelarmor_v1beta.types.ListTemplatesResponse):

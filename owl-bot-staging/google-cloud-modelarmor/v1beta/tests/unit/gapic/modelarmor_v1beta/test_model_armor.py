...
from google.cloud.modelarmor_v1beta.services.model_armor import ModelArmorAsyncClient
from google.cloud.modelarmor_v1beta.services.model_armor import ModelArmorClient
from google.cloud.modelarmor_v1beta.services.model_armor import pagers
from google.cloud.modelarmor_v1beta.services.model_armor import transports
...
@pytest.mark.parametrize("client_class", [
    ModelArmorClient, ModelArmorAsyncClient
])
...
def test_list_templates(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.list_templates),
            '__call__') as call:
...
def test_list_templates_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, service.Template)
                   for i in results)
...
async def test_list_templates_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_templates(request={},)
...
def test_create_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.Template(
            name='name_value',
...
def test_update_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.Template(
            name='name_value',
...
def test_delete_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_floor_setting(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_floor_setting),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_floor_setting(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_floor_setting),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.FloorSetting(
            name='name_value',
...
def test_sanitize_user_prompt(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.sanitize_user_prompt),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_sanitize_model_response(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.sanitize_model_response),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_template_rest_required_fields(request_type=service.CreateTemplateRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_template._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("request_id", "template_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_template_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "templateId", )) & set(("parent", "templateId", "template", )))
...
def test_update_template_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("updateMask", "template", )))
...
def test_update_floor_setting_rest_required_fields(request_type=service.UpdateFloorSettingRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_floor_setting._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_sanitize_user_prompt_rest_required_fields(request_type=service.SanitizeUserPromptRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).sanitize_user_prompt._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_sanitize_user_prompt_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "userPromptData", )))
...
def test_sanitize_model_response_rest_required_fields(request_type=service.SanitizeModelResponseRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).sanitize_model_response._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_sanitize_model_response_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "modelResponseData", )))
...
def test_list_templates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_list_templates") as post, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_list_templates_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "pre_list_templates") as pre:
        ...
        client.list_templates(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_get_template") as post, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_get_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "pre_get_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_template_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["template"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'filter_config': {'rai_settings': {'rai_filters': [{'filter_type': 2, 'confidence_level': 1}]}, 'sdp_settings': {'basic_config': {'filter_enforcement': 1}, 'advanced_config': {'inspect_template': 'inspect_template_value', 'deidentify_template': 'deidentify_template_value'}}, 'pi_and_jailbreak_filter_settings': {'filter_enforcement': 1, 'confidence_level': 1}, 'malicious_uri_filter_settings': {'filter_enforcement': 1}}, 'template_metadata': {'ignore_partial_invocation_failures': True, 'custom_prompt_safety_error_code': 3338, 'custom_prompt_safety_error_message': 'custom_prompt_safety_error_message_value', 'custom_llm_response_safety_error_code': 3963, 'custom_llm_response_safety_error_message': 'custom_llm_response_safety_error_message_value', 'log_template_operations': True, 'log_sanitize_operations': True, 'enforcement_type': 1, 'multi_language_detection': {'enable_multi_language_detection': True}}}
...
def test_create_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_create_template") as post, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_create_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "pre_create_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_template_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'template': {'name': 'projects/sample1/locations/sample2/templates/sample3'}}
    request_init["template"] = {'name': 'projects/sample1/locations/sample2/templates/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'filter_config': {'rai_settings': {'rai_filters': [{'filter_type': 2, 'confidence_level': 1}]}, 'sdp_settings': {'basic_config': {'filter_enforcement': 1}, 'advanced_config': {'inspect_template': 'inspect_template_value', 'deidentify_template': 'deidentify_template_value'}}, 'pi_and_jailbreak_filter_settings': {'filter_enforcement': 1, 'confidence_level': 1}, 'malicious_uri_filter_settings': {'filter_enforcement': 1}}, 'template_metadata': {'ignore_partial_invocation_failures': True, 'custom_prompt_safety_error_code': 3338, 'custom_prompt_safety_error_message': 'custom_prompt_safety_error_message_value', 'custom_llm_response_safety_error_code': 3963, 'custom_llm_response_safety_error_message': 'custom_llm_response_safety_error_message_value', 'log_template_operations': True, 'log_sanitize_operations': True, 'enforcement_type': 1, 'multi_language_detection': {'enable_multi_language_detection': True}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_update_template") as post, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_update_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "pre_update_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "pre_delete_template") as pre:
        pre.assert_not_called()
        ...
        client.delete_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_floor_setting_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_get_floor_setting") as post, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_get_floor_setting_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "pre_get_floor_setting") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_floor_setting(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_floor_setting_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'floor_setting': {'name': 'projects/sample1/locations/sample2/floorSetting'}}
    request_init["floor_setting"] = {'name': 'projects/sample1/locations/sample2/floorSetting', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'filter_config': {'rai_settings': {'rai_filters': [{'filter_type': 2, 'confidence_level': 1}]}, 'sdp_settings': {'basic_config': {'filter_enforcement': 1}, 'advanced_config': {'inspect_template': 'inspect_template_value', 'deidentify_template': 'deidentify_template_value'}}, 'pi_and_jailbreak_filter_settings': {'filter_enforcement': 1, 'confidence_level': 1}, 'malicious_uri_filter_settings': {'filter_enforcement': 1}}, 'enable_floor_setting_enforcement': True, 'integrated_services': [1], 'ai_platform_floor_setting': {'inspect_only': True, 'inspect_and_block': True, 'enable_cloud_logging': True}, 'floor_setting_metadata': {'multi_language_detection': {'enable_multi_language_detection': True}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_floor_setting_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_update_floor_setting") as post, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_update_floor_setting_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "pre_update_floor_setting") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_floor_setting(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_sanitize_user_prompt_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_sanitize_user_prompt") as post, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_sanitize_user_prompt_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "pre_sanitize_user_prompt") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.sanitize_user_prompt(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_sanitize_model_response_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_sanitize_model_response") as post, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "post_sanitize_model_response_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ModelArmorRestInterceptor, "pre_sanitize_model_response") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.sanitize_model_response(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_model_armor_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.modelarmor_v1beta.services.model_armor.transports.ModelArmorTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_model_armor_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.modelarmor_v1beta.services.model_armor.transports.ModelArmorTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ModelArmorTransport()
        adc.assert_called_once()
...
def test_model_armor_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.ModelArmorGrpcTransport, transports.ModelArmorGrpcAsyncIOTransport])
def test_model_armor_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ModelArmorGrpcTransport, transports.ModelArmorGrpcAsyncIOTransport])
def test_model_armor_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_floor_setting_path():
    project = "squid"
    location = "clam"
    expected = "projects/{project}/locations/{location}/floorSetting".format(project=project, location=location, )

...
def test_search_nearby_rest_required_fields(request_type=places_service.SearchNearbyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_nearby._get_unset_required_fields(jsonified_request)
...
def test_search_nearby_rest_unset_required_fields():
    transport = transports.PlacesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_search_text_rest_required_fields(request_type=places_service.SearchTextRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_text._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_photo_media_rest_required_fields(request_type=places_service.GetPhotoMediaRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_photo_media._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_place_rest_required_fields(request_type=places_service.GetPlaceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_place._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_place._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("language_code", "region_code", ))
    jsonified_request.update(unset_fields)
...
def test_get_place_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("languageCode", "regionCode", )) & set(("name", )))

...
from google.maps.places_v1.services.places import transports
...
from google.maps.places_v1.types import polyline
from google.maps.places_v1.types import price_range
from google.maps.places_v1.types import review
from google.maps.places_v1.types import route_modifiers
from google.maps.places_v1.types import routing_preference
from google.maps.places_v1.types import routing_summary
from google.maps.places_v1.types import travel_mode
...
def test__get_default_mtls_endpoint():
    ...
    assert PlacesClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert PlacesClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert PlacesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__get_client_cert_source():
    ...
    assert PlacesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert PlacesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert PlacesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert PlacesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(PlacesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PlacesClient))
@mock.patch.object(PlacesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PlacesAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = PlacesClient._DEFAULT_UNIVERSE
    default_endpoint = PlacesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = PlacesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert PlacesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert PlacesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == PlacesClient.DEFAULT_MTLS_ENDPOINT
    assert PlacesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert PlacesClient._get_api_endpoint(None, None, default_universe, "always") == PlacesClient.DEFAULT_MTLS_ENDPOINT
    assert PlacesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == PlacesClient.DEFAULT_MTLS_ENDPOINT
    assert PlacesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert PlacesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        PlacesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert PlacesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert PlacesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert PlacesClient._get_universe_domain(None, None) == PlacesClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (PlacesAsyncClient, transports.PlacesGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (PlacesClient, transports.PlacesGrpcTransport, "grpc", "false"),
    (PlacesAsyncClient, transports.PlacesGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_places_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    PlacesClient, PlacesAsyncClient
])
@mock.patch.object(PlacesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PlacesClient))
@mock.patch.object(PlacesAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PlacesAsyncClient))
...
def test_places_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (PlacesAsyncClient, transports.PlacesGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (PlacesClient, transports.PlacesRestTransport, "rest", None),
])
def test_places_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_places_client_client_options_from_dict():
    with mock.patch('google.maps.places_v1.services.places.transports.PlacesGrpcTransport.__init__') as grpc_transport:
...
def test_places_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_search_nearby(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.search_nearby),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_search_nearby_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.search_nearby in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_nearby] = mock_rpc
...
@pytest.mark.asyncio
async def test_search_nearby_async(transport: str = 'grpc_asyncio', request_type=places_service.SearchNearbyRequest):
    client = PlacesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(places_service.SearchNearbyResponse(
        ))
...
def test_search_text(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_text),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_search_text_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PlacesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_text in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_text] = mock_rpc
...
@pytest.mark.asyncio
async def test_search_text_async(transport: str = 'grpc_asyncio', request_type=places_service.SearchTextRequest):
    client = PlacesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(places_service.SearchTextResponse(
        ))
...
def test_get_photo_media(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_photo_media),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_photo_media_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PlacesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_photo_media in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_photo_media] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_photo_media_async(transport: str = 'grpc_asyncio', request_type=places_service.GetPhotoMediaRequest):
    client = PlacesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(places_service.PhotoMedia(
            name='name_value',
            photo_uri='photo_uri_value',
        ))
...
def test_get_place(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_place),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_get_place_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_place in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_place] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_place_async(transport: str = 'grpc_asyncio', request_type=places_service.GetPlaceRequest):
    client = PlacesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_autocomplete_places(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.autocomplete_places),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_autocomplete_places_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.autocomplete_places in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.autocomplete_places] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_autocomplete_places_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PlacesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.autocomplete_places in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.autocomplete_places] = mock_rpc
...
@pytest.mark.asyncio
async def test_autocomplete_places_async(transport: str = 'grpc_asyncio', request_type=places_service.AutocompletePlacesRequest):
    client = PlacesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(places_service.AutocompletePlacesResponse(
        ))
...
def test_search_nearby_rest_required_fields(request_type=places_service.SearchNearbyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_nearby._get_unset_required_fields(jsonified_request)
...
def test_search_nearby_rest_unset_required_fields():
    transport = transports.PlacesRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_search_text_rest_required_fields(request_type=places_service.SearchTextRequest):
    transport_class = transports.PlacesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_text._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_photo_media_rest_required_fields(request_type=places_service.GetPhotoMediaRequest):
    transport_class = transports.PlacesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_photo_media._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    assert not set(unset_fields) - set(("max_height_px", "max_width_px", "skip_http_redirect", ))
    jsonified_request.update(unset_fields)
...
def test_get_photo_media_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("maxHeightPx", "maxWidthPx", "skipHttpRedirect", )) & set(("name", )))
...
def test_get_photo_media_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{name=places/*/photos/*/media}" % client.transport._host, args[1])
...
def test_get_place_rest_required_fields(request_type=places_service.GetPlaceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_place._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_place._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("language_code", "region_code", "session_token", ))
    jsonified_request.update(unset_fields)
...
def test_get_place_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("languageCode", "regionCode", "sessionToken", )) & set(("name", )))
...
def test_get_place_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=places/*}" % client.transport._host, args[1])
...
def test_autocomplete_places_rest_required_fields(request_type=places_service.AutocompletePlacesRequest):
    transport_class = transports.PlacesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).autocomplete_places._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_nearby_empty_call_grpc():
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = places_service.SearchNearbyResponse()
        client.search_nearby(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_text_empty_call_grpc():
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = places_service.SearchTextResponse()
        client.search_text(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_photo_media_empty_call_grpc():
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = places_service.PhotoMedia()
        client.get_photo_media(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_place_empty_call_grpc():
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_autocomplete_places_empty_call_grpc():
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = places_service.AutocompletePlacesResponse()
        client.autocomplete_places(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = PlacesAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_nearby_empty_call_grpc_asyncio():
    client = PlacesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.search_nearby(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_text_empty_call_grpc_asyncio():
    client = PlacesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.search_text(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_photo_media_empty_call_grpc_asyncio():
    client = PlacesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_photo_media(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_place_empty_call_grpc_asyncio():
    client = PlacesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_autocomplete_places_empty_call_grpc_asyncio():
    client = PlacesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.autocomplete_places(request=None)
...
def test_transport_kind_rest():
    transport = PlacesClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_search_nearby_rest_bad_request(request_type=places_service.SearchNearbyRequest):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_search_nearby_rest_call_success(request_type):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_search_nearby_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PlacesRestInterceptor, "post_search_nearby") as post, \
        mock.patch.object(transports.PlacesRestInterceptor, "post_search_nearby_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PlacesRestInterceptor, "pre_search_nearby") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = places_service.SearchNearbyRequest.pb(places_service.SearchNearbyRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = places_service.SearchNearbyResponse.to_json(places_service.SearchNearbyResponse())
        ...
        post_with_metadata.return_value = places_service.SearchNearbyResponse(), metadata

        client.search_nearby(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_search_text_rest_call_success(request_type):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_search_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PlacesRestInterceptor, "post_search_text_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PlacesRestInterceptor, "pre_search_text") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = places_service.SearchTextRequest.pb(places_service.SearchTextRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = places_service.SearchTextResponse.to_json(places_service.SearchTextResponse())
        req.return_value.content = return_value
        ...
        client.search_text(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_photo_media_rest_bad_request(request_type=places_service.GetPhotoMediaRequest):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_photo_media_rest_call_success(request_type):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_photo_media_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PlacesRestInterceptor, "post_get_photo_media") as post, \
        mock.patch.object(transports.PlacesRestInterceptor, "post_get_photo_media_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PlacesRestInterceptor, "pre_get_photo_media") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = places_service.GetPhotoMediaRequest.pb(places_service.GetPhotoMediaRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_photo_media(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_place_rest_call_success(request_type):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_place_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PlacesRestInterceptor, "post_get_place_with_metadata") as post_with_metadata, \
        ...
        client.get_place(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_autocomplete_places_rest_bad_request(request_type=places_service.AutocompletePlacesRequest):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_autocomplete_places_rest_call_success(request_type):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_autocomplete_places_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PlacesRestInterceptor, "post_autocomplete_places") as post, \
        mock.patch.object(transports.PlacesRestInterceptor, "post_autocomplete_places_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PlacesRestInterceptor, "pre_autocomplete_places") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = places_service.AutocompletePlacesRequest.pb(places_service.AutocompletePlacesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = places_service.AutocompletePlacesResponse.to_json(places_service.AutocompletePlacesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = places_service.AutocompletePlacesResponse(), metadata

        client.autocomplete_places(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_nearby_empty_call_rest():
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_text_empty_call_rest():
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_photo_media_empty_call_rest():
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_place_empty_call_rest():
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_autocomplete_places_empty_call_rest():
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_places_base_transport():
    ...
    with mock.patch('google.maps.places_v1.services.places.transports.PlacesTransport.__init__') as Transport:
...
def test_places_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.maps.places_v1.services.places.transports.PlacesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_places_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.maps.places_v1.services.places.transports.PlacesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PlacesTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.PlacesGrpcTransport, transports.PlacesGrpcAsyncIOTransport])
def test_places_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_places_host_no_port(transport_name):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='places.googleapis.com'),
...
def test_places_host_with_port(transport_name):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='places.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
@pytest.mark.parametrize("transport_class", [transports.PlacesGrpcTransport, transports.PlacesGrpcAsyncIOTransport])
def test_places_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.PlacesGrpcTransport, transports.PlacesGrpcAsyncIOTransport])
def test_places_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_photo_path():
    place = "squid"
    photo = "clam"
    expected = "places/{place}/photos/{photo}".format(place=place, photo=photo, )
...
def test_photo_media_path():
    ...
    expected = "places/{place_id}/photos/{photo_reference}/media".format(place_id=place_id, photo_reference=photo_reference, )
...
def test_place_path():
    place_id = "winkle"
    expected = "places/{place_id}".format(place_id=place_id, )
...
def test_review_path():
    place = "scallop"
    review = "abalone"
    expected = "places/{place}/reviews/{review}".format(place=place, review=review, )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.PlacesTransport, '_prep_wrapped_messages') as prep:
        client = PlacesClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
def test_search_nearby_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = places_service.SearchNearbyResponse.to_json(places_service.SearchNearbyResponse())
...
def test_search_nearby_rest_bad_request(transport: str = 'rest', request_type=places_service.SearchNearbyRequest):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = places_service.SearchTextResponse.to_json(places_service.SearchTextResponse())
...
def test_search_text_rest_bad_request(transport: str = 'rest', request_type=places_service.SearchTextRequest):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_photo_media_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = places_service.PhotoMedia.to_json(places_service.PhotoMedia())
...
def test_get_photo_media_rest_bad_request(transport: str = 'rest', request_type=places_service.GetPhotoMediaRequest):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_place_rest_bad_request(transport: str = 'rest', request_type=places_service.GetPlaceRequest):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_autocomplete_places_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = places_service.AutocompletePlacesResponse.to_json(places_service.AutocompletePlacesResponse())
...
def test_autocomplete_places_rest_bad_request(transport: str = 'rest', request_type=places_service.AutocompletePlacesRequest):
    client = PlacesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

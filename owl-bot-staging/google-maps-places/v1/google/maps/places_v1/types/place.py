...
class Place(proto.Message):
    ...
    class OpeningHours(proto.Message):
        ...
        class OpeningHoursPeriod(proto.Message):
            ...
            open_: 'Place.OpeningHours.OpeningHoursPeriod.OpeningHoursPoint' = proto.Field(
                proto.MESSAGE,
                number=1,
                message='Place.OpeningHours.OpeningHoursPeriod.OpeningHoursPoint',
            )
            close: 'Place.OpeningHours.OpeningHoursPeriod.OpeningHoursPoint' = proto.Field(
                proto.MESSAGE,
                number=2,
                message='Place.OpeningHours.OpeningHoursPeriod.OpeningHoursPoint',
            )
        ...
        periods: MutableSequence['Place.OpeningHours.OpeningHoursPeriod'] = proto.RepeatedField(
            proto.MESSAGE,
            number=2,

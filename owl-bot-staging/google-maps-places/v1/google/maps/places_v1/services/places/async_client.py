...
from google.maps.places_v1.types import address_descriptor
from google.maps.places_v1.types import contextual_content
from google.maps.places_v1.types import ev_charging
from google.maps.places_v1.types import fuel_options
...
from google.maps.places_v1.types import price_range
...
from .transports.base import PlacesTransport, DEFAULT_CLIENT_INFO
...
class PlacesAsyncClient:
    ...
    parse_common_billing_account_path = staticmethod(PlacesClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(PlacesClient.parse_common_organization_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PlacesTransport, Callable[..., PlacesTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.maps.places_v1.PlacesAsyncClient`.",
                extra = {
    ...
    async def search_nearby(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_nearby]
    ...
    async def search_text(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_text]
    ...
    async def get_photo_media(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_photo_media]
    ...
    async def get_place(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_place]
    ...
    async def autocomplete_places(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.autocomplete_places]

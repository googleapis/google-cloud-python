...
class PlacesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_autocomplete_places(self, request: places_service.AutocompletePlacesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[places_service.AutocompletePlacesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_autocomplete_places_with_metadata(self, response: places_service.AutocompletePlacesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[places_service.AutocompletePlacesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for autocomplete_places
    ...
    def pre_get_photo_media(self, request: places_service.GetPhotoMediaRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[places_service.GetPhotoMediaRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_photo_media_with_metadata(self, response: places_service.PhotoMedia, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[places_service.PhotoMedia, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_photo_media
    ...
    def pre_get_place(self, request: places_service.GetPlaceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[places_service.GetPlaceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_place_with_metadata(self, response: place.Place, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[place.Place, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_place
    ...
    def pre_search_nearby(self, request: places_service.SearchNearbyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[places_service.SearchNearbyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search_nearby_with_metadata(self, response: places_service.SearchNearbyResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[places_service.SearchNearbyResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_nearby
    ...
    def pre_search_text(self, request: places_service.SearchTextRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[places_service.SearchTextRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search_text_with_metadata(self, response: places_service.SearchTextResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[places_service.SearchTextResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_text
...
class PlacesRestTransport(_BasePlacesRestTransport):
    ...
    class _AutocompletePlaces(_BasePlacesRestTransport._BaseAutocompletePlaces, PlacesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PlacesRestTransport._AutocompletePlaces._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetPhotoMedia(_BasePlacesRestTransport._BaseGetPhotoMedia, PlacesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PlacesRestTransport._GetPhotoMedia._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SearchNearby(_BasePlacesRestTransport._BaseSearchNearby, PlacesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PlacesRestTransport._SearchNearby._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SearchText(_BasePlacesRestTransport._BaseSearchText, PlacesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PlacesRestTransport._SearchText._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def autocomplete_places(self) -> Callable[
    ...
    @property
    def get_photo_media(self) -> Callable[
    ...
    @property
    def search_nearby(self) -> Callable[

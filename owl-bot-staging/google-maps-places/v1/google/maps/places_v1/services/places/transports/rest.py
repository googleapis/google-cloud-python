...
class PlacesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_autocomplete_places(self, request: places_service.AutocompletePlacesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[places_service.AutocompletePlacesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_photo_media(self, request: places_service.GetPhotoMediaRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[places_service.GetPhotoMediaRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_place(self, request: places_service.GetPlaceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[places_service.GetPlaceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_search_nearby(self, request: places_service.SearchNearbyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[places_service.SearchNearbyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_search_text(self, request: places_service.SearchTextRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[places_service.SearchTextRequest, Sequence[Tuple[str, str]]]:

...
class PlacesClient(metaclass=PlacesClientMeta):
    ...
    @staticmethod
    def photo_path(place: str,photo: str,) -> str:
        """Returns a fully-qualified photo string."""
        return "places/{place}/photos/{photo}".format(place=place, photo=photo, )
    ...
    @staticmethod
    def photo_media_path(place_id: str,photo_reference: str,) -> str:
        """Returns a fully-qualified photo_media string."""
        return "places/{place_id}/photos/{photo_reference}/media".format(place_id=place_id, photo_reference=photo_reference, )
    ...
    @staticmethod
    def review_path(place: str,review: str,) -> str:
        """Returns a fully-qualified review string."""
        return "places/{place}/reviews/{review}".format(place=place, review=review, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            PlacesClient._compare_universes(self.universe_domain, self.transport._credentials))

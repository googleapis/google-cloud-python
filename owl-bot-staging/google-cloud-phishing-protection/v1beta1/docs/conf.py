...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for google-cloud-phishing-protection",
...
man_pages = [
    (
        ...
        "google-cloud-phishing-protection Documentation",
        [author],
        1,
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-phishing-protection",
        "google-cloud-phishing-protection Library",
        "APIs",
    )
]

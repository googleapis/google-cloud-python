...
from .rest_base import _BasePhishingProtectionServiceV1Beta1RestTransport
...
class PhishingProtectionServiceV1Beta1RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_report_phishing(self, request: phishingprotection.ReportPhishingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[phishingprotection.ReportPhishingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_report_phishing_with_metadata(self, response: phishingprotection.ReportPhishingResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[phishingprotection.ReportPhishingResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for report_phishing
    ...
    class _ReportPhishing(_BasePhishingProtectionServiceV1Beta1RestTransport._BaseReportPhishing, PhishingProtectionServiceV1Beta1RestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.phishingprotection_v1beta1.PhishingProtectionServiceV1Beta1Client.ReportPhishing",
                    extra = {
                        "serviceName": "google.cloud.phishingprotection.v1beta1.PhishingProtectionServiceV1Beta1",
                        "rpcName": "ReportPhishing",
            ...
            # Send the request
            response = PhishingProtectionServiceV1Beta1RestTransport._ReportPhishing._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.phishingprotection_v1beta1.PhishingProtectionServiceV1Beta1Client.report_phishing",
                    extra = {
                        "serviceName": "google.cloud.phishingprotection.v1beta1.PhishingProtectionServiceV1Beta1",
                        "rpcName": "ReportPhishing",

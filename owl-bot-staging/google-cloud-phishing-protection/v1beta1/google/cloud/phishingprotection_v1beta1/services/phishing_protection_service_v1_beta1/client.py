...
class PhishingProtectionServiceV1Beta1Client(metaclass=PhishingProtectionServiceV1Beta1ClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "phishingprotection.{UNIVERSE_DOMAIN}"
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = PhishingProtectionServiceV1Beta1Client.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = PhishingProtectionServiceV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = PhishingProtectionServiceV1Beta1Client._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            PhishingProtectionServiceV1Beta1Client._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PhishingProtectionServiceV1Beta1Transport, Callable[..., PhishingProtectionServiceV1Beta1Transport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PhishingProtectionServiceV1Beta1Client._read_environment_variables()
        self._client_cert_source = PhishingProtectionServiceV1Beta1Client._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = PhishingProtectionServiceV1Beta1Client._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, PhishingProtectionServiceV1Beta1Transport)
        if transport_provided:
            ...
            self._transport = cast(PhishingProtectionServiceV1Beta1Transport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            PhishingProtectionServiceV1Beta1Client._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[PhishingProtectionServiceV1Beta1Transport], Callable[..., PhishingProtectionServiceV1Beta1Transport]] = (
                type(self).get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., PhishingProtectionServiceV1Beta1Transport], transport)
            )

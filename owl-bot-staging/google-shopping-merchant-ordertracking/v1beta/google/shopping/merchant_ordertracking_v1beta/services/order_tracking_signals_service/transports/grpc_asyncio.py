...
class OrderTrackingSignalsServiceGrpcAsyncIOTransport(OrderTrackingSignalsServiceTransport):
    """gRPC AsyncIO backend transport for OrderTrackingSignalsService.
    ...
    def create_order_tracking_signal(self) -> Callable[
            ...
            Awaitable[order_tracking_signals.OrderTrackingSignal]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_order_tracking_signal: self._wrap_method(
                self.create_order_tracking_signal,

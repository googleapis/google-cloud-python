...
from .base import OrderTrackingSignalsServiceTransport, DEFAULT_CLIENT_INFO
...
class OrderTrackingSignalsServiceGrpcTransport(OrderTrackingSignalsServiceTransport):
    """gRPC backend transport for OrderTrackingSignalsService.
    ...
    def create_order_tracking_signal(self) -> Callable[
        ...
        r"""Return a callable for the create order tracking signal method over gRPC.

        Creates new order tracking signal.

        Returns:
            Callable[[~.CreateOrderTrackingSignalRequest],
                    ~.OrderTrackingSignal]:
        ...
        if 'create_order_tracking_signal' not in self._stubs:
            self._stubs['create_order_tracking_signal'] = self._logged_channel.unary_unary(

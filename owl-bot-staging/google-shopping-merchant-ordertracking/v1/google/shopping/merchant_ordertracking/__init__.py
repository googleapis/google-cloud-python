...
from google.shopping.merchant_ordertracking_v1.types.order_tracking_signals import CreateOrderTrackingSignalRequest
from google.shopping.merchant_ordertracking_v1.types.order_tracking_signals import OrderTrackingSignal

...
class CreateOrderTrackingSignalRequest(proto.Message):
    ...
    Attributes:
        ...
        order_tracking_signal (google.shopping.merchant_ordertracking_v1.types.OrderTrackingSignal):
...
class OrderTrackingSignal(proto.Message):
    ...
    Attributes:
        ...
        shipping_info (MutableSequence[google.shopping.merchant_ordertracking_v1.types.OrderTrackingSignal.ShippingInfo]):
            Required. The shipping information for the
            order.
        line_items (MutableSequence[google.shopping.merchant_ordertracking_v1.types.OrderTrackingSignal.LineItemDetails]):
            Required. Information about line items in the
            order.
        shipment_line_item_mapping (MutableSequence[google.shopping.merchant_ordertracking_v1.types.OrderTrackingSignal.ShipmentLineItemMapping]):
    ...
    class ShippingInfo(proto.Message):
        ...
        Attributes:
            ...
            actual_delivery_time (google.type.datetime_pb2.DateTime):
                ...
                tracking_id or carrier_name.
            shipping_status (google.shopping.merchant_ordertracking_v1.types.OrderTrackingSignal.ShippingInfo.ShippingState):

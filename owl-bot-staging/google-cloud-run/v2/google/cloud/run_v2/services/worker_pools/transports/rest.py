...
class WorkerPoolsRestTransport(_BaseWorkerPoolsRestTransport):
    ...
    class _DeleteOperation(_BaseWorkerPoolsRestTransport._BaseDeleteOperation, WorkerPoolsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WorkerPoolsRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseWorkerPoolsRestTransport._BaseGetOperation, WorkerPoolsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WorkerPoolsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseWorkerPoolsRestTransport._BaseListOperations, WorkerPoolsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WorkerPoolsRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _WaitOperation(_BaseWorkerPoolsRestTransport._BaseWaitOperation, WorkerPoolsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WorkerPoolsRestTransport._WaitOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

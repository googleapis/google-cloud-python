...
class ServicesClient(metaclass=ServicesClientMeta):
    ...
    def create_service(self,
        ...
        # in a gcr_service.CreateServiceRequest.
    ...
    def get_service(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.GetServiceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_services(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.ListServicesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_service(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a gcr_service.UpdateServiceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_service(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.DeleteServiceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

...
def test_get_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TasksRestInterceptor, "post_get_task_with_metadata") as post_with_metadata, \
...
def test_list_tasks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TasksRestInterceptor, "post_list_tasks_with_metadata") as post_with_metadata, \

...
def test_get_execution_rest_required_fields(request_type=execution.GetExecutionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_execution._get_unset_required_fields(jsonified_request)
...
def test_get_execution_rest_unset_required_fields():
    transport = transports.ExecutionsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_execution_rest_bad_request(transport: str = 'rest', request_type=execution.GetExecutionRequest):
    client = ExecutionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_executions_rest_required_fields(request_type=execution.ListExecutionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_executions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_executions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = execution.ListExecutionsResponse.to_json(execution.ListExecutionsResponse())
...
def test_list_executions_rest_bad_request(transport: str = 'rest', request_type=execution.ListExecutionsRequest):
    client = ExecutionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_execution_rest_required_fields(request_type=execution.DeleteExecutionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_execution._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_execution_rest_bad_request(transport: str = 'rest', request_type=execution.DeleteExecutionRequest):
    client = ExecutionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_cancel_execution_rest(request_type):
    client = ExecutionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport="rest",
    )
...
def test_cancel_execution_rest_required_fields(request_type=execution.CancelExecutionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).cancel_execution._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_execution_rest_bad_request(transport: str = 'rest', request_type=execution.CancelExecutionRequest):
    client = ExecutionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_cancel_execution_rest_error():
    client = ExecutionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport='rest'
    )

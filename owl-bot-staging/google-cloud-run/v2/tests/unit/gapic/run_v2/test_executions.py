...
def test_get_execution_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ExecutionsRestInterceptor, "post_get_execution_with_metadata") as post_with_metadata, \
...
def test_list_executions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ExecutionsRestInterceptor, "post_list_executions_with_metadata") as post_with_metadata, \
...
def test_delete_execution_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ExecutionsRestInterceptor, "post_delete_execution_with_metadata") as post_with_metadata, \
...
def test_cancel_execution_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ExecutionsRestInterceptor, "post_cancel_execution_with_metadata") as post_with_metadata, \

...
def test_create_job_routing_parameters():
    ...
    request = gcr_job.CreateJobRequest(**{"parent": "projects/sample1/locations/sample2"})
...
def test_get_job_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = job.GetJobRequest(**{"name": "projects/sample1/locations/sample2/sample3"})
...
def test_update_job_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = gcr_job.UpdateJobRequest(**{"job": {"name": "projects/sample1/locations/sample2/sample3"}})
...
def test_delete_job_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = job.DeleteJobRequest(**{"name": "projects/sample1/locations/sample2/sample3"})
...
def test_run_job_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = job.RunJobRequest(**{"name": "projects/sample1/locations/sample2/sample3"})
...
def test_create_job_rest_bad_request(transport: str = 'rest', request_type=gcr_job.CreateJobRequest):
    client = JobsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_job_rest_bad_request(transport: str = 'rest', request_type=job.GetJobRequest):
    client = JobsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = job.ListJobsResponse.to_json(job.ListJobsResponse())
...
def test_list_jobs_rest_bad_request(transport: str = 'rest', request_type=job.ListJobsRequest):
    client = JobsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_job_rest_bad_request(transport: str = 'rest', request_type=gcr_job.UpdateJobRequest):
    client = JobsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_job_rest_bad_request(transport: str = 'rest', request_type=job.DeleteJobRequest):
    client = JobsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_run_job_rest_required_fields(request_type=job.RunJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).run_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_run_job_rest_bad_request(transport: str = 'rest', request_type=job.RunJobRequest):
    client = JobsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = JobsClient.get_transport_class(transport_name)(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
    )

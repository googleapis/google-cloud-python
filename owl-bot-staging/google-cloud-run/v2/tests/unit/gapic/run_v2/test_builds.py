...
def test_submit_build_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = build.SubmitBuildResponse.to_json(build.SubmitBuildResponse())
...
def test_submit_build_rest_bad_request(transport: str = 'rest', request_type=build.SubmitBuildRequest):
    client = BuildsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

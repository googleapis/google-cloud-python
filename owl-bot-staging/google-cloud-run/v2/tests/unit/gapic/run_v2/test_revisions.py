...
def test_get_revision_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RevisionsRestInterceptor, "post_get_revision_with_metadata") as post_with_metadata, \
...
def test_list_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RevisionsRestInterceptor, "post_list_revisions_with_metadata") as post_with_metadata, \
...
def test_delete_revision_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RevisionsRestInterceptor, "post_delete_revision_with_metadata") as post_with_metadata, \

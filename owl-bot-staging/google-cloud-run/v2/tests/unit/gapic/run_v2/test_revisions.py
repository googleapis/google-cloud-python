...
def test_get_revision_routing_parameters():
    ...
    request = revision.GetRevisionRequest(**{"name": "projects/sample1/locations/sample2/sample3"})
...
def test_list_revisions_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = revision.ListRevisionsRequest(**{"parent": "projects/sample1/locations/sample2/sample3"})
...
def test_delete_revision_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = revision.DeleteRevisionRequest(**{"name": "projects/sample1/locations/sample2/sample3"})
...
def test_get_revision_rest_bad_request(transport: str = 'rest', request_type=revision.GetRevisionRequest):
    client = RevisionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = revision.ListRevisionsResponse.to_json(revision.ListRevisionsResponse())
...
def test_list_revisions_rest_bad_request(transport: str = 'rest', request_type=revision.ListRevisionsRequest):
    client = RevisionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_revision_rest_required_fields(request_type=revision.DeleteRevisionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_revision._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_revision_rest_bad_request(transport: str = 'rest', request_type=revision.DeleteRevisionRequest):
    client = RevisionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )

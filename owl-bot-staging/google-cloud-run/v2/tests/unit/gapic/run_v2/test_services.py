...
def test_create_service_routing_parameters():
    ...
    request = gcr_service.CreateServiceRequest(**{"parent": "projects/sample1/locations/sample2"})
...
def test_get_service_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = service.GetServiceRequest(**{"name": "projects/sample1/locations/sample2/sample3"})
...
def test_list_services_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = service.ListServicesRequest(**{"parent": "projects/sample1/locations/sample2"})
...
def test_update_service_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = gcr_service.UpdateServiceRequest(**{"service": {"name": "projects/sample1/locations/sample2/sample3"}})
...
def test_delete_service_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = service.DeleteServiceRequest(**{"name": "projects/sample1/locations/sample2/sample3"})
...
def test_create_service_rest_bad_request(transport: str = 'rest', request_type=gcr_service.CreateServiceRequest):
    client = ServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_service_rest_bad_request(transport: str = 'rest', request_type=service.GetServiceRequest):
    client = ServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_services_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.ListServicesResponse.to_json(service.ListServicesResponse())
...
def test_list_services_rest_bad_request(transport: str = 'rest', request_type=service.ListServicesRequest):
    client = ServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_service_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "validateOnly", )) & set(("service", )))
...
def test_update_service_rest_bad_request(transport: str = 'rest', request_type=gcr_service.UpdateServiceRequest):
    client = ServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_service_rest_bad_request(transport: str = 'rest', request_type=service.DeleteServiceRequest):
    client = ServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )

...
class runCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'delete_worker_pool': ('name', 'validate_only', 'etag', ),
        'get_execution': ('name', ),
        ...
        'list_worker_pools': ('parent', 'page_size', 'page_token', 'show_deleted', ),
        ...
        'update_worker_pool': ('worker_pool', 'update_mask', 'validate_only', 'allow_missing', 'force_new_revision', ),
    }

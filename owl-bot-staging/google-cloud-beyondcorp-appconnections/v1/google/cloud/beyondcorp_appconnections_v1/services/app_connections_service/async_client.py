...
from google.cloud.beyondcorp_appconnections_v1.services.app_connections_service import pagers
...
from .client import AppConnectionsServiceClient
...
class AppConnectionsServiceAsyncClient:
    ...
    DEFAULT_ENDPOINT = AppConnectionsServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = AppConnectionsServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = AppConnectionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = AppConnectionsServiceClient._DEFAULT_UNIVERSE

    app_connection_path = staticmethod(AppConnectionsServiceClient.app_connection_path)
    parse_app_connection_path = staticmethod(AppConnectionsServiceClient.parse_app_connection_path)
    app_connector_path = staticmethod(AppConnectionsServiceClient.app_connector_path)
    parse_app_connector_path = staticmethod(AppConnectionsServiceClient.parse_app_connector_path)
    app_gateway_path = staticmethod(AppConnectionsServiceClient.app_gateway_path)
    parse_app_gateway_path = staticmethod(AppConnectionsServiceClient.parse_app_gateway_path)
    common_billing_account_path = staticmethod(AppConnectionsServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(AppConnectionsServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(AppConnectionsServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(AppConnectionsServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(AppConnectionsServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(AppConnectionsServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(AppConnectionsServiceClient.common_project_path)
    parse_common_project_path = staticmethod(AppConnectionsServiceClient.parse_common_project_path)
    common_location_path = staticmethod(AppConnectionsServiceClient.common_location_path)
    parse_common_location_path = staticmethod(AppConnectionsServiceClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AppConnectionsServiceAsyncClient: The constructed client.
        """
        return AppConnectionsServiceClient.from_service_account_info.__func__(AppConnectionsServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            AppConnectionsServiceAsyncClient: The constructed client.
        """
        return AppConnectionsServiceClient.from_service_account_file.__func__(AppConnectionsServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def transport(self) -> AppConnectionsServiceTransport:
        ...
        Returns:
            AppConnectionsServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AppConnectionsServiceTransport, Callable[..., AppConnectionsServiceTransport]]] = "grpc_asyncio",
            client_options: Optional[ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the app connections service async client.
        ...
        """
        self._client = AppConnectionsServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.beyondcorp.appconnections_v1.AppConnectionsServiceAsyncClient`.",
                extra = {
    ...
    async def list_app_connections(self,
            request: Optional[Union[app_connections_service.ListAppConnectionsRequest, dict]] = None,
            *,
        ...
        Args:
            ...
            parent (:class:`str`):
                Required. The resource name of the AppConnection
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_app_connections]
        ...
        response = pagers.ListAppConnectionsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_app_connection(self,
            request: Optional[Union[app_connections_service.GetAppConnectionRequest, dict]] = None,
            *,
        ...
        Returns:
            google.cloud.beyondcorp_appconnections_v1.types.AppConnection:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_app_connection]
    ...
    async def create_app_connection(self,
            request: Optional[Union[app_connections_service.CreateAppConnectionRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.beyondcorp_appconnections_v1.types.AppConnection` A BeyondCorp AppConnection resource represents a BeyondCorp protected
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, app_connection, app_connection_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        if app_connection is not None:
            request.app_connection = app_connection
        if app_connection_id is not None:
            request.app_connection_id = app_connection_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_app_connection]
        ...
        response = operation_async.from_gapic(
            ...
            app_connections_service.AppConnection,
            metadata_type=app_connections_service.AppConnectionOperationMetadata,
        )

        # Done; return the response.
        return response

    async def update_app_connection(self,
            request: Optional[Union[app_connections_service.UpdateAppConnectionRequest, dict]] = None,
            *,
            app_connection: Optional[app_connections_service.AppConnection] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [app_connection, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_app_connection]
    ...
    async def delete_app_connection(self,
            request: Optional[Union[app_connections_service.DeleteAppConnectionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_app_connection]
    ...
    async def resolve_app_connections(self,
            request: Optional[Union[app_connections_service.ResolveAppConnectionsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, app_connections_service.ResolveAppConnectionsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.resolve_app_connections]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ResolveAppConnectionsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,

...
class AppConnectionsServiceTransport(abc.ABC):
    """Abstract transport class for AppConnectionsService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_app_connections: gapic_v1.method.wrap_method(
                self.list_app_connections,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_app_connection: gapic_v1.method.wrap_method(
                self.get_app_connection,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_app_connection: gapic_v1.method.wrap_method(
                self.create_app_connection,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_app_connection: gapic_v1.method.wrap_method(
                self.update_app_connection,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_app_connection: gapic_v1.method.wrap_method(
                self.delete_app_connection,
                default_timeout=None,
                client_info=client_info,
            ),
            self.resolve_app_connections: gapic_v1.method.wrap_method(
                self.resolve_app_connections,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    def get_app_connection(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[app_connections_service.AppConnection]
            ]]:
        raise NotImplementedError()

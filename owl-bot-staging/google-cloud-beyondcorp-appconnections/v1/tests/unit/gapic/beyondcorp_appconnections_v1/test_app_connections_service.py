...
def test_list_app_connections_rest_required_fields(request_type=app_connections_service.ListAppConnectionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_app_connections._get_unset_required_fields(jsonified_request)
...
def test_list_app_connections_rest_unset_required_fields():
    transport = transports.AppConnectionsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_app_connection_rest_required_fields(request_type=app_connections_service.GetAppConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_app_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_app_connection_rest_required_fields(request_type=app_connections_service.CreateAppConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_app_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_app_connection_rest_required_fields(request_type=app_connections_service.UpdateAppConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_app_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_app_connection_rest_required_fields(request_type=app_connections_service.DeleteAppConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_app_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_resolve_app_connections_rest_required_fields(request_type=app_connections_service.ResolveAppConnectionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).resolve_app_connections._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

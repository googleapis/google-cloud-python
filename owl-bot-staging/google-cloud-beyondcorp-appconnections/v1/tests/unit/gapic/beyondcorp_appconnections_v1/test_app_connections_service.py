...
from google.cloud.beyondcorp_appconnections_v1.services.app_connections_service import AppConnectionsServiceAsyncClient
...
from google.cloud.beyondcorp_appconnections_v1.services.app_connections_service import transports
...
def test__read_environment_variables():
    assert AppConnectionsServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert AppConnectionsServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        with pytest.raises(ValueError) as excinfo:
            AppConnectionsServiceClient._read_environment_variables()
    assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert AppConnectionsServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert AppConnectionsServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert AppConnectionsServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert AppConnectionsServiceClient._get_client_cert_source(None, False) is None
    assert AppConnectionsServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AppConnectionsServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert AppConnectionsServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AppConnectionsServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(AppConnectionsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppConnectionsServiceClient))
@mock.patch.object(AppConnectionsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppConnectionsServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AppConnectionsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = AppConnectionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AppConnectionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AppConnectionsServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert AppConnectionsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AppConnectionsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert AppConnectionsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AppConnectionsServiceClient._get_api_endpoint(None, None, default_universe, "always") == AppConnectionsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert AppConnectionsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AppConnectionsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert AppConnectionsServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AppConnectionsServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AppConnectionsServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AppConnectionsServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AppConnectionsServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AppConnectionsServiceClient._get_universe_domain(None, None) == AppConnectionsServiceClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        AppConnectionsServiceClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = AppConnectionsServiceClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_name", [
    (AppConnectionsServiceClient, "grpc"),
    (AppConnectionsServiceAsyncClient, "grpc_asyncio"),
    (AppConnectionsServiceClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    ...
    (transports.AppConnectionsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
def test_app_connections_service_client_get_transport_class():
    ...
    available_transports = [
        transports.AppConnectionsServiceGrpcTransport,
        transports.AppConnectionsServiceRestTransport,
    ]
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (AppConnectionsServiceClient, transports.AppConnectionsServiceGrpcTransport, "grpc"),
    (AppConnectionsServiceAsyncClient, transports.AppConnectionsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (AppConnectionsServiceClient, transports.AppConnectionsServiceRestTransport, "rest"),
])
@mock.patch.object(AppConnectionsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppConnectionsServiceClient))
@mock.patch.object(AppConnectionsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppConnectionsServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (AppConnectionsServiceClient, transports.AppConnectionsServiceGrpcTransport, "grpc", "true"),
    (AppConnectionsServiceAsyncClient, transports.AppConnectionsServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (AppConnectionsServiceClient, transports.AppConnectionsServiceGrpcTransport, "grpc", "false"),
    (AppConnectionsServiceAsyncClient, transports.AppConnectionsServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (AppConnectionsServiceClient, transports.AppConnectionsServiceRestTransport, "rest", "true"),
    (AppConnectionsServiceClient, transports.AppConnectionsServiceRestTransport, "rest", "false"),
])
@mock.patch.object(AppConnectionsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppConnectionsServiceClient))
@mock.patch.object(AppConnectionsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppConnectionsServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    AppConnectionsServiceClient, AppConnectionsServiceAsyncClient
])
...
@mock.patch.object(AppConnectionsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppConnectionsServiceClient))
@mock.patch.object(AppConnectionsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppConnectionsServiceAsyncClient))
def test_app_connections_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (AppConnectionsServiceClient, transports.AppConnectionsServiceGrpcTransport, "grpc", grpc_helpers),
    (AppConnectionsServiceAsyncClient, transports.AppConnectionsServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (AppConnectionsServiceClient, transports.AppConnectionsServiceRestTransport, "rest", None),
])
...
def test_list_app_connections(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.list_app_connections),
            '__call__') as call:
...
def test_list_app_connections_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_app_connections in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_app_connections] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_app_connections_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_app_connections in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_app_connections] = mock_rpc
...
async def test_list_app_connections_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_app_connections(
            app_connections_service.ListAppConnectionsRequest(),
            parent='parent_value',
        )
...
def test_list_app_connections_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_app_connections(request={}, retry=retry, timeout=timeout)
        ...
        assert all(isinstance(i, app_connections_service.AppConnection)
                   for i in results)
...
def test_get_app_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_app_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_app_connection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_app_connection in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_app_connection] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_app_connection_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AppConnectionsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_app_connection in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_app_connection] = mock_rpc
...
async def test_get_app_connection_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_app_connection(
            app_connections_service.GetAppConnectionRequest(),
            name='name_value',
        )
...
def test_create_app_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_app_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_app_connection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_app_connection in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_app_connection] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_app_connection_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AppConnectionsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_app_connection in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_app_connection] = mock_rpc
...
def test_create_app_connection_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_app_connection(
            parent='parent_value',
            app_connection=app_connections_service.AppConnection(name='name_value'),
            app_connection_id='app_connection_id_value',
        )
...
async def test_create_app_connection_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_app_connection(
            app_connections_service.CreateAppConnectionRequest(),
            parent='parent_value',
            app_connection=app_connections_service.AppConnection(name='name_value'),
            app_connection_id='app_connection_id_value',
...
def test_update_app_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_app_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_app_connection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_app_connection in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_app_connection] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_app_connection_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AppConnectionsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_app_connection in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_app_connection] = mock_rpc
...
async def test_update_app_connection_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_app_connection(
            app_connections_service.UpdateAppConnectionRequest(),
            app_connection=app_connections_service.AppConnection(name='name_value'),
            update_mask=field_mask_pb2.FieldMask(paths=['paths_value']),
        )
...
def test_delete_app_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_app_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_app_connection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_app_connection in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_app_connection] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_app_connection_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AppConnectionsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_app_connection in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_app_connection] = mock_rpc
...
async def test_delete_app_connection_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_app_connection(
            app_connections_service.DeleteAppConnectionRequest(),
            name='name_value',
        )
...
def test_resolve_app_connections(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resolve_app_connections),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_resolve_app_connections_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.resolve_app_connections in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.resolve_app_connections] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_resolve_app_connections_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AppConnectionsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.resolve_app_connections in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.resolve_app_connections] = mock_rpc
...
async def test_resolve_app_connections_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.resolve_app_connections(
            app_connections_service.ResolveAppConnectionsRequest(),
            parent='parent_value',
        )
...
def test_resolve_app_connections_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.resolve_app_connections(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, app_connections_service.ResolveAppConnectionsResponse.AppConnectionDetails)
                   for i in results)
...
def test_list_app_connections_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppConnectionsServiceClient(
...
def test_get_app_connection_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppConnectionsServiceClient(
...
def test_update_app_connection_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppConnectionsServiceClient(
...
def test_delete_app_connection_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppConnectionsServiceClient(
...
def test_resolve_app_connections_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppConnectionsServiceClient(
...
def test_credentials_transport_error():
    ...
    transport = transports.AppConnectionsServiceGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = AppConnectionsServiceClient(
...
def test_transport_get_channel():
    ...
    transport = transports.AppConnectionsServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_list_app_connections_empty_call_grpc():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = app_connections_service.ListAppConnectionsResponse()
        client.list_app_connections(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_app_connection_empty_call_grpc():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = app_connections_service.AppConnection()
        client.get_app_connection(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_app_connection_empty_call_grpc():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_app_connection(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_app_connection_empty_call_grpc():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_app_connection(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_app_connection_empty_call_grpc():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_app_connection(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resolve_app_connections_empty_call_grpc():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = app_connections_service.ResolveAppConnectionsResponse()
        client.resolve_app_connections(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = AppConnectionsServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_app_connections_empty_call_grpc_asyncio():
    client = AppConnectionsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_app_connections(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_app_connection_empty_call_grpc_asyncio():
    client = AppConnectionsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_app_connection_empty_call_grpc_asyncio():
    client = AppConnectionsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_app_connection(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_app_connection_empty_call_grpc_asyncio():
    client = AppConnectionsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_app_connection(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_app_connection_empty_call_grpc_asyncio():
    client = AppConnectionsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_app_connection(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_resolve_app_connections_empty_call_grpc_asyncio():
    client = AppConnectionsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.resolve_app_connections(request=None)
...
def test_transport_kind_rest():
    transport = AppConnectionsServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_app_connections_rest_bad_request(request_type=app_connections_service.ListAppConnectionsRequest):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_app_connections_rest_call_success(request_type):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_app_connections_rest_interceptors(null_interceptor):
    transport = transports.AppConnectionsServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.AppConnectionsServiceRestInterceptor(),
        )
    client = AppConnectionsServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_list_app_connections") as post, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_list_app_connections_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "pre_list_app_connections") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = app_connections_service.ListAppConnectionsResponse.to_json(app_connections_service.ListAppConnectionsResponse())
        ...
        post_with_metadata.return_value = app_connections_service.ListAppConnectionsResponse(), metadata
...
def test_get_app_connection_rest_bad_request(request_type=app_connections_service.GetAppConnectionRequest):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_app_connection_rest_call_success(request_type):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_app_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_get_app_connection") as post, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_get_app_connection_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "pre_get_app_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = app_connections_service.AppConnection.to_json(app_connections_service.AppConnection())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = app_connections_service.AppConnection(), metadata
...
def test_create_app_connection_rest_bad_request(request_type=app_connections_service.CreateAppConnectionRequest):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_app_connection_rest_call_success(request_type):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    for field, value in request_init["app_connection"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_app_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_create_app_connection") as post, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_create_app_connection_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "pre_create_app_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_app_connection_rest_bad_request(request_type=app_connections_service.UpdateAppConnectionRequest):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_app_connection_rest_call_success(request_type):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_app_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_update_app_connection") as post, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_update_app_connection_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "pre_update_app_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_app_connection_rest_bad_request(request_type=app_connections_service.DeleteAppConnectionRequest):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_app_connection_rest_call_success(request_type):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_app_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_delete_app_connection") as post, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_delete_app_connection_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "pre_delete_app_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_resolve_app_connections_rest_bad_request(request_type=app_connections_service.ResolveAppConnectionsRequest):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_resolve_app_connections_rest_call_success(request_type):
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_resolve_app_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_resolve_app_connections") as post, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_resolve_app_connections_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "pre_resolve_app_connections") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = app_connections_service.ResolveAppConnectionsResponse.to_json(app_connections_service.ResolveAppConnectionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = app_connections_service.ResolveAppConnectionsResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_app_connections_empty_call_rest():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_app_connection_empty_call_rest():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_app_connection_empty_call_rest():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_app_connection_empty_call_rest():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_app_connection_empty_call_rest():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resolve_app_connections_empty_call_rest():
    client = AppConnectionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [
        (transports.AppConnectionsServiceGrpcTransport, grpc_helpers),
        (transports.AppConnectionsServiceGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_app_connections_service_client_transport_session_collision(transport_name):
    ...
    client1 = AppConnectionsServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = AppConnectionsServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("transport_class", [transports.AppConnectionsServiceGrpcTransport, transports.AppConnectionsServiceGrpcAsyncIOTransport])
def test_app_connections_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
@pytest.mark.parametrize("client_class,transport_class", [
    (AppConnectionsServiceClient, transports.AppConnectionsServiceGrpcTransport),

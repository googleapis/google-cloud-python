...
class GroundedGenerationServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_check_grounding(self, response: grounded_generation_service.CheckGroundingResponse) -> grounded_generation_service.CheckGroundingResponse:
        ...
        """
        return response
    def pre_generate_grounded_content(self, request: grounded_generation_service.GenerateGroundedContentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[grounded_generation_service.GenerateGroundedContentRequest, Sequence[Tuple[str, str]]]:
...
class GroundedGenerationServiceRestTransport(GroundedGenerationServiceTransport):
    ...
    class _GenerateGroundedContent(GroundedGenerationServiceRestStub):
        def __hash__(self):
            return hash("GenerateGroundedContent")
    ...
    class _StreamGenerateGroundedContent(GroundedGenerationServiceRestStub):
        def __hash__(self):
            return hash("StreamGenerateGroundedContent")

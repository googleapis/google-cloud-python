...
class GroundedGenerationServiceAsyncClient:
    """Service for grounded generation."""

    _client: GroundedGenerationServiceClient
    ...
    parse_location_path = staticmethod(GroundedGenerationServiceClient.parse_location_path)
    serving_config_path = staticmethod(GroundedGenerationServiceClient.serving_config_path)
    parse_serving_config_path = staticmethod(GroundedGenerationServiceClient.parse_serving_config_path)
    ...
    def transport(self) -> GroundedGenerationServiceTransport:
        ...
        Returns:
            GroundedGenerationServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = GroundedGenerationServiceClient.get_transport_class
    ...
    def __init__(self, *,
        ...
        """
        self._client = GroundedGenerationServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1.GroundedGenerationServiceAsyncClient`.",
                extra = {
    ...
    def stream_generate_grounded_content(self,
            requests: Optional[AsyncIterator[grounded_generation_service.GenerateGroundedContentRequest]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> Awaitable[AsyncIterable[grounded_generation_service.GenerateGroundedContentResponse]]:
        ...
        Args:
            requests (AsyncIterator[`google.cloud.discoveryengine_v1.types.GenerateGroundedContentRequest`]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.stream_generate_grounded_content]
    ...
    async def generate_grounded_content(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.GenerateGroundedContentRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.generate_grounded_content]
    ...
    async def check_grounding(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.CheckGroundingRequest, dict]]):
    ...
    async def __aenter__(self) -> "GroundedGenerationServiceAsyncClient":
        return self

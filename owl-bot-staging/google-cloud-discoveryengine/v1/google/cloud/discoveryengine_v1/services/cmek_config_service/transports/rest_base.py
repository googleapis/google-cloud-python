...
class _BaseCmekConfigServiceRestTransport(CmekConfigServiceTransport):
    """Base REST backend transport for CmekConfigService.
    ...
    class _BaseDeleteCmekConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1/{name=projects/*/locations/*/cmekConfigs/*}',
            },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = cmek_config_service.DeleteCmekConfigRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCmekConfigServiceRestTransport._BaseDeleteCmekConfig._get_unset_required_fields(query_params))
    ...
    class _BaseGetCmekConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1/{name=projects/*/locations/*/cmekConfig}',
            },
        {
                'method': 'get',
                'uri': '/v1/{name=projects/*/locations/*/cmekConfigs/*}',
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = cmek_config_service.GetCmekConfigRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCmekConfigServiceRestTransport._BaseGetCmekConfig._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseListCmekConfigs:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1/{parent=projects/*/locations/*}/cmekConfigs',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = cmek_config_service.ListCmekConfigsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCmekConfigServiceRestTransport._BaseListCmekConfigs._get_unset_required_fields(query_params))
    ...
    class _BaseUpdateCmekConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1/{config.name=projects/*/locations/*/cmekConfig}',
                'body': 'config',
            },
        {
                'method': 'patch',
                'uri': '/v1/{config.name=projects/*/locations/*/cmekConfigs/*}',
                'body': 'config',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = cmek_config_service.UpdateCmekConfigRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCmekConfigServiceRestTransport._BaseUpdateCmekConfig._get_unset_required_fields(query_params))
...
__all__=(
    '_BaseCmekConfigServiceRestTransport',
)

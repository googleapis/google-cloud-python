...
from .base import DataStoreServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class DataStoreServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_data_store(self, request: data_store_service.CreateDataStoreRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[data_store_service.CreateDataStoreRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_data_store(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_delete_data_store(self, request: data_store_service.DeleteDataStoreRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[data_store_service.DeleteDataStoreRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_delete_data_store(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_get_data_store(self, request: data_store_service.GetDataStoreRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[data_store_service.GetDataStoreRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_data_store(self, response: data_store.DataStore) -> data_store.DataStore:
        ...
        """
        return response
    def pre_list_data_stores(self, request: data_store_service.ListDataStoresRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[data_store_service.ListDataStoresRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_data_stores(self, response: data_store_service.ListDataStoresResponse) -> data_store_service.ListDataStoresResponse:
        ...
        """
        return response
    def pre_update_data_store(self, request: data_store_service.UpdateDataStoreRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[data_store_service.UpdateDataStoreRequest, Sequence[Tuple[str, str]]]:

...
class EngineServiceGrpcAsyncIOTransport(EngineServiceTransport):
    """gRPC AsyncIO backend transport for EngineService.
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_engine: gapic_v1.method_async.wrap_method(
                self.create_engine,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_engine: gapic_v1.method_async.wrap_method(
                self.delete_engine,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_engine: gapic_v1.method_async.wrap_method(
                self.update_engine,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_engine: gapic_v1.method_async.wrap_method(
                self.get_engine,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_engines: gapic_v1.method_async.wrap_method(
                self.list_engines,
                default_timeout=None,
                client_info=client_info,
            ),

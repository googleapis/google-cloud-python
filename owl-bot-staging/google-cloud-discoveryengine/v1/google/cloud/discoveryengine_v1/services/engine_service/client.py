...
class EngineServiceClient(metaclass=EngineServiceClientMeta):
    ...
    @staticmethod
    def collection_path(project: str,location: str,collection: str,) -> str:
        """Returns a fully-qualified collection string."""
        return "projects/{project}/locations/{location}/collections/{collection}".format(project=project, location=location, collection=collection, )

    @staticmethod
    def parse_collection_path(path: str) -> Dict[str,str]:
        """Parses a collection path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/collections/(?P<collection>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = EngineServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = EngineServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = EngineServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = EngineServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, EngineServiceTransport, Callable[..., EngineServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = EngineServiceClient._read_environment_variables()
        self._client_cert_source = EngineServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = EngineServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, EngineServiceTransport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[EngineServiceTransport], Callable[..., EngineServiceTransport]] = (
                EngineServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., EngineServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1.EngineServiceClient`.",
                    extra = {
    ...
    def create_engine(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.CreateEngineRequest, dict]):
        ...
        flattened_params = [parent, engine, engine_id]
    ...
    def delete_engine(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.DeleteEngineRequest, dict]):
    ...
    def update_engine(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.UpdateEngineRequest, dict]):
                The request object. Request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [engine, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def get_engine(self,
        ...
        r"""Gets a [Engine][google.cloud.discoveryengine.v1.Engine].
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.GetEngineRequest, dict]):
                The request object. Request message for
    ...
    def list_engines(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.ListEnginesRequest, dict]):
                The request object. Request message for

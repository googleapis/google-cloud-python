...
class ControlServiceAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1.ControlServiceAsyncClient`.",
                extra = {
    ...
    async def create_control(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.CreateControlRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            control (:class:`google.cloud.discoveryengine_v1.types.Control`):
    ...
    async def delete_control(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.DeleteControlRequest, dict]]):
    ...
    async def update_control(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.UpdateControlRequest, dict]]):
    ...
    async def list_controls(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.ListControlsRequest, dict]]):

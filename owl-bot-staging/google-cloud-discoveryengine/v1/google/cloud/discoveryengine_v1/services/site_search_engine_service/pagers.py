...
class ListTargetSitesPager:
    ...
    :class:`google.cloud.discoveryengine_v1.types.ListTargetSitesResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1.types.ListTargetSitesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1.types.ListTargetSitesRequest):
...
class FetchDomainVerificationStatusPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.discoveryengine_v1.types.FetchDomainVerificationStatusResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``target_sites`` field.
    ...
    All the usual :class:`google.cloud.discoveryengine_v1.types.FetchDomainVerificationStatusResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.discoveryengine_v1.types.FetchDomainVerificationStatusRequest):
                The initial request object.

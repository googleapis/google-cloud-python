...
class SearchTuningServiceClient(metaclass=SearchTuningServiceClientMeta):
    ...
    @staticmethod
    def custom_tuning_model_path(project: str,location: str,data_store: str,custom_tuning_model: str,) -> str:
        """Returns a fully-qualified custom_tuning_model string."""
        return "projects/{project}/locations/{location}/dataStores/{data_store}/customTuningModels/{custom_tuning_model}".format(project=project, location=location, data_store=data_store, custom_tuning_model=custom_tuning_model, )

    @staticmethod
    def parse_custom_tuning_model_path(path: str) -> Dict[str,str]:
        """Parses a custom_tuning_model path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/customTuningModels/(?P<custom_tuning_model>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SearchTuningServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SearchTuningServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SearchTuningServiceTransport, Callable[..., SearchTuningServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SearchTuningServiceClient._read_environment_variables()
        self._client_cert_source = SearchTuningServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SearchTuningServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SearchTuningServiceTransport], Callable[..., SearchTuningServiceTransport]] = (

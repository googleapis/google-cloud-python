...
class SchemaServiceClient(metaclass=SchemaServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SchemaServiceTransport, Callable[..., SchemaServiceTransport]]] = None,
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SchemaServiceTransport], Callable[..., SchemaServiceTransport]] = (

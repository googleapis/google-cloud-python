...
class SchemaServiceClient(metaclass=SchemaServiceClientMeta):
    ...
    @staticmethod
    def schema_path(project: str,location: str,data_store: str,schema: str,) -> str:
        """Returns a fully-qualified schema string."""
        return "projects/{project}/locations/{location}/dataStores/{data_store}/schemas/{schema}".format(project=project, location=location, data_store=data_store, schema=schema, )

    @staticmethod
    def parse_schema_path(path: str) -> Dict[str,str]:
        """Parses a schema path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/schemas/(?P<schema>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SchemaServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SchemaServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SchemaServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SchemaServiceClient._read_environment_variables()
        self._client_cert_source = SchemaServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SchemaServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SchemaServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(SchemaServiceTransport, transport)
    ...
    def get_schema(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.GetSchemaRequest, dict]):
        ...
        # in a schema_service.GetSchemaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, schema_service.GetSchemaRequest):
    ...
    def list_schemas(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.ListSchemasRequest, dict]):
                The request object. Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a schema_service.ListSchemasRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, schema_service.ListSchemasRequest):
    ...
    def create_schema(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.CreateSchemaRequest, dict]):
                The request object. Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a schema_service.CreateSchemaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, schema_service.CreateSchemaRequest):
    ...
    def update_schema(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.UpdateSchemaRequest, dict]):
                The request object. Request message for
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a schema_service.UpdateSchemaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, schema_service.UpdateSchemaRequest):
            request = schema_service.UpdateSchemaRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_schema]
    ...
    def delete_schema(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.DeleteSchemaRequest, dict]):
                The request object. Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a schema_service.DeleteSchemaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, schema_service.DeleteSchemaRequest):

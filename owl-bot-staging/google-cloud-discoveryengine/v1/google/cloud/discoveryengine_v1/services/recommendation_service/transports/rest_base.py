    ...
    class _BaseRecommend:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:recommend',
                'body': '*',
            },
        {
                'method': 'post',
                'uri': '/v1/{serving_config=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:recommend',
                'body': '*',
            },
        {
                'method': 'post',
                'uri': '/v1/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}:recommend',
                'body': '*',
            },
            ]
            return http_options
...
__all__=(
    '_BaseRecommendationServiceRestTransport',
)

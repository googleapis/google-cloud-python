...
class IdentityMappingStoreServiceAsyncClient:
    ...
    async def create_identity_mapping_store(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_identity_mapping_store():
                ...
                request = discoveryengine_v1.CreateIdentityMappingStoreRequest(
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.CreateIdentityMappingStoreRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            identity_mapping_store (:class:`google.cloud.discoveryengine_v1.types.IdentityMappingStore`):
        ...
        Returns:
            google.cloud.discoveryengine_v1.types.IdentityMappingStore:
    ...
    async def get_identity_mapping_store(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.GetIdentityMappingStoreRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_identity_mapping_store(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_identity_mapping_store():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1.DeleteIdentityMappingStoreRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.DeleteIdentityMappingStoreRequest, dict]]):
                The request object. Request message for
    ...
    async def import_identity_mappings(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.ImportIdentityMappingsRequest, dict]]):
                The request object. Request message for
    ...
    async def purge_identity_mappings(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.PurgeIdentityMappingsRequest, dict]]):
                The request object. Request message for
    ...
    async def list_identity_mappings(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.ListIdentityMappingsRequest, dict]]):
                The request object. Request message for
    ...
    async def list_identity_mapping_stores(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.ListIdentityMappingStoresRequest, dict]]):
                The request object. Request message for

...
class IdentityMappingStoreServiceTransport(abc.ABC):
    """Abstract transport class for IdentityMappingStoreService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_identity_mapping_store: gapic_v1.method.wrap_method(
                self.create_identity_mapping_store,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_identity_mapping_store: gapic_v1.method.wrap_method(
                self.get_identity_mapping_store,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_identity_mapping_store: gapic_v1.method.wrap_method(
                self.delete_identity_mapping_store,
                default_timeout=None,
                client_info=client_info,
            ),
            self.import_identity_mappings: gapic_v1.method.wrap_method(
                self.import_identity_mappings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.purge_identity_mappings: gapic_v1.method.wrap_method(
                self.purge_identity_mappings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_identity_mappings: gapic_v1.method.wrap_method(
                self.list_identity_mappings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_identity_mapping_stores: gapic_v1.method.wrap_method(

...
class AssistantServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return AssistantServiceClient.from_service_account_info.__func__(AssistantServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            AssistantServiceAsyncClient: The constructed client.
        """
        return AssistantServiceClient.from_service_account_file.__func__(AssistantServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def stream_assist(self,
        ...
        .. code-block:: python
            ...
            async def sample_stream_assist():
                # Create a client
                client = discoveryengine_v1.AssistantServiceAsyncClient()

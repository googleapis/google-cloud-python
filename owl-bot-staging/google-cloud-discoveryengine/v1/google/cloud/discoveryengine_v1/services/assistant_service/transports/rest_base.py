    ...
    class _BaseStreamAssist:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{name=projects/*/locations/*/collections/*/engines/*/assistants/*}:streamAssist',
                'body': '*',
            },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAssistantServiceRestTransport._BaseStreamAssist._get_unset_required_fields(query_params))
...
__all__=(
    '_BaseAssistantServiceRestTransport',
)

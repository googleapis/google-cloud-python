...
from .base import CompletionServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class CompletionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_complete_query(self, request: completion_service.CompleteQueryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[completion_service.CompleteQueryRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_complete_query(self, response: completion_service.CompleteQueryResponse) -> completion_service.CompleteQueryResponse:
        ...
        """
        return response
    def pre_import_completion_suggestions(self, request: import_config.ImportCompletionSuggestionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[import_config.ImportCompletionSuggestionsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_import_completion_suggestions(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_import_suggestion_deny_list_entries(self, request: import_config.ImportSuggestionDenyListEntriesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[import_config.ImportSuggestionDenyListEntriesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_import_suggestion_deny_list_entries(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_purge_completion_suggestions(self, request: purge_config.PurgeCompletionSuggestionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[purge_config.PurgeCompletionSuggestionsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_purge_completion_suggestions(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_purge_suggestion_deny_list_entries(self, request: purge_config.PurgeSuggestionDenyListEntriesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[purge_config.PurgeSuggestionDenyListEntriesRequest, Sequence[Tuple[str, str]]]:

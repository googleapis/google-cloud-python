...
class Conversation(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.discoveryengine_v1.types.Conversation.State):
            The state of the Conversation.
        user_pseudo_id (str):
            A unique identifier for tracking users.
        messages (MutableSequence[google.cloud.discoveryengine_v1.types.ConversationMessage]):
...
class TextInput(proto.Message):
    ...
    Attributes:
        input (str):
            Text input.
        context (google.cloud.discoveryengine_v1.types.ConversationContext):
...
class ConversationMessage(proto.Message):
    ...
    Attributes:
        user_input (google.cloud.discoveryengine_v1.types.TextInput):
            User text input.

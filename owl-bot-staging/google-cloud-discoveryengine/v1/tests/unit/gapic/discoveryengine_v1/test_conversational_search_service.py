...
def test_create_conversation_rest(request_type):
    ...
    request_init["conversation"] = {'name': 'name_value', 'state': 1, 'user_pseudo_id': 'user_pseudo_id_value', 'messages': [{'user_input': {'input': 'input_value', 'context': {'context_documents': ['context_documents_value1', 'context_documents_value2'], 'active_document': 'active_document_value'}}, 'reply': {'summary': {'summary_text': 'summary_text_value', 'summary_skipped_reasons': [1], 'safety_attributes': {'categories': ['categories_value1', 'categories_value2'], 'scores': [0.656, 0.657]}}}, 'create_time': {'seconds': 751, 'nanos': 543}}], 'start_time': {}, 'end_time': {}}

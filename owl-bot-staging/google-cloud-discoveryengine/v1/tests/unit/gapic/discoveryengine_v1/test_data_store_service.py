...
from google.cloud.discoveryengine_v1.services.data_store_service import DataStoreServiceAsyncClient
from google.cloud.discoveryengine_v1.services.data_store_service import DataStoreServiceClient
from google.cloud.discoveryengine_v1.services.data_store_service import pagers
from google.cloud.discoveryengine_v1.services.data_store_service import transports
...
def test_data_store_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1.services.data_store_service.transports.DataStoreServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_data_store_rest_required_fields(request_type=data_store_service.CreateDataStoreRequest):
    ...
    assert not set(unset_fields) - set(("cmek_config_name", "create_advanced_site_search", "data_store_id", "disable_cmek", "skip_default_schema_creation", ))
    jsonified_request.update(unset_fields)
...
def test_create_data_store_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("cmekConfigName", "createAdvancedSiteSearch", "dataStoreId", "disableCmek", "skipDefaultSchemaCreation", )) & set(("parent", "dataStore", "dataStoreId", )))
...
def test_create_data_store_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["data_store"] = {'name': 'name_value', 'display_name': 'display_name_value', 'industry_vertical': 1, 'solution_types': [1], 'default_schema_id': 'default_schema_id_value', 'content_config': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'advanced_site_search_config': {'disable_initial_index': True, 'disable_automatic_refresh': True}, 'kms_key_name': 'kms_key_name_value', 'cmek_config': {'name': 'name_value', 'kms_key': 'kms_key_value', 'kms_key_version': 'kms_key_version_value', 'state': 1, 'is_default': True, 'last_rotation_timestamp_micros': 3234, 'single_region_keys': [{'kms_key': 'kms_key_value'}], 'notebooklm_state': 1}, 'billing_estimation': {'structured_data_size': 2152, 'unstructured_data_size': 2379, 'website_data_size': 1798, 'structured_data_update_time': {}, 'unstructured_data_update_time': {}, 'website_data_update_time': {}}, 'acl_enabled': True, 'workspace_config': {'type_': 1, 'dasher_customer_id': 'dasher_customer_id_value', 'super_admin_service_account': 'super_admin_service_account_value', 'super_admin_email_address': 'super_admin_email_address_value'}, 'document_processing_config': {'name': 'name_value', 'chunking_config': {'layout_based_chunking_config': {'chunk_size': 1075, 'include_ancestor_headings': True}}, 'default_parsing_config': {'digital_parsing_config': {}, 'ocr_parsing_config': {'enhanced_document_elements': ['enhanced_document_elements_value1', 'enhanced_document_elements_value2'], 'use_native_text': True}, 'layout_parsing_config': {'enable_table_annotation': True, 'enable_image_annotation': True, 'structured_content_types': ['structured_content_types_value1', 'structured_content_types_value2'], 'exclude_html_elements': ['exclude_html_elements_value1', 'exclude_html_elements_value2'], 'exclude_html_classes': ['exclude_html_classes_value1', 'exclude_html_classes_value2'], 'exclude_html_ids': ['exclude_html_ids_value1', 'exclude_html_ids_value2']}}, 'parsing_config_overrides': {}}, 'starting_schema': {'struct_schema': {'fields': {}}, 'json_schema': 'json_schema_value', 'name': 'name_value'}, 'healthcare_fhir_config': {'enable_configurable_schema': True, 'enable_static_indexing_for_batch_ingestion': True}, 'identity_mapping_store': 'identity_mapping_store_value'}
...
def test_data_store_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1.services.data_store_service.transports.DataStoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_data_store_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1.services.data_store_service.transports.DataStoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataStoreServiceTransport()
        adc.assert_called_once()

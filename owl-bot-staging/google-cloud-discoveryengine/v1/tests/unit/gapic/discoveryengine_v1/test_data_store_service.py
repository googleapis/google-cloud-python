...
def test_create_data_store_rest(request_type):
    ...
    request_init["data_store"] = {'name': 'name_value', 'display_name': 'display_name_value', 'industry_vertical': 1, 'solution_types': [1], 'default_schema_id': 'default_schema_id_value', 'content_config': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'starting_schema': {'struct_schema': {'fields': {}}, 'json_schema': 'json_schema_value', 'name': 'name_value'}}
...
def test_update_data_store_rest(request_type):
    ...
    request_init["data_store"] = {'name': 'projects/sample1/locations/sample2/dataStores/sample3', 'display_name': 'display_name_value', 'industry_vertical': 1, 'solution_types': [1], 'default_schema_id': 'default_schema_id_value', 'content_config': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'starting_schema': {'struct_schema': {'fields': {}}, 'json_schema': 'json_schema_value', 'name': 'name_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

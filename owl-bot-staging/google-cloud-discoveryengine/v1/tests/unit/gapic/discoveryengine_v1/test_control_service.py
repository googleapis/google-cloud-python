...
def test_update_control_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'control': {'name': 'projects/sample1/locations/sample2/dataStores/sample3/controls/sample4'}}
    request_init["control"] = {'boost_action': {'fixed_boost': 0.1174, 'interpolation_boost_spec': {'field_name': 'field_name_value', 'attribute_type': 1, 'interpolation_type': 1, 'control_points': [{'attribute_value': 'attribute_value_value', 'boost_amount': 0.1306}]}, 'boost': 0.551, 'filter': 'filter_value', 'data_store': 'data_store_value'}, 'filter_action': {'filter': 'filter_value', 'data_store': 'data_store_value'}, 'redirect_action': {'redirect_uri': 'redirect_uri_value'}, 'synonyms_action': {'synonyms': ['synonyms_value1', 'synonyms_value2']}, 'promote_action': {'data_store': 'data_store_value', 'search_link_promotion': {'title': 'title_value', 'uri': 'uri_value', 'image_uri': 'image_uri_value', 'description': 'description_value', 'enabled': True}}, 'name': 'projects/sample1/locations/sample2/dataStores/sample3/controls/sample4', 'display_name': 'display_name_value', 'associated_serving_config_ids': ['associated_serving_config_ids_value1', 'associated_serving_config_ids_value2'], 'solution_type': 1, 'use_cases': [1], 'conditions': [{'query_terms': [{'value': 'value_value', 'full_match': True}], 'active_time_range': [{'start_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}}], 'query_regex': 'query_regex_value'}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

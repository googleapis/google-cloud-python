...
from google.cloud.discoveryengine_v1.services.site_search_engine_service import SiteSearchEngineServiceAsyncClient
from google.cloud.discoveryengine_v1.services.site_search_engine_service import SiteSearchEngineServiceClient
from google.cloud.discoveryengine_v1.services.site_search_engine_service import pagers
from google.cloud.discoveryengine_v1.services.site_search_engine_service import transports
...
def test_site_search_engine_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1.services.site_search_engine_service.transports.SiteSearchEngineServiceGrpcTransport.__init__') as grpc_transport:
...
async def test_get_site_search_engine_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.get_site_search_engine] = mock_object
...
async def test_create_target_site_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_target_site] = mock_object
...
async def test_batch_create_target_sites_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.batch_create_target_sites] = mock_object
...
async def test_get_target_site_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_target_site] = mock_object
...
async def test_update_target_site_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_target_site] = mock_object
...
async def test_delete_target_site_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_target_site] = mock_object
...
async def test_list_target_sites_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_target_sites] = mock_object
...
async def test_enable_advanced_site_search_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.enable_advanced_site_search] = mock_object
...
async def test_disable_advanced_site_search_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.disable_advanced_site_search] = mock_object
...
async def test_recrawl_uris_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.recrawl_uris] = mock_object
...
async def test_batch_verify_target_sites_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.batch_verify_target_sites] = mock_object
...
async def test_fetch_domain_verification_status_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_domain_verification_status] = mock_object
...
def test_get_site_search_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = site_search_engine.SiteSearchEngine.to_json(site_search_engine.SiteSearchEngine())
...
def test_get_site_search_engine_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.GetSiteSearchEngineRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_site_search_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/dataStores/*/siteSearchEngine}" % client.transport._host, args[1])
...
def test_create_target_site_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.CreateTargetSiteRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/targetSites" % client.transport._host, args[1])
...
def test_batch_create_target_sites_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.BatchCreateTargetSitesRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_target_site_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = site_search_engine.TargetSite.to_json(site_search_engine.TargetSite())
...
def test_get_target_site_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.GetTargetSiteRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}" % client.transport._host, args[1])
...
def test_update_target_site_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.UpdateTargetSiteRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{target_site.name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}" % client.transport._host, args[1])
...
def test_delete_target_site_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.DeleteTargetSiteRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_target_sites_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = site_search_engine_service.ListTargetSitesResponse.to_json(site_search_engine_service.ListTargetSitesResponse())
...
def test_list_target_sites_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.ListTargetSitesRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_enable_advanced_site_search_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.EnableAdvancedSiteSearchRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_disable_advanced_site_search_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.DisableAdvancedSiteSearchRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_verify_target_sites_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.BatchVerifyTargetSitesRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_domain_verification_status_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = site_search_engine_service.FetchDomainVerificationStatusResponse.to_json(site_search_engine_service.FetchDomainVerificationStatusResponse())
...
def test_fetch_domain_verification_status_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.FetchDomainVerificationStatusRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_site_search_engine_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1.services.site_search_engine_service.transports.SiteSearchEngineServiceTransport.__init__') as Transport:
...
def test_site_search_engine_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1.services.site_search_engine_service.transports.SiteSearchEngineServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_site_search_engine_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1.services.site_search_engine_service.transports.SiteSearchEngineServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SiteSearchEngineServiceTransport()
        adc.assert_called_once()

...
from google.cloud.discoveryengine_v1.services.completion_service import CompletionServiceAsyncClient
...
def test_completion_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1.services.completion_service.transports.CompletionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_import_suggestion_deny_list_entries(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_suggestion_deny_list_entries),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_import_suggestion_deny_list_entries_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.import_suggestion_deny_list_entries] = mock_object
...
@pytest.mark.asyncio
async def test_import_suggestion_deny_list_entries_async(transport: str = 'grpc_asyncio', request_type=import_config.ImportSuggestionDenyListEntriesRequest):
    client = CompletionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_import_suggestion_deny_list_entries_field_headers_async():
    client = CompletionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_purge_suggestion_deny_list_entries(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.purge_suggestion_deny_list_entries),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_purge_suggestion_deny_list_entries_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.purge_suggestion_deny_list_entries] = mock_object
...
@pytest.mark.asyncio
async def test_purge_suggestion_deny_list_entries_async(transport: str = 'grpc_asyncio', request_type=purge_config.PurgeSuggestionDenyListEntriesRequest):
    client = CompletionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_purge_suggestion_deny_list_entries_field_headers_async():
    client = CompletionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_import_completion_suggestions(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_completion_suggestions),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_import_completion_suggestions_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_import_completion_suggestions_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_import_completion_suggestions_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CompletionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.import_completion_suggestions()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == import_config.ImportCompletionSuggestionsRequest()
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.import_completion_suggestions] = mock_object
...
@pytest.mark.asyncio
async def test_import_completion_suggestions_field_headers_async():
    client = CompletionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_purge_completion_suggestions(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.purge_completion_suggestions),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_purge_completion_suggestions_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_purge_completion_suggestions_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_purge_completion_suggestions_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CompletionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.purge_completion_suggestions()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == purge_config.PurgeCompletionSuggestionsRequest()
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.purge_completion_suggestions] = mock_object
...
@pytest.mark.asyncio
async def test_purge_completion_suggestions_field_headers_async():
    client = CompletionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_complete_query_rest_required_fields(request_type=completion_service.CompleteQueryRequest):
    ...
    assert not set(unset_fields) - set(("include_tail_suggestions", "query", "query_model", "user_pseudo_id", ))
    jsonified_request.update(unset_fields)
...
def test_complete_query_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("includeTailSuggestions", "query", "queryModel", "userPseudoId", )) & set(("dataStore", "query", )))
...
def test_import_suggestion_deny_list_entries_rest(request_type):
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_import_suggestion_deny_list_entries_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CompletionServiceClient(
...
def test_import_suggestion_deny_list_entries_rest_required_fields(request_type=import_config.ImportSuggestionDenyListEntriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_suggestion_deny_list_entries._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_suggestion_deny_list_entries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.CompletionServiceRestInterceptor, "post_import_suggestion_deny_list_entries") as post, \
         mock.patch.object(transports.CompletionServiceRestInterceptor, "pre_import_suggestion_deny_list_entries") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.import_suggestion_deny_list_entries(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_import_suggestion_deny_list_entries_rest_bad_request(transport: str = 'rest', request_type=import_config.ImportSuggestionDenyListEntriesRequest):
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_suggestion_deny_list_entries_rest_error():
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_purge_suggestion_deny_list_entries_rest(request_type):
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_purge_suggestion_deny_list_entries_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CompletionServiceClient(
...
def test_purge_suggestion_deny_list_entries_rest_required_fields(request_type=purge_config.PurgeSuggestionDenyListEntriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).purge_suggestion_deny_list_entries._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_purge_suggestion_deny_list_entries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CompletionServiceRestInterceptor, "post_purge_suggestion_deny_list_entries") as post, \
         mock.patch.object(transports.CompletionServiceRestInterceptor, "pre_purge_suggestion_deny_list_entries") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.purge_suggestion_deny_list_entries(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_purge_suggestion_deny_list_entries_rest_bad_request(transport: str = 'rest', request_type=purge_config.PurgeSuggestionDenyListEntriesRequest):
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_suggestion_deny_list_entries_rest_error():
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_import_completion_suggestions_rest(request_type):
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_import_completion_suggestions_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CompletionServiceClient(
...
def test_import_completion_suggestions_rest_required_fields(request_type=import_config.ImportCompletionSuggestionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_completion_suggestions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_completion_suggestions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CompletionServiceRestInterceptor, "post_import_completion_suggestions") as post, \
         mock.patch.object(transports.CompletionServiceRestInterceptor, "pre_import_completion_suggestions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.import_completion_suggestions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_import_completion_suggestions_rest_bad_request(transport: str = 'rest', request_type=import_config.ImportCompletionSuggestionsRequest):
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_completion_suggestions_rest(request_type):
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_purge_completion_suggestions_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CompletionServiceClient(
...
def test_purge_completion_suggestions_rest_required_fields(request_type=purge_config.PurgeCompletionSuggestionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).purge_completion_suggestions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_purge_completion_suggestions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CompletionServiceRestInterceptor, "post_purge_completion_suggestions") as post, \
         mock.patch.object(transports.CompletionServiceRestInterceptor, "pre_purge_completion_suggestions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.purge_completion_suggestions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_purge_completion_suggestions_rest_bad_request(transport: str = 'rest', request_type=purge_config.PurgeCompletionSuggestionsRequest):
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_completion_suggestions_rest_error():
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_completion_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1.services.completion_service.transports.CompletionServiceTransport.__init__') as Transport:
...
def test_completion_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_completion_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CompletionServiceTransport()
        adc.assert_called_once()
...
def test_completion_service_client_transport_session_collision(transport_name):
    ...
    session1 = client1.transport.import_suggestion_deny_list_entries._session
    session2 = client2.transport.import_suggestion_deny_list_entries._session
    assert session1 != session2
    session1 = client1.transport.purge_suggestion_deny_list_entries._session
    session2 = client2.transport.purge_suggestion_deny_list_entries._session
    assert session1 != session2
    session1 = client1.transport.import_completion_suggestions._session
    session2 = client2.transport.import_completion_suggestions._session
    assert session1 != session2
    session1 = client1.transport.purge_completion_suggestions._session
    session2 = client2.transport.purge_completion_suggestions._session
    assert session1 != session2
...
def test_data_store_path():
    ...
    actual = CompletionServiceClient.data_store_path(project, location, data_store)
...
def test_parse_data_store_path():
    ...
    path = CompletionServiceClient.data_store_path(**expected)

    # Check that the path construction is reversible.
    actual = CompletionServiceClient.parse_data_store_path(path)
    assert expected == actual

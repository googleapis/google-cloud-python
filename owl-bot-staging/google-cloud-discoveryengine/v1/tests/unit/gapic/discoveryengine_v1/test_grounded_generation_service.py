...
from google.cloud.discoveryengine_v1.services.grounded_generation_service import GroundedGenerationServiceAsyncClient
from google.cloud.discoveryengine_v1.services.grounded_generation_service import GroundedGenerationServiceClient
from google.cloud.discoveryengine_v1.services.grounded_generation_service import transports
...
def test_grounded_generation_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1.services.grounded_generation_service.transports.GroundedGenerationServiceGrpcTransport.__init__') as grpc_transport:
...
def test_stream_generate_grounded_content(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.stream_generate_grounded_content),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_stream_generate_grounded_content_async(transport: str = 'grpc_asyncio', request_type=grounded_generation_service.GenerateGroundedContentRequest):
    client = GroundedGenerationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_generate_grounded_content(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_grounded_content),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_generate_grounded_content_async(transport: str = 'grpc_asyncio', request_type=grounded_generation_service.GenerateGroundedContentRequest):
    client = GroundedGenerationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_generate_grounded_content_rest_required_fields(request_type=grounded_generation_service.GenerateGroundedContentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_grounded_content._get_unset_required_fields(jsonified_request)
...
def test_generate_grounded_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.GroundedGenerationServiceRestInterceptor, "post_generate_grounded_content") as post, \
         mock.patch.object(transports.GroundedGenerationServiceRestInterceptor, "pre_generate_grounded_content") as pre:
        ...
        req.return_value._content = grounded_generation_service.GenerateGroundedContentResponse.to_json(grounded_generation_service.GenerateGroundedContentResponse())
        ...
        client.generate_grounded_content(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_generate_grounded_content_rest_bad_request(transport: str = 'rest', request_type=grounded_generation_service.GenerateGroundedContentRequest):
    client = GroundedGenerationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_check_grounding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = grounded_generation_service.CheckGroundingResponse.to_json(grounded_generation_service.CheckGroundingResponse())
...
def test_check_grounding_rest_bad_request(transport: str = 'rest', request_type=grounded_generation_service.CheckGroundingRequest):
    client = GroundedGenerationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_grounded_generation_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1.services.grounded_generation_service.transports.GroundedGenerationServiceTransport.__init__') as Transport:
...
def test_grounded_generation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1.services.grounded_generation_service.transports.GroundedGenerationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_grounded_generation_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1.services.grounded_generation_service.transports.GroundedGenerationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GroundedGenerationServiceTransport()
        adc.assert_called_once()

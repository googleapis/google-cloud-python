...
def test_generate_grounded_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GroundedGenerationServiceRestInterceptor, "post_generate_grounded_content_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = grounded_generation_service.GenerateGroundedContentResponse.to_json(grounded_generation_service.GenerateGroundedContentResponse())

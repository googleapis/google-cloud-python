...
from google.cloud.discoveryengine_v1.services.engine_service import EngineServiceAsyncClient
...
def test_update_engine_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'engine': {'name': 'projects/sample1/locations/sample2/collections/sample3/engines/sample4'}}
    request_init["engine"] = {'chat_engine_config': {'agent_creation_config': {'business': 'business_value', 'default_language_code': 'default_language_code_value', 'time_zone': 'time_zone_value', 'location': 'location_value'}, 'dialogflow_agent_to_link': 'dialogflow_agent_to_link_value', 'allow_cross_region': True}, 'search_engine_config': {'search_tier': 1, 'search_add_ons': [1]}, 'media_recommendation_engine_config': {'type_': 'type__value', 'optimization_objective': 'optimization_objective_value', 'optimization_objective_config': {'target_field': 'target_field_value', 'target_field_value_float': 0.2523}, 'training_state': 1, 'engine_features_config': {'recommended_for_you_config': {'context_event_type': 'context_event_type_value'}, 'most_popular_config': {'time_window_days': 1718}}}, 'chat_engine_metadata': {'dialogflow_agent': 'dialogflow_agent_value'}, 'name': 'projects/sample1/locations/sample2/collections/sample3/engines/sample4', 'display_name': 'display_name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'data_store_ids': ['data_store_ids_value1', 'data_store_ids_value2'], 'solution_type': 1, 'industry_vertical': 1, 'common_config': {'company_name': 'company_name_value'}, 'disable_analytics': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_engine_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1.services.engine_service.transports.EngineServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_engine_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1.services.engine_service.transports.EngineServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EngineServiceTransport()
        adc.assert_called_once()

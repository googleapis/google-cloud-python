...
from google.cloud.discoveryengine_v1.services.recommendation_service import RecommendationServiceAsyncClient
from google.cloud.discoveryengine_v1.services.recommendation_service import RecommendationServiceClient
from google.cloud.discoveryengine_v1.services.recommendation_service import transports
...
def test_recommendation_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1.services.recommendation_service.transports.RecommendationServiceGrpcTransport.__init__') as grpc_transport:
...
def test_recommendation_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1.services.recommendation_service.transports.RecommendationServiceTransport.__init__') as Transport:
...
def test_recommendation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1.services.recommendation_service.transports.RecommendationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_recommendation_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1.services.recommendation_service.transports.RecommendationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RecommendationServiceTransport()
        adc.assert_called_once()

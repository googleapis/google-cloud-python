...
class discoveryengineCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'estimate_data_size': ('location', 'website_data_source', 'file_data_source', ),
        ...
        'get_data_store': ('name', ),
        'get_document': ('name', ),
        'get_document_processing_config': ('name', ),
        'get_engine': ('name', ),
        'get_processed_document': ('name', 'processed_document_type', 'processed_document_format', ),
        'get_project': ('name', ),
        'get_schema': ('name', ),
        ...
        'purge_documents': ('parent', 'filter', 'gcs_source', 'error_config', 'force', ),
        ...
        'resume_engine': ('name', ),
        'search': ('serving_config', 'branch', 'query', 'image_query', 'page_size', 'page_token', 'offset', 'data_store_specs', 'filter', 'canonical_filter', 'order_by', 'user_info', 'facet_specs', 'boost_spec', 'params', 'query_expansion_spec', 'spell_correction_spec', 'user_pseudo_id', 'content_search_spec', 'embedding_spec', 'ranking_expression', 'safe_search', 'user_labels', 'custom_fine_tuning_spec', ),
        'train_custom_model': ('data_store', 'gcs_training_input', 'model_type', 'error_config', ),
        'tune_engine': ('name', ),
        'update_acl_config': ('acl_config', ),
        ...
        'update_document_processing_config': ('document_processing_config', 'update_mask', ),

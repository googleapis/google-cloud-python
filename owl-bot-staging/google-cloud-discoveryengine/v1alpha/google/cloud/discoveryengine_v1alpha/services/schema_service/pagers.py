...
class ListSchemasPager:
    ...
    :class:`google.cloud.discoveryengine_v1alpha.types.ListSchemasResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1alpha.types.ListSchemasResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1alpha.types.ListSchemasRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1alpha.types.ListSchemasResponse):

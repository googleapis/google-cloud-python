...
class _BaseEvaluationServiceRestTransport(EvaluationServiceTransport):
    """Base REST backend transport for EvaluationService.
    ...
    class _BaseCreateEvaluation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha/{parent=projects/*/locations/*}/evaluations',
                'body': 'evaluation',
            },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = evaluation_service.CreateEvaluationRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseEvaluationServiceRestTransport._BaseCreateEvaluation._get_unset_required_fields(query_params))
    ...
    class _BaseGetEvaluation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha/{name=projects/*/locations/*/evaluations/*}',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = evaluation_service.GetEvaluationRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseEvaluationServiceRestTransport._BaseGetEvaluation._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseListEvaluationResults:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha/{evaluation=projects/*/locations/*/evaluations/*}:listResults',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = evaluation_service.ListEvaluationResultsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseEvaluationServiceRestTransport._BaseListEvaluationResults._get_unset_required_fields(query_params))
    ...
    class _BaseListEvaluations:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = evaluation_service.ListEvaluationsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseEvaluationServiceRestTransport._BaseListEvaluations._get_unset_required_fields(query_params))

...
class DataStoreServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_data_store(self, response: data_store.DataStore) -> data_store.DataStore:
        ...
        """
        return response
    def pre_get_document_processing_config(self, request: data_store_service.GetDocumentProcessingConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[data_store_service.GetDocumentProcessingConfigRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_data_store(self, response: gcd_data_store.DataStore) -> gcd_data_store.DataStore:
        ...
        """
        return response
    def pre_update_document_processing_config(self, request: data_store_service.UpdateDocumentProcessingConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[data_store_service.UpdateDocumentProcessingConfigRequest, Sequence[Tuple[str, str]]]:

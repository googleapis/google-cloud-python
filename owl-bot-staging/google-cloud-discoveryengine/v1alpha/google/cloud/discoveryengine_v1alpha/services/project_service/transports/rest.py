...
class ProjectServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_report_consent_change(self, request: project_service.ReportConsentChangeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[project_service.ReportConsentChangeRequest, Sequence[Tuple[str, str]]]:

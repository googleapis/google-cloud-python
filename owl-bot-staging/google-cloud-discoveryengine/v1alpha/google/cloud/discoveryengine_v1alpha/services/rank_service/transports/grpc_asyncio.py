...
from .base import RankServiceTransport, DEFAULT_CLIENT_INFO
...
class RankServiceGrpcAsyncIOTransport(RankServiceTransport):
    ...
    def rank(self) -> Callable[
            ...
            Awaitable[rank_service.RankResponse]]:
        ...
        if 'rank' not in self._stubs:
            self._stubs['rank'] = self._logged_channel.unary_unary(
...
__all__ = (
    'RankServiceGrpcAsyncIOTransport',
)

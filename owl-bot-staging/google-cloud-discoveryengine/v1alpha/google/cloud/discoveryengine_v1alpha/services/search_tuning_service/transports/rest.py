...
from .base import SearchTuningServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class SearchTuningServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_list_custom_models(self, request: search_tuning_service.ListCustomModelsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[search_tuning_service.ListCustomModelsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_custom_models(self, response: search_tuning_service.ListCustomModelsResponse) -> search_tuning_service.ListCustomModelsResponse:
        ...
        """
        return response
    def pre_train_custom_model(self, request: search_tuning_service.TrainCustomModelRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[search_tuning_service.TrainCustomModelRequest, Sequence[Tuple[str, str]]]:
    ...
    class _ListCustomModels(SearchTuningServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha/{data_store=projects/*/locations/*/collections/*/dataStores/*}/customModels',
            },
            ]

...
class ControlServiceAsyncClient:
    ...
    async def create_control(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.CreateControlRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            control (:class:`google.cloud.discoveryengine_v1alpha.types.Control`):
    ...
    async def delete_control(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.DeleteControlRequest, dict]]):
    ...
    async def update_control(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.UpdateControlRequest, dict]]):
    ...
    async def get_control(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.GetControlRequest, dict]]):
    ...
    async def list_controls(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ListControlsRequest, dict]]):

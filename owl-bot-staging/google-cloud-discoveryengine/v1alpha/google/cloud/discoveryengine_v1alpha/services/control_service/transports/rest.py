...
from .base import ControlServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
    ...
    class _CreateControl(ControlServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha/{parent=projects/*/locations/*/dataStores/*}/controls',
                'body': 'control',
            },
{
                'method': 'post',
                'uri': '/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*}/controls',
                'body': 'control',
            },
{
                'method': 'post',
                'uri': '/v1alpha/{parent=projects/*/locations/*/collections/*/engines/*}/controls',
                'body': 'control',
            },
            ]
    ...
    class _DeleteControl(ControlServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1alpha/{name=projects/*/locations/*/dataStores/*/controls/*}',
            },
{
                'method': 'delete',
                'uri': '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/controls/*}',
            },
{
                'method': 'delete',
                'uri': '/v1alpha/{name=projects/*/locations/*/collections/*/engines/*/controls/*}',
            },
            ]
            ...
            },
{
    ...
    class _UpdateControl(ControlServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1alpha/{control.name=projects/*/locations/*/dataStores/*/controls/*}',
                'body': 'control',
            },
{
                'method': 'patch',
                'uri': '/v1alpha/{control.name=projects/*/locations/*/collections/*/dataStores/*/controls/*}',
                'body': 'control',
            },
{
                'method': 'patch',
                'uri': '/v1alpha/{control.name=projects/*/locations/*/collections/*/engines/*/controls/*}',
                'body': 'control',
            },
            ]

...
class ControlServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_control(self, request: control_service.CreateControlRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[control_service.CreateControlRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_control(self, request: control_service.DeleteControlRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[control_service.DeleteControlRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_control(self, request: control_service.GetControlRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[control_service.GetControlRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_controls(self, request: control_service.ListControlsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[control_service.ListControlsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_control(self, request: control_service.UpdateControlRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[control_service.UpdateControlRequest, Sequence[Tuple[str, str]]]:

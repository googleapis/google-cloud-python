...
class SampleQuerySetServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_sample_query_set(self, request: sample_query_set_service.CreateSampleQuerySetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[sample_query_set_service.CreateSampleQuerySetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_sample_query_set_with_metadata(self, response: gcd_sample_query_set.SampleQuerySet, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_sample_query_set.SampleQuerySet, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_sample_query_set
    ...
    def pre_delete_sample_query_set(self, request: sample_query_set_service.DeleteSampleQuerySetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[sample_query_set_service.DeleteSampleQuerySetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_sample_query_set(self, request: sample_query_set_service.GetSampleQuerySetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[sample_query_set_service.GetSampleQuerySetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_sample_query_set_with_metadata(self, response: sample_query_set.SampleQuerySet, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[sample_query_set.SampleQuerySet, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_sample_query_set
    ...
    def pre_list_sample_query_sets(self, request: sample_query_set_service.ListSampleQuerySetsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[sample_query_set_service.ListSampleQuerySetsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_sample_query_sets(self, response: sample_query_set_service.ListSampleQuerySetsResponse) -> sample_query_set_service.ListSampleQuerySetsResponse:
    ...
    def post_list_sample_query_sets_with_metadata(self, response: sample_query_set_service.ListSampleQuerySetsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[sample_query_set_service.ListSampleQuerySetsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_sample_query_sets
    ...
    def pre_update_sample_query_set(self, request: sample_query_set_service.UpdateSampleQuerySetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[sample_query_set_service.UpdateSampleQuerySetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_sample_query_set_with_metadata(self, response: gcd_sample_query_set.SampleQuerySet, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_sample_query_set.SampleQuerySet, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_sample_query_set
...
class SampleQuerySetServiceRestTransport(_BaseSampleQuerySetServiceRestTransport):
    ...
    class _CreateSampleQuerySet(_BaseSampleQuerySetServiceRestTransport._BaseCreateSampleQuerySet, SampleQuerySetServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.CreateSampleQuerySet",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
                        "rpcName": "CreateSampleQuerySet",
            ...
            # Send the request
            response = SampleQuerySetServiceRestTransport._CreateSampleQuerySet._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.create_sample_query_set",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
                        "rpcName": "CreateSampleQuerySet",
    ...
    class _DeleteSampleQuerySet(_BaseSampleQuerySetServiceRestTransport._BaseDeleteSampleQuerySet, SampleQuerySetServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.DeleteSampleQuerySet",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
                        "rpcName": "DeleteSampleQuerySet",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = SampleQuerySetServiceRestTransport._DeleteSampleQuerySet._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetSampleQuerySet(_BaseSampleQuerySetServiceRestTransport._BaseGetSampleQuerySet, SampleQuerySetServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.GetSampleQuerySet",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
                        "rpcName": "GetSampleQuerySet",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = SampleQuerySetServiceRestTransport._GetSampleQuerySet._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.get_sample_query_set",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
                        "rpcName": "GetSampleQuerySet",
                        "metadata": http_response["headers"],
    ...
    class _ListSampleQuerySets(_BaseSampleQuerySetServiceRestTransport._BaseListSampleQuerySets, SampleQuerySetServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.ListSampleQuerySets",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
                        "rpcName": "ListSampleQuerySets",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = SampleQuerySetServiceRestTransport._ListSampleQuerySets._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.list_sample_query_sets",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
                        "rpcName": "ListSampleQuerySets",
                        "metadata": http_response["headers"],
    ...
    class _UpdateSampleQuerySet(_BaseSampleQuerySetServiceRestTransport._BaseUpdateSampleQuerySet, SampleQuerySetServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.UpdateSampleQuerySet",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
                        "rpcName": "UpdateSampleQuerySet",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = SampleQuerySetServiceRestTransport._UpdateSampleQuerySet._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.update_sample_query_set",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
                        "rpcName": "UpdateSampleQuerySet",
                        "metadata": http_response["headers"],
    ...
    @property
    def create_sample_query_set(self) -> Callable[
    ...
    @property
    def delete_sample_query_set(self) -> Callable[
    ...
    @property
    def get_sample_query_set(self) -> Callable[
    ...
    @property
    def list_sample_query_sets(self) -> Callable[
    ...
    @property
    def update_sample_query_set(self) -> Callable[
    ...
    class _CancelOperation(_BaseSampleQuerySetServiceRestTransport._BaseCancelOperation, SampleQuerySetServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
            ...
            # Send the request
            response = SampleQuerySetServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseSampleQuerySetServiceRestTransport._BaseGetOperation, SampleQuerySetServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
            ...
            # Send the request
            response = SampleQuerySetServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseSampleQuerySetServiceRestTransport._BaseListOperations, SampleQuerySetServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
            ...
            # Send the request
            response = SampleQuerySetServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SampleQuerySetService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

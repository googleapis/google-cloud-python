...
from .base import SampleQuerySetServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class SampleQuerySetServiceRestTransport(SampleQuerySetServiceTransport):
    ...
    class _CreateSampleQuerySet(SampleQuerySetServiceRestStub):
        ...
        def __call__(self,
            ...
            pb_request = sample_query_set_service.CreateSampleQuerySetRequest.pb(request)
    ...
    class _DeleteSampleQuerySet(SampleQuerySetServiceRestStub):
        ...
        def __call__(self,
            ...
            pb_request = sample_query_set_service.DeleteSampleQuerySetRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _UpdateSampleQuerySet(SampleQuerySetServiceRestStub):
        ...
        def __call__(self,
            ...
            pb_request = sample_query_set_service.UpdateSampleQuerySetRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)

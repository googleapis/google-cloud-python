...
class SampleQuerySetServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_sample_query_set(self, request: sample_query_set_service.CreateSampleQuerySetRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sample_query_set_service.CreateSampleQuerySetRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_sample_query_set(self, request: sample_query_set_service.DeleteSampleQuerySetRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sample_query_set_service.DeleteSampleQuerySetRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_sample_query_set(self, request: sample_query_set_service.GetSampleQuerySetRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sample_query_set_service.GetSampleQuerySetRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_sample_query_sets(self, request: sample_query_set_service.ListSampleQuerySetsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sample_query_set_service.ListSampleQuerySetsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_sample_query_set(self, request: sample_query_set_service.UpdateSampleQuerySetRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sample_query_set_service.UpdateSampleQuerySetRequest, Sequence[Tuple[str, str]]]:

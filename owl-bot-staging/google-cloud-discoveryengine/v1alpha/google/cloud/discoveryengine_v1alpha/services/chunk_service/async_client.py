...
class ChunkServiceAsyncClient:
    ...
    DEFAULT_ENDPOINT = ChunkServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = ChunkServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = ChunkServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = ChunkServiceClient._DEFAULT_UNIVERSE

    chunk_path = staticmethod(ChunkServiceClient.chunk_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ChunkServiceAsyncClient: The constructed client.
        """
        return ChunkServiceClient.from_service_account_info.__func__(ChunkServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            ChunkServiceAsyncClient: The constructed client.
        """
        return ChunkServiceClient.from_service_account_file.__func__(ChunkServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return ChunkServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> ChunkServiceTransport:
        ...
        Returns:
            ChunkServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = functools.partial(type(ChunkServiceClient).get_transport_class, type(ChunkServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Union[str, ChunkServiceTransport] = "grpc_asyncio",
        ...
        """
        self._client = ChunkServiceClient(
    ...
    async def get_chunk(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.GetChunkRequest, dict]]):
    ...
    async def list_chunks(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ListChunksRequest, dict]]):
                The request object. Request message for

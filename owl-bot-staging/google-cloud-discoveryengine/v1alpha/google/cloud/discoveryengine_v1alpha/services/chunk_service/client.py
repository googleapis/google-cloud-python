...
class ChunkServiceClient(metaclass=ChunkServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ChunkServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Union[str, ChunkServiceTransport]): The
    ...
    def get_chunk(self,
        ...
        # in a chunk_service.GetChunkRequest.
    ...
    def list_chunks(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a chunk_service.ListChunksRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

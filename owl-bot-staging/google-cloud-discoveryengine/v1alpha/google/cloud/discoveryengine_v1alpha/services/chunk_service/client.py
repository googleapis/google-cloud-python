...
from .transports.grpc import ChunkServiceGrpcTransport
from .transports.grpc_asyncio import ChunkServiceGrpcAsyncIOTransport
from .transports.rest import ChunkServiceRestTransport


class ChunkServiceClientMeta(type):
    """Metaclass for the ChunkService client.
...
class ChunkServiceClient(metaclass=ChunkServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ChunkServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> ChunkServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            ChunkServiceTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = ChunkServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = ChunkServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ChunkServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ChunkServiceClient._DEFAULT_UNIVERSE
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = ChunkServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ChunkServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ChunkServiceTransport, Callable[..., ChunkServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the chunk service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,ChunkServiceTransport,Callable[..., ChunkServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the ChunkServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ChunkServiceClient._read_environment_variables()
        self._client_cert_source = ChunkServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ChunkServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ChunkServiceTransport)
        if transport_provided:
            # transport is a ChunkServiceTransport instance.
            ...
            self._transport = cast(ChunkServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            ChunkServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ChunkServiceTransport], Callable[..., ChunkServiceTransport]] = (
    ...
    def get_chunk(self,
        ...
        .. code-block:: python
            ...
            def sample_get_chunk():
                ...
                request = discoveryengine_v1alpha.GetChunkRequest(
                    name="name_value",
                )
        ...
        if not isinstance(request, chunk_service.GetChunkRequest):
            request = chunk_service.GetChunkRequest(request)
    ...
    def list_chunks(self,
        ...
        .. code-block:: python
            ...
            def sample_list_chunks():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.ListChunksRequest(
                    parent="parent_value",
                )
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, chunk_service.ListChunksRequest):
            request = chunk_service.ListChunksRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
    ...
    def __enter__(self) -> "ChunkServiceClient":
        return self

...
from .base import ChunkServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ChunkServiceRestTransport(ChunkServiceTransport):
    """REST backend transport for ChunkService.
    ...
    class _GetChunk(ChunkServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha/{name=projects/*/locations/*/dataStores/*/branches/*/documents/*/chunks/*}',
            },
{
                'method': 'get',
                'uri': '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/branches/*/documents/*/chunks/*}',
            },
            ]
            request, metadata = self._interceptor.pre_get_chunk(request, metadata)
            pb_request = chunk_service.GetChunkRequest.pb(request)
    ...
    class _ListChunks(ChunkServiceRestStub):
        def __hash__(self):
            ...
            },
{
            ...
            pb_request = chunk_service.ListChunksRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _CancelOperation(ChunkServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _GetOperation(ChunkServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _ListOperations(ChunkServiceRestStub):
        def __call__(self,

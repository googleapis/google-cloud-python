...
class ChunkServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_chunk(self, request: chunk_service.GetChunkRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[chunk_service.GetChunkRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_chunks(self, request: chunk_service.ListChunksRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[chunk_service.ListChunksRequest, Sequence[Tuple[str, str]]]:

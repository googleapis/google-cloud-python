...
class ChunkServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_chunk(self, request: chunk_service.GetChunkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[chunk_service.GetChunkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_chunk_with_metadata(self, response: chunk.Chunk, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[chunk.Chunk, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_chunk
    ...
    def pre_list_chunks(self, request: chunk_service.ListChunksRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[chunk_service.ListChunksRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_chunks_with_metadata(self, response: chunk_service.ListChunksResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[chunk_service.ListChunksResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_chunks
...
class ChunkServiceRestTransport(_BaseChunkServiceRestTransport):
    ...
    class _GetChunk(_BaseChunkServiceRestTransport._BaseGetChunk, ChunkServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ChunkServiceRestTransport._GetChunk._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListChunks(_BaseChunkServiceRestTransport._BaseListChunks, ChunkServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ChunkServiceRestTransport._ListChunks._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BaseChunkServiceRestTransport._BaseCancelOperation, ChunkServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ChunkServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseChunkServiceRestTransport._BaseGetOperation, ChunkServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ChunkServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseChunkServiceRestTransport._BaseListOperations, ChunkServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ChunkServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

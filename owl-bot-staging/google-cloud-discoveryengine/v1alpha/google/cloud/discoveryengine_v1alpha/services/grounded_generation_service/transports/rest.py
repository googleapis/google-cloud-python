...
from .base import GroundedGenerationServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class GroundedGenerationServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_check_grounding(self, request: grounded_generation_service.CheckGroundingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[grounded_generation_service.CheckGroundingRequest, Sequence[Tuple[str, str]]]:
...
class GroundedGenerationServiceRestTransport(GroundedGenerationServiceTransport):
    ...
    class _CheckGrounding(GroundedGenerationServiceRestStub):
        def __hash__(self):
            return hash("CheckGrounding")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha/{grounding_config=projects/*/locations/*/groundingConfigs/*}:check',
                'body': '*',
            },
            ]
            request, metadata = self._interceptor.pre_check_grounding(request, metadata)
            pb_request = grounded_generation_service.CheckGroundingRequest.pb(request)
    ...
    class _CancelOperation(GroundedGenerationServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _GetOperation(GroundedGenerationServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _ListOperations(GroundedGenerationServiceRestStub):
        def __call__(self,

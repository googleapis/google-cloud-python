...
class ListDocumentsPager:
    ...
    :class:`google.cloud.discoveryengine_v1alpha.types.ListDocumentsResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1alpha.types.ListDocumentsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1alpha.types.ListDocumentsRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1alpha.types.ListDocumentsResponse):

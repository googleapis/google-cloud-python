...
initial=1.0,maximum=30.0,multiplier=1.3,                    predicate=retries.if_exception_type(
    ...
    @property
    def get_processed_document(self) -> Callable[
            [document_service.GetProcessedDocumentRequest],
            Union[
                document.ProcessedDocument,
                Awaitable[document.ProcessedDocument]
            ]]:
        raise NotImplementedError()

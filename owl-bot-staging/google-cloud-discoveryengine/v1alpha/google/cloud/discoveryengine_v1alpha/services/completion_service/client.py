...
from google.cloud.discoveryengine_v1alpha.types import completion_service
...
class CompletionServiceClient(metaclass=CompletionServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            CompletionServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def complete_query(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.CompleteQueryRequest, dict]):
    ...
    def import_suggestion_deny_list_entries(self,
        ...
        .. code-block:: python
            ...
            def sample_import_suggestion_deny_list_entries():
                # Create a client
                client = discoveryengine_v1alpha.CompletionServiceClient()
                ...
                request = discoveryengine_v1alpha.ImportSuggestionDenyListEntriesRequest(
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.ImportSuggestionDenyListEntriesRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.import_suggestion_deny_list_entries]
        ...
        response = operation.from_gapic(
            ...
            import_config.ImportSuggestionDenyListEntriesResponse,
    ...
    def purge_suggestion_deny_list_entries(self,
        ...
        .. code-block:: python
            ...
            def sample_purge_suggestion_deny_list_entries():
                # Create a client
                client = discoveryengine_v1alpha.CompletionServiceClient()

                # Initialize request argument(s)
                request = discoveryengine_v1alpha.PurgeSuggestionDenyListEntriesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.PurgeSuggestionDenyListEntriesRequest, dict]):
                The request object. Request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, purge_config.PurgeSuggestionDenyListEntriesRequest):
            request = purge_config.PurgeSuggestionDenyListEntriesRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.purge_suggestion_deny_list_entries]
        ...
        response = operation.from_gapic(
            response,
            self._transport.operations_client,
            purge_config.PurgeSuggestionDenyListEntriesResponse,
            metadata_type=purge_config.PurgeSuggestionDenyListEntriesMetadata,
        )

        # Done; return the response.
        return response

    def import_completion_suggestions(self,
        ...
        .. code-block:: python
            ...
            def sample_import_completion_suggestions():
                ...
                request = discoveryengine_v1alpha.ImportCompletionSuggestionsRequest(
                    inline_source=inline_source,
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.ImportCompletionSuggestionsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.import_completion_suggestions]
    ...
    def purge_completion_suggestions(self,
        ...
        .. code-block:: python
            ...
            def sample_purge_completion_suggestions():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.PurgeCompletionSuggestionsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.PurgeCompletionSuggestionsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.purge_completion_suggestions]

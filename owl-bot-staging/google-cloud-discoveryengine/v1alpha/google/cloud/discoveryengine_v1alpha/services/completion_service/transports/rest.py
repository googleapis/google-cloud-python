    ...
    class _CompleteQuery(_BaseCompletionServiceRestTransport._BaseCompleteQuery, CompletionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.CompleteQuery",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.complete_query",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
                        "rpcName": "CompleteQuery",
    ...
    class _ImportCompletionSuggestions(_BaseCompletionServiceRestTransport._BaseImportCompletionSuggestions, CompletionServiceRestStub):
        ...
        suggestions method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.ImportCompletionSuggestions",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.import_completion_suggestions",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
                        "rpcName": "ImportCompletionSuggestions",
                        "metadata": http_response["headers"],
    ...
    class _ImportSuggestionDenyListEntries(_BaseCompletionServiceRestTransport._BaseImportSuggestionDenyListEntries, CompletionServiceRestStub):
        ...
        list entries method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.ImportSuggestionDenyListEntries",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.import_suggestion_deny_list_entries",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
                        "rpcName": "ImportSuggestionDenyListEntries",
                        "metadata": http_response["headers"],
    ...
    class _PurgeCompletionSuggestions(_BaseCompletionServiceRestTransport._BasePurgeCompletionSuggestions, CompletionServiceRestStub):
        ...
        suggestions method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.PurgeCompletionSuggestions",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.purge_completion_suggestions",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
                        "rpcName": "PurgeCompletionSuggestions",
                        "metadata": http_response["headers"],
    ...
    class _PurgeSuggestionDenyListEntries(_BaseCompletionServiceRestTransport._BasePurgeSuggestionDenyListEntries, CompletionServiceRestStub):
        ...
        list entries method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.PurgeSuggestionDenyListEntries",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.purge_suggestion_deny_list_entries",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
                        "rpcName": "PurgeSuggestionDenyListEntries",
                        "metadata": http_response["headers"],
    ...
    class _CancelOperation(_BaseCompletionServiceRestTransport._BaseCancelOperation, CompletionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
    ...
    class _GetOperation(_BaseCompletionServiceRestTransport._BaseGetOperation, CompletionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.CompletionServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseCompletionServiceRestTransport._BaseListOperations, CompletionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.CompletionServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.CompletionServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.CompletionService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

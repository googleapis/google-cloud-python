...
from .base import EstimateBillingServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class EstimateBillingServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_estimate_data_size(self, request: estimate_billing_service.EstimateDataSizeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[estimate_billing_service.EstimateDataSizeRequest, Sequence[Tuple[str, str]]]:

...
class EstimateBillingServiceTransport(abc.ABC):
    """Abstract transport class for EstimateBillingService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.estimate_data_size: gapic_v1.method.wrap_method(
    ...
    @property
    def estimate_data_size(self) -> Callable[

...
from .base import AclConfigServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class AclConfigServiceRestTransport(AclConfigServiceTransport):
    """REST backend transport for AclConfigService.
    ...
    class _GetAclConfig(AclConfigServiceRestStub):
        def __hash__(self):
            return hash("GetAclConfig")
    ...
    class _UpdateAclConfig(AclConfigServiceRestStub):
        def __hash__(self):
            return hash("UpdateAclConfig")
    ...
    class _CancelOperation(AclConfigServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _GetOperation(AclConfigServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _ListOperations(AclConfigServiceRestStub):
        def __call__(self,

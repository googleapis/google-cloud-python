...
class AclConfigServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_acl_config(self, request: acl_config_service.GetAclConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[acl_config_service.GetAclConfigRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_acl_config(self, request: acl_config_service.UpdateAclConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[acl_config_service.UpdateAclConfigRequest, Sequence[Tuple[str, str]]]:

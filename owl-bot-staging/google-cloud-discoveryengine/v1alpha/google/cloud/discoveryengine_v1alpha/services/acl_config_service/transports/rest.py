...
class AclConfigServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_acl_config(self, request: acl_config_service.GetAclConfigRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[acl_config_service.GetAclConfigRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_acl_config_with_metadata(self, response: acl_config.AclConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[acl_config.AclConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_acl_config
    ...
    def pre_update_acl_config(self, request: acl_config_service.UpdateAclConfigRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[acl_config_service.UpdateAclConfigRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_acl_config_with_metadata(self, response: acl_config.AclConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[acl_config.AclConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_acl_config
...
class AclConfigServiceRestTransport(_BaseAclConfigServiceRestTransport):
    ...
    class _GetAclConfig(_BaseAclConfigServiceRestTransport._BaseGetAclConfig, AclConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AclConfigServiceRestTransport._GetAclConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateAclConfig(_BaseAclConfigServiceRestTransport._BaseUpdateAclConfig, AclConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AclConfigServiceRestTransport._UpdateAclConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CancelOperation(_BaseAclConfigServiceRestTransport._BaseCancelOperation, AclConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AclConfigServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseAclConfigServiceRestTransport._BaseGetOperation, AclConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AclConfigServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseAclConfigServiceRestTransport._BaseListOperations, AclConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AclConfigServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

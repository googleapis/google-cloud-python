...
class _BaseAclConfigServiceRestTransport(AclConfigServiceTransport):
    """Base REST backend transport for AclConfigService.
    ...
    class _BaseGetAclConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha/{name=projects/*/locations/*/aclConfig}',
            },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = acl_config_service.GetAclConfigRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAclConfigServiceRestTransport._BaseGetAclConfig._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseUpdateAclConfig:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1alpha/{acl_config.name=projects/*/locations/*/aclConfig}',
                'body': 'acl_config',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = acl_config_service.UpdateAclConfigRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAclConfigServiceRestTransport._BaseUpdateAclConfig._get_unset_required_fields(query_params))

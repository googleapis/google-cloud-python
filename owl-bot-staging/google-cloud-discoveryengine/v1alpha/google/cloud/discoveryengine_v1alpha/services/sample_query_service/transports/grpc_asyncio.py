...
class SampleQueryServiceGrpcAsyncIOTransport(SampleQueryServiceTransport):
    """gRPC AsyncIO backend transport for SampleQueryService.
    ...
    def get_sample_query(self) -> Callable[
        ...
        if 'get_sample_query' not in self._stubs:
            self._stubs['get_sample_query'] = self.grpc_channel.unary_unary(
    ...
    def list_sample_queries(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListSampleQueriesRequest],
                    Awaitable[~.ListSampleQueriesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if 'list_sample_queries' not in self._stubs:
            self._stubs['list_sample_queries'] = self.grpc_channel.unary_unary(
    ...
    def create_sample_query(self) -> Callable[
        ...
        if 'create_sample_query' not in self._stubs:
            self._stubs['create_sample_query'] = self.grpc_channel.unary_unary(
    ...
    def update_sample_query(self) -> Callable[
        ...
        if 'update_sample_query' not in self._stubs:
            self._stubs['update_sample_query'] = self.grpc_channel.unary_unary(
    ...
    def delete_sample_query(self) -> Callable[
        ...
        if 'delete_sample_query' not in self._stubs:
            self._stubs['delete_sample_query'] = self.grpc_channel.unary_unary(
    ...
    def import_sample_queries(self) -> Callable[
        ...
        if 'import_sample_queries' not in self._stubs:
            self._stubs['import_sample_queries'] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_sample_query: gapic_v1.method_async.wrap_method(
                self.get_sample_query,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_sample_queries: gapic_v1.method_async.wrap_method(
                self.list_sample_queries,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_sample_query: gapic_v1.method_async.wrap_method(
                self.create_sample_query,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_sample_query: gapic_v1.method_async.wrap_method(
                self.update_sample_query,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_sample_query: gapic_v1.method_async.wrap_method(
                self.delete_sample_query,
                default_timeout=None,
                client_info=client_info,
            ),
            self.import_sample_queries: gapic_v1.method_async.wrap_method(
                self.import_sample_queries,
                default_timeout=None,
                client_info=client_info,
            ),
         }

...
from .base import SearchServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class SearchServiceRestTransport(SearchServiceTransport):
    """REST backend transport for SearchService.
    ...
    class _Search(SearchServiceRestStub):
        def __hash__(self):
            return hash("Search")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:search',
                'body': '*',
            },
{
                'method': 'post',
                'uri': '/v1alpha/{serving_config=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:search',
                'body': '*',
            },
{
                'method': 'post',
                'uri': '/v1alpha/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}:search',
                'body': '*',
            },
            ]
    ...
    class _GetOperation(SearchServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _ListOperations(SearchServiceRestStub):
        def __call__(self,

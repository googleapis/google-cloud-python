    ...
    class _Recommend(RecommendationServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:recommend',
                'body': '*',
            },
{
                'method': 'post',
                'uri': '/v1alpha/{serving_config=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:recommend',
                'body': '*',
            },
{
                'method': 'post',
                'uri': '/v1alpha/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}:recommend',
                'body': '*',
            },
            ]

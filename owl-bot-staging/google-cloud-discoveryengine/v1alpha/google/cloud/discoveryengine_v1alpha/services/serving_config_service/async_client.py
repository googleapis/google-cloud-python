...
class ServingConfigServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(ServingConfigServiceClient).get_transport_class, type(ServingConfigServiceClient))
    ...
    async def update_serving_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.UpdateServingConfigRequest, dict]]):
                The request object. Request for UpdateServingConfig
                method.
            serving_config (:class:`google.cloud.discoveryengine_v1alpha.types.ServingConfig`):
    ...
    async def get_serving_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.GetServingConfigRequest, dict]]):
    ...
    async def list_serving_configs(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ListServingConfigsRequest, dict]]):

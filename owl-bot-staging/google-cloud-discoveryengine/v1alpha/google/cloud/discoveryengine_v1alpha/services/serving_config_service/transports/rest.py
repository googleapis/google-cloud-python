...
class ServingConfigServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_update_serving_config(self, response: gcd_serving_config.ServingConfig) -> gcd_serving_config.ServingConfig:
    ...
    def post_update_serving_config_with_metadata(self, response: gcd_serving_config.ServingConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_serving_config.ServingConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_serving_config
...
class ServingConfigServiceRestTransport(_BaseServingConfigServiceRestTransport):
    ...
    class _GetServingConfig(_BaseServingConfigServiceRestTransport._BaseGetServingConfig, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.ServingConfigServiceClient.GetServingConfig",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.ServingConfigServiceClient.get_serving_config",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.ServingConfigService",
                        "rpcName": "GetServingConfig",
    ...
    class _ListServingConfigs(_BaseServingConfigServiceRestTransport._BaseListServingConfigs, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.ServingConfigServiceClient.ListServingConfigs",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.ServingConfigService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.ServingConfigServiceClient.list_serving_configs",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.ServingConfigService",
                        "rpcName": "ListServingConfigs",
                        "metadata": http_response["headers"],
    ...
    class _UpdateServingConfig(_BaseServingConfigServiceRestTransport._BaseUpdateServingConfig, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.ServingConfigServiceClient.UpdateServingConfig",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.ServingConfigService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = gcd_serving_config.ServingConfig.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.ServingConfigServiceClient.update_serving_config",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.ServingConfigService",
                        "rpcName": "UpdateServingConfig",
                        "metadata": http_response["headers"],
    ...
    class _CancelOperation(_BaseServingConfigServiceRestTransport._BaseCancelOperation, ServingConfigServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseServingConfigServiceRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = self._interceptor.pre_cancel_operation(request, metadata)
            transcoded_request = _BaseServingConfigServiceRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            body = _BaseServingConfigServiceRestTransport._BaseCancelOperation._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseServingConfigServiceRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.ServingConfigServiceClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.ServingConfigService",
            ...
            # Send the request
            response = ServingConfigServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseServingConfigServiceRestTransport._BaseGetOperation, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.ServingConfigServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.ServingConfigService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.ServingConfigServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.ServingConfigService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseServingConfigServiceRestTransport._BaseListOperations, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.ServingConfigServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.ServingConfigService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.ServingConfigServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.ServingConfigService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

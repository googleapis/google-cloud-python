...
class _BaseSessionServiceRestTransport(SessionServiceTransport):
    ...
    class _BaseListFiles:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha/{parent=projects/*/locations/*/collections/*/engines/*/sessions/*}/files',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = session_service.ListFilesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSessionServiceRestTransport._BaseListFiles._get_unset_required_fields(query_params))

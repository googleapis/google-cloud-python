...
# [START discoveryengine_v1alpha_generated_SampleQueryService_UpdateSampleQuery_sync]
...
def sample_update_sample_query():
    # Create a client
    ...
    # Make the request
    response = client.update_sample_query(request=request)

    # Handle the response
    print(response)

# [END discoveryengine_v1alpha_generated_SampleQueryService_UpdateSampleQuery_sync]

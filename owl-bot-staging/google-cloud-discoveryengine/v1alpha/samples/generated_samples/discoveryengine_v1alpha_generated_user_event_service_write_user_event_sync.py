...
# [START discoveryengine_v1alpha_generated_UserEventService_WriteUserEvent_sync]
...
def sample_write_user_event():
    ...
    request = discoveryengine_v1alpha.WriteUserEventRequest(
        parent="parent_value",
    )
...
# [END discoveryengine_v1alpha_generated_UserEventService_WriteUserEvent_sync]

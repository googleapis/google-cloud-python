...
# [START discoveryengine_v1alpha_generated_ServingConfigService_GetServingConfig_sync]
...
# [END discoveryengine_v1alpha_generated_ServingConfigService_GetServingConfig_sync]

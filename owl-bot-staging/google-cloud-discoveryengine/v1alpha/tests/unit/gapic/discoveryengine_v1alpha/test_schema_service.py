...
from google.cloud.discoveryengine_v1alpha.services.schema_service import SchemaServiceAsyncClient
...
def test_update_schema_rest(request_type):
    ...
    request_init["schema"] = {'struct_schema': {'fields': {}}, 'json_schema': 'json_schema_value', 'name': 'projects/sample1/locations/sample2/dataStores/sample3/schemas/sample4', 'field_configs': [{'field_path': 'field_path_value', 'field_type': 1, 'indexable_option': 1, 'dynamic_facetable_option': 1, 'searchable_option': 1, 'retrievable_option': 1, 'completable_option': 1, 'recs_filterable_option': 1, 'key_property_type': 'key_property_type_value', 'advanced_site_search_data_sources': [1], 'schema_org_paths': ['schema_org_paths_value1', 'schema_org_paths_value2']}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_schema_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1alpha.services.schema_service.transports.SchemaServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_schema_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1alpha.services.schema_service.transports.SchemaServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SchemaServiceTransport()
        adc.assert_called_once()

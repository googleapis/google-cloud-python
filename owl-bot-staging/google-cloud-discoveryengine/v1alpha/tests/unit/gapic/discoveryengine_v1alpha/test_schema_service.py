...
def test_update_schema_rest(request_type):
    ...
    request_init["schema"] = {'struct_schema': {'fields': {}}, 'json_schema': 'json_schema_value', 'name': 'projects/sample1/locations/sample2/dataStores/sample3/schemas/sample4', 'field_configs': [{'field_path': 'field_path_value', 'field_type': 1, 'indexable_option': 1, 'dynamic_facetable_option': 1, 'searchable_option': 1, 'retrievable_option': 1, 'completable_option': 1, 'recs_filterable_option': 1, 'key_property_type': 'key_property_type_value'}]}
    request = request_type(**request_init)

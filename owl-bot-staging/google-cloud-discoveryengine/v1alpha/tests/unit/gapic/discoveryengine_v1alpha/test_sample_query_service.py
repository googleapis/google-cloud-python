...
from google.cloud.discoveryengine_v1alpha.services.sample_query_service import SampleQueryServiceAsyncClient
from google.cloud.discoveryengine_v1alpha.services.sample_query_service import SampleQueryServiceClient
from google.cloud.discoveryengine_v1alpha.services.sample_query_service import pagers
from google.cloud.discoveryengine_v1alpha.services.sample_query_service import transports
...
def test_sample_query_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.sample_query_service.transports.SampleQueryServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_sample_query_empty_call():
...
@pytest.mark.asyncio
async def test_get_sample_query_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
async def test_get_sample_query_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.get_sample_query] = mock_object
...
def test_list_sample_queries_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_list_sample_queries_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = SampleQueryServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_list_sample_queries_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_sample_queries] = mock_object
...
def test_list_sample_queries_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_sample_queries(request={})
...
def test_create_sample_query_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_sample_query_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = SampleQueryServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_create_sample_query_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_sample_query] = mock_object
...
def test_update_sample_query_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_update_sample_query_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = SampleQueryServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_update_sample_query_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_sample_query] = mock_object
...
def test_delete_sample_query_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_sample_query_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = SampleQueryServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_delete_sample_query_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_sample_query] = mock_object
...
def test_import_sample_queries_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_import_sample_queries_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = SampleQueryServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.import_sample_queries()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == import_config.ImportSampleQueriesRequest()
...
async def test_import_sample_queries_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.import_sample_queries] = mock_object
...
def test_get_sample_query_rest(request_type):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_sample_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = sample_query.SampleQuery.to_json(sample_query.SampleQuery())
...
def test_get_sample_query_rest_bad_request(transport: str = 'rest', request_type=sample_query_service.GetSampleQueryRequest):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_sample_query_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/sampleQuerySets/*/sampleQueries/*}" % client.transport._host, args[1])
...
def test_get_sample_query_rest_error():
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_list_sample_queries_rest(request_type):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_sample_queries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = sample_query_service.ListSampleQueriesResponse.to_json(sample_query_service.ListSampleQueriesResponse())
...
def test_list_sample_queries_rest_bad_request(transport: str = 'rest', request_type=sample_query_service.ListSampleQueriesRequest):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_sample_queries_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/sampleQuerySets/*}/sampleQueries" % client.transport._host, args[1])
...
def test_create_sample_query_rest(request_type):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_create_sample_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcd_sample_query.SampleQuery.to_json(gcd_sample_query.SampleQuery())
...
def test_create_sample_query_rest_bad_request(transport: str = 'rest', request_type=sample_query_service.CreateSampleQueryRequest):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_sample_query_rest_error():
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_update_sample_query_rest(request_type):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_update_sample_query_rest_bad_request(transport: str = 'rest', request_type=sample_query_service.UpdateSampleQueryRequest):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_sample_query_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{sample_query.name=projects/*/locations/*/sampleQuerySets/*/sampleQueries/*}" % client.transport._host, args[1])
...
def test_update_sample_query_rest_error():
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_delete_sample_query_rest(request_type):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_delete_sample_query_rest_bad_request(transport: str = 'rest', request_type=sample_query_service.DeleteSampleQueryRequest):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_sample_query_rest_error():
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_import_sample_queries_rest(request_type):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_import_sample_queries_rest_bad_request(transport: str = 'rest', request_type=import_config.ImportSampleQueriesRequest):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_sample_queries_rest_error():
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_transport_kind(transport_name):
    transport = SampleQueryServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_sample_query_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.sample_query_service.transports.SampleQueryServiceTransport.__init__') as Transport:
...
def test_sample_query_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1alpha.services.sample_query_service.transports.SampleQueryServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_sample_query_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1alpha.services.sample_query_service.transports.SampleQueryServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SampleQueryServiceTransport()
        adc.assert_called_once()
...
def test_sample_query_path():
    ...
    sampleQuery = "octopus"
    expected = "projects/{project}/locations/{location}/sampleQuerySets/{sampleQuerySet}/sampleQueries/{sampleQuery}".format(project=project, location=location, sampleQuerySet=sampleQuerySet, sampleQuery=sampleQuery, )
    actual = SampleQueryServiceClient.sample_query_path(project, location, sampleQuerySet, sampleQuery)
...
def test_sample_query_set_path():
    ...
    expected = "projects/{project}/locations/{location}/sampleQuerySets/{sampleQuerySet}".format(project=project, location=location, sampleQuerySet=sampleQuerySet, )
    actual = SampleQueryServiceClient.sample_query_set_path(project, location, sampleQuerySet)
    assert expected == actual

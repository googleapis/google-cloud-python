...
from google.cloud.discoveryengine_v1alpha.services.completion_service import CompletionServiceAsyncClient
from google.cloud.discoveryengine_v1alpha.services.completion_service import CompletionServiceClient
from google.cloud.discoveryengine_v1alpha.services.completion_service import transports
...
def test_completion_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.completion_service.transports.CompletionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_completion_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.completion_service.transports.CompletionServiceTransport.__init__') as Transport:
...
def test_completion_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1alpha.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_completion_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1alpha.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CompletionServiceTransport()
        adc.assert_called_once()

...
async def test_set_uri_pattern_document_data_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.set_uri_pattern_document_data] = mock_object
...
async def test_get_uri_pattern_document_data_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_uri_pattern_document_data] = mock_object
...
def test_set_uri_pattern_document_data_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.SetUriPatternDocumentDataRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_uri_pattern_document_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = site_search_engine_service.GetUriPatternDocumentDataResponse.to_json(site_search_engine_service.GetUriPatternDocumentDataResponse())
...
def test_get_uri_pattern_document_data_rest_bad_request(transport: str = 'rest', request_type=site_search_engine_service.GetUriPatternDocumentDataRequest):
    client = SiteSearchEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

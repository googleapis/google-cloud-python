...
from google.cloud.discoveryengine_v1alpha.services.search_service import SearchServiceAsyncClient
from google.cloud.discoveryengine_v1alpha.services.search_service import SearchServiceClient
from google.cloud.discoveryengine_v1alpha.services.search_service import pagers
from google.cloud.discoveryengine_v1alpha.services.search_service import transports
...
def test_search_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.search_service.transports.SearchServiceGrpcTransport.__init__') as grpc_transport:
...
def test_search_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.search_service.transports.SearchServiceTransport.__init__') as Transport:
...
def test_search_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1alpha.services.search_service.transports.SearchServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_search_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1alpha.services.search_service.transports.SearchServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SearchServiceTransport()
        adc.assert_called_once()

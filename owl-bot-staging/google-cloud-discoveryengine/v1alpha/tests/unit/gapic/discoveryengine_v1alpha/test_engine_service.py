...
from google.cloud.discoveryengine_v1alpha.services.engine_service import EngineServiceAsyncClient
from google.cloud.discoveryengine_v1alpha.services.engine_service import EngineServiceClient
from google.cloud.discoveryengine_v1alpha.services.engine_service import pagers
from google.cloud.discoveryengine_v1alpha.services.engine_service import transports
...
def test__get_api_endpoint():
    ...
    assert EngineServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EngineServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    EngineServiceClient, EngineServiceAsyncClient
])
...
def test_create_engine(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_engine),
            '__call__') as call:
...
def test_delete_engine(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_engine),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_engine(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_engine),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_engine(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_engine),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_engines(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_engines),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_pause_engine(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.pause_engine),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = engine.Engine(
            name='name_value',
...
def test_pause_engine_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.pause_engine in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.pause_engine] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_pause_engine_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EngineServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.pause_engine in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.pause_engine] = mock_rpc
...
def test_resume_engine(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resume_engine),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = engine.Engine(
            name='name_value',
...
def test_resume_engine_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.resume_engine in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.resume_engine] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_resume_engine_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EngineServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.resume_engine in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.resume_engine] = mock_rpc
...
def test_tune_engine(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.tune_engine),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_tune_engine_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.tune_engine in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.tune_engine] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_tune_engine_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EngineServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.tune_engine in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.tune_engine] = mock_rpc
...
def test_pause_engine_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EngineServiceClient(
...
def test_resume_engine_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EngineServiceClient(
...
def test_tune_engine_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EngineServiceClient(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_pause_engine_empty_call_grpc():
    client = EngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = engine.Engine()
        client.pause_engine(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resume_engine_empty_call_grpc():
    client = EngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = engine.Engine()
        client.resume_engine(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_tune_engine_empty_call_grpc():
    client = EngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.tune_engine(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_pause_engine_empty_call_grpc_asyncio():
    client = EngineServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_resume_engine_empty_call_grpc_asyncio():
    client = EngineServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_tune_engine_empty_call_grpc_asyncio():
    client = EngineServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.tune_engine(request=None)
...
def test_create_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_create_engine") as post, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_create_engine_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "pre_create_engine") as pre:
...
def test_delete_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_delete_engine") as post, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_delete_engine_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "pre_delete_engine") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_update_engine") as post, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_update_engine_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "pre_update_engine") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_get_engine") as post, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_get_engine_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "pre_get_engine") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_engines_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_list_engines") as post, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_list_engines_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "pre_list_engines") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_pause_engine_rest_call_success(request_type):
    client = EngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_pause_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_pause_engine") as post, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_pause_engine_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "pre_pause_engine") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_resume_engine_rest_bad_request(request_type=engine_service.ResumeEngineRequest):
    client = EngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_resume_engine_rest_call_success(request_type):
    client = EngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_resume_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_resume_engine") as post, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_resume_engine_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "pre_resume_engine") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_tune_engine_rest_call_success(request_type):
    client = EngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_tune_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_tune_engine") as post, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "post_tune_engine_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EngineServiceRestInterceptor, "pre_tune_engine") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_pause_engine_empty_call_rest():
    client = EngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resume_engine_empty_call_rest():
    client = EngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_tune_engine_empty_call_rest():
    client = EngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize("transport_class", [transports.EngineServiceGrpcTransport, transports.EngineServiceGrpcAsyncIOTransport])
def test_engine_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):

...
def test_create_engine_rest_required_fields(request_type=engine_service.CreateEngineRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_engine._get_unset_required_fields(jsonified_request)
...
def test_create_engine_rest_unset_required_fields():
    transport = transports.EngineServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_delete_engine_rest_required_fields(request_type=engine_service.DeleteEngineRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_engine._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_engine_rest_required_fields(request_type=engine_service.UpdateEngineRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_engine._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_engine_rest_required_fields(request_type=engine_service.GetEngineRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_engine._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_engines_rest_required_fields(request_type=engine_service.ListEnginesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_engines._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_pause_engine_rest_required_fields(request_type=engine_service.PauseEngineRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).pause_engine._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_resume_engine_rest_required_fields(request_type=engine_service.ResumeEngineRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).resume_engine._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_tune_engine_rest_required_fields(request_type=engine_service.TuneEngineRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).tune_engine._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

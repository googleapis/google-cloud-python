...
def test_create_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcd_document.Document.to_json(gcd_document.Document())
...
def test_create_document_rest_bad_request(transport: str = 'rest', request_type=document_service.CreateDocumentRequest):
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_document_rest_bad_request(transport: str = 'rest', request_type=document_service.UpdateDocumentRequest):
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_document_rest_bad_request(transport: str = 'rest', request_type=document_service.DeleteDocumentRequest):
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_documents_rest_bad_request(transport: str = 'rest', request_type=import_config.ImportDocumentsRequest):
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_documents_rest_bad_request(transport: str = 'rest', request_type=purge_config.PurgeDocumentsRequest):
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_processed_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = document.ProcessedDocument.to_json(document.ProcessedDocument())
...
def test_get_processed_document_rest_bad_request(transport: str = 'rest', request_type=document_service.GetProcessedDocumentRequest):
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_get_documents_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = document_service.BatchGetDocumentsMetadataResponse.to_json(document_service.BatchGetDocumentsMetadataResponse())
...
def test_batch_get_documents_metadata_rest_bad_request(transport: str = 'rest', request_type=document_service.BatchGetDocumentsMetadataRequest):
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_document_processing_config] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_document_processing_config] = mock_object
...
def test_get_document_processing_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = document_processing_config.DocumentProcessingConfig.to_json(document_processing_config.DocumentProcessingConfig())
...
def test_get_document_processing_config_rest_bad_request(transport: str = 'rest', request_type=data_store_service.GetDocumentProcessingConfigRequest):
    client = DataStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_document_processing_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcd_document_processing_config.DocumentProcessingConfig.to_json(gcd_document_processing_config.DocumentProcessingConfig())
...
def test_update_document_processing_config_rest_bad_request(transport: str = 'rest', request_type=data_store_service.UpdateDocumentProcessingConfigRequest):
    client = DataStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

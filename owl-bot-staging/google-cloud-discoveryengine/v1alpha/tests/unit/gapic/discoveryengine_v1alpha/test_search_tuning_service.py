...
from google.cloud.discoveryengine_v1alpha.services.search_tuning_service import SearchTuningServiceAsyncClient
from google.cloud.discoveryengine_v1alpha.services.search_tuning_service import SearchTuningServiceClient
from google.cloud.discoveryengine_v1alpha.services.search_tuning_service import transports
...
def test_search_tuning_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.search_tuning_service.transports.SearchTuningServiceGrpcTransport.__init__') as grpc_transport:
...
def test_train_custom_model_rest_required_fields(request_type=search_tuning_service.TrainCustomModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).train_custom_model._get_unset_required_fields(jsonified_request)
...
def test_train_custom_model_rest_unset_required_fields():
    transport = transports.SearchTuningServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_search_tuning_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.search_tuning_service.transports.SearchTuningServiceTransport.__init__') as Transport:
...
def test_search_tuning_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1alpha.services.search_tuning_service.transports.SearchTuningServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_search_tuning_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1alpha.services.search_tuning_service.transports.SearchTuningServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.SearchTuningServiceTransport()
        adc.assert_called_once()

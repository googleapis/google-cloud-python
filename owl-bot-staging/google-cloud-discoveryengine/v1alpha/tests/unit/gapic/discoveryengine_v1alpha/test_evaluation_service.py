...
async def test_create_evaluation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_evaluation] = mock_object
...
async def test_list_evaluation_results_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_evaluation_results] = mock_object
...
def test_get_evaluation_rest_bad_request(transport: str = 'rest', request_type=evaluation_service.GetEvaluationRequest):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_evaluations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = evaluation_service.ListEvaluationsResponse.to_json(evaluation_service.ListEvaluationsResponse())
...
def test_list_evaluations_rest_bad_request(transport: str = 'rest', request_type=evaluation_service.ListEvaluationsRequest):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_evaluation_rest_bad_request(transport: str = 'rest', request_type=evaluation_service.CreateEvaluationRequest):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_evaluation_results_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = evaluation_service.ListEvaluationResultsResponse.to_json(evaluation_service.ListEvaluationResultsResponse())
...
def test_list_evaluation_results_rest_bad_request(transport: str = 'rest', request_type=evaluation_service.ListEvaluationResultsRequest):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

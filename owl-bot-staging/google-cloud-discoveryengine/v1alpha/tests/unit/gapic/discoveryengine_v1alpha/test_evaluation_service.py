...
def test_sample_query_path():
    ...
    actual = EvaluationServiceClient.sample_query_path(project, location, sampleQuerySet, sampleQuery)
    assert expected == actual
...
def test_sample_query_set_path():
    ...
    actual = EvaluationServiceClient.sample_query_set_path(project, location, sampleQuerySet)
    assert expected == actual

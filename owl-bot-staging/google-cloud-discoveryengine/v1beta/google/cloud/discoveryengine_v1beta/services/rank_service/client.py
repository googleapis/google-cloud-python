...
from google.cloud.discoveryengine_v1beta.types import rank_service
from google.cloud.location import locations_pb2 # type: ignore
from google.longrunning import operations_pb2 # type: ignore
from .transports.base import RankServiceTransport, DEFAULT_CLIENT_INFO
...
class RankServiceClient(metaclass=RankServiceClientMeta):
    ...
    @staticmethod
    def ranking_config_path(project: str,location: str,ranking_config: str,) -> str:
        """Returns a fully-qualified ranking_config string."""
        return "projects/{project}/locations/{location}/rankingConfigs/{ranking_config}".format(project=project, location=location, ranking_config=ranking_config, )

    @staticmethod
    def parse_ranking_config_path(path: str) -> Dict[str,str]:
        """Parses a ranking_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/rankingConfigs/(?P<ranking_config>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RankServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            RankServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RankServiceTransport, Callable[..., RankServiceTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,RankServiceTransport,Callable[..., RankServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the RankServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RankServiceClient._read_environment_variables()
        self._client_cert_source = RankServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RankServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RankServiceTransport], Callable[..., RankServiceTransport]] = (
    ...
    def rank(self,
        ...
        .. code-block:: python
            ...
            def sample_rank():
                # Create a client
                client = discoveryengine_v1beta.RankServiceClient()

                # Initialize request argument(s)
                request = discoveryengine_v1beta.RankRequest(

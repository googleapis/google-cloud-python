...
from .base import RankServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class RankServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_rank(self, request: rank_service.RankRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[rank_service.RankRequest, Sequence[Tuple[str, str]]]:
    ...
    class _Rank(RankServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{ranking_config=projects/*/locations/*/rankingConfigs/*}:rank',
                'body': '*',
            },
            ]

...
from google.cloud.discoveryengine_v1beta.services.site_search_engine_service import pagers
...
from .transports.grpc import SiteSearchEngineServiceGrpcTransport
from .transports.grpc_asyncio import SiteSearchEngineServiceGrpcAsyncIOTransport
from .transports.rest import SiteSearchEngineServiceRestTransport


class SiteSearchEngineServiceClientMeta(type):
    """Metaclass for the SiteSearchEngineService client.
...
class SiteSearchEngineServiceClient(metaclass=SiteSearchEngineServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SiteSearchEngineServiceClient: The constructed client.
        """
    ...
    def transport(self) -> SiteSearchEngineServiceTransport:
        ...
        Returns:
            SiteSearchEngineServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def sitemap_path(project: str,location: str,data_store: str,sitemap: str,) -> str:
        """Returns a fully-qualified sitemap string."""
        return "projects/{project}/locations/{location}/dataStores/{data_store}/siteSearchEngine/sitemaps/{sitemap}".format(project=project, location=location, data_store=data_store, sitemap=sitemap, )

    @staticmethod
    def parse_sitemap_path(path: str) -> Dict[str,str]:
        """Parses a sitemap path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/siteSearchEngine/sitemaps/(?P<sitemap>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def site_search_engine_path(project: str,location: str,data_store: str,) -> str:
        """Returns a fully-qualified site_search_engine string."""
        return "projects/{project}/locations/{location}/dataStores/{data_store}/siteSearchEngine".format(project=project, location=location, data_store=data_store, )

    @staticmethod
    def parse_site_search_engine_path(path: str) -> Dict[str,str]:
        """Parses a site_search_engine path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/siteSearchEngine$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def target_site_path(project: str,location: str,data_store: str,target_site: str,) -> str:
        """Returns a fully-qualified target_site string."""
        return "projects/{project}/locations/{location}/dataStores/{data_store}/siteSearchEngine/targetSites/{target_site}".format(project=project, location=location, data_store=data_store, target_site=target_site, )

    @staticmethod
    def parse_target_site_path(path: str) -> Dict[str,str]:
        """Parses a target_site path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/siteSearchEngine/targetSites/(?P<target_site>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SiteSearchEngineServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SiteSearchEngineServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SiteSearchEngineServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SiteSearchEngineServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SiteSearchEngineServiceTransport, Callable[..., SiteSearchEngineServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the site search engine service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SiteSearchEngineServiceClient._read_environment_variables()
        self._client_cert_source = SiteSearchEngineServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SiteSearchEngineServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SiteSearchEngineServiceTransport)
        if transport_provided:
            # transport is a SiteSearchEngineServiceTransport instance.
            ...
            self._transport = cast(SiteSearchEngineServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SiteSearchEngineServiceTransport], Callable[..., SiteSearchEngineServiceTransport]] = (
    ...
    def get_site_search_engine(self,
        ...
        .. code-block:: python
            ...
            def sample_get_site_search_engine():
                # Create a client
                client = discoveryengine_v1beta.SiteSearchEngineServiceClient()
                ...
                # Make the request
                response = client.get_site_search_engine(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.GetSiteSearchEngineRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_site_search_engine]
    ...
    def create_target_site(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.CreateTargetSiteRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_target_site]
    ...
    def batch_create_target_sites(self,
        ...
        .. code-block:: python
            ...
            def sample_batch_create_target_sites():
                # Create a client
                client = discoveryengine_v1beta.SiteSearchEngineServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.BatchCreateTargetSitesRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_create_target_sites]
    ...
    def get_target_site(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.GetTargetSiteRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_target_site]
    ...
    def update_target_site(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.UpdateTargetSiteRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_target_site]
    ...
    def delete_target_site(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.DeleteTargetSiteRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_target_site]
    ...
    def list_target_sites(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ListTargetSitesRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_target_sites]
        ...
        response = pagers.ListTargetSitesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def create_sitemap(self,
            request: Optional[Union[site_search_engine_service.CreateSitemapRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.CreateSitemapRequest, dict]):
                The request object. Request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, sitemap])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_sitemap]
    ...
    def delete_sitemap(self,
            request: Optional[Union[site_search_engine_service.DeleteSitemapRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.DeleteSitemapRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_sitemap]
    ...
    def fetch_sitemaps(self,
            request: Optional[Union[site_search_engine_service.FetchSitemapsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_fetch_sitemaps():
                ...
                # Make the request
                response = client.fetch_sitemaps(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.FetchSitemapsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_sitemaps]
    ...
    def enable_advanced_site_search(self,
        ...
        .. code-block:: python
            ...
            def sample_enable_advanced_site_search():
                # Create a client
                client = discoveryengine_v1beta.SiteSearchEngineServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.EnableAdvancedSiteSearchRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.enable_advanced_site_search]
    ...
    def disable_advanced_site_search(self,
        ...
        .. code-block:: python
            ...
            def sample_disable_advanced_site_search():
                # Create a client
                client = discoveryengine_v1beta.SiteSearchEngineServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.DisableAdvancedSiteSearchRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.disable_advanced_site_search]
    ...
    def recrawl_uris(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.RecrawlUrisRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.recrawl_uris]
    ...
    def batch_verify_target_sites(self,
        ...
        .. code-block:: python
            ...
            def sample_batch_verify_target_sites():
                # Create a client
                client = discoveryengine_v1beta.SiteSearchEngineServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.BatchVerifyTargetSitesRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_verify_target_sites]
    ...
    def fetch_domain_verification_status(self,
        ...
        .. code-block:: python
            ...
            def sample_fetch_domain_verification_status():
                # Create a client
                client = discoveryengine_v1beta.SiteSearchEngineServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.FetchDomainVerificationStatusRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_domain_verification_status]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.FetchDomainVerificationStatusPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "SiteSearchEngineServiceClient":
        return self

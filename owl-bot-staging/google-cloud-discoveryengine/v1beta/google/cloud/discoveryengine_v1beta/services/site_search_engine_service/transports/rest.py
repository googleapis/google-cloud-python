...
class SiteSearchEngineServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_create_sitemap(self, request: site_search_engine_service.CreateSitemapRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[site_search_engine_service.CreateSitemapRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_sitemap(self, request: site_search_engine_service.DeleteSitemapRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[site_search_engine_service.DeleteSitemapRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_fetch_sitemaps(self, request: site_search_engine_service.FetchSitemapsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[site_search_engine_service.FetchSitemapsRequest, Sequence[Tuple[str, str]]]:

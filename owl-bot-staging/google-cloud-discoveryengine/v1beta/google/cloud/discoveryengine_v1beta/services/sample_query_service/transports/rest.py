...
from .base import SampleQueryServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class SampleQueryServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_sample_query(self, request: sample_query_service.CreateSampleQueryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sample_query_service.CreateSampleQueryRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_sample_query(self, response: gcd_sample_query.SampleQuery) -> gcd_sample_query.SampleQuery:
        ...
        """
        return response
    def pre_delete_sample_query(self, request: sample_query_service.DeleteSampleQueryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sample_query_service.DeleteSampleQueryRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_sample_query(self, request: sample_query_service.GetSampleQueryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sample_query_service.GetSampleQueryRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_sample_query(self, response: sample_query.SampleQuery) -> sample_query.SampleQuery:
        ...
        """
        return response
    def pre_import_sample_queries(self, request: import_config.ImportSampleQueriesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[import_config.ImportSampleQueriesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_import_sample_queries(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_list_sample_queries(self, request: sample_query_service.ListSampleQueriesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sample_query_service.ListSampleQueriesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_sample_queries(self, response: sample_query_service.ListSampleQueriesResponse) -> sample_query_service.ListSampleQueriesResponse:
        ...
        """
        return response
    def pre_update_sample_query(self, request: sample_query_service.UpdateSampleQueryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sample_query_service.UpdateSampleQueryRequest, Sequence[Tuple[str, str]]]:
...
class SampleQueryServiceRestTransport(SampleQueryServiceTransport):
    """REST backend transport for SampleQueryService.
    ...
    class _CreateSampleQuery(SampleQueryServiceRestStub):
        def __hash__(self):
            return hash("CreateSampleQuery")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{parent=projects/*/locations/*/sampleQuerySets/*}/sampleQueries',
                'body': 'sample_query',
            },
            ]
            request, metadata = self._interceptor.pre_create_sample_query(request, metadata)
            pb_request = sample_query_service.CreateSampleQueryRequest.pb(request)
    ...
    class _DeleteSampleQuery(SampleQueryServiceRestStub):
        def __hash__(self):
            return hash("DeleteSampleQuery")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1beta/{name=projects/*/locations/*/sampleQuerySets/*/sampleQueries/*}',
            },
            ]
            request, metadata = self._interceptor.pre_delete_sample_query(request, metadata)
            pb_request = sample_query_service.DeleteSampleQueryRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetSampleQuery(SampleQueryServiceRestStub):
        def __hash__(self):
            return hash("GetSampleQuery")
        ...
        def __call__(self,
            ...
            pb_request = sample_query_service.GetSampleQueryRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ImportSampleQueries(SampleQueryServiceRestStub):
        def __hash__(self):
            return hash("ImportSampleQueries")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{parent=projects/*/locations/*/sampleQuerySets/*}/sampleQueries:import',
                'body': '*',
            },
            ]
            request, metadata = self._interceptor.pre_import_sample_queries(request, metadata)
            pb_request = import_config.ImportSampleQueriesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListSampleQueries(SampleQueryServiceRestStub):
        def __hash__(self):
            return hash("ListSampleQueries")
        ...
        def __call__(self,
            ...
            pb_request = sample_query_service.ListSampleQueriesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _UpdateSampleQuery(SampleQueryServiceRestStub):
        def __hash__(self):
            return hash("UpdateSampleQuery")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1beta/{sample_query.name=projects/*/locations/*/sampleQuerySets/*/sampleQueries/*}',
                'body': 'sample_query',
            },
            ]
            request, metadata = self._interceptor.pre_update_sample_query(request, metadata)
            pb_request = sample_query_service.UpdateSampleQueryRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _CancelOperation(SampleQueryServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _GetOperation(SampleQueryServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _ListOperations(SampleQueryServiceRestStub):
        def __call__(self,

...
class ListDataStoresPager:
    ...
    :class:`google.cloud.discoveryengine_v1beta.types.ListDataStoresResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1beta.types.ListDataStoresResponse`

...
class _BaseUserEventServiceRestTransport(UserEventServiceTransport):
    ...
    class _BaseCollectUserEvent:
        ...
        {
                'method': 'get',
                'uri': '/v1beta/{parent=projects/*/locations/*}/userEvents:collect',
            },
            ]
            return http_options
    ...
    class _BasePurgeUserEvents:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{parent=projects/*/locations/*/dataStores/*}/userEvents:purge',
                'body': '*',
            },
        {
                'method': 'post',
                'uri': '/v1beta/{parent=projects/*/locations/*/collections/*/dataStores/*}/userEvents:purge',
                'body': '*',
            },
            ]
            return http_options
    ...
    class _BaseWriteUserEvent:
        ...
        {
                'method': 'post',
                'uri': '/v1beta/{parent=projects/*/locations/*}/userEvents:write',
                'body': 'user_event',
            },
            ]
            return http_options

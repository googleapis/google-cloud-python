...
class SearchTuningServiceClient(metaclass=SearchTuningServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1beta.SearchTuningServiceClient`.",
                    extra = {
    ...
    def train_custom_model(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.TrainCustomModelRequest, dict]):
    ...
    def list_custom_models(self,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ListCustomModelsRequest, dict]):
                The request object. Request message for

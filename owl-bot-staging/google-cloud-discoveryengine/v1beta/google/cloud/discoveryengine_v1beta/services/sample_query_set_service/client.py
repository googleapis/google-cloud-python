...
from .transports.grpc import SampleQuerySetServiceGrpcTransport
from .transports.grpc_asyncio import SampleQuerySetServiceGrpcAsyncIOTransport
from .transports.rest import SampleQuerySetServiceRestTransport


class SampleQuerySetServiceClientMeta(type):
    """Metaclass for the SampleQuerySetService client.
    ...
    def get_transport_class(cls,
        ...
        ) -> Type[SampleQuerySetServiceTransport]:
...
class SampleQuerySetServiceClient(metaclass=SampleQuerySetServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SampleQuerySetServiceClient: The constructed client.
        """
    ...
    def transport(self) -> SampleQuerySetServiceTransport:
        ...
        Returns:
            SampleQuerySetServiceTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SampleQuerySetServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SampleQuerySetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SampleQuerySetServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SampleQuerySetServiceTransport, Callable[..., SampleQuerySetServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the sample query set service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SampleQuerySetServiceClient._read_environment_variables()
        self._client_cert_source = SampleQuerySetServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SampleQuerySetServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SampleQuerySetServiceTransport)
        if transport_provided:
            # transport is a SampleQuerySetServiceTransport instance.
            ...
            self._transport = cast(SampleQuerySetServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            SampleQuerySetServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SampleQuerySetServiceTransport], Callable[..., SampleQuerySetServiceTransport]] = (
                SampleQuerySetServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., SampleQuerySetServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1beta.SampleQuerySetServiceClient`.",
                    extra = {
    ...
    def get_sample_query_set(self,
        ...
        .. code-block:: python
            ...
            def sample_get_sample_query_set():
                # Create a client
                client = discoveryengine_v1beta.SampleQuerySetServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.GetSampleQuerySetRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_sample_query_set]
    ...
    def list_sample_query_sets(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListSampleQuerySetsPager:
        r"""Gets a list of
        [SampleQuerySet][google.cloud.discoveryengine.v1beta.SampleQuerySet]s.
        ...
        .. code-block:: python
            ...
            def sample_list_sample_query_sets():
                # Create a client
                client = discoveryengine_v1beta.SampleQuerySetServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ListSampleQuerySetsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.discoveryengine_v1beta.services.sample_query_set_service.pagers.ListSampleQuerySetsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_sample_query_sets]
        ...
        response = pagers.ListSampleQuerySetsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def create_sample_query_set(self,
        ...
        .. code-block:: python
            ...
            def sample_create_sample_query_set():
                # Create a client
                client = discoveryengine_v1beta.SampleQuerySetServiceClient()
                ...
                # Make the request
                response = client.create_sample_query_set(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.CreateSampleQuerySetRequest, dict]):
                The request object. Request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, sample_query_set, sample_query_set_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_sample_query_set]
    ...
    def update_sample_query_set(self,
        ...
        .. code-block:: python
            ...
            def sample_update_sample_query_set():
                # Create a client
                client = discoveryengine_v1beta.SampleQuerySetServiceClient()
                ...
                # Make the request
                response = client.update_sample_query_set(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.UpdateSampleQuerySetRequest, dict]):
                The request object. Request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [sample_query_set, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_sample_query_set]
    ...
    def delete_sample_query_set(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_sample_query_set():
                # Create a client
                client = discoveryengine_v1beta.SampleQuerySetServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.DeleteSampleQuerySetRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_sample_query_set]
    ...
    def __enter__(self) -> "SampleQuerySetServiceClient":
        return self

...
class SampleQuerySetServiceClient(metaclass=SampleQuerySetServiceClientMeta):
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = SampleQuerySetServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SampleQuerySetServiceClient._compare_universes(self.universe_domain, self.transport._credentials))

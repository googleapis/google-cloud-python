...
from .base import EvaluationServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class EvaluationServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_evaluation(self, request: evaluation_service.CreateEvaluationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[evaluation_service.CreateEvaluationRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_evaluation(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_get_evaluation(self, request: evaluation_service.GetEvaluationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[evaluation_service.GetEvaluationRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_evaluation(self, response: evaluation.Evaluation) -> evaluation.Evaluation:
        ...
        """
        return response
    def pre_list_evaluation_results(self, request: evaluation_service.ListEvaluationResultsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[evaluation_service.ListEvaluationResultsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_evaluation_results(self, response: evaluation_service.ListEvaluationResultsResponse) -> evaluation_service.ListEvaluationResultsResponse:
        ...
        """
        return response
    def pre_list_evaluations(self, request: evaluation_service.ListEvaluationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[evaluation_service.ListEvaluationsRequest, Sequence[Tuple[str, str]]]:
...
class EvaluationServiceRestTransport(EvaluationServiceTransport):
    ...
    class _CreateEvaluation(EvaluationServiceRestStub):
        def __hash__(self):
            return hash("CreateEvaluation")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{parent=projects/*/locations/*}/evaluations',
                'body': 'evaluation',
            },
            ]
    ...
    class _GetEvaluation(EvaluationServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1beta/{name=projects/*/locations/*/evaluations/*}',
            },
            ]
    ...
    class _ListEvaluationResults(EvaluationServiceRestStub):
        def __hash__(self):
            return hash("ListEvaluationResults")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1beta/{evaluation=projects/*/locations/*/evaluations/*}:listResults',
            },
            ]
    ...
    class _ListEvaluations(EvaluationServiceRestStub):
        def __hash__(self):

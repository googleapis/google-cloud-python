...
class ControlServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = ControlServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = functools.partial(type(ControlServiceClient).get_transport_class, type(ControlServiceClient))
    ...
    async def create_control(self,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                should not be set.
            control (:class:`google.cloud.discoveryengine_v1beta.types.Control`):
    ...
    async def update_control(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1beta.types.UpdateControlRequest, dict]]):
    ...
    async def list_controls(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_controls():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1beta.ListControlsRequest(
                    parent="parent_value",
                )

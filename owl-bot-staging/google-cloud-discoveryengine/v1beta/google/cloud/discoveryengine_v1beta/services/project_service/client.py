...
class ProjectServiceClient(metaclass=ProjectServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ProjectServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def provision_project(self,
        ...
        .. code-block:: python
            ...
            def sample_provision_project():
                # Create a client
                client = discoveryengine_v1beta.ProjectServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ProvisionProjectRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.discoveryengine_v1beta.types.Project`

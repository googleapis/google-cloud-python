...
from .base import ProjectServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ProjectServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_provision_project(self, request: project_service.ProvisionProjectRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[project_service.ProvisionProjectRequest, Sequence[Tuple[str, str]]]:
    ...
    class _ProvisionProject(ProjectServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{name=projects/*}:provision',
                'body': '*',
            },
            ]

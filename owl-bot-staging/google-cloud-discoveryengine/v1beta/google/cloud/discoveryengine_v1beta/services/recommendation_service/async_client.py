...
class RecommendationServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(RecommendationServiceClient).get_transport_class, type(RecommendationServiceClient))
    ...
    async def recommend(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1beta.types.RecommendRequest, dict]]):

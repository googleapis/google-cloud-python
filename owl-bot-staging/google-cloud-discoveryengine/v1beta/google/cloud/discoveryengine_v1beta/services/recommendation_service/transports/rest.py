...
class RecommendationServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_recommend(self, request: recommendation_service.RecommendRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[recommendation_service.RecommendRequest, Sequence[Tuple[str, str]]]:

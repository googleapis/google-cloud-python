...
from .rest_base import _BaseRecommendationServiceRestTransport
...
class RecommendationServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the RecommendationServiceRestTransport.
    ...
    """
    def pre_recommend(self, request: recommendation_service.RecommendRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[recommendation_service.RecommendRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for recommend

        Override in a subclass to manipulate the request or metadata
        before they are sent to the RecommendationService server.
        """
        return request, metadata
    ...
    def post_recommend(self, response: recommendation_service.RecommendResponse) -> recommendation_service.RecommendResponse:
        ...
        after it is returned by the RecommendationService server but before
        it is returned to user code. This `post_recommend` interceptor runs
        before the `post_recommend_with_metadata` interceptor.
        """
        return response

    def post_recommend_with_metadata(self, response: recommendation_service.RecommendResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[recommendation_service.RecommendResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for recommend

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the RecommendationService server but before it is returned to user code.

        We recommend only using this `post_recommend_with_metadata`
        interceptor in new development instead of the `post_recommend` interceptor.
        When both interceptors are used, this `post_recommend_with_metadata` interceptor runs after the
        `post_recommend` interceptor. The (possibly modified) response returned by
        `post_recommend` will be passed to
        `post_recommend_with_metadata`.
        """
...
class RecommendationServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: RecommendationServiceRestInterceptor


class RecommendationServiceRestTransport(_BaseRecommendationServiceRestTransport):
    """REST backend synchronous transport for RecommendationService.
    ...
    def __init__(self, *,
            ...
            interceptor: Optional[RecommendationServiceRestInterceptor] = None,
    ...
    class _Recommend(_BaseRecommendationServiceRestTransport._BaseRecommend, RecommendationServiceRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the recommend method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.RecommendationServiceClient.Recommend",
                    extra = {
            ...
            # Send the request
            response = RecommendationServiceRestTransport._Recommend._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            # Return the response
            resp = recommendation_service.RecommendResponse()
            pb_resp = recommendation_service.RecommendResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1beta.RecommendationServiceClient.recommend",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1beta.RecommendationService",
                        "rpcName": "Recommend",
    ...
    class _CancelOperation(_BaseRecommendationServiceRestTransport._BaseCancelOperation, RecommendationServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.RecommendationServiceClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1beta.RecommendationService",
            ...
            # Send the request
            response = RecommendationServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseRecommendationServiceRestTransport._BaseGetOperation, RecommendationServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.RecommendationServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1beta.RecommendationService",
            ...
            # Send the request
            response = RecommendationServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1beta.RecommendationServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1beta.RecommendationService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseRecommendationServiceRestTransport._BaseListOperations, RecommendationServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.RecommendationServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1beta.RecommendationService",
            ...
            # Send the request
            response = RecommendationServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1beta.RecommendationServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1beta.RecommendationService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

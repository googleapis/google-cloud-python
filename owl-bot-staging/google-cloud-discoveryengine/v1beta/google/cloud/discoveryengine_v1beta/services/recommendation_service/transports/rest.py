...
from .base import RecommendationServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class RecommendationServiceRestTransport(RecommendationServiceTransport):
    """REST backend transport for RecommendationService.
    ...
    class _Recommend(RecommendationServiceRestStub):
        def __hash__(self):
            return hash("Recommend")
            ...
            },
{
    ...
    class _CancelOperation(RecommendationServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _GetOperation(RecommendationServiceRestStub):
        def __call__(self,

...
class SessionServiceAsyncClient:
    ...
    parse_data_store_path = staticmethod(SessionServiceClient.parse_data_store_path)
    document_path = staticmethod(SessionServiceClient.document_path)
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1beta.SessionServiceAsyncClient`.",
                extra = {
    ...
    async def list_sessions(self,
        ...
        Returns:
            google.cloud.discoveryengine_v1beta.services.session_service.pagers.ListSessionsAsyncPager:

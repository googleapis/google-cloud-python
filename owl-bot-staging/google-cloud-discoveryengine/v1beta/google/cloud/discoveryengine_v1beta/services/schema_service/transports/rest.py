...
class SchemaServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_schema(self, request: schema_service.CreateSchemaRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[schema_service.CreateSchemaRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_schema(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_delete_schema(self, request: schema_service.DeleteSchemaRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[schema_service.DeleteSchemaRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_delete_schema(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_get_schema(self, request: schema_service.GetSchemaRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[schema_service.GetSchemaRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_schema(self, response: schema.Schema) -> schema.Schema:
        ...
        """
        return response
    def pre_list_schemas(self, request: schema_service.ListSchemasRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[schema_service.ListSchemasRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_schemas(self, response: schema_service.ListSchemasResponse) -> schema_service.ListSchemasResponse:
        ...
        """
        return response
    def pre_update_schema(self, request: schema_service.UpdateSchemaRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[schema_service.UpdateSchemaRequest, Sequence[Tuple[str, str]]]:

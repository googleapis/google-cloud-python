...
class CompletionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_advanced_complete_query(self, request: completion_service.AdvancedCompleteQueryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[completion_service.AdvancedCompleteQueryRequest, Sequence[Tuple[str, str]]]:

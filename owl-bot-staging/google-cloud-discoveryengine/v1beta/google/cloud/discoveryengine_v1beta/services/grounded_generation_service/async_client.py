...
class GroundedGenerationServiceAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1beta.GroundedGenerationServiceAsyncClient`.",
                extra = {
    ...
    async def check_grounding(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1beta.types.CheckGroundingRequest, dict]]):

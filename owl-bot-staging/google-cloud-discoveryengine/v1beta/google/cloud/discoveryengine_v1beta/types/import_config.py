...
from google.cloud.discoveryengine_v1beta.types import completion
...
class BigtableOptions(proto.Message):
    ...
    class BigtableColumnFamily(proto.Message):
        ...
        Attributes:
            ...
            encoding (google.cloud.discoveryengine_v1beta.types.BigtableOptions.Encoding):
            ...
            type_ (google.cloud.discoveryengine_v1beta.types.BigtableOptions.Type):
                ...
                function when the encoding value is set to ``BINARY``.
            columns (MutableSequence[google.cloud.discoveryengine_v1beta.types.BigtableOptions.BigtableColumn]):
...
class BigtableSource(proto.Message):
    ...
    Attributes:
        ...
        bigtable_options (google.cloud.discoveryengine_v1beta.types.BigtableOptions):
...
class ImportDocumentsRequest(proto.Message):
    ...
    Attributes:
        ...
        bigquery_source (google.cloud.discoveryengine_v1beta.types.BigQuerySource):
            ...
            This field is a member of `oneof`_ ``source``.
        fhir_store_source (google.cloud.discoveryengine_v1beta.types.FhirStoreSource):
            FhirStore input source.

            This field is a member of `oneof`_ ``source``.
        spanner_source (google.cloud.discoveryengine_v1beta.types.SpannerSource):
            Spanner input source.

            This field is a member of `oneof`_ ``source``.
        cloud_sql_source (google.cloud.discoveryengine_v1beta.types.CloudSqlSource):
            Cloud SQL input source.

            This field is a member of `oneof`_ ``source``.
        firestore_source (google.cloud.discoveryengine_v1beta.types.FirestoreSource):
            Firestore input source.

            This field is a member of `oneof`_ ``source``.
        alloy_db_source (google.cloud.discoveryengine_v1beta.types.AlloyDbSource):
            AlloyDB input source.

            This field is a member of `oneof`_ ``source``.
        bigtable_source (google.cloud.discoveryengine_v1beta.types.BigtableSource):
...
class ImportSuggestionDenyListEntriesRequest(proto.Message):
    ...
    Attributes:
        inline_source (google.cloud.discoveryengine_v1beta.types.ImportSuggestionDenyListEntriesRequest.InlineSource):
            The Inline source for the input content for
    ...
    class InlineSource(proto.Message):
        ...
        Attributes:
            entries (MutableSequence[google.cloud.discoveryengine_v1beta.types.SuggestionDenyListEntry]):
...
class ImportCompletionSuggestionsRequest(proto.Message):
    ...
    class InlineSource(proto.Message):
        ...
        Attributes:
            suggestions (MutableSequence[google.cloud.discoveryengine_v1beta.types.CompletionSuggestion]):
                Required. A list of all denylist entries to
                import. Max of 1000 items.
        """
...
class ImportSampleQueriesRequest(proto.Message):
    ...
    Attributes:
        inline_source (google.cloud.discoveryengine_v1beta.types.ImportSampleQueriesRequest.InlineSource):

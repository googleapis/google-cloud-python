...
from google.cloud.discoveryengine_v1beta.services.session_service import SessionServiceAsyncClient
from google.cloud.discoveryengine_v1beta.services.session_service import SessionServiceClient
from google.cloud.discoveryengine_v1beta.services.session_service import pagers
from google.cloud.discoveryengine_v1beta.services.session_service import transports
...
def test_session_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1beta.services.session_service.transports.SessionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/dataStores/*}/sessions" % client.transport._host, args[1])
...
def test_delete_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/dataStores/*/sessions/*}" % client.transport._host, args[1])
...
def test_update_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{session.name=projects/*/locations/*/dataStores/*/sessions/*}" % client.transport._host, args[1])
...
def test_session_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1beta.services.session_service.transports.SessionServiceTransport.__init__') as Transport:
...
def test_session_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1beta.services.session_service.transports.SessionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_session_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1beta.services.session_service.transports.SessionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SessionServiceTransport()
        adc.assert_called_once()

...
from google.cloud.discoveryengine_v1beta.services.engine_service import EngineServiceAsyncClient
from google.cloud.discoveryengine_v1beta.services.engine_service import EngineServiceClient
...
def test_create_engine_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_engine(
            parent='parent_value',
            engine=gcd_engine.Engine(chat_engine_config=gcd_engine.Engine.ChatEngineConfig(agent_creation_config=gcd_engine.Engine.ChatEngineConfig.AgentCreationConfig(business='business_value'))),
            engine_id='engine_id_value',
        )
        ...
        assert arg == mock_val
        arg = args[0].engine
        mock_val = gcd_engine.Engine(chat_engine_config=gcd_engine.Engine.ChatEngineConfig(agent_creation_config=gcd_engine.Engine.ChatEngineConfig.AgentCreationConfig(business='business_value')))
        assert arg == mock_val
...
def test_engine_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1beta.services.engine_service.transports.EngineServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_engine_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1beta.services.engine_service.transports.EngineServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EngineServiceTransport()
        adc.assert_called_once()

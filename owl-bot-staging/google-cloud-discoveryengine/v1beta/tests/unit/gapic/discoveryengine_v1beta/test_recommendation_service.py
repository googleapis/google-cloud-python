...
def test_recommend_rest_required_fields(request_type=recommendation_service.RecommendRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).recommend._get_unset_required_fields(jsonified_request)
...
def test_recommend_rest_unset_required_fields():
    transport = transports.RecommendationServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)

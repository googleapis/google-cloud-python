...
from google.cloud.discoveryengine_v1beta.services.recommendation_service import RecommendationServiceAsyncClient
from google.cloud.discoveryengine_v1beta.services.recommendation_service import RecommendationServiceClient
from google.cloud.discoveryengine_v1beta.services.recommendation_service import transports
from google.cloud.discoveryengine_v1beta.types import common
from google.cloud.discoveryengine_v1beta.types import recommendation_service
...
def test__read_environment_variables():
    assert RecommendationServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert RecommendationServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        with pytest.raises(ValueError) as excinfo:
            RecommendationServiceClient._read_environment_variables()
    assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert RecommendationServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert RecommendationServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert RecommendationServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert RecommendationServiceClient._get_client_cert_source(None, False) is None
    assert RecommendationServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RecommendationServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert RecommendationServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RecommendationServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(RecommendationServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RecommendationServiceClient))
@mock.patch.object(RecommendationServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RecommendationServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RecommendationServiceClient._DEFAULT_UNIVERSE
    default_endpoint = RecommendationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RecommendationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RecommendationServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert RecommendationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RecommendationServiceClient.DEFAULT_MTLS_ENDPOINT
    assert RecommendationServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RecommendationServiceClient._get_api_endpoint(None, None, default_universe, "always") == RecommendationServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert RecommendationServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RecommendationServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RecommendationServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RecommendationServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RecommendationServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert RecommendationServiceClient._get_universe_domain(None, None) == RecommendationServiceClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        RecommendationServiceClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = RecommendationServiceClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_name", [
    (RecommendationServiceClient, "grpc"),
    (RecommendationServiceAsyncClient, "grpc_asyncio"),
    (RecommendationServiceClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    ...
    (transports.RecommendationServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (transports.RecommendationServiceRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (RecommendationServiceAsyncClient, transports.RecommendationServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (RecommendationServiceClient, transports.RecommendationServiceRestTransport, "rest"),
])
@mock.patch.object(RecommendationServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RecommendationServiceClient))
@mock.patch.object(RecommendationServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RecommendationServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (RecommendationServiceAsyncClient, transports.RecommendationServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (RecommendationServiceClient, transports.RecommendationServiceGrpcTransport, "grpc", "false"),
    (RecommendationServiceAsyncClient, transports.RecommendationServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (RecommendationServiceClient, transports.RecommendationServiceRestTransport, "rest", "true"),
    (RecommendationServiceClient, transports.RecommendationServiceRestTransport, "rest", "false"),
])
@mock.patch.object(RecommendationServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RecommendationServiceClient))
@mock.patch.object(RecommendationServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RecommendationServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    RecommendationServiceClient, RecommendationServiceAsyncClient
])
...
@mock.patch.object(RecommendationServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RecommendationServiceClient))
@mock.patch.object(RecommendationServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RecommendationServiceAsyncClient))
def test_recommendation_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (RecommendationServiceClient, transports.RecommendationServiceGrpcTransport, "grpc", grpc_helpers),
    (RecommendationServiceAsyncClient, transports.RecommendationServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (RecommendationServiceClient, transports.RecommendationServiceRestTransport, "rest", None),
])
...
def test_recommend(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.recommend),
            '__call__') as call:
...
def test_recommend_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.recommend in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.recommend] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_recommend_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.recommend in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.recommend] = mock_rpc
...
def test_recommend_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RecommendationServiceClient(
...
def test_transport_get_channel():
    ...
    transport = transports.RecommendationServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_recommend_empty_call_grpc():
    client = RecommendationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_transport_kind_grpc_asyncio():
    transport = RecommendationServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_recommend_empty_call_grpc_asyncio():
    client = RecommendationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.recommend(request=None)
...
def test_transport_kind_rest():
    transport = RecommendationServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_recommend_rest_bad_request(request_type=recommendation_service.RecommendRequest):
    client = RecommendationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_recommend_rest_call_success(request_type):
    client = RecommendationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_recommend_rest_interceptors(null_interceptor):
    transport = transports.RecommendationServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RecommendationServiceRestInterceptor, "post_recommend") as post, \
        mock.patch.object(transports.RecommendationServiceRestInterceptor, "post_recommend_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommendationServiceRestInterceptor, "pre_recommend") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = recommendation_service.RecommendResponse.to_json(recommendation_service.RecommendResponse())
        ...
        post_with_metadata.return_value = recommendation_service.RecommendResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_recommend_empty_call_rest():
    client = RecommendationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.RecommendationServiceGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_recommendation_service_client_transport_session_collision(transport_name):
    ...
    client1 = RecommendationServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = RecommendationServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_engine_path():
    ...
    actual = RecommendationServiceClient.engine_path(project, location, collection, engine)
    assert expected == actual
...
@pytest.mark.parametrize("client_class,transport_class", [
    (RecommendationServiceClient, transports.RecommendationServiceGrpcTransport),
    (RecommendationServiceAsyncClient, transports.RecommendationServiceGrpcAsyncIOTransport),
])

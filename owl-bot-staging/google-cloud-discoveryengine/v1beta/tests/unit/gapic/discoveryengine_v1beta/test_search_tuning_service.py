...
async def test_train_custom_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.train_custom_model] = mock_object
...
async def test_list_custom_models_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_custom_models] = mock_object
...
def test_train_custom_model_rest_bad_request(transport: str = 'rest', request_type=search_tuning_service.TrainCustomModelRequest):
    client = SearchTuningServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_custom_models_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = search_tuning_service.ListCustomModelsResponse.to_json(search_tuning_service.ListCustomModelsResponse())
...
def test_list_custom_models_rest_bad_request(transport: str = 'rest', request_type=search_tuning_service.ListCustomModelsRequest):
    client = SearchTuningServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

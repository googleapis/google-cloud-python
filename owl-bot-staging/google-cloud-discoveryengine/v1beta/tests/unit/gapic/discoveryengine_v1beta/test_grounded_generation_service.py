...
from google.cloud.discoveryengine_v1beta.services.grounded_generation_service import GroundedGenerationServiceAsyncClient
from google.cloud.discoveryengine_v1beta.services.grounded_generation_service import GroundedGenerationServiceClient
from google.cloud.discoveryengine_v1beta.services.grounded_generation_service import transports
...
def test_grounded_generation_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1beta.services.grounded_generation_service.transports.GroundedGenerationServiceGrpcTransport.__init__') as grpc_transport:
...
def test_grounded_generation_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1beta.services.grounded_generation_service.transports.GroundedGenerationServiceTransport.__init__') as Transport:
...
def test_grounded_generation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1beta.services.grounded_generation_service.transports.GroundedGenerationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_grounded_generation_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1beta.services.grounded_generation_service.transports.GroundedGenerationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GroundedGenerationServiceTransport()
        adc.assert_called_once()

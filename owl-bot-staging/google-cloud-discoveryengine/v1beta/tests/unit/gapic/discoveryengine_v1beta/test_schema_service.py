...
from google.cloud.discoveryengine_v1beta.services.schema_service import SchemaServiceAsyncClient
from google.cloud.discoveryengine_v1beta.services.schema_service import SchemaServiceClient
from google.cloud.discoveryengine_v1beta.services.schema_service import pagers
from google.cloud.discoveryengine_v1beta.services.schema_service import transports
...
def test__get_api_endpoint():
    ...
    assert SchemaServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SchemaServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    SchemaServiceClient, SchemaServiceAsyncClient
])
...
def test_create_schema_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_schema(
            parent='parent_value',
            schema=gcd_schema.Schema(struct_schema=struct_pb2.Struct(fields={'key_value': struct_pb2.Value(null_value=struct_pb2.NullValue.NULL_VALUE)})),
            schema_id='schema_id_value',
        )
...
def test_update_schema(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_schema),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_get_schema") as post, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_get_schema_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "pre_get_schema") as pre:
...
def test_list_schemas_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_list_schemas") as post, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_list_schemas_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "pre_list_schemas") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_create_schema") as post, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_create_schema_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "pre_create_schema") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_update_schema") as post, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_update_schema_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "pre_update_schema") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_delete_schema") as post, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_delete_schema_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "pre_delete_schema") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

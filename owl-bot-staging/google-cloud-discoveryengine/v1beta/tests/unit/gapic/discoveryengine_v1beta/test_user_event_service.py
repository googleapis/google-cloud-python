...
from google.cloud.discoveryengine_v1beta.services.user_event_service import UserEventServiceAsyncClient
from google.cloud.discoveryengine_v1beta.services.user_event_service import UserEventServiceClient
from google.cloud.discoveryengine_v1beta.services.user_event_service import transports
...
def test__get_api_endpoint():
    ...
    assert UserEventServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == UserEventServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert UserEventServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == UserEventServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_user_event_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1beta.services.user_event_service.transports.UserEventServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_purge_user_events_async(transport: str = 'grpc_asyncio', request_type=purge_config.PurgeUserEventsRequest):
    client = UserEventServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_import_user_events_async(transport: str = 'grpc_asyncio', request_type=import_config.ImportUserEventsRequest):
    client = UserEventServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_transport_kind_grpc_asyncio():
    transport = UserEventServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = UserEventServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_write_user_event_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/dataStores/sample3'}
    request_init["user_event"] = {'event_type': 'event_type_value', 'user_pseudo_id': 'user_pseudo_id_value', 'engine': 'engine_value', 'data_store': 'data_store_value', 'event_time': {'seconds': 751, 'nanos': 543}, 'user_info': {'user_id': 'user_id_value', 'user_agent': 'user_agent_value'}, 'direct_user_request': True, 'session_id': 'session_id_value', 'page_info': {'pageview_id': 'pageview_id_value', 'page_category': 'page_category_value', 'uri': 'uri_value', 'referrer_uri': 'referrer_uri_value'}, 'attribution_token': 'attribution_token_value', 'filter': 'filter_value', 'documents': [{'id': 'id_value', 'name': 'name_value', 'uri': 'uri_value', 'quantity': 895, 'promotion_ids': ['promotion_ids_value1', 'promotion_ids_value2'], 'joined': True}], 'panel': {'panel_id': 'panel_id_value', 'display_name': 'display_name_value', 'panel_position': 1508, 'total_panels': 1286, 'documents': {}}, 'search_info': {'search_query': 'search_query_value', 'order_by': 'order_by_value', 'offset': 647}, 'completion_info': {'selected_suggestion': 'selected_suggestion_value', 'selected_position': 1821}, 'transaction_info': {'value': 0.541, 'currency': 'currency_value', 'transaction_id': 'transaction_id_value', 'tax': 0.333, 'cost': 0.441, 'discount_value': 0.1509}, 'tag_ids': ['tag_ids_value1', 'tag_ids_value2'], 'promotion_ids': ['promotion_ids_value1', 'promotion_ids_value2'], 'attributes': {}, 'media_info': {'media_progress_duration': {'seconds': 751, 'nanos': 543}, 'media_progress_percentage': 0.2641}, 'panels': {}}
...
def test_write_user_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UserEventServiceRestInterceptor, "post_write_user_event_with_metadata") as post_with_metadata, \
...
def test_collect_user_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UserEventServiceRestInterceptor, "post_collect_user_event_with_metadata") as post_with_metadata, \
...
def test_purge_user_events_rest_bad_request(request_type=purge_config.PurgeUserEventsRequest):
    client = UserEventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_purge_user_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UserEventServiceRestInterceptor, "post_purge_user_events_with_metadata") as post_with_metadata, \
...
def test_import_user_events_rest_bad_request(request_type=import_config.ImportUserEventsRequest):
    client = UserEventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_import_user_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UserEventServiceRestInterceptor, "post_import_user_events_with_metadata") as post_with_metadata, \
...
def test_user_event_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1beta.services.user_event_service.transports.UserEventServiceTransport.__init__') as Transport:
...
def test_user_event_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1beta.services.user_event_service.transports.UserEventServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_user_event_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1beta.services.user_event_service.transports.UserEventServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.UserEventServiceTransport()
        adc.assert_called_once()
...
def test_document_path():
    ...
    actual = UserEventServiceClient.document_path(project, location, data_store, branch, document)
    assert expected == actual

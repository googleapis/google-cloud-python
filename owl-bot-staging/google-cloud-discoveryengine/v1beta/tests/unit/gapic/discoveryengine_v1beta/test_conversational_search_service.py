...
from google.cloud.discoveryengine_v1beta.services.conversational_search_service import ConversationalSearchServiceAsyncClient
...
from google.cloud.discoveryengine_v1beta.services.conversational_search_service import transports
...
async def test_converse_conversation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.converse_conversation] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.create_conversation] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_conversation] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.answer_query] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_answer] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_session] = mock_object
...
def test_answer_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = conversational_search_service.AnswerQueryResponse.to_json(conversational_search_service.AnswerQueryResponse())
...
def test_answer_query_rest_bad_request(transport: str = 'rest', request_type=conversational_search_service.AnswerQueryRequest):
    client = ConversationalSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_answer_rest_bad_request(transport: str = 'rest', request_type=conversational_search_service.GetAnswerRequest):
    client = ConversationalSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_answer_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/dataStores/*/sessions/*/answers/*}" % client.transport._host, args[1])
...
def test_create_session_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/dataStores/sample3'}
    request_init["session"] = {'name': 'name_value', 'state': 1, 'user_pseudo_id': 'user_pseudo_id_value', 'turns': [{'query': {'text': 'text_value', 'query_id': 'query_id_value'}, 'answer': 'answer_value'}], 'start_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_session_rest_bad_request(transport: str = 'rest', request_type=conversational_search_service.CreateSessionRequest):
    client = ConversationalSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_session_rest_bad_request(transport: str = 'rest', request_type=conversational_search_service.DeleteSessionRequest):
    client = ConversationalSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_session_rest(request_type):
    ...
    request_init["session"] = {'name': 'projects/sample1/locations/sample2/dataStores/sample3/sessions/sample4', 'state': 1, 'user_pseudo_id': 'user_pseudo_id_value', 'turns': [{'query': {'text': 'text_value', 'query_id': 'query_id_value'}, 'answer': 'answer_value'}], 'start_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_session_rest_bad_request(transport: str = 'rest', request_type=conversational_search_service.UpdateSessionRequest):
    client = ConversationalSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_session_rest_bad_request(transport: str = 'rest', request_type=conversational_search_service.GetSessionRequest):
    client = ConversationalSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_sessions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = conversational_search_service.ListSessionsResponse.to_json(conversational_search_service.ListSessionsResponse())
...
def test_list_sessions_rest_bad_request(transport: str = 'rest', request_type=conversational_search_service.ListSessionsRequest):
    client = ConversationalSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

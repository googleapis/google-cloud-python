...
def test_converse_conversation_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = conversational_search_service.ConverseConversationResponse.pb(return_value)
...
def test_list_conversations_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = conversational_search_service.ListConversationsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)

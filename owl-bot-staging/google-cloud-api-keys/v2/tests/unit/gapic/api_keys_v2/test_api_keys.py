...
def test_create_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ApiKeysRestInterceptor, "post_create_key_with_metadata") as post_with_metadata, \
...
def test_list_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ApiKeysRestInterceptor, "post_list_keys_with_metadata") as post_with_metadata, \
...
def test_get_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ApiKeysRestInterceptor, "post_get_key_with_metadata") as post_with_metadata, \
...
def test_get_key_string_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ApiKeysRestInterceptor, "post_get_key_string_with_metadata") as post_with_metadata, \
...
def test_update_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ApiKeysRestInterceptor, "post_update_key_with_metadata") as post_with_metadata, \
...
def test_delete_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ApiKeysRestInterceptor, "post_delete_key_with_metadata") as post_with_metadata, \
...
def test_undelete_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ApiKeysRestInterceptor, "post_undelete_key_with_metadata") as post_with_metadata, \
...
def test_lookup_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ApiKeysRestInterceptor, "post_lookup_key_with_metadata") as post_with_metadata, \

...
class ApiKeysRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_key(self, request: apikeys.CreateKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[apikeys.CreateKeyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_key(self, request: apikeys.DeleteKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[apikeys.DeleteKeyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_key(self, request: apikeys.GetKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[apikeys.GetKeyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_key_string(self, request: apikeys.GetKeyStringRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[apikeys.GetKeyStringRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_keys(self, request: apikeys.ListKeysRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[apikeys.ListKeysRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_lookup_key(self, request: apikeys.LookupKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[apikeys.LookupKeyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_undelete_key(self, request: apikeys.UndeleteKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[apikeys.UndeleteKeyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_key(self, request: apikeys.UpdateKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[apikeys.UpdateKeyRequest, Sequence[Tuple[str, str]]]:

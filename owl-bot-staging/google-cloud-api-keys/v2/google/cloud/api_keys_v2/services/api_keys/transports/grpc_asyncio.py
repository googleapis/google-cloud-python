...
from .base import ApiKeysTransport, DEFAULT_CLIENT_INFO
from .grpc import ApiKeysGrpcTransport


class ApiKeysGrpcAsyncIOTransport(ApiKeysTransport):
    """gRPC AsyncIO backend transport for ApiKeys.
    ...
    def create_key(self) -> Callable[
        ...
        if 'create_key' not in self._stubs:
            self._stubs['create_key'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=apikeys.CreateKeyRequest.serialize,
    ...
    def list_keys(self) -> Callable[
            ...
            Awaitable[apikeys.ListKeysResponse]]:
        ...
        if 'list_keys' not in self._stubs:
            self._stubs['list_keys'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=apikeys.ListKeysRequest.serialize,
                response_deserializer=apikeys.ListKeysResponse.deserialize,
            )
    ...
    def get_key(self) -> Callable[
        ...
        if 'get_key' not in self._stubs:
            self._stubs['get_key'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=apikeys.GetKeyRequest.serialize,
                response_deserializer=resources.Key.deserialize,
            )
    ...
    def get_key_string(self) -> Callable[
            ...
            Awaitable[apikeys.GetKeyStringResponse]]:
        ...
        Returns:
            Callable[[~.GetKeyStringRequest],
                    Awaitable[~.GetKeyStringResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'get_key_string' not in self._stubs:
            self._stubs['get_key_string'] = self.grpc_channel.unary_unary(
                '/google.api.apikeys.v2.ApiKeys/GetKeyString',
                request_serializer=apikeys.GetKeyStringRequest.serialize,
                response_deserializer=apikeys.GetKeyStringResponse.deserialize,
            )
    ...
    def update_key(self) -> Callable[
        ...
        if 'update_key' not in self._stubs:
            self._stubs['update_key'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=apikeys.UpdateKeyRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def delete_key(self) -> Callable[
        ...
        if 'delete_key' not in self._stubs:
            self._stubs['delete_key'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=apikeys.DeleteKeyRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def undelete_key(self) -> Callable[
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'undelete_key' not in self._stubs:
            self._stubs['undelete_key'] = self.grpc_channel.unary_unary(
                '/google.api.apikeys.v2.ApiKeys/UndeleteKey',
                request_serializer=apikeys.UndeleteKeyRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def lookup_key(self) -> Callable[
            ...
            Awaitable[apikeys.LookupKeyResponse]]:
        ...
        Returns:
            Callable[[~.LookupKeyRequest],
                    Awaitable[~.LookupKeyResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'lookup_key' not in self._stubs:
            self._stubs['lookup_key'] = self.grpc_channel.unary_unary(
                '/google.api.apikeys.v2.ApiKeys/LookupKey',
                request_serializer=apikeys.LookupKeyRequest.serialize,
                response_deserializer=apikeys.LookupKeyResponse.deserialize,
            )
        return self._stubs['lookup_key']
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.get_key_string: gapic_v1.method_async.wrap_method(
                self.get_key_string,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.undelete_key: gapic_v1.method_async.wrap_method(
                self.undelete_key,
                default_timeout=None,
                client_info=client_info,
            ),
            self.lookup_key: gapic_v1.method_async.wrap_method(
                self.lookup_key,
                default_timeout=None,
                client_info=client_info,
            ),

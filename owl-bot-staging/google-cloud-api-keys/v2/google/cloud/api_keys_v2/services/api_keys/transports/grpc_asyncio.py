...
class ApiKeysGrpcAsyncIOTransport(ApiKeysTransport):
    ...
    def get_key_string(self) -> Callable[
        ...
        if 'get_key_string' not in self._stubs:
            self._stubs['get_key_string'] = self._logged_channel.unary_unary(
    ...
    def undelete_key(self) -> Callable[
        ...
        if 'undelete_key' not in self._stubs:
            self._stubs['undelete_key'] = self._logged_channel.unary_unary(
    ...
    def lookup_key(self) -> Callable[
        ...
        if 'lookup_key' not in self._stubs:
            self._stubs['lookup_key'] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.get_key_string: self._wrap_method(
                self.get_key_string,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.undelete_key: self._wrap_method(
                self.undelete_key,
                default_timeout=None,
                client_info=client_info,
            ),
            self.lookup_key: self._wrap_method(
                self.lookup_key,
                default_timeout=None,
                client_info=client_info,
            ),

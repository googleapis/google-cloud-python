...
class WorkflowsServiceV2BetaRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_run_pipeline(self, request: workflows.RunPipelineRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[workflows.RunPipelineRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_run_pipeline_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for run_pipeline
...
class WorkflowsServiceV2BetaRestTransport(_BaseWorkflowsServiceV2BetaRestTransport):
    ...
    class _RunPipeline(_BaseWorkflowsServiceV2BetaRestTransport._BaseRunPipeline, WorkflowsServiceV2BetaRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WorkflowsServiceV2BetaRestTransport._RunPipeline._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetLocation(_BaseWorkflowsServiceV2BetaRestTransport._BaseGetLocation, WorkflowsServiceV2BetaRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WorkflowsServiceV2BetaRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseWorkflowsServiceV2BetaRestTransport._BaseListLocations, WorkflowsServiceV2BetaRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WorkflowsServiceV2BetaRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BaseWorkflowsServiceV2BetaRestTransport._BaseCancelOperation, WorkflowsServiceV2BetaRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WorkflowsServiceV2BetaRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseWorkflowsServiceV2BetaRestTransport._BaseGetOperation, WorkflowsServiceV2BetaRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WorkflowsServiceV2BetaRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseWorkflowsServiceV2BetaRestTransport._BaseListOperations, WorkflowsServiceV2BetaRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WorkflowsServiceV2BetaRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
from .transports.base import RouteOptimizationTransport, DEFAULT_CLIENT_INFO
...
class RouteOptimizationClient(metaclass=RouteOptimizationClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            RouteOptimizationClient._compare_universes(self.universe_domain, self.transport._credentials))

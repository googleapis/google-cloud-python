...
class RouteOptimizationRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_optimize_tours(self, request: route_optimization_service.BatchOptimizeToursRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[route_optimization_service.BatchOptimizeToursRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_optimize_tours(self, request: route_optimization_service.OptimizeToursRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[route_optimization_service.OptimizeToursRequest, Sequence[Tuple[str, str]]]:

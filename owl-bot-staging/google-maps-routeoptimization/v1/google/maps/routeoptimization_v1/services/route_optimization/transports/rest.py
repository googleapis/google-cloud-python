...
from .rest_base import _BaseRouteOptimizationRestTransport
...
class RouteOptimizationRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_optimize_tours(self, request: route_optimization_service.BatchOptimizeToursRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[route_optimization_service.BatchOptimizeToursRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_batch_optimize_tours_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for batch_optimize_tours

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the RouteOptimization server but before it is returned to user code.
    ...
    def pre_optimize_tours(self, request: route_optimization_service.OptimizeToursRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[route_optimization_service.OptimizeToursRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_optimize_tours_with_metadata(self, response: route_optimization_service.OptimizeToursResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[route_optimization_service.OptimizeToursResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for optimize_tours
...
class RouteOptimizationRestTransport(_BaseRouteOptimizationRestTransport):
    """REST backend synchronous transport for RouteOptimization.
    ...
    class _BatchOptimizeTours(_BaseRouteOptimizationRestTransport._BaseBatchOptimizeTours, RouteOptimizationRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RouteOptimizationRestTransport._BatchOptimizeTours._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _OptimizeTours(_BaseRouteOptimizationRestTransport._BaseOptimizeTours, RouteOptimizationRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RouteOptimizationRestTransport._OptimizeTours._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseRouteOptimizationRestTransport._BaseGetOperation, RouteOptimizationRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RouteOptimizationRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
from google.cloud.gkeconnect.gateway_v1beta1.services.gateway_service import GatewayServiceAsyncClient
from google.cloud.gkeconnect.gateway_v1beta1.services.gateway_service import GatewayServiceClient
...
def test__get_default_mtls_endpoint():
    ...
    assert GatewayServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert GatewayServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert GatewayServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert GatewayServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert GatewayServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert GatewayServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert GatewayServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert GatewayServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert GatewayServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert GatewayServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert GatewayServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert GatewayServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert GatewayServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert GatewayServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(GatewayServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GatewayServiceClient))
@mock.patch.object(GatewayServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GatewayServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = GatewayServiceClient._DEFAULT_UNIVERSE
    default_endpoint = GatewayServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = GatewayServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert GatewayServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert GatewayServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == GatewayServiceClient.DEFAULT_MTLS_ENDPOINT
    assert GatewayServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert GatewayServiceClient._get_api_endpoint(None, None, default_universe, "always") == GatewayServiceClient.DEFAULT_MTLS_ENDPOINT
    assert GatewayServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == GatewayServiceClient.DEFAULT_MTLS_ENDPOINT
    assert GatewayServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert GatewayServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        GatewayServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert GatewayServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert GatewayServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert GatewayServiceClient._get_universe_domain(None, None) == GatewayServiceClient._DEFAULT_UNIVERSE
...
def test_gateway_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (GatewayServiceClient, transports.GatewayServiceGrpcTransport, "grpc"),
    (GatewayServiceAsyncClient, transports.GatewayServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
@mock.patch.object(GatewayServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GatewayServiceClient))
@mock.patch.object(GatewayServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GatewayServiceAsyncClient))
def test_gateway_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (GatewayServiceAsyncClient, transports.GatewayServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (GatewayServiceClient, transports.GatewayServiceGrpcTransport, "grpc", "false"),
    (GatewayServiceAsyncClient, transports.GatewayServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(GatewayServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GatewayServiceClient))
@mock.patch.object(GatewayServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GatewayServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_gateway_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    GatewayServiceClient, GatewayServiceAsyncClient
])
@mock.patch.object(GatewayServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GatewayServiceClient))
@mock.patch.object(GatewayServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GatewayServiceAsyncClient))
...
def test_gateway_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (GatewayServiceClient, transports.GatewayServiceGrpcTransport, "grpc", grpc_helpers),
    (GatewayServiceAsyncClient, transports.GatewayServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
def test_gateway_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_gateway_service_client_client_options_from_dict():
    with mock.patch('google.cloud.gkeconnect.gateway_v1beta1.services.gateway_service.transports.GatewayServiceGrpcTransport.__init__') as grpc_transport:
...
def test_gateway_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_get_resource_async(transport: str = 'grpc_asyncio', request_type=httpbody_pb2.HttpBody):
    client = GatewayServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_resource_from_dict_foreign():
    ...
    with mock.patch.object(
        ...
        response = client.get_resource(request={
            'content_type': 'content_type_value',
            'data': b'data_blob',
            'extensions': [any_pb2.Any(type_url='type.googleapis.com/google.protobuf.Empty')],
            }
        )
        call.assert_called()
...
def test_post_resource(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.post_resource),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = httpbody_pb2.HttpBody(
            content_type='content_type_value',
...
@pytest.mark.asyncio
async def test_post_resource_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.post_resource in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.post_resource] = mock_object
...
@pytest.mark.asyncio
async def test_post_resource_async(transport: str = 'grpc_asyncio', request_type=httpbody_pb2.HttpBody):
    client = GatewayServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_resource(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_resource),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = httpbody_pb2.HttpBody(
            content_type='content_type_value',
...
@pytest.mark.asyncio
async def test_delete_resource_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_resource in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_resource] = mock_object
...
@pytest.mark.asyncio
async def test_delete_resource_async(transport: str = 'grpc_asyncio', request_type=httpbody_pb2.HttpBody):
    client = GatewayServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_put_resource(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.put_resource),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = httpbody_pb2.HttpBody(
            content_type='content_type_value',
...
@pytest.mark.asyncio
async def test_put_resource_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.put_resource in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.put_resource] = mock_object
...
@pytest.mark.asyncio
async def test_put_resource_async(transport: str = 'grpc_asyncio', request_type=httpbody_pb2.HttpBody):
    client = GatewayServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_resource(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.patch_resource),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = httpbody_pb2.HttpBody(
            content_type='content_type_value',
...
@pytest.mark.asyncio
async def test_patch_resource_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.patch_resource in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.patch_resource] = mock_object
...
@pytest.mark.asyncio
async def test_patch_resource_async(transport: str = 'grpc_asyncio', request_type=httpbody_pb2.HttpBody):
    client = GatewayServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_gateway_service_base_transport():
    ...
    with mock.patch('google.cloud.gkeconnect.gateway_v1beta1.services.gateway_service.transports.GatewayServiceTransport.__init__') as Transport:
...
def test_gateway_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.gkeconnect.gateway_v1beta1.services.gateway_service.transports.GatewayServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_gateway_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.gkeconnect.gateway_v1beta1.services.gateway_service.transports.GatewayServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GatewayServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.GatewayServiceGrpcTransport, transports.GatewayServiceGrpcAsyncIOTransport])
def test_gateway_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_gateway_service_host_no_port(transport_name):
    client = GatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='connectgateway.googleapis.com'),
...
def test_gateway_service_host_with_port(transport_name):
    client = GatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='connectgateway.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
        'connectgateway.googleapis.com:8000'
    )
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.GatewayServiceGrpcTransport, transports.GatewayServiceGrpcAsyncIOTransport])
def test_gateway_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.GatewayServiceTransport, '_prep_wrapped_messages') as prep:
        client = GatewayServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

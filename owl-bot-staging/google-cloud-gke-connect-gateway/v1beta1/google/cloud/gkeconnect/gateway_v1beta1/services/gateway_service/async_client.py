...
class GatewayServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(GatewayServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(GatewayServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(GatewayServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(GatewayServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(GatewayServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(GatewayServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(GatewayServiceClient.common_project_path)
    parse_common_project_path = staticmethod(GatewayServiceClient.parse_common_project_path)
    common_location_path = staticmethod(GatewayServiceClient.common_location_path)
    parse_common_location_path = staticmethod(GatewayServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(GatewayServiceClient).get_transport_class, type(GatewayServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, GatewayServiceTransport, Callable[..., GatewayServiceTransport]]] = "grpc_asyncio",
    ...
    async def post_resource(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.post_resource]
    ...
    async def delete_resource(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_resource]
    ...
    async def put_resource(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.put_resource]
    ...
    async def patch_resource(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.patch_resource]

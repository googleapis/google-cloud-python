...
class GatewayControlRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_generate_credentials(self, request: control.GenerateCredentialsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[control.GenerateCredentialsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_generate_credentials_with_metadata(self, response: control.GenerateCredentialsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[control.GenerateCredentialsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for generate_credentials

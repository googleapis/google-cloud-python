...
def test_create_dataset_rest_unset_required_fields():
    transport = transports.MapsPlatformDatasetsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_dataset_metadata_rest_required_fields(request_type=maps_platform_datasets.UpdateDatasetMetadataRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_dataset_metadata._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

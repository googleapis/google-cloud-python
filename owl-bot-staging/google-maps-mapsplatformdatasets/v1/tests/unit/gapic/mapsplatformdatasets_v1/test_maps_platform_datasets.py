...
from google.maps.mapsplatformdatasets_v1.services.maps_platform_datasets import MapsPlatformDatasetsAsyncClient
...
from google.maps.mapsplatformdatasets_v1.services.maps_platform_datasets import transports
...
def test__get_api_endpoint():
    ...
    assert MapsPlatformDatasetsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == MapsPlatformDatasetsClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert MapsPlatformDatasetsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == MapsPlatformDatasetsClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    MapsPlatformDatasetsClient, MapsPlatformDatasetsAsyncClient
])
...
def test_update_dataset_metadata(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_dataset_metadata),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gmm_dataset.Dataset(
            name='name_value',
...
async def test_fetch_dataset_errors_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.fetch_dataset_errors(request={},)
...
def test_fetch_dataset_errors_rest_required_fields(request_type=maps_platform_datasets.FetchDatasetErrorsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_dataset_errors._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_dataset_errors_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pageSize", "pageToken", )) & set(("dataset", )))
...
def test_list_datasets_rest_required_fields(request_type=maps_platform_datasets.ListDatasetsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_datasets._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("page_size", "page_token", "tag", ))
    jsonified_request.update(unset_fields)
...
def test_list_datasets_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pageSize", "pageToken", "tag", )) & set(("parent", )))
...
def test_create_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_create_dataset") as post, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_create_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "pre_create_dataset") as pre:
...
def test_update_dataset_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_update_dataset_metadata") as post, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_update_dataset_metadata_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "pre_update_dataset_metadata") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_get_dataset") as post, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_get_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "pre_get_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_fetch_dataset_errors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_fetch_dataset_errors") as post, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_fetch_dataset_errors_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "pre_fetch_dataset_errors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.fetch_dataset_errors(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_datasets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_list_datasets") as post, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_list_datasets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "pre_list_datasets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "pre_delete_dataset") as pre:
        pre.assert_not_called()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.MapsPlatformDatasetsGrpcTransport, transports.MapsPlatformDatasetsGrpcAsyncIOTransport])
def test_maps_platform_datasets_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

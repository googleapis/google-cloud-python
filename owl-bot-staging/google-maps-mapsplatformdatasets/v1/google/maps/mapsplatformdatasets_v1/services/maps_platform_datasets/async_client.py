...
class MapsPlatformDatasetsAsyncClient:
    ...
    get_transport_class = functools.partial(type(MapsPlatformDatasetsClient).get_transport_class, type(MapsPlatformDatasetsClient))
    ...
    async def fetch_dataset_errors(self,

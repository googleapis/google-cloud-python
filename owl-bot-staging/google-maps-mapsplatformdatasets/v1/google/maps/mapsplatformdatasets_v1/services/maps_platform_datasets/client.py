...
from .transports.base import MapsPlatformDatasetsTransport, DEFAULT_CLIENT_INFO
...
class MapsPlatformDatasetsClient(metaclass=MapsPlatformDatasetsClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            MapsPlatformDatasetsClient._compare_universes(self.universe_domain, self.transport._credentials))

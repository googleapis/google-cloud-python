...
class MapsPlatformDatasetsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_dataset(self, request: maps_platform_datasets.CreateDatasetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maps_platform_datasets.CreateDatasetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_dataset_with_metadata(self, response: gmm_dataset.Dataset, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gmm_dataset.Dataset, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_dataset
    ...
    def pre_delete_dataset(self, request: maps_platform_datasets.DeleteDatasetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maps_platform_datasets.DeleteDatasetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_fetch_dataset_errors(self, request: maps_platform_datasets.FetchDatasetErrorsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maps_platform_datasets.FetchDatasetErrorsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_fetch_dataset_errors(self, response: maps_platform_datasets.FetchDatasetErrorsResponse) -> maps_platform_datasets.FetchDatasetErrorsResponse:
    ...
    def post_fetch_dataset_errors_with_metadata(self, response: maps_platform_datasets.FetchDatasetErrorsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maps_platform_datasets.FetchDatasetErrorsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for fetch_dataset_errors
    ...
    def pre_get_dataset(self, request: maps_platform_datasets.GetDatasetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maps_platform_datasets.GetDatasetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_datasets(self, request: maps_platform_datasets.ListDatasetsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maps_platform_datasets.ListDatasetsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_datasets_with_metadata(self, response: maps_platform_datasets.ListDatasetsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maps_platform_datasets.ListDatasetsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_datasets
    ...
    def pre_update_dataset_metadata(self, request: maps_platform_datasets.UpdateDatasetMetadataRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maps_platform_datasets.UpdateDatasetMetadataRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_dataset_metadata_with_metadata(self, response: gmm_dataset.Dataset, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gmm_dataset.Dataset, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_dataset_metadata
...
class MapsPlatformDatasetsRestTransport(_BaseMapsPlatformDatasetsRestTransport):
    ...
    class _CreateDataset(_BaseMapsPlatformDatasetsRestTransport._BaseCreateDataset, MapsPlatformDatasetsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MapsPlatformDatasetsRestTransport._CreateDataset._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteDataset(_BaseMapsPlatformDatasetsRestTransport._BaseDeleteDataset, MapsPlatformDatasetsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MapsPlatformDatasetsRestTransport._DeleteDataset._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _FetchDatasetErrors(_BaseMapsPlatformDatasetsRestTransport._BaseFetchDatasetErrors, MapsPlatformDatasetsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MapsPlatformDatasetsRestTransport._FetchDatasetErrors._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetDataset(_BaseMapsPlatformDatasetsRestTransport._BaseGetDataset, MapsPlatformDatasetsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MapsPlatformDatasetsRestTransport._GetDataset._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListDatasets(_BaseMapsPlatformDatasetsRestTransport._BaseListDatasets, MapsPlatformDatasetsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MapsPlatformDatasetsRestTransport._ListDatasets._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateDatasetMetadata(_BaseMapsPlatformDatasetsRestTransport._BaseUpdateDatasetMetadata, MapsPlatformDatasetsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MapsPlatformDatasetsRestTransport._UpdateDatasetMetadata._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class MapsPlatformDatasetsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_dataset(self, request: maps_platform_datasets.CreateDatasetRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[maps_platform_datasets.CreateDatasetRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_dataset(self, request: maps_platform_datasets.DeleteDatasetRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[maps_platform_datasets.DeleteDatasetRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_fetch_dataset_errors(self, request: maps_platform_datasets.FetchDatasetErrorsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[maps_platform_datasets.FetchDatasetErrorsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_dataset(self, request: maps_platform_datasets.GetDatasetRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[maps_platform_datasets.GetDatasetRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_datasets(self, request: maps_platform_datasets.ListDatasetsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[maps_platform_datasets.ListDatasetsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_dataset_metadata(self, request: maps_platform_datasets.UpdateDatasetMetadataRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[maps_platform_datasets.UpdateDatasetMetadataRequest, Sequence[Tuple[str, str]]]:

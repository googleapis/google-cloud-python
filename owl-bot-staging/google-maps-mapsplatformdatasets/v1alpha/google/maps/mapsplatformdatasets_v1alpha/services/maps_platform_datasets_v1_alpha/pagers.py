...
class ListDatasetVersionsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[maps_platform_datasets.ListDatasetVersionsResponse]],
            request: maps_platform_datasets.ListDatasetVersionsRequest,
            response: maps_platform_datasets.ListDatasetVersionsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[maps_platform_datasets.ListDatasetVersionsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

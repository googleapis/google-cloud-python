...
from .base import MapsPlatformDatasetsV1AlphaTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class MapsPlatformDatasetsV1AlphaRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_delete_dataset_version(self, request: maps_platform_datasets.DeleteDatasetVersionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[maps_platform_datasets.DeleteDatasetVersionRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_datasets(self, response: maps_platform_datasets.ListDatasetsResponse) -> maps_platform_datasets.ListDatasetsResponse:
        ...
        """
        return response
    def pre_list_dataset_versions(self, request: maps_platform_datasets.ListDatasetVersionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[maps_platform_datasets.ListDatasetVersionsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_dataset_versions(self, response: maps_platform_datasets.ListDatasetVersionsResponse) -> maps_platform_datasets.ListDatasetVersionsResponse:

...
from .transports.base import MapsPlatformDatasetsV1AlphaTransport, DEFAULT_CLIENT_INFO
...
class MapsPlatformDatasetsV1AlphaClient(metaclass=MapsPlatformDatasetsV1AlphaClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = MapsPlatformDatasetsV1AlphaClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            MapsPlatformDatasetsV1AlphaClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, MapsPlatformDatasetsV1AlphaTransport, Callable[..., MapsPlatformDatasetsV1AlphaTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = MapsPlatformDatasetsV1AlphaClient._read_environment_variables()
        self._client_cert_source = MapsPlatformDatasetsV1AlphaClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = MapsPlatformDatasetsV1AlphaClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[MapsPlatformDatasetsV1AlphaTransport], Callable[..., MapsPlatformDatasetsV1AlphaTransport]] = (
                type(self).get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., MapsPlatformDatasetsV1AlphaTransport], transport)
            )
    ...
    def list_dataset_versions(self,
            request: Optional[Union[maps_platform_datasets.ListDatasetVersionsRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def delete_dataset_version(self,
            request: Optional[Union[maps_platform_datasets.DeleteDatasetVersionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,

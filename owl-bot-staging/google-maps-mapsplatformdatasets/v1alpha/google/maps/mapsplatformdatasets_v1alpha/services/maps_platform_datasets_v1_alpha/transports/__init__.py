...
from .rest import MapsPlatformDatasetsV1AlphaRestTransport
from .rest import MapsPlatformDatasetsV1AlphaRestInterceptor


# Compile a registry of transports.
_transport_registry = OrderedDict()  # type: Dict[str, Type[MapsPlatformDatasetsV1AlphaTransport]]

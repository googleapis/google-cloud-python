...
class MapsPlatformDatasetsV1AlphaTransport(abc.ABC):
    """Abstract transport class for MapsPlatformDatasetsV1Alpha."""

    AUTH_SCOPES = (
        'https://www.googleapis.com/auth/cloud-platform',
    )

    DEFAULT_HOST: str = 'mapsplatformdatasets.googleapis.com'
    def __init__(
            self, *,
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.update_dataset_metadata: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
    ...
    @property
    def update_dataset_metadata(self) -> Callable[

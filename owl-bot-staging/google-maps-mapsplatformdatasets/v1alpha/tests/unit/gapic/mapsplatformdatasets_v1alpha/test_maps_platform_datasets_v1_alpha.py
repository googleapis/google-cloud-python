...
def test_create_dataset_rest_unset_required_fields():
    transport = transports.MapsPlatformDatasetsV1AlphaRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_dataset_versions_rest_required_fields(request_type=maps_platform_datasets.ListDatasetVersionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_dataset_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_dataset_version_rest_required_fields(request_type=maps_platform_datasets.DeleteDatasetVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_dataset_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

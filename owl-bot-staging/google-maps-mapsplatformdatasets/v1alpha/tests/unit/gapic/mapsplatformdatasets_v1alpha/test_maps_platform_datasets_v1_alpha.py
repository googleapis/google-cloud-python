...
from google.maps.mapsplatformdatasets_v1alpha.services.maps_platform_datasets_v1_alpha import MapsPlatformDatasetsV1AlphaAsyncClient
...
from google.maps.mapsplatformdatasets_v1alpha.services.maps_platform_datasets_v1_alpha import pagers
from google.maps.mapsplatformdatasets_v1alpha.services.maps_platform_datasets_v1_alpha import transports
...
def test__read_environment_variables():
    assert MapsPlatformDatasetsV1AlphaClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert MapsPlatformDatasetsV1AlphaClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert MapsPlatformDatasetsV1AlphaClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert MapsPlatformDatasetsV1AlphaClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert MapsPlatformDatasetsV1AlphaClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert MapsPlatformDatasetsV1AlphaClient._get_client_cert_source(None, False) is None
    assert MapsPlatformDatasetsV1AlphaClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert MapsPlatformDatasetsV1AlphaClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert MapsPlatformDatasetsV1AlphaClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert MapsPlatformDatasetsV1AlphaClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(MapsPlatformDatasetsV1AlphaClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsV1AlphaClient))
@mock.patch.object(MapsPlatformDatasetsV1AlphaAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsV1AlphaAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = MapsPlatformDatasetsV1AlphaClient._DEFAULT_UNIVERSE
    default_endpoint = MapsPlatformDatasetsV1AlphaClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = MapsPlatformDatasetsV1AlphaClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert MapsPlatformDatasetsV1AlphaClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert MapsPlatformDatasetsV1AlphaClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == MapsPlatformDatasetsV1AlphaClient.DEFAULT_MTLS_ENDPOINT
    assert MapsPlatformDatasetsV1AlphaClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert MapsPlatformDatasetsV1AlphaClient._get_api_endpoint(None, None, default_universe, "always") == MapsPlatformDatasetsV1AlphaClient.DEFAULT_MTLS_ENDPOINT
    assert MapsPlatformDatasetsV1AlphaClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == MapsPlatformDatasetsV1AlphaClient.DEFAULT_MTLS_ENDPOINT
    assert MapsPlatformDatasetsV1AlphaClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert MapsPlatformDatasetsV1AlphaClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        MapsPlatformDatasetsV1AlphaClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert MapsPlatformDatasetsV1AlphaClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert MapsPlatformDatasetsV1AlphaClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert MapsPlatformDatasetsV1AlphaClient._get_universe_domain(None, None) == MapsPlatformDatasetsV1AlphaClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (MapsPlatformDatasetsV1AlphaClient, transports.MapsPlatformDatasetsV1AlphaGrpcTransport, "grpc"),
    (MapsPlatformDatasetsV1AlphaClient, transports.MapsPlatformDatasetsV1AlphaRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (MapsPlatformDatasetsV1AlphaClient, transports.MapsPlatformDatasetsV1AlphaGrpcTransport, "grpc"),
    (MapsPlatformDatasetsV1AlphaAsyncClient, transports.MapsPlatformDatasetsV1AlphaGrpcAsyncIOTransport, "grpc_asyncio"),
    (MapsPlatformDatasetsV1AlphaClient, transports.MapsPlatformDatasetsV1AlphaRestTransport, "rest"),
])
@mock.patch.object(MapsPlatformDatasetsV1AlphaClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsV1AlphaClient))
@mock.patch.object(MapsPlatformDatasetsV1AlphaAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsV1AlphaAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (MapsPlatformDatasetsV1AlphaClient, transports.MapsPlatformDatasetsV1AlphaGrpcTransport, "grpc", "true"),
    (MapsPlatformDatasetsV1AlphaAsyncClient, transports.MapsPlatformDatasetsV1AlphaGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (MapsPlatformDatasetsV1AlphaClient, transports.MapsPlatformDatasetsV1AlphaGrpcTransport, "grpc", "false"),
    (MapsPlatformDatasetsV1AlphaAsyncClient, transports.MapsPlatformDatasetsV1AlphaGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (MapsPlatformDatasetsV1AlphaClient, transports.MapsPlatformDatasetsV1AlphaRestTransport, "rest", "true"),
    (MapsPlatformDatasetsV1AlphaClient, transports.MapsPlatformDatasetsV1AlphaRestTransport, "rest", "false"),
])
@mock.patch.object(MapsPlatformDatasetsV1AlphaClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsV1AlphaClient))
@mock.patch.object(MapsPlatformDatasetsV1AlphaAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsV1AlphaAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (MapsPlatformDatasetsV1AlphaClient, transports.MapsPlatformDatasetsV1AlphaGrpcTransport, "grpc", grpc_helpers),
    (MapsPlatformDatasetsV1AlphaAsyncClient, transports.MapsPlatformDatasetsV1AlphaGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (MapsPlatformDatasetsV1AlphaClient, transports.MapsPlatformDatasetsV1AlphaRestTransport, "rest", None),
])
...
def test_list_dataset_versions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_dataset_versions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_dataset_versions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_dataset_versions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MapsPlatformDatasetsV1AlphaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_dataset_versions in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_dataset_versions] = mock_object
...
def test_delete_dataset_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_dataset_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_dataset_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_dataset_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MapsPlatformDatasetsV1AlphaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_dataset_version in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_dataset_version] = mock_object
...
def test_create_dataset_rest_interceptors(null_interceptor):
    transport = transports.MapsPlatformDatasetsV1AlphaRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MapsPlatformDatasetsV1AlphaRestInterceptor(),
        )
    client = MapsPlatformDatasetsV1AlphaClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "post_create_dataset") as post, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "pre_create_dataset") as pre:
...
def test_update_dataset_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "post_update_dataset_metadata") as post, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "pre_update_dataset_metadata") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "post_get_dataset") as post, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "pre_get_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_dataset_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "post_list_dataset_versions") as post, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "pre_list_dataset_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_datasets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "post_list_datasets") as post, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "pre_list_datasets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "pre_delete_dataset") as pre:
        pre.assert_not_called()
...
def test_delete_dataset_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MapsPlatformDatasetsV1AlphaRestInterceptor, "pre_delete_dataset_version") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.MapsPlatformDatasetsV1AlphaGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
@pytest.mark.parametrize("client_class,transport_class", [
    (MapsPlatformDatasetsV1AlphaClient, transports.MapsPlatformDatasetsV1AlphaGrpcTransport),
    (MapsPlatformDatasetsV1AlphaAsyncClient, transports.MapsPlatformDatasetsV1AlphaGrpcAsyncIOTransport),
])

...
# [START mapsplatformdatasets_v1alpha_generated_MapsPlatformDatasetsV1Alpha_GetDataset_async]
...
async def sample_get_dataset():
    ...
    request = mapsplatformdatasets_v1alpha.GetDatasetRequest(
        name="name_value",
    )
...
# [END mapsplatformdatasets_v1alpha_generated_MapsPlatformDatasetsV1Alpha_GetDataset_async]

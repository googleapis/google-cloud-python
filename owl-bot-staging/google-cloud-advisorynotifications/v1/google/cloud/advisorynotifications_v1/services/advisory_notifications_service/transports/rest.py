...
class AdvisoryNotificationsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_notification(self, request: service.GetNotificationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.GetNotificationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_notification_with_metadata(self, response: service.Notification, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.Notification, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_notification
    ...
    def pre_get_settings(self, request: service.GetSettingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.GetSettingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_settings_with_metadata(self, response: service.Settings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.Settings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_settings
    ...
    def pre_list_notifications(self, request: service.ListNotificationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.ListNotificationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_notifications_with_metadata(self, response: service.ListNotificationsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.ListNotificationsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_notifications
    ...
    def pre_update_settings(self, request: service.UpdateSettingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.UpdateSettingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_settings_with_metadata(self, response: service.Settings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.Settings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_settings
...
class AdvisoryNotificationsServiceRestTransport(_BaseAdvisoryNotificationsServiceRestTransport):
    ...
    class _GetNotification(_BaseAdvisoryNotificationsServiceRestTransport._BaseGetNotification, AdvisoryNotificationsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AdvisoryNotificationsServiceRestTransport._GetNotification._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetSettings(_BaseAdvisoryNotificationsServiceRestTransport._BaseGetSettings, AdvisoryNotificationsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AdvisoryNotificationsServiceRestTransport._GetSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListNotifications(_BaseAdvisoryNotificationsServiceRestTransport._BaseListNotifications, AdvisoryNotificationsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AdvisoryNotificationsServiceRestTransport._ListNotifications._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateSettings(_BaseAdvisoryNotificationsServiceRestTransport._BaseUpdateSettings, AdvisoryNotificationsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AdvisoryNotificationsServiceRestTransport._UpdateSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

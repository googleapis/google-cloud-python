...
from .transports.base import AdvisoryNotificationsServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import AdvisoryNotificationsServiceGrpcTransport
from .transports.grpc_asyncio import AdvisoryNotificationsServiceGrpcAsyncIOTransport
from .transports.rest import AdvisoryNotificationsServiceRestTransport


class AdvisoryNotificationsServiceClientMeta(type):
    """Metaclass for the AdvisoryNotificationsService client.
...
class AdvisoryNotificationsServiceClient(metaclass=AdvisoryNotificationsServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "advisorynotifications.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AdvisoryNotificationsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> AdvisoryNotificationsServiceTransport:
        ...
        Returns:
            AdvisoryNotificationsServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def notification_path(organization: str,location: str,notification: str,) -> str:
        """Returns a fully-qualified notification string."""
        return "organizations/{organization}/locations/{location}/notifications/{notification}".format(organization=organization, location=location, notification=notification, )

    @staticmethod
    def parse_notification_path(path: str) -> Dict[str,str]:
        """Parses a notification path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/notifications/(?P<notification>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def settings_path(organization: str,location: str,) -> str:
        """Returns a fully-qualified settings string."""
        return "organizations/{organization}/locations/{location}/settings".format(organization=organization, location=location, )

    @staticmethod
    def parse_settings_path(path: str) -> Dict[str,str]:
        """Parses a settings path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/settings$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = AdvisoryNotificationsServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = AdvisoryNotificationsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AdvisoryNotificationsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = AdvisoryNotificationsServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AdvisoryNotificationsServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AdvisoryNotificationsServiceTransport, Callable[..., AdvisoryNotificationsServiceTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,AdvisoryNotificationsServiceTransport,Callable[..., AdvisoryNotificationsServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the AdvisoryNotificationsServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AdvisoryNotificationsServiceClient._read_environment_variables()
        self._client_cert_source = AdvisoryNotificationsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AdvisoryNotificationsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, AdvisoryNotificationsServiceTransport)
        if transport_provided:
            # transport is a AdvisoryNotificationsServiceTransport instance.
            ...
            self._transport = cast(AdvisoryNotificationsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            AdvisoryNotificationsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AdvisoryNotificationsServiceTransport], Callable[..., AdvisoryNotificationsServiceTransport]] = (
                type(self).get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AdvisoryNotificationsServiceTransport], transport)
            )
    ...
    def list_notifications(self,
        ...
        Args:
            request (Union[google.cloud.advisorynotifications_v1.types.ListNotificationsRequest, dict]):
        ...
        if not isinstance(request, service.ListNotificationsRequest):
    ...
    def get_notification(self,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.GetNotificationRequest):
    ...
    def get_settings(self,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.GetSettingsRequest):
    ...
    def update_settings(self,
        ...
        Args:
            request (Union[google.cloud.advisorynotifications_v1.types.UpdateSettingsRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.UpdateSettingsRequest):
    ...
    def __enter__(self) -> "AdvisoryNotificationsServiceClient":
        return self

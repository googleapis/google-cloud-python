...
class AdvisoryNotificationsServiceClient(metaclass=AdvisoryNotificationsServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AdvisoryNotificationsServiceTransport]] = None,
    ...
    def list_notifications(self,
        ...
        # in a service.ListNotificationsRequest.
    ...
    def get_notification(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.GetNotificationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_settings(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.GetSettingsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_settings(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.UpdateSettingsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

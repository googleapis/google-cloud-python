...
from .base import AdvisoryNotificationsServiceTransport, DEFAULT_CLIENT_INFO
...
class AdvisoryNotificationsServiceGrpcAsyncIOTransport(AdvisoryNotificationsServiceTransport):
    """gRPC AsyncIO backend transport for AdvisoryNotificationsService.
    ...
    def list_notifications(self) -> Callable[
            ...
            Awaitable[service.ListNotificationsResponse]]:
        ...
        if 'list_notifications' not in self._stubs:
            self._stubs['list_notifications'] = self._logged_channel.unary_unary(
                '/google.cloud.advisorynotifications.v1.AdvisoryNotificationsService/ListNotifications',
                request_serializer=service.ListNotificationsRequest.serialize,
                response_deserializer=service.ListNotificationsResponse.deserialize,
            )
    ...
    def get_notification(self) -> Callable[
            ...
            Awaitable[service.Notification]]:
        ...
        if 'get_notification' not in self._stubs:
            self._stubs['get_notification'] = self._logged_channel.unary_unary(
                '/google.cloud.advisorynotifications.v1.AdvisoryNotificationsService/GetNotification',
                request_serializer=service.GetNotificationRequest.serialize,
                response_deserializer=service.Notification.deserialize,
            )
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_notifications: self._wrap_method(
            ...
            self.get_notification: self._wrap_method(

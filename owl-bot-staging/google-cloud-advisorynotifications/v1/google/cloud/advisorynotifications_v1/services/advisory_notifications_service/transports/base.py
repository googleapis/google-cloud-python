...
class AdvisoryNotificationsServiceTransport(abc.ABC):
    """Abstract transport class for AdvisoryNotificationsService."""

    AUTH_SCOPES = (
        'https://www.googleapis.com/auth/cloud-platform',
    )

    DEFAULT_HOST: str = 'advisorynotifications.googleapis.com'
    def __init__(
            self, *,

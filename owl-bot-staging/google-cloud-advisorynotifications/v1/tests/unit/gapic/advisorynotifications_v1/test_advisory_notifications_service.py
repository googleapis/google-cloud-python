...
from google.cloud.advisorynotifications_v1.services.advisory_notifications_service import AdvisoryNotificationsServiceAsyncClient
from google.cloud.advisorynotifications_v1.services.advisory_notifications_service import AdvisoryNotificationsServiceClient
from google.cloud.advisorynotifications_v1.services.advisory_notifications_service import pagers
from google.cloud.advisorynotifications_v1.services.advisory_notifications_service import transports
...
def test__read_environment_variables():
    assert AdvisoryNotificationsServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert AdvisoryNotificationsServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        with pytest.raises(ValueError) as excinfo:
            AdvisoryNotificationsServiceClient._read_environment_variables()
    assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert AdvisoryNotificationsServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert AdvisoryNotificationsServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert AdvisoryNotificationsServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert AdvisoryNotificationsServiceClient._get_client_cert_source(None, False) is None
    assert AdvisoryNotificationsServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AdvisoryNotificationsServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert AdvisoryNotificationsServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AdvisoryNotificationsServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(AdvisoryNotificationsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdvisoryNotificationsServiceClient))
@mock.patch.object(AdvisoryNotificationsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdvisoryNotificationsServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AdvisoryNotificationsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = AdvisoryNotificationsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AdvisoryNotificationsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AdvisoryNotificationsServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert AdvisoryNotificationsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AdvisoryNotificationsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert AdvisoryNotificationsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AdvisoryNotificationsServiceClient._get_api_endpoint(None, None, default_universe, "always") == AdvisoryNotificationsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert AdvisoryNotificationsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AdvisoryNotificationsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert AdvisoryNotificationsServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AdvisoryNotificationsServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AdvisoryNotificationsServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AdvisoryNotificationsServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AdvisoryNotificationsServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AdvisoryNotificationsServiceClient._get_universe_domain(None, None) == AdvisoryNotificationsServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_name", [
    (AdvisoryNotificationsServiceClient, "grpc"),
    (AdvisoryNotificationsServiceAsyncClient, "grpc_asyncio"),
    (AdvisoryNotificationsServiceClient, "rest"),
])
def test_advisory_notifications_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        assert client.transport._host == (
            'advisorynotifications.googleapis.com:443'
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.AdvisoryNotificationsServiceGrpcTransport, "grpc"),
    (transports.AdvisoryNotificationsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (transports.AdvisoryNotificationsServiceRestTransport, "rest"),
])
...
def test_advisory_notifications_service_client_get_transport_class():
    ...
    available_transports = [
        transports.AdvisoryNotificationsServiceGrpcTransport,
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (AdvisoryNotificationsServiceClient, transports.AdvisoryNotificationsServiceGrpcTransport, "grpc"),
    (AdvisoryNotificationsServiceAsyncClient, transports.AdvisoryNotificationsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (AdvisoryNotificationsServiceClient, transports.AdvisoryNotificationsServiceRestTransport, "rest"),
])
@mock.patch.object(AdvisoryNotificationsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdvisoryNotificationsServiceClient))
@mock.patch.object(AdvisoryNotificationsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdvisoryNotificationsServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (AdvisoryNotificationsServiceClient, transports.AdvisoryNotificationsServiceGrpcTransport, "grpc", "true"),
    (AdvisoryNotificationsServiceAsyncClient, transports.AdvisoryNotificationsServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (AdvisoryNotificationsServiceClient, transports.AdvisoryNotificationsServiceGrpcTransport, "grpc", "false"),
    (AdvisoryNotificationsServiceAsyncClient, transports.AdvisoryNotificationsServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (AdvisoryNotificationsServiceClient, transports.AdvisoryNotificationsServiceRestTransport, "rest", "true"),
    (AdvisoryNotificationsServiceClient, transports.AdvisoryNotificationsServiceRestTransport, "rest", "false"),
])
@mock.patch.object(AdvisoryNotificationsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdvisoryNotificationsServiceClient))
@mock.patch.object(AdvisoryNotificationsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdvisoryNotificationsServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    AdvisoryNotificationsServiceClient, AdvisoryNotificationsServiceAsyncClient
])
...
@mock.patch.object(AdvisoryNotificationsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdvisoryNotificationsServiceClient))
@mock.patch.object(AdvisoryNotificationsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdvisoryNotificationsServiceAsyncClient))
def test_advisory_notifications_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (AdvisoryNotificationsServiceClient, transports.AdvisoryNotificationsServiceGrpcTransport, "grpc", grpc_helpers),
    (AdvisoryNotificationsServiceAsyncClient, transports.AdvisoryNotificationsServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (AdvisoryNotificationsServiceClient, transports.AdvisoryNotificationsServiceRestTransport, "rest", None),
])
...
def test_advisory_notifications_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    ...
    with mock.patch.object(
        ...
        create_channel.assert_called_with(
            ...
            scopes=None,
            default_host="advisorynotifications.googleapis.com",
...
def test_list_notifications_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_notifications in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_notifications] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_notifications_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_notifications in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_notifications] = mock_rpc
...
def test_list_notifications_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_notifications(request={}, retry=retry, timeout=timeout)
        ...
        assert all(isinstance(i, service.Notification)
                   for i in results)
...
def test_get_notification_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_notification in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_notification] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_notification_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AdvisoryNotificationsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_notification in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_notification] = mock_rpc
...
def test_list_notifications_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AdvisoryNotificationsServiceClient(
...
def test_get_notification_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AdvisoryNotificationsServiceClient(
...
def test_credentials_transport_error():
    ...
    transport = transports.AdvisoryNotificationsServiceGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = AdvisoryNotificationsServiceClient(
...
def test_transport_get_channel():
    ...
    transport = transports.AdvisoryNotificationsServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_list_notifications_empty_call_grpc():
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.ListNotificationsResponse()
        client.list_notifications(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_notification_empty_call_grpc():
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.Notification()
        client.get_notification(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = AdvisoryNotificationsServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_notifications_empty_call_grpc_asyncio():
    client = AdvisoryNotificationsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_notifications(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_notification_empty_call_grpc_asyncio():
    client = AdvisoryNotificationsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_notification(request=None)
...
def test_transport_kind_rest():
    transport = AdvisoryNotificationsServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_notifications_rest_bad_request(request_type=service.ListNotificationsRequest):
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_notifications_rest_call_success(request_type):
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_notifications_rest_interceptors(null_interceptor):
    transport = transports.AdvisoryNotificationsServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.AdvisoryNotificationsServiceRestInterceptor(),
        )
    client = AdvisoryNotificationsServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_list_notifications") as post, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_list_notifications_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "pre_list_notifications") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListNotificationsResponse.to_json(service.ListNotificationsResponse())
...
def test_get_notification_rest_call_success(request_type):
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_notification_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_get_notification") as post, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_get_notification_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "pre_get_notification") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_get_settings") as post, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_get_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "pre_get_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_update_settings") as post, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_update_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "pre_update_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_notifications_empty_call_rest():
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_notification_empty_call_rest():
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [
        (transports.AdvisoryNotificationsServiceGrpcTransport, grpc_helpers),
        (transports.AdvisoryNotificationsServiceGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_advisory_notifications_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_advisory_notifications_service_host_no_port(transport_name):
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='advisorynotifications.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'advisorynotifications.googleapis.com:443'
        if transport_name in ['grpc', 'grpc_asyncio']
        else 'https://advisorynotifications.googleapis.com'
    )
...
def test_advisory_notifications_service_host_with_port(transport_name):
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='advisorynotifications.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
        'advisorynotifications.googleapis.com:8000'
        if transport_name in ['grpc', 'grpc_asyncio']
        else 'https://advisorynotifications.googleapis.com:8000'
    )
...
def test_advisory_notifications_service_client_transport_session_collision(transport_name):
    ...
    client1 = AdvisoryNotificationsServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = AdvisoryNotificationsServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("transport_class", [transports.AdvisoryNotificationsServiceGrpcTransport, transports.AdvisoryNotificationsServiceGrpcAsyncIOTransport])
def test_advisory_notifications_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
@pytest.mark.parametrize("client_class,transport_class", [
    (AdvisoryNotificationsServiceClient, transports.AdvisoryNotificationsServiceGrpcTransport),
    (AdvisoryNotificationsServiceAsyncClient, transports.AdvisoryNotificationsServiceGrpcAsyncIOTransport),
])

...
def test_list_notifications_rest_required_fields(request_type=service.ListNotificationsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_notifications._get_unset_required_fields(jsonified_request)
...
def test_list_notifications_rest_unset_required_fields():
    transport = transports.AdvisoryNotificationsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_notification_rest_required_fields(request_type=service.GetNotificationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_notification._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_settings_rest_required_fields(request_type=service.GetSettingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_settings_rest_required_fields(request_type=service.UpdateSettingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

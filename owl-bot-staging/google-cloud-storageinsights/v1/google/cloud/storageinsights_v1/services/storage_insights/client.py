...
from .transports.base import StorageInsightsTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import StorageInsightsGrpcTransport
from .transports.grpc_asyncio import StorageInsightsGrpcAsyncIOTransport
from .transports.rest import StorageInsightsRestTransport


class StorageInsightsClientMeta(type):
    """Metaclass for the StorageInsights client.
...
class StorageInsightsClient(metaclass=StorageInsightsClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "storageinsights.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            StorageInsightsClient: The constructed client.
        """
    ...
    def transport(self) -> StorageInsightsTransport:
        ...
        Returns:
            StorageInsightsTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def dataset_config_path(project: str,location: str,dataset_config: str,) -> str:
        """Returns a fully-qualified dataset_config string."""
        return "projects/{project}/locations/{location}/datasetConfigs/{dataset_config}".format(project=project, location=location, dataset_config=dataset_config, )

    @staticmethod
    def parse_dataset_config_path(path: str) -> Dict[str,str]:
        """Parses a dataset_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/datasetConfigs/(?P<dataset_config>.+?)$", path)
    ...
    @staticmethod
    def report_detail_path(project: str,location: str,report_config: str,report_detail: str,) -> str:
        """Returns a fully-qualified report_detail string."""
        return "projects/{project}/locations/{location}/reportConfigs/{report_config}/reportDetails/{report_detail}".format(project=project, location=location, report_config=report_config, report_detail=report_detail, )

    @staticmethod
    def parse_report_detail_path(path: str) -> Dict[str,str]:
        """Parses a report_detail path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/reportConfigs/(?P<report_config>.+?)/reportDetails/(?P<report_detail>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = StorageInsightsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = StorageInsightsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = StorageInsightsClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, StorageInsightsTransport, Callable[..., StorageInsightsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = StorageInsightsClient._read_environment_variables()
        self._client_cert_source = StorageInsightsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = StorageInsightsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, StorageInsightsTransport)
        if transport_provided:
            # transport is a StorageInsightsTransport instance.
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[StorageInsightsTransport], Callable[..., StorageInsightsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.storageinsights_v1.StorageInsightsClient`.",
                    extra = {
    ...
    def list_report_configs(self,
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.ListReportConfigsRequest, dict]):
    ...
    def get_report_config(self,
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.GetReportConfigRequest, dict]):
    ...
    def create_report_config(self,
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.CreateReportConfigRequest, dict]):
    ...
    def update_report_config(self,
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.UpdateReportConfigRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_report_config]
    ...
    def delete_report_config(self,
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.DeleteReportConfigRequest, dict]):
    ...
    def list_report_details(self,
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.ListReportDetailsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_report_details]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListReportDetailsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_report_detail(self,
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.GetReportDetailRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_report_detail]
    ...
    def list_dataset_configs(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListDatasetConfigsPager:
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.ListDatasetConfigsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_dataset_configs]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListDatasetConfigsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_dataset_config(self,
        ...
        .. code-block:: python
            ...
            def sample_get_dataset_config():
                ...
                # Make the request
                response = client.get_dataset_config(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.storageinsights_v1.types.GetDatasetConfigRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_dataset_config]
    ...
    def create_dataset_config(self,
        ...
        .. code-block:: python
            ...
            def sample_create_dataset_config():
                # Create a client
                client = storageinsights_v1.StorageInsightsClient()
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.CreateDatasetConfigRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_dataset_config]
    ...
    def update_dataset_config(self,
        ...
        .. code-block:: python
            ...
            def sample_update_dataset_config():
                # Create a client
                client = storageinsights_v1.StorageInsightsClient()
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.UpdateDatasetConfigRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_dataset_config]
    ...
    def delete_dataset_config(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_dataset_config():
                # Create a client
                client = storageinsights_v1.StorageInsightsClient()
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.DeleteDatasetConfigRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_dataset_config]
    ...
    def link_dataset(self,
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.LinkDatasetRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.link_dataset]
    ...
    def unlink_dataset(self,
        ...
        Args:
            request (Union[google.cloud.storageinsights_v1.types.UnlinkDatasetRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.unlink_dataset]
    ...
    def __enter__(self) -> "StorageInsightsClient":
        return self

...
class StorageInsightsTransport(abc.ABC):
    """Abstract transport class for StorageInsights."""

    AUTH_SCOPES = (
        'https://www.googleapis.com/auth/cloud-platform',
    )

    DEFAULT_HOST: str = 'storageinsights.googleapis.com'
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.update_report_config: gapic_v1.method.wrap_method(
            ...
            self.list_report_details: gapic_v1.method.wrap_method(
            ...
            self.get_report_detail: gapic_v1.method.wrap_method(
                self.get_report_detail,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=60.0,
                    multiplier=1.3,
    ...
    @property
    def list_report_configs(self) -> Callable[
            [storageinsights.ListReportConfigsRequest],
            Union[
                storageinsights.ListReportConfigsResponse,
                Awaitable[storageinsights.ListReportConfigsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_report_config(self) -> Callable[
            [storageinsights.GetReportConfigRequest],
            Union[
                storageinsights.ReportConfig,
                Awaitable[storageinsights.ReportConfig]
            ]]:
        raise NotImplementedError()

    @property
    def create_report_config(self) -> Callable[
    ...
    @property
    def update_report_config(self) -> Callable[
    ...
    @property
    def delete_report_config(self) -> Callable[
    ...
    @property
    def list_report_details(self) -> Callable[
            [storageinsights.ListReportDetailsRequest],
            Union[
                storageinsights.ListReportDetailsResponse,
                Awaitable[storageinsights.ListReportDetailsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_report_detail(self) -> Callable[
            [storageinsights.GetReportDetailRequest],
            Union[
                storageinsights.ReportDetail,
                Awaitable[storageinsights.ReportDetail]
            ]]:
        raise NotImplementedError()

    @property
    def list_dataset_configs(self) -> Callable[
    ...
    @property
    def get_dataset_config(self) -> Callable[
            [storageinsights.GetDatasetConfigRequest],
            Union[
                storageinsights.DatasetConfig,
                Awaitable[storageinsights.DatasetConfig]
            ]]:
        raise NotImplementedError()

    @property
    def create_dataset_config(self) -> Callable[
    ...
    @property
    def update_dataset_config(self) -> Callable[
    ...
    @property
    def delete_dataset_config(self) -> Callable[
    ...
    @property
    def link_dataset(self) -> Callable[
    ...
    @property
    def unlink_dataset(self) -> Callable[

...
class StorageInsightsAsyncClient:
    ...
    async def update_report_config(self,
    ...
    async def list_report_details(self,
    ...
    async def list_dataset_configs(self,
    ...
    async def get_dataset_config(self,
    ...
    async def create_dataset_config(self,
    ...
    async def update_dataset_config(self,
    ...
    async def delete_dataset_config(self,

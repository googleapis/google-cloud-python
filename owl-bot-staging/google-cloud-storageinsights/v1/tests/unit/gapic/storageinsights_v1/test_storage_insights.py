...
def test_list_report_configs_rest_required_fields(request_type=storageinsights.ListReportConfigsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_report_configs._get_unset_required_fields(jsonified_request)
...
def test_get_report_config_rest_required_fields(request_type=storageinsights.GetReportConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_report_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_report_config_rest_required_fields(request_type=storageinsights.CreateReportConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_report_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_report_config_rest_required_fields(request_type=storageinsights.UpdateReportConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_report_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_report_config_rest_required_fields(request_type=storageinsights.DeleteReportConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_report_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_report_details_rest_required_fields(request_type=storageinsights.ListReportDetailsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_report_details._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_report_detail_rest_required_fields(request_type=storageinsights.GetReportDetailRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_report_detail._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

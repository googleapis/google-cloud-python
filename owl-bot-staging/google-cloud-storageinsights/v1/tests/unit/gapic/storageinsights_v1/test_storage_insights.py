...
from google.cloud.storageinsights_v1.services.storage_insights import StorageInsightsAsyncClient
from google.cloud.storageinsights_v1.services.storage_insights import StorageInsightsClient
from google.cloud.storageinsights_v1.services.storage_insights import pagers
from google.cloud.storageinsights_v1.services.storage_insights import transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert StorageInsightsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert StorageInsightsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert StorageInsightsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert StorageInsightsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert StorageInsightsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert StorageInsightsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert StorageInsightsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert StorageInsightsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(StorageInsightsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StorageInsightsClient))
@mock.patch.object(StorageInsightsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StorageInsightsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = StorageInsightsClient._DEFAULT_UNIVERSE
    default_endpoint = StorageInsightsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = StorageInsightsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert StorageInsightsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert StorageInsightsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == StorageInsightsClient.DEFAULT_MTLS_ENDPOINT
    assert StorageInsightsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert StorageInsightsClient._get_api_endpoint(None, None, default_universe, "always") == StorageInsightsClient.DEFAULT_MTLS_ENDPOINT
    assert StorageInsightsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == StorageInsightsClient.DEFAULT_MTLS_ENDPOINT
    assert StorageInsightsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert StorageInsightsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        StorageInsightsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert StorageInsightsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert StorageInsightsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert StorageInsightsClient._get_universe_domain(None, None) == StorageInsightsClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (StorageInsightsAsyncClient, transports.StorageInsightsGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (StorageInsightsClient, transports.StorageInsightsGrpcTransport, "grpc", "true"),
    (StorageInsightsAsyncClient, transports.StorageInsightsGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (StorageInsightsClient, transports.StorageInsightsGrpcTransport, "grpc", "false"),
    (StorageInsightsAsyncClient, transports.StorageInsightsGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (StorageInsightsClient, transports.StorageInsightsRestTransport, "rest", "true"),
    (StorageInsightsClient, transports.StorageInsightsRestTransport, "rest", "false"),
])
@mock.patch.object(StorageInsightsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StorageInsightsClient))
@mock.patch.object(StorageInsightsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StorageInsightsAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    StorageInsightsClient, StorageInsightsAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (StorageInsightsClient, transports.StorageInsightsGrpcTransport, "grpc", grpc_helpers),
    (StorageInsightsAsyncClient, transports.StorageInsightsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_list_report_configs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_report_configs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_report_configs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_report_configs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_report_configs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_report_configs] = mock_rpc
...
def test_list_report_configs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, storageinsights.ReportConfig)
                   for i in results)
...
def test_get_report_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_report_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_report_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_report_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_report_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_report_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_report_config] = mock_rpc
...
def test_create_report_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_report_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storageinsights.ReportConfig(
            name='name_value',
...
def test_create_report_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_report_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_report_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_report_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_report_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_report_config] = mock_rpc
...
def test_update_report_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_report_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storageinsights.ReportConfig(
            name='name_value',
...
def test_update_report_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_report_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_report_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_report_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_report_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_report_config] = mock_rpc
...
def test_delete_report_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_report_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_report_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_report_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_report_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_report_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_report_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_report_config] = mock_rpc
...
def test_list_report_details_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_report_details in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_report_details] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_report_details_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_report_details in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_report_details] = mock_rpc
...
def test_list_report_details_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, storageinsights.ReportDetail)
                   for i in results)
...
def test_get_report_detail(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_report_detail),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_report_detail_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_report_detail] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_report_detail_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_report_detail in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_report_detail] = mock_rpc
...
def test_list_dataset_configs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_dataset_configs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_dataset_configs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_dataset_configs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_dataset_configs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_dataset_configs] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_dataset_configs_async(transport: str = 'grpc_asyncio', request_type=storageinsights.ListDatasetConfigsRequest):
    client = StorageInsightsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(storageinsights.ListDatasetConfigsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_dataset_configs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, storageinsights.DatasetConfig)
                   for i in results)
...
async def test_list_dataset_configs_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_dataset_configs(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_dataset_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_dataset_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.dataset_config_state == storageinsights.DatasetConfig.ConfigState.CONFIG_STATE_ACTIVE
...
def test_get_dataset_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_dataset_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_dataset_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_dataset_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_dataset_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_dataset_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_dataset_config_async(transport: str = 'grpc_asyncio', request_type=storageinsights.GetDatasetConfigRequest):
    client = StorageInsightsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(storageinsights.DatasetConfig(
            name='name_value',
            uid='uid_value',
            organization_number=2045,
            include_newly_created_buckets=True,
...
def test_create_dataset_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_dataset_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_dataset_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_dataset_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_dataset_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_dataset_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_dataset_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_dataset_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_dataset_config_async(transport: str = 'grpc_asyncio', request_type=storageinsights.CreateDatasetConfigRequest):
    client = StorageInsightsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_dataset_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_dataset_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_dataset_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_dataset_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_dataset_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_dataset_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_dataset_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_dataset_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_dataset_config_async(transport: str = 'grpc_asyncio', request_type=storageinsights.UpdateDatasetConfigRequest):
    client = StorageInsightsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_dataset_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_dataset_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_dataset_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_dataset_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_dataset_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_dataset_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_dataset_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_dataset_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_dataset_config_async(transport: str = 'grpc_asyncio', request_type=storageinsights.DeleteDatasetConfigRequest):
    client = StorageInsightsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_link_dataset(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.link_dataset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_link_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.link_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.link_dataset] = mock_rpc
...
@pytest.mark.asyncio
async def test_link_dataset_async(transport: str = 'grpc_asyncio', request_type=storageinsights.LinkDatasetRequest):
    client = StorageInsightsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_unlink_dataset(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.unlink_dataset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_unlink_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageInsightsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.unlink_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.unlink_dataset] = mock_rpc
...
@pytest.mark.asyncio
async def test_unlink_dataset_async(transport: str = 'grpc_asyncio', request_type=storageinsights.UnlinkDatasetRequest):
    client = StorageInsightsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_dataset_configs_rest_required_fields(request_type=storageinsights.ListDatasetConfigsRequest):
    transport_class = transports.StorageInsightsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_dataset_configs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_dataset_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/datasetConfigs" % client.transport._host, args[1])
...
def test_list_dataset_configs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(storageinsights.ListDatasetConfigsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_dataset_config_rest_required_fields(request_type=storageinsights.GetDatasetConfigRequest):
    transport_class = transports.StorageInsightsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_dataset_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_dataset_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/datasetConfigs/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/datasetConfigs/*}" % client.transport._host, args[1])
...
def test_create_dataset_config_rest_required_fields(request_type=storageinsights.CreateDatasetConfigRequest):
    transport_class = transports.StorageInsightsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_dataset_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_dataset_config._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("dataset_config_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_dataset_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("datasetConfigId", "requestId", )) & set(("parent", "datasetConfigId", "datasetConfig", )))
...
def test_update_dataset_config_rest_required_fields(request_type=storageinsights.UpdateDatasetConfigRequest):
    transport_class = transports.StorageInsightsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_dataset_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_dataset_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("updateMask", "datasetConfig", )))
...
def test_update_dataset_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'dataset_config': {'name': 'projects/sample1/locations/sample2/datasetConfigs/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{dataset_config.name=projects/*/locations/*/datasetConfigs/*}" % client.transport._host, args[1])
...
def test_delete_dataset_config_rest_required_fields(request_type=storageinsights.DeleteDatasetConfigRequest):
    transport_class = transports.StorageInsightsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_dataset_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_link_dataset_rest_required_fields(request_type=storageinsights.LinkDatasetRequest):
    transport_class = transports.StorageInsightsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).link_dataset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_link_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/datasetConfigs/*}:linkDataset" % client.transport._host, args[1])
...
def test_unlink_dataset_rest_required_fields(request_type=storageinsights.UnlinkDatasetRequest):
    transport_class = transports.StorageInsightsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).unlink_dataset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_unlink_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/datasetConfigs/*}:unlinkDataset" % client.transport._host, args[1])
...
def test_list_report_configs_rest_bad_request(request_type=storageinsights.ListReportConfigsRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_report_configs_rest_interceptors(null_interceptor):
    transport = transports.StorageInsightsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.StorageInsightsRestInterceptor(),
        )
    client = StorageInsightsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_list_report_configs") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_list_report_configs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_list_report_configs") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = storageinsights.ListReportConfigsResponse.to_json(storageinsights.ListReportConfigsResponse())
        ...
        post_with_metadata.return_value = storageinsights.ListReportConfigsResponse(), metadata
...
def test_get_report_config_rest_bad_request(request_type=storageinsights.GetReportConfigRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_report_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_get_report_config") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_get_report_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_get_report_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = storageinsights.ReportConfig.to_json(storageinsights.ReportConfig())
        req.return_value.content = return_value
...
def test_create_report_config_rest_bad_request(request_type=storageinsights.CreateReportConfigRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_report_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_create_report_config") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_create_report_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_create_report_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_report_config_rest_bad_request(request_type=storageinsights.UpdateReportConfigRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_report_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_update_report_config") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_update_report_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_update_report_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_report_config_rest_bad_request(request_type=storageinsights.DeleteReportConfigRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_report_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_delete_report_config") as pre:
        pre.assert_not_called()
...
def test_list_report_details_rest_bad_request(request_type=storageinsights.ListReportDetailsRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_report_details_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_list_report_details") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_list_report_details_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_list_report_details") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = storageinsights.ListReportDetailsResponse.to_json(storageinsights.ListReportDetailsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = storageinsights.ListReportDetailsResponse(), metadata
...
def test_get_report_detail_rest_bad_request(request_type=storageinsights.GetReportDetailRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_report_detail_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_get_report_detail") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_get_report_detail_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_get_report_detail") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = storageinsights.ReportDetail.to_json(storageinsights.ReportDetail())
        req.return_value.content = return_value
...
def test_list_dataset_configs_rest_bad_request(request_type=storageinsights.ListDatasetConfigsRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_dataset_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_list_dataset_configs") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_list_dataset_configs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_list_dataset_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = storageinsights.ListDatasetConfigsRequest.pb(storageinsights.ListDatasetConfigsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = storageinsights.ListDatasetConfigsResponse.to_json(storageinsights.ListDatasetConfigsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = storageinsights.ListDatasetConfigsResponse(), metadata

        client.list_dataset_configs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_dataset_config_rest_bad_request(request_type=storageinsights.GetDatasetConfigRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_dataset_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_get_dataset_config") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_get_dataset_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_get_dataset_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = storageinsights.GetDatasetConfigRequest.pb(storageinsights.GetDatasetConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = storageinsights.DatasetConfig.to_json(storageinsights.DatasetConfig())
        req.return_value.content = return_value
        ...
        client.get_dataset_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_dataset_config_rest_bad_request(request_type=storageinsights.CreateDatasetConfigRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_dataset_config_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["dataset_config"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'uid': 'uid_value', 'organization_number': 2045, 'source_projects': {'project_numbers': [1619, 1620]}, 'source_folders': {'folder_numbers': [1496, 1497]}, 'organization_scope': True, 'cloud_storage_object_path': 'cloud_storage_object_path_value', 'include_cloud_storage_locations': {'locations': ['locations_value1', 'locations_value2']}, 'exclude_cloud_storage_locations': {}, 'include_cloud_storage_buckets': {'cloud_storage_buckets': [{'bucket_name': 'bucket_name_value', 'bucket_prefix_regex': 'bucket_prefix_regex_value'}]}, 'exclude_cloud_storage_buckets': {}, 'include_newly_created_buckets': True, 'skip_verification_and_ingest': True, 'retention_period_days': 2250, 'link': {'dataset': 'dataset_value', 'linked': True}, 'identity': {'name': 'name_value', 'type_': 1}, 'status': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}, 'dataset_config_state': 1, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = storageinsights.CreateDatasetConfigRequest.meta.fields["dataset_config"]
...
def test_create_dataset_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_create_dataset_config") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_create_dataset_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_create_dataset_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = storageinsights.CreateDatasetConfigRequest.pb(storageinsights.CreateDatasetConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_dataset_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_dataset_config_rest_bad_request(request_type=storageinsights.UpdateDatasetConfigRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'dataset_config': {'name': 'projects/sample1/locations/sample2/datasetConfigs/sample3'}}
    request = request_type(**request_init)
...
def test_update_dataset_config_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'dataset_config': {'name': 'projects/sample1/locations/sample2/datasetConfigs/sample3'}}
    request_init["dataset_config"] = {'name': 'projects/sample1/locations/sample2/datasetConfigs/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'uid': 'uid_value', 'organization_number': 2045, 'source_projects': {'project_numbers': [1619, 1620]}, 'source_folders': {'folder_numbers': [1496, 1497]}, 'organization_scope': True, 'cloud_storage_object_path': 'cloud_storage_object_path_value', 'include_cloud_storage_locations': {'locations': ['locations_value1', 'locations_value2']}, 'exclude_cloud_storage_locations': {}, 'include_cloud_storage_buckets': {'cloud_storage_buckets': [{'bucket_name': 'bucket_name_value', 'bucket_prefix_regex': 'bucket_prefix_regex_value'}]}, 'exclude_cloud_storage_buckets': {}, 'include_newly_created_buckets': True, 'skip_verification_and_ingest': True, 'retention_period_days': 2250, 'link': {'dataset': 'dataset_value', 'linked': True}, 'identity': {'name': 'name_value', 'type_': 1}, 'status': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}, 'dataset_config_state': 1, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = storageinsights.UpdateDatasetConfigRequest.meta.fields["dataset_config"]
...
def test_update_dataset_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_update_dataset_config") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_update_dataset_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_update_dataset_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = storageinsights.UpdateDatasetConfigRequest.pb(storageinsights.UpdateDatasetConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_dataset_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_dataset_config_rest_bad_request(request_type=storageinsights.DeleteDatasetConfigRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_dataset_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_delete_dataset_config") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_delete_dataset_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_delete_dataset_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = storageinsights.DeleteDatasetConfigRequest.pb(storageinsights.DeleteDatasetConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_dataset_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_link_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_link_dataset") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_link_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_link_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = storageinsights.LinkDatasetRequest.pb(storageinsights.LinkDatasetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.link_dataset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_unlink_dataset_rest_bad_request(request_type=storageinsights.UnlinkDatasetRequest):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_unlink_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_unlink_dataset") as post, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "post_unlink_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_unlink_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = storageinsights.UnlinkDatasetRequest.pb(storageinsights.UnlinkDatasetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.unlink_dataset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_storage_insights_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_storage_insights_host_no_port(transport_name):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='storageinsights.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'storageinsights.googleapis.com:443'
...
def test_storage_insights_host_with_port(transport_name):
    client = StorageInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='storageinsights.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.StorageInsightsGrpcTransport, transports.StorageInsightsGrpcAsyncIOTransport])
def test_storage_insights_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_dataset_config_path():
    ...
    expected = "projects/{project}/locations/{location}/datasetConfigs/{dataset_config}".format(project=project, location=location, dataset_config=dataset_config, )
    actual = StorageInsightsClient.dataset_config_path(project, location, dataset_config)

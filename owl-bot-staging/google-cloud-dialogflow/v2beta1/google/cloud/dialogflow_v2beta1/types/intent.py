...
class Intent(proto.Message):
    ...
    class Message(proto.Message):
        ...
        class RbmText(proto.Message):
            ...
            rbm_suggestion: MutableSequence['Intent.Message.RbmSuggestion'] = proto.RepeatedField(
                proto.MESSAGE,
                number=2,
        ...
        class RbmCarouselCard(proto.Message):
            ...
            card_contents: MutableSequence['Intent.Message.RbmCardContent'] = proto.RepeatedField(
                proto.MESSAGE,
                number=2,
        ...
        class RbmStandaloneCard(proto.Message):
            ...
            card_orientation: 'Intent.Message.RbmStandaloneCard.CardOrientation' = proto.Field(
                proto.ENUM,
                number=1,
        ...
        class RbmCardContent(proto.Message):
            ...
            suggestions: MutableSequence['Intent.Message.RbmSuggestion'] = proto.RepeatedField(
                proto.MESSAGE,
                number=4,
                message='Intent.Message.RbmSuggestion',
            )
        ...
        class RbmSuggestedAction(proto.Message):
            ...
            dial: 'Intent.Message.RbmSuggestedAction.RbmSuggestedActionDial' = proto.Field(
                proto.MESSAGE,
                number=3,
                oneof='action',
        ...
        telephony_synthesize_speech: 'Intent.Message.TelephonySynthesizeSpeech' = proto.Field(
            proto.MESSAGE,
            number=14,
            oneof='message',

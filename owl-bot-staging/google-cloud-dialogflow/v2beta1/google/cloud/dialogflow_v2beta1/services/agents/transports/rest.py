...
class AgentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get_validation_result(self, request: agent.GetValidationResultRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.GetValidationResultRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_import_agent(self, request: agent.ImportAgentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.ImportAgentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_search_agents(self, request: agent.SearchAgentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.SearchAgentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_agent(self, request: gcd_agent.SetAgentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_agent.SetAgentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_train_agent(self, request: agent.TrainAgentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.TrainAgentRequest, Sequence[Tuple[str, str]]]:

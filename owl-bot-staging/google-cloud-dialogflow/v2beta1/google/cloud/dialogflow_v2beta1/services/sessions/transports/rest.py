...
class SessionsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_detect_intent(self, request: gcd_session.DetectIntentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_session.DetectIntentRequest, Sequence[Tuple[str, str]]]:

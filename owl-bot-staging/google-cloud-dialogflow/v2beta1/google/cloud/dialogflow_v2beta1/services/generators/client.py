...
class GeneratorsClient(metaclass=GeneratorsClientMeta):
    ...
    @staticmethod
    def generator_path(project: str,location: str,generator: str,) -> str:
        """Returns a fully-qualified generator string."""
        return "projects/{project}/locations/{location}/generators/{generator}".format(project=project, location=location, generator=generator, )
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow_v2beta1.GeneratorsClient`.",
                    extra = {
    ...
    def create_generator(self,
        ...
        flattened_params = [parent, generator, generator_id]

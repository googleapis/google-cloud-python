...
class FulfillmentsAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = FulfillmentsClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = FulfillmentsClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, FulfillmentsTransport, Callable[..., FulfillmentsTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow_v2beta1.FulfillmentsAsyncClient`.",
                extra = {
    ...
    async def get_fulfillment(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2beta1.types.GetFulfillmentRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_fulfillment]
    ...
    async def update_fulfillment(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2beta1.types.UpdateFulfillmentRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_fulfillment]
    ...
    async def __aenter__(self) -> "FulfillmentsAsyncClient":
        return self

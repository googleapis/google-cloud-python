...
class EntityTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_create_entities(self, request: entity_type.BatchCreateEntitiesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_type.BatchCreateEntitiesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_batch_delete_entities(self, request: entity_type.BatchDeleteEntitiesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_type.BatchDeleteEntitiesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_batch_delete_entity_types(self, request: entity_type.BatchDeleteEntityTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_type.BatchDeleteEntityTypesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_batch_update_entities(self, request: entity_type.BatchUpdateEntitiesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_type.BatchUpdateEntitiesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_batch_update_entity_types(self, request: entity_type.BatchUpdateEntityTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_type.BatchUpdateEntityTypesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_entity_type(self, request: gcd_entity_type.CreateEntityTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_entity_type.CreateEntityTypeRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_entity_type(self, request: gcd_entity_type.UpdateEntityTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_entity_type.UpdateEntityTypeRequest, Sequence[Tuple[str, str]]]:

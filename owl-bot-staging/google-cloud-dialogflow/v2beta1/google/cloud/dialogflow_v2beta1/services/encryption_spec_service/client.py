...
class EncryptionSpecServiceClient(metaclass=EncryptionSpecServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow_v2beta1.EncryptionSpecServiceClient`.",
                    extra = {
    ...
    def get_encryption_spec(self,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2beta1.types.GetEncryptionSpecRequest, dict]):
    ...
    def initialize_encryption_spec(self,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2beta1.types.InitializeEncryptionSpecRequest, dict]):

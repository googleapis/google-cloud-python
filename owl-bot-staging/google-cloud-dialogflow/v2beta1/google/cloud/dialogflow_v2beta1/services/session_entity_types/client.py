...
class SessionEntityTypesClient(metaclass=SessionEntityTypesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SessionEntityTypesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SessionEntityTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SessionEntityTypesClient._DEFAULT_UNIVERSE
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = SessionEntityTypesClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SessionEntityTypesClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SessionEntityTypesTransport, Callable[..., SessionEntityTypesTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,SessionEntityTypesTransport,Callable[..., SessionEntityTypesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the SessionEntityTypesTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SessionEntityTypesClient._read_environment_variables()
        self._client_cert_source = SessionEntityTypesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SessionEntityTypesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SessionEntityTypesTransport)
        if transport_provided:
            ...
            self._transport = cast(SessionEntityTypesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            SessionEntityTypesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SessionEntityTypesTransport], Callable[..., SessionEntityTypesTransport]] = (
    ...
    def create_session_entity_type(self,
            request: Optional[Union[gcd_session_entity_type.CreateSessionEntityTypeRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_session_entity_type(self,
            request: Optional[Union[gcd_session_entity_type.UpdateSessionEntityTypeRequest, dict]] = None,
            *,
            session_entity_type: Optional[gcd_session_entity_type.SessionEntityType] = None,

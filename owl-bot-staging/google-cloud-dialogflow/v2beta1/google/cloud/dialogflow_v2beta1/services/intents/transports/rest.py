...
class IntentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_delete_intents(self, request: intent.BatchDeleteIntentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[intent.BatchDeleteIntentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_batch_delete_intents_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for batch_delete_intents
    ...
    def pre_batch_update_intents(self, request: intent.BatchUpdateIntentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[intent.BatchUpdateIntentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_batch_update_intents_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for batch_update_intents
    ...
    def pre_create_intent(self, request: gcd_intent.CreateIntentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_intent.CreateIntentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_intent_with_metadata(self, response: gcd_intent.Intent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_intent.Intent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_intent
    ...
    def pre_update_intent(self, request: gcd_intent.UpdateIntentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_intent.UpdateIntentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_intent_with_metadata(self, response: gcd_intent.Intent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_intent.Intent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_intent
...
class IntentsRestTransport(_BaseIntentsRestTransport):
    ...
    class _BatchDeleteIntents(_BaseIntentsRestTransport._BaseBatchDeleteIntents, IntentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = IntentsRestTransport._BatchDeleteIntents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _BatchUpdateIntents(_BaseIntentsRestTransport._BaseBatchUpdateIntents, IntentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = IntentsRestTransport._BatchUpdateIntents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class IntentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_delete_intents(self, request: intent.BatchDeleteIntentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[intent.BatchDeleteIntentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_batch_update_intents(self, request: intent.BatchUpdateIntentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[intent.BatchUpdateIntentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_intent(self, request: gcd_intent.CreateIntentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_intent.CreateIntentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_intent(self, request: gcd_intent.UpdateIntentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_intent.UpdateIntentRequest, Sequence[Tuple[str, str]]]:

...
class ContextsAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ContextsTransport, Callable[..., ContextsTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow_v2beta1.ContextsAsyncClient`.",
                extra = {
    ...
    async def list_contexts(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2beta1.types.ListContextsRequest, dict]]):
    ...
    async def create_context(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2beta1.types.CreateContextRequest, dict]]):
                The request object. The request message for
    ...
    async def update_context(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_context]
    ...
    async def delete_context(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_context]
    ...
    async def delete_all_contexts(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_all_contexts]

...
class _BaseConversationProfilesRestTransport(ConversationProfilesTransport):
    """Base REST backend transport for ConversationProfiles.
    ...
    class _BaseCreateConversationProfile:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseDeleteConversationProfile:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseGetConversationProfile:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseListConversationProfiles:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseSetSuggestionFeatureConfig:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseUpdateConversationProfile:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
...
__all__=(
    '_BaseConversationProfilesRestTransport',
)

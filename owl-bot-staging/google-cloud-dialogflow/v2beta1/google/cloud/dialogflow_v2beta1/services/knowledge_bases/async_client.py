...
class KnowledgeBasesAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = KnowledgeBasesClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = KnowledgeBasesClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, KnowledgeBasesTransport, Callable[..., KnowledgeBasesTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow_v2beta1.KnowledgeBasesAsyncClient`.",
                extra = {
    ...
    async def list_knowledge_bases(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_knowledge_bases]
    ...
    async def get_knowledge_base(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_knowledge_base]
    ...
    async def create_knowledge_base(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_knowledge_base]
    ...
    async def delete_knowledge_base(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_knowledge_base]
    ...
    async def update_knowledge_base(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_knowledge_base]

...
from .transports.rest import ConversationsRestTransport
...
class ConversationsClient(metaclass=ConversationsClientMeta):
    ...
    @staticmethod
    def data_store_path(project: str,location: str,collection: str,data_store: str,) -> str:
        """Returns a fully-qualified data_store string."""
        return "projects/{project}/locations/{location}/collections/{collection}/dataStores/{data_store}".format(project=project, location=location, collection=collection, data_store=data_store, )

    @staticmethod
    def parse_data_store_path(path: str) -> Dict[str,str]:
        """Parses a data_store path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/collections/(?P<collection>.+?)/dataStores/(?P<data_store>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ConversationsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ConversationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ConversationsClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ConversationsTransport, Callable[..., ConversationsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ConversationsClient._read_environment_variables()
        self._client_cert_source = ConversationsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ConversationsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ConversationsTransport)
        if transport_provided:
            ...
            self._transport = cast(ConversationsTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ConversationsTransport], Callable[..., ConversationsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow_v2beta1.ConversationsClient`.",
                    extra = {
    ...
    def ingest_context_references(self,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2beta1.types.IngestContextReferencesRequest, dict]):
                The request object. The request message for
        ...
        if not isinstance(request, gcd_conversation.IngestContextReferencesRequest):
            ...
            if context_references is not None:
                request.context_references = context_references

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.ingest_context_references]
    ...
    def suggest_conversation_summary(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.suggest_conversation_summary]
    ...
    def generate_stateless_summary(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_stateless_summary]
    ...
    def generate_stateless_suggestion(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_stateless_suggestion]
    ...
    def generate_suggestions(self,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2beta1.types.GenerateSuggestionsRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_suggestions]

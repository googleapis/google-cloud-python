...
class ConversationsAsyncClient:
    ...
    async def ingest_context_references(self,
    ...
    async def suggest_conversation_summary(self,
    ...
    async def generate_stateless_summary(self,
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("stateless_conversation.parent", request.stateless_conversation.parent),
            )),
        )
    ...
    async def generate_stateless_suggestion(self,

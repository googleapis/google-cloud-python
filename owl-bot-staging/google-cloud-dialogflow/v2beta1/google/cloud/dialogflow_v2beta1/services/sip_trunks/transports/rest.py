...
class SipTrunksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_sip_trunk(self, request: gcd_sip_trunk.CreateSipTrunkRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_sip_trunk.CreateSipTrunkRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_sip_trunk(self, request: sip_trunk.DeleteSipTrunkRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sip_trunk.DeleteSipTrunkRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_sip_trunk(self, request: sip_trunk.GetSipTrunkRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sip_trunk.GetSipTrunkRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_sip_trunks(self, request: sip_trunk.ListSipTrunksRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[sip_trunk.ListSipTrunksRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_sip_trunk(self, request: gcd_sip_trunk.UpdateSipTrunkRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_sip_trunk.UpdateSipTrunkRequest, Sequence[Tuple[str, str]]]:

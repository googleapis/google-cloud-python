...
class _BaseAnswerRecordsRestTransport(AnswerRecordsTransport):
    """Base REST backend transport for AnswerRecords.
    ...
    class _BaseUpdateAnswerRecord:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAnswerRecordsRestTransport._BaseUpdateAnswerRecord._get_unset_required_fields(query_params))

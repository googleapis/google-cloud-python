...
class AnswerRecordsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_answer_record(self, request: answer_record.GetAnswerRecordRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[answer_record.GetAnswerRecordRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_answer_record(self, response: answer_record.AnswerRecord) -> answer_record.AnswerRecord:
        ...
        it is returned to user code. This `post_get_answer_record` interceptor runs
        before the `post_get_answer_record_with_metadata` interceptor.
        """
        return response

    def post_get_answer_record_with_metadata(self, response: answer_record.AnswerRecord, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[answer_record.AnswerRecord, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_answer_record

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the AnswerRecords server but before it is returned to user code.

        We recommend only using this `post_get_answer_record_with_metadata`
        interceptor in new development instead of the `post_get_answer_record` interceptor.
        When both interceptors are used, this `post_get_answer_record_with_metadata` interceptor runs after the
        `post_get_answer_record` interceptor. The (possibly modified) response returned by
        `post_get_answer_record` will be passed to
        `post_get_answer_record_with_metadata`.
        """
        return response, metadata

    def pre_list_answer_records(self, request: answer_record.ListAnswerRecordsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[answer_record.ListAnswerRecordsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_answer_records_with_metadata(self, response: answer_record.ListAnswerRecordsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[answer_record.ListAnswerRecordsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_answer_records
    ...
    def pre_update_answer_record(self, request: gcd_answer_record.UpdateAnswerRecordRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_answer_record.UpdateAnswerRecordRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_answer_record_with_metadata(self, response: gcd_answer_record.AnswerRecord, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_answer_record.AnswerRecord, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_answer_record
    ...
    class _GetAnswerRecord(_BaseAnswerRecordsRestTransport._BaseGetAnswerRecord, AnswerRecordsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.AnswerRecordsClient.GetAnswerRecord",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
                        "rpcName": "GetAnswerRecord",
            ...
            # Send the request
            response = AnswerRecordsRestTransport._GetAnswerRecord._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.AnswerRecordsClient.get_answer_record",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
                        "rpcName": "GetAnswerRecord",
    ...
    class _ListAnswerRecords(_BaseAnswerRecordsRestTransport._BaseListAnswerRecords, AnswerRecordsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.AnswerRecordsClient.ListAnswerRecords",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
            ...
            # Send the request
            response = AnswerRecordsRestTransport._ListAnswerRecords._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.AnswerRecordsClient.list_answer_records",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
                        "rpcName": "ListAnswerRecords",
                        "metadata": http_response["headers"],
    ...
    class _UpdateAnswerRecord(_BaseAnswerRecordsRestTransport._BaseUpdateAnswerRecord, AnswerRecordsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.AnswerRecordsClient.UpdateAnswerRecord",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
            ...
            # Send the request
            response = AnswerRecordsRestTransport._UpdateAnswerRecord._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.AnswerRecordsClient.update_answer_record",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
                        "rpcName": "UpdateAnswerRecord",
                        "metadata": http_response["headers"],
    ...
    class _GetLocation(_BaseAnswerRecordsRestTransport._BaseGetLocation, AnswerRecordsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.AnswerRecordsClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = AnswerRecordsRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.AnswerRecordsAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(_BaseAnswerRecordsRestTransport._BaseListLocations, AnswerRecordsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.AnswerRecordsClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
            ...
            # Send the request
            response = AnswerRecordsRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.AnswerRecordsAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseAnswerRecordsRestTransport._BaseCancelOperation, AnswerRecordsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.AnswerRecordsClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
            ...
            # Send the request
            response = AnswerRecordsRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseAnswerRecordsRestTransport._BaseGetOperation, AnswerRecordsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.AnswerRecordsClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
            ...
            # Send the request
            response = AnswerRecordsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.AnswerRecordsAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseAnswerRecordsRestTransport._BaseListOperations, AnswerRecordsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.AnswerRecordsClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
            ...
            # Send the request
            response = AnswerRecordsRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.AnswerRecordsAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.AnswerRecords",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

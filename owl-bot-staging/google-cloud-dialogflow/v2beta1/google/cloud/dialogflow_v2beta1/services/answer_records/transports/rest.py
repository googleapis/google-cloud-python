...
class AnswerRecordsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_answer_record(self, request: answer_record.GetAnswerRecordRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[answer_record.GetAnswerRecordRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_answer_records(self, request: answer_record.ListAnswerRecordsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[answer_record.ListAnswerRecordsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_answer_record(self, request: gcd_answer_record.UpdateAnswerRecordRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_answer_record.UpdateAnswerRecordRequest, Sequence[Tuple[str, str]]]:

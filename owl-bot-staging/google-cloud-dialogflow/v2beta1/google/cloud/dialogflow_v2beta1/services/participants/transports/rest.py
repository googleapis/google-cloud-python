...
class ParticipantsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_compile_suggestion(self, request: participant.CompileSuggestionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[participant.CompileSuggestionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_compile_suggestion_with_metadata(self, response: participant.CompileSuggestionResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[participant.CompileSuggestionResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for compile_suggestion
    ...
    def pre_list_suggestions(self, request: participant.ListSuggestionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[participant.ListSuggestionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_suggestions_with_metadata(self, response: participant.ListSuggestionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[participant.ListSuggestionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_suggestions
...
class ParticipantsRestTransport(_BaseParticipantsRestTransport):
    ...
    class _AnalyzeContent(_BaseParticipantsRestTransport._BaseAnalyzeContent, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.AnalyzeContent",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsClient.analyze_content",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "AnalyzeContent",
    ...
    class _CompileSuggestion(_BaseParticipantsRestTransport._BaseCompileSuggestion, ParticipantsRestStub):
        def __hash__(self):
            return hash("ParticipantsRestTransport.CompileSuggestion")
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseParticipantsRestTransport._BaseCompileSuggestion._get_transcoded_request(http_options, request)

            body = _BaseParticipantsRestTransport._BaseCompileSuggestion._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseParticipantsRestTransport._BaseCompileSuggestion._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.CompileSuggestion",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "CompileSuggestion",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = ParticipantsRestTransport._CompileSuggestion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_compile_suggestion_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = participant.CompileSuggestionResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsClient.compile_suggestion",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "CompileSuggestion",
                        "metadata": http_response["headers"],
    ...
    class _CreateParticipant(_BaseParticipantsRestTransport._BaseCreateParticipant, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.CreateParticipant",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsClient.create_participant",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "CreateParticipant",
                        "metadata": http_response["headers"],
    ...
    class _GetParticipant(_BaseParticipantsRestTransport._BaseGetParticipant, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.GetParticipant",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsClient.get_participant",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "GetParticipant",
                        "metadata": http_response["headers"],
    ...
    class _ListParticipants(_BaseParticipantsRestTransport._BaseListParticipants, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.ListParticipants",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsClient.list_participants",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "ListParticipants",
                        "metadata": http_response["headers"],
    ...
    class _ListSuggestions(_BaseParticipantsRestTransport._BaseListSuggestions, ParticipantsRestStub):
        def __hash__(self):
            return hash("ParticipantsRestTransport.ListSuggestions")
        ...
        def __call__(self,
            ...
            http_options = _BaseParticipantsRestTransport._BaseListSuggestions._get_http_options()

            request, metadata = self._interceptor.pre_list_suggestions(request, metadata)
            transcoded_request = _BaseParticipantsRestTransport._BaseListSuggestions._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseParticipantsRestTransport._BaseListSuggestions._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.ListSuggestions",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "ListSuggestions",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = ParticipantsRestTransport._ListSuggestions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_suggestions_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = participant.ListSuggestionsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsClient.list_suggestions",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "ListSuggestions",
                        "metadata": http_response["headers"],
    ...
    class _SuggestArticles(_BaseParticipantsRestTransport._BaseSuggestArticles, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.SuggestArticles",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsClient.suggest_articles",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "SuggestArticles",
                        "metadata": http_response["headers"],
    ...
    class _SuggestFaqAnswers(_BaseParticipantsRestTransport._BaseSuggestFaqAnswers, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.SuggestFaqAnswers",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsClient.suggest_faq_answers",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "SuggestFaqAnswers",
                        "metadata": http_response["headers"],
    ...
    class _SuggestKnowledgeAssist(_BaseParticipantsRestTransport._BaseSuggestKnowledgeAssist, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.SuggestKnowledgeAssist",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsClient.suggest_knowledge_assist",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "SuggestKnowledgeAssist",
                        "metadata": http_response["headers"],
    ...
    class _SuggestSmartReplies(_BaseParticipantsRestTransport._BaseSuggestSmartReplies, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.SuggestSmartReplies",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsClient.suggest_smart_replies",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "SuggestSmartReplies",
                        "metadata": http_response["headers"],
    ...
    class _UpdateParticipant(_BaseParticipantsRestTransport._BaseUpdateParticipant, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.UpdateParticipant",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsClient.update_participant",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "UpdateParticipant",
                        "metadata": http_response["headers"],
    ...
    class _GetLocation(_BaseParticipantsRestTransport._BaseGetLocation, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(_BaseParticipantsRestTransport._BaseListLocations, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseParticipantsRestTransport._BaseCancelOperation, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
    ...
    class _GetOperation(_BaseParticipantsRestTransport._BaseGetOperation, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseParticipantsRestTransport._BaseListOperations, ParticipantsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.ParticipantsClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.ParticipantsAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2beta1.Participants",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

...
from google.cloud.dialogflow_v2beta1.services.generators import GeneratorsAsyncClient
from google.cloud.dialogflow_v2beta1.services.generators import GeneratorsClient
from google.cloud.dialogflow_v2beta1.services.generators import pagers
from google.cloud.dialogflow_v2beta1.services.generators import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert GeneratorsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert GeneratorsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert GeneratorsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert GeneratorsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert GeneratorsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert GeneratorsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert GeneratorsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert GeneratorsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert GeneratorsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(GeneratorsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GeneratorsClient))
@mock.patch.object(GeneratorsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GeneratorsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = GeneratorsClient._DEFAULT_UNIVERSE
    default_endpoint = GeneratorsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = GeneratorsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert GeneratorsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert GeneratorsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == GeneratorsClient.DEFAULT_MTLS_ENDPOINT
    assert GeneratorsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert GeneratorsClient._get_api_endpoint(None, None, default_universe, "always") == GeneratorsClient.DEFAULT_MTLS_ENDPOINT
    assert GeneratorsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == GeneratorsClient.DEFAULT_MTLS_ENDPOINT
    assert GeneratorsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert GeneratorsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        GeneratorsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert GeneratorsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert GeneratorsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert GeneratorsClient._get_universe_domain(None, None) == GeneratorsClient._DEFAULT_UNIVERSE
...
def test_generators_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (GeneratorsAsyncClient, transports.GeneratorsGrpcAsyncIOTransport, "grpc_asyncio"),
    (GeneratorsClient, transports.GeneratorsRestTransport, "rest"),
])
@mock.patch.object(GeneratorsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GeneratorsClient))
@mock.patch.object(GeneratorsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GeneratorsAsyncClient))
def test_generators_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (GeneratorsAsyncClient, transports.GeneratorsGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (GeneratorsClient, transports.GeneratorsGrpcTransport, "grpc", "false"),
    (GeneratorsAsyncClient, transports.GeneratorsGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_generators_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    GeneratorsClient, GeneratorsAsyncClient
])
@mock.patch.object(GeneratorsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GeneratorsClient))
@mock.patch.object(GeneratorsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GeneratorsAsyncClient))
...
def test_generators_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (GeneratorsAsyncClient, transports.GeneratorsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (GeneratorsClient, transports.GeneratorsRestTransport, "rest", None),
])
def test_generators_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_generators_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflow_v2beta1.services.generators.transports.GeneratorsGrpcTransport.__init__') as grpc_transport:
...
def test_generators_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_create_generator(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_generator),
            '__call__') as call:
...
def test_create_generator_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_generator] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_generator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_generator in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_generator] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_generator_async(transport: str = 'grpc_asyncio', request_type=gcd_generator.CreateGeneratorRequest):
    client = GeneratorsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gcd_generator.Generator(
            name='name_value',
            description='description_value',
            trigger_event=gcd_generator.TriggerEvent.END_OF_UTTERANCE,
        ))
...
def test_get_generator(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_generator),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_generator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GeneratorsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_generator in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_generator] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_generator_async(transport: str = 'grpc_asyncio', request_type=generator.GetGeneratorRequest):
    client = GeneratorsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_generators(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_generators),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_generators_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GeneratorsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_generators in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_generators] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_generators_async(transport: str = 'grpc_asyncio', request_type=generator.ListGeneratorsRequest):
    client = GeneratorsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(generator.ListGeneratorsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_generators_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, generator.Generator)
                   for i in results)
...
async def test_list_generators_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_generators(request={},)
...
def test_delete_generator(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_generator),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_generator_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_generator] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_generator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GeneratorsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_generator in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_generator] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_generator_async(transport: str = 'grpc_asyncio', request_type=generator.DeleteGeneratorRequest):
    client = GeneratorsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_generator(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_generator),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gcd_generator.Generator(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_generator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GeneratorsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_generator in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_generator] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_generator_async(transport: str = 'grpc_asyncio', request_type=gcd_generator.UpdateGeneratorRequest):
    client = GeneratorsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_generator_rest_required_fields(request_type=gcd_generator.CreateGeneratorRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_generator._get_unset_required_fields(jsonified_request)
...
def test_create_generator_rest_unset_required_fields():
    transport = transports.GeneratorsRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_generator._get_unset_required_fields({})
    assert set(unset_fields) == (set(("generatorId", )) & set(("parent", "generator", )))
...
def test_create_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2beta1/{parent=projects/*/locations/*}/generators" % client.transport._host, args[1])
...
def test_get_generator_rest_required_fields(request_type=generator.GetGeneratorRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_generator._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/generators/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{name=projects/*/locations/*/generators/*}" % client.transport._host, args[1])
...
def test_list_generators_rest_required_fields(request_type=generator.ListGeneratorsRequest):
    transport_class = transports.GeneratorsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_generators._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_generator_rest_required_fields(request_type=generator.DeleteGeneratorRequest):
    transport_class = transports.GeneratorsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_generator._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_generator_rest_required_fields(request_type=gcd_generator.UpdateGeneratorRequest):
    transport_class = transports.GeneratorsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_generator._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'generator': {'name': 'projects/sample1/locations/sample2/generators/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{generator.name=projects/*/locations/*/generators/*}" % client.transport._host, args[1])
...
def test_create_generator_rest_bad_request(request_type=gcd_generator.CreateGeneratorRequest):
    client = GeneratorsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_generator_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["generator"] = {'name': 'name_value', 'description': 'description_value', 'free_form_context': {'text': 'text_value'}, 'summarization_context': {'summarization_sections': [{'key': 'key_value', 'definition': 'definition_value', 'type_': 1}], 'few_shot_examples': [{'conversation_context': {'message_entries': [{'role': 1, 'text': 'text_value', 'language_code': 'language_code_value', 'create_time': {'seconds': 751, 'nanos': 543}}]}, 'extra_info': {}, 'summarization_section_list': {'summarization_sections': {}}, 'output': {'free_form_suggestion': {'response': 'response_value'}, 'summary_suggestion': {'summary_sections': [{'section': 'section_value', 'summary': 'summary_value'}]}}}], 'version': 'version_value', 'output_language_code': 'output_language_code_value'}, 'inference_parameter': {'max_output_tokens': 1865, 'temperature': 0.1198, 'top_k': 541, 'top_p': 0.546}, 'trigger_event': 1, 'published_model': 'published_model_value', 'create_time': {}, 'update_time': {}}
...
def test_create_generator_rest_interceptors(null_interceptor):
    transport = transports.GeneratorsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.GeneratorsRestInterceptor(),
        )
    client = GeneratorsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "post_create_generator") as post, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "post_create_generator_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "pre_create_generator") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcd_generator.CreateGeneratorRequest.pb(gcd_generator.CreateGeneratorRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_generator.Generator.to_json(gcd_generator.Generator())
        ...
        client.create_generator(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_generator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "post_get_generator") as post, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "post_get_generator_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "pre_get_generator") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_generator(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_generators_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "post_list_generators") as post, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "post_list_generators_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "pre_list_generators") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = generator.ListGeneratorsRequest.pb(generator.ListGeneratorsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = generator.ListGeneratorsResponse.to_json(generator.ListGeneratorsResponse())
        req.return_value.content = return_value
        ...
        client.list_generators(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_generator_rest_bad_request(request_type=generator.DeleteGeneratorRequest):
    client = GeneratorsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_generator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "pre_delete_generator") as pre:
        pre.assert_not_called()
        pb_message = generator.DeleteGeneratorRequest.pb(generator.DeleteGeneratorRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_generator(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_update_generator_rest_bad_request(request_type=gcd_generator.UpdateGeneratorRequest):
    client = GeneratorsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'generator': {'name': 'projects/sample1/locations/sample2/generators/sample3'}}
    request = request_type(**request_init)
...
def test_update_generator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "post_update_generator") as post, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "post_update_generator_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GeneratorsRestInterceptor, "pre_update_generator") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcd_generator.UpdateGeneratorRequest.pb(gcd_generator.UpdateGeneratorRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_generator(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_generators_base_transport():
    ...
    with mock.patch('google.cloud.dialogflow_v2beta1.services.generators.transports.GeneratorsTransport.__init__') as Transport:
...
def test_generators_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2beta1.services.generators.transports.GeneratorsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_generators_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2beta1.services.generators.transports.GeneratorsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GeneratorsTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.GeneratorsGrpcTransport, transports.GeneratorsGrpcAsyncIOTransport])
def test_generators_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.GeneratorsGrpcTransport, transports.GeneratorsGrpcAsyncIOTransport])
def test_generators_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.GeneratorsGrpcTransport, transports.GeneratorsGrpcAsyncIOTransport])
def test_generators_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_generator_path():
    ...
    location = "clam"
    generator = "whelk"
    expected = "projects/{project}/locations/{location}/generators/{generator}".format(project=project, location=location, generator=generator, )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.GeneratorsTransport, '_prep_wrapped_messages') as prep:
        client = GeneratorsClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
async def test_create_generator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_generator] = mock_object
...
async def test_get_generator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_generator] = mock_object
...
async def test_list_generators_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_generators] = mock_object
...
async def test_delete_generator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_generator] = mock_object
...
async def test_update_generator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_generator] = mock_object
...
def test_create_generator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = gcd_generator.Generator.to_json(gcd_generator.Generator())
...
def test_create_generator_rest_bad_request(transport: str = 'rest', request_type=gcd_generator.CreateGeneratorRequest):
    client = GeneratorsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_generator_rest_bad_request(transport: str = 'rest', request_type=generator.GetGeneratorRequest):
    client = GeneratorsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_generators_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = generator.ListGeneratorsResponse.to_json(generator.ListGeneratorsResponse())
...
def test_list_generators_rest_bad_request(transport: str = 'rest', request_type=generator.ListGeneratorsRequest):
    client = GeneratorsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_generator_rest_bad_request(transport: str = 'rest', request_type=generator.DeleteGeneratorRequest):
    client = GeneratorsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_generator_rest_bad_request(transport: str = 'rest', request_type=gcd_generator.UpdateGeneratorRequest):
    client = GeneratorsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

...
@pytest.mark.parametrize("client_class", [
    VersionsClient, VersionsAsyncClient
])
...
def test_versions_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflow_v2beta1.services.versions.transports.VersionsGrpcTransport.__init__') as grpc_transport:
...
def test_list_versions_rest_required_fields(request_type=version.ListVersionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_versions._get_unset_required_fields(jsonified_request)
...
def test_list_versions_rest_unset_required_fields():
    transport = transports.VersionsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.VersionsRestInterceptor, "post_list_versions") as post, \
         mock.patch.object(transports.VersionsRestInterceptor, "pre_list_versions") as pre:
...
def test_list_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2beta1/{parent=projects/*/agent}/versions" % client.transport._host, args[1])
...
def test_get_version_rest_required_fields(request_type=version.GetVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VersionsRestInterceptor, "post_get_version") as post, \
...
def test_get_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{name=projects/*/agent/versions/*}" % client.transport._host, args[1])
...
def test_create_version_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/agent'}
    request_init["version"] = {'name': 'name_value', 'description': 'description_value', 'version_number': 1518, 'create_time': {'seconds': 751, 'nanos': 543}, 'status': 1}
...
def test_create_version_rest_required_fields(request_type=gcd_version.CreateVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_version_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "version", )))
...
def test_create_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VersionsRestInterceptor, "post_create_version") as post, \
         mock.patch.object(transports.VersionsRestInterceptor, "pre_create_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_version_rest_bad_request(transport: str = 'rest', request_type=gcd_version.CreateVersionRequest):
    client = VersionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_version_rest(request_type):
    ...
    request_init["version"] = {'name': 'projects/sample1/agent/versions/sample2', 'description': 'description_value', 'version_number': 1518, 'create_time': {'seconds': 751, 'nanos': 543}, 'status': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_version_rest_required_fields(request_type=gcd_version.UpdateVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VersionsRestInterceptor, "post_update_version") as post, \
         mock.patch.object(transports.VersionsRestInterceptor, "pre_update_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_version_rest_bad_request(transport: str = 'rest', request_type=gcd_version.UpdateVersionRequest):
    client = VersionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{version.name=projects/*/agent/versions/*}" % client.transport._host, args[1])
...
def test_delete_version_rest_required_fields(request_type=version.DeleteVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VersionsRestInterceptor, "pre_delete_version") as pre:
        pre.assert_not_called()
...
def test_versions_base_transport():
    ...
    with mock.patch('google.cloud.dialogflow_v2beta1.services.versions.transports.VersionsTransport.__init__') as Transport:
...
def test_versions_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2beta1.services.versions.transports.VersionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_versions_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2beta1.services.versions.transports.VersionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.VersionsTransport()
        adc.assert_called_once()

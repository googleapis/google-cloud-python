...
def test_list_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VersionsRestInterceptor, "post_list_versions_with_metadata") as post_with_metadata, \
...
def test_get_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VersionsRestInterceptor, "post_get_version_with_metadata") as post_with_metadata, \
...
def test_create_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VersionsRestInterceptor, "post_create_version_with_metadata") as post_with_metadata, \
...
def test_update_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VersionsRestInterceptor, "post_update_version_with_metadata") as post_with_metadata, \

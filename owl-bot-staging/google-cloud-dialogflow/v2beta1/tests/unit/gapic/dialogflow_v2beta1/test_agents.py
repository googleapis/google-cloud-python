...
@pytest.mark.parametrize("client_class", [
    AgentsClient, AgentsAsyncClient
])
...
def test_agents_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflow_v2beta1.services.agents.transports.AgentsGrpcTransport.__init__') as grpc_transport:
...
def test_set_agent_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AgentsClient(
        ...
        # Ensure method has been cached
        assert client._transport.set_agent in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_agent] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_set_agent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AgentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.set_agent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.set_agent] = mock_rpc
...
@pytest.mark.asyncio
async def test_search_agents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AgentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_agents in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_agents] = mock_rpc
...
def test_train_agent_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AgentsClient(
        ...
        # Ensure method has been cached
        assert client._transport.train_agent in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.train_agent] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_train_agent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AgentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.train_agent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.train_agent] = mock_rpc
...
def test_import_agent_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AgentsClient(
        ...
        # Ensure method has been cached
        assert client._transport.import_agent in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_agent] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_import_agent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AgentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_agent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_agent] = mock_rpc
...
def test_get_validation_result_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AgentsClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_validation_result in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_validation_result] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_validation_result_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AgentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_validation_result in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_validation_result] = mock_rpc
...
def test_get_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2beta1/{parent=projects/*}/agent" % client.transport._host, args[1])
...
def test_set_agent_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AgentsClient(
...
def test_set_agent_rest_required_fields(request_type=gcd_agent.SetAgentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_agent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{agent.parent=projects/*}/agent" % client.transport._host, args[1])
...
def test_search_agents_rest_required_fields(request_type=agent.SearchAgentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_agents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_agents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{parent=projects/*}/agent:search" % client.transport._host, args[1])
...
def test_train_agent_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AgentsClient(
...
def test_train_agent_rest_required_fields(request_type=agent.TrainAgentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).train_agent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_train_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{parent=projects/*}/agent:train" % client.transport._host, args[1])
...
def test_export_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{parent=projects/*}/agent:export" % client.transport._host, args[1])
...
def test_import_agent_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AgentsClient(
...
def test_import_agent_rest_required_fields(request_type=agent.ImportAgentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_agent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_validation_result_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AgentsClient(
...
def test_get_validation_result_rest_required_fields(request_type=agent.GetValidationResultRequest):
    transport_class = transports.AgentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_validation_result._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_agent_empty_call_grpc():
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = gcd_agent.Agent()
        client.set_agent(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = gcd_agent.SetAgentRequest()
...
def test_search_agents_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = agent.SearchAgentsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_train_agent_empty_call_grpc():
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.train_agent(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = agent.TrainAgentRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_agent_empty_call_grpc():
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.import_agent(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = agent.ImportAgentRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_validation_result_empty_call_grpc():
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = validation_result.ValidationResult()
        client.get_validation_result(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = agent.GetValidationResultRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_set_agent_empty_call_grpc_asyncio():
    client = AgentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.set_agent(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_train_agent_empty_call_grpc_asyncio():
    client = AgentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.train_agent(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_import_agent_empty_call_grpc_asyncio():
    client = AgentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.import_agent(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_validation_result_empty_call_grpc_asyncio():
    client = AgentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_validation_result(request=None)
...
def test_get_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AgentsRestInterceptor, "post_get_agent_with_metadata") as post_with_metadata, \
        ...
        client.get_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_agent_rest_call_success(request_type):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AgentsRestInterceptor, "post_set_agent") as post, \
        mock.patch.object(transports.AgentsRestInterceptor, "post_set_agent_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AgentsRestInterceptor, "pre_set_agent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_agent.Agent.to_json(gcd_agent.Agent())
        req.return_value.content = return_value
        ...
        client.set_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.delete_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_search_agents_rest_bad_request(request_type=agent.SearchAgentsRequest):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_search_agents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AgentsRestInterceptor, "post_search_agents") as post, \
        mock.patch.object(transports.AgentsRestInterceptor, "post_search_agents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AgentsRestInterceptor, "pre_search_agents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = agent.SearchAgentsResponse.to_json(agent.SearchAgentsResponse())
        req.return_value.content = return_value
        ...
        client.search_agents(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_train_agent_rest_call_success(request_type):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_train_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AgentsRestInterceptor, "post_train_agent") as post, \
        mock.patch.object(transports.AgentsRestInterceptor, "post_train_agent_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AgentsRestInterceptor, "pre_train_agent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.train_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AgentsRestInterceptor, "post_export_agent") as post, \
        mock.patch.object(transports.AgentsRestInterceptor, "post_export_agent_with_metadata") as post_with_metadata, \
        ...
        client.export_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_import_agent_rest_call_success(request_type):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_import_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AgentsRestInterceptor, "post_import_agent") as post, \
        mock.patch.object(transports.AgentsRestInterceptor, "post_import_agent_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AgentsRestInterceptor, "pre_import_agent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.import_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_restore_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AgentsRestInterceptor, "post_restore_agent") as post, \
        mock.patch.object(transports.AgentsRestInterceptor, "post_restore_agent_with_metadata") as post_with_metadata, \
        ...
        client.restore_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_validation_result_rest_bad_request(request_type=agent.GetValidationResultRequest):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_validation_result_rest_call_success(request_type):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_validation_result_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AgentsRestInterceptor, "post_get_validation_result") as post, \
        mock.patch.object(transports.AgentsRestInterceptor, "post_get_validation_result_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AgentsRestInterceptor, "pre_get_validation_result") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = agent.GetValidationResultRequest.pb(agent.GetValidationResultRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = validation_result.ValidationResult.to_json(validation_result.ValidationResult())
        req.return_value.content = return_value
        ...
        client.get_validation_result(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_agent_empty_call_rest():
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_train_agent_empty_call_rest():
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_agent_empty_call_rest():
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_validation_result_empty_call_rest():
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_agents_base_transport():
    ...
    with mock.patch('google.cloud.dialogflow_v2beta1.services.agents.transports.AgentsTransport.__init__') as Transport:
...
def test_agents_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2beta1.services.agents.transports.AgentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_agents_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2beta1.services.agents.transports.AgentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AgentsTransport()
        adc.assert_called_once()

...
def test__read_environment_variables():
    assert ConversationProfilesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ConversationProfilesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ConversationProfilesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ConversationProfilesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ConversationProfilesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert ConversationProfilesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ConversationProfilesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ConversationProfilesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ConversationProfilesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ConversationProfilesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationProfilesClient))
@mock.patch.object(ConversationProfilesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationProfilesAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ConversationProfilesClient._DEFAULT_UNIVERSE
    default_endpoint = ConversationProfilesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ConversationProfilesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ConversationProfilesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ConversationProfilesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ConversationProfilesClient.DEFAULT_MTLS_ENDPOINT
    assert ConversationProfilesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ConversationProfilesClient._get_api_endpoint(None, None, default_universe, "always") == ConversationProfilesClient.DEFAULT_MTLS_ENDPOINT
    assert ConversationProfilesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ConversationProfilesClient.DEFAULT_MTLS_ENDPOINT
    assert ConversationProfilesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ConversationProfilesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ConversationProfilesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ConversationProfilesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ConversationProfilesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ConversationProfilesClient._get_universe_domain(None, None) == ConversationProfilesClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ConversationProfilesClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ConversationProfilesClient, transports.ConversationProfilesRestTransport, "rest"),
])
@mock.patch.object(ConversationProfilesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationProfilesClient))
@mock.patch.object(ConversationProfilesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationProfilesAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (ConversationProfilesClient, transports.ConversationProfilesRestTransport, "rest", "true"),
    (ConversationProfilesClient, transports.ConversationProfilesRestTransport, "rest", "false"),
])
@mock.patch.object(ConversationProfilesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationProfilesClient))
@mock.patch.object(ConversationProfilesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationProfilesAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ConversationProfilesClient, transports.ConversationProfilesGrpcTransport, "grpc", grpc_helpers),
    (ConversationProfilesAsyncClient, transports.ConversationProfilesGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (ConversationProfilesClient, transports.ConversationProfilesRestTransport, "rest", None),
])
...
def test_list_conversation_profiles_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_conversation_profiles in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_conversation_profiles] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_conversation_profiles_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_conversation_profiles in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_conversation_profiles] = mock_rpc
...
def test_list_conversation_profiles_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_conversation_profiles(request={}, retry=retry, timeout=timeout)
...
def test_get_conversation_profile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_conversation_profile in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_conversation_profile] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_conversation_profile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationProfilesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_conversation_profile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_conversation_profile] = mock_rpc
...
def test_create_conversation_profile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_conversation_profile in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_conversation_profile] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_conversation_profile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationProfilesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_conversation_profile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_conversation_profile] = mock_rpc
...
def test_update_conversation_profile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_conversation_profile in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_conversation_profile] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_conversation_profile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationProfilesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_conversation_profile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_conversation_profile] = mock_rpc
...
def test_delete_conversation_profile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_conversation_profile in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_conversation_profile] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_conversation_profile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationProfilesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_conversation_profile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_conversation_profile] = mock_rpc
...
def test_set_suggestion_feature_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.set_suggestion_feature_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_set_suggestion_feature_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.set_suggestion_feature_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_suggestion_feature_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_set_suggestion_feature_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationProfilesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.set_suggestion_feature_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.set_suggestion_feature_config] = mock_rpc
...
def test_set_suggestion_feature_config_flattened():
    ...
    with mock.patch.object(
        ...
        client.set_suggestion_feature_config(
            ...
            suggestion_feature_config=gcd_conversation_profile.HumanAgentAssistantConfig.SuggestionFeatureConfig(suggestion_feature=participant.SuggestionFeature(type_=participant.SuggestionFeature.Type.ARTICLE_SUGGESTION)),
        )
        ...
        mock_val = gcd_conversation_profile.HumanAgentAssistantConfig.SuggestionFeatureConfig(suggestion_feature=participant.SuggestionFeature(type_=participant.SuggestionFeature.Type.ARTICLE_SUGGESTION))
        assert arg == mock_val
...
def test_clear_suggestion_feature_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.clear_suggestion_feature_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_clear_suggestion_feature_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.clear_suggestion_feature_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.clear_suggestion_feature_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_clear_suggestion_feature_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationProfilesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.clear_suggestion_feature_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.clear_suggestion_feature_config] = mock_rpc
...
def test_list_conversation_profiles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2beta1/{parent=projects/*}/conversationProfiles" % client.transport._host, args[1])
...
def test_get_conversation_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{name=projects/*/conversationProfiles/*}" % client.transport._host, args[1])
...
def test_update_conversation_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{conversation_profile.name=projects/*/conversationProfiles/*}" % client.transport._host, args[1])
...
def test_set_suggestion_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{conversation_profile=projects/*/conversationProfiles/*}:setSuggestionFeatureConfig" % client.transport._host, args[1])
...
def test_clear_suggestion_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{conversation_profile=projects/*/conversationProfiles/*}:clearSuggestionFeatureConfig" % client.transport._host, args[1])
...
def test_list_conversation_profiles_rest_bad_request(request_type=conversation_profile.ListConversationProfilesRequest):
    client = ConversationProfilesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_conversation_profiles_rest_interceptors(null_interceptor):
    transport = transports.ConversationProfilesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ConversationProfilesRestInterceptor(),
        )
    client = ConversationProfilesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_list_conversation_profiles") as post, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_list_conversation_profiles_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "pre_list_conversation_profiles") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_profile.ListConversationProfilesResponse.to_json(conversation_profile.ListConversationProfilesResponse())
        ...
        post_with_metadata.return_value = conversation_profile.ListConversationProfilesResponse(), metadata
...
def test_get_conversation_profile_rest_bad_request(request_type=conversation_profile.GetConversationProfileRequest):
    client = ConversationProfilesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_conversation_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_get_conversation_profile") as post, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_get_conversation_profile_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "pre_get_conversation_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_profile.ConversationProfile.to_json(conversation_profile.ConversationProfile())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = conversation_profile.ConversationProfile(), metadata
...
def test_create_conversation_profile_rest_bad_request(request_type=gcd_conversation_profile.CreateConversationProfileRequest):
    client = ConversationProfilesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_conversation_profile_rest_call_success(request_type):
    ...
    for field, value in request_init["conversation_profile"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_conversation_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_create_conversation_profile") as post, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_create_conversation_profile_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "pre_create_conversation_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_conversation_profile.ConversationProfile.to_json(gcd_conversation_profile.ConversationProfile())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcd_conversation_profile.ConversationProfile(), metadata
...
def test_update_conversation_profile_rest_bad_request(request_type=gcd_conversation_profile.UpdateConversationProfileRequest):
    client = ConversationProfilesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_conversation_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_update_conversation_profile") as post, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_update_conversation_profile_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "pre_update_conversation_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_conversation_profile_rest_bad_request(request_type=conversation_profile.DeleteConversationProfileRequest):
    client = ConversationProfilesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_conversation_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "pre_delete_conversation_profile") as pre:
        pre.assert_not_called()
...
def test_set_suggestion_feature_config_rest_bad_request(request_type=gcd_conversation_profile.SetSuggestionFeatureConfigRequest):
    client = ConversationProfilesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_suggestion_feature_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_set_suggestion_feature_config") as post, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_set_suggestion_feature_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "pre_set_suggestion_feature_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_clear_suggestion_feature_config_rest_bad_request(request_type=gcd_conversation_profile.ClearSuggestionFeatureConfigRequest):
    client = ConversationProfilesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_clear_suggestion_feature_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_clear_suggestion_feature_config") as post, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_clear_suggestion_feature_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConversationProfilesRestInterceptor, "pre_clear_suggestion_feature_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (ConversationProfilesAsyncClient, transports.ConversationProfilesGrpcAsyncIOTransport),
])

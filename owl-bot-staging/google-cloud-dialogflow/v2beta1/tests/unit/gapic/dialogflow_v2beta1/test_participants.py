...
def test_create_participant_rest_required_fields(request_type=gcd_participant.CreateParticipantRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_participant._get_unset_required_fields(jsonified_request)
...
def test_create_participant_rest_unset_required_fields():
    transport = transports.ParticipantsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_participant_rest_required_fields(request_type=gcd_participant.UpdateParticipantRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_participant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_analyze_content_rest_required_fields(request_type=gcd_participant.AnalyzeContentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).analyze_content._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_suggest_articles_rest_required_fields(request_type=participant.SuggestArticlesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).suggest_articles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_suggest_faq_answers_rest_required_fields(request_type=participant.SuggestFaqAnswersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).suggest_faq_answers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_suggest_smart_replies_rest_required_fields(request_type=participant.SuggestSmartRepliesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).suggest_smart_replies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test_list_contexts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ContextsRestInterceptor, "post_list_contexts_with_metadata") as post_with_metadata, \
...
def test_get_context_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ContextsRestInterceptor, "post_get_context_with_metadata") as post_with_metadata, \
...
def test_create_context_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ContextsRestInterceptor, "post_create_context_with_metadata") as post_with_metadata, \
...
def test_update_context_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ContextsRestInterceptor, "post_update_context_with_metadata") as post_with_metadata, \

...
@pytest.mark.parametrize("client_class", [
    ContextsClient, ContextsAsyncClient
])
...
def test_list_contexts_rest_required_fields(request_type=context.ListContextsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_contexts._get_unset_required_fields(jsonified_request)
...
def test_list_contexts_rest_unset_required_fields():
    transport = transports.ContextsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_contexts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ContextsRestInterceptor, "post_list_contexts") as post, \
         mock.patch.object(transports.ContextsRestInterceptor, "pre_list_contexts") as pre:
        ...
        req.return_value._content = context.ListContextsResponse.to_json(context.ListContextsResponse())
...
def test_list_contexts_rest_bad_request(transport: str = 'rest', request_type=context.ListContextsRequest):
    client = ContextsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_context_rest_required_fields(request_type=context.GetContextRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_context._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_context_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContextsRestInterceptor, "post_get_context") as post, \
...
def test_get_context_rest_bad_request(transport: str = 'rest', request_type=context.GetContextRequest):
    client = ContextsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_context_rest_required_fields(request_type=gcd_context.CreateContextRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_context._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_context_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "context", )))
...
def test_create_context_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContextsRestInterceptor, "post_create_context") as post, \
         mock.patch.object(transports.ContextsRestInterceptor, "pre_create_context") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_context_rest_bad_request(transport: str = 'rest', request_type=gcd_context.CreateContextRequest):
    client = ContextsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_context_rest(request_type):
    ...
    request_init["context"] = {'name': 'projects/sample1/agent/sessions/sample2/contexts/sample3', 'lifespan_count': 1498, 'parameters': {'fields': {}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_context_rest_required_fields(request_type=gcd_context.UpdateContextRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_context._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_context_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContextsRestInterceptor, "post_update_context") as post, \
         mock.patch.object(transports.ContextsRestInterceptor, "pre_update_context") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_context_rest_bad_request(transport: str = 'rest', request_type=gcd_context.UpdateContextRequest):
    client = ContextsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_context_rest_required_fields(request_type=context.DeleteContextRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_context._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_context_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContextsRestInterceptor, "pre_delete_context") as pre:
        pre.assert_not_called()
...
def test_delete_context_rest_bad_request(transport: str = 'rest', request_type=context.DeleteContextRequest):
    client = ContextsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_all_contexts_rest_required_fields(request_type=context.DeleteAllContextsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_all_contexts._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_all_contexts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContextsRestInterceptor, "pre_delete_all_contexts") as pre:
        pre.assert_not_called()
        ...
        client.delete_all_contexts(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_all_contexts_rest_bad_request(transport: str = 'rest', request_type=context.DeleteAllContextsRequest):
    client = ContextsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_contexts_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2beta1.services.contexts.transports.ContextsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_contexts_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2beta1.services.contexts.transports.ContextsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.ContextsTransport()
        adc.assert_called_once()

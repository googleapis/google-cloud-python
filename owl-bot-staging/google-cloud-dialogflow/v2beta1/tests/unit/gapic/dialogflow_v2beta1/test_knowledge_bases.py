...
def test_list_knowledge_bases_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = knowledge_base.ListKnowledgeBasesResponse.pb(return_value)
...
def test_get_knowledge_base_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = knowledge_base.KnowledgeBase.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_create_knowledge_base_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = gcd_knowledge_base.KnowledgeBase.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)

...
async def test_list_knowledge_bases_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.list_knowledge_bases] = mock_object
...
async def test_get_knowledge_base_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_knowledge_base] = mock_object
...
async def test_create_knowledge_base_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_knowledge_base] = mock_object
...
async def test_delete_knowledge_base_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_knowledge_base] = mock_object
...
async def test_update_knowledge_base_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_knowledge_base] = mock_object
...
def test_list_knowledge_bases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = knowledge_base.ListKnowledgeBasesResponse.to_json(knowledge_base.ListKnowledgeBasesResponse())
...
def test_list_knowledge_bases_rest_bad_request(transport: str = 'rest', request_type=knowledge_base.ListKnowledgeBasesRequest):
    client = KnowledgeBasesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_knowledge_base_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = knowledge_base.KnowledgeBase.to_json(knowledge_base.KnowledgeBase())
...
def test_get_knowledge_base_rest_bad_request(transport: str = 'rest', request_type=knowledge_base.GetKnowledgeBaseRequest):
    client = KnowledgeBasesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_knowledge_base_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcd_knowledge_base.KnowledgeBase.to_json(gcd_knowledge_base.KnowledgeBase())
...
def test_create_knowledge_base_rest_bad_request(transport: str = 'rest', request_type=gcd_knowledge_base.CreateKnowledgeBaseRequest):
    client = KnowledgeBasesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_knowledge_base_rest_bad_request(transport: str = 'rest', request_type=knowledge_base.DeleteKnowledgeBaseRequest):
    client = KnowledgeBasesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_knowledge_base_rest_bad_request(transport: str = 'rest', request_type=gcd_knowledge_base.UpdateKnowledgeBaseRequest):
    client = KnowledgeBasesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

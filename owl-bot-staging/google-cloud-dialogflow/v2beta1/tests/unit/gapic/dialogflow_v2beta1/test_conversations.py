...
def test_create_conversation_rest_unset_required_fields():
    transport = transports.ConversationsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_complete_conversation_rest_required_fields(request_type=conversation.CompleteConversationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).complete_conversation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_messages_rest_required_fields(request_type=conversation.BatchCreateMessagesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_create_messages._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_messages_rest_required_fields(request_type=conversation.ListMessagesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_messages._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_suggest_conversation_summary_rest_required_fields(request_type=gcd_conversation.SuggestConversationSummaryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).suggest_conversation_summary._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_stateless_summary_rest_required_fields(request_type=conversation.GenerateStatelessSummaryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_stateless_summary._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_knowledge_rest_required_fields(request_type=conversation.SearchKnowledgeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_knowledge._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

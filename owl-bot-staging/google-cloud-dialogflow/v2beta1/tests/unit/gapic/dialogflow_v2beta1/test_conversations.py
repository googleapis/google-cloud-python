...
def test__get_api_endpoint():
    ...
    assert ConversationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ConversationsClient.DEFAULT_MTLS_ENDPOINT
...
def test_ingest_context_references(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.ingest_context_references),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_ingest_context_references_flattened():
    ...
    with mock.patch.object(
        ...
        client.ingest_context_references(
            conversation='conversation_value',
            context_references={'key_value': gcd_conversation.Conversation.ContextReference(context_contents=[gcd_conversation.Conversation.ContextReference.ContextContent(content='content_value')])},
        )
        ...
        mock_val = {'key_value': gcd_conversation.Conversation.ContextReference(context_contents=[gcd_conversation.Conversation.ContextReference.ContextContent(content='content_value')])}
        assert arg == mock_val
...
def test_generate_stateless_suggestion(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_stateless_suggestion),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_generate_suggestions(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_suggestions),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_ingest_context_references_rest_required_fields(request_type=gcd_conversation.IngestContextReferencesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).ingest_context_references._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_ingest_context_references_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("conversation", "contextReferences", )))
...
def test_ingest_context_references_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{conversation=projects/*/locations/*/conversations/*}:ingestContextReferences" % client.transport._host, args[1])
...
def test_generate_stateless_suggestion_rest_required_fields(request_type=conversation.GenerateStatelessSuggestionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_stateless_suggestion._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_knowledge_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "query", "conversationProfile", "sessionId", )))
...
def test_generate_suggestions_rest_required_fields(request_type=gcd_conversation.GenerateSuggestionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_suggestions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_conversation_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1'}
    request_init["conversation"] = {'name': 'name_value', 'lifecycle_state': 1, 'conversation_profile': 'conversation_profile_value', 'phone_number': {'country_code': 1294, 'phone_number': 'phone_number_value'}, 'conversation_stage': 1, 'start_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}, 'telephony_connection_info': {'dialed_number': 'dialed_number_value', 'sdp': 'sdp_value', 'sip_headers': [{'name': 'name_value', 'value': 'value_value'}], 'extra_mime_contents': [{'mime_type': 'mime_type_value', 'content': b'content_blob'}]}, 'ingested_context_references': {}}
...
def test_create_conversation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationsRestInterceptor, "post_create_conversation_with_metadata") as post_with_metadata, \
...
def test_list_conversations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationsRestInterceptor, "post_list_conversations_with_metadata") as post_with_metadata, \
...
def test_get_conversation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationsRestInterceptor, "post_get_conversation_with_metadata") as post_with_metadata, \
...
def test_complete_conversation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationsRestInterceptor, "post_complete_conversation_with_metadata") as post_with_metadata, \
...
def test_ingest_context_references_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConversationsRestInterceptor, "post_ingest_context_references") as post, \
        mock.patch.object(transports.ConversationsRestInterceptor, "post_ingest_context_references_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConversationsRestInterceptor, "pre_ingest_context_references") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.ingest_context_references(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_batch_create_messages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationsRestInterceptor, "post_batch_create_messages_with_metadata") as post_with_metadata, \
...
def test_list_messages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationsRestInterceptor, "post_list_messages_with_metadata") as post_with_metadata, \
...
def test_suggest_conversation_summary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationsRestInterceptor, "post_suggest_conversation_summary_with_metadata") as post_with_metadata, \
...
def test_generate_stateless_summary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationsRestInterceptor, "post_generate_stateless_summary_with_metadata") as post_with_metadata, \
...
def test_generate_stateless_suggestion_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConversationsRestInterceptor, "post_generate_stateless_suggestion") as post, \
        mock.patch.object(transports.ConversationsRestInterceptor, "post_generate_stateless_suggestion_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConversationsRestInterceptor, "pre_generate_stateless_suggestion") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.generate_stateless_suggestion(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_search_knowledge_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationsRestInterceptor, "post_search_knowledge_with_metadata") as post_with_metadata, \
...
def test_generate_suggestions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConversationsRestInterceptor, "post_generate_suggestions") as post, \
        mock.patch.object(transports.ConversationsRestInterceptor, "post_generate_suggestions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConversationsRestInterceptor, "pre_generate_suggestions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.generate_suggestions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_data_store_path():
    ...
    expected = "projects/{project}/locations/{location}/collections/{collection}/dataStores/{data_store}".format(project=project, location=location, collection=collection, data_store=data_store, )

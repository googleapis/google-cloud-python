...
from google.cloud.dialogflow_v2beta1.services.encryption_spec_service import EncryptionSpecServiceAsyncClient
from google.cloud.dialogflow_v2beta1.services.encryption_spec_service import EncryptionSpecServiceClient
from google.cloud.dialogflow_v2beta1.services.encryption_spec_service import transports
...
def test_encryption_spec_service_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflow_v2beta1.services.encryption_spec_service.transports.EncryptionSpecServiceGrpcTransport.__init__') as grpc_transport:
...
def test_initialize_encryption_spec_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{encryption_spec.name=projects/*/locations/*/encryptionSpec}:initialize" % client.transport._host, args[1])
...
def test_encryption_spec_service_base_transport():
    ...
    with mock.patch('google.cloud.dialogflow_v2beta1.services.encryption_spec_service.transports.EncryptionSpecServiceTransport.__init__') as Transport:
...
def test_encryption_spec_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2beta1.services.encryption_spec_service.transports.EncryptionSpecServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_encryption_spec_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2beta1.services.encryption_spec_service.transports.EncryptionSpecServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EncryptionSpecServiceTransport()
        adc.assert_called_once()

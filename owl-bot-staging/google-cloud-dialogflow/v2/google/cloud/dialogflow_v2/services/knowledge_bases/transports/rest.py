...
from .base import KnowledgeBasesTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
    ...
    class _CreateKnowledgeBase(KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{parent=projects/*}/knowledgeBases',
                'body': 'knowledge_base',
            },
{
                'method': 'post',
                'uri': '/v2/{parent=projects/*/locations/*}/knowledgeBases',
                'body': 'knowledge_base',
            },
{
                'method': 'post',
                'uri': '/v2/{parent=projects/*/agent}/knowledgeBases',
                'body': 'knowledge_base',
            },
            ]
    ...
    class _DeleteKnowledgeBase(KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v2/{name=projects/*/knowledgeBases/*}',
            },
{
                'method': 'delete',
                'uri': '/v2/{name=projects/*/locations/*/knowledgeBases/*}',
            },
{
                'method': 'delete',
                'uri': '/v2/{name=projects/*/agent/knowledgeBases/*}',
            },
            ]
            ...
            },
{
    ...
    class _UpdateKnowledgeBase(KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v2/{knowledge_base.name=projects/*/knowledgeBases/*}',
                'body': 'knowledge_base',
            },
{
                'method': 'patch',
                'uri': '/v2/{knowledge_base.name=projects/*/locations/*/knowledgeBases/*}',
                'body': 'knowledge_base',
            },
{
                'method': 'patch',
                'uri': '/v2/{knowledge_base.name=projects/*/agent/knowledgeBases/*}',
                'body': 'knowledge_base',
            },
            ]

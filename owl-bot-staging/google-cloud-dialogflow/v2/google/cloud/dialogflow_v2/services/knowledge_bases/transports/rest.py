...
class KnowledgeBasesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_knowledge_base(self, request: gcd_knowledge_base.CreateKnowledgeBaseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_knowledge_base.CreateKnowledgeBaseRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_knowledge_base(self, request: knowledge_base.DeleteKnowledgeBaseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[knowledge_base.DeleteKnowledgeBaseRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_knowledge_base(self, request: knowledge_base.GetKnowledgeBaseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[knowledge_base.GetKnowledgeBaseRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_knowledge_bases(self, request: knowledge_base.ListKnowledgeBasesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[knowledge_base.ListKnowledgeBasesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_knowledge_base(self, request: gcd_knowledge_base.UpdateKnowledgeBaseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_knowledge_base.UpdateKnowledgeBaseRequest, Sequence[Tuple[str, str]]]:

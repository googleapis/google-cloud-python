...
class KnowledgeBasesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_knowledge_base(self, request: gcd_knowledge_base.CreateKnowledgeBaseRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_knowledge_base.CreateKnowledgeBaseRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_knowledge_base_with_metadata(self, response: gcd_knowledge_base.KnowledgeBase, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_knowledge_base.KnowledgeBase, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_knowledge_base
    ...
    def pre_delete_knowledge_base(self, request: knowledge_base.DeleteKnowledgeBaseRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[knowledge_base.DeleteKnowledgeBaseRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_knowledge_base(self, request: knowledge_base.GetKnowledgeBaseRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[knowledge_base.GetKnowledgeBaseRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_knowledge_base_with_metadata(self, response: knowledge_base.KnowledgeBase, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[knowledge_base.KnowledgeBase, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_knowledge_base
    ...
    def pre_list_knowledge_bases(self, request: knowledge_base.ListKnowledgeBasesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[knowledge_base.ListKnowledgeBasesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_knowledge_bases_with_metadata(self, response: knowledge_base.ListKnowledgeBasesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[knowledge_base.ListKnowledgeBasesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_knowledge_bases
    ...
    def pre_update_knowledge_base(self, request: gcd_knowledge_base.UpdateKnowledgeBaseRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_knowledge_base.UpdateKnowledgeBaseRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_knowledge_base_with_metadata(self, response: gcd_knowledge_base.KnowledgeBase, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_knowledge_base.KnowledgeBase, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_knowledge_base
    ...
    class _CreateKnowledgeBase(_BaseKnowledgeBasesRestTransport._BaseCreateKnowledgeBase, KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.KnowledgeBasesClient.CreateKnowledgeBase",
                    extra = {
            ...
            # Send the request
            response = KnowledgeBasesRestTransport._CreateKnowledgeBase._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.KnowledgeBasesClient.create_knowledge_base",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
                        "rpcName": "CreateKnowledgeBase",
    ...
    class _DeleteKnowledgeBase(_BaseKnowledgeBasesRestTransport._BaseDeleteKnowledgeBase, KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.KnowledgeBasesClient.DeleteKnowledgeBase",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
            ...
            # Send the request
            response = KnowledgeBasesRestTransport._DeleteKnowledgeBase._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetKnowledgeBase(_BaseKnowledgeBasesRestTransport._BaseGetKnowledgeBase, KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.KnowledgeBasesClient.GetKnowledgeBase",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
            ...
            # Send the request
            response = KnowledgeBasesRestTransport._GetKnowledgeBase._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.KnowledgeBasesClient.get_knowledge_base",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
                        "rpcName": "GetKnowledgeBase",
                        "metadata": http_response["headers"],
    ...
    class _ListKnowledgeBases(_BaseKnowledgeBasesRestTransport._BaseListKnowledgeBases, KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.KnowledgeBasesClient.ListKnowledgeBases",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
            ...
            # Send the request
            response = KnowledgeBasesRestTransport._ListKnowledgeBases._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.KnowledgeBasesClient.list_knowledge_bases",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
                        "rpcName": "ListKnowledgeBases",
                        "metadata": http_response["headers"],
    ...
    class _UpdateKnowledgeBase(_BaseKnowledgeBasesRestTransport._BaseUpdateKnowledgeBase, KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.KnowledgeBasesClient.UpdateKnowledgeBase",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
            ...
            # Send the request
            response = KnowledgeBasesRestTransport._UpdateKnowledgeBase._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.KnowledgeBasesClient.update_knowledge_base",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
                        "rpcName": "UpdateKnowledgeBase",
                        "metadata": http_response["headers"],
    ...
    class _GetLocation(_BaseKnowledgeBasesRestTransport._BaseGetLocation, KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.KnowledgeBasesClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = KnowledgeBasesRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.KnowledgeBasesAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(_BaseKnowledgeBasesRestTransport._BaseListLocations, KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.KnowledgeBasesClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
            ...
            # Send the request
            response = KnowledgeBasesRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.KnowledgeBasesAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseKnowledgeBasesRestTransport._BaseCancelOperation, KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.KnowledgeBasesClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
            ...
            # Send the request
            response = KnowledgeBasesRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseKnowledgeBasesRestTransport._BaseGetOperation, KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.KnowledgeBasesClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
            ...
            # Send the request
            response = KnowledgeBasesRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.KnowledgeBasesAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseKnowledgeBasesRestTransport._BaseListOperations, KnowledgeBasesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.KnowledgeBasesClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
            ...
            # Send the request
            response = KnowledgeBasesRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.KnowledgeBasesAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.KnowledgeBases",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

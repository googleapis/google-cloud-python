...
from .base import ConversationProfilesTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
    ...
    class _ClearSuggestionFeatureConfig(ConversationProfilesRestStub):
        ...
        config method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{conversation_profile=projects/*/conversationProfiles/*}:clearSuggestionFeatureConfig',
                'body': '*',
            },
{
                'method': 'post',
                'uri': '/v2/{conversation_profile=projects/*/locations/*/conversationProfiles/*}:clearSuggestionFeatureConfig',
                'body': '*',
            },
            ]
    ...
    class _CreateConversationProfile(ConversationProfilesRestStub):
        ...
        profile method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{parent=projects/*}/conversationProfiles',
                'body': 'conversation_profile',
            },
{
                'method': 'post',
                'uri': '/v2/{parent=projects/*/locations/*}/conversationProfiles',
                'body': 'conversation_profile',
            },
            ]
    ...
    class _DeleteConversationProfile(ConversationProfilesRestStub):
        ...
        profile method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v2/{name=projects/*/conversationProfiles/*}',
            },
{
                'method': 'delete',
                'uri': '/v2/{name=projects/*/locations/*/conversationProfiles/*}',
            },
            ]
            ...
            },
{
    ...
    class _SetSuggestionFeatureConfig(ConversationProfilesRestStub):
        ...
        config method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{conversation_profile=projects/*/conversationProfiles/*}:setSuggestionFeatureConfig',
                'body': '*',
            },
{
                'method': 'post',
                'uri': '/v2/{conversation_profile=projects/*/locations/*/conversationProfiles/*}:setSuggestionFeatureConfig',
                'body': '*',
            },
            ]
    ...
    class _UpdateConversationProfile(ConversationProfilesRestStub):
        ...
        profile method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v2/{conversation_profile.name=projects/*/conversationProfiles/*}',
                'body': 'conversation_profile',
            },
{
                'method': 'patch',
                'uri': '/v2/{conversation_profile.name=projects/*/locations/*/conversationProfiles/*}',
                'body': 'conversation_profile',
            },
            ]

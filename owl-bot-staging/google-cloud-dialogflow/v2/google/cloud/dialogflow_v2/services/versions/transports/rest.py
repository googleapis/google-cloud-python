...
class VersionsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_version(self, request: gcd_version.CreateVersionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_version.CreateVersionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_version_with_metadata(self, response: gcd_version.Version, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_version.Version, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_version
    ...
    def pre_update_version(self, request: gcd_version.UpdateVersionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_version.UpdateVersionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_version_with_metadata(self, response: gcd_version.Version, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_version.Version, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_version

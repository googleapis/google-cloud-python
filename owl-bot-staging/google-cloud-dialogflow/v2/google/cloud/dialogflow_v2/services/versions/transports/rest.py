...
class VersionsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_version(self, request: gcd_version.CreateVersionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_version.CreateVersionRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_versions(self, response: version.ListVersionsResponse) -> version.ListVersionsResponse:
        ...
        """
        return response
    def pre_update_version(self, request: gcd_version.UpdateVersionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_version.UpdateVersionRequest, Sequence[Tuple[str, str]]]:

...
class SessionEntityTypesAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow_v2.SessionEntityTypesAsyncClient`.",
                extra = {
    ...
    async def list_session_entity_types(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.ListSessionEntityTypesRequest, dict]]):
    ...
    async def get_session_entity_type(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.GetSessionEntityTypeRequest, dict]]):
                The request object. The request message for
    ...
    async def create_session_entity_type(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.CreateSessionEntityTypeRequest, dict]]):
                The request object. The request message for
    ...
    async def update_session_entity_type(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.UpdateSessionEntityTypeRequest, dict]]):
                The request object. The request message for
    ...
    async def delete_session_entity_type(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.DeleteSessionEntityTypeRequest, dict]]):
                The request object. The request message for

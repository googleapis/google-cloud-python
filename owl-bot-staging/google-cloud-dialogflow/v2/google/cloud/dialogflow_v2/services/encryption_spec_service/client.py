...
from .transports.base import EncryptionSpecServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import EncryptionSpecServiceGrpcTransport
from .transports.grpc_asyncio import EncryptionSpecServiceGrpcAsyncIOTransport
from .transports.rest import EncryptionSpecServiceRestTransport


class EncryptionSpecServiceClientMeta(type):
    """Metaclass for the EncryptionSpecService client.
...
class EncryptionSpecServiceClient(metaclass=EncryptionSpecServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            EncryptionSpecServiceClient: The constructed client.
        """
    ...
    def transport(self) -> EncryptionSpecServiceTransport:
        ...
        Returns:
            EncryptionSpecServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def encryption_spec_path(project: str,location: str,) -> str:
        """Returns a fully-qualified encryption_spec string."""
        return "projects/{project}/locations/{location}/encryptionSpec".format(project=project, location=location, )

    @staticmethod
    def parse_encryption_spec_path(path: str) -> Dict[str,str]:
        """Parses a encryption_spec path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/encryptionSpec$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = EncryptionSpecServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = EncryptionSpecServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = EncryptionSpecServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            EncryptionSpecServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, EncryptionSpecServiceTransport, Callable[..., EncryptionSpecServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the encryption spec service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,EncryptionSpecServiceTransport,Callable[..., EncryptionSpecServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the EncryptionSpecServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = EncryptionSpecServiceClient._read_environment_variables()
        self._client_cert_source = EncryptionSpecServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = EncryptionSpecServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, EncryptionSpecServiceTransport)
        if transport_provided:
            # transport is a EncryptionSpecServiceTransport instance.
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[EncryptionSpecServiceTransport], Callable[..., EncryptionSpecServiceTransport]] = (
    ...
    def get_encryption_spec(self,
            request: Optional[Union[encryption_spec.GetEncryptionSpecRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            def sample_get_encryption_spec():
                ...
                request = dialogflow_v2.GetEncryptionSpecRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.GetEncryptionSpecRequest, dict]):
        ...
        Returns:
            google.cloud.dialogflow_v2.types.EncryptionSpec:
        ...
        if not isinstance(request, encryption_spec.GetEncryptionSpecRequest):
            request = encryption_spec.GetEncryptionSpecRequest(request)
    ...
    def initialize_encryption_spec(self,
            request: Optional[Union[gcd_encryption_spec.InitializeEncryptionSpecRequest, dict]] = None,
            *,
            encryption_spec: Optional[gcd_encryption_spec.EncryptionSpec] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> operation.Operation:
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.InitializeEncryptionSpecRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.dialogflow_v2.types.InitializeEncryptionSpecResponse`
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcd_encryption_spec.InitializeEncryptionSpecRequest):
            request = gcd_encryption_spec.InitializeEncryptionSpecRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.initialize_encryption_spec]
        ...
        response = operation.from_gapic(
            ...
            gcd_encryption_spec.InitializeEncryptionSpecResponse,
            metadata_type=gcd_encryption_spec.InitializeEncryptionSpecMetadata,
        )

        # Done; return the response.
        return response

    def __enter__(self) -> "EncryptionSpecServiceClient":
        return self

...
class EncryptionSpecServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_encryption_spec(self, request: encryption_spec.GetEncryptionSpecRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[encryption_spec.GetEncryptionSpecRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_initialize_encryption_spec(self, request: gcd_encryption_spec.InitializeEncryptionSpecRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_encryption_spec.InitializeEncryptionSpecRequest, Sequence[Tuple[str, str]]]:

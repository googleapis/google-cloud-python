...
class EncryptionSpecServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_encryption_spec(self, request: encryption_spec.GetEncryptionSpecRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[encryption_spec.GetEncryptionSpecRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_encryption_spec_with_metadata(self, response: encryption_spec.EncryptionSpec, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[encryption_spec.EncryptionSpec, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_encryption_spec
    ...
    def pre_initialize_encryption_spec(self, request: gcd_encryption_spec.InitializeEncryptionSpecRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_encryption_spec.InitializeEncryptionSpecRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class EncryptionSpecServiceRestTransport(_BaseEncryptionSpecServiceRestTransport):
    ...
    class _GetEncryptionSpec(_BaseEncryptionSpecServiceRestTransport._BaseGetEncryptionSpec, EncryptionSpecServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EncryptionSpecServiceRestTransport._GetEncryptionSpec._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _InitializeEncryptionSpec(_BaseEncryptionSpecServiceRestTransport._BaseInitializeEncryptionSpec, EncryptionSpecServiceRestStub):
        ...
        spec method over HTTP.
            ...
            # Send the request
            response = EncryptionSpecServiceRestTransport._InitializeEncryptionSpec._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetLocation(_BaseEncryptionSpecServiceRestTransport._BaseGetLocation, EncryptionSpecServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EncryptionSpecServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseEncryptionSpecServiceRestTransport._BaseListLocations, EncryptionSpecServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EncryptionSpecServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BaseEncryptionSpecServiceRestTransport._BaseCancelOperation, EncryptionSpecServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EncryptionSpecServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseEncryptionSpecServiceRestTransport._BaseGetOperation, EncryptionSpecServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EncryptionSpecServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseEncryptionSpecServiceRestTransport._BaseListOperations, EncryptionSpecServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EncryptionSpecServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

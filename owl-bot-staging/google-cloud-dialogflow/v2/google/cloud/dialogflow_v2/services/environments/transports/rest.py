...
class EnvironmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_environment(self, request: environment.CreateEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.CreateEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_environment(self, response: environment.Environment) -> environment.Environment:
    ...
    def post_create_environment_with_metadata(self, response: environment.Environment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.Environment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_environment
    ...
    def pre_delete_environment(self, request: environment.DeleteEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.DeleteEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_environment(self, request: environment.GetEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.GetEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_environment_with_metadata(self, response: environment.Environment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.Environment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_environment
    ...
    def pre_get_environment_history(self, request: environment.GetEnvironmentHistoryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.GetEnvironmentHistoryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_environment_history(self, response: environment.EnvironmentHistory) -> environment.EnvironmentHistory:
    ...
    def post_get_environment_history_with_metadata(self, response: environment.EnvironmentHistory, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.EnvironmentHistory, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_environment_history
    ...
    def pre_list_environments(self, request: environment.ListEnvironmentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.ListEnvironmentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_environments(self, response: environment.ListEnvironmentsResponse) -> environment.ListEnvironmentsResponse:
    ...
    def post_list_environments_with_metadata(self, response: environment.ListEnvironmentsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.ListEnvironmentsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_environments
    ...
    def pre_update_environment(self, request: environment.UpdateEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.UpdateEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_environment(self, response: environment.Environment) -> environment.Environment:
    ...
    def post_update_environment_with_metadata(self, response: environment.Environment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.Environment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_environment
...
class EnvironmentsRestTransport(_BaseEnvironmentsRestTransport):
    ...
    class _CreateEnvironment(_BaseEnvironmentsRestTransport._BaseCreateEnvironment, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EnvironmentsClient.CreateEnvironment",
                    extra = {
            ...
            # Send the request
            response = EnvironmentsRestTransport._CreateEnvironment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EnvironmentsClient.create_environment",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
                        "rpcName": "CreateEnvironment",
    ...
    class _DeleteEnvironment(_BaseEnvironmentsRestTransport._BaseDeleteEnvironment, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EnvironmentsClient.DeleteEnvironment",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
            ...
            # Send the request
            response = EnvironmentsRestTransport._DeleteEnvironment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetEnvironment(_BaseEnvironmentsRestTransport._BaseGetEnvironment, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EnvironmentsClient.GetEnvironment",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
            ...
            # Send the request
            response = EnvironmentsRestTransport._GetEnvironment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EnvironmentsClient.get_environment",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
                        "rpcName": "GetEnvironment",
                        "metadata": http_response["headers"],
    ...
    class _GetEnvironmentHistory(_BaseEnvironmentsRestTransport._BaseGetEnvironmentHistory, EnvironmentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseEnvironmentsRestTransport._BaseGetEnvironmentHistory._get_http_options()

            request, metadata = self._interceptor.pre_get_environment_history(request, metadata)
            transcoded_request = _BaseEnvironmentsRestTransport._BaseGetEnvironmentHistory._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseEnvironmentsRestTransport._BaseGetEnvironmentHistory._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EnvironmentsClient.GetEnvironmentHistory",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
            ...
            # Send the request
            response = EnvironmentsRestTransport._GetEnvironmentHistory._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_get_environment_history_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EnvironmentsClient.get_environment_history",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
                        "rpcName": "GetEnvironmentHistory",
                        "metadata": http_response["headers"],
    ...
    class _ListEnvironments(_BaseEnvironmentsRestTransport._BaseListEnvironments, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EnvironmentsClient.ListEnvironments",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
            ...
            # Send the request
            response = EnvironmentsRestTransport._ListEnvironments._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = environment.ListEnvironmentsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EnvironmentsClient.list_environments",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
                        "rpcName": "ListEnvironments",
                        "metadata": http_response["headers"],
    ...
    class _UpdateEnvironment(_BaseEnvironmentsRestTransport._BaseUpdateEnvironment, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EnvironmentsClient.UpdateEnvironment",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
            ...
            # Send the request
            response = EnvironmentsRestTransport._UpdateEnvironment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EnvironmentsClient.update_environment",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
                        "rpcName": "UpdateEnvironment",
                        "metadata": http_response["headers"],
    ...
    @property
    def get_environment_history(self) -> Callable[
    ...
    class _GetLocation(_BaseEnvironmentsRestTransport._BaseGetLocation, EnvironmentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseEnvironmentsRestTransport._BaseGetLocation._get_http_options()

            request, metadata = self._interceptor.pre_get_location(request, metadata)
            transcoded_request = _BaseEnvironmentsRestTransport._BaseGetLocation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseEnvironmentsRestTransport._BaseGetLocation._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EnvironmentsClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = EnvironmentsRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EnvironmentsAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(_BaseEnvironmentsRestTransport._BaseListLocations, EnvironmentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseEnvironmentsRestTransport._BaseListLocations._get_http_options()

            request, metadata = self._interceptor.pre_list_locations(request, metadata)
            transcoded_request = _BaseEnvironmentsRestTransport._BaseListLocations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseEnvironmentsRestTransport._BaseListLocations._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EnvironmentsClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
            ...
            # Send the request
            response = EnvironmentsRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EnvironmentsAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseEnvironmentsRestTransport._BaseCancelOperation, EnvironmentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseEnvironmentsRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = self._interceptor.pre_cancel_operation(request, metadata)
            transcoded_request = _BaseEnvironmentsRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseEnvironmentsRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EnvironmentsClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
            ...
            # Send the request
            response = EnvironmentsRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseEnvironmentsRestTransport._BaseGetOperation, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EnvironmentsClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
            ...
            # Send the request
            response = EnvironmentsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EnvironmentsAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseEnvironmentsRestTransport._BaseListOperations, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EnvironmentsClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
            ...
            # Send the request
            response = EnvironmentsRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EnvironmentsAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Environments",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

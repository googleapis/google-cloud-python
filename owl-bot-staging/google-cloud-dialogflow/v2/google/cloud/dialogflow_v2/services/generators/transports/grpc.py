...
from .base import GeneratorsTransport, DEFAULT_CLIENT_INFO
...
class GeneratorsGrpcTransport(GeneratorsTransport):
    ...
    @property
    def create_generator(self) -> Callable[
    ...
    def get_generator(self) -> Callable[
        ...
        if 'get_generator' not in self._stubs:
            self._stubs['get_generator'] = self._logged_channel.unary_unary(
    ...
    @property
    def list_generators(self) -> Callable[
        ...
        if 'list_generators' not in self._stubs:
            self._stubs['list_generators'] = self._logged_channel.unary_unary(
    ...
    @property
    def delete_generator(self) -> Callable[
        ...
        if 'delete_generator' not in self._stubs:
            self._stubs['delete_generator'] = self._logged_channel.unary_unary(
    ...
    @property
    def update_generator(self) -> Callable[

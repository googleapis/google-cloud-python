...
class GeneratorsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_generator(self, request: gcd_generator.CreateGeneratorRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_generator.CreateGeneratorRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_generators(self, response: generator.ListGeneratorsResponse) -> generator.ListGeneratorsResponse:
        ...
        """
        return response
    def pre_update_generator(self, request: gcd_generator.UpdateGeneratorRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_generator.UpdateGeneratorRequest, Sequence[Tuple[str, str]]]:

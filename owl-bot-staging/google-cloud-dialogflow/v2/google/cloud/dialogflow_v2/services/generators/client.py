...
class GeneratorsClient(metaclass=GeneratorsClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow_v2.GeneratorsClient`.",
                    extra = {
    ...
    def create_generator(self,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.CreateGeneratorRequest, dict]):
    ...
    def get_generator(self,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.GetGeneratorRequest, dict]):
    ...
    def list_generators(self,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.ListGeneratorsRequest, dict]):
    ...
    def delete_generator(self,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.DeleteGeneratorRequest, dict]):
    ...
    def update_generator(self,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.UpdateGeneratorRequest, dict]):

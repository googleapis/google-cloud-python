...
class FulfillmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_fulfillment(self, request: fulfillment.GetFulfillmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[fulfillment.GetFulfillmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_fulfillment(self, request: gcd_fulfillment.UpdateFulfillmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_fulfillment.UpdateFulfillmentRequest, Sequence[Tuple[str, str]]]:

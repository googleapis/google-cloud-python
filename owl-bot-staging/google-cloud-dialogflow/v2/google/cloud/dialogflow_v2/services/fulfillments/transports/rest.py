...
class FulfillmentsRestInterceptor:
    """Interceptor for Fulfillments.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the FulfillmentsRestTransport.

    .. code-block:: python
        class MyCustomFulfillmentsInterceptor(FulfillmentsRestInterceptor):
            def pre_get_fulfillment(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_fulfillment(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_update_fulfillment(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_fulfillment(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = FulfillmentsRestTransport(interceptor=MyCustomFulfillmentsInterceptor())
        client = FulfillmentsClient(transport=transport)


    """
    def pre_get_fulfillment(self, request: fulfillment.GetFulfillmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[fulfillment.GetFulfillmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for get_fulfillment

        Override in a subclass to manipulate the request or metadata
        before they are sent to the Fulfillments server.
        """
        return request, metadata
    ...
    def post_get_fulfillment(self, response: fulfillment.Fulfillment) -> fulfillment.Fulfillment:
        ...
        after it is returned by the Fulfillments server but before
        it is returned to user code. This `post_get_fulfillment` interceptor runs
        before the `post_get_fulfillment_with_metadata` interceptor.
        """
        return response

    def post_get_fulfillment_with_metadata(self, response: fulfillment.Fulfillment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[fulfillment.Fulfillment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_fulfillment

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the Fulfillments server but before it is returned to user code.

        We recommend only using this `post_get_fulfillment_with_metadata`
        interceptor in new development instead of the `post_get_fulfillment` interceptor.
        When both interceptors are used, this `post_get_fulfillment_with_metadata` interceptor runs after the
        `post_get_fulfillment` interceptor. The (possibly modified) response returned by
        `post_get_fulfillment` will be passed to
        `post_get_fulfillment_with_metadata`.
        """
        return response, metadata

    def pre_update_fulfillment(self, request: gcd_fulfillment.UpdateFulfillmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_fulfillment.UpdateFulfillmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_fulfillment(self, response: gcd_fulfillment.Fulfillment) -> gcd_fulfillment.Fulfillment:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the Fulfillments server but before
        it is returned to user code. This `post_update_fulfillment` interceptor runs
        before the `post_update_fulfillment_with_metadata` interceptor.
        """
        return response

    def post_update_fulfillment_with_metadata(self, response: gcd_fulfillment.Fulfillment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_fulfillment.Fulfillment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_fulfillment

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the Fulfillments server but before it is returned to user code.

        We recommend only using this `post_update_fulfillment_with_metadata`
        interceptor in new development instead of the `post_update_fulfillment` interceptor.
        When both interceptors are used, this `post_update_fulfillment_with_metadata` interceptor runs after the
        `post_update_fulfillment` interceptor. The (possibly modified) response returned by
        `post_update_fulfillment` will be passed to
...
class FulfillmentsRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: FulfillmentsRestInterceptor


class FulfillmentsRestTransport(_BaseFulfillmentsRestTransport):
    """REST backend synchronous transport for Fulfillments.
    ...
    def __init__(self, *,
            ...
            interceptor: Optional[FulfillmentsRestInterceptor] = None,
    ...
    class _GetFulfillment(_BaseFulfillmentsRestTransport._BaseGetFulfillment, FulfillmentsRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the get fulfillment method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.FulfillmentsClient.GetFulfillment",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
                        "rpcName": "GetFulfillment",
            ...
            # Send the request
            response = FulfillmentsRestTransport._GetFulfillment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            pb_resp = fulfillment.Fulfillment.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.FulfillmentsClient.get_fulfillment",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
                        "rpcName": "GetFulfillment",
    ...
    class _UpdateFulfillment(_BaseFulfillmentsRestTransport._BaseUpdateFulfillment, FulfillmentsRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the update fulfillment method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.FulfillmentsClient.UpdateFulfillment",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
                        "rpcName": "UpdateFulfillment",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = FulfillmentsRestTransport._UpdateFulfillment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            # Return the response
            resp = gcd_fulfillment.Fulfillment()
            pb_resp = gcd_fulfillment.Fulfillment.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.FulfillmentsClient.update_fulfillment",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
                        "rpcName": "UpdateFulfillment",
                        "metadata": http_response["headers"],
    ...
    class _GetLocation(_BaseFulfillmentsRestTransport._BaseGetLocation, FulfillmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.FulfillmentsClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = FulfillmentsRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.FulfillmentsAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(_BaseFulfillmentsRestTransport._BaseListLocations, FulfillmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.FulfillmentsClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
            ...
            # Send the request
            response = FulfillmentsRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.FulfillmentsAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseFulfillmentsRestTransport._BaseCancelOperation, FulfillmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.FulfillmentsClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
            ...
            # Send the request
            response = FulfillmentsRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseFulfillmentsRestTransport._BaseGetOperation, FulfillmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.FulfillmentsClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
            ...
            # Send the request
            response = FulfillmentsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.FulfillmentsAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseFulfillmentsRestTransport._BaseListOperations, FulfillmentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.FulfillmentsClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
            ...
            # Send the request
            response = FulfillmentsRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.FulfillmentsAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Fulfillments",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

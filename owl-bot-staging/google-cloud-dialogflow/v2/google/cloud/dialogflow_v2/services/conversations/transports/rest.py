...
from .base import ConversationsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ConversationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_complete_conversation(self, request: conversation.CompleteConversationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation.CompleteConversationRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_complete_conversation(self, response: conversation.Conversation) -> conversation.Conversation:
        ...
        """
        return response
    def pre_create_conversation(self, request: gcd_conversation.CreateConversationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_conversation.CreateConversationRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_conversation(self, response: gcd_conversation.Conversation) -> gcd_conversation.Conversation:
        ...
        """
        return response
    def pre_generate_stateless_suggestion(self, request: conversation.GenerateStatelessSuggestionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation.GenerateStatelessSuggestionRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_generate_stateless_suggestion(self, response: conversation.GenerateStatelessSuggestionResponse) -> conversation.GenerateStatelessSuggestionResponse:
        ...
        """
        return response
    def pre_generate_stateless_summary(self, request: conversation.GenerateStatelessSummaryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation.GenerateStatelessSummaryRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_generate_stateless_summary(self, response: conversation.GenerateStatelessSummaryResponse) -> conversation.GenerateStatelessSummaryResponse:
        ...
        """
        return response
    def pre_get_conversation(self, request: conversation.GetConversationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation.GetConversationRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_conversation(self, response: conversation.Conversation) -> conversation.Conversation:
        ...
        """
        return response
    def pre_list_conversations(self, request: conversation.ListConversationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation.ListConversationsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_conversations(self, response: conversation.ListConversationsResponse) -> conversation.ListConversationsResponse:
        ...
        """
        return response
    def pre_list_messages(self, request: conversation.ListMessagesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation.ListMessagesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_messages(self, response: conversation.ListMessagesResponse) -> conversation.ListMessagesResponse:
        ...
        """
        return response
    def pre_search_knowledge(self, request: conversation.SearchKnowledgeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation.SearchKnowledgeRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_search_knowledge(self, response: conversation.SearchKnowledgeResponse) -> conversation.SearchKnowledgeResponse:
        ...
        """
        return response
    def pre_suggest_conversation_summary(self, request: gcd_conversation.SuggestConversationSummaryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_conversation.SuggestConversationSummaryRequest, Sequence[Tuple[str, str]]]:
            ...
            },
{
    ...
    class _GenerateStatelessSuggestion(ConversationsRestStub):
        def __hash__(self):
            return hash("GenerateStatelessSuggestion")
        ...
        suggestion method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{parent=projects/*/locations/*}/statelessSuggestion:generate',
                'body': '*',
            },
            ]

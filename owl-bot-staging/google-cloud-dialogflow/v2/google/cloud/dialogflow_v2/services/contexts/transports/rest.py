...
class ContextsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_context(self, request: gcd_context.CreateContextRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_context.CreateContextRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_context_with_metadata(self, response: gcd_context.Context, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_context.Context, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_context
    ...
    def pre_delete_all_contexts(self, request: context.DeleteAllContextsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[context.DeleteAllContextsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_delete_context(self, request: context.DeleteContextRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[context.DeleteContextRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_context(self, request: context.GetContextRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[context.GetContextRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_context_with_metadata(self, response: context.Context, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[context.Context, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_context
    ...
    def pre_list_contexts(self, request: context.ListContextsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[context.ListContextsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_contexts_with_metadata(self, response: context.ListContextsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[context.ListContextsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_contexts
    ...
    def pre_update_context(self, request: gcd_context.UpdateContextRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_context.UpdateContextRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_context_with_metadata(self, response: gcd_context.Context, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_context.Context, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_context
    ...
    class _CreateContext(_BaseContextsRestTransport._BaseCreateContext, ContextsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ContextsClient.CreateContext",
                    extra = {
            ...
            # Send the request
            response = ContextsRestTransport._CreateContext._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ContextsClient.create_context",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
                        "rpcName": "CreateContext",
    ...
    class _DeleteAllContexts(_BaseContextsRestTransport._BaseDeleteAllContexts, ContextsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ContextsClient.DeleteAllContexts",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
            ...
            # Send the request
            response = ContextsRestTransport._DeleteAllContexts._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteContext(_BaseContextsRestTransport._BaseDeleteContext, ContextsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ContextsClient.DeleteContext",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
            ...
            # Send the request
            response = ContextsRestTransport._DeleteContext._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetContext(_BaseContextsRestTransport._BaseGetContext, ContextsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ContextsClient.GetContext",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
                        "rpcName": "GetContext",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ContextsClient.get_context",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
                        "rpcName": "GetContext",
                        "metadata": http_response["headers"],
    ...
    class _ListContexts(_BaseContextsRestTransport._BaseListContexts, ContextsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ContextsClient.ListContexts",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
            ...
            # Send the request
            response = ContextsRestTransport._ListContexts._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ContextsClient.list_contexts",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
                        "rpcName": "ListContexts",
                        "metadata": http_response["headers"],
    ...
    class _UpdateContext(_BaseContextsRestTransport._BaseUpdateContext, ContextsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ContextsClient.UpdateContext",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
            ...
            # Send the request
            response = ContextsRestTransport._UpdateContext._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ContextsClient.update_context",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
                        "rpcName": "UpdateContext",
                        "metadata": http_response["headers"],
    ...
    class _GetLocation(_BaseContextsRestTransport._BaseGetLocation, ContextsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ContextsClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = ContextsRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ContextsAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(_BaseContextsRestTransport._BaseListLocations, ContextsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ContextsClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
            ...
            # Send the request
            response = ContextsRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ContextsAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseContextsRestTransport._BaseCancelOperation, ContextsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ContextsClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
            ...
            # Send the request
            response = ContextsRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseContextsRestTransport._BaseGetOperation, ContextsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ContextsClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
            ...
            # Send the request
            response = ContextsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ContextsAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseContextsRestTransport._BaseListOperations, ContextsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ContextsClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
            ...
            # Send the request
            response = ContextsRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ContextsAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.v2.Contexts",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

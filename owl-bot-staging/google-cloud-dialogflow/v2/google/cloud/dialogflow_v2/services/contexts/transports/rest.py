...
class ContextsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_context(self, request: gcd_context.CreateContextRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_context.CreateContextRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_all_contexts(self, request: context.DeleteAllContextsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[context.DeleteAllContextsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_context(self, request: context.DeleteContextRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[context.DeleteContextRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_context(self, request: context.GetContextRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[context.GetContextRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_contexts(self, request: context.ListContextsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[context.ListContextsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_context(self, request: gcd_context.UpdateContextRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_context.UpdateContextRequest, Sequence[Tuple[str, str]]]:

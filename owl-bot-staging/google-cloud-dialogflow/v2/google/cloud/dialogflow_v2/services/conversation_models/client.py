...
class ConversationModelsClient(metaclass=ConversationModelsClientMeta):
    ...
    @staticmethod
    def conversation_model_evaluation_path(project: str,conversation_model: str,evaluation: str,) -> str:
        """Returns a fully-qualified conversation_model_evaluation string."""
        return "projects/{project}/conversationModels/{conversation_model}/evaluations/{evaluation}".format(project=project, conversation_model=conversation_model, evaluation=evaluation, )
    ...
    def parse_conversation_model_evaluation_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/conversationModels/(?P<conversation_model>.+?)/evaluations/(?P<evaluation>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ConversationModelsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ConversationModelsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ConversationModelsTransport, Callable[..., ConversationModelsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ConversationModelsClient._read_environment_variables()
        self._client_cert_source = ConversationModelsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ConversationModelsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ConversationModelsTransport], Callable[..., ConversationModelsTransport]] = (
    ...
    def create_conversation_model(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_conversation_model]
    ...
    def list_conversation_models(self,
    ...
    def delete_conversation_model(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_conversation_model]
    ...
    def deploy_conversation_model(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.deploy_conversation_model]
    ...
    def undeploy_conversation_model(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.undeploy_conversation_model]
    ...
    def get_conversation_model_evaluation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_conversation_model_evaluation]
    ...
    def list_conversation_model_evaluations(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_conversation_model_evaluations]
    ...
    def create_conversation_model_evaluation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_conversation_model_evaluation]

...
class ConversationModelsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_conversation_model(self, request: gcd_conversation_model.CreateConversationModelRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_conversation_model.CreateConversationModelRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_conversation_model_evaluation(self, request: conversation_model.CreateConversationModelEvaluationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation_model.CreateConversationModelEvaluationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_conversation_model(self, request: conversation_model.DeleteConversationModelRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation_model.DeleteConversationModelRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_deploy_conversation_model(self, request: conversation_model.DeployConversationModelRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation_model.DeployConversationModelRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_conversation_model(self, request: conversation_model.GetConversationModelRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation_model.GetConversationModelRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_conversation_model_evaluation(self, request: conversation_model.GetConversationModelEvaluationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation_model.GetConversationModelEvaluationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_conversation_model_evaluations(self, request: conversation_model.ListConversationModelEvaluationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation_model.ListConversationModelEvaluationsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_conversation_models(self, request: conversation_model.ListConversationModelsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation_model.ListConversationModelsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_undeploy_conversation_model(self, request: conversation_model.UndeployConversationModelRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation_model.UndeployConversationModelRequest, Sequence[Tuple[str, str]]]:

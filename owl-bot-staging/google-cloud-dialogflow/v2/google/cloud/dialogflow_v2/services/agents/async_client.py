...
class AgentsAsyncClient:
    ...
    get_transport_class = functools.partial(type(AgentsClient).get_transport_class, type(AgentsClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, AgentsTransport, Callable[..., AgentsTransport]]] = "grpc_asyncio",
    ...
    async def get_agent(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.GetAgentRequest, dict]]):
    ...
    async def set_agent(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.SetAgentRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.set_agent]
    ...
    async def delete_agent(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.DeleteAgentRequest, dict]]):
                The request object. The request message for
    ...
    async def search_agents(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.SearchAgentsRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_agents]
    ...
    async def train_agent(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.TrainAgentRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.train_agent]
    ...
    async def export_agent(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.ExportAgentRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_agent]
    ...
    async def import_agent(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.ImportAgentRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_agent]
    ...
    async def restore_agent(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.RestoreAgentRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.restore_agent]
    ...
    async def get_validation_result(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.GetValidationResultRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_validation_result]

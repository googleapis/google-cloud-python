...
class ConversationDatasetsClient(metaclass=ConversationDatasetsClientMeta):
    ...
    @staticmethod
    def conversation_dataset_path(project: str,location: str,conversation_dataset: str,) -> str:
        """Returns a fully-qualified conversation_dataset string."""
        return "projects/{project}/locations/{location}/conversationDatasets/{conversation_dataset}".format(project=project, location=location, conversation_dataset=conversation_dataset, )

    @staticmethod
    def parse_conversation_dataset_path(path: str) -> Dict[str,str]:
        """Parses a conversation_dataset path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/conversationDatasets/(?P<conversation_dataset>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ConversationDatasetsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ConversationDatasetsClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ConversationDatasetsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ConversationDatasetsTransport, Callable[..., ConversationDatasetsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ConversationDatasetsClient._read_environment_variables()
        self._client_cert_source = ConversationDatasetsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ConversationDatasetsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ConversationDatasetsTransport)
        if transport_provided:
            ...
            self._transport = cast(ConversationDatasetsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            ConversationDatasetsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ConversationDatasetsTransport], Callable[..., ConversationDatasetsTransport]] = (
    ...
    def create_conversation_dataset(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_conversation_dataset]
    ...
    def get_conversation_dataset(self,
    ...
    def list_conversation_datasets(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_conversation_datasets]
    ...
    def delete_conversation_dataset(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_conversation_dataset]
    ...
    def import_conversation_data(self,

...
class ParticipantsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_analyze_content(self, request: gcd_participant.AnalyzeContentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_participant.AnalyzeContentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_participant(self, request: gcd_participant.CreateParticipantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_participant.CreateParticipantRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_participant(self, request: participant.GetParticipantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[participant.GetParticipantRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_participants(self, request: participant.ListParticipantsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[participant.ListParticipantsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_suggest_articles(self, request: participant.SuggestArticlesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[participant.SuggestArticlesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_suggest_faq_answers(self, request: participant.SuggestFaqAnswersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[participant.SuggestFaqAnswersRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_suggest_knowledge_assist(self, request: participant.SuggestKnowledgeAssistRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[participant.SuggestKnowledgeAssistRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_suggest_smart_replies(self, request: participant.SuggestSmartRepliesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[participant.SuggestSmartRepliesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_participant(self, request: gcd_participant.UpdateParticipantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcd_participant.UpdateParticipantRequest, Sequence[Tuple[str, str]]]:

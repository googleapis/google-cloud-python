...
class DocumentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_document(self, request: gcd_document.CreateDocumentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_document.CreateDocumentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_document(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    def post_create_document_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_document

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the Documents server but before it is returned to user code.
    ...
    def pre_delete_document(self, request: document.DeleteDocumentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document.DeleteDocumentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_document(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        """Post-rpc interceptor for delete_document

        DEPRECATED. Please use the `post_delete_document_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the Documents server but before
        it is returned to user code. This `post_delete_document` interceptor runs
        before the `post_delete_document_with_metadata` interceptor.
        """
        return response

    def post_delete_document_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_document

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the Documents server but before it is returned to user code.

        We recommend only using this `post_delete_document_with_metadata`
        interceptor in new development instead of the `post_delete_document` interceptor.
        When both interceptors are used, this `post_delete_document_with_metadata` interceptor runs after the
        `post_delete_document` interceptor. The (possibly modified) response returned by
        `post_delete_document` will be passed to
        `post_delete_document_with_metadata`.
        """
        return response, metadata

    def pre_export_document(self, request: document.ExportDocumentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document.ExportDocumentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_export_document(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        """Post-rpc interceptor for export_document

        DEPRECATED. Please use the `post_export_document_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the Documents server but before
        it is returned to user code. This `post_export_document` interceptor runs
        before the `post_export_document_with_metadata` interceptor.
        """
        return response

    def post_export_document_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_document

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the Documents server but before it is returned to user code.

        We recommend only using this `post_export_document_with_metadata`
        interceptor in new development instead of the `post_export_document` interceptor.
        When both interceptors are used, this `post_export_document_with_metadata` interceptor runs after the
        `post_export_document` interceptor. The (possibly modified) response returned by
        `post_export_document` will be passed to
        `post_export_document_with_metadata`.
        """
        return response, metadata

    def pre_get_document(self, request: document.GetDocumentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document.GetDocumentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_document_with_metadata(self, response: document.Document, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document.Document, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_document
    ...
    def pre_import_documents(self, request: document.ImportDocumentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document.ImportDocumentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_import_documents_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for import_documents
    ...
    def pre_list_documents(self, request: document.ListDocumentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document.ListDocumentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_documents(self, response: document.ListDocumentsResponse) -> document.ListDocumentsResponse:
    ...
    def post_list_documents_with_metadata(self, response: document.ListDocumentsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document.ListDocumentsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_documents
    ...
    def pre_reload_document(self, request: document.ReloadDocumentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document.ReloadDocumentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_reload_document(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        """Post-rpc interceptor for reload_document

        DEPRECATED. Please use the `post_reload_document_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the Documents server but before
        it is returned to user code. This `post_reload_document` interceptor runs
        before the `post_reload_document_with_metadata` interceptor.
        """
        return response

    def post_reload_document_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for reload_document

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the Documents server but before it is returned to user code.

        We recommend only using this `post_reload_document_with_metadata`
        interceptor in new development instead of the `post_reload_document` interceptor.
        When both interceptors are used, this `post_reload_document_with_metadata` interceptor runs after the
        `post_reload_document` interceptor. The (possibly modified) response returned by
        `post_reload_document` will be passed to
        `post_reload_document_with_metadata`.
        """
        return response, metadata

    def pre_update_document(self, request: gcd_document.UpdateDocumentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_document.UpdateDocumentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_document(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    def post_update_document_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_document
...
class DocumentsRestTransport(_BaseDocumentsRestTransport):
    ...
    class _CreateDocument(_BaseDocumentsRestTransport._BaseCreateDocument, DocumentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseCreateDocument._get_http_options()

            request, metadata = self._interceptor.pre_create_document(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseCreateDocument._get_transcoded_request(http_options, request)

            body = _BaseDocumentsRestTransport._BaseCreateDocument._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseCreateDocument._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._CreateDocument._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteDocument(_BaseDocumentsRestTransport._BaseDeleteDocument, DocumentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseDeleteDocument._get_http_options()

            request, metadata = self._interceptor.pre_delete_document(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseDeleteDocument._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseDeleteDocument._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._DeleteDocument._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_delete_document_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _ExportDocument(_BaseDocumentsRestTransport._BaseExportDocument, DocumentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseExportDocument._get_http_options()

            request, metadata = self._interceptor.pre_export_document(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseExportDocument._get_transcoded_request(http_options, request)

            body = _BaseDocumentsRestTransport._BaseExportDocument._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseExportDocument._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._ExportDocument._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_export_document_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _GetDocument(_BaseDocumentsRestTransport._BaseGetDocument, DocumentsRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseGetDocument._get_http_options()

            request, metadata = self._interceptor.pre_get_document(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseGetDocument._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseGetDocument._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._GetDocument._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ImportDocuments(_BaseDocumentsRestTransport._BaseImportDocuments, DocumentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseImportDocuments._get_http_options()

            request, metadata = self._interceptor.pre_import_documents(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseImportDocuments._get_transcoded_request(http_options, request)

            body = _BaseDocumentsRestTransport._BaseImportDocuments._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseImportDocuments._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._ImportDocuments._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListDocuments(_BaseDocumentsRestTransport._BaseListDocuments, DocumentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseListDocuments._get_http_options()

            request, metadata = self._interceptor.pre_list_documents(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseListDocuments._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseListDocuments._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._ListDocuments._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ReloadDocument(_BaseDocumentsRestTransport._BaseReloadDocument, DocumentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseReloadDocument._get_http_options()

            request, metadata = self._interceptor.pre_reload_document(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseReloadDocument._get_transcoded_request(http_options, request)

            body = _BaseDocumentsRestTransport._BaseReloadDocument._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseReloadDocument._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._ReloadDocument._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_reload_document_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _UpdateDocument(_BaseDocumentsRestTransport._BaseUpdateDocument, DocumentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseUpdateDocument._get_http_options()

            request, metadata = self._interceptor.pre_update_document(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseUpdateDocument._get_transcoded_request(http_options, request)

            body = _BaseDocumentsRestTransport._BaseUpdateDocument._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseUpdateDocument._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._UpdateDocument._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetLocation(_BaseDocumentsRestTransport._BaseGetLocation, DocumentsRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseGetLocation._get_http_options()

            request, metadata = self._interceptor.pre_get_location(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseGetLocation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseGetLocation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseDocumentsRestTransport._BaseListLocations, DocumentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseListLocations._get_http_options()

            request, metadata = self._interceptor.pre_list_locations(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseListLocations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseListLocations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BaseDocumentsRestTransport._BaseCancelOperation, DocumentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = self._interceptor.pre_cancel_operation(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseDocumentsRestTransport._BaseGetOperation, DocumentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseGetOperation._get_http_options()

            request, metadata = self._interceptor.pre_get_operation(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseDocumentsRestTransport._BaseListOperations, DocumentsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDocumentsRestTransport._BaseListOperations._get_http_options()

            request, metadata = self._interceptor.pre_list_operations(request, metadata)
            transcoded_request = _BaseDocumentsRestTransport._BaseListOperations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDocumentsRestTransport._BaseListOperations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DocumentsRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
from google.cloud.dialogflow_v2.services.generators import GeneratorsAsyncClient
from google.cloud.dialogflow_v2.services.generators import GeneratorsClient
from google.cloud.dialogflow_v2.services.generators import pagers
from google.cloud.dialogflow_v2.services.generators import transports
...
def test_generators_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflow_v2.services.generators.transports.GeneratorsGrpcTransport.__init__') as grpc_transport:
...
def test_create_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2/{parent=projects/*/locations/*}/generators" % client.transport._host, args[1])
...
def test_get_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/locations/*/generators/*}" % client.transport._host, args[1])
...
def test_update_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{generator.name=projects/*/locations/*/generators/*}" % client.transport._host, args[1])
...
def test_generators_base_transport():
    ...
    with mock.patch('google.cloud.dialogflow_v2.services.generators.transports.GeneratorsTransport.__init__') as Transport:
...
def test_generators_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2.services.generators.transports.GeneratorsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_generators_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2.services.generators.transports.GeneratorsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GeneratorsTransport()
        adc.assert_called_once()

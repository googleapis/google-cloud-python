...
def test__get_api_endpoint():
    ...
    assert ConversationModelsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ConversationModelsClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert ConversationModelsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ConversationModelsClient.DEFAULT_MTLS_ENDPOINT
...
def test_create_conversation_model_rest_required_fields(request_type=gcd_conversation_model.CreateConversationModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_conversation_model._get_unset_required_fields(jsonified_request)
...
def test_create_conversation_model_rest_unset_required_fields():
    transport = transports.ConversationModelsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_conversation_model_rest_required_fields(request_type=conversation_model.GetConversationModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_conversation_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_conversation_models_rest_required_fields(request_type=conversation_model.ListConversationModelsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_conversation_models._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_conversation_model_rest_required_fields(request_type=conversation_model.DeleteConversationModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_conversation_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_deploy_conversation_model_rest_required_fields(request_type=conversation_model.DeployConversationModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).deploy_conversation_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_undeploy_conversation_model_rest_required_fields(request_type=conversation_model.UndeployConversationModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).undeploy_conversation_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_conversation_model_evaluation_rest_required_fields(request_type=conversation_model.GetConversationModelEvaluationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_conversation_model_evaluation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_conversation_model_evaluations_rest_required_fields(request_type=conversation_model.ListConversationModelEvaluationsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_conversation_model_evaluations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_conversation_model_evaluation_rest_required_fields(request_type=conversation_model.CreateConversationModelEvaluationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_conversation_model_evaluation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

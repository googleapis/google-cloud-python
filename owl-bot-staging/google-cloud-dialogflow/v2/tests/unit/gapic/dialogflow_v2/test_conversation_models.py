...
def test_create_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationModelsRestInterceptor, "post_create_conversation_model_with_metadata") as post_with_metadata, \
...
def test_get_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationModelsRestInterceptor, "post_get_conversation_model_with_metadata") as post_with_metadata, \
...
def test_list_conversation_models_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationModelsRestInterceptor, "post_list_conversation_models_with_metadata") as post_with_metadata, \
...
def test_delete_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationModelsRestInterceptor, "post_delete_conversation_model_with_metadata") as post_with_metadata, \
...
def test_deploy_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationModelsRestInterceptor, "post_deploy_conversation_model_with_metadata") as post_with_metadata, \
...
def test_undeploy_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationModelsRestInterceptor, "post_undeploy_conversation_model_with_metadata") as post_with_metadata, \
...
def test_get_conversation_model_evaluation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationModelsRestInterceptor, "post_get_conversation_model_evaluation_with_metadata") as post_with_metadata, \
...
def test_list_conversation_model_evaluations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationModelsRestInterceptor, "post_list_conversation_model_evaluations_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_model.ListConversationModelEvaluationsResponse.to_json(conversation_model.ListConversationModelEvaluationsResponse())
        req.return_value.content = return_value
...
def test_create_conversation_model_evaluation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationModelsRestInterceptor, "post_create_conversation_model_evaluation_with_metadata") as post_with_metadata, \

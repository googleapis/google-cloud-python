...
def test_list_documents_rest_unset_required_fields():
    transport = transports.DocumentsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_reload_document_rest_required_fields(request_type=document.ReloadDocumentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).reload_document._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_document_rest_required_fields(request_type=document.ExportDocumentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).export_document._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

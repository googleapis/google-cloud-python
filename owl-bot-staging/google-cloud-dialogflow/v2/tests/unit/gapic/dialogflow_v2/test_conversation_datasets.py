...
def test_create_conversation_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationDatasetsRestInterceptor, "post_create_conversation_dataset_with_metadata") as post_with_metadata, \
...
def test_get_conversation_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationDatasetsRestInterceptor, "post_get_conversation_dataset_with_metadata") as post_with_metadata, \
...
def test_list_conversation_datasets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationDatasetsRestInterceptor, "post_list_conversation_datasets_with_metadata") as post_with_metadata, \
...
def test_delete_conversation_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationDatasetsRestInterceptor, "post_delete_conversation_dataset_with_metadata") as post_with_metadata, \
...
def test_import_conversation_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConversationDatasetsRestInterceptor, "post_import_conversation_data_with_metadata") as post_with_metadata, \

...
def test__get_api_endpoint():
    ...
    assert ConversationDatasetsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ConversationDatasetsClient.DEFAULT_MTLS_ENDPOINT
...
def test_create_conversation_dataset_rest_required_fields(request_type=gcd_conversation_dataset.CreateConversationDatasetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_conversation_dataset._get_unset_required_fields(jsonified_request)
...
def test_create_conversation_dataset_rest_unset_required_fields():
    transport = transports.ConversationDatasetsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_conversation_dataset_rest_required_fields(request_type=conversation_dataset.GetConversationDatasetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_conversation_dataset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_conversation_datasets_rest_required_fields(request_type=conversation_dataset.ListConversationDatasetsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_conversation_datasets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_conversation_dataset_rest_required_fields(request_type=conversation_dataset.DeleteConversationDatasetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_conversation_dataset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_conversation_data_rest_required_fields(request_type=conversation_dataset.ImportConversationDataRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).import_conversation_data._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

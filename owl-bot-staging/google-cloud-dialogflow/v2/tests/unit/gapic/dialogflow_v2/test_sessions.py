...
def test_detect_intent_rest_required_fields(request_type=gcd_session.DetectIntentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).detect_intent._get_unset_required_fields(jsonified_request)
...
def test_detect_intent_rest_unset_required_fields():
    transport = transports.SessionsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)

...
async def test_detect_intent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.detect_intent] = mock_object
...
async def test_streaming_detect_intent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.streaming_detect_intent] = mock_object
...
def test_detect_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = gcd_session.DetectIntentResponse.to_json(gcd_session.DetectIntentResponse())
...
def test_detect_intent_rest_bad_request(transport: str = 'rest', request_type=gcd_session.DetectIntentRequest):
    client = SessionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

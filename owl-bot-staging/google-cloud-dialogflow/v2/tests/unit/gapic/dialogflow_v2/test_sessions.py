...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SessionsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert SessionsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SessionsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert SessionsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SessionsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(SessionsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionsClient))
@mock.patch.object(SessionsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SessionsClient._DEFAULT_UNIVERSE
    default_endpoint = SessionsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SessionsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SessionsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SessionsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SessionsClient.DEFAULT_MTLS_ENDPOINT
    assert SessionsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SessionsClient._get_api_endpoint(None, None, default_universe, "always") == SessionsClient.DEFAULT_MTLS_ENDPOINT
    assert SessionsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SessionsClient.DEFAULT_MTLS_ENDPOINT
    assert SessionsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SessionsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SessionsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SessionsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SessionsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SessionsClient._get_universe_domain(None, None) == SessionsClient._DEFAULT_UNIVERSE
...
def test_sessions_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class", [
    SessionsClient, SessionsAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (SessionsAsyncClient, transports.SessionsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (SessionsClient, transports.SessionsRestTransport, "rest", None),
])
def test_sessions_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_sessions_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_detect_intent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.detect_intent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.detect_intent] = mock_rpc
...
def test_detect_intent_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = gcd_session.QueryInput(audio_config=audio_config.InputAudioConfig(audio_encoding=audio_config.AudioEncoding.AUDIO_ENCODING_LINEAR_16))
        assert arg == mock_val
...
def test_streaming_detect_intent_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.streaming_detect_intent in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.streaming_detect_intent] = mock_rpc
        request = [{}]
...
@pytest.mark.asyncio
async def test_streaming_detect_intent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SessionsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.streaming_detect_intent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.streaming_detect_intent] = mock_rpc
...
def test_detect_intent_rest_required_fields(request_type=gcd_session.DetectIntentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).detect_intent._get_unset_required_fields(jsonified_request)
    ...
    return_value = gcd_session.DetectIntentResponse()
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = gcd_session.DetectIntentResponse.pb(return_value)
...
def test_detect_intent_rest_unset_required_fields():
    transport = transports.SessionsRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.detect_intent._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("session", "queryInput", )))


def test_detect_intent_rest_flattened():
    client = SessionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'session': 'projects/sample1/agent/sessions/sample2'}
        ...
        client.detect_intent(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{session=projects/*/agent/sessions/*}:detectIntent" % client.transport._host, args[1])


def test_detect_intent_rest_flattened_error(transport: str = 'rest'):
    client = SessionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_detect_intent_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = gcd_session.DetectIntentRequest()
...
def test_detect_intent_rest_bad_request(request_type=gcd_session.DetectIntentRequest):
    client = SessionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'session': 'projects/sample1/agent/sessions/sample2'}
    request = request_type(**request_init)
...
def test_detect_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SessionsRestInterceptor, "post_detect_intent") as post, \
        mock.patch.object(transports.SessionsRestInterceptor, "post_detect_intent_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SessionsRestInterceptor, "pre_detect_intent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcd_session.DetectIntentRequest.pb(gcd_session.DetectIntentRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_session.DetectIntentResponse.to_json(gcd_session.DetectIntentResponse())
        ...
        post.return_value = gcd_session.DetectIntentResponse()
        post_with_metadata.return_value = gcd_session.DetectIntentResponse(), metadata

        client.detect_intent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_sessions_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2.services.sessions.transports.SessionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_sessions_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2.services.sessions.transports.SessionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SessionsTransport()
        adc.assert_called_once()

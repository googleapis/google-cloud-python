...
from google.cloud.dialogflow_v2.services.encryption_spec_service import EncryptionSpecServiceAsyncClient
from google.cloud.dialogflow_v2.services.encryption_spec_service import EncryptionSpecServiceClient
from google.cloud.dialogflow_v2.services.encryption_spec_service import transports
...
def test__get_api_endpoint():
    ...
    assert EncryptionSpecServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == EncryptionSpecServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert EncryptionSpecServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EncryptionSpecServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    EncryptionSpecServiceClient, EncryptionSpecServiceAsyncClient
])
...
def test_encryption_spec_service_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflow_v2.services.encryption_spec_service.transports.EncryptionSpecServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_encryption_spec(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.get_encryption_spec),
            '__call__') as call:
...
async def test_get_encryption_spec_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.get_encryption_spec] = mock_object
...
def test_initialize_encryption_spec(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.initialize_encryption_spec),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_initialize_encryption_spec_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.initialize_encryption_spec] = mock_object
...
def test_get_encryption_spec_rest_required_fields(request_type=encryption_spec.GetEncryptionSpecRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_encryption_spec._get_unset_required_fields(jsonified_request)
...
def test_get_encryption_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.EncryptionSpecServiceRestInterceptor, "post_get_encryption_spec") as post, \
         mock.patch.object(transports.EncryptionSpecServiceRestInterceptor, "pre_get_encryption_spec") as pre:
        ...
        req.return_value._content = encryption_spec.EncryptionSpec.to_json(encryption_spec.EncryptionSpec())
        ...
        client.get_encryption_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_encryption_spec_rest_bad_request(transport: str = 'rest', request_type=encryption_spec.GetEncryptionSpecRequest):
    client = EncryptionSpecServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_encryption_spec_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2/{name=projects/*/locations/*/encryptionSpec}" % client.transport._host, args[1])
...
def test_initialize_encryption_spec_rest_required_fields(request_type=gcd_encryption_spec.InitializeEncryptionSpecRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).initialize_encryption_spec._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_initialize_encryption_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.EncryptionSpecServiceRestInterceptor, "post_initialize_encryption_spec") as post, \
         mock.patch.object(transports.EncryptionSpecServiceRestInterceptor, "pre_initialize_encryption_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.initialize_encryption_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_initialize_encryption_spec_rest_bad_request(transport: str = 'rest', request_type=gcd_encryption_spec.InitializeEncryptionSpecRequest):
    client = EncryptionSpecServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_initialize_encryption_spec_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{encryption_spec.name=projects/*/locations/*/encryptionSpec}:initialize" % client.transport._host, args[1])
...
def test_encryption_spec_service_base_transport():
    ...
    with mock.patch('google.cloud.dialogflow_v2.services.encryption_spec_service.transports.EncryptionSpecServiceTransport.__init__') as Transport:
...
def test_encryption_spec_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2.services.encryption_spec_service.transports.EncryptionSpecServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_encryption_spec_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2.services.encryption_spec_service.transports.EncryptionSpecServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EncryptionSpecServiceTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.EncryptionSpecServiceGrpcTransport, transports.EncryptionSpecServiceGrpcAsyncIOTransport])
def test_encryption_spec_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_encryption_spec_path():
    project = "squid"
    location = "clam"
    expected = "projects/{project}/locations/{location}/encryptionSpec".format(project=project, location=location, )

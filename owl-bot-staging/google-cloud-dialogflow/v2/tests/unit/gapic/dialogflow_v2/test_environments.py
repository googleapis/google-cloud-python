...
@pytest.mark.asyncio
async def test_get_environment_history_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = EnvironmentsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.get_environment_history()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == environment.GetEnvironmentHistoryRequest()
...
async def test_get_environment_history_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_environment_history] = mock_object
...
def test_create_environment_rest_bad_request(transport: str = 'rest', request_type=environment.CreateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_environment_rest_bad_request(transport: str = 'rest', request_type=environment.UpdateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_environment_history_rest(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_environment_history_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = environment.EnvironmentHistory.to_json(environment.EnvironmentHistory())
...
def test_get_environment_history_rest_bad_request(transport: str = 'rest', request_type=environment.GetEnvironmentHistoryRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

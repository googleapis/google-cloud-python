...
def test_get_environment_history_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.get_environment_history(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_get_environment_history_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EnvironmentsClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_environment_history in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_environment_history] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_environment_history_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_environment_history in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_environment_history] = mock_rpc
...
def test_get_environment_history_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.get_environment_history(request={}, retry=retry, timeout=timeout)
...
def test_list_environments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2/{parent=projects/*/agent}/environments" % client.transport._host, args[1])
...
def test_create_environment_rest_required_fields(request_type=environment.CreateEnvironmentRequest):
    transport_class = transports.EnvironmentsRestTransport
...
def test_create_environment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("environmentId", )) & set(("parent", "environment", "environmentId", )))
...
def test_update_environment_rest_required_fields(request_type=environment.UpdateEnvironmentRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_environment._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("allow_load_to_draft_and_discard_changes", "update_mask", ))
    jsonified_request.update(unset_fields)
...
def test_update_environment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowLoadToDraftAndDiscardChanges", "updateMask", )) & set(("environment", "updateMask", )))
...
def test_get_environment_history_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EnvironmentsClient(
...
def test_get_environment_history_rest_required_fields(request_type=environment.GetEnvironmentHistoryRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_environment_history._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = environment.EnvironmentHistory()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = environment.EnvironmentHistory.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_environment_history_rest_unset_required_fields():
    transport = transports.EnvironmentsRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.get_environment_history._get_unset_required_fields({})
    assert set(unset_fields) == (set(("pageSize", "pageToken", )) & set(("parent", )))


def test_get_environment_history_rest_pager(transport: str = 'rest'):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(environment.EnvironmentHistory.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        sample_request = {'parent': 'projects/sample1/agent/environments/sample2'}

        pager = client.get_environment_history(request=sample_request)
        ...
        pages = list(client.get_environment_history(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_environment_history_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environment.EnvironmentHistory()
        client.get_environment_history(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = environment.GetEnvironmentHistoryRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_environment_history_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_environment_history(request=None)
...
def test_get_environment_rest_bad_request(request_type=environment.GetEnvironmentRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/agent/environments/sample2'}
    request = request_type(**request_init)
...
def test_create_environment_rest_bad_request(request_type=environment.CreateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environment.CreateEnvironmentRequest.pb(environment.CreateEnvironmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_environment_rest_bad_request(request_type=environment.UpdateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'environment': {'name': 'projects/sample1/agent/environments/sample2'}}
    request = request_type(**request_init)
...
def test_update_environment_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'environment': {'name': 'projects/sample1/agent/environments/sample2'}}
    request_init["environment"] = {'name': 'projects/sample1/agent/environments/sample2', 'description': 'description_value', 'agent_version': 'agent_version_value', 'state': 1, 'update_time': {'seconds': 751, 'nanos': 543}, 'text_to_speech_settings': {'enable_text_to_speech': True, 'output_audio_encoding': 1, 'sample_rate_hertz': 1817, 'synthesize_speech_configs': {}}, 'fulfillment': {'name': 'name_value', 'display_name': 'display_name_value', 'generic_web_service': {'uri': 'uri_value', 'username': 'username_value', 'password': 'password_value', 'request_headers': {}, 'is_cloud_function': True}, 'enabled': True, 'features': [{'type_': 1}]}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environment.UpdateEnvironmentRequest.pb(environment.UpdateEnvironmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_environment_history_rest_bad_request(request_type=environment.GetEnvironmentHistoryRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/agent/environments/sample2'}
    request = request_type(**request_init)
...
def test_get_environment_history_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_environment_history_rest_interceptors(null_interceptor):
    transport = transports.EnvironmentsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.EnvironmentsRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_get_environment_history") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_get_environment_history_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_get_environment_history") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environment.GetEnvironmentHistoryRequest.pb(environment.GetEnvironmentHistoryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environment.EnvironmentHistory.to_json(environment.EnvironmentHistory())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = environment.EnvironmentHistory()
        post_with_metadata.return_value = environment.EnvironmentHistory(), metadata

        client.get_environment_history(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_environment_history_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_environments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2.services.environments.transports.EnvironmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_environments_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2.services.environments.transports.EnvironmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EnvironmentsTransport()
        adc.assert_called_once()
...
def test_environments_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.get_environment_history._session
    session2 = client2.transport.get_environment_history._session
    assert session1 != session2

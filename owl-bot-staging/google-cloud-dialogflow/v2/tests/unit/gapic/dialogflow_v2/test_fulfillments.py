...
def test_get_fulfillment_rest_required_fields(request_type=fulfillment.GetFulfillmentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_fulfillment._get_unset_required_fields(jsonified_request)
...
def test_get_fulfillment_rest_unset_required_fields():
    transport = transports.FulfillmentsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_fulfillment_rest_required_fields(request_type=gcd_fulfillment.UpdateFulfillmentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_fulfillment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
@pytest.mark.parametrize("client_class", [
    FulfillmentsClient, FulfillmentsAsyncClient
])
...
def test_transport_kind_grpc_asyncio():
    transport = FulfillmentsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = FulfillmentsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_get_fulfillment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FulfillmentsRestInterceptor, "post_get_fulfillment") as post, \
        mock.patch.object(transports.FulfillmentsRestInterceptor, "post_get_fulfillment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FulfillmentsRestInterceptor, "pre_get_fulfillment") as pre:
...
def test_update_fulfillment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FulfillmentsRestInterceptor, "post_update_fulfillment") as post, \
        mock.patch.object(transports.FulfillmentsRestInterceptor, "post_update_fulfillment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FulfillmentsRestInterceptor, "pre_update_fulfillment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

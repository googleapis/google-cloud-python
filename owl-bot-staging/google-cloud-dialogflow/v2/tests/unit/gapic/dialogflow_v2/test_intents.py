...
def test_list_intents_rest_required_fields(request_type=intent.ListIntentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_intents._get_unset_required_fields(jsonified_request)
...
def test_list_intents_rest_unset_required_fields():
    transport = transports.IntentsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_intent_rest_required_fields(request_type=intent.GetIntentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_intent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_intent_rest_required_fields(request_type=gcd_intent.CreateIntentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_intent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_intent_rest_required_fields(request_type=gcd_intent.UpdateIntentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_intent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_intent_rest_required_fields(request_type=intent.DeleteIntentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_intent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_intents_rest_required_fields(request_type=intent.BatchUpdateIntentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_update_intents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_delete_intents_rest_required_fields(request_type=intent.BatchDeleteIntentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_delete_intents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

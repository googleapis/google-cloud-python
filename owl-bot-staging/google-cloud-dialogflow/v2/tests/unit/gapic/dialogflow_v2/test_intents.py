...
@pytest.mark.parametrize("client_class", [
    IntentsClient, IntentsAsyncClient
])
...
def test_batch_update_intents(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_update_intents),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_batch_delete_intents(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_delete_intents),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_intent_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = gcd_intent.CreateIntentRequest()
...
def test_update_intent_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = gcd_intent.UpdateIntentRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_intents_empty_call_grpc():
    client = IntentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_intents_empty_call_grpc():
    client = IntentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = intent.BatchDeleteIntentsRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_update_intents_empty_call_grpc_asyncio():
    client = IntentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_delete_intents_empty_call_grpc_asyncio():
    client = IntentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_list_intents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IntentsRestInterceptor, "post_list_intents") as post, \
        mock.patch.object(transports.IntentsRestInterceptor, "post_list_intents_with_metadata") as post_with_metadata, \
...
def test_get_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IntentsRestInterceptor, "post_get_intent_with_metadata") as post_with_metadata, \
...
def test_create_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IntentsRestInterceptor, "post_create_intent") as post, \
        mock.patch.object(transports.IntentsRestInterceptor, "post_create_intent_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IntentsRestInterceptor, "pre_create_intent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_intent.Intent.to_json(gcd_intent.Intent())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcd_intent.Intent(), metadata
...
def test_update_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IntentsRestInterceptor, "post_update_intent") as post, \
        mock.patch.object(transports.IntentsRestInterceptor, "post_update_intent_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IntentsRestInterceptor, "pre_update_intent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IntentsRestInterceptor, "pre_delete_intent") as pre:
        pre.assert_not_called()
...
def test_batch_update_intents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IntentsRestInterceptor, "post_batch_update_intents") as post, \
        mock.patch.object(transports.IntentsRestInterceptor, "post_batch_update_intents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IntentsRestInterceptor, "pre_batch_update_intents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_batch_delete_intents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.IntentsRestInterceptor, "post_batch_delete_intents") as post, \
        mock.patch.object(transports.IntentsRestInterceptor, "post_batch_delete_intents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IntentsRestInterceptor, "pre_batch_delete_intents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_intents_empty_call_rest():
    client = IntentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_intents_empty_call_rest():
    client = IntentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

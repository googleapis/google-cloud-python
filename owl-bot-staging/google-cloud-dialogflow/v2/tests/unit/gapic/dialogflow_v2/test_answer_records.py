...
def test__get_api_endpoint():
    ...
    assert AnswerRecordsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AnswerRecordsClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    AnswerRecordsClient, AnswerRecordsAsyncClient
])
...
def test_list_answer_records_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AnswerRecordsRestInterceptor, "post_list_answer_records") as post, \
        mock.patch.object(transports.AnswerRecordsRestInterceptor, "post_list_answer_records_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AnswerRecordsRestInterceptor, "pre_list_answer_records") as pre:
...
def test_update_answer_record_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AnswerRecordsRestInterceptor, "post_update_answer_record") as post, \
        mock.patch.object(transports.AnswerRecordsRestInterceptor, "post_update_answer_record_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AnswerRecordsRestInterceptor, "pre_update_answer_record") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
@pytest.mark.parametrize("transport_class", [transports.AnswerRecordsGrpcTransport, transports.AnswerRecordsGrpcAsyncIOTransport])
def test_answer_records_transport_channel_mtls_with_client_cert_source(
    transport_class
):

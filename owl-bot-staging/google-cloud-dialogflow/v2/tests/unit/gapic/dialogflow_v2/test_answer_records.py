...
def test_list_answer_records_rest_required_fields(request_type=answer_record.ListAnswerRecordsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_answer_records._get_unset_required_fields(jsonified_request)
...
def test_list_answer_records_rest_unset_required_fields():
    transport = transports.AnswerRecordsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_answer_record_rest_required_fields(request_type=gcd_answer_record.UpdateAnswerRecordRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_answer_record._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

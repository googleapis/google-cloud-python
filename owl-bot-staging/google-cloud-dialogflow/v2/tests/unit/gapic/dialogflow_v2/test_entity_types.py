...
def test_list_entity_types_rest_required_fields(request_type=entity_type.ListEntityTypesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_entity_types._get_unset_required_fields(jsonified_request)
...
def test_list_entity_types_rest_unset_required_fields():
    transport = transports.EntityTypesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_entity_type_rest_required_fields(request_type=entity_type.GetEntityTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_entity_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_entity_type_rest_required_fields(request_type=gcd_entity_type.CreateEntityTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_entity_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_entity_type_rest_required_fields(request_type=gcd_entity_type.UpdateEntityTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_entity_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_entity_type_rest_required_fields(request_type=entity_type.DeleteEntityTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_entity_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_entity_types_rest_required_fields(request_type=entity_type.BatchUpdateEntityTypesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_update_entity_types._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_delete_entity_types_rest_required_fields(request_type=entity_type.BatchDeleteEntityTypesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_delete_entity_types._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_entities_rest_required_fields(request_type=entity_type.BatchCreateEntitiesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_create_entities._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_entities_rest_required_fields(request_type=entity_type.BatchUpdateEntitiesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_update_entities._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_delete_entities_rest_required_fields(request_type=entity_type.BatchDeleteEntitiesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_delete_entities._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

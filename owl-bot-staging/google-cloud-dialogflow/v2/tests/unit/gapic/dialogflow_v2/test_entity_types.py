...
def test__read_environment_variables():
    assert EntityTypesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert EntityTypesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert EntityTypesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert EntityTypesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert EntityTypesClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert EntityTypesClient._get_client_cert_source(None, False) is None
    assert EntityTypesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert EntityTypesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert EntityTypesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert EntityTypesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(EntityTypesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EntityTypesClient))
@mock.patch.object(EntityTypesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EntityTypesAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = EntityTypesClient._DEFAULT_UNIVERSE
    default_endpoint = EntityTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = EntityTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert EntityTypesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert EntityTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == EntityTypesClient.DEFAULT_MTLS_ENDPOINT
    assert EntityTypesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert EntityTypesClient._get_api_endpoint(None, None, default_universe, "always") == EntityTypesClient.DEFAULT_MTLS_ENDPOINT
    assert EntityTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EntityTypesClient.DEFAULT_MTLS_ENDPOINT
    assert EntityTypesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert EntityTypesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        EntityTypesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert EntityTypesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert EntityTypesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
...
@pytest.mark.parametrize("client_class", [
    EntityTypesClient, EntityTypesAsyncClient
])
...
@mock.patch.object(EntityTypesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EntityTypesClient))
@mock.patch.object(EntityTypesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EntityTypesAsyncClient))
def test_entity_types_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (EntityTypesAsyncClient, transports.EntityTypesGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_list_entity_types_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_entity_types] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_entity_types_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_entity_types in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_entity_types] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_entity_type_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_entity_type in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_entity_type] = mock_rpc
...
def test_create_entity_type_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_entity_type in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_entity_type] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_entity_type_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_entity_type in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_entity_type] = mock_rpc
...
def test_update_entity_type_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_entity_type in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_entity_type] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_entity_type_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_entity_type in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_entity_type] = mock_rpc
...
def test_delete_entity_type_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_entity_type in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_entity_type] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_entity_type_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_entity_type in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_entity_type] = mock_rpc
...
def test_batch_update_entity_types_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_batch_update_entity_types_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_update_entity_types in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_update_entity_types] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_update_entity_types_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_update_entity_types in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_update_entity_types] = mock_rpc
...
def test_batch_delete_entity_types_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_batch_delete_entity_types_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_delete_entity_types in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_delete_entity_types] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_delete_entity_types_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_delete_entity_types in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_delete_entity_types] = mock_rpc
...
def test_batch_create_entities_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_batch_create_entities_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_create_entities in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_create_entities] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_create_entities_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_create_entities in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_create_entities] = mock_rpc
...
def test_batch_update_entities_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_batch_update_entities_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_update_entities in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_update_entities] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_update_entities_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_update_entities in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_update_entities] = mock_rpc
...
def test_batch_delete_entities_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_batch_delete_entities_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_delete_entities in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_delete_entities] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_delete_entities_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_delete_entities in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_delete_entities] = mock_rpc
...
def test_batch_update_entity_types_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EntityTypesClient(
...
def test_batch_delete_entity_types_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EntityTypesClient(
...
def test_batch_create_entities_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EntityTypesClient(
...
def test_batch_update_entities_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EntityTypesClient(
...
def test_batch_delete_entities_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EntityTypesClient(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_entity_types_empty_call_grpc():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.batch_update_entity_types(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_entity_types_empty_call_grpc():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.batch_delete_entity_types(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_create_entities_empty_call_grpc():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.batch_create_entities(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_entities_empty_call_grpc():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.batch_update_entities(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_entities_empty_call_grpc():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.batch_delete_entities(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_update_entity_types_empty_call_grpc_asyncio():
    client = EntityTypesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_update_entity_types(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_delete_entity_types_empty_call_grpc_asyncio():
    client = EntityTypesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_delete_entity_types(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_create_entities_empty_call_grpc_asyncio():
    client = EntityTypesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_create_entities(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_update_entities_empty_call_grpc_asyncio():
    client = EntityTypesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_update_entities(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_delete_entities_empty_call_grpc_asyncio():
    client = EntityTypesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_delete_entities(request=None)
...
def test_list_entity_types_rest_bad_request(request_type=entity_type.ListEntityTypesRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_list_entity_types") as post, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_list_entity_types_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "pre_list_entity_types") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = entity_type.ListEntityTypesResponse.to_json(entity_type.ListEntityTypesResponse())
        ...
        post_with_metadata.return_value = entity_type.ListEntityTypesResponse(), metadata
...
def test_get_entity_type_rest_bad_request(request_type=entity_type.GetEntityTypeRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_get_entity_type") as post, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_get_entity_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "pre_get_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_entity_type_rest_bad_request(request_type=gcd_entity_type.CreateEntityTypeRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_create_entity_type") as post, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_create_entity_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "pre_create_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_entity_type.EntityType.to_json(gcd_entity_type.EntityType())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcd_entity_type.EntityType(), metadata
...
def test_update_entity_type_rest_bad_request(request_type=gcd_entity_type.UpdateEntityTypeRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_update_entity_type") as post, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_update_entity_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "pre_update_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_entity_type_rest_bad_request(request_type=entity_type.DeleteEntityTypeRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "pre_delete_entity_type") as pre:
        pre.assert_not_called()
...
def test_batch_update_entity_types_rest_bad_request(request_type=entity_type.BatchUpdateEntityTypesRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_update_entity_types_rest_call_success(request_type):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_update_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_batch_update_entity_types") as post, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_batch_update_entity_types_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "pre_batch_update_entity_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_batch_delete_entity_types_rest_bad_request(request_type=entity_type.BatchDeleteEntityTypesRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_delete_entity_types_rest_call_success(request_type):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_delete_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_batch_delete_entity_types") as post, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_batch_delete_entity_types_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "pre_batch_delete_entity_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_batch_create_entities_rest_bad_request(request_type=entity_type.BatchCreateEntitiesRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_create_entities_rest_call_success(request_type):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_create_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_batch_create_entities") as post, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_batch_create_entities_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "pre_batch_create_entities") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_batch_update_entities_rest_bad_request(request_type=entity_type.BatchUpdateEntitiesRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_update_entities_rest_call_success(request_type):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_update_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_batch_update_entities") as post, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_batch_update_entities_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "pre_batch_update_entities") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_batch_delete_entities_rest_bad_request(request_type=entity_type.BatchDeleteEntitiesRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_delete_entities_rest_call_success(request_type):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_delete_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_batch_delete_entities") as post, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_batch_delete_entities_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntityTypesRestInterceptor, "pre_batch_delete_entities") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_entity_types_empty_call_rest():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_entity_types_empty_call_rest():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_create_entities_empty_call_rest():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_entities_empty_call_rest():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_entities_empty_call_rest():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

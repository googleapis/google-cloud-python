...
def test_list_entity_types_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = entity_type.ListEntityTypesResponse.pb(return_value)
...
def test_get_entity_type_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = entity_type.EntityType.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_create_entity_type_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = gcd_entity_type.EntityType.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)

...
class _BaseCertificateAuthorityServiceRestTransport(CertificateAuthorityServiceTransport):
    ...
    class _BaseActivateCertificateAuthority:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseActivateCertificateAuthority._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseCreateCaPool:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseCreateCertificateAuthority:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseCreateCertificateAuthority._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseCreateCertificateTemplate:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseDeleteCertificateAuthority:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseDeleteCertificateAuthority._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseDeleteCertificateTemplate:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseDisableCertificateAuthority:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseDisableCertificateAuthority._get_unset_required_fields(query_params))
    ...
    class _BaseEnableCertificateAuthority:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseEnableCertificateAuthority._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseFetchCaCerts:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseFetchCertificateAuthorityCsr:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseFetchCertificateAuthorityCsr._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseGetCaPool:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseGetCertificateRevocationList:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseGetCertificateRevocationList._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseGetCertificateTemplate:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseListCertificateAuthorities:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseListCertificateAuthorities._get_unset_required_fields(query_params))
    ...
    class _BaseListCertificateRevocationLists:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseListCertificateRevocationLists._get_unset_required_fields(query_params))
    ...
    class _BaseListCertificateTemplates:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseUndeleteCertificateAuthority:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseUndeleteCertificateAuthority._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseUpdateCaPool:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseUpdateCertificateAuthority:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseUpdateCertificateAuthority._get_unset_required_fields(query_params))
    ...
    class _BaseUpdateCertificateRevocationList:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseUpdateCertificateRevocationList._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseUpdateCertificateTemplate:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")

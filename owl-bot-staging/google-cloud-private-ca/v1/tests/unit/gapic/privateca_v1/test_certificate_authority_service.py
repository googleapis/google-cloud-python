...
from google.cloud.security.privateca_v1.services.certificate_authority_service import CertificateAuthorityServiceAsyncClient
from google.cloud.security.privateca_v1.services.certificate_authority_service import CertificateAuthorityServiceClient
from google.cloud.security.privateca_v1.services.certificate_authority_service import pagers
from google.cloud.security.privateca_v1.services.certificate_authority_service import transports
...
def test_create_certificate_non_empty_request_with_auto_populated_field():
    ...
    request = service.CreateCertificateRequest(
        ...
        issuing_certificate_authority_id='issuing_certificate_authority_id_value',
    )
...
def test_undelete_certificate_authority(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.undelete_certificate_authority),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_undelete_certificate_authority_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.undelete_certificate_authority),
            '__call__') as call:
        client.undelete_certificate_authority(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.UndeleteCertificateAuthorityRequest(
            name='name_value',
...
def test_undelete_certificate_authority_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.undelete_certificate_authority in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.undelete_certificate_authority] = mock_rpc
...
@pytest.mark.asyncio
async def test_undelete_certificate_authority_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_undelete_certificate_authority_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.undelete_certificate_authority in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.undelete_certificate_authority] = mock_object
...
@pytest.mark.asyncio
async def test_undelete_certificate_authority_async(transport: str = 'grpc_asyncio', request_type=service.UndeleteCertificateAuthorityRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_certificate_authority_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.delete_certificate_authority),
            '__call__') as call:
        client.delete_certificate_authority(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.DeleteCertificateAuthorityRequest(
            name='name_value',
...
def test_delete_certificate_authority_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_certificate_authority in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.delete_certificate_authority] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_certificate_authority_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_certificate_authority_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_certificate_authority in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_certificate_authority] = mock_object
...
@pytest.mark.asyncio
async def test_delete_certificate_authority_async(transport: str = 'grpc_asyncio', request_type=service.DeleteCertificateAuthorityRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_ca_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_ca_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_ca_pool_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.create_ca_pool),
            '__call__') as call:
        client.create_ca_pool(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.CreateCaPoolRequest(
            parent='parent_value',
...
def test_create_ca_pool_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.create_ca_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.create_ca_pool] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_ca_pool_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_ca_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_ca_pool in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.create_ca_pool] = mock_object
...
@pytest.mark.asyncio
async def test_create_ca_pool_async(transport: str = 'grpc_asyncio', request_type=service.CreateCaPoolRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_ca_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_ca_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_ca_pool_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_ca_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_ca_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.update_ca_pool] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_ca_pool_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_update_ca_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_ca_pool in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_ca_pool] = mock_object
...
@pytest.mark.asyncio
async def test_update_ca_pool_async(transport: str = 'grpc_asyncio', request_type=service.UpdateCaPoolRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_ca_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_ca_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_ca_pool_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.get_ca_pool),
            '__call__') as call:
        client.get_ca_pool(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.GetCaPoolRequest(
            name='name_value',
...
def test_get_ca_pool_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_ca_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.get_ca_pool] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_ca_pool_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_get_ca_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_ca_pool in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_ca_pool] = mock_object
...
@pytest.mark.asyncio
async def test_get_ca_pool_async(transport: str = 'grpc_asyncio', request_type=service.GetCaPoolRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_ca_pools(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_ca_pools),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_ca_pools_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.list_ca_pools),
            '__call__') as call:
        client.list_ca_pools(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.ListCaPoolsRequest(
            parent='parent_value',
...
def test_list_ca_pools_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_ca_pools in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.list_ca_pools] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_ca_pools_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_list_ca_pools_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_ca_pools in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_ca_pools] = mock_object
...
@pytest.mark.asyncio
async def test_list_ca_pools_async(transport: str = 'grpc_asyncio', request_type=service.ListCaPoolsRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_ca_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_ca_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_ca_pool_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.delete_ca_pool),
            '__call__') as call:
        client.delete_ca_pool(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.DeleteCaPoolRequest(
            name='name_value',
...
def test_delete_ca_pool_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_ca_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.delete_ca_pool] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_ca_pool_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_ca_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_ca_pool in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_ca_pool] = mock_object
...
@pytest.mark.asyncio
async def test_delete_ca_pool_async(transport: str = 'grpc_asyncio', request_type=service.DeleteCaPoolRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_ca_certs(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_ca_certs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_fetch_ca_certs_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.fetch_ca_certs),
            '__call__') as call:
        client.fetch_ca_certs(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.FetchCaCertsRequest(
            ca_pool='ca_pool_value',
...
def test_fetch_ca_certs_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.fetch_ca_certs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.fetch_ca_certs] = mock_rpc
...
@pytest.mark.asyncio
async def test_fetch_ca_certs_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.FetchCaCertsResponse(
        ))
...
@pytest.mark.asyncio
async def test_fetch_ca_certs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_ca_certs in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_ca_certs] = mock_object
...
@pytest.mark.asyncio
async def test_fetch_ca_certs_async(transport: str = 'grpc_asyncio', request_type=service.FetchCaCertsRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_certificate_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_certificate_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_certificate_template_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.create_certificate_template),
            '__call__') as call:
        client.create_certificate_template(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.CreateCertificateTemplateRequest(
            parent='parent_value',
...
def test_create_certificate_template_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.create_certificate_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.create_certificate_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_certificate_template_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_certificate_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_certificate_template in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.create_certificate_template] = mock_object
...
@pytest.mark.asyncio
async def test_create_certificate_template_async(transport: str = 'grpc_asyncio', request_type=service.CreateCertificateTemplateRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_certificate_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_certificate_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_certificate_template_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.delete_certificate_template),
            '__call__') as call:
        client.delete_certificate_template(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.DeleteCertificateTemplateRequest(
            name='name_value',
...
def test_delete_certificate_template_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_certificate_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.delete_certificate_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_certificate_template_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_certificate_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_certificate_template in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_certificate_template] = mock_object
...
@pytest.mark.asyncio
async def test_delete_certificate_template_async(transport: str = 'grpc_asyncio', request_type=service.DeleteCertificateTemplateRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_certificate_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_certificate_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_certificate_template_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.get_certificate_template),
            '__call__') as call:
        client.get_certificate_template(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.GetCertificateTemplateRequest(
            name='name_value',
...
def test_get_certificate_template_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_certificate_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.get_certificate_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_certificate_template_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.CertificateTemplate(
            name='name_value',
            description='description_value',
        ))
...
@pytest.mark.asyncio
async def test_get_certificate_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_certificate_template in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_certificate_template] = mock_object
...
@pytest.mark.asyncio
async def test_get_certificate_template_async(transport: str = 'grpc_asyncio', request_type=service.GetCertificateTemplateRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_certificate_templates_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.list_certificate_templates),
            '__call__') as call:
        client.list_certificate_templates(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.ListCertificateTemplatesRequest(
            parent='parent_value',
...
def test_list_certificate_templates_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_certificate_templates in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.list_certificate_templates] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_certificate_templates_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_list_certificate_templates_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_certificate_templates in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_certificate_templates] = mock_object
...
@pytest.mark.asyncio
async def test_list_certificate_templates_async(transport: str = 'grpc_asyncio', request_type=service.ListCertificateTemplatesRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_certificate_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_certificate_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_certificate_template_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_certificate_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_certificate_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        client._transport._wrapped_methods[client._transport.update_certificate_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_certificate_template_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_update_certificate_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_certificate_template in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_certificate_template] = mock_object
...
@pytest.mark.asyncio
async def test_update_certificate_template_async(transport: str = 'grpc_asyncio', request_type=service.UpdateCertificateTemplateRequest):
    client = CertificateAuthorityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_certificate_rest_required_fields(request_type=service.CreateCertificateRequest):
    ...
    assert not set(unset_fields) - set(("certificate_id", "issuing_certificate_authority_id", "request_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_certificate_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("certificateId", "issuingCertificateAuthorityId", "requestId", "validateOnly", )) & set(("parent", "certificate", )))
...
def test_create_certificate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'parent': 'projects/sample1/locations/sample2/caPools/sample3'}
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/caPools/*}/certificates" % client.transport._host, args[1])
...
def test_get_certificate_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificates/sample4'}
    request = request_type(**request_init)
...
def test_get_certificate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificates/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/caPools/*/certificates/*}" % client.transport._host, args[1])
...
def test_revoke_certificate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/caPools/*/certificates/*}:revoke" % client.transport._host, args[1])
...
def test_update_certificate_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'certificate': {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificates/sample4'}}
...
def test_update_certificate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'certificate': {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificates/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{certificate.name=projects/*/locations/*/caPools/*/certificates/*}" % client.transport._host, args[1])
...
def test_activate_certificate_authority_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificateAuthorities/sample4'}
    request = request_type(**request_init)
...
def test_activate_certificate_authority_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificateAuthorities/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/caPools/*/certificateAuthorities/*}:activate" % client.transport._host, args[1])
...
def test_create_certificate_authority_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/caPools/*}/certificateAuthorities" % client.transport._host, args[1])
...
def test_disable_certificate_authority_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/caPools/*/certificateAuthorities/*}:disable" % client.transport._host, args[1])
...
def test_enable_certificate_authority_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/caPools/*/certificateAuthorities/*}:enable" % client.transport._host, args[1])
...
def test_fetch_certificate_authority_csr_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/caPools/*/certificateAuthorities/*}:fetch" % client.transport._host, args[1])
...
def test_get_certificate_authority_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/caPools/*/certificateAuthorities/*}" % client.transport._host, args[1])
...
def test_undelete_certificate_authority_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_undelete_certificate_authority_rest_required_fields(request_type=service.UndeleteCertificateAuthorityRequest):
    transport_class = transports.CertificateAuthorityServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).undelete_certificate_authority._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_undelete_certificate_authority_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_undelete_certificate_authority") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_undelete_certificate_authority") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.UndeleteCertificateAuthorityRequest.pb(service.UndeleteCertificateAuthorityRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.undelete_certificate_authority(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_undelete_certificate_authority_rest_bad_request(transport: str = 'rest', request_type=service.UndeleteCertificateAuthorityRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_undelete_certificate_authority_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/caPools/*/certificateAuthorities/*}:undelete" % client.transport._host, args[1])
...
def test_delete_certificate_authority_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_delete_certificate_authority_rest_required_fields(request_type=service.DeleteCertificateAuthorityRequest):
    transport_class = transports.CertificateAuthorityServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_certificate_authority._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_certificate_authority._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("ignore_active_certificates", "ignore_dependent_resources", "request_id", "skip_grace_period", ))
    jsonified_request.update(unset_fields)
...
def test_delete_certificate_authority_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("ignoreActiveCertificates", "ignoreDependentResources", "requestId", "skipGracePeriod", )) & set(("name", )))
...
def test_delete_certificate_authority_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_delete_certificate_authority") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_delete_certificate_authority") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.DeleteCertificateAuthorityRequest.pb(service.DeleteCertificateAuthorityRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_certificate_authority(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_certificate_authority_rest_bad_request(transport: str = 'rest', request_type=service.DeleteCertificateAuthorityRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_certificate_authority_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'certificate_authority': {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificateAuthorities/sample4'}}
...
def test_update_certificate_authority_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'certificate_authority': {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificateAuthorities/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{certificate_authority.name=projects/*/locations/*/caPools/*/certificateAuthorities/*}" % client.transport._host, args[1])
...
def test_create_ca_pool_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["ca_pool"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["ca_pool"][field])):
                    del request_init["ca_pool"][field][i][subfield]
            else:
                del request_init["ca_pool"][field][subfield]
    request = request_type(**request_init)
...
def test_create_ca_pool_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_create_ca_pool_rest_required_fields(request_type=service.CreateCaPoolRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_ca_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_ca_pool._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("ca_pool_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_ca_pool_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("caPoolId", "requestId", )) & set(("parent", "caPoolId", "caPool", )))
...
def test_create_ca_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_create_ca_pool") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_create_ca_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_ca_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_ca_pool_rest_bad_request(transport: str = 'rest', request_type=service.CreateCaPoolRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_ca_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/caPools" % client.transport._host, args[1])
...
def test_update_ca_pool_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'ca_pool': {'name': 'projects/sample1/locations/sample2/caPools/sample3'}}
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = service.UpdateCaPoolRequest.meta.fields["ca_pool"]
...
def test_update_ca_pool_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_update_ca_pool_rest_required_fields(request_type=service.UpdateCaPoolRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_ca_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_ca_pool_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("caPool", "updateMask", )))
...
def test_update_ca_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_update_ca_pool") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_update_ca_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_ca_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_ca_pool_rest_bad_request(transport: str = 'rest', request_type=service.UpdateCaPoolRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_ca_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'ca_pool': {'name': 'projects/sample1/locations/sample2/caPools/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{ca_pool.name=projects/*/locations/*/caPools/*}" % client.transport._host, args[1])
...
def test_get_ca_pool_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = resources.CaPool.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_get_ca_pool_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_get_ca_pool_rest_required_fields(request_type=service.GetCaPoolRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_ca_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_ca_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_get_ca_pool") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_get_ca_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_ca_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_ca_pool_rest_bad_request(transport: str = 'rest', request_type=service.GetCaPoolRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_ca_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/caPools/*}" % client.transport._host, args[1])
...
def test_list_ca_pools_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = service.ListCaPoolsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_list_ca_pools_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_list_ca_pools_rest_required_fields(request_type=service.ListCaPoolsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_ca_pools._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_ca_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_list_ca_pools") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_list_ca_pools") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.ListCaPoolsResponse.to_json(service.ListCaPoolsResponse())
        ...
        client.list_ca_pools(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_ca_pools_rest_bad_request(transport: str = 'rest', request_type=service.ListCaPoolsRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_ca_pool_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_delete_ca_pool_rest_required_fields(request_type=service.DeleteCaPoolRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_ca_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_ca_pool._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("ignore_dependent_resources", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_delete_ca_pool_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("ignoreDependentResources", "requestId", )) & set(("name", )))
...
def test_delete_ca_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_delete_ca_pool") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_delete_ca_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_ca_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_ca_pool_rest_bad_request(transport: str = 'rest', request_type=service.DeleteCaPoolRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_ca_certs_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = service.FetchCaCertsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_fetch_ca_certs_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_fetch_ca_certs_rest_required_fields(request_type=service.FetchCaCertsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_ca_certs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_ca_certs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_fetch_ca_certs") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_fetch_ca_certs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.FetchCaCertsResponse.to_json(service.FetchCaCertsResponse())
        ...
        client.fetch_ca_certs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_fetch_ca_certs_rest_bad_request(transport: str = 'rest', request_type=service.FetchCaCertsRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_ca_certs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'ca_pool': 'projects/sample1/locations/sample2/caPools/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{ca_pool=projects/*/locations/*/caPools/*}:fetchCaCerts" % client.transport._host, args[1])
...
def test_get_certificate_revocation_list_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificateAuthorities/sample4/certificateRevocationLists/sample5'}
    request = request_type(**request_init)
...
def test_get_certificate_revocation_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificateAuthorities/sample4/certificateRevocationLists/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/caPools/*/certificateAuthorities/*/certificateRevocationLists/*}" % client.transport._host, args[1])
...
def test_list_certificate_revocation_lists_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/caPools/sample3/certificateAuthorities/sample4'}
    request = request_type(**request_init)
...
def test_list_certificate_revocation_lists_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/caPools/sample3/certificateAuthorities/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/caPools/*/certificateAuthorities/*}/certificateRevocationLists" % client.transport._host, args[1])
...
def test_update_certificate_revocation_list_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'certificate_revocation_list': {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificateAuthorities/sample4/certificateRevocationLists/sample5'}}
    request_init["certificate_revocation_list"] = {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificateAuthorities/sample4/certificateRevocationLists/sample5', 'sequence_number': 1601, 'revoked_certificates': [{'certificate': 'certificate_value', 'hex_serial_number': 'hex_serial_number_value', 'revocation_reason': 1}], 'pem_crl': 'pem_crl_value', 'access_url': 'access_url_value', 'state': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'revision_id': 'revision_id_value', 'labels': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_certificate_revocation_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'certificate_revocation_list': {'name': 'projects/sample1/locations/sample2/caPools/sample3/certificateAuthorities/sample4/certificateRevocationLists/sample5'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{certificate_revocation_list.name=projects/*/locations/*/caPools/*/certificateAuthorities/*/certificateRevocationLists/*}" % client.transport._host, args[1])
...
def test_create_certificate_template_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["certificate_template"] = {'name': 'name_value', 'maximum_lifetime': {'seconds': 751, 'nanos': 543}, 'predefined_values': {'key_usage': {'base_key_usage': {'digital_signature': True, 'content_commitment': True, 'key_encipherment': True, 'data_encipherment': True, 'key_agreement': True, 'cert_sign': True, 'crl_sign': True, 'encipher_only': True, 'decipher_only': True}, 'extended_key_usage': {'server_auth': True, 'client_auth': True, 'code_signing': True, 'email_protection': True, 'time_stamping': True, 'ocsp_signing': True}, 'unknown_extended_key_usages': [{'object_id_path': [1456, 1457]}]}, 'ca_options': {'is_ca': True, 'max_issuer_path_length': 2349}, 'policy_ids': {}, 'aia_ocsp_servers': ['aia_ocsp_servers_value1', 'aia_ocsp_servers_value2'], 'name_constraints': {'critical': True, 'permitted_dns_names': ['permitted_dns_names_value1', 'permitted_dns_names_value2'], 'excluded_dns_names': ['excluded_dns_names_value1', 'excluded_dns_names_value2'], 'permitted_ip_ranges': ['permitted_ip_ranges_value1', 'permitted_ip_ranges_value2'], 'excluded_ip_ranges': ['excluded_ip_ranges_value1', 'excluded_ip_ranges_value2'], 'permitted_email_addresses': ['permitted_email_addresses_value1', 'permitted_email_addresses_value2'], 'excluded_email_addresses': ['excluded_email_addresses_value1', 'excluded_email_addresses_value2'], 'permitted_uris': ['permitted_uris_value1', 'permitted_uris_value2'], 'excluded_uris': ['excluded_uris_value1', 'excluded_uris_value2']}, 'additional_extensions': [{'object_id': {}, 'critical': True, 'value': b'value_blob'}]}, 'identity_constraints': {'cel_expression': {'expression': 'expression_value', 'title': 'title_value', 'description': 'description_value', 'location': 'location_value'}, 'allow_subject_passthrough': True, 'allow_subject_alt_names_passthrough': True}, 'passthrough_extensions': {'known_extensions': [1], 'additional_extensions': {}}, 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = service.CreateCertificateTemplateRequest.meta.fields["certificate_template"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["certificate_template"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["certificate_template"][field])):
                    del request_init["certificate_template"][field][i][subfield]
            else:
                del request_init["certificate_template"][field][subfield]
    request = request_type(**request_init)
...
def test_create_certificate_template_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_create_certificate_template_rest_required_fields(request_type=service.CreateCertificateTemplateRequest):
    transport_class = transports.CertificateAuthorityServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_certificate_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "certificateTemplateId" in jsonified_request
    assert jsonified_request["certificateTemplateId"] == request_init["certificate_template_id"]
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_certificate_template._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("certificate_template_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_certificate_template_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("certificateTemplateId", "requestId", )) & set(("parent", "certificateTemplateId", "certificateTemplate", )))
...
def test_create_certificate_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_create_certificate_template") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_create_certificate_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.CreateCertificateTemplateRequest.pb(service.CreateCertificateTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_certificate_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_certificate_template_rest_bad_request(transport: str = 'rest', request_type=service.CreateCertificateTemplateRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_certificate_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/certificateTemplates" % client.transport._host, args[1])
...
def test_delete_certificate_template_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/certificateTemplates/sample3'}
    request = request_type(**request_init)
...
def test_delete_certificate_template_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_delete_certificate_template_rest_required_fields(request_type=service.DeleteCertificateTemplateRequest):
    transport_class = transports.CertificateAuthorityServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_certificate_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_certificate_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_delete_certificate_template") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_delete_certificate_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.DeleteCertificateTemplateRequest.pb(service.DeleteCertificateTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_certificate_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_certificate_template_rest_bad_request(transport: str = 'rest', request_type=service.DeleteCertificateTemplateRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_certificate_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/certificateTemplates/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/certificateTemplates/*}" % client.transport._host, args[1])
...
def test_get_certificate_template_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = resources.CertificateTemplate.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_get_certificate_template_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_get_certificate_template_rest_required_fields(request_type=service.GetCertificateTemplateRequest):
    transport_class = transports.CertificateAuthorityServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_certificate_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_certificate_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_get_certificate_template") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_get_certificate_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.GetCertificateTemplateRequest.pb(service.GetCertificateTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = resources.CertificateTemplate.to_json(resources.CertificateTemplate())
        ...
        client.get_certificate_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_certificate_template_rest_bad_request(transport: str = 'rest', request_type=service.GetCertificateTemplateRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_certificate_templates_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = service.ListCertificateTemplatesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_list_certificate_templates_rest_required_fields(request_type=service.ListCertificateTemplatesRequest):
    transport_class = transports.CertificateAuthorityServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_certificate_templates._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_certificate_templates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_list_certificate_templates") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_list_certificate_templates") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.ListCertificateTemplatesRequest.pb(service.ListCertificateTemplatesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.ListCertificateTemplatesResponse.to_json(service.ListCertificateTemplatesResponse())
        ...
        client.list_certificate_templates(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_certificate_templates_rest_bad_request(transport: str = 'rest', request_type=service.ListCertificateTemplatesRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_certificate_templates_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(service.ListCertificateTemplatesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_update_certificate_template_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'certificate_template': {'name': 'projects/sample1/locations/sample2/certificateTemplates/sample3'}}
    request_init["certificate_template"] = {'name': 'projects/sample1/locations/sample2/certificateTemplates/sample3', 'maximum_lifetime': {'seconds': 751, 'nanos': 543}, 'predefined_values': {'key_usage': {'base_key_usage': {'digital_signature': True, 'content_commitment': True, 'key_encipherment': True, 'data_encipherment': True, 'key_agreement': True, 'cert_sign': True, 'crl_sign': True, 'encipher_only': True, 'decipher_only': True}, 'extended_key_usage': {'server_auth': True, 'client_auth': True, 'code_signing': True, 'email_protection': True, 'time_stamping': True, 'ocsp_signing': True}, 'unknown_extended_key_usages': [{'object_id_path': [1456, 1457]}]}, 'ca_options': {'is_ca': True, 'max_issuer_path_length': 2349}, 'policy_ids': {}, 'aia_ocsp_servers': ['aia_ocsp_servers_value1', 'aia_ocsp_servers_value2'], 'name_constraints': {'critical': True, 'permitted_dns_names': ['permitted_dns_names_value1', 'permitted_dns_names_value2'], 'excluded_dns_names': ['excluded_dns_names_value1', 'excluded_dns_names_value2'], 'permitted_ip_ranges': ['permitted_ip_ranges_value1', 'permitted_ip_ranges_value2'], 'excluded_ip_ranges': ['excluded_ip_ranges_value1', 'excluded_ip_ranges_value2'], 'permitted_email_addresses': ['permitted_email_addresses_value1', 'permitted_email_addresses_value2'], 'excluded_email_addresses': ['excluded_email_addresses_value1', 'excluded_email_addresses_value2'], 'permitted_uris': ['permitted_uris_value1', 'permitted_uris_value2'], 'excluded_uris': ['excluded_uris_value1', 'excluded_uris_value2']}, 'additional_extensions': [{'object_id': {}, 'critical': True, 'value': b'value_blob'}]}, 'identity_constraints': {'cel_expression': {'expression': 'expression_value', 'title': 'title_value', 'description': 'description_value', 'location': 'location_value'}, 'allow_subject_passthrough': True, 'allow_subject_alt_names_passthrough': True}, 'passthrough_extensions': {'known_extensions': [1], 'additional_extensions': {}}, 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = service.UpdateCertificateTemplateRequest.meta.fields["certificate_template"]
...
def test_update_certificate_template_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CertificateAuthorityServiceClient(
...
def test_update_certificate_template_rest_required_fields(request_type=service.UpdateCertificateTemplateRequest):
    transport_class = transports.CertificateAuthorityServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_certificate_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_certificate_template_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("certificateTemplate", "updateMask", )))
...
def test_update_certificate_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "post_update_certificate_template") as post, \
         mock.patch.object(transports.CertificateAuthorityServiceRestInterceptor, "pre_update_certificate_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.UpdateCertificateTemplateRequest.pb(service.UpdateCertificateTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_certificate_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_certificate_template_rest_bad_request(transport: str = 'rest', request_type=service.UpdateCertificateTemplateRequest):
    client = CertificateAuthorityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_certificate_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'certificate_template': {'name': 'projects/sample1/locations/sample2/certificateTemplates/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{certificate_template.name=projects/*/locations/*/certificateTemplates/*}" % client.transport._host, args[1])
...
def test_certificate_authority_service_base_transport():
    ...
    with mock.patch('google.cloud.security.privateca_v1.services.certificate_authority_service.transports.CertificateAuthorityServiceTransport.__init__') as Transport:
...
def test_certificate_authority_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.security.privateca_v1.services.certificate_authority_service.transports.CertificateAuthorityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_certificate_authority_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.security.privateca_v1.services.certificate_authority_service.transports.CertificateAuthorityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CertificateAuthorityServiceTransport()
        adc.assert_called_once()
...
def test_certificate_path():
    ...
    expected = "projects/{project}/locations/{location}/caPools/{ca_pool}/certificates/{certificate}".format(project=project, location=location, ca_pool=ca_pool, certificate=certificate, )
    actual = CertificateAuthorityServiceClient.certificate_path(project, location, ca_pool, certificate)
    assert expected == actual
...
def test_certificate_authority_path():
    ...
    expected = "projects/{project}/locations/{location}/caPools/{ca_pool}/certificateAuthorities/{certificate_authority}".format(project=project, location=location, ca_pool=ca_pool, certificate_authority=certificate_authority, )
    actual = CertificateAuthorityServiceClient.certificate_authority_path(project, location, ca_pool, certificate_authority)
    assert expected == actual
...
def test_certificate_revocation_list_path():
    ...
    expected = "projects/{project}/locations/{location}/caPools/{ca_pool}/certificateAuthorities/{certificate_authority}/certificateRevocationLists/{certificate_revocation_list}".format(project=project, location=location, ca_pool=ca_pool, certificate_authority=certificate_authority, certificate_revocation_list=certificate_revocation_list, )
    actual = CertificateAuthorityServiceClient.certificate_revocation_list_path(project, location, ca_pool, certificate_authority, certificate_revocation_list)
    assert expected == actual
...
def test_certificate_template_path():
    ...
    expected = "projects/{project}/locations/{location}/certificateTemplates/{certificate_template}".format(project=project, location=location, certificate_template=certificate_template, )
    actual = CertificateAuthorityServiceClient.certificate_template_path(project, location, certificate_template)
    assert expected == actual
...
def test_get_iam_policy_rest_bad_request(transport: str = 'rest', request_type=iam_policy_pb2.GetIamPolicyRequest):
    ...
    request = request_type()
    request = json_format.ParseDict({'resource': 'projects/sample1/locations/sample2/caPools/sample3'}, request)

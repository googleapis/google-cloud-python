...
class _BaseCertificateAuthorityServiceRestTransport(CertificateAuthorityServiceTransport):
    ...
    class _BaseRestoreCertificateAuthority:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseRestoreCertificateAuthority._get_unset_required_fields(query_params))
    ...
    class _BaseScheduleDeleteCertificateAuthority:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCertificateAuthorityServiceRestTransport._BaseScheduleDeleteCertificateAuthority._get_unset_required_fields(query_params))

...
from google.cloud.cloudsecuritycompliance_v1.services.config import ConfigAsyncClient
...
from google.cloud.cloudsecuritycompliance_v1.services.config import transports
...
def test_list_frameworks(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.list_frameworks),
            '__call__') as call:
...
def test_list_frameworks_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, common.Framework)
                   for i in results)
...
async def test_list_frameworks_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_frameworks(request={},)
...
def test_get_framework(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_framework),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_framework(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_framework),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = common.Framework(
            name='name_value',
...
def test_update_framework(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_framework),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = common.Framework(
            name='name_value',
...
def test_delete_framework(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_framework),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_cloud_controls_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, common.CloudControl)
                   for i in results)
...
async def test_list_cloud_controls_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_cloud_controls(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_cloud_control(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_cloud_control),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_cloud_control(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_cloud_control),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = common.CloudControl(
            name='name_value',
...
def test_update_cloud_control(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_cloud_control),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = common.CloudControl(
            name='name_value',
...
def test_delete_cloud_control(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_cloud_control),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_create_framework_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("frameworkId", )) & set(("parent", "frameworkId", "framework", )))
...
def test_update_framework_rest_required_fields(request_type=config.UpdateFrameworkRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_framework._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("major_revision_id", "update_mask", ))
    jsonified_request.update(unset_fields)
...
def test_update_framework_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("majorRevisionId", "updateMask", )) & set(("framework", )))
...
def test_list_cloud_controls_rest_required_fields(request_type=config.ListCloudControlsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_cloud_controls._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_cloud_control_rest_required_fields(request_type=config.CreateCloudControlRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_cloud_control._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_cloud_control_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("cloudControlId", )) & set(("parent", "cloudControlId", "cloudControl", )))
...
def test_update_cloud_control_rest_required_fields(request_type=config.UpdateCloudControlRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_cloud_control._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_cloud_control_rest_required_fields(request_type=config.DeleteCloudControlRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_cloud_control._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_frameworks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_frameworks") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_frameworks_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_list_frameworks") as pre:
        ...
        client.list_frameworks(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_framework_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_framework") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_framework_with_metadata") as post_with_metadata, \
        ...
        client.get_framework(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_framework_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'organizations/sample1/locations/sample2'}
    request_init["framework"] = {'name': 'name_value', 'major_revision_id': 1811, 'display_name': 'display_name_value', 'description': 'description_value', 'type_': 1, 'cloud_control_details': [{'name': 'name_value', 'major_revision_id': 1811, 'parameters': [{'name': 'name_value', 'parameter_value': {'string_value': 'string_value_value', 'bool_value': True, 'string_list_value': {'values': ['values_value1', 'values_value2']}, 'number_value': 0.1285, 'oneof_value': {}}}]}], 'category': [1], 'supported_cloud_providers': [1], 'supported_target_resource_types': [1], 'supported_enforcement_modes': [1]}
...
def test_create_framework_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_create_framework") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_create_framework_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_create_framework") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_framework(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_framework_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'framework': {'name': 'organizations/sample1/locations/sample2/frameworks/sample3'}}
    request_init["framework"] = {'name': 'organizations/sample1/locations/sample2/frameworks/sample3', 'major_revision_id': 1811, 'display_name': 'display_name_value', 'description': 'description_value', 'type_': 1, 'cloud_control_details': [{'name': 'name_value', 'major_revision_id': 1811, 'parameters': [{'name': 'name_value', 'parameter_value': {'string_value': 'string_value_value', 'bool_value': True, 'string_list_value': {'values': ['values_value1', 'values_value2']}, 'number_value': 0.1285, 'oneof_value': {}}}]}], 'category': [1], 'supported_cloud_providers': [1], 'supported_target_resource_types': [1], 'supported_enforcement_modes': [1]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_framework_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_update_framework") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_update_framework_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_update_framework") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_framework(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_framework_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_delete_framework") as pre:
        pre.assert_not_called()
        ...
        client.delete_framework(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_cloud_controls_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_cloud_controls") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_cloud_controls_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_list_cloud_controls") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_cloud_controls(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_cloud_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_cloud_control") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_cloud_control_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_get_cloud_control") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_cloud_control(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_cloud_control_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'organizations/sample1/locations/sample2'}
    request_init["cloud_control"] = {'name': 'name_value', 'major_revision_id': 1811, 'description': 'description_value', 'display_name': 'display_name_value', 'supported_enforcement_modes': [1], 'parameter_spec': [{'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'is_required': True, 'value_type': 3, 'default_value': {'string_value': 'string_value_value', 'bool_value': True, 'string_list_value': {'values': ['values_value1', 'values_value2']}, 'number_value': 0.1285, 'oneof_value': {'name': 'name_value', 'parameter_value': {}}}, 'substitution_rules': [{'placeholder_substitution_rule': {'attribute': 'attribute_value'}, 'attribute_substitution_rule': {'attribute': 'attribute_value'}}], 'sub_parameters': {}, 'validation': {'allowed_values': {'values': {}}, 'int_range': {'min_': 419, 'max_': 421}, 'regexp_pattern': {'pattern': 'pattern_value'}}}], 'rules': [{'cel_expression': {'resource_types_values': {}, 'expression': 'expression_value'}, 'description': 'description_value', 'rule_action_types': [1]}], 'severity': 1, 'finding_category': 'finding_category_value', 'supported_cloud_providers': [1], 'related_frameworks': ['related_frameworks_value1', 'related_frameworks_value2'], 'remediation_steps': 'remediation_steps_value', 'categories': [1], 'create_time': {'seconds': 751, 'nanos': 543}, 'supported_target_resource_types': [1]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_cloud_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_create_cloud_control") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_create_cloud_control_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_create_cloud_control") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_cloud_control(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_cloud_control_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'cloud_control': {'name': 'organizations/sample1/locations/sample2/cloudControls/sample3'}}
    request_init["cloud_control"] = {'name': 'organizations/sample1/locations/sample2/cloudControls/sample3', 'major_revision_id': 1811, 'description': 'description_value', 'display_name': 'display_name_value', 'supported_enforcement_modes': [1], 'parameter_spec': [{'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'is_required': True, 'value_type': 3, 'default_value': {'string_value': 'string_value_value', 'bool_value': True, 'string_list_value': {'values': ['values_value1', 'values_value2']}, 'number_value': 0.1285, 'oneof_value': {'name': 'name_value', 'parameter_value': {}}}, 'substitution_rules': [{'placeholder_substitution_rule': {'attribute': 'attribute_value'}, 'attribute_substitution_rule': {'attribute': 'attribute_value'}}], 'sub_parameters': {}, 'validation': {'allowed_values': {'values': {}}, 'int_range': {'min_': 419, 'max_': 421}, 'regexp_pattern': {'pattern': 'pattern_value'}}}], 'rules': [{'cel_expression': {'resource_types_values': {}, 'expression': 'expression_value'}, 'description': 'description_value', 'rule_action_types': [1]}], 'severity': 1, 'finding_category': 'finding_category_value', 'supported_cloud_providers': [1], 'related_frameworks': ['related_frameworks_value1', 'related_frameworks_value2'], 'remediation_steps': 'remediation_steps_value', 'categories': [1], 'create_time': {'seconds': 751, 'nanos': 543}, 'supported_target_resource_types': [1]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_cloud_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_update_cloud_control") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_update_cloud_control_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_update_cloud_control") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_cloud_control(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_cloud_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_delete_cloud_control") as pre:
        pre.assert_not_called()
        ...
        client.delete_cloud_control(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_config_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.cloudsecuritycompliance_v1.services.config.transports.ConfigTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_config_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.cloudsecuritycompliance_v1.services.config.transports.ConfigTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ConfigTransport()
        adc.assert_called_once()
...
def test_framework_path():
    ...
    location = "mussel"
    framework = "winkle"
    expected = "organizations/{organization}/locations/{location}/frameworks/{framework}".format(organization=organization, location=location, framework=framework, )

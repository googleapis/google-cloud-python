...
class FrameworkDeployment(proto.Message):
    ...
    cc_group_deployments: MutableSequence['CloudControlGroupDeployment'] = proto.RepeatedField(
        proto.MESSAGE,
        number=12,
...
class CloudControlGroupDeployment(proto.Message):
    ...
    cc_deployment_references: MutableSequence['CloudControlDeploymentReference'] = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
        message='CloudControlDeploymentReference',
    )

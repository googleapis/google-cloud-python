...
from .base import DeploymentTransport, DEFAULT_CLIENT_INFO
...
class DeploymentGrpcTransport(DeploymentTransport):
    ...
    @property
    def create_framework_deployment(self) -> Callable[
    ...
    @property
    def delete_framework_deployment(self) -> Callable[
    ...
    @property
    def get_framework_deployment(self) -> Callable[
    ...
    @property
    def list_framework_deployments(self) -> Callable[
    ...
    @property
    def get_cloud_control_deployment(self) -> Callable[
    ...
    @property
    def list_cloud_control_deployments(self) -> Callable[

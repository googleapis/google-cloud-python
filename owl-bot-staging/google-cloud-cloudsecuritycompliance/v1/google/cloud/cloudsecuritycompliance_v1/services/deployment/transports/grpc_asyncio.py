...
class DeploymentGrpcAsyncIOTransport(DeploymentTransport):
    """gRPC AsyncIO backend transport for Deployment.
    ...
    def get_framework_deployment(self) -> Callable[
            ...
            Awaitable[deployment.FrameworkDeployment]]:
    ...
    def list_framework_deployments(self) -> Callable[
            ...
            Awaitable[deployment.ListFrameworkDeploymentsResponse]]:
        ...
        Returns:
            Callable[[~.ListFrameworkDeploymentsRequest],
                    Awaitable[~.ListFrameworkDeploymentsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_cloud_control_deployment(self) -> Callable[
            ...
            Awaitable[deployment.CloudControlDeployment]]:
        ...
        Returns:
            Callable[[~.GetCloudControlDeploymentRequest],
                    Awaitable[~.CloudControlDeployment]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_cloud_control_deployments(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListCloudControlDeploymentsRequest],
                    Awaitable[~.ListCloudControlDeploymentsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_framework_deployment: self._wrap_method(
                self.create_framework_deployment,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_framework_deployment: self._wrap_method(
                self.delete_framework_deployment,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_framework_deployment: self._wrap_method(
                self.get_framework_deployment,
            ...
            self.list_framework_deployments: self._wrap_method(
                self.list_framework_deployments,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.get_cloud_control_deployment: self._wrap_method(
                self.get_cloud_control_deployment,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.list_cloud_control_deployments: self._wrap_method(
                self.list_cloud_control_deployments,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,

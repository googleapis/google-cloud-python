...
class ConfigClient(metaclass=ConfigClientMeta):
    ...
    @staticmethod
    def framework_path(organization: str,location: str,framework: str,) -> str:
        """Returns a fully-qualified framework string."""
        return "organizations/{organization}/locations/{location}/frameworks/{framework}".format(organization=organization, location=location, framework=framework, )

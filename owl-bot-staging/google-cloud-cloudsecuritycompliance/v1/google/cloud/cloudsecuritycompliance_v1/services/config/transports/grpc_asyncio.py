...
from google.cloud.cloudsecuritycompliance_v1.types import config
...
class ConfigGrpcAsyncIOTransport(ConfigTransport):
    ...
    @property
    def list_frameworks(self) -> Callable[
            [config.ListFrameworksRequest],
            Awaitable[config.ListFrameworksResponse]]:
        ...
        Returns:
            Callable[[~.ListFrameworksRequest],
                    Awaitable[~.ListFrameworksResponse]]:
    ...
    @property
    def get_framework(self) -> Callable[
            [config.GetFrameworkRequest],
            Awaitable[common.Framework]]:
    ...
    @property
    def create_framework(self) -> Callable[
    ...
    @property
    def update_framework(self) -> Callable[
    ...
    @property
    def delete_framework(self) -> Callable[
    ...
    @property
    def list_cloud_controls(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListCloudControlsRequest],
                    Awaitable[~.ListCloudControlsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    @property
    def get_cloud_control(self) -> Callable[
            [config.GetCloudControlRequest],
            Awaitable[common.CloudControl]]:
    ...
    @property
    def create_cloud_control(self) -> Callable[
    ...
    @property
    def update_cloud_control(self) -> Callable[
    ...
    @property
    def delete_cloud_control(self) -> Callable[
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_frameworks: self._wrap_method(
            ...
            self.get_framework: self._wrap_method(
                self.get_framework,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.create_framework: self._wrap_method(
                self.create_framework,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_framework: self._wrap_method(
                self.update_framework,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_framework: self._wrap_method(
                self.delete_framework,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_cloud_controls: self._wrap_method(
            ...
            self.get_cloud_control: self._wrap_method(
            ...
            self.create_cloud_control: self._wrap_method(
                self.create_cloud_control,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_cloud_control: self._wrap_method(
                self.update_cloud_control,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_cloud_control: self._wrap_method(

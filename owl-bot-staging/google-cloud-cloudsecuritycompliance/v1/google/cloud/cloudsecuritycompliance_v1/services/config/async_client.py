...
class ConfigAsyncClient:
    ...
    async def list_frameworks(self,
    ...
    async def create_framework(self,
    ...
    async def update_framework(self,
    ...
    async def delete_framework(self,
    ...
    async def list_cloud_controls(self,
    ...
    async def get_cloud_control(self,
    ...
    async def create_cloud_control(self,
    ...
    async def update_cloud_control(self,
    ...
    async def delete_cloud_control(self,

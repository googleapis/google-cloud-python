...
class ListOrganizationEventsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[event_resources.ListOrganizationEventsResponse]],
            request: event_resources.ListOrganizationEventsRequest,
            response: event_resources.ListOrganizationEventsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[event_resources.ListOrganizationEventsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
...
class ListOrganizationImpactsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[event_resources.ListOrganizationImpactsResponse]],
            request: event_resources.ListOrganizationImpactsRequest,
            response: event_resources.ListOrganizationImpactsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[event_resources.ListOrganizationImpactsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)

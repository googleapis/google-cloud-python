...
class ServiceHealthAsyncClient:
    ...
    get_transport_class = functools.partial(type(ServiceHealthClient).get_transport_class, type(ServiceHealthClient))
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_organization_events(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_organization_event(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_organization_impacts(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_organization_impact(self,

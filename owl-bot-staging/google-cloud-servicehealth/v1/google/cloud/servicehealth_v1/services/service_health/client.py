...
class ServiceHealthClient(metaclass=ServiceHealthClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ServiceHealthTransport, Callable[..., ServiceHealthTransport]]] = None,
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ServiceHealthTransport], Callable[..., ServiceHealthTransport]] = (
                ServiceHealthClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ServiceHealthTransport], transport)
            )

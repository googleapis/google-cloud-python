...
from .transports.base import ServiceHealthTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import ServiceHealthGrpcTransport
from .transports.grpc_asyncio import ServiceHealthGrpcAsyncIOTransport
from .transports.rest import ServiceHealthRestTransport


class ServiceHealthClientMeta(type):
    """Metaclass for the ServiceHealth client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ServiceHealthTransport]]
    _transport_registry["grpc"] = ServiceHealthGrpcTransport
    _transport_registry["grpc_asyncio"] = ServiceHealthGrpcAsyncIOTransport
    _transport_registry["rest"] = ServiceHealthRestTransport
...
class ServiceHealthClient(metaclass=ServiceHealthClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "servicehealth.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ServiceHealthClient: The constructed client.
        """
    ...
    def transport(self) -> ServiceHealthTransport:
        ...
        Returns:
            ServiceHealthTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def event_path(project: str,location: str,event: str,) -> str:
        """Returns a fully-qualified event string."""
        return "projects/{project}/locations/{location}/events/{event}".format(project=project, location=location, event=event, )

    @staticmethod
    def parse_event_path(path: str) -> Dict[str,str]:
        """Parses a event path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/events/(?P<event>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def organization_event_path(organization: str,location: str,event: str,) -> str:
        """Returns a fully-qualified organization_event string."""
        return "organizations/{organization}/locations/{location}/organizationEvents/{event}".format(organization=organization, location=location, event=event, )

    @staticmethod
    def parse_organization_event_path(path: str) -> Dict[str,str]:
        """Parses a organization_event path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/organizationEvents/(?P<event>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def organization_impact_path(organization: str,location: str,organization_impact: str,) -> str:
        """Returns a fully-qualified organization_impact string."""
        return "organizations/{organization}/locations/{location}/organizationImpacts/{organization_impact}".format(organization=organization, location=location, organization_impact=organization_impact, )

    @staticmethod
    def parse_organization_impact_path(path: str) -> Dict[str,str]:
        """Parses a organization_impact path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/organizationImpacts/(?P<organization_impact>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ServiceHealthClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ServiceHealthClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ServiceHealthClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ServiceHealthClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ServiceHealthTransport]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ServiceHealthClient._read_environment_variables()
        self._client_cert_source = ServiceHealthClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ServiceHealthClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ServiceHealthTransport)
        if transport_provided:
            # transport is a ServiceHealthTransport instance.
            ...
            self._transport = cast(ServiceHealthTransport, transport)
    ...
    def list_events(self,
        ...
        # in a event_resources.ListEventsRequest.
    ...
    def get_event(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a event_resources.GetEventRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_organization_events(self,
            request: Optional[Union[event_resources.ListOrganizationEventsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> pagers.ListOrganizationEventsPager:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a event_resources.ListOrganizationEventsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_organization_events]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListOrganizationEventsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def get_organization_event(self,
            request: Optional[Union[event_resources.GetOrganizationEventRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a event_resources.GetOrganizationEventRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_organization_event]
    ...
    def list_organization_impacts(self,
            request: Optional[Union[event_resources.ListOrganizationImpactsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> pagers.ListOrganizationImpactsPager:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a event_resources.ListOrganizationImpactsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_organization_impacts]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListOrganizationImpactsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def get_organization_impact(self,
            request: Optional[Union[event_resources.GetOrganizationImpactRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a event_resources.GetOrganizationImpactRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_organization_impact]
    ...
    def __enter__(self) -> "ServiceHealthClient":
        return self

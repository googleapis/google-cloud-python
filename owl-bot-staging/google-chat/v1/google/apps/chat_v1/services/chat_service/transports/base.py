...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
    ...
    @property
    def create_message(self) -> Callable[
            [gc_message.CreateMessageRequest],
            Union[
                gc_message.Message,
                Awaitable[gc_message.Message]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def update_message(self) -> Callable[
    ...
    @property
    def delete_message(self) -> Callable[
    ...
    def get_attachment(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[attachment.Attachment]
            ]]:
        raise NotImplementedError()

    @property
    def upload_attachment(self) -> Callable[
    ...
    @property
    def list_spaces(self) -> Callable[
            [space.ListSpacesRequest],
            Union[
                space.ListSpacesResponse,
                Awaitable[space.ListSpacesResponse]
            ]]:
        raise NotImplementedError()
    ...
    def create_space(self) -> Callable[
            ...
            Union[
                gc_space.Space,
                Awaitable[gc_space.Space]
            ]]:
        raise NotImplementedError()

    @property
    def set_up_space(self) -> Callable[
    ...
    @property
    def delete_space(self) -> Callable[
    ...
    @property
    def complete_import_space(self) -> Callable[
    ...
    @property
    def find_direct_message(self) -> Callable[
    ...
    def create_membership(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[gc_membership.Membership]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def create_reaction(self) -> Callable[
            [gc_reaction.CreateReactionRequest],
            Union[
                gc_reaction.Reaction,
                Awaitable[gc_reaction.Reaction]
            ]]:
        raise NotImplementedError()

    @property
    def list_reactions(self) -> Callable[
    ...
    @property
    def delete_reaction(self) -> Callable[

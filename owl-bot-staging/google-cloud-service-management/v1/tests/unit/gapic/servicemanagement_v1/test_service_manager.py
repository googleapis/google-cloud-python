...
def test__get_api_endpoint():
    ...
    assert ServiceManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ServiceManagerClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert ServiceManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ServiceManagerClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    ServiceManagerClient, ServiceManagerAsyncClient
])
...
def test_list_services_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_list_services") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_list_services_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_list_services") as pre:
...
def test_get_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_get_service") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_get_service_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_get_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_create_service") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_create_service_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_create_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_delete_service") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_delete_service_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_delete_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_undelete_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_undelete_service") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_undelete_service_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_undelete_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_service_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_list_service_configs") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_list_service_configs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_list_service_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_service_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_get_service_config") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_get_service_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_get_service_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_service_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_create_service_config") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_create_service_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_create_service_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_submit_config_source_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_submit_config_source") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_submit_config_source_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_submit_config_source") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_service_rollouts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_list_service_rollouts") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_list_service_rollouts_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_list_service_rollouts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_service_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_get_service_rollout") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_get_service_rollout_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_get_service_rollout") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_service_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_create_service_rollout") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_create_service_rollout_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_create_service_rollout") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_generate_config_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_generate_config_report") as post, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "post_generate_config_report_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceManagerRestInterceptor, "pre_generate_config_report") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

...
def test_get_service_rest_unset_required_fields():
    transport = transports.ServiceManagerRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_undelete_service_rest_required_fields(request_type=servicemanager.UndeleteServiceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).undelete_service._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_service_configs_rest_required_fields(request_type=servicemanager.ListServiceConfigsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_service_configs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_service_config_rest_required_fields(request_type=servicemanager.GetServiceConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_service_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_service_config_rest_required_fields(request_type=servicemanager.CreateServiceConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_service_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_submit_config_source_rest_required_fields(request_type=servicemanager.SubmitConfigSourceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).submit_config_source._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_service_rollouts_rest_required_fields(request_type=servicemanager.ListServiceRolloutsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_service_rollouts._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_service_rollout_rest_required_fields(request_type=servicemanager.GetServiceRolloutRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_service_rollout._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_service_rollout_rest_required_fields(request_type=servicemanager.CreateServiceRolloutRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_service_rollout._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_config_report_rest_required_fields(request_type=servicemanager.GenerateConfigReportRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_config_report._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

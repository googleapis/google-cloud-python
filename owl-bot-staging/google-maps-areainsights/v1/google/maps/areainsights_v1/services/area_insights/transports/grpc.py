...
from .base import AreaInsightsTransport, DEFAULT_CLIENT_INFO
...
class AreaInsightsGrpcTransport(AreaInsightsTransport):
    ...
    @property
    def compute_insights(self) -> Callable[
        ...
        Returns:
            Callable[[~.ComputeInsightsRequest],
        ...
        if 'compute_insights' not in self._stubs:
            self._stubs['compute_insights'] = self._logged_channel.unary_unary(
                '/google.maps.areainsights.v1.AreaInsights/ComputeInsights',
                request_serializer=area_insights_service.ComputeInsightsRequest.serialize,
                response_deserializer=area_insights_service.ComputeInsightsResponse.deserialize,
            )
        return self._stubs['compute_insights']

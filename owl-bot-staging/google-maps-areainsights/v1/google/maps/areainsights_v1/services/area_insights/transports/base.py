...
class AreaInsightsTransport(abc.ABC):
    """Abstract transport class for AreaInsights."""

    AUTH_SCOPES = (
        'https://www.googleapis.com/auth/cloud-platform',
    )

    DEFAULT_HOST: str = 'areainsights.googleapis.com'
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.compute_insights: gapic_v1.method.wrap_method(

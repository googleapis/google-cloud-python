...
class AreaInsightsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_compute_insights(self, request: area_insights_service.ComputeInsightsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[area_insights_service.ComputeInsightsRequest, Sequence[Tuple[str, str]]]:

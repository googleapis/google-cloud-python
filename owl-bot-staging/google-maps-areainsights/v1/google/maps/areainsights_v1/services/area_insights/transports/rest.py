...
class AreaInsightsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_compute_insights(self, request: area_insights_service.ComputeInsightsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[area_insights_service.ComputeInsightsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_compute_insights(self, response: area_insights_service.ComputeInsightsResponse) -> area_insights_service.ComputeInsightsResponse:
        ...
        it is returned to user code. This `post_compute_insights` interceptor runs
        before the `post_compute_insights_with_metadata` interceptor.
        """
        return response

    def post_compute_insights_with_metadata(self, response: area_insights_service.ComputeInsightsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[area_insights_service.ComputeInsightsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for compute_insights

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the AreaInsights server but before it is returned to user code.

        We recommend only using this `post_compute_insights_with_metadata`
        interceptor in new development instead of the `post_compute_insights` interceptor.
        When both interceptors are used, this `post_compute_insights_with_metadata` interceptor runs after the
        `post_compute_insights` interceptor. The (possibly modified) response returned by
        `post_compute_insights` will be passed to
...
class AreaInsightsRestTransport(_BaseAreaInsightsRestTransport):
    ...
    class _ComputeInsights(_BaseAreaInsightsRestTransport._BaseComputeInsights, AreaInsightsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AreaInsightsRestTransport._ComputeInsights._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

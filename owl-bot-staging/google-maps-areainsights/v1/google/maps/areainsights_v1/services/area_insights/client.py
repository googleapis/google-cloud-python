...
class AreaInsightsClient(metaclass=AreaInsightsClientMeta):
    ...
    @staticmethod
    def place_path(place_id: str,) -> str:
        """Returns a fully-qualified place string."""
        return "places/{place_id}".format(place_id=place_id, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AreaInsightsClient._compare_universes(self.universe_domain, self.transport._credentials))

...
class UptimeCheckServiceGrpcAsyncIOTransport(UptimeCheckServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_uptime_check_configs: gapic_v1.method_async.wrap_method(
            ...
            self.get_uptime_check_config: gapic_v1.method_async.wrap_method(
            ...
            self.create_uptime_check_config: gapic_v1.method_async.wrap_method(
                self.create_uptime_check_config,
                default_timeout=30.0,
                client_info=client_info,
            ),
            self.update_uptime_check_config: gapic_v1.method_async.wrap_method(
                self.update_uptime_check_config,
                default_timeout=30.0,
                client_info=client_info,
            ),
            self.delete_uptime_check_config: gapic_v1.method_async.wrap_method(
            ...
            self.list_uptime_check_ips: gapic_v1.method_async.wrap_method(

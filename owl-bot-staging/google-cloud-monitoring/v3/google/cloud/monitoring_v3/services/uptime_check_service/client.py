...
class UptimeCheckServiceClient(metaclass=UptimeCheckServiceClientMeta):
    ...
    @staticmethod
    def function_path(project: str,location: str,function: str,) -> str:
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = UptimeCheckServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            UptimeCheckServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, UptimeCheckServiceTransport, Callable[..., UptimeCheckServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = UptimeCheckServiceClient._read_environment_variables()
        self._client_cert_source = UptimeCheckServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = UptimeCheckServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[UptimeCheckServiceTransport], Callable[..., UptimeCheckServiceTransport]] = (

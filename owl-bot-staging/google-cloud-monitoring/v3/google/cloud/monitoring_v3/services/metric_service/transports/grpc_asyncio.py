...
class MetricServiceGrpcAsyncIOTransport(MetricServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.get_monitored_resource_descriptor: gapic_v1.method_async.wrap_method(
            ...
            self.list_metric_descriptors: gapic_v1.method_async.wrap_method(
            ...
            self.get_metric_descriptor: gapic_v1.method_async.wrap_method(
            ...
            self.create_metric_descriptor: gapic_v1.method_async.wrap_method(
                self.create_metric_descriptor,
                default_timeout=12.0,
                client_info=client_info,
            ),
            self.delete_metric_descriptor: gapic_v1.method_async.wrap_method(
            ...
            self.list_time_series: gapic_v1.method_async.wrap_method(
            ...
            self.create_time_series: gapic_v1.method_async.wrap_method(
                self.create_time_series,
                default_timeout=12.0,
                client_info=client_info,
            ),
            self.create_service_time_series: gapic_v1.method_async.wrap_method(

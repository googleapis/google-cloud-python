...
class ServiceMonitoringServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(ServiceMonitoringServiceClient).get_transport_class, type(ServiceMonitoringServiceClient))
    ...
    async def create_service_level_objective(self,
    ...
    async def get_service_level_objective(self,
    ...
    async def list_service_level_objectives(self,
    ...
    async def update_service_level_objective(self,
    ...
    async def delete_service_level_objective(self,

...
class GroupServiceAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GroupServiceTransport, Callable[..., GroupServiceTransport]]] = "grpc_asyncio",
    ...
    async def list_group_members(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_group_members]

...
def test__get_api_endpoint():
    ...
    assert AlertPolicyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AlertPolicyServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert AlertPolicyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AlertPolicyServiceClient.DEFAULT_MTLS_ENDPOINT

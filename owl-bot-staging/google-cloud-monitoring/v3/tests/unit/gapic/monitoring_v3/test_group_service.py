...
def test__read_environment_variables():
    assert GroupServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert GroupServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert GroupServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert GroupServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert GroupServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert GroupServiceClient._get_client_cert_source(None, False) is None
    assert GroupServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert GroupServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert GroupServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert GroupServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(GroupServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GroupServiceClient))
@mock.patch.object(GroupServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GroupServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = GroupServiceClient._DEFAULT_UNIVERSE
    default_endpoint = GroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = GroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert GroupServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert GroupServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == GroupServiceClient.DEFAULT_MTLS_ENDPOINT
    assert GroupServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert GroupServiceClient._get_api_endpoint(None, None, default_universe, "always") == GroupServiceClient.DEFAULT_MTLS_ENDPOINT
    assert GroupServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == GroupServiceClient.DEFAULT_MTLS_ENDPOINT
    assert GroupServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert GroupServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        GroupServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert GroupServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert GroupServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert GroupServiceClient._get_universe_domain(None, None) == GroupServiceClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        GroupServiceClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = GroupServiceClient(credentials=cred)
...
@mock.patch.object(GroupServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GroupServiceClient))
@mock.patch.object(GroupServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GroupServiceAsyncClient))
def test_group_service_client_client_api_endpoint(client_class):
...
@pytest.mark.asyncio
async def test_create_group_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GroupServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_group in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_group] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_group_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GroupServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_group in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_group] = mock_rpc
...
def test_list_group_members_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = GroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_group_members_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_group_members in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_group_members] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_group_members_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GroupServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_group_members in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_group_members] = mock_rpc
...
def test_list_group_members_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_group_members(request={}, retry=retry, timeout=timeout)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_group_members_empty_call_grpc():
    client = GroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = group_service.ListGroupMembersResponse()
        client.list_group_members(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = GroupServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_group_members_empty_call_grpc_asyncio():
    client = GroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_group_members(request=None)

...
@mock.patch.object(ServiceMonitoringServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServiceMonitoringServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert ServiceMonitoringServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ServiceMonitoringServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ServiceMonitoringServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ServiceMonitoringServiceClient._get_api_endpoint(None, None, default_universe, "always") == ServiceMonitoringServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ServiceMonitoringServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ServiceMonitoringServiceClient.DEFAULT_MTLS_ENDPOINT
...
async def test_create_service_level_objective_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_service_level_objective] = mock_object
...
async def test_get_service_level_objective_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_service_level_objective] = mock_object
...
async def test_list_service_level_objectives_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_service_level_objectives] = mock_object
...
async def test_update_service_level_objective_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_service_level_objective] = mock_object
...
async def test_delete_service_level_objective_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_service_level_objective] = mock_object

...
class IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport(IdentityAwareProxyOAuthServiceTransport):
    ...
    def list_brands(self) -> Callable[
        ...
        if 'list_brands' not in self._stubs:
            self._stubs['list_brands'] = self._logged_channel.unary_unary(
    ...
    def create_brand(self) -> Callable[
        ...
        if 'create_brand' not in self._stubs:
            self._stubs['create_brand'] = self._logged_channel.unary_unary(
    ...
    def get_brand(self) -> Callable[
        ...
        if 'get_brand' not in self._stubs:
            self._stubs['get_brand'] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_brands: self._wrap_method(
                self.list_brands,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_brand: self._wrap_method(
                self.create_brand,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_brand: self._wrap_method(
                self.get_brand,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_identity_aware_proxy_client: self._wrap_method(
                self.create_identity_aware_proxy_client,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_identity_aware_proxy_clients: self._wrap_method(
                self.list_identity_aware_proxy_clients,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_identity_aware_proxy_client: self._wrap_method(
                self.get_identity_aware_proxy_client,
                default_timeout=None,
                client_info=client_info,
            ),
            self.reset_identity_aware_proxy_client_secret: self._wrap_method(
                self.reset_identity_aware_proxy_client_secret,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_identity_aware_proxy_client: self._wrap_method(

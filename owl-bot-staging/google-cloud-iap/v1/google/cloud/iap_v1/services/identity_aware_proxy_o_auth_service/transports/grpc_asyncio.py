...
class IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport(IdentityAwareProxyOAuthServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_brands: gapic_v1.method_async.wrap_method(
                self.list_brands,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_brand: gapic_v1.method_async.wrap_method(
                self.create_brand,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_brand: gapic_v1.method_async.wrap_method(
                self.get_brand,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_identity_aware_proxy_client: gapic_v1.method_async.wrap_method(
                self.create_identity_aware_proxy_client,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_identity_aware_proxy_clients: gapic_v1.method_async.wrap_method(
                self.list_identity_aware_proxy_clients,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_identity_aware_proxy_client: gapic_v1.method_async.wrap_method(
                self.get_identity_aware_proxy_client,
                default_timeout=None,
                client_info=client_info,
            ),
            self.reset_identity_aware_proxy_client_secret: gapic_v1.method_async.wrap_method(
                self.reset_identity_aware_proxy_client_secret,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_identity_aware_proxy_client: gapic_v1.method_async.wrap_method(

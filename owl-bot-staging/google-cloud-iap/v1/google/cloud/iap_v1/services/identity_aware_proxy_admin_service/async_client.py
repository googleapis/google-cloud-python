...
class IdentityAwareProxyAdminServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(IdentityAwareProxyAdminServiceClient).get_transport_class, type(IdentityAwareProxyAdminServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, IdentityAwareProxyAdminServiceTransport, Callable[..., IdentityAwareProxyAdminServiceTransport]]] = "grpc_asyncio",
    ...
    async def get_iap_settings(self,
    ...
    async def update_iap_settings(self,
    ...
    async def list_tunnel_dest_groups(self,
    ...
    async def create_tunnel_dest_group(self,
    ...
    async def get_tunnel_dest_group(self,
    ...
    async def delete_tunnel_dest_group(self,
    ...
    async def update_tunnel_dest_group(self,

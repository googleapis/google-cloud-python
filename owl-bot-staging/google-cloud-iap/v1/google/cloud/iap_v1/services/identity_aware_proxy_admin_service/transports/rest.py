...
from .base import IdentityAwareProxyAdminServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class IdentityAwareProxyAdminServiceRestTransport(IdentityAwareProxyAdminServiceTransport):

...
@mock.patch.object(IdentityAwareProxyAdminServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(IdentityAwareProxyAdminServiceClient))
@mock.patch.object(IdentityAwareProxyAdminServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(IdentityAwareProxyAdminServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert IdentityAwareProxyAdminServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == IdentityAwareProxyAdminServiceClient.DEFAULT_MTLS_ENDPOINT
    assert IdentityAwareProxyAdminServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert IdentityAwareProxyAdminServiceClient._get_api_endpoint(None, None, default_universe, "always") == IdentityAwareProxyAdminServiceClient.DEFAULT_MTLS_ENDPOINT
    assert IdentityAwareProxyAdminServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == IdentityAwareProxyAdminServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_validate_iap_attribute_expression(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.validate_iap_attribute_expression),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_validate_iap_attribute_expression_rest_required_fields(request_type=service.ValidateIapAttributeExpressionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).validate_iap_attribute_expression._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_validate_iap_attribute_expression_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("expression", )) & set(("name", "expression", )))
...
def test_transport_kind_grpc_asyncio():
    transport = IdentityAwareProxyAdminServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
...
def test_get_iap_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_get_iap_settings_with_metadata") as post_with_metadata, \
...
def test_update_iap_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_update_iap_settings_with_metadata") as post_with_metadata, \
...
def test_validate_iap_attribute_expression_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_validate_iap_attribute_expression") as post, \
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_validate_iap_attribute_expression_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "pre_validate_iap_attribute_expression") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.validate_iap_attribute_expression(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_tunnel_dest_groups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_list_tunnel_dest_groups_with_metadata") as post_with_metadata, \
...
def test_create_tunnel_dest_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_create_tunnel_dest_group_with_metadata") as post_with_metadata, \
...
def test_get_tunnel_dest_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_get_tunnel_dest_group_with_metadata") as post_with_metadata, \
...
def test_update_tunnel_dest_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_update_tunnel_dest_group_with_metadata") as post_with_metadata, \

...
def test__read_environment_variables():
    assert IdentityAwareProxyOAuthServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert IdentityAwareProxyOAuthServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert IdentityAwareProxyOAuthServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert IdentityAwareProxyOAuthServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert IdentityAwareProxyOAuthServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert IdentityAwareProxyOAuthServiceClient._get_client_cert_source(None, False) is None
    assert IdentityAwareProxyOAuthServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert IdentityAwareProxyOAuthServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert IdentityAwareProxyOAuthServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert IdentityAwareProxyOAuthServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(IdentityAwareProxyOAuthServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(IdentityAwareProxyOAuthServiceClient))
@mock.patch.object(IdentityAwareProxyOAuthServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(IdentityAwareProxyOAuthServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = IdentityAwareProxyOAuthServiceClient._DEFAULT_UNIVERSE
    default_endpoint = IdentityAwareProxyOAuthServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = IdentityAwareProxyOAuthServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert IdentityAwareProxyOAuthServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert IdentityAwareProxyOAuthServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == IdentityAwareProxyOAuthServiceClient.DEFAULT_MTLS_ENDPOINT
    assert IdentityAwareProxyOAuthServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert IdentityAwareProxyOAuthServiceClient._get_api_endpoint(None, None, default_universe, "always") == IdentityAwareProxyOAuthServiceClient.DEFAULT_MTLS_ENDPOINT
    assert IdentityAwareProxyOAuthServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == IdentityAwareProxyOAuthServiceClient.DEFAULT_MTLS_ENDPOINT
    assert IdentityAwareProxyOAuthServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert IdentityAwareProxyOAuthServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        IdentityAwareProxyOAuthServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert IdentityAwareProxyOAuthServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert IdentityAwareProxyOAuthServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert IdentityAwareProxyOAuthServiceClient._get_universe_domain(None, None) == IdentityAwareProxyOAuthServiceClient._DEFAULT_UNIVERSE
...
def test_identity_aware_proxy_o_auth_service_client_from_service_account_info(client_class, transport_name):
...
def test_identity_aware_proxy_o_auth_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (IdentityAwareProxyOAuthServiceClient, transports.IdentityAwareProxyOAuthServiceRestTransport, "rest"),
])
@mock.patch.object(IdentityAwareProxyOAuthServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(IdentityAwareProxyOAuthServiceClient))
@mock.patch.object(IdentityAwareProxyOAuthServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(IdentityAwareProxyOAuthServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (IdentityAwareProxyOAuthServiceClient, transports.IdentityAwareProxyOAuthServiceRestTransport, "rest", "true"),
    (IdentityAwareProxyOAuthServiceClient, transports.IdentityAwareProxyOAuthServiceRestTransport, "rest", "false"),
])
@mock.patch.object(IdentityAwareProxyOAuthServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(IdentityAwareProxyOAuthServiceClient))
@mock.patch.object(IdentityAwareProxyOAuthServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(IdentityAwareProxyOAuthServiceAsyncClient))
...
def test_identity_aware_proxy_o_auth_service_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (IdentityAwareProxyOAuthServiceClient, transports.IdentityAwareProxyOAuthServiceGrpcTransport, "grpc", grpc_helpers),
    (IdentityAwareProxyOAuthServiceAsyncClient, transports.IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (IdentityAwareProxyOAuthServiceClient, transports.IdentityAwareProxyOAuthServiceRestTransport, "rest", None),
])
def test_identity_aware_proxy_o_auth_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_identity_aware_proxy_o_auth_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_list_brands_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_brands in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_brands] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_brand_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = IdentityAwareProxyOAuthServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_brand in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_brand] = mock_rpc
...
async def test_get_brand_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_brand in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_brand] = mock_rpc
...
def test_create_identity_aware_proxy_client_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_identity_aware_proxy_client in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_identity_aware_proxy_client] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_identity_aware_proxy_client_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = IdentityAwareProxyOAuthServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_identity_aware_proxy_client in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_identity_aware_proxy_client] = mock_rpc
...
def test_list_identity_aware_proxy_clients_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_identity_aware_proxy_clients in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_identity_aware_proxy_clients] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_identity_aware_proxy_clients_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = IdentityAwareProxyOAuthServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_identity_aware_proxy_clients in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_identity_aware_proxy_clients] = mock_rpc
...
def test_list_identity_aware_proxy_clients_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_identity_aware_proxy_clients(request={}, retry=retry, timeout=timeout)
...
def test_get_identity_aware_proxy_client_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_identity_aware_proxy_client in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_identity_aware_proxy_client] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_identity_aware_proxy_client_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = IdentityAwareProxyOAuthServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_identity_aware_proxy_client in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_identity_aware_proxy_client] = mock_rpc
...
def test_reset_identity_aware_proxy_client_secret_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.reset_identity_aware_proxy_client_secret in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.reset_identity_aware_proxy_client_secret] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_reset_identity_aware_proxy_client_secret_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = IdentityAwareProxyOAuthServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.reset_identity_aware_proxy_client_secret in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.reset_identity_aware_proxy_client_secret] = mock_rpc
...
def test_delete_identity_aware_proxy_client_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_identity_aware_proxy_client in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_identity_aware_proxy_client] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_identity_aware_proxy_client_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = IdentityAwareProxyOAuthServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_identity_aware_proxy_client in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_identity_aware_proxy_client] = mock_rpc
...
def test_list_brands_rest_required_fields(request_type=service.ListBrandsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_brands._get_unset_required_fields(jsonified_request)
...
def test_list_brands_rest_unset_required_fields():
    transport = transports.IdentityAwareProxyOAuthServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_create_brand_rest_required_fields(request_type=service.CreateBrandRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_brand._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_brand_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "brand", )))
...
def test_get_brand_rest_required_fields(request_type=service.GetBrandRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_brand._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_identity_aware_proxy_client_rest_required_fields(request_type=service.CreateIdentityAwareProxyClientRequest):
    transport_class = transports.IdentityAwareProxyOAuthServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_identity_aware_proxy_client._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_identity_aware_proxy_client_rest_unset_required_fields():
    ...
    unset_fields = transport.create_identity_aware_proxy_client._get_unset_required_fields({})
...
def test_list_identity_aware_proxy_clients_rest_required_fields(request_type=service.ListIdentityAwareProxyClientsRequest):
    transport_class = transports.IdentityAwareProxyOAuthServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_identity_aware_proxy_clients._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_identity_aware_proxy_clients_rest_unset_required_fields():
    ...
    unset_fields = transport.list_identity_aware_proxy_clients._get_unset_required_fields({})
...
def test_list_identity_aware_proxy_clients_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(service.ListIdentityAwareProxyClientsResponse.to_json(x) for x in response)
        ...
        pages = list(client.list_identity_aware_proxy_clients(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_identity_aware_proxy_client_rest_required_fields(request_type=service.GetIdentityAwareProxyClientRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_identity_aware_proxy_client._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reset_identity_aware_proxy_client_secret_rest_required_fields(request_type=service.ResetIdentityAwareProxyClientSecretRequest):
    transport_class = transports.IdentityAwareProxyOAuthServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).reset_identity_aware_proxy_client_secret._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reset_identity_aware_proxy_client_secret_rest_unset_required_fields():
    ...
    unset_fields = transport.reset_identity_aware_proxy_client_secret._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_delete_identity_aware_proxy_client_rest_required_fields(request_type=service.DeleteIdentityAwareProxyClientRequest):
    transport_class = transports.IdentityAwareProxyOAuthServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_identity_aware_proxy_client._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_identity_aware_proxy_client_rest_unset_required_fields():
    ...
    unset_fields = transport.delete_identity_aware_proxy_client._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_transport_kind_grpc_asyncio():
    transport = IdentityAwareProxyOAuthServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_list_brands_rest_interceptors(null_interceptor):
    transport = transports.IdentityAwareProxyOAuthServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.IdentityAwareProxyOAuthServiceRestInterceptor(),
        )
    client = IdentityAwareProxyOAuthServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_list_brands") as post, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_list_brands_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_list_brands") as pre:
        ...
        client.list_brands(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_brand_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1'}
    request_init["brand"] = {'name': 'name_value', 'support_email': 'support_email_value', 'application_title': 'application_title_value', 'org_internal_only': True}
...
def test_create_brand_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_create_brand") as post, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_create_brand_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_create_brand") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_brand(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_brand_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_get_brand") as post, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_get_brand_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_get_brand") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_brand(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_identity_aware_proxy_client_rest_bad_request(request_type=service.CreateIdentityAwareProxyClientRequest):
    client = IdentityAwareProxyOAuthServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_identity_aware_proxy_client_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/brands/sample2'}
    request_init["identity_aware_proxy_client"] = {'name': 'name_value', 'secret': 'secret_value', 'display_name': 'display_name_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = service.CreateIdentityAwareProxyClientRequest.meta.fields["identity_aware_proxy_client"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["identity_aware_proxy_client"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["identity_aware_proxy_client"][field])):
...
def test_create_identity_aware_proxy_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_create_identity_aware_proxy_client") as post, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_create_identity_aware_proxy_client_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_create_identity_aware_proxy_client") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.CreateIdentityAwareProxyClientRequest.pb(service.CreateIdentityAwareProxyClientRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.IdentityAwareProxyClient.to_json(service.IdentityAwareProxyClient())
        req.return_value.content = return_value
        ...
        client.create_identity_aware_proxy_client(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_identity_aware_proxy_clients_rest_bad_request(request_type=service.ListIdentityAwareProxyClientsRequest):
    client = IdentityAwareProxyOAuthServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_identity_aware_proxy_clients_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_list_identity_aware_proxy_clients") as post, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_list_identity_aware_proxy_clients_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_list_identity_aware_proxy_clients") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.ListIdentityAwareProxyClientsRequest.pb(service.ListIdentityAwareProxyClientsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListIdentityAwareProxyClientsResponse.to_json(service.ListIdentityAwareProxyClientsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.ListIdentityAwareProxyClientsResponse(), metadata

        client.list_identity_aware_proxy_clients(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_identity_aware_proxy_client_rest_bad_request(request_type=service.GetIdentityAwareProxyClientRequest):
    client = IdentityAwareProxyOAuthServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/brands/sample2/identityAwareProxyClients/sample3'}
    request = request_type(**request_init)
...
def test_get_identity_aware_proxy_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_get_identity_aware_proxy_client") as post, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_get_identity_aware_proxy_client_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_get_identity_aware_proxy_client") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.GetIdentityAwareProxyClientRequest.pb(service.GetIdentityAwareProxyClientRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_identity_aware_proxy_client(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_reset_identity_aware_proxy_client_secret_rest_bad_request(request_type=service.ResetIdentityAwareProxyClientSecretRequest):
    client = IdentityAwareProxyOAuthServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_reset_identity_aware_proxy_client_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_reset_identity_aware_proxy_client_secret") as post, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_reset_identity_aware_proxy_client_secret_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_reset_identity_aware_proxy_client_secret") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.ResetIdentityAwareProxyClientSecretRequest.pb(service.ResetIdentityAwareProxyClientSecretRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.reset_identity_aware_proxy_client_secret(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_identity_aware_proxy_client_rest_bad_request(request_type=service.DeleteIdentityAwareProxyClientRequest):
    client = IdentityAwareProxyOAuthServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_identity_aware_proxy_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_delete_identity_aware_proxy_client") as pre:
        pre.assert_not_called()
        pb_message = service.DeleteIdentityAwareProxyClientRequest.pb(service.DeleteIdentityAwareProxyClientRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_identity_aware_proxy_client(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_identity_aware_proxy_o_auth_service_transport_auth_gdch_credentials(transport_class):
...
def test_identity_aware_proxy_o_auth_service_client_transport_session_collision(transport_name):
...
@pytest.mark.parametrize("client_class,transport_class", [
    (IdentityAwareProxyOAuthServiceClient, transports.IdentityAwareProxyOAuthServiceGrpcTransport),
    (IdentityAwareProxyOAuthServiceAsyncClient, transports.IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport),
])

...
def test_list_brands_rest_required_fields(request_type=service.ListBrandsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_brands._get_unset_required_fields(jsonified_request)
...
def test_create_brand_rest_required_fields(request_type=service.CreateBrandRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_brand._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_brand_rest_required_fields(request_type=service.GetBrandRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_brand._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_identity_aware_proxy_client_rest_required_fields(request_type=service.CreateIdentityAwareProxyClientRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_identity_aware_proxy_client._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_identity_aware_proxy_clients_rest_required_fields(request_type=service.ListIdentityAwareProxyClientsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_identity_aware_proxy_clients._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_identity_aware_proxy_client_rest_required_fields(request_type=service.GetIdentityAwareProxyClientRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_identity_aware_proxy_client._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reset_identity_aware_proxy_client_secret_rest_required_fields(request_type=service.ResetIdentityAwareProxyClientSecretRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).reset_identity_aware_proxy_client_secret._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_identity_aware_proxy_client_rest_required_fields(request_type=service.DeleteIdentityAwareProxyClientRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_identity_aware_proxy_client._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

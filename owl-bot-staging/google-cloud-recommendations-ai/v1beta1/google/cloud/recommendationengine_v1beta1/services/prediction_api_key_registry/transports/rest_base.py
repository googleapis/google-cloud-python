...
class _BasePredictionApiKeyRegistryRestTransport(PredictionApiKeyRegistryTransport):
    """Base REST backend transport for PredictionApiKeyRegistry.
    ...
    class _BaseCreatePredictionApiKeyRegistration:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BasePredictionApiKeyRegistryRestTransport._BaseCreatePredictionApiKeyRegistration._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseDeletePredictionApiKeyRegistration:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BasePredictionApiKeyRegistryRestTransport._BaseDeletePredictionApiKeyRegistration._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseListPredictionApiKeyRegistrations:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BasePredictionApiKeyRegistryRestTransport._BaseListPredictionApiKeyRegistrations._get_unset_required_fields(query_params))
...
__all__=(
    '_BasePredictionApiKeyRegistryRestTransport',
)

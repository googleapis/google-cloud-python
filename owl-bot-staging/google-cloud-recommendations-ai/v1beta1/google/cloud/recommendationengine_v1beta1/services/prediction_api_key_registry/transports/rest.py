...
class PredictionApiKeyRegistryRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_prediction_api_key_registration(self, request: prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_prediction_api_key_registration(self, response: prediction_apikey_registry_service.PredictionApiKeyRegistration) -> prediction_apikey_registry_service.PredictionApiKeyRegistration:
        ...
        DEPRECATED. Please use the `post_create_prediction_api_key_registration_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the PredictionApiKeyRegistry server but before
        it is returned to user code. This `post_create_prediction_api_key_registration` interceptor runs
        before the `post_create_prediction_api_key_registration_with_metadata` interceptor.
        """
        return response

    def post_create_prediction_api_key_registration_with_metadata(self, response: prediction_apikey_registry_service.PredictionApiKeyRegistration, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[prediction_apikey_registry_service.PredictionApiKeyRegistration, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_prediction_api_key_registration

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the PredictionApiKeyRegistry server but before it is returned to user code.

        We recommend only using this `post_create_prediction_api_key_registration_with_metadata`
        interceptor in new development instead of the `post_create_prediction_api_key_registration` interceptor.
        When both interceptors are used, this `post_create_prediction_api_key_registration_with_metadata` interceptor runs after the
        `post_create_prediction_api_key_registration` interceptor. The (possibly modified) response returned by
        `post_create_prediction_api_key_registration` will be passed to
        `post_create_prediction_api_key_registration_with_metadata`.
        """
        return response, metadata

    def pre_delete_prediction_api_key_registration(self, request: prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_prediction_api_key_registrations(self, request: prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_prediction_api_key_registrations(self, response: prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse) -> prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse:
        ...
        DEPRECATED. Please use the `post_list_prediction_api_key_registrations_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the PredictionApiKeyRegistry server but before
        it is returned to user code. This `post_list_prediction_api_key_registrations` interceptor runs
        before the `post_list_prediction_api_key_registrations_with_metadata` interceptor.
        """
        return response

    def post_list_prediction_api_key_registrations_with_metadata(self, response: prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_prediction_api_key_registrations

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the PredictionApiKeyRegistry server but before it is returned to user code.

        We recommend only using this `post_list_prediction_api_key_registrations_with_metadata`
        interceptor in new development instead of the `post_list_prediction_api_key_registrations` interceptor.
        When both interceptors are used, this `post_list_prediction_api_key_registrations_with_metadata` interceptor runs after the
        `post_list_prediction_api_key_registrations` interceptor. The (possibly modified) response returned by
        `post_list_prediction_api_key_registrations` will be passed to
        `post_list_prediction_api_key_registrations_with_metadata`.
        """
        return response, metadata
...
class PredictionApiKeyRegistryRestTransport(_BasePredictionApiKeyRegistryRestTransport):
    ...
    class _CreatePredictionApiKeyRegistration(_BasePredictionApiKeyRegistryRestTransport._BaseCreatePredictionApiKeyRegistration, PredictionApiKeyRegistryRestStub):
        def __hash__(self):
        ...
        registration method over HTTP.
            ...
            transcoded_request = _BasePredictionApiKeyRegistryRestTransport._BaseCreatePredictionApiKeyRegistration._get_transcoded_request(http_options, request)
            ...
            query_params = _BasePredictionApiKeyRegistryRestTransport._BaseCreatePredictionApiKeyRegistration._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PredictionApiKeyRegistryRestTransport._CreatePredictionApiKeyRegistration._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeletePredictionApiKeyRegistration(_BasePredictionApiKeyRegistryRestTransport._BaseDeletePredictionApiKeyRegistration, PredictionApiKeyRegistryRestStub):
        def __hash__(self):
        ...
        registration method over HTTP.
            ...
            transcoded_request = _BasePredictionApiKeyRegistryRestTransport._BaseDeletePredictionApiKeyRegistration._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePredictionApiKeyRegistryRestTransport._BaseDeletePredictionApiKeyRegistration._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PredictionApiKeyRegistryRestTransport._DeletePredictionApiKeyRegistration._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListPredictionApiKeyRegistrations(_BasePredictionApiKeyRegistryRestTransport._BaseListPredictionApiKeyRegistrations, PredictionApiKeyRegistryRestStub):
        def __hash__(self):
        ...
        registrations method over HTTP.
            ...
            transcoded_request = _BasePredictionApiKeyRegistryRestTransport._BaseListPredictionApiKeyRegistrations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePredictionApiKeyRegistryRestTransport._BaseListPredictionApiKeyRegistrations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PredictionApiKeyRegistryRestTransport._ListPredictionApiKeyRegistrations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

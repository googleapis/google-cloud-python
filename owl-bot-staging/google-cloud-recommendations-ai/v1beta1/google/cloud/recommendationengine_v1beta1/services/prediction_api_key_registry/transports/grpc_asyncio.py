...
class PredictionApiKeyRegistryGrpcAsyncIOTransport(PredictionApiKeyRegistryTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_prediction_api_key_registration: self._wrap_method(
            ...
            self.list_prediction_api_key_registrations: self._wrap_method(
            ...
            self.delete_prediction_api_key_registration: self._wrap_method(

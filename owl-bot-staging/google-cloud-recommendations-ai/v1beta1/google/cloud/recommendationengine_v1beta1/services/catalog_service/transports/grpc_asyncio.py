...
class CatalogServiceGrpcAsyncIOTransport(CatalogServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_catalog_item: gapic_v1.method_async.wrap_method(
            ...
            self.get_catalog_item: gapic_v1.method_async.wrap_method(
            ...
            self.list_catalog_items: gapic_v1.method_async.wrap_method(
            ...
            self.update_catalog_item: gapic_v1.method_async.wrap_method(
            ...
            self.delete_catalog_item: gapic_v1.method_async.wrap_method(
            ...
            self.import_catalog_items: gapic_v1.method_async.wrap_method(

...
class CatalogServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_catalog_item(self, request: catalog_service.CreateCatalogItemRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[catalog_service.CreateCatalogItemRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_catalog_item_with_metadata(self, response: catalog.CatalogItem, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[catalog.CatalogItem, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_catalog_item
    ...
    def pre_delete_catalog_item(self, request: catalog_service.DeleteCatalogItemRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[catalog_service.DeleteCatalogItemRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_catalog_item(self, request: catalog_service.GetCatalogItemRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[catalog_service.GetCatalogItemRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_catalog_item_with_metadata(self, response: catalog.CatalogItem, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[catalog.CatalogItem, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_catalog_item
    ...
    def pre_import_catalog_items(self, request: import_.ImportCatalogItemsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[import_.ImportCatalogItemsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_import_catalog_items_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for import_catalog_items
    ...
    def pre_list_catalog_items(self, request: catalog_service.ListCatalogItemsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[catalog_service.ListCatalogItemsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_catalog_items_with_metadata(self, response: catalog_service.ListCatalogItemsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[catalog_service.ListCatalogItemsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_catalog_items
    ...
    def pre_update_catalog_item(self, request: catalog_service.UpdateCatalogItemRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[catalog_service.UpdateCatalogItemRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_catalog_item_with_metadata(self, response: catalog.CatalogItem, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[catalog.CatalogItem, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_catalog_item
...
class CatalogServiceRestTransport(_BaseCatalogServiceRestTransport):
    ...
    class _CreateCatalogItem(_BaseCatalogServiceRestTransport._BaseCreateCatalogItem, CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseCatalogServiceRestTransport._BaseCreateCatalogItem._get_transcoded_request(http_options, request)

            body = _BaseCatalogServiceRestTransport._BaseCreateCatalogItem._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseCatalogServiceRestTransport._BaseCreateCatalogItem._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CatalogServiceRestTransport._CreateCatalogItem._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = self._interceptor.post_create_catalog_item_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _DeleteCatalogItem(_BaseCatalogServiceRestTransport._BaseDeleteCatalogItem, CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseCatalogServiceRestTransport._BaseDeleteCatalogItem._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseCatalogServiceRestTransport._BaseDeleteCatalogItem._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CatalogServiceRestTransport._DeleteCatalogItem._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetCatalogItem(_BaseCatalogServiceRestTransport._BaseGetCatalogItem, CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseCatalogServiceRestTransport._BaseGetCatalogItem._get_http_options()

            request, metadata = self._interceptor.pre_get_catalog_item(request, metadata)
            transcoded_request = _BaseCatalogServiceRestTransport._BaseGetCatalogItem._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseCatalogServiceRestTransport._BaseGetCatalogItem._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CatalogServiceRestTransport._GetCatalogItem._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_get_catalog_item_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = catalog.CatalogItem.to_json(response)
                except:
    ...
    class _ImportCatalogItems(_BaseCatalogServiceRestTransport._BaseImportCatalogItems, CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseCatalogServiceRestTransport._BaseImportCatalogItems._get_transcoded_request(http_options, request)

            body = _BaseCatalogServiceRestTransport._BaseImportCatalogItems._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseCatalogServiceRestTransport._BaseImportCatalogItems._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CatalogServiceRestTransport._ImportCatalogItems._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_import_catalog_items_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _ListCatalogItems(_BaseCatalogServiceRestTransport._BaseListCatalogItems, CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseCatalogServiceRestTransport._BaseListCatalogItems._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseCatalogServiceRestTransport._BaseListCatalogItems._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CatalogServiceRestTransport._ListCatalogItems._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_catalog_items_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = catalog_service.ListCatalogItemsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _UpdateCatalogItem(_BaseCatalogServiceRestTransport._BaseUpdateCatalogItem, CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseCatalogServiceRestTransport._BaseUpdateCatalogItem._get_transcoded_request(http_options, request)

            body = _BaseCatalogServiceRestTransport._BaseUpdateCatalogItem._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseCatalogServiceRestTransport._BaseUpdateCatalogItem._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CatalogServiceRestTransport._UpdateCatalogItem._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_update_catalog_item_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = catalog.CatalogItem.to_json(response)
                except:

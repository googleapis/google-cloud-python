...
class UserEventServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_import_user_events(self, request: import_.ImportUserEventsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[import_.ImportUserEventsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_user_events(self, request: user_event_service.ListUserEventsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user_event_service.ListUserEventsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_user_events(self, response: user_event_service.ListUserEventsResponse) -> user_event_service.ListUserEventsResponse:
        ...
        DEPRECATED. Please use the `post_list_user_events_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the UserEventService server but before
        it is returned to user code. This `post_list_user_events` interceptor runs
        before the `post_list_user_events_with_metadata` interceptor.
        """
        return response

    def post_list_user_events_with_metadata(self, response: user_event_service.ListUserEventsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user_event_service.ListUserEventsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_user_events

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the UserEventService server but before it is returned to user code.

        We recommend only using this `post_list_user_events_with_metadata`
        interceptor in new development instead of the `post_list_user_events` interceptor.
        When both interceptors are used, this `post_list_user_events_with_metadata` interceptor runs after the
        `post_list_user_events` interceptor. The (possibly modified) response returned by
        `post_list_user_events` will be passed to
        `post_list_user_events_with_metadata`.
        """
        return response, metadata

    def pre_purge_user_events(self, request: user_event_service.PurgeUserEventsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user_event_service.PurgeUserEventsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_write_user_event_with_metadata(self, response: gcr_user_event.UserEvent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcr_user_event.UserEvent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for write_user_event
...
class UserEventServiceRestTransport(_BaseUserEventServiceRestTransport):
    ...
    class _CollectUserEvent(_BaseUserEventServiceRestTransport._BaseCollectUserEvent, UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.recommendationengine_v1beta1.UserEventServiceClient.CollectUserEvent",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.recommendationengine_v1beta1.UserEventServiceClient.collect_user_event",
                    extra = {
                        "serviceName": "google.cloud.recommendationengine.v1beta1.UserEventService",
                        "rpcName": "CollectUserEvent",
    ...
    class _ImportUserEvents(_BaseUserEventServiceRestTransport._BaseImportUserEvents, UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.recommendationengine_v1beta1.UserEventServiceClient.ImportUserEvents",
                    extra = {
                        "serviceName": "google.cloud.recommendationengine.v1beta1.UserEventService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.recommendationengine_v1beta1.UserEventServiceClient.import_user_events",
                    extra = {
                        "serviceName": "google.cloud.recommendationengine.v1beta1.UserEventService",
                        "rpcName": "ImportUserEvents",
                        "metadata": http_response["headers"],
    ...
    class _ListUserEvents(_BaseUserEventServiceRestTransport._BaseListUserEvents, UserEventServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseUserEventServiceRestTransport._BaseListUserEvents._get_http_options()

            request, metadata = self._interceptor.pre_list_user_events(request, metadata)
            transcoded_request = _BaseUserEventServiceRestTransport._BaseListUserEvents._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseUserEventServiceRestTransport._BaseListUserEvents._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.recommendationengine_v1beta1.UserEventServiceClient.ListUserEvents",
                    extra = {
                        "serviceName": "google.cloud.recommendationengine.v1beta1.UserEventService",
                        "rpcName": "ListUserEvents",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = UserEventServiceRestTransport._ListUserEvents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_user_events_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = user_event_service.ListUserEventsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.recommendationengine_v1beta1.UserEventServiceClient.list_user_events",
                    extra = {
                        "serviceName": "google.cloud.recommendationengine.v1beta1.UserEventService",
                        "rpcName": "ListUserEvents",
                        "metadata": http_response["headers"],
    ...
    class _PurgeUserEvents(_BaseUserEventServiceRestTransport._BasePurgeUserEvents, UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.recommendationengine_v1beta1.UserEventServiceClient.PurgeUserEvents",
                    extra = {
                        "serviceName": "google.cloud.recommendationengine.v1beta1.UserEventService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.recommendationengine_v1beta1.UserEventServiceClient.purge_user_events",
                    extra = {
                        "serviceName": "google.cloud.recommendationengine.v1beta1.UserEventService",
                        "rpcName": "PurgeUserEvents",
                        "metadata": http_response["headers"],
    ...
    class _WriteUserEvent(_BaseUserEventServiceRestTransport._BaseWriteUserEvent, UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.recommendationengine_v1beta1.UserEventServiceClient.WriteUserEvent",
                    extra = {
                        "serviceName": "google.cloud.recommendationengine.v1beta1.UserEventService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.recommendationengine_v1beta1.UserEventServiceClient.write_user_event",
                    extra = {
                        "serviceName": "google.cloud.recommendationengine.v1beta1.UserEventService",
                        "rpcName": "WriteUserEvent",
                        "metadata": http_response["headers"],

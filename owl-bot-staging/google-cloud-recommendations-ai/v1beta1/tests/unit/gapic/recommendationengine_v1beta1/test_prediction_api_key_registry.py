...
def test_create_prediction_api_key_registration_rest_required_fields(request_type=prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_prediction_api_key_registration._get_unset_required_fields(jsonified_request)
...
def test_create_prediction_api_key_registration_rest_unset_required_fields():
    transport = transports.PredictionApiKeyRegistryRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_prediction_api_key_registrations_rest_required_fields(request_type=prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_prediction_api_key_registrations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_prediction_api_key_registration_rest_required_fields(request_type=prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_prediction_api_key_registration._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

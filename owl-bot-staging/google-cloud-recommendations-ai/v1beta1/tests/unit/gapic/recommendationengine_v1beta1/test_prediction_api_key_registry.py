...
def test__read_environment_variables():
    assert PredictionApiKeyRegistryClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert PredictionApiKeyRegistryClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        with pytest.raises(ValueError) as excinfo:
            PredictionApiKeyRegistryClient._read_environment_variables()
    assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert PredictionApiKeyRegistryClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert PredictionApiKeyRegistryClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert PredictionApiKeyRegistryClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert PredictionApiKeyRegistryClient._get_client_cert_source(None, False) is None
    assert PredictionApiKeyRegistryClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert PredictionApiKeyRegistryClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert PredictionApiKeyRegistryClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert PredictionApiKeyRegistryClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(PredictionApiKeyRegistryClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PredictionApiKeyRegistryClient))
@mock.patch.object(PredictionApiKeyRegistryAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PredictionApiKeyRegistryAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = PredictionApiKeyRegistryClient._DEFAULT_UNIVERSE
    default_endpoint = PredictionApiKeyRegistryClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = PredictionApiKeyRegistryClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert PredictionApiKeyRegistryClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert PredictionApiKeyRegistryClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == PredictionApiKeyRegistryClient.DEFAULT_MTLS_ENDPOINT
    assert PredictionApiKeyRegistryClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert PredictionApiKeyRegistryClient._get_api_endpoint(None, None, default_universe, "always") == PredictionApiKeyRegistryClient.DEFAULT_MTLS_ENDPOINT
    assert PredictionApiKeyRegistryClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == PredictionApiKeyRegistryClient.DEFAULT_MTLS_ENDPOINT
    assert PredictionApiKeyRegistryClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert PredictionApiKeyRegistryClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        PredictionApiKeyRegistryClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert PredictionApiKeyRegistryClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert PredictionApiKeyRegistryClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert PredictionApiKeyRegistryClient._get_universe_domain(None, None) == PredictionApiKeyRegistryClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        PredictionApiKeyRegistryClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = PredictionApiKeyRegistryClient(credentials=cred)
...
@mock.patch.object(PredictionApiKeyRegistryClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PredictionApiKeyRegistryClient))
@mock.patch.object(PredictionApiKeyRegistryAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PredictionApiKeyRegistryAsyncClient))
def test_prediction_api_key_registry_client_client_api_endpoint(client_class):
...
def test_create_prediction_api_key_registration_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_prediction_api_key_registration in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_prediction_api_key_registration] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_prediction_api_key_registration_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_prediction_api_key_registration in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_prediction_api_key_registration] = mock_rpc
...
def test_list_prediction_api_key_registrations_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_prediction_api_key_registrations in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_prediction_api_key_registrations] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_prediction_api_key_registrations_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PredictionApiKeyRegistryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_prediction_api_key_registrations in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_prediction_api_key_registrations] = mock_rpc
...
def test_list_prediction_api_key_registrations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_prediction_api_key_registrations(request={}, retry=retry, timeout=timeout)
...
def test_delete_prediction_api_key_registration_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_prediction_api_key_registration in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_prediction_api_key_registration] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_prediction_api_key_registration_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PredictionApiKeyRegistryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_prediction_api_key_registration in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_prediction_api_key_registration] = mock_rpc
...
def test_create_prediction_api_key_registration_rest_required_fields(request_type=prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = prediction_apikey_registry_service.PredictionApiKeyRegistration.pb(return_value)
...
def test_list_prediction_api_key_registrations_rest_required_fields(request_type=prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_create_prediction_api_key_registration_empty_call_grpc():
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = prediction_apikey_registry_service.PredictionApiKeyRegistration()
        client.create_prediction_api_key_registration(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_prediction_api_key_registrations_empty_call_grpc():
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_prediction_api_key_registration_empty_call_grpc():
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_prediction_api_key_registration(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = PredictionApiKeyRegistryAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_prediction_api_key_registration_empty_call_grpc_asyncio():
    client = PredictionApiKeyRegistryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_prediction_api_key_registration(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_prediction_api_key_registrations_empty_call_grpc_asyncio():
    client = PredictionApiKeyRegistryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_prediction_api_key_registrations(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_prediction_api_key_registration_empty_call_grpc_asyncio():
    client = PredictionApiKeyRegistryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_prediction_api_key_registration(request=None)
...
def test_transport_kind_rest():
    transport = PredictionApiKeyRegistryClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_prediction_api_key_registration_rest_bad_request(request_type=prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_prediction_api_key_registration_rest_call_success(request_type):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_prediction_api_key_registration_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, "post_create_prediction_api_key_registration_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = prediction_apikey_registry_service.PredictionApiKeyRegistration.to_json(prediction_apikey_registry_service.PredictionApiKeyRegistration())
        ...
        post_with_metadata.return_value = prediction_apikey_registry_service.PredictionApiKeyRegistration(), metadata
...
def test_list_prediction_api_key_registrations_rest_bad_request(request_type=prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_prediction_api_key_registrations_rest_call_success(request_type):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_prediction_api_key_registrations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, "post_list_prediction_api_key_registrations_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse.to_json(prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(), metadata
...
def test_delete_prediction_api_key_registration_rest_bad_request(request_type=prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_prediction_api_key_registration_rest_call_success(request_type):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_prediction_api_key_registration_empty_call_rest():
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_prediction_api_key_registrations_empty_call_rest():
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_prediction_api_key_registration_empty_call_rest():
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

...
from google.cloud.recommendationengine_v1beta1.services.catalog_service import CatalogServiceAsyncClient
...
def test_catalog_service_client_client_options_from_dict():
    with mock.patch('google.cloud.recommendationengine_v1beta1.services.catalog_service.transports.CatalogServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_catalog_item_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_catalog_item in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_catalog_item] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_catalog_item_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_catalog_item in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_catalog_item] = mock_rpc
...
def test_get_catalog_item_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_catalog_item] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_catalog_item_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CatalogServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_catalog_item in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_catalog_item] = mock_rpc
...
def test_list_catalog_items_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_catalog_items in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_catalog_items] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_catalog_items_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CatalogServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_catalog_items in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_catalog_items] = mock_rpc
...
def test_list_catalog_items_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, catalog.CatalogItem)
                   for i in results)
...
def test_update_catalog_item_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_catalog_item in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_catalog_item] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_catalog_item_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CatalogServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_catalog_item in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_catalog_item] = mock_rpc
...
def test_delete_catalog_item_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_catalog_item in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_catalog_item] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_catalog_item_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CatalogServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_catalog_item in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_catalog_item] = mock_rpc
...
def test_import_catalog_items_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.import_catalog_items in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_catalog_items] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_import_catalog_items_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CatalogServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_catalog_items in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_catalog_items] = mock_rpc
...
def test_import_catalog_items_flattened():
    ...
    with mock.patch.object(
        ...
        client.import_catalog_items(
            parent='parent_value',
            request_id='request_id_value',
            input_config=import_.InputConfig(catalog_inline_source=import_.CatalogInlineSource(catalog_items=[catalog.CatalogItem(id='id_value')])),
        ...
        mock_val = import_.InputConfig(catalog_inline_source=import_.CatalogInlineSource(catalog_items=[catalog.CatalogItem(id='id_value')]))
        assert arg == mock_val
...
def test_create_catalog_item_rest_required_fields(request_type=catalog_service.CreateCatalogItemRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_catalog_item._get_unset_required_fields(jsonified_request)
...
def test_create_catalog_item_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "catalogItem", )))
...
def test_create_catalog_item_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/catalogs/*}/catalogItems" % client.transport._host, args[1])
...
def test_get_catalog_item_rest_required_fields(request_type=catalog_service.GetCatalogItemRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_catalog_item._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_catalog_item_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/catalogs/sample3/catalogItems/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/catalogs/*/catalogItems/**}" % client.transport._host, args[1])
...
def test_list_catalog_items_rest_required_fields(request_type=catalog_service.ListCatalogItemsRequest):
    transport_class = transports.CatalogServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_catalog_items._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_catalog_items_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(catalog_service.ListCatalogItemsResponse.to_json(x) for x in response)
...
def test_update_catalog_item_rest_required_fields(request_type=catalog_service.UpdateCatalogItemRequest):
    transport_class = transports.CatalogServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_catalog_item._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_catalog_item_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("name", "catalogItem", )))
...
def test_delete_catalog_item_rest_required_fields(request_type=catalog_service.DeleteCatalogItemRequest):
    transport_class = transports.CatalogServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_catalog_item._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_catalog_items_rest_required_fields(request_type=import_.ImportCatalogItemsRequest):
    transport_class = transports.CatalogServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_catalog_items._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_catalog_items_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/catalogs/*}/catalogItems:import" % client.transport._host, args[1])
...
def test_create_catalog_item_rest_bad_request(request_type=catalog_service.CreateCatalogItemRequest):
    client = CatalogServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_catalog_item_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_catalog_item") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_catalog_item_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_create_catalog_item") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = catalog_service.CreateCatalogItemRequest.pb(catalog_service.CreateCatalogItemRequest())
        ...
        post_with_metadata.return_value = catalog.CatalogItem(), metadata

        client.create_catalog_item(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_catalog_item_rest_bad_request(request_type=catalog_service.GetCatalogItemRequest):
    client = CatalogServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/catalogs/sample3/catalogItems/sample4'}
    request = request_type(**request_init)
...
def test_get_catalog_item_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_catalog_item") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_catalog_item_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_get_catalog_item") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = catalog_service.GetCatalogItemRequest.pb(catalog_service.GetCatalogItemRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_catalog_item(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_catalog_items_rest_bad_request(request_type=catalog_service.ListCatalogItemsRequest):
    client = CatalogServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_catalog_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_catalog_items") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_catalog_items_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_list_catalog_items") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = catalog_service.ListCatalogItemsRequest.pb(catalog_service.ListCatalogItemsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = catalog_service.ListCatalogItemsResponse.to_json(catalog_service.ListCatalogItemsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = catalog_service.ListCatalogItemsResponse(), metadata

        client.list_catalog_items(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_catalog_item_rest_bad_request(request_type=catalog_service.UpdateCatalogItemRequest):
    client = CatalogServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_catalog_item_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_catalog_item") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_catalog_item_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_update_catalog_item") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = catalog_service.UpdateCatalogItemRequest.pb(catalog_service.UpdateCatalogItemRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_catalog_item(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_catalog_item_rest_bad_request(request_type=catalog_service.DeleteCatalogItemRequest):
    client = CatalogServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_catalog_item_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_delete_catalog_item") as pre:
        pre.assert_not_called()
        pb_message = catalog_service.DeleteCatalogItemRequest.pb(catalog_service.DeleteCatalogItemRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_catalog_item(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_import_catalog_items_rest_bad_request(request_type=import_.ImportCatalogItemsRequest):
    client = CatalogServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_import_catalog_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_import_catalog_items") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_import_catalog_items_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_import_catalog_items") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = import_.ImportCatalogItemsRequest.pb(import_.ImportCatalogItemsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.import_catalog_items(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_catalog_service_base_transport():
    ...
    with mock.patch('google.cloud.recommendationengine_v1beta1.services.catalog_service.transports.CatalogServiceTransport.__init__') as Transport:
...
def test_catalog_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.recommendationengine_v1beta1.services.catalog_service.transports.CatalogServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_catalog_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.recommendationengine_v1beta1.services.catalog_service.transports.CatalogServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CatalogServiceTransport()
        adc.assert_called_once()
...
def test_catalog_item_path_path():
    ...
    actual = CatalogServiceClient.catalog_item_path_path(project, location, catalog, catalog_item_path)
    assert expected == actual

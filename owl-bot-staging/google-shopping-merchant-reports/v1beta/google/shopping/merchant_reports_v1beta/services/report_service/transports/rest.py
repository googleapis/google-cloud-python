...
class ReportServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_search(self, request: reports.SearchRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reports.SearchRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search(self, response: reports.SearchResponse) -> reports.SearchResponse:
    ...
    def post_search_with_metadata(self, response: reports.SearchResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reports.SearchResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search
...
class ReportServiceRestTransport(_BaseReportServiceRestTransport):
    ...
    class _Search(_BaseReportServiceRestTransport._BaseSearch, ReportServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReportServiceRestTransport._Search._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

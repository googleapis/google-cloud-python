...
def test_search_rest_required_fields(request_type=reports.SearchRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search._get_unset_required_fields(jsonified_request)
...
def test_search_rest_unset_required_fields():
    transport = transports.ReportServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)

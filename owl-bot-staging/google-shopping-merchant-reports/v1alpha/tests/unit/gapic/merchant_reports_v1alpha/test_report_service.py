...
from google.shopping.merchant_reports_v1alpha.services.report_service import ReportServiceAsyncClient
from google.shopping.merchant_reports_v1alpha.services.report_service import ReportServiceClient
from google.shopping.merchant_reports_v1alpha.services.report_service import pagers
from google.shopping.merchant_reports_v1alpha.services.report_service import transports
...
def test_report_service_client_client_options_from_dict():
    with mock.patch('google.shopping.merchant_reports_v1alpha.services.report_service.transports.ReportServiceGrpcTransport.__init__') as grpc_transport:
...
def test_report_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.shopping.merchant_reports_v1alpha.services.report_service.transports.ReportServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_report_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.shopping.merchant_reports_v1alpha.services.report_service.transports.ReportServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ReportServiceTransport()
        adc.assert_called_once()

    ...
    class _Search(_BaseReportServiceRestTransport._BaseSearch, ReportServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.reports_v1alpha.ReportServiceClient.Search",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.reports_v1alpha.ReportServiceClient.search",
                    extra = {
                        "serviceName": "google.shopping.merchant.reports.v1alpha.ReportService",
                        "rpcName": "Search",

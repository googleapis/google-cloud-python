...
class SearchRequest(proto.Message):
    ...
    Attributes:
        ...
        query (str):
            ...
            For details on how to construct your query, see the `Query
            Language
...
class SearchResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.shopping.merchant_reports_v1.types.ReportRow]):
...
class ReportRow(proto.Message):
    ...
    Attributes:
        product_performance_view (google.shopping.merchant_reports_v1.types.ProductPerformanceView):
            Fields available for query in ``product_performance_view``
            table.
        non_product_performance_view (google.shopping.merchant_reports_v1.types.NonProductPerformanceView):
            Fields available for query in
            ``non_product_performance_view`` table.
        product_view (google.shopping.merchant_reports_v1.types.ProductView):
            Fields available for query in ``product_view`` table.
        price_competitiveness_product_view (google.shopping.merchant_reports_v1.types.PriceCompetitivenessProductView):
            Fields available for query in
            ``price_competitiveness_product_view`` table.
        price_insights_product_view (google.shopping.merchant_reports_v1.types.PriceInsightsProductView):
            Fields available for query in
            ``price_insights_product_view`` table.
        best_sellers_product_cluster_view (google.shopping.merchant_reports_v1.types.BestSellersProductClusterView):
            Fields available for query in
            ``best_sellers_product_cluster_view`` table.
        best_sellers_brand_view (google.shopping.merchant_reports_v1.types.BestSellersBrandView):
            Fields available for query in ``best_sellers_brand_view``
            table.
        competitive_visibility_competitor_view (google.shopping.merchant_reports_v1.types.CompetitiveVisibilityCompetitorView):
            Fields available for query in
            ``competitive_visibility_competitor_view`` table.
        competitive_visibility_top_merchant_view (google.shopping.merchant_reports_v1.types.CompetitiveVisibilityTopMerchantView):
            Fields available for query in
            ``competitive_visibility_top_merchant_view`` table.
        competitive_visibility_benchmark_view (google.shopping.merchant_reports_v1.types.CompetitiveVisibilityBenchmarkView):
            Fields available for query in
...
class ProductPerformanceView(proto.Message):
    ...
    Attributes:
        marketing_method (google.shopping.merchant_reports_v1.types.MarketingMethod.MarketingMethodEnum):
...
class ProductView(proto.Message):
    ...
    Attributes:
        ...
        click_potential (google.shopping.merchant_reports_v1.types.ProductView.ClickPotential):
    ...
    class ItemIssue(proto.Message):
        ...
        Attributes:
            type_ (google.shopping.merchant_reports_v1.types.ProductView.ItemIssue.ItemIssueType):
                Item issue type.
            severity (google.shopping.merchant_reports_v1.types.ProductView.ItemIssue.ItemIssueSeverity):
                Item issue severity.
            resolution (google.shopping.merchant_reports_v1.types.ProductView.ItemIssue.ItemIssueResolution):
        ...
        class ItemIssueSeverity(proto.Message):
            ...
            severity_per_reporting_context: MutableSequence['ProductView.ItemIssue.ItemIssueSeverity.IssueSeverityPerReportingContext'] = proto.RepeatedField(
                proto.MESSAGE,
                number=1,
...
class PriceInsightsProductView(proto.Message):
    ...
    Attributes:
        ...
        effectiveness (google.shopping.merchant_reports_v1.types.PriceInsightsProductView.Effectiveness):
...
class BestSellersProductClusterView(proto.Message):
    ...
    Attributes:
        ...
        report_granularity (google.shopping.merchant_reports_v1.types.ReportGranularity.ReportGranularityEnum):
        ...
        variant_gtins (MutableSequence[str]):
            ...
            cluster.
        inventory_status (google.shopping.merchant_reports_v1.types.BestSellersProductClusterView.InventoryStatus):
        ...
        brand_inventory_status (google.shopping.merchant_reports_v1.types.BestSellersProductClusterView.InventoryStatus):
        ...
        relative_demand (google.shopping.merchant_reports_v1.types.RelativeDemand.RelativeDemandEnum):
        ...
        previous_relative_demand (google.shopping.merchant_reports_v1.types.RelativeDemand.RelativeDemandEnum):
            Estimated demand in relation to the product
            cluster with the highest popularity rank in the
        ...
        relative_demand_change (google.shopping.merchant_reports_v1.types.RelativeDemandChangeType.RelativeDemandChangeTypeEnum):
...
class CompetitiveVisibilityCompetitorView(proto.Message):
    ...
    Attributes:
        ...
        report_category_id (int):
            ...
            This field is a member of `oneof`_ ``_report_category_id``.
        traffic_source (google.shopping.merchant_reports_v1.types.TrafficSource.TrafficSourceEnum):

...
class AutokeyAdminAsyncClient:
    ...
    get_transport_class = functools.partial(type(AutokeyAdminClient).get_transport_class, type(AutokeyAdminClient))
    ...
    async def update_autokey_config(self,
    ...
    async def get_autokey_config(self,
    ...
    async def show_effective_autokey_config(self,

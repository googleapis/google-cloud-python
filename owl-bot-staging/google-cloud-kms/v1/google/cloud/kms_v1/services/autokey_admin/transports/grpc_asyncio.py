...
from .base import AutokeyAdminTransport, DEFAULT_CLIENT_INFO
...
class AutokeyAdminGrpcAsyncIOTransport(AutokeyAdminTransport):
    ...
    @property
    def update_autokey_config(self) -> Callable[
        ...
        if 'update_autokey_config' not in self._stubs:
            self._stubs['update_autokey_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_autokey_config(self) -> Callable[
        ...
        if 'get_autokey_config' not in self._stubs:
            self._stubs['get_autokey_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def show_effective_autokey_config(self) -> Callable[
        ...
        if 'show_effective_autokey_config' not in self._stubs:
            self._stubs['show_effective_autokey_config'] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.update_autokey_config: gapic_v1.method_async.wrap_method(
            ...
            self.get_autokey_config: gapic_v1.method_async.wrap_method(
            ...
            self.show_effective_autokey_config: gapic_v1.method_async.wrap_method(

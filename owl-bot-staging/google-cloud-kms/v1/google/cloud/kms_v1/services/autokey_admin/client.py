...
from .transports.base import AutokeyAdminTransport, DEFAULT_CLIENT_INFO
...
class AutokeyAdminClient(metaclass=AutokeyAdminClientMeta):
    ...
    @staticmethod
    def autokey_config_path(folder: str,) -> str:
        """Returns a fully-qualified autokey_config string."""
        return "folders/{folder}/autokeyConfig".format(folder=folder, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AutokeyAdminClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            AutokeyAdminClient._get_api_endpoint(
    ...
    def update_autokey_config(self,
    ...
    def show_effective_autokey_config(self,

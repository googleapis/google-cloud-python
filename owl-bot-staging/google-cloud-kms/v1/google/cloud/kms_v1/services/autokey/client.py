...
from .transports.base import AutokeyTransport, DEFAULT_CLIENT_INFO
...
class AutokeyClient(metaclass=AutokeyClientMeta):
    ...
    @staticmethod
    def key_handle_path(project: str,location: str,key_handle: str,) -> str:
        """Returns a fully-qualified key_handle string."""
        return "projects/{project}/locations/{location}/keyHandles/{key_handle}".format(project=project, location=location, key_handle=key_handle, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AutokeyClient._compare_universes(self.universe_domain, self.transport._credentials))

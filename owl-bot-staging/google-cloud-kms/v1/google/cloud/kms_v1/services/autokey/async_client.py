...
class AutokeyAsyncClient:
    ...
    common_billing_account_path = staticmethod(AutokeyClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(AutokeyClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(AutokeyClient.parse_common_organization_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return AutokeyClient.from_service_account_info.__func__(AutokeyAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            AutokeyAsyncClient: The constructed client.
        """
        return AutokeyClient.from_service_account_file.__func__(AutokeyAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    get_transport_class = functools.partial(type(AutokeyClient).get_transport_class, type(AutokeyClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, AutokeyTransport, Callable[..., AutokeyTransport]]] = "grpc_asyncio",
    ...
    async def create_key_handle(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_key_handle]
    ...
    async def get_key_handle(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_key_handle]
    ...
    async def list_key_handles(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_key_handles]

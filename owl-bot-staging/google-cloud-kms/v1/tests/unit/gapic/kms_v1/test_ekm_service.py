...
def test_list_ekm_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EkmServiceRestInterceptor, "post_list_ekm_connections_with_metadata") as post_with_metadata, \
...
def test_get_ekm_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EkmServiceRestInterceptor, "post_get_ekm_connection_with_metadata") as post_with_metadata, \
...
def test_create_ekm_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EkmServiceRestInterceptor, "post_create_ekm_connection_with_metadata") as post_with_metadata, \
...
def test_update_ekm_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EkmServiceRestInterceptor, "post_update_ekm_connection_with_metadata") as post_with_metadata, \
...
def test_get_ekm_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EkmServiceRestInterceptor, "post_get_ekm_config_with_metadata") as post_with_metadata, \
...
def test_update_ekm_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EkmServiceRestInterceptor, "post_update_ekm_config_with_metadata") as post_with_metadata, \
...
def test_verify_connectivity_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EkmServiceRestInterceptor, "post_verify_connectivity_with_metadata") as post_with_metadata, \

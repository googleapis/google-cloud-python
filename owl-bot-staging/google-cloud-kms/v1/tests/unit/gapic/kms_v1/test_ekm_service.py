...
def test_list_ekm_connections_rest_required_fields(request_type=ekm_service.ListEkmConnectionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_ekm_connections._get_unset_required_fields(jsonified_request)
...
def test_list_ekm_connections_rest_unset_required_fields():
    transport = transports.EkmServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_ekm_connection_rest_required_fields(request_type=ekm_service.GetEkmConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_ekm_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_ekm_connection_rest_required_fields(request_type=ekm_service.CreateEkmConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_ekm_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_ekm_connection_rest_required_fields(request_type=ekm_service.UpdateEkmConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_ekm_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_ekm_config_rest_required_fields(request_type=ekm_service.GetEkmConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_ekm_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_ekm_config_rest_required_fields(request_type=ekm_service.UpdateEkmConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_ekm_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_verify_connectivity_rest_required_fields(request_type=ekm_service.VerifyConnectivityRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).verify_connectivity._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
class VideoStitcherServiceClient(metaclass=VideoStitcherServiceClientMeta):
    ...
    @staticmethod
    def vod_config_path(project: str,location: str,vod_config: str,) -> str:
        """Returns a fully-qualified vod_config string."""
        return "projects/{project}/locations/{location}/vodConfigs/{vod_config}".format(project=project, location=location, vod_config=vod_config, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            VideoStitcherServiceClient._compare_universes(self.universe_domain, self.transport._credentials))

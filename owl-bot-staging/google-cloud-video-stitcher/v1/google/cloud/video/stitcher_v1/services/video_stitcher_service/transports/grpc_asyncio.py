...
class VideoStitcherServiceGrpcAsyncIOTransport(VideoStitcherServiceTransport):
    ...
    @property
    def update_live_config(self) -> Callable[
    ...
    @property
    def create_vod_config(self) -> Callable[
    ...
    @property
    def list_vod_configs(self) -> Callable[
    ...
    @property
    def get_vod_config(self) -> Callable[
            [video_stitcher_service.GetVodConfigRequest],
            Awaitable[vod_configs.VodConfig]]:
    ...
    @property
    def delete_vod_config(self) -> Callable[
    ...
    @property
    def update_vod_config(self) -> Callable[

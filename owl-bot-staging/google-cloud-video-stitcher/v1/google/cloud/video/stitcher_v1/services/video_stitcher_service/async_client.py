...
class VideoStitcherServiceAsyncClient:
    ...
    async def update_live_config(self,
    ...
    async def create_vod_config(self,
    ...
    async def list_vod_configs(self,
    ...
    async def delete_vod_config(self,
    ...
    async def update_vod_config(self,

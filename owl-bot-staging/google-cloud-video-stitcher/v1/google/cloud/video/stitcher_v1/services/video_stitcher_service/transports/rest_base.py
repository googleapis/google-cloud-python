...
class _BaseVideoStitcherServiceRestTransport(VideoStitcherServiceTransport):
    """Base REST backend transport for VideoStitcherService.
    ...
    class _BaseCreateLiveConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=projects/*/locations/*}/liveConfigs',
                'body': 'live_config',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = video_stitcher_service.CreateLiveConfigRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseCreateVodConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=projects/*/locations/*}/vodConfigs',
                'body': 'vod_config',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = video_stitcher_service.CreateVodConfigRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseDeleteLiveConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1/{name=projects/*/locations/*/liveConfigs/*}',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = video_stitcher_service.DeleteLiveConfigRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseDeleteVodConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1/{name=projects/*/locations/*/vodConfigs/*}',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = video_stitcher_service.DeleteVodConfigRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseGetLiveConfig:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = video_stitcher_service.GetLiveConfigRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseGetVodConfig:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = video_stitcher_service.GetVodConfigRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseListLiveAdTagDetails:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseListLiveConfigs:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = video_stitcher_service.ListLiveConfigsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseListVodAdTagDetails:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseListVodConfigs:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = video_stitcher_service.ListVodConfigsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseListVodStitchDetails:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseUpdateLiveConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1/{live_config.name=projects/*/locations/*/liveConfigs/*}',
                'body': 'live_config',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = video_stitcher_service.UpdateLiveConfigRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseUpdateVodConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1/{vod_config.name=projects/*/locations/*/vodConfigs/*}',
                'body': 'vod_config',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = video_stitcher_service.UpdateVodConfigRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request

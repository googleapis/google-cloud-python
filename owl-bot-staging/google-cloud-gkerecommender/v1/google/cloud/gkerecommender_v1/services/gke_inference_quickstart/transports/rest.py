...
class GkeInferenceQuickstartRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_fetch_benchmarking_data(self, request: gkerecommender.FetchBenchmarkingDataRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.FetchBenchmarkingDataRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_fetch_benchmarking_data_with_metadata(self, response: gkerecommender.FetchBenchmarkingDataResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.FetchBenchmarkingDataResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for fetch_benchmarking_data
    ...
    def pre_fetch_models(self, request: gkerecommender.FetchModelsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.FetchModelsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_fetch_models_with_metadata(self, response: gkerecommender.FetchModelsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.FetchModelsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for fetch_models
    ...
    def pre_fetch_model_servers(self, request: gkerecommender.FetchModelServersRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.FetchModelServersRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_fetch_model_servers_with_metadata(self, response: gkerecommender.FetchModelServersResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.FetchModelServersResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for fetch_model_servers
    ...
    def pre_fetch_model_server_versions(self, request: gkerecommender.FetchModelServerVersionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.FetchModelServerVersionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_fetch_model_server_versions(self, response: gkerecommender.FetchModelServerVersionsResponse) -> gkerecommender.FetchModelServerVersionsResponse:
    ...
    def post_fetch_model_server_versions_with_metadata(self, response: gkerecommender.FetchModelServerVersionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.FetchModelServerVersionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for fetch_model_server_versions
    ...
    def pre_fetch_profiles(self, request: gkerecommender.FetchProfilesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.FetchProfilesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_fetch_profiles_with_metadata(self, response: gkerecommender.FetchProfilesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.FetchProfilesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for fetch_profiles
    ...
    def pre_generate_optimized_manifest(self, request: gkerecommender.GenerateOptimizedManifestRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.GenerateOptimizedManifestRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_generate_optimized_manifest(self, response: gkerecommender.GenerateOptimizedManifestResponse) -> gkerecommender.GenerateOptimizedManifestResponse:
    ...
    def post_generate_optimized_manifest_with_metadata(self, response: gkerecommender.GenerateOptimizedManifestResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gkerecommender.GenerateOptimizedManifestResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for generate_optimized_manifest
...
class GkeInferenceQuickstartRestTransport(_BaseGkeInferenceQuickstartRestTransport):
    ...
    class _FetchBenchmarkingData(_BaseGkeInferenceQuickstartRestTransport._BaseFetchBenchmarkingData, GkeInferenceQuickstartRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GkeInferenceQuickstartRestTransport._FetchBenchmarkingData._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _FetchModels(_BaseGkeInferenceQuickstartRestTransport._BaseFetchModels, GkeInferenceQuickstartRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GkeInferenceQuickstartRestTransport._FetchModels._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _FetchModelServers(_BaseGkeInferenceQuickstartRestTransport._BaseFetchModelServers, GkeInferenceQuickstartRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GkeInferenceQuickstartRestTransport._FetchModelServers._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _FetchModelServerVersions(_BaseGkeInferenceQuickstartRestTransport._BaseFetchModelServerVersions, GkeInferenceQuickstartRestStub):
        ...
        versions method over HTTP.
            ...
            # Send the request
            response = GkeInferenceQuickstartRestTransport._FetchModelServerVersions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _FetchProfiles(_BaseGkeInferenceQuickstartRestTransport._BaseFetchProfiles, GkeInferenceQuickstartRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GkeInferenceQuickstartRestTransport._FetchProfiles._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GenerateOptimizedManifest(_BaseGkeInferenceQuickstartRestTransport._BaseGenerateOptimizedManifest, GkeInferenceQuickstartRestStub):
        ...
        manifest method over HTTP.
            ...
            transcoded_request = _BaseGkeInferenceQuickstartRestTransport._BaseGenerateOptimizedManifest._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = GkeInferenceQuickstartRestTransport._GenerateOptimizedManifest._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

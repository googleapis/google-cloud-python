...
from .transports.base import GkeInferenceQuickstartTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import GkeInferenceQuickstartGrpcTransport
from .transports.grpc_asyncio import GkeInferenceQuickstartGrpcAsyncIOTransport
from .transports.rest import GkeInferenceQuickstartRestTransport


class GkeInferenceQuickstartClientMeta(type):
    """Metaclass for the GkeInferenceQuickstart client.
    ...
    def get_transport_class(cls,
        ...
        ) -> Type[GkeInferenceQuickstartTransport]:
...
class GkeInferenceQuickstartClient(metaclass=GkeInferenceQuickstartClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "gkerecommender.{UNIVERSE_DOMAIN}"
    ...
    def transport(self) -> GkeInferenceQuickstartTransport:
        ...
        Returns:
            GkeInferenceQuickstartTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = GkeInferenceQuickstartClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = GkeInferenceQuickstartClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = GkeInferenceQuickstartClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GkeInferenceQuickstartTransport, Callable[..., GkeInferenceQuickstartTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GkeInferenceQuickstartClient._read_environment_variables()
        self._client_cert_source = GkeInferenceQuickstartClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = GkeInferenceQuickstartClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, GkeInferenceQuickstartTransport)
        if transport_provided:
            # transport is a GkeInferenceQuickstartTransport instance.
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[GkeInferenceQuickstartTransport], Callable[..., GkeInferenceQuickstartTransport]] = (
                GkeInferenceQuickstartClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., GkeInferenceQuickstartTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.gkerecommender_v1.GkeInferenceQuickstartClient`.",
                    extra = {
    ...
    def fetch_models(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.fetch_models]
        ...
        response = pagers.FetchModelsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def fetch_model_servers(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_model_servers]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.FetchModelServersPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def fetch_model_server_versions(self,
            request: Optional[Union[gkerecommender.FetchModelServerVersionsRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.FetchModelServerVersionsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_model_server_versions]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.FetchModelServerVersionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def fetch_profiles(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_profiles]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.FetchProfilesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def generate_optimized_manifest(self,
            request: Optional[Union[gkerecommender.GenerateOptimizedManifestRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_optimized_manifest]
    ...
    def fetch_benchmarking_data(self,
            request: Optional[Union[gkerecommender.FetchBenchmarkingDataRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_benchmarking_data]
    ...
    def __enter__(self) -> "GkeInferenceQuickstartClient":
        return self

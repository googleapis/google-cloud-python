...
class GkeInferenceQuickstartTransport(abc.ABC):
    ...
    @property
    def fetch_models(self) -> Callable[
    ...
    @property
    def fetch_model_servers(self) -> Callable[
    ...
    @property
    def fetch_model_server_versions(self) -> Callable[
    ...
    @property
    def fetch_profiles(self) -> Callable[
    ...
    @property
    def generate_optimized_manifest(self) -> Callable[
    ...
    @property
    def fetch_benchmarking_data(self) -> Callable[

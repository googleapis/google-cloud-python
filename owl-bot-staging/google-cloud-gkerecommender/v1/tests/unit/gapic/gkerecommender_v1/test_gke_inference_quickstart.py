...
from google.cloud.gkerecommender_v1.services.gke_inference_quickstart import GkeInferenceQuickstartAsyncClient
from google.cloud.gkerecommender_v1.services.gke_inference_quickstart import GkeInferenceQuickstartClient
from google.cloud.gkerecommender_v1.services.gke_inference_quickstart import pagers
from google.cloud.gkerecommender_v1.services.gke_inference_quickstart import transports
...
@mock.patch.object(GkeInferenceQuickstartAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GkeInferenceQuickstartAsyncClient))
def test__get_api_endpoint():
    ...
    assert GkeInferenceQuickstartClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == GkeInferenceQuickstartClient.DEFAULT_MTLS_ENDPOINT
    assert GkeInferenceQuickstartClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert GkeInferenceQuickstartClient._get_api_endpoint(None, None, default_universe, "always") == GkeInferenceQuickstartClient.DEFAULT_MTLS_ENDPOINT
    assert GkeInferenceQuickstartClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == GkeInferenceQuickstartClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    GkeInferenceQuickstartClient, GkeInferenceQuickstartAsyncClient
])
...
def test_gke_inference_quickstart_client_client_options_from_dict():
    with mock.patch('google.cloud.gkerecommender_v1.services.gke_inference_quickstart.transports.GkeInferenceQuickstartGrpcTransport.__init__') as grpc_transport:
...
def test_fetch_models(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.fetch_models),
            '__call__') as call:
...
async def test_fetch_models_async(transport: str = 'grpc_asyncio', request_type=gkerecommender.FetchModelsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gkerecommender.FetchModelsResponse(
            models=['models_value'],
            next_page_token='next_page_token_value',
        ))
...
async def test_fetch_models_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.fetch_models(request={},)
...
async def test_fetch_model_servers_async(transport: str = 'grpc_asyncio', request_type=gkerecommender.FetchModelServersRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gkerecommender.FetchModelServersResponse(
            model_servers=['model_servers_value'],
            next_page_token='next_page_token_value',
        ))
...
async def test_fetch_model_servers_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.fetch_model_servers(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
async def test_fetch_model_server_versions_async(transport: str = 'grpc_asyncio', request_type=gkerecommender.FetchModelServerVersionsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gkerecommender.FetchModelServerVersionsResponse(
            model_server_versions=['model_server_versions_value'],
            next_page_token='next_page_token_value',
        ))
...
async def test_fetch_model_server_versions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.fetch_model_server_versions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_fetch_profiles(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_profiles),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_fetch_profiles_async(transport: str = 'grpc_asyncio', request_type=gkerecommender.FetchProfilesRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gkerecommender.FetchProfilesResponse(
            comments='comments_value',
            next_page_token='next_page_token_value',
        ))
...
def test_fetch_profiles_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, gkerecommender.Profile)
                   for i in results)
...
async def test_fetch_profiles_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.fetch_profiles(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_generate_optimized_manifest(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_optimized_manifest),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_generate_optimized_manifest_async(transport: str = 'grpc_asyncio', request_type=gkerecommender.GenerateOptimizedManifestRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gkerecommender.GenerateOptimizedManifestResponse(
            comments=['comments_value'],
            manifest_version='manifest_version_value',
        ))
...
def test_fetch_benchmarking_data(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_benchmarking_data),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_fetch_model_servers_rest_required_fields(request_type=gkerecommender.FetchModelServersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_model_servers._get_unset_required_fields(jsonified_request)
    ...
    assert not set(unset_fields) - set(("model", "page_size", "page_token", ))
    jsonified_request.update(unset_fields)
...
def test_fetch_model_servers_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("model", "pageSize", "pageToken", )) & set(("model", )))
...
def test_fetch_model_server_versions_rest_required_fields(request_type=gkerecommender.FetchModelServerVersionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_model_server_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_model_server_versions._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("model", "model_server", "page_size", "page_token", ))
    jsonified_request.update(unset_fields)
...
def test_fetch_model_server_versions_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("model", "modelServer", "pageSize", "pageToken", )) & set(("model", "modelServer", )))
...
def test_generate_optimized_manifest_rest_required_fields(request_type=gkerecommender.GenerateOptimizedManifestRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_optimized_manifest._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_optimized_manifest_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("modelServerInfo", "acceleratorType", )))
...
def test_fetch_benchmarking_data_rest_required_fields(request_type=gkerecommender.FetchBenchmarkingDataRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_benchmarking_data._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_models_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_models") as post, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_models_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "pre_fetch_models") as pre:
        ...
        client.fetch_models(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_model_servers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_model_servers") as post, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_model_servers_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "pre_fetch_model_servers") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.fetch_model_servers(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_model_server_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_model_server_versions") as post, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_model_server_versions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "pre_fetch_model_server_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.fetch_model_server_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_profiles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_profiles") as post, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_profiles_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "pre_fetch_profiles") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.fetch_profiles(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_generate_optimized_manifest_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_generate_optimized_manifest") as post, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_generate_optimized_manifest_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "pre_generate_optimized_manifest") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.generate_optimized_manifest(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_benchmarking_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_benchmarking_data") as post, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_benchmarking_data_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "pre_fetch_benchmarking_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.fetch_benchmarking_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_gke_inference_quickstart_base_transport():
    ...
    with mock.patch('google.cloud.gkerecommender_v1.services.gke_inference_quickstart.transports.GkeInferenceQuickstartTransport.__init__') as Transport:
...
def test_gke_inference_quickstart_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.gkerecommender_v1.services.gke_inference_quickstart.transports.GkeInferenceQuickstartTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_gke_inference_quickstart_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.gkerecommender_v1.services.gke_inference_quickstart.transports.GkeInferenceQuickstartTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GkeInferenceQuickstartTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.GkeInferenceQuickstartGrpcTransport, transports.GkeInferenceQuickstartGrpcAsyncIOTransport])
def test_gke_inference_quickstart_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

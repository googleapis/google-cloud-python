...
def test__get_api_endpoint():
    ...
    assert PrivateCatalogClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == PrivateCatalogClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert PrivateCatalogClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == PrivateCatalogClient.DEFAULT_MTLS_ENDPOINT
...
def test_search_catalogs_rest_required_fields(request_type=private_catalog.SearchCatalogsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_catalogs._get_unset_required_fields(jsonified_request)
...
def test_search_catalogs_rest_unset_required_fields():
    transport = transports.PrivateCatalogRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_search_products_rest_required_fields(request_type=private_catalog.SearchProductsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_products._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_versions_rest_required_fields(request_type=private_catalog.SearchVersionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

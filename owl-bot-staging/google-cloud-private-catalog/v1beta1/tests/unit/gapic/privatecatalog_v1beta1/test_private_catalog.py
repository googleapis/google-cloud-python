...
def test_search_catalogs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PrivateCatalogRestInterceptor, "post_search_catalogs_with_metadata") as post_with_metadata, \
...
def test_search_products_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PrivateCatalogRestInterceptor, "post_search_products_with_metadata") as post_with_metadata, \
...
def test_search_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PrivateCatalogRestInterceptor, "post_search_versions_with_metadata") as post_with_metadata, \

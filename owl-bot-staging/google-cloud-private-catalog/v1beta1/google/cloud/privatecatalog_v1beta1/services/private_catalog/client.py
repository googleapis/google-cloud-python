...
class PrivateCatalogClientMeta(type):
    """Metaclass for the PrivateCatalog client.
...
class PrivateCatalogClient(metaclass=PrivateCatalogClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "cloudprivatecatalog.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            PrivateCatalogClient: The constructed client.
        """
    ...
    def transport(self) -> PrivateCatalogTransport:
        ...
        Returns:
            PrivateCatalogTransport: The transport used by the client
                instance.
        """
    ...
    def parse_catalog_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^catalogs/(?P<catalog>.+?)$", path)
    ...
    def version_path(catalog: str,product: str,version: str,) -> str:
        ...
        return "catalogs/{catalog}/products/{product}/versions/{version}".format(catalog=catalog, product=product, version=version, )

    @staticmethod
    def parse_version_path(path: str) -> Dict[str,str]:
        """Parses a version path into its component segments."""
        m = re.match(r"^catalogs/(?P<catalog>.+?)/products/(?P<product>.+?)/versions/(?P<version>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = PrivateCatalogClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = PrivateCatalogClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = PrivateCatalogClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            PrivateCatalogClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PrivateCatalogTransport, Callable[..., PrivateCatalogTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PrivateCatalogClient._read_environment_variables()
        self._client_cert_source = PrivateCatalogClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = PrivateCatalogClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, PrivateCatalogTransport)
        if transport_provided:
            # transport is a PrivateCatalogTransport instance.
            ...
            self._transport = cast(PrivateCatalogTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            PrivateCatalogClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[PrivateCatalogTransport], Callable[..., PrivateCatalogTransport]] = (
    ...
    def search_catalogs(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.search_catalogs]
    ...
    def search_products(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_products]
    ...
    def search_versions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_versions]

...
class PrivateCatalogRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_search_catalogs(self, request: private_catalog.SearchCatalogsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[private_catalog.SearchCatalogsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search_catalogs_with_metadata(self, response: private_catalog.SearchCatalogsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[private_catalog.SearchCatalogsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_catalogs
    ...
    def pre_search_products(self, request: private_catalog.SearchProductsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[private_catalog.SearchProductsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search_products_with_metadata(self, response: private_catalog.SearchProductsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[private_catalog.SearchProductsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_products
    ...
    def pre_search_versions(self, request: private_catalog.SearchVersionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[private_catalog.SearchVersionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search_versions_with_metadata(self, response: private_catalog.SearchVersionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[private_catalog.SearchVersionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_versions
...
class PrivateCatalogRestTransport(_BasePrivateCatalogRestTransport):
    ...
    class _SearchCatalogs(_BasePrivateCatalogRestTransport._BaseSearchCatalogs, PrivateCatalogRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PrivateCatalogRestTransport._SearchCatalogs._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SearchProducts(_BasePrivateCatalogRestTransport._BaseSearchProducts, PrivateCatalogRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PrivateCatalogRestTransport._SearchProducts._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SearchVersions(_BasePrivateCatalogRestTransport._BaseSearchVersions, PrivateCatalogRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PrivateCatalogRestTransport._SearchVersions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
from .transports.base import IssueResolutionServiceTransport, DEFAULT_CLIENT_INFO
...
class IssueResolutionServiceClient(metaclass=IssueResolutionServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        self._client_cert_source = IssueResolutionServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
    ...
    def render_account_issues(self,
    ...
    def render_product_issues(self,

...
class IssueResolutionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_render_account_issues(self, request: issueresolution.RenderAccountIssuesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[issueresolution.RenderAccountIssuesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_render_account_issues_with_metadata(self, response: issueresolution.RenderAccountIssuesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[issueresolution.RenderAccountIssuesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for render_account_issues
    ...
    def pre_render_product_issues(self, request: issueresolution.RenderProductIssuesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[issueresolution.RenderProductIssuesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_render_product_issues_with_metadata(self, response: issueresolution.RenderProductIssuesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[issueresolution.RenderProductIssuesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for render_product_issues
    ...
    def pre_trigger_action(self, request: issueresolution.TriggerActionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[issueresolution.TriggerActionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_trigger_action_with_metadata(self, response: issueresolution.TriggerActionResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[issueresolution.TriggerActionResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for trigger_action
...
class IssueResolutionServiceRestTransport(_BaseIssueResolutionServiceRestTransport):
    ...
    class _RenderAccountIssues(_BaseIssueResolutionServiceRestTransport._BaseRenderAccountIssues, IssueResolutionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.issueresolution_v1.IssueResolutionServiceClient.RenderAccountIssues",
                    extra = {
                        "serviceName": "google.shopping.merchant.issueresolution.v1.IssueResolutionService",
            ...
            # Send the request
            response = IssueResolutionServiceRestTransport._RenderAccountIssues._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.issueresolution_v1.IssueResolutionServiceClient.render_account_issues",
                    extra = {
                        "serviceName": "google.shopping.merchant.issueresolution.v1.IssueResolutionService",
                        "rpcName": "RenderAccountIssues",
    ...
    class _RenderProductIssues(_BaseIssueResolutionServiceRestTransport._BaseRenderProductIssues, IssueResolutionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.issueresolution_v1.IssueResolutionServiceClient.RenderProductIssues",
                    extra = {
                        "serviceName": "google.shopping.merchant.issueresolution.v1.IssueResolutionService",
            ...
            # Send the request
            response = IssueResolutionServiceRestTransport._RenderProductIssues._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.issueresolution_v1.IssueResolutionServiceClient.render_product_issues",
                    extra = {
                        "serviceName": "google.shopping.merchant.issueresolution.v1.IssueResolutionService",
                        "rpcName": "RenderProductIssues",
                        "metadata": http_response["headers"],
    ...
    class _TriggerAction(_BaseIssueResolutionServiceRestTransport._BaseTriggerAction, IssueResolutionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.issueresolution_v1.IssueResolutionServiceClient.TriggerAction",
                    extra = {
                        "serviceName": "google.shopping.merchant.issueresolution.v1.IssueResolutionService",
            ...
            # Send the request
            response = IssueResolutionServiceRestTransport._TriggerAction._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.issueresolution_v1.IssueResolutionServiceClient.trigger_action",
                    extra = {
                        "serviceName": "google.shopping.merchant.issueresolution.v1.IssueResolutionService",
                        "rpcName": "TriggerAction",
                        "metadata": http_response["headers"],
    ...
    @property
    def render_account_issues(self) -> Callable[
    ...
    @property
    def render_product_issues(self) -> Callable[
    ...
    @property
    def trigger_action(self) -> Callable[

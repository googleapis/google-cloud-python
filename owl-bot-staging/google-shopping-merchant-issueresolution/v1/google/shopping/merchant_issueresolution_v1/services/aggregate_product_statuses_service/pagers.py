...
class ListAggregateProductStatusesPager:
    ...
    :class:`google.shopping.merchant_issueresolution_v1.types.ListAggregateProductStatusesResponse` object, and
    ...
    All the usual :class:`google.shopping.merchant_issueresolution_v1.types.ListAggregateProductStatusesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.shopping.merchant_issueresolution_v1.types.ListAggregateProductStatusesRequest):
                The initial request object.
            response (google.shopping.merchant_issueresolution_v1.types.ListAggregateProductStatusesResponse):

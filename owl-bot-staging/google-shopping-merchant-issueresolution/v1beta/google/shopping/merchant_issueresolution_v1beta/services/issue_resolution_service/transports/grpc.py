...
from .base import IssueResolutionServiceTransport, DEFAULT_CLIENT_INFO
...
class IssueResolutionServiceGrpcTransport(IssueResolutionServiceTransport):
    """gRPC backend transport for IssueResolutionService.
...
__all__ = (
    'IssueResolutionServiceGrpcTransport',
)

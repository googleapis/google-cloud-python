...
class IamCheckerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_troubleshoot_iam_policy(self, request: checker.TroubleshootIamPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[checker.TroubleshootIamPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_troubleshoot_iam_policy_with_metadata(self, response: checker.TroubleshootIamPolicyResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[checker.TroubleshootIamPolicyResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for troubleshoot_iam_policy
...
class IamCheckerRestTransport(_BaseIamCheckerRestTransport):
    ...
    class _TroubleshootIamPolicy(_BaseIamCheckerRestTransport._BaseTroubleshootIamPolicy, IamCheckerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = IamCheckerRestTransport._TroubleshootIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = parallelstore.ListInstancesResponse.to_json(parallelstore.ListInstancesResponse())
...
def test_list_instances_rest_bad_request(transport: str = 'rest', request_type=parallelstore.ListInstancesRequest):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = parallelstore.Instance.to_json(parallelstore.Instance())
...
def test_get_instance_rest_bad_request(transport: str = 'rest', request_type=parallelstore.GetInstanceRequest):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_instance_rest_bad_request(transport: str = 'rest', request_type=parallelstore.CreateInstanceRequest):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_instance_rest_bad_request(transport: str = 'rest', request_type=parallelstore.UpdateInstanceRequest):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_instance_rest_bad_request(transport: str = 'rest', request_type=parallelstore.DeleteInstanceRequest):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_data_rest_bad_request(transport: str = 'rest', request_type=parallelstore.ImportDataRequest):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_data_rest_bad_request(transport: str = 'rest', request_type=parallelstore.ExportDataRequest):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = ParallelstoreClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )

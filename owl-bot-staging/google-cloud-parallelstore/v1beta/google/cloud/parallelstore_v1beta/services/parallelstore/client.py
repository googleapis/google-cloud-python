...
from .transports.base import ParallelstoreTransport, DEFAULT_CLIENT_INFO
...
class ParallelstoreClient(metaclass=ParallelstoreClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ParallelstoreClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ParallelstoreClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ParallelstoreTransport, Callable[..., ParallelstoreTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ParallelstoreClient._read_environment_variables()
        self._client_cert_source = ParallelstoreClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ParallelstoreClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            ParallelstoreClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ParallelstoreTransport], Callable[..., ParallelstoreTransport]] = (
    ...
    def create_instance(self,
            ...
            *,
            parent: Optional[str] = None,
            instance: Optional[parallelstore.Instance] = None,

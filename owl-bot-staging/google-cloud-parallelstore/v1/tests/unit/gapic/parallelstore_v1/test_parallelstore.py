...
from google.cloud.parallelstore_v1.services.parallelstore import ParallelstoreAsyncClient
from google.cloud.parallelstore_v1.services.parallelstore import ParallelstoreClient
from google.cloud.parallelstore_v1.services.parallelstore import pagers
from google.cloud.parallelstore_v1.services.parallelstore import transports
...
def test_parallelstore_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.parallelstore_v1.services.parallelstore.transports.ParallelstoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_parallelstore_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.parallelstore_v1.services.parallelstore.transports.ParallelstoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ParallelstoreTransport()
        adc.assert_called_once()

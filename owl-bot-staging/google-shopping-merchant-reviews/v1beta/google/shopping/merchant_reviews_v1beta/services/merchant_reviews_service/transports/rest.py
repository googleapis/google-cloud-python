...
class MerchantReviewsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_merchant_review(self, request: merchantreviews.DeleteMerchantReviewRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[merchantreviews.DeleteMerchantReviewRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_merchant_review(self, request: merchantreviews.GetMerchantReviewRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[merchantreviews.GetMerchantReviewRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_merchant_review_with_metadata(self, response: merchantreviews.MerchantReview, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[merchantreviews.MerchantReview, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_merchant_review
    ...
    def pre_insert_merchant_review(self, request: merchantreviews.InsertMerchantReviewRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[merchantreviews.InsertMerchantReviewRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_insert_merchant_review_with_metadata(self, response: merchantreviews.MerchantReview, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[merchantreviews.MerchantReview, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for insert_merchant_review
    ...
    def pre_list_merchant_reviews(self, request: merchantreviews.ListMerchantReviewsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[merchantreviews.ListMerchantReviewsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_merchant_reviews_with_metadata(self, response: merchantreviews.ListMerchantReviewsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[merchantreviews.ListMerchantReviewsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_merchant_reviews
...
class MerchantReviewsServiceRestTransport(_BaseMerchantReviewsServiceRestTransport):
    ...
    class _DeleteMerchantReview(_BaseMerchantReviewsServiceRestTransport._BaseDeleteMerchantReview, MerchantReviewsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MerchantReviewsServiceRestTransport._DeleteMerchantReview._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetMerchantReview(_BaseMerchantReviewsServiceRestTransport._BaseGetMerchantReview, MerchantReviewsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MerchantReviewsServiceRestTransport._GetMerchantReview._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _InsertMerchantReview(_BaseMerchantReviewsServiceRestTransport._BaseInsertMerchantReview, MerchantReviewsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MerchantReviewsServiceRestTransport._InsertMerchantReview._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListMerchantReviews(_BaseMerchantReviewsServiceRestTransport._BaseListMerchantReviews, MerchantReviewsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MerchantReviewsServiceRestTransport._ListMerchantReviews._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    @property
    def delete_merchant_review(self) -> Callable[
    ...
    @property
    def get_merchant_review(self) -> Callable[
    ...
    @property
    def insert_merchant_review(self) -> Callable[
    ...
    @property
    def list_merchant_reviews(self) -> Callable[
...
__all__=(
    'MerchantReviewsServiceRestTransport',
)

...
from google.shopping.merchant_reviews_v1beta.services.merchant_reviews_service import pagers
...
from .transports.base import MerchantReviewsServiceTransport, DEFAULT_CLIENT_INFO
...
class MerchantReviewsServiceAsyncClient:
    ...
    merchant_review_path = staticmethod(MerchantReviewsServiceClient.merchant_review_path)
    parse_merchant_review_path = staticmethod(MerchantReviewsServiceClient.parse_merchant_review_path)
    common_billing_account_path = staticmethod(MerchantReviewsServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(MerchantReviewsServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(MerchantReviewsServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(MerchantReviewsServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(MerchantReviewsServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(MerchantReviewsServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(MerchantReviewsServiceClient.common_project_path)
    parse_common_project_path = staticmethod(MerchantReviewsServiceClient.parse_common_project_path)
    common_location_path = staticmethod(MerchantReviewsServiceClient.common_location_path)
    parse_common_location_path = staticmethod(MerchantReviewsServiceClient.parse_common_location_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, MerchantReviewsServiceTransport, Callable[..., MerchantReviewsServiceTransport]]] = "grpc_asyncio",
    ...
    async def get_merchant_review(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_merchant_review]
    ...
    async def list_merchant_reviews(self,
            request: Optional[Union[merchantreviews.ListMerchantReviewsRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_merchant_reviews]
    ...
    async def insert_merchant_review(self,
            request: Optional[Union[merchantreviews.InsertMerchantReviewRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.insert_merchant_review]
    ...
    async def delete_merchant_review(self,
            request: Optional[Union[merchantreviews.DeleteMerchantReviewRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_merchant_review]

...
class ProductReviewsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_product_review(self, request: productreviews.DeleteProductReviewRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[productreviews.DeleteProductReviewRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_product_review(self, request: productreviews.GetProductReviewRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[productreviews.GetProductReviewRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_product_review_with_metadata(self, response: productreviews.ProductReview, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[productreviews.ProductReview, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_product_review
    ...
    def pre_insert_product_review(self, request: productreviews.InsertProductReviewRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[productreviews.InsertProductReviewRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_insert_product_review_with_metadata(self, response: productreviews.ProductReview, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[productreviews.ProductReview, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for insert_product_review
    ...
    def pre_list_product_reviews(self, request: productreviews.ListProductReviewsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[productreviews.ListProductReviewsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_product_reviews_with_metadata(self, response: productreviews.ListProductReviewsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[productreviews.ListProductReviewsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_product_reviews
...
class ProductReviewsServiceRestTransport(_BaseProductReviewsServiceRestTransport):
    ...
    class _DeleteProductReview(_BaseProductReviewsServiceRestTransport._BaseDeleteProductReview, ProductReviewsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ProductReviewsServiceRestTransport._DeleteProductReview._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetProductReview(_BaseProductReviewsServiceRestTransport._BaseGetProductReview, ProductReviewsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ProductReviewsServiceRestTransport._GetProductReview._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _InsertProductReview(_BaseProductReviewsServiceRestTransport._BaseInsertProductReview, ProductReviewsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ProductReviewsServiceRestTransport._InsertProductReview._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListProductReviews(_BaseProductReviewsServiceRestTransport._BaseListProductReviews, ProductReviewsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ProductReviewsServiceRestTransport._ListProductReviews._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

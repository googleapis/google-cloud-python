...
class BudgetServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_budget(self, request: budget_service.CreateBudgetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[budget_service.CreateBudgetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_budget_with_metadata(self, response: budget_model.Budget, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[budget_model.Budget, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_budget
    ...
    def pre_delete_budget(self, request: budget_service.DeleteBudgetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[budget_service.DeleteBudgetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_budget(self, request: budget_service.GetBudgetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[budget_service.GetBudgetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_budget_with_metadata(self, response: budget_model.Budget, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[budget_model.Budget, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_budget
    ...
    def pre_list_budgets(self, request: budget_service.ListBudgetsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[budget_service.ListBudgetsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_budgets_with_metadata(self, response: budget_service.ListBudgetsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[budget_service.ListBudgetsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_budgets
    ...
    def pre_update_budget(self, request: budget_service.UpdateBudgetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[budget_service.UpdateBudgetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_budget_with_metadata(self, response: budget_model.Budget, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[budget_model.Budget, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_budget
...
class BudgetServiceRestTransport(_BaseBudgetServiceRestTransport):
    ...
    class _CreateBudget(_BaseBudgetServiceRestTransport._BaseCreateBudget, BudgetServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BudgetServiceRestTransport._CreateBudget._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteBudget(_BaseBudgetServiceRestTransport._BaseDeleteBudget, BudgetServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BudgetServiceRestTransport._DeleteBudget._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetBudget(_BaseBudgetServiceRestTransport._BaseGetBudget, BudgetServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BudgetServiceRestTransport._GetBudget._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListBudgets(_BaseBudgetServiceRestTransport._BaseListBudgets, BudgetServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BudgetServiceRestTransport._ListBudgets._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateBudget(_BaseBudgetServiceRestTransport._BaseUpdateBudget, BudgetServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BudgetServiceRestTransport._UpdateBudget._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

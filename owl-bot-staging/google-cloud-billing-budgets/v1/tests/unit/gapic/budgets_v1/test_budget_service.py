...
def test_create_budget_rest_required_fields(request_type=budget_service.CreateBudgetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_budget._get_unset_required_fields(jsonified_request)
...
def test_create_budget_rest_unset_required_fields():
    transport = transports.BudgetServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_budget_rest_required_fields(request_type=budget_service.UpdateBudgetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_budget._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_budget_rest_required_fields(request_type=budget_service.GetBudgetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_budget._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_budgets_rest_required_fields(request_type=budget_service.ListBudgetsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_budgets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_budget_rest_required_fields(request_type=budget_service.DeleteBudgetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_budget._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
class ListResourceBundlesResponse(proto.Message):
    ...
    Attributes:
        resource_bundles (MutableSequence[google.cloud.configdelivery_v1beta.types.ResourceBundle]):
...
class FleetPackage(proto.Message):
    ...
    Attributes:
        ...
        labels (MutableMapping[str, str]):
            ...
            128 bytes.
        resource_bundle_selector (google.cloud.configdelivery_v1beta.types.FleetPackage.ResourceBundleSelector):
            Required. Information specifying the source
            of kubernetes configuration to deploy.
        target (google.cloud.configdelivery_v1beta.types.FleetPackage.Target):
            Optional. Configuration to select target
            clusters to deploy kubernetes configuration to.
        rollout_strategy (google.cloud.configdelivery_v1beta.types.RolloutStrategy):
            Optional. The strategy to use to deploy
            kubernetes configuration to clusters.
        variant_selector (google.cloud.configdelivery_v1beta.types.FleetPackage.VariantSelector):
            Required. Information specifying how to map a
            ``ResourceBundle`` variant to a target cluster.
        info (google.cloud.configdelivery_v1beta.types.FleetPackageInfo):
            Output only. Information containing the rollout status of
            the ``FleetPackage`` across all the target clusters.
        deletion_propagation_policy (google.cloud.configdelivery_v1beta.types.DeletionPropagationPolicy):
            Optional. Information around how to handle kubernetes
            resources at the target clusters when the ``FleetPackage``
            is deleted.
        state (google.cloud.configdelivery_v1beta.types.FleetPackage.State):
    ...
    class ResourceBundleSelector(proto.Message):
        ...
        Attributes:
            resource_bundle (google.cloud.configdelivery_v1beta.types.FleetPackage.ResourceBundleTag):
                Information specifying ``ResourceBundle``.

                This field is a member of `oneof`_ ``source``.
            cloud_build_repository (google.cloud.configdelivery_v1beta.types.FleetPackage.CloudBuildRepository):
    ...
    class Target(proto.Message):
        ...
        Attributes:
            fleet (google.cloud.configdelivery_v1beta.types.Fleet):
...
class FleetPackageInfo(proto.Message):
    ...
    Attributes:
        ...
        last_completed_rollout (str):
            ...
            ``projects/{project}/locations/{location}/fleetPackages/{fleet_package}/rollouts/{rollout}``.
        state (google.cloud.configdelivery_v1beta.types.FleetPackageInfo.State):
            Optional. Output only. The current state of the
            ``FleetPackage``.
        errors (MutableSequence[google.cloud.configdelivery_v1beta.types.FleetPackageError]):
...
class ClusterInfo(proto.Message):
    ...
    Attributes:
        membership (str):
            ...
            cluster
        desired (google.cloud.configdelivery_v1beta.types.ResourceBundleDeploymentInfo):
            Output only. Desired state for the resource
            bundle.
        initial (google.cloud.configdelivery_v1beta.types.ResourceBundleDeploymentInfo):
            Output only. Initial state of the resource
            bundle prior to the deployment.
        current (google.cloud.configdelivery_v1beta.types.ResourceBundleDeploymentInfo):
            Output only. Current state of the resource
            bundle.
        state (google.cloud.configdelivery_v1beta.types.ClusterInfo.State):
...
class ResourceBundleDeploymentInfo(proto.Message):
    ...
    Attributes:
        ...
        variant (str):
            ...
            release.
        sync_state (google.cloud.configdelivery_v1beta.types.ResourceBundleDeploymentInfo.SyncState):
...
class Fleet(proto.Message):
    ...
    Attributes:
        project (str):
            ...
            ``projects/{project}``.
        selector (google.cloud.configdelivery_v1beta.types.Fleet.LabelSelector):
...
class RolloutStrategy(proto.Message):
    ...
    Attributes:
        all_at_once (google.cloud.configdelivery_v1beta.types.AllAtOnceStrategy):
            AllAtOnceStrategy causes all clusters to be
            updated concurrently.

            This field is a member of `oneof`_ ``strategy``.
        rolling (google.cloud.configdelivery_v1beta.types.RollingStrategy):
...
class RolloutStrategyInfo(proto.Message):
    ...
    Attributes:
        all_at_once_strategy_info (google.cloud.configdelivery_v1beta.types.AllAtOnceStrategyInfo):
            AllAtOnceStrategyInfo represents the status
            of AllAtOnce rollout strategy execution.

            This field is a member of `oneof`_ ``strategy``.
        rolling_strategy_info (google.cloud.configdelivery_v1beta.types.RollingStrategyInfo):
...
class AllAtOnceStrategyInfo(proto.Message):
    ...
    Attributes:
        clusters (MutableSequence[google.cloud.configdelivery_v1beta.types.ClusterInfo]):
...
class ListFleetPackagesResponse(proto.Message):
    ...
    Attributes:
        fleet_packages (MutableSequence[google.cloud.configdelivery_v1beta.types.FleetPackage]):
...
class Release(proto.Message):
    ...
    Attributes:
        ...
        labels (MutableMapping[str, str]):
            Optional. Labels as key value pairs.
        lifecycle (google.cloud.configdelivery_v1beta.types.Release.Lifecycle):
        ...
        info (google.cloud.configdelivery_v1beta.types.ReleaseInfo):
...
class ListVariantsResponse(proto.Message):
    ...
    Attributes:
        variants (MutableSequence[google.cloud.configdelivery_v1beta.types.Variant]):
...
class ListReleasesResponse(proto.Message):
    ...
    Attributes:
        releases (MutableSequence[google.cloud.configdelivery_v1beta.types.Release]):
...
class ListRolloutsResponse(proto.Message):
    ...
    Attributes:
        rollouts (MutableSequence[google.cloud.configdelivery_v1beta.types.Rollout]):
...
class RolloutInfo(proto.Message):
    ...
    Attributes:
        state (google.cloud.configdelivery_v1beta.types.RolloutInfo.State):
        ...
        rollout_strategy_info (google.cloud.configdelivery_v1beta.types.RolloutStrategyInfo):
...
class Rollout(proto.Message):
    ...
    Attributes:
        ...
        rollout_strategy (google.cloud.configdelivery_v1beta.types.RolloutStrategy):
            ...
            clusters.
        info (google.cloud.configdelivery_v1beta.types.RolloutInfo):

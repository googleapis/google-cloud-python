...
from google.cloud.configdelivery_v1beta.services.config_delivery import ConfigDeliveryAsyncClient
from google.cloud.configdelivery_v1beta.services.config_delivery import ConfigDeliveryClient
from google.cloud.configdelivery_v1beta.services.config_delivery import pagers
from google.cloud.configdelivery_v1beta.services.config_delivery import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert ConfigDeliveryClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert ConfigDeliveryClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ConfigDeliveryClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ConfigDeliveryClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert ConfigDeliveryClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert ConfigDeliveryClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ConfigDeliveryClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ConfigDeliveryClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ConfigDeliveryClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ConfigDeliveryClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert ConfigDeliveryClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ConfigDeliveryClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ConfigDeliveryClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ConfigDeliveryClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ConfigDeliveryClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConfigDeliveryClient))
@mock.patch.object(ConfigDeliveryAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConfigDeliveryAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ConfigDeliveryClient._DEFAULT_UNIVERSE
    default_endpoint = ConfigDeliveryClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ConfigDeliveryClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ConfigDeliveryClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ConfigDeliveryClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ConfigDeliveryClient.DEFAULT_MTLS_ENDPOINT
    assert ConfigDeliveryClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ConfigDeliveryClient._get_api_endpoint(None, None, default_universe, "always") == ConfigDeliveryClient.DEFAULT_MTLS_ENDPOINT
    assert ConfigDeliveryClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ConfigDeliveryClient.DEFAULT_MTLS_ENDPOINT
    assert ConfigDeliveryClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ConfigDeliveryClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ConfigDeliveryClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ConfigDeliveryClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ConfigDeliveryClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ConfigDeliveryClient._get_universe_domain(None, None) == ConfigDeliveryClient._DEFAULT_UNIVERSE
...
def test_config_delivery_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ConfigDeliveryAsyncClient, transports.ConfigDeliveryGrpcAsyncIOTransport, "grpc_asyncio"),
    (ConfigDeliveryClient, transports.ConfigDeliveryRestTransport, "rest"),
])
@mock.patch.object(ConfigDeliveryClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConfigDeliveryClient))
@mock.patch.object(ConfigDeliveryAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConfigDeliveryAsyncClient))
def test_config_delivery_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (ConfigDeliveryAsyncClient, transports.ConfigDeliveryGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ConfigDeliveryClient, transports.ConfigDeliveryGrpcTransport, "grpc", "false"),
    (ConfigDeliveryAsyncClient, transports.ConfigDeliveryGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_config_delivery_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    ConfigDeliveryClient, ConfigDeliveryAsyncClient
])
@mock.patch.object(ConfigDeliveryClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ConfigDeliveryClient))
@mock.patch.object(ConfigDeliveryAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ConfigDeliveryAsyncClient))
...
def test_config_delivery_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ConfigDeliveryClient, transports.ConfigDeliveryGrpcTransport, "grpc", grpc_helpers),
    (ConfigDeliveryAsyncClient, transports.ConfigDeliveryGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (ConfigDeliveryClient, transports.ConfigDeliveryRestTransport, "rest", None),
])
def test_config_delivery_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_config_delivery_client_client_options_from_dict():
    with mock.patch('google.cloud.configdelivery_v1beta.services.config_delivery.transports.ConfigDeliveryGrpcTransport.__init__') as grpc_transport:
...
def test_config_delivery_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_list_resource_bundles_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_resource_bundles in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_resource_bundles] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_resource_bundles_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_resource_bundles in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_resource_bundles] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_resource_bundles_async(transport: str = 'grpc_asyncio', request_type=config_delivery.ListResourceBundlesRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config_delivery.ListResourceBundlesResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_resource_bundles_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, config_delivery.ResourceBundle)
                   for i in results)
...
async def test_list_resource_bundles_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_resource_bundles(request={},)
...
def test_get_resource_bundle(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_resource_bundle),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_resource_bundle_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_resource_bundle in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_resource_bundle] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_resource_bundle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_resource_bundle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_resource_bundle] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_resource_bundle_async(transport: str = 'grpc_asyncio', request_type=config_delivery.GetResourceBundleRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config_delivery.ResourceBundle(
            name='name_value',
            description='description_value',
        ))
...
def test_create_resource_bundle(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_resource_bundle),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_resource_bundle_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_resource_bundle in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_resource_bundle] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_resource_bundle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_resource_bundle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_resource_bundle] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_resource_bundle_async(transport: str = 'grpc_asyncio', request_type=config_delivery.CreateResourceBundleRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_resource_bundle(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_resource_bundle),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_resource_bundle_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_resource_bundle in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_resource_bundle] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_resource_bundle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_resource_bundle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_resource_bundle] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_resource_bundle_async(transport: str = 'grpc_asyncio', request_type=config_delivery.UpdateResourceBundleRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_resource_bundle(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_resource_bundle),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_resource_bundle_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_resource_bundle in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_resource_bundle] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_resource_bundle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_resource_bundle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_resource_bundle] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_resource_bundle_async(transport: str = 'grpc_asyncio', request_type=config_delivery.DeleteResourceBundleRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_fleet_packages_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_fleet_packages in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_fleet_packages] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_fleet_packages_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_fleet_packages in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_fleet_packages] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_fleet_packages_async(transport: str = 'grpc_asyncio', request_type=config_delivery.ListFleetPackagesRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config_delivery.ListFleetPackagesResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_fleet_packages_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, config_delivery.FleetPackage)
                   for i in results)
...
async def test_list_fleet_packages_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_fleet_packages(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_fleet_package(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_fleet_package),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.name == 'name_value'
    assert response.deletion_propagation_policy == config_delivery.DeletionPropagationPolicy.FOREGROUND
...
def test_get_fleet_package_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_fleet_package] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_fleet_package_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_fleet_package in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_fleet_package] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_fleet_package_async(transport: str = 'grpc_asyncio', request_type=config_delivery.GetFleetPackageRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config_delivery.FleetPackage(
            name='name_value',
            deletion_propagation_policy=config_delivery.DeletionPropagationPolicy.FOREGROUND,
            state=config_delivery.FleetPackage.State.ACTIVE,
        ))
...
def test_create_fleet_package(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_fleet_package),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_fleet_package_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_fleet_package in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_fleet_package] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_fleet_package_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_fleet_package in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_fleet_package] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_fleet_package_async(transport: str = 'grpc_asyncio', request_type=config_delivery.CreateFleetPackageRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_fleet_package(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_fleet_package),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_fleet_package_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_fleet_package in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_fleet_package] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_fleet_package_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_fleet_package in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_fleet_package] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_fleet_package_async(transport: str = 'grpc_asyncio', request_type=config_delivery.UpdateFleetPackageRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_fleet_package(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_fleet_package),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_fleet_package_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_fleet_package in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_fleet_package] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_fleet_package_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_fleet_package in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_fleet_package] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_fleet_package_async(transport: str = 'grpc_asyncio', request_type=config_delivery.DeleteFleetPackageRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_releases(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_releases),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_releases_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_releases in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_releases] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_releases_async(transport: str = 'grpc_asyncio', request_type=config_delivery.ListReleasesRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config_delivery.ListReleasesResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_releases_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, config_delivery.Release)
                   for i in results)
...
def test_get_release(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_release),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_release_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_release in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_release] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_release_async(transport: str = 'grpc_asyncio', request_type=config_delivery.GetReleaseRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config_delivery.Release(
            name='name_value',
            lifecycle=config_delivery.Release.Lifecycle.DRAFT,
            version='version_value',
        ))
...
def test_create_release(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_release),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_release_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_release in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_release] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_release_async(transport: str = 'grpc_asyncio', request_type=config_delivery.CreateReleaseRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_release(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_release),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_release_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_release in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_release] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_release_async(transport: str = 'grpc_asyncio', request_type=config_delivery.UpdateReleaseRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_release(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_release),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_release_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_release in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_release] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_release_async(transport: str = 'grpc_asyncio', request_type=config_delivery.DeleteReleaseRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_variants(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_variants),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_variants_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_variants in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_variants] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_variants_async(transport: str = 'grpc_asyncio', request_type=config_delivery.ListVariantsRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config_delivery.ListVariantsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_variants_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, config_delivery.Variant)
                   for i in results)
...
async def test_list_variants_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_variants(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_variant(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_variant),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_variant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_variant in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_variant] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_variant_async(transport: str = 'grpc_asyncio', request_type=config_delivery.GetVariantRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config_delivery.Variant(
            resources=['resources_value'],
            name='name_value',
        ))
...
def test_create_variant(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_variant),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_variant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_variant in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_variant] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_variant_async(transport: str = 'grpc_asyncio', request_type=config_delivery.CreateVariantRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_variant(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_variant),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_variant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_variant in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_variant] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_variant_async(transport: str = 'grpc_asyncio', request_type=config_delivery.UpdateVariantRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_variant(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_variant),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_variant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_variant in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_variant] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_variant_async(transport: str = 'grpc_asyncio', request_type=config_delivery.DeleteVariantRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_rollouts_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_rollouts in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_rollouts] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_rollouts_async(transport: str = 'grpc_asyncio', request_type=config_delivery.ListRolloutsRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config_delivery.ListRolloutsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_rollouts_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, config_delivery.Rollout)
                   for i in results)
...
def test_get_rollout(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_rollout),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_rollout_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_rollout in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_rollout] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_rollout_async(transport: str = 'grpc_asyncio', request_type=config_delivery.GetRolloutRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config_delivery.Rollout(
            name='name_value',
            release='release_value',
            deletion_propagation_policy=config_delivery.DeletionPropagationPolicy.FOREGROUND,
        ))
...
def test_suspend_rollout(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.suspend_rollout),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_suspend_rollout_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.suspend_rollout in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.suspend_rollout] = mock_rpc
...
@pytest.mark.asyncio
async def test_suspend_rollout_async(transport: str = 'grpc_asyncio', request_type=config_delivery.SuspendRolloutRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_resume_rollout(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resume_rollout),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_resume_rollout_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.resume_rollout in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.resume_rollout] = mock_rpc
...
@pytest.mark.asyncio
async def test_resume_rollout_async(transport: str = 'grpc_asyncio', request_type=config_delivery.ResumeRolloutRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_abort_rollout(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.abort_rollout),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_abort_rollout_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigDeliveryAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.abort_rollout in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.abort_rollout] = mock_rpc
...
@pytest.mark.asyncio
async def test_abort_rollout_async(transport: str = 'grpc_asyncio', request_type=config_delivery.AbortRolloutRequest):
    client = ConfigDeliveryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_resource_bundles_rest_required_fields(request_type=config_delivery.ListResourceBundlesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_resource_bundles._get_unset_required_fields(jsonified_request)
...
def test_list_resource_bundles_rest_unset_required_fields():
    transport = transports.ConfigDeliveryRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_resource_bundles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*}/resourceBundles" % client.transport._host, args[1])
...
def test_list_resource_bundles_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(config_delivery.ListResourceBundlesResponse.to_json(x) for x in response)
...
def test_get_resource_bundle_rest_required_fields(request_type=config_delivery.GetResourceBundleRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_resource_bundle._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_resource_bundle_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/resourceBundles/*}" % client.transport._host, args[1])
...
def test_create_resource_bundle_rest_required_fields(request_type=config_delivery.CreateResourceBundleRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_resource_bundle._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_resource_bundle._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("request_id", "resource_bundle_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_resource_bundle_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "resourceBundleId", )) & set(("parent", "resourceBundleId", "resourceBundle", )))
...
def test_update_resource_bundle_rest_required_fields(request_type=config_delivery.UpdateResourceBundleRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_resource_bundle._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_resource_bundle_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("updateMask", "resourceBundle", )))
...
def test_update_resource_bundle_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'resource_bundle': {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{resource_bundle.name=projects/*/locations/*/resourceBundles/*}" % client.transport._host, args[1])
...
def test_delete_resource_bundle_rest_required_fields(request_type=config_delivery.DeleteResourceBundleRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_resource_bundle._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_fleet_packages_rest_required_fields(request_type=config_delivery.ListFleetPackagesRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_fleet_packages._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_fleet_packages_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*}/fleetPackages" % client.transport._host, args[1])
...
def test_list_fleet_packages_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(config_delivery.ListFleetPackagesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_fleet_package_rest_required_fields(request_type=config_delivery.GetFleetPackageRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_fleet_package._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_fleet_package_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/fleetPackages/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/fleetPackages/*}" % client.transport._host, args[1])
...
def test_create_fleet_package_rest_required_fields(request_type=config_delivery.CreateFleetPackageRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_fleet_package._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_fleet_package._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("fleet_package_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_fleet_package_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("fleetPackageId", "requestId", )) & set(("parent", "fleetPackageId", "fleetPackage", )))
...
def test_update_fleet_package_rest_required_fields(request_type=config_delivery.UpdateFleetPackageRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_fleet_package._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_fleet_package_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("updateMask", "fleetPackage", )))
...
def test_update_fleet_package_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'fleet_package': {'name': 'projects/sample1/locations/sample2/fleetPackages/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{fleet_package.name=projects/*/locations/*/fleetPackages/*}" % client.transport._host, args[1])
...
def test_delete_fleet_package_rest_required_fields(request_type=config_delivery.DeleteFleetPackageRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_fleet_package._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_fleet_package._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("allow_missing", "force", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_delete_fleet_package_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "force", "requestId", )) & set(("name", )))
...
def test_list_releases_rest_required_fields(request_type=config_delivery.ListReleasesRequest):
    transport_class = transports.ConfigDeliveryRestTransport
...
def test_list_releases_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/resourceBundles/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/resourceBundles/*}/releases" % client.transport._host, args[1])
...
def test_list_releases_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(config_delivery.ListReleasesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_release_rest_required_fields(request_type=config_delivery.GetReleaseRequest):
    transport_class = transports.ConfigDeliveryRestTransport
...
def test_get_release_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/resourceBundles/*/releases/*}" % client.transport._host, args[1])
...
def test_create_release_rest_required_fields(request_type=config_delivery.CreateReleaseRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_release._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("release_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_release_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("releaseId", "requestId", )) & set(("parent", "releaseId", "release", )))
...
def test_update_release_rest_required_fields(request_type=config_delivery.UpdateReleaseRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_release._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_release_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("updateMask", "release", )))
...
def test_update_release_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'release': {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{release.name=projects/*/locations/*/resourceBundles/*/releases/*}" % client.transport._host, args[1])
...
def test_delete_release_rest_required_fields(request_type=config_delivery.DeleteReleaseRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_release._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_variants_rest_required_fields(request_type=config_delivery.ListVariantsRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_variants._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_variants_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/resourceBundles/*/releases/*}/variants" % client.transport._host, args[1])
...
def test_list_variants_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(config_delivery.ListVariantsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_variant_rest_required_fields(request_type=config_delivery.GetVariantRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_variant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_variant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4/variants/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/resourceBundles/*/releases/*/variants/*}" % client.transport._host, args[1])
...
def test_create_variant_rest_required_fields(request_type=config_delivery.CreateVariantRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_variant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_variant._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("request_id", "variant_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_variant_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "variantId", )) & set(("parent", "variantId", "variant", )))
...
def test_update_variant_rest_required_fields(request_type=config_delivery.UpdateVariantRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_variant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_variant_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("variant", )))
...
def test_update_variant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'variant': {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4/variants/sample5'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{variant.name=projects/*/locations/*/resourceBundles/*/releases/*/variants/*}" % client.transport._host, args[1])
...
def test_delete_variant_rest_required_fields(request_type=config_delivery.DeleteVariantRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_variant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_rollouts_rest_required_fields(request_type=config_delivery.ListRolloutsRequest):
    transport_class = transports.ConfigDeliveryRestTransport
...
def test_list_rollouts_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/fleetPackages/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/fleetPackages/*}/rollouts" % client.transport._host, args[1])
...
def test_list_rollouts_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(config_delivery.ListRolloutsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_rollout_rest_required_fields(request_type=config_delivery.GetRolloutRequest):
    transport_class = transports.ConfigDeliveryRestTransport
...
def test_get_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/fleetPackages/sample3/rollouts/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}" % client.transport._host, args[1])
...
def test_suspend_rollout_rest_required_fields(request_type=config_delivery.SuspendRolloutRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).suspend_rollout._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_suspend_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}:suspend" % client.transport._host, args[1])
...
def test_resume_rollout_rest_required_fields(request_type=config_delivery.ResumeRolloutRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).resume_rollout._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_resume_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}:resume" % client.transport._host, args[1])
...
def test_abort_rollout_rest_required_fields(request_type=config_delivery.AbortRolloutRequest):
    transport_class = transports.ConfigDeliveryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).abort_rollout._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_abort_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}:abort" % client.transport._host, args[1])
...
def test_list_resource_bundles_rest_bad_request(request_type=config_delivery.ListResourceBundlesRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_resource_bundles_rest_interceptors(null_interceptor):
    transport = transports.ConfigDeliveryRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ConfigDeliveryRestInterceptor(),
        )
    client = ConfigDeliveryClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_resource_bundles") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_resource_bundles_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_list_resource_bundles") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.ListResourceBundlesRequest.pb(config_delivery.ListResourceBundlesRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config_delivery.ListResourceBundlesResponse.to_json(config_delivery.ListResourceBundlesResponse())
        ...
        post_with_metadata.return_value = config_delivery.ListResourceBundlesResponse(), metadata

        client.list_resource_bundles(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_resource_bundle_rest_bad_request(request_type=config_delivery.GetResourceBundleRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3'}
    request = request_type(**request_init)
...
def test_get_resource_bundle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_resource_bundle") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_resource_bundle_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_get_resource_bundle") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.GetResourceBundleRequest.pb(config_delivery.GetResourceBundleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config_delivery.ResourceBundle.to_json(config_delivery.ResourceBundle())
        req.return_value.content = return_value
        ...
        client.get_resource_bundle(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_resource_bundle_rest_bad_request(request_type=config_delivery.CreateResourceBundleRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_resource_bundle_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["resource_bundle"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = config_delivery.CreateResourceBundleRequest.meta.fields["resource_bundle"]
...
def test_create_resource_bundle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_create_resource_bundle") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_create_resource_bundle_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_create_resource_bundle") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.CreateResourceBundleRequest.pb(config_delivery.CreateResourceBundleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_resource_bundle(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_resource_bundle_rest_bad_request(request_type=config_delivery.UpdateResourceBundleRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'resource_bundle': {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3'}}
    request = request_type(**request_init)
...
def test_update_resource_bundle_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'resource_bundle': {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3'}}
    request_init["resource_bundle"] = {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = config_delivery.UpdateResourceBundleRequest.meta.fields["resource_bundle"]
...
def test_update_resource_bundle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_update_resource_bundle") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_update_resource_bundle_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_update_resource_bundle") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.UpdateResourceBundleRequest.pb(config_delivery.UpdateResourceBundleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_resource_bundle(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_resource_bundle_rest_bad_request(request_type=config_delivery.DeleteResourceBundleRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_resource_bundle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_delete_resource_bundle") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_delete_resource_bundle_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_delete_resource_bundle") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.DeleteResourceBundleRequest.pb(config_delivery.DeleteResourceBundleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_resource_bundle(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_fleet_packages_rest_bad_request(request_type=config_delivery.ListFleetPackagesRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_fleet_packages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_fleet_packages") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_fleet_packages_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_list_fleet_packages") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.ListFleetPackagesRequest.pb(config_delivery.ListFleetPackagesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config_delivery.ListFleetPackagesResponse.to_json(config_delivery.ListFleetPackagesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config_delivery.ListFleetPackagesResponse(), metadata

        client.list_fleet_packages(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_fleet_package_rest_bad_request(request_type=config_delivery.GetFleetPackageRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_fleet_package_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_fleet_package") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_fleet_package_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_get_fleet_package") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.GetFleetPackageRequest.pb(config_delivery.GetFleetPackageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config_delivery.FleetPackage.to_json(config_delivery.FleetPackage())
        req.return_value.content = return_value
        ...
        client.get_fleet_package(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_fleet_package_rest_bad_request(request_type=config_delivery.CreateFleetPackageRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_fleet_package_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["fleet_package"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'resource_bundle_selector': {'resource_bundle': {'name': 'name_value', 'tag': 'tag_value'}, 'cloud_build_repository': {'variants_pattern': 'variants_pattern_value', 'name': 'name_value', 'path': 'path_value', 'tag': 'tag_value', 'service_account': 'service_account_value'}}, 'target': {'fleet': {'project': 'project_value', 'selector': {'match_labels': {}}}}, 'rollout_strategy': {'all_at_once': {}, 'rolling': {'max_concurrent': 1512}}, 'variant_selector': {'variant_name_template': 'variant_name_template_value'}, 'info': {'active_rollout': 'active_rollout_value', 'last_completed_rollout': 'last_completed_rollout_value', 'state': 1, 'errors': [{'error_message': 'error_message_value'}]}, 'deletion_propagation_policy': 1, 'state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_fleet_package_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_create_fleet_package") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_create_fleet_package_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_create_fleet_package") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.CreateFleetPackageRequest.pb(config_delivery.CreateFleetPackageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_fleet_package(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_fleet_package_rest_bad_request(request_type=config_delivery.UpdateFleetPackageRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'fleet_package': {'name': 'projects/sample1/locations/sample2/fleetPackages/sample3'}}
    request = request_type(**request_init)
...
def test_update_fleet_package_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'fleet_package': {'name': 'projects/sample1/locations/sample2/fleetPackages/sample3'}}
    request_init["fleet_package"] = {'name': 'projects/sample1/locations/sample2/fleetPackages/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'resource_bundle_selector': {'resource_bundle': {'name': 'name_value', 'tag': 'tag_value'}, 'cloud_build_repository': {'variants_pattern': 'variants_pattern_value', 'name': 'name_value', 'path': 'path_value', 'tag': 'tag_value', 'service_account': 'service_account_value'}}, 'target': {'fleet': {'project': 'project_value', 'selector': {'match_labels': {}}}}, 'rollout_strategy': {'all_at_once': {}, 'rolling': {'max_concurrent': 1512}}, 'variant_selector': {'variant_name_template': 'variant_name_template_value'}, 'info': {'active_rollout': 'active_rollout_value', 'last_completed_rollout': 'last_completed_rollout_value', 'state': 1, 'errors': [{'error_message': 'error_message_value'}]}, 'deletion_propagation_policy': 1, 'state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_fleet_package_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_update_fleet_package") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_update_fleet_package_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_update_fleet_package") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.UpdateFleetPackageRequest.pb(config_delivery.UpdateFleetPackageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_fleet_package(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_fleet_package_rest_bad_request(request_type=config_delivery.DeleteFleetPackageRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_fleet_package_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_delete_fleet_package") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_delete_fleet_package_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_delete_fleet_package") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.DeleteFleetPackageRequest.pb(config_delivery.DeleteFleetPackageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_fleet_package(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_releases_rest_bad_request(request_type=config_delivery.ListReleasesRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/resourceBundles/sample3'}
    request = request_type(**request_init)
...
def test_list_releases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_releases") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_releases_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_list_releases") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.ListReleasesRequest.pb(config_delivery.ListReleasesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config_delivery.ListReleasesResponse.to_json(config_delivery.ListReleasesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config_delivery.ListReleasesResponse(), metadata
...
def test_get_release_rest_bad_request(request_type=config_delivery.GetReleaseRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4'}
    request = request_type(**request_init)
...
def test_get_release_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_release") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_release_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_get_release") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.GetReleaseRequest.pb(config_delivery.GetReleaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_release_rest_bad_request(request_type=config_delivery.CreateReleaseRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_release_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/resourceBundles/sample3'}
    request_init["release"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'lifecycle': 1, 'version': 'version_value', 'publish_time': {}, 'info': {'oci_image_path': 'oci_image_path_value', 'variant_oci_image_paths': {}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_release_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_create_release") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_create_release_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_create_release") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.CreateReleaseRequest.pb(config_delivery.CreateReleaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_release_rest_bad_request(request_type=config_delivery.UpdateReleaseRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'release': {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4'}}
    request = request_type(**request_init)
...
def test_update_release_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'release': {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4'}}
    request_init["release"] = {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'lifecycle': 1, 'version': 'version_value', 'publish_time': {}, 'info': {'oci_image_path': 'oci_image_path_value', 'variant_oci_image_paths': {}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_release_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_update_release") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_update_release_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_update_release") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.UpdateReleaseRequest.pb(config_delivery.UpdateReleaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_release(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_release_rest_bad_request(request_type=config_delivery.DeleteReleaseRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_release_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_delete_release") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_delete_release_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_delete_release") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.DeleteReleaseRequest.pb(config_delivery.DeleteReleaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_release(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_variants_rest_bad_request(request_type=config_delivery.ListVariantsRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4'}
    request = request_type(**request_init)
...
def test_list_variants_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_variants") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_variants_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_list_variants") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.ListVariantsRequest.pb(config_delivery.ListVariantsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config_delivery.ListVariantsResponse.to_json(config_delivery.ListVariantsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config_delivery.ListVariantsResponse(), metadata

        client.list_variants(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_variant_rest_bad_request(request_type=config_delivery.GetVariantRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4/variants/sample5'}
    request = request_type(**request_init)
...
def test_get_variant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_variant") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_variant_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_get_variant") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.GetVariantRequest.pb(config_delivery.GetVariantRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_variant(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_variant_rest_bad_request(request_type=config_delivery.CreateVariantRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_variant_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4'}
    request_init["variant"] = {'labels': {}, 'resources': ['resources_value1', 'resources_value2'], 'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_variant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_create_variant") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_create_variant_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_create_variant") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.CreateVariantRequest.pb(config_delivery.CreateVariantRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_variant(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_variant_rest_bad_request(request_type=config_delivery.UpdateVariantRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'variant': {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4/variants/sample5'}}
    request = request_type(**request_init)
...
def test_update_variant_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'variant': {'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4/variants/sample5'}}
    request_init["variant"] = {'labels': {}, 'resources': ['resources_value1', 'resources_value2'], 'name': 'projects/sample1/locations/sample2/resourceBundles/sample3/releases/sample4/variants/sample5', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_variant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_update_variant") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_update_variant_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_update_variant") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.UpdateVariantRequest.pb(config_delivery.UpdateVariantRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_variant(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_variant_rest_bad_request(request_type=config_delivery.DeleteVariantRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_variant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_delete_variant") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_delete_variant_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_delete_variant") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.DeleteVariantRequest.pb(config_delivery.DeleteVariantRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_variant(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_rollouts_rest_bad_request(request_type=config_delivery.ListRolloutsRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/fleetPackages/sample3'}
    request = request_type(**request_init)
...
def test_list_rollouts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_rollouts") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_rollouts_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_list_rollouts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.ListRolloutsRequest.pb(config_delivery.ListRolloutsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config_delivery.ListRolloutsResponse.to_json(config_delivery.ListRolloutsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config_delivery.ListRolloutsResponse(), metadata
...
def test_get_rollout_rest_bad_request(request_type=config_delivery.GetRolloutRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/fleetPackages/sample3/rollouts/sample4'}
    request = request_type(**request_init)
...
def test_get_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_rollout") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_rollout_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_get_rollout") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.GetRolloutRequest.pb(config_delivery.GetRolloutRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_suspend_rollout_rest_bad_request(request_type=config_delivery.SuspendRolloutRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_suspend_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_suspend_rollout") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_suspend_rollout_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_suspend_rollout") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.SuspendRolloutRequest.pb(config_delivery.SuspendRolloutRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.suspend_rollout(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_resume_rollout_rest_bad_request(request_type=config_delivery.ResumeRolloutRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_resume_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_resume_rollout") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_resume_rollout_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_resume_rollout") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.ResumeRolloutRequest.pb(config_delivery.ResumeRolloutRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.resume_rollout(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_abort_rollout_rest_bad_request(request_type=config_delivery.AbortRolloutRequest):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_abort_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_abort_rollout") as post, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_abort_rollout_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigDeliveryRestInterceptor, "pre_abort_rollout") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config_delivery.AbortRolloutRequest.pb(config_delivery.AbortRolloutRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.abort_rollout(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_config_delivery_base_transport():
    ...
    with mock.patch('google.cloud.configdelivery_v1beta.services.config_delivery.transports.ConfigDeliveryTransport.__init__') as Transport:
...
def test_config_delivery_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.configdelivery_v1beta.services.config_delivery.transports.ConfigDeliveryTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_config_delivery_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.configdelivery_v1beta.services.config_delivery.transports.ConfigDeliveryTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ConfigDeliveryTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.ConfigDeliveryGrpcTransport, transports.ConfigDeliveryGrpcAsyncIOTransport])
def test_config_delivery_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_config_delivery_host_no_port(transport_name):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='configdelivery.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'configdelivery.googleapis.com:443'
...
def test_config_delivery_host_with_port(transport_name):
    client = ConfigDeliveryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='configdelivery.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ConfigDeliveryGrpcTransport, transports.ConfigDeliveryGrpcAsyncIOTransport])
def test_config_delivery_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_fleet_package_path():
    ...
    location = "clam"
    fleet_package = "whelk"
    expected = "projects/{project}/locations/{location}/fleetPackages/{fleet_package}".format(project=project, location=location, fleet_package=fleet_package, )
...
def test_release_path():
    ...
    release = "octopus"
    expected = "projects/{project}/locations/{location}/resourceBundles/{resource_bundle}/releases/{release}".format(project=project, location=location, resource_bundle=resource_bundle, release=release, )
    actual = ConfigDeliveryClient.release_path(project, location, resource_bundle, release)
    assert expected == actual
...
def test_repository_path():
    ...
    actual = ConfigDeliveryClient.repository_path(project, location, connection, repository)
    assert expected == actual
...
def test_resource_bundle_path():
    ...
    location = "nudibranch"
    resource_bundle = "cuttlefish"
    expected = "projects/{project}/locations/{location}/resourceBundles/{resource_bundle}".format(project=project, location=location, resource_bundle=resource_bundle, )
    actual = ConfigDeliveryClient.resource_bundle_path(project, location, resource_bundle)
    assert expected == actual
...
def test_rollout_path():
    ...
    fleet_package = "squid"
    rollout = "clam"
    expected = "projects/{project}/locations/{location}/fleetPackages/{fleet_package}/rollouts/{rollout}".format(project=project, location=location, fleet_package=fleet_package, rollout=rollout, )
    actual = ConfigDeliveryClient.rollout_path(project, location, fleet_package, rollout)
    assert expected == actual
...
def test_variant_path():
    ...
    release = "nautilus"
    variant = "scallop"
    expected = "projects/{project}/locations/{location}/resourceBundles/{resource_bundle}/releases/{release}/variants/{variant}".format(project=project, location=location, resource_bundle=resource_bundle, release=release, variant=variant, )
    actual = ConfigDeliveryClient.variant_path(project, location, resource_bundle, release, variant)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.ConfigDeliveryTransport, '_prep_wrapped_messages') as prep:
        client = ConfigDeliveryClient(
            credentials=ga_credentials.AnonymousCredentials(),

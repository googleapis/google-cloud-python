...
from google.cloud.configdelivery_v1alpha.services.config_delivery import ConfigDeliveryAsyncClient
from google.cloud.configdelivery_v1alpha.services.config_delivery import ConfigDeliveryClient
from google.cloud.configdelivery_v1alpha.services.config_delivery import pagers
from google.cloud.configdelivery_v1alpha.services.config_delivery import transports
...
def test_config_delivery_client_client_options_from_dict():
    with mock.patch('google.cloud.configdelivery_v1alpha.services.config_delivery.transports.ConfigDeliveryGrpcTransport.__init__') as grpc_transport:
...
def test_list_resource_bundles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/resourceBundles" % client.transport._host, args[1])
...
def test_get_resource_bundle_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/resourceBundles/*}" % client.transport._host, args[1])
...
def test_update_resource_bundle_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{resource_bundle.name=projects/*/locations/*/resourceBundles/*}" % client.transport._host, args[1])
...
def test_list_fleet_packages_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/fleetPackages" % client.transport._host, args[1])
...
def test_get_fleet_package_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/fleetPackages/*}" % client.transport._host, args[1])
...
def test_update_fleet_package_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{fleet_package.name=projects/*/locations/*/fleetPackages/*}" % client.transport._host, args[1])
...
def test_list_releases_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/resourceBundles/*}/releases" % client.transport._host, args[1])
...
def test_get_release_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/resourceBundles/*/releases/*}" % client.transport._host, args[1])
...
def test_update_release_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{release.name=projects/*/locations/*/resourceBundles/*/releases/*}" % client.transport._host, args[1])
...
def test_list_variants_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/resourceBundles/*/releases/*}/variants" % client.transport._host, args[1])
...
def test_get_variant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/resourceBundles/*/releases/*/variants/*}" % client.transport._host, args[1])
...
def test_update_variant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{variant.name=projects/*/locations/*/resourceBundles/*/releases/*/variants/*}" % client.transport._host, args[1])
...
def test_list_rollouts_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/fleetPackages/*}/rollouts" % client.transport._host, args[1])
...
def test_get_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}" % client.transport._host, args[1])
...
def test_suspend_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}:suspend" % client.transport._host, args[1])
...
def test_resume_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}:resume" % client.transport._host, args[1])
...
def test_abort_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}:abort" % client.transport._host, args[1])
...
def test_config_delivery_base_transport():
    ...
    with mock.patch('google.cloud.configdelivery_v1alpha.services.config_delivery.transports.ConfigDeliveryTransport.__init__') as Transport:
...
def test_config_delivery_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.configdelivery_v1alpha.services.config_delivery.transports.ConfigDeliveryTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_config_delivery_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.configdelivery_v1alpha.services.config_delivery.transports.ConfigDeliveryTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ConfigDeliveryTransport()
        adc.assert_called_once()

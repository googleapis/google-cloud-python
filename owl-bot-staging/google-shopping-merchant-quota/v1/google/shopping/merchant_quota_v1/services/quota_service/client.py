...
class QuotaServiceClient(metaclass=QuotaServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.quota_v1.QuotaServiceClient`.",
                    extra = {
    ...
    def list_quota_groups(self,
        ...
        Args:
            request (Union[google.shopping.merchant_quota_v1.types.ListQuotaGroupsRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_quota_v1.services.quota_service.pagers.ListQuotaGroupsPager:

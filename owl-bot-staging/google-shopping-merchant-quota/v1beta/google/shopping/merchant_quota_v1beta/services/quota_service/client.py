...
from google.shopping.merchant_quota_v1beta import gapic_version as package_version
...
from .transports.base import QuotaServiceTransport, DEFAULT_CLIENT_INFO
...
class QuotaServiceClient(metaclass=QuotaServiceClientMeta):
    ...
    @staticmethod
    def quota_group_path(account: str,group: str,) -> str:
        """Returns a fully-qualified quota_group string."""
        return "accounts/{account}/groups/{group}".format(account=account, group=group, )

    @staticmethod
    def parse_quota_group_path(path: str) -> Dict[str,str]:
        """Parses a quota_group path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/groups/(?P<group>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = QuotaServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            QuotaServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, QuotaServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Union[str, QuotaServiceTransport]): The
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = QuotaServiceClient._read_environment_variables()
        self._client_cert_source = QuotaServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = QuotaServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            QuotaServiceClient._get_api_endpoint(
    ...
    def list_quota_groups(self,
        ...
        Args:
            request (Union[google.shopping.merchant_quota_v1beta.types.ListQuotaGroupsRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_quota_v1beta.services.quota_service.pagers.ListQuotaGroupsPager:
        ...
        # in a quota.ListQuotaGroupsRequest.

...
from google.cloud.video.transcoder_v1.services.transcoder_service import TranscoderServiceAsyncClient
...
def test__get_api_endpoint():
    ...
    assert TranscoderServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == TranscoderServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert TranscoderServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == TranscoderServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    TranscoderServiceClient, TranscoderServiceAsyncClient
])
...
def test_create_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_create_job") as post, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_create_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "pre_create_job") as pre:
...
def test_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_list_jobs") as post, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_list_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "pre_list_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_get_job") as post, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_get_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "pre_get_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "pre_delete_job") as pre:
        pre.assert_not_called()
...
def test_create_job_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_create_job_template") as post, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_create_job_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "pre_create_job_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_job_templates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_list_job_templates") as post, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_list_job_templates_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "pre_list_job_templates") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_job_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_get_job_template") as post, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "post_get_job_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "pre_get_job_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_job_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TranscoderServiceRestInterceptor, "pre_delete_job_template") as pre:
        pre.assert_not_called()

...
def test_create_job_rest_unset_required_fields():
    transport = transports.TranscoderServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_job_template_rest_required_fields(request_type=services.CreateJobTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_job_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_job_templates_rest_required_fields(request_type=services.ListJobTemplatesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_job_templates._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_job_template_rest_required_fields(request_type=services.GetJobTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_job_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_job_template_rest_required_fields(request_type=services.DeleteJobTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_job_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

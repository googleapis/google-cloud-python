...
class _BaseTranscoderServiceRestTransport(TranscoderServiceTransport):
    """Base REST backend transport for TranscoderService.
...
__all__=(
    '_BaseTranscoderServiceRestTransport',
)

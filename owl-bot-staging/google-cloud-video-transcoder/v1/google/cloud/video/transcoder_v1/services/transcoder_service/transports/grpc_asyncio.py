...
class TranscoderServiceGrpcAsyncIOTransport(TranscoderServiceTransport):
    ...
    def create_job_template(self) -> Callable[
        ...
        if 'create_job_template' not in self._stubs:
            self._stubs['create_job_template'] = self._logged_channel.unary_unary(
    ...
    def list_job_templates(self) -> Callable[
        ...
        if 'list_job_templates' not in self._stubs:
            self._stubs['list_job_templates'] = self._logged_channel.unary_unary(
    ...
    def get_job_template(self) -> Callable[
        ...
        if 'get_job_template' not in self._stubs:
            self._stubs['get_job_template'] = self._logged_channel.unary_unary(
    ...
    def delete_job_template(self) -> Callable[
        ...
        if 'delete_job_template' not in self._stubs:
            self._stubs['delete_job_template'] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.create_job_template: self._wrap_method(
                self.create_job_template,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_job_templates: self._wrap_method(
            ...
            self.get_job_template: self._wrap_method(
            ...
            self.delete_job_template: self._wrap_method(

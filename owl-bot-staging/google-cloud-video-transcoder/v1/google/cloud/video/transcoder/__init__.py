...
from google.cloud.video.transcoder_v1.types.resources import InputAttributes
...
from google.cloud.video.transcoder_v1.types.resources import TrackDefinition

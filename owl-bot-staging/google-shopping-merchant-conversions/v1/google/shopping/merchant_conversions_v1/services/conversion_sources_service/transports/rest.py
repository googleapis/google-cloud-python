...
class ConversionSourcesServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_conversion_source(self, request: conversionsources.CreateConversionSourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversionsources.CreateConversionSourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_conversion_source_with_metadata(self, response: conversionsources.ConversionSource, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversionsources.ConversionSource, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_conversion_source
    ...
    def pre_delete_conversion_source(self, request: conversionsources.DeleteConversionSourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversionsources.DeleteConversionSourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_conversion_source(self, request: conversionsources.GetConversionSourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversionsources.GetConversionSourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_conversion_source_with_metadata(self, response: conversionsources.ConversionSource, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversionsources.ConversionSource, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_conversion_source
    ...
    def pre_list_conversion_sources(self, request: conversionsources.ListConversionSourcesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversionsources.ListConversionSourcesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_conversion_sources(self, response: conversionsources.ListConversionSourcesResponse) -> conversionsources.ListConversionSourcesResponse:
    ...
    def post_list_conversion_sources_with_metadata(self, response: conversionsources.ListConversionSourcesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversionsources.ListConversionSourcesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_conversion_sources
    ...
    def pre_undelete_conversion_source(self, request: conversionsources.UndeleteConversionSourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversionsources.UndeleteConversionSourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_undelete_conversion_source_with_metadata(self, response: conversionsources.ConversionSource, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversionsources.ConversionSource, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for undelete_conversion_source
    ...
    def pre_update_conversion_source(self, request: conversionsources.UpdateConversionSourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversionsources.UpdateConversionSourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_conversion_source_with_metadata(self, response: conversionsources.ConversionSource, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversionsources.ConversionSource, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_conversion_source
...
class ConversionSourcesServiceRestTransport(_BaseConversionSourcesServiceRestTransport):
    ...
    class _CreateConversionSource(_BaseConversionSourcesServiceRestTransport._BaseCreateConversionSource, ConversionSourcesServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient.CreateConversionSource",
                    extra = {
            ...
            # Send the request
            response = ConversionSourcesServiceRestTransport._CreateConversionSource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient.create_conversion_source",
                    extra = {
                        "serviceName": "google.shopping.merchant.conversions.v1.ConversionSourcesService",
                        "rpcName": "CreateConversionSource",
    ...
    class _DeleteConversionSource(_BaseConversionSourcesServiceRestTransport._BaseDeleteConversionSource, ConversionSourcesServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient.DeleteConversionSource",
                    extra = {
                        "serviceName": "google.shopping.merchant.conversions.v1.ConversionSourcesService",
            ...
            # Send the request
            response = ConversionSourcesServiceRestTransport._DeleteConversionSource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetConversionSource(_BaseConversionSourcesServiceRestTransport._BaseGetConversionSource, ConversionSourcesServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient.GetConversionSource",
                    extra = {
                        "serviceName": "google.shopping.merchant.conversions.v1.ConversionSourcesService",
            ...
            # Send the request
            response = ConversionSourcesServiceRestTransport._GetConversionSource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient.get_conversion_source",
                    extra = {
                        "serviceName": "google.shopping.merchant.conversions.v1.ConversionSourcesService",
                        "rpcName": "GetConversionSource",
                        "metadata": http_response["headers"],
    ...
    class _ListConversionSources(_BaseConversionSourcesServiceRestTransport._BaseListConversionSources, ConversionSourcesServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient.ListConversionSources",
                    extra = {
                        "serviceName": "google.shopping.merchant.conversions.v1.ConversionSourcesService",
            ...
            # Send the request
            response = ConversionSourcesServiceRestTransport._ListConversionSources._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient.list_conversion_sources",
                    extra = {
                        "serviceName": "google.shopping.merchant.conversions.v1.ConversionSourcesService",
                        "rpcName": "ListConversionSources",
                        "metadata": http_response["headers"],
    ...
    class _UndeleteConversionSource(_BaseConversionSourcesServiceRestTransport._BaseUndeleteConversionSource, ConversionSourcesServiceRestStub):
        ...
        source method over HTTP.
            ...
            transcoded_request = _BaseConversionSourcesServiceRestTransport._BaseUndeleteConversionSource._get_transcoded_request(http_options, request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient.UndeleteConversionSource",
                    extra = {
                        "serviceName": "google.shopping.merchant.conversions.v1.ConversionSourcesService",
            ...
            # Send the request
            response = ConversionSourcesServiceRestTransport._UndeleteConversionSource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient.undelete_conversion_source",
                    extra = {
                        "serviceName": "google.shopping.merchant.conversions.v1.ConversionSourcesService",
                        "rpcName": "UndeleteConversionSource",
                        "metadata": http_response["headers"],
    ...
    class _UpdateConversionSource(_BaseConversionSourcesServiceRestTransport._BaseUpdateConversionSource, ConversionSourcesServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient.UpdateConversionSource",
                    extra = {
                        "serviceName": "google.shopping.merchant.conversions.v1.ConversionSourcesService",
            ...
            # Send the request
            response = ConversionSourcesServiceRestTransport._UpdateConversionSource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient.update_conversion_source",
                    extra = {
                        "serviceName": "google.shopping.merchant.conversions.v1.ConversionSourcesService",
                        "rpcName": "UpdateConversionSource",
                        "metadata": http_response["headers"],
    ...
    @property
    def create_conversion_source(self) -> Callable[
    ...
    @property
    def delete_conversion_source(self) -> Callable[
    ...
    @property
    def get_conversion_source(self) -> Callable[
    ...
    @property
    def list_conversion_sources(self) -> Callable[
    ...
    @property
    def undelete_conversion_source(self) -> Callable[
    ...
    @property
    def update_conversion_source(self) -> Callable[

...
class ConversionSourcesServiceClient(metaclass=ConversionSourcesServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.conversions_v1.ConversionSourcesServiceClient`.",
                    extra = {
    ...
    def create_conversion_source(self,
        ...
        Args:
            request (Union[google.shopping.merchant_conversions_v1.types.CreateConversionSourceRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_conversions_v1.types.ConversionSource:
    ...
    def update_conversion_source(self,
        ...
        Args:
            request (Union[google.shopping.merchant_conversions_v1.types.UpdateConversionSourceRequest, dict]):
                The request object. Request message for the
    ...
    def delete_conversion_source(self,
        ...
        Args:
            request (Union[google.shopping.merchant_conversions_v1.types.DeleteConversionSourceRequest, dict]):
                The request object. Request message for the
    ...
    def undelete_conversion_source(self,
        ...
        Args:
            request (Union[google.shopping.merchant_conversions_v1.types.UndeleteConversionSourceRequest, dict]):
                The request object. Request message for the
    ...
    def get_conversion_source(self,
        ...
        Args:
            request (Union[google.shopping.merchant_conversions_v1.types.GetConversionSourceRequest, dict]):
                The request object. Request message for the
    ...
    def list_conversion_sources(self,
        ...
        Args:
            request (Union[google.shopping.merchant_conversions_v1.types.ListConversionSourcesRequest, dict]):
                The request object. Request message for the
                ListConversionSources method.
            parent (str):
                Required. The merchant account who owns the collection
                of conversion sources. Format: ``accounts/{account}``
        ...
        Returns:
            google.shopping.merchant_conversions_v1.services.conversion_sources_service.pagers.ListConversionSourcesPager:

...
from google.shopping.merchant_conversions_v1beta.services.conversion_sources_service import ConversionSourcesServiceAsyncClient
from google.shopping.merchant_conversions_v1beta.services.conversion_sources_service import ConversionSourcesServiceClient
from google.shopping.merchant_conversions_v1beta.services.conversion_sources_service import pagers
from google.shopping.merchant_conversions_v1beta.services.conversion_sources_service import transports
...
def test_conversion_sources_service_client_client_options_from_dict():
    with mock.patch('google.shopping.merchant_conversions_v1beta.services.conversion_sources_service.transports.ConversionSourcesServiceGrpcTransport.__init__') as grpc_transport:
...
async def test_create_conversion_source_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_conversion_source] = mock_object
...
async def test_update_conversion_source_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_conversion_source] = mock_object
...
async def test_delete_conversion_source_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_conversion_source] = mock_object
...
async def test_undelete_conversion_source_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.undelete_conversion_source] = mock_object
...
async def test_get_conversion_source_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_conversion_source] = mock_object
...
async def test_list_conversion_sources_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_conversion_sources] = mock_object
...
def test_create_conversion_source_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = conversionsources.ConversionSource.to_json(conversionsources.ConversionSource())
...
def test_create_conversion_source_rest_bad_request(transport: str = 'rest', request_type=conversionsources.CreateConversionSourceRequest):
    client = ConversionSourcesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_conversion_source_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("conversionSource", "updateMask", )))
...
def test_update_conversion_source_rest_bad_request(transport: str = 'rest', request_type=conversionsources.UpdateConversionSourceRequest):
    client = ConversionSourcesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_conversion_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/conversions/v1beta/{conversion_source.name=accounts/*/conversionSources/*}" % client.transport._host, args[1])
...
def test_delete_conversion_source_rest_bad_request(transport: str = 'rest', request_type=conversionsources.DeleteConversionSourceRequest):
    client = ConversionSourcesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_undelete_conversion_source_rest_bad_request(transport: str = 'rest', request_type=conversionsources.UndeleteConversionSourceRequest):
    client = ConversionSourcesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_conversion_source_rest_bad_request(transport: str = 'rest', request_type=conversionsources.GetConversionSourceRequest):
    client = ConversionSourcesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_conversion_sources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = conversionsources.ListConversionSourcesResponse.to_json(conversionsources.ListConversionSourcesResponse())
...
def test_list_conversion_sources_rest_bad_request(transport: str = 'rest', request_type=conversionsources.ListConversionSourcesRequest):
    client = ConversionSourcesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_conversion_sources_service_base_transport():
    ...
    with mock.patch('google.shopping.merchant_conversions_v1beta.services.conversion_sources_service.transports.ConversionSourcesServiceTransport.__init__') as Transport:
...
def test_conversion_sources_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.shopping.merchant_conversions_v1beta.services.conversion_sources_service.transports.ConversionSourcesServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_conversion_sources_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.shopping.merchant_conversions_v1beta.services.conversion_sources_service.transports.ConversionSourcesServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ConversionSourcesServiceTransport()
        adc.assert_called_once()

...
class ConversionSourcesServiceGrpcAsyncIOTransport(ConversionSourcesServiceTransport):
    """gRPC AsyncIO backend transport for ConversionSourcesService.
    ...
    def list_conversion_sources(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListConversionSourcesRequest],
                    Awaitable[~.ListConversionSourcesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_conversion_source: self._wrap_method(
                self.create_conversion_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_conversion_source: self._wrap_method(
                self.update_conversion_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_conversion_source: self._wrap_method(
                self.delete_conversion_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.undelete_conversion_source: self._wrap_method(
                self.undelete_conversion_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_conversion_source: self._wrap_method(
                self.get_conversion_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_conversion_sources: self._wrap_method(

...
from google.shopping.merchant_conversions_v1beta.services.conversion_sources_service import pagers
from google.shopping.merchant_conversions_v1beta.types import conversionsources
from .transports.base import ConversionSourcesServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import ConversionSourcesServiceGrpcTransport
from .transports.grpc_asyncio import ConversionSourcesServiceGrpcAsyncIOTransport
from .transports.rest import ConversionSourcesServiceRestTransport


class ConversionSourcesServiceClientMeta(type):
    """Metaclass for the ConversionSourcesService client.
...
class ConversionSourcesServiceClient(metaclass=ConversionSourcesServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ConversionSourcesServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ConversionSourcesServiceTransport:
        ...
        Returns:
            ConversionSourcesServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def conversion_source_path(account: str,conversion_source: str,) -> str:
        """Returns a fully-qualified conversion_source string."""
        return "accounts/{account}/conversionSources/{conversion_source}".format(account=account, conversion_source=conversion_source, )

    @staticmethod
    def parse_conversion_source_path(path: str) -> Dict[str,str]:
        """Parses a conversion_source path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/conversionSources/(?P<conversion_source>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ConversionSourcesServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ConversionSourcesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ConversionSourcesServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ConversionSourcesServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ConversionSourcesServiceTransport, Callable[..., ConversionSourcesServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ConversionSourcesServiceClient._read_environment_variables()
        self._client_cert_source = ConversionSourcesServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ConversionSourcesServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ConversionSourcesServiceTransport)
        if transport_provided:
            # transport is a ConversionSourcesServiceTransport instance.
            ...
            self._transport = cast(ConversionSourcesServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ConversionSourcesServiceTransport], Callable[..., ConversionSourcesServiceTransport]] = (
                ConversionSourcesServiceClient.get_transport_class(transport)
    ...
    def create_conversion_source(self,
        ...
        .. code-block:: python
            ...
            def sample_create_conversion_source():
                # Create a client
        ...
        Args:
            request (Union[google.shopping.merchant_conversions_v1beta.types.CreateConversionSourceRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_conversion_source]
    ...
    def update_conversion_source(self,
        ...
        .. code-block:: python
            ...
            def sample_update_conversion_source():
                # Create a client
                client = merchant_conversions_v1beta.ConversionSourcesServiceClient()
                ...
                # Make the request
                response = client.update_conversion_source(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.shopping.merchant_conversions_v1beta.types.UpdateConversionSourceRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_conversion_source]
    ...
    def delete_conversion_source(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_conversion_source():
                # Create a client
                client = merchant_conversions_v1beta.ConversionSourcesServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_conversions_v1beta.types.DeleteConversionSourceRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_conversion_source]
    ...
    def undelete_conversion_source(self,
        ...
        Args:
            request (Union[google.shopping.merchant_conversions_v1beta.types.UndeleteConversionSourceRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.undelete_conversion_source]
    ...
    def get_conversion_source(self,
        ...
        .. code-block:: python
            ...
            def sample_get_conversion_source():
                # Create a client
                client = merchant_conversions_v1beta.ConversionSourcesServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_conversions_v1beta.types.GetConversionSourceRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_conversion_source]
    ...
    def list_conversion_sources(self,
        ...
        Args:
            request (Union[google.shopping.merchant_conversions_v1beta.types.ListConversionSourcesRequest, dict]):
                The request object. Request message for the
        ...
        Returns:
            google.shopping.merchant_conversions_v1beta.services.conversion_sources_service.pagers.ListConversionSourcesPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_conversion_sources]
        ...
        response = pagers.ListConversionSourcesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "ConversionSourcesServiceClient":
        return self

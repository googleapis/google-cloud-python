...
class ConversionSourcesServiceAsyncClient:
    ...
    get_transport_class = ConversionSourcesServiceClient.get_transport_class
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.shopping.merchant.conversions_v1beta.ConversionSourcesServiceAsyncClient`.",
                extra = {
    ...
    async def create_conversion_source(self,
    ...
    async def update_conversion_source(self,
    ...
    async def delete_conversion_source(self,
    ...
    async def undelete_conversion_source(self,
    ...
    async def get_conversion_source(self,
    ...
    async def list_conversion_sources(self,

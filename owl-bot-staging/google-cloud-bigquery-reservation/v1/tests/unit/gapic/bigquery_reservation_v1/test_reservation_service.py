...
def test__get_api_endpoint():
    ...
    assert ReservationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ReservationServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_failover_reservation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.failover_reservation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = reservation.Reservation(
            name='name_value',
...
def test_create_reservation_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_reservation_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_reservation_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_reservation_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = reservation.ReservationGroup(
            name='name_value',
...
def test_delete_reservation_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_reservation_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_list_reservation_groups_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, reservation.ReservationGroup)
                   for i in results)
...
async def test_list_reservation_groups_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_reservation_groups(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_failover_reservation_rest_required_fields(request_type=reservation.FailoverReservationRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).failover_reservation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_reservation_group_rest_required_fields(request_type=reservation.CreateReservationGroupRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_reservation_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_reservation_group_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("reservationGroupId", )) & set(("parent", "reservationGroupId", "reservationGroup", )))
...
def test_get_reservation_group_rest_required_fields(request_type=reservation.GetReservationGroupRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_reservation_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_reservation_group_rest_required_fields(request_type=reservation.DeleteReservationGroupRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_reservation_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_reservation_groups_rest_required_fields(request_type=reservation.ListReservationGroupsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_reservation_groups._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_reservation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_create_reservation_with_metadata") as post_with_metadata, \
...
def test_list_reservations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_list_reservations_with_metadata") as post_with_metadata, \
...
def test_get_reservation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_get_reservation_with_metadata") as post_with_metadata, \
...
def test_update_reservation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_update_reservation_with_metadata") as post_with_metadata, \
...
def test_failover_reservation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_failover_reservation") as post, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_failover_reservation_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "pre_failover_reservation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.failover_reservation(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_capacity_commitment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_create_capacity_commitment_with_metadata") as post_with_metadata, \
...
def test_list_capacity_commitments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_list_capacity_commitments_with_metadata") as post_with_metadata, \
...
def test_get_capacity_commitment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_get_capacity_commitment_with_metadata") as post_with_metadata, \
...
def test_update_capacity_commitment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_update_capacity_commitment_with_metadata") as post_with_metadata, \
...
def test_split_capacity_commitment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_split_capacity_commitment_with_metadata") as post_with_metadata, \
...
def test_merge_capacity_commitments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_merge_capacity_commitments_with_metadata") as post_with_metadata, \
...
def test_create_assignment_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/reservations/sample3'}
    request_init["assignment"] = {'name': 'name_value', 'assignee': 'assignee_value', 'job_type': 1, 'state': 1, 'enable_gemini_in_bigquery': True, 'scheduling_policy': {'concurrency': 1195, 'max_slots': 986}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_assignment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_create_assignment_with_metadata") as post_with_metadata, \
...
def test_list_assignments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_list_assignments_with_metadata") as post_with_metadata, \
...
def test_search_assignments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_search_assignments_with_metadata") as post_with_metadata, \
...
def test_search_all_assignments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_search_all_assignments_with_metadata") as post_with_metadata, \
...
def test_move_assignment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_move_assignment_with_metadata") as post_with_metadata, \
...
def test_update_assignment_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'assignment': {'name': 'projects/sample1/locations/sample2/reservations/sample3/assignments/sample4'}}
    request_init["assignment"] = {'name': 'projects/sample1/locations/sample2/reservations/sample3/assignments/sample4', 'assignee': 'assignee_value', 'job_type': 1, 'state': 1, 'enable_gemini_in_bigquery': True, 'scheduling_policy': {'concurrency': 1195, 'max_slots': 986}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_assignment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_update_assignment_with_metadata") as post_with_metadata, \
...
def test_get_bi_reservation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_get_bi_reservation_with_metadata") as post_with_metadata, \
...
def test_update_bi_reservation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_update_bi_reservation_with_metadata") as post_with_metadata, \
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_reservation_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_create_reservation_group") as post, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_create_reservation_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "pre_create_reservation_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_reservation_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_reservation_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_get_reservation_group") as post, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_get_reservation_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "pre_get_reservation_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_reservation_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_reservation_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "pre_delete_reservation_group") as pre:
        pre.assert_not_called()
        ...
        client.delete_reservation_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_reservation_groups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_list_reservation_groups") as post, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "post_list_reservation_groups_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ReservationServiceRestInterceptor, "pre_list_reservation_groups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_reservation_groups(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_reservation_group_path():
    ...
    expected = "projects/{project}/locations/{location}/reservationGroups/{reservation_group}".format(project=project, location=location, reservation_group=reservation_group, )

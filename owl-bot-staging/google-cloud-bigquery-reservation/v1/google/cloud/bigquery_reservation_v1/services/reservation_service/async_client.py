...
class ReservationServiceAsyncClient:
    ...
    parse_bi_reservation_path = staticmethod(ReservationServiceClient.parse_bi_reservation_path)
    capacity_commitment_path = staticmethod(ReservationServiceClient.capacity_commitment_path)
    ...
    reservation_group_path = staticmethod(ReservationServiceClient.reservation_group_path)
    parse_reservation_group_path = staticmethod(ReservationServiceClient.parse_reservation_group_path)
    ...
    get_transport_class = ReservationServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, ReservationServiceTransport, Callable[..., ReservationServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.bigquery.reservation_v1.ReservationServiceAsyncClient`.",
                extra = {
    ...
    async def create_reservation(self,
            request: Optional[Union[gcbr_reservation.CreateReservationRequest, dict]] = None,
            *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_reservation]
    ...
    async def list_reservations(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_reservations]
    ...
    async def get_reservation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_reservation]
    ...
    async def delete_reservation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_reservation]
    ...
    async def update_reservation(self,
            request: Optional[Union[gcbr_reservation.UpdateReservationRequest, dict]] = None,
            *,
            reservation: Optional[gcbr_reservation.Reservation] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [reservation, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_reservation]
    ...
    async def failover_reservation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.failover_reservation]
    ...
    async def create_capacity_commitment(self,
            request: Optional[Union[reservation.CreateCapacityCommitmentRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, capacity_commitment]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_capacity_commitment]
    ...
    async def list_capacity_commitments(self,
            request: Optional[Union[reservation.ListCapacityCommitmentsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_capacity_commitments]
    ...
    async def get_capacity_commitment(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_capacity_commitment]
    ...
    async def delete_capacity_commitment(self,
            request: Optional[Union[reservation.DeleteCapacityCommitmentRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_capacity_commitment]
    ...
    async def update_capacity_commitment(self,
            request: Optional[Union[reservation.UpdateCapacityCommitmentRequest, dict]] = None,
            *,
            capacity_commitment: Optional[reservation.CapacityCommitment] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [capacity_commitment, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_capacity_commitment]
    ...
    async def split_capacity_commitment(self,
            request: Optional[Union[reservation.SplitCapacityCommitmentRequest, dict]] = None,
            *,
            name: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [name, slot_count]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.split_capacity_commitment]
    ...
    async def merge_capacity_commitments(self,
            request: Optional[Union[reservation.MergeCapacityCommitmentsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, capacity_commitment_ids]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.merge_capacity_commitments]
    ...
    async def create_assignment(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_assignment]
    ...
    async def list_assignments(self,
        ...
        **Note** "-" cannot be used for projects nor locations.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_assignments]
    ...
    async def delete_assignment(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_assignment]
    ...
    async def search_assignments(self,
        ...
        **Note** "-" cannot be used for projects nor locations.
        ...
        """
        warnings.warn("ReservationServiceAsyncClient.search_assignments is deprecated",
            DeprecationWarning)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_assignments]
    ...
    async def search_all_assignments(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_all_assignments]
    ...
    async def move_assignment(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [name, destination_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.move_assignment]
    ...
    async def update_assignment(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [assignment, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_assignment]
    ...
    async def get_bi_reservation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_bi_reservation]
    ...
    async def update_bi_reservation(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [bi_reservation, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_bi_reservation]
    ...
    async def get_iam_policy(self,
        ...
        r"""Gets the access control policy for a resource. May return:
    ...
    async def test_iam_permissions(self,
        ...
        r"""Gets your permissions on a resource. Returns an empty
    ...
    async def create_reservation_group(self,
            request: Optional[Union[reservation.CreateReservationGroupRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> reservation.ReservationGroup:
        r"""Creates a new reservation group.
        ...
        .. code-block:: python
            ...
            async def sample_create_reservation_group():
                # Create a client
                client = bigquery_reservation_v1.ReservationServiceAsyncClient()
                ...
                # Make the request
                response = await client.create_reservation_group(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.bigquery_reservation_v1.types.CreateReservationGroupRequest, dict]]):
                The request object. The request for
        ...
        Returns:
            google.cloud.bigquery_reservation_v1.types.ReservationGroup:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, reservation.CreateReservationGroupRequest):
            request = reservation.CreateReservationGroupRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_reservation_group]
    ...
    async def get_reservation_group(self,
            request: Optional[Union[reservation.GetReservationGroupRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Returns information about the reservation group.
        ...
        .. code-block:: python
            ...
            async def sample_get_reservation_group():
                # Create a client
                client = bigquery_reservation_v1.ReservationServiceAsyncClient()
                ...
                # Make the request
                response = await client.get_reservation_group(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.bigquery_reservation_v1.types.GetReservationGroupRequest, dict]]):
                The request object. The request for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, reservation.GetReservationGroupRequest):
            request = reservation.GetReservationGroupRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_reservation_group]
    ...
    async def delete_reservation_group(self,
            request: Optional[Union[reservation.DeleteReservationGroupRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_reservation_group():
                # Create a client
                client = bigquery_reservation_v1.ReservationServiceAsyncClient()

                # Initialize request argument(s)
                request = bigquery_reservation_v1.DeleteReservationGroupRequest(
                    name="name_value",
                )

                # Make the request
                await client.delete_reservation_group(request=request)

        Args:
            request (Optional[Union[google.cloud.bigquery_reservation_v1.types.DeleteReservationGroupRequest, dict]]):
                The request object. The request for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, reservation.DeleteReservationGroupRequest):
            request = reservation.DeleteReservationGroupRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_reservation_group]
    ...
    async def list_reservation_groups(self,
            request: Optional[Union[reservation.ListReservationGroupsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListReservationGroupsAsyncPager:
        r"""Lists all the reservation groups for the project in
        ...
        .. code-block:: python
            ...
            async def sample_list_reservation_groups():
                # Create a client
                client = bigquery_reservation_v1.ReservationServiceAsyncClient()

                # Initialize request argument(s)
                request = bigquery_reservation_v1.ListReservationGroupsRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_reservation_groups(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_reservation_v1.types.ListReservationGroupsRequest, dict]]):
                The request object. The request for
        ...
        Returns:
            google.cloud.bigquery_reservation_v1.services.reservation_service.pagers.ListReservationGroupsAsyncPager:
                The response for
                   [ReservationService.ListReservationGroups][google.cloud.bigquery.reservation.v1.ReservationService.ListReservationGroups].
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, reservation.ListReservationGroupsRequest):
            request = reservation.ListReservationGroupsRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_reservation_groups]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListReservationGroupsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,

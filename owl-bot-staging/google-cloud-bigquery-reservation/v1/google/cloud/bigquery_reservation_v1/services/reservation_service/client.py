...
class ReservationServiceClient(metaclass=ReservationServiceClientMeta):
    ...
    @staticmethod
    def reservation_group_path(project: str,location: str,reservation_group: str,) -> str:
        """Returns a fully-qualified reservation_group string."""
        return "projects/{project}/locations/{location}/reservationGroups/{reservation_group}".format(project=project, location=location, reservation_group=reservation_group, )

    @staticmethod
    def parse_reservation_group_path(path: str) -> Dict[str,str]:
        """Parses a reservation_group path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/reservationGroups/(?P<reservation_group>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ReservationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ReservationServiceTransport, Callable[..., ReservationServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ReservationServiceClient._read_environment_variables()
        self._client_cert_source = ReservationServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ReservationServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ReservationServiceTransport], Callable[..., ReservationServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.bigquery.reservation_v1.ReservationServiceClient`.",
                    extra = {
    ...
    def search_assignments(self,
        ...
        **Note** "-" cannot be used for projects nor locations.
        ...
        """
        warnings.warn("ReservationServiceClient.search_assignments is deprecated",
            DeprecationWarning)
    ...
    def create_reservation_group(self,
        ...
        .. code-block:: python
            ...
            def sample_create_reservation_group():
                # Create a client
                client = bigquery_reservation_v1.ReservationServiceClient()
        ...
        Args:
            request (Union[google.cloud.bigquery_reservation_v1.types.CreateReservationGroupRequest, dict]):
                The request object. The request for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_reservation_group]
    ...
    def get_reservation_group(self,
        ...
        Args:
            request (Union[google.cloud.bigquery_reservation_v1.types.GetReservationGroupRequest, dict]):
                The request object. The request for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_reservation_group]
    ...
    def delete_reservation_group(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_reservation_group():
                # Create a client
                client = bigquery_reservation_v1.ReservationServiceClient()
        ...
        Args:
            request (Union[google.cloud.bigquery_reservation_v1.types.DeleteReservationGroupRequest, dict]):
                The request object. The request for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_reservation_group]
    ...
    def list_reservation_groups(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListReservationGroupsPager:
        ...
        .. code-block:: python
            ...
            def sample_list_reservation_groups():
                # Create a client
                client = bigquery_reservation_v1.ReservationServiceClient()
        ...
        Args:
            request (Union[google.cloud.bigquery_reservation_v1.types.ListReservationGroupsRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.bigquery_reservation_v1.services.reservation_service.pagers.ListReservationGroupsPager:
                The response for
                   [ReservationService.ListReservationGroups][google.cloud.bigquery.reservation.v1.ReservationService.ListReservationGroups].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_reservation_groups]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListReservationGroupsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,

...
class RecommenderGrpcAsyncIOTransport(RecommenderTransport):
    ...
    @property
    def get_recommender_config(self) -> Callable[
    ...
    @property
    def update_recommender_config(self) -> Callable[
    ...
    @property
    def get_insight_type_config(self) -> Callable[
    ...
    @property
    def update_insight_type_config(self) -> Callable[
    ...
    @property
    def list_recommenders(self) -> Callable[
    ...
    @property
    def list_insight_types(self) -> Callable[

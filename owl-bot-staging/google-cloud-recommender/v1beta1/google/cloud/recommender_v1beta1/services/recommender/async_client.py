...
class RecommenderAsyncClient:
    ...
    get_transport_class = functools.partial(type(RecommenderClient).get_transport_class, type(RecommenderClient))
    ...
    async def mark_insight_accepted(self,
    ...
    async def mark_recommendation_claimed(self,
    ...
    async def mark_recommendation_succeeded(self,
    ...
    async def mark_recommendation_failed(self,
    ...
    async def get_recommender_config(self,
    ...
    async def update_recommender_config(self,
    ...
    async def get_insight_type_config(self,
    ...
    async def update_insight_type_config(self,
    ...
    async def list_recommenders(self,
            request: Optional[Union[recommender_service.ListRecommendersRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_recommenders]
    ...
    async def list_insight_types(self,
            request: Optional[Union[recommender_service.ListInsightTypesRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_insight_types]

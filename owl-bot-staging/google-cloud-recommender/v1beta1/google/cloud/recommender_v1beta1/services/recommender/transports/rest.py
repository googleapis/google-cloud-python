...
class RecommenderRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_list_insight_types(self, request: recommender_service.ListInsightTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[recommender_service.ListInsightTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_insight_types_with_metadata(self, response: recommender_service.ListInsightTypesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[recommender_service.ListInsightTypesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_insight_types
    ...
    def pre_list_recommenders(self, request: recommender_service.ListRecommendersRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[recommender_service.ListRecommendersRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_recommenders_with_metadata(self, response: recommender_service.ListRecommendersResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[recommender_service.ListRecommendersResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_recommenders
...
class RecommenderRestTransport(_BaseRecommenderRestTransport):
    ...
    class _ListInsightTypes(_BaseRecommenderRestTransport._BaseListInsightTypes, RecommenderRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RecommenderRestTransport._ListInsightTypes._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListRecommenders(_BaseRecommenderRestTransport._BaseListRecommenders, RecommenderRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RecommenderRestTransport._ListRecommenders._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

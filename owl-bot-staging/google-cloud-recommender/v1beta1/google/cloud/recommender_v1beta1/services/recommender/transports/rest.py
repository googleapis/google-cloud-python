...
class RecommenderRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_list_insight_types(self, request: recommender_service.ListInsightTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[recommender_service.ListInsightTypesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_recommenders(self, request: recommender_service.ListRecommendersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[recommender_service.ListRecommendersRequest, Sequence[Tuple[str, str]]]:

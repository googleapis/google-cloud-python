...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert RecommenderClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert RecommenderClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert RecommenderClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RecommenderClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert RecommenderClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RecommenderClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(RecommenderClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RecommenderClient))
@mock.patch.object(RecommenderAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RecommenderAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RecommenderClient._DEFAULT_UNIVERSE
    default_endpoint = RecommenderClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RecommenderClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RecommenderClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert RecommenderClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RecommenderClient.DEFAULT_MTLS_ENDPOINT
    assert RecommenderClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RecommenderClient._get_api_endpoint(None, None, default_universe, "always") == RecommenderClient.DEFAULT_MTLS_ENDPOINT
    assert RecommenderClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RecommenderClient.DEFAULT_MTLS_ENDPOINT
    assert RecommenderClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RecommenderClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RecommenderClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RecommenderClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RecommenderClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert RecommenderClient._get_universe_domain(None, None) == RecommenderClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class", [
    RecommenderClient, RecommenderAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (RecommenderAsyncClient, transports.RecommenderGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (RecommenderClient, transports.RecommenderRestTransport, "rest", None),
])
def test_recommender_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_recommender_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_list_insights_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_insights in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_insights] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_insight_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_insight in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_insight] = mock_rpc
...
def test_mark_insight_accepted_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.mark_insight_accepted in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.mark_insight_accepted] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_mark_insight_accepted_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.mark_insight_accepted in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.mark_insight_accepted] = mock_rpc
...
def test_list_recommendations_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_recommendations in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_recommendations] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_recommendations_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_recommendations in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_recommendations] = mock_rpc
...
def test_get_recommendation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_recommendation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_recommendation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_recommendation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_recommendation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_recommendation] = mock_rpc
...
def test_mark_recommendation_claimed_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.mark_recommendation_claimed in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.mark_recommendation_claimed] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_mark_recommendation_claimed_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.mark_recommendation_claimed in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.mark_recommendation_claimed] = mock_rpc
...
def test_mark_recommendation_succeeded_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.mark_recommendation_succeeded in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.mark_recommendation_succeeded] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_mark_recommendation_succeeded_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.mark_recommendation_succeeded in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.mark_recommendation_succeeded] = mock_rpc
...
def test_mark_recommendation_failed_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.mark_recommendation_failed in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.mark_recommendation_failed] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_mark_recommendation_failed_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.mark_recommendation_failed in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.mark_recommendation_failed] = mock_rpc
...
def test_get_recommender_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_recommender_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_recommender_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_recommender_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_recommender_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_recommender_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_recommender_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_recommender_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_recommender_config_async(transport: str = 'grpc_asyncio', request_type=recommender_service.GetRecommenderConfigRequest):
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(recommender_config.RecommenderConfig(
            name='name_value',
            etag='etag_value',
            revision_id='revision_id_value',
            display_name='display_name_value',
...
def test_update_recommender_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_recommender_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_recommender_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_recommender_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_recommender_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_recommender_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_recommender_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_recommender_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_recommender_config_async(transport: str = 'grpc_asyncio', request_type=recommender_service.UpdateRecommenderConfigRequest):
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gcr_recommender_config.RecommenderConfig(
            name='name_value',
            etag='etag_value',
            revision_id='revision_id_value',
            display_name='display_name_value',
...
def test_update_recommender_config_flattened():
    ...
    with mock.patch.object(
        ...
        client.update_recommender_config(
            recommender_config=gcr_recommender_config.RecommenderConfig(name='name_value'),
...
def test_get_insight_type_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_insight_type_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_insight_type_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_insight_type_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_insight_type_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_insight_type_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_insight_type_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_insight_type_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_insight_type_config_async(transport: str = 'grpc_asyncio', request_type=recommender_service.GetInsightTypeConfigRequest):
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(insight_type_config.InsightTypeConfig(
            name='name_value',
            etag='etag_value',
            revision_id='revision_id_value',
            display_name='display_name_value',
...
def test_update_insight_type_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_insight_type_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_insight_type_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_insight_type_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_insight_type_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_insight_type_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_insight_type_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_insight_type_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_insight_type_config_async(transport: str = 'grpc_asyncio', request_type=recommender_service.UpdateInsightTypeConfigRequest):
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gcr_insight_type_config.InsightTypeConfig(
            name='name_value',
            etag='etag_value',
            revision_id='revision_id_value',
            display_name='display_name_value',
...
def test_update_insight_type_config_flattened():
    ...
    with mock.patch.object(
        ...
        client.update_insight_type_config(
            insight_type_config=gcr_insight_type_config.InsightTypeConfig(name='name_value'),
            update_mask=field_mask_pb2.FieldMask(paths=['paths_value']),
        )
...
def test_list_recommenders_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_recommenders in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_recommenders] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_recommenders_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_recommenders in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_recommenders] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_recommenders_async(transport: str = 'grpc_asyncio', request_type=recommender_service.ListRecommendersRequest):
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(recommender_service.ListRecommendersResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_recommenders_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        retry = retries.Retry()
        timeout = 5
        pager = client.list_recommenders(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, recommendation.RecommenderType)
                   for i in results)
...
async def test_list_recommenders_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_recommenders(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_insight_types_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_insight_types_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_insight_types in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_insight_types] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_insight_types_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_insight_types in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_insight_types] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_insight_types_async(transport: str = 'grpc_asyncio', request_type=recommender_service.ListInsightTypesRequest):
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(recommender_service.ListInsightTypesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_insight_types_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        retry = retries.Retry()
        timeout = 5
        pager = client.list_insight_types(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, insight.InsightType)
                   for i in results)
...
async def test_list_insight_types_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_insight_types(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_insights_rest_required_fields(request_type=recommender_service.ListInsightsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_insights._get_unset_required_fields(jsonified_request)
...
def test_list_insights_rest_unset_required_fields():
    transport = transports.RecommenderRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_insights_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'parent': 'projects/sample1/locations/sample2/insightTypes/sample3'}
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/insightTypes/*}/insights" % client.transport._host, args[1])
...
def test_list_insights_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(recommender_service.ListInsightsResponse.to_json(x) for x in response)
...
def test_get_insight_rest_required_fields(request_type=recommender_service.GetInsightRequest):
    transport_class = transports.RecommenderRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_insight._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_insight_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/insightTypes/sample3/insights/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/insightTypes/*/insights/*}" % client.transport._host, args[1])
...
def test_mark_insight_accepted_rest_required_fields(request_type=recommender_service.MarkInsightAcceptedRequest):
    transport_class = transports.RecommenderRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).mark_insight_accepted._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_mark_insight_accepted_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "etag", )))
...
def test_mark_insight_accepted_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/insightTypes/*/insights/*}:markAccepted" % client.transport._host, args[1])
...
def test_list_recommendations_rest_required_fields(request_type=recommender_service.ListRecommendationsRequest):
    transport_class = transports.RecommenderRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_recommendations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_recommendations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/recommenders/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/recommenders/*}/recommendations" % client.transport._host, args[1])
...
def test_list_recommendations_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(recommender_service.ListRecommendationsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_recommendation_rest_required_fields(request_type=recommender_service.GetRecommendationRequest):
    transport_class = transports.RecommenderRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_recommendation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_recommendation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/recommenders/sample3/recommendations/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/recommenders/*/recommendations/*}" % client.transport._host, args[1])
...
def test_mark_recommendation_claimed_rest_required_fields(request_type=recommender_service.MarkRecommendationClaimedRequest):
    transport_class = transports.RecommenderRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).mark_recommendation_claimed._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_mark_recommendation_claimed_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/recommenders/*/recommendations/*}:markClaimed" % client.transport._host, args[1])
...
def test_mark_recommendation_succeeded_rest_required_fields(request_type=recommender_service.MarkRecommendationSucceededRequest):
    transport_class = transports.RecommenderRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).mark_recommendation_succeeded._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_mark_recommendation_succeeded_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/recommenders/*/recommendations/*}:markSucceeded" % client.transport._host, args[1])
...
def test_mark_recommendation_failed_rest_required_fields(request_type=recommender_service.MarkRecommendationFailedRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).mark_recommendation_failed._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_mark_recommendation_failed_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/recommenders/*/recommendations/*}:markFailed" % client.transport._host, args[1])
...
def test_get_recommender_config_rest_required_fields(request_type=recommender_service.GetRecommenderConfigRequest):
    transport_class = transports.RecommenderRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_recommender_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_recommender_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/recommenders/sample3/config'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/recommenders/*/config}" % client.transport._host, args[1])
...
def test_update_recommender_config_rest_required_fields(request_type=recommender_service.UpdateRecommenderConfigRequest):
    transport_class = transports.RecommenderRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_recommender_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_recommender_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("recommenderConfig", )))
...
def test_update_recommender_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'recommender_config': {'name': 'projects/sample1/locations/sample2/recommenders/sample3/config'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{recommender_config.name=projects/*/locations/*/recommenders/*/config}" % client.transport._host, args[1])
...
def test_get_insight_type_config_rest_required_fields(request_type=recommender_service.GetInsightTypeConfigRequest):
    transport_class = transports.RecommenderRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_insight_type_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_insight_type_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/insightTypes/sample3/config'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/insightTypes/*/config}" % client.transport._host, args[1])
...
def test_update_insight_type_config_rest_required_fields(request_type=recommender_service.UpdateInsightTypeConfigRequest):
    transport_class = transports.RecommenderRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_insight_type_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_insight_type_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("insightTypeConfig", )))
...
def test_update_insight_type_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'insight_type_config': {'name': 'projects/sample1/locations/sample2/insightTypes/sample3/config'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{insight_type_config.name=projects/*/locations/*/insightTypes/*/config}" % client.transport._host, args[1])
...
def test_list_recommenders_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RecommenderClient(
...
def test_list_recommenders_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(recommender_service.ListRecommendersResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_list_insight_types_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RecommenderClient(
...
def test_list_insight_types_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(recommender_service.ListInsightTypesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_list_insights_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = recommender_service.ListInsightsResponse()
        client.list_insights(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_insight_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = insight.Insight()
        client.get_insight(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mark_insight_accepted_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = insight.Insight()
        client.mark_insight_accepted(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_recommendations_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = recommender_service.ListRecommendationsResponse()
        client.list_recommendations(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_recommendation_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = recommendation.Recommendation()
        client.get_recommendation(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mark_recommendation_claimed_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = recommendation.Recommendation()
        client.mark_recommendation_claimed(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mark_recommendation_succeeded_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = recommendation.Recommendation()
        client.mark_recommendation_succeeded(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mark_recommendation_failed_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = recommendation.Recommendation()
        client.mark_recommendation_failed(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_recommender_config_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = recommender_config.RecommenderConfig()
        client.get_recommender_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_recommender_config_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = gcr_recommender_config.RecommenderConfig()
        client.update_recommender_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_insight_type_config_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = insight_type_config.InsightTypeConfig()
        client.get_insight_type_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_insight_type_config_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = gcr_insight_type_config.InsightTypeConfig()
        client.update_insight_type_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_recommenders_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = recommender_service.ListRecommendersResponse()
        client.list_recommenders(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_insight_types_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = recommender_service.ListInsightTypesResponse()
        client.list_insight_types(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = RecommenderAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_insights_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_insights(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_insight_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_insight(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_mark_insight_accepted_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.mark_insight_accepted(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_recommendations_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_recommendations(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_recommendation_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_mark_recommendation_claimed_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_mark_recommendation_succeeded_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_mark_recommendation_failed_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_recommender_config_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_recommender_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_recommender_config_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_recommender_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_insight_type_config_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_insight_type_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_insight_type_config_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_insight_type_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_recommenders_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_recommenders(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_insight_types_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_insight_types(request=None)
...
def test_transport_kind_rest():
    transport = RecommenderClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_insights_rest_bad_request(request_type=recommender_service.ListInsightsRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_insights_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_insights_rest_interceptors(null_interceptor):
    transport = transports.RecommenderRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RecommenderRestInterceptor(),
        )
    client = RecommenderClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_list_insights") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_list_insights_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_list_insights") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.ListInsightsRequest.pb(recommender_service.ListInsightsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = recommender_service.ListInsightsResponse.to_json(recommender_service.ListInsightsResponse())
        ...
        post_with_metadata.return_value = recommender_service.ListInsightsResponse(), metadata

        client.list_insights(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_insight_rest_bad_request(request_type=recommender_service.GetInsightRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/insightTypes/sample3/insights/sample4'}
    request = request_type(**request_init)
...
def test_get_insight_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_insight_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_get_insight") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_get_insight_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_get_insight") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.GetInsightRequest.pb(recommender_service.GetInsightRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_insight(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_mark_insight_accepted_rest_bad_request(request_type=recommender_service.MarkInsightAcceptedRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mark_insight_accepted_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mark_insight_accepted_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_mark_insight_accepted") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_mark_insight_accepted_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_mark_insight_accepted") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.MarkInsightAcceptedRequest.pb(recommender_service.MarkInsightAcceptedRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.mark_insight_accepted(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_recommendations_rest_bad_request(request_type=recommender_service.ListRecommendationsRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_recommendations_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_recommendations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_list_recommendations") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_list_recommendations_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_list_recommendations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.ListRecommendationsRequest.pb(recommender_service.ListRecommendationsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = recommender_service.ListRecommendationsResponse.to_json(recommender_service.ListRecommendationsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = recommender_service.ListRecommendationsResponse(), metadata

        client.list_recommendations(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_recommendation_rest_bad_request(request_type=recommender_service.GetRecommendationRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/recommenders/sample3/recommendations/sample4'}
    request = request_type(**request_init)
...
def test_get_recommendation_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_recommendation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_get_recommendation") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_get_recommendation_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_get_recommendation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.GetRecommendationRequest.pb(recommender_service.GetRecommendationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = recommendation.Recommendation.to_json(recommendation.Recommendation())
        req.return_value.content = return_value
        ...
        client.get_recommendation(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_mark_recommendation_claimed_rest_bad_request(request_type=recommender_service.MarkRecommendationClaimedRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mark_recommendation_claimed_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mark_recommendation_claimed_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_mark_recommendation_claimed") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_mark_recommendation_claimed_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_mark_recommendation_claimed") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.MarkRecommendationClaimedRequest.pb(recommender_service.MarkRecommendationClaimedRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.mark_recommendation_claimed(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_mark_recommendation_succeeded_rest_bad_request(request_type=recommender_service.MarkRecommendationSucceededRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mark_recommendation_succeeded_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mark_recommendation_succeeded_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_mark_recommendation_succeeded") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_mark_recommendation_succeeded_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_mark_recommendation_succeeded") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.MarkRecommendationSucceededRequest.pb(recommender_service.MarkRecommendationSucceededRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.mark_recommendation_succeeded(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_mark_recommendation_failed_rest_bad_request(request_type=recommender_service.MarkRecommendationFailedRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mark_recommendation_failed_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mark_recommendation_failed_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_mark_recommendation_failed") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_mark_recommendation_failed_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_mark_recommendation_failed") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.MarkRecommendationFailedRequest.pb(recommender_service.MarkRecommendationFailedRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.mark_recommendation_failed(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_recommender_config_rest_bad_request(request_type=recommender_service.GetRecommenderConfigRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/recommenders/sample3/config'}
    request = request_type(**request_init)
...
def test_get_recommender_config_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_recommender_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_get_recommender_config") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_get_recommender_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_get_recommender_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.GetRecommenderConfigRequest.pb(recommender_service.GetRecommenderConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = recommender_config.RecommenderConfig.to_json(recommender_config.RecommenderConfig())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = recommender_config.RecommenderConfig(), metadata

        client.get_recommender_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_recommender_config_rest_bad_request(request_type=recommender_service.UpdateRecommenderConfigRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'recommender_config': {'name': 'projects/sample1/locations/sample2/recommenders/sample3/config'}}
    request = request_type(**request_init)
...
def test_update_recommender_config_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'recommender_config': {'name': 'projects/sample1/locations/sample2/recommenders/sample3/config'}}
    request_init["recommender_config"] = {'name': 'projects/sample1/locations/sample2/recommenders/sample3/config', 'recommender_generation_config': {'params': {'fields': {}}}, 'etag': 'etag_value', 'update_time': {'seconds': 751, 'nanos': 543}, 'revision_id': 'revision_id_value', 'annotations': {}, 'display_name': 'display_name_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = recommender_service.UpdateRecommenderConfigRequest.meta.fields["recommender_config"]
...
def test_update_recommender_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_update_recommender_config") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_update_recommender_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_update_recommender_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.UpdateRecommenderConfigRequest.pb(recommender_service.UpdateRecommenderConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcr_recommender_config.RecommenderConfig.to_json(gcr_recommender_config.RecommenderConfig())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcr_recommender_config.RecommenderConfig(), metadata

        client.update_recommender_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_insight_type_config_rest_bad_request(request_type=recommender_service.GetInsightTypeConfigRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/insightTypes/sample3/config'}
    request = request_type(**request_init)
...
def test_get_insight_type_config_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_insight_type_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_get_insight_type_config") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_get_insight_type_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_get_insight_type_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.GetInsightTypeConfigRequest.pb(recommender_service.GetInsightTypeConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = insight_type_config.InsightTypeConfig.to_json(insight_type_config.InsightTypeConfig())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = insight_type_config.InsightTypeConfig(), metadata

        client.get_insight_type_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_insight_type_config_rest_bad_request(request_type=recommender_service.UpdateInsightTypeConfigRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'insight_type_config': {'name': 'projects/sample1/locations/sample2/insightTypes/sample3/config'}}
    request = request_type(**request_init)
...
def test_update_insight_type_config_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'insight_type_config': {'name': 'projects/sample1/locations/sample2/insightTypes/sample3/config'}}
    request_init["insight_type_config"] = {'name': 'projects/sample1/locations/sample2/insightTypes/sample3/config', 'insight_type_generation_config': {'params': {'fields': {}}}, 'etag': 'etag_value', 'update_time': {'seconds': 751, 'nanos': 543}, 'revision_id': 'revision_id_value', 'annotations': {}, 'display_name': 'display_name_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = recommender_service.UpdateInsightTypeConfigRequest.meta.fields["insight_type_config"]
...
def test_update_insight_type_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_update_insight_type_config") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_update_insight_type_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_update_insight_type_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.UpdateInsightTypeConfigRequest.pb(recommender_service.UpdateInsightTypeConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcr_insight_type_config.InsightTypeConfig.to_json(gcr_insight_type_config.InsightTypeConfig())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcr_insight_type_config.InsightTypeConfig(), metadata

        client.update_insight_type_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_recommenders_rest_bad_request(request_type=recommender_service.ListRecommendersRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_recommenders_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_recommenders_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_list_recommenders") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_list_recommenders_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_list_recommenders") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.ListRecommendersRequest.pb(recommender_service.ListRecommendersRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = recommender_service.ListRecommendersResponse.to_json(recommender_service.ListRecommendersResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = recommender_service.ListRecommendersResponse(), metadata

        client.list_recommenders(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_insight_types_rest_bad_request(request_type=recommender_service.ListInsightTypesRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_insight_types_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_insight_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_list_insight_types") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_list_insight_types_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_list_insight_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.ListInsightTypesRequest.pb(recommender_service.ListInsightTypesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = recommender_service.ListInsightTypesResponse.to_json(recommender_service.ListInsightTypesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = recommender_service.ListInsightTypesResponse(), metadata

        client.list_insight_types(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_insights_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_insight_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mark_insight_accepted_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_recommendations_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_recommendation_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mark_recommendation_claimed_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mark_recommendation_succeeded_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mark_recommendation_failed_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_recommender_config_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_recommender_config_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_insight_type_config_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_insight_type_config_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_recommenders_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_insight_types_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_recommender_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.recommender_v1beta1.services.recommender.transports.RecommenderTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_recommender_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.recommender_v1beta1.services.recommender.transports.RecommenderTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RecommenderTransport()
        adc.assert_called_once()
...
def test_insight_type_config_path():
    ...
    location = "octopus"
    insight_type = "oyster"
    expected = "projects/{project}/locations/{location}/insightTypes/{insight_type}/config".format(project=project, location=location, insight_type=insight_type, )
...
def test_recommender_config_path():
    ...
    location = "abalone"
    recommender = "squid"
    expected = "projects/{project}/locations/{location}/recommenders/{recommender}/config".format(project=project, location=location, recommender=recommender, )

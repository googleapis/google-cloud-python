...
def test_mark_recommendation_dismissed_rest_required_fields(request_type=recommender_service.MarkRecommendationDismissedRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).mark_recommendation_dismissed._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
async def test_mark_recommendation_dismissed_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.mark_recommendation_dismissed] = mock_object
...
def test_mark_recommendation_dismissed_rest_bad_request(transport: str = 'rest', request_type=recommender_service.MarkRecommendationDismissedRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

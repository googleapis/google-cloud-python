...
def test_mark_recommendation_dismissed(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.mark_recommendation_dismissed),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = recommendation.Recommendation(
            name='name_value',
...
def test_mark_recommendation_dismissed_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.mark_recommendation_dismissed in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.mark_recommendation_dismissed] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_mark_recommendation_dismissed_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RecommenderAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.mark_recommendation_dismissed in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.mark_recommendation_dismissed] = mock_rpc
...
@pytest.mark.asyncio
async def test_mark_recommendation_dismissed_async(transport: str = 'grpc_asyncio', request_type=recommender_service.MarkRecommendationDismissedRequest):
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_insights_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/insightTypes/*}/insights" % client.transport._host, args[1])
...
def test_get_insight_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/insightTypes/*/insights/*}" % client.transport._host, args[1])
...
def test_mark_insight_accepted_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/insightTypes/*/insights/*}:markAccepted" % client.transport._host, args[1])
...
def test_list_recommendations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/recommenders/*}/recommendations" % client.transport._host, args[1])
...
def test_get_recommendation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/recommenders/*/recommendations/*}" % client.transport._host, args[1])
...
def test_mark_recommendation_dismissed_rest_required_fields(request_type=recommender_service.MarkRecommendationDismissedRequest):
    transport_class = transports.RecommenderRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).mark_recommendation_dismissed._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_mark_recommendation_claimed_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/recommenders/*/recommendations/*}:markClaimed" % client.transport._host, args[1])
...
def test_mark_recommendation_succeeded_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/recommenders/*/recommendations/*}:markSucceeded" % client.transport._host, args[1])
...
def test_mark_recommendation_failed_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/recommenders/*/recommendations/*}:markFailed" % client.transport._host, args[1])
...
def test_get_recommender_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/recommenders/*/config}" % client.transport._host, args[1])
...
def test_update_recommender_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{recommender_config.name=projects/*/locations/*/recommenders/*/config}" % client.transport._host, args[1])
...
def test_get_insight_type_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/insightTypes/*/config}" % client.transport._host, args[1])
...
def test_update_insight_type_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{insight_type_config.name=projects/*/locations/*/insightTypes/*/config}" % client.transport._host, args[1])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mark_recommendation_dismissed_empty_call_grpc():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = recommendation.Recommendation()
        client.mark_recommendation_dismissed(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_mark_recommendation_dismissed_empty_call_grpc_asyncio():
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_mark_recommendation_dismissed_rest_bad_request(request_type=recommender_service.MarkRecommendationDismissedRequest):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mark_recommendation_dismissed_rest_call_success(request_type):
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mark_recommendation_dismissed_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_mark_recommendation_dismissed") as post, \
        mock.patch.object(transports.RecommenderRestInterceptor, "post_mark_recommendation_dismissed_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RecommenderRestInterceptor, "pre_mark_recommendation_dismissed") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommender_service.MarkRecommendationDismissedRequest.pb(recommender_service.MarkRecommendationDismissedRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.mark_recommendation_dismissed(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mark_recommendation_dismissed_empty_call_rest():
    client = RecommenderClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

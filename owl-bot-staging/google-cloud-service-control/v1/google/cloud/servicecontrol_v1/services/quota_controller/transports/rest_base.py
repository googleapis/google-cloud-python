...
class _BaseQuotaControllerRestTransport(QuotaControllerTransport):
    """Base REST backend transport for QuotaController.
...
__all__=(
    '_BaseQuotaControllerRestTransport',
)

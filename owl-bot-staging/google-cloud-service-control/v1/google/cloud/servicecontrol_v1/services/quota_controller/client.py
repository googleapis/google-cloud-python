...
class QuotaControllerClient(metaclass=QuotaControllerClientMeta):
    ...
    def transport(self) -> QuotaControllerTransport:
        ...
        Returns:
            QuotaControllerTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = QuotaControllerClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = QuotaControllerClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = QuotaControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = QuotaControllerClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            QuotaControllerClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, QuotaControllerTransport, Callable[..., QuotaControllerTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,QuotaControllerTransport,Callable[..., QuotaControllerTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the QuotaControllerTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = QuotaControllerClient._read_environment_variables()
        self._client_cert_source = QuotaControllerClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = QuotaControllerClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, QuotaControllerTransport)
        if transport_provided:
            ...
            self._transport = cast(QuotaControllerTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            QuotaControllerClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[QuotaControllerTransport], Callable[..., QuotaControllerTransport]] = (

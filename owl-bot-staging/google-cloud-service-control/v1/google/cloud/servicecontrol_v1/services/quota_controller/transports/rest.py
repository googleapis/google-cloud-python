...
class QuotaControllerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_allocate_quota(self, request: quota_controller.AllocateQuotaRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[quota_controller.AllocateQuotaRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_allocate_quota_with_metadata(self, response: quota_controller.AllocateQuotaResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[quota_controller.AllocateQuotaResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for allocate_quota
...
class QuotaControllerRestTransport(_BaseQuotaControllerRestTransport):
    ...
    class _AllocateQuota(_BaseQuotaControllerRestTransport._BaseAllocateQuota, QuotaControllerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = QuotaControllerRestTransport._AllocateQuota._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class QuotaControllerAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = QuotaControllerClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = QuotaControllerClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, QuotaControllerTransport, Callable[..., QuotaControllerTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.api.servicecontrol_v1.QuotaControllerAsyncClient`.",
                extra = {
    ...
    async def allocate_quota(self,
        ...
        **NOTE:** The client **must** fail-open on server errors
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.allocate_quota]

...
class _BaseServiceControllerRestTransport(ServiceControllerTransport):
    """Base REST backend transport for ServiceController.
    ...
    class _BaseCheck:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/services/{service_name}:check',
                'body': '*',
            },
            ]
            return http_options
    ...
    class _BaseReport:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/services/{service_name}:report',
                'body': '*',
            },
            ]
            return http_options
...
__all__=(
    '_BaseServiceControllerRestTransport',
)

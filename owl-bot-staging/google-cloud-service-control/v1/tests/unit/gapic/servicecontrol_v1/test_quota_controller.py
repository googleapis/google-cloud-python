...
def test__read_environment_variables():
    assert QuotaControllerClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert QuotaControllerClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        with pytest.raises(ValueError) as excinfo:
            QuotaControllerClient._read_environment_variables()
    assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert QuotaControllerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert QuotaControllerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert QuotaControllerClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert QuotaControllerClient._get_client_cert_source(None, False) is None
    assert QuotaControllerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert QuotaControllerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert QuotaControllerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert QuotaControllerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(QuotaControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuotaControllerClient))
@mock.patch.object(QuotaControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuotaControllerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = QuotaControllerClient._DEFAULT_UNIVERSE
    default_endpoint = QuotaControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = QuotaControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert QuotaControllerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert QuotaControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == QuotaControllerClient.DEFAULT_MTLS_ENDPOINT
    assert QuotaControllerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert QuotaControllerClient._get_api_endpoint(None, None, default_universe, "always") == QuotaControllerClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert QuotaControllerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert QuotaControllerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        QuotaControllerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert QuotaControllerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert QuotaControllerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert QuotaControllerClient._get_universe_domain(None, None) == QuotaControllerClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        QuotaControllerClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = QuotaControllerClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_name", [
    (QuotaControllerClient, "grpc"),
    (QuotaControllerAsyncClient, "grpc_asyncio"),
    (QuotaControllerClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    ...
    (transports.QuotaControllerRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (QuotaControllerClient, transports.QuotaControllerRestTransport, "rest"),
])
@mock.patch.object(QuotaControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuotaControllerClient))
@mock.patch.object(QuotaControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuotaControllerAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (QuotaControllerClient, transports.QuotaControllerRestTransport, "rest", "true"),
    (QuotaControllerClient, transports.QuotaControllerRestTransport, "rest", "false"),
])
@mock.patch.object(QuotaControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuotaControllerClient))
@mock.patch.object(QuotaControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuotaControllerAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    QuotaControllerClient, QuotaControllerAsyncClient
])
...
@mock.patch.object(QuotaControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuotaControllerClient))
@mock.patch.object(QuotaControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuotaControllerAsyncClient))
def test_quota_controller_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (QuotaControllerClient, transports.QuotaControllerGrpcTransport, "grpc", grpc_helpers),
    (QuotaControllerAsyncClient, transports.QuotaControllerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (QuotaControllerClient, transports.QuotaControllerRestTransport, "rest", None),
])
...
def test_allocate_quota_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.allocate_quota in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.allocate_quota] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_allocate_quota_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.allocate_quota in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.allocate_quota] = mock_rpc
...
def test_allocate_quota_rest_bad_request(request_type=quota_controller.AllocateQuotaRequest):
    client = QuotaControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_allocate_quota_rest_interceptors(null_interceptor):
    transport = transports.QuotaControllerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.QuotaControllerRestInterceptor(),
        )
    client = QuotaControllerClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.QuotaControllerRestInterceptor, "post_allocate_quota") as post, \
        mock.patch.object(transports.QuotaControllerRestInterceptor, "post_allocate_quota_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.QuotaControllerRestInterceptor, "pre_allocate_quota") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = quota_controller.AllocateQuotaResponse.to_json(quota_controller.AllocateQuotaResponse())
        ...
        post_with_metadata.return_value = quota_controller.AllocateQuotaResponse(), metadata
...
def test_quota_controller_client_transport_session_collision(transport_name):
    ...
    client1 = QuotaControllerClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = QuotaControllerClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("client_class,transport_class", [
    (QuotaControllerClient, transports.QuotaControllerGrpcTransport),
    (QuotaControllerAsyncClient, transports.QuotaControllerGrpcAsyncIOTransport),
])

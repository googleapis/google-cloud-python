...
class ServiceControllerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_check(self, request: service_controller.CheckRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service_controller.CheckRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_check_with_metadata(self, response: service_controller.CheckResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service_controller.CheckResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for check
    ...
    def pre_report(self, request: service_controller.ReportRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service_controller.ReportRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_report_with_metadata(self, response: service_controller.ReportResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service_controller.ReportResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for report
...
class ServiceControllerRestTransport(_BaseServiceControllerRestTransport):
    ...
    class _Check(_BaseServiceControllerRestTransport._BaseCheck, ServiceControllerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ServiceControllerRestTransport._Check._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Report(_BaseServiceControllerRestTransport._BaseReport, ServiceControllerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ServiceControllerRestTransport._Report._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
from .transports.base import InsightsConfigServiceTransport, DEFAULT_CLIENT_INFO
...
class InsightsConfigServiceAsyncClient:
    ...
    _client: InsightsConfigServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = InsightsConfigServiceClient.DEFAULT_ENDPOINT
    ...
    def transport(self) -> InsightsConfigServiceTransport:
        ...
        Returns:
            InsightsConfigServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = InsightsConfigServiceClient.get_transport_class
    ...
    def __init__(self, *,
        ...
        """
        self._client = InsightsConfigServiceClient(
    ...
    async def list_insights_configs(self,
            ...
            *,
            ...
            ) -> pagers.ListInsightsConfigsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.ListInsightsConfigsRequest, dict]]):
        ...
        response = pagers.ListInsightsConfigsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def create_insights_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.CreateInsightsConfigRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            insights_config (:class:`google.cloud.developerconnect_v1.types.InsightsConfig`):
                Required. The resource being created.
                This corresponds to the ``insights_config`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            insights_config_id (:class:`str`):
    ...
    async def get_insights_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.GetInsightsConfigRequest, dict]]):
    ...
    async def update_insights_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.UpdateInsightsConfigRequest, dict]]):
    ...
    async def delete_insights_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.DeleteInsightsConfigRequest, dict]]):
    ...
    async def __aenter__(self) -> "InsightsConfigServiceAsyncClient":
        return self

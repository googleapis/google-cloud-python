...
class DeveloperConnectTransport(abc.ABC):
    ...
    @property
    def create_git_repository_link(self) -> Callable[
    ...
    @property
    def delete_git_repository_link(self) -> Callable[
    ...
    @property
    def list_git_repository_links(self) -> Callable[
    ...
    @property
    def get_git_repository_link(self) -> Callable[
    ...
    @property
    def fetch_linkable_git_repositories(self) -> Callable[
    ...
    @property
    def fetch_git_hub_installations(self) -> Callable[
    ...
    @property
    def list_account_connectors(self) -> Callable[
    ...
    @property
    def get_account_connector(self) -> Callable[
    ...
    @property
    def create_account_connector(self) -> Callable[
    ...
    @property
    def update_account_connector(self) -> Callable[
    ...
    @property
    def delete_account_connector(self) -> Callable[
    ...
    @property
    def fetch_access_token(self) -> Callable[
    ...
    @property
    def fetch_self(self) -> Callable[
            [developer_connect.FetchSelfRequest],
            Union[
                developer_connect.User,
                Awaitable[developer_connect.User]
            ]]:
        raise NotImplementedError()

    @property
    def delete_self(self) -> Callable[

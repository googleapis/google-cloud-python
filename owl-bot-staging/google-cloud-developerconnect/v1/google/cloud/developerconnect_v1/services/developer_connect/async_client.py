...
class DeveloperConnectAsyncClient:
    """Service describing handlers for resources"""

    _client: DeveloperConnectClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = DeveloperConnectClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = DeveloperConnectClient.DEFAULT_MTLS_ENDPOINT
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return DeveloperConnectClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> DeveloperConnectTransport:
        ...
        Returns:
            DeveloperConnectTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = DeveloperConnectClient.get_transport_class
    ...
    def __init__(self, *,
        ...
        """
        self._client = DeveloperConnectClient(
    ...
    async def list_connections(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.ListConnectionsRequest, dict]]):
    ...
    async def get_connection(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.GetConnectionRequest, dict]]):
    ...
    async def create_connection(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.CreateConnectionRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            connection (:class:`google.cloud.developerconnect_v1.types.Connection`):
    ...
    async def update_connection(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.UpdateConnectionRequest, dict]]):
    ...
    async def delete_connection(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.DeleteConnectionRequest, dict]]):
    ...
    async def create_git_repository_link(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.CreateGitRepositoryLinkRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            git_repository_link (:class:`google.cloud.developerconnect_v1.types.GitRepositoryLink`):
                Required. The resource being created
                This corresponds to the ``git_repository_link`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            git_repository_link_id (:class:`str`):
    ...
    async def delete_git_repository_link(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.DeleteGitRepositoryLinkRequest, dict]]):
    ...
    async def list_git_repository_links(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListGitRepositoryLinksAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.ListGitRepositoryLinksRequest, dict]]):
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListGitRepositoryLinksAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_git_repository_link(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.GetGitRepositoryLinkRequest, dict]]):
    ...
    async def fetch_read_write_token(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.FetchReadWriteTokenRequest, dict]]):
                The request object. Message for fetching SCM read/write
                token.
            git_repository_link (:class:`str`):
    ...
    async def fetch_read_token(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.FetchReadTokenRequest, dict]]):
    ...
    async def fetch_linkable_git_repositories(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.FetchLinkableGitRepositoriesAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.FetchLinkableGitRepositoriesRequest, dict]]):
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.FetchLinkableGitRepositoriesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def fetch_git_hub_installations(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.FetchGitHubInstallationsRequest, dict]]):
    ...
    async def fetch_git_refs(self,
        ...
        Args:
            request (Optional[Union[google.cloud.developerconnect_v1.types.FetchGitRefsRequest, dict]]):
            ...
            git_repository_link (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            ref_type (:class:`google.cloud.developerconnect_v1.types.FetchGitRefsRequest.RefType`):
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.FetchGitRefsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def list_account_connectors(self,
    ...
    async def get_account_connector(self,
    ...
    async def create_account_connector(self,
    ...
    async def update_account_connector(self,
    ...
    async def delete_account_connector(self,
    ...
    async def __aenter__(self) -> "DeveloperConnectAsyncClient":
        return self

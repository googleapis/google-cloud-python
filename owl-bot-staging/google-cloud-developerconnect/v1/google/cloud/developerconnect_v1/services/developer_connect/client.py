...
from .transports.base import DeveloperConnectTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import DeveloperConnectGrpcTransport
from .transports.grpc_asyncio import DeveloperConnectGrpcAsyncIOTransport
from .transports.rest import DeveloperConnectRestTransport


class DeveloperConnectClientMeta(type):
    """Metaclass for the DeveloperConnect client.
...
class DeveloperConnectClient(metaclass=DeveloperConnectClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DeveloperConnectClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> DeveloperConnectTransport:
        """Returns the transport used by the client instance.

        Returns:
            DeveloperConnectTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def account_connector_path(project: str,location: str,account_connector: str,) -> str:
        """Returns a fully-qualified account_connector string."""
        return "projects/{project}/locations/{location}/accountConnectors/{account_connector}".format(project=project, location=location, account_connector=account_connector, )

    @staticmethod
    def parse_account_connector_path(path: str) -> Dict[str,str]:
        """Parses a account_connector path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/accountConnectors/(?P<account_connector>.+?)$", path)
    ...
    @staticmethod
    def git_repository_link_path(project: str,location: str,connection: str,git_repository_link: str,) -> str:
        """Returns a fully-qualified git_repository_link string."""
        return "projects/{project}/locations/{location}/connections/{connection}/gitRepositoryLinks/{git_repository_link}".format(project=project, location=location, connection=connection, git_repository_link=git_repository_link, )

    @staticmethod
    def parse_git_repository_link_path(path: str) -> Dict[str,str]:
        """Parses a git_repository_link path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/connections/(?P<connection>.+?)/gitRepositoryLinks/(?P<git_repository_link>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def user_path(project: str,location: str,account_connector: str,user: str,) -> str:
        """Returns a fully-qualified user string."""
        return "projects/{project}/locations/{location}/accountConnectors/{account_connector}/users/{user}".format(project=project, location=location, account_connector=account_connector, user=user, )

    @staticmethod
    def parse_user_path(path: str) -> Dict[str,str]:
        """Parses a user path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/accountConnectors/(?P<account_connector>.+?)/users/(?P<user>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DeveloperConnectClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DeveloperConnectClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = DeveloperConnectClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DeveloperConnectTransport, Callable[..., DeveloperConnectTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the developer connect client.
        ...
        Args:
            ...
            transport (Optional[Union[str,DeveloperConnectTransport,Callable[..., DeveloperConnectTransport]]]):
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DeveloperConnectClient._read_environment_variables()
        self._client_cert_source = DeveloperConnectClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DeveloperConnectClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DeveloperConnectTransport)
        if transport_provided:
            # transport is a DeveloperConnectTransport instance.
            ...
            self._transport = cast(DeveloperConnectTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DeveloperConnectTransport], Callable[..., DeveloperConnectTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.developerconnect_v1.DeveloperConnectClient`.",
                    extra = {
    ...
    def list_connections(self,
            request: Optional[Union[developer_connect.ListConnectionsRequest, dict]] = None,
            *,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.ListConnectionsRequest, dict]):
        ...
        if not isinstance(request, developer_connect.ListConnectionsRequest):
            request = developer_connect.ListConnectionsRequest(request)
    ...
    def get_connection(self,
            request: Optional[Union[developer_connect.GetConnectionRequest, dict]] = None,
            *,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.GetConnectionRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.GetConnectionRequest):
            request = developer_connect.GetConnectionRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
    ...
    def create_connection(self,
        ...
        r"""Creates a new Connection in a given project and
        location.
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.CreateConnectionRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.developerconnect_v1.types.Connection`
                Message describing Connection object
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.CreateConnectionRequest):
            request = developer_connect.CreateConnectionRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
    ...
    def update_connection(self,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.UpdateConnectionRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.UpdateConnectionRequest):
            request = developer_connect.UpdateConnectionRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if connection is not None:
                request.connection = connection
    ...
    def delete_connection(self,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.DeleteConnectionRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.DeleteConnectionRequest):
            request = developer_connect.DeleteConnectionRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
    ...
    def create_git_repository_link(self,
        ...
        r"""Creates a GitRepositoryLink. Upon linking a Git
        ...
        .. code-block:: python
            ...
            def sample_create_git_repository_link():
                # Create a client
                client = developerconnect_v1.DeveloperConnectClient()
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.CreateGitRepositoryLinkRequest, dict]):
            ...
            git_repository_link (google.cloud.developerconnect_v1.types.GitRepositoryLink):
                Required. The resource being created
                This corresponds to the ``git_repository_link`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.developerconnect_v1.types.GitRepositoryLink`
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.CreateGitRepositoryLinkRequest):
            request = developer_connect.CreateGitRepositoryLinkRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
            if git_repository_link is not None:
                request.git_repository_link = git_repository_link
            if git_repository_link_id is not None:
                request.git_repository_link_id = git_repository_link_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_git_repository_link]
    ...
    def delete_git_repository_link(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_git_repository_link():
                # Create a client
                client = developerconnect_v1.DeveloperConnectClient()
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.DeleteGitRepositoryLinkRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.DeleteGitRepositoryLinkRequest):
            request = developer_connect.DeleteGitRepositoryLinkRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_git_repository_link]
    ...
    def list_git_repository_links(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListGitRepositoryLinksPager:
        r"""Lists GitRepositoryLinks in a given project,
        ...
        .. code-block:: python
            ...
            def sample_list_git_repository_links():
                # Create a client
                client = developerconnect_v1.DeveloperConnectClient()
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.ListGitRepositoryLinksRequest, dict]):
        ...
        Returns:
            google.cloud.developerconnect_v1.services.developer_connect.pagers.ListGitRepositoryLinksPager:
                Message for response to listing
                GitRepositoryLinks
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.ListGitRepositoryLinksRequest):
            request = developer_connect.ListGitRepositoryLinksRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_git_repository_links]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListGitRepositoryLinksPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_git_repository_link(self,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.GetGitRepositoryLinkRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.GetGitRepositoryLinkRequest):
            request = developer_connect.GetGitRepositoryLinkRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_git_repository_link]
    ...
    def fetch_read_write_token(self,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.FetchReadWriteTokenRequest, dict]):
                The request object. Message for fetching SCM read/write
                token.
            git_repository_link (str):
                Required. The resource name of the gitRepositoryLink in
                the format
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.FetchReadWriteTokenRequest):
            request = developer_connect.FetchReadWriteTokenRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if git_repository_link is not None:
                request.git_repository_link = git_repository_link
    ...
    def fetch_read_token(self,
            request: Optional[Union[developer_connect.FetchReadTokenRequest, dict]] = None,
            *,
            git_repository_link: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.FetchReadTokenRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.FetchReadTokenRequest):
            request = developer_connect.FetchReadTokenRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if git_repository_link is not None:
                request.git_repository_link = git_repository_link
    ...
    def fetch_linkable_git_repositories(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.FetchLinkableGitRepositoriesPager:
        r"""FetchLinkableGitRepositories returns a list of git
        ...
        .. code-block:: python
            ...
            def sample_fetch_linkable_git_repositories():
                # Create a client
                client = developerconnect_v1.DeveloperConnectClient()
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.FetchLinkableGitRepositoriesRequest, dict]):
        ...
        Returns:
            google.cloud.developerconnect_v1.services.developer_connect.pagers.FetchLinkableGitRepositoriesPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_linkable_git_repositories]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.FetchLinkableGitRepositoriesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def fetch_git_hub_installations(self,
        ...
        r"""FetchGitHubInstallations returns the list of GitHub
        ...
        .. code-block:: python
            ...
            def sample_fetch_git_hub_installations():
                # Create a client
                client = developerconnect_v1.DeveloperConnectClient()
                ...
                # Make the request
                response = client.fetch_git_hub_installations(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.developerconnect_v1.types.FetchGitHubInstallationsRequest, dict]):
                The request object. Request for fetching github
                installations.
            connection (str):
                Required. The resource name of the connection in the
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.FetchGitHubInstallationsRequest):
            request = developer_connect.FetchGitHubInstallationsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if connection is not None:
                request.connection = connection
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_git_hub_installations]
    ...
    def fetch_git_refs(self,
            request: Optional[Union[developer_connect.FetchGitRefsRequest, dict]] = None,
            *,
            git_repository_link: Optional[str] = None,
            ref_type: Optional[developer_connect.FetchGitRefsRequest.RefType] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.FetchGitRefsPager:
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.FetchGitRefsRequest, dict]):
            ...
            ref_type (google.cloud.developerconnect_v1.types.FetchGitRefsRequest.RefType):
                ...
                This corresponds to the ``ref_type`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.cloud.developerconnect_v1.services.developer_connect.pagers.FetchGitRefsPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, developer_connect.FetchGitRefsRequest):
            request = developer_connect.FetchGitRefsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if git_repository_link is not None:
                request.git_repository_link = git_repository_link
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.FetchGitRefsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def list_account_connectors(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListAccountConnectorsPager:
        ...
        .. code-block:: python
            ...
            def sample_list_account_connectors():
                # Create a client
                client = developerconnect_v1.DeveloperConnectClient()
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.ListAccountConnectorsRequest, dict]):
                The request object. Message for requesting list of
                AccountConnectors
            parent (str):
                Required. Parent value for
        ...
        Returns:
            google.cloud.developerconnect_v1.services.developer_connect.pagers.ListAccountConnectorsPager:
                Message for response to listing
                AccountConnectors
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_account_connectors]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListAccountConnectorsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_account_connector(self,
        ...
        .. code-block:: python
            ...
            def sample_get_account_connector():
                # Create a client
                client = developerconnect_v1.DeveloperConnectClient()
                ...
                # Make the request
                response = client.get_account_connector(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.developerconnect_v1.types.GetAccountConnectorRequest, dict]):
                The request object. Message for getting a
                AccountConnector
            name (str):
                Required. Name of the resource
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_account_connector]
    ...
    def create_account_connector(self,
        ...
        .. code-block:: python
            ...
            def sample_create_account_connector():
                # Create a client
                client = developerconnect_v1.DeveloperConnectClient()
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.CreateAccountConnectorRequest, dict]):
                The request object.
            parent (str):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_account_connector]
    ...
    def update_account_connector(self,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.UpdateAccountConnectorRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_account_connector]
    ...
    def delete_account_connector(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_account_connector():
                # Create a client
                client = developerconnect_v1.DeveloperConnectClient()
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.DeleteAccountConnectorRequest, dict]):
                The request object. Message for deleting a
                AccountConnector
            name (str):
                Required. Name of the resource
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_account_connector]
    ...
    def fetch_access_token(self,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.FetchAccessTokenRequest, dict]):
    ...
    def list_users(self,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.ListUsersRequest, dict]):
                The request object. Message for requesting a list of
                Users
            parent (str):
                Required. Parent value for
        ...
        Returns:
            google.cloud.developerconnect_v1.services.developer_connect.pagers.ListUsersPager:
    ...
    def delete_user(self,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.DeleteUserRequest, dict]):
    ...
    def fetch_self(self,
        ...
        .. code-block:: python
            ...
            def sample_fetch_self():
                ...
                # Make the request
                response = client.fetch_self(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.developerconnect_v1.types.FetchSelfRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_self]
    ...
    def delete_self(self,
        ...
        Args:
            request (Union[google.cloud.developerconnect_v1.types.DeleteSelfRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_self]
    ...
    def __enter__(self) -> "DeveloperConnectClient":
        return self

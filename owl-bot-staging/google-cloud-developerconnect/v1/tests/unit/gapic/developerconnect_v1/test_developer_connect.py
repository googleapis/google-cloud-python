    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.create_git_repository_link] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_git_repository_link] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_git_repository_links] = mock_object
...
def test_list_git_repository_links_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_git_repository_links(request={})
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_git_repository_link] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_read_write_token] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_read_token] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_linkable_git_repositories] = mock_object
...
def test_fetch_linkable_git_repositories_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.fetch_linkable_git_repositories(request={})
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_git_hub_installations] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_git_refs] = mock_object
...
def test_fetch_git_refs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.fetch_git_refs(request={})
...
def test_list_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = developer_connect.ListConnectionsResponse.to_json(developer_connect.ListConnectionsResponse())
...
def test_list_connections_rest_bad_request(transport: str = 'rest', request_type=developer_connect.ListConnectionsRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = developer_connect.Connection.to_json(developer_connect.Connection())
...
def test_get_connection_rest_bad_request(transport: str = 'rest', request_type=developer_connect.GetConnectionRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_connection_rest_bad_request(transport: str = 'rest', request_type=developer_connect.CreateConnectionRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_connection_rest_bad_request(transport: str = 'rest', request_type=developer_connect.UpdateConnectionRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_connection_rest_bad_request(transport: str = 'rest', request_type=developer_connect.DeleteConnectionRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_git_repository_link_rest(request_type):
    ...
    request_init["git_repository_link"] = {'name': 'name_value', 'clone_uri': 'clone_uri_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'labels': {}, 'etag': 'etag_value', 'reconciling': True, 'annotations': {}, 'uid': 'uid_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_git_repository_link_rest_bad_request(transport: str = 'rest', request_type=developer_connect.CreateGitRepositoryLinkRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_git_repository_link_rest_bad_request(transport: str = 'rest', request_type=developer_connect.DeleteGitRepositoryLinkRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_git_repository_links_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = developer_connect.ListGitRepositoryLinksResponse.to_json(developer_connect.ListGitRepositoryLinksResponse())
...
def test_list_git_repository_links_rest_bad_request(transport: str = 'rest', request_type=developer_connect.ListGitRepositoryLinksRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_git_repository_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = developer_connect.GitRepositoryLink.to_json(developer_connect.GitRepositoryLink())
...
def test_get_git_repository_link_rest_bad_request(transport: str = 'rest', request_type=developer_connect.GetGitRepositoryLinkRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_read_write_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = developer_connect.FetchReadWriteTokenResponse.to_json(developer_connect.FetchReadWriteTokenResponse())
...
def test_fetch_read_write_token_rest_bad_request(transport: str = 'rest', request_type=developer_connect.FetchReadWriteTokenRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_read_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = developer_connect.FetchReadTokenResponse.to_json(developer_connect.FetchReadTokenResponse())
...
def test_fetch_read_token_rest_bad_request(transport: str = 'rest', request_type=developer_connect.FetchReadTokenRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_linkable_git_repositories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = developer_connect.FetchLinkableGitRepositoriesResponse.to_json(developer_connect.FetchLinkableGitRepositoriesResponse())
...
def test_fetch_linkable_git_repositories_rest_bad_request(transport: str = 'rest', request_type=developer_connect.FetchLinkableGitRepositoriesRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_git_hub_installations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = developer_connect.FetchGitHubInstallationsResponse.to_json(developer_connect.FetchGitHubInstallationsResponse())
...
def test_fetch_git_hub_installations_rest_bad_request(transport: str = 'rest', request_type=developer_connect.FetchGitHubInstallationsRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_git_refs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = developer_connect.FetchGitRefsResponse.to_json(developer_connect.FetchGitRefsResponse())
...
def test_fetch_git_refs_rest_bad_request(transport: str = 'rest', request_type=developer_connect.FetchGitRefsRequest):
    client = DeveloperConnectClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

...
def test_create_git_repository_link_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/connections/sample3'}
    request_init["git_repository_link"] = {'name': 'name_value', 'clone_uri': 'clone_uri_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'labels': {}, 'etag': 'etag_value', 'reconciling': True, 'annotations': {}, 'uid': 'uid_value', 'webhook_id': 'webhook_id_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

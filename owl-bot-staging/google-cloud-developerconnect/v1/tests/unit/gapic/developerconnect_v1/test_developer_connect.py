...
from google.cloud.developerconnect_v1.services.developer_connect import DeveloperConnectAsyncClient
from google.cloud.developerconnect_v1.services.developer_connect import DeveloperConnectClient
from google.cloud.developerconnect_v1.services.developer_connect import pagers
from google.cloud.developerconnect_v1.services.developer_connect import transports
...
def test__get_api_endpoint():
    ...
    assert DeveloperConnectClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DeveloperConnectClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert DeveloperConnectClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DeveloperConnectClient.DEFAULT_MTLS_ENDPOINT
...
def test_developer_connect_client_client_options_from_dict():
    with mock.patch('google.cloud.developerconnect_v1.services.developer_connect.transports.DeveloperConnectGrpcTransport.__init__') as grpc_transport:
...
def test_list_connections_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, developer_connect.Connection)
                   for i in results)
...
def test_create_connection_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_connection(
            parent='parent_value',
            connection=developer_connect.Connection(github_config=developer_connect.GitHubConfig(github_app=developer_connect.GitHubConfig.GitHubApp.DEVELOPER_CONNECT)),
            connection_id='connection_id_value',
        )
        ...
        mock_val = developer_connect.Connection(github_config=developer_connect.GitHubConfig(github_app=developer_connect.GitHubConfig.GitHubApp.DEVELOPER_CONNECT))
        assert arg == mock_val
...
def test_create_git_repository_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_git_repository_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_git_repository_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_git_repository_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_git_repository_links_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, developer_connect.GitRepositoryLink)
                   for i in results)
...
async def test_list_git_repository_links_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_git_repository_links(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_git_repository_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_git_repository_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_fetch_linkable_git_repositories_async(transport: str = 'grpc_asyncio', request_type=developer_connect.FetchLinkableGitRepositoriesRequest):
    client = DeveloperConnectAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_fetch_linkable_git_repositories_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, developer_connect.LinkableGitRepository)
                   for i in results)
...
async def test_fetch_linkable_git_repositories_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.fetch_linkable_git_repositories(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_fetch_git_hub_installations(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_git_hub_installations),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_fetch_git_refs_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.fetch_git_refs(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_account_connectors_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, developer_connect.AccountConnector)
                   for i in results)
...
async def test_list_account_connectors_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_account_connectors(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_account_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_account_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_account_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_account_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_account_connector_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_account_connector(
            parent='parent_value',
            account_connector=developer_connect.AccountConnector(provider_oauth_config=developer_connect.ProviderOAuthConfig(system_provider_id=developer_connect.SystemProvider.GITHUB)),
            account_connector_id='account_connector_id_value',
        )
        ...
        mock_val = developer_connect.AccountConnector(provider_oauth_config=developer_connect.ProviderOAuthConfig(system_provider_id=developer_connect.SystemProvider.GITHUB))
        assert arg == mock_val
...
def test_update_account_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_account_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_account_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_account_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_fetch_access_token(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_access_token),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_users_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, developer_connect.User)
                   for i in results)
...
def test_fetch_self(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_self),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_self(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_self),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_connection_rest_required_fields(request_type=developer_connect.CreateConnectionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_connection._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("connection_id", "request_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_connection_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("connectionId", "requestId", "validateOnly", )) & set(("parent", "connectionId", "connection", )))
...
def test_update_connection_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "requestId", "updateMask", "validateOnly", )) & set(("updateMask", "connection", )))
...
def test_create_git_repository_link_rest_required_fields(request_type=developer_connect.CreateGitRepositoryLinkRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_git_repository_link._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_git_repository_link._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("git_repository_link_id", "request_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_git_repository_link_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("gitRepositoryLinkId", "requestId", "validateOnly", )) & set(("parent", "gitRepositoryLink", "gitRepositoryLinkId", )))
...
def test_delete_git_repository_link_rest_required_fields(request_type=developer_connect.DeleteGitRepositoryLinkRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_git_repository_link._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_git_repository_links_rest_required_fields(request_type=developer_connect.ListGitRepositoryLinksRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_git_repository_links._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_git_repository_link_rest_required_fields(request_type=developer_connect.GetGitRepositoryLinkRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_git_repository_link._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_read_write_token_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{git_repository_link=projects/*/locations/*/connections/*/gitRepositoryLinks/*}:fetchReadWriteToken" % client.transport._host, args[1])
...
def test_fetch_read_token_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{git_repository_link=projects/*/locations/*/connections/*/gitRepositoryLinks/*}:fetchReadToken" % client.transport._host, args[1])
...
def test_fetch_linkable_git_repositories_rest_required_fields(request_type=developer_connect.FetchLinkableGitRepositoriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_linkable_git_repositories._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_linkable_git_repositories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{connection=projects/*/locations/*/connections/*}:fetchLinkableGitRepositories" % client.transport._host, args[1])
...
def test_fetch_git_hub_installations_rest_required_fields(request_type=developer_connect.FetchGitHubInstallationsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_git_hub_installations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_git_hub_installations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{connection=projects/*/locations/*/connections/*}:fetchGitHubInstallations" % client.transport._host, args[1])
...
def test_fetch_git_refs_rest_required_fields(request_type=developer_connect.FetchGitRefsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_git_refs._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("page_size", "page_token", "ref_type", ))
    jsonified_request.update(unset_fields)
...
def test_fetch_git_refs_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pageSize", "pageToken", "refType", )) & set(("gitRepositoryLink", "refType", )))
...
def test_fetch_git_refs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{git_repository_link=projects/*/locations/*/connections/*/gitRepositoryLinks/*}:fetchGitRefs" % client.transport._host, args[1])
...
def test_list_account_connectors_rest_required_fields(request_type=developer_connect.ListAccountConnectorsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_account_connectors._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_account_connector_rest_required_fields(request_type=developer_connect.GetAccountConnectorRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_account_connector._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_account_connector_rest_required_fields(request_type=developer_connect.CreateAccountConnectorRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_account_connector._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_account_connector._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("account_connector_id", "request_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_account_connector_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("accountConnectorId", "requestId", "validateOnly", )) & set(("parent", "accountConnectorId", "accountConnector", )))
...
def test_update_account_connector_rest_required_fields(request_type=developer_connect.UpdateAccountConnectorRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_account_connector._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_account_connector_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "requestId", "updateMask", "validateOnly", )) & set(("accountConnector", )))
...
def test_delete_account_connector_rest_required_fields(request_type=developer_connect.DeleteAccountConnectorRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_account_connector._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_access_token_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{account_connector=projects/*/locations/*/accountConnectors/*}/users:fetchAccessToken" % client.transport._host, args[1])
...
def test_list_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_list_connections") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_list_connections_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_list_connections") as pre:
...
def test_get_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_get_connection") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_get_connection_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_get_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_connection_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["connection"] = {'github_config': {'github_app': 1, 'authorizer_credential': {'oauth_token_secret_version': 'oauth_token_secret_version_value', 'username': 'username_value'}, 'app_installation_id': 2014, 'installation_uri': 'installation_uri_value'}, 'github_enterprise_config': {'host_uri': 'host_uri_value', 'app_id': 621, 'app_slug': 'app_slug_value', 'private_key_secret_version': 'private_key_secret_version_value', 'webhook_secret_secret_version': 'webhook_secret_secret_version_value', 'app_installation_id': 2014, 'installation_uri': 'installation_uri_value', 'service_directory_config': {'service': 'service_value'}, 'server_version': 'server_version_value', 'ssl_ca_certificate': 'ssl_ca_certificate_value'}, 'gitlab_config': {'webhook_secret_secret_version': 'webhook_secret_secret_version_value', 'read_authorizer_credential': {'user_token_secret_version': 'user_token_secret_version_value', 'username': 'username_value'}, 'authorizer_credential': {}}, 'gitlab_enterprise_config': {'host_uri': 'host_uri_value', 'webhook_secret_secret_version': 'webhook_secret_secret_version_value', 'read_authorizer_credential': {}, 'authorizer_credential': {}, 'service_directory_config': {}, 'ssl_ca_certificate': 'ssl_ca_certificate_value', 'server_version': 'server_version_value'}, 'bitbucket_data_center_config': {'host_uri': 'host_uri_value', 'webhook_secret_secret_version': 'webhook_secret_secret_version_value', 'read_authorizer_credential': {}, 'authorizer_credential': {}, 'service_directory_config': {}, 'ssl_ca_certificate': 'ssl_ca_certificate_value', 'server_version': 'server_version_value'}, 'bitbucket_cloud_config': {'workspace': 'workspace_value', 'webhook_secret_secret_version': 'webhook_secret_secret_version_value', 'read_authorizer_credential': {}, 'authorizer_credential': {}}, 'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'labels': {}, 'installation_state': {'stage': 1, 'message': 'message_value', 'action_uri': 'action_uri_value'}, 'disabled': True, 'reconciling': True, 'annotations': {}, 'etag': 'etag_value', 'uid': 'uid_value', 'crypto_key_config': {'key_reference': 'key_reference_value'}, 'git_proxy_config': {'enabled': True}}
...
def test_create_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_create_connection") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_create_connection_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_create_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_connection_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'connection': {'name': 'projects/sample1/locations/sample2/connections/sample3'}}
    request_init["connection"] = {'github_config': {'github_app': 1, 'authorizer_credential': {'oauth_token_secret_version': 'oauth_token_secret_version_value', 'username': 'username_value'}, 'app_installation_id': 2014, 'installation_uri': 'installation_uri_value'}, 'github_enterprise_config': {'host_uri': 'host_uri_value', 'app_id': 621, 'app_slug': 'app_slug_value', 'private_key_secret_version': 'private_key_secret_version_value', 'webhook_secret_secret_version': 'webhook_secret_secret_version_value', 'app_installation_id': 2014, 'installation_uri': 'installation_uri_value', 'service_directory_config': {'service': 'service_value'}, 'server_version': 'server_version_value', 'ssl_ca_certificate': 'ssl_ca_certificate_value'}, 'gitlab_config': {'webhook_secret_secret_version': 'webhook_secret_secret_version_value', 'read_authorizer_credential': {'user_token_secret_version': 'user_token_secret_version_value', 'username': 'username_value'}, 'authorizer_credential': {}}, 'gitlab_enterprise_config': {'host_uri': 'host_uri_value', 'webhook_secret_secret_version': 'webhook_secret_secret_version_value', 'read_authorizer_credential': {}, 'authorizer_credential': {}, 'service_directory_config': {}, 'ssl_ca_certificate': 'ssl_ca_certificate_value', 'server_version': 'server_version_value'}, 'bitbucket_data_center_config': {'host_uri': 'host_uri_value', 'webhook_secret_secret_version': 'webhook_secret_secret_version_value', 'read_authorizer_credential': {}, 'authorizer_credential': {}, 'service_directory_config': {}, 'ssl_ca_certificate': 'ssl_ca_certificate_value', 'server_version': 'server_version_value'}, 'bitbucket_cloud_config': {'workspace': 'workspace_value', 'webhook_secret_secret_version': 'webhook_secret_secret_version_value', 'read_authorizer_credential': {}, 'authorizer_credential': {}}, 'name': 'projects/sample1/locations/sample2/connections/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'labels': {}, 'installation_state': {'stage': 1, 'message': 'message_value', 'action_uri': 'action_uri_value'}, 'disabled': True, 'reconciling': True, 'annotations': {}, 'etag': 'etag_value', 'uid': 'uid_value', 'crypto_key_config': {'key_reference': 'key_reference_value'}, 'git_proxy_config': {'enabled': True}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_update_connection") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_update_connection_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_update_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_delete_connection") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_delete_connection_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_delete_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_git_repository_link_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/connections/sample3'}
    request_init["git_repository_link"] = {'name': 'name_value', 'clone_uri': 'clone_uri_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'labels': {}, 'etag': 'etag_value', 'reconciling': True, 'annotations': {}, 'uid': 'uid_value', 'webhook_id': 'webhook_id_value', 'git_proxy_uri': 'git_proxy_uri_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_git_repository_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_create_git_repository_link") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_create_git_repository_link_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_create_git_repository_link") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_git_repository_link(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_git_repository_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_delete_git_repository_link") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_delete_git_repository_link_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_delete_git_repository_link") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_git_repository_link(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_git_repository_links_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_list_git_repository_links") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_list_git_repository_links_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_list_git_repository_links") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_git_repository_links(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_git_repository_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_get_git_repository_link") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_get_git_repository_link_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_get_git_repository_link") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_git_repository_link(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_read_write_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_read_write_token") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_read_write_token_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_fetch_read_write_token") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_fetch_read_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_read_token") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_read_token_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_fetch_read_token") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_fetch_linkable_git_repositories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_linkable_git_repositories") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_linkable_git_repositories_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_fetch_linkable_git_repositories") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.fetch_linkable_git_repositories(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_git_hub_installations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_git_hub_installations") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_git_hub_installations_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_fetch_git_hub_installations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.fetch_git_hub_installations(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_git_refs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_git_refs") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_git_refs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_fetch_git_refs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_account_connectors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_list_account_connectors") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_list_account_connectors_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_list_account_connectors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_account_connectors(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_account_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_get_account_connector") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_get_account_connector_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_get_account_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_account_connector(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_account_connector_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["account_connector"] = {'provider_oauth_config': {'system_provider_id': 1, 'scopes': ['scopes_value1', 'scopes_value2']}, 'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'annotations': {}, 'etag': 'etag_value', 'labels': {}, 'oauth_start_uri': 'oauth_start_uri_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_account_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_create_account_connector") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_create_account_connector_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_create_account_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_account_connector(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_account_connector_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'account_connector': {'name': 'projects/sample1/locations/sample2/accountConnectors/sample3'}}
    request_init["account_connector"] = {'provider_oauth_config': {'system_provider_id': 1, 'scopes': ['scopes_value1', 'scopes_value2']}, 'name': 'projects/sample1/locations/sample2/accountConnectors/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'annotations': {}, 'etag': 'etag_value', 'labels': {}, 'oauth_start_uri': 'oauth_start_uri_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_account_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_update_account_connector") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_update_account_connector_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_update_account_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_account_connector(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_account_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_delete_account_connector") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_delete_account_connector_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_delete_account_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_account_connector(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_access_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_access_token") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_access_token_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_fetch_access_token") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.fetch_access_token(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_users_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_list_users") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_list_users_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_list_users") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_delete_user") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_delete_user_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_delete_user") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_fetch_self_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_self") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_fetch_self_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_fetch_self") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.fetch_self(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_self_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_delete_self") as post, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "post_delete_self_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeveloperConnectRestInterceptor, "pre_delete_self") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_self(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_developer_connect_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.developerconnect_v1.services.developer_connect.transports.DeveloperConnectTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_developer_connect_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.developerconnect_v1.services.developer_connect.transports.DeveloperConnectTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DeveloperConnectTransport()
        adc.assert_called_once()
...
def test_developer_connect_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_account_connector_path():
    ...
    expected = "projects/{project}/locations/{location}/accountConnectors/{account_connector}".format(project=project, location=location, account_connector=account_connector, )
...
def test_user_path():
    ...
    user = "nautilus"
    expected = "projects/{project}/locations/{location}/accountConnectors/{account_connector}/users/{user}".format(project=project, location=location, account_connector=account_connector, user=user, )

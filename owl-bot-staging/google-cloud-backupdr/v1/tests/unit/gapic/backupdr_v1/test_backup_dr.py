...
from google.cloud.backupdr_v1.services.backup_dr import BackupDRAsyncClient
from google.cloud.backupdr_v1.services.backup_dr import BackupDRClient
from google.cloud.backupdr_v1.services.backup_dr import pagers
from google.cloud.backupdr_v1.services.backup_dr import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert BackupDRClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert BackupDRClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert BackupDRClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert BackupDRClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert BackupDRClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert BackupDRClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert BackupDRClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert BackupDRClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(BackupDRClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BackupDRClient))
@mock.patch.object(BackupDRAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BackupDRAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BackupDRClient._DEFAULT_UNIVERSE
    default_endpoint = BackupDRClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = BackupDRClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert BackupDRClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert BackupDRClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BackupDRClient.DEFAULT_MTLS_ENDPOINT
    assert BackupDRClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert BackupDRClient._get_api_endpoint(None, None, default_universe, "always") == BackupDRClient.DEFAULT_MTLS_ENDPOINT
    assert BackupDRClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BackupDRClient.DEFAULT_MTLS_ENDPOINT
    assert BackupDRClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert BackupDRClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        BackupDRClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert BackupDRClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert BackupDRClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
...
def test_backup_dr_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (BackupDRAsyncClient, transports.BackupDRGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (BackupDRClient, transports.BackupDRGrpcTransport, "grpc", "false"),
    (BackupDRAsyncClient, transports.BackupDRGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_backup_dr_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    BackupDRClient, BackupDRAsyncClient
])
@mock.patch.object(BackupDRClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BackupDRClient))
@mock.patch.object(BackupDRAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BackupDRAsyncClient))
...
def test_backup_dr_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (BackupDRAsyncClient, transports.BackupDRGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (BackupDRClient, transports.BackupDRRestTransport, "rest", None),
])
def test_backup_dr_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_backup_dr_client_client_options_from_dict():
    with mock.patch('google.cloud.backupdr_v1.services.backup_dr.transports.BackupDRGrpcTransport.__init__') as grpc_transport:
...
def test_backup_dr_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_list_management_servers_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_management_servers in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_management_servers] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_management_servers_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_management_servers in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_management_servers] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_management_servers_async(transport: str = 'grpc_asyncio', request_type=backupdr.ListManagementServersRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_management_servers_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, backupdr.ManagementServer)
                   for i in results)
...
async def test_list_management_servers_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_management_servers(request={},)
...
def test_get_management_server(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_management_server),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_management_server_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_management_server in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_management_server] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_management_server_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_management_server in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_management_server] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_management_server_async(transport: str = 'grpc_asyncio', request_type=backupdr.GetManagementServerRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(backupdr.ManagementServer(
            name='name_value',
            description='description_value',
            type_=backupdr.ManagementServer.InstanceType.BACKUP_RESTORE,
            state=backupdr.ManagementServer.InstanceState.CREATING,
...
def test_create_management_server(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_management_server),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_management_server_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_management_server in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_management_server] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_management_server_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_management_server in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_management_server] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_management_server_async(transport: str = 'grpc_asyncio', request_type=backupdr.CreateManagementServerRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_management_server(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_management_server),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_management_server_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_management_server in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_management_server] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_management_server_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_management_server in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_management_server] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_management_server_async(transport: str = 'grpc_asyncio', request_type=backupdr.DeleteManagementServerRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_backup_vault(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_backup_vault),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_backup_vault_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_backup_vault in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_backup_vault] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_backup_vault_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_backup_vault in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_backup_vault] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_backup_vault_async(transport: str = 'grpc_asyncio', request_type=backupvault.CreateBackupVaultRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_backup_vaults_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_backup_vaults in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_backup_vaults] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_backup_vaults_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_backup_vaults in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_backup_vaults] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_backup_vaults_async(transport: str = 'grpc_asyncio', request_type=backupvault.ListBackupVaultsRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(backupvault.ListBackupVaultsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_backup_vaults_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, backupvault.BackupVault)
                   for i in results)
...
async def test_list_backup_vaults_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_backup_vaults(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_fetch_usable_backup_vaults_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.fetch_usable_backup_vaults in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.fetch_usable_backup_vaults] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_fetch_usable_backup_vaults_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_usable_backup_vaults in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_usable_backup_vaults] = mock_rpc
...
@pytest.mark.asyncio
async def test_fetch_usable_backup_vaults_async(transport: str = 'grpc_asyncio', request_type=backupvault.FetchUsableBackupVaultsRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(backupvault.FetchUsableBackupVaultsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_fetch_usable_backup_vaults_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.fetch_usable_backup_vaults(request={}, retry=retry, timeout=timeout)
...
async def test_fetch_usable_backup_vaults_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.fetch_usable_backup_vaults(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_backup_vault(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_backup_vault),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.access_restriction == backupvault.BackupVault.AccessRestriction.WITHIN_PROJECT
...
@pytest.mark.asyncio
async def test_get_backup_vault_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_backup_vault in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_backup_vault] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_backup_vault_async(transport: str = 'grpc_asyncio', request_type=backupvault.GetBackupVaultRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(backupvault.BackupVault(
            name='name_value',
            description='description_value',
            deletable=True,
            etag='etag_value',
...
def test_update_backup_vault(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_backup_vault),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_backup_vault_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_backup_vault in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_backup_vault] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_backup_vault_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_backup_vault in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_backup_vault] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_backup_vault_async(transport: str = 'grpc_asyncio', request_type=backupvault.UpdateBackupVaultRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_backup_vault(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_backup_vault),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_backup_vault_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_backup_vault in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_backup_vault] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_backup_vault_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_backup_vault in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_backup_vault] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_backup_vault_async(transport: str = 'grpc_asyncio', request_type=backupvault.DeleteBackupVaultRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_data_sources_async(transport: str = 'grpc_asyncio', request_type=backupvault.ListDataSourcesRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_data_sources_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, backupvault.DataSource)
                   for i in results)
...
@pytest.mark.asyncio
async def test_get_data_source_async(transport: str = 'grpc_asyncio', request_type=backupvault.GetDataSourceRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(backupvault.DataSource(
            name='name_value',
            state=backupvault.DataSource.State.CREATING,
            backup_count=1278,
            etag='etag_value',
...
@pytest.mark.asyncio
async def test_update_data_source_async(transport: str = 'grpc_asyncio', request_type=backupvault.UpdateDataSourceRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_backups_async(transport: str = 'grpc_asyncio', request_type=backupvault.ListBackupsRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(backupvault.ListBackupsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_backups_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, backupvault.Backup)
                   for i in results)
...
@pytest.mark.asyncio
async def test_get_backup_async(transport: str = 'grpc_asyncio', request_type=backupvault.GetBackupRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_backup_async(transport: str = 'grpc_asyncio', request_type=backupvault.UpdateBackupRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_backup_async(transport: str = 'grpc_asyncio', request_type=backupvault.DeleteBackupRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_restore_backup_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.restore_backup in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.restore_backup] = mock_rpc
...
@pytest.mark.asyncio
async def test_restore_backup_async(transport: str = 'grpc_asyncio', request_type=backupvault.RestoreBackupRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_backup_plan_async(transport: str = 'grpc_asyncio', request_type=backupplan.CreateBackupPlanRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_backup_plan_async(transport: str = 'grpc_asyncio', request_type=backupplan.GetBackupPlanRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(backupplan.BackupPlan(
            name='name_value',
            description='description_value',
            state=backupplan.BackupPlan.State.CREATING,
            resource_type='resource_type_value',
...
@pytest.mark.asyncio
async def test_list_backup_plans_async(transport: str = 'grpc_asyncio', request_type=backupplan.ListBackupPlansRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(backupplan.ListBackupPlansResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_backup_plans_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, backupplan.BackupPlan)
                   for i in results)
...
@pytest.mark.asyncio
async def test_delete_backup_plan_async(transport: str = 'grpc_asyncio', request_type=backupplan.DeleteBackupPlanRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_backup_plan_association(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_backup_plan_association),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_backup_plan_association_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_backup_plan_association in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_backup_plan_association] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_backup_plan_association_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_backup_plan_association in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_backup_plan_association] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_backup_plan_association_async(transport: str = 'grpc_asyncio', request_type=backupplanassociation.CreateBackupPlanAssociationRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_backup_plan_association(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_backup_plan_association),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_backup_plan_association_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_backup_plan_association in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_backup_plan_association] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_backup_plan_association_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_backup_plan_association in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_backup_plan_association] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_backup_plan_association_async(transport: str = 'grpc_asyncio', request_type=backupplanassociation.GetBackupPlanAssociationRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(backupplanassociation.BackupPlanAssociation(
            name='name_value',
            resource_type='resource_type_value',
            resource='resource_value',
            backup_plan='backup_plan_value',
...
def test_list_backup_plan_associations_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_backup_plan_associations in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_backup_plan_associations] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_backup_plan_associations_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_backup_plan_associations in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_backup_plan_associations] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_backup_plan_associations_async(transport: str = 'grpc_asyncio', request_type=backupplanassociation.ListBackupPlanAssociationsRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(backupplanassociation.ListBackupPlanAssociationsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_backup_plan_associations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_backup_plan_associations(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, backupplanassociation.BackupPlanAssociation)
                   for i in results)
...
async def test_list_backup_plan_associations_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_backup_plan_associations(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_delete_backup_plan_association(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_backup_plan_association),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_backup_plan_association_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_backup_plan_association in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_backup_plan_association] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_backup_plan_association_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_backup_plan_association in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_backup_plan_association] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_backup_plan_association_async(transport: str = 'grpc_asyncio', request_type=backupplanassociation.DeleteBackupPlanAssociationRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_trigger_backup(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.trigger_backup),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_trigger_backup_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.trigger_backup in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.trigger_backup] = mock_rpc
...
@pytest.mark.asyncio
async def test_trigger_backup_async(transport: str = 'grpc_asyncio', request_type=backupplanassociation.TriggerBackupRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_initialize_service(request_type, transport: str = 'grpc'):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.initialize_service),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
        response = client.initialize_service(request)
...
def test_initialize_service_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.initialize_service(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == backupdr.InitializeServiceRequest(
            name='name_value',
            resource_type='resource_type_value',
        )

def test_initialize_service_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BackupDRClient(
        ...
        # Ensure method has been cached
        assert client._transport.initialize_service in client._transport._wrapped_methods
        ...
        request = {}
        client.initialize_service(request)
...
@pytest.mark.asyncio
async def test_initialize_service_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BackupDRAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.initialize_service in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.initialize_service] = mock_rpc

        request = {}
        await client.initialize_service(request)
...
@pytest.mark.asyncio
async def test_initialize_service_async(transport: str = 'grpc_asyncio', request_type=backupdr.InitializeServiceRequest):
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.initialize_service(request)
...
@pytest.mark.asyncio
async def test_initialize_service_async_from_dict():
    await test_initialize_service_async(request_type=dict)

def test_initialize_service_field_headers():
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_initialize_service_field_headers_async():
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_management_servers_rest_required_fields(request_type=backupdr.ListManagementServersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_management_servers._get_unset_required_fields(jsonified_request)
...
def test_list_management_servers_rest_unset_required_fields():
    transport = transports.BackupDRRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_management_servers_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/managementServers" % client.transport._host, args[1])
...
def test_list_management_servers_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(backupdr.ListManagementServersResponse.to_json(x) for x in response)
...
def test_get_management_server_rest_required_fields(request_type=backupdr.GetManagementServerRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_management_server._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_management_server_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/managementServers/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/managementServers/*}" % client.transport._host, args[1])
...
def test_create_management_server_rest_required_fields(request_type=backupdr.CreateManagementServerRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_management_server._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "managementServerId" in jsonified_request
    assert jsonified_request["managementServerId"] == request_init["management_server_id"]
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_management_server._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("management_server_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_management_server_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("managementServerId", "requestId", )) & set(("parent", "managementServerId", "managementServer", )))
...
def test_delete_management_server_rest_required_fields(request_type=backupdr.DeleteManagementServerRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_management_server._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_backup_vault_rest_required_fields(request_type=backupvault.CreateBackupVaultRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_backup_vault._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_backup_vault._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("backup_vault_id", "request_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_backup_vault_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("backupVaultId", "requestId", "validateOnly", )) & set(("parent", "backupVaultId", "backupVault", )))
...
def test_create_backup_vault_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/backupVaults" % client.transport._host, args[1])
...
def test_list_backup_vaults_rest_required_fields(request_type=backupvault.ListBackupVaultsRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_backup_vaults._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_backup_vaults_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(backupvault.ListBackupVaultsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_fetch_usable_backup_vaults_rest_required_fields(request_type=backupvault.FetchUsableBackupVaultsRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_usable_backup_vaults._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_usable_backup_vaults_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/backupVaults:fetchUsable" % client.transport._host, args[1])
...
def test_fetch_usable_backup_vaults_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(backupvault.FetchUsableBackupVaultsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_backup_vault_rest_required_fields(request_type=backupvault.GetBackupVaultRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_backup_vault._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_backup_vault_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/backupVaults/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/backupVaults/*}" % client.transport._host, args[1])
...
def test_update_backup_vault_rest_required_fields(request_type=backupvault.UpdateBackupVaultRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_backup_vault._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_backup_vault_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("force", "requestId", "updateMask", "validateOnly", )) & set(("updateMask", "backupVault", )))
...
def test_update_backup_vault_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'backup_vault': {'name': 'projects/sample1/locations/sample2/backupVaults/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{backup_vault.name=projects/*/locations/*/backupVaults/*}" % client.transport._host, args[1])
...
def test_delete_backup_vault_rest_required_fields(request_type=backupvault.DeleteBackupVaultRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_backup_vault._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_backup_vault._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("allow_missing", "etag", "force", "ignore_backup_plan_references", "request_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_delete_backup_vault_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "etag", "force", "ignoreBackupPlanReferences", "requestId", "validateOnly", )) & set(("name", )))
...
def test_list_data_sources_rest_required_fields(request_type=backupvault.ListDataSourcesRequest):
    transport_class = transports.BackupDRRestTransport
...
def test_list_data_sources_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/backupVaults/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/backupVaults/*}/dataSources" % client.transport._host, args[1])
...
def test_list_data_sources_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(backupvault.ListDataSourcesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_data_source_rest_required_fields(request_type=backupvault.GetDataSourceRequest):
    transport_class = transports.BackupDRRestTransport
...
def test_get_data_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/backupVaults/sample3/dataSources/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/backupVaults/*/dataSources/*}" % client.transport._host, args[1])
...
def test_update_data_source_rest_required_fields(request_type=backupvault.UpdateDataSourceRequest):
    transport_class = transports.BackupDRRestTransport
...
def test_update_data_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'data_source': {'name': 'projects/sample1/locations/sample2/backupVaults/sample3/dataSources/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{data_source.name=projects/*/locations/*/backupVaults/*/dataSources/*}" % client.transport._host, args[1])
...
def test_list_backups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/backupVaults/sample3/dataSources/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/backupVaults/*/dataSources/*}/backups" % client.transport._host, args[1])
...
def test_get_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/backupVaults/sample3/dataSources/sample4/backups/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/backupVaults/*/dataSources/*/backups/*}" % client.transport._host, args[1])
...
def test_update_backup_rest_required_fields(request_type=backupvault.UpdateBackupRequest):
    transport_class = transports.BackupDRRestTransport
...
def test_update_backup_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("updateMask", "backup", )))
...
def test_update_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'backup': {'name': 'projects/sample1/locations/sample2/backupVaults/sample3/dataSources/sample4/backups/sample5'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{backup.name=projects/*/locations/*/backupVaults/*/dataSources/*/backups/*}" % client.transport._host, args[1])
...
def test_delete_backup_rest_required_fields(request_type=backupvault.DeleteBackupRequest):
    transport_class = transports.BackupDRRestTransport
...
def test_restore_backup_rest_required_fields(request_type=backupvault.RestoreBackupRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).restore_backup._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_restore_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/backupVaults/*/dataSources/*/backups/*}:restore" % client.transport._host, args[1])
...
def test_create_backup_plan_rest_required_fields(request_type=backupplan.CreateBackupPlanRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_backup_plan._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("backup_plan_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_backup_plan_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("backupPlanId", "requestId", )) & set(("parent", "backupPlanId", "backupPlan", )))
...
def test_get_backup_plan_rest_required_fields(request_type=backupplan.GetBackupPlanRequest):
    transport_class = transports.BackupDRRestTransport
...
def test_list_backup_plans_rest_required_fields(request_type=backupplan.ListBackupPlansRequest):
    transport_class = transports.BackupDRRestTransport
...
def test_list_backup_plans_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(backupplan.ListBackupPlansResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_backup_plan_rest_required_fields(request_type=backupplan.DeleteBackupPlanRequest):
    transport_class = transports.BackupDRRestTransport
...
def test_create_backup_plan_association_rest_required_fields(request_type=backupplanassociation.CreateBackupPlanAssociationRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_backup_plan_association._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "backupPlanAssociationId" in jsonified_request
    assert jsonified_request["backupPlanAssociationId"] == request_init["backup_plan_association_id"]
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_backup_plan_association._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("backup_plan_association_id", "request_id", ))
    jsonified_request.update(unset_fields)
    ...
    assert jsonified_request["parent"] == 'parent_value'
    assert "backupPlanAssociationId" in jsonified_request
    assert jsonified_request["backupPlanAssociationId"] == 'backup_plan_association_id_value'
...
def test_create_backup_plan_association_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("backupPlanAssociationId", "requestId", )) & set(("parent", "backupPlanAssociationId", "backupPlanAssociation", )))
...
def test_create_backup_plan_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/backupPlanAssociations" % client.transport._host, args[1])
...
def test_get_backup_plan_association_rest_required_fields(request_type=backupplanassociation.GetBackupPlanAssociationRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_backup_plan_association._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_backup_plan_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/backupPlanAssociations/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/backupPlanAssociations/*}" % client.transport._host, args[1])
...
def test_list_backup_plan_associations_rest_required_fields(request_type=backupplanassociation.ListBackupPlanAssociationsRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_backup_plan_associations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = backupplanassociation.ListBackupPlanAssociationsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_backup_plan_associations_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(backupplanassociation.ListBackupPlanAssociationsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_backup_plan_association_rest_required_fields(request_type=backupplanassociation.DeleteBackupPlanAssociationRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_backup_plan_association._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_trigger_backup_rest_required_fields(request_type=backupplanassociation.TriggerBackupRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).trigger_backup._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_trigger_backup_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "ruleId", )))
...
def test_trigger_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/backupPlanAssociations/*}:triggerBackup" % client.transport._host, args[1])
...
def test_initialize_service_rest_required_fields(request_type=backupdr.InitializeServiceRequest):
    transport_class = transports.BackupDRRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).initialize_service._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_initialize_service_rest_unset_required_fields():
    transport = transports.BackupDRRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.initialize_service._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", "resourceType", )))
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_initialize_service_empty_call_grpc():
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.initialize_service(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_initialize_service_empty_call_grpc_asyncio():
    client = BackupDRAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.initialize_service(request=None)
...
def test_list_management_servers_rest_bad_request(request_type=backupdr.ListManagementServersRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_management_servers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_management_servers") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_management_servers_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_list_management_servers") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupdr.ListManagementServersRequest.pb(backupdr.ListManagementServersRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = backupdr.ListManagementServersResponse.to_json(backupdr.ListManagementServersResponse())
        ...
        post_with_metadata.return_value = backupdr.ListManagementServersResponse(), metadata

        client.list_management_servers(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_management_server_rest_bad_request(request_type=backupdr.GetManagementServerRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/managementServers/sample3'}
    request = request_type(**request_init)
...
def test_get_management_server_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_management_server") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_management_server_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_get_management_server") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupdr.GetManagementServerRequest.pb(backupdr.GetManagementServerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_management_server(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_management_server_rest_bad_request(request_type=backupdr.CreateManagementServerRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_management_server_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupDRRestInterceptor, "post_create_management_server") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_create_management_server_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_create_management_server") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupdr.CreateManagementServerRequest.pb(backupdr.CreateManagementServerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_management_server(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_management_server_rest_bad_request(request_type=backupdr.DeleteManagementServerRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_management_server_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_delete_management_server") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_delete_management_server_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_delete_management_server") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupdr.DeleteManagementServerRequest.pb(backupdr.DeleteManagementServerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_management_server(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_backup_vault_rest_bad_request(request_type=backupvault.CreateBackupVaultRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_backup_vault_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_create_backup_vault") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_create_backup_vault_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_create_backup_vault") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.CreateBackupVaultRequest.pb(backupvault.CreateBackupVaultRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_backup_vault(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_backup_vaults_rest_bad_request(request_type=backupvault.ListBackupVaultsRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_backup_vaults_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_backup_vaults") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_backup_vaults_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_list_backup_vaults") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.ListBackupVaultsRequest.pb(backupvault.ListBackupVaultsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = backupvault.ListBackupVaultsResponse.to_json(backupvault.ListBackupVaultsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = backupvault.ListBackupVaultsResponse(), metadata

        client.list_backup_vaults(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_usable_backup_vaults_rest_bad_request(request_type=backupvault.FetchUsableBackupVaultsRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_fetch_usable_backup_vaults_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_fetch_usable_backup_vaults") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_fetch_usable_backup_vaults_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_fetch_usable_backup_vaults") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.FetchUsableBackupVaultsRequest.pb(backupvault.FetchUsableBackupVaultsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = backupvault.FetchUsableBackupVaultsResponse.to_json(backupvault.FetchUsableBackupVaultsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = backupvault.FetchUsableBackupVaultsResponse(), metadata

        client.fetch_usable_backup_vaults(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_backup_vault_rest_bad_request(request_type=backupvault.GetBackupVaultRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_backup_vault_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_backup_vault") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_backup_vault_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_get_backup_vault") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.GetBackupVaultRequest.pb(backupvault.GetBackupVaultRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_backup_vault(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_backup_vault_rest_bad_request(request_type=backupvault.UpdateBackupVaultRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'backup_vault': {'name': 'projects/sample1/locations/sample2/backupVaults/sample3'}}
    request = request_type(**request_init)
...
def test_update_backup_vault_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_update_backup_vault") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_update_backup_vault_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_update_backup_vault") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.UpdateBackupVaultRequest.pb(backupvault.UpdateBackupVaultRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_backup_vault(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_backup_vault_rest_bad_request(request_type=backupvault.DeleteBackupVaultRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_backup_vault_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_delete_backup_vault") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_delete_backup_vault_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_delete_backup_vault") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.DeleteBackupVaultRequest.pb(backupvault.DeleteBackupVaultRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_backup_vault(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_data_sources_rest_bad_request(request_type=backupvault.ListDataSourcesRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_data_sources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_data_sources") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_data_sources_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_list_data_sources") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.ListDataSourcesRequest.pb(backupvault.ListDataSourcesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = backupvault.ListDataSourcesResponse.to_json(backupvault.ListDataSourcesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = backupvault.ListDataSourcesResponse(), metadata
...
def test_get_data_source_rest_bad_request(request_type=backupvault.GetDataSourceRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/backupVaults/sample3/dataSources/sample4'}
    request = request_type(**request_init)
...
def test_get_data_source_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_data_source") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_data_source_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_get_data_source") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.GetDataSourceRequest.pb(backupvault.GetDataSourceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_data_source_rest_bad_request(request_type=backupvault.UpdateDataSourceRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'data_source': {'name': 'projects/sample1/locations/sample2/backupVaults/sample3/dataSources/sample4'}}
    request = request_type(**request_init)
...
def test_update_data_source_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_update_data_source") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_update_data_source_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_update_data_source") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.UpdateDataSourceRequest.pb(backupvault.UpdateDataSourceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_backups_rest_bad_request(request_type=backupvault.ListBackupsRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/backupVaults/sample3/dataSources/sample4'}
    request = request_type(**request_init)
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_backups") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_backups_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_list_backups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = backupvault.ListBackupsResponse.to_json(backupvault.ListBackupsResponse())
        req.return_value.content = return_value
...
def test_get_backup_rest_bad_request(request_type=backupvault.GetBackupRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/backupVaults/sample3/dataSources/sample4/backups/sample5'}
    request = request_type(**request_init)
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_backup") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_get_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_backup_rest_bad_request(request_type=backupvault.UpdateBackupRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'backup': {'name': 'projects/sample1/locations/sample2/backupVaults/sample3/dataSources/sample4/backups/sample5'}}
    request = request_type(**request_init)
...
def test_update_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_update_backup") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_update_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_update_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.UpdateBackupRequest.pb(backupvault.UpdateBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_delete_backup") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_delete_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_delete_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.DeleteBackupRequest.pb(backupvault.DeleteBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_restore_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_restore_backup") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_restore_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_restore_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupvault.RestoreBackupRequest.pb(backupvault.RestoreBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.restore_backup(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_backup_plan_rest_bad_request(request_type=backupplan.CreateBackupPlanRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_backup_plan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_create_backup_plan") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_create_backup_plan_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_create_backup_plan") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupplan.CreateBackupPlanRequest.pb(backupplan.CreateBackupPlanRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_backup_plan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_backup_plan") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_backup_plan_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_get_backup_plan") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupplan.GetBackupPlanRequest.pb(backupplan.GetBackupPlanRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_backup_plans_rest_bad_request(request_type=backupplan.ListBackupPlansRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_backup_plans_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_backup_plans") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_backup_plans_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_list_backup_plans") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupplan.ListBackupPlansRequest.pb(backupplan.ListBackupPlansRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = backupplan.ListBackupPlansResponse.to_json(backupplan.ListBackupPlansResponse())
        req.return_value.content = return_value
...
def test_delete_backup_plan_rest_bad_request(request_type=backupplan.DeleteBackupPlanRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_backup_plan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_delete_backup_plan") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_delete_backup_plan_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_delete_backup_plan") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupplan.DeleteBackupPlanRequest.pb(backupplan.DeleteBackupPlanRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_backup_plan_association_rest_bad_request(request_type=backupplanassociation.CreateBackupPlanAssociationRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_backup_plan_association_rest_call_success(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["backup_plan_association"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_create_backup_plan_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_create_backup_plan_association") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_create_backup_plan_association_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_create_backup_plan_association") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupplanassociation.CreateBackupPlanAssociationRequest.pb(backupplanassociation.CreateBackupPlanAssociationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_backup_plan_association(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_backup_plan_association_rest_bad_request(request_type=backupplanassociation.GetBackupPlanAssociationRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/backupPlanAssociations/sample3'}
    request = request_type(**request_init)
...
def test_get_backup_plan_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_backup_plan_association") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_get_backup_plan_association_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_get_backup_plan_association") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupplanassociation.GetBackupPlanAssociationRequest.pb(backupplanassociation.GetBackupPlanAssociationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = backupplanassociation.BackupPlanAssociation.to_json(backupplanassociation.BackupPlanAssociation())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = backupplanassociation.BackupPlanAssociation(), metadata

        client.get_backup_plan_association(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_backup_plan_associations_rest_bad_request(request_type=backupplanassociation.ListBackupPlanAssociationsRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_backup_plan_associations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_backup_plan_associations") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_list_backup_plan_associations_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_list_backup_plan_associations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupplanassociation.ListBackupPlanAssociationsRequest.pb(backupplanassociation.ListBackupPlanAssociationsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = backupplanassociation.ListBackupPlanAssociationsResponse.to_json(backupplanassociation.ListBackupPlanAssociationsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = backupplanassociation.ListBackupPlanAssociationsResponse(), metadata

        client.list_backup_plan_associations(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_backup_plan_association_rest_bad_request(request_type=backupplanassociation.DeleteBackupPlanAssociationRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_backup_plan_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_delete_backup_plan_association") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_delete_backup_plan_association_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_delete_backup_plan_association") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupplanassociation.DeleteBackupPlanAssociationRequest.pb(backupplanassociation.DeleteBackupPlanAssociationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_backup_plan_association(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_trigger_backup_rest_bad_request(request_type=backupplanassociation.TriggerBackupRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_trigger_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_trigger_backup") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_trigger_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_trigger_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupplanassociation.TriggerBackupRequest.pb(backupplanassociation.TriggerBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.trigger_backup(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_initialize_service_rest_bad_request(request_type=backupdr.InitializeServiceRequest):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/serviceConfig'}
    request = request_type(**request_init)
...
def test_initialize_service_rest_call_success(request_type):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_initialize_service_rest_interceptors(null_interceptor):
    transport = transports.BackupDRRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BackupDRRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_initialize_service") as post, \
        mock.patch.object(transports.BackupDRRestInterceptor, "post_initialize_service_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupDRRestInterceptor, "pre_initialize_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = backupdr.InitializeServiceRequest.pb(backupdr.InitializeServiceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.initialize_service(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_iam_policy_rest_bad_request(request_type=iam_policy_pb2.GetIamPolicyRequest):
    ...
    request = request_type()
    request = json_format.ParseDict({'resource': 'projects/sample1/locations/sample2/managementServers/sample3'}, request)
...
def test_get_iam_policy_rest(request_type):
    ...
    request_init = {'resource': 'projects/sample1/locations/sample2/managementServers/sample3'}
    request = request_type(**request_init)
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # Designate an appropriate value for the returned response.
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_initialize_service_empty_call_rest():
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_backup_dr_base_transport():
    ...
    with mock.patch('google.cloud.backupdr_v1.services.backup_dr.transports.BackupDRTransport.__init__') as Transport:
...
def test_backup_dr_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.backupdr_v1.services.backup_dr.transports.BackupDRTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_backup_dr_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.backupdr_v1.services.backup_dr.transports.BackupDRTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BackupDRTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.BackupDRGrpcTransport, transports.BackupDRGrpcAsyncIOTransport])
def test_backup_dr_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_backup_dr_host_no_port(transport_name):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='backupdr.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'backupdr.googleapis.com:443'
...
def test_backup_dr_host_with_port(transport_name):
    client = BackupDRClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='backupdr.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
@pytest.mark.parametrize("transport_class", [transports.BackupDRGrpcTransport, transports.BackupDRGrpcAsyncIOTransport])
def test_backup_dr_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.BackupDRGrpcTransport, transports.BackupDRGrpcAsyncIOTransport])
def test_backup_dr_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_backup_path():
    ...
    datasource = "octopus"
    backup = "oyster"
    expected = "projects/{project}/locations/{location}/backupVaults/{backupvault}/dataSources/{datasource}/backups/{backup}".format(project=project, location=location, backupvault=backupvault, datasource=datasource, backup=backup, )
    actual = BackupDRClient.backup_path(project, location, backupvault, datasource, backup)
...
def test_backup_plan_association_path():
    ...
    expected = "projects/{project}/locations/{location}/backupPlanAssociations/{backup_plan_association}".format(project=project, location=location, backup_plan_association=backup_plan_association, )
    actual = BackupDRClient.backup_plan_association_path(project, location, backup_plan_association)
    assert expected == actual
...
def test_backup_vault_path():
    ...
    location = "abalone"
    backupvault = "squid"
    expected = "projects/{project}/locations/{location}/backupVaults/{backupvault}".format(project=project, location=location, backupvault=backupvault, )
...
def test_data_source_path():
    ...
    datasource = "mussel"
    expected = "projects/{project}/locations/{location}/backupVaults/{backupvault}/dataSources/{datasource}".format(project=project, location=location, backupvault=backupvault, datasource=datasource, )
...
def test_management_server_path():
    ...
    expected = "projects/{project}/locations/{location}/managementServers/{managementserver}".format(project=project, location=location, managementserver=managementserver, )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.BackupDRTransport, '_prep_wrapped_messages') as prep:
        client = BackupDRClient(
            credentials=ga_credentials.AnonymousCredentials(),

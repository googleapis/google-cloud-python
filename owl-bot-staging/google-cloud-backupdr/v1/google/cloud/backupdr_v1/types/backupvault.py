...
class RemoveDataSourceRequest(proto.Message):
...
class SetInternalStatusRequest(proto.Message):
    ...
    Attributes:
        ...
        value (bytes):
            Required. The value required for this method
            to work.  This field must be the 32-byte SHA256
            hash of the DataSourceID.  The DataSourceID used
            here is only the final piece of the fully
            qualified resource path for this DataSource
            (i.e. the part after '.../dataSources/'). This
            field exists to make this method difficult to
            call since it is intended for use only by Backup
            Appliances.
        backup_config_state (google.cloud.backupdr_v1.types.BackupConfigState):
            Required. Output only. The new
...
class InitiateBackupResponse(proto.Message):
    r"""Response message for InitiateBackup.

    Attributes:
        backup (str):
            The name of the backup that was created.
        new_backup_generation_id (int):
            The generation id of the new backup.
        base_backup_generation_id (int):
            The generation id of the base backup. It is
            needed for the incremental backups.
    """
    ...
    new_backup_generation_id: int = proto.Field(
        proto.INT32,
        number=2,
    )
    base_backup_generation_id: int = proto.Field(
        proto.INT32,
        number=3,
    )


class AbandonBackupRequest(proto.Message):
...
class FinalizeBackupRequest(proto.Message):
    ...
    Attributes:
        data_source (str):
            ...
            'projects/*/locations/*/backupVaults/*/dataSources/'.
        description (str):
            This will be assigned to the description
            field of the newly created Backup.

            This field is a member of `oneof`_ ``_description``.
        consistency_time (google.protobuf.timestamp_pb2.Timestamp):
            The point in time when this backup was captured from the
            source. This will be assigned to the consistency_time field
        ...
        request_id (str):
            ...
            (00000000-0000-0000-0000-000000000000).
        backup_id (str):
            Required. Resource ID of the Backup resource to be
            finalized. This must be the same backup_id that was used in
            the InitiateBackupRequest.
        recovery_range_start_time (google.protobuf.timestamp_pb2.Timestamp):
            The earliest timestamp of data available in
            this Backup.  This will set on the newly created
            Backup.
        ...
        recovery_range_end_time (google.protobuf.timestamp_pb2.Timestamp):
            The latest timestamp of data available in
            this Backup.  This will be set on the newly
            created Backup.

            This field is a member of `oneof`_ ``_recovery_range_end_time``.
        retention_duration (google.protobuf.duration_pb2.Duration):
            The ExpireTime on the backup will be set to
            FinalizeTime plus this duration.  If the
            resulting ExpireTime is less than
            EnforcedRetentionEndTime, then ExpireTime is set
            to EnforcedRetentionEndTime.
...
class FetchAccessTokenRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            'projects/*/locations/*/backupVaults/*/dataSources'.
        generation_id (int):
            Required. The generation of the backup to
            update.
    """
...
class FetchAccessTokenResponse(proto.Message):
    ...
    Attributes:
        read_location (str):
            The location in bucket that can be used for
            reading.
        write_location (str):
            The location in bucket that can be used for
            writing.
    ...
    read_location: str = proto.Field(
        proto.STRING,
        number=1,
    )
    write_location: str = proto.Field(
        proto.STRING,
        number=2,
    )

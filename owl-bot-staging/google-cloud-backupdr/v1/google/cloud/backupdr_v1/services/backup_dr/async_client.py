...
class BackupDRAsyncClient:
    ...
    async def get_backup_plan_revision(self,
    ...
    async def list_backup_plan_revisions(self,
    ...
    async def update_backup_plan_association(self,
    ...
    async def fetch_backup_plan_associations_for_resource_type(self,
    ...
    async def get_data_source_reference(self,
    ...
    async def fetch_data_source_references_for_resource_type(self,

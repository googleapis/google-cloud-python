...
from google.cloud.backupdr_v1.types import backupplan
from google.cloud.backupdr_v1.types import backupplanassociation
...
from google.cloud.backupdr_v1.types import datasourcereference
...
from .transports.base import BackupDRTransport, DEFAULT_CLIENT_INFO
...
class BackupDRClient(metaclass=BackupDRClientMeta):
    ...
    @staticmethod
    def backup_path(project: str,location: str,backupvault: str,datasource: str,backup: str,) -> str:
        """Returns a fully-qualified backup string."""
        return "projects/{project}/locations/{location}/backupVaults/{backupvault}/dataSources/{datasource}/backups/{backup}".format(project=project, location=location, backupvault=backupvault, datasource=datasource, backup=backup, )

    @staticmethod
    def parse_backup_path(path: str) -> Dict[str,str]:
        """Parses a backup path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupVaults/(?P<backupvault>.+?)/dataSources/(?P<datasource>.+?)/backups/(?P<backup>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def backup_plan_path(project: str,location: str,backup_plan: str,) -> str:
        """Returns a fully-qualified backup_plan string."""
        return "projects/{project}/locations/{location}/backupPlans/{backup_plan}".format(project=project, location=location, backup_plan=backup_plan, )

    @staticmethod
    def parse_backup_plan_path(path: str) -> Dict[str,str]:
        """Parses a backup_plan path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupPlans/(?P<backup_plan>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def backup_plan_association_path(project: str,location: str,backup_plan_association: str,) -> str:
        """Returns a fully-qualified backup_plan_association string."""
        return "projects/{project}/locations/{location}/backupPlanAssociations/{backup_plan_association}".format(project=project, location=location, backup_plan_association=backup_plan_association, )
    ...
    def parse_backup_plan_association_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupPlanAssociations/(?P<backup_plan_association>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def backup_plan_revision_path(project: str,location: str,backup_plan: str,revision: str,) -> str:
        """Returns a fully-qualified backup_plan_revision string."""
        return "projects/{project}/locations/{location}/backupPlans/{backup_plan}/revisions/{revision}".format(project=project, location=location, backup_plan=backup_plan, revision=revision, )

    @staticmethod
    def parse_backup_plan_revision_path(path: str) -> Dict[str,str]:
        """Parses a backup_plan_revision path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupPlans/(?P<backup_plan>.+?)/revisions/(?P<revision>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def backup_vault_path(project: str,location: str,backupvault: str,) -> str:
        """Returns a fully-qualified backup_vault string."""
        return "projects/{project}/locations/{location}/backupVaults/{backupvault}".format(project=project, location=location, backupvault=backupvault, )

    @staticmethod
    def parse_backup_vault_path(path: str) -> Dict[str,str]:
        """Parses a backup_vault path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupVaults/(?P<backupvault>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def data_source_path(project: str,location: str,backupvault: str,datasource: str,) -> str:
        """Returns a fully-qualified data_source string."""
        return "projects/{project}/locations/{location}/backupVaults/{backupvault}/dataSources/{datasource}".format(project=project, location=location, backupvault=backupvault, datasource=datasource, )

    @staticmethod
    def parse_data_source_path(path: str) -> Dict[str,str]:
        """Parses a data_source path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupVaults/(?P<backupvault>.+?)/dataSources/(?P<datasource>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def data_source_reference_path(project: str,location: str,data_source_reference: str,) -> str:
        """Returns a fully-qualified data_source_reference string."""
        return "projects/{project}/locations/{location}/dataSourceReferences/{data_source_reference}".format(project=project, location=location, data_source_reference=data_source_reference, )
    ...
    def parse_data_source_reference_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataSourceReferences/(?P<data_source_reference>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def management_server_path(project: str,location: str,managementserver: str,) -> str:
        """Returns a fully-qualified management_server string."""
        return "projects/{project}/locations/{location}/managementServers/{managementserver}".format(project=project, location=location, managementserver=managementserver, )

    @staticmethod
    def parse_management_server_path(path: str) -> Dict[str,str]:
        """Parses a management_server path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/managementServers/(?P<managementserver>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def storage_pool_path(project: str,zone: str,storage_pool: str,) -> str:
        """Returns a fully-qualified storage_pool string."""
        return "projects/{project}/zones/{zone}/storagePools/{storage_pool}".format(project=project, zone=zone, storage_pool=storage_pool, )

    @staticmethod
    def parse_storage_pool_path(path: str) -> Dict[str,str]:
        """Parses a storage_pool path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/zones/(?P<zone>.+?)/storagePools/(?P<storage_pool>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = BackupDRClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = BackupDRClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = BackupDRClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BackupDRTransport, Callable[..., BackupDRTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = BackupDRClient._read_environment_variables()
        self._client_cert_source = BackupDRClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = BackupDRClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BackupDRTransport], Callable[..., BackupDRTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.backupdr_v1.BackupDRClient`.",
                    extra = {
    ...
    def list_management_servers(self,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1.types.ListManagementServersRequest, dict]):
    ...
    def get_management_server(self,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1.types.GetManagementServerRequest, dict]):
    ...
    def create_management_server(self,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1.types.CreateManagementServerRequest, dict]):
    ...
    def delete_management_server(self,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1.types.DeleteManagementServerRequest, dict]):
    ...
    def fetch_usable_backup_vaults(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_usable_backup_vaults]
    ...
    def get_backup_plan_revision(self,
    ...
    def list_backup_plan_revisions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_backup_plan_revisions]
    ...
    def create_backup_plan_association(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_backup_plan_association]
    ...
    def update_backup_plan_association(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_backup_plan_association]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("backup_plan_association.name", request.backup_plan_association.name),
            )),
        )
    ...
    def get_backup_plan_association(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_backup_plan_association]
    ...
    def list_backup_plan_associations(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_backup_plan_associations]
    ...
    def fetch_backup_plan_associations_for_resource_type(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_backup_plan_associations_for_resource_type]
    ...
    def delete_backup_plan_association(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_backup_plan_association]
    ...
    def get_data_source_reference(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_data_source_reference]
    ...
    def fetch_data_source_references_for_resource_type(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_data_source_references_for_resource_type]

...
class BackupDRClient(metaclass=BackupDRClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BackupDRTransport]] = None,
    ...
    def list_management_servers(self,
        ...
        # in a backupdr.ListManagementServersRequest.
    ...
    def get_management_server(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a backupdr.GetManagementServerRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_management_server(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a backupdr.CreateManagementServerRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_management_server(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a backupdr.DeleteManagementServerRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

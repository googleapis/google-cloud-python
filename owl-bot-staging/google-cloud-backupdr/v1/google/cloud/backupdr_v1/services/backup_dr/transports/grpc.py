...
class BackupDRGrpcTransport(BackupDRTransport):
    ...
    @property
    def get_backup_plan_revision(self) -> Callable[
    ...
    @property
    def list_backup_plan_revisions(self) -> Callable[
    ...
    @property
    def update_backup_plan_association(self) -> Callable[
    ...
    @property
    def fetch_backup_plan_associations_for_resource_type(self) -> Callable[
    ...
    @property
    def get_data_source_reference(self) -> Callable[
    ...
    @property
    def fetch_data_source_references_for_resource_type(self) -> Callable[
    ...
    @property
    def initialize_service(self) -> Callable[

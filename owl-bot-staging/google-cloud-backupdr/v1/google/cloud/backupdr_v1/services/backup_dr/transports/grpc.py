...
from .base import BackupDRTransport, DEFAULT_CLIENT_INFO
...
class BackupDRGrpcTransport(BackupDRTransport):
    ...
    @property
    def list_management_servers(self) -> Callable[
        ...
        if 'list_management_servers' not in self._stubs:
            self._stubs['list_management_servers'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_management_server(self) -> Callable[
        ...
        if 'get_management_server' not in self._stubs:
            self._stubs['get_management_server'] = self.grpc_channel.unary_unary(
    ...
    @property
    def create_management_server(self) -> Callable[
        ...
        if 'create_management_server' not in self._stubs:
            self._stubs['create_management_server'] = self.grpc_channel.unary_unary(
    ...
    @property
    def delete_management_server(self) -> Callable[
        ...
        if 'delete_management_server' not in self._stubs:
            self._stubs['delete_management_server'] = self.grpc_channel.unary_unary(
    ...
    @property
    def fetch_usable_backup_vaults(self) -> Callable[
        ...
        if 'fetch_usable_backup_vaults' not in self._stubs:
            self._stubs['fetch_usable_backup_vaults'] = self.grpc_channel.unary_unary(
    ...
    @property
    def remove_data_source(self) -> Callable[
    ...
    @property
    def set_internal_status(self) -> Callable[
    ...
    @property
    def initiate_backup(self) -> Callable[
    ...
    @property
    def abandon_backup(self) -> Callable[
    ...
    @property
    def finalize_backup(self) -> Callable[
    ...
    @property
    def create_backup_plan_association(self) -> Callable[
        ...
        if 'create_backup_plan_association' not in self._stubs:
            self._stubs['create_backup_plan_association'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_backup_plan_association(self) -> Callable[
        ...
        if 'get_backup_plan_association' not in self._stubs:
            self._stubs['get_backup_plan_association'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_backup_plan_associations(self) -> Callable[
        ...
        if 'list_backup_plan_associations' not in self._stubs:
            self._stubs['list_backup_plan_associations'] = self.grpc_channel.unary_unary(
    ...
    @property
    def delete_backup_plan_association(self) -> Callable[
        ...
        if 'delete_backup_plan_association' not in self._stubs:
            self._stubs['delete_backup_plan_association'] = self.grpc_channel.unary_unary(
    ...
    @property
    def trigger_backup(self) -> Callable[
        ...
        if 'trigger_backup' not in self._stubs:
            self._stubs['trigger_backup'] = self.grpc_channel.unary_unary(

...
def test__read_environment_variables():
    assert ContactCenterInsightsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ContactCenterInsightsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ContactCenterInsightsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ContactCenterInsightsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ContactCenterInsightsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert ContactCenterInsightsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ContactCenterInsightsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ContactCenterInsightsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ContactCenterInsightsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ContactCenterInsightsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ContactCenterInsightsClient))
@mock.patch.object(ContactCenterInsightsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ContactCenterInsightsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ContactCenterInsightsClient._DEFAULT_UNIVERSE
    default_endpoint = ContactCenterInsightsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ContactCenterInsightsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ContactCenterInsightsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ContactCenterInsightsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ContactCenterInsightsClient.DEFAULT_MTLS_ENDPOINT
    assert ContactCenterInsightsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ContactCenterInsightsClient._get_api_endpoint(None, None, default_universe, "always") == ContactCenterInsightsClient.DEFAULT_MTLS_ENDPOINT
    assert ContactCenterInsightsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ContactCenterInsightsClient.DEFAULT_MTLS_ENDPOINT
    assert ContactCenterInsightsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ContactCenterInsightsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ContactCenterInsightsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ContactCenterInsightsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ContactCenterInsightsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ContactCenterInsightsClient._get_universe_domain(None, None) == ContactCenterInsightsClient._DEFAULT_UNIVERSE
...
def test_bulk_delete_conversations(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.bulk_delete_conversations),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_conversation_rest_unset_required_fields():
    transport = transports.ContactCenterInsightsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_upload_conversation_rest_required_fields(request_type=contact_center_insights.UploadConversationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).upload_conversation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_analysis_rest_required_fields(request_type=contact_center_insights.CreateAnalysisRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_analysis._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_analysis_rest_required_fields(request_type=contact_center_insights.GetAnalysisRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_analysis._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_analyses_rest_required_fields(request_type=contact_center_insights.ListAnalysesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_analyses._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_analysis_rest_required_fields(request_type=contact_center_insights.DeleteAnalysisRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_analysis._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_bulk_analyze_conversations_rest_required_fields(request_type=contact_center_insights.BulkAnalyzeConversationsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).bulk_analyze_conversations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_bulk_delete_conversations_rest_required_fields(request_type=contact_center_insights.BulkDeleteConversationsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).bulk_delete_conversations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_bulk_delete_conversations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_bulk_delete_conversations") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_bulk_delete_conversations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_ingest_conversations_rest_required_fields(request_type=contact_center_insights.IngestConversationsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).ingest_conversations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_insights_data_rest_required_fields(request_type=contact_center_insights.ExportInsightsDataRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).export_insights_data._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_issue_model_rest_required_fields(request_type=contact_center_insights.CreateIssueModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_issue_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_issue_model_rest_required_fields(request_type=contact_center_insights.UpdateIssueModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_issue_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_issue_model_rest_required_fields(request_type=contact_center_insights.GetIssueModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_issue_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_issue_models_rest_required_fields(request_type=contact_center_insights.ListIssueModelsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_issue_models._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_issue_model_rest_required_fields(request_type=contact_center_insights.DeleteIssueModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_issue_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_deploy_issue_model_rest_required_fields(request_type=contact_center_insights.DeployIssueModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).deploy_issue_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_undeploy_issue_model_rest_required_fields(request_type=contact_center_insights.UndeployIssueModelRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).undeploy_issue_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_issue_rest_required_fields(request_type=contact_center_insights.GetIssueRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_issue._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_issues_rest_required_fields(request_type=contact_center_insights.ListIssuesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_issues._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_issue_rest_required_fields(request_type=contact_center_insights.UpdateIssueRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_issue._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_issue_rest_required_fields(request_type=contact_center_insights.DeleteIssueRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_issue._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_calculate_issue_model_stats_rest_required_fields(request_type=contact_center_insights.CalculateIssueModelStatsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).calculate_issue_model_stats._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_phrase_matcher_rest_required_fields(request_type=contact_center_insights.CreatePhraseMatcherRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_phrase_matcher._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_phrase_matcher_rest_required_fields(request_type=contact_center_insights.GetPhraseMatcherRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_phrase_matcher._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_phrase_matchers_rest_required_fields(request_type=contact_center_insights.ListPhraseMatchersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_phrase_matchers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_phrase_matcher_rest_required_fields(request_type=contact_center_insights.DeletePhraseMatcherRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_phrase_matcher._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_phrase_matcher_rest_required_fields(request_type=contact_center_insights.UpdatePhraseMatcherRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_phrase_matcher._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_calculate_stats_rest_required_fields(request_type=contact_center_insights.CalculateStatsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).calculate_stats._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_view_rest_required_fields(request_type=contact_center_insights.CreateViewRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_view_rest_required_fields(request_type=contact_center_insights.GetViewRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_views_rest_required_fields(request_type=contact_center_insights.ListViewsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_views._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_view_rest_required_fields(request_type=contact_center_insights.UpdateViewRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_view_rest_required_fields(request_type=contact_center_insights.DeleteViewRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_view._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

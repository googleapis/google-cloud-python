...
class ContactCenterInsightsTransport(abc.ABC):
    ...
    @property
    def upload_conversation(self) -> Callable[
    ...
    @property
    def bulk_delete_conversations(self) -> Callable[
    ...
    @property
    def export_issue_model(self) -> Callable[
    ...
    @property
    def import_issue_model(self) -> Callable[
    ...
    @property
    def create_analysis_rule(self) -> Callable[
    ...
    @property
    def get_analysis_rule(self) -> Callable[
    ...
    @property
    def list_analysis_rules(self) -> Callable[
    ...
    @property
    def update_analysis_rule(self) -> Callable[
    ...
    @property
    def delete_analysis_rule(self) -> Callable[
    ...
    @property
    def query_metrics(self) -> Callable[
    ...
    @property
    def create_qa_question(self) -> Callable[
    ...
    @property
    def get_qa_question(self) -> Callable[
    ...
    @property
    def update_qa_question(self) -> Callable[
    ...
    @property
    def delete_qa_question(self) -> Callable[
    ...
    @property
    def list_qa_questions(self) -> Callable[
    ...
    @property
    def create_qa_scorecard(self) -> Callable[
    ...
    @property
    def get_qa_scorecard(self) -> Callable[
    ...
    @property
    def update_qa_scorecard(self) -> Callable[
    ...
    @property
    def delete_qa_scorecard(self) -> Callable[
    ...
    @property
    def list_qa_scorecards(self) -> Callable[
    ...
    @property
    def create_qa_scorecard_revision(self) -> Callable[
    ...
    @property
    def get_qa_scorecard_revision(self) -> Callable[
    ...
    @property
    def tune_qa_scorecard_revision(self) -> Callable[
    ...
    @property
    def deploy_qa_scorecard_revision(self) -> Callable[
    ...
    @property
    def undeploy_qa_scorecard_revision(self) -> Callable[
    ...
    @property
    def delete_qa_scorecard_revision(self) -> Callable[
    ...
    @property
    def list_qa_scorecard_revisions(self) -> Callable[
    ...
    @property
    def create_feedback_label(self) -> Callable[
    ...
    @property
    def list_feedback_labels(self) -> Callable[
    ...
    @property
    def get_feedback_label(self) -> Callable[
    ...
    @property
    def update_feedback_label(self) -> Callable[
    ...
    @property
    def delete_feedback_label(self) -> Callable[
    ...
    @property
    def list_all_feedback_labels(self) -> Callable[
    ...
    @property
    def bulk_upload_feedback_labels(self) -> Callable[
    ...
    @property
    def bulk_download_feedback_labels(self) -> Callable[

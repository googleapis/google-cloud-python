...
class ContactCenterInsightsClient(metaclass=ContactCenterInsightsClientMeta):
    ...
    @staticmethod
    def analysis_rule_path(project: str,location: str,analysis_rule: str,) -> str:
        """Returns a fully-qualified analysis_rule string."""
        return "projects/{project}/locations/{location}/analysisRules/{analysis_rule}".format(project=project, location=location, analysis_rule=analysis_rule, )
    ...
    @staticmethod
    def conversation_profile_path(project: str,location: str,conversation_profile: str,) -> str:
        """Returns a fully-qualified conversation_profile string."""
        return "projects/{project}/locations/{location}/conversationProfiles/{conversation_profile}".format(project=project, location=location, conversation_profile=conversation_profile, )
    ...
    @staticmethod
    def feedback_label_path(project: str,location: str,conversation: str,feedback_label: str,) -> str:
        """Returns a fully-qualified feedback_label string."""
        return "projects/{project}/locations/{location}/conversations/{conversation}/feedbackLabels/{feedback_label}".format(project=project, location=location, conversation=conversation, feedback_label=feedback_label, )

    @staticmethod
    def parse_feedback_label_path(path: str) -> Dict[str,str]:
        """Parses a feedback_label path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/conversations/(?P<conversation>.+?)/feedbackLabels/(?P<feedback_label>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def qa_question_path(project: str,location: str,qa_scorecard: str,revision: str,qa_question: str,) -> str:
        """Returns a fully-qualified qa_question string."""
        return "projects/{project}/locations/{location}/qaScorecards/{qa_scorecard}/revisions/{revision}/qaQuestions/{qa_question}".format(project=project, location=location, qa_scorecard=qa_scorecard, revision=revision, qa_question=qa_question, )

    @staticmethod
    def parse_qa_question_path(path: str) -> Dict[str,str]:
        """Parses a qa_question path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/qaScorecards/(?P<qa_scorecard>.+?)/revisions/(?P<revision>.+?)/qaQuestions/(?P<qa_question>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def qa_scorecard_path(project: str,location: str,qa_scorecard: str,) -> str:
        """Returns a fully-qualified qa_scorecard string."""
        return "projects/{project}/locations/{location}/qaScorecards/{qa_scorecard}".format(project=project, location=location, qa_scorecard=qa_scorecard, )
    ...
    @staticmethod
    def qa_scorecard_result_path(project: str,location: str,qa_scorecard_result: str,) -> str:
        """Returns a fully-qualified qa_scorecard_result string."""
        return "projects/{project}/locations/{location}/qaScorecardResults/{qa_scorecard_result}".format(project=project, location=location, qa_scorecard_result=qa_scorecard_result, )
    ...
    @staticmethod
    def qa_scorecard_revision_path(project: str,location: str,qa_scorecard: str,revision: str,) -> str:
        """Returns a fully-qualified qa_scorecard_revision string."""
        return "projects/{project}/locations/{location}/qaScorecards/{qa_scorecard}/revisions/{revision}".format(project=project, location=location, qa_scorecard=qa_scorecard, revision=revision, )
    ...
    @staticmethod
    def recognizer_path(project: str,location: str,recognizer: str,) -> str:
        """Returns a fully-qualified recognizer string."""
        return "projects/{project}/locations/{location}/recognizers/{recognizer}".format(project=project, location=location, recognizer=recognizer, )
    ...
    def view_path(project: str,location: str,view: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/views/{view}".format(project=project, location=location, view=view, )
    ...
    def bulk_analyze_conversations(self,
    ...
    def bulk_delete_conversations(self,
    ...
    def update_phrase_matcher(self,
    ...
    def create_qa_scorecard_revision(self,
    ...
    def get_qa_scorecard_revision(self,
    ...
    def tune_qa_scorecard_revision(self,
    ...
    def deploy_qa_scorecard_revision(self,
    ...
    def undeploy_qa_scorecard_revision(self,
    ...
    def delete_qa_scorecard_revision(self,
    ...
    def list_qa_scorecard_revisions(self,
    ...
    def delete_feedback_label(self,
    ...
    def list_all_feedback_labels(self,
    ...
    def bulk_upload_feedback_labels(self,
    ...
    def bulk_download_feedback_labels(self,

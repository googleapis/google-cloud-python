...
from google.cloud.bigquery_datapolicies_v1.services.data_policy_service import DataPolicyServiceAsyncClient
...
from google.cloud.bigquery_datapolicies_v1.services.data_policy_service import transports
...
def test_data_policy_service_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery_datapolicies_v1.services.data_policy_service.transports.DataPolicyServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_data_policy_rest(request_type):
    ...
    request_init["data_policy"] = {'policy_tag': 'policy_tag_value', 'data_masking_policy': {'predefined_expression': 3, 'routine': 'routine_value'}, 'name': 'name_value', 'data_policy_type': 3, 'data_policy_id': 'data_policy_id_value'}
...
def test_create_data_policy_rest_required_fields(request_type=datapolicy.CreateDataPolicyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_data_policy._get_unset_required_fields(jsonified_request)
...
def test_create_data_policy_rest_unset_required_fields():
    transport = transports.DataPolicyServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_data_policy_rest(request_type):
    ...
    request_init["data_policy"] = {'policy_tag': 'policy_tag_value', 'data_masking_policy': {'predefined_expression': 3, 'routine': 'routine_value'}, 'name': 'projects/sample1/locations/sample2/dataPolicies/sample3', 'data_policy_type': 3, 'data_policy_id': 'data_policy_id_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_data_policy_rest_required_fields(request_type=datapolicy.UpdateDataPolicyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_data_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_rename_data_policy_rest_required_fields(request_type=datapolicy.RenameDataPolicyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).rename_data_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_data_policy_rest_required_fields(request_type=datapolicy.DeleteDataPolicyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_data_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_data_policy_rest_required_fields(request_type=datapolicy.GetDataPolicyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_data_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_data_policies_rest_required_fields(request_type=datapolicy.ListDataPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_data_policies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_data_policy_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery_datapolicies_v1.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_data_policy_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery_datapolicies_v1.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.DataPolicyServiceTransport()
        adc.assert_called_once()

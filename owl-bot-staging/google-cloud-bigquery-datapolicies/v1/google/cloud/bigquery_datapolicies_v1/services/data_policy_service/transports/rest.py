...
class DataPolicyServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_data_policy(self, request: datapolicy.CreateDataPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.CreateDataPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_data_policy_with_metadata(self, response: datapolicy.DataPolicy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.DataPolicy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_data_policy
    ...
    def pre_delete_data_policy(self, request: datapolicy.DeleteDataPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.DeleteDataPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_data_policy(self, request: datapolicy.GetDataPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.GetDataPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_data_policy_with_metadata(self, response: datapolicy.DataPolicy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.DataPolicy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_data_policy
    ...
    def pre_list_data_policies(self, request: datapolicy.ListDataPoliciesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.ListDataPoliciesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_data_policies_with_metadata(self, response: datapolicy.ListDataPoliciesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.ListDataPoliciesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_data_policies
    ...
    def pre_rename_data_policy(self, request: datapolicy.RenameDataPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.RenameDataPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_rename_data_policy(self, response: datapolicy.DataPolicy) -> datapolicy.DataPolicy:
    ...
    def post_rename_data_policy_with_metadata(self, response: datapolicy.DataPolicy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.DataPolicy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for rename_data_policy
    ...
    def pre_update_data_policy(self, request: datapolicy.UpdateDataPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.UpdateDataPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_data_policy_with_metadata(self, response: datapolicy.DataPolicy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.DataPolicy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_data_policy
...
class DataPolicyServiceRestTransport(_BaseDataPolicyServiceRestTransport):
    ...
    class _CreateDataPolicy(_BaseDataPolicyServiceRestTransport._BaseCreateDataPolicy, DataPolicyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataPolicyServiceRestTransport._CreateDataPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteDataPolicy(_BaseDataPolicyServiceRestTransport._BaseDeleteDataPolicy, DataPolicyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataPolicyServiceRestTransport._DeleteDataPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetDataPolicy(_BaseDataPolicyServiceRestTransport._BaseGetDataPolicy, DataPolicyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataPolicyServiceRestTransport._GetDataPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseDataPolicyServiceRestTransport._BaseGetIamPolicy, DataPolicyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataPolicyServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListDataPolicies(_BaseDataPolicyServiceRestTransport._BaseListDataPolicies, DataPolicyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataPolicyServiceRestTransport._ListDataPolicies._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RenameDataPolicy(_BaseDataPolicyServiceRestTransport._BaseRenameDataPolicy, DataPolicyServiceRestStub):
        def __hash__(self):
            return hash("DataPolicyServiceRestTransport.RenameDataPolicy")
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_rename_data_policy(request, metadata)
            transcoded_request = _BaseDataPolicyServiceRestTransport._BaseRenameDataPolicy._get_transcoded_request(http_options, request)

            body = _BaseDataPolicyServiceRestTransport._BaseRenameDataPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDataPolicyServiceRestTransport._BaseRenameDataPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DataPolicyServiceRestTransport._RenameDataPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_rename_data_policy_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = datapolicy.DataPolicy.to_json(response)
                except:
    ...
    class _SetIamPolicy(_BaseDataPolicyServiceRestTransport._BaseSetIamPolicy, DataPolicyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataPolicyServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseDataPolicyServiceRestTransport._BaseTestIamPermissions, DataPolicyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataPolicyServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateDataPolicy(_BaseDataPolicyServiceRestTransport._BaseUpdateDataPolicy, DataPolicyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataPolicyServiceRestTransport._UpdateDataPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def create_data_policy(self) -> Callable[
    ...
    @property
    def delete_data_policy(self) -> Callable[
    ...
    @property
    def get_data_policy(self) -> Callable[
    ...
    @property
    def list_data_policies(self) -> Callable[
    ...
    @property
    def rename_data_policy(self) -> Callable[
            [datapolicy.RenameDataPolicyRequest],
            datapolicy.DataPolicy]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._RenameDataPolicy(self._session, self._host, self._interceptor) # type: ignore
    ...
    @property
    def update_data_policy(self) -> Callable[

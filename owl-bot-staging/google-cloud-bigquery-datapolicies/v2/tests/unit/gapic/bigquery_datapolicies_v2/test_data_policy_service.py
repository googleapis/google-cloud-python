...
from google.cloud.bigquery_datapolicies_v2.services.data_policy_service import DataPolicyServiceAsyncClient
from google.cloud.bigquery_datapolicies_v2.services.data_policy_service import DataPolicyServiceClient
from google.cloud.bigquery_datapolicies_v2.services.data_policy_service import pagers
from google.cloud.bigquery_datapolicies_v2.services.data_policy_service import transports
...
def test_data_policy_service_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery_datapolicies_v2.services.data_policy_service.transports.DataPolicyServiceGrpcTransport.__init__') as grpc_transport:
...
def test_update_data_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "updateMask", )) & set(("dataPolicy", )))
...
def test_update_data_policy_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'data_policy': {'name': 'projects/sample1/locations/sample2/dataPolicies/sample3'}}
    request_init["data_policy"] = {'data_masking_policy': {'predefined_expression': 1, 'routine': 'routine_value'}, 'name': 'projects/sample1/locations/sample2/dataPolicies/sample3', 'data_policy_id': 'data_policy_id_value', 'etag': 'etag_value', 'data_policy_type': 1, 'policy_tag': 'policy_tag_value', 'grantees': ['grantees_value1', 'grantees_value2'], 'version': 1}
...
def test_data_policy_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery_datapolicies_v2.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_data_policy_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery_datapolicies_v2.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataPolicyServiceTransport()
        adc.assert_called_once()
...
def test_routine_path():
    ...
    dataset = "octopus"
    routine = "oyster"
    expected = "projects/{project}/datasets/{dataset}/routines/{routine}".format(project=project, dataset=dataset, routine=routine, )

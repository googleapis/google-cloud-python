...
# [START bigquerydatapolicy_v2_generated_DataPolicyService_AddGrantees_sync]
...
def sample_add_grantees():
    ...
    # Make the request
    response = client.add_grantees(request=request)

    # Handle the response
    print(response)

# [END bigquerydatapolicy_v2_generated_DataPolicyService_AddGrantees_sync]

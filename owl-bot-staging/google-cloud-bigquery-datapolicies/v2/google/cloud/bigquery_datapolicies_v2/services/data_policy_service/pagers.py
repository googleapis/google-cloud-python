...
class ListDataPoliciesPager:
    ...
    :class:`google.cloud.bigquery_datapolicies_v2.types.ListDataPoliciesResponse` object, and
    ...
    All the usual :class:`google.cloud.bigquery_datapolicies_v2.types.ListDataPoliciesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.bigquery_datapolicies_v2.types.ListDataPoliciesRequest):
                The initial request object.
            response (google.cloud.bigquery_datapolicies_v2.types.ListDataPoliciesResponse):

...
class DataPolicyServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_add_grantees(self, request: datapolicy.AddGranteesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.AddGranteesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_add_grantees_with_metadata(self, response: datapolicy.DataPolicy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.DataPolicy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for add_grantees
    ...
    def pre_remove_grantees(self, request: datapolicy.RemoveGranteesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.RemoveGranteesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_remove_grantees_with_metadata(self, response: datapolicy.DataPolicy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datapolicy.DataPolicy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for remove_grantees
...
class DataPolicyServiceRestTransport(_BaseDataPolicyServiceRestTransport):
    ...
    class _AddGrantees(_BaseDataPolicyServiceRestTransport._BaseAddGrantees, DataPolicyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataPolicyServiceRestTransport._AddGrantees._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _RemoveGrantees(_BaseDataPolicyServiceRestTransport._BaseRemoveGrantees, DataPolicyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataPolicyServiceRestTransport._RemoveGrantees._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

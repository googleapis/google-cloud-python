...
from google.cloud.bigquery_datapolicies_v2 import gapic_version as package_version
...
from google.cloud.bigquery_datapolicies_v2.services.data_policy_service import pagers
...
class DataPolicyServiceAsyncClient:
    ...
    async def create_data_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2.types.CreateDataPolicyRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            data_policy (:class:`google.cloud.bigquery_datapolicies_v2.types.DataPolicy`):
    ...
    async def add_grantees(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2.types.AddGranteesRequest, dict]]):
    ...
    async def remove_grantees(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2.types.RemoveGranteesRequest, dict]]):
                The request object. Request message for the
    ...
    async def update_data_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2.types.UpdateDataPolicyRequest, dict]]):
                The request object. Request message for the
    ...
    async def delete_data_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2.types.DeleteDataPolicyRequest, dict]]):
                The request object. Request message for the
    ...
    async def get_data_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2.types.GetDataPolicyRequest, dict]]):
    ...
    async def list_data_policies(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2.types.ListDataPoliciesRequest, dict]]):
                The request object. Request message for the
        ...
        Returns:
            google.cloud.bigquery_datapolicies_v2.services.data_policy_service.pagers.ListDataPoliciesAsyncPager:

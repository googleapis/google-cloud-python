...
class DataPolicyServiceClient(metaclass=DataPolicyServiceClientMeta):
    ...
    def create_data_policy(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2.types.CreateDataPolicyRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            data_policy (google.cloud.bigquery.datapolicies_v2.types.DataPolicy):
    ...
    def add_grantees(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2.types.AddGranteesRequest, dict]):
    ...
    def remove_grantees(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2.types.RemoveGranteesRequest, dict]):
                The request object. Request message for the
    ...
    def update_data_policy(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2.types.UpdateDataPolicyRequest, dict]):
                The request object. Request message for the
    ...
    def delete_data_policy(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2.types.DeleteDataPolicyRequest, dict]):
                The request object. Request message for the
    ...
    def get_data_policy(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2.types.GetDataPolicyRequest, dict]):
    ...
    def list_data_policies(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2.types.ListDataPoliciesRequest, dict]):
                The request object. Request message for the
        ...
        Returns:
            google.cloud.bigquery.datapolicies_v2.services.data_policy_service.pagers.ListDataPoliciesPager:

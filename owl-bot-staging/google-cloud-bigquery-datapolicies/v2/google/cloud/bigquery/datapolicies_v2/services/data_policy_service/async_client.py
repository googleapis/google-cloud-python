...
from google.cloud.bigquery.datapolicies_v2 import gapic_version as package_version
...
from google.cloud.bigquery.datapolicies_v2.services.data_policy_service import pagers
from google.cloud.bigquery.datapolicies_v2.types import datapolicy
from google.iam.v1 import iam_policy_pb2  # type: ignore
from google.iam.v1 import policy_pb2  # type: ignore
from google.protobuf import field_mask_pb2  # type: ignore
from .transports.base import DataPolicyServiceTransport, DEFAULT_CLIENT_INFO
...
class DataPolicyServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = DataPolicyServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = DataPolicyServiceClient._DEFAULT_UNIVERSE

    data_policy_path = staticmethod(DataPolicyServiceClient.data_policy_path)
    parse_data_policy_path = staticmethod(DataPolicyServiceClient.parse_data_policy_path)
    policy_tag_path = staticmethod(DataPolicyServiceClient.policy_tag_path)
    parse_policy_tag_path = staticmethod(DataPolicyServiceClient.parse_policy_tag_path)
    routine_path = staticmethod(DataPolicyServiceClient.routine_path)
    parse_routine_path = staticmethod(DataPolicyServiceClient.parse_routine_path)
    common_billing_account_path = staticmethod(DataPolicyServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(DataPolicyServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(DataPolicyServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(DataPolicyServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(DataPolicyServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(DataPolicyServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(DataPolicyServiceClient.common_project_path)
    parse_common_project_path = staticmethod(DataPolicyServiceClient.parse_common_project_path)
    common_location_path = staticmethod(DataPolicyServiceClient.common_location_path)
    parse_common_location_path = staticmethod(DataPolicyServiceClient.parse_common_location_path)
    ...
    get_transport_class = DataPolicyServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, DataPolicyServiceTransport, Callable[..., DataPolicyServiceTransport]]] = "grpc_asyncio",
            client_options: Optional[ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the data policy service async client.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.bigquery.datapolicies_v2.DataPolicyServiceAsyncClient`.",
                extra = {
    ...
    async def create_data_policy(self,
        ...
        .. code-block:: python
            ...
            from google.cloud.bigquery import datapolicies_v2

            async def sample_create_data_policy():
                # Create a client
                client = datapolicies_v2.DataPolicyServiceAsyncClient()

                # Initialize request argument(s)
                data_policy = datapolicies_v2.DataPolicy()
                data_policy.data_masking_policy.predefined_expression = "RANDOM_HASH"
                data_policy.data_policy_type = "COLUMN_LEVEL_SECURITY_POLICY"

                request = datapolicies_v2.CreateDataPolicyRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery.datapolicies_v2.types.CreateDataPolicyRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            data_policy (:class:`google.cloud.bigquery.datapolicies_v2.types.DataPolicy`):
        ...
        Returns:
            google.cloud.bigquery.datapolicies_v2.types.DataPolicy:
                Represents the label-policy binding.
        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, data_policy, data_policy_id]
        ...
        if data_policy_id is not None:
            request.data_policy_id = data_policy_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_data_policy]
    ...
    async def add_grantees(self,
            request: Optional[Union[datapolicy.AddGranteesRequest, dict]] = None,
            *,
            data_policy: Optional[str] = None,
            grantees: Optional[MutableSequence[str]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> datapolicy.DataPolicy:
        r"""Adds new grantees to a data policy.
        ...
        .. code-block:: python
            ...
            async def sample_add_grantees():
                # Create a client
                client = datapolicies_v2.DataPolicyServiceAsyncClient()

                # Initialize request argument(s)
                request = datapolicies_v2.AddGranteesRequest(
                    data_policy="data_policy_value",
                    grantees=['grantees_value1', 'grantees_value2'],
                )

                # Make the request
                response = await client.add_grantees(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.bigquery.datapolicies_v2.types.AddGranteesRequest, dict]]):
                The request object. Request message for the AddGrantees
                method.
            data_policy (:class:`str`):
                Required. Resource name of this data policy, in the
                format of
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            grantees (:class:`MutableSequence[str]`):
                Required. IAM principal that should be granted Fine
                Grained Access to the underlying data goverened by the
                data policy. The target data policy is determined by the
                ``data_policy`` field.
                ...
                This corresponds to the ``grantees`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [data_policy, grantees]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, datapolicy.AddGranteesRequest):
            request = datapolicy.AddGranteesRequest(request)
        ...
        if data_policy is not None:
            request.data_policy = data_policy
        if grantees:
            request.grantees.extend(grantees)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.add_grantees]
    ...
    async def remove_grantees(self,
            request: Optional[Union[datapolicy.RemoveGranteesRequest, dict]] = None,
            *,
            data_policy: Optional[str] = None,
            grantees: Optional[MutableSequence[str]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        r"""Removes grantees from a data policy.
        ...
        .. code-block:: python
            ...
            async def sample_remove_grantees():
                # Create a client
                client = datapolicies_v2.DataPolicyServiceAsyncClient()

                # Initialize request argument(s)
                request = datapolicies_v2.RemoveGranteesRequest(
                    data_policy="data_policy_value",
                    grantees=['grantees_value1', 'grantees_value2'],
                )

                # Make the request
                response = await client.remove_grantees(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.bigquery.datapolicies_v2.types.RemoveGranteesRequest, dict]]):
                The request object. Request message for the
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, datapolicy.RemoveGranteesRequest):
            request = datapolicy.RemoveGranteesRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.remove_grantees]
    ...
    async def update_data_policy(self,
        ...
        .. code-block:: python
            ...
            async def sample_update_data_policy():
                ...
                request = datapolicies_v2.UpdateDataPolicyRequest(
                    data_policy=data_policy,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery.datapolicies_v2.types.UpdateDataPolicyRequest, dict]]):
                The request object. Request message for the
            ...
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                Optional. The update mask applies to the resource. For
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [data_policy, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_data_policy]
    ...
    async def delete_data_policy(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_data_policy():
                ...
                # Initialize request argument(s)
                request = datapolicies_v2.DeleteDataPolicyRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery.datapolicies_v2.types.DeleteDataPolicyRequest, dict]]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_data_policy]
    ...
    async def get_data_policy(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_data_policy():
                ...
                # Initialize request argument(s)
                request = datapolicies_v2.GetDataPolicyRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery.datapolicies_v2.types.GetDataPolicyRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_data_policy]
    ...
    async def list_data_policies(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_data_policies():
                ...
                # Initialize request argument(s)
                request = datapolicies_v2.ListDataPoliciesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery.datapolicies_v2.types.ListDataPoliciesRequest, dict]]):
                The request object. Request message for the
        ...
        Returns:
            google.cloud.bigquery.datapolicies_v2.services.data_policy_service.pagers.ListDataPoliciesAsyncPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_data_policies]

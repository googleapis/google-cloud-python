...
from google.cloud.bigquery.datapolicies_v2beta1.services.data_policy_service import pagers
...
class DataPolicyServiceClient(metaclass=DataPolicyServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "bigquerydatapolicy.{UNIVERSE_DOMAIN}"
    ...
    @staticmethod
    def data_policy_path(project: str,location: str,data_policy: str,) -> str:
        """Returns a fully-qualified data_policy string."""
        return "projects/{project}/locations/{location}/dataPolicies/{data_policy}".format(project=project, location=location, data_policy=data_policy, )

    @staticmethod
    def parse_data_policy_path(path: str) -> Dict[str,str]:
        """Parses a data_policy path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataPolicies/(?P<data_policy>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DataPolicyServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DataPolicyServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = DataPolicyServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DataPolicyServiceTransport, Callable[..., DataPolicyServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DataPolicyServiceClient._read_environment_variables()
        self._client_cert_source = DataPolicyServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DataPolicyServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DataPolicyServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(DataPolicyServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DataPolicyServiceTransport], Callable[..., DataPolicyServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.bigquery.datapolicies_v2beta1.DataPolicyServiceClient`.",
                    extra = {
    ...
    def create_data_policy(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2beta1.types.CreateDataPolicyRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            data_policy (google.cloud.bigquery.datapolicies_v2beta1.types.DataPolicy):
        ...
        Returns:
            google.cloud.bigquery.datapolicies_v2beta1.types.DataPolicy:
    ...
    def add_grantees(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2beta1.types.AddGranteesRequest, dict]):
        ...
        if not isinstance(request, datapolicy.AddGranteesRequest):
            ...
            if grantees is not None:
                request.grantees = grantees

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.add_grantees]
    ...
    def remove_grantees(self,
        ...
        .. code-block:: python
            ...
            def sample_remove_grantees():
                ...
                # Initialize request argument(s)
                request = datapolicies_v2beta1.RemoveGranteesRequest(
                    data_policy="data_policy_value",
                    grantees=['grantees_value1', 'grantees_value2'],
                )
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2beta1.types.RemoveGranteesRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.remove_grantees]
    ...
    def update_data_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_update_data_policy():
                ...
                request = datapolicies_v2beta1.UpdateDataPolicyRequest(
                    data_policy=data_policy,
                )
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2beta1.types.UpdateDataPolicyRequest, dict]):
                The request object. Request message for the
    ...
    def delete_data_policy(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2beta1.types.DeleteDataPolicyRequest, dict]):
                The request object. Request message for the
    ...
    def get_data_policy(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2beta1.types.GetDataPolicyRequest, dict]):
    ...
    def list_data_policies(self,
        ...
        .. code-block:: python
            ...
            def sample_list_data_policies():
                ...
                # Initialize request argument(s)
                request = datapolicies_v2beta1.ListDataPoliciesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.bigquery.datapolicies_v2beta1.types.ListDataPoliciesRequest, dict]):
                The request object. Request message for the
        ...
        Returns:
            google.cloud.bigquery.datapolicies_v2beta1.services.data_policy_service.pagers.ListDataPoliciesPager:

...
class ListDataPoliciesPager:
    ...
    :class:`google.cloud.bigquery_datapolicies_v2beta1.types.ListDataPoliciesResponse` object, and
    ...
    All the usual :class:`google.cloud.bigquery_datapolicies_v2beta1.types.ListDataPoliciesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.bigquery_datapolicies_v2beta1.types.ListDataPoliciesRequest):
                The initial request object.
            response (google.cloud.bigquery_datapolicies_v2beta1.types.ListDataPoliciesResponse):
    ...
    @property
    def pages(self) -> Iterator[datapolicy.ListDataPoliciesResponse]:
    ...
    def __iter__(self) -> Iterator[datapolicy.DataPolicy]:
        for page in self.pages:
            yield from page.data_policies
...
class ListDataPoliciesAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[datapolicy.ListDataPoliciesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
            yield self._response
    def __aiter__(self) -> AsyncIterator[datapolicy.DataPolicy]:
        async def async_generator():
            async for page in self.pages:
                for response in page.data_policies:
                    yield response

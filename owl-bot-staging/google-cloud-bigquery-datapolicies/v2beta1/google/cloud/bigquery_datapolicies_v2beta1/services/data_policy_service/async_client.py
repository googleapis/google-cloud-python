...
class DataPolicyServiceAsyncClient:
    ...
    async def create_data_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2beta1.types.CreateDataPolicyRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            data_policy (:class:`google.cloud.bigquery_datapolicies_v2beta1.types.DataPolicy`):
        ...
        Returns:
            google.cloud.bigquery_datapolicies_v2beta1.types.DataPolicy:
    ...
    async def add_grantees(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2beta1.types.AddGranteesRequest, dict]]):
    ...
    async def remove_grantees(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2beta1.types.RemoveGranteesRequest, dict]]):
                The request object. Request message for the
    ...
    async def update_data_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2beta1.types.UpdateDataPolicyRequest, dict]]):
                The request object. Request message for the
    ...
    async def delete_data_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2beta1.types.DeleteDataPolicyRequest, dict]]):
                The request object. Request message for the
    ...
    async def get_data_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2beta1.types.GetDataPolicyRequest, dict]]):
    ...
    async def list_data_policies(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_data_policies():
                ...
                # Initialize request argument(s)
                request = bigquery_datapolicies_v2beta1.ListDataPoliciesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_datapolicies_v2beta1.types.ListDataPoliciesRequest, dict]]):
                The request object. Request message for the
        ...
        Returns:
            google.cloud.bigquery_datapolicies_v2beta1.services.data_policy_service.pagers.ListDataPoliciesAsyncPager:

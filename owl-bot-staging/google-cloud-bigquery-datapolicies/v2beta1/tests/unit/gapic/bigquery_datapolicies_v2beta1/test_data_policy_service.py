...
from google.cloud.bigquery_datapolicies_v2beta1.services.data_policy_service import DataPolicyServiceAsyncClient
from google.cloud.bigquery_datapolicies_v2beta1.services.data_policy_service import DataPolicyServiceClient
from google.cloud.bigquery_datapolicies_v2beta1.services.data_policy_service import pagers
from google.cloud.bigquery_datapolicies_v2beta1.services.data_policy_service import transports
...
def test__get_api_endpoint():
    ...
    assert DataPolicyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DataPolicyServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert DataPolicyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DataPolicyServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    DataPolicyServiceClient, DataPolicyServiceAsyncClient
])
...
def test_data_policy_service_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery_datapolicies_v2beta1.services.data_policy_service.transports.DataPolicyServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_data_policy(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_data_policy),
            '__call__') as call:
...
def test_create_data_policy_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_data_policy(
            parent='parent_value',
            data_policy=datapolicy.DataPolicy(data_masking_policy=datapolicy.DataMaskingPolicy(predefined_expression=datapolicy.DataMaskingPolicy.PredefinedExpression.SHA256)),
            data_policy_id='data_policy_id_value',
        )
        ...
        mock_val = datapolicy.DataPolicy(data_masking_policy=datapolicy.DataMaskingPolicy(predefined_expression=datapolicy.DataMaskingPolicy.PredefinedExpression.SHA256))
        assert arg == mock_val
...
def test_add_grantees(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.add_grantees),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datapolicy.DataPolicy(
            name='name_value',
...
def test_remove_grantees(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_grantees),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datapolicy.DataPolicy(
            name='name_value',
...
def test_update_data_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_data_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datapolicy.DataPolicy(
            name='name_value',
...
def test_delete_data_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_data_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_data_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datapolicy.DataPolicy(
            name='name_value',
...
def test_create_data_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "dataPolicyId", "dataPolicy", )))
...
def test_add_grantees_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("dataPolicy", "grantees", )))
...
def test_remove_grantees_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{data_policy=projects/*/locations/*/dataPolicies/*}:removeGrantees" % client.transport._host, args[1])
...
def test_create_data_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_create_data_policy") as post, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_create_data_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "pre_create_data_policy") as pre:
        ...
        client.create_data_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_add_grantees_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_add_grantees") as post, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_add_grantees_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "pre_add_grantees") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.add_grantees(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_remove_grantees_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_remove_grantees") as post, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_remove_grantees_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "pre_remove_grantees") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.remove_grantees(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_data_policy_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'data_policy': {'name': 'projects/sample1/locations/sample2/dataPolicies/sample3'}}
    request_init["data_policy"] = {'data_masking_policy': {'predefined_expression': 1}, 'name': 'projects/sample1/locations/sample2/dataPolicies/sample3', 'data_policy_id': 'data_policy_id_value', 'etag': 'etag_value', 'data_policy_type': 1, 'policy_tag': 'policy_tag_value', 'grantees': ['grantees_value1', 'grantees_value2'], 'version': 1}
...
def test_update_data_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_update_data_policy") as post, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_update_data_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "pre_update_data_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_data_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_data_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "pre_delete_data_policy") as pre:
        pre.assert_not_called()
        ...
        client.delete_data_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_data_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_get_data_policy") as post, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_get_data_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "pre_get_data_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_data_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_data_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_list_data_policies") as post, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_list_data_policies_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "pre_list_data_policies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_data_policies(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataPolicyServiceRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_data_policy_service_base_transport():
    ...
    with mock.patch('google.cloud.bigquery_datapolicies_v2beta1.services.data_policy_service.transports.DataPolicyServiceTransport.__init__') as Transport:
...
def test_data_policy_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery_datapolicies_v2beta1.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_data_policy_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery_datapolicies_v2beta1.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataPolicyServiceTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DataPolicyServiceGrpcTransport, transports.DataPolicyServiceGrpcAsyncIOTransport])
def test_data_policy_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

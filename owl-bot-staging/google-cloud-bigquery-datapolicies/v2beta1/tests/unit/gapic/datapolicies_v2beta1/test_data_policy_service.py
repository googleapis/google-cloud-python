...
from google.cloud.bigquery.datapolicies_v2beta1.services.data_policy_service import DataPolicyServiceAsyncClient
from google.cloud.bigquery.datapolicies_v2beta1.services.data_policy_service import DataPolicyServiceClient
from google.cloud.bigquery.datapolicies_v2beta1.services.data_policy_service import pagers
from google.cloud.bigquery.datapolicies_v2beta1.services.data_policy_service import transports
...
def test_data_policy_service_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery.datapolicies_v2beta1.services.data_policy_service.transports.DataPolicyServiceGrpcTransport.__init__') as grpc_transport:
...
def test_data_policy_service_base_transport():
    ...
    with mock.patch('google.cloud.bigquery.datapolicies_v2beta1.services.data_policy_service.transports.DataPolicyServiceTransport.__init__') as Transport:
...
def test_data_policy_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery.datapolicies_v2beta1.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_data_policy_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery.datapolicies_v2beta1.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataPolicyServiceTransport()
        adc.assert_called_once()

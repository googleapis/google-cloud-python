...
class ResourceSettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_setting(self, request: resource_settings.GetSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resource_settings.GetSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_setting(self, response: resource_settings.Setting) -> resource_settings.Setting:
    ...
    def post_get_setting_with_metadata(self, response: resource_settings.Setting, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resource_settings.Setting, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_setting
    ...
    def pre_list_settings(self, request: resource_settings.ListSettingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resource_settings.ListSettingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_settings(self, response: resource_settings.ListSettingsResponse) -> resource_settings.ListSettingsResponse:
    ...
    def post_list_settings_with_metadata(self, response: resource_settings.ListSettingsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resource_settings.ListSettingsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_settings
    ...
    def pre_update_setting(self, request: resource_settings.UpdateSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resource_settings.UpdateSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_setting(self, response: resource_settings.Setting) -> resource_settings.Setting:
    ...
    def post_update_setting_with_metadata(self, response: resource_settings.Setting, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resource_settings.Setting, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_setting
...
class ResourceSettingsServiceRestTransport(_BaseResourceSettingsServiceRestTransport):
    ...
    class _GetSetting(_BaseResourceSettingsServiceRestTransport._BaseGetSetting, ResourceSettingsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseResourceSettingsServiceRestTransport._BaseGetSetting._get_http_options()

            request, metadata = self._interceptor.pre_get_setting(request, metadata)
            transcoded_request = _BaseResourceSettingsServiceRestTransport._BaseGetSetting._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseResourceSettingsServiceRestTransport._BaseGetSetting._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ResourceSettingsServiceRestTransport._GetSetting._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            resp, _ = self._interceptor.post_get_setting_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _ListSettings(_BaseResourceSettingsServiceRestTransport._BaseListSettings, ResourceSettingsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseResourceSettingsServiceRestTransport._BaseListSettings._get_http_options()

            request, metadata = self._interceptor.pre_list_settings(request, metadata)
            transcoded_request = _BaseResourceSettingsServiceRestTransport._BaseListSettings._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseResourceSettingsServiceRestTransport._BaseListSettings._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ResourceSettingsServiceRestTransport._ListSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_settings_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = resource_settings.ListSettingsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _UpdateSetting(_BaseResourceSettingsServiceRestTransport._BaseUpdateSetting, ResourceSettingsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseResourceSettingsServiceRestTransport._BaseUpdateSetting._get_http_options()

            request, metadata = self._interceptor.pre_update_setting(request, metadata)
            transcoded_request = _BaseResourceSettingsServiceRestTransport._BaseUpdateSetting._get_transcoded_request(http_options, request)

            body = _BaseResourceSettingsServiceRestTransport._BaseUpdateSetting._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseResourceSettingsServiceRestTransport._BaseUpdateSetting._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ResourceSettingsServiceRestTransport._UpdateSetting._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_update_setting_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = resource_settings.Setting.to_json(response)
                except:
...
__all__=(
    'ResourceSettingsServiceRestTransport',
)

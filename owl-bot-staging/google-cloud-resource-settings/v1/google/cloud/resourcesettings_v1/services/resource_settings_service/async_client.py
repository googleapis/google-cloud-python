...
class ResourceSettingsServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = ResourceSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ResourceSettingsServiceTransport, Callable[..., ResourceSettingsServiceTransport]]] = "grpc_asyncio",
    ...
    async def list_settings(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_settings]
    ...
    async def get_setting(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_setting]
    ...
    async def update_setting(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_setting]

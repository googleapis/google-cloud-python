...
def test_list_settings_rest_required_fields(request_type=resource_settings.ListSettingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_settings._get_unset_required_fields(jsonified_request)
...
def test_get_setting_rest_required_fields(request_type=resource_settings.GetSettingRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_setting._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_setting_rest_required_fields(request_type=resource_settings.UpdateSettingRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_setting._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

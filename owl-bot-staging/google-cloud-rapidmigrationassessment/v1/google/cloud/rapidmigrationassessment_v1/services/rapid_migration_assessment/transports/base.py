...
from google.cloud.rapidmigrationassessment_v1.types import rapidmigrationassessment
...
class RapidMigrationAssessmentTransport(abc.ABC):
    """Abstract transport class for RapidMigrationAssessment."""

    AUTH_SCOPES = (
        'https://www.googleapis.com/auth/cloud-platform',
    )

    DEFAULT_HOST: str = 'rapidmigrationassessment.googleapis.com'
    def __init__(
            self, *,
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_collector: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.list_collectors: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.get_collector: gapic_v1.method.wrap_method(
                self.get_collector,
                default_retry=retries.Retry(
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
                        core_exceptions.DeadlineExceeded,
            ...
            self.update_collector: gapic_v1.method.wrap_method(
                self.update_collector,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_collector: gapic_v1.method.wrap_method(
                self.delete_collector,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.resume_collector: gapic_v1.method.wrap_method(
                self.resume_collector,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.register_collector: gapic_v1.method.wrap_method(
                self.register_collector,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.pause_collector: gapic_v1.method.wrap_method(
    ...
    @property
    def list_collectors(self) -> Callable[
    ...
    @property
    def update_collector(self) -> Callable[
    ...
    @property
    def delete_collector(self) -> Callable[
    ...
    @property
    def resume_collector(self) -> Callable[
    ...
    @property
    def register_collector(self) -> Callable[
    ...
    @property
    def pause_collector(self) -> Callable[

...
from .transports.base import RapidMigrationAssessmentTransport, DEFAULT_CLIENT_INFO
from .transports.grpc_asyncio import RapidMigrationAssessmentGrpcAsyncIOTransport
...
class RapidMigrationAssessmentAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RapidMigrationAssessmentAsyncClient: The constructed client.
        """
        return RapidMigrationAssessmentClient.from_service_account_info.__func__(RapidMigrationAssessmentAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            RapidMigrationAssessmentAsyncClient: The constructed client.
        """
        return RapidMigrationAssessmentClient.from_service_account_file.__func__(RapidMigrationAssessmentAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return RapidMigrationAssessmentClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> RapidMigrationAssessmentTransport:
        ...
        Returns:
            RapidMigrationAssessmentTransport: The transport used by the client instance.
        """
        return self._client.transport

    get_transport_class = functools.partial(type(RapidMigrationAssessmentClient).get_transport_class, type(RapidMigrationAssessmentClient))
    ...
    def __init__(self, *,
        ...
        """
        self._client = RapidMigrationAssessmentClient(
    ...
    async def create_collector(self,
        ...
        r"""Create a Collector to manage the on-prem appliance
        ...
        Args:
            request (Optional[Union[google.cloud.rapidmigrationassessment_v1.types.CreateCollectorRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            collector (:class:`google.cloud.rapidmigrationassessment_v1.types.Collector`):
                Required. The resource being created.
                This corresponds to the ``collector`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            collector_id (:class:`str`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.rapidmigrationassessment_v1.types.Collector`
        ...
        response = operation_async.from_gapic(
            ...
            metadata_type=rapidmigrationassessment.OperationMetadata,
        )
    ...
    async def create_annotation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.rapidmigrationassessment_v1.types.CreateAnnotationRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            annotation (:class:`google.cloud.rapidmigrationassessment_v1.types.Annotation`):
                Required. The resource being created.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.rapidmigrationassessment_v1.types.Annotation`
    ...
    async def get_annotation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.rapidmigrationassessment_v1.types.GetAnnotationRequest, dict]]):
        ...
        Returns:
            google.cloud.rapidmigrationassessment_v1.types.Annotation:
                Message describing an Annotation
        """
        # Create or coerce a protobuf request object.
        # Quick check: If we got a request object, we should *not* have
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_collectors(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> pagers.ListCollectorsAsyncPager:
        r"""Lists Collectors in a given project and location.
        ...
        Args:
            request (Optional[Union[google.cloud.rapidmigrationassessment_v1.types.ListCollectorsRequest, dict]]):
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
        ...
        response = pagers.ListCollectorsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    async def get_collector(self,
        ...
        r"""Gets details of a single Collector.
        ...
        Args:
            request (Optional[Union[google.cloud.rapidmigrationassessment_v1.types.GetCollectorRequest, dict]]):
                The request object. Message for getting a specific
                Collector.
            name (:class:`str`):
                Required. Name of the resource.
        ...
        Returns:
            google.cloud.rapidmigrationassessment_v1.types.Collector:
                Message describing Collector object.
        """
        # Create or coerce a protobuf request object.
        # Quick check: If we got a request object, we should *not* have
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def update_collector(self,
        ...
        r"""Updates the parameters of a single Collector.
        ...
        Args:
            request (Optional[Union[google.cloud.rapidmigrationassessment_v1.types.UpdateCollectorRequest, dict]]):
    ...
    async def delete_collector(self,
        ...
        Args:
            request (Optional[Union[google.cloud.rapidmigrationassessment_v1.types.DeleteCollectorRequest, dict]]):
    ...
    async def resume_collector(self,
        ...
        Args:
            request (Optional[Union[google.cloud.rapidmigrationassessment_v1.types.ResumeCollectorRequest, dict]]):
    ...
    async def register_collector(self,
        ...
        r"""Registers the given collector.
        ...
        Args:
            request (Optional[Union[google.cloud.rapidmigrationassessment_v1.types.RegisterCollectorRequest, dict]]):
    ...
    async def pause_collector(self,
        ...
        Args:
            request (Optional[Union[google.cloud.rapidmigrationassessment_v1.types.PauseCollectorRequest, dict]]):

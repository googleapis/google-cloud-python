...
from .base import RapidMigrationAssessmentTransport, DEFAULT_CLIENT_INFO
...
class RapidMigrationAssessmentGrpcTransport(RapidMigrationAssessmentTransport):
    ...
    def list_collectors(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListCollectorsRequest],
    ...
    def update_collector(self) -> Callable[
        ...
        Returns:
            Callable[[~.UpdateCollectorRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def resume_collector(self) -> Callable[
        ...
        Returns:
            Callable[[~.ResumeCollectorRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def pause_collector(self) -> Callable[
        ...
        Returns:
            Callable[[~.PauseCollectorRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """

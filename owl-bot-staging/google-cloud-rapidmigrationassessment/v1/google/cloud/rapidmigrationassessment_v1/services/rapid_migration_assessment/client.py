...
from .transports.grpc import RapidMigrationAssessmentGrpcTransport
from .transports.grpc_asyncio import RapidMigrationAssessmentGrpcAsyncIOTransport
from .transports.rest import RapidMigrationAssessmentRestTransport


class RapidMigrationAssessmentClientMeta(type):
    """Metaclass for the RapidMigrationAssessment client.
...
class RapidMigrationAssessmentClient(metaclass=RapidMigrationAssessmentClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "rapidmigrationassessment.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RapidMigrationAssessmentClient: The constructed client.
        """
    ...
    def transport(self) -> RapidMigrationAssessmentTransport:
        ...
        Returns:
            RapidMigrationAssessmentTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def annotation_path(project: str,location: str,annotation: str,) -> str:
        """Returns a fully-qualified annotation string."""
        return "projects/{project}/locations/{location}/annotations/{annotation}".format(project=project, location=location, annotation=annotation, )

    @staticmethod
    def parse_annotation_path(path: str) -> Dict[str,str]:
        """Parses a annotation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/annotations/(?P<annotation>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def collector_path(project: str,location: str,collector: str,) -> str:
        """Returns a fully-qualified collector string."""
        return "projects/{project}/locations/{location}/collectors/{collector}".format(project=project, location=location, collector=collector, )

    @staticmethod
    def parse_collector_path(path: str) -> Dict[str,str]:
        """Parses a collector path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/collectors/(?P<collector>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RapidMigrationAssessmentClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RapidMigrationAssessmentClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RapidMigrationAssessmentClient._DEFAULT_UNIVERSE
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = RapidMigrationAssessmentClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            RapidMigrationAssessmentClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RapidMigrationAssessmentTransport, Callable[..., RapidMigrationAssessmentTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RapidMigrationAssessmentClient._read_environment_variables()
        self._client_cert_source = RapidMigrationAssessmentClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RapidMigrationAssessmentClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RapidMigrationAssessmentTransport)
        if transport_provided:
            # transport is a RapidMigrationAssessmentTransport instance.
            ...
            self._transport = cast(RapidMigrationAssessmentTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            RapidMigrationAssessmentClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RapidMigrationAssessmentTransport], Callable[..., RapidMigrationAssessmentTransport]] = (
    ...
    def create_collector(self,
        ...
        Args:
            request (Union[google.cloud.rapidmigrationassessment_v1.types.CreateCollectorRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_collector]
    ...
    def create_annotation(self,
        ...
        Args:
            request (Union[google.cloud.rapidmigrationassessment_v1.types.CreateAnnotationRequest, dict]):
    ...
    def get_annotation(self,
        ...
        Args:
            request (Union[google.cloud.rapidmigrationassessment_v1.types.GetAnnotationRequest, dict]):
    ...
    def list_collectors(self,
        ...
        Args:
            request (Union[google.cloud.rapidmigrationassessment_v1.types.ListCollectorsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_collectors]
        ...
        response = pagers.ListCollectorsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def get_collector(self,
        ...
        Args:
            request (Union[google.cloud.rapidmigrationassessment_v1.types.GetCollectorRequest, dict]):
                The request object. Message for getting a specific
                Collector.
            name (str):
                Required. Name of the resource.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_collector]
    ...
    def update_collector(self,
        ...
        Args:
            request (Union[google.cloud.rapidmigrationassessment_v1.types.UpdateCollectorRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_collector]
    ...
    def delete_collector(self,
        ...
        Args:
            request (Union[google.cloud.rapidmigrationassessment_v1.types.DeleteCollectorRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_collector]
    ...
    def resume_collector(self,
        ...
        Args:
            request (Union[google.cloud.rapidmigrationassessment_v1.types.ResumeCollectorRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.resume_collector]
    ...
    def register_collector(self,
        ...
        Args:
            request (Union[google.cloud.rapidmigrationassessment_v1.types.RegisterCollectorRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.register_collector]
    ...
    def pause_collector(self,
        ...
        Args:
            request (Union[google.cloud.rapidmigrationassessment_v1.types.PauseCollectorRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.pause_collector]
    ...
    def __enter__(self) -> "RapidMigrationAssessmentClient":
        return self

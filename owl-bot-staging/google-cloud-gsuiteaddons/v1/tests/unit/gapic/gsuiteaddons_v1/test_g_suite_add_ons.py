...
def test_get_authorization_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_get_authorization_with_metadata") as post_with_metadata, \
...
def test_create_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_create_deployment_with_metadata") as post_with_metadata, \
...
def test_replace_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_replace_deployment_with_metadata") as post_with_metadata, \
...
def test_get_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_get_deployment_with_metadata") as post_with_metadata, \
...
def test_list_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_list_deployments_with_metadata") as post_with_metadata, \
...
def test_get_install_status_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_get_install_status_with_metadata") as post_with_metadata, \

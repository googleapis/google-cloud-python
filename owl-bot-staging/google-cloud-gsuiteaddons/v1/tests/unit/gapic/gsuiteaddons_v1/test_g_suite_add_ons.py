...
def test_get_authorization_rest_required_fields(request_type=gsuiteaddons.GetAuthorizationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_authorization._get_unset_required_fields(jsonified_request)
...
def test_replace_deployment_rest_required_fields(request_type=gsuiteaddons.ReplaceDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).replace_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_install_deployment_rest_required_fields(request_type=gsuiteaddons.InstallDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).install_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_uninstall_deployment_rest_required_fields(request_type=gsuiteaddons.UninstallDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).uninstall_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_install_status_rest_required_fields(request_type=gsuiteaddons.GetInstallStatusRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_install_status._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test__read_environment_variables():
    assert CloudShellServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert CloudShellServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert CloudShellServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert CloudShellServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert CloudShellServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert CloudShellServiceClient._get_client_cert_source(None, False) is None
    assert CloudShellServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert CloudShellServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert CloudShellServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert CloudShellServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(CloudShellServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudShellServiceClient))
@mock.patch.object(CloudShellServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudShellServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CloudShellServiceClient._DEFAULT_UNIVERSE
    default_endpoint = CloudShellServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = CloudShellServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert CloudShellServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert CloudShellServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CloudShellServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CloudShellServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CloudShellServiceClient._get_api_endpoint(None, None, default_universe, "always") == CloudShellServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CloudShellServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CloudShellServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CloudShellServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert CloudShellServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        CloudShellServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert CloudShellServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert CloudShellServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert CloudShellServiceClient._get_universe_domain(None, None) == CloudShellServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (CloudShellServiceClient, transports.CloudShellServiceRestTransport, "rest", "true"),
    (CloudShellServiceClient, transports.CloudShellServiceRestTransport, "rest", "false"),
])
@mock.patch.object(CloudShellServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudShellServiceClient))
@mock.patch.object(CloudShellServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudShellServiceAsyncClient))
...
@mock.patch.object(CloudShellServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudShellServiceClient))
@mock.patch.object(CloudShellServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudShellServiceAsyncClient))
def test_cloud_shell_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (CloudShellServiceClient, transports.CloudShellServiceRestTransport, "rest", None),
])
...
def test_start_environment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.start_environment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.start_environment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_start_environment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudShellServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.start_environment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.start_environment] = mock_rpc
...
def test_authorize_environment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.authorize_environment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.authorize_environment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_authorize_environment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudShellServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.authorize_environment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.authorize_environment] = mock_rpc
...
def test_add_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.add_public_key in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.add_public_key] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_add_public_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudShellServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.add_public_key in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.add_public_key] = mock_rpc
...
def test_remove_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.remove_public_key in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.remove_public_key] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_remove_public_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudShellServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.remove_public_key in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.remove_public_key] = mock_rpc
...
def test_start_environment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudShellServiceClient(
...
def test_authorize_environment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudShellServiceClient(
...
def test_add_public_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudShellServiceClient(
...
def test_remove_public_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudShellServiceClient(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_start_environment_empty_call_grpc():
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.start_environment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_authorize_environment_empty_call_grpc():
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.authorize_environment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_add_public_key_empty_call_grpc():
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.add_public_key(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_remove_public_key_empty_call_grpc():
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.remove_public_key(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = CloudShellServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_start_environment_empty_call_grpc_asyncio():
    client = CloudShellServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.start_environment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_authorize_environment_empty_call_grpc_asyncio():
    client = CloudShellServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.authorize_environment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_add_public_key_empty_call_grpc_asyncio():
    client = CloudShellServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.add_public_key(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_remove_public_key_empty_call_grpc_asyncio():
    client = CloudShellServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.remove_public_key(request=None)
...
def test_transport_kind_rest():
    transport = CloudShellServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_get_environment_rest_bad_request(request_type=cloudshell.GetEnvironmentRequest):
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_environment_rest_interceptors(null_interceptor):
    transport = transports.CloudShellServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CloudShellServiceRestInterceptor(),
        )
    client = CloudShellServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "post_get_environment") as post, \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "post_get_environment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "pre_get_environment") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloudshell.Environment.to_json(cloudshell.Environment())
...
def test_start_environment_rest_bad_request(request_type=cloudshell.StartEnvironmentRequest):
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_start_environment_rest_call_success(request_type):
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_start_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "post_start_environment") as post, \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "post_start_environment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "pre_start_environment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_authorize_environment_rest_bad_request(request_type=cloudshell.AuthorizeEnvironmentRequest):
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_authorize_environment_rest_call_success(request_type):
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_authorize_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "post_authorize_environment") as post, \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "post_authorize_environment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "pre_authorize_environment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_add_public_key_rest_call_success(request_type):
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_add_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "post_add_public_key") as post, \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "post_add_public_key_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "pre_add_public_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_remove_public_key_rest_bad_request(request_type=cloudshell.RemovePublicKeyRequest):
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_remove_public_key_rest_call_success(request_type):
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_remove_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "post_remove_public_key") as post, \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "post_remove_public_key_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudShellServiceRestInterceptor, "pre_remove_public_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_start_environment_empty_call_rest():
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_authorize_environment_empty_call_rest():
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_add_public_key_empty_call_rest():
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_remove_public_key_empty_call_rest():
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

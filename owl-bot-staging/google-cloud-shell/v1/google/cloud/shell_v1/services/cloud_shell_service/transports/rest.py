...
class CloudShellServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_add_public_key(self, request: cloudshell.AddPublicKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudshell.AddPublicKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_add_public_key_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for add_public_key
    ...
    def pre_authorize_environment(self, request: cloudshell.AuthorizeEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudshell.AuthorizeEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_authorize_environment_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for authorize_environment
    ...
    def pre_get_environment(self, request: cloudshell.GetEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudshell.GetEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_environment_with_metadata(self, response: cloudshell.Environment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudshell.Environment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_environment
    ...
    def pre_remove_public_key(self, request: cloudshell.RemovePublicKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudshell.RemovePublicKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_remove_public_key_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for remove_public_key
    ...
    def pre_start_environment(self, request: cloudshell.StartEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudshell.StartEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_start_environment_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for start_environment
...
class CloudShellServiceRestTransport(_BaseCloudShellServiceRestTransport):
    ...
    class _AddPublicKey(_BaseCloudShellServiceRestTransport._BaseAddPublicKey, CloudShellServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudShellServiceRestTransport._AddPublicKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _AuthorizeEnvironment(_BaseCloudShellServiceRestTransport._BaseAuthorizeEnvironment, CloudShellServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudShellServiceRestTransport._AuthorizeEnvironment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetEnvironment(_BaseCloudShellServiceRestTransport._BaseGetEnvironment, CloudShellServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudShellServiceRestTransport._GetEnvironment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RemovePublicKey(_BaseCloudShellServiceRestTransport._BaseRemovePublicKey, CloudShellServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudShellServiceRestTransport._RemovePublicKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _StartEnvironment(_BaseCloudShellServiceRestTransport._BaseStartEnvironment, CloudShellServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudShellServiceRestTransport._StartEnvironment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

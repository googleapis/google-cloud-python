...
class NetworkServicesClient(metaclass=NetworkServicesClientMeta):
    ...
    @staticmethod
    def address_path(project: str,region: str,address: str,) -> str:
        """Returns a fully-qualified address string."""
        return "projects/{project}/regions/{region}/addresses/{address}".format(project=project, region=region, address=address, )

    @staticmethod
    def parse_address_path(path: str) -> Dict[str,str]:
        """Parses a address path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/regions/(?P<region>.+?)/addresses/(?P<address>.+?)$", path)
    ...
    @staticmethod
    def backend_service_path(project: str,location: str,backend_service: str,) -> str:
        """Returns a fully-qualified backend_service string."""
        return "projects/{project}/locations/{location}/backendServices/{backend_service}".format(project=project, location=location, backend_service=backend_service, )

    @staticmethod
    def parse_backend_service_path(path: str) -> Dict[str,str]:
        """Parses a backend_service path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backendServices/(?P<backend_service>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def gateway_route_view_path(project: str,location: str,gateway: str,route_view: str,) -> str:
        """Returns a fully-qualified gateway_route_view string."""
        return "projects/{project}/locations/{location}/gateways/{gateway}/routeViews/{route_view}".format(project=project, location=location, gateway=gateway, route_view=route_view, )

    @staticmethod
    def parse_gateway_route_view_path(path: str) -> Dict[str,str]:
        """Parses a gateway_route_view path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/gateways/(?P<gateway>.+?)/routeViews/(?P<route_view>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def gateway_security_policy_path(project: str,location: str,gateway_security_policy: str,) -> str:
        """Returns a fully-qualified gateway_security_policy string."""
        return "projects/{project}/locations/{location}/gatewaySecurityPolicies/{gateway_security_policy}".format(project=project, location=location, gateway_security_policy=gateway_security_policy, )
    ...
    def parse_gateway_security_policy_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/gatewaySecurityPolicies/(?P<gateway_security_policy>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def grpc_route_path(project: str,location: str,grpc_route: str,) -> str:
        """Returns a fully-qualified grpc_route string."""
        return "projects/{project}/locations/{location}/grpcRoutes/{grpc_route}".format(project=project, location=location, grpc_route=grpc_route, )

    @staticmethod
    def parse_grpc_route_path(path: str) -> Dict[str,str]:
        """Parses a grpc_route path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/grpcRoutes/(?P<grpc_route>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def http_route_path(project: str,location: str,http_route: str,) -> str:
        """Returns a fully-qualified http_route string."""
        return "projects/{project}/locations/{location}/httpRoutes/{http_route}".format(project=project, location=location, http_route=http_route, )

    @staticmethod
    def parse_http_route_path(path: str) -> Dict[str,str]:
        """Parses a http_route path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/httpRoutes/(?P<http_route>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def mesh_route_view_path(project: str,location: str,mesh: str,route_view: str,) -> str:
        """Returns a fully-qualified mesh_route_view string."""
        return "projects/{project}/locations/{location}/meshes/{mesh}/routeViews/{route_view}".format(project=project, location=location, mesh=mesh, route_view=route_view, )

    @staticmethod
    def parse_mesh_route_view_path(path: str) -> Dict[str,str]:
        """Parses a mesh_route_view path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/meshes/(?P<mesh>.+?)/routeViews/(?P<route_view>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def service_binding_path(project: str,location: str,service_binding: str,) -> str:
        """Returns a fully-qualified service_binding string."""
        return "projects/{project}/locations/{location}/serviceBindings/{service_binding}".format(project=project, location=location, service_binding=service_binding, )

    @staticmethod
    def parse_service_binding_path(path: str) -> Dict[str,str]:
        """Parses a service_binding path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/serviceBindings/(?P<service_binding>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def service_lb_policy_path(project: str,location: str,service_lb_policy: str,) -> str:
        """Returns a fully-qualified service_lb_policy string."""
        return "projects/{project}/locations/{location}/serviceLbPolicies/{service_lb_policy}".format(project=project, location=location, service_lb_policy=service_lb_policy, )

    @staticmethod
    def parse_service_lb_policy_path(path: str) -> Dict[str,str]:
        """Parses a service_lb_policy path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/serviceLbPolicies/(?P<service_lb_policy>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def subnetwork_path(project: str,region: str,subnetwork: str,) -> str:
        """Returns a fully-qualified subnetwork string."""
        return "projects/{project}/regions/{region}/subnetworks/{subnetwork}".format(project=project, region=region, subnetwork=subnetwork, )
    ...
    @staticmethod
    def tcp_route_path(project: str,location: str,tcp_route: str,) -> str:
        """Returns a fully-qualified tcp_route string."""
        return "projects/{project}/locations/{location}/tcpRoutes/{tcp_route}".format(project=project, location=location, tcp_route=tcp_route, )

    @staticmethod
    def parse_tcp_route_path(path: str) -> Dict[str,str]:
        """Parses a tcp_route path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/tcpRoutes/(?P<tcp_route>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def tls_route_path(project: str,location: str,tls_route: str,) -> str:
        """Returns a fully-qualified tls_route string."""
        return "projects/{project}/locations/{location}/tlsRoutes/{tls_route}".format(project=project, location=location, tls_route=tls_route, )

    @staticmethod
    def parse_tls_route_path(path: str) -> Dict[str,str]:
        """Parses a tls_route path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/tlsRoutes/(?P<tls_route>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def wasm_plugin_path(project: str,location: str,wasm_plugin: str,) -> str:
        """Returns a fully-qualified wasm_plugin string."""
        return "projects/{project}/locations/{location}/wasmPlugins/{wasm_plugin}".format(project=project, location=location, wasm_plugin=wasm_plugin, )

    @staticmethod
    def parse_wasm_plugin_path(path: str) -> Dict[str,str]:
        """Parses a wasm_plugin path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/wasmPlugins/(?P<wasm_plugin>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def wasm_plugin_version_path(project: str,location: str,wasm_plugin: str,wasm_plugin_version: str,) -> str:
        """Returns a fully-qualified wasm_plugin_version string."""
        return "projects/{project}/locations/{location}/wasmPlugins/{wasm_plugin}/versions/{wasm_plugin_version}".format(project=project, location=location, wasm_plugin=wasm_plugin, wasm_plugin_version=wasm_plugin_version, )

    @staticmethod
    def parse_wasm_plugin_version_path(path: str) -> Dict[str,str]:
        """Parses a wasm_plugin_version path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/wasmPlugins/(?P<wasm_plugin>.+?)/versions/(?P<wasm_plugin_version>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = NetworkServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, NetworkServicesTransport, Callable[..., NetworkServicesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = NetworkServicesClient._read_environment_variables()
        self._client_cert_source = NetworkServicesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = NetworkServicesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[NetworkServicesTransport], Callable[..., NetworkServicesTransport]] = (
    ...
    def list_endpoint_policies(self,
            request: Optional[Union[endpoint_policy.ListEndpointPoliciesRequest, dict]] = None,
            *,
    ...
    def create_endpoint_policy(self,
            request: Optional[Union[gcn_endpoint_policy.CreateEndpointPolicyRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_endpoint_policy(self,
            request: Optional[Union[gcn_endpoint_policy.UpdateEndpointPolicyRequest, dict]] = None,
            *,
            endpoint_policy: Optional[gcn_endpoint_policy.EndpointPolicy] = None,
    ...
    def delete_endpoint_policy(self,
            request: Optional[Union[endpoint_policy.DeleteEndpointPolicyRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_wasm_plugin_versions(self,
            request: Optional[Union[extensibility.ListWasmPluginVersionsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_wasm_plugin_versions]
    ...
    def get_wasm_plugin_version(self,
            request: Optional[Union[extensibility.GetWasmPluginVersionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_wasm_plugin_version(self,
            request: Optional[Union[extensibility.CreateWasmPluginVersionRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_wasm_plugin_version]
    ...
    def delete_wasm_plugin_version(self,
            request: Optional[Union[extensibility.DeleteWasmPluginVersionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_wasm_plugin_version]
    ...
    def list_service_bindings(self,
            request: Optional[Union[service_binding.ListServiceBindingsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_service_binding(self,
            request: Optional[Union[gcn_service_binding.CreateServiceBindingRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_service_binding(self,
            request: Optional[Union[gcn_service_binding.UpdateServiceBindingRequest, dict]] = None,
            *,
            service_binding: Optional[gcn_service_binding.ServiceBinding] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def delete_service_binding(self,
            request: Optional[Union[service_binding.DeleteServiceBindingRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_service_lb_policies(self,
            request: Optional[Union[service_lb_policy.ListServiceLbPoliciesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_service_lb_policy(self,
            request: Optional[Union[service_lb_policy.GetServiceLbPolicyRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_service_lb_policy(self,
            request: Optional[Union[gcn_service_lb_policy.CreateServiceLbPolicyRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_service_lb_policy(self,
            request: Optional[Union[gcn_service_lb_policy.UpdateServiceLbPolicyRequest, dict]] = None,
            *,
            service_lb_policy: Optional[gcn_service_lb_policy.ServiceLbPolicy] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def delete_service_lb_policy(self,
            request: Optional[Union[service_lb_policy.DeleteServiceLbPolicyRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_gateway_route_view(self,
    ...
    def list_gateway_route_views(self,
    ...
    def list_mesh_route_views(self,

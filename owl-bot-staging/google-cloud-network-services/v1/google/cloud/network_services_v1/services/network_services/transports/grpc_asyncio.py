...
class NetworkServicesGrpcAsyncIOTransport(NetworkServicesTransport):
    ...
    @property
    def list_wasm_plugin_versions(self) -> Callable[
    ...
    @property
    def get_wasm_plugin_version(self) -> Callable[
    ...
    @property
    def create_wasm_plugin_version(self) -> Callable[
    ...
    @property
    def delete_wasm_plugin_version(self) -> Callable[
    ...
    @property
    def list_wasm_plugins(self) -> Callable[
    ...
    @property
    def get_wasm_plugin(self) -> Callable[
            [extensibility.GetWasmPluginRequest],
            Awaitable[extensibility.WasmPlugin]]:
    ...
    @property
    def create_wasm_plugin(self) -> Callable[
    ...
    @property
    def update_wasm_plugin(self) -> Callable[
    ...
    @property
    def delete_wasm_plugin(self) -> Callable[
    ...
    def list_gateways(self) -> Callable[
            ...
            Awaitable[gateway.ListGatewaysResponse]]:
    ...
    @property
    def list_grpc_routes(self) -> Callable[
    ...
    @property
    def get_grpc_route(self) -> Callable[
            [grpc_route.GetGrpcRouteRequest],
            Awaitable[grpc_route.GrpcRoute]]:
    ...
    @property
    def create_grpc_route(self) -> Callable[
    ...
    @property
    def update_grpc_route(self) -> Callable[
    ...
    @property
    def delete_grpc_route(self) -> Callable[
    ...
    @property
    def list_http_routes(self) -> Callable[
    ...
    @property
    def get_http_route(self) -> Callable[
    ...
    @property
    def create_http_route(self) -> Callable[
    ...
    @property
    def update_http_route(self) -> Callable[
    ...
    @property
    def delete_http_route(self) -> Callable[
    ...
    @property
    def list_tcp_routes(self) -> Callable[
            [tcp_route.ListTcpRoutesRequest],
            Awaitable[tcp_route.ListTcpRoutesResponse]]:
    ...
    @property
    def get_tcp_route(self) -> Callable[
            [tcp_route.GetTcpRouteRequest],
            Awaitable[tcp_route.TcpRoute]]:
    ...
    @property
    def create_tcp_route(self) -> Callable[
    ...
    @property
    def update_tcp_route(self) -> Callable[
    ...
    @property
    def delete_tcp_route(self) -> Callable[
    ...
    @property
    def list_tls_routes(self) -> Callable[
    ...
    @property
    def get_tls_route(self) -> Callable[
            [tls_route.GetTlsRouteRequest],
            Awaitable[tls_route.TlsRoute]]:
    ...
    @property
    def create_tls_route(self) -> Callable[
    ...
    @property
    def update_tls_route(self) -> Callable[
    ...
    @property
    def delete_tls_route(self) -> Callable[
    ...
    @property
    def list_service_bindings(self) -> Callable[
    ...
    @property
    def get_service_binding(self) -> Callable[
    ...
    @property
    def create_service_binding(self) -> Callable[
    ...
    @property
    def update_service_binding(self) -> Callable[
    ...
    @property
    def delete_service_binding(self) -> Callable[
    ...
    @property
    def list_service_lb_policies(self) -> Callable[
    ...
    @property
    def get_service_lb_policy(self) -> Callable[
    ...
    @property
    def create_service_lb_policy(self) -> Callable[
    ...
    @property
    def update_service_lb_policy(self) -> Callable[
    ...
    @property
    def delete_service_lb_policy(self) -> Callable[
    ...
    @property
    def get_gateway_route_view(self) -> Callable[
            [route_view.GetGatewayRouteViewRequest],
            Awaitable[route_view.GatewayRouteView]]:
    ...
    @property
    def get_mesh_route_view(self) -> Callable[
            [route_view.GetMeshRouteViewRequest],
            Awaitable[route_view.MeshRouteView]]:
    ...
    @property
    def list_gateway_route_views(self) -> Callable[
    ...
    @property
    def list_mesh_route_views(self) -> Callable[

...
class DepServiceTransport(abc.ABC):
    ...
    @property
    def list_lb_traffic_extensions(self) -> Callable[
    ...
    @property
    def get_lb_traffic_extension(self) -> Callable[
            [dep.GetLbTrafficExtensionRequest],
            Union[
                dep.LbTrafficExtension,
                Awaitable[dep.LbTrafficExtension]
            ]]:
        raise NotImplementedError()

    @property
    def create_lb_traffic_extension(self) -> Callable[
    ...
    @property
    def update_lb_traffic_extension(self) -> Callable[
    ...
    @property
    def delete_lb_traffic_extension(self) -> Callable[
    ...
    @property
    def list_lb_route_extensions(self) -> Callable[
    ...
    @property
    def get_lb_route_extension(self) -> Callable[
            [dep.GetLbRouteExtensionRequest],
            Union[
                dep.LbRouteExtension,
                Awaitable[dep.LbRouteExtension]
            ]]:
        raise NotImplementedError()

    @property
    def create_lb_route_extension(self) -> Callable[
    ...
    @property
    def update_lb_route_extension(self) -> Callable[
    ...
    @property
    def delete_lb_route_extension(self) -> Callable[
    ...
    @property
    def list_authz_extensions(self) -> Callable[
            [dep.ListAuthzExtensionsRequest],
            Union[
                dep.ListAuthzExtensionsResponse,
                Awaitable[dep.ListAuthzExtensionsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_authz_extension(self) -> Callable[
            [dep.GetAuthzExtensionRequest],
            Union[
                dep.AuthzExtension,
                Awaitable[dep.AuthzExtension]
            ]]:
        raise NotImplementedError()

    @property
    def create_authz_extension(self) -> Callable[
    ...
    @property
    def update_authz_extension(self) -> Callable[
    ...
    @property
    def delete_authz_extension(self) -> Callable[

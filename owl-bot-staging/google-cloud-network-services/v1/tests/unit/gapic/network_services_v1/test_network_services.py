...
from google.cloud.network_services_v1.services.network_services import NetworkServicesAsyncClient
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert NetworkServicesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert NetworkServicesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert NetworkServicesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert NetworkServicesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert NetworkServicesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert NetworkServicesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert NetworkServicesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert NetworkServicesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(NetworkServicesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkServicesClient))
@mock.patch.object(NetworkServicesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkServicesAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = NetworkServicesClient._DEFAULT_UNIVERSE
    default_endpoint = NetworkServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = NetworkServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert NetworkServicesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert NetworkServicesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == NetworkServicesClient.DEFAULT_MTLS_ENDPOINT
    assert NetworkServicesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert NetworkServicesClient._get_api_endpoint(None, None, default_universe, "always") == NetworkServicesClient.DEFAULT_MTLS_ENDPOINT
    assert NetworkServicesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == NetworkServicesClient.DEFAULT_MTLS_ENDPOINT
    assert NetworkServicesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert NetworkServicesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        NetworkServicesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert NetworkServicesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert NetworkServicesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert NetworkServicesClient._get_universe_domain(None, None) == NetworkServicesClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (NetworkServicesClient, transports.NetworkServicesRestTransport, "rest", "true"),
    (NetworkServicesClient, transports.NetworkServicesRestTransport, "rest", "false"),
])
@mock.patch.object(NetworkServicesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkServicesClient))
@mock.patch.object(NetworkServicesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkServicesAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    NetworkServicesClient, NetworkServicesAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (NetworkServicesClient, transports.NetworkServicesGrpcTransport, "grpc", grpc_helpers),
    (NetworkServicesAsyncClient, transports.NetworkServicesGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_list_gateways_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, gateway.Gateway)
                   for i in results)
...
def test_list_grpc_routes(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_grpc_routes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_grpc_routes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, grpc_route.GrpcRoute)
                   for i in results)
...
def test_get_grpc_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_grpc_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_grpc_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_grpc_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_grpc_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_grpc_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_grpc_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_grpc_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_http_routes(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_http_routes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_http_routes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, http_route.HttpRoute)
                   for i in results)
...
def test_get_http_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_http_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_http_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_http_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_http_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_http_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_http_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_http_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_tcp_routes(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_tcp_routes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_tcp_routes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, tcp_route.TcpRoute)
                   for i in results)
...
def test_get_tcp_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_tcp_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_tcp_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_tcp_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_tcp_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_tcp_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_tcp_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_tcp_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_tls_routes(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_tls_routes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_tls_routes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, tls_route.TlsRoute)
                   for i in results)
...
def test_get_tls_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_tls_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_tls_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_tls_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_tls_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_tls_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_tls_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_tls_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_service_bindings_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, service_binding.ServiceBinding)
                   for i in results)
...
def test_get_service_binding(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_service_binding),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_service_binding(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_service_binding),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_service_binding(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_service_binding),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_meshes(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_meshes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_meshes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, mesh.Mesh)
                   for i in results)
...
def test_get_mesh(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_mesh),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_mesh(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_mesh),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_mesh(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_mesh),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_mesh(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_mesh),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_endpoint_policies_rest_interceptors(null_interceptor):
    transport = transports.NetworkServicesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NetworkServicesRestInterceptor(),
        )
    client = NetworkServicesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_list_endpoint_policies") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_list_endpoint_policies") as pre:
...
def test_get_endpoint_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_get_endpoint_policy") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_get_endpoint_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_endpoint_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_create_endpoint_policy") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_create_endpoint_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_endpoint_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_update_endpoint_policy") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_update_endpoint_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_endpoint_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_delete_endpoint_policy") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_delete_endpoint_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_gateways_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_list_gateways") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_list_gateways") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_get_gateway") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_get_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_create_gateway") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_create_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_update_gateway") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_update_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_delete_gateway") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_delete_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_grpc_routes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_list_grpc_routes") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_list_grpc_routes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_grpc_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_get_grpc_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_get_grpc_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_grpc_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_create_grpc_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_create_grpc_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_grpc_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_update_grpc_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_update_grpc_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_grpc_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_delete_grpc_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_delete_grpc_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_http_routes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_list_http_routes") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_list_http_routes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_http_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_get_http_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_get_http_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_http_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_create_http_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_create_http_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_http_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_update_http_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_update_http_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_http_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_delete_http_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_delete_http_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_tcp_routes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_list_tcp_routes") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_list_tcp_routes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_tcp_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_get_tcp_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_get_tcp_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_tcp_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_create_tcp_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_create_tcp_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_tcp_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_update_tcp_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_update_tcp_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_tcp_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_delete_tcp_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_delete_tcp_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_tls_routes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_list_tls_routes") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_list_tls_routes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_tls_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_get_tls_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_get_tls_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_tls_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_create_tls_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_create_tls_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_tls_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_update_tls_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_update_tls_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_tls_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_delete_tls_route") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_delete_tls_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_service_bindings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_list_service_bindings") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_list_service_bindings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_service_binding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_get_service_binding") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_get_service_binding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_service_binding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_create_service_binding") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_create_service_binding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_service_binding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_delete_service_binding") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_delete_service_binding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_meshes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_list_meshes") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_list_meshes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_mesh_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_get_mesh") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_get_mesh") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_mesh_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_create_mesh") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_create_mesh") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_mesh_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_update_mesh") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_update_mesh") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_mesh_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "post_delete_mesh") as post, \
         mock.patch.object(transports.NetworkServicesRestInterceptor, "pre_delete_mesh") as pre:
        pre.assert_not_called()
        post.assert_not_called()

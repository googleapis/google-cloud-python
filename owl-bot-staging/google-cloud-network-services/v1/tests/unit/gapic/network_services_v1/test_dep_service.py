...
from google.cloud.network_services_v1.services.dep_service import DepServiceAsyncClient
from google.cloud.network_services_v1.services.dep_service import DepServiceClient
from google.cloud.network_services_v1.services.dep_service import pagers
from google.cloud.network_services_v1.services.dep_service import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert DepServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert DepServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert DepServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert DepServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert DepServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert DepServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert DepServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert DepServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert DepServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(DepServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DepServiceClient))
@mock.patch.object(DepServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DepServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DepServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DepServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = DepServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert DepServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert DepServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DepServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DepServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert DepServiceClient._get_api_endpoint(None, None, default_universe, "always") == DepServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DepServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DepServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DepServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert DepServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        DepServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert DepServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert DepServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert DepServiceClient._get_universe_domain(None, None) == DepServiceClient._DEFAULT_UNIVERSE
...
def test_dep_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (DepServiceAsyncClient, transports.DepServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (DepServiceClient, transports.DepServiceRestTransport, "rest"),
])
@mock.patch.object(DepServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DepServiceClient))
@mock.patch.object(DepServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DepServiceAsyncClient))
def test_dep_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (DepServiceAsyncClient, transports.DepServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (DepServiceClient, transports.DepServiceGrpcTransport, "grpc", "false"),
    (DepServiceAsyncClient, transports.DepServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_dep_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    DepServiceClient, DepServiceAsyncClient
])
@mock.patch.object(DepServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DepServiceClient))
@mock.patch.object(DepServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DepServiceAsyncClient))
...
def test_dep_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (DepServiceAsyncClient, transports.DepServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (DepServiceClient, transports.DepServiceRestTransport, "rest", None),
])
def test_dep_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_dep_service_client_client_options_from_dict():
    with mock.patch('google.cloud.network_services_v1.services.dep_service.transports.DepServiceGrpcTransport.__init__') as grpc_transport:
...
def test_dep_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_list_lb_traffic_extensions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_lb_traffic_extensions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_lb_traffic_extensions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_lb_traffic_extensions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_lb_traffic_extensions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_lb_traffic_extensions] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_lb_traffic_extensions_async(transport: str = 'grpc_asyncio', request_type=dep.ListLbTrafficExtensionsRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dep.ListLbTrafficExtensionsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_lb_traffic_extensions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_lb_traffic_extensions(request={}, retry=retry, timeout=timeout)
        ...
        assert all(isinstance(i, dep.LbTrafficExtension)
                   for i in results)
...
async def test_list_lb_traffic_extensions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_lb_traffic_extensions(request={},)
...
def test_get_lb_traffic_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_lb_traffic_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_lb_traffic_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_lb_traffic_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_lb_traffic_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_lb_traffic_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_lb_traffic_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_lb_traffic_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_lb_traffic_extension_async(transport: str = 'grpc_asyncio', request_type=dep.GetLbTrafficExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dep.LbTrafficExtension(
            name='name_value',
            description='description_value',
            forwarding_rules=['forwarding_rules_value'],
            load_balancing_scheme=dep.LoadBalancingScheme.INTERNAL_MANAGED,
...
def test_create_lb_traffic_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_lb_traffic_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_lb_traffic_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_lb_traffic_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_lb_traffic_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_lb_traffic_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_lb_traffic_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_lb_traffic_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_lb_traffic_extension_async(transport: str = 'grpc_asyncio', request_type=dep.CreateLbTrafficExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_lb_traffic_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_lb_traffic_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_lb_traffic_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_lb_traffic_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_lb_traffic_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_lb_traffic_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_lb_traffic_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_lb_traffic_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_lb_traffic_extension_async(transport: str = 'grpc_asyncio', request_type=dep.UpdateLbTrafficExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_lb_traffic_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_lb_traffic_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_lb_traffic_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_lb_traffic_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_lb_traffic_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_lb_traffic_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_lb_traffic_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_lb_traffic_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_lb_traffic_extension_async(transport: str = 'grpc_asyncio', request_type=dep.DeleteLbTrafficExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_lb_route_extensions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_lb_route_extensions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_lb_route_extensions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_lb_route_extensions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_lb_route_extensions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_lb_route_extensions] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_lb_route_extensions_async(transport: str = 'grpc_asyncio', request_type=dep.ListLbRouteExtensionsRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dep.ListLbRouteExtensionsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_lb_route_extensions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_lb_route_extensions(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dep.LbRouteExtension)
                   for i in results)
...
async def test_list_lb_route_extensions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_lb_route_extensions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_lb_route_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_lb_route_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_lb_route_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_lb_route_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_lb_route_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_lb_route_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_lb_route_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_lb_route_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_lb_route_extension_async(transport: str = 'grpc_asyncio', request_type=dep.GetLbRouteExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dep.LbRouteExtension(
            name='name_value',
            description='description_value',
            forwarding_rules=['forwarding_rules_value'],
            load_balancing_scheme=dep.LoadBalancingScheme.INTERNAL_MANAGED,
...
def test_create_lb_route_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_lb_route_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_lb_route_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_lb_route_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_lb_route_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_lb_route_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_lb_route_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_lb_route_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_lb_route_extension_async(transport: str = 'grpc_asyncio', request_type=dep.CreateLbRouteExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_lb_route_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_lb_route_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_lb_route_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_lb_route_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_lb_route_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_lb_route_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_lb_route_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_lb_route_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_lb_route_extension_async(transport: str = 'grpc_asyncio', request_type=dep.UpdateLbRouteExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_lb_route_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_lb_route_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_lb_route_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_lb_route_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_lb_route_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_lb_route_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_lb_route_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_lb_route_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_lb_route_extension_async(transport: str = 'grpc_asyncio', request_type=dep.DeleteLbRouteExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_authz_extensions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_authz_extensions in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_list_authz_extensions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_authz_extensions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_authz_extensions] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_authz_extensions_async(transport: str = 'grpc_asyncio', request_type=dep.ListAuthzExtensionsRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dep.ListAuthzExtensionsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_authz_extensions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dep.AuthzExtension)
                   for i in results)
...
async def test_list_authz_extensions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_authz_extensions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_authz_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_authz_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_authz_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_authz_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_authz_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_authz_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_authz_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_authz_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_authz_extension_async(transport: str = 'grpc_asyncio', request_type=dep.GetAuthzExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_authz_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_authz_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_authz_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_authz_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_authz_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_authz_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_authz_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_authz_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_authz_extension_async(transport: str = 'grpc_asyncio', request_type=dep.CreateAuthzExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_authz_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_authz_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_authz_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_authz_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_authz_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_authz_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_authz_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_authz_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_authz_extension_async(transport: str = 'grpc_asyncio', request_type=dep.UpdateAuthzExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_authz_extension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_authz_extension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_authz_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_authz_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_authz_extension] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_authz_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_authz_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_authz_extension] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_authz_extension_async(transport: str = 'grpc_asyncio', request_type=dep.DeleteAuthzExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_lb_traffic_extensions_rest_required_fields(request_type=dep.ListLbTrafficExtensionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_lb_traffic_extensions._get_unset_required_fields(jsonified_request)
...
def test_list_lb_traffic_extensions_rest_unset_required_fields():
    transport = transports.DepServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_lb_traffic_extensions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/lbTrafficExtensions" % client.transport._host, args[1])
...
def test_list_lb_traffic_extensions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(dep.ListLbTrafficExtensionsResponse.to_json(x) for x in response)
...
def test_get_lb_traffic_extension_rest_required_fields(request_type=dep.GetLbTrafficExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_lb_traffic_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_lb_traffic_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/lbTrafficExtensions/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/lbTrafficExtensions/*}" % client.transport._host, args[1])
...
def test_create_lb_traffic_extension_rest_required_fields(request_type=dep.CreateLbTrafficExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_lb_traffic_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "lbTrafficExtensionId" in jsonified_request
    assert jsonified_request["lbTrafficExtensionId"] == request_init["lb_traffic_extension_id"]
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_lb_traffic_extension._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("lb_traffic_extension_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_lb_traffic_extension_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("lbTrafficExtensionId", "requestId", )) & set(("parent", "lbTrafficExtensionId", "lbTrafficExtension", )))
...
def test_update_lb_traffic_extension_rest_required_fields(request_type=dep.UpdateLbTrafficExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_lb_traffic_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_lb_traffic_extension_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("lbTrafficExtension", )))
...
def test_update_lb_traffic_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'lb_traffic_extension': {'name': 'projects/sample1/locations/sample2/lbTrafficExtensions/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{lb_traffic_extension.name=projects/*/locations/*/lbTrafficExtensions/*}" % client.transport._host, args[1])
...
def test_delete_lb_traffic_extension_rest_required_fields(request_type=dep.DeleteLbTrafficExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_lb_traffic_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_lb_route_extensions_rest_required_fields(request_type=dep.ListLbRouteExtensionsRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_lb_route_extensions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_lb_route_extensions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/lbRouteExtensions" % client.transport._host, args[1])
...
def test_get_lb_route_extension_rest_required_fields(request_type=dep.GetLbRouteExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_lb_route_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_lb_route_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/lbRouteExtensions/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/lbRouteExtensions/*}" % client.transport._host, args[1])
...
def test_create_lb_route_extension_rest_required_fields(request_type=dep.CreateLbRouteExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_lb_route_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "lbRouteExtensionId" in jsonified_request
    assert jsonified_request["lbRouteExtensionId"] == request_init["lb_route_extension_id"]
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_lb_route_extension._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("lb_route_extension_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_lb_route_extension_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("lbRouteExtensionId", "requestId", )) & set(("parent", "lbRouteExtensionId", "lbRouteExtension", )))
...
def test_update_lb_route_extension_rest_required_fields(request_type=dep.UpdateLbRouteExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_lb_route_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_lb_route_extension_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("lbRouteExtension", )))
...
def test_update_lb_route_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'lb_route_extension': {'name': 'projects/sample1/locations/sample2/lbRouteExtensions/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{lb_route_extension.name=projects/*/locations/*/lbRouteExtensions/*}" % client.transport._host, args[1])
...
def test_delete_lb_route_extension_rest_required_fields(request_type=dep.DeleteLbRouteExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_lb_route_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_authz_extensions_rest_required_fields(request_type=dep.ListAuthzExtensionsRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_authz_extensions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_authz_extensions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/authzExtensions" % client.transport._host, args[1])
...
def test_get_authz_extension_rest_required_fields(request_type=dep.GetAuthzExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_authz_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_authz_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/authzExtensions/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/authzExtensions/*}" % client.transport._host, args[1])
...
def test_create_authz_extension_rest_required_fields(request_type=dep.CreateAuthzExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_authz_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_authz_extension._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("authz_extension_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_authz_extension_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("authzExtensionId", "requestId", )) & set(("parent", "authzExtensionId", "authzExtension", )))
...
def test_update_authz_extension_rest_required_fields(request_type=dep.UpdateAuthzExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_authz_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_authz_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'authz_extension': {'name': 'projects/sample1/locations/sample2/authzExtensions/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{authz_extension.name=projects/*/locations/*/authzExtensions/*}" % client.transport._host, args[1])
...
def test_delete_authz_extension_rest_required_fields(request_type=dep.DeleteAuthzExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_authz_extension._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_lb_traffic_extensions_rest_bad_request(request_type=dep.ListLbTrafficExtensionsRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_lb_traffic_extensions_rest_interceptors(null_interceptor):
    transport = transports.DepServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DepServiceRestInterceptor(),
        )
    client = DepServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_list_lb_traffic_extensions") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_list_lb_traffic_extensions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_list_lb_traffic_extensions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.ListLbTrafficExtensionsRequest.pb(dep.ListLbTrafficExtensionsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dep.ListLbTrafficExtensionsResponse.to_json(dep.ListLbTrafficExtensionsResponse())
        ...
        post_with_metadata.return_value = dep.ListLbTrafficExtensionsResponse(), metadata

        client.list_lb_traffic_extensions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_lb_traffic_extension_rest_bad_request(request_type=dep.GetLbTrafficExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/lbTrafficExtensions/sample3'}
    request = request_type(**request_init)
...
def test_get_lb_traffic_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_get_lb_traffic_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_get_lb_traffic_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_get_lb_traffic_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.GetLbTrafficExtensionRequest.pb(dep.GetLbTrafficExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_lb_traffic_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_lb_traffic_extension_rest_bad_request(request_type=dep.CreateLbTrafficExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_lb_traffic_extension_rest_call_success(request_type):
    ...
    for field, value in request_init["lb_traffic_extension"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_lb_traffic_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DepServiceRestInterceptor, "post_create_lb_traffic_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_create_lb_traffic_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_create_lb_traffic_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.CreateLbTrafficExtensionRequest.pb(dep.CreateLbTrafficExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_lb_traffic_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_lb_traffic_extension_rest_bad_request(request_type=dep.UpdateLbTrafficExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'lb_traffic_extension': {'name': 'projects/sample1/locations/sample2/lbTrafficExtensions/sample3'}}
    request = request_type(**request_init)
...
def test_update_lb_traffic_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_update_lb_traffic_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_update_lb_traffic_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_update_lb_traffic_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.UpdateLbTrafficExtensionRequest.pb(dep.UpdateLbTrafficExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_lb_traffic_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_lb_traffic_extension_rest_bad_request(request_type=dep.DeleteLbTrafficExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_lb_traffic_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_delete_lb_traffic_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_delete_lb_traffic_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_delete_lb_traffic_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.DeleteLbTrafficExtensionRequest.pb(dep.DeleteLbTrafficExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_lb_traffic_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_lb_route_extensions_rest_bad_request(request_type=dep.ListLbRouteExtensionsRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_lb_route_extensions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_list_lb_route_extensions") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_list_lb_route_extensions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_list_lb_route_extensions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.ListLbRouteExtensionsRequest.pb(dep.ListLbRouteExtensionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dep.ListLbRouteExtensionsResponse.to_json(dep.ListLbRouteExtensionsResponse())
        req.return_value.content = return_value
        ...
        client.list_lb_route_extensions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_lb_route_extension_rest_bad_request(request_type=dep.GetLbRouteExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/lbRouteExtensions/sample3'}
    request = request_type(**request_init)
...
def test_get_lb_route_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_get_lb_route_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_get_lb_route_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_get_lb_route_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_lb_route_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_lb_route_extension_rest_bad_request(request_type=dep.CreateLbRouteExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_lb_route_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_create_lb_route_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_create_lb_route_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_create_lb_route_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.CreateLbRouteExtensionRequest.pb(dep.CreateLbRouteExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_lb_route_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_lb_route_extension_rest_bad_request(request_type=dep.UpdateLbRouteExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'lb_route_extension': {'name': 'projects/sample1/locations/sample2/lbRouteExtensions/sample3'}}
    request = request_type(**request_init)
...
def test_update_lb_route_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_update_lb_route_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_update_lb_route_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_update_lb_route_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.UpdateLbRouteExtensionRequest.pb(dep.UpdateLbRouteExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_lb_route_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_lb_route_extension_rest_bad_request(request_type=dep.DeleteLbRouteExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_lb_route_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_delete_lb_route_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_delete_lb_route_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_delete_lb_route_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.DeleteLbRouteExtensionRequest.pb(dep.DeleteLbRouteExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_lb_route_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_authz_extensions_rest_bad_request(request_type=dep.ListAuthzExtensionsRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_authz_extensions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_list_authz_extensions") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_list_authz_extensions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_list_authz_extensions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dep.ListAuthzExtensionsResponse.to_json(dep.ListAuthzExtensionsResponse())
        req.return_value.content = return_value
        ...
        client.list_authz_extensions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_authz_extension_rest_bad_request(request_type=dep.GetAuthzExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/authzExtensions/sample3'}
    request = request_type(**request_init)
...
def test_get_authz_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_get_authz_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_get_authz_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_get_authz_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_authz_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_authz_extension_rest_bad_request(request_type=dep.CreateAuthzExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_authz_extension_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["authz_extension"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'labels': {}, 'load_balancing_scheme': 1, 'authority': 'authority_value', 'service': 'service_value', 'timeout': {'seconds': 751, 'nanos': 543}, 'fail_open': True, 'metadata': {'fields': {}}, 'forward_headers': ['forward_headers_value1', 'forward_headers_value2'], 'wire_format': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_authz_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_create_authz_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_create_authz_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_create_authz_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.CreateAuthzExtensionRequest.pb(dep.CreateAuthzExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_authz_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_authz_extension_rest_bad_request(request_type=dep.UpdateAuthzExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'authz_extension': {'name': 'projects/sample1/locations/sample2/authzExtensions/sample3'}}
    request = request_type(**request_init)
...
def test_update_authz_extension_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'authz_extension': {'name': 'projects/sample1/locations/sample2/authzExtensions/sample3'}}
    request_init["authz_extension"] = {'name': 'projects/sample1/locations/sample2/authzExtensions/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'labels': {}, 'load_balancing_scheme': 1, 'authority': 'authority_value', 'service': 'service_value', 'timeout': {'seconds': 751, 'nanos': 543}, 'fail_open': True, 'metadata': {'fields': {}}, 'forward_headers': ['forward_headers_value1', 'forward_headers_value2'], 'wire_format': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_authz_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_update_authz_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_update_authz_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_update_authz_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.UpdateAuthzExtensionRequest.pb(dep.UpdateAuthzExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_authz_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_authz_extension_rest_bad_request(request_type=dep.DeleteAuthzExtensionRequest):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_authz_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_delete_authz_extension") as post, \
        mock.patch.object(transports.DepServiceRestInterceptor, "post_delete_authz_extension_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DepServiceRestInterceptor, "pre_delete_authz_extension") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.DeleteAuthzExtensionRequest.pb(dep.DeleteAuthzExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_authz_extension(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_dep_service_base_transport():
    ...
    with mock.patch('google.cloud.network_services_v1.services.dep_service.transports.DepServiceTransport.__init__') as Transport:
...
def test_dep_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.network_services_v1.services.dep_service.transports.DepServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_dep_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.network_services_v1.services.dep_service.transports.DepServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DepServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.DepServiceGrpcTransport, transports.DepServiceGrpcAsyncIOTransport])
def test_dep_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_dep_service_host_no_port(transport_name):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='networkservices.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'networkservices.googleapis.com:443'
...
def test_dep_service_host_with_port(transport_name):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='networkservices.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
@pytest.mark.parametrize("transport_class", [transports.DepServiceGrpcTransport, transports.DepServiceGrpcAsyncIOTransport])
def test_dep_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DepServiceGrpcTransport, transports.DepServiceGrpcAsyncIOTransport])
def test_dep_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_authz_extension_path():
    ...
    expected = "projects/{project}/locations/{location}/authzExtensions/{authz_extension}".format(project=project, location=location, authz_extension=authz_extension, )
...
def test_lb_route_extension_path():
    ...
    expected = "projects/{project}/locations/{location}/lbRouteExtensions/{lb_route_extension}".format(project=project, location=location, lb_route_extension=lb_route_extension, )
    actual = DepServiceClient.lb_route_extension_path(project, location, lb_route_extension)
    assert expected == actual
...
def test_lb_traffic_extension_path():
    ...
    expected = "projects/{project}/locations/{location}/lbTrafficExtensions/{lb_traffic_extension}".format(project=project, location=location, lb_traffic_extension=lb_traffic_extension, )
    actual = DepServiceClient.lb_traffic_extension_path(project, location, lb_traffic_extension)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.DepServiceTransport, '_prep_wrapped_messages') as prep:
        client = DepServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

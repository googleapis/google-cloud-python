...
def test_list_lb_route_extensions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_lb_route_extensions(request={})
...
def test_update_lb_traffic_extension_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("updateMask", "lbTrafficExtension", )))
...
def test_update_lb_route_extension_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("updateMask", "lbRouteExtension", )))

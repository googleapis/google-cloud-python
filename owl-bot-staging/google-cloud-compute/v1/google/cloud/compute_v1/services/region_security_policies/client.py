...
class RegionSecurityPoliciesClient(metaclass=RegionSecurityPoliciesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionSecurityPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            RegionSecurityPoliciesClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RegionSecurityPoliciesTransport, Callable[..., RegionSecurityPoliciesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionSecurityPoliciesClient._read_environment_variables()
        self._client_cert_source = RegionSecurityPoliciesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionSecurityPoliciesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionSecurityPoliciesTransport], Callable[..., RegionSecurityPoliciesTransport]] = (
    ...
    def add_rule_unary(self,
            request: Optional[Union[compute.AddRuleRegionSecurityPolicyRequest, dict]] = None,
            *,
        ...
        has_flattened_params = any([project, region, security_policy, security_policy_rule_resource])
    ...
    def get_rule(self,
            request: Optional[Union[compute.GetRuleRegionSecurityPolicyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            security_policy: Optional[str] = None,
    ...
    def patch_rule_unary(self,
            request: Optional[Union[compute.PatchRuleRegionSecurityPolicyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            security_policy: Optional[str] = None,
    ...
    def remove_rule_unary(self,
            request: Optional[Union[compute.RemoveRuleRegionSecurityPolicyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            security_policy: Optional[str] = None,

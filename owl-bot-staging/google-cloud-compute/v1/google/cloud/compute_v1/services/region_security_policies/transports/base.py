...
class RegionSecurityPoliciesTransport(abc.ABC):
    """Abstract transport class for RegionSecurityPolicies."""
    ...
    def get(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.SecurityPolicy]
            ]]:
        raise NotImplementedError()
    ...
    def get_rule(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.SecurityPolicyRule]
            ]]:
        raise NotImplementedError()
    ...
    def list(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.SecurityPolicyList]
            ]]:
        raise NotImplementedError()

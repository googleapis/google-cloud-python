...
class ImagesClient(metaclass=ImagesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ImagesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ImagesClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        Args:
            ...
            transport (Union[str, ImagesTransport]): The
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ImagesClient._read_environment_variables()
        self._client_cert_source = ImagesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ImagesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
    ...
    def get_from_family(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetFromFamilyImageRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_iam_policy(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetIamPolicyImageRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListImagesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def set_iam_policy(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.SetIamPolicyImageRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def test_iam_permissions(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.TestIamPermissionsImageRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

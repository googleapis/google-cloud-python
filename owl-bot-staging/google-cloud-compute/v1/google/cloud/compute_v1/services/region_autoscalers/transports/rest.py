...
from .rest_base import _BaseRegionAutoscalersRestTransport
...
class RegionAutoscalersRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteRegionAutoscalerRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteRegionAutoscalerRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_with_metadata(self, response: compute.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        ...
        is returned by the RegionAutoscalers server but before it is returned to user code.
    ...
    def pre_get(self, request: compute.GetRegionAutoscalerRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetRegionAutoscalerRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.Autoscaler, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Autoscaler, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_insert(self, request: compute.InsertRegionAutoscalerRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertRegionAutoscalerRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListRegionAutoscalersRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListRegionAutoscalersRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.RegionAutoscalerList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.RegionAutoscalerList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_patch(self, request: compute.PatchRegionAutoscalerRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchRegionAutoscalerRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update(self, request: compute.UpdateRegionAutoscalerRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.UpdateRegionAutoscalerRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class RegionAutoscalersRestTransport(_BaseRegionAutoscalersRestTransport):
    """REST backend synchronous transport for RegionAutoscalers.
    ...
    class _Delete(_BaseRegionAutoscalersRestTransport._BaseDelete, RegionAutoscalersRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionAutoscalersClient.Delete",
                    extra = {
            ...
            # Send the request
            response = RegionAutoscalersRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionAutoscalersClient.delete",
                    extra = {
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "Delete",
    ...
    class _Get(_BaseRegionAutoscalersRestTransport._BaseGet, RegionAutoscalersRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionAutoscalersClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionAutoscalersRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionAutoscalersClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _Insert(_BaseRegionAutoscalersRestTransport._BaseInsert, RegionAutoscalersRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionAutoscalersClient.Insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionAutoscalersRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionAutoscalersClient.insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseRegionAutoscalersRestTransport._BaseList, RegionAutoscalersRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionAutoscalersClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionAutoscalersRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionAutoscalersClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _Patch(_BaseRegionAutoscalersRestTransport._BasePatch, RegionAutoscalersRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionAutoscalersClient.Patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionAutoscalersRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionAutoscalersClient.patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
    ...
    class _Update(_BaseRegionAutoscalersRestTransport._BaseUpdate, RegionAutoscalersRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionAutoscalersClient.Update",
                    extra = {
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "Update",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionAutoscalersRestTransport._Update._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionAutoscalersClient.update",
                    extra = {
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "Update",
                        "metadata": http_response["headers"],

...
class RegionZonesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_list(self, request: compute.ListRegionZonesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListRegionZonesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.ZoneList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ZoneList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class RegionZonesRestTransport(_BaseRegionZonesRestTransport):
    ...
    class _List(_BaseRegionZonesRestTransport._BaseList, RegionZonesRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseRegionZonesRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseRegionZonesRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionZonesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

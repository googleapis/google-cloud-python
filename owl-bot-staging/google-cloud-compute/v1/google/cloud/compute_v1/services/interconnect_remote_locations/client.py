...
from google.cloud.compute_v1.services.interconnect_remote_locations import pagers
...
class InterconnectRemoteLocationsClient(metaclass=InterconnectRemoteLocationsClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.InterconnectRemoteLocationsClient`.",
                    extra = {
    ...
    def get(self,
        ...
        Returns:
            google.cloud.compute_v1.types.InterconnectRemoteLocation:

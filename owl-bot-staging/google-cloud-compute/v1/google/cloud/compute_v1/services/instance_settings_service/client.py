...
from .transports.base import InstanceSettingsServiceTransport, DEFAULT_CLIENT_INFO
...
class InstanceSettingsServiceClient(metaclass=InstanceSettingsServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = InstanceSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = InstanceSettingsServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            InstanceSettingsServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, InstanceSettingsServiceTransport, Callable[..., InstanceSettingsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = InstanceSettingsServiceClient._read_environment_variables()
        self._client_cert_source = InstanceSettingsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = InstanceSettingsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            InstanceSettingsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[InstanceSettingsServiceTransport], Callable[..., InstanceSettingsServiceTransport]] = (
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                # Create a client
                client = compute_v1.InstanceSettingsServiceClient()

                # Initialize request argument(s)
                request = compute_v1.GetInstanceSettingRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.GetInstanceSettingRequest, dict]):
        ...
        if not isinstance(request, compute.GetInstanceSettingRequest):
            request = compute.GetInstanceSettingRequest(request)
    ...
    def patch_unary(self,
            request: Optional[Union[compute.PatchInstanceSettingRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            instance_settings_resource: Optional[compute.InstanceSettings] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1.PatchInstanceSettingRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.PatchInstanceSettingRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                should not be set.
            zone (str):
                The zone scoping this request. It
                should conform to RFC1035.

                This corresponds to the ``zone`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            instance_settings_resource (google.cloud.compute_v1.types.InstanceSettings):
                The body resource for this request
                This corresponds to the ``instance_settings_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.PatchInstanceSettingRequest):
            request = compute.PatchInstanceSettingRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            if zone is not None:
                request.zone = zone
            if instance_settings_resource is not None:
                request.instance_settings_resource = instance_settings_resource
    ...
    def __enter__(self) -> "InstanceSettingsServiceClient":
        return self

...
from .base import InstanceSettingsServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class InstanceSettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetInstanceSettingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetInstanceSettingRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get(self, response: compute.InstanceSettings) -> compute.InstanceSettings:
        ...
        """
        return response
    def pre_patch(self, request: compute.PatchInstanceSettingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchInstanceSettingRequest, Sequence[Tuple[str, str]]]:

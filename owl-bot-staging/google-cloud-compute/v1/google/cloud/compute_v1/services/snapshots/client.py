...
class SnapshotsClientMeta(type):
    """Metaclass for the Snapshots client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[SnapshotsTransport]]
    _transport_registry["rest"] = SnapshotsRestTransport
...
class SnapshotsClient(metaclass=SnapshotsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SnapshotsClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> SnapshotsTransport:
        """Returns the transport used by the client instance.

        Returns:
            SnapshotsTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = SnapshotsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = SnapshotsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SnapshotsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SnapshotsClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SnapshotsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SnapshotsTransport, Callable[..., SnapshotsTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,SnapshotsTransport,Callable[..., SnapshotsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the SnapshotsTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SnapshotsClient._read_environment_variables()
        self._client_cert_source = SnapshotsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SnapshotsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SnapshotsTransport)
        if transport_provided:
            # transport is a SnapshotsTransport instance.
            ...
            self._transport = cast(SnapshotsTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SnapshotsTransport], Callable[..., SnapshotsTransport]] = (
    ...
    def set_iam_policy(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, resource, global_set_policy_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_labels_unary(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, resource, global_set_labels_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsSnapshotRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            resource: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, resource, test_permissions_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')

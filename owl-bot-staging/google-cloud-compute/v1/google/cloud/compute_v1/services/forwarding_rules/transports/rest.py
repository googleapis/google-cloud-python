...
class ForwardingRulesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListForwardingRulesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListForwardingRulesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list(self, response: compute.ForwardingRuleAggregatedList) -> compute.ForwardingRuleAggregatedList:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.ForwardingRuleAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ForwardingRuleAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_delete(self, request: compute.DeleteForwardingRuleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteForwardingRuleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetForwardingRuleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetForwardingRuleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.ForwardingRule, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ForwardingRule, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_insert(self, request: compute.InsertForwardingRuleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertForwardingRuleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListForwardingRulesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListForwardingRulesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.ForwardingRuleList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ForwardingRuleList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_patch(self, request: compute.PatchForwardingRuleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchForwardingRuleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_set_labels(self, request: compute.SetLabelsForwardingRuleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SetLabelsForwardingRuleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_set_target(self, request: compute.SetTargetForwardingRuleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SetTargetForwardingRuleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_set_target_with_metadata(self, response: compute.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for set_target
...
class ForwardingRulesRestTransport(_BaseForwardingRulesRestTransport):
    ...
    class _AggregatedList(_BaseForwardingRulesRestTransport._BaseAggregatedList, ForwardingRulesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseForwardingRulesRestTransport._BaseAggregatedList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseForwardingRulesRestTransport._BaseAggregatedList._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ForwardingRulesRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = compute.ForwardingRuleAggregatedList.to_json(response)
                except:
    ...
    class _Delete(_BaseForwardingRulesRestTransport._BaseDelete, ForwardingRulesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseForwardingRulesRestTransport._BaseDelete._get_http_options()

            request, metadata = self._interceptor.pre_delete(request, metadata)
            transcoded_request = _BaseForwardingRulesRestTransport._BaseDelete._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseForwardingRulesRestTransport._BaseDelete._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ForwardingRulesRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseForwardingRulesRestTransport._BaseGet, ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseForwardingRulesRestTransport._BaseGet._get_http_options()

            request, metadata = self._interceptor.pre_get(request, metadata)
            transcoded_request = _BaseForwardingRulesRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseForwardingRulesRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ForwardingRulesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseForwardingRulesRestTransport._BaseInsert, ForwardingRulesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseForwardingRulesRestTransport._BaseInsert._get_http_options()

            request, metadata = self._interceptor.pre_insert(request, metadata)
            transcoded_request = _BaseForwardingRulesRestTransport._BaseInsert._get_transcoded_request(http_options, request)

            body = _BaseForwardingRulesRestTransport._BaseInsert._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseForwardingRulesRestTransport._BaseInsert._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ForwardingRulesRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _List(_BaseForwardingRulesRestTransport._BaseList, ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseForwardingRulesRestTransport._BaseList._get_http_options()

            request, metadata = self._interceptor.pre_list(request, metadata)
            transcoded_request = _BaseForwardingRulesRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseForwardingRulesRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ForwardingRulesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Patch(_BaseForwardingRulesRestTransport._BasePatch, ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseForwardingRulesRestTransport._BasePatch._get_http_options()

            request, metadata = self._interceptor.pre_patch(request, metadata)
            transcoded_request = _BaseForwardingRulesRestTransport._BasePatch._get_transcoded_request(http_options, request)

            body = _BaseForwardingRulesRestTransport._BasePatch._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseForwardingRulesRestTransport._BasePatch._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ForwardingRulesRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SetLabels(_BaseForwardingRulesRestTransport._BaseSetLabels, ForwardingRulesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseForwardingRulesRestTransport._BaseSetLabels._get_http_options()

            request, metadata = self._interceptor.pre_set_labels(request, metadata)
            transcoded_request = _BaseForwardingRulesRestTransport._BaseSetLabels._get_transcoded_request(http_options, request)

            body = _BaseForwardingRulesRestTransport._BaseSetLabels._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseForwardingRulesRestTransport._BaseSetLabels._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ForwardingRulesRestTransport._SetLabels._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SetTarget(_BaseForwardingRulesRestTransport._BaseSetTarget, ForwardingRulesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseForwardingRulesRestTransport._BaseSetTarget._get_http_options()

            request, metadata = self._interceptor.pre_set_target(request, metadata)
            transcoded_request = _BaseForwardingRulesRestTransport._BaseSetTarget._get_transcoded_request(http_options, request)

            body = _BaseForwardingRulesRestTransport._BaseSetTarget._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseForwardingRulesRestTransport._BaseSetTarget._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ForwardingRulesRestTransport._SetTarget._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

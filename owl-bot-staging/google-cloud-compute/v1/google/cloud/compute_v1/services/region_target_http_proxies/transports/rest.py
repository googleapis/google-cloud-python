...
class RegionTargetHttpProxiesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteRegionTargetHttpProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteRegionTargetHttpProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetRegionTargetHttpProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetRegionTargetHttpProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert(self, request: compute.InsertRegionTargetHttpProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertRegionTargetHttpProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListRegionTargetHttpProxiesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListRegionTargetHttpProxiesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_set_url_map(self, request: compute.SetUrlMapRegionTargetHttpProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SetUrlMapRegionTargetHttpProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class RegionTargetHttpProxiesRestTransport(_BaseRegionTargetHttpProxiesRestTransport):
    ...
    class _Delete(_BaseRegionTargetHttpProxiesRestTransport._BaseDelete, RegionTargetHttpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionTargetHttpProxiesRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseRegionTargetHttpProxiesRestTransport._BaseGet, RegionTargetHttpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionTargetHttpProxiesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseRegionTargetHttpProxiesRestTransport._BaseInsert, RegionTargetHttpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionTargetHttpProxiesRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _List(_BaseRegionTargetHttpProxiesRestTransport._BaseList, RegionTargetHttpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionTargetHttpProxiesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetUrlMap(_BaseRegionTargetHttpProxiesRestTransport._BaseSetUrlMap, RegionTargetHttpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionTargetHttpProxiesRestTransport._SetUrlMap._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class RegionTargetHttpProxiesTransport(abc.ABC):
    """Abstract transport class for RegionTargetHttpProxies."""
    ...
    def get(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.TargetHttpProxy]
            ]]:
        raise NotImplementedError()
    ...
    def list(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.TargetHttpProxyList]
            ]]:
        raise NotImplementedError()

...
class RegionBackendServicesClient(metaclass=RegionBackendServicesClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            RegionBackendServicesClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        Args:
            ...
            transport (Union[str, RegionBackendServicesTransport]): The
    ...
    def get(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetRegionBackendServiceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_health(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, region, backend_service, resource_group_reference_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')

        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetHealthRegionBackendServiceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_iam_policy(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetIamPolicyRegionBackendServiceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListRegionBackendServicesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_usable(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListUsableRegionBackendServicesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def patch_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, region, backend_service, backend_service_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_iam_policy(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.SetIamPolicyRegionBackendServiceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def set_security_policy_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, region, backend_service, security_policy_reference_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')

        # Minor optimization to avoid making a copy if the user passes
        # in a compute.SetSecurityPolicyRegionBackendServiceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def test_iam_permissions(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.TestIamPermissionsRegionBackendServiceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

...
class RegionBackendServicesRestInterceptor:
    """Interceptor for RegionBackendServices.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the RegionBackendServicesRestTransport.

    .. code-block:: python
        class MyCustomRegionBackendServicesInterceptor(RegionBackendServicesRestInterceptor):
        ...
        transport = RegionBackendServicesRestTransport(interceptor=MyCustomRegionBackendServicesInterceptor())
        client = RegionBackendServicesClient(transport=transport)


    """
    def pre_delete(self, request: compute.DeleteRegionBackendServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteRegionBackendServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for delete

        Override in a subclass to manipulate the request or metadata
        before they are sent to the RegionBackendServices server.
        """
        return request, metadata
    ...
    def post_delete(self, response: compute.Operation) -> compute.Operation:
        ...
        after it is returned by the RegionBackendServices server but before
    ...
    def post_delete_with_metadata(self, response: compute.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        ...
        is returned by the RegionBackendServices server but before it is returned to user code.
    ...
    def pre_get(self, request: compute.GetRegionBackendServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetRegionBackendServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.BackendService, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.BackendService, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_get_health(self, request: compute.GetHealthRegionBackendServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetHealthRegionBackendServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_health(self, response: compute.BackendServiceGroupHealth) -> compute.BackendServiceGroupHealth:
    ...
    def post_get_health_with_metadata(self, response: compute.BackendServiceGroupHealth, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.BackendServiceGroupHealth, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_health
    ...
    def pre_get_iam_policy(self, request: compute.GetIamPolicyRegionBackendServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetIamPolicyRegionBackendServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert(self, request: compute.InsertRegionBackendServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertRegionBackendServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListRegionBackendServicesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListRegionBackendServicesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list(self, response: compute.BackendServiceList) -> compute.BackendServiceList:
    ...
    def post_list_with_metadata(self, response: compute.BackendServiceList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.BackendServiceList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_list_usable(self, request: compute.ListUsableRegionBackendServicesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListUsableRegionBackendServicesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_usable(self, response: compute.BackendServiceListUsable) -> compute.BackendServiceListUsable:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the RegionBackendServices server but before
        it is returned to user code. This `post_list_usable` interceptor runs
        before the `post_list_usable_with_metadata` interceptor.
        """
        return response

    def post_list_usable_with_metadata(self, response: compute.BackendServiceListUsable, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.BackendServiceListUsable, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_usable

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the RegionBackendServices server but before it is returned to user code.

        We recommend only using this `post_list_usable_with_metadata`
        interceptor in new development instead of the `post_list_usable` interceptor.
        When both interceptors are used, this `post_list_usable_with_metadata` interceptor runs after the
        `post_list_usable` interceptor. The (possibly modified) response returned by
        `post_list_usable` will be passed to
        `post_list_usable_with_metadata`.
        """
        return response, metadata

    def pre_patch(self, request: compute.PatchRegionBackendServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchRegionBackendServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_set_iam_policy(self, request: compute.SetIamPolicyRegionBackendServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SetIamPolicyRegionBackendServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_set_security_policy(self, request: compute.SetSecurityPolicyRegionBackendServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SetSecurityPolicyRegionBackendServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_set_security_policy_with_metadata(self, response: compute.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for set_security_policy
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsRegionBackendServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsRegionBackendServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update(self, request: compute.UpdateRegionBackendServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.UpdateRegionBackendServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_with_metadata(self, response: compute.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update
...
class RegionBackendServicesRestTransport(_BaseRegionBackendServicesRestTransport):
    ...
    class _Delete(_BaseRegionBackendServicesRestTransport._BaseDelete, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BaseDelete._get_http_options()

            request, metadata = self._interceptor.pre_delete(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BaseDelete._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BaseDelete._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseRegionBackendServicesRestTransport._BaseGet, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BaseGet._get_http_options()

            request, metadata = self._interceptor.pre_get(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetHealth(_BaseRegionBackendServicesRestTransport._BaseGetHealth, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BaseGetHealth._get_http_options()

            request, metadata = self._interceptor.pre_get_health(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BaseGetHealth._get_transcoded_request(http_options, request)

            body = _BaseRegionBackendServicesRestTransport._BaseGetHealth._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BaseGetHealth._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._GetHealth._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = compute.BackendServiceGroupHealth.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _GetIamPolicy(_BaseRegionBackendServicesRestTransport._BaseGetIamPolicy, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BaseGetIamPolicy._get_http_options()

            request, metadata = self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseRegionBackendServicesRestTransport._BaseInsert, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BaseInsert._get_http_options()

            request, metadata = self._interceptor.pre_insert(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BaseInsert._get_transcoded_request(http_options, request)

            body = _BaseRegionBackendServicesRestTransport._BaseInsert._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BaseInsert._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _List(_BaseRegionBackendServicesRestTransport._BaseList, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BaseList._get_http_options()

            request, metadata = self._interceptor.pre_list(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListUsable(_BaseRegionBackendServicesRestTransport._BaseListUsable, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            Args:
                request (~.compute.ListUsableRegionBackendServicesRequest):
                    The request object. A request message for
                RegionBackendServices.ListUsable. See
                the method description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BaseListUsable._get_http_options()

            request, metadata = self._interceptor.pre_list_usable(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BaseListUsable._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BaseListUsable._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._ListUsable._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = compute.BackendServiceListUsable.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _Patch(_BaseRegionBackendServicesRestTransport._BasePatch, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BasePatch._get_http_options()

            request, metadata = self._interceptor.pre_patch(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BasePatch._get_transcoded_request(http_options, request)

            body = _BaseRegionBackendServicesRestTransport._BasePatch._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BasePatch._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SetIamPolicy(_BaseRegionBackendServicesRestTransport._BaseSetIamPolicy, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BaseSetIamPolicy._get_http_options()

            request, metadata = self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BaseSetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseRegionBackendServicesRestTransport._BaseSetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BaseSetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SetSecurityPolicy(_BaseRegionBackendServicesRestTransport._BaseSetSecurityPolicy, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BaseSetSecurityPolicy._get_http_options()

            request, metadata = self._interceptor.pre_set_security_policy(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BaseSetSecurityPolicy._get_transcoded_request(http_options, request)

            body = _BaseRegionBackendServicesRestTransport._BaseSetSecurityPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BaseSetSecurityPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._SetSecurityPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseRegionBackendServicesRestTransport._BaseTestIamPermissions, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseRegionBackendServicesRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Update(_BaseRegionBackendServicesRestTransport._BaseUpdate, RegionBackendServicesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionBackendServicesRestTransport._BaseUpdate._get_http_options()

            request, metadata = self._interceptor.pre_update(request, metadata)
            transcoded_request = _BaseRegionBackendServicesRestTransport._BaseUpdate._get_transcoded_request(http_options, request)

            body = _BaseRegionBackendServicesRestTransport._BaseUpdate._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseRegionBackendServicesRestTransport._BaseUpdate._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = RegionBackendServicesRestTransport._Update._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
from .base import RegionBackendServicesTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class RegionBackendServicesRestTransport(RegionBackendServicesTransport):
    ...
    class _SetSecurityPolicy(RegionBackendServicesRestStub):
        ...
        def __call__(self,
            ...
            pb_request = compute.SetSecurityPolicyRegionBackendServiceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _TestIamPermissions(RegionBackendServicesRestStub):
        ...
        def __call__(self,
            ...
            pb_request = compute.TestIamPermissionsRegionBackendServiceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)

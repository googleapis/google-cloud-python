...
class RegionDiskTypesTransport(abc.ABC):
    """Abstract transport class for RegionDiskTypes."""
    ...
    def list(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.RegionDiskTypeList]
            ]]:
        raise NotImplementedError()

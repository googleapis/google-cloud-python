...
class RegionDiskTypesClientMeta(type):
    """Metaclass for the RegionDiskTypes client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[RegionDiskTypesTransport]]
    _transport_registry["rest"] = RegionDiskTypesRestTransport
...
class RegionDiskTypesClient(metaclass=RegionDiskTypesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RegionDiskTypesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RegionDiskTypesTransport:
        """Returns the transport used by the client instance.

        Returns:
            RegionDiskTypesTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = RegionDiskTypesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = RegionDiskTypesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionDiskTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RegionDiskTypesClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RegionDiskTypesTransport, Callable[..., RegionDiskTypesTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionDiskTypesTransport,Callable[..., RegionDiskTypesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the RegionDiskTypesTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionDiskTypesClient._read_environment_variables()
        self._client_cert_source = RegionDiskTypesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionDiskTypesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RegionDiskTypesTransport)
        if transport_provided:
            # transport is a RegionDiskTypesTransport instance.
            ...
            self._transport = cast(RegionDiskTypesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            RegionDiskTypesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionDiskTypesTransport], Callable[..., RegionDiskTypesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionDiskTypesClient`.",
                    extra = {
    ...
    def get(self,
        ...
        flattened_params = [project, region, disk_type]
    ...
    def list(self,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListRegionDiskTypesRequest):
            request = compute.ListRegionDiskTypesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

...
class TargetTcpProxiesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListTargetTcpProxiesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListTargetTcpProxiesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.TargetTcpProxyAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TargetTcpProxyAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_delete(self, request: compute.DeleteTargetTcpProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteTargetTcpProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetTargetTcpProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetTargetTcpProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.TargetTcpProxy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TargetTcpProxy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_insert(self, request: compute.InsertTargetTcpProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertTargetTcpProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListTargetTcpProxiesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListTargetTcpProxiesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.TargetTcpProxyList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TargetTcpProxyList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_set_backend_service(self, request: compute.SetBackendServiceTargetTcpProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SetBackendServiceTargetTcpProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_set_proxy_header(self, request: compute.SetProxyHeaderTargetTcpProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SetProxyHeaderTargetTcpProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class TargetTcpProxiesRestTransport(_BaseTargetTcpProxiesRestTransport):
    ...
    class _AggregatedList(_BaseTargetTcpProxiesRestTransport._BaseAggregatedList, TargetTcpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TargetTcpProxiesRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Delete(_BaseTargetTcpProxiesRestTransport._BaseDelete, TargetTcpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TargetTcpProxiesRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseTargetTcpProxiesRestTransport._BaseGet, TargetTcpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TargetTcpProxiesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseTargetTcpProxiesRestTransport._BaseInsert, TargetTcpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TargetTcpProxiesRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _List(_BaseTargetTcpProxiesRestTransport._BaseList, TargetTcpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TargetTcpProxiesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetBackendService(_BaseTargetTcpProxiesRestTransport._BaseSetBackendService, TargetTcpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TargetTcpProxiesRestTransport._SetBackendService._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SetProxyHeader(_BaseTargetTcpProxiesRestTransport._BaseSetProxyHeader, TargetTcpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TargetTcpProxiesRestTransport._SetProxyHeader._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class AcceleratorTypesClient(metaclass=AcceleratorTypesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AcceleratorTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = AcceleratorTypesClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AcceleratorTypesClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AcceleratorTypesTransport, Callable[..., AcceleratorTypesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AcceleratorTypesClient._read_environment_variables()
        self._client_cert_source = AcceleratorTypesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AcceleratorTypesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            AcceleratorTypesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AcceleratorTypesTransport], Callable[..., AcceleratorTypesTransport]] = (
    ...
    def aggregated_list(self,
            request: Optional[Union[compute.AggregatedListAcceleratorTypesRequest, dict]] = None,
            *,
    ...
    def get(self,
        ...
        Args:
            ...
            accelerator_type (str):
                Name of the accelerator type to
                return.

...
class AddressesClient(metaclass=AddressesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = AddressesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = AddressesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AddressesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = AddressesClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AddressesTransport, Callable[..., AddressesTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,AddressesTransport,Callable[..., AddressesTransport]]]):
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AddressesClient._read_environment_variables()
        self._client_cert_source = AddressesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AddressesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, AddressesTransport)
        if transport_provided:
            ...
            self._transport = cast(AddressesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            AddressesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AddressesTransport], Callable[..., AddressesTransport]] = (
                AddressesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AddressesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.AddressesClient`.",
                    extra = {
    ...
    def delete_unary(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, address]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def insert_unary(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, address_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def move_unary(self,
            request: Optional[Union[compute.MoveAddressRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            address: Optional[str] = None,
            region_addresses_move_request_resource: Optional[compute.RegionAddressesMoveRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.MoveAddressRequest, dict]):
                ...
                See the method description for details.
            project (str):
                Source project ID which the Address
                is moved from.
            ...
            address (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            region_addresses_move_request_resource (google.cloud.compute_v1.types.RegionAddressesMoveRequest):
                The body resource for this request
                This corresponds to the ``region_addresses_move_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, address, region_addresses_move_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.MoveAddressRequest):
            request = compute.MoveAddressRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            ...
            if address is not None:
                request.address = address
            if region_addresses_move_request_resource is not None:
                request.region_addresses_move_request_resource = region_addresses_move_request_resource
    ...
    def set_labels_unary(self,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.SetLabelsAddressRequest):
            request = compute.SetLabelsAddressRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsAddressRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            resource: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsAddressRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsAddressRequest):
            request = compute.TestIamPermissionsAddressRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

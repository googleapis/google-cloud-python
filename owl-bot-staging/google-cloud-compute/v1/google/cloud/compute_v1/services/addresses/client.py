...
class AddressesClient(metaclass=AddressesClientMeta):
    ...
    def aggregated_list(self,
        ...
        # in a compute.AggregatedListAddressesRequest.
    ...
    def get(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetAddressRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListAddressesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def move_unary(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.MoveAddressRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def set_labels_unary(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.SetLabelsAddressRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

...
class GlobalOrganizationOperationsClient(metaclass=GlobalOrganizationOperationsClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            GlobalOrganizationOperationsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        Args:
            ...
            transport (Union[str, GlobalOrganizationOperationsTransport]): The
    ...
    def delete(self,
        ...
        # in a compute.DeleteGlobalOrganizationOperationRequest.

...
class GlobalOrganizationOperationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteGlobalOrganizationOperationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteGlobalOrganizationOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_with_metadata(self, response: compute.DeleteGlobalOrganizationOperationResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteGlobalOrganizationOperationResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete
    ...
    def pre_get(self, request: compute.GetGlobalOrganizationOperationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetGlobalOrganizationOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListGlobalOrganizationOperationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListGlobalOrganizationOperationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class GlobalOrganizationOperationsRestTransport(_BaseGlobalOrganizationOperationsRestTransport):
    ...
    class _Delete(_BaseGlobalOrganizationOperationsRestTransport._BaseDelete, GlobalOrganizationOperationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GlobalOrganizationOperationsRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseGlobalOrganizationOperationsRestTransport._BaseGet, GlobalOrganizationOperationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GlobalOrganizationOperationsRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _List(_BaseGlobalOrganizationOperationsRestTransport._BaseList, GlobalOrganizationOperationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GlobalOrganizationOperationsRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class HealthChecksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListHealthChecksRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListHealthChecksRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list(self, response: compute.HealthChecksAggregatedList) -> compute.HealthChecksAggregatedList:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.HealthChecksAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.HealthChecksAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_delete(self, request: compute.DeleteHealthCheckRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteHealthCheckRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetHealthCheckRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetHealthCheckRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert(self, request: compute.InsertHealthCheckRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertHealthCheckRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListHealthChecksRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListHealthChecksRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_patch(self, request: compute.PatchHealthCheckRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchHealthCheckRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update(self, request: compute.UpdateHealthCheckRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.UpdateHealthCheckRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class HealthChecksRestTransport(_BaseHealthChecksRestTransport):
    ...
    class _AggregatedList(_BaseHealthChecksRestTransport._BaseAggregatedList, HealthChecksRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseHealthChecksRestTransport._BaseAggregatedList._get_http_options()

            request, metadata = self._interceptor.pre_aggregated_list(request, metadata)
            transcoded_request = _BaseHealthChecksRestTransport._BaseAggregatedList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseHealthChecksRestTransport._BaseAggregatedList._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = HealthChecksRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = compute.HealthChecksAggregatedList.to_json(response)
                except:
    ...
    class _Delete(_BaseHealthChecksRestTransport._BaseDelete, HealthChecksRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseHealthChecksRestTransport._BaseDelete._get_http_options()

            request, metadata = self._interceptor.pre_delete(request, metadata)
            transcoded_request = _BaseHealthChecksRestTransport._BaseDelete._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseHealthChecksRestTransport._BaseDelete._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = HealthChecksRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseHealthChecksRestTransport._BaseGet, HealthChecksRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseHealthChecksRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseHealthChecksRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = HealthChecksRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseHealthChecksRestTransport._BaseInsert, HealthChecksRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseHealthChecksRestTransport._BaseInsert._get_http_options()

            request, metadata = self._interceptor.pre_insert(request, metadata)
            transcoded_request = _BaseHealthChecksRestTransport._BaseInsert._get_transcoded_request(http_options, request)

            body = _BaseHealthChecksRestTransport._BaseInsert._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseHealthChecksRestTransport._BaseInsert._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = HealthChecksRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _List(_BaseHealthChecksRestTransport._BaseList, HealthChecksRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseHealthChecksRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseHealthChecksRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = HealthChecksRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Patch(_BaseHealthChecksRestTransport._BasePatch, HealthChecksRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseHealthChecksRestTransport._BasePatch._get_transcoded_request(http_options, request)

            body = _BaseHealthChecksRestTransport._BasePatch._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseHealthChecksRestTransport._BasePatch._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = HealthChecksRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Update(_BaseHealthChecksRestTransport._BaseUpdate, HealthChecksRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseHealthChecksRestTransport._BaseUpdate._get_http_options()

            request, metadata = self._interceptor.pre_update(request, metadata)
            transcoded_request = _BaseHealthChecksRestTransport._BaseUpdate._get_transcoded_request(http_options, request)

            body = _BaseHealthChecksRestTransport._BaseUpdate._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseHealthChecksRestTransport._BaseUpdate._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = HealthChecksRestTransport._Update._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

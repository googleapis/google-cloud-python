...
class RegionHealthChecksTransport(abc.ABC):
    """Abstract transport class for RegionHealthChecks."""
    ...
    def list(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.HealthCheckList]
            ]]:
        raise NotImplementedError()

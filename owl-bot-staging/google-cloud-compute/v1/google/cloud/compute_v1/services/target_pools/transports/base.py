...
class TargetPoolsTransport(abc.ABC):
    """Abstract transport class for TargetPools."""
    ...
    def get_health(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.TargetPoolInstanceHealth]
            ]]:
        raise NotImplementedError()
    ...
    def list(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.TargetPoolList]
            ]]:
        raise NotImplementedError()

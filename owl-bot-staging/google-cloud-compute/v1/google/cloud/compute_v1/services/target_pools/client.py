...
class TargetPoolsClient(metaclass=TargetPoolsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = TargetPoolsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = TargetPoolsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = TargetPoolsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = TargetPoolsClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TargetPoolsTransport, Callable[..., TargetPoolsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = TargetPoolsClient._read_environment_variables()
        self._client_cert_source = TargetPoolsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = TargetPoolsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, TargetPoolsTransport)
        if transport_provided:
            ...
            self._transport = cast(TargetPoolsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            TargetPoolsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TargetPoolsTransport], Callable[..., TargetPoolsTransport]] = (
                TargetPoolsClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.TargetPoolsClient`.",
                    extra = {
    ...
    def add_health_check_unary(self,
            ...
            *,
            ...
            target_pools_add_health_check_request_resource: Optional[compute.TargetPoolsAddHealthCheckRequest] = None,
        ...
        flattened_params = [project, region, target_pool, target_pools_add_health_check_request_resource]
        ...
        if not isinstance(request, compute.AddHealthCheckTargetPoolRequest):
            ...
            if target_pools_add_health_check_request_resource is not None:
                request.target_pools_add_health_check_request_resource = target_pools_add_health_check_request_resource
    ...
    def add_instance_unary(self,
            ...
            *,
            ...
            region: Optional[str] = None,
            target_pool: Optional[str] = None,
            target_pools_add_instance_request_resource: Optional[compute.TargetPoolsAddInstanceRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_pool, target_pools_add_instance_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.AddInstanceTargetPoolRequest):
            ...
            if target_pools_add_instance_request_resource is not None:
                request.target_pools_add_instance_request_resource = target_pools_add_instance_request_resource
    ...
    def remove_health_check_unary(self,
            request: Optional[Union[compute.RemoveHealthCheckTargetPoolRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            target_pool: Optional[str] = None,
            target_pools_remove_health_check_request_resource: Optional[compute.TargetPoolsRemoveHealthCheckRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_pool, target_pools_remove_health_check_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.RemoveHealthCheckTargetPoolRequest):
            ...
            if target_pools_remove_health_check_request_resource is not None:
                request.target_pools_remove_health_check_request_resource = target_pools_remove_health_check_request_resource
    ...
    def remove_instance_unary(self,
            ...
            *,
            ...
            region: Optional[str] = None,
            target_pool: Optional[str] = None,
            target_pools_remove_instance_request_resource: Optional[compute.TargetPoolsRemoveInstanceRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_pool, target_pools_remove_instance_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.RemoveInstanceTargetPoolRequest):
            ...
            if target_pools_remove_instance_request_resource is not None:
                request.target_pools_remove_instance_request_resource = target_pools_remove_instance_request_resource
    ...
    def set_security_policy_unary(self,
            request: Optional[Union[compute.SetSecurityPolicyTargetPoolRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            target_pool: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_pool, security_policy_reference_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsTargetPoolRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1.TestIamPermissionsTargetPoolRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsTargetPoolRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsTargetPoolRequest):
            request = compute.TestIamPermissionsTargetPoolRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def __enter__(self) -> "TargetPoolsClient":
        return self

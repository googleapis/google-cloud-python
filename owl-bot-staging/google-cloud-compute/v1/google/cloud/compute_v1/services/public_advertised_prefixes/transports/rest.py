...
class PublicAdvertisedPrefixesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_announce(self, request: compute.AnnouncePublicAdvertisedPrefixeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AnnouncePublicAdvertisedPrefixeRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_patch(self, response: compute.Operation) -> compute.Operation:
        ...
        """
        return response
    def pre_withdraw(self, request: compute.WithdrawPublicAdvertisedPrefixeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.WithdrawPublicAdvertisedPrefixeRequest, Sequence[Tuple[str, str]]]:

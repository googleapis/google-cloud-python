...
class RoutersRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get_nat_ip_info(self, request: compute.GetNatIpInfoRouterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetNatIpInfoRouterRequest, Sequence[Tuple[str, str]]]:

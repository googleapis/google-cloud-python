...
class NodeTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListNodeTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListNodeTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.NodeTypeAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.NodeTypeAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_get(self, request: compute.GetNodeTypeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetNodeTypeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.NodeType, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.NodeType, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_list(self, request: compute.ListNodeTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListNodeTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.NodeTypeList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.NodeTypeList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class NodeTypesRestTransport(_BaseNodeTypesRestTransport):
    ...
    class _AggregatedList(_BaseNodeTypesRestTransport._BaseAggregatedList, NodeTypesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = NodeTypesRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

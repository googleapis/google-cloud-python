...
class SecurityPoliciesClient(metaclass=SecurityPoliciesClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SecurityPoliciesClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def add_rule_unary(self,
        ...
        has_flattened_params = any([project, security_policy, security_policy_rule_resource])
    ...
    def set_labels_unary(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.SetLabelsSecurityPolicyRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

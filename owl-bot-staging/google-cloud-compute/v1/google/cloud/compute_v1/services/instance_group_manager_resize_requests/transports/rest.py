...
class InstanceGroupManagerResizeRequestsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_cancel(self, request: compute.CancelInstanceGroupManagerResizeRequestRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.CancelInstanceGroupManagerResizeRequestRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_delete(self, request: compute.DeleteInstanceGroupManagerResizeRequestRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteInstanceGroupManagerResizeRequestRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetInstanceGroupManagerResizeRequestRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetInstanceGroupManagerResizeRequestRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert(self, request: compute.InsertInstanceGroupManagerResizeRequestRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertInstanceGroupManagerResizeRequestRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListInstanceGroupManagerResizeRequestsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListInstanceGroupManagerResizeRequestsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list(self, response: compute.InstanceGroupManagerResizeRequestsListResponse) -> compute.InstanceGroupManagerResizeRequestsListResponse:
    ...
    def post_list_with_metadata(self, response: compute.InstanceGroupManagerResizeRequestsListResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InstanceGroupManagerResizeRequestsListResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class InstanceGroupManagerResizeRequestsRestTransport(_BaseInstanceGroupManagerResizeRequestsRestTransport):
    ...
    def __init__(self, *,
       ...
       this library's repository. Thank you!
        ...
        self._interceptor = interceptor or InstanceGroupManagerResizeRequestsRestInterceptor()
        self._prep_wrapped_messages(client_info)

    class _Cancel(_BaseInstanceGroupManagerResizeRequestsRestTransport._BaseCancel, InstanceGroupManagerResizeRequestsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseInstanceGroupManagerResizeRequestsRestTransport._BaseCancel._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseInstanceGroupManagerResizeRequestsRestTransport._BaseCancel._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = InstanceGroupManagerResizeRequestsRestTransport._Cancel._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Delete(_BaseInstanceGroupManagerResizeRequestsRestTransport._BaseDelete, InstanceGroupManagerResizeRequestsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseInstanceGroupManagerResizeRequestsRestTransport._BaseDelete._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseInstanceGroupManagerResizeRequestsRestTransport._BaseDelete._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = InstanceGroupManagerResizeRequestsRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseInstanceGroupManagerResizeRequestsRestTransport._BaseGet, InstanceGroupManagerResizeRequestsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseInstanceGroupManagerResizeRequestsRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseInstanceGroupManagerResizeRequestsRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = InstanceGroupManagerResizeRequestsRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseInstanceGroupManagerResizeRequestsRestTransport._BaseInsert, InstanceGroupManagerResizeRequestsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseInstanceGroupManagerResizeRequestsRestTransport._BaseInsert._get_transcoded_request(http_options, request)

            body = _BaseInstanceGroupManagerResizeRequestsRestTransport._BaseInsert._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseInstanceGroupManagerResizeRequestsRestTransport._BaseInsert._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = InstanceGroupManagerResizeRequestsRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _List(_BaseInstanceGroupManagerResizeRequestsRestTransport._BaseList, InstanceGroupManagerResizeRequestsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseInstanceGroupManagerResizeRequestsRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseInstanceGroupManagerResizeRequestsRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = InstanceGroupManagerResizeRequestsRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = compute.InstanceGroupManagerResizeRequestsListResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,

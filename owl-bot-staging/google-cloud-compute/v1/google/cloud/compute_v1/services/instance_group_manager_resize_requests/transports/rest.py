...
from .base import InstanceGroupManagerResizeRequestsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class InstanceGroupManagerResizeRequestsRestTransport(InstanceGroupManagerResizeRequestsTransport):
    """REST backend transport for InstanceGroupManagerResizeRequests.
    ...
    class _Cancel(InstanceGroupManagerResizeRequestsRestStub):
        def __hash__(self):
            return hash("Cancel")
    ...
    class _Delete(InstanceGroupManagerResizeRequestsRestStub):
        def __hash__(self):
            return hash("Delete")
    ...
    class _Get(InstanceGroupManagerResizeRequestsRestStub):
        def __hash__(self):
            return hash("Get")
    ...
    class _Insert(InstanceGroupManagerResizeRequestsRestStub):
        def __hash__(self):
            return hash("Insert")
    ...
    class _List(InstanceGroupManagerResizeRequestsRestStub):
        def __hash__(self):
            return hash("List")

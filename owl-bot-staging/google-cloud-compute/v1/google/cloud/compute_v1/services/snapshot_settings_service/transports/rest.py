...
class SnapshotSettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetSnapshotSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetSnapshotSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_patch(self, request: compute.PatchSnapshotSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchSnapshotSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class SnapshotSettingsServiceRestTransport(_BaseSnapshotSettingsServiceRestTransport):
    ...
    class _Get(_BaseSnapshotSettingsServiceRestTransport._BaseGet, SnapshotSettingsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SnapshotSettingsServiceRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Patch(_BaseSnapshotSettingsServiceRestTransport._BasePatch, SnapshotSettingsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SnapshotSettingsServiceRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

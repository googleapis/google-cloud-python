...
class UrlMapsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListUrlMapsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListUrlMapsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.UrlMapsAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.UrlMapsAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_delete(self, request: compute.DeleteUrlMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetUrlMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert(self, request: compute.InsertUrlMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_invalidate_cache(self, request: compute.InvalidateCacheUrlMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InvalidateCacheUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_invalidate_cache_with_metadata(self, response: compute.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for invalidate_cache
    ...
    def pre_list(self, request: compute.ListUrlMapsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListUrlMapsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_patch(self, request: compute.PatchUrlMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update(self, request: compute.UpdateUrlMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.UpdateUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_validate(self, request: compute.ValidateUrlMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ValidateUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class UrlMapsRestTransport(_BaseUrlMapsRestTransport):
    ...
    class _AggregatedList(_BaseUrlMapsRestTransport._BaseAggregatedList, UrlMapsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UrlMapsRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseUrlMapsRestTransport._BaseInsert, UrlMapsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UrlMapsRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _InvalidateCache(_BaseUrlMapsRestTransport._BaseInvalidateCache, UrlMapsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UrlMapsRestTransport._InvalidateCache._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Update(_BaseUrlMapsRestTransport._BaseUpdate, UrlMapsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UrlMapsRestTransport._Update._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Validate(_BaseUrlMapsRestTransport._BaseValidate, UrlMapsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UrlMapsRestTransport._Validate._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

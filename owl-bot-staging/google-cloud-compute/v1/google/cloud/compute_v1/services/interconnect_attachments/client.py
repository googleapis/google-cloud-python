...
class InterconnectAttachmentsClient(metaclass=InterconnectAttachmentsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = InterconnectAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            InterconnectAttachmentsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        Args:
            ...
            transport (Union[str, InterconnectAttachmentsTransport]): The
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = InterconnectAttachmentsClient._read_environment_variables()
        self._client_cert_source = InterconnectAttachmentsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = InterconnectAttachmentsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
    ...
    def aggregated_list(self,
            request: Optional[Union[compute.AggregatedListInterconnectAttachmentsRequest, dict]] = None,
            *,
        ...
        # in a compute.AggregatedListInterconnectAttachmentsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, compute.AggregatedListInterconnectAttachmentsRequest):
    ...
    def delete_unary(self,
            request: Optional[Union[compute.DeleteInterconnectAttachmentRequest, dict]] = None,
            *,
            project: Optional[str] = None,
    ...
    def get(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetInterconnectAttachmentRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def insert_unary(self,
            request: Optional[Union[compute.InsertInterconnectAttachmentRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            interconnect_attachment_resource: Optional[compute.InterconnectAttachment] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute.Operation:
        ...
        if not isinstance(request, compute.InsertInterconnectAttachmentRequest):
            ...
            if interconnect_attachment_resource is not None:
                request.interconnect_attachment_resource = interconnect_attachment_resource
    ...
    def list(self,
            request: Optional[Union[compute.ListInterconnectAttachmentsRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListInterconnectAttachmentsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def patch_unary(self,
            request: Optional[Union[compute.PatchInterconnectAttachmentRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            interconnect_attachment: Optional[str] = None,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, region, interconnect_attachment, interconnect_attachment_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_labels_unary(self,
            request: Optional[Union[compute.SetLabelsInterconnectAttachmentRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.SetLabelsInterconnectAttachmentRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

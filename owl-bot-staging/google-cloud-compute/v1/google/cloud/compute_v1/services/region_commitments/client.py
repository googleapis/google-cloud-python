...
from .transports.rest import RegionCommitmentsRestTransport


class RegionCommitmentsClientMeta(type):
    """Metaclass for the RegionCommitments client.
...
class RegionCommitmentsClient(metaclass=RegionCommitmentsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RegionCommitmentsClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RegionCommitmentsTransport:
        """Returns the transport used by the client instance.

        Returns:
            RegionCommitmentsTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = RegionCommitmentsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = RegionCommitmentsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionCommitmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RegionCommitmentsClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            RegionCommitmentsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RegionCommitmentsTransport, Callable[..., RegionCommitmentsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionCommitmentsClient._read_environment_variables()
        self._client_cert_source = RegionCommitmentsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionCommitmentsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RegionCommitmentsTransport)
        if transport_provided:
            # transport is a RegionCommitmentsTransport instance.
            ...
            self._transport = cast(RegionCommitmentsTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionCommitmentsTransport], Callable[..., RegionCommitmentsTransport]] = (
                RegionCommitmentsClient.get_transport_class(transport)
    ...
    def aggregated_list(self,
            request: Optional[Union[compute.AggregatedListRegionCommitmentsRequest, dict]] = None,
            *,

...
class RegionCommitmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListRegionCommitmentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListRegionCommitmentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.CommitmentAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.CommitmentAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_get(self, request: compute.GetRegionCommitmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetRegionCommitmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.Commitment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Commitment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_insert(self, request: compute.InsertRegionCommitmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertRegionCommitmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListRegionCommitmentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListRegionCommitmentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.CommitmentList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.CommitmentList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_update(self, request: compute.UpdateRegionCommitmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.UpdateRegionCommitmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class RegionCommitmentsRestTransport(_BaseRegionCommitmentsRestTransport):
    ...
    class _AggregatedList(_BaseRegionCommitmentsRestTransport._BaseAggregatedList, RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionCommitmentsRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseRegionCommitmentsRestTransport._BaseGet, RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionCommitmentsRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseRegionCommitmentsRestTransport._BaseInsert, RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionCommitmentsRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _List(_BaseRegionCommitmentsRestTransport._BaseList, RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionCommitmentsRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Update(_BaseRegionCommitmentsRestTransport._BaseUpdate, RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionCommitmentsRestTransport._Update._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

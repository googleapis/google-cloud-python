...
class ExternalVpnGatewaysRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteExternalVpnGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetExternalVpnGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.ExternalVpnGateway, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ExternalVpnGateway, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_insert(self, request: compute.InsertExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertExternalVpnGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListExternalVpnGatewaysRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListExternalVpnGatewaysRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.ExternalVpnGatewayList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ExternalVpnGatewayList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_set_labels(self, request: compute.SetLabelsExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SetLabelsExternalVpnGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsExternalVpnGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class ExternalVpnGatewaysRestTransport(_BaseExternalVpnGatewaysRestTransport):
    ...
    class _Delete(_BaseExternalVpnGatewaysRestTransport._BaseDelete, ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ExternalVpnGatewaysRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseExternalVpnGatewaysRestTransport._BaseGet, ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ExternalVpnGatewaysRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseExternalVpnGatewaysRestTransport._BaseInsert, ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ExternalVpnGatewaysRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _List(_BaseExternalVpnGatewaysRestTransport._BaseList, ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ExternalVpnGatewaysRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetLabels(_BaseExternalVpnGatewaysRestTransport._BaseSetLabels, ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ExternalVpnGatewaysRestTransport._SetLabels._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseExternalVpnGatewaysRestTransport._BaseTestIamPermissions, ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ExternalVpnGatewaysRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class FirewallsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteFirewallRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteFirewallRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetFirewallRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetFirewallRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.Firewall, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Firewall, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_insert(self, request: compute.InsertFirewallRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertFirewallRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListFirewallsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListFirewallsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.FirewallList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.FirewallList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_patch(self, request: compute.PatchFirewallRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchFirewallRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update(self, request: compute.UpdateFirewallRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.UpdateFirewallRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class FirewallsRestTransport(_BaseFirewallsRestTransport):
    ...
    class _Insert(_BaseFirewallsRestTransport._BaseInsert, FirewallsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FirewallsRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Patch(_BaseFirewallsRestTransport._BasePatch, FirewallsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FirewallsRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Update(_BaseFirewallsRestTransport._BaseUpdate, FirewallsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FirewallsRestTransport._Update._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

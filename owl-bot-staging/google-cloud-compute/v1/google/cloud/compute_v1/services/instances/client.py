...
class InstancesClient(metaclass=InstancesClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.InstancesClient`.",
                    extra = {
    ...
    def add_network_interface_unary(self,
        ...
        r"""Adds one dynamic network interface to an active
        instance.
        ...
        .. code-block:: python
            ...
            def sample_add_network_interface():
                # Create a client
                client = compute_v1.InstancesClient()

                # Initialize request argument(s)
                request = compute_v1.AddNetworkInterfaceInstanceRequest(
                    instance="instance_value",
                    project="project_value",
                    zone="zone_value",
                )
                ...
                # Make the request
                response = client.add_network_interface(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.compute_v1.types.AddNetworkInterfaceInstanceRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.AddNetworkInterfaceInstanceRequest):
            request = compute.AddNetworkInterfaceInstanceRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.add_network_interface]
    ...
    def delete_network_interface_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_network_interface():
                # Create a client
                client = compute_v1.InstancesClient()

                # Initialize request argument(s)
                request = compute_v1.DeleteNetworkInterfaceInstanceRequest(
                    instance="instance_value",
                    network_interface_name="network_interface_name_value",
                    project="project_value",
                    zone="zone_value",
                )

                # Make the request
                response = client.delete_network_interface(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.compute_v1.types.DeleteNetworkInterfaceInstanceRequest, dict]):
                The request object. A request message for
            ...
            network_interface_name (str):
                The name of the dynamic network
                interface to be deleted from the
                instance.

                This corresponds to the ``network_interface_name`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.DeleteNetworkInterfaceInstanceRequest):
            request = compute.DeleteNetworkInterfaceInstanceRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            ...
            if network_interface_name is not None:
                request.network_interface_name = network_interface_name

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_network_interface]
    ...
    def get_effective_firewalls(self,
    ...
    def get_serial_port_output(self,
    ...
    def get_shielded_instance_identity(self,
    ...
    def report_host_as_faulty_unary(self,
    ...
    def report_host_as_faulty(self,
            request: Optional[Union[compute.ReportHostAsFaultyInstanceRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
    ...
    def send_diagnostic_interrupt(self,
    ...
    def set_name_unary(self,
            request: Optional[Union[compute.SetNameInstanceRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            instance: Optional[str] = None,
        ...
        Args:
            ...
            instances_set_name_request_resource (google.cloud.compute_v1.types.InstancesSetNameRequest):
                The body resource for this request
                This corresponds to the ``instances_set_name_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.set_name]
    ...
    def set_security_policy_unary(self,
            request: Optional[Union[compute.SetSecurityPolicyInstanceRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            instance: Optional[str] = None,
        ...
        Args:
            ...
            instances_set_security_policy_request_resource (google.cloud.compute_v1.types.InstancesSetSecurityPolicyRequest):
                The body resource for this request
                This corresponds to the ``instances_set_security_policy_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.

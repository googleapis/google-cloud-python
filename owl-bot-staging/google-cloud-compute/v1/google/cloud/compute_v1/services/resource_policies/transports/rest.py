...
class ResourcePoliciesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_list(self, response: compute.ResourcePolicyList) -> compute.ResourcePolicyList:
        ...
        """
        return response
    def pre_patch(self, request: compute.PatchResourcePolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchResourcePolicyRequest, Sequence[Tuple[str, str]]]:

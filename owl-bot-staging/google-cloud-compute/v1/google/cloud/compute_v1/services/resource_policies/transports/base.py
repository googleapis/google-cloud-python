...
class ResourcePoliciesTransport(abc.ABC):
    """Abstract transport class for ResourcePolicies."""
    ...
    def get(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.ResourcePolicy]
            ]]:
        raise NotImplementedError()
    ...
    def list(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.ResourcePolicyList]
            ]]:
        raise NotImplementedError()

...
class ReservationSubBlocksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetReservationSubBlockRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetReservationSubBlockRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.ReservationSubBlocksGetResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ReservationSubBlocksGetResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_list(self, request: compute.ListReservationSubBlocksRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListReservationSubBlocksRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.ReservationSubBlocksListResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ReservationSubBlocksListResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_perform_maintenance(self, request: compute.PerformMaintenanceReservationSubBlockRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PerformMaintenanceReservationSubBlockRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class ReservationSubBlocksRestTransport(_BaseReservationSubBlocksRestTransport):
    ...
    class _Get(_BaseReservationSubBlocksRestTransport._BaseGet, ReservationSubBlocksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReservationSubBlocksRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _List(_BaseReservationSubBlocksRestTransport._BaseList, ReservationSubBlocksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReservationSubBlocksRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _PerformMaintenance(_BaseReservationSubBlocksRestTransport._BasePerformMaintenance, ReservationSubBlocksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReservationSubBlocksRestTransport._PerformMaintenance._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class InstanceGroupManagersTransport(abc.ABC):
    ...
    def get(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.InstanceGroupManager]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def resume_instances(self) -> Callable[
    ...
    @property
    def start_instances(self) -> Callable[
    ...
    @property
    def stop_instances(self) -> Callable[
    ...
    @property
    def suspend_instances(self) -> Callable[

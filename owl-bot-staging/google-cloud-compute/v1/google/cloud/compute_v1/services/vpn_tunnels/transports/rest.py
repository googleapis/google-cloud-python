...
class VpnTunnelsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListVpnTunnelsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListVpnTunnelsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list(self, response: compute.VpnTunnelAggregatedList) -> compute.VpnTunnelAggregatedList:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.VpnTunnelAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.VpnTunnelAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_delete(self, request: compute.DeleteVpnTunnelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteVpnTunnelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetVpnTunnelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetVpnTunnelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.VpnTunnel, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.VpnTunnel, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_insert(self, request: compute.InsertVpnTunnelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertVpnTunnelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListVpnTunnelsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListVpnTunnelsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.VpnTunnelList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.VpnTunnelList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_set_labels(self, request: compute.SetLabelsVpnTunnelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SetLabelsVpnTunnelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class VpnTunnelsRestTransport(_BaseVpnTunnelsRestTransport):
    ...
    class _AggregatedList(_BaseVpnTunnelsRestTransport._BaseAggregatedList, VpnTunnelsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseVpnTunnelsRestTransport._BaseAggregatedList._get_http_options()

            request, metadata = self._interceptor.pre_aggregated_list(request, metadata)
            transcoded_request = _BaseVpnTunnelsRestTransport._BaseAggregatedList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseVpnTunnelsRestTransport._BaseAggregatedList._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = VpnTunnelsRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Delete(_BaseVpnTunnelsRestTransport._BaseDelete, VpnTunnelsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseVpnTunnelsRestTransport._BaseDelete._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseVpnTunnelsRestTransport._BaseDelete._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = VpnTunnelsRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseVpnTunnelsRestTransport._BaseGet, VpnTunnelsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseVpnTunnelsRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseVpnTunnelsRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = VpnTunnelsRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseVpnTunnelsRestTransport._BaseInsert, VpnTunnelsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseVpnTunnelsRestTransport._BaseInsert._get_transcoded_request(http_options, request)

            body = _BaseVpnTunnelsRestTransport._BaseInsert._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseVpnTunnelsRestTransport._BaseInsert._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = VpnTunnelsRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _List(_BaseVpnTunnelsRestTransport._BaseList, VpnTunnelsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseVpnTunnelsRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseVpnTunnelsRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = VpnTunnelsRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetLabels(_BaseVpnTunnelsRestTransport._BaseSetLabels, VpnTunnelsRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseVpnTunnelsRestTransport._BaseSetLabels._get_http_options()

            request, metadata = self._interceptor.pre_set_labels(request, metadata)
            transcoded_request = _BaseVpnTunnelsRestTransport._BaseSetLabels._get_transcoded_request(http_options, request)

            body = _BaseVpnTunnelsRestTransport._BaseSetLabels._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseVpnTunnelsRestTransport._BaseSetLabels._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = VpnTunnelsRestTransport._SetLabels._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

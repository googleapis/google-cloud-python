...
class VpnTunnelsRestTransport(VpnTunnelsTransport):
    """REST backend transport for VpnTunnels.
    ...
    class _AggregatedList(VpnTunnelsRestStub):
        def __hash__(self):
    ...
    class _Delete(VpnTunnelsRestStub):
        def __hash__(self):
            return hash("Delete")
    ...
    class _Insert(VpnTunnelsRestStub):
        def __hash__(self):
            return hash("Insert")
    ...
    class _List(VpnTunnelsRestStub):
        def __hash__(self):
            return hash("List")
    ...
    class _SetLabels(VpnTunnelsRestStub):
        def __hash__(self):

...
class InterconnectsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_diagnostics(self, response: compute.InterconnectsGetDiagnosticsResponse) -> compute.InterconnectsGetDiagnosticsResponse:
        ...
        """
        return response
    def pre_get_macsec_config(self, request: compute.GetMacsecConfigInterconnectRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetMacsecConfigInterconnectRequest, Sequence[Tuple[str, str]]]:

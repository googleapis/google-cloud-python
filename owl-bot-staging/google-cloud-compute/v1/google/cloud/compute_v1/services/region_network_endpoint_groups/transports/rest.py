...
from .base import RegionNetworkEndpointGroupsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class RegionNetworkEndpointGroupsRestTransport(RegionNetworkEndpointGroupsTransport):
    ...
    class _AttachNetworkEndpoints(RegionNetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            pb_request = compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest.pb(request)
    ...
    class _DetachNetworkEndpoints(RegionNetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            pb_request = compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListNetworkEndpoints(RegionNetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            pb_request = compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)

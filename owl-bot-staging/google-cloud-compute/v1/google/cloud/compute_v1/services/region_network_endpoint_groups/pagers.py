...
class ListPager:
    ...
    def __init__(self,
        ...
        """
        self._method = method
        self._request = compute.ListRegionNetworkEndpointGroupsRequest(request)
...
class ListNetworkEndpointsPager:
    ...
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1.types.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest):
                The initial request object.
        ...
        """
        self._method = method
        self._request = compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest(request)
        self._response = response
        self._retry = retry
        self._timeout = timeout
        self._metadata = metadata

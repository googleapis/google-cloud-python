...
class ProjectsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_move_instance(self, response: compute.Operation) -> compute.Operation:
        ...
        """
        return response
    def pre_set_cloud_armor_tier(self, request: compute.SetCloudArmorTierProjectRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetCloudArmorTierProjectRequest, Sequence[Tuple[str, str]]]:

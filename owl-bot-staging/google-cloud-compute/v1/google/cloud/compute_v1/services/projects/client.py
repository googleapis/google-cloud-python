...
class ProjectsClient(metaclass=ProjectsClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ProjectsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def disable_xpn_host_unary(self,
    ...
    def disable_xpn_resource_unary(self,
    ...
    def enable_xpn_host_unary(self,
    ...
    def enable_xpn_resource_unary(self,
    ...
    def set_cloud_armor_tier_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.SetCloudArmorTierProjectRequest, dict]):
                The request object. A request message for
            ...
            projects_set_cloud_armor_tier_request_resource (google.cloud.compute_v1.types.ProjectsSetCloudArmorTierRequest):
                The body resource for this request
                This corresponds to the ``projects_set_cloud_armor_tier_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.SetCloudArmorTierProjectRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, compute.SetCloudArmorTierProjectRequest):
            request = compute.SetCloudArmorTierProjectRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.set_cloud_armor_tier]
    ...
    def set_common_instance_metadata_unary(self,
    ...
    def set_common_instance_metadata(self,
            request: Optional[Union[compute.SetCommonInstanceMetadataProjectRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            metadata_resource: Optional[compute.Metadata] = None,
    ...
    def set_default_network_tier_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, projects_set_default_network_tier_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_default_network_tier(self,
            request: Optional[Union[compute.SetDefaultNetworkTierProjectRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            projects_set_default_network_tier_request_resource: Optional[compute.ProjectsSetDefaultNetworkTierRequest] = None,
    ...
    def set_usage_export_bucket_unary(self,
    ...
    def set_usage_export_bucket(self,
            request: Optional[Union[compute.SetUsageExportBucketProjectRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            usage_export_location_resource: Optional[compute.UsageExportLocation] = None,

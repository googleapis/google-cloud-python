...
class NetworkFirewallPoliciesClient(metaclass=NetworkFirewallPoliciesClientMeta):
    ...
    def __init__(self, *,
        ...
        self._client_cert_source = NetworkFirewallPoliciesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
    ...
    def add_association_unary(self,
        ...
        has_flattened_params = any([project, firewall_policy, firewall_policy_association_resource])
    ...
    def add_packet_mirroring_rule_unary(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, firewall_policy, firewall_policy_rule_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def add_packet_mirroring_rule(self,
            request: Optional[Union[compute.AddPacketMirroringRuleNetworkFirewallPolicyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            firewall_policy: Optional[str] = None,
    ...
    def get_packet_mirroring_rule(self,
    ...
    def patch_packet_mirroring_rule_unary(self,
    ...
    def patch_packet_mirroring_rule(self,
            request: Optional[Union[compute.PatchPacketMirroringRuleNetworkFirewallPolicyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            firewall_policy: Optional[str] = None,
    ...
    def remove_association_unary(self,
    ...
    def remove_packet_mirroring_rule_unary(self,
    ...
    def remove_packet_mirroring_rule(self,
            request: Optional[Union[compute.RemovePacketMirroringRuleNetworkFirewallPolicyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            firewall_policy: Optional[str] = None,

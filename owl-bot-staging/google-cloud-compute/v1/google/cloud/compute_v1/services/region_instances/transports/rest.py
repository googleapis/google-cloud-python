...
from .base import RegionInstancesTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class RegionInstancesRestTransport(RegionInstancesTransport):
    """REST backend transport for RegionInstances.
    ...
    class _BulkInsert(RegionInstancesRestStub):
        def __hash__(self):

...
class TargetInstancesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_list(self, response: compute.TargetInstanceList) -> compute.TargetInstanceList:
        ...
        """
        return response
    def pre_set_security_policy(self, request: compute.SetSecurityPolicyTargetInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetSecurityPolicyTargetInstanceRequest, Sequence[Tuple[str, str]]]:

...
class RegionNotificationEndpointsClient(metaclass=RegionNotificationEndpointsClientMeta):
    ...
    def __init__(self, *,
        ...
        Args:
            ...
            transport (Union[str, RegionNotificationEndpointsTransport]): The
    ...
    def get(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetRegionNotificationEndpointRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListRegionNotificationEndpointsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

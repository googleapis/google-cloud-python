...
class computeCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'add_packet_mirroring_rule': ('firewall_policy', 'firewall_policy_rule_resource', 'project', 'max_priority', 'min_priority', 'request_id', ),
        ...
        'bulk_insert': ('bulk_insert_disk_resource_resource', 'project', 'zone', 'request_id', ),
        'cancel': ('instance_group_manager', 'project', 'resize_request', 'zone', 'request_id', ),
        ...
        'delete_route_policy': ('project', 'region', 'router', 'policy', 'request_id', ),
        ...
        'get_packet_mirroring_rule': ('firewall_policy', 'project', 'priority', ),
        'get_route_policy': ('project', 'region', 'router', 'policy', ),
        ...
        'list_bgp_routes': ('project', 'region', 'router', 'address_family', 'destination_prefix', 'filter', 'max_results', 'order_by', 'page_token', 'peer', 'policy_applied', 'return_partial_success', 'route_type', ),
        ...
        'move': ('address', 'project', 'region', 'region_addresses_move_request_resource', 'request_id', ),
        ...
        'patch_packet_mirroring_rule': ('firewall_policy', 'firewall_policy_rule_resource', 'project', 'priority', 'request_id', ),
        ...
        'patch_route_policy': ('project', 'region', 'route_policy_resource', 'router', 'request_id', ),
        ...
        'remove_packet_mirroring_rule': ('firewall_policy', 'project', 'priority', 'request_id', ),
        ...
        'resume_instances': ('instance_group_manager', 'instance_group_managers_resume_instances_request_resource', 'project', 'zone', 'request_id', ),
        ...
        'set_cloud_armor_tier': ('project', 'projects_set_cloud_armor_tier_request_resource', 'request_id', ),
        ...
        'start_instances': ('instance_group_manager', 'instance_group_managers_start_instances_request_resource', 'project', 'zone', 'request_id', ),
        'start_with_encryption_key': ('instance', 'instances_start_with_encryption_key_request_resource', 'project', 'zone', 'request_id', ),
        'stop': ('instance', 'project', 'zone', 'discard_local_ssd', 'request_id', ),
        'stop_async_replication': ('disk', 'project', 'zone', 'request_id', ),
        'stop_group_async_replication': ('disks_stop_group_async_replication_resource_resource', 'project', 'zone', 'request_id', ),
        'stop_instances': ('instance_group_manager', 'instance_group_managers_stop_instances_request_resource', 'project', 'zone', 'request_id', ),
        'suspend': ('instance', 'project', 'zone', 'discard_local_ssd', 'request_id', ),
        'suspend_instances': ('instance_group_manager', 'instance_group_managers_suspend_instances_request_resource', 'project', 'zone', 'request_id', ),
        ...
        'update_route_policy': ('project', 'region', 'route_policy_resource', 'router', 'request_id', ),

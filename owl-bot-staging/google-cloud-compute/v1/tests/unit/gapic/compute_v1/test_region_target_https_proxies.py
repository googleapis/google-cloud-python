...
def test_delete_rest_unset_required_fields():
    transport = transports.RegionTargetHttpsProxiesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_set_ssl_certificates_rest_required_fields(request_type=compute.SetSslCertificatesRegionTargetHttpsProxyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_ssl_certificates._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_url_map_rest_required_fields(request_type=compute.SetUrlMapRegionTargetHttpsProxyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_url_map._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

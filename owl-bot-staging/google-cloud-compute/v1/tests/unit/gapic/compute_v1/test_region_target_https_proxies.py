...
from google.cloud.compute_v1.services.region_target_https_proxies import RegionTargetHttpsProxiesClient
...
def test__read_environment_variables():
    assert RegionTargetHttpsProxiesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert RegionTargetHttpsProxiesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert RegionTargetHttpsProxiesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert RegionTargetHttpsProxiesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert RegionTargetHttpsProxiesClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert RegionTargetHttpsProxiesClient._get_client_cert_source(None, False) is None
    assert RegionTargetHttpsProxiesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RegionTargetHttpsProxiesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert RegionTargetHttpsProxiesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RegionTargetHttpsProxiesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(RegionTargetHttpsProxiesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionTargetHttpsProxiesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionTargetHttpsProxiesClient._DEFAULT_UNIVERSE
    default_endpoint = RegionTargetHttpsProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RegionTargetHttpsProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RegionTargetHttpsProxiesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert RegionTargetHttpsProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RegionTargetHttpsProxiesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionTargetHttpsProxiesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RegionTargetHttpsProxiesClient._get_api_endpoint(None, None, default_universe, "always") == RegionTargetHttpsProxiesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionTargetHttpsProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RegionTargetHttpsProxiesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionTargetHttpsProxiesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RegionTargetHttpsProxiesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RegionTargetHttpsProxiesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RegionTargetHttpsProxiesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RegionTargetHttpsProxiesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert RegionTargetHttpsProxiesClient._get_universe_domain(None, None) == RegionTargetHttpsProxiesClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        RegionTargetHttpsProxiesClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = RegionTargetHttpsProxiesClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (RegionTargetHttpsProxiesClient, transports.RegionTargetHttpsProxiesRestTransport, "rest"),
])
@mock.patch.object(RegionTargetHttpsProxiesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionTargetHttpsProxiesClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (RegionTargetHttpsProxiesClient, transports.RegionTargetHttpsProxiesRestTransport, "rest", "true"),
    (RegionTargetHttpsProxiesClient, transports.RegionTargetHttpsProxiesRestTransport, "rest", "false"),
])
@mock.patch.object(RegionTargetHttpsProxiesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionTargetHttpsProxiesClient))
...
@mock.patch.object(RegionTargetHttpsProxiesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionTargetHttpsProxiesClient))
def test_region_target_https_proxies_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (RegionTargetHttpsProxiesClient, transports.RegionTargetHttpsProxiesRestTransport, "rest", None),
])
...
def test_set_ssl_certificates_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RegionTargetHttpsProxiesClient(
...
def test_set_ssl_certificates_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            target_https_proxy='target_https_proxy_value',
            region_target_https_proxies_set_ssl_certificates_request_resource=compute.RegionTargetHttpsProxiesSetSslCertificatesRequest(ssl_certificates=['ssl_certificates_value']),
        )
        mock_args.update(sample_request)
...
def test_set_ssl_certificates_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RegionTargetHttpsProxiesClient(
...
def test_delete_rest_bad_request(request_type=compute.DeleteRegionTargetHttpsProxyRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.RegionTargetHttpsProxiesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RegionTargetHttpsProxiesRestInterceptor(),
        )
    client = RegionTargetHttpsProxiesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "pre_delete") as pre:
...
def test_get_rest_bad_request(request_type=compute.GetRegionTargetHttpsProxyRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.TargetHttpsProxy.to_json(compute.TargetHttpsProxy())
        req.return_value.content = return_value
...
def test_insert_rest_bad_request(request_type=compute.InsertRegionTargetHttpsProxyRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_bad_request(request_type=compute.ListRegionTargetHttpsProxiesRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_patch_rest_bad_request(request_type=compute.PatchRegionTargetHttpsProxyRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_ssl_certificates_rest_bad_request(request_type=compute.SetSslCertificatesRegionTargetHttpsProxyRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_ssl_certificates_rest_call_success(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["region_target_https_proxies_set_ssl_certificates_request_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_set_ssl_certificates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_set_ssl_certificates") as post, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_set_ssl_certificates_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "pre_set_ssl_certificates") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_url_map_rest_bad_request(request_type=compute.SetUrlMapRegionTargetHttpsProxyRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_url_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_set_url_map") as post, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_set_url_map_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "pre_set_url_map") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_ssl_certificates_unary_empty_call_rest():
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.set_ssl_certificates),
            '__call__') as call:
...
def test_set_url_map_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.set_url_map),
            '__call__') as call:
...
def test_region_target_https_proxies_client_transport_session_collision(transport_name):
    ...
    client1 = RegionTargetHttpsProxiesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = RegionTargetHttpsProxiesClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("client_class,transport_class", [
    (RegionTargetHttpsProxiesClient, transports.RegionTargetHttpsProxiesRestTransport),
])

...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.SubnetworksRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_expand_ip_cidr_range_rest_required_fields(request_type=compute.ExpandIpCidrRangeSubnetworkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).expand_ip_cidr_range._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_private_ip_google_access_rest_required_fields(request_type=compute.SetPrivateIpGoogleAccessSubnetworkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_private_ip_google_access._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

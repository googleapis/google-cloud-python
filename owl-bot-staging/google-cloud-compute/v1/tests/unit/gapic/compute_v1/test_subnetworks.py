...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("views", )) & set(("project", "region", "subnetwork", )))
...
def test_list_rest_required_fields(request_type=compute.ListSubnetworksRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("filter", "max_results", "order_by", "page_token", "return_partial_success", "views", ))
    jsonified_request.update(unset_fields)
...
def test_list_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "maxResults", "orderBy", "pageToken", "returnPartialSuccess", "views", )) & set(("project", "region", )))
...
def test_list_usable_rest_required_fields(request_type=compute.ListUsableSubnetworksRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_usable._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("filter", "max_results", "order_by", "page_token", "return_partial_success", "service_project", ))
    jsonified_request.update(unset_fields)
...
def test_list_usable_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "maxResults", "orderBy", "pageToken", "returnPartialSuccess", "serviceProject", )) & set(("project", )))
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_expand_ip_cidr_range_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_expand_ip_cidr_range_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_list_usable_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_list_usable_with_metadata") as post_with_metadata, \
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
...
def test_set_private_ip_google_access_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_set_private_ip_google_access_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubnetworksRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
...
def test_expand_ip_cidr_range_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.expand_ip_cidr_range),
            '__call__') as call:
...
def test_set_private_ip_google_access_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.set_private_ip_google_access),
            '__call__') as call:

...
def test_delete_rest_unset_required_fields():
    transport = transports.TargetSslProxiesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_set_backend_service_rest_required_fields(request_type=compute.SetBackendServiceTargetSslProxyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_backend_service._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_certificate_map_rest_required_fields(request_type=compute.SetCertificateMapTargetSslProxyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_certificate_map._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_proxy_header_rest_required_fields(request_type=compute.SetProxyHeaderTargetSslProxyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_proxy_header._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_ssl_policy_rest_required_fields(request_type=compute.SetSslPolicyTargetSslProxyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_ssl_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

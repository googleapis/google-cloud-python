...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.HealthChecksRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteHealthCheckRequest):
    client = HealthChecksClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertHealthCheckRequest):
    client = HealthChecksClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_patch_rest_bad_request(transport: str = 'rest', request_type=compute.PatchHealthCheckRequest):
    client = HealthChecksClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateHealthCheckRequest):
    client = HealthChecksClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )

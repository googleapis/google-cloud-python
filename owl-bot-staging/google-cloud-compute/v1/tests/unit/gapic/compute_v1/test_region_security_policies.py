...
def test_add_rule_rest_unset_required_fields():
    transport = transports.RegionSecurityPoliciesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_add_rule_rest_bad_request(transport: str = 'rest', request_type=compute.AddRuleRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_add_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/securityPolicies/{security_policy}/addRule" % client.transport._host, args[1])
...
def test_add_rule_unary_rest_bad_request(transport: str = 'rest', request_type=compute.AddRuleRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_rule_rest_bad_request(transport: str = 'rest', request_type=compute.GetRuleRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/securityPolicies/{security_policy}/getRule" % client.transport._host, args[1])
...
def test_patch_rule_rest_bad_request(transport: str = 'rest', request_type=compute.PatchRuleRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_patch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/securityPolicies/{security_policy}/patchRule" % client.transport._host, args[1])
...
def test_patch_rule_unary_rest_bad_request(transport: str = 'rest', request_type=compute.PatchRuleRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_remove_rule_rest_bad_request(transport: str = 'rest', request_type=compute.RemoveRuleRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_remove_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/securityPolicies/{security_policy}/removeRule" % client.transport._host, args[1])
...
def test_remove_rule_unary_rest_bad_request(transport: str = 'rest', request_type=compute.RemoveRuleRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )

...
def test_announce_rest_unset_required_fields():
    transport = transports.PublicAdvertisedPrefixesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_announce_rest_bad_request(transport: str = 'rest', request_type=compute.AnnouncePublicAdvertisedPrefixeRequest):
    client = PublicAdvertisedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_announce_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/global/publicAdvertisedPrefixes/{public_advertised_prefix}/announce" % client.transport._host, args[1])
...
def test_announce_unary_rest_bad_request(transport: str = 'rest', request_type=compute.AnnouncePublicAdvertisedPrefixeRequest):
    client = PublicAdvertisedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_withdraw_rest_bad_request(transport: str = 'rest', request_type=compute.WithdrawPublicAdvertisedPrefixeRequest):
    client = PublicAdvertisedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_withdraw_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/publicAdvertisedPrefixes/{public_advertised_prefix}/withdraw" % client.transport._host, args[1])
...
def test_withdraw_unary_rest_bad_request(transport: str = 'rest', request_type=compute.WithdrawPublicAdvertisedPrefixeRequest):
    client = PublicAdvertisedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )

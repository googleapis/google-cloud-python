...
def test_bulk_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            region='region_value',
            bulk_insert_disk_resource_resource=compute.BulkInsertDiskResource(source_consistency_group_policy='source_consistency_group_policy_value'),
        )
        mock_args.update(sample_request)
...
def test_start_async_replication_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            disk='disk_value',
            region_disks_start_async_replication_request_resource=compute.RegionDisksStartAsyncReplicationRequest(async_secondary_disk='async_secondary_disk_value'),
        )
        mock_args.update(sample_request)
...
def test_stop_group_async_replication_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            region='region_value',
            disks_stop_group_async_replication_resource_resource=compute.DisksStopGroupAsyncReplicationResource(resource_policy='resource_policy_value'),
        )
        mock_args.update(sample_request)
...
def test_add_resource_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_add_resource_policies") as post, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_add_resource_policies_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_add_resource_policies") as pre:
...
def test_bulk_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_bulk_insert") as post, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_bulk_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_bulk_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_create_snapshot") as post, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_create_snapshot_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_create_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2'}
    request_init["disk_resource"] = {'access_mode': 'access_mode_value', 'architecture': 'architecture_value', 'async_primary_disk': {'consistency_group_policy': 'consistency_group_policy_value', 'consistency_group_policy_id': 'consistency_group_policy_id_value', 'disk': 'disk_value', 'disk_id': 'disk_id_value'}, 'async_secondary_disks': {}, 'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'disk_encryption_key': {'kms_key_name': 'kms_key_name_value', 'kms_key_service_account': 'kms_key_service_account_value', 'raw_key': 'raw_key_value', 'rsa_encrypted_key': 'rsa_encrypted_key_value', 'sha256': 'sha256_value'}, 'enable_confidential_compute': True, 'guest_os_features': [{'type_': 'type__value'}], 'id': 205, 'kind': 'kind_value', 'label_fingerprint': 'label_fingerprint_value', 'labels': {}, 'last_attach_timestamp': 'last_attach_timestamp_value', 'last_detach_timestamp': 'last_detach_timestamp_value', 'license_codes': [1361, 1362], 'licenses': ['licenses_value1', 'licenses_value2'], 'location_hint': 'location_hint_value', 'name': 'name_value', 'options': 'options_value', 'params': {'resource_manager_tags': {}}, 'physical_block_size_bytes': 2663, 'provisioned_iops': 1740, 'provisioned_throughput': 2411, 'region': 'region_value', 'replica_zones': ['replica_zones_value1', 'replica_zones_value2'], 'resource_policies': ['resource_policies_value1', 'resource_policies_value2'], 'resource_status': {'async_primary_disk': {'state': 'state_value'}, 'async_secondary_disks': {}}, 'satisfies_pzi': True, 'satisfies_pzs': True, 'self_link': 'self_link_value', 'size_gb': 739, 'source_consistency_group_policy': 'source_consistency_group_policy_value', 'source_consistency_group_policy_id': 'source_consistency_group_policy_id_value', 'source_disk': 'source_disk_value', 'source_disk_id': 'source_disk_id_value', 'source_image': 'source_image_value', 'source_image_encryption_key': {}, 'source_image_id': 'source_image_id_value', 'source_instant_snapshot': 'source_instant_snapshot_value', 'source_instant_snapshot_id': 'source_instant_snapshot_id_value', 'source_snapshot': 'source_snapshot_value', 'source_snapshot_encryption_key': {}, 'source_snapshot_id': 'source_snapshot_id_value', 'source_storage_object': 'source_storage_object_value', 'status': 'status_value', 'storage_pool': 'storage_pool_value', 'type_': 'type__value', 'users': ['users_value1', 'users_value2'], 'zone': 'zone_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_remove_resource_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_remove_resource_policies") as post, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_remove_resource_policies_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_remove_resource_policies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_resize_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_resize_with_metadata") as post_with_metadata, \
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_set_labels") as post, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_set_labels_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_start_async_replication_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_start_async_replication") as post, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_start_async_replication_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_start_async_replication") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_stop_async_replication_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_stop_async_replication") as post, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_stop_async_replication_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_stop_async_replication") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_stop_group_async_replication_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_stop_group_async_replication") as post, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_stop_group_async_replication_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_stop_group_async_replication") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_update_with_metadata") as post_with_metadata, \
...
def test_add_resource_policies_unary_empty_call_rest():
    ...
    with mock.patch.object(
            type(client.transport.add_resource_policies),
            '__call__') as call:
...
def test_bulk_insert_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.bulk_insert),
            '__call__') as call:
...
def test_remove_resource_policies_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_resource_policies),
            '__call__') as call:
...
def test_start_async_replication_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.start_async_replication),
            '__call__') as call:
...
def test_stop_async_replication_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.stop_async_replication),
            '__call__') as call:
...
def test_stop_group_async_replication_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.stop_group_async_replication),
            '__call__') as call:

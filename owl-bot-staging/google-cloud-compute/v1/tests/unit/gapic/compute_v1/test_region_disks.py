...
def test_add_resource_policies_rest_required_fields(request_type=compute.AddResourcePoliciesRegionDiskRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).add_resource_policies._get_unset_required_fields(jsonified_request)
...
def test_add_resource_policies_rest_unset_required_fields():
    transport = transports.RegionDisksRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_bulk_insert_rest_required_fields(request_type=compute.BulkInsertRegionDiskRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).bulk_insert._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_snapshot_rest_required_fields(request_type=compute.CreateSnapshotRegionDiskRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_snapshot._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_resource_policies_rest_required_fields(request_type=compute.RemoveResourcePoliciesRegionDiskRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).remove_resource_policies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_resize_rest_required_fields(request_type=compute.ResizeRegionDiskRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).resize._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_async_replication_rest_required_fields(request_type=compute.StartAsyncReplicationRegionDiskRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).start_async_replication._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_stop_async_replication_rest_required_fields(request_type=compute.StopAsyncReplicationRegionDiskRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).stop_async_replication._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_stop_group_async_replication_rest_required_fields(request_type=compute.StopGroupAsyncReplicationRegionDiskRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).stop_group_async_replication._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = RegionAutoscalersClient(credentials=cred)
...
def test_delete_rest_unset_required_fields():
    transport = transports.RegionAutoscalersRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_delete_rest_bad_request(request_type=compute.DeleteRegionAutoscalerRequest):
    client = RegionAutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionAutoscalersRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_bad_request(request_type=compute.GetRegionAutoscalerRequest):
    client = RegionAutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionAutoscalersRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.Autoscaler.to_json(compute.Autoscaler())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.Autoscaler(), metadata
...
def test_insert_rest_bad_request(request_type=compute.InsertRegionAutoscalerRequest):
    client = RegionAutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionAutoscalersRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_bad_request(request_type=compute.ListRegionAutoscalersRequest):
    client = RegionAutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionAutoscalersRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.RegionAutoscalerList.to_json(compute.RegionAutoscalerList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.RegionAutoscalerList(), metadata
...
def test_patch_rest_bad_request(request_type=compute.PatchRegionAutoscalerRequest):
    client = RegionAutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionAutoscalersRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
...
def test_update_rest_bad_request(request_type=compute.UpdateRegionAutoscalerRequest):
    client = RegionAutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionAutoscalersRestInterceptor, "post_update_with_metadata") as post_with_metadata, \
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = compute.DeleteRegionAutoscalerRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetRegionAutoscalerRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertRegionAutoscalerRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListRegionAutoscalersRequest()
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchRegionAutoscalerRequest()
...
def test_update_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.UpdateRegionAutoscalerRequest()

...
from google.cloud.compute_v1.services.public_delegated_prefixes import PublicDelegatedPrefixesClient
from google.cloud.compute_v1.services.public_delegated_prefixes import pagers
from google.cloud.compute_v1.services.public_delegated_prefixes import transports
...
def test__get_api_endpoint():
    ...
    assert PublicDelegatedPrefixesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == PublicDelegatedPrefixesClient.DEFAULT_MTLS_ENDPOINT
    assert PublicDelegatedPrefixesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert PublicDelegatedPrefixesClient._get_api_endpoint(None, None, default_universe, "always") == PublicDelegatedPrefixesClient.DEFAULT_MTLS_ENDPOINT
    assert PublicDelegatedPrefixesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == PublicDelegatedPrefixesClient.DEFAULT_MTLS_ENDPOINT
...
def test_public_delegated_prefixes_client_get_transport_class():
    transport = PublicDelegatedPrefixesClient.get_transport_class()
    ...
    assert transport == transports.PublicDelegatedPrefixesRestTransport
...
def test_aggregated_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        return_value = compute.PublicDelegatedPrefixAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListPublicDelegatedPrefixesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).aggregated_list._get_unset_required_fields(jsonified_request)
...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.PublicDelegatedPrefixesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "pre_aggregated_list") as pre:
        ...
        req.return_value._content = compute.PublicDelegatedPrefixAggregatedList.to_json(compute.PublicDelegatedPrefixAggregatedList())
...
def test_aggregated_list_rest_bad_request(transport: str = 'rest', request_type=compute.AggregatedListPublicDelegatedPrefixesRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_announce_rest(request_type):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport="rest",
    )
...
def test_announce_rest_required_fields(request_type=compute.AnnouncePublicDelegatedPrefixeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).announce._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_announce_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "publicDelegatedPrefix", "region", )))
...
def test_announce_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_announce") as post, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "pre_announce") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.announce(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_announce_rest_bad_request(transport: str = 'rest', request_type=compute.AnnouncePublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_announce_rest_flattened():
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.announce(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}/announce" % client.transport._host, args[1])


def test_announce_rest_flattened_error(transport: str = 'rest'):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_announce_unary_rest(request_type):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value._content = json_return_value.encode('UTF-8')
        req.return_value = response_value
        response = client.announce_unary(request)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_announce_unary_rest_interceptors(null_interceptor):
    transport = transports.PublicDelegatedPrefixesRestTransport(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        interceptor=None if null_interceptor else transports.PublicDelegatedPrefixesRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.announce_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_announce_unary_rest_bad_request(transport: str = 'rest', request_type=compute.AnnouncePublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_announce_unary_rest_flattened():
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.announce_unary(**mock_args)
...
def test_announce_unary_rest_flattened_error(transport: str = 'rest'):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_announce_unary_rest_error():
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport='rest'
    )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeletePublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}" % client.transport._host, args[1])
...
def test_delete_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DeletePublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("project", "publicDelegatedPrefix", "region", )))
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_get") as post, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.PublicDelegatedPrefix.to_json(compute.PublicDelegatedPrefix())
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetPublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertPublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_insert_unary_rest_bad_request(transport: str = 'rest', request_type=compute.InsertPublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.PublicDelegatedPrefixList.to_json(compute.PublicDelegatedPrefixList())
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListPublicDelegatedPrefixesRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_patch") as post, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_bad_request(transport: str = 'rest', request_type=compute.PatchPublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_patch_unary_rest_bad_request(transport: str = 'rest', request_type=compute.PatchPublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_withdraw_rest(request_type):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value._content = json_return_value.encode('UTF-8')
        req.return_value = response_value
        response = client.withdraw(request)
...
def test_withdraw_rest_required_fields(request_type=compute.WithdrawPublicDelegatedPrefixeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).withdraw._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_withdraw_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_withdraw") as post, \
         mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "pre_withdraw") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.withdraw(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_withdraw_rest_bad_request(transport: str = 'rest', request_type=compute.WithdrawPublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_withdraw_rest_flattened():
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.withdraw(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}/withdraw" % client.transport._host, args[1])


def test_withdraw_rest_flattened_error(transport: str = 'rest'):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_withdraw_unary_rest(request_type):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value._content = json_return_value.encode('UTF-8')
        req.return_value = response_value
        response = client.withdraw_unary(request)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_withdraw_unary_rest_interceptors(null_interceptor):
    transport = transports.PublicDelegatedPrefixesRestTransport(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        interceptor=None if null_interceptor else transports.PublicDelegatedPrefixesRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.withdraw_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_withdraw_unary_rest_bad_request(transport: str = 'rest', request_type=compute.WithdrawPublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_withdraw_unary_rest_flattened():
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.withdraw_unary(**mock_args)
...
def test_withdraw_unary_rest_flattened_error(transport: str = 'rest'):
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_withdraw_unary_rest_error():
    client = PublicDelegatedPrefixesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport='rest'
    )
...
def test_public_delegated_prefixes_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.public_delegated_prefixes.transports.PublicDelegatedPrefixesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_public_delegated_prefixes_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.public_delegated_prefixes.transports.PublicDelegatedPrefixesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.PublicDelegatedPrefixesTransport()
        adc.assert_called_once()
...
def test_public_delegated_prefixes_auth_adc():
...
def test_public_delegated_prefixes_client_transport_session_collision(transport_name):
    creds1 = _AnonymousCredentialsWithUniverseDomain()
    creds2 = _AnonymousCredentialsWithUniverseDomain()
    client1 = PublicDelegatedPrefixesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = PublicDelegatedPrefixesClient(
        credentials=creds2,
        transport=transport_name,
    )
    ...
    session1 = client1.transport.announce._session
    session2 = client2.transport.announce._session
    assert session1 != session2
    ...
    assert session1 != session2
    session1 = client1.transport.withdraw._session
    session2 = client2.transport.withdraw._session
    assert session1 != session2

def test_common_billing_account_path():
    billing_account = "squid"
    expected = "billingAccounts/{billing_account}".format(billing_account=billing_account, )
    actual = PublicDelegatedPrefixesClient.common_billing_account_path(billing_account)
...
def test_parse_common_billing_account_path():
    ...
    path = PublicDelegatedPrefixesClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = PublicDelegatedPrefixesClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = PublicDelegatedPrefixesClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = PublicDelegatedPrefixesClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = PublicDelegatedPrefixesClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = PublicDelegatedPrefixesClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = PublicDelegatedPrefixesClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = PublicDelegatedPrefixesClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = PublicDelegatedPrefixesClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = PublicDelegatedPrefixesClient.parse_common_location_path(path)
    assert expected == actual

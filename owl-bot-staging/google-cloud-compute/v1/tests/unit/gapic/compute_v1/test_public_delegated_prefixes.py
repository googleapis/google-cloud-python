...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = PublicDelegatedPrefixesClient(credentials=cred)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
...
def test_announce_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_announce_with_metadata") as post_with_metadata, \
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = compute.PublicDelegatedPrefix(), metadata
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = compute.PublicDelegatedPrefixList(), metadata
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
...
def test_withdraw_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, "post_withdraw_with_metadata") as post_with_metadata, \
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = compute.AggregatedListPublicDelegatedPrefixesRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_announce_unary_empty_call_rest():
    client = PublicDelegatedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.announce),
            '__call__') as call:
        client.announce_unary(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.AnnouncePublicDelegatedPrefixeRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeletePublicDelegatedPrefixeRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetPublicDelegatedPrefixeRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertPublicDelegatedPrefixeRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListPublicDelegatedPrefixesRequest()
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchPublicDelegatedPrefixeRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_withdraw_unary_empty_call_rest():
    client = PublicDelegatedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.withdraw),
            '__call__') as call:
        client.withdraw_unary(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.WithdrawPublicDelegatedPrefixeRequest()

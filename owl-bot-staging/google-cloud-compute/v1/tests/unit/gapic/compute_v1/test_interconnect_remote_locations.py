...
from google.cloud.compute_v1.services.interconnect_remote_locations import InterconnectRemoteLocationsClient
from google.cloud.compute_v1.services.interconnect_remote_locations import pagers
from google.cloud.compute_v1.services.interconnect_remote_locations import transports
...
@mock.patch.object(InterconnectRemoteLocationsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(InterconnectRemoteLocationsClient))
def test__get_api_endpoint():
    ...
    assert InterconnectRemoteLocationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == InterconnectRemoteLocationsClient.DEFAULT_MTLS_ENDPOINT
    assert InterconnectRemoteLocationsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert InterconnectRemoteLocationsClient._get_api_endpoint(None, None, default_universe, "always") == InterconnectRemoteLocationsClient.DEFAULT_MTLS_ENDPOINT
    assert InterconnectRemoteLocationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == InterconnectRemoteLocationsClient.DEFAULT_MTLS_ENDPOINT
...
def test_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, compute.InterconnectRemoteLocation)
                for i in results)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InterconnectRemoteLocationsRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.InterconnectRemoteLocationsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectRemoteLocationsRestInterceptor, "pre_get") as pre:
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InterconnectRemoteLocationsRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.InterconnectRemoteLocationsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectRemoteLocationsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

...
def test_delete_rest_unset_required_fields():
    transport = transports.ImagesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_deprecate_rest_required_fields(request_type=compute.DeprecateImageRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).deprecate._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_from_family_rest_required_fields(request_type=compute.GetFromFamilyImageRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_from_family._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

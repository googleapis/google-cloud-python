...
def test__get_client_cert_source():
    ...
    assert ImagesClient._get_client_cert_source(None, False) is None
    assert ImagesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ImagesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ImagesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ImagesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ImagesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ImagesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ImagesClient._DEFAULT_UNIVERSE
    default_endpoint = ImagesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ImagesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ImagesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ImagesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ImagesClient.DEFAULT_MTLS_ENDPOINT
    assert ImagesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ImagesClient._get_api_endpoint(None, None, default_universe, "always") == ImagesClient.DEFAULT_MTLS_ENDPOINT
    assert ImagesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ImagesClient.DEFAULT_MTLS_ENDPOINT
    assert ImagesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ImagesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ImagesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ImagesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ImagesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ImagesClient._get_universe_domain(None, None) == ImagesClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ImagesClient(credentials=cred)
...
def test_images_client_from_service_account_info(client_class, transport_name):
...
def test_images_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
def test_images_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
@mock.patch.object(ImagesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ImagesClient))
def test_images_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ImagesClient, transports.ImagesRestTransport, "rest", None),
])
def test_images_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_delete_rest_unset_required_fields():
    transport = transports.ImagesRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.delete._get_unset_required_fields({})
    assert set(unset_fields) == (set(("requestId", )) & set(("image", "project", )))
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/global/images/{image}" % client.transport._host, args[1])
...
def test_deprecate_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ImagesClient(
        ...
        # Ensure method has been cached
        assert client._transport.deprecate in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.deprecate] = mock_rpc
...
def test_deprecate_rest_required_fields(request_type=compute.DeprecateImageRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).deprecate._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_deprecate_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("deprecationStatusResource", "image", "project", )))
...
def test_deprecate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/images/{image}/deprecate" % client.transport._host, args[1])
...
def test_deprecate_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ImagesClient(
...
def test_get_rest_required_fields(request_type=compute.GetImageRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.Image.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("image", "project", )))
...
def test_get_from_family_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ImagesClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_from_family in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_from_family] = mock_rpc
...
def test_get_from_family_rest_required_fields(request_type=compute.GetFromFamilyImageRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_from_family._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_from_family_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("family", "project", )))
...
def test_get_from_family_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/images/family/{family}" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/images/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("forceCreate", "requestId", )) & set(("imageResource", "project", )))
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/images" % client.transport._host, args[1])
...
def test_list_rest_required_fields(request_type=compute.ListImagesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.ImageList.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("image", "imageResource", "project", )))
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/images/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/images/{resource}/setLabels" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/images/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_delete_rest_bad_request(request_type=compute.DeleteImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ImagesRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImagesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteImageRequest.pb(compute.DeleteImageRequest())
...
def test_deprecate_rest_bad_request(request_type=compute.DeprecateImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_deprecate_rest_call_success(request_type):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'image': 'sample2'}
    request_init["deprecation_status_resource"] = {'deleted': 'deleted_value', 'deprecated': 'deprecated_value', 'obsolete': 'obsolete_value', 'replacement': 'replacement_value', 'state': 'state_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = compute.DeprecateImageRequest.meta.fields["deprecation_status_resource"]
    ...
    for field, value in request_init["deprecation_status_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["deprecation_status_resource"][field])):
                    del request_init["deprecation_status_resource"][field][i][subfield]
            else:
                del request_init["deprecation_status_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_deprecate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_deprecate") as post, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_deprecate_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImagesRestInterceptor, "pre_deprecate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeprecateImageRequest.pb(compute.DeprecateImageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.deprecate(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_rest_bad_request(request_type=compute.GetImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImagesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetImageRequest.pb(compute.GetImageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.Image.to_json(compute.Image())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.Image(), metadata
...
def test_get_from_family_rest_bad_request(request_type=compute.GetFromFamilyImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_from_family_rest_call_success(request_type):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_from_family_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_get_from_family") as post, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_get_from_family_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImagesRestInterceptor, "pre_get_from_family") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetFromFamilyImageRequest.pb(compute.GetFromFamilyImageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_from_family(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_iam_policy_rest_bad_request(request_type=compute.GetIamPolicyImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImagesRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyImageRequest.pb(compute.GetIamPolicyImageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_insert_rest_bad_request(request_type=compute.InsertImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1'}
    request_init["image_resource"] = {'architecture': 'architecture_value', 'archive_size_bytes': 1922, 'creation_timestamp': 'creation_timestamp_value', 'deprecated': {'deleted': 'deleted_value', 'deprecated': 'deprecated_value', 'obsolete': 'obsolete_value', 'replacement': 'replacement_value', 'state': 'state_value'}, 'description': 'description_value', 'disk_size_gb': 1261, 'enable_confidential_compute': True, 'family': 'family_value', 'guest_os_features': [{'type_': 'type__value'}], 'id': 205, 'image_encryption_key': {'kms_key_name': 'kms_key_name_value', 'kms_key_service_account': 'kms_key_service_account_value', 'raw_key': 'raw_key_value', 'rsa_encrypted_key': 'rsa_encrypted_key_value', 'sha256': 'sha256_value'}, 'kind': 'kind_value', 'label_fingerprint': 'label_fingerprint_value', 'labels': {}, 'license_codes': [1361, 1362], 'licenses': ['licenses_value1', 'licenses_value2'], 'name': 'name_value', 'raw_disk': {'container_type': 'container_type_value', 'sha1_checksum': 'sha1_checksum_value', 'source': 'source_value'}, 'satisfies_pzi': True, 'satisfies_pzs': True, 'self_link': 'self_link_value', 'shielded_instance_initial_state': {'dbs': [{'content': 'content_value', 'file_type': 'file_type_value'}], 'dbxs': {}, 'keks': {}, 'pk': {}}, 'source_disk': 'source_disk_value', 'source_disk_encryption_key': {}, 'source_disk_id': 'source_disk_id_value', 'source_image': 'source_image_value', 'source_image_encryption_key': {}, 'source_image_id': 'source_image_id_value', 'source_snapshot': 'source_snapshot_value', 'source_snapshot_encryption_key': {}, 'source_snapshot_id': 'source_snapshot_id_value', 'source_type': 'source_type_value', 'status': 'status_value', 'storage_locations': ['storage_locations_value1', 'storage_locations_value2']}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = compute.InsertImageRequest.meta.fields["image_resource"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["image_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["image_resource"][field])):
                    del request_init["image_resource"][field][i][subfield]
            else:
                del request_init["image_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImagesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertImageRequest.pb(compute.InsertImageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rest_bad_request(request_type=compute.ListImagesRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImagesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListImagesRequest.pb(compute.ListImagesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ImageList.to_json(compute.ImageList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.ImageList(), metadata
...
def test_patch_rest_bad_request(request_type=compute.PatchImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchImageRequest.meta.fields["image_resource"]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImagesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchImageRequest.pb(compute.PatchImageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_set_iam_policy_rest_bad_request(request_type=compute.SetIamPolicyImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyImageRequest.meta.fields["global_set_policy_request_resource"]
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImagesRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyImageRequest.pb(compute.SetIamPolicyImageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_set_labels_rest_bad_request(request_type=compute.SetLabelsImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsImageRequest.meta.fields["global_set_labels_request_resource"]
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_set_labels") as post, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_set_labels_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImagesRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetLabelsImageRequest.pb(compute.SetLabelsImageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsImageRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.ImagesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImagesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsImageRequest.pb(compute.TestIamPermissionsImageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_deprecate_unary_empty_call_rest():
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.deprecate),
            '__call__') as call:
        client.deprecate_unary(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_from_family_empty_call_rest():
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.get_from_family),
            '__call__') as call:
        client.get_from_family(request=None)
...
def test_images_host_no_port(transport_name):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_images_host_with_port(transport_name):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_images_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = ImagesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = ImagesClient(
        credentials=creds2,
        transport=transport_name,
    )
    ...
    session1 = client1.transport.deprecate._session
    session2 = client2.transport.deprecate._session
    assert session1 != session2
    session1 = client1.transport.get._session
    session2 = client2.transport.get._session
    assert session1 != session2
    session1 = client1.transport.get_from_family._session
    session2 = client2.transport.get_from_family._session
    assert session1 != session2
...
@pytest.mark.parametrize("client_class,transport_class", [
    (ImagesClient, transports.ImagesRestTransport),
])

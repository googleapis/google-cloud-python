...
def test__get_api_endpoint():
    ...
    assert BackendBucketsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BackendBucketsClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert BackendBucketsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BackendBucketsClient.DEFAULT_MTLS_ENDPOINT
...
def test_add_signed_url_key_rest_required_fields(request_type=compute.AddSignedUrlKeyBackendBucketRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).add_signed_url_key._get_unset_required_fields(jsonified_request)
...
def test_add_signed_url_key_rest_unset_required_fields():
    transport = transports.BackendBucketsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)

    unset_fields = transport.add_signed_url_key._get_unset_required_fields({})
    assert set(unset_fields) == (set(("requestId", )) & set(("backendBucket", "project", "signedUrlKeyResource", )))
...
def test_add_signed_url_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.BackendBucketsRestInterceptor, "post_add_signed_url_key") as post, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_add_signed_url_key") as pre:
...
def test_add_signed_url_key_rest_bad_request(transport: str = 'rest', request_type=compute.AddSignedUrlKeyBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_add_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/global/backendBuckets/{backend_bucket}/addSignedUrlKey" % client.transport._host, args[1])
...
def test_add_signed_url_key_unary_rest_bad_request(transport: str = 'rest', request_type=compute.AddSignedUrlKeyBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("backendBucket", "project", )))
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_signed_url_key_rest_required_fields(request_type=compute.DeleteSignedUrlKeyBackendBucketRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_signed_url_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_signed_url_key_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("keyName", "requestId", )) & set(("backendBucket", "keyName", "project", )))
...
def test_delete_signed_url_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "post_delete_signed_url_key") as post, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_delete_signed_url_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_signed_url_key_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteSignedUrlKeyBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/backendBuckets/{backend_bucket}/deleteSignedUrlKey" % client.transport._host, args[1])
...
def test_delete_signed_url_key_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteSignedUrlKeyBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("backendBucket", "project", )))
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.BackendBucket.to_json(compute.BackendBucket())
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iam_policy_rest_bad_request(transport: str = 'rest', request_type=compute.GetIamPolicyBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/backendBuckets/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("backendBucketResource", "project", )))
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "post_list") as post, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.BackendBucketList.to_json(compute.BackendBucketList())
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListBackendBucketsRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("backendBucket", "backendBucketResource", "project", )))
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "post_patch") as post, \
...
def test_patch_rest_bad_request(transport: str = 'rest', request_type=compute.PatchBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_patch_unary_rest_bad_request(transport: str = 'rest', request_type=compute.PatchBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_set_edge_security_policy_rest_required_fields(request_type=compute.SetEdgeSecurityPolicyBackendBucketRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_edge_security_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_edge_security_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("backendBucket", "project", "securityPolicyReferenceResource", )))
...
def test_set_edge_security_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "post_set_edge_security_policy") as post, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_set_edge_security_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_edge_security_policy_rest_bad_request(transport: str = 'rest', request_type=compute.SetEdgeSecurityPolicyBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_set_edge_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/backendBuckets/{backend_bucket}/setEdgeSecurityPolicy" % client.transport._host, args[1])
...
def test_set_edge_security_policy_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetEdgeSecurityPolicyBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_bad_request(transport: str = 'rest', request_type=compute.SetIamPolicyBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/backendBuckets/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_bad_request(transport: str = 'rest', request_type=compute.TestIamPermissionsBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/backendBuckets/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "post_update") as post, \
         mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_update") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_unary_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_backend_buckets_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.backend_buckets.transports.BackendBucketsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_backend_buckets_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.backend_buckets.transports.BackendBucketsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.BackendBucketsTransport()
        adc.assert_called_once()

...
from google.cloud.compute_v1.services.region_instant_snapshots import RegionInstantSnapshotsClient
from google.cloud.compute_v1.services.region_instant_snapshots import pagers
from google.cloud.compute_v1.services.region_instant_snapshots import transports
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteRegionInstantSnapshotRequest):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/instantSnapshots/{instant_snapshot}" % client.transport._host, args[1])
...
def test_delete_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteRegionInstantSnapshotRequest):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstantSnapshot.to_json(compute.InstantSnapshot())
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetRegionInstantSnapshotRequest):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_bad_request(transport: str = 'rest', request_type=compute.GetIamPolicyRegionInstantSnapshotRequest):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/instantSnapshots/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertRegionInstantSnapshotRequest):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_unary_rest_bad_request(transport: str = 'rest', request_type=compute.InsertRegionInstantSnapshotRequest):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstantSnapshotList.to_json(compute.InstantSnapshotList())
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListRegionInstantSnapshotsRequest):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_iam_policy_rest_bad_request(transport: str = 'rest', request_type=compute.SetIamPolicyRegionInstantSnapshotRequest):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/instantSnapshots/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_set_labels_rest_bad_request(transport: str = 'rest', request_type=compute.SetLabelsRegionInstantSnapshotRequest):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/instantSnapshots/{resource}/setLabels" % client.transport._host, args[1])
...
def test_set_labels_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetLabelsRegionInstantSnapshotRequest):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_bad_request(transport: str = 'rest', request_type=compute.TestIamPermissionsRegionInstantSnapshotRequest):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/instantSnapshots/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_transport_kind(transport_name):
    transport = RegionInstantSnapshotsClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_region_instant_snapshots_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_instant_snapshots.transports.RegionInstantSnapshotsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_instant_snapshots_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_instant_snapshots.transports.RegionInstantSnapshotsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegionInstantSnapshotsTransport()
        adc.assert_called_once()

...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert BackendServicesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert BackendServicesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert BackendServicesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert BackendServicesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert BackendServicesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert BackendServicesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert BackendServicesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert BackendServicesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(BackendServicesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BackendServicesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BackendServicesClient._DEFAULT_UNIVERSE
    default_endpoint = BackendServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = BackendServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert BackendServicesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert BackendServicesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BackendServicesClient.DEFAULT_MTLS_ENDPOINT
    assert BackendServicesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert BackendServicesClient._get_api_endpoint(None, None, default_universe, "always") == BackendServicesClient.DEFAULT_MTLS_ENDPOINT
    assert BackendServicesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BackendServicesClient.DEFAULT_MTLS_ENDPOINT
    assert BackendServicesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert BackendServicesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        BackendServicesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert BackendServicesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert BackendServicesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert BackendServicesClient._get_universe_domain(None, None) == BackendServicesClient._DEFAULT_UNIVERSE
...
def test_list_usable_rest_required_fields(request_type=compute.ListUsableBackendServicesRequest):
    transport_class = transports.BackendServicesRestTransport
...
def test_list_usable_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/backendServices/listUsable" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsBackendServiceRequest):
    transport_class = transports.BackendServicesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/backendServices/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_add_signed_url_key_rest_bad_request(request_type=compute.AddSignedUrlKeyBackendServiceRequest):
    client = BackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_add_signed_url_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_add_signed_url_key_with_metadata") as post_with_metadata, \
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListBackendServicesRequest):
    client = BackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.BackendServiceAggregatedList.to_json(compute.BackendServiceAggregatedList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.BackendServiceAggregatedList(), metadata
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_delete_signed_url_key_rest_bad_request(request_type=compute.DeleteSignedUrlKeyBackendServiceRequest):
    client = BackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_signed_url_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_delete_signed_url_key_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_get_health_rest_bad_request(request_type=compute.GetHealthBackendServiceRequest):
    client = BackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_health_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_get_health_with_metadata") as post_with_metadata, \
...
def test_get_iam_policy_rest_bad_request(request_type=compute.GetIamPolicyBackendServiceRequest):
    client = BackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_list_usable_rest_bad_request(request_type=compute.ListUsableBackendServicesRequest):
    client = BackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_usable_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_list_usable") as post, \
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_list_usable_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackendServicesRestInterceptor, "pre_list_usable") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListUsableBackendServicesRequest.pb(compute.ListUsableBackendServicesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
...
def test_set_edge_security_policy_rest_bad_request(request_type=compute.SetEdgeSecurityPolicyBackendServiceRequest):
    client = BackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_edge_security_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_set_edge_security_policy_with_metadata") as post_with_metadata, \
...
def test_set_iam_policy_rest_bad_request(request_type=compute.SetIamPolicyBackendServiceRequest):
    client = BackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
...
def test_set_security_policy_rest_bad_request(request_type=compute.SetSecurityPolicyBackendServiceRequest):
    client = BackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_security_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_set_security_policy_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsBackendServiceRequest):
    client = BackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsBackendServiceRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackendServicesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsBackendServiceRequest.pb(compute.TestIamPermissionsBackendServiceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackendServicesRestInterceptor, "post_update_with_metadata") as post_with_metadata, \

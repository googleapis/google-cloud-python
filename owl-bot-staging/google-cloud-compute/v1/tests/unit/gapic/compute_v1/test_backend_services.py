...
def test_add_signed_url_key_rest_unset_required_fields():
    transport = transports.BackendServicesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_usable_rest_bad_request(transport: str = 'rest', request_type=compute.ListUsableBackendServicesRequest):
    client = BackendServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_bad_request(transport: str = 'rest', request_type=compute.TestIamPermissionsBackendServiceRequest):
    client = BackendServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )

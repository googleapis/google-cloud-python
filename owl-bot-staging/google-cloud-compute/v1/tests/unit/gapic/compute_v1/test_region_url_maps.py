...
def test__get_api_endpoint():
    ...
    assert RegionUrlMapsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RegionUrlMapsClient.DEFAULT_MTLS_ENDPOINT
...
def test_delete_rest_unset_required_fields():
    transport = transports.RegionUrlMapsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)

    unset_fields = transport.delete._get_unset_required_fields({})
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "region", "urlMap", )))
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "pre_delete") as pre:
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/urlMaps/{url_map}" % client.transport._host, args[1])
...
def test_delete_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "post_get") as post, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_insert_rest(request_type):
    ...
    test_field = compute.InsertRegionUrlMapRequest.meta.fields["url_map_resource"]
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "region", "urlMapResource", )))
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/urlMaps" % client.transport._host, args[1])
...
def test_insert_unary_rest_bad_request(transport: str = 'rest', request_type=compute.InsertRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListRegionUrlMapsRequest):
    client = RegionUrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_patch_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchRegionUrlMapRequest.meta.fields["url_map_resource"]
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "region", "urlMap", "urlMapResource", )))
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "post_patch") as post, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_bad_request(transport: str = 'rest', request_type=compute.PatchRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_patch_unary_rest_bad_request(transport: str = 'rest', request_type=compute.PatchRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.UpdateRegionUrlMapRequest.meta.fields["url_map_resource"]
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "post_update") as post, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "pre_update") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_unary_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_validate_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("project", "region", "regionUrlMapsValidateRequestResource", "urlMap", )))
...
def test_validate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "post_validate") as post, \
         mock.patch.object(transports.RegionUrlMapsRestInterceptor, "pre_validate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_validate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            url_map='url_map_value',
            region_url_maps_validate_request_resource=compute.RegionUrlMapsValidateRequest(resource=compute.UrlMap(creation_timestamp='creation_timestamp_value')),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/urlMaps/{url_map}/validate" % client.transport._host, args[1])
...
def test_region_url_maps_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.region_url_maps.transports.RegionUrlMapsTransport.__init__') as Transport:
...
def test_region_url_maps_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_url_maps.transports.RegionUrlMapsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_url_maps_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_url_maps.transports.RegionUrlMapsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.RegionUrlMapsTransport()
        adc.assert_called_once()
...
def test_region_url_maps_client_transport_session_collision(transport_name):
    creds1 = _AnonymousCredentialsWithUniverseDomain()
    creds2 = _AnonymousCredentialsWithUniverseDomain()
    client1 = RegionUrlMapsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = RegionUrlMapsClient(
        credentials=creds2,
        transport=transport_name,
    )

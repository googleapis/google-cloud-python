...
from google.cloud.compute_v1.services.region_instance_groups import RegionInstanceGroupsClient
...
def test_get_rest_unset_required_fields():
    transport = transports.RegionInstanceGroupsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_set_named_ports_rest_required_fields(request_type=compute.SetNamedPortsRegionInstanceGroupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_named_ports._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

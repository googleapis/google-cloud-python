...
def test__get_api_endpoint():
    ...
    assert InstanceGroupsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == InstanceGroupsClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert InstanceGroupsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == InstanceGroupsClient.DEFAULT_MTLS_ENDPOINT
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instanceGroups/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_add_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_add_instances_with_metadata") as post_with_metadata, \
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_list_instances_with_metadata") as post_with_metadata, \
...
def test_remove_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_remove_instances_with_metadata") as post_with_metadata, \
...
def test_set_named_ports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_set_named_ports_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_add_instances_unary_empty_call_rest():
    ...
    with mock.patch.object(
            type(client.transport.add_instances),
            '__call__') as call:
...
def test_remove_instances_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_instances),
            '__call__') as call:

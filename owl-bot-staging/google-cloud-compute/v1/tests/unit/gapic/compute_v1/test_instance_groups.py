...
def test_add_instances_rest_required_fields(request_type=compute.AddInstancesInstanceGroupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).add_instances._get_unset_required_fields(jsonified_request)
...
def test_add_instances_rest_unset_required_fields():
    transport = transports.InstanceGroupsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_remove_instances_rest_required_fields(request_type=compute.RemoveInstancesInstanceGroupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).remove_instances._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.RoutersRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_nat_ip_info_rest_required_fields(request_type=compute.GetNatIpInfoRouterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_nat_ip_info._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_nat_ip_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.NatIpInfoResponse.to_json(compute.NatIpInfoResponse())
...
def test_get_nat_ip_info_rest_bad_request(transport: str = 'rest', request_type=compute.GetNatIpInfoRouterRequest):
    client = RoutersClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_nat_ip_info_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/routers/{router}/getNatIpInfo" % client.transport._host, args[1])
...
def test_get_nat_mapping_info_rest_required_fields(request_type=compute.GetNatMappingInfoRoutersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_nat_mapping_info._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_router_status_rest_required_fields(request_type=compute.GetRouterStatusRouterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_router_status._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_preview_rest_required_fields(request_type=compute.PreviewRouterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).preview._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

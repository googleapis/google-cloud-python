...
def test__get_api_endpoint():
    ...
    assert ResourcePoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ResourcePoliciesClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert ResourcePoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ResourcePoliciesClient.DEFAULT_MTLS_ENDPOINT
...
def test_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.ResourcePolicy)
                for i in results)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_aggregated_list") as post, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "pre_aggregated_list") as pre:
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ResourcePoliciesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

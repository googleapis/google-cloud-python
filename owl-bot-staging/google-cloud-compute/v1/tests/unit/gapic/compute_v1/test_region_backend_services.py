...
def test_delete_rest_unset_required_fields():
    transport = transports.RegionBackendServicesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_health_rest_required_fields(request_type=compute.GetHealthRegionBackendServiceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_health._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_usable_rest_required_fields(request_type=compute.ListUsableRegionBackendServicesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_usable._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_usable_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.BackendServiceListUsable.to_json(compute.BackendServiceListUsable())
...
def test_list_usable_rest_bad_request(transport: str = 'rest', request_type=compute.ListUsableRegionBackendServicesRequest):
    client = RegionBackendServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_usable_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/backendServices/listUsable" % client.transport._host, args[1])
...
def test_set_security_policy_rest_bad_request(transport: str = 'rest', request_type=compute.SetSecurityPolicyRegionBackendServiceRequest):
    client = RegionBackendServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_set_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/backendServices/{backend_service}/setSecurityPolicy" % client.transport._host, args[1])
...
def test_set_security_policy_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetSecurityPolicyRegionBackendServiceRequest):
    client = RegionBackendServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_bad_request(transport: str = 'rest', request_type=compute.TestIamPermissionsRegionBackendServiceRequest):
    client = RegionBackendServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/backendServices/{resource}/testIamPermissions" % client.transport._host, args[1])

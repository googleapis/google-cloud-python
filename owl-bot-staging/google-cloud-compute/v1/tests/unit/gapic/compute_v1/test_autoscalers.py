...
def test__read_environment_variables():
    assert AutoscalersClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert AutoscalersClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert AutoscalersClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert AutoscalersClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert AutoscalersClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert AutoscalersClient._get_client_cert_source(None, False) is None
    assert AutoscalersClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AutoscalersClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert AutoscalersClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AutoscalersClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(AutoscalersClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AutoscalersClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AutoscalersClient._DEFAULT_UNIVERSE
    default_endpoint = AutoscalersClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AutoscalersClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AutoscalersClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert AutoscalersClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AutoscalersClient.DEFAULT_MTLS_ENDPOINT
    assert AutoscalersClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AutoscalersClient._get_api_endpoint(None, None, default_universe, "always") == AutoscalersClient.DEFAULT_MTLS_ENDPOINT
    assert AutoscalersClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AutoscalersClient.DEFAULT_MTLS_ENDPOINT
    assert AutoscalersClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AutoscalersClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AutoscalersClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AutoscalersClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AutoscalersClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AutoscalersClient._get_universe_domain(None, None) == AutoscalersClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        AutoscalersClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = AutoscalersClient(credentials=cred)
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.AutoscalersRestTransport, "rest"),
])
...
def test_autoscalers_client_get_transport_class():
    ...
    available_transports = [
        transports.AutoscalersRestTransport,
    ]
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (AutoscalersClient, transports.AutoscalersRestTransport, "rest"),
])
@mock.patch.object(AutoscalersClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AutoscalersClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (AutoscalersClient, transports.AutoscalersRestTransport, "rest", "true"),
    (AutoscalersClient, transports.AutoscalersRestTransport, "rest", "false"),
])
@mock.patch.object(AutoscalersClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AutoscalersClient))
...
@mock.patch.object(AutoscalersClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AutoscalersClient))
def test_autoscalers_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (AutoscalersClient, transports.AutoscalersRestTransport, "rest", None),
])
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = (
            compute.AutoscalerAggregatedList(
                items={
                    'a':compute.AutoscalersScopedList(),
                    'b':compute.AutoscalersScopedList(),
                    'c':compute.AutoscalersScopedList(),
                },
                next_page_token='abc',
            ),
            compute.AutoscalerAggregatedList(
            ...
            compute.AutoscalerAggregatedList(
                items={
                    'g':compute.AutoscalersScopedList(),
                },
                next_page_token='ghi',
            ),
            compute.AutoscalerAggregatedList(
                items={
                    'h':compute.AutoscalersScopedList(),
                    'i':compute.AutoscalersScopedList(),
                },
            ),
        )
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListAutoscalersRequest):
    client = AutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.AutoscalersRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.AutoscalersRestInterceptor(),
        )
    client = AutoscalersClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoscalersRestInterceptor, "post_aggregated_list") as post, \
        mock.patch.object(transports.AutoscalersRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoscalersRestInterceptor, "pre_aggregated_list") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.AutoscalerAggregatedList.to_json(compute.AutoscalerAggregatedList())
        ...
        post_with_metadata.return_value = compute.AutoscalerAggregatedList(), metadata
...
def test_delete_rest_bad_request(request_type=compute.DeleteAutoscalerRequest):
    client = AutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoscalersRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_bad_request(request_type=compute.GetAutoscalerRequest):
    client = AutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoscalersRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_insert_rest_bad_request(request_type=compute.InsertAutoscalerRequest):
    client = AutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoscalersRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_bad_request(request_type=compute.ListAutoscalersRequest):
    client = AutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoscalersRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.AutoscalerList.to_json(compute.AutoscalerList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.AutoscalerList(), metadata
...
def test_patch_rest_bad_request(request_type=compute.PatchAutoscalerRequest):
    client = AutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoscalersRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
...
def test_update_rest_bad_request(request_type=compute.UpdateAutoscalerRequest):
    client = AutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoscalersRestInterceptor, "post_update_with_metadata") as post_with_metadata, \
...
def test_autoscalers_client_transport_session_collision(transport_name):
    ...
    client1 = AutoscalersClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = AutoscalersClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("client_class,transport_class", [
    (AutoscalersClient, transports.AutoscalersRestTransport),
])

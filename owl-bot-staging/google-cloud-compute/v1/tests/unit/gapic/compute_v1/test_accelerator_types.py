...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert AcceleratorTypesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert AcceleratorTypesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert AcceleratorTypesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert AcceleratorTypesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert AcceleratorTypesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AcceleratorTypesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert AcceleratorTypesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AcceleratorTypesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(AcceleratorTypesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AcceleratorTypesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AcceleratorTypesClient._DEFAULT_UNIVERSE
    default_endpoint = AcceleratorTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AcceleratorTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AcceleratorTypesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert AcceleratorTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AcceleratorTypesClient.DEFAULT_MTLS_ENDPOINT
    assert AcceleratorTypesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AcceleratorTypesClient._get_api_endpoint(None, None, default_universe, "always") == AcceleratorTypesClient.DEFAULT_MTLS_ENDPOINT
    assert AcceleratorTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AcceleratorTypesClient.DEFAULT_MTLS_ENDPOINT
    assert AcceleratorTypesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AcceleratorTypesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AcceleratorTypesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AcceleratorTypesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AcceleratorTypesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AcceleratorTypesClient._get_universe_domain(None, None) == AcceleratorTypesClient._DEFAULT_UNIVERSE
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListAcceleratorTypesRequest):
    client = AcceleratorTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AcceleratorTypesRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.AcceleratorTypeAggregatedList.to_json(compute.AcceleratorTypeAggregatedList())
        ...
        post_with_metadata.return_value = compute.AcceleratorTypeAggregatedList(), metadata
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AcceleratorTypesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AcceleratorTypesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.AcceleratorTypeList.to_json(compute.AcceleratorTypeList())
        req.return_value.content = return_value

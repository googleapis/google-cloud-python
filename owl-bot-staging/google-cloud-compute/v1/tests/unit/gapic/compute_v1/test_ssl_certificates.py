...
def test__get_api_endpoint():
    ...
    assert SslCertificatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SslCertificatesClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert SslCertificatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SslCertificatesClient.DEFAULT_MTLS_ENDPOINT
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SslCertificatesRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SslCertificatesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SslCertificatesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SslCertificatesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SslCertificatesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \

...
def test_delete_rest_unset_required_fields():
    transport = transports.InterconnectsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_diagnostics_rest_required_fields(request_type=compute.GetDiagnosticsInterconnectRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_diagnostics._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_macsec_config_rest_required_fields(request_type=compute.GetMacsecConfigInterconnectRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_macsec_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_macsec_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InterconnectsGetMacsecConfigResponse.to_json(compute.InterconnectsGetMacsecConfigResponse())
...
def test_get_macsec_config_rest_bad_request(transport: str = 'rest', request_type=compute.GetMacsecConfigInterconnectRequest):
    client = InterconnectsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_macsec_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/interconnects/{interconnect}/getMacsecConfig" % client.transport._host, args[1])

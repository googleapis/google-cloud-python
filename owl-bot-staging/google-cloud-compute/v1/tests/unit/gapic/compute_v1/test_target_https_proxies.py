...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.TargetHttpsProxiesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_set_quic_override_rest_required_fields(request_type=compute.SetQuicOverrideTargetHttpsProxyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_quic_override._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

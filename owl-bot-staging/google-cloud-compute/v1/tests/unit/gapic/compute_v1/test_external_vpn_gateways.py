...
from google.cloud.compute_v1.services.external_vpn_gateways import ExternalVpnGatewaysClient
...
def test__read_environment_variables():
    assert ExternalVpnGatewaysClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ExternalVpnGatewaysClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ExternalVpnGatewaysClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ExternalVpnGatewaysClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ExternalVpnGatewaysClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert ExternalVpnGatewaysClient._get_client_cert_source(None, False) is None
    assert ExternalVpnGatewaysClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ExternalVpnGatewaysClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ExternalVpnGatewaysClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ExternalVpnGatewaysClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ExternalVpnGatewaysClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ExternalVpnGatewaysClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ExternalVpnGatewaysClient._DEFAULT_UNIVERSE
    default_endpoint = ExternalVpnGatewaysClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ExternalVpnGatewaysClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ExternalVpnGatewaysClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ExternalVpnGatewaysClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ExternalVpnGatewaysClient.DEFAULT_MTLS_ENDPOINT
    assert ExternalVpnGatewaysClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ExternalVpnGatewaysClient._get_api_endpoint(None, None, default_universe, "always") == ExternalVpnGatewaysClient.DEFAULT_MTLS_ENDPOINT
    assert ExternalVpnGatewaysClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ExternalVpnGatewaysClient.DEFAULT_MTLS_ENDPOINT
    assert ExternalVpnGatewaysClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ExternalVpnGatewaysClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ExternalVpnGatewaysClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ExternalVpnGatewaysClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ExternalVpnGatewaysClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ExternalVpnGatewaysClient._get_universe_domain(None, None) == ExternalVpnGatewaysClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        ExternalVpnGatewaysClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ExternalVpnGatewaysClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_name", [
    (ExternalVpnGatewaysClient, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (ExternalVpnGatewaysClient, transports.ExternalVpnGatewaysRestTransport, "rest", "true"),
    (ExternalVpnGatewaysClient, transports.ExternalVpnGatewaysRestTransport, "rest", "false"),
])
@mock.patch.object(ExternalVpnGatewaysClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ExternalVpnGatewaysClient))
...
@mock.patch.object(ExternalVpnGatewaysClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ExternalVpnGatewaysClient))
def test_external_vpn_gateways_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ExternalVpnGatewaysClient, transports.ExternalVpnGatewaysRestTransport, "rest", None),
])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            external_vpn_gateway_resource=compute.ExternalVpnGateway(creation_timestamp='creation_timestamp_value'),
        )
        mock_args.update(sample_request)
...
def test_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, compute.ExternalVpnGateway)
                for i in results)
...
def test_delete_rest_bad_request(request_type=compute.DeleteExternalVpnGatewayRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.ExternalVpnGatewaysRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ExternalVpnGatewaysRestInterceptor(),
        )
    client = ExternalVpnGatewaysClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "pre_delete") as pre:
...
def test_get_rest_bad_request(request_type=compute.GetExternalVpnGatewayRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ExternalVpnGateway.to_json(compute.ExternalVpnGateway())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.ExternalVpnGateway(), metadata
...
def test_insert_rest_bad_request(request_type=compute.InsertExternalVpnGatewayRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_call_success(request_type):
    ...
    for field, value in request_init["external_vpn_gateway_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_bad_request(request_type=compute.ListExternalVpnGatewaysRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ExternalVpnGatewayList.to_json(compute.ExternalVpnGatewayList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.ExternalVpnGatewayList(), metadata
...
def test_set_labels_rest_bad_request(request_type=compute.SetLabelsExternalVpnGatewayRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_set_labels") as post, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_set_labels_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsExternalVpnGatewayRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExternalVpnGatewaysRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_external_vpn_gateways_client_transport_session_collision(transport_name):
    ...
    client1 = ExternalVpnGatewaysClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = ExternalVpnGatewaysClient(
        credentials=creds2,
        transport=transport_name,
    )

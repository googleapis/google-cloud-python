...
def test_delete_rest_unset_required_fields():
    transport = transports.ExternalVpnGatewaysRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_set_labels_rest_required_fields(request_type=compute.SetLabelsExternalVpnGatewayRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_labels._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test__get_api_endpoint():
    ...
    assert RegionHealthChecksClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RegionHealthChecksClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert RegionHealthChecksClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RegionHealthChecksClient.DEFAULT_MTLS_ENDPOINT
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "pre_delete") as pre:
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_update") as post, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "post_update_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionHealthChecksRestInterceptor, "pre_update") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

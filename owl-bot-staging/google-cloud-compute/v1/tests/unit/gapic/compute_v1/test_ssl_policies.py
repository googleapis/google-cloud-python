...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.SslPoliciesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_available_features_rest_required_fields(request_type=compute.ListAvailableFeaturesSslPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_available_features._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

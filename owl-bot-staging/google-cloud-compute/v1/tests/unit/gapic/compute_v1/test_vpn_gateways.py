...
def test__get_default_mtls_endpoint():
    ...
    assert VpnGatewaysClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert VpnGatewaysClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert VpnGatewaysClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert VpnGatewaysClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert VpnGatewaysClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert VpnGatewaysClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert VpnGatewaysClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert VpnGatewaysClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert VpnGatewaysClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert VpnGatewaysClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert VpnGatewaysClient._get_client_cert_source(None, False) is None
    assert VpnGatewaysClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert VpnGatewaysClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert VpnGatewaysClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert VpnGatewaysClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(VpnGatewaysClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VpnGatewaysClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = VpnGatewaysClient._DEFAULT_UNIVERSE
    default_endpoint = VpnGatewaysClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = VpnGatewaysClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert VpnGatewaysClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert VpnGatewaysClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == VpnGatewaysClient.DEFAULT_MTLS_ENDPOINT
    assert VpnGatewaysClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert VpnGatewaysClient._get_api_endpoint(None, None, default_universe, "always") == VpnGatewaysClient.DEFAULT_MTLS_ENDPOINT
    assert VpnGatewaysClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == VpnGatewaysClient.DEFAULT_MTLS_ENDPOINT
    assert VpnGatewaysClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert VpnGatewaysClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        VpnGatewaysClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert VpnGatewaysClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert VpnGatewaysClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert VpnGatewaysClient._get_universe_domain(None, None) == VpnGatewaysClient._DEFAULT_UNIVERSE
...
def test_vpn_gateways_client_service_account_always_use_jwt(transport_class, transport_name):
...
@mock.patch.object(VpnGatewaysClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VpnGatewaysClient))
def test_vpn_gateways_client_client_options(client_class, transport_class, transport_name):
...
def test_vpn_gateways_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(VpnGatewaysClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VpnGatewaysClient))
...
@mock.patch.object(VpnGatewaysClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VpnGatewaysClient))
def test_vpn_gateways_client_client_api_endpoint(client_class):
...
def test_vpn_gateways_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_vpn_gateways_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListVpnGatewaysRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = compute.VpnGatewayAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.VpnGatewaysRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/aggregated/vpnGateways" % client.transport._host, args[1])
...
def test_aggregated_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        for result in results:
            ...
            assert tuple(type(t) for t in result) == (str, compute.VpnGatewaysScopedList)
...
def test_delete_rest_required_fields(request_type=compute.DeleteVpnGatewayRequest):
    transport_class = transports.VpnGatewaysRestTransport
...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "region", "vpnGateway", )))
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'project': 'sample1', 'region': 'sample2', 'vpn_gateway': 'sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/vpnGateways/{vpn_gateway}" % client.transport._host, args[1])
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteVpnGatewayRequest):
    transport_class = transports.VpnGatewaysRestTransport
...
def test_get_rest_required_fields(request_type=compute.GetVpnGatewayRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.VpnGateway.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_status_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = VpnGatewaysClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_status in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_status] = mock_rpc
...
def test_get_status_rest_required_fields(request_type=compute.GetStatusVpnGatewayRequest):
    transport_class = transports.VpnGatewaysRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_status._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.VpnGatewaysGetStatusResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_status_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/vpnGateways/{vpn_gateway}/getStatus" % client.transport._host, args[1])
...
def test_insert_rest_required_fields(request_type=compute.InsertVpnGatewayRequest):
    transport_class = transports.VpnGatewaysRestTransport
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "region", "vpnGatewayResource", )))
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            region='region_value',
            vpn_gateway_resource=compute.VpnGateway(creation_timestamp='creation_timestamp_value'),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/vpnGateways" % client.transport._host, args[1])
...
def test_insert_unary_rest_required_fields(request_type=compute.InsertVpnGatewayRequest):
    transport_class = transports.VpnGatewaysRestTransport
...
def test_list_rest_required_fields(request_type=compute.ListVpnGatewaysRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.VpnGatewayList.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.VpnGateway)
                for i in results)
...
def test_set_labels_rest_required_fields(request_type=compute.SetLabelsVpnGatewayRequest):
    transport_class = transports.VpnGatewaysRestTransport
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/vpnGateways/{resource}/setLabels" % client.transport._host, args[1])
...
def test_set_labels_unary_rest_required_fields(request_type=compute.SetLabelsVpnGatewayRequest):
    transport_class = transports.VpnGatewaysRestTransport
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsVpnGatewayRequest):
    transport_class = transports.VpnGatewaysRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/vpnGateways/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListVpnGatewaysRequest):
    client = VpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.VpnGatewaysRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.VpnGatewaysRestInterceptor(),
        )
    client = VpnGatewaysClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_aggregated_list") as post, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListVpnGatewaysRequest.pb(compute.AggregatedListVpnGatewaysRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.VpnGatewayAggregatedList.to_json(compute.VpnGatewayAggregatedList())
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteVpnGatewayRequest.pb(compute.DeleteVpnGatewayRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.VpnGateway.to_json(compute.VpnGateway())
        req.return_value.content = return_value
...
def test_get_status_rest_call_success(request_type):
    client = VpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_status_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_get_status") as post, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_get_status_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "pre_get_status") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetStatusVpnGatewayRequest.pb(compute.GetStatusVpnGatewayRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.VpnGatewaysGetStatusResponse.to_json(compute.VpnGatewaysGetStatusResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.VpnGatewaysGetStatusResponse(), metadata
...
def test_insert_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2'}
    request_init["vpn_gateway_resource"] = {'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'gateway_ip_version': 'gateway_ip_version_value', 'id': 205, 'kind': 'kind_value', 'label_fingerprint': 'label_fingerprint_value', 'labels': {}, 'name': 'name_value', 'network': 'network_value', 'region': 'region_value', 'self_link': 'self_link_value', 'stack_type': 'stack_type_value', 'vpn_interfaces': [{'id': 205, 'interconnect_attachment': 'interconnect_attachment_value', 'ip_address': 'ip_address_value', 'ipv6_address': 'ipv6_address_value'}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = compute.InsertVpnGatewayRequest.meta.fields["vpn_gateway_resource"]
    ...
    for field, value in request_init["vpn_gateway_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["vpn_gateway_resource"][field])):
                    del request_init["vpn_gateway_resource"][field][i][subfield]
            else:
                del request_init["vpn_gateway_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertVpnGatewayRequest.pb(compute.InsertVpnGatewayRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.VpnGatewayList.to_json(compute.VpnGatewayList())
        req.return_value.content = return_value
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsVpnGatewayRequest.meta.fields["region_set_labels_request_resource"]
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_set_labels") as post, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_set_labels_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetLabelsVpnGatewayRequest.pb(compute.SetLabelsVpnGatewayRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsVpnGatewayRequest):
    client = VpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsVpnGatewayRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VpnGatewaysRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsVpnGatewayRequest.pb(compute.TestIamPermissionsVpnGatewayRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = compute.AggregatedListVpnGatewaysRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteVpnGatewayRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetVpnGatewayRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_status_empty_call_rest():
    client = VpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.get_status),
            '__call__') as call:
        client.get_status(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetStatusVpnGatewayRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertVpnGatewayRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListVpnGatewaysRequest()
...
def test_set_labels_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetLabelsVpnGatewayRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsVpnGatewayRequest()
...
def test_vpn_gateways_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.vpn_gateways.transports.VpnGatewaysTransport.__init__') as Transport:
...
def test_vpn_gateways_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.vpn_gateways.transports.VpnGatewaysTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_vpn_gateways_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.vpn_gateways.transports.VpnGatewaysTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.VpnGatewaysTransport()
        adc.assert_called_once()
...
def test_vpn_gateways_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = VpnGatewaysClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = VpnGatewaysClient(
        credentials=creds2,
        transport=transport_name,
    )
    ...
    assert session1 != session2
    session1 = client1.transport.get_status._session
    session2 = client2.transport.get_status._session
    assert session1 != session2
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.VpnGatewaysTransport, '_prep_wrapped_messages') as prep:
        client = VpnGatewaysClient(
            credentials=ga_credentials.AnonymousCredentials(),

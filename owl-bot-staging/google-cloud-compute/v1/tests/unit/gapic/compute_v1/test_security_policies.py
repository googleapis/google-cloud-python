...
def test_add_rule_rest_unset_required_fields():
    transport = transports.SecurityPoliciesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_preconfigured_expression_sets_rest_required_fields(request_type=compute.ListPreconfiguredExpressionSetsSecurityPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_preconfigured_expression_sets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

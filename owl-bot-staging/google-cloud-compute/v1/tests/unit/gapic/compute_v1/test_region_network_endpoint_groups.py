...
def test_attach_network_endpoints_rest(request_type):
    ...
    request_init["region_network_endpoint_groups_attach_endpoints_request_resource"] = {'network_endpoints': [{'annotations': {}, 'fqdn': 'fqdn_value', 'instance': 'instance_value', 'ip_address': 'ip_address_value', 'port': 453}]}
...
def test_attach_network_endpoints_rest_unset_required_fields():
    transport = transports.RegionNetworkEndpointGroupsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_attach_network_endpoints_rest_bad_request(transport: str = 'rest', request_type=compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_attach_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/attachNetworkEndpoints" % client.transport._host, args[1])
...
def test_attach_network_endpoints_unary_rest_bad_request(transport: str = 'rest', request_type=compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_detach_network_endpoints_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'network_endpoint_group': 'sample3'}
    request_init["region_network_endpoint_groups_detach_endpoints_request_resource"] = {'network_endpoints': [{'annotations': {}, 'fqdn': 'fqdn_value', 'instance': 'instance_value', 'ip_address': 'ip_address_value', 'port': 453}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_detach_network_endpoints_rest_bad_request(transport: str = 'rest', request_type=compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_detach_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/detachNetworkEndpoints" % client.transport._host, args[1])
...
def test_detach_network_endpoints_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_network_endpoints_rest_bad_request(transport: str = 'rest', request_type=compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/listNetworkEndpoints" % client.transport._host, args[1])

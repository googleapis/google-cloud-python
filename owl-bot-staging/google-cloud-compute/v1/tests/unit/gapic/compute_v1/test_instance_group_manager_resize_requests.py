...
from google.cloud.compute_v1.services.instance_group_manager_resize_requests import InstanceGroupManagerResizeRequestsClient
from google.cloud.compute_v1.services.instance_group_manager_resize_requests import pagers
from google.cloud.compute_v1.services.instance_group_manager_resize_requests import transports
...
def test_cancel_rest(request_type):
...
def test_cancel_rest_bad_request(transport: str = 'rest', request_type=compute.CancelInstanceGroupManagerResizeRequestRequest):
    client = InstanceGroupManagerResizeRequestsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resizeRequests/{resize_request}/cancel" % client.transport._host, args[1])
...
def test_cancel_unary_rest(request_type):
    client = InstanceGroupManagerResizeRequestsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_cancel_unary_rest_interceptors(null_interceptor):
    transport = transports.InstanceGroupManagerResizeRequestsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InstanceGroupManagerResizeRequestsRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.cancel_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_cancel_unary_rest_bad_request(transport: str = 'rest', request_type=compute.CancelInstanceGroupManagerResizeRequestRequest):
    client = InstanceGroupManagerResizeRequestsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_unary_rest_error():
    client = InstanceGroupManagerResizeRequestsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteInstanceGroupManagerResizeRequestRequest):
    client = InstanceGroupManagerResizeRequestsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resizeRequests/{resize_request}" % client.transport._host, args[1])
...
def test_delete_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteInstanceGroupManagerResizeRequestRequest):
    client = InstanceGroupManagerResizeRequestsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstanceGroupManagerResizeRequest.to_json(compute.InstanceGroupManagerResizeRequest())
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetInstanceGroupManagerResizeRequestRequest):
    client = InstanceGroupManagerResizeRequestsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertInstanceGroupManagerResizeRequestRequest):
    client = InstanceGroupManagerResizeRequestsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            zone='zone_value',
            instance_group_manager='instance_group_manager_value',
            instance_group_manager_resize_request_resource=compute.InstanceGroupManagerResizeRequest(creation_timestamp='creation_timestamp_value'),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resizeRequests" % client.transport._host, args[1])
...
def test_insert_unary_rest_bad_request(transport: str = 'rest', request_type=compute.InsertInstanceGroupManagerResizeRequestRequest):
    client = InstanceGroupManagerResizeRequestsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstanceGroupManagerResizeRequestsListResponse.to_json(compute.InstanceGroupManagerResizeRequestsListResponse())
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListInstanceGroupManagerResizeRequestsRequest):
    client = InstanceGroupManagerResizeRequestsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = InstanceGroupManagerResizeRequestsClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_instance_group_manager_resize_requests_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.instance_group_manager_resize_requests.transports.InstanceGroupManagerResizeRequestsTransport.__init__') as Transport:
...
def test_instance_group_manager_resize_requests_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.instance_group_manager_resize_requests.transports.InstanceGroupManagerResizeRequestsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_instance_group_manager_resize_requests_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.instance_group_manager_resize_requests.transports.InstanceGroupManagerResizeRequestsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.InstanceGroupManagerResizeRequestsTransport()
        adc.assert_called_once()

...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.TargetInstancesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_set_security_policy_rest_required_fields(request_type=compute.SetSecurityPolicyTargetInstanceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_security_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_security_policy_rest_bad_request(transport: str = 'rest', request_type=compute.SetSecurityPolicyTargetInstanceRequest):
    client = TargetInstancesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_set_security_policy_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetSecurityPolicyTargetInstanceRequest):
    client = TargetInstancesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = TargetInstancesClient.get_transport_class(transport_name)(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
    )

...
def test__get_api_endpoint():
    ...
    assert FirewallPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == FirewallPoliciesClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert FirewallPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == FirewallPoliciesClient.DEFAULT_MTLS_ENDPOINT
...
def test_add_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_add_association") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_add_association_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_add_association") as pre:
...
def test_add_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_add_rule") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_add_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_add_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_clone_rules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_clone_rules") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_clone_rules_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_clone_rules") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_get_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_association") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_association_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_get_association") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_rule") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_get_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_associations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_list_associations") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_list_associations_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_list_associations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_move_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_move") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_move_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_move") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_patch_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_patch_rule") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_patch_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_patch_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_remove_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_remove_association") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_remove_association_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_remove_association") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_remove_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_remove_rule") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_remove_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_remove_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_associations_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_associations),
            '__call__') as call:

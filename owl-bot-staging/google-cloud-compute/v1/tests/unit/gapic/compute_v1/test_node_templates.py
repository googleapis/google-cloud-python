...
def test__get_default_mtls_endpoint():
    ...
    assert NodeTemplatesClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert NodeTemplatesClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert NodeTemplatesClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert NodeTemplatesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert NodeTemplatesClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert NodeTemplatesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert NodeTemplatesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        with pytest.raises(ValueError) as excinfo:
            NodeTemplatesClient._read_environment_variables()
    assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert NodeTemplatesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert NodeTemplatesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert NodeTemplatesClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert NodeTemplatesClient._get_client_cert_source(None, False) is None
    assert NodeTemplatesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert NodeTemplatesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert NodeTemplatesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert NodeTemplatesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(NodeTemplatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NodeTemplatesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = NodeTemplatesClient._DEFAULT_UNIVERSE
    default_endpoint = NodeTemplatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = NodeTemplatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert NodeTemplatesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert NodeTemplatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == NodeTemplatesClient.DEFAULT_MTLS_ENDPOINT
    assert NodeTemplatesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert NodeTemplatesClient._get_api_endpoint(None, None, default_universe, "always") == NodeTemplatesClient.DEFAULT_MTLS_ENDPOINT
    assert NodeTemplatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == NodeTemplatesClient.DEFAULT_MTLS_ENDPOINT
    assert NodeTemplatesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert NodeTemplatesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        NodeTemplatesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert NodeTemplatesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert NodeTemplatesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert NodeTemplatesClient._get_universe_domain(None, None) == NodeTemplatesClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        NodeTemplatesClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = NodeTemplatesClient(credentials=cred)
...
def test_node_templates_client_service_account_always_use_jwt(transport_class, transport_name):
...
@mock.patch.object(NodeTemplatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NodeTemplatesClient))
def test_node_templates_client_client_options(client_class, transport_class, transport_name):
...
def test_node_templates_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(NodeTemplatesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(NodeTemplatesClient))
def test_node_templates_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
@mock.patch.object(NodeTemplatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NodeTemplatesClient))
def test_node_templates_client_client_api_endpoint(client_class):
...
def test_node_templates_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_node_templates_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListNodeTemplatesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = compute.NodeTemplateAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.NodeTemplatesRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/aggregated/nodeTemplates" % client.transport._host, args[1])
...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("nodeTemplate", "project", "region", )))
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/nodeTemplates/{node_template}" % client.transport._host, args[1])
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteNodeTemplateRequest):
    transport_class = transports.NodeTemplatesRestTransport
...
def test_get_rest_required_fields(request_type=compute.GetNodeTemplateRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.NodeTemplate.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_iam_policy_rest_required_fields(request_type=compute.GetIamPolicyNodeTemplateRequest):
    transport_class = transports.NodeTemplatesRestTransport
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/nodeTemplates/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("nodeTemplateResource", "project", "region", )))
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            region='region_value',
            node_template_resource=compute.NodeTemplate(accelerators=[compute.AcceleratorConfig(accelerator_count=1805)]),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/nodeTemplates" % client.transport._host, args[1])
...
def test_insert_unary_rest_required_fields(request_type=compute.InsertNodeTemplateRequest):
    transport_class = transports.NodeTemplatesRestTransport
...
def test_list_rest_required_fields(request_type=compute.ListNodeTemplatesRequest):
    transport_class = transports.NodeTemplatesRestTransport
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.NodeTemplateList.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_set_iam_policy_rest_required_fields(request_type=compute.SetIamPolicyNodeTemplateRequest):
    transport_class = transports.NodeTemplatesRestTransport
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/nodeTemplates/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsNodeTemplateRequest):
    transport_class = transports.NodeTemplatesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/nodeTemplates/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListNodeTemplatesRequest):
    client = NodeTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.NodeTemplatesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NodeTemplatesRestInterceptor(),
        )
    client = NodeTemplatesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_aggregated_list") as post, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListNodeTemplatesRequest.pb(compute.AggregatedListNodeTemplatesRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NodeTemplateAggregatedList.to_json(compute.NodeTemplateAggregatedList())
        ...
        post_with_metadata.return_value = compute.NodeTemplateAggregatedList(), metadata
...
def test_delete_rest_bad_request(request_type=compute.DeleteNodeTemplateRequest):
    client = NodeTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteNodeTemplateRequest.pb(compute.DeleteNodeTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_rest_bad_request(request_type=compute.GetNodeTemplateRequest):
    client = NodeTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetNodeTemplateRequest.pb(compute.GetNodeTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NodeTemplate.to_json(compute.NodeTemplate())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.NodeTemplate(), metadata
...
def test_get_iam_policy_rest_bad_request(request_type=compute.GetIamPolicyNodeTemplateRequest):
    client = NodeTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyNodeTemplateRequest.pb(compute.GetIamPolicyNodeTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_insert_rest_bad_request(request_type=compute.InsertNodeTemplateRequest):
    client = NodeTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertNodeTemplateRequest.meta.fields["node_template_resource"]
    ...
    for field, value in request_init["node_template_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["node_template_resource"][field])):
                    del request_init["node_template_resource"][field][i][subfield]
            else:
                del request_init["node_template_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertNodeTemplateRequest.pb(compute.InsertNodeTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rest_bad_request(request_type=compute.ListNodeTemplatesRequest):
    client = NodeTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListNodeTemplatesRequest.pb(compute.ListNodeTemplatesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NodeTemplateList.to_json(compute.NodeTemplateList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.NodeTemplateList(), metadata
...
def test_set_iam_policy_rest_bad_request(request_type=compute.SetIamPolicyNodeTemplateRequest):
    client = NodeTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyNodeTemplateRequest.meta.fields["region_set_policy_request_resource"]
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyNodeTemplateRequest.pb(compute.SetIamPolicyNodeTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsNodeTemplateRequest):
    client = NodeTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsNodeTemplateRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NodeTemplatesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsNodeTemplateRequest.pb(compute.TestIamPermissionsNodeTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = compute.AggregatedListNodeTemplatesRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteNodeTemplateRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetNodeTemplateRequest()
...
def test_get_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetIamPolicyNodeTemplateRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertNodeTemplateRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListNodeTemplatesRequest()
...
def test_set_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetIamPolicyNodeTemplateRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsNodeTemplateRequest()
...
def test_node_templates_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.node_templates.transports.NodeTemplatesTransport.__init__') as Transport:
...
def test_node_templates_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.node_templates.transports.NodeTemplatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_node_templates_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.node_templates.transports.NodeTemplatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NodeTemplatesTransport()
        adc.assert_called_once()
...
def test_node_templates_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = NodeTemplatesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = NodeTemplatesClient(
        credentials=creds2,
        transport=transport_name,
    )

...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListUrlMapsRequest):
    client = UrlMapsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UrlMapsRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.UrlMapsAggregatedList.to_json(compute.UrlMapsAggregatedList())
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UrlMapsRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UrlMapsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UrlMapsRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_invalidate_cache_rest_bad_request(request_type=compute.InvalidateCacheUrlMapRequest):
    client = UrlMapsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_invalidate_cache_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'url_map': 'sample2'}
    request_init["cache_invalidation_rule_resource"] = {'cache_tags': ['cache_tags_value1', 'cache_tags_value2'], 'host': 'host_value', 'path': 'path_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_invalidate_cache_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UrlMapsRestInterceptor, "post_invalidate_cache_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UrlMapsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UrlMapsRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UrlMapsRestInterceptor, "post_update_with_metadata") as post_with_metadata, \
...
def test_validate_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'url_map': 'sample2'}
    request_init["url_maps_validate_request_resource"] = {'load_balancing_schemes': ['load_balancing_schemes_value1', 'load_balancing_schemes_value2'], 'resource': {'creation_timestamp': 'creation_timestamp_value', 'default_custom_error_response_policy': {'error_response_rules': [{'match_response_codes': ['match_response_codes_value1', 'match_response_codes_value2'], 'override_response_code': 2344, 'path': 'path_value'}], 'error_service': 'error_service_value'}, 'default_route_action': {'cors_policy': {'allow_credentials': True, 'allow_headers': ['allow_headers_value1', 'allow_headers_value2'], 'allow_methods': ['allow_methods_value1', 'allow_methods_value2'], 'allow_origin_regexes': ['allow_origin_regexes_value1', 'allow_origin_regexes_value2'], 'allow_origins': ['allow_origins_value1', 'allow_origins_value2'], 'disabled': True, 'expose_headers': ['expose_headers_value1', 'expose_headers_value2'], 'max_age': 722}, 'fault_injection_policy': {'abort': {'http_status': 1219, 'percentage': 0.10540000000000001}, 'delay': {'fixed_delay': {'nanos': 543, 'seconds': 751}, 'percentage': 0.10540000000000001}}, 'max_stream_duration': {}, 'request_mirror_policy': {'backend_service': 'backend_service_value', 'mirror_percent': 0.1515}, 'retry_policy': {'num_retries': 1197, 'per_try_timeout': {}, 'retry_conditions': ['retry_conditions_value1', 'retry_conditions_value2']}, 'timeout': {}, 'url_rewrite': {'host_rewrite': 'host_rewrite_value', 'path_prefix_rewrite': 'path_prefix_rewrite_value', 'path_template_rewrite': 'path_template_rewrite_value'}, 'weighted_backend_services': [{'backend_service': 'backend_service_value', 'header_action': {'request_headers_to_add': [{'header_name': 'header_name_value', 'header_value': 'header_value_value', 'replace': True}], 'request_headers_to_remove': ['request_headers_to_remove_value1', 'request_headers_to_remove_value2'], 'response_headers_to_add': {}, 'response_headers_to_remove': ['response_headers_to_remove_value1', 'response_headers_to_remove_value2']}, 'weight': 648}]}, 'default_service': 'default_service_value', 'default_url_redirect': {'host_redirect': 'host_redirect_value', 'https_redirect': True, 'path_redirect': 'path_redirect_value', 'prefix_redirect': 'prefix_redirect_value', 'redirect_response_code': 'redirect_response_code_value', 'strip_query': True}, 'description': 'description_value', 'fingerprint': 'fingerprint_value', 'header_action': {}, 'host_rules': [{'description': 'description_value', 'hosts': ['hosts_value1', 'hosts_value2'], 'path_matcher': 'path_matcher_value'}], 'id': 205, 'kind': 'kind_value', 'name': 'name_value', 'path_matchers': [{'default_custom_error_response_policy': {}, 'default_route_action': {}, 'default_service': 'default_service_value', 'default_url_redirect': {}, 'description': 'description_value', 'header_action': {}, 'name': 'name_value', 'path_rules': [{'custom_error_response_policy': {}, 'paths': ['paths_value1', 'paths_value2'], 'route_action': {}, 'service': 'service_value', 'url_redirect': {}}], 'route_rules': [{'custom_error_response_policy': {}, 'description': 'description_value', 'header_action': {}, 'match_rules': [{'full_path_match': 'full_path_match_value', 'header_matches': [{'exact_match': 'exact_match_value', 'header_name': 'header_name_value', 'invert_match': True, 'prefix_match': 'prefix_match_value', 'present_match': True, 'range_match': {'range_end': 931, 'range_start': 1178}, 'regex_match': 'regex_match_value', 'suffix_match': 'suffix_match_value'}], 'ignore_case': True, 'metadata_filters': [{'filter_labels': [{'name': 'name_value', 'value': 'value_value'}], 'filter_match_criteria': 'filter_match_criteria_value'}], 'path_template_match': 'path_template_match_value', 'prefix_match': 'prefix_match_value', 'query_parameter_matches': [{'exact_match': 'exact_match_value', 'name': 'name_value', 'present_match': True, 'regex_match': 'regex_match_value'}], 'regex_match': 'regex_match_value'}], 'priority': 898, 'route_action': {}, 'service': 'service_value', 'url_redirect': {}}]}], 'region': 'region_value', 'self_link': 'self_link_value', 'tests': [{'description': 'description_value', 'expected_output_url': 'expected_output_url_value', 'expected_redirect_response_code': 3275, 'headers': [{'name': 'name_value', 'value': 'value_value'}], 'host': 'host_value', 'path': 'path_value', 'service': 'service_value'}]}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_validate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UrlMapsRestInterceptor, "post_validate_with_metadata") as post_with_metadata, \
...
def test_invalidate_cache_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.invalidate_cache),
            '__call__') as call:
...
def test_validate_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.validate),
            '__call__') as call:

...
def test__get_default_mtls_endpoint():
    ...
    assert UrlMapsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert UrlMapsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert UrlMapsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__get_client_cert_source():
    ...
    assert UrlMapsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert UrlMapsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert UrlMapsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert UrlMapsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(UrlMapsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(UrlMapsClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = UrlMapsClient._DEFAULT_UNIVERSE
    default_endpoint = UrlMapsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = UrlMapsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert UrlMapsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert UrlMapsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == UrlMapsClient.DEFAULT_MTLS_ENDPOINT
    assert UrlMapsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert UrlMapsClient._get_api_endpoint(None, None, default_universe, "always") == UrlMapsClient.DEFAULT_MTLS_ENDPOINT
    assert UrlMapsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == UrlMapsClient.DEFAULT_MTLS_ENDPOINT
    assert UrlMapsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert UrlMapsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        UrlMapsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert UrlMapsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert UrlMapsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert UrlMapsClient._get_universe_domain(None, None) == UrlMapsClient._DEFAULT_UNIVERSE
...
def test_url_maps_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_url_maps_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(UrlMapsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(UrlMapsClient))
...
def test_url_maps_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_url_maps_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListUrlMapsRequest):
...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.UrlMapsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.UrlMapsRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.AggregatedListUrlMapsRequest.pb(compute.AggregatedListUrlMapsRequest())
        ...
        req.return_value._content = compute.UrlMapsAggregatedList.to_json(compute.UrlMapsAggregatedList())
...
def test_aggregated_list_rest_bad_request(transport: str = 'rest', request_type=compute.AggregatedListUrlMapsRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/aggregated/urlMaps" % client.transport._host, args[1])
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteUrlMapRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/urlMaps/{url_map}" % client.transport._host, args[1])
...
def test_delete_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteUrlMapRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "post_get") as post, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetUrlMapRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "urlMapResource", )))
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertUrlMapRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/urlMaps" % client.transport._host, args[1])
...
def test_insert_unary_rest_bad_request(transport: str = 'rest', request_type=compute.InsertUrlMapRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_invalidate_cache_rest(request_type):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport="rest",
    )
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.InvalidateCacheUrlMapRequest.meta.fields["cache_invalidation_rule_resource"]
...
def test_invalidate_cache_rest_required_fields(request_type=compute.InvalidateCacheUrlMapRequest):
    transport_class = transports.UrlMapsRestTransport
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).invalidate_cache._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_invalidate_cache_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("cacheInvalidationRuleResource", "project", "urlMap", )))
...
def test_invalidate_cache_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "post_invalidate_cache") as post, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "pre_invalidate_cache") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.InvalidateCacheUrlMapRequest.pb(compute.InvalidateCacheUrlMapRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.invalidate_cache(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_invalidate_cache_rest_bad_request(transport: str = 'rest', request_type=compute.InvalidateCacheUrlMapRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_invalidate_cache_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            url_map='url_map_value',
            cache_invalidation_rule_resource=compute.CacheInvalidationRule(host='host_value'),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/urlMaps/{url_map}/invalidateCache" % client.transport._host, args[1])
...
def test_invalidate_cache_rest_error():
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport='rest'
    )
...
def test_invalidate_cache_unary_rest_required_fields(request_type=compute.InvalidateCacheUrlMapRequest):
    transport_class = transports.UrlMapsRestTransport
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_invalidate_cache_unary_rest_interceptors(null_interceptor):
    transport = transports.UrlMapsRestTransport(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        interceptor=None if null_interceptor else transports.UrlMapsRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.invalidate_cache_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_invalidate_cache_unary_rest_bad_request(transport: str = 'rest', request_type=compute.InvalidateCacheUrlMapRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListUrlMapsRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "urlMap", "urlMapResource", )))
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "post_patch") as post, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_bad_request(transport: str = 'rest', request_type=compute.PatchUrlMapRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_patch_unary_rest_bad_request(transport: str = 'rest', request_type=compute.PatchUrlMapRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "post_update") as post, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "pre_update") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateUrlMapRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_unary_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateUrlMapRequest):
    client = UrlMapsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_validate_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'url_map': 'sample2'}
    request_init["url_maps_validate_request_resource"] = {'load_balancing_schemes': ['load_balancing_schemes_value1', 'load_balancing_schemes_value2'], 'resource': {'creation_timestamp': 'creation_timestamp_value', 'default_route_action': {'cors_policy': {'allow_credentials': True, 'allow_headers': ['allow_headers_value1', 'allow_headers_value2'], 'allow_methods': ['allow_methods_value1', 'allow_methods_value2'], 'allow_origin_regexes': ['allow_origin_regexes_value1', 'allow_origin_regexes_value2'], 'allow_origins': ['allow_origins_value1', 'allow_origins_value2'], 'disabled': True, 'expose_headers': ['expose_headers_value1', 'expose_headers_value2'], 'max_age': 722}, 'fault_injection_policy': {'abort': {'http_status': 1219, 'percentage': 0.10540000000000001}, 'delay': {'fixed_delay': {'nanos': 543, 'seconds': 751}, 'percentage': 0.10540000000000001}}, 'max_stream_duration': {}, 'request_mirror_policy': {'backend_service': 'backend_service_value'}, 'retry_policy': {'num_retries': 1197, 'per_try_timeout': {}, 'retry_conditions': ['retry_conditions_value1', 'retry_conditions_value2']}, 'timeout': {}, 'url_rewrite': {'host_rewrite': 'host_rewrite_value', 'path_prefix_rewrite': 'path_prefix_rewrite_value', 'path_template_rewrite': 'path_template_rewrite_value'}, 'weighted_backend_services': [{'backend_service': 'backend_service_value', 'header_action': {'request_headers_to_add': [{'header_name': 'header_name_value', 'header_value': 'header_value_value', 'replace': True}], 'request_headers_to_remove': ['request_headers_to_remove_value1', 'request_headers_to_remove_value2'], 'response_headers_to_add': {}, 'response_headers_to_remove': ['response_headers_to_remove_value1', 'response_headers_to_remove_value2']}, 'weight': 648}]}, 'default_service': 'default_service_value', 'default_url_redirect': {'host_redirect': 'host_redirect_value', 'https_redirect': True, 'path_redirect': 'path_redirect_value', 'prefix_redirect': 'prefix_redirect_value', 'redirect_response_code': 'redirect_response_code_value', 'strip_query': True}, 'description': 'description_value', 'fingerprint': 'fingerprint_value', 'header_action': {}, 'host_rules': [{'description': 'description_value', 'hosts': ['hosts_value1', 'hosts_value2'], 'path_matcher': 'path_matcher_value'}], 'id': 205, 'kind': 'kind_value', 'name': 'name_value', 'path_matchers': [{'default_route_action': {}, 'default_service': 'default_service_value', 'default_url_redirect': {}, 'description': 'description_value', 'header_action': {}, 'name': 'name_value', 'path_rules': [{'paths': ['paths_value1', 'paths_value2'], 'route_action': {}, 'service': 'service_value', 'url_redirect': {}}], 'route_rules': [{'description': 'description_value', 'header_action': {}, 'match_rules': [{'full_path_match': 'full_path_match_value', 'header_matches': [{'exact_match': 'exact_match_value', 'header_name': 'header_name_value', 'invert_match': True, 'prefix_match': 'prefix_match_value', 'present_match': True, 'range_match': {'range_end': 931, 'range_start': 1178}, 'regex_match': 'regex_match_value', 'suffix_match': 'suffix_match_value'}], 'ignore_case': True, 'metadata_filters': [{'filter_labels': [{'name': 'name_value', 'value': 'value_value'}], 'filter_match_criteria': 'filter_match_criteria_value'}], 'path_template_match': 'path_template_match_value', 'prefix_match': 'prefix_match_value', 'query_parameter_matches': [{'exact_match': 'exact_match_value', 'name': 'name_value', 'present_match': True, 'regex_match': 'regex_match_value'}], 'regex_match': 'regex_match_value'}], 'priority': 898, 'route_action': {}, 'service': 'service_value', 'url_redirect': {}}]}], 'region': 'region_value', 'self_link': 'self_link_value', 'tests': [{'description': 'description_value', 'expected_output_url': 'expected_output_url_value', 'expected_redirect_response_code': 3275, 'headers': [{'name': 'name_value', 'value': 'value_value'}], 'host': 'host_value', 'path': 'path_value', 'service': 'service_value'}]}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = compute.ValidateUrlMapRequest.meta.fields["url_maps_validate_request_resource"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["url_maps_validate_request_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["url_maps_validate_request_resource"][field])):
                    del request_init["url_maps_validate_request_resource"][field][i][subfield]
            else:
...
def test_validate_rest_required_fields(request_type=compute.ValidateUrlMapRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).validate._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_validate_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("project", "urlMap", "urlMapsValidateRequestResource", )))
...
def test_validate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "post_validate") as post, \
         mock.patch.object(transports.UrlMapsRestInterceptor, "pre_validate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.UrlMapsValidateResponse.to_json(compute.UrlMapsValidateResponse())
...
def test_validate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            url_map='url_map_value',
            url_maps_validate_request_resource=compute.UrlMapsValidateRequest(load_balancing_schemes=['load_balancing_schemes_value']),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/urlMaps/{url_map}/validate" % client.transport._host, args[1])
...
def test_transport_kind(transport_name):
    transport = UrlMapsClient.get_transport_class(transport_name)(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
    )
...
def test_url_maps_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.url_maps.transports.UrlMapsTransport.__init__') as Transport:
...
def test_url_maps_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.url_maps.transports.UrlMapsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_url_maps_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.url_maps.transports.UrlMapsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.UrlMapsTransport()
        adc.assert_called_once()

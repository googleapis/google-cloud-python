...
from google.cloud.compute_v1.services.network_attachments import NetworkAttachmentsClient
from google.cloud.compute_v1.services.network_attachments import pagers
from google.cloud.compute_v1.services.network_attachments import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert NetworkAttachmentsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert NetworkAttachmentsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert NetworkAttachmentsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert NetworkAttachmentsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert NetworkAttachmentsClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert NetworkAttachmentsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert NetworkAttachmentsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert NetworkAttachmentsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert NetworkAttachmentsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert NetworkAttachmentsClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert NetworkAttachmentsClient._get_client_cert_source(None, False) is None
    assert NetworkAttachmentsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert NetworkAttachmentsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert NetworkAttachmentsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert NetworkAttachmentsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(NetworkAttachmentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkAttachmentsClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = NetworkAttachmentsClient._DEFAULT_UNIVERSE
    default_endpoint = NetworkAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = NetworkAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert NetworkAttachmentsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert NetworkAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == NetworkAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    assert NetworkAttachmentsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert NetworkAttachmentsClient._get_api_endpoint(None, None, default_universe, "always") == NetworkAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    assert NetworkAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == NetworkAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    assert NetworkAttachmentsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert NetworkAttachmentsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        NetworkAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert NetworkAttachmentsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert NetworkAttachmentsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert NetworkAttachmentsClient._get_universe_domain(None, None) == NetworkAttachmentsClient._DEFAULT_UNIVERSE
...
def test_network_attachments_client_from_service_account_info(client_class, transport_name):
...
def test_network_attachments_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_network_attachments_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@mock.patch.object(NetworkAttachmentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkAttachmentsClient))
def test_network_attachments_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (NetworkAttachmentsClient, transports.NetworkAttachmentsRestTransport, "rest", "true"),
    (NetworkAttachmentsClient, transports.NetworkAttachmentsRestTransport, "rest", "false"),
])
@mock.patch.object(NetworkAttachmentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkAttachmentsClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_network_attachments_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(NetworkAttachmentsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(NetworkAttachmentsClient))
...
@mock.patch.object(NetworkAttachmentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkAttachmentsClient))
def test_network_attachments_client_client_api_endpoint(client_class):
...
def test_network_attachments_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (NetworkAttachmentsClient, transports.NetworkAttachmentsRestTransport, "rest", None),
])
def test_network_attachments_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListNetworkAttachmentsRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = compute.NetworkAttachmentAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.NetworkAttachmentsRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/aggregated/networkAttachments" % client.transport._host, args[1])
...
def test_aggregated_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(compute.NetworkAttachmentAggregatedList.to_json(x) for x in response)
        ...
        for result in results:
            ...
            assert tuple(type(t) for t in result) == (str, compute.NetworkAttachmentsScopedList)
...
def test_delete_rest_required_fields(request_type=compute.DeleteNetworkAttachmentRequest):
    transport_class = transports.NetworkAttachmentsRestTransport
...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("networkAttachment", "project", "region", )))
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'project': 'sample1', 'region': 'sample2', 'network_attachment': 'sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/networkAttachments/{network_attachment}" % client.transport._host, args[1])
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteNetworkAttachmentRequest):
    transport_class = transports.NetworkAttachmentsRestTransport
...
def test_get_rest_required_fields(request_type=compute.GetNetworkAttachmentRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.NetworkAttachment.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("networkAttachment", "project", "region", )))
...
def test_get_iam_policy_rest_required_fields(request_type=compute.GetIamPolicyNetworkAttachmentRequest):
    transport_class = transports.NetworkAttachmentsRestTransport
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/networkAttachments/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest_required_fields(request_type=compute.InsertNetworkAttachmentRequest):
    transport_class = transports.NetworkAttachmentsRestTransport
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("networkAttachmentResource", "project", "region", )))
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            region='region_value',
            network_attachment_resource=compute.NetworkAttachment(connection_endpoints=[compute.NetworkAttachmentConnectedEndpoint(ip_address='ip_address_value')]),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/networkAttachments" % client.transport._host, args[1])
...
def test_insert_unary_rest_required_fields(request_type=compute.InsertNetworkAttachmentRequest):
    transport_class = transports.NetworkAttachmentsRestTransport
...
def test_list_rest_required_fields(request_type=compute.ListNetworkAttachmentsRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.NetworkAttachmentList.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.NetworkAttachment)
                for i in results)
...
def test_patch_rest_required_fields(request_type=compute.PatchNetworkAttachmentRequest):
    transport_class = transports.NetworkAttachmentsRestTransport
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("networkAttachment", "networkAttachmentResource", "project", "region", )))
...
def test_patch_unary_rest_required_fields(request_type=compute.PatchNetworkAttachmentRequest):
    transport_class = transports.NetworkAttachmentsRestTransport
...
def test_set_iam_policy_rest_required_fields(request_type=compute.SetIamPolicyNetworkAttachmentRequest):
    transport_class = transports.NetworkAttachmentsRestTransport
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/networkAttachments/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsNetworkAttachmentRequest):
    transport_class = transports.NetworkAttachmentsRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/regions/{region}/networkAttachments/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListNetworkAttachmentsRequest):
    client = NetworkAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.NetworkAttachmentsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NetworkAttachmentsRestInterceptor(),
        )
    client = NetworkAttachmentsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_aggregated_list") as post, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListNetworkAttachmentsRequest.pb(compute.AggregatedListNetworkAttachmentsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NetworkAttachmentAggregatedList.to_json(compute.NetworkAttachmentAggregatedList())
        ...
        post_with_metadata.return_value = compute.NetworkAttachmentAggregatedList(), metadata
...
def test_delete_rest_bad_request(request_type=compute.DeleteNetworkAttachmentRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'network_attachment': 'sample3'}
    request = request_type(**request_init)
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteNetworkAttachmentRequest.pb(compute.DeleteNetworkAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetNetworkAttachmentRequest.pb(compute.GetNetworkAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NetworkAttachment.to_json(compute.NetworkAttachment())
        req.return_value.content = return_value
...
def test_get_iam_policy_rest_bad_request(request_type=compute.GetIamPolicyNetworkAttachmentRequest):
    client = NetworkAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyNetworkAttachmentRequest.pb(compute.GetIamPolicyNetworkAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_insert_rest_call_success(request_type):
    ...
    for field, value in request_init["network_attachment_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["network_attachment_resource"][field])):
                    del request_init["network_attachment_resource"][field][i][subfield]
            else:
                del request_init["network_attachment_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertNetworkAttachmentRequest.pb(compute.InsertNetworkAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListNetworkAttachmentsRequest.pb(compute.ListNetworkAttachmentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NetworkAttachmentList.to_json(compute.NetworkAttachmentList())
        req.return_value.content = return_value
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchNetworkAttachmentRequest.meta.fields["network_attachment_resource"]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchNetworkAttachmentRequest.pb(compute.PatchNetworkAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_set_iam_policy_rest_bad_request(request_type=compute.SetIamPolicyNetworkAttachmentRequest):
    client = NetworkAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyNetworkAttachmentRequest.meta.fields["region_set_policy_request_resource"]
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyNetworkAttachmentRequest.pb(compute.SetIamPolicyNetworkAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsNetworkAttachmentRequest):
    client = NetworkAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsNetworkAttachmentRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsNetworkAttachmentRequest.pb(compute.TestIamPermissionsNetworkAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = compute.AggregatedListNetworkAttachmentsRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteNetworkAttachmentRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetNetworkAttachmentRequest()
...
def test_get_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetIamPolicyNetworkAttachmentRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertNetworkAttachmentRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListNetworkAttachmentsRequest()
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchNetworkAttachmentRequest()
...
def test_set_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetIamPolicyNetworkAttachmentRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsNetworkAttachmentRequest()
...
def test_network_attachments_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.network_attachments.transports.NetworkAttachmentsTransport.__init__') as Transport:
...
def test_network_attachments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.network_attachments.transports.NetworkAttachmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_network_attachments_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.network_attachments.transports.NetworkAttachmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NetworkAttachmentsTransport()
        adc.assert_called_once()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.NetworkAttachmentsTransport, '_prep_wrapped_messages') as prep:
        client = NetworkAttachmentsClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
from google.ai.generativelanguage_v1.services.model_service import ModelServiceAsyncClient
from google.ai.generativelanguage_v1.services.model_service import ModelServiceClient
from google.ai.generativelanguage_v1.services.model_service import pagers
from google.ai.generativelanguage_v1.services.model_service import transports
...
def test_model_service_client_client_options_from_dict():
    with mock.patch('google.ai.generativelanguage_v1.services.model_service.transports.ModelServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{name=models/*}" % client.transport._host, args[1])
...
def test_list_models_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/models" % client.transport._host, args[1])
...
def test_model_service_base_transport():
    ...
    with mock.patch('google.ai.generativelanguage_v1.services.model_service.transports.ModelServiceTransport.__init__') as Transport:
...
def test_model_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1.services.model_service.transports.ModelServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_model_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1.services.model_service.transports.ModelServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ModelServiceTransport()
        adc.assert_called_once()

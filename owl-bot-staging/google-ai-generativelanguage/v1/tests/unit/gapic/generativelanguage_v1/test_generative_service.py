...
def test_generate_content_rest_required_fields(request_type=generative_service.GenerateContentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_content._get_unset_required_fields(jsonified_request)
...
def test_generate_content_rest_unset_required_fields():
    transport = transports.GenerativeServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_stream_generate_content_rest_required_fields(request_type=generative_service.GenerateContentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).stream_generate_content._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_embed_content_rest_required_fields(request_type=generative_service.EmbedContentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).embed_content._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_embed_contents_rest_required_fields(request_type=generative_service.BatchEmbedContentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_embed_contents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_count_tokens_rest_required_fields(request_type=generative_service.CountTokensRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).count_tokens._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

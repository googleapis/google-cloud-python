...
from google.ai.generativelanguage_v1.services.generative_service import GenerativeServiceAsyncClient
from google.ai.generativelanguage_v1.services.generative_service import GenerativeServiceClient
from google.ai.generativelanguage_v1.services.generative_service import transports
...
def test_generative_service_client_client_options_from_dict():
    with mock.patch('google.ai.generativelanguage_v1.services.generative_service.transports.GenerativeServiceGrpcTransport.__init__') as grpc_transport:
...
def test_generate_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{model=models/*}:generateContent" % client.transport._host, args[1])
...
def test_stream_generate_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{model=models/*}:streamGenerateContent" % client.transport._host, args[1])
...
def test_embed_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{model=models/*}:embedContent" % client.transport._host, args[1])
...
def test_batch_embed_contents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{model=models/*}:batchEmbedContents" % client.transport._host, args[1])
...
def test_count_tokens_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{model=models/*}:countTokens" % client.transport._host, args[1])
...
def test_generative_service_base_transport():
    ...
    with mock.patch('google.ai.generativelanguage_v1.services.generative_service.transports.GenerativeServiceTransport.__init__') as Transport:
...
def test_generative_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1.services.generative_service.transports.GenerativeServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_generative_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1.services.generative_service.transports.GenerativeServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GenerativeServiceTransport()
        adc.assert_called_once()

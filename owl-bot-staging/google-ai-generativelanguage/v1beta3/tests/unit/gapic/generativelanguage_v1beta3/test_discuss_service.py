...
from google.ai.generativelanguage_v1beta3.services.discuss_service import DiscussServiceAsyncClient
from google.ai.generativelanguage_v1beta3.services.discuss_service import DiscussServiceClient
from google.ai.generativelanguage_v1beta3.services.discuss_service import transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert DiscussServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert DiscussServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert DiscussServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert DiscussServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert DiscussServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert DiscussServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert DiscussServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert DiscussServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(DiscussServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DiscussServiceClient))
@mock.patch.object(DiscussServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DiscussServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DiscussServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DiscussServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = DiscussServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert DiscussServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert DiscussServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DiscussServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DiscussServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert DiscussServiceClient._get_api_endpoint(None, None, default_universe, "always") == DiscussServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DiscussServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DiscussServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DiscussServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert DiscussServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        DiscussServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert DiscussServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert DiscussServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert DiscussServiceClient._get_universe_domain(None, None) == DiscussServiceClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = DiscussServiceClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (DiscussServiceAsyncClient, transports.DiscussServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (DiscussServiceAsyncClient, transports.DiscussServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (DiscussServiceClient, transports.DiscussServiceGrpcTransport, "grpc", "false"),
    (DiscussServiceAsyncClient, transports.DiscussServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
@pytest.mark.parametrize("client_class", [
    DiscussServiceClient, DiscussServiceAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (DiscussServiceClient, transports.DiscussServiceGrpcTransport, "grpc", grpc_helpers),
    (DiscussServiceAsyncClient, transports.DiscussServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_discuss_service_client_client_options_from_dict():
    with mock.patch('google.ai.generativelanguage_v1beta3.services.discuss_service.transports.DiscussServiceGrpcTransport.__init__') as grpc_transport:
...
def test_generate_message(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.generate_message),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_generate_message_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_message in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_message] = mock_rpc
...
def test_count_message_tokens_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.count_message_tokens in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.count_message_tokens] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_count_message_tokens_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DiscussServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.count_message_tokens in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.count_message_tokens] = mock_rpc
...
def test_generate_message_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta3/{model=models/*}:generateMessage" % client.transport._host, args[1])
...
def test_count_message_tokens_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta3/{model=models/*}:countMessageTokens" % client.transport._host, args[1])
...
def test_generate_message_rest_bad_request(request_type=discuss_service.GenerateMessageRequest):
    client = DiscussServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_message_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DiscussServiceRestInterceptor, "post_generate_message") as post, \
        mock.patch.object(transports.DiscussServiceRestInterceptor, "post_generate_message_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DiscussServiceRestInterceptor, "pre_generate_message") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = discuss_service.GenerateMessageResponse.to_json(discuss_service.GenerateMessageResponse())
        ...
        post_with_metadata.return_value = discuss_service.GenerateMessageResponse(), metadata
...
def test_count_message_tokens_rest_bad_request(request_type=discuss_service.CountMessageTokensRequest):
    client = DiscussServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_count_message_tokens_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DiscussServiceRestInterceptor, "post_count_message_tokens") as post, \
        mock.patch.object(transports.DiscussServiceRestInterceptor, "post_count_message_tokens_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DiscussServiceRestInterceptor, "pre_count_message_tokens") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = discuss_service.CountMessageTokensResponse.to_json(discuss_service.CountMessageTokensResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = discuss_service.CountMessageTokensResponse(), metadata
...
def test_discuss_service_base_transport():
    ...
    with mock.patch('google.ai.generativelanguage_v1beta3.services.discuss_service.transports.DiscussServiceTransport.__init__') as Transport:
...
def test_discuss_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1beta3.services.discuss_service.transports.DiscussServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_discuss_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1beta3.services.discuss_service.transports.DiscussServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DiscussServiceTransport()
        adc.assert_called_once()
...
def test_discuss_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DiscussServiceGrpcTransport, transports.DiscussServiceGrpcAsyncIOTransport])
def test_discuss_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

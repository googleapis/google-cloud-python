...
def test_generate_message_rest_required_fields(request_type=discuss_service.GenerateMessageRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_message._get_unset_required_fields(jsonified_request)
...
def test_generate_message_rest_unset_required_fields():
    transport = transports.DiscussServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_count_message_tokens_rest_required_fields(request_type=discuss_service.CountMessageTokensRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).count_message_tokens._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

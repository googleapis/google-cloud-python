...
from google.ai.generativelanguage_v1beta3.services.permission_service import PermissionServiceAsyncClient
from google.ai.generativelanguage_v1beta3.services.permission_service import PermissionServiceClient
from google.ai.generativelanguage_v1beta3.services.permission_service import pagers
from google.ai.generativelanguage_v1beta3.services.permission_service import transports
...
def test_create_permission_rest_required_fields(request_type=permission_service.CreatePermissionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_permission._get_unset_required_fields(jsonified_request)
...
def test_create_permission_rest_unset_required_fields():
    transport = transports.PermissionServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_permission_rest_required_fields(request_type=permission_service.GetPermissionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_permission._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_permissions_rest_required_fields(request_type=permission_service.ListPermissionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_permissions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_permission_rest_required_fields(request_type=permission_service.UpdatePermissionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_permission._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_permission_rest_required_fields(request_type=permission_service.DeletePermissionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_permission._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transfer_ownership_rest_required_fields(request_type=permission_service.TransferOwnershipRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).transfer_ownership._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
class PermissionServiceAsyncClient:
    ...
    parse_tuned_model_path = staticmethod(PermissionServiceClient.parse_tuned_model_path)
    ...
    get_transport_class = functools.partial(type(PermissionServiceClient).get_transport_class, type(PermissionServiceClient))

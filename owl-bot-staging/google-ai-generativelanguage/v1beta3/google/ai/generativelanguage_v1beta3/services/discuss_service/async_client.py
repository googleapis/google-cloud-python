...
from google.ai.generativelanguage_v1beta3.types import safety
from google.longrunning import operations_pb2 # type: ignore
from .transports.base import DiscussServiceTransport, DEFAULT_CLIENT_INFO
...
class DiscussServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(DiscussServiceClient).get_transport_class, type(DiscussServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, DiscussServiceTransport, Callable[..., DiscussServiceTransport]]] = "grpc_asyncio",
    ...
    async def generate_message(self,
        ...
        has_flattened_params = any([model, prompt, temperature, candidate_count, top_p, top_k])
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.generate_message]
    ...
    async def count_message_tokens(self,
            request: Optional[Union[discuss_service.CountMessageTokensRequest, dict]] = None,
            *,
            model: Optional[str] = None,
            prompt: Optional[discuss_service.MessagePrompt] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.count_message_tokens]

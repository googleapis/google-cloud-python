...
class TextServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_batch_embed_text_with_metadata(self, response: text_service.BatchEmbedTextResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[text_service.BatchEmbedTextResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for batch_embed_text
    ...
    def post_count_text_tokens_with_metadata(self, response: text_service.CountTextTokensResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[text_service.CountTextTokensResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for count_text_tokens
    ...
    def post_embed_text_with_metadata(self, response: text_service.EmbedTextResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[text_service.EmbedTextResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for embed_text
    ...
    def post_generate_text_with_metadata(self, response: text_service.GenerateTextResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[text_service.GenerateTextResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for generate_text
...
class TextServiceRestTransport(_BaseTextServiceRestTransport):
    ...
    class _BatchEmbedText(_BaseTextServiceRestTransport._BaseBatchEmbedText, TextServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TextServiceRestTransport._BatchEmbedText._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CountTextTokens(_BaseTextServiceRestTransport._BaseCountTextTokens, TextServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TextServiceRestTransport._CountTextTokens._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _EmbedText(_BaseTextServiceRestTransport._BaseEmbedText, TextServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TextServiceRestTransport._EmbedText._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GenerateText(_BaseTextServiceRestTransport._BaseGenerateText, TextServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TextServiceRestTransport._GenerateText._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def batch_embed_text(self) -> Callable[
    ...
    @property
    def count_text_tokens(self) -> Callable[
    ...
    @property
    def generate_text(self) -> Callable[
    ...
    class _GetOperation(_BaseTextServiceRestTransport._BaseGetOperation, TextServiceRestStub):
        def __hash__(self):
            return hash("TextServiceRestTransport.GetOperation")
        ...
        def __call__(self,
            ...
            http_options = _BaseTextServiceRestTransport._BaseGetOperation._get_http_options()

            request, metadata = self._interceptor.pre_get_operation(request, metadata)
            transcoded_request = _BaseTextServiceRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseTextServiceRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = TextServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseTextServiceRestTransport._BaseListOperations, TextServiceRestStub):
        def __hash__(self):
            return hash("TextServiceRestTransport.ListOperations")
        ...
        def __call__(self,
            ...
            http_options = _BaseTextServiceRestTransport._BaseListOperations._get_http_options()

            request, metadata = self._interceptor.pre_list_operations(request, metadata)
            transcoded_request = _BaseTextServiceRestTransport._BaseListOperations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseTextServiceRestTransport._BaseListOperations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = TextServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

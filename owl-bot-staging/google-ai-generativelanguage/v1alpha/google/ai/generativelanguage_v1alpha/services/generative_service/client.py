...
class GenerativeServiceClient(metaclass=GenerativeServiceClientMeta):
    ...
    def cached_content_path(id: str,) -> str:
        ...
        return "cachedContents/{id}".format(id=id, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = GenerativeServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GenerativeServiceTransport, Callable[..., GenerativeServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GenerativeServiceClient._read_environment_variables()
        self._client_cert_source = GenerativeServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = GenerativeServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[GenerativeServiceTransport], Callable[..., GenerativeServiceTransport]] = (
    ...
    def bidi_generate_content(self,
            requests: Optional[Iterator[generative_service.BidiGenerateContentClientMessage]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),

...
from google.ai.generativelanguage_v1alpha.types import file
from google.ai.generativelanguage_v1alpha.types import file_service
...
class FileServiceTransport(abc.ABC):
    ...
    @property
    def create_file(self) -> Callable[
            [file_service.CreateFileRequest],
            Union[
                file_service.CreateFileResponse,
                Awaitable[file_service.CreateFileResponse]
            ]]:
        raise NotImplementedError()
    ...
    def list_files(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[file_service.ListFilesResponse]
            ]]:
        raise NotImplementedError()

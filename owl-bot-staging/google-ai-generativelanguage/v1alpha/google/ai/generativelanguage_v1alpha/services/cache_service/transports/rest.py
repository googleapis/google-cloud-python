...
class CacheServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_create_cached_content_with_metadata(self, response: gag_cached_content.CachedContent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gag_cached_content.CachedContent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_cached_content
    ...
    def post_get_cached_content_with_metadata(self, response: cached_content.CachedContent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cached_content.CachedContent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_cached_content
    ...
    def post_list_cached_contents_with_metadata(self, response: cache_service.ListCachedContentsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cache_service.ListCachedContentsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_cached_contents
    ...
    def post_update_cached_content_with_metadata(self, response: gag_cached_content.CachedContent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gag_cached_content.CachedContent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_cached_content
...
class CacheServiceRestTransport(_BaseCacheServiceRestTransport):
    ...
    class _CreateCachedContent(_BaseCacheServiceRestTransport._BaseCreateCachedContent, CacheServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CacheServiceRestTransport._CreateCachedContent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteCachedContent(_BaseCacheServiceRestTransport._BaseDeleteCachedContent, CacheServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CacheServiceRestTransport._DeleteCachedContent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetCachedContent(_BaseCacheServiceRestTransport._BaseGetCachedContent, CacheServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CacheServiceRestTransport._GetCachedContent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListCachedContents(_BaseCacheServiceRestTransport._BaseListCachedContents, CacheServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CacheServiceRestTransport._ListCachedContents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateCachedContent(_BaseCacheServiceRestTransport._BaseUpdateCachedContent, CacheServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CacheServiceRestTransport._UpdateCachedContent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseCacheServiceRestTransport._BaseGetOperation, CacheServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CacheServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseCacheServiceRestTransport._BaseListOperations, CacheServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CacheServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

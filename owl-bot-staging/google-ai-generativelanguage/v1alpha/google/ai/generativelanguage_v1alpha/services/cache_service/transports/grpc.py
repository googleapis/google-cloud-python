...
from .base import CacheServiceTransport, DEFAULT_CLIENT_INFO
...
class CacheServiceGrpcTransport(CacheServiceTransport):
    ...
    @property
    def list_cached_contents(self) -> Callable[
    ...
    @property
    def create_cached_content(self) -> Callable[
    ...
    @property
    def get_cached_content(self) -> Callable[
    ...
    @property
    def update_cached_content(self) -> Callable[
    ...
    @property
    def delete_cached_content(self) -> Callable[

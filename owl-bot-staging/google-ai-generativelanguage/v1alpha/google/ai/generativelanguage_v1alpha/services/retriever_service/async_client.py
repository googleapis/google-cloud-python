...
class RetrieverServiceAsyncClient:
    ...
    async def batch_create_chunks(self,
    ...
    async def batch_update_chunks(self,
    ...
    async def batch_delete_chunks(self,

...
from google.ai.generativelanguage_v1alpha.services.generative_service import GenerativeServiceAsyncClient
from google.ai.generativelanguage_v1alpha.services.generative_service import GenerativeServiceClient
from google.ai.generativelanguage_v1alpha.services.generative_service import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert GenerativeServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert GenerativeServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert GenerativeServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert GenerativeServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert GenerativeServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert GenerativeServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert GenerativeServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert GenerativeServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert GenerativeServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert GenerativeServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert GenerativeServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert GenerativeServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert GenerativeServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert GenerativeServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(GenerativeServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GenerativeServiceClient))
@mock.patch.object(GenerativeServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GenerativeServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = GenerativeServiceClient._DEFAULT_UNIVERSE
    default_endpoint = GenerativeServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = GenerativeServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert GenerativeServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert GenerativeServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == GenerativeServiceClient.DEFAULT_MTLS_ENDPOINT
    assert GenerativeServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert GenerativeServiceClient._get_api_endpoint(None, None, default_universe, "always") == GenerativeServiceClient.DEFAULT_MTLS_ENDPOINT
    assert GenerativeServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == GenerativeServiceClient.DEFAULT_MTLS_ENDPOINT
    assert GenerativeServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert GenerativeServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        GenerativeServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert GenerativeServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert GenerativeServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
...
def test_generative_service_client_from_service_account_info(client_class, transport_name):
...
def test_generative_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_generative_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (GenerativeServiceAsyncClient, transports.GenerativeServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (GenerativeServiceClient, transports.GenerativeServiceRestTransport, "rest"),
])
@mock.patch.object(GenerativeServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GenerativeServiceClient))
@mock.patch.object(GenerativeServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GenerativeServiceAsyncClient))
def test_generative_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (GenerativeServiceClient, transports.GenerativeServiceGrpcTransport, "grpc", "true"),
    (GenerativeServiceAsyncClient, transports.GenerativeServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (GenerativeServiceClient, transports.GenerativeServiceGrpcTransport, "grpc", "false"),
    (GenerativeServiceAsyncClient, transports.GenerativeServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (GenerativeServiceClient, transports.GenerativeServiceRestTransport, "rest", "true"),
    (GenerativeServiceClient, transports.GenerativeServiceRestTransport, "rest", "false"),
])
@mock.patch.object(GenerativeServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GenerativeServiceClient))
@mock.patch.object(GenerativeServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GenerativeServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_generative_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    GenerativeServiceClient, GenerativeServiceAsyncClient
])
@mock.patch.object(GenerativeServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GenerativeServiceClient))
@mock.patch.object(GenerativeServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GenerativeServiceAsyncClient))
...
def test_generative_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (GenerativeServiceClient, transports.GenerativeServiceGrpcTransport, "grpc", grpc_helpers),
    (GenerativeServiceAsyncClient, transports.GenerativeServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (GenerativeServiceClient, transports.GenerativeServiceRestTransport, "rest", None),
])
def test_generative_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_generative_service_client_client_options_from_dict():
    with mock.patch('google.ai.generativelanguage_v1alpha.services.generative_service.transports.GenerativeServiceGrpcTransport.__init__') as grpc_transport:
...
def test_generative_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_generate_content_async(transport: str = 'grpc_asyncio', request_type=generative_service.GenerateContentRequest):
    client = GenerativeServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(generative_service.GenerateContentResponse(
            model_version='model_version_value',
        ))
...
def test_generate_answer(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_answer),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_generate_answer_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GenerativeServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_answer in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_answer] = mock_rpc
...
@pytest.mark.asyncio
async def test_generate_answer_async(transport: str = 'grpc_asyncio', request_type=generative_service.GenerateAnswerRequest):
    client = GenerativeServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(generative_service.GenerateAnswerResponse(
            answerable_probability=0.234,
        ))
...
def test_generate_answer_flattened():
    ...
    with mock.patch.object(
        ...
        client.generate_answer(
            model='model_value',
            contents=[content.Content(parts=[content.Part(text='text_value')])],
            safety_settings=[safety.SafetySetting(category=safety.HarmCategory.HARM_CATEGORY_DEROGATORY)],
        ...
        mock_val = [safety.SafetySetting(category=safety.HarmCategory.HARM_CATEGORY_DEROGATORY)]
        assert arg == mock_val
...
@pytest.mark.asyncio
async def test_stream_generate_content_async(transport: str = 'grpc_asyncio', request_type=generative_service.GenerateContentRequest):
    client = GenerativeServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        call.return_value.read = mock.AsyncMock(side_effect=[generative_service.GenerateContentResponse()])
...
@pytest.mark.asyncio
async def test_embed_content_async(transport: str = 'grpc_asyncio', request_type=generative_service.EmbedContentRequest):
    client = GenerativeServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(generative_service.EmbedContentResponse(
        ))
...
def test_batch_embed_contents(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_embed_contents),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_batch_embed_contents_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_embed_contents in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_embed_contents] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_embed_contents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GenerativeServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_embed_contents in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_embed_contents] = mock_rpc
...
@pytest.mark.asyncio
async def test_batch_embed_contents_async(transport: str = 'grpc_asyncio', request_type=generative_service.BatchEmbedContentsRequest):
    client = GenerativeServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_count_tokens_async(transport: str = 'grpc_asyncio', request_type=generative_service.CountTokensRequest):
    client = GenerativeServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(generative_service.CountTokensResponse(
            total_tokens=1303,
            cached_content_token_count=2746,
        ))
...
def test_bidi_generate_content(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.bidi_generate_content),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = iter([generative_service.BidiGenerateContentServerMessage()])
...
def test_bidi_generate_content_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.bidi_generate_content in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.bidi_generate_content] = mock_rpc
        request = [{}]
...
@pytest.mark.asyncio
async def test_bidi_generate_content_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GenerativeServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.bidi_generate_content in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.bidi_generate_content] = mock_rpc
...
@pytest.mark.asyncio
async def test_bidi_generate_content_async(transport: str = 'grpc_asyncio', request_type=generative_service.BidiGenerateContentClientMessage):
    client = GenerativeServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        call.return_value.read = mock.AsyncMock(side_effect=[generative_service.BidiGenerateContentServerMessage()])
...
def test_generate_content_rest_required_fields(request_type=generative_service.GenerateContentRequest):
...
def test_generate_content_rest_unset_required_fields():
    transport = transports.GenerativeServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_generate_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/{model=models/*}:generateContent" % client.transport._host, args[1])
...
def test_generate_answer_rest_required_fields(request_type=generative_service.GenerateAnswerRequest):
    transport_class = transports.GenerativeServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_answer._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_answer_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("model", "contents", "answerStyle", )))
...
def test_generate_answer_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{model=models/*}:generateAnswer" % client.transport._host, args[1])
...
def test_stream_generate_content_rest_required_fields(request_type=generative_service.GenerateContentRequest):
    transport_class = transports.GenerativeServiceRestTransport
...
def test_stream_generate_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{model=models/*}:streamGenerateContent" % client.transport._host, args[1])
...
def test_embed_content_rest_required_fields(request_type=generative_service.EmbedContentRequest):
    transport_class = transports.GenerativeServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).embed_content._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_embed_content_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("model", "content", )))
...
def test_embed_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{model=models/*}:embedContent" % client.transport._host, args[1])
...
def test_batch_embed_contents_rest_required_fields(request_type=generative_service.BatchEmbedContentsRequest):
    transport_class = transports.GenerativeServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_embed_contents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_embed_contents_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("model", "requests", )))
...
def test_batch_embed_contents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{model=models/*}:batchEmbedContents" % client.transport._host, args[1])
...
def test_count_tokens_rest_required_fields(request_type=generative_service.CountTokensRequest):
    transport_class = transports.GenerativeServiceRestTransport
...
def test_count_tokens_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{model=models/*}:countTokens" % client.transport._host, args[1])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_generate_answer_empty_call_grpc():
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = generative_service.GenerateAnswerResponse()
        client.generate_answer(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_embed_content_empty_call_grpc():
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_embed_contents_empty_call_grpc():
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = generative_service.BatchEmbedContentsResponse()
        client.batch_embed_contents(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = GenerativeServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_generate_answer_empty_call_grpc_asyncio():
    client = GenerativeServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.generate_answer(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_embed_content_empty_call_grpc_asyncio():
    client = GenerativeServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_embed_contents_empty_call_grpc_asyncio():
    client = GenerativeServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_embed_contents(request=None)
...
def test_transport_kind_rest():
    transport = GenerativeServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_generate_content_rest_bad_request(request_type=generative_service.GenerateContentRequest):
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_content_rest_interceptors(null_interceptor):
    transport = transports.GenerativeServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.GenerativeServiceRestInterceptor(),
        )
    client = GenerativeServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_generate_content") as post, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_generate_content_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "pre_generate_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = generative_service.GenerateContentRequest.pb(generative_service.GenerateContentRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = generative_service.GenerateContentResponse.to_json(generative_service.GenerateContentResponse())
        ...
        post_with_metadata.return_value = generative_service.GenerateContentResponse(), metadata
...
def test_generate_answer_rest_bad_request(request_type=generative_service.GenerateAnswerRequest):
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_answer_rest_call_success(request_type):
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_answer_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_generate_answer") as post, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_generate_answer_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "pre_generate_answer") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = generative_service.GenerateAnswerRequest.pb(generative_service.GenerateAnswerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = generative_service.GenerateAnswerResponse.to_json(generative_service.GenerateAnswerResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = generative_service.GenerateAnswerResponse(), metadata

        client.generate_answer(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_stream_generate_content_rest_bad_request(request_type=generative_service.GenerateContentRequest):
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_stream_generate_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_stream_generate_content") as post, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_stream_generate_content_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "pre_stream_generate_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = generative_service.GenerateContentRequest.pb(generative_service.GenerateContentRequest())
...
def test_embed_content_rest_bad_request(request_type=generative_service.EmbedContentRequest):
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_embed_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_embed_content") as post, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_embed_content_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "pre_embed_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = generative_service.EmbedContentRequest.pb(generative_service.EmbedContentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = generative_service.EmbedContentResponse.to_json(generative_service.EmbedContentResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = generative_service.EmbedContentResponse(), metadata
...
def test_batch_embed_contents_rest_bad_request(request_type=generative_service.BatchEmbedContentsRequest):
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_embed_contents_rest_call_success(request_type):
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_embed_contents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_batch_embed_contents") as post, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_batch_embed_contents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "pre_batch_embed_contents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = generative_service.BatchEmbedContentsRequest.pb(generative_service.BatchEmbedContentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = generative_service.BatchEmbedContentsResponse.to_json(generative_service.BatchEmbedContentsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = generative_service.BatchEmbedContentsResponse(), metadata

        client.batch_embed_contents(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_count_tokens_rest_bad_request(request_type=generative_service.CountTokensRequest):
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_count_tokens_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_count_tokens") as post, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_count_tokens_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.GenerativeServiceRestInterceptor, "pre_count_tokens") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = generative_service.CountTokensRequest.pb(generative_service.CountTokensRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = generative_service.CountTokensResponse.to_json(generative_service.CountTokensResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = generative_service.CountTokensResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_generate_answer_empty_call_rest():
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_embed_content_empty_call_rest():
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_embed_contents_empty_call_rest():
    client = GenerativeServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_generative_service_base_transport():
    ...
    with mock.patch('google.ai.generativelanguage_v1alpha.services.generative_service.transports.GenerativeServiceTransport.__init__') as Transport:
...
def test_generative_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1alpha.services.generative_service.transports.GenerativeServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_generative_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1alpha.services.generative_service.transports.GenerativeServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GenerativeServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.GenerativeServiceGrpcTransport, transports.GenerativeServiceGrpcAsyncIOTransport])
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.GenerativeServiceTransport, '_prep_wrapped_messages') as prep:
        client = GenerativeServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

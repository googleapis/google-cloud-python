...
from google.ai.generativelanguage_v1alpha.services.text_service import TextServiceAsyncClient
from google.ai.generativelanguage_v1alpha.services.text_service import TextServiceClient
from google.ai.generativelanguage_v1alpha.services.text_service import transports
...
def test_text_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1alpha.services.text_service.transports.TextServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_text_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1alpha.services.text_service.transports.TextServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.TextServiceTransport()
        adc.assert_called_once()

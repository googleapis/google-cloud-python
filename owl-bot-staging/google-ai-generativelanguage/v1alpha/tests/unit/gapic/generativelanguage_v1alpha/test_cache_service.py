...
from google.ai.generativelanguage_v1alpha.services.cache_service import CacheServiceAsyncClient
from google.ai.generativelanguage_v1alpha.services.cache_service import CacheServiceClient
from google.ai.generativelanguage_v1alpha.services.cache_service import pagers
from google.ai.generativelanguage_v1alpha.services.cache_service import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert CacheServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert CacheServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert CacheServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert CacheServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert CacheServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert CacheServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert CacheServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert CacheServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert CacheServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert CacheServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert CacheServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(CacheServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CacheServiceClient))
@mock.patch.object(CacheServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CacheServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CacheServiceClient._DEFAULT_UNIVERSE
    default_endpoint = CacheServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = CacheServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert CacheServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert CacheServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CacheServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CacheServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CacheServiceClient._get_api_endpoint(None, None, default_universe, "always") == CacheServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CacheServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CacheServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CacheServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert CacheServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        CacheServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert CacheServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert CacheServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert CacheServiceClient._get_universe_domain(None, None) == CacheServiceClient._DEFAULT_UNIVERSE
...
def test_cache_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (CacheServiceAsyncClient, transports.CacheServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (CacheServiceClient, transports.CacheServiceRestTransport, "rest"),
])
@mock.patch.object(CacheServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CacheServiceClient))
@mock.patch.object(CacheServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CacheServiceAsyncClient))
def test_cache_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (CacheServiceAsyncClient, transports.CacheServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (CacheServiceClient, transports.CacheServiceGrpcTransport, "grpc", "false"),
    (CacheServiceAsyncClient, transports.CacheServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_cache_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    CacheServiceClient, CacheServiceAsyncClient
])
@mock.patch.object(CacheServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CacheServiceClient))
@mock.patch.object(CacheServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CacheServiceAsyncClient))
...
def test_cache_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (CacheServiceClient, transports.CacheServiceGrpcTransport, "grpc", grpc_helpers),
    (CacheServiceAsyncClient, transports.CacheServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (CacheServiceClient, transports.CacheServiceRestTransport, "rest", None),
])
def test_cache_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_cache_service_client_client_options_from_dict():
    with mock.patch('google.ai.generativelanguage_v1alpha.services.cache_service.transports.CacheServiceGrpcTransport.__init__') as grpc_transport:
...
def test_cache_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_list_cached_contents_async(transport: str = 'grpc_asyncio', request_type=cache_service.ListCachedContentsRequest):
    client = CacheServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(cache_service.ListCachedContentsResponse(
            next_page_token='next_page_token_value',
        ))
...
@pytest.mark.asyncio
async def test_create_cached_content_async(transport: str = 'grpc_asyncio', request_type=cache_service.CreateCachedContentRequest):
    client = CacheServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gag_cached_content.CachedContent(
            name='name_value',
            display_name='display_name_value',
            model='model_value',
        ))
...
def test_create_cached_content_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_cached_content(
            cached_content=gag_cached_content.CachedContent(expire_time=timestamp_pb2.Timestamp(seconds=751)),
        )
        ...
        mock_val = gag_cached_content.CachedContent(expire_time=timestamp_pb2.Timestamp(seconds=751))
        assert arg == mock_val
...
@pytest.mark.asyncio
async def test_get_cached_content_async(transport: str = 'grpc_asyncio', request_type=cache_service.GetCachedContentRequest):
    client = CacheServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_cached_content_async(transport: str = 'grpc_asyncio', request_type=cache_service.UpdateCachedContentRequest):
    client = CacheServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_cached_content_async(transport: str = 'grpc_asyncio', request_type=cache_service.DeleteCachedContentRequest):
    client = CacheServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_cached_contents_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(cache_service.ListCachedContentsResponse.to_json(x) for x in response)
...
def test_create_cached_content_rest_required_fields(request_type=cache_service.CreateCachedContentRequest):
...
def test_create_cached_content_rest_unset_required_fields():
    transport = transports.CacheServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_create_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/cachedContents" % client.transport._host, args[1])
...
def test_get_cached_content_rest_required_fields(request_type=cache_service.GetCachedContentRequest):
    transport_class = transports.CacheServiceRestTransport
...
def test_get_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=cachedContents/*}" % client.transport._host, args[1])
...
def test_update_cached_content_rest_required_fields(request_type=cache_service.UpdateCachedContentRequest):
    transport_class = transports.CacheServiceRestTransport
...
def test_update_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{cached_content.name=cachedContents/*}" % client.transport._host, args[1])
...
def test_delete_cached_content_rest_required_fields(request_type=cache_service.DeleteCachedContentRequest):
    transport_class = transports.CacheServiceRestTransport
...
def test_list_cached_contents_empty_call_grpc():
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_cached_content_empty_call_grpc():
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_cached_content_empty_call_grpc():
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_cached_content_empty_call_grpc():
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_cached_content_empty_call_grpc():
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_transport_kind_grpc_asyncio():
    transport = CacheServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_cached_contents_empty_call_grpc_asyncio():
    client = CacheServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_cached_content_empty_call_grpc_asyncio():
    client = CacheServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_cached_content_empty_call_grpc_asyncio():
    client = CacheServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_cached_content_empty_call_grpc_asyncio():
    client = CacheServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_cached_content_empty_call_grpc_asyncio():
    client = CacheServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_transport_kind_rest():
    transport = CacheServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_cached_contents_rest_bad_request(request_type=cache_service.ListCachedContentsRequest):
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_cached_contents_rest_interceptors(null_interceptor):
    transport = transports.CacheServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CacheServiceRestInterceptor(),
        )
    client = CacheServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "post_list_cached_contents") as post, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "post_list_cached_contents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "pre_list_cached_contents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cache_service.ListCachedContentsRequest.pb(cache_service.ListCachedContentsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cache_service.ListCachedContentsResponse.to_json(cache_service.ListCachedContentsResponse())
        ...
        post_with_metadata.return_value = cache_service.ListCachedContentsResponse(), metadata
...
def test_create_cached_content_rest_bad_request(request_type=cache_service.CreateCachedContentRequest):
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_cached_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "post_create_cached_content") as post, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "post_create_cached_content_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "pre_create_cached_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cache_service.CreateCachedContentRequest.pb(cache_service.CreateCachedContentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gag_cached_content.CachedContent.to_json(gag_cached_content.CachedContent())
        req.return_value.content = return_value
...
def test_get_cached_content_rest_bad_request(request_type=cache_service.GetCachedContentRequest):
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_cached_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "post_get_cached_content") as post, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "post_get_cached_content_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "pre_get_cached_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cache_service.GetCachedContentRequest.pb(cache_service.GetCachedContentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_cached_content_rest_bad_request(request_type=cache_service.UpdateCachedContentRequest):
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_cached_content_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'cached_content': {'name': 'cachedContents/sample1'}}
    request_init["cached_content"] = {'expire_time': {'seconds': 751, 'nanos': 543}, 'ttl': {'seconds': 751, 'nanos': 543}, 'name': 'cachedContents/sample1', 'display_name': 'display_name_value', 'model': 'model_value', 'system_instruction': {'parts': [{'text': 'text_value', 'inline_data': {'mime_type': 'mime_type_value', 'data': b'data_blob'}, 'function_call': {'id': 'id_value', 'name': 'name_value', 'args': {'fields': {}}}, 'function_response': {'id': 'id_value', 'name': 'name_value', 'response': {}}, 'file_data': {'mime_type': 'mime_type_value', 'file_uri': 'file_uri_value'}, 'executable_code': {'language': 1, 'code': 'code_value'}, 'code_execution_result': {'outcome': 1, 'output': 'output_value'}}], 'role': 'role_value'}, 'contents': {}, 'tools': [{'function_declarations': [{'name': 'name_value', 'description': 'description_value', 'parameters': {'type_': 1, 'format_': 'format__value', 'description': 'description_value', 'nullable': True, 'enum': ['enum_value1', 'enum_value2'], 'items': {}, 'max_items': 967, 'min_items': 965, 'properties': {}, 'required': ['required_value1', 'required_value2']}, 'response': {}}], 'google_search_retrieval': {'dynamic_retrieval_config': {'mode': 1, 'dynamic_threshold': 0.1809}}, 'code_execution': {}, 'google_search': {}}], 'tool_config': {'function_calling_config': {'mode': 1, 'allowed_function_names': ['allowed_function_names_value1', 'allowed_function_names_value2']}}, 'create_time': {}, 'update_time': {}, 'usage_metadata': {'total_token_count': 1836}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_cached_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "post_update_cached_content") as post, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "post_update_cached_content_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "pre_update_cached_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cache_service.UpdateCachedContentRequest.pb(cache_service.UpdateCachedContentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_cached_content_rest_bad_request(request_type=cache_service.DeleteCachedContentRequest):
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_cached_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CacheServiceRestInterceptor, "pre_delete_cached_content") as pre:
        pre.assert_not_called()
        pb_message = cache_service.DeleteCachedContentRequest.pb(cache_service.DeleteCachedContentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_cached_contents_empty_call_rest():
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_cached_content_empty_call_rest():
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_cached_content_empty_call_rest():
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_cached_content_empty_call_rest():
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_cached_content_empty_call_rest():
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_cache_service_base_transport():
    ...
    with mock.patch('google.ai.generativelanguage_v1alpha.services.cache_service.transports.CacheServiceTransport.__init__') as Transport:
...
def test_cache_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1alpha.services.cache_service.transports.CacheServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cache_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1alpha.services.cache_service.transports.CacheServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CacheServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.CacheServiceGrpcTransport, transports.CacheServiceGrpcAsyncIOTransport])
def test_cache_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.CacheServiceGrpcTransport, transports.CacheServiceGrpcAsyncIOTransport])
def test_cache_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.CacheServiceGrpcTransport, transports.CacheServiceGrpcAsyncIOTransport])
def test_cache_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_cached_content_path():
    id = "squid"
    expected = "cachedContents/{id}".format(id=id, )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.CacheServiceTransport, '_prep_wrapped_messages') as prep:
        client = CacheServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

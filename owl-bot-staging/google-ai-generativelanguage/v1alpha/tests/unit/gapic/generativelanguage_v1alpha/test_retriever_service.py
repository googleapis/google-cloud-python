...
from google.ai.generativelanguage_v1alpha.services.retriever_service import RetrieverServiceAsyncClient
from google.ai.generativelanguage_v1alpha.services.retriever_service import RetrieverServiceClient
from google.ai.generativelanguage_v1alpha.services.retriever_service import pagers
from google.ai.generativelanguage_v1alpha.services.retriever_service import transports
...
def test__get_api_endpoint():
    ...
    assert RetrieverServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RetrieverServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert RetrieverServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RetrieverServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    RetrieverServiceClient, RetrieverServiceAsyncClient
])
...
def test_retriever_service_client_client_options_from_dict():
    with mock.patch('google.ai.generativelanguage_v1alpha.services.retriever_service.transports.RetrieverServiceGrpcTransport.__init__') as grpc_transport:
...
async def test_list_corpora_async(transport: str = 'grpc_asyncio', request_type=retriever_service.ListCorporaRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(retriever_service.ListCorporaResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_corpora_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, retriever.Corpus)
                   for i in results)
...
def test_query_corpus(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.query_corpus),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_documents_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, retriever.Document)
                   for i in results)
...
def test_query_document(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.query_document),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_chunk(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_chunk),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_batch_create_chunks(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_create_chunks),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_chunk(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_chunk),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = retriever.Chunk(
            name='name_value',
...
def test_batch_update_chunks(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_update_chunks),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_chunk(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_chunk),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_batch_delete_chunks(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_delete_chunks),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_list_chunks_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, retriever.Chunk)
                   for i in results)
...
def test_create_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/corpora" % client.transport._host, args[1])
...
def test_get_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=corpora/*}" % client.transport._host, args[1])
...
def test_update_corpus_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("corpus", "updateMask", )))
...
def test_update_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{corpus.name=corpora/*}" % client.transport._host, args[1])
...
def test_create_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=corpora/*}/documents" % client.transport._host, args[1])
...
def test_get_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=corpora/*/documents/*}" % client.transport._host, args[1])
...
def test_update_document_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("document", "updateMask", )))
...
def test_update_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{document.name=corpora/*/documents/*}" % client.transport._host, args[1])
...
def test_create_chunk_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "chunk", )))
...
def test_create_chunk_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=corpora/*/documents/*}/chunks" % client.transport._host, args[1])
...
def test_batch_create_chunks_rest_required_fields(request_type=retriever_service.BatchCreateChunksRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_create_chunks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_chunk_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=corpora/*/documents/*/chunks/*}" % client.transport._host, args[1])
...
def test_update_chunk_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("chunk", "updateMask", )))
...
def test_update_chunk_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{chunk.name=corpora/*/documents/*/chunks/*}" % client.transport._host, args[1])
...
def test_batch_update_chunks_rest_required_fields(request_type=retriever_service.BatchUpdateChunksRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_update_chunks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_delete_chunks_rest_required_fields(request_type=retriever_service.BatchDeleteChunksRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_delete_chunks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_corpus_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {}
    request_init["corpus"] = {'name': 'name_value', 'display_name': 'display_name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}}
...
def test_create_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_create_corpus") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_create_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_create_corpus") as pre:
...
def test_get_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_get_corpus") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_get_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_get_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_corpus_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'corpus': {'name': 'corpora/sample1'}}
    request_init["corpus"] = {'name': 'corpora/sample1', 'display_name': 'display_name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_update_corpus") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_update_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_update_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_delete_corpus") as pre:
        pre.assert_not_called()
...
def test_list_corpora_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_list_corpora") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_list_corpora_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_list_corpora") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_query_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_query_corpus") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_query_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_query_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.query_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_document_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'corpora/sample1'}
    request_init["document"] = {'name': 'name_value', 'display_name': 'display_name_value', 'custom_metadata': [{'string_value': 'string_value_value', 'string_list_value': {'values': ['values_value1', 'values_value2']}, 'numeric_value': 0.1391, 'key': 'key_value'}], 'update_time': {'seconds': 751, 'nanos': 543}, 'create_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_create_document") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_create_document_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_create_document") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_get_document") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_get_document_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_get_document") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_document_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'document': {'name': 'corpora/sample1/documents/sample2'}}
    request_init["document"] = {'name': 'corpora/sample1/documents/sample2', 'display_name': 'display_name_value', 'custom_metadata': [{'string_value': 'string_value_value', 'string_list_value': {'values': ['values_value1', 'values_value2']}, 'numeric_value': 0.1391, 'key': 'key_value'}], 'update_time': {'seconds': 751, 'nanos': 543}, 'create_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_update_document") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_update_document_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_update_document") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_delete_document") as pre:
        pre.assert_not_called()
...
def test_list_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_list_documents") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_list_documents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_list_documents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_query_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_query_document") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_query_document_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_query_document") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.query_document(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_chunk_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'corpora/sample1/documents/sample2'}
    request_init["chunk"] = {'name': 'name_value', 'data': {'string_value': 'string_value_value'}, 'custom_metadata': [{'string_value': 'string_value_value', 'string_list_value': {'values': ['values_value1', 'values_value2']}, 'numeric_value': 0.1391, 'key': 'key_value'}], 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_chunk_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_create_chunk") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_create_chunk_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_create_chunk") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_chunk(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_batch_create_chunks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_batch_create_chunks") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_batch_create_chunks_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_batch_create_chunks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.batch_create_chunks(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_chunk_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_get_chunk") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_get_chunk_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_get_chunk") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_chunk_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'chunk': {'name': 'corpora/sample1/documents/sample2/chunks/sample3'}}
    request_init["chunk"] = {'name': 'corpora/sample1/documents/sample2/chunks/sample3', 'data': {'string_value': 'string_value_value'}, 'custom_metadata': [{'string_value': 'string_value_value', 'string_list_value': {'values': ['values_value1', 'values_value2']}, 'numeric_value': 0.1391, 'key': 'key_value'}], 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_chunk_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_update_chunk") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_update_chunk_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_update_chunk") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_chunk(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_batch_update_chunks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_batch_update_chunks") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_batch_update_chunks_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_batch_update_chunks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.batch_update_chunks(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_chunk_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_delete_chunk") as pre:
        pre.assert_not_called()
        ...
        client.delete_chunk(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_batch_delete_chunks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_batch_delete_chunks") as pre:
        pre.assert_not_called()
        ...
        client.batch_delete_chunks(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_chunks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_list_chunks") as post, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_list_chunks_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_list_chunks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_retriever_service_base_transport():
    ...
    with mock.patch('google.ai.generativelanguage_v1alpha.services.retriever_service.transports.RetrieverServiceTransport.__init__') as Transport:
...
def test_retriever_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1alpha.services.retriever_service.transports.RetrieverServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_retriever_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1alpha.services.retriever_service.transports.RetrieverServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RetrieverServiceTransport()
        adc.assert_called_once()
...
def test_retriever_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.RetrieverServiceGrpcTransport, transports.RetrieverServiceGrpcAsyncIOTransport])
def test_retriever_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_chunk_path():
    ...
    document = "clam"
    chunk = "whelk"
    expected = "corpora/{corpus}/documents/{document}/chunks/{chunk}".format(corpus=corpus, document=document, chunk=chunk, )
...
def test_corpus_path():
    corpus = "cuttlefish"
    expected = "corpora/{corpus}".format(corpus=corpus, )
...
def test_document_path():
    corpus = "winkle"
    document = "nautilus"
    expected = "corpora/{corpus}/documents/{document}".format(corpus=corpus, document=document, )

...
from google.ai.generativelanguage_v1alpha.services.prediction_service import PredictionServiceAsyncClient
from google.ai.generativelanguage_v1alpha.services.prediction_service import PredictionServiceClient
from google.ai.generativelanguage_v1alpha.services.prediction_service import transports
...
def test_prediction_service_client_client_options_from_dict():
    with mock.patch('google.ai.generativelanguage_v1alpha.services.prediction_service.transports.PredictionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_predict_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("model", "instances", )))
...
def test_predict_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/{model=models/*}:predict" % client.transport._host, args[1])
...
def test_prediction_service_base_transport():
    ...
    with mock.patch('google.ai.generativelanguage_v1alpha.services.prediction_service.transports.PredictionServiceTransport.__init__') as Transport:
...
def test_prediction_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1alpha.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_prediction_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1alpha.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PredictionServiceTransport()
        adc.assert_called_once()
...
def test_model_path():
    ...
    actual = PredictionServiceClient.model_path(model)

...
from google.ai.generativelanguage_v1beta.services.retriever_service import RetrieverServiceAsyncClient
from google.ai.generativelanguage_v1beta.services.retriever_service import RetrieverServiceClient
from google.ai.generativelanguage_v1beta.services.retriever_service import pagers
from google.ai.generativelanguage_v1beta.services.retriever_service import transports
...
def test_retriever_service_client_client_options_from_dict():
    with mock.patch('google.ai.generativelanguage_v1beta.services.retriever_service.transports.RetrieverServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_corpus_rest_required_fields(request_type=retriever_service.CreateCorpusRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_corpus._get_unset_required_fields(jsonified_request)
...
def test_create_corpus_rest_unset_required_fields():
    transport = transports.RetrieverServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_corpus_rest_bad_request(transport: str = 'rest', request_type=retriever_service.CreateCorpusRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_corpus_rest_required_fields(request_type=retriever_service.GetCorpusRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_corpus._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_corpus_rest_bad_request(transport: str = 'rest', request_type=retriever_service.GetCorpusRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_corpus_rest_required_fields(request_type=retriever_service.UpdateCorpusRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_corpus._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_corpus_rest_bad_request(transport: str = 'rest', request_type=retriever_service.UpdateCorpusRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_corpus_rest_required_fields(request_type=retriever_service.DeleteCorpusRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_corpus._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_corpus_rest_bad_request(transport: str = 'rest', request_type=retriever_service.DeleteCorpusRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_corpora_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = retriever_service.ListCorporaResponse.to_json(retriever_service.ListCorporaResponse())
...
def test_list_corpora_rest_bad_request(transport: str = 'rest', request_type=retriever_service.ListCorporaRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_query_corpus_rest_required_fields(request_type=retriever_service.QueryCorpusRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).query_corpus._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_query_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = retriever_service.QueryCorpusResponse.to_json(retriever_service.QueryCorpusResponse())
...
def test_query_corpus_rest_bad_request(transport: str = 'rest', request_type=retriever_service.QueryCorpusRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_document_rest_bad_request(transport: str = 'rest', request_type=retriever_service.CreateDocumentRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_document_rest_bad_request(transport: str = 'rest', request_type=retriever_service.GetDocumentRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_document_rest_bad_request(transport: str = 'rest', request_type=retriever_service.UpdateDocumentRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_document_rest_bad_request(transport: str = 'rest', request_type=retriever_service.DeleteDocumentRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = retriever_service.ListDocumentsResponse.to_json(retriever_service.ListDocumentsResponse())
...
def test_list_documents_rest_bad_request(transport: str = 'rest', request_type=retriever_service.ListDocumentsRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_query_document_rest_required_fields(request_type=retriever_service.QueryDocumentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).query_document._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_query_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = retriever_service.QueryDocumentResponse.to_json(retriever_service.QueryDocumentResponse())
...
def test_query_document_rest_bad_request(transport: str = 'rest', request_type=retriever_service.QueryDocumentRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_chunk_rest_required_fields(request_type=retriever_service.CreateChunkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_chunk._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_chunk_rest_bad_request(transport: str = 'rest', request_type=retriever_service.CreateChunkRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_batch_create_chunks_rest_required_fields(request_type=retriever_service.BatchCreateChunksRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_create_chunks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_chunks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = retriever_service.BatchCreateChunksResponse.to_json(retriever_service.BatchCreateChunksResponse())
...
def test_batch_create_chunks_rest_bad_request(transport: str = 'rest', request_type=retriever_service.BatchCreateChunksRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_chunk_rest_required_fields(request_type=retriever_service.GetChunkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_chunk._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_chunk_rest_bad_request(transport: str = 'rest', request_type=retriever_service.GetChunkRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_chunk_rest_required_fields(request_type=retriever_service.UpdateChunkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_chunk._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_chunk_rest_bad_request(transport: str = 'rest', request_type=retriever_service.UpdateChunkRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_batch_update_chunks_rest_required_fields(request_type=retriever_service.BatchUpdateChunksRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_update_chunks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_chunks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = retriever_service.BatchUpdateChunksResponse.to_json(retriever_service.BatchUpdateChunksResponse())
...
def test_batch_update_chunks_rest_bad_request(transport: str = 'rest', request_type=retriever_service.BatchUpdateChunksRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_chunk_rest_required_fields(request_type=retriever_service.DeleteChunkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_chunk._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_chunk_rest_bad_request(transport: str = 'rest', request_type=retriever_service.DeleteChunkRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_batch_delete_chunks_rest_required_fields(request_type=retriever_service.BatchDeleteChunksRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_delete_chunks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_delete_chunks_rest_bad_request(transport: str = 'rest', request_type=retriever_service.BatchDeleteChunksRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_chunks_rest_required_fields(request_type=retriever_service.ListChunksRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_chunks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_chunks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = retriever_service.ListChunksResponse.to_json(retriever_service.ListChunksResponse())
...
def test_list_chunks_rest_bad_request(transport: str = 'rest', request_type=retriever_service.ListChunksRequest):
    client = RetrieverServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_retriever_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1beta.services.retriever_service.transports.RetrieverServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_retriever_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1beta.services.retriever_service.transports.RetrieverServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.RetrieverServiceTransport()
        adc.assert_called_once()

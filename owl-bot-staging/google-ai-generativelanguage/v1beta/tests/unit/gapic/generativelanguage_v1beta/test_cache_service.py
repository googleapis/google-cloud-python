...
def test_create_cached_content_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {}
    request_init["cached_content"] = {'expire_time': {'seconds': 751, 'nanos': 543}, 'ttl': {'seconds': 751, 'nanos': 543}, 'name': 'name_value', 'display_name': 'display_name_value', 'model': 'model_value', 'system_instruction': {'parts': [{'text': 'text_value', 'inline_data': {'mime_type': 'mime_type_value', 'data': b'data_blob'}, 'function_call': {'id': 'id_value', 'name': 'name_value', 'args': {'fields': {}}}, 'function_response': {'id': 'id_value', 'name': 'name_value', 'response': {}, 'will_continue': True, 'scheduling': 1}, 'file_data': {'mime_type': 'mime_type_value', 'file_uri': 'file_uri_value'}, 'executable_code': {'language': 1, 'code': 'code_value'}, 'code_execution_result': {'outcome': 1, 'output': 'output_value'}, 'video_metadata': {'start_offset': {}, 'end_offset': {}, 'fps': 0.329}, 'thought': True, 'thought_signature': b'thought_signature_blob'}], 'role': 'role_value'}, 'contents': {}, 'tools': [{'function_declarations': [{'name': 'name_value', 'description': 'description_value', 'parameters': {'type_': 1, 'format_': 'format__value', 'title': 'title_value', 'description': 'description_value', 'nullable': True, 'enum': ['enum_value1', 'enum_value2'], 'items': {}, 'max_items': 967, 'min_items': 965, 'properties': {}, 'required': ['required_value1', 'required_value2'], 'min_properties': 1520, 'max_properties': 1522, 'minimum': 0.764, 'maximum': 0.766, 'min_length': 1061, 'max_length': 1063, 'pattern': 'pattern_value', 'example': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {}, 'list_value': {'values': {}}}, 'any_of': {}, 'property_ordering': ['property_ordering_value1', 'property_ordering_value2'], 'default': {}}, 'parameters_json_schema': {}, 'response': {}, 'response_json_schema': {}, 'behavior': 1}], 'google_search_retrieval': {'dynamic_retrieval_config': {'mode': 1, 'dynamic_threshold': 0.1809}}, 'code_execution': {}, 'google_search': {'time_range_filter': {'start_time': {}, 'end_time': {}}}, 'url_context': {}}], 'tool_config': {'function_calling_config': {'mode': 1, 'allowed_function_names': ['allowed_function_names_value1', 'allowed_function_names_value2']}}, 'create_time': {}, 'update_time': {}, 'usage_metadata': {'total_token_count': 1836}}

...
from google.ai.generativelanguage_v1beta.services.cache_service import CacheServiceClient
from google.ai.generativelanguage_v1beta.services.cache_service import pagers
from google.ai.generativelanguage_v1beta.services.cache_service import transports
...
def test_list_cached_contents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = cache_service.ListCachedContentsResponse.to_json(cache_service.ListCachedContentsResponse())
...
def test_list_cached_contents_rest_bad_request(transport: str = 'rest', request_type=cache_service.ListCachedContentsRequest):
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_cached_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gag_cached_content.CachedContent.to_json(gag_cached_content.CachedContent())
...
def test_create_cached_content_rest_bad_request(transport: str = 'rest', request_type=cache_service.CreateCachedContentRequest):
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_cached_content_rest_bad_request(transport: str = 'rest', request_type=cache_service.GetCachedContentRequest):
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_cached_content_rest_bad_request(transport: str = 'rest', request_type=cache_service.UpdateCachedContentRequest):
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_cached_content_rest_bad_request(transport: str = 'rest', request_type=cache_service.DeleteCachedContentRequest):
    client = CacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cache_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1beta.services.cache_service.transports.CacheServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cache_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1beta.services.cache_service.transports.CacheServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CacheServiceTransport()
        adc.assert_called_once()

...
from google.ai.generativelanguage_v1beta.services.permission_service import PermissionServiceAsyncClient
from google.ai.generativelanguage_v1beta.services.permission_service import PermissionServiceClient
from google.ai.generativelanguage_v1beta.services.permission_service import pagers
from google.ai.generativelanguage_v1beta.services.permission_service import transports
...
def test_permission_service_client_client_options_from_dict():
    with mock.patch('google.ai.generativelanguage_v1beta.services.permission_service.transports.PermissionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_permission_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta/{parent=tunedModels/*}/permissions" % client.transport._host, args[1])
...
def test_get_permission_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=tunedModels/*/permissions/*}" % client.transport._host, args[1])
...
def test_update_permission_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{permission.name=tunedModels/*/permissions/*}" % client.transport._host, args[1])
...
def test_permission_service_base_transport():
    ...
    with mock.patch('google.ai.generativelanguage_v1beta.services.permission_service.transports.PermissionServiceTransport.__init__') as Transport:
...
def test_permission_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1beta.services.permission_service.transports.PermissionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_permission_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1beta.services.permission_service.transports.PermissionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PermissionServiceTransport()
        adc.assert_called_once()

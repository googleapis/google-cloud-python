...
from google.ai.generativelanguage_v1beta.services.text_service import TextServiceAsyncClient
from google.ai.generativelanguage_v1beta.services.text_service import TextServiceClient
from google.ai.generativelanguage_v1beta.services.text_service import transports
...
def test_text_service_client_client_options_from_dict():
    with mock.patch('google.ai.generativelanguage_v1beta.services.text_service.transports.TextServiceGrpcTransport.__init__') as grpc_transport:
...
def test_batch_embed_text(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_embed_text),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_count_text_tokens(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.count_text_tokens),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_generate_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta/{model=models/*}:generateText" % client.transport._host, args[1])
...
def test_embed_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{model=models/*}:embedText" % client.transport._host, args[1])
...
def test_batch_embed_text_rest_required_fields(request_type=text_service.BatchEmbedTextRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_embed_text._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_embed_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TextServiceRestInterceptor, "post_batch_embed_text") as post, \
         mock.patch.object(transports.TextServiceRestInterceptor, "pre_batch_embed_text") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = text_service.BatchEmbedTextResponse.to_json(text_service.BatchEmbedTextResponse())
        ...
        client.batch_embed_text(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_batch_embed_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{model=models/*}:batchEmbedText" % client.transport._host, args[1])
...
def test_count_text_tokens_rest_required_fields(request_type=text_service.CountTextTokensRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).count_text_tokens._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_count_text_tokens_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TextServiceRestInterceptor, "post_count_text_tokens") as post, \
         mock.patch.object(transports.TextServiceRestInterceptor, "pre_count_text_tokens") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = text_service.CountTextTokensResponse.to_json(text_service.CountTextTokensResponse())
        ...
        client.count_text_tokens(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_count_text_tokens_rest_bad_request(transport: str = 'rest', request_type=text_service.CountTextTokensRequest):
    client = TextServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_count_text_tokens_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{model=models/*}:countTextTokens" % client.transport._host, args[1])
...
def test_text_service_base_transport():
    ...
    with mock.patch('google.ai.generativelanguage_v1beta.services.text_service.transports.TextServiceTransport.__init__') as Transport:
...
def test_text_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1beta.services.text_service.transports.TextServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_text_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1beta.services.text_service.transports.TextServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.TextServiceTransport()
        adc.assert_called_once()

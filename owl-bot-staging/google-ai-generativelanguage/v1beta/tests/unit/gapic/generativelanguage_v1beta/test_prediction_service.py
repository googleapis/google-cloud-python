...
from google.ai.generativelanguage_v1beta.services.prediction_service import PredictionServiceAsyncClient
from google.ai.generativelanguage_v1beta.services.prediction_service import PredictionServiceClient
from google.ai.generativelanguage_v1beta.services.prediction_service import transports
...
def test_prediction_service_client_client_options_from_dict():
    with mock.patch('google.ai.generativelanguage_v1beta.services.prediction_service.transports.PredictionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_predict_long_running(request_type, transport: str = 'grpc'):
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.predict_long_running),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
        response = client.predict_long_running(request)
...
def test_predict_long_running_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.predict_long_running(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == prediction_service.PredictLongRunningRequest(
            model='model_value',
        )

def test_predict_long_running_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = PredictionServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.predict_long_running in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.predict_long_running] = mock_rpc
        request = {}
        client.predict_long_running(request)
...
@pytest.mark.asyncio
async def test_predict_long_running_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PredictionServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.predict_long_running in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.predict_long_running] = mock_rpc

        request = {}
        await client.predict_long_running(request)
...
@pytest.mark.asyncio
async def test_predict_long_running_async(transport: str = 'grpc_asyncio', request_type=prediction_service.PredictLongRunningRequest):
    client = PredictionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.predict_long_running(request)
...
@pytest.mark.asyncio
async def test_predict_long_running_async_from_dict():
    await test_predict_long_running_async(request_type=dict)

def test_predict_long_running_field_headers():
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_predict_long_running_field_headers_async():
    client = PredictionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_predict_long_running_flattened():
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_predict_long_running_flattened_error():
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_predict_long_running_flattened_async():
    client = PredictionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.predict_long_running(
            model='model_value',
            instances=[struct_pb2.Value(null_value=struct_pb2.NullValue.NULL_VALUE)],
        )
...
@pytest.mark.asyncio
async def test_predict_long_running_flattened_error_async():
    client = PredictionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.predict_long_running(
            prediction_service.PredictLongRunningRequest(),
            model='model_value',
            instances=[struct_pb2.Value(null_value=struct_pb2.NullValue.NULL_VALUE)],
        )
...
def test_predict_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta/{model=models/*}:predict" % client.transport._host, args[1])
...
def test_predict_long_running_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = PredictionServiceClient(
...
def test_predict_long_running_rest_required_fields(request_type=prediction_service.PredictLongRunningRequest):
    transport_class = transports.PredictionServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).predict_long_running._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_predict_long_running_rest_unset_required_fields():
    transport = transports.PredictionServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.predict_long_running._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("model", "instances", )))


def test_predict_long_running_rest_flattened():
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.predict_long_running(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{model=models/*}:predictLongRunning" % client.transport._host, args[1])


def test_predict_long_running_rest_flattened_error(transport: str = 'rest'):
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_predict_long_running_empty_call_grpc():
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.predict_long_running(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = prediction_service.PredictLongRunningRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_predict_long_running_empty_call_grpc_asyncio():
    client = PredictionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.predict_long_running(request=None)
...
def test_predict_long_running_rest_bad_request(request_type=prediction_service.PredictLongRunningRequest):
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_predict_long_running_rest_call_success(request_type):
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_predict_long_running_rest_interceptors(null_interceptor):
    transport = transports.PredictionServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.PredictionServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PredictionServiceRestInterceptor, "post_predict_long_running") as post, \
        mock.patch.object(transports.PredictionServiceRestInterceptor, "post_predict_long_running_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PredictionServiceRestInterceptor, "pre_predict_long_running") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = prediction_service.PredictLongRunningRequest.pb(prediction_service.PredictLongRunningRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.predict_long_running(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_predict_long_running_empty_call_rest():
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_prediction_service_rest_lro_client():
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_prediction_service_base_transport():
    ...
    with mock.patch('google.ai.generativelanguage_v1beta.services.prediction_service.transports.PredictionServiceTransport.__init__') as Transport:
...
def test_prediction_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ai.generativelanguage_v1beta.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_prediction_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ai.generativelanguage_v1beta.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PredictionServiceTransport()
        adc.assert_called_once()
...
def test_prediction_service_client_transport_session_collision(transport_name):
    ...
    session1 = client1.transport.predict_long_running._session
    session2 = client2.transport.predict_long_running._session
    assert session1 != session2

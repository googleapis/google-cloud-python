    ...
    class _CancelOperation(_BasePermissionServiceRestTransport._BaseCancelOperation, PermissionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta.PermissionServiceClient.CancelOperation",
                    extra = {
                        "serviceName": "google.ai.generativelanguage.v1beta.PermissionService",
            ...
            # Send the request
            response = PermissionServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BasePermissionServiceRestTransport._BaseDeleteOperation, PermissionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta.PermissionServiceClient.DeleteOperation",
                    extra = {
                        "serviceName": "google.ai.generativelanguage.v1beta.PermissionService",
            ...
            # Send the request
            response = PermissionServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

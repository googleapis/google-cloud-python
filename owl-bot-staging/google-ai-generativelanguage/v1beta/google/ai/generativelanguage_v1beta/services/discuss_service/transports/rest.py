...
class DiscussServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_count_message_tokens_with_metadata(self, response: discuss_service.CountMessageTokensResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[discuss_service.CountMessageTokensResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for count_message_tokens
    ...
    def post_generate_message_with_metadata(self, response: discuss_service.GenerateMessageResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[discuss_service.GenerateMessageResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for generate_message
...
class DiscussServiceRestTransport(_BaseDiscussServiceRestTransport):
    ...
    class _CountMessageTokens(_BaseDiscussServiceRestTransport._BaseCountMessageTokens, DiscussServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DiscussServiceRestTransport._CountMessageTokens._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GenerateMessage(_BaseDiscussServiceRestTransport._BaseGenerateMessage, DiscussServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DiscussServiceRestTransport._GenerateMessage._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def count_message_tokens(self) -> Callable[
    ...
    @property
    def generate_message(self) -> Callable[
    ...
    class _CancelOperation(_BaseDiscussServiceRestTransport._BaseCancelOperation, DiscussServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DiscussServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseDiscussServiceRestTransport._BaseDeleteOperation, DiscussServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DiscussServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseDiscussServiceRestTransport._BaseGetOperation, DiscussServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DiscussServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseDiscussServiceRestTransport._BaseListOperations, DiscussServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DiscussServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
from google.ai.generativelanguage_v1beta.types import retriever_service
from google.longrunning import operations_pb2 # type: ignore
from google.protobuf import field_mask_pb2  # type: ignore
from google.protobuf import timestamp_pb2  # type: ignore
from .transports.base import RetrieverServiceTransport, DEFAULT_CLIENT_INFO
...
class RetrieverServiceClient(metaclass=RetrieverServiceClientMeta):
    ...
    def chunk_path(corpus: str,document: str,chunk: str,) -> str:
        ...
        return "corpora/{corpus}/documents/{document}/chunks/{chunk}".format(corpus=corpus, document=document, chunk=chunk, )

    @staticmethod
    def parse_chunk_path(path: str) -> Dict[str,str]:
        """Parses a chunk path into its component segments."""
        m = re.match(r"^corpora/(?P<corpus>.+?)/documents/(?P<document>.+?)/chunks/(?P<chunk>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def corpus_path(corpus: str,) -> str:
        """Returns a fully-qualified corpus string."""
        return "corpora/{corpus}".format(corpus=corpus, )
    ...
    def document_path(corpus: str,document: str,) -> str:
        ...
        return "corpora/{corpus}/documents/{document}".format(corpus=corpus, document=document, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RetrieverServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            RetrieverServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RetrieverServiceTransport, Callable[..., RetrieverServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RetrieverServiceClient._read_environment_variables()
        self._client_cert_source = RetrieverServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RetrieverServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RetrieverServiceTransport], Callable[..., RetrieverServiceTransport]] = (

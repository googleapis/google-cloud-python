...
class CacheServiceRestTransport(_BaseCacheServiceRestTransport):
    ...
    class _CancelOperation(_BaseCacheServiceRestTransport._BaseCancelOperation, CacheServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CacheServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseCacheServiceRestTransport._BaseDeleteOperation, CacheServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CacheServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
from google.ai.generativelanguage_v1beta.types import model_service
...
class ModelServiceTransport(abc.ABC):
    ...
    @property
    def get_tuned_model(self) -> Callable[
            [model_service.GetTunedModelRequest],
            Union[
                tuned_model.TunedModel,
                Awaitable[tuned_model.TunedModel]
            ]]:
        raise NotImplementedError()

    @property
    def list_tuned_models(self) -> Callable[
    ...
    @property
    def create_tuned_model(self) -> Callable[
    ...
    @property
    def update_tuned_model(self) -> Callable[
    ...
    @property
    def delete_tuned_model(self) -> Callable[

...
class GenerativeServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_embed_contents(self, request: generative_service.BatchEmbedContentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_service.BatchEmbedContentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_batch_embed_contents_with_metadata(self, response: generative_service.BatchEmbedContentsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_service.BatchEmbedContentsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for batch_embed_contents
    ...
    def pre_count_tokens(self, request: generative_service.CountTokensRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_service.CountTokensRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_count_tokens_with_metadata(self, response: generative_service.CountTokensResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_service.CountTokensResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for count_tokens
    ...
    def pre_embed_content(self, request: generative_service.EmbedContentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_service.EmbedContentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_embed_content_with_metadata(self, response: generative_service.EmbedContentResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_service.EmbedContentResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for embed_content
    ...
    def pre_generate_answer(self, request: generative_service.GenerateAnswerRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_service.GenerateAnswerRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_generate_answer_with_metadata(self, response: generative_service.GenerateAnswerResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_service.GenerateAnswerResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for generate_answer
    ...
    def pre_generate_content(self, request: generative_service.GenerateContentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_service.GenerateContentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_generate_content_with_metadata(self, response: generative_service.GenerateContentResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_service.GenerateContentResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for generate_content
    ...
    def pre_stream_generate_content(self, request: generative_service.GenerateContentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_service.GenerateContentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_stream_generate_content_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for stream_generate_content
...
class GenerativeServiceRestTransport(_BaseGenerativeServiceRestTransport):
    ...
    class _BatchEmbedContents(_BaseGenerativeServiceRestTransport._BaseBatchEmbedContents, GenerativeServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenerativeServiceRestTransport._BatchEmbedContents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CountTokens(_BaseGenerativeServiceRestTransport._BaseCountTokens, GenerativeServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenerativeServiceRestTransport._CountTokens._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _EmbedContent(_BaseGenerativeServiceRestTransport._BaseEmbedContent, GenerativeServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenerativeServiceRestTransport._EmbedContent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GenerateAnswer(_BaseGenerativeServiceRestTransport._BaseGenerateAnswer, GenerativeServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenerativeServiceRestTransport._GenerateAnswer._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GenerateContent(_BaseGenerativeServiceRestTransport._BaseGenerateContent, GenerativeServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenerativeServiceRestTransport._GenerateContent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _StreamGenerateContent(_BaseGenerativeServiceRestTransport._BaseStreamGenerateContent, GenerativeServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenerativeServiceRestTransport._StreamGenerateContent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.ai.generativelanguage_v1beta.GenerativeServiceClient.stream_generate_content",
                    extra = {
                        "serviceName": "google.ai.generativelanguage.v1beta.GenerativeService",
                        "rpcName": "StreamGenerateContent",
                        "metadata": http_response["headers"],
    ...
    class _CancelOperation(_BaseGenerativeServiceRestTransport._BaseCancelOperation, GenerativeServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta.GenerativeServiceClient.CancelOperation",
                    extra = {
                        "serviceName": "google.ai.generativelanguage.v1beta.GenerativeService",
            ...
            # Send the request
            response = GenerativeServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseGenerativeServiceRestTransport._BaseDeleteOperation, GenerativeServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta.GenerativeServiceClient.DeleteOperation",
                    extra = {
                        "serviceName": "google.ai.generativelanguage.v1beta.GenerativeService",
            ...
            # Send the request
            response = GenerativeServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseGenerativeServiceRestTransport._BaseGetOperation, GenerativeServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenerativeServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseGenerativeServiceRestTransport._BaseListOperations, GenerativeServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenerativeServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

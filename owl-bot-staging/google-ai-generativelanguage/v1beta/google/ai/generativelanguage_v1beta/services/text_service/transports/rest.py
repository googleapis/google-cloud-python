...
class TextServiceRestTransport(_BaseTextServiceRestTransport):
    ...
    class _CancelOperation(_BaseTextServiceRestTransport._BaseCancelOperation, TextServiceRestStub):
        def __hash__(self):
            return hash("TextServiceRestTransport.CancelOperation")
        ...
        def __call__(self,
            ...
            http_options = _BaseTextServiceRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = self._interceptor.pre_cancel_operation(request, metadata)
            transcoded_request = _BaseTextServiceRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseTextServiceRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta.TextServiceClient.CancelOperation",
                    extra = {
                        "serviceName": "google.ai.generativelanguage.v1beta.TextService",
            ...
            # Send the request
            response = TextServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseTextServiceRestTransport._BaseDeleteOperation, TextServiceRestStub):
        def __hash__(self):
            return hash("TextServiceRestTransport.DeleteOperation")
        ...
        def __call__(self,
            ...
            http_options = _BaseTextServiceRestTransport._BaseDeleteOperation._get_http_options()

            request, metadata = self._interceptor.pre_delete_operation(request, metadata)
            transcoded_request = _BaseTextServiceRestTransport._BaseDeleteOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseTextServiceRestTransport._BaseDeleteOperation._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta.TextServiceClient.DeleteOperation",
                    extra = {
                        "serviceName": "google.ai.generativelanguage.v1beta.TextService",
            ...
            # Send the request
            response = TextServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class _BaseFileServiceRestTransport(FileServiceTransport):
    ...
    class _BaseDownloadFile:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1beta/{name=files/*}:download',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = file_service.DownloadFileRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseFileServiceRestTransport._BaseDownloadFile._get_unset_required_fields(query_params))

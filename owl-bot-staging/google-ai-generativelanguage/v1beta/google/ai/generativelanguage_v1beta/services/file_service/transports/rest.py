...
class FileServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_create_file_with_metadata(self, response: file_service.CreateFileResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[file_service.CreateFileResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_file
    ...
    def pre_download_file(self, request: file_service.DownloadFileRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[file_service.DownloadFileRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_download_file_with_metadata(self, response: file_service.DownloadFileResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[file_service.DownloadFileResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for download_file
    ...
    def post_list_files_with_metadata(self, response: file_service.ListFilesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[file_service.ListFilesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_files
...
class FileServiceRestTransport(_BaseFileServiceRestTransport):
    ...
    class _CreateFile(_BaseFileServiceRestTransport._BaseCreateFile, FileServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FileServiceRestTransport._CreateFile._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteFile(_BaseFileServiceRestTransport._BaseDeleteFile, FileServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FileServiceRestTransport._DeleteFile._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DownloadFile(_BaseFileServiceRestTransport._BaseDownloadFile, FileServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FileServiceRestTransport._DownloadFile._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListFiles(_BaseFileServiceRestTransport._BaseListFiles, FileServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FileServiceRestTransport._ListFiles._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BaseFileServiceRestTransport._BaseCancelOperation, FileServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FileServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseFileServiceRestTransport._BaseDeleteOperation, FileServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FileServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseFileServiceRestTransport._BaseGetOperation, FileServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FileServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseFileServiceRestTransport._BaseListOperations, FileServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FileServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

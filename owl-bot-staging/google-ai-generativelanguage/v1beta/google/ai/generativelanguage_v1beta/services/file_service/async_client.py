...
class FileServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(FileServiceClient).get_transport_class, type(FileServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, FileServiceTransport, Callable[..., FileServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_file(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_file]

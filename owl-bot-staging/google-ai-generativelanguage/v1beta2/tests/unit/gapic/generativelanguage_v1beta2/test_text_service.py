...
def test_generate_text_rest_required_fields(request_type=text_service.GenerateTextRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_text._get_unset_required_fields(jsonified_request)
...
def test_generate_text_rest_unset_required_fields():
    transport = transports.TextServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_embed_text_rest_required_fields(request_type=text_service.EmbedTextRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).embed_text._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

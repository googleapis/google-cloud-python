...
from google.cloud.config_v1.services.config import ConfigAsyncClient
from google.cloud.config_v1.services.config import ConfigClient
...
def test__get_default_mtls_endpoint():
    ...
    assert ConfigClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ConfigClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ConfigClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__get_client_cert_source():
    ...
    assert ConfigClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ConfigClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ConfigClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ConfigClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ConfigClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConfigClient))
@mock.patch.object(ConfigAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConfigAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ConfigClient._DEFAULT_UNIVERSE
    default_endpoint = ConfigClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ConfigClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ConfigClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ConfigClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ConfigClient.DEFAULT_MTLS_ENDPOINT
    assert ConfigClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ConfigClient._get_api_endpoint(None, None, default_universe, "always") == ConfigClient.DEFAULT_MTLS_ENDPOINT
    assert ConfigClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ConfigClient.DEFAULT_MTLS_ENDPOINT
    assert ConfigClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ConfigClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ConfigClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ConfigClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ConfigClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ConfigClient._get_universe_domain(None, None) == ConfigClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (ConfigAsyncClient, transports.ConfigGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ConfigClient, transports.ConfigGrpcTransport, "grpc", "false"),
    (ConfigAsyncClient, transports.ConfigGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_config_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    ConfigClient, ConfigAsyncClient
])
@mock.patch.object(ConfigClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ConfigClient))
@mock.patch.object(ConfigAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ConfigAsyncClient))
...
def test_config_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (ConfigAsyncClient, transports.ConfigGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (ConfigClient, transports.ConfigRestTransport, "rest", None),
])
def test_config_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_config_client_client_options_from_dict():
    with mock.patch('google.cloud.config_v1.services.config.transports.ConfigGrpcTransport.__init__') as grpc_transport:
...
def test_config_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_list_deployments_async(transport: str = 'grpc_asyncio', request_type=config.ListDeploymentsRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config.ListDeploymentsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_deployments_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, config.Deployment)
                   for i in results)
...
@pytest.mark.asyncio
async def test_get_deployment_async(transport: str = 'grpc_asyncio', request_type=config.GetDeploymentRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_deployment_async(transport: str = 'grpc_asyncio', request_type=config.CreateDeploymentRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_deployment_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_deployment(
            parent='parent_value',
            deployment=config.Deployment(terraform_blueprint=config.TerraformBlueprint(gcs_source='gcs_source_value')),
            deployment_id='deployment_id_value',
        )
        ...
        mock_val = config.Deployment(terraform_blueprint=config.TerraformBlueprint(gcs_source='gcs_source_value'))
        assert arg == mock_val
...
@pytest.mark.asyncio
async def test_update_deployment_async(transport: str = 'grpc_asyncio', request_type=config.UpdateDeploymentRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_deployment_async(transport: str = 'grpc_asyncio', request_type=config.DeleteDeploymentRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_revisions_async(transport: str = 'grpc_asyncio', request_type=config.ListRevisionsRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config.ListRevisionsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_revisions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, config.Revision)
                   for i in results)
...
def test_get_revision(request_type, transport: str = 'grpc'):
    ...
    assert response.state_detail == 'state_detail_value'
    assert response.error_code == config.Revision.ErrorCode.CLOUD_BUILD_PERMISSION_DENIED
...
@pytest.mark.asyncio
async def test_get_revision_async(transport: str = 'grpc_asyncio', request_type=config.GetRevisionRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_resource(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_resource),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_resource_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_resource in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_resource] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_resource_async(transport: str = 'grpc_asyncio', request_type=config.GetResourceRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_resources(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_resources),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_resources_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_resources in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_resources] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_resources_async(transport: str = 'grpc_asyncio', request_type=config.ListResourcesRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config.ListResourcesResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_resources_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, config.Resource)
                   for i in results)
...
async def test_list_resources_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_resources(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_export_deployment_statefile(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_deployment_statefile),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_export_deployment_statefile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.export_deployment_statefile in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.export_deployment_statefile] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_export_deployment_statefile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_deployment_statefile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_deployment_statefile] = mock_rpc
...
@pytest.mark.asyncio
async def test_export_deployment_statefile_async(transport: str = 'grpc_asyncio', request_type=config.ExportDeploymentStatefileRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_export_revision_statefile(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_revision_statefile),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = config.Statefile(
            signed_uri='signed_uri_value',
...
def test_export_revision_statefile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.export_revision_statefile in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.export_revision_statefile] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_export_revision_statefile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_revision_statefile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_revision_statefile] = mock_rpc
...
@pytest.mark.asyncio
async def test_export_revision_statefile_async(transport: str = 'grpc_asyncio', request_type=config.ExportRevisionStatefileRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_import_statefile(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_statefile),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = config.Statefile(
            signed_uri='signed_uri_value',
...
def test_import_statefile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_statefile] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_import_statefile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_statefile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_statefile] = mock_rpc
...
@pytest.mark.asyncio
async def test_import_statefile_async(transport: str = 'grpc_asyncio', request_type=config.ImportStatefileRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_statefile(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_statefile),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_delete_statefile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_statefile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_statefile] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_statefile_async(transport: str = 'grpc_asyncio', request_type=config.DeleteStatefileRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_lock_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.lock_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_lock_deployment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.lock_deployment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.lock_deployment] = mock_rpc
...
@pytest.mark.asyncio
async def test_lock_deployment_async(transport: str = 'grpc_asyncio', request_type=config.LockDeploymentRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_unlock_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.unlock_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_unlock_deployment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.unlock_deployment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.unlock_deployment] = mock_rpc
...
@pytest.mark.asyncio
async def test_unlock_deployment_async(transport: str = 'grpc_asyncio', request_type=config.UnlockDeploymentRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_export_lock_info(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_lock_info),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_export_lock_info_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_lock_info in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_lock_info] = mock_rpc
...
@pytest.mark.asyncio
async def test_export_lock_info_async(transport: str = 'grpc_asyncio', request_type=config.ExportLockInfoRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_preview(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_preview),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_preview_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_preview in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_preview] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_preview_async(transport: str = 'grpc_asyncio', request_type=config.CreatePreviewRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_preview_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_preview(
            parent='parent_value',
            preview=config.Preview(terraform_blueprint=config.TerraformBlueprint(gcs_source='gcs_source_value')),
        )
        ...
        assert arg == mock_val
        arg = args[0].preview
        mock_val = config.Preview(terraform_blueprint=config.TerraformBlueprint(gcs_source='gcs_source_value'))
        assert arg == mock_val
...
def test_get_preview(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_preview),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_preview_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_preview in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_preview] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_preview_async(transport: str = 'grpc_asyncio', request_type=config.GetPreviewRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_previews(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_previews),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_previews_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_previews in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_previews] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_previews_async(transport: str = 'grpc_asyncio', request_type=config.ListPreviewsRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config.ListPreviewsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_previews_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, config.Preview)
                   for i in results)
...
async def test_list_previews_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_previews(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_delete_preview(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_preview),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_preview_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_preview in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_preview] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_preview_async(transport: str = 'grpc_asyncio', request_type=config.DeletePreviewRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_export_preview_result(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_preview_result),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_export_preview_result_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.export_preview_result in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.export_preview_result] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_export_preview_result_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_preview_result in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_preview_result] = mock_rpc
...
@pytest.mark.asyncio
async def test_export_preview_result_async(transport: str = 'grpc_asyncio', request_type=config.ExportPreviewResultRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config.ExportPreviewResultResponse(
        ))
...
def test_list_terraform_versions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_terraform_versions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_terraform_versions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_terraform_versions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_terraform_versions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_terraform_versions] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_terraform_versions_async(transport: str = 'grpc_asyncio', request_type=config.ListTerraformVersionsRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config.ListTerraformVersionsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_terraform_versions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, config.TerraformVersion)
                   for i in results)
...
async def test_list_terraform_versions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_terraform_versions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_terraform_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_terraform_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_terraform_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_terraform_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_terraform_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_terraform_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_terraform_version in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_terraform_version] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_terraform_version_async(transport: str = 'grpc_asyncio', request_type=config.GetTerraformVersionRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config.TerraformVersion(
            name='name_value',
            state=config.TerraformVersion.State.ACTIVE,
        ))
...
def test_list_resource_changes_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_resource_changes in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_resource_changes] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_resource_changes_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_resource_changes in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_resource_changes] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_resource_changes_async(transport: str = 'grpc_asyncio', request_type=config.ListResourceChangesRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config.ListResourceChangesResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_resource_changes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, config.ResourceChange)
                   for i in results)
...
async def test_list_resource_changes_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_resource_changes(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_resource_change(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_resource_change),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_resource_change_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_resource_change in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_resource_change] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_resource_change_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_resource_change in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_resource_change] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_resource_change_async(transport: str = 'grpc_asyncio', request_type=config.GetResourceChangeRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config.ResourceChange(
            name='name_value',
            intent=config.ResourceChange.Intent.CREATE,
        ))
...
def test_list_resource_drifts_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_resource_drifts in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_resource_drifts] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_resource_drifts_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_resource_drifts in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_resource_drifts] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_resource_drifts_async(transport: str = 'grpc_asyncio', request_type=config.ListResourceDriftsRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config.ListResourceDriftsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_resource_drifts_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, config.ResourceDrift)
                   for i in results)
...
async def test_list_resource_drifts_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_resource_drifts(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_resource_drift(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_resource_drift),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_resource_drift_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_resource_drift in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_resource_drift] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_resource_drift_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_resource_drift in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_resource_drift] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_resource_drift_async(transport: str = 'grpc_asyncio', request_type=config.GetResourceDriftRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(config.ResourceDrift(
            name='name_value',
        ))
...
def test_list_deployments_rest_required_fields(request_type=config.ListDeploymentsRequest):
...
def test_list_deployments_rest_unset_required_fields():
    transport = transports.ConfigRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_create_deployment_rest_required_fields(request_type=config.CreateDeploymentRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_deployment._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("deployment_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_deployment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("deploymentId", "requestId", )) & set(("parent", "deploymentId", "deployment", )))
...
def test_update_deployment_rest_required_fields(request_type=config.UpdateDeploymentRequest):
    transport_class = transports.ConfigRestTransport
...
def test_update_deployment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("deployment", )))
...
def test_delete_deployment_rest_required_fields(request_type=config.DeleteDeploymentRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_deployment._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("delete_policy", "force", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_delete_deployment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("deletePolicy", "force", "requestId", )) & set(("name", )))
...
def test_list_revisions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/deployments/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/deployments/*}/revisions" % client.transport._host, args[1])
...
def test_get_revision_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/deployments/sample3/revisions/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/deployments/*/revisions/*}" % client.transport._host, args[1])
...
def test_get_resource_rest_required_fields(request_type=config.GetResourceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_resource._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/deployments/sample3/revisions/sample4/resources/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/deployments/*/revisions/*/resources/*}" % client.transport._host, args[1])
...
def test_list_resources_rest_required_fields(request_type=config.ListResourcesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_resources._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_resources_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/deployments/sample3/revisions/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/deployments/*/revisions/*}/resources" % client.transport._host, args[1])
...
def test_export_deployment_statefile_rest_required_fields(request_type=config.ExportDeploymentStatefileRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_deployment_statefile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_revision_statefile_rest_required_fields(request_type=config.ExportRevisionStatefileRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_revision_statefile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_statefile_rest_required_fields(request_type=config.ImportStatefileRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_statefile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_statefile_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "lockId", )))
...
def test_import_statefile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/deployments/*}:importState" % client.transport._host, args[1])
...
def test_delete_statefile_rest_required_fields(request_type=config.DeleteStatefileRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_statefile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_statefile_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "lockId", )))
...
def test_delete_statefile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/deployments/*}:deleteState" % client.transport._host, args[1])
...
def test_lock_deployment_rest_required_fields(request_type=config.LockDeploymentRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).lock_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_lock_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/deployments/*}:lock" % client.transport._host, args[1])
...
def test_unlock_deployment_rest_required_fields(request_type=config.UnlockDeploymentRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).unlock_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_unlock_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/deployments/*}:unlock" % client.transport._host, args[1])
...
def test_export_lock_info_rest_required_fields(request_type=config.ExportLockInfoRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_lock_info._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_lock_info_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/deployments/*}:exportLock" % client.transport._host, args[1])
...
def test_create_preview_rest_required_fields(request_type=config.CreatePreviewRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_preview._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_preview._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("preview_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_preview_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("previewId", "requestId", )) & set(("parent", "preview", )))
...
def test_create_preview_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/previews" % client.transport._host, args[1])
...
def test_get_preview_rest_required_fields(request_type=config.GetPreviewRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_preview._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_preview_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/previews/*}" % client.transport._host, args[1])
...
def test_list_previews_rest_required_fields(request_type=config.ListPreviewsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_previews._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_preview_rest_required_fields(request_type=config.DeletePreviewRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_preview._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_preview_result_rest_required_fields(request_type=config.ExportPreviewResultRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_preview_result._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_terraform_versions_rest_required_fields(request_type=config.ListTerraformVersionsRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_terraform_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_terraform_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/terraformVersions" % client.transport._host, args[1])
...
def test_list_terraform_versions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(config.ListTerraformVersionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_terraform_version_rest_required_fields(request_type=config.GetTerraformVersionRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_terraform_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_terraform_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/terraformVersions/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/terraformVersions/*}" % client.transport._host, args[1])
...
def test_list_resource_changes_rest_required_fields(request_type=config.ListResourceChangesRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_resource_changes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_resource_changes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/previews/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/previews/*}/resourceChanges" % client.transport._host, args[1])
...
def test_list_resource_changes_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(config.ListResourceChangesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_resource_change_rest_required_fields(request_type=config.GetResourceChangeRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_resource_change._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_resource_change_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/previews/sample3/resourceChanges/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/previews/*/resourceChanges/*}" % client.transport._host, args[1])
...
def test_list_resource_drifts_rest_required_fields(request_type=config.ListResourceDriftsRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_resource_drifts._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_resource_drifts_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/previews/*}/resourceDrifts" % client.transport._host, args[1])
...
def test_get_resource_drift_rest_required_fields(request_type=config.GetResourceDriftRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_resource_drift._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_resource_drift_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/previews/sample3/resourceDrifts/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/previews/*/resourceDrifts/*}" % client.transport._host, args[1])
...
def test_list_deployments_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.ListDeploymentsRequest()
...
def test_get_deployment_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.GetDeploymentRequest()
...
def test_create_deployment_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.CreateDeploymentRequest()
...
def test_update_deployment_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.UpdateDeploymentRequest()
...
def test_delete_deployment_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.DeleteDeploymentRequest()
...
def test_list_revisions_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.ListRevisionsRequest()
...
def test_get_revision_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.GetRevisionRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_resource_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = config.Resource()
        client.get_resource(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.GetResourceRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_resources_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = config.ListResourcesResponse()
        client.list_resources(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.ListResourcesRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_deployment_statefile_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = config.Statefile()
        client.export_deployment_statefile(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.ExportDeploymentStatefileRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_revision_statefile_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = config.Statefile()
        client.export_revision_statefile(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.ExportRevisionStatefileRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_statefile_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = config.Statefile()
        client.import_statefile(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.ImportStatefileRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_statefile_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_statefile(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.DeleteStatefileRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_lock_deployment_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.lock_deployment(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.LockDeploymentRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_unlock_deployment_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.unlock_deployment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_lock_info_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = config.LockInfo()
        client.export_lock_info(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.ExportLockInfoRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_preview_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_preview(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.CreatePreviewRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_preview_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = config.Preview()
        client.get_preview(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.GetPreviewRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_previews_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = config.ListPreviewsResponse()
        client.list_previews(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.ListPreviewsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_preview_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_preview(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.DeletePreviewRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_preview_result_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = config.ExportPreviewResultResponse()
        client.export_preview_result(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = config.ExportPreviewResultRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_terraform_versions_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = config.ListTerraformVersionsResponse()
        client.list_terraform_versions(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_terraform_version_empty_call_grpc():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = config.TerraformVersion()
        client.get_terraform_version(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_resource_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_resource(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_resources_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_resources(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_export_deployment_statefile_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.export_deployment_statefile(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_export_revision_statefile_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.export_revision_statefile(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_import_statefile_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.import_statefile(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_statefile_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_statefile(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_lock_deployment_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.lock_deployment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_unlock_deployment_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.unlock_deployment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_export_lock_info_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.export_lock_info(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_preview_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_preview(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_preview_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_preview(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_previews_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_previews(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_preview_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_preview(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_export_preview_result_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.export_preview_result(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_terraform_versions_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_terraform_versions(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_terraform_version_empty_call_grpc_asyncio():
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_terraform_version(request=None)
...
def test_list_deployments_rest_bad_request(request_type=config.ListDeploymentsRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_deployments") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_deployments_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_list_deployments") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.ListDeploymentsResponse.to_json(config.ListDeploymentsResponse())
        ...
        post_with_metadata.return_value = config.ListDeploymentsResponse(), metadata
...
def test_get_deployment_rest_bad_request(request_type=config.GetDeploymentRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_deployment") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_deployment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_get_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.Deployment.to_json(config.Deployment())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.Deployment(), metadata
...
def test_create_deployment_rest_bad_request(request_type=config.CreateDeploymentRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ConfigRestInterceptor, "post_create_deployment") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_create_deployment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_create_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_deployment_rest_bad_request(request_type=config.UpdateDeploymentRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigRestInterceptor, "post_update_deployment") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_update_deployment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_update_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_deployment_rest_bad_request(request_type=config.DeleteDeploymentRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigRestInterceptor, "post_delete_deployment") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_delete_deployment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_delete_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_revisions_rest_bad_request(request_type=config.ListRevisionsRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_revisions") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_revisions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_list_revisions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.ListRevisionsResponse.to_json(config.ListRevisionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.ListRevisionsResponse(), metadata
...
def test_get_revision_rest_bad_request(request_type=config.GetRevisionRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/deployments/sample3/revisions/sample4'}
    request = request_type(**request_init)
...
def test_get_revision_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_revision") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_revision_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_get_revision") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.Revision.to_json(config.Revision())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.Revision(), metadata
...
def test_get_resource_rest_bad_request(request_type=config.GetResourceRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/deployments/sample3/revisions/sample4/resources/sample5'}
    request = request_type(**request_init)
...
def test_get_resource_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_resource_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_resource") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_resource_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_get_resource") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.Resource.to_json(config.Resource())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.Resource(), metadata

        client.get_resource(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_resources_rest_bad_request(request_type=config.ListResourcesRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/deployments/sample3/revisions/sample4'}
    request = request_type(**request_init)
...
def test_list_resources_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_resources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_resources") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_resources_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_list_resources") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.ListResourcesResponse.to_json(config.ListResourcesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.ListResourcesResponse(), metadata

        client.list_resources(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_deployment_statefile_rest_bad_request(request_type=config.ExportDeploymentStatefileRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_deployment_statefile_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_deployment_statefile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_export_deployment_statefile") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_export_deployment_statefile_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_export_deployment_statefile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config.ExportDeploymentStatefileRequest.pb(config.ExportDeploymentStatefileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.Statefile.to_json(config.Statefile())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.Statefile(), metadata

        client.export_deployment_statefile(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_revision_statefile_rest_bad_request(request_type=config.ExportRevisionStatefileRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_revision_statefile_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_revision_statefile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_export_revision_statefile") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_export_revision_statefile_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_export_revision_statefile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config.ExportRevisionStatefileRequest.pb(config.ExportRevisionStatefileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.export_revision_statefile(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_import_statefile_rest_bad_request(request_type=config.ImportStatefileRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_import_statefile_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_import_statefile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_import_statefile") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_import_statefile_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_import_statefile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.import_statefile(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_statefile_rest_bad_request(request_type=config.DeleteStatefileRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_statefile_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_statefile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_delete_statefile") as pre:
        pre.assert_not_called()
        ...
        client.delete_statefile(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_lock_deployment_rest_bad_request(request_type=config.LockDeploymentRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_lock_deployment_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_lock_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigRestInterceptor, "post_lock_deployment") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_lock_deployment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_lock_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.lock_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_unlock_deployment_rest_bad_request(request_type=config.UnlockDeploymentRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_unlock_deployment_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_unlock_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigRestInterceptor, "post_unlock_deployment") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_unlock_deployment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_unlock_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.unlock_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_lock_info_rest_bad_request(request_type=config.ExportLockInfoRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_lock_info_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_lock_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_export_lock_info") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_export_lock_info_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_export_lock_info") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.LockInfo.to_json(config.LockInfo())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.LockInfo(), metadata

        client.export_lock_info(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_preview_rest_bad_request(request_type=config.CreatePreviewRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_preview_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_preview_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigRestInterceptor, "post_create_preview") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_create_preview_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_create_preview") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_preview(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_preview_rest_bad_request(request_type=config.GetPreviewRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_preview_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_preview_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_preview") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_preview_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_get_preview") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.Preview.to_json(config.Preview())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.Preview(), metadata

        client.get_preview(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_previews_rest_bad_request(request_type=config.ListPreviewsRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_previews_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_previews_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_previews") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_previews_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_list_previews") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.ListPreviewsResponse.to_json(config.ListPreviewsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.ListPreviewsResponse(), metadata

        client.list_previews(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_preview_rest_bad_request(request_type=config.DeletePreviewRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_preview_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_preview_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ConfigRestInterceptor, "post_delete_preview") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_delete_preview_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_delete_preview") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_preview(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_preview_result_rest_bad_request(request_type=config.ExportPreviewResultRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_preview_result_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_preview_result_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_export_preview_result") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_export_preview_result_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_export_preview_result") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config.ExportPreviewResultRequest.pb(config.ExportPreviewResultRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.ExportPreviewResultResponse.to_json(config.ExportPreviewResultResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.ExportPreviewResultResponse(), metadata

        client.export_preview_result(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_terraform_versions_rest_bad_request(request_type=config.ListTerraformVersionsRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_terraform_versions_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_terraform_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_terraform_versions") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_terraform_versions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_list_terraform_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config.ListTerraformVersionsRequest.pb(config.ListTerraformVersionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.ListTerraformVersionsResponse.to_json(config.ListTerraformVersionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.ListTerraformVersionsResponse(), metadata

        client.list_terraform_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_terraform_version_rest_bad_request(request_type=config.GetTerraformVersionRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/terraformVersions/sample3'}
    request = request_type(**request_init)
...
def test_get_terraform_version_rest_call_success(request_type):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_terraform_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_terraform_version") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_terraform_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_get_terraform_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config.GetTerraformVersionRequest.pb(config.GetTerraformVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.TerraformVersion.to_json(config.TerraformVersion())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = config.TerraformVersion(), metadata

        client.get_terraform_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_resource_changes_rest_bad_request(request_type=config.ListResourceChangesRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_resource_changes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_resource_changes") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_resource_changes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_list_resource_changes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config.ListResourceChangesRequest.pb(config.ListResourceChangesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.ListResourceChangesResponse.to_json(config.ListResourceChangesResponse())
        req.return_value.content = return_value
        ...
        client.list_resource_changes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_resource_change_rest_bad_request(request_type=config.GetResourceChangeRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/previews/sample3/resourceChanges/sample4'}
    request = request_type(**request_init)
...
def test_get_resource_change_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_resource_change") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_resource_change_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_get_resource_change") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config.GetResourceChangeRequest.pb(config.GetResourceChangeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_resource_change(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_resource_drifts_rest_bad_request(request_type=config.ListResourceDriftsRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_resource_drifts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_resource_drifts") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_list_resource_drifts_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_list_resource_drifts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config.ListResourceDriftsRequest.pb(config.ListResourceDriftsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.ListResourceDriftsResponse.to_json(config.ListResourceDriftsResponse())
        req.return_value.content = return_value
        ...
        client.list_resource_drifts(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_resource_drift_rest_bad_request(request_type=config.GetResourceDriftRequest):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/previews/sample3/resourceDrifts/sample4'}
    request = request_type(**request_init)
...
def test_get_resource_drift_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_resource_drift") as post, \
        mock.patch.object(transports.ConfigRestInterceptor, "post_get_resource_drift_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ConfigRestInterceptor, "pre_get_resource_drift") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_resource_drift(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_iam_policy_rest_bad_request(request_type=iam_policy_pb2.GetIamPolicyRequest):
    ...
    request = request_type()
    request = json_format.ParseDict({'resource': 'projects/sample1/locations/sample2/deployments/sample3'}, request)
...
def test_get_iam_policy_rest(request_type):
    ...
    request_init = {'resource': 'projects/sample1/locations/sample2/deployments/sample3'}
    request = request_type(**request_init)
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # Designate an appropriate value for the returned response.
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_resource_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_resources_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_deployment_statefile_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_revision_statefile_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_statefile_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_statefile_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_lock_deployment_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_unlock_deployment_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_lock_info_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_preview_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_preview_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_preview_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_preview_result_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_terraform_versions_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_terraform_version_empty_call_rest():
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_config_base_transport():
    ...
    with mock.patch('google.cloud.config_v1.services.config.transports.ConfigTransport.__init__') as Transport:
...
def test_config_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.config_v1.services.config.transports.ConfigTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_config_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.config_v1.services.config.transports.ConfigTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ConfigTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.ConfigGrpcTransport, transports.ConfigGrpcAsyncIOTransport])
def test_config_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_config_host_no_port(transport_name):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='config.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'config.googleapis.com:443'
...
def test_config_host_with_port(transport_name):
    client = ConfigClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='config.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
@pytest.mark.parametrize("transport_class", [transports.ConfigGrpcTransport, transports.ConfigGrpcAsyncIOTransport])
def test_config_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
def test_preview_path():
    ...
    location = "mussel"
    preview = "winkle"
    expected = "projects/{project}/locations/{location}/previews/{preview}".format(project=project, location=location, preview=preview, )
...
def test_resource_path():
    ...
    revision = "octopus"
    resource = "oyster"
    expected = "projects/{project}/locations/{location}/deployments/{deployment}/revisions/{revision}/resources/{resource}".format(project=project, location=location, deployment=deployment, revision=revision, resource=resource, )
    actual = ConfigClient.resource_path(project, location, deployment, revision, resource)
    assert expected == actual
...
def test_resource_change_path():
    ...
    expected = "projects/{project}/locations/{location}/previews/{preview}/resourceChanges/{resource_change}".format(project=project, location=location, preview=preview, resource_change=resource_change, )
    actual = ConfigClient.resource_change_path(project, location, preview, resource_change)
    assert expected == actual
...
def test_resource_drift_path():
    ...
    expected = "projects/{project}/locations/{location}/previews/{preview}/resourceDrifts/{resource_drift}".format(project=project, location=location, preview=preview, resource_drift=resource_drift, )
    actual = ConfigClient.resource_drift_path(project, location, preview, resource_drift)
    assert expected == actual
...
def test_revision_path():
    ...
    deployment = "oyster"
    revision = "nudibranch"
    expected = "projects/{project}/locations/{location}/deployments/{deployment}/revisions/{revision}".format(project=project, location=location, deployment=deployment, revision=revision, )
...
def test_terraform_version_path():
    ...
    expected = "projects/{project}/locations/{location}/terraformVersions/{terraform_version}".format(project=project, location=location, terraform_version=terraform_version, )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.ConfigTransport, '_prep_wrapped_messages') as prep:
        client = ConfigClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
from google.cloud.config_v1.types.config import GetResourceChangeRequest
from google.cloud.config_v1.types.config import GetResourceDriftRequest
...
from google.cloud.config_v1.types.config import ListResourceChangesRequest
from google.cloud.config_v1.types.config import ListResourceChangesResponse
from google.cloud.config_v1.types.config import ListResourceDriftsRequest
from google.cloud.config_v1.types.config import ListResourceDriftsResponse
...
from google.cloud.config_v1.types.config import PropertyChange
from google.cloud.config_v1.types.config import PropertyDrift
from google.cloud.config_v1.types.config import ProviderConfig
from google.cloud.config_v1.types.config import Resource
from google.cloud.config_v1.types.config import ResourceCAIInfo
from google.cloud.config_v1.types.config import ResourceChange
from google.cloud.config_v1.types.config import ResourceChangeTerraformInfo
from google.cloud.config_v1.types.config import ResourceDrift
from google.cloud.config_v1.types.config import ResourceDriftTerraformInfo

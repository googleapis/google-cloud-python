...
class ConfigAsyncClient:
    ...
    async def export_deployment_statefile(self,
    ...
    async def export_revision_statefile(self,
    ...
    async def import_statefile(self,
    ...
    async def delete_statefile(self,
    ...
    async def lock_deployment(self,
    ...
    async def unlock_deployment(self,
    ...
    async def export_lock_info(self,
    ...
    async def export_preview_result(self,
    ...
    async def list_terraform_versions(self,
    ...
    async def get_terraform_version(self,
    ...
    async def list_resource_changes(self,
    ...
    async def get_resource_change(self,
    ...
    async def list_resource_drifts(self,
    ...
    async def get_resource_drift(self,

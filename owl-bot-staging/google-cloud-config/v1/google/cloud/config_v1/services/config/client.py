...
class ConfigClient(metaclass=ConfigClientMeta):
    ...
    @staticmethod
    def preview_path(project: str,location: str,preview: str,) -> str:
        """Returns a fully-qualified preview string."""
        return "projects/{project}/locations/{location}/previews/{preview}".format(project=project, location=location, preview=preview, )
    ...
    @staticmethod
    def resource_path(project: str,location: str,deployment: str,revision: str,resource: str,) -> str:
        """Returns a fully-qualified resource string."""
        return "projects/{project}/locations/{location}/deployments/{deployment}/revisions/{revision}/resources/{resource}".format(project=project, location=location, deployment=deployment, revision=revision, resource=resource, )

    @staticmethod
    def parse_resource_path(path: str) -> Dict[str,str]:
        """Parses a resource path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/deployments/(?P<deployment>.+?)/revisions/(?P<revision>.+?)/resources/(?P<resource>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def resource_change_path(project: str,location: str,preview: str,resource_change: str,) -> str:
        """Returns a fully-qualified resource_change string."""
        return "projects/{project}/locations/{location}/previews/{preview}/resourceChanges/{resource_change}".format(project=project, location=location, preview=preview, resource_change=resource_change, )

    @staticmethod
    def parse_resource_change_path(path: str) -> Dict[str,str]:
        """Parses a resource_change path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/previews/(?P<preview>.+?)/resourceChanges/(?P<resource_change>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def resource_drift_path(project: str,location: str,preview: str,resource_drift: str,) -> str:
        """Returns a fully-qualified resource_drift string."""
        return "projects/{project}/locations/{location}/previews/{preview}/resourceDrifts/{resource_drift}".format(project=project, location=location, preview=preview, resource_drift=resource_drift, )

    @staticmethod
    def parse_resource_drift_path(path: str) -> Dict[str,str]:
        """Parses a resource_drift path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/previews/(?P<preview>.+?)/resourceDrifts/(?P<resource_drift>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def revision_path(project: str,location: str,deployment: str,revision: str,) -> str:
        """Returns a fully-qualified revision string."""
        return "projects/{project}/locations/{location}/deployments/{deployment}/revisions/{revision}".format(project=project, location=location, deployment=deployment, revision=revision, )
    ...
    @staticmethod
    def terraform_version_path(project: str,location: str,terraform_version: str,) -> str:
        """Returns a fully-qualified terraform_version string."""
        return "projects/{project}/locations/{location}/terraformVersions/{terraform_version}".format(project=project, location=location, terraform_version=terraform_version, )
    ...
    def export_deployment_statefile(self,
    ...
    def export_revision_statefile(self,
    ...
    def export_preview_result(self,
    ...
    def list_terraform_versions(self,
    ...
    def list_resource_changes(self,

...
class ConfigGrpcAsyncIOTransport(ConfigTransport):
    ...
    def list_deployments(self) -> Callable[
            ...
            Awaitable[config.ListDeploymentsResponse]]:
    ...
    def list_revisions(self) -> Callable[
            ...
            Awaitable[config.ListRevisionsResponse]]:
    ...
    def list_resources(self) -> Callable[
            ...
            Awaitable[config.ListResourcesResponse]]:
    ...
    @property
    def export_deployment_statefile(self) -> Callable[
            [config.ExportDeploymentStatefileRequest],
            Awaitable[config.Statefile]]:
    ...
    @property
    def export_revision_statefile(self) -> Callable[
    ...
    @property
    def import_statefile(self) -> Callable[
    ...
    @property
    def delete_statefile(self) -> Callable[
    ...
    @property
    def lock_deployment(self) -> Callable[
    ...
    @property
    def unlock_deployment(self) -> Callable[
    ...
    @property
    def export_lock_info(self) -> Callable[
            [config.ExportLockInfoRequest],
            Awaitable[config.LockInfo]]:
    ...
    @property
    def create_preview(self) -> Callable[
    ...
    @property
    def get_preview(self) -> Callable[
            [config.GetPreviewRequest],
            Awaitable[config.Preview]]:
    ...
    @property
    def list_previews(self) -> Callable[
            [config.ListPreviewsRequest],
            Awaitable[config.ListPreviewsResponse]]:
    ...
    @property
    def delete_preview(self) -> Callable[
    ...
    @property
    def export_preview_result(self) -> Callable[
    ...
    @property
    def list_terraform_versions(self) -> Callable[
    ...
    @property
    def get_terraform_version(self) -> Callable[
            [config.GetTerraformVersionRequest],
            Awaitable[config.TerraformVersion]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.list_revisions: gapic_v1.method_async.wrap_method(
                self.list_revisions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_revision: gapic_v1.method_async.wrap_method(
                self.get_revision,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_resource: gapic_v1.method_async.wrap_method(
                self.get_resource,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_resources: gapic_v1.method_async.wrap_method(
                self.list_resources,
                default_timeout=None,
                client_info=client_info,
            ),
            self.export_deployment_statefile: gapic_v1.method_async.wrap_method(
                self.export_deployment_statefile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.export_revision_statefile: gapic_v1.method_async.wrap_method(
                self.export_revision_statefile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.import_statefile: gapic_v1.method_async.wrap_method(
                self.import_statefile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_statefile: gapic_v1.method_async.wrap_method(
                self.delete_statefile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.lock_deployment: gapic_v1.method_async.wrap_method(
                self.lock_deployment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.unlock_deployment: gapic_v1.method_async.wrap_method(
                self.unlock_deployment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.export_lock_info: gapic_v1.method_async.wrap_method(
                self.export_lock_info,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_preview: gapic_v1.method_async.wrap_method(
                self.create_preview,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_preview: gapic_v1.method_async.wrap_method(
                self.get_preview,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_previews: gapic_v1.method_async.wrap_method(
                self.list_previews,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_preview: gapic_v1.method_async.wrap_method(
                self.delete_preview,
                default_timeout=None,
                client_info=client_info,
            ),
            self.export_preview_result: gapic_v1.method_async.wrap_method(
                self.export_preview_result,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_terraform_versions: gapic_v1.method_async.wrap_method(
                self.list_terraform_versions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_terraform_version: gapic_v1.method_async.wrap_method(

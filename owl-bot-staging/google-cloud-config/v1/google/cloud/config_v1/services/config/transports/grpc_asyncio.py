...
class ConfigGrpcAsyncIOTransport(ConfigTransport):
    ...
    @property
    def list_resource_changes(self) -> Callable[
    ...
    @property
    def get_resource_change(self) -> Callable[
            [config.GetResourceChangeRequest],
            Awaitable[config.ResourceChange]]:
    ...
    @property
    def list_resource_drifts(self) -> Callable[
    ...
    @property
    def get_resource_drift(self) -> Callable[
            [config.GetResourceDriftRequest],
            Awaitable[config.ResourceDrift]]:

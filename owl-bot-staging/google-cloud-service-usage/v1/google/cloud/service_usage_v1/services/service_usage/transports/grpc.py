...
class ServiceUsageGrpcTransport(ServiceUsageTransport):
    ...
    def enable_service(self) -> Callable[
        ...
        if 'enable_service' not in self._stubs:
            self._stubs['enable_service'] = self._logged_channel.unary_unary(
    ...
    def disable_service(self) -> Callable[
        ...
        if 'disable_service' not in self._stubs:
            self._stubs['disable_service'] = self._logged_channel.unary_unary(
    ...
    def batch_enable_services(self) -> Callable[
        ...
        if 'batch_enable_services' not in self._stubs:
            self._stubs['batch_enable_services'] = self._logged_channel.unary_unary(
    ...
    def batch_get_services(self) -> Callable[
        ...
        if 'batch_get_services' not in self._stubs:
            self._stubs['batch_get_services'] = self._logged_channel.unary_unary(

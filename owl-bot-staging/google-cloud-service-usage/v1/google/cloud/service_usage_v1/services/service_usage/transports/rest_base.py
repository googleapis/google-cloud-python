...
class _BaseServiceUsageRestTransport(ServiceUsageTransport):
    """Base REST backend transport for ServiceUsage.
    ...
    class _BaseBatchEnableServices:
...
__all__=(
    '_BaseServiceUsageRestTransport',
)

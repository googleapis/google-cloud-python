...
class TemplatesServiceGrpcAsyncIOTransport(TemplatesServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_job_from_template: gapic_v1.method_async.wrap_method(
                self.create_job_from_template,
                default_timeout=None,
                client_info=client_info,
            ),
            self.launch_template: gapic_v1.method_async.wrap_method(
                self.launch_template,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_template: gapic_v1.method_async.wrap_method(
                self.get_template,
                default_timeout=None,
                client_info=client_info,
            ),

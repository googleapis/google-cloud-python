...
class TemplatesServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_job_from_template(self, request: templates.CreateJobFromTemplateRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[templates.CreateJobFromTemplateRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_job_from_template_with_metadata(self, response: jobs.Job, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.Job, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_job_from_template
    ...
    def pre_get_template(self, request: templates.GetTemplateRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[templates.GetTemplateRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_template_with_metadata(self, response: templates.GetTemplateResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[templates.GetTemplateResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_template
    ...
    def pre_launch_template(self, request: templates.LaunchTemplateRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[templates.LaunchTemplateRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_launch_template_with_metadata(self, response: templates.LaunchTemplateResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[templates.LaunchTemplateResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for launch_template
...
class TemplatesServiceRestTransport(_BaseTemplatesServiceRestTransport):
    ...
    class _CreateJobFromTemplate(_BaseTemplatesServiceRestTransport._BaseCreateJobFromTemplate, TemplatesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TemplatesServiceRestTransport._CreateJobFromTemplate._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetTemplate(_BaseTemplatesServiceRestTransport._BaseGetTemplate, TemplatesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TemplatesServiceRestTransport._GetTemplate._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _LaunchTemplate(_BaseTemplatesServiceRestTransport._BaseLaunchTemplate, TemplatesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TemplatesServiceRestTransport._LaunchTemplate._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

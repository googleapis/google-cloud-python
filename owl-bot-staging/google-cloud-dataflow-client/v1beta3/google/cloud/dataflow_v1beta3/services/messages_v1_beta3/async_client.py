...
class MessagesV1Beta3AsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, MessagesV1Beta3Transport, Callable[..., MessagesV1Beta3Transport]]] = "grpc_asyncio",
    ...
    async def list_job_messages(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_job_messages]

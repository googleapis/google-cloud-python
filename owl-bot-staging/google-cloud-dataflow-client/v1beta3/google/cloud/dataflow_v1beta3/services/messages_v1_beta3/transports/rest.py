...
class MessagesV1Beta3RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_list_job_messages(self, request: messages.ListJobMessagesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[messages.ListJobMessagesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_job_messages_with_metadata(self, response: messages.ListJobMessagesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[messages.ListJobMessagesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_job_messages
...
class MessagesV1Beta3RestTransport(_BaseMessagesV1Beta3RestTransport):
    ...
    class _ListJobMessages(_BaseMessagesV1Beta3RestTransport._BaseListJobMessages, MessagesV1Beta3RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MessagesV1Beta3RestTransport._ListJobMessages._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

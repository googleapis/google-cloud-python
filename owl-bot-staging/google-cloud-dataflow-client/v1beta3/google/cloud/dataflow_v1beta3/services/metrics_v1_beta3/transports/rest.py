...
class MetricsV1Beta3RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_job_execution_details(self, request: metrics.GetJobExecutionDetailsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metrics.GetJobExecutionDetailsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_job_execution_details_with_metadata(self, response: metrics.JobExecutionDetails, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metrics.JobExecutionDetails, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_job_execution_details
    ...
    def pre_get_job_metrics(self, request: metrics.GetJobMetricsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metrics.GetJobMetricsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_job_metrics_with_metadata(self, response: metrics.JobMetrics, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metrics.JobMetrics, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_job_metrics
    ...
    def pre_get_stage_execution_details(self, request: metrics.GetStageExecutionDetailsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metrics.GetStageExecutionDetailsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_stage_execution_details_with_metadata(self, response: metrics.StageExecutionDetails, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metrics.StageExecutionDetails, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_stage_execution_details
...
class MetricsV1Beta3RestTransport(_BaseMetricsV1Beta3RestTransport):
    ...
    class _GetJobExecutionDetails(_BaseMetricsV1Beta3RestTransport._BaseGetJobExecutionDetails, MetricsV1Beta3RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MetricsV1Beta3RestTransport._GetJobExecutionDetails._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetJobMetrics(_BaseMetricsV1Beta3RestTransport._BaseGetJobMetrics, MetricsV1Beta3RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MetricsV1Beta3RestTransport._GetJobMetrics._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetStageExecutionDetails(_BaseMetricsV1Beta3RestTransport._BaseGetStageExecutionDetails, MetricsV1Beta3RestStub):
        ...
        details method over HTTP.
            ...
            # Send the request
            response = MetricsV1Beta3RestTransport._GetStageExecutionDetails._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class MetricsV1Beta3RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_job_execution_details(self, request: metrics.GetJobExecutionDetailsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[metrics.GetJobExecutionDetailsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_job_metrics(self, request: metrics.GetJobMetricsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[metrics.GetJobMetricsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_stage_execution_details(self, request: metrics.GetStageExecutionDetailsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[metrics.GetStageExecutionDetailsRequest, Sequence[Tuple[str, str]]]:

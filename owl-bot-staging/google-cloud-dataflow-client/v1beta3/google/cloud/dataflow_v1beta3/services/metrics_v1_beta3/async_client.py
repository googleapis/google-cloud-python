...
from .transports.base import MetricsV1Beta3Transport, DEFAULT_CLIENT_INFO
...
class MetricsV1Beta3AsyncClient:
    ...
    common_billing_account_path = staticmethod(MetricsV1Beta3Client.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(MetricsV1Beta3Client.parse_common_billing_account_path)
    common_folder_path = staticmethod(MetricsV1Beta3Client.common_folder_path)
    parse_common_folder_path = staticmethod(MetricsV1Beta3Client.parse_common_folder_path)
    common_organization_path = staticmethod(MetricsV1Beta3Client.common_organization_path)
    parse_common_organization_path = staticmethod(MetricsV1Beta3Client.parse_common_organization_path)
    common_project_path = staticmethod(MetricsV1Beta3Client.common_project_path)
    parse_common_project_path = staticmethod(MetricsV1Beta3Client.parse_common_project_path)
    common_location_path = staticmethod(MetricsV1Beta3Client.common_location_path)
    parse_common_location_path = staticmethod(MetricsV1Beta3Client.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(MetricsV1Beta3Client).get_transport_class, type(MetricsV1Beta3Client))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, MetricsV1Beta3Transport, Callable[..., MetricsV1Beta3Transport]]] = "grpc_asyncio",
    ...
    async def get_job_metrics(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_job_metrics]
    ...
    async def get_job_execution_details(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_job_execution_details]
    ...
    async def get_stage_execution_details(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_stage_execution_details]

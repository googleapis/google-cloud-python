...
class SnapshotsV1Beta3RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_snapshot(self, request: snapshots.DeleteSnapshotRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[snapshots.DeleteSnapshotRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_snapshot_with_metadata(self, response: snapshots.DeleteSnapshotResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[snapshots.DeleteSnapshotResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_snapshot
    ...
    def pre_get_snapshot(self, request: snapshots.GetSnapshotRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[snapshots.GetSnapshotRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_snapshot_with_metadata(self, response: snapshots.Snapshot, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[snapshots.Snapshot, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_snapshot
    ...
    def pre_list_snapshots(self, request: snapshots.ListSnapshotsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[snapshots.ListSnapshotsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_snapshots_with_metadata(self, response: snapshots.ListSnapshotsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[snapshots.ListSnapshotsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_snapshots
...
class SnapshotsV1Beta3RestTransport(_BaseSnapshotsV1Beta3RestTransport):
    ...
    class _DeleteSnapshot(_BaseSnapshotsV1Beta3RestTransport._BaseDeleteSnapshot, SnapshotsV1Beta3RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SnapshotsV1Beta3RestTransport._DeleteSnapshot._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetSnapshot(_BaseSnapshotsV1Beta3RestTransport._BaseGetSnapshot, SnapshotsV1Beta3RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SnapshotsV1Beta3RestTransport._GetSnapshot._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListSnapshots(_BaseSnapshotsV1Beta3RestTransport._BaseListSnapshots, SnapshotsV1Beta3RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SnapshotsV1Beta3RestTransport._ListSnapshots._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

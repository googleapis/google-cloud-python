...
class FlexTemplatesServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_launch_flex_template(self, request: templates.LaunchFlexTemplateRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[templates.LaunchFlexTemplateRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_launch_flex_template_with_metadata(self, response: templates.LaunchFlexTemplateResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[templates.LaunchFlexTemplateResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for launch_flex_template
...
class FlexTemplatesServiceRestTransport(_BaseFlexTemplatesServiceRestTransport):
    ...
    class _LaunchFlexTemplate(_BaseFlexTemplatesServiceRestTransport._BaseLaunchFlexTemplate, FlexTemplatesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FlexTemplatesServiceRestTransport._LaunchFlexTemplate._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class JobsV1Beta3RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list_jobs(self, request: jobs.ListJobsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.ListJobsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list_jobs_with_metadata(self, response: jobs.ListJobsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.ListJobsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list_jobs
    ...
    def pre_create_job(self, request: jobs.CreateJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.CreateJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_job_with_metadata(self, response: jobs.Job, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.Job, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_job
    ...
    def pre_get_job(self, request: jobs.GetJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.GetJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_job_with_metadata(self, response: jobs.Job, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.Job, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_job
    ...
    def pre_list_jobs(self, request: jobs.ListJobsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.ListJobsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_jobs_with_metadata(self, response: jobs.ListJobsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.ListJobsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_jobs
    ...
    def pre_snapshot_job(self, request: jobs.SnapshotJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.SnapshotJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_snapshot_job_with_metadata(self, response: snapshots.Snapshot, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[snapshots.Snapshot, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for snapshot_job
    ...
    def pre_update_job(self, request: jobs.UpdateJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.UpdateJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_job_with_metadata(self, response: jobs.Job, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[jobs.Job, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_job
...
class JobsV1Beta3RestTransport(_BaseJobsV1Beta3RestTransport):
    ...
    class _AggregatedListJobs(_BaseJobsV1Beta3RestTransport._BaseAggregatedListJobs, JobsV1Beta3RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = JobsV1Beta3RestTransport._AggregatedListJobs._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CreateJob(_BaseJobsV1Beta3RestTransport._BaseCreateJob, JobsV1Beta3RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = JobsV1Beta3RestTransport._CreateJob._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListJobs(_BaseJobsV1Beta3RestTransport._BaseListJobs, JobsV1Beta3RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = JobsV1Beta3RestTransport._ListJobs._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SnapshotJob(_BaseJobsV1Beta3RestTransport._BaseSnapshotJob, JobsV1Beta3RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = JobsV1Beta3RestTransport._SnapshotJob._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateJob(_BaseJobsV1Beta3RestTransport._BaseUpdateJob, JobsV1Beta3RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = JobsV1Beta3RestTransport._UpdateJob._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

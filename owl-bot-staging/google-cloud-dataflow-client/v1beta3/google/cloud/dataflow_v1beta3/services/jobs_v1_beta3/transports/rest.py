...
class JobsV1Beta3RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list_jobs(self, request: jobs.ListJobsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[jobs.ListJobsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_job(self, request: jobs.CreateJobRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[jobs.CreateJobRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_job(self, request: jobs.GetJobRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[jobs.GetJobRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_jobs(self, request: jobs.ListJobsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[jobs.ListJobsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_snapshot_job(self, request: jobs.SnapshotJobRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[jobs.SnapshotJobRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_job(self, request: jobs.UpdateJobRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[jobs.UpdateJobRequest, Sequence[Tuple[str, str]]]:

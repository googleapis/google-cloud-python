...
from google.cloud.dataflow_v1beta3.services.messages_v1_beta3 import MessagesV1Beta3AsyncClient
from google.cloud.dataflow_v1beta3.services.messages_v1_beta3 import MessagesV1Beta3Client
...
def test__get_api_endpoint():
    ...
    assert MessagesV1Beta3Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == MessagesV1Beta3Client.DEFAULT_MTLS_ENDPOINT
    ...
    assert MessagesV1Beta3Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == MessagesV1Beta3Client.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    MessagesV1Beta3Client, MessagesV1Beta3AsyncClient
])
...
def test_list_job_messages_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, messages.JobMessage)
                   for i in results)
...
def test_list_job_messages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MessagesV1Beta3RestInterceptor, "post_list_job_messages") as post, \
        mock.patch.object(transports.MessagesV1Beta3RestInterceptor, "post_list_job_messages_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MessagesV1Beta3RestInterceptor, "pre_list_job_messages") as pre:
...
def test_messages_v1_beta3_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.MessagesV1Beta3GrpcTransport, transports.MessagesV1Beta3GrpcAsyncIOTransport])
def test_messages_v1_beta3_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

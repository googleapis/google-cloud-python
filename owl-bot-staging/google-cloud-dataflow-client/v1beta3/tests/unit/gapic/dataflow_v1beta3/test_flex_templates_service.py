...
def test__get_api_endpoint():
    ...
    assert FlexTemplatesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == FlexTemplatesServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert FlexTemplatesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == FlexTemplatesServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_launch_flex_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FlexTemplatesServiceRestInterceptor, "post_launch_flex_template_with_metadata") as post_with_metadata, \

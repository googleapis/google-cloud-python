...
from google.cloud.dataflow_v1beta3.services.templates_service import TemplatesServiceAsyncClient
from google.cloud.dataflow_v1beta3.services.templates_service import TemplatesServiceClient
...
def test__get_api_endpoint():
    ...
    assert TemplatesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == TemplatesServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert TemplatesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == TemplatesServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    TemplatesServiceClient, TemplatesServiceAsyncClient
])
...
def test_create_job_from_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TemplatesServiceRestInterceptor, "post_create_job_from_template") as post, \
        mock.patch.object(transports.TemplatesServiceRestInterceptor, "post_create_job_from_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TemplatesServiceRestInterceptor, "pre_create_job_from_template") as pre:
...
def test_launch_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TemplatesServiceRestInterceptor, "post_launch_template") as post, \
        mock.patch.object(transports.TemplatesServiceRestInterceptor, "post_launch_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TemplatesServiceRestInterceptor, "pre_launch_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TemplatesServiceRestInterceptor, "post_get_template") as post, \
        mock.patch.object(transports.TemplatesServiceRestInterceptor, "post_get_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TemplatesServiceRestInterceptor, "pre_get_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

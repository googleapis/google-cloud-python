...
def test_create_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_create_job_with_metadata") as post_with_metadata, \
...
def test_get_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_get_job_with_metadata") as post_with_metadata, \
...
def test_update_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_update_job_with_metadata") as post_with_metadata, \
...
def test_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_list_jobs_with_metadata") as post_with_metadata, \
...
def test_aggregated_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_aggregated_list_jobs_with_metadata") as post_with_metadata, \
...
def test_snapshot_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_snapshot_job_with_metadata") as post_with_metadata, \

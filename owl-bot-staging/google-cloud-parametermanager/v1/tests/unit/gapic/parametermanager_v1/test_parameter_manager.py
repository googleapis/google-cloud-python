...
from google.cloud.parametermanager_v1.services.parameter_manager import ParameterManagerAsyncClient
from google.cloud.parametermanager_v1.services.parameter_manager import ParameterManagerClient
from google.cloud.parametermanager_v1.services.parameter_manager import pagers
from google.cloud.parametermanager_v1.services.parameter_manager import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert ParameterManagerClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert ParameterManagerClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ParameterManagerClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ParameterManagerClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert ParameterManagerClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert ParameterManagerClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ParameterManagerClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ParameterManagerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ParameterManagerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ParameterManagerClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert ParameterManagerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ParameterManagerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ParameterManagerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ParameterManagerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ParameterManagerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ParameterManagerClient))
@mock.patch.object(ParameterManagerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ParameterManagerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ParameterManagerClient._DEFAULT_UNIVERSE
    default_endpoint = ParameterManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ParameterManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ParameterManagerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ParameterManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ParameterManagerClient.DEFAULT_MTLS_ENDPOINT
    assert ParameterManagerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ParameterManagerClient._get_api_endpoint(None, None, default_universe, "always") == ParameterManagerClient.DEFAULT_MTLS_ENDPOINT
    assert ParameterManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ParameterManagerClient.DEFAULT_MTLS_ENDPOINT
    assert ParameterManagerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ParameterManagerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ParameterManagerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ParameterManagerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ParameterManagerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ParameterManagerClient._get_universe_domain(None, None) == ParameterManagerClient._DEFAULT_UNIVERSE
...
def test_parameter_manager_client_from_service_account_info(client_class, transport_name):
...
def test_parameter_manager_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_parameter_manager_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ParameterManagerAsyncClient, transports.ParameterManagerGrpcAsyncIOTransport, "grpc_asyncio"),
    (ParameterManagerClient, transports.ParameterManagerRestTransport, "rest"),
])
@mock.patch.object(ParameterManagerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ParameterManagerClient))
@mock.patch.object(ParameterManagerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ParameterManagerAsyncClient))
def test_parameter_manager_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (ParameterManagerClient, transports.ParameterManagerGrpcTransport, "grpc", "true"),
    (ParameterManagerAsyncClient, transports.ParameterManagerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ParameterManagerClient, transports.ParameterManagerGrpcTransport, "grpc", "false"),
    (ParameterManagerAsyncClient, transports.ParameterManagerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (ParameterManagerClient, transports.ParameterManagerRestTransport, "rest", "true"),
    (ParameterManagerClient, transports.ParameterManagerRestTransport, "rest", "false"),
])
@mock.patch.object(ParameterManagerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ParameterManagerClient))
@mock.patch.object(ParameterManagerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ParameterManagerAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_parameter_manager_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    ParameterManagerClient, ParameterManagerAsyncClient
])
@mock.patch.object(ParameterManagerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ParameterManagerClient))
@mock.patch.object(ParameterManagerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ParameterManagerAsyncClient))
...
def test_parameter_manager_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ParameterManagerClient, transports.ParameterManagerGrpcTransport, "grpc", grpc_helpers),
    (ParameterManagerAsyncClient, transports.ParameterManagerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (ParameterManagerClient, transports.ParameterManagerRestTransport, "rest", None),
])
def test_parameter_manager_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_parameter_manager_client_client_options_from_dict():
    with mock.patch('google.cloud.parametermanager_v1.services.parameter_manager.transports.ParameterManagerGrpcTransport.__init__') as grpc_transport:
...
def test_parameter_manager_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_list_parameters(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.list_parameters),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_list_parameters_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_parameters in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_parameters] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_parameters_async(transport: str = 'grpc_asyncio', request_type=service.ListParametersRequest):
    client = ParameterManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(service.ListParametersResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_parameters_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, service.Parameter)
                   for i in results)
...
async def test_list_parameters_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_parameters(request={},)
...
def test_get_parameter(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_parameter),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_parameter_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ParameterManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_parameter in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_parameter] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_parameter_async(transport: str = 'grpc_asyncio', request_type=service.GetParameterRequest):
    client = ParameterManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_parameter(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_parameter),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.Parameter(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_parameter_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ParameterManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_parameter in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_parameter] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_parameter_async(transport: str = 'grpc_asyncio', request_type=service.CreateParameterRequest):
    client = ParameterManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_parameter(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_parameter),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.Parameter(
            name='name_value',
...
def test_update_parameter_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_parameter] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_parameter_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ParameterManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_parameter in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_parameter] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_parameter_async(transport: str = 'grpc_asyncio', request_type=service.UpdateParameterRequest):
    client = ParameterManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_parameter(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_parameter),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_parameter_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_parameter] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_parameter_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ParameterManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_parameter in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_parameter] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_parameter_async(transport: str = 'grpc_asyncio', request_type=service.DeleteParameterRequest):
    client = ParameterManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_parameter_versions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_parameter_versions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_parameter_versions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_parameter_versions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ParameterManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_parameter_versions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_parameter_versions] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_parameter_versions_async(transport: str = 'grpc_asyncio', request_type=service.ListParameterVersionsRequest):
    client = ParameterManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(service.ListParameterVersionsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_parameter_versions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, service.ParameterVersion)
                   for i in results)
...
async def test_list_parameter_versions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_parameter_versions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_parameter_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_parameter_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_parameter_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_parameter_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_parameter_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_parameter_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ParameterManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_parameter_version in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_parameter_version] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_parameter_version_async(transport: str = 'grpc_asyncio', request_type=service.GetParameterVersionRequest):
    client = ParameterManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(service.ParameterVersion(
            name='name_value',
            disabled=True,
            kms_key_version='kms_key_version_value',
        ))
...
def test_render_parameter_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.render_parameter_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_render_parameter_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.render_parameter_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.render_parameter_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_render_parameter_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ParameterManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.render_parameter_version in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.render_parameter_version] = mock_rpc
...
@pytest.mark.asyncio
async def test_render_parameter_version_async(transport: str = 'grpc_asyncio', request_type=service.RenderParameterVersionRequest):
    client = ParameterManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(service.RenderParameterVersionResponse(
            parameter_version='parameter_version_value',
            rendered_payload=b'rendered_payload_blob',
        ))
...
def test_create_parameter_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_parameter_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.ParameterVersion(
            name='name_value',
...
def test_create_parameter_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_parameter_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_parameter_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_parameter_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ParameterManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_parameter_version in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_parameter_version] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_parameter_version_async(transport: str = 'grpc_asyncio', request_type=service.CreateParameterVersionRequest):
    client = ParameterManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_parameter_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_parameter_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.ParameterVersion(
            name='name_value',
...
def test_update_parameter_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_parameter_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_parameter_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_parameter_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ParameterManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_parameter_version in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_parameter_version] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_parameter_version_async(transport: str = 'grpc_asyncio', request_type=service.UpdateParameterVersionRequest):
    client = ParameterManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_parameter_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_parameter_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_parameter_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_parameter_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_parameter_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_parameter_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ParameterManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_parameter_version in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_parameter_version] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_parameter_version_async(transport: str = 'grpc_asyncio', request_type=service.DeleteParameterVersionRequest):
    client = ParameterManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_parameters_rest_required_fields(request_type=service.ListParametersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_parameters._get_unset_required_fields(jsonified_request)
...
def test_list_parameters_rest_unset_required_fields():
    transport = transports.ParameterManagerRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/parameters" % client.transport._host, args[1])
...
def test_get_parameter_rest_required_fields(request_type=service.GetParameterRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_parameter._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_parameter_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/parameters/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/parameters/*}" % client.transport._host, args[1])
...
def test_create_parameter_rest_required_fields(request_type=service.CreateParameterRequest):
    transport_class = transports.ParameterManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_parameter._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_parameter._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("parameter_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_parameter_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("parameterId", "requestId", )) & set(("parent", "parameterId", "parameter", )))
...
def test_update_parameter_rest_required_fields(request_type=service.UpdateParameterRequest):
    transport_class = transports.ParameterManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_parameter._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_parameter_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("parameter", )))
...
def test_update_parameter_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parameter': {'name': 'projects/sample1/locations/sample2/parameters/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parameter.name=projects/*/locations/*/parameters/*}" % client.transport._host, args[1])
...
def test_delete_parameter_rest_required_fields(request_type=service.DeleteParameterRequest):
    transport_class = transports.ParameterManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_parameter._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_parameter_versions_rest_required_fields(request_type=service.ListParameterVersionsRequest):
    transport_class = transports.ParameterManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_parameter_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_parameter_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/parameters/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/parameters/*}/versions" % client.transport._host, args[1])
...
def test_list_parameter_versions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(service.ListParameterVersionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_parameter_version_rest_required_fields(request_type=service.GetParameterVersionRequest):
    transport_class = transports.ParameterManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_parameter_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_parameter_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/parameters/sample3/versions/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/parameters/*/versions/*}" % client.transport._host, args[1])
...
def test_render_parameter_version_rest_required_fields(request_type=service.RenderParameterVersionRequest):
    transport_class = transports.ParameterManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).render_parameter_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_render_parameter_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/parameters/*/versions/*}:render" % client.transport._host, args[1])
...
def test_create_parameter_version_rest_required_fields(request_type=service.CreateParameterVersionRequest):
    transport_class = transports.ParameterManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_parameter_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "parameterVersionId" in jsonified_request
    assert jsonified_request["parameterVersionId"] == request_init["parameter_version_id"]
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_parameter_version._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("parameter_version_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_parameter_version_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("parameterVersionId", "requestId", )) & set(("parent", "parameterVersionId", "parameterVersion", )))
...
def test_update_parameter_version_rest_required_fields(request_type=service.UpdateParameterVersionRequest):
    transport_class = transports.ParameterManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_parameter_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_parameter_version_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("parameterVersion", )))
...
def test_update_parameter_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parameter_version': {'name': 'projects/sample1/locations/sample2/parameters/sample3/versions/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parameter_version.name=projects/*/locations/*/parameters/*/versions/*}" % client.transport._host, args[1])
...
def test_delete_parameter_version_rest_required_fields(request_type=service.DeleteParameterVersionRequest):
    transport_class = transports.ParameterManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_parameter_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_parameters_rest_interceptors(null_interceptor):
    transport = transports.ParameterManagerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ParameterManagerRestInterceptor(),
        )
    client = ParameterManagerClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_list_parameters") as post, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_list_parameters_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_list_parameters") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListParametersResponse.to_json(service.ListParametersResponse())
        ...
        client.list_parameters(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_parameter_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_get_parameter") as post, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_get_parameter_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_get_parameter") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_parameter(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_parameter_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["parameter"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'format_': 1, 'policy_member': {'iam_policy_name_principal': 'iam_policy_name_principal_value', 'iam_policy_uid_principal': 'iam_policy_uid_principal_value'}, 'kms_key': 'kms_key_value'}
...
def test_create_parameter_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_create_parameter") as post, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_create_parameter_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_create_parameter") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_parameter(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_parameter_rest_bad_request(request_type=service.UpdateParameterRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parameter': {'name': 'projects/sample1/locations/sample2/parameters/sample3'}}
    request = request_type(**request_init)
...
def test_update_parameter_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parameter': {'name': 'projects/sample1/locations/sample2/parameters/sample3'}}
    request_init["parameter"] = {'name': 'projects/sample1/locations/sample2/parameters/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'format_': 1, 'policy_member': {'iam_policy_name_principal': 'iam_policy_name_principal_value', 'iam_policy_uid_principal': 'iam_policy_uid_principal_value'}, 'kms_key': 'kms_key_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_parameter_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_update_parameter") as post, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_update_parameter_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_update_parameter") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_parameter(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_parameter_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_delete_parameter") as pre:
        pre.assert_not_called()
        ...
        client.delete_parameter(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_list_parameter_versions_rest_bad_request(request_type=service.ListParameterVersionsRequest):
    client = ParameterManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_parameter_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_list_parameter_versions") as post, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_list_parameter_versions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_list_parameter_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.ListParameterVersionsRequest.pb(service.ListParameterVersionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListParameterVersionsResponse.to_json(service.ListParameterVersionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.ListParameterVersionsResponse(), metadata

        client.list_parameter_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_parameter_version_rest_bad_request(request_type=service.GetParameterVersionRequest):
    client = ParameterManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/parameters/sample3/versions/sample4'}
    request = request_type(**request_init)
...
def test_get_parameter_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_get_parameter_version") as post, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_get_parameter_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_get_parameter_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.GetParameterVersionRequest.pb(service.GetParameterVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_parameter_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_render_parameter_version_rest_bad_request(request_type=service.RenderParameterVersionRequest):
    client = ParameterManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_render_parameter_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_render_parameter_version") as post, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_render_parameter_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_render_parameter_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.RenderParameterVersionRequest.pb(service.RenderParameterVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.RenderParameterVersionResponse.to_json(service.RenderParameterVersionResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.RenderParameterVersionResponse(), metadata

        client.render_parameter_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_parameter_version_rest_bad_request(request_type=service.CreateParameterVersionRequest):
    client = ParameterManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_parameter_version_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/parameters/sample3'}
    request_init["parameter_version"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'disabled': True, 'payload': {'data': b'data_blob'}, 'kms_key_version': 'kms_key_version_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_parameter_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_create_parameter_version") as post, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_create_parameter_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_create_parameter_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.CreateParameterVersionRequest.pb(service.CreateParameterVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_parameter_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_parameter_version_rest_bad_request(request_type=service.UpdateParameterVersionRequest):
    client = ParameterManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parameter_version': {'name': 'projects/sample1/locations/sample2/parameters/sample3/versions/sample4'}}
    request = request_type(**request_init)
...
def test_update_parameter_version_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parameter_version': {'name': 'projects/sample1/locations/sample2/parameters/sample3/versions/sample4'}}
    request_init["parameter_version"] = {'name': 'projects/sample1/locations/sample2/parameters/sample3/versions/sample4', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'disabled': True, 'payload': {'data': b'data_blob'}, 'kms_key_version': 'kms_key_version_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_parameter_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_update_parameter_version") as post, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "post_update_parameter_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_update_parameter_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.UpdateParameterVersionRequest.pb(service.UpdateParameterVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_parameter_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_parameter_version_rest_bad_request(request_type=service.DeleteParameterVersionRequest):
    client = ParameterManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_parameter_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_delete_parameter_version") as pre:
        pre.assert_not_called()
        pb_message = service.DeleteParameterVersionRequest.pb(service.DeleteParameterVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_parameter_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_parameter_manager_base_transport():
    ...
    with mock.patch('google.cloud.parametermanager_v1.services.parameter_manager.transports.ParameterManagerTransport.__init__') as Transport:
...
def test_parameter_manager_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.parametermanager_v1.services.parameter_manager.transports.ParameterManagerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_parameter_manager_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.parametermanager_v1.services.parameter_manager.transports.ParameterManagerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ParameterManagerTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.ParameterManagerGrpcTransport, transports.ParameterManagerGrpcAsyncIOTransport])
def test_parameter_manager_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_parameter_manager_host_no_port(transport_name):
    client = ParameterManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='parametermanager.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'parametermanager.googleapis.com:443'
...
def test_parameter_manager_host_with_port(transport_name):
    client = ParameterManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='parametermanager.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ParameterManagerGrpcTransport, transports.ParameterManagerGrpcAsyncIOTransport])
def test_parameter_manager_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_crypto_key_path():
    ...
    actual = ParameterManagerClient.crypto_key_path(project, location, key_ring, crypto_key)
...
def test_parameter_path():
    ...
    location = "nautilus"
    parameter = "scallop"
    expected = "projects/{project}/locations/{location}/parameters/{parameter}".format(project=project, location=location, parameter=parameter, )
...
def test_parameter_version_path():
    ...
    expected = "projects/{project}/locations/{location}/parameters/{parameter}/versions/{parameter_version}".format(project=project, location=location, parameter=parameter, parameter_version=parameter_version, )
    actual = ParameterManagerClient.parameter_version_path(project, location, parameter, parameter_version)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.ParameterManagerTransport, '_prep_wrapped_messages') as prep:
        client = ParameterManagerClient(
            credentials=ga_credentials.AnonymousCredentials(),

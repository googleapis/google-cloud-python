...
def test_create_parameter_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["parameter"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'format_': 1, 'policy_member': {'iam_policy_name_principal': 'iam_policy_name_principal_value', 'iam_policy_uid_principal': 'iam_policy_uid_principal_value'}}
...
def test_update_parameter_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parameter': {'name': 'projects/sample1/locations/sample2/parameters/sample3'}}
    request_init["parameter"] = {'name': 'projects/sample1/locations/sample2/parameters/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'format_': 1, 'policy_member': {'iam_policy_name_principal': 'iam_policy_name_principal_value', 'iam_policy_uid_principal': 'iam_policy_uid_principal_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_parameter_version_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/parameters/sample3'}
    request_init["parameter_version"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'disabled': True, 'payload': {'data': b'data_blob'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_parameter_version_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parameter_version': {'name': 'projects/sample1/locations/sample2/parameters/sample3/versions/sample4'}}
    request_init["parameter_version"] = {'name': 'projects/sample1/locations/sample2/parameters/sample3/versions/sample4', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'disabled': True, 'payload': {'data': b'data_blob'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

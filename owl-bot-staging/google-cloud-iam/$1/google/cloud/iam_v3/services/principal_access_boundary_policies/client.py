...
class PrincipalAccessBoundaryPoliciesClient(metaclass=PrincipalAccessBoundaryPoliciesClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.iam_v3.PrincipalAccessBoundaryPoliciesClient`.",
                    extra = {
    ...
    def create_principal_access_boundary_policy(self,
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.CreatePrincipalAccessBoundaryPolicyRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            principal_access_boundary_policy (google.cloud.iam_v3.types.PrincipalAccessBoundaryPolicy):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.iam_v3.types.PrincipalAccessBoundaryPolicy`
    ...
    def get_principal_access_boundary_policy(self,
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.GetPrincipalAccessBoundaryPolicyRequest, dict]):
                The request object. Request message for
    ...
    def update_principal_access_boundary_policy(self,
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.UpdatePrincipalAccessBoundaryPolicyRequest, dict]):
                The request object. Request message for
    ...
    def delete_principal_access_boundary_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_principal_access_boundary_policy():
                ...
                # Initialize request argument(s)
                request = iam_v3.DeletePrincipalAccessBoundaryPolicyRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.DeletePrincipalAccessBoundaryPolicyRequest, dict]):
                The request object. Request message for
    ...
    def list_principal_access_boundary_policies(self,
        ...
        .. code-block:: python
            ...
            def sample_list_principal_access_boundary_policies():
                ...
                # Initialize request argument(s)
                request = iam_v3.ListPrincipalAccessBoundaryPoliciesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.ListPrincipalAccessBoundaryPoliciesRequest, dict]):
                The request object. Request message for
    ...
    def search_principal_access_boundary_policy_bindings(self,
        ...
        .. code-block:: python
            ...
            def sample_search_principal_access_boundary_policy_bindings():
                ...
                # Initialize request argument(s)
                request = iam_v3.SearchPrincipalAccessBoundaryPolicyBindingsRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.SearchPrincipalAccessBoundaryPolicyBindingsRequest, dict]):
                The request object. Request message for

...
from google.cloud.iam_v3.types import policy_bindings_service
...
class ListPolicyBindingsPager:
    ...
    :class:`google.cloud.iam_v3.types.ListPolicyBindingsResponse` object, and
    ...
    All the usual :class:`google.cloud.iam_v3.types.ListPolicyBindingsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.iam_v3.types.ListPolicyBindingsRequest):
                The initial request object.
            response (google.cloud.iam_v3.types.ListPolicyBindingsResponse):
...
class SearchTargetPolicyBindingsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.iam_v3.types.SearchTargetPolicyBindingsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``policy_bindings`` field.
    ...
    All the usual :class:`google.cloud.iam_v3.types.SearchTargetPolicyBindingsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.iam_v3.types.SearchTargetPolicyBindingsRequest):
                The initial request object.
            response (google.cloud.iam_v3.types.SearchTargetPolicyBindingsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

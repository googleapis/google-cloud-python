...
from google.cloud.iam_v3beta.types import operation_metadata
from google.cloud.iam_v3beta.types import policy_binding_resources
from google.cloud.iam_v3beta.types import principal_access_boundary_policies_service
from google.cloud.iam_v3beta.types import principal_access_boundary_policy_resources
from google.cloud.location import locations_pb2 # type: ignore
from google.longrunning import operations_pb2 # type: ignore
from google.protobuf import empty_pb2  # type: ignore
from google.protobuf import field_mask_pb2  # type: ignore
from google.protobuf import timestamp_pb2  # type: ignore
from .transports.base import PrincipalAccessBoundaryPoliciesTransport, DEFAULT_CLIENT_INFO
...
class PrincipalAccessBoundaryPoliciesClientMeta(type):
    """Metaclass for the PrincipalAccessBoundaryPolicies client.
...
class PrincipalAccessBoundaryPoliciesClient(metaclass=PrincipalAccessBoundaryPoliciesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            PrincipalAccessBoundaryPoliciesClient: The constructed client.
        """
    ...
    def transport(self) -> PrincipalAccessBoundaryPoliciesTransport:
        ...
        Returns:
            PrincipalAccessBoundaryPoliciesTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def policy_binding_path(organization: str,location: str,policy_binding: str,) -> str:
        """Returns a fully-qualified policy_binding string."""
        return "organizations/{organization}/locations/{location}/policyBindings/{policy_binding}".format(organization=organization, location=location, policy_binding=policy_binding, )
    ...
    @staticmethod
    def principal_access_boundary_policy_path(organization: str,location: str,principal_access_boundary_policy: str,) -> str:
        """Returns a fully-qualified principal_access_boundary_policy string."""
        return "organizations/{organization}/locations/{location}/principalAccessBoundaryPolicies/{principal_access_boundary_policy}".format(organization=organization, location=location, principal_access_boundary_policy=principal_access_boundary_policy, )

    @staticmethod
    def parse_principal_access_boundary_policy_path(path: str) -> Dict[str,str]:
        """Parses a principal_access_boundary_policy path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/principalAccessBoundaryPolicies/(?P<principal_access_boundary_policy>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = PrincipalAccessBoundaryPoliciesClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PrincipalAccessBoundaryPoliciesClient._read_environment_variables()
        self._client_cert_source = PrincipalAccessBoundaryPoliciesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        ...
        self._api_endpoint = (self._api_endpoint or
            PrincipalAccessBoundaryPoliciesClient._get_api_endpoint(
    ...
    def create_principal_access_boundary_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_create_principal_access_boundary_policy():
                # Create a client
        ...
        Args:
            request (Union[google.cloud.iam_v3beta.types.CreatePrincipalAccessBoundaryPolicyRequest, dict]):
    ...
    def get_principal_access_boundary_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_get_principal_access_boundary_policy():
                # Create a client
                client = iam_v3beta.PrincipalAccessBoundaryPoliciesClient()
                ...
                # Make the request
                response = client.get_principal_access_boundary_policy(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.iam_v3beta.types.GetPrincipalAccessBoundaryPolicyRequest, dict]):
                The request object. Request message for
    ...
    def update_principal_access_boundary_policy(self,
        ...
        Args:
            request (Union[google.cloud.iam_v3beta.types.UpdatePrincipalAccessBoundaryPolicyRequest, dict]):
                The request object. Request message for
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("principal_access_boundary_policy.name", request.principal_access_boundary_policy.name),
            )),
        )
    ...
    def delete_principal_access_boundary_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_principal_access_boundary_policy():
                # Create a client
                client = iam_v3beta.PrincipalAccessBoundaryPoliciesClient()
        ...
        Args:
            request (Union[google.cloud.iam_v3beta.types.DeletePrincipalAccessBoundaryPolicyRequest, dict]):
                The request object. Request message for
    ...
    def list_principal_access_boundary_policies(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListPrincipalAccessBoundaryPoliciesPager:
        ...
        .. code-block:: python
            ...
            def sample_list_principal_access_boundary_policies():
                # Create a client
                client = iam_v3beta.PrincipalAccessBoundaryPoliciesClient()
        ...
        Args:
            request (Union[google.cloud.iam_v3beta.types.ListPrincipalAccessBoundaryPoliciesRequest, dict]):
                The request object. Request message for
        ...
        response = pagers.ListPrincipalAccessBoundaryPoliciesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def search_principal_access_boundary_policy_bindings(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.SearchPrincipalAccessBoundaryPolicyBindingsPager:
        ...
        .. code-block:: python
            ...
            def sample_search_principal_access_boundary_policy_bindings():
                # Create a client
                client = iam_v3beta.PrincipalAccessBoundaryPoliciesClient()
        ...
        Args:
            request (Union[google.cloud.iam_v3beta.types.SearchPrincipalAccessBoundaryPolicyBindingsRequest, dict]):
                The request object. Request message for
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.SearchPrincipalAccessBoundaryPolicyBindingsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "PrincipalAccessBoundaryPoliciesClient":
        return self

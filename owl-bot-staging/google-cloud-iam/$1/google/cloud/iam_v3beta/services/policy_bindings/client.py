...
from .transports.grpc import PolicyBindingsGrpcTransport
from .transports.grpc_asyncio import PolicyBindingsGrpcAsyncIOTransport
from .transports.rest import PolicyBindingsRestTransport


class PolicyBindingsClientMeta(type):
    """Metaclass for the PolicyBindings client.
...
class PolicyBindingsClient(metaclass=PolicyBindingsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            PolicyBindingsClient: The constructed client.
        """
    ...
    def transport(self) -> PolicyBindingsTransport:
        ...
        Returns:
            PolicyBindingsTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = PolicyBindingsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = PolicyBindingsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = PolicyBindingsClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PolicyBindingsTransport, Callable[..., PolicyBindingsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PolicyBindingsClient._read_environment_variables()
        self._client_cert_source = PolicyBindingsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = PolicyBindingsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, PolicyBindingsTransport)
        if transport_provided:
            # transport is a PolicyBindingsTransport instance.
            ...
            self._transport = cast(PolicyBindingsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            PolicyBindingsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[PolicyBindingsTransport], Callable[..., PolicyBindingsTransport]] = (
                PolicyBindingsClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., PolicyBindingsTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.iam_v3beta.PolicyBindingsClient`.",
                    extra = {
    ...
    def create_policy_binding(self,
        ...
        Args:
            request (Union[google.cloud.iam_v3beta.types.CreatePolicyBindingRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_policy_binding]
    ...
    def get_policy_binding(self,
        ...
        Args:
            request (Union[google.cloud.iam_v3beta.types.GetPolicyBindingRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_policy_binding]
    ...
    def update_policy_binding(self,
        ...
        .. code-block:: python
            ...
            def sample_update_policy_binding():
                # Create a client
                client = iam_v3beta.PolicyBindingsClient()
        ...
        Args:
            request (Union[google.cloud.iam_v3beta.types.UpdatePolicyBindingRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_policy_binding]
    ...
    def delete_policy_binding(self,
        ...
        Args:
            request (Union[google.cloud.iam_v3beta.types.DeletePolicyBindingRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_policy_binding]
    ...
    def list_policy_bindings(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListPolicyBindingsPager:
        ...
        Args:
            request (Union[google.cloud.iam_v3beta.types.ListPolicyBindingsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_policy_bindings]
        ...
        response = pagers.ListPolicyBindingsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def search_target_policy_bindings(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.SearchTargetPolicyBindingsPager:
        ...
        Args:
            request (Union[google.cloud.iam_v3beta.types.SearchTargetPolicyBindingsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_target_policy_bindings]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.SearchTargetPolicyBindingsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "PolicyBindingsClient":
        return self

...
class PolicyBindingsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_policy_binding(self, request: policy_bindings_service.CreatePolicyBindingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy_bindings_service.CreatePolicyBindingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_policy_binding_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_policy_binding
    ...
    def pre_delete_policy_binding(self, request: policy_bindings_service.DeletePolicyBindingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy_bindings_service.DeletePolicyBindingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_policy_binding_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_policy_binding
    ...
    def pre_get_policy_binding(self, request: policy_bindings_service.GetPolicyBindingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy_bindings_service.GetPolicyBindingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_policy_binding_with_metadata(self, response: policy_binding_resources.PolicyBinding, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy_binding_resources.PolicyBinding, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_policy_binding
    ...
    def pre_list_policy_bindings(self, request: policy_bindings_service.ListPolicyBindingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy_bindings_service.ListPolicyBindingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_policy_bindings(self, response: policy_bindings_service.ListPolicyBindingsResponse) -> policy_bindings_service.ListPolicyBindingsResponse:
    ...
    def post_list_policy_bindings_with_metadata(self, response: policy_bindings_service.ListPolicyBindingsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy_bindings_service.ListPolicyBindingsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_policy_bindings
    ...
    def pre_search_target_policy_bindings(self, request: policy_bindings_service.SearchTargetPolicyBindingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy_bindings_service.SearchTargetPolicyBindingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search_target_policy_bindings(self, response: policy_bindings_service.SearchTargetPolicyBindingsResponse) -> policy_bindings_service.SearchTargetPolicyBindingsResponse:
    ...
    def post_search_target_policy_bindings_with_metadata(self, response: policy_bindings_service.SearchTargetPolicyBindingsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy_bindings_service.SearchTargetPolicyBindingsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_target_policy_bindings
    ...
    def pre_update_policy_binding(self, request: policy_bindings_service.UpdatePolicyBindingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy_bindings_service.UpdatePolicyBindingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_policy_binding_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_policy_binding
...
class PolicyBindingsRestTransport(_BasePolicyBindingsRestTransport):
    ...
    class _CreatePolicyBinding(_BasePolicyBindingsRestTransport._BaseCreatePolicyBinding, PolicyBindingsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PolicyBindingsRestTransport._CreatePolicyBinding._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeletePolicyBinding(_BasePolicyBindingsRestTransport._BaseDeletePolicyBinding, PolicyBindingsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PolicyBindingsRestTransport._DeletePolicyBinding._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetPolicyBinding(_BasePolicyBindingsRestTransport._BaseGetPolicyBinding, PolicyBindingsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PolicyBindingsRestTransport._GetPolicyBinding._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListPolicyBindings(_BasePolicyBindingsRestTransport._BaseListPolicyBindings, PolicyBindingsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PolicyBindingsRestTransport._ListPolicyBindings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SearchTargetPolicyBindings(_BasePolicyBindingsRestTransport._BaseSearchTargetPolicyBindings, PolicyBindingsRestStub):
        ...
        bindings method over HTTP.
            ...
            # Send the request
            response = PolicyBindingsRestTransport._SearchTargetPolicyBindings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdatePolicyBinding(_BasePolicyBindingsRestTransport._BaseUpdatePolicyBinding, PolicyBindingsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PolicyBindingsRestTransport._UpdatePolicyBinding._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BasePolicyBindingsRestTransport._BaseGetOperation, PolicyBindingsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PolicyBindingsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

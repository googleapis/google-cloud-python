...
class PoliciesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_policy(self, request: gi_policy.CreatePolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gi_policy.CreatePolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_policy_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_policy
    ...
    def pre_delete_policy(self, request: policy.DeletePolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy.DeletePolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_policy_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_policy
    ...
    def pre_get_policy(self, request: policy.GetPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy.GetPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_policy_with_metadata(self, response: policy.Policy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy.Policy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_policy
    ...
    def pre_list_policies(self, request: policy.ListPoliciesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy.ListPoliciesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_policies_with_metadata(self, response: policy.ListPoliciesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy.ListPoliciesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_policies
    ...
    def pre_update_policy(self, request: policy.UpdatePolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[policy.UpdatePolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_policy_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_policy
...
class PoliciesRestTransport(_BasePoliciesRestTransport):
    ...
    class _CreatePolicy(_BasePoliciesRestTransport._BaseCreatePolicy, PoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PoliciesRestTransport._CreatePolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeletePolicy(_BasePoliciesRestTransport._BaseDeletePolicy, PoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PoliciesRestTransport._DeletePolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListPolicies(_BasePoliciesRestTransport._BaseListPolicies, PoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PoliciesRestTransport._ListPolicies._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdatePolicy(_BasePoliciesRestTransport._BaseUpdatePolicy, PoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PoliciesRestTransport._UpdatePolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BasePoliciesRestTransport._BaseGetOperation, PoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PoliciesRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class ListPoliciesPager:
    ...
    """
    def __init__(self,
            method: Callable[..., policy.ListPoliciesResponse],
        ...
        """
        self._method = method
        self._request = policy.ListPoliciesRequest(request)
    ...
    @property
    def pages(self) -> Iterator[policy.ListPoliciesResponse]:
    ...
    def __iter__(self) -> Iterator[policy.Policy]:
...
class ListPoliciesAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[policy.ListPoliciesResponse]],
            request: policy.ListPoliciesRequest,
            response: policy.ListPoliciesResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[policy.ListPoliciesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
            yield self._response
    def __aiter__(self) -> AsyncIterator[policy.Policy]:

...
class PoliciesAsyncClient:
    ...
    parse_common_billing_account_path = staticmethod(PoliciesClient.parse_common_billing_account_path)
    ...
    get_transport_class = functools.partial(type(PoliciesClient).get_transport_class, type(PoliciesClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, PoliciesTransport, Callable[..., PoliciesTransport]]] = "grpc_asyncio",

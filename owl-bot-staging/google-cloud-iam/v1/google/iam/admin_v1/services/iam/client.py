...
class IAMClient(metaclass=IAMClientMeta):
    ...
    def list_service_accounts(self,
        ...
        .. code-block:: python
            ...
            def sample_list_service_accounts():
                ...
                request = admin_v1.ListServiceAccountsRequest(
                    name="name_value",
                )
    ...
    def create_service_account_key(self,
        ...
        .. code-block:: python
            ...
            def sample_create_service_account_key():
                ...
                # Initialize request argument(s)
                request = admin_v1.CreateServiceAccountKeyRequest(
                    name="name_value",
                )
    ...
    def upload_service_account_key(self,
        ...
        .. code-block:: python
            ...
            def sample_upload_service_account_key():
                ...
                # Initialize request argument(s)
                request = admin_v1.UploadServiceAccountKeyRequest(
                )
    ...
    def disable_service_account_key(self,
        ...
        Args:
            request (Union[google.iam.admin_v1.types.DisableServiceAccountKeyRequest, dict]):
    ...
    def enable_service_account_key(self,
        ...
        Args:
            request (Union[google.iam.admin_v1.types.EnableServiceAccountKeyRequest, dict]):
    ...
    def get_role(self,
        ...
        .. code-block:: python
            ...
            def sample_get_role():
                ...
                # Initialize request argument(s)
                request = admin_v1.GetRoleRequest(
                )
    ...
    def query_testable_permissions(self,
        ...
        .. code-block:: python
            ...
            def sample_query_testable_permissions():
                ...
                # Initialize request argument(s)
                request = admin_v1.QueryTestablePermissionsRequest(
                )

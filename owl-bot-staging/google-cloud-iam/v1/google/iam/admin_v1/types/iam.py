...
class ListServiceAccountsResponse(proto.Message):
    ...
    Attributes:
        accounts (MutableSequence[google.iam.admin_v1.types.ServiceAccount]):
...
class ListServiceAccountKeysRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            the ``email`` address or the ``unique_id`` of the service
            account.
        key_types (MutableSequence[google.iam.admin_v1.types.ListServiceAccountKeysRequest.KeyType]):
...
class ListServiceAccountKeysResponse(proto.Message):
    ...
    Attributes:
        keys (MutableSequence[google.iam.admin_v1.types.ServiceAccountKey]):
...
class QueryGrantableRolesResponse(proto.Message):
    ...
    Attributes:
        roles (MutableSequence[google.iam.admin_v1.types.Role]):
...
class QueryTestablePermissionsResponse(proto.Message):
    ...
    Attributes:
        permissions (MutableSequence[google.iam.admin_v1.types.Permission]):
...
class QueryAuditableServicesResponse(proto.Message):
    ...
    Attributes:
        services (MutableSequence[google.iam.admin_v1.types.QueryAuditableServicesResponse.AuditableService]):
...
class LintPolicyResponse(proto.Message):
    ...
    Attributes:
        lint_results (MutableSequence[google.iam.admin_v1.types.LintResult]):

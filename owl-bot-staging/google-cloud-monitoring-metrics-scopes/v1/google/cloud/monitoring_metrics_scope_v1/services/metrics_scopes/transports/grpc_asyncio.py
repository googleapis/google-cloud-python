...
class MetricsScopesGrpcAsyncIOTransport(MetricsScopesTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_metrics_scope: self._wrap_method(
                self.get_metrics_scope,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_metrics_scopes_by_monitored_project: self._wrap_method(
                self.list_metrics_scopes_by_monitored_project,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_monitored_project: self._wrap_method(
                self.create_monitored_project,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_monitored_project: self._wrap_method(

...
class MetricsScopesClientMeta(type):
    """Metaclass for the MetricsScopes client.
    ...
    _transport_registry["grpc_asyncio"] = MetricsScopesGrpcAsyncIOTransport
...
class MetricsScopesClient(metaclass=MetricsScopesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            MetricsScopesClient: The constructed client.
        """
    ...
    def transport(self) -> MetricsScopesTransport:
        ...
        Returns:
            MetricsScopesTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def metrics_scope_path(metrics_scope: str,) -> str:
        """Returns a fully-qualified metrics_scope string."""
        return "locations/global/metricsScope/{metrics_scope}".format(metrics_scope=metrics_scope, )

    @staticmethod
    def parse_metrics_scope_path(path: str) -> Dict[str,str]:
        """Parses a metrics_scope path into its component segments."""
        m = re.match(r"^locations/global/metricsScope/(?P<metrics_scope>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def monitored_project_path(metrics_scope: str,project: str,) -> str:
        """Returns a fully-qualified monitored_project string."""
        return "locations/global/metricsScopes/{metrics_scope}/projects/{project}".format(metrics_scope=metrics_scope, project=project, )

    @staticmethod
    def parse_monitored_project_path(path: str) -> Dict[str,str]:
        """Parses a monitored_project path into its component segments."""
        m = re.match(r"^locations/global/metricsScopes/(?P<metrics_scope>.+?)/projects/(?P<project>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = MetricsScopesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = MetricsScopesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = MetricsScopesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = MetricsScopesClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            MetricsScopesClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = MetricsScopesClient._read_environment_variables()
        self._client_cert_source = MetricsScopesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = MetricsScopesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, MetricsScopesTransport)
        if transport_provided:
            # transport is a MetricsScopesTransport instance.
            ...
            self._transport = cast(MetricsScopesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            MetricsScopesClient._get_api_endpoint(
    ...
    def get_metrics_scope(self,
        ...
        # in a metrics_scopes.GetMetricsScopeRequest.
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_metrics_scope]
    ...
    def list_metrics_scopes_by_monitored_project(self,
            request: Optional[Union[metrics_scopes.ListMetricsScopesByMonitoredProjectRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a metrics_scopes.ListMetricsScopesByMonitoredProjectRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, metrics_scopes.ListMetricsScopesByMonitoredProjectRequest):
            request = metrics_scopes.ListMetricsScopesByMonitoredProjectRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_metrics_scopes_by_monitored_project]
    ...
    def create_monitored_project(self,
            request: Optional[Union[metrics_scopes.CreateMonitoredProjectRequest, dict]] = None,
            *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a metrics_scopes.CreateMonitoredProjectRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_monitored_project]
    ...
    def delete_monitored_project(self,
            request: Optional[Union[metrics_scopes.DeleteMonitoredProjectRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a metrics_scopes.DeleteMonitoredProjectRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_monitored_project]

...
from .base import ConfidentialComputingTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ConfidentialComputingRestTransport(ConfidentialComputingTransport):
    """REST backend transport for ConfidentialComputing.
    ...
    class _CreateChallenge(ConfidentialComputingRestStub):
        def __hash__(self):
            return hash("CreateChallenge")
    ...
    class _VerifyAttestation(ConfidentialComputingRestStub):
        def __hash__(self):
            return hash("VerifyAttestation")
    ...
    class _GetLocation(ConfidentialComputingRestStub):
        def __call__(self,
    ...
    class _ListLocations(ConfidentialComputingRestStub):
        def __call__(self,

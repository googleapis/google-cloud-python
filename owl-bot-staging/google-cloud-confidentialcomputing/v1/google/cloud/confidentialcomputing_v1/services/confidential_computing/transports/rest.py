...
class ConfidentialComputingRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_challenge(self, request: service.CreateChallengeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[service.CreateChallengeRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_verify_attestation(self, request: service.VerifyAttestationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[service.VerifyAttestationRequest, Sequence[Tuple[str, str]]]:

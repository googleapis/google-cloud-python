...
from google.cloud.confidentialcomputing_v1alpha1.services.confidential_computing import ConfidentialComputingAsyncClient
from google.cloud.confidentialcomputing_v1alpha1.services.confidential_computing import ConfidentialComputingClient
from google.cloud.confidentialcomputing_v1alpha1.services.confidential_computing import transports
...
@pytest.mark.parametrize("client_class", [
    ConfidentialComputingClient, ConfidentialComputingAsyncClient
])
@mock.patch.object(ConfidentialComputingClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ConfidentialComputingClient))
@mock.patch.object(ConfidentialComputingAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ConfidentialComputingAsyncClient))
...
def test_confidential_computing_client_client_options_from_dict():
    with mock.patch('google.cloud.confidentialcomputing_v1alpha1.services.confidential_computing.transports.ConfidentialComputingGrpcTransport.__init__') as grpc_transport:
...
def test_create_challenge(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_challenge),
            '__call__') as call:
    ...
    assert response.nonce == b'nonce_blob'
...
def test_verify_attestation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.verify_attestation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.VerifyAttestationResponse(
            claims_token=b'claims_token_blob',
        )
    ...
    assert response.claims_token == b'claims_token_blob'
...
def test_create_challenge_rest(request_type):
    ...
    request_init["challenge"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'expire_time': {}, 'used': True, 'nonce': b'nonce_blob'}
...
def test_create_challenge_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ConfidentialComputingRestInterceptor, "post_create_challenge") as post, \
         mock.patch.object(transports.ConfidentialComputingRestInterceptor, "pre_create_challenge") as pre:
...
def test_create_challenge_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*}/challenges" % client.transport._host, args[1])
...
def test_verify_attestation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConfidentialComputingRestInterceptor, "post_verify_attestation") as post, \
         mock.patch.object(transports.ConfidentialComputingRestInterceptor, "pre_verify_attestation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_confidential_computing_base_transport():
    ...
    with mock.patch('google.cloud.confidentialcomputing_v1alpha1.services.confidential_computing.transports.ConfidentialComputingTransport.__init__') as Transport:
...
def test_confidential_computing_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.confidentialcomputing_v1alpha1.services.confidential_computing.transports.ConfidentialComputingTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_confidential_computing_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.confidentialcomputing_v1alpha1.services.confidential_computing.transports.ConfidentialComputingTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ConfidentialComputingTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ConfidentialComputingGrpcTransport, transports.ConfidentialComputingGrpcAsyncIOTransport])
def test_confidential_computing_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

...
def test_create_instance_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["instance"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'private_config': {'is_private': True, 'ca_pool': 'ca_pool_value', 'http_service_attachment': 'http_service_attachment_value', 'ssh_service_attachment': 'ssh_service_attachment_value'}, 'state': 1, 'state_note': 1, 'kms_key': 'kms_key_value', 'host_config': {'html': 'html_value', 'api': 'api_value', 'git_http': 'git_http_value', 'git_ssh': 'git_ssh_value'}}

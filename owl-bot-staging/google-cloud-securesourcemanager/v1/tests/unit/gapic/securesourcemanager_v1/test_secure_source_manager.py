...
def test_list_instances_rest_unset_required_fields():
    transport = transports.SecureSourceManagerRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_repositories_rest_required_fields(request_type=secure_source_manager.ListRepositoriesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_repositories._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_repository_rest_required_fields(request_type=secure_source_manager.GetRepositoryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_repository._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_repository_rest_required_fields(request_type=secure_source_manager.CreateRepositoryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_repository._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_repository_rest_required_fields(request_type=secure_source_manager.DeleteRepositoryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_repository._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_iam_policy_repo_rest_required_fields(request_type=iam_policy_pb2.GetIamPolicyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_iam_policy_repo._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_iam_policy_repo_rest_required_fields(request_type=iam_policy_pb2.SetIamPolicyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_iam_policy_repo._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_test_iam_permissions_repo_rest_required_fields(request_type=iam_policy_pb2.TestIamPermissionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).test_iam_permissions_repo._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

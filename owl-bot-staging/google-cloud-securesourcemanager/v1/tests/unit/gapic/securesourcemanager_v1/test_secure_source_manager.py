...
from google.cloud.securesourcemanager_v1.services.secure_source_manager import SecureSourceManagerAsyncClient
...
from google.cloud.securesourcemanager_v1.services.secure_source_manager import transports
...
def test__read_environment_variables():
    assert SecureSourceManagerClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SecureSourceManagerClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SecureSourceManagerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SecureSourceManagerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SecureSourceManagerClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert SecureSourceManagerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SecureSourceManagerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert SecureSourceManagerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SecureSourceManagerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(SecureSourceManagerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecureSourceManagerClient))
@mock.patch.object(SecureSourceManagerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecureSourceManagerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SecureSourceManagerClient._DEFAULT_UNIVERSE
    default_endpoint = SecureSourceManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SecureSourceManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SecureSourceManagerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SecureSourceManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SecureSourceManagerClient.DEFAULT_MTLS_ENDPOINT
    assert SecureSourceManagerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SecureSourceManagerClient._get_api_endpoint(None, None, default_universe, "always") == SecureSourceManagerClient.DEFAULT_MTLS_ENDPOINT
    assert SecureSourceManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SecureSourceManagerClient.DEFAULT_MTLS_ENDPOINT
    assert SecureSourceManagerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SecureSourceManagerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SecureSourceManagerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SecureSourceManagerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SecureSourceManagerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SecureSourceManagerClient._get_universe_domain(None, None) == SecureSourceManagerClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (SecureSourceManagerClient, transports.SecureSourceManagerGrpcTransport, "grpc"),
    (SecureSourceManagerAsyncClient, transports.SecureSourceManagerGrpcAsyncIOTransport, "grpc_asyncio"),
    (SecureSourceManagerClient, transports.SecureSourceManagerRestTransport, "rest"),
])
@mock.patch.object(SecureSourceManagerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecureSourceManagerClient))
@mock.patch.object(SecureSourceManagerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecureSourceManagerAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (SecureSourceManagerClient, transports.SecureSourceManagerGrpcTransport, "grpc", "true"),
    (SecureSourceManagerAsyncClient, transports.SecureSourceManagerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (SecureSourceManagerClient, transports.SecureSourceManagerGrpcTransport, "grpc", "false"),
    (SecureSourceManagerAsyncClient, transports.SecureSourceManagerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (SecureSourceManagerClient, transports.SecureSourceManagerRestTransport, "rest", "true"),
    (SecureSourceManagerClient, transports.SecureSourceManagerRestTransport, "rest", "false"),
])
@mock.patch.object(SecureSourceManagerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecureSourceManagerClient))
@mock.patch.object(SecureSourceManagerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecureSourceManagerAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    SecureSourceManagerClient, SecureSourceManagerAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (SecureSourceManagerClient, transports.SecureSourceManagerGrpcTransport, "grpc", grpc_helpers),
    (SecureSourceManagerAsyncClient, transports.SecureSourceManagerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (SecureSourceManagerClient, transports.SecureSourceManagerRestTransport, "rest", None),
])
...
def test_list_instances_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, secure_source_manager.Instance)
                   for i in results)
...
def test_list_repositories_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_repositories] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_repositories_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_repositories in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_repositories] = mock_rpc
...
def test_list_repositories_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, secure_source_manager.Repository)
                   for i in results)
...
@pytest.mark.asyncio
async def test_get_repository_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_repository in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_repository] = mock_rpc
...
def test_create_repository_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_repository] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_repository_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_repository in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_repository] = mock_rpc
...
def test_delete_repository_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_repository] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_repository_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_repository in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_repository] = mock_rpc
...
def test_get_iam_policy_repo(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_iam_policy_repo),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_iam_policy_repo_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_iam_policy_repo in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_iam_policy_repo] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_iam_policy_repo_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_iam_policy_repo in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_iam_policy_repo] = mock_rpc
...
def test_set_iam_policy_repo(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.set_iam_policy_repo),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = policy_pb2.Policy(
            version=774,
...
def test_set_iam_policy_repo_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.set_iam_policy_repo in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_iam_policy_repo] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_set_iam_policy_repo_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.set_iam_policy_repo in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.set_iam_policy_repo] = mock_rpc
...
def test_test_iam_permissions_repo(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.test_iam_permissions_repo),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_test_iam_permissions_repo_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.test_iam_permissions_repo in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.test_iam_permissions_repo] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_test_iam_permissions_repo_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.test_iam_permissions_repo in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.test_iam_permissions_repo] = mock_rpc
...
def test_create_branch_rule(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_branch_rule),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_branch_rule_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_branch_rule in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_branch_rule] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_branch_rule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_branch_rule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_branch_rule] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_branch_rule_async(transport: str = 'grpc_asyncio', request_type=secure_source_manager.CreateBranchRuleRequest):
    client = SecureSourceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_branch_rules_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_branch_rules] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_branch_rules_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_branch_rules in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_branch_rules] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_branch_rules_async(transport: str = 'grpc_asyncio', request_type=secure_source_manager.ListBranchRulesRequest):
    client = SecureSourceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(secure_source_manager.ListBranchRulesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_branch_rules_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, secure_source_manager.BranchRule)
                   for i in results)
...
async def test_list_branch_rules_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_branch_rules(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_branch_rule(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_branch_rule),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_branch_rule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_branch_rule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_branch_rule] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_branch_rule_async(transport: str = 'grpc_asyncio', request_type=secure_source_manager.GetBranchRuleRequest):
    client = SecureSourceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(secure_source_manager.BranchRule(
            name='name_value',
            uid='uid_value',
            etag='etag_value',
            include_pattern='include_pattern_value',
...
def test_update_branch_rule(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_branch_rule),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_branch_rule_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_branch_rule in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_branch_rule] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_branch_rule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_branch_rule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_branch_rule] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_branch_rule_async(transport: str = 'grpc_asyncio', request_type=secure_source_manager.UpdateBranchRuleRequest):
    client = SecureSourceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_branch_rule(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_branch_rule),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_branch_rule_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_branch_rule in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_branch_rule] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_branch_rule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecureSourceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_branch_rule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_branch_rule] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_branch_rule_async(transport: str = 'grpc_asyncio', request_type=secure_source_manager.DeleteBranchRuleRequest):
    client = SecureSourceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_repositories_rest_required_fields(request_type=secure_source_manager.ListRepositoriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_repositories._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("filter", "instance", "page_size", "page_token", ))
    jsonified_request.update(unset_fields)
...
def test_list_repositories_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "instance", "pageSize", "pageToken", )) & set(("parent", )))
...
def test_create_branch_rule_rest_required_fields(request_type=secure_source_manager.CreateBranchRuleRequest):
    transport_class = transports.SecureSourceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_branch_rule._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_branch_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("branchRuleId", )) & set(("parent", "branchRule", "branchRuleId", )))
...
def test_create_branch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/repositories/*}/branchRules" % client.transport._host, args[1])
...
def test_list_branch_rules_rest_required_fields(request_type=secure_source_manager.ListBranchRulesRequest):
    transport_class = transports.SecureSourceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_branch_rules._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_branch_rules_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(secure_source_manager.ListBranchRulesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_branch_rule_rest_required_fields(request_type=secure_source_manager.GetBranchRuleRequest):
    transport_class = transports.SecureSourceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_branch_rule._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_branch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/repositories/sample3/branchRules/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/repositories/*/branchRules/*}" % client.transport._host, args[1])
...
def test_update_branch_rule_rest_required_fields(request_type=secure_source_manager.UpdateBranchRuleRequest):
    transport_class = transports.SecureSourceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_branch_rule._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_branch_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("branchRule", "updateMask", )))
...
def test_update_branch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'branch_rule': {'name': 'projects/sample1/locations/sample2/repositories/sample3/branchRules/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{branch_rule.name=projects/*/locations/*/repositories/*/branchRules/*}" % client.transport._host, args[1])
...
def test_delete_branch_rule_rest_required_fields(request_type=secure_source_manager.DeleteBranchRuleRequest):
    transport_class = transports.SecureSourceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_branch_rule._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_instances_rest_bad_request(request_type=secure_source_manager.ListInstancesRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_instances_rest_interceptors(null_interceptor):
    transport = transports.SecureSourceManagerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SecureSourceManagerRestInterceptor(),
        )
    client = SecureSourceManagerClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_list_instances") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_list_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_list_instances") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = secure_source_manager.ListInstancesResponse.to_json(secure_source_manager.ListInstancesResponse())
        ...
        post_with_metadata.return_value = secure_source_manager.ListInstancesResponse(), metadata
...
def test_get_instance_rest_bad_request(request_type=secure_source_manager.GetInstanceRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_get_instance") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_get_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_get_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = secure_source_manager.Instance.to_json(secure_source_manager.Instance())
        req.return_value.content = return_value
...
def test_create_instance_rest_bad_request(request_type=secure_source_manager.CreateInstanceRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_create_instance") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_create_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_create_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_instance_rest_bad_request(request_type=secure_source_manager.DeleteInstanceRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_delete_instance") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_delete_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_delete_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_repositories_rest_bad_request(request_type=secure_source_manager.ListRepositoriesRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_repositories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_list_repositories") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_list_repositories_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_list_repositories") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = secure_source_manager.ListRepositoriesResponse.to_json(secure_source_manager.ListRepositoriesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = secure_source_manager.ListRepositoriesResponse(), metadata
...
def test_get_repository_rest_bad_request(request_type=secure_source_manager.GetRepositoryRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_get_repository") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_get_repository_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_get_repository") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = secure_source_manager.Repository.to_json(secure_source_manager.Repository())
        req.return_value.content = return_value
...
def test_create_repository_rest_bad_request(request_type=secure_source_manager.CreateRepositoryRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_create_repository") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_create_repository_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_create_repository") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_repository_rest_bad_request(request_type=secure_source_manager.DeleteRepositoryRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_delete_repository") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_delete_repository_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_delete_repository") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_iam_policy_repo_rest_bad_request(request_type=iam_policy_pb2.GetIamPolicyRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_iam_policy_repo_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_get_iam_policy_repo") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_get_iam_policy_repo_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_get_iam_policy_repo") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_repo_rest_bad_request(request_type=iam_policy_pb2.SetIamPolicyRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_iam_policy_repo_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_set_iam_policy_repo") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_set_iam_policy_repo_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_set_iam_policy_repo") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_repo_rest_bad_request(request_type=iam_policy_pb2.TestIamPermissionsRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_repo_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_test_iam_permissions_repo") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_test_iam_permissions_repo_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_test_iam_permissions_repo") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_branch_rule_rest_bad_request(request_type=secure_source_manager.CreateBranchRuleRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_branch_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_create_branch_rule") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_create_branch_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_create_branch_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = secure_source_manager.CreateBranchRuleRequest.pb(secure_source_manager.CreateBranchRuleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_branch_rule(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_branch_rules_rest_bad_request(request_type=secure_source_manager.ListBranchRulesRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_branch_rules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_list_branch_rules") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_list_branch_rules_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_list_branch_rules") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = secure_source_manager.ListBranchRulesRequest.pb(secure_source_manager.ListBranchRulesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = secure_source_manager.ListBranchRulesResponse.to_json(secure_source_manager.ListBranchRulesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = secure_source_manager.ListBranchRulesResponse(), metadata

        client.list_branch_rules(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_branch_rule_rest_bad_request(request_type=secure_source_manager.GetBranchRuleRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/repositories/sample3/branchRules/sample4'}
    request = request_type(**request_init)
...
def test_get_branch_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_get_branch_rule") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_get_branch_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_get_branch_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = secure_source_manager.GetBranchRuleRequest.pb(secure_source_manager.GetBranchRuleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = secure_source_manager.BranchRule.to_json(secure_source_manager.BranchRule())
        req.return_value.content = return_value
        ...
        client.get_branch_rule(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_branch_rule_rest_bad_request(request_type=secure_source_manager.UpdateBranchRuleRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'branch_rule': {'name': 'projects/sample1/locations/sample2/repositories/sample3/branchRules/sample4'}}
    request = request_type(**request_init)
...
def test_update_branch_rule_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'branch_rule': {'name': 'projects/sample1/locations/sample2/repositories/sample3/branchRules/sample4'}}
    request_init["branch_rule"] = {'name': 'projects/sample1/locations/sample2/repositories/sample3/branchRules/sample4', 'uid': 'uid_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'annotations': {}, 'etag': 'etag_value', 'include_pattern': 'include_pattern_value', 'disabled': True, 'require_pull_request': True, 'minimum_reviews_count': 2280, 'minimum_approvals_count': 2491, 'require_comments_resolved': True, 'allow_stale_reviews': True, 'require_linear_history': True, 'required_status_checks': [{'context': 'context_value'}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = secure_source_manager.UpdateBranchRuleRequest.meta.fields["branch_rule"]
...
def test_update_branch_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_update_branch_rule") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_update_branch_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_update_branch_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = secure_source_manager.UpdateBranchRuleRequest.pb(secure_source_manager.UpdateBranchRuleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_branch_rule(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_branch_rule_rest_bad_request(request_type=secure_source_manager.DeleteBranchRuleRequest):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_branch_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_delete_branch_rule") as post, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "post_delete_branch_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecureSourceManagerRestInterceptor, "pre_delete_branch_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = secure_source_manager.DeleteBranchRuleRequest.pb(secure_source_manager.DeleteBranchRuleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_branch_rule(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_secure_source_manager_host_no_port(transport_name):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='securesourcemanager.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'securesourcemanager.googleapis.com:443'
...
def test_secure_source_manager_host_with_port(transport_name):
    client = SecureSourceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='securesourcemanager.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.SecureSourceManagerGrpcTransport, transports.SecureSourceManagerGrpcAsyncIOTransport])
def test_secure_source_manager_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_branch_rule_path():
    ...
    repository = "whelk"
    branch_rule = "octopus"
    expected = "projects/{project}/locations/{location}/repositories/{repository}/branchRules/{branch_rule}".format(project=project, location=location, repository=repository, branch_rule=branch_rule, )
    actual = SecureSourceManagerClient.branch_rule_path(project, location, repository, branch_rule)
...
def test_service_attachment_path():
    ...
    actual = SecureSourceManagerClient.service_attachment_path(project, region, service_attachment)
    assert expected == actual
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (SecureSourceManagerAsyncClient, transports.SecureSourceManagerGrpcAsyncIOTransport),
])

...
from .transports.grpc import SecureSourceManagerGrpcTransport
from .transports.grpc_asyncio import SecureSourceManagerGrpcAsyncIOTransport
from .transports.rest import SecureSourceManagerRestTransport


class SecureSourceManagerClientMeta(type):
    """Metaclass for the SecureSourceManager client.
...
class SecureSourceManagerClient(metaclass=SecureSourceManagerClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "securesourcemanager.{UNIVERSE_DOMAIN}"
    ...
    def transport(self) -> SecureSourceManagerTransport:
        ...
        Returns:
            SecureSourceManagerTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def branch_rule_path(project: str,location: str,repository: str,branch_rule: str,) -> str:
        """Returns a fully-qualified branch_rule string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/branchRules/{branch_rule}".format(project=project, location=location, repository=repository, branch_rule=branch_rule, )

    @staticmethod
    def parse_branch_rule_path(path: str) -> Dict[str,str]:
        """Parses a branch_rule path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/branchRules/(?P<branch_rule>.+?)$", path)
    ...
    @staticmethod
    def hook_path(project: str,location: str,repository: str,hook: str,) -> str:
        """Returns a fully-qualified hook string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/hooks/{hook}".format(project=project, location=location, repository=repository, hook=hook, )

    @staticmethod
    def parse_hook_path(path: str) -> Dict[str,str]:
        """Parses a hook path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/hooks/(?P<hook>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def issue_path(project: str,location: str,repository: str,issue: str,) -> str:
        """Returns a fully-qualified issue string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/issues/{issue}".format(project=project, location=location, repository=repository, issue=issue, )

    @staticmethod
    def parse_issue_path(path: str) -> Dict[str,str]:
        """Parses a issue path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/issues/(?P<issue>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def issue_comment_path(project: str,location: str,repository: str,issue: str,comment: str,) -> str:
        """Returns a fully-qualified issue_comment string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/issues/{issue}/issueComments/{comment}".format(project=project, location=location, repository=repository, issue=issue, comment=comment, )

    @staticmethod
    def parse_issue_comment_path(path: str) -> Dict[str,str]:
        """Parses a issue_comment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/issues/(?P<issue>.+?)/issueComments/(?P<comment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def pull_request_path(project: str,location: str,repository: str,pull_request: str,) -> str:
        """Returns a fully-qualified pull_request string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/pullRequests/{pull_request}".format(project=project, location=location, repository=repository, pull_request=pull_request, )

    @staticmethod
    def parse_pull_request_path(path: str) -> Dict[str,str]:
        """Parses a pull_request path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/pullRequests/(?P<pull_request>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def pull_request_comment_path(project: str,location: str,repository: str,pull_request: str,comment: str,) -> str:
        """Returns a fully-qualified pull_request_comment string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/pullRequests/{pull_request}/pullRequestComments/{comment}".format(project=project, location=location, repository=repository, pull_request=pull_request, comment=comment, )

    @staticmethod
    def parse_pull_request_comment_path(path: str) -> Dict[str,str]:
        """Parses a pull_request_comment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/pullRequests/(?P<pull_request>.+?)/pullRequestComments/(?P<comment>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SecureSourceManagerClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SecureSourceManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SecureSourceManagerClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SecureSourceManagerTransport, Callable[..., SecureSourceManagerTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SecureSourceManagerClient._read_environment_variables()
        self._client_cert_source = SecureSourceManagerClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SecureSourceManagerClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SecureSourceManagerTransport)
        if transport_provided:
            # transport is a SecureSourceManagerTransport instance.
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SecureSourceManagerTransport], Callable[..., SecureSourceManagerTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.securesourcemanager_v1.SecureSourceManagerClient`.",
                    extra = {
    ...
    def get_iam_policy_repo(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_iam_policy_repo]
    ...
    def set_iam_policy_repo(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.set_iam_policy_repo]
    ...
    def test_iam_permissions_repo(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.test_iam_permissions_repo]
    ...
    def create_branch_rule(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_branch_rule]
    ...
    def list_branch_rules(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_branch_rules]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListBranchRulesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_branch_rule(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_branch_rule]
    ...
    def update_branch_rule(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_branch_rule]
    ...
    def list_pull_request_file_diffs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_pull_request_file_diffs]
    ...
    def list_pull_request_comments(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_pull_request_comments]
    ...
    def create_pull_request_comment(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_pull_request_comment]
    ...
    def update_pull_request_comment(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_pull_request_comment]
    ...
    def delete_pull_request_comment(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_pull_request_comment]
    ...
    def batch_create_pull_request_comments(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_create_pull_request_comments]
    ...
    def resolve_pull_request_comments(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.resolve_pull_request_comments]
    ...
    def unresolve_pull_request_comments(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.unresolve_pull_request_comments]
    ...
    def __enter__(self) -> "SecureSourceManagerClient":
        return self

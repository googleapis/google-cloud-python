...
class RecaptchaEnterpriseServiceClient(metaclass=RecaptchaEnterpriseServiceClientMeta):
    ...
    def assessment_path(project: str,assessment: str,) -> str:
        ...
        return "projects/{project}/assessments/{assessment}".format(project=project, assessment=assessment, )

    @staticmethod
    def parse_assessment_path(path: str) -> Dict[str,str]:
        """Parses a assessment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/assessments/(?P<assessment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def firewall_policy_path(project: str,firewallpolicy: str,) -> str:
        """Returns a fully-qualified firewall_policy string."""
        return "projects/{project}/firewallpolicies/{firewallpolicy}".format(project=project, firewallpolicy=firewallpolicy, )

    @staticmethod
    def parse_firewall_policy_path(path: str) -> Dict[str,str]:
        """Parses a firewall_policy path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/firewallpolicies/(?P<firewallpolicy>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def metrics_path(project: str,key: str,) -> str:
        """Returns a fully-qualified metrics string."""
        return "projects/{project}/keys/{key}/metrics".format(project=project, key=key, )
    ...
    @staticmethod
    def related_account_group_path(project: str,relatedaccountgroup: str,) -> str:
        """Returns a fully-qualified related_account_group string."""
        return "projects/{project}/relatedaccountgroups/{relatedaccountgroup}".format(project=project, relatedaccountgroup=relatedaccountgroup, )
    ...
    def parse_related_account_group_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/relatedaccountgroups/(?P<relatedaccountgroup>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def related_account_group_membership_path(project: str,relatedaccountgroup: str,membership: str,) -> str:
        """Returns a fully-qualified related_account_group_membership string."""
        return "projects/{project}/relatedaccountgroups/{relatedaccountgroup}/memberships/{membership}".format(project=project, relatedaccountgroup=relatedaccountgroup, membership=membership, )
    ...
    def parse_related_account_group_membership_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/relatedaccountgroups/(?P<relatedaccountgroup>.+?)/memberships/(?P<membership>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RecaptchaEnterpriseServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            RecaptchaEnterpriseServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RecaptchaEnterpriseServiceTransport, Callable[..., RecaptchaEnterpriseServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RecaptchaEnterpriseServiceClient._read_environment_variables()
        self._client_cert_source = RecaptchaEnterpriseServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RecaptchaEnterpriseServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RecaptchaEnterpriseServiceTransport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RecaptchaEnterpriseServiceTransport], Callable[..., RecaptchaEnterpriseServiceTransport]] = (
    ...
    def retrieve_legacy_secret_key(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.retrieve_legacy_secret_key]
    ...
    def remove_ip_override(self,
        ...
        .. code-block:: python
            ...
            def sample_remove_ip_override():
                ...
                # Make the request
                response = client.remove_ip_override(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.remove_ip_override]
    ...
    def list_ip_overrides(self,
        ...
        Args:
            request (Union[google.cloud.recaptchaenterprise_v1.types.ListIpOverridesRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_ip_overrides]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListIpOverridesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def update_firewall_policy(self,
    ...
    def delete_firewall_policy(self,
    ...
    def reorder_firewall_policies(self,
        ...
        .. code-block:: python
            ...
            def sample_reorder_firewall_policies():
                # Create a client
                client = recaptchaenterprise_v1.RecaptchaEnterpriseServiceClient()
                ...
                # Make the request
                response = client.reorder_firewall_policies(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.recaptchaenterprise_v1.types.ReorderFirewallPoliciesRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reorder_firewall_policies]
    ...
    def list_related_account_groups(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_related_account_groups]
    ...
    def list_related_account_group_memberships(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_related_account_group_memberships]
    ...
    def search_related_account_group_memberships(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_related_account_group_memberships]

...
class RecaptchaEnterpriseServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(RecaptchaEnterpriseServiceClient).get_transport_class, type(RecaptchaEnterpriseServiceClient))
    ...
    async def retrieve_legacy_secret_key(self,
    ...
    async def create_firewall_policy(self,
    ...
    async def list_firewall_policies(self,
    ...
    async def get_firewall_policy(self,
    ...
    async def update_firewall_policy(self,
    ...
    async def delete_firewall_policy(self,
    ...
    async def reorder_firewall_policies(self,
    ...
    async def list_related_account_groups(self,
    ...
    async def list_related_account_group_memberships(self,
    ...
    async def search_related_account_group_memberships(self,

...
class RecaptchaEnterpriseServiceGrpcTransport(RecaptchaEnterpriseServiceTransport):
    ...
    @property
    def retrieve_legacy_secret_key(self) -> Callable[
    ...
    @property
    def add_ip_override(self) -> Callable[
    ...
    @property
    def remove_ip_override(self) -> Callable[
    ...
    @property
    def list_ip_overrides(self) -> Callable[
    ...
    @property
    def create_firewall_policy(self) -> Callable[
    ...
    @property
    def list_firewall_policies(self) -> Callable[
    ...
    @property
    def get_firewall_policy(self) -> Callable[
    ...
    @property
    def update_firewall_policy(self) -> Callable[
    ...
    @property
    def delete_firewall_policy(self) -> Callable[
    ...
    @property
    def reorder_firewall_policies(self) -> Callable[
    ...
    def list_related_account_group_memberships(self) -> Callable[
        ...
        if 'list_related_account_group_memberships' not in self._stubs:
            self._stubs['list_related_account_group_memberships'] = self.grpc_channel.unary_unary(
    ...
    def search_related_account_group_memberships(self) -> Callable[
        ...
        if 'search_related_account_group_memberships' not in self._stubs:
            self._stubs['search_related_account_group_memberships'] = self.grpc_channel.unary_unary(

...
from google.cloud.oracledatabase_v1.types import autonomous_database_character_set
from google.cloud.oracledatabase_v1.types import autonomous_db_backup
from google.cloud.oracledatabase_v1.types import autonomous_db_version
from google.cloud.oracledatabase_v1.types import db_node
from google.cloud.oracledatabase_v1.types import db_server
from google.cloud.oracledatabase_v1.types import db_system_shape
from google.cloud.oracledatabase_v1.types import entitlement
from google.cloud.oracledatabase_v1.types import exadata_infra
from google.cloud.oracledatabase_v1.types import gi_version
from google.cloud.oracledatabase_v1.types import oracledatabase
from google.cloud.oracledatabase_v1.types import vm_cluster
from google.longrunning import operations_pb2 # type: ignore
from google.protobuf import empty_pb2  # type: ignore
from google.protobuf import timestamp_pb2  # type: ignore
from .transports.base import OracleDatabaseTransport, DEFAULT_CLIENT_INFO
...
class OracleDatabaseClient(metaclass=OracleDatabaseClientMeta):
    ...
    @staticmethod
    def autonomous_database_path(project: str,location: str,autonomous_database: str,) -> str:
        """Returns a fully-qualified autonomous_database string."""
        return "projects/{project}/locations/{location}/autonomousDatabases/{autonomous_database}".format(project=project, location=location, autonomous_database=autonomous_database, )
    ...
    @staticmethod
    def autonomous_database_backup_path(project: str,location: str,autonomous_database_backup: str,) -> str:
        """Returns a fully-qualified autonomous_database_backup string."""
        return "projects/{project}/locations/{location}/autonomousDatabaseBackups/{autonomous_database_backup}".format(project=project, location=location, autonomous_database_backup=autonomous_database_backup, )
    ...
    @staticmethod
    def autonomous_database_character_set_path(project: str,location: str,autonomous_database_character_set: str,) -> str:
        """Returns a fully-qualified autonomous_database_character_set string."""
        return "projects/{project}/locations/{location}/autonomousDatabaseCharacterSets/{autonomous_database_character_set}".format(project=project, location=location, autonomous_database_character_set=autonomous_database_character_set, )
    ...
    def parse_autonomous_database_character_set_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/autonomousDatabaseCharacterSets/(?P<autonomous_database_character_set>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def autonomous_db_version_path(project: str,location: str,autonomous_db_version: str,) -> str:
        """Returns a fully-qualified autonomous_db_version string."""
        return "projects/{project}/locations/{location}/autonomousDbVersions/{autonomous_db_version}".format(project=project, location=location, autonomous_db_version=autonomous_db_version, )
    ...
    @staticmethod
    def cloud_exadata_infrastructure_path(project: str,location: str,cloud_exadata_infrastructure: str,) -> str:
        """Returns a fully-qualified cloud_exadata_infrastructure string."""
        return "projects/{project}/locations/{location}/cloudExadataInfrastructures/{cloud_exadata_infrastructure}".format(project=project, location=location, cloud_exadata_infrastructure=cloud_exadata_infrastructure, )
    ...
    def parse_cloud_exadata_infrastructure_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/cloudExadataInfrastructures/(?P<cloud_exadata_infrastructure>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def cloud_vm_cluster_path(project: str,location: str,cloud_vm_cluster: str,) -> str:
        """Returns a fully-qualified cloud_vm_cluster string."""
        return "projects/{project}/locations/{location}/cloudVmClusters/{cloud_vm_cluster}".format(project=project, location=location, cloud_vm_cluster=cloud_vm_cluster, )
    ...
    @staticmethod
    def db_node_path(project: str,location: str,cloud_vm_cluster: str,db_node: str,) -> str:
        """Returns a fully-qualified db_node string."""
        return "projects/{project}/locations/{location}/cloudVmClusters/{cloud_vm_cluster}/dbNodes/{db_node}".format(project=project, location=location, cloud_vm_cluster=cloud_vm_cluster, db_node=db_node, )

    @staticmethod
    def parse_db_node_path(path: str) -> Dict[str,str]:
        """Parses a db_node path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/cloudVmClusters/(?P<cloud_vm_cluster>.+?)/dbNodes/(?P<db_node>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def db_server_path(project: str,location: str,cloud_exadata_infrastructure: str,db_server: str,) -> str:
        """Returns a fully-qualified db_server string."""
        return "projects/{project}/locations/{location}/cloudExadataInfrastructures/{cloud_exadata_infrastructure}/dbServers/{db_server}".format(project=project, location=location, cloud_exadata_infrastructure=cloud_exadata_infrastructure, db_server=db_server, )

    @staticmethod
    def parse_db_server_path(path: str) -> Dict[str,str]:
        """Parses a db_server path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/cloudExadataInfrastructures/(?P<cloud_exadata_infrastructure>.+?)/dbServers/(?P<db_server>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def db_system_shape_path(project: str,location: str,db_system_shape: str,) -> str:
        """Returns a fully-qualified db_system_shape string."""
        return "projects/{project}/locations/{location}/dbSystemShapes/{db_system_shape}".format(project=project, location=location, db_system_shape=db_system_shape, )
    ...
    @staticmethod
    def gi_version_path(project: str,location: str,gi_version: str,) -> str:
        """Returns a fully-qualified gi_version string."""
        return "projects/{project}/locations/{location}/giVersions/{gi_version}".format(project=project, location=location, gi_version=gi_version, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            OracleDatabaseClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def list_cloud_exadata_infrastructures(self,
    ...
    def create_cloud_exadata_infrastructure(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, cloud_exadata_infrastructure, cloud_exadata_infrastructure_id])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def delete_cloud_exadata_infrastructure(self,
    ...
    def list_cloud_vm_clusters(self,
    ...
    def create_cloud_vm_cluster(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, cloud_vm_cluster, cloud_vm_cluster_id])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def delete_cloud_vm_cluster(self,
    ...
    def list_db_system_shapes(self,
    ...
    def create_autonomous_database(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, autonomous_database, autonomous_database_id])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def restore_autonomous_database(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([name, restore_time])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def generate_autonomous_database_wallet(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([name, type_, is_regional, password])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list_autonomous_db_versions(self,
    ...
    def list_autonomous_database_character_sets(self,
    ...
    def list_autonomous_database_backups(self,

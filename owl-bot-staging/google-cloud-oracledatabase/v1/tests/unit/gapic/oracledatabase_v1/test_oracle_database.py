...
def test_list_cloud_exadata_infrastructures_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = oracledatabase.ListCloudExadataInfrastructuresResponse.to_json(oracledatabase.ListCloudExadataInfrastructuresResponse())
...
def test_list_cloud_exadata_infrastructures_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.ListCloudExadataInfrastructuresRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_cloud_exadata_infrastructure_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = exadata_infra.CloudExadataInfrastructure.to_json(exadata_infra.CloudExadataInfrastructure())
...
def test_get_cloud_exadata_infrastructure_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.GetCloudExadataInfrastructureRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_cloud_exadata_infrastructure_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.CreateCloudExadataInfrastructureRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_cloud_exadata_infrastructure_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.DeleteCloudExadataInfrastructureRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_cloud_vm_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = oracledatabase.ListCloudVmClustersResponse.to_json(oracledatabase.ListCloudVmClustersResponse())
...
def test_list_cloud_vm_clusters_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.ListCloudVmClustersRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_cloud_vm_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vm_cluster.CloudVmCluster.to_json(vm_cluster.CloudVmCluster())
...
def test_get_cloud_vm_cluster_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.GetCloudVmClusterRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_cloud_vm_cluster_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.CreateCloudVmClusterRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_cloud_vm_cluster_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.DeleteCloudVmClusterRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_entitlements_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = oracledatabase.ListEntitlementsResponse.to_json(oracledatabase.ListEntitlementsResponse())
...
def test_list_entitlements_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.ListEntitlementsRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_db_servers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = oracledatabase.ListDbServersResponse.to_json(oracledatabase.ListDbServersResponse())
...
def test_list_db_servers_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.ListDbServersRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_db_nodes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = oracledatabase.ListDbNodesResponse.to_json(oracledatabase.ListDbNodesResponse())
...
def test_list_db_nodes_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.ListDbNodesRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_gi_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = oracledatabase.ListGiVersionsResponse.to_json(oracledatabase.ListGiVersionsResponse())
...
def test_list_gi_versions_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.ListGiVersionsRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_db_system_shapes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = oracledatabase.ListDbSystemShapesResponse.to_json(oracledatabase.ListDbSystemShapesResponse())
...
def test_list_db_system_shapes_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.ListDbSystemShapesRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_autonomous_databases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = oracledatabase.ListAutonomousDatabasesResponse.to_json(oracledatabase.ListAutonomousDatabasesResponse())
...
def test_list_autonomous_databases_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.ListAutonomousDatabasesRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_autonomous_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = autonomous_database.AutonomousDatabase.to_json(autonomous_database.AutonomousDatabase())
...
def test_get_autonomous_database_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.GetAutonomousDatabaseRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_autonomous_database_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.CreateAutonomousDatabaseRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_autonomous_database_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.DeleteAutonomousDatabaseRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_restore_autonomous_database_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.RestoreAutonomousDatabaseRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_generate_autonomous_database_wallet_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = oracledatabase.GenerateAutonomousDatabaseWalletResponse.to_json(oracledatabase.GenerateAutonomousDatabaseWalletResponse())
...
def test_generate_autonomous_database_wallet_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.GenerateAutonomousDatabaseWalletRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_autonomous_db_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = oracledatabase.ListAutonomousDbVersionsResponse.to_json(oracledatabase.ListAutonomousDbVersionsResponse())
...
def test_list_autonomous_database_character_sets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = oracledatabase.ListAutonomousDatabaseCharacterSetsResponse.to_json(oracledatabase.ListAutonomousDatabaseCharacterSetsResponse())
...
def test_list_autonomous_database_character_sets_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.ListAutonomousDatabaseCharacterSetsRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_autonomous_database_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = oracledatabase.ListAutonomousDatabaseBackupsResponse.to_json(oracledatabase.ListAutonomousDatabaseBackupsResponse())
...
def test_list_autonomous_database_backups_rest_bad_request(transport: str = 'rest', request_type=oracledatabase.ListAutonomousDatabaseBackupsRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

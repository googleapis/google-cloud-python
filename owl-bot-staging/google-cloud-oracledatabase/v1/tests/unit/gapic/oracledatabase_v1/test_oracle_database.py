...
from google.cloud.oracledatabase_v1.services.oracle_database import OracleDatabaseAsyncClient
from google.cloud.oracledatabase_v1.services.oracle_database import OracleDatabaseClient
from google.cloud.oracledatabase_v1.services.oracle_database import pagers
from google.cloud.oracledatabase_v1.services.oracle_database import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert OracleDatabaseClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert OracleDatabaseClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert OracleDatabaseClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert OracleDatabaseClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert OracleDatabaseClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert OracleDatabaseClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert OracleDatabaseClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert OracleDatabaseClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert OracleDatabaseClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert OracleDatabaseClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert OracleDatabaseClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert OracleDatabaseClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert OracleDatabaseClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert OracleDatabaseClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(OracleDatabaseClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OracleDatabaseClient))
@mock.patch.object(OracleDatabaseAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OracleDatabaseAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = OracleDatabaseClient._DEFAULT_UNIVERSE
    default_endpoint = OracleDatabaseClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = OracleDatabaseClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert OracleDatabaseClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert OracleDatabaseClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == OracleDatabaseClient.DEFAULT_MTLS_ENDPOINT
    assert OracleDatabaseClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert OracleDatabaseClient._get_api_endpoint(None, None, default_universe, "always") == OracleDatabaseClient.DEFAULT_MTLS_ENDPOINT
    assert OracleDatabaseClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == OracleDatabaseClient.DEFAULT_MTLS_ENDPOINT
    assert OracleDatabaseClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert OracleDatabaseClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        OracleDatabaseClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert OracleDatabaseClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert OracleDatabaseClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert OracleDatabaseClient._get_universe_domain(None, None) == OracleDatabaseClient._DEFAULT_UNIVERSE
...
def test_oracle_database_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (OracleDatabaseAsyncClient, transports.OracleDatabaseGrpcAsyncIOTransport, "grpc_asyncio"),
    (OracleDatabaseClient, transports.OracleDatabaseRestTransport, "rest"),
])
@mock.patch.object(OracleDatabaseClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OracleDatabaseClient))
@mock.patch.object(OracleDatabaseAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OracleDatabaseAsyncClient))
def test_oracle_database_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (OracleDatabaseAsyncClient, transports.OracleDatabaseGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (OracleDatabaseClient, transports.OracleDatabaseGrpcTransport, "grpc", "false"),
    (OracleDatabaseAsyncClient, transports.OracleDatabaseGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_oracle_database_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    OracleDatabaseClient, OracleDatabaseAsyncClient
])
@mock.patch.object(OracleDatabaseClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OracleDatabaseClient))
@mock.patch.object(OracleDatabaseAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OracleDatabaseAsyncClient))
...
def test_oracle_database_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (OracleDatabaseClient, transports.OracleDatabaseGrpcTransport, "grpc", grpc_helpers),
    (OracleDatabaseAsyncClient, transports.OracleDatabaseGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (OracleDatabaseClient, transports.OracleDatabaseRestTransport, "rest", None),
])
def test_oracle_database_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_oracle_database_client_client_options_from_dict():
    with mock.patch('google.cloud.oracledatabase_v1.services.oracle_database.transports.OracleDatabaseGrpcTransport.__init__') as grpc_transport:
...
def test_oracle_database_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_list_cloud_exadata_infrastructures_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_cloud_exadata_infrastructures in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_cloud_exadata_infrastructures] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_cloud_exadata_infrastructures_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_cloud_exadata_infrastructures in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_cloud_exadata_infrastructures] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_cloud_exadata_infrastructures_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.ListCloudExadataInfrastructuresRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.ListCloudExadataInfrastructuresResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_cloud_exadata_infrastructures_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_cloud_exadata_infrastructures(request={}, retry=retry, timeout=timeout)
        ...
        assert all(isinstance(i, exadata_infra.CloudExadataInfrastructure)
                   for i in results)
...
async def test_list_cloud_exadata_infrastructures_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_cloud_exadata_infrastructures(request={},)
...
def test_get_cloud_exadata_infrastructure(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_cloud_exadata_infrastructure),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_cloud_exadata_infrastructure_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_cloud_exadata_infrastructure in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_cloud_exadata_infrastructure] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_cloud_exadata_infrastructure_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_cloud_exadata_infrastructure in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_cloud_exadata_infrastructure] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_cloud_exadata_infrastructure_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.GetCloudExadataInfrastructureRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(exadata_infra.CloudExadataInfrastructure(
            name='name_value',
            display_name='display_name_value',
            gcp_oracle_zone='gcp_oracle_zone_value',
            entitlement_id='entitlement_id_value',
...
def test_create_cloud_exadata_infrastructure(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_cloud_exadata_infrastructure),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_cloud_exadata_infrastructure_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_cloud_exadata_infrastructure in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_cloud_exadata_infrastructure] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_cloud_exadata_infrastructure_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_cloud_exadata_infrastructure in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_cloud_exadata_infrastructure] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_cloud_exadata_infrastructure_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.CreateCloudExadataInfrastructureRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_cloud_exadata_infrastructure_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_cloud_exadata_infrastructure(
            parent='parent_value',
            cloud_exadata_infrastructure=exadata_infra.CloudExadataInfrastructure(name='name_value'),
            cloud_exadata_infrastructure_id='cloud_exadata_infrastructure_id_value',
        )
...
def test_delete_cloud_exadata_infrastructure(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_cloud_exadata_infrastructure),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_cloud_exadata_infrastructure_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_cloud_exadata_infrastructure in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_cloud_exadata_infrastructure] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_cloud_exadata_infrastructure_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_cloud_exadata_infrastructure in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_cloud_exadata_infrastructure] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_cloud_exadata_infrastructure_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.DeleteCloudExadataInfrastructureRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_cloud_vm_clusters_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_cloud_vm_clusters in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_cloud_vm_clusters] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_cloud_vm_clusters_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_cloud_vm_clusters in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_cloud_vm_clusters] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_cloud_vm_clusters_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.ListCloudVmClustersRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.ListCloudVmClustersResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_cloud_vm_clusters_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vm_cluster.CloudVmCluster)
                   for i in results)
...
async def test_list_cloud_vm_clusters_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_cloud_vm_clusters(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_cloud_vm_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_cloud_vm_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_cloud_vm_cluster_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_cloud_vm_cluster in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_cloud_vm_cluster] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_cloud_vm_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_cloud_vm_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_cloud_vm_cluster] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_cloud_vm_cluster_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.GetCloudVmClusterRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vm_cluster.CloudVmCluster(
            name='name_value',
            exadata_infrastructure='exadata_infrastructure_value',
            display_name='display_name_value',
            gcp_oracle_zone='gcp_oracle_zone_value',
...
def test_create_cloud_vm_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_cloud_vm_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_cloud_vm_cluster_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_cloud_vm_cluster in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_cloud_vm_cluster] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_cloud_vm_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_cloud_vm_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_cloud_vm_cluster] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_cloud_vm_cluster_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.CreateCloudVmClusterRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_cloud_vm_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_cloud_vm_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_cloud_vm_cluster_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_cloud_vm_cluster in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_delete_cloud_vm_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_cloud_vm_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_cloud_vm_cluster] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_cloud_vm_cluster_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.DeleteCloudVmClusterRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_entitlements_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.ListEntitlementsRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.ListEntitlementsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_entitlements_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, entitlement.Entitlement)
                   for i in results)
...
def test_list_db_servers(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_db_servers),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_db_servers_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_db_servers in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_db_servers] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_db_servers_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.ListDbServersRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.ListDbServersResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_db_servers_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, db_server.DbServer)
                   for i in results)
...
async def test_list_db_servers_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_db_servers(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_db_nodes(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_db_nodes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_db_nodes_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_db_nodes in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_db_nodes] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_db_nodes_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.ListDbNodesRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.ListDbNodesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_db_nodes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, db_node.DbNode)
                   for i in results)
...
async def test_list_db_nodes_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_db_nodes(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_gi_versions(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_gi_versions),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_gi_versions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_gi_versions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_gi_versions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_gi_versions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_gi_versions] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_gi_versions_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.ListGiVersionsRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.ListGiVersionsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_gi_versions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, gi_version.GiVersion)
                   for i in results)
...
async def test_list_gi_versions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_gi_versions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_db_system_shapes_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_db_system_shapes in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_db_system_shapes] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_db_system_shapes_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_db_system_shapes in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_db_system_shapes] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_db_system_shapes_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.ListDbSystemShapesRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.ListDbSystemShapesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_db_system_shapes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, db_system_shape.DbSystemShape)
                   for i in results)
...
async def test_list_db_system_shapes_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_db_system_shapes(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_autonomous_databases_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_autonomous_databases in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_autonomous_databases] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_autonomous_databases_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_autonomous_databases in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_autonomous_databases] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_autonomous_databases_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.ListAutonomousDatabasesRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.ListAutonomousDatabasesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_autonomous_databases_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_autonomous_databases(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, autonomous_database.AutonomousDatabase)
                   for i in results)
...
async def test_list_autonomous_databases_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_autonomous_databases(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_autonomous_database(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_autonomous_database),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_autonomous_database_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_autonomous_database in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_autonomous_database] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_autonomous_database_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_autonomous_database in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_autonomous_database] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_autonomous_database_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.GetAutonomousDatabaseRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(autonomous_database.AutonomousDatabase(
            name='name_value',
            database='database_value',
            display_name='display_name_value',
            entitlement_id='entitlement_id_value',
...
def test_create_autonomous_database(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_autonomous_database),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_autonomous_database_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_autonomous_database in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_autonomous_database] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_autonomous_database_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_autonomous_database in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_autonomous_database] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_autonomous_database_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.CreateAutonomousDatabaseRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_autonomous_database_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_autonomous_database(
            parent='parent_value',
            autonomous_database=gco_autonomous_database.AutonomousDatabase(name='name_value'),
            autonomous_database_id='autonomous_database_id_value',
        )
...
def test_delete_autonomous_database(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_autonomous_database),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_autonomous_database_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_autonomous_database in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_autonomous_database] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_autonomous_database_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_autonomous_database in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_autonomous_database] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_autonomous_database_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.DeleteAutonomousDatabaseRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_restore_autonomous_database(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.restore_autonomous_database),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_restore_autonomous_database_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.restore_autonomous_database in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.restore_autonomous_database] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_restore_autonomous_database_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.restore_autonomous_database in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.restore_autonomous_database] = mock_rpc
...
@pytest.mark.asyncio
async def test_restore_autonomous_database_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.RestoreAutonomousDatabaseRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_restore_autonomous_database_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = 'name_value'
        assert arg == mock_val
        assert TimestampRule().to_proto(args[0].restore_time) == timestamp_pb2.Timestamp(seconds=751)
...
def test_generate_autonomous_database_wallet(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_autonomous_database_wallet),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_generate_autonomous_database_wallet_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.generate_autonomous_database_wallet in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_autonomous_database_wallet] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_autonomous_database_wallet_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_autonomous_database_wallet in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_autonomous_database_wallet] = mock_rpc
...
@pytest.mark.asyncio
async def test_generate_autonomous_database_wallet_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.GenerateAutonomousDatabaseWalletRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.GenerateAutonomousDatabaseWalletResponse(
            archive_content=b'archive_content_blob',
        ))
...
def test_list_autonomous_db_versions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_autonomous_db_versions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_autonomous_db_versions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_autonomous_db_versions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_autonomous_db_versions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_autonomous_db_versions] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_autonomous_db_versions_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.ListAutonomousDbVersionsRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.ListAutonomousDbVersionsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_autonomous_db_versions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_autonomous_db_versions(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, autonomous_db_version.AutonomousDbVersion)
                   for i in results)
...
async def test_list_autonomous_db_versions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_autonomous_db_versions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_autonomous_database_character_sets_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_autonomous_database_character_sets in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_autonomous_database_character_sets] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_autonomous_database_character_sets_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_autonomous_database_character_sets in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_autonomous_database_character_sets] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_autonomous_database_character_sets_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.ListAutonomousDatabaseCharacterSetsRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.ListAutonomousDatabaseCharacterSetsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_autonomous_database_character_sets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_autonomous_database_character_sets(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, autonomous_database_character_set.AutonomousDatabaseCharacterSet)
                   for i in results)
...
async def test_list_autonomous_database_character_sets_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_autonomous_database_character_sets(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_autonomous_database_backups_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_autonomous_database_backups in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_autonomous_database_backups] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_autonomous_database_backups_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_autonomous_database_backups in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_autonomous_database_backups] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_autonomous_database_backups_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.ListAutonomousDatabaseBackupsRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(oracledatabase.ListAutonomousDatabaseBackupsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_autonomous_database_backups_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_autonomous_database_backups(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, autonomous_db_backup.AutonomousDatabaseBackup)
                   for i in results)
...
async def test_list_autonomous_database_backups_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_autonomous_database_backups(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_stop_autonomous_database(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.stop_autonomous_database),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_stop_autonomous_database_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.stop_autonomous_database in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.stop_autonomous_database] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_stop_autonomous_database_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.stop_autonomous_database in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.stop_autonomous_database] = mock_rpc
...
@pytest.mark.asyncio
async def test_stop_autonomous_database_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.StopAutonomousDatabaseRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_start_autonomous_database(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.start_autonomous_database),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_start_autonomous_database_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.start_autonomous_database in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.start_autonomous_database] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_start_autonomous_database_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.start_autonomous_database in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.start_autonomous_database] = mock_rpc
...
@pytest.mark.asyncio
async def test_start_autonomous_database_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.StartAutonomousDatabaseRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_restart_autonomous_database(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.restart_autonomous_database),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_restart_autonomous_database_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.restart_autonomous_database in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.restart_autonomous_database] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_restart_autonomous_database_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OracleDatabaseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.restart_autonomous_database in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.restart_autonomous_database] = mock_rpc
...
@pytest.mark.asyncio
async def test_restart_autonomous_database_async(transport: str = 'grpc_asyncio', request_type=oracledatabase.RestartAutonomousDatabaseRequest):
    client = OracleDatabaseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_cloud_exadata_infrastructures_rest_required_fields(request_type=oracledatabase.ListCloudExadataInfrastructuresRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_cloud_exadata_infrastructures._get_unset_required_fields(jsonified_request)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = oracledatabase.ListCloudExadataInfrastructuresResponse.pb(return_value)
...
def test_list_cloud_exadata_infrastructures_rest_unset_required_fields():
    transport = transports.OracleDatabaseRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_cloud_exadata_infrastructures_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/cloudExadataInfrastructures" % client.transport._host, args[1])


def test_list_cloud_exadata_infrastructures_rest_flattened_error(transport: str = 'rest'):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_cloud_exadata_infrastructures_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(oracledatabase.ListCloudExadataInfrastructuresResponse.to_json(x) for x in response)
        ...
        pages = list(client.list_cloud_exadata_infrastructures(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_cloud_exadata_infrastructure_rest_required_fields(request_type=oracledatabase.GetCloudExadataInfrastructureRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_cloud_exadata_infrastructure._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_cloud_exadata_infrastructure_rest_unset_required_fields():
    ...
    unset_fields = transport.get_cloud_exadata_infrastructure._get_unset_required_fields({})
...
def test_get_cloud_exadata_infrastructure_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/cloudExadataInfrastructures/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/cloudExadataInfrastructures/*}" % client.transport._host, args[1])
...
def test_create_cloud_exadata_infrastructure_rest_required_fields(request_type=oracledatabase.CreateCloudExadataInfrastructureRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_cloud_exadata_infrastructure._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_cloud_exadata_infrastructure._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("cloud_exadata_infrastructure_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_cloud_exadata_infrastructure_rest_unset_required_fields():
    ...
    unset_fields = transport.create_cloud_exadata_infrastructure._get_unset_required_fields({})
    assert set(unset_fields) == (set(("cloudExadataInfrastructureId", "requestId", )) & set(("parent", "cloudExadataInfrastructureId", "cloudExadataInfrastructure", )))
...
def test_create_cloud_exadata_infrastructure_rest_flattened_error(transport: str = 'rest'):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_cloud_exadata_infrastructure_rest_required_fields(request_type=oracledatabase.DeleteCloudExadataInfrastructureRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_cloud_exadata_infrastructure._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_cloud_exadata_infrastructure_rest_unset_required_fields():
    ...
    unset_fields = transport.delete_cloud_exadata_infrastructure._get_unset_required_fields({})
...
def test_delete_cloud_exadata_infrastructure_rest_flattened_error(transport: str = 'rest'):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_cloud_vm_clusters_rest_required_fields(request_type=oracledatabase.ListCloudVmClustersRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_cloud_vm_clusters._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_cloud_vm_clusters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/cloudVmClusters" % client.transport._host, args[1])
...
def test_list_cloud_vm_clusters_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(oracledatabase.ListCloudVmClustersResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_cloud_vm_cluster_rest_required_fields(request_type=oracledatabase.GetCloudVmClusterRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_cloud_vm_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_cloud_vm_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/cloudVmClusters/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/cloudVmClusters/*}" % client.transport._host, args[1])
...
def test_create_cloud_vm_cluster_rest_required_fields(request_type=oracledatabase.CreateCloudVmClusterRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_cloud_vm_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_cloud_vm_cluster._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("cloud_vm_cluster_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_cloud_vm_cluster_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("cloudVmClusterId", "requestId", )) & set(("parent", "cloudVmClusterId", "cloudVmCluster", )))
...
def test_delete_cloud_vm_cluster_rest_required_fields(request_type=oracledatabase.DeleteCloudVmClusterRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_cloud_vm_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_entitlements_rest_required_fields(request_type=oracledatabase.ListEntitlementsRequest):
    transport_class = transports.OracleDatabaseRestTransport
...
def test_list_entitlements_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(oracledatabase.ListEntitlementsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_list_db_servers_rest_required_fields(request_type=oracledatabase.ListDbServersRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_db_servers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_db_servers_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/cloudExadataInfrastructures/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/cloudExadataInfrastructures/*}/dbServers" % client.transport._host, args[1])
...
def test_list_db_servers_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(oracledatabase.ListDbServersResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_list_db_nodes_rest_required_fields(request_type=oracledatabase.ListDbNodesRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_db_nodes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_db_nodes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/cloudVmClusters/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/cloudVmClusters/*}/dbNodes" % client.transport._host, args[1])
...
def test_list_db_nodes_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(oracledatabase.ListDbNodesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_list_gi_versions_rest_required_fields(request_type=oracledatabase.ListGiVersionsRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_gi_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_gi_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/giVersions" % client.transport._host, args[1])
...
def test_list_gi_versions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(oracledatabase.ListGiVersionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_list_db_system_shapes_rest_required_fields(request_type=oracledatabase.ListDbSystemShapesRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_db_system_shapes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_db_system_shapes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/dbSystemShapes" % client.transport._host, args[1])
...
def test_list_db_system_shapes_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(oracledatabase.ListDbSystemShapesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_list_autonomous_databases_rest_required_fields(request_type=oracledatabase.ListAutonomousDatabasesRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_autonomous_databases._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_autonomous_databases_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/autonomousDatabases" % client.transport._host, args[1])
...
def test_list_autonomous_databases_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(oracledatabase.ListAutonomousDatabasesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_autonomous_database_rest_required_fields(request_type=oracledatabase.GetAutonomousDatabaseRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_autonomous_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_autonomous_database_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/autonomousDatabases/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/autonomousDatabases/*}" % client.transport._host, args[1])
...
def test_create_autonomous_database_rest_required_fields(request_type=oracledatabase.CreateAutonomousDatabaseRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_autonomous_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_autonomous_database_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("autonomousDatabaseId", "requestId", )) & set(("parent", "autonomousDatabaseId", "autonomousDatabase", )))
...
def test_delete_autonomous_database_rest_required_fields(request_type=oracledatabase.DeleteAutonomousDatabaseRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_autonomous_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_restore_autonomous_database_rest_required_fields(request_type=oracledatabase.RestoreAutonomousDatabaseRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).restore_autonomous_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_restore_autonomous_database_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "restoreTime", )))
...
def test_restore_autonomous_database_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/autonomousDatabases/*}:restore" % client.transport._host, args[1])
...
def test_generate_autonomous_database_wallet_rest_required_fields(request_type=oracledatabase.GenerateAutonomousDatabaseWalletRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_autonomous_database_wallet._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = oracledatabase.GenerateAutonomousDatabaseWalletResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_generate_autonomous_database_wallet_rest_unset_required_fields():
    ...
    unset_fields = transport.generate_autonomous_database_wallet._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", "password", )))
...
def test_generate_autonomous_database_wallet_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/autonomousDatabases/*}:generateWallet" % client.transport._host, args[1])


def test_generate_autonomous_database_wallet_rest_flattened_error(transport: str = 'rest'):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_autonomous_db_versions_rest_required_fields(request_type=oracledatabase.ListAutonomousDbVersionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_autonomous_db_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_autonomous_db_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/autonomousDbVersions" % client.transport._host, args[1])
...
def test_list_autonomous_db_versions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(oracledatabase.ListAutonomousDbVersionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_list_autonomous_database_character_sets_rest_required_fields(request_type=oracledatabase.ListAutonomousDatabaseCharacterSetsRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_autonomous_database_character_sets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = oracledatabase.ListAutonomousDatabaseCharacterSetsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_autonomous_database_character_sets_rest_unset_required_fields():
    ...
    unset_fields = transport.list_autonomous_database_character_sets._get_unset_required_fields({})
    assert set(unset_fields) == (set(("filter", "pageSize", "pageToken", )) & set(("parent", )))
...
def test_list_autonomous_database_character_sets_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/autonomousDatabaseCharacterSets" % client.transport._host, args[1])


def test_list_autonomous_database_character_sets_rest_flattened_error(transport: str = 'rest'):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_autonomous_database_character_sets_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(oracledatabase.ListAutonomousDatabaseCharacterSetsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.list_autonomous_database_character_sets(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_list_autonomous_database_backups_rest_required_fields(request_type=oracledatabase.ListAutonomousDatabaseBackupsRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_autonomous_database_backups._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = oracledatabase.ListAutonomousDatabaseBackupsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_autonomous_database_backups_rest_unset_required_fields():
    ...
    unset_fields = transport.list_autonomous_database_backups._get_unset_required_fields({})
    assert set(unset_fields) == (set(("filter", "pageSize", "pageToken", )) & set(("parent", )))
...
def test_list_autonomous_database_backups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/autonomousDatabaseBackups" % client.transport._host, args[1])
...
def test_list_autonomous_database_backups_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(oracledatabase.ListAutonomousDatabaseBackupsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.list_autonomous_database_backups(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_stop_autonomous_database_rest_required_fields(request_type=oracledatabase.StopAutonomousDatabaseRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).stop_autonomous_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_stop_autonomous_database_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/autonomousDatabases/*}:stop" % client.transport._host, args[1])
...
def test_start_autonomous_database_rest_required_fields(request_type=oracledatabase.StartAutonomousDatabaseRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).start_autonomous_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_autonomous_database_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/autonomousDatabases/*}:start" % client.transport._host, args[1])
...
def test_restart_autonomous_database_rest_required_fields(request_type=oracledatabase.RestartAutonomousDatabaseRequest):
    transport_class = transports.OracleDatabaseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).restart_autonomous_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_restart_autonomous_database_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/autonomousDatabases/*}:restart" % client.transport._host, args[1])
...
def test_list_cloud_exadata_infrastructures_rest_bad_request(request_type=oracledatabase.ListCloudExadataInfrastructuresRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_cloud_exadata_infrastructures_rest_interceptors(null_interceptor):
    transport = transports.OracleDatabaseRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.OracleDatabaseRestInterceptor(),
        )
    client = OracleDatabaseClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_cloud_exadata_infrastructures") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_cloud_exadata_infrastructures_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_list_cloud_exadata_infrastructures") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.ListCloudExadataInfrastructuresRequest.pb(oracledatabase.ListCloudExadataInfrastructuresRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.ListCloudExadataInfrastructuresResponse.to_json(oracledatabase.ListCloudExadataInfrastructuresResponse())
        ...
        post_with_metadata.return_value = oracledatabase.ListCloudExadataInfrastructuresResponse(), metadata

        client.list_cloud_exadata_infrastructures(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_cloud_exadata_infrastructure_rest_bad_request(request_type=oracledatabase.GetCloudExadataInfrastructureRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/cloudExadataInfrastructures/sample3'}
    request = request_type(**request_init)
...
def test_get_cloud_exadata_infrastructure_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_get_cloud_exadata_infrastructure") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_get_cloud_exadata_infrastructure_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_get_cloud_exadata_infrastructure") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.GetCloudExadataInfrastructureRequest.pb(oracledatabase.GetCloudExadataInfrastructureRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = exadata_infra.CloudExadataInfrastructure.to_json(exadata_infra.CloudExadataInfrastructure())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = exadata_infra.CloudExadataInfrastructure(), metadata

        client.get_cloud_exadata_infrastructure(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_cloud_exadata_infrastructure_rest_bad_request(request_type=oracledatabase.CreateCloudExadataInfrastructureRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_cloud_exadata_infrastructure_rest_call_success(request_type):
    ...
    test_field = oracledatabase.CreateCloudExadataInfrastructureRequest.meta.fields["cloud_exadata_infrastructure"]
    ...
    for field, value in request_init["cloud_exadata_infrastructure"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["cloud_exadata_infrastructure"][field])):
...
def test_create_cloud_exadata_infrastructure_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_create_cloud_exadata_infrastructure") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_create_cloud_exadata_infrastructure_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_create_cloud_exadata_infrastructure") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.CreateCloudExadataInfrastructureRequest.pb(oracledatabase.CreateCloudExadataInfrastructureRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_cloud_exadata_infrastructure(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_cloud_exadata_infrastructure_rest_bad_request(request_type=oracledatabase.DeleteCloudExadataInfrastructureRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_cloud_exadata_infrastructure_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_delete_cloud_exadata_infrastructure") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_delete_cloud_exadata_infrastructure_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_delete_cloud_exadata_infrastructure") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.DeleteCloudExadataInfrastructureRequest.pb(oracledatabase.DeleteCloudExadataInfrastructureRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_cloud_exadata_infrastructure(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_cloud_vm_clusters_rest_bad_request(request_type=oracledatabase.ListCloudVmClustersRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_cloud_vm_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_cloud_vm_clusters") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_cloud_vm_clusters_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_list_cloud_vm_clusters") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.ListCloudVmClustersRequest.pb(oracledatabase.ListCloudVmClustersRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.ListCloudVmClustersResponse.to_json(oracledatabase.ListCloudVmClustersResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = oracledatabase.ListCloudVmClustersResponse(), metadata

        client.list_cloud_vm_clusters(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_cloud_vm_cluster_rest_bad_request(request_type=oracledatabase.GetCloudVmClusterRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/cloudVmClusters/sample3'}
    request = request_type(**request_init)
...
def test_get_cloud_vm_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_get_cloud_vm_cluster") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_get_cloud_vm_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_get_cloud_vm_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.GetCloudVmClusterRequest.pb(oracledatabase.GetCloudVmClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_cloud_vm_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_cloud_vm_cluster_rest_bad_request(request_type=oracledatabase.CreateCloudVmClusterRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_cloud_vm_cluster_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = oracledatabase.CreateCloudVmClusterRequest.meta.fields["cloud_vm_cluster"]
...
def test_create_cloud_vm_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_create_cloud_vm_cluster") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_create_cloud_vm_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_create_cloud_vm_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.CreateCloudVmClusterRequest.pb(oracledatabase.CreateCloudVmClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_cloud_vm_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_cloud_vm_cluster_rest_bad_request(request_type=oracledatabase.DeleteCloudVmClusterRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_cloud_vm_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_delete_cloud_vm_cluster") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_delete_cloud_vm_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_delete_cloud_vm_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.DeleteCloudVmClusterRequest.pb(oracledatabase.DeleteCloudVmClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_cloud_vm_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_entitlements_rest_bad_request(request_type=oracledatabase.ListEntitlementsRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_entitlements_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_entitlements") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_entitlements_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_list_entitlements") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.ListEntitlementsRequest.pb(oracledatabase.ListEntitlementsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.ListEntitlementsResponse.to_json(oracledatabase.ListEntitlementsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = oracledatabase.ListEntitlementsResponse(), metadata
...
def test_list_db_servers_rest_bad_request(request_type=oracledatabase.ListDbServersRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/cloudExadataInfrastructures/sample3'}
    request = request_type(**request_init)
...
def test_list_db_servers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_db_servers") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_db_servers_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_list_db_servers") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.ListDbServersRequest.pb(oracledatabase.ListDbServersRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.ListDbServersResponse.to_json(oracledatabase.ListDbServersResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = oracledatabase.ListDbServersResponse(), metadata

        client.list_db_servers(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_db_nodes_rest_bad_request(request_type=oracledatabase.ListDbNodesRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/cloudVmClusters/sample3'}
    request = request_type(**request_init)
...
def test_list_db_nodes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_db_nodes") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_db_nodes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_list_db_nodes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.ListDbNodesRequest.pb(oracledatabase.ListDbNodesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.ListDbNodesResponse.to_json(oracledatabase.ListDbNodesResponse())
        req.return_value.content = return_value
        ...
        client.list_db_nodes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_gi_versions_rest_bad_request(request_type=oracledatabase.ListGiVersionsRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_gi_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_gi_versions") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_gi_versions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_list_gi_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.ListGiVersionsRequest.pb(oracledatabase.ListGiVersionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.ListGiVersionsResponse.to_json(oracledatabase.ListGiVersionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = oracledatabase.ListGiVersionsResponse(), metadata

        client.list_gi_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_db_system_shapes_rest_bad_request(request_type=oracledatabase.ListDbSystemShapesRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_db_system_shapes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_db_system_shapes") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_db_system_shapes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_list_db_system_shapes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.ListDbSystemShapesRequest.pb(oracledatabase.ListDbSystemShapesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.ListDbSystemShapesResponse.to_json(oracledatabase.ListDbSystemShapesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = oracledatabase.ListDbSystemShapesResponse(), metadata

        client.list_db_system_shapes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_autonomous_databases_rest_bad_request(request_type=oracledatabase.ListAutonomousDatabasesRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_autonomous_databases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_autonomous_databases") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_autonomous_databases_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_list_autonomous_databases") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.ListAutonomousDatabasesRequest.pb(oracledatabase.ListAutonomousDatabasesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.ListAutonomousDatabasesResponse.to_json(oracledatabase.ListAutonomousDatabasesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = oracledatabase.ListAutonomousDatabasesResponse(), metadata

        client.list_autonomous_databases(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_autonomous_database_rest_bad_request(request_type=oracledatabase.GetAutonomousDatabaseRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/autonomousDatabases/sample3'}
    request = request_type(**request_init)
...
def test_get_autonomous_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_get_autonomous_database") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_get_autonomous_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_get_autonomous_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.GetAutonomousDatabaseRequest.pb(oracledatabase.GetAutonomousDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = autonomous_database.AutonomousDatabase.to_json(autonomous_database.AutonomousDatabase())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = autonomous_database.AutonomousDatabase(), metadata

        client.get_autonomous_database(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_autonomous_database_rest_bad_request(request_type=oracledatabase.CreateAutonomousDatabaseRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_autonomous_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_create_autonomous_database") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_create_autonomous_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_create_autonomous_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.CreateAutonomousDatabaseRequest.pb(oracledatabase.CreateAutonomousDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_autonomous_database(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_autonomous_database_rest_bad_request(request_type=oracledatabase.DeleteAutonomousDatabaseRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_autonomous_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_delete_autonomous_database") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_delete_autonomous_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_delete_autonomous_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.DeleteAutonomousDatabaseRequest.pb(oracledatabase.DeleteAutonomousDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_autonomous_database(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_restore_autonomous_database_rest_bad_request(request_type=oracledatabase.RestoreAutonomousDatabaseRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_restore_autonomous_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_restore_autonomous_database") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_restore_autonomous_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_restore_autonomous_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.RestoreAutonomousDatabaseRequest.pb(oracledatabase.RestoreAutonomousDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.restore_autonomous_database(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_generate_autonomous_database_wallet_rest_bad_request(request_type=oracledatabase.GenerateAutonomousDatabaseWalletRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_autonomous_database_wallet_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_generate_autonomous_database_wallet") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_generate_autonomous_database_wallet_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_generate_autonomous_database_wallet") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.GenerateAutonomousDatabaseWalletRequest.pb(oracledatabase.GenerateAutonomousDatabaseWalletRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.GenerateAutonomousDatabaseWalletResponse.to_json(oracledatabase.GenerateAutonomousDatabaseWalletResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = oracledatabase.GenerateAutonomousDatabaseWalletResponse(), metadata

        client.generate_autonomous_database_wallet(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_autonomous_db_versions_rest_bad_request(request_type=oracledatabase.ListAutonomousDbVersionsRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_autonomous_db_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_autonomous_db_versions") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_autonomous_db_versions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_list_autonomous_db_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.ListAutonomousDbVersionsRequest.pb(oracledatabase.ListAutonomousDbVersionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.ListAutonomousDbVersionsResponse.to_json(oracledatabase.ListAutonomousDbVersionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = oracledatabase.ListAutonomousDbVersionsResponse(), metadata

        client.list_autonomous_db_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_autonomous_database_character_sets_rest_bad_request(request_type=oracledatabase.ListAutonomousDatabaseCharacterSetsRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_autonomous_database_character_sets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_autonomous_database_character_sets") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_autonomous_database_character_sets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_list_autonomous_database_character_sets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.ListAutonomousDatabaseCharacterSetsRequest.pb(oracledatabase.ListAutonomousDatabaseCharacterSetsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.ListAutonomousDatabaseCharacterSetsResponse.to_json(oracledatabase.ListAutonomousDatabaseCharacterSetsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = oracledatabase.ListAutonomousDatabaseCharacterSetsResponse(), metadata

        client.list_autonomous_database_character_sets(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_autonomous_database_backups_rest_bad_request(request_type=oracledatabase.ListAutonomousDatabaseBackupsRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_autonomous_database_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_autonomous_database_backups") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_list_autonomous_database_backups_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_list_autonomous_database_backups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.ListAutonomousDatabaseBackupsRequest.pb(oracledatabase.ListAutonomousDatabaseBackupsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oracledatabase.ListAutonomousDatabaseBackupsResponse.to_json(oracledatabase.ListAutonomousDatabaseBackupsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = oracledatabase.ListAutonomousDatabaseBackupsResponse(), metadata

        client.list_autonomous_database_backups(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_stop_autonomous_database_rest_bad_request(request_type=oracledatabase.StopAutonomousDatabaseRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_stop_autonomous_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_stop_autonomous_database") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_stop_autonomous_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_stop_autonomous_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.StopAutonomousDatabaseRequest.pb(oracledatabase.StopAutonomousDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.stop_autonomous_database(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_start_autonomous_database_rest_bad_request(request_type=oracledatabase.StartAutonomousDatabaseRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_start_autonomous_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_start_autonomous_database") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_start_autonomous_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_start_autonomous_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.StartAutonomousDatabaseRequest.pb(oracledatabase.StartAutonomousDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.start_autonomous_database(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_restart_autonomous_database_rest_bad_request(request_type=oracledatabase.RestartAutonomousDatabaseRequest):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_restart_autonomous_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_restart_autonomous_database") as post, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "post_restart_autonomous_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OracleDatabaseRestInterceptor, "pre_restart_autonomous_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = oracledatabase.RestartAutonomousDatabaseRequest.pb(oracledatabase.RestartAutonomousDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.restart_autonomous_database(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_oracle_database_base_transport():
    ...
    with mock.patch('google.cloud.oracledatabase_v1.services.oracle_database.transports.OracleDatabaseTransport.__init__') as Transport:
...
def test_oracle_database_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.oracledatabase_v1.services.oracle_database.transports.OracleDatabaseTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_oracle_database_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.oracledatabase_v1.services.oracle_database.transports.OracleDatabaseTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.OracleDatabaseTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.OracleDatabaseGrpcTransport, transports.OracleDatabaseGrpcAsyncIOTransport])
def test_oracle_database_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_oracle_database_host_no_port(transport_name):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='oracledatabase.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'oracledatabase.googleapis.com:443'
...
def test_oracle_database_host_with_port(transport_name):
    client = OracleDatabaseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='oracledatabase.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.OracleDatabaseGrpcTransport, transports.OracleDatabaseGrpcAsyncIOTransport])
def test_oracle_database_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_autonomous_database_path():
    ...
    expected = "projects/{project}/locations/{location}/autonomousDatabases/{autonomous_database}".format(project=project, location=location, autonomous_database=autonomous_database, )
    actual = OracleDatabaseClient.autonomous_database_path(project, location, autonomous_database)
...
def test_autonomous_database_backup_path():
    ...
    expected = "projects/{project}/locations/{location}/autonomousDatabaseBackups/{autonomous_database_backup}".format(project=project, location=location, autonomous_database_backup=autonomous_database_backup, )
    actual = OracleDatabaseClient.autonomous_database_backup_path(project, location, autonomous_database_backup)
    assert expected == actual
...
def test_autonomous_database_character_set_path():
    ...
    expected = "projects/{project}/locations/{location}/autonomousDatabaseCharacterSets/{autonomous_database_character_set}".format(project=project, location=location, autonomous_database_character_set=autonomous_database_character_set, )
    actual = OracleDatabaseClient.autonomous_database_character_set_path(project, location, autonomous_database_character_set)
    assert expected == actual
...
def test_autonomous_db_version_path():
    ...
    expected = "projects/{project}/locations/{location}/autonomousDbVersions/{autonomous_db_version}".format(project=project, location=location, autonomous_db_version=autonomous_db_version, )
    actual = OracleDatabaseClient.autonomous_db_version_path(project, location, autonomous_db_version)
    assert expected == actual
...
def test_cloud_exadata_infrastructure_path():
    ...
    expected = "projects/{project}/locations/{location}/cloudExadataInfrastructures/{cloud_exadata_infrastructure}".format(project=project, location=location, cloud_exadata_infrastructure=cloud_exadata_infrastructure, )
    actual = OracleDatabaseClient.cloud_exadata_infrastructure_path(project, location, cloud_exadata_infrastructure)
    assert expected == actual
...
def test_cloud_vm_cluster_path():
    ...
    expected = "projects/{project}/locations/{location}/cloudVmClusters/{cloud_vm_cluster}".format(project=project, location=location, cloud_vm_cluster=cloud_vm_cluster, )
    actual = OracleDatabaseClient.cloud_vm_cluster_path(project, location, cloud_vm_cluster)
    assert expected == actual
...
def test_db_node_path():
    ...
    db_node = "octopus"
    expected = "projects/{project}/locations/{location}/cloudVmClusters/{cloud_vm_cluster}/dbNodes/{db_node}".format(project=project, location=location, cloud_vm_cluster=cloud_vm_cluster, db_node=db_node, )
    actual = OracleDatabaseClient.db_node_path(project, location, cloud_vm_cluster, db_node)
    assert expected == actual
...
def test_db_server_path():
    ...
    db_server = "abalone"
    expected = "projects/{project}/locations/{location}/cloudExadataInfrastructures/{cloud_exadata_infrastructure}/dbServers/{db_server}".format(project=project, location=location, cloud_exadata_infrastructure=cloud_exadata_infrastructure, db_server=db_server, )
    actual = OracleDatabaseClient.db_server_path(project, location, cloud_exadata_infrastructure, db_server)
    assert expected == actual
...
def test_db_system_shape_path():
    ...
    expected = "projects/{project}/locations/{location}/dbSystemShapes/{db_system_shape}".format(project=project, location=location, db_system_shape=db_system_shape, )
    actual = OracleDatabaseClient.db_system_shape_path(project, location, db_system_shape)
    assert expected == actual
...
def test_gi_version_path():
    ...
    expected = "projects/{project}/locations/{location}/giVersions/{gi_version}".format(project=project, location=location, gi_version=gi_version, )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.OracleDatabaseTransport, '_prep_wrapped_messages') as prep:
        client = OracleDatabaseClient(
            credentials=ga_credentials.AnonymousCredentials(),

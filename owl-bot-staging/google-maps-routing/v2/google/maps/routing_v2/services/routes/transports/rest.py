...
class RoutesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_compute_route_matrix(self, request: routes_service.ComputeRouteMatrixRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[routes_service.ComputeRouteMatrixRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_compute_route_matrix_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for compute_route_matrix
    ...
    def pre_compute_routes(self, request: routes_service.ComputeRoutesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[routes_service.ComputeRoutesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_compute_routes_with_metadata(self, response: routes_service.ComputeRoutesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[routes_service.ComputeRoutesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for compute_routes
...
class RoutesRestTransport(_BaseRoutesRestTransport):
    ...
    class _ComputeRouteMatrix(_BaseRoutesRestTransport._BaseComputeRouteMatrix, RoutesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RoutesRestTransport._ComputeRouteMatrix._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ComputeRoutes(_BaseRoutesRestTransport._BaseComputeRoutes, RoutesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RoutesRestTransport._ComputeRoutes._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class RoutesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_compute_route_matrix(self, request: routes_service.ComputeRouteMatrixRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[routes_service.ComputeRouteMatrixRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_compute_routes(self, request: routes_service.ComputeRoutesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[routes_service.ComputeRoutesRequest, Sequence[Tuple[str, str]]]:

...
class RoutesGrpcTransport(RoutesTransport):
    """gRPC backend transport for Routes.
    ...
    @property
    def compute_routes(self) -> Callable[
        ...
        **NOTE:** This method requires that you specify a response field
        ...
        if 'compute_routes' not in self._stubs:
            self._stubs['compute_routes'] = self._logged_channel.unary_unary(
    ...
    @property
    def compute_route_matrix(self) -> Callable[
        ...
        **NOTE:** This method requires that you specify a response field
        ...
        if 'compute_route_matrix' not in self._stubs:
            self._stubs['compute_route_matrix'] = self._logged_channel.unary_stream(

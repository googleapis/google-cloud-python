...
class OrchestrationCluster(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.telcoautomation_v1alpha1.types.OrchestrationCluster.State):
...
class ListOrchestrationClustersResponse(proto.Message):
    ...
    Attributes:
        orchestration_clusters (MutableSequence[google.cloud.telcoautomation_v1alpha1.types.OrchestrationCluster]):
...
class ListEdgeSlmsResponse(proto.Message):
    ...
    Attributes:
        edge_slms (MutableSequence[google.cloud.telcoautomation_v1alpha1.types.EdgeSlm]):
            The list of EdgeSlm
        next_page_token (str):
            A token identifying a page of results the
            server should return.
...
class CreateBlueprintRequest(proto.Message):
    ...
    Attributes:
        ...
        blueprint (google.cloud.telcoautomation_v1alpha1.types.Blueprint):
...
class ListBlueprintsResponse(proto.Message):
    ...
    Attributes:
        blueprints (MutableSequence[google.cloud.telcoautomation_v1alpha1.types.Blueprint]):
...
class ListPublicBlueprintsResponse(proto.Message):
    ...
    Attributes:
        public_blueprints (MutableSequence[google.cloud.telcoautomation_v1alpha1.types.PublicBlueprint]):
...
class CreateDeploymentRequest(proto.Message):
    ...
    Attributes:
        ...
        deployment (google.cloud.telcoautomation_v1alpha1.types.Deployment):
...
class ListDeploymentsResponse(proto.Message):
    ...
    Attributes:
        deployments (MutableSequence[google.cloud.telcoautomation_v1alpha1.types.Deployment]):
...
class ListHydratedDeploymentsResponse(proto.Message):
    ...
    Attributes:
        hydrated_deployments (MutableSequence[google.cloud.telcoautomation_v1alpha1.types.HydratedDeployment]):
...
class UpdateHydratedDeploymentRequest(proto.Message):
    ...
    Attributes:
        hydrated_deployment (google.cloud.telcoautomation_v1alpha1.types.HydratedDeployment):
...
class ResourceStatus(proto.Message):
    ...
    Attributes:
        ...
        resource_type (google.cloud.telcoautomation_v1alpha1.types.ResourceType):

...
from .base import TelcoAutomationTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomTelcoAutomationInterceptor(TelcoAutomationRestInterceptor):
            ...
            def pre_delete_blueprint_revision(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_delete_blueprint_revision(self, response):
                logging.log(f"Received response: {response}")
                return response
            ...
            def pre_delete_deployment_revision(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_delete_deployment_revision(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    def pre_delete_blueprint_revision(self, request: telcoautomation.DeleteBlueprintRevisionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[telcoautomation.DeleteBlueprintRevisionRequest, Sequence[Tuple[str, str]]]:
        """Pre-rpc interceptor for delete_blueprint_revision
    ...
    def post_delete_blueprint_revision(self, response: telcoautomation.Blueprint) -> telcoautomation.Blueprint:
        """Post-rpc interceptor for delete_blueprint_revision
        ...
        """
        return response
    def pre_delete_deployment(self, request: telcoautomation.DeleteDeploymentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[telcoautomation.DeleteDeploymentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_deployment_revision(self, request: telcoautomation.DeleteDeploymentRevisionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[telcoautomation.DeleteDeploymentRevisionRequest, Sequence[Tuple[str, str]]]:
        """Pre-rpc interceptor for delete_deployment_revision
    ...
    def post_delete_deployment_revision(self, response: telcoautomation.Deployment) -> telcoautomation.Deployment:
        """Post-rpc interceptor for delete_deployment_revision
...
class TelcoAutomationRestTransport(TelcoAutomationTransport):
    ...
    class _ApplyDeployment(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:apply',
                'body': '*',
            },
            ]
    ...
    class _ApplyHydratedDeployment(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*/hydratedDeployments/*}:apply',
                'body': '*',
            },
            ]
    ...
    class _ApproveBlueprint(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}:approve',
                'body': '*',
            },
            ]
    ...
    class _ComputeDeploymentStatus(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:computeDeploymentStatus',
            },
            ]
    ...
    class _CreateBlueprint(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{parent=projects/*/locations/*/orchestrationClusters/*}/blueprints',
                'body': 'blueprint',
            },
            ]
    ...
    class _CreateDeployment(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{parent=projects/*/locations/*/orchestrationClusters/*}/deployments',
                'body': 'deployment',
            },
            ]
    ...
    class _CreateEdgeSlm(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{parent=projects/*/locations/*}/edgeSlms',
                'body': 'edge_slm',
            },
            ]
    ...
    class _CreateOrchestrationCluster(TelcoAutomationRestStub):
        ...
        cluster method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{parent=projects/*/locations/*}/orchestrationClusters',
    ...
    class _DeleteBlueprint(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}',
            },
            ]
    ...
    class _DeleteBlueprintRevision(TelcoAutomationRestStub):
        def __hash__(self):
            return hash("DeleteBlueprintRevision")
        ...
        def __call__(self,
            ...
            r"""Call the delete blueprint revision method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}:deleteRevision',
            },
            ]
            request, metadata = self._interceptor.pre_delete_blueprint_revision(request, metadata)
            pb_request = telcoautomation.DeleteBlueprintRevisionRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            ...
            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)
            resp = self._interceptor.post_delete_blueprint_revision(resp)
            return resp

    class _DeleteDeployment(TelcoAutomationRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}',
            },
            ]
            request, metadata = self._interceptor.pre_delete_deployment(request, metadata)
            pb_request = telcoautomation.DeleteDeploymentRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _DeleteDeploymentRevision(TelcoAutomationRestStub):
        def __hash__(self):
            return hash("DeleteDeploymentRevision")
        ...
        revision method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:deleteRevision',
            },
            ]
            request, metadata = self._interceptor.pre_delete_deployment_revision(request, metadata)
            pb_request = telcoautomation.DeleteDeploymentRevisionRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            ...
            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)
            resp = self._interceptor.post_delete_deployment_revision(resp)
            return resp
    ...
    class _DeleteEdgeSlm(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1alpha1/{name=projects/*/locations/*/edgeSlms/*}',
            },
            ]
    ...
    class _DeleteOrchestrationCluster(TelcoAutomationRestStub):
        ...
        cluster method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*}',
            },
            ]
    ...
    class _DiscardBlueprintChanges(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}:discard',
                'body': '*',
            },
            ]
    ...
    class _DiscardDeploymentChanges(TelcoAutomationRestStub):
        ...
        changes method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:discard',
                'body': '*',
            },
            ]
    ...
    class _GetHydratedDeployment(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*/hydratedDeployments/*}',
            },
            ]
    ...
    class _GetPublicBlueprint(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha1/{name=projects/*/locations/*/publicBlueprints/*}',
            },
            ]
    ...
    class _ListBlueprintRevisions(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}:listRevisions',
            },
            ]
    ...
    class _ListDeploymentRevisions(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:listRevisions',
            },
            ]
    ...
    class _ListHydratedDeployments(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha1/{parent=projects/*/locations/*/orchestrationClusters/*/deployments/*}/hydratedDeployments',
            },
            ]
    ...
    class _ListPublicBlueprints(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha1/{parent=projects/*/locations/*}/publicBlueprints',
            },
            ]
    ...
    class _ProposeBlueprint(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}:propose',
                'body': '*',
            },
            ]
    ...
    class _RejectBlueprint(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}:reject',
                'body': '*',
            },
            ]
    ...
    class _RemoveDeployment(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:remove',
                'body': '*',
            },
            ]
    ...
    class _RollbackDeployment(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:rollback',
                'body': '*',
            },
            ]
    ...
    class _SearchBlueprintRevisions(TelcoAutomationRestStub):
        ...
        revisions method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha1/{parent=projects/*/locations/*/orchestrationClusters/*}/blueprints:searchRevisions',
            },
            ]
    ...
    class _SearchDeploymentRevisions(TelcoAutomationRestStub):
        ...
        revisions method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1alpha1/{parent=projects/*/locations/*/orchestrationClusters/*}/deployments:searchRevisions',
            },
            ]
    ...
    class _UpdateBlueprint(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1alpha1/{blueprint.name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}',
                'body': 'blueprint',
            },
            ]
    ...
    class _UpdateDeployment(TelcoAutomationRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1alpha1/{deployment.name=projects/*/locations/*/orchestrationClusters/*/deployments/*}',
                'body': 'deployment',
            },
            ]
    ...
    class _UpdateHydratedDeployment(TelcoAutomationRestStub):
        ...
        deployment method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1alpha1/{hydrated_deployment.name=projects/*/locations/*/orchestrationClusters/*/deployments/*/hydratedDeployments/*}',
    ...
    @property
    def delete_blueprint_revision(self) -> Callable[
            [telcoautomation.DeleteBlueprintRevisionRequest],
            telcoautomation.Blueprint]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._DeleteBlueprintRevision(self._session, self._host, self._interceptor) # type: ignore
    ...
    @property
    def delete_deployment_revision(self) -> Callable[
            [telcoautomation.DeleteDeploymentRevisionRequest],
            telcoautomation.Deployment]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._DeleteDeploymentRevision(self._session, self._host, self._interceptor) # type: ignore

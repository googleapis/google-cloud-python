...
from .types.telcoautomation import DeleteBlueprintRevisionRequest
from .types.telcoautomation import DeleteDeploymentRequest
from .types.telcoautomation import DeleteDeploymentRevisionRequest

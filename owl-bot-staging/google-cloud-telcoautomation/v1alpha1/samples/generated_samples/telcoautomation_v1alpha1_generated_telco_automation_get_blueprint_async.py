...
# [START telcoautomation_v1alpha1_generated_TelcoAutomation_GetBlueprint_async]
...
async def sample_get_blueprint():
    ...
    request = telcoautomation_v1alpha1.GetBlueprintRequest(
        name="name_value",
    )
...
# [END telcoautomation_v1alpha1_generated_TelcoAutomation_GetBlueprint_async]

...
def test_create_blueprint_rest(request_type):
    ...
    request_init["blueprint"] = {'name': 'name_value', 'revision_id': 'revision_id_value', 'source_blueprint': 'source_blueprint_value', 'revision_create_time': {'seconds': 751, 'nanos': 543}, 'approval_state': 1, 'display_name': 'display_name_value', 'repository': 'repository_value', 'files': [{'path': 'path_value', 'content': 'content_value', 'deleted': True, 'editable': True}], 'labels': {}, 'create_time': {}, 'update_time': {}, 'source_provider': 'source_provider_value', 'deployment_level': 1, 'rollback_support': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_deployment_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/orchestrationClusters/sample3'}
    request_init["deployment"] = {'name': 'name_value', 'revision_id': 'revision_id_value', 'source_blueprint_revision': 'source_blueprint_revision_value', 'revision_create_time': {'seconds': 751, 'nanos': 543}, 'state': 1, 'display_name': 'display_name_value', 'repository': 'repository_value', 'files': [{'path': 'path_value', 'content': 'content_value', 'deleted': True, 'editable': True}], 'labels': {}, 'create_time': {}, 'update_time': {}, 'source_provider': 'source_provider_value', 'workload_cluster': 'workload_cluster_value', 'deployment_level': 1, 'rollback_support': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

...
from google.cloud.telcoautomation_v1alpha1.services.telco_automation import TelcoAutomationAsyncClient
...
from google.cloud.telcoautomation_v1alpha1.services.telco_automation import transports
...
def test__get_api_endpoint():
    ...
    assert TelcoAutomationClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == TelcoAutomationClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert TelcoAutomationClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == TelcoAutomationClient.DEFAULT_MTLS_ENDPOINT
...
def test_telco_automation_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        assert client.transport._host == (
            ...
            'https://telcoautomation.googleapis.com'
        )
...
@pytest.mark.parametrize("client_class", [
    TelcoAutomationClient, TelcoAutomationAsyncClient
])
...
def test_telco_automation_client_client_options_from_dict():
    with mock.patch('google.cloud.telcoautomation_v1alpha1.services.telco_automation.transports.TelcoAutomationGrpcTransport.__init__') as grpc_transport:
...
def test_list_orchestration_clusters_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, telcoautomation.OrchestrationCluster)
                   for i in results)
...
async def test_list_orchestration_clusters_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_orchestration_clusters(request={},)
...
def test_get_orchestration_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_orchestration_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_orchestration_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_orchestration_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_orchestration_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_orchestration_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_edge_slms(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_edge_slms),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_edge_slms_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, telcoautomation.EdgeSlm)
                   for i in results)
...
async def test_list_edge_slms_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_edge_slms(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_edge_slm(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_edge_slm),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_edge_slm(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_edge_slm),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_edge_slm(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_edge_slm),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_blueprint(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_blueprint),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_blueprint(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_blueprint),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = telcoautomation.Blueprint(
            name='name_value',
...
def test_get_blueprint(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_blueprint),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = telcoautomation.Blueprint(
            name='name_value',
...
def test_delete_blueprint(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_blueprint),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_blueprint_revision(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_blueprint_revision),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = telcoautomation.Blueprint(
            name='name_value',
...
@pytest.mark.asyncio
async def test_delete_blueprint_revision_async(transport: str = 'grpc_asyncio', request_type=telcoautomation.DeleteBlueprintRevisionRequest):
    client = TelcoAutomationAsyncClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_blueprints(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_blueprints),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_blueprints_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, telcoautomation.Blueprint)
                   for i in results)
...
async def test_list_blueprints_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_blueprints(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_approve_blueprint(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.approve_blueprint),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = telcoautomation.Blueprint(
            name='name_value',
...
def test_propose_blueprint(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.propose_blueprint),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = telcoautomation.Blueprint(
            name='name_value',
...
def test_reject_blueprint(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.reject_blueprint),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = telcoautomation.Blueprint(
            name='name_value',
...
async def test_list_blueprint_revisions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_blueprint_revisions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
async def test_search_blueprint_revisions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.search_blueprint_revisions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_search_deployment_revisions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, telcoautomation.Deployment)
                   for i in results)
...
async def test_search_deployment_revisions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.search_deployment_revisions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_discard_blueprint_changes(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.discard_blueprint_changes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_public_blueprints_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, telcoautomation.PublicBlueprint)
                   for i in results)
...
async def test_list_public_blueprints_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_public_blueprints(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_public_blueprint(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_public_blueprint),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.deployment_level == telcoautomation.PublicBlueprint.DeploymentLevel.HYDRATION
    assert response.source_provider == 'source_provider_value'
...
@pytest.mark.asyncio
async def test_delete_deployment_async(transport: str = 'grpc_asyncio', request_type=telcoautomation.DeleteDeploymentRequest):
    client = TelcoAutomationAsyncClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_remove_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_deployment_revision(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_deployment_revision),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = telcoautomation.Deployment(
            name='name_value',
...
@pytest.mark.asyncio
async def test_delete_deployment_revision_async(transport: str = 'grpc_asyncio', request_type=telcoautomation.DeleteDeploymentRevisionRequest):
    client = TelcoAutomationAsyncClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
async def test_list_deployment_revisions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_deployment_revisions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_discard_deployment_changes(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.discard_deployment_changes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_apply_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.apply_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = telcoautomation.Deployment(
            name='name_value',
...
def test_compute_deployment_status(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.compute_deployment_status),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_rollback_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rollback_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = telcoautomation.Deployment(
            name='name_value',
...
def test_get_hydrated_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_hydrated_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_hydrated_deployments_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, telcoautomation.HydratedDeployment)
                   for i in results)
...
async def test_list_hydrated_deployments_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_hydrated_deployments(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_update_hydrated_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_hydrated_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = telcoautomation.HydratedDeployment(
            name='name_value',
...
def test_apply_hydrated_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.apply_hydrated_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = telcoautomation.HydratedDeployment(
            name='name_value',
...
def test_list_orchestration_clusters_rest_required_fields(request_type=telcoautomation.ListOrchestrationClustersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_orchestration_clusters._get_unset_required_fields(jsonified_request)
...
def test_list_orchestration_clusters_rest_unset_required_fields():
    transport = transports.TelcoAutomationRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_orchestration_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_list_orchestration_clusters") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_list_orchestration_clusters") as pre:
        ...
        req.return_value._content = telcoautomation.ListOrchestrationClustersResponse.to_json(telcoautomation.ListOrchestrationClustersResponse())
        ...
        client.list_orchestration_clusters(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_orchestration_clusters_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ListOrchestrationClustersRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_orchestration_clusters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*}/orchestrationClusters" % client.transport._host, args[1])
...
def test_get_orchestration_cluster_rest_required_fields(request_type=telcoautomation.GetOrchestrationClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_orchestration_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_orchestration_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_get_orchestration_cluster") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_get_orchestration_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.OrchestrationCluster.to_json(telcoautomation.OrchestrationCluster())
        ...
        client.get_orchestration_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_orchestration_cluster_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.GetOrchestrationClusterRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_orchestration_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*}" % client.transport._host, args[1])
...
def test_create_orchestration_cluster_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["orchestration_cluster"] = {'name': 'name_value', 'management_config': {'standard_management_config': {'network': 'network_value', 'subnet': 'subnet_value', 'master_ipv4_cidr_block': 'master_ipv4_cidr_block_value', 'cluster_cidr_block': 'cluster_cidr_block_value', 'services_cidr_block': 'services_cidr_block_value', 'cluster_named_range': 'cluster_named_range_value', 'services_named_range': 'services_named_range_value', 'master_authorized_networks_config': {'cidr_blocks': [{'display_name': 'display_name_value', 'cidr_block': 'cidr_block_value'}]}}, 'full_management_config': {'network': 'network_value', 'subnet': 'subnet_value', 'master_ipv4_cidr_block': 'master_ipv4_cidr_block_value', 'cluster_cidr_block': 'cluster_cidr_block_value', 'services_cidr_block': 'services_cidr_block_value', 'cluster_named_range': 'cluster_named_range_value', 'services_named_range': 'services_named_range_value', 'master_authorized_networks_config': {}}}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'tna_version': 'tna_version_value', 'state': 1}
...
def test_create_orchestration_cluster_rest_required_fields(request_type=telcoautomation.CreateOrchestrationClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_orchestration_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_orchestration_cluster._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("orchestration_cluster_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_orchestration_cluster_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("orchestrationClusterId", "requestId", )) & set(("parent", "orchestrationClusterId", "orchestrationCluster", )))
...
def test_create_orchestration_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_create_orchestration_cluster") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_create_orchestration_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_orchestration_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_orchestration_cluster_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.CreateOrchestrationClusterRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_orchestration_cluster_rest_required_fields(request_type=telcoautomation.DeleteOrchestrationClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_orchestration_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_orchestration_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_delete_orchestration_cluster") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_delete_orchestration_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_orchestration_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_orchestration_cluster_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.DeleteOrchestrationClusterRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_edge_slms_rest_required_fields(request_type=telcoautomation.ListEdgeSlmsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_edge_slms._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_edge_slms_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_list_edge_slms") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_list_edge_slms") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.ListEdgeSlmsResponse.to_json(telcoautomation.ListEdgeSlmsResponse())
        ...
        client.list_edge_slms(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_edge_slms_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ListEdgeSlmsRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_edge_slms_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*}/edgeSlms" % client.transport._host, args[1])
...
def test_get_edge_slm_rest_required_fields(request_type=telcoautomation.GetEdgeSlmRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_edge_slm._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_edge_slm_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_get_edge_slm") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_get_edge_slm") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.EdgeSlm.to_json(telcoautomation.EdgeSlm())
        ...
        client.get_edge_slm(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_edge_slm_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.GetEdgeSlmRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_edge_slm_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/edgeSlms/*}" % client.transport._host, args[1])
...
def test_create_edge_slm_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["edge_slm"] = {'name': 'name_value', 'orchestration_cluster': 'orchestration_cluster_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'tna_version': 'tna_version_value', 'state': 1, 'workload_cluster_type': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_edge_slm_rest_required_fields(request_type=telcoautomation.CreateEdgeSlmRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_edge_slm._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_edge_slm._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("edge_slm_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_edge_slm_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("edgeSlmId", "requestId", )) & set(("parent", "edgeSlmId", "edgeSlm", )))
...
def test_create_edge_slm_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_create_edge_slm") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_create_edge_slm") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_edge_slm(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_edge_slm_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.CreateEdgeSlmRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_edge_slm_rest_required_fields(request_type=telcoautomation.DeleteEdgeSlmRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_edge_slm._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_edge_slm_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_delete_edge_slm") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_delete_edge_slm") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_edge_slm(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_edge_slm_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.DeleteEdgeSlmRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_blueprint_rest(request_type):
    ...
    request_init["blueprint"] = {'name': 'name_value', 'revision_id': 'revision_id_value', 'source_blueprint': 'source_blueprint_value', 'revision_create_time': {'seconds': 751, 'nanos': 543}, 'approval_state': 1, 'display_name': 'display_name_value', 'repository': 'repository_value', 'files': [{'path': 'path_value', 'content': 'content_value', 'deleted': True, 'editable': True}], 'labels': {}, 'create_time': {}, 'update_time': {}, 'source_provider': 'source_provider_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_blueprint_rest_required_fields(request_type=telcoautomation.CreateBlueprintRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_blueprint._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_blueprint_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("blueprintId", )) & set(("parent", "blueprint", )))
...
def test_create_blueprint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_create_blueprint") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_create_blueprint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.Blueprint.to_json(telcoautomation.Blueprint())
        ...
        client.create_blueprint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_blueprint_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.CreateBlueprintRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_blueprint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*/orchestrationClusters/*}/blueprints" % client.transport._host, args[1])
...
def test_update_blueprint_rest(request_type):
    ...
    request_init["blueprint"] = {'name': 'projects/sample1/locations/sample2/orchestrationClusters/sample3/blueprints/sample4', 'revision_id': 'revision_id_value', 'source_blueprint': 'source_blueprint_value', 'revision_create_time': {'seconds': 751, 'nanos': 543}, 'approval_state': 1, 'display_name': 'display_name_value', 'repository': 'repository_value', 'files': [{'path': 'path_value', 'content': 'content_value', 'deleted': True, 'editable': True}], 'labels': {}, 'create_time': {}, 'update_time': {}, 'source_provider': 'source_provider_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_blueprint_rest_required_fields(request_type=telcoautomation.UpdateBlueprintRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_blueprint._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_blueprint_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("blueprint", "updateMask", )))
...
def test_update_blueprint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_update_blueprint") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_update_blueprint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_blueprint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_blueprint_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.UpdateBlueprintRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_blueprint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{blueprint.name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}" % client.transport._host, args[1])
...
def test_get_blueprint_rest_required_fields(request_type=telcoautomation.GetBlueprintRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_blueprint._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_blueprint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_get_blueprint") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_get_blueprint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_blueprint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_blueprint_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.GetBlueprintRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_blueprint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}" % client.transport._host, args[1])
...
def test_delete_blueprint_rest_required_fields(request_type=telcoautomation.DeleteBlueprintRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_blueprint._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_blueprint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_delete_blueprint") as pre:
        pre.assert_not_called()
        ...
        client.delete_blueprint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_blueprint_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.DeleteBlueprintRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_blueprint_revision_rest_required_fields(request_type=telcoautomation.DeleteBlueprintRevisionRequest):
    transport_class = transports.TelcoAutomationRestTransport
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_blueprint_revision._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_blueprint_revision_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_delete_blueprint_revision") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_delete_blueprint_revision") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = telcoautomation.DeleteBlueprintRevisionRequest.pb(telcoautomation.DeleteBlueprintRevisionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_blueprint_revision(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_blueprint_revision_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.DeleteBlueprintRevisionRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_blueprints_rest_required_fields(request_type=telcoautomation.ListBlueprintsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_blueprints._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_blueprints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_list_blueprints") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_list_blueprints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.ListBlueprintsResponse.to_json(telcoautomation.ListBlueprintsResponse())
        ...
        client.list_blueprints(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_blueprints_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ListBlueprintsRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_approve_blueprint_rest_required_fields(request_type=telcoautomation.ApproveBlueprintRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).approve_blueprint._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_approve_blueprint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_approve_blueprint") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_approve_blueprint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.approve_blueprint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_approve_blueprint_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ApproveBlueprintRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_approve_blueprint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}:approve" % client.transport._host, args[1])
...
def test_propose_blueprint_rest_required_fields(request_type=telcoautomation.ProposeBlueprintRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).propose_blueprint._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_propose_blueprint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_propose_blueprint") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_propose_blueprint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.propose_blueprint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_propose_blueprint_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ProposeBlueprintRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_propose_blueprint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}:propose" % client.transport._host, args[1])
...
def test_reject_blueprint_rest_required_fields(request_type=telcoautomation.RejectBlueprintRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).reject_blueprint._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reject_blueprint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_reject_blueprint") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_reject_blueprint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.reject_blueprint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_reject_blueprint_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.RejectBlueprintRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_reject_blueprint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}:reject" % client.transport._host, args[1])
...
def test_list_blueprint_revisions_rest_required_fields(request_type=telcoautomation.ListBlueprintRevisionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_blueprint_revisions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_blueprint_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_list_blueprint_revisions") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_list_blueprint_revisions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.ListBlueprintRevisionsResponse.to_json(telcoautomation.ListBlueprintRevisionsResponse())
        ...
        client.list_blueprint_revisions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_blueprint_revisions_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ListBlueprintRevisionsRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_blueprint_revisions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}:listRevisions" % client.transport._host, args[1])
...
def test_search_blueprint_revisions_rest_required_fields(request_type=telcoautomation.SearchBlueprintRevisionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_blueprint_revisions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_blueprint_revisions_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pageSize", "pageToken", "query", )) & set(("parent", "query", )))
...
def test_search_blueprint_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_search_blueprint_revisions") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_search_blueprint_revisions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.SearchBlueprintRevisionsResponse.to_json(telcoautomation.SearchBlueprintRevisionsResponse())
        ...
        client.search_blueprint_revisions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_search_blueprint_revisions_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.SearchBlueprintRevisionsRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_search_blueprint_revisions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*/orchestrationClusters/*}/blueprints:searchRevisions" % client.transport._host, args[1])
...
def test_search_deployment_revisions_rest_required_fields(request_type=telcoautomation.SearchDeploymentRevisionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_deployment_revisions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_deployment_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_search_deployment_revisions") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_search_deployment_revisions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.SearchDeploymentRevisionsResponse.to_json(telcoautomation.SearchDeploymentRevisionsResponse())
        ...
        client.search_deployment_revisions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_search_deployment_revisions_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.SearchDeploymentRevisionsRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_search_deployment_revisions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*/orchestrationClusters/*}/deployments:searchRevisions" % client.transport._host, args[1])
...
def test_discard_blueprint_changes_rest_required_fields(request_type=telcoautomation.DiscardBlueprintChangesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).discard_blueprint_changes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_discard_blueprint_changes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_discard_blueprint_changes") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_discard_blueprint_changes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.DiscardBlueprintChangesResponse.to_json(telcoautomation.DiscardBlueprintChangesResponse())
        ...
        client.discard_blueprint_changes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_discard_blueprint_changes_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.DiscardBlueprintChangesRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_discard_blueprint_changes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/blueprints/*}:discard" % client.transport._host, args[1])
...
def test_list_public_blueprints_rest_required_fields(request_type=telcoautomation.ListPublicBlueprintsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_public_blueprints._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_public_blueprints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_list_public_blueprints") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_list_public_blueprints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.ListPublicBlueprintsResponse.to_json(telcoautomation.ListPublicBlueprintsResponse())
        ...
        client.list_public_blueprints(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_public_blueprints_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ListPublicBlueprintsRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_public_blueprints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*}/publicBlueprints" % client.transport._host, args[1])
...
def test_get_public_blueprint_rest_required_fields(request_type=telcoautomation.GetPublicBlueprintRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_public_blueprint._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_public_blueprint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_get_public_blueprint") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_get_public_blueprint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.PublicBlueprint.to_json(telcoautomation.PublicBlueprint())
        ...
        client.get_public_blueprint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_public_blueprint_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.GetPublicBlueprintRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_public_blueprint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/publicBlueprints/*}" % client.transport._host, args[1])
...
def test_create_deployment_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/orchestrationClusters/sample3'}
    request_init["deployment"] = {'name': 'name_value', 'revision_id': 'revision_id_value', 'source_blueprint_revision': 'source_blueprint_revision_value', 'revision_create_time': {'seconds': 751, 'nanos': 543}, 'state': 1, 'display_name': 'display_name_value', 'repository': 'repository_value', 'files': [{'path': 'path_value', 'content': 'content_value', 'deleted': True, 'editable': True}], 'labels': {}, 'create_time': {}, 'update_time': {}, 'source_provider': 'source_provider_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_create_deployment") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_create_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.Deployment.to_json(telcoautomation.Deployment())
...
def test_create_deployment_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.CreateDeploymentRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*/orchestrationClusters/*}/deployments" % client.transport._host, args[1])
...
def test_update_deployment_rest(request_type):
    ...
    request_init["deployment"] = {'name': 'projects/sample1/locations/sample2/orchestrationClusters/sample3/deployments/sample4', 'revision_id': 'revision_id_value', 'source_blueprint_revision': 'source_blueprint_revision_value', 'revision_create_time': {'seconds': 751, 'nanos': 543}, 'state': 1, 'display_name': 'display_name_value', 'repository': 'repository_value', 'files': [{'path': 'path_value', 'content': 'content_value', 'deleted': True, 'editable': True}], 'labels': {}, 'create_time': {}, 'update_time': {}, 'source_provider': 'source_provider_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_update_deployment") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_update_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_deployment_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.UpdateDeploymentRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{deployment.name=projects/*/locations/*/orchestrationClusters/*/deployments/*}" % client.transport._host, args[1])
...
def test_get_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_get_deployment") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_get_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_deployment_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.GetDeploymentRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}" % client.transport._host, args[1])
...
def test_delete_deployment_rest_required_fields(request_type=telcoautomation.DeleteDeploymentRequest):
    transport_class = transports.TelcoAutomationRestTransport
...
def test_delete_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_delete_deployment") as pre:
        pre.assert_not_called()
        pb_message = telcoautomation.DeleteDeploymentRequest.pb(telcoautomation.DeleteDeploymentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_deployment_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.DeleteDeploymentRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_remove_deployment_rest_required_fields(request_type=telcoautomation.RemoveDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).remove_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_remove_deployment") as pre:
        pre.assert_not_called()
        ...
        client.remove_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_remove_deployment_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.RemoveDeploymentRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_remove_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:remove" % client.transport._host, args[1])
...
def test_delete_deployment_revision_rest_required_fields(request_type=telcoautomation.DeleteDeploymentRevisionRequest):
    transport_class = transports.TelcoAutomationRestTransport
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_deployment_revision._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_deployment_revision_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_delete_deployment_revision") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_delete_deployment_revision") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = telcoautomation.DeleteDeploymentRevisionRequest.pb(telcoautomation.DeleteDeploymentRevisionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_deployment_revision(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_deployment_revision_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.DeleteDeploymentRevisionRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_list_deployments") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_list_deployments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.ListDeploymentsResponse.to_json(telcoautomation.ListDeploymentsResponse())
...
def test_list_deployments_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ListDeploymentsRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_deployment_revisions_rest_required_fields(request_type=telcoautomation.ListDeploymentRevisionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_deployment_revisions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_deployment_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_list_deployment_revisions") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_list_deployment_revisions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.ListDeploymentRevisionsResponse.to_json(telcoautomation.ListDeploymentRevisionsResponse())
        ...
        client.list_deployment_revisions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_deployment_revisions_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ListDeploymentRevisionsRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_deployment_revisions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:listRevisions" % client.transport._host, args[1])
...
def test_discard_deployment_changes_rest_required_fields(request_type=telcoautomation.DiscardDeploymentChangesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).discard_deployment_changes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_discard_deployment_changes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_discard_deployment_changes") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_discard_deployment_changes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.DiscardDeploymentChangesResponse.to_json(telcoautomation.DiscardDeploymentChangesResponse())
        ...
        client.discard_deployment_changes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_discard_deployment_changes_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.DiscardDeploymentChangesRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_discard_deployment_changes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:discard" % client.transport._host, args[1])
...
def test_apply_deployment_rest_required_fields(request_type=telcoautomation.ApplyDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).apply_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_apply_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_apply_deployment") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_apply_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.apply_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_apply_deployment_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ApplyDeploymentRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_apply_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:apply" % client.transport._host, args[1])
...
def test_compute_deployment_status_rest_required_fields(request_type=telcoautomation.ComputeDeploymentStatusRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).compute_deployment_status._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_compute_deployment_status_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_compute_deployment_status") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_compute_deployment_status") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.ComputeDeploymentStatusResponse.to_json(telcoautomation.ComputeDeploymentStatusResponse())
        ...
        client.compute_deployment_status(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_compute_deployment_status_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ComputeDeploymentStatusRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_compute_deployment_status_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:computeDeploymentStatus" % client.transport._host, args[1])
...
def test_rollback_deployment_rest_required_fields(request_type=telcoautomation.RollbackDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).rollback_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_rollback_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_rollback_deployment") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_rollback_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.rollback_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_rollback_deployment_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.RollbackDeploymentRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_rollback_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*}:rollback" % client.transport._host, args[1])
...
def test_get_hydrated_deployment_rest_required_fields(request_type=telcoautomation.GetHydratedDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_hydrated_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_hydrated_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_get_hydrated_deployment") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_get_hydrated_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.HydratedDeployment.to_json(telcoautomation.HydratedDeployment())
        ...
        client.get_hydrated_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_hydrated_deployment_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.GetHydratedDeploymentRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_hydrated_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*/hydratedDeployments/*}" % client.transport._host, args[1])
...
def test_list_hydrated_deployments_rest_required_fields(request_type=telcoautomation.ListHydratedDeploymentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_hydrated_deployments._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_hydrated_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_list_hydrated_deployments") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_list_hydrated_deployments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = telcoautomation.ListHydratedDeploymentsResponse.to_json(telcoautomation.ListHydratedDeploymentsResponse())
        ...
        client.list_hydrated_deployments(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_hydrated_deployments_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ListHydratedDeploymentsRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_hydrated_deployments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*/orchestrationClusters/*/deployments/*}/hydratedDeployments" % client.transport._host, args[1])
...
def test_update_hydrated_deployment_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'hydrated_deployment': {'name': 'projects/sample1/locations/sample2/orchestrationClusters/sample3/deployments/sample4/hydratedDeployments/sample5'}}
    request_init["hydrated_deployment"] = {'name': 'projects/sample1/locations/sample2/orchestrationClusters/sample3/deployments/sample4/hydratedDeployments/sample5', 'state': 1, 'files': [{'path': 'path_value', 'content': 'content_value', 'deleted': True, 'editable': True}], 'workload_cluster': 'workload_cluster_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_hydrated_deployment_rest_required_fields(request_type=telcoautomation.UpdateHydratedDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_hydrated_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_hydrated_deployment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("hydratedDeployment", "updateMask", )))
...
def test_update_hydrated_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_update_hydrated_deployment") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_update_hydrated_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_hydrated_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_hydrated_deployment_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.UpdateHydratedDeploymentRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_hydrated_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'hydrated_deployment': {'name': 'projects/sample1/locations/sample2/orchestrationClusters/sample3/deployments/sample4/hydratedDeployments/sample5'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{hydrated_deployment.name=projects/*/locations/*/orchestrationClusters/*/deployments/*/hydratedDeployments/*}" % client.transport._host, args[1])
...
def test_apply_hydrated_deployment_rest_required_fields(request_type=telcoautomation.ApplyHydratedDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).apply_hydrated_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_apply_hydrated_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "post_apply_hydrated_deployment") as post, \
         mock.patch.object(transports.TelcoAutomationRestInterceptor, "pre_apply_hydrated_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.apply_hydrated_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_apply_hydrated_deployment_rest_bad_request(transport: str = 'rest', request_type=telcoautomation.ApplyHydratedDeploymentRequest):
    client = TelcoAutomationClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_apply_hydrated_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/orchestrationClusters/*/deployments/*/hydratedDeployments/*}:apply" % client.transport._host, args[1])
...
def test_telco_automation_base_transport():
    ...
    with mock.patch('google.cloud.telcoautomation_v1alpha1.services.telco_automation.transports.TelcoAutomationTransport.__init__') as Transport:
...
def test_telco_automation_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.telcoautomation_v1alpha1.services.telco_automation.transports.TelcoAutomationTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_telco_automation_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.telcoautomation_v1alpha1.services.telco_automation.transports.TelcoAutomationTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.TelcoAutomationTransport()
        adc.assert_called_once()
...
def test_telco_automation_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.TelcoAutomationGrpcTransport, transports.TelcoAutomationGrpcAsyncIOTransport])
def test_telco_automation_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_blueprint_path():
    ...
    blueprint = "octopus"
    expected = "projects/{project}/locations/{location}/orchestrationClusters/{orchestration_cluster}/blueprints/{blueprint}".format(project=project, location=location, orchestration_cluster=orchestration_cluster, blueprint=blueprint, )
...
def test_deployment_path():
    ...
    deployment = "abalone"
    expected = "projects/{project}/locations/{location}/orchestrationClusters/{orchestration_cluster}/deployments/{deployment}".format(project=project, location=location, orchestration_cluster=orchestration_cluster, deployment=deployment, )
...
def test_edge_slm_path():
    ...
    location = "nudibranch"
    edge_slm = "cuttlefish"
    expected = "projects/{project}/locations/{location}/edgeSlms/{edge_slm}".format(project=project, location=location, edge_slm=edge_slm, )
...
def test_hydrated_deployment_path():
    ...
    expected = "projects/{project}/locations/{location}/orchestrationClusters/{orchestration_cluster}/deployments/{deployment}/hydratedDeployments/{hydrated_deployment}".format(project=project, location=location, orchestration_cluster=orchestration_cluster, deployment=deployment, hydrated_deployment=hydrated_deployment, )
...
def test_orchestration_cluster_path():
    ...
    location = "nautilus"
    orchestration_cluster = "scallop"
    expected = "projects/{project}/locations/{location}/orchestrationClusters/{orchestration_cluster}".format(project=project, location=location, orchestration_cluster=orchestration_cluster, )
...
def test_public_blueprint_path():
    ...
    expected = "projects/{project}/locations/{location}/publicBlueprints/{public_lueprint}".format(project=project, location=location, public_lueprint=public_lueprint, )

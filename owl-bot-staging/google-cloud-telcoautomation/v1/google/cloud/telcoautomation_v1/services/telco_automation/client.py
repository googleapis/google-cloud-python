...
from .transports.base import TelcoAutomationTransport, DEFAULT_CLIENT_INFO
...
class TelcoAutomationClient(metaclass=TelcoAutomationClientMeta):
    ...
    @staticmethod
    def blueprint_path(project: str,location: str,orchestration_cluster: str,blueprint: str,) -> str:
        """Returns a fully-qualified blueprint string."""
        return "projects/{project}/locations/{location}/orchestrationClusters/{orchestration_cluster}/blueprints/{blueprint}".format(project=project, location=location, orchestration_cluster=orchestration_cluster, blueprint=blueprint, )

    @staticmethod
    def parse_blueprint_path(path: str) -> Dict[str,str]:
        """Parses a blueprint path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/orchestrationClusters/(?P<orchestration_cluster>.+?)/blueprints/(?P<blueprint>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def deployment_path(project: str,location: str,orchestration_cluster: str,deployment: str,) -> str:
        """Returns a fully-qualified deployment string."""
        return "projects/{project}/locations/{location}/orchestrationClusters/{orchestration_cluster}/deployments/{deployment}".format(project=project, location=location, orchestration_cluster=orchestration_cluster, deployment=deployment, )

    @staticmethod
    def parse_deployment_path(path: str) -> Dict[str,str]:
        """Parses a deployment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/orchestrationClusters/(?P<orchestration_cluster>.+?)/deployments/(?P<deployment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def edge_slm_path(project: str,location: str,edge_slm: str,) -> str:
        """Returns a fully-qualified edge_slm string."""
        return "projects/{project}/locations/{location}/edgeSlms/{edge_slm}".format(project=project, location=location, edge_slm=edge_slm, )

    @staticmethod
    def parse_edge_slm_path(path: str) -> Dict[str,str]:
        """Parses a edge_slm path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/edgeSlms/(?P<edge_slm>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def hydrated_deployment_path(project: str,location: str,orchestration_cluster: str,deployment: str,hydrated_deployment: str,) -> str:
        """Returns a fully-qualified hydrated_deployment string."""
        return "projects/{project}/locations/{location}/orchestrationClusters/{orchestration_cluster}/deployments/{deployment}/hydratedDeployments/{hydrated_deployment}".format(project=project, location=location, orchestration_cluster=orchestration_cluster, deployment=deployment, hydrated_deployment=hydrated_deployment, )

    @staticmethod
    def parse_hydrated_deployment_path(path: str) -> Dict[str,str]:
        """Parses a hydrated_deployment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/orchestrationClusters/(?P<orchestration_cluster>.+?)/deployments/(?P<deployment>.+?)/hydratedDeployments/(?P<hydrated_deployment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def orchestration_cluster_path(project: str,location: str,orchestration_cluster: str,) -> str:
        """Returns a fully-qualified orchestration_cluster string."""
        return "projects/{project}/locations/{location}/orchestrationClusters/{orchestration_cluster}".format(project=project, location=location, orchestration_cluster=orchestration_cluster, )
    ...
    def parse_orchestration_cluster_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/orchestrationClusters/(?P<orchestration_cluster>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def public_blueprint_path(project: str,location: str,public_lueprint: str,) -> str:
        """Returns a fully-qualified public_blueprint string."""
        return "projects/{project}/locations/{location}/publicBlueprints/{public_lueprint}".format(project=project, location=location, public_lueprint=public_lueprint, )

    @staticmethod
    def parse_public_blueprint_path(path: str) -> Dict[str,str]:
        """Parses a public_blueprint path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/publicBlueprints/(?P<public_lueprint>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = TelcoAutomationClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TelcoAutomationTransport, Callable[..., TelcoAutomationTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = TelcoAutomationClient._read_environment_variables()
        self._client_cert_source = TelcoAutomationClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = TelcoAutomationClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TelcoAutomationTransport], Callable[..., TelcoAutomationTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.telcoautomation_v1.TelcoAutomationClient`.",
                    extra = {
    ...
    def list_orchestration_clusters(self,
            request: Optional[Union[telcoautomation.ListOrchestrationClustersRequest, dict]] = None,
            *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_orchestration_clusters]
    ...
    def get_orchestration_cluster(self,
            request: Optional[Union[telcoautomation.GetOrchestrationClusterRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_orchestration_cluster]
    ...
    def create_orchestration_cluster(self,
            request: Optional[Union[telcoautomation.CreateOrchestrationClusterRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, orchestration_cluster, orchestration_cluster_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_orchestration_cluster]
    ...
    def delete_orchestration_cluster(self,
            request: Optional[Union[telcoautomation.DeleteOrchestrationClusterRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_orchestration_cluster]
    ...
    def create_edge_slm(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, edge_slm, edge_slm_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def create_blueprint(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, blueprint, blueprint_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_blueprint(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [blueprint, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list_blueprint_revisions(self,
            request: Optional[Union[telcoautomation.ListBlueprintRevisionsRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def search_blueprint_revisions(self,
            request: Optional[Union[telcoautomation.SearchBlueprintRevisionsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_blueprint_revisions]
    ...
    def search_deployment_revisions(self,
            request: Optional[Union[telcoautomation.SearchDeploymentRevisionsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            query: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_deployment_revisions]
    ...
    def discard_blueprint_changes(self,
            request: Optional[Union[telcoautomation.DiscardBlueprintChangesRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.discard_blueprint_changes]
    ...
    def list_public_blueprints(self,
            request: Optional[Union[telcoautomation.ListPublicBlueprintsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_public_blueprint(self,
            request: Optional[Union[telcoautomation.GetPublicBlueprintRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_deployment_revisions(self,
            request: Optional[Union[telcoautomation.ListDeploymentRevisionsRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_deployment_revisions]
    ...
    def discard_deployment_changes(self,
            request: Optional[Union[telcoautomation.DiscardDeploymentChangesRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.discard_deployment_changes]
    ...
    def compute_deployment_status(self,
            request: Optional[Union[telcoautomation.ComputeDeploymentStatusRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.compute_deployment_status]
    ...
    def rollback_deployment(self,
            request: Optional[Union[telcoautomation.RollbackDeploymentRequest, dict]] = None,
            *,
            name: Optional[str] = None,
    ...
    def get_hydrated_deployment(self,
            request: Optional[Union[telcoautomation.GetHydratedDeploymentRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_hydrated_deployments(self,
            request: Optional[Union[telcoautomation.ListHydratedDeploymentsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_hydrated_deployments]
    ...
    def update_hydrated_deployment(self,
            request: Optional[Union[telcoautomation.UpdateHydratedDeploymentRequest, dict]] = None,
            *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [hydrated_deployment, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_hydrated_deployment]
    ...
    def apply_hydrated_deployment(self,
            request: Optional[Union[telcoautomation.ApplyHydratedDeploymentRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.apply_hydrated_deployment]

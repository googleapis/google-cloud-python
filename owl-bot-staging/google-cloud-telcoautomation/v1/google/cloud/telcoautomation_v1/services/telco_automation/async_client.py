...
class TelcoAutomationAsyncClient:
    ...
    get_transport_class = functools.partial(type(TelcoAutomationClient).get_transport_class, type(TelcoAutomationClient))
    ...
    async def list_orchestration_clusters(self,
    ...
    async def get_orchestration_cluster(self,
    ...
    async def create_orchestration_cluster(self,
    ...
    async def delete_orchestration_cluster(self,
    ...
    async def create_edge_slm(self,
    ...
    async def delete_edge_slm(self,
    ...
    async def delete_blueprint(self,
    ...
    async def approve_blueprint(self,
    ...
    async def propose_blueprint(self,
    ...
    async def reject_blueprint(self,
    ...
    async def list_blueprint_revisions(self,
    ...
    async def search_blueprint_revisions(self,
    ...
    async def search_deployment_revisions(self,
    ...
    async def discard_blueprint_changes(self,
    ...
    async def list_public_blueprints(self,
    ...
    async def get_public_blueprint(self,
    ...
    async def list_deployment_revisions(self,
    ...
    async def discard_deployment_changes(self,
    ...
    async def apply_deployment(self,
    ...
    async def compute_deployment_status(self,
    ...
    async def get_hydrated_deployment(self,
    ...
    async def list_hydrated_deployments(self,
    ...
    async def update_hydrated_deployment(self,
    ...
    async def apply_hydrated_deployment(self,

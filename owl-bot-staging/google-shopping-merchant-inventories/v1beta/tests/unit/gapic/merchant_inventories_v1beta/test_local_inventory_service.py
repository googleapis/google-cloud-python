...
from google.shopping.merchant_inventories_v1beta.services.local_inventory_service import LocalInventoryServiceAsyncClient
from google.shopping.merchant_inventories_v1beta.services.local_inventory_service import LocalInventoryServiceClient
from google.shopping.merchant_inventories_v1beta.services.local_inventory_service import pagers
from google.shopping.merchant_inventories_v1beta.services.local_inventory_service import transports
...
def test_list_local_inventories_rest_required_fields(request_type=localinventory.ListLocalInventoriesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_local_inventories._get_unset_required_fields(jsonified_request)
...
def test_list_local_inventories_rest_unset_required_fields():
    transport = transports.LocalInventoryServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_insert_local_inventory_rest_required_fields(request_type=localinventory.InsertLocalInventoryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).insert_local_inventory._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_local_inventory_rest_required_fields(request_type=localinventory.DeleteLocalInventoryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_local_inventory._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transport_kind(transport_name):
    transport = LocalInventoryServiceClient.get_transport_class(transport_name)(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
    )

...
def test_list_regional_inventories_rest_required_fields(request_type=regionalinventory.ListRegionalInventoriesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_regional_inventories._get_unset_required_fields(jsonified_request)
...
def test_list_regional_inventories_rest_unset_required_fields():
    transport = transports.RegionalInventoryServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_insert_regional_inventory_rest_required_fields(request_type=regionalinventory.InsertRegionalInventoryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).insert_regional_inventory._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_regional_inventory_rest_required_fields(request_type=regionalinventory.DeleteRegionalInventoryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_regional_inventory._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

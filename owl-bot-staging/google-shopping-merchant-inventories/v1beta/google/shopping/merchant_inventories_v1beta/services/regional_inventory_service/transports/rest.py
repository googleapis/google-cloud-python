...
class RegionalInventoryServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_regional_inventory(self, request: regionalinventory.DeleteRegionalInventoryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regionalinventory.DeleteRegionalInventoryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert_regional_inventory(self, request: regionalinventory.InsertRegionalInventoryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regionalinventory.InsertRegionalInventoryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_insert_regional_inventory_with_metadata(self, response: regionalinventory.RegionalInventory, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regionalinventory.RegionalInventory, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for insert_regional_inventory
    ...
    def pre_list_regional_inventories(self, request: regionalinventory.ListRegionalInventoriesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regionalinventory.ListRegionalInventoriesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_regional_inventories_with_metadata(self, response: regionalinventory.ListRegionalInventoriesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regionalinventory.ListRegionalInventoriesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_regional_inventories
...
class RegionalInventoryServiceRestTransport(_BaseRegionalInventoryServiceRestTransport):
    ...
    class _DeleteRegionalInventory(_BaseRegionalInventoryServiceRestTransport._BaseDeleteRegionalInventory, RegionalInventoryServiceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseRegionalInventoryServiceRestTransport._BaseDeleteRegionalInventory._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = RegionalInventoryServiceRestTransport._DeleteRegionalInventory._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _InsertRegionalInventory(_BaseRegionalInventoryServiceRestTransport._BaseInsertRegionalInventory, RegionalInventoryServiceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseRegionalInventoryServiceRestTransport._BaseInsertRegionalInventory._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = RegionalInventoryServiceRestTransport._InsertRegionalInventory._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListRegionalInventories(_BaseRegionalInventoryServiceRestTransport._BaseListRegionalInventories, RegionalInventoryServiceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseRegionalInventoryServiceRestTransport._BaseListRegionalInventories._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = RegionalInventoryServiceRestTransport._ListRegionalInventories._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

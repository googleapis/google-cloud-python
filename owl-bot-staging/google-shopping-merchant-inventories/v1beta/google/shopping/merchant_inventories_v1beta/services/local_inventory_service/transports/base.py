...
class LocalInventoryServiceTransport(abc.ABC):
    """Abstract transport class for LocalInventoryService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_local_inventories: gapic_v1.method.wrap_method(
                self.list_local_inventories,
                default_timeout=None,
                client_info=client_info,
            ),
            self.insert_local_inventory: gapic_v1.method.wrap_method(
                self.insert_local_inventory,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_local_inventory: gapic_v1.method.wrap_method(
    ...
    def insert_local_inventory(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[localinventory.LocalInventory]
            ]]:
        raise NotImplementedError()

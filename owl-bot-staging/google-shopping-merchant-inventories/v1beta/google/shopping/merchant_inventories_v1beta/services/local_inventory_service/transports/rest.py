...
from .base import LocalInventoryServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class LocalInventoryServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_local_inventory(self, request: localinventory.DeleteLocalInventoryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[localinventory.DeleteLocalInventoryRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert_local_inventory(self, request: localinventory.InsertLocalInventoryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[localinventory.InsertLocalInventoryRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_insert_local_inventory(self, response: localinventory.LocalInventory) -> localinventory.LocalInventory:
        ...
        """
        return response
    def pre_list_local_inventories(self, request: localinventory.ListLocalInventoriesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[localinventory.ListLocalInventoriesRequest, Sequence[Tuple[str, str]]]:

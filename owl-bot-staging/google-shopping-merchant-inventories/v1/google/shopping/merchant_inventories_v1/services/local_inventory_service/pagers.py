...
class ListLocalInventoriesPager:
    ...
    :class:`google.shopping.merchant_inventories_v1.types.ListLocalInventoriesResponse` object, and
    ...
    All the usual :class:`google.shopping.merchant_inventories_v1.types.ListLocalInventoriesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.shopping.merchant_inventories_v1.types.ListLocalInventoriesRequest):
                The initial request object.
            response (google.shopping.merchant_inventories_v1.types.ListLocalInventoriesResponse):

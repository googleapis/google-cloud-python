...
class LocalInventoryServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_local_inventory(self, request: localinventory.DeleteLocalInventoryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[localinventory.DeleteLocalInventoryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert_local_inventory(self, request: localinventory.InsertLocalInventoryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[localinventory.InsertLocalInventoryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_insert_local_inventory_with_metadata(self, response: localinventory.LocalInventory, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[localinventory.LocalInventory, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for insert_local_inventory
    ...
    def pre_list_local_inventories(self, request: localinventory.ListLocalInventoriesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[localinventory.ListLocalInventoriesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_local_inventories_with_metadata(self, response: localinventory.ListLocalInventoriesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[localinventory.ListLocalInventoriesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_local_inventories
...
class LocalInventoryServiceRestTransport(_BaseLocalInventoryServiceRestTransport):
    ...
    class _DeleteLocalInventory(_BaseLocalInventoryServiceRestTransport._BaseDeleteLocalInventory, LocalInventoryServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LocalInventoryServiceRestTransport._DeleteLocalInventory._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _InsertLocalInventory(_BaseLocalInventoryServiceRestTransport._BaseInsertLocalInventory, LocalInventoryServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LocalInventoryServiceRestTransport._InsertLocalInventory._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListLocalInventories(_BaseLocalInventoryServiceRestTransport._BaseListLocalInventories, LocalInventoryServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LocalInventoryServiceRestTransport._ListLocalInventories._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

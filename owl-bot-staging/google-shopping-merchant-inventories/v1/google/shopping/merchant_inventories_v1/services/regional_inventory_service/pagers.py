...
class ListRegionalInventoriesPager:
    ...
    :class:`google.shopping.merchant_inventories_v1.types.ListRegionalInventoriesResponse` object, and
    ...
    All the usual :class:`google.shopping.merchant_inventories_v1.types.ListRegionalInventoriesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.shopping.merchant_inventories_v1.types.ListRegionalInventoriesRequest):
                The initial request object.
            response (google.shopping.merchant_inventories_v1.types.ListRegionalInventoriesResponse):
...
class ListRegionalInventoriesAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[regionalinventory.ListRegionalInventoriesResponse]],
            request: regionalinventory.ListRegionalInventoriesRequest,
            response: regionalinventory.ListRegionalInventoriesResponse,
            *,
    ...
    @property
    async def pages(self) -> AsyncIterator[regionalinventory.ListRegionalInventoriesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

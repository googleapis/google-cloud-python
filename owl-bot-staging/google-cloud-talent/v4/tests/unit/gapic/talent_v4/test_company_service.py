...
def test_create_company_rest_required_fields(request_type=company_service.CreateCompanyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_company._get_unset_required_fields(jsonified_request)
...
def test_create_company_rest_unset_required_fields():
    transport = transports.CompanyServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_company_rest_required_fields(request_type=company_service.GetCompanyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_company._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_company_rest_required_fields(request_type=company_service.UpdateCompanyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_company._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_company_rest_required_fields(request_type=company_service.DeleteCompanyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_company._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_companies_rest_required_fields(request_type=company_service.ListCompaniesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_companies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

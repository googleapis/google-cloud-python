...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert CompanyServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert CompanyServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert CompanyServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert CompanyServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert CompanyServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert CompanyServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert CompanyServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert CompanyServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(CompanyServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CompanyServiceClient))
@mock.patch.object(CompanyServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CompanyServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CompanyServiceClient._DEFAULT_UNIVERSE
    default_endpoint = CompanyServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = CompanyServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert CompanyServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert CompanyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CompanyServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CompanyServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CompanyServiceClient._get_api_endpoint(None, None, default_universe, "always") == CompanyServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CompanyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CompanyServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CompanyServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert CompanyServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        CompanyServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert CompanyServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert CompanyServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert CompanyServiceClient._get_universe_domain(None, None) == CompanyServiceClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = CompanyServiceClient(credentials=cred)
...
@pytest.mark.parametrize("client_class", [
    CompanyServiceClient, CompanyServiceAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (CompanyServiceClient, transports.CompanyServiceGrpcTransport, "grpc", grpc_helpers),
    (CompanyServiceAsyncClient, transports.CompanyServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_company_service_client_client_options_from_dict():
    with mock.patch('google.cloud.talent_v4.services.company_service.transports.CompanyServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_create_company_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_company in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_company] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_company_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CompanyServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_company in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_company] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_company_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CompanyServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_company in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_company] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_company_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CompanyServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_company in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_company] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_companies_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CompanyServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_companies in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_companies] = mock_rpc
...
def test_create_company_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v4/{parent=projects/*/tenants/*}/companies" % client.transport._host, args[1])
...
def test_get_company_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v4/{name=projects/*/tenants/*/companies/*}" % client.transport._host, args[1])
...
def test_update_company_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("company", )))
...
def test_update_company_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v4/{company.name=projects/*/tenants/*/companies/*}" % client.transport._host, args[1])
...
def test_create_company_rest_bad_request(request_type=company_service.CreateCompanyRequest):
    client = CompanyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_company_rest_call_success(request_type):
    ...
    for field, value in request_init["company"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["company"][field])):
                    del request_init["company"][field][i][subfield]
            else:
                del request_init["company"][field][subfield]
    request = request_type(**request_init)
...
def test_create_company_rest_interceptors(null_interceptor):
    transport = transports.CompanyServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CompanyServiceRestInterceptor(),
        )
    client = CompanyServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "post_create_company") as post, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "post_create_company_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "pre_create_company") as pre:
        ...
        post_with_metadata.return_value = gct_company.Company(), metadata
...
def test_get_company_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "post_get_company") as post, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "post_get_company_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "pre_get_company") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        post_with_metadata.return_value = company.Company(), metadata
...
def test_update_company_rest_bad_request(request_type=company_service.UpdateCompanyRequest):
    client = CompanyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_company_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = company_service.UpdateCompanyRequest.meta.fields["company"]
...
def test_update_company_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "post_update_company") as post, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "post_update_company_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "pre_update_company") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_company_rest_bad_request(request_type=company_service.DeleteCompanyRequest):
    client = CompanyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_company_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "pre_delete_company") as pre:
        pre.assert_not_called()
...
def test_list_companies_rest_bad_request(request_type=company_service.ListCompaniesRequest):
    client = CompanyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_companies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "post_list_companies") as post, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "post_list_companies_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CompanyServiceRestInterceptor, "pre_list_companies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = company_service.ListCompaniesResponse.to_json(company_service.ListCompaniesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = company_service.ListCompaniesResponse(), metadata
...
def test_company_service_base_transport():
    ...
    with mock.patch('google.cloud.talent_v4.services.company_service.transports.CompanyServiceTransport.__init__') as Transport:
...
def test_company_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.talent_v4.services.company_service.transports.CompanyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_company_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.talent_v4.services.company_service.transports.CompanyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CompanyServiceTransport()
        adc.assert_called_once()

...
class TenantServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_tenant(self, request: tenant_service.CreateTenantRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tenant_service.CreateTenantRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_tenant_with_metadata(self, response: gct_tenant.Tenant, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gct_tenant.Tenant, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_tenant
    ...
    def pre_delete_tenant(self, request: tenant_service.DeleteTenantRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tenant_service.DeleteTenantRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_tenant(self, request: tenant_service.GetTenantRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tenant_service.GetTenantRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_tenant_with_metadata(self, response: tenant.Tenant, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tenant.Tenant, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_tenant
    ...
    def pre_list_tenants(self, request: tenant_service.ListTenantsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tenant_service.ListTenantsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_tenants_with_metadata(self, response: tenant_service.ListTenantsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tenant_service.ListTenantsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_tenants
    ...
    def pre_update_tenant(self, request: tenant_service.UpdateTenantRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tenant_service.UpdateTenantRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_tenant_with_metadata(self, response: gct_tenant.Tenant, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gct_tenant.Tenant, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_tenant
    ...
    class _CreateTenant(_BaseTenantServiceRestTransport._BaseCreateTenant, TenantServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.talent_v4.TenantServiceClient.CreateTenant",
                    extra = {
            ...
            # Send the request
            response = TenantServiceRestTransport._CreateTenant._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.talent_v4.TenantServiceClient.create_tenant",
                    extra = {
                        "serviceName": "google.cloud.talent.v4.TenantService",
                        "rpcName": "CreateTenant",
    ...
    class _DeleteTenant(_BaseTenantServiceRestTransport._BaseDeleteTenant, TenantServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.talent_v4.TenantServiceClient.DeleteTenant",
                    extra = {
                        "serviceName": "google.cloud.talent.v4.TenantService",
            ...
            # Send the request
            response = TenantServiceRestTransport._DeleteTenant._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetTenant(_BaseTenantServiceRestTransport._BaseGetTenant, TenantServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.talent_v4.TenantServiceClient.GetTenant",
                    extra = {
                        "serviceName": "google.cloud.talent.v4.TenantService",
                        "rpcName": "GetTenant",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = TenantServiceRestTransport._GetTenant._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.talent_v4.TenantServiceClient.get_tenant",
                    extra = {
                        "serviceName": "google.cloud.talent.v4.TenantService",
                        "rpcName": "GetTenant",
                        "metadata": http_response["headers"],
    ...
    class _ListTenants(_BaseTenantServiceRestTransport._BaseListTenants, TenantServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.talent_v4.TenantServiceClient.ListTenants",
                    extra = {
                        "serviceName": "google.cloud.talent.v4.TenantService",
                        "rpcName": "ListTenants",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = TenantServiceRestTransport._ListTenants._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.talent_v4.TenantServiceClient.list_tenants",
                    extra = {
                        "serviceName": "google.cloud.talent.v4.TenantService",
                        "rpcName": "ListTenants",
                        "metadata": http_response["headers"],
    ...
    class _UpdateTenant(_BaseTenantServiceRestTransport._BaseUpdateTenant, TenantServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.talent_v4.TenantServiceClient.UpdateTenant",
                    extra = {
                        "serviceName": "google.cloud.talent.v4.TenantService",
            ...
            # Send the request
            response = TenantServiceRestTransport._UpdateTenant._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.talent_v4.TenantServiceClient.update_tenant",
                    extra = {
                        "serviceName": "google.cloud.talent.v4.TenantService",
                        "rpcName": "UpdateTenant",
                        "metadata": http_response["headers"],
    ...
    class _GetOperation(_BaseTenantServiceRestTransport._BaseGetOperation, TenantServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.talent_v4.TenantServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.talent.v4.TenantService",
            ...
            # Send the request
            response = TenantServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.talent_v4.TenantServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.talent.v4.TenantService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,

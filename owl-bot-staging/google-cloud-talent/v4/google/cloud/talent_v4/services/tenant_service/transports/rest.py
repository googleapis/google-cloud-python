...
from .base import TenantServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class TenantServiceRestTransport(TenantServiceTransport):
    ...
    class _CreateTenant(TenantServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v4/{parent=projects/*}/tenants',
                'body': 'tenant',
            },
            ]
    ...
    class _UpdateTenant(TenantServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v4/{tenant.name=projects/*/tenants/*}',
                'body': 'tenant',
            },
            ]

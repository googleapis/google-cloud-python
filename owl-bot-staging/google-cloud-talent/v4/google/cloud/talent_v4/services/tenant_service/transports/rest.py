...
class TenantServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_tenant(self, request: tenant_service.CreateTenantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tenant_service.CreateTenantRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_tenant(self, request: tenant_service.DeleteTenantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tenant_service.DeleteTenantRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_tenant(self, request: tenant_service.GetTenantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tenant_service.GetTenantRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_tenants(self, request: tenant_service.ListTenantsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tenant_service.ListTenantsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_tenant(self, request: tenant_service.UpdateTenantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tenant_service.UpdateTenantRequest, Sequence[Tuple[str, str]]]:

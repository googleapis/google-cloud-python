...
class CompanyServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_company(self, request: company_service.CreateCompanyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[company_service.CreateCompanyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_company_with_metadata(self, response: gct_company.Company, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gct_company.Company, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_company
    ...
    def pre_delete_company(self, request: company_service.DeleteCompanyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[company_service.DeleteCompanyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_company(self, request: company_service.GetCompanyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[company_service.GetCompanyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_company_with_metadata(self, response: company.Company, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[company.Company, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_company
    ...
    def pre_list_companies(self, request: company_service.ListCompaniesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[company_service.ListCompaniesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_companies_with_metadata(self, response: company_service.ListCompaniesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[company_service.ListCompaniesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_companies
    ...
    def pre_update_company(self, request: company_service.UpdateCompanyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[company_service.UpdateCompanyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_company_with_metadata(self, response: gct_company.Company, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gct_company.Company, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_company
...
class CompanyServiceRestTransport(_BaseCompanyServiceRestTransport):
    ...
    class _CreateCompany(_BaseCompanyServiceRestTransport._BaseCreateCompany, CompanyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CompanyServiceRestTransport._CreateCompany._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteCompany(_BaseCompanyServiceRestTransport._BaseDeleteCompany, CompanyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CompanyServiceRestTransport._DeleteCompany._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetCompany(_BaseCompanyServiceRestTransport._BaseGetCompany, CompanyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CompanyServiceRestTransport._GetCompany._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListCompanies(_BaseCompanyServiceRestTransport._BaseListCompanies, CompanyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CompanyServiceRestTransport._ListCompanies._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateCompany(_BaseCompanyServiceRestTransport._BaseUpdateCompany, CompanyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CompanyServiceRestTransport._UpdateCompany._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseCompanyServiceRestTransport._BaseGetOperation, CompanyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CompanyServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class CompanyServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_company(self, request: company_service.CreateCompanyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[company_service.CreateCompanyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_company(self, request: company_service.DeleteCompanyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[company_service.DeleteCompanyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_company(self, request: company_service.GetCompanyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[company_service.GetCompanyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_companies(self, request: company_service.ListCompaniesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[company_service.ListCompaniesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_company(self, request: company_service.UpdateCompanyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[company_service.UpdateCompanyRequest, Sequence[Tuple[str, str]]]:

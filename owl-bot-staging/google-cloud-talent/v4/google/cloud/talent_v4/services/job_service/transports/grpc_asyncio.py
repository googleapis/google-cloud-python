...
class JobServiceGrpcAsyncIOTransport(JobServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.batch_create_jobs: gapic_v1.method_async.wrap_method(
            ...
            self.batch_update_jobs: gapic_v1.method_async.wrap_method(
            ...
            self.batch_delete_jobs: gapic_v1.method_async.wrap_method(
            ...
            self.search_jobs: gapic_v1.method_async.wrap_method(
                self.search_jobs,
                default_timeout=30.0,
                client_info=client_info,
            ),
            self.search_jobs_for_alert: gapic_v1.method_async.wrap_method(

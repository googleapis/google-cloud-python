...
class _BaseCompletionRestTransport(CompletionTransport):
    """Base REST backend transport for Completion.
    ...
    class _BaseCompleteQuery:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v4beta1/{parent=projects/*/tenants/*}:complete',
            },
        {
                'method': 'get',
                'uri': '/v4beta1/{parent=projects/*}:complete',
            },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCompletionRestTransport._BaseCompleteQuery._get_unset_required_fields(query_params))

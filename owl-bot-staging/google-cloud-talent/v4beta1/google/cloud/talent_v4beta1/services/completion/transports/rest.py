...
from .rest_base import _BaseCompletionRestTransport
...
class CompletionRestInterceptor:
    """Interceptor for Completion.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the CompletionRestTransport.

    .. code-block:: python
        class MyCustomCompletionInterceptor(CompletionRestInterceptor):
        ...
        transport = CompletionRestTransport(interceptor=MyCustomCompletionInterceptor())
    ...
    def pre_complete_query(self, request: completion_service.CompleteQueryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[completion_service.CompleteQueryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        ...
        before they are sent to the Completion server.
        """
        return request, metadata
...
class CompletionRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: CompletionRestInterceptor


class CompletionRestTransport(_BaseCompletionRestTransport):
    """REST backend synchronous transport for Completion.
    ...
    def __init__(self, *,
            ...
            interceptor: Optional[CompletionRestInterceptor] = None,
        ...
        self._interceptor = interceptor or CompletionRestInterceptor()
        self._prep_wrapped_messages(client_info)

    class _CompleteQuery(_BaseCompletionRestTransport._BaseCompleteQuery, CompletionRestStub):
        def __hash__(self):
            return hash("CompletionRestTransport.CompleteQuery")
        ...
        def __call__(self,
            ...
            http_options = _BaseCompletionRestTransport._BaseCompleteQuery._get_http_options()

            request, metadata = self._interceptor.pre_complete_query(request, metadata)
            transcoded_request = _BaseCompletionRestTransport._BaseCompleteQuery._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseCompletionRestTransport._BaseCompleteQuery._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.talent_v4beta1.CompletionClient.CompleteQuery",
                    extra = {
            ...
            # Send the request
            response = CompletionRestTransport._CompleteQuery._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.talent_v4beta1.CompletionClient.complete_query",
                    extra = {
                        "serviceName": "google.cloud.talent.v4beta1.Completion",
                        "rpcName": "CompleteQuery",
    ...
    class _GetOperation(_BaseCompletionRestTransport._BaseGetOperation, CompletionRestStub):
        def __hash__(self):
            return hash("CompletionRestTransport.GetOperation")
        ...
        def __call__(self,
            ...
            http_options = _BaseCompletionRestTransport._BaseGetOperation._get_http_options()

            request, metadata = self._interceptor.pre_get_operation(request, metadata)
            transcoded_request = _BaseCompletionRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseCompletionRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.talent_v4beta1.CompletionClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.talent.v4beta1.Completion",
            ...
            # Send the request
            response = CompletionRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.talent_v4beta1.CompletionAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.talent.v4beta1.Completion",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,

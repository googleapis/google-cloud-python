...
from .base import CompletionTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class CompletionRestTransport(CompletionTransport):
    """REST backend transport for Completion.
    ...
    class _CompleteQuery(CompletionRestStub):
        def __hash__(self):
            ...
            },
{
    ...
    class _GetOperation(CompletionRestStub):
        def __call__(self,

...
class TenantServiceGrpcAsyncIOTransport(TenantServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_tenant: gapic_v1.method_async.wrap_method(
                self.create_tenant,
                default_timeout=30.0,
                client_info=client_info,
            ),
            self.get_tenant: gapic_v1.method_async.wrap_method(
                self.get_tenant,
            ...
            self.update_tenant: gapic_v1.method_async.wrap_method(
                self.update_tenant,
                default_timeout=30.0,
                client_info=client_info,
            ),
            self.delete_tenant: gapic_v1.method_async.wrap_method(
                self.delete_tenant,
                default_retry=retries.AsyncRetry(
                    initial=0.1,
                    maximum=60.0,
            ...
            self.list_tenants: gapic_v1.method_async.wrap_method(
                self.list_tenants,
                default_retry=retries.AsyncRetry(
                    initial=0.1,
                    maximum=60.0,

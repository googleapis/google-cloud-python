...
def test_create_job_rest_unset_required_fields():
    transport = transports.JobServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_batch_create_jobs_rest_required_fields(request_type=job_service.BatchCreateJobsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_create_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_jobs_rest_required_fields(request_type=job_service.BatchUpdateJobsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_update_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_delete_jobs_rest_required_fields(request_type=job_service.BatchDeleteJobsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_delete_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_jobs_rest_required_fields(request_type=job_service.SearchJobsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_jobs_for_alert_rest_required_fields(request_type=job_service.SearchJobsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_jobs_for_alert._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

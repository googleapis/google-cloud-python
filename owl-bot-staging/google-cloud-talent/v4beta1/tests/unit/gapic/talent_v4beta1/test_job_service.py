...
def test_search_jobs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.search_jobs(request={}, retry=retry, timeout=timeout)
...
def test_search_jobs_for_alert_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.search_jobs_for_alert(request={}, retry=retry, timeout=timeout)
...
def test_create_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.JobServiceRestInterceptor, "post_create_job") as post, \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_create_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobServiceRestInterceptor, "pre_create_job") as pre:
...
def test_batch_create_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.JobServiceRestInterceptor, "post_batch_create_jobs") as post, \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_batch_create_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobServiceRestInterceptor, "pre_batch_create_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.JobServiceRestInterceptor, "post_get_job_with_metadata") as post_with_metadata, \
...
def test_update_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_update_job") as post, \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_update_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobServiceRestInterceptor, "pre_update_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_batch_update_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_batch_update_jobs") as post, \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_batch_update_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobServiceRestInterceptor, "pre_batch_update_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobServiceRestInterceptor, "pre_delete_job") as pre:
        pre.assert_not_called()
...
def test_batch_delete_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobServiceRestInterceptor, "pre_batch_delete_jobs") as pre:
        pre.assert_not_called()
...
def test_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_list_jobs") as post, \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_list_jobs_with_metadata") as post_with_metadata, \
...
def test_search_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_search_jobs") as post, \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_search_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobServiceRestInterceptor, "pre_search_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_search_jobs_for_alert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_search_jobs_for_alert") as post, \
        mock.patch.object(transports.JobServiceRestInterceptor, "post_search_jobs_for_alert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobServiceRestInterceptor, "pre_search_jobs_for_alert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = job_service.SearchJobsRequest.pb(job_service.SearchJobsRequest())

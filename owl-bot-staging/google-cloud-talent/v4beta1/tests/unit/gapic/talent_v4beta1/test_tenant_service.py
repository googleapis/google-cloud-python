...
def test_create_tenant_rest_required_fields(request_type=tenant_service.CreateTenantRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_tenant._get_unset_required_fields(jsonified_request)
...
def test_create_tenant_rest_unset_required_fields():
    transport = transports.TenantServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_tenant_rest_required_fields(request_type=tenant_service.GetTenantRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_tenant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_tenant_rest_required_fields(request_type=tenant_service.UpdateTenantRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_tenant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_tenant_rest_required_fields(request_type=tenant_service.DeleteTenantRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_tenant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_tenants_rest_required_fields(request_type=tenant_service.ListTenantsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_tenants._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

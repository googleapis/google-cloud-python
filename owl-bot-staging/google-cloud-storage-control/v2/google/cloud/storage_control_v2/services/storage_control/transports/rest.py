...
class StorageControlRestTransport(_BaseStorageControlRestTransport):
    ...
    class _GetFolderIntelligenceConfig(_BaseStorageControlRestTransport._BaseGetFolderIntelligenceConfig, StorageControlRestStub):
        ...
        config method over HTTP.
            ...
            # Send the request
            response = StorageControlRestTransport._GetFolderIntelligenceConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOrganizationIntelligenceConfig(_BaseStorageControlRestTransport._BaseGetOrganizationIntelligenceConfig, StorageControlRestStub):
        ...
        intelligence config method over HTTP.
            ...
            transcoded_request = _BaseStorageControlRestTransport._BaseGetOrganizationIntelligenceConfig._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = StorageControlRestTransport._GetOrganizationIntelligenceConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetProjectIntelligenceConfig(_BaseStorageControlRestTransport._BaseGetProjectIntelligenceConfig, StorageControlRestStub):
        ...
        config method over HTTP.
            ...
            # Send the request
            response = StorageControlRestTransport._GetProjectIntelligenceConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateFolderIntelligenceConfig(_BaseStorageControlRestTransport._BaseUpdateFolderIntelligenceConfig, StorageControlRestStub):
        ...
        intelligence config method over HTTP.
            ...
            # Send the request
            response = StorageControlRestTransport._UpdateFolderIntelligenceConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateOrganizationIntelligenceConfig(_BaseStorageControlRestTransport._BaseUpdateOrganizationIntelligenceConfig, StorageControlRestStub):
        ...
        intelligence config method over HTTP.
            ...
            transcoded_request = _BaseStorageControlRestTransport._BaseUpdateOrganizationIntelligenceConfig._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = StorageControlRestTransport._UpdateOrganizationIntelligenceConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateProjectIntelligenceConfig(_BaseStorageControlRestTransport._BaseUpdateProjectIntelligenceConfig, StorageControlRestStub):
        ...
        intelligence config method over HTTP.
            ...
            # Send the request
            response = StorageControlRestTransport._UpdateProjectIntelligenceConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

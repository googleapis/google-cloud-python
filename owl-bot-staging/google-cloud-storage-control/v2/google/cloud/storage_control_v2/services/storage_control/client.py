...
from .transports.base import StorageControlTransport, DEFAULT_CLIENT_INFO
...
class StorageControlClient(metaclass=StorageControlClientMeta):
    ...
    def anywhere_cache_path(project: str,bucket: str,anywhere_cache: str,) -> str:
        ...
        return "projects/{project}/buckets/{bucket}/anywhereCaches/{anywhere_cache}".format(project=project, bucket=bucket, anywhere_cache=anywhere_cache, )

    @staticmethod
    def parse_anywhere_cache_path(path: str) -> Dict[str,str]:
        """Parses a anywhere_cache path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/buckets/(?P<bucket>.+?)/anywhereCaches/(?P<anywhere_cache>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def folder_path(project: str,bucket: str,folder: str,) -> str:
        """Returns a fully-qualified folder string."""
        return "projects/{project}/buckets/{bucket}/folders/{folder}".format(project=project, bucket=bucket, folder=folder, )

    @staticmethod
    def parse_folder_path(path: str) -> Dict[str,str]:
        """Parses a folder path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/buckets/(?P<bucket>.+?)/folders/(?P<folder>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def intelligence_config_path(folder: str,location: str,) -> str:
        """Returns a fully-qualified intelligence_config string."""
        return "folders/{folder}/locations/{location}/intelligenceConfig".format(folder=folder, location=location, )

    @staticmethod
    def parse_intelligence_config_path(path: str) -> Dict[str,str]:
        """Parses a intelligence_config path into its component segments."""
        m = re.match(r"^folders/(?P<folder>.+?)/locations/(?P<location>.+?)/intelligenceConfig$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def managed_folder_path(project: str,bucket: str,managed_folder: str,) -> str:
        """Returns a fully-qualified managed_folder string."""
        return "projects/{project}/buckets/{bucket}/managedFolders/{managed_folder}".format(project=project, bucket=bucket, managed_folder=managed_folder, )

    @staticmethod
    def parse_managed_folder_path(path: str) -> Dict[str,str]:
        """Parses a managed_folder path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/buckets/(?P<bucket>.+?)/managedFolders/(?P<managed_folder>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def storage_layout_path(project: str,bucket: str,) -> str:
        """Returns a fully-qualified storage_layout string."""
        return "projects/{project}/buckets/{bucket}/storageLayout".format(project=project, bucket=bucket, )

    @staticmethod
    def parse_storage_layout_path(path: str) -> Dict[str,str]:
        """Parses a storage_layout path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/buckets/(?P<bucket>.+?)/storageLayout$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = StorageControlClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, StorageControlTransport, Callable[..., StorageControlTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = StorageControlClient._read_environment_variables()
        self._client_cert_source = StorageControlClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = StorageControlClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[StorageControlTransport], Callable[..., StorageControlTransport]] = (
    ...
    def create_managed_folder(self,
    ...
    def create_anywhere_cache(self,
    ...
    def update_anywhere_cache(self,
    ...
    def disable_anywhere_cache(self,
    ...
    def resume_anywhere_cache(self,
    ...
    def get_project_intelligence_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_project_intelligence_config]
    ...
    def update_project_intelligence_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_project_intelligence_config]
    ...
    def get_folder_intelligence_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_folder_intelligence_config]
    ...
    def update_folder_intelligence_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_folder_intelligence_config]
    ...
    def get_organization_intelligence_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_organization_intelligence_config]
    ...
    def update_organization_intelligence_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_organization_intelligence_config]

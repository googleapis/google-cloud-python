...
class StorageControlAsyncClient:
    ...
    async def get_storage_layout(self,
    ...
    async def create_managed_folder(self,
    ...
    async def delete_managed_folder(self,
    ...
    async def get_managed_folder(self,
    ...
    async def list_managed_folders(self,
    ...
    async def create_anywhere_cache(self,
    ...
    async def update_anywhere_cache(self,
    ...
    async def disable_anywhere_cache(self,
    ...
    async def pause_anywhere_cache(self,
    ...
    async def resume_anywhere_cache(self,
    ...
    async def get_anywhere_cache(self,
    ...
    async def list_anywhere_caches(self,
    ...
    async def get_project_intelligence_config(self,
    ...
    async def update_project_intelligence_config(self,
    ...
    async def get_folder_intelligence_config(self,
    ...
    async def update_folder_intelligence_config(self,
    ...
    async def get_organization_intelligence_config(self,
    ...
    async def update_organization_intelligence_config(self,

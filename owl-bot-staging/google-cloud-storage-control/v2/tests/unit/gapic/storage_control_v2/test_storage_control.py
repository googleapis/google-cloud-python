...
from google.cloud.storage_control_v2.services.storage_control import StorageControlAsyncClient
from google.cloud.storage_control_v2.services.storage_control import StorageControlClient
from google.cloud.storage_control_v2.services.storage_control import pagers
from google.cloud.storage_control_v2.services.storage_control import transports
...
def test__get_api_endpoint():
    ...
    assert StorageControlClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == StorageControlClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert StorageControlClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == StorageControlClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    StorageControlClient, StorageControlAsyncClient
])
...
def test_list_folders_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, storage_control.Folder)
                   for i in results)
...
def test_rename_folder(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rename_folder),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_storage_layout(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_storage_layout),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_managed_folder(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_managed_folder),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_managed_folder(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_managed_folder),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_get_managed_folder(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_managed_folder),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storage_control.ManagedFolder(
            name='name_value',
...
def test_list_managed_folders_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, storage_control.ManagedFolder)
                   for i in results)
...
async def test_list_managed_folders_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_managed_folders(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_create_anywhere_cache(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_anywhere_cache),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_anywhere_cache(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_anywhere_cache),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_disable_anywhere_cache(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.disable_anywhere_cache),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_pause_anywhere_cache(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.pause_anywhere_cache),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storage_control.AnywhereCache(
            name='name_value',
...
def test_resume_anywhere_cache(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resume_anywhere_cache),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storage_control.AnywhereCache(
            name='name_value',
...
def test_get_anywhere_cache(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_anywhere_cache),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storage_control.AnywhereCache(
            name='name_value',
...
def test_list_anywhere_caches_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, storage_control.AnywhereCache)
                   for i in results)
...
async def test_list_anywhere_caches_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_anywhere_caches(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_project_intelligence_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_project_intelligence_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_project_intelligence_config_async(transport: str = 'grpc_asyncio', request_type=storage_control.GetProjectIntelligenceConfigRequest):
    client = StorageControlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_project_intelligence_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_project_intelligence_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storage_control.IntelligenceConfig(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_project_intelligence_config_async(transport: str = 'grpc_asyncio', request_type=storage_control.UpdateProjectIntelligenceConfigRequest):
    client = StorageControlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_folder_intelligence_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_folder_intelligence_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storage_control.IntelligenceConfig(
            name='name_value',
...
def test_update_folder_intelligence_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_folder_intelligence_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storage_control.IntelligenceConfig(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_folder_intelligence_config_async(transport: str = 'grpc_asyncio', request_type=storage_control.UpdateFolderIntelligenceConfigRequest):
    client = StorageControlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_organization_intelligence_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_organization_intelligence_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storage_control.IntelligenceConfig(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_organization_intelligence_config_async(transport: str = 'grpc_asyncio', request_type=storage_control.GetOrganizationIntelligenceConfigRequest):
    client = StorageControlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_organization_intelligence_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_organization_intelligence_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storage_control.IntelligenceConfig(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_organization_intelligence_config_async(transport: str = 'grpc_asyncio', request_type=storage_control.UpdateOrganizationIntelligenceConfigRequest):
    client = StorageControlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_project_intelligence_config_rest_required_fields(request_type=storage_control.GetProjectIntelligenceConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_project_intelligence_config._get_unset_required_fields(jsonified_request)
...
def test_update_project_intelligence_config_rest_required_fields(request_type=storage_control.UpdateProjectIntelligenceConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_project_intelligence_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_project_intelligence_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("intelligenceConfig", "updateMask", )))
...
def test_get_folder_intelligence_config_rest_required_fields(request_type=storage_control.GetFolderIntelligenceConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_folder_intelligence_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_folder_intelligence_config_rest_required_fields(request_type=storage_control.UpdateFolderIntelligenceConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_folder_intelligence_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_organization_intelligence_config_rest_required_fields(request_type=storage_control.GetOrganizationIntelligenceConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_organization_intelligence_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_organization_intelligence_config_rest_required_fields(request_type=storage_control.UpdateOrganizationIntelligenceConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_organization_intelligence_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_organization_intelligence_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{intelligence_config.name=organizations/*/locations/*/intelligenceConfig}" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_no_http_options():
    client = StorageControlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_set_iam_policy_rest_no_http_options():
    client = StorageControlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_test_iam_permissions_rest_no_http_options():
    client = StorageControlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_project_intelligence_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.StorageControlRestInterceptor, "post_get_project_intelligence_config") as post, \
        mock.patch.object(transports.StorageControlRestInterceptor, "post_get_project_intelligence_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageControlRestInterceptor, "pre_get_project_intelligence_config") as pre:
        ...
        client.get_project_intelligence_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_project_intelligence_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageControlRestInterceptor, "post_update_project_intelligence_config") as post, \
        mock.patch.object(transports.StorageControlRestInterceptor, "post_update_project_intelligence_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageControlRestInterceptor, "pre_update_project_intelligence_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_project_intelligence_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_folder_intelligence_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageControlRestInterceptor, "post_get_folder_intelligence_config") as post, \
        mock.patch.object(transports.StorageControlRestInterceptor, "post_get_folder_intelligence_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageControlRestInterceptor, "pre_get_folder_intelligence_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_folder_intelligence_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_folder_intelligence_config_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'intelligence_config': {'name': 'folders/sample1/locations/sample2/intelligenceConfig'}}
    request_init["intelligence_config"] = {'name': 'folders/sample1/locations/sample2/intelligenceConfig', 'edition_config': 1, 'update_time': {'seconds': 751, 'nanos': 543}, 'filter': {'included_cloud_storage_locations': {'locations': ['locations_value1', 'locations_value2']}, 'excluded_cloud_storage_locations': {}, 'included_cloud_storage_buckets': {'bucket_id_regexes': ['bucket_id_regexes_value1', 'bucket_id_regexes_value2']}, 'excluded_cloud_storage_buckets': {}}, 'effective_intelligence_config': {'effective_edition': 1, 'intelligence_config': 'intelligence_config_value'}, 'trial_config': {'expire_time': {}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_folder_intelligence_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageControlRestInterceptor, "post_update_folder_intelligence_config") as post, \
        mock.patch.object(transports.StorageControlRestInterceptor, "post_update_folder_intelligence_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageControlRestInterceptor, "pre_update_folder_intelligence_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_folder_intelligence_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_organization_intelligence_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageControlRestInterceptor, "post_get_organization_intelligence_config") as post, \
        mock.patch.object(transports.StorageControlRestInterceptor, "post_get_organization_intelligence_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageControlRestInterceptor, "pre_get_organization_intelligence_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_organization_intelligence_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_organization_intelligence_config_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'intelligence_config': {'name': 'organizations/sample1/locations/sample2/intelligenceConfig'}}
    request_init["intelligence_config"] = {'name': 'organizations/sample1/locations/sample2/intelligenceConfig', 'edition_config': 1, 'update_time': {'seconds': 751, 'nanos': 543}, 'filter': {'included_cloud_storage_locations': {'locations': ['locations_value1', 'locations_value2']}, 'excluded_cloud_storage_locations': {}, 'included_cloud_storage_buckets': {'bucket_id_regexes': ['bucket_id_regexes_value1', 'bucket_id_regexes_value2']}, 'excluded_cloud_storage_buckets': {}}, 'effective_intelligence_config': {'effective_edition': 1, 'intelligence_config': 'intelligence_config_value'}, 'trial_config': {'expire_time': {}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_organization_intelligence_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageControlRestInterceptor, "post_update_organization_intelligence_config") as post, \
        mock.patch.object(transports.StorageControlRestInterceptor, "post_update_organization_intelligence_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageControlRestInterceptor, "pre_update_organization_intelligence_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_organization_intelligence_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_storage_control_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.storage_control_v2.services.storage_control.transports.StorageControlTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_storage_control_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.storage_control_v2.services.storage_control.transports.StorageControlTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.StorageControlTransport()
        adc.assert_called_once()
...
def test_storage_control_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.StorageControlGrpcTransport, transports.StorageControlGrpcAsyncIOTransport])
def test_storage_control_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_anywhere_cache_path():
    ...
    expected = "projects/{project}/buckets/{bucket}/anywhereCaches/{anywhere_cache}".format(project=project, bucket=bucket, anywhere_cache=anywhere_cache, )
...
def test_folder_path():
    ...
    bucket = "mussel"
    folder = "winkle"
    expected = "projects/{project}/buckets/{bucket}/folders/{folder}".format(project=project, bucket=bucket, folder=folder, )
...
def test_intelligence_config_path():
    folder = "squid"
    location = "clam"
    expected = "folders/{folder}/locations/{location}/intelligenceConfig".format(folder=folder, location=location, )
...
def test_managed_folder_path():
    ...
    expected = "projects/{project}/buckets/{bucket}/managedFolders/{managed_folder}".format(project=project, bucket=bucket, managed_folder=managed_folder, )
...
def test_storage_layout_path():
    project = "scallop"
    bucket = "abalone"
    expected = "projects/{project}/buckets/{bucket}/storageLayout".format(project=project, bucket=bucket, )

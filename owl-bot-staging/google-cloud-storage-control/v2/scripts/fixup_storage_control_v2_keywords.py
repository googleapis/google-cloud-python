...
class storage_controlCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        'create_anywhere_cache': ('parent', 'anywhere_cache', 'request_id', ),
...
def fix_files(
    ...
    *,
    transformer=storage_controlCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the storage_control client library.

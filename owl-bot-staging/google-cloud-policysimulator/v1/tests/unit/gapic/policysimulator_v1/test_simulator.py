...
def test_get_replay_rest_required_fields(request_type=simulator.GetReplayRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_replay._get_unset_required_fields(jsonified_request)
...
def test_get_replay_rest_unset_required_fields():
    transport = transports.SimulatorRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_replay_rest_required_fields(request_type=simulator.CreateReplayRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_replay._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_replay_results_rest_required_fields(request_type=simulator.ListReplayResultsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_replay_results._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

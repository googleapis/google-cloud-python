...
from .transports.base import SimulatorTransport, DEFAULT_CLIENT_INFO
...
class SimulatorAsyncClient:
    ...
    DEFAULT_ENDPOINT = SimulatorClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = SimulatorClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = SimulatorClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = SimulatorClient._DEFAULT_UNIVERSE

    replay_path = staticmethod(SimulatorClient.replay_path)
    parse_replay_path = staticmethod(SimulatorClient.parse_replay_path)
    replay_result_path = staticmethod(SimulatorClient.replay_result_path)
    parse_replay_result_path = staticmethod(SimulatorClient.parse_replay_result_path)
    common_billing_account_path = staticmethod(SimulatorClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(SimulatorClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(SimulatorClient.common_folder_path)
    parse_common_folder_path = staticmethod(SimulatorClient.parse_common_folder_path)
    common_organization_path = staticmethod(SimulatorClient.common_organization_path)
    parse_common_organization_path = staticmethod(SimulatorClient.parse_common_organization_path)
    common_project_path = staticmethod(SimulatorClient.common_project_path)
    parse_common_project_path = staticmethod(SimulatorClient.parse_common_project_path)
    common_location_path = staticmethod(SimulatorClient.common_location_path)
    parse_common_location_path = staticmethod(SimulatorClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SimulatorAsyncClient: The constructed client.
        """
        return SimulatorClient.from_service_account_info.__func__(SimulatorAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            SimulatorAsyncClient: The constructed client.
        """
        return SimulatorClient.from_service_account_file.__func__(SimulatorAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return SimulatorClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> SimulatorTransport:
        ...
        Returns:
            SimulatorTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = SimulatorClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, SimulatorTransport, Callable[..., SimulatorTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.policysimulator_v1.SimulatorAsyncClient`.",
                extra = {
    ...
    async def get_replay(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_replay():
                # Create a client
                client = policysimulator_v1.SimulatorAsyncClient()
                ...
                # Make the request
                response = await client.get_replay(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.policysimulator_v1.types.GetReplayRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_replay]
    ...
    async def create_replay(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_replay():
                # Create a client
                client = policysimulator_v1.SimulatorAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.policysimulator_v1.types.CreateReplayRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            replay (:class:`google.cloud.policysimulator_v1.types.Replay`):
                Required. The
                [Replay][google.cloud.policysimulator.v1.Replay] to
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, replay]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_replay]
    ...
    async def list_replay_results(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListReplayResultsAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_list_replay_results():
                # Create a client
                client = policysimulator_v1.SimulatorAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.policysimulator_v1.types.ListReplayResultsRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_replay_results]
        ...
        response = pagers.ListReplayResultsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def __aenter__(self) -> "SimulatorAsyncClient":
        return self

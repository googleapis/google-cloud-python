...
class SimulatorRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_replay(self, request: simulator.CreateReplayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[simulator.CreateReplayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_replay(self, request: simulator.GetReplayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[simulator.GetReplayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_replay_results(self, request: simulator.ListReplayResultsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[simulator.ListReplayResultsRequest, Sequence[Tuple[str, str]]]:

...
class SimulatorRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_replay(self, request: simulator.CreateReplayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[simulator.CreateReplayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_replay_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_replay
    ...
    def pre_get_replay(self, request: simulator.GetReplayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[simulator.GetReplayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_replay_with_metadata(self, response: simulator.Replay, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[simulator.Replay, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_replay
    ...
    def pre_list_replay_results(self, request: simulator.ListReplayResultsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[simulator.ListReplayResultsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_replay_results_with_metadata(self, response: simulator.ListReplayResultsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[simulator.ListReplayResultsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_replay_results
...
class SimulatorRestTransport(_BaseSimulatorRestTransport):
    ...
    class _CreateReplay(_BaseSimulatorRestTransport._BaseCreateReplay, SimulatorRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SimulatorRestTransport._CreateReplay._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListReplayResults(_BaseSimulatorRestTransport._BaseListReplayResults, SimulatorRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SimulatorRestTransport._ListReplayResults._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseSimulatorRestTransport._BaseGetOperation, SimulatorRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SimulatorRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseSimulatorRestTransport._BaseListOperations, SimulatorRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SimulatorRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

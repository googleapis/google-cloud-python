...
from .base import SimulatorTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class SimulatorRestTransport(SimulatorTransport):
    """REST backend transport for Simulator.
    ...
    class _CreateReplay(SimulatorRestStub):
        def __hash__(self):
            return hash("CreateReplay")
            ...
            },
{
    ...
    class _GetReplay(SimulatorRestStub):
        def __hash__(self):
            return hash("GetReplay")
            ...
            },
{
    ...
    class _ListReplayResults(SimulatorRestStub):
        def __hash__(self):
            return hash("ListReplayResults")
            ...
            },
{
    ...
    class _GetOperation(SimulatorRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _ListOperations(SimulatorRestStub):
        def __call__(self,

...
from .transports.base import OrgPolicyViolationsPreviewServiceTransport, DEFAULT_CLIENT_INFO
...
class OrgPolicyViolationsPreviewServiceAsyncClient:
    ...
    _client: OrgPolicyViolationsPreviewServiceClient
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            OrgPolicyViolationsPreviewServiceAsyncClient: The constructed client.
        """
        return OrgPolicyViolationsPreviewServiceClient.from_service_account_info.__func__(OrgPolicyViolationsPreviewServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            OrgPolicyViolationsPreviewServiceAsyncClient: The constructed client.
        """
        return OrgPolicyViolationsPreviewServiceClient.from_service_account_file.__func__(OrgPolicyViolationsPreviewServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return OrgPolicyViolationsPreviewServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    get_transport_class = OrgPolicyViolationsPreviewServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, OrgPolicyViolationsPreviewServiceTransport, Callable[..., OrgPolicyViolationsPreviewServiceTransport]]] = "grpc_asyncio",
            client_options: Optional[ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the org policy violations preview service async client.
        ...
        Args:
            ...
            transport (Optional[Union[str,OrgPolicyViolationsPreviewServiceTransport,Callable[..., OrgPolicyViolationsPreviewServiceTransport]]]):
                ...
                arguments as used in the OrgPolicyViolationsPreviewServiceTransport constructor.
        ...
        """
        self._client = OrgPolicyViolationsPreviewServiceClient(
    ...
    async def list_org_policy_violations_previews(self,
            ...
            *,
            ...
            ) -> pagers.ListOrgPolicyViolationsPreviewsAsyncPager:
        r"""ListOrgPolicyViolationsPreviews lists each
        [OrgPolicyViolationsPreview][google.cloud.policysimulator.v1.OrgPolicyViolationsPreview]
        ...
        Args:
            request (Optional[Union[google.cloud.policysimulator_v1.types.ListOrgPolicyViolationsPreviewsRequest, dict]]):
        ...
        response = pagers.ListOrgPolicyViolationsPreviewsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_org_policy_violations_preview(self,
        ...
        r"""GetOrgPolicyViolationsPreview gets the specified
        [OrgPolicyViolationsPreview][google.cloud.policysimulator.v1.OrgPolicyViolationsPreview].
        Each
        [OrgPolicyViolationsPreview][google.cloud.policysimulator.v1.OrgPolicyViolationsPreview]
        is available for at least 7 days.
        ...
        Args:
            request (Optional[Union[google.cloud.policysimulator_v1.types.GetOrgPolicyViolationsPreviewRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcp_orgpolicy.GetOrgPolicyViolationsPreviewRequest):
            request = gcp_orgpolicy.GetOrgPolicyViolationsPreviewRequest(request)
    ...
    async def create_org_policy_violations_preview(self,
        ...
        r"""CreateOrgPolicyViolationsPreview creates an
        [OrgPolicyViolationsPreview][google.cloud.policysimulator.v1.OrgPolicyViolationsPreview]
        ...
        .. code-block:: python
            ...
            async def sample_create_org_policy_violations_preview():
                # Create a client
                client = policysimulator_v1.OrgPolicyViolationsPreviewServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.policysimulator_v1.types.CreateOrgPolicyViolationsPreviewRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            org_policy_violations_preview (:class:`google.cloud.policysimulator_v1.types.OrgPolicyViolationsPreview`):
                Required. The
                [OrgPolicyViolationsPreview][google.cloud.policysimulator.v1.OrgPolicyViolationsPreview]
                to generate.

                This corresponds to the ``org_policy_violations_preview`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            org_policy_violations_preview_id (:class:`str`):
                Optional. An optional user-specified ID for the
                [OrgPolicyViolationsPreview][google.cloud.policysimulator.v1.OrgPolicyViolationsPreview].
                If not provided, a random ID will be generated.

                This corresponds to the ``org_policy_violations_preview_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.policysimulator_v1.types.OrgPolicyViolationsPreview` OrgPolicyViolationsPreview is a resource providing a preview of the
                   violations that will exist if an OrgPolicy change is
                   made.
        ...
        response = operation_async.from_gapic(
            ...
            gcp_orgpolicy.OrgPolicyViolationsPreview,
            metadata_type=gcp_orgpolicy.CreateOrgPolicyViolationsPreviewOperationMetadata,
        )

        # Done; return the response.
        return response

    async def list_org_policy_violations(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListOrgPolicyViolationsAsyncPager:
        r"""ListOrgPolicyViolations lists the [OrgPolicyViolations][] that
        are present in an
        [OrgPolicyViolationsPreview][google.cloud.policysimulator.v1.OrgPolicyViolationsPreview].
        ...
        .. code-block:: python
            ...
            async def sample_list_org_policy_violations():
                # Create a client
                client = policysimulator_v1.OrgPolicyViolationsPreviewServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.policysimulator_v1.types.ListOrgPolicyViolationsRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcp_orgpolicy.ListOrgPolicyViolationsRequest):
            request = gcp_orgpolicy.ListOrgPolicyViolationsRequest(request)
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListOrgPolicyViolationsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def __aenter__(self) -> "OrgPolicyViolationsPreviewServiceAsyncClient":
        return self

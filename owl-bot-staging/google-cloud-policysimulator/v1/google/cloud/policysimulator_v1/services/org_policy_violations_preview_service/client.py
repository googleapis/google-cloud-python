...
class OrgPolicyViolationsPreviewServiceClient(metaclass=OrgPolicyViolationsPreviewServiceClientMeta):
    ...
    @staticmethod
    def org_policy_violation_path(organization: str,location: str,org_policy_violations_preview: str,org_policy_violation: str,) -> str:
        """Returns a fully-qualified org_policy_violation string."""
        return "organizations/{organization}/locations/{location}/orgPolicyViolationsPreviews/{org_policy_violations_preview}/orgPolicyViolations/{org_policy_violation}".format(organization=organization, location=location, org_policy_violations_preview=org_policy_violations_preview, org_policy_violation=org_policy_violation, )

    @staticmethod
    def parse_org_policy_violation_path(path: str) -> Dict[str,str]:
        """Parses a org_policy_violation path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/orgPolicyViolationsPreviews/(?P<org_policy_violations_preview>.+?)/orgPolicyViolations/(?P<org_policy_violation>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def org_policy_violations_preview_path(organization: str,location: str,org_policy_violations_preview: str,) -> str:
        """Returns a fully-qualified org_policy_violations_preview string."""
        return "organizations/{organization}/locations/{location}/orgPolicyViolationsPreviews/{org_policy_violations_preview}".format(organization=organization, location=location, org_policy_violations_preview=org_policy_violations_preview, )
    ...
    def parse_org_policy_violations_preview_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/orgPolicyViolationsPreviews/(?P<org_policy_violations_preview>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = OrgPolicyViolationsPreviewServiceClient._read_environment_variables()
        self._client_cert_source = OrgPolicyViolationsPreviewServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
    ...
    def list_org_policy_violations_previews(self,
    ...
    def get_org_policy_violations_preview(self,
    ...
    def create_org_policy_violations_preview(self,
    ...
    def list_org_policy_violations(self,

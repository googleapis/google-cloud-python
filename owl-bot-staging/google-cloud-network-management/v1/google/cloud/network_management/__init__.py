...
from google.cloud.network_management_v1.types.trace import DirectVpcEgressConnectionInfo
...
from google.cloud.network_management_v1.types.trace import ServerlessExternalConnectionInfo

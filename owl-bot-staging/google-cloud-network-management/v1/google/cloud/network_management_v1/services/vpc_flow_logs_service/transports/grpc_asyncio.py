...
from .base import VpcFlowLogsServiceTransport, DEFAULT_CLIENT_INFO
from .grpc import VpcFlowLogsServiceGrpcTransport
...
class VpcFlowLogsServiceGrpcAsyncIOTransport(VpcFlowLogsServiceTransport):
    """gRPC AsyncIO backend transport for VpcFlowLogsService.
    ...
    def list_vpc_flow_logs_configs(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListVpcFlowLogsConfigsRequest],
                    Awaitable[~.ListVpcFlowLogsConfigsResponse]]:
    ...
    def get_vpc_flow_logs_config(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetVpcFlowLogsConfigRequest],
                    Awaitable[~.VpcFlowLogsConfig]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'get_vpc_flow_logs_config' not in self._stubs:
            self._stubs['get_vpc_flow_logs_config'] = self._logged_channel.unary_unary(
                '/google.cloud.networkmanagement.v1.VpcFlowLogsService/GetVpcFlowLogsConfig',
                request_serializer=vpc_flow_logs.GetVpcFlowLogsConfigRequest.serialize,
                response_deserializer=vpc_flow_logs_config.VpcFlowLogsConfig.deserialize,
            )
    ...
    def delete_vpc_flow_logs_config(self) -> Callable[
        ...
        Returns:
            Callable[[~.DeleteVpcFlowLogsConfigRequest],
                    Awaitable[~.Operation]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_vpc_flow_logs_configs: self._wrap_method(
                self.list_vpc_flow_logs_configs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_vpc_flow_logs_config: self._wrap_method(
                self.get_vpc_flow_logs_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_vpc_flow_logs_config: self._wrap_method(
                self.create_vpc_flow_logs_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_vpc_flow_logs_config: self._wrap_method(
...
__all__ = (
    'VpcFlowLogsServiceGrpcAsyncIOTransport',
)

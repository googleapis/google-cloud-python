...
class VpcFlowLogsServiceClient(metaclass=VpcFlowLogsServiceClientMeta):
    ...
    @staticmethod
    def vpc_flow_logs_config_path(project: str,location: str,vpc_flow_logs_config: str,) -> str:
        """Returns a fully-qualified vpc_flow_logs_config string."""
        return "projects/{project}/locations/{location}/vpcFlowLogsConfigs/{vpc_flow_logs_config}".format(project=project, location=location, vpc_flow_logs_config=vpc_flow_logs_config, )
    ...
    def list_vpc_flow_logs_configs(self,
    ...
    def get_vpc_flow_logs_config(self,
    ...
    def create_vpc_flow_logs_config(self,
    ...
    def update_vpc_flow_logs_config(self,
    ...
    def delete_vpc_flow_logs_config(self,

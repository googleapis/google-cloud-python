...
from .transports.base import VpcFlowLogsServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc_asyncio import VpcFlowLogsServiceGrpcAsyncIOTransport
...
class VpcFlowLogsServiceAsyncClient:
    ...
    _client: VpcFlowLogsServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = VpcFlowLogsServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = VpcFlowLogsServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    def transport(self) -> VpcFlowLogsServiceTransport:
        ...
        Returns:
            VpcFlowLogsServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = VpcFlowLogsServiceClient.get_transport_class
    ...
    def __init__(self, *,
        ...
        Args:
            ...
            transport (Optional[Union[str,VpcFlowLogsServiceTransport,Callable[..., VpcFlowLogsServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the VpcFlowLogsServiceTransport constructor.
        ...
        """
        self._client = VpcFlowLogsServiceClient(
    ...
    async def list_vpc_flow_logs_configs(self,
            ...
            *,
            ...
            ) -> pagers.ListVpcFlowLogsConfigsAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_list_vpc_flow_logs_configs():
                # Create a client
                client = network_management_v1.VpcFlowLogsServiceAsyncClient()

                # Initialize request argument(s)
                request = network_management_v1.ListVpcFlowLogsConfigsRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_vpc_flow_logs_configs(request=request)
        ...
        if not isinstance(request, vpc_flow_logs.ListVpcFlowLogsConfigsRequest):
            request = vpc_flow_logs.ListVpcFlowLogsConfigsRequest(request)
        ...
        response = pagers.ListVpcFlowLogsConfigsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_vpc_flow_logs_config(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_vpc_flow_logs_config():
                # Create a client
                client = network_management_v1.VpcFlowLogsServiceAsyncClient()

                # Initialize request argument(s)
                request = network_management_v1.GetVpcFlowLogsConfigRequest(
                    name="name_value",
                )

                # Make the request
                response = await client.get_vpc_flow_logs_config(request=request)
        ...
        Returns:
            google.cloud.network_management_v1.types.VpcFlowLogsConfig:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, vpc_flow_logs.GetVpcFlowLogsConfigRequest):
            request = vpc_flow_logs.GetVpcFlowLogsConfigRequest(request)
    ...
    async def create_vpc_flow_logs_config(self,
        ...
        r"""Creates a new ``VpcFlowLogsConfig``. If a configuration with the
        ...
        .. code-block:: python
            ...
            async def sample_create_vpc_flow_logs_config():
                # Create a client
                client = network_management_v1.VpcFlowLogsServiceAsyncClient()
        ...
        Args:
            ...
            vpc_flow_logs_config (:class:`google.cloud.network_management_v1.types.VpcFlowLogsConfig`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            vpc_flow_logs_config_id (:class:`str`):
                Required. ID of the ``VpcFlowLogsConfig``.
                This corresponds to the ``vpc_flow_logs_config_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.network_management_v1.types.VpcFlowLogsConfig`
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, vpc_flow_logs_config, vpc_flow_logs_config_id])
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, vpc_flow_logs.CreateVpcFlowLogsConfigRequest):
            request = vpc_flow_logs.CreateVpcFlowLogsConfigRequest(request)

        # If we have keyword arguments corresponding to fields on the
        # request, apply these.
        if parent is not None:
            request.parent = parent
        if vpc_flow_logs_config is not None:
            request.vpc_flow_logs_config = vpc_flow_logs_config
        if vpc_flow_logs_config_id is not None:
            request.vpc_flow_logs_config_id = vpc_flow_logs_config_id
    ...
    async def update_vpc_flow_logs_config(self,
        ...
        r"""Updates an existing ``VpcFlowLogsConfig``. If a configuration
        ...
        .. code-block:: python
            ...
            async def sample_update_vpc_flow_logs_config():
                # Create a client
                client = network_management_v1.VpcFlowLogsServiceAsyncClient()
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([vpc_flow_logs_config, update_mask])
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, vpc_flow_logs.UpdateVpcFlowLogsConfigRequest):
            request = vpc_flow_logs.UpdateVpcFlowLogsConfigRequest(request)
    ...
    async def delete_vpc_flow_logs_config(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_vpc_flow_logs_config():
                # Create a client
                client = network_management_v1.VpcFlowLogsServiceAsyncClient()

                # Initialize request argument(s)
                request = network_management_v1.DeleteVpcFlowLogsConfigRequest(
                    name="name_value",
                )
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, vpc_flow_logs.DeleteVpcFlowLogsConfigRequest):
            request = vpc_flow_logs.DeleteVpcFlowLogsConfigRequest(request)
    ...
    async def __aenter__(self) -> "VpcFlowLogsServiceAsyncClient":
        return self

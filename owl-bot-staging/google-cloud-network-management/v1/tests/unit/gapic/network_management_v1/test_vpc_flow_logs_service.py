...
from google.cloud.network_management_v1.services.vpc_flow_logs_service import VpcFlowLogsServiceAsyncClient
from google.cloud.network_management_v1.services.vpc_flow_logs_service import VpcFlowLogsServiceClient
from google.cloud.network_management_v1.services.vpc_flow_logs_service import pagers
from google.cloud.network_management_v1.services.vpc_flow_logs_service import transports
...
def test__get_api_endpoint():
    ...
    assert VpcFlowLogsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == VpcFlowLogsServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert VpcFlowLogsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == VpcFlowLogsServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    VpcFlowLogsServiceClient, VpcFlowLogsServiceAsyncClient
])
...
def test_vpc_flow_logs_service_client_client_options_from_dict():
    with mock.patch('google.cloud.network_management_v1.services.vpc_flow_logs_service.transports.VpcFlowLogsServiceGrpcTransport.__init__') as grpc_transport:
...
def test_list_vpc_flow_logs_configs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, vpc_flow_logs_config.VpcFlowLogsConfig)
                   for i in results)
...
async def test_list_vpc_flow_logs_configs_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_vpc_flow_logs_configs(request={},)
...
def test_get_vpc_flow_logs_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_vpc_flow_logs_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_vpc_flow_logs_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_vpc_flow_logs_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_vpc_flow_logs_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_vpc_flow_logs_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_vpc_flow_logs_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_vpc_flow_logs_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_vpc_flow_logs_configs_rest_required_fields(request_type=vpc_flow_logs.ListVpcFlowLogsConfigsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_vpc_flow_logs_configs._get_unset_required_fields(jsonified_request)
...
def test_get_vpc_flow_logs_config_rest_required_fields(request_type=vpc_flow_logs.GetVpcFlowLogsConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_vpc_flow_logs_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_vpc_flow_logs_config_rest_required_fields(request_type=vpc_flow_logs.CreateVpcFlowLogsConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_vpc_flow_logs_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_vpc_flow_logs_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("vpcFlowLogsConfigId", )) & set(("parent", "vpcFlowLogsConfigId", "vpcFlowLogsConfig", )))
...
def test_update_vpc_flow_logs_config_rest_required_fields(request_type=vpc_flow_logs.UpdateVpcFlowLogsConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_vpc_flow_logs_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_vpc_flow_logs_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("updateMask", "vpcFlowLogsConfig", )))
...
def test_update_vpc_flow_logs_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{vpc_flow_logs_config.name=projects/*/locations/*/vpcFlowLogsConfigs/*}" % client.transport._host, args[1])
...
def test_delete_vpc_flow_logs_config_rest_required_fields(request_type=vpc_flow_logs.DeleteVpcFlowLogsConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_vpc_flow_logs_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_vpc_flow_logs_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "post_list_vpc_flow_logs_configs") as post, \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "post_list_vpc_flow_logs_configs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "pre_list_vpc_flow_logs_configs") as pre:
        ...
        client.list_vpc_flow_logs_configs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_vpc_flow_logs_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "post_get_vpc_flow_logs_config") as post, \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "post_get_vpc_flow_logs_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "pre_get_vpc_flow_logs_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_vpc_flow_logs_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_vpc_flow_logs_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "post_create_vpc_flow_logs_config") as post, \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "post_create_vpc_flow_logs_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "pre_create_vpc_flow_logs_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_vpc_flow_logs_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_vpc_flow_logs_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "post_update_vpc_flow_logs_config") as post, \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "post_update_vpc_flow_logs_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "pre_update_vpc_flow_logs_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_vpc_flow_logs_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_vpc_flow_logs_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "post_delete_vpc_flow_logs_config") as post, \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "post_delete_vpc_flow_logs_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VpcFlowLogsServiceRestInterceptor, "pre_delete_vpc_flow_logs_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_vpc_flow_logs_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_vpc_flow_logs_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.network_management_v1.services.vpc_flow_logs_service.transports.VpcFlowLogsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_vpc_flow_logs_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.network_management_v1.services.vpc_flow_logs_service.transports.VpcFlowLogsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.VpcFlowLogsServiceTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.VpcFlowLogsServiceGrpcTransport, transports.VpcFlowLogsServiceGrpcAsyncIOTransport])
def test_vpc_flow_logs_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_vpc_flow_logs_config_path():
    ...
    expected = "projects/{project}/locations/{location}/vpcFlowLogsConfigs/{vpc_flow_logs_config}".format(project=project, location=location, vpc_flow_logs_config=vpc_flow_logs_config, )

...
class GkeHubMembershipServiceAsyncClient:
    ...
    **Membership management may be non-trivial:** it is recommended to
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = GkeHubMembershipServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GkeHubMembershipServiceTransport, Callable[..., GkeHubMembershipServiceTransport]]] = "grpc_asyncio",
    ...
    async def validate_exclusivity(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.validate_exclusivity]
    ...
    async def generate_exclusivity_manifest(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.generate_exclusivity_manifest]

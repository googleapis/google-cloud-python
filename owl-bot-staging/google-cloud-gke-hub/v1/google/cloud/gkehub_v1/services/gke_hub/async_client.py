...
class GkeHubAsyncClient:
    ...
    **Membership management may be non-trivial:** it is recommended to
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GkeHubTransport, Callable[..., GkeHubTransport]]] = "grpc_asyncio",
    ...
    async def list_memberships(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_memberships]
    ...
    async def get_membership(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_membership]
    ...
    async def create_membership(self,
        ...
        **This is currently only supported for GKE clusters on Google
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_membership]
    ...
    async def delete_membership(self,
        ...
        **This is currently only supported for GKE clusters on Google
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_membership]
    ...
    async def update_membership(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_membership]
    ...
    async def generate_connect_manifest(self,
        ...
        **This method is used internally by Google-provided libraries.**
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.generate_connect_manifest]

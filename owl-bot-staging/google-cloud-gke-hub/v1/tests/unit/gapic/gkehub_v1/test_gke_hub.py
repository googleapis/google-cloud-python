...
def test__get_client_cert_source():
    ...
    assert GkeHubClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert GkeHubClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert GkeHubClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert GkeHubClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(GkeHubClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GkeHubClient))
@mock.patch.object(GkeHubAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GkeHubAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = GkeHubClient._DEFAULT_UNIVERSE
    default_endpoint = GkeHubClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = GkeHubClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert GkeHubClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert GkeHubClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == GkeHubClient.DEFAULT_MTLS_ENDPOINT
    assert GkeHubClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert GkeHubClient._get_api_endpoint(None, None, default_universe, "always") == GkeHubClient.DEFAULT_MTLS_ENDPOINT
    assert GkeHubClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == GkeHubClient.DEFAULT_MTLS_ENDPOINT
    assert GkeHubClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert GkeHubClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        GkeHubClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert GkeHubClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert GkeHubClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert GkeHubClient._get_universe_domain(None, None) == GkeHubClient._DEFAULT_UNIVERSE
...
def test_list_memberships_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeHubRestInterceptor, "post_list_memberships_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListMembershipsResponse.to_json(service.ListMembershipsResponse())
...
def test_list_features_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeHubRestInterceptor, "post_list_features_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListFeaturesResponse.to_json(service.ListFeaturesResponse())
        req.return_value.content = return_value
...
def test_get_membership_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeHubRestInterceptor, "post_get_membership_with_metadata") as post_with_metadata, \
...
def test_get_feature_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeHubRestInterceptor, "post_get_feature_with_metadata") as post_with_metadata, \
...
def test_create_membership_rest_bad_request(request_type=service.CreateMembershipRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_membership_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeHubRestInterceptor, "post_create_membership_with_metadata") as post_with_metadata, \
...
def test_create_feature_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeHubRestInterceptor, "post_create_feature_with_metadata") as post_with_metadata, \
...
def test_delete_membership_rest_bad_request(request_type=service.DeleteMembershipRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_membership_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeHubRestInterceptor, "post_delete_membership_with_metadata") as post_with_metadata, \
...
def test_delete_feature_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeHubRestInterceptor, "post_delete_feature_with_metadata") as post_with_metadata, \
...
def test_update_membership_rest_bad_request(request_type=service.UpdateMembershipRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_membership_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeHubRestInterceptor, "post_update_membership_with_metadata") as post_with_metadata, \
...
def test_update_feature_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeHubRestInterceptor, "post_update_feature_with_metadata") as post_with_metadata, \
...
def test_generate_connect_manifest_rest_bad_request(request_type=service.GenerateConnectManifestRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_connect_manifest_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GkeHubRestInterceptor, "post_generate_connect_manifest_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.GenerateConnectManifestResponse.to_json(service.GenerateConnectManifestResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.GenerateConnectManifestResponse(), metadata

...
def test_list_memberships_rest_required_fields(request_type=service.ListMembershipsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_memberships._get_unset_required_fields(jsonified_request)
...
def test_get_membership_rest_required_fields(request_type=service.GetMembershipRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_membership._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_membership_rest_required_fields(request_type=service.CreateMembershipRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_membership._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_membership_rest_required_fields(request_type=service.DeleteMembershipRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_membership._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_membership_rest_required_fields(request_type=service.UpdateMembershipRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_membership._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_connect_manifest_rest_required_fields(request_type=service.GenerateConnectManifestRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_connect_manifest._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

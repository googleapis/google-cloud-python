...
class SpeechTranslationServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = SpeechTranslationServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = SpeechTranslationServiceClient._DEFAULT_UNIVERSE
    ...
    get_transport_class = functools.partial(type(SpeechTranslationServiceClient).get_transport_class, type(SpeechTranslationServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, SpeechTranslationServiceTransport, Callable[..., SpeechTranslationServiceTransport]]] = "grpc_asyncio",
            client_options: Optional[ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the speech translation service async client.
    ...
    def streaming_translate_speech(self,
            requests: Optional[AsyncIterator[media_translation.StreamingTranslateSpeechRequest]] = None,
            *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.streaming_translate_speech]

...
class SpeechTranslationServiceClient(metaclass=SpeechTranslationServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "mediatranslation.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SpeechTranslationServiceClient: The constructed client.
        """
    ...
    def transport(self) -> SpeechTranslationServiceTransport:
        ...
        Returns:
            SpeechTranslationServiceTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SpeechTranslationServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SpeechTranslationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SpeechTranslationServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SpeechTranslationServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SpeechTranslationServiceTransport, Callable[..., SpeechTranslationServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SpeechTranslationServiceClient._read_environment_variables()
        self._client_cert_source = SpeechTranslationServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SpeechTranslationServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SpeechTranslationServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(SpeechTranslationServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SpeechTranslationServiceTransport], Callable[..., SpeechTranslationServiceTransport]] = (
    ...
    def streaming_translate_speech(self,
            requests: Optional[Iterator[media_translation.StreamingTranslateSpeechRequest]] = None,
            *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.streaming_translate_speech]

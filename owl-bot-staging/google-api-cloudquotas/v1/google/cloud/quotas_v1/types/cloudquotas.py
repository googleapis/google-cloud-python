...
from google.cloud.quotas_v1.types import resources
...
class ListQuotaInfosResponse(proto.Message):
    ...
    Attributes:
        quota_infos (MutableSequence[google.cloud.quotas_v1.types.QuotaInfo]):
...
class ListQuotaPreferencesResponse(proto.Message):
    ...
    Attributes:
        quota_preferences (MutableSequence[google.cloud.quotas_v1.types.QuotaPreference]):
...
class CreateQuotaPreferenceRequest(proto.Message):
    ...
    Attributes:
        ...
        ignore_safety_checks (MutableSequence[google.cloud.quotas_v1.types.QuotaSafetyCheck]):

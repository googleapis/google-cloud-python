...
from google.cloud.quotas_v1.services.cloud_quotas import CloudQuotasAsyncClient
from google.cloud.quotas_v1.services.cloud_quotas import CloudQuotasClient
from google.cloud.quotas_v1.services.cloud_quotas import pagers
from google.cloud.quotas_v1.services.cloud_quotas import transports
...
def test_cloud_quotas_client_client_options_from_dict():
    with mock.patch('google.cloud.quotas_v1.services.cloud_quotas.transports.CloudQuotasGrpcTransport.__init__') as grpc_transport:
...
def test_list_quota_infos_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = cloudquotas.ListQuotaInfosResponse.to_json(cloudquotas.ListQuotaInfosResponse())
...
def test_list_quota_infos_rest_bad_request(transport: str = 'rest', request_type=cloudquotas.ListQuotaInfosRequest):
    client = CloudQuotasClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_quota_info_rest_bad_request(transport: str = 'rest', request_type=cloudquotas.GetQuotaInfoRequest):
    client = CloudQuotasClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_quota_preferences_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloudquotas.ListQuotaPreferencesResponse.to_json(cloudquotas.ListQuotaPreferencesResponse())
...
def test_list_quota_preferences_rest_bad_request(transport: str = 'rest', request_type=cloudquotas.ListQuotaPreferencesRequest):
    client = CloudQuotasClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_quota_preference_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = resources.QuotaPreference.to_json(resources.QuotaPreference())
...
def test_get_quota_preference_rest_bad_request(transport: str = 'rest', request_type=cloudquotas.GetQuotaPreferenceRequest):
    client = CloudQuotasClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_quota_preference_rest_bad_request(transport: str = 'rest', request_type=cloudquotas.CreateQuotaPreferenceRequest):
    client = CloudQuotasClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_quota_preference_rest_bad_request(transport: str = 'rest', request_type=cloudquotas.UpdateQuotaPreferenceRequest):
    client = CloudQuotasClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cloud_quotas_base_transport():
    ...
    with mock.patch('google.cloud.quotas_v1.services.cloud_quotas.transports.CloudQuotasTransport.__init__') as Transport:
...
def test_cloud_quotas_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.quotas_v1.services.cloud_quotas.transports.CloudQuotasTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cloud_quotas_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.quotas_v1.services.cloud_quotas.transports.CloudQuotasTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CloudQuotasTransport()
        adc.assert_called_once()

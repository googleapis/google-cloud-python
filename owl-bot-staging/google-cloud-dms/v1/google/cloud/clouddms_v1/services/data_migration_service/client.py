...
class DataMigrationServiceClient(metaclass=DataMigrationServiceClientMeta):
    ...
    @staticmethod
    def conversion_workspace_path(project: str,location: str,conversion_workspace: str,) -> str:
        """Returns a fully-qualified conversion_workspace string."""
        return "projects/{project}/locations/{location}/conversionWorkspaces/{conversion_workspace}".format(project=project, location=location, conversion_workspace=conversion_workspace, )
    ...
    @staticmethod
    def mapping_rule_path(project: str,location: str,conversion_workspace: str,mapping_rule: str,) -> str:
        """Returns a fully-qualified mapping_rule string."""
        return "projects/{project}/locations/{location}/conversionWorkspaces/{conversion_workspace}/mappingRules/{mapping_rule}".format(project=project, location=location, conversion_workspace=conversion_workspace, mapping_rule=mapping_rule, )

    @staticmethod
    def parse_mapping_rule_path(path: str) -> Dict[str,str]:
        """Parses a mapping_rule path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/conversionWorkspaces/(?P<conversion_workspace>.+?)/mappingRules/(?P<mapping_rule>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            DataMigrationServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def generate_tcp_proxy_script(self,
    ...
    def get_conversion_workspace(self,
    ...
    def list_conversion_workspaces(self,
    ...
    def create_conversion_workspace(self,
    ...
    def update_conversion_workspace(self,
    ...
    def delete_conversion_workspace(self,
    ...
    def seed_conversion_workspace(self,
    ...
    def convert_conversion_workspace(self,
    ...
    def commit_conversion_workspace(self,
    ...
    def rollback_conversion_workspace(self,
    ...
    def apply_conversion_workspace(self,
    ...
    def describe_database_entities(self,
    ...
    def search_background_jobs(self,
    ...
    def describe_conversion_workspace_revisions(self,

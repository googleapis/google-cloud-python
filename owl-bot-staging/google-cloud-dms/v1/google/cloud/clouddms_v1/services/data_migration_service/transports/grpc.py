...
class DataMigrationServiceGrpcTransport(DataMigrationServiceTransport):
    ...
    def rollback_conversion_workspace(self) -> Callable[
        ...
        if 'rollback_conversion_workspace' not in self._stubs:
            self._stubs['rollback_conversion_workspace'] = self.grpc_channel.unary_unary(
    ...
    def describe_conversion_workspace_revisions(self) -> Callable[
        ...
        if 'describe_conversion_workspace_revisions' not in self._stubs:
            self._stubs['describe_conversion_workspace_revisions'] = self.grpc_channel.unary_unary(

...
class DataMigrationServiceGrpcTransport(DataMigrationServiceTransport):
    ...
    @property
    def generate_tcp_proxy_script(self) -> Callable[
    ...
    @property
    def get_conversion_workspace(self) -> Callable[
    ...
    @property
    def list_conversion_workspaces(self) -> Callable[
    ...
    @property
    def create_conversion_workspace(self) -> Callable[
    ...
    @property
    def update_conversion_workspace(self) -> Callable[
    ...
    @property
    def delete_conversion_workspace(self) -> Callable[
    ...
    @property
    def create_mapping_rule(self) -> Callable[
    ...
    @property
    def delete_mapping_rule(self) -> Callable[
    ...
    @property
    def list_mapping_rules(self) -> Callable[
    ...
    @property
    def get_mapping_rule(self) -> Callable[
    ...
    @property
    def seed_conversion_workspace(self) -> Callable[
    ...
    @property
    def import_mapping_rules(self) -> Callable[
    ...
    @property
    def convert_conversion_workspace(self) -> Callable[
    ...
    @property
    def commit_conversion_workspace(self) -> Callable[
    ...
    @property
    def rollback_conversion_workspace(self) -> Callable[
    ...
    @property
    def apply_conversion_workspace(self) -> Callable[
    ...
    @property
    def describe_database_entities(self) -> Callable[
    ...
    @property
    def search_background_jobs(self) -> Callable[
    ...
    @property
    def describe_conversion_workspace_revisions(self) -> Callable[

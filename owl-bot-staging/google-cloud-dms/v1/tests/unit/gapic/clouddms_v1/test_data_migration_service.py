...
def test__get_api_endpoint():
    ...
    assert DataMigrationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DataMigrationServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert DataMigrationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DataMigrationServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_generate_tcp_proxy_script(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_tcp_proxy_script),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_mapping_rule(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_mapping_rule),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_mapping_rule(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_mapping_rule),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_mapping_rules_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, conversionworkspace_resources.MappingRule)
                   for i in results)
...
def test_get_mapping_rule(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_mapping_rule),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = conversionworkspace_resources.MappingRule(
            name='name_value',
...
def test_transport_kind_grpc_asyncio():
    transport = DataMigrationServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )

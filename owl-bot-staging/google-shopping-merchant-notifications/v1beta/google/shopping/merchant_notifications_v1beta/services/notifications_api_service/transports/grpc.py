...
class NotificationsApiServiceGrpcTransport(NotificationsApiServiceTransport):
    ...
    def get_notification_subscription(self) -> Callable[
        ...
        if 'get_notification_subscription' not in self._stubs:
            self._stubs['get_notification_subscription'] = self.grpc_channel.unary_unary(
    ...
    def create_notification_subscription(self) -> Callable[
        ...
        if 'create_notification_subscription' not in self._stubs:
            self._stubs['create_notification_subscription'] = self.grpc_channel.unary_unary(
    ...
    def update_notification_subscription(self) -> Callable[
        ...
        if 'update_notification_subscription' not in self._stubs:
            self._stubs['update_notification_subscription'] = self.grpc_channel.unary_unary(
    ...
    def delete_notification_subscription(self) -> Callable[
        ...
        if 'delete_notification_subscription' not in self._stubs:
            self._stubs['delete_notification_subscription'] = self.grpc_channel.unary_unary(
    ...
    def list_notification_subscriptions(self) -> Callable[
        ...
        if 'list_notification_subscriptions' not in self._stubs:
            self._stubs['list_notification_subscriptions'] = self.grpc_channel.unary_unary(

...
class NotificationsApiServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(NotificationsApiServiceClient).get_transport_class, type(NotificationsApiServiceClient))
    ...
    async def get_notification_subscription(self,
    ...
    async def create_notification_subscription(self,
    ...
    async def update_notification_subscription(self,
    ...
    async def delete_notification_subscription(self,
    ...
    async def list_notification_subscriptions(self,

...
def test_get_notification_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "post_get_notification_subscription_with_metadata") as post_with_metadata, \
...
def test_create_notification_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "post_create_notification_subscription_with_metadata") as post_with_metadata, \
...
def test_update_notification_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "post_update_notification_subscription_with_metadata") as post_with_metadata, \
...
def test_list_notification_subscriptions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "post_list_notification_subscriptions_with_metadata") as post_with_metadata, \

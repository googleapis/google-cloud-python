...
from google.shopping.merchant_notifications_v1beta.services.notifications_api_service import NotificationsApiServiceAsyncClient
from google.shopping.merchant_notifications_v1beta.services.notifications_api_service import NotificationsApiServiceClient
from google.shopping.merchant_notifications_v1beta.services.notifications_api_service import pagers
from google.shopping.merchant_notifications_v1beta.services.notifications_api_service import transports
...
@mock.patch.object(NotificationsApiServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NotificationsApiServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert NotificationsApiServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == NotificationsApiServiceClient.DEFAULT_MTLS_ENDPOINT
    assert NotificationsApiServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert NotificationsApiServiceClient._get_api_endpoint(None, None, default_universe, "always") == NotificationsApiServiceClient.DEFAULT_MTLS_ENDPOINT
    assert NotificationsApiServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == NotificationsApiServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    NotificationsApiServiceClient, NotificationsApiServiceAsyncClient
])
...
def test_notifications_api_service_client_client_options_from_dict():
    with mock.patch('google.shopping.merchant_notifications_v1beta.services.notifications_api_service.transports.NotificationsApiServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_notification_subscription(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.get_notification_subscription),
            '__call__') as call:
...
async def test_get_notification_subscription_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.get_notification_subscription] = mock_object
...
def test_create_notification_subscription(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_notification_subscription),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = notificationsapi.NotificationSubscription(
            name='name_value',
...
async def test_create_notification_subscription_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_notification_subscription] = mock_object
...
@pytest.mark.asyncio
async def test_create_notification_subscription_async(transport: str = 'grpc_asyncio', request_type=notificationsapi.CreateNotificationSubscriptionRequest):
    client = NotificationsApiServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_notification_subscription(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_notification_subscription),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = notificationsapi.NotificationSubscription(
            name='name_value',
...
async def test_update_notification_subscription_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_notification_subscription] = mock_object
...
@pytest.mark.asyncio
async def test_update_notification_subscription_async(transport: str = 'grpc_asyncio', request_type=notificationsapi.UpdateNotificationSubscriptionRequest):
    client = NotificationsApiServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_notification_subscription(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_notification_subscription),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_delete_notification_subscription_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_notification_subscription] = mock_object
...
@pytest.mark.asyncio
async def test_delete_notification_subscription_async(transport: str = 'grpc_asyncio', request_type=notificationsapi.DeleteNotificationSubscriptionRequest):
    client = NotificationsApiServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_list_notification_subscriptions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_notification_subscriptions] = mock_object
...
@pytest.mark.asyncio
async def test_list_notification_subscriptions_async(transport: str = 'grpc_asyncio', request_type=notificationsapi.ListNotificationSubscriptionsRequest):
    client = NotificationsApiServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_notification_subscriptions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, notificationsapi.NotificationSubscription)
                   for i in results)
...
async def test_list_notification_subscriptions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_notification_subscriptions(request={},)
...
def test_get_notification_subscription_rest_required_fields(request_type=notificationsapi.GetNotificationSubscriptionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_notification_subscription._get_unset_required_fields(jsonified_request)
...
def test_get_notification_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "post_get_notification_subscription") as post, \
         mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "pre_get_notification_subscription") as pre:
        ...
        req.return_value._content = notificationsapi.NotificationSubscription.to_json(notificationsapi.NotificationSubscription())
        ...
        client.get_notification_subscription(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_notification_subscription_rest_bad_request(transport: str = 'rest', request_type=notificationsapi.GetNotificationSubscriptionRequest):
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_notification_subscription_rest(request_type):
    ...
    request_init["notification_subscription"] = {'all_managed_accounts': True, 'target_account': 'target_account_value', 'name': 'name_value', 'registered_event': 1, 'call_back_uri': 'call_back_uri_value'}
...
def test_create_notification_subscription_rest_required_fields(request_type=notificationsapi.CreateNotificationSubscriptionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_notification_subscription._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_notification_subscription_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "notificationSubscription", )))
...
def test_create_notification_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "post_create_notification_subscription") as post, \
         mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "pre_create_notification_subscription") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_notification_subscription(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_notification_subscription_rest_bad_request(transport: str = 'rest', request_type=notificationsapi.CreateNotificationSubscriptionRequest):
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_notification_subscription_rest(request_type):
    ...
    request_init["notification_subscription"] = {'all_managed_accounts': True, 'target_account': 'target_account_value', 'name': 'accounts/sample1/notificationsubscriptions/sample2', 'registered_event': 1, 'call_back_uri': 'call_back_uri_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_notification_subscription_rest_required_fields(request_type=notificationsapi.UpdateNotificationSubscriptionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_notification_subscription._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_notification_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "post_update_notification_subscription") as post, \
         mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "pre_update_notification_subscription") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_notification_subscription(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_notification_subscription_rest_bad_request(transport: str = 'rest', request_type=notificationsapi.UpdateNotificationSubscriptionRequest):
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_notification_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/notifications/v1beta/{notification_subscription.name=accounts/*/notificationsubscriptions/*}" % client.transport._host, args[1])
...
def test_delete_notification_subscription_rest_required_fields(request_type=notificationsapi.DeleteNotificationSubscriptionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_notification_subscription._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_notification_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "pre_delete_notification_subscription") as pre:
        pre.assert_not_called()
        ...
        client.delete_notification_subscription(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_notification_subscription_rest_bad_request(transport: str = 'rest', request_type=notificationsapi.DeleteNotificationSubscriptionRequest):
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_notification_subscriptions_rest_required_fields(request_type=notificationsapi.ListNotificationSubscriptionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_notification_subscriptions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_notification_subscriptions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "post_list_notification_subscriptions") as post, \
         mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "pre_list_notification_subscriptions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = notificationsapi.ListNotificationSubscriptionsResponse.to_json(notificationsapi.ListNotificationSubscriptionsResponse())
        ...
        client.list_notification_subscriptions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_notification_subscriptions_rest_bad_request(transport: str = 'rest', request_type=notificationsapi.ListNotificationSubscriptionsRequest):
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_notifications_api_service_base_transport():
    ...
    with mock.patch('google.shopping.merchant_notifications_v1beta.services.notifications_api_service.transports.NotificationsApiServiceTransport.__init__') as Transport:
...
def test_notifications_api_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.shopping.merchant_notifications_v1beta.services.notifications_api_service.transports.NotificationsApiServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_notifications_api_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.shopping.merchant_notifications_v1beta.services.notifications_api_service.transports.NotificationsApiServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NotificationsApiServiceTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.NotificationsApiServiceGrpcTransport, transports.NotificationsApiServiceGrpcAsyncIOTransport])
def test_notifications_api_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_notification_subscription_path():
    ...
    expected = "accounts/{account}/notificationsubscriptions/{notification_subscription}".format(account=account, notification_subscription=notification_subscription, )

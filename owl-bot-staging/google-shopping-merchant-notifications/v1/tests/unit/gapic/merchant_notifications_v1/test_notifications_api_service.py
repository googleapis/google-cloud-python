...
from google.shopping.merchant_notifications_v1.services.notifications_api_service import NotificationsApiServiceAsyncClient
from google.shopping.merchant_notifications_v1.services.notifications_api_service import NotificationsApiServiceClient
from google.shopping.merchant_notifications_v1.services.notifications_api_service import pagers
from google.shopping.merchant_notifications_v1.services.notifications_api_service import transports
...
def test_notifications_api_service_client_client_options_from_dict():
    with mock.patch('google.shopping.merchant_notifications_v1.services.notifications_api_service.transports.NotificationsApiServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_notification_subscription_health_metrics(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_notification_subscription_health_metrics),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_notification_subscription_health_metrics_async(transport: str = 'grpc_asyncio', request_type=notificationsapi.GetNotificationSubscriptionHealthMetricsRequest):
    client = NotificationsApiServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_notification_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/notifications/v1/{notification_subscription.name=accounts/*/notificationsubscriptions/*}" % client.transport._host, args[1])
...
def test_get_notification_subscription_health_metrics_rest_required_fields(request_type=notificationsapi.GetNotificationSubscriptionHealthMetricsRequest):
    transport_class = transports.NotificationsApiServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_notification_subscription_health_metrics._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_notification_subscription_health_metrics_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "post_get_notification_subscription_health_metrics") as post, \
        mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "post_get_notification_subscription_health_metrics_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotificationsApiServiceRestInterceptor, "pre_get_notification_subscription_health_metrics") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notificationsapi.GetNotificationSubscriptionHealthMetricsRequest.pb(notificationsapi.GetNotificationSubscriptionHealthMetricsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_notification_subscription_health_metrics(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_notifications_api_service_base_transport():
    ...
    with mock.patch('google.shopping.merchant_notifications_v1.services.notifications_api_service.transports.NotificationsApiServiceTransport.__init__') as Transport:
...
def test_notifications_api_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.shopping.merchant_notifications_v1.services.notifications_api_service.transports.NotificationsApiServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_notifications_api_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.shopping.merchant_notifications_v1.services.notifications_api_service.transports.NotificationsApiServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NotificationsApiServiceTransport()
        adc.assert_called_once()

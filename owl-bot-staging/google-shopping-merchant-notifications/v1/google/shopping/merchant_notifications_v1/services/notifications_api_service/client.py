...
from .transports.base import NotificationsApiServiceTransport, DEFAULT_CLIENT_INFO
...
class NotificationsApiServiceClient(metaclass=NotificationsApiServiceClientMeta):
    ...
    @staticmethod
    def notification_subscription_path(account: str,notification_subscription: str,) -> str:
        """Returns a fully-qualified notification_subscription string."""
        return "accounts/{account}/notificationsubscriptions/{notification_subscription}".format(account=account, notification_subscription=notification_subscription, )
    ...
    @staticmethod
    def notification_subscription_health_metrics_path(account: str,notification_subscription: str,) -> str:
    ...
    def __init__(self, *,
        ...
        self._client_cert_source = NotificationsApiServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
    ...
    def update_notification_subscription(self,
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("notification_subscription.name", request.notification_subscription.name),
            )),
        )
    ...
    def list_notification_subscriptions(self,
    ...
    def get_notification_subscription_health_metrics(self,

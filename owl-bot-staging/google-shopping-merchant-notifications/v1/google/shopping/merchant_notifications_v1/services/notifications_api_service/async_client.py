...
class NotificationsApiServiceAsyncClient:
    ...
    parse_notification_subscription_health_metrics_path = staticmethod(NotificationsApiServiceClient.parse_notification_subscription_health_metrics_path)
    ...
    async def get_notification_subscription_health_metrics(self,

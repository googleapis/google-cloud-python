...
from google.cloud.securitycenter_v1beta1.services.security_center import SecurityCenterAsyncClient
from google.cloud.securitycenter_v1beta1.services.security_center import SecurityCenterClient
...
def test_security_center_client_client_options_from_dict():
    with mock.patch('google.cloud.securitycenter_v1beta1.services.security_center.transports.SecurityCenterGrpcTransport.__init__') as grpc_transport:
...
def test_create_source_rest(request_type):
    ...
    request_init["source"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value'}
...
def test_create_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=organizations/*}/sources" % client.transport._host, args[1])
...
def test_create_finding_rest(request_type):
    ...
    request_init["finding"] = {'name': 'name_value', 'parent': 'parent_value', 'resource_name': 'resource_name_value', 'state': 1, 'category': 'category_value', 'external_uri': 'external_uri_value', 'source_properties': {}, 'security_marks': {'name': 'name_value', 'marks': {}}, 'event_time': {'seconds': 751, 'nanos': 543}, 'create_time': {}}
    request = request_type(**request_init)
...
def test_create_finding_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=organizations/*/sources/*}/findings" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{resource=organizations/*/sources/*}:getIamPolicy" % client.transport._host, args[1])
...
def test_get_organization_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=organizations/*/organizationSettings}" % client.transport._host, args[1])
...
def test_get_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=organizations/*/sources/*}" % client.transport._host, args[1])
...
def test_group_findings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=organizations/*/sources/*}/findings:group" % client.transport._host, args[1])
...
def test_list_findings_rest_required_fields(request_type=securitycenter_service.ListFindingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_findings._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("field_mask", "filter", "order_by", "page_size", "page_token", "read_time", ))
    jsonified_request.update(unset_fields)
...
def test_list_findings_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("fieldMask", "filter", "orderBy", "pageSize", "pageToken", "readTime", )) & set(("parent", )))
...
def test_run_asset_discovery_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=organizations/*}/assets:runDiscovery" % client.transport._host, args[1])
...
def test_set_finding_state_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=organizations/*/sources/*/findings/*}:setState" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{resource=organizations/*/sources/*}:setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{resource=organizations/*/sources/*}:testIamPermissions" % client.transport._host, args[1])
...
def test_update_finding_rest(request_type):
    ...
    request_init["finding"] = {'name': 'organizations/sample1/sources/sample2/findings/sample3', 'parent': 'parent_value', 'resource_name': 'resource_name_value', 'state': 1, 'category': 'category_value', 'external_uri': 'external_uri_value', 'source_properties': {}, 'security_marks': {'name': 'name_value', 'marks': {}}, 'event_time': {'seconds': 751, 'nanos': 543}, 'create_time': {}}
    request = request_type(**request_init)
...
def test_update_finding_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{finding.name=organizations/*/sources/*/findings/*}" % client.transport._host, args[1])
...
def test_update_organization_settings_rest(request_type):
    ...
    request_init["organization_settings"] = {'name': 'organizations/sample1/organizationSettings', 'enable_asset_discovery': True, 'asset_discovery_config': {'project_ids': ['project_ids_value1', 'project_ids_value2'], 'inclusion_mode': 1}}
    request = request_type(**request_init)
...
def test_update_organization_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{organization_settings.name=organizations/*/organizationSettings}" % client.transport._host, args[1])
...
def test_update_source_rest(request_type):
    ...
    request_init["source"] = {'name': 'organizations/sample1/sources/sample2', 'display_name': 'display_name_value', 'description': 'description_value'}
    request = request_type(**request_init)
...
def test_update_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{source.name=organizations/*/sources/*}" % client.transport._host, args[1])
...
def test_update_security_marks_rest(request_type):
    ...
    request_init["security_marks"] = {'name': 'organizations/sample1/assets/sample2/securityMarks', 'marks': {}}
    request = request_type(**request_init)
...
def test_update_security_marks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{security_marks.name=organizations/*/assets/*/securityMarks}" % client.transport._host, args[1])
...
def test_security_center_base_transport():
    ...
    with mock.patch('google.cloud.securitycenter_v1beta1.services.security_center.transports.SecurityCenterTransport.__init__') as Transport:
...
def test_security_center_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.securitycenter_v1beta1.services.security_center.transports.SecurityCenterTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_security_center_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.securitycenter_v1beta1.services.security_center.transports.SecurityCenterTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SecurityCenterTransport()
        adc.assert_called_once()

...
from google.cloud.securitycenter_v1.types import attack_path
from google.cloud.securitycenter_v1.types import bigquery_export
from google.cloud.securitycenter_v1.types import effective_event_threat_detection_custom_module
from google.cloud.securitycenter_v1.types import effective_security_health_analytics_custom_module
...
class ListDescendantSecurityHealthAnalyticsCustomModulesResponse(proto.Message):
    ...
    security_health_analytics_custom_modules: MutableSequence[gcs_security_health_analytics_custom_module.SecurityHealthAnalyticsCustomModule] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gcs_security_health_analytics_custom_module.SecurityHealthAnalyticsCustomModule,
    )
...
class ListEffectiveSecurityHealthAnalyticsCustomModulesResponse(proto.Message):
    ...
    effective_security_health_analytics_custom_modules: MutableSequence[effective_security_health_analytics_custom_module.EffectiveSecurityHealthAnalyticsCustomModule] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class ListDescendantEventThreatDetectionCustomModulesResponse(proto.Message):
    ...
    event_threat_detection_custom_modules: MutableSequence[gcs_event_threat_detection_custom_module.EventThreatDetectionCustomModule] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gcs_event_threat_detection_custom_module.EventThreatDetectionCustomModule,
    )
...
class ListEffectiveEventThreatDetectionCustomModulesResponse(proto.Message):
    ...
    effective_event_threat_detection_custom_modules: MutableSequence[effective_event_threat_detection_custom_module.EffectiveEventThreatDetectionCustomModule] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,

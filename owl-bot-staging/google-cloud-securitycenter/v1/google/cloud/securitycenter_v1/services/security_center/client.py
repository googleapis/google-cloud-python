...
class SecurityCenterClient(metaclass=SecurityCenterClientMeta):
    ...
    @staticmethod
    def attack_path_path(organization: str,simulation: str,valued_resource: str,attack_path: str,) -> str:
        """Returns a fully-qualified attack_path string."""
        return "organizations/{organization}/simulations/{simulation}/valuedResources/{valued_resource}/attackPaths/{attack_path}".format(organization=organization, simulation=simulation, valued_resource=valued_resource, attack_path=attack_path, )

    @staticmethod
    def parse_attack_path_path(path: str) -> Dict[str,str]:
        """Parses a attack_path path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/simulations/(?P<simulation>.+?)/valuedResources/(?P<valued_resource>.+?)/attackPaths/(?P<attack_path>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def big_query_export_path(organization: str,export: str,) -> str:
        """Returns a fully-qualified big_query_export string."""
        return "organizations/{organization}/bigQueryExports/{export}".format(organization=organization, export=export, )

    @staticmethod
    def parse_big_query_export_path(path: str) -> Dict[str,str]:
        """Parses a big_query_export path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/bigQueryExports/(?P<export>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def effective_event_threat_detection_custom_module_path(organization: str,module: str,) -> str:
        """Returns a fully-qualified effective_event_threat_detection_custom_module string."""
        return "organizations/{organization}/eventThreatDetectionSettings/effectiveCustomModules/{module}".format(organization=organization, module=module, )
    ...
    def parse_effective_event_threat_detection_custom_module_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/eventThreatDetectionSettings/effectiveCustomModules/(?P<module>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def effective_security_health_analytics_custom_module_path(organization: str,effective_custom_module: str,) -> str:
        """Returns a fully-qualified effective_security_health_analytics_custom_module string."""
        return "organizations/{organization}/securityHealthAnalyticsSettings/effectiveCustomModules/{effective_custom_module}".format(organization=organization, effective_custom_module=effective_custom_module, )
    ...
    def parse_effective_security_health_analytics_custom_module_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/securityHealthAnalyticsSettings/effectiveCustomModules/(?P<effective_custom_module>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def event_threat_detection_custom_module_path(organization: str,module: str,) -> str:
        """Returns a fully-qualified event_threat_detection_custom_module string."""
        return "organizations/{organization}/eventThreatDetectionSettings/customModules/{module}".format(organization=organization, module=module, )
    ...
    def parse_event_threat_detection_custom_module_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/eventThreatDetectionSettings/customModules/(?P<module>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def external_system_path(organization: str,source: str,finding: str,externalsystem: str,) -> str:
        """Returns a fully-qualified external_system string."""
        return "organizations/{organization}/sources/{source}/findings/{finding}/externalSystems/{externalsystem}".format(organization=organization, source=source, finding=finding, externalsystem=externalsystem, )

    @staticmethod
    def parse_external_system_path(path: str) -> Dict[str,str]:
        """Parses a external_system path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/sources/(?P<source>.+?)/findings/(?P<finding>.+?)/externalSystems/(?P<externalsystem>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def mute_config_path(organization: str,mute_config: str,) -> str:
        ...
        return "organizations/{organization}/muteConfigs/{mute_config}".format(organization=organization, mute_config=mute_config, )

    @staticmethod
    def parse_mute_config_path(path: str) -> Dict[str,str]:
        """Parses a mute_config path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/muteConfigs/(?P<mute_config>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def policy_path(organization: str,constraint_name: str,) -> str:
        """Returns a fully-qualified policy string."""
        return "organizations/{organization}/policies/{constraint_name}".format(organization=organization, constraint_name=constraint_name, )

    @staticmethod
    def parse_policy_path(path: str) -> Dict[str,str]:
        """Parses a policy path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/policies/(?P<constraint_name>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def resource_value_config_path(organization: str,resource_value_config: str,) -> str:
        """Returns a fully-qualified resource_value_config string."""
        return "organizations/{organization}/resourceValueConfigs/{resource_value_config}".format(organization=organization, resource_value_config=resource_value_config, )
    ...
    def parse_resource_value_config_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/resourceValueConfigs/(?P<resource_value_config>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def security_health_analytics_custom_module_path(organization: str,custom_module: str,) -> str:
        """Returns a fully-qualified security_health_analytics_custom_module string."""
        return "organizations/{organization}/securityHealthAnalyticsSettings/customModules/{custom_module}".format(organization=organization, custom_module=custom_module, )
    ...
    def parse_security_health_analytics_custom_module_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/securityHealthAnalyticsSettings/customModules/(?P<custom_module>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def simulation_path(organization: str,simulation: str,) -> str:
        """Returns a fully-qualified simulation string."""
        return "organizations/{organization}/simulations/{simulation}".format(organization=organization, simulation=simulation, )

    @staticmethod
    def parse_simulation_path(path: str) -> Dict[str,str]:
        """Parses a simulation path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/simulations/(?P<simulation>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def table_data_profile_path(project: str,table_profile: str,) -> str:
        """Returns a fully-qualified table_data_profile string."""
        return "projects/{project}/tableProfiles/{table_profile}".format(project=project, table_profile=table_profile, )

    @staticmethod
    def parse_table_data_profile_path(path: str) -> Dict[str,str]:
        """Parses a table_data_profile path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/tableProfiles/(?P<table_profile>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def valued_resource_path(organization: str,simulation: str,valued_resource: str,) -> str:
        """Returns a fully-qualified valued_resource string."""
        return "organizations/{organization}/simulations/{simulation}/valuedResources/{valued_resource}".format(organization=organization, simulation=simulation, valued_resource=valued_resource, )

    @staticmethod
    def parse_valued_resource_path(path: str) -> Dict[str,str]:
        """Parses a valued_resource path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/simulations/(?P<simulation>.+?)/valuedResources/(?P<valued_resource>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.securitycenter_v1.SecurityCenterClient`.",
                    extra = {
    ...
    def group_assets(self,
        ...
        """
        warnings.warn("SecurityCenterClient.group_assets is deprecated",
            DeprecationWarning)
    ...
    def list_assets(self,
        ...
        """
        warnings.warn("SecurityCenterClient.list_assets is deprecated",
            DeprecationWarning)
    ...
    def run_asset_discovery(self,
        ...
        """
        warnings.warn("SecurityCenterClient.run_asset_discovery is deprecated",
            DeprecationWarning)
    ...
    def update_external_system(self,
    ...
    def create_big_query_export(self,
    ...
    def delete_big_query_export(self,
    ...
    def update_big_query_export(self,
    ...
    def batch_create_resource_value_configs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_create_resource_value_configs]
    ...
    def delete_resource_value_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_resource_value_config]
    ...
    def get_resource_value_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_resource_value_config]
    ...
    def list_resource_value_configs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_resource_value_configs]
    ...
    def update_resource_value_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_resource_value_config]
    ...
    def list_valued_resources(self,

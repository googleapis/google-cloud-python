...
class SecurityCenterGrpcAsyncIOTransport(SecurityCenterTransport):
    ...
    @property
    def batch_create_resource_value_configs(self) -> Callable[
        ...
        if 'batch_create_resource_value_configs' not in self._stubs:
            self._stubs['batch_create_resource_value_configs'] = self.grpc_channel.unary_unary(
    ...
    @property
    def create_big_query_export(self) -> Callable[
    ...
    @property
    def delete_big_query_export(self) -> Callable[
    ...
    @property
    def delete_resource_value_config(self) -> Callable[
    ...
    @property
    def get_big_query_export(self) -> Callable[
    ...
    @property
    def get_simulation(self) -> Callable[
            [securitycenter_service.GetSimulationRequest],
            Awaitable[simulation.Simulation]]:
    ...
    @property
    def get_valued_resource(self) -> Callable[
    ...
    @property
    def get_resource_value_config(self) -> Callable[
    ...
    @property
    def list_attack_paths(self) -> Callable[
    ...
    @property
    def list_big_query_exports(self) -> Callable[
    ...
    @property
    def list_resource_value_configs(self) -> Callable[
    ...
    @property
    def list_valued_resources(self) -> Callable[
    ...
    @property
    def update_big_query_export(self) -> Callable[
    ...
    @property
    def update_external_system(self) -> Callable[
    ...
    @property
    def update_resource_value_config(self) -> Callable[

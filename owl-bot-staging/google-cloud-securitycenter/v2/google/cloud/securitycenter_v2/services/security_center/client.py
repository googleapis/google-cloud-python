...
class SecurityCenterClient(metaclass=SecurityCenterClientMeta):
    ...
    @staticmethod
    def big_query_export_path(organization: str,location: str,export: str,) -> str:
        """Returns a fully-qualified big_query_export string."""
        return "organizations/{organization}/locations/{location}/bigQueryExports/{export}".format(organization=organization, location=location, export=export, )
    ...
    @staticmethod
    def notification_config_path(organization: str,location: str,notification_config: str,) -> str:
        """Returns a fully-qualified notification_config string."""
        return "organizations/{organization}/locations/{location}/notificationConfigs/{notification_config}".format(organization=organization, location=location, notification_config=notification_config, )

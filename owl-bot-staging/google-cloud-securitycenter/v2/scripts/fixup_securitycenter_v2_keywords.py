...
class securitycenterCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'group_findings': ('parent', 'group_by', 'filter', 'page_token', 'page_size', ),
        'list_attack_paths': ('parent', 'filter', 'page_token', 'page_size', ),
        'list_big_query_exports': ('parent', 'page_size', 'page_token', ),
        'list_findings': ('parent', 'filter', 'order_by', 'field_mask', 'page_token', 'page_size', ),
        ...
        'update_security_marks': ('security_marks', 'update_mask', ),

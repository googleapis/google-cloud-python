...
from google.cloud.securitycenter_v1p1beta1.services.security_center import SecurityCenterAsyncClient
from google.cloud.securitycenter_v1p1beta1.services.security_center import SecurityCenterClient
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SecurityCenterClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SecurityCenterClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SecurityCenterClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SecurityCenterClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert SecurityCenterClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SecurityCenterClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert SecurityCenterClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SecurityCenterClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(SecurityCenterClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecurityCenterClient))
@mock.patch.object(SecurityCenterAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecurityCenterAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SecurityCenterClient._DEFAULT_UNIVERSE
    default_endpoint = SecurityCenterClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SecurityCenterClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SecurityCenterClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SecurityCenterClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SecurityCenterClient.DEFAULT_MTLS_ENDPOINT
    assert SecurityCenterClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SecurityCenterClient._get_api_endpoint(None, None, default_universe, "always") == SecurityCenterClient.DEFAULT_MTLS_ENDPOINT
    assert SecurityCenterClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SecurityCenterClient.DEFAULT_MTLS_ENDPOINT
    assert SecurityCenterClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SecurityCenterClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SecurityCenterClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SecurityCenterClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SecurityCenterClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SecurityCenterClient._get_universe_domain(None, None) == SecurityCenterClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (SecurityCenterAsyncClient, transports.SecurityCenterGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class", [
    SecurityCenterClient, SecurityCenterAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (SecurityCenterClient, transports.SecurityCenterGrpcTransport, "grpc", grpc_helpers),
    (SecurityCenterAsyncClient, transports.SecurityCenterGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
@pytest.mark.asyncio
async def test_create_source_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_source in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_source] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_finding_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_finding in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_finding] = mock_rpc
...
def test_create_notification_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_notification_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_notification_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_notification_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_notification_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_notification_config] = mock_rpc
...
def test_delete_notification_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_notification_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_notification_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_notification_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_notification_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_notification_config] = mock_rpc
...
def test_get_notification_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_notification_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_notification_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_notification_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_notification_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_notification_config] = mock_rpc
...
def test_get_organization_settings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_organization_settings in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_organization_settings] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_organization_settings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_organization_settings in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_organization_settings] = mock_rpc
...
async def test_get_source_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_source in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_source] = mock_rpc
...
@pytest.mark.asyncio
async def test_group_assets_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.group_assets in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.group_assets] = mock_rpc
...
def test_group_assets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, securitycenter_service.GroupResult)
                   for i in results)
...
@pytest.mark.asyncio
async def test_group_findings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.group_findings in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.group_findings] = mock_rpc
...
def test_list_assets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, securitycenter_service.ListAssetsResponse.ListAssetsResult)
                   for i in results)
...
def test_list_findings_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, securitycenter_service.ListFindingsResponse.ListFindingsResult)
                   for i in results)
...
def test_list_notification_configs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_notification_configs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_notification_configs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_notification_configs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_notification_configs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_notification_configs] = mock_rpc
...
def test_list_notification_configs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_notification_configs(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, notification_config.NotificationConfig)
                   for i in results)
...
@pytest.mark.asyncio
async def test_list_sources_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_sources in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_sources] = mock_rpc
...
def test_list_sources_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, source.Source)
                   for i in results)
...
def test_run_asset_discovery_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.run_asset_discovery in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.run_asset_discovery] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_run_asset_discovery_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.run_asset_discovery in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.run_asset_discovery] = mock_rpc
...
def test_set_finding_state_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_finding_state] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_set_finding_state_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.set_finding_state in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.set_finding_state] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_finding_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_finding in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_finding] = mock_rpc
...
def test_update_notification_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_notification_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_notification_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_notification_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_notification_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_notification_config] = mock_rpc
...
def test_update_organization_settings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_organization_settings in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_organization_settings] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_organization_settings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_organization_settings in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_organization_settings] = mock_rpc
...
def test_update_organization_settings_flattened():
    ...
    with mock.patch.object(
        ...
        client.update_organization_settings(
            organization_settings=gcs_organization_settings.OrganizationSettings(name='name_value'),
        )
...
@pytest.mark.asyncio
async def test_update_source_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_source in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_source] = mock_rpc
...
def test_update_security_marks_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_security_marks in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_security_marks] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_security_marks_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityCenterAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_security_marks in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_security_marks] = mock_rpc
...
def test_create_source_rest_bad_request(request_type=securitycenter_service.CreateSourceRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_source_rest_interceptors(null_interceptor):
    transport = transports.SecurityCenterRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SecurityCenterRestInterceptor(),
        )
    client = SecurityCenterClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_create_source") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_create_source_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_create_source") as pre:
...
def test_create_finding_rest_bad_request(request_type=securitycenter_service.CreateFindingRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_finding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_create_finding") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_create_finding_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_create_finding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_notification_config_rest_bad_request(request_type=securitycenter_service.CreateNotificationConfigRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_notification_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_create_notification_config") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_create_notification_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_create_notification_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcs_notification_config.NotificationConfig.to_json(gcs_notification_config.NotificationConfig())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcs_notification_config.NotificationConfig(), metadata
...
def test_delete_notification_config_rest_bad_request(request_type=securitycenter_service.DeleteNotificationConfigRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_notification_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_delete_notification_config") as pre:
        pre.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_notification_config_rest_bad_request(request_type=securitycenter_service.GetNotificationConfigRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_notification_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_get_notification_config") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_get_notification_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_get_notification_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = notification_config.NotificationConfig.to_json(notification_config.NotificationConfig())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = notification_config.NotificationConfig(), metadata
...
def test_get_organization_settings_rest_bad_request(request_type=securitycenter_service.GetOrganizationSettingsRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_organization_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_get_organization_settings") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_get_organization_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_get_organization_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = organization_settings.OrganizationSettings.to_json(organization_settings.OrganizationSettings())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = organization_settings.OrganizationSettings(), metadata
...
def test_get_source_rest_bad_request(request_type=securitycenter_service.GetSourceRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_source_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_get_source") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_get_source_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_get_source") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_group_assets_rest_bad_request(request_type=securitycenter_service.GroupAssetsRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_group_assets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_group_assets") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_group_assets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_group_assets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = securitycenter_service.GroupAssetsResponse.to_json(securitycenter_service.GroupAssetsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = securitycenter_service.GroupAssetsResponse(), metadata
...
def test_group_findings_rest_bad_request(request_type=securitycenter_service.GroupFindingsRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_group_findings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_group_findings") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_group_findings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_group_findings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = securitycenter_service.GroupFindingsResponse.to_json(securitycenter_service.GroupFindingsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = securitycenter_service.GroupFindingsResponse(), metadata
...
def test_list_assets_rest_bad_request(request_type=securitycenter_service.ListAssetsRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_assets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_list_assets") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_list_assets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_list_assets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = securitycenter_service.ListAssetsResponse.to_json(securitycenter_service.ListAssetsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = securitycenter_service.ListAssetsResponse(), metadata
...
def test_list_findings_rest_bad_request(request_type=securitycenter_service.ListFindingsRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_findings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_list_findings") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_list_findings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_list_findings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = securitycenter_service.ListFindingsResponse.to_json(securitycenter_service.ListFindingsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = securitycenter_service.ListFindingsResponse(), metadata
...
def test_list_notification_configs_rest_bad_request(request_type=securitycenter_service.ListNotificationConfigsRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_notification_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_list_notification_configs") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_list_notification_configs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_list_notification_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = securitycenter_service.ListNotificationConfigsResponse.to_json(securitycenter_service.ListNotificationConfigsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = securitycenter_service.ListNotificationConfigsResponse(), metadata
...
def test_list_sources_rest_bad_request(request_type=securitycenter_service.ListSourcesRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_sources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_list_sources") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_list_sources_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_list_sources") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = securitycenter_service.ListSourcesResponse.to_json(securitycenter_service.ListSourcesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = securitycenter_service.ListSourcesResponse(), metadata
...
def test_run_asset_discovery_rest_bad_request(request_type=securitycenter_service.RunAssetDiscoveryRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_run_asset_discovery_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_run_asset_discovery") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_run_asset_discovery_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_run_asset_discovery") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_finding_state_rest_bad_request(request_type=securitycenter_service.SetFindingStateRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_finding_state_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_set_finding_state") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_set_finding_state_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_set_finding_state") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_finding_rest_bad_request(request_type=securitycenter_service.UpdateFindingRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_finding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_finding") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_finding_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_update_finding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_notification_config_rest_bad_request(request_type=securitycenter_service.UpdateNotificationConfigRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_notification_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_notification_config") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_notification_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_update_notification_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_organization_settings_rest_bad_request(request_type=securitycenter_service.UpdateOrganizationSettingsRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_organization_settings_rest_call_success(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["organization_settings"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_update_organization_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_organization_settings") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_organization_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_update_organization_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcs_organization_settings.OrganizationSettings.to_json(gcs_organization_settings.OrganizationSettings())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcs_organization_settings.OrganizationSettings(), metadata
...
def test_update_source_rest_bad_request(request_type=securitycenter_service.UpdateSourceRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_source_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_source") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_source_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_update_source") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_security_marks_rest_bad_request(request_type=securitycenter_service.UpdateSecurityMarksRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_security_marks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_security_marks") as post, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_security_marks_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_update_security_marks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcs_security_marks.SecurityMarks.to_json(gcs_security_marks.SecurityMarks())
        req.return_value.content = return_value
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.SecurityCenterGrpcTransport, transports.SecurityCenterGrpcAsyncIOTransport])
def test_security_center_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

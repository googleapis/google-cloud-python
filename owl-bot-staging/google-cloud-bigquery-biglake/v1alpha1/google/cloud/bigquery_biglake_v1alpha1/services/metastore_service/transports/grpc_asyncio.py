...
class MetastoreServiceGrpcAsyncIOTransport(MetastoreServiceTransport):
    ...
    @property
    def create_catalog(self) -> Callable[
            [metastore.CreateCatalogRequest],
            Awaitable[metastore.Catalog]]:
    ...
    @property
    def delete_catalog(self) -> Callable[
    ...
    def list_catalogs(self) -> Callable[
            ...
            Awaitable[metastore.ListCatalogsResponse]]:
    ...
    @property
    def delete_database(self) -> Callable[
    ...
    def list_databases(self) -> Callable[
            ...
            Awaitable[metastore.ListDatabasesResponse]]:
    ...
    @property
    def update_table(self) -> Callable[
    ...
    @property
    def rename_table(self) -> Callable[
    ...
    def list_tables(self) -> Callable[
            ...
            Awaitable[metastore.ListTablesResponse]]:
    ...
    @property
    def create_lock(self) -> Callable[
            [metastore.CreateLockRequest],
            Awaitable[metastore.Lock]]:
    ...
    @property
    def list_locks(self) -> Callable[
            [metastore.ListLocksRequest],
            Awaitable[metastore.ListLocksResponse]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_catalog: gapic_v1.method_async.wrap_method(
                self.create_catalog,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_catalog: gapic_v1.method_async.wrap_method(
                self.delete_catalog,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_catalog: gapic_v1.method_async.wrap_method(
                self.get_catalog,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_catalogs: gapic_v1.method_async.wrap_method(
                self.list_catalogs,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.rename_table: gapic_v1.method_async.wrap_method(
                self.rename_table,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.create_lock: gapic_v1.method_async.wrap_method(
                self.create_lock,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_lock: gapic_v1.method_async.wrap_method(
                self.delete_lock,
                default_timeout=None,
                client_info=client_info,
            ),
            self.check_lock: gapic_v1.method_async.wrap_method(
                self.check_lock,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_locks: gapic_v1.method_async.wrap_method(
                self.list_locks,
                default_timeout=None,
                client_info=client_info,
            ),

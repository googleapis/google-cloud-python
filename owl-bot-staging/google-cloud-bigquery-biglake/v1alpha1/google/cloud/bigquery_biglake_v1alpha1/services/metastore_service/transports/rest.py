...
class MetastoreServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_check_lock(self, request: metastore.CheckLockRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[metastore.CheckLockRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_lock(self, request: metastore.CreateLockRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[metastore.CreateLockRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_lock(self, request: metastore.DeleteLockRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[metastore.DeleteLockRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_locks(self, request: metastore.ListLocksRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[metastore.ListLocksRequest, Sequence[Tuple[str, str]]]:

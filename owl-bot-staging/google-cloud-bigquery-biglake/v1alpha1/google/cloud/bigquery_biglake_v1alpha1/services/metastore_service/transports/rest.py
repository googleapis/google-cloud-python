...
class MetastoreServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_check_lock(self, request: metastore.CheckLockRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore.CheckLockRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_check_lock_with_metadata(self, response: metastore.Lock, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore.Lock, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for check_lock
    ...
    def pre_create_lock(self, request: metastore.CreateLockRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore.CreateLockRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_lock_with_metadata(self, response: metastore.Lock, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore.Lock, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_lock
    ...
    def pre_delete_lock(self, request: metastore.DeleteLockRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore.DeleteLockRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_locks(self, request: metastore.ListLocksRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore.ListLocksRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_locks_with_metadata(self, response: metastore.ListLocksResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore.ListLocksResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_locks
...
class MetastoreServiceRestTransport(_BaseMetastoreServiceRestTransport):
    ...
    class _CheckLock(_BaseMetastoreServiceRestTransport._BaseCheckLock, MetastoreServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MetastoreServiceRestTransport._CheckLock._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CreateLock(_BaseMetastoreServiceRestTransport._BaseCreateLock, MetastoreServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MetastoreServiceRestTransport._CreateLock._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteLock(_BaseMetastoreServiceRestTransport._BaseDeleteLock, MetastoreServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MetastoreServiceRestTransport._DeleteLock._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocks(_BaseMetastoreServiceRestTransport._BaseListLocks, MetastoreServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MetastoreServiceRestTransport._ListLocks._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

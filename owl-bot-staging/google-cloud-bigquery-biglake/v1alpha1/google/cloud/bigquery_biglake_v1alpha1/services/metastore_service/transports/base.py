...
class MetastoreServiceTransport(abc.ABC):
    """Abstract transport class for MetastoreService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_catalog: gapic_v1.method.wrap_method(
                self.create_catalog,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_catalog: gapic_v1.method.wrap_method(
                self.delete_catalog,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_catalog: gapic_v1.method.wrap_method(
                self.get_catalog,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.create_lock: gapic_v1.method.wrap_method(
                self.create_lock,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_lock: gapic_v1.method.wrap_method(
                self.delete_lock,
                default_timeout=None,
                client_info=client_info,
            ),
            self.check_lock: gapic_v1.method.wrap_method(
                self.check_lock,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_locks: gapic_v1.method.wrap_method(
                self.list_locks,
                default_timeout=None,
                client_info=client_info,
            ),

...
from google.cloud.bigquery.biglake_v1alpha1.services.metastore_service import MetastoreServiceAsyncClient
from google.cloud.bigquery.biglake_v1alpha1.services.metastore_service import MetastoreServiceClient
from google.cloud.bigquery.biglake_v1alpha1.services.metastore_service import pagers
from google.cloud.bigquery.biglake_v1alpha1.services.metastore_service import transports
...
def test_metastore_service_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery.biglake_v1alpha1.services.metastore_service.transports.MetastoreServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_lock(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_lock),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_lock(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_lock),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_check_lock(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.check_lock),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = metastore.Lock(
            name='name_value',
...
def test_list_locks(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_locks),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_locks_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, metastore.Lock)
                   for i in results)
...
def test_update_table_rest(request_type):
    ...
    request_init["table"] = {'hive_options': {'parameters': {}, 'table_type': 'table_type_value', 'storage_descriptor': {'location_uri': 'location_uri_value', 'input_format': 'input_format_value', 'output_format': 'output_format_value', 'serde_info': {'serialization_lib': 'serialization_lib_value'}}}, 'name': 'projects/sample1/locations/sample2/catalogs/sample3/databases/sample4/tables/sample5', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'expire_time': {}, 'type_': 1}
    request = request_type(**request_init)
...
def test_create_lock_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_create_lock") as post, \
         mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_create_lock") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_lock_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_delete_lock") as pre:
        pre.assert_not_called()
...
def test_check_lock_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_check_lock") as post, \
         mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_check_lock") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_locks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_list_locks") as post, \
         mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_list_locks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_metastore_service_base_transport():
    ...
    with mock.patch('google.cloud.bigquery.biglake_v1alpha1.services.metastore_service.transports.MetastoreServiceTransport.__init__') as Transport:
...
def test_metastore_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery.biglake_v1alpha1.services.metastore_service.transports.MetastoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_metastore_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery.biglake_v1alpha1.services.metastore_service.transports.MetastoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MetastoreServiceTransport()
        adc.assert_called_once()

...
from google.cloud.bigquery_biglake_v1.services.metastore_service import MetastoreServiceAsyncClient
...
from google.cloud.bigquery_biglake_v1.services.metastore_service import transports
...
def test__get_api_endpoint():
    ...
    assert MetastoreServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == MetastoreServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert MetastoreServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == MetastoreServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    MetastoreServiceClient, MetastoreServiceAsyncClient
])
...
def test_metastore_service_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery_biglake_v1.services.metastore_service.transports.MetastoreServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_catalog(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_catalog),
            '__call__') as call:
...
def test_delete_catalog(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_catalog),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = metastore.Catalog(
            name='name_value',
...
def test_get_catalog(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_catalog),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = metastore.Catalog(
            name='name_value',
...
def test_list_catalogs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, metastore.Catalog)
                   for i in results)
...
def test_delete_database(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_database),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = metastore.Database(
            name='name_value',
...
def test_list_databases_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, metastore.Database)
                   for i in results)
...
def test_rename_table(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rename_table),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = metastore.Table(
            name='name_value',
...
def test_list_tables_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, metastore.Table)
                   for i in results)
...
def test_create_catalog_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_create_catalog") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_create_catalog_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_create_catalog") as pre:
...
def test_delete_catalog_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_delete_catalog") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_delete_catalog_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_delete_catalog") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_catalog_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_get_catalog") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_get_catalog_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_get_catalog") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_catalogs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_list_catalogs") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_list_catalogs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_list_catalogs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_create_database") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_create_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_create_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_delete_database") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_delete_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_delete_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_update_database") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_update_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_update_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_get_database") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_get_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_get_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_databases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_list_databases") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_list_databases_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_list_databases") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_create_table") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_create_table_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_create_table") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_delete_table") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_delete_table_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_delete_table") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_update_table") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_update_table_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_update_table") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_rename_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_rename_table") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_rename_table_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_rename_table") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_get_table") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_get_table_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_get_table") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_tables_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_list_tables") as post, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "post_list_tables_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetastoreServiceRestInterceptor, "pre_list_tables") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_metastore_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery_biglake_v1.services.metastore_service.transports.MetastoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_metastore_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery_biglake_v1.services.metastore_service.transports.MetastoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MetastoreServiceTransport()
        adc.assert_called_once()
...
def test_metastore_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.MetastoreServiceGrpcTransport, transports.MetastoreServiceGrpcAsyncIOTransport])
def test_metastore_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

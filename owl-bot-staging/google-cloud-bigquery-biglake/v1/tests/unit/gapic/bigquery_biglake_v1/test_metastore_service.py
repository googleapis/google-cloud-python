...
def test_create_catalog_rest_required_fields(request_type=metastore.CreateCatalogRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_catalog._get_unset_required_fields(jsonified_request)
...
def test_create_catalog_rest_unset_required_fields():
    transport = transports.MetastoreServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_delete_catalog_rest_required_fields(request_type=metastore.DeleteCatalogRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_catalog._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_catalog_rest_required_fields(request_type=metastore.GetCatalogRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_catalog._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_database_rest_required_fields(request_type=metastore.CreateDatabaseRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_database_rest_required_fields(request_type=metastore.DeleteDatabaseRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_database_rest_required_fields(request_type=metastore.UpdateDatabaseRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_database_rest_required_fields(request_type=metastore.GetDatabaseRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_rename_table_rest_required_fields(request_type=metastore.RenameTableRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).rename_table._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
class _BaseMetastoreServiceRestTransport(MetastoreServiceTransport):
    """Base REST backend transport for MetastoreService.
    ...
    class _BaseCreateCatalog:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=projects/*/locations/*}/catalogs',
                'body': 'catalog',
            },
            ]
            return http_options
    ...
    class _BaseCreateTable:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=projects/*/locations/*/catalogs/*/databases/*}/tables',
                'body': 'table',
            },
            ]
            return http_options
    ...
    class _BaseDeleteCatalog:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1/{name=projects/*/locations/*/catalogs/*}',
            },
            ]
            return http_options
    ...
    class _BaseDeleteTable:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1/{name=projects/*/locations/*/catalogs/*/databases/*/tables/*}',
            },
            ]
            return http_options
    ...
    class _BaseRenameTable:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{name=projects/*/locations/*/catalogs/*/databases/*/tables/*}:rename',
                'body': '*',
            },
            ]
            return http_options
    ...
    class _BaseUpdateDatabase:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1/{database.name=projects/*/locations/*/catalogs/*/databases/*}',
                'body': 'database',
            },
            ]
            return http_options
    ...
    class _BaseUpdateTable:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1/{table.name=projects/*/locations/*/catalogs/*/databases/*/tables/*}',
                'body': 'table',
            },
            ]
            return http_options
...
__all__=(
    '_BaseMetastoreServiceRestTransport',
)

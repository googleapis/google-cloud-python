...
def test_list_constraints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrgPolicyRestInterceptor, "post_list_constraints_with_metadata") as post_with_metadata, \
...
def test_list_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrgPolicyRestInterceptor, "post_list_policies_with_metadata") as post_with_metadata, \
...
def test_get_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrgPolicyRestInterceptor, "post_get_policy_with_metadata") as post_with_metadata, \
...
def test_get_effective_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrgPolicyRestInterceptor, "post_get_effective_policy_with_metadata") as post_with_metadata, \
...
def test_create_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrgPolicyRestInterceptor, "post_create_policy_with_metadata") as post_with_metadata, \
...
def test_update_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrgPolicyRestInterceptor, "post_update_policy_with_metadata") as post_with_metadata, \
...
def test_create_custom_constraint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrgPolicyRestInterceptor, "post_create_custom_constraint_with_metadata") as post_with_metadata, \
...
def test_update_custom_constraint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrgPolicyRestInterceptor, "post_update_custom_constraint_with_metadata") as post_with_metadata, \
...
def test_get_custom_constraint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrgPolicyRestInterceptor, "post_get_custom_constraint_with_metadata") as post_with_metadata, \
...
def test_list_custom_constraints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrgPolicyRestInterceptor, "post_list_custom_constraints_with_metadata") as post_with_metadata, \

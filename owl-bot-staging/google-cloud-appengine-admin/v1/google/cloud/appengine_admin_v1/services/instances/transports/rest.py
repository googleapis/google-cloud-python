...
class InstancesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_debug_instance(self, request: appengine.DebugInstanceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[appengine.DebugInstanceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_debug_instance_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for debug_instance
    ...
    def pre_delete_instance(self, request: appengine.DeleteInstanceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[appengine.DeleteInstanceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_instance(self, request: appengine.GetInstanceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[appengine.GetInstanceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_instances(self, request: appengine.ListInstancesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[appengine.ListInstancesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_instances_with_metadata(self, response: appengine.ListInstancesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[appengine.ListInstancesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_instances
...
class InstancesRestTransport(_BaseInstancesRestTransport):
    ...
    class _DebugInstance(_BaseInstancesRestTransport._BaseDebugInstance, InstancesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = InstancesRestTransport._DebugInstance._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class InstancesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_debug_instance(self, request: appengine.DebugInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.DebugInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_instance(self, request: appengine.DeleteInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.DeleteInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_instance(self, request: appengine.GetInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.GetInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_instances(self, request: appengine.ListInstancesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.ListInstancesRequest, Sequence[Tuple[str, str]]]:

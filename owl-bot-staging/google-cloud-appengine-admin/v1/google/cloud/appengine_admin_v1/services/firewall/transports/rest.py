...
class FirewallRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_update_ingress_rules(self, request: appengine.BatchUpdateIngressRulesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.BatchUpdateIngressRulesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_ingress_rule(self, request: appengine.CreateIngressRuleRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.CreateIngressRuleRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_ingress_rule(self, request: appengine.DeleteIngressRuleRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.DeleteIngressRuleRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_ingress_rule(self, request: appengine.GetIngressRuleRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.GetIngressRuleRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_ingress_rules(self, request: appengine.ListIngressRulesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.ListIngressRulesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_ingress_rule(self, request: appengine.UpdateIngressRuleRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.UpdateIngressRuleRequest, Sequence[Tuple[str, str]]]:

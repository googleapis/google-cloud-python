...
class DomainMappingsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_domain_mapping(self, request: appengine.CreateDomainMappingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.CreateDomainMappingRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_domain_mapping(self, request: appengine.DeleteDomainMappingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.DeleteDomainMappingRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_domain_mapping(self, request: appengine.GetDomainMappingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.GetDomainMappingRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_domain_mappings(self, request: appengine.ListDomainMappingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.ListDomainMappingsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_domain_mapping(self, request: appengine.UpdateDomainMappingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.UpdateDomainMappingRequest, Sequence[Tuple[str, str]]]:

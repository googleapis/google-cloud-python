...
class VersionsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_version(self, request: appengine.CreateVersionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.CreateVersionRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_version(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_delete_version(self, request: appengine.DeleteVersionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.DeleteVersionRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_delete_version(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_get_version(self, request: appengine.GetVersionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.GetVersionRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_version(self, response: version.Version) -> version.Version:
        ...
        """
        return response
    def pre_list_versions(self, request: appengine.ListVersionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.ListVersionsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_versions(self, response: appengine.ListVersionsResponse) -> appengine.ListVersionsResponse:
        ...
        """
        return response
    def pre_update_version(self, request: appengine.UpdateVersionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.UpdateVersionRequest, Sequence[Tuple[str, str]]]:

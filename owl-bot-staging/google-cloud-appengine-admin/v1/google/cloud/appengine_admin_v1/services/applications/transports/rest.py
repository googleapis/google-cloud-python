...
class ApplicationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_application(self, request: appengine.CreateApplicationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[appengine.CreateApplicationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_application(self, request: appengine.GetApplicationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[appengine.GetApplicationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_application_with_metadata(self, response: application.Application, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[application.Application, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_application
    ...
    def pre_repair_application(self, request: appengine.RepairApplicationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[appengine.RepairApplicationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_repair_application_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for repair_application
    ...
    def pre_update_application(self, request: appengine.UpdateApplicationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[appengine.UpdateApplicationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class ApplicationsRestTransport(_BaseApplicationsRestTransport):
    ...
    class _CreateApplication(_BaseApplicationsRestTransport._BaseCreateApplication, ApplicationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ApplicationsRestTransport._CreateApplication._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetApplication(_BaseApplicationsRestTransport._BaseGetApplication, ApplicationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ApplicationsRestTransport._GetApplication._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RepairApplication(_BaseApplicationsRestTransport._BaseRepairApplication, ApplicationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ApplicationsRestTransport._RepairApplication._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateApplication(_BaseApplicationsRestTransport._BaseUpdateApplication, ApplicationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ApplicationsRestTransport._UpdateApplication._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class _BaseApplicationsRestTransport(ApplicationsTransport):
    """Base REST backend transport for Applications.
...
__all__=(
    '_BaseApplicationsRestTransport',
)

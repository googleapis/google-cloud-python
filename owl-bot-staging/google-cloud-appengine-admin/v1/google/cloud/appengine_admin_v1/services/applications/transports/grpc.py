...
class ApplicationsGrpcTransport(ApplicationsTransport):
    """gRPC backend transport for Applications.
    ...
    def repair_application(self) -> Callable[
        ...
        if 'repair_application' not in self._stubs:
            self._stubs['repair_application'] = self._logged_channel.unary_unary(

...
class AuthorizedCertificatesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_authorized_certificate(self, request: appengine.CreateAuthorizedCertificateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.CreateAuthorizedCertificateRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_authorized_certificate(self, request: appengine.DeleteAuthorizedCertificateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.DeleteAuthorizedCertificateRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_authorized_certificate(self, request: appengine.GetAuthorizedCertificateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.GetAuthorizedCertificateRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_authorized_certificates(self, request: appengine.ListAuthorizedCertificatesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.ListAuthorizedCertificatesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_authorized_certificate(self, request: appengine.UpdateAuthorizedCertificateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.UpdateAuthorizedCertificateRequest, Sequence[Tuple[str, str]]]:

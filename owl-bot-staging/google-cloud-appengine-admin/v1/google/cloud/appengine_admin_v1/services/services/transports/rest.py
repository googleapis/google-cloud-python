...
class ServicesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_service(self, request: appengine.DeleteServiceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.DeleteServiceRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_delete_service(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_get_service(self, request: appengine.GetServiceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.GetServiceRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_service(self, response: service.Service) -> service.Service:
        ...
        """
        return response
    def pre_list_services(self, request: appengine.ListServicesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.ListServicesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_services(self, response: appengine.ListServicesResponse) -> appengine.ListServicesResponse:
        ...
        """
        return response
    def pre_update_service(self, request: appengine.UpdateServiceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[appengine.UpdateServiceRequest, Sequence[Tuple[str, str]]]:

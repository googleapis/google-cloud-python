...
class AuthorizedDomainsClient(metaclass=AuthorizedDomainsClientMeta):
    ...
    def transport(self) -> AuthorizedDomainsTransport:
        ...
        Returns:
            AuthorizedDomainsTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AuthorizedDomainsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AuthorizedDomainsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = AuthorizedDomainsClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AuthorizedDomainsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AuthorizedDomainsTransport, Callable[..., AuthorizedDomainsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AuthorizedDomainsClient._read_environment_variables()
        self._client_cert_source = AuthorizedDomainsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AuthorizedDomainsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, AuthorizedDomainsTransport)
        if transport_provided:
            ...
            self._transport = cast(AuthorizedDomainsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            AuthorizedDomainsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AuthorizedDomainsTransport], Callable[..., AuthorizedDomainsTransport]] = (

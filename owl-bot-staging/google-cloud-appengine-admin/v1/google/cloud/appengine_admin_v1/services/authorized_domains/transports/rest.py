...
class AuthorizedDomainsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_list_authorized_domains(self, request: appengine.ListAuthorizedDomainsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[appengine.ListAuthorizedDomainsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_authorized_domains_with_metadata(self, response: appengine.ListAuthorizedDomainsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[appengine.ListAuthorizedDomainsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_authorized_domains
...
class AuthorizedDomainsRestTransport(_BaseAuthorizedDomainsRestTransport):
    ...
    class _ListAuthorizedDomains(_BaseAuthorizedDomainsRestTransport._BaseListAuthorizedDomains, AuthorizedDomainsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AuthorizedDomainsRestTransport._ListAuthorizedDomains._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

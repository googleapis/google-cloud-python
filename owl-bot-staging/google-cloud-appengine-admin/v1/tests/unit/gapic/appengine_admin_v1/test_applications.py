...
async def test_repair_application_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.repair_application] = mock_object
...
def test_get_application_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ApplicationsRestInterceptor, "post_get_application") as post, \
         mock.patch.object(transports.ApplicationsRestInterceptor, "pre_get_application") as pre:
...
def test_get_application_rest_bad_request(transport: str = 'rest', request_type=appengine.GetApplicationRequest):
    client = ApplicationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_application_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ApplicationsRestInterceptor, "post_create_application") as post, \
         mock.patch.object(transports.ApplicationsRestInterceptor, "pre_create_application") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_application_rest_bad_request(transport: str = 'rest', request_type=appengine.CreateApplicationRequest):
    client = ApplicationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_application_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ApplicationsRestInterceptor, "post_update_application") as post, \
         mock.patch.object(transports.ApplicationsRestInterceptor, "pre_update_application") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_application_rest_bad_request(transport: str = 'rest', request_type=appengine.UpdateApplicationRequest):
    client = ApplicationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_repair_application_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ApplicationsRestInterceptor, "post_repair_application") as post, \
         mock.patch.object(transports.ApplicationsRestInterceptor, "pre_repair_application") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.repair_application(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_repair_application_rest_bad_request(transport: str = 'rest', request_type=appengine.RepairApplicationRequest):
    client = ApplicationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_applications_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.appengine_admin_v1.services.applications.transports.ApplicationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_applications_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.appengine_admin_v1.services.applications.transports.ApplicationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ApplicationsTransport()
        adc.assert_called_once()

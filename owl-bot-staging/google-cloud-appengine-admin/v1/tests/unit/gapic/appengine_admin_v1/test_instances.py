...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstancesRestInterceptor, "post_list_instances_with_metadata") as post_with_metadata, \
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstancesRestInterceptor, "post_get_instance_with_metadata") as post_with_metadata, \
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstancesRestInterceptor, "post_delete_instance_with_metadata") as post_with_metadata, \
...
def test_debug_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstancesRestInterceptor, "post_debug_instance_with_metadata") as post_with_metadata, \

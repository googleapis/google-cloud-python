...
@pytest.mark.parametrize("client_class", [
    InstancesClient, InstancesAsyncClient
])
...
async def test_debug_instance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.debug_instance] = mock_object
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.InstancesRestInterceptor, "post_list_instances") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_list_instances") as pre:
        ...
        req.return_value._content = appengine.ListInstancesResponse.to_json(appengine.ListInstancesResponse())
...
def test_list_instances_rest_bad_request(transport: str = 'rest', request_type=appengine.ListInstancesRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_get_instance") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_get_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_instance_rest_bad_request(transport: str = 'rest', request_type=appengine.GetInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.InstancesRestInterceptor, "post_delete_instance") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_delete_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_instance_rest_bad_request(transport: str = 'rest', request_type=appengine.DeleteInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_debug_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.InstancesRestInterceptor, "post_debug_instance") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_debug_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.debug_instance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_debug_instance_rest_bad_request(transport: str = 'rest', request_type=appengine.DebugInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_instances_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.appengine_admin_v1.services.instances.transports.InstancesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_instances_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.appengine_admin_v1.services.instances.transports.InstancesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.InstancesTransport()
        adc.assert_called_once()

...
@pytest.mark.asyncio
async def test_list_authorized_domains_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    ...
    with mock.patch.object(
        ...
        response = await client.list_authorized_domains()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == appengine.ListAuthorizedDomainsRequest()
...
async def test_list_authorized_domains_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.list_authorized_domains] = mock_object
...
def test_list_authorized_domains_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = appengine.ListAuthorizedDomainsResponse.to_json(appengine.ListAuthorizedDomainsResponse())
...
def test_list_authorized_domains_rest_bad_request(transport: str = 'rest', request_type=appengine.ListAuthorizedDomainsRequest):
    client = AuthorizedDomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

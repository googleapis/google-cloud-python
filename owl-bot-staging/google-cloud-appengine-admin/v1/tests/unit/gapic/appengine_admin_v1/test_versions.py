...
def test_list_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = appengine.ListVersionsResponse.to_json(appengine.ListVersionsResponse())
...
def test_list_versions_rest_bad_request(transport: str = 'rest', request_type=appengine.ListVersionsRequest):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_version_rest_bad_request(transport: str = 'rest', request_type=appengine.GetVersionRequest):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_version_rest_bad_request(transport: str = 'rest', request_type=appengine.CreateVersionRequest):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_version_rest_bad_request(transport: str = 'rest', request_type=appengine.UpdateVersionRequest):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VersionsRestInterceptor, "post_delete_version") as post, \
...
def test_delete_version_rest_bad_request(transport: str = 'rest', request_type=appengine.DeleteVersionRequest):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_versions_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.appengine_admin_v1.services.versions.transports.VersionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_versions_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.appengine_admin_v1.services.versions.transports.VersionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.VersionsTransport()
        adc.assert_called_once()

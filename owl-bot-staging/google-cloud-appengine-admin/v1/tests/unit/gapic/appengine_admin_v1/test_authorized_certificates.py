...
def test__read_environment_variables():
    assert AuthorizedCertificatesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert AuthorizedCertificatesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert AuthorizedCertificatesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert AuthorizedCertificatesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert AuthorizedCertificatesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert AuthorizedCertificatesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AuthorizedCertificatesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert AuthorizedCertificatesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AuthorizedCertificatesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(AuthorizedCertificatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AuthorizedCertificatesClient))
@mock.patch.object(AuthorizedCertificatesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AuthorizedCertificatesAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AuthorizedCertificatesClient._DEFAULT_UNIVERSE
    default_endpoint = AuthorizedCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AuthorizedCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AuthorizedCertificatesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert AuthorizedCertificatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AuthorizedCertificatesClient.DEFAULT_MTLS_ENDPOINT
    assert AuthorizedCertificatesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AuthorizedCertificatesClient._get_api_endpoint(None, None, default_universe, "always") == AuthorizedCertificatesClient.DEFAULT_MTLS_ENDPOINT
    assert AuthorizedCertificatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AuthorizedCertificatesClient.DEFAULT_MTLS_ENDPOINT
    assert AuthorizedCertificatesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AuthorizedCertificatesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AuthorizedCertificatesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AuthorizedCertificatesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AuthorizedCertificatesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AuthorizedCertificatesClient._get_universe_domain(None, None) == AuthorizedCertificatesClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = AuthorizedCertificatesClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (AuthorizedCertificatesClient, transports.AuthorizedCertificatesRestTransport, "rest"),
])
@mock.patch.object(AuthorizedCertificatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AuthorizedCertificatesClient))
@mock.patch.object(AuthorizedCertificatesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AuthorizedCertificatesAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (AuthorizedCertificatesClient, transports.AuthorizedCertificatesRestTransport, "rest", "true"),
    (AuthorizedCertificatesClient, transports.AuthorizedCertificatesRestTransport, "rest", "false"),
])
@mock.patch.object(AuthorizedCertificatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AuthorizedCertificatesClient))
@mock.patch.object(AuthorizedCertificatesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AuthorizedCertificatesAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (AuthorizedCertificatesClient, transports.AuthorizedCertificatesGrpcTransport, "grpc", grpc_helpers),
    (AuthorizedCertificatesAsyncClient, transports.AuthorizedCertificatesGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (AuthorizedCertificatesClient, transports.AuthorizedCertificatesRestTransport, "rest", None),
])
...
def test_list_authorized_certificates_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_authorized_certificates in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_authorized_certificates] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_authorized_certificates_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_authorized_certificates in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_authorized_certificates] = mock_rpc
...
def test_list_authorized_certificates_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_authorized_certificates(request={}, retry=retry, timeout=timeout)
...
def test_get_authorized_certificate_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_authorized_certificate in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_authorized_certificate] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_authorized_certificate_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AuthorizedCertificatesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_authorized_certificate in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_authorized_certificate] = mock_rpc
...
def test_create_authorized_certificate_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_authorized_certificate in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_authorized_certificate] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_authorized_certificate_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AuthorizedCertificatesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_authorized_certificate in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_authorized_certificate] = mock_rpc
...
def test_update_authorized_certificate_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_authorized_certificate in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_authorized_certificate] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_authorized_certificate_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AuthorizedCertificatesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_authorized_certificate in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_authorized_certificate] = mock_rpc
...
def test_delete_authorized_certificate_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_authorized_certificate in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_authorized_certificate] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_authorized_certificate_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AuthorizedCertificatesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_authorized_certificate in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_authorized_certificate] = mock_rpc
...
def test_list_authorized_certificates_rest_bad_request(request_type=appengine.ListAuthorizedCertificatesRequest):
    client = AuthorizedCertificatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_authorized_certificates_rest_interceptors(null_interceptor):
    transport = transports.AuthorizedCertificatesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.AuthorizedCertificatesRestInterceptor(),
        )
    client = AuthorizedCertificatesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "post_list_authorized_certificates") as post, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "post_list_authorized_certificates_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "pre_list_authorized_certificates") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = appengine.ListAuthorizedCertificatesResponse.to_json(appengine.ListAuthorizedCertificatesResponse())
        ...
        post_with_metadata.return_value = appengine.ListAuthorizedCertificatesResponse(), metadata
...
def test_get_authorized_certificate_rest_bad_request(request_type=appengine.GetAuthorizedCertificateRequest):
    client = AuthorizedCertificatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_authorized_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "post_get_authorized_certificate") as post, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "post_get_authorized_certificate_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "pre_get_authorized_certificate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = certificate.AuthorizedCertificate.to_json(certificate.AuthorizedCertificate())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = certificate.AuthorizedCertificate(), metadata
...
def test_create_authorized_certificate_rest_bad_request(request_type=appengine.CreateAuthorizedCertificateRequest):
    client = AuthorizedCertificatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_authorized_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "post_create_authorized_certificate") as post, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "post_create_authorized_certificate_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "pre_create_authorized_certificate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_authorized_certificate_rest_bad_request(request_type=appengine.UpdateAuthorizedCertificateRequest):
    client = AuthorizedCertificatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_authorized_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "post_update_authorized_certificate") as post, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "post_update_authorized_certificate_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "pre_update_authorized_certificate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_authorized_certificate_rest_bad_request(request_type=appengine.DeleteAuthorizedCertificateRequest):
    client = AuthorizedCertificatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_authorized_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "pre_delete_authorized_certificate") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (AuthorizedCertificatesAsyncClient, transports.AuthorizedCertificatesGrpcAsyncIOTransport),
])

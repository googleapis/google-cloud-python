...
def test_list_domain_mappings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DomainMappingsRestInterceptor, "post_list_domain_mappings_with_metadata") as post_with_metadata, \
...
def test_get_domain_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DomainMappingsRestInterceptor, "post_get_domain_mapping_with_metadata") as post_with_metadata, \
...
def test_create_domain_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DomainMappingsRestInterceptor, "post_create_domain_mapping_with_metadata") as post_with_metadata, \
...
def test_update_domain_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DomainMappingsRestInterceptor, "post_update_domain_mapping_with_metadata") as post_with_metadata, \
...
def test_delete_domain_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DomainMappingsRestInterceptor, "post_delete_domain_mapping_with_metadata") as post_with_metadata, \

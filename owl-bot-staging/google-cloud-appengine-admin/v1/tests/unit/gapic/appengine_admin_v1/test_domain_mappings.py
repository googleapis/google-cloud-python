...
def test__get_api_endpoint():
    ...
    assert DomainMappingsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DomainMappingsClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert DomainMappingsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DomainMappingsClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    DomainMappingsClient, DomainMappingsAsyncClient
])
...
async def test_list_domain_mappings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.list_domain_mappings] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_domain_mapping] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.create_domain_mapping] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_domain_mapping] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_domain_mapping] = mock_object
...
def test_list_domain_mappings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DomainMappingsRestInterceptor, "post_list_domain_mappings") as post, \
         mock.patch.object(transports.DomainMappingsRestInterceptor, "pre_list_domain_mappings") as pre:
        ...
        req.return_value._content = appengine.ListDomainMappingsResponse.to_json(appengine.ListDomainMappingsResponse())
        ...
        client.list_domain_mappings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_domain_mappings_rest_bad_request(transport: str = 'rest', request_type=appengine.ListDomainMappingsRequest):
    client = DomainMappingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_domain_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DomainMappingsRestInterceptor, "post_get_domain_mapping") as post, \
         mock.patch.object(transports.DomainMappingsRestInterceptor, "pre_get_domain_mapping") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = domain_mapping.DomainMapping.to_json(domain_mapping.DomainMapping())
        ...
        client.get_domain_mapping(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_domain_mapping_rest_bad_request(transport: str = 'rest', request_type=appengine.GetDomainMappingRequest):
    client = DomainMappingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_domain_mapping_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'apps/sample1'}
    request_init["domain_mapping"] = {'name': 'name_value', 'id': 'id_value', 'ssl_settings': {'certificate_id': 'certificate_id_value', 'ssl_management_type': 1, 'pending_managed_certificate_id': 'pending_managed_certificate_id_value'}, 'resource_records': [{'name': 'name_value', 'rrdata': 'rrdata_value', 'type_': 1}]}
...
def test_create_domain_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DomainMappingsRestInterceptor, "post_create_domain_mapping") as post, \
         mock.patch.object(transports.DomainMappingsRestInterceptor, "pre_create_domain_mapping") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_domain_mapping(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_domain_mapping_rest_bad_request(transport: str = 'rest', request_type=appengine.CreateDomainMappingRequest):
    client = DomainMappingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_domain_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DomainMappingsRestInterceptor, "post_update_domain_mapping") as post, \
         mock.patch.object(transports.DomainMappingsRestInterceptor, "pre_update_domain_mapping") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_domain_mapping(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_domain_mapping_rest_bad_request(transport: str = 'rest', request_type=appengine.UpdateDomainMappingRequest):
    client = DomainMappingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_domain_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DomainMappingsRestInterceptor, "post_delete_domain_mapping") as post, \
         mock.patch.object(transports.DomainMappingsRestInterceptor, "pre_delete_domain_mapping") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_domain_mapping(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_domain_mapping_rest_bad_request(transport: str = 'rest', request_type=appengine.DeleteDomainMappingRequest):
    client = DomainMappingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_domain_mappings_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.appengine_admin_v1.services.domain_mappings.transports.DomainMappingsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_domain_mappings_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.appengine_admin_v1.services.domain_mappings.transports.DomainMappingsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DomainMappingsTransport()
        adc.assert_called_once()

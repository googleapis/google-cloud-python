...
from .transports.base import SystemPolicyV1Beta1Transport, DEFAULT_CLIENT_INFO
...
class SystemPolicyV1Beta1ClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[SystemPolicyV1Beta1Transport]]
...
class SystemPolicyV1Beta1Client(metaclass=SystemPolicyV1Beta1ClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SystemPolicyV1Beta1Client: The constructed client.
        """
    ...
    def transport(self) -> SystemPolicyV1Beta1Transport:
        ...
        Returns:
            SystemPolicyV1Beta1Transport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = SystemPolicyV1Beta1Client._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = SystemPolicyV1Beta1Client.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SystemPolicyV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SystemPolicyV1Beta1Client._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SystemPolicyV1Beta1Client._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SystemPolicyV1Beta1Transport, Callable[..., SystemPolicyV1Beta1Transport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,SystemPolicyV1Beta1Transport,Callable[..., SystemPolicyV1Beta1Transport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the SystemPolicyV1Beta1Transport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SystemPolicyV1Beta1Client._read_environment_variables()
        self._client_cert_source = SystemPolicyV1Beta1Client._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SystemPolicyV1Beta1Client._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SystemPolicyV1Beta1Transport)
        if transport_provided:
            # transport is a SystemPolicyV1Beta1Transport instance.
            ...
            self._transport = cast(SystemPolicyV1Beta1Transport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SystemPolicyV1Beta1Transport], Callable[..., SystemPolicyV1Beta1Transport]] = (

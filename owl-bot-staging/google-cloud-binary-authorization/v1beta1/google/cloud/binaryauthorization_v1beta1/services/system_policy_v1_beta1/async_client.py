...
class SystemPolicyV1Beta1AsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = SystemPolicyV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = SystemPolicyV1Beta1Client.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, SystemPolicyV1Beta1Transport, Callable[..., SystemPolicyV1Beta1Transport]]] = "grpc_asyncio",
            client_options: Optional[ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the system policy v1 beta1 async client.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.binaryauthorization_v1beta1.SystemPolicyV1Beta1AsyncClient`.",
                extra = {

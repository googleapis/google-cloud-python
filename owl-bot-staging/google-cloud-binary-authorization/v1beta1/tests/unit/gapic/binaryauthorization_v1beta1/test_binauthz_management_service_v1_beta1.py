...
@mock.patch.object(BinauthzManagementServiceV1Beta1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BinauthzManagementServiceV1Beta1Client))
@mock.patch.object(BinauthzManagementServiceV1Beta1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BinauthzManagementServiceV1Beta1AsyncClient))
def test__get_api_endpoint():
    ...
    assert BinauthzManagementServiceV1Beta1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BinauthzManagementServiceV1Beta1Client.DEFAULT_MTLS_ENDPOINT
    assert BinauthzManagementServiceV1Beta1Client._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert BinauthzManagementServiceV1Beta1Client._get_api_endpoint(None, None, default_universe, "always") == BinauthzManagementServiceV1Beta1Client.DEFAULT_MTLS_ENDPOINT
    assert BinauthzManagementServiceV1Beta1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BinauthzManagementServiceV1Beta1Client.DEFAULT_MTLS_ENDPOINT
...
def test_transport_kind_grpc_asyncio():
    transport = BinauthzManagementServiceV1Beta1AsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_get_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, "post_get_policy_with_metadata") as post_with_metadata, \
...
def test_update_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, "post_update_policy_with_metadata") as post_with_metadata, \
...
def test_create_attestor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, "post_create_attestor_with_metadata") as post_with_metadata, \
...
def test_get_attestor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, "post_get_attestor_with_metadata") as post_with_metadata, \
...
def test_update_attestor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, "post_update_attestor_with_metadata") as post_with_metadata, \
...
def test_list_attestors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, "post_list_attestors_with_metadata") as post_with_metadata, \

...
def test_get_policy_rest_unset_required_fields():
    transport = transports.BinauthzManagementServiceV1RestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_attestor_rest_required_fields(request_type=service.CreateAttestorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_attestor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_attestor_rest_required_fields(request_type=service.GetAttestorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_attestor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_attestor_rest_required_fields(request_type=service.UpdateAttestorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_attestor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_attestors_rest_required_fields(request_type=service.ListAttestorsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_attestors._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_attestor_rest_required_fields(request_type=service.DeleteAttestorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_attestor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

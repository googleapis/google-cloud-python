...
from google.cloud.binaryauthorization_v1.services.binauthz_management_service_v1 import BinauthzManagementServiceV1AsyncClient
...
from google.cloud.binaryauthorization_v1.services.binauthz_management_service_v1 import transports
...
def test__read_environment_variables():
    assert BinauthzManagementServiceV1Client._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert BinauthzManagementServiceV1Client._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert BinauthzManagementServiceV1Client._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert BinauthzManagementServiceV1Client._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert BinauthzManagementServiceV1Client._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert BinauthzManagementServiceV1Client._get_client_cert_source(None, False) is None
    assert BinauthzManagementServiceV1Client._get_client_cert_source(mock_provided_cert_source, False) is None
    assert BinauthzManagementServiceV1Client._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert BinauthzManagementServiceV1Client._get_client_cert_source(None, True) is mock_default_cert_source
            assert BinauthzManagementServiceV1Client._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(BinauthzManagementServiceV1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BinauthzManagementServiceV1Client))
@mock.patch.object(BinauthzManagementServiceV1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BinauthzManagementServiceV1AsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BinauthzManagementServiceV1Client._DEFAULT_UNIVERSE
    default_endpoint = BinauthzManagementServiceV1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = BinauthzManagementServiceV1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert BinauthzManagementServiceV1Client._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert BinauthzManagementServiceV1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BinauthzManagementServiceV1Client.DEFAULT_MTLS_ENDPOINT
    assert BinauthzManagementServiceV1Client._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert BinauthzManagementServiceV1Client._get_api_endpoint(None, None, default_universe, "always") == BinauthzManagementServiceV1Client.DEFAULT_MTLS_ENDPOINT
    assert BinauthzManagementServiceV1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BinauthzManagementServiceV1Client.DEFAULT_MTLS_ENDPOINT
    assert BinauthzManagementServiceV1Client._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert BinauthzManagementServiceV1Client._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        BinauthzManagementServiceV1Client._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert BinauthzManagementServiceV1Client._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert BinauthzManagementServiceV1Client._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert BinauthzManagementServiceV1Client._get_universe_domain(None, None) == BinauthzManagementServiceV1Client._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = BinauthzManagementServiceV1Client(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_name", [
    (BinauthzManagementServiceV1Client, "grpc"),
    (BinauthzManagementServiceV1AsyncClient, "grpc_asyncio"),
    (BinauthzManagementServiceV1Client, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    ...
    (transports.BinauthzManagementServiceV1RestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (BinauthzManagementServiceV1Client, transports.BinauthzManagementServiceV1GrpcTransport, "grpc"),
    (BinauthzManagementServiceV1AsyncClient, transports.BinauthzManagementServiceV1GrpcAsyncIOTransport, "grpc_asyncio"),
    (BinauthzManagementServiceV1Client, transports.BinauthzManagementServiceV1RestTransport, "rest"),
])
@mock.patch.object(BinauthzManagementServiceV1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BinauthzManagementServiceV1Client))
@mock.patch.object(BinauthzManagementServiceV1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BinauthzManagementServiceV1AsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (BinauthzManagementServiceV1Client, transports.BinauthzManagementServiceV1GrpcTransport, "grpc", "true"),
    (BinauthzManagementServiceV1AsyncClient, transports.BinauthzManagementServiceV1GrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (BinauthzManagementServiceV1Client, transports.BinauthzManagementServiceV1GrpcTransport, "grpc", "false"),
    (BinauthzManagementServiceV1AsyncClient, transports.BinauthzManagementServiceV1GrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (BinauthzManagementServiceV1Client, transports.BinauthzManagementServiceV1RestTransport, "rest", "true"),
    (BinauthzManagementServiceV1Client, transports.BinauthzManagementServiceV1RestTransport, "rest", "false"),
])
@mock.patch.object(BinauthzManagementServiceV1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BinauthzManagementServiceV1Client))
@mock.patch.object(BinauthzManagementServiceV1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BinauthzManagementServiceV1AsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (BinauthzManagementServiceV1Client, transports.BinauthzManagementServiceV1GrpcTransport, "grpc", grpc_helpers),
    (BinauthzManagementServiceV1AsyncClient, transports.BinauthzManagementServiceV1GrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (BinauthzManagementServiceV1Client, transports.BinauthzManagementServiceV1RestTransport, "rest", None),
])
...
def test_create_attestor_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_attestor in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_attestor] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_attestor_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BinauthzManagementServiceV1AsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_attestor in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_attestor] = mock_rpc
...
def test_get_attestor_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_attestor in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_attestor] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_attestor_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BinauthzManagementServiceV1AsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_attestor in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_attestor] = mock_rpc
...
def test_update_attestor_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_attestor in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_attestor] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_attestor_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BinauthzManagementServiceV1AsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_attestor in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_attestor] = mock_rpc
...
def test_list_attestors_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_attestors in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_attestors] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_attestors_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BinauthzManagementServiceV1AsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_attestors in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_attestors] = mock_rpc
...
def test_list_attestors_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_attestors(request={}, retry=retry, timeout=timeout)
...
def test_delete_attestor_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_attestor in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_attestor] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_attestor_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BinauthzManagementServiceV1AsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_attestor in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_attestor] = mock_rpc
...
def test_transport_kind_grpc_asyncio():
    transport = BinauthzManagementServiceV1AsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = BinauthzManagementServiceV1Client.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_get_policy_rest_interceptors(null_interceptor):
    transport = transports.BinauthzManagementServiceV1RestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BinauthzManagementServiceV1RestInterceptor(),
        )
    client = BinauthzManagementServiceV1Client(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_get_policy") as post, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_get_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "pre_get_policy") as pre:
...
def test_update_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_update_policy") as post, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_update_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "pre_update_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_attestor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_create_attestor") as post, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_create_attestor_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "pre_create_attestor") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_attestor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_get_attestor") as post, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_get_attestor_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "pre_get_attestor") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_attestor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_update_attestor") as post, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_update_attestor_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "pre_update_attestor") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_attestors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_list_attestors") as post, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_list_attestors_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "pre_list_attestors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListAttestorsResponse.to_json(service.ListAttestorsResponse())
        req.return_value.content = return_value
...
def test_delete_attestor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "pre_delete_attestor") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.BinauthzManagementServiceV1GrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_binauthz_management_service_v1_client_transport_session_collision(transport_name):
    ...
    client2 = BinauthzManagementServiceV1Client(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("client_class,transport_class", [
    (BinauthzManagementServiceV1Client, transports.BinauthzManagementServiceV1GrpcTransport),
    (BinauthzManagementServiceV1AsyncClient, transports.BinauthzManagementServiceV1GrpcAsyncIOTransport),
])

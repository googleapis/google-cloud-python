...
from google.cloud.binaryauthorization_v1.services.binauthz_management_service_v1 import pagers
...
class BinauthzManagementServiceV1ClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[BinauthzManagementServiceV1Transport]]
...
class BinauthzManagementServiceV1Client(metaclass=BinauthzManagementServiceV1ClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = BinauthzManagementServiceV1Client._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = BinauthzManagementServiceV1Client.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = BinauthzManagementServiceV1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = BinauthzManagementServiceV1Client._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            BinauthzManagementServiceV1Client._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BinauthzManagementServiceV1Transport, Callable[..., BinauthzManagementServiceV1Transport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,BinauthzManagementServiceV1Transport,Callable[..., BinauthzManagementServiceV1Transport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the BinauthzManagementServiceV1Transport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = BinauthzManagementServiceV1Client._read_environment_variables()
        self._client_cert_source = BinauthzManagementServiceV1Client._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = BinauthzManagementServiceV1Client._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, BinauthzManagementServiceV1Transport)
        if transport_provided:
            ...
            self._transport = cast(BinauthzManagementServiceV1Transport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BinauthzManagementServiceV1Transport], Callable[..., BinauthzManagementServiceV1Transport]] = (
                BinauthzManagementServiceV1Client.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., BinauthzManagementServiceV1Transport], transport)
            )

...
from .rest_base import _BaseBinauthzManagementServiceV1RestTransport
...
class BinauthzManagementServiceV1RestInterceptor:
    """Interceptor for BinauthzManagementServiceV1.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the BinauthzManagementServiceV1RestTransport.

    .. code-block:: python
        class MyCustomBinauthzManagementServiceV1Interceptor(BinauthzManagementServiceV1RestInterceptor):
        ...
        transport = BinauthzManagementServiceV1RestTransport(interceptor=MyCustomBinauthzManagementServiceV1Interceptor())
        client = BinauthzManagementServiceV1Client(transport=transport)


    """
    def pre_create_attestor(self, request: service.CreateAttestorRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.CreateAttestorRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for create_attestor

        Override in a subclass to manipulate the request or metadata
        before they are sent to the BinauthzManagementServiceV1 server.
        """
        return request, metadata
    ...
    def post_create_attestor_with_metadata(self, response: resources.Attestor, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.Attestor, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_attestor
    ...
    def pre_delete_attestor(self, request: service.DeleteAttestorRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.DeleteAttestorRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_attestor(self, request: service.GetAttestorRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.GetAttestorRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_attestor_with_metadata(self, response: resources.Attestor, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.Attestor, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_attestor
    ...
    def pre_get_policy(self, request: service.GetPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.GetPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_policy_with_metadata(self, response: resources.Policy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.Policy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_policy
    ...
    def pre_list_attestors(self, request: service.ListAttestorsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.ListAttestorsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_attestors_with_metadata(self, response: service.ListAttestorsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.ListAttestorsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_attestors
    ...
    def pre_update_attestor(self, request: service.UpdateAttestorRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.UpdateAttestorRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_attestor_with_metadata(self, response: resources.Attestor, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.Attestor, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_attestor
    ...
    def pre_update_policy(self, request: service.UpdatePolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.UpdatePolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_policy_with_metadata(self, response: resources.Policy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.Policy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_policy
...
class BinauthzManagementServiceV1RestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: BinauthzManagementServiceV1RestInterceptor


class BinauthzManagementServiceV1RestTransport(_BaseBinauthzManagementServiceV1RestTransport):
    """REST backend synchronous transport for BinauthzManagementServiceV1.
    ...
    class _CreateAttestor(_BaseBinauthzManagementServiceV1RestTransport._BaseCreateAttestor, BinauthzManagementServiceV1RestStub):
        def __hash__(self):
            return hash("BinauthzManagementServiceV1RestTransport.CreateAttestor")
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseBinauthzManagementServiceV1RestTransport._BaseCreateAttestor._get_transcoded_request(http_options, request)

            body = _BaseBinauthzManagementServiceV1RestTransport._BaseCreateAttestor._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBinauthzManagementServiceV1RestTransport._BaseCreateAttestor._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BinauthzManagementServiceV1RestTransport._CreateAttestor._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteAttestor(_BaseBinauthzManagementServiceV1RestTransport._BaseDeleteAttestor, BinauthzManagementServiceV1RestStub):
        def __hash__(self):
            return hash("BinauthzManagementServiceV1RestTransport.DeleteAttestor")
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseBinauthzManagementServiceV1RestTransport._BaseDeleteAttestor._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseBinauthzManagementServiceV1RestTransport._BaseDeleteAttestor._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BinauthzManagementServiceV1RestTransport._DeleteAttestor._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetAttestor(_BaseBinauthzManagementServiceV1RestTransport._BaseGetAttestor, BinauthzManagementServiceV1RestStub):
        def __hash__(self):
            return hash("BinauthzManagementServiceV1RestTransport.GetAttestor")
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseBinauthzManagementServiceV1RestTransport._BaseGetAttestor._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseBinauthzManagementServiceV1RestTransport._BaseGetAttestor._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BinauthzManagementServiceV1RestTransport._GetAttestor._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetPolicy(_BaseBinauthzManagementServiceV1RestTransport._BaseGetPolicy, BinauthzManagementServiceV1RestStub):
        def __hash__(self):
            return hash("BinauthzManagementServiceV1RestTransport.GetPolicy")
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseBinauthzManagementServiceV1RestTransport._BaseGetPolicy._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseBinauthzManagementServiceV1RestTransport._BaseGetPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BinauthzManagementServiceV1RestTransport._GetPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListAttestors(_BaseBinauthzManagementServiceV1RestTransport._BaseListAttestors, BinauthzManagementServiceV1RestStub):
        def __hash__(self):
            return hash("BinauthzManagementServiceV1RestTransport.ListAttestors")
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseBinauthzManagementServiceV1RestTransport._BaseListAttestors._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseBinauthzManagementServiceV1RestTransport._BaseListAttestors._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BinauthzManagementServiceV1RestTransport._ListAttestors._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateAttestor(_BaseBinauthzManagementServiceV1RestTransport._BaseUpdateAttestor, BinauthzManagementServiceV1RestStub):
        def __hash__(self):
            return hash("BinauthzManagementServiceV1RestTransport.UpdateAttestor")
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseBinauthzManagementServiceV1RestTransport._BaseUpdateAttestor._get_transcoded_request(http_options, request)

            body = _BaseBinauthzManagementServiceV1RestTransport._BaseUpdateAttestor._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBinauthzManagementServiceV1RestTransport._BaseUpdateAttestor._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BinauthzManagementServiceV1RestTransport._UpdateAttestor._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdatePolicy(_BaseBinauthzManagementServiceV1RestTransport._BaseUpdatePolicy, BinauthzManagementServiceV1RestStub):
        def __hash__(self):
            return hash("BinauthzManagementServiceV1RestTransport.UpdatePolicy")
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseBinauthzManagementServiceV1RestTransport._BaseUpdatePolicy._get_transcoded_request(http_options, request)

            body = _BaseBinauthzManagementServiceV1RestTransport._BaseUpdatePolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseBinauthzManagementServiceV1RestTransport._BaseUpdatePolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = BinauthzManagementServiceV1RestTransport._UpdatePolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class BinauthzManagementServiceV1AsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = BinauthzManagementServiceV1Client._DEFAULT_ENDPOINT_TEMPLATE
    ...
    parse_attestor_path = staticmethod(BinauthzManagementServiceV1Client.parse_attestor_path)
    policy_path = staticmethod(BinauthzManagementServiceV1Client.policy_path)
    parse_policy_path = staticmethod(BinauthzManagementServiceV1Client.parse_policy_path)
    common_billing_account_path = staticmethod(BinauthzManagementServiceV1Client.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(BinauthzManagementServiceV1Client.parse_common_billing_account_path)
    common_folder_path = staticmethod(BinauthzManagementServiceV1Client.common_folder_path)
    parse_common_folder_path = staticmethod(BinauthzManagementServiceV1Client.parse_common_folder_path)
    common_organization_path = staticmethod(BinauthzManagementServiceV1Client.common_organization_path)
    parse_common_organization_path = staticmethod(BinauthzManagementServiceV1Client.parse_common_organization_path)
    common_project_path = staticmethod(BinauthzManagementServiceV1Client.common_project_path)
    parse_common_project_path = staticmethod(BinauthzManagementServiceV1Client.parse_common_project_path)
    common_location_path = staticmethod(BinauthzManagementServiceV1Client.common_location_path)
    parse_common_location_path = staticmethod(BinauthzManagementServiceV1Client.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(BinauthzManagementServiceV1Client).get_transport_class, type(BinauthzManagementServiceV1Client))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, BinauthzManagementServiceV1Transport, Callable[..., BinauthzManagementServiceV1Transport]]] = "grpc_asyncio",
    ...
    async def get_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.binaryauthorization_v1.types.GetPolicyRequest, dict]]):
    ...
    async def update_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.binaryauthorization_v1.types.UpdatePolicyRequest, dict]]):
                The request object. Request message for
    ...
    async def create_attestor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.binaryauthorization_v1.types.CreateAttestorRequest, dict]]):
                The request object. Request message for
    ...
    async def get_attestor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.binaryauthorization_v1.types.GetAttestorRequest, dict]]):
                The request object. Request message for
    ...
    async def update_attestor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.binaryauthorization_v1.types.UpdateAttestorRequest, dict]]):
                The request object. Request message for
    ...
    async def list_attestors(self,
        ...
        Args:
            request (Optional[Union[google.cloud.binaryauthorization_v1.types.ListAttestorsRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_attestor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.binaryauthorization_v1.types.DeleteAttestorRequest, dict]]):
                The request object. Request message for

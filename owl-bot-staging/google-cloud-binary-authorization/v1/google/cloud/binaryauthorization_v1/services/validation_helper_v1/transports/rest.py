...
class ValidationHelperV1RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_validate_attestation_occurrence(self, request: service.ValidateAttestationOccurrenceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.ValidateAttestationOccurrenceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_validate_attestation_occurrence_with_metadata(self, response: service.ValidateAttestationOccurrenceResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.ValidateAttestationOccurrenceResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for validate_attestation_occurrence
...
class ValidationHelperV1RestTransport(_BaseValidationHelperV1RestTransport):
    ...
    class _ValidateAttestationOccurrence(_BaseValidationHelperV1RestTransport._BaseValidateAttestationOccurrence, ValidationHelperV1RestStub):
        ...
        occurrence method over HTTP.
            ...
            transcoded_request = _BaseValidationHelperV1RestTransport._BaseValidateAttestationOccurrence._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = ValidationHelperV1RestTransport._ValidateAttestationOccurrence._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
def test__get_api_endpoint():
    ...
    assert CloudFilestoreManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CloudFilestoreManagerClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert CloudFilestoreManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CloudFilestoreManagerClient.DEFAULT_MTLS_ENDPOINT
...
def test_revert_instance(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.revert_instance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_snapshots_rest_required_fields(request_type=cloud_filestore_service.ListSnapshotsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_snapshots._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("filter", "order_by", "page_size", "page_token", "return_partial_success", ))
    jsonified_request.update(unset_fields)
...
def test_list_snapshots_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "orderBy", "pageSize", "pageToken", "returnPartialSuccess", )) & set(("parent", )))
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_list_instances_with_metadata") as post_with_metadata, \
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_get_instance_with_metadata") as post_with_metadata, \
...
def test_create_instance_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["instance"] = {'name': 'name_value', 'description': 'description_value', 'state': 1, 'status_message': 'status_message_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'tier': 1, 'labels': {}, 'file_shares': [{'name': 'name_value', 'capacity_gb': 1142, 'source_backup': 'source_backup_value', 'nfs_export_options': [{'ip_ranges': ['ip_ranges_value1', 'ip_ranges_value2'], 'access_mode': 1, 'squash_mode': 1, 'anon_uid': 845, 'anon_gid': 831}]}], 'networks': [{'network': 'network_value', 'modes': [1], 'reserved_ip_range': 'reserved_ip_range_value', 'ip_addresses': ['ip_addresses_value1', 'ip_addresses_value2'], 'connect_mode': 1}], 'etag': 'etag_value', 'satisfies_pzs': {'value': True}, 'satisfies_pzi': True, 'kms_key_name': 'kms_key_name_value', 'suspension_reasons': [1], 'replication': {'role': 1, 'replicas': [{'state': 1, 'state_reasons': [1], 'peer_instance': 'peer_instance_value', 'last_active_sync_time': {}}]}, 'tags': {}, 'protocol': 1, 'custom_performance_supported': True, 'performance_config': {'iops_per_tb': {'max_iops_per_tb': 1595}, 'fixed_iops': {'max_iops': 864}}, 'performance_limits': {'max_iops': 864, 'max_read_iops': 1371, 'max_write_iops': 1514, 'max_read_throughput_bps': 2462, 'max_write_throughput_bps': 2605}, 'deletion_protection_enabled': True, 'deletion_protection_reason': 'deletion_protection_reason_value'}
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_create_instance_with_metadata") as post_with_metadata, \
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_update_instance_with_metadata") as post_with_metadata, \
...
def test_restore_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_restore_instance_with_metadata") as post_with_metadata, \
...
def test_revert_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_revert_instance") as post, \
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_revert_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_revert_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_delete_instance_with_metadata") as post_with_metadata, \
...
def test_list_snapshots_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_list_snapshots_with_metadata") as post_with_metadata, \
...
def test_get_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_get_snapshot_with_metadata") as post_with_metadata, \
...
def test_create_snapshot_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/instances/sample3'}
    request_init["snapshot"] = {'name': 'name_value', 'description': 'description_value', 'state': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'labels': {}, 'filesystem_used_bytes': 2267, 'tags': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_create_snapshot_with_metadata") as post_with_metadata, \
...
def test_delete_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_delete_snapshot_with_metadata") as post_with_metadata, \
...
def test_update_snapshot_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'snapshot': {'name': 'projects/sample1/locations/sample2/instances/sample3/snapshots/sample4'}}
    request_init["snapshot"] = {'name': 'projects/sample1/locations/sample2/instances/sample3/snapshots/sample4', 'description': 'description_value', 'state': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'labels': {}, 'filesystem_used_bytes': 2267, 'tags': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_update_snapshot_with_metadata") as post_with_metadata, \
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_list_backups_with_metadata") as post_with_metadata, \
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_get_backup_with_metadata") as post_with_metadata, \
...
def test_create_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_create_backup_with_metadata") as post_with_metadata, \
...
def test_delete_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_delete_backup_with_metadata") as post_with_metadata, \
...
def test_update_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_update_backup_with_metadata") as post_with_metadata, \
...
def test_promote_replica_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_promote_replica") as post, \
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_promote_replica_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_promote_replica") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.promote_replica(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

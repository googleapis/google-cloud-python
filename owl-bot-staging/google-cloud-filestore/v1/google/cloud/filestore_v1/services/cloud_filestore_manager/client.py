...
class CloudFilestoreManagerClient(metaclass=CloudFilestoreManagerClientMeta):
    ...
    @staticmethod
    def snapshot_path(project: str,location: str,instance: str,snapshot: str,) -> str:
        """Returns a fully-qualified snapshot string."""
        return "projects/{project}/locations/{location}/instances/{instance}/snapshots/{snapshot}".format(project=project, location=location, instance=instance, snapshot=snapshot, )

    @staticmethod
    def parse_snapshot_path(path: str) -> Dict[str,str]:
        """Parses a snapshot path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/snapshots/(?P<snapshot>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = CloudFilestoreManagerClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = CloudFilestoreManagerClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CloudFilestoreManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = CloudFilestoreManagerClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CloudFilestoreManagerTransport, Callable[..., CloudFilestoreManagerTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CloudFilestoreManagerClient._read_environment_variables()
        self._client_cert_source = CloudFilestoreManagerClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CloudFilestoreManagerClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, CloudFilestoreManagerTransport)
        if transport_provided:
            ...
            self._transport = cast(CloudFilestoreManagerTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CloudFilestoreManagerTransport], Callable[..., CloudFilestoreManagerTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.filestore_v1.CloudFilestoreManagerClient`.",
                    extra = {
    ...
    def revert_instance(self,
        ...
        r"""Revert an existing instance's file system to a
        specified snapshot.
        ...
        Args:
            request (Union[google.cloud.filestore_v1.types.RevertInstanceRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.revert_instance]
    ...
    def promote_replica(self,
        ...
        Args:
            request (Union[google.cloud.filestore_v1.types.PromoteReplicaRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_filestore_service.PromoteReplicaRequest):
            request = cloud_filestore_service.PromoteReplicaRequest(request)

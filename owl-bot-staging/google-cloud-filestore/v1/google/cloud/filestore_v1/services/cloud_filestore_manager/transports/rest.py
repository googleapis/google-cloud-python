...
class CloudFilestoreManagerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_revert_instance(self, request: cloud_filestore_service.RevertInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_filestore_service.RevertInstanceRequest, Sequence[Tuple[str, str]]]:

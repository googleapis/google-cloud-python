...
class HostProjectRegistrationServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_host_project_registration(self, request: host_project_registration_service.CreateHostProjectRegistrationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[host_project_registration_service.CreateHostProjectRegistrationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_host_project_registration(self, request: host_project_registration_service.GetHostProjectRegistrationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[host_project_registration_service.GetHostProjectRegistrationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_host_project_registrations(self, request: host_project_registration_service.ListHostProjectRegistrationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[host_project_registration_service.ListHostProjectRegistrationsRequest, Sequence[Tuple[str, str]]]:

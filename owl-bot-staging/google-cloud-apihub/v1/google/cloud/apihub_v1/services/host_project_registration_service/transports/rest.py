...
from .base import HostProjectRegistrationServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class HostProjectRegistrationServiceRestTransport(HostProjectRegistrationServiceTransport):
    """REST backend transport for HostProjectRegistrationService.
    ...
    class _CreateHostProjectRegistration(HostProjectRegistrationServiceRestStub):
        def __hash__(self):
            return hash("CreateHostProjectRegistration")
        ...
        registration method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=projects/*/locations/*}/hostProjectRegistrations',
                'body': 'host_project_registration',
            },
            ]
            request, metadata = self._interceptor.pre_create_host_project_registration(request, metadata)
            pb_request = host_project_registration_service.CreateHostProjectRegistrationRequest.pb(request)
    ...
    class _GetHostProjectRegistration(HostProjectRegistrationServiceRestStub):
        def __hash__(self):
            return hash("GetHostProjectRegistration")
        ...
        registration method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1/{name=projects/*/locations/*/hostProjectRegistrations/*}',
            },
            ]
            request, metadata = self._interceptor.pre_get_host_project_registration(request, metadata)
            pb_request = host_project_registration_service.GetHostProjectRegistrationRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListHostProjectRegistrations(HostProjectRegistrationServiceRestStub):
        def __hash__(self):
            return hash("ListHostProjectRegistrations")
        ...
        registrations method over HTTP.
            ...
            pb_request = host_project_registration_service.ListHostProjectRegistrationsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetLocation(HostProjectRegistrationServiceRestStub):
        def __call__(self,
    ...
    class _ListLocations(HostProjectRegistrationServiceRestStub):
        def __call__(self,
    ...
    class _CancelOperation(HostProjectRegistrationServiceRestStub):
        def __call__(self,
    ...
    class _GetOperation(HostProjectRegistrationServiceRestStub):
        def __call__(self,
    ...
    class _ListOperations(HostProjectRegistrationServiceRestStub):
        def __call__(self,

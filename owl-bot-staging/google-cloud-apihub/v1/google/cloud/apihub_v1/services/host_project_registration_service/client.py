...
from .transports.base import HostProjectRegistrationServiceTransport, DEFAULT_CLIENT_INFO
...
class HostProjectRegistrationServiceClientMeta(type):
    """Metaclass for the HostProjectRegistrationService client.
...
class HostProjectRegistrationServiceClient(metaclass=HostProjectRegistrationServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            HostProjectRegistrationServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> HostProjectRegistrationServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            HostProjectRegistrationServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def host_project_registration_path(project: str,location: str,host_project_registration: str,) -> str:
        """Returns a fully-qualified host_project_registration string."""
        return "projects/{project}/locations/{location}/hostProjectRegistrations/{host_project_registration}".format(project=project, location=location, host_project_registration=host_project_registration, )

    @staticmethod
    def parse_host_project_registration_path(path: str) -> Dict[str,str]:
        """Parses a host_project_registration path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/hostProjectRegistrations/(?P<host_project_registration>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = HostProjectRegistrationServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = HostProjectRegistrationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = HostProjectRegistrationServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            HostProjectRegistrationServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, HostProjectRegistrationServiceTransport, Callable[..., HostProjectRegistrationServiceTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,HostProjectRegistrationServiceTransport,Callable[..., HostProjectRegistrationServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the HostProjectRegistrationServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = HostProjectRegistrationServiceClient._read_environment_variables()
        self._client_cert_source = HostProjectRegistrationServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = HostProjectRegistrationServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, HostProjectRegistrationServiceTransport)
        if transport_provided:
            # transport is a HostProjectRegistrationServiceTransport instance.
            ...
            self._transport = cast(HostProjectRegistrationServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[HostProjectRegistrationServiceTransport], Callable[..., HostProjectRegistrationServiceTransport]] = (
                HostProjectRegistrationServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., HostProjectRegistrationServiceTransport], transport)
            )
    ...
    def create_host_project_registration(self,
        ...
        .. code-block:: python
            ...
            def sample_create_host_project_registration():
                # Create a client
                client = apihub_v1.HostProjectRegistrationServiceClient()

                # Initialize request argument(s)
                host_project_registration = apihub_v1.HostProjectRegistration()
                host_project_registration.gcp_project = "gcp_project_value"

                request = apihub_v1.CreateHostProjectRegistrationRequest(
                    parent="parent_value",
                ...
                # Make the request
                response = client.create_host_project_registration(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.apihub_v1.types.CreateHostProjectRegistrationRequest, dict]):
            ...
            host_project_registration (google.cloud.apihub_v1.types.HostProjectRegistration):
                ...
                This corresponds to the ``host_project_registration`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        if not isinstance(request, host_project_registration_service.CreateHostProjectRegistrationRequest):
            ...
            if host_project_registration is not None:
                request.host_project_registration = host_project_registration
            if host_project_registration_id is not None:
                request.host_project_registration_id = host_project_registration_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_host_project_registration]
    ...
    def get_host_project_registration(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.GetHostProjectRegistrationRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_host_project_registration]
    ...
    def list_host_project_registrations(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.ListHostProjectRegistrationsRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_host_project_registrations]
        ...
        response = pagers.ListHostProjectRegistrationsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "HostProjectRegistrationServiceClient":
        return self

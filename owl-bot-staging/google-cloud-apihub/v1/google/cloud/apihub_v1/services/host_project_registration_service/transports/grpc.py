...
class HostProjectRegistrationServiceGrpcTransport(HostProjectRegistrationServiceTransport):
    ...
    def create_host_project_registration(self) -> Callable[
        ...
        if 'create_host_project_registration' not in self._stubs:
            self._stubs['create_host_project_registration'] = self.grpc_channel.unary_unary(
    ...
    def get_host_project_registration(self) -> Callable[
        ...
        if 'get_host_project_registration' not in self._stubs:
            self._stubs['get_host_project_registration'] = self.grpc_channel.unary_unary(
    ...
    def list_host_project_registrations(self) -> Callable[
        ...
        if 'list_host_project_registrations' not in self._stubs:
            self._stubs['list_host_project_registrations'] = self.grpc_channel.unary_unary(

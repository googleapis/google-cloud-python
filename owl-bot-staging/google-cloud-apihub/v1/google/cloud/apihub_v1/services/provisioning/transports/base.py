...
class ProvisioningTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_api_hub_instance: gapic_v1.method.wrap_method(
                self.create_api_hub_instance,
            ...
            self.lookup_api_hub_instance: gapic_v1.method.wrap_method(
                self.lookup_api_hub_instance,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
    ...
    @property
    def create_api_hub_instance(self) -> Callable[
    ...
    @property
    def delete_api_hub_instance(self) -> Callable[
    ...
    @property
    def get_api_hub_instance(self) -> Callable[
            [provisioning_service.GetApiHubInstanceRequest],
            Union[
                common_fields.ApiHubInstance,
                Awaitable[common_fields.ApiHubInstance]
            ]]:
        raise NotImplementedError()

    @property
    def lookup_api_hub_instance(self) -> Callable[
            [provisioning_service.LookupApiHubInstanceRequest],
            Union[
                provisioning_service.LookupApiHubInstanceResponse,
                Awaitable[provisioning_service.LookupApiHubInstanceResponse]
            ]]:
        raise NotImplementedError()

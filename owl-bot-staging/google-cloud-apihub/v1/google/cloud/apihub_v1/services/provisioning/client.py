...
class ProvisioningClient(metaclass=ProvisioningClientMeta):
    ...
    @staticmethod
    def api_hub_instance_path(project: str,location: str,api_hub_instance: str,) -> str:
        """Returns a fully-qualified api_hub_instance string."""
        return "projects/{project}/locations/{location}/apiHubInstances/{api_hub_instance}".format(project=project, location=location, api_hub_instance=api_hub_instance, )
    ...
    def create_api_hub_instance(self,
    ...
    def delete_api_hub_instance(self,
    ...
    def lookup_api_hub_instance(self,

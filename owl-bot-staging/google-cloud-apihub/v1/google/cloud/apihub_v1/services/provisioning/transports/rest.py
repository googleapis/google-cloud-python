...
class ProvisioningRestTransport(ProvisioningTransport):
    ...
    class _CreateApiHubInstance(ProvisioningRestStub):
        def __hash__(self):
            return hash("CreateApiHubInstance")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=projects/*/locations/*}/apiHubInstances',
                'body': 'api_hub_instance',
            },
            ]
            request, metadata = self._interceptor.pre_create_api_hub_instance(request, metadata)
            pb_request = provisioning_service.CreateApiHubInstanceRequest.pb(request)
    ...
    class _GetApiHubInstance(ProvisioningRestStub):
        def __hash__(self):
            return hash("GetApiHubInstance")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1/{name=projects/*/locations/*/apiHubInstances/*}',
            },
            ]
            request, metadata = self._interceptor.pre_get_api_hub_instance(request, metadata)
            pb_request = provisioning_service.GetApiHubInstanceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _LookupApiHubInstance(ProvisioningRestStub):
        def __hash__(self):
            return hash("LookupApiHubInstance")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1/{parent=projects/*/locations/*}/apiHubInstances:lookup',
            },
            ]
            request, metadata = self._interceptor.pre_lookup_api_hub_instance(request, metadata)
            pb_request = provisioning_service.LookupApiHubInstanceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)

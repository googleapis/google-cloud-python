...
class RuntimeProjectAttachmentServiceClient(metaclass=RuntimeProjectAttachmentServiceClientMeta):
    ...
    @staticmethod
    def runtime_project_attachment_path(project: str,location: str,runtime_project_attachment: str,) -> str:
        """Returns a fully-qualified runtime_project_attachment string."""
        return "projects/{project}/locations/{location}/runtimeProjectAttachments/{runtime_project_attachment}".format(project=project, location=location, runtime_project_attachment=runtime_project_attachment, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            RuntimeProjectAttachmentServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RuntimeProjectAttachmentServiceClient._read_environment_variables()
        self._client_cert_source = RuntimeProjectAttachmentServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
    ...
    def create_runtime_project_attachment(self,
    ...
    def get_runtime_project_attachment(self,
    ...
    def list_runtime_project_attachments(self,
    ...
    def delete_runtime_project_attachment(self,
    ...
    def lookup_runtime_project_attachment(self,

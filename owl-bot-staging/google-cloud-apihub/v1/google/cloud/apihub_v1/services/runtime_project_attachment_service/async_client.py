...
from .transports.base import RuntimeProjectAttachmentServiceTransport, DEFAULT_CLIENT_INFO
...
class RuntimeProjectAttachmentServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(RuntimeProjectAttachmentServiceClient).get_transport_class, type(RuntimeProjectAttachmentServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, RuntimeProjectAttachmentServiceTransport, Callable[..., RuntimeProjectAttachmentServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_runtime_project_attachment(self,
        ...
        has_flattened_params = any([parent, runtime_project_attachment, runtime_project_attachment_id])
    ...
    async def get_runtime_project_attachment(self,
    ...
    async def list_runtime_project_attachments(self,
    ...
    async def delete_runtime_project_attachment(self,
    ...
    async def lookup_runtime_project_attachment(self,

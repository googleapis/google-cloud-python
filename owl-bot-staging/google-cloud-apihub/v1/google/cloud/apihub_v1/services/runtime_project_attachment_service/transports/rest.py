...
from .base import RuntimeProjectAttachmentServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class RuntimeProjectAttachmentServiceRestTransport(RuntimeProjectAttachmentServiceTransport):

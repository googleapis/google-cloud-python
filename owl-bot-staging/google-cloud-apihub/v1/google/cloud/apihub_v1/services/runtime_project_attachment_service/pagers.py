...
class ListRuntimeProjectAttachmentsPager:
    """A pager for iterating through ``list_runtime_project_attachments`` requests.

    This class thinly wraps an initial
    :class:`google.cloud.apihub_v1.types.ListRuntimeProjectAttachmentsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``runtime_project_attachments`` field.

    If there are more pages, the ``__iter__`` method will make additional
    ``ListRuntimeProjectAttachments`` requests and continue to iterate
    through the ``runtime_project_attachments`` field on the
    corresponding responses.

    All the usual :class:`google.cloud.apihub_v1.types.ListRuntimeProjectAttachmentsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.apihub_v1.types.ListRuntimeProjectAttachmentsRequest):
                The initial request object.
            response (google.cloud.apihub_v1.types.ListRuntimeProjectAttachmentsResponse):
...
class ListRuntimeProjectAttachmentsAsyncPager:
    """A pager for iterating through ``list_runtime_project_attachments`` requests.

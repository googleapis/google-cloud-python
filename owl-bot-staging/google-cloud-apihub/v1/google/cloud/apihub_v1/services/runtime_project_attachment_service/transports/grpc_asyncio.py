...
class RuntimeProjectAttachmentServiceGrpcAsyncIOTransport(RuntimeProjectAttachmentServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_runtime_project_attachment: self._wrap_method(
                self.create_runtime_project_attachment,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_runtime_project_attachment: self._wrap_method(
            ...
            self.list_runtime_project_attachments: self._wrap_method(
            ...
            self.delete_runtime_project_attachment: self._wrap_method(
                self.delete_runtime_project_attachment,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.lookup_runtime_project_attachment: self._wrap_method(

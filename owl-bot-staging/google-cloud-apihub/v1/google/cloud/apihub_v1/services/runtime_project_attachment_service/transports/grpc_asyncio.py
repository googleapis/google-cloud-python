...
from .base import RuntimeProjectAttachmentServiceTransport, DEFAULT_CLIENT_INFO
from .grpc import RuntimeProjectAttachmentServiceGrpcTransport


class RuntimeProjectAttachmentServiceGrpcAsyncIOTransport(RuntimeProjectAttachmentServiceTransport):
    """gRPC AsyncIO backend transport for RuntimeProjectAttachmentService.
    ...
    @property
    def create_runtime_project_attachment(self) -> Callable[
            [runtime_project_attachment_service.CreateRuntimeProjectAttachmentRequest],
            Awaitable[runtime_project_attachment_service.RuntimeProjectAttachment]]:
        ...
        Returns:
            Callable[[~.CreateRuntimeProjectAttachmentRequest],
                    Awaitable[~.RuntimeProjectAttachment]]:
        ...
        if 'create_runtime_project_attachment' not in self._stubs:
            self._stubs['create_runtime_project_attachment'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_runtime_project_attachment(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetRuntimeProjectAttachmentRequest],
                    Awaitable[~.RuntimeProjectAttachment]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if 'get_runtime_project_attachment' not in self._stubs:
            self._stubs['get_runtime_project_attachment'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_runtime_project_attachments(self) -> Callable[
            [runtime_project_attachment_service.ListRuntimeProjectAttachmentsRequest],
            Awaitable[runtime_project_attachment_service.ListRuntimeProjectAttachmentsResponse]]:
        r"""Return a callable for the list runtime project
        ...
        Returns:
            Callable[[~.ListRuntimeProjectAttachmentsRequest],
                    Awaitable[~.ListRuntimeProjectAttachmentsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if 'list_runtime_project_attachments' not in self._stubs:
            self._stubs['list_runtime_project_attachments'] = self.grpc_channel.unary_unary(
    ...
    @property
    def delete_runtime_project_attachment(self) -> Callable[
        ...
        Returns:
            Callable[[~.DeleteRuntimeProjectAttachmentRequest],
                    Awaitable[~.Empty]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if 'delete_runtime_project_attachment' not in self._stubs:
            self._stubs['delete_runtime_project_attachment'] = self.grpc_channel.unary_unary(
    ...
    @property
    def lookup_runtime_project_attachment(self) -> Callable[
        ...
        r"""Return a callable for the lookup runtime project
        attachment method over gRPC.

        Look up a runtime project attachment. This API can be
        called in the context of any project.

        Returns:
            Callable[[~.LookupRuntimeProjectAttachmentRequest],
                    Awaitable[~.LookupRuntimeProjectAttachmentResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if 'lookup_runtime_project_attachment' not in self._stubs:
            self._stubs['lookup_runtime_project_attachment'] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_runtime_project_attachment: gapic_v1.method_async.wrap_method(
                self.create_runtime_project_attachment,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_runtime_project_attachment: gapic_v1.method_async.wrap_method(
            ...
            self.list_runtime_project_attachments: gapic_v1.method_async.wrap_method(
                self.list_runtime_project_attachments,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.delete_runtime_project_attachment: gapic_v1.method_async.wrap_method(
                self.delete_runtime_project_attachment,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.lookup_runtime_project_attachment: gapic_v1.method_async.wrap_method(
                self.lookup_runtime_project_attachment,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,

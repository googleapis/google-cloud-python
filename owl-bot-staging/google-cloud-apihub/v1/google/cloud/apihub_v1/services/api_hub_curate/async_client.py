...
class ApiHubCurateAsyncClient:
    ...
    parse_plugin_instance_path = staticmethod(ApiHubCurateClient.parse_plugin_instance_path)
    common_billing_account_path = staticmethod(ApiHubCurateClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ApiHubCurateClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(ApiHubCurateClient.parse_common_organization_path)
    common_project_path = staticmethod(ApiHubCurateClient.common_project_path)
    parse_common_project_path = staticmethod(ApiHubCurateClient.parse_common_project_path)
    common_location_path = staticmethod(ApiHubCurateClient.common_location_path)
    parse_common_location_path = staticmethod(ApiHubCurateClient.parse_common_location_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ApiHubCurateTransport, Callable[..., ApiHubCurateTransport]]] = "grpc_asyncio",
    ...
    async def create_curation(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_curation]
    ...
    async def get_curation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_curation]
    ...
    async def list_curations(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_curations]
    ...
    async def update_curation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_curation]
    ...
    async def delete_curation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_curation]

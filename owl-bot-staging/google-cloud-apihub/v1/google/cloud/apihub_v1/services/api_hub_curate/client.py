...
from .transports.base import ApiHubCurateTransport, DEFAULT_CLIENT_INFO
from .transports.rest import ApiHubCurateRestTransport


class ApiHubCurateClientMeta(type):
    """Metaclass for the ApiHubCurate client.
...
class ApiHubCurateClient(metaclass=ApiHubCurateClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ApiHubCurateClient: The constructed client.
        """
    ...
    def transport(self) -> ApiHubCurateTransport:
        ...
        Returns:
            ApiHubCurateTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def curation_path(project: str,location: str,curation: str,) -> str:
        """Returns a fully-qualified curation string."""
        return "projects/{project}/locations/{location}/curations/{curation}".format(project=project, location=location, curation=curation, )

    @staticmethod
    def parse_curation_path(path: str) -> Dict[str,str]:
        """Parses a curation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/curations/(?P<curation>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def plugin_instance_path(project: str,location: str,plugin: str,instance: str,) -> str:
        """Returns a fully-qualified plugin_instance string."""
        return "projects/{project}/locations/{location}/plugins/{plugin}/instances/{instance}".format(project=project, location=location, plugin=plugin, instance=instance, )

    @staticmethod
    def parse_plugin_instance_path(path: str) -> Dict[str,str]:
        """Parses a plugin_instance path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/plugins/(?P<plugin>.+?)/instances/(?P<instance>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ApiHubCurateClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ApiHubCurateClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ApiHubCurateClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ApiHubCurateTransport, Callable[..., ApiHubCurateTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ApiHubCurateClient._read_environment_variables()
        self._client_cert_source = ApiHubCurateClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ApiHubCurateClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ApiHubCurateTransport)
        if transport_provided:
            # transport is a ApiHubCurateTransport instance.
            ...
            self._transport = cast(ApiHubCurateTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            ApiHubCurateClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ApiHubCurateTransport], Callable[..., ApiHubCurateTransport]] = (
                ApiHubCurateClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ApiHubCurateTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.apihub_v1.ApiHubCurateClient`.",
                    extra = {
    ...
    def create_curation(self,
        ...
        .. code-block:: python
            ...
            def sample_create_curation():
                # Create a client
                client = apihub_v1.ApiHubCurateClient()
                ...
                # Make the request
                response = client.create_curation(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.apihub_v1.types.CreateCurationRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_curation]
    ...
    def get_curation(self,
        ...
        .. code-block:: python
            ...
            def sample_get_curation():
                ...
                # Make the request
                response = client.get_curation(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.apihub_v1.types.GetCurationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_curation]
    ...
    def list_curations(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.ListCurationsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_curations]
        ...
        response = pagers.ListCurationsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def update_curation(self,
        ...
        .. code-block:: python
            ...
            def sample_update_curation():
                ...
                # Make the request
                response = client.update_curation(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.apihub_v1.types.UpdateCurationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_curation]
    ...
    def delete_curation(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.DeleteCurationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_curation]
    ...
    def __enter__(self) -> "ApiHubCurateClient":
        return self

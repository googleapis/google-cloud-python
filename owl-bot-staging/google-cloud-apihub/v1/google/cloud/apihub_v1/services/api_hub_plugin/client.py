...
from .transports.grpc import ApiHubPluginGrpcTransport
from .transports.grpc_asyncio import ApiHubPluginGrpcAsyncIOTransport
from .transports.rest import ApiHubPluginRestTransport


class ApiHubPluginClientMeta(type):
    """Metaclass for the ApiHubPlugin client.
...
class ApiHubPluginClient(metaclass=ApiHubPluginClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ApiHubPluginClient: The constructed client.
        """
    ...
    def transport(self) -> ApiHubPluginTransport:
        ...
        Returns:
            ApiHubPluginTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def plugin_path(project: str,location: str,plugin: str,) -> str:
        """Returns a fully-qualified plugin string."""
        return "projects/{project}/locations/{location}/plugins/{plugin}".format(project=project, location=location, plugin=plugin, )

    @staticmethod
    def parse_plugin_path(path: str) -> Dict[str,str]:
        """Parses a plugin path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/plugins/(?P<plugin>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ApiHubPluginClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ApiHubPluginClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ApiHubPluginClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ApiHubPluginTransport, Callable[..., ApiHubPluginTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ApiHubPluginClient._read_environment_variables()
        self._client_cert_source = ApiHubPluginClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ApiHubPluginClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ApiHubPluginTransport)
        if transport_provided:
            # transport is a ApiHubPluginTransport instance.
            ...
            self._transport = cast(ApiHubPluginTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ApiHubPluginTransport], Callable[..., ApiHubPluginTransport]] = (
                ApiHubPluginClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ApiHubPluginTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.apihub_v1.ApiHubPluginClient`.",
                    extra = {
    ...
    def get_plugin(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.GetPluginRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_plugin]
    ...
    def enable_plugin(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.EnablePluginRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.enable_plugin]
    ...
    def disable_plugin(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.DisablePluginRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.disable_plugin]
    ...
    def create_plugin(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.CreatePluginRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_plugin]
    ...
    def list_plugins(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.ListPluginsRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_plugins]
        ...
        response = pagers.ListPluginsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def delete_plugin(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.DeletePluginRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_plugin]
    ...
    def create_plugin_instance(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.CreatePluginInstanceRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_plugin_instance]
    ...
    def execute_plugin_instance_action(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.ExecutePluginInstanceActionRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.execute_plugin_instance_action]
    ...
    def get_plugin_instance(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.GetPluginInstanceRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_plugin_instance]
    ...
    def list_plugin_instances(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListPluginInstancesPager:
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.ListPluginInstancesRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_plugin_instances]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListPluginInstancesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def enable_plugin_instance_action(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.EnablePluginInstanceActionRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.enable_plugin_instance_action]
    ...
    def disable_plugin_instance_action(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.DisablePluginInstanceActionRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.disable_plugin_instance_action]
    ...
    def update_plugin_instance(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.UpdatePluginInstanceRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_plugin_instance]
    ...
    def delete_plugin_instance(self,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.DeletePluginInstanceRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_plugin_instance]
    ...
    def __enter__(self) -> "ApiHubPluginClient":
        return self

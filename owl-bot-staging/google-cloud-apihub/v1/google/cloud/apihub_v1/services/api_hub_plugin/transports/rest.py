...
class ApiHubPluginRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_disable_plugin(self, request: plugin_service.DisablePluginRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[plugin_service.DisablePluginRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_enable_plugin(self, request: plugin_service.EnablePluginRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[plugin_service.EnablePluginRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_plugin(self, request: plugin_service.GetPluginRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[plugin_service.GetPluginRequest, Sequence[Tuple[str, str]]]:

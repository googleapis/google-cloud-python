...
from .base import ApiHubPluginTransport, DEFAULT_CLIENT_INFO
...
class ApiHubPluginGrpcTransport(ApiHubPluginTransport):
    ...
    @property
    def enable_plugin(self) -> Callable[
    ...
    @property
    def disable_plugin(self) -> Callable[
    ...
    @property
    def create_plugin(self) -> Callable[
    ...
    @property
    def list_plugins(self) -> Callable[
    ...
    @property
    def delete_plugin(self) -> Callable[
    ...
    @property
    def create_plugin_instance(self) -> Callable[
    ...
    @property
    def execute_plugin_instance_action(self) -> Callable[
    ...
    @property
    def get_plugin_instance(self) -> Callable[
    ...
    @property
    def list_plugin_instances(self) -> Callable[
    ...
    @property
    def enable_plugin_instance_action(self) -> Callable[
    ...
    @property
    def disable_plugin_instance_action(self) -> Callable[
    ...
    @property
    def update_plugin_instance(self) -> Callable[
    ...
    @property
    def delete_plugin_instance(self) -> Callable[

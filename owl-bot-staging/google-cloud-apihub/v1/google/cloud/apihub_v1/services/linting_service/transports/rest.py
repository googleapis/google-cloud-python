...
class LintingServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_style_guide(self, request: linting_service.GetStyleGuideRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[linting_service.GetStyleGuideRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_style_guide_contents(self, request: linting_service.GetStyleGuideContentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[linting_service.GetStyleGuideContentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_lint_spec(self, request: linting_service.LintSpecRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[linting_service.LintSpecRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_style_guide(self, request: linting_service.UpdateStyleGuideRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[linting_service.UpdateStyleGuideRequest, Sequence[Tuple[str, str]]]:

...
from .base import LintingServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class LintingServiceRestTransport(LintingServiceTransport):
    """REST backend transport for LintingService.
    ...
    class _GetStyleGuide(LintingServiceRestStub):
        def __hash__(self):
            return hash("GetStyleGuide")
    ...
    class _GetStyleGuideContents(LintingServiceRestStub):
        def __hash__(self):
            return hash("GetStyleGuideContents")
    ...
    class _LintSpec(LintingServiceRestStub):
        def __hash__(self):
            return hash("LintSpec")
    ...
    class _UpdateStyleGuide(LintingServiceRestStub):
        def __hash__(self):
            return hash("UpdateStyleGuide")
    ...
    class _GetLocation(LintingServiceRestStub):
        def __call__(self,
    ...
    class _ListLocations(LintingServiceRestStub):
        def __call__(self,
    ...
    class _CancelOperation(LintingServiceRestStub):
        def __call__(self,

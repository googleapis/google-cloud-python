...
from .transports.base import ApiHubTransport, DEFAULT_CLIENT_INFO
...
class ApiHubClient(metaclass=ApiHubClientMeta):
    ...
    @staticmethod
    def api_operation_path(project: str,location: str,api: str,version: str,operation: str,) -> str:
        """Returns a fully-qualified api_operation string."""
        return "projects/{project}/locations/{location}/apis/{api}/versions/{version}/operations/{operation}".format(project=project, location=location, api=api, version=version, operation=operation, )

    @staticmethod
    def parse_api_operation_path(path: str) -> Dict[str,str]:
        """Parses a api_operation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apis/(?P<api>.+?)/versions/(?P<version>.+?)/operations/(?P<operation>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def attribute_path(project: str,location: str,attribute: str,) -> str:
        """Returns a fully-qualified attribute string."""
        return "projects/{project}/locations/{location}/attributes/{attribute}".format(project=project, location=location, attribute=attribute, )

    @staticmethod
    def parse_attribute_path(path: str) -> Dict[str,str]:
        """Parses a attribute path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/attributes/(?P<attribute>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def definition_path(project: str,location: str,api: str,version: str,definition: str,) -> str:
        """Returns a fully-qualified definition string."""
        return "projects/{project}/locations/{location}/apis/{api}/versions/{version}/definitions/{definition}".format(project=project, location=location, api=api, version=version, definition=definition, )

    @staticmethod
    def parse_definition_path(path: str) -> Dict[str,str]:
        """Parses a definition path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apis/(?P<api>.+?)/versions/(?P<version>.+?)/definitions/(?P<definition>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def deployment_path(project: str,location: str,deployment: str,) -> str:
        """Returns a fully-qualified deployment string."""
        return "projects/{project}/locations/{location}/deployments/{deployment}".format(project=project, location=location, deployment=deployment, )

    @staticmethod
    def parse_deployment_path(path: str) -> Dict[str,str]:
        """Parses a deployment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/deployments/(?P<deployment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def external_api_path(project: str,location: str,external_api: str,) -> str:
        """Returns a fully-qualified external_api string."""
        return "projects/{project}/locations/{location}/externalApis/{external_api}".format(project=project, location=location, external_api=external_api, )

    @staticmethod
    def parse_external_api_path(path: str) -> Dict[str,str]:
        """Parses a external_api path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/externalApis/(?P<external_api>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def spec_path(project: str,location: str,api: str,version: str,spec: str,) -> str:
    ...
    @staticmethod
    def version_path(project: str,location: str,api: str,version: str,) -> str:
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ApiHubClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ApiHubTransport, Callable[..., ApiHubTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ApiHubClient._read_environment_variables()
        self._client_cert_source = ApiHubClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ApiHubClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ApiHubTransport], Callable[..., ApiHubTransport]] = (

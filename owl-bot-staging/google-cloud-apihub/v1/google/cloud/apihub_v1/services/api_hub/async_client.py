...
class ApiHubAsyncClient:
    ...
    async def get_spec_contents(self,
    ...
    async def create_api_operation(self,
    ...
    async def get_api_operation(self,
    ...
    async def list_api_operations(self,
    ...
    async def update_api_operation(self,
    ...
    async def delete_api_operation(self,
    ...
    async def create_attribute(self,
    ...
    async def create_external_api(self,
    ...
    async def get_external_api(self,
    ...
    async def update_external_api(self,
    ...
    async def delete_external_api(self,
    ...
    async def list_external_apis(self,

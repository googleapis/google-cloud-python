...
from .base import ApiHubTransport, DEFAULT_CLIENT_INFO
from .grpc import ApiHubGrpcTransport


class ApiHubGrpcAsyncIOTransport(ApiHubTransport):
    """gRPC AsyncIO backend transport for ApiHub.
    ...
    def list_apis(self) -> Callable[
            ...
            Awaitable[apihub_service.ListApisResponse]]:
    ...
    def create_version(self) -> Callable[
            ...
            Awaitable[common_fields.Version]]:
    ...
    @property
    def create_spec(self) -> Callable[
            [apihub_service.CreateSpecRequest],
            Awaitable[common_fields.Spec]]:
    ...
    @property
    def get_spec_contents(self) -> Callable[
            [apihub_service.GetSpecContentsRequest],
            Awaitable[common_fields.SpecContents]]:
    ...
    @property
    def get_api_operation(self) -> Callable[
    ...
    @property
    def list_api_operations(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListApiOperationsRequest],
                    Awaitable[~.ListApiOperationsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    @property
    def get_definition(self) -> Callable[
            [apihub_service.GetDefinitionRequest],
            Awaitable[common_fields.Definition]]:
    ...
    def create_deployment(self) -> Callable[
            ...
            Awaitable[common_fields.Deployment]]:
    ...
    @property
    def create_attribute(self) -> Callable[
            [apihub_service.CreateAttributeRequest],
            Awaitable[common_fields.Attribute]]:
    ...
    @property
    def get_attribute(self) -> Callable[
    ...
    @property
    def delete_attribute(self) -> Callable[
    ...
    @property
    def list_attributes(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListAttributesRequest],
                    Awaitable[~.ListAttributesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    @property
    def search_resources(self) -> Callable[
        ...
        Returns:
            Callable[[~.SearchResourcesRequest],
                    Awaitable[~.SearchResourcesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    @property
    def create_external_api(self) -> Callable[
            [apihub_service.CreateExternalApiRequest],
            Awaitable[common_fields.ExternalApi]]:
    ...
    @property
    def get_external_api(self) -> Callable[
    ...
    @property
    def update_external_api(self) -> Callable[
    ...
    @property
    def delete_external_api(self) -> Callable[
    ...
    @property
    def list_external_apis(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListExternalApisRequest],
                    Awaitable[~.ListExternalApisResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.create_spec: gapic_v1.method_async.wrap_method(
                self.create_spec,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_spec: gapic_v1.method_async.wrap_method(
                self.get_spec,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.get_spec_contents: gapic_v1.method_async.wrap_method(
            ...
            self.list_specs: gapic_v1.method_async.wrap_method(
                self.list_specs,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.update_spec: gapic_v1.method_async.wrap_method(
                self.update_spec,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_spec: gapic_v1.method_async.wrap_method(
                self.delete_spec,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_api_operation: gapic_v1.method_async.wrap_method(
            ...
            self.list_api_operations: gapic_v1.method_async.wrap_method(
            ...
            self.get_definition: gapic_v1.method_async.wrap_method(
                self.get_definition,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.create_attribute: gapic_v1.method_async.wrap_method(
                self.create_attribute,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_attribute: gapic_v1.method_async.wrap_method(
                self.get_attribute,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.update_attribute: gapic_v1.method_async.wrap_method(
                self.update_attribute,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_attribute: gapic_v1.method_async.wrap_method(
                self.delete_attribute,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_attributes: gapic_v1.method_async.wrap_method(
            ...
            self.search_resources: gapic_v1.method_async.wrap_method(
            ...
            self.create_external_api: gapic_v1.method_async.wrap_method(
                self.create_external_api,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_external_api: gapic_v1.method_async.wrap_method(
            ...
            self.update_external_api: gapic_v1.method_async.wrap_method(
                self.update_external_api,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_external_api: gapic_v1.method_async.wrap_method(
                self.delete_external_api,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_external_apis: gapic_v1.method_async.wrap_method(

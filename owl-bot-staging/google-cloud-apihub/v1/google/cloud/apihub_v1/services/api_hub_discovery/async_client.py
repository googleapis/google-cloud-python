...
class ApiHubDiscoveryAsyncClient:
    ...
    async def list_discovered_api_observations(self,
    ...
    async def get_discovered_api_observation(self,
    ...
    async def list_discovered_api_operations(self,
    ...
    async def get_discovered_api_operation(self,

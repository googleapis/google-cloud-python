...
class ApiHubDependenciesTransport(abc.ABC):
    """Abstract transport class for ApiHubDependencies."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_dependency: gapic_v1.method.wrap_method(
                self.create_dependency,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_dependency: gapic_v1.method.wrap_method(
                self.get_dependency,
            ...
            self.update_dependency: gapic_v1.method.wrap_method(
                self.update_dependency,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_dependency: gapic_v1.method.wrap_method(
                self.delete_dependency,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_dependencies: gapic_v1.method.wrap_method(
    ...
    def create_dependency(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[common_fields.Dependency]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def update_dependency(self) -> Callable[
    ...
    @property
    def delete_dependency(self) -> Callable[
    ...
    @property
    def list_dependencies(self) -> Callable[
            [apihub_service.ListDependenciesRequest],
            Union[
                apihub_service.ListDependenciesResponse,
                Awaitable[apihub_service.ListDependenciesResponse]
            ]]:
        raise NotImplementedError()

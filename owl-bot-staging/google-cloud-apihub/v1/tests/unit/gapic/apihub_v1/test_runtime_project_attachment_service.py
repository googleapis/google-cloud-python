...
def test_transport_kind_grpc_asyncio():
    transport = RuntimeProjectAttachmentServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_create_runtime_project_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "post_create_runtime_project_attachment_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = runtime_project_attachment_service.RuntimeProjectAttachment.to_json(runtime_project_attachment_service.RuntimeProjectAttachment())
...
def test_get_runtime_project_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "post_get_runtime_project_attachment_with_metadata") as post_with_metadata, \
...
def test_list_runtime_project_attachments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "post_list_runtime_project_attachments_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = runtime_project_attachment_service.ListRuntimeProjectAttachmentsResponse.to_json(runtime_project_attachment_service.ListRuntimeProjectAttachmentsResponse())
        req.return_value.content = return_value
...
def test_lookup_runtime_project_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "post_lookup_runtime_project_attachment_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = runtime_project_attachment_service.LookupRuntimeProjectAttachmentResponse.to_json(runtime_project_attachment_service.LookupRuntimeProjectAttachmentResponse())
        req.return_value.content = return_value

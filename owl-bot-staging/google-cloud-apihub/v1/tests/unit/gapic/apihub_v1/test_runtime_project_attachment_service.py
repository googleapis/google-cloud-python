...
from google.cloud.apihub_v1.services.runtime_project_attachment_service import RuntimeProjectAttachmentServiceAsyncClient
from google.cloud.apihub_v1.services.runtime_project_attachment_service import RuntimeProjectAttachmentServiceClient
from google.cloud.apihub_v1.services.runtime_project_attachment_service import pagers
from google.cloud.apihub_v1.services.runtime_project_attachment_service import transports
...
@mock.patch.object(RuntimeProjectAttachmentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RuntimeProjectAttachmentServiceClient))
@mock.patch.object(RuntimeProjectAttachmentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RuntimeProjectAttachmentServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert RuntimeProjectAttachmentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RuntimeProjectAttachmentServiceClient.DEFAULT_MTLS_ENDPOINT
    assert RuntimeProjectAttachmentServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RuntimeProjectAttachmentServiceClient._get_api_endpoint(None, None, default_universe, "always") == RuntimeProjectAttachmentServiceClient.DEFAULT_MTLS_ENDPOINT
    assert RuntimeProjectAttachmentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RuntimeProjectAttachmentServiceClient.DEFAULT_MTLS_ENDPOINT
...
@mock.patch.object(RuntimeProjectAttachmentServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RuntimeProjectAttachmentServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (RuntimeProjectAttachmentServiceAsyncClient, transports.RuntimeProjectAttachmentServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_runtime_project_attachment_service_client_client_options_from_dict():
    with mock.patch('google.cloud.apihub_v1.services.runtime_project_attachment_service.transports.RuntimeProjectAttachmentServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_runtime_project_attachment(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_runtime_project_attachment),
            '__call__') as call:
...
async def test_create_runtime_project_attachment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_runtime_project_attachment] = mock_object
...
@pytest.mark.asyncio
async def test_create_runtime_project_attachment_async(transport: str = 'grpc_asyncio', request_type=runtime_project_attachment_service.CreateRuntimeProjectAttachmentRequest):
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_runtime_project_attachment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_runtime_project_attachment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = runtime_project_attachment_service.RuntimeProjectAttachment(
            name='name_value',
...
async def test_get_runtime_project_attachment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_runtime_project_attachment] = mock_object
...
@pytest.mark.asyncio
async def test_get_runtime_project_attachment_async(transport: str = 'grpc_asyncio', request_type=runtime_project_attachment_service.GetRuntimeProjectAttachmentRequest):
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_list_runtime_project_attachments_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_runtime_project_attachments] = mock_object
...
@pytest.mark.asyncio
async def test_list_runtime_project_attachments_async(transport: str = 'grpc_asyncio', request_type=runtime_project_attachment_service.ListRuntimeProjectAttachmentsRequest):
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_runtime_project_attachments_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, runtime_project_attachment_service.RuntimeProjectAttachment)
                   for i in results)
...
async def test_list_runtime_project_attachments_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_runtime_project_attachments(request={},)
...
def test_delete_runtime_project_attachment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_runtime_project_attachment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_delete_runtime_project_attachment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_runtime_project_attachment] = mock_object
...
@pytest.mark.asyncio
async def test_delete_runtime_project_attachment_async(transport: str = 'grpc_asyncio', request_type=runtime_project_attachment_service.DeleteRuntimeProjectAttachmentRequest):
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_lookup_runtime_project_attachment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.lookup_runtime_project_attachment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_lookup_runtime_project_attachment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.lookup_runtime_project_attachment] = mock_object
...
@pytest.mark.asyncio
async def test_lookup_runtime_project_attachment_async(transport: str = 'grpc_asyncio', request_type=runtime_project_attachment_service.LookupRuntimeProjectAttachmentRequest):
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_runtime_project_attachment_rest(request_type):
    ...
    request_init["runtime_project_attachment"] = {'name': 'name_value', 'runtime_project': 'runtime_project_value', 'create_time': {'seconds': 751, 'nanos': 543}}
...
def test_create_runtime_project_attachment_rest_required_fields(request_type=runtime_project_attachment_service.CreateRuntimeProjectAttachmentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_runtime_project_attachment._get_unset_required_fields(jsonified_request)
...
def test_create_runtime_project_attachment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("runtimeProjectAttachmentId", )) & set(("parent", "runtimeProjectAttachmentId", "runtimeProjectAttachment", )))
...
def test_create_runtime_project_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "post_create_runtime_project_attachment") as post, \
         mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "pre_create_runtime_project_attachment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = runtime_project_attachment_service.CreateRuntimeProjectAttachmentRequest.pb(runtime_project_attachment_service.CreateRuntimeProjectAttachmentRequest())
        ...
        req.return_value._content = runtime_project_attachment_service.RuntimeProjectAttachment.to_json(runtime_project_attachment_service.RuntimeProjectAttachment())
        ...
        client.create_runtime_project_attachment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_runtime_project_attachment_rest_bad_request(transport: str = 'rest', request_type=runtime_project_attachment_service.CreateRuntimeProjectAttachmentRequest):
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_runtime_project_attachment_rest_required_fields(request_type=runtime_project_attachment_service.GetRuntimeProjectAttachmentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_runtime_project_attachment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_runtime_project_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "post_get_runtime_project_attachment") as post, \
         mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "pre_get_runtime_project_attachment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = runtime_project_attachment_service.GetRuntimeProjectAttachmentRequest.pb(runtime_project_attachment_service.GetRuntimeProjectAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_runtime_project_attachment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_runtime_project_attachment_rest_bad_request(transport: str = 'rest', request_type=runtime_project_attachment_service.GetRuntimeProjectAttachmentRequest):
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_runtime_project_attachments_rest_required_fields(request_type=runtime_project_attachment_service.ListRuntimeProjectAttachmentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_runtime_project_attachments._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_runtime_project_attachments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "post_list_runtime_project_attachments") as post, \
         mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "pre_list_runtime_project_attachments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = runtime_project_attachment_service.ListRuntimeProjectAttachmentsRequest.pb(runtime_project_attachment_service.ListRuntimeProjectAttachmentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = runtime_project_attachment_service.ListRuntimeProjectAttachmentsResponse.to_json(runtime_project_attachment_service.ListRuntimeProjectAttachmentsResponse())
        ...
        client.list_runtime_project_attachments(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_runtime_project_attachments_rest_bad_request(transport: str = 'rest', request_type=runtime_project_attachment_service.ListRuntimeProjectAttachmentsRequest):
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_runtime_project_attachment_rest_required_fields(request_type=runtime_project_attachment_service.DeleteRuntimeProjectAttachmentRequest):
    transport_class = transports.RuntimeProjectAttachmentServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_runtime_project_attachment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_runtime_project_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "pre_delete_runtime_project_attachment") as pre:
        pre.assert_not_called()
        pb_message = runtime_project_attachment_service.DeleteRuntimeProjectAttachmentRequest.pb(runtime_project_attachment_service.DeleteRuntimeProjectAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_runtime_project_attachment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_runtime_project_attachment_rest_bad_request(transport: str = 'rest', request_type=runtime_project_attachment_service.DeleteRuntimeProjectAttachmentRequest):
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_lookup_runtime_project_attachment_rest_required_fields(request_type=runtime_project_attachment_service.LookupRuntimeProjectAttachmentRequest):
    transport_class = transports.RuntimeProjectAttachmentServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).lookup_runtime_project_attachment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_lookup_runtime_project_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "post_lookup_runtime_project_attachment") as post, \
         mock.patch.object(transports.RuntimeProjectAttachmentServiceRestInterceptor, "pre_lookup_runtime_project_attachment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = runtime_project_attachment_service.LookupRuntimeProjectAttachmentRequest.pb(runtime_project_attachment_service.LookupRuntimeProjectAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = runtime_project_attachment_service.LookupRuntimeProjectAttachmentResponse.to_json(runtime_project_attachment_service.LookupRuntimeProjectAttachmentResponse())
        ...
        client.lookup_runtime_project_attachment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_lookup_runtime_project_attachment_rest_bad_request(transport: str = 'rest', request_type=runtime_project_attachment_service.LookupRuntimeProjectAttachmentRequest):
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = RuntimeProjectAttachmentServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_runtime_project_attachment_service_base_transport():
    ...
    with mock.patch('google.cloud.apihub_v1.services.runtime_project_attachment_service.transports.RuntimeProjectAttachmentServiceTransport.__init__') as Transport:
...
def test_runtime_project_attachment_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.apihub_v1.services.runtime_project_attachment_service.transports.RuntimeProjectAttachmentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_runtime_project_attachment_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.apihub_v1.services.runtime_project_attachment_service.transports.RuntimeProjectAttachmentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RuntimeProjectAttachmentServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.RuntimeProjectAttachmentServiceGrpcTransport, transports.RuntimeProjectAttachmentServiceGrpcAsyncIOTransport])
...
def test_runtime_project_attachment_path():
    ...
    expected = "projects/{project}/locations/{location}/runtimeProjectAttachments/{runtime_project_attachment}".format(project=project, location=location, runtime_project_attachment=runtime_project_attachment, )

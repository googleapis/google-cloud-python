...
def test_get_plugin_empty_call():
...
@pytest.mark.asyncio
async def test_get_plugin_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
async def test_get_plugin_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.get_plugin] = mock_object
...
def test_enable_plugin_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ApiHubPluginClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_enable_plugin_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ApiHubPluginAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_enable_plugin_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.enable_plugin] = mock_object
...
def test_disable_plugin_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ApiHubPluginClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_disable_plugin_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ApiHubPluginAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_disable_plugin_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.disable_plugin] = mock_object
...
def test_get_plugin_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = plugin_service.Plugin.to_json(plugin_service.Plugin())
...
def test_get_plugin_rest_bad_request(transport: str = 'rest', request_type=plugin_service.GetPluginRequest):
    client = ApiHubPluginClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_disable_plugin_rest_bad_request(transport: str = 'rest', request_type=plugin_service.DisablePluginRequest):
    client = ApiHubPluginClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

...
from google.cloud.apihub_v1.services.api_hub_plugin import ApiHubPluginAsyncClient
from google.cloud.apihub_v1.services.api_hub_plugin import ApiHubPluginClient
from google.cloud.apihub_v1.services.api_hub_plugin import pagers
from google.cloud.apihub_v1.services.api_hub_plugin import transports
...
@pytest.mark.parametrize("client_class", [
    ApiHubPluginClient, ApiHubPluginAsyncClient
])
...
def test_get_plugin(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.get_plugin),
            '__call__') as call:
...
def test_enable_plugin(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.enable_plugin),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = plugin_service.Plugin(
            name='name_value',
...
def test_disable_plugin(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.disable_plugin),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = plugin_service.Plugin(
            name='name_value',
...
def test_create_plugin(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_plugin),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = plugin_service.Plugin(
            name='name_value',
...
def test_list_plugins(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_plugins),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_plugins_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, plugin_service.Plugin)
                   for i in results)
...
async def test_list_plugins_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_plugins(request={},)
...
def test_delete_plugin(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_plugin),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_plugin_instance(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_plugin_instance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_execute_plugin_instance_action(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.execute_plugin_instance_action),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_plugin_instance(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_plugin_instance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_plugin_instances_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, plugin_service.PluginInstance)
                   for i in results)
...
async def test_list_plugin_instances_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_plugin_instances(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_enable_plugin_instance_action(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.enable_plugin_instance_action),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_disable_plugin_instance_action(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.disable_plugin_instance_action),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_plugin_instance(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_plugin_instance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = plugin_service.PluginInstance(
            name='name_value',
...
def test_delete_plugin_instance(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_plugin_instance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_plugin_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pluginId", )) & set(("parent", "plugin", )))
...
def test_create_plugin_instance_rest_required_fields(request_type=plugin_service.CreatePluginInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_plugin_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_plugin_instance_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pluginInstanceId", )) & set(("parent", "pluginInstance", )))
...
def test_execute_plugin_instance_action_rest_required_fields(request_type=plugin_service.ExecutePluginInstanceActionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).execute_plugin_instance_action._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_execute_plugin_instance_action_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "actionExecutionDetail", )))
...
def test_get_plugin_instance_rest_required_fields(request_type=plugin_service.GetPluginInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_plugin_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_plugin_instances_rest_required_fields(request_type=plugin_service.ListPluginInstancesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_plugin_instances._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_enable_plugin_instance_action_rest_required_fields(request_type=plugin_service.EnablePluginInstanceActionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).enable_plugin_instance_action._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_enable_plugin_instance_action_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "actionId", )))
...
def test_disable_plugin_instance_action_rest_required_fields(request_type=plugin_service.DisablePluginInstanceActionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).disable_plugin_instance_action._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_plugin_instance_rest_required_fields(request_type=plugin_service.UpdatePluginInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_plugin_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_plugin_instance_rest_required_fields(request_type=plugin_service.DeletePluginInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_plugin_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_plugin_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_get_plugin") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_get_plugin_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_get_plugin") as pre:
        ...
        client.get_plugin(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_enable_plugin_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_enable_plugin") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_enable_plugin_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_enable_plugin") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.enable_plugin(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_disable_plugin_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_disable_plugin") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_disable_plugin_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_disable_plugin") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.disable_plugin(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_plugin_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_create_plugin") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_create_plugin_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_create_plugin") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_plugin(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_plugins_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_list_plugins") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_list_plugins_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_list_plugins") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_plugins(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_plugin_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_delete_plugin") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_delete_plugin_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_delete_plugin") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_plugin(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_plugin_instance_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/plugins/sample3'}
    request_init["plugin_instance"] = {'name': 'name_value', 'display_name': 'display_name_value', 'auth_config': {'google_service_account_config': {'service_account': 'service_account_value'}, 'user_password_config': {'username': 'username_value', 'password': {'secret_version': 'secret_version_value'}}, 'api_key_config': {'name': 'name_value', 'api_key': {}, 'http_element_location': 1}, 'oauth2_client_credentials_config': {'client_id': 'client_id_value', 'client_secret': {}}, 'auth_type': 1}, 'additional_config': {}, 'state': 1, 'error_message': 'error_message_value', 'actions': [{'hub_instance_action': {'current_execution_state': 1, 'last_execution': {'result': 1, 'error_message': 'error_message_value', 'start_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}}}, 'action_id': 'action_id_value', 'state': 1, 'schedule_cron_expression': 'schedule_cron_expression_value', 'curation_config': {'custom_curation': {'curation': 'curation_value'}, 'curation_type': 1}, 'schedule_time_zone': 'schedule_time_zone_value', 'service_account': 'service_account_value', 'resource_config': {'action_type': 1, 'pubsub_topic': 'pubsub_topic_value'}}], 'create_time': {}, 'update_time': {}, 'source_project_id': 'source_project_id_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_plugin_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_create_plugin_instance") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_create_plugin_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_create_plugin_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_plugin_instance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_execute_plugin_instance_action_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_execute_plugin_instance_action") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_execute_plugin_instance_action_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_execute_plugin_instance_action") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.execute_plugin_instance_action(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_plugin_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_get_plugin_instance") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_get_plugin_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_get_plugin_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_plugin_instance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_plugin_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_list_plugin_instances") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_list_plugin_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_list_plugin_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_plugin_instances(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_enable_plugin_instance_action_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_enable_plugin_instance_action") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_enable_plugin_instance_action_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_enable_plugin_instance_action") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.enable_plugin_instance_action(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_disable_plugin_instance_action_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_disable_plugin_instance_action") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_disable_plugin_instance_action_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_disable_plugin_instance_action") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.disable_plugin_instance_action(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_plugin_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_update_plugin_instance") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_update_plugin_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_update_plugin_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_plugin_instance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_plugin_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_delete_plugin_instance") as post, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "post_delete_plugin_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiHubPluginRestInterceptor, "pre_delete_plugin_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_plugin_instance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_api_hub_plugin_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.apihub_v1.services.api_hub_plugin.transports.ApiHubPluginTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_api_hub_plugin_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.apihub_v1.services.api_hub_plugin.transports.ApiHubPluginTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ApiHubPluginTransport()
        adc.assert_called_once()
...
def test_api_hub_plugin_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ApiHubPluginGrpcTransport, transports.ApiHubPluginGrpcAsyncIOTransport])
def test_api_hub_plugin_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_plugin_path():
    ...
    location = "mussel"
    plugin = "winkle"
    expected = "projects/{project}/locations/{location}/plugins/{plugin}".format(project=project, location=location, plugin=plugin, )

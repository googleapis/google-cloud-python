...
def test_create_api_rest_bad_request(transport: str = 'rest', request_type=apihub_service.CreateApiRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_api_rest_bad_request(transport: str = 'rest', request_type=apihub_service.GetApiRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_apis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apihub_service.ListApisResponse.to_json(apihub_service.ListApisResponse())
...
def test_list_apis_rest_bad_request(transport: str = 'rest', request_type=apihub_service.ListApisRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_api_rest_bad_request(transport: str = 'rest', request_type=apihub_service.UpdateApiRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = common_fields.Version.to_json(common_fields.Version())
...
def test_create_version_rest_bad_request(transport: str = 'rest', request_type=apihub_service.CreateVersionRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_version_rest_bad_request(transport: str = 'rest', request_type=apihub_service.GetVersionRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apihub_service.ListVersionsResponse.to_json(apihub_service.ListVersionsResponse())
...
def test_list_versions_rest_bad_request(transport: str = 'rest', request_type=apihub_service.ListVersionsRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_version_rest_bad_request(transport: str = 'rest', request_type=apihub_service.UpdateVersionRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_version_rest_bad_request(transport: str = 'rest', request_type=apihub_service.DeleteVersionRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_spec_rest_bad_request(transport: str = 'rest', request_type=apihub_service.CreateSpecRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_spec_rest_bad_request(transport: str = 'rest', request_type=apihub_service.GetSpecRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_spec_contents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = common_fields.SpecContents.to_json(common_fields.SpecContents())
...
def test_get_spec_contents_rest_bad_request(transport: str = 'rest', request_type=apihub_service.GetSpecContentsRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_specs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apihub_service.ListSpecsResponse.to_json(apihub_service.ListSpecsResponse())
...
def test_list_specs_rest_bad_request(transport: str = 'rest', request_type=apihub_service.ListSpecsRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_spec_rest_bad_request(transport: str = 'rest', request_type=apihub_service.UpdateSpecRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_api_operation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = common_fields.ApiOperation.to_json(common_fields.ApiOperation())
...
def test_get_api_operation_rest_bad_request(transport: str = 'rest', request_type=apihub_service.GetApiOperationRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_api_operations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apihub_service.ListApiOperationsResponse.to_json(apihub_service.ListApiOperationsResponse())
...
def test_list_api_operations_rest_bad_request(transport: str = 'rest', request_type=apihub_service.ListApiOperationsRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_definition_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = common_fields.Definition.to_json(common_fields.Definition())
...
def test_get_definition_rest_bad_request(transport: str = 'rest', request_type=apihub_service.GetDefinitionRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = common_fields.Deployment.to_json(common_fields.Deployment())
...
def test_create_deployment_rest_bad_request(transport: str = 'rest', request_type=apihub_service.CreateDeploymentRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_deployment_rest_bad_request(transport: str = 'rest', request_type=apihub_service.GetDeploymentRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apihub_service.ListDeploymentsResponse.to_json(apihub_service.ListDeploymentsResponse())
...
def test_list_deployments_rest_bad_request(transport: str = 'rest', request_type=apihub_service.ListDeploymentsRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_deployment_rest_bad_request(transport: str = 'rest', request_type=apihub_service.UpdateDeploymentRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_deployment_rest_bad_request(transport: str = 'rest', request_type=apihub_service.DeleteDeploymentRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_attribute_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = common_fields.Attribute.to_json(common_fields.Attribute())
...
def test_create_attribute_rest_bad_request(transport: str = 'rest', request_type=apihub_service.CreateAttributeRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_attribute_rest_bad_request(transport: str = 'rest', request_type=apihub_service.GetAttributeRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_attribute_rest_bad_request(transport: str = 'rest', request_type=apihub_service.UpdateAttributeRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_attribute_rest_bad_request(transport: str = 'rest', request_type=apihub_service.DeleteAttributeRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_attributes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apihub_service.ListAttributesResponse.to_json(apihub_service.ListAttributesResponse())
...
def test_list_attributes_rest_bad_request(transport: str = 'rest', request_type=apihub_service.ListAttributesRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_resources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apihub_service.SearchResourcesResponse.to_json(apihub_service.SearchResourcesResponse())
...
def test_search_resources_rest_bad_request(transport: str = 'rest', request_type=apihub_service.SearchResourcesRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_external_api_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = common_fields.ExternalApi.to_json(common_fields.ExternalApi())
...
def test_create_external_api_rest_bad_request(transport: str = 'rest', request_type=apihub_service.CreateExternalApiRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_external_api_rest_bad_request(transport: str = 'rest', request_type=apihub_service.GetExternalApiRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_external_api_rest_bad_request(transport: str = 'rest', request_type=apihub_service.UpdateExternalApiRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_external_api_rest_bad_request(transport: str = 'rest', request_type=apihub_service.DeleteExternalApiRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_external_apis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apihub_service.ListExternalApisResponse.to_json(apihub_service.ListExternalApisResponse())
...
def test_list_external_apis_rest_bad_request(transport: str = 'rest', request_type=apihub_service.ListExternalApisRequest):
    client = ApiHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

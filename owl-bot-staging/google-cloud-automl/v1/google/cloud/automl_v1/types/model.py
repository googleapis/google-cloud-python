...
class Model(proto.Message):
    ...
    image_classification_model_metadata: image.ImageClassificationModelMetadata = proto.Field(
        proto.MESSAGE,
        number=13,
        oneof='model_metadata',
        message=image.ImageClassificationModelMetadata,
    )
    text_classification_model_metadata: text.TextClassificationModelMetadata = proto.Field(
        proto.MESSAGE,
        number=14,
        oneof='model_metadata',
        message=text.TextClassificationModelMetadata,
    )
    image_object_detection_model_metadata: image.ImageObjectDetectionModelMetadata = proto.Field(
        proto.MESSAGE,
        number=20,
        oneof='model_metadata',

...
class Dataset(proto.Message):
    ...
    image_classification_dataset_metadata: image.ImageClassificationDatasetMetadata = proto.Field(
        proto.MESSAGE,
        number=24,
        oneof='dataset_metadata',
        message=image.ImageClassificationDatasetMetadata,
    )
    text_classification_dataset_metadata: text.TextClassificationDatasetMetadata = proto.Field(
        proto.MESSAGE,
        number=25,
        oneof='dataset_metadata',

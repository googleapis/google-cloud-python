...
def test_predict_rest_required_fields(request_type=prediction_service.PredictRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).predict._get_unset_required_fields(jsonified_request)
...
def test_predict_rest_unset_required_fields():
    transport = transports.PredictionServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_batch_predict_rest_required_fields(request_type=prediction_service.BatchPredictRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_predict._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

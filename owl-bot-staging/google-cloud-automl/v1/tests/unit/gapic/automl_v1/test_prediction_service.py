...
def test_predict_flattened():
    ...
    with mock.patch.object(
        ...
        assert arg == mock_val
        arg = args[0].payload
        mock_val = data_items.ExamplePayload(image=data_items.Image(image_bytes=b'image_bytes_blob'))
        assert arg == mock_val
        arg = args[0].params
...
def test_batch_predict_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_batch_predict_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_predict in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_predict] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_predict_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PredictionServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_predict in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_predict] = mock_rpc
...
def test_batch_predict_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = io.BatchPredictInputConfig(gcs_source=io.GcsSource(input_uris=['input_uris_value']))
        assert arg == mock_val
        arg = args[0].output_config
        mock_val = io.BatchPredictOutputConfig(gcs_destination=io.GcsDestination(output_uri_prefix='output_uri_prefix_value'))
        assert arg == mock_val
        arg = args[0].params
        mock_val = {'key_value': 'value_value'}
        assert arg == mock_val
...
def test_predict_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/models/*}:predict" % client.transport._host, args[1])
...
def test_batch_predict_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = PredictionServiceClient(
...
def test_batch_predict_rest_required_fields(request_type=prediction_service.BatchPredictRequest):
    transport_class = transports.PredictionServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_predict._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_predict_rest_unset_required_fields():
    transport = transports.PredictionServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.batch_predict._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", "inputConfig", "outputConfig", )))


def test_batch_predict_rest_flattened():
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/models/*}:batchPredict" % client.transport._host, args[1])


def test_batch_predict_rest_flattened_error(transport: str = 'rest'):
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_predict_empty_call_grpc():
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.batch_predict(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_predict_empty_call_grpc_asyncio():
    client = PredictionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_predict(request=None)
...
def test_batch_predict_rest_bad_request(request_type=prediction_service.BatchPredictRequest):
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_predict_rest_call_success(request_type):
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_batch_predict_rest_interceptors(null_interceptor):
    transport = transports.PredictionServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.PredictionServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PredictionServiceRestInterceptor, "post_batch_predict") as post, \
        mock.patch.object(transports.PredictionServiceRestInterceptor, "post_batch_predict_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PredictionServiceRestInterceptor, "pre_batch_predict") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = prediction_service.BatchPredictRequest.pb(prediction_service.BatchPredictRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.batch_predict(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_predict_empty_call_rest():
    client = PredictionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_prediction_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.automl_v1.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_prediction_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.automl_v1.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PredictionServiceTransport()
        adc.assert_called_once()
...
def test_prediction_service_client_transport_session_collision(transport_name):
    ...
    session1 = client1.transport.batch_predict._session
    session2 = client2.transport.batch_predict._session
    assert session1 != session2

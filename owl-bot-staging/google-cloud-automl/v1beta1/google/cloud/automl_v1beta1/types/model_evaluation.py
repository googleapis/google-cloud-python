...
class ModelEvaluation(proto.Message):
    ...
    translation_evaluation_metrics: translation.TranslationEvaluationMetrics = proto.Field(
        proto.MESSAGE,
        number=9,
        oneof='metrics',
    ...
    text_sentiment_evaluation_metrics: text_sentiment.TextSentimentEvaluationMetrics = proto.Field(
        proto.MESSAGE,
        number=11,
        oneof='metrics',

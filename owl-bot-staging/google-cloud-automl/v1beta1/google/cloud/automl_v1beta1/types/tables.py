...
class TablesDatasetMetadata(proto.Message):
    ...
    target_column_correlations: MutableMapping[str, data_stats.CorrelationStats] = proto.MapField(
        proto.STRING,
        proto.MESSAGE,
        number=6,
...
class TablesModelMetadata(proto.Message):
    ...
    input_feature_column_specs: MutableSequence[column_spec.ColumnSpec] = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
        message=column_spec.ColumnSpec,
    )
    ...
    tables_model_column_info: MutableSequence['TablesModelColumnInfo'] = proto.RepeatedField(
        proto.MESSAGE,
        number=5,

...
class Model(proto.Message):
    ...
    video_classification_model_metadata: video.VideoClassificationModelMetadata = proto.Field(
        proto.MESSAGE,
        number=23,
        oneof='model_metadata',
        message=video.VideoClassificationModelMetadata,
    )
    video_object_tracking_model_metadata: video.VideoObjectTrackingModelMetadata = proto.Field(
        proto.MESSAGE,
        number=21,
        oneof='model_metadata',

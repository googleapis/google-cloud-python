...
class Dataset(proto.Message):
    ...
    video_classification_dataset_metadata: video.VideoClassificationDatasetMetadata = proto.Field(
        proto.MESSAGE,
        number=31,
        oneof='dataset_metadata',
        message=video.VideoClassificationDatasetMetadata,
    )
    video_object_tracking_dataset_metadata: video.VideoObjectTrackingDatasetMetadata = proto.Field(
        proto.MESSAGE,
        number=29,
        oneof='dataset_metadata',

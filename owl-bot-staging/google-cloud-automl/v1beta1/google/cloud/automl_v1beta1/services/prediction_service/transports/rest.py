...
class PredictionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_predict(self, request: prediction_service.BatchPredictRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[prediction_service.BatchPredictRequest, Sequence[Tuple[str, str]]]:

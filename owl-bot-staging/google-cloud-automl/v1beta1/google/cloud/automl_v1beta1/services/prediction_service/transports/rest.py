...
class PredictionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_predict(self, request: prediction_service.BatchPredictRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[prediction_service.BatchPredictRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_batch_predict(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    def post_batch_predict_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for batch_predict
...
class PredictionServiceRestTransport(_BasePredictionServiceRestTransport):
    ...
    class _BatchPredict(_BasePredictionServiceRestTransport._BaseBatchPredict, PredictionServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BasePredictionServiceRestTransport._BaseBatchPredict._get_transcoded_request(http_options, request)

            body = _BasePredictionServiceRestTransport._BaseBatchPredict._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BasePredictionServiceRestTransport._BaseBatchPredict._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PredictionServiceRestTransport._BatchPredict._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = self._interceptor.post_batch_predict_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:

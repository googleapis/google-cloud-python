...
def test__get_client_cert_source():
    ...
    assert AutoMlClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AutoMlClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert AutoMlClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AutoMlClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(AutoMlClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AutoMlClient))
@mock.patch.object(AutoMlAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AutoMlAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AutoMlClient._DEFAULT_UNIVERSE
    default_endpoint = AutoMlClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AutoMlClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AutoMlClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert AutoMlClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AutoMlClient.DEFAULT_MTLS_ENDPOINT
    assert AutoMlClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AutoMlClient._get_api_endpoint(None, None, default_universe, "always") == AutoMlClient.DEFAULT_MTLS_ENDPOINT
    assert AutoMlClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AutoMlClient.DEFAULT_MTLS_ENDPOINT
    assert AutoMlClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AutoMlClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AutoMlClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AutoMlClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AutoMlClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AutoMlClient._get_universe_domain(None, None) == AutoMlClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class", [
    AutoMlClient, AutoMlAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (AutoMlAsyncClient, transports.AutoMlGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (AutoMlClient, transports.AutoMlRestTransport, "rest", None),
])
def test_auto_ml_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_auto_ml_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_create_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_dataset] = mock_rpc
...
def test_create_dataset_flattened():
    ...
    with mock.patch.object(
        ...
        assert arg == mock_val
        arg = args[0].dataset
        mock_val = gca_dataset.Dataset(translation_dataset_metadata=translation.TranslationDatasetMetadata(source_language_code='source_language_code_value'))
        assert arg == mock_val
...
@pytest.mark.asyncio
async def test_get_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_dataset] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_datasets_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_datasets in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_datasets] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_dataset] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_dataset] = mock_rpc
...
@pytest.mark.asyncio
async def test_import_data_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_data in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_data] = mock_rpc
...
def test_import_data_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = io.InputConfig(gcs_source=io.GcsSource(input_uris=['input_uris_value']))
        assert arg == mock_val
...
@pytest.mark.asyncio
async def test_export_data_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_data in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_data] = mock_rpc
...
def test_export_data_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = io.OutputConfig(gcs_destination=io.GcsDestination(output_uri_prefix='output_uri_prefix_value'))
        assert arg == mock_val
...
def test_get_annotation_spec_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_annotation_spec in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_annotation_spec] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_annotation_spec_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_annotation_spec in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_annotation_spec] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_table_spec_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_table_spec in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_table_spec] = mock_rpc
...
def test_list_table_specs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_table_specs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_table_specs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_table_specs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_table_specs] = mock_rpc
...
def test_update_table_spec_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_table_spec] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_table_spec_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_table_spec in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_table_spec] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_column_spec_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_column_spec in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_column_spec] = mock_rpc
...
def test_list_column_specs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_column_specs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_column_specs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_column_specs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_column_specs] = mock_rpc
...
def test_update_column_spec_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_column_spec in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_column_spec] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_column_spec_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_column_spec in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_column_spec] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_model] = mock_rpc
...
def test_create_model_flattened():
    ...
    with mock.patch.object(
        ...
        assert arg == mock_val
        arg = args[0].model
        mock_val = gca_model.Model(translation_model_metadata=translation.TranslationModelMetadata(base_model='base_model_value'))
        assert arg == mock_val
...
@pytest.mark.asyncio
async def test_delete_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_model] = mock_rpc
...
@pytest.mark.asyncio
async def test_deploy_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.deploy_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.deploy_model] = mock_rpc
...
@pytest.mark.asyncio
async def test_undeploy_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.undeploy_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.undeploy_model] = mock_rpc
...
@pytest.mark.asyncio
async def test_export_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_model] = mock_rpc
...
def test_export_model_flattened():
    ...
    with mock.patch.object(
        ...
        assert arg == mock_val
        arg = args[0].output_config
        mock_val = io.ModelExportOutputConfig(gcs_destination=io.GcsDestination(output_uri_prefix='output_uri_prefix_value'))
        assert arg == mock_val
...
def test_export_evaluated_examples_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.export_evaluated_examples in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.export_evaluated_examples] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_export_evaluated_examples_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_evaluated_examples in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_evaluated_examples] = mock_rpc
...
def test_export_evaluated_examples_flattened():
    ...
    with mock.patch.object(
        ...
        assert arg == mock_val
        arg = args[0].output_config
        mock_val = io.ExportEvaluatedExamplesOutputConfig(bigquery_destination=io.BigQueryDestination(output_uri='output_uri_value'))
        assert arg == mock_val
...
def test_get_model_evaluation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_model_evaluation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_model_evaluation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_model_evaluation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_model_evaluation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_model_evaluation] = mock_rpc
...
def test_list_model_evaluations_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_model_evaluations in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_model_evaluations] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_model_evaluations_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AutoMlAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_model_evaluations in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_model_evaluations] = mock_rpc
...
def test_create_dataset_rest_unset_required_fields():
    transport = transports.AutoMlRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_create_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/datasets" % client.transport._host, args[1])
...
def test_get_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/datasets/*}" % client.transport._host, args[1])
...
def test_update_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'dataset': {'name': 'projects/sample1/locations/sample2/datasets/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{dataset.name=projects/*/locations/*/datasets/*}" % client.transport._host, args[1])
...
def test_import_data_rest_required_fields(request_type=service.ImportDataRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_data._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_data_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/datasets/*}:importData" % client.transport._host, args[1])
...
def test_export_data_rest_required_fields(request_type=service.ExportDataRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_data._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_data_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/datasets/*}:exportData" % client.transport._host, args[1])
...
def test_get_annotation_spec_rest_required_fields(request_type=service.GetAnnotationSpecRequest):
    transport_class = transports.AutoMlRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_annotation_spec._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_annotation_spec_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/datasets/sample3/annotationSpecs/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/datasets/*/annotationSpecs/*}" % client.transport._host, args[1])
...
def test_get_table_spec_rest_required_fields(request_type=service.GetTableSpecRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_table_spec._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_table_spec_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/datasets/*/tableSpecs/*}" % client.transport._host, args[1])
...
def test_list_table_specs_rest_required_fields(request_type=service.ListTableSpecsRequest):
    transport_class = transports.AutoMlRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_table_specs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_table_specs._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("field_mask", "filter", "page_size", "page_token", ))
    jsonified_request.update(unset_fields)
...
def test_list_table_specs_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("fieldMask", "filter", "pageSize", "pageToken", )) & set(("parent", )))
...
def test_list_table_specs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/datasets/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/datasets/*}/tableSpecs" % client.transport._host, args[1])
...
def test_update_table_spec_rest_required_fields(request_type=service.UpdateTableSpecRequest):
    transport_class = transports.AutoMlRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_table_spec._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_table_spec_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'table_spec': {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{table_spec.name=projects/*/locations/*/datasets/*/tableSpecs/*}" % client.transport._host, args[1])
...
def test_get_column_spec_rest_required_fields(request_type=service.GetColumnSpecRequest):
    transport_class = transports.AutoMlRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_column_spec._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_column_spec_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4/columnSpecs/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/datasets/*/tableSpecs/*/columnSpecs/*}" % client.transport._host, args[1])
...
def test_list_column_specs_rest_required_fields(request_type=service.ListColumnSpecsRequest):
    transport_class = transports.AutoMlRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_column_specs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_column_specs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/datasets/*/tableSpecs/*}/columnSpecs" % client.transport._host, args[1])
...
def test_update_column_spec_rest_required_fields(request_type=service.UpdateColumnSpecRequest):
    transport_class = transports.AutoMlRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_column_spec._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_column_spec_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'column_spec': {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4/columnSpecs/sample5'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{column_spec.name=projects/*/locations/*/datasets/*/tableSpecs/*/columnSpecs/*}" % client.transport._host, args[1])
...
def test_create_model_rest_required_fields(request_type=service.CreateModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_model_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "model", )))
...
def test_create_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/models" % client.transport._host, args[1])
...
def test_get_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/models/*}" % client.transport._host, args[1])
...
def test_list_models_rest_required_fields(request_type=service.ListModelsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_models._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_model_rest_required_fields(request_type=service.DeleteModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_deploy_model_rest_required_fields(request_type=service.DeployModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).deploy_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_deploy_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/models/*}:deploy" % client.transport._host, args[1])
...
def test_undeploy_model_rest_required_fields(request_type=service.UndeployModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).undeploy_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_undeploy_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/models/*}:undeploy" % client.transport._host, args[1])
...
def test_export_model_rest_required_fields(request_type=service.ExportModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/models/*}:export" % client.transport._host, args[1])
...
def test_export_evaluated_examples_rest_required_fields(request_type=service.ExportEvaluatedExamplesRequest):
    transport_class = transports.AutoMlRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_evaluated_examples._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_evaluated_examples_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/models/*}:exportEvaluatedExamples" % client.transport._host, args[1])
...
def test_get_model_evaluation_rest_required_fields(request_type=service.GetModelEvaluationRequest):
    transport_class = transports.AutoMlRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_model_evaluation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_model_evaluation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/models/sample3/modelEvaluations/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/models/*/modelEvaluations/*}" % client.transport._host, args[1])
...
def test_list_model_evaluations_rest_required_fields(request_type=service.ListModelEvaluationsRequest):
    transport_class = transports.AutoMlRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_model_evaluations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_model_evaluations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/models/*}/modelEvaluations" % client.transport._host, args[1])
...
def test_list_model_evaluations_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(service.ListModelEvaluationsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_create_dataset_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.CreateDatasetRequest()
...
def test_get_dataset_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.GetDatasetRequest()
...
def test_list_datasets_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.ListDatasetsRequest()
...
def test_update_dataset_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.UpdateDatasetRequest()
...
def test_import_data_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.ImportDataRequest()
...
def test_export_data_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.ExportDataRequest()
...
def test_get_annotation_spec_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.GetAnnotationSpecRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_table_spec_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = table_spec.TableSpec()
        client.get_table_spec(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.GetTableSpecRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_table_specs_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.ListTableSpecsResponse()
        client.list_table_specs(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_table_spec_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = gca_table_spec.TableSpec()
        client.update_table_spec(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.UpdateTableSpecRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_column_spec_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = column_spec.ColumnSpec()
        client.get_column_spec(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.GetColumnSpecRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_column_specs_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.ListColumnSpecsResponse()
        client.list_column_specs(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.ListColumnSpecsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_column_spec_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = gca_column_spec.ColumnSpec()
        client.update_column_spec(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.UpdateColumnSpecRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_model_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_model(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.CreateModelRequest()
...
def test_get_model_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.GetModelRequest()
...
def test_list_models_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.ListModelsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_model_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.DeleteModelRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_deploy_model_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.deploy_model(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.DeployModelRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_undeploy_model_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.undeploy_model(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.UndeployModelRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_model_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.export_model(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.ExportModelRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_evaluated_examples_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.export_evaluated_examples(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.ExportEvaluatedExamplesRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_model_evaluation_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = model_evaluation.ModelEvaluation()
        client.get_model_evaluation(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.GetModelEvaluationRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_model_evaluations_empty_call_grpc():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.ListModelEvaluationsResponse()
        client.list_model_evaluations(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.ListModelEvaluationsRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = AutoMlAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_table_spec_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_table_spec(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_table_specs_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_table_specs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_table_spec_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_table_spec(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_column_spec_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_column_spec(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_column_specs_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_column_specs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_column_spec_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_column_spec(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_model_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_model_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_deploy_model_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.deploy_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_undeploy_model_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.undeploy_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_export_model_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.export_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_export_evaluated_examples_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.export_evaluated_examples(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_model_evaluation_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_model_evaluation(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_model_evaluations_empty_call_grpc_asyncio():
    client = AutoMlAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_model_evaluations(request=None)
...
def test_transport_kind_rest():
    transport = AutoMlClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_dataset_rest_bad_request(request_type=service.CreateDatasetRequest):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoMlRestInterceptor, "post_create_dataset") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_create_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_create_dataset") as pre:
...
def test_get_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoMlRestInterceptor, "post_get_dataset_with_metadata") as post_with_metadata, \
...
def test_list_datasets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_list_datasets") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_list_datasets_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListDatasetsResponse.to_json(service.ListDatasetsResponse())
        req.return_value.content = return_value
...
def test_update_dataset_rest_bad_request(request_type=service.UpdateDatasetRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'dataset': {'name': 'projects/sample1/locations/sample2/datasets/sample3'}}
    request = request_type(**request_init)
...
def test_update_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_update_dataset") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_update_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_update_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoMlRestInterceptor, "post_delete_dataset") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_delete_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_delete_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_import_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoMlRestInterceptor, "post_import_data_with_metadata") as post_with_metadata, \
        ...
        client.import_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoMlRestInterceptor, "post_export_data_with_metadata") as post_with_metadata, \
        ...
        client.export_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_annotation_spec_rest_bad_request(request_type=service.GetAnnotationSpecRequest):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/datasets/sample3/annotationSpecs/sample4'}
    request = request_type(**request_init)
...
def test_get_annotation_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_get_annotation_spec") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_get_annotation_spec_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_get_annotation_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.GetAnnotationSpecRequest.pb(service.GetAnnotationSpecRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = annotation_spec.AnnotationSpec.to_json(annotation_spec.AnnotationSpec())
        req.return_value.content = return_value
        ...
        client.get_annotation_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_table_spec_rest_bad_request(request_type=service.GetTableSpecRequest):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4'}
    request = request_type(**request_init)
...
def test_get_table_spec_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_table_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_get_table_spec") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_get_table_spec_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_get_table_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = table_spec.TableSpec.to_json(table_spec.TableSpec())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = table_spec.TableSpec(), metadata

        client.get_table_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_table_specs_rest_bad_request(request_type=service.ListTableSpecsRequest):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_table_specs_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_table_specs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_list_table_specs") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_list_table_specs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_list_table_specs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListTableSpecsResponse.to_json(service.ListTableSpecsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.ListTableSpecsResponse(), metadata

        client.list_table_specs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_table_spec_rest_bad_request(request_type=service.UpdateTableSpecRequest):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'table_spec': {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4'}}
    request = request_type(**request_init)
...
def test_update_table_spec_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'table_spec': {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4'}}
    request_init["table_spec"] = {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4', 'time_column_spec_id': 'time_column_spec_id_value', 'row_count': 992, 'valid_row_count': 1615, 'column_count': 1302, 'input_configs': [{'gcs_source': {'input_uris': ['input_uris_value1', 'input_uris_value2']}, 'bigquery_source': {'input_uri': 'input_uri_value'}, 'params': {}}], 'etag': 'etag_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_table_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_update_table_spec") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_update_table_spec_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_update_table_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gca_table_spec.TableSpec.to_json(gca_table_spec.TableSpec())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gca_table_spec.TableSpec(), metadata

        client.update_table_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_column_spec_rest_bad_request(request_type=service.GetColumnSpecRequest):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4/columnSpecs/sample5'}
    request = request_type(**request_init)
...
def test_get_column_spec_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_column_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_get_column_spec") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_get_column_spec_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_get_column_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = column_spec.ColumnSpec.to_json(column_spec.ColumnSpec())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = column_spec.ColumnSpec(), metadata

        client.get_column_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_column_specs_rest_bad_request(request_type=service.ListColumnSpecsRequest):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4'}
    request = request_type(**request_init)
...
def test_list_column_specs_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_column_specs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_list_column_specs") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_list_column_specs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_list_column_specs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListColumnSpecsResponse.to_json(service.ListColumnSpecsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.ListColumnSpecsResponse(), metadata

        client.list_column_specs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_column_spec_rest_bad_request(request_type=service.UpdateColumnSpecRequest):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'column_spec': {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4/columnSpecs/sample5'}}
    request = request_type(**request_init)
...
def test_update_column_spec_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'column_spec': {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4/columnSpecs/sample5'}}
    request_init["column_spec"] = {'name': 'projects/sample1/locations/sample2/datasets/sample3/tableSpecs/sample4/columnSpecs/sample5', 'data_type': {'list_element_type': {}, 'struct_type': {'fields': {}}, 'time_format': 'time_format_value', 'type_code': 3, 'nullable': True}, 'display_name': 'display_name_value', 'data_stats': {'float64_stats': {'mean': 0.417, 'standard_deviation': 0.1907, 'quantiles': [0.983, 0.984], 'histogram_buckets': [{'min_': 0.419, 'max_': 0.421, 'count': 553}]}, 'string_stats': {'top_unigram_stats': [{'value': 'value_value', 'count': 553}]}, 'timestamp_stats': {'granular_stats': {}}, 'array_stats': {'member_stats': {}}, 'struct_stats': {'field_stats': {}}, 'category_stats': {'top_category_stats': [{'value': 'value_value', 'count': 553}]}, 'distinct_value_count': 2150, 'null_value_count': 1727, 'valid_value_count': 1812}, 'top_correlated_columns': [{'column_spec_id': 'column_spec_id_value', 'correlation_stats': {'cramers_v': 0.962}}], 'etag': 'etag_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_column_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_update_column_spec") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_update_column_spec_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_update_column_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.UpdateColumnSpecRequest.pb(service.UpdateColumnSpecRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gca_column_spec.ColumnSpec.to_json(gca_column_spec.ColumnSpec())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gca_column_spec.ColumnSpec(), metadata

        client.update_column_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_model_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_create_model") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_create_model_with_metadata") as post_with_metadata, \
        ...
        client.create_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoMlRestInterceptor, "post_get_model_with_metadata") as post_with_metadata, \
...
def test_list_models_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AutoMlRestInterceptor, "post_list_models_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListModelsResponse.to_json(service.ListModelsResponse())
        req.return_value.content = return_value
...
def test_delete_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_delete_model") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_delete_model_with_metadata") as post_with_metadata, \
        ...
        client.delete_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_deploy_model_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_deploy_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_deploy_model") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_deploy_model_with_metadata") as post_with_metadata, \
        ...
        client.deploy_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_undeploy_model_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_undeploy_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_undeploy_model") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_undeploy_model_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_undeploy_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.undeploy_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_model_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_export_model") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_export_model_with_metadata") as post_with_metadata, \
        ...
        client.export_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_evaluated_examples_rest_bad_request(request_type=service.ExportEvaluatedExamplesRequest):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_evaluated_examples_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_evaluated_examples_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_export_evaluated_examples") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_export_evaluated_examples_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_export_evaluated_examples") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.ExportEvaluatedExamplesRequest.pb(service.ExportEvaluatedExamplesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.export_evaluated_examples(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_model_evaluation_rest_bad_request(request_type=service.GetModelEvaluationRequest):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/models/sample3/modelEvaluations/sample4'}
    request = request_type(**request_init)
...
def test_get_model_evaluation_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_model_evaluation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_get_model_evaluation") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_get_model_evaluation_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_get_model_evaluation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.GetModelEvaluationRequest.pb(service.GetModelEvaluationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = model_evaluation.ModelEvaluation.to_json(model_evaluation.ModelEvaluation())
        req.return_value.content = return_value
        ...
        client.get_model_evaluation(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_model_evaluations_rest_bad_request(request_type=service.ListModelEvaluationsRequest):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_model_evaluations_rest_call_success(request_type):
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_model_evaluations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_list_model_evaluations") as post, \
        mock.patch.object(transports.AutoMlRestInterceptor, "post_list_model_evaluations_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AutoMlRestInterceptor, "pre_list_model_evaluations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.ListModelEvaluationsRequest.pb(service.ListModelEvaluationsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListModelEvaluationsResponse.to_json(service.ListModelEvaluationsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.ListModelEvaluationsResponse(), metadata

        client.list_model_evaluations(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_table_spec_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_table_specs_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_table_spec_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_column_spec_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_column_specs_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_column_spec_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_model_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_undeploy_model_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_model_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_evaluated_examples_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_model_evaluation_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_model_evaluations_empty_call_rest():
    client = AutoMlClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_auto_ml_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.automl_v1beta1.services.auto_ml.transports.AutoMlTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_auto_ml_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.automl_v1beta1.services.auto_ml.transports.AutoMlTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AutoMlTransport()
        adc.assert_called_once()

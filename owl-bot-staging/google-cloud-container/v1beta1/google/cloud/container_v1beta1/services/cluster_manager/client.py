...
class ClusterManagerClient(metaclass=ClusterManagerClientMeta):
    ...
    def set_labels(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project_id, zone, cluster_id, resource_labels, label_fingerprint]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def fetch_cluster_upgrade_info(self,
            request: Optional[Union[cluster_service.FetchClusterUpgradeInfoRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_cluster_upgrade_info]
    ...
    def fetch_node_pool_upgrade_info(self,
            request: Optional[Union[cluster_service.FetchNodePoolUpgradeInfoRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_node_pool_upgrade_info]

...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_list_clusters_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = cluster_service.ListClustersResponse(), metadata
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_get_cluster_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = cluster_service.Cluster(), metadata
...
def test_create_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_create_cluster_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = cluster_service.Operation(), metadata
...
def test_update_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_update_cluster_with_metadata") as post_with_metadata, \
...
def test_update_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_update_node_pool_with_metadata") as post_with_metadata, \
...
def test_set_node_pool_autoscaling_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_node_pool_autoscaling_with_metadata") as post_with_metadata, \
...
def test_set_logging_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_logging_service_with_metadata") as post_with_metadata, \
...
def test_set_monitoring_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_monitoring_service_with_metadata") as post_with_metadata, \
...
def test_set_addons_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_addons_config_with_metadata") as post_with_metadata, \
...
def test_set_locations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_locations_with_metadata") as post_with_metadata, \
...
def test_update_master_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_update_master_with_metadata") as post_with_metadata, \
...
def test_set_master_auth_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_master_auth_with_metadata") as post_with_metadata, \
...
def test_delete_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_delete_cluster_with_metadata") as post_with_metadata, \
...
def test_list_operations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_list_operations_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = cluster_service.ListOperationsResponse(), metadata
...
def test_get_operation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_get_operation_with_metadata") as post_with_metadata, \
...
def test_get_server_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_get_server_config_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = cluster_service.ServerConfig(), metadata
...
def test_get_json_web_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_get_json_web_keys_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = cluster_service.GetJSONWebKeysResponse(), metadata
...
def test_list_node_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_list_node_pools_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = cluster_service.ListNodePoolsResponse(), metadata
...
def test_get_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_get_node_pool_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = cluster_service.NodePool(), metadata
...
def test_create_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_create_node_pool_with_metadata") as post_with_metadata, \
...
def test_delete_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_delete_node_pool_with_metadata") as post_with_metadata, \
...
def test_rollback_node_pool_upgrade_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_rollback_node_pool_upgrade_with_metadata") as post_with_metadata, \
...
def test_set_node_pool_management_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_node_pool_management_with_metadata") as post_with_metadata, \
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_labels_with_metadata") as post_with_metadata, \
...
def test_set_legacy_abac_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_legacy_abac_with_metadata") as post_with_metadata, \
...
def test_start_ip_rotation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_start_ip_rotation_with_metadata") as post_with_metadata, \
...
def test_complete_ip_rotation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_complete_ip_rotation_with_metadata") as post_with_metadata, \
...
def test_set_node_pool_size_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_node_pool_size_with_metadata") as post_with_metadata, \
...
def test_set_network_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_network_policy_with_metadata") as post_with_metadata, \
...
def test_set_maintenance_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_set_maintenance_policy_with_metadata") as post_with_metadata, \
...
def test_list_usable_subnetworks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_list_usable_subnetworks_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = cluster_service.ListUsableSubnetworksResponse(), metadata
...
def test_check_autopilot_compatibility_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterManagerRestInterceptor, "post_check_autopilot_compatibility_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = cluster_service.CheckAutopilotCompatibilityResponse(), metadata

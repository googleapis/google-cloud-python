...
# [START merchantapi_v1_generated_RegionsService_GetRegion_sync]
...
def sample_get_region():
    ...
    request = merchant_accounts_v1.GetRegionRequest(
        name="name_value",
    )
...
# [END merchantapi_v1_generated_RegionsService_GetRegion_sync]

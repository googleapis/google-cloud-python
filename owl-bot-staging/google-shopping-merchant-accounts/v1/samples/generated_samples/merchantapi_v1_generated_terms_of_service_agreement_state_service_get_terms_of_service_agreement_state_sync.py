...
#
# Snippet for GetTermsOfServiceAgreementState
...
# [START merchantapi_v1_generated_TermsOfServiceAgreementStateService_GetTermsOfServiceAgreementState_sync]
...
def sample_get_terms_of_service_agreement_state():
    # Create a client
    client = merchant_accounts_v1.TermsOfServiceAgreementStateServiceClient()

    # Initialize request argument(s)
    request = merchant_accounts_v1.GetTermsOfServiceAgreementStateRequest(
        name="name_value",
    )

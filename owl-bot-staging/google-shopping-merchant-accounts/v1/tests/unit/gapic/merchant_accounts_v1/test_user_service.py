...
from google.shopping.merchant_accounts_v1.services.user_service import UserServiceAsyncClient
from google.shopping.merchant_accounts_v1.services.user_service import UserServiceClient
from google.shopping.merchant_accounts_v1.services.user_service import pagers
from google.shopping.merchant_accounts_v1.services.user_service import transports
...
def test_create_user_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("userId", )) & set(("parent", "userId", )))
...
def test_user_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.shopping.merchant_accounts_v1.services.user_service.transports.UserServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_user_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.shopping.merchant_accounts_v1.services.user_service.transports.UserServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.UserServiceTransport()
        adc.assert_called_once()

...
from google.shopping.merchant_accounts_v1.services.omnichannel_settings_service import OmnichannelSettingsServiceAsyncClient
from google.shopping.merchant_accounts_v1.services.omnichannel_settings_service import OmnichannelSettingsServiceClient
from google.shopping.merchant_accounts_v1.services.omnichannel_settings_service import pagers
from google.shopping.merchant_accounts_v1.services.omnichannel_settings_service import transports
from google.shopping.merchant_accounts_v1.types import omnichannelsettings
import google.auth
...
def test__get_default_mtls_endpoint():
    ...
    assert OmnichannelSettingsServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert OmnichannelSettingsServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert OmnichannelSettingsServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert OmnichannelSettingsServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert OmnichannelSettingsServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert OmnichannelSettingsServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert OmnichannelSettingsServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert OmnichannelSettingsServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert OmnichannelSettingsServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert OmnichannelSettingsServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert OmnichannelSettingsServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert OmnichannelSettingsServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert OmnichannelSettingsServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert OmnichannelSettingsServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(OmnichannelSettingsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OmnichannelSettingsServiceClient))
@mock.patch.object(OmnichannelSettingsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OmnichannelSettingsServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = OmnichannelSettingsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = OmnichannelSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = OmnichannelSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert OmnichannelSettingsServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert OmnichannelSettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == OmnichannelSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert OmnichannelSettingsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert OmnichannelSettingsServiceClient._get_api_endpoint(None, None, default_universe, "always") == OmnichannelSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert OmnichannelSettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == OmnichannelSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert OmnichannelSettingsServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert OmnichannelSettingsServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        OmnichannelSettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert OmnichannelSettingsServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert OmnichannelSettingsServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert OmnichannelSettingsServiceClient._get_universe_domain(None, None) == OmnichannelSettingsServiceClient._DEFAULT_UNIVERSE
...
def test_omnichannel_settings_service_client_from_service_account_info(client_class, transport_name):
...
def test_omnichannel_settings_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_omnichannel_settings_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (OmnichannelSettingsServiceClient, transports.OmnichannelSettingsServiceGrpcTransport, "grpc"),
    (OmnichannelSettingsServiceAsyncClient, transports.OmnichannelSettingsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (OmnichannelSettingsServiceClient, transports.OmnichannelSettingsServiceRestTransport, "rest"),
])
@mock.patch.object(OmnichannelSettingsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OmnichannelSettingsServiceClient))
@mock.patch.object(OmnichannelSettingsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OmnichannelSettingsServiceAsyncClient))
def test_omnichannel_settings_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(OmnichannelSettingsServiceClient, 'get_transport_class') as gtc:
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (OmnichannelSettingsServiceClient, transports.OmnichannelSettingsServiceGrpcTransport, "grpc", "true"),
    (OmnichannelSettingsServiceAsyncClient, transports.OmnichannelSettingsServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (OmnichannelSettingsServiceClient, transports.OmnichannelSettingsServiceGrpcTransport, "grpc", "false"),
    (OmnichannelSettingsServiceAsyncClient, transports.OmnichannelSettingsServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (OmnichannelSettingsServiceClient, transports.OmnichannelSettingsServiceRestTransport, "rest", "true"),
    (OmnichannelSettingsServiceClient, transports.OmnichannelSettingsServiceRestTransport, "rest", "false"),
])
@mock.patch.object(OmnichannelSettingsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OmnichannelSettingsServiceClient))
@mock.patch.object(OmnichannelSettingsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OmnichannelSettingsServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_omnichannel_settings_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(OmnichannelSettingsServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OmnichannelSettingsServiceClient))
@mock.patch.object(OmnichannelSettingsServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OmnichannelSettingsServiceAsyncClient))
def test_omnichannel_settings_service_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_omnichannel_settings_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (OmnichannelSettingsServiceClient, transports.OmnichannelSettingsServiceGrpcTransport, "grpc", grpc_helpers),
    (OmnichannelSettingsServiceAsyncClient, transports.OmnichannelSettingsServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (OmnichannelSettingsServiceClient, transports.OmnichannelSettingsServiceRestTransport, "rest", None),
])
def test_omnichannel_settings_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_omnichannel_settings_service_client_client_options_from_dict():
    with mock.patch('google.shopping.merchant_accounts_v1.services.omnichannel_settings_service.transports.OmnichannelSettingsServiceGrpcTransport.__init__') as grpc_transport:
...
def test_omnichannel_settings_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_get_omnichannel_setting_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.get_omnichannel_setting in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_omnichannel_setting] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_omnichannel_setting_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_omnichannel_setting in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_omnichannel_setting] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_omnichannel_setting_async(transport: str = 'grpc_asyncio', request_type=omnichannelsettings.GetOmnichannelSettingRequest):
    client = OmnichannelSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_omnichannel_settings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_omnichannel_settings in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_omnichannel_settings] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_omnichannel_settings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OmnichannelSettingsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_omnichannel_settings in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_omnichannel_settings] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_omnichannel_settings_async(transport: str = 'grpc_asyncio', request_type=omnichannelsettings.ListOmnichannelSettingsRequest):
    client = OmnichannelSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_omnichannel_settings_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_omnichannel_settings(request={}, retry=retry, timeout=timeout)
...
def test_create_omnichannel_setting(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_omnichannel_setting),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = omnichannelsettings.OmnichannelSetting(
            name='name_value',
...
def test_create_omnichannel_setting_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_omnichannel_setting in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_omnichannel_setting] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_omnichannel_setting_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OmnichannelSettingsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_omnichannel_setting in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_omnichannel_setting] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_omnichannel_setting_async(transport: str = 'grpc_asyncio', request_type=omnichannelsettings.CreateOmnichannelSettingRequest):
    client = OmnichannelSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_omnichannel_setting_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_omnichannel_setting(
            parent='parent_value',
            omnichannel_setting=omnichannelsettings.OmnichannelSetting(name='name_value'),
        )
...
def test_update_omnichannel_setting(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_omnichannel_setting),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = omnichannelsettings.OmnichannelSetting(
            name='name_value',
...
def test_update_omnichannel_setting_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_omnichannel_setting in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_omnichannel_setting] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_omnichannel_setting_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OmnichannelSettingsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_omnichannel_setting in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_omnichannel_setting] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_omnichannel_setting_async(transport: str = 'grpc_asyncio', request_type=omnichannelsettings.UpdateOmnichannelSettingRequest):
    client = OmnichannelSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_request_inventory_verification(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.request_inventory_verification),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, omnichannelsettings.RequestInventoryVerificationResponse)
...
def test_request_inventory_verification_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.request_inventory_verification in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.request_inventory_verification] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_request_inventory_verification_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OmnichannelSettingsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.request_inventory_verification in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.request_inventory_verification] = mock_rpc
...
@pytest.mark.asyncio
async def test_request_inventory_verification_async(transport: str = 'grpc_asyncio', request_type=omnichannelsettings.RequestInventoryVerificationRequest):
    client = OmnichannelSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(omnichannelsettings.RequestInventoryVerificationResponse(
        ))
...
def test_get_omnichannel_setting_rest_required_fields(request_type=omnichannelsettings.GetOmnichannelSettingRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_omnichannel_setting._get_unset_required_fields(jsonified_request)
...
def test_get_omnichannel_setting_rest_unset_required_fields():
    transport = transports.OmnichannelSettingsServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_omnichannel_setting_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/accounts/v1/{name=accounts/*/omnichannelSettings/*}" % client.transport._host, args[1])
...
def test_list_omnichannel_settings_rest_required_fields(request_type=omnichannelsettings.ListOmnichannelSettingsRequest):
    transport_class = transports.OmnichannelSettingsServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_omnichannel_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = omnichannelsettings.ListOmnichannelSettingsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_omnichannel_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1/{parent=accounts/*}/omnichannelSettings" % client.transport._host, args[1])
...
def test_list_omnichannel_settings_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(omnichannelsettings.ListOmnichannelSettingsResponse.to_json(x) for x in response)
...
def test_create_omnichannel_setting_rest_required_fields(request_type=omnichannelsettings.CreateOmnichannelSettingRequest):
    transport_class = transports.OmnichannelSettingsServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_omnichannel_setting._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_omnichannel_setting_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "omnichannelSetting", )))
...
def test_update_omnichannel_setting_rest_required_fields(request_type=omnichannelsettings.UpdateOmnichannelSettingRequest):
    transport_class = transports.OmnichannelSettingsServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_omnichannel_setting._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_omnichannel_setting_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("omnichannelSetting", "updateMask", )))
...
def test_update_omnichannel_setting_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'omnichannel_setting': {'name': 'accounts/sample1/omnichannelSettings/sample2'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1/{omnichannel_setting.name=accounts/*/omnichannelSettings/*}" % client.transport._host, args[1])
...
def test_request_inventory_verification_rest_required_fields(request_type=omnichannelsettings.RequestInventoryVerificationRequest):
    transport_class = transports.OmnichannelSettingsServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).request_inventory_verification._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = omnichannelsettings.RequestInventoryVerificationResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_request_inventory_verification_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1/{name=accounts/*/omnichannelSettings/*}:requestInventoryVerification" % client.transport._host, args[1])
...
def test_transport_kind_grpc_asyncio():
    transport = OmnichannelSettingsServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_get_omnichannel_setting_rest_bad_request(request_type=omnichannelsettings.GetOmnichannelSettingRequest):
    client = OmnichannelSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_omnichannel_setting_rest_interceptors(null_interceptor):
    transport = transports.OmnichannelSettingsServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.OmnichannelSettingsServiceRestInterceptor(),
        )
    client = OmnichannelSettingsServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "post_get_omnichannel_setting") as post, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "post_get_omnichannel_setting_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "pre_get_omnichannel_setting") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = omnichannelsettings.GetOmnichannelSettingRequest.pb(omnichannelsettings.GetOmnichannelSettingRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = omnichannelsettings.OmnichannelSetting.to_json(omnichannelsettings.OmnichannelSetting())
        ...
        post_with_metadata.return_value = omnichannelsettings.OmnichannelSetting(), metadata

        client.get_omnichannel_setting(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_omnichannel_settings_rest_bad_request(request_type=omnichannelsettings.ListOmnichannelSettingsRequest):
    client = OmnichannelSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_omnichannel_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "post_list_omnichannel_settings") as post, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "post_list_omnichannel_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "pre_list_omnichannel_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = omnichannelsettings.ListOmnichannelSettingsRequest.pb(omnichannelsettings.ListOmnichannelSettingsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = omnichannelsettings.ListOmnichannelSettingsResponse.to_json(omnichannelsettings.ListOmnichannelSettingsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = omnichannelsettings.ListOmnichannelSettingsResponse(), metadata

        client.list_omnichannel_settings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_omnichannel_setting_rest_bad_request(request_type=omnichannelsettings.CreateOmnichannelSettingRequest):
    client = OmnichannelSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_omnichannel_setting_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "post_create_omnichannel_setting") as post, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "post_create_omnichannel_setting_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "pre_create_omnichannel_setting") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = omnichannelsettings.CreateOmnichannelSettingRequest.pb(omnichannelsettings.CreateOmnichannelSettingRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_omnichannel_setting(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_omnichannel_setting_rest_bad_request(request_type=omnichannelsettings.UpdateOmnichannelSettingRequest):
    client = OmnichannelSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'omnichannel_setting': {'name': 'accounts/sample1/omnichannelSettings/sample2'}}
    request = request_type(**request_init)
...
def test_update_omnichannel_setting_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'omnichannel_setting': {'name': 'accounts/sample1/omnichannelSettings/sample2'}}
    request_init["omnichannel_setting"] = {'name': 'accounts/sample1/omnichannelSettings/sample2', 'region_code': 'region_code_value', 'lsf_type': 1, 'in_stock': {'uri': 'uri_value', 'state': 1}, 'pickup': {'uri': 'uri_value', 'state': 1}, 'lfp_link': {'lfp_provider': 'lfp_provider_value', 'external_account_id': 'external_account_id_value', 'state': 1}, 'odo': {'uri': 'uri_value', 'state': 1}, 'about': {'uri': 'uri_value', 'state': 1}, 'inventory_verification': {'state': 1, 'contact': 'contact_value', 'contact_email': 'contact_email_value', 'contact_state': 1}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = omnichannelsettings.UpdateOmnichannelSettingRequest.meta.fields["omnichannel_setting"]
...
def test_update_omnichannel_setting_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "post_update_omnichannel_setting") as post, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "post_update_omnichannel_setting_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "pre_update_omnichannel_setting") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = omnichannelsettings.UpdateOmnichannelSettingRequest.pb(omnichannelsettings.UpdateOmnichannelSettingRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_omnichannel_setting(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_request_inventory_verification_rest_bad_request(request_type=omnichannelsettings.RequestInventoryVerificationRequest):
    client = OmnichannelSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_request_inventory_verification_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "post_request_inventory_verification") as post, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "post_request_inventory_verification_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OmnichannelSettingsServiceRestInterceptor, "pre_request_inventory_verification") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = omnichannelsettings.RequestInventoryVerificationRequest.pb(omnichannelsettings.RequestInventoryVerificationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = omnichannelsettings.RequestInventoryVerificationResponse.to_json(omnichannelsettings.RequestInventoryVerificationResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = omnichannelsettings.RequestInventoryVerificationResponse(), metadata

        client.request_inventory_verification(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_omnichannel_settings_service_base_transport():
    ...
    with mock.patch('google.shopping.merchant_accounts_v1.services.omnichannel_settings_service.transports.OmnichannelSettingsServiceTransport.__init__') as Transport:
...
def test_omnichannel_settings_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.shopping.merchant_accounts_v1.services.omnichannel_settings_service.transports.OmnichannelSettingsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_omnichannel_settings_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.shopping.merchant_accounts_v1.services.omnichannel_settings_service.transports.OmnichannelSettingsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.OmnichannelSettingsServiceTransport()
        adc.assert_called_once()
...
def test_omnichannel_settings_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@pytest.mark.parametrize("transport_class", [transports.OmnichannelSettingsServiceGrpcTransport, transports.OmnichannelSettingsServiceGrpcAsyncIOTransport])
...
def test_omnichannel_settings_service_client_transport_session_collision(transport_name):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.OmnichannelSettingsServiceGrpcTransport, transports.OmnichannelSettingsServiceGrpcAsyncIOTransport])
def test_omnichannel_settings_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_omnichannel_setting_path():
    ...
    expected = "accounts/{account}/omnichannelSettings/{omnichannel_setting}".format(account=account, omnichannel_setting=omnichannel_setting, )
    actual = OmnichannelSettingsServiceClient.omnichannel_setting_path(account, omnichannel_setting)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = OmnichannelSettingsServiceClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.OmnichannelSettingsServiceTransport, '_prep_wrapped_messages') as prep:
        client = OmnichannelSettingsServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize("client_class,transport_class", [
    (OmnichannelSettingsServiceClient, transports.OmnichannelSettingsServiceGrpcTransport),
    (OmnichannelSettingsServiceAsyncClient, transports.OmnichannelSettingsServiceGrpcAsyncIOTransport),
])

...
class BusinessIdentity(proto.Message):
    ...
    Attributes:
        ...
        promotions_consent (google.shopping.merchant_accounts_v1.types.BusinessIdentity.PromotionsConsent):
            Required. Whether the identity attributes may
            be used for promotions.
        black_owned (google.shopping.merchant_accounts_v1.types.BusinessIdentity.IdentityAttribute):
            Optional. Specifies whether the business identifies itself
            as being black-owned. This optional field will only be
            available for businesses with the business country set to
            ``US``. It is also not applicable for marketplaces or
            marketplace sellers.
        women_owned (google.shopping.merchant_accounts_v1.types.BusinessIdentity.IdentityAttribute):
            Optional. Specifies whether the business identifies itself
            as being women-owned. This optional field will only be
            available for businesses with a business country set to
            ``US``. It is also not applicable for marketplaces or
            marketplace sellers.
        veteran_owned (google.shopping.merchant_accounts_v1.types.BusinessIdentity.IdentityAttribute):
            Optional. Specifies whether the business identifies itself
            as being veteran-owned. This optional field will only be
            available for businesses with a business country set to
            ``US``. It is also not applicable for marketplaces or
            marketplace sellers.
        latino_owned (google.shopping.merchant_accounts_v1.types.BusinessIdentity.IdentityAttribute):
            Optional. Specifies whether the business identifies itself
            as being latino-owned. This optional field will only be
            available for businesses with the business country set to
            ``US``. It is also not applicable for marketplaces or
            marketplace sellers.
        small_business (google.shopping.merchant_accounts_v1.types.BusinessIdentity.IdentityAttribute):
            Optional. Specifies whether the business identifies itself
    ...
    class IdentityAttribute(proto.Message):
        ...
        Attributes:
            identity_declaration (google.shopping.merchant_accounts_v1.types.BusinessIdentity.IdentityAttribute.IdentityDeclaration):

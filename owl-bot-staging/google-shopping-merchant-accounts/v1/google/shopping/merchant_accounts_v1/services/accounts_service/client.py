...
from google.shopping.merchant_accounts_v1.services.accounts_service import pagers
from google.shopping.merchant_accounts_v1.types import accounts
from google.type import datetime_pb2  # type: ignore
from .transports.base import AccountsServiceTransport, DEFAULT_CLIENT_INFO
...
class AccountsServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AccountsServiceTransport]]
...
class AccountsServiceClient(metaclass=AccountsServiceClientMeta):
    ...
    @staticmethod
    def user_path(account: str,email: str,) -> str:
        """Returns a fully-qualified user string."""
        return "accounts/{account}/users/{email}".format(account=account, email=email, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AccountsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AccountsServiceTransport, Callable[..., AccountsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AccountsServiceClient._read_environment_variables()
        self._client_cert_source = AccountsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AccountsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            AccountsServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1.AccountsServiceClient`.",
                    extra = {
    ...
    def get_account(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.GetAccountRequest, dict]):
    ...
    def create_and_configure_account(self,
        ...
        r"""Creates a Merchant Center account with additional
        configuration. Adds the user that makes the request as
        an admin for the new account.
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.CreateAndConfigureAccountRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_and_configure_account]
    ...
    def delete_account(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.DeleteAccountRequest, dict]):
    ...
    def update_account(self,
        ...
        standalone, advanced account or sub-account. Executing
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.UpdateAccountRequest, dict]):
    ...
    def list_accounts(self,
        ...
        r"""Note: For the ``accounts.list`` method, quota and limits usage
        are charged for each user, and not for the Merchant Center ID or
        the advanced account ID. To list several sub-accounts, you
        should use the ``accounts.listSubaccounts`` method, which is
        more suitable for advanced accounts use case.
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.ListAccountsRequest, dict]):
    ...
    def list_sub_accounts(self,
        ...
        r"""List all sub-accounts for a given advanced account. This is a
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.ListSubAccountsRequest, dict]):

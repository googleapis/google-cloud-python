    ...
    class _GetBusinessIdentity(_BaseBusinessIdentityServiceRestTransport._BaseGetBusinessIdentity, BusinessIdentityServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.BusinessIdentityServiceClient.GetBusinessIdentity",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.BusinessIdentityServiceClient.get_business_identity",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.BusinessIdentityService",
                        "rpcName": "GetBusinessIdentity",
    ...
    class _UpdateBusinessIdentity(_BaseBusinessIdentityServiceRestTransport._BaseUpdateBusinessIdentity, BusinessIdentityServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.BusinessIdentityServiceClient.UpdateBusinessIdentity",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.BusinessIdentityService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.BusinessIdentityServiceClient.update_business_identity",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.BusinessIdentityService",
                        "rpcName": "UpdateBusinessIdentity",
                        "metadata": http_response["headers"],

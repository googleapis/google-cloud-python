...
class ListAccountIssuesPager:
    ...
    :class:`google.shopping.merchant_accounts_v1.types.ListAccountIssuesResponse` object, and
    ...
    All the usual :class:`google.shopping.merchant_accounts_v1.types.ListAccountIssuesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.shopping.merchant_accounts_v1.types.ListAccountIssuesRequest):
                The initial request object.
            response (google.shopping.merchant_accounts_v1.types.ListAccountIssuesResponse):

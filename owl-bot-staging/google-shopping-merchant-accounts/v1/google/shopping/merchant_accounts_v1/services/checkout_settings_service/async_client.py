...
class CheckoutSettingsServiceAsyncClient:
    ...
    async def get_checkout_settings(self,
    ...
    async def create_checkout_settings(self,
    ...
    async def update_checkout_settings(self,
    ...
    async def delete_checkout_settings(self,

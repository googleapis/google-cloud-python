...
from .transports.base import CheckoutSettingsServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import CheckoutSettingsServiceGrpcTransport
from .transports.grpc_asyncio import CheckoutSettingsServiceGrpcAsyncIOTransport
from .transports.rest import CheckoutSettingsServiceRestTransport


class CheckoutSettingsServiceClientMeta(type):
    """Metaclass for the CheckoutSettingsService client.
    ...
    def get_transport_class(cls,
        ...
        ) -> Type[CheckoutSettingsServiceTransport]:
...
class CheckoutSettingsServiceClient(metaclass=CheckoutSettingsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CheckoutSettingsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CheckoutSettingsServiceTransport:
        ...
        Returns:
            CheckoutSettingsServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def checkout_settings_path(account: str,program: str,) -> str:
        """Returns a fully-qualified checkout_settings string."""
        return "accounts/{account}/programs/{program}/checkoutSettings".format(account=account, program=program, )

    @staticmethod
    def parse_checkout_settings_path(path: str) -> Dict[str,str]:
        """Parses a checkout_settings path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/programs/(?P<program>.+?)/checkoutSettings$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CheckoutSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CheckoutSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = CheckoutSettingsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CheckoutSettingsServiceTransport, Callable[..., CheckoutSettingsServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the checkout settings service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CheckoutSettingsServiceClient._read_environment_variables()
        self._client_cert_source = CheckoutSettingsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CheckoutSettingsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, CheckoutSettingsServiceTransport)
        if transport_provided:
            # transport is a CheckoutSettingsServiceTransport instance.
            ...
            self._transport = cast(CheckoutSettingsServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CheckoutSettingsServiceTransport], Callable[..., CheckoutSettingsServiceTransport]] = (
                CheckoutSettingsServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., CheckoutSettingsServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1.CheckoutSettingsServiceClient`.",
                    extra = {
    ...
    def get_checkout_settings(self,
            request: Optional[Union[checkoutsettings.GetCheckoutSettingsRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            def sample_get_checkout_settings():
                # Create a client
                ...
                # Make the request
                response = client.get_checkout_settings(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.GetCheckoutSettingsRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_checkout_settings]
    ...
    def create_checkout_settings(self,
            request: Optional[Union[checkoutsettings.CreateCheckoutSettingsRequest, dict]] = None,
            *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.CreateCheckoutSettingsRequest, dict]):
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            checkout_settings (google.shopping.merchant_accounts_v1.types.CheckoutSettings):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_checkout_settings]
    ...
    def update_checkout_settings(self,
            request: Optional[Union[checkoutsettings.UpdateCheckoutSettingsRequest, dict]] = None,
            *,
            checkout_settings: Optional[checkoutsettings.CheckoutSettings] = None,
        ...
        .. code-block:: python
            ...
            def sample_update_checkout_settings():
                # Create a client
                client = merchant_accounts_v1.CheckoutSettingsServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.UpdateCheckoutSettingsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_checkout_settings]
    ...
    def delete_checkout_settings(self,
            request: Optional[Union[checkoutsettings.DeleteCheckoutSettingsRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_delete_checkout_settings():
                # Create a client
                client = merchant_accounts_v1.CheckoutSettingsServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.DeleteCheckoutSettingsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_checkout_settings]
    ...
    def __enter__(self) -> "CheckoutSettingsServiceClient":
        return self

...
class ProgramsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_disable_program(self, request: programs.DisableProgramRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[programs.DisableProgramRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_disable_program_with_metadata(self, response: programs.Program, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[programs.Program, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for disable_program
    ...
    def pre_enable_program(self, request: programs.EnableProgramRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[programs.EnableProgramRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_enable_program_with_metadata(self, response: programs.Program, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[programs.Program, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for enable_program
    ...
    def pre_get_program(self, request: programs.GetProgramRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[programs.GetProgramRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_program_with_metadata(self, response: programs.Program, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[programs.Program, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_program
    ...
    def pre_list_programs(self, request: programs.ListProgramsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[programs.ListProgramsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_programs_with_metadata(self, response: programs.ListProgramsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[programs.ListProgramsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_programs
...
class ProgramsServiceRestTransport(_BaseProgramsServiceRestTransport):
    ...
    class _DisableProgram(_BaseProgramsServiceRestTransport._BaseDisableProgram, ProgramsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ProgramsServiceRestTransport._DisableProgram._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _EnableProgram(_BaseProgramsServiceRestTransport._BaseEnableProgram, ProgramsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ProgramsServiceRestTransport._EnableProgram._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetProgram(_BaseProgramsServiceRestTransport._BaseGetProgram, ProgramsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ProgramsServiceRestTransport._GetProgram._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListPrograms(_BaseProgramsServiceRestTransport._BaseListPrograms, ProgramsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ProgramsServiceRestTransport._ListPrograms._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    @property
    def disable_program(self) -> Callable[
    ...
    @property
    def enable_program(self) -> Callable[
    ...
    @property
    def list_programs(self) -> Callable[

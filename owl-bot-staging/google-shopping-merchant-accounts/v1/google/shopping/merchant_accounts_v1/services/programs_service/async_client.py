...
from google.shopping.merchant_accounts_v1.services.programs_service import pagers
from google.shopping.merchant_accounts_v1.types import programs
from .transports.base import ProgramsServiceTransport, DEFAULT_CLIENT_INFO
...
class ProgramsServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(ProgramsServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ProgramsServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ProgramsServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(ProgramsServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(ProgramsServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(ProgramsServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(ProgramsServiceClient.common_project_path)
    parse_common_project_path = staticmethod(ProgramsServiceClient.parse_common_project_path)
    common_location_path = staticmethod(ProgramsServiceClient.common_location_path)
    parse_common_location_path = staticmethod(ProgramsServiceClient.parse_common_location_path)
    ...
    get_transport_class = ProgramsServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, ProgramsServiceTransport, Callable[..., ProgramsServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.shopping.merchant.accounts_v1.ProgramsServiceAsyncClient`.",
                extra = {
    ...
    async def get_program(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.GetProgramRequest, dict]]):
        ...
        Returns:
            google.shopping.merchant_accounts_v1.types.Program:
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_program]
    ...
    async def list_programs(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_programs():
                ...
                # Initialize request argument(s)
                request = merchant_accounts_v1.ListProgramsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.ListProgramsRequest, dict]]):
        ...
        Returns:
            google.shopping.merchant_accounts_v1.services.programs_service.pagers.ListProgramsAsyncPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_programs]
    ...
    async def enable_program(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.EnableProgramRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.enable_program]
    ...
    async def disable_program(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.DisableProgramRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.disable_program]

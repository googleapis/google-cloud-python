...
class ListProgramsPager:
    ...
    :class:`google.shopping.merchant_accounts_v1.types.ListProgramsResponse` object, and
    ...
    All the usual :class:`google.shopping.merchant_accounts_v1.types.ListProgramsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.shopping.merchant_accounts_v1.types.ListProgramsRequest):
                The initial request object.
            response (google.shopping.merchant_accounts_v1.types.ListProgramsResponse):

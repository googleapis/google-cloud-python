...
class ProgramsServiceClient(metaclass=ProgramsServiceClientMeta):
    ...
    @staticmethod
    def program_path(account: str,program: str,) -> str:
        """Returns a fully-qualified program string."""
        return "accounts/{account}/programs/{program}".format(account=account, program=program, )
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1.ProgramsServiceClient`.",
                    extra = {
    ...
    def get_program(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.GetProgramRequest, dict]):
    ...
    def list_programs(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.ListProgramsRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_accounts_v1.services.programs_service.pagers.ListProgramsPager:
    ...
    def enable_program(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.EnableProgramRequest, dict]):
    ...
    def disable_program(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.DisableProgramRequest, dict]):

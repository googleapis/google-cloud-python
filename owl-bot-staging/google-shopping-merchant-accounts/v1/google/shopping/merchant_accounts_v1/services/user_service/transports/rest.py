...
from google.shopping.merchant_accounts_v1.types import user
...
class UserServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_user(self, request: gsma_user.CreateUserRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gsma_user.CreateUserRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_user_with_metadata(self, response: gsma_user.User, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gsma_user.User, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_user
    ...
    def pre_delete_user(self, request: user.DeleteUserRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user.DeleteUserRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_user(self, request: user.GetUserRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user.GetUserRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_user_with_metadata(self, response: user.User, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user.User, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_user
    ...
    def pre_list_users(self, request: user.ListUsersRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user.ListUsersRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_users(self, response: user.ListUsersResponse) -> user.ListUsersResponse:
    ...
    def post_list_users_with_metadata(self, response: user.ListUsersResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user.ListUsersResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_users
    ...
    def pre_update_user(self, request: gsma_user.UpdateUserRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gsma_user.UpdateUserRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_user_with_metadata(self, response: gsma_user.User, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gsma_user.User, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_user
...
class UserServiceRestTransport(_BaseUserServiceRestTransport):
    ...
    class _CreateUser(_BaseUserServiceRestTransport._BaseCreateUser, UserServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseUserServiceRestTransport._BaseCreateUser._get_http_options()

            request, metadata = self._interceptor.pre_create_user(request, metadata)
            transcoded_request = _BaseUserServiceRestTransport._BaseCreateUser._get_transcoded_request(http_options, request)

            body = _BaseUserServiceRestTransport._BaseCreateUser._get_request_body_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.UserServiceClient.CreateUser",
                    extra = {
            ...
            # Send the request
            response = UserServiceRestTransport._CreateUser._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.UserServiceClient.create_user",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.UserService",
                        "rpcName": "CreateUser",
    ...
    class _DeleteUser(_BaseUserServiceRestTransport._BaseDeleteUser, UserServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseUserServiceRestTransport._BaseDeleteUser._get_transcoded_request(http_options, request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.UserServiceClient.DeleteUser",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.UserService",
                        "rpcName": "DeleteUser",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = UserServiceRestTransport._DeleteUser._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetUser(_BaseUserServiceRestTransport._BaseGetUser, UserServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.UserServiceClient.GetUser",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.UserService",
                        "rpcName": "GetUser",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.UserServiceClient.get_user",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.UserService",
                        "rpcName": "GetUser",
                        "metadata": http_response["headers"],
    ...
    class _ListUsers(_BaseUserServiceRestTransport._BaseListUsers, UserServiceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseUserServiceRestTransport._BaseListUsers._get_transcoded_request(http_options, request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.UserServiceClient.ListUsers",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.UserService",
                        "rpcName": "ListUsers",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = UserServiceRestTransport._ListUsers._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.UserServiceClient.list_users",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.UserService",
                        "rpcName": "ListUsers",
                        "metadata": http_response["headers"],
    ...
    class _UpdateUser(_BaseUserServiceRestTransport._BaseUpdateUser, UserServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseUserServiceRestTransport._BaseUpdateUser._get_http_options()

            request, metadata = self._interceptor.pre_update_user(request, metadata)
            transcoded_request = _BaseUserServiceRestTransport._BaseUpdateUser._get_transcoded_request(http_options, request)

            body = _BaseUserServiceRestTransport._BaseUpdateUser._get_request_body_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.UserServiceClient.UpdateUser",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.UserService",
                        "rpcName": "UpdateUser",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = UserServiceRestTransport._UpdateUser._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.UserServiceClient.update_user",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.UserService",
                        "rpcName": "UpdateUser",
                        "metadata": http_response["headers"],

...
class OnlineReturnPolicyServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_online_return_policy(self, request: gsma_online_return_policy.CreateOnlineReturnPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gsma_online_return_policy.CreateOnlineReturnPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_online_return_policy(self, response: gsma_online_return_policy.OnlineReturnPolicy) -> gsma_online_return_policy.OnlineReturnPolicy:
    ...
    def post_create_online_return_policy_with_metadata(self, response: gsma_online_return_policy.OnlineReturnPolicy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gsma_online_return_policy.OnlineReturnPolicy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_online_return_policy
    ...
    def pre_delete_online_return_policy(self, request: online_return_policy.DeleteOnlineReturnPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[online_return_policy.DeleteOnlineReturnPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_online_return_policy(self, request: online_return_policy.GetOnlineReturnPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[online_return_policy.GetOnlineReturnPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_online_return_policy_with_metadata(self, response: online_return_policy.OnlineReturnPolicy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[online_return_policy.OnlineReturnPolicy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_online_return_policy
    ...
    def pre_list_online_return_policies(self, request: online_return_policy.ListOnlineReturnPoliciesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[online_return_policy.ListOnlineReturnPoliciesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_online_return_policies(self, response: online_return_policy.ListOnlineReturnPoliciesResponse) -> online_return_policy.ListOnlineReturnPoliciesResponse:
    ...
    def post_list_online_return_policies_with_metadata(self, response: online_return_policy.ListOnlineReturnPoliciesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[online_return_policy.ListOnlineReturnPoliciesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_online_return_policies
...
class OnlineReturnPolicyServiceRestTransport(_BaseOnlineReturnPolicyServiceRestTransport):
    ...
    class _CreateOnlineReturnPolicy(_BaseOnlineReturnPolicyServiceRestTransport._BaseCreateOnlineReturnPolicy, OnlineReturnPolicyServiceRestStub):
        ...
        policy method over HTTP.
            ...
            transcoded_request = _BaseOnlineReturnPolicyServiceRestTransport._BaseCreateOnlineReturnPolicy._get_transcoded_request(http_options, request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.OnlineReturnPolicyServiceClient.CreateOnlineReturnPolicy",
                    extra = {
            ...
            # Send the request
            response = OnlineReturnPolicyServiceRestTransport._CreateOnlineReturnPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.OnlineReturnPolicyServiceClient.create_online_return_policy",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.OnlineReturnPolicyService",
                        "rpcName": "CreateOnlineReturnPolicy",
    ...
    class _DeleteOnlineReturnPolicy(_BaseOnlineReturnPolicyServiceRestTransport._BaseDeleteOnlineReturnPolicy, OnlineReturnPolicyServiceRestStub):
        ...
        policy method over HTTP.
            ...
            transcoded_request = _BaseOnlineReturnPolicyServiceRestTransport._BaseDeleteOnlineReturnPolicy._get_transcoded_request(http_options, request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.OnlineReturnPolicyServiceClient.DeleteOnlineReturnPolicy",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.OnlineReturnPolicyService",
            ...
            # Send the request
            response = OnlineReturnPolicyServiceRestTransport._DeleteOnlineReturnPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOnlineReturnPolicy(_BaseOnlineReturnPolicyServiceRestTransport._BaseGetOnlineReturnPolicy, OnlineReturnPolicyServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.OnlineReturnPolicyServiceClient.GetOnlineReturnPolicy",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.OnlineReturnPolicyService",
            ...
            # Send the request
            response = OnlineReturnPolicyServiceRestTransport._GetOnlineReturnPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.OnlineReturnPolicyServiceClient.get_online_return_policy",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.OnlineReturnPolicyService",
                        "rpcName": "GetOnlineReturnPolicy",
                        "metadata": http_response["headers"],
    ...
    class _ListOnlineReturnPolicies(_BaseOnlineReturnPolicyServiceRestTransport._BaseListOnlineReturnPolicies, OnlineReturnPolicyServiceRestStub):
        ...
        policies method over HTTP.
            ...
            transcoded_request = _BaseOnlineReturnPolicyServiceRestTransport._BaseListOnlineReturnPolicies._get_transcoded_request(http_options, request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.OnlineReturnPolicyServiceClient.ListOnlineReturnPolicies",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.OnlineReturnPolicyService",
            ...
            # Send the request
            response = OnlineReturnPolicyServiceRestTransport._ListOnlineReturnPolicies._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.OnlineReturnPolicyServiceClient.list_online_return_policies",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.OnlineReturnPolicyService",
                        "rpcName": "ListOnlineReturnPolicies",
                        "metadata": http_response["headers"],

...
class DeveloperRegistrationServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_developer_registration(self, request: developerregistration.GetDeveloperRegistrationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[developerregistration.GetDeveloperRegistrationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_developer_registration_with_metadata(self, response: developerregistration.DeveloperRegistration, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[developerregistration.DeveloperRegistration, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_developer_registration
    ...
    def pre_register_gcp(self, request: developerregistration.RegisterGcpRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[developerregistration.RegisterGcpRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_register_gcp_with_metadata(self, response: developerregistration.DeveloperRegistration, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[developerregistration.DeveloperRegistration, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for register_gcp
    ...
    def pre_unregister_gcp(self, request: developerregistration.UnregisterGcpRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[developerregistration.UnregisterGcpRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class DeveloperRegistrationServiceRestTransport(_BaseDeveloperRegistrationServiceRestTransport):
    ...
    class _GetDeveloperRegistration(_BaseDeveloperRegistrationServiceRestTransport._BaseGetDeveloperRegistration, DeveloperRegistrationServiceRestStub):
        def __hash__(self):
        ...
        registration method over HTTP.
            ...
            transcoded_request = _BaseDeveloperRegistrationServiceRestTransport._BaseGetDeveloperRegistration._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = DeveloperRegistrationServiceRestTransport._GetDeveloperRegistration._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RegisterGcp(_BaseDeveloperRegistrationServiceRestTransport._BaseRegisterGcp, DeveloperRegistrationServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DeveloperRegistrationServiceRestTransport._RegisterGcp._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UnregisterGcp(_BaseDeveloperRegistrationServiceRestTransport._BaseUnregisterGcp, DeveloperRegistrationServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DeveloperRegistrationServiceRestTransport._UnregisterGcp._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

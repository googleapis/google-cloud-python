...
from .base import DeveloperRegistrationServiceTransport, DEFAULT_CLIENT_INFO
...
class _BaseDeveloperRegistrationServiceRestTransport(DeveloperRegistrationServiceTransport):
    ...
    class _BaseGetDeveloperRegistration:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/accounts/v1/{name=accounts/*/developerRegistration}',
            },
            ]
            return http_options
    ...
    class _BaseRegisterGcp:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/accounts/v1/{name=accounts/*/developerRegistration}:registerGcp',
                'body': '*',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = developerregistration.RegisterGcpRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseUnregisterGcp:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/accounts/v1/{name=accounts/*/developerRegistration}:unregisterGcp',
                'body': '*',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = developerregistration.UnregisterGcpRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request

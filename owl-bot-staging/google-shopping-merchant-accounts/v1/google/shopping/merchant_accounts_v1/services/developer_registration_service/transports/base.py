...
class DeveloperRegistrationServiceTransport(abc.ABC):
    """Abstract transport class for DeveloperRegistrationService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.register_gcp: gapic_v1.method.wrap_method(
                self.register_gcp,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_developer_registration: gapic_v1.method.wrap_method(
                self.get_developer_registration,
                default_timeout=None,
                client_info=client_info,
            ),
            self.unregister_gcp: gapic_v1.method.wrap_method(
                self.unregister_gcp,
                default_timeout=None,
                client_info=client_info,
            ),

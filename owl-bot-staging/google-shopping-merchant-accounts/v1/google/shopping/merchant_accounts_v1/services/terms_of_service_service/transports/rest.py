    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomTermsOfServiceServiceInterceptor(TermsOfServiceServiceRestInterceptor):
            ...
            def post_accept_terms_of_service(self, response):
    ...
    def post_accept_terms_of_service(self, response: termsofservice.AcceptTermsOfServiceResponse) -> termsofservice.AcceptTermsOfServiceResponse:
        ...
        it is returned to user code. This `post_accept_terms_of_service` interceptor runs
        before the `post_accept_terms_of_service_with_metadata` interceptor.
        """
        return response

    def post_accept_terms_of_service_with_metadata(self, response: termsofservice.AcceptTermsOfServiceResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[termsofservice.AcceptTermsOfServiceResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for accept_terms_of_service

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the TermsOfServiceService server but before it is returned to user code.

        We recommend only using this `post_accept_terms_of_service_with_metadata`
        interceptor in new development instead of the `post_accept_terms_of_service` interceptor.
        When both interceptors are used, this `post_accept_terms_of_service_with_metadata` interceptor runs after the
        `post_accept_terms_of_service` interceptor. The (possibly modified) response returned by
        `post_accept_terms_of_service` will be passed to
        `post_accept_terms_of_service_with_metadata`.
        """
...
class TermsOfServiceServiceRestTransport(_BaseTermsOfServiceServiceRestTransport):
    ...
    class _AcceptTermsOfService(_BaseTermsOfServiceServiceRestTransport._BaseAcceptTermsOfService, TermsOfServiceServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.TermsOfServiceServiceClient.AcceptTermsOfService",
                    extra = {
            ...
            # Return the response
            resp = termsofservice.AcceptTermsOfServiceResponse()
            pb_resp = termsofservice.AcceptTermsOfServiceResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.TermsOfServiceServiceClient.accept_terms_of_service",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.TermsOfServiceService",
                        "rpcName": "AcceptTermsOfService",
    ...
    class _GetTermsOfService(_BaseTermsOfServiceServiceRestTransport._BaseGetTermsOfService, TermsOfServiceServiceRestStub):
        ...
        def __call__(self,
            ...
            Returns:
                ~.termsofservice.TermsOfService:
                    The ``TermsOfService`` message represents a specific
                version of the terms of service that merchants must
                accept to access certain features or services. For more
                information, see `Terms of
                ...
                agreements for using the service. Merchants can retrieve
                the latest terms of service for a given ``kind`` and
                ``region`` through ``RetrieveLatestTermsOfService``, and
                accept them as required through
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.TermsOfServiceServiceClient.GetTermsOfService",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.TermsOfServiceService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.TermsOfServiceServiceClient.get_terms_of_service",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.TermsOfServiceService",
                        "rpcName": "GetTermsOfService",
                        "metadata": http_response["headers"],
    ...
    class _RetrieveLatestTermsOfService(_BaseTermsOfServiceServiceRestTransport._BaseRetrieveLatestTermsOfService, TermsOfServiceServiceRestStub):
        ...
        service method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.TermsOfServiceServiceClient.RetrieveLatestTermsOfService",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.TermsOfServiceService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.TermsOfServiceServiceClient.retrieve_latest_terms_of_service",
                    extra = {
                        "serviceName": "google.shopping.merchant.accounts.v1.TermsOfServiceService",
                        "rpcName": "RetrieveLatestTermsOfService",
                        "metadata": http_response["headers"],

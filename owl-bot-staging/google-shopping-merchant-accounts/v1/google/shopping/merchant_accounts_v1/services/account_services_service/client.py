...
from google.shopping.merchant_accounts_v1.services.account_services_service import pagers
from google.shopping.merchant_accounts_v1.types import accountservices
from .transports.base import AccountServicesServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import AccountServicesServiceGrpcTransport
from .transports.grpc_asyncio import AccountServicesServiceGrpcAsyncIOTransport
from .transports.rest import AccountServicesServiceRestTransport


class AccountServicesServiceClientMeta(type):
    """Metaclass for the AccountServicesService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AccountServicesServiceTransport]]
    _transport_registry["grpc"] = AccountServicesServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = AccountServicesServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = AccountServicesServiceRestTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[AccountServicesServiceTransport]:
...
class AccountServicesServiceClient(metaclass=AccountServicesServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AccountServicesServiceClient: The constructed client.
        """
    ...
    def transport(self) -> AccountServicesServiceTransport:
        ...
        Returns:
            AccountServicesServiceTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def account_service_path(account: str,service: str,) -> str:
        """Returns a fully-qualified account_service string."""
        return "accounts/{account}/services/{service}".format(account=account, service=service, )

    @staticmethod
    def parse_account_service_path(path: str) -> Dict[str,str]:
        """Parses a account_service path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/services/(?P<service>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AccountServicesServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AccountServicesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = AccountServicesServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AccountServicesServiceTransport, Callable[..., AccountServicesServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the account services service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AccountServicesServiceClient._read_environment_variables()
        self._client_cert_source = AccountServicesServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AccountServicesServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, AccountServicesServiceTransport)
        if transport_provided:
            # transport is a AccountServicesServiceTransport instance.
            ...
            self._transport = cast(AccountServicesServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AccountServicesServiceTransport], Callable[..., AccountServicesServiceTransport]] = (
                AccountServicesServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AccountServicesServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1.AccountServicesServiceClient`.",
                    extra = {
    ...
    def get_account_service(self,
        ...
        .. code-block:: python
            ...
            def sample_get_account_service():
                # Create a client
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.GetAccountServiceRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_account_service]
    ...
    def list_account_services(self,
            request: Optional[Union[accountservices.ListAccountServicesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListAccountServicesPager:
        ...
        .. code-block:: python
            ...
            def sample_list_account_services():
                # Create a client
                client = merchant_accounts_v1.AccountServicesServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.ListAccountServicesRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_accounts_v1.services.account_services_service.pagers.ListAccountServicesPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_account_services]
        ...
        response = pagers.ListAccountServicesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def propose_account_service(self,
            request: Optional[Union[accountservices.ProposeAccountServiceRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.ProposeAccountServiceRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.propose_account_service]
    ...
    def approve_account_service(self,
            request: Optional[Union[accountservices.ApproveAccountServiceRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_approve_account_service():
                # Create a client
                client = merchant_accounts_v1.AccountServicesServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.ApproveAccountServiceRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.approve_account_service]
    ...
    def reject_account_service(self,
            request: Optional[Union[accountservices.RejectAccountServiceRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_reject_account_service():
                # Create a client
                client = merchant_accounts_v1.AccountServicesServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.RejectAccountServiceRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reject_account_service]
    ...
    def __enter__(self) -> "AccountServicesServiceClient":
        return self

...
class AccountServicesServiceAsyncClient:
    ...
    account_service_path = staticmethod(AccountServicesServiceClient.account_service_path)
    parse_account_service_path = staticmethod(AccountServicesServiceClient.parse_account_service_path)
    common_billing_account_path = staticmethod(AccountServicesServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(AccountServicesServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(AccountServicesServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(AccountServicesServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(AccountServicesServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(AccountServicesServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(AccountServicesServiceClient.common_project_path)
    parse_common_project_path = staticmethod(AccountServicesServiceClient.parse_common_project_path)
    common_location_path = staticmethod(AccountServicesServiceClient.common_location_path)
    parse_common_location_path = staticmethod(AccountServicesServiceClient.parse_common_location_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AccountServicesServiceTransport, Callable[..., AccountServicesServiceTransport]]] = "grpc_asyncio",
    ...
    async def get_account_service(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_account_service]
    ...
    async def list_account_services(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_account_services]
    ...
    async def propose_account_service(self,
    ...
    async def approve_account_service(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.approve_account_service]
    ...
    async def reject_account_service(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.reject_account_service]

...
class AutomaticImprovementsServiceAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.shopping.merchant.accounts_v1.AutomaticImprovementsServiceAsyncClient`.",
                extra = {
    ...
    async def get_automatic_improvements(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.GetAutomaticImprovementsRequest, dict]]):
    ...
    async def update_automatic_improvements(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.UpdateAutomaticImprovementsRequest, dict]]):
                The request object. Request message for the ``UpdateAutomaticImprovements``
                method.
            automatic_improvements (:class:`google.shopping.merchant_accounts_v1.types.AutomaticImprovements`):

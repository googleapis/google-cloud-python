...
class RegionsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_create_regions(self, request: regions.BatchCreateRegionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.BatchCreateRegionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_batch_create_regions_with_metadata(self, response: regions.BatchCreateRegionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.BatchCreateRegionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for batch_create_regions
    ...
    def pre_batch_delete_regions(self, request: regions.BatchDeleteRegionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.BatchDeleteRegionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_batch_update_regions(self, request: regions.BatchUpdateRegionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.BatchUpdateRegionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_batch_update_regions_with_metadata(self, response: regions.BatchUpdateRegionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.BatchUpdateRegionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for batch_update_regions
...
class RegionsServiceRestTransport(_BaseRegionsServiceRestTransport):
    ...
    class _BatchCreateRegions(_BaseRegionsServiceRestTransport._BaseBatchCreateRegions, RegionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionsServiceRestTransport._BatchCreateRegions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _BatchDeleteRegions(_BaseRegionsServiceRestTransport._BaseBatchDeleteRegions, RegionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionsServiceRestTransport._BatchDeleteRegions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _BatchUpdateRegions(_BaseRegionsServiceRestTransport._BaseBatchUpdateRegions, RegionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionsServiceRestTransport._BatchUpdateRegions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

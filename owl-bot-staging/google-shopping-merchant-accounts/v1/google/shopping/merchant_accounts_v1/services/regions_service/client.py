...
from .transports.base import RegionsServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import RegionsServiceGrpcTransport
from .transports.grpc_asyncio import RegionsServiceGrpcAsyncIOTransport
from .transports.rest import RegionsServiceRestTransport


class RegionsServiceClientMeta(type):
    """Metaclass for the RegionsService client.
...
class RegionsServiceClient(metaclass=RegionsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RegionsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> RegionsServiceTransport:
        ...
        Returns:
            RegionsServiceTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def region_path(account: str,region: str,) -> str:
        """Returns a fully-qualified region string."""
        return "accounts/{account}/regions/{region}".format(account=account, region=region, )

    @staticmethod
    def parse_region_path(path: str) -> Dict[str,str]:
        """Parses a region path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/regions/(?P<region>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RegionsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RegionsServiceTransport, Callable[..., RegionsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionsServiceClient._read_environment_variables()
        self._client_cert_source = RegionsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RegionsServiceTransport)
        if transport_provided:
            # transport is a RegionsServiceTransport instance.
            ...
            self._transport = cast(RegionsServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionsServiceTransport], Callable[..., RegionsServiceTransport]] = (
                RegionsServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., RegionsServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1.RegionsServiceClient`.",
                    extra = {
    ...
    def get_region(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.GetRegionRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_region]
    ...
    def create_region(self,
        ...
        .. code-block:: python
            ...
            def sample_create_region():
                ...
                # Initialize request argument(s)
                request = merchant_accounts_v1.CreateRegionRequest(
                    parent="parent_value",
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.CreateRegionRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, region, region_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_region]
    ...
    def batch_create_regions(self,
        ...
        .. code-block:: python
            ...
            def sample_batch_create_regions():
                # Create a client
                client = merchant_accounts_v1.RegionsServiceClient()
                ...
                # Make the request
                response = client.batch_create_regions(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.BatchCreateRegionsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_create_regions]
    ...
    def update_region(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.UpdateRegionRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [region, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_region]
    ...
    def batch_update_regions(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.BatchUpdateRegionsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_update_regions]
    ...
    def delete_region(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_region():
                ...
                # Initialize request argument(s)
                request = merchant_accounts_v1.DeleteRegionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.DeleteRegionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_region]
    ...
    def batch_delete_regions(self,
        ...
        .. code-block:: python
            ...
            def sample_batch_delete_regions():
                # Create a client
                client = merchant_accounts_v1.RegionsServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.BatchDeleteRegionsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_delete_regions]
    ...
    def list_regions(self,
        ...
        .. code-block:: python
            ...
            def sample_list_regions():
                ...
                # Initialize request argument(s)
                request = merchant_accounts_v1.ListRegionsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.ListRegionsRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_accounts_v1.services.regions_service.pagers.ListRegionsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_regions]
        ...
        response = pagers.ListRegionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "RegionsServiceClient":
        return self

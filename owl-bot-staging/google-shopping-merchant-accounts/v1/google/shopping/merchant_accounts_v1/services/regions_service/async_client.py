...
class RegionsServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(RegionsServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(RegionsServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(RegionsServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(RegionsServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(RegionsServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(RegionsServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(RegionsServiceClient.common_project_path)
    parse_common_project_path = staticmethod(RegionsServiceClient.parse_common_project_path)
    common_location_path = staticmethod(RegionsServiceClient.common_location_path)
    parse_common_location_path = staticmethod(RegionsServiceClient.parse_common_location_path)
    ...
    get_transport_class = RegionsServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, RegionsServiceTransport, Callable[..., RegionsServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.shopping.merchant.accounts_v1.RegionsServiceAsyncClient`.",
                extra = {
    ...
    async def get_region(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.GetRegionRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_region]
    ...
    async def create_region(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.CreateRegionRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            region (:class:`google.shopping.merchant_accounts_v1.types.Region`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_region]
    ...
    async def batch_create_regions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_create_regions]
    ...
    async def update_region(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.UpdateRegionRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_region]
    ...
    async def batch_update_regions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_update_regions]
    ...
    async def delete_region(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.DeleteRegionRequest, dict]]):
    ...
    async def batch_delete_regions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_delete_regions]
    ...
    async def list_regions(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.ListRegionsRequest, dict]]):
        ...
        Returns:
            google.shopping.merchant_accounts_v1.services.regions_service.pagers.ListRegionsAsyncPager:

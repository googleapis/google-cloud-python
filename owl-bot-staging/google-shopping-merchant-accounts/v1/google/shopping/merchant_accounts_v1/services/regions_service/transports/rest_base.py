...
class _BaseRegionsServiceRestTransport(RegionsServiceTransport):
    ...
    class _BaseBatchCreateRegions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/accounts/v1/{parent=accounts/*}/regions:batchCreate',
                'body': '*',
            },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = regions.BatchCreateRegionsRequest.pb(request)
    ...
    class _BaseBatchDeleteRegions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/accounts/v1/{parent=accounts/*}/regions:batchDelete',
                'body': '*',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = regions.BatchDeleteRegionsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseBatchUpdateRegions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/accounts/v1/{parent=accounts/*}/regions:batchUpdate',
                'body': '*',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = regions.BatchUpdateRegionsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseCreateRegion:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/accounts/v1/{parent=accounts/*}/regions',
                'body': 'region',
            },
            ]
            return http_options
    ...
    class _BaseDeleteRegion:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/accounts/v1/{name=accounts/*/regions/*}',
            },
            ]
            return http_options
    ...
    class _BaseUpdateRegion:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/accounts/v1/{region.name=accounts/*/regions/*}',
                'body': 'region',
            },
            ]
            return http_options
...
__all__=(
    '_BaseRegionsServiceRestTransport',
)

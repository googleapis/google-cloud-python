...
class ShippingSettingsServiceClient(metaclass=ShippingSettingsServiceClientMeta):
    ...
    @staticmethod
    def shipping_settings_path(account: str,) -> str:
        """Returns a fully-qualified shipping_settings string."""
        return "accounts/{account}/shippingSettings".format(account=account, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ShippingSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ShippingSettingsServiceTransport, Callable[..., ShippingSettingsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ShippingSettingsServiceClient._read_environment_variables()
        self._client_cert_source = ShippingSettingsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ShippingSettingsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ShippingSettingsServiceTransport], Callable[..., ShippingSettingsServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1.ShippingSettingsServiceClient`.",
                    extra = {
    ...
    def get_shipping_settings(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.GetShippingSettingsRequest, dict]):
    ...
    def insert_shipping_settings(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.InsertShippingSettingsRequest, dict]):

...
class ShippingSettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_shipping_settings(self, request: shippingsettings.GetShippingSettingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[shippingsettings.GetShippingSettingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_shipping_settings_with_metadata(self, response: shippingsettings.ShippingSettings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[shippingsettings.ShippingSettings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_shipping_settings
    ...
    def pre_insert_shipping_settings(self, request: shippingsettings.InsertShippingSettingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[shippingsettings.InsertShippingSettingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_insert_shipping_settings_with_metadata(self, response: shippingsettings.ShippingSettings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[shippingsettings.ShippingSettings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for insert_shipping_settings
...
class ShippingSettingsServiceRestTransport(_BaseShippingSettingsServiceRestTransport):
    ...
    class _GetShippingSettings(_BaseShippingSettingsServiceRestTransport._BaseGetShippingSettings, ShippingSettingsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ShippingSettingsServiceRestTransport._GetShippingSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _InsertShippingSettings(_BaseShippingSettingsServiceRestTransport._BaseInsertShippingSettings, ShippingSettingsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ShippingSettingsServiceRestTransport._InsertShippingSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class AutofeedSettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_autofeed_settings(self, request: autofeedsettings.GetAutofeedSettingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[autofeedsettings.GetAutofeedSettingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_autofeed_settings_with_metadata(self, response: autofeedsettings.AutofeedSettings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[autofeedsettings.AutofeedSettings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_autofeed_settings
    ...
    def pre_update_autofeed_settings(self, request: autofeedsettings.UpdateAutofeedSettingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[autofeedsettings.UpdateAutofeedSettingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_autofeed_settings_with_metadata(self, response: autofeedsettings.AutofeedSettings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[autofeedsettings.AutofeedSettings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_autofeed_settings
...
class AutofeedSettingsServiceRestTransport(_BaseAutofeedSettingsServiceRestTransport):
    ...
    class _GetAutofeedSettings(_BaseAutofeedSettingsServiceRestTransport._BaseGetAutofeedSettings, AutofeedSettingsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AutofeedSettingsServiceRestTransport._GetAutofeedSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateAutofeedSettings(_BaseAutofeedSettingsServiceRestTransport._BaseUpdateAutofeedSettings, AutofeedSettingsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AutofeedSettingsServiceRestTransport._UpdateAutofeedSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

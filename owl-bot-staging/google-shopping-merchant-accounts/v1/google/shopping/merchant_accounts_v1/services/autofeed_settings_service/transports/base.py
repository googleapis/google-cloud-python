...
class AutofeedSettingsServiceTransport(abc.ABC):
    """Abstract transport class for AutofeedSettingsService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_autofeed_settings: gapic_v1.method.wrap_method(
                self.get_autofeed_settings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_autofeed_settings: gapic_v1.method.wrap_method(
    ...
    @property
    def get_autofeed_settings(self) -> Callable[
    ...
    @property
    def update_autofeed_settings(self) -> Callable[

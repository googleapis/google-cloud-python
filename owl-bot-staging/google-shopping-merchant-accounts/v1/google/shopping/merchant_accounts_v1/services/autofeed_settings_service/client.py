...
class AutofeedSettingsServiceClient(metaclass=AutofeedSettingsServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1.AutofeedSettingsServiceClient`.",
                    extra = {
    ...
    def get_autofeed_settings(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.GetAutofeedSettingsRequest, dict]):
    ...
    def update_autofeed_settings(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.UpdateAutofeedSettingsRequest, dict]):

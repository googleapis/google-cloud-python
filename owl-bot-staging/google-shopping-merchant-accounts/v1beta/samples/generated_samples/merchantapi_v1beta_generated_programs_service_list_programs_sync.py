...
# [START merchantapi_v1beta_generated_ProgramsService_ListPrograms_sync]
...
def sample_list_programs():
    # Create a client
    client = merchant_accounts_v1beta.ProgramsServiceClient()

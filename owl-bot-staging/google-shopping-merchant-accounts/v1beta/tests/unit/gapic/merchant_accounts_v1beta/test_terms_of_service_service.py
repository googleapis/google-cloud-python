...
def test_get_terms_of_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = termsofservice.TermsOfService.to_json(termsofservice.TermsOfService())
...
def test_get_terms_of_service_rest_bad_request(transport: str = 'rest', request_type=termsofservice.GetTermsOfServiceRequest):
    client = TermsOfServiceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_retrieve_latest_terms_of_service_rest_bad_request(transport: str = 'rest', request_type=termsofservice.RetrieveLatestTermsOfServiceRequest):
    client = TermsOfServiceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_accept_terms_of_service_rest_bad_request(transport: str = 'rest', request_type=termsofservice.AcceptTermsOfServiceRequest):
    client = TermsOfServiceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

...
def test_get_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UserServiceRestInterceptor, "post_get_user_with_metadata") as post_with_metadata, \
...
def test_create_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UserServiceRestInterceptor, "post_create_user_with_metadata") as post_with_metadata, \
...
def test_update_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UserServiceRestInterceptor, "post_update_user_with_metadata") as post_with_metadata, \
...
def test_list_users_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UserServiceRestInterceptor, "post_list_users_with_metadata") as post_with_metadata, \

...
from google.shopping.merchant_accounts_v1beta.services.user_service import UserServiceAsyncClient
from google.shopping.merchant_accounts_v1beta.services.user_service import UserServiceClient
from google.shopping.merchant_accounts_v1beta.services.user_service import pagers
from google.shopping.merchant_accounts_v1beta.services.user_service import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert UserServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert UserServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert UserServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert UserServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert UserServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert UserServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert UserServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert UserServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert UserServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert UserServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(UserServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(UserServiceClient))
@mock.patch.object(UserServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(UserServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = UserServiceClient._DEFAULT_UNIVERSE
    default_endpoint = UserServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = UserServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert UserServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert UserServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == UserServiceClient.DEFAULT_MTLS_ENDPOINT
    assert UserServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert UserServiceClient._get_api_endpoint(None, None, default_universe, "always") == UserServiceClient.DEFAULT_MTLS_ENDPOINT
    assert UserServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == UserServiceClient.DEFAULT_MTLS_ENDPOINT
    assert UserServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert UserServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        UserServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert UserServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert UserServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert UserServiceClient._get_universe_domain(None, None) == UserServiceClient._DEFAULT_UNIVERSE
...
def test_user_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (UserServiceClient, transports.UserServiceGrpcTransport, "grpc"),
    (UserServiceAsyncClient, transports.UserServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (UserServiceClient, transports.UserServiceRestTransport, "rest"),
])
@mock.patch.object(UserServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(UserServiceClient))
@mock.patch.object(UserServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(UserServiceAsyncClient))
def test_user_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (UserServiceAsyncClient, transports.UserServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (UserServiceClient, transports.UserServiceGrpcTransport, "grpc", "false"),
    (UserServiceAsyncClient, transports.UserServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_user_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    UserServiceClient, UserServiceAsyncClient
])
@mock.patch.object(UserServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(UserServiceClient))
@mock.patch.object(UserServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(UserServiceAsyncClient))
...
def test_user_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (UserServiceAsyncClient, transports.UserServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (UserServiceClient, transports.UserServiceRestTransport, "rest", None),
])
def test_user_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_user_service_client_client_options_from_dict():
    with mock.patch('google.shopping.merchant_accounts_v1beta.services.user_service.transports.UserServiceGrpcTransport.__init__') as grpc_transport:
...
def test_user_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_get_user(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.get_user),
            '__call__') as call:
...
async def test_get_user_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_user in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_user] = mock_object
...
@pytest.mark.asyncio
async def test_get_user_async(transport: str = 'grpc_asyncio', request_type=user.GetUserRequest):
    client = UserServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_user(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_user),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_user_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = UserServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_user in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_user] = mock_object
...
@pytest.mark.asyncio
async def test_create_user_async(transport: str = 'grpc_asyncio', request_type=gsma_user.CreateUserRequest):
    client = UserServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_user(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_user),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_delete_user_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_user] = mock_object
...
@pytest.mark.asyncio
async def test_delete_user_async(transport: str = 'grpc_asyncio', request_type=user.DeleteUserRequest):
    client = UserServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_user(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_user),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gsma_user.User(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_user_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = UserServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_user in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_user] = mock_object
...
@pytest.mark.asyncio
async def test_update_user_async(transport: str = 'grpc_asyncio', request_type=gsma_user.UpdateUserRequest):
    client = UserServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_users(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_users),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_list_users_empty_call_async():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(user.ListUsersResponse(
            next_page_token='next_page_token_value',
        ))
...
async def test_list_users_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_users] = mock_object
...
@pytest.mark.asyncio
async def test_list_users_async(transport: str = 'grpc_asyncio', request_type=user.ListUsersRequest):
    client = UserServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_users_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, user.User)
                   for i in results)
...
def test_get_user_rest_unset_required_fields():
    transport = transports.UserServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_user_rest_interceptors(null_interceptor):
    transport = transports.UserServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.UserServiceRestInterceptor(),
        )
    client = UserServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UserServiceRestInterceptor, "post_get_user") as post, \
         mock.patch.object(transports.UserServiceRestInterceptor, "pre_get_user") as pre:
        ...
        req.return_value._content = user.User.to_json(user.User())
...
def test_get_user_rest_bad_request(transport: str = 'rest', request_type=user.GetUserRequest):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_user_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/accounts/v1beta/{name=accounts/*/users/*}" % client.transport._host, args[1])
...
def test_create_user_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("userId", )) & set(("parent", "userId", "user", )))
...
def test_create_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UserServiceRestInterceptor, "post_create_user") as post, \
         mock.patch.object(transports.UserServiceRestInterceptor, "pre_create_user") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gsma_user.User.to_json(gsma_user.User())
...
def test_create_user_rest_bad_request(transport: str = 'rest', request_type=gsma_user.CreateUserRequest):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_user_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1beta/{parent=accounts/*}/users" % client.transport._host, args[1])
...
def test_delete_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UserServiceRestInterceptor, "pre_delete_user") as pre:
        pre.assert_not_called()
...
def test_delete_user_rest_bad_request(transport: str = 'rest', request_type=user.DeleteUserRequest):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_user_rest(request_type):
    ...
    request_init["user"] = {'name': 'accounts/sample1/users/sample2', 'state': 1, 'access_rights': [1]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_user_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("user", "updateMask", )))
...
def test_update_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UserServiceRestInterceptor, "post_update_user") as post, \
         mock.patch.object(transports.UserServiceRestInterceptor, "pre_update_user") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_user_rest_bad_request(transport: str = 'rest', request_type=gsma_user.UpdateUserRequest):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_user_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1beta/{user.name=accounts/*/users/*}" % client.transport._host, args[1])
...
def test_list_users_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UserServiceRestInterceptor, "post_list_users") as post, \
         mock.patch.object(transports.UserServiceRestInterceptor, "pre_list_users") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = user.ListUsersResponse.to_json(user.ListUsersResponse())
...
def test_list_users_rest_bad_request(transport: str = 'rest', request_type=user.ListUsersRequest):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = UserServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_user_service_base_transport():
    ...
    with mock.patch('google.shopping.merchant_accounts_v1beta.services.user_service.transports.UserServiceTransport.__init__') as Transport:
...
def test_user_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.shopping.merchant_accounts_v1beta.services.user_service.transports.UserServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_user_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.shopping.merchant_accounts_v1beta.services.user_service.transports.UserServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.UserServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.UserServiceGrpcTransport, transports.UserServiceGrpcAsyncIOTransport])
def test_user_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.UserServiceGrpcTransport, transports.UserServiceGrpcAsyncIOTransport])
def test_user_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.UserServiceGrpcTransport, transports.UserServiceGrpcAsyncIOTransport])
def test_user_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_user_path():
    account = "whelk"
    email = "octopus"
    expected = "accounts/{account}/users/{email}".format(account=account, email=email, )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.UserServiceTransport, '_prep_wrapped_messages') as prep:
        client = UserServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
from google.shopping.merchant_accounts_v1beta.services.checkout_settings_service import CheckoutSettingsServiceAsyncClient
from google.shopping.merchant_accounts_v1beta.services.checkout_settings_service import CheckoutSettingsServiceClient
from google.shopping.merchant_accounts_v1beta.services.checkout_settings_service import transports
...
@mock.patch.object(CheckoutSettingsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CheckoutSettingsServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert CheckoutSettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CheckoutSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CheckoutSettingsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CheckoutSettingsServiceClient._get_api_endpoint(None, None, default_universe, "always") == CheckoutSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CheckoutSettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CheckoutSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    CheckoutSettingsServiceClient, CheckoutSettingsServiceAsyncClient
])
...
def test_checkout_settings_service_client_client_options_from_dict():
    with mock.patch('google.shopping.merchant_accounts_v1beta.services.checkout_settings_service.transports.CheckoutSettingsServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_checkout_settings(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.get_checkout_settings),
            '__call__') as call:
...
def test_create_checkout_settings(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_checkout_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = checkoutsettings.CheckoutSettings(
            name='name_value',
...
def test_update_checkout_settings(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_checkout_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = checkoutsettings.CheckoutSettings(
            name='name_value',
...
def test_delete_checkout_settings(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_checkout_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_checkout_settings_rest_required_fields(request_type=checkoutsettings.GetCheckoutSettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_checkout_settings._get_unset_required_fields(jsonified_request)
...
def test_create_checkout_settings_rest_required_fields(request_type=checkoutsettings.CreateCheckoutSettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_checkout_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_checkout_settings_rest_required_fields(request_type=checkoutsettings.UpdateCheckoutSettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_checkout_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_checkout_settings_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("checkoutSettings", "updateMask", )))
...
def test_update_checkout_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1beta/{checkout_settings.name=accounts/*/programs/*/checkoutSettings}" % client.transport._host, args[1])
...
def test_delete_checkout_settings_rest_required_fields(request_type=checkoutsettings.DeleteCheckoutSettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_checkout_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_checkout_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CheckoutSettingsServiceRestInterceptor, "post_get_checkout_settings") as post, \
        mock.patch.object(transports.CheckoutSettingsServiceRestInterceptor, "post_get_checkout_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CheckoutSettingsServiceRestInterceptor, "pre_get_checkout_settings") as pre:
        ...
        client.get_checkout_settings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_checkout_settings_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'accounts/sample1/programs/sample2'}
    request_init["checkout_settings"] = {'name': 'name_value', 'uri_settings': {'checkout_uri_template': 'checkout_uri_template_value', 'cart_uri_template': 'cart_uri_template_value'}, 'eligible_destinations': [1], 'enrollment_state': 1, 'review_state': 1, 'effective_uri_settings': {}, 'effective_enrollment_state': 1, 'effective_review_state': 1}
...
def test_create_checkout_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CheckoutSettingsServiceRestInterceptor, "post_create_checkout_settings") as post, \
        mock.patch.object(transports.CheckoutSettingsServiceRestInterceptor, "post_create_checkout_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CheckoutSettingsServiceRestInterceptor, "pre_create_checkout_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_checkout_settings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_checkout_settings_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'checkout_settings': {'name': 'accounts/sample1/programs/sample2/checkoutSettings'}}
    request_init["checkout_settings"] = {'name': 'accounts/sample1/programs/sample2/checkoutSettings', 'uri_settings': {'checkout_uri_template': 'checkout_uri_template_value', 'cart_uri_template': 'cart_uri_template_value'}, 'eligible_destinations': [1], 'enrollment_state': 1, 'review_state': 1, 'effective_uri_settings': {}, 'effective_enrollment_state': 1, 'effective_review_state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_checkout_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CheckoutSettingsServiceRestInterceptor, "post_update_checkout_settings") as post, \
        mock.patch.object(transports.CheckoutSettingsServiceRestInterceptor, "post_update_checkout_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CheckoutSettingsServiceRestInterceptor, "pre_update_checkout_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_checkout_settings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_checkout_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CheckoutSettingsServiceRestInterceptor, "pre_delete_checkout_settings") as pre:
        pre.assert_not_called()
        ...
        client.delete_checkout_settings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_checkout_settings_service_base_transport():
    ...
    with mock.patch('google.shopping.merchant_accounts_v1beta.services.checkout_settings_service.transports.CheckoutSettingsServiceTransport.__init__') as Transport:
...
def test_checkout_settings_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.shopping.merchant_accounts_v1beta.services.checkout_settings_service.transports.CheckoutSettingsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_checkout_settings_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.shopping.merchant_accounts_v1beta.services.checkout_settings_service.transports.CheckoutSettingsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CheckoutSettingsServiceTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.CheckoutSettingsServiceGrpcTransport, transports.CheckoutSettingsServiceGrpcAsyncIOTransport])
def test_checkout_settings_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_checkout_settings_path():
    account = "squid"
    program = "clam"
    expected = "accounts/{account}/programs/{program}/checkoutSettings".format(account=account, program=program, )

...
from google.shopping.merchant_accounts_v1beta.services.omnichannel_settings_service import OmnichannelSettingsServiceAsyncClient
from google.shopping.merchant_accounts_v1beta.services.omnichannel_settings_service import OmnichannelSettingsServiceClient
from google.shopping.merchant_accounts_v1beta.services.omnichannel_settings_service import pagers
from google.shopping.merchant_accounts_v1beta.services.omnichannel_settings_service import transports
...
def test_omnichannel_settings_service_client_client_options_from_dict():
    with mock.patch('google.shopping.merchant_accounts_v1beta.services.omnichannel_settings_service.transports.OmnichannelSettingsServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_omnichannel_setting_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/accounts/v1beta/{name=accounts/*/omnichannelSettings/*}" % client.transport._host, args[1])
...
def test_list_omnichannel_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1beta/{parent=accounts/*}/omnichannelSettings" % client.transport._host, args[1])
...
def test_update_omnichannel_setting_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1beta/{omnichannel_setting.name=accounts/*/omnichannelSettings/*}" % client.transport._host, args[1])
...
def test_request_inventory_verification_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1beta/{name=accounts/*/omnichannelSettings/*}:requestInventoryVerification" % client.transport._host, args[1])
...
def test_omnichannel_settings_service_base_transport():
    ...
    with mock.patch('google.shopping.merchant_accounts_v1beta.services.omnichannel_settings_service.transports.OmnichannelSettingsServiceTransport.__init__') as Transport:
...
def test_omnichannel_settings_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.shopping.merchant_accounts_v1beta.services.omnichannel_settings_service.transports.OmnichannelSettingsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_omnichannel_settings_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.shopping.merchant_accounts_v1beta.services.omnichannel_settings_service.transports.OmnichannelSettingsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.OmnichannelSettingsServiceTransport()
        adc.assert_called_once()

...
from google.shopping.merchant_accounts_v1beta.services.shipping_settings_service import ShippingSettingsServiceAsyncClient
from google.shopping.merchant_accounts_v1beta.services.shipping_settings_service import ShippingSettingsServiceClient
from google.shopping.merchant_accounts_v1beta.services.shipping_settings_service import transports
...
def test_shipping_settings_service_client_client_options_from_dict():
    with mock.patch('google.shopping.merchant_accounts_v1beta.services.shipping_settings_service.transports.ShippingSettingsServiceGrpcTransport.__init__') as grpc_transport:
...
async def test_get_shipping_settings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.get_shipping_settings] = mock_object
...
async def test_insert_shipping_settings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.insert_shipping_settings] = mock_object
...
def test_get_shipping_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = shippingsettings.ShippingSettings.to_json(shippingsettings.ShippingSettings())
...
def test_get_shipping_settings_rest_bad_request(transport: str = 'rest', request_type=shippingsettings.GetShippingSettingsRequest):
    client = ShippingSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_shipping_settings_rest_bad_request(transport: str = 'rest', request_type=shippingsettings.InsertShippingSettingsRequest):
    client = ShippingSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_shipping_settings_service_base_transport():
    ...
    with mock.patch('google.shopping.merchant_accounts_v1beta.services.shipping_settings_service.transports.ShippingSettingsServiceTransport.__init__') as Transport:
...
def test_shipping_settings_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.shopping.merchant_accounts_v1beta.services.shipping_settings_service.transports.ShippingSettingsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_shipping_settings_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.shopping.merchant_accounts_v1beta.services.shipping_settings_service.transports.ShippingSettingsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ShippingSettingsServiceTransport()
        adc.assert_called_once()

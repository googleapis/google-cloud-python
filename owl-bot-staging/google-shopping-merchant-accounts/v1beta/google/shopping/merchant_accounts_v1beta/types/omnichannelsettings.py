...
class OmnichannelSetting(proto.Message):
    ...
    Attributes:
        ...
        lsf_type (google.shopping.merchant_accounts_v1beta.types.OmnichannelSetting.LsfType):
            Required. The Local Store Front type for this
            country.
        in_stock (google.shopping.merchant_accounts_v1beta.types.InStock):
            Optional. The InStock URI and state for this
            country.
        pickup (google.shopping.merchant_accounts_v1beta.types.Pickup):
            Optional. The Pickup URI and state for this
            country.
        lfp_link (google.shopping.merchant_accounts_v1beta.types.LfpLink):
            Output only. The established link to a LFP
            provider.
        odo (google.shopping.merchant_accounts_v1beta.types.OnDisplayToOrder):
            Optional. The On Display to Order (ODO)
            policy URI and state for this country.
        about (google.shopping.merchant_accounts_v1beta.types.About):
            Optional. The about page URI and state for
            this country.
        inventory_verification (google.shopping.merchant_accounts_v1beta.types.InventoryVerification):
...
class InStock(proto.Message):
    ...
    Attributes:
        ...
        state (google.shopping.merchant_accounts_v1beta.types.ReviewState.State):
...
class OnDisplayToOrder(proto.Message):
    ...
    (`ODO <https://support.google.com/merchants/answer/14615056?hl=en&ref_topic=15145747&sjid=6892280366904591178-NC>`__).
...
class About(proto.Message):
    ...
    (`impressum <https://support.google.com/merchants/answer/14675634?hl=en&ref_topic=15145634&sjid=6892280366904591178-NC>`__).
...
class InventoryVerification(proto.Message):
    ...
    verification <https://support.google.com/merchants/answer/14684499?hl=en&ref_topic=15145634&sjid=6892280366904591178-NC>`__.

    Attributes:
        state (google.shopping.merchant_accounts_v1beta.types.InventoryVerification.State):
        ...
        contact_state (google.shopping.merchant_accounts_v1beta.types.ReviewState.State):
...
class ListOmnichannelSettingsResponse(proto.Message):
    ...
    Attributes:
        omnichannel_settings (MutableSequence[google.shopping.merchant_accounts_v1beta.types.OmnichannelSetting]):
...
class CreateOmnichannelSettingRequest(proto.Message):
    ...
    Attributes:
        ...
        omnichannel_setting (google.shopping.merchant_accounts_v1beta.types.OmnichannelSetting):

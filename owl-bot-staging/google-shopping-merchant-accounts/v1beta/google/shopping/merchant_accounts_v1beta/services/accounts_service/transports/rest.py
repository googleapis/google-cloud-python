...
class AccountsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_and_configure_account(self, request: accounts.CreateAndConfigureAccountRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.CreateAndConfigureAccountRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_and_configure_account_with_metadata(self, response: accounts.Account, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.Account, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_and_configure_account
    ...
    def pre_delete_account(self, request: accounts.DeleteAccountRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.DeleteAccountRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_account(self, request: accounts.GetAccountRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.GetAccountRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_account_with_metadata(self, response: accounts.Account, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.Account, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_account
    ...
    def pre_list_accounts(self, request: accounts.ListAccountsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.ListAccountsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_accounts_with_metadata(self, response: accounts.ListAccountsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.ListAccountsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_accounts
    ...
    def pre_list_sub_accounts(self, request: accounts.ListSubAccountsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.ListSubAccountsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_sub_accounts_with_metadata(self, response: accounts.ListSubAccountsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.ListSubAccountsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_sub_accounts
    ...
    def pre_update_account(self, request: accounts.UpdateAccountRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.UpdateAccountRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_account_with_metadata(self, response: accounts.Account, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.Account, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_account
...
class AccountsServiceRestTransport(_BaseAccountsServiceRestTransport):
    ...
    class _CreateAndConfigureAccount(_BaseAccountsServiceRestTransport._BaseCreateAndConfigureAccount, AccountsServiceRestStub):
        ...
        account method over HTTP.
            ...
            # Send the request
            response = AccountsServiceRestTransport._CreateAndConfigureAccount._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteAccount(_BaseAccountsServiceRestTransport._BaseDeleteAccount, AccountsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccountsServiceRestTransport._DeleteAccount._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetAccount(_BaseAccountsServiceRestTransport._BaseGetAccount, AccountsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccountsServiceRestTransport._GetAccount._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListAccounts(_BaseAccountsServiceRestTransport._BaseListAccounts, AccountsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccountsServiceRestTransport._ListAccounts._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListSubAccounts(_BaseAccountsServiceRestTransport._BaseListSubAccounts, AccountsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccountsServiceRestTransport._ListSubAccounts._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateAccount(_BaseAccountsServiceRestTransport._BaseUpdateAccount, AccountsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccountsServiceRestTransport._UpdateAccount._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

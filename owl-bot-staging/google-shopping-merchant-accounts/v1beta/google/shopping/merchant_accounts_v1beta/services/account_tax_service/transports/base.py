...
class AccountTaxServiceTransport(abc.ABC):
    """Abstract transport class for AccountTaxService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_account_tax: gapic_v1.method.wrap_method(
                self.get_account_tax,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_account_tax: gapic_v1.method.wrap_method(
                self.list_account_tax,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_account_tax: gapic_v1.method.wrap_method(

...
from .base import AccountTaxServiceTransport, DEFAULT_CLIENT_INFO
...
class _BaseAccountTaxServiceRestTransport(AccountTaxServiceTransport):
    """Base REST backend transport for AccountTaxService.
...
__all__=(
    '_BaseAccountTaxServiceRestTransport',
)

...
from .transports.base import AccountTaxServiceTransport, DEFAULT_CLIENT_INFO
...
class AccountTaxServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(AccountTaxServiceClient).get_transport_class, type(AccountTaxServiceClient))
    ...
    async def get_account_tax(self,
    ...
    async def list_account_tax(self,
    ...
    async def update_account_tax(self,

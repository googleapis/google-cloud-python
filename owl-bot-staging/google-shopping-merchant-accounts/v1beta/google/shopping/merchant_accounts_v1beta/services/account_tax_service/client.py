...
class AccountTaxServiceClient(metaclass=AccountTaxServiceClientMeta):
    ...
    @staticmethod
    def account_tax_path(account: str,tax: str,) -> str:
        """Returns a fully-qualified account_tax string."""
        return "accounts/{account}/accounttax/{tax}".format(account=account, tax=tax, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AccountTaxServiceClient._compare_universes(self.universe_domain, self.transport._credentials))

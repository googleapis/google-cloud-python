...
class AccountTaxServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_account_tax(self, request: account_tax.GetAccountTaxRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[account_tax.GetAccountTaxRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_account_tax(self, request: account_tax.ListAccountTaxRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[account_tax.ListAccountTaxRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_account_tax(self, request: gsma_account_tax.UpdateAccountTaxRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gsma_account_tax.UpdateAccountTaxRequest, Sequence[Tuple[str, str]]]:

...
class AccountTaxServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_account_tax(self, request: account_tax.GetAccountTaxRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[account_tax.GetAccountTaxRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_account_tax_with_metadata(self, response: account_tax.AccountTax, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[account_tax.AccountTax, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_account_tax
    ...
    def pre_list_account_tax(self, request: account_tax.ListAccountTaxRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[account_tax.ListAccountTaxRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_account_tax_with_metadata(self, response: account_tax.ListAccountTaxResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[account_tax.ListAccountTaxResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_account_tax
    ...
    def pre_update_account_tax(self, request: gsma_account_tax.UpdateAccountTaxRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gsma_account_tax.UpdateAccountTaxRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_account_tax_with_metadata(self, response: gsma_account_tax.AccountTax, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gsma_account_tax.AccountTax, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_account_tax
...
class AccountTaxServiceRestTransport(_BaseAccountTaxServiceRestTransport):
    ...
    class _GetAccountTax(_BaseAccountTaxServiceRestTransport._BaseGetAccountTax, AccountTaxServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccountTaxServiceRestTransport._GetAccountTax._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListAccountTax(_BaseAccountTaxServiceRestTransport._BaseListAccountTax, AccountTaxServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccountTaxServiceRestTransport._ListAccountTax._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateAccountTax(_BaseAccountTaxServiceRestTransport._BaseUpdateAccountTax, AccountTaxServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccountTaxServiceRestTransport._UpdateAccountTax._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def get_account_tax(self) -> Callable[
    ...
    @property
    def list_account_tax(self) -> Callable[
    ...
    @property
    def update_account_tax(self) -> Callable[

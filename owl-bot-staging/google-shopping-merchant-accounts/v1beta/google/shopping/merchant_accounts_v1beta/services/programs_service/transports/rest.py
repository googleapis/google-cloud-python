...
from .base import ProgramsServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ProgramsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_disable_program(self, request: programs.DisableProgramRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[programs.DisableProgramRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_disable_program(self, response: programs.Program) -> programs.Program:
        ...
        """
        return response
    def pre_enable_program(self, request: programs.EnableProgramRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[programs.EnableProgramRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_enable_program(self, response: programs.Program) -> programs.Program:
        ...
        """
        return response
    def pre_get_program(self, request: programs.GetProgramRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[programs.GetProgramRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_program(self, response: programs.Program) -> programs.Program:
        ...
        """
        return response
    def pre_list_programs(self, request: programs.ListProgramsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[programs.ListProgramsRequest, Sequence[Tuple[str, str]]]:
...
class ProgramsServiceRestTransport(ProgramsServiceTransport):
    """REST backend transport for ProgramsService.
    ...
    class _DisableProgram(ProgramsServiceRestStub):
        def __hash__(self):
            return hash("DisableProgram")
    ...
    class _EnableProgram(ProgramsServiceRestStub):
        def __hash__(self):
            return hash("EnableProgram")
    ...
    class _GetProgram(ProgramsServiceRestStub):
        def __hash__(self):
            return hash("GetProgram")
    ...
    class _ListPrograms(ProgramsServiceRestStub):
        def __hash__(self):
            return hash("ListPrograms")

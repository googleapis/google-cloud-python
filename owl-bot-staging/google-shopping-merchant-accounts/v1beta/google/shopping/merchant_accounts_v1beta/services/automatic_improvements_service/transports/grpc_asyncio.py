...
from .base import AutomaticImprovementsServiceTransport, DEFAULT_CLIENT_INFO
...
class AutomaticImprovementsServiceGrpcAsyncIOTransport(AutomaticImprovementsServiceTransport):
    ...
    @property
    def get_automatic_improvements(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetAutomaticImprovementsRequest],
    ...
    @property
    def update_automatic_improvements(self) -> Callable[
        ...
        Returns:
            Callable[[~.UpdateAutomaticImprovementsRequest],
                    Awaitable[~.AutomaticImprovements]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_automatic_improvements: self._wrap_method(
                self.get_automatic_improvements,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_automatic_improvements: self._wrap_method(
                self.update_automatic_improvements,
                default_timeout=None,
                client_info=client_info,
            ),
        }

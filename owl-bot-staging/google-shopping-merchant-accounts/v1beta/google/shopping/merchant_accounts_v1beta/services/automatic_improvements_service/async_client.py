...
from .transports.base import AutomaticImprovementsServiceTransport, DEFAULT_CLIENT_INFO
...
class AutomaticImprovementsServiceAsyncClient:
    ...
    _client: AutomaticImprovementsServiceClient
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AutomaticImprovementsServiceAsyncClient: The constructed client.
        """
        return AutomaticImprovementsServiceClient.from_service_account_info.__func__(AutomaticImprovementsServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            AutomaticImprovementsServiceAsyncClient: The constructed client.
        """
        return AutomaticImprovementsServiceClient.from_service_account_file.__func__(AutomaticImprovementsServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return AutomaticImprovementsServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> AutomaticImprovementsServiceTransport:
        ...
        Returns:
            AutomaticImprovementsServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = AutomaticImprovementsServiceClient.get_transport_class
    ...
    def __init__(self, *,
        ...
        """Instantiates the automatic improvements service async client.
        ...
        """
        self._client = AutomaticImprovementsServiceClient(
    ...
    async def get_automatic_improvements(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1beta.types.GetAutomaticImprovementsRequest, dict]]):
    ...
    async def update_automatic_improvements(self,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1beta.types.UpdateAutomaticImprovementsRequest, dict]]):
                The request object. Request message for the ``UpdateAutomaticImprovements``
                method.
            automatic_improvements (:class:`google.shopping.merchant_accounts_v1beta.types.AutomaticImprovements`):
    ...
    async def __aenter__(self) -> "AutomaticImprovementsServiceAsyncClient":
        return self

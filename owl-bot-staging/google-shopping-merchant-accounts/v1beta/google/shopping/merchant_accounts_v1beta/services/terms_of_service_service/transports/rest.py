...
class TermsOfServiceServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_accept_terms_of_service(self, request: termsofservice.AcceptTermsOfServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[termsofservice.AcceptTermsOfServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_terms_of_service(self, request: termsofservice.GetTermsOfServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[termsofservice.GetTermsOfServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_terms_of_service_with_metadata(self, response: termsofservice.TermsOfService, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[termsofservice.TermsOfService, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_terms_of_service
    ...
    def pre_retrieve_latest_terms_of_service(self, request: termsofservice.RetrieveLatestTermsOfServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[termsofservice.RetrieveLatestTermsOfServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_retrieve_latest_terms_of_service_with_metadata(self, response: termsofservice.TermsOfService, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[termsofservice.TermsOfService, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for retrieve_latest_terms_of_service
...
class TermsOfServiceServiceRestTransport(_BaseTermsOfServiceServiceRestTransport):
    ...
    class _AcceptTermsOfService(_BaseTermsOfServiceServiceRestTransport._BaseAcceptTermsOfService, TermsOfServiceServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TermsOfServiceServiceRestTransport._AcceptTermsOfService._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetTermsOfService(_BaseTermsOfServiceServiceRestTransport._BaseGetTermsOfService, TermsOfServiceServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TermsOfServiceServiceRestTransport._GetTermsOfService._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RetrieveLatestTermsOfService(_BaseTermsOfServiceServiceRestTransport._BaseRetrieveLatestTermsOfService, TermsOfServiceServiceRestStub):
        ...
        service method over HTTP.
            ...
            transcoded_request = _BaseTermsOfServiceServiceRestTransport._BaseRetrieveLatestTermsOfService._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = TermsOfServiceServiceRestTransport._RetrieveLatestTermsOfService._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
from .rest_base import _BaseBusinessIdentityServiceRestTransport
...
class BusinessIdentityServiceRestInterceptor:
    """Interceptor for BusinessIdentityService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the BusinessIdentityServiceRestTransport.

    .. code-block:: python
        class MyCustomBusinessIdentityServiceInterceptor(BusinessIdentityServiceRestInterceptor):
            def pre_get_business_identity(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_business_identity(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_update_business_identity(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_business_identity(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = BusinessIdentityServiceRestTransport(interceptor=MyCustomBusinessIdentityServiceInterceptor())
        client = BusinessIdentityServiceClient(transport=transport)


    """
    def pre_get_business_identity(self, request: businessidentity.GetBusinessIdentityRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[businessidentity.GetBusinessIdentityRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for get_business_identity

        Override in a subclass to manipulate the request or metadata
        before they are sent to the BusinessIdentityService server.
        """
        return request, metadata
    ...
    def post_get_business_identity_with_metadata(self, response: businessidentity.BusinessIdentity, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[businessidentity.BusinessIdentity, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_business_identity
    ...
    def pre_update_business_identity(self, request: businessidentity.UpdateBusinessIdentityRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[businessidentity.UpdateBusinessIdentityRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_business_identity_with_metadata(self, response: businessidentity.BusinessIdentity, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[businessidentity.BusinessIdentity, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_business_identity
...
class BusinessIdentityServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: BusinessIdentityServiceRestInterceptor
...
class BusinessIdentityServiceRestTransport(_BaseBusinessIdentityServiceRestTransport):
    ...
    def __init__(self, *,
            ...
            interceptor: Optional[BusinessIdentityServiceRestInterceptor] = None,
    ...
    class _GetBusinessIdentity(_BaseBusinessIdentityServiceRestTransport._BaseGetBusinessIdentity, BusinessIdentityServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BusinessIdentityServiceRestTransport._GetBusinessIdentity._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = businessidentity.BusinessIdentity()
    ...
    class _UpdateBusinessIdentity(_BaseBusinessIdentityServiceRestTransport._BaseUpdateBusinessIdentity, BusinessIdentityServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BusinessIdentityServiceRestTransport._UpdateBusinessIdentity._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

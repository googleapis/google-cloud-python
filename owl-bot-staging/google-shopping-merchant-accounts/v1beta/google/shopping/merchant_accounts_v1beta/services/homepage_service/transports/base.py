...
class HomepageServiceTransport(abc.ABC):
    """Abstract transport class for HomepageService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_homepage: gapic_v1.method.wrap_method(
                self.get_homepage,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_homepage: gapic_v1.method.wrap_method(
                self.update_homepage,
                default_timeout=None,
                client_info=client_info,
            ),
            self.claim_homepage: gapic_v1.method.wrap_method(
                self.claim_homepage,
                default_timeout=None,
                client_info=client_info,
            ),
            self.unclaim_homepage: gapic_v1.method.wrap_method(
    ...
    def update_homepage(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[gsma_homepage.Homepage]
            ]]:
        raise NotImplementedError()

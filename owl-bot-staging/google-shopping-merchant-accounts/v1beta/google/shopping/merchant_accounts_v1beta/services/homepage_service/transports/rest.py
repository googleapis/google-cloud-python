...
class HomepageServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_claim_homepage(self, request: homepage.ClaimHomepageRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[homepage.ClaimHomepageRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_claim_homepage_with_metadata(self, response: homepage.Homepage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[homepage.Homepage, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for claim_homepage
    ...
    def pre_get_homepage(self, request: homepage.GetHomepageRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[homepage.GetHomepageRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_homepage_with_metadata(self, response: homepage.Homepage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[homepage.Homepage, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_homepage
    ...
    def pre_unclaim_homepage(self, request: homepage.UnclaimHomepageRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[homepage.UnclaimHomepageRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_unclaim_homepage_with_metadata(self, response: homepage.Homepage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[homepage.Homepage, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for unclaim_homepage
    ...
    def pre_update_homepage(self, request: gsma_homepage.UpdateHomepageRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gsma_homepage.UpdateHomepageRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_homepage_with_metadata(self, response: gsma_homepage.Homepage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gsma_homepage.Homepage, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_homepage
...
class HomepageServiceRestTransport(_BaseHomepageServiceRestTransport):
    ...
    class _ClaimHomepage(_BaseHomepageServiceRestTransport._BaseClaimHomepage, HomepageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = HomepageServiceRestTransport._ClaimHomepage._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetHomepage(_BaseHomepageServiceRestTransport._BaseGetHomepage, HomepageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = HomepageServiceRestTransport._GetHomepage._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UnclaimHomepage(_BaseHomepageServiceRestTransport._BaseUnclaimHomepage, HomepageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = HomepageServiceRestTransport._UnclaimHomepage._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateHomepage(_BaseHomepageServiceRestTransport._BaseUpdateHomepage, HomepageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = HomepageServiceRestTransport._UpdateHomepage._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def claim_homepage(self) -> Callable[
    ...
    @property
    def get_homepage(self) -> Callable[
    ...
    @property
    def unclaim_homepage(self) -> Callable[
    ...
    @property
    def update_homepage(self) -> Callable[

...
class HomepageServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_claim_homepage(self, request: homepage.ClaimHomepageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[homepage.ClaimHomepageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_homepage(self, request: homepage.GetHomepageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[homepage.GetHomepageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_unclaim_homepage(self, request: homepage.UnclaimHomepageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[homepage.UnclaimHomepageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_homepage(self, request: gsma_homepage.UpdateHomepageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gsma_homepage.UpdateHomepageRequest, Sequence[Tuple[str, str]]]:

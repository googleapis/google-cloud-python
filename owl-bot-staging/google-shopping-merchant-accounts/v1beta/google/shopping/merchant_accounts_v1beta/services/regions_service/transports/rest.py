...
class RegionsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_region(self, request: regions.CreateRegionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[regions.CreateRegionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_region(self, request: regions.DeleteRegionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[regions.DeleteRegionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_region(self, request: regions.GetRegionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[regions.GetRegionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_regions(self, request: regions.ListRegionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[regions.ListRegionsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_region(self, request: regions.UpdateRegionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[regions.UpdateRegionRequest, Sequence[Tuple[str, str]]]:

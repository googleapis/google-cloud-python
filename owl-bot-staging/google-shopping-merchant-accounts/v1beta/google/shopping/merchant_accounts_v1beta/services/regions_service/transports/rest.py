...
class RegionsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_region(self, request: regions.CreateRegionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.CreateRegionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_region_with_metadata(self, response: regions.Region, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.Region, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_region
    ...
    def pre_delete_region(self, request: regions.DeleteRegionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.DeleteRegionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_region(self, request: regions.GetRegionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.GetRegionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_region_with_metadata(self, response: regions.Region, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.Region, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_region
    ...
    def pre_list_regions(self, request: regions.ListRegionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.ListRegionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_regions_with_metadata(self, response: regions.ListRegionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.ListRegionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_regions
    ...
    def pre_update_region(self, request: regions.UpdateRegionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.UpdateRegionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_region_with_metadata(self, response: regions.Region, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[regions.Region, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_region
...
class RegionsServiceRestTransport(_BaseRegionsServiceRestTransport):
    ...
    class _CreateRegion(_BaseRegionsServiceRestTransport._BaseCreateRegion, RegionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionsServiceRestTransport._CreateRegion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteRegion(_BaseRegionsServiceRestTransport._BaseDeleteRegion, RegionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionsServiceRestTransport._DeleteRegion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetRegion(_BaseRegionsServiceRestTransport._BaseGetRegion, RegionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionsServiceRestTransport._GetRegion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListRegions(_BaseRegionsServiceRestTransport._BaseListRegions, RegionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionsServiceRestTransport._ListRegions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateRegion(_BaseRegionsServiceRestTransport._BaseUpdateRegion, RegionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionsServiceRestTransport._UpdateRegion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
from .base import UserServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class UserServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_user(self, request: gsma_user.CreateUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gsma_user.CreateUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_user(self, response: gsma_user.User) -> gsma_user.User:
        ...
        """
        return response
    def pre_delete_user(self, request: user.DeleteUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[user.DeleteUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_user(self, request: user.GetUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[user.GetUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_user(self, response: user.User) -> user.User:
        ...
        """
        return response
    def pre_list_users(self, request: user.ListUsersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[user.ListUsersRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_users(self, response: user.ListUsersResponse) -> user.ListUsersResponse:
        ...
        """
        return response
    def pre_update_user(self, request: gsma_user.UpdateUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gsma_user.UpdateUserRequest, Sequence[Tuple[str, str]]]:

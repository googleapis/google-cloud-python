...
class _BaseUserServiceRestTransport(UserServiceTransport):
    """Base REST backend transport for UserService.
    ...
    class _BaseCreateUser:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseUserServiceRestTransport._BaseCreateUser._get_unset_required_fields(query_params))
    ...
    class _BaseDeleteUser:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseUserServiceRestTransport._BaseDeleteUser._get_unset_required_fields(query_params))
    ...
    class _BaseGetUser:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseUserServiceRestTransport._BaseGetUser._get_unset_required_fields(query_params))
    ...
    class _BaseListUsers:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseUserServiceRestTransport._BaseListUsers._get_unset_required_fields(query_params))
    ...
    class _BaseUpdateUser:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseUserServiceRestTransport._BaseUpdateUser._get_unset_required_fields(query_params))

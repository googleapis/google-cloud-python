...
from .base import UserServiceTransport, DEFAULT_CLIENT_INFO
from .grpc import UserServiceGrpcTransport


class UserServiceGrpcAsyncIOTransport(UserServiceTransport):
    """gRPC AsyncIO backend transport for UserService.
    ...
    def get_user(self) -> Callable[
        ...
        if 'get_user' not in self._stubs:
            self._stubs['get_user'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=user.GetUserRequest.serialize,
    ...
    def create_user(self) -> Callable[
            ...
            Awaitable[gsma_user.User]]:
        r"""Return a callable for the create user method over gRPC.

        Creates a Merchant Center account user. Executing
        ...
        if 'create_user' not in self._stubs:
            self._stubs['create_user'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=gsma_user.CreateUserRequest.serialize,
                response_deserializer=gsma_user.User.deserialize,
            )
    ...
    def delete_user(self) -> Callable[
        ...
        Deletes a Merchant Center account user. Executing
        this method requires admin access.
        ...
        if 'delete_user' not in self._stubs:
            self._stubs['delete_user'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=user.DeleteUserRequest.serialize,
    ...
    def update_user(self) -> Callable[
        ...
        Updates a Merchant Center account user. Executing
        this method requires admin access.
    ...
    def list_users(self) -> Callable[
            ...
            Awaitable[user.ListUsersResponse]]:
        ...
        if 'list_users' not in self._stubs:
            self._stubs['list_users'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=user.ListUsersRequest.serialize,
                response_deserializer=user.ListUsersResponse.deserialize,
            )
...
__all__ = (
    'UserServiceGrpcAsyncIOTransport',
)

...
class EmailPreferencesServiceRestInterceptor:
    """Interceptor for EmailPreferencesService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the EmailPreferencesServiceRestTransport.

    .. code-block:: python
        class MyCustomEmailPreferencesServiceInterceptor(EmailPreferencesServiceRestInterceptor):
            def pre_get_email_preferences(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_email_preferences(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_update_email_preferences(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_email_preferences(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = EmailPreferencesServiceRestTransport(interceptor=MyCustomEmailPreferencesServiceInterceptor())
        client = EmailPreferencesServiceClient(transport=transport)


    """
    def pre_get_email_preferences(self, request: emailpreferences.GetEmailPreferencesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[emailpreferences.GetEmailPreferencesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for get_email_preferences

        Override in a subclass to manipulate the request or metadata
        before they are sent to the EmailPreferencesService server.
        """
        return request, metadata
    ...
    def post_get_email_preferences_with_metadata(self, response: emailpreferences.EmailPreferences, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[emailpreferences.EmailPreferences, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_email_preferences
    ...
    def pre_update_email_preferences(self, request: emailpreferences.UpdateEmailPreferencesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[emailpreferences.UpdateEmailPreferencesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_email_preferences_with_metadata(self, response: emailpreferences.EmailPreferences, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[emailpreferences.EmailPreferences, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_email_preferences
...
class EmailPreferencesServiceRestStub:
...
class EmailPreferencesServiceRestTransport(_BaseEmailPreferencesServiceRestTransport):
    ...
    def __init__(self, *,
            ...
            interceptor: Optional[EmailPreferencesServiceRestInterceptor] = None,
    ...
    class _GetEmailPreferences(_BaseEmailPreferencesServiceRestTransport._BaseGetEmailPreferences, EmailPreferencesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EmailPreferencesServiceRestTransport._GetEmailPreferences._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = emailpreferences.EmailPreferences()
    ...
    class _UpdateEmailPreferences(_BaseEmailPreferencesServiceRestTransport._BaseUpdateEmailPreferences, EmailPreferencesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EmailPreferencesServiceRestTransport._UpdateEmailPreferences._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def get_email_preferences(self) -> Callable[
    ...
    @property
    def update_email_preferences(self) -> Callable[

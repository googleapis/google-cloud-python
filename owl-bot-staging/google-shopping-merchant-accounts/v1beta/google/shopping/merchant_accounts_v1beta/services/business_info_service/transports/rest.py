...
class BusinessInfoServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_business_info(self, request: businessinfo.GetBusinessInfoRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[businessinfo.GetBusinessInfoRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_business_info_with_metadata(self, response: businessinfo.BusinessInfo, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[businessinfo.BusinessInfo, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_business_info
    ...
    def pre_update_business_info(self, request: businessinfo.UpdateBusinessInfoRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[businessinfo.UpdateBusinessInfoRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_business_info_with_metadata(self, response: businessinfo.BusinessInfo, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[businessinfo.BusinessInfo, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_business_info
...
class BusinessInfoServiceRestTransport(_BaseBusinessInfoServiceRestTransport):
    ...
    class _GetBusinessInfo(_BaseBusinessInfoServiceRestTransport._BaseGetBusinessInfo, BusinessInfoServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BusinessInfoServiceRestTransport._GetBusinessInfo._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateBusinessInfo(_BaseBusinessInfoServiceRestTransport._BaseUpdateBusinessInfo, BusinessInfoServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BusinessInfoServiceRestTransport._UpdateBusinessInfo._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

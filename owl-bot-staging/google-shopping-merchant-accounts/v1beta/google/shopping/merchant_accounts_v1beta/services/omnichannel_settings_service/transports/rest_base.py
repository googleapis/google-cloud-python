...
class _BaseOmnichannelSettingsServiceRestTransport(OmnichannelSettingsServiceTransport):
    """Base REST backend transport for OmnichannelSettingsService.
    ...
    class _BaseCreateOmnichannelSetting:
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = omnichannelsettings.CreateOmnichannelSettingRequest.pb(request)
    ...
    class _BaseGetOmnichannelSetting:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = omnichannelsettings.GetOmnichannelSettingRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseListOmnichannelSettings:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = omnichannelsettings.ListOmnichannelSettingsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseRequestInventoryVerification:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/accounts/v1beta/{name=accounts/*/omnichannelSettings/*}:requestInventoryVerification',
                'body': '*',
            },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseOmnichannelSettingsServiceRestTransport._BaseRequestInventoryVerification._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseUpdateOmnichannelSetting:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/accounts/v1beta/{omnichannel_setting.name=accounts/*/omnichannelSettings/*}',
                'body': 'omnichannel_setting',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = omnichannelsettings.UpdateOmnichannelSettingRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request

...
class OmnichannelSettingsServiceClient(metaclass=OmnichannelSettingsServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        self._client_cert_source = OmnichannelSettingsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
    ...
    def get_omnichannel_setting(self,
    ...
    def list_omnichannel_settings(self,
    ...
    def create_omnichannel_setting(self,
    ...
    def update_omnichannel_setting(self,
    ...
    def request_inventory_verification(self,

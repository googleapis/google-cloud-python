...
class CheckoutSettingsServiceClient(metaclass=CheckoutSettingsServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1beta.CheckoutSettingsServiceClient`.",
                    extra = {
    ...
    def get_checkout_settings(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.GetCheckoutSettingsRequest, dict]):
    ...
    def create_checkout_settings(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.CreateCheckoutSettingsRequest, dict]):
    ...
    def update_checkout_settings(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.UpdateCheckoutSettingsRequest, dict]):
    ...
    def delete_checkout_settings(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.DeleteCheckoutSettingsRequest, dict]):

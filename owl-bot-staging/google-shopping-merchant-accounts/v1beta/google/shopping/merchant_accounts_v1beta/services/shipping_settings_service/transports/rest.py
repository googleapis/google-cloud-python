...
from .base import ShippingSettingsServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ShippingSettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_shipping_settings(self, request: shippingsettings.GetShippingSettingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[shippingsettings.GetShippingSettingsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_shipping_settings(self, response: shippingsettings.ShippingSettings) -> shippingsettings.ShippingSettings:
        ...
        """
        return response
    def pre_insert_shipping_settings(self, request: shippingsettings.InsertShippingSettingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[shippingsettings.InsertShippingSettingsRequest, Sequence[Tuple[str, str]]]:

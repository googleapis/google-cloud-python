...
class OnlineReturnPolicyServiceTransport(abc.ABC):
    """Abstract transport class for OnlineReturnPolicyService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_online_return_policy: gapic_v1.method.wrap_method(
                self.get_online_return_policy,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_online_return_policies: gapic_v1.method.wrap_method(
    ...
    @property
    def get_online_return_policy(self) -> Callable[
    ...
    @property
    def list_online_return_policies(self) -> Callable[
    ...
    @property
    def create_online_return_policy(self) -> Callable[
    ...
    @property
    def update_online_return_policy(self) -> Callable[
    ...
    @property
    def delete_online_return_policy(self) -> Callable[

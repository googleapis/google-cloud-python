...
from .transports.base import OnlineReturnPolicyServiceTransport, DEFAULT_CLIENT_INFO
...
class OnlineReturnPolicyServiceAsyncClient:
    ...
    async def get_online_return_policy(self,
    ...
    async def list_online_return_policies(self,
    ...
    async def create_online_return_policy(self,
            request: Optional[Union[online_return_policy.CreateOnlineReturnPolicyRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, online_return_policy.CreateOnlineReturnPolicyRequest):
    ...
    async def update_online_return_policy(self,
    ...
    async def delete_online_return_policy(self,

...
class OnlineReturnPolicyServiceClient(metaclass=OnlineReturnPolicyServiceClientMeta):
    ...
    @staticmethod
    def online_return_policy_path(account: str,return_policy: str,) -> str:
    ...
    def __init__(self, *,
        ...
        self._client_cert_source = OnlineReturnPolicyServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1beta.OnlineReturnPolicyServiceClient`.",
                    extra = {
    ...
    def get_online_return_policy(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.GetOnlineReturnPolicyRequest, dict]):
    ...
    def list_online_return_policies(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.ListOnlineReturnPoliciesRequest, dict]):
    ...
    def create_online_return_policy(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.CreateOnlineReturnPolicyRequest, dict]):
    ...
    def update_online_return_policy(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.UpdateOnlineReturnPolicyRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_online_return_policy]
    ...
    def delete_online_return_policy(self,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.DeleteOnlineReturnPolicyRequest, dict]):

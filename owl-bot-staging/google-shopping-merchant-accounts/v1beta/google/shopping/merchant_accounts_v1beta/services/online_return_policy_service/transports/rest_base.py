...
class _BaseOnlineReturnPolicyServiceRestTransport(OnlineReturnPolicyServiceTransport):
    ...
    class _BaseCreateOnlineReturnPolicy:
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = online_return_policy.CreateOnlineReturnPolicyRequest.pb(request)
    ...
    class _BaseUpdateOnlineReturnPolicy:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/accounts/v1beta/{online_return_policy.name=accounts/*/onlineReturnPolicies/*}',
                'body': 'online_return_policy',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = gsma_online_return_policy.UpdateOnlineReturnPolicyRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseOnlineReturnPolicyServiceRestTransport._BaseUpdateOnlineReturnPolicy._get_unset_required_fields(query_params))

...
class TermsOfServiceAgreementStateServiceAsyncClient:
    ...
    DEFAULT_MTLS_ENDPOINT = TermsOfServiceAgreementStateServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = TermsOfServiceAgreementStateServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    parse_account_path = staticmethod(TermsOfServiceAgreementStateServiceClient.parse_account_path)
    terms_of_service_path = staticmethod(TermsOfServiceAgreementStateServiceClient.terms_of_service_path)
    parse_terms_of_service_path = staticmethod(TermsOfServiceAgreementStateServiceClient.parse_terms_of_service_path)
    terms_of_service_agreement_state_path = staticmethod(TermsOfServiceAgreementStateServiceClient.terms_of_service_agreement_state_path)
    parse_terms_of_service_agreement_state_path = staticmethod(TermsOfServiceAgreementStateServiceClient.parse_terms_of_service_agreement_state_path)
    common_billing_account_path = staticmethod(TermsOfServiceAgreementStateServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(TermsOfServiceAgreementStateServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(TermsOfServiceAgreementStateServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(TermsOfServiceAgreementStateServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(TermsOfServiceAgreementStateServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(TermsOfServiceAgreementStateServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(TermsOfServiceAgreementStateServiceClient.common_project_path)
    parse_common_project_path = staticmethod(TermsOfServiceAgreementStateServiceClient.parse_common_project_path)
    common_location_path = staticmethod(TermsOfServiceAgreementStateServiceClient.common_location_path)
    parse_common_location_path = staticmethod(TermsOfServiceAgreementStateServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(TermsOfServiceAgreementStateServiceClient).get_transport_class, type(TermsOfServiceAgreementStateServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, TermsOfServiceAgreementStateServiceTransport, Callable[..., TermsOfServiceAgreementStateServiceTransport]]] = "grpc_asyncio",
    ...
    async def get_terms_of_service_agreement_state(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_terms_of_service_agreement_state]
    ...
    async def retrieve_for_application_terms_of_service_agreement_state(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.retrieve_for_application_terms_of_service_agreement_state]

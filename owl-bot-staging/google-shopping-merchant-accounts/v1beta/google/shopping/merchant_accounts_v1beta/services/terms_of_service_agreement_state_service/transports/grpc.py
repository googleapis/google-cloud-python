...
from .base import TermsOfServiceAgreementStateServiceTransport, DEFAULT_CLIENT_INFO
...
class TermsOfServiceAgreementStateServiceGrpcTransport(TermsOfServiceAgreementStateServiceTransport):
    """gRPC backend transport for TermsOfServiceAgreementStateService.
    ...
    @property
    def get_terms_of_service_agreement_state(self) -> Callable[
        ...
        r"""Return a callable for the get terms of service agreement
        state method over gRPC.

        Returns the state of a terms of service agreement.

        Returns:
            Callable[[~.GetTermsOfServiceAgreementStateRequest],
        ...
        if 'get_terms_of_service_agreement_state' not in self._stubs:
            self._stubs['get_terms_of_service_agreement_state'] = self._logged_channel.unary_unary(
    ...
    @property
    def retrieve_for_application_terms_of_service_agreement_state(self) -> Callable[
            [termsofserviceagreementstate.RetrieveForApplicationTermsOfServiceAgreementStateRequest],
            termsofserviceagreementstate.TermsOfServiceAgreementState]:
        r"""Return a callable for the retrieve for application terms
        of service agreement state method over gRPC.

        Retrieves the state of the agreement for the
        application terms of service.

        Returns:
            Callable[[~.RetrieveForApplicationTermsOfServiceAgreementStateRequest],
                    ~.TermsOfServiceAgreementState]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'retrieve_for_application_terms_of_service_agreement_state' not in self._stubs:
            self._stubs['retrieve_for_application_terms_of_service_agreement_state'] = self._logged_channel.unary_unary(

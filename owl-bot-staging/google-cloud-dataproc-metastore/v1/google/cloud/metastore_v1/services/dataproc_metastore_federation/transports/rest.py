...
from .rest_base import _BaseDataprocMetastoreFederationRestTransport
...
class DataprocMetastoreFederationRestInterceptor:
    """Interceptor for DataprocMetastoreFederation.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the DataprocMetastoreFederationRestTransport.

    .. code-block:: python
        class MyCustomDataprocMetastoreFederationInterceptor(DataprocMetastoreFederationRestInterceptor):
            def pre_create_federation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_create_federation(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_delete_federation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_delete_federation(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_get_federation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_federation(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_federations(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_federations(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_update_federation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_federation(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = DataprocMetastoreFederationRestTransport(interceptor=MyCustomDataprocMetastoreFederationInterceptor())
        client = DataprocMetastoreFederationClient(transport=transport)


    """
    def pre_create_federation(self, request: metastore_federation.CreateFederationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore_federation.CreateFederationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for create_federation

        Override in a subclass to manipulate the request or metadata
        before they are sent to the DataprocMetastoreFederation server.
        """
        return request, metadata
    ...
    def post_create_federation_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_federation
    ...
    def pre_delete_federation(self, request: metastore_federation.DeleteFederationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore_federation.DeleteFederationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_federation_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_federation
    ...
    def pre_get_federation(self, request: metastore_federation.GetFederationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore_federation.GetFederationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_federation_with_metadata(self, response: metastore_federation.Federation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore_federation.Federation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_federation
    ...
    def pre_list_federations(self, request: metastore_federation.ListFederationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore_federation.ListFederationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_federations_with_metadata(self, response: metastore_federation.ListFederationsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore_federation.ListFederationsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_federations
    ...
    def pre_update_federation(self, request: metastore_federation.UpdateFederationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[metastore_federation.UpdateFederationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_federation_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_federation
...
class DataprocMetastoreFederationRestStub:
...
class DataprocMetastoreFederationRestTransport(_BaseDataprocMetastoreFederationRestTransport):
    ...
    def __init__(self, *,
            ...
            interceptor: Optional[DataprocMetastoreFederationRestInterceptor] = None,
        ...
        self._interceptor = interceptor or DataprocMetastoreFederationRestInterceptor()
    ...
    class _CreateFederation(_BaseDataprocMetastoreFederationRestTransport._BaseCreateFederation, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the create federation method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.CreateFederation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "CreateFederation",
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._CreateFederation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationClient.create_federation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "CreateFederation",
    ...
    class _DeleteFederation(_BaseDataprocMetastoreFederationRestTransport._BaseDeleteFederation, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the delete federation method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.DeleteFederation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "DeleteFederation",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._DeleteFederation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationClient.delete_federation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "DeleteFederation",
                        "metadata": http_response["headers"],
    ...
    class _GetFederation(_BaseDataprocMetastoreFederationRestTransport._BaseGetFederation, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the get federation method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.GetFederation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "GetFederation",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._GetFederation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = metastore_federation.Federation()
            pb_resp = metastore_federation.Federation.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationClient.get_federation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "GetFederation",
                        "metadata": http_response["headers"],
    ...
    class _ListFederations(_BaseDataprocMetastoreFederationRestTransport._BaseListFederations, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the list federations method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.ListFederations",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "ListFederations",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._ListFederations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = metastore_federation.ListFederationsResponse()
            pb_resp = metastore_federation.ListFederationsResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationClient.list_federations",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "ListFederations",
                        "metadata": http_response["headers"],
    ...
    class _UpdateFederation(_BaseDataprocMetastoreFederationRestTransport._BaseUpdateFederation, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the update federation method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.UpdateFederation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "UpdateFederation",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._UpdateFederation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationClient.update_federation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "UpdateFederation",
                        "metadata": http_response["headers"],
    ...
    class _GetLocation(_BaseDataprocMetastoreFederationRestTransport._BaseGetLocation, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(_BaseDataprocMetastoreFederationRestTransport._BaseListLocations, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _GetIamPolicy(_BaseDataprocMetastoreFederationRestTransport._BaseGetIamPolicy, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.GetIamPolicy",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationAsyncClient.GetIamPolicy",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(_BaseDataprocMetastoreFederationRestTransport._BaseSetIamPolicy, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.SetIamPolicy",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationAsyncClient.SetIamPolicy",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(_BaseDataprocMetastoreFederationRestTransport._BaseTestIamPermissions, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.TestIamPermissions",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationAsyncClient.TestIamPermissions",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseDataprocMetastoreFederationRestTransport._BaseCancelOperation, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteOperation(_BaseDataprocMetastoreFederationRestTransport._BaseDeleteOperation, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.DeleteOperation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseDataprocMetastoreFederationRestTransport._BaseGetOperation, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseDataprocMetastoreFederationRestTransport._BaseListOperations, DataprocMetastoreFederationRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.metastore_v1.DataprocMetastoreFederationClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
            ...
            # Send the request
            response = DataprocMetastoreFederationRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.metastore_v1.DataprocMetastoreFederationAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.metastore.v1.DataprocMetastoreFederation",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

...
class _BaseDataprocMetastoreRestTransport(DataprocMetastoreTransport):
    ...
    class _BaseRestoreService:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{service=projects/*/locations/*/services/*}:restore',
                'body': '*',
            },
            ]
            return http_options
    ...
    class _BaseUpdateMetadataImport:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1/{metadata_import.name=projects/*/locations/*/services/*/metadataImports/*}',
                'body': 'metadata_import',
            },
            ]
            return http_options
    ...
    class _BaseUpdateService:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1/{service.name=projects/*/locations/*/services/*}',
                'body': 'service',
            },
            ]
            return http_options
...
__all__=(
    '_BaseDataprocMetastoreRestTransport',
)

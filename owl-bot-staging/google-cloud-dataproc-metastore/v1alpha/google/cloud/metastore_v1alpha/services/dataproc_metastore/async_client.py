...
class DataprocMetastoreAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = DataprocMetastoreClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = DataprocMetastoreClient._DEFAULT_UNIVERSE
    ...
    get_transport_class = DataprocMetastoreClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, DataprocMetastoreTransport, Callable[..., DataprocMetastoreTransport]]] = "grpc_asyncio",
        ...
        Args:
            ...
            transport (Optional[Union[str,DataprocMetastoreTransport,Callable[..., DataprocMetastoreTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the DataprocMetastoreTransport constructor.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.metastore_v1alpha.DataprocMetastoreAsyncClient`.",
                extra = {
    ...
    async def list_services(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.ListServicesRequest, dict]]):
    ...
    async def get_service(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.GetServiceRequest, dict]]):
                The request object. Request message for
    ...
    async def create_service(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.CreateServiceRequest, dict]]):
                The request object. Request message for
    ...
    async def update_service(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.UpdateServiceRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_service(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.DeleteServiceRequest, dict]]):
                The request object. Request message for
    ...
    async def list_metadata_imports(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.ListMetadataImportsRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_metadata_imports]
    ...
    async def get_metadata_import(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.GetMetadataImportRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_metadata_import]
    ...
    async def create_metadata_import(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.CreateMetadataImportRequest, dict]]):
                The request object. Request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, metadata_import, metadata_import_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_metadata_import]
    ...
    async def update_metadata_import(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.UpdateMetadataImportRequest, dict]]):
                The request object. Request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [metadata_import, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_metadata_import]
    ...
    async def export_metadata(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.ExportMetadataRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_metadata]
    ...
    async def restore_service(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [service, backup]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.restore_service]
    ...
    async def list_backups(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.ListBackupsRequest, dict]]):
                The request object. Request message for
    ...
    async def get_backup(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.GetBackupRequest, dict]]):
                The request object. Request message for
    ...
    async def create_backup(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.CreateBackupRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            backup (:class:`google.cloud.metastore_v1alpha.types.Backup`):
    ...
    async def delete_backup(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1alpha.types.DeleteBackupRequest, dict]]):
                The request object. Request message for
    ...
    async def remove_iam_policy(self,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, metastore.RemoveIamPolicyRequest):
            request = metastore.RemoveIamPolicyRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.remove_iam_policy]
    ...
    async def query_metadata(self,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, metastore.QueryMetadataRequest):
            request = metastore.QueryMetadataRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.query_metadata]
    ...
    async def move_table_to_database(self,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, metastore.MoveTableToDatabaseRequest):
            request = metastore.MoveTableToDatabaseRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.move_table_to_database]
    ...
    async def alter_metadata_resource_location(self,
            request: Optional[Union[metastore.AlterMetadataResourceLocationRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, metastore.AlterMetadataResourceLocationRequest):
            request = metastore.AlterMetadataResourceLocationRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.alter_metadata_resource_location]
    ...
    async def __aenter__(self) -> "DataprocMetastoreAsyncClient":
        return self

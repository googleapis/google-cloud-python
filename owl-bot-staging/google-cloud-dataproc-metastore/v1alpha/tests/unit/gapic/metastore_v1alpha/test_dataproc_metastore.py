...
def test__get_api_endpoint():
    ...
    assert DataprocMetastoreClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DataprocMetastoreClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert DataprocMetastoreClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DataprocMetastoreClient.DEFAULT_MTLS_ENDPOINT
...
def test_list_services_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_list_services_with_metadata") as post_with_metadata, \
...
def test_get_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_get_service_with_metadata") as post_with_metadata, \
...
def test_create_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_create_service_with_metadata") as post_with_metadata, \
...
def test_update_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_update_service_with_metadata") as post_with_metadata, \
...
def test_delete_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_delete_service_with_metadata") as post_with_metadata, \
...
def test_list_metadata_imports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_list_metadata_imports_with_metadata") as post_with_metadata, \
...
def test_get_metadata_import_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_get_metadata_import_with_metadata") as post_with_metadata, \
...
def test_create_metadata_import_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_create_metadata_import_with_metadata") as post_with_metadata, \
...
def test_update_metadata_import_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_update_metadata_import_with_metadata") as post_with_metadata, \
...
def test_export_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_export_metadata_with_metadata") as post_with_metadata, \
...
def test_restore_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_restore_service_with_metadata") as post_with_metadata, \
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_list_backups_with_metadata") as post_with_metadata, \
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_get_backup_with_metadata") as post_with_metadata, \
...
def test_create_backup_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/services/sample3'}
    request_init["backup"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}, 'state': 1, 'service_revision': {'hive_metastore_config': {'version': 'version_value', 'config_overrides': {}, 'kerberos_config': {'keytab': {'cloud_secret': 'cloud_secret_value'}, 'principal': 'principal_value', 'krb5_config_gcs_uri': 'krb5_config_gcs_uri_value'}, 'endpoint_protocol': 1, 'auxiliary_versions': {}}, 'name': 'name_value', 'create_time': {}, 'update_time': {}, 'labels': {}, 'network': 'network_value', 'endpoint_uri': 'endpoint_uri_value', 'port': 453, 'state': 1, 'state_message': 'state_message_value', 'artifact_gcs_uri': 'artifact_gcs_uri_value', 'tier': 1, 'metadata_integration': {'data_catalog_config': {'enabled': True}, 'dataplex_config': {'lake_resources': {}}}, 'maintenance_window': {'hour_of_day': {'value': 541}, 'day_of_week': 1}, 'uid': 'uid_value', 'metadata_management_activity': {'metadata_exports': [{'destination_gcs_uri': 'destination_gcs_uri_value', 'start_time': {}, 'end_time': {}, 'state': 1, 'database_dump_type': 1}], 'restores': [{'start_time': {}, 'end_time': {}, 'state': 1, 'backup': 'backup_value', 'type_': 1, 'details': 'details_value'}]}, 'release_channel': 1, 'encryption_config': {'kms_key': 'kms_key_value'}, 'network_config': {'consumers': [{'subnetwork': 'subnetwork_value', 'endpoint_uri': 'endpoint_uri_value', 'endpoint_location': 'endpoint_location_value'}], 'custom_routes_enabled': True}, 'database_type': 1, 'telemetry_config': {'log_format': 1}, 'scaling_config': {'instance_size': 1, 'scaling_factor': 0.1471}}, 'description': 'description_value', 'restoring_services': ['restoring_services_value1', 'restoring_services_value2']}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_create_backup_with_metadata") as post_with_metadata, \
...
def test_delete_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_delete_backup_with_metadata") as post_with_metadata, \
...
def test_remove_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_remove_iam_policy_with_metadata") as post_with_metadata, \
...
def test_query_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_query_metadata_with_metadata") as post_with_metadata, \
...
def test_move_table_to_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_move_table_to_database_with_metadata") as post_with_metadata, \
...
def test_alter_metadata_resource_location_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_alter_metadata_resource_location_with_metadata") as post_with_metadata, \

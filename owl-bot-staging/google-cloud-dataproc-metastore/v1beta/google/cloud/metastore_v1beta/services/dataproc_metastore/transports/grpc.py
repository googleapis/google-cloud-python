...
class DataprocMetastoreGrpcTransport(DataprocMetastoreTransport):
    ...
    @property
    def remove_iam_policy(self) -> Callable[
    ...
    @property
    def query_metadata(self) -> Callable[
    ...
    @property
    def move_table_to_database(self) -> Callable[
    ...
    @property
    def alter_metadata_resource_location(self) -> Callable[
        ...
        if 'alter_metadata_resource_location' not in self._stubs:
            self._stubs['alter_metadata_resource_location'] = self.grpc_channel.unary_unary(

...
from .transports.base import DataprocMetastoreFederationTransport, DEFAULT_CLIENT_INFO
...
class DataprocMetastoreFederationAsyncClient:
    ...
    get_transport_class = functools.partial(type(DataprocMetastoreFederationClient).get_transport_class, type(DataprocMetastoreFederationClient))
    ...
    async def list_federations(self,
    ...
    async def create_federation(self,
    ...
    async def update_federation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1beta.types.UpdateFederationRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, metastore_federation.UpdateFederationRequest):
    ...
    async def delete_federation(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_federation():
                ...
                # Initialize request argument(s)
                request = metastore_v1beta.DeleteFederationRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.metastore_v1beta.types.DeleteFederationRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, metastore_federation.DeleteFederationRequest):
    ...
    async def __aenter__(self) -> "DataprocMetastoreFederationAsyncClient":
        return self

...
class DataprocMetastoreFederationTransport(abc.ABC):
    ...
    @property
    def list_federations(self) -> Callable[
    ...
    @property
    def get_federation(self) -> Callable[
    ...
    @property
    def create_federation(self) -> Callable[
    ...
    @property
    def update_federation(self) -> Callable[
    ...
    @property
    def delete_federation(self) -> Callable[

...
def test_list_federations_rest_required_fields(request_type=metastore_federation.ListFederationsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_federations._get_unset_required_fields(jsonified_request)
...
def test_list_federations_rest_unset_required_fields():
    transport = transports.DataprocMetastoreFederationRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_federation_rest_required_fields(request_type=metastore_federation.GetFederationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_federation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_federation_rest_required_fields(request_type=metastore_federation.CreateFederationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_federation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_federation_rest_required_fields(request_type=metastore_federation.UpdateFederationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_federation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_federation_rest_required_fields(request_type=metastore_federation.DeleteFederationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_federation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

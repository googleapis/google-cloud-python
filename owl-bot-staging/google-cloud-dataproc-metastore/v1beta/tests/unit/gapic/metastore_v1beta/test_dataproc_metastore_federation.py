...
def test__read_environment_variables():
    assert DataprocMetastoreFederationClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert DataprocMetastoreFederationClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert DataprocMetastoreFederationClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert DataprocMetastoreFederationClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert DataprocMetastoreFederationClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert DataprocMetastoreFederationClient._get_client_cert_source(None, False) is None
    assert DataprocMetastoreFederationClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert DataprocMetastoreFederationClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert DataprocMetastoreFederationClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert DataprocMetastoreFederationClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(DataprocMetastoreFederationClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataprocMetastoreFederationClient))
@mock.patch.object(DataprocMetastoreFederationAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataprocMetastoreFederationAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DataprocMetastoreFederationClient._DEFAULT_UNIVERSE
    default_endpoint = DataprocMetastoreFederationClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = DataprocMetastoreFederationClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert DataprocMetastoreFederationClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert DataprocMetastoreFederationClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DataprocMetastoreFederationClient.DEFAULT_MTLS_ENDPOINT
    assert DataprocMetastoreFederationClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert DataprocMetastoreFederationClient._get_api_endpoint(None, None, default_universe, "always") == DataprocMetastoreFederationClient.DEFAULT_MTLS_ENDPOINT
    assert DataprocMetastoreFederationClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DataprocMetastoreFederationClient.DEFAULT_MTLS_ENDPOINT
    assert DataprocMetastoreFederationClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert DataprocMetastoreFederationClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        DataprocMetastoreFederationClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert DataprocMetastoreFederationClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert DataprocMetastoreFederationClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert DataprocMetastoreFederationClient._get_universe_domain(None, None) == DataprocMetastoreFederationClient._DEFAULT_UNIVERSE
...
@mock.patch.object(DataprocMetastoreFederationClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataprocMetastoreFederationClient))
@mock.patch.object(DataprocMetastoreFederationAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataprocMetastoreFederationAsyncClient))
def test_dataproc_metastore_federation_client_client_api_endpoint(client_class):
...
def test_list_federations_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_federations in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_federations] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_federations_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_federations in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_federations] = mock_rpc
...
def test_list_federations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_federations(request={}, retry=retry, timeout=timeout)
...
def test_get_federation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_federation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_federation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_federation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataprocMetastoreFederationAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_federation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_federation] = mock_rpc
...
def test_create_federation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_federation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_federation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_federation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataprocMetastoreFederationAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_federation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_federation] = mock_rpc
...
def test_update_federation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_federation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_federation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_federation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataprocMetastoreFederationAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_federation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_federation] = mock_rpc
...
def test_delete_federation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_federation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_federation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_federation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataprocMetastoreFederationAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_federation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_federation] = mock_rpc
...
def test_list_federations_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataprocMetastoreFederationClient(
...
def test_get_federation_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataprocMetastoreFederationClient(
...
def test_create_federation_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataprocMetastoreFederationClient(
...
def test_update_federation_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataprocMetastoreFederationClient(
...
def test_delete_federation_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataprocMetastoreFederationClient(
...
def test_list_federations_empty_call_grpc():
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = metastore_federation.ListFederationsResponse()
        client.list_federations(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_federation_empty_call_grpc():
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = metastore_federation.Federation()
        client.get_federation(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_federation_empty_call_grpc():
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_federation(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_federation_empty_call_grpc():
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_federation(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_federation_empty_call_grpc():
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_federation(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = DataprocMetastoreFederationAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_federations_empty_call_grpc_asyncio():
    client = DataprocMetastoreFederationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_federations(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_federation_empty_call_grpc_asyncio():
    client = DataprocMetastoreFederationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_federation(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_federation_empty_call_grpc_asyncio():
    client = DataprocMetastoreFederationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_federation(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_federation_empty_call_grpc_asyncio():
    client = DataprocMetastoreFederationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_federation(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_federation_empty_call_grpc_asyncio():
    client = DataprocMetastoreFederationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_federation(request=None)
...
def test_transport_kind_rest():
    transport = DataprocMetastoreFederationClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_federations_rest_bad_request(request_type=metastore_federation.ListFederationsRequest):
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_federations_rest_call_success(request_type):
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_federations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_list_federations_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = metastore_federation.ListFederationsResponse.to_json(metastore_federation.ListFederationsResponse())
        ...
        post_with_metadata.return_value = metastore_federation.ListFederationsResponse(), metadata
...
def test_get_federation_rest_bad_request(request_type=metastore_federation.GetFederationRequest):
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_federation_rest_call_success(request_type):
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_get_federation_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = metastore_federation.Federation.to_json(metastore_federation.Federation())
        req.return_value.content = return_value
...
def test_create_federation_rest_bad_request(request_type=metastore_federation.CreateFederationRequest):
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_federation_rest_call_success(request_type):
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    for field, value in request_init["federation"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_create_federation_with_metadata") as post_with_metadata, \
...
def test_update_federation_rest_bad_request(request_type=metastore_federation.UpdateFederationRequest):
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_federation_rest_call_success(request_type):
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_update_federation_with_metadata") as post_with_metadata, \
...
def test_delete_federation_rest_bad_request(request_type=metastore_federation.DeleteFederationRequest):
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_federation_rest_call_success(request_type):
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_delete_federation_with_metadata") as post_with_metadata, \
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_federations_empty_call_rest():
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_federation_empty_call_rest():
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_federation_empty_call_rest():
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_federation_empty_call_rest():
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_federation_empty_call_rest():
    client = DataprocMetastoreFederationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

...
#
# Snippet for AlterMetadataResourceLocation
...
# [START metastore_v1beta_generated_DataprocMetastore_AlterMetadataResourceLocation_sync]
...
def sample_alter_metadata_resource_location():
    ...
    request = metastore_v1beta.AlterMetadataResourceLocationRequest(

...
from google.cloud.vmwareengine_v1.services.vmware_engine import VmwareEngineAsyncClient
...
from google.cloud.vmwareengine_v1.services.vmware_engine import transports
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (VmwareEngineAsyncClient, transports.VmwareEngineGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (VmwareEngineAsyncClient, transports.VmwareEngineGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (VmwareEngineClient, transports.VmwareEngineGrpcTransport, "grpc", "false"),
    (VmwareEngineAsyncClient, transports.VmwareEngineGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
@pytest.mark.parametrize("client_class", [
    VmwareEngineClient, VmwareEngineAsyncClient
])
@mock.patch.object(VmwareEngineClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VmwareEngineClient))
@mock.patch.object(VmwareEngineAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VmwareEngineAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (VmwareEngineClient, transports.VmwareEngineGrpcTransport, "grpc", grpc_helpers),
    (VmwareEngineAsyncClient, transports.VmwareEngineGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_list_private_clouds_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, vmwareengine_resources.PrivateCloud)
                   for i in results)
...
async def test_list_private_clouds_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_private_clouds(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_private_cloud(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_private_cloud),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_private_cloud(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_private_cloud),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_private_cloud(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_private_cloud),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_private_cloud(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_private_cloud),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_undelete_private_cloud(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.undelete_private_cloud),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_clusters_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine_resources.Cluster)
                   for i in results)
...
def test_list_subnets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine_resources.Subnet)
                   for i in results)
...
def test_list_node_types(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_node_types),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_node_types_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine_resources.NodeType)
                   for i in results)
...
async def test_list_node_types_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_node_types(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_node_type(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_node_type),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_show_nsx_credentials(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.show_nsx_credentials),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_show_vcenter_credentials(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.show_vcenter_credentials),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = vmwareengine_resources.Credentials(
            username='username_value',
...
def test_reset_nsx_credentials(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.reset_nsx_credentials),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_reset_vcenter_credentials(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.reset_vcenter_credentials),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_hcx_activation_key(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_hcx_activation_key),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_hcx_activation_keys_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine_resources.HcxActivationKey)
                   for i in results)
...
async def test_list_hcx_activation_keys_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_hcx_activation_keys(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_hcx_activation_key(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_hcx_activation_key),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_network_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_network_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_network_policies_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine_resources.NetworkPolicy)
                   for i in results)
...
async def test_list_network_policies_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_network_policies(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_network_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_network_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_network_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_network_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_network_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_network_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_vmware_engine_network(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_vmware_engine_network),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_vmware_engine_network_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_vmware_engine_network(
            parent='parent_value',
            vmware_engine_network=vmwareengine_resources.VmwareEngineNetwork(name='name_value'),
...
def test_update_vmware_engine_network(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_vmware_engine_network),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_vmware_engine_network(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_vmware_engine_network),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_vmware_engine_network(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_vmware_engine_network),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_vmware_engine_networks_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine_resources.VmwareEngineNetwork)
                   for i in results)
...
async def test_list_vmware_engine_networks_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_vmware_engine_networks(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_private_connection_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_private_connection(
            parent='parent_value',
            private_connection=vmwareengine_resources.PrivateConnection(name='name_value'),
...
def test_list_private_connections_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine_resources.PrivateConnection)
                   for i in results)
...
def test_update_private_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_private_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_private_connection_peering_routes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine_resources.PeeringRoute)
                   for i in results)
...
async def test_list_private_connection_peering_routes_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_private_connection_peering_routes(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_list_private_clouds_rest_interceptors(null_interceptor):
    transport = transports.VmwareEngineRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.VmwareEngineRestInterceptor(),
        )
    client = VmwareEngineClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_list_private_clouds") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_list_private_clouds") as pre:
...
def test_get_private_cloud_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_get_private_cloud") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_get_private_cloud") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_private_cloud_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_create_private_cloud") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_create_private_cloud") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_private_cloud_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_update_private_cloud") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_update_private_cloud") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_private_cloud_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_delete_private_cloud") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_delete_private_cloud") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_undelete_private_cloud_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_undelete_private_cloud") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_undelete_private_cloud") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_list_clusters") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_list_clusters") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_get_cluster") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_get_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_create_cluster") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_create_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_update_cluster") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_update_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_delete_cluster") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_delete_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_subnets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_list_subnets") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_list_subnets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_subnet_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_get_subnet") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_get_subnet") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_subnet_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_update_subnet") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_update_subnet") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_node_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_list_node_types") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_list_node_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_node_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_get_node_type") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_get_node_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_show_nsx_credentials_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_show_nsx_credentials") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_show_nsx_credentials") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_show_vcenter_credentials_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_show_vcenter_credentials") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_show_vcenter_credentials") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_reset_nsx_credentials_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_reset_nsx_credentials") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_reset_nsx_credentials") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_reset_vcenter_credentials_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_reset_vcenter_credentials") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_reset_vcenter_credentials") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_hcx_activation_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_create_hcx_activation_key") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_create_hcx_activation_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_hcx_activation_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_list_hcx_activation_keys") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_list_hcx_activation_keys") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_hcx_activation_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_get_hcx_activation_key") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_get_hcx_activation_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_network_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_get_network_policy") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_get_network_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_network_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_list_network_policies") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_list_network_policies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_network_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_create_network_policy") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_create_network_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_network_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_update_network_policy") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_update_network_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_network_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_delete_network_policy") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_delete_network_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_vmware_engine_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_create_vmware_engine_network") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_create_vmware_engine_network") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_vmware_engine_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_update_vmware_engine_network") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_update_vmware_engine_network") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_vmware_engine_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_delete_vmware_engine_network") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_delete_vmware_engine_network") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_vmware_engine_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_get_vmware_engine_network") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_get_vmware_engine_network") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_vmware_engine_networks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_list_vmware_engine_networks") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_list_vmware_engine_networks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_private_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_create_private_connection") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_create_private_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_private_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_get_private_connection") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_get_private_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_private_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_list_private_connections") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_list_private_connections") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_private_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_update_private_connection") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_update_private_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_private_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_delete_private_connection") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_delete_private_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_private_connection_peering_routes_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = vmwareengine.ListPrivateConnectionPeeringRoutesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_private_connection_peering_routes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "post_list_private_connection_peering_routes") as post, \
         mock.patch.object(transports.VmwareEngineRestInterceptor, "pre_list_private_connection_peering_routes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_vmware_engine_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_vmware_engine_host_no_port(transport_name):
    client = VmwareEngineClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='vmwareengine.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'vmwareengine.googleapis.com:443'
...
def test_vmware_engine_host_with_port(transport_name):
    client = VmwareEngineClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='vmwareengine.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
@pytest.mark.parametrize("transport_class", [transports.VmwareEngineGrpcTransport, transports.VmwareEngineGrpcAsyncIOTransport])
def test_vmware_engine_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.VmwareEngineGrpcTransport, transports.VmwareEngineGrpcAsyncIOTransport])
def test_vmware_engine_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

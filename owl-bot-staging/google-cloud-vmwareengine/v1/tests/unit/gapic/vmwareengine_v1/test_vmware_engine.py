...
def test_list_private_clouds_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, vmwareengine.PrivateCloud)
                   for i in results)
...
async def test_get_private_cloud_async(transport: str = 'grpc_asyncio', request_type=vmwareengine.GetPrivateCloudRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vmwareengine.PrivateCloud(
            name='name_value',
            state=vmwareengine.PrivateCloud.State.ACTIVE,
            description='description_value',
            uid='uid_value',
...
def test_list_clusters_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine.Cluster)
                   for i in results)
...
async def test_get_cluster_async(transport: str = 'grpc_asyncio', request_type=vmwareengine.GetClusterRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vmwareengine.Cluster(
            name='name_value',
            state=vmwareengine.Cluster.State.ACTIVE,
            management=True,
            uid='uid_value',
...
def test_list_subnets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine.Subnet)
                   for i in results)
...
def test_list_node_types_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine.NodeType)
                   for i in results)
...
async def test_get_node_type_async(transport: str = 'grpc_asyncio', request_type=vmwareengine.GetNodeTypeRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vmwareengine.NodeType(
            name='name_value',
            node_type_id='node_type_id_value',
            display_name='display_name_value',
            virtual_cpu_count=1846,
...
async def test_show_nsx_credentials_async(transport: str = 'grpc_asyncio', request_type=vmwareengine.ShowNsxCredentialsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vmwareengine.Credentials(
            username='username_value',
            password='password_value',
        ))
...
def test_list_hcx_activation_keys_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine.HcxActivationKey)
                   for i in results)
...
async def test_get_hcx_activation_key_async(transport: str = 'grpc_asyncio', request_type=vmwareengine.GetHcxActivationKeyRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vmwareengine.HcxActivationKey(
            name='name_value',
            state=vmwareengine.HcxActivationKey.State.AVAILABLE,
            activation_key='activation_key_value',
            uid='uid_value',
...
async def test_get_network_policy_async(transport: str = 'grpc_asyncio', request_type=vmwareengine.GetNetworkPolicyRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vmwareengine.NetworkPolicy(
            name='name_value',
            edge_services_cidr='edge_services_cidr_value',
            uid='uid_value',
            vmware_engine_network='vmware_engine_network_value',
...
def test_list_network_policies_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine.NetworkPolicy)
                   for i in results)
...
async def test_get_vmware_engine_network_async(transport: str = 'grpc_asyncio', request_type=vmwareengine.GetVmwareEngineNetworkRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vmwareengine.VmwareEngineNetwork(
            name='name_value',
            description='description_value',
            state=vmwareengine.VmwareEngineNetwork.State.CREATING,
            type_=vmwareengine.VmwareEngineNetwork.Type.LEGACY,
...
def test_list_vmware_engine_networks_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmwareengine.VmwareEngineNetwork)
                   for i in results)
...
def test_get_private_cloud_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vmwareengine.PrivateCloud.to_json(vmwareengine.PrivateCloud())
...
def test_create_private_cloud_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["private_cloud"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'expire_time': {}, 'state': 1, 'network_config': {'management_cidr': 'management_cidr_value', 'vmware_engine_network': 'vmware_engine_network_value', 'vmware_engine_network_canonical': 'vmware_engine_network_canonical_value', 'management_ip_address_layout_version': 3836}, 'management_cluster': {'cluster_id': 'cluster_id_value', 'node_type_configs': {}}, 'description': 'description_value', 'hcx': {'internal_ip': 'internal_ip_value', 'version': 'version_value', 'state': 1, 'fqdn': 'fqdn_value'}, 'nsx': {'internal_ip': 'internal_ip_value', 'version': 'version_value', 'state': 1, 'fqdn': 'fqdn_value'}, 'vcenter': {'internal_ip': 'internal_ip_value', 'version': 'version_value', 'state': 1, 'fqdn': 'fqdn_value'}, 'uid': 'uid_value'}
    request = request_type(**request_init)
...
def test_get_node_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vmwareengine.NodeType.to_json(vmwareengine.NodeType())
...
def test_show_nsx_credentials_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vmwareengine.Credentials.to_json(vmwareengine.Credentials())
...
def test_get_hcx_activation_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vmwareengine.HcxActivationKey.to_json(vmwareengine.HcxActivationKey())
...
def test_get_network_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vmwareengine.NetworkPolicy.to_json(vmwareengine.NetworkPolicy())
...
def test_get_vmware_engine_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vmwareengine.VmwareEngineNetwork.to_json(vmwareengine.VmwareEngineNetwork())

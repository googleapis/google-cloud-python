...
class VmwareEngineClient(metaclass=VmwareEngineClientMeta):
    ...
    @staticmethod
    def cluster_path(project: str,location: str,private_cloud: str,cluster: str,) -> str:
        """Returns a fully-qualified cluster string."""
        return "projects/{project}/locations/{location}/privateClouds/{private_cloud}/clusters/{cluster}".format(project=project, location=location, private_cloud=private_cloud, cluster=cluster, )
    ...
    @staticmethod
    def dns_bind_permission_path(project: str,location: str,) -> str:
        """Returns a fully-qualified dns_bind_permission string."""
        return "projects/{project}/locations/{location}/dnsBindPermission".format(project=project, location=location, )
    ...
    @staticmethod
    def dns_forwarding_path(project: str,location: str,private_cloud: str,) -> str:
        """Returns a fully-qualified dns_forwarding string."""
        return "projects/{project}/locations/{location}/privateClouds/{private_cloud}/dnsForwarding".format(project=project, location=location, private_cloud=private_cloud, )
    ...
    @staticmethod
    def external_access_rule_path(project: str,location: str,network_policy: str,external_access_rule: str,) -> str:
        """Returns a fully-qualified external_access_rule string."""
        return "projects/{project}/locations/{location}/networkPolicies/{network_policy}/externalAccessRules/{external_access_rule}".format(project=project, location=location, network_policy=network_policy, external_access_rule=external_access_rule, )

    @staticmethod
    def parse_external_access_rule_path(path: str) -> Dict[str,str]:
        """Parses a external_access_rule path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/networkPolicies/(?P<network_policy>.+?)/externalAccessRules/(?P<external_access_rule>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def external_address_path(project: str,location: str,private_cloud: str,external_address: str,) -> str:
        """Returns a fully-qualified external_address string."""
        return "projects/{project}/locations/{location}/privateClouds/{private_cloud}/externalAddresses/{external_address}".format(project=project, location=location, private_cloud=private_cloud, external_address=external_address, )

    @staticmethod
    def parse_external_address_path(path: str) -> Dict[str,str]:
        """Parses a external_address path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/privateClouds/(?P<private_cloud>.+?)/externalAddresses/(?P<external_address>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def hcx_activation_key_path(project: str,location: str,private_cloud: str,hcx_activation_key: str,) -> str:
        """Returns a fully-qualified hcx_activation_key string."""
        return "projects/{project}/locations/{location}/privateClouds/{private_cloud}/hcxActivationKeys/{hcx_activation_key}".format(project=project, location=location, private_cloud=private_cloud, hcx_activation_key=hcx_activation_key, )

    @staticmethod
    def parse_hcx_activation_key_path(path: str) -> Dict[str,str]:
        """Parses a hcx_activation_key path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/privateClouds/(?P<private_cloud>.+?)/hcxActivationKeys/(?P<hcx_activation_key>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def logging_server_path(project: str,location: str,private_cloud: str,logging_server: str,) -> str:
        """Returns a fully-qualified logging_server string."""
        return "projects/{project}/locations/{location}/privateClouds/{private_cloud}/loggingServers/{logging_server}".format(project=project, location=location, private_cloud=private_cloud, logging_server=logging_server, )

    @staticmethod
    def parse_logging_server_path(path: str) -> Dict[str,str]:
        """Parses a logging_server path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/privateClouds/(?P<private_cloud>.+?)/loggingServers/(?P<logging_server>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def management_dns_zone_binding_path(project: str,location: str,private_cloud: str,management_dns_zone_binding: str,) -> str:
        """Returns a fully-qualified management_dns_zone_binding string."""
        return "projects/{project}/locations/{location}/privateClouds/{private_cloud}/managementDnsZoneBindings/{management_dns_zone_binding}".format(project=project, location=location, private_cloud=private_cloud, management_dns_zone_binding=management_dns_zone_binding, )
    ...
    def parse_management_dns_zone_binding_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/privateClouds/(?P<private_cloud>.+?)/managementDnsZoneBindings/(?P<management_dns_zone_binding>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def network_peering_path(project: str,location: str,network_peering: str,) -> str:
        """Returns a fully-qualified network_peering string."""
        return "projects/{project}/locations/{location}/networkPeerings/{network_peering}".format(project=project, location=location, network_peering=network_peering, )
    ...
    @staticmethod
    def network_policy_path(project: str,location: str,network_policy: str,) -> str:
        """Returns a fully-qualified network_policy string."""
        return "projects/{project}/locations/{location}/networkPolicies/{network_policy}".format(project=project, location=location, network_policy=network_policy, )
    ...
    @staticmethod
    def node_path(project: str,location: str,private_cloud: str,cluster: str,node: str,) -> str:
        """Returns a fully-qualified node string."""
        return "projects/{project}/locations/{location}/privateClouds/{private_cloud}/clusters/{cluster}/nodes/{node}".format(project=project, location=location, private_cloud=private_cloud, cluster=cluster, node=node, )

    @staticmethod
    def parse_node_path(path: str) -> Dict[str,str]:
        """Parses a node path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/privateClouds/(?P<private_cloud>.+?)/clusters/(?P<cluster>.+?)/nodes/(?P<node>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def node_type_path(project: str,location: str,node_type: str,) -> str:
        """Returns a fully-qualified node_type string."""
        return "projects/{project}/locations/{location}/nodeTypes/{node_type}".format(project=project, location=location, node_type=node_type, )
    ...
    @staticmethod
    def private_cloud_path(project: str,location: str,private_cloud: str,) -> str:
        """Returns a fully-qualified private_cloud string."""
        return "projects/{project}/locations/{location}/privateClouds/{private_cloud}".format(project=project, location=location, private_cloud=private_cloud, )
    ...
    @staticmethod
    def subnet_path(project: str,location: str,private_cloud: str,subnet: str,) -> str:
        """Returns a fully-qualified subnet string."""
        return "projects/{project}/locations/{location}/privateClouds/{private_cloud}/subnets/{subnet}".format(project=project, location=location, private_cloud=private_cloud, subnet=subnet, )
    ...
    @staticmethod
    def vmware_engine_network_path(project: str,location: str,vmware_engine_network: str,) -> str:
        """Returns a fully-qualified vmware_engine_network string."""
        return "projects/{project}/locations/{location}/vmwareEngineNetworks/{vmware_engine_network}".format(project=project, location=location, vmware_engine_network=vmware_engine_network, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            VmwareEngineClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def undelete_private_cloud(self,
    ...
    def list_external_addresses(self,
    ...
    def fetch_network_policy_external_addresses(self,
    ...
    def create_external_address(self,
    ...
    def update_external_address(self,
    ...
    def delete_external_address(self,
    ...
    def get_external_access_rule(self,
    ...
    def create_external_access_rule(self,
    ...
    def update_external_access_rule(self,
    ...
    def delete_external_access_rule(self,
    ...
    def update_logging_server(self,
    ...
    def show_vcenter_credentials(self,
    ...
    def reset_nsx_credentials(self,
    ...
    def reset_vcenter_credentials(self,
    ...
    def update_dns_forwarding(self,
    ...
    def create_network_peering(self,
    ...
    def delete_network_peering(self,
    ...
    def update_network_peering(self,
    ...
    def create_hcx_activation_key(self,
    ...
    def list_hcx_activation_keys(self,
    ...
    def get_hcx_activation_key(self,
    ...
    def list_management_dns_zone_bindings(self,
    ...
    def get_management_dns_zone_binding(self,
    ...
    def create_management_dns_zone_binding(self,
    ...
    def update_management_dns_zone_binding(self,
    ...
    def delete_management_dns_zone_binding(self,
    ...
    def repair_management_dns_zone_binding(self,
    ...
    def create_vmware_engine_network(self,
    ...
    def update_vmware_engine_network(self,
    ...
    def delete_vmware_engine_network(self,
    ...
    def get_vmware_engine_network(self,
    ...
    def list_vmware_engine_networks(self,
    ...
    def update_private_connection(self,
    ...
    def list_private_connection_peering_routes(self,
    ...
    def grant_dns_bind_permission(self,
    ...
    def get_dns_bind_permission(self,
    ...
    def revoke_dns_bind_permission(self,

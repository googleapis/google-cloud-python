...
class VmwareEngineGrpcAsyncIOTransport(VmwareEngineTransport):
    ...
    def get_cluster(self) -> Callable[
            ...
            Awaitable[vmwareengine_resources.Cluster]]:
    ...
    def get_node(self) -> Callable[
            ...
            Awaitable[vmwareengine_resources.Node]]:
    ...
    def fetch_network_policy_external_addresses(self) -> Callable[
        ...
        if 'fetch_network_policy_external_addresses' not in self._stubs:
            self._stubs['fetch_network_policy_external_addresses'] = self.grpc_channel.unary_unary(
    ...
    def get_subnet(self) -> Callable[
            ...
            Awaitable[vmwareengine_resources.Subnet]]:
    ...
    def get_node_type(self) -> Callable[
            ...
            Awaitable[vmwareengine_resources.NodeType]]:
    ...
    def list_management_dns_zone_bindings(self) -> Callable[
        ...
        if 'list_management_dns_zone_bindings' not in self._stubs:
            self._stubs['list_management_dns_zone_bindings'] = self.grpc_channel.unary_unary(
    ...
    def get_management_dns_zone_binding(self) -> Callable[
        ...
        if 'get_management_dns_zone_binding' not in self._stubs:
            self._stubs['get_management_dns_zone_binding'] = self.grpc_channel.unary_unary(
    ...
    def create_management_dns_zone_binding(self) -> Callable[
        ...
        if 'create_management_dns_zone_binding' not in self._stubs:
            self._stubs['create_management_dns_zone_binding'] = self.grpc_channel.unary_unary(
    ...
    def update_management_dns_zone_binding(self) -> Callable[
        ...
        if 'update_management_dns_zone_binding' not in self._stubs:
            self._stubs['update_management_dns_zone_binding'] = self.grpc_channel.unary_unary(
    ...
    def delete_management_dns_zone_binding(self) -> Callable[
        ...
        if 'delete_management_dns_zone_binding' not in self._stubs:
            self._stubs['delete_management_dns_zone_binding'] = self.grpc_channel.unary_unary(
    ...
    def repair_management_dns_zone_binding(self) -> Callable[
        ...
        if 'repair_management_dns_zone_binding' not in self._stubs:
            self._stubs['repair_management_dns_zone_binding'] = self.grpc_channel.unary_unary(
    ...
    def list_private_connection_peering_routes(self) -> Callable[
        ...
        if 'list_private_connection_peering_routes' not in self._stubs:
            self._stubs['list_private_connection_peering_routes'] = self.grpc_channel.unary_unary(
...
__all__ = (
    'VmwareEngineGrpcAsyncIOTransport',
)

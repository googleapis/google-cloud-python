...
class Constraint(proto.Message):
    ...
    security_health_analytics_module: sha_constraints.SecurityHealthAnalyticsModule = proto.Field(
        proto.MESSAGE,
        number=3,
    ...
    org_policy_constraint_custom: org_policy_constraints.OrgPolicyConstraintCustom = proto.Field(
        proto.MESSAGE,
        number=6,
        oneof='implementation',

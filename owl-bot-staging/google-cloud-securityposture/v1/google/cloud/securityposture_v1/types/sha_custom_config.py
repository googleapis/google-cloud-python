...
class CustomConfig(proto.Message):
    ...
    Attributes:
        predicate (google.type.expr_pb2.Expr):
            Required. The CEL expression to evaluate to
            produce findings. When the expression evaluates
            to true against a resource, a finding is
            generated.
        custom_output (google.cloud.securityposture_v1.types.CustomConfig.CustomOutputSpec):
            Optional. Custom output properties.
        resource_selector (google.cloud.securityposture_v1.types.CustomConfig.ResourceSelector):
            Required. The resource types that the custom
            module operates on. Each custom module can
            specify up to 5 resource types.
        severity (google.cloud.securityposture_v1.types.CustomConfig.Severity):
            Required. The severity to assign to findings
    ...
    class CustomOutputSpec(proto.Message):
        ...
        Attributes:
            properties (MutableSequence[google.cloud.securityposture_v1.types.CustomConfig.CustomOutputSpec.Property]):
        ...
        class Property(proto.Message):
            ...
            Attributes:
                name (str):
                    Required. Name of the property for the custom
                    output.
    ...
    class ResourceSelector(proto.Message):
        ...
        Attributes:
            resource_types (MutableSequence[str]):
                Required. The resource types to run the
                detector on.
        """

...
class SecurityPostureGrpcAsyncIOTransport(SecurityPostureTransport):
    """gRPC AsyncIO backend transport for SecurityPosture.
    ...
    def list_postures(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListPosturesRequest],
                    Awaitable[~.ListPosturesResponse]]:
    ...
    def list_posture_revisions(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListPostureRevisionsRequest],
                    Awaitable[~.ListPostureRevisionsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_posture(self) -> Callable[
            ...
            Awaitable[securityposture.Posture]]:
    ...
    def list_posture_deployments(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListPostureDeploymentsRequest],
                    Awaitable[~.ListPostureDeploymentsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_posture_templates(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListPostureTemplatesRequest],
                    Awaitable[~.ListPostureTemplatesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_posture_template(self) -> Callable[
            ...
            Awaitable[securityposture.PostureTemplate]]:

...
class SecurityPostureClient(metaclass=SecurityPostureClientMeta):
    ...
    @staticmethod
    def posture_path(organization: str,location: str,posture: str,) -> str:
        """Returns a fully-qualified posture string."""
        return "organizations/{organization}/locations/{location}/postures/{posture}".format(organization=organization, location=location, posture=posture, )

    @staticmethod
    def parse_posture_path(path: str) -> Dict[str,str]:
        """Parses a posture path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/postures/(?P<posture>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def posture_deployment_path(organization: str,location: str,posture_deployment: str,) -> str:
        """Returns a fully-qualified posture_deployment string."""
        return "organizations/{organization}/locations/{location}/postureDeployments/{posture_deployment}".format(organization=organization, location=location, posture_deployment=posture_deployment, )

    @staticmethod
    def parse_posture_deployment_path(path: str) -> Dict[str,str]:
        """Parses a posture_deployment path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/postureDeployments/(?P<posture_deployment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def posture_template_path(organization: str,location: str,posture_template: str,) -> str:
        """Returns a fully-qualified posture_template string."""
        return "organizations/{organization}/locations/{location}/postureTemplates/{posture_template}".format(organization=organization, location=location, posture_template=posture_template, )

    @staticmethod
    def parse_posture_template_path(path: str) -> Dict[str,str]:
        """Parses a posture_template path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/postureTemplates/(?P<posture_template>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def list_posture_revisions(self,
    ...
    def list_posture_deployments(self,
    ...
    def get_posture_deployment(self,
    ...
    def create_posture_deployment(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_posture_deployment]
    ...
    def update_posture_deployment(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_posture_deployment]
    ...
    def delete_posture_deployment(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_posture_deployment]
    ...
    def list_posture_templates(self,

...
from google.cloud.securityposture_v1.services.security_posture import SecurityPostureAsyncClient
from google.cloud.securityposture_v1.services.security_posture import SecurityPostureClient
from google.cloud.securityposture_v1.services.security_posture import pagers
from google.cloud.securityposture_v1.services.security_posture import transports
from google.cloud.securityposture_v1.types import org_policy_config
from google.cloud.securityposture_v1.types import org_policy_constraints
from google.cloud.securityposture_v1.types import securityposture
from google.cloud.securityposture_v1.types import sha_constraints
...
def test__get_default_mtls_endpoint():
    ...
    assert SecurityPostureClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert SecurityPostureClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert SecurityPostureClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert SecurityPostureClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert SecurityPostureClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test_security_posture_client_from_service_account_info(client_class, transport_name):
...
def test_security_posture_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_security_posture_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (SecurityPostureAsyncClient, transports.SecurityPostureGrpcAsyncIOTransport, "grpc_asyncio"),
    (SecurityPostureClient, transports.SecurityPostureRestTransport, "rest"),
])
@mock.patch.object(SecurityPostureClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SecurityPostureClient))
@mock.patch.object(SecurityPostureAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SecurityPostureAsyncClient))
def test_security_posture_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (SecurityPostureClient, transports.SecurityPostureGrpcTransport, "grpc", "true"),
    (SecurityPostureAsyncClient, transports.SecurityPostureGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (SecurityPostureClient, transports.SecurityPostureGrpcTransport, "grpc", "false"),
    (SecurityPostureAsyncClient, transports.SecurityPostureGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (SecurityPostureClient, transports.SecurityPostureRestTransport, "rest", "true"),
    (SecurityPostureClient, transports.SecurityPostureRestTransport, "rest", "false"),
])
@mock.patch.object(SecurityPostureClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SecurityPostureClient))
@mock.patch.object(SecurityPostureAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SecurityPostureAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_security_posture_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    SecurityPostureClient, SecurityPostureAsyncClient
])
@mock.patch.object(SecurityPostureClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SecurityPostureClient))
@mock.patch.object(SecurityPostureAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SecurityPostureAsyncClient))
...
def test_security_posture_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (SecurityPostureClient, transports.SecurityPostureGrpcTransport, "grpc", grpc_helpers),
    (SecurityPostureAsyncClient, transports.SecurityPostureGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (SecurityPostureClient, transports.SecurityPostureRestTransport, "rest", None),
])
def test_security_posture_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_security_posture_client_client_options_from_dict():
    with mock.patch('google.cloud.securityposture_v1.services.security_posture.transports.SecurityPostureGrpcTransport.__init__') as grpc_transport:
...
def test_security_posture_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_list_postures(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.list_postures),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_list_postures_async(transport: str = 'grpc_asyncio', request_type=securityposture.ListPosturesRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(securityposture.ListPosturesResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_postures_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, securityposture.Posture)
                   for i in results)
...
async def test_list_postures_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_postures(request={},)
...
@pytest.mark.asyncio
async def test_list_posture_revisions_async(transport: str = 'grpc_asyncio', request_type=securityposture.ListPostureRevisionsRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(securityposture.ListPostureRevisionsResponse(
            next_page_token='next_page_token_value',
        ))
...
async def test_list_posture_revisions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_posture_revisions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_posture(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_posture),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_posture_async(transport: str = 'grpc_asyncio', request_type=securityposture.GetPostureRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(securityposture.Posture(
            name='name_value',
            state=securityposture.Posture.State.DEPRECATED,
            revision_id='revision_id_value',
            description='description_value',
...
def test_create_posture(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_posture),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_posture_async(transport: str = 'grpc_asyncio', request_type=securityposture.CreatePostureRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_posture(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_posture),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_posture_async(transport: str = 'grpc_asyncio', request_type=securityposture.UpdatePostureRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_posture(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_posture),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_posture_async(transport: str = 'grpc_asyncio', request_type=securityposture.DeletePostureRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_extract_posture(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.extract_posture),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_extract_posture_async(transport: str = 'grpc_asyncio', request_type=securityposture.ExtractPostureRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_posture_deployments_async(transport: str = 'grpc_asyncio', request_type=securityposture.ListPostureDeploymentsRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(securityposture.ListPostureDeploymentsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_posture_deployments_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, securityposture.PostureDeployment)
                   for i in results)
...
async def test_list_posture_deployments_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_posture_deployments(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_posture_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_posture_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_posture_deployment_async(transport: str = 'grpc_asyncio', request_type=securityposture.GetPostureDeploymentRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(securityposture.PostureDeployment(
            name='name_value',
            target_resource='target_resource_value',
            state=securityposture.PostureDeployment.State.CREATING,
            posture_id='posture_id_value',
...
def test_create_posture_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_posture_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_posture_deployment_async(transport: str = 'grpc_asyncio', request_type=securityposture.CreatePostureDeploymentRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_posture_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_posture_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_posture_deployment_async(transport: str = 'grpc_asyncio', request_type=securityposture.UpdatePostureDeploymentRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_posture_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_posture_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_posture_deployment_async(transport: str = 'grpc_asyncio', request_type=securityposture.DeletePostureDeploymentRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_posture_templates_async(transport: str = 'grpc_asyncio', request_type=securityposture.ListPostureTemplatesRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(securityposture.ListPostureTemplatesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_posture_templates_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, securityposture.PostureTemplate)
                   for i in results)
...
async def test_list_posture_templates_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_posture_templates(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_posture_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_posture_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_posture_template_async(transport: str = 'grpc_asyncio', request_type=securityposture.GetPostureTemplateRequest):
    client = SecurityPostureAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(securityposture.PostureTemplate(
            name='name_value',
            revision_id='revision_id_value',
            description='description_value',
            state=securityposture.PostureTemplate.State.ACTIVE,
...
def test_list_postures_rest_required_fields(request_type=securityposture.ListPosturesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_postures._get_unset_required_fields(jsonified_request)
...
def test_list_postures_rest_unset_required_fields():
    transport = transports.SecurityPostureRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_postures_rest_interceptors(null_interceptor):
    transport = transports.SecurityPostureRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SecurityPostureRestInterceptor(),
        )
    client = SecurityPostureClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_list_postures") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_list_postures") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.ListPosturesRequest.pb(securityposture.ListPosturesRequest())
        ...
        req.return_value._content = securityposture.ListPosturesResponse.to_json(securityposture.ListPosturesResponse())
        ...
        client.list_postures(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_postures_rest_bad_request(transport: str = 'rest', request_type=securityposture.ListPosturesRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_postures_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=organizations/*/locations/*}/postures" % client.transport._host, args[1])
...
def test_list_postures_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(securityposture.ListPosturesResponse.to_json(x) for x in response)
...
def test_list_posture_revisions_rest_required_fields(request_type=securityposture.ListPostureRevisionsRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_posture_revisions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_posture_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_list_posture_revisions") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_list_posture_revisions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.ListPostureRevisionsRequest.pb(securityposture.ListPostureRevisionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = securityposture.ListPostureRevisionsResponse.to_json(securityposture.ListPostureRevisionsResponse())
        ...
        client.list_posture_revisions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_posture_revisions_rest_bad_request(transport: str = 'rest', request_type=securityposture.ListPostureRevisionsRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_posture_revisions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(securityposture.ListPostureRevisionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        sample_request = {'name': 'organizations/sample1/locations/sample2/postures/sample3'}
...
def test_get_posture_rest_required_fields(request_type=securityposture.GetPostureRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_posture._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_posture_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_get_posture") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_get_posture") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.GetPostureRequest.pb(securityposture.GetPostureRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = securityposture.Posture.to_json(securityposture.Posture())
        ...
        client.get_posture(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_posture_rest_bad_request(transport: str = 'rest', request_type=securityposture.GetPostureRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_posture_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/locations/*/postures/*}" % client.transport._host, args[1])
...
def test_create_posture_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'organizations/sample1/locations/sample2'}
    request_init["posture"] = {'name': 'name_value', 'state': 1, 'revision_id': 'revision_id_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'policy_sets': [{'policy_set_id': 'policy_set_id_value', 'description': 'description_value', 'policies': [{'policy_id': 'policy_id_value', 'compliance_standards': [{'standard': 'standard_value', 'control': 'control_value'}], 'constraint': {'security_health_analytics_module': {'module_name': 'module_name_value', 'module_enablement_state': 1}, 'security_health_analytics_custom_module': {'id': 'id_value', 'display_name': 'display_name_value', 'config': {'predicate': {'expression': 'expression_value', 'title': 'title_value', 'description': 'description_value', 'location': 'location_value'}, 'custom_output': {'properties': [{'name': 'name_value', 'value_expression': {}}]}, 'resource_selector': {'resource_types': ['resource_types_value1', 'resource_types_value2']}, 'severity': 1, 'description': 'description_value', 'recommendation': 'recommendation_value'}, 'module_enablement_state': 1}, 'org_policy_constraint': {'canned_constraint_id': 'canned_constraint_id_value', 'policy_rules': [{'values': {'allowed_values': ['allowed_values_value1', 'allowed_values_value2'], 'denied_values': ['denied_values_value1', 'denied_values_value2']}, 'allow_all': True, 'deny_all': True, 'enforce': True, 'condition': {}}]}, 'org_policy_constraint_custom': {'custom_constraint': {'name': 'name_value', 'resource_types': ['resource_types_value1', 'resource_types_value2'], 'method_types': [1], 'condition': 'condition_value', 'action_type': 1, 'display_name': 'display_name_value', 'description': 'description_value', 'update_time': {}}, 'policy_rules': {}}}, 'description': 'description_value'}]}], 'etag': 'etag_value', 'annotations': {}, 'reconciling': True}
...
def test_create_posture_rest_required_fields(request_type=securityposture.CreatePostureRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_posture._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_posture_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("postureId", )) & set(("parent", "postureId", "posture", )))
...
def test_create_posture_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_create_posture") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_create_posture") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.CreatePostureRequest.pb(securityposture.CreatePostureRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_posture(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_posture_rest_bad_request(transport: str = 'rest', request_type=securityposture.CreatePostureRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_posture_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'posture': {'name': 'organizations/sample1/locations/sample2/postures/sample3'}}
    request_init["posture"] = {'name': 'organizations/sample1/locations/sample2/postures/sample3', 'state': 1, 'revision_id': 'revision_id_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'policy_sets': [{'policy_set_id': 'policy_set_id_value', 'description': 'description_value', 'policies': [{'policy_id': 'policy_id_value', 'compliance_standards': [{'standard': 'standard_value', 'control': 'control_value'}], 'constraint': {'security_health_analytics_module': {'module_name': 'module_name_value', 'module_enablement_state': 1}, 'security_health_analytics_custom_module': {'id': 'id_value', 'display_name': 'display_name_value', 'config': {'predicate': {'expression': 'expression_value', 'title': 'title_value', 'description': 'description_value', 'location': 'location_value'}, 'custom_output': {'properties': [{'name': 'name_value', 'value_expression': {}}]}, 'resource_selector': {'resource_types': ['resource_types_value1', 'resource_types_value2']}, 'severity': 1, 'description': 'description_value', 'recommendation': 'recommendation_value'}, 'module_enablement_state': 1}, 'org_policy_constraint': {'canned_constraint_id': 'canned_constraint_id_value', 'policy_rules': [{'values': {'allowed_values': ['allowed_values_value1', 'allowed_values_value2'], 'denied_values': ['denied_values_value1', 'denied_values_value2']}, 'allow_all': True, 'deny_all': True, 'enforce': True, 'condition': {}}]}, 'org_policy_constraint_custom': {'custom_constraint': {'name': 'name_value', 'resource_types': ['resource_types_value1', 'resource_types_value2'], 'method_types': [1], 'condition': 'condition_value', 'action_type': 1, 'display_name': 'display_name_value', 'description': 'description_value', 'update_time': {}}, 'policy_rules': {}}}, 'description': 'description_value'}]}], 'etag': 'etag_value', 'annotations': {}, 'reconciling': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_posture_rest_required_fields(request_type=securityposture.UpdatePostureRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_posture._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_posture._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("revision_id", "update_mask", ))
    jsonified_request.update(unset_fields)
...
def test_update_posture_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("revisionId", "updateMask", )) & set(("updateMask", "posture", "revisionId", )))
...
def test_update_posture_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_update_posture") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_update_posture") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.UpdatePostureRequest.pb(securityposture.UpdatePostureRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_posture(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_posture_rest_bad_request(transport: str = 'rest', request_type=securityposture.UpdatePostureRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_posture_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'posture': {'name': 'organizations/sample1/locations/sample2/postures/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{posture.name=organizations/*/locations/*/postures/*}" % client.transport._host, args[1])
...
def test_delete_posture_rest_required_fields(request_type=securityposture.DeletePostureRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_posture._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_posture_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_delete_posture") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_delete_posture") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.DeletePostureRequest.pb(securityposture.DeletePostureRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_posture(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_posture_rest_bad_request(transport: str = 'rest', request_type=securityposture.DeletePostureRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_extract_posture_rest_required_fields(request_type=securityposture.ExtractPostureRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).extract_posture._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_extract_posture_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "postureId", "workload", )))
...
def test_extract_posture_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_extract_posture") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_extract_posture") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.ExtractPostureRequest.pb(securityposture.ExtractPostureRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.extract_posture(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_extract_posture_rest_bad_request(transport: str = 'rest', request_type=securityposture.ExtractPostureRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_extract_posture_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*/locations/*}/postures:extract" % client.transport._host, args[1])
...
def test_list_posture_deployments_rest_required_fields(request_type=securityposture.ListPostureDeploymentsRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_posture_deployments._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_posture_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_list_posture_deployments") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_list_posture_deployments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.ListPostureDeploymentsRequest.pb(securityposture.ListPostureDeploymentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = securityposture.ListPostureDeploymentsResponse.to_json(securityposture.ListPostureDeploymentsResponse())
        ...
        client.list_posture_deployments(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_posture_deployments_rest_bad_request(transport: str = 'rest', request_type=securityposture.ListPostureDeploymentsRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_posture_deployments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*/locations/*}/postureDeployments" % client.transport._host, args[1])
...
def test_list_posture_deployments_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(securityposture.ListPostureDeploymentsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_posture_deployment_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'organizations/sample1/locations/sample2/postureDeployments/sample3'}
    request = request_type(**request_init)
...
def test_get_posture_deployment_rest_required_fields(request_type=securityposture.GetPostureDeploymentRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_posture_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_posture_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_get_posture_deployment") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_get_posture_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.GetPostureDeploymentRequest.pb(securityposture.GetPostureDeploymentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = securityposture.PostureDeployment.to_json(securityposture.PostureDeployment())
        ...
        client.get_posture_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_posture_deployment_rest_bad_request(transport: str = 'rest', request_type=securityposture.GetPostureDeploymentRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_posture_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'organizations/sample1/locations/sample2/postureDeployments/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/locations/*/postureDeployments/*}" % client.transport._host, args[1])
...
def test_create_posture_deployment_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'organizations/sample1/locations/sample2'}
    request_init["posture_deployment"] = {'name': 'name_value', 'target_resource': 'target_resource_value', 'state': 1, 'posture_id': 'posture_id_value', 'posture_revision_id': 'posture_revision_id_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'etag': 'etag_value', 'annotations': {}, 'reconciling': True, 'desired_posture_id': 'desired_posture_id_value', 'desired_posture_revision_id': 'desired_posture_revision_id_value', 'failure_message': 'failure_message_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = securityposture.CreatePostureDeploymentRequest.meta.fields["posture_deployment"]
...
def test_create_posture_deployment_rest_required_fields(request_type=securityposture.CreatePostureDeploymentRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_posture_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "postureDeploymentId" in jsonified_request
    assert jsonified_request["postureDeploymentId"] == request_init["posture_deployment_id"]
...
def test_create_posture_deployment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("postureDeploymentId", )) & set(("parent", "postureDeploymentId", "postureDeployment", )))
...
def test_create_posture_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_create_posture_deployment") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_create_posture_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.CreatePostureDeploymentRequest.pb(securityposture.CreatePostureDeploymentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_posture_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_posture_deployment_rest_bad_request(transport: str = 'rest', request_type=securityposture.CreatePostureDeploymentRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_posture_deployment_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'posture_deployment': {'name': 'organizations/sample1/locations/sample2/postureDeployments/sample3'}}
    request_init["posture_deployment"] = {'name': 'organizations/sample1/locations/sample2/postureDeployments/sample3', 'target_resource': 'target_resource_value', 'state': 1, 'posture_id': 'posture_id_value', 'posture_revision_id': 'posture_revision_id_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'etag': 'etag_value', 'annotations': {}, 'reconciling': True, 'desired_posture_id': 'desired_posture_id_value', 'desired_posture_revision_id': 'desired_posture_revision_id_value', 'failure_message': 'failure_message_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = securityposture.UpdatePostureDeploymentRequest.meta.fields["posture_deployment"]
...
def test_update_posture_deployment_rest_required_fields(request_type=securityposture.UpdatePostureDeploymentRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_posture_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_posture_deployment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("updateMask", "postureDeployment", )))
...
def test_update_posture_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_update_posture_deployment") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_update_posture_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.UpdatePostureDeploymentRequest.pb(securityposture.UpdatePostureDeploymentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_posture_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_posture_deployment_rest_bad_request(transport: str = 'rest', request_type=securityposture.UpdatePostureDeploymentRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_posture_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'posture_deployment': {'name': 'organizations/sample1/locations/sample2/postureDeployments/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{posture_deployment.name=organizations/*/locations/*/postureDeployments/*}" % client.transport._host, args[1])
...
def test_delete_posture_deployment_rest_required_fields(request_type=securityposture.DeletePostureDeploymentRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_posture_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_posture_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_delete_posture_deployment") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_delete_posture_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.DeletePostureDeploymentRequest.pb(securityposture.DeletePostureDeploymentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_posture_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_posture_deployment_rest_bad_request(transport: str = 'rest', request_type=securityposture.DeletePostureDeploymentRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_posture_templates_rest_required_fields(request_type=securityposture.ListPostureTemplatesRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_posture_templates._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_posture_templates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_list_posture_templates") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_list_posture_templates") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.ListPostureTemplatesRequest.pb(securityposture.ListPostureTemplatesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = securityposture.ListPostureTemplatesResponse.to_json(securityposture.ListPostureTemplatesResponse())
        ...
        client.list_posture_templates(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_posture_templates_rest_bad_request(transport: str = 'rest', request_type=securityposture.ListPostureTemplatesRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_posture_templates_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*/locations/*}/postureTemplates" % client.transport._host, args[1])
...
def test_list_posture_templates_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(securityposture.ListPostureTemplatesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_posture_template_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'organizations/sample1/locations/sample2/postureTemplates/sample3'}
    request = request_type(**request_init)
...
def test_get_posture_template_rest_required_fields(request_type=securityposture.GetPostureTemplateRequest):
    transport_class = transports.SecurityPostureRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_posture_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_posture_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "post_get_posture_template") as post, \
         mock.patch.object(transports.SecurityPostureRestInterceptor, "pre_get_posture_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securityposture.GetPostureTemplateRequest.pb(securityposture.GetPostureTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = securityposture.PostureTemplate.to_json(securityposture.PostureTemplate())
        ...
        client.get_posture_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_posture_template_rest_bad_request(transport: str = 'rest', request_type=securityposture.GetPostureTemplateRequest):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_posture_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'organizations/sample1/locations/sample2/postureTemplates/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/locations/*/postureTemplates/*}" % client.transport._host, args[1])
...
def test_security_posture_base_transport():
    ...
    with mock.patch('google.cloud.securityposture_v1.services.security_posture.transports.SecurityPostureTransport.__init__') as Transport:
...
def test_security_posture_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.securityposture_v1.services.security_posture.transports.SecurityPostureTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_security_posture_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.securityposture_v1.services.security_posture.transports.SecurityPostureTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SecurityPostureTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.SecurityPostureGrpcTransport, transports.SecurityPostureGrpcAsyncIOTransport])
def test_security_posture_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_security_posture_host_no_port(transport_name):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='securityposture.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'securityposture.googleapis.com:443'
...
def test_security_posture_host_with_port(transport_name):
    client = SecurityPostureClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='securityposture.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.SecurityPostureGrpcTransport, transports.SecurityPostureGrpcAsyncIOTransport])
def test_security_posture_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_posture_path():
    ...
    location = "clam"
    posture = "whelk"
    expected = "organizations/{organization}/locations/{location}/postures/{posture}".format(organization=organization, location=location, posture=posture, )
...
def test_posture_deployment_path():
    ...
    expected = "organizations/{organization}/locations/{location}/postureDeployments/{posture_deployment}".format(organization=organization, location=location, posture_deployment=posture_deployment, )
    actual = SecurityPostureClient.posture_deployment_path(organization, location, posture_deployment)
    assert expected == actual
...
def test_posture_template_path():
    ...
    expected = "organizations/{organization}/locations/{location}/postureTemplates/{posture_template}".format(organization=organization, location=location, posture_template=posture_template, )
    actual = SecurityPostureClient.posture_template_path(organization, location, posture_template)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.SecurityPostureTransport, '_prep_wrapped_messages') as prep:
        client = SecurityPostureClient(
            credentials=ga_credentials.AnonymousCredentials(),

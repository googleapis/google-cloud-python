...
def test__get_api_endpoint():
    ...
    assert CloudFunctionsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CloudFunctionsServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert CloudFunctionsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CloudFunctionsServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_list_functions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_list_functions_with_metadata") as post_with_metadata, \
...
def test_get_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_get_function_with_metadata") as post_with_metadata, \
...
def test_create_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_create_function_with_metadata") as post_with_metadata, \
...
def test_update_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_update_function_with_metadata") as post_with_metadata, \
...
def test_delete_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_delete_function_with_metadata") as post_with_metadata, \
...
def test_call_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_call_function_with_metadata") as post_with_metadata, \
...
def test_generate_upload_url_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_generate_upload_url_with_metadata") as post_with_metadata, \
...
def test_generate_download_url_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_generate_download_url_with_metadata") as post_with_metadata, \
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \

...
from .base import FunctionServiceTransport, DEFAULT_CLIENT_INFO
...
class FunctionServiceGrpcAsyncIOTransport(FunctionServiceTransport):
    ...
    def list_runtimes(self) -> Callable[
            ...
            Awaitable[functions.ListRuntimesResponse]]:
...
__all__ = (
    'FunctionServiceGrpcAsyncIOTransport',
)

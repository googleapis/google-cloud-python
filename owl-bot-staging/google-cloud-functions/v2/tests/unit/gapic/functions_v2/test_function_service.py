...
from google.cloud.functions_v2.services.function_service import FunctionServiceAsyncClient
...
from google.cloud.functions_v2.services.function_service import transports
...
def test__get_api_endpoint():
    ...
    assert FunctionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == FunctionServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert FunctionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == FunctionServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    FunctionServiceClient, FunctionServiceAsyncClient
])
...
def test_list_functions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, functions.Function)
                   for i in results)
...
def test_get_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_get_function") as post, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_get_function_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "pre_get_function") as pre:
...
def test_list_functions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_list_functions") as post, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_list_functions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "pre_list_functions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_function_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["function"] = {'name': 'name_value', 'description': 'description_value', 'build_config': {'automatic_update_policy': {}, 'on_deploy_update_policy': {'runtime_version': 'runtime_version_value'}, 'build': 'build_value', 'runtime': 'runtime_value', 'entry_point': 'entry_point_value', 'source': {'storage_source': {'bucket': 'bucket_value', 'object_': 'object__value', 'generation': 1068, 'source_upload_url': 'source_upload_url_value'}, 'repo_source': {'branch_name': 'branch_name_value', 'tag_name': 'tag_name_value', 'commit_sha': 'commit_sha_value', 'project_id': 'project_id_value', 'repo_name': 'repo_name_value', 'dir_': 'dir__value', 'invert_regex': True}, 'git_uri': 'git_uri_value'}, 'source_provenance': {'resolved_storage_source': {}, 'resolved_repo_source': {}, 'git_uri': 'git_uri_value'}, 'worker_pool': 'worker_pool_value', 'environment_variables': {}, 'docker_registry': 1, 'docker_repository': 'docker_repository_value', 'service_account': 'service_account_value'}, 'service_config': {'service': 'service_value', 'timeout_seconds': 1621, 'available_memory': 'available_memory_value', 'available_cpu': 'available_cpu_value', 'environment_variables': {}, 'max_instance_count': 1922, 'min_instance_count': 1920, 'vpc_connector': 'vpc_connector_value', 'vpc_connector_egress_settings': 1, 'ingress_settings': 1, 'uri': 'uri_value', 'service_account_email': 'service_account_email_value', 'all_traffic_on_latest_revision': True, 'secret_environment_variables': [{'key': 'key_value', 'project_id': 'project_id_value', 'secret': 'secret_value', 'version': 'version_value'}], 'secret_volumes': [{'mount_path': 'mount_path_value', 'project_id': 'project_id_value', 'secret': 'secret_value', 'versions': [{'version': 'version_value', 'path': 'path_value'}]}], 'revision': 'revision_value', 'max_instance_request_concurrency': 3436, 'security_level': 1, 'binary_authorization_policy': 'binary_authorization_policy_value'}, 'event_trigger': {'trigger': 'trigger_value', 'trigger_region': 'trigger_region_value', 'event_type': 'event_type_value', 'event_filters': [{'attribute': 'attribute_value', 'value': 'value_value', 'operator': 'operator_value'}], 'pubsub_topic': 'pubsub_topic_value', 'service_account_email': 'service_account_email_value', 'retry_policy': 1, 'channel': 'channel_value', 'service': 'service_value'}, 'state': 1, 'update_time': {'seconds': 751, 'nanos': 543}, 'labels': {}, 'state_messages': [{'severity': 1, 'type_': 'type__value', 'message': 'message_value'}], 'environment': 1, 'url': 'url_value', 'kms_key_name': 'kms_key_name_value', 'satisfies_pzs': True, 'create_time': {}}
...
def test_create_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_create_function") as post, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_create_function_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "pre_create_function") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_function_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'function': {'name': 'projects/sample1/locations/sample2/functions/sample3'}}
    request_init["function"] = {'name': 'projects/sample1/locations/sample2/functions/sample3', 'description': 'description_value', 'build_config': {'automatic_update_policy': {}, 'on_deploy_update_policy': {'runtime_version': 'runtime_version_value'}, 'build': 'build_value', 'runtime': 'runtime_value', 'entry_point': 'entry_point_value', 'source': {'storage_source': {'bucket': 'bucket_value', 'object_': 'object__value', 'generation': 1068, 'source_upload_url': 'source_upload_url_value'}, 'repo_source': {'branch_name': 'branch_name_value', 'tag_name': 'tag_name_value', 'commit_sha': 'commit_sha_value', 'project_id': 'project_id_value', 'repo_name': 'repo_name_value', 'dir_': 'dir__value', 'invert_regex': True}, 'git_uri': 'git_uri_value'}, 'source_provenance': {'resolved_storage_source': {}, 'resolved_repo_source': {}, 'git_uri': 'git_uri_value'}, 'worker_pool': 'worker_pool_value', 'environment_variables': {}, 'docker_registry': 1, 'docker_repository': 'docker_repository_value', 'service_account': 'service_account_value'}, 'service_config': {'service': 'service_value', 'timeout_seconds': 1621, 'available_memory': 'available_memory_value', 'available_cpu': 'available_cpu_value', 'environment_variables': {}, 'max_instance_count': 1922, 'min_instance_count': 1920, 'vpc_connector': 'vpc_connector_value', 'vpc_connector_egress_settings': 1, 'ingress_settings': 1, 'uri': 'uri_value', 'service_account_email': 'service_account_email_value', 'all_traffic_on_latest_revision': True, 'secret_environment_variables': [{'key': 'key_value', 'project_id': 'project_id_value', 'secret': 'secret_value', 'version': 'version_value'}], 'secret_volumes': [{'mount_path': 'mount_path_value', 'project_id': 'project_id_value', 'secret': 'secret_value', 'versions': [{'version': 'version_value', 'path': 'path_value'}]}], 'revision': 'revision_value', 'max_instance_request_concurrency': 3436, 'security_level': 1, 'binary_authorization_policy': 'binary_authorization_policy_value'}, 'event_trigger': {'trigger': 'trigger_value', 'trigger_region': 'trigger_region_value', 'event_type': 'event_type_value', 'event_filters': [{'attribute': 'attribute_value', 'value': 'value_value', 'operator': 'operator_value'}], 'pubsub_topic': 'pubsub_topic_value', 'service_account_email': 'service_account_email_value', 'retry_policy': 1, 'channel': 'channel_value', 'service': 'service_value'}, 'state': 1, 'update_time': {'seconds': 751, 'nanos': 543}, 'labels': {}, 'state_messages': [{'severity': 1, 'type_': 'type__value', 'message': 'message_value'}], 'environment': 1, 'url': 'url_value', 'kms_key_name': 'kms_key_name_value', 'satisfies_pzs': True, 'create_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_update_function") as post, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_update_function_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "pre_update_function") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_delete_function") as post, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_delete_function_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "pre_delete_function") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_generate_upload_url_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_generate_upload_url") as post, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_generate_upload_url_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "pre_generate_upload_url") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_generate_download_url_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_generate_download_url") as post, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_generate_download_url_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "pre_generate_download_url") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_runtimes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_list_runtimes") as post, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "post_list_runtimes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FunctionServiceRestInterceptor, "pre_list_runtimes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_function_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.FunctionServiceGrpcTransport, transports.FunctionServiceGrpcAsyncIOTransport])
def test_function_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

...
def test_get_function_rest_required_fields(request_type=functions.GetFunctionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_function._get_unset_required_fields(jsonified_request)
...
def test_get_function_rest_unset_required_fields():
    transport = transports.FunctionServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_functions_rest_required_fields(request_type=functions.ListFunctionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_functions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_function_rest_required_fields(request_type=functions.CreateFunctionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_function._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_function_rest_required_fields(request_type=functions.UpdateFunctionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_function._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_function_rest_required_fields(request_type=functions.DeleteFunctionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_function._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_upload_url_rest_required_fields(request_type=functions.GenerateUploadUrlRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_upload_url._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_download_url_rest_required_fields(request_type=functions.GenerateDownloadUrlRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_download_url._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_runtimes_rest_required_fields(request_type=functions.ListRuntimesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_runtimes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

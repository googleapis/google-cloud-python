...
from google.cloud.asset_v1p2beta1.types.asset_service import BatchGetAssetsHistoryResponse
...
from google.cloud.asset_v1p2beta1.types.asset_service import ExportAssetsResponse

...
class ArtifactRegistryClient(metaclass=ArtifactRegistryClientMeta):
    ...
    @staticmethod
    def attachment_path(project: str,location: str,repository: str,attachment: str,) -> str:
        """Returns a fully-qualified attachment string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/attachments/{attachment}".format(project=project, location=location, repository=repository, attachment=attachment, )

    @staticmethod
    def parse_attachment_path(path: str) -> Dict[str,str]:
        """Parses a attachment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/attachments/(?P<attachment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def docker_image_path(project: str,location: str,repository: str,docker_image: str,) -> str:
        """Returns a fully-qualified docker_image string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/dockerImages/{docker_image}".format(project=project, location=location, repository=repository, docker_image=docker_image, )

    @staticmethod
    def parse_docker_image_path(path: str) -> Dict[str,str]:
        """Parses a docker_image path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/dockerImages/(?P<docker_image>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def maven_artifact_path(project: str,location: str,repository: str,maven_artifact: str,) -> str:
        """Returns a fully-qualified maven_artifact string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/mavenArtifacts/{maven_artifact}".format(project=project, location=location, repository=repository, maven_artifact=maven_artifact, )

    @staticmethod
    def parse_maven_artifact_path(path: str) -> Dict[str,str]:
        """Parses a maven_artifact path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/mavenArtifacts/(?P<maven_artifact>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def npm_package_path(project: str,location: str,repository: str,npm_package: str,) -> str:
        """Returns a fully-qualified npm_package string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/npmPackages/{npm_package}".format(project=project, location=location, repository=repository, npm_package=npm_package, )

    @staticmethod
    def parse_npm_package_path(path: str) -> Dict[str,str]:
        """Parses a npm_package path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/npmPackages/(?P<npm_package>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def package_path(project: str,location: str,repository: str,package: str,) -> str:
        """Returns a fully-qualified package string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/packages/{package}".format(project=project, location=location, repository=repository, package=package, )

    @staticmethod
    def parse_package_path(path: str) -> Dict[str,str]:
        """Parses a package path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/packages/(?P<package>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def python_package_path(project: str,location: str,repository: str,python_package: str,) -> str:
        """Returns a fully-qualified python_package string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/pythonPackages/{python_package}".format(project=project, location=location, repository=repository, python_package=python_package, )

    @staticmethod
    def parse_python_package_path(path: str) -> Dict[str,str]:
        """Parses a python_package path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/pythonPackages/(?P<python_package>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def rule_path(project: str,location: str,repository: str,rule: str,) -> str:
        """Returns a fully-qualified rule string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/rules/{rule}".format(project=project, location=location, repository=repository, rule=rule, )

    @staticmethod
    def parse_rule_path(path: str) -> Dict[str,str]:
        """Parses a rule path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/rules/(?P<rule>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def vpcsc_config_path(project: str,location: str,) -> str:
        """Returns a fully-qualified vpcsc_config string."""
        return "projects/{project}/locations/{location}/vpcscConfig".format(project=project, location=location, )

    @staticmethod
    def parse_vpcsc_config_path(path: str) -> Dict[str,str]:
        """Parses a vpcsc_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/vpcscConfig$", path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.devtools.artifactregistry_v1.ArtifactRegistryClient`.",
                    extra = {
    ...
    def batch_delete_versions(self,
    ...
    def update_version(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.UpdateVersionRequest, dict]):
    ...
    def delete_file(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.DeleteFileRequest, dict]):
    ...
    def update_file(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.UpdateFileRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_file]
    ...
    def create_rule(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.CreateRuleRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_rule]
    ...
    def list_rules(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.ListRulesRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_rules]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListRulesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_rule(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.GetRuleRequest, dict]):
    ...
    def update_rule(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.UpdateRuleRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_rule]
    ...
    def delete_rule(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.DeleteRuleRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_rule]
    ...
    def update_package(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.UpdatePackageRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_package]
    ...
    def list_attachments(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.ListAttachmentsRequest, dict]):
    ...
    def get_attachment(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.GetAttachmentRequest, dict]):
    ...
    def create_attachment(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.CreateAttachmentRequest, dict]):
                The request object. The request to create a new
                attachment.
            parent (str):
                Required. The name of the parent
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_attachment]
    ...
    def delete_attachment(self,
        ...
        Args:
            request (Union[google.cloud.artifactregistry_v1.types.DeleteAttachmentRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_attachment]

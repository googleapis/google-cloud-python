...
class ArtifactRegistryGrpcTransport(ArtifactRegistryTransport):
    ...
    @property
    def list_docker_images(self) -> Callable[
    ...
    @property
    def get_docker_image(self) -> Callable[
    ...
    @property
    def list_maven_artifacts(self) -> Callable[
    ...
    @property
    def get_maven_artifact(self) -> Callable[
    ...
    @property
    def list_npm_packages(self) -> Callable[
    ...
    @property
    def get_npm_package(self) -> Callable[
    ...
    @property
    def list_python_packages(self) -> Callable[
    ...
    @property
    def get_python_package(self) -> Callable[
    ...
    @property
    def batch_delete_versions(self) -> Callable[
    ...
    @property
    def get_vpcsc_config(self) -> Callable[
    ...
    @property
    def update_vpcsc_config(self) -> Callable[
    ...
    @property
    def update_package(self) -> Callable[
    ...
    @property
    def create_attachment(self) -> Callable[
    ...
    @property
    def delete_attachment(self) -> Callable[

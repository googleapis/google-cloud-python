...
class ArtifactRegistryGrpcAsyncIOTransport(ArtifactRegistryTransport):
    ...
    def get_docker_image(self) -> Callable[
            ...
            Awaitable[artifact.DockerImage]]:
    ...
    def get_python_package(self) -> Callable[
            ...
            Awaitable[artifact.PythonPackage]]:
    ...
    def list_rules(self) -> Callable[
            ...
            Awaitable[rule.ListRulesResponse]]:
    ...
    def get_vpcsc_config(self) -> Callable[
            ...
            Awaitable[vpcsc_config.VPCSCConfig]]:

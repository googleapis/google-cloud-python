...
def test_create_repository_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["repository"] = {'maven_config': {'allow_snapshot_overwrites': True, 'version_policy': 1}, 'name': 'name_value', 'format_': 1, 'description': 'description_value', 'labels': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'kms_key_name': 'kms_key_name_value'}
    request = request_type(**request_init)
...
def test_update_repository_rest(request_type):
    ...
    request_init["repository"] = {'maven_config': {'allow_snapshot_overwrites': True, 'version_policy': 1}, 'name': 'projects/sample1/locations/sample2/repositories/sample3', 'format_': 1, 'description': 'description_value', 'labels': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'kms_key_name': 'kms_key_name_value'}
    request = request_type(**request_init)

...
from .base import CloudMemcacheTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class CloudMemcacheRestTransport(CloudMemcacheTransport):
    ...
    class _ApplySoftwareUpdate(CloudMemcacheRestStub):
        def __hash__(self):
            return hash("ApplySoftwareUpdate")

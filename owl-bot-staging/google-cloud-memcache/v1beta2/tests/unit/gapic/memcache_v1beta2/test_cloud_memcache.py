...
def test__read_environment_variables():
    assert CloudMemcacheClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert CloudMemcacheClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert CloudMemcacheClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert CloudMemcacheClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert CloudMemcacheClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert CloudMemcacheClient._get_client_cert_source(None, False) is None
    assert CloudMemcacheClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert CloudMemcacheClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert CloudMemcacheClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert CloudMemcacheClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(CloudMemcacheClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudMemcacheClient))
@mock.patch.object(CloudMemcacheAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudMemcacheAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CloudMemcacheClient._DEFAULT_UNIVERSE
    default_endpoint = CloudMemcacheClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = CloudMemcacheClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert CloudMemcacheClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert CloudMemcacheClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CloudMemcacheClient.DEFAULT_MTLS_ENDPOINT
    assert CloudMemcacheClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CloudMemcacheClient._get_api_endpoint(None, None, default_universe, "always") == CloudMemcacheClient.DEFAULT_MTLS_ENDPOINT
    assert CloudMemcacheClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CloudMemcacheClient.DEFAULT_MTLS_ENDPOINT
    assert CloudMemcacheClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert CloudMemcacheClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        CloudMemcacheClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert CloudMemcacheClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert CloudMemcacheClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert CloudMemcacheClient._get_universe_domain(None, None) == CloudMemcacheClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_name", [
    (CloudMemcacheClient, "grpc"),
    (CloudMemcacheAsyncClient, "grpc_asyncio"),
    (CloudMemcacheClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    ...
    (transports.CloudMemcacheRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (CloudMemcacheClient, transports.CloudMemcacheRestTransport, "rest"),
])
@mock.patch.object(CloudMemcacheClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudMemcacheClient))
@mock.patch.object(CloudMemcacheAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudMemcacheAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (CloudMemcacheClient, transports.CloudMemcacheRestTransport, "rest", "true"),
    (CloudMemcacheClient, transports.CloudMemcacheRestTransport, "rest", "false"),
])
@mock.patch.object(CloudMemcacheClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudMemcacheClient))
@mock.patch.object(CloudMemcacheAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudMemcacheAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    CloudMemcacheClient, CloudMemcacheAsyncClient
])
...
@mock.patch.object(CloudMemcacheClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudMemcacheClient))
@mock.patch.object(CloudMemcacheAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudMemcacheAsyncClient))
def test_cloud_memcache_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (CloudMemcacheClient, transports.CloudMemcacheGrpcTransport, "grpc", grpc_helpers),
    (CloudMemcacheAsyncClient, transports.CloudMemcacheGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (CloudMemcacheClient, transports.CloudMemcacheRestTransport, "rest", None),
])
...
def test_update_parameters_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_parameters_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_parameters in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_parameters] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_parameters_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudMemcacheAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_parameters in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_parameters] = mock_rpc
...
def test_apply_parameters_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_apply_parameters_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.apply_parameters in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.apply_parameters] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_apply_parameters_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudMemcacheAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.apply_parameters in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.apply_parameters] = mock_rpc
...
def test_apply_software_update_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_apply_software_update_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.apply_software_update in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.apply_software_update] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_apply_software_update_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudMemcacheAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.apply_software_update in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.apply_software_update] = mock_rpc
...
def test_reschedule_maintenance_flattened():
    ...
    with mock.patch.object(
        ...
        client.reschedule_maintenance(
            instance='instance_value',
            reschedule_type=cloud_memcache.RescheduleMaintenanceRequest.RescheduleType.IMMEDIATE,
...
def test_update_parameters_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudMemcacheClient(
...
def test_apply_parameters_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudMemcacheClient(
...
def test_apply_software_update_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudMemcacheClient(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_parameters_empty_call_grpc():
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_parameters(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_apply_parameters_empty_call_grpc():
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.apply_parameters(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_apply_software_update_empty_call_grpc():
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.apply_software_update(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = CloudMemcacheAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_parameters_empty_call_grpc_asyncio():
    client = CloudMemcacheAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_parameters(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_apply_parameters_empty_call_grpc_asyncio():
    client = CloudMemcacheAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.apply_parameters(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_apply_software_update_empty_call_grpc_asyncio():
    client = CloudMemcacheAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.apply_software_update(request=None)
...
def test_transport_kind_rest():
    transport = CloudMemcacheClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_instances_rest_bad_request(request_type=cloud_memcache.ListInstancesRequest):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_instances_rest_interceptors(null_interceptor):
    transport = transports.CloudMemcacheRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CloudMemcacheRestInterceptor(),
        )
    client = CloudMemcacheClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_list_instances") as post, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_list_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "pre_list_instances") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_memcache.ListInstancesResponse.to_json(cloud_memcache.ListInstancesResponse())
        ...
        post_with_metadata.return_value = cloud_memcache.ListInstancesResponse(), metadata
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_get_instance") as post, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_get_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "pre_get_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_memcache.Instance.to_json(cloud_memcache.Instance())
        req.return_value.content = return_value
...
def test_create_instance_rest_bad_request(request_type=cloud_memcache.CreateInstanceRequest):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_create_instance") as post, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_create_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "pre_create_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_instance_rest_bad_request(request_type=cloud_memcache.UpdateInstanceRequest):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_update_instance") as post, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_update_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "pre_update_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_parameters_rest_bad_request(request_type=cloud_memcache.UpdateParametersRequest):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_parameters_rest_call_success(request_type):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_parameters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_update_parameters") as post, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_update_parameters_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "pre_update_parameters") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_instance_rest_bad_request(request_type=cloud_memcache.DeleteInstanceRequest):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_delete_instance") as post, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_delete_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "pre_delete_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_apply_parameters_rest_bad_request(request_type=cloud_memcache.ApplyParametersRequest):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_apply_parameters_rest_call_success(request_type):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_apply_parameters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_apply_parameters") as post, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_apply_parameters_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "pre_apply_parameters") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_apply_software_update_rest_bad_request(request_type=cloud_memcache.ApplySoftwareUpdateRequest):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_apply_software_update_rest_call_success(request_type):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_apply_software_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_apply_software_update") as post, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_apply_software_update_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "pre_apply_software_update") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_reschedule_maintenance_rest_bad_request(request_type=cloud_memcache.RescheduleMaintenanceRequest):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_reschedule_maintenance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_reschedule_maintenance") as post, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_reschedule_maintenance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudMemcacheRestInterceptor, "pre_reschedule_maintenance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_parameters_empty_call_rest():
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_apply_parameters_empty_call_rest():
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_apply_software_update_empty_call_rest():
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_cloud_memcache_host_no_port(transport_name):
    ...
    assert client.transport._host == (
        'memcache.googleapis.com:443'
        if transport_name in ['grpc', 'grpc_asyncio']
        else 'https://memcache.googleapis.com'
    )
...
def test_cloud_memcache_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        'memcache.googleapis.com:8000'
        if transport_name in ['grpc', 'grpc_asyncio']
        else 'https://memcache.googleapis.com:8000'
    )
...
def test_cloud_memcache_client_transport_session_collision(transport_name):
    ...
    client1 = CloudMemcacheClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = CloudMemcacheClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("client_class,transport_class", [
    (CloudMemcacheClient, transports.CloudMemcacheGrpcTransport),
    (CloudMemcacheAsyncClient, transports.CloudMemcacheGrpcAsyncIOTransport),
])

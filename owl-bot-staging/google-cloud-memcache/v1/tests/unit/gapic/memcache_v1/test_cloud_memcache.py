...
def test_list_instances_rest_unset_required_fields():
    transport = transports.CloudMemcacheRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_parameters_rest_required_fields(request_type=cloud_memcache.UpdateParametersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_parameters._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_apply_parameters_rest_required_fields(request_type=cloud_memcache.ApplyParametersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).apply_parameters._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reschedule_maintenance_rest_required_fields(request_type=cloud_memcache.RescheduleMaintenanceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).reschedule_maintenance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

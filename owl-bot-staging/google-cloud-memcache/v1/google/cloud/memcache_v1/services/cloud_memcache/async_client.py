...
class CloudMemcacheAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CloudMemcacheTransport, Callable[..., CloudMemcacheTransport]]] = "grpc_asyncio",
    ...
    async def update_parameters(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_parameters]
    ...
    async def apply_parameters(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.apply_parameters]

...
class CloudMemcacheClient(metaclass=CloudMemcacheClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            CloudMemcacheClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            CloudMemcacheClient._get_api_endpoint(
    ...
    def reschedule_maintenance(self,
        ...
        Args:
            request (Union[google.cloud.memcache_v1.types.RescheduleMaintenanceRequest, dict]):
                The request object. Request for

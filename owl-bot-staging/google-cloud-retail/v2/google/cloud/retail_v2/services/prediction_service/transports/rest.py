    ...
    class _Predict(_BasePredictionServiceRestTransport._BasePredict, PredictionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.PredictionServiceClient.Predict",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.PredictionServiceClient.predict",
                    extra = {
                        "serviceName": "google.cloud.retail.v2.PredictionService",
                        "rpcName": "Predict",
    ...
    class _GetOperation(_BasePredictionServiceRestTransport._BaseGetOperation, PredictionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.PredictionServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2.PredictionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.PredictionServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2.PredictionService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BasePredictionServiceRestTransport._BaseListOperations, PredictionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.PredictionServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2.PredictionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.PredictionServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2.PredictionService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

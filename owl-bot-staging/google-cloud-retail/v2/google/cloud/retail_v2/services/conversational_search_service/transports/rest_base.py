...
class _BaseConversationalSearchServiceRestTransport(ConversationalSearchServiceTransport):
    ...
    class _BaseConversationalSearch:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{placement=projects/*/locations/*/catalogs/*/placements/*}:conversationalSearch',
                'body': '*',
            },
        {
                'method': 'post',
                'uri': '/v2/{placement=projects/*/locations/*/catalogs/*/servingConfigs/*}:conversationalSearch',
                'body': '*',
            },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = conversational_search_service.ConversationalSearchRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseConversationalSearchServiceRestTransport._BaseConversationalSearch._get_unset_required_fields(query_params))

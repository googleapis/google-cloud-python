...
from .base import GenerativeQuestionServiceTransport, DEFAULT_CLIENT_INFO
...
class GenerativeQuestionServiceGrpcAsyncIOTransport(GenerativeQuestionServiceTransport):
    ...
    @property
    def update_generative_questions_feature_config(self) -> Callable[
        ...
        if 'update_generative_questions_feature_config' not in self._stubs:
            self._stubs['update_generative_questions_feature_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_generative_questions_feature_config(self) -> Callable[
        ...
        if 'get_generative_questions_feature_config' not in self._stubs:
            self._stubs['get_generative_questions_feature_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_generative_question_configs(self) -> Callable[
        ...
        if 'list_generative_question_configs' not in self._stubs:
            self._stubs['list_generative_question_configs'] = self.grpc_channel.unary_unary(
    ...
    @property
    def update_generative_question_config(self) -> Callable[
        ...
        if 'update_generative_question_config' not in self._stubs:
            self._stubs['update_generative_question_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def batch_update_generative_question_configs(self) -> Callable[
        ...
        if 'batch_update_generative_question_configs' not in self._stubs:
            self._stubs['batch_update_generative_question_configs'] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.update_generative_questions_feature_config: self._wrap_method(
                self.update_generative_questions_feature_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_generative_questions_feature_config: self._wrap_method(
                self.get_generative_questions_feature_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_generative_question_configs: self._wrap_method(
                self.list_generative_question_configs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_generative_question_config: self._wrap_method(
                self.update_generative_question_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_update_generative_question_configs: self._wrap_method(

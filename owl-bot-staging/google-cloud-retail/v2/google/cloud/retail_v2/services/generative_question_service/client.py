...
from .transports.base import GenerativeQuestionServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import GenerativeQuestionServiceGrpcTransport
from .transports.grpc_asyncio import GenerativeQuestionServiceGrpcAsyncIOTransport
from .transports.rest import GenerativeQuestionServiceRestTransport


class GenerativeQuestionServiceClientMeta(type):
    """Metaclass for the GenerativeQuestionService client.
    ...
    def get_transport_class(cls,
        ...
        ) -> Type[GenerativeQuestionServiceTransport]:
...
class GenerativeQuestionServiceClient(metaclass=GenerativeQuestionServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            GenerativeQuestionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> GenerativeQuestionServiceTransport:
        ...
        Returns:
            GenerativeQuestionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = GenerativeQuestionServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = GenerativeQuestionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = GenerativeQuestionServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            GenerativeQuestionServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GenerativeQuestionServiceTransport, Callable[..., GenerativeQuestionServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GenerativeQuestionServiceClient._read_environment_variables()
        self._client_cert_source = GenerativeQuestionServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = GenerativeQuestionServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, GenerativeQuestionServiceTransport)
        if transport_provided:
            # transport is a GenerativeQuestionServiceTransport instance.
            ...
            self._transport = cast(GenerativeQuestionServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[GenerativeQuestionServiceTransport], Callable[..., GenerativeQuestionServiceTransport]] = (
                GenerativeQuestionServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., GenerativeQuestionServiceTransport], transport)
            )
    ...
    def update_generative_questions_feature_config(self,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.UpdateGenerativeQuestionsFeatureConfigRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.update_generative_questions_feature_config]
    ...
    def get_generative_questions_feature_config(self,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.GetGenerativeQuestionsFeatureConfigRequest, dict]):
                The request object. Request for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_generative_questions_feature_config]
    ...
    def list_generative_question_configs(self,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.ListGenerativeQuestionConfigsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_generative_question_configs]
    ...
    def update_generative_question_config(self,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.UpdateGenerativeQuestionConfigRequest, dict]):
                The request object. Request for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_generative_question_config]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("generative_question_config.catalog", request.generative_question_config.catalog),
            )),
        )
    ...
    def batch_update_generative_question_configs(self,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.BatchUpdateGenerativeQuestionConfigsRequest, dict]):
                The request object. Request for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_update_generative_question_configs]
    ...
    def __enter__(self) -> "GenerativeQuestionServiceClient":
        return self

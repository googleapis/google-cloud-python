...
class ServingConfigServiceGrpcAsyncIOTransport(ServingConfigServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_serving_config: gapic_v1.method_async.wrap_method(
                self.create_serving_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_serving_config: gapic_v1.method_async.wrap_method(
                self.delete_serving_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_serving_config: gapic_v1.method_async.wrap_method(
                self.update_serving_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_serving_config: gapic_v1.method_async.wrap_method(
                self.get_serving_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_serving_configs: gapic_v1.method_async.wrap_method(
                self.list_serving_configs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.add_control: gapic_v1.method_async.wrap_method(
                self.add_control,
                default_timeout=None,
                client_info=client_info,
            ),
            self.remove_control: gapic_v1.method_async.wrap_method(
                self.remove_control,
                default_timeout=None,
                client_info=client_info,
            ),

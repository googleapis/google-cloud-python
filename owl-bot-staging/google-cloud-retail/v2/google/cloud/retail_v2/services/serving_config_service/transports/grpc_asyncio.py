...
class ServingConfigServiceGrpcAsyncIOTransport(ServingConfigServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.get_serving_config: self._wrap_method(
                self.get_serving_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_serving_configs: self._wrap_method(
                self.list_serving_configs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.add_control: self._wrap_method(
                self.add_control,
                default_timeout=None,
                client_info=client_info,
            ),
            self.remove_control: self._wrap_method(
                self.remove_control,
                default_timeout=None,
                client_info=client_info,
            ),

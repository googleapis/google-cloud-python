...
class ServingConfigServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_add_control(self, request: serving_config_service.AddControlRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[serving_config_service.AddControlRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_add_control_with_metadata(self, response: gcr_serving_config.ServingConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcr_serving_config.ServingConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for add_control
    ...
    def pre_create_serving_config(self, request: serving_config_service.CreateServingConfigRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[serving_config_service.CreateServingConfigRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_serving_config_with_metadata(self, response: gcr_serving_config.ServingConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcr_serving_config.ServingConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_serving_config
    ...
    def pre_delete_serving_config(self, request: serving_config_service.DeleteServingConfigRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[serving_config_service.DeleteServingConfigRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_serving_config(self, request: serving_config_service.GetServingConfigRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[serving_config_service.GetServingConfigRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_serving_config_with_metadata(self, response: serving_config.ServingConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[serving_config.ServingConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_serving_config
    ...
    def pre_list_serving_configs(self, request: serving_config_service.ListServingConfigsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[serving_config_service.ListServingConfigsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_serving_configs(self, response: serving_config_service.ListServingConfigsResponse) -> serving_config_service.ListServingConfigsResponse:
    ...
    def post_list_serving_configs_with_metadata(self, response: serving_config_service.ListServingConfigsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[serving_config_service.ListServingConfigsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_serving_configs
    ...
    def pre_remove_control(self, request: serving_config_service.RemoveControlRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[serving_config_service.RemoveControlRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_remove_control_with_metadata(self, response: gcr_serving_config.ServingConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcr_serving_config.ServingConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for remove_control
    ...
    def pre_update_serving_config(self, request: serving_config_service.UpdateServingConfigRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[serving_config_service.UpdateServingConfigRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_serving_config_with_metadata(self, response: gcr_serving_config.ServingConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcr_serving_config.ServingConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_serving_config
...
class ServingConfigServiceRestTransport(_BaseServingConfigServiceRestTransport):
    ...
    class _AddControl(_BaseServingConfigServiceRestTransport._BaseAddControl, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ServingConfigServiceRestTransport._AddControl._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CreateServingConfig(_BaseServingConfigServiceRestTransport._BaseCreateServingConfig, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ServingConfigServiceRestTransport._CreateServingConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteServingConfig(_BaseServingConfigServiceRestTransport._BaseDeleteServingConfig, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ServingConfigServiceRestTransport._DeleteServingConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetServingConfig(_BaseServingConfigServiceRestTransport._BaseGetServingConfig, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ServingConfigServiceRestTransport._GetServingConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListServingConfigs(_BaseServingConfigServiceRestTransport._BaseListServingConfigs, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ServingConfigServiceRestTransport._ListServingConfigs._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RemoveControl(_BaseServingConfigServiceRestTransport._BaseRemoveControl, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ServingConfigServiceRestTransport._RemoveControl._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateServingConfig(_BaseServingConfigServiceRestTransport._BaseUpdateServingConfig, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ServingConfigServiceRestTransport._UpdateServingConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def create_serving_config(self) -> Callable[
    ...
    @property
    def delete_serving_config(self) -> Callable[
    ...
    @property
    def remove_control(self) -> Callable[
    ...
    class _GetOperation(_BaseServingConfigServiceRestTransport._BaseGetOperation, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ServingConfigServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseServingConfigServiceRestTransport._BaseListOperations, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ServingConfigServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
...
__all__=(
    'ServingConfigServiceRestTransport',
)

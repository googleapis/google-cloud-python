...
def test_create_serving_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ServingConfigServiceRestInterceptor, "post_create_serving_config_with_metadata") as post_with_metadata, \
...
def test_add_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ServingConfigServiceRestInterceptor, "post_add_control_with_metadata") as post_with_metadata, \
...
def test_remove_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ServingConfigServiceRestInterceptor, "post_remove_control_with_metadata") as post_with_metadata, \

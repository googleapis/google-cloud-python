...
def test_create_model_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/catalogs/sample3'}
    request_init["model"] = {'name': 'name_value', 'display_name': 'display_name_value', 'training_state': 1, 'serving_state': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'type_': 'type__value', 'optimization_objective': 'optimization_objective_value', 'periodic_tuning_state': 1, 'last_tune_time': {}, 'tuning_operation': 'tuning_operation_value', 'data_state': 1, 'filtering_option': 1, 'serving_config_lists': [{'serving_config_ids': ['serving_config_ids_value1', 'serving_config_ids_value2']}], 'model_features_config': {'frequently_bought_together_config': {'context_products_type': 1}}}
...
def test_create_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ModelServiceRestInterceptor, "post_create_model_with_metadata") as post_with_metadata, \
...
def test_pause_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ModelServiceRestInterceptor, "post_pause_model_with_metadata") as post_with_metadata, \
...
def test_resume_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ModelServiceRestInterceptor, "post_resume_model_with_metadata") as post_with_metadata, \
...
def test_tune_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ModelServiceRestInterceptor, "post_tune_model_with_metadata") as post_with_metadata, \

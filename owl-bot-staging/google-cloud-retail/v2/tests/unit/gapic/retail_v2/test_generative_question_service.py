...
from google.cloud.retail_v2.services.generative_question_service import GenerativeQuestionServiceAsyncClient
from google.cloud.retail_v2.services.generative_question_service import GenerativeQuestionServiceClient
from google.cloud.retail_v2.services.generative_question_service import transports
from google.cloud.retail_v2.types import generative_question
from google.cloud.retail_v2.types import generative_question_service
...
def test_generative_question_service_client_client_options_from_dict():
    with mock.patch('google.cloud.retail_v2.services.generative_question_service.transports.GenerativeQuestionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_update_generative_questions_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2/{generative_questions_feature_config.catalog=projects/*/locations/*/catalogs/*}/generativeQuestionFeature" % client.transport._host, args[1])
...
def test_update_generative_question_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{generative_question_config.catalog=projects/*/locations/*/catalogs/*}/generativeQuestion" % client.transport._host, args[1])
...
def test_batch_update_generative_question_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/locations/*/catalogs/*}/generativeQuestion:batchUpdate" % client.transport._host, args[1])
...
def test_generative_question_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2.services.generative_question_service.transports.GenerativeQuestionServiceTransport.__init__') as Transport:
...
def test_generative_question_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2.services.generative_question_service.transports.GenerativeQuestionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_generative_question_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2.services.generative_question_service.transports.GenerativeQuestionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GenerativeQuestionServiceTransport()
        adc.assert_called_once()

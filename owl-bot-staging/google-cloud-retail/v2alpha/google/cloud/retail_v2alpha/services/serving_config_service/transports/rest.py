    ...
    class _AddControl(_BaseServingConfigServiceRestTransport._BaseAddControl, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ServingConfigServiceClient.AddControl",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.ServingConfigServiceClient.add_control",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
                        "rpcName": "AddControl",
    ...
    class _CreateServingConfig(_BaseServingConfigServiceRestTransport._BaseCreateServingConfig, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ServingConfigServiceClient.CreateServingConfig",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.ServingConfigServiceClient.create_serving_config",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
                        "rpcName": "CreateServingConfig",
                        "metadata": http_response["headers"],
    ...
    class _DeleteServingConfig(_BaseServingConfigServiceRestTransport._BaseDeleteServingConfig, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ServingConfigServiceClient.DeleteServingConfig",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
    ...
    class _GetServingConfig(_BaseServingConfigServiceRestTransport._BaseGetServingConfig, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ServingConfigServiceClient.GetServingConfig",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.ServingConfigServiceClient.get_serving_config",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
                        "rpcName": "GetServingConfig",
                        "metadata": http_response["headers"],
    ...
    class _ListServingConfigs(_BaseServingConfigServiceRestTransport._BaseListServingConfigs, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ServingConfigServiceClient.ListServingConfigs",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.ServingConfigServiceClient.list_serving_configs",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
                        "rpcName": "ListServingConfigs",
                        "metadata": http_response["headers"],
    ...
    class _RemoveControl(_BaseServingConfigServiceRestTransport._BaseRemoveControl, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ServingConfigServiceClient.RemoveControl",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.ServingConfigServiceClient.remove_control",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
                        "rpcName": "RemoveControl",
                        "metadata": http_response["headers"],
    ...
    class _UpdateServingConfig(_BaseServingConfigServiceRestTransport._BaseUpdateServingConfig, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ServingConfigServiceClient.UpdateServingConfig",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.ServingConfigServiceClient.update_serving_config",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
                        "rpcName": "UpdateServingConfig",
                        "metadata": http_response["headers"],
    ...
    class _GetOperation(_BaseServingConfigServiceRestTransport._BaseGetOperation, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ServingConfigServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.ServingConfigServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseServingConfigServiceRestTransport._BaseListOperations, ServingConfigServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ServingConfigServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.ServingConfigServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ServingConfigService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

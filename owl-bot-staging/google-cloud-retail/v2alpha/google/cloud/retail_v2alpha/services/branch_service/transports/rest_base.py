...
class _BaseBranchServiceRestTransport(BranchServiceTransport):
    """Base REST backend transport for BranchService.
    ...
    class _BaseGetBranch:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseBranchServiceRestTransport._BaseGetBranch._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseListBranches:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseBranchServiceRestTransport._BaseListBranches._get_unset_required_fields(query_params))
...
__all__=(
    '_BaseBranchServiceRestTransport',
)

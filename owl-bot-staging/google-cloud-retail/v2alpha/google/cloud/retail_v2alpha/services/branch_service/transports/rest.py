...
from google.cloud.retail_v2alpha.types import branch_service
...
class BranchServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_branch(self, request: branch_service.GetBranchRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[branch_service.GetBranchRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_branch(self, response: branch.Branch) -> branch.Branch:
        ...
        DEPRECATED. Please use the `post_get_branch_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the BranchService server but before
        it is returned to user code. This `post_get_branch` interceptor runs
        before the `post_get_branch_with_metadata` interceptor.
        """
        return response

    def post_get_branch_with_metadata(self, response: branch.Branch, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[branch.Branch, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_branch

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the BranchService server but before it is returned to user code.

        We recommend only using this `post_get_branch_with_metadata`
        interceptor in new development instead of the `post_get_branch` interceptor.
        When both interceptors are used, this `post_get_branch_with_metadata` interceptor runs after the
        `post_get_branch` interceptor. The (possibly modified) response returned by
        `post_get_branch` will be passed to
        `post_get_branch_with_metadata`.
        """
        return response, metadata

    def pre_list_branches(self, request: branch_service.ListBranchesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[branch_service.ListBranchesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_branches(self, response: branch_service.ListBranchesResponse) -> branch_service.ListBranchesResponse:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the BranchService server but before
        it is returned to user code. This `post_list_branches` interceptor runs
        before the `post_list_branches_with_metadata` interceptor.
        """
        return response

    def post_list_branches_with_metadata(self, response: branch_service.ListBranchesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[branch_service.ListBranchesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_branches

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the BranchService server but before it is returned to user code.

        We recommend only using this `post_list_branches_with_metadata`
        interceptor in new development instead of the `post_list_branches` interceptor.
        When both interceptors are used, this `post_list_branches_with_metadata` interceptor runs after the
        `post_list_branches` interceptor. The (possibly modified) response returned by
        `post_list_branches` will be passed to
        `post_list_branches_with_metadata`.
        """
        return response, metadata
...
class BranchServiceRestTransport(_BaseBranchServiceRestTransport):
    ...
    class _GetBranch(_BaseBranchServiceRestTransport._BaseGetBranch, BranchServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BranchServiceRestTransport._GetBranch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListBranches(_BaseBranchServiceRestTransport._BaseListBranches, BranchServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BranchServiceRestTransport._ListBranches._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    @property
    def list_branches(self) -> Callable[
    ...
    class _GetOperation(_BaseBranchServiceRestTransport._BaseGetOperation, BranchServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BranchServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseBranchServiceRestTransport._BaseListOperations, BranchServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = BranchServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

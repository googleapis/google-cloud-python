...
class BranchServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_branch(self, request: branch_service.GetBranchRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[branch_service.GetBranchRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_branches(self, request: branch_service.ListBranchesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[branch_service.ListBranchesRequest, Sequence[Tuple[str, str]]]:

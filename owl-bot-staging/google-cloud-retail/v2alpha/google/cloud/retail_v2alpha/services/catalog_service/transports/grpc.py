...
class CatalogServiceGrpcTransport(CatalogServiceTransport):
    ...
    def update_catalog(self) -> Callable[
        ...
        if 'update_catalog' not in self._stubs:
            self._stubs['update_catalog'] = self._logged_channel.unary_unary(
    ...
    def set_default_branch(self) -> Callable[
        ...
        if 'set_default_branch' not in self._stubs:
            self._stubs['set_default_branch'] = self._logged_channel.unary_unary(
    ...
    def get_default_branch(self) -> Callable[
        ...
        if 'get_default_branch' not in self._stubs:
            self._stubs['get_default_branch'] = self._logged_channel.unary_unary(
    ...
    def get_completion_config(self) -> Callable[
        ...
        if 'get_completion_config' not in self._stubs:
            self._stubs['get_completion_config'] = self._logged_channel.unary_unary(
    ...
    def update_completion_config(self) -> Callable[
        ...
        if 'update_completion_config' not in self._stubs:
            self._stubs['update_completion_config'] = self._logged_channel.unary_unary(
    ...
    def get_attributes_config(self) -> Callable[
        ...
        if 'get_attributes_config' not in self._stubs:
            self._stubs['get_attributes_config'] = self._logged_channel.unary_unary(
    ...
    def update_attributes_config(self) -> Callable[
        ...
        if 'update_attributes_config' not in self._stubs:
            self._stubs['update_attributes_config'] = self._logged_channel.unary_unary(
    ...
    def add_catalog_attribute(self) -> Callable[
        ...
        if 'add_catalog_attribute' not in self._stubs:
            self._stubs['add_catalog_attribute'] = self._logged_channel.unary_unary(
    ...
    def remove_catalog_attribute(self) -> Callable[
        ...
        if 'remove_catalog_attribute' not in self._stubs:
            self._stubs['remove_catalog_attribute'] = self._logged_channel.unary_unary(
    ...
    def replace_catalog_attribute(self) -> Callable[
        ...
        if 'replace_catalog_attribute' not in self._stubs:
            self._stubs['replace_catalog_attribute'] = self._logged_channel.unary_unary(

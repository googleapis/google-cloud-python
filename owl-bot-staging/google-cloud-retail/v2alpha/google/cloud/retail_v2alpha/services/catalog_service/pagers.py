...
class ListCatalogsPager:
    ...
    :class:`google.cloud.retail_v2alpha.types.ListCatalogsResponse` object, and
    ...
    All the usual :class:`google.cloud.retail_v2alpha.types.ListCatalogsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.retail_v2alpha.types.ListCatalogsResponse):

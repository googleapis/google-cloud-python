    ...
    class _CompleteQuery(_BaseCompletionServiceRestTransport._BaseCompleteQuery, CompletionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.CompletionServiceClient.CompleteQuery",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.CompletionServiceClient.complete_query",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.CompletionService",
                        "rpcName": "CompleteQuery",
    ...
    class _ImportCompletionData(_BaseCompletionServiceRestTransport._BaseImportCompletionData, CompletionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.CompletionServiceClient.ImportCompletionData",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.CompletionServiceClient.import_completion_data",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.CompletionService",
                        "rpcName": "ImportCompletionData",
                        "metadata": http_response["headers"],
    ...
    class _GetOperation(_BaseCompletionServiceRestTransport._BaseGetOperation, CompletionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.CompletionServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.CompletionServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.CompletionService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseCompletionServiceRestTransport._BaseListOperations, CompletionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.CompletionServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.CompletionServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.CompletionService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

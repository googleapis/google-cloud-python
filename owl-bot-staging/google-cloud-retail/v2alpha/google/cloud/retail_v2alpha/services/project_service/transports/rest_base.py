...
class _BaseProjectServiceRestTransport(ProjectServiceTransport):
    ...
    class _BaseAcceptTerms:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectServiceRestTransport._BaseAcceptTerms._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseEnrollSolution:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectServiceRestTransport._BaseEnrollSolution._get_unset_required_fields(query_params))
    ...
    class _BaseGetLoggingConfig:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectServiceRestTransport._BaseGetLoggingConfig._get_unset_required_fields(query_params))
    ...
    class _BaseListEnrolledSolutions:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectServiceRestTransport._BaseListEnrolledSolutions._get_unset_required_fields(query_params))
    ...
    class _BaseUpdateLoggingConfig:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectServiceRestTransport._BaseUpdateLoggingConfig._get_unset_required_fields(query_params))

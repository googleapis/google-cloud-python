...
class ProjectServiceGrpcTransport(ProjectServiceTransport):
    ...
    @property
    def accept_terms(self) -> Callable[
        ...
        if 'accept_terms' not in self._stubs:
            self._stubs['accept_terms'] = self._logged_channel.unary_unary(
    ...
    @property
    def enroll_solution(self) -> Callable[
        ...
        if 'enroll_solution' not in self._stubs:
            self._stubs['enroll_solution'] = self._logged_channel.unary_unary(
    ...
    @property
    def list_enrolled_solutions(self) -> Callable[
        ...
        if 'list_enrolled_solutions' not in self._stubs:
            self._stubs['list_enrolled_solutions'] = self._logged_channel.unary_unary(
    ...
    @property
    def get_logging_config(self) -> Callable[
        ...
        if 'get_logging_config' not in self._stubs:
            self._stubs['get_logging_config'] = self._logged_channel.unary_unary(
    ...
    @property
    def update_logging_config(self) -> Callable[
        ...
        if 'update_logging_config' not in self._stubs:
            self._stubs['update_logging_config'] = self._logged_channel.unary_unary(
    ...
    @property
    def get_alert_config(self) -> Callable[
        ...
        if 'get_alert_config' not in self._stubs:
            self._stubs['get_alert_config'] = self._logged_channel.unary_unary(
    ...
    @property
    def update_alert_config(self) -> Callable[
        ...
        if 'update_alert_config' not in self._stubs:
            self._stubs['update_alert_config'] = self._logged_channel.unary_unary(

...
class ProjectServiceClient(metaclass=ProjectServiceClientMeta):
    ...
    @staticmethod
    def logging_config_path(project: str,) -> str:
        """Returns a fully-qualified logging_config string."""
        return "projects/{project}/loggingConfig".format(project=project, )
    ...
    @staticmethod
    def retail_project_path(project: str,) -> str:
        """Returns a fully-qualified retail_project string."""
        return "projects/{project}/retailProject".format(project=project, )
    ...
    def list_enrolled_solutions(self,

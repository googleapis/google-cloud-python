...
from google.cloud.retail_v2alpha.types import generative_question_service
...
class GenerativeQuestionServiceAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.retail_v2alpha.GenerativeQuestionServiceAsyncClient`.",
                extra = {
    ...
    async def update_generative_questions_feature_config(self,
    ...
    async def get_generative_questions_feature_config(self,
    ...
    async def list_generative_question_configs(self,
    ...
    async def update_generative_question_config(self,
    ...
    async def batch_update_generative_question_configs(self,

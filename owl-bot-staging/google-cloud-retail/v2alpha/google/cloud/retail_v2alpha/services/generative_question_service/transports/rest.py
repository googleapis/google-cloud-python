...
class GenerativeQuestionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_update_generative_question_configs(self, request: generative_question_service.BatchUpdateGenerativeQuestionConfigsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[generative_question_service.BatchUpdateGenerativeQuestionConfigsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_generative_questions_feature_config(self, request: generative_question_service.GetGenerativeQuestionsFeatureConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[generative_question_service.GetGenerativeQuestionsFeatureConfigRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_generative_question_configs(self, request: generative_question_service.ListGenerativeQuestionConfigsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[generative_question_service.ListGenerativeQuestionConfigsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_generative_question_config(self, request: generative_question_service.UpdateGenerativeQuestionConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[generative_question_service.UpdateGenerativeQuestionConfigRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_generative_questions_feature_config(self, request: generative_question_service.UpdateGenerativeQuestionsFeatureConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[generative_question_service.UpdateGenerativeQuestionsFeatureConfigRequest, Sequence[Tuple[str, str]]]:

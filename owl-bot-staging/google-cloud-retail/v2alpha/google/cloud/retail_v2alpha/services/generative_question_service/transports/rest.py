...
class GenerativeQuestionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_update_generative_question_configs(self, request: generative_question_service.BatchUpdateGenerativeQuestionConfigsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_question_service.BatchUpdateGenerativeQuestionConfigsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_batch_update_generative_question_configs(self, response: generative_question_service.BatchUpdateGenerativeQuestionConfigsResponse) -> generative_question_service.BatchUpdateGenerativeQuestionConfigsResponse:
    ...
    def pre_get_generative_questions_feature_config(self, request: generative_question_service.GetGenerativeQuestionsFeatureConfigRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_question_service.GetGenerativeQuestionsFeatureConfigRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_generative_questions_feature_config(self, response: generative_question.GenerativeQuestionsFeatureConfig) -> generative_question.GenerativeQuestionsFeatureConfig:
    ...
    def post_get_generative_questions_feature_config_with_metadata(self, response: generative_question.GenerativeQuestionsFeatureConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_question.GenerativeQuestionsFeatureConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_generative_questions_feature_config
    ...
    def pre_list_generative_question_configs(self, request: generative_question_service.ListGenerativeQuestionConfigsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_question_service.ListGenerativeQuestionConfigsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_generative_question_configs(self, response: generative_question_service.ListGenerativeQuestionConfigsResponse) -> generative_question_service.ListGenerativeQuestionConfigsResponse:
    ...
    def post_list_generative_question_configs_with_metadata(self, response: generative_question_service.ListGenerativeQuestionConfigsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_question_service.ListGenerativeQuestionConfigsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_generative_question_configs
    ...
    def pre_update_generative_question_config(self, request: generative_question_service.UpdateGenerativeQuestionConfigRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_question_service.UpdateGenerativeQuestionConfigRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_generative_question_config(self, response: generative_question.GenerativeQuestionConfig) -> generative_question.GenerativeQuestionConfig:
    ...
    def post_update_generative_question_config_with_metadata(self, response: generative_question.GenerativeQuestionConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_question.GenerativeQuestionConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_generative_question_config
    ...
    def pre_update_generative_questions_feature_config(self, request: generative_question_service.UpdateGenerativeQuestionsFeatureConfigRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_question_service.UpdateGenerativeQuestionsFeatureConfigRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_generative_questions_feature_config(self, response: generative_question.GenerativeQuestionsFeatureConfig) -> generative_question.GenerativeQuestionsFeatureConfig:
    ...
    def post_update_generative_questions_feature_config_with_metadata(self, response: generative_question.GenerativeQuestionsFeatureConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_question.GenerativeQuestionsFeatureConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_generative_questions_feature_config
...
class GenerativeQuestionServiceRestTransport(_BaseGenerativeQuestionServiceRestTransport):
    ...
    class _BatchUpdateGenerativeQuestionConfigs(_BaseGenerativeQuestionServiceRestTransport._BaseBatchUpdateGenerativeQuestionConfigs, GenerativeQuestionServiceRestStub):
        def __hash__(self):
        ...
        question configs method over HTTP.
            ...
            transcoded_request = _BaseGenerativeQuestionServiceRestTransport._BaseBatchUpdateGenerativeQuestionConfigs._get_transcoded_request(http_options, request)
            ...
            query_params = _BaseGenerativeQuestionServiceRestTransport._BaseBatchUpdateGenerativeQuestionConfigs._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = GenerativeQuestionServiceRestTransport._BatchUpdateGenerativeQuestionConfigs._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetGenerativeQuestionsFeatureConfig(_BaseGenerativeQuestionServiceRestTransport._BaseGetGenerativeQuestionsFeatureConfig, GenerativeQuestionServiceRestStub):
        def __hash__(self):
        ...
        feature config method over HTTP.
            ...
            transcoded_request = _BaseGenerativeQuestionServiceRestTransport._BaseGetGenerativeQuestionsFeatureConfig._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseGenerativeQuestionServiceRestTransport._BaseGetGenerativeQuestionsFeatureConfig._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = GenerativeQuestionServiceRestTransport._GetGenerativeQuestionsFeatureConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListGenerativeQuestionConfigs(_BaseGenerativeQuestionServiceRestTransport._BaseListGenerativeQuestionConfigs, GenerativeQuestionServiceRestStub):
        def __hash__(self):
        ...
        configs method over HTTP.
            ...
            transcoded_request = _BaseGenerativeQuestionServiceRestTransport._BaseListGenerativeQuestionConfigs._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = GenerativeQuestionServiceRestTransport._ListGenerativeQuestionConfigs._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateGenerativeQuestionConfig(_BaseGenerativeQuestionServiceRestTransport._BaseUpdateGenerativeQuestionConfig, GenerativeQuestionServiceRestStub):
        def __hash__(self):
        ...
        question config method over HTTP.
            ...
            transcoded_request = _BaseGenerativeQuestionServiceRestTransport._BaseUpdateGenerativeQuestionConfig._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = GenerativeQuestionServiceRestTransport._UpdateGenerativeQuestionConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateGenerativeQuestionsFeatureConfig(_BaseGenerativeQuestionServiceRestTransport._BaseUpdateGenerativeQuestionsFeatureConfig, GenerativeQuestionServiceRestStub):
        def __hash__(self):
        ...
        questions feature config method over HTTP.
            ...
            transcoded_request = _BaseGenerativeQuestionServiceRestTransport._BaseUpdateGenerativeQuestionsFeatureConfig._get_transcoded_request(http_options, request)
            ...
            # Jsonify the query params
            query_params = _BaseGenerativeQuestionServiceRestTransport._BaseUpdateGenerativeQuestionsFeatureConfig._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = GenerativeQuestionServiceRestTransport._UpdateGenerativeQuestionsFeatureConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseGenerativeQuestionServiceRestTransport._BaseGetOperation, GenerativeQuestionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenerativeQuestionServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseGenerativeQuestionServiceRestTransport._BaseListOperations, GenerativeQuestionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenerativeQuestionServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class UserEventServiceClient(metaclass=UserEventServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            UserEventServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def export_user_events(self,
        ...
        Args:
            request (Union[google.cloud.retail_v2alpha.types.ExportUserEventsRequest, dict]):

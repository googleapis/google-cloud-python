...
class UserEventServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_export_user_events(self, request: export_config.ExportUserEventsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[export_config.ExportUserEventsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_import_user_events(self, request: import_config.ImportUserEventsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[import_config.ImportUserEventsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_purge_user_events(self, request: purge_config.PurgeUserEventsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[purge_config.PurgeUserEventsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_rejoin_user_events(self, request: user_event_service.RejoinUserEventsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[user_event_service.RejoinUserEventsRequest, Sequence[Tuple[str, str]]]:

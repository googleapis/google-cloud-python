...
class UserEventServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_export_user_events(self, request: export_config.ExportUserEventsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[export_config.ExportUserEventsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_export_user_events(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        """Post-rpc interceptor for export_user_events

        DEPRECATED. Please use the `post_export_user_events_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the UserEventService server but before
        it is returned to user code. This `post_export_user_events` interceptor runs
        before the `post_export_user_events_with_metadata` interceptor.
        """
        return response

    def post_export_user_events_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_user_events

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the UserEventService server but before it is returned to user code.

        We recommend only using this `post_export_user_events_with_metadata`
        interceptor in new development instead of the `post_export_user_events` interceptor.
        When both interceptors are used, this `post_export_user_events_with_metadata` interceptor runs after the
        `post_export_user_events` interceptor. The (possibly modified) response returned by
        `post_export_user_events` will be passed to
    ...
    def pre_rejoin_user_events(self, request: user_event_service.RejoinUserEventsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user_event_service.RejoinUserEventsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_rejoin_user_events(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the UserEventService server but before
        it is returned to user code. This `post_rejoin_user_events` interceptor runs
        before the `post_rejoin_user_events_with_metadata` interceptor.
        """
        return response

    def post_rejoin_user_events_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for rejoin_user_events

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the UserEventService server but before it is returned to user code.

        We recommend only using this `post_rejoin_user_events_with_metadata`
        interceptor in new development instead of the `post_rejoin_user_events` interceptor.
        When both interceptors are used, this `post_rejoin_user_events_with_metadata` interceptor runs after the
        `post_rejoin_user_events` interceptor. The (possibly modified) response returned by
        `post_rejoin_user_events` will be passed to
...
class UserEventServiceRestTransport(_BaseUserEventServiceRestTransport):
    ...
    class _CollectUserEvent(_BaseUserEventServiceRestTransport._BaseCollectUserEvent, UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.UserEventServiceClient.CollectUserEvent",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.UserEventServiceClient.collect_user_event",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
                        "rpcName": "CollectUserEvent",
    ...
    class _ExportUserEvents(_BaseUserEventServiceRestTransport._BaseExportUserEvents, UserEventServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseUserEventServiceRestTransport._BaseExportUserEvents._get_http_options()

            request, metadata = self._interceptor.pre_export_user_events(request, metadata)
            transcoded_request = _BaseUserEventServiceRestTransport._BaseExportUserEvents._get_transcoded_request(http_options, request)

            body = _BaseUserEventServiceRestTransport._BaseExportUserEvents._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseUserEventServiceRestTransport._BaseExportUserEvents._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.UserEventServiceClient.ExportUserEvents",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
                        "rpcName": "ExportUserEvents",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = UserEventServiceRestTransport._ExportUserEvents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_export_user_events_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.UserEventServiceClient.export_user_events",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
                        "rpcName": "ExportUserEvents",
                        "metadata": http_response["headers"],
    ...
    class _ImportUserEvents(_BaseUserEventServiceRestTransport._BaseImportUserEvents, UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.UserEventServiceClient.ImportUserEvents",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.UserEventServiceClient.import_user_events",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
                        "rpcName": "ImportUserEvents",
                        "metadata": http_response["headers"],
    ...
    class _PurgeUserEvents(_BaseUserEventServiceRestTransport._BasePurgeUserEvents, UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.UserEventServiceClient.PurgeUserEvents",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.UserEventServiceClient.purge_user_events",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
                        "rpcName": "PurgeUserEvents",
                        "metadata": http_response["headers"],
    ...
    class _RejoinUserEvents(_BaseUserEventServiceRestTransport._BaseRejoinUserEvents, UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.UserEventServiceClient.RejoinUserEvents",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
                        "rpcName": "RejoinUserEvents",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = UserEventServiceRestTransport._RejoinUserEvents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.UserEventServiceClient.rejoin_user_events",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
                        "rpcName": "RejoinUserEvents",
                        "metadata": http_response["headers"],
    ...
    class _WriteUserEvent(_BaseUserEventServiceRestTransport._BaseWriteUserEvent, UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.UserEventServiceClient.WriteUserEvent",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.UserEventServiceClient.write_user_event",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
                        "rpcName": "WriteUserEvent",
                        "metadata": http_response["headers"],
    ...
    class _GetOperation(_BaseUserEventServiceRestTransport._BaseGetOperation, UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.UserEventServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.UserEventServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseUserEventServiceRestTransport._BaseListOperations, UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.UserEventServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.UserEventServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.UserEventService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

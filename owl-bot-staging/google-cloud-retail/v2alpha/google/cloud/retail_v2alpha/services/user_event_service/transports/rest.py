...
class UserEventServiceRestTransport(UserEventServiceTransport):
    ...
    class _ExportUserEvents(UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2alpha/{parent=projects/*/locations/*/catalogs/*}/userEvents:export',
                'body': '*',
            },
            ]
    ...
    class _ImportUserEvents(UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2alpha/{parent=projects/*/locations/*/catalogs/*}/userEvents:import',
                'body': '*',
            },
            ]
    ...
    class _PurgeUserEvents(UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2alpha/{parent=projects/*/locations/*/catalogs/*}/userEvents:purge',
                'body': '*',
            },
            ]
    ...
    class _RejoinUserEvents(UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2alpha/{parent=projects/*/locations/*/catalogs/*}/userEvents:rejoin',
                'body': '*',
            },
            ]
    ...
    class _WriteUserEvent(UserEventServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2alpha/{parent=projects/*/locations/*/catalogs/*}/userEvents:write',
                'body': 'user_event',
            },
            ]

...
class ModelServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_model(self, request: model_service.CreateModelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_service.CreateModelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_pause_model(self, request: model_service.PauseModelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_service.PauseModelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_pause_model_with_metadata(self, response: model.Model, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model.Model, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for pause_model
    ...
    def pre_resume_model(self, request: model_service.ResumeModelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_service.ResumeModelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_resume_model_with_metadata(self, response: model.Model, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model.Model, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for resume_model
    ...
    def pre_tune_model(self, request: model_service.TuneModelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_service.TuneModelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_tune_model_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for tune_model
    ...
    def post_update_model_with_metadata(self, response: gcr_model.Model, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcr_model.Model, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_model
...
class ModelServiceRestTransport(_BaseModelServiceRestTransport):
    ...
    class _CreateModel(_BaseModelServiceRestTransport._BaseCreateModel, ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ModelServiceRestTransport._CreateModel._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _PauseModel(_BaseModelServiceRestTransport._BasePauseModel, ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ModelServiceRestTransport._PauseModel._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ResumeModel(_BaseModelServiceRestTransport._BaseResumeModel, ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ModelServiceRestTransport._ResumeModel._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TuneModel(_BaseModelServiceRestTransport._BaseTuneModel, ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ModelServiceRestTransport._TuneModel._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

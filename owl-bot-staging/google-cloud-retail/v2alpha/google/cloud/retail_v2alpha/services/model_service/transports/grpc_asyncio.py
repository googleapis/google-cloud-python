...
class ModelServiceGrpcAsyncIOTransport(ModelServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.pause_model: gapic_v1.method_async.wrap_method(
                self.pause_model,
                default_timeout=None,
                client_info=client_info,
            ),
            self.resume_model: gapic_v1.method_async.wrap_method(
                self.resume_model,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.tune_model: gapic_v1.method_async.wrap_method(
                self.tune_model,
                default_timeout=None,
                client_info=client_info,
            ),

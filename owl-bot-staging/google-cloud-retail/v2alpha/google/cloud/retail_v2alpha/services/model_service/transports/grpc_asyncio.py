...
class ModelServiceGrpcAsyncIOTransport(ModelServiceTransport):
    ...
    def pause_model(self) -> Callable[
        ...
        if 'pause_model' not in self._stubs:
            self._stubs['pause_model'] = self._logged_channel.unary_unary(
    ...
    def resume_model(self) -> Callable[
        ...
        if 'resume_model' not in self._stubs:
            self._stubs['resume_model'] = self._logged_channel.unary_unary(
    ...
    def tune_model(self) -> Callable[
        ...
        if 'tune_model' not in self._stubs:
            self._stubs['tune_model'] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.pause_model: self._wrap_method(
                self.pause_model,
                default_timeout=None,
                client_info=client_info,
            ),
            self.resume_model: self._wrap_method(
                self.resume_model,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.tune_model: self._wrap_method(
                self.tune_model,
                default_timeout=None,
                client_info=client_info,
            ),

...
class ConversationalSearchServiceAsyncClient:
    ...
    branch_path = staticmethod(ConversationalSearchServiceClient.branch_path)
    parse_branch_path = staticmethod(ConversationalSearchServiceClient.parse_branch_path)
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.retail_v2alpha.ConversationalSearchServiceAsyncClient`.",
                extra = {
    ...
    def conversational_search(self,
            request: Optional[Union[conversational_search_service.ConversationalSearchRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> Awaitable[AsyncIterable[conversational_search_service.ConversationalSearchResponse]]:
        ...
        .. code-block:: python
            ...
            async def sample_conversational_search():
                # Create a client
                client = retail_v2alpha.ConversationalSearchServiceAsyncClient()
                ...
                # Make the request
                stream = await client.conversational_search(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.ConversationalSearchRequest, dict]]):
        ...
        Returns:
            AsyncIterable[google.cloud.retail_v2alpha.types.ConversationalSearchResponse]:
        ...
        if not isinstance(request, conversational_search_service.ConversationalSearchRequest):
            request = conversational_search_service.ConversationalSearchRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.conversational_search]

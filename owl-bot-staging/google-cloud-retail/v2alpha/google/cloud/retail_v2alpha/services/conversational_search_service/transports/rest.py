    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomConversationalSearchServiceInterceptor(ConversationalSearchServiceRestInterceptor):
            def pre_conversational_search(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_conversational_search(self, response):
    ...
    """
    def pre_conversational_search(self, request: conversational_search_service.ConversationalSearchRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversational_search_service.ConversationalSearchRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_conversational_search(self, response: rest_streaming.ResponseIterator) -> rest_streaming.ResponseIterator:
        ...
        it is returned to user code. This `post_conversational_search` interceptor runs
        before the `post_conversational_search_with_metadata` interceptor.
        """
        return response

    def post_conversational_search_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for conversational_search

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the ConversationalSearchService server but before it is returned to user code.

        We recommend only using this `post_conversational_search_with_metadata`
        interceptor in new development instead of the `post_conversational_search` interceptor.
        When both interceptors are used, this `post_conversational_search_with_metadata` interceptor runs after the
        `post_conversational_search` interceptor. The (possibly modified) response returned by
        `post_conversational_search` will be passed to
        `post_conversational_search_with_metadata`.
        """
...
class ConversationalSearchServiceRestTransport(_BaseConversationalSearchServiceRestTransport):
    ...
    class _ConversationalSearch(_BaseConversationalSearchServiceRestTransport._BaseConversationalSearch, ConversationalSearchServiceRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the conversational search method over HTTP.
            ...
            transcoded_request = _BaseConversationalSearchServiceRestTransport._BaseConversationalSearch._get_transcoded_request(http_options, request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ConversationalSearchServiceClient.ConversationalSearch",
                    extra = {
            ...
            # Send the request
            response = ConversationalSearchServiceRestTransport._ConversationalSearch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseConversationalSearchServiceRestTransport._BaseGetOperation, ConversationalSearchServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ConversationalSearchServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ConversationalSearchService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.ConversationalSearchServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ConversationalSearchService",
                        "rpcName": "GetOperation",
    ...
    class _ListOperations(_BaseConversationalSearchServiceRestTransport._BaseListOperations, ConversationalSearchServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.ConversationalSearchServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ConversationalSearchService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.ConversationalSearchServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2alpha.ConversationalSearchService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

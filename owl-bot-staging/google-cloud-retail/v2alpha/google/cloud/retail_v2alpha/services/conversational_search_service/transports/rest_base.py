    ...
    class _BaseConversationalSearch:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2alpha/{placement=projects/*/locations/*/catalogs/*/placements/*}:conversationalSearch',
                'body': '*',
            },
        {
                'method': 'post',
                'uri': '/v2alpha/{placement=projects/*/locations/*/catalogs/*/servingConfigs/*}:conversationalSearch',
                'body': '*',
            },
            ]
            return http_options

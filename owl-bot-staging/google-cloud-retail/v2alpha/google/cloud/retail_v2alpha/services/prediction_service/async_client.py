...
from google.cloud.retail_v2alpha.types import prediction_service
...
class PredictionServiceAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.retail_v2alpha.PredictionServiceAsyncClient`.",
                extra = {
    ...
    async def predict(self,
        ...
        .. code-block:: python
            ...
            async def sample_predict():
                # Create a client
                client = retail_v2alpha.PredictionServiceAsyncClient()
                ...
                request = retail_v2alpha.PredictRequest(
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.PredictRequest, dict]]):
        ...
        Returns:
            google.cloud.retail_v2alpha.types.PredictResponse:

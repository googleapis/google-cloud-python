...
from .base import MerchantCenterAccountLinkServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class MerchantCenterAccountLinkServiceRestTransport(MerchantCenterAccountLinkServiceTransport):
    ...
    class _CreateMerchantCenterAccountLink(MerchantCenterAccountLinkServiceRestStub):
        ...
        account link method over HTTP.
            ...
            pb_request = merchant_center_account_link_service.CreateMerchantCenterAccountLinkRequest.pb(request)
    ...
    class _DeleteMerchantCenterAccountLink(MerchantCenterAccountLinkServiceRestStub):
        ...
        account link method over HTTP.
            ...
            pb_request = merchant_center_account_link_service.DeleteMerchantCenterAccountLinkRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListMerchantCenterAccountLinks(MerchantCenterAccountLinkServiceRestStub):
        ...
        account links method over HTTP.
            ...
            pb_request = merchant_center_account_link_service.ListMerchantCenterAccountLinksRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)

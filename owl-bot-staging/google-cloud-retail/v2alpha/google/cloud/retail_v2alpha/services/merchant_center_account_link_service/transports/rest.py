...
class MerchantCenterAccountLinkServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_merchant_center_account_link(self, request: merchant_center_account_link_service.CreateMerchantCenterAccountLinkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[merchant_center_account_link_service.CreateMerchantCenterAccountLinkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_merchant_center_account_link(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        it is returned to user code. This `post_create_merchant_center_account_link` interceptor runs
        before the `post_create_merchant_center_account_link_with_metadata` interceptor.
        """
        return response

    def post_create_merchant_center_account_link_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_merchant_center_account_link

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the MerchantCenterAccountLinkService server but before it is returned to user code.

        We recommend only using this `post_create_merchant_center_account_link_with_metadata`
        interceptor in new development instead of the `post_create_merchant_center_account_link` interceptor.
        When both interceptors are used, this `post_create_merchant_center_account_link_with_metadata` interceptor runs after the
        `post_create_merchant_center_account_link` interceptor. The (possibly modified) response returned by
        `post_create_merchant_center_account_link` will be passed to
        `post_create_merchant_center_account_link_with_metadata`.
        """
        return response, metadata

    def pre_delete_merchant_center_account_link(self, request: merchant_center_account_link_service.DeleteMerchantCenterAccountLinkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[merchant_center_account_link_service.DeleteMerchantCenterAccountLinkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_merchant_center_account_links(self, request: merchant_center_account_link_service.ListMerchantCenterAccountLinksRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[merchant_center_account_link_service.ListMerchantCenterAccountLinksRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_merchant_center_account_links(self, response: merchant_center_account_link_service.ListMerchantCenterAccountLinksResponse) -> merchant_center_account_link_service.ListMerchantCenterAccountLinksResponse:
        """Post-rpc interceptor for list_merchant_center_account_links

        DEPRECATED. Please use the `post_list_merchant_center_account_links_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the MerchantCenterAccountLinkService server but before
        it is returned to user code. This `post_list_merchant_center_account_links` interceptor runs
        before the `post_list_merchant_center_account_links_with_metadata` interceptor.
        """
        return response
    ...
    def post_list_merchant_center_account_links_with_metadata(self, response: merchant_center_account_link_service.ListMerchantCenterAccountLinksResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[merchant_center_account_link_service.ListMerchantCenterAccountLinksResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        ...
        We recommend only using this `post_list_merchant_center_account_links_with_metadata`
        interceptor in new development instead of the `post_list_merchant_center_account_links` interceptor.
        When both interceptors are used, this `post_list_merchant_center_account_links_with_metadata` interceptor runs after the
        `post_list_merchant_center_account_links` interceptor. The (possibly modified) response returned by
        `post_list_merchant_center_account_links` will be passed to
...
class MerchantCenterAccountLinkServiceRestTransport(_BaseMerchantCenterAccountLinkServiceRestTransport):
    ...
    class _CreateMerchantCenterAccountLink(_BaseMerchantCenterAccountLinkServiceRestTransport._BaseCreateMerchantCenterAccountLink, MerchantCenterAccountLinkServiceRestStub):
        def __hash__(self):
        ...
        account link method over HTTP.
            ...
            transcoded_request = _BaseMerchantCenterAccountLinkServiceRestTransport._BaseCreateMerchantCenterAccountLink._get_transcoded_request(http_options, request)
            ...
            query_params = _BaseMerchantCenterAccountLinkServiceRestTransport._BaseCreateMerchantCenterAccountLink._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = MerchantCenterAccountLinkServiceRestTransport._CreateMerchantCenterAccountLink._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteMerchantCenterAccountLink(_BaseMerchantCenterAccountLinkServiceRestTransport._BaseDeleteMerchantCenterAccountLink, MerchantCenterAccountLinkServiceRestStub):
        def __hash__(self):
        ...
        account link method over HTTP.
            ...
            transcoded_request = _BaseMerchantCenterAccountLinkServiceRestTransport._BaseDeleteMerchantCenterAccountLink._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseMerchantCenterAccountLinkServiceRestTransport._BaseDeleteMerchantCenterAccountLink._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = MerchantCenterAccountLinkServiceRestTransport._DeleteMerchantCenterAccountLink._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListMerchantCenterAccountLinks(_BaseMerchantCenterAccountLinkServiceRestTransport._BaseListMerchantCenterAccountLinks, MerchantCenterAccountLinkServiceRestStub):
        def __hash__(self):
        ...
        account links method over HTTP.
            ...
            transcoded_request = _BaseMerchantCenterAccountLinkServiceRestTransport._BaseListMerchantCenterAccountLinks._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseMerchantCenterAccountLinkServiceRestTransport._BaseListMerchantCenterAccountLinks._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = MerchantCenterAccountLinkServiceRestTransport._ListMerchantCenterAccountLinks._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    @property
    def create_merchant_center_account_link(self) -> Callable[
    ...
    @property
    def delete_merchant_center_account_link(self) -> Callable[
    ...
    @property
    def list_merchant_center_account_links(self) -> Callable[
    ...
    class _GetOperation(_BaseMerchantCenterAccountLinkServiceRestTransport._BaseGetOperation, MerchantCenterAccountLinkServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MerchantCenterAccountLinkServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseMerchantCenterAccountLinkServiceRestTransport._BaseListOperations, MerchantCenterAccountLinkServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MerchantCenterAccountLinkServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class MerchantCenterAccountLinkServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_merchant_center_account_link(self, request: merchant_center_account_link_service.CreateMerchantCenterAccountLinkRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[merchant_center_account_link_service.CreateMerchantCenterAccountLinkRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_merchant_center_account_link(self, request: merchant_center_account_link_service.DeleteMerchantCenterAccountLinkRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[merchant_center_account_link_service.DeleteMerchantCenterAccountLinkRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_merchant_center_account_links(self, request: merchant_center_account_link_service.ListMerchantCenterAccountLinksRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[merchant_center_account_link_service.ListMerchantCenterAccountLinksRequest, Sequence[Tuple[str, str]]]:

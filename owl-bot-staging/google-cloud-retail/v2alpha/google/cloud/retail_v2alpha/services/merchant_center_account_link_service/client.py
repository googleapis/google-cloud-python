...
class MerchantCenterAccountLinkServiceClient(metaclass=MerchantCenterAccountLinkServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            MerchantCenterAccountLinkServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = MerchantCenterAccountLinkServiceClient._read_environment_variables()
        self._client_cert_source = MerchantCenterAccountLinkServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)

...
from .base import MerchantCenterAccountLinkServiceTransport, DEFAULT_CLIENT_INFO
...
class MerchantCenterAccountLinkServiceGrpcTransport(MerchantCenterAccountLinkServiceTransport):
    ...
    def list_merchant_center_account_links(self) -> Callable[
        ...
        if 'list_merchant_center_account_links' not in self._stubs:
            self._stubs['list_merchant_center_account_links'] = self.grpc_channel.unary_unary(
    ...
    def create_merchant_center_account_link(self) -> Callable[
        ...
        if 'create_merchant_center_account_link' not in self._stubs:
            self._stubs['create_merchant_center_account_link'] = self.grpc_channel.unary_unary(
    ...
    def delete_merchant_center_account_link(self) -> Callable[
        ...
        if 'delete_merchant_center_account_link' not in self._stubs:
            self._stubs['delete_merchant_center_account_link'] = self.grpc_channel.unary_unary(
...
__all__ = (
    'MerchantCenterAccountLinkServiceGrpcTransport',
)

...
class ProductServiceAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.retail_v2alpha.ProductServiceAsyncClient`.",
                extra = {
    ...
    async def export_products(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.ExportProductsRequest, dict]]):

...
class Rule(proto.Message):
    ...
    - An action specifies what occurs on that trigger. Currently rules
      only work for [controls][google.cloud.retail.v2alpha.Control] with
    ...
    Attributes:
        ...
        twoway_synonyms_action (google.cloud.retail_v2alpha.types.Rule.TwowaySynonymsAction):
            ...
            This field is a member of `oneof`_ ``action``.
        force_return_facet_action (google.cloud.retail_v2alpha.types.Rule.ForceReturnFacetAction):
            Force returns an attribute as a facet in the
            request.

            This field is a member of `oneof`_ ``action``.
        remove_facet_action (google.cloud.retail_v2alpha.types.Rule.RemoveFacetAction):
            Remove an attribute as a facet in the request
            (if present).

            This field is a member of `oneof`_ ``action``.
        pin_action (google.cloud.retail_v2alpha.types.Rule.PinAction):
...
class CustomAttribute(proto.Message):
    ...
    Attributes:
        ...
        searchable (bool):
            ...
            of the [Catalog][google.cloud.retail.v2alpha.Catalog] is set
...
class Image(proto.Message):
    ...
    prediction and search results. Product images can be returned in
    results, and are shown in prediction or search previews in the
    console. Please try to provide correct product images and avoid
    using images with size too small.
...
class PriceInfo(proto.Message):
    ...
    Attributes:
        ...
        original_price (float):
            ...
            [price][google.cloud.retail.v2alpha.PriceInfo.price]. If
            set,
...
class LocalInventory(proto.Message):
    ...
    Attributes:
        ...
        price_info (google.cloud.retail_v2alpha.types.PriceInfo):
            ...
            Google Merchant Center property
            `price <https://support.google.com/merchants/answer/6324371>`__.
        availability (google.cloud.retail_v2alpha.types.LocalInventory.Availability):
            Optional. The availability of the
            [Product][google.cloud.retail.v2alpha.Product] at this
            place_id. Default to
            [Availability.IN_STOCK][google.cloud.retail.v2alpha.LocalInventory.Availability.IN_STOCK].

            For primary products with variants set the availability of
            the primary as
            [Availability.OUT_OF_STOCK][google.cloud.retail.v2alpha.LocalInventory.Availability.OUT_OF_STOCK]
            and set the true availability at the variant level. This way
            the primary product will be considered "in stock" as long as
            it has at least one variant in stock.

            For primary products with no variants set the true
            availability at the primary level.
            ...
            `here <https://cloud.google.com/retail/docs/local-inventory-updates#local-inventory-update-methods>`__
            for more details.
...
class PinControlMetadata(proto.Message):
    ...
    Attributes:
        all_matched_pins (MutableMapping[int, google.cloud.retail_v2alpha.types.PinControlMetadata.ProductPins]):
            Map of all matched pins, keyed by pin
            position.
        dropped_pins (MutableMapping[int, google.cloud.retail_v2alpha.types.PinControlMetadata.ProductPins]):

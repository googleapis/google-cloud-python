...
def test__get_api_endpoint():
    ...
    assert CompletionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CompletionServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_complete_query_rest_required_fields(request_type=completion_service.CompleteQueryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).complete_query._get_unset_required_fields(jsonified_request)
...
def test_import_completion_data_rest_required_fields(request_type=import_config.ImportCompletionDataRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).import_completion_data._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

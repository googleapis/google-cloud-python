...
def test_complete_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CompletionServiceRestInterceptor, "post_complete_query_with_metadata") as post_with_metadata, \
...
def test_import_completion_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CompletionServiceRestInterceptor, "post_import_completion_data_with_metadata") as post_with_metadata, \

...
def test_list_merchant_center_account_links_rest_required_fields(request_type=merchant_center_account_link_service.ListMerchantCenterAccountLinksRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_merchant_center_account_links._get_unset_required_fields(jsonified_request)
...
def test_list_merchant_center_account_links_rest_unset_required_fields():
    transport = transports.MerchantCenterAccountLinkServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_merchant_center_account_link_rest_required_fields(request_type=merchant_center_account_link_service.CreateMerchantCenterAccountLinkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_merchant_center_account_link._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_merchant_center_account_link_rest_required_fields(request_type=merchant_center_account_link_service.DeleteMerchantCenterAccountLinkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_merchant_center_account_link._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

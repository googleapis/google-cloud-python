...
@mock.patch.object(MerchantCenterAccountLinkServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MerchantCenterAccountLinkServiceClient))
@mock.patch.object(MerchantCenterAccountLinkServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MerchantCenterAccountLinkServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert MerchantCenterAccountLinkServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == MerchantCenterAccountLinkServiceClient.DEFAULT_MTLS_ENDPOINT
    assert MerchantCenterAccountLinkServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert MerchantCenterAccountLinkServiceClient._get_api_endpoint(None, None, default_universe, "always") == MerchantCenterAccountLinkServiceClient.DEFAULT_MTLS_ENDPOINT
    assert MerchantCenterAccountLinkServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == MerchantCenterAccountLinkServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = MerchantCenterAccountLinkServiceClient(credentials=cred)
...
@mock.patch.object(MerchantCenterAccountLinkServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MerchantCenterAccountLinkServiceClient))
@mock.patch.object(MerchantCenterAccountLinkServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MerchantCenterAccountLinkServiceAsyncClient))
def test_merchant_center_account_link_service_client_client_api_endpoint(client_class):
...
def test_list_merchant_center_account_links_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = MerchantCenterAccountLinkServiceClient(
...
def test_create_merchant_center_account_link_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = MerchantCenterAccountLinkServiceClient(
...
def test_delete_merchant_center_account_link_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = MerchantCenterAccountLinkServiceClient(
...
def test_list_merchant_center_account_links_empty_call_grpc():
    client = MerchantCenterAccountLinkServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_merchant_center_account_link_empty_call_grpc():
    client = MerchantCenterAccountLinkServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_merchant_center_account_link_empty_call_grpc():
    client = MerchantCenterAccountLinkServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_transport_kind_grpc_asyncio():
    transport = MerchantCenterAccountLinkServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_merchant_center_account_links_empty_call_grpc_asyncio():
    client = MerchantCenterAccountLinkServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_merchant_center_account_link_empty_call_grpc_asyncio():
    client = MerchantCenterAccountLinkServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_merchant_center_account_link_empty_call_grpc_asyncio():
    client = MerchantCenterAccountLinkServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_list_merchant_center_account_links_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MerchantCenterAccountLinkServiceRestInterceptor, "post_list_merchant_center_account_links_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = merchant_center_account_link_service.ListMerchantCenterAccountLinksResponse.to_json(merchant_center_account_link_service.ListMerchantCenterAccountLinksResponse())
...
def test_create_merchant_center_account_link_rest_bad_request(request_type=merchant_center_account_link_service.CreateMerchantCenterAccountLinkRequest):
    client = MerchantCenterAccountLinkServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_merchant_center_account_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MerchantCenterAccountLinkServiceRestInterceptor, "post_create_merchant_center_account_link_with_metadata") as post_with_metadata, \
...
def test_delete_merchant_center_account_link_rest_bad_request(request_type=merchant_center_account_link_service.DeleteMerchantCenterAccountLinkRequest):
    client = MerchantCenterAccountLinkServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_merchant_center_account_links_empty_call_rest():
    client = MerchantCenterAccountLinkServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_merchant_center_account_link_empty_call_rest():
    client = MerchantCenterAccountLinkServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_merchant_center_account_link_empty_call_rest():
    client = MerchantCenterAccountLinkServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

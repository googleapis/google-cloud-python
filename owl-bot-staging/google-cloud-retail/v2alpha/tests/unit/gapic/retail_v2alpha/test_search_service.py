...
from google.cloud.retail_v2alpha.services.search_service import SearchServiceAsyncClient
from google.cloud.retail_v2alpha.services.search_service import SearchServiceClient
from google.cloud.retail_v2alpha.services.search_service import pagers
from google.cloud.retail_v2alpha.services.search_service import transports
...
def test__get_api_endpoint():
    ...
    assert SearchServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SearchServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_search_service_client_client_options_from_dict():
    with mock.patch('google.cloud.retail_v2alpha.services.search_service.transports.SearchServiceGrpcTransport.__init__') as grpc_transport:
...
def test_transport_kind_grpc_asyncio():
    transport = SearchServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = SearchServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_search_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SearchServiceRestInterceptor, "post_search") as post, \
        mock.patch.object(transports.SearchServiceRestInterceptor, "post_search_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SearchServiceRestInterceptor, "pre_search") as pre:
...
def test_search_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2alpha.services.search_service.transports.SearchServiceTransport.__init__') as Transport:
...
def test_search_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2alpha.services.search_service.transports.SearchServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_search_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2alpha.services.search_service.transports.SearchServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SearchServiceTransport()
        adc.assert_called_once()

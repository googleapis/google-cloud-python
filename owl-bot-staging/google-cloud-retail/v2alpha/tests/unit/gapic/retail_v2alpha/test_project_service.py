...
from google.cloud.retail_v2alpha.services.project_service import ProjectServiceAsyncClient
from google.cloud.retail_v2alpha.services.project_service import ProjectServiceClient
from google.cloud.retail_v2alpha.services.project_service import transports
...
def test_accept_terms(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.accept_terms),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.accept_terms] = mock_object
...
def test_enroll_solution(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.enroll_solution),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.enroll_solution] = mock_object
...
def test_list_enrolled_solutions(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_enrolled_solutions),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_enrolled_solutions] = mock_object
...
def test_get_logging_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_logging_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_logging_config] = mock_object
...
def test_update_logging_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_logging_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = project.LoggingConfig(
            name='name_value',
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_logging_config] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_alert_config] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_alert_config] = mock_object
...
def test_accept_terms_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectServiceRestInterceptor, "post_accept_terms") as post, \
         mock.patch.object(transports.ProjectServiceRestInterceptor, "pre_accept_terms") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.accept_terms(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_accept_terms_rest_bad_request(transport: str = 'rest', request_type=project_service.AcceptTermsRequest):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_enroll_solution_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("project", "solution", )))
...
def test_enroll_solution_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ProjectServiceRestInterceptor, "post_enroll_solution") as post, \
         mock.patch.object(transports.ProjectServiceRestInterceptor, "pre_enroll_solution") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.enroll_solution(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_enroll_solution_rest_bad_request(transport: str = 'rest', request_type=project_service.EnrollSolutionRequest):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_enrolled_solutions_rest_required_fields(request_type=project_service.ListEnrolledSolutionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_enrolled_solutions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_enrolled_solutions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectServiceRestInterceptor, "post_list_enrolled_solutions") as post, \
         mock.patch.object(transports.ProjectServiceRestInterceptor, "pre_list_enrolled_solutions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = project_service.ListEnrolledSolutionsResponse.to_json(project_service.ListEnrolledSolutionsResponse())
        ...
        client.list_enrolled_solutions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_enrolled_solutions_rest_bad_request(transport: str = 'rest', request_type=project_service.ListEnrolledSolutionsRequest):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_logging_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectServiceRestInterceptor, "post_get_logging_config") as post, \
         mock.patch.object(transports.ProjectServiceRestInterceptor, "pre_get_logging_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = project.LoggingConfig.to_json(project.LoggingConfig())
        ...
        client.get_logging_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_logging_config_rest_bad_request(transport: str = 'rest', request_type=project_service.GetLoggingConfigRequest):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_logging_config_rest(request_type):
    ...
    request_init["logging_config"] = {'name': 'projects/sample1/loggingConfig', 'default_log_generation_rule': {'logging_level': 1, 'info_log_sample_rate': 0.21050000000000002}, 'service_log_generation_rules': [{'service_name': 'service_name_value', 'log_generation_rule': {}}]}
...
def test_update_logging_config_rest_required_fields(request_type=project_service.UpdateLoggingConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_logging_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_logging_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectServiceRestInterceptor, "post_update_logging_config") as post, \
         mock.patch.object(transports.ProjectServiceRestInterceptor, "pre_update_logging_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_logging_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_logging_config_rest_bad_request(transport: str = 'rest', request_type=project_service.UpdateLoggingConfigRequest):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_project_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2alpha.services.project_service.transports.ProjectServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_project_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2alpha.services.project_service.transports.ProjectServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ProjectServiceTransport()
        adc.assert_called_once()
...
def test_logging_config_path():
    project = "whelk"
    expected = "projects/{project}/loggingConfig".format(project=project, )
...
def test_retail_project_path():
    project = "oyster"
    expected = "projects/{project}/retailProject".format(project=project, )

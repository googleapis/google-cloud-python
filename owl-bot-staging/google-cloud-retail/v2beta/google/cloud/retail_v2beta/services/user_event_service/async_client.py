...
class UserEventServiceAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.retail_v2beta.UserEventServiceAsyncClient`.",
                extra = {
    ...
    async def write_user_event(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2beta.types.WriteUserEventRequest, dict]]):
    ...
    async def collect_user_event(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2beta.types.CollectUserEventRequest, dict]]):
    ...
    async def purge_user_events(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2beta.types.PurgeUserEventsRequest, dict]]):
    ...
    async def import_user_events(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2beta.types.ImportUserEventsRequest, dict]]):
    ...
    async def export_user_events(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2beta.types.ExportUserEventsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_user_events]
    ...
    async def rejoin_user_events(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2beta.types.RejoinUserEventsRequest, dict]]):

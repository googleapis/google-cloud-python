...
class GenerativeQuestionServiceClient(metaclass=GenerativeQuestionServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.retail_v2beta.GenerativeQuestionServiceClient`.",
                    extra = {
    ...
    def update_generative_questions_feature_config(self,
        ...
        Args:
            request (Union[google.cloud.retail_v2beta.types.UpdateGenerativeQuestionsFeatureConfigRequest, dict]):
    ...
    def get_generative_questions_feature_config(self,
        ...
        Args:
            request (Union[google.cloud.retail_v2beta.types.GetGenerativeQuestionsFeatureConfigRequest, dict]):
                The request object. Request for
    ...
    def list_generative_question_configs(self,
        ...
        Args:
            request (Union[google.cloud.retail_v2beta.types.ListGenerativeQuestionConfigsRequest, dict]):
    ...
    def update_generative_question_config(self,
        ...
        Args:
            request (Union[google.cloud.retail_v2beta.types.UpdateGenerativeQuestionConfigRequest, dict]):
                The request object. Request for
    ...
    def batch_update_generative_question_configs(self,
        ...
        Args:
            request (Union[google.cloud.retail_v2beta.types.BatchUpdateGenerativeQuestionConfigsRequest, dict]):
                The request object. Request for
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            requests (MutableSequence[google.cloud.retail_v2beta.types.UpdateGenerativeQuestionConfigRequest]):

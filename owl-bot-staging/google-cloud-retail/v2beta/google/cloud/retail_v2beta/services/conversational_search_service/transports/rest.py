    ...
    class _ConversationalSearch(_BaseConversationalSearchServiceRestTransport._BaseConversationalSearch, ConversationalSearchServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ConversationalSearchServiceClient.ConversationalSearch",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ConversationalSearchServiceClient.conversational_search",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.ConversationalSearchService",
                        "rpcName": "ConversationalSearch",
    ...
    class _GetOperation(_BaseConversationalSearchServiceRestTransport._BaseGetOperation, ConversationalSearchServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ConversationalSearchServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.ConversationalSearchService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ConversationalSearchServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.ConversationalSearchService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseConversationalSearchServiceRestTransport._BaseListOperations, ConversationalSearchServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ConversationalSearchServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.ConversationalSearchService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ConversationalSearchServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.ConversationalSearchService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

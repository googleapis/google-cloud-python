...
class ControlServiceRestTransport(ControlServiceTransport):
    ...
    class _CreateControl(ControlServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2beta/{parent=projects/*/locations/*/catalogs/*}/controls',
                'body': 'control',
            },
            ]
    ...
    class _DeleteControl(ControlServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v2beta/{name=projects/*/locations/*/catalogs/*/controls/*}',
            },
            ]
    ...
    class _UpdateControl(ControlServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v2beta/{control.name=projects/*/locations/*/catalogs/*/controls/*}',
                'body': 'control',
            },
            ]

...
class CompletionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_import_completion_data(self, request: import_config.ImportCompletionDataRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[import_config.ImportCompletionDataRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_import_completion_data(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        """Post-rpc interceptor for import_completion_data

        DEPRECATED. Please use the `post_import_completion_data_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the CompletionService server but before
        it is returned to user code. This `post_import_completion_data` interceptor runs
        before the `post_import_completion_data_with_metadata` interceptor.
        """
        return response

    def post_import_completion_data_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for import_completion_data

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the CompletionService server but before it is returned to user code.

        We recommend only using this `post_import_completion_data_with_metadata`
        interceptor in new development instead of the `post_import_completion_data` interceptor.
        When both interceptors are used, this `post_import_completion_data_with_metadata` interceptor runs after the
        `post_import_completion_data` interceptor. The (possibly modified) response returned by
        `post_import_completion_data` will be passed to
        `post_import_completion_data_with_metadata`.
        """
        return response, metadata
...
class CompletionServiceRestTransport(_BaseCompletionServiceRestTransport):
    ...
    class _CompleteQuery(_BaseCompletionServiceRestTransport._BaseCompleteQuery, CompletionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CompletionServiceClient.CompleteQuery",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CompletionServiceClient.complete_query",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CompletionService",
                        "rpcName": "CompleteQuery",
    ...
    class _ImportCompletionData(_BaseCompletionServiceRestTransport._BaseImportCompletionData, CompletionServiceRestStub):
        def __hash__(self):
            return hash("CompletionServiceRestTransport.ImportCompletionData")
        ...
        def __call__(self,
            ...
            http_options = _BaseCompletionServiceRestTransport._BaseImportCompletionData._get_http_options()

            request, metadata = self._interceptor.pre_import_completion_data(request, metadata)
            transcoded_request = _BaseCompletionServiceRestTransport._BaseImportCompletionData._get_transcoded_request(http_options, request)

            body = _BaseCompletionServiceRestTransport._BaseImportCompletionData._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseCompletionServiceRestTransport._BaseImportCompletionData._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CompletionServiceClient.ImportCompletionData",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CompletionService",
                        "rpcName": "ImportCompletionData",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = CompletionServiceRestTransport._ImportCompletionData._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_import_completion_data_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CompletionServiceClient.import_completion_data",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CompletionService",
                        "rpcName": "ImportCompletionData",
                        "metadata": http_response["headers"],
    ...
    class _GetOperation(_BaseCompletionServiceRestTransport._BaseGetOperation, CompletionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CompletionServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CompletionServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CompletionService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseCompletionServiceRestTransport._BaseListOperations, CompletionServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CompletionServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CompletionServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CompletionService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

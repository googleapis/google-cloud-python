...
class CompletionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_import_completion_data(self, request: import_config.ImportCompletionDataRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[import_config.ImportCompletionDataRequest, Sequence[Tuple[str, str]]]:

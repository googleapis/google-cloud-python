...
class CatalogServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_batch_remove_catalog_attributes(self, request: catalog_service.BatchRemoveCatalogAttributesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[catalog_service.BatchRemoveCatalogAttributesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_batch_remove_catalog_attributes(self, response: catalog_service.BatchRemoveCatalogAttributesResponse) -> catalog_service.BatchRemoveCatalogAttributesResponse:
        ...
        DEPRECATED. Please use the `post_batch_remove_catalog_attributes_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the CatalogService server but before
        it is returned to user code. This `post_batch_remove_catalog_attributes` interceptor runs
        before the `post_batch_remove_catalog_attributes_with_metadata` interceptor.
        """
        return response

    def post_batch_remove_catalog_attributes_with_metadata(self, response: catalog_service.BatchRemoveCatalogAttributesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[catalog_service.BatchRemoveCatalogAttributesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for batch_remove_catalog_attributes

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the CatalogService server but before it is returned to user code.

        We recommend only using this `post_batch_remove_catalog_attributes_with_metadata`
        interceptor in new development instead of the `post_batch_remove_catalog_attributes` interceptor.
        When both interceptors are used, this `post_batch_remove_catalog_attributes_with_metadata` interceptor runs after the
        `post_batch_remove_catalog_attributes` interceptor. The (possibly modified) response returned by
        `post_batch_remove_catalog_attributes` will be passed to
...
class CatalogServiceRestTransport(_BaseCatalogServiceRestTransport):
    ...
    class _AddCatalogAttribute(_BaseCatalogServiceRestTransport._BaseAddCatalogAttribute, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.AddCatalogAttribute",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceClient.add_catalog_attribute",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "AddCatalogAttribute",
    ...
    class _BatchRemoveCatalogAttributes(_BaseCatalogServiceRestTransport._BaseBatchRemoveCatalogAttributes, CatalogServiceRestStub):
        def __hash__(self):
            return hash("CatalogServiceRestTransport.BatchRemoveCatalogAttributes")
        ...
        attributes method over HTTP.
            ...
            transcoded_request = _BaseCatalogServiceRestTransport._BaseBatchRemoveCatalogAttributes._get_transcoded_request(http_options, request)

            body = _BaseCatalogServiceRestTransport._BaseBatchRemoveCatalogAttributes._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseCatalogServiceRestTransport._BaseBatchRemoveCatalogAttributes._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.BatchRemoveCatalogAttributes",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "BatchRemoveCatalogAttributes",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = CatalogServiceRestTransport._BatchRemoveCatalogAttributes._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_batch_remove_catalog_attributes_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = catalog_service.BatchRemoveCatalogAttributesResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceClient.batch_remove_catalog_attributes",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "BatchRemoveCatalogAttributes",
                        "metadata": http_response["headers"],
    ...
    class _GetAttributesConfig(_BaseCatalogServiceRestTransport._BaseGetAttributesConfig, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.GetAttributesConfig",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceClient.get_attributes_config",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "GetAttributesConfig",
                        "metadata": http_response["headers"],
    ...
    class _GetCompletionConfig(_BaseCatalogServiceRestTransport._BaseGetCompletionConfig, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.GetCompletionConfig",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceClient.get_completion_config",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "GetCompletionConfig",
                        "metadata": http_response["headers"],
    ...
    class _GetDefaultBranch(_BaseCatalogServiceRestTransport._BaseGetDefaultBranch, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.GetDefaultBranch",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceClient.get_default_branch",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "GetDefaultBranch",
                        "metadata": http_response["headers"],
    ...
    class _ListCatalogs(_BaseCatalogServiceRestTransport._BaseListCatalogs, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.ListCatalogs",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceClient.list_catalogs",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "ListCatalogs",
                        "metadata": http_response["headers"],
    ...
    class _RemoveCatalogAttribute(_BaseCatalogServiceRestTransport._BaseRemoveCatalogAttribute, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.RemoveCatalogAttribute",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceClient.remove_catalog_attribute",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "RemoveCatalogAttribute",
                        "metadata": http_response["headers"],
    ...
    class _ReplaceCatalogAttribute(_BaseCatalogServiceRestTransport._BaseReplaceCatalogAttribute, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.ReplaceCatalogAttribute",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceClient.replace_catalog_attribute",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "ReplaceCatalogAttribute",
                        "metadata": http_response["headers"],
    ...
    class _SetDefaultBranch(_BaseCatalogServiceRestTransport._BaseSetDefaultBranch, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.SetDefaultBranch",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
    ...
    class _UpdateAttributesConfig(_BaseCatalogServiceRestTransport._BaseUpdateAttributesConfig, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.UpdateAttributesConfig",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceClient.update_attributes_config",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "UpdateAttributesConfig",
                        "metadata": http_response["headers"],
    ...
    class _UpdateCatalog(_BaseCatalogServiceRestTransport._BaseUpdateCatalog, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.UpdateCatalog",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceClient.update_catalog",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "UpdateCatalog",
                        "metadata": http_response["headers"],
    ...
    class _UpdateCompletionConfig(_BaseCatalogServiceRestTransport._BaseUpdateCompletionConfig, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.UpdateCompletionConfig",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceClient.update_completion_config",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "UpdateCompletionConfig",
                        "metadata": http_response["headers"],
    ...
    class _GetOperation(_BaseCatalogServiceRestTransport._BaseGetOperation, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseCatalogServiceRestTransport._BaseListOperations, CatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.CatalogServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.CatalogServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.retail.v2beta.CatalogService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

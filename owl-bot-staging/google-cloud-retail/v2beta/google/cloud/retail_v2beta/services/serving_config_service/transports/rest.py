...
class ServingConfigServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_add_control(self, request: serving_config_service.AddControlRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[serving_config_service.AddControlRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_serving_config(self, request: serving_config_service.CreateServingConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[serving_config_service.CreateServingConfigRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_serving_config(self, request: serving_config_service.DeleteServingConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[serving_config_service.DeleteServingConfigRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_serving_config(self, request: serving_config_service.GetServingConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[serving_config_service.GetServingConfigRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_serving_configs(self, request: serving_config_service.ListServingConfigsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[serving_config_service.ListServingConfigsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_remove_control(self, request: serving_config_service.RemoveControlRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[serving_config_service.RemoveControlRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_serving_config(self, request: serving_config_service.UpdateServingConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[serving_config_service.UpdateServingConfigRequest, Sequence[Tuple[str, str]]]:

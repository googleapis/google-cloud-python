...
def test_purge_user_events_rest_required_fields(request_type=purge_config.PurgeUserEventsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).purge_user_events._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_rejoin_user_events_rest_required_fields(request_type=user_event_service.RejoinUserEventsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).rejoin_user_events._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

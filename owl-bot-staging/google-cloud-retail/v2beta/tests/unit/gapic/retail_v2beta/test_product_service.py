...
from google.cloud.retail_v2beta.services.product_service import ProductServiceAsyncClient
from google.cloud.retail_v2beta.services.product_service import ProductServiceClient
from google.cloud.retail_v2beta.services.product_service import pagers
from google.cloud.retail_v2beta.services.product_service import transports
from google.cloud.retail_v2beta.types import common
from google.cloud.retail_v2beta.types import export_config
...
from google.cloud.retail_v2beta.types import promotion
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ProductServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ProductServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ProductServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ProductServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert ProductServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ProductServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ProductServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ProductServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ProductServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ProductServiceClient))
@mock.patch.object(ProductServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ProductServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ProductServiceClient._DEFAULT_UNIVERSE
    default_endpoint = ProductServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ProductServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ProductServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ProductServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ProductServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ProductServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ProductServiceClient._get_api_endpoint(None, None, default_universe, "always") == ProductServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ProductServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ProductServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ProductServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ProductServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ProductServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ProductServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ProductServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ProductServiceClient._get_universe_domain(None, None) == ProductServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ProductServiceAsyncClient, transports.ProductServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class", [
    ProductServiceClient, ProductServiceAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ProductServiceClient, transports.ProductServiceGrpcTransport, "grpc", grpc_helpers),
    (ProductServiceAsyncClient, transports.ProductServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_product_service_client_client_options_from_dict():
    with mock.patch('google.cloud.retail_v2beta.services.product_service.transports.ProductServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_product_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_product(
            parent='parent_value',
            product=gcr_product.Product(expire_time=timestamp_pb2.Timestamp(seconds=751)),
            product_id='product_id_value',
        )
...
@pytest.mark.asyncio
async def test_purge_products_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProductServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.purge_products in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.purge_products] = mock_rpc
...
@pytest.mark.asyncio
async def test_purge_products_async(transport: str = 'grpc_asyncio', request_type=purge_config.PurgeProductsRequest):
    client = ProductServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_import_products_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProductServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_products in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_products] = mock_rpc
...
def test_export_products(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_products),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_export_products_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProductServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_products in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_products] = mock_rpc
...
@pytest.mark.asyncio
async def test_export_products_async(transport: str = 'grpc_asyncio', request_type=export_config.ExportProductsRequest):
    client = ProductServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_set_inventory(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.set_inventory),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_set_inventory_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProductServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.set_inventory in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.set_inventory] = mock_rpc
...
def test_add_fulfillment_places(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.add_fulfillment_places),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_add_fulfillment_places_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.add_fulfillment_places in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.add_fulfillment_places] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_add_fulfillment_places_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProductServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.add_fulfillment_places in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.add_fulfillment_places] = mock_rpc
...
def test_remove_fulfillment_places(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_fulfillment_places),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_remove_fulfillment_places_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.remove_fulfillment_places in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.remove_fulfillment_places] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_remove_fulfillment_places_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProductServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.remove_fulfillment_places in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.remove_fulfillment_places] = mock_rpc
...
def test_add_local_inventories(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.add_local_inventories),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_add_local_inventories_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.add_local_inventories in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.add_local_inventories] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_add_local_inventories_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProductServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.add_local_inventories in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.add_local_inventories] = mock_rpc
...
def test_remove_local_inventories(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_local_inventories),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_remove_local_inventories_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.remove_local_inventories in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.remove_local_inventories] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_remove_local_inventories_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProductServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.remove_local_inventories in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.remove_local_inventories] = mock_rpc
...
def test_create_product_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2beta/{parent=projects/*/locations/*/catalogs/*/branches/*}/products" % client.transport._host, args[1])
...
def test_get_product_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{name=projects/*/locations/*/catalogs/*/branches/*/products/**}" % client.transport._host, args[1])
...
def test_update_product_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{product.name=projects/*/locations/*/catalogs/*/branches/*/products/**}" % client.transport._host, args[1])
...
def test_purge_products_rest_required_fields(request_type=purge_config.PurgeProductsRequest):
    transport_class = transports.ProductServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).purge_products._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_products_rest_required_fields(request_type=export_config.ExportProductsRequest):
    transport_class = transports.ProductServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_products._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_inventory_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{inventory.name=projects/*/locations/*/catalogs/*/branches/*/products/**}:setInventory" % client.transport._host, args[1])
...
def test_add_fulfillment_places_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:addFulfillmentPlaces" % client.transport._host, args[1])
...
def test_remove_fulfillment_places_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:removeFulfillmentPlaces" % client.transport._host, args[1])
...
def test_add_local_inventories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:addLocalInventories" % client.transport._host, args[1])
...
def test_remove_local_inventories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:removeLocalInventories" % client.transport._host, args[1])
...
def test_create_product_rest_bad_request(request_type=product_service.CreateProductRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_product_rest_interceptors(null_interceptor):
    transport = transports.ProductServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ProductServiceRestInterceptor(),
        )
    client = ProductServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_create_product") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_create_product_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_create_product") as pre:
...
def test_get_product_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_get_product") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_get_product_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_get_product") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_products_rest_bad_request(request_type=product_service.ListProductsRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_products_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_list_products") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_list_products_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_list_products") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = product_service.ListProductsResponse.to_json(product_service.ListProductsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = product_service.ListProductsResponse(), metadata
...
def test_update_product_rest_bad_request(request_type=product_service.UpdateProductRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_product_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_update_product") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_update_product_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_update_product") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_product_rest_bad_request(request_type=product_service.DeleteProductRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_product_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_delete_product") as pre:
        pre.assert_not_called()
...
def test_purge_products_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_purge_products") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_purge_products_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_purge_products") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = purge_config.PurgeProductsRequest.pb(purge_config.PurgeProductsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.purge_products(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_import_products_rest_bad_request(request_type=import_config.ImportProductsRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_import_products_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_import_products") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_import_products_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_import_products") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_export_products_rest_bad_request(request_type=export_config.ExportProductsRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_products_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_export_products") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_export_products_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_export_products") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = export_config.ExportProductsRequest.pb(export_config.ExportProductsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.export_products(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_inventory_rest_bad_request(request_type=product_service.SetInventoryRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_inventory_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_set_inventory") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_set_inventory_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_set_inventory") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_add_fulfillment_places_rest_bad_request(request_type=product_service.AddFulfillmentPlacesRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_add_fulfillment_places_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_add_fulfillment_places") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_add_fulfillment_places_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_add_fulfillment_places") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_remove_fulfillment_places_rest_bad_request(request_type=product_service.RemoveFulfillmentPlacesRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_remove_fulfillment_places_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_remove_fulfillment_places") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_remove_fulfillment_places_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_remove_fulfillment_places") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_add_local_inventories_rest_bad_request(request_type=product_service.AddLocalInventoriesRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_add_local_inventories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_add_local_inventories") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_add_local_inventories_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_add_local_inventories") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_remove_local_inventories_rest_bad_request(request_type=product_service.RemoveLocalInventoriesRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_remove_local_inventories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_remove_local_inventories") as post, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "post_remove_local_inventories_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProductServiceRestInterceptor, "pre_remove_local_inventories") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_product_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2beta.services.product_service.transports.ProductServiceTransport.__init__') as Transport:
...
def test_product_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2beta.services.product_service.transports.ProductServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_product_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2beta.services.product_service.transports.ProductServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ProductServiceTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ProductServiceGrpcTransport, transports.ProductServiceGrpcAsyncIOTransport])
def test_product_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

...
def test_export_products_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_export_products_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ProductServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.export_products()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == export_config.ExportProductsRequest()
...
def test_purge_products_rest_bad_request(transport: str = 'rest', request_type=purge_config.PurgeProductsRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_products_rest(request_type):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_export_products_rest_bad_request(transport: str = 'rest', request_type=export_config.ExportProductsRequest):
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_products_rest_error():
    client = ProductServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )

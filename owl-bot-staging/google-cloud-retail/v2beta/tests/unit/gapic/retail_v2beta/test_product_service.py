...
def test_create_product_rest_required_fields(request_type=product_service.CreateProductRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_product._get_unset_required_fields(jsonified_request)
...
def test_get_product_rest_required_fields(request_type=product_service.GetProductRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_product._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_products_rest_required_fields(request_type=product_service.ListProductsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_products._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_product_rest_required_fields(request_type=product_service.UpdateProductRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_product._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_product_rest_required_fields(request_type=product_service.DeleteProductRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_product._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_products_rest_required_fields(request_type=import_config.ImportProductsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).import_products._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_inventory_rest_required_fields(request_type=product_service.SetInventoryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_inventory._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_add_fulfillment_places_rest_required_fields(request_type=product_service.AddFulfillmentPlacesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).add_fulfillment_places._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_fulfillment_places_rest_required_fields(request_type=product_service.RemoveFulfillmentPlacesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).remove_fulfillment_places._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_add_local_inventories_rest_required_fields(request_type=product_service.AddLocalInventoriesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).add_local_inventories._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_local_inventories_rest_required_fields(request_type=product_service.RemoveLocalInventoriesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).remove_local_inventories._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

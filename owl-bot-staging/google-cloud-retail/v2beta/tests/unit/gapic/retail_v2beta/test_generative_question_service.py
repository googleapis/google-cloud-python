...
from google.cloud.retail_v2beta.services.generative_question_service import GenerativeQuestionServiceAsyncClient
from google.cloud.retail_v2beta.services.generative_question_service import GenerativeQuestionServiceClient
from google.cloud.retail_v2beta.services.generative_question_service import transports
from google.cloud.retail_v2beta.types import generative_question
from google.cloud.retail_v2beta.types import generative_question_service
...
@mock.patch.object(GenerativeQuestionServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GenerativeQuestionServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert GenerativeQuestionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == GenerativeQuestionServiceClient.DEFAULT_MTLS_ENDPOINT
    assert GenerativeQuestionServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert GenerativeQuestionServiceClient._get_api_endpoint(None, None, default_universe, "always") == GenerativeQuestionServiceClient.DEFAULT_MTLS_ENDPOINT
    assert GenerativeQuestionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == GenerativeQuestionServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_generative_question_service_client_client_options_from_dict():
    with mock.patch('google.cloud.retail_v2beta.services.generative_question_service.transports.GenerativeQuestionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_update_generative_questions_feature_config(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.update_generative_questions_feature_config),
            '__call__') as call:
...
def test_update_generative_questions_feature_config_empty_call():
...
@pytest.mark.asyncio
async def test_update_generative_questions_feature_config_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
@pytest.mark.asyncio
async def test_update_generative_questions_feature_config_async(transport: str = 'grpc_asyncio', request_type=generative_question_service.UpdateGenerativeQuestionsFeatureConfigRequest):
    client = GenerativeQuestionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_generative_questions_feature_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_generative_questions_feature_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = generative_question.GenerativeQuestionsFeatureConfig(
            catalog='catalog_value',
...
def test_get_generative_questions_feature_config_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_get_generative_questions_feature_config_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = GenerativeQuestionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_get_generative_questions_feature_config_async(transport: str = 'grpc_asyncio', request_type=generative_question_service.GetGenerativeQuestionsFeatureConfigRequest):
    client = GenerativeQuestionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_generative_question_configs(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_generative_question_configs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_generative_question_configs_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = GenerativeQuestionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_list_generative_question_configs_async(transport: str = 'grpc_asyncio', request_type=generative_question_service.ListGenerativeQuestionConfigsRequest):
    client = GenerativeQuestionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_generative_question_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_generative_question_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_generative_question_config_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_update_generative_question_config_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = GenerativeQuestionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_update_generative_question_config_async(transport: str = 'grpc_asyncio', request_type=generative_question_service.UpdateGenerativeQuestionConfigRequest):
    client = GenerativeQuestionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_update_generative_question_configs(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_update_generative_question_configs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_batch_update_generative_question_configs_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_batch_update_generative_question_configs_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = GenerativeQuestionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_batch_update_generative_question_configs_async(transport: str = 'grpc_asyncio', request_type=generative_question_service.BatchUpdateGenerativeQuestionConfigsRequest):
    client = GenerativeQuestionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_update_generative_question_configs_flattened():
    ...
    with mock.patch.object(
        ...
        client.batch_update_generative_question_configs(
            parent='parent_value',
            requests=[generative_question_service.UpdateGenerativeQuestionConfigRequest(generative_question_config=generative_question.GenerativeQuestionConfig(catalog='catalog_value'))],
        )
        ...
        assert arg == mock_val
        arg = args[0].requests
        mock_val = [generative_question_service.UpdateGenerativeQuestionConfigRequest(generative_question_config=generative_question.GenerativeQuestionConfig(catalog='catalog_value'))]
        assert arg == mock_val
...
def test_update_generative_questions_feature_config_rest(request_type):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    request_init["generative_questions_feature_config"] = {'catalog': 'projects/sample1/locations/sample2/catalogs/sample3', 'feature_enabled': True, 'minimum_products': 1743}
...
def test_update_generative_questions_feature_config_rest_required_fields(request_type=generative_question_service.UpdateGenerativeQuestionsFeatureConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_generative_questions_feature_config._get_unset_required_fields(jsonified_request)
...
def test_update_generative_questions_feature_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "post_update_generative_questions_feature_config") as post, \
         mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "pre_update_generative_questions_feature_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = generative_question_service.UpdateGenerativeQuestionsFeatureConfigRequest.pb(generative_question_service.UpdateGenerativeQuestionsFeatureConfigRequest())
        ...
        req.return_value._content = generative_question.GenerativeQuestionsFeatureConfig.to_json(generative_question.GenerativeQuestionsFeatureConfig())
        ...
        client.update_generative_questions_feature_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_generative_questions_feature_config_rest_bad_request(transport: str = 'rest', request_type=generative_question_service.UpdateGenerativeQuestionsFeatureConfigRequest):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_generative_questions_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2beta/{generative_questions_feature_config.catalog=projects/*/locations/*/catalogs/*}/generativeQuestionFeature" % client.transport._host, args[1])
...
def test_get_generative_questions_feature_config_rest(request_type):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_generative_questions_feature_config_rest_required_fields(request_type=generative_question_service.GetGenerativeQuestionsFeatureConfigRequest):
    transport_class = transports.GenerativeQuestionServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_generative_questions_feature_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_generative_questions_feature_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "post_get_generative_questions_feature_config") as post, \
         mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "pre_get_generative_questions_feature_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = generative_question_service.GetGenerativeQuestionsFeatureConfigRequest.pb(generative_question_service.GetGenerativeQuestionsFeatureConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_generative_questions_feature_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_generative_questions_feature_config_rest_bad_request(transport: str = 'rest', request_type=generative_question_service.GetGenerativeQuestionsFeatureConfigRequest):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_generative_questions_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{catalog=projects/*/locations/*/catalogs/*}/generativeQuestionFeature" % client.transport._host, args[1])
...
def test_list_generative_question_configs_rest(request_type):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_generative_question_configs_rest_required_fields(request_type=generative_question_service.ListGenerativeQuestionConfigsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_generative_question_configs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_generative_question_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "post_list_generative_question_configs") as post, \
         mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "pre_list_generative_question_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = generative_question_service.ListGenerativeQuestionConfigsRequest.pb(generative_question_service.ListGenerativeQuestionConfigsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = generative_question_service.ListGenerativeQuestionConfigsResponse.to_json(generative_question_service.ListGenerativeQuestionConfigsResponse())
        ...
        client.list_generative_question_configs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_generative_question_configs_rest_bad_request(transport: str = 'rest', request_type=generative_question_service.ListGenerativeQuestionConfigsRequest):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_generative_question_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{parent=projects/*/locations/*/catalogs/*}/generativeQuestions" % client.transport._host, args[1])
...
def test_list_generative_question_configs_rest_error():
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_update_generative_question_config_rest(request_type):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    request_init["generative_question_config"] = {'catalog': 'projects/sample1/locations/sample2/catalogs/sample3', 'facet': 'facet_value', 'generated_question': 'generated_question_value', 'final_question': 'final_question_value', 'example_values': ['example_values_value1', 'example_values_value2'], 'frequency': 0.978, 'allowed_in_conversation': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_generative_question_config_rest_required_fields(request_type=generative_question_service.UpdateGenerativeQuestionConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_generative_question_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_generative_question_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "post_update_generative_question_config") as post, \
         mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "pre_update_generative_question_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = generative_question_service.UpdateGenerativeQuestionConfigRequest.pb(generative_question_service.UpdateGenerativeQuestionConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = generative_question.GenerativeQuestionConfig.to_json(generative_question.GenerativeQuestionConfig())
        ...
        client.update_generative_question_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_generative_question_config_rest_bad_request(transport: str = 'rest', request_type=generative_question_service.UpdateGenerativeQuestionConfigRequest):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_generative_question_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{generative_question_config.catalog=projects/*/locations/*/catalogs/*}/generativeQuestion" % client.transport._host, args[1])
...
def test_batch_update_generative_question_configs_rest(request_type):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_batch_update_generative_question_configs_rest_required_fields(request_type=generative_question_service.BatchUpdateGenerativeQuestionConfigsRequest):
    transport_class = transports.GenerativeQuestionServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_update_generative_question_configs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_generative_question_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "post_batch_update_generative_question_configs") as post, \
         mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "pre_batch_update_generative_question_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = generative_question_service.BatchUpdateGenerativeQuestionConfigsRequest.pb(generative_question_service.BatchUpdateGenerativeQuestionConfigsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = generative_question_service.BatchUpdateGenerativeQuestionConfigsResponse.to_json(generative_question_service.BatchUpdateGenerativeQuestionConfigsResponse())
        ...
        client.batch_update_generative_question_configs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_batch_update_generative_question_configs_rest_bad_request(transport: str = 'rest', request_type=generative_question_service.BatchUpdateGenerativeQuestionConfigsRequest):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_update_generative_question_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{parent=projects/*/locations/*/catalogs/*}/generativeQuestion:batchUpdate" % client.transport._host, args[1])
...
def test_batch_update_generative_question_configs_rest_error():
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_transport_kind(transport_name):
    transport = GenerativeQuestionServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_generative_question_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2beta.services.generative_question_service.transports.GenerativeQuestionServiceTransport.__init__') as Transport:
...
def test_generative_question_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2beta.services.generative_question_service.transports.GenerativeQuestionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_generative_question_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2beta.services.generative_question_service.transports.GenerativeQuestionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GenerativeQuestionServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.GenerativeQuestionServiceGrpcTransport, transports.GenerativeQuestionServiceGrpcAsyncIOTransport])
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.GenerativeQuestionServiceGrpcTransport, transports.GenerativeQuestionServiceGrpcAsyncIOTransport])
def test_generative_question_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

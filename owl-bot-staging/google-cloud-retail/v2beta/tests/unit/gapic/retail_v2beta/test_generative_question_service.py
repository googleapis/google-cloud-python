...
def test_transport_kind_grpc_asyncio():
    transport = GenerativeQuestionServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_update_generative_questions_feature_config_rest_bad_request(request_type=generative_question_service.UpdateGenerativeQuestionsFeatureConfigRequest):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_generative_questions_feature_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "post_update_generative_questions_feature_config_with_metadata") as post_with_metadata, \
...
def test_get_generative_questions_feature_config_rest_bad_request(request_type=generative_question_service.GetGenerativeQuestionsFeatureConfigRequest):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_generative_questions_feature_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "post_get_generative_questions_feature_config_with_metadata") as post_with_metadata, \
...
def test_list_generative_question_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "post_list_generative_question_configs_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = generative_question_service.ListGenerativeQuestionConfigsResponse.to_json(generative_question_service.ListGenerativeQuestionConfigsResponse())
        req.return_value.content = return_value
...
def test_update_generative_question_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "post_update_generative_question_config_with_metadata") as post_with_metadata, \
...
def test_batch_update_generative_question_configs_rest_bad_request(request_type=generative_question_service.BatchUpdateGenerativeQuestionConfigsRequest):
    client = GenerativeQuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_update_generative_question_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GenerativeQuestionServiceRestInterceptor, "post_batch_update_generative_question_configs_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = generative_question_service.BatchUpdateGenerativeQuestionConfigsResponse.to_json(generative_question_service.BatchUpdateGenerativeQuestionConfigsResponse())
        req.return_value.content = return_value

...
def test_list_catalogs_rest_required_fields(request_type=catalog_service.ListCatalogsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_catalogs._get_unset_required_fields(jsonified_request)
...
def test_update_catalog_rest_required_fields(request_type=catalog_service.UpdateCatalogRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_catalog._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_completion_config_rest_required_fields(request_type=catalog_service.GetCompletionConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_completion_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_completion_config_rest_required_fields(request_type=catalog_service.UpdateCompletionConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_completion_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_attributes_config_rest_required_fields(request_type=catalog_service.GetAttributesConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_attributes_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_attributes_config_rest_required_fields(request_type=catalog_service.UpdateAttributesConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_attributes_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_add_catalog_attribute_rest_required_fields(request_type=catalog_service.AddCatalogAttributeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).add_catalog_attribute._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_catalog_attribute_rest_required_fields(request_type=catalog_service.RemoveCatalogAttributeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).remove_catalog_attribute._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_remove_catalog_attributes_rest_required_fields(request_type=catalog_service.BatchRemoveCatalogAttributesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_remove_catalog_attributes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_replace_catalog_attribute_rest_required_fields(request_type=catalog_service.ReplaceCatalogAttributeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).replace_catalog_attribute._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test_get_alert_config_rest_bad_request(transport: str = 'rest', request_type=project_service.GetAlertConfigRequest):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_alert_config_rest_bad_request(transport: str = 'rest', request_type=project_service.UpdateAlertConfigRequest):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

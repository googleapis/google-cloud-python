...
from google.cloud.retail_v2beta.services.project_service import ProjectServiceAsyncClient
from google.cloud.retail_v2beta.services.project_service import ProjectServiceClient
from google.cloud.retail_v2beta.services.project_service import transports
...
def test_project_service_client_client_options_from_dict():
    with mock.patch('google.cloud.retail_v2beta.services.project_service.transports.ProjectServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_alert_config(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.get_alert_config),
            '__call__') as call:
...
def test_get_alert_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_alert_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_alert_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_alert_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_alert_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_alert_config_async(transport: str = 'grpc_asyncio', request_type=project_service.GetAlertConfigRequest):
    client = ProjectServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_alert_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_alert_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = project.AlertConfig(
            name='name_value',
...
def test_update_alert_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_alert_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_alert_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_alert_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProjectServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_alert_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_alert_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_alert_config_async(transport: str = 'grpc_asyncio', request_type=project_service.UpdateAlertConfigRequest):
    client = ProjectServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_alert_config_rest_required_fields(request_type=project_service.GetAlertConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_alert_config._get_unset_required_fields(jsonified_request)
...
def test_get_alert_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2beta/{name=projects/*/alertConfig}" % client.transport._host, args[1])
...
def test_update_alert_config_rest_required_fields(request_type=project_service.UpdateAlertConfigRequest):
    transport_class = transports.ProjectServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_alert_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_alert_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{alert_config.name=projects/*/alertConfig}" % client.transport._host, args[1])
...
def test_get_alert_config_empty_call_grpc():
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = project.AlertConfig()
        client.get_alert_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_alert_config_empty_call_grpc():
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = project.AlertConfig()
        client.update_alert_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_alert_config_empty_call_grpc_asyncio():
    client = ProjectServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_alert_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_alert_config_empty_call_grpc_asyncio():
    client = ProjectServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_alert_config(request=None)
...
def test_get_alert_config_rest_bad_request(request_type=project_service.GetAlertConfigRequest):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_alert_config_rest_call_success(request_type):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_alert_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ProjectServiceRestInterceptor, "post_get_alert_config") as post, \
        mock.patch.object(transports.ProjectServiceRestInterceptor, "post_get_alert_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProjectServiceRestInterceptor, "pre_get_alert_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = project_service.GetAlertConfigRequest.pb(project_service.GetAlertConfigRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = project.AlertConfig.to_json(project.AlertConfig())
        ...
        client.get_alert_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_alert_config_rest_bad_request(request_type=project_service.UpdateAlertConfigRequest):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_alert_config_rest_call_success(request_type):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'alert_config': {'name': 'projects/sample1/alertConfig'}}
    request_init["alert_config"] = {'name': 'projects/sample1/alertConfig', 'alert_policies': [{'alert_group': 'alert_group_value', 'enroll_status': 1, 'recipients': [{'email_address': 'email_address_value'}]}]}
...
def test_update_alert_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ProjectServiceRestInterceptor, "post_update_alert_config") as post, \
        mock.patch.object(transports.ProjectServiceRestInterceptor, "post_update_alert_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ProjectServiceRestInterceptor, "pre_update_alert_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = project_service.UpdateAlertConfigRequest.pb(project_service.UpdateAlertConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_alert_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_alert_config_empty_call_rest():
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_alert_config_empty_call_rest():
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_project_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2beta.services.project_service.transports.ProjectServiceTransport.__init__') as Transport:
...
def test_project_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2beta.services.project_service.transports.ProjectServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_project_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2beta.services.project_service.transports.ProjectServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ProjectServiceTransport()
        adc.assert_called_once()
...
def test_alert_config_path():
    project = "squid"
    expected = "projects/{project}/alertConfig".format(project=project, )

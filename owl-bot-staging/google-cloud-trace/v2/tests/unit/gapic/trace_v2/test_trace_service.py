...
def test_batch_write_spans_rest_required_fields(request_type=tracing.BatchWriteSpansRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_write_spans._get_unset_required_fields(jsonified_request)
...
def test_create_span_rest_required_fields(request_type=trace.Span):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_span._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

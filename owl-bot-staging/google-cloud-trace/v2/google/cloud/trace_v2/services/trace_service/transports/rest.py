...
class TraceServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_write_spans(self, request: tracing.BatchWriteSpansRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tracing.BatchWriteSpansRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_create_span(self, request: trace.Span, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[trace.Span, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_span_with_metadata(self, response: trace.Span, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[trace.Span, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_span
...
class TraceServiceRestTransport(_BaseTraceServiceRestTransport):
    ...
    class _BatchWriteSpans(_BaseTraceServiceRestTransport._BaseBatchWriteSpans, TraceServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TraceServiceRestTransport._BatchWriteSpans._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CreateSpan(_BaseTraceServiceRestTransport._BaseCreateSpan, TraceServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TraceServiceRestTransport._CreateSpan._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

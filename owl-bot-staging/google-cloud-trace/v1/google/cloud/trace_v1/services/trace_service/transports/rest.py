...
class TraceServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_trace(self, request: trace.GetTraceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[trace.GetTraceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_trace_with_metadata(self, response: trace.Trace, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[trace.Trace, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_trace
    ...
    def pre_list_traces(self, request: trace.ListTracesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[trace.ListTracesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_traces_with_metadata(self, response: trace.ListTracesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[trace.ListTracesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_traces
    ...
    def pre_patch_traces(self, request: trace.PatchTracesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[trace.PatchTracesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class TraceServiceRestTransport(_BaseTraceServiceRestTransport):
    ...
    class _GetTrace(_BaseTraceServiceRestTransport._BaseGetTrace, TraceServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TraceServiceRestTransport._GetTrace._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListTraces(_BaseTraceServiceRestTransport._BaseListTraces, TraceServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TraceServiceRestTransport._ListTraces._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _PatchTraces(_BaseTraceServiceRestTransport._BasePatchTraces, TraceServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TraceServiceRestTransport._PatchTraces._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

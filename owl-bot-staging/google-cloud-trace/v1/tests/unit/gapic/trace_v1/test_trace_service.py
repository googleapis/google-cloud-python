...
def test_list_traces_rest_required_fields(request_type=trace.ListTracesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_traces._get_unset_required_fields(jsonified_request)
...
def test_list_traces_rest_unset_required_fields():
    transport = transports.TraceServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_trace_rest_required_fields(request_type=trace.GetTraceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_trace._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_patch_traces_rest_required_fields(request_type=trace.PatchTracesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).patch_traces._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

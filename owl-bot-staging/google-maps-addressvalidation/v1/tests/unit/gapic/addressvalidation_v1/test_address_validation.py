...
def test_validate_address_rest_required_fields(request_type=address_validation_service.ValidateAddressRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).validate_address._get_unset_required_fields(jsonified_request)
...
def test_validate_address_rest_unset_required_fields():
    transport = transports.AddressValidationRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_provide_validation_feedback_rest_required_fields(request_type=address_validation_service.ProvideValidationFeedbackRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).provide_validation_feedback._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

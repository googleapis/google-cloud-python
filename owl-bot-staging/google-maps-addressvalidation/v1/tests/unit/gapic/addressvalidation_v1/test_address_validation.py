...
def test_validate_address_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = address_validation_service.ValidateAddressResponse.pb(return_value)
...
def test_provide_validation_feedback_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = address_validation_service.ProvideValidationFeedbackResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)

...
class AddressValidationRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_provide_validation_feedback(self, request: address_validation_service.ProvideValidationFeedbackRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[address_validation_service.ProvideValidationFeedbackRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_provide_validation_feedback_with_metadata(self, response: address_validation_service.ProvideValidationFeedbackResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[address_validation_service.ProvideValidationFeedbackResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for provide_validation_feedback
    ...
    def pre_validate_address(self, request: address_validation_service.ValidateAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[address_validation_service.ValidateAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_validate_address_with_metadata(self, response: address_validation_service.ValidateAddressResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[address_validation_service.ValidateAddressResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for validate_address
...
class AddressValidationRestTransport(_BaseAddressValidationRestTransport):
    ...
    class _ProvideValidationFeedback(_BaseAddressValidationRestTransport._BaseProvideValidationFeedback, AddressValidationRestStub):
        ...
        feedback method over HTTP.
            ...
            # Send the request
            response = AddressValidationRestTransport._ProvideValidationFeedback._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ValidateAddress(_BaseAddressValidationRestTransport._BaseValidateAddress, AddressValidationRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AddressValidationRestTransport._ValidateAddress._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

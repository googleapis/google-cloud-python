...
class AddressValidationTransport(abc.ABC):
    """Abstract transport class for AddressValidation."""

    AUTH_SCOPES = (
    )

    DEFAULT_HOST: str = 'addressvalidation.googleapis.com'
    def __init__(
            self, *,
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.validate_address: gapic_v1.method.wrap_method(
                self.validate_address,
                default_timeout=None,
                client_info=client_info,
            ),
            self.provide_validation_feedback: gapic_v1.method.wrap_method(

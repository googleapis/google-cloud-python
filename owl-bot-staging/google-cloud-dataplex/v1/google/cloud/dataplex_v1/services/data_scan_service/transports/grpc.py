...
class DataScanServiceGrpcTransport(DataScanServiceTransport):
    ...
    @property
    def create_data_scan(self) -> Callable[
        ...
        if 'create_data_scan' not in self._stubs:
            self._stubs['create_data_scan'] = self.grpc_channel.unary_unary(
    ...
    @property
    def update_data_scan(self) -> Callable[
        ...
        if 'update_data_scan' not in self._stubs:
            self._stubs['update_data_scan'] = self.grpc_channel.unary_unary(
    ...
    @property
    def delete_data_scan(self) -> Callable[
        ...
        if 'delete_data_scan' not in self._stubs:
            self._stubs['delete_data_scan'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_data_scan(self) -> Callable[
        ...
        if 'get_data_scan' not in self._stubs:
            self._stubs['get_data_scan'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_data_scans(self) -> Callable[
        ...
        if 'list_data_scans' not in self._stubs:
            self._stubs['list_data_scans'] = self.grpc_channel.unary_unary(
    ...
    @property
    def run_data_scan(self) -> Callable[
        ...
        if 'run_data_scan' not in self._stubs:
            self._stubs['run_data_scan'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_data_scan_job(self) -> Callable[
        ...
        if 'get_data_scan_job' not in self._stubs:
            self._stubs['get_data_scan_job'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_data_scan_jobs(self) -> Callable[
    ...
    @property
    def generate_data_quality_rules(self) -> Callable[

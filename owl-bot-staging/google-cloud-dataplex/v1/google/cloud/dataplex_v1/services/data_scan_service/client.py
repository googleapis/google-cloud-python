...
class DataScanServiceClient(metaclass=DataScanServiceClientMeta):
    ...
    @staticmethod
    def data_scan_path(project: str,location: str,dataScan: str,) -> str:
        """Returns a fully-qualified data_scan string."""
        return "projects/{project}/locations/{location}/dataScans/{dataScan}".format(project=project, location=location, dataScan=dataScan, )
    ...
    @staticmethod
    def data_scan_job_path(project: str,location: str,dataScan: str,job: str,) -> str:
        """Returns a fully-qualified data_scan_job string."""
        return "projects/{project}/locations/{location}/dataScans/{dataScan}/jobs/{job}".format(project=project, location=location, dataScan=dataScan, job=job, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            DataScanServiceClient._compare_universes(self.universe_domain, self.transport._credentials))

...
class ContentServiceClient(metaclass=ContentServiceClientMeta):
    ...
    def content_path(project: str,location: str,lake: str,content: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/lakes/{lake}/content/{content}".format(project=project, location=location, lake=lake, content=content, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ContentServiceClient._compare_universes(self.universe_domain, self.transport._credentials))

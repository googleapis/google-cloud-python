...
class ContentServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(ContentServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ContentServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ContentServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(ContentServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(ContentServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(ContentServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(ContentServiceClient.common_project_path)
    parse_common_project_path = staticmethod(ContentServiceClient.parse_common_project_path)
    common_location_path = staticmethod(ContentServiceClient.common_location_path)
    parse_common_location_path = staticmethod(ContentServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(ContentServiceClient).get_transport_class, type(ContentServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, ContentServiceTransport, Callable[..., ContentServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_content(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_content]
    ...
    async def update_content(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_content]
    ...
    async def get_content(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_content]
    ...
    async def list_content(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_content]

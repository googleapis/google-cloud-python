...
class CatalogServiceTransport(abc.ABC):
    ...
    @property
    def create_entry_type(self) -> Callable[
    ...
    @property
    def update_entry_type(self) -> Callable[
    ...
    @property
    def delete_entry_type(self) -> Callable[
    ...
    @property
    def list_entry_types(self) -> Callable[
            [catalog.ListEntryTypesRequest],
            Union[
                catalog.ListEntryTypesResponse,
                Awaitable[catalog.ListEntryTypesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_entry_type(self) -> Callable[
            [catalog.GetEntryTypeRequest],
            Union[
                catalog.EntryType,
                Awaitable[catalog.EntryType]
            ]]:
        raise NotImplementedError()

    @property
    def create_aspect_type(self) -> Callable[
    ...
    @property
    def update_aspect_type(self) -> Callable[
    ...
    @property
    def delete_aspect_type(self) -> Callable[
    ...
    @property
    def list_aspect_types(self) -> Callable[
            [catalog.ListAspectTypesRequest],
            Union[
                catalog.ListAspectTypesResponse,
                Awaitable[catalog.ListAspectTypesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_aspect_type(self) -> Callable[
            [catalog.GetAspectTypeRequest],
            Union[
                catalog.AspectType,
                Awaitable[catalog.AspectType]
            ]]:
        raise NotImplementedError()
    ...
    def list_entry_groups(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[catalog.ListEntryGroupsResponse]
            ]]:
        raise NotImplementedError()
    ...
    def list_entries(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[catalog.ListEntriesResponse]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def search_entries(self) -> Callable[
            [catalog.SearchEntriesRequest],
            Union[
                catalog.SearchEntriesResponse,
                Awaitable[catalog.SearchEntriesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def create_metadata_job(self) -> Callable[
    ...
    @property
    def get_metadata_job(self) -> Callable[
            [catalog.GetMetadataJobRequest],
            Union[
                catalog.MetadataJob,
                Awaitable[catalog.MetadataJob]
            ]]:
        raise NotImplementedError()

    @property
    def list_metadata_jobs(self) -> Callable[
    ...
    @property
    def cancel_metadata_job(self) -> Callable[
    ...
    @property
    def create_entry_link(self) -> Callable[
            [catalog.CreateEntryLinkRequest],
            Union[
                catalog.EntryLink,
                Awaitable[catalog.EntryLink]
            ]]:
        raise NotImplementedError()

    @property
    def delete_entry_link(self) -> Callable[
    ...
    @property
    def get_entry_link(self) -> Callable[

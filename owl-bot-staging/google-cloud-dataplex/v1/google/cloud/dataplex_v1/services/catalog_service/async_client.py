...
class CatalogServiceAsyncClient:
    ...
    async def create_entry_type(self,
    ...
    async def update_entry_type(self,
    ...
    async def delete_entry_type(self,
    ...
    async def list_entry_types(self,
    ...
    async def create_aspect_type(self,
    ...
    async def update_aspect_type(self,
    ...
    async def delete_aspect_type(self,
    ...
    async def list_aspect_types(self,
    ...
    async def get_aspect_type(self,
    ...
    async def create_metadata_job(self,
    ...
    async def get_metadata_job(self,
    ...
    async def list_metadata_jobs(self,
    ...
    async def cancel_metadata_job(self,
    ...
    async def create_entry_link(self,
    ...
    async def delete_entry_link(self,

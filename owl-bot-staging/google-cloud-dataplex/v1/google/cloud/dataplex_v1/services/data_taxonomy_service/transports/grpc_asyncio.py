...
class DataTaxonomyServiceGrpcAsyncIOTransport(DataTaxonomyServiceTransport):
    ...
    @property
    def create_data_taxonomy(self) -> Callable[
    ...
    @property
    def update_data_taxonomy(self) -> Callable[
    ...
    @property
    def delete_data_taxonomy(self) -> Callable[
    ...
    @property
    def list_data_taxonomies(self) -> Callable[
    ...
    @property
    def get_data_taxonomy(self) -> Callable[
            [data_taxonomy.GetDataTaxonomyRequest],
            Awaitable[data_taxonomy.DataTaxonomy]]:
    ...
    @property
    def create_data_attribute_binding(self) -> Callable[
        ...
        if 'create_data_attribute_binding' not in self._stubs:
            self._stubs['create_data_attribute_binding'] = self.grpc_channel.unary_unary(
    ...
    @property
    def update_data_attribute_binding(self) -> Callable[
        ...
        if 'update_data_attribute_binding' not in self._stubs:
            self._stubs['update_data_attribute_binding'] = self.grpc_channel.unary_unary(
    ...
    @property
    def delete_data_attribute_binding(self) -> Callable[
        ...
        if 'delete_data_attribute_binding' not in self._stubs:
            self._stubs['delete_data_attribute_binding'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_data_attribute_bindings(self) -> Callable[
    ...
    @property
    def get_data_attribute_binding(self) -> Callable[
    ...
    @property
    def create_data_attribute(self) -> Callable[
    ...
    @property
    def update_data_attribute(self) -> Callable[
    ...
    @property
    def delete_data_attribute(self) -> Callable[
    ...
    @property
    def list_data_attributes(self) -> Callable[
    ...
    @property
    def get_data_attribute(self) -> Callable[
            [data_taxonomy.GetDataAttributeRequest],
            Awaitable[data_taxonomy.DataAttribute]]:

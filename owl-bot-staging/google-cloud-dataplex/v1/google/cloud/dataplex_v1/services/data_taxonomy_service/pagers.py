...
class ListDataAttributeBindingsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[data_taxonomy.ListDataAttributeBindingsResponse]],
            request: data_taxonomy.ListDataAttributeBindingsRequest,
            response: data_taxonomy.ListDataAttributeBindingsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[data_taxonomy.ListDataAttributeBindingsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)

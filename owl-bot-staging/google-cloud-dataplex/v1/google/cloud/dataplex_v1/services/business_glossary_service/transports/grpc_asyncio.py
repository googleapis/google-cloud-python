...
class BusinessGlossaryServiceGrpcAsyncIOTransport(BusinessGlossaryServiceTransport):
    ...
    def get_glossary(self) -> Callable[
            ...
            Awaitable[business_glossary.Glossary]]:
    ...
    @property
    def create_glossary_category(self) -> Callable[
    ...
    @property
    def update_glossary_category(self) -> Callable[
    ...
    @property
    def delete_glossary_category(self) -> Callable[
    ...
    @property
    def get_glossary_category(self) -> Callable[
    ...
    @property
    def list_glossary_categories(self) -> Callable[
    ...
    @property
    def create_glossary_term(self) -> Callable[
    ...
    @property
    def update_glossary_term(self) -> Callable[
    ...
    @property
    def delete_glossary_term(self) -> Callable[
    ...
    @property
    def get_glossary_term(self) -> Callable[
    ...
    @property
    def list_glossary_terms(self) -> Callable[

...
class BusinessGlossaryServiceClient(metaclass=BusinessGlossaryServiceClientMeta):
    ...
    @staticmethod
    def glossary_category_path(project: str,location: str,glossary: str,glossary_category: str,) -> str:
        """Returns a fully-qualified glossary_category string."""
        return "projects/{project}/locations/{location}/glossaries/{glossary}/categories/{glossary_category}".format(project=project, location=location, glossary=glossary, glossary_category=glossary_category, )

    @staticmethod
    def parse_glossary_category_path(path: str) -> Dict[str,str]:
        """Parses a glossary_category path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/glossaries/(?P<glossary>.+?)/categories/(?P<glossary_category>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def glossary_term_path(project: str,location: str,glossary: str,glossary_term: str,) -> str:
        """Returns a fully-qualified glossary_term string."""
        return "projects/{project}/locations/{location}/glossaries/{glossary}/terms/{glossary_term}".format(project=project, location=location, glossary=glossary, glossary_term=glossary_term, )
    ...
    def __init__(self, *,
        ...
        self._client_cert_source = BusinessGlossaryServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
    ...
    def update_glossary_category(self,
    ...
    def delete_glossary_category(self,
    ...
    def get_glossary_category(self,

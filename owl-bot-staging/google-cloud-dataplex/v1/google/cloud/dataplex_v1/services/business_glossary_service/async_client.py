...
from .transports.base import BusinessGlossaryServiceTransport, DEFAULT_CLIENT_INFO
...
class BusinessGlossaryServiceAsyncClient:
    ...
    async def update_glossary(self,
    ...
    async def create_glossary_category(self,
    ...
    async def update_glossary_category(self,
    ...
    async def delete_glossary_category(self,
    ...
    async def get_glossary_category(self,
    ...
    async def list_glossary_categories(self,
    ...
    async def update_glossary_term(self,
    ...
    async def delete_glossary_term(self,
    ...
    async def get_glossary_term(self,

...
class CmekServiceClient(metaclass=CmekServiceClientMeta):
    ...
    @staticmethod
    def encryption_config_path(organization: str,location: str,encryption_config: str,) -> str:
        """Returns a fully-qualified encryption_config string."""
        return "organizations/{organization}/locations/{location}/encryptionConfigs/{encryption_config}".format(organization=organization, location=location, encryption_config=encryption_config, )

    @staticmethod
    def parse_encryption_config_path(path: str) -> Dict[str,str]:
        """Parses a encryption_config path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/encryptionConfigs/(?P<encryption_config>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def organization_location_path(organization: str,location: str,) -> str:
        """Returns a fully-qualified organization_location string."""
        return "organizations/{organization}/locations/{location}".format(organization=organization, location=location, )
    ...
    def parse_organization_location_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CmekServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CmekServiceTransport, Callable[..., CmekServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CmekServiceClient._read_environment_variables()
        self._client_cert_source = CmekServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CmekServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            CmekServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CmekServiceTransport], Callable[..., CmekServiceTransport]] = (
    ...
    def create_encryption_config(self,
    ...
    def update_encryption_config(self,
    ...
    def delete_encryption_config(self,
    ...
    def list_encryption_configs(self,

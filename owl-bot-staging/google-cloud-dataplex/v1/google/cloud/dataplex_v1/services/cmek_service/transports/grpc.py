...
from .base import CmekServiceTransport, DEFAULT_CLIENT_INFO
...
class CmekServiceGrpcTransport(CmekServiceTransport):
    ...
    @property
    def create_encryption_config(self) -> Callable[
    ...
    @property
    def update_encryption_config(self) -> Callable[
    ...
    @property
    def delete_encryption_config(self) -> Callable[
    ...
    @property
    def list_encryption_configs(self) -> Callable[
    ...
    @property
    def get_encryption_config(self) -> Callable[

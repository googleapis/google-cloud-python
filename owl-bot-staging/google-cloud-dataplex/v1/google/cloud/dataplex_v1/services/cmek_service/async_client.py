...
from .transports.base import CmekServiceTransport, DEFAULT_CLIENT_INFO
...
class CmekServiceAsyncClient:
    ...
    parse_encryption_config_path = staticmethod(CmekServiceClient.parse_encryption_config_path)
    organization_location_path = staticmethod(CmekServiceClient.organization_location_path)
    parse_organization_location_path = staticmethod(CmekServiceClient.parse_organization_location_path)
    common_billing_account_path = staticmethod(CmekServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(CmekServiceClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(CmekServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(CmekServiceClient.common_project_path)
    parse_common_project_path = staticmethod(CmekServiceClient.parse_common_project_path)
    common_location_path = staticmethod(CmekServiceClient.common_location_path)
    parse_common_location_path = staticmethod(CmekServiceClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return CmekServiceClient.from_service_account_info.__func__(CmekServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            CmekServiceAsyncClient: The constructed client.
        """
        return CmekServiceClient.from_service_account_file.__func__(CmekServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CmekServiceTransport, Callable[..., CmekServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_encryption_config(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_encryption_config():
                ...
                # Make the request
                operation = client.create_encryption_config(request=request)
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_encryption_config]
    ...
    async def update_encryption_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_encryption_config]
    ...
    async def delete_encryption_config(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_encryption_config():
                ...
                # Make the request
                operation = client.delete_encryption_config(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_encryption_config]
    ...
    async def list_encryption_configs(self,
            request: Optional[Union[cmek.ListEncryptionConfigsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListEncryptionConfigsAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_list_encryption_configs():
                # Create a client
                client = dataplex_v1.CmekServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.ListEncryptionConfigsRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cmek.ListEncryptionConfigsRequest):
            request = cmek.ListEncryptionConfigsRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_encryption_configs]
        ...
        response = pagers.ListEncryptionConfigsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_encryption_config(self,
            request: Optional[Union[cmek.GetEncryptionConfigRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_get_encryption_config():
                # Create a client
                client = dataplex_v1.CmekServiceAsyncClient()

                # Initialize request argument(s)
                request = dataplex_v1.GetEncryptionConfigRequest(
                    name="name_value",
                )

                # Make the request
                response = await client.get_encryption_config(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.GetEncryptionConfigRequest, dict]]):
                The request object. Get EncryptionConfig Request
            name (:class:`str`):
                Required. The name of the
                EncryptionConfig to fetch.
        ...
        Returns:
            google.cloud.dataplex_v1.types.EncryptionConfig:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cmek.GetEncryptionConfigRequest):
            request = cmek.GetEncryptionConfigRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_encryption_config]
    ...
    async def __aenter__(self) -> "CmekServiceAsyncClient":
        return self

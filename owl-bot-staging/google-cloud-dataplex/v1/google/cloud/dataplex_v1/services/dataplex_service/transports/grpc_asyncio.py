...
class DataplexServiceGrpcAsyncIOTransport(DataplexServiceTransport):
    ...
    @property
    def list_lakes(self) -> Callable[
            [service.ListLakesRequest],
            Awaitable[service.ListLakesResponse]]:
    ...
    @property
    def get_lake(self) -> Callable[
            [service.GetLakeRequest],
            Awaitable[resources.Lake]]:
    ...
    @property
    def list_lake_actions(self) -> Callable[
            [service.ListLakeActionsRequest],
            Awaitable[service.ListActionsResponse]]:
    ...
    @property
    def list_zone_actions(self) -> Callable[
    ...
    @property
    def list_asset_actions(self) -> Callable[
    ...
    def list_jobs(self) -> Callable[
            ...
            Awaitable[service.ListJobsResponse]]:
    ...
    def run_task(self) -> Callable[
            ...
            Awaitable[service.RunTaskResponse]]:
    ...
    def list_sessions(self) -> Callable[
            ...
            Awaitable[service.ListSessionsResponse]]:

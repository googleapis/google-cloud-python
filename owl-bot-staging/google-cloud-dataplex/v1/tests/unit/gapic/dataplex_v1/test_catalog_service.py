...
from google.cloud.dataplex_v1.services.catalog_service import CatalogServiceAsyncClient
...
from google.cloud.dataplex_v1.services.catalog_service import transports
...
def test_create_entry_type(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_entry_type),
            '__call__') as call:
...
def test_update_entry_type(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_entry_type),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_entry_type(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_entry_type),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_entry_types(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_entry_types),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_entry_types_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, catalog.EntryType)
                   for i in results)
...
async def test_list_entry_types_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_entry_types(request={},)
...
def test_get_entry_type(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_entry_type),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_aspect_type(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_aspect_type),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_aspect_type(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_aspect_type),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_aspect_type(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_aspect_type),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_aspect_types_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, catalog.AspectType)
                   for i in results)
...
async def test_list_aspect_types_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_aspect_types(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_aspect_type(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_aspect_type),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_entry_groups_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, catalog.EntryGroup)
                   for i in results)
...
def test_list_entries_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, catalog.Entry)
                   for i in results)
...
def test_search_entries(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_entries),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_search_entries_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, catalog.SearchEntriesResult)
                   for i in results)
...
async def test_search_entries_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.search_entries(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_create_metadata_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_metadata_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_metadata_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_metadata_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_metadata_jobs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, catalog.MetadataJob)
                   for i in results)
...
async def test_list_metadata_jobs_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_metadata_jobs(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_cancel_metadata_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.cancel_metadata_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_entry_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_entry_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_entry_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_entry_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = catalog.EntryLink(
            name='name_value',
...
def test_get_entry_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_entry_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = catalog.EntryLink(
            name='name_value',
...
def test_create_entry_type_rest_required_fields(request_type=catalog.CreateEntryTypeRequest):
    ...
    assert not set(unset_fields) - set(("entry_type_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_entry_type_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("entryTypeId", "validateOnly", )) & set(("parent", "entryTypeId", "entryType", )))
...
def test_update_entry_type_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("entryType", "updateMask", )))
...
def test_create_aspect_type_rest_required_fields(request_type=catalog.CreateAspectTypeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_aspect_type._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("aspect_type_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_aspect_type_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("aspectTypeId", "validateOnly", )) & set(("parent", "aspectTypeId", "aspectType", )))
...
def test_update_aspect_type_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("aspectType", "updateMask", )))
...
def test_create_entry_group_rest_required_fields(request_type=catalog.CreateEntryGroupRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_entry_group._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("entry_group_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_entry_group_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("entryGroupId", "validateOnly", )) & set(("parent", "entryGroupId", "entryGroup", )))
...
def test_update_entry_group_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("entryGroup", "updateMask", )))
...
def test_create_entry_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("entryId", )) & set(("parent", "entryId", "entry", )))
...
def test_update_entry_rest_required_fields(request_type=catalog.UpdateEntryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_entry._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("allow_missing", "aspect_keys", "delete_missing_aspects", "update_mask", ))
    jsonified_request.update(unset_fields)
...
def test_update_entry_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "aspectKeys", "deleteMissingAspects", "updateMask", )) & set(("entry", )))
...
def test_get_entry_rest_required_fields(request_type=catalog.GetEntryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_entry._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("aspect_types", "paths", "view", ))
    jsonified_request.update(unset_fields)
...
def test_get_entry_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("aspectTypes", "paths", "view", )) & set(("name", )))
...
def test_lookup_entry_rest_required_fields(request_type=catalog.LookupEntryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).lookup_entry._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("aspect_types", "entry", "paths", "view", ))
    jsonified_request.update(unset_fields)
...
def test_lookup_entry_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("aspectTypes", "entry", "paths", "view", )) & set(("name", "entry", )))
...
def test_search_entries_rest_required_fields(request_type=catalog.SearchEntriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_entries._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("order_by", "page_size", "page_token", "query", "scope", "semantic_search", ))
    jsonified_request.update(unset_fields)
...
def test_search_entries_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("orderBy", "pageSize", "pageToken", "query", "scope", "semanticSearch", )) & set(("name", "query", )))
...
def test_create_metadata_job_rest_required_fields(request_type=catalog.CreateMetadataJobRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_metadata_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_metadata_job._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("metadata_job_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_metadata_job_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("metadataJobId", "validateOnly", )) & set(("parent", "metadataJob", )))
...
def test_cancel_metadata_job_rest_required_fields(request_type=catalog.CancelMetadataJobRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).cancel_metadata_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_entry_link_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("entryLinkId", )) & set(("parent", "entryLinkId", "entryLink", )))
...
def test_create_entry_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_entry_type") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_entry_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_create_entry_type") as pre:
        ...
        client.create_entry_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_entry_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_entry_type") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_entry_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_update_entry_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_entry_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_entry_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_delete_entry_type") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_delete_entry_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_delete_entry_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_entry_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_entry_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_entry_types") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_entry_types_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_list_entry_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_entry_types(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_entry_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_entry_type") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_entry_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_get_entry_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_entry_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_aspect_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_aspect_type") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_aspect_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_create_aspect_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_aspect_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_aspect_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_aspect_type") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_aspect_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_update_aspect_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_aspect_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_aspect_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_delete_aspect_type") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_delete_aspect_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_delete_aspect_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_aspect_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_aspect_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_aspect_types") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_aspect_types_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_list_aspect_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_aspect_types(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_aspect_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_aspect_type") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_aspect_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_get_aspect_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_aspect_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_entry_group_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["entry_group"] = {'name': 'name_value', 'uid': 'uid_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'display_name': 'display_name_value', 'labels': {}, 'etag': 'etag_value', 'transfer_status': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_entry_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_entry_group") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_entry_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_create_entry_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_entry_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_entry_group_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'entry_group': {'name': 'projects/sample1/locations/sample2/entryGroups/sample3'}}
    request_init["entry_group"] = {'name': 'projects/sample1/locations/sample2/entryGroups/sample3', 'uid': 'uid_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'display_name': 'display_name_value', 'labels': {}, 'etag': 'etag_value', 'transfer_status': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_entry_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_entry_group") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_entry_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_update_entry_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_entry_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_entry_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_delete_entry_group") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_delete_entry_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_delete_entry_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_entry_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_entry_groups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_entry_groups") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_entry_groups_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_list_entry_groups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_entry_groups(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_entry_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_entry_group") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_entry_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_get_entry_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_entry_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_entry") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_entry_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_create_entry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_entry(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_entry") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_entry_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_update_entry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_entry(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_delete_entry") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_delete_entry_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_delete_entry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_entry(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_entries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_entries") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_entries_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_list_entries") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_entries(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_entry") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_entry_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_get_entry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_entry(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_lookup_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_lookup_entry") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_lookup_entry_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_lookup_entry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.lookup_entry(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_search_entries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_search_entries") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_search_entries_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_search_entries") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.search_entries(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_metadata_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_metadata_job") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_metadata_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_create_metadata_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_metadata_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_metadata_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_metadata_job") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_metadata_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_get_metadata_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_metadata_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_metadata_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_metadata_jobs") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_metadata_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_list_metadata_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_metadata_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_cancel_metadata_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_cancel_metadata_job") as pre:
        pre.assert_not_called()
        ...
        client.cancel_metadata_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_entry_link_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/entryGroups/sample3'}
    request_init["entry_link"] = {'name': 'name_value', 'entry_link_type': 'entry_link_type_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'entry_references': [{'name': 'name_value', 'path': 'path_value', 'type_': 2}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_entry_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_entry_link") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_entry_link_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_create_entry_link") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_entry_link(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_entry_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_delete_entry_link") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_delete_entry_link_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_delete_entry_link") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_entry_link(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_entry_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_entry_link") as post, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_entry_link_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_get_entry_link") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_entry_link(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_catalog_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dataplex_v1.services.catalog_service.transports.CatalogServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_catalog_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dataplex_v1.services.catalog_service.transports.CatalogServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CatalogServiceTransport()
        adc.assert_called_once()
...
def test_aspect_type_path():
    ...
    location = "clam"
    aspect_type = "whelk"
    expected = "projects/{project}/locations/{location}/aspectTypes/{aspect_type}".format(project=project, location=location, aspect_type=aspect_type, )
...
def test_entry_link_path():
    ...
    entry_group = "scallop"
    entry_link = "abalone"
    expected = "projects/{project}/locations/{location}/entryGroups/{entry_group}/entryLinks/{entry_link}".format(project=project, location=location, entry_group=entry_group, entry_link=entry_link, )
...
def test_entry_type_path():
    ...
    expected = "projects/{project}/locations/{location}/entryTypes/{entry_type}".format(project=project, location=location, entry_type=entry_type, )
...
def test_metadata_job_path():
    ...
    expected = "projects/{project}/locations/{location}/metadataJobs/{metadataJob}".format(project=project, location=location, metadataJob=metadataJob, )

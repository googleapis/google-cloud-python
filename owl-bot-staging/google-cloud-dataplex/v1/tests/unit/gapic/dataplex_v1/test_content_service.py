...
@mock.patch.object(ContentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ContentServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert ContentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ContentServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert ContentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ContentServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ContentServiceAsyncClient, transports.ContentServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (ContentServiceAsyncClient, transports.ContentServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ContentServiceClient, transports.ContentServiceGrpcTransport, "grpc", "false"),
    (ContentServiceAsyncClient, transports.ContentServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
@pytest.mark.parametrize("client_class", [
    ContentServiceClient, ContentServiceAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ContentServiceClient, transports.ContentServiceGrpcTransport, "grpc", grpc_helpers),
    (ContentServiceAsyncClient, transports.ContentServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_create_content(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_content),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_create_content_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_content in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_content] = mock_rpc
...
def test_update_content(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_content),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = analyze.Content(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_content_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ContentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_content in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_content] = mock_rpc
...
def test_delete_content(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_content),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_delete_content_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ContentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_content in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_content] = mock_rpc
...
def test_get_content(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_content),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = analyze.Content(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_content_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ContentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_content in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_content] = mock_rpc
...
def test_list_content(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_content),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_content_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ContentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_content in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_content] = mock_rpc
...
def test_list_content_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, analyze.Content)
                   for i in results)
...
def test_create_content_rest_required_fields(request_type=gcd_content.CreateContentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_content._get_unset_required_fields(jsonified_request)
...
def test_create_content_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("validateOnly", )) & set(("parent", "content", )))
...
def test_create_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/lakes/*}/contentitems" % client.transport._host, args[1])
...
def test_update_content_rest_required_fields(request_type=gcd_content.UpdateContentRequest):
    transport_class = transports.ContentServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_content._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_content_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("updateMask", "content", )))
...
def test_update_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'content': {'name': 'projects/sample1/locations/sample2/lakes/sample3/contentitems/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{content.name=projects/*/locations/*/lakes/*/contentitems/**}" % client.transport._host, args[1])
...
def test_delete_content_rest_required_fields(request_type=content.DeleteContentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_content._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/lakes/sample3/contentitems/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/lakes/*/contentitems/**}" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'resource': 'projects/sample1/locations/sample2/lakes/sample3/contentitems/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{resource=projects/*/locations/*/lakes/*/contentitems/**}:getIamPolicy" % client.transport._host, args[1])
...
def test_create_content_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/lakes/sample3'}
    request_init["content"] = {'name': 'name_value', 'uid': 'uid_value', 'path': 'path_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'description': 'description_value', 'data_text': 'data_text_value', 'sql_script': {'engine': 2}, 'notebook': {'kernel_type': 1}}
...
def test_create_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_create_content") as post, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_create_content_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "pre_create_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcd_content.CreateContentRequest.pb(gcd_content.CreateContentRequest())
        ...
        client.create_content(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_content_rest_bad_request(request_type=gcd_content.UpdateContentRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'content': {'name': 'projects/sample1/locations/sample2/lakes/sample3/contentitems/sample4'}}
    request = request_type(**request_init)
...
def test_update_content_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'content': {'name': 'projects/sample1/locations/sample2/lakes/sample3/contentitems/sample4'}}
    request_init["content"] = {'name': 'projects/sample1/locations/sample2/lakes/sample3/contentitems/sample4', 'uid': 'uid_value', 'path': 'path_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'description': 'description_value', 'data_text': 'data_text_value', 'sql_script': {'engine': 2}, 'notebook': {'kernel_type': 1}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_update_content") as post, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_update_content_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "pre_update_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcd_content.UpdateContentRequest.pb(gcd_content.UpdateContentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_content(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_content_rest_bad_request(request_type=content.DeleteContentRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/lakes/sample3/contentitems/sample4'}
    request = request_type(**request_init)
...
def test_delete_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "pre_delete_content") as pre:
        pre.assert_not_called()
        ...
        client.delete_content(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_get_content") as post, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_get_content_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "pre_get_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_content(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_iam_policy_rest_bad_request(request_type=iam_policy_pb2.GetIamPolicyRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'resource': 'projects/sample1/locations/sample2/lakes/sample3/contentitems/sample4'}
    request = request_type(**request_init)
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_list_content") as post, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "post_list_content_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ContentServiceRestInterceptor, "pre_list_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = content.ListContentResponse.to_json(content.ListContentResponse())
        req.return_value.content = return_value
        ...
        client.list_content(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_content_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ContentServiceGrpcTransport, transports.ContentServiceGrpcAsyncIOTransport])
def test_content_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

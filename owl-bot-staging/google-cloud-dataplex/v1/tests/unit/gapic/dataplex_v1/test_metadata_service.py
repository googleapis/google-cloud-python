...
from google.cloud.dataplex_v1.services.metadata_service import MetadataServiceAsyncClient
...
def test_create_entity(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_entity),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_create_entity_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_entity in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_entity] = mock_rpc
...
def test_update_entity(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_entity),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = metadata_.Entity(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_entity_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MetadataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_entity in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_entity] = mock_rpc
...
def test_delete_entity(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_entity),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_delete_entity_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MetadataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_entity in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_entity] = mock_rpc
...
def test_get_entity(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_entity),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = metadata_.Entity(
            name='name_value',
...
async def test_get_entity_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_entity in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_entity] = mock_rpc
...
def test_list_entities(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_entities),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_entities_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MetadataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_entities in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_entities] = mock_rpc
...
def test_list_entities_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_entities(request={}, retry=retry, timeout=timeout)
        ...
        assert all(isinstance(i, metadata_.Entity)
                   for i in results)
...
def test_create_partition(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_partition),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_partition_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_partition] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_partition_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MetadataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_partition in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_partition] = mock_rpc
...
def test_delete_partition(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_partition),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_partition_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_partition] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_partition_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MetadataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_partition in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_partition] = mock_rpc
...
def test_get_partition(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_partition),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = metadata_.Partition(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_partition_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MetadataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_partition in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_partition] = mock_rpc
...
def test_list_partitions(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_partitions),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_partitions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MetadataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_partitions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_partitions] = mock_rpc
...
def test_list_partitions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_partitions(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, metadata_.Partition)
                   for i in results)
...
def test_create_entity_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = MetadataServiceClient(
...
def test_create_entity_rest_required_fields(request_type=metadata_.CreateEntityRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_entity._get_unset_required_fields(jsonified_request)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = metadata_.Entity.pb(return_value)
...
def test_create_entity_rest_unset_required_fields():
    ...
    unset_fields = transport.create_entity._get_unset_required_fields({})
    assert set(unset_fields) == (set(("validateOnly", )) & set(("parent", "entity", )))


def test_create_entity_rest_flattened():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'parent': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4'}
        ...
        client.create_entity(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/lakes/*/zones/*}/entities" % client.transport._host, args[1])


def test_create_entity_rest_flattened_error(transport: str = 'rest'):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_entity_rest_required_fields(request_type=metadata_.UpdateEntityRequest):
    transport_class = transports.MetadataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_entity._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_entity_rest_unset_required_fields():
    ...
    unset_fields = transport.update_entity._get_unset_required_fields({})
    assert set(unset_fields) == (set(("validateOnly", )) & set(("entity", )))


def test_delete_entity_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = MetadataServiceClient(
...
def test_delete_entity_rest_required_fields(request_type=metadata_.DeleteEntityRequest):
    transport_class = transports.MetadataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_entity._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_entity_rest_unset_required_fields():
    ...
    unset_fields = transport.delete_entity._get_unset_required_fields({})
    assert set(unset_fields) == (set(("etag", )) & set(("name", "etag", )))


def test_delete_entity_rest_flattened():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5'}
        ...
        client.delete_entity(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/lakes/*/zones/*/entities/*}" % client.transport._host, args[1])


def test_delete_entity_rest_flattened_error(transport: str = 'rest'):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_entity_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = MetadataServiceClient(
...
def test_get_entity_rest_required_fields(request_type=metadata_.GetEntityRequest):
    transport_class = transports.MetadataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_entity._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_entity_rest_unset_required_fields():
    ...
    unset_fields = transport.get_entity._get_unset_required_fields({})
    assert set(unset_fields) == (set(("view", )) & set(("name", )))


def test_get_entity_rest_flattened():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_entity_rest_flattened_error(transport: str = 'rest'):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_entities_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = MetadataServiceClient(
...
def test_list_entities_rest_required_fields(request_type=metadata_.ListEntitiesRequest):
    transport_class = transports.MetadataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_entities._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = metadata_.ListEntitiesResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = metadata_.ListEntitiesResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_entities_rest_unset_required_fields():
    ...
    unset_fields = transport.list_entities._get_unset_required_fields({})
    assert set(unset_fields) == (set(("filter", "pageSize", "pageToken", "view", )) & set(("parent", "view", )))


def test_list_entities_rest_flattened():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.list_entities(**mock_args)
...
def test_list_entities_rest_flattened_error(transport: str = 'rest'):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_entities_rest_pager(transport: str = 'rest'):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(metadata_.ListEntitiesResponse.to_json(x) for x in response)
        ...
        pages = list(client.list_entities(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token


def test_create_partition_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = MetadataServiceClient(
...
def test_create_partition_rest_required_fields(request_type=metadata_.CreatePartitionRequest):
    transport_class = transports.MetadataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_partition._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = metadata_.Partition()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = metadata_.Partition.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_create_partition_rest_unset_required_fields():
    ...
    unset_fields = transport.create_partition._get_unset_required_fields({})
    assert set(unset_fields) == (set(("validateOnly", )) & set(("parent", "partition", )))


def test_create_partition_rest_flattened():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5'}
        ...
        client.create_partition(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/lakes/*/zones/*/entities/*}/partitions" % client.transport._host, args[1])


def test_create_partition_rest_flattened_error(transport: str = 'rest'):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_partition_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = MetadataServiceClient(
...
def test_delete_partition_rest_required_fields(request_type=metadata_.DeletePartitionRequest):
    transport_class = transports.MetadataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_partition._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_partition_rest_unset_required_fields():
    ...
    unset_fields = transport.delete_partition._get_unset_required_fields({})
    assert set(unset_fields) == (set(("etag", )) & set(("name", )))


def test_delete_partition_rest_flattened():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5/partitions/sample6'}
        ...
        client.delete_partition(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/lakes/*/zones/*/entities/*/partitions/**}" % client.transport._host, args[1])


def test_delete_partition_rest_flattened_error(transport: str = 'rest'):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_partition_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = MetadataServiceClient(
...
def test_get_partition_rest_required_fields(request_type=metadata_.GetPartitionRequest):
    transport_class = transports.MetadataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_partition._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_partition_rest_unset_required_fields():
    ...
    unset_fields = transport.get_partition._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))


def test_get_partition_rest_flattened():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.get_partition(**mock_args)
...
def test_get_partition_rest_flattened_error(transport: str = 'rest'):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_partitions_rest_required_fields(request_type=metadata_.ListPartitionsRequest):
    transport_class = transports.MetadataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_partitions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = metadata_.ListPartitionsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = metadata_.ListPartitionsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_partitions_rest_pager(transport: str = 'rest'):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(metadata_.ListPartitionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.list_partitions(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_entity_empty_call_grpc():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = metadata_.Entity()
        client.create_entity(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_entity_empty_call_grpc():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = metadata_.Entity()
        client.update_entity(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_entity_empty_call_grpc():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_entity(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_entity_empty_call_grpc():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = metadata_.Entity()
        client.get_entity(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_entities_empty_call_grpc():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = metadata_.ListEntitiesResponse()
        client.list_entities(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_partition_empty_call_grpc():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = metadata_.Partition()
        client.create_partition(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_partition_empty_call_grpc():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_partition(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_partition_empty_call_grpc():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = metadata_.Partition()
        client.get_partition(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = MetadataServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_entity_empty_call_grpc_asyncio():
    client = MetadataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_entity(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_entity_empty_call_grpc_asyncio():
    client = MetadataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_entity(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_entity_empty_call_grpc_asyncio():
    client = MetadataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_entity(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_entity_empty_call_grpc_asyncio():
    client = MetadataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_entity(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_entities_empty_call_grpc_asyncio():
    client = MetadataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_entities(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_partition_empty_call_grpc_asyncio():
    client = MetadataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_partition(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_partition_empty_call_grpc_asyncio():
    client = MetadataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_partition(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_partition_empty_call_grpc_asyncio():
    client = MetadataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_partition(request=None)
...
def test_transport_kind_rest():
    transport = MetadataServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_entity_rest_bad_request(request_type=metadata_.CreateEntityRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4'}
    request = request_type(**request_init)
...
def test_create_entity_rest_call_success(request_type):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    for field, value in request_init["entity"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["entity"][field])):
                    del request_init["entity"][field][i][subfield]
            else:
                del request_init["entity"][field][subfield]
    request = request_type(**request_init)
...
def test_create_entity_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_create_entity") as post, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_create_entity_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_create_entity") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = metadata_.CreateEntityRequest.pb(metadata_.CreateEntityRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = metadata_.Entity.to_json(metadata_.Entity())
        ...
        post.return_value = metadata_.Entity()
        post_with_metadata.return_value = metadata_.Entity(), metadata

        client.create_entity(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_entity_rest_bad_request(request_type=metadata_.UpdateEntityRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'entity': {'name': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5'}}
    request = request_type(**request_init)
...
def test_update_entity_rest_call_success(request_type):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'entity': {'name': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5'}}
    request_init["entity"] = {'name': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'id': 'id_value', 'etag': 'etag_value', 'type_': 1, 'asset': 'asset_value', 'data_path': 'data_path_value', 'data_path_pattern': 'data_path_pattern_value', 'catalog_entry': 'catalog_entry_value', 'system': 1, 'format_': {'format_': 1, 'compression_format': 2, 'mime_type': 'mime_type_value', 'csv': {'encoding': 'encoding_value', 'header_rows': 1171, 'delimiter': 'delimiter_value', 'quote': 'quote_value'}, 'json': {'encoding': 'encoding_value'}, 'iceberg': {'metadata_location': 'metadata_location_value'}}, 'compatibility': {'hive_metastore': {'compatible': True, 'reason': 'reason_value'}, 'bigquery': {}}, 'access': {'read': 1}, 'uid': 'uid_value', 'schema': {'user_managed': True, 'fields': [{'name': 'name_value', 'description': 'description_value', 'type_': 1, 'mode': 1, 'fields': {}}], 'partition_fields': [{'name': 'name_value', 'type_': 1}], 'partition_style': 1}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = metadata_.UpdateEntityRequest.meta.fields["entity"]
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_entity_rest_interceptors(null_interceptor):
    transport = transports.MetadataServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MetadataServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_update_entity") as post, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_update_entity_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_update_entity") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = metadata_.UpdateEntityRequest.pb(metadata_.UpdateEntityRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_entity(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_entity_rest_bad_request(request_type=metadata_.DeleteEntityRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5'}
    request = request_type(**request_init)
...
def test_delete_entity_rest_call_success(request_type):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_entity_rest_interceptors(null_interceptor):
    transport = transports.MetadataServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MetadataServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_delete_entity") as pre:
        pre.assert_not_called()
        ...
        client.delete_entity(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_get_entity_rest_bad_request(request_type=metadata_.GetEntityRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_entity_rest_call_success(request_type):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_entity_rest_interceptors(null_interceptor):
    transport = transports.MetadataServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MetadataServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_get_entity") as post, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_get_entity_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_get_entity") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = metadata_.GetEntityRequest.pb(metadata_.GetEntityRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_entity(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_entities_rest_bad_request(request_type=metadata_.ListEntitiesRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_entities_rest_call_success(request_type):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_list_entities_rest_interceptors(null_interceptor):
    transport = transports.MetadataServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MetadataServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_list_entities") as post, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_list_entities_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_list_entities") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = metadata_.ListEntitiesRequest.pb(metadata_.ListEntitiesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = metadata_.ListEntitiesResponse.to_json(metadata_.ListEntitiesResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = metadata_.ListEntitiesResponse()
        post_with_metadata.return_value = metadata_.ListEntitiesResponse(), metadata

        client.list_entities(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_partition_rest_bad_request(request_type=metadata_.CreatePartitionRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5'}
    request = request_type(**request_init)
...
def test_create_partition_rest_call_success(request_type):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5'}
    request_init["partition"] = {'name': 'name_value', 'values': ['values_value1', 'values_value2'], 'location': 'location_value', 'etag': 'etag_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = metadata_.CreatePartitionRequest.meta.fields["partition"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["partition"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["partition"][field])):
                    del request_init["partition"][field][i][subfield]
            else:
                del request_init["partition"][field][subfield]
    request = request_type(**request_init)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_create_partition_rest_interceptors(null_interceptor):
    transport = transports.MetadataServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MetadataServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_create_partition") as post, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_create_partition_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_create_partition") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = metadata_.CreatePartitionRequest.pb(metadata_.CreatePartitionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = metadata_.Partition.to_json(metadata_.Partition())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = metadata_.Partition()
        post_with_metadata.return_value = metadata_.Partition(), metadata

        client.create_partition(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_partition_rest_bad_request(request_type=metadata_.DeletePartitionRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5/partitions/sample6'}
    request = request_type(**request_init)
...
def test_delete_partition_rest_call_success(request_type):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_partition_rest_interceptors(null_interceptor):
    transport = transports.MetadataServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MetadataServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_delete_partition") as pre:
        pre.assert_not_called()
        pb_message = metadata_.DeletePartitionRequest.pb(metadata_.DeletePartitionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_partition(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_get_partition_rest_bad_request(request_type=metadata_.GetPartitionRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_partition_rest_call_success(request_type):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_partition_rest_interceptors(null_interceptor):
    transport = transports.MetadataServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MetadataServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_get_partition") as post, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_get_partition_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_get_partition") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = metadata_.GetPartitionRequest.pb(metadata_.GetPartitionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_partition(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_partitions_rest_bad_request(request_type=metadata_.ListPartitionsRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_partitions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_list_partitions") as post, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "post_list_partitions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_list_partitions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = metadata_.ListPartitionsRequest.pb(metadata_.ListPartitionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = metadata_.ListPartitionsResponse.to_json(metadata_.ListPartitionsResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = metadata_.ListPartitionsResponse()
        post_with_metadata.return_value = metadata_.ListPartitionsResponse(), metadata

        client.list_partitions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_entity_empty_call_rest():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_entity_empty_call_rest():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_entity_empty_call_rest():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_entity_empty_call_rest():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_entities_empty_call_rest():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_partition_empty_call_rest():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_partition_empty_call_rest():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_partition_empty_call_rest():
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_metadata_service_client_transport_session_collision(transport_name):
    ...
    session1 = client1.transport.create_entity._session
    session2 = client2.transport.create_entity._session
    assert session1 != session2
    session1 = client1.transport.update_entity._session
    session2 = client2.transport.update_entity._session
    assert session1 != session2
    session1 = client1.transport.delete_entity._session
    session2 = client2.transport.delete_entity._session
    assert session1 != session2
    session1 = client1.transport.get_entity._session
    session2 = client2.transport.get_entity._session
    assert session1 != session2
    session1 = client1.transport.list_entities._session
    session2 = client2.transport.list_entities._session
    assert session1 != session2
    session1 = client1.transport.create_partition._session
    session2 = client2.transport.create_partition._session
    assert session1 != session2
    session1 = client1.transport.delete_partition._session
    session2 = client2.transport.delete_partition._session
    assert session1 != session2
    session1 = client1.transport.get_partition._session
    session2 = client2.transport.get_partition._session
    assert session1 != session2

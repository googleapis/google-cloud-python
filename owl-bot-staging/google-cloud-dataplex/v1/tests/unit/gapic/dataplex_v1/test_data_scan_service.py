...
from google.cloud.dataplex_v1.services.data_scan_service import DataScanServiceAsyncClient
from google.cloud.dataplex_v1.services.data_scan_service import DataScanServiceClient
from google.cloud.dataplex_v1.services.data_scan_service import pagers
from google.cloud.dataplex_v1.services.data_scan_service import transports
from google.cloud.dataplex_v1.types import data_discovery
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert DataScanServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert DataScanServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert DataScanServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert DataScanServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert DataScanServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert DataScanServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert DataScanServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert DataScanServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(DataScanServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataScanServiceClient))
@mock.patch.object(DataScanServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataScanServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DataScanServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DataScanServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = DataScanServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert DataScanServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert DataScanServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DataScanServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DataScanServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert DataScanServiceClient._get_api_endpoint(None, None, default_universe, "always") == DataScanServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DataScanServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DataScanServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DataScanServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert DataScanServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        DataScanServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert DataScanServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert DataScanServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert DataScanServiceClient._get_universe_domain(None, None) == DataScanServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (DataScanServiceAsyncClient, transports.DataScanServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (DataScanServiceClient, transports.DataScanServiceGrpcTransport, "grpc", "true"),
    (DataScanServiceAsyncClient, transports.DataScanServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (DataScanServiceClient, transports.DataScanServiceGrpcTransport, "grpc", "false"),
    (DataScanServiceAsyncClient, transports.DataScanServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (DataScanServiceClient, transports.DataScanServiceRestTransport, "rest", "true"),
    (DataScanServiceClient, transports.DataScanServiceRestTransport, "rest", "false"),
])
@mock.patch.object(DataScanServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataScanServiceClient))
@mock.patch.object(DataScanServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataScanServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    DataScanServiceClient, DataScanServiceAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (DataScanServiceClient, transports.DataScanServiceGrpcTransport, "grpc", grpc_helpers),
    (DataScanServiceAsyncClient, transports.DataScanServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_create_data_scan(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_data_scan),
            '__call__') as call:
...
def test_create_data_scan_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_data_scan] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_data_scan_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_data_scan in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_data_scan] = mock_rpc
...
def test_update_data_scan(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_data_scan),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_data_scan_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_data_scan] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_data_scan_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataScanServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_data_scan in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_data_scan] = mock_rpc
...
def test_delete_data_scan(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_data_scan),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_data_scan_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_data_scan] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_data_scan_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataScanServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_data_scan in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_data_scan] = mock_rpc
...
def test_get_data_scan(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_scan),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_data_scan_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataScanServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_data_scan in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_data_scan] = mock_rpc
...
def test_list_data_scans(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_data_scans),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_data_scans_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataScanServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_data_scans in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_data_scans] = mock_rpc
...
def test_list_data_scans_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, datascans.DataScan)
                   for i in results)
...
def test_run_data_scan(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.run_data_scan),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_run_data_scan_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataScanServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.run_data_scan in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.run_data_scan] = mock_rpc
...
def test_get_data_scan_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_scan_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_data_scan_job_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_data_scan_job] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_data_scan_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataScanServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_data_scan_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_data_scan_job] = mock_rpc
...
def test_list_data_scan_jobs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_data_scan_jobs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_data_scan_jobs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_data_scan_jobs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataScanServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_data_scan_jobs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_data_scan_jobs] = mock_rpc
...
def test_list_data_scan_jobs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, datascans.DataScanJob)
                   for i in results)
...
def test_generate_data_quality_rules(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_data_quality_rules),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_generate_data_quality_rules_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.generate_data_quality_rules in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_data_quality_rules] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_data_quality_rules_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataScanServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_data_quality_rules in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_data_quality_rules] = mock_rpc
...
@pytest.mark.asyncio
async def test_generate_data_quality_rules_async(transport: str = 'grpc_asyncio', request_type=datascans.GenerateDataQualityRulesRequest):
    client = DataScanServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(datascans.GenerateDataQualityRulesResponse(
        ))
...
def test_create_data_scan_rest_required_fields(request_type=datascans.CreateDataScanRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_data_scan._get_unset_required_fields(jsonified_request)
    ...
    assert not set(unset_fields) - set(("data_scan_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_data_scan_rest_unset_required_fields():
    transport = transports.DataScanServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_data_scan._get_unset_required_fields({})
    assert set(unset_fields) == (set(("dataScanId", "validateOnly", )) & set(("parent", "dataScan", "dataScanId", )))
...
def test_create_data_scan_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/dataScans" % client.transport._host, args[1])
...
def test_update_data_scan_rest_required_fields(request_type=datascans.UpdateDataScanRequest):
    transport_class = transports.DataScanServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_data_scan._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_data_scan_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("dataScan", )))
...
def test_update_data_scan_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'data_scan': {'name': 'projects/sample1/locations/sample2/dataScans/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{data_scan.name=projects/*/locations/*/dataScans/*}" % client.transport._host, args[1])
...
def test_delete_data_scan_rest_required_fields(request_type=datascans.DeleteDataScanRequest):
    transport_class = transports.DataScanServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_data_scan._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_data_scan_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/dataScans/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/dataScans/*}" % client.transport._host, args[1])
...
def test_get_data_scan_rest_required_fields(request_type=datascans.GetDataScanRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_data_scan._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_data_scans_rest_required_fields(request_type=datascans.ListDataScansRequest):
    transport_class = transports.DataScanServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_data_scans._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_run_data_scan_rest_required_fields(request_type=datascans.RunDataScanRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).run_data_scan._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_run_data_scan_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/dataScans/*}:run" % client.transport._host, args[1])
...
def test_get_data_scan_job_rest_required_fields(request_type=datascans.GetDataScanJobRequest):
    transport_class = transports.DataScanServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_data_scan_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_data_scan_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/dataScans/sample3/jobs/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/dataScans/*/jobs/*}" % client.transport._host, args[1])
...
def test_list_data_scan_jobs_rest_required_fields(request_type=datascans.ListDataScanJobsRequest):
    transport_class = transports.DataScanServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_data_scan_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_data_scan_jobs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/dataScans/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/dataScans/*}/jobs" % client.transport._host, args[1])
...
def test_list_data_scan_jobs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(datascans.ListDataScanJobsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_generate_data_quality_rules_rest_required_fields(request_type=datascans.GenerateDataQualityRulesRequest):
    transport_class = transports.DataScanServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_data_quality_rules._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_data_quality_rules_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/dataScans/*}:generateDataQualityRules" % client.transport._host, args[1])
...
def test_create_data_scan_rest_bad_request(request_type=datascans.CreateDataScanRequest):
    client = DataScanServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_data_scan_rest_interceptors(null_interceptor):
    transport = transports.DataScanServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DataScanServiceRestInterceptor(),
        )
    client = DataScanServiceClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_create_data_scan") as post, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_create_data_scan_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "pre_create_data_scan") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = datascans.CreateDataScanRequest.pb(datascans.CreateDataScanRequest())
        ...
        client.create_data_scan(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_data_scan_rest_bad_request(request_type=datascans.UpdateDataScanRequest):
    client = DataScanServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'data_scan': {'name': 'projects/sample1/locations/sample2/dataScans/sample3'}}
    request = request_type(**request_init)
...
def test_update_data_scan_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'data_scan': {'name': 'projects/sample1/locations/sample2/dataScans/sample3'}}
    request_init["data_scan"] = {'name': 'projects/sample1/locations/sample2/dataScans/sample3', 'uid': 'uid_value', 'description': 'description_value', 'display_name': 'display_name_value', 'labels': {}, 'state': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'data': {'entity': 'entity_value', 'resource': 'resource_value'}, 'execution_spec': {'trigger': {'on_demand': {}, 'schedule': {'cron': 'cron_value'}}, 'field': 'field_value'}, 'execution_status': {'latest_job_start_time': {}, 'latest_job_end_time': {}, 'latest_job_create_time': {}}, 'type_': 1, 'data_quality_spec': {'rules': [{'range_expectation': {'min_value': 'min_value_value', 'max_value': 'max_value_value', 'strict_min_enabled': True, 'strict_max_enabled': True}, 'non_null_expectation': {}, 'set_expectation': {'values': ['values_value1', 'values_value2']}, 'regex_expectation': {'regex': 'regex_value'}, 'uniqueness_expectation': {}, 'statistic_range_expectation': {'statistic': 1, 'min_value': 'min_value_value', 'max_value': 'max_value_value', 'strict_min_enabled': True, 'strict_max_enabled': True}, 'row_condition_expectation': {'sql_expression': 'sql_expression_value'}, 'table_condition_expectation': {'sql_expression': 'sql_expression_value'}, 'sql_assertion': {'sql_statement': 'sql_statement_value'}, 'column': 'column_value', 'ignore_null': True, 'dimension': 'dimension_value', 'threshold': 0.973, 'name': 'name_value', 'description': 'description_value', 'suspended': True}], 'sampling_percent': 0.17070000000000002, 'row_filter': 'row_filter_value', 'post_scan_actions': {'bigquery_export': {'results_table': 'results_table_value'}, 'notification_report': {'recipients': {'emails': ['emails_value1', 'emails_value2']}, 'score_threshold_trigger': {'score_threshold': 0.1608}, 'job_failure_trigger': {}, 'job_end_trigger': {}}}}, 'data_profile_spec': {'sampling_percent': 0.17070000000000002, 'row_filter': 'row_filter_value', 'post_scan_actions': {'bigquery_export': {'results_table': 'results_table_value'}}, 'include_fields': {'field_names': ['field_names_value1', 'field_names_value2']}, 'exclude_fields': {}}, 'data_discovery_spec': {'bigquery_publishing_config': {'table_type': 1, 'connection': 'connection_value', 'location': 'location_value'}, 'storage_config': {'include_patterns': ['include_patterns_value1', 'include_patterns_value2'], 'exclude_patterns': ['exclude_patterns_value1', 'exclude_patterns_value2'], 'csv_options': {'header_rows': 1171, 'delimiter': 'delimiter_value', 'encoding': 'encoding_value', 'type_inference_disabled': True, 'quote': 'quote_value'}, 'json_options': {'encoding': 'encoding_value', 'type_inference_disabled': True}}}, 'data_quality_result': {'passed': True, 'score': 0.54, 'dimensions': [{'dimension': {'name': 'name_value'}, 'passed': True, 'score': 0.54}], 'columns': [{'column': 'column_value', 'score': 0.54}], 'rules': [{'rule': {}, 'passed': True, 'evaluated_count': 1603, 'passed_count': 1288, 'null_count': 1091, 'pass_ratio': 0.1077, 'failing_rows_query': 'failing_rows_query_value', 'assertion_row_count': 2071}], 'row_count': 992, 'scanned_data': {'incremental_field': {'field': 'field_value', 'start': 'start_value', 'end': 'end_value'}}, 'post_scan_actions_result': {'bigquery_export_result': {'state': 1, 'message': 'message_value'}}}, 'data_profile_result': {'row_count': 992, 'profile': {'fields': [{'name': 'name_value', 'type_': 'type__value', 'mode': 'mode_value', 'profile': {'null_ratio': 0.1081, 'distinct_ratio': 0.1504, 'top_n_values': [{'value': 'value_value', 'count': 553, 'ratio': 0.543}], 'string_profile': {'min_length': 1061, 'max_length': 1063, 'average_length': 0.1468}, 'integer_profile': {'average': 0.731, 'standard_deviation': 0.1907, 'min_': 419, 'quartiles': [987, 988], 'max_': 421}, 'double_profile': {'average': 0.731, 'standard_deviation': 0.1907, 'min_': 0.419, 'quartiles': [0.987, 0.988], 'max_': 0.421}}}]}, 'scanned_data': {}, 'post_scan_actions_result': {'bigquery_export_result': {'state': 1, 'message': 'message_value'}}}, 'data_discovery_result': {'bigquery_publishing': {'dataset': 'dataset_value', 'location': 'location_value'}, 'scan_statistics': {'scanned_file_count': 1891, 'data_processed_bytes': 2119, 'files_excluded': 1472, 'tables_created': 1458, 'tables_deleted': 1457, 'tables_updated': 1473, 'filesets_created': 1686, 'filesets_deleted': 1685, 'filesets_updated': 1701}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_data_scan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_update_data_scan") as post, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_update_data_scan_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "pre_update_data_scan") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = datascans.UpdateDataScanRequest.pb(datascans.UpdateDataScanRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_data_scan(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_data_scan_rest_bad_request(request_type=datascans.DeleteDataScanRequest):
    client = DataScanServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_data_scan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_delete_data_scan") as post, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_delete_data_scan_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "pre_delete_data_scan") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = datascans.DeleteDataScanRequest.pb(datascans.DeleteDataScanRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_data_scan(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_data_scan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_get_data_scan") as post, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_get_data_scan_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "pre_get_data_scan") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_data_scan(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_data_scans_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_list_data_scans") as post, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_list_data_scans_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "pre_list_data_scans") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = datascans.ListDataScansResponse.to_json(datascans.ListDataScansResponse())
        req.return_value.content = return_value
        ...
        client.list_data_scans(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_run_data_scan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_run_data_scan") as post, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_run_data_scan_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "pre_run_data_scan") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = datascans.RunDataScanResponse.to_json(datascans.RunDataScanResponse())
        req.return_value.content = return_value
        ...
        client.run_data_scan(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_data_scan_job_rest_bad_request(request_type=datascans.GetDataScanJobRequest):
    client = DataScanServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/dataScans/sample3/jobs/sample4'}
    request = request_type(**request_init)
...
def test_get_data_scan_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_get_data_scan_job") as post, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_get_data_scan_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "pre_get_data_scan_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = datascans.GetDataScanJobRequest.pb(datascans.GetDataScanJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_data_scan_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_data_scan_jobs_rest_bad_request(request_type=datascans.ListDataScanJobsRequest):
    client = DataScanServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_data_scan_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_list_data_scan_jobs") as post, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_list_data_scan_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "pre_list_data_scan_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = datascans.ListDataScanJobsRequest.pb(datascans.ListDataScanJobsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = datascans.ListDataScanJobsResponse.to_json(datascans.ListDataScanJobsResponse())
        req.return_value.content = return_value
        ...
        client.list_data_scan_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_generate_data_quality_rules_rest_bad_request(request_type=datascans.GenerateDataQualityRulesRequest):
    client = DataScanServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_data_quality_rules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_generate_data_quality_rules") as post, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "post_generate_data_quality_rules_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataScanServiceRestInterceptor, "pre_generate_data_quality_rules") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = datascans.GenerateDataQualityRulesRequest.pb(datascans.GenerateDataQualityRulesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = datascans.GenerateDataQualityRulesResponse.to_json(datascans.GenerateDataQualityRulesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = datascans.GenerateDataQualityRulesResponse(), metadata

        client.generate_data_quality_rules(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_data_scan_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DataScanServiceGrpcTransport, transports.DataScanServiceGrpcAsyncIOTransport])
def test_data_scan_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

...
from google.cloud.dataplex_v1.services.data_taxonomy_service import DataTaxonomyServiceAsyncClient
...
from google.cloud.dataplex_v1.services.data_taxonomy_service import transports
...
def test__get_api_endpoint():
    ...
    assert DataTaxonomyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DataTaxonomyServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert DataTaxonomyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DataTaxonomyServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    DataTaxonomyServiceClient, DataTaxonomyServiceAsyncClient
])
...
def test_create_data_taxonomy(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_data_taxonomy),
            '__call__') as call:
...
def test_update_data_taxonomy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_data_taxonomy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_data_taxonomy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_data_taxonomy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_data_taxonomies_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, data_taxonomy.DataTaxonomy)
                   for i in results)
...
def test_get_data_taxonomy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_taxonomy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_data_attribute_binding(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_data_attribute_binding),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_data_attribute_binding(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_data_attribute_binding),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_data_attribute_binding(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_data_attribute_binding),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_data_attribute_bindings_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, data_taxonomy.DataAttributeBinding)
                   for i in results)
...
def test_get_data_attribute_binding(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_attribute_binding),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_data_attribute(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_data_attribute),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_data_attribute(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_data_attribute),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_data_attribute(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_data_attribute),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_data_attributes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, data_taxonomy.DataAttribute)
                   for i in results)
...
def test_get_data_attribute(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_attribute),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_data_taxonomy_rest_required_fields(request_type=gcd_data_taxonomy.CreateDataTaxonomyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_data_taxonomy._get_unset_required_fields(jsonified_request)
    ...
    assert not set(unset_fields) - set(("data_taxonomy_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_data_taxonomy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("dataTaxonomyId", "validateOnly", )) & set(("parent", "dataTaxonomyId", "dataTaxonomy", )))
...
def test_update_data_taxonomy_rest_required_fields(request_type=gcd_data_taxonomy.UpdateDataTaxonomyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_data_taxonomy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_data_taxonomy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("updateMask", "dataTaxonomy", )))
...
def test_delete_data_taxonomy_rest_required_fields(request_type=data_taxonomy.DeleteDataTaxonomyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_data_taxonomy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_data_taxonomies_rest_required_fields(request_type=data_taxonomy.ListDataTaxonomiesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_data_taxonomies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_data_attribute_binding_rest_required_fields(request_type=data_taxonomy.CreateDataAttributeBindingRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_data_attribute_binding._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_data_attribute_binding._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("data_attribute_binding_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_data_attribute_binding_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("dataAttributeBindingId", "validateOnly", )) & set(("parent", "dataAttributeBindingId", "dataAttributeBinding", )))
...
def test_update_data_attribute_binding_rest_required_fields(request_type=data_taxonomy.UpdateDataAttributeBindingRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_data_attribute_binding._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_data_attribute_binding_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("updateMask", "dataAttributeBinding", )))
...
def test_update_data_attribute_binding_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{data_attribute_binding.name=projects/*/locations/*/dataAttributeBindings/*}" % client.transport._host, args[1])
...
def test_delete_data_attribute_binding_rest_required_fields(request_type=data_taxonomy.DeleteDataAttributeBindingRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_data_attribute_binding._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_data_attribute_bindings_rest_required_fields(request_type=data_taxonomy.ListDataAttributeBindingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_data_attribute_bindings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_data_attribute_binding_rest_required_fields(request_type=data_taxonomy.GetDataAttributeBindingRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_data_attribute_binding._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_data_attribute_rest_required_fields(request_type=data_taxonomy.CreateDataAttributeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_data_attribute._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_data_attribute._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("data_attribute_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_data_attribute_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("dataAttributeId", "validateOnly", )) & set(("parent", "dataAttributeId", "dataAttribute", )))
...
def test_update_data_attribute_rest_required_fields(request_type=data_taxonomy.UpdateDataAttributeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_data_attribute._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_data_attribute_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("updateMask", "dataAttribute", )))
...
def test_update_data_attribute_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{data_attribute.name=projects/*/locations/*/dataTaxonomies/*/attributes/*}" % client.transport._host, args[1])
...
def test_delete_data_attribute_rest_required_fields(request_type=data_taxonomy.DeleteDataAttributeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_data_attribute._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_data_attributes_rest_required_fields(request_type=data_taxonomy.ListDataAttributesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_data_attributes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_data_taxonomy_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["data_taxonomy"] = {'name': 'name_value', 'uid': 'uid_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'display_name': 'display_name_value', 'labels': {}, 'attribute_count': 1628, 'etag': 'etag_value', 'class_count': 1182}
...
def test_create_data_taxonomy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_create_data_taxonomy") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_create_data_taxonomy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_create_data_taxonomy") as pre:
        ...
        client.create_data_taxonomy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_data_taxonomy_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'data_taxonomy': {'name': 'projects/sample1/locations/sample2/dataTaxonomies/sample3'}}
    request_init["data_taxonomy"] = {'name': 'projects/sample1/locations/sample2/dataTaxonomies/sample3', 'uid': 'uid_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'display_name': 'display_name_value', 'labels': {}, 'attribute_count': 1628, 'etag': 'etag_value', 'class_count': 1182}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_data_taxonomy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_update_data_taxonomy") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_update_data_taxonomy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_update_data_taxonomy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_data_taxonomy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_data_taxonomy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_delete_data_taxonomy") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_delete_data_taxonomy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_delete_data_taxonomy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_data_taxonomy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_data_taxonomies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_list_data_taxonomies") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_list_data_taxonomies_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_list_data_taxonomies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_data_taxonomies(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_data_taxonomy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_get_data_taxonomy") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_get_data_taxonomy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_get_data_taxonomy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_data_taxonomy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_data_attribute_binding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_create_data_attribute_binding") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_create_data_attribute_binding_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_create_data_attribute_binding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_data_attribute_binding(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_data_attribute_binding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_update_data_attribute_binding") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_update_data_attribute_binding_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_update_data_attribute_binding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_data_attribute_binding(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_data_attribute_binding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_delete_data_attribute_binding") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_delete_data_attribute_binding_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_delete_data_attribute_binding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_data_attribute_binding(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_data_attribute_bindings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_list_data_attribute_bindings") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_list_data_attribute_bindings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_list_data_attribute_bindings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_data_attribute_bindings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_data_attribute_binding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_get_data_attribute_binding") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_get_data_attribute_binding_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_get_data_attribute_binding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_data_attribute_binding(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_data_attribute_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_create_data_attribute") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_create_data_attribute_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_create_data_attribute") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_data_attribute(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_data_attribute_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_update_data_attribute") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_update_data_attribute_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_update_data_attribute") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_data_attribute(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_data_attribute_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_delete_data_attribute") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_delete_data_attribute_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_delete_data_attribute") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_data_attribute(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_data_attributes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_list_data_attributes") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_list_data_attributes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_list_data_attributes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_data_attributes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_data_attribute_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_get_data_attribute") as post, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "post_get_data_attribute_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataTaxonomyServiceRestInterceptor, "pre_get_data_attribute") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_data_attribute(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DataTaxonomyServiceGrpcTransport, transports.DataTaxonomyServiceGrpcAsyncIOTransport])
def test_data_taxonomy_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

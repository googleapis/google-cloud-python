...
from google.cloud.dataplex_v1.services.business_glossary_service import BusinessGlossaryServiceAsyncClient
from google.cloud.dataplex_v1.services.business_glossary_service import BusinessGlossaryServiceClient
from google.cloud.dataplex_v1.services.business_glossary_service import pagers
from google.cloud.dataplex_v1.services.business_glossary_service import transports
...
def test__get_api_endpoint():
    ...
    assert BusinessGlossaryServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BusinessGlossaryServiceClient.DEFAULT_MTLS_ENDPOINT
    assert BusinessGlossaryServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert BusinessGlossaryServiceClient._get_api_endpoint(None, None, default_universe, "always") == BusinessGlossaryServiceClient.DEFAULT_MTLS_ENDPOINT
    assert BusinessGlossaryServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BusinessGlossaryServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    BusinessGlossaryServiceClient, BusinessGlossaryServiceAsyncClient
])
...
def test_business_glossary_service_client_client_options_from_dict():
    with mock.patch('google.cloud.dataplex_v1.services.business_glossary_service.transports.BusinessGlossaryServiceGrpcTransport.__init__') as grpc_transport:
...
def test_update_glossary(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_glossary),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_glossaries_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, business_glossary.Glossary)
                   for i in results)
...
def test_create_glossary_category(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_glossary_category),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_glossary_category(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_glossary_category),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = business_glossary.GlossaryCategory(
            name='name_value',
...
def test_delete_glossary_category(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_glossary_category),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_glossary_categories_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, business_glossary.GlossaryCategory)
                   for i in results)
...
async def test_list_glossary_categories_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_glossary_categories(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_update_glossary_term(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_glossary_term),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = business_glossary.GlossaryTerm(
            name='name_value',
...
def test_delete_glossary_term(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_glossary_term),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_get_glossary_term(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_glossary_term),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = business_glossary.GlossaryTerm(
            name='name_value',
...
def test_list_glossary_terms_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, business_glossary.GlossaryTerm)
                   for i in results)
...
async def test_list_glossary_terms_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_glossary_terms(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_create_glossary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("glossaryId", "validateOnly", )) & set(("parent", "glossaryId", "glossary", )))
...
def test_update_glossary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("glossary", "updateMask", )))
...
def test_create_glossary_category_rest_required_fields(request_type=business_glossary.CreateGlossaryCategoryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_glossary_category._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_glossary_category_rest_required_fields(request_type=business_glossary.UpdateGlossaryCategoryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_glossary_category._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_glossary_category_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("category", "updateMask", )))
...
def test_delete_glossary_category_rest_required_fields(request_type=business_glossary.DeleteGlossaryCategoryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_glossary_category._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_glossary_category_rest_required_fields(request_type=business_glossary.GetGlossaryCategoryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_glossary_category._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_glossary_categories_rest_required_fields(request_type=business_glossary.ListGlossaryCategoriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_glossary_categories._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_glossary_term_rest_required_fields(request_type=business_glossary.CreateGlossaryTermRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_glossary_term._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_glossary_term_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("termId", )) & set(("parent", "termId", "term", )))
...
def test_update_glossary_term_rest_required_fields(request_type=business_glossary.UpdateGlossaryTermRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_glossary_term._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_glossary_term_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("term", "updateMask", )))
...
def test_delete_glossary_term_rest_required_fields(request_type=business_glossary.DeleteGlossaryTermRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_glossary_term._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_glossary_terms_rest_required_fields(request_type=business_glossary.ListGlossaryTermsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_glossary_terms._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_glossary_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["glossary"] = {'name': 'name_value', 'uid': 'uid_value', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'term_count': 1088, 'category_count': 1510, 'etag': 'etag_value'}
...
def test_create_glossary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_create_glossary") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_create_glossary_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_create_glossary") as pre:
...
def test_update_glossary_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'glossary': {'name': 'projects/sample1/locations/sample2/glossaries/sample3'}}
    request_init["glossary"] = {'name': 'projects/sample1/locations/sample2/glossaries/sample3', 'uid': 'uid_value', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'term_count': 1088, 'category_count': 1510, 'etag': 'etag_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_glossary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_update_glossary") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_update_glossary_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_update_glossary") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_glossary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_glossary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_delete_glossary") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_delete_glossary_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_delete_glossary") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_glossary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_get_glossary") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_get_glossary_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_get_glossary") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_glossaries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_list_glossaries") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_list_glossaries_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_list_glossaries") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_glossary_category_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/glossaries/sample3'}
    request_init["category"] = {'name': 'name_value', 'uid': 'uid_value', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'parent': 'parent_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_glossary_category_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_create_glossary_category") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_create_glossary_category_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_create_glossary_category") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_glossary_category(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_glossary_category_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'category': {'name': 'projects/sample1/locations/sample2/glossaries/sample3/categories/sample4'}}
    request_init["category"] = {'name': 'projects/sample1/locations/sample2/glossaries/sample3/categories/sample4', 'uid': 'uid_value', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'parent': 'parent_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_glossary_category_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_update_glossary_category") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_update_glossary_category_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_update_glossary_category") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_glossary_category(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_glossary_category_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_delete_glossary_category") as pre:
        pre.assert_not_called()
        ...
        client.delete_glossary_category(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_glossary_category_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_get_glossary_category") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_get_glossary_category_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_get_glossary_category") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_glossary_category(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_glossary_categories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_list_glossary_categories") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_list_glossary_categories_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_list_glossary_categories") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_glossary_categories(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_glossary_term_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/glossaries/sample3'}
    request_init["term"] = {'name': 'name_value', 'uid': 'uid_value', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'parent': 'parent_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_glossary_term_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_create_glossary_term") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_create_glossary_term_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_create_glossary_term") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_glossary_term(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_glossary_term_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'term': {'name': 'projects/sample1/locations/sample2/glossaries/sample3/terms/sample4'}}
    request_init["term"] = {'name': 'projects/sample1/locations/sample2/glossaries/sample3/terms/sample4', 'uid': 'uid_value', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'parent': 'parent_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_glossary_term_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_update_glossary_term") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_update_glossary_term_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_update_glossary_term") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_glossary_term(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_glossary_term_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_delete_glossary_term") as pre:
        pre.assert_not_called()
        ...
        client.delete_glossary_term(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_glossary_term_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_get_glossary_term") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_get_glossary_term_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_get_glossary_term") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_glossary_term(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_glossary_terms_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_list_glossary_terms") as post, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "post_list_glossary_terms_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BusinessGlossaryServiceRestInterceptor, "pre_list_glossary_terms") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_glossary_terms(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_business_glossary_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dataplex_v1.services.business_glossary_service.transports.BusinessGlossaryServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_business_glossary_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dataplex_v1.services.business_glossary_service.transports.BusinessGlossaryServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BusinessGlossaryServiceTransport()
        adc.assert_called_once()
...
def test_glossary_category_path():
    ...
    expected = "projects/{project}/locations/{location}/glossaries/{glossary}/categories/{glossary_category}".format(project=project, location=location, glossary=glossary, glossary_category=glossary_category, )
...
def test_glossary_term_path():
    ...
    expected = "projects/{project}/locations/{location}/glossaries/{glossary}/terms/{glossary_term}".format(project=project, location=location, glossary=glossary, glossary_term=glossary_term, )

...
class speechCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'delete_custom_class': ('name', 'validate_only', 'allow_missing', 'etag', ),
        ...
        'get_phrase_set': ('name', ),
        'get_recognizer': ('name', ),
        'list_custom_classes': ('parent', 'page_size', 'page_token', 'show_deleted', ),
        'list_phrase_sets': ('parent', 'page_size', 'page_token', 'show_deleted', ),
        'list_recognizers': ('parent', 'page_size', 'page_token', 'show_deleted', ),
        'recognize': ('recognizer', 'config', 'config_mask', 'content', 'uri', ),
        'streaming_recognize': ('recognizer', 'streaming_config', 'audio', ),
        'undelete_custom_class': ('name', 'validate_only', 'etag', ),
        'undelete_phrase_set': ('name', 'validate_only', 'etag', ),
        'undelete_recognizer': ('name', 'validate_only', 'etag', ),
        'update_config': ('config', 'update_mask', ),
        'update_custom_class': ('custom_class', 'update_mask', 'validate_only', ),
        'update_phrase_set': ('phrase_set', 'update_mask', 'validate_only', ),
        'update_recognizer': ('recognizer', 'update_mask', 'validate_only', ),
    }

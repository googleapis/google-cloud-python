...
class SpeechRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_long_running_recognize(self, request: cloud_speech.LongRunningRecognizeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloud_speech.LongRunningRecognizeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_long_running_recognize_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for long_running_recognize
...
class SpeechRestTransport(_BaseSpeechRestTransport):
    ...
    class _LongRunningRecognize(_BaseSpeechRestTransport._BaseLongRunningRecognize, SpeechRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SpeechRestTransport._LongRunningRecognize._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

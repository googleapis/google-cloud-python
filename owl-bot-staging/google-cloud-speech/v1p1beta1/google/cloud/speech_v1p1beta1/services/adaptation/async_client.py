...
class AdaptationAsyncClient:
    ...
    async def create_phrase_set(self,
    ...
    async def list_phrase_set(self,
    ...
    async def update_phrase_set(self,
    ...
    async def delete_phrase_set(self,
    ...
    async def create_custom_class(self,
    ...
    async def get_custom_class(self,
    ...
    async def list_custom_classes(self,
    ...
    async def update_custom_class(self,
    ...
    async def delete_custom_class(self,

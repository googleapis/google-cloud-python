    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_phrase_set] = mock_object
...
def test_create_phrase_set_rest_bad_request(transport: str = 'rest', request_type=cloud_speech_adaptation.CreatePhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_phrase_set_rest_bad_request(transport: str = 'rest', request_type=cloud_speech_adaptation.GetPhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_phrase_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_speech_adaptation.ListPhraseSetResponse.to_json(cloud_speech_adaptation.ListPhraseSetResponse())
...
def test_list_phrase_set_rest_bad_request(transport: str = 'rest', request_type=cloud_speech_adaptation.ListPhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_phrase_set_rest_bad_request(transport: str = 'rest', request_type=cloud_speech_adaptation.UpdatePhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_phrase_set_rest_bad_request(transport: str = 'rest', request_type=cloud_speech_adaptation.DeletePhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_custom_class_rest_bad_request(transport: str = 'rest', request_type=cloud_speech_adaptation.CreateCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_custom_class_rest_bad_request(transport: str = 'rest', request_type=cloud_speech_adaptation.GetCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_custom_classes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_speech_adaptation.ListCustomClassesResponse.to_json(cloud_speech_adaptation.ListCustomClassesResponse())
...
def test_list_custom_classes_rest_bad_request(transport: str = 'rest', request_type=cloud_speech_adaptation.ListCustomClassesRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_custom_class_rest_bad_request(transport: str = 'rest', request_type=cloud_speech_adaptation.UpdateCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_custom_class_rest_bad_request(transport: str = 'rest', request_type=cloud_speech_adaptation.DeleteCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

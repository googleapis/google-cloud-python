...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert AdaptationClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert AdaptationClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AdaptationClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert AdaptationClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AdaptationClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(AdaptationClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdaptationClient))
@mock.patch.object(AdaptationAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdaptationAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AdaptationClient._DEFAULT_UNIVERSE
    default_endpoint = AdaptationClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AdaptationClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AdaptationClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert AdaptationClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AdaptationClient.DEFAULT_MTLS_ENDPOINT
    assert AdaptationClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AdaptationClient._get_api_endpoint(None, None, default_universe, "always") == AdaptationClient.DEFAULT_MTLS_ENDPOINT
    assert AdaptationClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AdaptationClient.DEFAULT_MTLS_ENDPOINT
    assert AdaptationClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AdaptationClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AdaptationClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AdaptationClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AdaptationClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AdaptationClient._get_universe_domain(None, None) == AdaptationClient._DEFAULT_UNIVERSE
...
def test_adaptation_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class", [
    AdaptationClient, AdaptationAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (AdaptationAsyncClient, transports.AdaptationGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (AdaptationClient, transports.AdaptationRestTransport, "rest", None),
])
def test_adaptation_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_adaptation_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_list_phrase_set_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AdaptationAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_phrase_set in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_phrase_set] = mock_rpc
...
def test_create_phrase_set_rest_required_fields(request_type=cloud_speech_adaptation.CreatePhraseSetRequest):
...
def test_create_phrase_set_rest_unset_required_fields():
    transport = transports.AdaptationRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_phrase_set._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "phraseSetId", "phraseSet", )))
...
def test_create_phrase_set_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1p1beta1/{parent=projects/*/locations/*}/phraseSets" % client.transport._host, args[1])
...
def test_get_phrase_set_rest_required_fields(request_type=cloud_speech_adaptation.GetPhraseSetRequest):
    transport_class = transports.AdaptationRestTransport
...
def test_get_phrase_set_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1p1beta1/{name=projects/*/locations/*/phraseSets/*}" % client.transport._host, args[1])
...
def test_list_phrase_set_rest_required_fields(request_type=cloud_speech_adaptation.ListPhraseSetRequest):
    transport_class = transports.AdaptationRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_phrase_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_phrase_set_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(cloud_speech_adaptation.ListPhraseSetResponse.to_json(x) for x in response)
...
def test_update_phrase_set_rest_required_fields(request_type=cloud_speech_adaptation.UpdatePhraseSetRequest):
    transport_class = transports.AdaptationRestTransport
...
def test_update_phrase_set_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1p1beta1/{phrase_set.name=projects/*/locations/*/phraseSets/*}" % client.transport._host, args[1])
...
def test_delete_phrase_set_rest_required_fields(request_type=cloud_speech_adaptation.DeletePhraseSetRequest):
    transport_class = transports.AdaptationRestTransport
...
def test_create_custom_class_rest_required_fields(request_type=cloud_speech_adaptation.CreateCustomClassRequest):
    transport_class = transports.AdaptationRestTransport
...
def test_create_custom_class_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "customClassId", "customClass", )))
...
def test_create_custom_class_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1p1beta1/{parent=projects/*/locations/*}/customClasses" % client.transport._host, args[1])
...
def test_get_custom_class_rest_required_fields(request_type=cloud_speech_adaptation.GetCustomClassRequest):
    transport_class = transports.AdaptationRestTransport
...
def test_get_custom_class_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1p1beta1/{name=projects/*/locations/*/customClasses/*}" % client.transport._host, args[1])
...
def test_list_custom_classes_rest_required_fields(request_type=cloud_speech_adaptation.ListCustomClassesRequest):
    transport_class = transports.AdaptationRestTransport
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = cloud_speech_adaptation.ListCustomClassesResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_custom_classes_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(cloud_speech_adaptation.ListCustomClassesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_update_custom_class_rest_required_fields(request_type=cloud_speech_adaptation.UpdateCustomClassRequest):
    transport_class = transports.AdaptationRestTransport
...
def test_update_custom_class_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1p1beta1/{custom_class.name=projects/*/locations/*/customClasses/*}" % client.transport._host, args[1])
...
def test_delete_custom_class_rest_required_fields(request_type=cloud_speech_adaptation.DeleteCustomClassRequest):
    transport_class = transports.AdaptationRestTransport
...
def test_get_phrase_set_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_speech_adaptation.GetPhraseSetRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_phrase_set_empty_call_grpc():
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = cloud_speech_adaptation.ListPhraseSetResponse()
        client.list_phrase_set(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_speech_adaptation.ListPhraseSetRequest()
...
def test_update_phrase_set_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_speech_adaptation.UpdatePhraseSetRequest()
...
def test_delete_phrase_set_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_speech_adaptation.DeletePhraseSetRequest()
...
def test_create_custom_class_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_speech_adaptation.CreateCustomClassRequest()
...
def test_get_custom_class_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_speech_adaptation.GetCustomClassRequest()
...
def test_list_custom_classes_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_speech_adaptation.ListCustomClassesRequest()
...
def test_update_custom_class_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_speech_adaptation.UpdateCustomClassRequest()
...
def test_transport_kind_grpc_asyncio():
    transport = AdaptationAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_phrase_set_empty_call_grpc_asyncio():
    client = AdaptationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_phrase_set(request=None)
...
def test_transport_kind_rest():
    transport = AdaptationClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_phrase_set_rest_bad_request(request_type=cloud_speech_adaptation.CreatePhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_phrase_set_rest_interceptors(null_interceptor):
    transport = transports.AdaptationRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.AdaptationRestInterceptor(),
        )
    client = AdaptationClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_create_phrase_set") as post, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_create_phrase_set_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdaptationRestInterceptor, "pre_create_phrase_set") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_speech_adaptation.CreatePhraseSetRequest.pb(cloud_speech_adaptation.CreatePhraseSetRequest())
...
def test_get_phrase_set_rest_bad_request(request_type=cloud_speech_adaptation.GetPhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_phrase_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_get_phrase_set") as post, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_get_phrase_set_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdaptationRestInterceptor, "pre_get_phrase_set") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_speech_adaptation.GetPhraseSetRequest.pb(cloud_speech_adaptation.GetPhraseSetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_phrase_set_rest_bad_request(request_type=cloud_speech_adaptation.ListPhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_phrase_set_rest_call_success(request_type):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_phrase_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_list_phrase_set") as post, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_list_phrase_set_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdaptationRestInterceptor, "pre_list_phrase_set") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_speech_adaptation.ListPhraseSetRequest.pb(cloud_speech_adaptation.ListPhraseSetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_speech_adaptation.ListPhraseSetResponse.to_json(cloud_speech_adaptation.ListPhraseSetResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = cloud_speech_adaptation.ListPhraseSetResponse(), metadata

        client.list_phrase_set(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_phrase_set_rest_bad_request(request_type=cloud_speech_adaptation.UpdatePhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_phrase_set_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'phrase_set': {'name': 'projects/sample1/locations/sample2/phraseSets/sample3'}}
    request_init["phrase_set"] = {'name': 'projects/sample1/locations/sample2/phraseSets/sample3', 'phrases': [{'value': 'value_value', 'boost': 0.551}], 'boost': 0.551, 'kms_key_name': 'kms_key_name_value', 'kms_key_version_name': 'kms_key_version_name_value', 'uid': 'uid_value', 'display_name': 'display_name_value', 'state': 2, 'delete_time': {'seconds': 751, 'nanos': 543}, 'expire_time': {}, 'annotations': {}, 'etag': 'etag_value', 'reconciling': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = cloud_speech_adaptation.UpdatePhraseSetRequest.meta.fields["phrase_set"]
...
def test_update_phrase_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_update_phrase_set") as post, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_update_phrase_set_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdaptationRestInterceptor, "pre_update_phrase_set") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_speech_adaptation.UpdatePhraseSetRequest.pb(cloud_speech_adaptation.UpdatePhraseSetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_phrase_set_rest_bad_request(request_type=cloud_speech_adaptation.DeletePhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_phrase_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdaptationRestInterceptor, "pre_delete_phrase_set") as pre:
        pre.assert_not_called()
        pb_message = cloud_speech_adaptation.DeletePhraseSetRequest.pb(cloud_speech_adaptation.DeletePhraseSetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_custom_class_rest_bad_request(request_type=cloud_speech_adaptation.CreateCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_custom_class_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_create_custom_class") as post, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_create_custom_class_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdaptationRestInterceptor, "pre_create_custom_class") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_speech_adaptation.CreateCustomClassRequest.pb(cloud_speech_adaptation.CreateCustomClassRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_custom_class_rest_bad_request(request_type=cloud_speech_adaptation.GetCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_custom_class_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_get_custom_class") as post, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_get_custom_class_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdaptationRestInterceptor, "pre_get_custom_class") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_speech_adaptation.GetCustomClassRequest.pb(cloud_speech_adaptation.GetCustomClassRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_custom_classes_rest_bad_request(request_type=cloud_speech_adaptation.ListCustomClassesRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_custom_classes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_list_custom_classes") as post, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_list_custom_classes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdaptationRestInterceptor, "pre_list_custom_classes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_speech_adaptation.ListCustomClassesRequest.pb(cloud_speech_adaptation.ListCustomClassesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_speech_adaptation.ListCustomClassesResponse.to_json(cloud_speech_adaptation.ListCustomClassesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = cloud_speech_adaptation.ListCustomClassesResponse(), metadata
...
def test_update_custom_class_rest_bad_request(request_type=cloud_speech_adaptation.UpdateCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_custom_class_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'custom_class': {'name': 'projects/sample1/locations/sample2/customClasses/sample3'}}
    request_init["custom_class"] = {'name': 'projects/sample1/locations/sample2/customClasses/sample3', 'custom_class_id': 'custom_class_id_value', 'items': [{'value': 'value_value'}], 'kms_key_name': 'kms_key_name_value', 'kms_key_version_name': 'kms_key_version_name_value', 'uid': 'uid_value', 'display_name': 'display_name_value', 'state': 2, 'delete_time': {'seconds': 751, 'nanos': 543}, 'expire_time': {}, 'annotations': {}, 'etag': 'etag_value', 'reconciling': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = cloud_speech_adaptation.UpdateCustomClassRequest.meta.fields["custom_class"]
...
def test_update_custom_class_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_update_custom_class") as post, \
        mock.patch.object(transports.AdaptationRestInterceptor, "post_update_custom_class_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AdaptationRestInterceptor, "pre_update_custom_class") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_speech_adaptation.UpdateCustomClassRequest.pb(cloud_speech_adaptation.UpdateCustomClassRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_custom_class_rest_bad_request(request_type=cloud_speech_adaptation.DeleteCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_custom_class_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AdaptationRestInterceptor, "pre_delete_custom_class") as pre:
        pre.assert_not_called()
        pb_message = cloud_speech_adaptation.DeleteCustomClassRequest.pb(cloud_speech_adaptation.DeleteCustomClassRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_phrase_set_empty_call_rest():
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_crypto_key_version_path():
    ...
    actual = AdaptationClient.crypto_key_version_path(project, location, key_ring, crypto_key, crypto_key_version)
    assert expected == actual

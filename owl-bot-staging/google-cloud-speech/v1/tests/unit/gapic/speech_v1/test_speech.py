...
def test_recognize_rest_required_fields(request_type=cloud_speech.RecognizeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).recognize._get_unset_required_fields(jsonified_request)
...
def test_long_running_recognize_rest_required_fields(request_type=cloud_speech.LongRunningRecognizeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).long_running_recognize._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
from .base import WorkflowsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class WorkflowsRestTransport(WorkflowsTransport):
    """REST backend transport for Workflows.
    ...
    class _CreateWorkflow(WorkflowsRestStub):
        def __hash__(self):
    ...
    class _DeleteWorkflow(WorkflowsRestStub):
        def __hash__(self):
    ...
    class _GetWorkflow(WorkflowsRestStub):
        def __hash__(self):
    ...
    class _ListWorkflows(WorkflowsRestStub):
        def __hash__(self):
    ...
    class _UpdateWorkflow(WorkflowsRestStub):
        def __hash__(self):
    ...
    class _GetLocation(WorkflowsRestStub):
        def __call__(self,
    ...
    class _ListLocations(WorkflowsRestStub):
        def __call__(self,
    ...
    class _DeleteOperation(WorkflowsRestStub):
        def __call__(self,
    ...
    class _GetOperation(WorkflowsRestStub):
        def __call__(self,
    ...
    class _ListOperations(WorkflowsRestStub):
        def __call__(self,

...
def test_create_workflow_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["workflow"] = {'name': 'name_value', 'description': 'description_value', 'state': 1, 'revision_id': 'revision_id_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'revision_create_time': {}, 'labels': {}, 'service_account': 'service_account_value', 'source_contents': 'source_contents_value', 'crypto_key_name': 'crypto_key_name_value', 'state_error': {'details': 'details_value', 'type_': 1}, 'call_log_level': 1, 'user_env_vars': {}}
...
def test_update_workflow_rest(request_type):
    ...
    request_init["workflow"] = {'name': 'projects/sample1/locations/sample2/workflows/sample3', 'description': 'description_value', 'state': 1, 'revision_id': 'revision_id_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'revision_create_time': {}, 'labels': {}, 'service_account': 'service_account_value', 'source_contents': 'source_contents_value', 'crypto_key_name': 'crypto_key_name_value', 'state_error': {'details': 'details_value', 'type_': 1}, 'call_log_level': 1, 'user_env_vars': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

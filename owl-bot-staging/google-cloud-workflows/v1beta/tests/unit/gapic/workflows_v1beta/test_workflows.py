...
def test_list_workflows_rest_required_fields(request_type=workflows.ListWorkflowsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_workflows._get_unset_required_fields(jsonified_request)
...
def test_list_workflows_rest_unset_required_fields():
    transport = transports.WorkflowsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_workflows_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.WorkflowsRestInterceptor, "post_list_workflows") as post, \
         mock.patch.object(transports.WorkflowsRestInterceptor, "pre_list_workflows") as pre:
        ...
        req.return_value._content = workflows.ListWorkflowsResponse.to_json(workflows.ListWorkflowsResponse())
        ...
        client.list_workflows(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_workflows_rest_bad_request(transport: str = 'rest', request_type=workflows.ListWorkflowsRequest):
    client = WorkflowsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_workflow_rest_required_fields(request_type=workflows.GetWorkflowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_workflow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_workflow_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WorkflowsRestInterceptor, "post_get_workflow") as post, \
         mock.patch.object(transports.WorkflowsRestInterceptor, "pre_get_workflow") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_workflow(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_workflow_rest_bad_request(transport: str = 'rest', request_type=workflows.GetWorkflowRequest):
    client = WorkflowsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_workflow_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["workflow"] = {'name': 'name_value', 'description': 'description_value', 'state': 1, 'revision_id': 'revision_id_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'revision_create_time': {}, 'labels': {}, 'service_account': 'service_account_value', 'source_contents': 'source_contents_value'}
...
def test_create_workflow_rest_required_fields(request_type=workflows.CreateWorkflowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_workflow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_workflow_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("workflowId", )) & set(("parent", "workflow", "workflowId", )))
...
def test_create_workflow_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.WorkflowsRestInterceptor, "post_create_workflow") as post, \
         mock.patch.object(transports.WorkflowsRestInterceptor, "pre_create_workflow") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_workflow(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_workflow_rest_bad_request(transport: str = 'rest', request_type=workflows.CreateWorkflowRequest):
    client = WorkflowsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_workflow_rest_required_fields(request_type=workflows.DeleteWorkflowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_workflow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_workflow_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.WorkflowsRestInterceptor, "post_delete_workflow") as post, \
         mock.patch.object(transports.WorkflowsRestInterceptor, "pre_delete_workflow") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_workflow(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_workflow_rest_bad_request(transport: str = 'rest', request_type=workflows.DeleteWorkflowRequest):
    client = WorkflowsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_workflow_rest(request_type):
    ...
    request_init["workflow"] = {'name': 'projects/sample1/locations/sample2/workflows/sample3', 'description': 'description_value', 'state': 1, 'revision_id': 'revision_id_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'revision_create_time': {}, 'labels': {}, 'service_account': 'service_account_value', 'source_contents': 'source_contents_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_workflow_rest_required_fields(request_type=workflows.UpdateWorkflowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_workflow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_workflow_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.WorkflowsRestInterceptor, "post_update_workflow") as post, \
         mock.patch.object(transports.WorkflowsRestInterceptor, "pre_update_workflow") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_workflow(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_workflow_rest_bad_request(transport: str = 'rest', request_type=workflows.UpdateWorkflowRequest):
    client = WorkflowsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_workflows_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.workflows_v1beta.services.workflows.transports.WorkflowsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_workflows_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.workflows_v1beta.services.workflows.transports.WorkflowsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.WorkflowsTransport()
        adc.assert_called_once()

...
def test_list_workflows_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkflowsRestInterceptor, "post_list_workflows_with_metadata") as post_with_metadata, \
...
def test_get_workflow_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkflowsRestInterceptor, "post_get_workflow_with_metadata") as post_with_metadata, \
...
def test_create_workflow_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkflowsRestInterceptor, "post_create_workflow_with_metadata") as post_with_metadata, \
...
def test_delete_workflow_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkflowsRestInterceptor, "post_delete_workflow_with_metadata") as post_with_metadata, \
...
def test_update_workflow_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkflowsRestInterceptor, "post_update_workflow_with_metadata") as post_with_metadata, \

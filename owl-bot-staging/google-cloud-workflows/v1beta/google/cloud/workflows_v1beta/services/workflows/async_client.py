...
class WorkflowsAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, WorkflowsTransport, Callable[..., WorkflowsTransport]]] = "grpc_asyncio",
    ...
    async def list_workflows(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_workflows]
    ...
    async def get_workflow(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_workflow]
    ...
    async def create_workflow(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_workflow]
    ...
    async def delete_workflow(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_workflow]
    ...
    async def update_workflow(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_workflow]

...
from maps.fleetengine.delivery_v1.types import delivery_vehicles as mfd_delivery_vehicles
from maps.fleetengine.delivery_v1.types import header as mfd_header
from maps.fleetengine.delivery_v1.types import tasks as mfd_tasks
...
class CreateDeliveryVehicleRequest(proto.Message):
    ...
    Attributes:
        header (maps.fleetengine.delivery_v1.types.DeliveryRequestHeader):
...
class ListDeliveryVehiclesResponse(proto.Message):
    ...
    Attributes:
        delivery_vehicles (MutableSequence[maps.fleetengine.delivery_v1.types.DeliveryVehicle]):
...
class BatchCreateTasksRequest(proto.Message):
    ...
    Attributes:
        ...
        parent (str):
            ...
            ``CreateTaskRequest`` messages must either be empty, or it
            must match this field.
        requests (MutableSequence[maps.fleetengine.delivery_v1.types.CreateTaskRequest]):
...
class BatchCreateTasksResponse(proto.Message):
    ...
    Attributes:
        tasks (MutableSequence[maps.fleetengine.delivery_v1.types.Task]):
            The created Tasks.
    """

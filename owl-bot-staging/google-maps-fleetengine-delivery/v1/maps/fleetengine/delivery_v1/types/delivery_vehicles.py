...
class DeliveryVehicle(proto.Message):
    ...
    Attributes:
        ...
        last_location (maps.fleetengine.delivery_v1.types.DeliveryVehicleLocation):
            The last reported location of the Delivery
            Vehicle.
        navigation_status (maps.fleetengine.delivery_v1.types.DeliveryVehicleNavigationStatus):
        ...
        remaining_duration (google.protobuf.duration_pb2.Duration):
            ...
            ``UpdateDeliveryVehicleRequest`` if the
            ``current_route_segment`` field is empty.
        remaining_vehicle_journey_segments (MutableSequence[maps.fleetengine.delivery_v1.types.VehicleJourneySegment]):
        ...
        attributes (MutableSequence[maps.fleetengine.delivery_v1.types.DeliveryVehicleAttribute]):
            ...
            unique key.
        type_ (maps.fleetengine.delivery_v1.types.DeliveryVehicle.DeliveryVehicleType):
...
class VehicleJourneySegment(proto.Message):
    ...
    Attributes:
        stop (maps.fleetengine.delivery_v1.types.VehicleStop):
...
class VehicleStop(proto.Message):
    ...
    Attributes:
        planned_location (maps.fleetengine.delivery_v1.types.LocationInfo):
            ...
            ``SearchTasks`` call.
        tasks (MutableSequence[maps.fleetengine.delivery_v1.types.VehicleStop.TaskInfo]):
        ...
        state (maps.fleetengine.delivery_v1.types.VehicleStop.State):
    ...
    class TaskInfo(proto.Message):
        ...
        Attributes:
            ...
            task_duration (google.protobuf.duration_pb2.Duration):
                ...
                Task.
            target_time_window (maps.fleetengine.delivery_v1.types.TimeWindow):

...
class Task(proto.Message):
    ...
    Attributes:
        ...
        task_outcome_location (maps.fleetengine.delivery_v1.types.LocationInfo):
            ...
            (the *raw* location).
        task_outcome_location_source (maps.fleetengine.delivery_v1.types.Task.TaskOutcomeLocationSource):
        ...
        target_time_window (maps.fleetengine.delivery_v1.types.TimeWindow):
            ...
            be completed.
        journey_sharing_info (maps.fleetengine.delivery_v1.types.Task.JourneySharingInfo):
            Output only. Journey sharing-specific fields. Not populated
            when state is ``CLOSED``.
        task_tracking_view_config (maps.fleetengine.delivery_v1.types.TaskTrackingViewConfig):
        ...
        attributes (MutableSequence[maps.fleetengine.delivery_v1.types.TaskAttribute]):
...
class TaskTrackingViewConfig(proto.Message):
    ...
    Attributes:
        route_polyline_points_visibility (maps.fleetengine.delivery_v1.types.TaskTrackingViewConfig.VisibilityOption):
        ...
        estimated_arrival_time_visibility (maps.fleetengine.delivery_v1.types.TaskTrackingViewConfig.VisibilityOption):
            ...
            used.
        estimated_task_completion_time_visibility (maps.fleetengine.delivery_v1.types.TaskTrackingViewConfig.VisibilityOption):
            The field that specifies when estimated task
            completion time can be visible. If this field is
            not specified, the project level default
            visibility configuration for this data will be
            used.
        remaining_driving_distance_visibility (maps.fleetengine.delivery_v1.types.TaskTrackingViewConfig.VisibilityOption):
            ...
            visibility configuration for this data will be
            used.
        remaining_stop_count_visibility (maps.fleetengine.delivery_v1.types.TaskTrackingViewConfig.VisibilityOption):
            The field that specifies when remaining stop
            count can be visible. If this field is not
            specified, the project level default visibility
            configuration for this data will be used.
        vehicle_location_visibility (maps.fleetengine.delivery_v1.types.TaskTrackingViewConfig.VisibilityOption):

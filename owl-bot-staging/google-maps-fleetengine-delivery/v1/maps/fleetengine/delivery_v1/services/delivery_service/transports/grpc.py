...
from .base import DeliveryServiceTransport, DEFAULT_CLIENT_INFO


class DeliveryServiceGrpcTransport(DeliveryServiceTransport):
    """gRPC backend transport for DeliveryService.
    ...
    def create_delivery_vehicle(self) -> Callable[
        ...
        Returns:
            Callable[[~.CreateDeliveryVehicleRequest],
                    ~.DeliveryVehicle]:
    ...
    def get_delivery_vehicle(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetDeliveryVehicleRequest],
                    ~.DeliveryVehicle]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def update_delivery_vehicle(self) -> Callable[
        ...
        Returns:
            Callable[[~.UpdateDeliveryVehicleRequest],
                    ~.DeliveryVehicle]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def get_task_tracking_info(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetTaskTrackingInfoRequest],
                    ~.TaskTrackingInfo]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def list_delivery_vehicles(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListDeliveryVehiclesRequest],

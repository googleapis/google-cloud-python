...
class DeliveryRequestHeader(proto.Message):
    r"""A RequestHeader contains fields common to all Delivery RPC
    requests.
    ...
    Attributes:
        ...
        sdk_type (google.maps.fleetengine_delivery_v1.types.DeliveryRequestHeader.SdkType):
        ...
        nav_sdk_version (str):
            ...
            applicable. The version format is "major.minor.patch",
            example: ``2.1.0``.
        platform (google.maps.fleetengine_delivery_v1.types.DeliveryRequestHeader.Platform):

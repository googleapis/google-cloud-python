...
class DeliveryServiceClient(metaclass=DeliveryServiceClientMeta):
    ...
    @staticmethod
    def delivery_vehicle_path(provider: str,vehicle: str,) -> str:
        """Returns a fully-qualified delivery_vehicle string."""
        return "providers/{provider}/deliveryVehicles/{vehicle}".format(provider=provider, vehicle=vehicle, )
    ...
    @staticmethod
    def task_path(provider: str,task: str,) -> str:
        """Returns a fully-qualified task string."""
        return "providers/{provider}/tasks/{task}".format(provider=provider, task=task, )
    ...
    @staticmethod
    def task_tracking_info_path(provider: str,tracking: str,) -> str:
        """Returns a fully-qualified task_tracking_info string."""
        return "providers/{provider}/taskTrackingInfo/{tracking}".format(provider=provider, tracking=tracking, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            DeliveryServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def create_delivery_vehicle(self,
    ...
    def update_delivery_vehicle(self,
    ...
    def search_tasks(self,
        ...
        """
        warnings.warn("DeliveryServiceClient.search_tasks is deprecated",
            DeprecationWarning)
    ...
    def get_task_tracking_info(self,
    ...
    def list_delivery_vehicles(self,

...
from google.maps.fleetengine_delivery_v1.types import delivery_api
from google.maps.fleetengine_delivery_v1.types import delivery_vehicles
from google.maps.fleetengine_delivery_v1.types import task_tracking_info
from google.maps.fleetengine_delivery_v1.types import tasks
...
class DeliveryServiceTransport(abc.ABC):
    ...
    @property
    def delete_delivery_vehicle(self) -> Callable[
    ...
    def list_tasks(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[delivery_api.ListTasksResponse]
            ]]:
        raise NotImplementedError()

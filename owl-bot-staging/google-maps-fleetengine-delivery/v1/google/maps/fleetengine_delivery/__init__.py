...
from google.maps.fleetengine_delivery_v1.types.delivery_api import DeleteDeliveryVehicleRequest
from google.maps.fleetengine_delivery_v1.types.delivery_api import DeleteTaskRequest

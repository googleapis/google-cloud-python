...
from maps.fleetengine.delivery_v1.services.delivery_service import DeliveryServiceAsyncClient
from maps.fleetengine.delivery_v1.services.delivery_service import DeliveryServiceClient
from maps.fleetengine.delivery_v1.services.delivery_service import pagers
from maps.fleetengine.delivery_v1.services.delivery_service import transports
...
from maps.fleetengine.delivery_v1.types import header
...
def test_delivery_service_client_client_options_from_dict():
    with mock.patch('maps.fleetengine.delivery_v1.services.delivery_service.transports.DeliveryServiceGrpcTransport.__init__') as grpc_transport:
...
def test_delivery_service_base_transport():
    ...
    with mock.patch('maps.fleetengine.delivery_v1.services.delivery_service.transports.DeliveryServiceTransport.__init__') as Transport:
...
def test_delivery_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('maps.fleetengine.delivery_v1.services.delivery_service.transports.DeliveryServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_delivery_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('maps.fleetengine.delivery_v1.services.delivery_service.transports.DeliveryServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DeliveryServiceTransport()
        adc.assert_called_once()

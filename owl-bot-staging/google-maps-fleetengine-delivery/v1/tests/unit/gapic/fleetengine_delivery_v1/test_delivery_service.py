...
from google.maps.fleetengine_delivery_v1.services.delivery_service import DeliveryServiceAsyncClient
from google.maps.fleetengine_delivery_v1.services.delivery_service import DeliveryServiceClient
from google.maps.fleetengine_delivery_v1.services.delivery_service import pagers
from google.maps.fleetengine_delivery_v1.services.delivery_service import transports
...
from google.maps.fleetengine_delivery_v1.types import header
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert DeliveryServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert DeliveryServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert DeliveryServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert DeliveryServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert DeliveryServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert DeliveryServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert DeliveryServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert DeliveryServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(DeliveryServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DeliveryServiceClient))
@mock.patch.object(DeliveryServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DeliveryServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DeliveryServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DeliveryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = DeliveryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert DeliveryServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert DeliveryServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DeliveryServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DeliveryServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert DeliveryServiceClient._get_api_endpoint(None, None, default_universe, "always") == DeliveryServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DeliveryServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DeliveryServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DeliveryServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert DeliveryServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        DeliveryServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert DeliveryServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert DeliveryServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert DeliveryServiceClient._get_universe_domain(None, None) == DeliveryServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (DeliveryServiceAsyncClient, transports.DeliveryServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (DeliveryServiceClient, transports.DeliveryServiceGrpcTransport, "grpc", "true"),
    (DeliveryServiceAsyncClient, transports.DeliveryServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (DeliveryServiceClient, transports.DeliveryServiceGrpcTransport, "grpc", "false"),
    (DeliveryServiceAsyncClient, transports.DeliveryServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (DeliveryServiceClient, transports.DeliveryServiceRestTransport, "rest", "true"),
    (DeliveryServiceClient, transports.DeliveryServiceRestTransport, "rest", "false"),
])
@mock.patch.object(DeliveryServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DeliveryServiceClient))
@mock.patch.object(DeliveryServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DeliveryServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    DeliveryServiceClient, DeliveryServiceAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (DeliveryServiceClient, transports.DeliveryServiceGrpcTransport, "grpc", grpc_helpers),
    (DeliveryServiceAsyncClient, transports.DeliveryServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_create_delivery_vehicle(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_delivery_vehicle),
            '__call__') as call:
...
def test_create_delivery_vehicle_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_delivery_vehicle in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_delivery_vehicle] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_delivery_vehicle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_delivery_vehicle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_delivery_vehicle] = mock_rpc
...
def test_get_delivery_vehicle(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_delivery_vehicle),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = delivery_vehicles.DeliveryVehicle(
            name='name_value',
...
def test_get_delivery_vehicle_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_delivery_vehicle in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_delivery_vehicle] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_delivery_vehicle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DeliveryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_delivery_vehicle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_delivery_vehicle] = mock_rpc
...
def test_delete_delivery_vehicle(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_delivery_vehicle),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
        response = client.delete_delivery_vehicle(request)
...
def test_delete_delivery_vehicle_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_delete_delivery_vehicle_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_delivery_vehicle in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_delivery_vehicle] = mock_rpc
        request = {}
        client.delete_delivery_vehicle(request)
...
@pytest.mark.asyncio
async def test_delete_delivery_vehicle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DeliveryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_delivery_vehicle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_delivery_vehicle] = mock_rpc

        request = {}
        await client.delete_delivery_vehicle(request)
...
@pytest.mark.asyncio
async def test_delete_delivery_vehicle_async(transport: str = 'grpc_asyncio', request_type=delivery_api.DeleteDeliveryVehicleRequest):
    client = DeliveryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.delete_delivery_vehicle(request)
...
def test_delete_delivery_vehicle_flattened_error():
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_delivery_vehicle_flattened_async():
    client = DeliveryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_delivery_vehicle(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_delete_delivery_vehicle_flattened_error_async():
    client = DeliveryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_delivery_vehicle(
            delivery_api.DeleteDeliveryVehicleRequest(),
            name='name_value',
        )
...
def test_update_delivery_vehicle(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_delivery_vehicle),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = delivery_vehicles.DeliveryVehicle(
            name='name_value',
...
def test_update_delivery_vehicle_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_delivery_vehicle in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_delivery_vehicle] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_delivery_vehicle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DeliveryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_delivery_vehicle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_delivery_vehicle] = mock_rpc
...
def test_batch_create_tasks(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_create_tasks),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_batch_create_tasks_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_create_tasks in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_create_tasks] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_create_tasks_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DeliveryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_create_tasks in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_create_tasks] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_task_async(transport: str = 'grpc_asyncio', request_type=delivery_api.DeleteTaskRequest):
    client = DeliveryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_task(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_task),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = tasks.Task(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_task_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DeliveryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_task in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_task] = mock_rpc
...
def test_list_tasks_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, tasks.Task)
                   for i in results)
...
def test_get_task_tracking_info(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_task_tracking_info),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_task_tracking_info_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_task_tracking_info in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_task_tracking_info] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_task_tracking_info_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DeliveryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_task_tracking_info in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_task_tracking_info] = mock_rpc
...
def test_list_delivery_vehicles_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_delivery_vehicles in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_delivery_vehicles] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_delivery_vehicles_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DeliveryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_delivery_vehicles in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_delivery_vehicles] = mock_rpc
...
def test_list_delivery_vehicles_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, delivery_vehicles.DeliveryVehicle)
                   for i in results)
...
def test_delete_delivery_vehicle_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DeliveryServiceClient(
...
def test_delete_delivery_vehicle_rest_required_fields(request_type=delivery_api.DeleteDeliveryVehicleRequest):
    transport_class = transports.DeliveryServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_delivery_vehicle._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_delivery_vehicle_rest_unset_required_fields():
    transport = transports.DeliveryServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.delete_delivery_vehicle._get_unset_required_fields({})
    assert set(unset_fields) == (set(("header", )) & set(("name", )))


def test_delete_delivery_vehicle_rest_flattened():
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.delete_delivery_vehicle(**mock_args)
...
def test_delete_delivery_vehicle_rest_flattened_error(transport: str = 'rest'):
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_task_rest_required_fields(request_type=delivery_api.DeleteTaskRequest):
    transport_class = transports.DeliveryServiceRestTransport
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_delivery_vehicle_empty_call_grpc():
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_delivery_vehicle(request=None)
...
def test_create_delivery_vehicle_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
        ...
        request_msg = delivery_api.CreateDeliveryVehicleRequest(**{"parent": "providers/sample1"})
...
def test_get_delivery_vehicle_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = delivery_api.GetDeliveryVehicleRequest(**{"name": "providers/sample1"})
...
def test_delete_delivery_vehicle_routing_parameters_request_1_grpc():
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_delivery_vehicle(request={"name": "providers/sample1"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = delivery_api.DeleteDeliveryVehicleRequest(**{"name": "providers/sample1"})
...
def test_update_delivery_vehicle_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = delivery_vehicles.DeliveryVehicle()
        client.update_delivery_vehicle(request={"delivery_vehicle": {"name": "providers/sample1"}})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = delivery_api.UpdateDeliveryVehicleRequest(**{"delivery_vehicle": {"name": "providers/sample1"}})
...
def test_batch_create_tasks_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = delivery_api.BatchCreateTasksRequest(**{"parent": "providers/sample1"})
...
def test_delete_task_routing_parameters_request_1_grpc():
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_task(request={"name": "providers/sample1"})
...
def test_update_task_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = delivery_api.UpdateTaskRequest(**{"task": {"name": "providers/sample1"}})
...
def test_get_task_tracking_info_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = delivery_api.GetTaskTrackingInfoRequest(**{"name": "providers/sample1"})
...
def test_list_delivery_vehicles_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = delivery_api.ListDeliveryVehiclesRequest(**{"parent": "providers/sample1"})
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_delivery_vehicle_empty_call_grpc_asyncio():
    client = DeliveryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_delivery_vehicle(request=None)
...
@pytest.mark.asyncio
async def test_delete_delivery_vehicle_routing_parameters_request_1_grpc_asyncio():
    client = DeliveryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_delivery_vehicle(request={"name": "providers/sample1"})
...
async def test_update_delivery_vehicle_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.update_delivery_vehicle(request={"delivery_vehicle": {"name": "providers/sample1"}})
...
@pytest.mark.asyncio
async def test_delete_task_routing_parameters_request_1_grpc_asyncio():
    client = DeliveryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_task(request={"name": "providers/sample1"})
...
def test_create_delivery_vehicle_rest_bad_request(request_type=delivery_api.CreateDeliveryVehicleRequest):
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_delivery_vehicle_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'providers/sample1'}
    request_init["delivery_vehicle"] = {'name': 'name_value', 'last_location': {'location': {'latitude': 0.86, 'longitude': 0.971}, 'horizontal_accuracy': {'value': 0.541}, 'latlng_accuracy': {}, 'heading': {'value': 541}, 'bearing_accuracy': {}, 'heading_accuracy': {}, 'altitude': {}, 'vertical_accuracy': {}, 'altitude_accuracy': {}, 'speed_kmph': {}, 'speed': {}, 'speed_accuracy': {}, 'update_time': {'seconds': 751, 'nanos': 543}, 'server_time': {}, 'location_sensor': 1, 'is_road_snapped': {'value': True}, 'is_gps_sensor_enabled': {}, 'time_since_update': {}, 'num_stale_updates': {}, 'raw_location': {}, 'raw_location_time': {}, 'raw_location_sensor': 1, 'raw_location_accuracy': {}, 'flp_location': {}, 'flp_update_time': {}, 'flp_latlng_accuracy_meters': {}, 'flp_heading_degrees': {}, 'supplemental_location': {}, 'supplemental_location_time': {}, 'supplemental_location_sensor': 1, 'supplemental_location_accuracy': {}, 'road_snapped': True}, 'past_locations': {}, 'navigation_status': 1, 'current_route_segment': b'current_route_segment_blob', 'current_route_segment_end_point': {}, 'remaining_distance_meters': {}, 'remaining_duration': {'seconds': 751, 'nanos': 543}, 'remaining_vehicle_journey_segments': [{'stop': {'planned_location': {'point': {}}, 'tasks': [{'task_id': 'task_id_value', 'task_duration': {}, 'target_time_window': {'start_time': {}, 'end_time': {}}}], 'state': 1}, 'driving_distance_meters': {}, 'driving_duration': {}, 'path': {}}], 'attributes': [{'key': 'key_value', 'value': 'value_value', 'string_value': 'string_value_value', 'bool_value': True, 'number_value': 0.1285}], 'type_': 1}
...
def test_create_delivery_vehicle_rest_interceptors(null_interceptor):
    transport = transports.DeliveryServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DeliveryServiceRestInterceptor(),
        )
    client = DeliveryServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_create_delivery_vehicle") as post, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_create_delivery_vehicle_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_create_delivery_vehicle") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = delivery_vehicles.DeliveryVehicle.to_json(delivery_vehicles.DeliveryVehicle())
...
def test_get_delivery_vehicle_rest_bad_request(request_type=delivery_api.GetDeliveryVehicleRequest):
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_delivery_vehicle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_get_delivery_vehicle") as post, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_get_delivery_vehicle_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_get_delivery_vehicle") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_delivery_vehicle_rest_bad_request(request_type=delivery_api.DeleteDeliveryVehicleRequest):
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_delivery_vehicle_rest_call_success(request_type):
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_delivery_vehicle_rest_interceptors(null_interceptor):
    transport = transports.DeliveryServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DeliveryServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_delete_delivery_vehicle") as pre:
        pre.assert_not_called()
        pb_message = delivery_api.DeleteDeliveryVehicleRequest.pb(delivery_api.DeleteDeliveryVehicleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_delivery_vehicle(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_delivery_vehicle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_update_delivery_vehicle") as post, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_update_delivery_vehicle_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_update_delivery_vehicle") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_batch_create_tasks_rest_bad_request(request_type=delivery_api.BatchCreateTasksRequest):
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_create_tasks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_batch_create_tasks") as post, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_batch_create_tasks_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_batch_create_tasks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = delivery_api.BatchCreateTasksResponse.to_json(delivery_api.BatchCreateTasksResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = delivery_api.BatchCreateTasksResponse(), metadata
...
def test_create_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_create_task") as post, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_create_task_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_create_task") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_get_task") as post, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_get_task_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_get_task") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_task_rest_bad_request(request_type=delivery_api.DeleteTaskRequest):
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_delete_task") as pre:
        pre.assert_not_called()
...
def test_update_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_update_task") as post, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_update_task_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_update_task") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_tasks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_list_tasks") as post, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_list_tasks_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_list_tasks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = delivery_api.ListTasksResponse.to_json(delivery_api.ListTasksResponse())
        req.return_value.content = return_value
...
def test_get_task_tracking_info_rest_bad_request(request_type=delivery_api.GetTaskTrackingInfoRequest):
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_task_tracking_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_get_task_tracking_info") as post, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_get_task_tracking_info_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_get_task_tracking_info") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = task_tracking_info.TaskTrackingInfo.to_json(task_tracking_info.TaskTrackingInfo())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = task_tracking_info.TaskTrackingInfo(), metadata
...
def test_list_delivery_vehicles_rest_bad_request(request_type=delivery_api.ListDeliveryVehiclesRequest):
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_delivery_vehicles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_list_delivery_vehicles") as post, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_list_delivery_vehicles_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_list_delivery_vehicles") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = delivery_api.ListDeliveryVehiclesResponse.to_json(delivery_api.ListDeliveryVehiclesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = delivery_api.ListDeliveryVehiclesResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_delivery_vehicle_empty_call_rest():
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_delete_task_routing_parameters_request_1_rest():
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_delivery_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.delete_delivery_vehicle._session
    session2 = client2.transport.delete_delivery_vehicle._session
    assert session1 != session2
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DeliveryServiceGrpcTransport, transports.DeliveryServiceGrpcAsyncIOTransport])
def test_delivery_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

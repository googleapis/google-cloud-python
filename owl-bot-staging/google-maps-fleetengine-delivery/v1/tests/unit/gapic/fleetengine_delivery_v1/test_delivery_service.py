...
def test_create_delivery_vehicle_rest_required_fields(request_type=delivery_api.CreateDeliveryVehicleRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_delivery_vehicle._get_unset_required_fields(jsonified_request)
...
def test_create_delivery_vehicle_rest_unset_required_fields():
    transport = transports.DeliveryServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_delivery_vehicle_rest_required_fields(request_type=delivery_api.GetDeliveryVehicleRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_delivery_vehicle._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_delivery_vehicle_rest_required_fields(request_type=delivery_api.UpdateDeliveryVehicleRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_delivery_vehicle._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_tasks_rest_required_fields(request_type=delivery_api.BatchCreateTasksRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_create_tasks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_task_rest_required_fields(request_type=delivery_api.CreateTaskRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_task._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_tasks_rest_required_fields(request_type=delivery_api.SearchTasksRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_tasks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_task_rest_required_fields(request_type=delivery_api.UpdateTaskRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_task._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_task_tracking_info_rest_required_fields(request_type=delivery_api.GetTaskTrackingInfoRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_task_tracking_info._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_delivery_vehicles_rest_required_fields(request_type=delivery_api.ListDeliveryVehiclesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_delivery_vehicles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

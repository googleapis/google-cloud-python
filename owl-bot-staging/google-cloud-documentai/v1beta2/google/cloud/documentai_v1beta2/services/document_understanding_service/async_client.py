...
class DocumentUnderstandingServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = DocumentUnderstandingServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DocumentUnderstandingServiceTransport, Callable[..., DocumentUnderstandingServiceTransport]]] = "grpc_asyncio",

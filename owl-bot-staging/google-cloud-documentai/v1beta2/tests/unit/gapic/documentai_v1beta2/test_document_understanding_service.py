...
def test__read_environment_variables():
    assert DocumentUnderstandingServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert DocumentUnderstandingServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert DocumentUnderstandingServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert DocumentUnderstandingServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert DocumentUnderstandingServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert DocumentUnderstandingServiceClient._get_client_cert_source(None, False) is None
    assert DocumentUnderstandingServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert DocumentUnderstandingServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert DocumentUnderstandingServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert DocumentUnderstandingServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(DocumentUnderstandingServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DocumentUnderstandingServiceClient))
@mock.patch.object(DocumentUnderstandingServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DocumentUnderstandingServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DocumentUnderstandingServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DocumentUnderstandingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = DocumentUnderstandingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert DocumentUnderstandingServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert DocumentUnderstandingServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DocumentUnderstandingServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DocumentUnderstandingServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert DocumentUnderstandingServiceClient._get_api_endpoint(None, None, default_universe, "always") == DocumentUnderstandingServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DocumentUnderstandingServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DocumentUnderstandingServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DocumentUnderstandingServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert DocumentUnderstandingServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        DocumentUnderstandingServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert DocumentUnderstandingServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert DocumentUnderstandingServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert DocumentUnderstandingServiceClient._get_universe_domain(None, None) == DocumentUnderstandingServiceClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        DocumentUnderstandingServiceClient._get_universe_domain("", None)
...
@mock.patch.object(DocumentUnderstandingServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DocumentUnderstandingServiceClient))
@mock.patch.object(DocumentUnderstandingServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DocumentUnderstandingServiceAsyncClient))
def test_document_understanding_service_client_client_api_endpoint(client_class):

...
def test_batch_delete_documents_rest_required_fields(request_type=document_service.BatchDeleteDocumentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_delete_documents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_dataset_schema_rest_required_fields(request_type=document_service.GetDatasetSchemaRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_dataset_schema._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_dataset_schema_rest_required_fields(request_type=document_service.UpdateDatasetSchemaRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_dataset_schema._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

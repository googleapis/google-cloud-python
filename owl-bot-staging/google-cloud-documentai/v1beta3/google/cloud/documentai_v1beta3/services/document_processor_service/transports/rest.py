...
class DocumentProcessorServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_import_processor_version(self, request: document_processor_service.ImportProcessorVersionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[document_processor_service.ImportProcessorVersionRequest, Sequence[Tuple[str, str]]]:

...
class DocumentServiceClient(metaclass=DocumentServiceClientMeta):
    ...
    @staticmethod
    def dataset_path(project: str,location: str,processor: str,) -> str:
        """Returns a fully-qualified dataset string."""
        return "projects/{project}/locations/{location}/processors/{processor}/dataset".format(project=project, location=location, processor=processor, )
    ...
    @staticmethod
    def dataset_schema_path(project: str,location: str,processor: str,) -> str:
        """Returns a fully-qualified dataset_schema string."""
        return "projects/{project}/locations/{location}/processors/{processor}/dataset/datasetSchema".format(project=project, location=location, processor=processor, )
    ...
    @staticmethod
    def schema_path(project: str,location: str,schema: str,) -> str:
        """Returns a fully-qualified schema string."""
        return "projects/{project}/locations/{location}/schemas/{schema}".format(project=project, location=location, schema=schema, )
    ...
    def update_dataset_schema(self,

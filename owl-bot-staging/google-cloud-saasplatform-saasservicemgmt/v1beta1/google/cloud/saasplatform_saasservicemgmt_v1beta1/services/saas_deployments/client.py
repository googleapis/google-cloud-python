...
from google.cloud.saasplatform_saasservicemgmt_v1beta1.services.saas_deployments import pagers
...
from google.cloud.saasplatform_saasservicemgmt_v1beta1.types import deployments_service
from google.longrunning import operations_pb2 # type: ignore
from google.protobuf import field_mask_pb2  # type: ignore
from google.protobuf import timestamp_pb2  # type: ignore
from .transports.base import SaasDeploymentsTransport, DEFAULT_CLIENT_INFO
...
class SaasDeploymentsClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[SaasDeploymentsTransport]]
...
class SaasDeploymentsClient(metaclass=SaasDeploymentsClientMeta):
    ...
    @staticmethod
    def release_path(project: str,location: str,release: str,) -> str:
        """Returns a fully-qualified release string."""
        return "projects/{project}/locations/{location}/releases/{release}".format(project=project, location=location, release=release, )

    @staticmethod
    def parse_release_path(path: str) -> Dict[str,str]:
        """Parses a release path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/releases/(?P<release>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def rollout_path(project: str,location: str,rollout_id: str,) -> str:
        """Returns a fully-qualified rollout string."""
        return "projects/{project}/locations/{location}/rollouts/{rollout_id}".format(project=project, location=location, rollout_id=rollout_id, )

    @staticmethod
    def parse_rollout_path(path: str) -> Dict[str,str]:
        """Parses a rollout path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/rollouts/(?P<rollout_id>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def saas_path(project: str,location: str,saas: str,) -> str:
        """Returns a fully-qualified saas string."""
        return "projects/{project}/locations/{location}/saas/{saas}".format(project=project, location=location, saas=saas, )

    @staticmethod
    def parse_saas_path(path: str) -> Dict[str,str]:
        """Parses a saas path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/saas/(?P<saas>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def tenant_path(project: str,location: str,tenant: str,) -> str:
        """Returns a fully-qualified tenant string."""
        return "projects/{project}/locations/{location}/tenants/{tenant}".format(project=project, location=location, tenant=tenant, )

    @staticmethod
    def parse_tenant_path(path: str) -> Dict[str,str]:
        """Parses a tenant path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/tenants/(?P<tenant>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def unit_path(project: str,location: str,unit: str,) -> str:
        """Returns a fully-qualified unit string."""
        return "projects/{project}/locations/{location}/units/{unit}".format(project=project, location=location, unit=unit, )

    @staticmethod
    def parse_unit_path(path: str) -> Dict[str,str]:
        """Parses a unit path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/units/(?P<unit>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def unit_kind_path(project: str,location: str,unitKind: str,) -> str:
        """Returns a fully-qualified unit_kind string."""
        return "projects/{project}/locations/{location}/unitKinds/{unitKind}".format(project=project, location=location, unitKind=unitKind, )

    @staticmethod
    def parse_unit_kind_path(path: str) -> Dict[str,str]:
        """Parses a unit_kind path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/unitKinds/(?P<unitKind>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def unit_operation_path(project: str,location: str,unitOperation: str,) -> str:
        """Returns a fully-qualified unit_operation string."""
        return "projects/{project}/locations/{location}/unitOperations/{unitOperation}".format(project=project, location=location, unitOperation=unitOperation, )

    @staticmethod
    def parse_unit_operation_path(path: str) -> Dict[str,str]:
        """Parses a unit_operation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/unitOperations/(?P<unitOperation>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SaasDeploymentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SaasDeploymentsTransport, Callable[..., SaasDeploymentsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SaasDeploymentsClient._read_environment_variables()
        self._client_cert_source = SaasDeploymentsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SaasDeploymentsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            SaasDeploymentsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SaasDeploymentsTransport], Callable[..., SaasDeploymentsTransport]] = (
    ...
    def create_unit_kind(self,
            request: Optional[Union[deployments_service.CreateUnitKindRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_unit_kind(self,
            request: Optional[Union[deployments_service.UpdateUnitKindRequest, dict]] = None,
            *,
            unit_kind: Optional[deployments_resources.UnitKind] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def delete_unit_kind(self,
            request: Optional[Union[deployments_service.DeleteUnitKindRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_unit_operations(self,
            request: Optional[Union[deployments_service.ListUnitOperationsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_unit_operation(self,
            request: Optional[Union[deployments_service.GetUnitOperationRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_unit_operation(self,
            request: Optional[Union[deployments_service.CreateUnitOperationRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_unit_operation(self,
            request: Optional[Union[deployments_service.UpdateUnitOperationRequest, dict]] = None,
            *,
            unit_operation: Optional[deployments_resources.UnitOperation] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def delete_unit_operation(self,
            request: Optional[Union[deployments_service.DeleteUnitOperationRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,

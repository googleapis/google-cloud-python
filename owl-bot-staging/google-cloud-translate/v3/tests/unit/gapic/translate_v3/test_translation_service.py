...
def test_create_adaptive_mt_dataset(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_adaptive_mt_dataset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_adaptive_mt_dataset_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_adaptive_mt_dataset in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_adaptive_mt_dataset] = mock_rpc
        request = {}
...
async def test_create_adaptive_mt_dataset_empty_call_async():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(adaptive_mt.AdaptiveMtDataset(
            name='name_value',
            display_name='display_name_value',
            source_language_code='source_language_code_value',
            target_language_code='target_language_code_value',
...
@pytest.mark.asyncio
async def test_create_adaptive_mt_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TranslationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_adaptive_mt_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_adaptive_mt_dataset] = mock_object
...
@pytest.mark.asyncio
async def test_create_adaptive_mt_dataset_async(transport: str = 'grpc_asyncio', request_type=adaptive_mt.CreateAdaptiveMtDatasetRequest):
    client = TranslationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_adaptive_mt_dataset(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_adaptive_mt_dataset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_adaptive_mt_dataset_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_adaptive_mt_dataset in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_adaptive_mt_dataset] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_adaptive_mt_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TranslationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_adaptive_mt_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_adaptive_mt_dataset] = mock_object
...
@pytest.mark.asyncio
async def test_delete_adaptive_mt_dataset_async(transport: str = 'grpc_asyncio', request_type=adaptive_mt.DeleteAdaptiveMtDatasetRequest):
    client = TranslationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_adaptive_mt_dataset(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_adaptive_mt_dataset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = adaptive_mt.AdaptiveMtDataset(
            name='name_value',
...
def test_get_adaptive_mt_dataset_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_adaptive_mt_dataset in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_adaptive_mt_dataset] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_adaptive_mt_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TranslationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_adaptive_mt_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_adaptive_mt_dataset] = mock_object
...
@pytest.mark.asyncio
async def test_get_adaptive_mt_dataset_async(transport: str = 'grpc_asyncio', request_type=adaptive_mt.GetAdaptiveMtDatasetRequest):
    client = TranslationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_adaptive_mt_datasets_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_adaptive_mt_datasets in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_adaptive_mt_datasets] = mock_rpc
        request = {}
...
async def test_list_adaptive_mt_datasets_empty_call_async():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(adaptive_mt.ListAdaptiveMtDatasetsResponse(
            next_page_token='next_page_token_value',
        ))
...
@pytest.mark.asyncio
async def test_list_adaptive_mt_datasets_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TranslationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_adaptive_mt_datasets in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_adaptive_mt_datasets] = mock_object
...
@pytest.mark.asyncio
async def test_list_adaptive_mt_datasets_async(transport: str = 'grpc_asyncio', request_type=adaptive_mt.ListAdaptiveMtDatasetsRequest):
    client = TranslationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_adaptive_mt_datasets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_adaptive_mt_datasets(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, adaptive_mt.AdaptiveMtDataset)
                   for i in results)
...
async def test_list_adaptive_mt_datasets_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_adaptive_mt_datasets(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_adaptive_mt_translate(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.adaptive_mt_translate),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_adaptive_mt_translate_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.adaptive_mt_translate in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.adaptive_mt_translate] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_adaptive_mt_translate_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TranslationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.adaptive_mt_translate in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.adaptive_mt_translate] = mock_object
...
@pytest.mark.asyncio
async def test_adaptive_mt_translate_async(transport: str = 'grpc_asyncio', request_type=adaptive_mt.AdaptiveMtTranslateRequest):
    client = TranslationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_adaptive_mt_file(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_adaptive_mt_file),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_adaptive_mt_file_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_adaptive_mt_file in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_adaptive_mt_file] = mock_rpc
        request = {}
...
async def test_get_adaptive_mt_file_empty_call_async():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(adaptive_mt.AdaptiveMtFile(
            name='name_value',
            display_name='display_name_value',
            entry_count=1210,
        ))
...
@pytest.mark.asyncio
async def test_get_adaptive_mt_file_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TranslationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_adaptive_mt_file in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_adaptive_mt_file] = mock_object
...
@pytest.mark.asyncio
async def test_get_adaptive_mt_file_async(transport: str = 'grpc_asyncio', request_type=adaptive_mt.GetAdaptiveMtFileRequest):
    client = TranslationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_adaptive_mt_file(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_adaptive_mt_file),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_adaptive_mt_file_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_adaptive_mt_file in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_adaptive_mt_file] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_adaptive_mt_file_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TranslationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_adaptive_mt_file in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_adaptive_mt_file] = mock_object
...
@pytest.mark.asyncio
async def test_delete_adaptive_mt_file_async(transport: str = 'grpc_asyncio', request_type=adaptive_mt.DeleteAdaptiveMtFileRequest):
    client = TranslationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_adaptive_mt_file(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_adaptive_mt_file),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_import_adaptive_mt_file_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.import_adaptive_mt_file in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_adaptive_mt_file] = mock_rpc
        request = {}
...
async def test_import_adaptive_mt_file_empty_call_async():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(adaptive_mt.ImportAdaptiveMtFileResponse(
        ))
...
@pytest.mark.asyncio
async def test_import_adaptive_mt_file_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TranslationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_adaptive_mt_file in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.import_adaptive_mt_file] = mock_object
...
@pytest.mark.asyncio
async def test_import_adaptive_mt_file_async(transport: str = 'grpc_asyncio', request_type=adaptive_mt.ImportAdaptiveMtFileRequest):
    client = TranslationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_adaptive_mt_files_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_adaptive_mt_files in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_adaptive_mt_files] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_adaptive_mt_files_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TranslationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_adaptive_mt_files in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_adaptive_mt_files] = mock_object
...
@pytest.mark.asyncio
async def test_list_adaptive_mt_files_async(transport: str = 'grpc_asyncio', request_type=adaptive_mt.ListAdaptiveMtFilesRequest):
    client = TranslationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_adaptive_mt_files_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, adaptive_mt.AdaptiveMtFile)
                   for i in results)
...
async def test_list_adaptive_mt_files_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_adaptive_mt_files(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_adaptive_mt_sentences_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_adaptive_mt_sentences in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_adaptive_mt_sentences] = mock_rpc
        request = {}
...
async def test_list_adaptive_mt_sentences_empty_call_async():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(adaptive_mt.ListAdaptiveMtSentencesResponse(
            next_page_token='next_page_token_value',
        ))
...
@pytest.mark.asyncio
async def test_list_adaptive_mt_sentences_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TranslationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_adaptive_mt_sentences in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_adaptive_mt_sentences] = mock_object
...
@pytest.mark.asyncio
async def test_list_adaptive_mt_sentences_async(transport: str = 'grpc_asyncio', request_type=adaptive_mt.ListAdaptiveMtSentencesRequest):
    client = TranslationServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_adaptive_mt_sentences_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_adaptive_mt_sentences(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, adaptive_mt.AdaptiveMtSentence)
                   for i in results)
...
async def test_list_adaptive_mt_sentences_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_adaptive_mt_sentences(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_create_adaptive_mt_dataset_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["adaptive_mt_dataset"] = {'name': 'name_value', 'display_name': 'display_name_value', 'source_language_code': 'source_language_code_value', 'target_language_code': 'target_language_code_value', 'example_count': 1396, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = adaptive_mt.CreateAdaptiveMtDatasetRequest.meta.fields["adaptive_mt_dataset"]
...
def test_create_adaptive_mt_dataset_rest_required_fields(request_type=adaptive_mt.CreateAdaptiveMtDatasetRequest):
    transport_class = transports.TranslationServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_adaptive_mt_dataset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_adaptive_mt_dataset_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "adaptiveMtDataset", )))
...
def test_create_adaptive_mt_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_create_adaptive_mt_dataset") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_create_adaptive_mt_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = adaptive_mt.CreateAdaptiveMtDatasetRequest.pb(adaptive_mt.CreateAdaptiveMtDatasetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = adaptive_mt.AdaptiveMtDataset.to_json(adaptive_mt.AdaptiveMtDataset())
        ...
        client.create_adaptive_mt_dataset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_adaptive_mt_dataset_rest_bad_request(transport: str = 'rest', request_type=adaptive_mt.CreateAdaptiveMtDatasetRequest):
    client = TranslationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_adaptive_mt_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*}/adaptiveMtDatasets" % client.transport._host, args[1])
...
def test_delete_adaptive_mt_dataset_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/adaptiveMtDatasets/sample3'}
    request = request_type(**request_init)
...
def test_delete_adaptive_mt_dataset_rest_required_fields(request_type=adaptive_mt.DeleteAdaptiveMtDatasetRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_adaptive_mt_dataset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_adaptive_mt_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_delete_adaptive_mt_dataset") as pre:
        pre.assert_not_called()
        pb_message = adaptive_mt.DeleteAdaptiveMtDatasetRequest.pb(adaptive_mt.DeleteAdaptiveMtDatasetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_adaptive_mt_dataset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_adaptive_mt_dataset_rest_bad_request(transport: str = 'rest', request_type=adaptive_mt.DeleteAdaptiveMtDatasetRequest):
    client = TranslationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_adaptive_mt_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/adaptiveMtDatasets/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/adaptiveMtDatasets/*}" % client.transport._host, args[1])
...
def test_get_adaptive_mt_dataset_rest_required_fields(request_type=adaptive_mt.GetAdaptiveMtDatasetRequest):
    transport_class = transports.TranslationServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_adaptive_mt_dataset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_adaptive_mt_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_get_adaptive_mt_dataset") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_get_adaptive_mt_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = adaptive_mt.GetAdaptiveMtDatasetRequest.pb(adaptive_mt.GetAdaptiveMtDatasetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_adaptive_mt_dataset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_adaptive_mt_dataset_rest_bad_request(transport: str = 'rest', request_type=adaptive_mt.GetAdaptiveMtDatasetRequest):
    client = TranslationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_adaptive_mt_datasets_rest_required_fields(request_type=adaptive_mt.ListAdaptiveMtDatasetsRequest):
    transport_class = transports.TranslationServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_adaptive_mt_datasets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_adaptive_mt_datasets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_list_adaptive_mt_datasets") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_list_adaptive_mt_datasets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = adaptive_mt.ListAdaptiveMtDatasetsRequest.pb(adaptive_mt.ListAdaptiveMtDatasetsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = adaptive_mt.ListAdaptiveMtDatasetsResponse.to_json(adaptive_mt.ListAdaptiveMtDatasetsResponse())
        ...
        client.list_adaptive_mt_datasets(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_adaptive_mt_datasets_rest_bad_request(transport: str = 'rest', request_type=adaptive_mt.ListAdaptiveMtDatasetsRequest):
    client = TranslationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_adaptive_mt_datasets_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(adaptive_mt.ListAdaptiveMtDatasetsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_adaptive_mt_translate_rest_required_fields(request_type=adaptive_mt.AdaptiveMtTranslateRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).adaptive_mt_translate._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_adaptive_mt_translate_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "dataset", "content", )))
...
def test_adaptive_mt_translate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_adaptive_mt_translate") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_adaptive_mt_translate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = adaptive_mt.AdaptiveMtTranslateRequest.pb(adaptive_mt.AdaptiveMtTranslateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = adaptive_mt.AdaptiveMtTranslateResponse.to_json(adaptive_mt.AdaptiveMtTranslateResponse())
        ...
        client.adaptive_mt_translate(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_adaptive_mt_translate_rest_bad_request(transport: str = 'rest', request_type=adaptive_mt.AdaptiveMtTranslateRequest):
    client = TranslationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_adaptive_mt_translate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*}:adaptiveMtTranslate" % client.transport._host, args[1])
...
def test_get_adaptive_mt_file_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/adaptiveMtDatasets/sample3/adaptiveMtFiles/sample4'}
    request = request_type(**request_init)
...
def test_get_adaptive_mt_file_rest_required_fields(request_type=adaptive_mt.GetAdaptiveMtFileRequest):
    transport_class = transports.TranslationServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_adaptive_mt_file._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_adaptive_mt_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_get_adaptive_mt_file") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_get_adaptive_mt_file") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = adaptive_mt.GetAdaptiveMtFileRequest.pb(adaptive_mt.GetAdaptiveMtFileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = adaptive_mt.AdaptiveMtFile.to_json(adaptive_mt.AdaptiveMtFile())
        ...
        client.get_adaptive_mt_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_adaptive_mt_file_rest_bad_request(transport: str = 'rest', request_type=adaptive_mt.GetAdaptiveMtFileRequest):
    client = TranslationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_adaptive_mt_file_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/adaptiveMtDatasets/sample3/adaptiveMtFiles/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/adaptiveMtDatasets/*/adaptiveMtFiles/*}" % client.transport._host, args[1])
...
def test_delete_adaptive_mt_file_rest_required_fields(request_type=adaptive_mt.DeleteAdaptiveMtFileRequest):
    transport_class = transports.TranslationServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_adaptive_mt_file._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_adaptive_mt_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_delete_adaptive_mt_file") as pre:
        pre.assert_not_called()
        pb_message = adaptive_mt.DeleteAdaptiveMtFileRequest.pb(adaptive_mt.DeleteAdaptiveMtFileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_adaptive_mt_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_adaptive_mt_file_rest_bad_request(transport: str = 'rest', request_type=adaptive_mt.DeleteAdaptiveMtFileRequest):
    client = TranslationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_adaptive_mt_file_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/adaptiveMtDatasets/sample3'}
    request = request_type(**request_init)
...
def test_import_adaptive_mt_file_rest_required_fields(request_type=adaptive_mt.ImportAdaptiveMtFileRequest):
    transport_class = transports.TranslationServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_adaptive_mt_file._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_adaptive_mt_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_import_adaptive_mt_file") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_import_adaptive_mt_file") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = adaptive_mt.ImportAdaptiveMtFileRequest.pb(adaptive_mt.ImportAdaptiveMtFileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = adaptive_mt.ImportAdaptiveMtFileResponse.to_json(adaptive_mt.ImportAdaptiveMtFileResponse())
        ...
        client.import_adaptive_mt_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_import_adaptive_mt_file_rest_bad_request(transport: str = 'rest', request_type=adaptive_mt.ImportAdaptiveMtFileRequest):
    client = TranslationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_adaptive_mt_file_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/adaptiveMtDatasets/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/adaptiveMtDatasets/*}:importAdaptiveMtFile" % client.transport._host, args[1])
...
def test_list_adaptive_mt_files_rest_required_fields(request_type=adaptive_mt.ListAdaptiveMtFilesRequest):
    transport_class = transports.TranslationServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_adaptive_mt_files._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_adaptive_mt_files_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_list_adaptive_mt_files") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_list_adaptive_mt_files") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = adaptive_mt.ListAdaptiveMtFilesRequest.pb(adaptive_mt.ListAdaptiveMtFilesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = adaptive_mt.ListAdaptiveMtFilesResponse.to_json(adaptive_mt.ListAdaptiveMtFilesResponse())
        ...
        client.list_adaptive_mt_files(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_adaptive_mt_files_rest_bad_request(transport: str = 'rest', request_type=adaptive_mt.ListAdaptiveMtFilesRequest):
    client = TranslationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_adaptive_mt_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/adaptiveMtDatasets/*}/adaptiveMtFiles" % client.transport._host, args[1])
...
def test_list_adaptive_mt_files_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(adaptive_mt.ListAdaptiveMtFilesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_list_adaptive_mt_sentences_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/adaptiveMtDatasets/sample3/adaptiveMtFiles/sample4'}
    request = request_type(**request_init)
...
def test_list_adaptive_mt_sentences_rest_required_fields(request_type=adaptive_mt.ListAdaptiveMtSentencesRequest):
    transport_class = transports.TranslationServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_adaptive_mt_sentences._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_adaptive_mt_sentences_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_list_adaptive_mt_sentences") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_list_adaptive_mt_sentences") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = adaptive_mt.ListAdaptiveMtSentencesRequest.pb(adaptive_mt.ListAdaptiveMtSentencesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = adaptive_mt.ListAdaptiveMtSentencesResponse.to_json(adaptive_mt.ListAdaptiveMtSentencesResponse())
        ...
        client.list_adaptive_mt_sentences(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_adaptive_mt_sentences_rest_bad_request(transport: str = 'rest', request_type=adaptive_mt.ListAdaptiveMtSentencesRequest):
    client = TranslationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_adaptive_mt_sentences_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/adaptiveMtDatasets/sample3/adaptiveMtFiles/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/adaptiveMtDatasets/*/adaptiveMtFiles/*}/adaptiveMtSentences" % client.transport._host, args[1])
...
def test_list_adaptive_mt_sentences_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(adaptive_mt.ListAdaptiveMtSentencesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_adaptive_mt_dataset_path():
    ...
    location = "clam"
    dataset = "whelk"
    expected = "projects/{project}/locations/{location}/adaptiveMtDatasets/{dataset}".format(project=project, location=location, dataset=dataset, )
    actual = TranslationServiceClient.adaptive_mt_dataset_path(project, location, dataset)
...
def test_adaptive_mt_file_path():
    ...
    dataset = "winkle"
    file = "nautilus"
    expected = "projects/{project}/locations/{location}/adaptiveMtDatasets/{dataset}/adaptiveMtFiles/{file}".format(project=project, location=location, dataset=dataset, file=file, )
    actual = TranslationServiceClient.adaptive_mt_file_path(project, location, dataset, file)
    assert expected == actual
...
def test_adaptive_mt_sentence_path():
    ...
    file = "nudibranch"
    sentence = "cuttlefish"
    expected = "projects/{project}/locations/{location}/adaptiveMtDatasets/{dataset}/adaptiveMtFiles/{file}/adaptiveMtSentences/{sentence}".format(project=project, location=location, dataset=dataset, file=file, sentence=sentence, )
    actual = TranslationServiceClient.adaptive_mt_sentence_path(project, location, dataset, file, sentence)
    assert expected == actual

...
class TranslationServiceAsyncClient:
    ...
    async def get_glossary_entry(self,
    ...
    async def list_glossary_entries(self,
    ...
    async def create_glossary_entry(self,
    ...
    async def update_glossary_entry(self,
    ...
    async def delete_glossary_entry(self,
    ...
    async def create_adaptive_mt_dataset(self,
    ...
    async def delete_adaptive_mt_dataset(self,
    ...
    async def get_adaptive_mt_dataset(self,
    ...
    async def list_adaptive_mt_datasets(self,
    ...
    async def adaptive_mt_translate(self,
    ...
    async def get_adaptive_mt_file(self,
    ...
    async def delete_adaptive_mt_file(self,
    ...
    async def import_adaptive_mt_file(self,
    ...
    async def list_adaptive_mt_files(self,
    ...
    async def list_adaptive_mt_sentences(self,

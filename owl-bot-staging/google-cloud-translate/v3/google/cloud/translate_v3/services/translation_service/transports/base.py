...
class TranslationServiceTransport(abc.ABC):
    ...
    @property
    def romanize_text(self) -> Callable[
    ...
    @property
    def update_glossary(self) -> Callable[
    ...
    @property
    def get_glossary_entry(self) -> Callable[
    ...
    @property
    def list_glossary_entries(self) -> Callable[
    ...
    @property
    def create_glossary_entry(self) -> Callable[
    ...
    @property
    def update_glossary_entry(self) -> Callable[
    ...
    @property
    def delete_glossary_entry(self) -> Callable[
    ...
    def get_dataset(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[automl_translation.Dataset]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def create_adaptive_mt_dataset(self) -> Callable[
    ...
    @property
    def delete_adaptive_mt_dataset(self) -> Callable[
    ...
    @property
    def get_adaptive_mt_dataset(self) -> Callable[
    ...
    @property
    def list_adaptive_mt_datasets(self) -> Callable[
    ...
    @property
    def adaptive_mt_translate(self) -> Callable[
    ...
    @property
    def get_adaptive_mt_file(self) -> Callable[
            [adaptive_mt.GetAdaptiveMtFileRequest],
            Union[
                adaptive_mt.AdaptiveMtFile,
                Awaitable[adaptive_mt.AdaptiveMtFile]
            ]]:
        raise NotImplementedError()

    @property
    def delete_adaptive_mt_file(self) -> Callable[
    ...
    @property
    def import_adaptive_mt_file(self) -> Callable[
    ...
    @property
    def list_adaptive_mt_files(self) -> Callable[
    ...
    @property
    def list_adaptive_mt_sentences(self) -> Callable[
    ...
    def get_model(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[automl_translation.Model]
            ]]:
        raise NotImplementedError()

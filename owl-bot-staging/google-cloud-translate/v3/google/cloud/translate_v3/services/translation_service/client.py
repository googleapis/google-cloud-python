...
from google.cloud.translate_v3.types import adaptive_mt
...
class TranslationServiceClient(metaclass=TranslationServiceClientMeta):
    ...
    @staticmethod
    def adaptive_mt_dataset_path(project: str,location: str,dataset: str,) -> str:
        """Returns a fully-qualified adaptive_mt_dataset string."""
        return "projects/{project}/locations/{location}/adaptiveMtDatasets/{dataset}".format(project=project, location=location, dataset=dataset, )

    @staticmethod
    def parse_adaptive_mt_dataset_path(path: str) -> Dict[str,str]:
        """Parses a adaptive_mt_dataset path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/adaptiveMtDatasets/(?P<dataset>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def adaptive_mt_file_path(project: str,location: str,dataset: str,file: str,) -> str:
        """Returns a fully-qualified adaptive_mt_file string."""
        return "projects/{project}/locations/{location}/adaptiveMtDatasets/{dataset}/adaptiveMtFiles/{file}".format(project=project, location=location, dataset=dataset, file=file, )

    @staticmethod
    def parse_adaptive_mt_file_path(path: str) -> Dict[str,str]:
        """Parses a adaptive_mt_file path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/adaptiveMtDatasets/(?P<dataset>.+?)/adaptiveMtFiles/(?P<file>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def adaptive_mt_sentence_path(project: str,location: str,dataset: str,file: str,sentence: str,) -> str:
        """Returns a fully-qualified adaptive_mt_sentence string."""
        return "projects/{project}/locations/{location}/adaptiveMtDatasets/{dataset}/adaptiveMtFiles/{file}/adaptiveMtSentences/{sentence}".format(project=project, location=location, dataset=dataset, file=file, sentence=sentence, )

    @staticmethod
    def parse_adaptive_mt_sentence_path(path: str) -> Dict[str,str]:
        """Parses a adaptive_mt_sentence path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/adaptiveMtDatasets/(?P<dataset>.+?)/adaptiveMtFiles/(?P<file>.+?)/adaptiveMtSentences/(?P<sentence>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def example_path(project: str,location: str,dataset: str,example: str,) -> str:
        """Returns a fully-qualified example string."""
        return "projects/{project}/locations/{location}/datasets/{dataset}/examples/{example}".format(project=project, location=location, dataset=dataset, example=example, )

    @staticmethod
    def parse_example_path(path: str) -> Dict[str,str]:
        """Parses a example path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/datasets/(?P<dataset>.+?)/examples/(?P<example>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def glossary_entry_path(project: str,location: str,glossary: str,glossary_entry: str,) -> str:
        """Returns a fully-qualified glossary_entry string."""
        return "projects/{project}/locations/{location}/glossaries/{glossary}/glossaryEntries/{glossary_entry}".format(project=project, location=location, glossary=glossary, glossary_entry=glossary_entry, )

    @staticmethod
    def parse_glossary_entry_path(path: str) -> Dict[str,str]:
        """Parses a glossary_entry path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/glossaries/(?P<glossary>.+?)/glossaryEntries/(?P<glossary_entry>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = TranslationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            TranslationServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TranslationServiceTransport, Callable[..., TranslationServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = TranslationServiceClient._read_environment_variables()
        self._client_cert_source = TranslationServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = TranslationServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TranslationServiceTransport], Callable[..., TranslationServiceTransport]] = (
    ...
    def detect_language(self,
            request: Optional[Union[translation_service.DetectLanguageRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            model: Optional[str] = None,
            mime_type: Optional[str] = None,
    ...
    def get_supported_languages(self,
            request: Optional[Union[translation_service.GetSupportedLanguagesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            model: Optional[str] = None,
    ...
    def translate_document(self,
            request: Optional[Union[translation_service.TranslateDocumentRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    def batch_translate_text(self,
            request: Optional[Union[translation_service.BatchTranslateTextRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    def batch_translate_document(self,
            request: Optional[Union[translation_service.BatchTranslateDocumentRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            source_language_code: Optional[str] = None,
            target_language_codes: Optional[MutableSequence[str]] = None,
            input_configs: Optional[MutableSequence[translation_service.BatchDocumentInputConfig]] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, source_language_code, target_language_codes, input_configs, output_config])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def create_glossary(self,
            request: Optional[Union[translation_service.CreateGlossaryRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_glossary(self,
            request: Optional[Union[translation_service.UpdateGlossaryRequest, dict]] = None,
            *,
            glossary: Optional[translation_service.Glossary] = None,
    ...
    def list_glossaries(self,
            request: Optional[Union[translation_service.ListGlossariesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def delete_glossary(self,
            request: Optional[Union[translation_service.DeleteGlossaryRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_glossary_entry(self,
            request: Optional[Union[translation_service.GetGlossaryEntryRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_glossary_entries(self,
            request: Optional[Union[translation_service.ListGlossaryEntriesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_glossary_entry(self,
            request: Optional[Union[translation_service.CreateGlossaryEntryRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_glossary_entry(self,
            request: Optional[Union[translation_service.UpdateGlossaryEntryRequest, dict]] = None,
            *,
            glossary_entry: Optional[common.GlossaryEntry] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def delete_glossary_entry(self,
            request: Optional[Union[translation_service.DeleteGlossaryEntryRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_adaptive_mt_dataset(self,
            request: Optional[Union[adaptive_mt.CreateAdaptiveMtDatasetRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_adaptive_mt_dataset]
    ...
    def delete_adaptive_mt_dataset(self,
            request: Optional[Union[adaptive_mt.DeleteAdaptiveMtDatasetRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_adaptive_mt_dataset]
    ...
    def get_adaptive_mt_dataset(self,
    ...
    def list_adaptive_mt_datasets(self,
            request: Optional[Union[adaptive_mt.ListAdaptiveMtDatasetsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_adaptive_mt_datasets]
    ...
    def list_adaptive_mt_sentences(self,
            request: Optional[Union[adaptive_mt.ListAdaptiveMtSentencesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_adaptive_mt_sentences]

...
def test__get_api_endpoint():
    ...
    assert TranslationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == TranslationServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert TranslationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == TranslationServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_translate_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TranslationServiceRestInterceptor, "post_translate_text_with_metadata") as post_with_metadata, \
...
def test_detect_language_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TranslationServiceRestInterceptor, "post_detect_language_with_metadata") as post_with_metadata, \
...
def test_get_supported_languages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TranslationServiceRestInterceptor, "post_get_supported_languages_with_metadata") as post_with_metadata, \
...
def test_translate_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TranslationServiceRestInterceptor, "post_translate_document_with_metadata") as post_with_metadata, \
...
def test_batch_translate_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TranslationServiceRestInterceptor, "post_batch_translate_text_with_metadata") as post_with_metadata, \
...
def test_batch_translate_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TranslationServiceRestInterceptor, "post_batch_translate_document_with_metadata") as post_with_metadata, \
...
def test_create_glossary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TranslationServiceRestInterceptor, "post_create_glossary_with_metadata") as post_with_metadata, \
...
def test_list_glossaries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TranslationServiceRestInterceptor, "post_list_glossaries_with_metadata") as post_with_metadata, \
...
def test_get_glossary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TranslationServiceRestInterceptor, "post_get_glossary_with_metadata") as post_with_metadata, \
...
def test_delete_glossary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TranslationServiceRestInterceptor, "post_delete_glossary_with_metadata") as post_with_metadata, \

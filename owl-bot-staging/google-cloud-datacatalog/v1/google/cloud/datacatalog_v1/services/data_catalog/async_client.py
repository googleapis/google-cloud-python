...
class DataCatalogAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = DataCatalogClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = DataCatalogClient.get_transport_class
    ...
    async def search_catalog(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.search_catalog is deprecated",
            DeprecationWarning)
    ...
    async def create_entry_group(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.create_entry_group is deprecated",
            DeprecationWarning)
    ...
    async def get_entry_group(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.get_entry_group is deprecated",
            DeprecationWarning)
    ...
    async def update_entry_group(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.update_entry_group is deprecated",
            DeprecationWarning)
    ...
    async def delete_entry_group(self,
        ...
        Args:
            ...
            metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
                ...
                be of type `bytes`.
        """
        warnings.warn("DataCatalogAsyncClient.delete_entry_group is deprecated",
            DeprecationWarning)
    ...
    async def list_entry_groups(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.list_entry_groups is deprecated",
            DeprecationWarning)
    ...
    async def create_entry(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.create_entry is deprecated",
            DeprecationWarning)
    ...
    async def update_entry(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.update_entry is deprecated",
            DeprecationWarning)
    ...
    async def delete_entry(self,
        ...
        Args:
            ...
            metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
                ...
                be of type `bytes`.
        """
        warnings.warn("DataCatalogAsyncClient.delete_entry is deprecated",
            DeprecationWarning)
    ...
    async def get_entry(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.get_entry is deprecated",
            DeprecationWarning)
    ...
    async def lookup_entry(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.lookup_entry is deprecated",
            DeprecationWarning)
    ...
    async def list_entries(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.list_entries is deprecated",
            DeprecationWarning)
    ...
    async def modify_entry_overview(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.modify_entry_overview is deprecated",
            DeprecationWarning)
    ...
    async def modify_entry_contacts(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.modify_entry_contacts is deprecated",
            DeprecationWarning)
    ...
    async def create_tag_template(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.create_tag_template is deprecated",
            DeprecationWarning)
    ...
    async def get_tag_template(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.get_tag_template is deprecated",
            DeprecationWarning)
    ...
    async def update_tag_template(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.update_tag_template is deprecated",
            DeprecationWarning)
    ...
    async def delete_tag_template(self,
        ...
        Args:
            ...
            metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
                ...
                be of type `bytes`.
        """
        warnings.warn("DataCatalogAsyncClient.delete_tag_template is deprecated",
            DeprecationWarning)
    ...
    async def create_tag_template_field(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.create_tag_template_field is deprecated",
            DeprecationWarning)
    ...
    async def update_tag_template_field(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.update_tag_template_field is deprecated",
            DeprecationWarning)
    ...
    async def rename_tag_template_field(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.rename_tag_template_field is deprecated",
            DeprecationWarning)
    ...
    async def rename_tag_template_field_enum_value(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.rename_tag_template_field_enum_value is deprecated",
            DeprecationWarning)
    ...
    async def delete_tag_template_field(self,
        ...
        Args:
            ...
            metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
                ...
                be of type `bytes`.
        """
        warnings.warn("DataCatalogAsyncClient.delete_tag_template_field is deprecated",
            DeprecationWarning)
    ...
    async def create_tag(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.create_tag is deprecated",
            DeprecationWarning)
    ...
    async def update_tag(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.update_tag is deprecated",
            DeprecationWarning)
    ...
    async def delete_tag(self,
        ...
        Args:
            ...
            metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
                ...
                be of type `bytes`.
        """
        warnings.warn("DataCatalogAsyncClient.delete_tag is deprecated",
            DeprecationWarning)
    ...
    async def list_tags(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.list_tags is deprecated",
            DeprecationWarning)
    ...
    async def reconcile_tags(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.reconcile_tags is deprecated",
            DeprecationWarning)
    ...
    async def star_entry(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.star_entry is deprecated",
            DeprecationWarning)
    ...
    async def unstar_entry(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.unstar_entry is deprecated",
            DeprecationWarning)
    ...
    async def set_iam_policy(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.set_iam_policy is deprecated",
            DeprecationWarning)
    ...
    async def get_iam_policy(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.get_iam_policy is deprecated",
            DeprecationWarning)
    ...
    async def test_iam_permissions(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.test_iam_permissions is deprecated",
            DeprecationWarning)
    ...
    async def import_entries(self,
        ...
        """
        warnings.warn("DataCatalogAsyncClient.import_entries is deprecated",
            DeprecationWarning)
    ...
    async def set_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.datacatalog_v1.types.SetConfigRequest, dict]]):
                The request object. Request message for
        ...
        """
        warnings.warn("DataCatalogAsyncClient.set_config is deprecated",
            DeprecationWarning)
    ...
    async def retrieve_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.datacatalog_v1.types.RetrieveConfigRequest, dict]]):
                The request object. Request message for
        ...
        """
        warnings.warn("DataCatalogAsyncClient.retrieve_config is deprecated",
            DeprecationWarning)
    ...
    async def retrieve_effective_config(self,
        ...
        .. code-block:: python
            ...
            async def sample_retrieve_effective_config():
                ...
                # Make the request
                response = await client.retrieve_effective_config(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.datacatalog_v1.types.RetrieveEffectiveConfigRequest, dict]]):
                The request object. Request message for
                [RetrieveEffectiveConfig][google.cloud.datacatalog.v1.DataCatalog.RetrieveEffectiveConfig].
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        """
        warnings.warn("DataCatalogAsyncClient.retrieve_effective_config is deprecated",
            DeprecationWarning)

...
class DataCatalogGrpcTransport(DataCatalogTransport):
    ...
    @property
    def reconcile_tags(self) -> Callable[
    ...
    @property
    def import_entries(self) -> Callable[
    ...
    @property
    def retrieve_config(self) -> Callable[
    ...
    @property
    def retrieve_effective_config(self) -> Callable[

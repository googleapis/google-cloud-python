...
class PolicyTagManagerSerializationAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PolicyTagManagerSerializationTransport, Callable[..., PolicyTagManagerSerializationTransport]]] = "grpc_asyncio",
    ...
    async def replace_taxonomy(self,

...
@mock.patch.object(PolicyTagManagerSerializationClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PolicyTagManagerSerializationClient))
@mock.patch.object(PolicyTagManagerSerializationAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PolicyTagManagerSerializationAsyncClient))
def test__get_api_endpoint():
    ...
    assert PolicyTagManagerSerializationClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == PolicyTagManagerSerializationClient.DEFAULT_MTLS_ENDPOINT
    assert PolicyTagManagerSerializationClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert PolicyTagManagerSerializationClient._get_api_endpoint(None, None, default_universe, "always") == PolicyTagManagerSerializationClient.DEFAULT_MTLS_ENDPOINT
    assert PolicyTagManagerSerializationClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == PolicyTagManagerSerializationClient.DEFAULT_MTLS_ENDPOINT
...
async def test_replace_taxonomy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.replace_taxonomy] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.import_taxonomies] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.export_taxonomies] = mock_object

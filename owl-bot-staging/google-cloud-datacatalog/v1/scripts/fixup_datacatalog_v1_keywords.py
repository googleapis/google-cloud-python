...
class datacatalogCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'get_taxonomy': ('name', ),
        'import_entries': ('parent', 'gcs_bucket_path', 'job_id', ),
        ...
        'lookup_entry': ('linked_resource', 'sql_resource', 'fully_qualified_name', 'project', 'location', ),
        'modify_entry_contacts': ('name', 'contacts', ),
        'modify_entry_overview': ('name', 'entry_overview', ),
        'reconcile_tags': ('parent', 'tag_template', 'force_delete_missing', 'tags', ),
        ...
        'search_catalog': ('scope', 'query', 'page_size', 'page_token', 'order_by', 'admin_search', ),

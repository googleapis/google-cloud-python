...
def test__read_environment_variables():
    assert BetaAnalyticsDataClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert BetaAnalyticsDataClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert BetaAnalyticsDataClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert BetaAnalyticsDataClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert BetaAnalyticsDataClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert BetaAnalyticsDataClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert BetaAnalyticsDataClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert BetaAnalyticsDataClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert BetaAnalyticsDataClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(BetaAnalyticsDataClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BetaAnalyticsDataClient))
@mock.patch.object(BetaAnalyticsDataAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BetaAnalyticsDataAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BetaAnalyticsDataClient._DEFAULT_UNIVERSE
    default_endpoint = BetaAnalyticsDataClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = BetaAnalyticsDataClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert BetaAnalyticsDataClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert BetaAnalyticsDataClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BetaAnalyticsDataClient.DEFAULT_MTLS_ENDPOINT
    assert BetaAnalyticsDataClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert BetaAnalyticsDataClient._get_api_endpoint(None, None, default_universe, "always") == BetaAnalyticsDataClient.DEFAULT_MTLS_ENDPOINT
    assert BetaAnalyticsDataClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BetaAnalyticsDataClient.DEFAULT_MTLS_ENDPOINT
    assert BetaAnalyticsDataClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert BetaAnalyticsDataClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        BetaAnalyticsDataClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert BetaAnalyticsDataClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert BetaAnalyticsDataClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert BetaAnalyticsDataClient._get_universe_domain(None, None) == BetaAnalyticsDataClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (BetaAnalyticsDataClient, transports.BetaAnalyticsDataRestTransport, "rest", "true"),
    (BetaAnalyticsDataClient, transports.BetaAnalyticsDataRestTransport, "rest", "false"),
])
@mock.patch.object(BetaAnalyticsDataClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BetaAnalyticsDataClient))
@mock.patch.object(BetaAnalyticsDataAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BetaAnalyticsDataAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (BetaAnalyticsDataClient, transports.BetaAnalyticsDataGrpcTransport, "grpc", grpc_helpers),
    (BetaAnalyticsDataAsyncClient, transports.BetaAnalyticsDataGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (BetaAnalyticsDataClient, transports.BetaAnalyticsDataRestTransport, "rest", None),
])
...
async def test_run_report_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.run_report in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.run_report] = mock_rpc
...
def test_run_pivot_report_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.run_pivot_report] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_run_pivot_report_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BetaAnalyticsDataAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.run_pivot_report in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.run_pivot_report] = mock_rpc
...
def test_batch_run_reports_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_run_reports] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_run_reports_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BetaAnalyticsDataAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_run_reports in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_run_reports] = mock_rpc
...
def test_batch_run_pivot_reports_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_run_pivot_reports in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_run_pivot_reports] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_run_pivot_reports_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BetaAnalyticsDataAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_run_pivot_reports in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_run_pivot_reports] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_metadata_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BetaAnalyticsDataAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_metadata in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_metadata] = mock_rpc
...
def test_run_realtime_report_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.run_realtime_report in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.run_realtime_report] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_run_realtime_report_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BetaAnalyticsDataAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.run_realtime_report in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.run_realtime_report] = mock_rpc
...
def test_check_compatibility(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.check_compatibility),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_audience_export(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_audience_export),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_audience_export_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_audience_export in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_audience_export] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_audience_export_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BetaAnalyticsDataAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_audience_export in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_audience_export] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_audience_export_async(transport: str = 'grpc_asyncio', request_type=analytics_data_api.CreateAudienceExportRequest):
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_query_audience_export(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.query_audience_export),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_query_audience_export_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.query_audience_export in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.query_audience_export] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_query_audience_export_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BetaAnalyticsDataAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.query_audience_export in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.query_audience_export] = mock_rpc
...
@pytest.mark.asyncio
async def test_query_audience_export_async(transport: str = 'grpc_asyncio', request_type=analytics_data_api.QueryAudienceExportRequest):
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_data_api.QueryAudienceExportResponse(
            row_count=992,
        ))
...
def test_get_audience_export(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_audience_export),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_audience_export_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_audience_export in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_audience_export] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_audience_export_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BetaAnalyticsDataAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_audience_export in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_audience_export] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_audience_export_async(transport: str = 'grpc_asyncio', request_type=analytics_data_api.GetAudienceExportRequest):
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_data_api.AudienceExport(
            name='name_value',
            audience='audience_value',
            audience_display_name='audience_display_name_value',
            state=analytics_data_api.AudienceExport.State.CREATING,
...
def test_list_audience_exports_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_audience_exports in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_audience_exports] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_audience_exports_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BetaAnalyticsDataAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_audience_exports in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_audience_exports] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_audience_exports_async(transport: str = 'grpc_asyncio', request_type=analytics_data_api.ListAudienceExportsRequest):
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_data_api.ListAudienceExportsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_audience_exports_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, analytics_data_api.AudienceExport)
                   for i in results)
...
async def test_list_audience_exports_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_audience_exports(request={},)
...
def test_create_audience_export_rest_required_fields(request_type=analytics_data_api.CreateAudienceExportRequest):
    transport_class = transports.BetaAnalyticsDataRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_audience_export._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_audience_export_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "audienceExport", )))
...
def test_create_audience_export_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=properties/*}/audienceExports" % client.transport._host, args[1])
...
def test_query_audience_export_rest_required_fields(request_type=analytics_data_api.QueryAudienceExportRequest):
    transport_class = transports.BetaAnalyticsDataRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_audience_export._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_query_audience_export_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=properties/*/audienceExports/*}:query" % client.transport._host, args[1])
...
def test_get_audience_export_rest_required_fields(request_type=analytics_data_api.GetAudienceExportRequest):
    transport_class = transports.BetaAnalyticsDataRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_audience_export._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_audience_export_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=properties/*/audienceExports/*}" % client.transport._host, args[1])
...
def test_list_audience_exports_rest_required_fields(request_type=analytics_data_api.ListAudienceExportsRequest):
    transport_class = transports.BetaAnalyticsDataRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_audience_exports._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_audience_exports_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(analytics_data_api.ListAudienceExportsResponse.to_json(x) for x in response)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_run_pivot_report_empty_call_grpc():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = analytics_data_api.RunPivotReportResponse()
        client.run_pivot_report(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = analytics_data_api.RunPivotReportRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_run_reports_empty_call_grpc():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = analytics_data_api.BatchRunReportsResponse()
        client.batch_run_reports(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = analytics_data_api.BatchRunReportsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_run_pivot_reports_empty_call_grpc():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = analytics_data_api.BatchRunPivotReportsResponse()
        client.batch_run_pivot_reports(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = analytics_data_api.BatchRunPivotReportsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_run_realtime_report_empty_call_grpc():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = analytics_data_api.RunRealtimeReportResponse()
        client.run_realtime_report(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = analytics_data_api.RunRealtimeReportRequest()
...
def test_check_compatibility_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = analytics_data_api.CheckCompatibilityRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_audience_export_empty_call_grpc():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_audience_export(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = analytics_data_api.CreateAudienceExportRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_audience_export_empty_call_grpc():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = analytics_data_api.QueryAudienceExportResponse()
        client.query_audience_export(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = analytics_data_api.QueryAudienceExportRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_audience_export_empty_call_grpc():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = analytics_data_api.AudienceExport()
        client.get_audience_export(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = analytics_data_api.GetAudienceExportRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_audience_exports_empty_call_grpc():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = analytics_data_api.ListAudienceExportsResponse()
        client.list_audience_exports(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = analytics_data_api.ListAudienceExportsRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = BetaAnalyticsDataAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_run_pivot_report_empty_call_grpc_asyncio():
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.run_pivot_report(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_run_reports_empty_call_grpc_asyncio():
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_run_reports(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_run_pivot_reports_empty_call_grpc_asyncio():
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_run_pivot_reports(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_run_realtime_report_empty_call_grpc_asyncio():
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.run_realtime_report(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_audience_export_empty_call_grpc_asyncio():
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_audience_export(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_query_audience_export_empty_call_grpc_asyncio():
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.query_audience_export(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_audience_export_empty_call_grpc_asyncio():
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_audience_export(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_audience_exports_empty_call_grpc_asyncio():
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_audience_exports(request=None)
...
def test_transport_kind_rest():
    transport = BetaAnalyticsDataClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_run_report_rest_interceptors(null_interceptor):
    transport = transports.BetaAnalyticsDataRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BetaAnalyticsDataRestInterceptor(),
        )
    client = BetaAnalyticsDataClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_run_report") as post, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_run_report_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "pre_run_report") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = analytics_data_api.RunReportResponse.to_json(analytics_data_api.RunReportResponse())
        ...
        post_with_metadata.return_value = analytics_data_api.RunReportResponse(), metadata
...
def test_run_pivot_report_rest_bad_request(request_type=analytics_data_api.RunPivotReportRequest):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_run_pivot_report_rest_call_success(request_type):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_run_pivot_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_run_pivot_report") as post, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_run_pivot_report_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "pre_run_pivot_report") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = analytics_data_api.RunPivotReportResponse.to_json(analytics_data_api.RunPivotReportResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = analytics_data_api.RunPivotReportResponse(), metadata
...
def test_batch_run_reports_rest_bad_request(request_type=analytics_data_api.BatchRunReportsRequest):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_run_reports_rest_call_success(request_type):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_run_reports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_batch_run_reports") as post, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_batch_run_reports_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "pre_batch_run_reports") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = analytics_data_api.BatchRunReportsResponse.to_json(analytics_data_api.BatchRunReportsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = analytics_data_api.BatchRunReportsResponse(), metadata
...
def test_batch_run_pivot_reports_rest_bad_request(request_type=analytics_data_api.BatchRunPivotReportsRequest):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_run_pivot_reports_rest_call_success(request_type):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_run_pivot_reports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_batch_run_pivot_reports") as post, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_batch_run_pivot_reports_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "pre_batch_run_pivot_reports") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = analytics_data_api.BatchRunPivotReportsResponse.to_json(analytics_data_api.BatchRunPivotReportsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = analytics_data_api.BatchRunPivotReportsResponse(), metadata
...
def test_get_metadata_rest_bad_request(request_type=analytics_data_api.GetMetadataRequest):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_get_metadata") as post, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_get_metadata_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "pre_get_metadata") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = analytics_data_api.Metadata.to_json(analytics_data_api.Metadata())
        req.return_value.content = return_value
...
def test_run_realtime_report_rest_bad_request(request_type=analytics_data_api.RunRealtimeReportRequest):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_run_realtime_report_rest_call_success(request_type):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_run_realtime_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_run_realtime_report") as post, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_run_realtime_report_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "pre_run_realtime_report") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = analytics_data_api.RunRealtimeReportResponse.to_json(analytics_data_api.RunRealtimeReportResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = analytics_data_api.RunRealtimeReportResponse(), metadata
...
def test_check_compatibility_rest_bad_request(request_type=analytics_data_api.CheckCompatibilityRequest):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_check_compatibility_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_check_compatibility") as post, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_check_compatibility_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "pre_check_compatibility") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = analytics_data_api.CheckCompatibilityResponse.to_json(analytics_data_api.CheckCompatibilityResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = analytics_data_api.CheckCompatibilityResponse(), metadata
...
def test_create_audience_export_rest_bad_request(request_type=analytics_data_api.CreateAudienceExportRequest):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_audience_export_rest_call_success(request_type):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'properties/sample1'}
    request_init["audience_export"] = {'name': 'name_value', 'audience': 'audience_value', 'audience_display_name': 'audience_display_name_value', 'dimensions': [{'dimension_name': 'dimension_name_value'}], 'state': 1, 'begin_creating_time': {'seconds': 751, 'nanos': 543}, 'creation_quota_tokens_charged': 3070, 'row_count': 992, 'error_message': 'error_message_value', 'percentage_completed': 0.2106}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = analytics_data_api.CreateAudienceExportRequest.meta.fields["audience_export"]
...
def test_create_audience_export_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_create_audience_export") as post, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_create_audience_export_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "pre_create_audience_export") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = analytics_data_api.CreateAudienceExportRequest.pb(analytics_data_api.CreateAudienceExportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_audience_export(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_query_audience_export_rest_bad_request(request_type=analytics_data_api.QueryAudienceExportRequest):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_query_audience_export_rest_call_success(request_type):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_query_audience_export_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_query_audience_export") as post, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_query_audience_export_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "pre_query_audience_export") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = analytics_data_api.QueryAudienceExportRequest.pb(analytics_data_api.QueryAudienceExportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = analytics_data_api.QueryAudienceExportResponse.to_json(analytics_data_api.QueryAudienceExportResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = analytics_data_api.QueryAudienceExportResponse(), metadata

        client.query_audience_export(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_audience_export_rest_bad_request(request_type=analytics_data_api.GetAudienceExportRequest):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_audience_export_rest_call_success(request_type):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_audience_export_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_get_audience_export") as post, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_get_audience_export_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "pre_get_audience_export") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = analytics_data_api.GetAudienceExportRequest.pb(analytics_data_api.GetAudienceExportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = analytics_data_api.AudienceExport.to_json(analytics_data_api.AudienceExport())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = analytics_data_api.AudienceExport(), metadata

        client.get_audience_export(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_audience_exports_rest_bad_request(request_type=analytics_data_api.ListAudienceExportsRequest):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_audience_exports_rest_call_success(request_type):
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_audience_exports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_list_audience_exports") as post, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_list_audience_exports_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "pre_list_audience_exports") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = analytics_data_api.ListAudienceExportsRequest.pb(analytics_data_api.ListAudienceExportsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = analytics_data_api.ListAudienceExportsResponse.to_json(analytics_data_api.ListAudienceExportsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = analytics_data_api.ListAudienceExportsResponse(), metadata

        client.list_audience_exports(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_run_pivot_report_empty_call_rest():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_run_reports_empty_call_rest():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_run_pivot_reports_empty_call_rest():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_run_realtime_report_empty_call_rest():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_audience_export_empty_call_rest():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_audience_export_empty_call_rest():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_audience_export_empty_call_rest():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_audience_exports_empty_call_rest():
    client = BetaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_audience_export_path():
    ...
    expected = "properties/{property}/audienceExports/{audience_export}".format(property=property, audience_export=audience_export, )
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (BetaAnalyticsDataAsyncClient, transports.BetaAnalyticsDataGrpcAsyncIOTransport),
])

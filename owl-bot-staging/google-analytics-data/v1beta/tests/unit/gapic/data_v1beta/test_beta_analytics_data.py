...
def test_get_metadata_rest_required_fields(request_type=analytics_data_api.GetMetadataRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_metadata._get_unset_required_fields(jsonified_request)
...
def test_get_metadata_rest_unset_required_fields():
    transport = transports.BetaAnalyticsDataRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_audience_export_rest_required_fields(request_type=analytics_data_api.CreateAudienceExportRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_audience_export._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_query_audience_export_rest_required_fields(request_type=analytics_data_api.QueryAudienceExportRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).query_audience_export._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_audience_export_rest_required_fields(request_type=analytics_data_api.GetAudienceExportRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_audience_export._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_audience_exports_rest_required_fields(request_type=analytics_data_api.ListAudienceExportsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_audience_exports._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
class BetaAnalyticsDataTransport(abc.ABC):
    ...
    @property
    def create_audience_export(self) -> Callable[
    ...
    @property
    def query_audience_export(self) -> Callable[
    ...
    @property
    def get_audience_export(self) -> Callable[
    ...
    @property
    def list_audience_exports(self) -> Callable[

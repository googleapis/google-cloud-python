...
class BetaAnalyticsDataRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_create_audience_export(self, request: analytics_data_api.CreateAudienceExportRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[analytics_data_api.CreateAudienceExportRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_audience_export(self, request: analytics_data_api.GetAudienceExportRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[analytics_data_api.GetAudienceExportRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_audience_exports(self, request: analytics_data_api.ListAudienceExportsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[analytics_data_api.ListAudienceExportsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_query_audience_export(self, request: analytics_data_api.QueryAudienceExportRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[analytics_data_api.QueryAudienceExportRequest, Sequence[Tuple[str, str]]]:

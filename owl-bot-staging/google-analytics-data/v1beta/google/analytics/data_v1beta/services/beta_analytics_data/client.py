...
class BetaAnalyticsDataClient(metaclass=BetaAnalyticsDataClientMeta):
    ...
    @staticmethod
    def audience_export_path(property: str,audience_export: str,) -> str:
        """Returns a fully-qualified audience_export string."""
        return "properties/{property}/audienceExports/{audience_export}".format(property=property, audience_export=audience_export, )

    @staticmethod
    def parse_audience_export_path(path: str) -> Dict[str,str]:
        """Parses a audience_export path into its component segments."""
        m = re.match(r"^properties/(?P<property>.+?)/audienceExports/(?P<audience_export>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = BetaAnalyticsDataClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            BetaAnalyticsDataClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BetaAnalyticsDataTransport, Callable[..., BetaAnalyticsDataTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = BetaAnalyticsDataClient._read_environment_variables()
        self._client_cert_source = BetaAnalyticsDataClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = BetaAnalyticsDataClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BetaAnalyticsDataTransport], Callable[..., BetaAnalyticsDataTransport]] = (
    ...
    def create_audience_export(self,
    ...
    def query_audience_export(self,
    ...
    def list_audience_exports(self,

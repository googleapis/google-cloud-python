...
class AlphaAnalyticsDataAsyncClient:
    ...
    get_transport_class = functools.partial(type(AlphaAnalyticsDataClient).get_transport_class, type(AlphaAnalyticsDataClient))
    ...
    async def run_funnel_report(self,
    ...
    async def create_audience_list(self,
    ...
    async def query_audience_list(self,
    ...
    async def sheet_export_audience_list(self,
    ...
    async def get_audience_list(self,
    ...
    async def list_audience_lists(self,
    ...
    async def create_recurring_audience_list(self,
    ...
    async def get_recurring_audience_list(self,
    ...
    async def list_recurring_audience_lists(self,
    ...
    async def create_report_task(self,
    ...
    async def query_report_task(self,
    ...
    async def get_report_task(self,
    ...
    async def list_report_tasks(self,

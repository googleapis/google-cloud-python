...
class AlphaAnalyticsDataClient(metaclass=AlphaAnalyticsDataClientMeta):
    ...
    @staticmethod
    def audience_list_path(property: str,audience_list: str,) -> str:
        """Returns a fully-qualified audience_list string."""
        return "properties/{property}/audienceLists/{audience_list}".format(property=property, audience_list=audience_list, )

    @staticmethod
    def parse_audience_list_path(path: str) -> Dict[str,str]:
        """Parses a audience_list path into its component segments."""
        m = re.match(r"^properties/(?P<property>.+?)/audienceLists/(?P<audience_list>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def property_quotas_snapshot_path(property: str,) -> str:
        """Returns a fully-qualified property_quotas_snapshot string."""
        return "properties/{property}/propertyQuotasSnapshot".format(property=property, )
    ...
    @staticmethod
    def recurring_audience_list_path(property: str,recurring_audience_list: str,) -> str:
        """Returns a fully-qualified recurring_audience_list string."""
        return "properties/{property}/recurringAudienceLists/{recurring_audience_list}".format(property=property, recurring_audience_list=recurring_audience_list, )
    ...
    def parse_recurring_audience_list_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^properties/(?P<property>.+?)/recurringAudienceLists/(?P<recurring_audience_list>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def report_task_path(property: str,report_task: str,) -> str:
        """Returns a fully-qualified report_task string."""
        return "properties/{property}/reportTasks/{report_task}".format(property=property, report_task=report_task, )

    @staticmethod
    def parse_report_task_path(path: str) -> Dict[str,str]:
        """Parses a report_task path into its component segments."""
        m = re.match(r"^properties/(?P<property>.+?)/reportTasks/(?P<report_task>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AlphaAnalyticsDataClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AlphaAnalyticsDataClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AlphaAnalyticsDataTransport, Callable[..., AlphaAnalyticsDataTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AlphaAnalyticsDataClient._read_environment_variables()
        self._client_cert_source = AlphaAnalyticsDataClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AlphaAnalyticsDataClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AlphaAnalyticsDataTransport], Callable[..., AlphaAnalyticsDataTransport]] = (
    ...
    def run_funnel_report(self,
            request: Optional[Union[analytics_data_api.RunFunnelReportRequest, dict]] = None,
            *,
    ...
    def create_audience_list(self,
            request: Optional[Union[analytics_data_api.CreateAudienceListRequest, dict]] = None,
            *,
    ...
    def query_audience_list(self,
            request: Optional[Union[analytics_data_api.QueryAudienceListRequest, dict]] = None,
            *,
    ...
    def sheet_export_audience_list(self,
            request: Optional[Union[analytics_data_api.SheetExportAudienceListRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.sheet_export_audience_list]
    ...
    def get_audience_list(self,
            request: Optional[Union[analytics_data_api.GetAudienceListRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_audience_lists(self,
            request: Optional[Union[analytics_data_api.ListAudienceListsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_recurring_audience_list(self,
            request: Optional[Union[analytics_data_api.CreateRecurringAudienceListRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            recurring_audience_list: Optional[analytics_data_api.RecurringAudienceList] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, analytics_data_api.CreateRecurringAudienceListRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_recurring_audience_list]
    ...
    def get_recurring_audience_list(self,
            request: Optional[Union[analytics_data_api.GetRecurringAudienceListRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_recurring_audience_list]
    ...
    def list_recurring_audience_lists(self,
            request: Optional[Union[analytics_data_api.ListRecurringAudienceListsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, analytics_data_api.ListRecurringAudienceListsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_recurring_audience_lists]
    ...
    def get_property_quotas_snapshot(self,
            request: Optional[Union[analytics_data_api.GetPropertyQuotasSnapshotRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_property_quotas_snapshot]
    ...
    def create_report_task(self,
            request: Optional[Union[analytics_data_api.CreateReportTaskRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def query_report_task(self,
            request: Optional[Union[analytics_data_api.QueryReportTaskRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_report_tasks(self,
            request: Optional[Union[analytics_data_api.ListReportTasksRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,

...
def test_create_audience_list_rest(request_type):
    ...
    request_init["audience_list"] = {'name': 'name_value', 'audience': 'audience_value', 'audience_display_name': 'audience_display_name_value', 'dimensions': [{'dimension_name': 'dimension_name_value'}], 'state': 1, 'begin_creating_time': {'seconds': 751, 'nanos': 543}}
...
def test_audience_list_path():
    propertyId = "squid"
    audienceListId = "clam"
    expected = "properties/{propertyId}/audienceLists/{audienceListId}".format(propertyId=propertyId, audienceListId=audienceListId, )

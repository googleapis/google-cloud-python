...
def test_get_property_quotas_snapshot_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_get_property_quotas_snapshot_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = AlphaAnalyticsDataAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_recurring_audience_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = analytics_data_api.RecurringAudienceList.to_json(analytics_data_api.RecurringAudienceList())
...
def test_create_recurring_audience_list_rest_bad_request(transport: str = 'rest', request_type=analytics_data_api.CreateRecurringAudienceListRequest):
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_recurring_audience_list_rest_bad_request(transport: str = 'rest', request_type=analytics_data_api.GetRecurringAudienceListRequest):
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_recurring_audience_lists_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = analytics_data_api.ListRecurringAudienceListsResponse.to_json(analytics_data_api.ListRecurringAudienceListsResponse())
...
def test_list_recurring_audience_lists_rest_bad_request(transport: str = 'rest', request_type=analytics_data_api.ListRecurringAudienceListsRequest):
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_property_quotas_snapshot_rest(request_type):
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_property_quotas_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = analytics_data_api.PropertyQuotasSnapshot.to_json(analytics_data_api.PropertyQuotasSnapshot())
...
def test_get_property_quotas_snapshot_rest_bad_request(transport: str = 'rest', request_type=analytics_data_api.GetPropertyQuotasSnapshotRequest):
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_property_quotas_snapshot_rest_error():
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_create_report_task_rest_bad_request(transport: str = 'rest', request_type=analytics_data_api.CreateReportTaskRequest):
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_report_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = analytics_data_api.QueryReportTaskResponse.to_json(analytics_data_api.QueryReportTaskResponse())
...
def test_query_report_task_rest_bad_request(transport: str = 'rest', request_type=analytics_data_api.QueryReportTaskRequest):
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_report_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = analytics_data_api.ReportTask.to_json(analytics_data_api.ReportTask())
...
def test_get_report_task_rest_bad_request(transport: str = 'rest', request_type=analytics_data_api.GetReportTaskRequest):
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_report_tasks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = analytics_data_api.ListReportTasksResponse.to_json(analytics_data_api.ListReportTasksResponse())
...
def test_list_report_tasks_rest_bad_request(transport: str = 'rest', request_type=analytics_data_api.ListReportTasksRequest):
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

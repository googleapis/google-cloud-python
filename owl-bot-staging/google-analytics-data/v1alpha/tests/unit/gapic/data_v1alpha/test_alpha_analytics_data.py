...
def test_create_audience_list_rest(request_type):
    ...
    request_init["audience_list"] = {'name': 'name_value', 'audience': 'audience_value', 'audience_display_name': 'audience_display_name_value', 'dimensions': [{'dimension_name': 'dimension_name_value'}], 'state': 1, 'begin_creating_time': {'seconds': 751, 'nanos': 543}, 'creation_quota_tokens_charged': 3070, 'row_count': 992, 'error_message': 'error_message_value', 'percentage_completed': 0.2106, 'recurring_audience_list': 'recurring_audience_list_value'}
...
def test_create_recurring_audience_list_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'properties/sample1'}
    request_init["recurring_audience_list"] = {'name': 'name_value', 'audience': 'audience_value', 'audience_display_name': 'audience_display_name_value', 'dimensions': [{'dimension_name': 'dimension_name_value'}], 'active_days_remaining': 2213, 'audience_lists': ['audience_lists_value1', 'audience_lists_value2']}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

...
@mock.patch.object(StreamingVideoIntelligenceServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StreamingVideoIntelligenceServiceClient))
@mock.patch.object(StreamingVideoIntelligenceServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StreamingVideoIntelligenceServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert StreamingVideoIntelligenceServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert StreamingVideoIntelligenceServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == StreamingVideoIntelligenceServiceClient.DEFAULT_MTLS_ENDPOINT
    assert StreamingVideoIntelligenceServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert StreamingVideoIntelligenceServiceClient._get_api_endpoint(None, None, default_universe, "always") == StreamingVideoIntelligenceServiceClient.DEFAULT_MTLS_ENDPOINT
    assert StreamingVideoIntelligenceServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == StreamingVideoIntelligenceServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    StreamingVideoIntelligenceServiceClient, StreamingVideoIntelligenceServiceAsyncClient
])
...
@mock.patch.object(StreamingVideoIntelligenceServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StreamingVideoIntelligenceServiceClient))
@mock.patch.object(StreamingVideoIntelligenceServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StreamingVideoIntelligenceServiceAsyncClient))
def test_streaming_video_intelligence_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (StreamingVideoIntelligenceServiceAsyncClient, transports.StreamingVideoIntelligenceServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
...
def test_streaming_annotate_video_use_cached_wrapped_rpc():
...
async def test_streaming_annotate_video_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.streaming_annotate_video] = mock_object
...
def test_transport_kind(transport_name):
    transport = StreamingVideoIntelligenceServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )

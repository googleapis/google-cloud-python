...
class StreamingVideoIntelligenceServiceGrpcAsyncIOTransport(StreamingVideoIntelligenceServiceTransport):
    ...
    def streaming_annotate_video(self) -> Callable[
        ...
        if 'streaming_annotate_video' not in self._stubs:
            self._stubs['streaming_annotate_video'] = self.grpc_channel.stream_stream(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.streaming_annotate_video: gapic_v1.method_async.wrap_method(

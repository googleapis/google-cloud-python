...
from .base import VideoIntelligenceServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class VideoIntelligenceServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_annotate_video(self, request: video_intelligence.AnnotateVideoRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[video_intelligence.AnnotateVideoRequest, Sequence[Tuple[str, str]]]:
...
class VideoIntelligenceServiceRestTransport(VideoIntelligenceServiceTransport):
    """REST backend transport for VideoIntelligenceService.
    ...
    class _AnnotateVideo(VideoIntelligenceServiceRestStub):
        def __hash__(self):
            return hash("AnnotateVideo")

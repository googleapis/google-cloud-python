...
class VideoIntelligenceServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_annotate_video(self, request: video_intelligence.AnnotateVideoRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[video_intelligence.AnnotateVideoRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_annotate_video_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for annotate_video
...
class VideoIntelligenceServiceRestTransport(_BaseVideoIntelligenceServiceRestTransport):
    ...
    class _AnnotateVideo(_BaseVideoIntelligenceServiceRestTransport._BaseAnnotateVideo, VideoIntelligenceServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = VideoIntelligenceServiceRestTransport._AnnotateVideo._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

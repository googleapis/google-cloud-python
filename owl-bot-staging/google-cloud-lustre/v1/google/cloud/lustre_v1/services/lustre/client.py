...
from .transports.grpc import LustreGrpcTransport
from .transports.grpc_asyncio import LustreGrpcAsyncIOTransport
from .transports.rest import LustreRestTransport


class LustreClientMeta(type):
    """Metaclass for the Lustre client.
...
class LustreClient(metaclass=LustreClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "lustre.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            LustreClient: The constructed client.
        """
    ...
    def transport(self) -> LustreTransport:
        ...
        Returns:
            LustreTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = LustreClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = LustreClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = LustreClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, LustreTransport, Callable[..., LustreTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = LustreClient._read_environment_variables()
        self._client_cert_source = LustreClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = LustreClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, LustreTransport)
        if transport_provided:
            # transport is a LustreTransport instance.
            ...
            self._transport = cast(LustreTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[LustreTransport], Callable[..., LustreTransport]] = (
                LustreClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., LustreTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.lustre_v1.LustreClient`.",
                    extra = {
    ...
    def list_instances(self,
        ...
        Args:
            request (Union[google.cloud.lustre_v1.types.ListInstancesRequest, dict]):
    ...
    def get_instance(self,
        ...
        Args:
            request (Union[google.cloud.lustre_v1.types.GetInstanceRequest, dict]):
    ...
    def create_instance(self,
        ...
        Args:
            request (Union[google.cloud.lustre_v1.types.CreateInstanceRequest, dict]):
    ...
    def update_instance(self,
        ...
        Args:
            request (Union[google.cloud.lustre_v1.types.UpdateInstanceRequest, dict]):
    ...
    def delete_instance(self,
        ...
        Args:
            request (Union[google.cloud.lustre_v1.types.DeleteInstanceRequest, dict]):
    ...
    def __enter__(self) -> "LustreClient":
        return self

...
from google.cloud.lustre_v1.services.lustre import LustreAsyncClient
from google.cloud.lustre_v1.services.lustre import LustreClient
from google.cloud.lustre_v1.services.lustre import pagers
from google.cloud.lustre_v1.services.lustre import transports
...
@pytest.mark.parametrize("client_class", [
    LustreClient, LustreAsyncClient
])
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LustreRestInterceptor, "post_list_instances") as post, \
        mock.patch.object(transports.LustreRestInterceptor, "post_list_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LustreRestInterceptor, "pre_list_instances") as pre:
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LustreRestInterceptor, "post_get_instance") as post, \
        mock.patch.object(transports.LustreRestInterceptor, "post_get_instance_with_metadata") as post_with_metadata, \
...
def test_create_instance_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["instance"] = {'name': 'name_value', 'filesystem': 'filesystem_value', 'capacity_gib': 1247, 'network': 'network_value', 'state': 1, 'mount_point': 'mount_point_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'labels': {}, 'per_unit_storage_throughput': 2931, 'gke_support_enabled': True}
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LustreRestInterceptor, "post_create_instance") as post, \
        mock.patch.object(transports.LustreRestInterceptor, "post_create_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LustreRestInterceptor, "pre_create_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_instance_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'instance': {'name': 'projects/sample1/locations/sample2/instances/sample3'}}
    request_init["instance"] = {'name': 'projects/sample1/locations/sample2/instances/sample3', 'filesystem': 'filesystem_value', 'capacity_gib': 1247, 'network': 'network_value', 'state': 1, 'mount_point': 'mount_point_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'labels': {}, 'per_unit_storage_throughput': 2931, 'gke_support_enabled': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LustreRestInterceptor, "post_update_instance") as post, \
        mock.patch.object(transports.LustreRestInterceptor, "post_update_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LustreRestInterceptor, "pre_update_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LustreRestInterceptor, "post_delete_instance") as post, \
        mock.patch.object(transports.LustreRestInterceptor, "post_delete_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LustreRestInterceptor, "pre_delete_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_import_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LustreRestInterceptor, "post_import_data_with_metadata") as post_with_metadata, \
...
def test_export_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LustreRestInterceptor, "post_export_data_with_metadata") as post_with_metadata, \
...
def test_lustre_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.lustre_v1.services.lustre.transports.LustreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_lustre_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.lustre_v1.services.lustre.transports.LustreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.LustreTransport()
        adc.assert_called_once()
...
def test_lustre_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.LustreGrpcTransport, transports.LustreGrpcAsyncIOTransport])
def test_lustre_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.LustreGrpcTransport, transports.LustreGrpcAsyncIOTransport])
def test_lustre_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

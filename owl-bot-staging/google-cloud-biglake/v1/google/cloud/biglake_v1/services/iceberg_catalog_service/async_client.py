...
class IcebergCatalogServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(IcebergCatalogServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(IcebergCatalogServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(IcebergCatalogServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(IcebergCatalogServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(IcebergCatalogServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(IcebergCatalogServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(IcebergCatalogServiceClient.common_project_path)
    parse_common_project_path = staticmethod(IcebergCatalogServiceClient.parse_common_project_path)
    common_location_path = staticmethod(IcebergCatalogServiceClient.common_location_path)
    parse_common_location_path = staticmethod(IcebergCatalogServiceClient.parse_common_location_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, IcebergCatalogServiceTransport, Callable[..., IcebergCatalogServiceTransport]]] = "grpc_asyncio",
    ...
    async def get_iceberg_catalog(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_iceberg_catalog]
    ...
    async def list_iceberg_catalogs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_iceberg_catalogs]
    ...
    async def update_iceberg_catalog(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_iceberg_catalog]
    ...
    async def create_iceberg_catalog(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_iceberg_catalog]
    ...
    async def failover_iceberg_catalog(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.failover_iceberg_catalog]

...
class IcebergCatalogServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_iceberg_catalog(self, request: iceberg_rest_catalog.CreateIcebergCatalogRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[iceberg_rest_catalog.CreateIcebergCatalogRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_iceberg_catalog_with_metadata(self, response: iceberg_rest_catalog.IcebergCatalog, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[iceberg_rest_catalog.IcebergCatalog, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_iceberg_catalog
    ...
    def pre_failover_iceberg_catalog(self, request: iceberg_rest_catalog.FailoverIcebergCatalogRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[iceberg_rest_catalog.FailoverIcebergCatalogRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_failover_iceberg_catalog(self, response: iceberg_rest_catalog.FailoverIcebergCatalogResponse) -> iceberg_rest_catalog.FailoverIcebergCatalogResponse:
    ...
    def post_failover_iceberg_catalog_with_metadata(self, response: iceberg_rest_catalog.FailoverIcebergCatalogResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[iceberg_rest_catalog.FailoverIcebergCatalogResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for failover_iceberg_catalog
    ...
    def pre_get_iceberg_catalog(self, request: iceberg_rest_catalog.GetIcebergCatalogRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[iceberg_rest_catalog.GetIcebergCatalogRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_iceberg_catalog_with_metadata(self, response: iceberg_rest_catalog.IcebergCatalog, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[iceberg_rest_catalog.IcebergCatalog, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_iceberg_catalog
    ...
    def pre_list_iceberg_catalogs(self, request: iceberg_rest_catalog.ListIcebergCatalogsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[iceberg_rest_catalog.ListIcebergCatalogsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_iceberg_catalogs(self, response: iceberg_rest_catalog.ListIcebergCatalogsResponse) -> iceberg_rest_catalog.ListIcebergCatalogsResponse:
    ...
    def post_list_iceberg_catalogs_with_metadata(self, response: iceberg_rest_catalog.ListIcebergCatalogsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[iceberg_rest_catalog.ListIcebergCatalogsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_iceberg_catalogs
    ...
    def pre_update_iceberg_catalog(self, request: iceberg_rest_catalog.UpdateIcebergCatalogRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[iceberg_rest_catalog.UpdateIcebergCatalogRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_iceberg_catalog_with_metadata(self, response: iceberg_rest_catalog.IcebergCatalog, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[iceberg_rest_catalog.IcebergCatalog, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_iceberg_catalog
...
class IcebergCatalogServiceRestTransport(_BaseIcebergCatalogServiceRestTransport):
    ...
    class _CreateIcebergCatalog(_BaseIcebergCatalogServiceRestTransport._BaseCreateIcebergCatalog, IcebergCatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = IcebergCatalogServiceRestTransport._CreateIcebergCatalog._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _FailoverIcebergCatalog(_BaseIcebergCatalogServiceRestTransport._BaseFailoverIcebergCatalog, IcebergCatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = IcebergCatalogServiceRestTransport._FailoverIcebergCatalog._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetIcebergCatalog(_BaseIcebergCatalogServiceRestTransport._BaseGetIcebergCatalog, IcebergCatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = IcebergCatalogServiceRestTransport._GetIcebergCatalog._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListIcebergCatalogs(_BaseIcebergCatalogServiceRestTransport._BaseListIcebergCatalogs, IcebergCatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = IcebergCatalogServiceRestTransport._ListIcebergCatalogs._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateIcebergCatalog(_BaseIcebergCatalogServiceRestTransport._BaseUpdateIcebergCatalog, IcebergCatalogServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = IcebergCatalogServiceRestTransport._UpdateIcebergCatalog._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

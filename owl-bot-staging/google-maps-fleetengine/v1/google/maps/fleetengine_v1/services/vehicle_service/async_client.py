...
class VehicleServiceAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, VehicleServiceTransport, Callable[..., VehicleServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_vehicle(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_vehicle]
    ...
    async def get_vehicle(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_vehicle]
    ...
    async def update_vehicle(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_vehicle]
    ...
    async def update_vehicle_location(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_vehicle_location]
    ...
    async def search_vehicles(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_vehicles]
    ...
    async def search_fuzzed_vehicles(self,
        ...
        Returns:
            google.maps.fleetengine_v1.types.SearchVehiclesResponse:
                SearchVehicles response message.
        """
        warnings.warn("VehicleServiceAsyncClient.search_fuzzed_vehicles is deprecated",
            DeprecationWarning)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_fuzzed_vehicles]

...
class VehicleServiceClient(metaclass=VehicleServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            VehicleServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def search_fuzzed_vehicles(self,
        ...
        Returns:
            google.maps.fleetengine_v1.types.SearchVehiclesResponse:
                SearchVehicles response message.
        """
        warnings.warn("VehicleServiceClient.search_fuzzed_vehicles is deprecated",
            DeprecationWarning)

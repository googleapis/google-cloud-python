...
class VehicleServiceClient(metaclass=VehicleServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = VehicleServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = VehicleServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, VehicleServiceTransport, Callable[..., VehicleServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = VehicleServiceClient._read_environment_variables()
        self._client_cert_source = VehicleServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = VehicleServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, VehicleServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(VehicleServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[VehicleServiceTransport], Callable[..., VehicleServiceTransport]] = (
                VehicleServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `maps.fleetengine_v1.VehicleServiceClient`.",
                    extra = {
    ...
    def create_vehicle(self,
        ...
        Args:
            request (Union[google.maps.fleetengine_v1.types.CreateVehicleRequest, dict]):
    ...
    def get_vehicle(self,
        ...
        Args:
            request (Union[google.maps.fleetengine_v1.types.GetVehicleRequest, dict]):
    ...
    def delete_vehicle(self,
        ...
        Args:
            request (Union[google.maps.fleetengine_v1.types.DeleteVehicleRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_vehicle]
    ...
    def update_vehicle(self,
        ...
        Args:
            request (Union[google.maps.fleetengine_v1.types.UpdateVehicleRequest, dict]):
    ...
    def update_vehicle_attributes(self,
            request: Optional[Union[vehicle_api.UpdateVehicleAttributesRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.maps.fleetengine_v1.types.UpdateVehicleAttributesRequest, dict]):
    ...
    def list_vehicles(self,
        ...
        Args:
            request (Union[google.maps.fleetengine_v1.types.ListVehiclesRequest, dict]):

...
from google.maps.fleetengine_v1.types import trip_api
from google.maps.fleetengine_v1.types import trips
...
class TripServiceClient(metaclass=TripServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = TripServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = TripServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            TripServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TripServiceTransport, Callable[..., TripServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = TripServiceClient._read_environment_variables()
        self._client_cert_source = TripServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = TripServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, TripServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(TripServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TripServiceTransport], Callable[..., TripServiceTransport]] = (
                TripServiceClient.get_transport_class(transport)
    ...
    def create_trip(self,
        ...
        Args:
            request (Union[google.maps.fleetengine_v1.types.CreateTripRequest, dict]):
    ...
    def get_trip(self,
        ...
        Args:
            request (Union[google.maps.fleetengine_v1.types.GetTripRequest, dict]):
    ...
    def report_billable_trip(self,
        ...
        Args:
            request (Union[google.maps.fleetengine_v1.types.ReportBillableTripRequest, dict]):
    ...
    def search_trips(self,
        ...
        Args:
            request (Union[google.maps.fleetengine_v1.types.SearchTripsRequest, dict]):
        ...
        Returns:
            google.maps.fleetengine_v1.services.trip_service.pagers.SearchTripsPager:
    ...
    def update_trip(self,
        ...
        Args:
            request (Union[google.maps.fleetengine_v1.types.UpdateTripRequest, dict]):
    ...
    def __enter__(self) -> "TripServiceClient":
        return self

...
class TripServiceAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TripServiceTransport, Callable[..., TripServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_trip(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_trip]
    ...
    async def delete_trip(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_trip]
    ...
    async def search_trips(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_trips]
    ...
    async def update_trip(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_trip]

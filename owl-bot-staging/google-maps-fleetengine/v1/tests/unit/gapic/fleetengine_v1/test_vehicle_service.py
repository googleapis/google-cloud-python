...
from google.maps.fleetengine_v1.services.vehicle_service import VehicleServiceAsyncClient
from google.maps.fleetengine_v1.services.vehicle_service import VehicleServiceClient
from google.maps.fleetengine_v1.services.vehicle_service import pagers
from google.maps.fleetengine_v1.services.vehicle_service import transports
from google.maps.fleetengine_v1.types import fleetengine
from google.maps.fleetengine_v1.types import header
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert VehicleServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert VehicleServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert VehicleServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert VehicleServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert VehicleServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert VehicleServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert VehicleServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert VehicleServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(VehicleServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VehicleServiceClient))
@mock.patch.object(VehicleServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VehicleServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = VehicleServiceClient._DEFAULT_UNIVERSE
    default_endpoint = VehicleServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = VehicleServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert VehicleServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert VehicleServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == VehicleServiceClient.DEFAULT_MTLS_ENDPOINT
    assert VehicleServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert VehicleServiceClient._get_api_endpoint(None, None, default_universe, "always") == VehicleServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert VehicleServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert VehicleServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        VehicleServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert VehicleServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert VehicleServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert VehicleServiceClient._get_universe_domain(None, None) == VehicleServiceClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = VehicleServiceClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (VehicleServiceClient, transports.VehicleServiceGrpcTransport, "grpc", grpc_helpers),
    (VehicleServiceAsyncClient, transports.VehicleServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
def test_vehicle_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_vehicle_service_client_client_options_from_dict():
    with mock.patch('google.maps.fleetengine_v1.services.vehicle_service.transports.VehicleServiceGrpcTransport.__init__') as grpc_transport:
...
def test_vehicle_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_create_vehicle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_vehicle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_vehicle] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_vehicle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VehicleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_vehicle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_vehicle] = mock_rpc
...
def test_delete_vehicle(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_vehicle),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
        response = client.delete_vehicle(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = vehicle_api.DeleteVehicleRequest()
        assert args[0] == request
...
def test_delete_vehicle_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_delete_vehicle_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_vehicle in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_vehicle] = mock_rpc
        request = {}
        client.delete_vehicle(request)
...
@pytest.mark.asyncio
async def test_delete_vehicle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VehicleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_vehicle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_vehicle] = mock_rpc

        request = {}
        await client.delete_vehicle(request)
...
@pytest.mark.asyncio
async def test_delete_vehicle_async(transport: str = 'grpc_asyncio', request_type=vehicle_api.DeleteVehicleRequest):
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.delete_vehicle(request)
...
def test_delete_vehicle_flattened_error():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_vehicle_flattened_async():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_vehicle(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_delete_vehicle_flattened_error_async():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_vehicle_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VehicleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_vehicle in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_vehicle] = mock_rpc
...
def test_update_vehicle_attributes_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_vehicle_attributes in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_vehicle_attributes] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_vehicle_attributes_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VehicleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_vehicle_attributes in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_vehicle_attributes] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_vehicles_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VehicleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_vehicles in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_vehicles] = mock_rpc
...
@pytest.mark.asyncio
async def test_search_vehicles_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VehicleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_vehicles in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_vehicles] = mock_rpc
...
def test_create_vehicle_empty_call_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicles.Vehicle()
        client.create_vehicle(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_vehicle_empty_call_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicles.Vehicle()
        client.get_vehicle(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_vehicle_empty_call_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_vehicle(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_vehicle_empty_call_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicles.Vehicle()
        client.update_vehicle(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_vehicle_attributes_empty_call_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicle_api.UpdateVehicleAttributesResponse()
        client.update_vehicle_attributes(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_vehicles_empty_call_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicle_api.ListVehiclesResponse()
        client.list_vehicles(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_vehicles_empty_call_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicle_api.SearchVehiclesResponse()
        client.search_vehicles(request=None)
...
def test_create_vehicle_routing_parameters_request_1_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicles.Vehicle()
        client.create_vehicle(request={"parent": "providers/sample1"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = vehicle_api.CreateVehicleRequest(**{"parent": "providers/sample1"})
...
def test_get_vehicle_routing_parameters_request_1_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicles.Vehicle()
        client.get_vehicle(request={"name": "providers/sample1"})
...
def test_delete_vehicle_routing_parameters_request_1_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_vehicle(request={"name": "providers/sample1"})
...
def test_update_vehicle_routing_parameters_request_1_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicles.Vehicle()
        client.update_vehicle(request={"name": "providers/sample1"})
...
def test_update_vehicle_attributes_routing_parameters_request_1_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicle_api.UpdateVehicleAttributesResponse()
        client.update_vehicle_attributes(request={"name": "providers/sample1"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = vehicle_api.UpdateVehicleAttributesRequest(**{"name": "providers/sample1"})
...
def test_list_vehicles_routing_parameters_request_1_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicle_api.ListVehiclesResponse()
        client.list_vehicles(request={"parent": "providers/sample1"})
...
def test_search_vehicles_routing_parameters_request_1_grpc():
    client = VehicleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = vehicle_api.SearchVehiclesResponse()
        client.search_vehicles(request={"parent": "providers/sample1"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = vehicle_api.SearchVehiclesRequest(**{"parent": "providers/sample1"})
...
def test_transport_kind_grpc_asyncio():
    transport = VehicleServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_vehicle_empty_call_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_vehicle(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_vehicle_empty_call_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_vehicle(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_vehicle_empty_call_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_vehicle(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_vehicle_empty_call_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_vehicle(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_vehicle_attributes_empty_call_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_vehicle_attributes(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_vehicles_empty_call_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_vehicles(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_vehicles_empty_call_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.search_vehicles(request=None)
...
@pytest.mark.asyncio
async def test_create_vehicle_routing_parameters_request_1_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_vehicle(request={"parent": "providers/sample1"})
...
@pytest.mark.asyncio
async def test_get_vehicle_routing_parameters_request_1_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_vehicle(request={"name": "providers/sample1"})
...
@pytest.mark.asyncio
async def test_delete_vehicle_routing_parameters_request_1_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_vehicle(request={"name": "providers/sample1"})
...
@pytest.mark.asyncio
async def test_update_vehicle_routing_parameters_request_1_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_vehicle(request={"name": "providers/sample1"})
...
@pytest.mark.asyncio
async def test_update_vehicle_attributes_routing_parameters_request_1_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_vehicle_attributes(request={"name": "providers/sample1"})
...
@pytest.mark.asyncio
async def test_list_vehicles_routing_parameters_request_1_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_vehicles(request={"parent": "providers/sample1"})
...
@pytest.mark.asyncio
async def test_search_vehicles_routing_parameters_request_1_grpc_asyncio():
    client = VehicleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.search_vehicles(request={"parent": "providers/sample1"})
...
def test_vehicle_service_base_transport():
    ...
    with mock.patch('google.maps.fleetengine_v1.services.vehicle_service.transports.VehicleServiceTransport.__init__') as Transport:
...
def test_vehicle_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.maps.fleetengine_v1.services.vehicle_service.transports.VehicleServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_vehicle_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.maps.fleetengine_v1.services.vehicle_service.transports.VehicleServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.VehicleServiceTransport()
        adc.assert_called_once()

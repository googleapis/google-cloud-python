...
class cloudcontrolspartnerCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'get_partner': ('name', ),
        'get_partner_permissions': ('name', ),
        'get_violation': ('name', ),
        'get_workload': ('name', ),
        'list_access_approval_requests': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
...
def fix_files(
    ...
    *,
    transformer=cloudcontrolspartnerCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the cloudcontrolspartner client library.

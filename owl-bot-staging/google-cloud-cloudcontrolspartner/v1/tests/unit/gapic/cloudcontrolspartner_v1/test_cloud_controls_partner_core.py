...
from google.cloud.cloudcontrolspartner_v1.services.cloud_controls_partner_core import CloudControlsPartnerCoreAsyncClient
from google.cloud.cloudcontrolspartner_v1.services.cloud_controls_partner_core import CloudControlsPartnerCoreClient
from google.cloud.cloudcontrolspartner_v1.services.cloud_controls_partner_core import pagers
from google.cloud.cloudcontrolspartner_v1.services.cloud_controls_partner_core import transports
from google.cloud.cloudcontrolspartner_v1.types import access_approval_requests
from google.cloud.cloudcontrolspartner_v1.types import completion_state
...
def test_cloud_controls_partner_core_client_client_options_from_dict():
    with mock.patch('google.cloud.cloudcontrolspartner_v1.services.cloud_controls_partner_core.transports.CloudControlsPartnerCoreGrpcTransport.__init__') as grpc_transport:
...
def test_get_ekm_connections_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/locations/*/customers/*/workloads/*/ekmConnections}" % client.transport._host, args[1])
...
def test_get_partner_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/locations/*/customers/*/workloads/*/partnerPermissions}" % client.transport._host, args[1])
...
def test_list_access_approval_requests_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*/locations/*/customers/*/workloads/*}/accessApprovalRequests" % client.transport._host, args[1])
...
def test_cloud_controls_partner_core_base_transport():
    ...
    with mock.patch('google.cloud.cloudcontrolspartner_v1.services.cloud_controls_partner_core.transports.CloudControlsPartnerCoreTransport.__init__') as Transport:
...
def test_cloud_controls_partner_core_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.cloudcontrolspartner_v1.services.cloud_controls_partner_core.transports.CloudControlsPartnerCoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cloud_controls_partner_core_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.cloudcontrolspartner_v1.services.cloud_controls_partner_core.transports.CloudControlsPartnerCoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CloudControlsPartnerCoreTransport()
        adc.assert_called_once()

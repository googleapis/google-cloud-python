...
from google.cloud.cloudcontrolspartner_v1.services.cloud_controls_partner_core import pagers
...
from .transports.base import CloudControlsPartnerCoreTransport, DEFAULT_CLIENT_INFO
...
class CloudControlsPartnerCoreAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.cloudcontrolspartner_v1.CloudControlsPartnerCoreAsyncClient`.",
                extra = {
    ...
    async def get_ekm_connections(self,
    ...
    async def get_partner_permissions(self,
    ...
    async def list_access_approval_requests(self,
        ...
        """
        warnings.warn("CloudControlsPartnerCoreAsyncClient.list_access_approval_requests is deprecated",
            DeprecationWarning)
    ...
    async def create_customer(self,
        ...
        Args:
            request (Optional[Union[google.cloud.cloudcontrolspartner_v1.types.CreateCustomerRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            customer (:class:`google.cloud.cloudcontrolspartner_v1.types.Customer`):
    ...
    async def update_customer(self,
        ...
        Args:
            request (Optional[Union[google.cloud.cloudcontrolspartner_v1.types.UpdateCustomerRequest, dict]]):
    ...
    async def delete_customer(self,
        ...
        Args:
            request (Optional[Union[google.cloud.cloudcontrolspartner_v1.types.DeleteCustomerRequest, dict]]):

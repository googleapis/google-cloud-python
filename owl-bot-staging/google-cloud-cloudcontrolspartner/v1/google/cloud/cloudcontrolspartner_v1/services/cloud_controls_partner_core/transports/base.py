...
from google.cloud.cloudcontrolspartner_v1.types import ekm_connections
from google.cloud.cloudcontrolspartner_v1.types import partner_permissions
from google.cloud.cloudcontrolspartner_v1.types import partners

DEFAULT_CLIENT_INFO = gapic_v1.client_info.ClientInfo(gapic_version=package_version.__version__)


class CloudControlsPartnerCoreTransport(abc.ABC):
    """Abstract transport class for CloudControlsPartnerCore."""

    AUTH_SCOPES = (
        'https://www.googleapis.com/auth/cloud-platform',
    )

    DEFAULT_HOST: str = 'cloudcontrolspartner.googleapis.com'
    def __init__(
            self, *,
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.get_ekm_connections: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.get_partner_permissions: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.list_access_approval_requests: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.get_partner: gapic_v1.method.wrap_method(
                self.get_partner,
    ...
    def list_customers(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[customers.ListCustomersResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_ekm_connections(self) -> Callable[
    ...
    @property
    def get_partner_permissions(self) -> Callable[
    ...
    @property
    def list_access_approval_requests(self) -> Callable[
    ...
    @property
    def get_partner(self) -> Callable[
            [partners.GetPartnerRequest],
            Union[
                partners.Partner,
                Awaitable[partners.Partner]
            ]]:
        raise NotImplementedError()

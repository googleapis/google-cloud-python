...
class CloudControlsPartnerCoreClient(metaclass=CloudControlsPartnerCoreClientMeta):
    ...
    @staticmethod
    def access_approval_request_path(organization: str,location: str,customer: str,workload: str,access_approval_request: str,) -> str:
        """Returns a fully-qualified access_approval_request string."""
        return "organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}/accessApprovalRequests/{access_approval_request}".format(organization=organization, location=location, customer=customer, workload=workload, access_approval_request=access_approval_request, )
    ...
    def parse_access_approval_request_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/customers/(?P<customer>.+?)/workloads/(?P<workload>.+?)/accessApprovalRequests/(?P<access_approval_request>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def customer_path(organization: str,location: str,customer: str,) -> str:
        """Returns a fully-qualified customer string."""
        return "organizations/{organization}/locations/{location}/customers/{customer}".format(organization=organization, location=location, customer=customer, )

    @staticmethod
    def parse_customer_path(path: str) -> Dict[str,str]:
        """Parses a customer path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/customers/(?P<customer>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def ekm_connections_path(organization: str,location: str,customer: str,workload: str,) -> str:
        """Returns a fully-qualified ekm_connections string."""
        return "organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}/ekmConnections".format(organization=organization, location=location, customer=customer, workload=workload, )

    @staticmethod
    def parse_ekm_connections_path(path: str) -> Dict[str,str]:
        """Parses a ekm_connections path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/customers/(?P<customer>.+?)/workloads/(?P<workload>.+?)/ekmConnections$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def partner_path(organization: str,location: str,) -> str:
        """Returns a fully-qualified partner string."""
        return "organizations/{organization}/locations/{location}/partner".format(organization=organization, location=location, )

    @staticmethod
    def parse_partner_path(path: str) -> Dict[str,str]:
        """Parses a partner path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/partner$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def partner_permissions_path(organization: str,location: str,customer: str,workload: str,) -> str:
        """Returns a fully-qualified partner_permissions string."""
        return "organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}/partnerPermissions".format(organization=organization, location=location, customer=customer, workload=workload, )

    @staticmethod
    def parse_partner_permissions_path(path: str) -> Dict[str,str]:
        """Parses a partner_permissions path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/customers/(?P<customer>.+?)/workloads/(?P<workload>.+?)/partnerPermissions$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def workload_path(organization: str,location: str,customer: str,workload: str,) -> str:
        """Returns a fully-qualified workload string."""
        return "organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}".format(organization=organization, location=location, customer=customer, workload=workload, )

    @staticmethod
    def parse_workload_path(path: str) -> Dict[str,str]:
        """Parses a workload path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/customers/(?P<customer>.+?)/workloads/(?P<workload>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CloudControlsPartnerCoreClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            CloudControlsPartnerCoreClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CloudControlsPartnerCoreTransport, Callable[..., CloudControlsPartnerCoreTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CloudControlsPartnerCoreClient._read_environment_variables()
        self._client_cert_source = CloudControlsPartnerCoreClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CloudControlsPartnerCoreClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CloudControlsPartnerCoreTransport], Callable[..., CloudControlsPartnerCoreTransport]] = (
    ...
    def get_partner_permissions(self,
    ...
    def list_access_approval_requests(self,
        ...
        """
        warnings.warn("CloudControlsPartnerCoreClient.list_access_approval_requests is deprecated",
            DeprecationWarning)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_access_approval_requests]

...
from .rest_base import _BaseCloudControlsPartnerMonitoringRestTransport
...
class CloudControlsPartnerMonitoringRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_violation(self, request: violations.GetViolationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[violations.GetViolationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_violation(self, response: violations.Violation) -> violations.Violation:
        ...
        it is returned to user code. This `post_get_violation` interceptor runs
        before the `post_get_violation_with_metadata` interceptor.
        """
        return response

    def post_get_violation_with_metadata(self, response: violations.Violation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[violations.Violation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_violation

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the CloudControlsPartnerMonitoring server but before it is returned to user code.

        We recommend only using this `post_get_violation_with_metadata`
        interceptor in new development instead of the `post_get_violation` interceptor.
        When both interceptors are used, this `post_get_violation_with_metadata` interceptor runs after the
        `post_get_violation` interceptor. The (possibly modified) response returned by
        `post_get_violation` will be passed to
        `post_get_violation_with_metadata`.
        """
        return response, metadata

    def pre_list_violations(self, request: violations.ListViolationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[violations.ListViolationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_violations(self, response: violations.ListViolationsResponse) -> violations.ListViolationsResponse:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the CloudControlsPartnerMonitoring server but before
        it is returned to user code. This `post_list_violations` interceptor runs
        before the `post_list_violations_with_metadata` interceptor.
        """
        return response

    def post_list_violations_with_metadata(self, response: violations.ListViolationsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[violations.ListViolationsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_violations

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the CloudControlsPartnerMonitoring server but before it is returned to user code.

        We recommend only using this `post_list_violations_with_metadata`
        interceptor in new development instead of the `post_list_violations` interceptor.
        When both interceptors are used, this `post_list_violations_with_metadata` interceptor runs after the
        `post_list_violations` interceptor. The (possibly modified) response returned by
        `post_list_violations` will be passed to
...
class CloudControlsPartnerMonitoringRestTransport(_BaseCloudControlsPartnerMonitoringRestTransport):
    ...
    class _GetViolation(_BaseCloudControlsPartnerMonitoringRestTransport._BaseGetViolation, CloudControlsPartnerMonitoringRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudControlsPartnerMonitoringRestTransport._GetViolation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListViolations(_BaseCloudControlsPartnerMonitoringRestTransport._BaseListViolations, CloudControlsPartnerMonitoringRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudControlsPartnerMonitoringRestTransport._ListViolations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

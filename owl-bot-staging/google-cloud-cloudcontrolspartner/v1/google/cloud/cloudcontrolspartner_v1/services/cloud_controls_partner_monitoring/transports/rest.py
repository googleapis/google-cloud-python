...
class CloudControlsPartnerMonitoringRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_violation(self, request: violations.GetViolationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[violations.GetViolationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_violations(self, request: violations.ListViolationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[violations.ListViolationsRequest, Sequence[Tuple[str, str]]]:

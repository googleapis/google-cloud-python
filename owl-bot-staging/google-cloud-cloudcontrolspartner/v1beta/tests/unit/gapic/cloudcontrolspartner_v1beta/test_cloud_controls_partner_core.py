...
async def test_get_ekm_connections_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_ekm_connections] = mock_object
...
async def test_get_partner_permissions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_partner_permissions] = mock_object
...
async def test_list_access_approval_requests_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_access_approval_requests] = mock_object
...
async def test_get_partner_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_partner] = mock_object
...
def test_get_workload_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = customer_workloads.Workload.to_json(customer_workloads.Workload())
...
def test_get_workload_rest_bad_request(transport: str = 'rest', request_type=customer_workloads.GetWorkloadRequest):
    client = CloudControlsPartnerCoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_workloads_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = customer_workloads.ListWorkloadsResponse.to_json(customer_workloads.ListWorkloadsResponse())
...
def test_list_workloads_rest_bad_request(transport: str = 'rest', request_type=customer_workloads.ListWorkloadsRequest):
    client = CloudControlsPartnerCoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_customer_rest_bad_request(transport: str = 'rest', request_type=customers.GetCustomerRequest):
    client = CloudControlsPartnerCoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_customers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = customers.ListCustomersResponse.to_json(customers.ListCustomersResponse())
...
def test_list_customers_rest_bad_request(transport: str = 'rest', request_type=customers.ListCustomersRequest):
    client = CloudControlsPartnerCoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_ekm_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = ekm_connections.EkmConnections.to_json(ekm_connections.EkmConnections())
...
def test_get_ekm_connections_rest_bad_request(transport: str = 'rest', request_type=ekm_connections.GetEkmConnectionsRequest):
    client = CloudControlsPartnerCoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_partner_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = partner_permissions.PartnerPermissions.to_json(partner_permissions.PartnerPermissions())
...
def test_get_partner_permissions_rest_bad_request(transport: str = 'rest', request_type=partner_permissions.GetPartnerPermissionsRequest):
    client = CloudControlsPartnerCoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_access_approval_requests_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = access_approval_requests.ListAccessApprovalRequestsResponse.to_json(access_approval_requests.ListAccessApprovalRequestsResponse())
...
def test_list_access_approval_requests_rest_bad_request(transport: str = 'rest', request_type=access_approval_requests.ListAccessApprovalRequestsRequest):
    client = CloudControlsPartnerCoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_partner_rest_bad_request(transport: str = 'rest', request_type=partners.GetPartnerRequest):
    client = CloudControlsPartnerCoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

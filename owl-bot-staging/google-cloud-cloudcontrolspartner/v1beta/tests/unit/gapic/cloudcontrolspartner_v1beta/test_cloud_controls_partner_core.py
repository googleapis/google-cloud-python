...
from google.cloud.cloudcontrolspartner_v1beta.services.cloud_controls_partner_core import CloudControlsPartnerCoreAsyncClient
from google.cloud.cloudcontrolspartner_v1beta.services.cloud_controls_partner_core import CloudControlsPartnerCoreClient
from google.cloud.cloudcontrolspartner_v1beta.services.cloud_controls_partner_core import pagers
from google.cloud.cloudcontrolspartner_v1beta.services.cloud_controls_partner_core import transports
from google.cloud.cloudcontrolspartner_v1beta.types import access_approval_requests
from google.cloud.cloudcontrolspartner_v1beta.types import completion_state
...
@mock.patch.object(CloudControlsPartnerCoreAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudControlsPartnerCoreAsyncClient))
def test__get_api_endpoint():
    ...
    assert CloudControlsPartnerCoreClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CloudControlsPartnerCoreClient.DEFAULT_MTLS_ENDPOINT
    assert CloudControlsPartnerCoreClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CloudControlsPartnerCoreClient._get_api_endpoint(None, None, default_universe, "always") == CloudControlsPartnerCoreClient.DEFAULT_MTLS_ENDPOINT
    assert CloudControlsPartnerCoreClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CloudControlsPartnerCoreClient.DEFAULT_MTLS_ENDPOINT
...
def test_cloud_controls_partner_core_client_client_options_from_dict():
    with mock.patch('google.cloud.cloudcontrolspartner_v1beta.services.cloud_controls_partner_core.transports.CloudControlsPartnerCoreGrpcTransport.__init__') as grpc_transport:
...
def test_list_workloads_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, customer_workloads.Workload)
                   for i in results)
...
def test_get_ekm_connections(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_ekm_connections),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_partner_permissions(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_partner_permissions),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_access_approval_requests_async(transport: str = 'grpc_asyncio', request_type=access_approval_requests.ListAccessApprovalRequestsRequest):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_access_approval_requests_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, access_approval_requests.AccessApprovalRequest)
                   for i in results)
...
async def test_list_access_approval_requests_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_access_approval_requests(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_partner(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_partner),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_workload_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta/{name=organizations/*/locations/*/customers/*/workloads/*}" % client.transport._host, args[1])
...
def test_list_workloads_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=organizations/*/locations/*/customers/*}/workloads" % client.transport._host, args[1])
...
def test_get_customer_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=organizations/*/locations/*/customers/*}" % client.transport._host, args[1])
...
def test_list_customers_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=organizations/*/locations/*}/customers" % client.transport._host, args[1])
...
def test_get_ekm_connections_rest_required_fields(request_type=ekm_connections.GetEkmConnectionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_ekm_connections._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_ekm_connections_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=organizations/*/locations/*/customers/*/workloads/*/ekmConnections}" % client.transport._host, args[1])
...
def test_get_partner_permissions_rest_required_fields(request_type=partner_permissions.GetPartnerPermissionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_partner_permissions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_partner_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=organizations/*/locations/*/customers/*/workloads/*/partnerPermissions}" % client.transport._host, args[1])
...
def test_list_access_approval_requests_rest_required_fields(request_type=access_approval_requests.ListAccessApprovalRequestsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_access_approval_requests._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_access_approval_requests_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=organizations/*/locations/*/customers/*/workloads/*}/accessApprovalRequests" % client.transport._host, args[1])
...
def test_get_partner_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=organizations/*/locations/*/partner}" % client.transport._host, args[1])
...
def test_create_customer_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("customerId", )) & set(("parent", "customer", "customerId", )))
...
def test_update_customer_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{customer.name=organizations/*/locations/*/customers/*}" % client.transport._host, args[1])
...
def test_get_workload_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_workload") as post, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_workload_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_get_workload") as pre:
...
def test_list_workloads_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_list_workloads") as post, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_list_workloads_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_list_workloads") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_customer_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_customer") as post, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_customer_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_get_customer") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_customer(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_customers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_list_customers") as post, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_list_customers_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_list_customers") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_customers(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_ekm_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_ekm_connections") as post, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_ekm_connections_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_get_ekm_connections") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_ekm_connections(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_partner_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_partner_permissions") as post, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_partner_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_get_partner_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_partner_permissions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_access_approval_requests_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_list_access_approval_requests") as post, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_list_access_approval_requests_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_list_access_approval_requests") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = access_approval_requests.ListAccessApprovalRequestsResponse.to_json(access_approval_requests.ListAccessApprovalRequestsResponse())
        req.return_value.content = return_value
        ...
        client.list_access_approval_requests(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_partner_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_partner") as post, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_partner_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_get_partner") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_partner(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_customer_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'organizations/sample1/locations/sample2'}
    request_init["customer"] = {'name': 'name_value', 'display_name': 'display_name_value', 'customer_onboarding_state': {'onboarding_steps': [{'step': 1, 'start_time': {'seconds': 751, 'nanos': 543}, 'completion_time': {}, 'completion_state': 1}]}, 'is_onboarded': True, 'organization_domain': 'organization_domain_value'}
...
def test_create_customer_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_create_customer") as post, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_create_customer_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_create_customer") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_customer(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_customer_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'customer': {'name': 'organizations/sample1/locations/sample2/customers/sample3'}}
    request_init["customer"] = {'name': 'organizations/sample1/locations/sample2/customers/sample3', 'display_name': 'display_name_value', 'customer_onboarding_state': {'onboarding_steps': [{'step': 1, 'start_time': {'seconds': 751, 'nanos': 543}, 'completion_time': {}, 'completion_state': 1}]}, 'is_onboarded': True, 'organization_domain': 'organization_domain_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_customer_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_update_customer") as post, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_update_customer_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_update_customer") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_customer(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_customer_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_delete_customer") as pre:
        pre.assert_not_called()
        ...
        client.delete_customer(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_cloud_controls_partner_core_base_transport():
    ...
    with mock.patch('google.cloud.cloudcontrolspartner_v1beta.services.cloud_controls_partner_core.transports.CloudControlsPartnerCoreTransport.__init__') as Transport:
...
def test_cloud_controls_partner_core_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.cloudcontrolspartner_v1beta.services.cloud_controls_partner_core.transports.CloudControlsPartnerCoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cloud_controls_partner_core_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.cloudcontrolspartner_v1beta.services.cloud_controls_partner_core.transports.CloudControlsPartnerCoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CloudControlsPartnerCoreTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.CloudControlsPartnerCoreGrpcTransport, transports.CloudControlsPartnerCoreGrpcAsyncIOTransport])
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.CloudControlsPartnerCoreGrpcTransport, transports.CloudControlsPartnerCoreGrpcAsyncIOTransport])
def test_cloud_controls_partner_core_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_access_approval_request_path():
    ...
    expected = "organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}/accessApprovalRequests/{access_approval_request}".format(organization=organization, location=location, customer=customer, workload=workload, access_approval_request=access_approval_request, )
...
def test_customer_path():
    ...
    location = "abalone"
    customer = "squid"
    expected = "organizations/{organization}/locations/{location}/customers/{customer}".format(organization=organization, location=location, customer=customer, )
...
def test_ekm_connections_path():
    ...
    customer = "cuttlefish"
    workload = "mussel"
    expected = "organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}/ekmConnections".format(organization=organization, location=location, customer=customer, workload=workload, )
...
def test_partner_path():
    organization = "squid"
    location = "clam"
    expected = "organizations/{organization}/locations/{location}/partner".format(organization=organization, location=location, )
...
def test_partner_permissions_path():
    ...
    customer = "cuttlefish"
    workload = "mussel"
    expected = "organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}/partnerPermissions".format(organization=organization, location=location, customer=customer, workload=workload, )
...
def test_workload_path():
    ...
    customer = "whelk"
    workload = "octopus"
    expected = "organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}".format(organization=organization, location=location, customer=customer, workload=workload, )

...
class CloudControlsPartnerCoreRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_customer(self, request: customers.GetCustomerRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[customers.GetCustomerRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_ekm_connections(self, request: ekm_connections.GetEkmConnectionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ekm_connections.GetEkmConnectionsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_partner(self, request: partners.GetPartnerRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[partners.GetPartnerRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_partner_permissions(self, request: partner_permissions.GetPartnerPermissionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[partner_permissions.GetPartnerPermissionsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_workload(self, request: customer_workloads.GetWorkloadRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[customer_workloads.GetWorkloadRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_access_approval_requests(self, request: access_approval_requests.ListAccessApprovalRequestsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[access_approval_requests.ListAccessApprovalRequestsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_customers(self, request: customers.ListCustomersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[customers.ListCustomersRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_workloads(self, request: customer_workloads.ListWorkloadsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[customer_workloads.ListWorkloadsRequest, Sequence[Tuple[str, str]]]:

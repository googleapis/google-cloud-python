...
from google.cloud.cloudcontrolspartner_v1beta.services.cloud_controls_partner_monitoring import pagers
...
class CloudControlsPartnerMonitoringAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = CloudControlsPartnerMonitoringClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    parse_violation_path = staticmethod(CloudControlsPartnerMonitoringClient.parse_violation_path)
    common_billing_account_path = staticmethod(CloudControlsPartnerMonitoringClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(CloudControlsPartnerMonitoringClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(CloudControlsPartnerMonitoringClient.common_folder_path)
    parse_common_folder_path = staticmethod(CloudControlsPartnerMonitoringClient.parse_common_folder_path)
    common_organization_path = staticmethod(CloudControlsPartnerMonitoringClient.common_organization_path)
    parse_common_organization_path = staticmethod(CloudControlsPartnerMonitoringClient.parse_common_organization_path)
    common_project_path = staticmethod(CloudControlsPartnerMonitoringClient.common_project_path)
    parse_common_project_path = staticmethod(CloudControlsPartnerMonitoringClient.parse_common_project_path)
    common_location_path = staticmethod(CloudControlsPartnerMonitoringClient.common_location_path)
    parse_common_location_path = staticmethod(CloudControlsPartnerMonitoringClient.parse_common_location_path)
    ...
    get_transport_class = CloudControlsPartnerMonitoringClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, CloudControlsPartnerMonitoringTransport, Callable[..., CloudControlsPartnerMonitoringTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.cloudcontrolspartner_v1beta.CloudControlsPartnerMonitoringAsyncClient`.",
                extra = {
    ...
    async def list_violations(self,
        ...
        Args:
            request (Optional[Union[google.cloud.cloudcontrolspartner_v1beta.types.ListViolationsRequest, dict]]):
    ...
    async def get_violation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.cloudcontrolspartner_v1beta.types.GetViolationRequest, dict]]):
        ...
        Returns:
            google.cloud.cloudcontrolspartner_v1beta.types.Violation:

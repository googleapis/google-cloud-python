...
def test__read_environment_variables():
    assert ApiGatewayServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ApiGatewayServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ApiGatewayServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ApiGatewayServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ApiGatewayServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert ApiGatewayServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ApiGatewayServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ApiGatewayServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ApiGatewayServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ApiGatewayServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApiGatewayServiceClient))
@mock.patch.object(ApiGatewayServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApiGatewayServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ApiGatewayServiceClient._DEFAULT_UNIVERSE
    default_endpoint = ApiGatewayServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ApiGatewayServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ApiGatewayServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ApiGatewayServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ApiGatewayServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ApiGatewayServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ApiGatewayServiceClient._get_api_endpoint(None, None, default_universe, "always") == ApiGatewayServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ApiGatewayServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ApiGatewayServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ApiGatewayServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ApiGatewayServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ApiGatewayServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ApiGatewayServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ApiGatewayServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ApiGatewayServiceClient._get_universe_domain(None, None) == ApiGatewayServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (ApiGatewayServiceClient, transports.ApiGatewayServiceRestTransport, "rest", "true"),
    (ApiGatewayServiceClient, transports.ApiGatewayServiceRestTransport, "rest", "false"),
])
@mock.patch.object(ApiGatewayServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApiGatewayServiceClient))
@mock.patch.object(ApiGatewayServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApiGatewayServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ApiGatewayServiceClient, transports.ApiGatewayServiceGrpcTransport, "grpc", grpc_helpers),
    (ApiGatewayServiceAsyncClient, transports.ApiGatewayServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (ApiGatewayServiceClient, transports.ApiGatewayServiceRestTransport, "rest", None),
])
...
@pytest.mark.asyncio
async def test_list_gateways_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_gateways in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_gateways] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_gateway_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiGatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_gateway in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_gateway] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_gateway_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiGatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_gateway in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_gateway] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_gateway_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiGatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_gateway in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_gateway] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_gateway_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiGatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_gateway in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_gateway] = mock_rpc
...
def test_list_api_configs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_api_configs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_api_configs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiGatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_api_configs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_api_configs] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_api_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiGatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_api_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_api_config] = mock_rpc
...
def test_create_api_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_api_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_api_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiGatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_api_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_api_config] = mock_rpc
...
def test_update_api_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_api_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_api_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiGatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_api_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_api_config] = mock_rpc
...
def test_delete_api_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_api_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_api_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiGatewayServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_api_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_api_config] = mock_rpc
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_api_configs_empty_call_grpc():
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = apigateway.ListApiConfigsResponse()
        client.list_api_configs(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_api_config_empty_call_grpc():
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = apigateway.ApiConfig()
        client.get_api_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_api_config_empty_call_grpc():
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_api_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_api_config_empty_call_grpc():
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_api_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_api_config_empty_call_grpc():
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_api_config(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = ApiGatewayServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_api_configs_empty_call_grpc_asyncio():
    client = ApiGatewayServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_api_configs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_api_config_empty_call_grpc_asyncio():
    client = ApiGatewayServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_api_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_api_config_empty_call_grpc_asyncio():
    client = ApiGatewayServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_api_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_api_config_empty_call_grpc_asyncio():
    client = ApiGatewayServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_api_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_api_config_empty_call_grpc_asyncio():
    client = ApiGatewayServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_api_config(request=None)
...
def test_transport_kind_rest():
    transport = ApiGatewayServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_gateways_rest_bad_request(request_type=apigateway.ListGatewaysRequest):
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_gateways_rest_interceptors(null_interceptor):
    transport = transports.ApiGatewayServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ApiGatewayServiceRestInterceptor(),
        )
    client = ApiGatewayServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_list_gateways") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_list_gateways_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_list_gateways") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = apigateway.ListGatewaysResponse.to_json(apigateway.ListGatewaysResponse())
...
def test_get_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_get_gateway") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_get_gateway_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_get_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = apigateway.Gateway.to_json(apigateway.Gateway())
        req.return_value.content = return_value
...
def test_create_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_create_gateway") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_create_gateway_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_create_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_update_gateway") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_update_gateway_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_update_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_delete_gateway") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_delete_gateway_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_delete_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_apis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_list_apis") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_list_apis_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_list_apis") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = apigateway.ListApisResponse.to_json(apigateway.ListApisResponse())
        req.return_value.content = return_value
...
def test_get_api_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_get_api") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_get_api_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_get_api") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = apigateway.Api.to_json(apigateway.Api())
        req.return_value.content = return_value
...
def test_create_api_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_create_api") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_create_api_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_create_api") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_api_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_update_api") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_update_api_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_update_api") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_api_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_delete_api") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_delete_api_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_delete_api") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_api_configs_rest_bad_request(request_type=apigateway.ListApiConfigsRequest):
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_api_configs_rest_call_success(request_type):
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_api_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_list_api_configs") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_list_api_configs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_list_api_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = apigateway.ListApiConfigsResponse.to_json(apigateway.ListApiConfigsResponse())
        req.return_value.content = return_value
...
def test_get_api_config_rest_call_success(request_type):
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_api_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_get_api_config") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_get_api_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_get_api_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = apigateway.ApiConfig.to_json(apigateway.ApiConfig())
        req.return_value.content = return_value
...
def test_create_api_config_rest_bad_request(request_type=apigateway.CreateApiConfigRequest):
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_api_config_rest_call_success(request_type):
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_api_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_create_api_config") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_create_api_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_create_api_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_api_config_rest_bad_request(request_type=apigateway.UpdateApiConfigRequest):
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_api_config_rest_call_success(request_type):
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_api_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_update_api_config") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_update_api_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_update_api_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_api_config_rest_bad_request(request_type=apigateway.DeleteApiConfigRequest):
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_api_config_rest_call_success(request_type):
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_api_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_delete_api_config") as post, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_delete_api_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "pre_delete_api_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_api_configs_empty_call_rest():
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_api_config_empty_call_rest():
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_api_config_empty_call_rest():
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_api_config_empty_call_rest():
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_api_config_empty_call_rest():
    client = ApiGatewayServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (ApiGatewayServiceAsyncClient, transports.ApiGatewayServiceGrpcAsyncIOTransport),
])

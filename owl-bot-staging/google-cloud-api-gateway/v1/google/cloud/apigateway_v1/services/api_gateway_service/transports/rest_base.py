...
class _BaseApiGatewayServiceRestTransport(ApiGatewayServiceTransport):
    """Base REST backend transport for ApiGatewayService.
...
__all__=(
    '_BaseApiGatewayServiceRestTransport',
)

...
def test_create_aws_cluster(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_aws_cluster),
            '__call__') as call:
...
def test_update_aws_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_aws_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_aws_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_aws_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_aws_clusters_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, aws_resources.AwsCluster)
                   for i in results)
...
def test_delete_aws_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_aws_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_generate_aws_cluster_agent_token(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_aws_cluster_agent_token),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_generate_aws_access_token(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_aws_access_token),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_aws_node_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_aws_node_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_aws_node_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_aws_node_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_rollback_aws_node_pool_update(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rollback_aws_node_pool_update),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_aws_node_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_aws_node_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_aws_node_pools_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, aws_resources.AwsNodePool)
                   for i in results)
...
def test_delete_aws_node_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_aws_node_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_aws_open_id_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_aws_open_id_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_aws_json_web_keys(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_aws_json_web_keys),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_aws_server_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_aws_server_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_aws_cluster_rest_required_fields(request_type=aws_service.CreateAwsClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_aws_cluster._get_unset_required_fields(jsonified_request)
...
def test_create_aws_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_create_aws_cluster") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_create_aws_cluster") as pre:
...
def test_update_aws_cluster_rest_required_fields(request_type=aws_service.UpdateAwsClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_aws_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_aws_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_update_aws_cluster") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_update_aws_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_aws_cluster_rest_required_fields(request_type=aws_service.GetAwsClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_aws_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_aws_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_get_aws_cluster") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_get_aws_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_aws_clusters_rest_required_fields(request_type=aws_service.ListAwsClustersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_aws_clusters._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_aws_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_list_aws_clusters") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_list_aws_clusters") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_aws_cluster_rest_required_fields(request_type=aws_service.DeleteAwsClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_aws_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_aws_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_delete_aws_cluster") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_delete_aws_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_generate_aws_cluster_agent_token_rest_required_fields(request_type=aws_service.GenerateAwsClusterAgentTokenRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_aws_cluster_agent_token._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_aws_cluster_agent_token_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("awsCluster", "subjectToken", "subjectTokenType", "version", )))
...
def test_generate_aws_cluster_agent_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_generate_aws_cluster_agent_token") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_generate_aws_cluster_agent_token") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = aws_service.GenerateAwsClusterAgentTokenResponse.to_json(aws_service.GenerateAwsClusterAgentTokenResponse())
        ...
        client.generate_aws_cluster_agent_token(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_generate_aws_cluster_agent_token_rest_bad_request(transport: str = 'rest', request_type=aws_service.GenerateAwsClusterAgentTokenRequest):
    client = AwsClustersClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_generate_aws_access_token_rest_required_fields(request_type=aws_service.GenerateAwsAccessTokenRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_aws_access_token._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_aws_access_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_generate_aws_access_token") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_generate_aws_access_token") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_aws_node_pool_rest_required_fields(request_type=aws_service.CreateAwsNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_aws_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_aws_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_create_aws_node_pool") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_create_aws_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_aws_node_pool_rest_required_fields(request_type=aws_service.UpdateAwsNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_aws_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_aws_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_update_aws_node_pool") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_update_aws_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_rollback_aws_node_pool_update_rest_required_fields(request_type=aws_service.RollbackAwsNodePoolUpdateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).rollback_aws_node_pool_update._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_rollback_aws_node_pool_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_rollback_aws_node_pool_update") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_rollback_aws_node_pool_update") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.rollback_aws_node_pool_update(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_rollback_aws_node_pool_update_rest_bad_request(transport: str = 'rest', request_type=aws_service.RollbackAwsNodePoolUpdateRequest):
    client = AwsClustersClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_aws_node_pool_rest_required_fields(request_type=aws_service.GetAwsNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_aws_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_aws_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_get_aws_node_pool") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_get_aws_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_aws_node_pools_rest_required_fields(request_type=aws_service.ListAwsNodePoolsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_aws_node_pools._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_aws_node_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_list_aws_node_pools") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_list_aws_node_pools") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_aws_node_pool_rest_required_fields(request_type=aws_service.DeleteAwsNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_aws_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_aws_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_delete_aws_node_pool") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_delete_aws_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_aws_open_id_config_rest_required_fields(request_type=aws_service.GetAwsOpenIdConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_aws_open_id_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_aws_open_id_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_get_aws_open_id_config") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_get_aws_open_id_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = aws_resources.AwsOpenIdConfig.to_json(aws_resources.AwsOpenIdConfig())
        ...
        client.get_aws_open_id_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_aws_open_id_config_rest_bad_request(transport: str = 'rest', request_type=aws_service.GetAwsOpenIdConfigRequest):
    client = AwsClustersClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_aws_json_web_keys_rest_required_fields(request_type=aws_service.GetAwsJsonWebKeysRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_aws_json_web_keys._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_aws_json_web_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_get_aws_json_web_keys") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_get_aws_json_web_keys") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = aws_resources.AwsJsonWebKeys.to_json(aws_resources.AwsJsonWebKeys())
        ...
        client.get_aws_json_web_keys(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_aws_json_web_keys_rest_bad_request(transport: str = 'rest', request_type=aws_service.GetAwsJsonWebKeysRequest):
    client = AwsClustersClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_aws_server_config_rest_required_fields(request_type=aws_service.GetAwsServerConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_aws_server_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_aws_server_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "post_get_aws_server_config") as post, \
         mock.patch.object(transports.AwsClustersRestInterceptor, "pre_get_aws_server_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_aws_clusters_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.AwsClustersGrpcTransport, transports.AwsClustersGrpcAsyncIOTransport])
def test_aws_clusters_transport_channel_mtls_with_client_cert_source(
    transport_class
):

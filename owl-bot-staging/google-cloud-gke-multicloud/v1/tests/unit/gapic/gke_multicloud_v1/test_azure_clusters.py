...
def test_create_azure_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_create_azure_client_with_metadata") as post_with_metadata, \
...
def test_get_azure_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_client_with_metadata") as post_with_metadata, \
...
def test_list_azure_clients_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_list_azure_clients_with_metadata") as post_with_metadata, \
...
def test_delete_azure_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_delete_azure_client_with_metadata") as post_with_metadata, \
...
def test_create_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_create_azure_cluster_with_metadata") as post_with_metadata, \
...
def test_update_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_update_azure_cluster_with_metadata") as post_with_metadata, \
...
def test_get_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_cluster_with_metadata") as post_with_metadata, \
...
def test_list_azure_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_list_azure_clusters_with_metadata") as post_with_metadata, \
...
def test_delete_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_delete_azure_cluster_with_metadata") as post_with_metadata, \
...
def test_generate_azure_cluster_agent_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_generate_azure_cluster_agent_token_with_metadata") as post_with_metadata, \
...
def test_generate_azure_access_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_generate_azure_access_token_with_metadata") as post_with_metadata, \
...
def test_create_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_create_azure_node_pool_with_metadata") as post_with_metadata, \
...
def test_update_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_update_azure_node_pool_with_metadata") as post_with_metadata, \
...
def test_get_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_node_pool_with_metadata") as post_with_metadata, \
...
def test_list_azure_node_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_list_azure_node_pools_with_metadata") as post_with_metadata, \
...
def test_delete_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_delete_azure_node_pool_with_metadata") as post_with_metadata, \
...
def test_get_azure_open_id_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_open_id_config_with_metadata") as post_with_metadata, \
...
def test_get_azure_json_web_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_json_web_keys_with_metadata") as post_with_metadata, \
...
def test_get_azure_server_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_server_config_with_metadata") as post_with_metadata, \

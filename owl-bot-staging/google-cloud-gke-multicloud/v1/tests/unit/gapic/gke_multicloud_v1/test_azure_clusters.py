...
from google.cloud.gke_multicloud_v1.services.azure_clusters import AzureClustersAsyncClient
...
def test__get_api_endpoint():
    ...
    assert AzureClustersClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AzureClustersClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    AzureClustersClient, AzureClustersAsyncClient
])
...
def test_create_azure_client(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_azure_client),
            '__call__') as call:
...
def test_get_azure_client(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_azure_client),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_azure_clients_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, azure_resources.AzureClient)
                   for i in results)
...
def test_delete_azure_client(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_azure_client),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_azure_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_azure_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_azure_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_azure_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_azure_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_azure_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_azure_clusters_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, azure_resources.AzureCluster)
                   for i in results)
...
def test_delete_azure_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_azure_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_generate_azure_cluster_agent_token(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_azure_cluster_agent_token),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_generate_azure_cluster_agent_token_async(transport: str = 'grpc_asyncio', request_type=azure_service.GenerateAzureClusterAgentTokenRequest):
    client = AzureClustersAsyncClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_generate_azure_access_token(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_azure_access_token),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_azure_node_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_azure_node_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_azure_node_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_azure_node_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_azure_node_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_azure_node_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_azure_node_pools_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, azure_resources.AzureNodePool)
                   for i in results)
...
def test_delete_azure_node_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_azure_node_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_azure_open_id_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_azure_open_id_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_azure_json_web_keys(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_azure_json_web_keys),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_azure_server_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_azure_server_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_azure_client_rest_required_fields(request_type=azure_service.CreateAzureClientRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_azure_client._get_unset_required_fields(jsonified_request)
...
def test_create_azure_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_create_azure_client") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_create_azure_client") as pre:
...
def test_get_azure_client_rest_required_fields(request_type=azure_service.GetAzureClientRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_azure_client._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_azure_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_client") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_get_azure_client") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_azure_clients_rest_required_fields(request_type=azure_service.ListAzureClientsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_azure_clients._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_azure_clients_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_list_azure_clients") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_list_azure_clients") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_azure_client_rest_required_fields(request_type=azure_service.DeleteAzureClientRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_azure_client._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_azure_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_delete_azure_client") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_delete_azure_client") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_azure_cluster_rest_required_fields(request_type=azure_service.CreateAzureClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_azure_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_create_azure_cluster") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_create_azure_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_azure_cluster_rest_required_fields(request_type=azure_service.UpdateAzureClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_azure_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_update_azure_cluster") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_update_azure_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_azure_cluster_rest_required_fields(request_type=azure_service.GetAzureClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_azure_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_cluster") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_get_azure_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_azure_clusters_rest_required_fields(request_type=azure_service.ListAzureClustersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_azure_clusters._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_azure_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_list_azure_clusters") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_list_azure_clusters") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_azure_cluster_rest_required_fields(request_type=azure_service.DeleteAzureClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_azure_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_delete_azure_cluster") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_delete_azure_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_generate_azure_cluster_agent_token_rest_required_fields(request_type=azure_service.GenerateAzureClusterAgentTokenRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_azure_cluster_agent_token._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_azure_cluster_agent_token_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("azureCluster", "subjectToken", "subjectTokenType", "version", )))
...
def test_generate_azure_cluster_agent_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_generate_azure_cluster_agent_token") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_generate_azure_cluster_agent_token") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = azure_service.GenerateAzureClusterAgentTokenResponse.to_json(azure_service.GenerateAzureClusterAgentTokenResponse())
        ...
        client.generate_azure_cluster_agent_token(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_generate_azure_cluster_agent_token_rest_bad_request(transport: str = 'rest', request_type=azure_service.GenerateAzureClusterAgentTokenRequest):
    client = AzureClustersClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_generate_azure_access_token_rest_required_fields(request_type=azure_service.GenerateAzureAccessTokenRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_azure_access_token._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_azure_access_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_generate_azure_access_token") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_generate_azure_access_token") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_azure_node_pool_rest_required_fields(request_type=azure_service.CreateAzureNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_azure_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_create_azure_node_pool") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_create_azure_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_azure_node_pool_rest_required_fields(request_type=azure_service.UpdateAzureNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_azure_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_update_azure_node_pool") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_update_azure_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_azure_node_pool_rest_required_fields(request_type=azure_service.GetAzureNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_azure_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_node_pool") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_get_azure_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_azure_node_pools_rest_required_fields(request_type=azure_service.ListAzureNodePoolsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_azure_node_pools._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_azure_node_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_list_azure_node_pools") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_list_azure_node_pools") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_azure_node_pool_rest_required_fields(request_type=azure_service.DeleteAzureNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_azure_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_delete_azure_node_pool") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_delete_azure_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_azure_open_id_config_rest_required_fields(request_type=azure_service.GetAzureOpenIdConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_azure_open_id_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_azure_open_id_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_open_id_config") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_get_azure_open_id_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = azure_resources.AzureOpenIdConfig.to_json(azure_resources.AzureOpenIdConfig())
        ...
        client.get_azure_open_id_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_azure_open_id_config_rest_bad_request(transport: str = 'rest', request_type=azure_service.GetAzureOpenIdConfigRequest):
    client = AzureClustersClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_azure_open_id_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{azure_cluster=projects/*/locations/*/azureClusters/*}/.well-known/openid-configuration" % client.transport._host, args[1])
...
def test_get_azure_json_web_keys_rest_required_fields(request_type=azure_service.GetAzureJsonWebKeysRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_azure_json_web_keys._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_azure_json_web_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_json_web_keys") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_get_azure_json_web_keys") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = azure_resources.AzureJsonWebKeys.to_json(azure_resources.AzureJsonWebKeys())
        ...
        client.get_azure_json_web_keys(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_azure_json_web_keys_rest_bad_request(transport: str = 'rest', request_type=azure_service.GetAzureJsonWebKeysRequest):
    client = AzureClustersClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_azure_server_config_rest_required_fields(request_type=azure_service.GetAzureServerConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_azure_server_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_azure_server_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_server_config") as post, \
         mock.patch.object(transports.AzureClustersRestInterceptor, "pre_get_azure_server_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_azure_clusters_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.AzureClustersGrpcTransport, transports.AzureClustersGrpcAsyncIOTransport])
def test_azure_clusters_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.AzureClustersGrpcTransport, transports.AzureClustersGrpcAsyncIOTransport])
def test_azure_clusters_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

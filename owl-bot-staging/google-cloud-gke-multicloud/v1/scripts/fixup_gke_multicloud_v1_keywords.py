...
class gke_multicloudCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'delete_aws_cluster': ('name', 'validate_only', 'allow_missing', 'ignore_errors', 'etag', ),
        'delete_aws_node_pool': ('name', 'validate_only', 'allow_missing', 'ignore_errors', 'etag', ),
        'delete_azure_client': ('name', 'allow_missing', 'validate_only', ),
        'delete_azure_cluster': ('name', 'allow_missing', 'validate_only', 'etag', 'ignore_errors', ),
        'delete_azure_node_pool': ('name', 'validate_only', 'allow_missing', 'etag', 'ignore_errors', ),
        'generate_attached_cluster_agent_token': ('attached_cluster', 'subject_token', 'subject_token_type', 'version', 'grant_type', 'audience', 'scope', 'requested_token_type', 'options', ),
        'generate_attached_cluster_install_manifest': ('parent', 'attached_cluster_id', 'platform_version', 'proxy_config', ),
        'generate_aws_access_token': ('aws_cluster', ),
        'generate_aws_cluster_agent_token': ('aws_cluster', 'subject_token', 'subject_token_type', 'version', 'node_pool_id', 'grant_type', 'audience', 'scope', 'requested_token_type', 'options', ),
        'generate_azure_access_token': ('azure_cluster', ),
        'generate_azure_cluster_agent_token': ('azure_cluster', 'subject_token', 'subject_token_type', 'version', 'node_pool_id', 'grant_type', 'audience', 'scope', 'requested_token_type', 'options', ),
        'get_attached_cluster': ('name', ),
        'get_attached_server_config': ('name', ),
        'get_aws_cluster': ('name', ),
        'get_aws_json_web_keys': ('aws_cluster', ),
        'get_aws_node_pool': ('name', ),
        'get_aws_open_id_config': ('aws_cluster', ),
        'get_aws_server_config': ('name', ),
        'get_azure_client': ('name', ),
        'get_azure_cluster': ('name', ),
        'get_azure_json_web_keys': ('azure_cluster', ),
        'get_azure_node_pool': ('name', ),
        'get_azure_open_id_config': ('azure_cluster', ),
        'get_azure_server_config': ('name', ),
        'import_attached_cluster': ('parent', 'fleet_membership', 'platform_version', 'distribution', 'validate_only', 'proxy_config', ),
        ...
        'rollback_aws_node_pool_update': ('name', 'respect_pdb', ),

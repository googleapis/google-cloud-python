...
class AzureClustersClient(metaclass=AzureClustersClientMeta):
    ...
    @staticmethod
    def azure_client_path(project: str,location: str,azure_client: str,) -> str:
        """Returns a fully-qualified azure_client string."""
        return "projects/{project}/locations/{location}/azureClients/{azure_client}".format(project=project, location=location, azure_client=azure_client, )

    @staticmethod
    def parse_azure_client_path(path: str) -> Dict[str,str]:
        """Parses a azure_client path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/azureClients/(?P<azure_client>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def azure_cluster_path(project: str,location: str,azure_cluster: str,) -> str:
        """Returns a fully-qualified azure_cluster string."""
        return "projects/{project}/locations/{location}/azureClusters/{azure_cluster}".format(project=project, location=location, azure_cluster=azure_cluster, )

    @staticmethod
    def parse_azure_cluster_path(path: str) -> Dict[str,str]:
        """Parses a azure_cluster path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/azureClusters/(?P<azure_cluster>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def azure_node_pool_path(project: str,location: str,azure_cluster: str,azure_node_pool: str,) -> str:
        """Returns a fully-qualified azure_node_pool string."""
        return "projects/{project}/locations/{location}/azureClusters/{azure_cluster}/azureNodePools/{azure_node_pool}".format(project=project, location=location, azure_cluster=azure_cluster, azure_node_pool=azure_node_pool, )

    @staticmethod
    def parse_azure_node_pool_path(path: str) -> Dict[str,str]:
        """Parses a azure_node_pool path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/azureClusters/(?P<azure_cluster>.+?)/azureNodePools/(?P<azure_node_pool>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def azure_server_config_path(project: str,location: str,) -> str:
        """Returns a fully-qualified azure_server_config string."""
        return "projects/{project}/locations/{location}/azureServerConfig".format(project=project, location=location, )

    @staticmethod
    def parse_azure_server_config_path(path: str) -> Dict[str,str]:
        """Parses a azure_server_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/azureServerConfig$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AzureClustersClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AzureClustersTransport, Callable[..., AzureClustersTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AzureClustersClient._read_environment_variables()
        self._client_cert_source = AzureClustersClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AzureClustersClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AzureClustersTransport], Callable[..., AzureClustersTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.gkemulticloud_v1.AzureClustersClient`.",
                    extra = {
    ...
    def create_azure_client(self,
        ...
        flattened_params = [parent, azure_client, azure_client_id]
    ...
    def create_azure_cluster(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, azure_cluster, azure_cluster_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_azure_cluster(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [azure_cluster, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def generate_azure_cluster_agent_token(self,
            request: Optional[Union[azure_service.GenerateAzureClusterAgentTokenRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_azure_cluster_agent_token]
    ...
    def generate_azure_access_token(self,
            request: Optional[Union[azure_service.GenerateAzureAccessTokenRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_azure_access_token]
    ...
    def create_azure_node_pool(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, azure_node_pool, azure_node_pool_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_azure_node_pool(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [azure_node_pool, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list_azure_node_pools(self,
    ...
    def delete_azure_node_pool(self,
    ...
    def get_azure_open_id_config(self,
            request: Optional[Union[azure_service.GetAzureOpenIdConfigRequest, dict]] = None,
            *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [azure_cluster]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def get_azure_json_web_keys(self,
    ...
    def get_azure_server_config(self,
            request: Optional[Union[azure_service.GetAzureServerConfigRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,

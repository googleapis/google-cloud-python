...
class AzureClustersAsyncClient:
    ...
    async def create_azure_client(self,
    ...
    async def list_azure_clients(self,
    ...
    async def delete_azure_client(self,
    ...
    async def create_azure_cluster(self,
    ...
    async def update_azure_cluster(self,
    ...
    async def get_azure_cluster(self,
    ...
    async def list_azure_clusters(self,
    ...
    async def delete_azure_cluster(self,
    ...
    async def generate_azure_cluster_agent_token(self,
    ...
    async def generate_azure_access_token(self,
    ...
    async def create_azure_node_pool(self,
    ...
    async def update_azure_node_pool(self,
    ...
    async def get_azure_node_pool(self,
    ...
    async def list_azure_node_pools(self,
    ...
    async def delete_azure_node_pool(self,
    ...
    async def get_azure_open_id_config(self,
    ...
    async def get_azure_json_web_keys(self,
    ...
    async def get_azure_server_config(self,

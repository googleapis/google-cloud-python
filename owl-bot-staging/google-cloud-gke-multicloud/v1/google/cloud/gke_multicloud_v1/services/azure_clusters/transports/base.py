...
class AzureClustersTransport(abc.ABC):
    """Abstract transport class for AzureClusters."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_azure_client: gapic_v1.method.wrap_method(
                self.create_azure_client,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_azure_client: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.list_azure_clients: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.delete_azure_client: gapic_v1.method.wrap_method(
                self.delete_azure_client,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.create_azure_cluster: gapic_v1.method.wrap_method(
                self.create_azure_cluster,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_azure_cluster: gapic_v1.method.wrap_method(
                self.update_azure_cluster,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_azure_cluster: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.list_azure_clusters: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.delete_azure_cluster: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.create_azure_node_pool: gapic_v1.method.wrap_method(
                self.create_azure_node_pool,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_azure_node_pool: gapic_v1.method.wrap_method(
                self.update_azure_node_pool,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_azure_node_pool: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.list_azure_node_pools: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.get_azure_server_config: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
    ...
    def get_azure_client(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[azure_resources.AzureClient]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def generate_azure_cluster_agent_token(self) -> Callable[
    ...
    def get_azure_node_pool(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[azure_resources.AzureNodePool]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def get_azure_open_id_config(self) -> Callable[
    ...
    @property
    def get_azure_json_web_keys(self) -> Callable[

...
class AzureClustersRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_generate_azure_cluster_agent_token(self, request: azure_service.GenerateAzureClusterAgentTokenRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[azure_service.GenerateAzureClusterAgentTokenRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_azure_json_web_keys(self, request: azure_service.GetAzureJsonWebKeysRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[azure_service.GetAzureJsonWebKeysRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_azure_open_id_config(self, request: azure_service.GetAzureOpenIdConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[azure_service.GetAzureOpenIdConfigRequest, Sequence[Tuple[str, str]]]:

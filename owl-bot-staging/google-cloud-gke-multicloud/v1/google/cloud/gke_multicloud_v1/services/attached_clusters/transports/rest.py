...
class AttachedClustersRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_attached_cluster(self, request: attached_service.CreateAttachedClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[attached_service.CreateAttachedClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_attached_cluster(self, request: attached_service.DeleteAttachedClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[attached_service.DeleteAttachedClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_generate_attached_cluster_agent_token(self, request: attached_service.GenerateAttachedClusterAgentTokenRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[attached_service.GenerateAttachedClusterAgentTokenRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_generate_attached_cluster_install_manifest(self, request: attached_service.GenerateAttachedClusterInstallManifestRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[attached_service.GenerateAttachedClusterInstallManifestRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_attached_cluster(self, request: attached_service.GetAttachedClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[attached_service.GetAttachedClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_attached_server_config(self, request: attached_service.GetAttachedServerConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[attached_service.GetAttachedServerConfigRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_import_attached_cluster(self, request: attached_service.ImportAttachedClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[attached_service.ImportAttachedClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_attached_clusters(self, request: attached_service.ListAttachedClustersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[attached_service.ListAttachedClustersRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_attached_cluster(self, request: attached_service.UpdateAttachedClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[attached_service.UpdateAttachedClusterRequest, Sequence[Tuple[str, str]]]:

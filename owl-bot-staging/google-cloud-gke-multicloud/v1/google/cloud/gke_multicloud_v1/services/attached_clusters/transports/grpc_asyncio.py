...
class AttachedClustersGrpcAsyncIOTransport(AttachedClustersTransport):
    ...
    def generate_attached_cluster_install_manifest(self) -> Callable[
        ...
        if 'generate_attached_cluster_install_manifest' not in self._stubs:
            self._stubs['generate_attached_cluster_install_manifest'] = self.grpc_channel.unary_unary(
    ...
    def generate_attached_cluster_agent_token(self) -> Callable[
        ...
        if 'generate_attached_cluster_agent_token' not in self._stubs:
            self._stubs['generate_attached_cluster_agent_token'] = self.grpc_channel.unary_unary(

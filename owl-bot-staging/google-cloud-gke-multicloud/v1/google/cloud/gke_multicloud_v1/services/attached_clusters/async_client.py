...
from .transports.base import AttachedClustersTransport, DEFAULT_CLIENT_INFO
...
class AttachedClustersAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = AttachedClustersClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = functools.partial(type(AttachedClustersClient).get_transport_class, type(AttachedClustersClient))
    ...
    async def create_attached_cluster(self,
    ...
    async def update_attached_cluster(self,
    ...
    async def import_attached_cluster(self,
    ...
    async def get_attached_cluster(self,
    ...
    async def list_attached_clusters(self,
    ...
    async def delete_attached_cluster(self,
    ...
    async def get_attached_server_config(self,
    ...
    async def generate_attached_cluster_install_manifest(self,
    ...
    async def generate_attached_cluster_agent_token(self,

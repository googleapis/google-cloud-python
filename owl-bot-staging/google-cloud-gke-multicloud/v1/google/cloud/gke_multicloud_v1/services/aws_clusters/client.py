...
class AwsClustersClient(metaclass=AwsClustersClientMeta):
    ...
    @staticmethod
    def aws_cluster_path(project: str,location: str,aws_cluster: str,) -> str:
        """Returns a fully-qualified aws_cluster string."""
        return "projects/{project}/locations/{location}/awsClusters/{aws_cluster}".format(project=project, location=location, aws_cluster=aws_cluster, )
    ...
    @staticmethod
    def aws_node_pool_path(project: str,location: str,aws_cluster: str,aws_node_pool: str,) -> str:
        """Returns a fully-qualified aws_node_pool string."""
        return "projects/{project}/locations/{location}/awsClusters/{aws_cluster}/awsNodePools/{aws_node_pool}".format(project=project, location=location, aws_cluster=aws_cluster, aws_node_pool=aws_node_pool, )

    @staticmethod
    def parse_aws_node_pool_path(path: str) -> Dict[str,str]:
        """Parses a aws_node_pool path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/awsClusters/(?P<aws_cluster>.+?)/awsNodePools/(?P<aws_node_pool>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def aws_server_config_path(project: str,location: str,) -> str:
        """Returns a fully-qualified aws_server_config string."""
        return "projects/{project}/locations/{location}/awsServerConfig".format(project=project, location=location, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AwsClustersClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def generate_aws_cluster_agent_token(self,
    ...
    def generate_aws_access_token(self,
    ...
    def rollback_aws_node_pool_update(self,
    ...
    def get_aws_open_id_config(self,
    ...
    def get_aws_json_web_keys(self,
    ...
    def get_aws_server_config(self,

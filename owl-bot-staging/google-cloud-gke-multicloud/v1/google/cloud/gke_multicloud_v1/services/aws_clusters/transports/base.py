...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
    ...
    def get_aws_cluster(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[aws_resources.AwsCluster]
            ]]:
        raise NotImplementedError()
    ...
    def get_aws_node_pool(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[aws_resources.AwsNodePool]
            ]]:
        raise NotImplementedError()
    ...
    def get_aws_open_id_config(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[aws_resources.AwsOpenIdConfig]
            ]]:
        raise NotImplementedError()
    ...
    def get_aws_json_web_keys(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[aws_resources.AwsJsonWebKeys]
            ]]:
        raise NotImplementedError()
    ...
    def get_aws_server_config(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[aws_resources.AwsServerConfig]
            ]]:
        raise NotImplementedError()

...
class AwsClustersAsyncClient:
    ...
    get_transport_class = functools.partial(type(AwsClustersClient).get_transport_class, type(AwsClustersClient))
    ...
    async def create_aws_cluster(self,
    ...
    async def update_aws_cluster(self,
    ...
    async def get_aws_cluster(self,
    ...
    async def list_aws_clusters(self,
    ...
    async def delete_aws_cluster(self,
    ...
    async def generate_aws_cluster_agent_token(self,
    ...
    async def generate_aws_access_token(self,
    ...
    async def create_aws_node_pool(self,
    ...
    async def update_aws_node_pool(self,
    ...
    async def rollback_aws_node_pool_update(self,
    ...
    async def get_aws_node_pool(self,
    ...
    async def list_aws_node_pools(self,
    ...
    async def delete_aws_node_pool(self,
    ...
    async def get_aws_open_id_config(self,
    ...
    async def get_aws_json_web_keys(self,
    ...
    async def get_aws_server_config(self,

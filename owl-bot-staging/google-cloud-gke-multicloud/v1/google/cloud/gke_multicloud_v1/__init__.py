...
from .types.common_resources import CloudMonitoringConfig
...
from .types.common_resources import NodeKubeletConfig
from .types.common_resources import NodeTaint
from .types.common_resources import OperationMetadata
from .types.common_resources import SecurityPostureConfig

...
async def test_find_closest_building_insights_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.find_closest_building_insights] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_data_layers] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_geo_tiff] = mock_object
...
def test_find_closest_building_insights_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = solar_service.BuildingInsights.to_json(solar_service.BuildingInsights())
...
def test_find_closest_building_insights_rest_bad_request(transport: str = 'rest', request_type=solar_service.FindClosestBuildingInsightsRequest):
    client = SolarClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_data_layers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = solar_service.DataLayers.to_json(solar_service.DataLayers())
...
def test_get_data_layers_rest_bad_request(transport: str = 'rest', request_type=solar_service.GetDataLayersRequest):
    client = SolarClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_geo_tiff_rest_bad_request(transport: str = 'rest', request_type=solar_service.GetGeoTiffRequest):
    client = SolarClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

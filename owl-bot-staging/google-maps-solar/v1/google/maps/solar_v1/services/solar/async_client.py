...
from .transports.base import SolarTransport, DEFAULT_CLIENT_INFO
...
class SolarAsyncClient:
    ...
    get_transport_class = functools.partial(type(SolarClient).get_transport_class, type(SolarClient))
    ...
    async def find_closest_building_insights(self,
    ...
    async def get_data_layers(self,

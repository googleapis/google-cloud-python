...
class SolarRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_find_closest_building_insights(self, request: solar_service.FindClosestBuildingInsightsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[solar_service.FindClosestBuildingInsightsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_find_closest_building_insights_with_metadata(self, response: solar_service.BuildingInsights, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[solar_service.BuildingInsights, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for find_closest_building_insights
    ...
    def pre_get_data_layers(self, request: solar_service.GetDataLayersRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[solar_service.GetDataLayersRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_data_layers_with_metadata(self, response: solar_service.DataLayers, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[solar_service.DataLayers, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_data_layers
    ...
    def pre_get_geo_tiff(self, request: solar_service.GetGeoTiffRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[solar_service.GetGeoTiffRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_geo_tiff_with_metadata(self, response: httpbody_pb2.HttpBody, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[httpbody_pb2.HttpBody, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_geo_tiff
...
class SolarRestTransport(_BaseSolarRestTransport):
    ...
    class _FindClosestBuildingInsights(_BaseSolarRestTransport._BaseFindClosestBuildingInsights, SolarRestStub):
        ...
        insights method over HTTP.
            ...
            # Send the request
            response = SolarRestTransport._FindClosestBuildingInsights._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class SolarRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_find_closest_building_insights(self, request: solar_service.FindClosestBuildingInsightsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[solar_service.FindClosestBuildingInsightsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_data_layers(self, request: solar_service.GetDataLayersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[solar_service.GetDataLayersRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_geo_tiff(self, request: solar_service.GetGeoTiffRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[solar_service.GetGeoTiffRequest, Sequence[Tuple[str, str]]]:

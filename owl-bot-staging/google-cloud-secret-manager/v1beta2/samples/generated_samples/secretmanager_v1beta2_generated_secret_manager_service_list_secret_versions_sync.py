...
#
# Snippet for ListSecretVersions
...
def sample_list_secret_versions():
    ...
    request = secretmanager_v1beta2.ListSecretVersionsRequest(
        parent="parent_value",
    )
...
# [END secretmanager_v1beta2_generated_SecretManagerService_ListSecretVersions_sync]

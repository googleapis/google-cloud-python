...
#
# Snippet for DestroySecretVersion
...
def sample_destroy_secret_version():
    ...
    request = secretmanager_v1beta2.DestroySecretVersionRequest(
        name="name_value",
    )
...
# [END secretmanager_v1beta2_generated_SecretManagerService_DestroySecretVersion_sync]

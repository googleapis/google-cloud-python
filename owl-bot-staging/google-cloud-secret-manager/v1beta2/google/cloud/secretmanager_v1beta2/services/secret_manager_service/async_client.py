...
from google.cloud.secretmanager_v1beta2.types import service
...
class SecretManagerServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(SecretManagerServiceClient).get_transport_class, type(SecretManagerServiceClient))
    ...
    async def add_secret_version(self,
    ...
    async def list_secret_versions(self,
    ...
    async def get_secret_version(self,
    ...
    async def access_secret_version(self,
...
initial=2.0,maximum=60.0,multiplier=2.0,                predicate=retries.if_exception_type(
    ...
    async def disable_secret_version(self,
    ...
    async def enable_secret_version(self,
    ...
    async def destroy_secret_version(self,

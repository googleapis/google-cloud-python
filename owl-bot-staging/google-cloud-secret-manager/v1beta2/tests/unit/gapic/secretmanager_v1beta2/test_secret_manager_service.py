...
from google.cloud.secretmanager_v1beta2.services.secret_manager_service import SecretManagerServiceAsyncClient
from google.cloud.secretmanager_v1beta2.services.secret_manager_service import SecretManagerServiceClient
from google.cloud.secretmanager_v1beta2.services.secret_manager_service import pagers
from google.cloud.secretmanager_v1beta2.services.secret_manager_service import transports
...
def test__get_api_endpoint():
    ...
    assert SecretManagerServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SecretManagerServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert SecretManagerServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SecretManagerServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    SecretManagerServiceClient, SecretManagerServiceAsyncClient
])
...
def test_secret_manager_service_client_client_options_from_dict():
    with mock.patch('google.cloud.secretmanager_v1beta2.services.secret_manager_service.transports.SecretManagerServiceGrpcTransport.__init__') as grpc_transport:
...
def test_list_secrets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_list_secrets") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_list_secrets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_list_secrets") as pre:
...
def test_create_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_create_secret") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_create_secret_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_create_secret") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_add_secret_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_add_secret_version") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_add_secret_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_add_secret_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_get_secret") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_get_secret_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_get_secret") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_secret_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'secret': {'name': 'projects/sample1/secrets/sample2'}}
    request_init["secret"] = {'name': 'projects/sample1/secrets/sample2', 'replication': {'automatic': {'customer_managed_encryption': {'kms_key_name': 'kms_key_name_value'}}, 'user_managed': {'replicas': [{'location': 'location_value', 'customer_managed_encryption': {}}]}}, 'create_time': {'seconds': 751, 'nanos': 543}, 'labels': {}, 'topics': [{'name': 'name_value'}], 'expire_time': {}, 'ttl': {'seconds': 751, 'nanos': 543}, 'etag': 'etag_value', 'rotation': {'next_rotation_time': {}, 'rotation_period': {}}, 'version_aliases': {}, 'annotations': {}, 'version_destroy_ttl': {}, 'customer_managed_encryption': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_update_secret") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_update_secret_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_update_secret") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_delete_secret") as pre:
        pre.assert_not_called()
...
def test_list_secret_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_list_secret_versions") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_list_secret_versions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_list_secret_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_secret_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_get_secret_version") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_get_secret_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_get_secret_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_access_secret_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_access_secret_version") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_access_secret_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_access_secret_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_disable_secret_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_disable_secret_version") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_disable_secret_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_disable_secret_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_enable_secret_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_enable_secret_version") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_enable_secret_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_enable_secret_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_destroy_secret_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_destroy_secret_version") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_destroy_secret_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_destroy_secret_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecretManagerServiceRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_secret_manager_service_base_transport():
    ...
    with mock.patch('google.cloud.secretmanager_v1beta2.services.secret_manager_service.transports.SecretManagerServiceTransport.__init__') as Transport:
...
def test_secret_manager_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.secretmanager_v1beta2.services.secret_manager_service.transports.SecretManagerServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_secret_manager_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.secretmanager_v1beta2.services.secret_manager_service.transports.SecretManagerServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SecretManagerServiceTransport()
        adc.assert_called_once()

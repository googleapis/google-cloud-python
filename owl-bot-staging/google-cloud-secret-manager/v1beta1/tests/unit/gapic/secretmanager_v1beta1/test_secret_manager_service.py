...
def test_list_secrets_rest_required_fields(request_type=service.ListSecretsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_secrets._get_unset_required_fields(jsonified_request)
...
def test_create_secret_rest_required_fields(request_type=service.CreateSecretRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_secret._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_add_secret_version_rest_required_fields(request_type=service.AddSecretVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).add_secret_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_secret_rest_required_fields(request_type=service.GetSecretRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_secret._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_secret_rest_required_fields(request_type=service.UpdateSecretRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_secret._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_secret_rest_required_fields(request_type=service.DeleteSecretRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_secret._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_secret_versions_rest_required_fields(request_type=service.ListSecretVersionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_secret_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_secret_version_rest_required_fields(request_type=service.GetSecretVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_secret_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_access_secret_version_rest_required_fields(request_type=service.AccessSecretVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).access_secret_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_disable_secret_version_rest_required_fields(request_type=service.DisableSecretVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).disable_secret_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_enable_secret_version_rest_required_fields(request_type=service.EnableSecretVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).enable_secret_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_destroy_secret_version_rest_required_fields(request_type=service.DestroySecretVersionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).destroy_secret_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

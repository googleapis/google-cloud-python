...
from .base import GDCHardwareManagementTransport, DEFAULT_CLIENT_INFO
...
class GDCHardwareManagementGrpcAsyncIOTransport(GDCHardwareManagementTransport):
    ...
    @property
    def create_order(self) -> Callable[
    ...
    @property
    def update_order(self) -> Callable[
    ...
    @property
    def delete_order(self) -> Callable[
    ...
    @property
    def submit_order(self) -> Callable[
    ...
    @property
    def cancel_order(self) -> Callable[
    ...
    @property
    def get_site(self) -> Callable[
            [service.GetSiteRequest],
            Awaitable[resources.Site]]:
    ...
    @property
    def list_hardware_groups(self) -> Callable[
    ...
    @property
    def get_hardware_group(self) -> Callable[
    ...
    @property
    def create_hardware_group(self) -> Callable[
    ...
    @property
    def update_hardware_group(self) -> Callable[
    ...
    @property
    def delete_hardware_group(self) -> Callable[
    ...
    @property
    def list_hardware(self) -> Callable[
            [service.ListHardwareRequest],
            Awaitable[service.ListHardwareResponse]]:
    ...
    @property
    def get_hardware(self) -> Callable[
            [service.GetHardwareRequest],
            Awaitable[resources.Hardware]]:
    ...
    @property
    def create_hardware(self) -> Callable[
    ...
    @property
    def update_hardware(self) -> Callable[
    ...
    @property
    def delete_hardware(self) -> Callable[
    ...
    @property
    def list_comments(self) -> Callable[
            [service.ListCommentsRequest],
            Awaitable[service.ListCommentsResponse]]:
    ...
    @property
    def get_comment(self) -> Callable[
            [service.GetCommentRequest],
            Awaitable[resources.Comment]]:
    ...
    @property
    def create_comment(self) -> Callable[
    ...
    @property
    def record_action_on_comment(self) -> Callable[
    ...
    @property
    def list_change_log_entries(self) -> Callable[
    ...
    @property
    def get_change_log_entry(self) -> Callable[
            [service.GetChangeLogEntryRequest],
            Awaitable[resources.ChangeLogEntry]]:
    ...
    @property
    def get_sku(self) -> Callable[
            [service.GetSkuRequest],
            Awaitable[resources.Sku]]:
    ...
    def list_zones(self) -> Callable[
            ...
            Awaitable[service.ListZonesResponse]]:
    ...
    @property
    def get_zone(self) -> Callable[
            [service.GetZoneRequest],
            Awaitable[resources.Zone]]:
    ...
    @property
    def signal_zone_state(self) -> Callable[
    ...
    @property
    def request_order_date_change(self) -> Callable[
...
__all__ = (
    'GDCHardwareManagementGrpcAsyncIOTransport',
)

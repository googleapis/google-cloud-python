...
from google.cloud.gdchardwaremanagement_v1alpha.services.gdc_hardware_management import pagers
from google.cloud.gdchardwaremanagement_v1alpha.types import resources
from google.cloud.gdchardwaremanagement_v1alpha.types import service
...
from .transports.base import GDCHardwareManagementTransport, DEFAULT_CLIENT_INFO
...
class GDCHardwareManagementClient(metaclass=GDCHardwareManagementClientMeta):
    ...
    @staticmethod
    def change_log_entry_path(project: str,location: str,order: str,change_log_entry: str,) -> str:
        """Returns a fully-qualified change_log_entry string."""
        return "projects/{project}/locations/{location}/orders/{order}/changeLogEntries/{change_log_entry}".format(project=project, location=location, order=order, change_log_entry=change_log_entry, )

    @staticmethod
    def parse_change_log_entry_path(path: str) -> Dict[str,str]:
        """Parses a change_log_entry path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/orders/(?P<order>.+?)/changeLogEntries/(?P<change_log_entry>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def comment_path(project: str,location: str,order: str,comment: str,) -> str:
        """Returns a fully-qualified comment string."""
        return "projects/{project}/locations/{location}/orders/{order}/comments/{comment}".format(project=project, location=location, order=order, comment=comment, )

    @staticmethod
    def parse_comment_path(path: str) -> Dict[str,str]:
        """Parses a comment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/orders/(?P<order>.+?)/comments/(?P<comment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def hardware_path(project: str,location: str,hardware: str,) -> str:
        """Returns a fully-qualified hardware string."""
        return "projects/{project}/locations/{location}/hardware/{hardware}".format(project=project, location=location, hardware=hardware, )

    @staticmethod
    def parse_hardware_path(path: str) -> Dict[str,str]:
        """Parses a hardware path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/hardware/(?P<hardware>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def hardware_group_path(project: str,location: str,order: str,hardware_group: str,) -> str:
        """Returns a fully-qualified hardware_group string."""
        return "projects/{project}/locations/{location}/orders/{order}/hardwareGroups/{hardware_group}".format(project=project, location=location, order=order, hardware_group=hardware_group, )

    @staticmethod
    def parse_hardware_group_path(path: str) -> Dict[str,str]:
        """Parses a hardware_group path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/orders/(?P<order>.+?)/hardwareGroups/(?P<hardware_group>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def order_path(project: str,location: str,order: str,) -> str:
        """Returns a fully-qualified order string."""
        return "projects/{project}/locations/{location}/orders/{order}".format(project=project, location=location, order=order, )

    @staticmethod
    def parse_order_path(path: str) -> Dict[str,str]:
        """Parses a order path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/orders/(?P<order>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def site_path(project: str,location: str,site: str,) -> str:
        """Returns a fully-qualified site string."""
        return "projects/{project}/locations/{location}/sites/{site}".format(project=project, location=location, site=site, )

    @staticmethod
    def parse_site_path(path: str) -> Dict[str,str]:
        """Parses a site path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/sites/(?P<site>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def sku_path(project: str,location: str,sku: str,) -> str:
        """Returns a fully-qualified sku string."""
        return "projects/{project}/locations/{location}/skus/{sku}".format(project=project, location=location, sku=sku, )

    @staticmethod
    def parse_sku_path(path: str) -> Dict[str,str]:
        """Parses a sku path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/skus/(?P<sku>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def zone_path(project: str,location: str,zone: str,) -> str:
        """Returns a fully-qualified zone string."""
        return "projects/{project}/locations/{location}/zones/{zone}".format(project=project, location=location, zone=zone, )

    @staticmethod
    def parse_zone_path(path: str) -> Dict[str,str]:
        """Parses a zone path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/zones/(?P<zone>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = GDCHardwareManagementClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GDCHardwareManagementTransport, Callable[..., GDCHardwareManagementTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GDCHardwareManagementClient._read_environment_variables()
        self._client_cert_source = GDCHardwareManagementClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = GDCHardwareManagementClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[GDCHardwareManagementTransport], Callable[..., GDCHardwareManagementTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.gdchardwaremanagement_v1alpha.GDCHardwareManagementClient`.",
                    extra = {
    ...
    def create_order(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, order, order_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_order(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [order, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def cancel_order(self,
            request: Optional[Union[service.CancelOrderRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.gdchardwaremanagement_v1alpha.types.CancelOrderRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.CancelOrderRequest):
            request = service.CancelOrderRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
    ...
    def create_site(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, site, site_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_site(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [site, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def delete_site(self,
        ...
        Args:
            request (Union[google.cloud.gdchardwaremanagement_v1alpha.types.DeleteSiteRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_site]
    ...
    def create_hardware_group(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, hardware_group, hardware_group_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_hardware_group(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [hardware_group, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def delete_hardware_group(self,
    ...
    def create_hardware(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, hardware, hardware_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_hardware(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [hardware, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def create_comment(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, comment, comment_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def record_action_on_comment(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [name, action_type]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list_change_log_entries(self,
    ...
    def create_zone(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, zone, zone_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_zone(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [zone, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def signal_zone_state(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [name, state_signal]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def request_order_date_change(self,
            request: Optional[Union[service.RequestOrderDateChangeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            requested_date: Optional[date_pb2.Date] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation.Operation:
        r"""Updates the requested date change of a single Order.
        ...
        .. code-block:: python
            ...
            def sample_request_order_date_change():
                # Create a client
                client = gdchardwaremanagement_v1alpha.GDCHardwareManagementClient()

                # Initialize request argument(s)
                request = gdchardwaremanagement_v1alpha.RequestOrderDateChangeRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.gdchardwaremanagement_v1alpha.types.RequestOrderDateChangeRequest, dict]):
            ...
            requested_date (google.type.date_pb2.Date):
                Required. The date to which the
                customer or Google wants to set the
                scheduled installation date.

                This corresponds to the ``requested_date`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [name, requested_date]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.RequestOrderDateChangeRequest):
            request = service.RequestOrderDateChangeRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.request_order_date_change]

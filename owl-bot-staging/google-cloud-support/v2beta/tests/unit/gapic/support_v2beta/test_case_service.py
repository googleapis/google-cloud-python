...
from google.cloud.support_v2beta.services.case_service import CaseServiceAsyncClient
from google.cloud.support_v2beta.services.case_service import CaseServiceClient
from google.cloud.support_v2beta.services.case_service import pagers
from google.cloud.support_v2beta.services.case_service import transports
...
from google.cloud.support_v2beta.types import escalation
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert CaseServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert CaseServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert CaseServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert CaseServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert CaseServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert CaseServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(CaseServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CaseServiceClient))
@mock.patch.object(CaseServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CaseServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CaseServiceClient._DEFAULT_UNIVERSE
    default_endpoint = CaseServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = CaseServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert CaseServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert CaseServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CaseServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CaseServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CaseServiceClient._get_api_endpoint(None, None, default_universe, "always") == CaseServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CaseServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CaseServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CaseServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert CaseServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        CaseServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert CaseServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert CaseServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert CaseServiceClient._get_universe_domain(None, None) == CaseServiceClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = CaseServiceClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (CaseServiceAsyncClient, transports.CaseServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (CaseServiceAsyncClient, transports.CaseServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (CaseServiceClient, transports.CaseServiceGrpcTransport, "grpc", "false"),
    (CaseServiceAsyncClient, transports.CaseServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
@pytest.mark.parametrize("client_class", [
    CaseServiceClient, CaseServiceAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (CaseServiceAsyncClient, transports.CaseServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_case_service_client_client_options_from_dict():
    with mock.patch('google.cloud.support_v2beta.services.case_service.transports.CaseServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_case(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.get_case),
            '__call__') as call:
...
async def test_get_case_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_case in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_case] = mock_rpc
...
def test_list_cases(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_cases),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_list_cases_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_cases in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_cases] = mock_rpc
...
def test_list_cases_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, case.Case)
                   for i in results)
...
def test_search_cases(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_cases),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_search_cases_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CaseServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_cases in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_cases] = mock_rpc
...
def test_create_case(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_case),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_case_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CaseServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_case in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_case] = mock_rpc
...
def test_update_case(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_case),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gcs_case.Case(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_case_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CaseServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_case in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_case] = mock_rpc
...
def test_escalate_case(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.escalate_case),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = case.Case(
            name='name_value',
...
@pytest.mark.asyncio
async def test_escalate_case_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CaseServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.escalate_case in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.escalate_case] = mock_rpc
...
def test_close_case(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.close_case),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = case.Case(
            name='name_value',
...
async def test_close_case_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.close_case in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.close_case] = mock_rpc
...
def test_search_case_classifications_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.search_case_classifications in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.search_case_classifications] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_search_case_classifications_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CaseServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_case_classifications in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_case_classifications] = mock_rpc
...
async def test_search_case_classifications_async(transport: str = 'grpc_asyncio', request_type=case_service.SearchCaseClassificationsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(case_service.SearchCaseClassificationsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_search_case_classifications_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        retry = retries.Retry()
        timeout = 5
        pager = client.search_case_classifications(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, case.CaseClassification)
                   for i in results)
...
def test_get_case_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2beta/{name=projects/*/cases/*}" % client.transport._host, args[1])
...
def test_list_cases_rest_required_fields(request_type=case_service.ListCasesRequest):
    ...
    assert not set(unset_fields) - set(("filter", "page_size", "page_token", "product_line", ))
    jsonified_request.update(unset_fields)
...
def test_list_cases_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "pageSize", "pageToken", "productLine", )) & set(("parent", )))
...
def test_list_cases_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{parent=projects/*}/cases" % client.transport._host, args[1])
...
def test_update_case_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{case.name=projects/*/cases/*}" % client.transport._host, args[1])
...
def test_get_case_rest_interceptors(null_interceptor):
    transport = transports.CaseServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CaseServiceRestInterceptor(),
        )
    client = CaseServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_get_case") as post, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_get_case_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "pre_get_case") as pre:
        ...
        post_with_metadata.return_value = case.Case(), metadata
...
def test_list_cases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_list_cases") as post, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_list_cases_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "pre_list_cases") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = case_service.ListCasesResponse.to_json(case_service.ListCasesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = case_service.ListCasesResponse(), metadata
...
def test_search_cases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_search_cases") as post, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_search_cases_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "pre_search_cases") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = case_service.SearchCasesResponse.to_json(case_service.SearchCasesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = case_service.SearchCasesResponse(), metadata
...
def test_create_case_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1'}
    request_init["case"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'classification': {'id': 'id_value', 'display_name': 'display_name_value', 'product': {'product_line': 1}}, 'time_zone': 'time_zone_value', 'subscriber_email_addresses': ['subscriber_email_addresses_value1', 'subscriber_email_addresses_value2'], 'state': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'creator': {'display_name': 'display_name_value', 'email': 'email_value', 'google_support': True, 'username': 'username_value'}, 'contact_email': 'contact_email_value', 'escalated': True, 'test_case': True, 'language_code': 'language_code_value', 'priority': 1}
...
def test_create_case_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_create_case") as post, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_create_case_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "pre_create_case") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        post_with_metadata.return_value = gcs_case.Case(), metadata
...
def test_update_case_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_update_case") as post, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_update_case_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "pre_update_case") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_escalate_case_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_escalate_case") as post, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_escalate_case_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "pre_escalate_case") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_close_case_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_close_case") as post, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_close_case_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "pre_close_case") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_search_case_classifications_rest_bad_request(request_type=case_service.SearchCaseClassificationsRequest):
    client = CaseServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_search_case_classifications_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_search_case_classifications") as post, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "post_search_case_classifications_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CaseServiceRestInterceptor, "pre_search_case_classifications") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = case_service.SearchCaseClassificationsResponse.to_json(case_service.SearchCaseClassificationsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = case_service.SearchCaseClassificationsResponse(), metadata
...
def test_case_service_base_transport():
    ...
    with mock.patch('google.cloud.support_v2beta.services.case_service.transports.CaseServiceTransport.__init__') as Transport:
...
def test_case_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.support_v2beta.services.case_service.transports.CaseServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_case_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.support_v2beta.services.case_service.transports.CaseServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CaseServiceTransport()
        adc.assert_called_once()
...
def test_case_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.CaseServiceGrpcTransport, transports.CaseServiceGrpcAsyncIOTransport])
def test_case_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.CaseServiceGrpcTransport, transports.CaseServiceGrpcAsyncIOTransport])
def test_case_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

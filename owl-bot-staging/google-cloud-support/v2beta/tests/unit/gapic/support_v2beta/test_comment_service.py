...
from google.cloud.support_v2beta.services.comment_service import CommentServiceAsyncClient
from google.cloud.support_v2beta.services.comment_service import CommentServiceClient
from google.cloud.support_v2beta.services.comment_service import pagers
from google.cloud.support_v2beta.services.comment_service import transports
...
def test__read_environment_variables():
    assert CommentServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert CommentServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert CommentServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert CommentServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert CommentServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert CommentServiceClient._get_client_cert_source(None, False) is None
    assert CommentServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert CommentServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert CommentServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert CommentServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(CommentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CommentServiceClient))
@mock.patch.object(CommentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CommentServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CommentServiceClient._DEFAULT_UNIVERSE
    default_endpoint = CommentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = CommentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert CommentServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert CommentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CommentServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CommentServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CommentServiceClient._get_api_endpoint(None, None, default_universe, "always") == CommentServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CommentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CommentServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CommentServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert CommentServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        CommentServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert CommentServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert CommentServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert CommentServiceClient._get_universe_domain(None, None) == CommentServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_name", [
    (CommentServiceClient, "grpc"),
    (CommentServiceAsyncClient, "grpc_asyncio"),
    (CommentServiceClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.CommentServiceGrpcTransport, "grpc"),
    (transports.CommentServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (transports.CommentServiceRestTransport, "rest"),
])
...
def test_comment_service_client_get_transport_class():
    ...
    available_transports = [
        transports.CommentServiceGrpcTransport,
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (CommentServiceClient, transports.CommentServiceGrpcTransport, "grpc"),
    (CommentServiceAsyncClient, transports.CommentServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (CommentServiceClient, transports.CommentServiceRestTransport, "rest"),
])
@mock.patch.object(CommentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CommentServiceClient))
@mock.patch.object(CommentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CommentServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (CommentServiceClient, transports.CommentServiceGrpcTransport, "grpc", "true"),
    (CommentServiceAsyncClient, transports.CommentServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (CommentServiceClient, transports.CommentServiceGrpcTransport, "grpc", "false"),
    (CommentServiceAsyncClient, transports.CommentServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (CommentServiceClient, transports.CommentServiceRestTransport, "rest", "true"),
    (CommentServiceClient, transports.CommentServiceRestTransport, "rest", "false"),
])
@mock.patch.object(CommentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CommentServiceClient))
@mock.patch.object(CommentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CommentServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    CommentServiceClient, CommentServiceAsyncClient
])
...
@mock.patch.object(CommentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CommentServiceClient))
@mock.patch.object(CommentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CommentServiceAsyncClient))
def test_comment_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (CommentServiceClient, transports.CommentServiceGrpcTransport, "grpc", grpc_helpers),
    (CommentServiceAsyncClient, transports.CommentServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (CommentServiceClient, transports.CommentServiceRestTransport, "rest", None),
])
...
def test_comment_service_client_client_options_from_dict():
    with mock.patch('google.cloud.support_v2beta.services.comment_service.transports.CommentServiceGrpcTransport.__init__') as grpc_transport:
...
def test_list_comments(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.list_comments),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_list_comments_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_comments in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_comments] = mock_rpc
...
def test_list_comments_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, comment.Comment)
                   for i in results)
...
def test_create_comment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_comment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_comment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CommentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_comment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_comment] = mock_rpc
...
def test_create_comment_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_comment(
            parent='parent_value',
            comment=gcs_comment.Comment(name='name_value'),
        )
...
def test_get_comment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_comment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = comment.Comment(
            name='name_value',
            body='body_value',
            plain_text_body='plain_text_body_value',
        )
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, comment.Comment)
    assert response.name == 'name_value'
    assert response.body == 'body_value'
    assert response.plain_text_body == 'plain_text_body_value'
...
@pytest.mark.asyncio
async def test_get_comment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CommentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_comment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_comment] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_comment_async(transport: str = 'grpc_asyncio', request_type=comment_service.GetCommentRequest):
    client = CommentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(comment.Comment(
            name='name_value',
            body='body_value',
            plain_text_body='plain_text_body_value',
        ))
...
def test_list_comments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2beta/{parent=projects/*/cases/*}/comments" % client.transport._host, args[1])
...
def test_get_comment_rest_required_fields(request_type=comment_service.GetCommentRequest):
    transport_class = transports.CommentServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_comment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = comment.Comment.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_comment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'sample1/sample2/cases/sample3/comments/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{name=*/*/cases/*/comments/*}" % client.transport._host, args[1])
...
def test_credentials_transport_error():
    ...
    transport = transports.CommentServiceGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = CommentServiceClient(
...
def test_transport_get_channel():
    ...
    transport = transports.CommentServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
@pytest.mark.parametrize("transport_class", [
    transports.CommentServiceGrpcTransport,
    transports.CommentServiceGrpcAsyncIOTransport,
    transports.CommentServiceRestTransport,
])
...
def test_transport_kind_grpc_asyncio():
    transport = CommentServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = CommentServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_comments_rest_bad_request(request_type=comment_service.ListCommentsRequest):
    client = CommentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_comments_rest_interceptors(null_interceptor):
    transport = transports.CommentServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CommentServiceRestInterceptor(),
        )
    client = CommentServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CommentServiceRestInterceptor, "post_list_comments") as post, \
        mock.patch.object(transports.CommentServiceRestInterceptor, "post_list_comments_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CommentServiceRestInterceptor, "pre_list_comments") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = comment_service.ListCommentsResponse.to_json(comment_service.ListCommentsResponse())
        ...
        post_with_metadata.return_value = comment_service.ListCommentsResponse(), metadata
...
def test_create_comment_rest_bad_request(request_type=comment_service.CreateCommentRequest):
    client = CommentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_comment_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/cases/sample2'}
    request_init["comment"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'creator': {'display_name': 'display_name_value', 'email': 'email_value', 'google_support': True, 'username': 'username_value'}, 'body': 'body_value', 'plain_text_body': 'plain_text_body_value'}
...
def test_create_comment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CommentServiceRestInterceptor, "post_create_comment") as post, \
        mock.patch.object(transports.CommentServiceRestInterceptor, "post_create_comment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CommentServiceRestInterceptor, "pre_create_comment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_comment_rest_bad_request(request_type=comment_service.GetCommentRequest):
    client = CommentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'sample1/sample2/cases/sample3/comments/sample4'}
    request = request_type(**request_init)
...
def test_get_comment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CommentServiceRestInterceptor, "post_get_comment") as post, \
        mock.patch.object(transports.CommentServiceRestInterceptor, "post_get_comment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CommentServiceRestInterceptor, "pre_get_comment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = comment_service.GetCommentRequest.pb(comment_service.GetCommentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = comment.Comment.to_json(comment.Comment())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = comment.Comment()
        post_with_metadata.return_value = comment.Comment(), metadata

        client.get_comment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_comment_service_base_transport():
    ...
    with mock.patch('google.cloud.support_v2beta.services.comment_service.transports.CommentServiceTransport.__init__') as Transport:
...
def test_comment_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.support_v2beta.services.comment_service.transports.CommentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_comment_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.support_v2beta.services.comment_service.transports.CommentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CommentServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize(
    ...
    [
        (transports.CommentServiceGrpcTransport, grpc_helpers),
        (transports.CommentServiceGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_comment_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_comment_service_host_no_port(transport_name):
    client = CommentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='cloudsupport.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'cloudsupport.googleapis.com:443'
...
def test_comment_service_host_with_port(transport_name):
    client = CommentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='cloudsupport.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
def test_comment_service_client_transport_session_collision(transport_name):
    ...
    client1 = CommentServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = CommentServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("transport_class", [transports.CommentServiceGrpcTransport, transports.CommentServiceGrpcAsyncIOTransport])
def test_comment_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.CommentServiceGrpcTransport, transports.CommentServiceGrpcAsyncIOTransport])
def test_comment_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
@pytest.mark.parametrize("client_class,transport_class", [
    (CommentServiceClient, transports.CommentServiceGrpcTransport),
    (CommentServiceAsyncClient, transports.CommentServiceGrpcAsyncIOTransport),
])

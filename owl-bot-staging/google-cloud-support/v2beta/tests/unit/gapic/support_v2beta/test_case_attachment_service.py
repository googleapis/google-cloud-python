...
from google.cloud.support_v2beta.services.case_attachment_service import CaseAttachmentServiceAsyncClient
from google.cloud.support_v2beta.services.case_attachment_service import CaseAttachmentServiceClient
from google.cloud.support_v2beta.services.case_attachment_service import pagers
from google.cloud.support_v2beta.services.case_attachment_service import transports
...
def test__read_environment_variables():
    assert CaseAttachmentServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert CaseAttachmentServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert CaseAttachmentServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert CaseAttachmentServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert CaseAttachmentServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert CaseAttachmentServiceClient._get_client_cert_source(None, False) is None
    assert CaseAttachmentServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert CaseAttachmentServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert CaseAttachmentServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert CaseAttachmentServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(CaseAttachmentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CaseAttachmentServiceClient))
@mock.patch.object(CaseAttachmentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CaseAttachmentServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CaseAttachmentServiceClient._DEFAULT_UNIVERSE
    default_endpoint = CaseAttachmentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = CaseAttachmentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert CaseAttachmentServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert CaseAttachmentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CaseAttachmentServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CaseAttachmentServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CaseAttachmentServiceClient._get_api_endpoint(None, None, default_universe, "always") == CaseAttachmentServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CaseAttachmentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CaseAttachmentServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CaseAttachmentServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert CaseAttachmentServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        CaseAttachmentServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert CaseAttachmentServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert CaseAttachmentServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert CaseAttachmentServiceClient._get_universe_domain(None, None) == CaseAttachmentServiceClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        CaseAttachmentServiceClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = CaseAttachmentServiceClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_name", [
    (CaseAttachmentServiceClient, "grpc"),
    (CaseAttachmentServiceAsyncClient, "grpc_asyncio"),
    (CaseAttachmentServiceClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.CaseAttachmentServiceGrpcTransport, "grpc"),
    (transports.CaseAttachmentServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (transports.CaseAttachmentServiceRestTransport, "rest"),
])
...
def test_case_attachment_service_client_get_transport_class():
    ...
    available_transports = [
        transports.CaseAttachmentServiceGrpcTransport,
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (CaseAttachmentServiceClient, transports.CaseAttachmentServiceGrpcTransport, "grpc"),
    (CaseAttachmentServiceAsyncClient, transports.CaseAttachmentServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (CaseAttachmentServiceClient, transports.CaseAttachmentServiceRestTransport, "rest"),
])
@mock.patch.object(CaseAttachmentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CaseAttachmentServiceClient))
@mock.patch.object(CaseAttachmentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CaseAttachmentServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (CaseAttachmentServiceClient, transports.CaseAttachmentServiceGrpcTransport, "grpc", "true"),
    (CaseAttachmentServiceAsyncClient, transports.CaseAttachmentServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (CaseAttachmentServiceClient, transports.CaseAttachmentServiceGrpcTransport, "grpc", "false"),
    (CaseAttachmentServiceAsyncClient, transports.CaseAttachmentServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (CaseAttachmentServiceClient, transports.CaseAttachmentServiceRestTransport, "rest", "true"),
    (CaseAttachmentServiceClient, transports.CaseAttachmentServiceRestTransport, "rest", "false"),
])
@mock.patch.object(CaseAttachmentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CaseAttachmentServiceClient))
@mock.patch.object(CaseAttachmentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CaseAttachmentServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    CaseAttachmentServiceClient, CaseAttachmentServiceAsyncClient
])
...
@mock.patch.object(CaseAttachmentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CaseAttachmentServiceClient))
@mock.patch.object(CaseAttachmentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CaseAttachmentServiceAsyncClient))
def test_case_attachment_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (CaseAttachmentServiceClient, transports.CaseAttachmentServiceGrpcTransport, "grpc", grpc_helpers),
    (CaseAttachmentServiceAsyncClient, transports.CaseAttachmentServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (CaseAttachmentServiceClient, transports.CaseAttachmentServiceRestTransport, "rest", None),
])
...
def test_case_attachment_service_client_client_options_from_dict():
    with mock.patch('google.cloud.support_v2beta.services.case_attachment_service.transports.CaseAttachmentServiceGrpcTransport.__init__') as grpc_transport:
...
def test_list_attachments(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.list_attachments),
            '__call__') as call:
...
def test_list_attachments_non_empty_request_with_auto_populated_field():
...
def test_list_attachments_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_attachments in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_attachments] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_attachments_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_attachments in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_attachments] = mock_rpc
...
async def test_list_attachments_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_attachments(
            parent='parent_value',
        )
...
def test_list_attachments_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_attachments(request={}, retry=retry, timeout=timeout)
        ...
        assert all(isinstance(i, attachment.Attachment)
                   for i in results)
...
def test_get_attachment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_attachment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_attachment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CaseAttachmentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_attachment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_attachment] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_attachment_async(transport: str = 'grpc_asyncio', request_type=attachment_service.GetAttachmentRequest):
    client = CaseAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(attachment.Attachment(
            name='name_value',
            filename='filename_value',
            mime_type='mime_type_value',
            size_bytes=1089,
...
def test_list_attachments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2beta/{parent=projects/*/cases/*}/attachments" % client.transport._host, args[1])
...
def test_get_attachment_rest_required_fields(request_type=attachment_service.GetAttachmentRequest):
    transport_class = transports.CaseAttachmentServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_attachment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_attachment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'sample1/sample2/cases/sample3/attachments/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta/{name=*/*/cases/*/attachments/*}" % client.transport._host, args[1])
...
def test_credentials_transport_error():
    ...
    transport = transports.CaseAttachmentServiceGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = CaseAttachmentServiceClient(
...
def test_transport_get_channel():
    ...
    transport = transports.CaseAttachmentServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
@pytest.mark.parametrize("transport_class", [
    transports.CaseAttachmentServiceGrpcTransport,
    transports.CaseAttachmentServiceGrpcAsyncIOTransport,
    transports.CaseAttachmentServiceRestTransport,
])
...
def test_list_attachments_empty_call_grpc():
    client = CaseAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = attachment_service.ListAttachmentsResponse()
        client.list_attachments(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = CaseAttachmentServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_attachments_empty_call_grpc_asyncio():
    client = CaseAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_attachments(request=None)
...
def test_transport_kind_rest():
    transport = CaseAttachmentServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_attachments_rest_bad_request(request_type=attachment_service.ListAttachmentsRequest):
    client = CaseAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_attachments_rest_call_success(request_type):
    client = CaseAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_attachments_rest_interceptors(null_interceptor):
    transport = transports.CaseAttachmentServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CaseAttachmentServiceRestInterceptor(),
        )
    client = CaseAttachmentServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CaseAttachmentServiceRestInterceptor, "post_list_attachments") as post, \
        mock.patch.object(transports.CaseAttachmentServiceRestInterceptor, "post_list_attachments_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CaseAttachmentServiceRestInterceptor, "pre_list_attachments") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = attachment_service.ListAttachmentsResponse.to_json(attachment_service.ListAttachmentsResponse())
        ...
        post_with_metadata.return_value = attachment_service.ListAttachmentsResponse(), metadata
...
def test_get_attachment_rest_bad_request(request_type=attachment_service.GetAttachmentRequest):
    client = CaseAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'sample1/sample2/cases/sample3/attachments/sample4'}
    request = request_type(**request_init)
...
def test_get_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CaseAttachmentServiceRestInterceptor, "post_get_attachment") as post, \
        mock.patch.object(transports.CaseAttachmentServiceRestInterceptor, "post_get_attachment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CaseAttachmentServiceRestInterceptor, "pre_get_attachment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = attachment_service.GetAttachmentRequest.pb(attachment_service.GetAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_attachment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_attachments_empty_call_rest():
    client = CaseAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_case_attachment_service_base_transport():
    ...
    with mock.patch('google.cloud.support_v2beta.services.case_attachment_service.transports.CaseAttachmentServiceTransport.__init__') as Transport:
...
def test_case_attachment_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.support_v2beta.services.case_attachment_service.transports.CaseAttachmentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_case_attachment_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.support_v2beta.services.case_attachment_service.transports.CaseAttachmentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CaseAttachmentServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize(
    ...
    [
        (transports.CaseAttachmentServiceGrpcTransport, grpc_helpers),
        (transports.CaseAttachmentServiceGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_case_attachment_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_case_attachment_service_client_transport_session_collision(transport_name):
    ...
    client1 = CaseAttachmentServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = CaseAttachmentServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("transport_class", [transports.CaseAttachmentServiceGrpcTransport, transports.CaseAttachmentServiceGrpcAsyncIOTransport])
def test_case_attachment_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.CaseAttachmentServiceGrpcTransport, transports.CaseAttachmentServiceGrpcAsyncIOTransport])
def test_case_attachment_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
@pytest.mark.parametrize("client_class,transport_class", [
    (CaseAttachmentServiceClient, transports.CaseAttachmentServiceGrpcTransport),
    (CaseAttachmentServiceAsyncClient, transports.CaseAttachmentServiceGrpcAsyncIOTransport),
])

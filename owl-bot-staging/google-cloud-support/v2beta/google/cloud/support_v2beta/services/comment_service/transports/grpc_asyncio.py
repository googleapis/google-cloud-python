...
from .base import CommentServiceTransport, DEFAULT_CLIENT_INFO
...
class CommentServiceGrpcAsyncIOTransport(CommentServiceTransport):
    """gRPC AsyncIO backend transport for CommentService.
    ...
    def list_comments(self) -> Callable[
            ...
            Awaitable[comment_service.ListCommentsResponse]]:
        ...
        if 'list_comments' not in self._stubs:
            self._stubs['list_comments'] = self._logged_channel.unary_unary(
                ...
                request_serializer=comment_service.ListCommentsRequest.serialize,
                response_deserializer=comment_service.ListCommentsResponse.deserialize,
            )
    ...
    def create_comment(self) -> Callable[
        ...
        if 'create_comment' not in self._stubs:
            self._stubs['create_comment'] = self._logged_channel.unary_unary(
                ...
                request_serializer=comment_service.CreateCommentRequest.serialize,
...
__all__ = (
    'CommentServiceGrpcAsyncIOTransport',
)

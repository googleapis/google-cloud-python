...
class CommentServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get_comment(self, request: comment_service.GetCommentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[comment_service.GetCommentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_comment_with_metadata(self, response: comment.Comment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[comment.Comment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_comment
...
class CommentServiceRestTransport(_BaseCommentServiceRestTransport):
    ...
    class _GetComment(_BaseCommentServiceRestTransport._BaseGetComment, CommentServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CommentServiceRestTransport._GetComment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
from .transports.base import CommentServiceTransport, DEFAULT_CLIENT_INFO
...
from .transports.rest import CommentServiceRestTransport


class CommentServiceClientMeta(type):
    """Metaclass for the CommentService client.
...
class CommentServiceClient(metaclass=CommentServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "cloudsupport.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CommentServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CommentServiceTransport:
        ...
        Returns:
            CommentServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def case_path(organization: str,case: str,) -> str:
        """Returns a fully-qualified case string."""
        return "organizations/{organization}/cases/{case}".format(organization=organization, case=case, )
    ...
    @staticmethod
    def comment_path(organization: str,case: str,comment: str,) -> str:
        """Returns a fully-qualified comment string."""
        return "organizations/{organization}/cases/{case}/comments/{comment}".format(organization=organization, case=case, comment=comment, )

    @staticmethod
    def parse_comment_path(path: str) -> Dict[str,str]:
        """Parses a comment path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/cases/(?P<case>.+?)/comments/(?P<comment>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = CommentServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = CommentServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CommentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = CommentServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CommentServiceTransport, Callable[..., CommentServiceTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,CommentServiceTransport,Callable[..., CommentServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CommentServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CommentServiceClient._read_environment_variables()
        self._client_cert_source = CommentServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CommentServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, CommentServiceTransport)
        if transport_provided:
            # transport is a CommentServiceTransport instance.
        ...
        self._api_endpoint = (self._api_endpoint or
            CommentServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CommentServiceTransport], Callable[..., CommentServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.support_v2beta.CommentServiceClient`.",
                    extra = {
    ...
    def list_comments(self,
        ...
        .. code-block:: python
            ...
            def sample_list_comments():
                # Create a client
                client = support_v2beta.CommentServiceClient()

                # Initialize request argument(s)
                request = support_v2beta.ListCommentsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.ListCommentsRequest, dict]):
        ...
        if not isinstance(request, comment_service.ListCommentsRequest):
    ...
    def create_comment(self,
        ...
        .. code-block:: python
            ...
            def sample_create_comment():
                ...
                # Initialize request argument(s)
                request = support_v2beta.CreateCommentRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.CreateCommentRequest, dict]):
                The request object. The request message for the
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, comment_service.CreateCommentRequest):
    ...
    def get_comment(self,
        ...
        .. code-block:: python
            ...
            def sample_get_comment():
                ...
                # Initialize request argument(s)
                request = support_v2beta.GetCommentRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.GetCommentRequest, dict]):
                The request object. The request message for the
                GetComment endpoint.
            name (str):
    ...
    def __enter__(self) -> "CommentServiceClient":
        return self

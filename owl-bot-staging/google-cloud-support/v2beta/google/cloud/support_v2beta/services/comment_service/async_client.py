...
class CommentServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = CommentServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    common_billing_account_path = staticmethod(CommentServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(CommentServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(CommentServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(CommentServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(CommentServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(CommentServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(CommentServiceClient.common_project_path)
    parse_common_project_path = staticmethod(CommentServiceClient.parse_common_project_path)
    common_location_path = staticmethod(CommentServiceClient.common_location_path)
    parse_common_location_path = staticmethod(CommentServiceClient.parse_common_location_path)
    ...
    get_transport_class = CommentServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, CommentServiceTransport, Callable[..., CommentServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.support_v2beta.CommentServiceAsyncClient`.",
                extra = {
    ...
    async def list_comments(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_comments():
                # Create a client
                client = support_v2beta.CommentServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.support_v2beta.types.ListCommentsRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_comments]
    ...
    async def create_comment(self,
        ...
        Args:
            request (Optional[Union[google.cloud.support_v2beta.types.CreateCommentRequest, dict]]):
                The request object. The request message for the
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            comment (:class:`google.cloud.support_v2beta.types.Comment`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_comment]
    ...
    async def get_comment(self,
        ...
        Args:
            request (Optional[Union[google.cloud.support_v2beta.types.GetCommentRequest, dict]]):
                The request object. The request message for the
                GetComment endpoint.
            name (:class:`str`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_comment]

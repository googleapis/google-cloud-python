...
class ListCasesPager:
    ...
    :class:`google.cloud.support_v2beta.types.ListCasesResponse` object, and
    ...
    All the usual :class:`google.cloud.support_v2beta.types.ListCasesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.support_v2beta.types.ListCasesRequest):
                The initial request object.
            response (google.cloud.support_v2beta.types.ListCasesResponse):
...
class SearchCasesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.support_v2beta.types.SearchCasesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``cases`` field.
    ...
    All the usual :class:`google.cloud.support_v2beta.types.SearchCasesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.support_v2beta.types.SearchCasesRequest):
                The initial request object.
            response (google.cloud.support_v2beta.types.SearchCasesResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class SearchCaseClassificationsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.support_v2beta.types.SearchCaseClassificationsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.support_v2beta.types.SearchCaseClassificationsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.support_v2beta.types.SearchCaseClassificationsRequest):
                The initial request object.
            response (google.cloud.support_v2beta.types.SearchCaseClassificationsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

...
from .transports.base import CaseServiceTransport, DEFAULT_CLIENT_INFO
...
class CaseServiceClient(metaclass=CaseServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CaseServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CaseServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = CaseServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CaseServiceTransport, Callable[..., CaseServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CaseServiceClient._read_environment_variables()
        self._client_cert_source = CaseServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CaseServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, CaseServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(CaseServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CaseServiceTransport], Callable[..., CaseServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.support_v2beta.CaseServiceClient`.",
                    extra = {
    ...
    def get_case(self,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.GetCaseRequest, dict]):
    ...
    def list_cases(self,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.ListCasesRequest, dict]):
    ...
    def search_cases(self,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.SearchCasesRequest, dict]):
    ...
    def create_case(self,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.CreateCaseRequest, dict]):
                The request object. The request message for the
                CreateCase endpoint.
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            case (google.cloud.support_v2beta.types.Case):
    ...
    def update_case(self,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.UpdateCaseRequest, dict]):
                The request object. The request message for the
                UpdateCase endpoint
            case (google.cloud.support_v2beta.types.Case):
    ...
    def escalate_case(self,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.EscalateCaseRequest, dict]):
                The request object. The request message for the
    ...
    def close_case(self,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.CloseCaseRequest, dict]):
    ...
    def search_case_classifications(self,
            request: Optional[Union[case_service.SearchCaseClassificationsRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.SearchCaseClassificationsRequest, dict]):
                The request object. The request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_case_classifications]

...
from google.cloud.support_v2beta.types import attachment
from google.cloud.support_v2beta.types import attachment_service


from .rest_base import _BaseCaseAttachmentServiceRestTransport
...
class CaseAttachmentServiceRestInterceptor:
    """Interceptor for CaseAttachmentService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the CaseAttachmentServiceRestTransport.

    .. code-block:: python
        class MyCustomCaseAttachmentServiceInterceptor(CaseAttachmentServiceRestInterceptor):
        ...
        transport = CaseAttachmentServiceRestTransport(interceptor=MyCustomCaseAttachmentServiceInterceptor())
        client = CaseAttachmentServiceClient(transport=transport)


    """
    def pre_get_attachment(self, request: attachment_service.GetAttachmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[attachment_service.GetAttachmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for get_attachment

        Override in a subclass to manipulate the request or metadata
        before they are sent to the CaseAttachmentService server.
        """
        return request, metadata
    ...
    def post_get_attachment(self, response: attachment.Attachment) -> attachment.Attachment:
        ...
        after it is returned by the CaseAttachmentService server but before
    ...
    def post_get_attachment_with_metadata(self, response: attachment.Attachment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[attachment.Attachment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_attachment

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the CaseAttachmentService server but before it is returned to user code.
    ...
    def pre_list_attachments(self, request: attachment_service.ListAttachmentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[attachment_service.ListAttachmentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_attachments_with_metadata(self, response: attachment_service.ListAttachmentsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[attachment_service.ListAttachmentsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_attachments
...
class CaseAttachmentServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: CaseAttachmentServiceRestInterceptor
...
class CaseAttachmentServiceRestTransport(_BaseCaseAttachmentServiceRestTransport):
    ...
    def __init__(self, *,
            ...
            interceptor: Optional[CaseAttachmentServiceRestInterceptor] = None,
    ...
    class _GetAttachment(_BaseCaseAttachmentServiceRestTransport._BaseGetAttachment, CaseAttachmentServiceRestStub):
        ...
        def __call__(self,
            ...
            Returns:
                ~.attachment.Attachment:
                    An Attachment contains metadata about a file that was
                uploaded to a case - it is NOT a file itself. That being
                said, the name of an Attachment object can be used to
                download its accompanying file through the
                ``media.download`` endpoint.

                While attachments can be uploaded in the console at the
                same time as a comment, they're associated on a "case"
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.support_v2beta.CaseAttachmentServiceClient.GetAttachment",
                    extra = {
            ...
            # Send the request
            response = CaseAttachmentServiceRestTransport._GetAttachment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.support_v2beta.CaseAttachmentServiceClient.get_attachment",
                    extra = {
                        "serviceName": "google.cloud.support.v2beta.CaseAttachmentService",
                        "rpcName": "GetAttachment",
    ...
    class _ListAttachments(_BaseCaseAttachmentServiceRestTransport._BaseListAttachments, CaseAttachmentServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.support_v2beta.CaseAttachmentServiceClient.ListAttachments",
                    extra = {
                        "serviceName": "google.cloud.support.v2beta.CaseAttachmentService",
            ...
            # Send the request
            response = CaseAttachmentServiceRestTransport._ListAttachments._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = attachment_service.ListAttachmentsResponse()
            pb_resp = attachment_service.ListAttachmentsResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.support_v2beta.CaseAttachmentServiceClient.list_attachments",
                    extra = {
                        "serviceName": "google.cloud.support.v2beta.CaseAttachmentService",
                        "rpcName": "ListAttachments",
                        "metadata": http_response["headers"],
    ...
    @property
    def get_attachment(self) -> Callable[
    ...
    @property
    def list_attachments(self) -> Callable[

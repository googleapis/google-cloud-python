...
class ListAttachmentsPager:
    ...
    :class:`google.cloud.support_v2beta.types.ListAttachmentsResponse` object, and
    ...
    All the usual :class:`google.cloud.support_v2beta.types.ListAttachmentsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.support_v2beta.types.ListAttachmentsRequest):
                The initial request object.
            response (google.cloud.support_v2beta.types.ListAttachmentsResponse):

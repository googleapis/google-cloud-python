...
class ProductLine(proto.Enum):
    r"""The product line a support case may be associated with.
...
class Case(proto.Message):
    ...
    Attributes:
        ...
        classification (google.cloud.support_v2beta.types.CaseClassification):
        ...
        subscriber_email_addresses (MutableSequence[str]):
            ...
            this case.
        state (google.cloud.support_v2beta.types.Case.State):
        ...
        priority (google.cloud.support_v2beta.types.Case.Priority):
...
class CaseClassification(proto.Message):
    ...
    Attributes:
        ...
        product (google.cloud.support_v2beta.types.Product):
            The full product the classification
            corresponds to.
    """
...
class Product(proto.Message):
    ...
    Attributes:
        product_line (google.cloud.support_v2beta.types.ProductLine):
            The product line of the Product.
    """

    product_line: 'ProductLine' = proto.Field(
        proto.ENUM,
        number=1,
        enum='ProductLine',
    )

...
def test_list_attachments_rest_required_fields(request_type=attachment_service.ListAttachmentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_attachments._get_unset_required_fields(jsonified_request)
...
def test_list_attachments_rest_unset_required_fields():
    transport = transports.CaseAttachmentServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)

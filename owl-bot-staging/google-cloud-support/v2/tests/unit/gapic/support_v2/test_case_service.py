...
from google.cloud.support_v2.services.case_service import transports
...
from google.cloud.support_v2.types import escalation
...
def test_get_case_rest_required_fields(request_type=case_service.GetCaseRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_case._get_unset_required_fields(jsonified_request)
...
def test_get_case_rest_unset_required_fields():
    transport = transports.CaseServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_cases_rest_required_fields(request_type=case_service.ListCasesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_cases._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_case_rest_required_fields(request_type=case_service.CreateCaseRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_case._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_case_rest_required_fields(request_type=case_service.UpdateCaseRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_case._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_escalate_case_rest_required_fields(request_type=case_service.EscalateCaseRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).escalate_case._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_close_case_rest_required_fields(request_type=case_service.CloseCaseRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).close_case._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

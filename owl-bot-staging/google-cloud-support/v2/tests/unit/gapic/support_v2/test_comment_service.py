...
from google.cloud.support_v2.services.comment_service import transports
...
def test_list_comments_rest_required_fields(request_type=comment_service.ListCommentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_comments._get_unset_required_fields(jsonified_request)
...
def test_list_comments_rest_unset_required_fields():
    transport = transports.CommentServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_comment_rest_required_fields(request_type=comment_service.CreateCommentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_comment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

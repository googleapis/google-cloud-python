...
class CaseServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_close_case(self, request: case_service.CloseCaseRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case_service.CloseCaseRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_close_case_with_metadata(self, response: case.Case, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case.Case, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for close_case
    ...
    def pre_create_case(self, request: case_service.CreateCaseRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case_service.CreateCaseRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_case_with_metadata(self, response: gcs_case.Case, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcs_case.Case, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_case
    ...
    def pre_escalate_case(self, request: case_service.EscalateCaseRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case_service.EscalateCaseRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_escalate_case_with_metadata(self, response: case.Case, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case.Case, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for escalate_case
    ...
    def pre_get_case(self, request: case_service.GetCaseRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case_service.GetCaseRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_case_with_metadata(self, response: case.Case, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case.Case, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_case
    ...
    def pre_list_cases(self, request: case_service.ListCasesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case_service.ListCasesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_cases_with_metadata(self, response: case_service.ListCasesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case_service.ListCasesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_cases
    ...
    def pre_search_case_classifications(self, request: case_service.SearchCaseClassificationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case_service.SearchCaseClassificationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search_case_classifications(self, response: case_service.SearchCaseClassificationsResponse) -> case_service.SearchCaseClassificationsResponse:
    ...
    def post_search_case_classifications_with_metadata(self, response: case_service.SearchCaseClassificationsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case_service.SearchCaseClassificationsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_case_classifications
    ...
    def pre_search_cases(self, request: case_service.SearchCasesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case_service.SearchCasesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search_cases_with_metadata(self, response: case_service.SearchCasesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case_service.SearchCasesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_cases
    ...
    def pre_update_case(self, request: case_service.UpdateCaseRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[case_service.UpdateCaseRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_case_with_metadata(self, response: gcs_case.Case, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcs_case.Case, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_case
...
class CaseServiceRestTransport(_BaseCaseServiceRestTransport):
    ...
    class _CloseCase(_BaseCaseServiceRestTransport._BaseCloseCase, CaseServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CaseServiceRestTransport._CloseCase._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CreateCase(_BaseCaseServiceRestTransport._BaseCreateCase, CaseServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CaseServiceRestTransport._CreateCase._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _EscalateCase(_BaseCaseServiceRestTransport._BaseEscalateCase, CaseServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CaseServiceRestTransport._EscalateCase._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListCases(_BaseCaseServiceRestTransport._BaseListCases, CaseServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CaseServiceRestTransport._ListCases._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SearchCaseClassifications(_BaseCaseServiceRestTransport._BaseSearchCaseClassifications, CaseServiceRestStub):
        ...
        classifications method over HTTP.
            ...
            # Send the request
            response = CaseServiceRestTransport._SearchCaseClassifications._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SearchCases(_BaseCaseServiceRestTransport._BaseSearchCases, CaseServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CaseServiceRestTransport._SearchCases._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateCase(_BaseCaseServiceRestTransport._BaseUpdateCase, CaseServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CaseServiceRestTransport._UpdateCase._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class CommentServiceClient(metaclass=CommentServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            CommentServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CommentServiceTransport]] = None,
    ...
    def list_comments(self,
        ...
        Args:
            request (Union[google.cloud.support_v2.types.ListCommentsRequest, dict]):
        ...
        # in a comment_service.ListCommentsRequest.
    ...
    def create_comment(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a comment_service.CreateCommentRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

...
class CommentServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_comment(self, request: comment_service.CreateCommentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[comment_service.CreateCommentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_comment_with_metadata(self, response: gcs_comment.Comment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcs_comment.Comment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_comment
    ...
    def pre_list_comments(self, request: comment_service.ListCommentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[comment_service.ListCommentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_comments_with_metadata(self, response: comment_service.ListCommentsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[comment_service.ListCommentsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_comments
...
class CommentServiceRestTransport(_BaseCommentServiceRestTransport):
    ...
    class _CreateComment(_BaseCommentServiceRestTransport._BaseCreateComment, CommentServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CommentServiceRestTransport._CreateComment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListComments(_BaseCommentServiceRestTransport._BaseListComments, CommentServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CommentServiceRestTransport._ListComments._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

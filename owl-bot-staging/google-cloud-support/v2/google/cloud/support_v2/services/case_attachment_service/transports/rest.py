    ...
    class _ListAttachments(_BaseCaseAttachmentServiceRestTransport._BaseListAttachments, CaseAttachmentServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.support_v2.CaseAttachmentServiceClient.ListAttachments",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.support_v2.CaseAttachmentServiceClient.list_attachments",
                    extra = {
                        "serviceName": "google.cloud.support.v2.CaseAttachmentService",
                        "rpcName": "ListAttachments",

...
from .base import CaseAttachmentServiceTransport, DEFAULT_CLIENT_INFO
...
class CaseAttachmentServiceGrpcAsyncIOTransport(CaseAttachmentServiceTransport):
    ...
    def list_attachments(self) -> Callable[
        ...
        if 'list_attachments' not in self._stubs:
            self._stubs['list_attachments'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=attachment_service.ListAttachmentsRequest.serialize,
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_attachments: gapic_v1.method_async.wrap_method(
...
__all__ = (
    'CaseAttachmentServiceGrpcAsyncIOTransport',
)

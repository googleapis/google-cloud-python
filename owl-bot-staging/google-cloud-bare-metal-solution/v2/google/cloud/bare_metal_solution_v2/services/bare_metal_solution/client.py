...
class BareMetalSolutionClient(metaclass=BareMetalSolutionClientMeta):
    ...
    @staticmethod
    def instance_config_path(project: str,location: str,instance_config: str,) -> str:
        """Returns a fully-qualified instance_config string."""
        return "projects/{project}/locations/{location}/instanceConfigs/{instance_config}".format(project=project, location=location, instance_config=instance_config, )

    @staticmethod
    def parse_instance_config_path(path: str) -> Dict[str,str]:
        """Parses a instance_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instanceConfigs/(?P<instance_config>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def instance_quota_path(project: str,location: str,instance_quota: str,) -> str:
        """Returns a fully-qualified instance_quota string."""
        return "projects/{project}/locations/{location}/instanceQuotas/{instance_quota}".format(project=project, location=location, instance_quota=instance_quota, )

    @staticmethod
    def parse_instance_quota_path(path: str) -> Dict[str,str]:
        """Parses a instance_quota path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instanceQuotas/(?P<instance_quota>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def interconnect_attachment_path(project: str,region: str,interconnect_attachment: str,) -> str:
        """Returns a fully-qualified interconnect_attachment string."""
        return "projects/{project}/regions/{region}/interconnectAttachments/{interconnect_attachment}".format(project=project, region=region, interconnect_attachment=interconnect_attachment, )
    ...
    def parse_interconnect_attachment_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/regions/(?P<region>.+?)/interconnectAttachments/(?P<interconnect_attachment>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def network_config_path(project: str,location: str,network_config: str,) -> str:
        """Returns a fully-qualified network_config string."""
        return "projects/{project}/locations/{location}/networkConfigs/{network_config}".format(project=project, location=location, network_config=network_config, )

    @staticmethod
    def parse_network_config_path(path: str) -> Dict[str,str]:
        """Parses a network_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/networkConfigs/(?P<network_config>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def nfs_share_path(project: str,location: str,nfs_share: str,) -> str:
        """Returns a fully-qualified nfs_share string."""
        return "projects/{project}/locations/{location}/nfsShares/{nfs_share}".format(project=project, location=location, nfs_share=nfs_share, )

    @staticmethod
    def parse_nfs_share_path(path: str) -> Dict[str,str]:
        """Parses a nfs_share path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/nfsShares/(?P<nfs_share>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def os_image_path(project: str,location: str,os_image: str,) -> str:
        """Returns a fully-qualified os_image string."""
        return "projects/{project}/locations/{location}/osImages/{os_image}".format(project=project, location=location, os_image=os_image, )

    @staticmethod
    def parse_os_image_path(path: str) -> Dict[str,str]:
        """Parses a os_image path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/osImages/(?P<os_image>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def provisioning_config_path(project: str,location: str,provisioning_config: str,) -> str:
        """Returns a fully-qualified provisioning_config string."""
        return "projects/{project}/locations/{location}/provisioningConfigs/{provisioning_config}".format(project=project, location=location, provisioning_config=provisioning_config, )

    @staticmethod
    def parse_provisioning_config_path(path: str) -> Dict[str,str]:
        """Parses a provisioning_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/provisioningConfigs/(?P<provisioning_config>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def provisioning_quota_path(project: str,location: str,provisioning_quota: str,) -> str:
        """Returns a fully-qualified provisioning_quota string."""
        return "projects/{project}/locations/{location}/provisioningQuotas/{provisioning_quota}".format(project=project, location=location, provisioning_quota=provisioning_quota, )

    @staticmethod
    def parse_provisioning_quota_path(path: str) -> Dict[str,str]:
        """Parses a provisioning_quota path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/provisioningQuotas/(?P<provisioning_quota>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def server_network_template_path(project: str,location: str,server_network_template: str,) -> str:
        """Returns a fully-qualified server_network_template string."""
        return "projects/{project}/locations/{location}/serverNetworkTemplate/{server_network_template}".format(project=project, location=location, server_network_template=server_network_template, )
    ...
    def parse_server_network_template_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/serverNetworkTemplate/(?P<server_network_template>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def ssh_key_path(project: str,location: str,ssh_key: str,) -> str:
        """Returns a fully-qualified ssh_key string."""
        return "projects/{project}/locations/{location}/sshKeys/{ssh_key}".format(project=project, location=location, ssh_key=ssh_key, )

    @staticmethod
    def parse_ssh_key_path(path: str) -> Dict[str,str]:
        """Parses a ssh_key path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/sshKeys/(?P<ssh_key>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def volume_config_path(project: str,location: str,volume_config: str,) -> str:
        """Returns a fully-qualified volume_config string."""
        return "projects/{project}/locations/{location}/volumeConfigs/{volume_config}".format(project=project, location=location, volume_config=volume_config, )

    @staticmethod
    def parse_volume_config_path(path: str) -> Dict[str,str]:
        """Parses a volume_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/volumeConfigs/(?P<volume_config>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = BareMetalSolutionClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            BareMetalSolutionClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BareMetalSolutionTransport, Callable[..., BareMetalSolutionTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = BareMetalSolutionClient._read_environment_variables()
        self._client_cert_source = BareMetalSolutionClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = BareMetalSolutionClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BareMetalSolutionTransport], Callable[..., BareMetalSolutionTransport]] = (
    ...
    def enable_interactive_serial_console(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.enable_interactive_serial_console]
    ...
    def disable_interactive_serial_console(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.disable_interactive_serial_console]
    ...
    def list_provisioning_quotas(self,
    ...
    def submit_provisioning_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.submit_provisioning_config]
    ...
    def create_provisioning_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_provisioning_config]
    ...
    def update_provisioning_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_provisioning_config]

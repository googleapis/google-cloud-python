...
@pytest.mark.asyncio
async def test_list_tag_keys_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
async def test_list_tag_keys_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.list_tag_keys] = mock_object
...
@pytest.mark.asyncio
async def test_get_tag_key_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = TagKeysAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_get_tag_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_tag_key] = mock_object
...
@pytest.mark.asyncio
async def test_get_namespaced_tag_key_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = TagKeysAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_get_namespaced_tag_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_namespaced_tag_key] = mock_object
...
@pytest.mark.asyncio
async def test_create_tag_key_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = TagKeysAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_create_tag_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_tag_key] = mock_object
...
@pytest.mark.asyncio
async def test_update_tag_key_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = TagKeysAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_update_tag_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_tag_key] = mock_object
...
@pytest.mark.asyncio
async def test_delete_tag_key_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = TagKeysAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_delete_tag_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_tag_key] = mock_object
...
def test_transport_kind(transport_name):
    transport = TagKeysClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )

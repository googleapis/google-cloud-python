...
def test_list_tag_keys_rest_required_fields(request_type=tag_keys.ListTagKeysRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_tag_keys._get_unset_required_fields(jsonified_request)
...
def test_list_tag_keys_rest_unset_required_fields():
    transport = transports.TagKeysRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_tag_key_rest_required_fields(request_type=tag_keys.GetTagKeyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_tag_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_namespaced_tag_key_rest_required_fields(request_type=tag_keys.GetNamespacedTagKeyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_namespaced_tag_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_tag_key_rest_required_fields(request_type=tag_keys.CreateTagKeyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_tag_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_tag_key_rest_required_fields(request_type=tag_keys.UpdateTagKeyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_tag_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_tag_key_rest_required_fields(request_type=tag_keys.DeleteTagKeyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_tag_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

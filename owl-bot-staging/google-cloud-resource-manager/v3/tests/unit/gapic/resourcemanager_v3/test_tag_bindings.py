...
def test__read_environment_variables():
    assert TagBindingsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert TagBindingsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert TagBindingsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert TagBindingsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert TagBindingsClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert TagBindingsClient._get_client_cert_source(None, False) is None
    assert TagBindingsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert TagBindingsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert TagBindingsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert TagBindingsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(TagBindingsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagBindingsClient))
@mock.patch.object(TagBindingsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagBindingsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TagBindingsClient._DEFAULT_UNIVERSE
    default_endpoint = TagBindingsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = TagBindingsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert TagBindingsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert TagBindingsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == TagBindingsClient.DEFAULT_MTLS_ENDPOINT
    assert TagBindingsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert TagBindingsClient._get_api_endpoint(None, None, default_universe, "always") == TagBindingsClient.DEFAULT_MTLS_ENDPOINT
    assert TagBindingsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == TagBindingsClient.DEFAULT_MTLS_ENDPOINT
    assert TagBindingsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert TagBindingsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        TagBindingsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert TagBindingsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert TagBindingsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert TagBindingsClient._get_universe_domain(None, None) == TagBindingsClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_name", [
    (TagBindingsClient, "grpc"),
    (TagBindingsAsyncClient, "grpc_asyncio"),
    (TagBindingsClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.TagBindingsGrpcTransport, "grpc"),
    (transports.TagBindingsGrpcAsyncIOTransport, "grpc_asyncio"),
    (transports.TagBindingsRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (TagBindingsClient, transports.TagBindingsRestTransport, "rest"),
])
@mock.patch.object(TagBindingsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagBindingsClient))
@mock.patch.object(TagBindingsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagBindingsAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (TagBindingsClient, transports.TagBindingsRestTransport, "rest", "true"),
    (TagBindingsClient, transports.TagBindingsRestTransport, "rest", "false"),
])
@mock.patch.object(TagBindingsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagBindingsClient))
@mock.patch.object(TagBindingsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagBindingsAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    TagBindingsClient, TagBindingsAsyncClient
])
...
@mock.patch.object(TagBindingsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagBindingsClient))
@mock.patch.object(TagBindingsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagBindingsAsyncClient))
def test_tag_bindings_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (TagBindingsClient, transports.TagBindingsGrpcTransport, "grpc", grpc_helpers),
    (TagBindingsAsyncClient, transports.TagBindingsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (TagBindingsClient, transports.TagBindingsRestTransport, "rest", None),
])
...
def test_list_tag_bindings_non_empty_request_with_auto_populated_field():
...
def test_list_tag_bindings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_tag_bindings in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_tag_bindings] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_tag_bindings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_tag_bindings in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_tag_bindings] = mock_rpc
...
def test_list_tag_bindings_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        retry = retries.Retry()
        timeout = 5
        pager = client.list_tag_bindings(request={}, retry=retry, timeout=timeout)
...
def test_create_tag_binding_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_tag_binding_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_tag_binding in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_tag_binding] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_tag_binding_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TagBindingsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_tag_binding in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_tag_binding] = mock_rpc

        request = {}
        await client.create_tag_binding(request)
...
def test_delete_tag_binding_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_delete_tag_binding_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_tag_binding in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_tag_binding] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_tag_binding_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TagBindingsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_tag_binding in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_tag_binding] = mock_rpc
...
def test_list_effective_tags(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_effective_tags),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_effective_tags_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_effective_tags_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_effective_tags in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_effective_tags] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_effective_tags_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TagBindingsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_effective_tags in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_effective_tags] = mock_rpc
...
async def test_list_effective_tags_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_effective_tags(
            parent='parent_value',
        )
...
async def test_list_effective_tags_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_effective_tags(
            tag_bindings.ListEffectiveTagsRequest(),
            parent='parent_value',
        )
...
def test_list_effective_tags_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        retry = retries.Retry()
        timeout = 5
        pager = client.list_effective_tags(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, tag_bindings.EffectiveTag)
                   for i in results)
...
def test_list_tag_bindings_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TagBindingsClient(
...
def test_create_tag_binding_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TagBindingsClient(
...
def test_delete_tag_binding_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TagBindingsClient(
...
def test_list_effective_tags_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TagBindingsClient(
...
def test_list_tag_bindings_empty_call_grpc():
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = tag_bindings.ListTagBindingsResponse()
        client.list_tag_bindings(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_tag_binding_empty_call_grpc():
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_tag_binding(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_tag_binding_empty_call_grpc():
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_tag_binding(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_effective_tags_empty_call_grpc():
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = tag_bindings.ListEffectiveTagsResponse()
        client.list_effective_tags(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = TagBindingsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_tag_bindings_empty_call_grpc_asyncio():
    client = TagBindingsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_tag_bindings(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_tag_binding_empty_call_grpc_asyncio():
    client = TagBindingsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_tag_binding(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_tag_binding_empty_call_grpc_asyncio():
    client = TagBindingsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_tag_binding(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_effective_tags_empty_call_grpc_asyncio():
    client = TagBindingsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_effective_tags(request=None)
...
def test_transport_kind_rest():
    transport = TagBindingsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_tag_bindings_rest_bad_request(request_type=tag_bindings.ListTagBindingsRequest):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_tag_bindings_rest_call_success(request_type):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_tag_bindings_rest_interceptors(null_interceptor):
    transport = transports.TagBindingsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.TagBindingsRestInterceptor(),
        )
    client = TagBindingsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TagBindingsRestInterceptor, "post_list_tag_bindings") as post, \
        mock.patch.object(transports.TagBindingsRestInterceptor, "post_list_tag_bindings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TagBindingsRestInterceptor, "pre_list_tag_bindings") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = tag_bindings.ListTagBindingsResponse.to_json(tag_bindings.ListTagBindingsResponse())
        ...
        post_with_metadata.return_value = tag_bindings.ListTagBindingsResponse(), metadata
...
def test_create_tag_binding_rest_bad_request(request_type=tag_bindings.CreateTagBindingRequest):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_tag_binding_rest_call_success(request_type):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    for field, value in request_init["tag_binding"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_tag_binding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TagBindingsRestInterceptor, "post_create_tag_binding") as post, \
        mock.patch.object(transports.TagBindingsRestInterceptor, "post_create_tag_binding_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TagBindingsRestInterceptor, "pre_create_tag_binding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_tag_binding_rest_bad_request(request_type=tag_bindings.DeleteTagBindingRequest):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_tag_binding_rest_call_success(request_type):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_tag_binding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.TagBindingsRestInterceptor, "post_delete_tag_binding") as post, \
        mock.patch.object(transports.TagBindingsRestInterceptor, "post_delete_tag_binding_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TagBindingsRestInterceptor, "pre_delete_tag_binding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_effective_tags_rest_bad_request(request_type=tag_bindings.ListEffectiveTagsRequest):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_effective_tags_rest_call_success(request_type):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_effective_tags_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TagBindingsRestInterceptor, "post_list_effective_tags") as post, \
        mock.patch.object(transports.TagBindingsRestInterceptor, "post_list_effective_tags_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TagBindingsRestInterceptor, "pre_list_effective_tags") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = tag_bindings.ListEffectiveTagsResponse.to_json(tag_bindings.ListEffectiveTagsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = tag_bindings.ListEffectiveTagsResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_tag_bindings_empty_call_rest():
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_tag_binding_empty_call_rest():
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_tag_binding_empty_call_rest():
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_effective_tags_empty_call_rest():
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_tag_bindings_client_transport_session_collision(transport_name):
    ...
    client1 = TagBindingsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = TagBindingsClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("client_class,transport_class", [
    (TagBindingsClient, transports.TagBindingsGrpcTransport),
    (TagBindingsAsyncClient, transports.TagBindingsGrpcAsyncIOTransport),
])

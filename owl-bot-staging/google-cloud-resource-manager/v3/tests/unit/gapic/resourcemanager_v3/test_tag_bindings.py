...
def test_list_tag_bindings_rest_required_fields(request_type=tag_bindings.ListTagBindingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_tag_bindings._get_unset_required_fields(jsonified_request)
...
def test_create_tag_binding_rest_required_fields(request_type=tag_bindings.CreateTagBindingRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_tag_binding._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_tag_binding_rest_required_fields(request_type=tag_bindings.DeleteTagBindingRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_tag_binding._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_effective_tags_rest_required_fields(request_type=tag_bindings.ListEffectiveTagsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_effective_tags._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

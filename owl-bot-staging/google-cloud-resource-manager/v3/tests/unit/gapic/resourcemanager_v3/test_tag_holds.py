...
def test_create_tag_hold_rest_required_fields(request_type=tag_holds.CreateTagHoldRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_tag_hold._get_unset_required_fields(jsonified_request)
...
def test_delete_tag_hold_rest_required_fields(request_type=tag_holds.DeleteTagHoldRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_tag_hold._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_tag_holds_rest_required_fields(request_type=tag_holds.ListTagHoldsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_tag_holds._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

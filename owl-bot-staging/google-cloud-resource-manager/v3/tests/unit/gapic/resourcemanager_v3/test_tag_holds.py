...
def test_create_tag_hold_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TagHoldsRestInterceptor, "post_create_tag_hold_with_metadata") as post_with_metadata, \
...
def test_delete_tag_hold_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TagHoldsRestInterceptor, "post_delete_tag_hold_with_metadata") as post_with_metadata, \
...
def test_list_tag_holds_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TagHoldsRestInterceptor, "post_list_tag_holds_with_metadata") as post_with_metadata, \

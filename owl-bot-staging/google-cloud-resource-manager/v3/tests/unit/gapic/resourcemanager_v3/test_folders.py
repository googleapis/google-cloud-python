...
def test_get_folder_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FoldersRestInterceptor, "post_get_folder_with_metadata") as post_with_metadata, \
...
def test_list_folders_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FoldersRestInterceptor, "post_list_folders_with_metadata") as post_with_metadata, \
...
def test_search_folders_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FoldersRestInterceptor, "post_search_folders_with_metadata") as post_with_metadata, \
...
def test_create_folder_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FoldersRestInterceptor, "post_create_folder_with_metadata") as post_with_metadata, \
...
def test_update_folder_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FoldersRestInterceptor, "post_update_folder_with_metadata") as post_with_metadata, \
...
def test_move_folder_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FoldersRestInterceptor, "post_move_folder_with_metadata") as post_with_metadata, \
...
def test_delete_folder_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FoldersRestInterceptor, "post_delete_folder_with_metadata") as post_with_metadata, \
...
def test_undelete_folder_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FoldersRestInterceptor, "post_undelete_folder_with_metadata") as post_with_metadata, \
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FoldersRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FoldersRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FoldersRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \

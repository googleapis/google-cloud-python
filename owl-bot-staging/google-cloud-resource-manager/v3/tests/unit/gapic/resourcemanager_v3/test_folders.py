...
def test_get_folder_rest_required_fields(request_type=folders.GetFolderRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_folder._get_unset_required_fields(jsonified_request)
...
def test_list_folders_rest_required_fields(request_type=folders.ListFoldersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_folders._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_folder_rest_required_fields(request_type=folders.CreateFolderRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_folder._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_folder_rest_required_fields(request_type=folders.UpdateFolderRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_folder._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_move_folder_rest_required_fields(request_type=folders.MoveFolderRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).move_folder._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_folder_rest_required_fields(request_type=folders.DeleteFolderRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_folder._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_undelete_folder_rest_required_fields(request_type=folders.UndeleteFolderRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).undelete_folder._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

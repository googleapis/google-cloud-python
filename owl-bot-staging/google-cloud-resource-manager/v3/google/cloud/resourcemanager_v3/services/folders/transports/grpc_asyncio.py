...
class FoldersGrpcAsyncIOTransport(FoldersTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.search_folders: gapic_v1.method_async.wrap_method(
                self.search_folders,
                default_timeout=60.0,
                client_info=client_info,
            ),
            ...
            self.update_folder: gapic_v1.method_async.wrap_method(
                self.update_folder,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.move_folder: gapic_v1.method_async.wrap_method(
                self.move_folder,
                default_timeout=60.0,
                client_info=client_info,
            ),
            ...
            self.undelete_folder: gapic_v1.method_async.wrap_method(

...
class FoldersAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FoldersTransport, Callable[..., FoldersTransport]]] = "grpc_asyncio",
    ...
    async def search_folders(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_folders]
    ...
    async def update_folder(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_folder]
    ...
    async def move_folder(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.move_folder]
    ...
    async def undelete_folder(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.undelete_folder]

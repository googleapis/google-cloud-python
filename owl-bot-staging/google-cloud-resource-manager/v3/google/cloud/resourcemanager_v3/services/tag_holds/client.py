...
class TagHoldsClient(metaclass=TagHoldsClientMeta):
    ...
    @staticmethod
    def tag_hold_path(tag_value: str,tag_hold: str,) -> str:
        """Returns a fully-qualified tag_hold string."""
        return "tagValues/{tag_value}/tagHolds/{tag_hold}".format(tag_value=tag_value, tag_hold=tag_hold, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            TagHoldsClient._compare_universes(self.universe_domain, self.transport._credentials))

...
class TagHoldsGrpcAsyncIOTransport(TagHoldsTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_tag_hold: gapic_v1.method_async.wrap_method(
                self.create_tag_hold,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_tag_hold: gapic_v1.method_async.wrap_method(
                self.delete_tag_hold,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_tag_holds: gapic_v1.method_async.wrap_method(
                self.list_tag_holds,
                default_timeout=None,
                client_info=client_info,
            ),

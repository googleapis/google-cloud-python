...
class TagHoldsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_tag_hold(self, request: tag_holds.CreateTagHoldRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_holds.CreateTagHoldRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_tag_hold(self, request: tag_holds.DeleteTagHoldRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_holds.DeleteTagHoldRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_tag_holds(self, request: tag_holds.ListTagHoldsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_holds.ListTagHoldsRequest, Sequence[Tuple[str, str]]]:

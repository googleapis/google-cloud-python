...
class TagHoldsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_tag_hold(self, request: tag_holds.CreateTagHoldRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_holds.CreateTagHoldRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_tag_hold_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_tag_hold
    ...
    def pre_delete_tag_hold(self, request: tag_holds.DeleteTagHoldRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_holds.DeleteTagHoldRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_tag_hold_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_tag_hold
    ...
    def pre_list_tag_holds(self, request: tag_holds.ListTagHoldsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_holds.ListTagHoldsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_tag_holds_with_metadata(self, response: tag_holds.ListTagHoldsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_holds.ListTagHoldsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_tag_holds
...
class TagHoldsRestTransport(_BaseTagHoldsRestTransport):
    ...
    class _CreateTagHold(_BaseTagHoldsRestTransport._BaseCreateTagHold, TagHoldsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagHoldsRestTransport._CreateTagHold._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteTagHold(_BaseTagHoldsRestTransport._BaseDeleteTagHold, TagHoldsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagHoldsRestTransport._DeleteTagHold._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListTagHolds(_BaseTagHoldsRestTransport._BaseListTagHolds, TagHoldsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagHoldsRestTransport._ListTagHolds._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    @property
    def create_tag_hold(self) -> Callable[
    ...
    @property
    def delete_tag_hold(self) -> Callable[
    ...
    @property
    def list_tag_holds(self) -> Callable[
    ...
    class _GetOperation(_BaseTagHoldsRestTransport._BaseGetOperation, TagHoldsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagHoldsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

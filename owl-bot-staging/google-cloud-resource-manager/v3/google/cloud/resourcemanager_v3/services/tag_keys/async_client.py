...
class TagKeysAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TagKeysTransport, Callable[..., TagKeysTransport]]] = "grpc_asyncio",
    ...
    async def list_tag_keys(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_tag_keys]
    ...
    async def get_tag_key(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_tag_key]
    ...
    async def get_namespaced_tag_key(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_namespaced_tag_key]
    ...
    async def create_tag_key(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_tag_key]
    ...
    async def update_tag_key(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_tag_key]
    ...
    async def delete_tag_key(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_tag_key]

...
class TagKeysRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_tag_key(self, request: tag_keys.CreateTagKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_keys.CreateTagKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_tag_key_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_tag_key
    ...
    def pre_delete_tag_key(self, request: tag_keys.DeleteTagKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_keys.DeleteTagKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_tag_key_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_tag_key
    ...
    def pre_get_namespaced_tag_key(self, request: tag_keys.GetNamespacedTagKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_keys.GetNamespacedTagKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_namespaced_tag_key_with_metadata(self, response: tag_keys.TagKey, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_keys.TagKey, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_namespaced_tag_key
    ...
    def pre_get_tag_key(self, request: tag_keys.GetTagKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_keys.GetTagKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_tag_key_with_metadata(self, response: tag_keys.TagKey, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_keys.TagKey, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_tag_key
    ...
    def pre_list_tag_keys(self, request: tag_keys.ListTagKeysRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_keys.ListTagKeysRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_tag_keys_with_metadata(self, response: tag_keys.ListTagKeysResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_keys.ListTagKeysResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_tag_keys
    ...
    def pre_update_tag_key(self, request: tag_keys.UpdateTagKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_keys.UpdateTagKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_tag_key_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_tag_key
...
class TagKeysRestTransport(_BaseTagKeysRestTransport):
    ...
    class _CreateTagKey(_BaseTagKeysRestTransport._BaseCreateTagKey, TagKeysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagKeysRestTransport._CreateTagKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteTagKey(_BaseTagKeysRestTransport._BaseDeleteTagKey, TagKeysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagKeysRestTransport._DeleteTagKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseTagKeysRestTransport._BaseGetIamPolicy, TagKeysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagKeysRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetNamespacedTagKey(_BaseTagKeysRestTransport._BaseGetNamespacedTagKey, TagKeysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagKeysRestTransport._GetNamespacedTagKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BaseTagKeysRestTransport._BaseSetIamPolicy, TagKeysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagKeysRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseTagKeysRestTransport._BaseTestIamPermissions, TagKeysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagKeysRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateTagKey(_BaseTagKeysRestTransport._BaseUpdateTagKey, TagKeysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagKeysRestTransport._UpdateTagKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseTagKeysRestTransport._BaseGetOperation, TagKeysRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagKeysRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

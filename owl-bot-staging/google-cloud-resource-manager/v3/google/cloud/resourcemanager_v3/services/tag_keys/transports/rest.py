...
class TagKeysRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get_namespaced_tag_key(self, request: tag_keys.GetNamespacedTagKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_keys.GetNamespacedTagKeyRequest, Sequence[Tuple[str, str]]]:

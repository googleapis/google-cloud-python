...
class OrganizationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get_organization(self, request: organizations.GetOrganizationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[organizations.GetOrganizationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_organization_with_metadata(self, response: organizations.Organization, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[organizations.Organization, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_organization
    ...
    def pre_search_organizations(self, request: organizations.SearchOrganizationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[organizations.SearchOrganizationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search_organizations_with_metadata(self, response: organizations.SearchOrganizationsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[organizations.SearchOrganizationsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_organizations
...
class OrganizationsRestTransport(_BaseOrganizationsRestTransport):
    ...
    class _GetIamPolicy(_BaseOrganizationsRestTransport._BaseGetIamPolicy, OrganizationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OrganizationsRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOrganization(_BaseOrganizationsRestTransport._BaseGetOrganization, OrganizationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OrganizationsRestTransport._GetOrganization._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SearchOrganizations(_BaseOrganizationsRestTransport._BaseSearchOrganizations, OrganizationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OrganizationsRestTransport._SearchOrganizations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BaseOrganizationsRestTransport._BaseSetIamPolicy, OrganizationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OrganizationsRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseOrganizationsRestTransport._BaseTestIamPermissions, OrganizationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OrganizationsRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseOrganizationsRestTransport._BaseGetOperation, OrganizationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OrganizationsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

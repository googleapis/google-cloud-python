...
class TagValuesGrpcAsyncIOTransport(TagValuesTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_tag_values: gapic_v1.method_async.wrap_method(
            ...
            self.get_tag_value: gapic_v1.method_async.wrap_method(
                self.get_tag_value,
                default_retry=retries.AsyncRetry(
                    initial=0.1,
                    maximum=60.0,
            ...
            self.get_namespaced_tag_value: gapic_v1.method_async.wrap_method(
                self.get_namespaced_tag_value,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_tag_value: gapic_v1.method_async.wrap_method(
                self.create_tag_value,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_tag_value: gapic_v1.method_async.wrap_method(
                self.update_tag_value,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_tag_value: gapic_v1.method_async.wrap_method(

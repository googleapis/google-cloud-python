...
class TagBindingsGrpcAsyncIOTransport(TagBindingsTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_tag_bindings: gapic_v1.method_async.wrap_method(
            ...
            self.create_tag_binding: gapic_v1.method_async.wrap_method(
                self.create_tag_binding,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_tag_binding: gapic_v1.method_async.wrap_method(
                self.delete_tag_binding,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_effective_tags: gapic_v1.method_async.wrap_method(

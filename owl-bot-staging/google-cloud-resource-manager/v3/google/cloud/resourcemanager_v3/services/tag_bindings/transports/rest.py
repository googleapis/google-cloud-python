...
class TagBindingsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_tag_binding(self, request: tag_bindings.CreateTagBindingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_bindings.CreateTagBindingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_tag_binding_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_tag_binding
    ...
    def pre_delete_tag_binding(self, request: tag_bindings.DeleteTagBindingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_bindings.DeleteTagBindingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_tag_binding_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_tag_binding
    ...
    def pre_list_effective_tags(self, request: tag_bindings.ListEffectiveTagsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_bindings.ListEffectiveTagsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_effective_tags_with_metadata(self, response: tag_bindings.ListEffectiveTagsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_bindings.ListEffectiveTagsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_effective_tags
    ...
    def pre_list_tag_bindings(self, request: tag_bindings.ListTagBindingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_bindings.ListTagBindingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_tag_bindings_with_metadata(self, response: tag_bindings.ListTagBindingsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tag_bindings.ListTagBindingsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_tag_bindings
...
class TagBindingsRestTransport(_BaseTagBindingsRestTransport):
    ...
    class _CreateTagBinding(_BaseTagBindingsRestTransport._BaseCreateTagBinding, TagBindingsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagBindingsRestTransport._CreateTagBinding._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteTagBinding(_BaseTagBindingsRestTransport._BaseDeleteTagBinding, TagBindingsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagBindingsRestTransport._DeleteTagBinding._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListEffectiveTags(_BaseTagBindingsRestTransport._BaseListEffectiveTags, TagBindingsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagBindingsRestTransport._ListEffectiveTags._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListTagBindings(_BaseTagBindingsRestTransport._BaseListTagBindings, TagBindingsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagBindingsRestTransport._ListTagBindings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    @property
    def list_effective_tags(self) -> Callable[
    ...
    class _GetOperation(_BaseTagBindingsRestTransport._BaseGetOperation, TagBindingsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TagBindingsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class TagBindingsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_tag_binding(self, request: tag_bindings.CreateTagBindingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_bindings.CreateTagBindingRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_tag_binding(self, request: tag_bindings.DeleteTagBindingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_bindings.DeleteTagBindingRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_effective_tags(self, request: tag_bindings.ListEffectiveTagsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_bindings.ListEffectiveTagsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_tag_bindings(self, request: tag_bindings.ListTagBindingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_bindings.ListTagBindingsRequest, Sequence[Tuple[str, str]]]:

...
class CloudSchedulerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_job(self, request: cloudscheduler.CreateJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudscheduler.CreateJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_job_with_metadata(self, response: gcs_job.Job, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcs_job.Job, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_job
    ...
    def pre_delete_job(self, request: cloudscheduler.DeleteJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudscheduler.DeleteJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_job(self, request: cloudscheduler.GetJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudscheduler.GetJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_jobs(self, request: cloudscheduler.ListJobsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudscheduler.ListJobsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_jobs_with_metadata(self, response: cloudscheduler.ListJobsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudscheduler.ListJobsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_jobs
    ...
    def pre_pause_job(self, request: cloudscheduler.PauseJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudscheduler.PauseJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_pause_job_with_metadata(self, response: job.Job, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[job.Job, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for pause_job
    ...
    def pre_resume_job(self, request: cloudscheduler.ResumeJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudscheduler.ResumeJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_resume_job_with_metadata(self, response: job.Job, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[job.Job, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for resume_job
    ...
    def pre_run_job(self, request: cloudscheduler.RunJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudscheduler.RunJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_run_job_with_metadata(self, response: job.Job, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[job.Job, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for run_job
    ...
    def pre_update_job(self, request: cloudscheduler.UpdateJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudscheduler.UpdateJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_job_with_metadata(self, response: gcs_job.Job, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcs_job.Job, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_job
...
class CloudSchedulerRestTransport(_BaseCloudSchedulerRestTransport):
    ...
    class _CreateJob(_BaseCloudSchedulerRestTransport._BaseCreateJob, CloudSchedulerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudSchedulerRestTransport._CreateJob._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteJob(_BaseCloudSchedulerRestTransport._BaseDeleteJob, CloudSchedulerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudSchedulerRestTransport._DeleteJob._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetJob(_BaseCloudSchedulerRestTransport._BaseGetJob, CloudSchedulerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudSchedulerRestTransport._GetJob._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListJobs(_BaseCloudSchedulerRestTransport._BaseListJobs, CloudSchedulerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudSchedulerRestTransport._ListJobs._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _PauseJob(_BaseCloudSchedulerRestTransport._BasePauseJob, CloudSchedulerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudSchedulerRestTransport._PauseJob._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ResumeJob(_BaseCloudSchedulerRestTransport._BaseResumeJob, CloudSchedulerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudSchedulerRestTransport._ResumeJob._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _RunJob(_BaseCloudSchedulerRestTransport._BaseRunJob, CloudSchedulerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudSchedulerRestTransport._RunJob._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateJob(_BaseCloudSchedulerRestTransport._BaseUpdateJob, CloudSchedulerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudSchedulerRestTransport._UpdateJob._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetLocation(_BaseCloudSchedulerRestTransport._BaseGetLocation, CloudSchedulerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudSchedulerRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseCloudSchedulerRestTransport._BaseListLocations, CloudSchedulerRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CloudSchedulerRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

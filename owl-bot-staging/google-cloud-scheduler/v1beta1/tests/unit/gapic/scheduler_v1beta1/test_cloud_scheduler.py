...
def test__get_api_endpoint():
    ...
    assert CloudSchedulerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CloudSchedulerClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert CloudSchedulerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CloudSchedulerClient.DEFAULT_MTLS_ENDPOINT
...
def test_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudSchedulerRestInterceptor, "post_list_jobs_with_metadata") as post_with_metadata, \
...
def test_get_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudSchedulerRestInterceptor, "post_get_job_with_metadata") as post_with_metadata, \
...
def test_create_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudSchedulerRestInterceptor, "post_create_job_with_metadata") as post_with_metadata, \
...
def test_update_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudSchedulerRestInterceptor, "post_update_job_with_metadata") as post_with_metadata, \
...
def test_pause_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudSchedulerRestInterceptor, "post_pause_job_with_metadata") as post_with_metadata, \
...
def test_resume_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudSchedulerRestInterceptor, "post_resume_job_with_metadata") as post_with_metadata, \
...
def test_run_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudSchedulerRestInterceptor, "post_run_job_with_metadata") as post_with_metadata, \

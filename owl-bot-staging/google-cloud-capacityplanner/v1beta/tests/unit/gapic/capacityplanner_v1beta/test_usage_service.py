...
from google.cloud.capacityplanner_v1beta.services.usage_service import UsageServiceAsyncClient
from google.cloud.capacityplanner_v1beta.services.usage_service import UsageServiceClient
from google.cloud.capacityplanner_v1beta.services.usage_service import transports
...
@pytest.mark.parametrize("client_class", [
    UsageServiceClient, UsageServiceAsyncClient
])
...
def test_query_usage_histories(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.query_usage_histories),
            '__call__') as call:
...
def test_query_forecasts(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.query_forecasts),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_query_reservations(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.query_reservations),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_export_usage_histories(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_usage_histories),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_export_forecasts(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_forecasts),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_export_reservations_usage(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_reservations_usage),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_query_usage_histories_rest_required_fields(request_type=usage_service.QueryUsageHistoriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_usage_histories._get_unset_required_fields(jsonified_request)
...
def test_query_reservations_rest_required_fields(request_type=usage_service.QueryReservationsRequest):
    ...
    assert not set(unset_fields) - set(("aggregation_method", "cloud_resource_type", "end_date", "gpu_type", "include_unapproved_reservations", "location_level", "machine_family", "machine_shape", "ownership_type", "reservation_data_level", "reservation_type", "share_type", "start_date", ))
    jsonified_request.update(unset_fields)
...
def test_query_reservations_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("aggregationMethod", "cloudResourceType", "endDate", "gpuType", "includeUnapprovedReservations", "locationLevel", "machineFamily", "machineShape", "ownershipType", "reservationDataLevel", "reservationType", "shareType", "startDate", )) & set(("parent", )))
...
def test_export_usage_histories_rest_required_fields(request_type=usage_service.ExportUsageHistoriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_usage_histories._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_usage_histories_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "resourceType", "outputConfig", )))
...
def test_export_reservations_usage_rest_required_fields(request_type=usage_service.ExportReservationsUsageRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_reservations_usage._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_reservations_usage_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "cloudResourceType", "usageAggregationMethod", "outputConfig", )))
...
def test_query_usage_histories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_query_usage_histories") as post, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_query_usage_histories_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "pre_query_usage_histories") as pre:
        ...
        client.query_usage_histories(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_query_forecasts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_query_forecasts") as post, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_query_forecasts_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "pre_query_forecasts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.query_forecasts(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_query_reservations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_query_reservations") as post, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_query_reservations_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "pre_query_reservations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.query_reservations(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_usage_histories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_export_usage_histories") as post, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_export_usage_histories_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "pre_export_usage_histories") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.export_usage_histories(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_forecasts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_export_forecasts") as post, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_export_forecasts_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "pre_export_forecasts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.export_forecasts(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_reservations_usage_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_export_reservations_usage") as post, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "post_export_reservations_usage_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.UsageServiceRestInterceptor, "pre_export_reservations_usage") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.export_reservations_usage(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_usage_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.capacityplanner_v1beta.services.usage_service.transports.UsageServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_usage_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.capacityplanner_v1beta.services.usage_service.transports.UsageServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.UsageServiceTransport()
        adc.assert_called_once()
...
def test_usage_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.UsageServiceGrpcTransport, transports.UsageServiceGrpcAsyncIOTransport])
def test_usage_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.UsageServiceGrpcTransport, transports.UsageServiceGrpcAsyncIOTransport])
def test_usage_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_forecast_path():
    ...
    location = "clam"
    forecast = "whelk"
    expected = "projects/{project}/locations/{location}/forecasts/{forecast}".format(project=project, location=location, forecast=forecast, )

...
class UsageServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_export_forecasts(self, request: usage_service.ExportForecastsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[usage_service.ExportForecastsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_export_forecasts_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_forecasts
    ...
    def pre_export_reservations_usage(self, request: usage_service.ExportReservationsUsageRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[usage_service.ExportReservationsUsageRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_export_reservations_usage_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_reservations_usage
    ...
    def pre_export_usage_histories(self, request: usage_service.ExportUsageHistoriesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[usage_service.ExportUsageHistoriesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_export_usage_histories_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_usage_histories
    ...
    def pre_query_forecasts(self, request: usage_service.QueryForecastsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[usage_service.QueryForecastsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_query_forecasts_with_metadata(self, response: usage_service.QueryForecastsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[usage_service.QueryForecastsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for query_forecasts
    ...
    def pre_query_reservations(self, request: usage_service.QueryReservationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[usage_service.QueryReservationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_query_reservations_with_metadata(self, response: usage_service.QueryReservationsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[usage_service.QueryReservationsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for query_reservations
    ...
    def pre_query_usage_histories(self, request: usage_service.QueryUsageHistoriesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[usage_service.QueryUsageHistoriesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_query_usage_histories_with_metadata(self, response: usage_service.QueryUsageHistoriesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[usage_service.QueryUsageHistoriesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for query_usage_histories
...
class UsageServiceRestTransport(_BaseUsageServiceRestTransport):
    ...
    class _ExportForecasts(_BaseUsageServiceRestTransport._BaseExportForecasts, UsageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UsageServiceRestTransport._ExportForecasts._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ExportReservationsUsage(_BaseUsageServiceRestTransport._BaseExportReservationsUsage, UsageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UsageServiceRestTransport._ExportReservationsUsage._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ExportUsageHistories(_BaseUsageServiceRestTransport._BaseExportUsageHistories, UsageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UsageServiceRestTransport._ExportUsageHistories._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _QueryForecasts(_BaseUsageServiceRestTransport._BaseQueryForecasts, UsageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UsageServiceRestTransport._QueryForecasts._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _QueryReservations(_BaseUsageServiceRestTransport._BaseQueryReservations, UsageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UsageServiceRestTransport._QueryReservations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _QueryUsageHistories(_BaseUsageServiceRestTransport._BaseQueryUsageHistories, UsageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UsageServiceRestTransport._QueryUsageHistories._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

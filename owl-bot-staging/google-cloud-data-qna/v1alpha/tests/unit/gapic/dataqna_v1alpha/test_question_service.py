...
def test__get_api_endpoint():
    ...
    assert QuestionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == QuestionServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert QuestionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == QuestionServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_get_question_rest_required_fields(request_type=question_service.GetQuestionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_question._get_unset_required_fields(jsonified_request)
...
def test_get_question_rest_unset_required_fields():
    transport = transports.QuestionServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_question_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.QuestionServiceRestInterceptor, "post_get_question") as post, \
         mock.patch.object(transports.QuestionServiceRestInterceptor, "pre_get_question") as pre:
...
def test_create_question_rest_required_fields(request_type=question_service.CreateQuestionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_question._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_question_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.QuestionServiceRestInterceptor, "post_create_question") as post, \
         mock.patch.object(transports.QuestionServiceRestInterceptor, "pre_create_question") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_execute_question_rest_required_fields(request_type=question_service.ExecuteQuestionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).execute_question._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_execute_question_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.QuestionServiceRestInterceptor, "post_execute_question") as post, \
         mock.patch.object(transports.QuestionServiceRestInterceptor, "pre_execute_question") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_user_feedback_rest_required_fields(request_type=question_service.GetUserFeedbackRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_user_feedback._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_user_feedback_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.QuestionServiceRestInterceptor, "post_get_user_feedback") as post, \
         mock.patch.object(transports.QuestionServiceRestInterceptor, "pre_get_user_feedback") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_user_feedback_rest_required_fields(request_type=question_service.UpdateUserFeedbackRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_user_feedback._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_user_feedback_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.QuestionServiceRestInterceptor, "post_update_user_feedback") as post, \
         mock.patch.object(transports.QuestionServiceRestInterceptor, "pre_update_user_feedback") as pre:
        pre.assert_not_called()
        post.assert_not_called()

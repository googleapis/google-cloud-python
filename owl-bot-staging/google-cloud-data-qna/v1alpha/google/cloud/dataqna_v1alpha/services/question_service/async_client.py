...
class QuestionServiceAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, QuestionServiceTransport, Callable[..., QuestionServiceTransport]]] = "grpc_asyncio",
    ...
    async def get_question(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_question]
    ...
    async def create_question(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_question]
    ...
    async def execute_question(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.execute_question]
    ...
    async def get_user_feedback(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_user_feedback]
    ...
    async def update_user_feedback(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_user_feedback]

...
class QuestionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_question(self, request: question_service.CreateQuestionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[question_service.CreateQuestionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_question_with_metadata(self, response: gcd_question.Question, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_question.Question, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_question
    ...
    def pre_execute_question(self, request: question_service.ExecuteQuestionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[question_service.ExecuteQuestionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_execute_question_with_metadata(self, response: question.Question, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[question.Question, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for execute_question
    ...
    def pre_get_question(self, request: question_service.GetQuestionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[question_service.GetQuestionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_question_with_metadata(self, response: question.Question, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[question.Question, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_question
    ...
    def pre_get_user_feedback(self, request: question_service.GetUserFeedbackRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[question_service.GetUserFeedbackRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_user_feedback_with_metadata(self, response: user_feedback.UserFeedback, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user_feedback.UserFeedback, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_user_feedback
    ...
    def pre_update_user_feedback(self, request: question_service.UpdateUserFeedbackRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[question_service.UpdateUserFeedbackRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_user_feedback_with_metadata(self, response: gcd_user_feedback.UserFeedback, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcd_user_feedback.UserFeedback, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_user_feedback
...
class QuestionServiceRestTransport(_BaseQuestionServiceRestTransport):
    ...
    class _CreateQuestion(_BaseQuestionServiceRestTransport._BaseCreateQuestion, QuestionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = QuestionServiceRestTransport._CreateQuestion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ExecuteQuestion(_BaseQuestionServiceRestTransport._BaseExecuteQuestion, QuestionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = QuestionServiceRestTransport._ExecuteQuestion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetQuestion(_BaseQuestionServiceRestTransport._BaseGetQuestion, QuestionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = QuestionServiceRestTransport._GetQuestion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetUserFeedback(_BaseQuestionServiceRestTransport._BaseGetUserFeedback, QuestionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = QuestionServiceRestTransport._GetUserFeedback._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateUserFeedback(_BaseQuestionServiceRestTransport._BaseUpdateUserFeedback, QuestionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = QuestionServiceRestTransport._UpdateUserFeedback._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class AutoSuggestionServiceRestInterceptor:
    """Interceptor for AutoSuggestionService.
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_suggest_queries(self, request: auto_suggestion_service.SuggestQueriesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[auto_suggestion_service.SuggestQueriesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for suggest_queries

        Override in a subclass to manipulate the request or metadata
        before they are sent to the AutoSuggestionService server.
        """
        return request, metadata
    ...
    def post_suggest_queries(self, response: auto_suggestion_service.SuggestQueriesResponse) -> auto_suggestion_service.SuggestQueriesResponse:
        ...
        after it is returned by the AutoSuggestionService server but before
        it is returned to user code. This `post_suggest_queries` interceptor runs
        before the `post_suggest_queries_with_metadata` interceptor.
        """
        return response

    def post_suggest_queries_with_metadata(self, response: auto_suggestion_service.SuggestQueriesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[auto_suggestion_service.SuggestQueriesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for suggest_queries

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the AutoSuggestionService server but before it is returned to user code.

        We recommend only using this `post_suggest_queries_with_metadata`
        interceptor in new development instead of the `post_suggest_queries` interceptor.
        When both interceptors are used, this `post_suggest_queries_with_metadata` interceptor runs after the
        `post_suggest_queries` interceptor. The (possibly modified) response returned by
        `post_suggest_queries` will be passed to
        `post_suggest_queries_with_metadata`.
        """
        return response, metadata


@dataclasses.dataclass
class AutoSuggestionServiceRestStub:
...
class AutoSuggestionServiceRestTransport(_BaseAutoSuggestionServiceRestTransport):
    ...
    class _SuggestQueries(_BaseAutoSuggestionServiceRestTransport._BaseSuggestQueries, AutoSuggestionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AutoSuggestionServiceRestTransport._SuggestQueries._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            # Return the response
            resp = auto_suggestion_service.SuggestQueriesResponse()

...
class AutoSuggestionServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = AutoSuggestionServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AutoSuggestionServiceTransport, Callable[..., AutoSuggestionServiceTransport]]] = "grpc_asyncio",
    ...
    async def suggest_queries(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.suggest_queries]

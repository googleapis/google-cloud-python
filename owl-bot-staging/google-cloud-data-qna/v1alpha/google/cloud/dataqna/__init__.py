...
from google.cloud.dataqna_v1alpha.types.auto_suggestion_service import SuggestQueriesRequest
from google.cloud.dataqna_v1alpha.types.auto_suggestion_service import SuggestQueriesResponse

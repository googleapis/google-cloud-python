...
class PrivilegedAccessManagerAsyncClient:
    ...
    get_transport_class = functools.partial(type(PrivilegedAccessManagerClient).get_transport_class, type(PrivilegedAccessManagerClient))
    ...
    async def search_entitlements(self,
    ...
    async def delete_entitlement(self,
    ...
    async def update_entitlement(self,

...
class PrivilegedAccessManagerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_approve_grant(self, request: privilegedaccessmanager.ApproveGrantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.ApproveGrantRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_check_onboarding_status(self, request: privilegedaccessmanager.CheckOnboardingStatusRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.CheckOnboardingStatusRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_entitlement(self, request: privilegedaccessmanager.CreateEntitlementRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.CreateEntitlementRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_grant(self, request: privilegedaccessmanager.CreateGrantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.CreateGrantRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_entitlement(self, request: privilegedaccessmanager.DeleteEntitlementRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.DeleteEntitlementRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_deny_grant(self, request: privilegedaccessmanager.DenyGrantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.DenyGrantRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_entitlement(self, request: privilegedaccessmanager.GetEntitlementRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.GetEntitlementRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_grant(self, request: privilegedaccessmanager.GetGrantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.GetGrantRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_entitlements(self, request: privilegedaccessmanager.ListEntitlementsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.ListEntitlementsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_grants(self, request: privilegedaccessmanager.ListGrantsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.ListGrantsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_revoke_grant(self, request: privilegedaccessmanager.RevokeGrantRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.RevokeGrantRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_search_entitlements(self, request: privilegedaccessmanager.SearchEntitlementsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.SearchEntitlementsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_search_grants(self, request: privilegedaccessmanager.SearchGrantsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.SearchGrantsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_entitlement(self, request: privilegedaccessmanager.UpdateEntitlementRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[privilegedaccessmanager.UpdateEntitlementRequest, Sequence[Tuple[str, str]]]:

...
class PrivilegedAccessManagerGrpcTransport(PrivilegedAccessManagerTransport):
    ...
    @property
    def check_onboarding_status(self) -> Callable[
    ...
    @property
    def search_entitlements(self) -> Callable[
    ...
    @property
    def delete_entitlement(self) -> Callable[
    ...
    @property
    def update_entitlement(self) -> Callable[
    ...
    @property
    def search_grants(self) -> Callable[
    ...
    @property
    def create_grant(self) -> Callable[
    ...
    @property
    def approve_grant(self) -> Callable[
    ...
    @property
    def revoke_grant(self) -> Callable[

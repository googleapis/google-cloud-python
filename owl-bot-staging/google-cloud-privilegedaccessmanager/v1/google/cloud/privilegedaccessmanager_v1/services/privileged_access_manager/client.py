...
from .transports.rest import PrivilegedAccessManagerRestTransport


class PrivilegedAccessManagerClientMeta(type):
    """Metaclass for the PrivilegedAccessManager client.
...
class PrivilegedAccessManagerClient(metaclass=PrivilegedAccessManagerClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            PrivilegedAccessManagerClient: The constructed client.
        """
    ...
    def transport(self) -> PrivilegedAccessManagerTransport:
        ...
        Returns:
            PrivilegedAccessManagerTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def entitlement_path(project: str,location: str,entitlement: str,) -> str:
        """Returns a fully-qualified entitlement string."""
        return "projects/{project}/locations/{location}/entitlements/{entitlement}".format(project=project, location=location, entitlement=entitlement, )
    ...
    @staticmethod
    def grant_path(project: str,location: str,entitlement: str,grant: str,) -> str:
        """Returns a fully-qualified grant string."""
        return "projects/{project}/locations/{location}/entitlements/{entitlement}/grants/{grant}".format(project=project, location=location, entitlement=entitlement, grant=grant, )

    @staticmethod
    def parse_grant_path(path: str) -> Dict[str,str]:
        """Parses a grant path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/entitlements/(?P<entitlement>.+?)/grants/(?P<grant>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = PrivilegedAccessManagerClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = PrivilegedAccessManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = PrivilegedAccessManagerClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            PrivilegedAccessManagerClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PrivilegedAccessManagerTransport, Callable[..., PrivilegedAccessManagerTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PrivilegedAccessManagerClient._read_environment_variables()
        self._client_cert_source = PrivilegedAccessManagerClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = PrivilegedAccessManagerClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, PrivilegedAccessManagerTransport)
        if transport_provided:
            # transport is a PrivilegedAccessManagerTransport instance.
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[PrivilegedAccessManagerTransport], Callable[..., PrivilegedAccessManagerTransport]] = (
    ...
    def check_onboarding_status(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.CheckOnboardingStatusRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.check_onboarding_status]
    ...
    def list_entitlements(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.ListEntitlementsRequest, dict]):
    ...
    def search_entitlements(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.SearchEntitlementsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_entitlements]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.SearchEntitlementsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def get_entitlement(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.GetEntitlementRequest, dict]):
    ...
    def create_entitlement(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.CreateEntitlementRequest, dict]):
    ...
    def delete_entitlement(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.DeleteEntitlementRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_entitlement]
    ...
    def update_entitlement(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.UpdateEntitlementRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_entitlement]
    ...
    def list_grants(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.ListGrantsRequest, dict]):
                The request object. Message for requesting list of
                grants.
            parent (str):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_grants]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListGrantsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def search_grants(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.SearchGrantsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_grants]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.SearchGrantsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def get_grant(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.GetGrantRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_grant]
    ...
    def create_grant(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.CreateGrantRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_grant]
    ...
    def approve_grant(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.ApproveGrantRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.approve_grant]
    ...
    def deny_grant(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.DenyGrantRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.deny_grant]
    ...
    def revoke_grant(self,
        ...
        Args:
            request (Union[google.cloud.privilegedaccessmanager_v1.types.RevokeGrantRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.revoke_grant]
    ...
    def __enter__(self) -> "PrivilegedAccessManagerClient":
        return self

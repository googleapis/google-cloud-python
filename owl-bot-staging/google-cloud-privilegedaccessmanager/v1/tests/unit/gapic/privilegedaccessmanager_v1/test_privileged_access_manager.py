...
from google.cloud.privilegedaccessmanager_v1.services.privileged_access_manager import PrivilegedAccessManagerAsyncClient
from google.cloud.privilegedaccessmanager_v1.services.privileged_access_manager import PrivilegedAccessManagerClient
from google.cloud.privilegedaccessmanager_v1.services.privileged_access_manager import pagers
from google.cloud.privilegedaccessmanager_v1.services.privileged_access_manager import transports
...
@mock.patch.object(PrivilegedAccessManagerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PrivilegedAccessManagerAsyncClient))
def test__get_api_endpoint():
    ...
    assert PrivilegedAccessManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == PrivilegedAccessManagerClient.DEFAULT_MTLS_ENDPOINT
    assert PrivilegedAccessManagerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert PrivilegedAccessManagerClient._get_api_endpoint(None, None, default_universe, "always") == PrivilegedAccessManagerClient.DEFAULT_MTLS_ENDPOINT
    assert PrivilegedAccessManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == PrivilegedAccessManagerClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    PrivilegedAccessManagerClient, PrivilegedAccessManagerAsyncClient
])
...
def test_privileged_access_manager_client_client_options_from_dict():
    with mock.patch('google.cloud.privilegedaccessmanager_v1.services.privileged_access_manager.transports.PrivilegedAccessManagerGrpcTransport.__init__') as grpc_transport:
...
def test_check_onboarding_status(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.check_onboarding_status),
            '__call__') as call:
...
async def test_check_onboarding_status_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.check_onboarding_status] = mock_object
...
def test_list_entitlements_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, privilegedaccessmanager.Entitlement)
                   for i in results)
...
async def test_search_entitlements_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.search_entitlements] = mock_object
...
async def test_search_entitlements_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.search_entitlements(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_delete_entitlement(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_entitlement),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
async def test_delete_entitlement_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_entitlement] = mock_object
...
def test_update_entitlement(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_entitlement),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
async def test_update_entitlement_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_entitlement] = mock_object
...
def test_list_grants(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_grants),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_list_grants_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_grants] = mock_object
...
def test_list_grants_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, privilegedaccessmanager.Grant)
                   for i in results)
...
async def test_list_grants_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_grants(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_search_grants(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_grants),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_search_grants_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.search_grants] = mock_object
...
async def test_search_grants_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.search_grants(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_grant(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_grant),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_get_grant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_grant] = mock_object
...
def test_create_grant(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_grant),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = privilegedaccessmanager.Grant(
            name='name_value',
...
async def test_create_grant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_grant] = mock_object
...
def test_approve_grant(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.approve_grant),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = privilegedaccessmanager.Grant(
            name='name_value',
...
async def test_approve_grant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.approve_grant] = mock_object
...
def test_deny_grant(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.deny_grant),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = privilegedaccessmanager.Grant(
            name='name_value',
...
async def test_deny_grant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.deny_grant] = mock_object
...
def test_revoke_grant(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.revoke_grant),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
async def test_revoke_grant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.revoke_grant] = mock_object
...
def test_check_onboarding_status_rest_required_fields(request_type=privilegedaccessmanager.CheckOnboardingStatusRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).check_onboarding_status._get_unset_required_fields(jsonified_request)
...
def test_check_onboarding_status_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_check_onboarding_status") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_check_onboarding_status") as pre:
        ...
        req.return_value._content = privilegedaccessmanager.CheckOnboardingStatusResponse.to_json(privilegedaccessmanager.CheckOnboardingStatusResponse())
        ...
        client.check_onboarding_status(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_check_onboarding_status_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.CheckOnboardingStatusRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_entitlements_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_list_entitlements") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_list_entitlements") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = privilegedaccessmanager.ListEntitlementsResponse.to_json(privilegedaccessmanager.ListEntitlementsResponse())
        ...
        client.list_entitlements(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_entitlements_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.ListEntitlementsRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_entitlements_rest_required_fields(request_type=privilegedaccessmanager.SearchEntitlementsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_entitlements._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_entitlements._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("caller_access_type", "filter", "page_size", "page_token", ))
    jsonified_request.update(unset_fields)
...
def test_search_entitlements_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("callerAccessType", "filter", "pageSize", "pageToken", )) & set(("parent", "callerAccessType", )))
...
def test_search_entitlements_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_search_entitlements") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_search_entitlements") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = privilegedaccessmanager.SearchEntitlementsResponse.to_json(privilegedaccessmanager.SearchEntitlementsResponse())
        ...
        client.search_entitlements(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_search_entitlements_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.SearchEntitlementsRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_entitlement_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_get_entitlement") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_get_entitlement") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = privilegedaccessmanager.Entitlement.to_json(privilegedaccessmanager.Entitlement())
        ...
        client.get_entitlement(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_entitlement_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.GetEntitlementRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_entitlement_rest_required_fields(request_type=privilegedaccessmanager.CreateEntitlementRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_entitlement._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("entitlement_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_entitlement_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("entitlementId", "requestId", )) & set(("parent", "entitlementId", "entitlement", )))
...
def test_create_entitlement_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_create_entitlement") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_create_entitlement") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_entitlement(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_entitlement_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.CreateEntitlementRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_entitlement_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_delete_entitlement") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_delete_entitlement") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_entitlement(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_entitlement_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.DeleteEntitlementRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_entitlement_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("entitlement", "updateMask", )))
...
def test_update_entitlement_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_update_entitlement") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_update_entitlement") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_entitlement(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_entitlement_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.UpdateEntitlementRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_grants_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_list_grants") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_list_grants") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = privilegedaccessmanager.ListGrantsResponse.to_json(privilegedaccessmanager.ListGrantsResponse())
        ...
        client.list_grants(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_grants_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.ListGrantsRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_grants_rest_required_fields(request_type=privilegedaccessmanager.SearchGrantsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_grants._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("caller_relationship", "filter", "page_size", "page_token", ))
    jsonified_request.update(unset_fields)
...
def test_search_grants_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("callerRelationship", "filter", "pageSize", "pageToken", )) & set(("parent", "callerRelationship", )))
...
def test_search_grants_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_search_grants") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_search_grants") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = privilegedaccessmanager.SearchGrantsResponse.to_json(privilegedaccessmanager.SearchGrantsResponse())
        ...
        client.search_grants(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_search_grants_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.SearchGrantsRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_grant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_get_grant") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_get_grant") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = privilegedaccessmanager.Grant.to_json(privilegedaccessmanager.Grant())
        ...
        client.get_grant(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_grant_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.GetGrantRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_grant_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("parent", "grant", )))
...
def test_create_grant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_create_grant") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_create_grant") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_grant(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_grant_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.CreateGrantRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_approve_grant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_approve_grant") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_approve_grant") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.approve_grant(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_approve_grant_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.ApproveGrantRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_deny_grant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_deny_grant") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_deny_grant") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.deny_grant(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_deny_grant_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.DenyGrantRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_revoke_grant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_revoke_grant") as post, \
         mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "pre_revoke_grant") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.revoke_grant(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_revoke_grant_rest_bad_request(transport: str = 'rest', request_type=privilegedaccessmanager.RevokeGrantRequest):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_privileged_access_manager_base_transport():
    ...
    with mock.patch('google.cloud.privilegedaccessmanager_v1.services.privileged_access_manager.transports.PrivilegedAccessManagerTransport.__init__') as Transport:
...
def test_privileged_access_manager_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.privilegedaccessmanager_v1.services.privileged_access_manager.transports.PrivilegedAccessManagerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_privileged_access_manager_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.privilegedaccessmanager_v1.services.privileged_access_manager.transports.PrivilegedAccessManagerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PrivilegedAccessManagerTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.PrivilegedAccessManagerGrpcTransport, transports.PrivilegedAccessManagerGrpcAsyncIOTransport])
def test_privileged_access_manager_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_entitlement_path():
    ...
    location = "clam"
    entitlement = "whelk"
    expected = "projects/{project}/locations/{location}/entitlements/{entitlement}".format(project=project, location=location, entitlement=entitlement, )
...
def test_grant_path():
    ...
    entitlement = "winkle"
    grant = "nautilus"
    expected = "projects/{project}/locations/{location}/entitlements/{entitlement}/grants/{grant}".format(project=project, location=location, entitlement=entitlement, grant=grant, )

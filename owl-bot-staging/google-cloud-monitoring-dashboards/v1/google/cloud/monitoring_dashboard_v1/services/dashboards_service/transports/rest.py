...
class DashboardsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_dashboard(self, request: dashboards_service.CreateDashboardRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[dashboards_service.CreateDashboardRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_dashboard_with_metadata(self, response: gmd_dashboard.Dashboard, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gmd_dashboard.Dashboard, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_dashboard
    ...
    def pre_delete_dashboard(self, request: dashboards_service.DeleteDashboardRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[dashboards_service.DeleteDashboardRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_dashboard(self, request: dashboards_service.GetDashboardRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[dashboards_service.GetDashboardRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_dashboard_with_metadata(self, response: dashboard.Dashboard, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[dashboard.Dashboard, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_dashboard
    ...
    def pre_list_dashboards(self, request: dashboards_service.ListDashboardsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[dashboards_service.ListDashboardsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_dashboards_with_metadata(self, response: dashboards_service.ListDashboardsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[dashboards_service.ListDashboardsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_dashboards
    ...
    def pre_update_dashboard(self, request: dashboards_service.UpdateDashboardRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[dashboards_service.UpdateDashboardRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_dashboard_with_metadata(self, response: dashboard.Dashboard, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[dashboard.Dashboard, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_dashboard
...
class DashboardsServiceRestTransport(_BaseDashboardsServiceRestTransport):
    ...
    class _CreateDashboard(_BaseDashboardsServiceRestTransport._BaseCreateDashboard, DashboardsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DashboardsServiceRestTransport._CreateDashboard._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteDashboard(_BaseDashboardsServiceRestTransport._BaseDeleteDashboard, DashboardsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DashboardsServiceRestTransport._DeleteDashboard._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetDashboard(_BaseDashboardsServiceRestTransport._BaseGetDashboard, DashboardsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DashboardsServiceRestTransport._GetDashboard._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListDashboards(_BaseDashboardsServiceRestTransport._BaseListDashboards, DashboardsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DashboardsServiceRestTransport._ListDashboards._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateDashboard(_BaseDashboardsServiceRestTransport._BaseUpdateDashboard, DashboardsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DashboardsServiceRestTransport._UpdateDashboard._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
from google.cloud.monitoring_dashboard_v1.types import error_reporting_panel
from google.cloud.monitoring_dashboard_v1.types import incident_list
...
from google.cloud.monitoring_dashboard_v1.types import section_header
from google.cloud.monitoring_dashboard_v1.types import single_view_group
...
def test__get_api_endpoint():
    ...
    assert DashboardsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DashboardsServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert DashboardsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DashboardsServiceClient.DEFAULT_MTLS_ENDPOINT
...
async def test_create_dashboard_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_dashboard] = mock_object
...
async def test_list_dashboards_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_dashboards] = mock_object
...
async def test_get_dashboard_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_dashboard] = mock_object
...
async def test_delete_dashboard_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_dashboard] = mock_object
...
async def test_update_dashboard_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_dashboard] = mock_object
...
def test_create_dashboard_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = gmd_dashboard.Dashboard.to_json(gmd_dashboard.Dashboard())

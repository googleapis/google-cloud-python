...
def test_create_dashboard_rest_required_fields(request_type=dashboards_service.CreateDashboardRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_dashboard._get_unset_required_fields(jsonified_request)
...
def test_create_dashboard_rest_unset_required_fields():
    transport = transports.DashboardsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_dashboards_rest_required_fields(request_type=dashboards_service.ListDashboardsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_dashboards._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_dashboard_rest_required_fields(request_type=dashboards_service.GetDashboardRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_dashboard._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_dashboard_rest_required_fields(request_type=dashboards_service.DeleteDashboardRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_dashboard._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_dashboard_rest_required_fields(request_type=dashboards_service.UpdateDashboardRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_dashboard._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

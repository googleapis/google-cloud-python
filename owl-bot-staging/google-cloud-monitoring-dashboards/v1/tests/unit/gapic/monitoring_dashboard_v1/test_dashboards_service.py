...
def test_create_dashboard_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DashboardsServiceRestInterceptor, "post_create_dashboard_with_metadata") as post_with_metadata, \
...
def test_list_dashboards_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DashboardsServiceRestInterceptor, "post_list_dashboards_with_metadata") as post_with_metadata, \
...
def test_get_dashboard_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DashboardsServiceRestInterceptor, "post_get_dashboard_with_metadata") as post_with_metadata, \
...
def test_update_dashboard_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DashboardsServiceRestInterceptor, "post_update_dashboard_with_metadata") as post_with_metadata, \

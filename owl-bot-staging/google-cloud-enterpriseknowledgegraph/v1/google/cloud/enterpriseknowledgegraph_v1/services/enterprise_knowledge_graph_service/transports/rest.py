...
from .base import EnterpriseKnowledgeGraphServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class EnterpriseKnowledgeGraphServiceRestTransport(EnterpriseKnowledgeGraphServiceTransport):

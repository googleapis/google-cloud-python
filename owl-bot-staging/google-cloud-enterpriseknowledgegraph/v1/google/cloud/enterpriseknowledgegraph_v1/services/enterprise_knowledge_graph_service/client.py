...
from .transports.base import EnterpriseKnowledgeGraphServiceTransport, DEFAULT_CLIENT_INFO
...
class EnterpriseKnowledgeGraphServiceClient(metaclass=EnterpriseKnowledgeGraphServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "enterpriseknowledgegraph.{UNIVERSE_DOMAIN}"
    ...
    @staticmethod
    def cloud_knowledge_graph_entity_path(project: str,location: str,cloud_knowledge_graph_entity: str,) -> str:
        """Returns a fully-qualified cloud_knowledge_graph_entity string."""
        return "projects/{project}/locations/{location}/cloudKnowledgeGraphEntities/{cloud_knowledge_graph_entity}".format(project=project, location=location, cloud_knowledge_graph_entity=cloud_knowledge_graph_entity, )
    ...
    def parse_cloud_knowledge_graph_entity_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/cloudKnowledgeGraphEntities/(?P<cloud_knowledge_graph_entity>.+?)$", path)
    ...
    @staticmethod
    def entity_reconciliation_job_path(project: str,location: str,entity_reconciliation_job: str,) -> str:
        """Returns a fully-qualified entity_reconciliation_job string."""
        return "projects/{project}/locations/{location}/entityReconciliationJobs/{entity_reconciliation_job}".format(project=project, location=location, entity_reconciliation_job=entity_reconciliation_job, )
    ...
    def parse_entity_reconciliation_job_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/entityReconciliationJobs/(?P<entity_reconciliation_job>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def public_knowledge_graph_entity_path(project: str,location: str,public_knowledge_graph_entity: str,) -> str:
        """Returns a fully-qualified public_knowledge_graph_entity string."""
        return "projects/{project}/locations/{location}/publicKnowledgeGraphEntities/{public_knowledge_graph_entity}".format(project=project, location=location, public_knowledge_graph_entity=public_knowledge_graph_entity, )
    ...
    def parse_public_knowledge_graph_entity_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/publicKnowledgeGraphEntities/(?P<public_knowledge_graph_entity>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = EnterpriseKnowledgeGraphServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = EnterpriseKnowledgeGraphServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = EnterpriseKnowledgeGraphServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            EnterpriseKnowledgeGraphServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, EnterpriseKnowledgeGraphServiceTransport, Callable[..., EnterpriseKnowledgeGraphServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = EnterpriseKnowledgeGraphServiceClient._read_environment_variables()
        self._client_cert_source = EnterpriseKnowledgeGraphServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = EnterpriseKnowledgeGraphServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, EnterpriseKnowledgeGraphServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(EnterpriseKnowledgeGraphServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[EnterpriseKnowledgeGraphServiceTransport], Callable[..., EnterpriseKnowledgeGraphServiceTransport]] = (
                EnterpriseKnowledgeGraphServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., EnterpriseKnowledgeGraphServiceTransport], transport)
            )
    ...
    def create_entity_reconciliation_job(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_entity_reconciliation_job]
    ...
    def get_entity_reconciliation_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_entity_reconciliation_job]
    ...
    def list_entity_reconciliation_jobs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_entity_reconciliation_jobs]
    ...
    def cancel_entity_reconciliation_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.cancel_entity_reconciliation_job]
    ...
    def delete_entity_reconciliation_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_entity_reconciliation_job]

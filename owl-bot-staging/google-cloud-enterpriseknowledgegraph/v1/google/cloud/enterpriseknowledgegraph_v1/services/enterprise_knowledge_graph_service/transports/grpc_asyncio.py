...
from .base import EnterpriseKnowledgeGraphServiceTransport, DEFAULT_CLIENT_INFO
...
class EnterpriseKnowledgeGraphServiceGrpcAsyncIOTransport(EnterpriseKnowledgeGraphServiceTransport):
    ...
    def create_entity_reconciliation_job(self) -> Callable[
        ...
        if 'create_entity_reconciliation_job' not in self._stubs:
            self._stubs['create_entity_reconciliation_job'] = self.grpc_channel.unary_unary(
    ...
    def get_entity_reconciliation_job(self) -> Callable[
        ...
        if 'get_entity_reconciliation_job' not in self._stubs:
            self._stubs['get_entity_reconciliation_job'] = self.grpc_channel.unary_unary(
    ...
    def list_entity_reconciliation_jobs(self) -> Callable[
        ...
        if 'list_entity_reconciliation_jobs' not in self._stubs:
            self._stubs['list_entity_reconciliation_jobs'] = self.grpc_channel.unary_unary(
    ...
    def cancel_entity_reconciliation_job(self) -> Callable[
        ...
        if 'cancel_entity_reconciliation_job' not in self._stubs:
            self._stubs['cancel_entity_reconciliation_job'] = self.grpc_channel.unary_unary(
    ...
    def delete_entity_reconciliation_job(self) -> Callable[
        ...
        if 'delete_entity_reconciliation_job' not in self._stubs:
            self._stubs['delete_entity_reconciliation_job'] = self.grpc_channel.unary_unary(
    ...
    def lookup(self) -> Callable[
            ...
            Awaitable[service.LookupResponse]]:
    ...
    def search(self) -> Callable[
            ...
            Awaitable[service.SearchResponse]]:
    ...
    def lookup_public_kg(self) -> Callable[
            ...
            Awaitable[service.LookupPublicKgResponse]]:
    ...
    def search_public_kg(self) -> Callable[
            ...
            Awaitable[service.SearchPublicKgResponse]]:

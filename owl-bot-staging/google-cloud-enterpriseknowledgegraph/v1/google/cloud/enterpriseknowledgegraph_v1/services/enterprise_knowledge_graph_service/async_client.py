...
class EnterpriseKnowledgeGraphServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(EnterpriseKnowledgeGraphServiceClient).get_transport_class, type(EnterpriseKnowledgeGraphServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, EnterpriseKnowledgeGraphServiceTransport, Callable[..., EnterpriseKnowledgeGraphServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_entity_reconciliation_job(self,
    ...
    async def get_entity_reconciliation_job(self,
    ...
    async def list_entity_reconciliation_jobs(self,
    ...
    async def cancel_entity_reconciliation_job(self,
    ...
    async def delete_entity_reconciliation_job(self,
    ...
    async def lookup_public_kg(self,
    ...
    async def search_public_kg(self,

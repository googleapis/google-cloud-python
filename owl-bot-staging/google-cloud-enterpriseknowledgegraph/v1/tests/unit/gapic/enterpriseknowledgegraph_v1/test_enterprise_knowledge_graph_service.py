...
from google.cloud.enterpriseknowledgegraph_v1.services.enterprise_knowledge_graph_service import EnterpriseKnowledgeGraphServiceAsyncClient
...
from google.cloud.enterpriseknowledgegraph_v1.services.enterprise_knowledge_graph_service import transports
...
@mock.patch.object(EnterpriseKnowledgeGraphServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EnterpriseKnowledgeGraphServiceClient))
@mock.patch.object(EnterpriseKnowledgeGraphServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EnterpriseKnowledgeGraphServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert EnterpriseKnowledgeGraphServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == EnterpriseKnowledgeGraphServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EnterpriseKnowledgeGraphServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert EnterpriseKnowledgeGraphServiceClient._get_api_endpoint(None, None, default_universe, "always") == EnterpriseKnowledgeGraphServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (EnterpriseKnowledgeGraphServiceAsyncClient, transports.EnterpriseKnowledgeGraphServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_create_entity_reconciliation_job(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_entity_reconciliation_job),
            '__call__') as call:
...
def test_get_entity_reconciliation_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_entity_reconciliation_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.EntityReconciliationJob(
            name='name_value',
...
def test_list_entity_reconciliation_jobs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, service.EntityReconciliationJob)
                   for i in results)
...
def test_cancel_entity_reconciliation_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.cancel_entity_reconciliation_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_entity_reconciliation_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_entity_reconciliation_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_lookup_public_kg(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.lookup_public_kg),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_search_public_kg(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_public_kg),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_entity_reconciliation_job_rest_required_fields(request_type=service.CreateEntityReconciliationJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_entity_reconciliation_job._get_unset_required_fields(jsonified_request)
...
def test_create_entity_reconciliation_job_rest_unset_required_fields():
    transport = transports.EnterpriseKnowledgeGraphServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_entity_reconciliation_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_create_entity_reconciliation_job") as post, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "pre_create_entity_reconciliation_job") as pre:
...
def test_get_entity_reconciliation_job_rest_required_fields(request_type=service.GetEntityReconciliationJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_entity_reconciliation_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_entity_reconciliation_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_get_entity_reconciliation_job") as post, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "pre_get_entity_reconciliation_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_entity_reconciliation_jobs_rest_required_fields(request_type=service.ListEntityReconciliationJobsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_entity_reconciliation_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_entity_reconciliation_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_list_entity_reconciliation_jobs") as post, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "pre_list_entity_reconciliation_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_cancel_entity_reconciliation_job_rest_required_fields(request_type=service.CancelEntityReconciliationJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).cancel_entity_reconciliation_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_entity_reconciliation_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "pre_cancel_entity_reconciliation_job") as pre:
        pre.assert_not_called()
...
def test_delete_entity_reconciliation_job_rest_required_fields(request_type=service.DeleteEntityReconciliationJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_entity_reconciliation_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_entity_reconciliation_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "pre_delete_entity_reconciliation_job") as pre:
        pre.assert_not_called()
...
def test_lookup_rest_required_fields(request_type=service.LookupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).lookup._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_lookup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_lookup") as post, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "pre_lookup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_search_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_search") as post, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "pre_search") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_lookup_public_kg_rest_required_fields(request_type=service.LookupPublicKgRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).lookup_public_kg._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_lookup_public_kg_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_lookup_public_kg") as post, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "pre_lookup_public_kg") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_search_public_kg_rest_required_fields(request_type=service.SearchPublicKgRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_public_kg._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_public_kg_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_search_public_kg") as post, \
         mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "pre_search_public_kg") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_transport_kind(transport_name):
    transport = EnterpriseKnowledgeGraphServiceClient.get_transport_class(transport_name)(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
    )

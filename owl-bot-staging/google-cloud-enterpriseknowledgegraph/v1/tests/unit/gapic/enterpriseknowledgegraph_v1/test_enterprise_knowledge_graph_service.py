...
def test_transport_kind_grpc_asyncio():
    transport = EnterpriseKnowledgeGraphServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_create_entity_reconciliation_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_create_entity_reconciliation_job_with_metadata") as post_with_metadata, \
...
def test_get_entity_reconciliation_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_get_entity_reconciliation_job_with_metadata") as post_with_metadata, \
...
def test_list_entity_reconciliation_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_list_entity_reconciliation_jobs_with_metadata") as post_with_metadata, \
...
def test_lookup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_lookup_with_metadata") as post_with_metadata, \
...
def test_search_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_search_with_metadata") as post_with_metadata, \
...
def test_lookup_public_kg_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_lookup_public_kg_with_metadata") as post_with_metadata, \
...
def test_search_public_kg_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EnterpriseKnowledgeGraphServiceRestInterceptor, "post_search_public_kg_with_metadata") as post_with_metadata, \

...
def test__get_api_endpoint():
    ...
    assert EdgeContainerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EdgeContainerClient.DEFAULT_MTLS_ENDPOINT
...
def test_upgrade_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.upgrade_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_generate_offline_credential(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_offline_credential),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_upgrade_cluster_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "targetVersion", )))
...
def test_generate_offline_credential_rest_required_fields(request_type=service.GenerateOfflineCredentialRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_offline_credential._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_clusters_with_metadata") as post_with_metadata, \
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_cluster_with_metadata") as post_with_metadata, \
...
def test_create_cluster_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["cluster"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'fleet': {'project': 'project_value', 'membership': 'membership_value'}, 'networking': {'cluster_ipv4_cidr_blocks': ['cluster_ipv4_cidr_blocks_value1', 'cluster_ipv4_cidr_blocks_value2'], 'services_ipv4_cidr_blocks': ['services_ipv4_cidr_blocks_value1', 'services_ipv4_cidr_blocks_value2']}, 'authorization': {'admin_users': {'username': 'username_value'}}, 'default_max_pods_per_node': 2634, 'endpoint': 'endpoint_value', 'port': 453, 'cluster_ca_certificate': 'cluster_ca_certificate_value', 'maintenance_policy': {'window': {'recurring_window': {'window': {'start_time': {}, 'end_time': {}}, 'recurrence': 'recurrence_value'}}, 'maintenance_exclusions': [{'window': {}, 'id': 'id_value'}]}, 'control_plane_version': 'control_plane_version_value', 'node_version': 'node_version_value', 'control_plane': {'remote': {}, 'local': {'node_location': 'node_location_value', 'node_count': 1070, 'machine_filter': 'machine_filter_value', 'shared_deployment_policy': 1, 'control_plane_node_storage_schema': 'control_plane_node_storage_schema_value'}}, 'system_addons_config': {'ingress': {'disabled': True, 'ipv4_vip': 'ipv4_vip_value'}, 'vm_service_config': {'vmm_enabled': True}}, 'external_load_balancer_ipv4_address_pools': ['external_load_balancer_ipv4_address_pools_value1', 'external_load_balancer_ipv4_address_pools_value2'], 'control_plane_encryption': {'kms_key': 'kms_key_value', 'kms_key_active_version': 'kms_key_active_version_value', 'kms_key_state': 1, 'kms_status': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}, 'resource_state': 1}, 'status': 1, 'maintenance_events': [{'uuid': 'uuid_value', 'target_version': 'target_version_value', 'operation': 'operation_value', 'type_': 1, 'schedule': 1, 'state': 1, 'create_time': {}, 'start_time': {}, 'end_time': {}, 'update_time': {}}], 'target_version': 'target_version_value', 'release_channel': 1, 'survivability_config': {'offline_reboot_ttl': {'seconds': 751, 'nanos': 543}}, 'external_load_balancer_ipv6_address_pools': ['external_load_balancer_ipv6_address_pools_value1', 'external_load_balancer_ipv6_address_pools_value2'], 'connection_state': {'state': 1, 'update_time': {}}}
...
def test_create_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_create_cluster_with_metadata") as post_with_metadata, \
...
def test_update_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_update_cluster_with_metadata") as post_with_metadata, \
...
def test_upgrade_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_upgrade_cluster") as post, \
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_upgrade_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_upgrade_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.upgrade_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_delete_cluster_with_metadata") as post_with_metadata, \
...
def test_generate_access_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_generate_access_token_with_metadata") as post_with_metadata, \
...
def test_generate_offline_credential_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_generate_offline_credential") as post, \
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_generate_offline_credential_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_generate_offline_credential") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.generate_offline_credential(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_node_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_node_pools_with_metadata") as post_with_metadata, \
...
def test_get_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_node_pool_with_metadata") as post_with_metadata, \
...
def test_create_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_create_node_pool_with_metadata") as post_with_metadata, \
...
def test_update_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_update_node_pool_with_metadata") as post_with_metadata, \
...
def test_delete_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_delete_node_pool_with_metadata") as post_with_metadata, \
...
def test_list_machines_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_machines_with_metadata") as post_with_metadata, \
...
def test_get_machine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_machine_with_metadata") as post_with_metadata, \
...
def test_list_vpn_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_vpn_connections_with_metadata") as post_with_metadata, \
...
def test_get_vpn_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_vpn_connection_with_metadata") as post_with_metadata, \
...
def test_create_vpn_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_create_vpn_connection_with_metadata") as post_with_metadata, \
...
def test_delete_vpn_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_delete_vpn_connection_with_metadata") as post_with_metadata, \
...
def test_get_server_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_server_config") as post, \
        mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_server_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_get_server_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

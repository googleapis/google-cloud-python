...
def test_list_clusters_rest_unset_required_fields():
    transport = transports.EdgeContainerRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_node_pools_rest_required_fields(request_type=service.ListNodePoolsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_node_pools._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_node_pool_rest_required_fields(request_type=service.GetNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_node_pool_rest_required_fields(request_type=service.CreateNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_node_pool_rest_required_fields(request_type=service.DeleteNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_machines_rest_required_fields(request_type=service.ListMachinesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_machines._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_machine_rest_required_fields(request_type=service.GetMachineRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_machine._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_vpn_connections_rest_required_fields(request_type=service.ListVpnConnectionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_vpn_connections._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_vpn_connection_rest_required_fields(request_type=service.GetVpnConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_vpn_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_vpn_connection_rest_required_fields(request_type=service.CreateVpnConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_vpn_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_vpn_connection_rest_required_fields(request_type=service.DeleteVpnConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_vpn_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
from .transports.base import DataAccessControlServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import DataAccessControlServiceGrpcTransport
from .transports.grpc_asyncio import DataAccessControlServiceGrpcAsyncIOTransport
from .transports.rest import DataAccessControlServiceRestTransport


class DataAccessControlServiceClientMeta(type):
    """Metaclass for the DataAccessControlService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[DataAccessControlServiceTransport]]
    _transport_registry["grpc"] = DataAccessControlServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = DataAccessControlServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = DataAccessControlServiceRestTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[DataAccessControlServiceTransport]:
...
class DataAccessControlServiceClient(metaclass=DataAccessControlServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DataAccessControlServiceClient: The constructed client.
        """
    ...
    def transport(self) -> DataAccessControlServiceTransport:
        ...
        Returns:
            DataAccessControlServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def data_access_label_path(project: str,location: str,instance: str,data_access_label: str,) -> str:
        """Returns a fully-qualified data_access_label string."""
        return "projects/{project}/locations/{location}/instances/{instance}/dataAccessLabels/{data_access_label}".format(project=project, location=location, instance=instance, data_access_label=data_access_label, )

    @staticmethod
    def parse_data_access_label_path(path: str) -> Dict[str,str]:
        """Parses a data_access_label path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/dataAccessLabels/(?P<data_access_label>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def data_access_scope_path(project: str,location: str,instance: str,data_access_scope: str,) -> str:
        """Returns a fully-qualified data_access_scope string."""
        return "projects/{project}/locations/{location}/instances/{instance}/dataAccessScopes/{data_access_scope}".format(project=project, location=location, instance=instance, data_access_scope=data_access_scope, )

    @staticmethod
    def parse_data_access_scope_path(path: str) -> Dict[str,str]:
        """Parses a data_access_scope path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/dataAccessScopes/(?P<data_access_scope>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DataAccessControlServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DataAccessControlServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = DataAccessControlServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DataAccessControlServiceTransport, Callable[..., DataAccessControlServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DataAccessControlServiceClient._read_environment_variables()
        self._client_cert_source = DataAccessControlServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DataAccessControlServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DataAccessControlServiceTransport)
        if transport_provided:
            # transport is a DataAccessControlServiceTransport instance.
            ...
            self._transport = cast(DataAccessControlServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DataAccessControlServiceTransport], Callable[..., DataAccessControlServiceTransport]] = (
                DataAccessControlServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., DataAccessControlServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.chronicle_v1.DataAccessControlServiceClient`.",
                    extra = {
    ...
    def create_data_access_label(self,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.CreateDataAccessLabelRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_data_access_label]
    ...
    def get_data_access_label(self,
        ...
        .. code-block:: python
            ...
            def sample_get_data_access_label():
                # Create a client
                client = chronicle_v1.DataAccessControlServiceClient()
                ...
                # Make the request
                response = client.get_data_access_label(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.chronicle_v1.types.GetDataAccessLabelRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_data_access_label]
    ...
    def list_data_access_labels(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListDataAccessLabelsPager:
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.ListDataAccessLabelsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_data_access_labels]
        ...
        response = pagers.ListDataAccessLabelsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def update_data_access_label(self,
        ...
        .. code-block:: python
            ...
            def sample_update_data_access_label():
                # Create a client
                client = chronicle_v1.DataAccessControlServiceClient()
                ...
                # Make the request
                response = client.update_data_access_label(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.chronicle_v1.types.UpdateDataAccessLabelRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_data_access_label]
    ...
    def delete_data_access_label(self,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.DeleteDataAccessLabelRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_data_access_label]
    ...
    def create_data_access_scope(self,
        ...
        .. code-block:: python
            ...
            def sample_create_data_access_scope():
                # Create a client
                client = chronicle_v1.DataAccessControlServiceClient()
                ...
                # Make the request
                response = client.create_data_access_scope(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.chronicle_v1.types.CreateDataAccessScopeRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_data_access_scope]
    ...
    def get_data_access_scope(self,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.GetDataAccessScopeRequest, dict]):
                The request object. Request message to retrieve a data
                access scope.
            name (str):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_data_access_scope]
    ...
    def list_data_access_scopes(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListDataAccessScopesPager:
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.ListDataAccessScopesRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_data_access_scopes]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListDataAccessScopesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def update_data_access_scope(self,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.UpdateDataAccessScopeRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_data_access_scope]
    ...
    def delete_data_access_scope(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_data_access_scope():
                # Create a client
                client = chronicle_v1.DataAccessControlServiceClient()
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.DeleteDataAccessScopeRequest, dict]):
                The request object. Request message to delete a data
                access scope.
            name (str):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_data_access_scope]
    ...
    def __enter__(self) -> "DataAccessControlServiceClient":
        return self

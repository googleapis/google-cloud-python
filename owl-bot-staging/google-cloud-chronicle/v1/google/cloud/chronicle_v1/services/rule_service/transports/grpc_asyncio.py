...
from .base import RuleServiceTransport, DEFAULT_CLIENT_INFO
...
class RuleServiceGrpcAsyncIOTransport(RuleServiceTransport):
    ...
    @property
    def list_rule_revisions(self) -> Callable[
            [rule.ListRuleRevisionsRequest],
            Awaitable[rule.ListRuleRevisionsResponse]]:
    ...
    @property
    def create_retrohunt(self) -> Callable[
    ...
    @property
    def get_retrohunt(self) -> Callable[
            [rule.GetRetrohuntRequest],
            Awaitable[rule.Retrohunt]]:
    ...
    @property
    def list_retrohunts(self) -> Callable[
            [rule.ListRetrohuntsRequest],
            Awaitable[rule.ListRetrohuntsResponse]]:
    ...
    @property
    def get_rule_deployment(self) -> Callable[
            [rule.GetRuleDeploymentRequest],
            Awaitable[rule.RuleDeployment]]:
    ...
    @property
    def list_rule_deployments(self) -> Callable[
    ...
    @property
    def update_rule_deployment(self) -> Callable[

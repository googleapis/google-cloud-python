...
class ReferenceListServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_reference_list(self, request: gcc_reference_list.CreateReferenceListRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcc_reference_list.CreateReferenceListRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_reference_list_with_metadata(self, response: gcc_reference_list.ReferenceList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcc_reference_list.ReferenceList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_reference_list
    ...
    def pre_get_reference_list(self, request: reference_list.GetReferenceListRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reference_list.GetReferenceListRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_reference_list_with_metadata(self, response: reference_list.ReferenceList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reference_list.ReferenceList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_reference_list
    ...
    def pre_list_reference_lists(self, request: reference_list.ListReferenceListsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reference_list.ListReferenceListsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_reference_lists_with_metadata(self, response: reference_list.ListReferenceListsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reference_list.ListReferenceListsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_reference_lists
    ...
    def pre_update_reference_list(self, request: gcc_reference_list.UpdateReferenceListRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcc_reference_list.UpdateReferenceListRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_reference_list_with_metadata(self, response: gcc_reference_list.ReferenceList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcc_reference_list.ReferenceList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_reference_list
...
class ReferenceListServiceRestTransport(_BaseReferenceListServiceRestTransport):
    ...
    class _CreateReferenceList(_BaseReferenceListServiceRestTransport._BaseCreateReferenceList, ReferenceListServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReferenceListServiceRestTransport._CreateReferenceList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetReferenceList(_BaseReferenceListServiceRestTransport._BaseGetReferenceList, ReferenceListServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReferenceListServiceRestTransport._GetReferenceList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListReferenceLists(_BaseReferenceListServiceRestTransport._BaseListReferenceLists, ReferenceListServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReferenceListServiceRestTransport._ListReferenceLists._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateReferenceList(_BaseReferenceListServiceRestTransport._BaseUpdateReferenceList, ReferenceListServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReferenceListServiceRestTransport._UpdateReferenceList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CancelOperation(_BaseReferenceListServiceRestTransport._BaseCancelOperation, ReferenceListServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReferenceListServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteOperation(_BaseReferenceListServiceRestTransport._BaseDeleteOperation, ReferenceListServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReferenceListServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseReferenceListServiceRestTransport._BaseGetOperation, ReferenceListServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReferenceListServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseReferenceListServiceRestTransport._BaseListOperations, ReferenceListServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReferenceListServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

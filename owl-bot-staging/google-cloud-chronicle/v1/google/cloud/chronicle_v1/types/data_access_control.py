...
class DataAccessScope(proto.Message):
    ...
    allowed_data_access_labels: MutableSequence['DataAccessLabelReference'] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
        message='DataAccessLabelReference',
    )
    denied_data_access_labels: MutableSequence['DataAccessLabelReference'] = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
        message='DataAccessLabelReference',
    )

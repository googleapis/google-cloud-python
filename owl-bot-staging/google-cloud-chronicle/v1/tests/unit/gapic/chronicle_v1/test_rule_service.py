...
from google.cloud.chronicle_v1.services.rule_service import RuleServiceAsyncClient
from google.cloud.chronicle_v1.services.rule_service import RuleServiceClient
from google.cloud.chronicle_v1.services.rule_service import pagers
from google.cloud.chronicle_v1.services.rule_service import transports
...
@pytest.mark.parametrize("client_class", [
    RuleServiceClient, RuleServiceAsyncClient
])
...
def test_create_rule(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_rule),
            '__call__') as call:
...
def test_list_rules(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_rules),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_rules_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, rule.Rule)
                   for i in results)
...
async def test_list_rules_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_rules(request={},)
...
def test_update_rule(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_rule),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gcc_rule.Rule(
            name='name_value',
...
def test_delete_rule(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_rule),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_list_rule_revisions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_rule_revisions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_create_retrohunt(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_retrohunt),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_retrohunt(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_retrohunt),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_retrohunts(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_retrohunts),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_retrohunts_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, rule.Retrohunt)
                   for i in results)
...
async def test_list_retrohunts_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_retrohunts(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_rule_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_rule_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_rule_deployments_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, rule.RuleDeployment)
                   for i in results)
...
async def test_list_rule_deployments_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_rule_deployments(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_update_rule_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_rule_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = rule.RuleDeployment(
            name='name_value',
...
def test_create_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "rule", )))
...
def test_list_rule_revisions_rest_required_fields(request_type=rule.ListRuleRevisionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_rule_revisions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_retrohunt_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "retrohunt", )))
...
def test_get_rule_deployment_rest_required_fields(request_type=rule.GetRuleDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_rule_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_rule_deployments_rest_required_fields(request_type=rule.ListRuleDeploymentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_rule_deployments._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_rule_deployment_rest_required_fields(request_type=rule.UpdateRuleDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_rule_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_rule_deployment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("ruleDeployment", "updateMask", )))
...
def test_update_rule_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{rule_deployment.name=projects/*/locations/*/instances/*/rules/*/deployment}" % client.transport._host, args[1])
...
def test_create_rule_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/instances/sample3'}
    request_init["rule"] = {'name': 'name_value', 'revision_id': 'revision_id_value', 'display_name': 'display_name_value', 'text': 'text_value', 'author': 'author_value', 'severity': {'display_name': 'display_name_value'}, 'metadata': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'revision_create_time': {}, 'compilation_state': 1, 'type_': 1, 'reference_lists': ['reference_lists_value1', 'reference_lists_value2'], 'allowed_run_frequencies': [1], 'etag': 'etag_value', 'scope': 'scope_value', 'compilation_diagnostics': [{'message': 'message_value', 'position': {'start_line': 1077, 'start_column': 1307, 'end_line': 830, 'end_column': 1060}, 'severity': 1, 'uri': 'uri_value'}], 'near_real_time_live_rule_eligible': True, 'inputs_used': {'uses_udm': True, 'uses_entity': True, 'uses_detection': True}}
...
def test_create_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_create_rule") as post, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_create_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "pre_create_rule") as pre:
        ...
        client.create_rule(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_get_rule") as post, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_get_rule_with_metadata") as post_with_metadata, \
...
def test_list_rules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_rules") as post, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_rules_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "pre_list_rules") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_rules(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_rule_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'rule': {'name': 'projects/sample1/locations/sample2/instances/sample3/rules/sample4'}}
    request_init["rule"] = {'name': 'projects/sample1/locations/sample2/instances/sample3/rules/sample4', 'revision_id': 'revision_id_value', 'display_name': 'display_name_value', 'text': 'text_value', 'author': 'author_value', 'severity': {'display_name': 'display_name_value'}, 'metadata': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'revision_create_time': {}, 'compilation_state': 1, 'type_': 1, 'reference_lists': ['reference_lists_value1', 'reference_lists_value2'], 'allowed_run_frequencies': [1], 'etag': 'etag_value', 'scope': 'scope_value', 'compilation_diagnostics': [{'message': 'message_value', 'position': {'start_line': 1077, 'start_column': 1307, 'end_line': 830, 'end_column': 1060}, 'severity': 1, 'uri': 'uri_value'}], 'near_real_time_live_rule_eligible': True, 'inputs_used': {'uses_udm': True, 'uses_entity': True, 'uses_detection': True}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_update_rule") as post, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_update_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "pre_update_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_rule(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "pre_delete_rule") as pre:
        pre.assert_not_called()
        ...
        client.delete_rule(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_rule_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_rule_revisions") as post, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_rule_revisions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "pre_list_rule_revisions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_rule_revisions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_retrohunt_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/instances/sample3/rules/sample4'}
    request_init["retrohunt"] = {'name': 'name_value', 'process_interval': {'start_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}}, 'execution_interval': {}, 'state': 1, 'progress_percentage': 0.2034}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_retrohunt_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_create_retrohunt") as post, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_create_retrohunt_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "pre_create_retrohunt") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_retrohunt(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_retrohunt_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_get_retrohunt") as post, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_get_retrohunt_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "pre_get_retrohunt") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_retrohunt(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_retrohunts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_retrohunts") as post, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_retrohunts_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "pre_list_retrohunts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_retrohunts(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_rule_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_get_rule_deployment") as post, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_get_rule_deployment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "pre_get_rule_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_rule_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_rule_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_rule_deployments") as post, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_rule_deployments_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "pre_list_rule_deployments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_rule_deployments(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_rule_deployment_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'rule_deployment': {'name': 'projects/sample1/locations/sample2/instances/sample3/rules/sample4/deployment'}}
    request_init["rule_deployment"] = {'name': 'projects/sample1/locations/sample2/instances/sample3/rules/sample4/deployment', 'enabled': True, 'alerting': True, 'archived': True, 'archive_time': {'seconds': 751, 'nanos': 543}, 'run_frequency': 1, 'execution_state': 1, 'producer_rules': ['producer_rules_value1', 'producer_rules_value2'], 'consumer_rules': ['consumer_rules_value1', 'consumer_rules_value2'], 'last_alert_status_change_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_rule_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_update_rule_deployment") as post, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "post_update_rule_deployment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RuleServiceRestInterceptor, "pre_update_rule_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_rule_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_rule_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.chronicle_v1.services.rule_service.transports.RuleServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_rule_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.chronicle_v1.services.rule_service.transports.RuleServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RuleServiceTransport()
        adc.assert_called_once()
...
def test_rule_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.RuleServiceGrpcTransport, transports.RuleServiceGrpcAsyncIOTransport])
def test_rule_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.RuleServiceGrpcTransport, transports.RuleServiceGrpcAsyncIOTransport])
def test_rule_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_retrohunt_path():
    ...
    rule = "mussel"
    retrohunt = "winkle"
    expected = "projects/{project}/locations/{location}/instances/{instance}/rules/{rule}/retrohunts/{retrohunt}".format(project=project, location=location, instance=instance, rule=rule, retrohunt=retrohunt, )
...
def test_rule_path():
    ...
    instance = "oyster"
    rule = "nudibranch"
    expected = "projects/{project}/locations/{location}/instances/{instance}/rules/{rule}".format(project=project, location=location, instance=instance, rule=rule, )
...
def test_rule_deployment_path():
    ...
    instance = "squid"
    rule = "clam"
    expected = "projects/{project}/locations/{location}/instances/{instance}/rules/{rule}/deployment".format(project=project, location=location, instance=instance, rule=rule, )

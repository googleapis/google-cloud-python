...
def test_create_document_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DocumentSchemaServiceRestInterceptor, "post_create_document_schema_with_metadata") as post_with_metadata, \
...
def test_update_document_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DocumentSchemaServiceRestInterceptor, "post_update_document_schema_with_metadata") as post_with_metadata, \
...
def test_get_document_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DocumentSchemaServiceRestInterceptor, "post_get_document_schema_with_metadata") as post_with_metadata, \
...
def test_list_document_schemas_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DocumentSchemaServiceRestInterceptor, "post_list_document_schemas_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = document_schema_service.ListDocumentSchemasResponse(), metadata

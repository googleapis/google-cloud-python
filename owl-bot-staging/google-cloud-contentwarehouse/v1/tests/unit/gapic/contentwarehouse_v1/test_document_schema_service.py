...
def test_create_document_schema_rest_required_fields(request_type=document_schema_service.CreateDocumentSchemaRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_document_schema._get_unset_required_fields(jsonified_request)
...
def test_create_document_schema_rest_unset_required_fields():
    transport = transports.DocumentSchemaServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_document_schema_rest_required_fields(request_type=document_schema_service.UpdateDocumentSchemaRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_document_schema._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_document_schema_rest_required_fields(request_type=document_schema_service.GetDocumentSchemaRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_document_schema._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_document_schema_rest_required_fields(request_type=document_schema_service.DeleteDocumentSchemaRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_document_schema._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_document_schemas_rest_required_fields(request_type=document_schema_service.ListDocumentSchemasRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_document_schemas._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transport_kind(transport_name):
    transport = DocumentSchemaServiceClient.get_transport_class(transport_name)(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
    )

...
def test_list_linked_targets_rest_required_fields(request_type=document_link_service.ListLinkedTargetsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_linked_targets._get_unset_required_fields(jsonified_request)
...
def test_list_linked_targets_rest_unset_required_fields():
    transport = transports.DocumentLinkServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_linked_sources_rest_required_fields(request_type=document_link_service.ListLinkedSourcesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_linked_sources._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_document_link_rest_required_fields(request_type=document_link_service.CreateDocumentLinkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_document_link._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_document_link_rest_required_fields(request_type=document_link_service.DeleteDocumentLinkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_document_link._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transport_kind(transport_name):
    transport = DocumentLinkServiceClient.get_transport_class(transport_name)(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
    )

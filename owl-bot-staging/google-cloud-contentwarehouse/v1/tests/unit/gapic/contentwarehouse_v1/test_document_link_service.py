...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = DocumentLinkServiceClient(credentials=cred)
...
def test_list_linked_targets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DocumentLinkServiceRestInterceptor, "post_list_linked_targets_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = document_link_service.ListLinkedTargetsResponse(), metadata
...
def test_list_linked_sources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DocumentLinkServiceRestInterceptor, "post_list_linked_sources_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = document_link_service.ListLinkedSourcesResponse(), metadata
...
def test_create_document_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DocumentLinkServiceRestInterceptor, "post_create_document_link_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = document_link_service.DocumentLink(), metadata

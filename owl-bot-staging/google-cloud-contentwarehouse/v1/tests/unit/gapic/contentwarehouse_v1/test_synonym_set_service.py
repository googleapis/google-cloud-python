...
def test_create_synonym_set_rest_required_fields(request_type=synonymset_service_request.CreateSynonymSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_synonym_set._get_unset_required_fields(jsonified_request)
...
def test_create_synonym_set_rest_unset_required_fields():
    transport = transports.SynonymSetServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_synonym_set_rest_required_fields(request_type=synonymset_service_request.GetSynonymSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_synonym_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_synonym_set_rest_required_fields(request_type=synonymset_service_request.UpdateSynonymSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_synonym_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_synonym_set_rest_required_fields(request_type=synonymset_service_request.DeleteSynonymSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_synonym_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_synonym_sets_rest_required_fields(request_type=synonymset_service_request.ListSynonymSetsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_synonym_sets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test_search_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DocumentServiceRestInterceptor, "post_search_documents_with_metadata") as post_with_metadata, \
...
def test_lock_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DocumentServiceRestInterceptor, "post_lock_document_with_metadata") as post_with_metadata, \
...
def test_fetch_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DocumentServiceRestInterceptor, "post_fetch_acl_with_metadata") as post_with_metadata, \
...
def test_set_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DocumentServiceRestInterceptor, "post_set_acl_with_metadata") as post_with_metadata, \

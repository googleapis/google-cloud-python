...
def test_create_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = document_service.CreateDocumentResponse.to_json(document_service.CreateDocumentResponse())
...
def test_create_document_rest_bad_request(transport: str = 'rest', request_type=document_service_request.CreateDocumentRequest):
    client = DocumentServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcc_document.Document.to_json(gcc_document.Document())
...
def test_get_document_rest_bad_request(transport: str = 'rest', request_type=document_service_request.GetDocumentRequest):
    client = DocumentServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = document_service.UpdateDocumentResponse.to_json(document_service.UpdateDocumentResponse())
...
def test_update_document_rest_bad_request(transport: str = 'rest', request_type=document_service_request.UpdateDocumentRequest):
    client = DocumentServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_document_rest_bad_request(transport: str = 'rest', request_type=document_service_request.DeleteDocumentRequest):
    client = DocumentServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_search_documents_rest_required_fields(request_type=document_service_request.SearchDocumentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_documents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = document_service.SearchDocumentsResponse.to_json(document_service.SearchDocumentsResponse())
...
def test_search_documents_rest_bad_request(transport: str = 'rest', request_type=document_service_request.SearchDocumentsRequest):
    client = DocumentServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_lock_document_rest_required_fields(request_type=document_service_request.LockDocumentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).lock_document._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_lock_document_rest_bad_request(transport: str = 'rest', request_type=document_service_request.LockDocumentRequest):
    client = DocumentServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_fetch_acl_rest_required_fields(request_type=document_service_request.FetchAclRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).fetch_acl._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = document_service.FetchAclResponse.to_json(document_service.FetchAclResponse())
...
def test_fetch_acl_rest_bad_request(transport: str = 'rest', request_type=document_service_request.FetchAclRequest):
    client = DocumentServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_set_acl_rest_required_fields(request_type=document_service_request.SetAclRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).set_acl._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = document_service.SetAclResponse.to_json(document_service.SetAclResponse())
...
def test_set_acl_rest_bad_request(transport: str = 'rest', request_type=document_service_request.SetAclRequest):
    client = DocumentServiceClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )

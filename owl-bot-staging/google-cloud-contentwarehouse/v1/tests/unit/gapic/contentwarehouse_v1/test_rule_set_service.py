...
def test_create_rule_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RuleSetServiceRestInterceptor, "post_create_rule_set_with_metadata") as post_with_metadata, \
...
def test_get_rule_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RuleSetServiceRestInterceptor, "post_get_rule_set_with_metadata") as post_with_metadata, \
...
def test_update_rule_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RuleSetServiceRestInterceptor, "post_update_rule_set_with_metadata") as post_with_metadata, \
...
def test_list_rule_sets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RuleSetServiceRestInterceptor, "post_list_rule_sets_with_metadata") as post_with_metadata, \

...
def test_create_rule_set_rest_required_fields(request_type=ruleset_service_request.CreateRuleSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_rule_set._get_unset_required_fields(jsonified_request)
...
def test_create_rule_set_rest_unset_required_fields():
    transport = transports.RuleSetServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_rule_set_rest_required_fields(request_type=ruleset_service_request.GetRuleSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_rule_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_rule_set_rest_required_fields(request_type=ruleset_service_request.UpdateRuleSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_rule_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_rule_set_rest_required_fields(request_type=ruleset_service_request.DeleteRuleSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_rule_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_rule_sets_rest_required_fields(request_type=ruleset_service_request.ListRuleSetsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_rule_sets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
class DocumentServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_document(self, request: document_service_request.CreateDocumentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service_request.CreateDocumentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_document_with_metadata(self, response: document_service.CreateDocumentResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service.CreateDocumentResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_document
    ...
    def pre_delete_document(self, request: document_service_request.DeleteDocumentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service_request.DeleteDocumentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_fetch_acl(self, request: document_service_request.FetchAclRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service_request.FetchAclRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_fetch_acl_with_metadata(self, response: document_service.FetchAclResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service.FetchAclResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for fetch_acl
    ...
    def pre_get_document(self, request: document_service_request.GetDocumentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service_request.GetDocumentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_document_with_metadata(self, response: gcc_document.Document, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcc_document.Document, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_document
    ...
    def pre_lock_document(self, request: document_service_request.LockDocumentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service_request.LockDocumentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_lock_document_with_metadata(self, response: gcc_document.Document, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcc_document.Document, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for lock_document
    ...
    def pre_search_documents(self, request: document_service_request.SearchDocumentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service_request.SearchDocumentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search_documents_with_metadata(self, response: document_service.SearchDocumentsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service.SearchDocumentsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_documents
    ...
    def pre_set_acl(self, request: document_service_request.SetAclRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service_request.SetAclRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_set_acl_with_metadata(self, response: document_service.SetAclResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service.SetAclResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for set_acl
    ...
    def pre_update_document(self, request: document_service_request.UpdateDocumentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service_request.UpdateDocumentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_document_with_metadata(self, response: document_service.UpdateDocumentResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_service.UpdateDocumentResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_document
...
class DocumentServiceRestTransport(_BaseDocumentServiceRestTransport):
    ...
    class _CreateDocument(_BaseDocumentServiceRestTransport._BaseCreateDocument, DocumentServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = document_service.CreateDocumentResponse.to_json(response)
                except:
    ...
    class _FetchAcl(_BaseDocumentServiceRestTransport._BaseFetchAcl, DocumentServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_fetch_acl_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = document_service.FetchAclResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _LockDocument(_BaseDocumentServiceRestTransport._BaseLockDocument, DocumentServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_lock_document_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = gcc_document.Document.to_json(response)
                except:
    ...
    class _SearchDocuments(_BaseDocumentServiceRestTransport._BaseSearchDocuments, DocumentServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_search_documents_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = document_service.SearchDocumentsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _SetAcl(_BaseDocumentServiceRestTransport._BaseSetAcl, DocumentServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_set_acl_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _UpdateDocument(_BaseDocumentServiceRestTransport._BaseUpdateDocument, DocumentServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = document_service.UpdateDocumentResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,

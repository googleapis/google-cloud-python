...
class DocumentServiceGrpcAsyncIOTransport(DocumentServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.search_documents: gapic_v1.method_async.wrap_method(
                self.search_documents,
                default_timeout=180.0,
                client_info=client_info,
            ),
            self.lock_document: gapic_v1.method_async.wrap_method(
                self.lock_document,
                default_timeout=None,
                client_info=client_info,
            ),
            self.fetch_acl: gapic_v1.method_async.wrap_method(
                self.fetch_acl,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.set_acl: gapic_v1.method_async.wrap_method(
                self.set_acl,
                default_timeout=60.0,
                client_info=client_info,
            ),

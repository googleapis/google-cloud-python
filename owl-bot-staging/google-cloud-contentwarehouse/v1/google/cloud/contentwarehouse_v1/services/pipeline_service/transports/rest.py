...
class PipelineServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_run_pipeline(self, request: pipeline_service.RunPipelineRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pipeline_service.RunPipelineRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    class _RunPipeline(_BasePipelineServiceRestTransport._BaseRunPipeline, PipelineServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.contentwarehouse_v1.PipelineServiceClient.RunPipeline",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.contentwarehouse_v1.PipelineServiceClient.run_pipeline",
                    extra = {
                        "serviceName": "google.cloud.contentwarehouse.v1.PipelineService",
                        "rpcName": "RunPipeline",
    ...
    class _GetOperation(_BasePipelineServiceRestTransport._BaseGetOperation, PipelineServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.contentwarehouse_v1.PipelineServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.contentwarehouse.v1.PipelineService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.contentwarehouse_v1.PipelineServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.contentwarehouse.v1.PipelineService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,

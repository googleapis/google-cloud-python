...
class SynonymSetServiceGrpcAsyncIOTransport(SynonymSetServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_synonym_set: gapic_v1.method_async.wrap_method(
                self.create_synonym_set,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_synonym_set: gapic_v1.method_async.wrap_method(
            ...
            self.update_synonym_set: gapic_v1.method_async.wrap_method(
                self.update_synonym_set,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_synonym_set: gapic_v1.method_async.wrap_method(
                self.delete_synonym_set,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_synonym_sets: gapic_v1.method_async.wrap_method(

...
class DocumentLinkServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_document_link(self, request: document_link_service.CreateDocumentLinkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_link_service.CreateDocumentLinkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_document_link_with_metadata(self, response: document_link_service.DocumentLink, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_link_service.DocumentLink, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_document_link
    ...
    def pre_delete_document_link(self, request: document_link_service.DeleteDocumentLinkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_link_service.DeleteDocumentLinkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_linked_sources(self, request: document_link_service.ListLinkedSourcesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_link_service.ListLinkedSourcesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_linked_sources_with_metadata(self, response: document_link_service.ListLinkedSourcesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_link_service.ListLinkedSourcesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_linked_sources
    ...
    def pre_list_linked_targets(self, request: document_link_service.ListLinkedTargetsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_link_service.ListLinkedTargetsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_linked_targets_with_metadata(self, response: document_link_service.ListLinkedTargetsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[document_link_service.ListLinkedTargetsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_linked_targets

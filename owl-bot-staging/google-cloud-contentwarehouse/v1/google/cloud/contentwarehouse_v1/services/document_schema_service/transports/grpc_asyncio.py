...
class DocumentSchemaServiceGrpcAsyncIOTransport(DocumentSchemaServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_document_schema: gapic_v1.method_async.wrap_method(
                self.create_document_schema,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_document_schema: gapic_v1.method_async.wrap_method(
                self.update_document_schema,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_document_schema: gapic_v1.method_async.wrap_method(
            ...
            self.delete_document_schema: gapic_v1.method_async.wrap_method(
                self.delete_document_schema,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_document_schemas: gapic_v1.method_async.wrap_method(

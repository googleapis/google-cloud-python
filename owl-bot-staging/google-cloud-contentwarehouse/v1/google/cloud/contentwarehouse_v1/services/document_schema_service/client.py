...
class DocumentSchemaServiceClient(metaclass=DocumentSchemaServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, DocumentSchemaServiceTransport):
    ...
    def create_document_schema(self,
            request: Union[document_schema_service.CreateDocumentSchemaRequest, dict] = None,
            *,
            parent: str = None,
        ...
        # in a document_schema_service.CreateDocumentSchemaRequest.
    ...
    def update_document_schema(self,
            request: Union[document_schema_service.UpdateDocumentSchemaRequest, dict] = None,
            *,
            name: str = None,
            document_schema: gcc_document_schema.DocumentSchema = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a document_schema_service.UpdateDocumentSchemaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_document_schema(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a document_schema_service.GetDocumentSchemaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_document_schema(self,
            request: Union[document_schema_service.DeleteDocumentSchemaRequest, dict] = None,
            *,
            name: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a document_schema_service.DeleteDocumentSchemaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_document_schemas(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a document_schema_service.ListDocumentSchemasRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

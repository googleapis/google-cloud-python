...
class RuleSetServiceGrpcAsyncIOTransport(RuleSetServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_rule_set: gapic_v1.method_async.wrap_method(
                self.create_rule_set,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_rule_set: gapic_v1.method_async.wrap_method(
                self.get_rule_set,
            ...
            self.update_rule_set: gapic_v1.method_async.wrap_method(
                self.update_rule_set,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_rule_set: gapic_v1.method_async.wrap_method(
                self.delete_rule_set,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_rule_sets: gapic_v1.method_async.wrap_method(
                self.list_rule_sets,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,

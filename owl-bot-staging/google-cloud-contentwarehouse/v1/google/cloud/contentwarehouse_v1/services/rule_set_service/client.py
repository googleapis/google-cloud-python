...
class RuleSetServiceClient(metaclass=RuleSetServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, RuleSetServiceTransport):
    ...
    def create_rule_set(self,
        ...
        # in a ruleset_service_request.CreateRuleSetRequest.
    ...
    def get_rule_set(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a ruleset_service_request.GetRuleSetRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_rule_set(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a ruleset_service_request.UpdateRuleSetRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_rule_set(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a ruleset_service_request.DeleteRuleSetRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_rule_sets(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a ruleset_service_request.ListRuleSetsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

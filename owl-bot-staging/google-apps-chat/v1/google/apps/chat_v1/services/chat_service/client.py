...
from google.apps.chat_v1.types import deletion_metadata
from google.apps.chat_v1.types import event_payload
from google.apps.chat_v1.types import group
from google.apps.chat_v1.types import history_state
from google.apps.chat_v1.types import matched_url
...
from .transports.base import ChatServiceTransport, DEFAULT_CLIENT_INFO
...
class ChatServiceClient(metaclass=ChatServiceClientMeta):
    ...
    @staticmethod
    def attachment_path(space: str,message: str,attachment: str,) -> str:
        """Returns a fully-qualified attachment string."""
        return "spaces/{space}/messages/{message}/attachments/{attachment}".format(space=space, message=message, attachment=attachment, )

    @staticmethod
    def parse_attachment_path(path: str) -> Dict[str,str]:
        """Parses a attachment path into its component segments."""
        m = re.match(r"^spaces/(?P<space>.+?)/messages/(?P<message>.+?)/attachments/(?P<attachment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def custom_emoji_path(custom_emoji: str,) -> str:
        """Returns a fully-qualified custom_emoji string."""
        return "customEmojis/{custom_emoji}".format(custom_emoji=custom_emoji, )
    ...
    @staticmethod
    def membership_path(space: str,member: str,) -> str:
        """Returns a fully-qualified membership string."""
        return "spaces/{space}/members/{member}".format(space=space, member=member, )
    ...
    @staticmethod
    def message_path(space: str,message: str,) -> str:
        """Returns a fully-qualified message string."""
        return "spaces/{space}/messages/{message}".format(space=space, message=message, )
    ...
    @staticmethod
    def quoted_message_metadata_path(space: str,message: str,quoted_message_metadata: str,) -> str:
        """Returns a fully-qualified quoted_message_metadata string."""
        return "spaces/{space}/messages/{message}/quotedMessageMetadata/{quoted_message_metadata}".format(space=space, message=message, quoted_message_metadata=quoted_message_metadata, )
    ...
    def parse_quoted_message_metadata_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^spaces/(?P<space>.+?)/messages/(?P<message>.+?)/quotedMessageMetadata/(?P<quoted_message_metadata>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def reaction_path(space: str,message: str,reaction: str,) -> str:
        """Returns a fully-qualified reaction string."""
        return "spaces/{space}/messages/{message}/reactions/{reaction}".format(space=space, message=message, reaction=reaction, )

    @staticmethod
    def parse_reaction_path(path: str) -> Dict[str,str]:
        """Parses a reaction path into its component segments."""
        m = re.match(r"^spaces/(?P<space>.+?)/messages/(?P<message>.+?)/reactions/(?P<reaction>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def space_event_path(space: str,space_event: str,) -> str:
        """Returns a fully-qualified space_event string."""
        return "spaces/{space}/spaceEvents/{space_event}".format(space=space, space_event=space_event, )
    ...
    @staticmethod
    def space_notification_setting_path(user: str,space: str,) -> str:
        """Returns a fully-qualified space_notification_setting string."""
        return "users/{user}/spaces/{space}/spaceNotificationSetting".format(user=user, space=space, )
    ...
    def parse_space_notification_setting_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^users/(?P<user>.+?)/spaces/(?P<space>.+?)/spaceNotificationSetting$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def space_read_state_path(user: str,space: str,) -> str:
        """Returns a fully-qualified space_read_state string."""
        return "users/{user}/spaces/{space}/spaceReadState".format(user=user, space=space, )

    @staticmethod
    def parse_space_read_state_path(path: str) -> Dict[str,str]:
        """Parses a space_read_state path into its component segments."""
        m = re.match(r"^users/(?P<user>.+?)/spaces/(?P<space>.+?)/spaceReadState$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def thread_path(space: str,thread: str,) -> str:
        """Returns a fully-qualified thread string."""
        return "spaces/{space}/threads/{thread}".format(space=space, thread=thread, )
    ...
    @staticmethod
    def thread_read_state_path(user: str,space: str,thread: str,) -> str:
        """Returns a fully-qualified thread_read_state string."""
        return "users/{user}/spaces/{space}/threads/{thread}/threadReadState".format(user=user, space=space, thread=thread, )

    @staticmethod
    def parse_thread_read_state_path(path: str) -> Dict[str,str]:
        """Parses a thread_read_state path into its component segments."""
        m = re.match(r"^users/(?P<user>.+?)/spaces/(?P<space>.+?)/threads/(?P<thread>.+?)/threadReadState$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ChatServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ChatServiceTransport, Callable[..., ChatServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ChatServiceClient._read_environment_variables()
        self._client_cert_source = ChatServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ChatServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ChatServiceTransport], Callable[..., ChatServiceTransport]] = (
    ...
    def complete_import_space(self,
    ...
    def get_space_read_state(self,
            request: Optional[Union[space_read_state.GetSpaceReadStateRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def update_space_read_state(self,
            request: Optional[Union[gc_space_read_state.UpdateSpaceReadStateRequest, dict]] = None,
            *,
    ...
    def get_thread_read_state(self,
            request: Optional[Union[thread_read_state.GetThreadReadStateRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_space_notification_setting(self,
            request: Optional[Union[space_notification_setting.GetSpaceNotificationSettingRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, space_notification_setting.GetSpaceNotificationSettingRequest):
            request = space_notification_setting.GetSpaceNotificationSettingRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_space_notification_setting]
    ...
    def update_space_notification_setting(self,
            request: Optional[Union[gc_space_notification_setting.UpdateSpaceNotificationSettingRequest, dict]] = None,
            *,
            space_notification_setting: Optional[gc_space_notification_setting.SpaceNotificationSetting] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gc_space_notification_setting.UpdateSpaceNotificationSettingRequest):
            request = gc_space_notification_setting.UpdateSpaceNotificationSettingRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_space_notification_setting]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("space_notification_setting.name", request.space_notification_setting.name),
            )),
        )

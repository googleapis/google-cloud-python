...
class ChatServiceGrpcAsyncIOTransport(ChatServiceTransport):
    ...
    @property
    def search_spaces(self) -> Callable[
            [space.SearchSpacesRequest],
            Awaitable[space.SearchSpacesResponse]]:
    ...
    @property
    def create_custom_emoji(self) -> Callable[
            [reaction.CreateCustomEmojiRequest],
            Awaitable[reaction.CustomEmoji]]:
    ...
    @property
    def get_custom_emoji(self) -> Callable[
    ...
    @property
    def list_custom_emojis(self) -> Callable[
    ...
    @property
    def delete_custom_emoji(self) -> Callable[
    ...
    @property
    def get_space_read_state(self) -> Callable[
    ...
    @property
    def update_space_read_state(self) -> Callable[
    ...
    @property
    def get_thread_read_state(self) -> Callable[
    ...
    @property
    def get_space_event(self) -> Callable[
            [space_event.GetSpaceEventRequest],
            Awaitable[space_event.SpaceEvent]]:
    ...
    @property
    def list_space_events(self) -> Callable[
    ...
    @property
    def get_space_notification_setting(self) -> Callable[
    ...
    @property
    def update_space_notification_setting(self) -> Callable[

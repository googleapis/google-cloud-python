...
def test_search_spaces_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = space.SearchSpacesResponse.to_json(space.SearchSpacesResponse())
...
def test_search_spaces_rest_bad_request(transport: str = 'rest', request_type=space.SearchSpacesRequest):
    client = ChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_membership_rest_bad_request(transport: str = 'rest', request_type=gc_membership.UpdateMembershipRequest):
    client = ChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_space_read_state_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = space_read_state.SpaceReadState.to_json(space_read_state.SpaceReadState())
...
def test_get_space_read_state_rest_bad_request(transport: str = 'rest', request_type=space_read_state.GetSpaceReadStateRequest):
    client = ChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_space_read_state_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gc_space_read_state.SpaceReadState.to_json(gc_space_read_state.SpaceReadState())
...
def test_update_space_read_state_rest_bad_request(transport: str = 'rest', request_type=gc_space_read_state.UpdateSpaceReadStateRequest):
    client = ChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_thread_read_state_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = thread_read_state.ThreadReadState.to_json(thread_read_state.ThreadReadState())
...
def test_get_thread_read_state_rest_bad_request(transport: str = 'rest', request_type=thread_read_state.GetThreadReadStateRequest):
    client = ChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_space_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = space_event.SpaceEvent.to_json(space_event.SpaceEvent())
...
def test_get_space_event_rest_bad_request(transport: str = 'rest', request_type=space_event.GetSpaceEventRequest):
    client = ChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_space_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = space_event.ListSpaceEventsResponse.to_json(space_event.ListSpaceEventsResponse())
...
def test_list_space_events_rest_bad_request(transport: str = 'rest', request_type=space_event.ListSpaceEventsRequest):
    client = ChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

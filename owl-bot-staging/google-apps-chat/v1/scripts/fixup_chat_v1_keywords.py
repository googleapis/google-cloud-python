...
class chatCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'list_space_events': ('parent', 'filter', 'page_size', 'page_token', ),
        'list_spaces': ('page_size', 'page_token', 'filter', ),
        'search_spaces': ('query', 'use_admin_access', 'page_size', 'page_token', 'order_by', ),
...
def fix_files(
    ...
    *,
    transformer=chatCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the chat client library.

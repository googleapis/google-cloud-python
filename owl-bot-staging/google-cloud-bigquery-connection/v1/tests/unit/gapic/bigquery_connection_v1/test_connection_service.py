...
def test_create_connection_rest_required_fields(request_type=gcbc_connection.CreateConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_connection._get_unset_required_fields(jsonified_request)
...
def test_create_connection_rest_unset_required_fields():
    transport = transports.ConnectionServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_connection_rest_required_fields(request_type=connection.GetConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_connections_rest_required_fields(request_type=connection.ListConnectionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_connections._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_connection_rest_required_fields(request_type=gcbc_connection.UpdateConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_connection_rest_required_fields(request_type=connection.DeleteConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

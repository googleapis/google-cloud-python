...
from .transports.base import MemorystoreTransport, DEFAULT_CLIENT_INFO
...
class MemorystoreClient(metaclass=MemorystoreClientMeta):
    ...
    @staticmethod
    def backup_path(project: str,location: str,backup_collection: str,backup: str,) -> str:
        """Returns a fully-qualified backup string."""
        return "projects/{project}/locations/{location}/backupCollections/{backup_collection}/backups/{backup}".format(project=project, location=location, backup_collection=backup_collection, backup=backup, )

    @staticmethod
    def parse_backup_path(path: str) -> Dict[str,str]:
        """Parses a backup path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupCollections/(?P<backup_collection>.+?)/backups/(?P<backup>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def backup_collection_path(project: str,location: str,backup_collection: str,) -> str:
        """Returns a fully-qualified backup_collection string."""
        return "projects/{project}/locations/{location}/backupCollections/{backup_collection}".format(project=project, location=location, backup_collection=backup_collection, )
    ...
    @staticmethod
    def certificate_authority_path(project: str,location: str,instance: str,) -> str:
        """Returns a fully-qualified certificate_authority string."""
        return "projects/{project}/locations/{location}/instances/{instance}/certificateAuthority".format(project=project, location=location, instance=instance, )
    ...
    @staticmethod
    def forwarding_rule_path(project: str,region: str,forwarding_rule: str,) -> str:
    ...
    @staticmethod
    def service_attachment_path(project: str,region: str,service_attachment: str,) -> str:
        """Returns a fully-qualified service_attachment string."""
        return "projects/{project}/regions/{region}/serviceAttachments/{service_attachment}".format(project=project, region=region, service_attachment=service_attachment, )
    ...
    def list_backup_collections(self,
    ...
    def get_backup_collection(self,

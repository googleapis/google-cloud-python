...
from google.cloud.memorystore_v1.services.memorystore import MemorystoreClient
from google.cloud.memorystore_v1.services.memorystore import pagers
from google.cloud.memorystore_v1.services.memorystore import transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert MemorystoreClient._read_environment_variables() == (True, "auto", None)
...
def test_memorystore_client_get_transport_class():
    transport = MemorystoreClient.get_transport_class()
    ...
    assert transport == transports.MemorystoreRestTransport
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (MemorystoreClient, transports.MemorystoreRestTransport, "rest", "true"),
...
def test_list_instances_rest_required_fields(request_type=memorystore.ListInstancesRequest):
    ...
    return_value = memorystore.ListInstancesResponse()
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = memorystore.ListInstancesResponse.pb(return_value)
...
def test_list_instances_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(memorystore.ListInstancesResponse.to_json(x) for x in response)
        ...
        assert all(isinstance(i, memorystore.Instance)
                for i in results)
...
def test_get_instance_rest_required_fields(request_type=memorystore.GetInstanceRequest):
    transport_class = transports.MemorystoreRestTransport
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = memorystore.Instance.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_update_instance_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("instance", )))
...
def test_get_certificate_authority_rest_required_fields(request_type=memorystore.GetCertificateAuthorityRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = memorystore.CertificateAuthority.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_reschedule_maintenance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            name='name_value',
            reschedule_type=memorystore.RescheduleMaintenanceRequest.RescheduleType.IMMEDIATE,
...
def test_list_backup_collections_rest_required_fields(request_type=memorystore.ListBackupCollectionsRequest):
    ...
    # Designate an appropriate value for the returned response.
    return_value = memorystore.ListBackupCollectionsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = memorystore.ListBackupCollectionsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_backup_collections_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, memorystore.BackupCollection)
                for i in results)
...
def test_get_backup_collection_rest_required_fields(request_type=memorystore.GetBackupCollectionRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = memorystore.BackupCollection.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_backups_rest_required_fields(request_type=memorystore.ListBackupsRequest):
    transport_class = transports.MemorystoreRestTransport
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = memorystore.ListBackupsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_backups_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(memorystore.ListBackupsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, memorystore.Backup)
                for i in results)
...
def test_get_backup_rest_required_fields(request_type=memorystore.GetBackupRequest):
    transport_class = transports.MemorystoreRestTransport
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = memorystore.Backup.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_backup_instance_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.backup_instance in client._transport._wrapped_methods
        ...
        request = {}
        client.backup_instance(request)
...
def test_backup_instance_rest_required_fields(request_type=memorystore.BackupInstanceRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            response = client.backup_instance(request)
...
def test_backup_instance_rest_flattened():
    client = MemorystoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.backup_instance(**mock_args)
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_list_instances") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_list_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_list_instances") as pre:
...
def test_get_instance_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        return_value = memorystore.Instance(
              name='name_value',
              state=memorystore.Instance.State.CREATING,
              uid='uid_value',
              replica_count=1384,
              authorization_mode=memorystore.Instance.AuthorizationMode.AUTH_DISABLED,
              transit_encryption_mode=memorystore.Instance.TransitEncryptionMode.TRANSIT_ENCRYPTION_DISABLED,
              shard_count=1178,
              node_type=memorystore.Instance.NodeType.SHARED_CORE_NANO,
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, memorystore.Instance)
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_get_instance") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_get_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_get_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = memorystore.Instance.to_json(memorystore.Instance())
        req.return_value.content = return_value
...
def test_create_instance_rest_call_success(request_type):
    ...
    test_field = memorystore.CreateInstanceRequest.meta.fields["instance"]
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_create_instance") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_create_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_create_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_instance_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = memorystore.UpdateInstanceRequest.meta.fields["instance"]
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_update_instance") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_update_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_update_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_delete_instance") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_delete_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_delete_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_certificate_authority_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_get_certificate_authority") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_get_certificate_authority_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_get_certificate_authority") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_reschedule_maintenance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_reschedule_maintenance") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_reschedule_maintenance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_reschedule_maintenance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_backup_collections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_list_backup_collections") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_list_backup_collections_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_list_backup_collections") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_backup_collection_rest_call_success(request_type):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, memorystore.BackupCollection)
    assert response.name == 'name_value'
...
def test_get_backup_collection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_get_backup_collection") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_get_backup_collection_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_get_backup_collection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        pre.return_value = request, metadata
        post.return_value = memorystore.BackupCollection()
        post_with_metadata.return_value = memorystore.BackupCollection(), metadata
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_list_backups") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_list_backups_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_list_backups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = memorystore.ListBackupsRequest.pb(memorystore.ListBackupsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        pre.return_value = request, metadata
        post.return_value = memorystore.ListBackupsResponse()
        post_with_metadata.return_value = memorystore.ListBackupsResponse(), metadata
...
def test_get_backup_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        return_value = memorystore.Backup(
              ...
              replica_count=1384,
              shard_count=1178,
              backup_type=memorystore.Backup.BackupType.ON_DEMAND,
              state=memorystore.Backup.State.CREATING,
              uid='uid_value',
        )
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, memorystore.Backup)
    assert response.name == 'name_value'
    assert response.instance == 'instance_value'
    assert response.instance_uid == 'instance_uid_value'
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_get_backup") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_get_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_get_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = memorystore.GetBackupRequest.pb(memorystore.GetBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = memorystore.Backup.to_json(memorystore.Backup())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = memorystore.Backup()
        post_with_metadata.return_value = memorystore.Backup(), metadata
...
def test_delete_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_delete_backup") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_delete_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_delete_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_export_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_export_backup") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_export_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_export_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_backup_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_backup_instance") as post, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "post_backup_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MemorystoreRestInterceptor, "pre_backup_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.backup_instance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_backup_instance_empty_call_rest():
    client = MemorystoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.backup_instance),
            '__call__') as call:
        client.backup_instance(request=None)
...
def test_memorystore_rest_lro_client():
    client = MemorystoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_memorystore_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.memorystore_v1.services.memorystore.transports.MemorystoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_memorystore_base_transport_with_adc():
    # Test the default credentials are used if credentials and credentials_file are None.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.memorystore_v1.services.memorystore.transports.MemorystoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MemorystoreTransport()
        adc.assert_called_once()
...
def test_memorystore_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = MemorystoreClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = MemorystoreClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_backup_path():
    ...
    actual = MemorystoreClient.backup_path(project, location, backup_collection, backup)
...
def test_parse_backup_path():
    ...
    path = MemorystoreClient.backup_path(**expected)

    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_backup_path(path)
    assert expected == actual
...
def test_parse_backup_collection_path():
    ...
    path = MemorystoreClient.backup_collection_path(**expected)

    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_backup_collection_path(path)
    assert expected == actual
...
def test_certificate_authority_path():
    ...
    location = "octopus"
    instance = "oyster"
    expected = "projects/{project}/locations/{location}/instances/{instance}/certificateAuthority".format(project=project, location=location, instance=instance, )
    actual = MemorystoreClient.certificate_authority_path(project, location, instance)
    assert expected == actual
...
def test_parse_certificate_authority_path():
    ...
    path = MemorystoreClient.certificate_authority_path(**expected)

    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_certificate_authority_path(path)
    assert expected == actual
...
def test_crypto_key_path():
    ...
    actual = MemorystoreClient.crypto_key_path(project, location, key_ring, crypto_key)
    assert expected == actual
...
def test_parse_crypto_key_path():
    ...
    path = MemorystoreClient.crypto_key_path(**expected)

    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_crypto_key_path(path)
    assert expected == actual
...
def test_parse_forwarding_rule_path():
    ...
    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_forwarding_rule_path(path)
    assert expected == actual
...
def test_instance_path():
    ...
    actual = MemorystoreClient.instance_path(project, location, instance)
    assert expected == actual
...
def test_parse_instance_path():
    ...
    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_instance_path(path)
    assert expected == actual
...
def test_network_path():
    ...
    actual = MemorystoreClient.network_path(project, network)
    assert expected == actual
...
def test_parse_network_path():
    ...
    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_network_path(path)
    assert expected == actual
...
def test_parse_service_attachment_path():
    ...
    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_service_attachment_path(path)
    assert expected == actual

def test_common_billing_account_path():
    billing_account = "whelk"
    expected = "billingAccounts/{billing_account}".format(billing_account=billing_account, )
    actual = MemorystoreClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_common_billing_account_path(path)
    assert expected == actual

def test_common_folder_path():
    folder = "oyster"
    expected = "folders/{folder}".format(folder=folder, )
    actual = MemorystoreClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_common_folder_path(path)
    assert expected == actual

def test_common_organization_path():
    organization = "cuttlefish"
    expected = "organizations/{organization}".format(organization=organization, )
    actual = MemorystoreClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_common_organization_path(path)
    assert expected == actual

def test_common_project_path():
    project = "winkle"
    expected = "projects/{project}".format(project=project, )
    actual = MemorystoreClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = MemorystoreClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = MemorystoreClient.parse_common_location_path(path)
    assert expected == actual
...
@pytest.mark.parametrize("client_class,transport_class", [
    (MemorystoreClient, transports.MemorystoreRestTransport),
])

...
class MemorystoreRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_instance(self, request: memorystore.CreateInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[memorystore.CreateInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_instance(self, request: memorystore.DeleteInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[memorystore.DeleteInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_certificate_authority(self, request: memorystore.GetCertificateAuthorityRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[memorystore.GetCertificateAuthorityRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_instance(self, request: memorystore.GetInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[memorystore.GetInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_instances(self, request: memorystore.ListInstancesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[memorystore.ListInstancesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_instance(self, request: memorystore.UpdateInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[memorystore.UpdateInstanceRequest, Sequence[Tuple[str, str]]]:

...
from google.cloud.memorystore_v1beta.services.memorystore import MemorystoreClient
from google.cloud.memorystore_v1beta.services.memorystore import pagers
from google.cloud.memorystore_v1beta.services.memorystore import transports
...
def test_get_certificate_authority_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/instances/*}/certificateAuthority" % client.transport._host, args[1])
...
def test_memorystore_base_transport():
    ...
    with mock.patch('google.cloud.memorystore_v1beta.services.memorystore.transports.MemorystoreTransport.__init__') as Transport:
...
def test_memorystore_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.memorystore_v1beta.services.memorystore.transports.MemorystoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_memorystore_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.memorystore_v1beta.services.memorystore.transports.MemorystoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MemorystoreTransport()
        adc.assert_called_once()

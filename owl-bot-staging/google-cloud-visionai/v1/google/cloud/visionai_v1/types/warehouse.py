...
class ListAnnotationsRequest(proto.Message):
    ...
    Attributes:
        ...
        filter (str):
            ...
            corpus of IMAGE type, only ``key`` is supported. Timestamps
            are specified in the RFC-3339 format, and only one
            restriction may be applied per field, joined by
            conjunctions. Format:
            "partition.temporal_partition.start_time >
...
class SchemaKeySortingStrategy(proto.Message):
    ...
    class Option(proto.Message):
        ...
        aggregate_method: 'SchemaKeySortingStrategy.Option.AggregateMethod' = proto.Field(
            proto.ENUM,
            number=3,
            optional=True,

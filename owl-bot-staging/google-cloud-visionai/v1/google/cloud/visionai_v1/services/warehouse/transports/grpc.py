...
class WarehouseGrpcTransport(WarehouseTransport):
    ...
    @property
    def create_asset(self) -> Callable[
    ...
    @property
    def update_asset(self) -> Callable[
    ...
    @property
    def delete_asset(self) -> Callable[
    ...
    @property
    def upload_asset(self) -> Callable[
    ...
    @property
    def generate_retrieval_url(self) -> Callable[
    ...
    @property
    def analyze_asset(self) -> Callable[
    ...
    @property
    def create_corpus(self) -> Callable[
    ...
    @property
    def update_corpus(self) -> Callable[
    ...
    @property
    def list_corpora(self) -> Callable[
    ...
    @property
    def analyze_corpus(self) -> Callable[
    ...
    @property
    def create_data_schema(self) -> Callable[
    ...
    @property
    def update_data_schema(self) -> Callable[
    ...
    @property
    def get_data_schema(self) -> Callable[
    ...
    @property
    def delete_data_schema(self) -> Callable[
    ...
    @property
    def list_data_schemas(self) -> Callable[
    ...
    @property
    def create_annotation(self) -> Callable[
    ...
    @property
    def get_annotation(self) -> Callable[
    ...
    @property
    def update_annotation(self) -> Callable[
    ...
    @property
    def delete_annotation(self) -> Callable[
    ...
    @property
    def ingest_asset(self) -> Callable[
    ...
    @property
    def generate_hls_uri(self) -> Callable[
    ...
    @property
    def import_assets(self) -> Callable[
    ...
    @property
    def create_search_config(self) -> Callable[
    ...
    @property
    def update_search_config(self) -> Callable[
    ...
    @property
    def get_search_config(self) -> Callable[
    ...
    @property
    def delete_search_config(self) -> Callable[
    ...
    @property
    def list_search_configs(self) -> Callable[
    ...
    @property
    def create_search_hypernym(self) -> Callable[
    ...
    @property
    def update_search_hypernym(self) -> Callable[
    ...
    @property
    def get_search_hypernym(self) -> Callable[
    ...
    @property
    def delete_search_hypernym(self) -> Callable[
    ...
    @property
    def list_search_hypernyms(self) -> Callable[
    ...
    @property
    def search_index_endpoint(self) -> Callable[
    ...
    @property
    def update_collection(self) -> Callable[
    ...
    @property
    def add_collection_item(self) -> Callable[
    ...
    @property
    def remove_collection_item(self) -> Callable[
    ...
    @property
    def view_collection_items(self) -> Callable[

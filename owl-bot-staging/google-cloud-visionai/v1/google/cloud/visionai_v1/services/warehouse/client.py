...
class WarehouseClient(metaclass=WarehouseClientMeta):
    ...
    @staticmethod
    def annotation_path(project_number: str,location: str,corpus: str,asset: str,annotation: str,) -> str:
        """Returns a fully-qualified annotation string."""
        return "projects/{project_number}/locations/{location}/corpora/{corpus}/assets/{asset}/annotations/{annotation}".format(project_number=project_number, location=location, corpus=corpus, asset=asset, annotation=annotation, )

    @staticmethod
    def parse_annotation_path(path: str) -> Dict[str,str]:
        """Parses a annotation path into its component segments."""
        m = re.match(r"^projects/(?P<project_number>.+?)/locations/(?P<location>.+?)/corpora/(?P<corpus>.+?)/assets/(?P<asset>.+?)/annotations/(?P<annotation>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def asset_path(project_number: str,location: str,corpus: str,asset: str,) -> str:
        """Returns a fully-qualified asset string."""
        return "projects/{project_number}/locations/{location}/corpora/{corpus}/assets/{asset}".format(project_number=project_number, location=location, corpus=corpus, asset=asset, )
    ...
    @staticmethod
    def collection_path(project_number: str,location: str,corpus: str,collection: str,) -> str:
        """Returns a fully-qualified collection string."""
        return "projects/{project_number}/locations/{location}/corpora/{corpus}/collections/{collection}".format(project_number=project_number, location=location, corpus=corpus, collection=collection, )
    ...
    @staticmethod
    def corpus_path(project_number: str,location: str,corpus: str,) -> str:
        """Returns a fully-qualified corpus string."""
        return "projects/{project_number}/locations/{location}/corpora/{corpus}".format(project_number=project_number, location=location, corpus=corpus, )
    ...
    @staticmethod
    def data_schema_path(project_number: str,location: str,corpus: str,data_schema: str,) -> str:
        """Returns a fully-qualified data_schema string."""
        return "projects/{project_number}/locations/{location}/corpora/{corpus}/dataSchemas/{data_schema}".format(project_number=project_number, location=location, corpus=corpus, data_schema=data_schema, )
    ...
    @staticmethod
    def index_path(project_number: str,location: str,corpus: str,index: str,) -> str:
        """Returns a fully-qualified index string."""
        return "projects/{project_number}/locations/{location}/corpora/{corpus}/indexes/{index}".format(project_number=project_number, location=location, corpus=corpus, index=index, )
    ...
    @staticmethod
    def search_config_path(project_number: str,location: str,corpus: str,search_config: str,) -> str:
        """Returns a fully-qualified search_config string."""
        return "projects/{project_number}/locations/{location}/corpora/{corpus}/searchConfigs/{search_config}".format(project_number=project_number, location=location, corpus=corpus, search_config=search_config, )

    @staticmethod
    def parse_search_config_path(path: str) -> Dict[str,str]:
        """Parses a search_config path into its component segments."""
        m = re.match(r"^projects/(?P<project_number>.+?)/locations/(?P<location>.+?)/corpora/(?P<corpus>.+?)/searchConfigs/(?P<search_config>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def search_hypernym_path(project_number: str,location: str,corpus: str,search_hypernym: str,) -> str:
        """Returns a fully-qualified search_hypernym string."""
        return "projects/{project_number}/locations/{location}/corpora/{corpus}/searchHypernyms/{search_hypernym}".format(project_number=project_number, location=location, corpus=corpus, search_hypernym=search_hypernym, )

    @staticmethod
    def parse_search_hypernym_path(path: str) -> Dict[str,str]:
        """Parses a search_hypernym path into its component segments."""
        m = re.match(r"^projects/(?P<project_number>.+?)/locations/(?P<location>.+?)/corpora/(?P<corpus>.+?)/searchHypernyms/(?P<search_hypernym>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            WarehouseClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def create_search_hypernym(self,
    ...
    def update_search_hypernym(self,
    ...
    def delete_search_hypernym(self,
    ...
    def list_search_hypernyms(self,
    ...
    def search_index_endpoint(self,
    ...
    def view_collection_items(self,

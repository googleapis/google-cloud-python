...
from google.cloud.visionai_v1.types import streams_resources
from google.cloud.visionai_v1.types import streams_service
...
class StreamsServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.get_stream_thumbnail: gapic_v1.method.wrap_method(
    ...
    def get_stream(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[streams_resources.Stream]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def get_stream_thumbnail(self) -> Callable[
    ...
    @property
    def generate_stream_hls_token(self) -> Callable[
    ...
    def get_event(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[streams_resources.Event]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def update_event(self) -> Callable[
    ...
    @property
    def get_series(self) -> Callable[
            [streams_service.GetSeriesRequest],
            Union[
                streams_resources.Series,
                Awaitable[streams_resources.Series]
            ]]:
        raise NotImplementedError()

    @property
    def create_series(self) -> Callable[
    ...
    @property
    def update_series(self) -> Callable[
    ...
    @property
    def delete_series(self) -> Callable[
    ...
    @property
    def materialize_channel(self) -> Callable[

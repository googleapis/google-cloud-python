...
class StreamingServiceTransport(abc.ABC):
    """Abstract transport class for StreamingService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.send_packets: gapic_v1.method.wrap_method(
                self.send_packets,
                default_timeout=None,
                client_info=client_info,
            ),
            self.receive_packets: gapic_v1.method.wrap_method(
                self.receive_packets,
                default_timeout=None,
                client_info=client_info,
            ),
            self.receive_events: gapic_v1.method.wrap_method(
                self.receive_events,
                default_timeout=None,
                client_info=client_info,
            ),
            self.acquire_lease: gapic_v1.method.wrap_method(
                self.acquire_lease,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.release_lease: gapic_v1.method.wrap_method(
                self.release_lease,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    @property
    def send_packets(self) -> Callable[
    ...
    @property
    def receive_packets(self) -> Callable[
    ...
    @property
    def receive_events(self) -> Callable[
    ...
    @property
    def acquire_lease(self) -> Callable[
            [streaming_service.AcquireLeaseRequest],
            Union[
                streaming_service.Lease,
                Awaitable[streaming_service.Lease]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def release_lease(self) -> Callable[

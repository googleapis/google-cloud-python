...
class LiveVideoAnalyticsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_list_public_operators(self, request: lva_service.ListPublicOperatorsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[lva_service.ListPublicOperatorsRequest, Sequence[Tuple[str, str]]]:

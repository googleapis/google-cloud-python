...
class LiveVideoAnalyticsTransport(abc.ABC):
    ...
    @property
    def list_public_operators(self) -> Callable[
    ...
    @property
    def resolve_operator_info(self) -> Callable[
    ...
    @property
    def list_operators(self) -> Callable[
    ...
    def get_operator(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[lva_resources.Operator]
            ]]:
        raise NotImplementedError()

    @property
    def create_operator(self) -> Callable[
    ...
    @property
    def update_operator(self) -> Callable[
    ...
    @property
    def delete_operator(self) -> Callable[
    ...
    def get_process(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[lva_resources.Process]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def batch_run_process(self) -> Callable[

...
from google.cloud.visionai_v1.types import lva_service
...
from .transports.base import LiveVideoAnalyticsTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import LiveVideoAnalyticsGrpcTransport
from .transports.grpc_asyncio import LiveVideoAnalyticsGrpcAsyncIOTransport
from .transports.rest import LiveVideoAnalyticsRestTransport


class LiveVideoAnalyticsClientMeta(type):
    """Metaclass for the LiveVideoAnalytics client.
...
class LiveVideoAnalyticsClient(metaclass=LiveVideoAnalyticsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            LiveVideoAnalyticsClient: The constructed client.
        """
    ...
    def transport(self) -> LiveVideoAnalyticsTransport:
        ...
        Returns:
            LiveVideoAnalyticsTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def analysis_path(project: str,location: str,cluster: str,analysis: str,) -> str:
        """Returns a fully-qualified analysis string."""
        return "projects/{project}/locations/{location}/clusters/{cluster}/analyses/{analysis}".format(project=project, location=location, cluster=cluster, analysis=analysis, )

    @staticmethod
    def parse_analysis_path(path: str) -> Dict[str,str]:
        """Parses a analysis path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/analyses/(?P<analysis>.+?)$", path)
    ...
    @staticmethod
    def operator_path(project: str,location: str,operator: str,) -> str:
        """Returns a fully-qualified operator string."""
        return "projects/{project}/locations/{location}/operators/{operator}".format(project=project, location=location, operator=operator, )

    @staticmethod
    def parse_operator_path(path: str) -> Dict[str,str]:
        """Parses a operator path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/operators/(?P<operator>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def process_path(project: str,location: str,cluster: str,process: str,) -> str:
        """Returns a fully-qualified process string."""
        return "projects/{project}/locations/{location}/clusters/{cluster}/processes/{process}".format(project=project, location=location, cluster=cluster, process=process, )

    @staticmethod
    def parse_process_path(path: str) -> Dict[str,str]:
        """Parses a process path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/processes/(?P<process>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = LiveVideoAnalyticsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = LiveVideoAnalyticsClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, LiveVideoAnalyticsTransport, Callable[..., LiveVideoAnalyticsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = LiveVideoAnalyticsClient._read_environment_variables()
        self._client_cert_source = LiveVideoAnalyticsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = LiveVideoAnalyticsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, LiveVideoAnalyticsTransport)
        if transport_provided:
            # transport is a LiveVideoAnalyticsTransport instance.
            ...
            self._transport = cast(LiveVideoAnalyticsTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[LiveVideoAnalyticsTransport], Callable[..., LiveVideoAnalyticsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.visionai_v1.LiveVideoAnalyticsClient`.",
                    extra = {
    ...
    def list_public_operators(self,
            ...
            *,
            ...
            ) -> pagers.ListPublicOperatorsPager:
        ...
        .. code-block:: python
            ...
            def sample_list_public_operators():
                # Create a client
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.ListPublicOperatorsRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_public_operators]
        ...
        response = pagers.ListPublicOperatorsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def resolve_operator_info(self,
        ...
        .. code-block:: python
            ...
            def sample_resolve_operator_info():
                # Create a client
                client = visionai_v1.LiveVideoAnalyticsClient()
                ...
                # Make the request
                response = client.resolve_operator_info(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.visionai_v1.types.ResolveOperatorInfoRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, queries]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.resolve_operator_info]
    ...
    def list_operators(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.ListOperatorsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_operators]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListOperatorsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_operator(self,
        ...
        .. code-block:: python
            ...
            def sample_get_operator():
                ...
                # Make the request
                response = client.get_operator(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.visionai_v1.types.GetOperatorRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_operator]
    ...
    def create_operator(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.CreateOperatorRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, operator, operator_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_operator]
    ...
    def update_operator(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.UpdateOperatorRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [operator, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_operator]
    ...
    def delete_operator(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.DeleteOperatorRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_operator]
    ...
    def list_analyses(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.ListAnalysesRequest, dict]):
                The request object. Message for requesting list of
                Analyses
            parent (str):
                Required. Parent value for
    ...
    def get_analysis(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.GetAnalysisRequest, dict]):
    ...
    def create_analysis(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.CreateAnalysisRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, analysis, analysis_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_analysis(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.UpdateAnalysisRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [analysis, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_analysis]
    ...
    def delete_analysis(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.DeleteAnalysisRequest, dict]):
    ...
    def list_processes(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.ListProcessesRequest, dict]):
                The request object. Message for requesting list of
                Processes.
            parent (str):
                Required. Parent value for
    ...
    def get_process(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.GetProcessRequest, dict]):
    ...
    def create_process(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.CreateProcessRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, process, process_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_process(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.UpdateProcessRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [process, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def delete_process(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.DeleteProcessRequest, dict]):
    ...
    def batch_run_process(self,
        ...
        Args:
            request (Union[google.cloud.visionai_v1.types.BatchRunProcessRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_run_process]
    ...
    def __enter__(self) -> "LiveVideoAnalyticsClient":
        return self

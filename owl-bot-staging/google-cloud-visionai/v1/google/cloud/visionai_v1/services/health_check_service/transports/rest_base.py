...
class _BaseHealthCheckServiceRestTransport(HealthCheckServiceTransport):
    """Base REST backend transport for HealthCheckService.
...
__all__=(
    '_BaseHealthCheckServiceRestTransport',
)

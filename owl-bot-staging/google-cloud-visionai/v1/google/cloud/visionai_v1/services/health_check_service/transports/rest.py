...
class HealthCheckServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_health_check(self, request: health_service.HealthCheckRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[health_service.HealthCheckRequest, Sequence[Tuple[str, str]]]:

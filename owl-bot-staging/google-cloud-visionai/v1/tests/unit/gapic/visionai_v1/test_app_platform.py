...
from google.cloud.visionai_v1.services.app_platform import AppPlatformAsyncClient
from google.cloud.visionai_v1.services.app_platform import AppPlatformClient
from google.cloud.visionai_v1.services.app_platform import pagers
from google.cloud.visionai_v1.services.app_platform import transports
from google.cloud.visionai_v1.types import annotations
...
def test_app_platform_client_client_options_from_dict():
    with mock.patch('google.cloud.visionai_v1.services.app_platform.transports.AppPlatformGrpcTransport.__init__') as grpc_transport:
...
def test_app_platform_base_transport():
    ...
    with mock.patch('google.cloud.visionai_v1.services.app_platform.transports.AppPlatformTransport.__init__') as Transport:
...
def test_app_platform_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.visionai_v1.services.app_platform.transports.AppPlatformTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_app_platform_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.visionai_v1.services.app_platform.transports.AppPlatformTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AppPlatformTransport()
        adc.assert_called_once()

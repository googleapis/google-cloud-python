...
from google.cloud.visionai_v1.services.live_video_analytics import LiveVideoAnalyticsAsyncClient
from google.cloud.visionai_v1.services.live_video_analytics import LiveVideoAnalyticsClient
from google.cloud.visionai_v1.services.live_video_analytics import pagers
from google.cloud.visionai_v1.services.live_video_analytics import transports
...
def test__get_api_endpoint():
    ...
    assert LiveVideoAnalyticsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == LiveVideoAnalyticsClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert LiveVideoAnalyticsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == LiveVideoAnalyticsClient.DEFAULT_MTLS_ENDPOINT
...
async def test_list_public_operators_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_public_operators(request={},)
...
def test_list_public_operators_rest_required_fields(request_type=lva_service.ListPublicOperatorsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_public_operators._get_unset_required_fields(jsonified_request)
...
def test_list_public_operators_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_list_public_operators") as post, \
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_list_public_operators_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "pre_list_public_operators") as pre:
        ...
        client.list_public_operators(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_resolve_operator_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_resolve_operator_info_with_metadata") as post_with_metadata, \
...
def test_list_operators_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_list_operators_with_metadata") as post_with_metadata, \
...
def test_get_operator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_get_operator_with_metadata") as post_with_metadata, \
...
def test_create_operator_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["operator"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'operator_definition': {'operator': 'operator_value', 'input_args': [{'argument': 'argument_value', 'type_': 'type__value'}], 'output_args': {}, 'attributes': [{'attribute': 'attribute_value', 'type_': 'type__value', 'default_value': {'i': 105, 'f': 0.10200000000000001, 'b': True, 's': b's_blob'}}], 'resources': {'cpu': 'cpu_value', 'cpu_limits': 'cpu_limits_value', 'memory': 'memory_value', 'memory_limits': 'memory_limits_value', 'gpus': 447, 'latency_budget_ms': 1801}, 'short_description': 'short_description_value', 'description': 'description_value'}, 'docker_image': 'docker_image_value'}
...
def test_create_operator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_create_operator_with_metadata") as post_with_metadata, \
...
def test_update_operator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_update_operator_with_metadata") as post_with_metadata, \
...
def test_delete_operator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_delete_operator_with_metadata") as post_with_metadata, \
...
def test_list_analyses_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_list_analyses_with_metadata") as post_with_metadata, \
...
def test_get_analysis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_get_analysis_with_metadata") as post_with_metadata, \
...
def test_create_analysis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_create_analysis_with_metadata") as post_with_metadata, \
...
def test_update_analysis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_update_analysis_with_metadata") as post_with_metadata, \
...
def test_delete_analysis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_delete_analysis_with_metadata") as post_with_metadata, \
...
def test_list_processes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_list_processes_with_metadata") as post_with_metadata, \
...
def test_get_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_get_process_with_metadata") as post_with_metadata, \
...
def test_create_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_create_process_with_metadata") as post_with_metadata, \
...
def test_update_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_update_process_with_metadata") as post_with_metadata, \
...
def test_delete_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_delete_process_with_metadata") as post_with_metadata, \
...
def test_batch_run_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_batch_run_process_with_metadata") as post_with_metadata, \
...
def test_live_video_analytics_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.visionai_v1.services.live_video_analytics.transports.LiveVideoAnalyticsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_live_video_analytics_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.visionai_v1.services.live_video_analytics.transports.LiveVideoAnalyticsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.LiveVideoAnalyticsTransport()
        adc.assert_called_once()

...
from .transports.base import AppPlatformTransport, DEFAULT_CLIENT_INFO
from .transports.grpc_asyncio import AppPlatformGrpcAsyncIOTransport
from .client import AppPlatformClient
...
class AppPlatformAsyncClient:
    """Service describing handlers for resources"""

    _client: AppPlatformClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = AppPlatformClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = AppPlatformClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = AppPlatformClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = AppPlatformClient._DEFAULT_UNIVERSE

    application_path = staticmethod(AppPlatformClient.application_path)
    parse_application_path = staticmethod(AppPlatformClient.parse_application_path)
    draft_path = staticmethod(AppPlatformClient.draft_path)
    parse_draft_path = staticmethod(AppPlatformClient.parse_draft_path)
    instance_path = staticmethod(AppPlatformClient.instance_path)
    parse_instance_path = staticmethod(AppPlatformClient.parse_instance_path)
    processor_path = staticmethod(AppPlatformClient.processor_path)
    parse_processor_path = staticmethod(AppPlatformClient.parse_processor_path)
    stream_path = staticmethod(AppPlatformClient.stream_path)
    parse_stream_path = staticmethod(AppPlatformClient.parse_stream_path)
    common_billing_account_path = staticmethod(AppPlatformClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(AppPlatformClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(AppPlatformClient.common_folder_path)
    parse_common_folder_path = staticmethod(AppPlatformClient.parse_common_folder_path)
    common_organization_path = staticmethod(AppPlatformClient.common_organization_path)
    parse_common_organization_path = staticmethod(AppPlatformClient.parse_common_organization_path)
    common_project_path = staticmethod(AppPlatformClient.common_project_path)
    parse_common_project_path = staticmethod(AppPlatformClient.parse_common_project_path)
    common_location_path = staticmethod(AppPlatformClient.common_location_path)
    parse_common_location_path = staticmethod(AppPlatformClient.parse_common_location_path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return AppPlatformClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> AppPlatformTransport:
        ...
        Returns:
            AppPlatformTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = AppPlatformClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, AppPlatformTransport, Callable[..., AppPlatformTransport]]] = "grpc_asyncio",
        ...
        """
        self._client = AppPlatformClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.visionai_v1alpha1.AppPlatformAsyncClient`.",
                extra = {
    ...
    async def list_applications(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.ListApplicationsRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_applications]
    ...
    async def get_application(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.GetApplicationRequest, dict]]):
        ...
        Returns:
            google.cloud.visionai_v1alpha1.types.Application:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_application]
    ...
    async def create_application(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.CreateApplicationRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            application (:class:`google.cloud.visionai_v1alpha1.types.Application`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.visionai_v1alpha1.types.Application`
                Message describing Application object
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, application]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_application]
    ...
    async def update_application(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.UpdateApplicationRequest, dict]]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [application, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_application]
    ...
    async def delete_application(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.DeleteApplicationRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_application]
    ...
    async def deploy_application(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.DeployApplicationRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.visionai_v1alpha1.types.DeployApplicationResponse` RPC Request Messages.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.deploy_application]
    ...
    async def undeploy_application(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.UndeployApplicationRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.visionai_v1alpha1.types.UndeployApplicationResponse`
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.undeploy_application]
    ...
    async def add_application_stream_input(self,
            request: Optional[Union[platform.AddApplicationStreamInputRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.AddApplicationStreamInputRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.visionai_v1alpha1.types.AddApplicationStreamInputResponse`
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.add_application_stream_input]
    ...
    async def remove_application_stream_input(self,
            request: Optional[Union[platform.RemoveApplicationStreamInputRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.RemoveApplicationStreamInputRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.visionai_v1alpha1.types.RemoveApplicationStreamInputResponse`
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.remove_application_stream_input]
    ...
    async def update_application_stream_input(self,
            request: Optional[Union[platform.UpdateApplicationStreamInputRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.UpdateApplicationStreamInputRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.visionai_v1alpha1.types.UpdateApplicationStreamInputResponse`
                Message for AddApplicationStreamInput Response.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_application_stream_input]
    ...
    async def list_instances(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.ListInstancesRequest, dict]]):
                The request object. Message for requesting list of
                Instances.
            parent (:class:`str`):
                Required. Parent value for
    ...
    async def get_instance(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.GetInstanceRequest, dict]]):
        ...
        Returns:
            google.cloud.visionai_v1alpha1.types.Instance:
    ...
    async def create_application_instances(self,
            request: Optional[Union[platform.CreateApplicationInstancesRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_create_application_instances():
                ...
                request = visionai_v1alpha1.CreateApplicationInstancesRequest(
                    name="name_value",
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.CreateApplicationInstancesRequest, dict]]):
                The request object. Message for adding stream input to an
                Application.
            name (:class:`str`):
                Required. the name of the application
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.visionai_v1alpha1.types.CreateApplicationInstancesResponse`
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_application_instances]
    ...
    async def delete_application_instances(self,
            request: Optional[Union[platform.DeleteApplicationInstancesRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.DeleteApplicationInstancesRequest, dict]]):
                The request object. Message for removing stream input
                from an Application.
            name (:class:`str`):
                Required. the name of the application
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.visionai_v1alpha1.types.Instance`
                Message describing Instance object
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_application_instances]
    ...
    async def update_application_instances(self,
            request: Optional[Union[platform.UpdateApplicationInstancesRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            application_instances: Optional[MutableSequence[platform.UpdateApplicationInstancesRequest.UpdateApplicationInstance]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation_async.AsyncOperation:
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.UpdateApplicationInstancesRequest, dict]]):
            ...
            name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            application_instances (:class:`MutableSequence[google.cloud.visionai_v1alpha1.types.UpdateApplicationInstancesRequest.UpdateApplicationInstance]`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.visionai_v1alpha1.types.UpdateApplicationInstancesResponse`
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [name, application_instances]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        if application_instances:
            request.application_instances.extend(application_instances)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_application_instances]
    ...
    async def list_drafts(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.ListDraftsRequest, dict]]):
                The request object. Message for requesting list of
                Drafts.
            parent (:class:`str`):
                Required. Parent value for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_drafts]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListDraftsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_draft(self,
        ...
        Returns:
            google.cloud.visionai_v1alpha1.types.Draft:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_draft]
    ...
    async def create_draft(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.CreateDraftRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            draft (:class:`google.cloud.visionai_v1alpha1.types.Draft`):
                Required. The resource being created.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.visionai_v1alpha1.types.Draft`
                Message describing Draft object
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, draft, draft_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_draft]
    ...
    async def update_draft(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.UpdateDraftRequest, dict]]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [draft, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_draft]
    ...
    async def delete_draft(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.DeleteDraftRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_draft]
    ...
    async def list_processors(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.ListProcessorsRequest, dict]]):
                The request object. Message for requesting list of
                Processors.
            parent (:class:`str`):
                Required. Parent value for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_processors]
    ...
    async def list_prebuilt_processors(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.ListPrebuiltProcessorsRequest, dict]]):
        ...
        Returns:
            google.cloud.visionai_v1alpha1.types.ListPrebuiltProcessorsResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_prebuilt_processors]
    ...
    async def get_processor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.GetProcessorRequest, dict]]):
        ...
        Returns:
            google.cloud.visionai_v1alpha1.types.Processor:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_processor]
    ...
    async def create_processor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.CreateProcessorRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            processor (:class:`google.cloud.visionai_v1alpha1.types.Processor`):
                Required. The resource being created.
                This corresponds to the ``processor`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            processor_id (:class:`str`):
                Required. Id of the requesting
                object.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.visionai_v1alpha1.types.Processor` Message describing Processor object.
                   Next ID: 18
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, processor, processor_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_processor]
    ...
    async def update_processor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.UpdateProcessorRequest, dict]]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [processor, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_processor]
    ...
    async def delete_processor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.DeleteProcessorRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_processor]
    ...
    async def __aenter__(self) -> "AppPlatformAsyncClient":
        return self

...
class AppPlatformRestTransport(_BaseAppPlatformRestTransport):
    ...
    class _GetLocation(_BaseAppPlatformRestTransport._BaseGetLocation, AppPlatformRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AppPlatformRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseAppPlatformRestTransport._BaseListLocations, AppPlatformRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AppPlatformRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseAppPlatformRestTransport._BaseGetIamPolicy, AppPlatformRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AppPlatformRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BaseAppPlatformRestTransport._BaseSetIamPolicy, AppPlatformRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AppPlatformRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseAppPlatformRestTransport._BaseTestIamPermissions, AppPlatformRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AppPlatformRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

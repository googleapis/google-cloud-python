...
class AppPlatformClient(metaclass=AppPlatformClientMeta):
    ...
    @staticmethod
    def application_path(project: str,location: str,application: str,) -> str:
        """Returns a fully-qualified application string."""
        return "projects/{project}/locations/{location}/applications/{application}".format(project=project, location=location, application=application, )
    ...
    @staticmethod
    def draft_path(project: str,location: str,application: str,draft: str,) -> str:
        """Returns a fully-qualified draft string."""
        return "projects/{project}/locations/{location}/applications/{application}/drafts/{draft}".format(project=project, location=location, application=application, draft=draft, )
    ...
    @staticmethod
    def instance_path(project: str,location: str,application: str,instance: str,) -> str:
        """Returns a fully-qualified instance string."""
        return "projects/{project}/locations/{location}/applications/{application}/instances/{instance}".format(project=project, location=location, application=application, instance=instance, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AppPlatformClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            AppPlatformClient._get_api_endpoint(
    ...
    def add_application_stream_input(self,
    ...
    def remove_application_stream_input(self,
    ...
    def update_application_stream_input(self,
    ...
    def delete_application_instances(self,
    ...
    def update_application_instances(self,
    ...
    def list_prebuilt_processors(self,

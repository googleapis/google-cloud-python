...
class AppPlatformGrpcAsyncIOTransport(AppPlatformTransport):
    ...
    def get_application(self) -> Callable[
            ...
            Awaitable[platform.Application]]:
    ...
    @property
    def deploy_application(self) -> Callable[
    ...
    @property
    def undeploy_application(self) -> Callable[
    ...
    @property
    def add_application_stream_input(self) -> Callable[
    ...
    @property
    def remove_application_stream_input(self) -> Callable[
        ...
        if 'remove_application_stream_input' not in self._stubs:
            self._stubs['remove_application_stream_input'] = self.grpc_channel.unary_unary(
    ...
    @property
    def update_application_stream_input(self) -> Callable[
        ...
        if 'update_application_stream_input' not in self._stubs:
            self._stubs['update_application_stream_input'] = self.grpc_channel.unary_unary(
    ...
    @property
    def create_application_instances(self) -> Callable[
    ...
    @property
    def delete_application_instances(self) -> Callable[
    ...
    @property
    def update_application_instances(self) -> Callable[
    ...
    @property
    def list_drafts(self) -> Callable[
            [platform.ListDraftsRequest],
            Awaitable[platform.ListDraftsResponse]]:
    ...
    @property
    def get_draft(self) -> Callable[
            [platform.GetDraftRequest],
            Awaitable[platform.Draft]]:
    ...
    @property
    def create_draft(self) -> Callable[
    ...
    @property
    def update_draft(self) -> Callable[
    ...
    @property
    def delete_draft(self) -> Callable[
    ...
    def list_processors(self) -> Callable[
            ...
            Awaitable[platform.ListProcessorsResponse]]:
    ...
    @property
    def list_prebuilt_processors(self) -> Callable[
    ...
    @property
    def update_processor(self) -> Callable[

...
class LiveVideoAnalyticsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_analysis(self, request: lva_service.CreateAnalysisRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[lva_service.CreateAnalysisRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_analysis(self, request: lva_service.DeleteAnalysisRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[lva_service.DeleteAnalysisRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_analysis(self, request: lva_service.GetAnalysisRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[lva_service.GetAnalysisRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_analyses(self, request: lva_service.ListAnalysesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[lva_service.ListAnalysesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_analysis(self, request: lva_service.UpdateAnalysisRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[lva_service.UpdateAnalysisRequest, Sequence[Tuple[str, str]]]:

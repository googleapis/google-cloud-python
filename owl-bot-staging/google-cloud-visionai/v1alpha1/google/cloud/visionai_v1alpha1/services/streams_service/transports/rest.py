...
class StreamsServiceRestTransport(_BaseStreamsServiceRestTransport):
    ...
    class _GetLocation(_BaseStreamsServiceRestTransport._BaseGetLocation, StreamsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = StreamsServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseStreamsServiceRestTransport._BaseListLocations, StreamsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = StreamsServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseStreamsServiceRestTransport._BaseGetIamPolicy, StreamsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = StreamsServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BaseStreamsServiceRestTransport._BaseSetIamPolicy, StreamsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = StreamsServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseStreamsServiceRestTransport._BaseTestIamPermissions, StreamsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = StreamsServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

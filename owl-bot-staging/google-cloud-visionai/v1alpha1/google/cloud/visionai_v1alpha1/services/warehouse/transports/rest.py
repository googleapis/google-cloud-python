...
class WarehouseRestTransport(_BaseWarehouseRestTransport):
    ...
    class _GetLocation(_BaseWarehouseRestTransport._BaseGetLocation, WarehouseRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WarehouseRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseWarehouseRestTransport._BaseListLocations, WarehouseRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WarehouseRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseWarehouseRestTransport._BaseGetIamPolicy, WarehouseRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WarehouseRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BaseWarehouseRestTransport._BaseSetIamPolicy, WarehouseRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WarehouseRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseWarehouseRestTransport._BaseTestIamPermissions, WarehouseRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WarehouseRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

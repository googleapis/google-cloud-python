...
from .transports.base import WarehouseTransport, DEFAULT_CLIENT_INFO
...
class WarehouseAsyncClient:
    ...
    common_billing_account_path = staticmethod(WarehouseClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(WarehouseClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(WarehouseClient.parse_common_organization_path)
    ...
    parse_common_location_path = staticmethod(WarehouseClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(WarehouseClient).get_transport_class, type(WarehouseClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, WarehouseTransport, Callable[..., WarehouseTransport]]] = "grpc_asyncio",
    ...
    async def create_asset(self,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                should not be set.
            asset (:class:`google.cloud.visionai_v1alpha1.types.Asset`):
    ...
    async def create_corpus(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.CreateCorpusRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            corpus (:class:`google.cloud.visionai_v1alpha1.types.Corpus`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.visionai_v1alpha1.types.Corpus` Corpus is a set of video contents for management. Within a corpus, videos
                   share the same data schema. Search is also restricted
    ...
    async def update_corpus(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.UpdateCorpusRequest, dict]]):
    ...
    async def list_corpora(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.ListCorporaRequest, dict]]):
    ...
    async def create_data_schema(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.CreateDataSchemaRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            data_schema (:class:`google.cloud.visionai_v1alpha1.types.DataSchema`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_data_schema]
    ...
    async def update_data_schema(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.UpdateDataSchemaRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_data_schema]
    ...
    async def get_data_schema(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_data_schema]
    ...
    async def delete_data_schema(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_data_schema]
    ...
    async def list_data_schemas(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_data_schemas]
    ...
    async def create_annotation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.CreateAnnotationRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            annotation (:class:`google.cloud.visionai_v1alpha1.types.Annotation`):
    ...
    async def get_annotation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.GetAnnotationRequest, dict]]):
    ...
    async def list_annotations(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.ListAnnotationsRequest, dict]]):
                The request object. Request message for GetAnnotation
                API.
            parent (:class:`str`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_annotations]
    ...
    async def update_annotation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_annotation]
    ...
    async def delete_annotation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_annotation]
    ...
    def ingest_asset(self,
        ...
        Args:
            requests (AsyncIterator[`google.cloud.visionai_v1alpha1.types.IngestAssetRequest`]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.ingest_asset]
    ...
    async def clip_asset(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.ClipAssetRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.clip_asset]
    ...
    async def generate_hls_uri(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.GenerateHlsUriRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.generate_hls_uri]
    ...
    async def create_search_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.CreateSearchConfigRequest, dict]]):
                The request object. Request message for
                CreateSearchConfig.
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            search_config (:class:`google.cloud.visionai_v1alpha1.types.SearchConfig`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_search_config]
    ...
    async def update_search_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.UpdateSearchConfigRequest, dict]]):
                The request object. Request message for
                UpdateSearchConfig.
            search_config (:class:`google.cloud.visionai_v1alpha1.types.SearchConfig`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_search_config]
    ...
    async def get_search_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_search_config]
    ...
    async def delete_search_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.DeleteSearchConfigRequest, dict]]):
                The request object. Request message for
                DeleteSearchConfig.
            name (:class:`str`):
                Required. The name of the search configuration to
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_search_config]
    ...
    async def list_search_configs(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.ListSearchConfigsRequest, dict]]):
                The request object. Request message for
                ListSearchConfigs.
            parent (:class:`str`):
                Required. The parent, which owns this collection of
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_search_configs]
    ...
    async def search_assets(self,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1alpha1.types.SearchAssetsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_assets]

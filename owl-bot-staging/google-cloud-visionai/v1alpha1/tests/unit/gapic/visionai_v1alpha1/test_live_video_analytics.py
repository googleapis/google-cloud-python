...
from google.cloud.visionai_v1alpha1.services.live_video_analytics import LiveVideoAnalyticsAsyncClient
from google.cloud.visionai_v1alpha1.services.live_video_analytics import LiveVideoAnalyticsClient
from google.cloud.visionai_v1alpha1.services.live_video_analytics import pagers
from google.cloud.visionai_v1alpha1.services.live_video_analytics import transports
...
def test_live_video_analytics_client_client_options_from_dict():
    with mock.patch('google.cloud.visionai_v1alpha1.services.live_video_analytics.transports.LiveVideoAnalyticsGrpcTransport.__init__') as grpc_transport:
...
def test_list_analyses_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*/clusters/*}/analyses" % client.transport._host, args[1])
...
def test_get_analysis_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/clusters/*/analyses/*}" % client.transport._host, args[1])
...
def test_create_analysis_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/clusters/sample3'}
    request_init["analysis"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'analysis_definition': {'analyzers': [{'analyzer': 'analyzer_value', 'operator': 'operator_value', 'inputs': [{'input': 'input_value'}], 'attrs': {}, 'debug_options': {'environment_variables': {}}}]}, 'input_streams_mapping': {}, 'output_streams_mapping': {}}
...
def test_update_analysis_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{analysis.name=projects/*/locations/*/clusters/*/analyses/*}" % client.transport._host, args[1])
...
def test_live_video_analytics_base_transport():
    ...
    with mock.patch('google.cloud.visionai_v1alpha1.services.live_video_analytics.transports.LiveVideoAnalyticsTransport.__init__') as Transport:
...
def test_live_video_analytics_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.visionai_v1alpha1.services.live_video_analytics.transports.LiveVideoAnalyticsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_live_video_analytics_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.visionai_v1alpha1.services.live_video_analytics.transports.LiveVideoAnalyticsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.LiveVideoAnalyticsTransport()
        adc.assert_called_once()

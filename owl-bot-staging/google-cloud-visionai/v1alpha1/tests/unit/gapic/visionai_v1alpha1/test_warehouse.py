...
from google.cloud.visionai_v1alpha1.services.warehouse import WarehouseAsyncClient
from google.cloud.visionai_v1alpha1.services.warehouse import WarehouseClient
from google.cloud.visionai_v1alpha1.services.warehouse import pagers
from google.cloud.visionai_v1alpha1.services.warehouse import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert WarehouseClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert WarehouseClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert WarehouseClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert WarehouseClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert WarehouseClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert WarehouseClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert WarehouseClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert WarehouseClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(WarehouseClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WarehouseClient))
@mock.patch.object(WarehouseAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WarehouseAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = WarehouseClient._DEFAULT_UNIVERSE
    default_endpoint = WarehouseClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = WarehouseClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert WarehouseClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert WarehouseClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == WarehouseClient.DEFAULT_MTLS_ENDPOINT
    assert WarehouseClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert WarehouseClient._get_api_endpoint(None, None, default_universe, "always") == WarehouseClient.DEFAULT_MTLS_ENDPOINT
    assert WarehouseClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == WarehouseClient.DEFAULT_MTLS_ENDPOINT
    assert WarehouseClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert WarehouseClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        WarehouseClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert WarehouseClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert WarehouseClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert WarehouseClient._get_universe_domain(None, None) == WarehouseClient._DEFAULT_UNIVERSE
...
def test_warehouse_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (WarehouseAsyncClient, transports.WarehouseGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (WarehouseAsyncClient, transports.WarehouseGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (WarehouseClient, transports.WarehouseGrpcTransport, "grpc", "false"),
    (WarehouseAsyncClient, transports.WarehouseGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_warehouse_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(WarehouseClient, "DEFAULT_ENDPOINT", modify_default_endpoint(WarehouseClient))
@mock.patch.object(WarehouseAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(WarehouseAsyncClient))
...
def test_warehouse_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (WarehouseAsyncClient, transports.WarehouseGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (WarehouseClient, transports.WarehouseRestTransport, "rest", None),
])
def test_warehouse_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_warehouse_client_client_options_from_dict():
    with mock.patch('google.cloud.visionai_v1alpha1.services.warehouse.transports.WarehouseGrpcTransport.__init__') as grpc_transport:
...
def test_warehouse_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_create_asset(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_asset),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_create_asset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_asset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_asset] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_asset_async(transport: str = 'grpc_asyncio', request_type=warehouse.CreateAssetRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_asset(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_asset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = warehouse.Asset(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_asset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_asset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_asset] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_asset_async(transport: str = 'grpc_asyncio', request_type=warehouse.UpdateAssetRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_asset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_asset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_asset] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_asset_async(transport: str = 'grpc_asyncio', request_type=warehouse.GetAssetRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_assets_async(transport: str = 'grpc_asyncio', request_type=warehouse.ListAssetsRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(warehouse.ListAssetsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_assets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, warehouse.Asset)
                   for i in results)
...
def test_delete_asset(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_asset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_delete_asset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_asset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_asset] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_asset_async(transport: str = 'grpc_asyncio', request_type=warehouse.DeleteAssetRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_corpus(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_corpus),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_corpus_async(transport: str = 'grpc_asyncio', request_type=warehouse.CreateCorpusRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_corpus(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_corpus),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_corpus_async(transport: str = 'grpc_asyncio', request_type=warehouse.GetCorpusRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_corpus(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_corpus),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = warehouse.Corpus(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_corpus_async(transport: str = 'grpc_asyncio', request_type=warehouse.UpdateCorpusRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_corpora(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_corpora),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_corpora_async(transport: str = 'grpc_asyncio', request_type=warehouse.ListCorporaRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(warehouse.ListCorporaResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_corpora_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, warehouse.Corpus)
                   for i in results)
...
async def test_list_corpora_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_corpora(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_delete_corpus(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_corpus),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_delete_corpus_async(transport: str = 'grpc_asyncio', request_type=warehouse.DeleteCorpusRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_data_schema(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_data_schema),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_data_schema_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_data_schema in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_data_schema] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_data_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_data_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_data_schema] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_data_schema_async(transport: str = 'grpc_asyncio', request_type=warehouse.CreateDataSchemaRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(warehouse.DataSchema(
            name='name_value',
            key='key_value',
        ))
...
def test_update_data_schema(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_data_schema),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = warehouse.DataSchema(
            name='name_value',
...
def test_update_data_schema_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_data_schema in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_data_schema] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_data_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_data_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_data_schema] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_data_schema_async(transport: str = 'grpc_asyncio', request_type=warehouse.UpdateDataSchemaRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_data_schema(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_schema),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = warehouse.DataSchema(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_data_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_data_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_data_schema] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_data_schema_async(transport: str = 'grpc_asyncio', request_type=warehouse.GetDataSchemaRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_data_schema(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_data_schema),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_data_schema_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_data_schema in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_data_schema] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_data_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_data_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_data_schema] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_data_schema_async(transport: str = 'grpc_asyncio', request_type=warehouse.DeleteDataSchemaRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_data_schemas_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_data_schemas] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_data_schemas_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_data_schemas in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_data_schemas] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_data_schemas_async(transport: str = 'grpc_asyncio', request_type=warehouse.ListDataSchemasRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(warehouse.ListDataSchemasResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_data_schemas_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, warehouse.DataSchema)
                   for i in results)
...
async def test_list_data_schemas_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_data_schemas(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_create_annotation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_annotation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_annotation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_annotation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_annotation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_annotation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_annotation] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_annotation_async(transport: str = 'grpc_asyncio', request_type=warehouse.CreateAnnotationRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(warehouse.Annotation(
            name='name_value',
        ))
...
def test_get_annotation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_annotation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = warehouse.Annotation(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_annotation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_annotation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_annotation] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_annotation_async(transport: str = 'grpc_asyncio', request_type=warehouse.GetAnnotationRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_annotations_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_annotations] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_annotations_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_annotations in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_annotations] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_annotations_async(transport: str = 'grpc_asyncio', request_type=warehouse.ListAnnotationsRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(warehouse.ListAnnotationsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_annotations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, warehouse.Annotation)
                   for i in results)
...
def test_update_annotation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_annotation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = warehouse.Annotation(
            name='name_value',
...
def test_update_annotation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_annotation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_annotation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_annotation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_annotation] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_annotation_async(transport: str = 'grpc_asyncio', request_type=warehouse.UpdateAnnotationRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_annotation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_annotation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_annotation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_annotation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_annotation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_annotation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_annotation] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_annotation_async(transport: str = 'grpc_asyncio', request_type=warehouse.DeleteAnnotationRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_ingest_asset(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.ingest_asset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_ingest_asset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.ingest_asset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.ingest_asset] = mock_rpc
...
@pytest.mark.asyncio
async def test_ingest_asset_async(transport: str = 'grpc_asyncio', request_type=warehouse.IngestAssetRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        call.return_value.read = mock.AsyncMock(side_effect=[warehouse.IngestAssetResponse()])
...
def test_clip_asset(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.clip_asset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_clip_asset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.clip_asset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.clip_asset] = mock_rpc
...
@pytest.mark.asyncio
async def test_clip_asset_async(transport: str = 'grpc_asyncio', request_type=warehouse.ClipAssetRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_generate_hls_uri(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_hls_uri),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_generate_hls_uri_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_hls_uri] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_hls_uri_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_hls_uri in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_hls_uri] = mock_rpc
...
@pytest.mark.asyncio
async def test_generate_hls_uri_async(transport: str = 'grpc_asyncio', request_type=warehouse.GenerateHlsUriRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(warehouse.GenerateHlsUriResponse(
            uri='uri_value',
        ))
...
def test_create_search_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_search_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_search_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_search_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_search_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_search_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_search_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_search_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_search_config_async(transport: str = 'grpc_asyncio', request_type=warehouse.CreateSearchConfigRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(warehouse.SearchConfig(
            name='name_value',
        ))
...
def test_update_search_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_search_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = warehouse.SearchConfig(
            name='name_value',
...
def test_update_search_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_search_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_search_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_search_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_search_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_search_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_search_config_async(transport: str = 'grpc_asyncio', request_type=warehouse.UpdateSearchConfigRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_search_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_search_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = warehouse.SearchConfig(
            name='name_value',
...
def test_get_search_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_search_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_search_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_search_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_search_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_search_config_async(transport: str = 'grpc_asyncio', request_type=warehouse.GetSearchConfigRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_search_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_search_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_search_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_search_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_search_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_search_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_search_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_search_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_search_config_async(transport: str = 'grpc_asyncio', request_type=warehouse.DeleteSearchConfigRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_search_configs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_search_configs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_search_configs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_search_configs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_search_configs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_search_configs] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_search_configs_async(transport: str = 'grpc_asyncio', request_type=warehouse.ListSearchConfigsRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_search_configs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, warehouse.SearchConfig)
                   for i in results)
...
async def test_list_search_configs_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_search_configs(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_search_assets(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_assets),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_search_assets_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WarehouseAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_assets in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_assets] = mock_rpc
...
@pytest.mark.asyncio
async def test_search_assets_async(transport: str = 'grpc_asyncio', request_type=warehouse.SearchAssetsRequest):
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(warehouse.SearchAssetsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_search_assets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, warehouse.SearchResultItem)
                   for i in results)
...
async def test_search_assets_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.search_assets(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_create_asset_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("assetId", )) & set(("parent", "asset", )))
...
def test_create_asset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'parent': 'projects/sample1/locations/sample2/corpora/sample3'}
        ...
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*/corpora/*}/assets" % client.transport._host, args[1])
...
def test_update_asset_rest_required_fields(request_type=warehouse.UpdateAssetRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_asset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_asset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'asset': {'name': 'projects/sample1/locations/sample2/corpora/sample3/assets/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{asset.name=projects/*/locations/*/corpora/*/assets/*}" % client.transport._host, args[1])
...
def test_get_asset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/corpora/sample3/assets/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/corpora/*/assets/*}" % client.transport._host, args[1])
...
def test_create_corpus_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "corpus", )))
...
def test_create_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*}/corpora" % client.transport._host, args[1])
...
def test_get_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/corpora/*}" % client.transport._host, args[1])
...
def test_update_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'corpus': {'name': 'projects/sample1/locations/sample2/corpora/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{corpus.name=projects/*/locations/*/corpora/*}" % client.transport._host, args[1])
...
def test_list_corpora_rest_required_fields(request_type=warehouse.ListCorporaRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_corpora._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_data_schema_rest_required_fields(request_type=warehouse.CreateDataSchemaRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_data_schema._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_data_schema_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "dataSchema", )))
...
def test_create_data_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*/corpora/*}/dataSchemas" % client.transport._host, args[1])
...
def test_update_data_schema_rest_required_fields(request_type=warehouse.UpdateDataSchemaRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_data_schema._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_data_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'data_schema': {'name': 'projects/sample1/locations/sample2/corpora/sample3/dataSchemas/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{data_schema.name=projects/*/locations/*/corpora/*/dataSchemas/*}" % client.transport._host, args[1])
...
def test_get_data_schema_rest_required_fields(request_type=warehouse.GetDataSchemaRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_data_schema._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_data_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/corpora/sample3/dataSchemas/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/corpora/*/dataSchemas/*}" % client.transport._host, args[1])
...
def test_delete_data_schema_rest_required_fields(request_type=warehouse.DeleteDataSchemaRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_data_schema._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_data_schemas_rest_required_fields(request_type=warehouse.ListDataSchemasRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_data_schemas._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_annotation_rest_required_fields(request_type=warehouse.CreateAnnotationRequest):
    transport_class = transports.WarehouseRestTransport
...
def test_create_annotation_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("annotationId", )) & set(("parent", "annotation", )))
...
def test_create_annotation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/corpora/sample3/assets/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*/corpora/*/assets/*}/annotations" % client.transport._host, args[1])
...
def test_get_annotation_rest_required_fields(request_type=warehouse.GetAnnotationRequest):
    transport_class = transports.WarehouseRestTransport
...
def test_get_annotation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/corpora/sample3/assets/sample4/annotations/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/corpora/*/assets/*/annotations/*}" % client.transport._host, args[1])
...
def test_update_annotation_rest_required_fields(request_type=warehouse.UpdateAnnotationRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_annotation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_annotation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'annotation': {'name': 'projects/sample1/locations/sample2/corpora/sample3/assets/sample4/annotations/sample5'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{annotation.name=projects/*/locations/*/corpora/*/assets/*/annotations/*}" % client.transport._host, args[1])
...
def test_delete_annotation_rest_required_fields(request_type=warehouse.DeleteAnnotationRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_annotation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_clip_asset_rest_required_fields(request_type=warehouse.ClipAssetRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).clip_asset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_hls_uri_rest_required_fields(request_type=warehouse.GenerateHlsUriRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_hls_uri._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_hls_uri_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "temporalPartitions", )))
...
def test_create_search_config_rest_required_fields(request_type=warehouse.CreateSearchConfigRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_search_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_search_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("searchConfigId", )) & set(("parent", "searchConfig", "searchConfigId", )))
...
def test_create_search_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*/corpora/*}/searchConfigs" % client.transport._host, args[1])
...
def test_update_search_config_rest_required_fields(request_type=warehouse.UpdateSearchConfigRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_search_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_search_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'search_config': {'name': 'projects/sample1/locations/sample2/corpora/sample3/searchConfigs/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{search_config.name=projects/*/locations/*/corpora/*/searchConfigs/*}" % client.transport._host, args[1])
...
def test_get_search_config_rest_required_fields(request_type=warehouse.GetSearchConfigRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_search_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_search_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/corpora/sample3/searchConfigs/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/corpora/*/searchConfigs/*}" % client.transport._host, args[1])
...
def test_delete_search_config_rest_required_fields(request_type=warehouse.DeleteSearchConfigRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_search_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_search_configs_rest_required_fields(request_type=warehouse.ListSearchConfigsRequest):
    transport_class = transports.WarehouseRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_search_configs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_search_configs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(warehouse.ListSearchConfigsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_search_assets_rest_required_fields(request_type=warehouse.SearchAssetsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_assets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_assets_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        sample_request = {'corpus': 'projects/sample1/locations/sample2/corpora/sample3'}
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_data_schema_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.DataSchema()
        client.create_data_schema(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_data_schema_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.DataSchema()
        client.update_data_schema(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_data_schema_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.DataSchema()
        client.get_data_schema(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_data_schema_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_data_schema(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_data_schemas_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.ListDataSchemasResponse()
        client.list_data_schemas(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_annotation_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.Annotation()
        client.create_annotation(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_annotation_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.Annotation()
        client.get_annotation(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_annotation_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.Annotation()
        client.update_annotation(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_annotation_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_annotation(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_clip_asset_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.ClipAssetResponse()
        client.clip_asset(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_generate_hls_uri_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.GenerateHlsUriResponse()
        client.generate_hls_uri(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_search_config_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.SearchConfig()
        client.create_search_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_search_config_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.SearchConfig()
        client.update_search_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_search_config_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.SearchConfig()
        client.get_search_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_search_config_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_search_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_search_configs_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.ListSearchConfigsResponse()
        client.list_search_configs(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_assets_empty_call_grpc():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = warehouse.SearchAssetsResponse()
        client.search_assets(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = WarehouseAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_data_schema_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_data_schema(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_data_schema_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_data_schema(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_data_schema_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_data_schema(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_data_schema_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_data_schema(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_data_schemas_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_data_schemas(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_annotation_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_annotation(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_annotation_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_annotation(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_annotation_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_annotation(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_annotation_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_annotation(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_clip_asset_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.clip_asset(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_generate_hls_uri_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.generate_hls_uri(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_search_config_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_search_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_search_config_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_search_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_search_config_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_search_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_search_config_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_search_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_search_configs_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_search_configs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_assets_empty_call_grpc_asyncio():
    client = WarehouseAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.search_assets(request=None)
...
def test_transport_kind_rest():
    transport = WarehouseClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_asset_rest_bad_request(request_type=warehouse.CreateAssetRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_asset_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/corpora/sample3'}
    request_init["asset"] = {'name': 'name_value', 'ttl': {'seconds': 751, 'nanos': 543}}
...
def test_create_asset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WarehouseRestInterceptor, "post_create_asset") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_create_asset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_create_asset") as pre:
...
def test_update_asset_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'asset': {'name': 'projects/sample1/locations/sample2/corpora/sample3/assets/sample4'}}
    request_init["asset"] = {'name': 'projects/sample1/locations/sample2/corpora/sample3/assets/sample4', 'ttl': {'seconds': 751, 'nanos': 543}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_asset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_update_asset") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_update_asset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_update_asset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_asset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_asset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_get_asset") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_get_asset_with_metadata") as post_with_metadata, \
...
def test_list_assets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_list_assets") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_list_assets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_list_assets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = warehouse.ListAssetsResponse.to_json(warehouse.ListAssetsResponse())
        req.return_value.content = return_value
...
def test_delete_asset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WarehouseRestInterceptor, "post_delete_asset") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_delete_asset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_delete_asset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_corpus_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["corpus"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'default_ttl': {'seconds': 751, 'nanos': 543}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_create_corpus") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_create_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_create_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_get_corpus") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_get_corpus_with_metadata") as post_with_metadata, \
        ...
        client.get_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_corpus_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'corpus': {'name': 'projects/sample1/locations/sample2/corpora/sample3'}}
    request_init["corpus"] = {'name': 'projects/sample1/locations/sample2/corpora/sample3', 'display_name': 'display_name_value', 'description': 'description_value', 'default_ttl': {'seconds': 751, 'nanos': 543}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_update_corpus") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_update_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_update_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_corpora_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_list_corpora") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_list_corpora_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_list_corpora") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = warehouse.ListCorporaResponse.to_json(warehouse.ListCorporaResponse())
        req.return_value.content = return_value
        ...
        client.list_corpora(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_delete_corpus") as pre:
        pre.assert_not_called()
        ...
        client.delete_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_create_data_schema_rest_bad_request(request_type=warehouse.CreateDataSchemaRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_data_schema_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/corpora/sample3'}
    request_init["data_schema"] = {'name': 'name_value', 'key': 'key_value', 'schema_details': {'type_': 1, 'proto_any_config': {'type_uri': 'type_uri_value'}, 'granularity': 1, 'search_strategy': {'search_strategy_type': 1}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_data_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_create_data_schema") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_create_data_schema_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_create_data_schema") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = warehouse.CreateDataSchemaRequest.pb(warehouse.CreateDataSchemaRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_data_schema(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_data_schema_rest_bad_request(request_type=warehouse.UpdateDataSchemaRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_data_schema_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'data_schema': {'name': 'projects/sample1/locations/sample2/corpora/sample3/dataSchemas/sample4'}}
    request_init["data_schema"] = {'name': 'projects/sample1/locations/sample2/corpora/sample3/dataSchemas/sample4', 'key': 'key_value', 'schema_details': {'type_': 1, 'proto_any_config': {'type_uri': 'type_uri_value'}, 'granularity': 1, 'search_strategy': {'search_strategy_type': 1}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_data_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_update_data_schema") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_update_data_schema_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_update_data_schema") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = warehouse.UpdateDataSchemaRequest.pb(warehouse.UpdateDataSchemaRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_data_schema(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_data_schema_rest_bad_request(request_type=warehouse.GetDataSchemaRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/corpora/sample3/dataSchemas/sample4'}
    request = request_type(**request_init)
...
def test_get_data_schema_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_data_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_get_data_schema") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_get_data_schema_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_get_data_schema") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_data_schema(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_data_schema_rest_bad_request(request_type=warehouse.DeleteDataSchemaRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_data_schema_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_data_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_delete_data_schema") as pre:
        pre.assert_not_called()
        pb_message = warehouse.DeleteDataSchemaRequest.pb(warehouse.DeleteDataSchemaRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_data_schema(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_list_data_schemas_rest_bad_request(request_type=warehouse.ListDataSchemasRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_data_schemas_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_data_schemas_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_list_data_schemas") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_list_data_schemas_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_list_data_schemas") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = warehouse.ListDataSchemasRequest.pb(warehouse.ListDataSchemasRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = warehouse.ListDataSchemasResponse.to_json(warehouse.ListDataSchemasResponse())
        req.return_value.content = return_value
        ...
        client.list_data_schemas(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_annotation_rest_bad_request(request_type=warehouse.CreateAnnotationRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_annotation_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_annotation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_create_annotation") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_create_annotation_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_create_annotation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = warehouse.CreateAnnotationRequest.pb(warehouse.CreateAnnotationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_annotation_rest_bad_request(request_type=warehouse.GetAnnotationRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/corpora/sample3/assets/sample4/annotations/sample5'}
    request = request_type(**request_init)
...
def test_get_annotation_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_annotation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_get_annotation") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_get_annotation_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_get_annotation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_annotations_rest_bad_request(request_type=warehouse.ListAnnotationsRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_annotations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_list_annotations") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_list_annotations_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_list_annotations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = warehouse.ListAnnotationsRequest.pb(warehouse.ListAnnotationsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = warehouse.ListAnnotationsResponse.to_json(warehouse.ListAnnotationsResponse())
        req.return_value.content = return_value
        ...
        client.list_annotations(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_annotation_rest_bad_request(request_type=warehouse.UpdateAnnotationRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_annotation_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_annotation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_update_annotation") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_update_annotation_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_update_annotation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = warehouse.UpdateAnnotationRequest.pb(warehouse.UpdateAnnotationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_annotation(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_annotation_rest_bad_request(request_type=warehouse.DeleteAnnotationRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_annotation_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_annotation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_delete_annotation") as pre:
        pre.assert_not_called()
        pb_message = warehouse.DeleteAnnotationRequest.pb(warehouse.DeleteAnnotationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_annotation(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_clip_asset_rest_bad_request(request_type=warehouse.ClipAssetRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_clip_asset_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_clip_asset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_clip_asset") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_clip_asset_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = warehouse.ClipAssetResponse.to_json(warehouse.ClipAssetResponse())
        req.return_value.content = return_value
        ...
        client.clip_asset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_generate_hls_uri_rest_bad_request(request_type=warehouse.GenerateHlsUriRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_hls_uri_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_hls_uri_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_generate_hls_uri") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_generate_hls_uri_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_generate_hls_uri") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = warehouse.GenerateHlsUriRequest.pb(warehouse.GenerateHlsUriRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = warehouse.GenerateHlsUriResponse.to_json(warehouse.GenerateHlsUriResponse())
        req.return_value.content = return_value
        ...
        client.generate_hls_uri(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_search_config_rest_bad_request(request_type=warehouse.CreateSearchConfigRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_search_config_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_search_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_create_search_config") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_create_search_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_create_search_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = warehouse.CreateSearchConfigRequest.pb(warehouse.CreateSearchConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_search_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_search_config_rest_bad_request(request_type=warehouse.UpdateSearchConfigRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_search_config_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_search_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_update_search_config") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_update_search_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_update_search_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = warehouse.UpdateSearchConfigRequest.pb(warehouse.UpdateSearchConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_search_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_search_config_rest_bad_request(request_type=warehouse.GetSearchConfigRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/corpora/sample3/searchConfigs/sample4'}
    request = request_type(**request_init)
...
def test_get_search_config_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_search_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_get_search_config") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_get_search_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_get_search_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = warehouse.GetSearchConfigRequest.pb(warehouse.GetSearchConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_search_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_search_config_rest_bad_request(request_type=warehouse.DeleteSearchConfigRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_search_config_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_search_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_delete_search_config") as pre:
        pre.assert_not_called()
        pb_message = warehouse.DeleteSearchConfigRequest.pb(warehouse.DeleteSearchConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_search_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_list_search_configs_rest_bad_request(request_type=warehouse.ListSearchConfigsRequest):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_search_configs_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_search_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_list_search_configs") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_list_search_configs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_list_search_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = warehouse.ListSearchConfigsRequest.pb(warehouse.ListSearchConfigsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = warehouse.ListSearchConfigsResponse.to_json(warehouse.ListSearchConfigsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = warehouse.ListSearchConfigsResponse(), metadata

        client.list_search_configs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_search_assets_rest_call_success(request_type):
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_search_assets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_search_assets") as post, \
        mock.patch.object(transports.WarehouseRestInterceptor, "post_search_assets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WarehouseRestInterceptor, "pre_search_assets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = warehouse.SearchAssetsResponse.to_json(warehouse.SearchAssetsResponse())
        req.return_value.content = return_value
        ...
        client.search_assets(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_data_schema_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_data_schema_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_data_schema_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_data_schema_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_data_schemas_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_annotation_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_annotation_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_annotation_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_annotation_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_clip_asset_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_generate_hls_uri_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_search_config_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_search_config_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_search_config_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_search_config_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_search_configs_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_assets_empty_call_rest():
    client = WarehouseClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_warehouse_base_transport():
    ...
    with mock.patch('google.cloud.visionai_v1alpha1.services.warehouse.transports.WarehouseTransport.__init__') as Transport:
...
def test_warehouse_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.visionai_v1alpha1.services.warehouse.transports.WarehouseTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_warehouse_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.visionai_v1alpha1.services.warehouse.transports.WarehouseTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.WarehouseTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.WarehouseGrpcTransport, transports.WarehouseGrpcAsyncIOTransport])
def test_warehouse_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.WarehouseGrpcTransport, transports.WarehouseGrpcAsyncIOTransport])
def test_warehouse_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.WarehouseGrpcTransport, transports.WarehouseGrpcAsyncIOTransport])
def test_warehouse_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_annotation_path():
    ...
    asset = "octopus"
    annotation = "oyster"
    expected = "projects/{project_number}/locations/{location}/corpora/{corpus}/assets/{asset}/annotations/{annotation}".format(project_number=project_number, location=location, corpus=corpus, asset=asset, annotation=annotation, )
    actual = WarehouseClient.annotation_path(project_number, location, corpus, asset, annotation)
...
def test_asset_path():
    ...
    corpus = "squid"
    asset = "clam"
    expected = "projects/{project_number}/locations/{location}/corpora/{corpus}/assets/{asset}".format(project_number=project_number, location=location, corpus=corpus, asset=asset, )
...
def test_corpus_path():
    ...
    location = "mussel"
    corpus = "winkle"
    expected = "projects/{project_number}/locations/{location}/corpora/{corpus}".format(project_number=project_number, location=location, corpus=corpus, )
...
def test_data_schema_path():
    ...
    corpus = "whelk"
    data_schema = "octopus"
    expected = "projects/{project_number}/locations/{location}/corpora/{corpus}/dataSchemas/{data_schema}".format(project_number=project_number, location=location, corpus=corpus, data_schema=data_schema, )
    actual = WarehouseClient.data_schema_path(project_number, location, corpus, data_schema)
    assert expected == actual
...
def test_search_config_path():
    ...
    expected = "projects/{project_number}/locations/{location}/corpora/{corpus}/searchConfigs/{search_config}".format(project_number=project_number, location=location, corpus=corpus, search_config=search_config, )
    actual = WarehouseClient.search_config_path(project_number, location, corpus, search_config)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.WarehouseTransport, '_prep_wrapped_messages') as prep:
        client = WarehouseClient(
            credentials=ga_credentials.AnonymousCredentials(),

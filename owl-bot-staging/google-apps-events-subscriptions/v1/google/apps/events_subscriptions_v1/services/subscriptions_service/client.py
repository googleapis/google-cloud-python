...
class SubscriptionsServiceClient(metaclass=SubscriptionsServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SubscriptionsServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SubscriptionsServiceTransport]] = None,
    ...
    def create_subscription(self,
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1.types.CreateSubscriptionRequest, dict]):
        ...
        # in a subscriptions_service.CreateSubscriptionRequest.
    ...
    def delete_subscription(self,
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1.types.DeleteSubscriptionRequest, dict]):
                The request object. The request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a subscriptions_service.DeleteSubscriptionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_subscription(self,
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1.types.GetSubscriptionRequest, dict]):
                The request object. The request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a subscriptions_service.GetSubscriptionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_subscriptions(self,
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1.types.ListSubscriptionsRequest, dict]):
                The request object. The request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a subscriptions_service.ListSubscriptionsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_subscription(self,
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1.types.UpdateSubscriptionRequest, dict]):
                The request object. The request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a subscriptions_service.UpdateSubscriptionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def reactivate_subscription(self,
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1.types.ReactivateSubscriptionRequest, dict]):
                The request object. The request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a subscriptions_service.ReactivateSubscriptionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

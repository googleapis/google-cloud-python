...
class ListSubscriptionsPager:
    ...
    :class:`google.apps.events_subscriptions_v1.types.ListSubscriptionsResponse` object, and
    ...
    All the usual :class:`google.apps.events_subscriptions_v1.types.ListSubscriptionsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
            method: Callable[..., subscriptions_service.ListSubscriptionsResponse],
        ...
        Args:
            ...
            request (google.apps.events_subscriptions_v1.types.ListSubscriptionsRequest):
                The initial request object.
            response (google.apps.events_subscriptions_v1.types.ListSubscriptionsResponse):
        ...
        """
        self._method = method
        self._request = subscriptions_service.ListSubscriptionsRequest(request)
    ...
    @property
    def pages(self) -> Iterator[subscriptions_service.ListSubscriptionsResponse]:

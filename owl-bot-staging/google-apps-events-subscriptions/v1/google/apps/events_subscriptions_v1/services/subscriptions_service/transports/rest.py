...
from google.apps.events_subscriptions_v1.types import subscriptions_service
...
class SubscriptionsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_subscription(self, request: subscriptions_service.CreateSubscriptionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[subscriptions_service.CreateSubscriptionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_subscription_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_subscription
    ...
    def pre_delete_subscription(self, request: subscriptions_service.DeleteSubscriptionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[subscriptions_service.DeleteSubscriptionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_subscription_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_subscription
    ...
    def pre_get_subscription(self, request: subscriptions_service.GetSubscriptionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[subscriptions_service.GetSubscriptionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_subscription_with_metadata(self, response: subscription_resource.Subscription, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[subscription_resource.Subscription, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_subscription
    ...
    def pre_list_subscriptions(self, request: subscriptions_service.ListSubscriptionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[subscriptions_service.ListSubscriptionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_subscriptions_with_metadata(self, response: subscriptions_service.ListSubscriptionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[subscriptions_service.ListSubscriptionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_subscriptions
    ...
    def pre_reactivate_subscription(self, request: subscriptions_service.ReactivateSubscriptionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[subscriptions_service.ReactivateSubscriptionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_reactivate_subscription_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for reactivate_subscription
    ...
    def pre_update_subscription(self, request: subscriptions_service.UpdateSubscriptionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[subscriptions_service.UpdateSubscriptionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_subscription_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_subscription
...
class SubscriptionsServiceRestTransport(_BaseSubscriptionsServiceRestTransport):
    ...
    class _CreateSubscription(_BaseSubscriptionsServiceRestTransport._BaseCreateSubscription, SubscriptionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SubscriptionsServiceRestTransport._CreateSubscription._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteSubscription(_BaseSubscriptionsServiceRestTransport._BaseDeleteSubscription, SubscriptionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SubscriptionsServiceRestTransport._DeleteSubscription._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetSubscription(_BaseSubscriptionsServiceRestTransport._BaseGetSubscription, SubscriptionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SubscriptionsServiceRestTransport._GetSubscription._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListSubscriptions(_BaseSubscriptionsServiceRestTransport._BaseListSubscriptions, SubscriptionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SubscriptionsServiceRestTransport._ListSubscriptions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ReactivateSubscription(_BaseSubscriptionsServiceRestTransport._BaseReactivateSubscription, SubscriptionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SubscriptionsServiceRestTransport._ReactivateSubscription._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateSubscription(_BaseSubscriptionsServiceRestTransport._BaseUpdateSubscription, SubscriptionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SubscriptionsServiceRestTransport._UpdateSubscription._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def reactivate_subscription(self) -> Callable[
    ...
    class _GetOperation(_BaseSubscriptionsServiceRestTransport._BaseGetOperation, SubscriptionsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SubscriptionsServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
...
__all__=(
    'SubscriptionsServiceRestTransport',
)

...
class SubscriptionsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_subscription(self, request: subscriptions_service.CreateSubscriptionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[subscriptions_service.CreateSubscriptionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_subscription(self, request: subscriptions_service.DeleteSubscriptionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[subscriptions_service.DeleteSubscriptionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_subscription(self, request: subscriptions_service.GetSubscriptionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[subscriptions_service.GetSubscriptionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_subscriptions(self, request: subscriptions_service.ListSubscriptionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[subscriptions_service.ListSubscriptionsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_reactivate_subscription(self, request: subscriptions_service.ReactivateSubscriptionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[subscriptions_service.ReactivateSubscriptionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_subscription(self, request: subscriptions_service.UpdateSubscriptionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[subscriptions_service.UpdateSubscriptionRequest, Sequence[Tuple[str, str]]]:

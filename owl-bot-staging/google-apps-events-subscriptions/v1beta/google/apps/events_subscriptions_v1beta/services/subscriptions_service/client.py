...
from .transports.base import SubscriptionsServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import SubscriptionsServiceGrpcTransport
from .transports.grpc_asyncio import SubscriptionsServiceGrpcAsyncIOTransport
from .transports.rest import SubscriptionsServiceRestTransport


class SubscriptionsServiceClientMeta(type):
    """Metaclass for the SubscriptionsService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[SubscriptionsServiceTransport]]
    _transport_registry["grpc"] = SubscriptionsServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = SubscriptionsServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = SubscriptionsServiceRestTransport
...
class SubscriptionsServiceClient(metaclass=SubscriptionsServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "workspaceevents.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SubscriptionsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> SubscriptionsServiceTransport:
        ...
        Returns:
            SubscriptionsServiceTransport: The transport used by the client
                instance.
        """
    ...
    def subscription_path(subscription: str,) -> str:
        ...
        return "subscriptions/{subscription}".format(subscription=subscription, )

    @staticmethod
    def parse_subscription_path(path: str) -> Dict[str,str]:
        """Parses a subscription path into its component segments."""
        m = re.match(r"^subscriptions/(?P<subscription>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SubscriptionsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SubscriptionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SubscriptionsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SubscriptionsServiceTransport, Callable[..., SubscriptionsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SubscriptionsServiceClient._read_environment_variables()
        self._client_cert_source = SubscriptionsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SubscriptionsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SubscriptionsServiceTransport)
        if transport_provided:
            # transport is a SubscriptionsServiceTransport instance.
            ...
            self._transport = cast(SubscriptionsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            SubscriptionsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SubscriptionsServiceTransport], Callable[..., SubscriptionsServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.apps.events.subscriptions_v1beta.SubscriptionsServiceClient`.",
                    extra = {
    ...
    def create_subscription(self,
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1beta.types.CreateSubscriptionRequest, dict]):
            ...
            subscription (google.apps.events_subscriptions_v1beta.types.Subscription):
    ...
    def delete_subscription(self,
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1beta.types.DeleteSubscriptionRequest, dict]):
                The request object. The request message for
    ...
    def get_subscription(self,
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1beta.types.GetSubscriptionRequest, dict]):
                The request object. The request message for
    ...
    def list_subscriptions(self,
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1beta.types.ListSubscriptionsRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.apps.events_subscriptions_v1beta.services.subscriptions_service.pagers.ListSubscriptionsPager:
    ...
    def update_subscription(self,
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1beta.types.UpdateSubscriptionRequest, dict]):
                The request object. The request message for
    ...
    def reactivate_subscription(self,
        ...
        .. code-block:: python
            ...
            def sample_reactivate_subscription():
                # Create a client
                client = events_subscriptions_v1beta.SubscriptionsServiceClient()
        ...
        Args:
            request (Union[google.apps.events_subscriptions_v1beta.types.ReactivateSubscriptionRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reactivate_subscription]
    ...
    def __enter__(self) -> "SubscriptionsServiceClient":
        return self

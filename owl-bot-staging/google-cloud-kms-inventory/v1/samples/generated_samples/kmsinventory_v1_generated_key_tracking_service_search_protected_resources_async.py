...
#
# Snippet for SearchProtectedResources
# NOTE: This snippet has been automatically generated for illustrative purposes only.
# It may require modifications to work in your environment.

# To install the latest published package dependency, execute the following:
#   python3 -m pip install google-cloud-kms-inventory
...
from google.cloud.kms import inventory_v1


async def sample_search_protected_resources():
    # Create a client
    client = inventory_v1.KeyTrackingServiceAsyncClient()

    # Initialize request argument(s)
    request = inventory_v1.SearchProtectedResourcesRequest(
        scope="scope_value",

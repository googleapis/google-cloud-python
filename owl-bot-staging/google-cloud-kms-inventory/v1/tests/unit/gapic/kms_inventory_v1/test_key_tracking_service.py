...
def test_get_protected_resources_summary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.KeyTrackingServiceRestInterceptor, "post_get_protected_resources_summary_with_metadata") as post_with_metadata, \
...
def test_search_protected_resources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.KeyTrackingServiceRestInterceptor, "post_search_protected_resources_with_metadata") as post_with_metadata, \

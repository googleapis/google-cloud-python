...
from google.cloud.kms_inventory_v1.services.key_tracking_service import KeyTrackingServiceAsyncClient
...
from google.cloud.kms_inventory_v1.services.key_tracking_service import transports
...
def test__get_api_endpoint():
    ...
    assert KeyTrackingServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == KeyTrackingServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert KeyTrackingServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == KeyTrackingServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_get_protected_resources_summary_rest_required_fields(request_type=key_tracking_service.GetProtectedResourcesSummaryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_protected_resources_summary._get_unset_required_fields(jsonified_request)
...
def test_search_protected_resources_rest_required_fields(request_type=key_tracking_service.SearchProtectedResourcesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_protected_resources._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
class KeyTrackingServiceClient(metaclass=KeyTrackingServiceClientMeta):
    ...
    @staticmethod
    def protected_resources_summary_path(project: str,location: str,key_ring: str,crypto_key: str,) -> str:
        """Returns a fully-qualified protected_resources_summary string."""
        return "projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/protectedResourcesSummary".format(project=project, location=location, key_ring=key_ring, crypto_key=crypto_key, )
    ...
    def parse_protected_resources_summary_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/keyRings/(?P<key_ring>.+?)/cryptoKeys/(?P<crypto_key>.+?)/protectedResourcesSummary$", path)
        return m.groupdict() if m else {}
    ...
    def get_protected_resources_summary(self,
    ...
    def search_protected_resources(self,

...
class SearchProtectedResourcesPager:
    ...
    :class:`google.cloud.kms.inventory_v1.types.SearchProtectedResourcesResponse` object, and
    ...
    All the usual :class:`google.cloud.kms.inventory_v1.types.SearchProtectedResourcesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.kms.inventory_v1.types.SearchProtectedResourcesRequest):
                The initial request object.
            response (google.cloud.kms.inventory_v1.types.SearchProtectedResourcesResponse):

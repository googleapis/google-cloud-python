...
from google.cloud.kms.inventory_v1.services.key_tracking_service import pagers
from google.cloud.kms.inventory_v1.types import key_tracking_service
from .transports.base import KeyTrackingServiceTransport, DEFAULT_CLIENT_INFO
...
class KeyTrackingServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(KeyTrackingServiceClient).get_transport_class, type(KeyTrackingServiceClient))
    ...
    async def get_protected_resources_summary(self,
        ...
        Args:
            request (Optional[Union[google.cloud.kms.inventory_v1.types.GetProtectedResourcesSummaryRequest, dict]]):
        ...
        Returns:
            google.cloud.kms.inventory_v1.types.ProtectedResourcesSummary:
    ...
    async def search_protected_resources(self,
        ...
        Args:
            request (Optional[Union[google.cloud.kms.inventory_v1.types.SearchProtectedResourcesRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.kms.inventory_v1.services.key_tracking_service.pagers.SearchProtectedResourcesAsyncPager:

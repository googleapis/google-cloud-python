...
from .base import KeyTrackingServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class KeyTrackingServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_protected_resources_summary(self, request: key_tracking_service.GetProtectedResourcesSummaryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[key_tracking_service.GetProtectedResourcesSummaryRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_protected_resources_summary(self, response: key_tracking_service.ProtectedResourcesSummary) -> key_tracking_service.ProtectedResourcesSummary:
        ...
        """
        return response
    def pre_search_protected_resources(self, request: key_tracking_service.SearchProtectedResourcesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[key_tracking_service.SearchProtectedResourcesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_search_protected_resources(self, response: key_tracking_service.SearchProtectedResourcesResponse) -> key_tracking_service.SearchProtectedResourcesResponse:

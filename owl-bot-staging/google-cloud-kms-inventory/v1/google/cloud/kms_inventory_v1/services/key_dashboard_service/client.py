...
from .transports.grpc import KeyDashboardServiceGrpcTransport
from .transports.grpc_asyncio import KeyDashboardServiceGrpcAsyncIOTransport
from .transports.rest import KeyDashboardServiceRestTransport


class KeyDashboardServiceClientMeta(type):
    """Metaclass for the KeyDashboardService client.
...
class KeyDashboardServiceClient(metaclass=KeyDashboardServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "kmsinventory.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            KeyDashboardServiceClient: The constructed client.
        """
    ...
    def transport(self) -> KeyDashboardServiceTransport:
        ...
        Returns:
            KeyDashboardServiceTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = KeyDashboardServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = KeyDashboardServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = KeyDashboardServiceClient._DEFAULT_UNIVERSE
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = KeyDashboardServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            KeyDashboardServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, KeyDashboardServiceTransport, Callable[..., KeyDashboardServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = KeyDashboardServiceClient._read_environment_variables()
        self._client_cert_source = KeyDashboardServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = KeyDashboardServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, KeyDashboardServiceTransport)
        if transport_provided:
            # transport is a KeyDashboardServiceTransport instance.
            ...
            self._transport = cast(KeyDashboardServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            KeyDashboardServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[KeyDashboardServiceTransport], Callable[..., KeyDashboardServiceTransport]] = (
    ...
    def list_crypto_keys(self,
        ...
        Args:
            request (Union[google.cloud.kms_inventory_v1.types.ListCryptoKeysRequest, dict]):
    ...
    def __enter__(self) -> "KeyDashboardServiceClient":
        return self

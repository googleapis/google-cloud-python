...
class KeyTrackingServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_protected_resources_summary(self, request: key_tracking_service.GetProtectedResourcesSummaryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[key_tracking_service.GetProtectedResourcesSummaryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_protected_resources_summary_with_metadata(self, response: key_tracking_service.ProtectedResourcesSummary, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[key_tracking_service.ProtectedResourcesSummary, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_protected_resources_summary
    ...
    def pre_search_protected_resources(self, request: key_tracking_service.SearchProtectedResourcesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[key_tracking_service.SearchProtectedResourcesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_search_protected_resources_with_metadata(self, response: key_tracking_service.SearchProtectedResourcesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[key_tracking_service.SearchProtectedResourcesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_protected_resources
...
class KeyTrackingServiceRestTransport(_BaseKeyTrackingServiceRestTransport):
    ...
    class _GetProtectedResourcesSummary(_BaseKeyTrackingServiceRestTransport._BaseGetProtectedResourcesSummary, KeyTrackingServiceRestStub):
        ...
        summary method over HTTP.
            ...
            # Send the request
            response = KeyTrackingServiceRestTransport._GetProtectedResourcesSummary._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SearchProtectedResources(_BaseKeyTrackingServiceRestTransport._BaseSearchProtectedResources, KeyTrackingServiceRestStub):
        ...
        resources method over HTTP.
            ...
            # Send the request
            response = KeyTrackingServiceRestTransport._SearchProtectedResources._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class SearchProtectedResourcesAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[key_tracking_service.SearchProtectedResourcesResponse]],
            request: key_tracking_service.SearchProtectedResourcesRequest,
            response: key_tracking_service.SearchProtectedResourcesResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[key_tracking_service.SearchProtectedResourcesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

...
from .transports.base import AMLTransport, DEFAULT_CLIENT_INFO
...
class AMLClient(metaclass=AMLClientMeta):
    ...
    @staticmethod
    def backtest_result_path(project_num: str,location: str,instance: str,backtest_result: str,) -> str:
        """Returns a fully-qualified backtest_result string."""
        return "projects/{project_num}/locations/{location}/instances/{instance}/backtestResults/{backtest_result}".format(project_num=project_num, location=location, instance=instance, backtest_result=backtest_result, )

    @staticmethod
    def parse_backtest_result_path(path: str) -> Dict[str,str]:
        """Parses a backtest_result path into its component segments."""
        m = re.match(r"^projects/(?P<project_num>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/backtestResults/(?P<backtest_result>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def dataset_path(project_num: str,location: str,instance: str,dataset: str,) -> str:
        """Returns a fully-qualified dataset string."""
        return "projects/{project_num}/locations/{location}/instances/{instance}/datasets/{dataset}".format(project_num=project_num, location=location, instance=instance, dataset=dataset, )
    ...
    @staticmethod
    def engine_config_path(project_num: str,location: str,instance: str,engine_config: str,) -> str:
        """Returns a fully-qualified engine_config string."""
        return "projects/{project_num}/locations/{location}/instances/{instance}/engineConfigs/{engine_config}".format(project_num=project_num, location=location, instance=instance, engine_config=engine_config, )

    @staticmethod
    def parse_engine_config_path(path: str) -> Dict[str,str]:
        """Parses a engine_config path into its component segments."""
        m = re.match(r"^projects/(?P<project_num>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/engineConfigs/(?P<engine_config>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def engine_version_path(project_num: str,location: str,instance: str,engine_version: str,) -> str:
        """Returns a fully-qualified engine_version string."""
        return "projects/{project_num}/locations/{location}/instances/{instance}/engineVersions/{engine_version}".format(project_num=project_num, location=location, instance=instance, engine_version=engine_version, )

    @staticmethod
    def parse_engine_version_path(path: str) -> Dict[str,str]:
        """Parses a engine_version path into its component segments."""
        m = re.match(r"^projects/(?P<project_num>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/engineVersions/(?P<engine_version>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def model_path(project_num: str,location: str,instance: str,model: str,) -> str:
        """Returns a fully-qualified model string."""
        return "projects/{project_num}/locations/{location}/instances/{instance}/models/{model}".format(project_num=project_num, location=location, instance=instance, model=model, )
    ...
    @staticmethod
    def prediction_result_path(project_num: str,location: str,instance: str,prediction_result: str,) -> str:
        """Returns a fully-qualified prediction_result string."""
        return "projects/{project_num}/locations/{location}/instances/{instance}/predictionResults/{prediction_result}".format(project_num=project_num, location=location, instance=instance, prediction_result=prediction_result, )

    @staticmethod
    def parse_prediction_result_path(path: str) -> Dict[str,str]:
        """Parses a prediction_result path into its component segments."""
        m = re.match(r"^projects/(?P<project_num>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/predictionResults/(?P<prediction_result>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def import_registered_parties(self,
    ...
    def export_registered_parties(self,
    ...
    def export_engine_config_metadata(self,
    ...
    def list_prediction_results(self,
    ...
    def export_prediction_result_metadata(self,
    ...
    def delete_prediction_result(self,
    ...
    def update_backtest_result(self,
    ...
    def export_backtest_result_metadata(self,
    ...
    def delete_backtest_result(self,

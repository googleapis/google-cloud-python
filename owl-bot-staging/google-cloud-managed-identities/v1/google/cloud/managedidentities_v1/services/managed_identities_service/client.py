...
class ManagedIdentitiesServiceClient(metaclass=ManagedIdentitiesServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "managedidentities.{UNIVERSE_DOMAIN}"
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ManagedIdentitiesServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ManagedIdentitiesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ManagedIdentitiesServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ManagedIdentitiesServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ManagedIdentitiesServiceTransport, Callable[..., ManagedIdentitiesServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ManagedIdentitiesServiceClient._read_environment_variables()
        self._client_cert_source = ManagedIdentitiesServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ManagedIdentitiesServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ManagedIdentitiesServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(ManagedIdentitiesServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ManagedIdentitiesServiceTransport], Callable[..., ManagedIdentitiesServiceTransport]] = (

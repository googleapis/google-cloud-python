...
def test__get_api_endpoint():
    ...
    assert TablesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == TablesServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_get_table_rest_unset_required_fields():
    transport = transports.TablesServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_workspace_rest_required_fields(request_type=tables.GetWorkspaceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_workspace._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_row_rest_required_fields(request_type=tables.GetRowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_row._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_rows_rest_required_fields(request_type=tables.ListRowsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_rows._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_row_rest_required_fields(request_type=tables.CreateRowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_row._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_rows_rest_required_fields(request_type=tables.BatchCreateRowsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_create_rows._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_row_rest_required_fields(request_type=tables.UpdateRowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_row._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_rows_rest_required_fields(request_type=tables.BatchUpdateRowsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_update_rows._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_row_rest_required_fields(request_type=tables.DeleteRowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_row._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_delete_rows_rest_required_fields(request_type=tables.BatchDeleteRowsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_delete_rows._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test_get_table_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TablesServiceRestInterceptor, "post_get_table_with_metadata") as post_with_metadata, \
...
def test_list_tables_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TablesServiceRestInterceptor, "post_list_tables_with_metadata") as post_with_metadata, \
...
def test_get_workspace_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TablesServiceRestInterceptor, "post_get_workspace_with_metadata") as post_with_metadata, \
...
def test_list_workspaces_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TablesServiceRestInterceptor, "post_list_workspaces_with_metadata") as post_with_metadata, \
...
def test_get_row_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TablesServiceRestInterceptor, "post_get_row_with_metadata") as post_with_metadata, \
...
def test_list_rows_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TablesServiceRestInterceptor, "post_list_rows_with_metadata") as post_with_metadata, \
...
def test_create_row_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TablesServiceRestInterceptor, "post_create_row_with_metadata") as post_with_metadata, \
...
def test_batch_create_rows_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TablesServiceRestInterceptor, "post_batch_create_rows_with_metadata") as post_with_metadata, \
...
def test_update_row_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TablesServiceRestInterceptor, "post_update_row_with_metadata") as post_with_metadata, \
...
def test_batch_update_rows_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TablesServiceRestInterceptor, "post_batch_update_rows_with_metadata") as post_with_metadata, \

...
def test_check_instance_upgradability_rest_required_fields(request_type=service.CheckInstanceUpgradabilityRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).check_instance_upgradability._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_rollback_instance_rest_required_fields(request_type=service.RollbackInstanceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).rollback_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_diagnose_instance_rest_required_fields(request_type=service.DiagnoseInstanceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).diagnose_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

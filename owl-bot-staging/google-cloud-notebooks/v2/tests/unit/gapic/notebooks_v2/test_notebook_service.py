...
from google.cloud.notebooks_v2.services.notebook_service import NotebookServiceAsyncClient
...
from google.cloud.notebooks_v2.services.notebook_service import transports
...
def test_check_instance_upgradability(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.check_instance_upgradability),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_update_instance") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_update_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_update_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_check_instance_upgradability_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_check_instance_upgradability") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_check_instance_upgradability_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_check_instance_upgradability") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_rollback_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_rollback_instance") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_rollback_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_rollback_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_diagnose_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_diagnose_instance") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_diagnose_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_diagnose_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

...
class NotebookServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.check_instance_upgradability: gapic_v1.method.wrap_method(
    ...
    @property
    def check_instance_upgradability(self) -> Callable[
    ...
    @property
    def rollback_instance(self) -> Callable[
    ...
    @property
    def diagnose_instance(self) -> Callable[

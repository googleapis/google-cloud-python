...
class NotebookServiceAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.notebooks_v2.NotebookServiceAsyncClient`.",
                extra = {
    ...
    async def list_instances(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v2.types.ListInstancesRequest, dict]]):
    ...
    async def create_instance(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v2.types.CreateInstanceRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            instance (:class:`google.cloud.notebooks_v2.types.Instance`):
    ...
    async def update_instance(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v2.types.UpdateInstanceRequest, dict]]):
    ...
    async def delete_instance(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v2.types.DeleteInstanceRequest, dict]]):
    ...
    async def start_instance(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v2.types.StartInstanceRequest, dict]]):
    ...
    async def stop_instance(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v2.types.StopInstanceRequest, dict]]):
    ...
    async def reset_instance(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v2.types.ResetInstanceRequest, dict]]):
    ...
    async def check_instance_upgradability(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v2.types.CheckInstanceUpgradabilityRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.check_instance_upgradability]
    ...
    async def upgrade_instance(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v2.types.UpgradeInstanceRequest, dict]]):
    ...
    async def rollback_instance(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v2.types.RollbackInstanceRequest, dict]]):
    ...
    async def diagnose_instance(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v2.types.DiagnoseInstanceRequest, dict]]):
                The request object. Request for creating a notebook
            ...
            name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            diagnostic_config (:class:`google.cloud.notebooks_v2.types.DiagnosticConfig`):

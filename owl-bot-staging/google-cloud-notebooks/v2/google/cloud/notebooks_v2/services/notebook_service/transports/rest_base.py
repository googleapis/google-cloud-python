...
class _BaseNotebookServiceRestTransport(NotebookServiceTransport):
    ...
    class _BaseCheckInstanceUpgradability:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v2/{notebook_instance=projects/*/locations/*/instances/*}:checkUpgradability',
            },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = service.CheckInstanceUpgradabilityRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseNotebookServiceRestTransport._BaseCheckInstanceUpgradability._get_unset_required_fields(query_params))
    ...
    class _BaseDiagnoseInstance:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{name=projects/*/locations/*/instances/*}:diagnose',
                'body': '*',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = service.DiagnoseInstanceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseNotebookServiceRestTransport._BaseDiagnoseInstance._get_unset_required_fields(query_params))
    ...
    class _BaseRollbackInstance:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{name=projects/*/locations/*/instances/*}:rollback',
                'body': '*',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = service.RollbackInstanceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseNotebookServiceRestTransport._BaseRollbackInstance._get_unset_required_fields(query_params))
    ...
    class _BaseUpdateInstance:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseNotebookServiceRestTransport._BaseUpdateInstance._get_unset_required_fields(query_params))
    ...
    class _BaseUpgradeInstance:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{name=projects/*/locations/*/instances/*}:upgrade',
                'body': '*',
            },
            ]
            return http_options
    ...
    class _BaseGetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v2/{resource=projects/*/locations/*/instances/*}:getIamPolicy',
            },
            ]
            return http_options
    ...
    class _BaseSetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{resource=projects/*/locations/*/instances/*}:setIamPolicy',
                'body': '*',
            },
            ]
            return http_options
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{resource=projects/*/locations/*/instances/*}:testIamPermissions',
                'body': '*',
            },
            ]
            return http_options
...
__all__=(
    '_BaseNotebookServiceRestTransport',
)

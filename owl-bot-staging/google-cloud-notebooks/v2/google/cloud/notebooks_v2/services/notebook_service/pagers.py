...
class ListInstancesPager:
    ...
    :class:`google.cloud.notebooks_v2.types.ListInstancesResponse` object, and
    ...
    All the usual :class:`google.cloud.notebooks_v2.types.ListInstancesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.notebooks_v2.types.ListInstancesRequest):
                The initial request object.
            response (google.cloud.notebooks_v2.types.ListInstancesResponse):

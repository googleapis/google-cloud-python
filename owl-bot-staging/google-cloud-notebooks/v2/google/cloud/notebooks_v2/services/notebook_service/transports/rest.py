...
class NotebookServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_check_instance_upgradability(self, request: service.CheckInstanceUpgradabilityRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.CheckInstanceUpgradabilityRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_check_instance_upgradability_with_metadata(self, response: service.CheckInstanceUpgradabilityResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.CheckInstanceUpgradabilityResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for check_instance_upgradability
    ...
    def pre_diagnose_instance(self, request: service.DiagnoseInstanceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.DiagnoseInstanceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_diagnose_instance_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for diagnose_instance
    ...
    def pre_rollback_instance(self, request: service.RollbackInstanceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.RollbackInstanceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_rollback_instance_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for rollback_instance
...
class NotebookServiceRestTransport(_BaseNotebookServiceRestTransport):
    ...
    class _CheckInstanceUpgradability(_BaseNotebookServiceRestTransport._BaseCheckInstanceUpgradability, NotebookServiceRestStub):
        ...
        upgradability method over HTTP.
            ...
            # Send the request
            response = NotebookServiceRestTransport._CheckInstanceUpgradability._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DiagnoseInstance(_BaseNotebookServiceRestTransport._BaseDiagnoseInstance, NotebookServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = NotebookServiceRestTransport._DiagnoseInstance._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _RollbackInstance(_BaseNotebookServiceRestTransport._BaseRollbackInstance, NotebookServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = NotebookServiceRestTransport._RollbackInstance._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateInstance(_BaseNotebookServiceRestTransport._BaseUpdateInstance, NotebookServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = NotebookServiceRestTransport._UpdateInstance._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
from google.cloud.notebooks_v1.services.notebook_service import NotebookServiceAsyncClient
...
def test_notebook_service_client_client_options_from_dict():
    with mock.patch('google.cloud.notebooks_v1.services.notebook_service.transports.NotebookServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_update_instance_config_async(transport: str = 'grpc_asyncio', request_type=service.UpdateInstanceConfigRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_shielded_instance_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_shielded_instance_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_shielded_instance_config_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_shielded_instance_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_shielded_instance_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_shielded_instance_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_shielded_instance_config_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.update_shielded_instance_config()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.UpdateShieldedInstanceConfigRequest()

@pytest.mark.asyncio
async def test_update_shielded_instance_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_shielded_instance_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_shielded_instance_config] = mock_object
...
@pytest.mark.asyncio
async def test_update_shielded_instance_config_async(transport: str = 'grpc_asyncio', request_type=service.UpdateShieldedInstanceConfigRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_instance_metadata_items(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_instance_metadata_items),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_instance_metadata_items_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_instance_metadata_items in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_instance_metadata_items] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_instance_metadata_items_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.UpdateInstanceMetadataItemsResponse(
        ))
        response = await client.update_instance_metadata_items()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.UpdateInstanceMetadataItemsRequest()

@pytest.mark.asyncio
async def test_update_instance_metadata_items_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_instance_metadata_items in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_instance_metadata_items] = mock_object
...
@pytest.mark.asyncio
async def test_update_instance_metadata_items_async(transport: str = 'grpc_asyncio', request_type=service.UpdateInstanceMetadataItemsRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_instance_health(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_instance_health),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.health_state == service.GetInstanceHealthResponse.HealthState.HEALTHY


def test_get_instance_health_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_get_instance_health_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_instance_health in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_instance_health] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_instance_health_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.GetInstanceHealthResponse(
            health_state=service.GetInstanceHealthResponse.HealthState.HEALTHY,
        ))
...
@pytest.mark.asyncio
async def test_get_instance_health_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_instance_health in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_instance_health] = mock_object
...
@pytest.mark.asyncio
async def test_get_instance_health_async(transport: str = 'grpc_asyncio', request_type=service.GetInstanceHealthRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_rollback_instance(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rollback_instance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_rollback_instance_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.rollback_instance] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_rollback_instance_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.rollback_instance()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.RollbackInstanceRequest()

@pytest.mark.asyncio
async def test_rollback_instance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.rollback_instance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.rollback_instance] = mock_object
...
def test_diagnose_instance(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.diagnose_instance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_diagnose_instance_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.diagnose_instance] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_diagnose_instance_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_diagnose_instance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.diagnose_instance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.diagnose_instance] = mock_object
...
async def test_list_schedules_empty_call_async():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListSchedulesResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
@pytest.mark.asyncio
async def test_list_schedules_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_schedules in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_schedules] = mock_object
...
@pytest.mark.asyncio
async def test_list_schedules_async(transport: str = 'grpc_asyncio', request_type=service.ListSchedulesRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_schedule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_schedule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_schedule] = mock_object
...
@pytest.mark.asyncio
async def test_get_schedule_async(transport: str = 'grpc_asyncio', request_type=service.GetScheduleRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_schedule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_schedule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_schedule] = mock_object
...
@pytest.mark.asyncio
async def test_delete_schedule_async(transport: str = 'grpc_asyncio', request_type=service.DeleteScheduleRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_schedule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_schedule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_schedule] = mock_object
...
@pytest.mark.asyncio
async def test_create_schedule_async(transport: str = 'grpc_asyncio', request_type=service.CreateScheduleRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_trigger_schedule(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.trigger_schedule),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_trigger_schedule_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_trigger_schedule_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.trigger_schedule] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_trigger_schedule_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.trigger_schedule()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.TriggerScheduleRequest()

@pytest.mark.asyncio
async def test_trigger_schedule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.trigger_schedule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.trigger_schedule] = mock_object
...
@pytest.mark.asyncio
async def test_trigger_schedule_async(transport: str = 'grpc_asyncio', request_type=service.TriggerScheduleRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_executions_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListExecutionsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
async def test_list_executions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_executions] = mock_object
...
@pytest.mark.asyncio
async def test_list_executions_async(transport: str = 'grpc_asyncio', request_type=service.ListExecutionsRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_execution_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_get_execution_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_execution] = mock_object
...
@pytest.mark.asyncio
async def test_get_execution_async(transport: str = 'grpc_asyncio', request_type=service.GetExecutionRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_execution_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_delete_execution_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_execution] = mock_object
...
@pytest.mark.asyncio
async def test_delete_execution_async(transport: str = 'grpc_asyncio', request_type=service.DeleteExecutionRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_execution_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_execution] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_execution_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_execution_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_execution in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_execution] = mock_object
...
@pytest.mark.asyncio
async def test_create_execution_async(transport: str = 'grpc_asyncio', request_type=service.CreateExecutionRequest):
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_execution_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_execution(
            parent='parent_value',
            execution=gcn_execution.Execution(execution_template=gcn_execution.ExecutionTemplate(scale_tier=gcn_execution.ExecutionTemplate.ScaleTier.BASIC)),
            execution_id='execution_id_value',
        )
        ...
        mock_val = gcn_execution.Execution(execution_template=gcn_execution.ExecutionTemplate(scale_tier=gcn_execution.ExecutionTemplate.ScaleTier.BASIC))
        assert arg == mock_val
...
def test_notebook_service_base_transport():
    ...
    with mock.patch('google.cloud.notebooks_v1.services.notebook_service.transports.NotebookServiceTransport.__init__') as Transport:
...
def test_notebook_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.notebooks_v1.services.notebook_service.transports.NotebookServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_notebook_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.notebooks_v1.services.notebook_service.transports.NotebookServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NotebookServiceTransport()
        adc.assert_called_once()
...
def test_execution_path():
    ...
    expected = "projects/{project}/location/{location}/executions/{execution}".format(project=project, location=location, execution=execution, )
...
def test_schedule_path():
    ...
    location = "octopus"
    schedule = "oyster"
    expected = "projects/{project}/location/{location}/schedules/{schedule}".format(project=project, location=location, schedule=schedule, )

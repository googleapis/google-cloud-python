...
class ManagedNotebookServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = ManagedNotebookServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = ManagedNotebookServiceClient._DEFAULT_UNIVERSE
    ...
    common_billing_account_path = staticmethod(ManagedNotebookServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ManagedNotebookServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ManagedNotebookServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(ManagedNotebookServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(ManagedNotebookServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(ManagedNotebookServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(ManagedNotebookServiceClient.common_project_path)
    parse_common_project_path = staticmethod(ManagedNotebookServiceClient.parse_common_project_path)
    common_location_path = staticmethod(ManagedNotebookServiceClient.common_location_path)
    parse_common_location_path = staticmethod(ManagedNotebookServiceClient.parse_common_location_path)
    ...
    get_transport_class = ManagedNotebookServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, ManagedNotebookServiceTransport, Callable[..., ManagedNotebookServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.notebooks_v1.ManagedNotebookServiceAsyncClient`.",
                extra = {
    ...
    async def list_runtimes(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v1.types.ListRuntimesRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_runtimes]
    ...
    async def get_runtime(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v1.types.GetRuntimeRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_runtime]
    ...
    async def create_runtime(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v1.types.CreateRuntimeRequest, dict]]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, runtime_id, runtime]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_runtime]
    ...
    async def update_runtime(self,
            request: Optional[Union[managed_service.UpdateRuntimeRequest, dict]] = None,
            *,
            runtime: Optional[gcn_runtime.Runtime] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v1.types.UpdateRuntimeRequest, dict]]):
                The request object. Request for updating a Managed
            ...
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                ...
                software configuration kernels, the ``update_mask``
                parameter would be specified as
                ``software_config.kernels``, and the ``PATCH`` request
                body would specify the new value, as follows:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [runtime, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_runtime]
    ...
    async def delete_runtime(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v1.types.DeleteRuntimeRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_runtime]
    ...
    async def start_runtime(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v1.types.StartRuntimeRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.start_runtime]
    ...
    async def stop_runtime(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v1.types.StopRuntimeRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.stop_runtime]
    ...
    async def switch_runtime(self,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v1.types.SwitchRuntimeRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.switch_runtime]
    ...
    async def reset_runtime(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.reset_runtime]
    ...
    async def upgrade_runtime(self,
            request: Optional[Union[managed_service.UpgradeRuntimeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Upgrades a Managed Notebook Runtime to the latest
        version.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.upgrade_runtime]
    ...
    async def report_runtime_event(self,
            request: Optional[Union[managed_service.ReportRuntimeEventRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v1.types.ReportRuntimeEventRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.report_runtime_event]
    ...
    async def refresh_runtime_token_internal(self,
            request: Optional[Union[managed_service.RefreshRuntimeTokenInternalRequest, dict]] = None,
            *,
            name: Optional[str] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v1.types.RefreshRuntimeTokenInternalRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.refresh_runtime_token_internal]
    ...
    async def diagnose_runtime(self,
            request: Optional[Union[managed_service.DiagnoseRuntimeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.notebooks_v1.types.DiagnoseRuntimeRequest, dict]]):
                The request object. Request for creating a notebook
                instance diagnostic file.
            name (:class:`str`):
                Required. Format:
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            diagnostic_config (:class:`google.cloud.notebooks_v1.types.DiagnosticConfig`):
                Required. Defines flags that are used
                to run the diagnostic tool

                This corresponds to the ``diagnostic_config`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [name, diagnostic_config]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        if diagnostic_config is not None:
            request.diagnostic_config = diagnostic_config

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.diagnose_runtime]

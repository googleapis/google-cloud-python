...
class NotebookServiceGrpcTransport(NotebookServiceTransport):
    ...
    @property
    def update_shielded_instance_config(self) -> Callable[
        ...
        if 'update_shielded_instance_config' not in self._stubs:
            self._stubs['update_shielded_instance_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def update_instance_metadata_items(self) -> Callable[
        ...
        if 'update_instance_metadata_items' not in self._stubs:
            self._stubs['update_instance_metadata_items'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_instance_health(self) -> Callable[
    ...
    @property
    def trigger_schedule(self) -> Callable[

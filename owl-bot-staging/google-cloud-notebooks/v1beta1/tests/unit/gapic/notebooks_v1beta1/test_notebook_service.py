...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert NotebookServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert NotebookServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert NotebookServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert NotebookServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert NotebookServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert NotebookServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert NotebookServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert NotebookServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(NotebookServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NotebookServiceClient))
@mock.patch.object(NotebookServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NotebookServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = NotebookServiceClient._DEFAULT_UNIVERSE
    default_endpoint = NotebookServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = NotebookServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert NotebookServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert NotebookServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == NotebookServiceClient.DEFAULT_MTLS_ENDPOINT
    assert NotebookServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert NotebookServiceClient._get_api_endpoint(None, None, default_universe, "always") == NotebookServiceClient.DEFAULT_MTLS_ENDPOINT
    assert NotebookServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == NotebookServiceClient.DEFAULT_MTLS_ENDPOINT
    assert NotebookServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert NotebookServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        NotebookServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert NotebookServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert NotebookServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert NotebookServiceClient._get_universe_domain(None, None) == NotebookServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (NotebookServiceClient, transports.NotebookServiceRestTransport, "rest", "true"),
    (NotebookServiceClient, transports.NotebookServiceRestTransport, "rest", "false"),
])
@mock.patch.object(NotebookServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NotebookServiceClient))
@mock.patch.object(NotebookServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NotebookServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (NotebookServiceClient, transports.NotebookServiceGrpcTransport, "grpc", grpc_helpers),
    (NotebookServiceAsyncClient, transports.NotebookServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_register_instance_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.register_instance] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_register_instance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.register_instance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.register_instance] = mock_rpc
...
def test_set_instance_accelerator_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.set_instance_accelerator in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_instance_accelerator] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_set_instance_accelerator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.set_instance_accelerator in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.set_instance_accelerator] = mock_rpc
...
def test_set_instance_machine_type_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.set_instance_machine_type in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_instance_machine_type] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_set_instance_machine_type_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.set_instance_machine_type in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.set_instance_machine_type] = mock_rpc
...
def test_set_instance_labels_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.set_instance_labels in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_instance_labels] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_set_instance_labels_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.set_instance_labels in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.set_instance_labels] = mock_rpc
...
@pytest.mark.asyncio
async def test_start_instance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.start_instance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.start_instance] = mock_rpc
...
@pytest.mark.asyncio
async def test_stop_instance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.stop_instance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.stop_instance] = mock_rpc
...
@pytest.mark.asyncio
async def test_reset_instance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.reset_instance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.reset_instance] = mock_rpc
...
def test_report_instance_info_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.report_instance_info in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.report_instance_info] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_report_instance_info_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.report_instance_info in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.report_instance_info] = mock_rpc
...
def test_is_instance_upgradeable_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.is_instance_upgradeable in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.is_instance_upgradeable] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_is_instance_upgradeable_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.is_instance_upgradeable in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.is_instance_upgradeable] = mock_rpc
...
def test_upgrade_instance_internal_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.upgrade_instance_internal in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.upgrade_instance_internal] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_upgrade_instance_internal_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.upgrade_instance_internal in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.upgrade_instance_internal] = mock_rpc
...
def test_list_environments_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_environments] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_environments_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_environments in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_environments] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_environment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_environment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_environment] = mock_rpc
...
def test_create_environment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_environment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_environment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_environment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_environment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_environment] = mock_rpc
...
def test_delete_environment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_environment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_environment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_environment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_environment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_environment] = mock_rpc
...
def test_register_instance_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
...
def test_register_instance_rest_required_fields(request_type=service.RegisterInstanceRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).register_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_register_instance_rest_unset_required_fields():
    transport = transports.NotebookServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.register_instance._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "instanceId", )))


def test_set_instance_accelerator_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
...
def test_set_instance_accelerator_rest_required_fields(request_type=service.SetInstanceAcceleratorRequest):
    transport_class = transports.NotebookServiceRestTransport

    request_init = {}
    request_init["name"] = ""
    request_init["core_count"] = 0
    request = request_type(**request_init)
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(
        pb_request,
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_instance_accelerator._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present

    jsonified_request["name"] = 'name_value'
    jsonified_request["coreCount"] = 1073
    ...
    assert "name" in jsonified_request
    assert jsonified_request["name"] == 'name_value'
    assert "coreCount" in jsonified_request
    assert jsonified_request["coreCount"] == 1073
...
def test_set_instance_accelerator_rest_unset_required_fields():
    transport = transports.NotebookServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.set_instance_accelerator._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", "type", "coreCount", )))


def test_set_instance_machine_type_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
...
def test_set_instance_machine_type_rest_required_fields(request_type=service.SetInstanceMachineTypeRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_instance_machine_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_instance_machine_type_rest_unset_required_fields():
    transport = transports.NotebookServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.set_instance_machine_type._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", "machineType", )))


def test_set_instance_labels_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
...
def test_set_instance_labels_rest_required_fields(request_type=service.SetInstanceLabelsRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_instance_labels._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_instance_labels_rest_unset_required_fields():
    transport = transports.NotebookServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.set_instance_labels._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_report_instance_info_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
...
def test_report_instance_info_rest_required_fields(request_type=service.ReportInstanceInfoRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).report_instance_info._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present

    jsonified_request["name"] = 'name_value'
    jsonified_request["vmId"] = 'vm_id_value'
    ...
    assert "name" in jsonified_request
    assert jsonified_request["name"] == 'name_value'
    assert "vmId" in jsonified_request
    assert jsonified_request["vmId"] == 'vm_id_value'
...
def test_report_instance_info_rest_unset_required_fields():
    transport = transports.NotebookServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.report_instance_info._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", "vmId", )))


def test_is_instance_upgradeable_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
...
def test_is_instance_upgradeable_rest_required_fields(request_type=service.IsInstanceUpgradeableRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).is_instance_upgradeable._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = service.IsInstanceUpgradeableResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = service.IsInstanceUpgradeableResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_is_instance_upgradeable_rest_unset_required_fields():
    transport = transports.NotebookServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.is_instance_upgradeable._get_unset_required_fields({})
...
def test_upgrade_instance_internal_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
...
def test_upgrade_instance_internal_rest_required_fields(request_type=service.UpgradeInstanceInternalRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).upgrade_instance_internal._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_upgrade_instance_internal_rest_unset_required_fields():
    transport = transports.NotebookServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.upgrade_instance_internal._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", "vmId", )))
...
def test_list_environments_rest_required_fields(request_type=service.ListEnvironmentsRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_environments._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_environment_rest_required_fields(request_type=service.GetEnvironmentRequest):
    transport_class = transports.NotebookServiceRestTransport
...
def test_create_environment_rest_required_fields(request_type=service.CreateEnvironmentRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_environment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_environment._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("environment_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_environment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("environmentId", )) & set(("parent", "environmentId", "environment", )))
...
def test_delete_environment_rest_required_fields(request_type=service.DeleteEnvironmentRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_environment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_instances") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_list_instances") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListInstancesResponse.to_json(service.ListInstancesResponse())
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_instance") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_get_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_create_instance") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_create_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_create_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_register_instance_rest_bad_request(request_type=service.RegisterInstanceRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_register_instance_rest_call_success(request_type):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_register_instance_rest_interceptors(null_interceptor):
    transport = transports.NotebookServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NotebookServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_register_instance") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_register_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_register_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.RegisterInstanceRequest.pb(service.RegisterInstanceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.register_instance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_instance_accelerator_rest_bad_request(request_type=service.SetInstanceAcceleratorRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_instance_accelerator_rest_call_success(request_type):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_set_instance_accelerator_rest_interceptors(null_interceptor):
    transport = transports.NotebookServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NotebookServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_set_instance_accelerator") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_set_instance_accelerator_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_set_instance_accelerator") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.SetInstanceAcceleratorRequest.pb(service.SetInstanceAcceleratorRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.set_instance_accelerator(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_instance_machine_type_rest_bad_request(request_type=service.SetInstanceMachineTypeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_instance_machine_type_rest_call_success(request_type):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_set_instance_machine_type_rest_interceptors(null_interceptor):
    transport = transports.NotebookServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NotebookServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_set_instance_machine_type") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_set_instance_machine_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_set_instance_machine_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.SetInstanceMachineTypeRequest.pb(service.SetInstanceMachineTypeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.set_instance_machine_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_instance_labels_rest_bad_request(request_type=service.SetInstanceLabelsRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_instance_labels_rest_call_success(request_type):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_set_instance_labels_rest_interceptors(null_interceptor):
    transport = transports.NotebookServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NotebookServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_set_instance_labels") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_set_instance_labels_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_set_instance_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.SetInstanceLabelsRequest.pb(service.SetInstanceLabelsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.set_instance_labels(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_delete_instance") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_delete_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_delete_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_start_instance_rest_bad_request(request_type=service.StartInstanceRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_start_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_start_instance") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_start_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_start_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_stop_instance_rest_bad_request(request_type=service.StopInstanceRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_stop_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_stop_instance") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_stop_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_stop_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_reset_instance_rest_bad_request(request_type=service.ResetInstanceRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_reset_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_reset_instance") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_reset_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_reset_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_report_instance_info_rest_bad_request(request_type=service.ReportInstanceInfoRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_report_instance_info_rest_call_success(request_type):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_report_instance_info_rest_interceptors(null_interceptor):
    transport = transports.NotebookServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NotebookServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_report_instance_info") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_report_instance_info_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_report_instance_info") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.ReportInstanceInfoRequest.pb(service.ReportInstanceInfoRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.report_instance_info(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_is_instance_upgradeable_rest_bad_request(request_type=service.IsInstanceUpgradeableRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_is_instance_upgradeable_rest_call_success(request_type):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_is_instance_upgradeable_rest_interceptors(null_interceptor):
    transport = transports.NotebookServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NotebookServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_is_instance_upgradeable") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_is_instance_upgradeable_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_is_instance_upgradeable") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.IsInstanceUpgradeableRequest.pb(service.IsInstanceUpgradeableRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.IsInstanceUpgradeableResponse.to_json(service.IsInstanceUpgradeableResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = service.IsInstanceUpgradeableResponse()
        post_with_metadata.return_value = service.IsInstanceUpgradeableResponse(), metadata

        client.is_instance_upgradeable(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_upgrade_instance_rest_bad_request(request_type=service.UpgradeInstanceRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_upgrade_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_upgrade_instance") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_upgrade_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_upgrade_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_upgrade_instance_internal_rest_bad_request(request_type=service.UpgradeInstanceInternalRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_upgrade_instance_internal_rest_call_success(request_type):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_upgrade_instance_internal_rest_interceptors(null_interceptor):
    transport = transports.NotebookServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NotebookServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_upgrade_instance_internal") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_upgrade_instance_internal_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_upgrade_instance_internal") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.UpgradeInstanceInternalRequest.pb(service.UpgradeInstanceInternalRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.upgrade_instance_internal(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_environments_rest_bad_request(request_type=service.ListEnvironmentsRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_environments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_environments") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_environments_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_list_environments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.ListEnvironmentsRequest.pb(service.ListEnvironmentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListEnvironmentsResponse.to_json(service.ListEnvironmentsResponse())
        req.return_value.content = return_value
        ...
        client.list_environments(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_environment") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_environment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_get_environment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        post_with_metadata.return_value = environment.Environment(), metadata
...
def test_create_environment_rest_bad_request(request_type=service.CreateEnvironmentRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_environment_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["environment"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'vm_image': {'project': 'project_value', 'image_name': 'image_name_value', 'image_family': 'image_family_value'}, 'container_image': {'repository': 'repository_value', 'tag': 'tag_value'}, 'post_startup_script': 'post_startup_script_value', 'create_time': {'seconds': 751, 'nanos': 543}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_create_environment") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_create_environment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_create_environment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.CreateEnvironmentRequest.pb(service.CreateEnvironmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_environment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_environment_rest_bad_request(request_type=service.DeleteEnvironmentRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_delete_environment") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_delete_environment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_delete_environment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.DeleteEnvironmentRequest.pb(service.DeleteEnvironmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_environment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_register_instance_empty_call_rest():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_instance_accelerator_empty_call_rest():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_instance_machine_type_empty_call_rest():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_instance_labels_empty_call_rest():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_report_instance_info_empty_call_rest():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_is_instance_upgradeable_empty_call_rest():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_upgrade_instance_internal_empty_call_rest():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_notebook_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.notebooks_v1beta1.services.notebook_service.transports.NotebookServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_notebook_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.notebooks_v1beta1.services.notebook_service.transports.NotebookServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NotebookServiceTransport()
        adc.assert_called_once()
...
def test_notebook_service_host_no_port(transport_name):
    ...
    assert client.transport._host == (
        'notebooks.googleapis.com:443'
        if transport_name in ['grpc', 'grpc_asyncio']
        else 'https://notebooks.googleapis.com'
    )
...
def test_notebook_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        'notebooks.googleapis.com:8000'
        if transport_name in ['grpc', 'grpc_asyncio']
        else 'https://notebooks.googleapis.com:8000'
    )
...
def test_notebook_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.register_instance._session
    session2 = client2.transport.register_instance._session
    assert session1 != session2
    session1 = client1.transport.set_instance_accelerator._session
    session2 = client2.transport.set_instance_accelerator._session
    assert session1 != session2
    session1 = client1.transport.set_instance_machine_type._session
    session2 = client2.transport.set_instance_machine_type._session
    assert session1 != session2
    session1 = client1.transport.set_instance_labels._session
    session2 = client2.transport.set_instance_labels._session
    assert session1 != session2
    ...
    assert session1 != session2
    session1 = client1.transport.report_instance_info._session
    session2 = client2.transport.report_instance_info._session
    assert session1 != session2
    session1 = client1.transport.is_instance_upgradeable._session
    session2 = client2.transport.is_instance_upgradeable._session
    assert session1 != session2
    session1 = client1.transport.upgrade_instance._session
    session2 = client2.transport.upgrade_instance._session
    assert session1 != session2
    session1 = client1.transport.upgrade_instance_internal._session
    session2 = client2.transport.upgrade_instance_internal._session
    assert session1 != session2

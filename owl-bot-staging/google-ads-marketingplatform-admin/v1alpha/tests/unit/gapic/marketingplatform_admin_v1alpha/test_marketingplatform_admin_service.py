...
def test_get_organization_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = resources.Organization.to_json(resources.Organization())
...
def test_get_organization_rest_bad_request(transport: str = 'rest', request_type=marketingplatform_admin.GetOrganizationRequest):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_analytics_account_links_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = marketingplatform_admin.ListAnalyticsAccountLinksResponse.to_json(marketingplatform_admin.ListAnalyticsAccountLinksResponse())
...
def test_list_analytics_account_links_rest_bad_request(transport: str = 'rest', request_type=marketingplatform_admin.ListAnalyticsAccountLinksRequest):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_analytics_account_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = resources.AnalyticsAccountLink.to_json(resources.AnalyticsAccountLink())
...
def test_create_analytics_account_link_rest_bad_request(transport: str = 'rest', request_type=marketingplatform_admin.CreateAnalyticsAccountLinkRequest):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_analytics_account_link_rest_bad_request(transport: str = 'rest', request_type=marketingplatform_admin.DeleteAnalyticsAccountLinkRequest):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_property_service_level_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = marketingplatform_admin.SetPropertyServiceLevelResponse.to_json(marketingplatform_admin.SetPropertyServiceLevelResponse())
...
def test_set_property_service_level_rest_bad_request(transport: str = 'rest', request_type=marketingplatform_admin.SetPropertyServiceLevelRequest):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

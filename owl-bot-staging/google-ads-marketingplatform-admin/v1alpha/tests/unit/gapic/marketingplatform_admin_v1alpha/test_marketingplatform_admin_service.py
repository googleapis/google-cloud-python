...
from google.ads.marketingplatform_admin_v1alpha.services.marketingplatform_admin_service import MarketingplatformAdminServiceAsyncClient
from google.ads.marketingplatform_admin_v1alpha.services.marketingplatform_admin_service import MarketingplatformAdminServiceClient
from google.ads.marketingplatform_admin_v1alpha.services.marketingplatform_admin_service import pagers
from google.ads.marketingplatform_admin_v1alpha.services.marketingplatform_admin_service import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert MarketingplatformAdminServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert MarketingplatformAdminServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert MarketingplatformAdminServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert MarketingplatformAdminServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert MarketingplatformAdminServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert MarketingplatformAdminServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert MarketingplatformAdminServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert MarketingplatformAdminServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert MarketingplatformAdminServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert MarketingplatformAdminServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert MarketingplatformAdminServiceClient._get_client_cert_source(None, False) is None
    assert MarketingplatformAdminServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert MarketingplatformAdminServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert MarketingplatformAdminServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert MarketingplatformAdminServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(MarketingplatformAdminServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MarketingplatformAdminServiceClient))
@mock.patch.object(MarketingplatformAdminServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MarketingplatformAdminServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = MarketingplatformAdminServiceClient._DEFAULT_UNIVERSE
    default_endpoint = MarketingplatformAdminServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = MarketingplatformAdminServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert MarketingplatformAdminServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert MarketingplatformAdminServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == MarketingplatformAdminServiceClient.DEFAULT_MTLS_ENDPOINT
    assert MarketingplatformAdminServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert MarketingplatformAdminServiceClient._get_api_endpoint(None, None, default_universe, "always") == MarketingplatformAdminServiceClient.DEFAULT_MTLS_ENDPOINT
    assert MarketingplatformAdminServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == MarketingplatformAdminServiceClient.DEFAULT_MTLS_ENDPOINT
    assert MarketingplatformAdminServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert MarketingplatformAdminServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        MarketingplatformAdminServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert MarketingplatformAdminServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert MarketingplatformAdminServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert MarketingplatformAdminServiceClient._get_universe_domain(None, None) == MarketingplatformAdminServiceClient._DEFAULT_UNIVERSE
...
def test_marketingplatform_admin_service_client_from_service_account_info(client_class, transport_name):
...
def test_marketingplatform_admin_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_marketingplatform_admin_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (MarketingplatformAdminServiceClient, transports.MarketingplatformAdminServiceGrpcTransport, "grpc"),
    (MarketingplatformAdminServiceAsyncClient, transports.MarketingplatformAdminServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (MarketingplatformAdminServiceClient, transports.MarketingplatformAdminServiceRestTransport, "rest"),
])
@mock.patch.object(MarketingplatformAdminServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MarketingplatformAdminServiceClient))
@mock.patch.object(MarketingplatformAdminServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MarketingplatformAdminServiceAsyncClient))
def test_marketingplatform_admin_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(MarketingplatformAdminServiceClient, 'get_transport_class') as gtc:
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (MarketingplatformAdminServiceClient, transports.MarketingplatformAdminServiceGrpcTransport, "grpc", "true"),
    (MarketingplatformAdminServiceAsyncClient, transports.MarketingplatformAdminServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (MarketingplatformAdminServiceClient, transports.MarketingplatformAdminServiceGrpcTransport, "grpc", "false"),
    (MarketingplatformAdminServiceAsyncClient, transports.MarketingplatformAdminServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (MarketingplatformAdminServiceClient, transports.MarketingplatformAdminServiceRestTransport, "rest", "true"),
    (MarketingplatformAdminServiceClient, transports.MarketingplatformAdminServiceRestTransport, "rest", "false"),
])
@mock.patch.object(MarketingplatformAdminServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MarketingplatformAdminServiceClient))
@mock.patch.object(MarketingplatformAdminServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MarketingplatformAdminServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_marketingplatform_admin_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(MarketingplatformAdminServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(MarketingplatformAdminServiceClient))
@mock.patch.object(MarketingplatformAdminServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(MarketingplatformAdminServiceAsyncClient))
def test_marketingplatform_admin_service_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_marketingplatform_admin_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (MarketingplatformAdminServiceClient, transports.MarketingplatformAdminServiceGrpcTransport, "grpc", grpc_helpers),
    (MarketingplatformAdminServiceAsyncClient, transports.MarketingplatformAdminServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (MarketingplatformAdminServiceClient, transports.MarketingplatformAdminServiceRestTransport, "rest", None),
])
def test_marketingplatform_admin_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_marketingplatform_admin_service_client_client_options_from_dict():
    with mock.patch('google.ads.marketingplatform_admin_v1alpha.services.marketingplatform_admin_service.transports.MarketingplatformAdminServiceGrpcTransport.__init__') as grpc_transport:
...
def test_marketingplatform_admin_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_get_organization_async(transport: str = 'grpc_asyncio', request_type=marketingplatform_admin.GetOrganizationRequest):
    client = MarketingplatformAdminServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.Organization(
            name='name_value',
            display_name='display_name_value',
        ))
...
def test_list_analytics_account_links_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_analytics_account_links in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_analytics_account_links] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_analytics_account_links_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MarketingplatformAdminServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_analytics_account_links in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_analytics_account_links] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_analytics_account_links_async(transport: str = 'grpc_asyncio', request_type=marketingplatform_admin.ListAnalyticsAccountLinksRequest):
    client = MarketingplatformAdminServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(marketingplatform_admin.ListAnalyticsAccountLinksResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_analytics_account_links_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_analytics_account_links(request={}, retry=retry, timeout=timeout)
        ...
        assert all(isinstance(i, resources.AnalyticsAccountLink)
                   for i in results)
...
async def test_list_analytics_account_links_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_analytics_account_links(request={},)
...
def test_create_analytics_account_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_analytics_account_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.display_name == 'display_name_value'
    assert response.link_verification_state == resources.LinkVerificationState.LINK_VERIFICATION_STATE_VERIFIED
...
def test_create_analytics_account_link_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_analytics_account_link in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_analytics_account_link] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_analytics_account_link_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MarketingplatformAdminServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_analytics_account_link in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_analytics_account_link] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_analytics_account_link_async(transport: str = 'grpc_asyncio', request_type=marketingplatform_admin.CreateAnalyticsAccountLinkRequest):
    client = MarketingplatformAdminServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.AnalyticsAccountLink(
            name='name_value',
            analytics_account='analytics_account_value',
            display_name='display_name_value',
            link_verification_state=resources.LinkVerificationState.LINK_VERIFICATION_STATE_VERIFIED,
...
def test_delete_analytics_account_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_analytics_account_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_analytics_account_link_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_analytics_account_link in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_analytics_account_link] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_analytics_account_link_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MarketingplatformAdminServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_analytics_account_link in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_analytics_account_link] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_analytics_account_link_async(transport: str = 'grpc_asyncio', request_type=marketingplatform_admin.DeleteAnalyticsAccountLinkRequest):
    client = MarketingplatformAdminServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_set_property_service_level(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.set_property_service_level),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_set_property_service_level_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.set_property_service_level in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_property_service_level] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_set_property_service_level_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MarketingplatformAdminServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.set_property_service_level in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.set_property_service_level] = mock_rpc
...
@pytest.mark.asyncio
async def test_set_property_service_level_async(transport: str = 'grpc_asyncio', request_type=marketingplatform_admin.SetPropertyServiceLevelRequest):
    client = MarketingplatformAdminServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_organization_rest_required_fields(request_type=marketingplatform_admin.GetOrganizationRequest):
...
def test_get_organization_rest_unset_required_fields():
    transport = transports.MarketingplatformAdminServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_organization_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/{name=organizations/*}" % client.transport._host, args[1])
...
def test_list_analytics_account_links_rest_required_fields(request_type=marketingplatform_admin.ListAnalyticsAccountLinksRequest):
    transport_class = transports.MarketingplatformAdminServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_analytics_account_links._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = marketingplatform_admin.ListAnalyticsAccountLinksResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_analytics_account_links_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=organizations/*}/analyticsAccountLinks" % client.transport._host, args[1])
...
def test_list_analytics_account_links_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(marketingplatform_admin.ListAnalyticsAccountLinksResponse.to_json(x) for x in response)
...
def test_create_analytics_account_link_rest_required_fields(request_type=marketingplatform_admin.CreateAnalyticsAccountLinkRequest):
    transport_class = transports.MarketingplatformAdminServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_analytics_account_link._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_analytics_account_link_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "analyticsAccountLink", )))
...
def test_delete_analytics_account_link_rest_required_fields(request_type=marketingplatform_admin.DeleteAnalyticsAccountLinkRequest):
    transport_class = transports.MarketingplatformAdminServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_analytics_account_link._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_analytics_account_link_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=organizations/*/analyticsAccountLinks/*}" % client.transport._host, args[1])
...
def test_set_property_service_level_rest_required_fields(request_type=marketingplatform_admin.SetPropertyServiceLevelRequest):
    transport_class = transports.MarketingplatformAdminServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_property_service_level._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = marketingplatform_admin.SetPropertyServiceLevelResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_set_property_service_level_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("analyticsAccountLink", "analyticsProperty", "serviceLevel", )))
...
def test_set_property_service_level_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'analytics_account_link': 'organizations/sample1/analyticsAccountLinks/sample2'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{analytics_account_link=organizations/*/analyticsAccountLinks/*}:setPropertyServiceLevel" % client.transport._host, args[1])
...
def test_transport_kind_grpc_asyncio():
    transport = MarketingplatformAdminServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_get_organization_rest_bad_request(request_type=marketingplatform_admin.GetOrganizationRequest):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_organization_rest_interceptors(null_interceptor):
    transport = transports.MarketingplatformAdminServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MarketingplatformAdminServiceRestInterceptor(),
        )
    client = MarketingplatformAdminServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "post_get_organization") as post, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "post_get_organization_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "pre_get_organization") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = marketingplatform_admin.GetOrganizationRequest.pb(marketingplatform_admin.GetOrganizationRequest())
...
def test_list_analytics_account_links_rest_bad_request(request_type=marketingplatform_admin.ListAnalyticsAccountLinksRequest):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_analytics_account_links_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "post_list_analytics_account_links") as post, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "post_list_analytics_account_links_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "pre_list_analytics_account_links") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = marketingplatform_admin.ListAnalyticsAccountLinksRequest.pb(marketingplatform_admin.ListAnalyticsAccountLinksRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = marketingplatform_admin.ListAnalyticsAccountLinksResponse.to_json(marketingplatform_admin.ListAnalyticsAccountLinksResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = marketingplatform_admin.ListAnalyticsAccountLinksResponse(), metadata

        client.list_analytics_account_links(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_analytics_account_link_rest_bad_request(request_type=marketingplatform_admin.CreateAnalyticsAccountLinkRequest):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_analytics_account_link_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'organizations/sample1'}
    request_init["analytics_account_link"] = {'name': 'name_value', 'analytics_account': 'analytics_account_value', 'display_name': 'display_name_value', 'link_verification_state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = marketingplatform_admin.CreateAnalyticsAccountLinkRequest.meta.fields["analytics_account_link"]
    ...
    for field, value in request_init["analytics_account_link"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_analytics_account_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "post_create_analytics_account_link") as post, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "post_create_analytics_account_link_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "pre_create_analytics_account_link") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = marketingplatform_admin.CreateAnalyticsAccountLinkRequest.pb(marketingplatform_admin.CreateAnalyticsAccountLinkRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = resources.AnalyticsAccountLink.to_json(resources.AnalyticsAccountLink())
        req.return_value.content = return_value
        ...
        client.create_analytics_account_link(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_analytics_account_link_rest_bad_request(request_type=marketingplatform_admin.DeleteAnalyticsAccountLinkRequest):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_analytics_account_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "pre_delete_analytics_account_link") as pre:
        pre.assert_not_called()
        pb_message = marketingplatform_admin.DeleteAnalyticsAccountLinkRequest.pb(marketingplatform_admin.DeleteAnalyticsAccountLinkRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_analytics_account_link(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_set_property_service_level_rest_bad_request(request_type=marketingplatform_admin.SetPropertyServiceLevelRequest):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'analytics_account_link': 'organizations/sample1/analyticsAccountLinks/sample2'}
    request = request_type(**request_init)
...
def test_set_property_service_level_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "post_set_property_service_level") as post, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "post_set_property_service_level_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MarketingplatformAdminServiceRestInterceptor, "pre_set_property_service_level") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = marketingplatform_admin.SetPropertyServiceLevelRequest.pb(marketingplatform_admin.SetPropertyServiceLevelRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = marketingplatform_admin.SetPropertyServiceLevelResponse.to_json(marketingplatform_admin.SetPropertyServiceLevelResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = marketingplatform_admin.SetPropertyServiceLevelResponse(), metadata

        client.set_property_service_level(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_marketingplatform_admin_service_base_transport():
    ...
    with mock.patch('google.ads.marketingplatform_admin_v1alpha.services.marketingplatform_admin_service.transports.MarketingplatformAdminServiceTransport.__init__') as Transport:
...
def test_marketingplatform_admin_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.marketingplatform_admin_v1alpha.services.marketingplatform_admin_service.transports.MarketingplatformAdminServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_marketingplatform_admin_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.marketingplatform_admin_v1alpha.services.marketingplatform_admin_service.transports.MarketingplatformAdminServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MarketingplatformAdminServiceTransport()
        adc.assert_called_once()
...
def test_marketingplatform_admin_service_transport_auth_adc(transport_class):
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        ...
        adc.assert_called_once_with(
            scopes=["1", "2"],
            default_scopes=(                'https://www.googleapis.com/auth/marketingplatformadmin.analytics.read',                'https://www.googleapis.com/auth/marketingplatformadmin.analytics.update',),
            quota_project_id="octopus",
        )
...
def test_marketingplatform_admin_service_transport_auth_gdch_credentials(transport_class):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.MarketingplatformAdminServiceGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
def test_marketingplatform_admin_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@pytest.mark.parametrize("transport_class", [transports.MarketingplatformAdminServiceGrpcTransport, transports.MarketingplatformAdminServiceGrpcAsyncIOTransport])
...
def test_marketingplatform_admin_service_host_no_port(transport_name):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='marketingplatformadmin.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'marketingplatformadmin.googleapis.com:443'
...
def test_marketingplatform_admin_service_host_with_port(transport_name):
    client = MarketingplatformAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='marketingplatformadmin.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
def test_marketingplatform_admin_service_client_transport_session_collision(transport_name):
...
def test_analytics_account_link_path():
    ...
    expected = "organizations/{organization}/analyticsAccountLinks/{analytics_account_link}".format(organization=organization, analytics_account_link=analytics_account_link, )
    actual = MarketingplatformAdminServiceClient.analytics_account_link_path(organization, analytics_account_link)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = MarketingplatformAdminServiceClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.MarketingplatformAdminServiceTransport, '_prep_wrapped_messages') as prep:
        client = MarketingplatformAdminServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize("client_class,transport_class", [
    (MarketingplatformAdminServiceClient, transports.MarketingplatformAdminServiceGrpcTransport),
    (MarketingplatformAdminServiceAsyncClient, transports.MarketingplatformAdminServiceGrpcAsyncIOTransport),
])

...
class marketingplatform_adminCallTransformer(cst.CSTTransformer):
...
def fix_files(
    ...
    *,
    transformer=marketingplatform_adminCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the marketingplatform_admin client library.

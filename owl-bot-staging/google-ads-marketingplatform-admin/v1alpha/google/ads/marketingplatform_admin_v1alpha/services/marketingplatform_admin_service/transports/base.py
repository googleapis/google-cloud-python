...
from google.ads.marketingplatform_admin_v1alpha.types import marketingplatform_admin
...
class MarketingplatformAdminServiceTransport(abc.ABC):
    ...
    @property
    def list_analytics_account_links(self) -> Callable[
    ...
    @property
    def create_analytics_account_link(self) -> Callable[
    ...
    @property
    def delete_analytics_account_link(self) -> Callable[
    ...
    @property
    def set_property_service_level(self) -> Callable[

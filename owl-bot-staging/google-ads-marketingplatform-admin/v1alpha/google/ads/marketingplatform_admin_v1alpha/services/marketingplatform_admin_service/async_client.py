...
from .transports.base import MarketingplatformAdminServiceTransport, DEFAULT_CLIENT_INFO
...
class MarketingplatformAdminServiceAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, MarketingplatformAdminServiceTransport, Callable[..., MarketingplatformAdminServiceTransport]]] = "grpc_asyncio",
    ...
    async def list_analytics_account_links(self,
    ...
    async def create_analytics_account_link(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, analytics_account_link])
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
    ...
    async def delete_analytics_account_link(self,
    ...
    async def set_property_service_level(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([analytics_account_link])
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")

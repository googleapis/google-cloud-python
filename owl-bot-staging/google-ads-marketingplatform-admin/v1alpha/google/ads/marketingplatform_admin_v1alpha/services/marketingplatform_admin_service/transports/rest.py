...
class MarketingplatformAdminServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_analytics_account_link(self, request: marketingplatform_admin.CreateAnalyticsAccountLinkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[marketingplatform_admin.CreateAnalyticsAccountLinkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_analytics_account_link_with_metadata(self, response: resources.AnalyticsAccountLink, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.AnalyticsAccountLink, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_analytics_account_link
    ...
    def pre_delete_analytics_account_link(self, request: marketingplatform_admin.DeleteAnalyticsAccountLinkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[marketingplatform_admin.DeleteAnalyticsAccountLinkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_organization(self, request: marketingplatform_admin.GetOrganizationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[marketingplatform_admin.GetOrganizationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_organization_with_metadata(self, response: resources.Organization, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.Organization, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_organization
    ...
    def pre_list_analytics_account_links(self, request: marketingplatform_admin.ListAnalyticsAccountLinksRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[marketingplatform_admin.ListAnalyticsAccountLinksRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_analytics_account_links(self, response: marketingplatform_admin.ListAnalyticsAccountLinksResponse) -> marketingplatform_admin.ListAnalyticsAccountLinksResponse:
    ...
    def post_list_analytics_account_links_with_metadata(self, response: marketingplatform_admin.ListAnalyticsAccountLinksResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[marketingplatform_admin.ListAnalyticsAccountLinksResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_analytics_account_links
    ...
    def pre_set_property_service_level(self, request: marketingplatform_admin.SetPropertyServiceLevelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[marketingplatform_admin.SetPropertyServiceLevelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_set_property_service_level(self, response: marketingplatform_admin.SetPropertyServiceLevelResponse) -> marketingplatform_admin.SetPropertyServiceLevelResponse:
    ...
    def post_set_property_service_level_with_metadata(self, response: marketingplatform_admin.SetPropertyServiceLevelResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[marketingplatform_admin.SetPropertyServiceLevelResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for set_property_service_level
...
class MarketingplatformAdminServiceRestTransport(_BaseMarketingplatformAdminServiceRestTransport):
    ...
    class _CreateAnalyticsAccountLink(_BaseMarketingplatformAdminServiceRestTransport._BaseCreateAnalyticsAccountLink, MarketingplatformAdminServiceRestStub):
        def __hash__(self):
        ...
        link method over HTTP.
            ...
            transcoded_request = _BaseMarketingplatformAdminServiceRestTransport._BaseCreateAnalyticsAccountLink._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = MarketingplatformAdminServiceRestTransport._CreateAnalyticsAccountLink._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteAnalyticsAccountLink(_BaseMarketingplatformAdminServiceRestTransport._BaseDeleteAnalyticsAccountLink, MarketingplatformAdminServiceRestStub):
        def __hash__(self):
        ...
        link method over HTTP.
            ...
            transcoded_request = _BaseMarketingplatformAdminServiceRestTransport._BaseDeleteAnalyticsAccountLink._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = MarketingplatformAdminServiceRestTransport._DeleteAnalyticsAccountLink._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOrganization(_BaseMarketingplatformAdminServiceRestTransport._BaseGetOrganization, MarketingplatformAdminServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MarketingplatformAdminServiceRestTransport._GetOrganization._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListAnalyticsAccountLinks(_BaseMarketingplatformAdminServiceRestTransport._BaseListAnalyticsAccountLinks, MarketingplatformAdminServiceRestStub):
        def __hash__(self):
        ...
        links method over HTTP.
            ...
            transcoded_request = _BaseMarketingplatformAdminServiceRestTransport._BaseListAnalyticsAccountLinks._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = MarketingplatformAdminServiceRestTransport._ListAnalyticsAccountLinks._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetPropertyServiceLevel(_BaseMarketingplatformAdminServiceRestTransport._BaseSetPropertyServiceLevel, MarketingplatformAdminServiceRestStub):
        def __hash__(self):
        ...
        level method over HTTP.
            ...
            transcoded_request = _BaseMarketingplatformAdminServiceRestTransport._BaseSetPropertyServiceLevel._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = MarketingplatformAdminServiceRestTransport._SetPropertyServiceLevel._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

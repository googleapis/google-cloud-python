...
class live_streamCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'create_clip': ('parent', 'clip_id', 'clip', 'request_id', ),
        'create_dvr_session': ('parent', 'dvr_session_id', 'dvr_session', 'request_id', ),
        ...
        'delete_clip': ('name', 'request_id', ),
        'delete_dvr_session': ('name', 'request_id', ),
        'delete_event': ('name', 'request_id', ),
        'delete_input': ('name', 'request_id', ),
        'get_asset': ('name', ),
        'get_channel': ('name', ),
        'get_clip': ('name', ),
        'get_dvr_session': ('name', ),
        'get_event': ('name', ),
        'get_input': ('name', ),
        'get_pool': ('name', ),
        'list_assets': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        'list_channels': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        'list_clips': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        'list_dvr_sessions': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        ...
        'update_dvr_session': ('update_mask', 'dvr_session', 'request_id', ),
...
def fix_files(
    ...
    *,
    transformer=live_streamCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the live_stream client library.

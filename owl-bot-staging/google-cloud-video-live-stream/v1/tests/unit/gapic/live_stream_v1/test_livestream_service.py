...
from google.cloud.video.live_stream_v1.services.livestream_service import LivestreamServiceAsyncClient
...
def test__read_environment_variables():
    assert LivestreamServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert LivestreamServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert LivestreamServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert LivestreamServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert LivestreamServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert LivestreamServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert LivestreamServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert LivestreamServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert LivestreamServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(LivestreamServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LivestreamServiceClient))
@mock.patch.object(LivestreamServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LivestreamServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = LivestreamServiceClient._DEFAULT_UNIVERSE
    default_endpoint = LivestreamServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = LivestreamServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert LivestreamServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert LivestreamServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == LivestreamServiceClient.DEFAULT_MTLS_ENDPOINT
    assert LivestreamServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert LivestreamServiceClient._get_api_endpoint(None, None, default_universe, "always") == LivestreamServiceClient.DEFAULT_MTLS_ENDPOINT
    assert LivestreamServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == LivestreamServiceClient.DEFAULT_MTLS_ENDPOINT
    assert LivestreamServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert LivestreamServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        LivestreamServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert LivestreamServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert LivestreamServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert LivestreamServiceClient._get_universe_domain(None, None) == LivestreamServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (LivestreamServiceClient, transports.LivestreamServiceRestTransport, "rest", "true"),
    (LivestreamServiceClient, transports.LivestreamServiceRestTransport, "rest", "false"),
])
@mock.patch.object(LivestreamServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LivestreamServiceClient))
@mock.patch.object(LivestreamServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LivestreamServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    LivestreamServiceClient, LivestreamServiceAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (LivestreamServiceClient, transports.LivestreamServiceGrpcTransport, "grpc", grpc_helpers),
    (LivestreamServiceAsyncClient, transports.LivestreamServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (LivestreamServiceClient, transports.LivestreamServiceRestTransport, "rest", None),
])
...
@pytest.mark.asyncio
async def test_start_channel_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LivestreamServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.start_channel in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.start_channel] = mock_rpc
...
@pytest.mark.asyncio
async def test_stop_channel_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LivestreamServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.stop_channel in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.stop_channel] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_input_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LivestreamServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_input in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_input] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_inputs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LivestreamServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_inputs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_inputs] = mock_rpc
...
async def test_get_input_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_input in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_input] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_input_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LivestreamServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_input in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_input] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_input_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LivestreamServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_input in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_input] = mock_rpc
...
def test_list_clips(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_clips),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_list_clips_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_clips in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_clips] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_clips_async(transport: str = 'grpc_asyncio', request_type=service.ListClipsRequest):
    client = LivestreamServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(service.ListClipsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_clips_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Clip)
                   for i in results)
...
async def test_list_clips_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_clips(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_clip(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_clip),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_get_clip_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_clip in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_clip] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_clip_async(transport: str = 'grpc_asyncio', request_type=service.GetClipRequest):
    client = LivestreamServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_clip(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_clip),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_clip_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LivestreamServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_clip in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_clip] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_clip_async(transport: str = 'grpc_asyncio', request_type=service.CreateClipRequest):
    client = LivestreamServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_clip(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_clip),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_clip_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LivestreamServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_clip in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_clip] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_clip_async(transport: str = 'grpc_asyncio', request_type=service.DeleteClipRequest):
    client = LivestreamServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_get_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_pool] = mock_rpc
...
def test_update_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LivestreamServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_pool] = mock_rpc
...
def test_list_clips_rest_required_fields(request_type=service.ListClipsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_clips._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_clips_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/channels/*}/clips" % client.transport._host, args[1])
...
def test_get_clip_rest_required_fields(request_type=service.GetClipRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_clip._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_clip_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/channels/sample3/clips/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/channels/*/clips/*}" % client.transport._host, args[1])
...
def test_create_clip_rest_required_fields(request_type=service.CreateClipRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_clip._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_clip._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("clip_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_clip_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("clipId", "requestId", )) & set(("parent", "clipId", "clip", )))
...
def test_delete_clip_rest_required_fields(request_type=service.DeleteClipRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_clip._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_channel_rest_interceptors(null_interceptor):
    transport = transports.LivestreamServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.LivestreamServiceRestInterceptor(),
        )
    client = LivestreamServiceClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_create_channel") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_create_channel_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_create_channel") as pre:
...
def test_list_channels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_list_channels") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_list_channels_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_list_channels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListChannelsResponse.to_json(service.ListChannelsResponse())
        req.return_value.content = return_value
...
def test_get_channel_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_channel") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_channel_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_get_channel") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_channel_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_delete_channel") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_delete_channel_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_delete_channel") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_channel_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_update_channel") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_update_channel_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_update_channel") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_start_channel_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_start_channel") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_start_channel_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_start_channel") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_stop_channel_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_stop_channel") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_stop_channel_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_stop_channel") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_input_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_create_input") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_create_input_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_create_input") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_inputs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_list_inputs") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_list_inputs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_list_inputs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_input_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_input") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_input_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_get_input") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_input_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_delete_input") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_delete_input_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_delete_input") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_input_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_update_input") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_update_input_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_update_input") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_create_event") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_create_event_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_create_event") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_list_events") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_list_events_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_list_events") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_event") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_event_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_get_event") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_delete_event") as pre:
        pre.assert_not_called()
...
def test_list_clips_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_list_clips") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_list_clips_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_list_clips") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_clips(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_clip_rest_bad_request(request_type=service.GetClipRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/channels/sample3/clips/sample4'}
    request = request_type(**request_init)
...
def test_get_clip_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_clip") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_clip_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_get_clip") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_clip(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_clip_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_create_clip") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_create_clip_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_create_clip") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_clip(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_clip_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_delete_clip") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_delete_clip_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_delete_clip") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_clip(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_asset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_create_asset") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_create_asset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_create_asset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_asset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_delete_asset") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_delete_asset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_delete_asset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_asset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_asset") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_asset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_get_asset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_assets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_list_assets") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_list_assets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_list_assets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_pool") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_get_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_get_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_update_pool") as post, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "post_update_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LivestreamServiceRestInterceptor, "pre_update_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_clip_path():
    ...
    channel = "whelk"
    clip = "octopus"
    expected = "projects/{project}/locations/{location}/channels/{channel}/clips/{clip}".format(project=project, location=location, channel=channel, clip=clip, )
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (LivestreamServiceAsyncClient, transports.LivestreamServiceGrpcAsyncIOTransport),
])

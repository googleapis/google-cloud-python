...
class LivestreamServiceClient(metaclass=LivestreamServiceClientMeta):
    ...
    def clip_path(project: str,location: str,channel: str,clip: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/channels/{channel}/clips/{clip}".format(project=project, location=location, channel=channel, clip=clip, )
    ...
    def dvr_session_path(project: str,location: str,channel: str,dvr_session: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/channels/{channel}/dvrSessions/{dvr_session}".format(project=project, location=location, channel=channel, dvr_session=dvr_session, )
    ...
    def event_path(project: str,location: str,channel: str,event: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/channels/{channel}/events/{event}".format(project=project, location=location, channel=channel, event=event, )
    ...
    def input_path(project: str,location: str,input: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/inputs/{input}".format(project=project, location=location, input=input, )
    ...
    def pool_path(project: str,location: str,pool: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/pools/{pool}".format(project=project, location=location, pool=pool, )

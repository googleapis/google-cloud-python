...
class LivestreamServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = LivestreamServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    clip_path = staticmethod(LivestreamServiceClient.clip_path)
    parse_clip_path = staticmethod(LivestreamServiceClient.parse_clip_path)
    dvr_session_path = staticmethod(LivestreamServiceClient.dvr_session_path)
    parse_dvr_session_path = staticmethod(LivestreamServiceClient.parse_dvr_session_path)
    ...
    parse_secret_version_path = staticmethod(LivestreamServiceClient.parse_secret_version_path)
    common_billing_account_path = staticmethod(LivestreamServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(LivestreamServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(LivestreamServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(LivestreamServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(LivestreamServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(LivestreamServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(LivestreamServiceClient.common_project_path)
    parse_common_project_path = staticmethod(LivestreamServiceClient.parse_common_project_path)
    common_location_path = staticmethod(LivestreamServiceClient.common_location_path)
    parse_common_location_path = staticmethod(LivestreamServiceClient.parse_common_location_path)
    ...
    get_transport_class = LivestreamServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, LivestreamServiceTransport, Callable[..., LivestreamServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.video.livestream_v1.LivestreamServiceAsyncClient`.",
                extra = {
    ...
    async def update_channel(self,
        ...
        Args:
            ...
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                ...
                If the mask is not present, then each field from the
                list above is updated if the field appears in the
                request payload. To unset a field, add the field to the
                update mask and remove it from the request payload.
    ...
    async def start_channel(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.start_channel]
    ...
    async def stop_channel(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.stop_channel]
    ...
    async def start_distribution(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.start_distribution]
    ...
    async def stop_distribution(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.stop_distribution]
    ...
    async def create_input(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, input, input_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_input]
    ...
    async def list_inputs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_inputs]
    ...
    async def get_input(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_input]
    ...
    async def delete_input(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_input]
    ...
    async def update_input(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [input, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_input]
    ...
    async def preview_input(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.preview_input]
    ...
    async def create_event(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_event]
    ...
    async def list_events(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_events]
    ...
    async def get_event(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_event]
    ...
    async def delete_event(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_event]
    ...
    async def list_clips(self,
            request: Optional[Union[service.ListClipsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListClipsAsyncPager:
        r"""Returns a list of all clips in the specified channel.
        ...
        Args:
            request (Optional[Union[google.cloud.video.live_stream_v1.types.ListClipsRequest, dict]]):
                The request object. Request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.ListClipsRequest):
            request = service.ListClipsRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_clips]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListClipsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_clip(self,
            request: Optional[Union[service.GetClipRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.GetClipRequest):
            request = service.GetClipRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_clip]
    ...
    async def create_clip(self,
            request: Optional[Union[service.CreateClipRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            clip: Optional[resources.Clip] = None,
            clip_id: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation_async.AsyncOperation:
        r"""Creates a clip with the provided clip ID in the
        specified channel.
        ...
        Args:
            request (Optional[Union[google.cloud.video.live_stream_v1.types.CreateClipRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            clip (:class:`google.cloud.video.live_stream_v1.types.Clip`):
                Required. The resource being created
                This corresponds to the ``clip`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            clip_id (:class:`str`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.video.live_stream_v1.types.Clip` Clip is a sub-resource under channel. Each clip represents a clipping
                   operation that generates a VOD playlist from its
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, clip, clip_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.CreateClipRequest):
            request = service.CreateClipRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_clip]
    ...
    async def delete_clip(self,
            request: Optional[Union[service.DeleteClipRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.video.live_stream_v1.types.DeleteClipRequest, dict]]):
                The request object. Request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.DeleteClipRequest):
            request = service.DeleteClipRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_clip]
    ...
    async def create_dvr_session(self,
        ...
        Args:
            request (Optional[Union[google.cloud.video.live_stream_v1.types.CreateDvrSessionRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            dvr_session (:class:`google.cloud.video.live_stream_v1.types.DvrSession`):
                Required. The resource being created
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_dvr_session]
    ...
    async def list_dvr_sessions(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListDvrSessionsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.video.live_stream_v1.types.ListDvrSessionsRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_dvr_sessions]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListDvrSessionsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_dvr_session(self,
        ...
        Args:
            request (Optional[Union[google.cloud.video.live_stream_v1.types.GetDvrSessionRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_dvr_session]
    ...
    async def delete_dvr_session(self,
        ...
        Args:
            request (Optional[Union[google.cloud.video.live_stream_v1.types.DeleteDvrSessionRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_dvr_session]
    ...
    async def update_dvr_session(self,
        ...
        Args:
            request (Optional[Union[google.cloud.video.live_stream_v1.types.UpdateDvrSessionRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_dvr_session]
    ...
    async def create_asset(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_asset]
    ...
    async def update_pool(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [pool, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_pool]

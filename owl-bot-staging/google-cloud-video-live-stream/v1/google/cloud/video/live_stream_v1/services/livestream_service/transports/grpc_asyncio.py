...
class LivestreamServiceGrpcAsyncIOTransport(LivestreamServiceTransport):
    ...
    def list_channels(self) -> Callable[
            ...
            Awaitable[service.ListChannelsResponse]]:
    ...
    @property
    def start_channel(self) -> Callable[
    ...
    @property
    def start_distribution(self) -> Callable[
    ...
    @property
    def stop_distribution(self) -> Callable[
    ...
    @property
    def create_input(self) -> Callable[
    ...
    @property
    def list_inputs(self) -> Callable[
            [service.ListInputsRequest],
            Awaitable[service.ListInputsResponse]]:
    ...
    @property
    def delete_input(self) -> Callable[
    ...
    @property
    def update_input(self) -> Callable[
    ...
    @property
    def preview_input(self) -> Callable[
            [service.PreviewInputRequest],
            Awaitable[service.PreviewInputResponse]]:
    ...
    def list_events(self) -> Callable[
            ...
            Awaitable[service.ListEventsResponse]]:
    ...
    @property
    def delete_event(self) -> Callable[
    ...
    @property
    def list_clips(self) -> Callable[
            [service.ListClipsRequest],
            Awaitable[service.ListClipsResponse]]:
    ...
    @property
    def get_clip(self) -> Callable[
            [service.GetClipRequest],
            Awaitable[resources.Clip]]:
    ...
    @property
    def create_dvr_session(self) -> Callable[
    ...
    @property
    def list_dvr_sessions(self) -> Callable[
            [service.ListDvrSessionsRequest],
            Awaitable[service.ListDvrSessionsResponse]]:
    ...
    @property
    def get_dvr_session(self) -> Callable[
            [service.GetDvrSessionRequest],
            Awaitable[resources.DvrSession]]:
    ...
    @property
    def delete_dvr_session(self) -> Callable[
    ...
    @property
    def update_dvr_session(self) -> Callable[
    ...
    def list_assets(self) -> Callable[
            ...
            Awaitable[service.ListAssetsResponse]]:
    ...
    @property
    def get_pool(self) -> Callable[
            [service.GetPoolRequest],
            Awaitable[resources.Pool]]:

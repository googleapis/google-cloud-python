...
class FleetRoutingRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_optimize_tours(self, request: fleet_routing.BatchOptimizeToursRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[fleet_routing.BatchOptimizeToursRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_optimize_tours(self, request: fleet_routing.OptimizeToursRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[fleet_routing.OptimizeToursRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_optimize_tours_with_metadata(self, response: fleet_routing.OptimizeToursResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[fleet_routing.OptimizeToursResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for optimize_tours
...
class FleetRoutingRestTransport(_BaseFleetRoutingRestTransport):
    ...
    class _BatchOptimizeTours(_BaseFleetRoutingRestTransport._BaseBatchOptimizeTours, FleetRoutingRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FleetRoutingRestTransport._BatchOptimizeTours._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _OptimizeTours(_BaseFleetRoutingRestTransport._BaseOptimizeTours, FleetRoutingRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FleetRoutingRestTransport._OptimizeTours._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseFleetRoutingRestTransport._BaseGetOperation, FleetRoutingRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FleetRoutingRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

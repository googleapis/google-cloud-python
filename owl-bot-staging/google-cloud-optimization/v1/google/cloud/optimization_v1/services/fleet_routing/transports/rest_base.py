...
class _BaseFleetRoutingRestTransport(FleetRoutingTransport):
    """Base REST backend transport for FleetRouting.
    ...
    class _BaseBatchOptimizeTours:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseFleetRoutingRestTransport._BaseBatchOptimizeTours._get_unset_required_fields(query_params))
    ...
    class _BaseOptimizeTours:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseFleetRoutingRestTransport._BaseOptimizeTours._get_unset_required_fields(query_params))
...
__all__=(
    '_BaseFleetRoutingRestTransport',
)

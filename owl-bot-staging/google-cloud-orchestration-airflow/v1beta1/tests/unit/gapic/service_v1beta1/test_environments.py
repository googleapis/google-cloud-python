...
def test_update_environment_rest_required_fields(request_type=environments.UpdateEnvironmentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_environment._get_unset_required_fields(jsonified_request)
...
def test_update_environment_rest_unset_required_fields():
    transport = transports.EnvironmentsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_fetch_database_properties_rest_required_fields(request_type=environments.FetchDatabasePropertiesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).fetch_database_properties._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

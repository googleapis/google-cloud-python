...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert EnvironmentsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert EnvironmentsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert EnvironmentsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert EnvironmentsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert EnvironmentsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert EnvironmentsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert EnvironmentsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(EnvironmentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EnvironmentsClient))
@mock.patch.object(EnvironmentsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EnvironmentsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = EnvironmentsClient._DEFAULT_UNIVERSE
    default_endpoint = EnvironmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = EnvironmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert EnvironmentsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert EnvironmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == EnvironmentsClient.DEFAULT_MTLS_ENDPOINT
    assert EnvironmentsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert EnvironmentsClient._get_api_endpoint(None, None, default_universe, "always") == EnvironmentsClient.DEFAULT_MTLS_ENDPOINT
    assert EnvironmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EnvironmentsClient.DEFAULT_MTLS_ENDPOINT
    assert EnvironmentsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert EnvironmentsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        EnvironmentsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert EnvironmentsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert EnvironmentsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = EnvironmentsClient(credentials=cred)
...
def test_update_environment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_environment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_environment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_environment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_environment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_environment] = mock_rpc
...
def test_restart_web_server_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.restart_web_server(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_restart_web_server_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EnvironmentsClient(
        ...
        # Ensure method has been cached
        assert client._transport.restart_web_server in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_restart_web_server_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.restart_web_server in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.restart_web_server] = mock_rpc
...
@pytest.mark.asyncio
async def test_check_upgrade_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.check_upgrade in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.check_upgrade] = mock_rpc
...
def test_execute_airflow_command(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.execute_airflow_command),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_execute_airflow_command_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.execute_airflow_command in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.execute_airflow_command] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_execute_airflow_command_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.execute_airflow_command in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.execute_airflow_command] = mock_rpc
...
@pytest.mark.asyncio
async def test_execute_airflow_command_async(transport: str = 'grpc_asyncio', request_type=environments.ExecuteAirflowCommandRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(environments.ExecuteAirflowCommandResponse(
            execution_id='execution_id_value',
            pod='pod_value',
            pod_namespace='pod_namespace_value',
            error='error_value',
...
def test_stop_airflow_command(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.stop_airflow_command),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_stop_airflow_command_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.stop_airflow_command in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.stop_airflow_command] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_stop_airflow_command_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.stop_airflow_command in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.stop_airflow_command] = mock_rpc
...
@pytest.mark.asyncio
async def test_stop_airflow_command_async(transport: str = 'grpc_asyncio', request_type=environments.StopAirflowCommandRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(environments.StopAirflowCommandResponse(
            is_done=True,
            output=['output_value'],
        ))
...
def test_poll_airflow_command(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.poll_airflow_command),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_poll_airflow_command_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.poll_airflow_command in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.poll_airflow_command] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_poll_airflow_command_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.poll_airflow_command in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.poll_airflow_command] = mock_rpc
...
@pytest.mark.asyncio
async def test_poll_airflow_command_async(transport: str = 'grpc_asyncio', request_type=environments.PollAirflowCommandRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(environments.PollAirflowCommandResponse(
            output_end=True,
        ))
...
@pytest.mark.asyncio
async def test_list_workloads_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_workloads in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_workloads] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_workloads_async(transport: str = 'grpc_asyncio', request_type=environments.ListWorkloadsRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(environments.ListWorkloadsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_workloads_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, environments.ListWorkloadsResponse.ComposerWorkload)
                   for i in results)
...
def test_create_user_workloads_secret(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_user_workloads_secret),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_user_workloads_secret_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_user_workloads_secret in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_user_workloads_secret] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_user_workloads_secret_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_user_workloads_secret in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_user_workloads_secret] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_user_workloads_secret_async(transport: str = 'grpc_asyncio', request_type=environments.CreateUserWorkloadsSecretRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(environments.UserWorkloadsSecret(
            name='name_value',
        ))
...
def test_get_user_workloads_secret(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_user_workloads_secret),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = environments.UserWorkloadsSecret(
            name='name_value',
...
def test_get_user_workloads_secret_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_user_workloads_secret in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_user_workloads_secret] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_user_workloads_secret_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_user_workloads_secret in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_user_workloads_secret] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_user_workloads_secret_async(transport: str = 'grpc_asyncio', request_type=environments.GetUserWorkloadsSecretRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_user_workloads_secrets_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_user_workloads_secrets in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_user_workloads_secrets] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_user_workloads_secrets_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_user_workloads_secrets in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_user_workloads_secrets] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_user_workloads_secrets_async(transport: str = 'grpc_asyncio', request_type=environments.ListUserWorkloadsSecretsRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_user_workloads_secrets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_user_workloads_secrets(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, environments.UserWorkloadsSecret)
                   for i in results)
...
async def test_list_user_workloads_secrets_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_user_workloads_secrets(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_update_user_workloads_secret(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_user_workloads_secret),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = environments.UserWorkloadsSecret(
            name='name_value',
...
def test_update_user_workloads_secret_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_user_workloads_secret in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_user_workloads_secret] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_user_workloads_secret_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_user_workloads_secret in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_user_workloads_secret] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_user_workloads_secret_async(transport: str = 'grpc_asyncio', request_type=environments.UpdateUserWorkloadsSecretRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_user_workloads_secret(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_user_workloads_secret),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_user_workloads_secret_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_user_workloads_secret in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_user_workloads_secret] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_user_workloads_secret_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_user_workloads_secret in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_user_workloads_secret] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_user_workloads_secret_async(transport: str = 'grpc_asyncio', request_type=environments.DeleteUserWorkloadsSecretRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_user_workloads_config_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_user_workloads_config_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_user_workloads_config_map_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_user_workloads_config_map in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_user_workloads_config_map] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_user_workloads_config_map_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_user_workloads_config_map in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_user_workloads_config_map] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_user_workloads_config_map_async(transport: str = 'grpc_asyncio', request_type=environments.CreateUserWorkloadsConfigMapRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_user_workloads_config_map_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_user_workloads_config_map(
            parent='parent_value',
            user_workloads_config_map=environments.UserWorkloadsConfigMap(name='name_value'),
        )
...
def test_get_user_workloads_config_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_user_workloads_config_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = environments.UserWorkloadsConfigMap(
            name='name_value',
...
def test_get_user_workloads_config_map_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_user_workloads_config_map in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_user_workloads_config_map] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_user_workloads_config_map_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_user_workloads_config_map in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_user_workloads_config_map] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_user_workloads_config_map_async(transport: str = 'grpc_asyncio', request_type=environments.GetUserWorkloadsConfigMapRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_user_workloads_config_maps_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_user_workloads_config_maps in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_user_workloads_config_maps] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_user_workloads_config_maps_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_user_workloads_config_maps in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_user_workloads_config_maps] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_user_workloads_config_maps_async(transport: str = 'grpc_asyncio', request_type=environments.ListUserWorkloadsConfigMapsRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(environments.ListUserWorkloadsConfigMapsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_user_workloads_config_maps_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_user_workloads_config_maps(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, environments.UserWorkloadsConfigMap)
                   for i in results)
...
async def test_list_user_workloads_config_maps_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_user_workloads_config_maps(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_update_user_workloads_config_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_user_workloads_config_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = environments.UserWorkloadsConfigMap(
            name='name_value',
...
def test_update_user_workloads_config_map_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_user_workloads_config_map in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_user_workloads_config_map] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_user_workloads_config_map_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_user_workloads_config_map in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_user_workloads_config_map] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_user_workloads_config_map_async(transport: str = 'grpc_asyncio', request_type=environments.UpdateUserWorkloadsConfigMapRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_user_workloads_config_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_user_workloads_config_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_user_workloads_config_map_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_user_workloads_config_map in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_user_workloads_config_map] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_user_workloads_config_map_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_user_workloads_config_map in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_user_workloads_config_map] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_user_workloads_config_map_async(transport: str = 'grpc_asyncio', request_type=environments.DeleteUserWorkloadsConfigMapRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_save_snapshot(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.save_snapshot),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_save_snapshot_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.save_snapshot in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.save_snapshot] = mock_rpc
...
@pytest.mark.asyncio
async def test_save_snapshot_async(transport: str = 'grpc_asyncio', request_type=environments.SaveSnapshotRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_load_snapshot(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.load_snapshot),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_load_snapshot_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.load_snapshot in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.load_snapshot] = mock_rpc
...
@pytest.mark.asyncio
async def test_load_snapshot_async(transport: str = 'grpc_asyncio', request_type=environments.LoadSnapshotRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_database_failover(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.database_failover),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_database_failover_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.database_failover] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_database_failover_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.database_failover in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.database_failover] = mock_rpc
...
@pytest.mark.asyncio
async def test_database_failover_async(transport: str = 'grpc_asyncio', request_type=environments.DatabaseFailoverRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_fetch_database_properties(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_database_properties),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_fetch_database_properties_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.fetch_database_properties in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.fetch_database_properties] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_fetch_database_properties_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_database_properties in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_database_properties] = mock_rpc
...
@pytest.mark.asyncio
async def test_fetch_database_properties_async(transport: str = 'grpc_asyncio', request_type=environments.FetchDatabasePropertiesRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(environments.FetchDatabasePropertiesResponse(
            primary_gce_zone='primary_gce_zone_value',
            secondary_gce_zone='secondary_gce_zone_value',
            is_failover_replica_available=True,
        ))
...
def test_create_environment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/environments" % client.transport._host, args[1])
...
def test_get_environment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/environments/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/environments/*}" % client.transport._host, args[1])
...
def test_list_environments_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(environments.ListEnvironmentsResponse.to_json(x) for x in response)
...
def test_update_environment_rest_required_fields(request_type=environments.UpdateEnvironmentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_environment._get_unset_required_fields(jsonified_request)
...
def test_update_environment_rest_unset_required_fields():
    transport = transports.EnvironmentsRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_workloads_rest_required_fields(request_type=environments.ListWorkloadsRequest):
    transport_class = transports.EnvironmentsRestTransport
...
def test_list_workloads_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/environments/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/environments/*}/workloads" % client.transport._host, args[1])
...
def test_list_workloads_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(environments.ListWorkloadsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_create_user_workloads_secret_rest_required_fields(request_type=environments.CreateUserWorkloadsSecretRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_user_workloads_secret._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_user_workloads_secret_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "userWorkloadsSecret", )))
...
def test_create_user_workloads_secret_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/environments/*}/userWorkloadsSecrets" % client.transport._host, args[1])
...
def test_get_user_workloads_secret_rest_required_fields(request_type=environments.GetUserWorkloadsSecretRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_user_workloads_secret._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_user_workloads_secret_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsSecrets/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/environments/*/userWorkloadsSecrets/*}" % client.transport._host, args[1])
...
def test_list_user_workloads_secrets_rest_required_fields(request_type=environments.ListUserWorkloadsSecretsRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_user_workloads_secrets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_user_workloads_secrets_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(environments.ListUserWorkloadsSecretsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_update_user_workloads_secret_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'user_workloads_secret': {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsSecrets/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{user_workloads_secret.name=projects/*/locations/*/environments/*/userWorkloadsSecrets/*}" % client.transport._host, args[1])
...
def test_delete_user_workloads_secret_rest_required_fields(request_type=environments.DeleteUserWorkloadsSecretRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_user_workloads_secret._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_user_workloads_config_map_rest_required_fields(request_type=environments.CreateUserWorkloadsConfigMapRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_user_workloads_config_map._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_user_workloads_config_map_rest_unset_required_fields():
    ...
    unset_fields = transport.create_user_workloads_config_map._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "userWorkloadsConfigMap", )))
...
def test_create_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/environments/*}/userWorkloadsConfigMaps" % client.transport._host, args[1])
...
def test_get_user_workloads_config_map_rest_required_fields(request_type=environments.GetUserWorkloadsConfigMapRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_user_workloads_config_map._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsConfigMaps/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/environments/*/userWorkloadsConfigMaps/*}" % client.transport._host, args[1])
...
def test_list_user_workloads_config_maps_rest_required_fields(request_type=environments.ListUserWorkloadsConfigMapsRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_user_workloads_config_maps._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_user_workloads_config_maps_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(environments.ListUserWorkloadsConfigMapsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.list_user_workloads_config_maps(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_update_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'user_workloads_config_map': {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsConfigMaps/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{user_workloads_config_map.name=projects/*/locations/*/environments/*/userWorkloadsConfigMaps/*}" % client.transport._host, args[1])
...
def test_delete_user_workloads_config_map_rest_required_fields(request_type=environments.DeleteUserWorkloadsConfigMapRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_user_workloads_config_map._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_user_workloads_config_map_rest_unset_required_fields():
    ...
    unset_fields = transport.delete_user_workloads_config_map._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_fetch_database_properties_rest_required_fields(request_type=environments.FetchDatabasePropertiesRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_database_properties._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_restart_web_server_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.restart_web_server(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = environments.RestartWebServerRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_check_upgrade_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.check_upgrade(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_execute_airflow_command_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.ExecuteAirflowCommandResponse()
        client.execute_airflow_command(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_stop_airflow_command_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.StopAirflowCommandResponse()
        client.stop_airflow_command(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_poll_airflow_command_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.PollAirflowCommandResponse()
        client.poll_airflow_command(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_user_workloads_secret_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.UserWorkloadsSecret()
        client.create_user_workloads_secret(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_user_workloads_secret_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.UserWorkloadsSecret()
        client.get_user_workloads_secret(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_user_workloads_secrets_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.ListUserWorkloadsSecretsResponse()
        client.list_user_workloads_secrets(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_user_workloads_secret_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.UserWorkloadsSecret()
        client.update_user_workloads_secret(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_user_workloads_secret_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_user_workloads_secret(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_user_workloads_config_map_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.UserWorkloadsConfigMap()
        client.create_user_workloads_config_map(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_user_workloads_config_map_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.UserWorkloadsConfigMap()
        client.get_user_workloads_config_map(request=None)
...
def test_list_user_workloads_config_maps_empty_call_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.ListUserWorkloadsConfigMapsResponse()
        client.list_user_workloads_config_maps(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_user_workloads_config_map_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.UserWorkloadsConfigMap()
        client.update_user_workloads_config_map(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_user_workloads_config_map_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_user_workloads_config_map(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_save_snapshot_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.save_snapshot(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_load_snapshot_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.load_snapshot(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_database_failover_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.database_failover(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_fetch_database_properties_empty_call_grpc():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = environments.FetchDatabasePropertiesResponse()
        client.fetch_database_properties(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_restart_web_server_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.restart_web_server(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_check_upgrade_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.check_upgrade(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_execute_airflow_command_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.execute_airflow_command(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_stop_airflow_command_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.stop_airflow_command(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_poll_airflow_command_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.poll_airflow_command(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_user_workloads_secret_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_user_workloads_secret(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_user_workloads_secret_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_user_workloads_secret(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_user_workloads_secrets_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_user_workloads_secrets(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_user_workloads_secret_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_user_workloads_secret(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_user_workloads_secret_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_user_workloads_secret(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_user_workloads_config_map_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_user_workloads_config_map(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_user_workloads_config_map_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_user_workloads_config_map(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_user_workloads_config_maps_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_user_workloads_config_maps(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_user_workloads_config_map_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_user_workloads_config_map(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_user_workloads_config_map_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_user_workloads_config_map(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_save_snapshot_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.save_snapshot(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_load_snapshot_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.load_snapshot(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_database_failover_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.database_failover(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_fetch_database_properties_empty_call_grpc_asyncio():
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.fetch_database_properties(request=None)
...
def test_create_environment_rest_bad_request(request_type=environments.CreateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_environment_rest_interceptors(null_interceptor):
    transport = transports.EnvironmentsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.EnvironmentsRestInterceptor(),
        )
    client = EnvironmentsClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_create_environment") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_create_environment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_create_environment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.CreateEnvironmentRequest.pb(environments.CreateEnvironmentRequest())
...
def test_get_environment_rest_bad_request(request_type=environments.GetEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_get_environment") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_get_environment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_get_environment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.GetEnvironmentRequest.pb(environments.GetEnvironmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environments.Environment.to_json(environments.Environment())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environments.Environment(), metadata
...
def test_list_environments_rest_bad_request(request_type=environments.ListEnvironmentsRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_environments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_environments") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_environments_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_list_environments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.ListEnvironmentsRequest.pb(environments.ListEnvironmentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environments.ListEnvironmentsResponse.to_json(environments.ListEnvironmentsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environments.ListEnvironmentsResponse(), metadata
...
def test_update_environment_rest_bad_request(request_type=environments.UpdateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_update_environment") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_update_environment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_update_environment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.UpdateEnvironmentRequest.pb(environments.UpdateEnvironmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_environment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_environment_rest_bad_request(request_type=environments.DeleteEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_delete_environment") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_delete_environment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_delete_environment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.DeleteEnvironmentRequest.pb(environments.DeleteEnvironmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_restart_web_server_rest_bad_request(request_type=environments.RestartWebServerRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_restart_web_server_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_restart_web_server_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_restart_web_server") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_restart_web_server_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_restart_web_server") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.RestartWebServerRequest.pb(environments.RestartWebServerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.restart_web_server(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_check_upgrade_rest_bad_request(request_type=environments.CheckUpgradeRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'environment': 'projects/sample1/locations/sample2/environments/sample3'}
    request = request_type(**request_init)
...
def test_check_upgrade_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_check_upgrade_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_check_upgrade") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_check_upgrade_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_check_upgrade") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.CheckUpgradeRequest.pb(environments.CheckUpgradeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.check_upgrade(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_execute_airflow_command_rest_bad_request(request_type=environments.ExecuteAirflowCommandRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_execute_airflow_command_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_execute_airflow_command_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_execute_airflow_command") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_execute_airflow_command_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_execute_airflow_command") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.ExecuteAirflowCommandRequest.pb(environments.ExecuteAirflowCommandRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environments.ExecuteAirflowCommandResponse.to_json(environments.ExecuteAirflowCommandResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environments.ExecuteAirflowCommandResponse(), metadata

        client.execute_airflow_command(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_stop_airflow_command_rest_bad_request(request_type=environments.StopAirflowCommandRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_stop_airflow_command_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_stop_airflow_command_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_stop_airflow_command") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_stop_airflow_command_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_stop_airflow_command") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.StopAirflowCommandRequest.pb(environments.StopAirflowCommandRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environments.StopAirflowCommandResponse.to_json(environments.StopAirflowCommandResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environments.StopAirflowCommandResponse(), metadata

        client.stop_airflow_command(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_poll_airflow_command_rest_bad_request(request_type=environments.PollAirflowCommandRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_poll_airflow_command_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_poll_airflow_command_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_poll_airflow_command") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_poll_airflow_command_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_poll_airflow_command") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.PollAirflowCommandRequest.pb(environments.PollAirflowCommandRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environments.PollAirflowCommandResponse.to_json(environments.PollAirflowCommandResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environments.PollAirflowCommandResponse(), metadata

        client.poll_airflow_command(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_workloads_rest_bad_request(request_type=environments.ListWorkloadsRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_workloads_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_workloads") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_workloads_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_list_workloads") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.ListWorkloadsRequest.pb(environments.ListWorkloadsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environments.ListWorkloadsResponse.to_json(environments.ListWorkloadsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environments.ListWorkloadsResponse(), metadata
...
def test_create_user_workloads_secret_rest_bad_request(request_type=environments.CreateUserWorkloadsSecretRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_user_workloads_secret_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = environments.CreateUserWorkloadsSecretRequest.meta.fields["user_workloads_secret"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["user_workloads_secret"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_create_user_workloads_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_create_user_workloads_secret") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_create_user_workloads_secret_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_create_user_workloads_secret") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.CreateUserWorkloadsSecretRequest.pb(environments.CreateUserWorkloadsSecretRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environments.UserWorkloadsSecret.to_json(environments.UserWorkloadsSecret())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environments.UserWorkloadsSecret(), metadata

        client.create_user_workloads_secret(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_user_workloads_secret_rest_bad_request(request_type=environments.GetUserWorkloadsSecretRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsSecrets/sample4'}
    request = request_type(**request_init)
...
def test_get_user_workloads_secret_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_user_workloads_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_get_user_workloads_secret") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_get_user_workloads_secret_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_get_user_workloads_secret") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.GetUserWorkloadsSecretRequest.pb(environments.GetUserWorkloadsSecretRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_user_workloads_secret(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_user_workloads_secrets_rest_bad_request(request_type=environments.ListUserWorkloadsSecretsRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_user_workloads_secrets_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_user_workloads_secrets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_user_workloads_secrets") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_user_workloads_secrets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_list_user_workloads_secrets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.ListUserWorkloadsSecretsRequest.pb(environments.ListUserWorkloadsSecretsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environments.ListUserWorkloadsSecretsResponse.to_json(environments.ListUserWorkloadsSecretsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environments.ListUserWorkloadsSecretsResponse(), metadata

        client.list_user_workloads_secrets(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_user_workloads_secret_rest_bad_request(request_type=environments.UpdateUserWorkloadsSecretRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'user_workloads_secret': {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsSecrets/sample4'}}
    request = request_type(**request_init)
...
def test_update_user_workloads_secret_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'user_workloads_secret': {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsSecrets/sample4'}}
    request_init["user_workloads_secret"] = {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsSecrets/sample4', 'data': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = environments.UpdateUserWorkloadsSecretRequest.meta.fields["user_workloads_secret"]
...
def test_update_user_workloads_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_update_user_workloads_secret") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_update_user_workloads_secret_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_update_user_workloads_secret") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.UpdateUserWorkloadsSecretRequest.pb(environments.UpdateUserWorkloadsSecretRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_user_workloads_secret(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_user_workloads_secret_rest_bad_request(request_type=environments.DeleteUserWorkloadsSecretRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_user_workloads_secret_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_user_workloads_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_delete_user_workloads_secret") as pre:
        pre.assert_not_called()
        pb_message = environments.DeleteUserWorkloadsSecretRequest.pb(environments.DeleteUserWorkloadsSecretRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_user_workloads_secret(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_user_workloads_config_map_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = environments.CreateUserWorkloadsConfigMapRequest.meta.fields["user_workloads_config_map"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["user_workloads_config_map"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["user_workloads_config_map"][field])):
...
def test_create_user_workloads_config_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_create_user_workloads_config_map") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_create_user_workloads_config_map_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_create_user_workloads_config_map") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.CreateUserWorkloadsConfigMapRequest.pb(environments.CreateUserWorkloadsConfigMapRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environments.UserWorkloadsConfigMap.to_json(environments.UserWorkloadsConfigMap())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environments.UserWorkloadsConfigMap(), metadata

        client.create_user_workloads_config_map(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_user_workloads_config_map_rest_bad_request(request_type=environments.GetUserWorkloadsConfigMapRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsConfigMaps/sample4'}
    request = request_type(**request_init)
...
def test_get_user_workloads_config_map_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_user_workloads_config_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_get_user_workloads_config_map") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_get_user_workloads_config_map_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_get_user_workloads_config_map") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.GetUserWorkloadsConfigMapRequest.pb(environments.GetUserWorkloadsConfigMapRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_user_workloads_config_map(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_user_workloads_config_maps_rest_bad_request(request_type=environments.ListUserWorkloadsConfigMapsRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_user_workloads_config_maps_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_user_workloads_config_maps_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_user_workloads_config_maps") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_user_workloads_config_maps_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_list_user_workloads_config_maps") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.ListUserWorkloadsConfigMapsRequest.pb(environments.ListUserWorkloadsConfigMapsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environments.ListUserWorkloadsConfigMapsResponse.to_json(environments.ListUserWorkloadsConfigMapsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environments.ListUserWorkloadsConfigMapsResponse(), metadata

        client.list_user_workloads_config_maps(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_user_workloads_config_map_rest_bad_request(request_type=environments.UpdateUserWorkloadsConfigMapRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'user_workloads_config_map': {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsConfigMaps/sample4'}}
    request = request_type(**request_init)
...
def test_update_user_workloads_config_map_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'user_workloads_config_map': {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsConfigMaps/sample4'}}
    request_init["user_workloads_config_map"] = {'name': 'projects/sample1/locations/sample2/environments/sample3/userWorkloadsConfigMaps/sample4', 'data': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = environments.UpdateUserWorkloadsConfigMapRequest.meta.fields["user_workloads_config_map"]
...
def test_update_user_workloads_config_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_update_user_workloads_config_map") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_update_user_workloads_config_map_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_update_user_workloads_config_map") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.UpdateUserWorkloadsConfigMapRequest.pb(environments.UpdateUserWorkloadsConfigMapRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_user_workloads_config_map(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_user_workloads_config_map_rest_bad_request(request_type=environments.DeleteUserWorkloadsConfigMapRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_user_workloads_config_map_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_user_workloads_config_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_delete_user_workloads_config_map") as pre:
        pre.assert_not_called()
        pb_message = environments.DeleteUserWorkloadsConfigMapRequest.pb(environments.DeleteUserWorkloadsConfigMapRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_user_workloads_config_map(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_save_snapshot_rest_bad_request(request_type=environments.SaveSnapshotRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_save_snapshot_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_save_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_save_snapshot") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_save_snapshot_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_save_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.SaveSnapshotRequest.pb(environments.SaveSnapshotRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.save_snapshot(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_load_snapshot_rest_bad_request(request_type=environments.LoadSnapshotRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_load_snapshot_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_load_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_load_snapshot") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_load_snapshot_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_load_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.LoadSnapshotRequest.pb(environments.LoadSnapshotRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.load_snapshot(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_database_failover_rest_bad_request(request_type=environments.DatabaseFailoverRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_database_failover_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_database_failover_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_database_failover") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_database_failover_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_database_failover") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.DatabaseFailoverRequest.pb(environments.DatabaseFailoverRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.database_failover(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_database_properties_rest_bad_request(request_type=environments.FetchDatabasePropertiesRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_fetch_database_properties_rest_call_success(request_type):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_fetch_database_properties_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_fetch_database_properties") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_fetch_database_properties_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_fetch_database_properties") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environments.FetchDatabasePropertiesRequest.pb(environments.FetchDatabasePropertiesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environments.FetchDatabasePropertiesResponse.to_json(environments.FetchDatabasePropertiesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environments.FetchDatabasePropertiesResponse(), metadata

        client.fetch_database_properties(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_restart_web_server_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_check_upgrade_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_execute_airflow_command_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_stop_airflow_command_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_poll_airflow_command_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_user_workloads_secret_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_user_workloads_secret_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_user_workloads_secrets_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_user_workloads_secret_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_user_workloads_secret_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_user_workloads_config_map_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_user_workloads_config_map_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_user_workloads_config_maps_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_user_workloads_config_map_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_user_workloads_config_map_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_save_snapshot_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_load_snapshot_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_database_failover_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_fetch_database_properties_empty_call_rest():
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_user_workloads_config_map_path():
    ...
    expected = "projects/{project}/locations/{location}/environments/{environment}/userWorkloadsConfigMaps/{user_workloads_config_map}".format(project=project, location=location, environment=environment, user_workloads_config_map=user_workloads_config_map, )
    actual = EnvironmentsClient.user_workloads_config_map_path(project, location, environment, user_workloads_config_map)
    assert expected == actual
...
def test_user_workloads_secret_path():
    ...
    expected = "projects/{project}/locations/{location}/environments/{environment}/userWorkloadsSecrets/{user_workloads_secret}".format(project=project, location=location, environment=environment, user_workloads_secret=user_workloads_secret, )
    actual = EnvironmentsClient.user_workloads_secret_path(project, location, environment, user_workloads_secret)
    assert expected == actual

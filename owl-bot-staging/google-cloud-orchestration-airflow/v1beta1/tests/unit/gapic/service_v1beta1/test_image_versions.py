...
from google.cloud.orchestration.airflow.service_v1beta1.services.image_versions import ImageVersionsAsyncClient
from google.cloud.orchestration.airflow.service_v1beta1.services.image_versions import ImageVersionsClient
from google.cloud.orchestration.airflow.service_v1beta1.services.image_versions import pagers
from google.cloud.orchestration.airflow.service_v1beta1.services.image_versions import transports
...
def test__read_environment_variables():
    assert ImageVersionsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ImageVersionsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ImageVersionsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ImageVersionsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ImageVersionsClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert ImageVersionsClient._get_client_cert_source(None, False) is None
    assert ImageVersionsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ImageVersionsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ImageVersionsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ImageVersionsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ImageVersionsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ImageVersionsClient))
...
def test__get_api_endpoint():
    ...
    default_universe = ImageVersionsClient._DEFAULT_UNIVERSE
    default_endpoint = ImageVersionsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ImageVersionsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ImageVersionsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ImageVersionsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ImageVersionsClient.DEFAULT_MTLS_ENDPOINT
    assert ImageVersionsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ImageVersionsClient._get_api_endpoint(None, None, default_universe, "always") == ImageVersionsClient.DEFAULT_MTLS_ENDPOINT
    assert ImageVersionsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ImageVersionsClient.DEFAULT_MTLS_ENDPOINT
    assert ImageVersionsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ImageVersionsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ImageVersionsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ImageVersionsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ImageVersionsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ImageVersionsClient._get_universe_domain(None, None) == ImageVersionsClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        ImageVersionsClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ImageVersionsClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ImageVersionsAsyncClient, transports.ImageVersionsGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (ImageVersionsAsyncClient, transports.ImageVersionsGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ImageVersionsClient, transports.ImageVersionsGrpcTransport, "grpc", "false"),
    (ImageVersionsAsyncClient, transports.ImageVersionsGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
@pytest.mark.parametrize("client_class", [
    ImageVersionsClient, ImageVersionsAsyncClient
])
...
@mock.patch.object(ImageVersionsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ImageVersionsClient))
@mock.patch.object(ImageVersionsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ImageVersionsAsyncClient))
def test_image_versions_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ImageVersionsClient, transports.ImageVersionsGrpcTransport, "grpc", grpc_helpers),
    (ImageVersionsAsyncClient, transports.ImageVersionsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_list_image_versions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_image_versions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_image_versions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_image_versions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_image_versions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_image_versions] = mock_rpc
...
def test_list_image_versions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_image_versions(request={}, retry=retry, timeout=timeout)
        ...
        assert all(isinstance(i, image_versions.ImageVersion)
                   for i in results)
...
def test_list_image_versions_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ImageVersionsClient(
...
def test_list_image_versions_empty_call_grpc():
    client = ImageVersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = image_versions.ListImageVersionsResponse()
        client.list_image_versions(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = ImageVersionsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_image_versions_empty_call_grpc_asyncio():
    client = ImageVersionsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_image_versions(request=None)
...
def test_transport_kind_rest():
    transport = ImageVersionsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_image_versions_rest_bad_request(request_type=image_versions.ListImageVersionsRequest):
    client = ImageVersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_image_versions_rest_call_success(request_type):
    client = ImageVersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_image_versions_rest_interceptors(null_interceptor):
    transport = transports.ImageVersionsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ImageVersionsRestInterceptor(),
        )
    client = ImageVersionsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImageVersionsRestInterceptor, "post_list_image_versions") as post, \
        mock.patch.object(transports.ImageVersionsRestInterceptor, "post_list_image_versions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImageVersionsRestInterceptor, "pre_list_image_versions") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = image_versions.ListImageVersionsResponse.to_json(image_versions.ListImageVersionsResponse())
        ...
        post_with_metadata.return_value = image_versions.ListImageVersionsResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_image_versions_empty_call_rest():
    client = ImageVersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_image_versions_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.ImageVersionsGrpcTransport, transports.ImageVersionsGrpcAsyncIOTransport])
def test_image_versions_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ImageVersionsGrpcTransport, transports.ImageVersionsGrpcAsyncIOTransport])
def test_image_versions_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

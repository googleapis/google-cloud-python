...
class EnvironmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_restart_web_server(self, request: environments.RestartWebServerRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.RestartWebServerRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_restart_web_server_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for restart_web_server
...
class EnvironmentsRestTransport(_BaseEnvironmentsRestTransport):
    ...
    class _RestartWebServer(_BaseEnvironmentsRestTransport._BaseRestartWebServer, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._RestartWebServer._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class ImageVersionsAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ImageVersionsTransport, Callable[..., ImageVersionsTransport]]] = "grpc_asyncio",
    ...
    async def list_image_versions(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_image_versions]

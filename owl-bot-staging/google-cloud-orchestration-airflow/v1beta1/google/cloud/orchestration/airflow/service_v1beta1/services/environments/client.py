...
class EnvironmentsClient(metaclass=EnvironmentsClientMeta):
    ...
    @staticmethod
    def user_workloads_config_map_path(project: str,location: str,environment: str,user_workloads_config_map: str,) -> str:
        """Returns a fully-qualified user_workloads_config_map string."""
        return "projects/{project}/locations/{location}/environments/{environment}/userWorkloadsConfigMaps/{user_workloads_config_map}".format(project=project, location=location, environment=environment, user_workloads_config_map=user_workloads_config_map, )
    ...
    def parse_user_workloads_config_map_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/environments/(?P<environment>.+?)/userWorkloadsConfigMaps/(?P<user_workloads_config_map>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def user_workloads_secret_path(project: str,location: str,environment: str,user_workloads_secret: str,) -> str:
        """Returns a fully-qualified user_workloads_secret string."""
        return "projects/{project}/locations/{location}/environments/{environment}/userWorkloadsSecrets/{user_workloads_secret}".format(project=project, location=location, environment=environment, user_workloads_secret=user_workloads_secret, )
    ...
    def parse_user_workloads_secret_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/environments/(?P<environment>.+?)/userWorkloadsSecrets/(?P<user_workloads_secret>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            EnvironmentsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def execute_airflow_command(self,
    ...
    def list_workloads(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a environments.ListWorkloadsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_user_workloads_secret(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a environments.CreateUserWorkloadsSecretRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_user_workloads_secret]
    ...
    def get_user_workloads_secret(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a environments.GetUserWorkloadsSecretRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_user_workloads_secret]
    ...
    def list_user_workloads_secrets(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a environments.ListUserWorkloadsSecretsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_user_workloads_secrets]
    ...
    def update_user_workloads_secret(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a environments.UpdateUserWorkloadsSecretRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_user_workloads_secret]
    ...
    def delete_user_workloads_secret(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a environments.DeleteUserWorkloadsSecretRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_user_workloads_secret]
    ...
    def create_user_workloads_config_map(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a environments.CreateUserWorkloadsConfigMapRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_user_workloads_config_map]
    ...
    def get_user_workloads_config_map(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a environments.GetUserWorkloadsConfigMapRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_user_workloads_config_map]
    ...
    def list_user_workloads_config_maps(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a environments.ListUserWorkloadsConfigMapsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_user_workloads_config_maps]
    ...
    def update_user_workloads_config_map(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a environments.UpdateUserWorkloadsConfigMapRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_user_workloads_config_map]

         # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("user_workloads_config_map.name", request.user_workloads_config_map.name),
            )),
        )
    ...
    def delete_user_workloads_config_map(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a environments.DeleteUserWorkloadsConfigMapRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_user_workloads_config_map]
    ...
    def fetch_database_properties(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_database_properties]

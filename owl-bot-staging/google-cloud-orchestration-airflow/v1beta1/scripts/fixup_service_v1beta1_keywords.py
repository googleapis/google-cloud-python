...
class serviceCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'delete_user_workloads_config_map': ('name', ),
        'delete_user_workloads_secret': ('name', ),
        ...
        'get_user_workloads_config_map': ('name', ),
        'get_user_workloads_secret': ('name', ),
        'list_environments': ('parent', 'page_size', 'page_token', ),
        'list_image_versions': ('parent', 'page_size', 'page_token', 'include_past_releases', ),
        'list_user_workloads_config_maps': ('parent', 'page_size', 'page_token', ),
        'list_user_workloads_secrets': ('parent', 'page_size', 'page_token', ),
        ...
        'update_user_workloads_config_map': ('user_workloads_config_map', ),
        'update_user_workloads_secret': ('user_workloads_secret', ),
    }
...
def fix_files(
    ...
    *,
    transformer=serviceCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the service client library.

...
class ImageVersionsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_list_image_versions(self, request: image_versions.ListImageVersionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[image_versions.ListImageVersionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_image_versions_with_metadata(self, response: image_versions.ListImageVersionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[image_versions.ListImageVersionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_image_versions
...
class ImageVersionsRestTransport(_BaseImageVersionsRestTransport):
    ...
    class _ListImageVersions(_BaseImageVersionsRestTransport._BaseListImageVersions, ImageVersionsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ImageVersionsRestTransport._ListImageVersions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseImageVersionsRestTransport._BaseDeleteOperation, ImageVersionsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ImageVersionsRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseImageVersionsRestTransport._BaseGetOperation, ImageVersionsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ImageVersionsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseImageVersionsRestTransport._BaseListOperations, ImageVersionsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.orchestration.airflow.service_v1.ImageVersionsClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.orchestration.airflow.service.v1.ImageVersions",
            ...
            # Send the request
            response = ImageVersionsRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.orchestration.airflow.service_v1.ImageVersionsAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.orchestration.airflow.service.v1.ImageVersions",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

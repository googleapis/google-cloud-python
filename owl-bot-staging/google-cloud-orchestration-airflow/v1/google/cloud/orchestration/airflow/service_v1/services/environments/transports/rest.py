...
class EnvironmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_check_upgrade(self, request: environments.CheckUpgradeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.CheckUpgradeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_check_upgrade_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for check_upgrade
    ...
    def pre_create_environment(self, request: environments.CreateEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.CreateEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_environment_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_environment
    ...
    def pre_create_user_workloads_config_map(self, request: environments.CreateUserWorkloadsConfigMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.CreateUserWorkloadsConfigMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_user_workloads_config_map_with_metadata(self, response: environments.UserWorkloadsConfigMap, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.UserWorkloadsConfigMap, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_user_workloads_config_map
    ...
    def pre_create_user_workloads_secret(self, request: environments.CreateUserWorkloadsSecretRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.CreateUserWorkloadsSecretRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_user_workloads_secret_with_metadata(self, response: environments.UserWorkloadsSecret, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.UserWorkloadsSecret, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_user_workloads_secret
    ...
    def pre_database_failover(self, request: environments.DatabaseFailoverRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.DatabaseFailoverRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_database_failover_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for database_failover
    ...
    def pre_delete_environment(self, request: environments.DeleteEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.DeleteEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_environment_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_environment
    ...
    def pre_delete_user_workloads_config_map(self, request: environments.DeleteUserWorkloadsConfigMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.DeleteUserWorkloadsConfigMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_delete_user_workloads_secret(self, request: environments.DeleteUserWorkloadsSecretRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.DeleteUserWorkloadsSecretRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_execute_airflow_command(self, request: environments.ExecuteAirflowCommandRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.ExecuteAirflowCommandRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_execute_airflow_command_with_metadata(self, response: environments.ExecuteAirflowCommandResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.ExecuteAirflowCommandResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for execute_airflow_command
    ...
    def pre_fetch_database_properties(self, request: environments.FetchDatabasePropertiesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.FetchDatabasePropertiesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_fetch_database_properties_with_metadata(self, response: environments.FetchDatabasePropertiesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.FetchDatabasePropertiesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for fetch_database_properties
    ...
    def pre_get_environment(self, request: environments.GetEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.GetEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_environment_with_metadata(self, response: environments.Environment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.Environment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_environment
    ...
    def pre_get_user_workloads_config_map(self, request: environments.GetUserWorkloadsConfigMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.GetUserWorkloadsConfigMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_user_workloads_config_map_with_metadata(self, response: environments.UserWorkloadsConfigMap, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.UserWorkloadsConfigMap, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_user_workloads_config_map
    ...
    def pre_get_user_workloads_secret(self, request: environments.GetUserWorkloadsSecretRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.GetUserWorkloadsSecretRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_user_workloads_secret_with_metadata(self, response: environments.UserWorkloadsSecret, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.UserWorkloadsSecret, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_user_workloads_secret
    ...
    def pre_list_environments(self, request: environments.ListEnvironmentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.ListEnvironmentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_environments_with_metadata(self, response: environments.ListEnvironmentsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.ListEnvironmentsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_environments
    ...
    def pre_list_user_workloads_config_maps(self, request: environments.ListUserWorkloadsConfigMapsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.ListUserWorkloadsConfigMapsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_user_workloads_config_maps(self, response: environments.ListUserWorkloadsConfigMapsResponse) -> environments.ListUserWorkloadsConfigMapsResponse:
    ...
    def post_list_user_workloads_config_maps_with_metadata(self, response: environments.ListUserWorkloadsConfigMapsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.ListUserWorkloadsConfigMapsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_user_workloads_config_maps
    ...
    def pre_list_user_workloads_secrets(self, request: environments.ListUserWorkloadsSecretsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.ListUserWorkloadsSecretsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_user_workloads_secrets(self, response: environments.ListUserWorkloadsSecretsResponse) -> environments.ListUserWorkloadsSecretsResponse:
    ...
    def post_list_user_workloads_secrets_with_metadata(self, response: environments.ListUserWorkloadsSecretsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.ListUserWorkloadsSecretsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_user_workloads_secrets
    ...
    def pre_list_workloads(self, request: environments.ListWorkloadsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.ListWorkloadsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_workloads_with_metadata(self, response: environments.ListWorkloadsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.ListWorkloadsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_workloads
    ...
    def pre_load_snapshot(self, request: environments.LoadSnapshotRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.LoadSnapshotRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_load_snapshot_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for load_snapshot
    ...
    def pre_poll_airflow_command(self, request: environments.PollAirflowCommandRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.PollAirflowCommandRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_poll_airflow_command_with_metadata(self, response: environments.PollAirflowCommandResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.PollAirflowCommandResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for poll_airflow_command
    ...
    def pre_save_snapshot(self, request: environments.SaveSnapshotRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.SaveSnapshotRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_save_snapshot_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for save_snapshot
    ...
    def pre_stop_airflow_command(self, request: environments.StopAirflowCommandRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.StopAirflowCommandRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_stop_airflow_command_with_metadata(self, response: environments.StopAirflowCommandResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.StopAirflowCommandResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for stop_airflow_command
    ...
    def pre_update_environment(self, request: environments.UpdateEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.UpdateEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_environment_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_environment
    ...
    def pre_update_user_workloads_config_map(self, request: environments.UpdateUserWorkloadsConfigMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.UpdateUserWorkloadsConfigMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_user_workloads_config_map_with_metadata(self, response: environments.UserWorkloadsConfigMap, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.UserWorkloadsConfigMap, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_user_workloads_config_map
    ...
    def pre_update_user_workloads_secret(self, request: environments.UpdateUserWorkloadsSecretRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.UpdateUserWorkloadsSecretRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_user_workloads_secret_with_metadata(self, response: environments.UserWorkloadsSecret, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environments.UserWorkloadsSecret, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_user_workloads_secret
...
class EnvironmentsRestTransport(_BaseEnvironmentsRestTransport):
    ...
    class _CheckUpgrade(_BaseEnvironmentsRestTransport._BaseCheckUpgrade, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._CheckUpgrade._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CreateUserWorkloadsConfigMap(_BaseEnvironmentsRestTransport._BaseCreateUserWorkloadsConfigMap, EnvironmentsRestStub):
        ...
        config map method over HTTP.
            ...
            # Send the request
            response = EnvironmentsRestTransport._CreateUserWorkloadsConfigMap._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CreateUserWorkloadsSecret(_BaseEnvironmentsRestTransport._BaseCreateUserWorkloadsSecret, EnvironmentsRestStub):
        ...
        secret method over HTTP.
            ...
            # Send the request
            response = EnvironmentsRestTransport._CreateUserWorkloadsSecret._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DatabaseFailover(_BaseEnvironmentsRestTransport._BaseDatabaseFailover, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._DatabaseFailover._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteUserWorkloadsConfigMap(_BaseEnvironmentsRestTransport._BaseDeleteUserWorkloadsConfigMap, EnvironmentsRestStub):
        ...
        config map method over HTTP.
            ...
            # Send the request
            response = EnvironmentsRestTransport._DeleteUserWorkloadsConfigMap._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteUserWorkloadsSecret(_BaseEnvironmentsRestTransport._BaseDeleteUserWorkloadsSecret, EnvironmentsRestStub):
        ...
        secret method over HTTP.
            ...
            # Send the request
            response = EnvironmentsRestTransport._DeleteUserWorkloadsSecret._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ExecuteAirflowCommand(_BaseEnvironmentsRestTransport._BaseExecuteAirflowCommand, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._ExecuteAirflowCommand._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _FetchDatabaseProperties(_BaseEnvironmentsRestTransport._BaseFetchDatabaseProperties, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._FetchDatabaseProperties._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetUserWorkloadsConfigMap(_BaseEnvironmentsRestTransport._BaseGetUserWorkloadsConfigMap, EnvironmentsRestStub):
        ...
        map method over HTTP.
            ...
            # Send the request
            response = EnvironmentsRestTransport._GetUserWorkloadsConfigMap._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetUserWorkloadsSecret(_BaseEnvironmentsRestTransport._BaseGetUserWorkloadsSecret, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._GetUserWorkloadsSecret._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListUserWorkloadsConfigMaps(_BaseEnvironmentsRestTransport._BaseListUserWorkloadsConfigMaps, EnvironmentsRestStub):
        ...
        config maps method over HTTP.
            ...
            # Send the request
            response = EnvironmentsRestTransport._ListUserWorkloadsConfigMaps._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListUserWorkloadsSecrets(_BaseEnvironmentsRestTransport._BaseListUserWorkloadsSecrets, EnvironmentsRestStub):
        ...
        secrets method over HTTP.
            ...
            # Send the request
            response = EnvironmentsRestTransport._ListUserWorkloadsSecrets._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListWorkloads(_BaseEnvironmentsRestTransport._BaseListWorkloads, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._ListWorkloads._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _LoadSnapshot(_BaseEnvironmentsRestTransport._BaseLoadSnapshot, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._LoadSnapshot._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _PollAirflowCommand(_BaseEnvironmentsRestTransport._BasePollAirflowCommand, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._PollAirflowCommand._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SaveSnapshot(_BaseEnvironmentsRestTransport._BaseSaveSnapshot, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._SaveSnapshot._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _StopAirflowCommand(_BaseEnvironmentsRestTransport._BaseStopAirflowCommand, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._StopAirflowCommand._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateUserWorkloadsConfigMap(_BaseEnvironmentsRestTransport._BaseUpdateUserWorkloadsConfigMap, EnvironmentsRestStub):
        ...
        config map method over HTTP.
            ...
            # Send the request
            response = EnvironmentsRestTransport._UpdateUserWorkloadsConfigMap._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateUserWorkloadsSecret(_BaseEnvironmentsRestTransport._BaseUpdateUserWorkloadsSecret, EnvironmentsRestStub):
        ...
        secret method over HTTP.
            ...
            # Send the request
            response = EnvironmentsRestTransport._UpdateUserWorkloadsSecret._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def create_user_workloads_config_map(self) -> Callable[
    ...
    @property
    def create_user_workloads_secret(self) -> Callable[
    ...
    @property
    def database_failover(self) -> Callable[
    ...
    @property
    def delete_user_workloads_config_map(self) -> Callable[
    ...
    @property
    def delete_user_workloads_secret(self) -> Callable[
    ...
    @property
    def execute_airflow_command(self) -> Callable[
    ...
    @property
    def fetch_database_properties(self) -> Callable[
    ...
    @property
    def get_user_workloads_config_map(self) -> Callable[
    ...
    @property
    def get_user_workloads_secret(self) -> Callable[
    ...
    @property
    def list_user_workloads_config_maps(self) -> Callable[
    ...
    @property
    def list_user_workloads_secrets(self) -> Callable[
    ...
    @property
    def poll_airflow_command(self) -> Callable[
    ...
    @property
    def stop_airflow_command(self) -> Callable[
    ...
    @property
    def update_user_workloads_config_map(self) -> Callable[
    ...
    @property
    def update_user_workloads_secret(self) -> Callable[
    ...
    class _DeleteOperation(_BaseEnvironmentsRestTransport._BaseDeleteOperation, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

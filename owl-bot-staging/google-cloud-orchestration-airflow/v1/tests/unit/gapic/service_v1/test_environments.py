...
from google.cloud.orchestration.airflow.service_v1.services.environments import EnvironmentsAsyncClient
from google.cloud.orchestration.airflow.service_v1.services.environments import EnvironmentsClient
from google.cloud.orchestration.airflow.service_v1.services.environments import pagers
from google.cloud.orchestration.airflow.service_v1.services.environments import transports
...
def test_create_environment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/environments" % client.transport._host, args[1])
...
def test_get_environment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/environments/*}" % client.transport._host, args[1])
...
def test_list_workloads_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/environments/*}/workloads" % client.transport._host, args[1])
...
def test_check_upgrade_rest_required_fields(request_type=environments.CheckUpgradeRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).check_upgrade._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_user_workloads_secret_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/environments/*}/userWorkloadsSecrets" % client.transport._host, args[1])
...
def test_get_user_workloads_secret_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/environments/*/userWorkloadsSecrets/*}" % client.transport._host, args[1])
...
def test_update_user_workloads_secret_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{user_workloads_secret.name=projects/*/locations/*/environments/*/userWorkloadsSecrets/*}" % client.transport._host, args[1])
...
def test_create_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/environments/*}/userWorkloadsConfigMaps" % client.transport._host, args[1])
...
def test_get_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/environments/*/userWorkloadsConfigMaps/*}" % client.transport._host, args[1])
...
def test_update_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{user_workloads_config_map.name=projects/*/locations/*/environments/*/userWorkloadsConfigMaps/*}" % client.transport._host, args[1])
...
def test_environments_base_transport():
    ...
    with mock.patch('google.cloud.orchestration.airflow.service_v1.services.environments.transports.EnvironmentsTransport.__init__') as Transport:
...
def test_environments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.orchestration.airflow.service_v1.services.environments.transports.EnvironmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_environments_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.orchestration.airflow.service_v1.services.environments.transports.EnvironmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EnvironmentsTransport()
        adc.assert_called_once()

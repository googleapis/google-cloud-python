...
from google.cloud.orchestration.airflow.service_v1.services.image_versions import ImageVersionsAsyncClient
from google.cloud.orchestration.airflow.service_v1.services.image_versions import ImageVersionsClient
from google.cloud.orchestration.airflow.service_v1.services.image_versions import pagers
from google.cloud.orchestration.airflow.service_v1.services.image_versions import transports
...
def test_image_versions_client_client_options_from_dict():
    with mock.patch('google.cloud.orchestration.airflow.service_v1.services.image_versions.transports.ImageVersionsGrpcTransport.__init__') as grpc_transport:
...
def test_list_image_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/imageVersions" % client.transport._host, args[1])
...
def test_image_versions_base_transport():
    ...
    with mock.patch('google.cloud.orchestration.airflow.service_v1.services.image_versions.transports.ImageVersionsTransport.__init__') as Transport:
...
def test_image_versions_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.orchestration.airflow.service_v1.services.image_versions.transports.ImageVersionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_image_versions_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.orchestration.airflow.service_v1.services.image_versions.transports.ImageVersionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ImageVersionsTransport()
        adc.assert_called_once()

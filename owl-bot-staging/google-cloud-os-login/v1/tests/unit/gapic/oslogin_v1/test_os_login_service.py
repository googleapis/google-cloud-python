...
def test__get_api_endpoint():
    ...
    assert OsLoginServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == OsLoginServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert OsLoginServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == OsLoginServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_import_ssh_public_key_rest_required_fields(request_type=oslogin.ImportSshPublicKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_ssh_public_key._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("project_id", "regions", ))
    jsonified_request.update(unset_fields)
...
def test_import_ssh_public_key_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("projectId", "regions", )) & set(("parent", )))
...
def test_transport_kind_grpc_asyncio():
    transport = OsLoginServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = OsLoginServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_create_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_create_ssh_public_key_with_metadata") as post_with_metadata, \
...
def test_get_login_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_get_login_profile_with_metadata") as post_with_metadata, \
...
def test_get_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_get_ssh_public_key_with_metadata") as post_with_metadata, \
...
def test_import_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_import_ssh_public_key_with_metadata") as post_with_metadata, \
...
def test_update_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_update_ssh_public_key_with_metadata") as post_with_metadata, \

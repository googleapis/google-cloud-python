...
def test_create_ssh_public_key_rest_required_fields(request_type=oslogin.CreateSshPublicKeyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_ssh_public_key._get_unset_required_fields(jsonified_request)
...
def test_create_ssh_public_key_rest_unset_required_fields():
    transport = transports.OsLoginServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_delete_posix_account_rest_required_fields(request_type=oslogin.DeletePosixAccountRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_posix_account._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_ssh_public_key_rest_required_fields(request_type=oslogin.DeleteSshPublicKeyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_ssh_public_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_login_profile_rest_required_fields(request_type=oslogin.GetLoginProfileRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_login_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_ssh_public_key_rest_required_fields(request_type=oslogin.GetSshPublicKeyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_ssh_public_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_ssh_public_key_rest_required_fields(request_type=oslogin.ImportSshPublicKeyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).import_ssh_public_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_ssh_public_key_rest_required_fields(request_type=oslogin.UpdateSshPublicKeyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_ssh_public_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

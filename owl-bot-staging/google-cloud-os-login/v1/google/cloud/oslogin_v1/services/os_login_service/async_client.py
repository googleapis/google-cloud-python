...
class OsLoginServiceAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, OsLoginServiceTransport, Callable[..., OsLoginServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_ssh_public_key(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_ssh_public_key]
    ...
    async def delete_posix_account(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_posix_account]
    ...
    async def delete_ssh_public_key(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_ssh_public_key]
    ...
    async def get_login_profile(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_login_profile]
    ...
    async def get_ssh_public_key(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_ssh_public_key]
    ...
    async def import_ssh_public_key(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_ssh_public_key]
    ...
    async def update_ssh_public_key(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_ssh_public_key]

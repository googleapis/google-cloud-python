...
class OsLoginServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_ssh_public_key(self, request: oslogin.CreateSshPublicKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[oslogin.CreateSshPublicKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_ssh_public_key_with_metadata(self, response: common.SshPublicKey, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[common.SshPublicKey, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_ssh_public_key
    ...
    def pre_delete_posix_account(self, request: oslogin.DeletePosixAccountRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[oslogin.DeletePosixAccountRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_delete_ssh_public_key(self, request: oslogin.DeleteSshPublicKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[oslogin.DeleteSshPublicKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_login_profile(self, request: oslogin.GetLoginProfileRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[oslogin.GetLoginProfileRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_login_profile_with_metadata(self, response: oslogin.LoginProfile, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[oslogin.LoginProfile, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_login_profile
    ...
    def pre_get_ssh_public_key(self, request: oslogin.GetSshPublicKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[oslogin.GetSshPublicKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_ssh_public_key_with_metadata(self, response: common.SshPublicKey, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[common.SshPublicKey, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_ssh_public_key
    ...
    def pre_import_ssh_public_key(self, request: oslogin.ImportSshPublicKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[oslogin.ImportSshPublicKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_import_ssh_public_key_with_metadata(self, response: oslogin.ImportSshPublicKeyResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[oslogin.ImportSshPublicKeyResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for import_ssh_public_key
    ...
    def pre_update_ssh_public_key(self, request: oslogin.UpdateSshPublicKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[oslogin.UpdateSshPublicKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_ssh_public_key_with_metadata(self, response: common.SshPublicKey, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[common.SshPublicKey, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_ssh_public_key
...
class OsLoginServiceRestTransport(_BaseOsLoginServiceRestTransport):
    ...
    class _CreateSshPublicKey(_BaseOsLoginServiceRestTransport._BaseCreateSshPublicKey, OsLoginServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OsLoginServiceRestTransport._CreateSshPublicKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeletePosixAccount(_BaseOsLoginServiceRestTransport._BaseDeletePosixAccount, OsLoginServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OsLoginServiceRestTransport._DeletePosixAccount._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteSshPublicKey(_BaseOsLoginServiceRestTransport._BaseDeleteSshPublicKey, OsLoginServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OsLoginServiceRestTransport._DeleteSshPublicKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetLoginProfile(_BaseOsLoginServiceRestTransport._BaseGetLoginProfile, OsLoginServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OsLoginServiceRestTransport._GetLoginProfile._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetSshPublicKey(_BaseOsLoginServiceRestTransport._BaseGetSshPublicKey, OsLoginServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OsLoginServiceRestTransport._GetSshPublicKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ImportSshPublicKey(_BaseOsLoginServiceRestTransport._BaseImportSshPublicKey, OsLoginServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OsLoginServiceRestTransport._ImportSshPublicKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateSshPublicKey(_BaseOsLoginServiceRestTransport._BaseUpdateSshPublicKey, OsLoginServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OsLoginServiceRestTransport._UpdateSshPublicKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

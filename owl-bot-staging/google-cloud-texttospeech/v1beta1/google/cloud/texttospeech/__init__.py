...
from google.cloud.texttospeech_v1beta1.types.cloud_tts import MultispeakerPrebuiltVoice
from google.cloud.texttospeech_v1beta1.types.cloud_tts import MultiSpeakerVoiceConfig

...
class TextToSpeechRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_list_voices(self, request: cloud_tts.ListVoicesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloud_tts.ListVoicesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_voices_with_metadata(self, response: cloud_tts.ListVoicesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloud_tts.ListVoicesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_voices
    ...
    def pre_synthesize_speech(self, request: cloud_tts.SynthesizeSpeechRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloud_tts.SynthesizeSpeechRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_synthesize_speech_with_metadata(self, response: cloud_tts.SynthesizeSpeechResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloud_tts.SynthesizeSpeechResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for synthesize_speech
...
class TextToSpeechRestTransport(_BaseTextToSpeechRestTransport):
    ...
    class _ListVoices(_BaseTextToSpeechRestTransport._BaseListVoices, TextToSpeechRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TextToSpeechRestTransport._ListVoices._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SynthesizeSpeech(_BaseTextToSpeechRestTransport._BaseSynthesizeSpeech, TextToSpeechRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TextToSpeechRestTransport._SynthesizeSpeech._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseTextToSpeechRestTransport._BaseGetOperation, TextToSpeechRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TextToSpeechRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseTextToSpeechRestTransport._BaseListOperations, TextToSpeechRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TextToSpeechRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

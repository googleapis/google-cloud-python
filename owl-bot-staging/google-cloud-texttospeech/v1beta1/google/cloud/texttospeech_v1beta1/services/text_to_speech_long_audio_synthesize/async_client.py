...
class TextToSpeechLongAudioSynthesizeAsyncClient:
    ...
    get_transport_class = functools.partial(type(TextToSpeechLongAudioSynthesizeClient).get_transport_class, type(TextToSpeechLongAudioSynthesizeClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, TextToSpeechLongAudioSynthesizeTransport, Callable[..., TextToSpeechLongAudioSynthesizeTransport]]] = "grpc_asyncio",
    ...
    async def synthesize_long_audio(self,

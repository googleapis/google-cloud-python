...
from google.cloud.texttospeech_v1.services.text_to_speech_long_audio_synthesize import TextToSpeechLongAudioSynthesizeAsyncClient
...
from google.cloud.texttospeech_v1.services.text_to_speech_long_audio_synthesize import transports
...
@mock.patch.object(TextToSpeechLongAudioSynthesizeClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TextToSpeechLongAudioSynthesizeClient))
@mock.patch.object(TextToSpeechLongAudioSynthesizeAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TextToSpeechLongAudioSynthesizeAsyncClient))
def test__get_api_endpoint():
    ...
    assert TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == TextToSpeechLongAudioSynthesizeClient.DEFAULT_MTLS_ENDPOINT
    assert TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(None, None, default_universe, "always") == TextToSpeechLongAudioSynthesizeClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (TextToSpeechLongAudioSynthesizeAsyncClient, transports.TextToSpeechLongAudioSynthesizeGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_synthesize_long_audio(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.synthesize_long_audio),
            '__call__') as call:
...
def test_synthesize_long_audio_rest_required_fields(request_type=cloud_tts_lrs.SynthesizeLongAudioRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).synthesize_long_audio._get_unset_required_fields(jsonified_request)
...
def test_synthesize_long_audio_rest_unset_required_fields():
    transport = transports.TextToSpeechLongAudioSynthesizeRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_synthesize_long_audio_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.TextToSpeechLongAudioSynthesizeRestInterceptor, "post_synthesize_long_audio") as post, \
         mock.patch.object(transports.TextToSpeechLongAudioSynthesizeRestInterceptor, "pre_synthesize_long_audio") as pre:
...
def test_transport_kind(transport_name):
    transport = TextToSpeechLongAudioSynthesizeClient.get_transport_class(transport_name)(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
    )

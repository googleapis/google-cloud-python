...
def test_transport_kind_grpc_asyncio():
    transport = TextToSpeechLongAudioSynthesizeAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_synthesize_long_audio_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TextToSpeechLongAudioSynthesizeRestInterceptor, "post_synthesize_long_audio_with_metadata") as post_with_metadata, \

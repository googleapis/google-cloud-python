...
def test_list_voices_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TextToSpeechRestInterceptor, "post_list_voices_with_metadata") as post_with_metadata, \
...
def test_synthesize_speech_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TextToSpeechRestInterceptor, "post_synthesize_speech_with_metadata") as post_with_metadata, \

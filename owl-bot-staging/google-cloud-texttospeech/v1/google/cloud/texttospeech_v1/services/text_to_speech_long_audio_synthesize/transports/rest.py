...
class TextToSpeechLongAudioSynthesizeRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_synthesize_long_audio(self, request: cloud_tts_lrs.SynthesizeLongAudioRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloud_tts_lrs.SynthesizeLongAudioRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_synthesize_long_audio_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for synthesize_long_audio
...
class TextToSpeechLongAudioSynthesizeRestTransport(_BaseTextToSpeechLongAudioSynthesizeRestTransport):
    ...
    class _SynthesizeLongAudio(_BaseTextToSpeechLongAudioSynthesizeRestTransport._BaseSynthesizeLongAudio, TextToSpeechLongAudioSynthesizeRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseTextToSpeechLongAudioSynthesizeRestTransport._BaseSynthesizeLongAudio._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = TextToSpeechLongAudioSynthesizeRestTransport._SynthesizeLongAudio._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseTextToSpeechLongAudioSynthesizeRestTransport._BaseGetOperation, TextToSpeechLongAudioSynthesizeRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TextToSpeechLongAudioSynthesizeRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseTextToSpeechLongAudioSynthesizeRestTransport._BaseListOperations, TextToSpeechLongAudioSynthesizeRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TextToSpeechLongAudioSynthesizeRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class CloudChannelReportsServiceTransport(abc.ABC):
    """Abstract transport class for CloudChannelReportsService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.run_report_job: gapic_v1.method.wrap_method(
                self.run_report_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.fetch_report_results: gapic_v1.method.wrap_method(
                self.fetch_report_results,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    @property
    def run_report_job(self) -> Callable[
    ...
    @property
    def fetch_report_results(self) -> Callable[
            [reports_service.FetchReportResultsRequest],
            Union[
                reports_service.FetchReportResultsResponse,
                Awaitable[reports_service.FetchReportResultsResponse]
            ]]:
        raise NotImplementedError()

...
class CloudChannelReportsServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(CloudChannelReportsServiceClient).get_transport_class, type(CloudChannelReportsServiceClient))
    ...
    async def run_report_job(self,
        ...
        """
        warnings.warn("CloudChannelReportsServiceAsyncClient.run_report_job is deprecated",
            DeprecationWarning)
    ...
    async def fetch_report_results(self,
        ...
        """
        warnings.warn("CloudChannelReportsServiceAsyncClient.fetch_report_results is deprecated",
            DeprecationWarning)
    ...
    async def list_reports(self,
        ...
        """
        warnings.warn("CloudChannelReportsServiceAsyncClient.list_reports is deprecated",
            DeprecationWarning)

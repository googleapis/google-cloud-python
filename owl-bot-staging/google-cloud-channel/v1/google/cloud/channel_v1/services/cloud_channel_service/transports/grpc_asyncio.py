...
class CloudChannelServiceGrpcAsyncIOTransport(CloudChannelServiceTransport):
    ...
    def __init__(self, *,
        ...
        Args:
            host (Optional[str]):
                 The hostname to connect to (default: 'cloudchannel.googleapis.com').
    ...
    def check_cloud_identity_accounts_exist(self) -> Callable[
        ...
        if 'check_cloud_identity_accounts_exist' not in self._stubs:
            self._stubs['check_cloud_identity_accounts_exist'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_customer_repricing_config(self) -> Callable[
        ...
        if 'get_customer_repricing_config' not in self._stubs:
            self._stubs['get_customer_repricing_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_customer_repricing_configs(self) -> Callable[
        ...
        if 'list_customer_repricing_configs' not in self._stubs:
            self._stubs['list_customer_repricing_configs'] = self.grpc_channel.unary_unary(
    ...
    @property
    def create_customer_repricing_config(self) -> Callable[
        ...
        if 'create_customer_repricing_config' not in self._stubs:
            self._stubs['create_customer_repricing_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def update_customer_repricing_config(self) -> Callable[
        ...
        if 'update_customer_repricing_config' not in self._stubs:
            self._stubs['update_customer_repricing_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def delete_customer_repricing_config(self) -> Callable[
        ...
        if 'delete_customer_repricing_config' not in self._stubs:
            self._stubs['delete_customer_repricing_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_channel_partner_repricing_config(self) -> Callable[
        ...
        if 'get_channel_partner_repricing_config' not in self._stubs:
            self._stubs['get_channel_partner_repricing_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_channel_partner_repricing_configs(self) -> Callable[
        ...
        if 'list_channel_partner_repricing_configs' not in self._stubs:
            self._stubs['list_channel_partner_repricing_configs'] = self.grpc_channel.unary_unary(
    ...
    @property
    def create_channel_partner_repricing_config(self) -> Callable[
        ...
        if 'create_channel_partner_repricing_config' not in self._stubs:
            self._stubs['create_channel_partner_repricing_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def update_channel_partner_repricing_config(self) -> Callable[
        ...
        if 'update_channel_partner_repricing_config' not in self._stubs:
            self._stubs['update_channel_partner_repricing_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def delete_channel_partner_repricing_config(self) -> Callable[
        ...
        if 'delete_channel_partner_repricing_config' not in self._stubs:
            self._stubs['delete_channel_partner_repricing_config'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_sku_groups(self) -> Callable[
            [service.ListSkuGroupsRequest],
            Awaitable[service.ListSkuGroupsResponse]]:
    ...
    @property
    def list_sku_group_billable_skus(self) -> Callable[
    ...
    @property
    def lookup_offer(self) -> Callable[
            [service.LookupOfferRequest],
            Awaitable[offers.Offer]]:
    ...
    @property
    def query_eligible_billing_accounts(self) -> Callable[
        ...
        if 'query_eligible_billing_accounts' not in self._stubs:
            self._stubs['query_eligible_billing_accounts'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_entitlement_changes(self) -> Callable[
...
__all__ = (
    'CloudChannelServiceGrpcAsyncIOTransport',
)

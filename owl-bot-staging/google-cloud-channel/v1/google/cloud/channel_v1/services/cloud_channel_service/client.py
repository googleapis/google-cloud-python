...
class CloudChannelServiceClient(metaclass=CloudChannelServiceClientMeta):
    ...
    @staticmethod
    def billing_account_path(account: str,billing_account: str,) -> str:
        """Returns a fully-qualified billing_account string."""
        return "accounts/{account}/billingAccounts/{billing_account}".format(account=account, billing_account=billing_account, )
    ...
    @staticmethod
    def sku_group_path(account: str,sku_group: str,) -> str:
        """Returns a fully-qualified sku_group string."""
        return "accounts/{account}/skuGroups/{sku_group}".format(account=account, sku_group=sku_group, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            CloudChannelServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def list_sku_group_billable_skus(self,
    ...
    def query_eligible_billing_accounts(self,

...
class CloudChannelServiceAsyncClient:
    ...
    get_transport_class = CloudChannelServiceClient.get_transport_class
    ...
    async def get_customer_repricing_config(self,
    ...
    async def list_customer_repricing_configs(self,
    ...
    async def create_customer_repricing_config(self,
    ...
    async def update_customer_repricing_config(self,
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("customer_repricing_config.name", request.customer_repricing_config.name),
            )),
        )
    ...
    async def delete_customer_repricing_config(self,
    ...
    async def get_channel_partner_repricing_config(self,
    ...
    async def list_channel_partner_repricing_configs(self,
    ...
    async def create_channel_partner_repricing_config(self,
    ...
    async def update_channel_partner_repricing_config(self,
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("channel_partner_repricing_config.name", request.channel_partner_repricing_config.name),
            )),
        )
    ...
    async def delete_channel_partner_repricing_config(self,
    ...
    async def list_sku_groups(self,
    ...
    async def list_sku_group_billable_skus(self,
    ...
    async def query_eligible_billing_accounts(self,
        ...
        r"""Lists the billing accounts that are eligible to purchase
        ...
        .. code-block:: python
            ...
            async def sample_query_eligible_billing_accounts():
                ...
                # Make the request
                response = await client.query_eligible_billing_accounts(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.channel_v1.types.QueryEligibleBillingAccountsRequest, dict]]):
                The request object. Request message for
    ...
    async def list_entitlement_changes(self,

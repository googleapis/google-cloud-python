...
from .rest_base import _BaseClientGatewaysServiceRestTransport
...
class ClientGatewaysServiceRestInterceptor:
    """Interceptor for ClientGatewaysService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the ClientGatewaysServiceRestTransport.

    .. code-block:: python
        class MyCustomClientGatewaysServiceInterceptor(ClientGatewaysServiceRestInterceptor):
            def pre_create_client_gateway(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_create_client_gateway(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_delete_client_gateway(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_delete_client_gateway(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_get_client_gateway(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_client_gateway(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_client_gateways(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_client_gateways(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = ClientGatewaysServiceRestTransport(interceptor=MyCustomClientGatewaysServiceInterceptor())
        client = ClientGatewaysServiceClient(transport=transport)


    """
    def pre_create_client_gateway(self, request: client_gateways_service.CreateClientGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[client_gateways_service.CreateClientGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for create_client_gateway

        Override in a subclass to manipulate the request or metadata
        before they are sent to the ClientGatewaysService server.
        """
        return request, metadata
    ...
    def post_create_client_gateway(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        after it is returned by the ClientGatewaysService server but before
        it is returned to user code. This `post_create_client_gateway` interceptor runs
        before the `post_create_client_gateway_with_metadata` interceptor.
        """
        return response

    def post_create_client_gateway_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_client_gateway

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the ClientGatewaysService server but before it is returned to user code.

        We recommend only using this `post_create_client_gateway_with_metadata`
        interceptor in new development instead of the `post_create_client_gateway` interceptor.
        When both interceptors are used, this `post_create_client_gateway_with_metadata` interceptor runs after the
        `post_create_client_gateway` interceptor. The (possibly modified) response returned by
        `post_create_client_gateway` will be passed to
        `post_create_client_gateway_with_metadata`.
        """
        return response, metadata

    def pre_delete_client_gateway(self, request: client_gateways_service.DeleteClientGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[client_gateways_service.DeleteClientGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_client_gateway(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the ClientGatewaysService server but before
        it is returned to user code. This `post_delete_client_gateway` interceptor runs
        before the `post_delete_client_gateway_with_metadata` interceptor.
        """
        return response

    def post_delete_client_gateway_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_client_gateway

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the ClientGatewaysService server but before it is returned to user code.

        We recommend only using this `post_delete_client_gateway_with_metadata`
        interceptor in new development instead of the `post_delete_client_gateway` interceptor.
        When both interceptors are used, this `post_delete_client_gateway_with_metadata` interceptor runs after the
        `post_delete_client_gateway` interceptor. The (possibly modified) response returned by
        `post_delete_client_gateway` will be passed to
        `post_delete_client_gateway_with_metadata`.
        """
        return response, metadata

    def pre_get_client_gateway(self, request: client_gateways_service.GetClientGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[client_gateways_service.GetClientGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_client_gateway(self, response: client_gateways_service.ClientGateway) -> client_gateways_service.ClientGateway:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the ClientGatewaysService server but before
        it is returned to user code. This `post_get_client_gateway` interceptor runs
        before the `post_get_client_gateway_with_metadata` interceptor.
        """
        return response

    def post_get_client_gateway_with_metadata(self, response: client_gateways_service.ClientGateway, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[client_gateways_service.ClientGateway, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_client_gateway

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the ClientGatewaysService server but before it is returned to user code.

        We recommend only using this `post_get_client_gateway_with_metadata`
        interceptor in new development instead of the `post_get_client_gateway` interceptor.
        When both interceptors are used, this `post_get_client_gateway_with_metadata` interceptor runs after the
        `post_get_client_gateway` interceptor. The (possibly modified) response returned by
        `post_get_client_gateway` will be passed to
        `post_get_client_gateway_with_metadata`.
        """
        return response, metadata

    def pre_list_client_gateways(self, request: client_gateways_service.ListClientGatewaysRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[client_gateways_service.ListClientGatewaysRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_client_gateways(self, response: client_gateways_service.ListClientGatewaysResponse) -> client_gateways_service.ListClientGatewaysResponse:
        """Post-rpc interceptor for list_client_gateways

        DEPRECATED. Please use the `post_list_client_gateways_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the ClientGatewaysService server but before
        it is returned to user code. This `post_list_client_gateways` interceptor runs
        before the `post_list_client_gateways_with_metadata` interceptor.
        """
        return response

    def post_list_client_gateways_with_metadata(self, response: client_gateways_service.ListClientGatewaysResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[client_gateways_service.ListClientGatewaysResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_client_gateways

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the ClientGatewaysService server but before it is returned to user code.

        We recommend only using this `post_list_client_gateways_with_metadata`
        interceptor in new development instead of the `post_list_client_gateways` interceptor.
        When both interceptors are used, this `post_list_client_gateways_with_metadata` interceptor runs after the
        `post_list_client_gateways` interceptor. The (possibly modified) response returned by
        `post_list_client_gateways` will be passed to
...
class ClientGatewaysServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: ClientGatewaysServiceRestInterceptor


class ClientGatewaysServiceRestTransport(_BaseClientGatewaysServiceRestTransport):
    """REST backend synchronous transport for ClientGatewaysService.
    ...
    def __init__(self, *,
            ...
            interceptor: Optional[ClientGatewaysServiceRestInterceptor] = None,
        ...
        self._interceptor = interceptor or ClientGatewaysServiceRestInterceptor()
    ...
    class _CreateClientGateway(_BaseClientGatewaysServiceRestTransport._BaseCreateClientGateway, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the create client gateway method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.CreateClientGateway",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "CreateClientGateway",
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._CreateClientGateway._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.create_client_gateway",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "CreateClientGateway",
    ...
    class _DeleteClientGateway(_BaseClientGatewaysServiceRestTransport._BaseDeleteClientGateway, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the delete client gateway method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.DeleteClientGateway",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "DeleteClientGateway",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._DeleteClientGateway._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.delete_client_gateway",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "DeleteClientGateway",
                        "metadata": http_response["headers"],
    ...
    class _GetClientGateway(_BaseClientGatewaysServiceRestTransport._BaseGetClientGateway, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the get client gateway method over HTTP.
            ...
            Returns:
                ~.client_gateways_service.ClientGateway:
                    Message describing ClientGateway
                object.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.GetClientGateway",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "GetClientGateway",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._GetClientGateway._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = client_gateways_service.ClientGateway()
            pb_resp = client_gateways_service.ClientGateway.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.get_client_gateway",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "GetClientGateway",
                        "metadata": http_response["headers"],
    ...
    class _ListClientGateways(_BaseClientGatewaysServiceRestTransport._BaseListClientGateways, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            r"""Call the list client gateways method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.ListClientGateways",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "ListClientGateways",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._ListClientGateways._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = client_gateways_service.ListClientGatewaysResponse()
            pb_resp = client_gateways_service.ListClientGatewaysResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.list_client_gateways",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "ListClientGateways",
                        "metadata": http_response["headers"],
    ...
    @property
    def create_client_gateway(self) -> Callable[
    ...
    @property
    def delete_client_gateway(self) -> Callable[
    ...
    @property
    def get_client_gateway(self) -> Callable[
    ...
    @property
    def list_client_gateways(self) -> Callable[
    ...
    class _GetLocation(_BaseClientGatewaysServiceRestTransport._BaseGetLocation, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(_BaseClientGatewaysServiceRestTransport._BaseListLocations, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _GetIamPolicy(_BaseClientGatewaysServiceRestTransport._BaseGetIamPolicy, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.GetIamPolicy",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceAsyncClient.GetIamPolicy",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(_BaseClientGatewaysServiceRestTransport._BaseSetIamPolicy, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.SetIamPolicy",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceAsyncClient.SetIamPolicy",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(_BaseClientGatewaysServiceRestTransport._BaseTestIamPermissions, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.TestIamPermissions",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceAsyncClient.TestIamPermissions",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseClientGatewaysServiceRestTransport._BaseCancelOperation, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteOperation(_BaseClientGatewaysServiceRestTransport._BaseDeleteOperation, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.DeleteOperation",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseClientGatewaysServiceRestTransport._BaseGetOperation, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseClientGatewaysServiceRestTransport._BaseListOperations, ClientGatewaysServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
            ...
            # Send the request
            response = ClientGatewaysServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.beyondcorp.clientgateways.v1.ClientGatewaysService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

...
class BackupForGKEAsyncClient:
    ...
    async def create_backup_plan(self,
    ...
    async def list_backup_plans(self,
    ...
    async def get_backup_plan(self,
    ...
    async def update_backup_plan(self,
    ...
    async def delete_backup_plan(self,
    ...
    async def create_backup_channel(self,
    ...
    async def list_backup_channels(self,
    ...
    async def update_backup_channel(self,
    ...
    async def delete_backup_channel(self,
    ...
    async def list_backup_plan_bindings(self,
    ...
    async def get_backup_plan_binding(self,
    ...
    async def list_volume_backups(self,
    ...
    async def create_restore_plan(self,
    ...
    async def list_restore_plans(self,
    ...
    async def get_restore_plan(self,
    ...
    async def update_restore_plan(self,
    ...
    async def delete_restore_plan(self,
    ...
    async def create_restore_channel(self,
    ...
    async def list_restore_channels(self,
    ...
    async def get_restore_channel(self,
    ...
    async def update_restore_channel(self,
    ...
    async def delete_restore_channel(self,
    ...
    async def list_restore_plan_bindings(self,
    ...
    async def get_restore_plan_binding(self,
    ...
    async def list_volume_restores(self,
    ...
    async def get_volume_restore(self,
    ...
    async def get_backup_index_download_url(self,

...
class BackupForGKEClient(metaclass=BackupForGKEClientMeta):
    ...
    @staticmethod
    def backup_channel_path(project: str,location: str,backup_channel: str,) -> str:
        """Returns a fully-qualified backup_channel string."""
        return "projects/{project}/locations/{location}/backupChannels/{backup_channel}".format(project=project, location=location, backup_channel=backup_channel, )
    ...
    @staticmethod
    def backup_plan_binding_path(project: str,location: str,backup_channel: str,backup_plan_binding: str,) -> str:
        """Returns a fully-qualified backup_plan_binding string."""
        return "projects/{project}/locations/{location}/backupChannels/{backup_channel}/backupPlanBindings/{backup_plan_binding}".format(project=project, location=location, backup_channel=backup_channel, backup_plan_binding=backup_plan_binding, )

    @staticmethod
    def parse_backup_plan_binding_path(path: str) -> Dict[str,str]:
        """Parses a backup_plan_binding path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupChannels/(?P<backup_channel>.+?)/backupPlanBindings/(?P<backup_plan_binding>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def restore_channel_path(project: str,location: str,restore_channel: str,) -> str:
        """Returns a fully-qualified restore_channel string."""
        return "projects/{project}/locations/{location}/restoreChannels/{restore_channel}".format(project=project, location=location, restore_channel=restore_channel, )
    ...
    @staticmethod
    def restore_plan_binding_path(project: str,location: str,restore_channel: str,restore_plan_binding: str,) -> str:
        """Returns a fully-qualified restore_plan_binding string."""
        return "projects/{project}/locations/{location}/restoreChannels/{restore_channel}/restorePlanBindings/{restore_plan_binding}".format(project=project, location=location, restore_channel=restore_channel, restore_plan_binding=restore_plan_binding, )

    @staticmethod
    def parse_restore_plan_binding_path(path: str) -> Dict[str,str]:
        """Parses a restore_plan_binding path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/restoreChannels/(?P<restore_channel>.+?)/restorePlanBindings/(?P<restore_plan_binding>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def create_backup_channel(self,
    ...
    def update_backup_channel(self,
    ...
    def delete_backup_channel(self,
    ...
    def list_backup_plan_bindings(self,
    ...
    def get_backup_plan_binding(self,
    ...
    def create_restore_channel(self,
    ...
    def list_restore_channels(self,
    ...
    def update_restore_channel(self,
    ...
    def delete_restore_channel(self,
    ...
    def list_restore_plan_bindings(self,
    ...
    def get_restore_plan_binding(self,
    ...
    def get_backup_index_download_url(self,

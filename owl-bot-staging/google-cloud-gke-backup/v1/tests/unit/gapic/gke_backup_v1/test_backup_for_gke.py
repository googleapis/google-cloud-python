...
def test_get_backup_index_download_url(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_backup_index_download_url),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_backup_index_download_url_rest_required_fields(request_type=gkebackup.GetBackupIndexDownloadUrlRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_backup_index_download_url._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_backup_index_download_url_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{backup=projects/*/locations/*/backupPlans/*/backups/*}:getBackupIndexDownloadUrl" % client.transport._host, args[1])
...
def test_create_backup_plan_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["backup_plan"] = {'name': 'name_value', 'uid': 'uid_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'cluster': 'cluster_value', 'retention_policy': {'backup_delete_lock_days': 2400, 'backup_retain_days': 1896, 'locked': True}, 'labels': {}, 'backup_schedule': {'cron_schedule': 'cron_schedule_value', 'paused': True, 'rpo_config': {'target_rpo_minutes': 1947, 'exclusion_windows': [{'start_time': {'hours': 561, 'minutes': 773, 'seconds': 751, 'nanos': 543}, 'duration': {'seconds': 751, 'nanos': 543}, 'single_occurrence_date': {'year': 433, 'month': 550, 'day': 318}, 'daily': True, 'days_of_week': {'days_of_week': [1]}}]}, 'next_scheduled_backup_time': {}}, 'etag': 'etag_value', 'deactivated': True, 'backup_config': {'all_namespaces': True, 'selected_namespaces': {'namespaces': ['namespaces_value1', 'namespaces_value2']}, 'selected_applications': {'namespaced_names': [{'namespace': 'namespace_value', 'name': 'name_value'}]}, 'include_volume_data': True, 'include_secrets': True, 'encryption_key': {'gcp_kms_encryption_key': 'gcp_kms_encryption_key_value'}, 'permissive_mode': True}, 'protected_pod_count': 2036, 'state': 1, 'state_reason': 'state_reason_value', 'rpo_risk_level': 1504, 'rpo_risk_reason': 'rpo_risk_reason_value'}
...
def test_create_backup_plan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_create_backup_plan_with_metadata") as post_with_metadata, \
...
def test_list_backup_plans_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_list_backup_plans_with_metadata") as post_with_metadata, \
...
def test_get_backup_plan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_get_backup_plan_with_metadata") as post_with_metadata, \
...
def test_update_backup_plan_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'backup_plan': {'name': 'projects/sample1/locations/sample2/backupPlans/sample3'}}
    request_init["backup_plan"] = {'name': 'projects/sample1/locations/sample2/backupPlans/sample3', 'uid': 'uid_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'cluster': 'cluster_value', 'retention_policy': {'backup_delete_lock_days': 2400, 'backup_retain_days': 1896, 'locked': True}, 'labels': {}, 'backup_schedule': {'cron_schedule': 'cron_schedule_value', 'paused': True, 'rpo_config': {'target_rpo_minutes': 1947, 'exclusion_windows': [{'start_time': {'hours': 561, 'minutes': 773, 'seconds': 751, 'nanos': 543}, 'duration': {'seconds': 751, 'nanos': 543}, 'single_occurrence_date': {'year': 433, 'month': 550, 'day': 318}, 'daily': True, 'days_of_week': {'days_of_week': [1]}}]}, 'next_scheduled_backup_time': {}}, 'etag': 'etag_value', 'deactivated': True, 'backup_config': {'all_namespaces': True, 'selected_namespaces': {'namespaces': ['namespaces_value1', 'namespaces_value2']}, 'selected_applications': {'namespaced_names': [{'namespace': 'namespace_value', 'name': 'name_value'}]}, 'include_volume_data': True, 'include_secrets': True, 'encryption_key': {'gcp_kms_encryption_key': 'gcp_kms_encryption_key_value'}, 'permissive_mode': True}, 'protected_pod_count': 2036, 'state': 1, 'state_reason': 'state_reason_value', 'rpo_risk_level': 1504, 'rpo_risk_reason': 'rpo_risk_reason_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_backup_plan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_update_backup_plan_with_metadata") as post_with_metadata, \
...
def test_delete_backup_plan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_delete_backup_plan_with_metadata") as post_with_metadata, \
...
def test_create_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_create_backup_with_metadata") as post_with_metadata, \
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_list_backups_with_metadata") as post_with_metadata, \
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_get_backup_with_metadata") as post_with_metadata, \
...
def test_update_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_update_backup_with_metadata") as post_with_metadata, \
...
def test_delete_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_delete_backup_with_metadata") as post_with_metadata, \
...
def test_list_volume_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_list_volume_backups_with_metadata") as post_with_metadata, \
...
def test_get_volume_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_get_volume_backup_with_metadata") as post_with_metadata, \
...
def test_create_restore_plan_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["restore_plan"] = {'name': 'name_value', 'uid': 'uid_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'backup_plan': 'backup_plan_value', 'cluster': 'cluster_value', 'restore_config': {'volume_data_restore_policy': 1, 'cluster_resource_conflict_policy': 1, 'namespaced_resource_restore_mode': 1, 'cluster_resource_restore_scope': {'selected_group_kinds': [{'resource_group': 'resource_group_value', 'resource_kind': 'resource_kind_value'}], 'excluded_group_kinds': {}, 'all_group_kinds': True, 'no_group_kinds': True}, 'all_namespaces': True, 'selected_namespaces': {'namespaces': ['namespaces_value1', 'namespaces_value2']}, 'selected_applications': {'namespaced_names': [{'namespace': 'namespace_value', 'name': 'name_value'}]}, 'no_namespaces': True, 'excluded_namespaces': {}, 'substitution_rules': [{'target_namespaces': ['target_namespaces_value1', 'target_namespaces_value2'], 'target_group_kinds': {}, 'target_json_path': 'target_json_path_value', 'original_value_pattern': 'original_value_pattern_value', 'new_value': 'new_value_value'}], 'transformation_rules': [{'field_actions': [{'op': 1, 'from_path': 'from_path_value', 'path': 'path_value', 'value': 'value_value'}], 'resource_filter': {'namespaces': ['namespaces_value1', 'namespaces_value2'], 'group_kinds': {}, 'json_path': 'json_path_value'}, 'description': 'description_value'}], 'volume_data_restore_policy_bindings': [{'policy': 1, 'volume_type': 1}], 'restore_order': {'group_kind_dependencies': [{'satisfying': {}, 'requiring': {}}]}}, 'labels': {}, 'etag': 'etag_value', 'state': 1, 'state_reason': 'state_reason_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_restore_plan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_create_restore_plan_with_metadata") as post_with_metadata, \
...
def test_list_restore_plans_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_list_restore_plans_with_metadata") as post_with_metadata, \
...
def test_get_restore_plan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_get_restore_plan_with_metadata") as post_with_metadata, \
...
def test_update_restore_plan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_update_restore_plan_with_metadata") as post_with_metadata, \
...
def test_delete_restore_plan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_delete_restore_plan_with_metadata") as post_with_metadata, \
...
def test_create_restore_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/restorePlans/sample3'}
    request_init["restore"] = {'name': 'name_value', 'uid': 'uid_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'description': 'description_value', 'backup': 'backup_value', 'cluster': 'cluster_value', 'restore_config': {'volume_data_restore_policy': 1, 'cluster_resource_conflict_policy': 1, 'namespaced_resource_restore_mode': 1, 'cluster_resource_restore_scope': {'selected_group_kinds': [{'resource_group': 'resource_group_value', 'resource_kind': 'resource_kind_value'}], 'excluded_group_kinds': {}, 'all_group_kinds': True, 'no_group_kinds': True}, 'all_namespaces': True, 'selected_namespaces': {'namespaces': ['namespaces_value1', 'namespaces_value2']}, 'selected_applications': {'namespaced_names': [{'namespace': 'namespace_value', 'name': 'name_value'}]}, 'no_namespaces': True, 'excluded_namespaces': {}, 'substitution_rules': [{'target_namespaces': ['target_namespaces_value1', 'target_namespaces_value2'], 'target_group_kinds': {}, 'target_json_path': 'target_json_path_value', 'original_value_pattern': 'original_value_pattern_value', 'new_value': 'new_value_value'}], 'transformation_rules': [{'field_actions': [{'op': 1, 'from_path': 'from_path_value', 'path': 'path_value', 'value': 'value_value'}], 'resource_filter': {'namespaces': ['namespaces_value1', 'namespaces_value2'], 'group_kinds': {}, 'json_path': 'json_path_value'}, 'description': 'description_value'}], 'volume_data_restore_policy_bindings': [{'policy': 1, 'volume_type': 1}], 'restore_order': {'group_kind_dependencies': [{'satisfying': {}, 'requiring': {}}]}}, 'labels': {}, 'state': 1, 'state_reason': 'state_reason_value', 'complete_time': {}, 'resources_restored_count': 2602, 'resources_excluded_count': 2576, 'resources_failed_count': 2343, 'volumes_restored_count': 2394, 'etag': 'etag_value', 'filter': {'inclusion_filters': [{'group_kind': {}, 'name': 'name_value', 'namespace': 'namespace_value', 'labels': {}}], 'exclusion_filters': {}}, 'volume_data_restore_policy_overrides': [{'policy': 1, 'selected_pvcs': {}}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_restore_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_create_restore_with_metadata") as post_with_metadata, \
...
def test_list_restores_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_list_restores_with_metadata") as post_with_metadata, \
...
def test_get_restore_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_get_restore_with_metadata") as post_with_metadata, \
...
def test_update_restore_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_update_restore_with_metadata") as post_with_metadata, \
...
def test_delete_restore_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_delete_restore_with_metadata") as post_with_metadata, \
...
def test_list_volume_restores_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_list_volume_restores_with_metadata") as post_with_metadata, \
...
def test_get_volume_restore_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_get_volume_restore_with_metadata") as post_with_metadata, \
...
def test_get_backup_index_download_url_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_get_backup_index_download_url") as post, \
        mock.patch.object(transports.BackupForGKERestInterceptor, "post_get_backup_index_download_url_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BackupForGKERestInterceptor, "pre_get_backup_index_download_url") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_backup_index_download_url(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

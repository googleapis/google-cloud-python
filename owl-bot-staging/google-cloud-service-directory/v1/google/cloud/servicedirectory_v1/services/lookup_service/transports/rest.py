...
class LookupServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_resolve_service(self, request: lookup_service.ResolveServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[lookup_service.ResolveServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_resolve_service_with_metadata(self, response: lookup_service.ResolveServiceResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[lookup_service.ResolveServiceResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for resolve_service
...
class LookupServiceRestTransport(_BaseLookupServiceRestTransport):
    ...
    class _ResolveService(_BaseLookupServiceRestTransport._BaseResolveService, LookupServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LookupServiceRestTransport._ResolveService._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetLocation(_BaseLookupServiceRestTransport._BaseGetLocation, LookupServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LookupServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseLookupServiceRestTransport._BaseListLocations, LookupServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LookupServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

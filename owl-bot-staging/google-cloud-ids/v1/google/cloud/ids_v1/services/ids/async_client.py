...
class IDSAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = IDSClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = IDSClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, IDSTransport, Callable[..., IDSTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.ids_v1.IDSAsyncClient`.",
                extra = {

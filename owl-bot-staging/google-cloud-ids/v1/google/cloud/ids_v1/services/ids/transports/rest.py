...
class IDSRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_endpoint(self, request: ids.CreateEndpointRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ids.CreateEndpointRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_endpoint(self, request: ids.DeleteEndpointRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ids.DeleteEndpointRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_endpoint(self, request: ids.GetEndpointRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ids.GetEndpointRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_endpoints(self, request: ids.ListEndpointsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ids.ListEndpointsRequest, Sequence[Tuple[str, str]]]:

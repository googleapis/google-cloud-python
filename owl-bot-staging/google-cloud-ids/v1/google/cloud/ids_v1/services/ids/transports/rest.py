...
class IDSRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_endpoint(self, request: ids.CreateEndpointRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ids.CreateEndpointRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_endpoint_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_endpoint
    ...
    def pre_delete_endpoint(self, request: ids.DeleteEndpointRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ids.DeleteEndpointRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_endpoint_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_endpoint
    ...
    def pre_get_endpoint(self, request: ids.GetEndpointRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ids.GetEndpointRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_endpoint_with_metadata(self, response: ids.Endpoint, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ids.Endpoint, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_endpoint
    ...
    def pre_list_endpoints(self, request: ids.ListEndpointsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ids.ListEndpointsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_endpoints_with_metadata(self, response: ids.ListEndpointsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ids.ListEndpointsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_endpoints
...
class IDSRestTransport(_BaseIDSRestTransport):
    ...
    class _CreateEndpoint(_BaseIDSRestTransport._BaseCreateEndpoint, IDSRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = IDSRestTransport._CreateEndpoint._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

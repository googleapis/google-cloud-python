...
def test_list_endpoints_rest_unset_required_fields():
    transport = transports.IDSRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = ids.ListEndpointsResponse.to_json(ids.ListEndpointsResponse())
...
def test_list_endpoints_rest_bad_request(transport: str = 'rest', request_type=ids.ListEndpointsRequest):
    client = IDSClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_endpoint_rest_bad_request(transport: str = 'rest', request_type=ids.GetEndpointRequest):
    client = IDSClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_endpoint_rest_bad_request(transport: str = 'rest', request_type=ids.CreateEndpointRequest):
    client = IDSClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_endpoint_rest_bad_request(transport: str = 'rest', request_type=ids.DeleteEndpointRequest):
    client = IDSClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )

...
from google.analytics.admin_v1beta.types import access_report
...
class AnalyticsAdminServiceClient(metaclass=AnalyticsAdminServiceClientMeta):
    ...
    @staticmethod
    def key_event_path(property: str,key_event: str,) -> str:
        """Returns a fully-qualified key_event string."""
        return "properties/{property}/keyEvents/{key_event}".format(property=property, key_event=key_event, )

    @staticmethod
    def parse_key_event_path(path: str) -> Dict[str,str]:
        """Parses a key_event path into its component segments."""
        m = re.match(r"^properties/(?P<property>.+?)/keyEvents/(?P<key_event>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AnalyticsAdminServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AnalyticsAdminServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AnalyticsAdminServiceTransport, Callable[..., AnalyticsAdminServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AnalyticsAdminServiceClient._read_environment_variables()
        self._client_cert_source = AnalyticsAdminServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AnalyticsAdminServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AnalyticsAdminServiceTransport], Callable[..., AnalyticsAdminServiceTransport]] = (
    ...
    def create_conversion_event(self,
        ...
        """
        warnings.warn("AnalyticsAdminServiceClient.create_conversion_event is deprecated",
            DeprecationWarning)
    ...
    def update_conversion_event(self,
        ...
        """
        warnings.warn("AnalyticsAdminServiceClient.update_conversion_event is deprecated",
            DeprecationWarning)
    ...
    def get_conversion_event(self,
        ...
        """
        warnings.warn("AnalyticsAdminServiceClient.get_conversion_event is deprecated",
            DeprecationWarning)
    ...
    def delete_conversion_event(self,
        ...
        Args:
            ...
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
        warnings.warn("AnalyticsAdminServiceClient.delete_conversion_event is deprecated",
            DeprecationWarning)
    ...
    def list_conversion_events(self,
        ...
        """
        warnings.warn("AnalyticsAdminServiceClient.list_conversion_events is deprecated",
            DeprecationWarning)

...
class AnalyticsAdminServiceGrpcTransport(AnalyticsAdminServiceTransport):
    ...
    @property
    def create_key_event(self) -> Callable[
    ...
    @property
    def update_key_event(self) -> Callable[
    ...
    @property
    def get_key_event(self) -> Callable[
    ...
    @property
    def delete_key_event(self) -> Callable[
    ...
    @property
    def list_key_events(self) -> Callable[

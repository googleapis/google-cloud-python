...
class AnalyticsAdminServiceAsyncClient:
    ...
    async def create_subproperty(self,
        ...
        Args:
            request (Optional[Union[google.analytics.admin_v1alpha.types.CreateSubpropertyRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_subproperty]

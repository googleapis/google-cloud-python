...
class AnalyticsAdminServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_create_sk_ad_network_conversion_value_schema(self, response: resources.SKAdNetworkConversionValueSchema) -> resources.SKAdNetworkConversionValueSchema:
        ...
        """
        return response
    def pre_create_subproperty(self, request: analytics_admin.CreateSubpropertyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[analytics_admin.CreateSubpropertyRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_subproperty(self, response: analytics_admin.CreateSubpropertyResponse) -> analytics_admin.CreateSubpropertyResponse:
            ...
            },
{
    ...
    class _CreateSubproperty(AnalyticsAdminServiceRestStub):
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_create_subproperty(request, metadata)

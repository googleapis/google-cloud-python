...
class ProductSearchRestTransport(_BaseProductSearchRestTransport):
    ...
    class _GetOperation(_BaseProductSearchRestTransport._BaseGetOperation, ProductSearchRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseProductSearchRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseProductSearchRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ProductSearchRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class ImageAnnotatorRestTransport(_BaseImageAnnotatorRestTransport):
    ...
    class _GetOperation(_BaseImageAnnotatorRestTransport._BaseGetOperation, ImageAnnotatorRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseImageAnnotatorRestTransport._BaseGetOperation._get_http_options()

            request, metadata = self._interceptor.pre_get_operation(request, metadata)
            transcoded_request = _BaseImageAnnotatorRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseImageAnnotatorRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ImageAnnotatorRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

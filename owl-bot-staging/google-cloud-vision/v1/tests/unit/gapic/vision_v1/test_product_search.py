...
def test_create_product_set_rest_required_fields(request_type=product_search_service.CreateProductSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_product_set._get_unset_required_fields(jsonified_request)
...
def test_create_product_set_rest_unset_required_fields():
    transport = transports.ProductSearchRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_product_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = product_search_service.ProductSet.to_json(product_search_service.ProductSet())
...
def test_create_product_set_rest_bad_request(transport: str = 'rest', request_type=product_search_service.CreateProductSetRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_product_sets_rest_required_fields(request_type=product_search_service.ListProductSetsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_product_sets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_product_sets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = product_search_service.ListProductSetsResponse.to_json(product_search_service.ListProductSetsResponse())
...
def test_list_product_sets_rest_bad_request(transport: str = 'rest', request_type=product_search_service.ListProductSetsRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_product_set_rest_required_fields(request_type=product_search_service.GetProductSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_product_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_product_set_rest_bad_request(transport: str = 'rest', request_type=product_search_service.GetProductSetRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_product_set_rest_required_fields(request_type=product_search_service.UpdateProductSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_product_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_product_set_rest_bad_request(transport: str = 'rest', request_type=product_search_service.UpdateProductSetRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_product_set_rest_required_fields(request_type=product_search_service.DeleteProductSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_product_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_product_set_rest_bad_request(transport: str = 'rest', request_type=product_search_service.DeleteProductSetRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_product_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = product_search_service.Product.to_json(product_search_service.Product())
...
def test_create_product_rest_bad_request(transport: str = 'rest', request_type=product_search_service.CreateProductRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_products_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = product_search_service.ListProductsResponse.to_json(product_search_service.ListProductsResponse())
...
def test_list_products_rest_bad_request(transport: str = 'rest', request_type=product_search_service.ListProductsRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_product_rest_bad_request(transport: str = 'rest', request_type=product_search_service.GetProductRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_product_rest_bad_request(transport: str = 'rest', request_type=product_search_service.UpdateProductRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_product_rest_bad_request(transport: str = 'rest', request_type=product_search_service.DeleteProductRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_reference_image_rest_required_fields(request_type=product_search_service.CreateReferenceImageRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_reference_image._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_reference_image_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = product_search_service.ReferenceImage.to_json(product_search_service.ReferenceImage())
...
def test_create_reference_image_rest_bad_request(transport: str = 'rest', request_type=product_search_service.CreateReferenceImageRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_reference_image_rest_required_fields(request_type=product_search_service.DeleteReferenceImageRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_reference_image._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_reference_image_rest_bad_request(transport: str = 'rest', request_type=product_search_service.DeleteReferenceImageRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_reference_images_rest_required_fields(request_type=product_search_service.ListReferenceImagesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_reference_images._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_reference_images_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = product_search_service.ListReferenceImagesResponse.to_json(product_search_service.ListReferenceImagesResponse())
...
def test_list_reference_images_rest_bad_request(transport: str = 'rest', request_type=product_search_service.ListReferenceImagesRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_reference_image_rest_required_fields(request_type=product_search_service.GetReferenceImageRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_reference_image._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_reference_image_rest_bad_request(transport: str = 'rest', request_type=product_search_service.GetReferenceImageRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_add_product_to_product_set_rest_required_fields(request_type=product_search_service.AddProductToProductSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).add_product_to_product_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_add_product_to_product_set_rest_bad_request(transport: str = 'rest', request_type=product_search_service.AddProductToProductSetRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_remove_product_from_product_set_rest_required_fields(request_type=product_search_service.RemoveProductFromProductSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).remove_product_from_product_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_product_from_product_set_rest_bad_request(transport: str = 'rest', request_type=product_search_service.RemoveProductFromProductSetRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_products_in_product_set_rest_required_fields(request_type=product_search_service.ListProductsInProductSetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_products_in_product_set._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_products_in_product_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = product_search_service.ListProductsInProductSetResponse.to_json(product_search_service.ListProductsInProductSetResponse())
...
def test_list_products_in_product_set_rest_bad_request(transport: str = 'rest', request_type=product_search_service.ListProductsInProductSetRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_import_product_sets_rest_required_fields(request_type=product_search_service.ImportProductSetsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).import_product_sets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_product_sets_rest_bad_request(transport: str = 'rest', request_type=product_search_service.ImportProductSetsRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_purge_products_rest_required_fields(request_type=product_search_service.PurgeProductsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).purge_products._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_purge_products_rest_bad_request(transport: str = 'rest', request_type=product_search_service.PurgeProductsRequest):
    client = ProductSearchClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )

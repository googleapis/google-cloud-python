...
def test_batch_annotate_files_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ImageAnnotatorClient(
        ...
        # Ensure method has been cached
        assert client._transport.batch_annotate_files in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_annotate_files] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_annotate_files_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ImageAnnotatorAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_annotate_files in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_annotate_files] = mock_rpc

        request = {}
        await client.batch_annotate_files(request)
...
def test_batch_annotate_files_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        arg = args[0].requests
        mock_val = [image_annotator.AnnotateFileRequest(input_config=image_annotator.InputConfig(gcs_source=image_annotator.GcsSource(uri='uri_value')))]
        assert arg == mock_val
...
def test_async_batch_annotate_images_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ImageAnnotatorClient(
        ...
        # Ensure method has been cached
        assert client._transport.async_batch_annotate_images in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.async_batch_annotate_images] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_async_batch_annotate_images_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ImageAnnotatorAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.async_batch_annotate_images in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.async_batch_annotate_images] = mock_rpc

        request = {}
        await client.async_batch_annotate_images(request)
...
def test_batch_annotate_images_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1p4beta1/images:annotate" % client.transport._host, args[1])
...
def test_batch_annotate_files_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ImageAnnotatorClient(
...
def test_batch_annotate_files_rest_required_fields(request_type=image_annotator.BatchAnnotateFilesRequest):
    transport_class = transports.ImageAnnotatorRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_annotate_files._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = image_annotator.BatchAnnotateFilesResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_batch_annotate_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1p4beta1/files:annotate" % client.transport._host, args[1])
...
def test_async_batch_annotate_images_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ImageAnnotatorClient(
...
def test_async_batch_annotate_images_rest_required_fields(request_type=image_annotator.AsyncBatchAnnotateImagesRequest):
    transport_class = transports.ImageAnnotatorRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).async_batch_annotate_images._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_async_batch_annotate_images_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("requests", "outputConfig", )))
...
def test_async_batch_annotate_images_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1p4beta1/images:asyncBatchAnnotate" % client.transport._host, args[1])
...
def test_async_batch_annotate_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1p4beta1/files:asyncBatchAnnotate" % client.transport._host, args[1])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_annotate_files_empty_call_grpc():
    client = ImageAnnotatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = image_annotator.BatchAnnotateFilesResponse()
        client.batch_annotate_files(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = image_annotator.BatchAnnotateFilesRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_async_batch_annotate_images_empty_call_grpc():
    client = ImageAnnotatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.async_batch_annotate_images(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = image_annotator.AsyncBatchAnnotateImagesRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_annotate_files_empty_call_grpc_asyncio():
    client = ImageAnnotatorAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_annotate_files(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_async_batch_annotate_images_empty_call_grpc_asyncio():
    client = ImageAnnotatorAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.async_batch_annotate_images(request=None)
...
def test_batch_annotate_files_rest_bad_request(request_type=image_annotator.BatchAnnotateFilesRequest):
    client = ImageAnnotatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_annotate_files_rest_call_success(request_type):
    client = ImageAnnotatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_annotate_files_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ImageAnnotatorRestInterceptor, "post_batch_annotate_files") as post, \
        mock.patch.object(transports.ImageAnnotatorRestInterceptor, "post_batch_annotate_files_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImageAnnotatorRestInterceptor, "pre_batch_annotate_files") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = image_annotator.BatchAnnotateFilesRequest.pb(image_annotator.BatchAnnotateFilesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = image_annotator.BatchAnnotateFilesResponse.to_json(image_annotator.BatchAnnotateFilesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = image_annotator.BatchAnnotateFilesResponse(), metadata

        client.batch_annotate_files(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_async_batch_annotate_images_rest_bad_request(request_type=image_annotator.AsyncBatchAnnotateImagesRequest):
    client = ImageAnnotatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_async_batch_annotate_images_rest_call_success(request_type):
    client = ImageAnnotatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_async_batch_annotate_images_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ImageAnnotatorRestInterceptor, "post_async_batch_annotate_images") as post, \
        mock.patch.object(transports.ImageAnnotatorRestInterceptor, "post_async_batch_annotate_images_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ImageAnnotatorRestInterceptor, "pre_async_batch_annotate_images") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = image_annotator.AsyncBatchAnnotateImagesRequest.pb(image_annotator.AsyncBatchAnnotateImagesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.async_batch_annotate_images(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_annotate_files_empty_call_rest():
    client = ImageAnnotatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_async_batch_annotate_images_empty_call_rest():
    client = ImageAnnotatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_image_annotator_base_transport():
    ...
    with mock.patch('google.cloud.vision_v1p4beta1.services.image_annotator.transports.ImageAnnotatorTransport.__init__') as Transport:
...
def test_image_annotator_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.vision_v1p4beta1.services.image_annotator.transports.ImageAnnotatorTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_image_annotator_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.vision_v1p4beta1.services.image_annotator.transports.ImageAnnotatorTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ImageAnnotatorTransport()
        adc.assert_called_once()
...
def test_image_annotator_client_transport_session_collision(transport_name):
    ...
    session1 = client1.transport.batch_annotate_files._session
    session2 = client2.transport.batch_annotate_files._session
    assert session1 != session2
    session1 = client1.transport.async_batch_annotate_images._session
    session2 = client2.transport.async_batch_annotate_images._session
    assert session1 != session2

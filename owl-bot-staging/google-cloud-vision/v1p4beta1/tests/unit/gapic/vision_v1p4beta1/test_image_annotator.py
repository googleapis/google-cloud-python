...
def test_batch_annotate_files_rest_required_fields(request_type=image_annotator.BatchAnnotateFilesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_annotate_files._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_async_batch_annotate_images_rest_required_fields(request_type=image_annotator.AsyncBatchAnnotateImagesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).async_batch_annotate_images._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.batch_annotate_files] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.async_batch_annotate_images] = mock_object
...
def test_batch_annotate_files_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = image_annotator.BatchAnnotateFilesResponse.to_json(image_annotator.BatchAnnotateFilesResponse())
...
def test_batch_annotate_files_rest_bad_request(transport: str = 'rest', request_type=image_annotator.BatchAnnotateFilesRequest):
    client = ImageAnnotatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_async_batch_annotate_images_rest_bad_request(transport: str = 'rest', request_type=image_annotator.AsyncBatchAnnotateImagesRequest):
    client = ImageAnnotatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

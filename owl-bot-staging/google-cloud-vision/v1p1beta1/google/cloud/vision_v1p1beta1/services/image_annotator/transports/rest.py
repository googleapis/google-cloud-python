...
from .base import ImageAnnotatorTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ImageAnnotatorRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_annotate_images(self, request: image_annotator.BatchAnnotateImagesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[image_annotator.BatchAnnotateImagesRequest, Sequence[Tuple[str, str]]]:
...
class ImageAnnotatorRestTransport(ImageAnnotatorTransport):
    """REST backend transport for ImageAnnotator.
    ...
    class _BatchAnnotateImages(ImageAnnotatorRestStub):
        def __hash__(self):

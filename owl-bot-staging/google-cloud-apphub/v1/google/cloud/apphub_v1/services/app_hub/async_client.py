...
from .transports.base import AppHubTransport, DEFAULT_CLIENT_INFO
...
class AppHubAsyncClient:
    ...
    get_transport_class = functools.partial(type(AppHubClient).get_transport_class, type(AppHubClient))
    ...
    async def lookup_service_project_attachment(self,
    ...
    async def list_service_project_attachments(self,
    ...
    async def create_service_project_attachment(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, service_project_attachment, service_project_attachment_id])
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
    ...
    async def get_service_project_attachment(self,
    ...
    async def delete_service_project_attachment(self,
    ...
    async def detach_service_project_attachment(self,
    ...
    async def list_discovered_services(self,
    ...
    async def get_discovered_service(self,
    ...
    async def lookup_discovered_service(self,
    ...
    async def list_discovered_workloads(self,
    ...
    async def get_discovered_workload(self,
    ...
    async def lookup_discovered_workload(self,

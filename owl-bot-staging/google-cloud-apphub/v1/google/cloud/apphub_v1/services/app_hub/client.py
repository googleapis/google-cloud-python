...
class AppHubClient(metaclass=AppHubClientMeta):
    ...
    @staticmethod
    def discovered_service_path(project: str,location: str,discovered_service: str,) -> str:
        """Returns a fully-qualified discovered_service string."""
        return "projects/{project}/locations/{location}/discoveredServices/{discovered_service}".format(project=project, location=location, discovered_service=discovered_service, )
    ...
    @staticmethod
    def discovered_workload_path(project: str,location: str,discovered_workload: str,) -> str:
        """Returns a fully-qualified discovered_workload string."""
        return "projects/{project}/locations/{location}/discoveredWorkloads/{discovered_workload}".format(project=project, location=location, discovered_workload=discovered_workload, )
    ...
    @staticmethod
    def service_path(project: str,location: str,application: str,service: str,) -> str:
        """Returns a fully-qualified service string."""
        return "projects/{project}/locations/{location}/applications/{application}/services/{service}".format(project=project, location=location, application=application, service=service, )
    ...
    @staticmethod
    def service_project_attachment_path(project: str,location: str,service_project_attachment: str,) -> str:
        """Returns a fully-qualified service_project_attachment string."""
        return "projects/{project}/locations/{location}/serviceProjectAttachments/{service_project_attachment}".format(project=project, location=location, service_project_attachment=service_project_attachment, )
    ...
    @staticmethod
    def workload_path(project: str,location: str,application: str,workload: str,) -> str:
        """Returns a fully-qualified workload string."""
        return "projects/{project}/locations/{location}/applications/{application}/workloads/{workload}".format(project=project, location=location, application=application, workload=workload, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AppHubClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            AppHubClient._get_api_endpoint(
    ...
    def lookup_service_project_attachment(self,
    ...
    def list_service_project_attachments(self,
    ...
    def create_service_project_attachment(self,
    ...
    def get_service_project_attachment(self,
    ...
    def delete_service_project_attachment(self,
    ...
    def detach_service_project_attachment(self,
    ...
    def get_discovered_service(self,
    ...
    def lookup_discovered_service(self,
    ...
    def list_discovered_workloads(self,
    ...
    def get_discovered_workload(self,
    ...
    def lookup_discovered_workload(self,

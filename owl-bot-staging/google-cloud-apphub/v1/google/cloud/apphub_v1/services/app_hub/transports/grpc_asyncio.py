...
from .base import AppHubTransport, DEFAULT_CLIENT_INFO
...
class AppHubGrpcAsyncIOTransport(AppHubTransport):
    ...
    @property
    def lookup_service_project_attachment(self) -> Callable[
        ...
        if 'lookup_service_project_attachment' not in self._stubs:
            self._stubs['lookup_service_project_attachment'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_service_project_attachments(self) -> Callable[
        ...
        if 'list_service_project_attachments' not in self._stubs:
            self._stubs['list_service_project_attachments'] = self.grpc_channel.unary_unary(
    ...
    @property
    def create_service_project_attachment(self) -> Callable[
        ...
        if 'create_service_project_attachment' not in self._stubs:
            self._stubs['create_service_project_attachment'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_service_project_attachment(self) -> Callable[
        ...
        if 'get_service_project_attachment' not in self._stubs:
            self._stubs['get_service_project_attachment'] = self.grpc_channel.unary_unary(
    ...
    @property
    def delete_service_project_attachment(self) -> Callable[
        ...
        if 'delete_service_project_attachment' not in self._stubs:
            self._stubs['delete_service_project_attachment'] = self.grpc_channel.unary_unary(
    ...
    @property
    def detach_service_project_attachment(self) -> Callable[
        ...
        if 'detach_service_project_attachment' not in self._stubs:
            self._stubs['detach_service_project_attachment'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_discovered_services(self) -> Callable[
    ...
    @property
    def get_discovered_service(self) -> Callable[
    ...
    @property
    def lookup_discovered_service(self) -> Callable[
    ...
    @property
    def list_discovered_workloads(self) -> Callable[
    ...
    @property
    def get_discovered_workload(self) -> Callable[
    ...
    @property
    def lookup_discovered_workload(self) -> Callable[

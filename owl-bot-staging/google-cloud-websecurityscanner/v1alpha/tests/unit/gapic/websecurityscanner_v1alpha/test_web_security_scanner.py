...
from google.cloud.websecurityscanner_v1alpha.services.web_security_scanner import WebSecurityScannerAsyncClient
from google.cloud.websecurityscanner_v1alpha.services.web_security_scanner import WebSecurityScannerClient
from google.cloud.websecurityscanner_v1alpha.services.web_security_scanner import pagers
from google.cloud.websecurityscanner_v1alpha.services.web_security_scanner import transports
...
def test__get_api_endpoint():
    ...
    assert WebSecurityScannerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == WebSecurityScannerClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert WebSecurityScannerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == WebSecurityScannerClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    WebSecurityScannerClient, WebSecurityScannerAsyncClient
])
...
def test_web_security_scanner_client_client_options_from_dict():
    with mock.patch('google.cloud.websecurityscanner_v1alpha.services.web_security_scanner.transports.WebSecurityScannerGrpcTransport.__init__') as grpc_transport:
...
def test_get_finding(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        call.return_value = finding.Finding(
            name='name_value',
            finding_type=finding.Finding.FindingType.MIXED_CONTENT,
    ...
    assert response.name == 'name_value'
    assert response.finding_type == finding.Finding.FindingType.MIXED_CONTENT
...
def test_create_scan_config_rest_required_fields(request_type=web_security_scanner.CreateScanConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_scan_config._get_unset_required_fields(jsonified_request)
...
def test_create_scan_config_rest_unset_required_fields():
    transport = transports.WebSecurityScannerRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_scan_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_create_scan_config") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_create_scan_config") as pre:
...
def test_create_scan_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/{parent=projects/*}/scanConfigs" % client.transport._host, args[1])
...
def test_delete_scan_config_rest_required_fields(request_type=web_security_scanner.DeleteScanConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_scan_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_scan_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_delete_scan_config") as pre:
        pre.assert_not_called()
...
def test_delete_scan_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/scanConfigs/*}" % client.transport._host, args[1])
...
def test_get_scan_config_rest_required_fields(request_type=web_security_scanner.GetScanConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_scan_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_scan_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_get_scan_config") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_get_scan_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_scan_configs_rest_required_fields(request_type=web_security_scanner.ListScanConfigsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_scan_configs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_scan_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_list_scan_configs") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_list_scan_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_scan_config_rest_required_fields(request_type=web_security_scanner.UpdateScanConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_scan_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_scan_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_update_scan_config") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_update_scan_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_scan_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{scan_config.name=projects/*/scanConfigs/*}" % client.transport._host, args[1])
...
def test_start_scan_run_rest_required_fields(request_type=web_security_scanner.StartScanRunRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).start_scan_run._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_scan_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_start_scan_run") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_start_scan_run") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_start_scan_run_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/scanConfigs/*}:start" % client.transport._host, args[1])
...
def test_get_scan_run_rest_required_fields(request_type=web_security_scanner.GetScanRunRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_scan_run._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_scan_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_get_scan_run") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_get_scan_run") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_scan_run_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/scanConfigs/*/scanRuns/*}" % client.transport._host, args[1])
...
def test_list_scan_runs_rest_required_fields(request_type=web_security_scanner.ListScanRunsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_scan_runs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_scan_runs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_list_scan_runs") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_list_scan_runs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_scan_runs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/scanConfigs/*}/scanRuns" % client.transport._host, args[1])
...
def test_stop_scan_run_rest_required_fields(request_type=web_security_scanner.StopScanRunRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).stop_scan_run._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_stop_scan_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_stop_scan_run") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_stop_scan_run") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_stop_scan_run_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/scanConfigs/*/scanRuns/*}:stop" % client.transport._host, args[1])
...
def test_list_crawled_urls_rest_required_fields(request_type=web_security_scanner.ListCrawledUrlsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_crawled_urls._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_crawled_urls_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_list_crawled_urls") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_list_crawled_urls") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_crawled_urls_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/scanConfigs/*/scanRuns/*}/crawledUrls" % client.transport._host, args[1])
...
def test_get_finding_rest_required_fields(request_type=web_security_scanner.GetFindingRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_finding._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_finding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_get_finding") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_get_finding") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_finding_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/scanConfigs/*/scanRuns/*/findings/*}" % client.transport._host, args[1])
...
def test_list_findings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_list_findings") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_list_findings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_findings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/scanConfigs/*/scanRuns/*}/findings" % client.transport._host, args[1])
...
def test_list_finding_type_stats_rest_required_fields(request_type=web_security_scanner.ListFindingTypeStatsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_finding_type_stats._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_finding_type_stats_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_list_finding_type_stats") as post, \
         mock.patch.object(transports.WebSecurityScannerRestInterceptor, "pre_list_finding_type_stats") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_finding_type_stats_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/scanConfigs/*/scanRuns/*}/findingTypeStats" % client.transport._host, args[1])
...
def test_web_security_scanner_base_transport():
    ...
    with mock.patch('google.cloud.websecurityscanner_v1alpha.services.web_security_scanner.transports.WebSecurityScannerTransport.__init__') as Transport:
...
def test_web_security_scanner_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.websecurityscanner_v1alpha.services.web_security_scanner.transports.WebSecurityScannerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_web_security_scanner_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.websecurityscanner_v1alpha.services.web_security_scanner.transports.WebSecurityScannerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.WebSecurityScannerTransport()
        adc.assert_called_once()

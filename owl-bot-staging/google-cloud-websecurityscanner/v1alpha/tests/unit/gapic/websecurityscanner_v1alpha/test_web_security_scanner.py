...
def test_create_scan_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_create_scan_config_with_metadata") as post_with_metadata, \
...
def test_get_scan_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_get_scan_config_with_metadata") as post_with_metadata, \
...
def test_list_scan_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_list_scan_configs_with_metadata") as post_with_metadata, \
...
def test_update_scan_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_update_scan_config_with_metadata") as post_with_metadata, \
...
def test_start_scan_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_start_scan_run_with_metadata") as post_with_metadata, \
...
def test_get_scan_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_get_scan_run_with_metadata") as post_with_metadata, \
...
def test_list_scan_runs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_list_scan_runs_with_metadata") as post_with_metadata, \
...
def test_stop_scan_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_stop_scan_run_with_metadata") as post_with_metadata, \
...
def test_list_crawled_urls_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_list_crawled_urls_with_metadata") as post_with_metadata, \
...
def test_get_finding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_get_finding_with_metadata") as post_with_metadata, \
...
def test_list_findings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_list_findings_with_metadata") as post_with_metadata, \
...
def test_list_finding_type_stats_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebSecurityScannerRestInterceptor, "post_list_finding_type_stats_with_metadata") as post_with_metadata, \

...
class WebSecurityScannerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_create_scan_config_with_metadata(self, response: scan_config.ScanConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[scan_config.ScanConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_scan_config
    ...
    def post_update_scan_config_with_metadata(self, response: scan_config.ScanConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[scan_config.ScanConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_scan_config

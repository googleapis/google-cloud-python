...
class CertificateManagerTransport(abc.ABC):
    ...
    @property
    def list_trust_configs(self) -> Callable[
    ...
    @property
    def get_trust_config(self) -> Callable[
            [trust_config.GetTrustConfigRequest],
            Union[
                trust_config.TrustConfig,
                Awaitable[trust_config.TrustConfig]
            ]]:
        raise NotImplementedError()

    @property
    def create_trust_config(self) -> Callable[
    ...
    @property
    def update_trust_config(self) -> Callable[
    ...
    @property
    def delete_trust_config(self) -> Callable[

...
class AssuredWorkloadsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_workload(self, request: assuredworkloads.CreateWorkloadRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[assuredworkloads.CreateWorkloadRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_workload_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_workload
    ...
    def pre_delete_workload(self, request: assuredworkloads.DeleteWorkloadRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[assuredworkloads.DeleteWorkloadRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_workload(self, request: assuredworkloads.GetWorkloadRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[assuredworkloads.GetWorkloadRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_workload_with_metadata(self, response: assuredworkloads.Workload, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[assuredworkloads.Workload, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_workload
    ...
    def pre_list_workloads(self, request: assuredworkloads.ListWorkloadsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[assuredworkloads.ListWorkloadsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_workloads_with_metadata(self, response: assuredworkloads.ListWorkloadsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[assuredworkloads.ListWorkloadsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_workloads
    ...
    def pre_restrict_allowed_resources(self, request: assuredworkloads.RestrictAllowedResourcesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[assuredworkloads.RestrictAllowedResourcesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_restrict_allowed_resources_with_metadata(self, response: assuredworkloads.RestrictAllowedResourcesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[assuredworkloads.RestrictAllowedResourcesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for restrict_allowed_resources
    ...
    def pre_update_workload(self, request: assuredworkloads.UpdateWorkloadRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[assuredworkloads.UpdateWorkloadRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_workload_with_metadata(self, response: assuredworkloads.Workload, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[assuredworkloads.Workload, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_workload
...
class AssuredWorkloadsServiceRestTransport(_BaseAssuredWorkloadsServiceRestTransport):
    ...
    class _CreateWorkload(_BaseAssuredWorkloadsServiceRestTransport._BaseCreateWorkload, AssuredWorkloadsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AssuredWorkloadsServiceRestTransport._CreateWorkload._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteWorkload(_BaseAssuredWorkloadsServiceRestTransport._BaseDeleteWorkload, AssuredWorkloadsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AssuredWorkloadsServiceRestTransport._DeleteWorkload._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetWorkload(_BaseAssuredWorkloadsServiceRestTransport._BaseGetWorkload, AssuredWorkloadsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AssuredWorkloadsServiceRestTransport._GetWorkload._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListWorkloads(_BaseAssuredWorkloadsServiceRestTransport._BaseListWorkloads, AssuredWorkloadsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AssuredWorkloadsServiceRestTransport._ListWorkloads._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RestrictAllowedResources(_BaseAssuredWorkloadsServiceRestTransport._BaseRestrictAllowedResources, AssuredWorkloadsServiceRestStub):
        ...
        resources method over HTTP.
            ...
            transcoded_request = _BaseAssuredWorkloadsServiceRestTransport._BaseRestrictAllowedResources._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = AssuredWorkloadsServiceRestTransport._RestrictAllowedResources._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateWorkload(_BaseAssuredWorkloadsServiceRestTransport._BaseUpdateWorkload, AssuredWorkloadsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AssuredWorkloadsServiceRestTransport._UpdateWorkload._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseAssuredWorkloadsServiceRestTransport._BaseGetOperation, AssuredWorkloadsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AssuredWorkloadsServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseAssuredWorkloadsServiceRestTransport._BaseListOperations, AssuredWorkloadsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AssuredWorkloadsServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

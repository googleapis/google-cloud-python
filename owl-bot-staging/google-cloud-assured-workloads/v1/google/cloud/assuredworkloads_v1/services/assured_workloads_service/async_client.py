...
class AssuredWorkloadsServiceAsyncClient:
    ...
    parse_violation_path = staticmethod(AssuredWorkloadsServiceClient.parse_violation_path)
    ...
    get_transport_class = AssuredWorkloadsServiceClient.get_transport_class
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.assuredworkloads_v1.AssuredWorkloadsServiceAsyncClient`.",
                extra = {
    ...
    async def create_workload(self,
    ...
    async def restrict_allowed_resources(self,
    ...
    async def delete_workload(self,
    ...
    async def list_violations(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_violations]
    ...
    async def get_violation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_violation]
    ...
    async def acknowledge_violation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.acknowledge_violation]

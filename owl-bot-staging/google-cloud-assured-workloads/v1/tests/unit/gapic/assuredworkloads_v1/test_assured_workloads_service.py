...
def test_create_workload_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_create_workload_with_metadata") as post_with_metadata, \
...
def test_update_workload_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_update_workload_with_metadata") as post_with_metadata, \
...
def test_restrict_allowed_resources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_restrict_allowed_resources_with_metadata") as post_with_metadata, \
...
def test_get_workload_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_get_workload_with_metadata") as post_with_metadata, \
...
def test_list_workloads_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_list_workloads_with_metadata") as post_with_metadata, \

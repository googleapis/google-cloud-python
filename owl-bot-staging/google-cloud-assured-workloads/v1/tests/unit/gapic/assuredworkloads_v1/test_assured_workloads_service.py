...
from google.cloud.assuredworkloads_v1.services.assured_workloads_service import AssuredWorkloadsServiceAsyncClient
...
from google.cloud.assuredworkloads_v1.services.assured_workloads_service import transports
...
@mock.patch.object(AssuredWorkloadsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AssuredWorkloadsServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert AssuredWorkloadsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AssuredWorkloadsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert AssuredWorkloadsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AssuredWorkloadsServiceClient._get_api_endpoint(None, None, default_universe, "always") == AssuredWorkloadsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert AssuredWorkloadsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AssuredWorkloadsServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    AssuredWorkloadsServiceClient, AssuredWorkloadsServiceAsyncClient
])
...
def test_restrict_allowed_resources(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.restrict_allowed_resources),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_workloads_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, assuredworkloads.Workload)
                   for i in results)
...
def test_list_violations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, assuredworkloads.Violation)
                   for i in results)
...
def test_acknowledge_violation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.acknowledge_violation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_workload_rest_required_fields(request_type=assuredworkloads.CreateWorkloadRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_workload._get_unset_required_fields(jsonified_request)
...
def test_create_workload_rest_unset_required_fields():
    transport = transports.AssuredWorkloadsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_workload_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_create_workload") as post, \
         mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "pre_create_workload") as pre:
...
def test_update_workload_rest_required_fields(request_type=assuredworkloads.UpdateWorkloadRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_workload._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_workload_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_update_workload") as post, \
         mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "pre_update_workload") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_restrict_allowed_resources_rest_required_fields(request_type=assuredworkloads.RestrictAllowedResourcesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).restrict_allowed_resources._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_restrict_allowed_resources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_restrict_allowed_resources") as post, \
         mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "pre_restrict_allowed_resources") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_workload_rest_required_fields(request_type=assuredworkloads.DeleteWorkloadRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_workload._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_workload_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "pre_delete_workload") as pre:
        pre.assert_not_called()
...
def test_get_workload_rest_required_fields(request_type=assuredworkloads.GetWorkloadRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_workload._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_workload_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_get_workload") as post, \
         mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "pre_get_workload") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_workloads_rest_required_fields(request_type=assuredworkloads.ListWorkloadsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_workloads._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_workloads_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_list_workloads") as post, \
         mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "pre_list_workloads") as pre:
        pre.assert_not_called()
        post.assert_not_called()

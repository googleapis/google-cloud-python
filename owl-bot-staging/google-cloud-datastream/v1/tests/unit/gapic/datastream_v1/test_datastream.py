...
def test_create_private_connection_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["private_connection"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'display_name': 'display_name_value', 'state': 1, 'error': {'reason': 'reason_value', 'error_uuid': 'error_uuid_value', 'message': 'message_value', 'error_time': {}, 'details': {}}, 'satisfies_pzs': True, 'satisfies_pzi': True, 'vpc_peering_config': {'vpc': 'vpc_value', 'subnet': 'subnet_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

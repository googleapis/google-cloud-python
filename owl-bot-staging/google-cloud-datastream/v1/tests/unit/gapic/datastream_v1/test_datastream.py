...
def test_run_stream(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.run_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_private_connection_rest_required_fields(request_type=datastream.CreatePrivateConnectionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_private_connection._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("force", "private_connection_id", "request_id", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_create_private_connection_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("force", "privateConnectionId", "requestId", "validateOnly", )) & set(("parent", "privateConnectionId", "privateConnection", )))
...
def test_create_connection_profile_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["connection_profile"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'display_name': 'display_name_value', 'satisfies_pzs': True, 'satisfies_pzi': True, 'oracle_profile': {'hostname': 'hostname_value', 'port': 453, 'username': 'username_value', 'password': 'password_value', 'database_service': 'database_service_value', 'connection_attributes': {}, 'oracle_ssl_config': {'ca_certificate': 'ca_certificate_value', 'ca_certificate_set': True, 'server_certificate_distinguished_name': 'server_certificate_distinguished_name_value'}, 'oracle_asm_config': {'hostname': 'hostname_value', 'port': 453, 'username': 'username_value', 'password': 'password_value', 'asm_service': 'asm_service_value', 'connection_attributes': {}, 'oracle_ssl_config': {}, 'secret_manager_stored_password': 'secret_manager_stored_password_value'}, 'secret_manager_stored_password': 'secret_manager_stored_password_value'}, 'gcs_profile': {'bucket': 'bucket_value', 'root_path': 'root_path_value'}, 'mysql_profile': {'hostname': 'hostname_value', 'port': 453, 'username': 'username_value', 'password': 'password_value', 'ssl_config': {'client_key': 'client_key_value', 'client_key_set': True, 'client_certificate': 'client_certificate_value', 'client_certificate_set': True, 'ca_certificate': 'ca_certificate_value', 'ca_certificate_set': True}, 'secret_manager_stored_password': 'secret_manager_stored_password_value'}, 'bigquery_profile': {}, 'postgresql_profile': {'hostname': 'hostname_value', 'port': 453, 'username': 'username_value', 'password': 'password_value', 'database': 'database_value', 'secret_manager_stored_password': 'secret_manager_stored_password_value', 'ssl_config': {'server_verification': {'ca_certificate': 'ca_certificate_value', 'server_certificate_hostname': 'server_certificate_hostname_value'}, 'server_and_client_verification': {'client_certificate': 'client_certificate_value', 'client_key': 'client_key_value', 'ca_certificate': 'ca_certificate_value', 'server_certificate_hostname': 'server_certificate_hostname_value'}}}, 'sql_server_profile': {'hostname': 'hostname_value', 'port': 453, 'username': 'username_value', 'password': 'password_value', 'database': 'database_value', 'secret_manager_stored_password': 'secret_manager_stored_password_value'}, 'salesforce_profile': {'domain': 'domain_value', 'user_credentials': {'username': 'username_value', 'password': 'password_value', 'security_token': 'security_token_value', 'secret_manager_stored_password': 'secret_manager_stored_password_value', 'secret_manager_stored_security_token': 'secret_manager_stored_security_token_value'}, 'oauth2_client_credentials': {'client_id': 'client_id_value', 'client_secret': 'client_secret_value', 'secret_manager_stored_client_secret': 'secret_manager_stored_client_secret_value'}}, 'mongodb_profile': {'host_addresses': [{'hostname': 'hostname_value', 'port': 453}], 'replica_set': 'replica_set_value', 'username': 'username_value', 'password': 'password_value', 'secret_manager_stored_password': 'secret_manager_stored_password_value', 'ssl_config': {'client_key': 'client_key_value', 'client_key_set': True, 'client_certificate': 'client_certificate_value', 'client_certificate_set': True, 'ca_certificate': 'ca_certificate_value', 'ca_certificate_set': True, 'secret_manager_stored_client_key': 'secret_manager_stored_client_key_value'}, 'srv_connection_format': {}, 'standard_connection_format': {'direct_connection': True}}, 'static_service_ip_connectivity': {}, 'forward_ssh_connectivity': {'hostname': 'hostname_value', 'username': 'username_value', 'port': 453, 'password': 'password_value', 'private_key': 'private_key_value'}, 'private_connectivity': {'private_connection': 'private_connection_value'}}
...
def test_create_stream_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["stream"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'display_name': 'display_name_value', 'source_config': {'source_connection_profile': 'source_connection_profile_value', 'oracle_source_config': {'include_objects': {'oracle_schemas': [{'schema': 'schema_value', 'oracle_tables': [{'table': 'table_value', 'oracle_columns': [{'column': 'column_value', 'data_type': 'data_type_value', 'length': 642, 'precision': 972, 'scale': 520, 'encoding': 'encoding_value', 'primary_key': True, 'nullable': True, 'ordinal_position': 1725}]}]}]}, 'exclude_objects': {}, 'max_concurrent_cdc_tasks': 2550, 'max_concurrent_backfill_tasks': 3076, 'drop_large_objects': {}, 'stream_large_objects': {}, 'log_miner': {}, 'binary_log_parser': {'oracle_asm_log_file_access': {}, 'log_file_directories': {'online_log_directory': 'online_log_directory_value', 'archived_log_directory': 'archived_log_directory_value'}}}, 'mysql_source_config': {'include_objects': {'mysql_databases': [{'database': 'database_value', 'mysql_tables': [{'table': 'table_value', 'mysql_columns': [{'column': 'column_value', 'data_type': 'data_type_value', 'length': 642, 'collation': 'collation_value', 'primary_key': True, 'nullable': True, 'ordinal_position': 1725, 'precision': 972, 'scale': 520}]}]}]}, 'exclude_objects': {}, 'max_concurrent_cdc_tasks': 2550, 'max_concurrent_backfill_tasks': 3076, 'binary_log_position': {}, 'gtid': {}}, 'postgresql_source_config': {'include_objects': {'postgresql_schemas': [{'schema': 'schema_value', 'postgresql_tables': [{'table': 'table_value', 'postgresql_columns': [{'column': 'column_value', 'data_type': 'data_type_value', 'length': 642, 'precision': 972, 'scale': 520, 'primary_key': True, 'nullable': True, 'ordinal_position': 1725}]}]}]}, 'exclude_objects': {}, 'replication_slot': 'replication_slot_value', 'publication': 'publication_value', 'max_concurrent_backfill_tasks': 3076}, 'sql_server_source_config': {'include_objects': {'schemas': [{'schema': 'schema_value', 'tables': [{'table': 'table_value', 'columns': [{'column': 'column_value', 'data_type': 'data_type_value', 'length': 642, 'precision': 972, 'scale': 520, 'primary_key': True, 'nullable': True, 'ordinal_position': 1725}]}]}]}, 'exclude_objects': {}, 'max_concurrent_cdc_tasks': 2550, 'max_concurrent_backfill_tasks': 3076, 'transaction_logs': {}, 'change_tables': {}}, 'salesforce_source_config': {'include_objects': {'objects': [{'object_name': 'object_name_value', 'fields': [{'name': 'name_value', 'data_type': 'data_type_value', 'nillable': True}]}]}, 'exclude_objects': {}, 'polling_interval': {'seconds': 751, 'nanos': 543}}, 'mongodb_source_config': {'include_objects': {'databases': [{'database': 'database_value', 'collections': [{'collection': 'collection_value', 'fields': [{'field': 'field_value'}]}]}]}, 'exclude_objects': {}, 'max_concurrent_backfill_tasks': 3076}}, 'destination_config': {'destination_connection_profile': 'destination_connection_profile_value', 'gcs_destination_config': {'path': 'path_value', 'file_rotation_mb': 1693, 'file_rotation_interval': {}, 'avro_file_format': {}, 'json_file_format': {'schema_file_format': 1, 'compression': 1}}, 'bigquery_destination_config': {'single_target_dataset': {'dataset_id': 'dataset_id_value'}, 'source_hierarchy_datasets': {'dataset_template': {'location': 'location_value', 'dataset_id_prefix': 'dataset_id_prefix_value', 'kms_key_name': 'kms_key_name_value'}, 'project_id': 'project_id_value'}, 'data_freshness': {}, 'blmt_config': {'bucket': 'bucket_value', 'root_path': 'root_path_value', 'connection_name': 'connection_name_value', 'file_format': 1, 'table_format': 1}, 'merge': {}, 'append_only': {}}}, 'state': 1, 'backfill_all': {'oracle_excluded_objects': {}, 'mysql_excluded_objects': {}, 'postgresql_excluded_objects': {}, 'sql_server_excluded_objects': {}, 'salesforce_excluded_objects': {}, 'mongodb_excluded_objects': {}}, 'backfill_none': {}, 'errors': [{'reason': 'reason_value', 'error_uuid': 'error_uuid_value', 'message': 'message_value', 'error_time': {}, 'details': {}}], 'customer_managed_encryption_key': 'customer_managed_encryption_key_value', 'last_recovery_time': {}, 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_run_stream_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DatastreamRestInterceptor, "post_run_stream") as post, \
        mock.patch.object(transports.DatastreamRestInterceptor, "post_run_stream_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatastreamRestInterceptor, "pre_run_stream") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.run_stream(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_stream_object_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_get_stream_object_with_metadata") as post_with_metadata, \
...
def test_lookup_stream_object_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_lookup_stream_object_with_metadata") as post_with_metadata, \
...
def test_list_stream_objects_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_list_stream_objects_with_metadata") as post_with_metadata, \
...
def test_start_backfill_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_start_backfill_job_with_metadata") as post_with_metadata, \
...
def test_stop_backfill_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_stop_backfill_job_with_metadata") as post_with_metadata, \
...
def test_create_private_connection_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["private_connection"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'display_name': 'display_name_value', 'state': 1, 'error': {'reason': 'reason_value', 'error_uuid': 'error_uuid_value', 'message': 'message_value', 'error_time': {}, 'details': {}}, 'satisfies_pzs': True, 'satisfies_pzi': True, 'vpc_peering_config': {'vpc': 'vpc_value', 'subnet': 'subnet_value'}, 'psc_interface_config': {'network_attachment': 'network_attachment_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_network_attachment_path():
    ...
    expected = "projects/{project}/regions/{region}/networkAttachments/{network_attachment}".format(project=project, region=region, network_attachment=network_attachment, )

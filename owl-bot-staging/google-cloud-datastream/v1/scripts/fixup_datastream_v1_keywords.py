...
class datastreamCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'list_stream_objects': ('parent', 'page_size', 'page_token', ),
        'list_streams': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        'lookup_stream_object': ('parent', 'source_object_identifier', ),
        'run_stream': ('name', 'cdc_strategy', 'force', ),
        'start_backfill_job': ('object_', ),
        'stop_backfill_job': ('object_', ),
        'update_connection_profile': ('connection_profile', 'update_mask', 'request_id', 'validate_only', 'force', ),

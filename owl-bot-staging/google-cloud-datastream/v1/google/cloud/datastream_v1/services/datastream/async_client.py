...
class DatastreamAsyncClient:
    ...
    parse_connection_profile_path = staticmethod(DatastreamClient.parse_connection_profile_path)
    network_attachment_path = staticmethod(DatastreamClient.network_attachment_path)
    parse_network_attachment_path = staticmethod(DatastreamClient.parse_network_attachment_path)
    ...
    parse_private_connection_path = staticmethod(DatastreamClient.parse_private_connection_path)
    ...
    common_billing_account_path = staticmethod(DatastreamClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(DatastreamClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(DatastreamClient.parse_common_organization_path)
    ...
    parse_common_location_path = staticmethod(DatastreamClient.parse_common_location_path)
    ...
    get_transport_class = DatastreamClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, DatastreamTransport, Callable[..., DatastreamTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.datastream_v1.DatastreamAsyncClient`.",
                extra = {
    ...
    async def list_connection_profiles(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_connection_profiles]
    ...
    async def get_connection_profile(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_connection_profile]
    ...
    async def create_connection_profile(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_connection_profile]
    ...
    async def update_connection_profile(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_connection_profile]
    ...
    async def delete_connection_profile(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_connection_profile]
    ...
    async def discover_connection_profile(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.discover_connection_profile]
    ...
    async def run_stream(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.run_stream]
    ...
    async def get_stream_object(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_stream_object]
    ...
    async def lookup_stream_object(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.lookup_stream_object]
    ...
    async def list_stream_objects(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_stream_objects]
    ...
    async def start_backfill_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.start_backfill_job]
    ...
    async def stop_backfill_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.stop_backfill_job]
    ...
    async def fetch_static_ips(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.fetch_static_ips]
    ...
    async def create_private_connection(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_private_connection]
    ...
    async def get_private_connection(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_private_connection]
    ...
    async def list_private_connections(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_private_connections]
    ...
    async def delete_private_connection(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_private_connection]
    ...
    async def create_route(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_route]
    ...
    async def get_route(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_route]
    ...
    async def list_routes(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_routes]
    ...
    async def delete_route(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_route]

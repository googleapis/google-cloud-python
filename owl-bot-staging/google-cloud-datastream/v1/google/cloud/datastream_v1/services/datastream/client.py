...
class DatastreamClient(metaclass=DatastreamClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "datastream.{UNIVERSE_DOMAIN}"
    ...
    @staticmethod
    def network_attachment_path(project: str,region: str,network_attachment: str,) -> str:
        """Returns a fully-qualified network_attachment string."""
        return "projects/{project}/regions/{region}/networkAttachments/{network_attachment}".format(project=project, region=region, network_attachment=network_attachment, )

    @staticmethod
    def parse_network_attachment_path(path: str) -> Dict[str,str]:
        """Parses a network_attachment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/regions/(?P<region>.+?)/networkAttachments/(?P<network_attachment>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def stream_path(project: str,location: str,stream: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/streams/{stream}".format(project=project, location=location, stream=stream, )

    @staticmethod
    def parse_stream_path(path: str) -> Dict[str,str]:
        """Parses a stream path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/streams/(?P<stream>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def stream_object_path(project: str,location: str,stream: str,object: str,) -> str:
        """Returns a fully-qualified stream_object string."""
        return "projects/{project}/locations/{location}/streams/{stream}/objects/{object}".format(project=project, location=location, stream=stream, object=object, )

    @staticmethod
    def parse_stream_object_path(path: str) -> Dict[str,str]:
        """Parses a stream_object path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/streams/(?P<stream>.+?)/objects/(?P<object>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DatastreamClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DatastreamClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = DatastreamClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DatastreamTransport, Callable[..., DatastreamTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DatastreamClient._read_environment_variables()
        self._client_cert_source = DatastreamClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DatastreamClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DatastreamTransport)
        if transport_provided:
            ...
            self._transport = cast(DatastreamTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DatastreamTransport], Callable[..., DatastreamTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.datastream_v1.DatastreamClient`.",
                    extra = {
    ...
    def create_connection_profile(self,
            request: Optional[Union[datastream.CreateConnectionProfileRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, connection_profile, connection_profile_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_connection_profile(self,
            request: Optional[Union[datastream.UpdateConnectionProfileRequest, dict]] = None,
            *,
            connection_profile: Optional[datastream_resources.ConnectionProfile] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [connection_profile, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def delete_connection_profile(self,
            request: Optional[Union[datastream.DeleteConnectionProfileRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def discover_connection_profile(self,
            request: Optional[Union[datastream.DiscoverConnectionProfileRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.discover_connection_profile]
    ...
    def run_stream(self,
        ...
        Args:
            request (Union[google.cloud.datastream_v1.types.RunStreamRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.run_stream]
    ...
    def create_private_connection(self,
            request: Optional[Union[datastream.CreatePrivateConnectionRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, private_connection, private_connection_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_private_connection]
    ...
    def list_private_connections(self,
    ...
    def delete_private_connection(self,
            request: Optional[Union[datastream.DeletePrivateConnectionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_private_connection]
    ...
    def create_route(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, route, route_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')

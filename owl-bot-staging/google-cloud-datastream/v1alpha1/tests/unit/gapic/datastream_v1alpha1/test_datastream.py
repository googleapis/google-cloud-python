...
@pytest.mark.asyncio
async def test_fetch_errors_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DatastreamAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_errors in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_errors] = mock_rpc
...
def test_list_connection_profiles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_list_connection_profiles_with_metadata") as post_with_metadata, \
...
def test_get_connection_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_get_connection_profile_with_metadata") as post_with_metadata, \
...
def test_create_connection_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_create_connection_profile_with_metadata") as post_with_metadata, \
...
def test_update_connection_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_update_connection_profile_with_metadata") as post_with_metadata, \
...
def test_delete_connection_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_delete_connection_profile_with_metadata") as post_with_metadata, \
...
def test_discover_connection_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_discover_connection_profile_with_metadata") as post_with_metadata, \
...
def test_list_streams_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_list_streams_with_metadata") as post_with_metadata, \
...
def test_get_stream_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_get_stream_with_metadata") as post_with_metadata, \
...
def test_create_stream_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_create_stream_with_metadata") as post_with_metadata, \
...
def test_update_stream_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_update_stream_with_metadata") as post_with_metadata, \
...
def test_delete_stream_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_delete_stream_with_metadata") as post_with_metadata, \
...
def test_fetch_errors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_fetch_errors_with_metadata") as post_with_metadata, \
...
def test_fetch_static_ips_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_fetch_static_ips_with_metadata") as post_with_metadata, \
...
def test_create_private_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_create_private_connection_with_metadata") as post_with_metadata, \
...
def test_get_private_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_get_private_connection_with_metadata") as post_with_metadata, \
...
def test_list_private_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_list_private_connections_with_metadata") as post_with_metadata, \
...
def test_delete_private_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_delete_private_connection_with_metadata") as post_with_metadata, \
...
def test_create_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_create_route_with_metadata") as post_with_metadata, \
...
def test_get_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_get_route_with_metadata") as post_with_metadata, \
...
def test_list_routes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_list_routes_with_metadata") as post_with_metadata, \
...
def test_delete_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastreamRestInterceptor, "post_delete_route_with_metadata") as post_with_metadata, \

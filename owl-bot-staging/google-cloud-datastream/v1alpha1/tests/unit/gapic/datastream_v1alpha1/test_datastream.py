...
@pytest.mark.parametrize("client_class", [
    DatastreamClient, DatastreamAsyncClient
])
...
def test_list_connection_profiles_rest_required_fields(request_type=datastream.ListConnectionProfilesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_connection_profiles._get_unset_required_fields(jsonified_request)
...
def test_list_connection_profiles_rest_unset_required_fields():
    transport = transports.DatastreamRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_connection_profiles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DatastreamRestInterceptor, "post_list_connection_profiles") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_list_connection_profiles") as pre:
...
def test_list_connection_profiles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*}/connectionProfiles" % client.transport._host, args[1])
...
def test_get_connection_profile_rest_required_fields(request_type=datastream.GetConnectionProfileRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_connection_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_connection_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_get_connection_profile") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_get_connection_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_connection_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/connectionProfiles/*}" % client.transport._host, args[1])
...
def test_create_connection_profile_rest_required_fields(request_type=datastream.CreateConnectionProfileRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_connection_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_connection_profile._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("connection_profile_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_connection_profile_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("connectionProfileId", "requestId", )) & set(("parent", "connectionProfileId", "connectionProfile", )))
...
def test_create_connection_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DatastreamRestInterceptor, "post_create_connection_profile") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_create_connection_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_connection_profile_rest_required_fields(request_type=datastream.UpdateConnectionProfileRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_connection_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_connection_profile_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("connectionProfile", )))
...
def test_update_connection_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_update_connection_profile") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_update_connection_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_connection_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{connection_profile.name=projects/*/locations/*/connectionProfiles/*}" % client.transport._host, args[1])
...
def test_delete_connection_profile_rest_required_fields(request_type=datastream.DeleteConnectionProfileRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_connection_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_connection_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_delete_connection_profile") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_delete_connection_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_discover_connection_profile_rest_required_fields(request_type=datastream.DiscoverConnectionProfileRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).discover_connection_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_discover_connection_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_discover_connection_profile") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_discover_connection_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_streams_rest_required_fields(request_type=datastream.ListStreamsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_streams._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_streams_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_list_streams") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_list_streams") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_streams_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*}/streams" % client.transport._host, args[1])
...
def test_get_stream_rest_required_fields(request_type=datastream.GetStreamRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_stream._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_stream_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_get_stream") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_get_stream") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_stream_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/streams/*}" % client.transport._host, args[1])
...
def test_create_stream_rest_required_fields(request_type=datastream.CreateStreamRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_stream._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_stream_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_create_stream") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_create_stream") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_stream_rest_required_fields(request_type=datastream.UpdateStreamRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_stream._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_stream_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_update_stream") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_update_stream") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_stream_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{stream.name=projects/*/locations/*/streams/*}" % client.transport._host, args[1])
...
def test_delete_stream_rest_required_fields(request_type=datastream.DeleteStreamRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_stream._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_stream_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_delete_stream") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_delete_stream") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_fetch_errors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_fetch_errors") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_fetch_errors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.fetch_errors(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_fetch_errors_rest_bad_request(transport: str = 'rest', request_type=datastream.FetchErrorsRequest):
    client = DatastreamClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_fetch_static_ips_rest_required_fields(request_type=datastream.FetchStaticIpsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).fetch_static_ips._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_static_ips_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_fetch_static_ips") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_fetch_static_ips") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_fetch_static_ips_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*}:fetchStaticIps" % client.transport._host, args[1])
...
def test_create_private_connection_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["private_connection"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'display_name': 'display_name_value', 'state': 1, 'error': {'reason': 'reason_value', 'error_uuid': 'error_uuid_value', 'message': 'message_value', 'error_time': {}, 'details': {}}, 'vpc_peering_config': {'vpc_name': 'vpc_name_value', 'subnet': 'subnet_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_private_connection_rest_required_fields(request_type=datastream.CreatePrivateConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_private_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_private_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_create_private_connection") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_create_private_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_private_connection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*}/privateConnections" % client.transport._host, args[1])
...
def test_get_private_connection_rest_required_fields(request_type=datastream.GetPrivateConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_private_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_private_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_get_private_connection") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_get_private_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_private_connection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/privateConnections/*}" % client.transport._host, args[1])
...
def test_list_private_connections_rest_required_fields(request_type=datastream.ListPrivateConnectionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_private_connections._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_private_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_list_private_connections") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_list_private_connections") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_private_connection_rest_required_fields(request_type=datastream.DeletePrivateConnectionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_private_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_private_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_delete_private_connection") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_delete_private_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_route_rest_required_fields(request_type=datastream.CreateRouteRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_route._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_create_route") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_create_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_route_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*/privateConnections/*}/routes" % client.transport._host, args[1])
...
def test_get_route_rest_required_fields(request_type=datastream.GetRouteRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_route._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_get_route") as post, \
...
def test_get_route_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/privateConnections/*/routes/*}" % client.transport._host, args[1])
...
def test_list_routes_rest_required_fields(request_type=datastream.ListRoutesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_routes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_routes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_list_routes") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_list_routes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_route_rest_required_fields(request_type=datastream.DeleteRouteRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_route._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_route_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_delete_route") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_delete_route") as pre:
        pre.assert_not_called()
        post.assert_not_called()

...
class DatastreamRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_fetch_errors(self, request: datastream.FetchErrorsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastream.FetchErrorsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_fetch_errors_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for fetch_errors
...
class DatastreamRestTransport(_BaseDatastreamRestTransport):
    ...
    class _FetchErrors(_BaseDatastreamRestTransport._BaseFetchErrors, DatastreamRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DatastreamRestTransport._FetchErrors._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

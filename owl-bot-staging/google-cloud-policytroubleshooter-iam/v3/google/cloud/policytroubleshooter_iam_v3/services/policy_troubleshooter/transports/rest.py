...
class PolicyTroubleshooterRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_troubleshoot_iam_policy(self, request: troubleshooter.TroubleshootIamPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[troubleshooter.TroubleshootIamPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_troubleshoot_iam_policy_with_metadata(self, response: troubleshooter.TroubleshootIamPolicyResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[troubleshooter.TroubleshootIamPolicyResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for troubleshoot_iam_policy
...
class PolicyTroubleshooterRestTransport(_BasePolicyTroubleshooterRestTransport):
    ...
    class _TroubleshootIamPolicy(_BasePolicyTroubleshooterRestTransport._BaseTroubleshootIamPolicy, PolicyTroubleshooterRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PolicyTroubleshooterRestTransport._TroubleshootIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

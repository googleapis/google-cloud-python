...
from .base import PolicyTroubleshooterTransport, DEFAULT_CLIENT_INFO
...
class PolicyTroubleshooterGrpcTransport(PolicyTroubleshooterTransport):
    """gRPC backend transport for PolicyTroubleshooter.
    ...
    def troubleshoot_iam_policy(self) -> Callable[
        ...
        if 'troubleshoot_iam_policy' not in self._stubs:
            self._stubs['troubleshoot_iam_policy'] = self._logged_channel.unary_unary(

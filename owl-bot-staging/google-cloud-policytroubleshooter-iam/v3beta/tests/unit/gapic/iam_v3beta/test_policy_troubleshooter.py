...
from google.cloud.policytroubleshooter.iam_v3beta.services.policy_troubleshooter import PolicyTroubleshooterAsyncClient
from google.cloud.policytroubleshooter.iam_v3beta.services.policy_troubleshooter import PolicyTroubleshooterClient
from google.cloud.policytroubleshooter.iam_v3beta.services.policy_troubleshooter import transports
...
def test_policy_troubleshooter_client_client_options_from_dict():
    with mock.patch('google.cloud.policytroubleshooter.iam_v3beta.services.policy_troubleshooter.transports.PolicyTroubleshooterGrpcTransport.__init__') as grpc_transport:
...
def test_policy_troubleshooter_base_transport():
    ...
    with mock.patch('google.cloud.policytroubleshooter.iam_v3beta.services.policy_troubleshooter.transports.PolicyTroubleshooterTransport.__init__') as Transport:
...
def test_policy_troubleshooter_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.policytroubleshooter.iam_v3beta.services.policy_troubleshooter.transports.PolicyTroubleshooterTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_policy_troubleshooter_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.policytroubleshooter.iam_v3beta.services.policy_troubleshooter.transports.PolicyTroubleshooterTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PolicyTroubleshooterTransport()
        adc.assert_called_once()

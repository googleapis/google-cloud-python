...
class AlloyDBCSQLAdminRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_restore_from_cloud_sql(self, request: csql_service.RestoreFromCloudSQLRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[csql_service.RestoreFromCloudSQLRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_restore_from_cloud_sql_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for restore_from_cloud_sql
...
class AlloyDBCSQLAdminRestTransport(_BaseAlloyDBCSQLAdminRestTransport):
    ...
    class _RestoreFromCloudSQL(_BaseAlloyDBCSQLAdminRestTransport._BaseRestoreFromCloudSQL, AlloyDBCSQLAdminRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AlloyDBCSQLAdminRestTransport._RestoreFromCloudSQL._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def restore_from_cloud_sql(self) -> Callable[
    ...
    class _GetLocation(_BaseAlloyDBCSQLAdminRestTransport._BaseGetLocation, AlloyDBCSQLAdminRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AlloyDBCSQLAdminRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseAlloyDBCSQLAdminRestTransport._BaseListLocations, AlloyDBCSQLAdminRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.alloydb_v1alpha.AlloyDBCSQLAdminClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.alloydb.v1alpha.AlloyDBCSQLAdmin",
            ...
            # Send the request
            response = AlloyDBCSQLAdminRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.alloydb_v1alpha.AlloyDBCSQLAdminAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.alloydb.v1alpha.AlloyDBCSQLAdmin",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseAlloyDBCSQLAdminRestTransport._BaseCancelOperation, AlloyDBCSQLAdminRestStub):
        ...
        def __call__(self,
            ...
            body = _BaseAlloyDBCSQLAdminRestTransport._BaseCancelOperation._get_request_body_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.alloydb_v1alpha.AlloyDBCSQLAdminClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.alloydb.v1alpha.AlloyDBCSQLAdmin",
            ...
            # Send the request
            response = AlloyDBCSQLAdminRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteOperation(_BaseAlloyDBCSQLAdminRestTransport._BaseDeleteOperation, AlloyDBCSQLAdminRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.alloydb_v1alpha.AlloyDBCSQLAdminClient.DeleteOperation",
                    extra = {
                        "serviceName": "google.cloud.alloydb.v1alpha.AlloyDBCSQLAdmin",
            ...
            # Send the request
            response = AlloyDBCSQLAdminRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseAlloyDBCSQLAdminRestTransport._BaseGetOperation, AlloyDBCSQLAdminRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.alloydb_v1alpha.AlloyDBCSQLAdminClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.alloydb.v1alpha.AlloyDBCSQLAdmin",
            ...
            # Send the request
            response = AlloyDBCSQLAdminRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.alloydb_v1alpha.AlloyDBCSQLAdminAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.alloydb.v1alpha.AlloyDBCSQLAdmin",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseAlloyDBCSQLAdminRestTransport._BaseListOperations, AlloyDBCSQLAdminRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.alloydb_v1alpha.AlloyDBCSQLAdminClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.alloydb.v1alpha.AlloyDBCSQLAdmin",
            ...
            # Send the request
            response = AlloyDBCSQLAdminRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.alloydb_v1alpha.AlloyDBCSQLAdminAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.alloydb.v1alpha.AlloyDBCSQLAdmin",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

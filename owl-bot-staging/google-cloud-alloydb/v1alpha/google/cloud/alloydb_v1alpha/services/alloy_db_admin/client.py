...
from google.cloud.alloydb_v1alpha.services.alloy_db_admin import pagers
from google.cloud.alloydb_v1alpha.types import csql_resources
from google.cloud.alloydb_v1alpha.types import data_model
from google.cloud.alloydb_v1alpha.types import gemini
from google.cloud.alloydb_v1alpha.types import resources
from google.cloud.alloydb_v1alpha.types import service
...
from .transports.base import AlloyDBAdminTransport, DEFAULT_CLIENT_INFO
...
class AlloyDBAdminClient(metaclass=AlloyDBAdminClientMeta):
    ...
    def backup_path(project: str,location: str,backup: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/backups/{backup}".format(project=project, location=location, backup=backup, )

    @staticmethod
    def parse_backup_path(path: str) -> Dict[str,str]:
        """Parses a backup path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backups/(?P<backup>.+?)$", path)
    ...
    @staticmethod
    def connection_info_path(project: str,location: str,cluster: str,instance: str,) -> str:
        """Returns a fully-qualified connection_info string."""
        return "projects/{project}/locations/{location}/clusters/{cluster}/instances/{instance}/connectionInfo".format(project=project, location=location, cluster=cluster, instance=instance, )

    @staticmethod
    def parse_connection_info_path(path: str) -> Dict[str,str]:
        """Parses a connection_info path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/instances/(?P<instance>.+?)/connectionInfo$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def database_path(project: str,location: str,cluster: str,database: str,) -> str:
        """Returns a fully-qualified database string."""
        return "projects/{project}/locations/{location}/clusters/{cluster}/databases/{database}".format(project=project, location=location, cluster=cluster, database=database, )

    @staticmethod
    def parse_database_path(path: str) -> Dict[str,str]:
        """Parses a database path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/databases/(?P<database>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def instance_path(project: str,location: str,cluster: str,instance: str,) -> str:
        """Returns a fully-qualified instance string."""
        return "projects/{project}/locations/{location}/clusters/{cluster}/instances/{instance}".format(project=project, location=location, cluster=cluster, instance=instance, )

    @staticmethod
    def parse_instance_path(path: str) -> Dict[str,str]:
        """Parses a instance path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/instances/(?P<instance>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def supported_database_flag_path(project: str,location: str,flag: str,) -> str:
        """Returns a fully-qualified supported_database_flag string."""
        return "projects/{project}/locations/{location}/flags/{flag}".format(project=project, location=location, flag=flag, )
    ...
    def parse_supported_database_flag_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/flags/(?P<flag>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def user_path(project: str,location: str,cluster: str,user: str,) -> str:
        """Returns a fully-qualified user string."""
        return "projects/{project}/locations/{location}/clusters/{cluster}/users/{user}".format(project=project, location=location, cluster=cluster, user=user, )

    @staticmethod
    def parse_user_path(path: str) -> Dict[str,str]:
        """Parses a user path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/users/(?P<user>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = AlloyDBAdminClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = AlloyDBAdminClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AlloyDBAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = AlloyDBAdminClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AlloyDBAdminTransport, Callable[..., AlloyDBAdminTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AlloyDBAdminClient._read_environment_variables()
        self._client_cert_source = AlloyDBAdminClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AlloyDBAdminClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, AlloyDBAdminTransport)
        if transport_provided:
            ...
            self._transport = cast(AlloyDBAdminTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AlloyDBAdminTransport], Callable[..., AlloyDBAdminTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.alloydb_v1alpha.AlloyDBAdminClient`.",
                    extra = {
    ...
    def list_clusters(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.ListClustersRequest, dict]):
    ...
    def get_cluster(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.GetClusterRequest, dict]):
        ...
        Returns:
            google.cloud.alloydb_v1alpha.types.Cluster:
    ...
    def update_cluster(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.UpdateClusterRequest, dict]):
    ...
    def export_cluster(self,
            ...
            *,
            ...
            csv_export_options: Optional[service.ExportClusterRequest.CsvExportOptions] = None,
            sql_export_options: Optional[service.ExportClusterRequest.SqlExportOptions] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation.Operation:
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.ExportClusterRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.alloydb_v1alpha.types.ExportClusterResponse`
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [name, gcs_destination, database, csv_export_options, sql_export_options]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def import_cluster(self,
            request: Optional[Union[service.ImportClusterRequest, dict]] = None,
            *,
            name: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.ImportClusterRequest, dict]):
            ...
            gcs_uri (str):
                ...
                where the source file for import will be stored. The URI
                ...
                should not be set.
            database (str):
                Optional. Name of the database to which the import will
                be done. For import from SQL file, this is required only
                if the file does not specify a database. Note - Value
                provided should be the same as expected from
                ...
                should not be set.
            user (str):
                Optional. Database user to be used for importing the
                data. Note - Value provided should be the same as
                expected from ``SELECT current_user;`` and NOT as a
                resource reference.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.alloydb_v1alpha.types.ImportClusterResponse`
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [name, gcs_uri, database, user]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.ImportClusterRequest):
            request = service.ImportClusterRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.import_cluster]
    ...
    def upgrade_cluster(self,
            ...
            *,
            name: Optional[str] = None,
            version: Optional[resources.DatabaseVersion] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation.Operation:
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.UpgradeClusterRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.alloydb_v1alpha.types.UpgradeClusterResponse`
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.upgrade_cluster]
        ...
        response = operation.from_gapic(
            response,
            self._transport.operations_client,
            service.UpgradeClusterResponse,
            metadata_type=service.OperationMetadata,
        )
    ...
    def delete_cluster(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.DeleteClusterRequest, dict]):
    ...
    def promote_cluster(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.PromoteClusterRequest, dict]):
    ...
    def switchover_cluster(self,
            request: Optional[Union[service.SwitchoverClusterRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Switches the roles of PRIMARY and SECONDARY clusters
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.SwitchoverClusterRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.SwitchoverClusterRequest):
            request = service.SwitchoverClusterRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.switchover_cluster]
    ...
    def create_secondary_cluster(self,
    ...
    def list_instances(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.ListInstancesRequest, dict]):
                The request object. Message for requesting list of
                Instances
            parent (str):
                Required. The name of the parent resource. For the
    ...
    def get_instance(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.GetInstanceRequest, dict]):
        ...
        Returns:
            google.cloud.alloydb_v1alpha.types.Instance:
    ...
    def create_instance(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.CreateInstanceRequest, dict]):
    ...
    def create_secondary_instance(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.CreateSecondaryInstanceRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_secondary_instance]
    ...
    def batch_create_instances(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.BatchCreateInstancesRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.alloydb_v1alpha.types.BatchCreateInstancesResponse`
    ...
    def update_instance(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.UpdateInstanceRequest, dict]):
    ...
    def delete_instance(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.DeleteInstanceRequest, dict]):
    ...
    def failover_instance(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.FailoverInstanceRequest, dict]):
    ...
    def inject_fault(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [fault_type, name]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def restart_instance(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.RestartInstanceRequest, dict]):
                The request object.
            name (str):
                Required. The name of the resource.
                For the required format, see the comment
    ...
    def execute_sql(self,
            request: Optional[Union[service.ExecuteSqlRequest, dict]] = None,
            *,
        ...
        r"""Executes a SQL statement in a database inside an
        AlloyDB instance.
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.ExecuteSqlRequest, dict]):
                The request object. Request for ExecuteSql rpc.
            instance (str):
                Required. The instance where the SQL
                will be executed. For the required
                format, see the comment on the
                Instance.name field.
            ...
            database (str):
                ...
                expected from ``SELECT current_database();`` and NOT as
                ...
                should not be set.
            user (str):
                Required. Database user to be used for executing the
                SQL. Note - Value provided should be the same as
                expected from ``SELECT current_user;`` and NOT as a
                resource reference.
            ...
            sql_statement (str):
                ...
                database. Any valid statement is
                permitted, including DDL, DML, DQL
                statements.

                This corresponds to the ``sql_statement`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            password (str):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [instance, database, user, sql_statement, password]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.ExecuteSqlRequest):
            request = service.ExecuteSqlRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if instance is not None:
                request.instance = instance
            ...
            if sql_statement is not None:
                request.sql_statement = sql_statement
    ...
    def list_backups(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.ListBackupsRequest, dict]):
                The request object. Message for requesting list of
                Backups
            parent (str):
    ...
    def get_backup(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.GetBackupRequest, dict]):
        ...
        Returns:
            google.cloud.alloydb_v1alpha.types.Backup:
    ...
    def create_backup(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.CreateBackupRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.alloydb_v1alpha.types.Backup`
                Message describing Backup object
    ...
    def update_backup(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.UpdateBackupRequest, dict]):
    ...
    def delete_backup(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.DeleteBackupRequest, dict]):
    ...
    def list_supported_database_flags(self,
            request: Optional[Union[service.ListSupportedDatabaseFlagsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.ListSupportedDatabaseFlagsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_supported_database_flags]
    ...
    def generate_client_certificate(self,
        ...
        Args:
            request (Union[google.cloud.alloydb_v1alpha.types.GenerateClientCertificateRequest, dict]):
        ...
        Returns:
            google.cloud.alloydb_v1alpha.types.GenerateClientCertificateResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_client_certificate]
    ...
    def create_user(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, user, user_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_user(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [user, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')

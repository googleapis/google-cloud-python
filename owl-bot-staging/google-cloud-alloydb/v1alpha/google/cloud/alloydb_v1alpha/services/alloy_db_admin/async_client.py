...
class AlloyDBAdminAsyncClient:
    ...
    async def promote_cluster(self,
    ...
    async def switchover_cluster(self,
    ...
    async def restore_cluster(self,
    ...
    async def create_secondary_cluster(self,
    ...
    async def create_secondary_instance(self,
    ...
    async def batch_create_instances(self,
    ...
    async def list_supported_database_flags(self,

...
from google.cloud.alloydb_v1alpha.services.alloy_db_admin import AlloyDBAdminAsyncClient
from google.cloud.alloydb_v1alpha.services.alloy_db_admin import AlloyDBAdminClient
from google.cloud.alloydb_v1alpha.services.alloy_db_admin import pagers
from google.cloud.alloydb_v1alpha.services.alloy_db_admin import transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert AlloyDBAdminClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert AlloyDBAdminClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert AlloyDBAdminClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert AlloyDBAdminClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AlloyDBAdminClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert AlloyDBAdminClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AlloyDBAdminClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(AlloyDBAdminClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AlloyDBAdminClient))
@mock.patch.object(AlloyDBAdminAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AlloyDBAdminAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AlloyDBAdminClient._DEFAULT_UNIVERSE
    default_endpoint = AlloyDBAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AlloyDBAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AlloyDBAdminClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert AlloyDBAdminClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AlloyDBAdminClient.DEFAULT_MTLS_ENDPOINT
    assert AlloyDBAdminClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AlloyDBAdminClient._get_api_endpoint(None, None, default_universe, "always") == AlloyDBAdminClient.DEFAULT_MTLS_ENDPOINT
    assert AlloyDBAdminClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AlloyDBAdminClient.DEFAULT_MTLS_ENDPOINT
    assert AlloyDBAdminClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AlloyDBAdminClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AlloyDBAdminClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AlloyDBAdminClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AlloyDBAdminClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AlloyDBAdminClient._get_universe_domain(None, None) == AlloyDBAdminClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (AlloyDBAdminClient, transports.AlloyDBAdminGrpcTransport, "grpc"),
    (AlloyDBAdminAsyncClient, transports.AlloyDBAdminGrpcAsyncIOTransport, "grpc_asyncio"),
    (AlloyDBAdminClient, transports.AlloyDBAdminRestTransport, "rest"),
])
@mock.patch.object(AlloyDBAdminClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AlloyDBAdminClient))
@mock.patch.object(AlloyDBAdminAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AlloyDBAdminAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (AlloyDBAdminAsyncClient, transports.AlloyDBAdminGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (AlloyDBAdminClient, transports.AlloyDBAdminGrpcTransport, "grpc", "false"),
    (AlloyDBAdminAsyncClient, transports.AlloyDBAdminGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
@pytest.mark.parametrize("client_class", [
    AlloyDBAdminClient, AlloyDBAdminAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (AlloyDBAdminClient, transports.AlloyDBAdminGrpcTransport, "grpc", grpc_helpers),
    (AlloyDBAdminAsyncClient, transports.AlloyDBAdminGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_alloy_db_admin_client_client_options_from_dict():
    with mock.patch('google.cloud.alloydb_v1alpha.services.alloy_db_admin.transports.AlloyDBAdminGrpcTransport.__init__') as grpc_transport:
...
def test_create_cluster_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_cluster(
            parent='parent_value',
            cluster=resources.Cluster(backup_source=resources.BackupSource(backup_uid='backup_uid_value')),
...
def test_promote_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.promote_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_restore_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.restore_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_secondary_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_secondary_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_instances_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Instance)
                   for i in results)
...
def test_create_secondary_instance(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_secondary_instance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_batch_create_instances(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_create_instances),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_inject_fault(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.inject_fault),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_backups_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Backup)
                   for i in results)
...
def test_list_supported_database_flags_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.SupportedDatabaseFlag)
                   for i in results)
...
def test_generate_client_certificate(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_client_certificate),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_connection_info(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_connection_info),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_users_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.User)
                   for i in results)
...
@pytest.mark.asyncio
async def test_list_databases_async(transport: str = 'grpc_asyncio', request_type=service.ListDatabasesRequest):
    client = AlloyDBAdminAsyncClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_databases_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Database)
                   for i in results)
...
def test_list_clusters_rest_unset_required_fields():
    transport = transports.AlloyDBAdminRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_clusters_rest_interceptors(null_interceptor):
    transport = transports.AlloyDBAdminRestTransport(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        interceptor=None if null_interceptor else transports.AlloyDBAdminRestInterceptor(),
        )
    client = AlloyDBAdminClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_list_clusters") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_list_clusters") as pre:
...
def test_list_clusters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/clusters" % client.transport._host, args[1])
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_get_cluster") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_get_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/clusters/*}" % client.transport._host, args[1])
...
def test_create_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_create_cluster") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_create_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_update_cluster") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_update_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{cluster.name=projects/*/locations/*/clusters/*}" % client.transport._host, args[1])
...
def test_delete_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_delete_cluster") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_delete_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_promote_cluster_rest_required_fields(request_type=service.PromoteClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).promote_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_promote_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_promote_cluster") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_promote_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_promote_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/clusters/*}:promote" % client.transport._host, args[1])
...
def test_restore_cluster_rest_required_fields(request_type=service.RestoreClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).restore_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_restore_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_restore_cluster") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_restore_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_secondary_cluster_rest_required_fields(request_type=service.CreateSecondaryClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_secondary_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_secondary_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_create_secondary_cluster") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_create_secondary_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_secondary_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/clusters:createsecondary" % client.transport._host, args[1])
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_list_instances") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_list_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/clusters/*}/instances" % client.transport._host, args[1])
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_get_instance") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_get_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/clusters/*/instances/*}" % client.transport._host, args[1])
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_create_instance") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_create_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_secondary_instance_rest_required_fields(request_type=service.CreateSecondaryInstanceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_secondary_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_secondary_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_create_secondary_instance") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_create_secondary_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_secondary_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/clusters/*}/instances:createsecondary" % client.transport._host, args[1])
...
def test_batch_create_instances_rest_required_fields(request_type=service.BatchCreateInstancesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_create_instances._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_batch_create_instances") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_batch_create_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_update_instance") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_update_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{instance.name=projects/*/locations/*/clusters/*/instances/*}" % client.transport._host, args[1])
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_delete_instance") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_delete_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_failover_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_failover_instance") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_failover_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_failover_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/clusters/*/instances/*}:failover" % client.transport._host, args[1])
...
def test_inject_fault_rest_required_fields(request_type=service.InjectFaultRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).inject_fault._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_inject_fault_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_inject_fault") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_inject_fault") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_inject_fault_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/clusters/*/instances/*}:injectFault" % client.transport._host, args[1])
...
def test_restart_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_restart_instance") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_restart_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_restart_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/clusters/*/instances/*}:restart" % client.transport._host, args[1])
...
def test_list_backups_rest_required_fields(request_type=service.ListBackupsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_backups._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_list_backups") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_list_backups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_backups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/backups" % client.transport._host, args[1])
...
def test_get_backup_rest_required_fields(request_type=service.GetBackupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_backup._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_get_backup") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_get_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/backups/*}" % client.transport._host, args[1])
...
def test_create_backup_rest_required_fields(request_type=service.CreateBackupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_backup._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_create_backup") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_create_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_backup_rest_required_fields(request_type=service.UpdateBackupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_backup._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_update_backup") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_update_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{backup.name=projects/*/locations/*/backups/*}" % client.transport._host, args[1])
...
def test_delete_backup_rest_required_fields(request_type=service.DeleteBackupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_backup._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_delete_backup") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_delete_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_supported_database_flags_rest_required_fields(request_type=service.ListSupportedDatabaseFlagsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_supported_database_flags._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_supported_database_flags_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_list_supported_database_flags") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_list_supported_database_flags") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_supported_database_flags_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/supportedDatabaseFlags" % client.transport._host, args[1])
...
def test_generate_client_certificate_rest_required_fields(request_type=service.GenerateClientCertificateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).generate_client_certificate._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_client_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_generate_client_certificate") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_generate_client_certificate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_generate_client_certificate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/clusters/*}:generateClientCertificate" % client.transport._host, args[1])
...
def test_get_connection_info_rest_required_fields(request_type=service.GetConnectionInfoRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_connection_info._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_connection_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_get_connection_info") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_get_connection_info") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_connection_info_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/clusters/*/instances/*}/connectionInfo" % client.transport._host, args[1])
...
def test_list_users_rest_required_fields(request_type=service.ListUsersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_users._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_users_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_list_users") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_list_users") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_users_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/clusters/*}/users" % client.transport._host, args[1])
...
def test_get_user_rest_required_fields(request_type=service.GetUserRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_user._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_get_user") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_get_user") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_user_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/clusters/*/users/*}" % client.transport._host, args[1])
...
def test_create_user_rest_required_fields(request_type=service.CreateUserRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_user._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_create_user") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_create_user") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_user_rest_required_fields(request_type=service.UpdateUserRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_user._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_update_user") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_update_user") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_user_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{user.name=projects/*/locations/*/clusters/*/users/*}" % client.transport._host, args[1])
...
def test_delete_user_rest_required_fields(request_type=service.DeleteUserRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_user._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_delete_user") as pre:
        pre.assert_not_called()
...
def test_list_databases_rest_required_fields(request_type=service.ListDatabasesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_databases._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_databases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "post_list_databases") as post, \
         mock.patch.object(transports.AlloyDBAdminRestInterceptor, "pre_list_databases") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.ListDatabasesResponse.to_json(service.ListDatabasesResponse())
...
def test_list_databases_rest_bad_request(transport: str = 'rest', request_type=service.ListDatabasesRequest):
    client = AlloyDBAdminClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_databases_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/clusters/*}/databases" % client.transport._host, args[1])
...
def test_alloy_db_admin_base_transport():
    ...
    with mock.patch('google.cloud.alloydb_v1alpha.services.alloy_db_admin.transports.AlloyDBAdminTransport.__init__') as Transport:
...
def test_alloy_db_admin_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.alloydb_v1alpha.services.alloy_db_admin.transports.AlloyDBAdminTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_alloy_db_admin_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.alloydb_v1alpha.services.alloy_db_admin.transports.AlloyDBAdminTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.AlloyDBAdminTransport()
        adc.assert_called_once()
...
def test_alloy_db_admin_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.AlloyDBAdminGrpcTransport, transports.AlloyDBAdminGrpcAsyncIOTransport])
def test_alloy_db_admin_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.AlloyDBAdminGrpcTransport, transports.AlloyDBAdminGrpcAsyncIOTransport])
def test_alloy_db_admin_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_database_path():
    ...
    cluster = "winkle"
    database = "nautilus"
    expected = "projects/{project}/locations/{location}/clusters/{cluster}/databases/{database}".format(project=project, location=location, cluster=cluster, database=database, )

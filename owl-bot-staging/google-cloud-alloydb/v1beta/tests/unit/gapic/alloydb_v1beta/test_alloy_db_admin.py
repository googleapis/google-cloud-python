...
from google.cloud.alloydb_v1beta.services.alloy_db_admin import AlloyDBAdminAsyncClient
from google.cloud.alloydb_v1beta.services.alloy_db_admin import AlloyDBAdminClient
from google.cloud.alloydb_v1beta.services.alloy_db_admin import pagers
from google.cloud.alloydb_v1beta.services.alloy_db_admin import transports
...
def test_list_databases_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/clusters/*}/databases" % client.transport._host, args[1])

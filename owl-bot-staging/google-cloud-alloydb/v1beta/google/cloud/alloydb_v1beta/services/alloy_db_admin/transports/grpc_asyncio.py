...
from .base import AlloyDBAdminTransport, DEFAULT_CLIENT_INFO
...
class AlloyDBAdminGrpcAsyncIOTransport(AlloyDBAdminTransport):
    ...
    def execute_sql(self) -> Callable[
            ...
            Awaitable[service.ExecuteSqlResponse]]:
    ...
    def list_backups(self) -> Callable[
            ...
            Awaitable[service.ListBackupsResponse]]:
    ...
    def list_supported_database_flags(self) -> Callable[
        ...
        if 'list_supported_database_flags' not in self._stubs:
            self._stubs['list_supported_database_flags'] = self.grpc_channel.unary_unary(
    ...
    def get_connection_info(self) -> Callable[
            ...
            Awaitable[resources.ConnectionInfo]]:
    ...
    def list_users(self) -> Callable[
            ...
            Awaitable[service.ListUsersResponse]]:

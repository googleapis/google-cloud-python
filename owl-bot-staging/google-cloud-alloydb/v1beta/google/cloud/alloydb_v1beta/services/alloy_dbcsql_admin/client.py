...
from google.cloud.alloydb_v1beta.types import resources
from google.cloud.alloydb_v1beta.types import service
from google.cloud.location import locations_pb2 # type: ignore
from google.iam.v1 import iam_policy_pb2  # type: ignore
from google.iam.v1 import policy_pb2  # type: ignore
from google.longrunning import operations_pb2 # type: ignore
from .transports.base import AlloyDBCSQLAdminTransport, DEFAULT_CLIENT_INFO
...
class AlloyDBCSQLAdminClient(metaclass=AlloyDBCSQLAdminClientMeta):
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            AlloyDBCSQLAdminClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.alloydb_v1beta.AlloyDBCSQLAdminClient`.",
                    extra = {
    ...
    def restore_from_cloud_sql(self,
        ...
        .. code-block:: python
            ...
            def sample_restore_from_cloud_sql():
                # Create a client
                client = alloydb_v1beta.AlloyDBCSQLAdminClient()
        ...
        Args:
            request (Union[google.cloud.alloydb_v1beta.types.RestoreFromCloudSQLRequest, dict]):

...
def test__read_environment_variables():
    assert WorkloadIdentityPoolsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert WorkloadIdentityPoolsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        with pytest.raises(ValueError) as excinfo:
            WorkloadIdentityPoolsClient._read_environment_variables()
    assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert WorkloadIdentityPoolsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert WorkloadIdentityPoolsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert WorkloadIdentityPoolsClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert WorkloadIdentityPoolsClient._get_client_cert_source(None, False) is None
    assert WorkloadIdentityPoolsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert WorkloadIdentityPoolsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert WorkloadIdentityPoolsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert WorkloadIdentityPoolsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(WorkloadIdentityPoolsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WorkloadIdentityPoolsClient))
@mock.patch.object(WorkloadIdentityPoolsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WorkloadIdentityPoolsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = WorkloadIdentityPoolsClient._DEFAULT_UNIVERSE
    default_endpoint = WorkloadIdentityPoolsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = WorkloadIdentityPoolsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert WorkloadIdentityPoolsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert WorkloadIdentityPoolsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == WorkloadIdentityPoolsClient.DEFAULT_MTLS_ENDPOINT
    assert WorkloadIdentityPoolsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert WorkloadIdentityPoolsClient._get_api_endpoint(None, None, default_universe, "always") == WorkloadIdentityPoolsClient.DEFAULT_MTLS_ENDPOINT
    assert WorkloadIdentityPoolsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == WorkloadIdentityPoolsClient.DEFAULT_MTLS_ENDPOINT
    assert WorkloadIdentityPoolsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert WorkloadIdentityPoolsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        WorkloadIdentityPoolsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert WorkloadIdentityPoolsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert WorkloadIdentityPoolsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert WorkloadIdentityPoolsClient._get_universe_domain(None, None) == WorkloadIdentityPoolsClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        WorkloadIdentityPoolsClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = WorkloadIdentityPoolsClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_name", [
    (WorkloadIdentityPoolsClient, "grpc"),
    (WorkloadIdentityPoolsAsyncClient, "grpc_asyncio"),
])
def test_workload_identity_pools_client_from_service_account_info(client_class, transport_name):
...
def test_workload_identity_pools_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class", [
    WorkloadIdentityPoolsClient, WorkloadIdentityPoolsAsyncClient
])
...
def test_workload_identity_pools_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
@mock.patch.object(WorkloadIdentityPoolsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WorkloadIdentityPoolsClient))
@mock.patch.object(WorkloadIdentityPoolsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WorkloadIdentityPoolsAsyncClient))
def test_workload_identity_pools_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (WorkloadIdentityPoolsClient, transports.WorkloadIdentityPoolsGrpcTransport, "grpc", grpc_helpers),
    (WorkloadIdentityPoolsAsyncClient, transports.WorkloadIdentityPoolsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
def test_workload_identity_pools_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_workload_identity_pools_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_list_workload_identity_pools_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        client.list_workload_identity_pools(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_list_workload_identity_pools_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_workload_identity_pools in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_workload_identity_pools] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_workload_identity_pools_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_workload_identity_pools in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_workload_identity_pools] = mock_rpc
...
def test_list_workload_identity_pools_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_workload_identity_pools(request={}, retry=retry, timeout=timeout)
...
def test_get_workload_identity_pool_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.get_workload_identity_pool(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_get_workload_identity_pool_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_workload_identity_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_workload_identity_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_workload_identity_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_workload_identity_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_workload_identity_pool] = mock_rpc
...
def test_create_workload_identity_pool_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.create_workload_identity_pool(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_create_workload_identity_pool_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsClient(
        ...
        # Ensure method has been cached
        assert client._transport.create_workload_identity_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_workload_identity_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_workload_identity_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_workload_identity_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_workload_identity_pool] = mock_rpc
...
def test_update_workload_identity_pool_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.update_workload_identity_pool(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == gi_workload_identity_pool.UpdateWorkloadIdentityPoolRequest(
        )

def test_update_workload_identity_pool_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsClient(
        ...
        # Ensure method has been cached
        assert client._transport.update_workload_identity_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_workload_identity_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_workload_identity_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_workload_identity_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_workload_identity_pool] = mock_rpc
...
def test_update_workload_identity_pool_field_headers():
    ...
    request.workload_identity_pool.name = 'name_value'
...
def test_delete_workload_identity_pool_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.delete_workload_identity_pool(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_delete_workload_identity_pool_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_workload_identity_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_workload_identity_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_workload_identity_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_workload_identity_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_workload_identity_pool] = mock_rpc
...
def test_undelete_workload_identity_pool_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.undelete_workload_identity_pool(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_undelete_workload_identity_pool_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsClient(
        ...
        # Ensure method has been cached
        assert client._transport.undelete_workload_identity_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.undelete_workload_identity_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_undelete_workload_identity_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.undelete_workload_identity_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.undelete_workload_identity_pool] = mock_rpc
...
def test_list_workload_identity_pool_providers_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.list_workload_identity_pool_providers(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_list_workload_identity_pool_providers_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_workload_identity_pool_providers in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_workload_identity_pool_providers] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_workload_identity_pool_providers_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_workload_identity_pool_providers in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_workload_identity_pool_providers] = mock_rpc
...
def test_list_workload_identity_pool_providers_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_workload_identity_pool_providers(request={}, retry=retry, timeout=timeout)
...
def test_get_workload_identity_pool_provider_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.get_workload_identity_pool_provider(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_get_workload_identity_pool_provider_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_workload_identity_pool_provider in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_workload_identity_pool_provider] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_workload_identity_pool_provider_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_workload_identity_pool_provider in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_workload_identity_pool_provider] = mock_rpc
...
def test_create_workload_identity_pool_provider_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.create_workload_identity_pool_provider(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_create_workload_identity_pool_provider_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsClient(
        ...
        # Ensure method has been cached
        assert client._transport.create_workload_identity_pool_provider in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_workload_identity_pool_provider] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_workload_identity_pool_provider_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_workload_identity_pool_provider in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_workload_identity_pool_provider] = mock_rpc
...
def test_update_workload_identity_pool_provider_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.update_workload_identity_pool_provider(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == workload_identity_pool.UpdateWorkloadIdentityPoolProviderRequest(
        )

def test_update_workload_identity_pool_provider_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsClient(
        ...
        # Ensure method has been cached
        assert client._transport.update_workload_identity_pool_provider in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_workload_identity_pool_provider] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_workload_identity_pool_provider_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_workload_identity_pool_provider in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_workload_identity_pool_provider] = mock_rpc
...
def test_update_workload_identity_pool_provider_field_headers():
    ...
    request.workload_identity_pool_provider.name = 'name_value'
    ...
    assert (
        'x-goog-request-params',
        'workload_identity_pool_provider.name=name_value',
    ) in kw['metadata']
...
def test_delete_workload_identity_pool_provider_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.delete_workload_identity_pool_provider(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_delete_workload_identity_pool_provider_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_workload_identity_pool_provider in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_workload_identity_pool_provider] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_workload_identity_pool_provider_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_workload_identity_pool_provider in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_workload_identity_pool_provider] = mock_rpc
...
def test_undelete_workload_identity_pool_provider_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.undelete_workload_identity_pool_provider(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_undelete_workload_identity_pool_provider_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsClient(
        ...
        # Ensure method has been cached
        assert client._transport.undelete_workload_identity_pool_provider in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.undelete_workload_identity_pool_provider] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_undelete_workload_identity_pool_provider_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkloadIdentityPoolsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.undelete_workload_identity_pool_provider in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.undelete_workload_identity_pool_provider] = mock_rpc
...
def test_list_workload_identity_pools_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = workload_identity_pool.ListWorkloadIdentityPoolsResponse()
        client.list_workload_identity_pools(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = workload_identity_pool.ListWorkloadIdentityPoolsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_workload_identity_pool_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = workload_identity_pool.WorkloadIdentityPool()
        client.get_workload_identity_pool(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = workload_identity_pool.GetWorkloadIdentityPoolRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_workload_identity_pool_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_workload_identity_pool(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = gi_workload_identity_pool.CreateWorkloadIdentityPoolRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_workload_identity_pool_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_workload_identity_pool(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = gi_workload_identity_pool.UpdateWorkloadIdentityPoolRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_workload_identity_pool_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_workload_identity_pool(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = workload_identity_pool.DeleteWorkloadIdentityPoolRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_undelete_workload_identity_pool_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.undelete_workload_identity_pool(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = workload_identity_pool.UndeleteWorkloadIdentityPoolRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_workload_identity_pool_providers_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = workload_identity_pool.ListWorkloadIdentityPoolProvidersResponse()
        client.list_workload_identity_pool_providers(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = workload_identity_pool.ListWorkloadIdentityPoolProvidersRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_workload_identity_pool_provider_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = workload_identity_pool.WorkloadIdentityPoolProvider()
        client.get_workload_identity_pool_provider(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = workload_identity_pool.GetWorkloadIdentityPoolProviderRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_workload_identity_pool_provider_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_workload_identity_pool_provider(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = workload_identity_pool.CreateWorkloadIdentityPoolProviderRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_workload_identity_pool_provider_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_workload_identity_pool_provider(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = workload_identity_pool.UpdateWorkloadIdentityPoolProviderRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_workload_identity_pool_provider_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_workload_identity_pool_provider(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = workload_identity_pool.DeleteWorkloadIdentityPoolProviderRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_undelete_workload_identity_pool_provider_empty_call_grpc():
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.undelete_workload_identity_pool_provider(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = workload_identity_pool.UndeleteWorkloadIdentityPoolProviderRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = WorkloadIdentityPoolsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_workload_identity_pools_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_workload_identity_pools(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_workload_identity_pool_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_workload_identity_pool(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_workload_identity_pool_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_workload_identity_pool(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_workload_identity_pool_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_workload_identity_pool(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_workload_identity_pool_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_workload_identity_pool(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_undelete_workload_identity_pool_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.undelete_workload_identity_pool(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_workload_identity_pool_providers_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_workload_identity_pool_providers(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_workload_identity_pool_provider_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_workload_identity_pool_provider(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_workload_identity_pool_provider_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_workload_identity_pool_provider(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_workload_identity_pool_provider_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_workload_identity_pool_provider(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_workload_identity_pool_provider_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_workload_identity_pool_provider(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_undelete_workload_identity_pool_provider_empty_call_grpc_asyncio():
    client = WorkloadIdentityPoolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.undelete_workload_identity_pool_provider(request=None)
...
def test_workload_identity_pools_transport_auth_gdch_credentials(transport_class):
...
def test_workload_identity_pools_host_no_port(transport_name):
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_workload_identity_pools_host_with_port(transport_name):
    client = WorkloadIdentityPoolsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize("client_class,transport_class", [
    (WorkloadIdentityPoolsClient, transports.WorkloadIdentityPoolsGrpcTransport),

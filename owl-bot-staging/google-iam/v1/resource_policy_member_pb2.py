...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_RESOURCEPOLICYMEMBER'].fields_by_name['iam_policy_name_principal']._options = None
  _globals['_RESOURCEPOLICYMEMBER'].fields_by_name['iam_policy_name_principal']._serialized_options = b'\340A\003'
  _globals['_RESOURCEPOLICYMEMBER'].fields_by_name['iam_policy_uid_principal']._options = None
  _globals['_RESOURCEPOLICYMEMBER'].fields_by_name['iam_policy_uid_principal']._serialized_options = b'\340A\003'

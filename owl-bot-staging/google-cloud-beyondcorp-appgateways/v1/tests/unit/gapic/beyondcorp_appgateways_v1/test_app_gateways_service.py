...
def test__get_api_endpoint():
    ...
    assert AppGatewaysServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AppGatewaysServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert AppGatewaysServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AppGatewaysServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_list_app_gateways_rest_required_fields(request_type=app_gateways_service.ListAppGatewaysRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_app_gateways._get_unset_required_fields(jsonified_request)
...
def test_list_app_gateways_rest_unset_required_fields():
    transport = transports.AppGatewaysServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_app_gateway_rest_required_fields(request_type=app_gateways_service.GetAppGatewayRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_app_gateway._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_app_gateway_rest_required_fields(request_type=app_gateways_service.CreateAppGatewayRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_app_gateway._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_app_gateway_rest_required_fields(request_type=app_gateways_service.DeleteAppGatewayRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_app_gateway._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test_list_app_gateways_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "post_list_app_gateways_with_metadata") as post_with_metadata, \
...
def test_get_app_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "post_get_app_gateway_with_metadata") as post_with_metadata, \
...
def test_create_app_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "post_create_app_gateway_with_metadata") as post_with_metadata, \
...
def test_delete_app_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "post_delete_app_gateway_with_metadata") as post_with_metadata, \

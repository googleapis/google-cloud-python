...
class AppGatewaysServiceTransport(abc.ABC):
    """Abstract transport class for AppGatewaysService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_app_gateways: gapic_v1.method.wrap_method(
                self.list_app_gateways,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_app_gateway: gapic_v1.method.wrap_method(
                self.get_app_gateway,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_app_gateway: gapic_v1.method.wrap_method(
                self.create_app_gateway,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_app_gateway: gapic_v1.method.wrap_method(

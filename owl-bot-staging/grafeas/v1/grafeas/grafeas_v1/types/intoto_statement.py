...
class InTotoSlsaProvenanceV1(proto.Message):
    ...
    class BuildDefinition(proto.Message):
        ...
        resolved_dependencies: MutableSequence['InTotoSlsaProvenanceV1.ResourceDescriptor'] = proto.RepeatedField(
            proto.MESSAGE,
            number=4,
    ...
    class RunDetails(proto.Message):
        ...
        byproducts: MutableSequence['InTotoSlsaProvenanceV1.ResourceDescriptor'] = proto.RepeatedField(
            proto.MESSAGE,
            number=3,
            message='InTotoSlsaProvenanceV1.ResourceDescriptor',
        )
    ...
    class ProvenanceBuilder(proto.Message):
        ...
        builder_dependencies: MutableSequence['InTotoSlsaProvenanceV1.ResourceDescriptor'] = proto.RepeatedField(
            proto.MESSAGE,
            number=3,
            message='InTotoSlsaProvenanceV1.ResourceDescriptor',
        )

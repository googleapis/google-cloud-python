...
class AnalyticsHubServiceGrpcTransport(AnalyticsHubServiceTransport):
    ...
    @property
    def create_query_template(self) -> Callable[
    ...
    @property
    def get_query_template(self) -> Callable[
    ...
    @property
    def list_query_templates(self) -> Callable[
    ...
    @property
    def update_query_template(self) -> Callable[
    ...
    @property
    def delete_query_template(self) -> Callable[
    ...
    @property
    def submit_query_template(self) -> Callable[
    ...
    @property
    def approve_query_template(self) -> Callable[

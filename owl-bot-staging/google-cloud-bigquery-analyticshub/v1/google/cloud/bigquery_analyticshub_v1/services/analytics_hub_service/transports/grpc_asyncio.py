...
class AnalyticsHubServiceGrpcAsyncIOTransport(AnalyticsHubServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.subscribe_data_exchange: gapic_v1.method_async.wrap_method(
                self.subscribe_data_exchange,
                default_timeout=None,
                client_info=client_info,
            ),
            self.refresh_subscription: gapic_v1.method_async.wrap_method(
            ...
            self.list_shared_resource_subscriptions: gapic_v1.method_async.wrap_method(
                self.list_shared_resource_subscriptions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.revoke_subscription: gapic_v1.method_async.wrap_method(

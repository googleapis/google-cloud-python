...
class AnalyticsHubServiceClient(metaclass=AnalyticsHubServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "analyticshub.{UNIVERSE_DOMAIN}"
    ...
    @staticmethod
    def data_exchange_path(project: str,location: str,data_exchange: str,) -> str:
        """Returns a fully-qualified data_exchange string."""
        return "projects/{project}/locations/{location}/dataExchanges/{data_exchange}".format(project=project, location=location, data_exchange=data_exchange, )

    @staticmethod
    def parse_data_exchange_path(path: str) -> Dict[str,str]:
        """Parses a data_exchange path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataExchanges/(?P<data_exchange>.+?)$", path)
    ...
    @staticmethod
    def listing_path(project: str,location: str,data_exchange: str,listing: str,) -> str:
        """Returns a fully-qualified listing string."""
        return "projects/{project}/locations/{location}/dataExchanges/{data_exchange}/listings/{listing}".format(project=project, location=location, data_exchange=data_exchange, listing=listing, )

    @staticmethod
    def parse_listing_path(path: str) -> Dict[str,str]:
        """Parses a listing path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataExchanges/(?P<data_exchange>.+?)/listings/(?P<listing>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def order_path(project: str,order: str,) -> str:
        """Returns a fully-qualified order string."""
        return "projects/{project}/orders/{order}".format(project=project, order=order, )
    ...
    @staticmethod
    def query_template_path(project: str,location: str,data_exchange: str,query_template: str,) -> str:
        """Returns a fully-qualified query_template string."""
        return "projects/{project}/locations/{location}/dataExchanges/{data_exchange}/queryTemplates/{query_template}".format(project=project, location=location, data_exchange=data_exchange, query_template=query_template, )

    @staticmethod
    def parse_query_template_path(path: str) -> Dict[str,str]:
        """Parses a query_template path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataExchanges/(?P<data_exchange>.+?)/queryTemplates/(?P<query_template>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def routine_path(project: str,dataset: str,routine: str,) -> str:
        """Returns a fully-qualified routine string."""
        return "projects/{project}/datasets/{dataset}/routines/{routine}".format(project=project, dataset=dataset, routine=routine, )

    @staticmethod
    def parse_routine_path(path: str) -> Dict[str,str]:
        """Parses a routine path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/datasets/(?P<dataset>.+?)/routines/(?P<routine>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AnalyticsHubServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AnalyticsHubServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = AnalyticsHubServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AnalyticsHubServiceTransport, Callable[..., AnalyticsHubServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AnalyticsHubServiceClient._read_environment_variables()
        self._client_cert_source = AnalyticsHubServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AnalyticsHubServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, AnalyticsHubServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(AnalyticsHubServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AnalyticsHubServiceTransport], Callable[..., AnalyticsHubServiceTransport]] = (
                AnalyticsHubServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.bigquery.analyticshub_v1.AnalyticsHubServiceClient`.",
                    extra = {
    ...
    def list_org_data_exchanges(self,
    ...
    def subscribe_data_exchange(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.subscribe_data_exchange]
    ...
    def refresh_subscription(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.refresh_subscription]
    ...
    def list_shared_resource_subscriptions(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListSharedResourceSubscriptionsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_shared_resource_subscriptions]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListSharedResourceSubscriptionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def revoke_subscription(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.revoke_subscription]
    ...
    def create_query_template(self,
        ...
        .. code-block:: python
            ...
            def sample_create_query_template():
                # Create a client
                client = bigquery_analyticshub_v1.AnalyticsHubServiceClient()
                ...
                # Make the request
                response = client.create_query_template(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.bigquery_analyticshub_v1.types.CreateQueryTemplateRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_query_template]
    ...
    def get_query_template(self,
        ...
        .. code-block:: python
            ...
            def sample_get_query_template():
                ...
                # Make the request
                response = client.get_query_template(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.bigquery_analyticshub_v1.types.GetQueryTemplateRequest, dict]):
                The request object. Message for creating a QueryTemplate.
            name (str):
                Required. The parent resource path of the QueryTemplate.
                e.g.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_query_template]
    ...
    def list_query_templates(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListQueryTemplatesPager:
        ...
        .. code-block:: python
            ...
            def sample_list_query_templates():
                # Create a client
                client = bigquery_analyticshub_v1.AnalyticsHubServiceClient()
        ...
        Args:
            request (Union[google.cloud.bigquery_analyticshub_v1.types.ListQueryTemplatesRequest, dict]):
                The request object. Message for requesting the list of
                QueryTemplates.
            parent (str):
        ...
        Returns:
            google.cloud.bigquery_analyticshub_v1.services.analytics_hub_service.pagers.ListQueryTemplatesPager:
                Message for response to the list of
                QueryTemplates.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_query_templates]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListQueryTemplatesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def update_query_template(self,
        ...
        Args:
            request (Union[google.cloud.bigquery_analyticshub_v1.types.UpdateQueryTemplateRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_query_template]
    ...
    def delete_query_template(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_query_template():
                # Create a client
                client = bigquery_analyticshub_v1.AnalyticsHubServiceClient()
        ...
        Args:
            request (Union[google.cloud.bigquery_analyticshub_v1.types.DeleteQueryTemplateRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_query_template]
    ...
    def submit_query_template(self,
        ...
        .. code-block:: python
            ...
            def sample_submit_query_template():
                # Create a client
                client = bigquery_analyticshub_v1.AnalyticsHubServiceClient()
                ...
                # Make the request
                response = client.submit_query_template(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.bigquery_analyticshub_v1.types.SubmitQueryTemplateRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.submit_query_template]
    ...
    def approve_query_template(self,
        ...
        .. code-block:: python
            ...
            def sample_approve_query_template():
                # Create a client
                client = bigquery_analyticshub_v1.AnalyticsHubServiceClient()
                ...
                # Make the request
                response = client.approve_query_template(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.bigquery_analyticshub_v1.types.ApproveQueryTemplateRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.approve_query_template]

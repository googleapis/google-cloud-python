...
class AnalyticsHubServiceAsyncClient:
    ...
    parse_data_exchange_path = staticmethod(AnalyticsHubServiceClient.parse_data_exchange_path)
    ...
    parse_managed_service_path = staticmethod(AnalyticsHubServiceClient.parse_managed_service_path)
    ...
    query_template_path = staticmethod(AnalyticsHubServiceClient.query_template_path)
    parse_query_template_path = staticmethod(AnalyticsHubServiceClient.parse_query_template_path)
    ...
    parse_subscription_path = staticmethod(AnalyticsHubServiceClient.parse_subscription_path)
    ...
    common_billing_account_path = staticmethod(AnalyticsHubServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(AnalyticsHubServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(AnalyticsHubServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(AnalyticsHubServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(AnalyticsHubServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(AnalyticsHubServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(AnalyticsHubServiceClient.common_project_path)
    parse_common_project_path = staticmethod(AnalyticsHubServiceClient.parse_common_project_path)
    common_location_path = staticmethod(AnalyticsHubServiceClient.common_location_path)
    parse_common_location_path = staticmethod(AnalyticsHubServiceClient.parse_common_location_path)
    ...
    get_transport_class = AnalyticsHubServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, AnalyticsHubServiceTransport, Callable[..., AnalyticsHubServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.bigquery.analyticshub_v1.AnalyticsHubServiceAsyncClient`.",
                extra = {
    ...
    async def list_data_exchanges(self,
            request: Optional[Union[analyticshub.ListDataExchangesRequest, dict]] = None,
            *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_data_exchanges]
    ...
    async def list_org_data_exchanges(self,
            request: Optional[Union[analyticshub.ListOrgDataExchangesRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_org_data_exchanges]
    ...
    async def get_data_exchange(self,
            request: Optional[Union[analyticshub.GetDataExchangeRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_data_exchange]
    ...
    async def create_data_exchange(self,
            request: Optional[Union[analyticshub.CreateDataExchangeRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            data_exchange: Optional[analyticshub.DataExchange] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> analyticshub.DataExchange:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_data_exchange]
    ...
    async def update_data_exchange(self,
            request: Optional[Union[analyticshub.UpdateDataExchangeRequest, dict]] = None,
            *,
            data_exchange: Optional[analyticshub.DataExchange] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_data_exchange]
    ...
    async def delete_data_exchange(self,
            request: Optional[Union[analyticshub.DeleteDataExchangeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_data_exchange]
    ...
    async def list_listings(self,
            request: Optional[Union[analyticshub.ListListingsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_listings]
    ...
    async def get_listing(self,
            request: Optional[Union[analyticshub.GetListingRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_listing]
    ...
    async def create_listing(self,
            request: Optional[Union[analyticshub.CreateListingRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            listing: Optional[analyticshub.Listing] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> analyticshub.Listing:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_listing]
    ...
    async def update_listing(self,
            request: Optional[Union[analyticshub.UpdateListingRequest, dict]] = None,
            *,
            listing: Optional[analyticshub.Listing] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_listing]
    ...
    async def delete_listing(self,
            request: Optional[Union[analyticshub.DeleteListingRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_listing]
    ...
    async def subscribe_listing(self,
            request: Optional[Union[analyticshub.SubscribeListingRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.subscribe_listing]
    ...
    async def subscribe_data_exchange(self,
            request: Optional[Union[analyticshub.SubscribeDataExchangeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.subscribe_data_exchange]
    ...
    async def refresh_subscription(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.refresh_subscription]
    ...
    async def list_shared_resource_subscriptions(self,
            request: Optional[Union[analyticshub.ListSharedResourceSubscriptionsRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_shared_resource_subscriptions]
    ...
    async def revoke_subscription(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.revoke_subscription]
    ...
    async def create_query_template(self,
            request: Optional[Union[analyticshub.CreateQueryTemplateRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            query_template: Optional[analyticshub.QueryTemplate] = None,
            query_template_id: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> analyticshub.QueryTemplate:
        r"""Creates a new QueryTemplate
        ...
        .. code-block:: python
            ...
            async def sample_create_query_template():
                # Create a client
                client = bigquery_analyticshub_v1.AnalyticsHubServiceAsyncClient()
                ...
                request = bigquery_analyticshub_v1.CreateQueryTemplateRequest(
                    parent="parent_value",
                ...
                # Make the request
                response = await client.create_query_template(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.bigquery_analyticshub_v1.types.CreateQueryTemplateRequest, dict]]):
                The request object. Message for creating a QueryTemplate.
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            query_template (:class:`google.cloud.bigquery_analyticshub_v1.types.QueryTemplate`):
                Required. The QueryTemplate to
                create.

                This corresponds to the ``query_template`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            query_template_id (:class:`str`):
                ...
                This corresponds to the ``query_template_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.cloud.bigquery_analyticshub_v1.types.QueryTemplate:
                A query template is a container for
                sharing table-valued functions defined
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, query_template, query_template_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, analyticshub.CreateQueryTemplateRequest):
            request = analyticshub.CreateQueryTemplateRequest(request)
        ...
        if query_template is not None:
            request.query_template = query_template
        if query_template_id is not None:
            request.query_template_id = query_template_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_query_template]
    ...
    async def get_query_template(self,
            request: Optional[Union[analyticshub.GetQueryTemplateRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_analyticshub_v1.types.GetQueryTemplateRequest, dict]]):
                The request object. Message for creating a QueryTemplate.
            name (:class:`str`):
                Required. The parent resource path of the QueryTemplate.
                e.g.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, analyticshub.GetQueryTemplateRequest):
            request = analyticshub.GetQueryTemplateRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_query_template]
    ...
    async def list_query_templates(self,
            request: Optional[Union[analyticshub.ListQueryTemplatesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListQueryTemplatesAsyncPager:
        r"""Lists all QueryTemplates in a given project and
        location.
        ...
        .. code-block:: python
            ...
            async def sample_list_query_templates():
                # Create a client
                client = bigquery_analyticshub_v1.AnalyticsHubServiceAsyncClient()

                # Initialize request argument(s)
                request = bigquery_analyticshub_v1.ListQueryTemplatesRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_query_templates(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.bigquery_analyticshub_v1.types.ListQueryTemplatesRequest, dict]]):
                The request object. Message for requesting the list of
                QueryTemplates.
            parent (:class:`str`):
        ...
        Returns:
            google.cloud.bigquery_analyticshub_v1.services.analytics_hub_service.pagers.ListQueryTemplatesAsyncPager:
                Message for response to the list of
                QueryTemplates.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, analyticshub.ListQueryTemplatesRequest):
            request = analyticshub.ListQueryTemplatesRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_query_templates]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListQueryTemplatesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def update_query_template(self,
            request: Optional[Union[analyticshub.UpdateQueryTemplateRequest, dict]] = None,
            *,
            query_template: Optional[analyticshub.QueryTemplate] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        r"""Updates an existing QueryTemplate
        ...
        .. code-block:: python
            ...
            async def sample_update_query_template():
                # Create a client
                client = bigquery_analyticshub_v1.AnalyticsHubServiceAsyncClient()
                ...
                # Make the request
                response = await client.update_query_template(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.bigquery_analyticshub_v1.types.UpdateQueryTemplateRequest, dict]]):
                The request object. Message for updating a QueryTemplate.
            query_template (:class:`google.cloud.bigquery_analyticshub_v1.types.QueryTemplate`):
                Required. The QueryTemplate to
                update.
                ...
                should not be set.
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                Optional. Field mask specifies the fields to update in
                the query template resource. The fields specified in the
                ``updateMask`` are relative to the resource and are not
                a full request.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [query_template, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, analyticshub.UpdateQueryTemplateRequest):
            request = analyticshub.UpdateQueryTemplateRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_query_template]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("query_template.name", request.query_template.name),
            )),
        )
    ...
    async def delete_query_template(self,
            request: Optional[Union[analyticshub.DeleteQueryTemplateRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_query_template():
                # Create a client
                client = bigquery_analyticshub_v1.AnalyticsHubServiceAsyncClient()

                # Initialize request argument(s)
                request = bigquery_analyticshub_v1.DeleteQueryTemplateRequest(
                    name="name_value",
                )

                # Make the request
                await client.delete_query_template(request=request)

        Args:
            request (Optional[Union[google.cloud.bigquery_analyticshub_v1.types.DeleteQueryTemplateRequest, dict]]):
                The request object. Message for deleting a QueryTemplate.
            name (:class:`str`):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, analyticshub.DeleteQueryTemplateRequest):
            request = analyticshub.DeleteQueryTemplateRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_query_template]
    ...
    async def submit_query_template(self,
            request: Optional[Union[analyticshub.SubmitQueryTemplateRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Submits a query template for approval.
        ...
        .. code-block:: python
            ...
            async def sample_submit_query_template():
                # Create a client
                client = bigquery_analyticshub_v1.AnalyticsHubServiceAsyncClient()

                # Initialize request argument(s)
                request = bigquery_analyticshub_v1.SubmitQueryTemplateRequest(
                    name="name_value",
                )

                # Make the request
                response = await client.submit_query_template(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.bigquery_analyticshub_v1.types.SubmitQueryTemplateRequest, dict]]):
                The request object. Message for submitting a
                QueryTemplate.
            name (:class:`str`):
                Required. The resource path of the QueryTemplate. e.g.
                ``projects/myproject/locations/us/dataExchanges/123/queryTemplates/myqueryTemplate``.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, analyticshub.SubmitQueryTemplateRequest):
            request = analyticshub.SubmitQueryTemplateRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.submit_query_template]
    ...
    async def approve_query_template(self,
            request: Optional[Union[analyticshub.ApproveQueryTemplateRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_approve_query_template():
                # Create a client
                client = bigquery_analyticshub_v1.AnalyticsHubServiceAsyncClient()

                # Initialize request argument(s)
                request = bigquery_analyticshub_v1.ApproveQueryTemplateRequest(
                    name="name_value",
                )

                # Make the request
                response = await client.approve_query_template(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.bigquery_analyticshub_v1.types.ApproveQueryTemplateRequest, dict]]):
                The request object. Message for approving a
                QueryTemplate.
            name (:class:`str`):
                Required. The resource path of the QueryTemplate. e.g.
                ``projects/myproject/locations/us/dataExchanges/123/queryTemplates/myqueryTemplate``.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, analyticshub.ApproveQueryTemplateRequest):
            request = analyticshub.ApproveQueryTemplateRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.approve_query_template]

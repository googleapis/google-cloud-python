...
from google.cloud.bigquery_analyticshub_v1.services.analytics_hub_service import AnalyticsHubServiceAsyncClient
...
from google.cloud.bigquery_analyticshub_v1.services.analytics_hub_service import transports
...
def test__get_api_endpoint():
    ...
    assert AnalyticsHubServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AnalyticsHubServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert AnalyticsHubServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AnalyticsHubServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_analytics_hub_service_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery_analyticshub_v1.services.analytics_hub_service.transports.AnalyticsHubServiceGrpcTransport.__init__') as grpc_transport:
...
def test_subscribe_data_exchange(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.subscribe_data_exchange),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_subscribe_data_exchange_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.subscribe_data_exchange in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.subscribe_data_exchange] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_subscribe_data_exchange_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnalyticsHubServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.subscribe_data_exchange in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.subscribe_data_exchange] = mock_rpc
...
@pytest.mark.asyncio
async def test_subscribe_data_exchange_async(transport: str = 'grpc_asyncio', request_type=analyticshub.SubscribeDataExchangeRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_refresh_subscription(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.refresh_subscription),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_refresh_subscription_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.refresh_subscription in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.refresh_subscription] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_refresh_subscription_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnalyticsHubServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.refresh_subscription in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.refresh_subscription] = mock_rpc
...
@pytest.mark.asyncio
async def test_refresh_subscription_async(transport: str = 'grpc_asyncio', request_type=analyticshub.RefreshSubscriptionRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_subscription_async(transport: str = 'grpc_asyncio', request_type=analyticshub.GetSubscriptionRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analyticshub.Subscription(
            name='name_value',
            organization_id='organization_id_value',
            organization_display_name='organization_display_name_value',
            state=analyticshub.Subscription.State.STATE_ACTIVE,
...
@pytest.mark.asyncio
async def test_list_subscriptions_async(transport: str = 'grpc_asyncio', request_type=analyticshub.ListSubscriptionsRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analyticshub.ListSubscriptionsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_subscriptions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, analyticshub.Subscription)
                   for i in results)
...
def test_list_shared_resource_subscriptions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_shared_resource_subscriptions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_shared_resource_subscriptions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_shared_resource_subscriptions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnalyticsHubServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_shared_resource_subscriptions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_shared_resource_subscriptions] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_shared_resource_subscriptions_async(transport: str = 'grpc_asyncio', request_type=analyticshub.ListSharedResourceSubscriptionsRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analyticshub.ListSharedResourceSubscriptionsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_shared_resource_subscriptions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_shared_resource_subscriptions(request={}, retry=retry, timeout=timeout)
...
async def test_list_shared_resource_subscriptions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_shared_resource_subscriptions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_revoke_subscription(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.revoke_subscription),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_revoke_subscription_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.revoke_subscription in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.revoke_subscription] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_revoke_subscription_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnalyticsHubServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.revoke_subscription in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.revoke_subscription] = mock_rpc
...
@pytest.mark.asyncio
async def test_revoke_subscription_async(transport: str = 'grpc_asyncio', request_type=analyticshub.RevokeSubscriptionRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analyticshub.RevokeSubscriptionResponse(
        ))
...
@pytest.mark.asyncio
async def test_delete_subscription_async(transport: str = 'grpc_asyncio', request_type=analyticshub.DeleteSubscriptionRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_query_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_query_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_query_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_query_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_query_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_query_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnalyticsHubServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_query_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_query_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_query_template_async(transport: str = 'grpc_asyncio', request_type=analyticshub.CreateQueryTemplateRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analyticshub.QueryTemplate(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
            proposer='proposer_value',
...
def test_get_query_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_query_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = analyticshub.QueryTemplate(
            name='name_value',
...
def test_get_query_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_query_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_query_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_query_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnalyticsHubServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_query_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_query_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_query_template_async(transport: str = 'grpc_asyncio', request_type=analyticshub.GetQueryTemplateRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_query_templates_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_query_templates in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_query_templates] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_query_templates_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnalyticsHubServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_query_templates in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_query_templates] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_query_templates_async(transport: str = 'grpc_asyncio', request_type=analyticshub.ListQueryTemplatesRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analyticshub.ListQueryTemplatesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_query_templates_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, analyticshub.QueryTemplate)
                   for i in results)
...
async def test_list_query_templates_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_query_templates(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_update_query_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_query_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = analyticshub.QueryTemplate(
            name='name_value',
...
def test_update_query_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_query_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_query_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_query_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnalyticsHubServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_query_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_query_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_query_template_async(transport: str = 'grpc_asyncio', request_type=analyticshub.UpdateQueryTemplateRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_query_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_query_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_query_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_query_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_query_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_query_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnalyticsHubServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_query_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_query_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_query_template_async(transport: str = 'grpc_asyncio', request_type=analyticshub.DeleteQueryTemplateRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_submit_query_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.submit_query_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = analyticshub.QueryTemplate(
            name='name_value',
...
def test_submit_query_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.submit_query_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.submit_query_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_submit_query_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnalyticsHubServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.submit_query_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.submit_query_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_submit_query_template_async(transport: str = 'grpc_asyncio', request_type=analyticshub.SubmitQueryTemplateRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_approve_query_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.approve_query_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = analyticshub.QueryTemplate(
            name='name_value',
...
def test_approve_query_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.approve_query_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.approve_query_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_approve_query_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnalyticsHubServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.approve_query_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.approve_query_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_approve_query_template_async(transport: str = 'grpc_asyncio', request_type=analyticshub.ApproveQueryTemplateRequest):
    client = AnalyticsHubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_analytics_hub_service_base_transport():
    ...
    with mock.patch('google.cloud.bigquery_analyticshub_v1.services.analytics_hub_service.transports.AnalyticsHubServiceTransport.__init__') as Transport:
...
def test_analytics_hub_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery_analyticshub_v1.services.analytics_hub_service.transports.AnalyticsHubServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_analytics_hub_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery_analyticshub_v1.services.analytics_hub_service.transports.AnalyticsHubServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AnalyticsHubServiceTransport()
        adc.assert_called_once()
...
def test_order_path():
    project = "winkle"
    order = "nautilus"
    expected = "projects/{project}/orders/{order}".format(project=project, order=order, )
...
def test_query_template_path():
    ...
    expected = "projects/{project}/locations/{location}/dataExchanges/{data_exchange}/queryTemplates/{query_template}".format(project=project, location=location, data_exchange=data_exchange, query_template=query_template, )
    actual = AnalyticsHubServiceClient.query_template_path(project, location, data_exchange, query_template)
    assert expected == actual
...
def test_subscription_path():
    ...
    actual = AnalyticsHubServiceClient.subscription_path(project, location, subscription)
    assert expected == actual

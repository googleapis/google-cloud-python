...
from google.cloud.compute_v1beta.services.global_organization_operations import GlobalOrganizationOperationsClient
from google.cloud.compute_v1beta.services.global_organization_operations import pagers
from google.cloud.compute_v1beta.services.global_organization_operations import transports
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/locations/global/operations/{operation}" % client.transport._host, args[1])
...
def test_global_organization_operations_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.global_organization_operations.transports.GlobalOrganizationOperationsTransport.__init__') as Transport:
...
def test_global_organization_operations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.global_organization_operations.transports.GlobalOrganizationOperationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_global_organization_operations_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.global_organization_operations.transports.GlobalOrganizationOperationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GlobalOrganizationOperationsTransport()
        adc.assert_called_once()

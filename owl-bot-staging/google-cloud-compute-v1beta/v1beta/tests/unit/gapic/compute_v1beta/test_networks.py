...
from google.cloud.compute_v1beta.services.networks import NetworksClient
from google.cloud.compute_v1beta.services.networks import pagers
from google.cloud.compute_v1beta.services.networks import transports
...
def test_get_effective_firewalls_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/networks/{network}/getEffectiveFirewalls" % client.transport._host, args[1])
...
def test_list_peering_routes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/networks/{network}/listPeeringRoutes" % client.transport._host, args[1])
...
def test_request_remove_peering_rest_required_fields(request_type=compute.RequestRemovePeeringNetworkRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).request_remove_peering._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_request_remove_peering_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("network", "networksRequestRemovePeeringRequestResource", "project", )))
...
def test_request_remove_peering_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/networks/{network}/requestRemovePeering" % client.transport._host, args[1])
...
def test_switch_to_custom_mode_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/networks/{network}/switchToCustomMode" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/networks/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_add_peering_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'network': 'sample2'}
    request_init["networks_add_peering_request_resource"] = {'auto_create_routes': True, 'name': 'name_value', 'network_peering': {'auto_create_routes': True, 'connection_status': {'consensus_state': {'delete_status': 'delete_status_value', 'update_status': 'update_status_value'}, 'traffic_configuration': {'export_custom_routes_to_peer': True, 'export_subnet_routes_with_public_ip_to_peer': True, 'import_custom_routes_from_peer': True, 'import_subnet_routes_with_public_ip_from_peer': True, 'stack_type': 'stack_type_value'}, 'update_strategy': 'update_strategy_value'}, 'exchange_subnet_routes': True, 'export_custom_routes': True, 'export_subnet_routes_with_public_ip': True, 'import_custom_routes': True, 'import_subnet_routes_with_public_ip': True, 'name': 'name_value', 'network': 'network_value', 'peer_mtu': 865, 'stack_type': 'stack_type_value', 'state': 'state_value', 'state_details': 'state_details_value', 'update_strategy': 'update_strategy_value'}, 'peer_network': 'peer_network_value'}
...
def test_add_peering_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "post_add_peering_with_metadata") as post_with_metadata, \
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_get_effective_firewalls_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "post_get_effective_firewalls_with_metadata") as post_with_metadata, \
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_list_peering_routes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "post_list_peering_routes_with_metadata") as post_with_metadata, \
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
...
def test_remove_peering_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "post_remove_peering_with_metadata") as post_with_metadata, \
...
def test_request_remove_peering_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworksRestInterceptor, "post_request_remove_peering") as post, \
        mock.patch.object(transports.NetworksRestInterceptor, "post_request_remove_peering_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworksRestInterceptor, "pre_request_remove_peering") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.request_remove_peering(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_switch_to_custom_mode_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "post_switch_to_custom_mode_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworksRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.NetworksRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworksRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_peering_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'network': 'sample2'}
    request_init["networks_update_peering_request_resource"] = {'network_peering': {'auto_create_routes': True, 'connection_status': {'consensus_state': {'delete_status': 'delete_status_value', 'update_status': 'update_status_value'}, 'traffic_configuration': {'export_custom_routes_to_peer': True, 'export_subnet_routes_with_public_ip_to_peer': True, 'import_custom_routes_from_peer': True, 'import_subnet_routes_with_public_ip_from_peer': True, 'stack_type': 'stack_type_value'}, 'update_strategy': 'update_strategy_value'}, 'exchange_subnet_routes': True, 'export_custom_routes': True, 'export_subnet_routes_with_public_ip': True, 'import_custom_routes': True, 'import_subnet_routes_with_public_ip': True, 'name': 'name_value', 'network': 'network_value', 'peer_mtu': 865, 'stack_type': 'stack_type_value', 'state': 'state_value', 'state_details': 'state_details_value', 'update_strategy': 'update_strategy_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_peering_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "post_update_peering_with_metadata") as post_with_metadata, \
...
def test_add_peering_unary_empty_call_rest():
    ...
    with mock.patch.object(
            type(client.transport.add_peering),
            '__call__') as call:
...
def test_remove_peering_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_peering),
            '__call__') as call:
...
def test_request_remove_peering_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.request_remove_peering),
            '__call__') as call:
...
def test_switch_to_custom_mode_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.switch_to_custom_mode),
            '__call__') as call:
...
def test_update_peering_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.update_peering),
            '__call__') as call:
...
def test_networks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.networks.transports.NetworksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_networks_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.networks.transports.NetworksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NetworksTransport()
        adc.assert_called_once()

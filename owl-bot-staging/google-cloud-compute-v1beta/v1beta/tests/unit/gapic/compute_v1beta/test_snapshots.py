...
from google.cloud.compute_v1beta.services.snapshots import SnapshotsClient
from google.cloud.compute_v1beta.services.snapshots import pagers
from google.cloud.compute_v1beta.services.snapshots import transports
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListSnapshotsRequest):
    ...
    return_value = compute.SnapshotAggregatedList()
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = compute.SnapshotAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/snapshots" % client.transport._host, args[1])
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = (
            compute.SnapshotAggregatedList(
                items={
                    'a':compute.SnapshotsScopedList(),
                    'b':compute.SnapshotsScopedList(),
                    'c':compute.SnapshotsScopedList(),
                },
                next_page_token='abc',
            ),
            compute.SnapshotAggregatedList(
            ...
            compute.SnapshotAggregatedList(
                items={
                    'g':compute.SnapshotsScopedList(),
                },
                next_page_token='ghi',
            ),
            compute.SnapshotAggregatedList(
                items={
                    'h':compute.SnapshotsScopedList(),
                    'i':compute.SnapshotsScopedList(),
                },
            ),
        )
        ...
        response = tuple(compute.SnapshotAggregatedList.to_json(x) for x in response)
        ...
        assert isinstance(pager.get('a'), compute.SnapshotsScopedList)
        ...
        for result in results:
            ...
            assert tuple(type(t) for t in result) == (str, compute.SnapshotsScopedList)

        assert pager.get('a') is None
        assert isinstance(pager.get('h'), compute.SnapshotsScopedList)
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/snapshots/{snapshot}" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/snapshots/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/snapshots" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/snapshots/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/snapshots/{resource}/setLabels" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/snapshots/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListSnapshotsRequest):
    client = SnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SnapshotsRestInterceptor, "post_aggregated_list") as post, \
        mock.patch.object(transports.SnapshotsRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SnapshotsRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListSnapshotsRequest.pb(compute.AggregatedListSnapshotsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SnapshotAggregatedList.to_json(compute.SnapshotAggregatedList())
        ...
        post.return_value = compute.SnapshotAggregatedList()
        post_with_metadata.return_value = compute.SnapshotAggregatedList(), metadata
...
def test_snapshots_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.snapshots.transports.SnapshotsTransport.__init__') as Transport:
...
def test_snapshots_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.snapshots.transports.SnapshotsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_snapshots_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.snapshots.transports.SnapshotsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SnapshotsTransport()
        adc.assert_called_once()

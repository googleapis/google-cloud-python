...
from google.cloud.compute_v1beta.services.firewall_policies import FirewallPoliciesClient
from google.cloud.compute_v1beta.services.firewall_policies import pagers
from google.cloud.compute_v1beta.services.firewall_policies import transports
...
def test_add_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/addAssociation" % client.transport._host, args[1])
...
def test_add_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/addPacketMirroringRule" % client.transport._host, args[1])
...
def test_clone_rules_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/cloneRules" % client.transport._host, args[1])
...
def test_get_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/getAssociation" % client.transport._host, args[1])
...
def test_get_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/getPacketMirroringRule" % client.transport._host, args[1])
...
def test_patch_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/patchPacketMirroringRule" % client.transport._host, args[1])
...
def test_patch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/patchRule" % client.transport._host, args[1])
...
def test_remove_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/removeAssociation" % client.transport._host, args[1])
...
def test_remove_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/removePacketMirroringRule" % client.transport._host, args[1])
...
def test_remove_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/removeRule" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_add_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_add_packet_mirroring_rule") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_add_packet_mirroring_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_add_packet_mirroring_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_packet_mirroring_rule") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_packet_mirroring_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_get_packet_mirroring_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_patch_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_patch_packet_mirroring_rule") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_patch_packet_mirroring_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_patch_packet_mirroring_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_remove_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_remove_packet_mirroring_rule") as post, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_remove_packet_mirroring_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_remove_packet_mirroring_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_firewall_policies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.firewall_policies.transports.FirewallPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_firewall_policies_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.firewall_policies.transports.FirewallPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.FirewallPoliciesTransport()
        adc.assert_called_once()

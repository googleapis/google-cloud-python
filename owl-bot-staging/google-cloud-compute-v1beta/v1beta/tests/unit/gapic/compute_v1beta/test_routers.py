...
from google.cloud.compute_v1beta.services.routers import RoutersClient
from google.cloud.compute_v1beta.services.routers import pagers
from google.cloud.compute_v1beta.services.routers import transports
...
def test_delete_route_policy_rest_required_fields(request_type=compute.DeleteRoutePolicyRouterRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_route_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_route_policy._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("policy", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_delete_route_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("policy", "requestId", )) & set(("project", "region", "router", )))
...
def test_delete_route_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/deleteRoutePolicy" % client.transport._host, args[1])
...
def test_get_nat_ip_info_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("natName", )) & set(("project", "region", "router", )))
...
def test_get_nat_ip_info_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/getNatIpInfo" % client.transport._host, args[1])
...
def test_get_nat_mapping_info_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/getNatMappingInfo" % client.transport._host, args[1])
...
def test_get_route_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("policy", )) & set(("project", "region", "router", )))
...
def test_get_route_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/getRoutePolicy" % client.transport._host, args[1])
...
def test_get_router_status_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/getRouterStatus" % client.transport._host, args[1])
...
def test_list_bgp_routes_rest_required_fields(request_type=compute.ListBgpRoutesRoutersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_bgp_routes._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("address_family", "destination_prefix", "filter", "max_results", "order_by", "page_token", "peer", "policy_applied", "return_partial_success", "route_type", ))
    jsonified_request.update(unset_fields)
...
def test_list_bgp_routes_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("addressFamily", "destinationPrefix", "filter", "maxResults", "orderBy", "pageToken", "peer", "policyApplied", "returnPartialSuccess", "routeType", )) & set(("project", "region", "router", )))
...
def test_list_bgp_routes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/listBgpRoutes" % client.transport._host, args[1])
...
def test_list_bgp_routes_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.BgpRoute)
                for i in results)
...
def test_list_route_policies_rest_required_fields(request_type=compute.ListRoutePoliciesRoutersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_route_policies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_route_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/listRoutePolicies" % client.transport._host, args[1])
...
def test_list_route_policies_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.RoutePolicy)
                for i in results)
...
def test_patch_route_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "region", "routePolicyResource", "router", )))
...
def test_patch_route_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/patchRoutePolicy" % client.transport._host, args[1])
...
def test_preview_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/preview" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_update_route_policy_rest_required_fields(request_type=compute.UpdateRoutePolicyRouterRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_route_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_route_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/updateRoutePolicy" % client.transport._host, args[1])
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RoutersRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RoutersRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_delete_route_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_delete_route_policy") as post, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_delete_route_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RoutersRestInterceptor, "pre_delete_route_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_route_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RoutersRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_get_nat_ip_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_get_nat_ip_info") as post, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_get_nat_ip_info_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RoutersRestInterceptor, "pre_get_nat_ip_info") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_nat_ip_info(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_nat_mapping_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RoutersRestInterceptor, "post_get_nat_mapping_info_with_metadata") as post_with_metadata, \
...
def test_get_route_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_get_route_policy") as post, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_get_route_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RoutersRestInterceptor, "pre_get_route_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_route_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_router_status_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RoutersRestInterceptor, "post_get_router_status_with_metadata") as post_with_metadata, \
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RoutersRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RoutersRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_list_bgp_routes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_list_bgp_routes") as post, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_list_bgp_routes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RoutersRestInterceptor, "pre_list_bgp_routes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_bgp_routes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_route_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_list_route_policies") as post, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_list_route_policies_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RoutersRestInterceptor, "pre_list_route_policies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_route_policies(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RoutersRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
...
def test_patch_route_policy_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'router': 'sample3'}
    request_init["route_policy_resource"] = {'description': 'description_value', 'fingerprint': 'fingerprint_value', 'name': 'name_value', 'terms': [{'actions': [{'description': 'description_value', 'expression': 'expression_value', 'location': 'location_value', 'title': 'title_value'}], 'match': {}, 'priority': 898}], 'type_': 'type__value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_patch_route_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_patch_route_policy") as post, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_patch_route_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RoutersRestInterceptor, "pre_patch_route_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.patch_route_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_preview_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RoutersRestInterceptor, "post_preview_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RoutersRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RoutersRestInterceptor, "post_update_with_metadata") as post_with_metadata, \
...
def test_update_route_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_update_route_policy") as post, \
        mock.patch.object(transports.RoutersRestInterceptor, "post_update_route_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RoutersRestInterceptor, "pre_update_route_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_route_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_route_policy_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_route_policy),
            '__call__') as call:
...
def test_get_nat_ip_info_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.get_nat_ip_info),
            '__call__') as call:
...
def test_get_nat_mapping_info_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.get_nat_mapping_info),
            '__call__') as call:
...
def test_get_route_policy_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.get_route_policy),
            '__call__') as call:
...
def test_get_router_status_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.get_router_status),
            '__call__') as call:
...
def test_list_bgp_routes_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_bgp_routes),
            '__call__') as call:
...
def test_list_route_policies_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_route_policies),
            '__call__') as call:
...
def test_patch_route_policy_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.patch_route_policy),
            '__call__') as call:
...
def test_update_route_policy_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.update_route_policy),
            '__call__') as call:
...
def test_routers_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.routers.transports.RoutersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_routers_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.routers.transports.RoutersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RoutersTransport()
        adc.assert_called_once()

...
from google.cloud.compute_v1beta.services.disks import DisksClient
from google.cloud.compute_v1beta.services.disks import pagers
from google.cloud.compute_v1beta.services.disks import transports
...
def test_add_resource_policies_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("disk", "disksAddResourcePoliciesRequestResource", "project", "zone", )))
...
def test_add_resource_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/addResourcePolicies" % client.transport._host, args[1])
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/disks" % client.transport._host, args[1])
...
def test_bulk_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("bulkInsertDiskResourceResource", "project", "zone", )))
...
def test_bulk_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/bulkInsert" % client.transport._host, args[1])
...
def test_bulk_set_labels_rest_required_fields(request_type=compute.BulkSetLabelsDiskRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).bulk_set_labels._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("request_id", "resource", ))
    jsonified_request.update(unset_fields)
...
def test_bulk_set_labels_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "resource", )) & set(("bulkZoneSetLabelsRequestResource", "project", "zone", )))
...
def test_bulk_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            zone='zone_value',
            bulk_zone_set_labels_request_resource=compute.BulkZoneSetLabelsRequest(requests=[compute.BulkSetLabelsRequest(label_fingerprint='label_fingerprint_value')]),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/bulkSetLabels" % client.transport._host, args[1])
...
def test_create_snapshot_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("guestFlush", "requestId", )) & set(("disk", "project", "snapshotResource", "zone", )))
...
def test_create_snapshot_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/createSnapshot" % client.transport._host, args[1])
...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("disk", "project", "zone", )))
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/{disk}" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "sourceImage", )) & set(("diskResource", "project", "zone", )))
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks" % client.transport._host, args[1])
...
def test_remove_resource_policies_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("disk", "disksRemoveResourcePoliciesRequestResource", "project", "zone", )))
...
def test_remove_resource_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/removeResourcePolicies" % client.transport._host, args[1])
...
def test_resize_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("disk", "disksResizeRequestResource", "project", "zone", )))
...
def test_resize_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/resize" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_set_labels_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "resource", "zone", "zoneSetLabelsRequestResource", )))
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/{resource}/setLabels" % client.transport._host, args[1])
...
def test_start_async_replication_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("disk", "disksStartAsyncReplicationRequestResource", "project", "zone", )))
...
def test_start_async_replication_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            zone='zone_value',
            disk='disk_value',
            disks_start_async_replication_request_resource=compute.DisksStartAsyncReplicationRequest(async_secondary_disk='async_secondary_disk_value'),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/startAsyncReplication" % client.transport._host, args[1])
...
def test_stop_async_replication_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/stopAsyncReplication" % client.transport._host, args[1])
...
def test_stop_group_async_replication_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("disksStopGroupAsyncReplicationResourceResource", "project", "zone", )))
...
def test_stop_group_async_replication_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/stopGroupAsyncReplication" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/disks/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_update_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("paths", "requestId", "updateMask", )) & set(("disk", "diskResource", "project", "zone", )))
...
def test_add_resource_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DisksRestInterceptor, "post_add_resource_policies") as post, \
        mock.patch.object(transports.DisksRestInterceptor, "post_add_resource_policies_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DisksRestInterceptor, "pre_add_resource_policies") as pre:
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DisksRestInterceptor, "post_aggregated_list") as post, \
        mock.patch.object(transports.DisksRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DisksRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_bulk_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DisksRestInterceptor, "post_bulk_insert_with_metadata") as post_with_metadata, \
...
def test_bulk_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DisksRestInterceptor, "post_bulk_set_labels") as post, \
        mock.patch.object(transports.DisksRestInterceptor, "post_bulk_set_labels_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DisksRestInterceptor, "pre_bulk_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.bulk_set_labels(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DisksRestInterceptor, "post_create_snapshot") as post, \
        mock.patch.object(transports.DisksRestInterceptor, "post_create_snapshot_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DisksRestInterceptor, "pre_create_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DisksRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DisksRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DisksRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.DisksRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DisksRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DisksRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_remove_resource_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DisksRestInterceptor, "post_remove_resource_policies") as post, \
        mock.patch.object(transports.DisksRestInterceptor, "post_remove_resource_policies_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DisksRestInterceptor, "pre_remove_resource_policies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_resize_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DisksRestInterceptor, "post_resize_with_metadata") as post_with_metadata, \
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DisksRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.DisksRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DisksRestInterceptor, "post_set_labels_with_metadata") as post_with_metadata, \
...
def test_start_async_replication_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DisksRestInterceptor, "post_start_async_replication") as post, \
        mock.patch.object(transports.DisksRestInterceptor, "post_start_async_replication_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DisksRestInterceptor, "pre_start_async_replication") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_stop_async_replication_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DisksRestInterceptor, "post_stop_async_replication") as post, \
        mock.patch.object(transports.DisksRestInterceptor, "post_stop_async_replication_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DisksRestInterceptor, "pre_stop_async_replication") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_stop_group_async_replication_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DisksRestInterceptor, "post_stop_group_async_replication") as post, \
        mock.patch.object(transports.DisksRestInterceptor, "post_stop_group_async_replication_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DisksRestInterceptor, "pre_stop_group_async_replication") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DisksRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.DisksRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DisksRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DisksRestInterceptor, "post_update_with_metadata") as post_with_metadata, \
...
def test_bulk_set_labels_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.bulk_set_labels),
            '__call__') as call:
...
def test_disks_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.disks.transports.DisksTransport.__init__') as Transport:
...
def test_disks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.disks.transports.DisksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_disks_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.disks.transports.DisksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DisksTransport()
        adc.assert_called_once()

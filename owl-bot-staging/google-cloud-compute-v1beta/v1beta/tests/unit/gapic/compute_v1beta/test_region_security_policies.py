...
from google.cloud.compute_v1beta.services.region_security_policies import RegionSecurityPoliciesClient
from google.cloud.compute_v1beta.services.region_security_policies import pagers
from google.cloud.compute_v1beta.services.region_security_policies import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert RegionSecurityPoliciesClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert RegionSecurityPoliciesClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert RegionSecurityPoliciesClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert RegionSecurityPoliciesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert RegionSecurityPoliciesClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert RegionSecurityPoliciesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert RegionSecurityPoliciesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert RegionSecurityPoliciesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert RegionSecurityPoliciesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert RegionSecurityPoliciesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert RegionSecurityPoliciesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RegionSecurityPoliciesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert RegionSecurityPoliciesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RegionSecurityPoliciesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(RegionSecurityPoliciesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionSecurityPoliciesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionSecurityPoliciesClient._DEFAULT_UNIVERSE
    default_endpoint = RegionSecurityPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RegionSecurityPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RegionSecurityPoliciesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert RegionSecurityPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RegionSecurityPoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionSecurityPoliciesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RegionSecurityPoliciesClient._get_api_endpoint(None, None, default_universe, "always") == RegionSecurityPoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionSecurityPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RegionSecurityPoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionSecurityPoliciesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RegionSecurityPoliciesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RegionSecurityPoliciesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RegionSecurityPoliciesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RegionSecurityPoliciesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert RegionSecurityPoliciesClient._get_universe_domain(None, None) == RegionSecurityPoliciesClient._DEFAULT_UNIVERSE
...
def test_region_security_policies_client_from_service_account_info(client_class, transport_name):
...
def test_region_security_policies_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_region_security_policies_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (RegionSecurityPoliciesClient, transports.RegionSecurityPoliciesRestTransport, "rest"),
])
@mock.patch.object(RegionSecurityPoliciesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionSecurityPoliciesClient))
def test_region_security_policies_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (RegionSecurityPoliciesClient, transports.RegionSecurityPoliciesRestTransport, "rest", "true"),
    (RegionSecurityPoliciesClient, transports.RegionSecurityPoliciesRestTransport, "rest", "false"),
])
@mock.patch.object(RegionSecurityPoliciesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionSecurityPoliciesClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_region_security_policies_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(RegionSecurityPoliciesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RegionSecurityPoliciesClient))
def test_region_security_policies_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_region_security_policies_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (RegionSecurityPoliciesClient, transports.RegionSecurityPoliciesRestTransport, "rest", None),
])
def test_region_security_policies_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_add_rule_rest_required_fields(request_type=compute.AddRuleRegionSecurityPolicyRequest):
...
def test_add_rule_rest_unset_required_fields():
    transport = transports.RegionSecurityPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.add_rule._get_unset_required_fields({})
    assert set(unset_fields) == (set(("validateOnly", )) & set(("project", "region", "securityPolicy", "securityPolicyRuleResource", )))
...
def test_add_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'project': 'sample1', 'region': 'sample2', 'security_policy': 'sample3'}
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/securityPolicies/{security_policy}/addRule" % client.transport._host, args[1])
...
def test_add_rule_unary_rest_required_fields(request_type=compute.AddRuleRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_delete_rest_required_fields(request_type=compute.DeleteRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "region", "securityPolicy", )))
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/securityPolicies/{security_policy}" % client.transport._host, args[1])
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("project", "region", "securityPolicy", )))
...
def test_get_rule_rest_required_fields(request_type=compute.GetRuleRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_get_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("priority", )) & set(("project", "region", "securityPolicy", )))
...
def test_get_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/securityPolicies/{security_policy}/getRule" % client.transport._host, args[1])
...
def test_insert_rest_required_fields(request_type=compute.InsertRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "validateOnly", )) & set(("project", "region", "securityPolicyResource", )))
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/securityPolicies" % client.transport._host, args[1])
...
def test_insert_unary_rest_required_fields(request_type=compute.InsertRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_list_rest_required_fields(request_type=compute.ListRegionSecurityPoliciesRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_patch_rest_required_fields(request_type=compute.PatchRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("project", "region", "securityPolicy", "securityPolicyResource", )))
...
def test_patch_unary_rest_required_fields(request_type=compute.PatchRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_patch_rule_rest_required_fields(request_type=compute.PatchRuleRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_patch_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("priority", "updateMask", "validateOnly", )) & set(("project", "region", "securityPolicy", "securityPolicyRuleResource", )))
...
def test_patch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/securityPolicies/{security_policy}/patchRule" % client.transport._host, args[1])
...
def test_patch_rule_unary_rest_required_fields(request_type=compute.PatchRuleRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_remove_rule_rest_required_fields(request_type=compute.RemoveRuleRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_remove_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/securityPolicies/{security_policy}/removeRule" % client.transport._host, args[1])
...
def test_remove_rule_unary_rest_required_fields(request_type=compute.RemoveRuleRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_set_labels_rest_required_fields(request_type=compute.SetLabelsRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/securityPolicies/{resource}/setLabels" % client.transport._host, args[1])
...
def test_set_labels_unary_rest_required_fields(request_type=compute.SetLabelsRegionSecurityPolicyRequest):
    transport_class = transports.RegionSecurityPoliciesRestTransport
...
def test_add_rule_rest_bad_request(request_type=compute.AddRuleRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'security_policy': 'sample3'}
    request = request_type(**request_init)
...
def test_add_rule_rest_call_success(request_type):
    ...
    test_field = compute.AddRuleRegionSecurityPolicyRequest.meta.fields["security_policy_rule_resource"]
...
def test_add_rule_rest_interceptors(null_interceptor):
    transport = transports.RegionSecurityPoliciesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RegionSecurityPoliciesRestInterceptor(),
        )
    client = RegionSecurityPoliciesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_add_rule") as post, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_add_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "pre_add_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AddRuleRegionSecurityPolicyRequest.pb(compute.AddRuleRegionSecurityPolicyRequest())
...
def test_delete_rest_bad_request(request_type=compute.DeleteRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteRegionSecurityPolicyRequest.pb(compute.DeleteRegionSecurityPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRegionSecurityPolicyRequest.pb(compute.GetRegionSecurityPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_rule_rest_bad_request(request_type=compute.GetRuleRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_get_rule") as post, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_get_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "pre_get_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRuleRegionSecurityPolicyRequest.pb(compute.GetRuleRegionSecurityPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_insert_rest_bad_request(request_type=compute.InsertRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.InsertRegionSecurityPolicyRequest.meta.fields["security_policy_resource"]
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertRegionSecurityPolicyRequest.pb(compute.InsertRegionSecurityPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListRegionSecurityPoliciesRequest.pb(compute.ListRegionSecurityPoliciesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchRegionSecurityPolicyRequest.meta.fields["security_policy_resource"]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchRegionSecurityPolicyRequest.pb(compute.PatchRegionSecurityPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_patch_rule_rest_bad_request(request_type=compute.PatchRuleRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_patch_rule_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchRuleRegionSecurityPolicyRequest.meta.fields["security_policy_rule_resource"]
...
def test_patch_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_patch_rule") as post, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_patch_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "pre_patch_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchRuleRegionSecurityPolicyRequest.pb(compute.PatchRuleRegionSecurityPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_remove_rule_rest_bad_request(request_type=compute.RemoveRuleRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_remove_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_remove_rule") as post, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_remove_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "pre_remove_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.RemoveRuleRegionSecurityPolicyRequest.pb(compute.RemoveRuleRegionSecurityPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_set_labels_rest_bad_request(request_type=compute.SetLabelsRegionSecurityPolicyRequest):
    client = RegionSecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsRegionSecurityPolicyRequest.meta.fields["region_set_labels_request_resource"]
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_set_labels") as post, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "post_set_labels_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionSecurityPoliciesRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetLabelsRegionSecurityPolicyRequest.pb(compute.SetLabelsRegionSecurityPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_region_security_policies_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.region_security_policies.transports.RegionSecurityPoliciesTransport.__init__') as Transport:
...
def test_region_security_policies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.region_security_policies.transports.RegionSecurityPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_security_policies_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.region_security_policies.transports.RegionSecurityPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegionSecurityPoliciesTransport()
        adc.assert_called_once()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.RegionSecurityPoliciesTransport, '_prep_wrapped_messages') as prep:
        client = RegionSecurityPoliciesClient(
            credentials=ga_credentials.AnonymousCredentials(),

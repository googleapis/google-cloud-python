...
from google.cloud.compute_v1beta.services.public_delegated_prefixes import PublicDelegatedPrefixesClient
from google.cloud.compute_v1beta.services.public_delegated_prefixes import pagers
from google.cloud.compute_v1beta.services.public_delegated_prefixes import transports
...
def test_announce_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}/announce" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}" % client.transport._host, args[1])
...
def test_withdraw_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}/withdraw" % client.transport._host, args[1])
...
def test_public_delegated_prefixes_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.public_delegated_prefixes.transports.PublicDelegatedPrefixesTransport.__init__') as Transport:
...
def test_public_delegated_prefixes_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.public_delegated_prefixes.transports.PublicDelegatedPrefixesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_public_delegated_prefixes_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.public_delegated_prefixes.transports.PublicDelegatedPrefixesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PublicDelegatedPrefixesTransport()
        adc.assert_called_once()

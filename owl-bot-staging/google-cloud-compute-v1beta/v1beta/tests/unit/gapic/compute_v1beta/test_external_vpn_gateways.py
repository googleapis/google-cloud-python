...
from google.cloud.compute_v1beta.services.external_vpn_gateways import ExternalVpnGatewaysClient
from google.cloud.compute_v1beta.services.external_vpn_gateways import pagers
from google.cloud.compute_v1beta.services.external_vpn_gateways import transports
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/global/externalVpnGateways/{external_vpn_gateway}" % client.transport._host, args[1])
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/externalVpnGateways/{resource}/setLabels" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/externalVpnGateways/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_external_vpn_gateways_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.external_vpn_gateways.transports.ExternalVpnGatewaysTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_external_vpn_gateways_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.external_vpn_gateways.transports.ExternalVpnGatewaysTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ExternalVpnGatewaysTransport()
        adc.assert_called_once()

...
from google.cloud.compute_v1beta.services.organization_security_policies import OrganizationSecurityPoliciesClient
from google.cloud.compute_v1beta.services.organization_security_policies import pagers
from google.cloud.compute_v1beta.services.organization_security_policies import transports
...
@mock.patch.object(OrganizationSecurityPoliciesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OrganizationSecurityPoliciesClient))
def test__get_api_endpoint():
    ...
    assert OrganizationSecurityPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == OrganizationSecurityPoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert OrganizationSecurityPoliciesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert OrganizationSecurityPoliciesClient._get_api_endpoint(None, None, default_universe, "always") == OrganizationSecurityPoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert OrganizationSecurityPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == OrganizationSecurityPoliciesClient.DEFAULT_MTLS_ENDPOINT
...
def test_add_association_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("replaceExistingAssociation", "requestId", )) & set(("securityPolicy", "securityPolicyAssociationResource", )))
...
def test_add_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/locations/global/securityPolicies/{security_policy}/addAssociation" % client.transport._host, args[1])
...
def test_add_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("securityPolicy", "securityPolicyRuleResource", )))
...
def test_copy_rules_rest_required_fields(request_type=compute.CopyRulesOrganizationSecurityPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).copy_rules._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("request_id", "source_security_policy", ))
    jsonified_request.update(unset_fields)
...
def test_copy_rules_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "sourceSecurityPolicy", )) & set(("securityPolicy", )))
...
def test_copy_rules_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/securityPolicies/{security_policy}/copyRules" % client.transport._host, args[1])
...
def test_get_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/securityPolicies/{security_policy}/getAssociation" % client.transport._host, args[1])
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("parentId", "requestId", )) & set(("securityPolicyResource", )))
...
def test_move_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("parentId", "requestId", )) & set(("securityPolicy", )))
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("securityPolicy", "securityPolicyResource", )))
...
def test_patch_rule_rest_required_fields(request_type=compute.PatchRuleOrganizationSecurityPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).patch_rule._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("priority", "request_id", "update_mask", ))
    jsonified_request.update(unset_fields)
...
def test_patch_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("priority", "requestId", "updateMask", )) & set(("securityPolicy", "securityPolicyRuleResource", )))
...
def test_patch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/securityPolicies/{security_policy}/patchRule" % client.transport._host, args[1])
...
def test_remove_association_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("name", "requestId", )) & set(("securityPolicy", )))
...
def test_remove_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/securityPolicies/{security_policy}/removeAssociation" % client.transport._host, args[1])
...
def test_remove_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/securityPolicies/{security_policy}/removeRule" % client.transport._host, args[1])
...
def test_add_association_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'security_policy': 'sample1'}
    request_init["security_policy_association_resource"] = {'attachment_id': 'attachment_id_value', 'display_name': 'display_name_value', 'excluded_folders': ['excluded_folders_value1', 'excluded_folders_value2'], 'excluded_projects': ['excluded_projects_value1', 'excluded_projects_value2'], 'name': 'name_value', 'security_policy_id': 'security_policy_id_value', 'short_name': 'short_name_value'}
...
def test_add_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_add_association") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_add_association_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_add_association") as pre:
...
def test_add_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_add_rule") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_add_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_add_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_copy_rules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_copy_rules") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_copy_rules_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_copy_rules") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.copy_rules(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_get_association") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_get_association_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_get_association") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_get_rule") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_get_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_get_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_associations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_list_associations") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_list_associations_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_list_associations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.OrganizationSecurityPoliciesListAssociationsResponse.to_json(compute.OrganizationSecurityPoliciesListAssociationsResponse())
        req.return_value.content = return_value
...
def test_list_preconfigured_expression_sets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_list_preconfigured_expression_sets") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_list_preconfigured_expression_sets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_list_preconfigured_expression_sets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListPreconfiguredExpressionSetsOrganizationSecurityPoliciesRequest.pb(compute.ListPreconfiguredExpressionSetsOrganizationSecurityPoliciesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_move_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_move") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_move_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_move") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_patch_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_patch_rule") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_patch_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_patch_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_remove_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_remove_association") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_remove_association_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_remove_association") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_remove_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_remove_rule") as post, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "post_remove_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationSecurityPoliciesRestInterceptor, "pre_remove_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_copy_rules_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.copy_rules),
            '__call__') as call:
...
def test_organization_security_policies_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.organization_security_policies.transports.OrganizationSecurityPoliciesTransport.__init__') as Transport:
...
def test_organization_security_policies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.organization_security_policies.transports.OrganizationSecurityPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_organization_security_policies_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.organization_security_policies.transports.OrganizationSecurityPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.OrganizationSecurityPoliciesTransport()
        adc.assert_called_once()

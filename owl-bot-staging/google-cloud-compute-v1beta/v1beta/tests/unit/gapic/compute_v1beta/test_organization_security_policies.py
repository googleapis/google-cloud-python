...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("securityPolicy", "securityPolicyResource", )))
...
def test_patch_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("priority", "requestId", )) & set(("securityPolicy", "securityPolicyRuleResource", )))

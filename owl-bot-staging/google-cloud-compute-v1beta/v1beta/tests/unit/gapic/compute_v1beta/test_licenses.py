...
from google.cloud.compute_v1beta.services.licenses import LicensesClient
from google.cloud.compute_v1beta.services.licenses import pagers
from google.cloud.compute_v1beta.services.licenses import transports
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/licenses/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_update_rest_required_fields(request_type=compute.UpdateLicenseRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("license_", "request_id", "update_mask", ))
    jsonified_request.update(unset_fields)
...
def test_update_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("license", "requestId", "updateMask", )) & set(("license", "licenseResource", "project", )))
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicensesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicensesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicensesRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
...
def test_insert_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1'}
    request_init["license_resource"] = {'allowed_replacement_licenses': ['allowed_replacement_licenses_value1', 'allowed_replacement_licenses_value2'], 'appendable_to_disk': True, 'charges_use_fee': True, 'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'id': 205, 'incompatible_licenses': ['incompatible_licenses_value1', 'incompatible_licenses_value2'], 'kind': 'kind_value', 'license_code': 1245, 'minimum_retention': {'nanos': 543, 'seconds': 751}, 'multi_tenant_only': True, 'name': 'name_value', 'os_license': True, 'removable_from_disk': True, 'required_coattached_licenses': ['required_coattached_licenses_value1', 'required_coattached_licenses_value2'], 'resource_requirements': {'min_guest_cpu_count': 2042, 'min_memory_mb': 1386}, 'self_link': 'self_link_value', 'self_link_with_id': 'self_link_with_id_value', 'sole_tenant_only': True, 'transferable': True, 'update_timestamp': 'update_timestamp_value'}
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicensesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicensesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicensesRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicensesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicensesRestInterceptor, "post_update_with_metadata") as post_with_metadata, \
...
def test_licenses_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.licenses.transports.LicensesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_licenses_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.licenses.transports.LicensesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.LicensesTransport()
        adc.assert_called_once()

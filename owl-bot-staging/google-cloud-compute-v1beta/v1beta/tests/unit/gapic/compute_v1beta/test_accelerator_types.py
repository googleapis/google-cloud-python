...
from google.cloud.compute_v1beta.services.accelerator_types import AcceleratorTypesClient
from google.cloud.compute_v1beta.services.accelerator_types import pagers
from google.cloud.compute_v1beta.services.accelerator_types import transports
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/acceleratorTypes" % client.transport._host, args[1])
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/acceleratorTypes/{accelerator_type}" % client.transport._host, args[1])
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/acceleratorTypes" % client.transport._host, args[1])
...
def test_accelerator_types_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.accelerator_types.transports.AcceleratorTypesTransport.__init__') as Transport:
...
def test_accelerator_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.accelerator_types.transports.AcceleratorTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_accelerator_types_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.accelerator_types.transports.AcceleratorTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AcceleratorTypesTransport()
        adc.assert_called_once()

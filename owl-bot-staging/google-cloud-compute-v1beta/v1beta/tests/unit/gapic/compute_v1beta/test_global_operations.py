...
from google.cloud.compute_v1beta.services.global_operations import GlobalOperationsClient
from google.cloud.compute_v1beta.services.global_operations import pagers
from google.cloud.compute_v1beta.services.global_operations import transports
...
def test__get_api_endpoint():
    ...
    assert GlobalOperationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == GlobalOperationsClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert GlobalOperationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == GlobalOperationsClient.DEFAULT_MTLS_ENDPOINT
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/operations" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/operations/{operation}" % client.transport._host, args[1])
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/operations" % client.transport._host, args[1])
...
def test_wait_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/operations/{operation}/wait" % client.transport._host, args[1])
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_wait_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_wait_with_metadata") as post_with_metadata, \
...
def test_global_operations_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.global_operations.transports.GlobalOperationsTransport.__init__') as Transport:
...
def test_global_operations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.global_operations.transports.GlobalOperationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_global_operations_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.global_operations.transports.GlobalOperationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GlobalOperationsTransport()
        adc.assert_called_once()

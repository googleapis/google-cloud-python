...
from google.cloud.compute_v1beta.services.network_firewall_policies import NetworkFirewallPoliciesClient
from google.cloud.compute_v1beta.services.network_firewall_policies import pagers
from google.cloud.compute_v1beta.services.network_firewall_policies import transports
...
def test__get_api_endpoint():
    ...
    assert NetworkFirewallPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == NetworkFirewallPoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert NetworkFirewallPoliciesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert NetworkFirewallPoliciesClient._get_api_endpoint(None, None, default_universe, "always") == NetworkFirewallPoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert NetworkFirewallPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == NetworkFirewallPoliciesClient.DEFAULT_MTLS_ENDPOINT
...
def test_add_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/addAssociation" % client.transport._host, args[1])
...
def test_add_packet_mirroring_rule_rest_required_fields(request_type=compute.AddPacketMirroringRuleNetworkFirewallPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).add_packet_mirroring_rule._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_add_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/addPacketMirroringRule" % client.transport._host, args[1])
...
def test_add_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/addRule" % client.transport._host, args[1])
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/firewallPolicies" % client.transport._host, args[1])
...
def test_clone_rules_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/cloneRules" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}" % client.transport._host, args[1])
...
def test_get_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/getAssociation" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_get_packet_mirroring_rule_rest_required_fields(request_type=compute.GetPacketMirroringRuleNetworkFirewallPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_packet_mirroring_rule._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/getPacketMirroringRule" % client.transport._host, args[1])
...
def test_get_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/getRule" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies" % client.transport._host, args[1])
...
def test_patch_packet_mirroring_rule_rest_required_fields(request_type=compute.PatchPacketMirroringRuleNetworkFirewallPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).patch_packet_mirroring_rule._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_patch_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/patchPacketMirroringRule" % client.transport._host, args[1])
...
def test_patch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/patchRule" % client.transport._host, args[1])
...
def test_remove_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/removeAssociation" % client.transport._host, args[1])
...
def test_remove_packet_mirroring_rule_rest_required_fields(request_type=compute.RemovePacketMirroringRuleNetworkFirewallPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).remove_packet_mirroring_rule._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/removePacketMirroringRule" % client.transport._host, args[1])
...
def test_remove_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{firewall_policy}/removeRule" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/firewallPolicies/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_add_association_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'firewall_policy': 'sample2'}
    request_init["firewall_policy_association_resource"] = {'attachment_target': 'attachment_target_value', 'display_name': 'display_name_value', 'firewall_policy_id': 'firewall_policy_id_value', 'name': 'name_value', 'priority': 898, 'short_name': 'short_name_value'}
...
def test_add_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_add_association_with_metadata") as post_with_metadata, \
...
def test_add_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_add_packet_mirroring_rule") as post, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_add_packet_mirroring_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_add_packet_mirroring_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.add_packet_mirroring_rule(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_add_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_add_rule_with_metadata") as post_with_metadata, \
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_aggregated_list") as post, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_clone_rules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_clone_rules_with_metadata") as post_with_metadata, \
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_get_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_get_association_with_metadata") as post_with_metadata, \
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
...
def test_get_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_get_packet_mirroring_rule") as post, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_get_packet_mirroring_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_get_packet_mirroring_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_packet_mirroring_rule(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_get_rule_with_metadata") as post_with_metadata, \
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
...
def test_patch_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_patch_packet_mirroring_rule") as post, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_patch_packet_mirroring_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_patch_packet_mirroring_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.patch_packet_mirroring_rule(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_patch_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_patch_rule_with_metadata") as post_with_metadata, \
...
def test_remove_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_remove_association_with_metadata") as post_with_metadata, \
...
def test_remove_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_remove_packet_mirroring_rule") as post, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_remove_packet_mirroring_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_remove_packet_mirroring_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.remove_packet_mirroring_rule(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_remove_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_remove_rule_with_metadata") as post_with_metadata, \
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
...
def test_add_packet_mirroring_rule_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.add_packet_mirroring_rule),
            '__call__') as call:
...
def test_get_packet_mirroring_rule_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.get_packet_mirroring_rule),
            '__call__') as call:
...
def test_patch_packet_mirroring_rule_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.patch_packet_mirroring_rule),
            '__call__') as call:
...
def test_remove_packet_mirroring_rule_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_packet_mirroring_rule),
            '__call__') as call:
...
def test_network_firewall_policies_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.network_firewall_policies.transports.NetworkFirewallPoliciesTransport.__init__') as Transport:
...
def test_network_firewall_policies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.network_firewall_policies.transports.NetworkFirewallPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_network_firewall_policies_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.network_firewall_policies.transports.NetworkFirewallPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NetworkFirewallPoliciesTransport()
        adc.assert_called_once()

...
def test_add_packet_mirroring_rule_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'firewall_policy': 'sample2'}
    request_init["firewall_policy_rule_resource"] = {'action': 'action_value', 'description': 'description_value', 'direction': 'direction_value', 'disabled': True, 'enable_logging': True, 'kind': 'kind_value', 'match': {'dest_address_groups': ['dest_address_groups_value1', 'dest_address_groups_value2'], 'dest_fqdns': ['dest_fqdns_value1', 'dest_fqdns_value2'], 'dest_ip_ranges': ['dest_ip_ranges_value1', 'dest_ip_ranges_value2'], 'dest_network_scope': 'dest_network_scope_value', 'dest_region_codes': ['dest_region_codes_value1', 'dest_region_codes_value2'], 'dest_threat_intelligences': ['dest_threat_intelligences_value1', 'dest_threat_intelligences_value2'], 'layer4_configs': [{'ip_protocol': 'ip_protocol_value', 'ports': ['ports_value1', 'ports_value2']}], 'src_address_groups': ['src_address_groups_value1', 'src_address_groups_value2'], 'src_fqdns': ['src_fqdns_value1', 'src_fqdns_value2'], 'src_ip_ranges': ['src_ip_ranges_value1', 'src_ip_ranges_value2'], 'src_network_scope': 'src_network_scope_value', 'src_networks': ['src_networks_value1', 'src_networks_value2'], 'src_region_codes': ['src_region_codes_value1', 'src_region_codes_value2'], 'src_secure_tags': [{'name': 'name_value', 'state': 'state_value'}], 'src_threat_intelligences': ['src_threat_intelligences_value1', 'src_threat_intelligences_value2']}, 'priority': 898, 'rule_name': 'rule_name_value', 'rule_tuple_count': 1737, 'security_profile_group': 'security_profile_group_value', 'target_resources': ['target_resources_value1', 'target_resources_value2'], 'target_secure_tags': {}, 'target_service_accounts': ['target_service_accounts_value1', 'target_service_accounts_value2'], 'tls_inspect': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

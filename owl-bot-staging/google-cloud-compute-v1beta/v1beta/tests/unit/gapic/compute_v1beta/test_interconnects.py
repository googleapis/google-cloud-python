...
from google.cloud.compute_v1beta.services.interconnects import InterconnectsClient
from google.cloud.compute_v1beta.services.interconnects import pagers
from google.cloud.compute_v1beta.services.interconnects import transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert InterconnectsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert InterconnectsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert InterconnectsClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert InterconnectsClient._get_client_cert_source(None, False) is None
    assert InterconnectsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert InterconnectsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert InterconnectsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert InterconnectsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(InterconnectsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(InterconnectsClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = InterconnectsClient._DEFAULT_UNIVERSE
    default_endpoint = InterconnectsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = InterconnectsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert InterconnectsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert InterconnectsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == InterconnectsClient.DEFAULT_MTLS_ENDPOINT
    assert InterconnectsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert InterconnectsClient._get_api_endpoint(None, None, default_universe, "always") == InterconnectsClient.DEFAULT_MTLS_ENDPOINT
    assert InterconnectsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == InterconnectsClient.DEFAULT_MTLS_ENDPOINT
    assert InterconnectsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert InterconnectsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        InterconnectsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert InterconnectsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert InterconnectsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert InterconnectsClient._get_universe_domain(None, None) == InterconnectsClient._DEFAULT_UNIVERSE
...
@mock.patch.object(InterconnectsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(InterconnectsClient))
def test_interconnects_client_client_api_endpoint(client_class):
...
def test_interconnects_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_delete_rest_unset_required_fields():
    transport = transports.InterconnectsRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.delete._get_unset_required_fields({})
    assert set(unset_fields) == (set(("requestId", )) & set(("interconnect", "project", )))
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/global/interconnects/{interconnect}" % client.transport._host, args[1])
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteInterconnectRequest):
    transport_class = transports.InterconnectsRestTransport
...
def test_get_rest_required_fields(request_type=compute.GetInterconnectRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.Interconnect.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_diagnostics_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterconnectsClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_diagnostics in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_diagnostics] = mock_rpc
...
def test_get_diagnostics_rest_required_fields(request_type=compute.GetDiagnosticsInterconnectRequest):
    transport_class = transports.InterconnectsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_diagnostics._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.InterconnectsGetDiagnosticsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_diagnostics_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/interconnects/{interconnect}/getDiagnostics" % client.transport._host, args[1])
...
def test_get_macsec_config_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterconnectsClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_macsec_config in client._transport._wrapped_methods
...
def test_get_macsec_config_rest_required_fields(request_type=compute.GetMacsecConfigInterconnectRequest):
    transport_class = transports.InterconnectsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_macsec_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_macsec_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/interconnects/{interconnect}/getMacsecConfig" % client.transport._host, args[1])
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("interconnectResource", "project", )))
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/interconnects" % client.transport._host, args[1])
...
def test_insert_unary_rest_required_fields(request_type=compute.InsertInterconnectRequest):
    transport_class = transports.InterconnectsRestTransport
...
def test_list_rest_required_fields(request_type=compute.ListInterconnectsRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.InterconnectList.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("interconnect", "interconnectResource", "project", )))
...
def test_patch_unary_rest_required_fields(request_type=compute.PatchInterconnectRequest):
    transport_class = transports.InterconnectsRestTransport
...
def test_set_labels_rest_required_fields(request_type=compute.SetLabelsInterconnectRequest):
    transport_class = transports.InterconnectsRestTransport
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/interconnects/{resource}/setLabels" % client.transport._host, args[1])
...
def test_set_labels_unary_rest_required_fields(request_type=compute.SetLabelsInterconnectRequest):
    transport_class = transports.InterconnectsRestTransport
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsInterconnectRequest):
    transport_class = transports.InterconnectsRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/interconnects/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_delete_rest_bad_request(request_type=compute.DeleteInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.InterconnectsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterconnectsRestInterceptor(),
        )
    client = InterconnectsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteInterconnectRequest.pb(compute.DeleteInterconnectRequest())
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.Interconnect.to_json(compute.Interconnect())
        req.return_value.content = return_value
...
def test_get_diagnostics_rest_bad_request(request_type=compute.GetDiagnosticsInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_diagnostics_rest_call_success(request_type):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_diagnostics_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_get_diagnostics") as post, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_get_diagnostics_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "pre_get_diagnostics") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetDiagnosticsInterconnectRequest.pb(compute.GetDiagnosticsInterconnectRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectsGetDiagnosticsResponse.to_json(compute.InterconnectsGetDiagnosticsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.InterconnectsGetDiagnosticsResponse(), metadata

        client.get_diagnostics(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_macsec_config_rest_bad_request(request_type=compute.GetMacsecConfigInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_macsec_config_rest_call_success(request_type):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_macsec_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_get_macsec_config") as post, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_get_macsec_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "pre_get_macsec_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetMacsecConfigInterconnectRequest.pb(compute.GetMacsecConfigInterconnectRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectsGetMacsecConfigResponse.to_json(compute.InterconnectsGetMacsecConfigResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.InterconnectsGetMacsecConfigResponse(), metadata

        client.get_macsec_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_insert_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1'}
    request_init["interconnect_resource"] = {'aai_enabled': True, 'admin_enabled': True, 'application_aware_interconnect': {'bandwidth_percentage_policy': {'bandwidth_percentages': [{'percentage': 1054, 'traffic_class': 'traffic_class_value'}]}, 'profile_description': 'profile_description_value', 'shape_average_percentages': {}, 'strict_priority_policy': {}}, 'available_features': ['available_features_value1', 'available_features_value2'], 'circuit_infos': [{'customer_demarc_id': 'customer_demarc_id_value', 'google_circuit_id': 'google_circuit_id_value', 'google_demarc_id': 'google_demarc_id_value'}], 'creation_timestamp': 'creation_timestamp_value', 'customer_name': 'customer_name_value', 'description': 'description_value', 'expected_outages': [{'affected_circuits': ['affected_circuits_value1', 'affected_circuits_value2'], 'description': 'description_value', 'end_time': 837, 'issue_type': 'issue_type_value', 'name': 'name_value', 'source': 'source_value', 'start_time': 1084, 'state': 'state_value'}], 'google_ip_address': 'google_ip_address_value', 'google_reference_id': 'google_reference_id_value', 'id': 205, 'interconnect_attachments': ['interconnect_attachments_value1', 'interconnect_attachments_value2'], 'interconnect_groups': ['interconnect_groups_value1', 'interconnect_groups_value2'], 'interconnect_type': 'interconnect_type_value', 'kind': 'kind_value', 'label_fingerprint': 'label_fingerprint_value', 'labels': {}, 'link_type': 'link_type_value', 'location': 'location_value', 'macsec': {'fail_open': True, 'pre_shared_keys': [{'name': 'name_value', 'start_time': 'start_time_value'}]}, 'macsec_enabled': True, 'name': 'name_value', 'noc_contact_email': 'noc_contact_email_value', 'operational_status': 'operational_status_value', 'peer_ip_address': 'peer_ip_address_value', 'provisioned_link_count': 2375, 'remote_location': 'remote_location_value', 'requested_features': ['requested_features_value1', 'requested_features_value2'], 'requested_link_count': 2151, 'satisfies_pzs': True, 'self_link': 'self_link_value', 'state': 'state_value', 'wire_groups': ['wire_groups_value1', 'wire_groups_value2']}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = compute.InsertInterconnectRequest.meta.fields["interconnect_resource"]
    ...
    for field, value in request_init["interconnect_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["interconnect_resource"][field])):
                    del request_init["interconnect_resource"][field][i][subfield]
            else:
                del request_init["interconnect_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertInterconnectRequest.pb(compute.InsertInterconnectRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListInterconnectsRequest.pb(compute.ListInterconnectsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectList.to_json(compute.InterconnectList())
        req.return_value.content = return_value
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchInterconnectRequest.meta.fields["interconnect_resource"]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchInterconnectRequest.pb(compute.PatchInterconnectRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsInterconnectRequest.meta.fields["global_set_labels_request_resource"]
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_set_labels") as post, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_set_labels_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetLabelsInterconnectRequest.pb(compute.SetLabelsInterconnectRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsInterconnectRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectsRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsInterconnectRequest.pb(compute.TestIamPermissionsInterconnectRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = compute.DeleteInterconnectRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetInterconnectRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_diagnostics_empty_call_rest():
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.get_diagnostics),
            '__call__') as call:
        client.get_diagnostics(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetDiagnosticsInterconnectRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_macsec_config_empty_call_rest():
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.get_macsec_config),
            '__call__') as call:
        client.get_macsec_config(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetMacsecConfigInterconnectRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertInterconnectRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListInterconnectsRequest()
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchInterconnectRequest()
...
def test_set_labels_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetLabelsInterconnectRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsInterconnectRequest()
...
def test_interconnects_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.interconnects.transports.InterconnectsTransport.__init__') as Transport:
...
def test_interconnects_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.interconnects.transports.InterconnectsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_interconnects_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.interconnects.transports.InterconnectsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.InterconnectsTransport()
        adc.assert_called_once()
...
def test_interconnects_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = InterconnectsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = InterconnectsClient(
        credentials=creds2,
        transport=transport_name,
    )

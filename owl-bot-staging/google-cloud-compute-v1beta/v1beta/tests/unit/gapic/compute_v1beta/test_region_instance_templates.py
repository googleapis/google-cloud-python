...
from google.cloud.compute_v1beta.services.region_instance_templates import RegionInstanceTemplatesClient
from google.cloud.compute_v1beta.services.region_instance_templates import pagers
from google.cloud.compute_v1beta.services.region_instance_templates import transports
...
def test__read_environment_variables():
    assert RegionInstanceTemplatesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert RegionInstanceTemplatesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert RegionInstanceTemplatesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert RegionInstanceTemplatesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert RegionInstanceTemplatesClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert RegionInstanceTemplatesClient._get_client_cert_source(None, False) is None
    assert RegionInstanceTemplatesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RegionInstanceTemplatesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert RegionInstanceTemplatesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RegionInstanceTemplatesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(RegionInstanceTemplatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionInstanceTemplatesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionInstanceTemplatesClient._DEFAULT_UNIVERSE
    default_endpoint = RegionInstanceTemplatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RegionInstanceTemplatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RegionInstanceTemplatesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert RegionInstanceTemplatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RegionInstanceTemplatesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionInstanceTemplatesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RegionInstanceTemplatesClient._get_api_endpoint(None, None, default_universe, "always") == RegionInstanceTemplatesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionInstanceTemplatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RegionInstanceTemplatesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionInstanceTemplatesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RegionInstanceTemplatesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RegionInstanceTemplatesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RegionInstanceTemplatesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RegionInstanceTemplatesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert RegionInstanceTemplatesClient._get_universe_domain(None, None) == RegionInstanceTemplatesClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        RegionInstanceTemplatesClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = RegionInstanceTemplatesClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (RegionInstanceTemplatesClient, transports.RegionInstanceTemplatesRestTransport, "rest"),
])
@mock.patch.object(RegionInstanceTemplatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionInstanceTemplatesClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (RegionInstanceTemplatesClient, transports.RegionInstanceTemplatesRestTransport, "rest", "true"),
    (RegionInstanceTemplatesClient, transports.RegionInstanceTemplatesRestTransport, "rest", "false"),
])
@mock.patch.object(RegionInstanceTemplatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionInstanceTemplatesClient))
...
@mock.patch.object(RegionInstanceTemplatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionInstanceTemplatesClient))
def test_region_instance_templates_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (RegionInstanceTemplatesClient, transports.RegionInstanceTemplatesRestTransport, "rest", None),
])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceTemplates/{instance_template}" % client.transport._host, args[1])
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("view", )) & set(("instanceTemplate", "project", "region", )))
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceTemplates" % client.transport._host, args[1])
...
def test_list_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "maxResults", "orderBy", "pageToken", "returnPartialSuccess", "view", )) & set(("project", "region", )))
...
def test_delete_rest_bad_request(request_type=compute.DeleteRegionInstanceTemplateRequest):
    client = RegionInstanceTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.RegionInstanceTemplatesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RegionInstanceTemplatesRestInterceptor(),
        )
    client = RegionInstanceTemplatesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "pre_delete") as pre:
...
def test_get_rest_bad_request(request_type=compute.GetRegionInstanceTemplateRequest):
    client = RegionInstanceTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_bad_request(request_type=compute.InsertRegionInstanceTemplateRequest):
    client = RegionInstanceTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_bad_request(request_type=compute.ListRegionInstanceTemplatesRequest):
    client = RegionInstanceTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = compute.DeleteRegionInstanceTemplateRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetRegionInstanceTemplateRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertRegionInstanceTemplateRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListRegionInstanceTemplatesRequest()
...
def test_region_instance_templates_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.region_instance_templates.transports.RegionInstanceTemplatesTransport.__init__') as Transport:
...
def test_region_instance_templates_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.region_instance_templates.transports.RegionInstanceTemplatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_instance_templates_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.region_instance_templates.transports.RegionInstanceTemplatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegionInstanceTemplatesTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("client_class,transport_class", [
    (RegionInstanceTemplatesClient, transports.RegionInstanceTemplatesRestTransport),
])

...
from google.cloud.compute_v1beta.services.machine_types import MachineTypesClient
from google.cloud.compute_v1beta.services.machine_types import pagers
from google.cloud.compute_v1beta.services.machine_types import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert MachineTypesClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert MachineTypesClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert MachineTypesClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert MachineTypesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert MachineTypesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert MachineTypesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert MachineTypesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert MachineTypesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert MachineTypesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert MachineTypesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert MachineTypesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(MachineTypesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MachineTypesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = MachineTypesClient._DEFAULT_UNIVERSE
    default_endpoint = MachineTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = MachineTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert MachineTypesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert MachineTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == MachineTypesClient.DEFAULT_MTLS_ENDPOINT
    assert MachineTypesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert MachineTypesClient._get_api_endpoint(None, None, default_universe, "always") == MachineTypesClient.DEFAULT_MTLS_ENDPOINT
    assert MachineTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == MachineTypesClient.DEFAULT_MTLS_ENDPOINT
    assert MachineTypesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert MachineTypesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        MachineTypesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert MachineTypesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert MachineTypesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert MachineTypesClient._get_universe_domain(None, None) == MachineTypesClient._DEFAULT_UNIVERSE
...
def test_machine_types_client_service_account_always_use_jwt(transport_class, transport_name):
...
@mock.patch.object(MachineTypesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MachineTypesClient))
def test_machine_types_client_client_options(client_class, transport_class, transport_name):
...
def test_machine_types_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(MachineTypesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(MachineTypesClient))
...
def test_machine_types_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_machine_types_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListMachineTypesRequest):
...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.MachineTypesRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/machineTypes" % client.transport._host, args[1])
...
def test_aggregated_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        for result in results:
            ...
            assert tuple(type(t) for t in result) == (str, compute.MachineTypesScopedList)
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'machine_type': 'sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/machineTypes/{machine_type}" % client.transport._host, args[1])
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/machineTypes" % client.transport._host, args[1])
...
def test_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.MachineType)
                for i in results)
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListMachineTypesRequest):
    client = MachineTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.MachineTypesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MachineTypesRestInterceptor(),
        )
    client = MachineTypesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MachineTypesRestInterceptor, "post_aggregated_list") as post, \
        mock.patch.object(transports.MachineTypesRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MachineTypesRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListMachineTypesRequest.pb(compute.AggregatedListMachineTypesRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.MachineTypeAggregatedList.to_json(compute.MachineTypeAggregatedList())
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MachineTypesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MachineTypesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MachineTypesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListMachineTypesRequest.pb(compute.ListMachineTypesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_machine_types_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.machine_types.transports.MachineTypesTransport.__init__') as Transport:
...
def test_machine_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.machine_types.transports.MachineTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_machine_types_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.machine_types.transports.MachineTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MachineTypesTransport()
        adc.assert_called_once()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.MachineTypesTransport, '_prep_wrapped_messages') as prep:
        client = MachineTypesClient(
            credentials=ga_credentials.AnonymousCredentials(),

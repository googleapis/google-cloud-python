...
from google.cloud.compute_v1beta.services.region_operations import RegionOperationsClient
from google.cloud.compute_v1beta.services.region_operations import pagers
from google.cloud.compute_v1beta.services.region_operations import transports
...
def test__get_api_endpoint():
    ...
    assert RegionOperationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RegionOperationsClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert RegionOperationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RegionOperationsClient.DEFAULT_MTLS_ENDPOINT
...
def test_wait_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/operations/{operation}/wait" % client.transport._host, args[1])
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionOperationsRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.RegionOperationsRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionOperationsRestInterceptor, "pre_delete") as pre:
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionOperationsRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.RegionOperationsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionOperationsRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.RegionOperationsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionOperationsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_wait_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionOperationsRestInterceptor, "post_wait") as post, \
        mock.patch.object(transports.RegionOperationsRestInterceptor, "post_wait_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionOperationsRestInterceptor, "pre_wait") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_region_operations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.region_operations.transports.RegionOperationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_operations_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.region_operations.transports.RegionOperationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegionOperationsTransport()
        adc.assert_called_once()

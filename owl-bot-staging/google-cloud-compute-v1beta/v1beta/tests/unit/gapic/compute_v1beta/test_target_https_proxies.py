...
from google.cloud.compute_v1beta.services.target_https_proxies import TargetHttpsProxiesClient
from google.cloud.compute_v1beta.services.target_https_proxies import pagers
from google.cloud.compute_v1beta.services.target_https_proxies import transports
...
def test__get_api_endpoint():
    ...
    assert TargetHttpsProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == TargetHttpsProxiesClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert TargetHttpsProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == TargetHttpsProxiesClient.DEFAULT_MTLS_ENDPOINT
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/targetHttpsProxies" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetHttpsProxies/{target_https_proxy}" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetHttpsProxies" % client.transport._host, args[1])
...
def test_set_certificate_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetHttpsProxies/{target_https_proxy}/setCertificateMap" % client.transport._host, args[1])
...
def test_set_quic_override_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetHttpsProxiesClient(
        ...
        # Ensure method has been cached
        assert client._transport.set_quic_override in client._transport._wrapped_methods
...
def test_set_quic_override_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetHttpsProxies/{target_https_proxy}/setQuicOverride" % client.transport._host, args[1])
...
def test_set_quic_override_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetHttpsProxiesClient(
...
def test_set_ssl_certificates_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/targetHttpsProxies/{target_https_proxy}/setSslCertificates" % client.transport._host, args[1])
...
def test_set_ssl_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetHttpsProxies/{target_https_proxy}/setSslPolicy" % client.transport._host, args[1])
...
def test_set_url_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/targetHttpsProxies/{target_https_proxy}/setUrlMap" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsTargetHttpsProxyRequest):
    transport_class = transports.TargetHttpsProxiesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetHttpsProxies/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
...
def test_set_certificate_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_set_certificate_map_with_metadata") as post_with_metadata, \
...
def test_set_quic_override_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_set_quic_override_with_metadata") as post_with_metadata, \
...
def test_set_ssl_certificates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_set_ssl_certificates_with_metadata") as post_with_metadata, \
...
def test_set_ssl_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_set_ssl_policy_with_metadata") as post_with_metadata, \
...
def test_set_url_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_set_url_map_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsTargetHttpsProxyRequest):
    client = TargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsTargetHttpsProxyRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsTargetHttpsProxyRequest.pb(compute.TestIamPermissionsTargetHttpsProxyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = compute.AggregatedListTargetHttpsProxiesRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteTargetHttpsProxyRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetTargetHttpsProxyRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertTargetHttpsProxyRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListTargetHttpsProxiesRequest()
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchTargetHttpsProxyRequest()
...
def test_set_certificate_map_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetCertificateMapTargetHttpsProxyRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_quic_override_unary_empty_call_rest():
    client = TargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.set_quic_override),
            '__call__') as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetQuicOverrideTargetHttpsProxyRequest()
...
def test_set_ssl_certificates_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetSslCertificatesTargetHttpsProxyRequest()
...
def test_set_ssl_policy_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetSslPolicyTargetHttpsProxyRequest()
...
def test_set_url_map_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetUrlMapTargetHttpsProxyRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsTargetHttpsProxyRequest()
...
def test_target_https_proxies_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.target_https_proxies.transports.TargetHttpsProxiesTransport.__init__') as Transport:
...
def test_target_https_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.target_https_proxies.transports.TargetHttpsProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_target_https_proxies_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.target_https_proxies.transports.TargetHttpsProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.TargetHttpsProxiesTransport()
        adc.assert_called_once()

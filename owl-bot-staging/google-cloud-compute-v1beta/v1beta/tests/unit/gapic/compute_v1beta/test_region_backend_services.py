...
from google.cloud.compute_v1beta.services.region_backend_services import RegionBackendServicesClient
from google.cloud.compute_v1beta.services.region_backend_services import pagers
from google.cloud.compute_v1beta.services.region_backend_services import transports
...
def test__read_environment_variables():
    assert RegionBackendServicesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert RegionBackendServicesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert RegionBackendServicesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert RegionBackendServicesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert RegionBackendServicesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert RegionBackendServicesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RegionBackendServicesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert RegionBackendServicesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RegionBackendServicesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(RegionBackendServicesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionBackendServicesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionBackendServicesClient._DEFAULT_UNIVERSE
    default_endpoint = RegionBackendServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RegionBackendServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RegionBackendServicesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert RegionBackendServicesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RegionBackendServicesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionBackendServicesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RegionBackendServicesClient._get_api_endpoint(None, None, default_universe, "always") == RegionBackendServicesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionBackendServicesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RegionBackendServicesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionBackendServicesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RegionBackendServicesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RegionBackendServicesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RegionBackendServicesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RegionBackendServicesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert RegionBackendServicesClient._get_universe_domain(None, None) == RegionBackendServicesClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = RegionBackendServicesClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (RegionBackendServicesClient, transports.RegionBackendServicesRestTransport, "rest"),
])
@mock.patch.object(RegionBackendServicesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionBackendServicesClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (RegionBackendServicesClient, transports.RegionBackendServicesRestTransport, "rest", "true"),
    (RegionBackendServicesClient, transports.RegionBackendServicesRestTransport, "rest", "false"),
])
@mock.patch.object(RegionBackendServicesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionBackendServicesClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (RegionBackendServicesClient, transports.RegionBackendServicesRestTransport, "rest", None),
])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/backendServices/{backend_service}" % client.transport._host, args[1])
...
def test_get_health_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/backendServices/{backend_service}/getHealth" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/backendServices/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/backendServices" % client.transport._host, args[1])
...
def test_list_usable_rest_required_fields(request_type=compute.ListUsableRegionBackendServicesRequest):
    transport_class = transports.RegionBackendServicesRestTransport
...
def test_list_usable_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/backendServices/listUsable" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/backendServices/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_set_security_policy_rest_required_fields(request_type=compute.SetSecurityPolicyRegionBackendServiceRequest):
    transport_class = transports.RegionBackendServicesRestTransport
...
def test_set_security_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("backendService", "project", "region", "securityPolicyReferenceResource", )))
...
def test_set_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/backendServices/{backend_service}/setSecurityPolicy" % client.transport._host, args[1])
...
def test_set_security_policy_unary_rest_required_fields(request_type=compute.SetSecurityPolicyRegionBackendServiceRequest):
    transport_class = transports.RegionBackendServicesRestTransport
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsRegionBackendServiceRequest):
    transport_class = transports.RegionBackendServicesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/backendServices/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_delete_rest_bad_request(request_type=compute.DeleteRegionBackendServiceRequest):
    client = RegionBackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.RegionBackendServicesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RegionBackendServicesRestInterceptor(),
        )
    client = RegionBackendServicesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_delete") as pre:
...
def test_get_rest_call_success(request_type):
    ...
    assert response.external_managed_migration_state == 'external_managed_migration_state_value'
    assert math.isclose(response.external_managed_migration_testing_percentage, 0.47540000000000004, rel_tol=1e-6)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_health_rest_bad_request(request_type=compute.GetHealthRegionBackendServiceRequest):
    client = RegionBackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_health_rest_call_success(request_type):
    ...
    for field, value in request_init["resource_group_reference_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_get_health_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_get_health") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_get_health_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_get_health") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.BackendServiceGroupHealth.to_json(compute.BackendServiceGroupHealth())
        req.return_value.content = return_value
...
def test_get_iam_policy_rest_bad_request(request_type=compute.GetIamPolicyRegionBackendServiceRequest):
    client = RegionBackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_bad_request(request_type=compute.InsertRegionBackendServiceRequest):
    client = RegionBackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2'}
    request_init["backend_service_resource"] = {'affinity_cookie_ttl_sec': 2432, 'backends': [{'balancing_mode': 'balancing_mode_value', 'capacity_scaler': 0.1575, 'custom_metrics': [{'dry_run': True, 'max_utilization': 0.1633, 'name': 'name_value'}], 'description': 'description_value', 'failover': True, 'group': 'group_value', 'max_connections': 1608, 'max_connections_per_endpoint': 2990, 'max_connections_per_instance': 2978, 'max_in_flight_requests': 2356, 'max_in_flight_requests_per_endpoint': 3738, 'max_in_flight_requests_per_instance': 3726, 'max_rate': 849, 'max_rate_per_endpoint': 0.22310000000000002, 'max_rate_per_instance': 0.22190000000000001, 'max_utilization': 0.1633, 'preference': 'preference_value', 'traffic_duration': 'traffic_duration_value'}], 'cdn_policy': {'bypass_cache_on_request_headers': [{'header_name': 'header_name_value'}], 'cache_key_policy': {'include_host': True, 'include_http_headers': ['include_http_headers_value1', 'include_http_headers_value2'], 'include_named_cookies': ['include_named_cookies_value1', 'include_named_cookies_value2'], 'include_protocol': True, 'include_query_string': True, 'query_string_blacklist': ['query_string_blacklist_value1', 'query_string_blacklist_value2'], 'query_string_whitelist': ['query_string_whitelist_value1', 'query_string_whitelist_value2']}, 'cache_mode': 'cache_mode_value', 'client_ttl': 1074, 'default_ttl': 1176, 'max_ttl': 761, 'negative_caching': True, 'negative_caching_policy': [{'code': 411, 'ttl': 340}], 'request_coalescing': True, 'serve_while_stale': 1813, 'signed_url_cache_max_age_sec': 2890, 'signed_url_key_names': ['signed_url_key_names_value1', 'signed_url_key_names_value2']}, 'circuit_breakers': {'connect_timeout': {'nanos': 543, 'seconds': 751}, 'max_connections': 1608, 'max_pending_requests': 2149, 'max_requests': 1313, 'max_requests_per_connection': 2902, 'max_retries': 1187}, 'compression_mode': 'compression_mode_value', 'connection_draining': {'draining_timeout_sec': 2124}, 'connection_tracking_policy': {'connection_persistence_on_unhealthy_backends': 'connection_persistence_on_unhealthy_backends_value', 'enable_strong_affinity': True, 'idle_timeout_sec': 1694, 'tracking_mode': 'tracking_mode_value'}, 'consistent_hash': {'http_cookie': {'name': 'name_value', 'path': 'path_value', 'ttl': {}}, 'http_header_name': 'http_header_name_value', 'minimum_ring_size': 1829}, 'creation_timestamp': 'creation_timestamp_value', 'custom_metrics': [{'dry_run': True, 'name': 'name_value'}], 'custom_request_headers': ['custom_request_headers_value1', 'custom_request_headers_value2'], 'custom_response_headers': ['custom_response_headers_value1', 'custom_response_headers_value2'], 'description': 'description_value', 'dynamic_forwarding': {'ip_port_selection': {'enabled': True}}, 'edge_security_policy': 'edge_security_policy_value', 'enable_c_d_n': True, 'external_managed_migration_state': 'external_managed_migration_state_value', 'external_managed_migration_testing_percentage': 0.47540000000000004, 'failover_policy': {'disable_connection_drain_on_failover': True, 'drop_traffic_if_unhealthy': True, 'failover_ratio': 0.1494}, 'fingerprint': 'fingerprint_value', 'ha_policy': {'fast_i_p_move': 'fast_i_p_move_value', 'leader': {'backend_group': 'backend_group_value', 'network_endpoint': {'instance': 'instance_value'}}}, 'health_checks': ['health_checks_value1', 'health_checks_value2'], 'iap': {'enabled': True, 'oauth2_client_id': 'oauth2_client_id_value', 'oauth2_client_secret': 'oauth2_client_secret_value', 'oauth2_client_secret_sha256': 'oauth2_client_secret_sha256_value'}, 'id': 205, 'ip_address_selection_policy': 'ip_address_selection_policy_value', 'kind': 'kind_value', 'load_balancing_scheme': 'load_balancing_scheme_value', 'locality_lb_policies': [{'custom_policy': {'data': 'data_value', 'name': 'name_value'}, 'policy': {'name': 'name_value'}}], 'locality_lb_policy': 'locality_lb_policy_value', 'log_config': {'enable': True, 'optional_fields': ['optional_fields_value1', 'optional_fields_value2'], 'optional_mode': 'optional_mode_value', 'sample_rate': 0.1165}, 'max_stream_duration': {}, 'metadatas': {}, 'name': 'name_value', 'network': 'network_value', 'network_pass_through_lb_traffic_policy': {'zonal_affinity': {'spillover': 'spillover_value', 'spillover_ratio': 0.163}}, 'outlier_detection': {'base_ejection_time': {}, 'consecutive_errors': 1956, 'consecutive_gateway_failure': 2880, 'enforcing_consecutive_errors': 3006, 'enforcing_consecutive_gateway_failure': 3930, 'enforcing_success_rate': 2334, 'interval': {}, 'max_ejection_percent': 2118, 'success_rate_minimum_hosts': 2799, 'success_rate_request_volume': 2915, 'success_rate_stdev_factor': 2663}, 'params': {'resource_manager_tags': {}}, 'port': 453, 'port_name': 'port_name_value', 'protocol': 'protocol_value', 'region': 'region_value', 'security_policy': 'security_policy_value', 'security_settings': {'authentication': 'authentication_value', 'aws_v4_authentication': {'access_key': 'access_key_value', 'access_key_id': 'access_key_id_value', 'access_key_version': 'access_key_version_value', 'origin_region': 'origin_region_value'}, 'client_tls_policy': 'client_tls_policy_value', 'subject_alt_names': ['subject_alt_names_value1', 'subject_alt_names_value2']}, 'self_link': 'self_link_value', 'service_bindings': ['service_bindings_value1', 'service_bindings_value2'], 'service_lb_policy': 'service_lb_policy_value', 'session_affinity': 'session_affinity_value', 'strong_session_affinity_cookie': {'name': 'name_value', 'path': 'path_value', 'ttl': {}}, 'subsetting': {'policy': 'policy_value', 'subset_size': 1200}, 'timeout_sec': 1185, 'tls_settings': {'authentication_config': 'authentication_config_value', 'sni': 'sni_value', 'subject_alt_names': [{'dns_name': 'dns_name_value', 'uniform_resource_identifier': 'uniform_resource_identifier_value'}]}, 'used_by': [{'reference': 'reference_value'}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["backend_service_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_usable_rest_bad_request(request_type=compute.ListUsableRegionBackendServicesRequest):
    client = RegionBackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_usable_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_list_usable") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_list_usable_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_list_usable") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListUsableRegionBackendServicesRequest.pb(compute.ListUsableRegionBackendServicesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.BackendServiceListUsable.to_json(compute.BackendServiceListUsable())
        req.return_value.content = return_value
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_bad_request(request_type=compute.SetIamPolicyRegionBackendServiceRequest):
    client = RegionBackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_security_policy_rest_bad_request(request_type=compute.SetSecurityPolicyRegionBackendServiceRequest):
    client = RegionBackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_security_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetSecurityPolicyRegionBackendServiceRequest.meta.fields["security_policy_reference_resource"]
...
def test_set_security_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_set_security_policy") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_set_security_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_set_security_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetSecurityPolicyRegionBackendServiceRequest.pb(compute.SetSecurityPolicyRegionBackendServiceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsRegionBackendServiceRequest):
    client = RegionBackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsRegionBackendServiceRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRegionBackendServiceRequest.pb(compute.TestIamPermissionsRegionBackendServiceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_rest_bad_request(request_type=compute.UpdateRegionBackendServiceRequest):
    client = RegionBackendServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_update") as post, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_update_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionBackendServicesRestInterceptor, "pre_update") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_usable_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_usable),
            '__call__') as call:
...
def test_region_backend_services_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.region_backend_services.transports.RegionBackendServicesTransport.__init__') as Transport:
...
def test_region_backend_services_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.region_backend_services.transports.RegionBackendServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_backend_services_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.region_backend_services.transports.RegionBackendServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegionBackendServicesTransport()
        adc.assert_called_once()

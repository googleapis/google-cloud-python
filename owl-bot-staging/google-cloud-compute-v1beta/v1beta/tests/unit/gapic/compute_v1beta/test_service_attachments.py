...
from google.cloud.compute_v1beta.services.service_attachments import ServiceAttachmentsClient
from google.cloud.compute_v1beta.services.service_attachments import pagers
from google.cloud.compute_v1beta.services.service_attachments import transports
...
def test__read_environment_variables():
    assert ServiceAttachmentsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ServiceAttachmentsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ServiceAttachmentsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ServiceAttachmentsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ServiceAttachmentsClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert ServiceAttachmentsClient._get_client_cert_source(None, False) is None
    assert ServiceAttachmentsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ServiceAttachmentsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ServiceAttachmentsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ServiceAttachmentsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ServiceAttachmentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServiceAttachmentsClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ServiceAttachmentsClient._DEFAULT_UNIVERSE
    default_endpoint = ServiceAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ServiceAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ServiceAttachmentsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ServiceAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ServiceAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    assert ServiceAttachmentsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ServiceAttachmentsClient._get_api_endpoint(None, None, default_universe, "always") == ServiceAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    assert ServiceAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ServiceAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    assert ServiceAttachmentsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ServiceAttachmentsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ServiceAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ServiceAttachmentsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ServiceAttachmentsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ServiceAttachmentsClient._get_universe_domain(None, None) == ServiceAttachmentsClient._DEFAULT_UNIVERSE
...
@mock.patch.object(ServiceAttachmentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServiceAttachmentsClient))
def test_service_attachments_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ServiceAttachmentsClient, transports.ServiceAttachmentsRestTransport, "rest", None),
])
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/serviceAttachments" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{service_attachment}" % client.transport._host, args[1])
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("showNatIps", )) & set(("project", "region", "serviceAttachment", )))
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            region='region_value',
            service_attachment_resource=compute.ServiceAttachment(connected_endpoints=[compute.ServiceAttachmentConnectedEndpoint(consumer_network='consumer_network_value')]),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListServiceAttachmentsRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.ServiceAttachmentsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ServiceAttachmentsRestInterceptor(),
        )
    client = ServiceAttachmentsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_aggregated_list") as post, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "pre_aggregated_list") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ServiceAttachmentAggregatedList.to_json(compute.ServiceAttachmentAggregatedList())
        ...
        post_with_metadata.return_value = compute.ServiceAttachmentAggregatedList(), metadata
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ServiceAttachment.to_json(compute.ServiceAttachment())
        req.return_value.content = return_value
...
def test_get_iam_policy_rest_bad_request(request_type=compute.GetIamPolicyServiceAttachmentRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2'}
    request_init["service_attachment_resource"] = {'connected_endpoints': [{'consumer_network': 'consumer_network_value', 'endpoint': 'endpoint_value', 'nat_ips': ['nat_ips_value1', 'nat_ips_value2'], 'propagated_connection_count': 2878, 'psc_connection_id': 1793, 'status': 'status_value'}], 'connection_preference': 'connection_preference_value', 'consumer_accept_lists': [{'connection_limit': 1710, 'network_url': 'network_url_value', 'project_id_or_num': 'project_id_or_num_value'}], 'consumer_reject_lists': ['consumer_reject_lists_value1', 'consumer_reject_lists_value2'], 'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'domain_names': ['domain_names_value1', 'domain_names_value2'], 'enable_proxy_protocol': True, 'fingerprint': 'fingerprint_value', 'id': 205, 'kind': 'kind_value', 'metadata': {}, 'name': 'name_value', 'nat_subnets': ['nat_subnets_value1', 'nat_subnets_value2'], 'producer_forwarding_rule': 'producer_forwarding_rule_value', 'propagated_connection_limit': 2868, 'psc_service_attachment_id': {'high': 416, 'low': 338}, 'reconcile_connections': True, 'region': 'region_value', 'self_link': 'self_link_value', 'target_service': 'target_service_value', 'tunneling_config': {'encapsulation_profile': 'encapsulation_profile_value', 'routing_mode': 'routing_mode_value'}}
    ...
    for field, value in request_init["service_attachment_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ServiceAttachmentList.to_json(compute.ServiceAttachmentList())
        req.return_value.content = return_value
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_bad_request(request_type=compute.SetIamPolicyServiceAttachmentRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsServiceAttachmentRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ServiceAttachmentsRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = compute.AggregatedListServiceAttachmentsRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteServiceAttachmentRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetServiceAttachmentRequest()
...
def test_get_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetIamPolicyServiceAttachmentRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertServiceAttachmentRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListServiceAttachmentsRequest()
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchServiceAttachmentRequest()
...
def test_set_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetIamPolicyServiceAttachmentRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsServiceAttachmentRequest()
...
def test_service_attachments_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.service_attachments.transports.ServiceAttachmentsTransport.__init__') as Transport:
...
def test_service_attachments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.service_attachments.transports.ServiceAttachmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_service_attachments_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.service_attachments.transports.ServiceAttachmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ServiceAttachmentsTransport()
        adc.assert_called_once()
...
def test_service_attachments_client_transport_session_collision(transport_name):
    ...
    client1 = ServiceAttachmentsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = ServiceAttachmentsClient(
        credentials=creds2,
        transport=transport_name,
    )

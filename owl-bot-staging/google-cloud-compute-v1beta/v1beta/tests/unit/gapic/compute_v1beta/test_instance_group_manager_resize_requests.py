...
from google.cloud.compute_v1beta.services.instance_group_manager_resize_requests import InstanceGroupManagerResizeRequestsClient
from google.cloud.compute_v1beta.services.instance_group_manager_resize_requests import pagers
from google.cloud.compute_v1beta.services.instance_group_manager_resize_requests import transports
...
@mock.patch.object(InstanceGroupManagerResizeRequestsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(InstanceGroupManagerResizeRequestsClient))
def test__get_api_endpoint():
    ...
    assert InstanceGroupManagerResizeRequestsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert InstanceGroupManagerResizeRequestsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == InstanceGroupManagerResizeRequestsClient.DEFAULT_MTLS_ENDPOINT
    assert InstanceGroupManagerResizeRequestsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert InstanceGroupManagerResizeRequestsClient._get_api_endpoint(None, None, default_universe, "always") == InstanceGroupManagerResizeRequestsClient.DEFAULT_MTLS_ENDPOINT
...
def test_instance_group_manager_resize_requests_client_get_transport_class():
    transport = InstanceGroupManagerResizeRequestsClient.get_transport_class()
    ...
    assert transport == transports.InstanceGroupManagerResizeRequestsRestTransport
...
def test_cancel_rest_required_fields(request_type=compute.CancelInstanceGroupManagerResizeRequestRequest):
    ...
    assert "resizeRequest" in jsonified_request
    assert jsonified_request["resizeRequest"] == 'resize_request_value'
...
def test_cancel_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instanceGroupManager", "project", "resizeRequest", "zone", )))
...
def test_cancel_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            resize_request='resize_request_value',
        )
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resizeRequests/{resize_request}/cancel" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resizeRequests/{resize_request}" % client.transport._host, args[1])
...
def test_get_rest_required_fields(request_type=compute.GetInstanceGroupManagerResizeRequestRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.InstanceGroupManagerResizeRequest.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("instanceGroupManager", "project", "resizeRequest", "zone", )))
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instanceGroupManager", "instanceGroupManagerResizeRequestResource", "project", "zone", )))
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resizeRequests" % client.transport._host, args[1])
...
def test_list_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "maxResults", "orderBy", "pageToken", "returnPartialSuccess", )) & set(("instanceGroupManager", "project", "zone", )))
...
def test_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, compute.InstanceGroupManagerResizeRequest)
                for i in results)
...
def test_cancel_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "post_cancel") as post, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "post_cancel_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "pre_cancel") as pre:
        ...
        client.cancel(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_call_success(request_type):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, compute.InstanceGroupManagerResizeRequest)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InstanceGroupManagerResizeRequestsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_cancel_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = compute.CancelInstanceGroupManagerResizeRequestRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteInstanceGroupManagerResizeRequestRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetInstanceGroupManagerResizeRequestRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertInstanceGroupManagerResizeRequestRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListInstanceGroupManagerResizeRequestsRequest()

        assert args[0] == request_msg


def test_instance_group_manager_resize_requests_base_transport_error():
...
def test_instance_group_manager_resize_requests_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.instance_group_manager_resize_requests.transports.InstanceGroupManagerResizeRequestsTransport.__init__') as Transport:
...
def test_instance_group_manager_resize_requests_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.instance_group_manager_resize_requests.transports.InstanceGroupManagerResizeRequestsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_instance_group_manager_resize_requests_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.instance_group_manager_resize_requests.transports.InstanceGroupManagerResizeRequestsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.InstanceGroupManagerResizeRequestsTransport()
        adc.assert_called_once()
...
def test_instance_group_manager_resize_requests_client_transport_session_collision(transport_name):
    ...
    client2 = InstanceGroupManagerResizeRequestsClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_common_folder_path():
    ...
    actual = InstanceGroupManagerResizeRequestsClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = InstanceGroupManagerResizeRequestsClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = InstanceGroupManagerResizeRequestsClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = InstanceGroupManagerResizeRequestsClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = InstanceGroupManagerResizeRequestsClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = InstanceGroupManagerResizeRequestsClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = InstanceGroupManagerResizeRequestsClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = InstanceGroupManagerResizeRequestsClient.parse_common_location_path(path)
    assert expected == actual

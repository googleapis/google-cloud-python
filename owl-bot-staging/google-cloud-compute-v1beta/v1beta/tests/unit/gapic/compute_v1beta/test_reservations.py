...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            zone='zone_value',
            reservation_resource=compute.Reservation(advanced_deployment_control=compute.ReservationAdvancedDeploymentControl(reservation_operational_mode='reservation_operational_mode_value')),
        )
        mock_args.update(sample_request)

...
from google.cloud.compute_v1beta.services.region_network_endpoint_groups import RegionNetworkEndpointGroupsClient
from google.cloud.compute_v1beta.services.region_network_endpoint_groups import pagers
from google.cloud.compute_v1beta.services.region_network_endpoint_groups import transports
...
def test__read_environment_variables():
    assert RegionNetworkEndpointGroupsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert RegionNetworkEndpointGroupsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert RegionNetworkEndpointGroupsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert RegionNetworkEndpointGroupsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert RegionNetworkEndpointGroupsClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert RegionNetworkEndpointGroupsClient._get_client_cert_source(None, False) is None
    assert RegionNetworkEndpointGroupsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RegionNetworkEndpointGroupsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert RegionNetworkEndpointGroupsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RegionNetworkEndpointGroupsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(RegionNetworkEndpointGroupsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionNetworkEndpointGroupsClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionNetworkEndpointGroupsClient._DEFAULT_UNIVERSE
    default_endpoint = RegionNetworkEndpointGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RegionNetworkEndpointGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RegionNetworkEndpointGroupsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert RegionNetworkEndpointGroupsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RegionNetworkEndpointGroupsClient.DEFAULT_MTLS_ENDPOINT
    assert RegionNetworkEndpointGroupsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RegionNetworkEndpointGroupsClient._get_api_endpoint(None, None, default_universe, "always") == RegionNetworkEndpointGroupsClient.DEFAULT_MTLS_ENDPOINT
    assert RegionNetworkEndpointGroupsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RegionNetworkEndpointGroupsClient.DEFAULT_MTLS_ENDPOINT
    assert RegionNetworkEndpointGroupsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RegionNetworkEndpointGroupsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RegionNetworkEndpointGroupsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RegionNetworkEndpointGroupsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RegionNetworkEndpointGroupsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert RegionNetworkEndpointGroupsClient._get_universe_domain(None, None) == RegionNetworkEndpointGroupsClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (RegionNetworkEndpointGroupsClient, transports.RegionNetworkEndpointGroupsRestTransport, "rest", None),
])
...
def test_attach_network_endpoints_rest_required_fields(request_type=compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest):
...
def test_attach_network_endpoints_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("networkEndpointGroup", "project", "region", "regionNetworkEndpointGroupsAttachEndpointsRequestResource", )))
...
def test_attach_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region_network_endpoint_groups_attach_endpoints_request_resource=compute.RegionNetworkEndpointGroupsAttachEndpointsRequest(network_endpoints=[compute.NetworkEndpoint(annotations={'key_value': 'value_value'})]),
        )
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/attachNetworkEndpoints" % client.transport._host, args[1])
...
def test_attach_network_endpoints_unary_rest_required_fields(request_type=compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest):
    transport_class = transports.RegionNetworkEndpointGroupsRestTransport
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}" % client.transport._host, args[1])
...
def test_detach_network_endpoints_rest_required_fields(request_type=compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest):
    transport_class = transports.RegionNetworkEndpointGroupsRestTransport
...
def test_detach_network_endpoints_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("networkEndpointGroup", "project", "region", "regionNetworkEndpointGroupsDetachEndpointsRequestResource", )))
...
def test_detach_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            network_endpoint_group='network_endpoint_group_value',
            region_network_endpoint_groups_detach_endpoints_request_resource=compute.RegionNetworkEndpointGroupsDetachEndpointsRequest(network_endpoints=[compute.NetworkEndpoint(annotations={'key_value': 'value_value'})]),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/detachNetworkEndpoints" % client.transport._host, args[1])
...
def test_detach_network_endpoints_unary_rest_required_fields(request_type=compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest):
    transport_class = transports.RegionNetworkEndpointGroupsRestTransport
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/networkEndpointGroups" % client.transport._host, args[1])
...
def test_list_network_endpoints_rest_required_fields(request_type=compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest):
    transport_class = transports.RegionNetworkEndpointGroupsRestTransport
...
def test_list_network_endpoints_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "maxResults", "orderBy", "pageToken", "returnPartialSuccess", )) & set(("networkEndpointGroup", "project", "region", )))
...
def test_list_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/listNetworkEndpoints" % client.transport._host, args[1])
...
def test_attach_network_endpoints_rest_bad_request(request_type=compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_attach_network_endpoints_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'network_endpoint_group': 'sample3'}
    request_init["region_network_endpoint_groups_attach_endpoints_request_resource"] = {'network_endpoints': [{'annotations': {}, 'client_destination_port': 2468, 'fqdn': 'fqdn_value', 'instance': 'instance_value', 'ip_address': 'ip_address_value', 'ipv6_address': 'ipv6_address_value', 'port': 453}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest.meta.fields["region_network_endpoint_groups_attach_endpoints_request_resource"]
    ...
    for field, value in request_init["region_network_endpoint_groups_attach_endpoints_request_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["region_network_endpoint_groups_attach_endpoints_request_resource"][field])):
                    del request_init["region_network_endpoint_groups_attach_endpoints_request_resource"][field][i][subfield]
            else:
                del request_init["region_network_endpoint_groups_attach_endpoints_request_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_attach_network_endpoints_rest_interceptors(null_interceptor):
    transport = transports.RegionNetworkEndpointGroupsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RegionNetworkEndpointGroupsRestInterceptor(),
        )
    client = RegionNetworkEndpointGroupsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_attach_network_endpoints") as post, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_attach_network_endpoints_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "pre_attach_network_endpoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest.pb(compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest())
        ...
        client.attach_network_endpoints(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_rest_bad_request(request_type=compute.DeleteRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_detach_network_endpoints_rest_bad_request(request_type=compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_detach_network_endpoints_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'network_endpoint_group': 'sample3'}
    request_init["region_network_endpoint_groups_detach_endpoints_request_resource"] = {'network_endpoints': [{'annotations': {}, 'client_destination_port': 2468, 'fqdn': 'fqdn_value', 'instance': 'instance_value', 'ip_address': 'ip_address_value', 'ipv6_address': 'ipv6_address_value', 'port': 453}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest.meta.fields["region_network_endpoint_groups_detach_endpoints_request_resource"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["region_network_endpoint_groups_detach_endpoints_request_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["region_network_endpoint_groups_detach_endpoints_request_resource"][field])):
                    del request_init["region_network_endpoint_groups_detach_endpoints_request_resource"][field][i][subfield]
            else:
                del request_init["region_network_endpoint_groups_detach_endpoints_request_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_detach_network_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_detach_network_endpoints") as post, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_detach_network_endpoints_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "pre_detach_network_endpoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest.pb(compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.detach_network_endpoints(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_rest_bad_request(request_type=compute.GetRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_bad_request(request_type=compute.InsertRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2'}
    request_init["network_endpoint_group_resource"] = {'annotations': {}, 'app_engine': {'service': 'service_value', 'url_mask': 'url_mask_value', 'version': 'version_value'}, 'cloud_function': {'function': 'function_value', 'url_mask': 'url_mask_value'}, 'cloud_run': {'service': 'service_value', 'tag': 'tag_value', 'url_mask': 'url_mask_value'}, 'creation_timestamp': 'creation_timestamp_value', 'default_port': 1289, 'description': 'description_value', 'id': 205, 'kind': 'kind_value', 'load_balancer': {'default_port': 1289, 'network': 'network_value', 'subnetwork': 'subnetwork_value', 'zone': 'zone_value'}, 'name': 'name_value', 'network': 'network_value', 'network_endpoint_type': 'network_endpoint_type_value', 'psc_data': {'consumer_psc_address': 'consumer_psc_address_value', 'producer_port': 1416, 'psc_connection_id': 1793, 'psc_connection_status': 'psc_connection_status_value'}, 'psc_target_service': 'psc_target_service_value', 'region': 'region_value', 'self_link': 'self_link_value', 'serverless_deployment': {'platform': 'platform_value', 'resource': 'resource_value', 'url_mask': 'url_mask_value', 'version': 'version_value'}, 'size': 443, 'subnetwork': 'subnetwork_value', 'zone': 'zone_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_bad_request(request_type=compute.ListRegionNetworkEndpointGroupsRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_network_endpoints_rest_bad_request(request_type=compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_network_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_list_network_endpoints") as post, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_list_network_endpoints_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "pre_list_network_endpoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest.pb(compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.list_network_endpoints(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_attach_network_endpoints_unary_empty_call_rest():
    ...
    with mock.patch.object(
            type(client.transport.attach_network_endpoints),
            '__call__') as call:
...
def test_detach_network_endpoints_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.detach_network_endpoints),
            '__call__') as call:
...
def test_list_network_endpoints_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_network_endpoints),
            '__call__') as call:
...
def test_region_network_endpoint_groups_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.region_network_endpoint_groups.transports.RegionNetworkEndpointGroupsTransport.__init__') as Transport:
...
def test_region_network_endpoint_groups_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.region_network_endpoint_groups.transports.RegionNetworkEndpointGroupsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_network_endpoint_groups_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.region_network_endpoint_groups.transports.RegionNetworkEndpointGroupsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegionNetworkEndpointGroupsTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("client_class,transport_class", [
    (RegionNetworkEndpointGroupsClient, transports.RegionNetworkEndpointGroupsRestTransport),
])

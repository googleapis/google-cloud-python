...
from google.cloud.compute_v1beta.services.region_network_firewall_policies import RegionNetworkFirewallPoliciesClient
from google.cloud.compute_v1beta.services.region_network_firewall_policies import pagers
from google.cloud.compute_v1beta.services.region_network_firewall_policies import transports
...
def test_add_association_rest_required_fields(request_type=compute.AddAssociationRegionNetworkFirewallPolicyRequest):
    ...
    assert not set(unset_fields) - set(("associated_policy_to_be_replaced", "replace_existing_association", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_add_association_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("associatedPolicyToBeReplaced", "replaceExistingAssociation", "requestId", )) & set(("firewallPolicy", "firewallPolicyAssociationResource", "project", "region", )))
...
def test_add_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/addAssociation" % client.transport._host, args[1])
...
def test_add_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/addRule" % client.transport._host, args[1])
...
def test_clone_rules_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/cloneRules" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}" % client.transport._host, args[1])
...
def test_get_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/getAssociation" % client.transport._host, args[1])
...
def test_get_effective_firewalls_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/getEffectiveFirewalls" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_get_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/getRule" % client.transport._host, args[1])
...
def test_patch_association_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("firewallPolicy", "firewallPolicyAssociationResource", "project", "region", )))
...
def test_patch_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/patchAssociation" % client.transport._host, args[1])
...
def test_patch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/patchRule" % client.transport._host, args[1])
...
def test_remove_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/removeAssociation" % client.transport._host, args[1])
...
def test_remove_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/removeRule" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/firewallPolicies/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_patch_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionNetworkFirewallPoliciesRestInterceptor, "post_patch_association") as post, \
        mock.patch.object(transports.RegionNetworkFirewallPoliciesRestInterceptor, "post_patch_association_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionNetworkFirewallPoliciesRestInterceptor, "pre_patch_association") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.patch_association(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_patch_association_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.patch_association),
            '__call__') as call:
...
def test_region_network_firewall_policies_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.region_network_firewall_policies.transports.RegionNetworkFirewallPoliciesTransport.__init__') as Transport:
...
def test_region_network_firewall_policies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.region_network_firewall_policies.transports.RegionNetworkFirewallPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_network_firewall_policies_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.region_network_firewall_policies.transports.RegionNetworkFirewallPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegionNetworkFirewallPoliciesTransport()
        adc.assert_called_once()

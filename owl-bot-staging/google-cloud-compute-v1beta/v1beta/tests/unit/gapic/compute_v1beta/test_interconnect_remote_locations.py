...
from google.cloud.compute_v1beta.services.interconnect_remote_locations import InterconnectRemoteLocationsClient
from google.cloud.compute_v1beta.services.interconnect_remote_locations import pagers
from google.cloud.compute_v1beta.services.interconnect_remote_locations import transports
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/global/interconnectRemoteLocations/{interconnect_remote_location}" % client.transport._host, args[1])
...
def test_interconnect_remote_locations_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.interconnect_remote_locations.transports.InterconnectRemoteLocationsTransport.__init__') as Transport:
...
def test_interconnect_remote_locations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.interconnect_remote_locations.transports.InterconnectRemoteLocationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_interconnect_remote_locations_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.interconnect_remote_locations.transports.InterconnectRemoteLocationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.InterconnectRemoteLocationsTransport()
        adc.assert_called_once()

...
from google.cloud.compute_v1beta.services.interconnect_attachments import InterconnectAttachmentsClient
from google.cloud.compute_v1beta.services.interconnect_attachments import pagers
from google.cloud.compute_v1beta.services.interconnect_attachments import transports
...
def test__read_environment_variables():
    assert InterconnectAttachmentsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert InterconnectAttachmentsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert InterconnectAttachmentsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert InterconnectAttachmentsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert InterconnectAttachmentsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert InterconnectAttachmentsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert InterconnectAttachmentsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert InterconnectAttachmentsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert InterconnectAttachmentsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(InterconnectAttachmentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(InterconnectAttachmentsClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = InterconnectAttachmentsClient._DEFAULT_UNIVERSE
    default_endpoint = InterconnectAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = InterconnectAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert InterconnectAttachmentsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert InterconnectAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == InterconnectAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    assert InterconnectAttachmentsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert InterconnectAttachmentsClient._get_api_endpoint(None, None, default_universe, "always") == InterconnectAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    assert InterconnectAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == InterconnectAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    assert InterconnectAttachmentsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert InterconnectAttachmentsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        InterconnectAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert InterconnectAttachmentsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert InterconnectAttachmentsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert InterconnectAttachmentsClient._get_universe_domain(None, None) == InterconnectAttachmentsClient._DEFAULT_UNIVERSE
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/interconnectAttachments" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/interconnectAttachments/{interconnect_attachment}" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/interconnectAttachments" % client.transport._host, args[1])
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/interconnectAttachments/{resource}/setLabels" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsInterconnectAttachmentRequest):
    transport_class = transports.InterconnectAttachmentsRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/interconnectAttachments/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListInterconnectAttachmentsRequest):
    client = InterconnectAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectAttachmentAggregatedList.to_json(compute.InterconnectAttachmentAggregatedList())
        ...
        post_with_metadata.return_value = compute.InterconnectAttachmentAggregatedList(), metadata
...
def test_delete_rest_bad_request(request_type=compute.DeleteInterconnectAttachmentRequest):
    client = InterconnectAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_call_success(request_type):
    ...
    assert response.candidate_cloud_router_ip_address == 'candidate_cloud_router_ip_address_value'
    assert response.candidate_cloud_router_ipv6_address == 'candidate_cloud_router_ipv6_address_value'
    assert response.candidate_customer_router_ip_address == 'candidate_customer_router_ip_address_value'
    assert response.candidate_customer_router_ipv6_address == 'candidate_customer_router_ipv6_address_value'
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectAttachment.to_json(compute.InterconnectAttachment())
        req.return_value.content = return_value
...
def test_insert_rest_bad_request(request_type=compute.InsertInterconnectAttachmentRequest):
    client = InterconnectAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_call_success(request_type):
    ...
    for field, value in request_init["interconnect_attachment_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectAttachmentList.to_json(compute.InterconnectAttachmentList())
        req.return_value.content = return_value
...
def test_patch_rest_bad_request(request_type=compute.PatchInterconnectAttachmentRequest):
    client = InterconnectAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
...
def test_set_labels_rest_bad_request(request_type=compute.SetLabelsInterconnectAttachmentRequest):
    client = InterconnectAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_set_labels_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsInterconnectAttachmentRequest):
    client = InterconnectAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsInterconnectAttachmentRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsInterconnectAttachmentRequest.pb(compute.TestIamPermissionsInterconnectAttachmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsInterconnectAttachmentRequest()
...
def test_interconnect_attachments_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.interconnect_attachments.transports.InterconnectAttachmentsTransport.__init__') as Transport:
...
def test_interconnect_attachments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.interconnect_attachments.transports.InterconnectAttachmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_interconnect_attachments_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.interconnect_attachments.transports.InterconnectAttachmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.InterconnectAttachmentsTransport()
        adc.assert_called_once()

...
from google.cloud.compute_v1beta.services.region_instance_group_managers import RegionInstanceGroupManagersClient
from google.cloud.compute_v1beta.services.region_instance_group_managers import pagers
from google.cloud.compute_v1beta.services.region_instance_group_managers import transports
...
@mock.patch.object(RegionInstanceGroupManagersClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionInstanceGroupManagersClient))
def test__get_api_endpoint():
    ...
    assert RegionInstanceGroupManagersClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RegionInstanceGroupManagersClient.DEFAULT_MTLS_ENDPOINT
    assert RegionInstanceGroupManagersClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RegionInstanceGroupManagersClient._get_api_endpoint(None, None, default_universe, "always") == RegionInstanceGroupManagersClient.DEFAULT_MTLS_ENDPOINT
    assert RegionInstanceGroupManagersClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RegionInstanceGroupManagersClient.DEFAULT_MTLS_ENDPOINT
...
def test_abandon_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region_instance_group_managers_abandon_instances_request_resource=compute.RegionInstanceGroupManagersAbandonInstancesRequest(instances=['instances_value']),
        )
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/abandonInstances" % client.transport._host, args[1])
...
def test_apply_updates_to_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/applyUpdatesToInstances" % client.transport._host, args[1])
...
def test_create_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_managers_create_instances_request_resource=compute.RegionInstanceGroupManagersCreateInstancesRequest(instances=[compute.PerInstanceConfig(fingerprint='fingerprint_value')]),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/createInstances" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}" % client.transport._host, args[1])
...
def test_delete_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_managers_delete_instances_request_resource=compute.RegionInstanceGroupManagersDeleteInstancesRequest(instances=['instances_value']),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/deleteInstances" % client.transport._host, args[1])
...
def test_delete_per_instance_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_manager_delete_instance_config_req_resource=compute.RegionInstanceGroupManagerDeleteInstanceConfigReq(names=['names_value']),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/deletePerInstanceConfigs" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            region='region_value',
            instance_group_manager_resource=compute.InstanceGroupManager(all_instances_config=compute.InstanceGroupManagerAllInstancesConfig(properties=compute.InstancePropertiesPatch(labels={'key_value': 'value_value'}))),
        )
        mock_args.update(sample_request)
...
def test_list_errors_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/listErrors" % client.transport._host, args[1])
...
def test_list_managed_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/listManagedInstances" % client.transport._host, args[1])
...
def test_list_per_instance_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/listPerInstanceConfigs" % client.transport._host, args[1])
...
def test_patch_per_instance_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_manager_patch_instance_config_req_resource=compute.RegionInstanceGroupManagerPatchInstanceConfigReq(per_instance_configs=[compute.PerInstanceConfig(fingerprint='fingerprint_value')]),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/patchPerInstanceConfigs" % client.transport._host, args[1])
...
def test_recreate_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_managers_recreate_request_resource=compute.RegionInstanceGroupManagersRecreateRequest(instances=['instances_value']),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/recreateInstances" % client.transport._host, args[1])
...
def test_resize_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/resize" % client.transport._host, args[1])
...
def test_resize_advanced_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instanceGroupManager", "project", "region", "regionInstanceGroupManagersResizeAdvancedRequestResource", )))
...
def test_resize_advanced_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_managers_resize_advanced_request_resource=compute.RegionInstanceGroupManagersResizeAdvancedRequest(no_creation_retries=True),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/resizeAdvanced" % client.transport._host, args[1])
...
def test_resume_instances_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instanceGroupManager", "project", "region", "regionInstanceGroupManagersResumeInstancesRequestResource", )))
...
def test_resume_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_managers_resume_instances_request_resource=compute.RegionInstanceGroupManagersResumeInstancesRequest(instances=['instances_value']),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/resumeInstances" % client.transport._host, args[1])
...
def test_set_auto_healing_policies_rest_required_fields(request_type=compute.SetAutoHealingPoliciesRegionInstanceGroupManagerRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_auto_healing_policies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_auto_healing_policies_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instanceGroupManager", "project", "region", "regionInstanceGroupManagersSetAutoHealingRequestResource", )))
...
def test_set_auto_healing_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_managers_set_auto_healing_request_resource=compute.RegionInstanceGroupManagersSetAutoHealingRequest(auto_healing_policies=[compute.InstanceGroupManagerAutoHealingPolicy(health_check='health_check_value')]),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/setAutoHealingPolicies" % client.transport._host, args[1])
...
def test_set_instance_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_managers_set_template_request_resource=compute.RegionInstanceGroupManagersSetTemplateRequest(instance_template='instance_template_value'),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/setInstanceTemplate" % client.transport._host, args[1])
...
def test_set_target_pools_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_managers_set_target_pools_request_resource=compute.RegionInstanceGroupManagersSetTargetPoolsRequest(fingerprint='fingerprint_value'),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/setTargetPools" % client.transport._host, args[1])
...
def test_start_instances_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instanceGroupManager", "project", "region", "regionInstanceGroupManagersStartInstancesRequestResource", )))
...
def test_start_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_managers_start_instances_request_resource=compute.RegionInstanceGroupManagersStartInstancesRequest(instances=['instances_value']),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/startInstances" % client.transport._host, args[1])
...
def test_stop_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/stopInstances" % client.transport._host, args[1])
...
def test_suspend_instances_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instanceGroupManager", "project", "region", "regionInstanceGroupManagersSuspendInstancesRequestResource", )))
...
def test_suspend_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instance_group_manager='instance_group_manager_value',
            region_instance_group_managers_suspend_instances_request_resource=compute.RegionInstanceGroupManagersSuspendInstancesRequest(force_suspend=True),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/suspendInstances" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_update_per_instance_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/updatePerInstanceConfigs" % client.transport._host, args[1])
...
def test_abandon_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_abandon_instances") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_abandon_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_abandon_instances") as pre:
...
def test_apply_updates_to_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_apply_updates_to_instances") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_apply_updates_to_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_apply_updates_to_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_instances_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'instance_group_manager': 'sample3'}
    request_init["region_instance_group_managers_create_instances_request_resource"] = {'instances': [{'fingerprint': 'fingerprint_value', 'name': 'name_value', 'preserved_state': {'disks': {}, 'external_i_ps': {}, 'internal_i_ps': {}, 'metadata': {}}, 'status': 'status_value'}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_create_instances") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_create_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_create_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_delete_instances") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_delete_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_delete_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_per_instance_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_delete_per_instance_configs") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_delete_per_instance_configs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_delete_per_instance_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2'}
    request_init["instance_group_manager_resource"] = {'all_instances_config': {'properties': {'labels': {}, 'metadata': {}}}, 'auto_healing_policies': [{'health_check': 'health_check_value', 'initial_delay_sec': 1778}], 'base_instance_name': 'base_instance_name_value', 'creation_timestamp': 'creation_timestamp_value', 'current_actions': {'abandoning': 1041, 'creating': 845, 'creating_without_retries': 2589, 'deleting': 844, 'none': 432, 'recreating': 1060, 'refreshing': 1069, 'restarting': 1091, 'resuming': 874, 'starting': 876, 'stopping': 884, 'suspending': 1088, 'verifying': 979}, 'description': 'description_value', 'distribution_policy': {'target_shape': 'target_shape_value', 'zones': [{'zone': 'zone_value'}]}, 'failover_action': 'failover_action_value', 'fingerprint': 'fingerprint_value', 'id': 205, 'instance_flexibility_policy': {'instance_selections': {}, 'provisioning_model_mix': {'standard_capacity_base': 2296, 'standard_capacity_percent_above_base': 3764}}, 'instance_group': 'instance_group_value', 'instance_lifecycle_policy': {'default_action_on_failure': 'default_action_on_failure_value', 'force_update_on_repair': 'force_update_on_repair_value', 'on_failed_health_check': 'on_failed_health_check_value', 'on_repair': {'allow_changing_zone': 'allow_changing_zone_value'}}, 'instance_template': 'instance_template_value', 'kind': 'kind_value', 'list_managed_instances_results': 'list_managed_instances_results_value', 'multi_mig': 'multi_mig_value', 'name': 'name_value', 'named_ports': [{'name': 'name_value', 'port': 453}], 'params': {'resource_manager_tags': {}}, 'region': 'region_value', 'resource_policies': {'workload_policy': 'workload_policy_value'}, 'satisfies_pzi': True, 'satisfies_pzs': True, 'self_link': 'self_link_value', 'service_account': 'service_account_value', 'standby_policy': {'initial_delay_sec': 1778, 'mode': 'mode_value'}, 'stateful_policy': {'preserved_state': {'disks': {}, 'external_i_ps': {}, 'internal_i_ps': {}}}, 'status': {'all_instances_config': {'current_revision': 'current_revision_value', 'effective': True}, 'autoscaler': 'autoscaler_value', 'bulk_instance_operation': {'in_progress': True, 'last_progress_check': {'error': {'errors': [{'code': 'code_value', 'error_details': [{'error_info': {'domain': 'domain_value', 'metadatas': {}, 'reason': 'reason_value'}, 'help_': {'links': [{'description': 'description_value', 'url': 'url_value'}]}, 'localized_message': {'locale': 'locale_value', 'message': 'message_value'}, 'quota_info': {'dimensions': {}, 'future_limit': 0.1305, 'limit': 0.543, 'limit_name': 'limit_name_value', 'metric_name': 'metric_name_value', 'rollout_status': 'rollout_status_value'}}], 'location': 'location_value', 'message': 'message_value'}]}, 'timestamp': 'timestamp_value'}}, 'is_stable': True, 'stateful': {'has_stateful_config': True, 'is_stateful': True, 'per_instance_configs': {'all_effective': True}}, 'version_target': {'is_reached': True}}, 'target_pools': ['target_pools_value1', 'target_pools_value2'], 'target_size': 1185, 'target_size_policy': {'mode': 'mode_value'}, 'target_stopped_size': 2047, 'target_suspended_size': 2251, 'update_policy': {'instance_redistribution_type': 'instance_redistribution_type_value', 'max_surge': {'calculated': 1042, 'fixed': 528, 'percent': 753}, 'max_unavailable': {}, 'min_ready_sec': 1362, 'minimal_action': 'minimal_action_value', 'most_disruptive_allowed_action': 'most_disruptive_allowed_action_value', 'replacement_method': 'replacement_method_value', 'type_': 'type__value'}, 'versions': [{'instance_template': 'instance_template_value', 'name': 'name_value', 'target_size': {}}], 'zone': 'zone_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_errors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_list_errors") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_list_errors_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_list_errors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_managed_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_list_managed_instances") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_list_managed_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_list_managed_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_per_instance_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_list_per_instance_configs") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_list_per_instance_configs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_list_per_instance_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.RegionInstanceGroupManagersListInstanceConfigsResp.to_json(compute.RegionInstanceGroupManagersListInstanceConfigsResp())
        req.return_value.content = return_value
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_patch_per_instance_configs_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'instance_group_manager': 'sample3'}
    request_init["region_instance_group_manager_patch_instance_config_req_resource"] = {'per_instance_configs': [{'fingerprint': 'fingerprint_value', 'name': 'name_value', 'preserved_state': {'disks': {}, 'external_i_ps': {}, 'internal_i_ps': {}, 'metadata': {}}, 'status': 'status_value'}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_patch_per_instance_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_patch_per_instance_configs") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_patch_per_instance_configs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_patch_per_instance_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_recreate_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_recreate_instances") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_recreate_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_recreate_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_resize_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_resize") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_resize_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_resize") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_resize_advanced_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.ResizeAdvancedRegionInstanceGroupManagerRequest.meta.fields["region_instance_group_managers_resize_advanced_request_resource"]
...
def test_resize_advanced_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_resize_advanced") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_resize_advanced_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_resize_advanced") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.resize_advanced(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_resume_instances_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.ResumeInstancesRegionInstanceGroupManagerRequest.meta.fields["region_instance_group_managers_resume_instances_request_resource"]
...
def test_resume_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_resume_instances") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_resume_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_resume_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.resume_instances(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_auto_healing_policies_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'instance_group_manager': 'sample3'}
    request_init["region_instance_group_managers_set_auto_healing_request_resource"] = {'auto_healing_policies': [{'health_check': 'health_check_value', 'initial_delay_sec': 1778}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetAutoHealingPoliciesRegionInstanceGroupManagerRequest.meta.fields["region_instance_group_managers_set_auto_healing_request_resource"]
...
def test_set_auto_healing_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_set_auto_healing_policies") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_set_auto_healing_policies_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_set_auto_healing_policies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetAutoHealingPoliciesRegionInstanceGroupManagerRequest.pb(compute.SetAutoHealingPoliciesRegionInstanceGroupManagerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.set_auto_healing_policies(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_instance_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_set_instance_template") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_set_instance_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_set_instance_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_target_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_set_target_pools") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_set_target_pools_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_set_target_pools") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_start_instances_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.StartInstancesRegionInstanceGroupManagerRequest.meta.fields["region_instance_group_managers_start_instances_request_resource"]
...
def test_start_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_start_instances") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_start_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_start_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.start_instances(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_stop_instances_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'instance_group_manager': 'sample3'}
    request_init["region_instance_group_managers_stop_instances_request_resource"] = {'force_stop': True, 'instances': ['instances_value1', 'instances_value2']}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_stop_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_stop_instances") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_stop_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_stop_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.stop_instances(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_suspend_instances_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'instance_group_manager': 'sample3'}
    request_init["region_instance_group_managers_suspend_instances_request_resource"] = {'force_suspend': True, 'instances': ['instances_value1', 'instances_value2']}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_suspend_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_suspend_instances") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_suspend_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_suspend_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.suspend_instances(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_update") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_update_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_update") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_per_instance_configs_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'instance_group_manager': 'sample3'}
    request_init["region_instance_group_manager_update_instance_config_req_resource"] = {'per_instance_configs': [{'fingerprint': 'fingerprint_value', 'name': 'name_value', 'preserved_state': {'disks': {}, 'external_i_ps': {}, 'internal_i_ps': {}, 'metadata': {}}, 'status': 'status_value'}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_per_instance_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_update_per_instance_configs") as post, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "post_update_per_instance_configs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstanceGroupManagersRestInterceptor, "pre_update_per_instance_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_abandon_instances_unary_empty_call_rest():
    ...
    with mock.patch.object(
            type(client.transport.abandon_instances),
            '__call__') as call:
...
def test_apply_updates_to_instances_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.apply_updates_to_instances),
            '__call__') as call:
...
def test_create_instances_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.create_instances),
            '__call__') as call:
...
def test_delete_instances_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_instances),
            '__call__') as call:
...
def test_delete_per_instance_configs_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_per_instance_configs),
            '__call__') as call:
...
def test_list_errors_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_errors),
            '__call__') as call:
...
def test_list_managed_instances_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_managed_instances),
            '__call__') as call:
...
def test_list_per_instance_configs_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_per_instance_configs),
            '__call__') as call:
...
def test_patch_per_instance_configs_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.patch_per_instance_configs),
            '__call__') as call:
...
def test_recreate_instances_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.recreate_instances),
            '__call__') as call:
...
def test_resize_advanced_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.resize_advanced),
            '__call__') as call:
...
def test_resume_instances_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.resume_instances),
            '__call__') as call:
...
def test_set_auto_healing_policies_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.set_auto_healing_policies),
            '__call__') as call:
...
def test_set_instance_template_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.set_instance_template),
            '__call__') as call:
...
def test_set_target_pools_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.set_target_pools),
            '__call__') as call:
...
def test_start_instances_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.start_instances),
            '__call__') as call:
...
def test_stop_instances_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.stop_instances),
            '__call__') as call:
...
def test_suspend_instances_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.suspend_instances),
            '__call__') as call:
...
def test_update_per_instance_configs_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.update_per_instance_configs),
            '__call__') as call:
...
def test_region_instance_group_managers_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.region_instance_group_managers.transports.RegionInstanceGroupManagersTransport.__init__') as Transport:
...
def test_region_instance_group_managers_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.region_instance_group_managers.transports.RegionInstanceGroupManagersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_instance_group_managers_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.region_instance_group_managers.transports.RegionInstanceGroupManagersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegionInstanceGroupManagersTransport()
        adc.assert_called_once()

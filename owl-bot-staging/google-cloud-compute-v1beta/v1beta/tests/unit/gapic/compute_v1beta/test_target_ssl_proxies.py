...
from google.cloud.compute_v1beta.services.target_ssl_proxies import TargetSslProxiesClient
from google.cloud.compute_v1beta.services.target_ssl_proxies import pagers
from google.cloud.compute_v1beta.services.target_ssl_proxies import transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert TargetSslProxiesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert TargetSslProxiesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert TargetSslProxiesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert TargetSslProxiesClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert TargetSslProxiesClient._get_client_cert_source(None, False) is None
    assert TargetSslProxiesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert TargetSslProxiesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert TargetSslProxiesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert TargetSslProxiesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(TargetSslProxiesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TargetSslProxiesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TargetSslProxiesClient._DEFAULT_UNIVERSE
    default_endpoint = TargetSslProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = TargetSslProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert TargetSslProxiesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert TargetSslProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == TargetSslProxiesClient.DEFAULT_MTLS_ENDPOINT
    assert TargetSslProxiesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert TargetSslProxiesClient._get_api_endpoint(None, None, default_universe, "always") == TargetSslProxiesClient.DEFAULT_MTLS_ENDPOINT
    assert TargetSslProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == TargetSslProxiesClient.DEFAULT_MTLS_ENDPOINT
    assert TargetSslProxiesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert TargetSslProxiesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        TargetSslProxiesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert TargetSslProxiesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert TargetSslProxiesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert TargetSslProxiesClient._get_universe_domain(None, None) == TargetSslProxiesClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = TargetSslProxiesClient(credentials=cred)
...
@mock.patch.object(TargetSslProxiesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TargetSslProxiesClient))
def test_target_ssl_proxies_client_client_api_endpoint(client_class):
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetSslProxies" % client.transport._host, args[1])
...
def test_set_backend_service_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.set_backend_service in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_backend_service] = mock_rpc
...
def test_set_backend_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setBackendService" % client.transport._host, args[1])
...
def test_set_certificate_map_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetSslProxiesClient(
...
def test_set_certificate_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setCertificateMap" % client.transport._host, args[1])
...
def test_set_certificate_map_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetSslProxiesClient(
...
def test_set_proxy_header_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_proxy_header] = mock_rpc
...
def test_set_proxy_header_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setProxyHeader" % client.transport._host, args[1])
...
def test_set_ssl_certificates_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setSslCertificates" % client.transport._host, args[1])
...
def test_set_ssl_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetSslProxiesClient(
        ...
        # Ensure method has been cached
        assert client._transport.set_ssl_policy in client._transport._wrapped_methods
...
def test_set_ssl_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setSslPolicy" % client.transport._host, args[1])
...
def test_set_ssl_policy_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetSslProxiesClient(
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsTargetSslProxyRequest):
    transport_class = transports.TargetSslProxiesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetSslProxies/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_delete_rest_bad_request(request_type=compute.DeleteTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
...
def test_get_rest_bad_request(request_type=compute.GetTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.TargetSslProxy.to_json(compute.TargetSslProxy())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.TargetSslProxy(), metadata
...
def test_insert_rest_bad_request(request_type=compute.InsertTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_insert_rest_call_success(request_type):
    ...
    for field, value in request_init["target_ssl_proxy_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
...
def test_list_rest_bad_request(request_type=compute.ListTargetSslProxiesRequest):
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.TargetSslProxyList.to_json(compute.TargetSslProxyList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.TargetSslProxyList(), metadata
...
def test_set_backend_service_rest_bad_request(request_type=compute.SetBackendServiceTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_backend_service_rest_call_success(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["target_ssl_proxies_set_backend_service_request_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_set_backend_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_backend_service_with_metadata") as post_with_metadata, \
...
def test_set_certificate_map_rest_bad_request(request_type=compute.SetCertificateMapTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_certificate_map_rest_call_success(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["target_ssl_proxies_set_certificate_map_request_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_set_certificate_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_certificate_map_with_metadata") as post_with_metadata, \
...
def test_set_proxy_header_rest_bad_request(request_type=compute.SetProxyHeaderTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_proxy_header_rest_call_success(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["target_ssl_proxies_set_proxy_header_request_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_set_proxy_header_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_proxy_header_with_metadata") as post_with_metadata, \
...
def test_set_ssl_certificates_rest_bad_request(request_type=compute.SetSslCertificatesTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_ssl_certificates_rest_call_success(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["target_ssl_proxies_set_ssl_certificates_request_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_set_ssl_certificates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_ssl_certificates_with_metadata") as post_with_metadata, \
...
def test_set_ssl_policy_rest_bad_request(request_type=compute.SetSslPolicyTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_ssl_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_ssl_policy_with_metadata") as post_with_metadata, \
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsTargetSslProxyRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.TargetSslProxiesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsTargetSslProxyRequest.pb(compute.TestIamPermissionsTargetSslProxyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_set_backend_service_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.set_backend_service),
            '__call__') as call:
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_certificate_map_unary_empty_call_rest():
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.set_certificate_map),
            '__call__') as call:
...
def test_set_proxy_header_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.set_proxy_header),
            '__call__') as call:
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_ssl_policy_unary_empty_call_rest():
    client = TargetSslProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.set_ssl_policy),
            '__call__') as call:
        client.set_ssl_policy_unary(request=None)
...
def test_target_ssl_proxies_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.target_ssl_proxies.transports.TargetSslProxiesTransport.__init__') as Transport:
...
def test_target_ssl_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.target_ssl_proxies.transports.TargetSslProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_target_ssl_proxies_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.target_ssl_proxies.transports.TargetSslProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.TargetSslProxiesTransport()
        adc.assert_called_once()

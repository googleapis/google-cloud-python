...
from google.cloud.compute_v1beta.services.security_policies import SecurityPoliciesClient
from google.cloud.compute_v1beta.services.security_policies import pagers
from google.cloud.compute_v1beta.services.security_policies import transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SecurityPoliciesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SecurityPoliciesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SecurityPoliciesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SecurityPoliciesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert SecurityPoliciesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SecurityPoliciesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert SecurityPoliciesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SecurityPoliciesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(SecurityPoliciesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecurityPoliciesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SecurityPoliciesClient._DEFAULT_UNIVERSE
    default_endpoint = SecurityPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SecurityPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SecurityPoliciesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SecurityPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SecurityPoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert SecurityPoliciesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SecurityPoliciesClient._get_api_endpoint(None, None, default_universe, "always") == SecurityPoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert SecurityPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SecurityPoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert SecurityPoliciesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SecurityPoliciesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SecurityPoliciesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SecurityPoliciesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SecurityPoliciesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SecurityPoliciesClient._get_universe_domain(None, None) == SecurityPoliciesClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = SecurityPoliciesClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (SecurityPoliciesClient, transports.SecurityPoliciesRestTransport, "rest", "true"),
    (SecurityPoliciesClient, transports.SecurityPoliciesRestTransport, "rest", "false"),
])
@mock.patch.object(SecurityPoliciesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecurityPoliciesClient))
...
def test_add_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/global/securityPolicies/{security_policy}/addRule" % client.transport._host, args[1])
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/securityPolicies" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/securityPolicies/{security_policy}" % client.transport._host, args[1])
...
def test_get_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/securityPolicies/{security_policy}/getRule" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            security_policy_resource=compute.SecurityPolicy(adaptive_protection_config=compute.SecurityPolicyAdaptiveProtectionConfig(auto_deploy_config=compute.SecurityPolicyAdaptiveProtectionConfigAutoDeployConfig(confidence_threshold=0.2106))),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/securityPolicies" % client.transport._host, args[1])
...
def test_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.SecurityPolicy)
                for i in results)
...
def test_list_preconfigured_expression_sets_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_preconfigured_expression_sets in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_preconfigured_expression_sets] = mock_rpc
...
def test_list_preconfigured_expression_sets_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/securityPolicies/listPreconfiguredExpressionSets" % client.transport._host, args[1])
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("project", "securityPolicy", "securityPolicyResource", )))
...
def test_patch_rule_rest_required_fields(request_type=compute.PatchRuleSecurityPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).patch_rule._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("priority", "update_mask", "validate_only", ))
    jsonified_request.update(unset_fields)
...
def test_patch_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("priority", "updateMask", "validateOnly", )) & set(("project", "securityPolicy", "securityPolicyRuleResource", )))
...
def test_patch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/securityPolicies/{security_policy}/patchRule" % client.transport._host, args[1])
...
def test_remove_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/securityPolicies/{security_policy}/removeRule" % client.transport._host, args[1])
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/securityPolicies/{resource}/setLabels" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsSecurityPolicyRequest):
    transport_class = transports.SecurityPoliciesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/securityPolicies/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened_error(transport: str = 'rest'):
    ...
    with pytest.raises(ValueError):
        client.test_iam_permissions(
            compute.TestIamPermissionsSecurityPolicyRequest(),
            project='project_value',
            resource='resource_value',
            test_permissions_request_resource=compute.TestPermissionsRequest(permissions=['permissions_value']),
        )
...
def test_add_rule_rest_call_success(request_type):
    ...
    for field, value in request_init["security_policy_rule_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_add_rule_rest_interceptors(null_interceptor):
    transport = transports.SecurityPoliciesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SecurityPoliciesRestInterceptor(),
        )
    client = SecurityPoliciesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_add_rule") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_add_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_add_rule") as pre:
...
def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListSecurityPoliciesRequest):
    client = SecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_aggregated_list") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_aggregated_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SecurityPoliciesAggregatedList.to_json(compute.SecurityPoliciesAggregatedList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.SecurityPoliciesAggregatedList(), metadata
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_get_rule") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_get_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_get_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_call_success(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["security_policy_resource"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_preconfigured_expression_sets_rest_bad_request(request_type=compute.ListPreconfiguredExpressionSetsSecurityPoliciesRequest):
    client = SecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_preconfigured_expression_sets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_list_preconfigured_expression_sets") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_list_preconfigured_expression_sets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_list_preconfigured_expression_sets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SecurityPoliciesListPreconfiguredExpressionSetsResponse.to_json(compute.SecurityPoliciesListPreconfiguredExpressionSetsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.SecurityPoliciesListPreconfiguredExpressionSetsResponse(), metadata
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_patch") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_patch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_patch_rule_rest_bad_request(request_type=compute.PatchRuleSecurityPolicyRequest):
    client = SecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_patch_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_patch_rule") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_patch_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_patch_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_remove_rule_rest_bad_request(request_type=compute.RemoveRuleSecurityPolicyRequest):
    client = SecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_remove_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_remove_rule") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_remove_rule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_remove_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_labels_rest_bad_request(request_type=compute.SetLabelsSecurityPolicyRequest):
    client = SecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_set_labels") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_set_labels_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsSecurityPolicyRequest):
    client = SecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsSecurityPolicyRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecurityPoliciesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsSecurityPolicyRequest.pb(compute.TestIamPermissionsSecurityPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        request = compute.TestIamPermissionsSecurityPolicyRequest()
        metadata =[
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_list_preconfigured_expression_sets_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_preconfigured_expression_sets),
            '__call__') as call:
...
def test_security_policies_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.security_policies.transports.SecurityPoliciesTransport.__init__') as Transport:
...
def test_security_policies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.security_policies.transports.SecurityPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_security_policies_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.security_policies.transports.SecurityPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SecurityPoliciesTransport()
        adc.assert_called_once()
...
def test_security_policies_client_transport_session_collision(transport_name):
    ...
    client2 = SecurityPoliciesClient(
        credentials=creds2,
        transport=transport_name,
    )

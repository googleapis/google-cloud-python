...
from google.cloud.compute_v1beta.services.region_instant_snapshots import RegionInstantSnapshotsClient
from google.cloud.compute_v1beta.services.region_instant_snapshots import pagers
from google.cloud.compute_v1beta.services.region_instant_snapshots import transports
...
def test__get_api_endpoint():
    ...
    assert RegionInstantSnapshotsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RegionInstantSnapshotsClient.DEFAULT_MTLS_ENDPOINT
    assert RegionInstantSnapshotsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RegionInstantSnapshotsClient._get_api_endpoint(None, None, default_universe, "always") == RegionInstantSnapshotsClient.DEFAULT_MTLS_ENDPOINT
    assert RegionInstantSnapshotsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RegionInstantSnapshotsClient.DEFAULT_MTLS_ENDPOINT
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = RegionInstantSnapshotsClient(credentials=cred)
...
def test_region_instant_snapshots_client_get_transport_class():
    transport = RegionInstantSnapshotsClient.get_transport_class()
    ...
    assert transport == transports.RegionInstantSnapshotsRestTransport
...
def test_delete_rest_required_fields(request_type=compute.DeleteRegionInstantSnapshotRequest):
    ...
    jsonified_request["instantSnapshot"] = 'instant_snapshot_value'
    ...
    assert "instantSnapshot" in jsonified_request
    assert jsonified_request["instantSnapshot"] == 'instant_snapshot_value'
...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instantSnapshot", "project", "region", )))
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            instant_snapshot='instant_snapshot_value',
        )
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instantSnapshots/{instant_snapshot}" % client.transport._host, args[1])
...
def test_get_rest_required_fields(request_type=compute.GetRegionInstantSnapshotRequest):
    transport_class = transports.RegionInstantSnapshotsRestTransport
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.InstantSnapshot.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("instantSnapshot", "project", "region", )))
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instantSnapshots/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instantSnapshotResource", "project", "region", )))
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instantSnapshots" % client.transport._host, args[1])
...
def test_list_rest_required_fields(request_type=compute.ListRegionInstantSnapshotsRequest):
    ...
    # Designate an appropriate value for the returned response.
    return_value = compute.InstantSnapshotList()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.InstantSnapshotList.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(compute.InstantSnapshotList.to_json(x) for x in response)
        ...
        assert all(isinstance(i, compute.InstantSnapshot)
                for i in results)
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instantSnapshots/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instantSnapshots/{resource}/setLabels" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/instantSnapshots/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "pre_delete") as pre:
...
def test_get_rest_call_success(request_type):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, compute.InstantSnapshot)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InstantSnapshot.to_json(compute.InstantSnapshot())
        req.return_value.content = return_value
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_get_iam_policy") as post, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_get_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2'}
    request_init["instant_snapshot_resource"] = {'architecture': 'architecture_value', 'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'disk_size_gb': 1261, 'id': 205, 'kind': 'kind_value', 'label_fingerprint': 'label_fingerprint_value', 'labels': {}, 'name': 'name_value', 'region': 'region_value', 'resource_status': {'storage_size_bytes': 1941}, 'satisfies_pzi': True, 'satisfies_pzs': True, 'self_link': 'self_link_value', 'self_link_with_id': 'self_link_with_id_value', 'source_disk': 'source_disk_value', 'source_disk_id': 'source_disk_id_value', 'status': 'status_value', 'zone': 'zone_value'}
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_set_iam_policy") as post, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_set_iam_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_set_labels") as post, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_set_labels_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionInstantSnapshotsRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = compute.DeleteRegionInstantSnapshotRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetRegionInstantSnapshotRequest()
...
def test_get_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetIamPolicyRegionInstantSnapshotRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertRegionInstantSnapshotRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListRegionInstantSnapshotsRequest()
...
def test_set_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetIamPolicyRegionInstantSnapshotRequest()
...
def test_set_labels_unary_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetLabelsRegionInstantSnapshotRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsRegionInstantSnapshotRequest()
...
def test_region_instant_snapshots_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.region_instant_snapshots.transports.RegionInstantSnapshotsTransport.__init__') as Transport:
...
def test_region_instant_snapshots_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.region_instant_snapshots.transports.RegionInstantSnapshotsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_instant_snapshots_base_transport_with_adc():
    # Test the default credentials are used if credentials and credentials_file are None.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.region_instant_snapshots.transports.RegionInstantSnapshotsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegionInstantSnapshotsTransport()
        adc.assert_called_once()
...
def test_region_instant_snapshots_auth_adc():
...
def test_region_instant_snapshots_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = RegionInstantSnapshotsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = RegionInstantSnapshotsClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_common_billing_account_path():
    ...
    actual = RegionInstantSnapshotsClient.common_billing_account_path(billing_account)
...
def test_parse_common_billing_account_path():
    ...
    path = RegionInstantSnapshotsClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionInstantSnapshotsClient.parse_common_billing_account_path(path)
    assert expected == actual

def test_common_folder_path():
    folder = "whelk"
    expected = "folders/{folder}".format(folder=folder, )
    actual = RegionInstantSnapshotsClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = RegionInstantSnapshotsClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionInstantSnapshotsClient.parse_common_folder_path(path)
    assert expected == actual

def test_common_organization_path():
    organization = "oyster"
    expected = "organizations/{organization}".format(organization=organization, )
    actual = RegionInstantSnapshotsClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = RegionInstantSnapshotsClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionInstantSnapshotsClient.parse_common_organization_path(path)
    assert expected == actual

def test_common_project_path():
    project = "cuttlefish"
    expected = "projects/{project}".format(project=project, )
    actual = RegionInstantSnapshotsClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = RegionInstantSnapshotsClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionInstantSnapshotsClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = RegionInstantSnapshotsClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = RegionInstantSnapshotsClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionInstantSnapshotsClient.parse_common_location_path(path)
    assert expected == actual
...
@pytest.mark.parametrize("client_class,transport_class", [
    (RegionInstantSnapshotsClient, transports.RegionInstantSnapshotsRestTransport),
])

...
from google.cloud.compute_v1beta.services.region_target_tcp_proxies import RegionTargetTcpProxiesClient
from google.cloud.compute_v1beta.services.region_target_tcp_proxies import pagers
from google.cloud.compute_v1beta.services.region_target_tcp_proxies import transports
...
def test__get_api_endpoint():
    ...
    assert RegionTargetTcpProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RegionTargetTcpProxiesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionTargetTcpProxiesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RegionTargetTcpProxiesClient._get_api_endpoint(None, None, default_universe, "always") == RegionTargetTcpProxiesClient.DEFAULT_MTLS_ENDPOINT
    assert RegionTargetTcpProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RegionTargetTcpProxiesClient.DEFAULT_MTLS_ENDPOINT
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/targetTcpProxies/{target_tcp_proxy}" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/targetTcpProxies/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "post_delete") as post, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "post_delete_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "pre_delete") as pre:
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "post_get") as post, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "post_get_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "post_insert") as post, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "post_insert_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "post_list") as post, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "post_list_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "post_test_iam_permissions") as post, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "post_test_iam_permissions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.RegionTargetTcpProxiesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_region_target_tcp_proxies_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1beta.services.region_target_tcp_proxies.transports.RegionTargetTcpProxiesTransport.__init__') as Transport:
...
def test_region_target_tcp_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1beta.services.region_target_tcp_proxies.transports.RegionTargetTcpProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_target_tcp_proxies_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1beta.services.region_target_tcp_proxies.transports.RegionTargetTcpProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegionTargetTcpProxiesTransport()
        adc.assert_called_once()

...
class InstanceSettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetInstanceSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetInstanceSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.InstanceSettings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InstanceSettings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_patch(self, request: compute.PatchInstanceSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchInstanceSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class InstanceSettingsServiceRestTransport(_BaseInstanceSettingsServiceRestTransport):
    ...
    class _Get(_BaseInstanceSettingsServiceRestTransport._BaseGet, InstanceSettingsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseInstanceSettingsServiceRestTransport._BaseGet._get_http_options()

            request, metadata = self._interceptor.pre_get(request, metadata)
            transcoded_request = _BaseInstanceSettingsServiceRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseInstanceSettingsServiceRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.InstanceSettingsServiceClient.Get",
                    extra = {
            ...
            # Send the request
            response = InstanceSettingsServiceRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.InstanceSettingsServiceClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.InstanceSettingsService",
                        "rpcName": "Get",
    ...
    class _Patch(_BaseInstanceSettingsServiceRestTransport._BasePatch, InstanceSettingsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseInstanceSettingsServiceRestTransport._BasePatch._get_http_options()

            request, metadata = self._interceptor.pre_patch(request, metadata)
            transcoded_request = _BaseInstanceSettingsServiceRestTransport._BasePatch._get_transcoded_request(http_options, request)

            body = _BaseInstanceSettingsServiceRestTransport._BasePatch._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseInstanceSettingsServiceRestTransport._BasePatch._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.InstanceSettingsServiceClient.Patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.InstanceSettingsService",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = InstanceSettingsServiceRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.InstanceSettingsServiceClient.patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.InstanceSettingsService",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],

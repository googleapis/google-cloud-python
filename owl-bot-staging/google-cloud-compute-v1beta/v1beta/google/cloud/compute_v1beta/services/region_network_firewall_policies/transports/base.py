...
class RegionNetworkFirewallPoliciesTransport(abc.ABC):
    """Abstract transport class for RegionNetworkFirewallPolicies."""
    ...
    @property
    def add_association(self) -> Callable[
    ...
    def get(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.FirewallPolicy]
            ]]:
        raise NotImplementedError()

    @property
    def get_association(self) -> Callable[
    ...
    def get_effective_firewalls(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.RegionNetworkFirewallPoliciesGetEffectiveFirewallsResponse]
            ]]:
        raise NotImplementedError()
    ...
    def get_rule(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.FirewallPolicyRule]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def patch_association(self) -> Callable[
    ...
    @property
    def remove_association(self) -> Callable[

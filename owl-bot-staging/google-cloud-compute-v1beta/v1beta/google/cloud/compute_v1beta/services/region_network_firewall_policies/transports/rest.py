...
class RegionNetworkFirewallPoliciesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_patch_association(self, request: compute.PatchAssociationRegionNetworkFirewallPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchAssociationRegionNetworkFirewallPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_patch_association_with_metadata(self, response: compute.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for patch_association
...
class RegionNetworkFirewallPoliciesRestTransport(_BaseRegionNetworkFirewallPoliciesRestTransport):
    ...
    class _PatchAssociation(_BaseRegionNetworkFirewallPoliciesRestTransport._BasePatchAssociation, RegionNetworkFirewallPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionNetworkFirewallPoliciesRestTransport._PatchAssociation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

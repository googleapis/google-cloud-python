...
from .transports.base import AdviceTransport, DEFAULT_CLIENT_INFO
...
class AdviceClient(metaclass=AdviceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AdviceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AdviceTransport, Callable[..., AdviceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AdviceClient._read_environment_variables()
        self._client_cert_source = AdviceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AdviceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            AdviceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AdviceTransport], Callable[..., AdviceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.AdviceClient`.",
                    extra = {
    ...
    def calendar_mode(self,
            ...
            *,
            ...
            calendar_mode_advice_request_resource: Optional[compute.CalendarModeAdviceRequest] = None,
        ...
        .. code-block:: python
            ...
            def sample_calendar_mode():
                ...
                request = compute_v1beta.CalendarModeAdviceRpcRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.CalendarModeAdviceRpcRequest, dict]):
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            calendar_mode_advice_request_resource (google.cloud.compute_v1beta.types.CalendarModeAdviceRequest):
        ...
        Returns:
            google.cloud.compute_v1beta.types.CalendarModeAdviceResponse:
        ...
        if not isinstance(request, compute.CalendarModeAdviceRpcRequest):
            ...
            if calendar_mode_advice_request_resource is not None:
                request.calendar_mode_advice_request_resource = calendar_mode_advice_request_resource

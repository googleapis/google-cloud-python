...
class AdviceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_calendar_mode(self, request: compute.CalendarModeAdviceRpcRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.CalendarModeAdviceRpcRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_calendar_mode_with_metadata(self, response: compute.CalendarModeAdviceResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.CalendarModeAdviceResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for calendar_mode
    ...
    class _CalendarMode(_BaseAdviceRestTransport._BaseCalendarMode, AdviceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.AdviceClient.CalendarMode",
                    extra = {
            ...
            # Send the request
            response = AdviceRestTransport._CalendarMode._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.AdviceClient.calendar_mode",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Advice",
                        "rpcName": "CalendarMode",

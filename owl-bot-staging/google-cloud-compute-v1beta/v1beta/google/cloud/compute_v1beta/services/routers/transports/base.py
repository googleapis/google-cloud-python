...
class RoutersTransport(abc.ABC):
    ...
    @property
    def delete_route_policy(self) -> Callable[
    ...
    def get(self) -> Callable[
            ...
            Union[
                compute.Router,
                Awaitable[compute.Router]
            ]]:
        raise NotImplementedError()

    @property
    def get_nat_ip_info(self) -> Callable[
            [compute.GetNatIpInfoRouterRequest],
            Union[
                compute.NatIpInfoResponse,
                Awaitable[compute.NatIpInfoResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_nat_mapping_info(self) -> Callable[
    ...
    @property
    def get_route_policy(self) -> Callable[
    ...
    @property
    def get_router_status(self) -> Callable[
    ...
    def list(self) -> Callable[
            ...
            Union[
                compute.RouterList,
                Awaitable[compute.RouterList]
            ]]:
        raise NotImplementedError()

    @property
    def list_bgp_routes(self) -> Callable[
            [compute.ListBgpRoutesRoutersRequest],
            Union[
                compute.RoutersListBgpRoutes,
                Awaitable[compute.RoutersListBgpRoutes]
            ]]:
        raise NotImplementedError()

    @property
    def list_route_policies(self) -> Callable[
    ...
    @property
    def patch_route_policy(self) -> Callable[
    ...
    def preview(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[compute.RoutersPreviewResponse]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def update_route_policy(self) -> Callable[

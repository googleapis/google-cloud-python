...
from google.cloud.compute_v1beta.services.routers import pagers
...
class RoutersClient(metaclass=RoutersClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RoutersClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RoutersTransport, Callable[..., RoutersTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RoutersClient._read_environment_variables()
        self._client_cert_source = RoutersClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RoutersClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RoutersTransport], Callable[..., RoutersTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RoutersClient`.",
                    extra = {
    ...
    def aggregated_list(self,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1beta.AggregatedListRoutersRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListRoutersRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.routers.pagers.AggregatedListPager:
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRouterRequest, dict]):
    ...
    def delete_route_policy_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_route_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteRoutePolicyRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRoutePolicyRouterRequest, dict]):
                The request object. A request message for
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRouterRequest, dict]):
    ...
    def get_nat_ip_info(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetNatIpInfoRouterRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.NatIpInfoResponse:
    ...
    def get_nat_mapping_info(self,
        ...
        .. code-block:: python
            ...
            def sample_get_nat_mapping_info():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetNatMappingInfoRoutersRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetNatMappingInfoRoutersRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.routers.pagers.GetNatMappingInfoPager:
                Contains a list of
    ...
    def get_route_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_get_route_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRoutePolicyRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRoutePolicyRouterRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.RoutersGetRoutePolicyResponse:
    ...
    def get_router_status(self,
        ...
        .. code-block:: python
            ...
            def sample_get_router_status():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRouterStatusRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRouterStatusRouterRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.RouterStatusResponse:
    ...
    def insert_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRouterRequest, dict]):
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            router_resource (google.cloud.compute_v1beta.types.Router):
    ...
    def list(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRoutersRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.routers.pagers.ListPager:
    ...
    def list_bgp_routes(self,
        ...
        .. code-block:: python
            ...
            def sample_list_bgp_routes():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListBgpRoutesRoutersRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListBgpRoutesRoutersRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.routers.pagers.ListBgpRoutesPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def list_route_policies(self,
        ...
        .. code-block:: python
            ...
            def sample_list_route_policies():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListRoutePoliciesRoutersRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRoutePoliciesRoutersRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.routers.pagers.ListRoutePoliciesPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def patch_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchRouterRequest, dict]):
    ...
    def patch_route_policy_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_patch_route_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchRoutePolicyRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchRoutePolicyRouterRequest, dict]):
                The request object. A request message for
            ...
            router (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            route_policy_resource (google.cloud.compute_v1beta.types.RoutePolicy):
                The body resource for this request
    ...
    def preview(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PreviewRouterRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.RoutersPreviewResponse:
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsRouterRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsRouterRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsRouterRequest):
            request = compute.TestIamPermissionsRouterRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def update_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateRouterRequest, dict]):
    ...
    def update_route_policy_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_update_route_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.UpdateRoutePolicyRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateRoutePolicyRouterRequest, dict]):
                The request object. A request message for

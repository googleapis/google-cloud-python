...
class RoutersRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsRouterRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsRouterRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class RoutersRestTransport(_BaseRoutersRestTransport):
    ...
    class _TestIamPermissions(_BaseRoutersRestTransport._BaseTestIamPermissions, RoutersRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RoutersRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

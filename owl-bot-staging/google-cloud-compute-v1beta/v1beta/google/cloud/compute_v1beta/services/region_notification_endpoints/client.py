...
class RegionNotificationEndpointsClient(metaclass=RegionNotificationEndpointsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionNotificationEndpointsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RegionNotificationEndpointsTransport, Callable[..., RegionNotificationEndpointsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionNotificationEndpointsClient._read_environment_variables()
        self._client_cert_source = RegionNotificationEndpointsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionNotificationEndpointsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionNotificationEndpointsTransport], Callable[..., RegionNotificationEndpointsTransport]] = (
                RegionNotificationEndpointsClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., RegionNotificationEndpointsTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionNotificationEndpointsClient`.",
                    extra = {
    ...
    def delete_unary(self,
            request: Optional[Union[compute.DeleteRegionNotificationEndpointRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1beta.DeleteRegionNotificationEndpointRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRegionNotificationEndpointRequest, dict]):
    ...
    def get(self,
            request: Optional[Union[compute.GetRegionNotificationEndpointRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            notification_endpoint: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionNotificationEndpointRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.NotificationEndpoint:
    ...
    def insert_unary(self,
            request: Optional[Union[compute.InsertRegionNotificationEndpointRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertRegionNotificationEndpointRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRegionNotificationEndpointRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            notification_endpoint_resource (google.cloud.compute_v1beta.types.NotificationEndpoint):
    ...
    def list(self,
            request: Optional[Union[compute.ListRegionNotificationEndpointsRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListRegionNotificationEndpointsRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionNotificationEndpointsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_notification_endpoints.pagers.ListPager:
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsRegionNotificationEndpointRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsRegionNotificationEndpointRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsRegionNotificationEndpointRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsRegionNotificationEndpointRequest):
            request = compute.TestIamPermissionsRegionNotificationEndpointRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

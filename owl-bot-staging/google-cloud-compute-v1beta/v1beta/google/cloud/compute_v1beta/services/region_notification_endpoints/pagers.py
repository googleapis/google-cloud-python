...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.NotificationEndpointList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.NotificationEndpointList`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListRegionNotificationEndpointsRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.NotificationEndpointList):

...
class RegionNotificationEndpointsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsRegionNotificationEndpointRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsRegionNotificationEndpointRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class RegionNotificationEndpointsRestTransport(_BaseRegionNotificationEndpointsRestTransport):
    ...
    class _TestIamPermissions(_BaseRegionNotificationEndpointsRestTransport._BaseTestIamPermissions, RegionNotificationEndpointsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionNotificationEndpointsRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

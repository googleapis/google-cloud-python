...
class AggregatedListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.VpnGatewayAggregatedList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.VpnGatewayAggregatedList`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.AggregatedListVpnGatewaysRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.VpnGatewayAggregatedList):
...
class ListPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.VpnGatewayList` object, and
    provides an ``__iter__`` method to iterate through its
    ``items`` field.
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.VpnGatewayList`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListVpnGatewaysRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.VpnGatewayList):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

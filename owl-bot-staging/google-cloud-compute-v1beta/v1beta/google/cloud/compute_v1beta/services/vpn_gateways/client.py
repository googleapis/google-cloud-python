...
class VpnGatewaysClient(metaclass=VpnGatewaysClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.VpnGatewaysClient`.",
                    extra = {
    ...
    def aggregated_list(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListVpnGatewaysRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.vpn_gateways.pagers.AggregatedListPager:
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteVpnGatewayRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteVpnGatewayRequest, dict]):
                The request object. A request message for
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetVpnGatewayRequest(
                    project="project_value",
                    region="region_value",
                    vpn_gateway="vpn_gateway_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetVpnGatewayRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.VpnGateway:
    ...
    def get_status(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetStatusVpnGatewayRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.VpnGatewaysGetStatusResponse:
    ...
    def insert_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertVpnGatewayRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            vpn_gateway_resource (google.cloud.compute_v1beta.types.VpnGateway):
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListVpnGatewaysRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListVpnGatewaysRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.vpn_gateways.pagers.ListPager:
    ...
    def set_labels_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_set_labels():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetLabelsVpnGatewayRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsVpnGatewayRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsVpnGatewayRequest, dict]):
                The request object. A request message for

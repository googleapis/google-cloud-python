...
class TargetInstancesClient(metaclass=TargetInstancesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = TargetInstancesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TargetInstancesTransport, Callable[..., TargetInstancesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = TargetInstancesClient._read_environment_variables()
        self._client_cert_source = TargetInstancesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = TargetInstancesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TargetInstancesTransport], Callable[..., TargetInstancesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.TargetInstancesClient`.",
                    extra = {
    ...
    def aggregated_list(self,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1beta.AggregatedListTargetInstancesRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListTargetInstancesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_instances.pagers.AggregatedListPager:
    ...
    def delete_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteTargetInstanceRequest, dict]):
                The request object. A request message for
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetTargetInstanceRequest(
                    project="project_value",
                    target_instance="target_instance_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetTargetInstanceRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.TargetInstance:
    ...
    def insert_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertTargetInstanceRequest, dict]):
                The request object. A request message for
            ...
            zone (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_instance_resource (google.cloud.compute_v1beta.types.TargetInstance):
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListTargetInstancesRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListTargetInstancesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_instances.pagers.ListPager:
    ...
    def set_security_policy_unary(self,
            request: Optional[Union[compute.SetSecurityPolicyTargetInstanceRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            target_instance: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetSecurityPolicyTargetInstanceRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, target_instance, security_policy_reference_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsTargetInstanceRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsTargetInstanceRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsTargetInstanceRequest, dict]):
                The request object. A request message for

...
class NodeTypesClientMeta(type):
    """Metaclass for the NodeTypes client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[NodeTypesTransport]]
    _transport_registry["rest"] = NodeTypesRestTransport
...
class NodeTypesClient(metaclass=NodeTypesClientMeta):
    """The NodeTypes API."""
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            NodeTypesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> NodeTypesTransport:
        """Returns the transport used by the client instance.

        Returns:
            NodeTypesTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = NodeTypesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = NodeTypesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = NodeTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = NodeTypesClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, NodeTypesTransport, Callable[..., NodeTypesTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,NodeTypesTransport,Callable[..., NodeTypesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the NodeTypesTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = NodeTypesClient._read_environment_variables()
        self._client_cert_source = NodeTypesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = NodeTypesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, NodeTypesTransport)
        if transport_provided:
            # transport is a NodeTypesTransport instance.
            ...
            self._transport = cast(NodeTypesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            NodeTypesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[NodeTypesTransport], Callable[..., NodeTypesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.NodeTypesClient`.",
                    extra = {
    ...
    def aggregated_list(self,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                # Create a client
                client = compute_v1beta.NodeTypesClient()

                # Initialize request argument(s)
                request = compute_v1beta.AggregatedListNodeTypesRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListNodeTypesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.node_types.pagers.AggregatedListPager:
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetNodeTypeRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetNodeTypeRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.types.NodeType:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, node_type]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListNodeTypesRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListNodeTypesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.node_types.pagers.ListPager:

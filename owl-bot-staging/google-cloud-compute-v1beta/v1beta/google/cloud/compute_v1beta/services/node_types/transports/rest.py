    ...
    class _AggregatedList(_BaseNodeTypesRestTransport._BaseAggregatedList, NodeTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NodeTypesClient.AggregatedList",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NodeTypesClient.aggregated_list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NodeTypes",
                        "rpcName": "AggregatedList",
    ...
    class _Get(_BaseNodeTypesRestTransport._BaseGet, NodeTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NodeTypesClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NodeTypes",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NodeTypesClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NodeTypes",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseNodeTypesRestTransport._BaseList, NodeTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NodeTypesClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NodeTypes",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NodeTypesClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NodeTypes",
                        "rpcName": "List",
                        "metadata": http_response["headers"],

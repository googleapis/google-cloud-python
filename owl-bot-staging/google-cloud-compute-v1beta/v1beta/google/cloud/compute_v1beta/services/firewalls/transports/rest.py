...
class FirewallsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsFirewallRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsFirewallRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class FirewallsRestTransport(_BaseFirewallsRestTransport):
    ...
    class _TestIamPermissions(_BaseFirewallsRestTransport._BaseTestIamPermissions, FirewallsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FirewallsRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

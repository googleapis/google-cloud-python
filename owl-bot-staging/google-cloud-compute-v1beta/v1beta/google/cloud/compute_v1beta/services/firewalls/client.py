...
from google.cloud.compute_v1beta.services.firewalls import pagers
...
class FirewallsClient(metaclass=FirewallsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = FirewallsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FirewallsTransport, Callable[..., FirewallsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = FirewallsClient._read_environment_variables()
        self._client_cert_source = FirewallsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = FirewallsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            FirewallsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[FirewallsTransport], Callable[..., FirewallsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.FirewallsClient`.",
                    extra = {
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1beta.DeleteFirewallRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteFirewallRequest, dict]):
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetFirewallRequest(
                    firewall="firewall_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetFirewallRequest, dict]):
    ...
    def insert_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertFirewallRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertFirewallRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            firewall_resource (google.cloud.compute_v1beta.types.Firewall):
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListFirewallsRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListFirewallsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.firewalls.pagers.ListPager:
    ...
    def patch_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchFirewallRequest(
                    firewall="firewall_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchFirewallRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsFirewallRequest, dict]] = None,
            *,
            project: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsFirewallRequest, dict]):
                The request object. A request message for
    ...
    def update_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_update():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.UpdateFirewallRequest(
                    firewall="firewall_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateFirewallRequest, dict]):
                The request object. A request message for

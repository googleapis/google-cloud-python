...
class RegionInstancesClient(metaclass=RegionInstancesClientMeta):
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            RegionInstancesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionInstancesClient`.",
                    extra = {
    ...
    def bulk_insert_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_bulk_insert():
                # Create a client
                client = compute_v1beta.RegionInstancesClient()

                # Initialize request argument(s)
                request = compute_v1beta.BulkInsertRegionInstanceRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.BulkInsertRegionInstanceRequest, dict]):
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            bulk_insert_instance_resource_resource (google.cloud.compute_v1beta.types.BulkInsertInstanceResource):

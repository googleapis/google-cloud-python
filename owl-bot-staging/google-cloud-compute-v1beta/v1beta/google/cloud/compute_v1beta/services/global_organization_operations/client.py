...
from google.cloud.compute_v1beta.services.global_organization_operations import pagers
...
class GlobalOrganizationOperationsClient(metaclass=GlobalOrganizationOperationsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = GlobalOrganizationOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GlobalOrganizationOperationsTransport, Callable[..., GlobalOrganizationOperationsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GlobalOrganizationOperationsClient._read_environment_variables()
        self._client_cert_source = GlobalOrganizationOperationsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = GlobalOrganizationOperationsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, GlobalOrganizationOperationsTransport)
        ...
        self._api_endpoint = (self._api_endpoint or
            GlobalOrganizationOperationsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[GlobalOrganizationOperationsTransport], Callable[..., GlobalOrganizationOperationsTransport]] = (
                GlobalOrganizationOperationsClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., GlobalOrganizationOperationsTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.GlobalOrganizationOperationsClient`.",
                    extra = {
    ...
    def delete(self,
            request: Optional[Union[compute.DeleteGlobalOrganizationOperationRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1beta.DeleteGlobalOrganizationOperationRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteGlobalOrganizationOperationRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.types.DeleteGlobalOrganizationOperationResponse:
    ...
    def get(self,
            request: Optional[Union[compute.GetGlobalOrganizationOperationRequest, dict]] = None,
            *,
            operation: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetGlobalOrganizationOperationRequest(
                    operation="operation_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetGlobalOrganizationOperationRequest, dict]):
                The request object. A request message for
                GlobalOrganizationOperations.Get. See
                the method description for details.
            operation (str):
                Name of the Operations resource to
                return. Parent is derived from this
                field.
    ...
    def list(self,
            request: Optional[Union[compute.ListGlobalOrganizationOperationsRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListGlobalOrganizationOperationsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.global_organization_operations.pagers.ListPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListGlobalOrganizationOperationsRequest):
            request = compute.ListGlobalOrganizationOperationsRequest(request)

    ...
    class _Get(_BaseSnapshotSettingsServiceRestTransport._BaseGet, SnapshotSettingsServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.SnapshotSettingsServiceClient.Get",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.SnapshotSettingsServiceClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.SnapshotSettingsService",
                        "rpcName": "Get",
    ...
    class _Patch(_BaseSnapshotSettingsServiceRestTransport._BasePatch, SnapshotSettingsServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.SnapshotSettingsServiceClient.Patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.SnapshotSettingsService",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.SnapshotSettingsServiceClient.patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.SnapshotSettingsService",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],

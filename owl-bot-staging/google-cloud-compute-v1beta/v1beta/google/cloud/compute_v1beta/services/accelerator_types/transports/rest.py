...
class AcceleratorTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListAcceleratorTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListAcceleratorTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.AcceleratorTypeAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AcceleratorTypeAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_get(self, request: compute.GetAcceleratorTypeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetAcceleratorTypeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.AcceleratorType, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AcceleratorType, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_list(self, request: compute.ListAcceleratorTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListAcceleratorTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.AcceleratorTypeList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AcceleratorTypeList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class AcceleratorTypesRestTransport(_BaseAcceleratorTypesRestTransport):
    ...
    class _AggregatedList(_BaseAcceleratorTypesRestTransport._BaseAggregatedList, AcceleratorTypesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AcceleratorTypesRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseAcceleratorTypesRestTransport._BaseGet, AcceleratorTypesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AcceleratorTypesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _List(_BaseAcceleratorTypesRestTransport._BaseList, AcceleratorTypesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AcceleratorTypesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

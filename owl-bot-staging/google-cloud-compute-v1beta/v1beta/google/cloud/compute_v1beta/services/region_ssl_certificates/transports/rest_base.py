...
class _BaseRegionSslCertificatesRestTransport(RegionSslCertificatesTransport):
    ...
    class _BaseDelete:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/compute/beta/projects/{project}/regions/{region}/sslCertificates/{ssl_certificate}',
            },
            ]
            return http_options
    ...
    class _BaseInsert:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/regions/{region}/sslCertificates',
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/regions/{region}/sslCertificates/{resource}/testIamPermissions',
...
__all__=(
    '_BaseRegionSslCertificatesRestTransport',
)

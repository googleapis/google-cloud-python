...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.PublicDelegatedPrefixList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.PublicDelegatedPrefixList`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListGlobalPublicDelegatedPrefixesRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.PublicDelegatedPrefixList):

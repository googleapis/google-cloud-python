...
from google.cloud.compute_v1beta.services.global_public_delegated_prefixes import pagers
...
class GlobalPublicDelegatedPrefixesClient(metaclass=GlobalPublicDelegatedPrefixesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = GlobalPublicDelegatedPrefixesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GlobalPublicDelegatedPrefixesTransport, Callable[..., GlobalPublicDelegatedPrefixesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GlobalPublicDelegatedPrefixesClient._read_environment_variables()
        self._client_cert_source = GlobalPublicDelegatedPrefixesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = GlobalPublicDelegatedPrefixesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, GlobalPublicDelegatedPrefixesTransport)
        ...
        self._api_endpoint = (self._api_endpoint or
            GlobalPublicDelegatedPrefixesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[GlobalPublicDelegatedPrefixesTransport], Callable[..., GlobalPublicDelegatedPrefixesTransport]] = (
                GlobalPublicDelegatedPrefixesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., GlobalPublicDelegatedPrefixesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.GlobalPublicDelegatedPrefixesClient`.",
                    extra = {
    ...
    def delete_unary(self,
            request: Optional[Union[compute.DeleteGlobalPublicDelegatedPrefixeRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                # Create a client
                client = compute_v1beta.GlobalPublicDelegatedPrefixesClient()

                # Initialize request argument(s)
                request = compute_v1beta.DeleteGlobalPublicDelegatedPrefixeRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteGlobalPublicDelegatedPrefixeRequest, dict]):
        ...
        flattened_params = [project, public_delegated_prefix]
    ...
    def get(self,
            request: Optional[Union[compute.GetGlobalPublicDelegatedPrefixeRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            public_delegated_prefix: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetGlobalPublicDelegatedPrefixeRequest(
                    project="project_value",
                    public_delegated_prefix="public_delegated_prefix_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetGlobalPublicDelegatedPrefixeRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetGlobalPublicDelegatedPrefixeRequest):
            request = compute.GetGlobalPublicDelegatedPrefixeRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def insert_unary(self,
            request: Optional[Union[compute.InsertGlobalPublicDelegatedPrefixeRequest, dict]] = None,
            *,
            project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertGlobalPublicDelegatedPrefixeRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertGlobalPublicDelegatedPrefixeRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, public_delegated_prefix_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list(self,
            request: Optional[Union[compute.ListGlobalPublicDelegatedPrefixesRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListGlobalPublicDelegatedPrefixesRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListGlobalPublicDelegatedPrefixesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.global_public_delegated_prefixes.pagers.ListPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListGlobalPublicDelegatedPrefixesRequest):
            request = compute.ListGlobalPublicDelegatedPrefixesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def patch_unary(self,
            request: Optional[Union[compute.PatchGlobalPublicDelegatedPrefixeRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            public_delegated_prefix: Optional[str] = None,
            public_delegated_prefix_resource: Optional[compute.PublicDelegatedPrefix] = None,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchGlobalPublicDelegatedPrefixeRequest(
                    project="project_value",
                    public_delegated_prefix="public_delegated_prefix_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchGlobalPublicDelegatedPrefixeRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, public_delegated_prefix, public_delegated_prefix_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')

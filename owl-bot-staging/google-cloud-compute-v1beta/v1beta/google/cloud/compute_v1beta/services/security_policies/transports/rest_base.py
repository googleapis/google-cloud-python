...
class _BaseSecurityPoliciesRestTransport(SecurityPoliciesTransport):
    ...
    class _BaseAddRule:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/securityPolicies/{security_policy}/addRule',
    ...
    class _BaseAggregatedList:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/compute/beta/projects/{project}/aggregated/securityPolicies',
            },
            ]
            return http_options
    ...
    class _BaseDelete:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/compute/beta/projects/{project}/global/securityPolicies/{security_policy}',
            },
            ]
            return http_options
    ...
    class _BaseGetRule:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/compute/beta/projects/{project}/global/securityPolicies/{security_policy}/getRule',
            },
            ]
            return http_options
    ...
    class _BaseInsert:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/securityPolicies',
    ...
    class _BaseListPreconfiguredExpressionSets:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/compute/beta/projects/{project}/global/securityPolicies/listPreconfiguredExpressionSets',
            },
            ]
            return http_options
    ...
    class _BasePatchRule:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/securityPolicies/{security_policy}/patchRule',
                'body': 'security_policy_rule_resource',
            },
            ]
            return http_options
    ...
    class _BaseRemoveRule:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/securityPolicies/{security_policy}/removeRule',
            },
            ]
            return http_options
    ...
    class _BaseSetLabels:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/securityPolicies/{resource}/setLabels',
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/securityPolicies/{resource}/testIamPermissions',
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.TestIamPermissionsSecurityPolicyRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSecurityPoliciesRestTransport._BaseTestIamPermissions._get_unset_required_fields(query_params))

            return query_params


__all__=(
    '_BaseSecurityPoliciesRestTransport',
)

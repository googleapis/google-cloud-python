...
class SecurityPoliciesClient(metaclass=SecurityPoliciesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = SecurityPoliciesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = SecurityPoliciesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SecurityPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SecurityPoliciesClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SecurityPoliciesTransport, Callable[..., SecurityPoliciesTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,SecurityPoliciesTransport,Callable[..., SecurityPoliciesTransport]]]):
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SecurityPoliciesClient._read_environment_variables()
        self._client_cert_source = SecurityPoliciesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SecurityPoliciesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SecurityPoliciesTransport)
        if transport_provided:
            ...
            self._transport = cast(SecurityPoliciesTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SecurityPoliciesTransport], Callable[..., SecurityPoliciesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.SecurityPoliciesClient`.",
                    extra = {
    ...
    def add_rule_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_add_rule():
                ...
                request = compute_v1beta.AddRuleSecurityPolicyRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AddRuleSecurityPolicyRequest, dict]):
        ...
        flattened_params = [project, security_policy, security_policy_rule_resource]
    ...
    def aggregated_list(self,
            request: Optional[Union[compute.AggregatedListSecurityPoliciesRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.AggregatedListSecurityPoliciesRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListSecurityPoliciesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.security_policies.pagers.AggregatedListPager:
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteSecurityPolicyRequest(
                    project="project_value",
                    security_policy="security_policy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteSecurityPolicyRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, security_policy]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetSecurityPolicyRequest(
                    project="project_value",
                    security_policy="security_policy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetSecurityPolicyRequest, dict]):
                The request object. A request message for
    ...
    def get_rule(self,
        ...
        .. code-block:: python
            ...
            def sample_get_rule():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRuleSecurityPolicyRequest(
                    project="project_value",
                    security_policy="security_policy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRuleSecurityPolicyRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertSecurityPolicyRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertSecurityPolicyRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, security_policy_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListSecurityPoliciesRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListSecurityPoliciesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.security_policies.pagers.ListPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def list_preconfigured_expression_sets(self,
            request: Optional[Union[compute.ListPreconfiguredExpressionSetsSecurityPoliciesRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list_preconfigured_expression_sets():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListPreconfiguredExpressionSetsSecurityPoliciesRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListPreconfiguredExpressionSetsSecurityPoliciesRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListPreconfiguredExpressionSetsSecurityPoliciesRequest):
            request = compute.ListPreconfiguredExpressionSetsSecurityPoliciesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def patch_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchSecurityPolicyRequest(
                    project="project_value",
                    security_policy="security_policy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchSecurityPolicyRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, security_policy, security_policy_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def patch_rule_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_patch_rule():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchRuleSecurityPolicyRequest(
                    project="project_value",
                    security_policy="security_policy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchRuleSecurityPolicyRequest, dict]):
                The request object. A request message for
    ...
    def remove_rule_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.RemoveRuleSecurityPolicyRequest, dict]):
                The request object. A request message for
    ...
    def set_labels_unary(self,
            ...
            *,
            ...
            global_set_labels_request_resource: Optional[compute.GlobalSetLabelsRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_set_labels():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetLabelsSecurityPolicyRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsSecurityPolicyRequest, dict]):
                The request object. A request message for
            ...
            resource (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            global_set_labels_request_resource (google.cloud.compute_v1beta.types.GlobalSetLabelsRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, resource, global_set_labels_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.SetLabelsSecurityPolicyRequest):
            request = compute.SetLabelsSecurityPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            ...
            if global_set_labels_request_resource is not None:
                request.global_set_labels_request_resource = global_set_labels_request_resource
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsSecurityPolicyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            resource: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsSecurityPolicyRequest(
                    project="project_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsSecurityPolicyRequest, dict]):
                The request object. A request message for
                SecurityPolicies.TestIamPermissions. See
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsSecurityPolicyRequest):
            request = compute.TestIamPermissionsSecurityPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def __enter__(self) -> "SecurityPoliciesClient":
        return self

...
from google.cloud.compute_v1beta.services.region_instance_groups import pagers
...
class RegionInstanceGroupsClient(metaclass=RegionInstanceGroupsClientMeta):
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            RegionInstanceGroupsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionInstanceGroupsClient`.",
                    extra = {
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                request = compute_v1beta.GetRegionInstanceGroupRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionInstanceGroupRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.types.InstanceGroup:
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListRegionInstanceGroupsRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionInstanceGroupsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_instance_groups.pagers.ListPager:
    ...
    def list_instances(self,
        ...
        .. code-block:: python
            ...
            def sample_list_instances():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListInstancesRegionInstanceGroupsRequest(
                    instance_group="instance_group_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListInstancesRegionInstanceGroupsRequest, dict]):
                The request object. A request message for
            ...
            instance_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            region_instance_groups_list_instances_request_resource (google.cloud.compute_v1beta.types.RegionInstanceGroupsListInstancesRequest):
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_instance_groups.pagers.ListInstancesPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def set_named_ports_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetNamedPortsRegionInstanceGroupRequest, dict]):
                The request object. A request message for
            ...
            instance_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            region_instance_groups_set_named_ports_request_resource (google.cloud.compute_v1beta.types.RegionInstanceGroupsSetNamedPortsRequest):
                The body resource for this request
    ...
    def test_iam_permissions(self,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsRegionInstanceGroupRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsRegionInstanceGroupRequest, dict]):
                The request object. A request message for

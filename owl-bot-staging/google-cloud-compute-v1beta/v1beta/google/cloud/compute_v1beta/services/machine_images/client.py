...
from google.cloud.compute_v1beta.services.machine_images import pagers
...
class MachineImagesClient(metaclass=MachineImagesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = MachineImagesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = MachineImagesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = MachineImagesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = MachineImagesClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, MachineImagesTransport, Callable[..., MachineImagesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = MachineImagesClient._read_environment_variables()
        self._client_cert_source = MachineImagesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = MachineImagesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, MachineImagesTransport)
        if transport_provided:
            ...
            self._transport = cast(MachineImagesTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[MachineImagesTransport], Callable[..., MachineImagesTransport]] = (
                MachineImagesClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.MachineImagesClient`.",
                    extra = {
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                # Create a client
                client = compute_v1beta.MachineImagesClient()

                # Initialize request argument(s)
                request = compute_v1beta.DeleteMachineImageRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteMachineImageRequest, dict]):
        ...
        flattened_params = [project, machine_image]
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetMachineImageRequest(
                    machine_image="machine_image_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetMachineImageRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.MachineImage:
    ...
    def get_iam_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetIamPolicyMachineImageRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyMachineImageRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertMachineImageRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertMachineImageRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            machine_image_resource (google.cloud.compute_v1beta.types.MachineImage):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, machine_image_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListMachineImagesRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListMachineImagesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.machine_images.pagers.ListPager:
    ...
    def set_iam_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_set_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetIamPolicyMachineImageRequest(
                    project="project_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyMachineImageRequest, dict]):
                The request object. A request message for
    ...
    def set_labels_unary(self,
            request: Optional[Union[compute.SetLabelsMachineImageRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            resource: Optional[str] = None,
        ...
        r"""Sets the labels on a machine image. To learn more
        ...
        .. code-block:: python
            ...
            def sample_set_labels():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetLabelsMachineImageRequest(
                    project="project_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsMachineImageRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.SetLabelsMachineImageRequest):
            request = compute.SetLabelsMachineImageRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsMachineImageRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            resource: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsMachineImageRequest(
                    project="project_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsMachineImageRequest, dict]):
                The request object. A request message for

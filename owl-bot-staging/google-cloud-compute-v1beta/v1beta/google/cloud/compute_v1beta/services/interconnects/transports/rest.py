...
from .rest_base import _BaseInterconnectsRestTransport
    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomInterconnectsInterceptor(InterconnectsRestInterceptor):
            ...
            def pre_get_diagnostics(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_diagnostics(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    """
    def pre_delete(self, request: compute.DeleteInterconnectRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteInterconnectRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetInterconnectRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetInterconnectRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.Interconnect, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Interconnect, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_get_diagnostics(self, request: compute.GetDiagnosticsInterconnectRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetDiagnosticsInterconnectRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_diagnostics(self, response: compute.InterconnectsGetDiagnosticsResponse) -> compute.InterconnectsGetDiagnosticsResponse:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the Interconnects server but before
        it is returned to user code. This `post_get_diagnostics` interceptor runs
        before the `post_get_diagnostics_with_metadata` interceptor.
        """
        return response

    def post_get_diagnostics_with_metadata(self, response: compute.InterconnectsGetDiagnosticsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InterconnectsGetDiagnosticsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_diagnostics

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the Interconnects server but before it is returned to user code.

        We recommend only using this `post_get_diagnostics_with_metadata`
        interceptor in new development instead of the `post_get_diagnostics` interceptor.
        When both interceptors are used, this `post_get_diagnostics_with_metadata` interceptor runs after the
        `post_get_diagnostics` interceptor. The (possibly modified) response returned by
        `post_get_diagnostics` will be passed to
        `post_get_diagnostics_with_metadata`.
        """
        return response, metadata

    def pre_get_macsec_config(self, request: compute.GetMacsecConfigInterconnectRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetMacsecConfigInterconnectRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_macsec_config(self, response: compute.InterconnectsGetMacsecConfigResponse) -> compute.InterconnectsGetMacsecConfigResponse:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the Interconnects server but before
        it is returned to user code. This `post_get_macsec_config` interceptor runs
        before the `post_get_macsec_config_with_metadata` interceptor.
        """
        return response

    def post_get_macsec_config_with_metadata(self, response: compute.InterconnectsGetMacsecConfigResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InterconnectsGetMacsecConfigResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_macsec_config

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the Interconnects server but before it is returned to user code.

        We recommend only using this `post_get_macsec_config_with_metadata`
        interceptor in new development instead of the `post_get_macsec_config` interceptor.
        When both interceptors are used, this `post_get_macsec_config_with_metadata` interceptor runs after the
        `post_get_macsec_config` interceptor. The (possibly modified) response returned by
        `post_get_macsec_config` will be passed to
        `post_get_macsec_config_with_metadata`.
        """
        return response, metadata

    def pre_insert(self, request: compute.InsertInterconnectRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertInterconnectRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListInterconnectsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListInterconnectsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.InterconnectList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InterconnectList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_patch(self, request: compute.PatchInterconnectRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchInterconnectRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_set_labels(self, request: compute.SetLabelsInterconnectRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SetLabelsInterconnectRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsInterconnectRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsInterconnectRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class InterconnectsRestTransport(_BaseInterconnectsRestTransport):
    """REST backend synchronous transport for Interconnects.
    ...
    class _Delete(_BaseInterconnectsRestTransport._BaseDelete, InterconnectsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.InterconnectsClient.Delete",
                    extra = {
            ...
            # Send the request
            response = InterconnectsRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.InterconnectsClient.delete",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "Delete",
    ...
    class _Get(_BaseInterconnectsRestTransport._BaseGet, InterconnectsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.InterconnectsClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.InterconnectsClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _GetDiagnostics(_BaseInterconnectsRestTransport._BaseGetDiagnostics, InterconnectsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.InterconnectsClient.GetDiagnostics",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
            ...
            # Send the request
            response = InterconnectsRestTransport._GetDiagnostics._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = compute.InterconnectsGetDiagnosticsResponse()
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.InterconnectsClient.get_diagnostics",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "GetDiagnostics",
                        "metadata": http_response["headers"],
    ...
    class _GetMacsecConfig(_BaseInterconnectsRestTransport._BaseGetMacsecConfig, InterconnectsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.InterconnectsClient.GetMacsecConfig",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
            ...
            # Send the request
            response = InterconnectsRestTransport._GetMacsecConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.InterconnectsClient.get_macsec_config",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "GetMacsecConfig",
                        "metadata": http_response["headers"],
    ...
    class _Insert(_BaseInterconnectsRestTransport._BaseInsert, InterconnectsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.InterconnectsClient.Insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = InterconnectsRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.InterconnectsClient.insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseInterconnectsRestTransport._BaseList, InterconnectsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.InterconnectsClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.InterconnectsClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _Patch(_BaseInterconnectsRestTransport._BasePatch, InterconnectsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.InterconnectsClient.Patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = InterconnectsRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.InterconnectsClient.patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
    ...
    class _SetLabels(_BaseInterconnectsRestTransport._BaseSetLabels, InterconnectsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.InterconnectsClient.SetLabels",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "SetLabels",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = InterconnectsRestTransport._SetLabels._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.InterconnectsClient.set_labels",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "SetLabels",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(_BaseInterconnectsRestTransport._BaseTestIamPermissions, InterconnectsRestStub):
        def __hash__(self):
            return hash("InterconnectsRestTransport.TestIamPermissions")
        ...
        def __call__(self,
            ...
            Args:
                request (~.compute.TestIamPermissionsInterconnectRequest):
                    The request object. A request message for
                Interconnects.TestIamPermissions. See
            ...
            transcoded_request = _BaseInterconnectsRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseInterconnectsRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseInterconnectsRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.InterconnectsClient.TestIamPermissions",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
            ...
            # Send the request
            response = InterconnectsRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.InterconnectsClient.test_iam_permissions",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Interconnects",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
    ...
    @property
    def get_diagnostics(self) -> Callable[
    ...
    @property
    def get_macsec_config(self) -> Callable[
    ...
    def test_iam_permissions(self) -> Callable[
            [compute.TestIamPermissionsInterconnectRequest],
            compute.TestPermissionsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

...
class _BaseLicensesRestTransport(LicensesTransport):
    ...
    class _BaseDelete:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/compute/beta/projects/{project}/global/licenses/{license_}',
            },
            ]
            return http_options
    ...
    class _BaseGetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/compute/beta/projects/{project}/global/licenses/{resource}/getIamPolicy',
            },
            ]
            return http_options
    ...
    class _BaseInsert:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/licenses',
    ...
    class _BaseSetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/licenses/{resource}/setIamPolicy',
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/licenses/{resource}/testIamPermissions',

...
class LicensesClient(metaclass=LicensesClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.LicensesClient`.",
                    extra = {
    ...
    def delete_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteLicenseRequest, dict]):
    ...
    def get(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetLicenseRequest, dict]):
    ...
    def get_iam_policy(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyLicenseRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertLicenseRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            license_resource (google.cloud.compute_v1beta.types.License):
    ...
    def list(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListLicensesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.licenses.pagers.ListPager:
    ...
    def set_iam_policy(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyLicenseRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(self,
        ...
        *Caution* This resource is intended for use only by third-party
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsLicenseRequest, dict]):
                The request object. A request message for
    ...
    def update_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateLicenseRequest, dict]):
                The request object. A request message for

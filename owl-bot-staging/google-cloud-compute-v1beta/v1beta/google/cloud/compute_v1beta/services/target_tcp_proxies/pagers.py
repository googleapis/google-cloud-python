...
class AggregatedListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.TargetTcpProxyAggregatedList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.TargetTcpProxyAggregatedList`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.AggregatedListTargetTcpProxiesRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.TargetTcpProxyAggregatedList):
...
class ListPager:
    ...
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListTargetTcpProxiesRequest):
                The initial request object.

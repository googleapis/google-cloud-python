...
class TargetTcpProxiesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsTargetTcpProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsTargetTcpProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class TargetTcpProxiesRestTransport(_BaseTargetTcpProxiesRestTransport):
    ...
    class _TestIamPermissions(_BaseTargetTcpProxiesRestTransport._BaseTestIamPermissions, TargetTcpProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TargetTcpProxiesRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class UrlMapsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsUrlMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class UrlMapsRestTransport(_BaseUrlMapsRestTransport):
    ...
    class _TestIamPermissions(_BaseUrlMapsRestTransport._BaseTestIamPermissions, UrlMapsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UrlMapsRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

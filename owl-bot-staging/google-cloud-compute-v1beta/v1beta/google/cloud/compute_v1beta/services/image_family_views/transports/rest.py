...
class ImageFamilyViewsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetImageFamilyViewRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetImageFamilyViewRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.ImageFamilyView, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ImageFamilyView, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
...
class ImageFamilyViewsRestTransport(_BaseImageFamilyViewsRestTransport):
    ...
    class _Get(_BaseImageFamilyViewsRestTransport._BaseGet, ImageFamilyViewsRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseImageFamilyViewsRestTransport._BaseGet._get_http_options()

            request, metadata = self._interceptor.pre_get(request, metadata)
            transcoded_request = _BaseImageFamilyViewsRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseImageFamilyViewsRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.ImageFamilyViewsClient.Get",
                    extra = {
            ...
            # Send the request
            response = ImageFamilyViewsRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.ImageFamilyViewsClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.ImageFamilyViews",
                        "rpcName": "Get",

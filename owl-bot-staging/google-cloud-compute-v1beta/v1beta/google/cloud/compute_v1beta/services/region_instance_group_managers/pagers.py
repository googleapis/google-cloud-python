...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.RegionInstanceGroupManagerList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.RegionInstanceGroupManagerList`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListRegionInstanceGroupManagersRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.RegionInstanceGroupManagerList):
...
class ListErrorsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.RegionInstanceGroupManagersListErrorsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``items`` field.
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.RegionInstanceGroupManagersListErrorsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListErrorsRegionInstanceGroupManagersRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.RegionInstanceGroupManagersListErrorsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListManagedInstancesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.RegionInstanceGroupManagersListInstancesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.RegionInstanceGroupManagersListInstancesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListManagedInstancesRegionInstanceGroupManagersRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.RegionInstanceGroupManagersListInstancesResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListPerInstanceConfigsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.RegionInstanceGroupManagersListInstanceConfigsResp` object, and
    provides an ``__iter__`` method to iterate through its
    ``items`` field.
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.RegionInstanceGroupManagersListInstanceConfigsResp`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListPerInstanceConfigsRegionInstanceGroupManagersRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.RegionInstanceGroupManagersListInstanceConfigsResp):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

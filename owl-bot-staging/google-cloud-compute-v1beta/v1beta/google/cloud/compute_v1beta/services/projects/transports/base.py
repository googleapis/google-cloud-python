...
class ProjectsTransport(abc.ABC):
    ...
    @property
    def disable_xpn_host(self) -> Callable[
    ...
    @property
    def disable_xpn_resource(self) -> Callable[
    ...
    @property
    def enable_xpn_host(self) -> Callable[
    ...
    @property
    def enable_xpn_resource(self) -> Callable[
    ...
    def get(self) -> Callable[
            ...
            Union[
                compute.Project,
                Awaitable[compute.Project]
            ]]:
        raise NotImplementedError()

    @property
    def get_xpn_host(self) -> Callable[
    ...
    @property
    def get_xpn_resources(self) -> Callable[
            [compute.GetXpnResourcesProjectsRequest],
            Union[
                compute.ProjectsGetXpnResources,
                Awaitable[compute.ProjectsGetXpnResources]
            ]]:
        raise NotImplementedError()

    @property
    def list_xpn_hosts(self) -> Callable[
            [compute.ListXpnHostsProjectsRequest],
            Union[
                compute.XpnHostList,
                Awaitable[compute.XpnHostList]
            ]]:
        raise NotImplementedError()

    @property
    def move_disk(self) -> Callable[
    ...
    @property
    def set_cloud_armor_tier(self) -> Callable[
    ...
    @property
    def set_common_instance_metadata(self) -> Callable[
    ...
    @property
    def set_default_network_tier(self) -> Callable[
    ...
    @property
    def set_managed_protection_tier(self) -> Callable[
    ...
    @property
    def set_usage_export_bucket(self) -> Callable[

...
class GlobalOperationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListGlobalOperationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListGlobalOperationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.OperationAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.OperationAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_delete(self, request: compute.DeleteGlobalOperationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteGlobalOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_with_metadata(self, response: compute.DeleteGlobalOperationResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteGlobalOperationResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete
    ...
    def pre_get(self, request: compute.GetGlobalOperationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetGlobalOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListGlobalOperationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListGlobalOperationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_wait(self, request: compute.WaitGlobalOperationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.WaitGlobalOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    class _AggregatedList(_BaseGlobalOperationsRestTransport._BaseAggregatedList, GlobalOperationsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalOperationsClient.AggregatedList",
                    extra = {
            ...
            # Send the request
            response = GlobalOperationsRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalOperationsClient.aggregated_list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.GlobalOperations",
                        "rpcName": "AggregatedList",
    ...
    class _Delete(_BaseGlobalOperationsRestTransport._BaseDelete, GlobalOperationsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalOperationsClient.Delete",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.GlobalOperations",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = GlobalOperationsRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalOperationsClient.delete",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.GlobalOperations",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
    ...
    class _Get(_BaseGlobalOperationsRestTransport._BaseGet, GlobalOperationsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalOperationsClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.GlobalOperations",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = GlobalOperationsRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalOperationsClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.GlobalOperations",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseGlobalOperationsRestTransport._BaseList, GlobalOperationsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalOperationsClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.GlobalOperations",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = GlobalOperationsRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalOperationsClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.GlobalOperations",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _Wait(_BaseGlobalOperationsRestTransport._BaseWait, GlobalOperationsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalOperationsClient.Wait",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.GlobalOperations",
                        "rpcName": "Wait",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = GlobalOperationsRestTransport._Wait._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalOperationsClient.wait",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.GlobalOperations",
                        "rpcName": "Wait",
                        "metadata": http_response["headers"],

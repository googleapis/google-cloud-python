...
class MachineTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListMachineTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListMachineTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list(self, response: compute.MachineTypeAggregatedList) -> compute.MachineTypeAggregatedList:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.MachineTypeAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.MachineTypeAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_get(self, request: compute.GetMachineTypeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetMachineTypeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.MachineType, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.MachineType, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_list(self, request: compute.ListMachineTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListMachineTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.MachineTypeList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.MachineTypeList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class MachineTypesRestTransport(_BaseMachineTypesRestTransport):
    ...
    class _AggregatedList(_BaseMachineTypesRestTransport._BaseAggregatedList, MachineTypesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseMachineTypesRestTransport._BaseAggregatedList._get_http_options()

            request, metadata = self._interceptor.pre_aggregated_list(request, metadata)
            transcoded_request = _BaseMachineTypesRestTransport._BaseAggregatedList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseMachineTypesRestTransport._BaseAggregatedList._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.MachineTypesClient.AggregatedList",
                    extra = {
            ...
            # Send the request
            response = MachineTypesRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = compute.MachineTypeAggregatedList.to_json(response)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.MachineTypesClient.aggregated_list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.MachineTypes",
                        "rpcName": "AggregatedList",
    ...
    class _Get(_BaseMachineTypesRestTransport._BaseGet, MachineTypesRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseMachineTypesRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseMachineTypesRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.MachineTypesClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.MachineTypes",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = MachineTypesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.MachineTypesClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.MachineTypes",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseMachineTypesRestTransport._BaseList, MachineTypesRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseMachineTypesRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseMachineTypesRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.MachineTypesClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.MachineTypes",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = MachineTypesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.MachineTypesClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.MachineTypes",
                        "rpcName": "List",
                        "metadata": http_response["headers"],

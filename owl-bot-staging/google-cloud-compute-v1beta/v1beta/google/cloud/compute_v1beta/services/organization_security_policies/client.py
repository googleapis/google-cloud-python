...
from .transports.base import OrganizationSecurityPoliciesTransport, DEFAULT_CLIENT_INFO
...
class OrganizationSecurityPoliciesClient(metaclass=OrganizationSecurityPoliciesClientMeta):
    ...
    def __init__(self, *,
        ...
        self._client_cert_source = OrganizationSecurityPoliciesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)

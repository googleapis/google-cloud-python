...
class TargetSslProxiesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsTargetSslProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsTargetSslProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class TargetSslProxiesRestTransport(_BaseTargetSslProxiesRestTransport):
    ...
    class _TestIamPermissions(_BaseTargetSslProxiesRestTransport._BaseTestIamPermissions, TargetSslProxiesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TargetSslProxiesRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

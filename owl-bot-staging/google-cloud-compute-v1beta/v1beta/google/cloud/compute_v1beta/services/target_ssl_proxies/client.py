...
class TargetSslProxiesClient(metaclass=TargetSslProxiesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = TargetSslProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TargetSslProxiesTransport, Callable[..., TargetSslProxiesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = TargetSslProxiesClient._read_environment_variables()
        self._client_cert_source = TargetSslProxiesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = TargetSslProxiesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TargetSslProxiesTransport], Callable[..., TargetSslProxiesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.TargetSslProxiesClient`.",
                    extra = {
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1beta.DeleteTargetSslProxyRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteTargetSslProxyRequest, dict]):
    ...
    def get(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetTargetSslProxyRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertTargetSslProxyRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_ssl_proxy_resource (google.cloud.compute_v1beta.types.TargetSslProxy):
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListTargetSslProxiesRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListTargetSslProxiesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_ssl_proxies.pagers.ListPager:
    ...
    def set_backend_service_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetBackendServiceTargetSslProxyRequest, dict]):
                The request object. A request message for
            ...
            target_ssl_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_ssl_proxies_set_backend_service_request_resource (google.cloud.compute_v1beta.types.TargetSslProxiesSetBackendServiceRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, target_ssl_proxy, target_ssl_proxies_set_backend_service_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_certificate_map_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetCertificateMapTargetSslProxyRequest, dict]):
                The request object. A request message for
            ...
            target_ssl_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_ssl_proxies_set_certificate_map_request_resource (google.cloud.compute_v1beta.types.TargetSslProxiesSetCertificateMapRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, target_ssl_proxy, target_ssl_proxies_set_certificate_map_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_proxy_header_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_set_proxy_header():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetProxyHeaderTargetSslProxyRequest(
                    project="project_value",
                    target_ssl_proxy="target_ssl_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetProxyHeaderTargetSslProxyRequest, dict]):
                The request object. A request message for
            ...
            target_ssl_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_ssl_proxies_set_proxy_header_request_resource (google.cloud.compute_v1beta.types.TargetSslProxiesSetProxyHeaderRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, target_ssl_proxy, target_ssl_proxies_set_proxy_header_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_ssl_certificates_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_set_ssl_certificates():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetSslCertificatesTargetSslProxyRequest(
                    project="project_value",
                    target_ssl_proxy="target_ssl_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetSslCertificatesTargetSslProxyRequest, dict]):
                The request object. A request message for
            ...
            target_ssl_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_ssl_proxies_set_ssl_certificates_request_resource (google.cloud.compute_v1beta.types.TargetSslProxiesSetSslCertificatesRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, target_ssl_proxy, target_ssl_proxies_set_ssl_certificates_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_ssl_policy_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_set_ssl_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetSslPolicyTargetSslProxyRequest(
                    project="project_value",
                    target_ssl_proxy="target_ssl_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetSslPolicyTargetSslProxyRequest, dict]):
                The request object. A request message for
            ...
            target_ssl_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            ssl_policy_reference_resource (google.cloud.compute_v1beta.types.SslPolicyReference):
                The body resource for this request
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsTargetSslProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsTargetSslProxyRequest, dict]):
                The request object. A request message for

...
class TargetGrpcProxiesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteTargetGrpcProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteTargetGrpcProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetTargetGrpcProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetTargetGrpcProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.TargetGrpcProxy, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TargetGrpcProxy, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_insert(self, request: compute.InsertTargetGrpcProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertTargetGrpcProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListTargetGrpcProxiesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListTargetGrpcProxiesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.TargetGrpcProxyList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TargetGrpcProxyList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_patch(self, request: compute.PatchTargetGrpcProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchTargetGrpcProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsTargetGrpcProxyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsTargetGrpcProxyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    class _Delete(_BaseTargetGrpcProxiesRestTransport._BaseDelete, TargetGrpcProxiesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.TargetGrpcProxiesClient.Delete",
                    extra = {
            ...
            # Send the request
            response = TargetGrpcProxiesRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.TargetGrpcProxiesClient.delete",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.TargetGrpcProxies",
                        "rpcName": "Delete",
    ...
    class _Get(_BaseTargetGrpcProxiesRestTransport._BaseGet, TargetGrpcProxiesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.TargetGrpcProxiesClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.TargetGrpcProxies",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = TargetGrpcProxiesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.TargetGrpcProxiesClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.TargetGrpcProxies",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _Insert(_BaseTargetGrpcProxiesRestTransport._BaseInsert, TargetGrpcProxiesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.TargetGrpcProxiesClient.Insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.TargetGrpcProxies",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = TargetGrpcProxiesRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.TargetGrpcProxiesClient.insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.TargetGrpcProxies",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseTargetGrpcProxiesRestTransport._BaseList, TargetGrpcProxiesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.TargetGrpcProxiesClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.TargetGrpcProxies",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = TargetGrpcProxiesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.TargetGrpcProxiesClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.TargetGrpcProxies",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _Patch(_BaseTargetGrpcProxiesRestTransport._BasePatch, TargetGrpcProxiesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.TargetGrpcProxiesClient.Patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.TargetGrpcProxies",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = TargetGrpcProxiesRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.TargetGrpcProxiesClient.patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.TargetGrpcProxies",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(_BaseTargetGrpcProxiesRestTransport._BaseTestIamPermissions, TargetGrpcProxiesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.TargetGrpcProxiesClient.TestIamPermissions",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.TargetGrpcProxies",
            ...
            # Send the request
            response = TargetGrpcProxiesRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.TargetGrpcProxiesClient.test_iam_permissions",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.TargetGrpcProxies",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],

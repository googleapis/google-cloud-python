...
class NetworkEdgeSecurityServicesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListNetworkEdgeSecurityServicesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListNetworkEdgeSecurityServicesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.NetworkEdgeSecurityServiceAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.NetworkEdgeSecurityServiceAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the NetworkEdgeSecurityServices server but before it is returned to user code.
    ...
    def pre_delete(self, request: compute.DeleteNetworkEdgeSecurityServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteNetworkEdgeSecurityServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetNetworkEdgeSecurityServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetNetworkEdgeSecurityServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.NetworkEdgeSecurityService, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.NetworkEdgeSecurityService, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_insert(self, request: compute.InsertNetworkEdgeSecurityServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertNetworkEdgeSecurityServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_patch(self, request: compute.PatchNetworkEdgeSecurityServiceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchNetworkEdgeSecurityServiceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    class _AggregatedList(_BaseNetworkEdgeSecurityServicesRestTransport._BaseAggregatedList, NetworkEdgeSecurityServicesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NetworkEdgeSecurityServicesClient.AggregatedList",
                    extra = {
            ...
            # Send the request
            response = NetworkEdgeSecurityServicesRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NetworkEdgeSecurityServicesClient.aggregated_list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NetworkEdgeSecurityServices",
                        "rpcName": "AggregatedList",
    ...
    class _Delete(_BaseNetworkEdgeSecurityServicesRestTransport._BaseDelete, NetworkEdgeSecurityServicesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NetworkEdgeSecurityServicesClient.Delete",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NetworkEdgeSecurityServices",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = NetworkEdgeSecurityServicesRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NetworkEdgeSecurityServicesClient.delete",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NetworkEdgeSecurityServices",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
    ...
    class _Get(_BaseNetworkEdgeSecurityServicesRestTransport._BaseGet, NetworkEdgeSecurityServicesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NetworkEdgeSecurityServicesClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NetworkEdgeSecurityServices",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = NetworkEdgeSecurityServicesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NetworkEdgeSecurityServicesClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NetworkEdgeSecurityServices",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _Insert(_BaseNetworkEdgeSecurityServicesRestTransport._BaseInsert, NetworkEdgeSecurityServicesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NetworkEdgeSecurityServicesClient.Insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NetworkEdgeSecurityServices",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = NetworkEdgeSecurityServicesRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NetworkEdgeSecurityServicesClient.insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NetworkEdgeSecurityServices",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
    ...
    class _Patch(_BaseNetworkEdgeSecurityServicesRestTransport._BasePatch, NetworkEdgeSecurityServicesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NetworkEdgeSecurityServicesClient.Patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NetworkEdgeSecurityServices",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = NetworkEdgeSecurityServicesRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NetworkEdgeSecurityServicesClient.patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.NetworkEdgeSecurityServices",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],

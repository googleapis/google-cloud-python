...
class BackendBucketsClient(metaclass=BackendBucketsClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.BackendBucketsClient`.",
                    extra = {
    ...
    def add_signed_url_key_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AddSignedUrlKeyBackendBucketRequest, dict]):
    ...
    def delete_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def delete_signed_url_key_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteSignedUrlKeyBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def get(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def get_iam_policy(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def list(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListBackendBucketsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.backend_buckets.pagers.ListPager:
    ...
    def list_usable(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListUsableBackendBucketsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.backend_buckets.pagers.ListUsablePager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def patch_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def set_edge_security_policy_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetEdgeSecurityPolicyBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def set_iam_policy(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def update_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateBackendBucketRequest, dict]):
                The request object. A request message for

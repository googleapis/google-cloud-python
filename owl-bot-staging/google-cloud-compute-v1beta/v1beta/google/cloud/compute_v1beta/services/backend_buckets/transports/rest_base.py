...
from .base import BackendBucketsTransport, DEFAULT_CLIENT_INFO
...
class _BaseBackendBucketsRestTransport(BackendBucketsTransport):
    ...
    class _BaseAddSignedUrlKey:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}/addSignedUrlKey',
    ...
    class _BaseDelete:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}',
            },
            ]
            return http_options
    ...
    class _BaseDeleteSignedUrlKey:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}/deleteSignedUrlKey',
            },
            ]
            return http_options
    ...
    class _BaseGetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/compute/beta/projects/{project}/global/backendBuckets/{resource}/getIamPolicy',
            },
            ]
            return http_options
    ...
    class _BaseInsert:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/backendBuckets',
    ...
    class _BaseListUsable:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/compute/beta/projects/{project}/global/backendBuckets/listUsable',
            },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseBackendBucketsRestTransport._BaseListUsable._get_unset_required_fields(query_params))
    ...
    class _BaseSetEdgeSecurityPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}/setEdgeSecurityPolicy',
    ...
    class _BaseSetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/backendBuckets/{resource}/setIamPolicy',
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/global/backendBuckets/{resource}/testIamPermissions',
...
__all__=(
    '_BaseBackendBucketsRestTransport',
)

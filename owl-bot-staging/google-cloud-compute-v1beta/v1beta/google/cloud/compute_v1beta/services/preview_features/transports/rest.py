...
class PreviewFeaturesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetPreviewFeatureRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetPreviewFeatureRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.PreviewFeature, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PreviewFeature, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_list(self, request: compute.ListPreviewFeaturesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListPreviewFeaturesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.PreviewFeatureList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PreviewFeatureList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_update(self, request: compute.UpdatePreviewFeatureRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.UpdatePreviewFeatureRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    class _Get(_BasePreviewFeaturesRestTransport._BaseGet, PreviewFeaturesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.PreviewFeaturesClient.Get",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.PreviewFeaturesClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.PreviewFeatures",
                        "rpcName": "Get",
    ...
    class _List(_BasePreviewFeaturesRestTransport._BaseList, PreviewFeaturesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.PreviewFeaturesClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.PreviewFeatures",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = PreviewFeaturesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.PreviewFeaturesClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.PreviewFeatures",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _Update(_BasePreviewFeaturesRestTransport._BaseUpdate, PreviewFeaturesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.PreviewFeaturesClient.Update",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.PreviewFeatures",
                        "rpcName": "Update",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = PreviewFeaturesRestTransport._Update._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.PreviewFeaturesClient.update",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.PreviewFeatures",
                        "rpcName": "Update",
                        "metadata": http_response["headers"],

...
from google.cloud.compute_v1beta.services.region_target_https_proxies import pagers
...
class RegionTargetHttpsProxiesClient(metaclass=RegionTargetHttpsProxiesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = RegionTargetHttpsProxiesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = RegionTargetHttpsProxiesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionTargetHttpsProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RegionTargetHttpsProxiesClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RegionTargetHttpsProxiesTransport, Callable[..., RegionTargetHttpsProxiesTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionTargetHttpsProxiesTransport,Callable[..., RegionTargetHttpsProxiesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the RegionTargetHttpsProxiesTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionTargetHttpsProxiesClient._read_environment_variables()
        self._client_cert_source = RegionTargetHttpsProxiesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionTargetHttpsProxiesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RegionTargetHttpsProxiesTransport)
        if transport_provided:
            ...
            self._transport = cast(RegionTargetHttpsProxiesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            RegionTargetHttpsProxiesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionTargetHttpsProxiesTransport], Callable[..., RegionTargetHttpsProxiesTransport]] = (
                RegionTargetHttpsProxiesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., RegionTargetHttpsProxiesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionTargetHttpsProxiesClient`.",
                    extra = {
    ...
    def delete_unary(self,
            request: Optional[Union[compute.DeleteRegionTargetHttpsProxyRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                # Create a client
                client = compute_v1beta.RegionTargetHttpsProxiesClient()

                # Initialize request argument(s)
                request = compute_v1beta.DeleteRegionTargetHttpsProxyRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRegionTargetHttpsProxyRequest, dict]):
        ...
        flattened_params = [project, region, target_https_proxy]
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRegionTargetHttpsProxyRequest(
                    project="project_value",
                    region="region_value",
                    target_https_proxy="target_https_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionTargetHttpsProxyRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.TargetHttpsProxy:
    ...
    def insert_unary(self,
            request: Optional[Union[compute.InsertRegionTargetHttpsProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertRegionTargetHttpsProxyRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRegionTargetHttpsProxyRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_https_proxy_resource (google.cloud.compute_v1beta.types.TargetHttpsProxy):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_https_proxy_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list(self,
            request: Optional[Union[compute.ListRegionTargetHttpsProxiesRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListRegionTargetHttpsProxiesRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionTargetHttpsProxiesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_target_https_proxies.pagers.ListPager:
    ...
    def patch_unary(self,
            request: Optional[Union[compute.PatchRegionTargetHttpsProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            target_https_proxy: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchRegionTargetHttpsProxyRequest(
                    project="project_value",
                    region="region_value",
                    target_https_proxy="target_https_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchRegionTargetHttpsProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_https_proxy, target_https_proxy_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_ssl_certificates_unary(self,
            request: Optional[Union[compute.SetSslCertificatesRegionTargetHttpsProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            target_https_proxy: Optional[str] = None,
            region_target_https_proxies_set_ssl_certificates_request_resource: Optional[compute.RegionTargetHttpsProxiesSetSslCertificatesRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_set_ssl_certificates():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetSslCertificatesRegionTargetHttpsProxyRequest(
                    project="project_value",
                    region="region_value",
                    target_https_proxy="target_https_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetSslCertificatesRegionTargetHttpsProxyRequest, dict]):
                The request object. A request message for
            ...
            target_https_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            region_target_https_proxies_set_ssl_certificates_request_resource (google.cloud.compute_v1beta.types.RegionTargetHttpsProxiesSetSslCertificatesRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_https_proxy, region_target_https_proxies_set_ssl_certificates_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.SetSslCertificatesRegionTargetHttpsProxyRequest):
            ...
            if target_https_proxy is not None:
                request.target_https_proxy = target_https_proxy
            if region_target_https_proxies_set_ssl_certificates_request_resource is not None:
                request.region_target_https_proxies_set_ssl_certificates_request_resource = region_target_https_proxies_set_ssl_certificates_request_resource
    ...
    def set_url_map_unary(self,
            request: Optional[Union[compute.SetUrlMapRegionTargetHttpsProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            target_https_proxy: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_set_url_map():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetUrlMapRegionTargetHttpsProxyRequest(
                    project="project_value",
                    region="region_value",
                    target_https_proxy="target_https_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetUrlMapRegionTargetHttpsProxyRequest, dict]):
                The request object. A request message for
            ...
            target_https_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            url_map_reference_resource (google.cloud.compute_v1beta.types.UrlMapReference):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_https_proxy, url_map_reference_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsRegionTargetHttpsProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsRegionTargetHttpsProxyRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsRegionTargetHttpsProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsRegionTargetHttpsProxyRequest):
            request = compute.TestIamPermissionsRegionTargetHttpsProxyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def __enter__(self) -> "RegionTargetHttpsProxiesClient":
        return self

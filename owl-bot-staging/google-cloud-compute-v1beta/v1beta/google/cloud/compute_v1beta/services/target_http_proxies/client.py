...
from google.cloud.compute_v1beta.services.target_http_proxies import pagers
...
class TargetHttpProxiesClientMeta(type):
    """Metaclass for the TargetHttpProxies client.
...
class TargetHttpProxiesClient(metaclass=TargetHttpProxiesClientMeta):
    ...
    @property
    def transport(self) -> TargetHttpProxiesTransport:
        """Returns the transport used by the client instance.

        Returns:
            TargetHttpProxiesTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = TargetHttpProxiesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = TargetHttpProxiesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = TargetHttpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = TargetHttpProxiesClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TargetHttpProxiesTransport, Callable[..., TargetHttpProxiesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = TargetHttpProxiesClient._read_environment_variables()
        self._client_cert_source = TargetHttpProxiesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = TargetHttpProxiesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, TargetHttpProxiesTransport)
        if transport_provided:
            # transport is a TargetHttpProxiesTransport instance.
            ...
            self._transport = cast(TargetHttpProxiesTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TargetHttpProxiesTransport], Callable[..., TargetHttpProxiesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.TargetHttpProxiesClient`.",
                    extra = {
    ...
    def aggregated_list(self,
            request: Optional[Union[compute.AggregatedListTargetHttpProxiesRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1beta.AggregatedListTargetHttpProxiesRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListTargetHttpProxiesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_http_proxies.pagers.AggregatedListPager:
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteTargetHttpProxyRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteTargetHttpProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, target_http_proxy]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def get(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetTargetHttpProxyRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertTargetHttpProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, target_http_proxy_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListTargetHttpProxiesRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListTargetHttpProxiesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_http_proxies.pagers.ListPager:
    ...
    def patch_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchTargetHttpProxyRequest(
                    project="project_value",
                    target_http_proxy="target_http_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchTargetHttpProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, target_http_proxy, target_http_proxy_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_url_map_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_set_url_map():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetUrlMapTargetHttpProxyRequest(
                    project="project_value",
                    target_http_proxy="target_http_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetUrlMapTargetHttpProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, target_http_proxy, url_map_reference_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsTargetHttpProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsTargetHttpProxyRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsTargetHttpProxyRequest, dict]):
                The request object. A request message for
                TargetHttpProxies.TestIamPermissions.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsTargetHttpProxyRequest):
            request = compute.TestIamPermissionsTargetHttpProxyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def __enter__(self) -> "TargetHttpProxiesClient":
        return self

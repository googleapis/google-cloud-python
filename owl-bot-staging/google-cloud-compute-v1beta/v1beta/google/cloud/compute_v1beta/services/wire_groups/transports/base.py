...
class WireGroupsTransport(abc.ABC):
    """Abstract transport class for WireGroups."""
    ...
    def delete(self) -> Callable[
            [compute.DeleteWireGroupRequest],
            Union[
                compute.Operation,
    ...
    def get(self) -> Callable[
            [compute.GetWireGroupRequest],
            Union[
                compute.WireGroup,
                Awaitable[compute.WireGroup]
            ]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[
            [compute.InsertWireGroupRequest],
            Union[
                compute.Operation,
                Awaitable[compute.Operation]
            ]]:
    ...
    def list(self) -> Callable[
            [compute.ListWireGroupsRequest],
            Union[
                compute.WireGroupList,
                Awaitable[compute.WireGroupList]
            ]]:
        raise NotImplementedError()

    @property
    def patch(self) -> Callable[
            [compute.PatchWireGroupRequest],
            Union[
                compute.Operation,
                Awaitable[compute.Operation]
            ]]:

...
from .base import InterconnectRemoteLocationsTransport, DEFAULT_CLIENT_INFO
...
class _BaseInterconnectRemoteLocationsRestTransport(InterconnectRemoteLocationsTransport):
    ...
    class _BaseGet:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/compute/beta/projects/{project}/global/interconnectRemoteLocations/{interconnect_remote_location}',
            },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = compute.GetInterconnectRemoteLocationRequest.pb(request)
    ...
    class _BaseList:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/compute/beta/projects/{project}/global/interconnectRemoteLocations',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.ListInterconnectRemoteLocationsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request

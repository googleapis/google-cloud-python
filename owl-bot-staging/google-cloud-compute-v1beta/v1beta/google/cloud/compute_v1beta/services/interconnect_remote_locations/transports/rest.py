...
class InterconnectRemoteLocationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetInterconnectRemoteLocationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetInterconnectRemoteLocationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.InterconnectRemoteLocation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InterconnectRemoteLocation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_list(self, request: compute.ListInterconnectRemoteLocationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListInterconnectRemoteLocationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.InterconnectRemoteLocationList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InterconnectRemoteLocationList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class InterconnectRemoteLocationsRestTransport(_BaseInterconnectRemoteLocationsRestTransport):
    ...
    class _Get(_BaseInterconnectRemoteLocationsRestTransport._BaseGet, InterconnectRemoteLocationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = InterconnectRemoteLocationsRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _List(_BaseInterconnectRemoteLocationsRestTransport._BaseList, InterconnectRemoteLocationsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = InterconnectRemoteLocationsRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class RegionMultiMigsTransport(abc.ABC):
    """Abstract transport class for RegionMultiMigs."""
    ...
    def delete(self) -> Callable[
            [compute.DeleteRegionMultiMigRequest],
            Union[
                compute.Operation,
    ...
    def get(self) -> Callable[
            [compute.GetRegionMultiMigRequest],
            Union[
                compute.MultiMig,
                Awaitable[compute.MultiMig]
            ]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[
            [compute.InsertRegionMultiMigRequest],
            Union[
                compute.Operation,
                Awaitable[compute.Operation]
            ]]:
    ...
    def list(self) -> Callable[
            [compute.ListRegionMultiMigsRequest],
            Union[
                compute.MultiMigsList,
                Awaitable[compute.MultiMigsList]
            ]]:
        raise NotImplementedError()

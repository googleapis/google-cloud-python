...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.ExternalVpnGatewayList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.ExternalVpnGatewayList`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListExternalVpnGatewaysRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.ExternalVpnGatewayList):

...
from google.cloud.compute_v1beta.services.networks import pagers
...
class NetworksClient(metaclass=NetworksClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = NetworksClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, NetworksTransport, Callable[..., NetworksTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = NetworksClient._read_environment_variables()
        self._client_cert_source = NetworksClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = NetworksClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[NetworksTransport], Callable[..., NetworksTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.NetworksClient`.",
                    extra = {
    ...
    def add_peering_unary(self,
            ...
            *,
            ...
            networks_add_peering_request_resource: Optional[compute.NetworksAddPeeringRequest] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AddPeeringNetworkRequest, dict]):
            ...
            network (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            networks_add_peering_request_resource (google.cloud.compute_v1beta.types.NetworksAddPeeringRequest):
        ...
        if not isinstance(request, compute.AddPeeringNetworkRequest):
            ...
            if networks_add_peering_request_resource is not None:
                request.networks_add_peering_request_resource = networks_add_peering_request_resource
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteNetworkRequest(
                    network="network_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteNetworkRequest, dict]):
                The request object. A request message for
    ...
    def get(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetNetworkRequest, dict]):
    ...
    def get_effective_firewalls(self,
            request: Optional[Union[compute.GetEffectiveFirewallsNetworkRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            network: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_get_effective_firewalls():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetEffectiveFirewallsNetworkRequest(
                    network="network_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetEffectiveFirewallsNetworkRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.NetworksGetEffectiveFirewallsResponse:
    ...
    def insert_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertNetworkRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertNetworkRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            network_resource (google.cloud.compute_v1beta.types.Network):
                The body resource for this request
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListNetworksRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListNetworksRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.networks.pagers.ListPager:
    ...
    def list_peering_routes(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListPeeringRoutesNetworksRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.networks.pagers.ListPeeringRoutesPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def patch_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchNetworkRequest, dict]):
    ...
    def remove_peering_unary(self,
            ...
            *,
            project: Optional[str] = None,
            network: Optional[str] = None,
            networks_remove_peering_request_resource: Optional[compute.NetworksRemovePeeringRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_remove_peering():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.RemovePeeringNetworkRequest(
                    network="network_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.RemovePeeringNetworkRequest, dict]):
                The request object. A request message for
            ...
            network (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            networks_remove_peering_request_resource (google.cloud.compute_v1beta.types.NetworksRemovePeeringRequest):
                The body resource for this request
        ...
        if not isinstance(request, compute.RemovePeeringNetworkRequest):
            ...
            if networks_remove_peering_request_resource is not None:
                request.networks_remove_peering_request_resource = networks_remove_peering_request_resource
    ...
    def request_remove_peering_unary(self,
            request: Optional[Union[compute.RequestRemovePeeringNetworkRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            network: Optional[str] = None,
            networks_request_remove_peering_request_resource: Optional[compute.NetworksRequestRemovePeeringRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_request_remove_peering():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.RequestRemovePeeringNetworkRequest(
                    network="network_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.RequestRemovePeeringNetworkRequest, dict]):
                The request object. A request message for
            ...
            network (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            networks_request_remove_peering_request_resource (google.cloud.compute_v1beta.types.NetworksRequestRemovePeeringRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, network, networks_request_remove_peering_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.RequestRemovePeeringNetworkRequest):
            ...
            if networks_request_remove_peering_request_resource is not None:
                request.networks_request_remove_peering_request_resource = networks_request_remove_peering_request_resource
    ...
    def request_remove_peering(self,
            request: Optional[Union[compute.RequestRemovePeeringNetworkRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            network: Optional[str] = None,
    ...
    def switch_to_custom_mode_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SwitchToCustomModeNetworkRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsNetworkRequest, dict]] = None,
            *,
            project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsNetworkRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsNetworkRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsNetworkRequest):
            request = compute.TestIamPermissionsNetworkRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def update_peering_unary(self,
            ...
            *,
            project: Optional[str] = None,
            network: Optional[str] = None,
            networks_update_peering_request_resource: Optional[compute.NetworksUpdatePeeringRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_update_peering():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.UpdatePeeringNetworkRequest(
                    network="network_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdatePeeringNetworkRequest, dict]):
                The request object. A request message for
            ...
            network (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            networks_update_peering_request_resource (google.cloud.compute_v1beta.types.NetworksUpdatePeeringRequest):
                The body resource for this request
        ...
        if not isinstance(request, compute.UpdatePeeringNetworkRequest):
            ...
            if networks_update_peering_request_resource is not None:
                request.networks_update_peering_request_resource = networks_update_peering_request_resource

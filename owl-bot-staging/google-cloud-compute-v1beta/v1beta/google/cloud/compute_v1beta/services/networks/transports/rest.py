...
class NetworksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsNetworkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsNetworkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class NetworksRestTransport(_BaseNetworksRestTransport):
    ...
    class _TestIamPermissions(_BaseNetworksRestTransport._BaseTestIamPermissions, NetworksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = NetworksRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

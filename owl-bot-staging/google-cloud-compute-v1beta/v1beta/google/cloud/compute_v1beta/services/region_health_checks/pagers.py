...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.HealthCheckList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.HealthCheckList`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListRegionHealthChecksRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.HealthCheckList):

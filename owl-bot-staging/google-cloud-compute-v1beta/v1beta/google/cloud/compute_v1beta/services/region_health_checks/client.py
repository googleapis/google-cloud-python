...
from google.cloud.compute_v1beta.services.region_health_checks import pagers
...
class RegionHealthChecksClient(metaclass=RegionHealthChecksClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionHealthChecksClient`.",
                    extra = {
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1beta.DeleteRegionHealthCheckRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRegionHealthCheckRequest, dict]):
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRegionHealthCheckRequest(
                    health_check="health_check_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionHealthCheckRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertRegionHealthCheckRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRegionHealthCheckRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            health_check_resource (google.cloud.compute_v1beta.types.HealthCheck):
    ...
    def list(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionHealthChecksRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_health_checks.pagers.ListPager:
    ...
    def patch_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchRegionHealthCheckRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsRegionHealthCheckRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsRegionHealthCheckRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsRegionHealthCheckRequest, dict]):
                The request object. A request message for
    ...
    def update_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_update():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.UpdateRegionHealthCheckRequest(
                    health_check="health_check_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateRegionHealthCheckRequest, dict]):
                The request object. A request message for

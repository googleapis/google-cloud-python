...
class RegionCommitmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsRegionCommitmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsRegionCommitmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update_reservations(self, request: compute.UpdateReservationsRegionCommitmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.UpdateReservationsRegionCommitmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_reservations_with_metadata(self, response: compute.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_reservations
...
class RegionCommitmentsRestTransport(_BaseRegionCommitmentsRestTransport):
    ...
    class _TestIamPermissions(_BaseRegionCommitmentsRestTransport._BaseTestIamPermissions, RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionCommitmentsRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateReservations(_BaseRegionCommitmentsRestTransport._BaseUpdateReservations, RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionCommitmentsRestTransport._UpdateReservations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def update_reservations(self) -> Callable[

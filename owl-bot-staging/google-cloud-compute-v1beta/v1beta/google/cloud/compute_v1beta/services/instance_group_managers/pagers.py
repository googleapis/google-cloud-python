...
class AggregatedListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.InstanceGroupManagerAggregatedList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.InstanceGroupManagerAggregatedList`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.AggregatedListInstanceGroupManagersRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.InstanceGroupManagerAggregatedList):
...
class ListPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.InstanceGroupManagerList` object, and
    provides an ``__iter__`` method to iterate through its
    ``items`` field.
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.InstanceGroupManagerList`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListInstanceGroupManagersRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.InstanceGroupManagerList):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListErrorsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.InstanceGroupManagersListErrorsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``items`` field.
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.InstanceGroupManagersListErrorsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListErrorsInstanceGroupManagersRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.InstanceGroupManagersListErrorsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListManagedInstancesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.InstanceGroupManagersListManagedInstancesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.InstanceGroupManagersListManagedInstancesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListManagedInstancesInstanceGroupManagersRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.InstanceGroupManagersListManagedInstancesResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListPerInstanceConfigsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.InstanceGroupManagersListPerInstanceConfigsResp` object, and
    provides an ``__iter__`` method to iterate through its
    ``items`` field.
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.InstanceGroupManagersListPerInstanceConfigsResp`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListPerInstanceConfigsInstanceGroupManagersRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.InstanceGroupManagersListPerInstanceConfigsResp):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

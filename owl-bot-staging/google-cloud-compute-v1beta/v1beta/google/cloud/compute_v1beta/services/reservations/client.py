...
from google.cloud.compute_v1beta.services.reservations import pagers
...
class ReservationsClient(metaclass=ReservationsClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.ReservationsClient`.",
                    extra = {
    ...
    def aggregated_list(self,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1beta.AggregatedListReservationsRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListReservationsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.reservations.pagers.AggregatedListPager:
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteReservationRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteReservationRequest, dict]):
                The request object. A request message for
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetReservationRequest(
                    project="project_value",
                    reservation="reservation_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetReservationRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.Reservation:
    ...
    def get_iam_policy(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyReservationRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertReservationRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertReservationRequest, dict]):
                The request object. A request message for
            ...
            zone (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            reservation_resource (google.cloud.compute_v1beta.types.Reservation):
    ...
    def list(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListReservationsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.reservations.pagers.ListPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def perform_maintenance_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_perform_maintenance():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PerformMaintenanceReservationRequest(
                    project="project_value",
                    reservation="reservation_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PerformMaintenanceReservationRequest, dict]):
                The request object. A request message for
            ...
            reservation (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            reservations_perform_maintenance_request_resource (google.cloud.compute_v1beta.types.ReservationsPerformMaintenanceRequest):
                The body resource for this request
    ...
    def resize_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_resize():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ResizeReservationRequest(
                    project="project_value",
                    reservation="reservation_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ResizeReservationRequest, dict]):
                The request object. A request message for
            ...
            reservation (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            reservations_resize_request_resource (google.cloud.compute_v1beta.types.ReservationsResizeRequest):
                The body resource for this request
    ...
    def set_iam_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_set_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetIamPolicyReservationRequest(
                    project="project_value",
                    resource="resource_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyReservationRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsReservationRequest, dict]):
                The request object. A request message for
    ...
    def update_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_update():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.UpdateReservationRequest(
                    project="project_value",
                    reservation="reservation_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateReservationRequest, dict]):
                The request object. A request message for

...
class ForwardingRulesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsForwardingRuleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsForwardingRuleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class ForwardingRulesRestTransport(_BaseForwardingRulesRestTransport):
    ...
    class _TestIamPermissions(_BaseForwardingRulesRestTransport._BaseTestIamPermissions, ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ForwardingRulesRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

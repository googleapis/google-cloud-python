...
from .base import RegionUrlMapsTransport, DEFAULT_CLIENT_INFO
...
class _BaseRegionUrlMapsRestTransport(RegionUrlMapsTransport):
    """Base REST backend transport for RegionUrlMaps.
    ...
    class _BaseDelete:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/compute/beta/projects/{project}/regions/{region}/urlMaps/{url_map}',
            },
            ]
            return http_options
    ...
    class _BaseInsert:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/regions/{region}/urlMaps',
    ...
    class _BaseInvalidateCache:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/regions/{region}/urlMaps/{url_map}/invalidateCache',
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.InvalidateCacheRegionUrlMapRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/regions/{region}/urlMaps/{resource}/testIamPermissions',
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.TestIamPermissionsRegionUrlMapRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseValidate:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/regions/{region}/urlMaps/{url_map}/validate',
...
__all__=(
    '_BaseRegionUrlMapsRestTransport',
)

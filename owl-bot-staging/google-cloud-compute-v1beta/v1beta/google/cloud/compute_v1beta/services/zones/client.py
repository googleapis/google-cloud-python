...
class ZonesClient(metaclass=ZonesClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.ZonesClient`.",
                    extra = {
    ...
    def get(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetZoneRequest, dict]):
    ...
    def list(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListZonesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.zones.pagers.ListPager:

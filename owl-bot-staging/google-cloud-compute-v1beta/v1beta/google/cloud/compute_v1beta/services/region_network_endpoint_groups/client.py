...
class RegionNetworkEndpointGroupsClient(metaclass=RegionNetworkEndpointGroupsClientMeta):
    ...
    def __init__(self, *,
        ...
        self._client_cert_source = RegionNetworkEndpointGroupsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionNetworkEndpointGroupsClient`.",
                    extra = {
    ...
    def attach_network_endpoints_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_attach_network_endpoints():
                ...
                request = compute_v1beta.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest, dict]):
            ...
            network_endpoint_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            region_network_endpoint_groups_attach_endpoints_request_resource (google.cloud.compute_v1beta.types.RegionNetworkEndpointGroupsAttachEndpointsRequest):
    ...
    def delete_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRegionNetworkEndpointGroupRequest, dict]):
                The request object. A request message for
    ...
    def detach_network_endpoints_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_detach_network_endpoints():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest(
                    network_endpoint_group="network_endpoint_group_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest, dict]):
                The request object. A request message for
            ...
            network_endpoint_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            region_network_endpoint_groups_detach_endpoints_request_resource (google.cloud.compute_v1beta.types.RegionNetworkEndpointGroupsDetachEndpointsRequest):
                The body resource for this request
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRegionNetworkEndpointGroupRequest(
                    network_endpoint_group="network_endpoint_group_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionNetworkEndpointGroupRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRegionNetworkEndpointGroupRequest, dict]):
                The request object. A request message for
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListRegionNetworkEndpointGroupsRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionNetworkEndpointGroupsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_network_endpoint_groups.pagers.ListPager:
    ...
    def list_network_endpoints(self,
        ...
        .. code-block:: python
            ...
            def sample_list_network_endpoints():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest(
                    network_endpoint_group="network_endpoint_group_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_network_endpoint_groups.pagers.ListNetworkEndpointsPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.

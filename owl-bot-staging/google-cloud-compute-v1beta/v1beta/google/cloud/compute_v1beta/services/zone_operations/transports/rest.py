...
class ZoneOperationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteZoneOperationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteZoneOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_with_metadata(self, response: compute.DeleteZoneOperationResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteZoneOperationResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete
    ...
    def pre_get(self, request: compute.GetZoneOperationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetZoneOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListZoneOperationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListZoneOperationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_wait(self, request: compute.WaitZoneOperationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.WaitZoneOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    class _Delete(_BaseZoneOperationsRestTransport._BaseDelete, ZoneOperationsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.ZoneOperationsClient.Delete",
                    extra = {
            ...
            # Send the request
            response = ZoneOperationsRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.ZoneOperationsClient.delete",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.ZoneOperations",
                        "rpcName": "Delete",
    ...
    class _Get(_BaseZoneOperationsRestTransport._BaseGet, ZoneOperationsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.ZoneOperationsClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.ZoneOperations",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.ZoneOperationsClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.ZoneOperations",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseZoneOperationsRestTransport._BaseList, ZoneOperationsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.ZoneOperationsClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.ZoneOperations",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.ZoneOperationsClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.ZoneOperations",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _Wait(_BaseZoneOperationsRestTransport._BaseWait, ZoneOperationsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.ZoneOperationsClient.Wait",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.ZoneOperations",
                        "rpcName": "Wait",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.ZoneOperationsClient.wait",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.ZoneOperations",
                        "rpcName": "Wait",
                        "metadata": http_response["headers"],

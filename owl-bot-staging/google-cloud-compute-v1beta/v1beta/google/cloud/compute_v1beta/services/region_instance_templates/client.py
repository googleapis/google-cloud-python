...
class RegionInstanceTemplatesClient(metaclass=RegionInstanceTemplatesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionInstanceTemplatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RegionInstanceTemplatesTransport, Callable[..., RegionInstanceTemplatesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionInstanceTemplatesClient._read_environment_variables()
        self._client_cert_source = RegionInstanceTemplatesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionInstanceTemplatesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionInstanceTemplatesTransport], Callable[..., RegionInstanceTemplatesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionInstanceTemplatesClient`.",
                    extra = {
    ...
    def delete_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRegionInstanceTemplateRequest, dict]):
    ...
    def get(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionInstanceTemplateRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRegionInstanceTemplateRequest, dict]):
                The request object. A request message for
    ...
    def list(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionInstanceTemplatesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_instance_templates.pagers.ListPager:

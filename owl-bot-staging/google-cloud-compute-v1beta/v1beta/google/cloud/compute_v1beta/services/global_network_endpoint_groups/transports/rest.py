...
class GlobalNetworkEndpointGroupsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_attach_network_endpoints(self, request: compute.AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_delete(self, request: compute.DeleteGlobalNetworkEndpointGroupRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteGlobalNetworkEndpointGroupRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_detach_network_endpoints(self, request: compute.DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetGlobalNetworkEndpointGroupRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetGlobalNetworkEndpointGroupRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert(self, request: compute.InsertGlobalNetworkEndpointGroupRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertGlobalNetworkEndpointGroupRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListGlobalNetworkEndpointGroupsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListGlobalNetworkEndpointGroupsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_network_endpoints(self, request: compute.ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class GlobalNetworkEndpointGroupsRestTransport(_BaseGlobalNetworkEndpointGroupsRestTransport):
    ...
    class _AttachNetworkEndpoints(_BaseGlobalNetworkEndpointGroupsRestTransport._BaseAttachNetworkEndpoints, GlobalNetworkEndpointGroupsRestStub):
        def __hash__(self):
            return hash("GlobalNetworkEndpointGroupsRestTransport.AttachNetworkEndpoints")
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseAttachNetworkEndpoints._get_transcoded_request(http_options, request)

            body = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseAttachNetworkEndpoints._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseAttachNetworkEndpoints._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = GlobalNetworkEndpointGroupsRestTransport._AttachNetworkEndpoints._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Delete(_BaseGlobalNetworkEndpointGroupsRestTransport._BaseDelete, GlobalNetworkEndpointGroupsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseDelete._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseDelete._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = GlobalNetworkEndpointGroupsRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DetachNetworkEndpoints(_BaseGlobalNetworkEndpointGroupsRestTransport._BaseDetachNetworkEndpoints, GlobalNetworkEndpointGroupsRestStub):
        def __hash__(self):
            return hash("GlobalNetworkEndpointGroupsRestTransport.DetachNetworkEndpoints")
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseDetachNetworkEndpoints._get_transcoded_request(http_options, request)

            body = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseDetachNetworkEndpoints._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseDetachNetworkEndpoints._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = GlobalNetworkEndpointGroupsRestTransport._DetachNetworkEndpoints._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Get(_BaseGlobalNetworkEndpointGroupsRestTransport._BaseGet, GlobalNetworkEndpointGroupsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = GlobalNetworkEndpointGroupsRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseGlobalNetworkEndpointGroupsRestTransport._BaseInsert, GlobalNetworkEndpointGroupsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseInsert._get_transcoded_request(http_options, request)

            body = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseInsert._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseInsert._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = GlobalNetworkEndpointGroupsRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _List(_BaseGlobalNetworkEndpointGroupsRestTransport._BaseList, GlobalNetworkEndpointGroupsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = GlobalNetworkEndpointGroupsRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListNetworkEndpoints(_BaseGlobalNetworkEndpointGroupsRestTransport._BaseListNetworkEndpoints, GlobalNetworkEndpointGroupsRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseListNetworkEndpoints._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseGlobalNetworkEndpointGroupsRestTransport._BaseListNetworkEndpoints._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = GlobalNetworkEndpointGroupsRestTransport._ListNetworkEndpoints._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

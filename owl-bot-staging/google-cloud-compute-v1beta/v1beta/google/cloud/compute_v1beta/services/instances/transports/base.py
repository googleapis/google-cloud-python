...
class InstancesTransport(abc.ABC):
    ...
    @property
    def get_partner_metadata(self) -> Callable[
            [compute.GetPartnerMetadataInstanceRequest],
            Union[
                compute.PartnerMetadata,
                Awaitable[compute.PartnerMetadata]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def get_shielded_vm_identity(self) -> Callable[
            [compute.GetShieldedVmIdentityInstanceRequest],
            Union[
                compute.ShieldedVmIdentity,
                Awaitable[compute.ShieldedVmIdentity]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def patch_partner_metadata(self) -> Callable[
    ...
    @property
    def set_shielded_vm_integrity_policy(self) -> Callable[
    ...
    @property
    def update_shielded_vm_config(self) -> Callable[

...
from .base import StoragePoolsTransport, DEFAULT_CLIENT_INFO
...
class _BaseStoragePoolsRestTransport(StoragePoolsTransport):
    ...
    class _BaseAggregatedList:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/compute/beta/projects/{project}/aggregated/storagePools',
            },
            ]
            return http_options
    ...
    class _BaseDelete:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/compute/beta/projects/{project}/zones/{zone}/storagePools/{storage_pool}',
            },
            ]
            return http_options
    ...
    class _BaseGetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/compute/beta/projects/{project}/zones/{zone}/storagePools/{resource}/getIamPolicy',
            },
            ]
            return http_options
    ...
    class _BaseInsert:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/zones/{zone}/storagePools',
    ...
    class _BaseListDisks:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/compute/beta/projects/{project}/zones/{zone}/storagePools/{storage_pool}/listDisks',
            },
            ]
            return http_options
    ...
    class _BaseSetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/zones/{zone}/storagePools/{resource}/setIamPolicy',
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/compute/beta/projects/{project}/zones/{zone}/storagePools/{resource}/testIamPermissions',
...
__all__=(
    '_BaseStoragePoolsRestTransport',
)

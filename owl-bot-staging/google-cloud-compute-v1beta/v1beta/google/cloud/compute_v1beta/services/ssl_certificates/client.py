...
from google.cloud.compute_v1beta.services.ssl_certificates import pagers
...
class SslCertificatesClient(metaclass=SslCertificatesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SslCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SslCertificatesTransport, Callable[..., SslCertificatesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SslCertificatesClient._read_environment_variables()
        self._client_cert_source = SslCertificatesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SslCertificatesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SslCertificatesTransport], Callable[..., SslCertificatesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.SslCertificatesClient`.",
                    extra = {
    ...
    def aggregated_list(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListSslCertificatesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.ssl_certificates.pagers.AggregatedListPager:
    ...
    def delete_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteSslCertificateRequest, dict]):
                The request object. A request message for
    ...
    def get(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetSslCertificateRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertSslCertificateRequest, dict]):
                The request object. A request message for
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListSslCertificatesRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListSslCertificatesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.ssl_certificates.pagers.ListPager:
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsSslCertificateRequest, dict]] = None,
            *,
            project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsSslCertificateRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsSslCertificateRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsSslCertificateRequest):
            request = compute.TestIamPermissionsSslCertificateRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

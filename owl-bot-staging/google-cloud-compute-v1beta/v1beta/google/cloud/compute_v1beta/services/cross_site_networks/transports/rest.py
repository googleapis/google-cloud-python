...
class CrossSiteNetworksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteCrossSiteNetworkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteCrossSiteNetworkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetCrossSiteNetworkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetCrossSiteNetworkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.CrossSiteNetwork, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.CrossSiteNetwork, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_insert(self, request: compute.InsertCrossSiteNetworkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertCrossSiteNetworkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListCrossSiteNetworksRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListCrossSiteNetworksRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.CrossSiteNetworkList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.CrossSiteNetworkList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_patch(self, request: compute.PatchCrossSiteNetworkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchCrossSiteNetworkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    class _Delete(_BaseCrossSiteNetworksRestTransport._BaseDelete, CrossSiteNetworksRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.CrossSiteNetworksClient.Delete",
                    extra = {
            ...
            # Send the request
            response = CrossSiteNetworksRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.CrossSiteNetworksClient.delete",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.CrossSiteNetworks",
                        "rpcName": "Delete",
    ...
    class _Get(_BaseCrossSiteNetworksRestTransport._BaseGet, CrossSiteNetworksRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.CrossSiteNetworksClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.CrossSiteNetworks",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = CrossSiteNetworksRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.CrossSiteNetworksClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.CrossSiteNetworks",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _Insert(_BaseCrossSiteNetworksRestTransport._BaseInsert, CrossSiteNetworksRestStub):
        ...
        def __call__(self,
            ...
            Args:
                request (~.compute.InsertCrossSiteNetworkRequest):
                    The request object. A request message for
                CrossSiteNetworks.Insert. See the method
                description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.CrossSiteNetworksClient.Insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.CrossSiteNetworks",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = CrossSiteNetworksRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.CrossSiteNetworksClient.insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.CrossSiteNetworks",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseCrossSiteNetworksRestTransport._BaseList, CrossSiteNetworksRestStub):
        ...
        def __call__(self,
            ...
            Args:
                request (~.compute.ListCrossSiteNetworksRequest):
                    The request object. A request message for
                CrossSiteNetworks.List. See the method
                description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            Returns:
                ~.compute.CrossSiteNetworkList:
                    Response to the list request that
                contains a list of cross-site networks.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.CrossSiteNetworksClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.CrossSiteNetworks",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = CrossSiteNetworksRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = compute.CrossSiteNetworkList()
            pb_resp = compute.CrossSiteNetworkList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.CrossSiteNetworksClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.CrossSiteNetworks",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _Patch(_BaseCrossSiteNetworksRestTransport._BasePatch, CrossSiteNetworksRestStub):
        ...
        def __call__(self,
            ...
            Args:
                request (~.compute.PatchCrossSiteNetworkRequest):
                    The request object. A request message for
                CrossSiteNetworks.Patch. See the method
                description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.CrossSiteNetworksClient.Patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.CrossSiteNetworks",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = CrossSiteNetworksRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.CrossSiteNetworksClient.patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.CrossSiteNetworks",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],

...
from google.cloud.compute_v1beta.services.cross_site_networks import pagers
from google.cloud.compute_v1beta.types import compute
from .transports.base import CrossSiteNetworksTransport, DEFAULT_CLIENT_INFO
...
class CrossSiteNetworksClient(metaclass=CrossSiteNetworksClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CrossSiteNetworksClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CrossSiteNetworksTransport, Callable[..., CrossSiteNetworksTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CrossSiteNetworksClient._read_environment_variables()
        self._client_cert_source = CrossSiteNetworksClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CrossSiteNetworksClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CrossSiteNetworksTransport], Callable[..., CrossSiteNetworksTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.CrossSiteNetworksClient`.",
                    extra = {
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1beta.DeleteCrossSiteNetworkRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteCrossSiteNetworkRequest, dict]):
    ...
    def get(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetCrossSiteNetworkRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertCrossSiteNetworkRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertCrossSiteNetworkRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            cross_site_network_resource (google.cloud.compute_v1beta.types.CrossSiteNetwork):
    ...
    def list(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListCrossSiteNetworksRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.cross_site_networks.pagers.ListPager:
    ...
    def patch_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchCrossSiteNetworkRequest, dict]):
                The request object. A request message for

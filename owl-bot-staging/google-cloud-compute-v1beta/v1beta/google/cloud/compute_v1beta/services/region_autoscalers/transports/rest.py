...
class RegionAutoscalersRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsRegionAutoscalerRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsRegionAutoscalerRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class RegionAutoscalersRestTransport(_BaseRegionAutoscalersRestTransport):
    ...
    class _TestIamPermissions(_BaseRegionAutoscalersRestTransport._BaseTestIamPermissions, RegionAutoscalersRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = RegionAutoscalersRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

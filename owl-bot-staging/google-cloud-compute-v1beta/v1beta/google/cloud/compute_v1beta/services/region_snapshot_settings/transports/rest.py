...
from .rest_base import _BaseRegionSnapshotSettingsRestTransport
...
class RegionSnapshotSettingsRestInterceptor:
    """Interceptor for RegionSnapshotSettings.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the RegionSnapshotSettingsRestTransport.

    .. code-block:: python
        class MyCustomRegionSnapshotSettingsInterceptor(RegionSnapshotSettingsRestInterceptor):
        ...
        transport = RegionSnapshotSettingsRestTransport(interceptor=MyCustomRegionSnapshotSettingsInterceptor())
        client = RegionSnapshotSettingsClient(transport=transport)


    """
    def pre_get(self, request: compute.GetRegionSnapshotSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetRegionSnapshotSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for get

        Override in a subclass to manipulate the request or metadata
        before they are sent to the RegionSnapshotSettings server.
        """
        return request, metadata
    ...
    def post_get(self, response: compute.SnapshotSettings) -> compute.SnapshotSettings:
        ...
        after it is returned by the RegionSnapshotSettings server but before
        it is returned to user code. This `post_get` interceptor runs
        before the `post_get_with_metadata` interceptor.
        """
        return response

    def post_get_with_metadata(self, response: compute.SnapshotSettings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SnapshotSettings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the RegionSnapshotSettings server but before it is returned to user code.
    ...
    def pre_patch(self, request: compute.PatchRegionSnapshotSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchRegionSnapshotSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class RegionSnapshotSettingsRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: RegionSnapshotSettingsRestInterceptor


class RegionSnapshotSettingsRestTransport(_BaseRegionSnapshotSettingsRestTransport):
    """REST backend synchronous transport for RegionSnapshotSettings.
    ...
    def __init__(self, *,
            ...
            interceptor: Optional[RegionSnapshotSettingsRestInterceptor] = None,
    ...
    class _Get(_BaseRegionSnapshotSettingsRestTransport._BaseGet, RegionSnapshotSettingsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionSnapshotSettingsClient.Get",
                    extra = {
            ...
            # Send the request
            response = RegionSnapshotSettingsRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionSnapshotSettingsClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.RegionSnapshotSettings",
                        "rpcName": "Get",
    ...
    class _Patch(_BaseRegionSnapshotSettingsRestTransport._BasePatch, RegionSnapshotSettingsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionSnapshotSettingsClient.Patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.RegionSnapshotSettings",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionSnapshotSettingsRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionSnapshotSettingsClient.patch",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.RegionSnapshotSettings",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],

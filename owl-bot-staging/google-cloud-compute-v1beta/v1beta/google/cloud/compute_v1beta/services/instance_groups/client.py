...
from google.cloud.compute_v1beta.services.instance_groups import pagers
...
class InstanceGroupsClient(metaclass=InstanceGroupsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = InstanceGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, InstanceGroupsTransport, Callable[..., InstanceGroupsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = InstanceGroupsClient._read_environment_variables()
        self._client_cert_source = InstanceGroupsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = InstanceGroupsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[InstanceGroupsTransport], Callable[..., InstanceGroupsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.InstanceGroupsClient`.",
                    extra = {
    ...
    def add_instances_unary(self,
            request: Optional[Union[compute.AddInstancesInstanceGroupRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            instance_group: Optional[str] = None,
            instance_groups_add_instances_request_resource: Optional[compute.InstanceGroupsAddInstancesRequest] = None,
        ...
        .. code-block:: python
            ...
            def sample_add_instances():
                ...
                request = compute_v1beta.AddInstancesInstanceGroupRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AddInstancesInstanceGroupRequest, dict]):
            ...
            instance_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            instance_groups_add_instances_request_resource (google.cloud.compute_v1beta.types.InstanceGroupsAddInstancesRequest):
        ...
        flattened_params = [project, zone, instance_group, instance_groups_add_instances_request_resource]
        ...
        if not isinstance(request, compute.AddInstancesInstanceGroupRequest):
            ...
            if instance_groups_add_instances_request_resource is not None:
                request.instance_groups_add_instances_request_resource = instance_groups_add_instances_request_resource
    ...
    def aggregated_list(self,
            request: Optional[Union[compute.AggregatedListInstanceGroupsRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.AggregatedListInstanceGroupsRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListInstanceGroupsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.instance_groups.pagers.AggregatedListPager:
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteInstanceGroupRequest(
                    instance_group="instance_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteInstanceGroupRequest, dict]):
                The request object. A request message for
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetInstanceGroupRequest(
                    instance_group="instance_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetInstanceGroupRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertInstanceGroupRequest, dict]):
                The request object. A request message for
            ...
            zone (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            instance_group_resource (google.cloud.compute_v1beta.types.InstanceGroup):
                The body resource for this request
    ...
    def list(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListInstanceGroupsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.instance_groups.pagers.ListPager:
    ...
    def list_instances(self,
            request: Optional[Union[compute.ListInstancesInstanceGroupsRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            instance_group: Optional[str] = None,
            instance_groups_list_instances_request_resource: Optional[compute.InstanceGroupsListInstancesRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            def sample_list_instances():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListInstancesInstanceGroupsRequest(
                    instance_group="instance_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListInstancesInstanceGroupsRequest, dict]):
                The request object. A request message for
            ...
            instance_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            instance_groups_list_instances_request_resource (google.cloud.compute_v1beta.types.InstanceGroupsListInstancesRequest):
                The body resource for this request
        ...
        Returns:
            google.cloud.compute_v1beta.services.instance_groups.pagers.ListInstancesPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, instance_group, instance_groups_list_instances_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.ListInstancesInstanceGroupsRequest):
            ...
            if instance_groups_list_instances_request_resource is not None:
                request.instance_groups_list_instances_request_resource = instance_groups_list_instances_request_resource
    ...
    def remove_instances_unary(self,
            request: Optional[Union[compute.RemoveInstancesInstanceGroupRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            instance_group: Optional[str] = None,
            instance_groups_remove_instances_request_resource: Optional[compute.InstanceGroupsRemoveInstancesRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_remove_instances():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.RemoveInstancesInstanceGroupRequest(
                    instance_group="instance_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.RemoveInstancesInstanceGroupRequest, dict]):
                The request object. A request message for
            ...
            instance_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            instance_groups_remove_instances_request_resource (google.cloud.compute_v1beta.types.InstanceGroupsRemoveInstancesRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, instance_group, instance_groups_remove_instances_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.RemoveInstancesInstanceGroupRequest):
            ...
            if instance_groups_remove_instances_request_resource is not None:
                request.instance_groups_remove_instances_request_resource = instance_groups_remove_instances_request_resource
    ...
    def set_named_ports_unary(self,
            request: Optional[Union[compute.SetNamedPortsInstanceGroupRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            instance_group: Optional[str] = None,
            instance_groups_set_named_ports_request_resource: Optional[compute.InstanceGroupsSetNamedPortsRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_set_named_ports():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetNamedPortsInstanceGroupRequest(
                    instance_group="instance_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetNamedPortsInstanceGroupRequest, dict]):
                The request object. A request message for
            ...
            instance_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            instance_groups_set_named_ports_request_resource (google.cloud.compute_v1beta.types.InstanceGroupsSetNamedPortsRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, instance_group, instance_groups_set_named_ports_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.SetNamedPortsInstanceGroupRequest):
            ...
            if instance_groups_set_named_ports_request_resource is not None:
                request.instance_groups_set_named_ports_request_resource = instance_groups_set_named_ports_request_resource
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsInstanceGroupRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsInstanceGroupRequest, dict]):
                The request object. A request message for

...
class DiskSettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetDiskSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetDiskSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_patch(self, request: compute.PatchDiskSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.PatchDiskSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class DiskSettingsServiceRestTransport(_BaseDiskSettingsServiceRestTransport):
    ...
    class _Get(_BaseDiskSettingsServiceRestTransport._BaseGet, DiskSettingsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DiskSettingsServiceRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Patch(_BaseDiskSettingsServiceRestTransport._BasePatch, DiskSettingsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DiskSettingsServiceRestTransport._Patch._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

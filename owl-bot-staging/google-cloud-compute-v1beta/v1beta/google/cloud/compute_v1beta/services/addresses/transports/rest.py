...
class AddressesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListAddressesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListAddressesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.AddressAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AddressAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_delete(self, request: compute.DeleteAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DeleteAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(self, request: compute.GetAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert(self, request: compute.InsertAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.InsertAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListAddressesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListAddressesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_move(self, request: compute.MoveAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.MoveAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_set_labels(self, request: compute.SetLabelsAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.SetLabelsAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class AddressesRestTransport(_BaseAddressesRestTransport):
    ...
    class _AggregatedList(_BaseAddressesRestTransport._BaseAggregatedList, AddressesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AddressesRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseAddressesRestTransport._BaseInsert, AddressesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AddressesRestTransport._Insert._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Move(_BaseAddressesRestTransport._BaseMove, AddressesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AddressesRestTransport._Move._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SetLabels(_BaseAddressesRestTransport._BaseSetLabels, AddressesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AddressesRestTransport._SetLabels._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseAddressesRestTransport._BaseTestIamPermissions, AddressesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AddressesRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

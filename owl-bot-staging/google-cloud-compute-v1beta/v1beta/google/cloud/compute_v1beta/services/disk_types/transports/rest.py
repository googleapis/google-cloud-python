...
class DiskTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListDiskTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListDiskTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.DiskTypeAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DiskTypeAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_get(self, request: compute.GetDiskTypeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetDiskTypeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(self, request: compute.ListDiskTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListDiskTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.DiskTypeList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DiskTypeList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class DiskTypesRestTransport(_BaseDiskTypesRestTransport):
    ...
    class _AggregatedList(_BaseDiskTypesRestTransport._BaseAggregatedList, DiskTypesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDiskTypesRestTransport._BaseAggregatedList._get_http_options()

            request, metadata = self._interceptor.pre_aggregated_list(request, metadata)
            transcoded_request = _BaseDiskTypesRestTransport._BaseAggregatedList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDiskTypesRestTransport._BaseAggregatedList._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.DiskTypesClient.AggregatedList",
                    extra = {
            ...
            # Send the request
            response = DiskTypesRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.DiskTypesClient.aggregated_list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.DiskTypes",
                        "rpcName": "AggregatedList",
    ...
    class _Get(_BaseDiskTypesRestTransport._BaseGet, DiskTypesRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseDiskTypesRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDiskTypesRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.DiskTypesClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.DiskTypes",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = DiskTypesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.DiskTypesClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.DiskTypes",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseDiskTypesRestTransport._BaseList, DiskTypesRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseDiskTypesRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDiskTypesRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.DiskTypesClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.DiskTypes",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = DiskTypesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.DiskTypesClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.DiskTypes",
                        "rpcName": "List",
                        "metadata": http_response["headers"],

...
class StoragePoolTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListStoragePoolTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.AggregatedListStoragePoolTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list_with_metadata(self, response: compute.StoragePoolTypeAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.StoragePoolTypeAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_get(self, request: compute.GetStoragePoolTypeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetStoragePoolTypeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.StoragePoolType, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.StoragePoolType, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_list(self, request: compute.ListStoragePoolTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListStoragePoolTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.StoragePoolTypeList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.StoragePoolTypeList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    class _AggregatedList(_BaseStoragePoolTypesRestTransport._BaseAggregatedList, StoragePoolTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.StoragePoolTypesClient.AggregatedList",
                    extra = {
            ...
            # Send the request
            response = StoragePoolTypesRestTransport._AggregatedList._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.StoragePoolTypesClient.aggregated_list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.StoragePoolTypes",
                        "rpcName": "AggregatedList",
    ...
    class _Get(_BaseStoragePoolTypesRestTransport._BaseGet, StoragePoolTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.StoragePoolTypesClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.StoragePoolTypes",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = StoragePoolTypesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.StoragePoolTypesClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.StoragePoolTypes",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseStoragePoolTypesRestTransport._BaseList, StoragePoolTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.StoragePoolTypesClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.StoragePoolTypes",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = StoragePoolTypesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.StoragePoolTypesClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.StoragePoolTypes",
                        "rpcName": "List",
                        "metadata": http_response["headers"],

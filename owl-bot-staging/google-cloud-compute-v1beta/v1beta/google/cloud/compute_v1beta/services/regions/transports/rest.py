...
class RegionsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetRegionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetRegionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.Region, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.Region, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_list(self, request: compute.ListRegionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListRegionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.RegionList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.RegionList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class RegionsRestTransport(_BaseRegionsRestTransport):
    ...
    class _Get(_BaseRegionsRestTransport._BaseGet, RegionsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseRegionsRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseRegionsRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionsClient.Get",
                    extra = {
            ...
            # Send the request
            response = RegionsRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionsClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Regions",
                        "rpcName": "Get",
    ...
    class _List(_BaseRegionsRestTransport._BaseList, RegionsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseRegionsRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseRegionsRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionsClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Regions",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionsRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionsClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.Regions",
                        "rpcName": "List",
                        "metadata": http_response["headers"],

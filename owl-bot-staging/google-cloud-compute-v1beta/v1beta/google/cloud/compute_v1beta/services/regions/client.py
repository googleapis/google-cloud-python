...
from google.cloud.compute_v1beta.services.regions import pagers
...
class RegionsClientMeta(type):
    """Metaclass for the Regions client.
...
class RegionsClient(metaclass=RegionsClientMeta):
    """The Regions API."""
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RegionsClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RegionsTransport:
        """Returns the transport used by the client instance.

        Returns:
            RegionsTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = RegionsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = RegionsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RegionsClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RegionsTransport, Callable[..., RegionsTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionsTransport,Callable[..., RegionsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the RegionsTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionsClient._read_environment_variables()
        self._client_cert_source = RegionsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RegionsTransport)
        if transport_provided:
            # transport is a RegionsTransport instance.
            ...
            self._transport = cast(RegionsTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionsTransport], Callable[..., RegionsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionsClient`.",
                    extra = {
    ...
    def get(self,
        ...
        for the region. It is recommended to use the default setting for
        the constraint unless your application requires the fail-closed
        ...
        .. code-block:: python
            ...
            def sample_get():
                # Create a client
                client = compute_v1beta.RegionsClient()

                # Initialize request argument(s)
                request = compute_v1beta.GetRegionRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionRequest, dict]):
            ...
            project (str):
                ...
                should not be set.
            region (str):
                Name of the region resource to
                return.
        ...
        Returns:
            google.cloud.compute_v1beta.types.Region:
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListRegionsRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.regions.pagers.ListPager:
    ...
    def __enter__(self) -> "RegionsClient":
        return self

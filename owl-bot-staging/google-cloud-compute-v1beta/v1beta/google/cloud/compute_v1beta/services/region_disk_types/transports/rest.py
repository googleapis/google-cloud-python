...
class RegionDiskTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetRegionDiskTypeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.GetRegionDiskTypeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(self, response: compute.DiskType, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.DiskType, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_list(self, request: compute.ListRegionDiskTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.ListRegionDiskTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(self, response: compute.RegionDiskTypeList, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.RegionDiskTypeList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class RegionDiskTypesRestTransport(_BaseRegionDiskTypesRestTransport):
    ...
    class _Get(_BaseRegionDiskTypesRestTransport._BaseGet, RegionDiskTypesRestStub):
        ...
        def __call__(self,
            ...
            Returns:
                ...
                `Regional </compute/docs/reference/rest/beta/regionDiskTypes>`__
                \*
                `Zonal </compute/docs/reference/rest/beta/diskTypes>`__
            ...
            http_options = _BaseRegionDiskTypesRestTransport._BaseGet._get_http_options()

            request, metadata = self._interceptor.pre_get(request, metadata)
            transcoded_request = _BaseRegionDiskTypesRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseRegionDiskTypesRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionDiskTypesClient.Get",
                    extra = {
            ...
            # Send the request
            response = RegionDiskTypesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionDiskTypesClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.RegionDiskTypes",
                        "rpcName": "Get",
    ...
    class _List(_BaseRegionDiskTypesRestTransport._BaseList, RegionDiskTypesRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseRegionDiskTypesRestTransport._BaseList._get_http_options()

            request, metadata = self._interceptor.pre_list(request, metadata)
            transcoded_request = _BaseRegionDiskTypesRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseRegionDiskTypesRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionDiskTypesClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.RegionDiskTypes",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionDiskTypesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionDiskTypesClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.RegionDiskTypes",
                        "rpcName": "List",
                        "metadata": http_response["headers"],

...
class VpnTunnelsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsVpnTunnelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[compute.TestIamPermissionsVpnTunnelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class VpnTunnelsRestTransport(_BaseVpnTunnelsRestTransport):
    ...
    class _AggregatedList(_BaseVpnTunnelsRestTransport._BaseAggregatedList, VpnTunnelsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.VpnTunnelsClient.AggregatedList",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.VpnTunnelsClient.aggregated_list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "AggregatedList",
    ...
    class _Delete(_BaseVpnTunnelsRestTransport._BaseDelete, VpnTunnelsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.VpnTunnelsClient.Delete",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.VpnTunnelsClient.delete",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
    ...
    class _Get(_BaseVpnTunnelsRestTransport._BaseGet, VpnTunnelsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.VpnTunnelsClient.Get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.VpnTunnelsClient.get",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _Insert(_BaseVpnTunnelsRestTransport._BaseInsert, VpnTunnelsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.VpnTunnelsClient.Insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.VpnTunnelsClient.insert",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseVpnTunnelsRestTransport._BaseList, VpnTunnelsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.VpnTunnelsClient.List",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.VpnTunnelsClient.list",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _SetLabels(_BaseVpnTunnelsRestTransport._BaseSetLabels, VpnTunnelsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.VpnTunnelsClient.SetLabels",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "SetLabels",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.VpnTunnelsClient.set_labels",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "SetLabels",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(_BaseVpnTunnelsRestTransport._BaseTestIamPermissions, VpnTunnelsRestStub):
        def __hash__(self):
            return hash("VpnTunnelsRestTransport.TestIamPermissions")
        ...
        def __call__(self,
            ...
            http_options = _BaseVpnTunnelsRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseVpnTunnelsRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseVpnTunnelsRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseVpnTunnelsRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.VpnTunnelsClient.TestIamPermissions",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
            ...
            # Send the request
            response = VpnTunnelsRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.VpnTunnelsClient.test_iam_permissions",
                    extra = {
                        "serviceName": "google.cloud.compute.v1beta.VpnTunnels",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],

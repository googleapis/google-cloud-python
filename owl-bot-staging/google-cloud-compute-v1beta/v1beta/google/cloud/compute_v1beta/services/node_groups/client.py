...
from google.cloud.compute_v1beta.services.node_groups import pagers
...
class NodeGroupsClient(metaclass=NodeGroupsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = NodeGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, NodeGroupsTransport, Callable[..., NodeGroupsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = NodeGroupsClient._read_environment_variables()
        self._client_cert_source = NodeGroupsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = NodeGroupsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            NodeGroupsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[NodeGroupsTransport], Callable[..., NodeGroupsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.NodeGroupsClient`.",
                    extra = {
    ...
    def add_nodes_unary(self,
            request: Optional[Union[compute.AddNodesNodeGroupRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            node_group: Optional[str] = None,
            node_groups_add_nodes_request_resource: Optional[compute.NodeGroupsAddNodesRequest] = None,
        ...
        .. code-block:: python
            ...
            def sample_add_nodes():
                ...
                request = compute_v1beta.AddNodesNodeGroupRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AddNodesNodeGroupRequest, dict]):
            ...
            node_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            node_groups_add_nodes_request_resource (google.cloud.compute_v1beta.types.NodeGroupsAddNodesRequest):
        ...
        flattened_params = [project, zone, node_group, node_groups_add_nodes_request_resource]
        ...
        if not isinstance(request, compute.AddNodesNodeGroupRequest):
            ...
            if node_groups_add_nodes_request_resource is not None:
                request.node_groups_add_nodes_request_resource = node_groups_add_nodes_request_resource
    ...
    def aggregated_list(self,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.AggregatedListNodeGroupsRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListNodeGroupsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.node_groups.pagers.AggregatedListPager:
    ...
    def delete_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteNodeGroupRequest(
                    node_group="node_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteNodeGroupRequest, dict]):
                The request object. A request message for
    ...
    def delete_nodes_unary(self,
            request: Optional[Union[compute.DeleteNodesNodeGroupRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            node_group: Optional[str] = None,
            node_groups_delete_nodes_request_resource: Optional[compute.NodeGroupsDeleteNodesRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_delete_nodes():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteNodesNodeGroupRequest(
                    node_group="node_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteNodesNodeGroupRequest, dict]):
                The request object. A request message for
            ...
            node_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            node_groups_delete_nodes_request_resource (google.cloud.compute_v1beta.types.NodeGroupsDeleteNodesRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, node_group, node_groups_delete_nodes_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.DeleteNodesNodeGroupRequest):
            ...
            if node_groups_delete_nodes_request_resource is not None:
                request.node_groups_delete_nodes_request_resource = node_groups_delete_nodes_request_resource
    ...
    def get(self,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetNodeGroupRequest(
                    node_group="node_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetNodeGroupRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.types.NodeGroup:
    ...
    def get_iam_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetIamPolicyNodeGroupRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyNodeGroupRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertNodeGroupRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertNodeGroupRequest, dict]):
                The request object. A request message for
            ...
            initial_node_count (int):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            node_group_resource (google.cloud.compute_v1beta.types.NodeGroup):
                The body resource for this request
    ...
    def list(self,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListNodeGroupsRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListNodeGroupsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.node_groups.pagers.ListPager:
    ...
    def list_nodes(self,
        ...
        .. code-block:: python
            ...
            def sample_list_nodes():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListNodesNodeGroupsRequest(
                    node_group="node_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListNodesNodeGroupsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.node_groups.pagers.ListNodesPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def patch_unary(self,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchNodeGroupRequest(
                    node_group="node_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchNodeGroupRequest, dict]):
                The request object. A request message for
    ...
    def perform_maintenance_unary(self,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PerformMaintenanceNodeGroupRequest, dict]):
                The request object. A request message for
            ...
            node_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            node_groups_perform_maintenance_request_resource (google.cloud.compute_v1beta.types.NodeGroupsPerformMaintenanceRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, node_group, node_groups_perform_maintenance_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_iam_policy(self,
        ...
        .. code-block:: python
            ...
            def sample_set_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetIamPolicyNodeGroupRequest(
                    project="project_value",
                    resource="resource_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyNodeGroupRequest, dict]):
                The request object. A request message for
    ...
    def set_node_template_unary(self,
            request: Optional[Union[compute.SetNodeTemplateNodeGroupRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            node_group: Optional[str] = None,
            node_groups_set_node_template_request_resource: Optional[compute.NodeGroupsSetNodeTemplateRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_set_node_template():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetNodeTemplateNodeGroupRequest(
                    node_group="node_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetNodeTemplateNodeGroupRequest, dict]):
                The request object. A request message for
            ...
            node_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            node_groups_set_node_template_request_resource (google.cloud.compute_v1beta.types.NodeGroupsSetNodeTemplateRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, node_group, node_groups_set_node_template_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.SetNodeTemplateNodeGroupRequest):
            ...
            if node_groups_set_node_template_request_resource is not None:
                request.node_groups_set_node_template_request_resource = node_groups_set_node_template_request_resource
    ...
    def simulate_maintenance_event_unary(self,
            request: Optional[Union[compute.SimulateMaintenanceEventNodeGroupRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            node_group: Optional[str] = None,
            node_groups_simulate_maintenance_event_request_resource: Optional[compute.NodeGroupsSimulateMaintenanceEventRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_simulate_maintenance_event():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SimulateMaintenanceEventNodeGroupRequest(
                    node_group="node_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SimulateMaintenanceEventNodeGroupRequest, dict]):
                The request object. A request message for
            ...
            node_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            node_groups_simulate_maintenance_event_request_resource (google.cloud.compute_v1beta.types.NodeGroupsSimulateMaintenanceEventRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, node_group, node_groups_simulate_maintenance_event_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.SimulateMaintenanceEventNodeGroupRequest):
            ...
            if node_groups_simulate_maintenance_event_request_resource is not None:
                request.node_groups_simulate_maintenance_event_request_resource = node_groups_simulate_maintenance_event_request_resource
    ...
    def test_iam_permissions(self,
            request: Optional[Union[compute.TestIamPermissionsNodeGroupRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            resource: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsNodeGroupRequest, dict]):
                The request object. A request message for

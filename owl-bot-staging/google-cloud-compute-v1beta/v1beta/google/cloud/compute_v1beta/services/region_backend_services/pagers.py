...
class ListPager:
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListRegionBackendServicesRequest):
...
class ListUsablePager:
    ...
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListUsableRegionBackendServicesRequest):
                The initial request object.

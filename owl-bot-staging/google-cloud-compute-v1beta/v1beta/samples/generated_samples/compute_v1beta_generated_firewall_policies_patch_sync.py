...
# [START compute_v1beta_generated_FirewallPolicies_Patch_sync]
...
def sample_patch():
    ...
    request = compute_v1beta.PatchFirewallPolicyRequest(
...
# [END compute_v1beta_generated_FirewallPolicies_Patch_sync]

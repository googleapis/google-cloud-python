...
class CloudQuotasClient(metaclass=CloudQuotasClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            CloudQuotasClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def list_quota_infos(self,
        ...
        Args:
            request (Union[google.cloud.cloudquotas_v1.types.ListQuotaInfosRequest, dict]):
    ...
    def list_quota_preferences(self,
        ...
        Args:
            request (Union[google.cloud.cloudquotas_v1.types.ListQuotaPreferencesRequest, dict]):
                The request object. Message for requesting list of
                QuotaPreferences
            parent (str):
    ...
    def create_quota_preference(self,
        ...
        Args:
            request (Union[google.cloud.cloudquotas_v1.types.CreateQuotaPreferenceRequest, dict]):
    ...
    def update_quota_preference(self,
        ...
        Args:
            request (Union[google.cloud.cloudquotas_v1.types.UpdateQuotaPreferenceRequest, dict]):

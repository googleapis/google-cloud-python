...
class QuotaInfo(proto.Message):
    ...
    Attributes:
        ...
        container_type (google.cloud.quotas_v1.types.QuotaInfo.ContainerType):
        ...
        metric_unit (str):
            ...
            reported, e.g., "MByte".
        quota_increase_eligibility (google.cloud.quotas_v1.types.QuotaIncreaseEligibility):
            Whether it is eligible to request a higher
            quota value for this quota.
        is_fixed (bool):
            Whether the quota value is fixed or
            adjustable
        dimensions_infos (MutableSequence[google.cloud.quotas_v1.types.DimensionsInfo]):
...
class QuotaIncreaseEligibility(proto.Message):
    ...
    Attributes:
        is_eligible (bool):
            ...
            for the quota.
        ineligibility_reason (google.cloud.quotas_v1.types.QuotaIncreaseEligibility.IneligibilityReason):
...
class QuotaPreference(proto.Message):
    ...
    Attributes:
        ...
        quota_config (google.cloud.quotas_v1.types.QuotaConfig):
...
class QuotaConfig(proto.Message):
    ...
    Attributes:
        ...
        request_origin (google.cloud.quotas_v1.types.QuotaConfig.Origin):
...
class DimensionsInfo(proto.Message):
    ...
    Attributes:
        dimensions (MutableMapping[str, str]):
            ...
            quota.
        details (google.cloud.quotas_v1.types.QuotaDetails):

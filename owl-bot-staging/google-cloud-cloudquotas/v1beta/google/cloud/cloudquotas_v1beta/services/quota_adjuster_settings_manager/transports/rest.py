...
class QuotaAdjusterSettingsManagerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_quota_adjuster_settings(self, request: quota_adjuster_settings.GetQuotaAdjusterSettingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[quota_adjuster_settings.GetQuotaAdjusterSettingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_quota_adjuster_settings(self, response: quota_adjuster_settings.QuotaAdjusterSettings) -> quota_adjuster_settings.QuotaAdjusterSettings:
    ...
    def pre_update_quota_adjuster_settings(self, request: gac_quota_adjuster_settings.UpdateQuotaAdjusterSettingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gac_quota_adjuster_settings.UpdateQuotaAdjusterSettingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_quota_adjuster_settings(self, response: gac_quota_adjuster_settings.QuotaAdjusterSettings) -> gac_quota_adjuster_settings.QuotaAdjusterSettings:
...
class QuotaAdjusterSettingsManagerRestTransport(_BaseQuotaAdjusterSettingsManagerRestTransport):
    ...
    class _GetQuotaAdjusterSettings(_BaseQuotaAdjusterSettingsManagerRestTransport._BaseGetQuotaAdjusterSettings, QuotaAdjusterSettingsManagerRestStub):
        def __hash__(self):
        ...
        settings method over HTTP.
            ...
            transcoded_request = _BaseQuotaAdjusterSettingsManagerRestTransport._BaseGetQuotaAdjusterSettings._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = QuotaAdjusterSettingsManagerRestTransport._GetQuotaAdjusterSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateQuotaAdjusterSettings(_BaseQuotaAdjusterSettingsManagerRestTransport._BaseUpdateQuotaAdjusterSettings, QuotaAdjusterSettingsManagerRestStub):
        def __hash__(self):
        ...
        settings method over HTTP.
            ...
            transcoded_request = _BaseQuotaAdjusterSettingsManagerRestTransport._BaseUpdateQuotaAdjusterSettings._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = QuotaAdjusterSettingsManagerRestTransport._UpdateQuotaAdjusterSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

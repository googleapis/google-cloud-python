...
class LineageTransport(abc.ABC):
    ...
    @property
    def create_process(self) -> Callable[
            [lineage.CreateProcessRequest],
            Union[
                lineage.Process,
                Awaitable[lineage.Process]
            ]]:
        raise NotImplementedError()

    @property
    def update_process(self) -> Callable[
    ...
    @property
    def list_processes(self) -> Callable[
            [lineage.ListProcessesRequest],
            Union[
                lineage.ListProcessesResponse,
                Awaitable[lineage.ListProcessesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def delete_process(self) -> Callable[
    ...
    @property
    def create_run(self) -> Callable[
            [lineage.CreateRunRequest],
            Union[
                lineage.Run,
                Awaitable[lineage.Run]
            ]]:
        raise NotImplementedError()

    @property
    def update_run(self) -> Callable[
    ...
    @property
    def list_runs(self) -> Callable[
            [lineage.ListRunsRequest],
            Union[
                lineage.ListRunsResponse,
                Awaitable[lineage.ListRunsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def delete_run(self) -> Callable[
    ...
    @property
    def create_lineage_event(self) -> Callable[
            [lineage.CreateLineageEventRequest],
            Union[
                lineage.LineageEvent,
                Awaitable[lineage.LineageEvent]
            ]]:
        raise NotImplementedError()

    @property
    def get_lineage_event(self) -> Callable[
    ...
    @property
    def list_lineage_events(self) -> Callable[
    ...
    @property
    def delete_lineage_event(self) -> Callable[
    ...
    @property
    def search_links(self) -> Callable[
            [lineage.SearchLinksRequest],
            Union[
                lineage.SearchLinksResponse,
                Awaitable[lineage.SearchLinksResponse]
            ]]:
        raise NotImplementedError()

    @property
    def batch_search_link_processes(self) -> Callable[

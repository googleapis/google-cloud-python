...
from .base import LineageTransport, DEFAULT_CLIENT_INFO
...
class LineageGrpcTransport(LineageTransport):
    ...
    @property
    def process_open_lineage_run_event(self) -> Callable[
        ...
        if 'process_open_lineage_run_event' not in self._stubs:
            self._stubs['process_open_lineage_run_event'] = self.grpc_channel.unary_unary(

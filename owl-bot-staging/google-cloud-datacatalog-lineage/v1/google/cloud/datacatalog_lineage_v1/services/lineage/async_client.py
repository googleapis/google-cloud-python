...
from .transports.base import LineageTransport, DEFAULT_CLIENT_INFO
...
class LineageAsyncClient:
    ...
    get_transport_class = functools.partial(type(LineageClient).get_transport_class, type(LineageClient))
    ...
    async def process_open_lineage_run_event(self,
    ...
    async def create_lineage_event(self,
    ...
    async def get_lineage_event(self,
    ...
    async def list_lineage_events(self,
    ...
    async def delete_lineage_event(self,
    ...
    async def batch_search_link_processes(self,

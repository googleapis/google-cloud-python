...
from google.cloud.datacatalog_lineage_v1.services.lineage import LineageAsyncClient
from google.cloud.datacatalog_lineage_v1.services.lineage import LineageClient
from google.cloud.datacatalog_lineage_v1.services.lineage import pagers
from google.cloud.datacatalog_lineage_v1.services.lineage import transports
...
@pytest.mark.parametrize("client_class", [
    LineageClient, LineageAsyncClient
])
...
def test_process_open_lineage_run_event(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.process_open_lineage_run_event),
            '__call__') as call:
...
def test_list_processes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, lineage.Process)
                   for i in results)
...
def test_create_run(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_run),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_run(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_run),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = lineage.Run(
            name='name_value',
...
def test_list_runs(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_runs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_runs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, lineage.Run)
                   for i in results)
...
async def test_list_runs_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_runs(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_delete_run(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_run),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_lineage_event(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_lineage_event),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_lineage_event(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_lineage_event),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = lineage.LineageEvent(
            name='name_value',
...
def test_list_lineage_events_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, lineage.LineageEvent)
                   for i in results)
...
async def test_list_lineage_events_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_lineage_events(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_delete_lineage_event(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_lineage_event),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_search_links(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_links),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_search_links_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, lineage.Link)
                   for i in results)
...
async def test_search_links_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.search_links(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_batch_search_link_processes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, lineage.ProcessLinks)
                   for i in results)
...
async def test_batch_search_link_processes_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.batch_search_link_processes(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_process_open_lineage_run_event_rest_required_fields(request_type=lineage.ProcessOpenLineageRunEventRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).process_open_lineage_run_event._get_unset_required_fields(jsonified_request)
...
def test_process_open_lineage_run_event_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("parent", "openLineage", )))
...
def test_create_process_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("parent", "process", )))
...
def test_update_process_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "updateMask", )) & set(("process", )))
...
def test_create_run_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("parent", "run", )))
...
def test_update_run_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "updateMask", )) & set(("run", )))
...
def test_create_lineage_event_rest_required_fields(request_type=lineage.CreateLineageEventRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_lineage_event._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_lineage_event_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("parent", "lineageEvent", )))
...
def test_list_lineage_events_rest_required_fields(request_type=lineage.ListLineageEventsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_lineage_events._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_lineage_event_rest_required_fields(request_type=lineage.DeleteLineageEventRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_lineage_event._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_search_link_processes_rest_required_fields(request_type=lineage.BatchSearchLinkProcessesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_search_link_processes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_search_link_processes_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "links", )))
...
def test_process_open_lineage_run_event_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_process_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = lineage.Process()
        client.create_process(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_process_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = lineage.Process()
        client.update_process(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_process_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = lineage.Process()
        client.get_process(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_processes_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = lineage.ListProcessesResponse()
        client.list_processes(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = lineage.ListProcessesRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_process_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_process(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = lineage.DeleteProcessRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_run_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = lineage.Run()
        client.create_run(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_run_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = lineage.Run()
        client.update_run(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = lineage.UpdateRunRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_run_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = lineage.Run()
        client.get_run(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = lineage.GetRunRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_runs_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_run_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_run(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = lineage.DeleteRunRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_lineage_event_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_lineage_event_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = lineage.GetLineageEventRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_lineage_events_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = lineage.ListLineageEventsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_lineage_event_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = lineage.DeleteLineageEventRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_links_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = lineage.SearchLinksResponse()
        client.search_links(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = lineage.SearchLinksRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_search_link_processes_empty_call_grpc():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_process_open_lineage_run_event_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.process_open_lineage_run_event(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_process_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_process(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_process_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_process(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_process_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_process(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_processes_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_processes(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_process_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_run_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_run(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_run_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_run(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_run_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_run(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_runs_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_runs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_run_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_lineage_event_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_lineage_event(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_lineage_event_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_lineage_event(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_lineage_events_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_lineage_events(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_lineage_event_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_links_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.search_links(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_search_link_processes_empty_call_grpc_asyncio():
    client = LineageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_search_link_processes(request=None)
...
def test_process_open_lineage_run_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LineageRestInterceptor, "post_process_open_lineage_run_event") as post, \
        mock.patch.object(transports.LineageRestInterceptor, "post_process_open_lineage_run_event_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LineageRestInterceptor, "pre_process_open_lineage_run_event") as pre:
        ...
        client.process_open_lineage_run_event(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_process_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["process"] = {'name': 'name_value', 'display_name': 'display_name_value', 'attributes': {}, 'origin': {'source_type': 1, 'name': 'name_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LineageRestInterceptor, "post_create_process") as post, \
        mock.patch.object(transports.LineageRestInterceptor, "post_create_process_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LineageRestInterceptor, "pre_create_process") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_process_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'process': {'name': 'projects/sample1/locations/sample2/processes/sample3'}}
    request_init["process"] = {'name': 'projects/sample1/locations/sample2/processes/sample3', 'display_name': 'display_name_value', 'attributes': {}, 'origin': {'source_type': 1, 'name': 'name_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LineageRestInterceptor, "post_update_process") as post, \
        mock.patch.object(transports.LineageRestInterceptor, "post_update_process_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LineageRestInterceptor, "pre_update_process") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LineageRestInterceptor, "post_get_process") as post, \
        mock.patch.object(transports.LineageRestInterceptor, "post_get_process_with_metadata") as post_with_metadata, \
...
def test_list_processes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LineageRestInterceptor, "post_list_processes") as post, \
        mock.patch.object(transports.LineageRestInterceptor, "post_list_processes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LineageRestInterceptor, "pre_list_processes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LineageRestInterceptor, "post_delete_process") as post, \
        mock.patch.object(transports.LineageRestInterceptor, "post_delete_process_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LineageRestInterceptor, "pre_delete_process") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_run_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/processes/sample3'}
    request_init["run"] = {'name': 'name_value', 'display_name': 'display_name_value', 'attributes': {}, 'start_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}, 'state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LineageRestInterceptor, "post_create_run_with_metadata") as post_with_metadata, \
        ...
        client.create_run(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_run_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'run': {'name': 'projects/sample1/locations/sample2/processes/sample3/runs/sample4'}}
    request_init["run"] = {'name': 'projects/sample1/locations/sample2/processes/sample3/runs/sample4', 'display_name': 'display_name_value', 'attributes': {}, 'start_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}, 'state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LineageRestInterceptor, "post_update_run_with_metadata") as post_with_metadata, \
        ...
        client.update_run(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LineageRestInterceptor, "post_get_run_with_metadata") as post_with_metadata, \
        ...
        client.get_run(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_runs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LineageRestInterceptor, "post_list_runs_with_metadata") as post_with_metadata, \
        ...
        client.list_runs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LineageRestInterceptor, "post_delete_run_with_metadata") as post_with_metadata, \
        ...
        client.delete_run(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_lineage_event_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/processes/sample3/runs/sample4'}
    request_init["lineage_event"] = {'name': 'name_value', 'links': [{'source': {'fully_qualified_name': 'fully_qualified_name_value'}, 'target': {}}], 'start_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_lineage_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LineageRestInterceptor, "post_create_lineage_event") as post, \
        mock.patch.object(transports.LineageRestInterceptor, "post_create_lineage_event_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LineageRestInterceptor, "pre_create_lineage_event") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_lineage_event(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_lineage_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LineageRestInterceptor, "post_get_lineage_event") as post, \
        mock.patch.object(transports.LineageRestInterceptor, "post_get_lineage_event_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LineageRestInterceptor, "pre_get_lineage_event") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_lineage_event(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_lineage_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LineageRestInterceptor, "post_list_lineage_events") as post, \
        mock.patch.object(transports.LineageRestInterceptor, "post_list_lineage_events_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LineageRestInterceptor, "pre_list_lineage_events") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_lineage_events(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_lineage_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LineageRestInterceptor, "pre_delete_lineage_event") as pre:
        pre.assert_not_called()
        ...
        client.delete_lineage_event(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_search_links_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LineageRestInterceptor, "post_search_links") as post, \
        mock.patch.object(transports.LineageRestInterceptor, "post_search_links_with_metadata") as post_with_metadata, \
        ...
        client.search_links(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_batch_search_link_processes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LineageRestInterceptor, "post_batch_search_link_processes") as post, \
        mock.patch.object(transports.LineageRestInterceptor, "post_batch_search_link_processes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LineageRestInterceptor, "pre_batch_search_link_processes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.batch_search_link_processes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_process_open_lineage_run_event_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_process_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_process_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_process_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_processes_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_process_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_run_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_run_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_run_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_runs_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_run_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_lineage_event_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_lineage_event_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_lineage_events_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_lineage_event_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_links_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_search_link_processes_empty_call_rest():
    client = LineageClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_lineage_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.datacatalog_lineage_v1.services.lineage.transports.LineageTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_lineage_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.datacatalog_lineage_v1.services.lineage.transports.LineageTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.LineageTransport()
        adc.assert_called_once()
...
def test_lineage_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.LineageGrpcTransport, transports.LineageGrpcAsyncIOTransport])
def test_lineage_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.LineageGrpcTransport, transports.LineageGrpcAsyncIOTransport])
def test_lineage_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_lineage_event_path():
    ...
    expected = "projects/{project}/locations/{location}/processes/{process}/runs/{run}/lineageEvents/{lineage_event}".format(project=project, location=location, process=process, run=run, lineage_event=lineage_event, )
...
def test_process_path():
    ...
    location = "abalone"
    process = "squid"
    expected = "projects/{project}/locations/{location}/processes/{process}".format(project=project, location=location, process=process, )
...
def test_run_path():
    ...
    process = "cuttlefish"
    run = "mussel"
    expected = "projects/{project}/locations/{location}/processes/{process}/runs/{run}".format(project=project, location=location, process=process, run=run, )

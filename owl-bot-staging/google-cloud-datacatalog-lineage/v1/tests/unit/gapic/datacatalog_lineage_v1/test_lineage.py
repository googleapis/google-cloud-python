...
def test_process_open_lineage_run_event_rest_required_fields(request_type=lineage.ProcessOpenLineageRunEventRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).process_open_lineage_run_event._get_unset_required_fields(jsonified_request)
...
def test_process_open_lineage_run_event_rest_unset_required_fields():
    transport = transports.LineageRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_process_open_lineage_run_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = lineage.ProcessOpenLineageRunEventResponse.to_json(lineage.ProcessOpenLineageRunEventResponse())
...
def test_process_open_lineage_run_event_rest_bad_request(transport: str = 'rest', request_type=lineage.ProcessOpenLineageRunEventRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_process_rest_required_fields(request_type=lineage.CreateProcessRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_process._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_process_rest_bad_request(transport: str = 'rest', request_type=lineage.CreateProcessRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_process_rest_required_fields(request_type=lineage.UpdateProcessRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_process._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_process_rest_bad_request(transport: str = 'rest', request_type=lineage.UpdateProcessRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_process_rest_required_fields(request_type=lineage.GetProcessRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_process._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_process_rest_bad_request(transport: str = 'rest', request_type=lineage.GetProcessRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_processes_rest_required_fields(request_type=lineage.ListProcessesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_processes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_processes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = lineage.ListProcessesResponse.to_json(lineage.ListProcessesResponse())
...
def test_list_processes_rest_bad_request(transport: str = 'rest', request_type=lineage.ListProcessesRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_process_rest_required_fields(request_type=lineage.DeleteProcessRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_process._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_process_rest_bad_request(transport: str = 'rest', request_type=lineage.DeleteProcessRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_run_rest_required_fields(request_type=lineage.CreateRunRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_run._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_run_rest_bad_request(transport: str = 'rest', request_type=lineage.CreateRunRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_run_rest_required_fields(request_type=lineage.UpdateRunRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_run._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_run_rest_bad_request(transport: str = 'rest', request_type=lineage.UpdateRunRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_run_rest_required_fields(request_type=lineage.GetRunRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_run._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_run_rest_bad_request(transport: str = 'rest', request_type=lineage.GetRunRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_runs_rest_required_fields(request_type=lineage.ListRunsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_runs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_runs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = lineage.ListRunsResponse.to_json(lineage.ListRunsResponse())
...
def test_list_runs_rest_bad_request(transport: str = 'rest', request_type=lineage.ListRunsRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_run_rest_required_fields(request_type=lineage.DeleteRunRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_run._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_run_rest_bad_request(transport: str = 'rest', request_type=lineage.DeleteRunRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_create_lineage_event_rest_required_fields(request_type=lineage.CreateLineageEventRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_lineage_event._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_lineage_event_rest_bad_request(transport: str = 'rest', request_type=lineage.CreateLineageEventRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_get_lineage_event_rest_required_fields(request_type=lineage.GetLineageEventRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_lineage_event._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_lineage_event_rest_bad_request(transport: str = 'rest', request_type=lineage.GetLineageEventRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_list_lineage_events_rest_required_fields(request_type=lineage.ListLineageEventsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_lineage_events._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_lineage_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = lineage.ListLineageEventsResponse.to_json(lineage.ListLineageEventsResponse())
...
def test_list_lineage_events_rest_bad_request(transport: str = 'rest', request_type=lineage.ListLineageEventsRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_lineage_event_rest_required_fields(request_type=lineage.DeleteLineageEventRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_lineage_event._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_lineage_event_rest_bad_request(transport: str = 'rest', request_type=lineage.DeleteLineageEventRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_search_links_rest_required_fields(request_type=lineage.SearchLinksRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_links._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_links_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = lineage.SearchLinksResponse.to_json(lineage.SearchLinksResponse())
...
def test_search_links_rest_bad_request(transport: str = 'rest', request_type=lineage.SearchLinksRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_batch_search_link_processes_rest_required_fields(request_type=lineage.BatchSearchLinkProcessesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_search_link_processes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_search_link_processes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = lineage.BatchSearchLinkProcessesResponse.to_json(lineage.BatchSearchLinkProcessesResponse())
...
def test_batch_search_link_processes_rest_bad_request(transport: str = 'rest', request_type=lineage.BatchSearchLinkProcessesRequest):
    client = LineageClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )

...
from google.cloud.datacatalog.lineage_v1.services.lineage import LineageAsyncClient
from google.cloud.datacatalog.lineage_v1.services.lineage import LineageClient
from google.cloud.datacatalog.lineage_v1.services.lineage import pagers
from google.cloud.datacatalog.lineage_v1.services.lineage import transports
...
def test_lineage_client_client_options_from_dict():
    with mock.patch('google.cloud.datacatalog.lineage_v1.services.lineage.transports.LineageGrpcTransport.__init__') as grpc_transport:
...
def test_lineage_base_transport():
    ...
    with mock.patch('google.cloud.datacatalog.lineage_v1.services.lineage.transports.LineageTransport.__init__') as Transport:
...
def test_lineage_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.datacatalog.lineage_v1.services.lineage.transports.LineageTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_lineage_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.datacatalog.lineage_v1.services.lineage.transports.LineageTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.LineageTransport()
        adc.assert_called_once()

...
from .transports.base import LicenseManagerTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import LicenseManagerGrpcTransport
from .transports.grpc_asyncio import LicenseManagerGrpcAsyncIOTransport
from .transports.rest import LicenseManagerRestTransport


class LicenseManagerClientMeta(type):
    """Metaclass for the LicenseManager client.
...
class LicenseManagerClient(metaclass=LicenseManagerClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "licensemanager.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            LicenseManagerClient: The constructed client.
        """
    ...
    def transport(self) -> LicenseManagerTransport:
        ...
        Returns:
            LicenseManagerTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def compute_instance_path(project: str,zone: str,instance: str,) -> str:
    ...
    @staticmethod
    def configuration_path(project: str,location: str,configuration: str,) -> str:
        """Returns a fully-qualified configuration string."""
        return "projects/{project}/locations/{location}/configurations/{configuration}".format(project=project, location=location, configuration=configuration, )

    @staticmethod
    def parse_configuration_path(path: str) -> Dict[str,str]:
        """Parses a configuration path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/configurations/(?P<configuration>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = LicenseManagerClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = LicenseManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = LicenseManagerClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, LicenseManagerTransport, Callable[..., LicenseManagerTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = LicenseManagerClient._read_environment_variables()
        self._client_cert_source = LicenseManagerClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = LicenseManagerClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, LicenseManagerTransport)
        if transport_provided:
            # transport is a LicenseManagerTransport instance.
            ...
            self._transport = cast(LicenseManagerTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            LicenseManagerClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[LicenseManagerTransport], Callable[..., LicenseManagerTransport]] = (
                LicenseManagerClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., LicenseManagerTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.licensemanager_v1.LicenseManagerClient`.",
                    extra = {
    ...
    def list_configurations(self,
            ...
            *,
            ...
            ) -> pagers.ListConfigurationsPager:
        ...
        .. code-block:: python
            ...
            def sample_list_configurations():
                # Create a client
        ...
        Args:
            request (Union[google.cloud.licensemanager_v1.types.ListConfigurationsRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_configurations]
        ...
        response = pagers.ListConfigurationsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_configuration(self,
        ...
        .. code-block:: python
            ...
            def sample_get_configuration():
                ...
                # Make the request
                response = client.get_configuration(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.licensemanager_v1.types.GetConfigurationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_configuration]
    ...
    def create_configuration(self,
        ...
        Args:
            request (Union[google.cloud.licensemanager_v1.types.CreateConfigurationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_configuration]
    ...
    def update_configuration(self,
        ...
        Args:
            request (Union[google.cloud.licensemanager_v1.types.UpdateConfigurationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_configuration]
    ...
    def delete_configuration(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_configuration():
                # Create a client
                client = licensemanager_v1.LicenseManagerClient()
        ...
        Args:
            request (Union[google.cloud.licensemanager_v1.types.DeleteConfigurationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_configuration]
    ...
    def list_instances(self,
        ...
        Args:
            request (Union[google.cloud.licensemanager_v1.types.ListInstancesRequest, dict]):
                The request object. Message for requesting list of
                Instances
            parent (str):
                Required. Parent value for
    ...
    def get_instance(self,
        ...
        Args:
            request (Union[google.cloud.licensemanager_v1.types.GetInstanceRequest, dict]):
    ...
    def deactivate_configuration(self,
        ...
        .. code-block:: python
            ...
            def sample_deactivate_configuration():
                # Create a client
                client = licensemanager_v1.LicenseManagerClient()
        ...
        Args:
            request (Union[google.cloud.licensemanager_v1.types.DeactivateConfigurationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.deactivate_configuration]
    ...
    def reactivate_configuration(self,
        ...
        .. code-block:: python
            ...
            def sample_reactivate_configuration():
                # Create a client
                client = licensemanager_v1.LicenseManagerClient()
        ...
        Args:
            request (Union[google.cloud.licensemanager_v1.types.ReactivateConfigurationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reactivate_configuration]
    ...
    def query_configuration_license_usage(self,
        ...
        .. code-block:: python
            ...
            def sample_query_configuration_license_usage():
                # Create a client
                client = licensemanager_v1.LicenseManagerClient()
                ...
                # Make the request
                response = client.query_configuration_license_usage(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.licensemanager_v1.types.QueryConfigurationLicenseUsageRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.query_configuration_license_usage]
    ...
    def aggregate_usage(self,
        ...
        Args:
            request (Union[google.cloud.licensemanager_v1.types.AggregateUsageRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.aggregate_usage]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.AggregateUsagePager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def list_products(self,
        ...
        Args:
            request (Union[google.cloud.licensemanager_v1.types.ListProductsRequest, dict]):
                The request object. Message for requesting list of
                Products
            parent (str):
                Required. Parent value for
    ...
    def get_product(self,
        ...
        Args:
            request (Union[google.cloud.licensemanager_v1.types.GetProductRequest, dict]):
    ...
    def __enter__(self) -> "LicenseManagerClient":
        return self

...
class LicenseManagerGrpcAsyncIOTransport(LicenseManagerTransport):
    """gRPC AsyncIO backend transport for LicenseManager.
    ...
    def list_configurations(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListConfigurationsRequest],
                    Awaitable[~.ListConfigurationsResponse]]:
    ...
    def get_configuration(self) -> Callable[
            ...
            Awaitable[api_entities.Configuration]]:
    ...
    def get_instance(self) -> Callable[
            ...
            Awaitable[api_entities.Instance]]:
    ...
    def query_configuration_license_usage(self) -> Callable[
        ...
        Returns:
            Callable[[~.QueryConfigurationLicenseUsageRequest],
                    Awaitable[~.QueryConfigurationLicenseUsageResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def aggregate_usage(self) -> Callable[
        ...
        Returns:
            Callable[[~.AggregateUsageRequest],
                    Awaitable[~.AggregateUsageResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_product(self) -> Callable[
            ...
            Awaitable[api_entities.Product]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_configurations: self._wrap_method(
            ...
            self.get_configuration: self._wrap_method(
            ...
            self.create_configuration: self._wrap_method(
                self.create_configuration,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_configuration: self._wrap_method(
                self.update_configuration,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_configuration: self._wrap_method(
            ...
            self.deactivate_configuration: self._wrap_method(
                self.deactivate_configuration,
                default_timeout=None,
                client_info=client_info,
            ),
            self.reactivate_configuration: self._wrap_method(
                self.reactivate_configuration,
                default_timeout=None,
                client_info=client_info,
            ),
            self.query_configuration_license_usage: self._wrap_method(
            ...
            self.aggregate_usage: self._wrap_method(

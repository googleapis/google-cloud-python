...
class LicenseManagerAsyncClient:
    ...
    async def deactivate_configuration(self,
    ...
    async def reactivate_configuration(self,
    ...
    async def query_configuration_license_usage(self,
    ...
    async def aggregate_usage(self,

...
from .base import LicenseManagerTransport, DEFAULT_CLIENT_INFO
...
class LicenseManagerGrpcTransport(LicenseManagerTransport):
    ...
    @property
    def list_configurations(self) -> Callable[
    ...
    @property
    def get_configuration(self) -> Callable[
    ...
    @property
    def create_configuration(self) -> Callable[
    ...
    @property
    def update_configuration(self) -> Callable[
    ...
    @property
    def delete_configuration(self) -> Callable[
    ...
    @property
    def deactivate_configuration(self) -> Callable[
    ...
    @property
    def reactivate_configuration(self) -> Callable[
    ...
    @property
    def query_configuration_license_usage(self) -> Callable[
    ...
    @property
    def aggregate_usage(self) -> Callable[

...
from google.cloud.managedkafka_v1.services.managed_kafka_connect import ManagedKafkaConnectAsyncClient
...
from google.cloud.managedkafka_v1.services.managed_kafka_connect import transports
...
def test__get_api_endpoint():
    ...
    assert ManagedKafkaConnectClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ManagedKafkaConnectClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert ManagedKafkaConnectClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ManagedKafkaConnectClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    ManagedKafkaConnectClient, ManagedKafkaConnectAsyncClient
])
...
def test_managed_kafka_connect_client_client_options_from_dict():
    with mock.patch('google.cloud.managedkafka_v1.services.managed_kafka_connect.transports.ManagedKafkaConnectGrpcTransport.__init__') as grpc_transport:
...
def test_list_connect_clusters_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, resources.ConnectCluster)
                   for i in results)
...
async def test_list_connect_clusters_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_connect_clusters(request={},)
...
def test_get_connect_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_connect_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_connect_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_connect_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_connect_cluster_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_connect_cluster(
            parent='parent_value',
            connect_cluster=resources.ConnectCluster(gcp_config=resources.ConnectGcpConfig(access_config=resources.ConnectAccessConfig(network_configs=[resources.ConnectNetworkConfig(primary_subnet='primary_subnet_value')]))),
            connect_cluster_id='connect_cluster_id_value',
        )
        ...
        mock_val = resources.ConnectCluster(gcp_config=resources.ConnectGcpConfig(access_config=resources.ConnectAccessConfig(network_configs=[resources.ConnectNetworkConfig(primary_subnet='primary_subnet_value')])))
        assert arg == mock_val
...
def test_update_connect_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_connect_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_connect_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_connect_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_connectors(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_connectors),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_connectors_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Connector)
                   for i in results)
...
def test_get_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.Connector(
            name='name_value',
...
def test_update_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.Connector(
            name='name_value',
...
def test_delete_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_pause_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.pause_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_resume_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resume_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_restart_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.restart_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_stop_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.stop_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_connect_clusters_rest_required_fields(request_type=managed_kafka_connect.ListConnectClustersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_connect_clusters._get_unset_required_fields(jsonified_request)
...
def test_get_connect_cluster_rest_required_fields(request_type=managed_kafka_connect.GetConnectClusterRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_connect_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_connect_cluster_rest_required_fields(request_type=managed_kafka_connect.CreateConnectClusterRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_connect_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_connect_cluster._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("connect_cluster_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_connect_cluster_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("connectClusterId", "requestId", )) & set(("parent", "connectClusterId", "connectCluster", )))
...
def test_update_connect_cluster_rest_required_fields(request_type=managed_kafka_connect.UpdateConnectClusterRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_connect_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_connect_cluster_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("updateMask", "connectCluster", )))
...
def test_delete_connect_cluster_rest_required_fields(request_type=managed_kafka_connect.DeleteConnectClusterRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_connect_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_connector_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("updateMask", "connector", )))
...
def test_update_connector_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{connector.name=projects/*/locations/*/connectClusters/*/connectors/*}" % client.transport._host, args[1])
...
def test_list_connect_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_list_connect_clusters") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_list_connect_clusters_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_list_connect_clusters") as pre:
        ...
        client.list_connect_clusters(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_connect_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_get_connect_cluster") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_get_connect_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_get_connect_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_connect_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_connect_cluster_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["connect_cluster"] = {'gcp_config': {'access_config': {'network_configs': [{'primary_subnet': 'primary_subnet_value', 'additional_subnets': ['additional_subnets_value1', 'additional_subnets_value2'], 'dns_domain_names': ['dns_domain_names_value1', 'dns_domain_names_value2']}]}, 'secret_paths': ['secret_paths_value1', 'secret_paths_value2']}, 'name': 'name_value', 'kafka_cluster': 'kafka_cluster_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'capacity_config': {'vcpu_count': 1094, 'memory_bytes': 1311}, 'state': 1, 'config': {}}
...
def test_create_connect_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_create_connect_cluster") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_create_connect_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_create_connect_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_connect_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_connect_cluster_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'connect_cluster': {'name': 'projects/sample1/locations/sample2/connectClusters/sample3'}}
    request_init["connect_cluster"] = {'gcp_config': {'access_config': {'network_configs': [{'primary_subnet': 'primary_subnet_value', 'additional_subnets': ['additional_subnets_value1', 'additional_subnets_value2'], 'dns_domain_names': ['dns_domain_names_value1', 'dns_domain_names_value2']}]}, 'secret_paths': ['secret_paths_value1', 'secret_paths_value2']}, 'name': 'projects/sample1/locations/sample2/connectClusters/sample3', 'kafka_cluster': 'kafka_cluster_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'capacity_config': {'vcpu_count': 1094, 'memory_bytes': 1311}, 'state': 1, 'config': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_connect_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_update_connect_cluster") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_update_connect_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_update_connect_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_connect_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_connect_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_delete_connect_cluster") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_delete_connect_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_delete_connect_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_connect_cluster(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_connectors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_list_connectors") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_list_connectors_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_list_connectors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_get_connector") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_get_connector_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_get_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_connector_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/connectClusters/sample3'}
    request_init["connector"] = {'task_restart_policy': {'minimum_backoff': {'seconds': 751, 'nanos': 543}, 'maximum_backoff': {}}, 'name': 'name_value', 'configs': {}, 'state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_create_connector") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_create_connector_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_create_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_connector_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'connector': {'name': 'projects/sample1/locations/sample2/connectClusters/sample3/connectors/sample4'}}
    request_init["connector"] = {'task_restart_policy': {'minimum_backoff': {'seconds': 751, 'nanos': 543}, 'maximum_backoff': {}}, 'name': 'projects/sample1/locations/sample2/connectClusters/sample3/connectors/sample4', 'configs': {}, 'state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_update_connector") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_update_connector_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_update_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_connector(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_delete_connector") as pre:
        pre.assert_not_called()
...
def test_pause_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_pause_connector") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_pause_connector_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_pause_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.pause_connector(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_resume_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_resume_connector") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_resume_connector_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_resume_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.resume_connector(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_restart_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_restart_connector") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_restart_connector_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_restart_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.restart_connector(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_stop_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_stop_connector") as post, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "post_stop_connector_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaConnectRestInterceptor, "pre_stop_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.stop_connector(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_managed_kafka_connect_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.managedkafka_v1.services.managed_kafka_connect.transports.ManagedKafkaConnectTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_managed_kafka_connect_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.managedkafka_v1.services.managed_kafka_connect.transports.ManagedKafkaConnectTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ManagedKafkaConnectTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ManagedKafkaConnectGrpcTransport, transports.ManagedKafkaConnectGrpcAsyncIOTransport])
def test_managed_kafka_connect_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_connect_cluster_path():
    ...
    expected = "projects/{project}/locations/{location}/connectClusters/{connect_cluster}".format(project=project, location=location, connect_cluster=connect_cluster, )
...
def test_connector_path():
    ...
    connector = "nautilus"
    expected = "projects/{project}/locations/{location}/connectClusters/{connect_cluster}/connectors/{connector}".format(project=project, location=location, connect_cluster=connect_cluster, connector=connector, )

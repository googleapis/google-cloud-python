    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_topics] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_topic] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.create_topic] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_topic] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_topic] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_consumer_groups] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_consumer_group] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_consumer_group] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_consumer_group] = mock_object
...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = managed_kafka.ListClustersResponse.to_json(managed_kafka.ListClustersResponse())
...
def test_list_clusters_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.ListClustersRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_cluster_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.GetClusterRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_cluster_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["cluster"] = {'gcp_config': {'access_config': {'network_configs': [{'subnet': 'subnet_value'}]}, 'kms_key': 'kms_key_value'}, 'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'capacity_config': {'vcpu_count': 1094, 'memory_bytes': 1311}, 'rebalance_config': {'mode': 1}, 'state': 1}
...
def test_create_cluster_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.CreateClusterRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_cluster_rest(request_type):
    ...
    request_init["cluster"] = {'gcp_config': {'access_config': {'network_configs': [{'subnet': 'subnet_value'}]}, 'kms_key': 'kms_key_value'}, 'name': 'projects/sample1/locations/sample2/clusters/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'capacity_config': {'vcpu_count': 1094, 'memory_bytes': 1311}, 'rebalance_config': {'mode': 1}, 'state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_cluster_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.UpdateClusterRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_cluster_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.DeleteClusterRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_topics_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = managed_kafka.ListTopicsResponse.to_json(managed_kafka.ListTopicsResponse())
...
def test_list_topics_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.ListTopicsRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_topic_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.GetTopicRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_topic_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.CreateTopicRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_topic_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.UpdateTopicRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_topic_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.DeleteTopicRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_consumer_groups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = managed_kafka.ListConsumerGroupsResponse.to_json(managed_kafka.ListConsumerGroupsResponse())
...
def test_list_consumer_groups_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.ListConsumerGroupsRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_consumer_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = resources.ConsumerGroup.to_json(resources.ConsumerGroup())
...
def test_get_consumer_group_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.GetConsumerGroupRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_consumer_group_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.UpdateConsumerGroupRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_consumer_group_rest_bad_request(transport: str = 'rest', request_type=managed_kafka.DeleteConsumerGroupRequest):
    client = ManagedKafkaClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

...
from google.cloud.managedkafka_v1.services.managed_kafka import ManagedKafkaAsyncClient
from google.cloud.managedkafka_v1.services.managed_kafka import ManagedKafkaClient
from google.cloud.managedkafka_v1.services.managed_kafka import pagers
from google.cloud.managedkafka_v1.services.managed_kafka import transports
...
@pytest.mark.parametrize("client_class", [
    ManagedKafkaClient, ManagedKafkaAsyncClient
])
...
def test_create_cluster_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_cluster(
            parent='parent_value',
            cluster=resources.Cluster(gcp_config=resources.GcpConfig(access_config=resources.AccessConfig(network_configs=[resources.NetworkConfig(subnet='subnet_value')]))),
            cluster_id='cluster_id_value',
        )
        ...
        assert arg == mock_val
        arg = args[0].cluster
        mock_val = resources.Cluster(gcp_config=resources.GcpConfig(access_config=resources.AccessConfig(network_configs=[resources.NetworkConfig(subnet='subnet_value')])))
        assert arg == mock_val
...
def test_list_topics_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Topic)
                   for i in results)
...
def test_list_consumer_groups_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.ConsumerGroup)
                   for i in results)
...
async def test_list_consumer_groups_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_consumer_groups(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_consumer_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_consumer_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_consumer_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_consumer_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.ConsumerGroup(
            name='name_value',
...
def test_delete_consumer_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_consumer_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_list_acls(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_acls),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_acls_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Acl)
                   for i in results)
...
async def test_list_acls_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_acls(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_create_acl(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_acl),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.Acl(
            name='name_value',
...
def test_update_acl(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_acl),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.Acl(
            name='name_value',
...
def test_delete_acl(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_acl),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_add_acl_entry(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.add_acl_entry),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_remove_acl_entry(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_acl_entry),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_topic_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("topicId", )) & set(("parent", "topicId", "topic", )))
...
def test_update_topic_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("updateMask", "topic", )))
...
def test_list_consumer_groups_rest_required_fields(request_type=managed_kafka.ListConsumerGroupsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_consumer_groups._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_consumer_group_rest_required_fields(request_type=managed_kafka.UpdateConsumerGroupRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_consumer_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_consumer_group_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("updateMask", "consumerGroup", )))
...
def test_update_consumer_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{consumer_group.name=projects/*/locations/*/clusters/*/consumerGroups/**}" % client.transport._host, args[1])
...
def test_delete_consumer_group_rest_required_fields(request_type=managed_kafka.DeleteConsumerGroupRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_consumer_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_acl_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("aclId", )) & set(("parent", "aclId", "acl", )))
...
def test_add_acl_entry_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("acl", "aclEntry", )))
...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_clusters") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_clusters_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_list_clusters") as pre:
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_cluster") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_get_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_cluster_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["cluster"] = {'gcp_config': {'access_config': {'network_configs': [{'subnet': 'subnet_value'}]}, 'kms_key': 'kms_key_value'}, 'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'capacity_config': {'vcpu_count': 1094, 'memory_bytes': 1311}, 'rebalance_config': {'mode': 1}, 'state': 1, 'satisfies_pzi': True, 'satisfies_pzs': True}
...
def test_create_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_create_cluster") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_create_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_create_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_cluster_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'cluster': {'name': 'projects/sample1/locations/sample2/clusters/sample3'}}
    request_init["cluster"] = {'gcp_config': {'access_config': {'network_configs': [{'subnet': 'subnet_value'}]}, 'kms_key': 'kms_key_value'}, 'name': 'projects/sample1/locations/sample2/clusters/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'capacity_config': {'vcpu_count': 1094, 'memory_bytes': 1311}, 'rebalance_config': {'mode': 1}, 'state': 1, 'satisfies_pzi': True, 'satisfies_pzs': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_update_cluster") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_update_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_update_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_delete_cluster") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_delete_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_delete_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_topics_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_topics") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_topics_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_list_topics") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_topics(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_topic") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_topic_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_get_topic") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_topic(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_create_topic") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_create_topic_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_create_topic") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_topic(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_topic_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'topic': {'name': 'projects/sample1/locations/sample2/clusters/sample3/topics/sample4'}}
    request_init["topic"] = {'name': 'projects/sample1/locations/sample2/clusters/sample3/topics/sample4', 'partition_count': 1634, 'replication_factor': 1912, 'configs': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_update_topic") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_update_topic_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_update_topic") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_topic(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_delete_topic") as pre:
        pre.assert_not_called()
        ...
        client.delete_topic(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_consumer_groups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_consumer_groups") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_consumer_groups_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_list_consumer_groups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_consumer_groups(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_consumer_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_consumer_group") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_consumer_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_get_consumer_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_consumer_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_consumer_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_update_consumer_group") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_update_consumer_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_update_consumer_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_consumer_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_consumer_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_delete_consumer_group") as pre:
        pre.assert_not_called()
        ...
        client.delete_consumer_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_acls_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_acls") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_acls_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_list_acls") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_acls(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_acl") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_acl_with_metadata") as post_with_metadata, \
        ...
        client.get_acl(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_acl_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/clusters/sample3'}
    request_init["acl"] = {'name': 'name_value', 'acl_entries': [{'principal': 'principal_value', 'permission_type': 'permission_type_value', 'operation': 'operation_value', 'host': 'host_value'}], 'etag': 'etag_value', 'resource_type': 'resource_type_value', 'resource_name': 'resource_name_value', 'pattern_type': 'pattern_type_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_create_acl") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_create_acl_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_create_acl") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_acl(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_acl_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'acl': {'name': 'projects/sample1/locations/sample2/clusters/sample3/acls/sample4'}}
    request_init["acl"] = {'name': 'projects/sample1/locations/sample2/clusters/sample3/acls/sample4', 'acl_entries': [{'principal': 'principal_value', 'permission_type': 'permission_type_value', 'operation': 'operation_value', 'host': 'host_value'}], 'etag': 'etag_value', 'resource_type': 'resource_type_value', 'resource_name': 'resource_name_value', 'pattern_type': 'pattern_type_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_update_acl") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_update_acl_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_update_acl") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_acl(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_delete_acl") as pre:
        pre.assert_not_called()
        ...
        client.delete_acl(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_add_acl_entry_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'acl': 'projects/sample1/locations/sample2/clusters/sample3/acls/sample4'}
    request_init["acl_entry"] = {'principal': 'principal_value', 'permission_type': 'permission_type_value', 'operation': 'operation_value', 'host': 'host_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_add_acl_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_add_acl_entry") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_add_acl_entry_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_add_acl_entry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.add_acl_entry(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_remove_acl_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_remove_acl_entry") as post, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_remove_acl_entry_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_remove_acl_entry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.remove_acl_entry(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_managed_kafka_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.managedkafka_v1.services.managed_kafka.transports.ManagedKafkaTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_managed_kafka_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.managedkafka_v1.services.managed_kafka.transports.ManagedKafkaTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ManagedKafkaTransport()
        adc.assert_called_once()
...
def test_managed_kafka_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.ManagedKafkaGrpcTransport, transports.ManagedKafkaGrpcAsyncIOTransport])
def test_managed_kafka_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ManagedKafkaGrpcTransport, transports.ManagedKafkaGrpcAsyncIOTransport])
def test_managed_kafka_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_acl_path():
    ...
    cluster = "whelk"
    acl = "octopus"
    expected = "projects/{project}/locations/{location}/clusters/{cluster}/acls/{acl}".format(project=project, location=location, cluster=cluster, acl=acl, )
...
def test_consumer_group_path():
    ...
    expected = "projects/{project}/locations/{location}/clusters/{cluster}/consumerGroups/{consumer_group}".format(project=project, location=location, cluster=cluster, consumer_group=consumer_group, )
...
def test_topic_path():
    ...
    cluster = "winkle"
    topic = "nautilus"
    expected = "projects/{project}/locations/{location}/clusters/{cluster}/topics/{topic}".format(project=project, location=location, cluster=cluster, topic=topic, )

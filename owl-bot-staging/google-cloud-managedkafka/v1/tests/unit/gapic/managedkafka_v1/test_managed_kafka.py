...
def test_create_cluster_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["cluster"] = {'gcp_config': {'access_config': {'network_configs': [{'subnet': 'subnet_value'}]}, 'kms_key': 'kms_key_value'}, 'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'capacity_config': {'vcpu_count': 1094, 'memory_bytes': 1311}, 'rebalance_config': {'mode': 1}, 'state': 1, 'satisfies_pzi': True, 'satisfies_pzs': True, 'tls_config': {'trust_config': {'cas_configs': [{'ca_pool': 'ca_pool_value'}]}, 'ssl_principal_mapping_rules': 'ssl_principal_mapping_rules_value'}}

...
class ListConnectClustersAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[managed_kafka_connect.ListConnectClustersResponse]],
            request: managed_kafka_connect.ListConnectClustersRequest,
            response: managed_kafka_connect.ListConnectClustersResponse,
            *,
    ...
    @property
    async def pages(self) -> AsyncIterator[managed_kafka_connect.ListConnectClustersResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
...
class ListConnectorsAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[managed_kafka_connect.ListConnectorsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)

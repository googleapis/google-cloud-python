...
class ManagedKafkaConnectClient(metaclass=ManagedKafkaConnectClientMeta):
    ...
    @staticmethod
    def connect_cluster_path(project: str,location: str,connect_cluster: str,) -> str:
        """Returns a fully-qualified connect_cluster string."""
        return "projects/{project}/locations/{location}/connectClusters/{connect_cluster}".format(project=project, location=location, connect_cluster=connect_cluster, )
    ...
    @staticmethod
    def connector_path(project: str,location: str,connect_cluster: str,connector: str,) -> str:
        """Returns a fully-qualified connector string."""
        return "projects/{project}/locations/{location}/connectClusters/{connect_cluster}/connectors/{connector}".format(project=project, location=location, connect_cluster=connect_cluster, connector=connector, )

    @staticmethod
    def parse_connector_path(path: str) -> Dict[str,str]:
        """Parses a connector path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/connectClusters/(?P<connect_cluster>.+?)/connectors/(?P<connector>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def list_connect_clusters(self,
    ...
    def create_connect_cluster(self,
    ...
    def update_connect_cluster(self,
    ...
    def delete_connect_cluster(self,

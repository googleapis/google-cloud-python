...
from .transports.base import ManagedKafkaTransport, DEFAULT_CLIENT_INFO
...
class ManagedKafkaClient(metaclass=ManagedKafkaClientMeta):
    ...
    @staticmethod
    def acl_path(project: str,location: str,cluster: str,acl: str,) -> str:
        """Returns a fully-qualified acl string."""
        return "projects/{project}/locations/{location}/clusters/{cluster}/acls/{acl}".format(project=project, location=location, cluster=cluster, acl=acl, )
    ...
    @staticmethod
    def consumer_group_path(project: str,location: str,cluster: str,consumer_group: str,) -> str:
        """Returns a fully-qualified consumer_group string."""
        return "projects/{project}/locations/{location}/clusters/{cluster}/consumerGroups/{consumer_group}".format(project=project, location=location, cluster=cluster, consumer_group=consumer_group, )

    @staticmethod
    def parse_consumer_group_path(path: str) -> Dict[str,str]:
        """Parses a consumer_group path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/consumerGroups/(?P<consumer_group>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def topic_path(project: str,location: str,cluster: str,topic: str,) -> str:
        """Returns a fully-qualified topic string."""
        return "projects/{project}/locations/{location}/clusters/{cluster}/topics/{topic}".format(project=project, location=location, cluster=cluster, topic=topic, )
    ...
    def update_consumer_group(self,

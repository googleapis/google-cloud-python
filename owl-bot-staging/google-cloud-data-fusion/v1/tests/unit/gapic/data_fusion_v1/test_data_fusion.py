...
def test_list_available_versions_rest_required_fields(request_type=datafusion.ListAvailableVersionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_available_versions._get_unset_required_fields(jsonified_request)
...
def test_list_available_versions_rest_unset_required_fields():
    transport = transports.DataFusionRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_instance_rest_required_fields(request_type=datafusion.UpdateInstanceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_restart_instance_rest_required_fields(request_type=datafusion.RestartInstanceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).restart_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

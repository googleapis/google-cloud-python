...
@pytest.mark.asyncio
async def test_list_available_versions_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
async def test_list_available_versions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.list_available_versions] = mock_object
...
async def test_restart_instance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.restart_instance] = mock_object
...
def test_list_available_versions_rest(request_type):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_available_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = datafusion.ListAvailableVersionsResponse.to_json(datafusion.ListAvailableVersionsResponse())
...
def test_list_available_versions_rest_bad_request(transport: str = 'rest', request_type=datafusion.ListAvailableVersionsRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = datafusion.ListInstancesResponse.to_json(datafusion.ListInstancesResponse())
...
def test_list_instances_rest_bad_request(transport: str = 'rest', request_type=datafusion.ListInstancesRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = datafusion.Instance.to_json(datafusion.Instance())
...
def test_get_instance_rest_bad_request(transport: str = 'rest', request_type=datafusion.GetInstanceRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_instance_rest_bad_request(transport: str = 'rest', request_type=datafusion.CreateInstanceRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_instance_rest_bad_request(transport: str = 'rest', request_type=datafusion.DeleteInstanceRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_instance_rest_bad_request(transport: str = 'rest', request_type=datafusion.UpdateInstanceRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_restart_instance_rest_bad_request(transport: str = 'rest', request_type=datafusion.RestartInstanceRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = DataFusionClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )

...
@pytest.mark.parametrize("client_class", [
    DataFusionClient, DataFusionAsyncClient
])
...
def test_list_available_versions_rest_required_fields(request_type=datafusion.ListAvailableVersionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_available_versions._get_unset_required_fields(jsonified_request)
    ...
    assert not set(unset_fields) - set(("latest_patch_only", "page_size", "page_token", ))
    jsonified_request.update(unset_fields)
...
def test_list_available_versions_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("latestPatchOnly", "pageSize", "pageToken", )) & set(("parent", )))
...
def test_create_instance_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("instanceId", )) & set(("parent", "instanceId", )))
...
def test_transport_kind_grpc_asyncio():
    transport = DataFusionAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = DataFusionClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_available_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataFusionRestInterceptor, "post_list_available_versions") as post, \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_list_available_versions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataFusionRestInterceptor, "pre_list_available_versions") as pre:
        ...
        client.list_available_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_list_instances") as post, \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_list_instances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataFusionRestInterceptor, "pre_list_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_get_instance") as post, \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_get_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataFusionRestInterceptor, "pre_get_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_instance_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["instance"] = {'name': 'name_value', 'description': 'description_value', 'type_': 1, 'enable_stackdriver_logging': True, 'enable_stackdriver_monitoring': True, 'private_instance': True, 'network_config': {'network': 'network_value', 'ip_allocation': 'ip_allocation_value'}, 'labels': {}, 'options': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'state': 1, 'state_message': 'state_message_value', 'service_endpoint': 'service_endpoint_value', 'zone': 'zone_value', 'version': 'version_value', 'service_account': 'service_account_value', 'display_name': 'display_name_value', 'available_version': [{'version_number': 'version_number_value', 'default_version': True, 'available_features': ['available_features_value1', 'available_features_value2'], 'type_': 1}], 'api_endpoint': 'api_endpoint_value', 'gcs_bucket': 'gcs_bucket_value', 'accelerators': [{'accelerator_type': 1, 'state': 1}], 'p4_service_account': 'p4_service_account_value', 'tenant_project_id': 'tenant_project_id_value', 'dataproc_service_account': 'dataproc_service_account_value', 'enable_rbac': True, 'crypto_key_config': {'key_reference': 'key_reference_value'}, 'disabled_reason': [1]}
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DataFusionRestInterceptor, "post_create_instance") as post, \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_create_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataFusionRestInterceptor, "pre_create_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_delete_instance") as post, \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_delete_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataFusionRestInterceptor, "pre_delete_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_update_instance") as post, \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_update_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataFusionRestInterceptor, "pre_update_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_restart_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_restart_instance") as post, \
        mock.patch.object(transports.DataFusionRestInterceptor, "post_restart_instance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataFusionRestInterceptor, "pre_restart_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_data_fusion_host_no_port(transport_name):
    ...
    assert client.transport._host == (
        'datafusion.googleapis.com:443'
        if transport_name in ['grpc', 'grpc_asyncio']
        else 'https://datafusion.googleapis.com'
    )
...
def test_data_fusion_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        'datafusion.googleapis.com:8000'
        if transport_name in ['grpc', 'grpc_asyncio']
        else 'https://datafusion.googleapis.com:8000'
    )

...
class DataFusionClient(metaclass=DataFusionClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "datafusion.{UNIVERSE_DOMAIN}"
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DataFusionClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DataFusionClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = DataFusionClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            DataFusionClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DataFusionTransport, Callable[..., DataFusionTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DataFusionClient._read_environment_variables()
        self._client_cert_source = DataFusionClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DataFusionClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DataFusionTransport)
        if transport_provided:
            ...
            self._transport = cast(DataFusionTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DataFusionTransport], Callable[..., DataFusionTransport]] = (
    ...
    def list_available_versions(self,
        ...
        Returns:
            google.cloud.data_fusion_v1.services.data_fusion.pagers.ListAvailableVersionsPager:
    ...
    def list_instances(self,
        ...
        Returns:
            google.cloud.data_fusion_v1.services.data_fusion.pagers.ListInstancesPager:
                Response message for the list
                instance request.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    def __enter__(self) -> "DataFusionClient":
        return self

...
class BatchServiceTransport(abc.ABC):
    ...
    def list_jobs(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[batch.ListJobsResponse]
            ]]:
        raise NotImplementedError()
    ...
    def list_tasks(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[batch.ListTasksResponse]
            ]]:
        raise NotImplementedError()

    @property
    def create_resource_allowance(self) -> Callable[
    ...
    @property
    def get_resource_allowance(self) -> Callable[
    ...
    @property
    def delete_resource_allowance(self) -> Callable[
    ...
    @property
    def list_resource_allowances(self) -> Callable[
    ...
    @property
    def update_resource_allowance(self) -> Callable[

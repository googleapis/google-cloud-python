...
class BatchServiceAsyncClient:
    ...
    parse_resource_allowance_path = staticmethod(BatchServiceClient.parse_resource_allowance_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BatchServiceTransport, Callable[..., BatchServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_resource_allowance(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_resource_allowance]
    ...
    async def get_resource_allowance(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_resource_allowance]
    ...
    async def delete_resource_allowance(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_resource_allowance]
    ...
    async def list_resource_allowances(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_resource_allowances]
    ...
    async def update_resource_allowance(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_resource_allowance]

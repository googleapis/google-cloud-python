...
class BatchServiceClient(metaclass=BatchServiceClientMeta):
    ...
    @staticmethod
    def resource_allowance_path(project: str,location: str,resource_allowance: str,) -> str:
        """Returns a fully-qualified resource_allowance string."""
        return "projects/{project}/locations/{location}/resourceAllowances/{resource_allowance}".format(project=project, location=location, resource_allowance=resource_allowance, )

    @staticmethod
    def parse_resource_allowance_path(path: str) -> Dict[str,str]:
        """Parses a resource_allowance path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/resourceAllowances/(?P<resource_allowance>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def task_path(project: str,location: str,job: str,task_group: str,task: str,) -> str:
        """Returns a fully-qualified task string."""
        return "projects/{project}/locations/{location}/jobs/{job}/taskGroups/{task_group}/tasks/{task}".format(project=project, location=location, job=job, task_group=task_group, task=task, )

    @staticmethod
    def parse_task_path(path: str) -> Dict[str,str]:
        """Parses a task path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/jobs/(?P<job>.+?)/taskGroups/(?P<task_group>.+?)/tasks/(?P<task>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def task_group_path(project: str,location: str,job: str,task_group: str,) -> str:
        """Returns a fully-qualified task_group string."""
        return "projects/{project}/locations/{location}/jobs/{job}/taskGroups/{task_group}".format(project=project, location=location, job=job, task_group=task_group, )

    @staticmethod
    def parse_task_group_path(path: str) -> Dict[str,str]:
        """Parses a task_group path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/jobs/(?P<job>.+?)/taskGroups/(?P<task_group>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = BatchServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BatchServiceTransport, Callable[..., BatchServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = BatchServiceClient._read_environment_variables()
        self._client_cert_source = BatchServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = BatchServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            BatchServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BatchServiceTransport], Callable[..., BatchServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.batch_v1alpha.BatchServiceClient`.",
                    extra = {
    ...
    def update_job(self,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                ...
                The ``jobs.patch`` method can only be used while a job
                is in the ``QUEUED``, ``SCHEDULED``, or ``RUNNING``
                state and currently only supports increasing the value
                of the first ``taskCount`` field in the job's
                ``taskGroups`` field. Therefore, you must set the value
                of ``updateMask`` to ``taskGroups``. Any other job
                fields in the update request will be ignored.

                For example, to update a job's ``taskCount`` to ``2``,
                set ``updateMask`` to ``taskGroups`` and use the
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [job, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def create_resource_allowance(self,
            request: Optional[Union[batch.CreateResourceAllowanceRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            resource_allowance: Optional[gcb_resource_allowance.ResourceAllowance] = None,
            resource_allowance_id: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.cloud.batch_v1alpha.types.CreateResourceAllowanceRequest, dict]):
                The request object. CreateResourceAllowance Request.
            parent (str):
                Required. The parent resource name
                where the ResourceAllowance will be
                created. Pattern:
                "projects/{project}/locations/{location}"
            ...
            resource_allowance (google.cloud.batch_v1alpha.types.ResourceAllowance):
                Required. The ResourceAllowance to
                create.

                This corresponds to the ``resource_allowance`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, resource_allowance, resource_allowance_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, batch.CreateResourceAllowanceRequest):
            ...
            if parent is not None:
                request.parent = parent
            if resource_allowance is not None:
                request.resource_allowance = resource_allowance
            if resource_allowance_id is not None:
                request.resource_allowance_id = resource_allowance_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_resource_allowance]
    ...
    def get_resource_allowance(self,
            request: Optional[Union[batch.GetResourceAllowanceRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Get a ResourceAllowance specified by its resource
        name.
        ...
        Args:
            request (Union[google.cloud.batch_v1alpha.types.GetResourceAllowanceRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_resource_allowance]
    ...
    def delete_resource_allowance(self,
            request: Optional[Union[batch.DeleteResourceAllowanceRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.batch_v1alpha.types.DeleteResourceAllowanceRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_resource_allowance]
    ...
    def list_resource_allowances(self,
            request: Optional[Union[batch.ListResourceAllowancesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListResourceAllowancesPager:
        r"""List all ResourceAllowances for a project within a
        region.
        ...
        Args:
            request (Union[google.cloud.batch_v1alpha.types.ListResourceAllowancesRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_resource_allowances]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListResourceAllowancesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def update_resource_allowance(self,
            request: Optional[Union[batch.UpdateResourceAllowanceRequest, dict]] = None,
            *,
            resource_allowance: Optional[gcb_resource_allowance.ResourceAllowance] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.batch_v1alpha.types.UpdateResourceAllowanceRequest, dict]):
                The request object. UpdateResourceAllowance Request.
            resource_allowance (google.cloud.batch_v1alpha.types.ResourceAllowance):
                Required. The ResourceAllowance to update. Update
                description. Only fields specified in ``update_mask``
                are updated.
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                ...
                overwritten in the ResourceAllowance resource by the
                ...
                UpdateResourceAllowance request now only supports update
                on ``limit`` field.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [resource_allowance, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_resource_allowance]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("resource_allowance.name", request.resource_allowance.name),
            )),
        )

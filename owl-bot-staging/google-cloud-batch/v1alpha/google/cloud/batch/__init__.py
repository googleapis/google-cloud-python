...
from google.cloud.batch_v1alpha.types.batch import CancelJobRequest
from google.cloud.batch_v1alpha.types.batch import CancelJobResponse
...
from google.cloud.batch_v1alpha.types.batch import UpdateJobRequest

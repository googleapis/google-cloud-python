...
from google.cloud.batch_v1alpha.services.batch_service import BatchServiceAsyncClient
...
from google.cloud.batch_v1alpha.services.batch_service import transports
...
def test__read_environment_variables():
    assert BatchServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert BatchServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert BatchServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert BatchServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert BatchServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert BatchServiceClient._get_client_cert_source(None, False) is None
    assert BatchServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert BatchServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert BatchServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert BatchServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(BatchServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BatchServiceClient))
@mock.patch.object(BatchServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BatchServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BatchServiceClient._DEFAULT_UNIVERSE
    default_endpoint = BatchServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = BatchServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert BatchServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert BatchServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BatchServiceClient.DEFAULT_MTLS_ENDPOINT
    assert BatchServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert BatchServiceClient._get_api_endpoint(None, None, default_universe, "always") == BatchServiceClient.DEFAULT_MTLS_ENDPOINT
    assert BatchServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BatchServiceClient.DEFAULT_MTLS_ENDPOINT
    assert BatchServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert BatchServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        BatchServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert BatchServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert BatchServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert BatchServiceClient._get_universe_domain(None, None) == BatchServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (BatchServiceAsyncClient, transports.BatchServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (BatchServiceAsyncClient, transports.BatchServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (BatchServiceClient, transports.BatchServiceGrpcTransport, "grpc", "false"),
    (BatchServiceAsyncClient, transports.BatchServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
@pytest.mark.parametrize("client_class", [
    BatchServiceClient, BatchServiceAsyncClient
])
...
@mock.patch.object(BatchServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BatchServiceClient))
@mock.patch.object(BatchServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BatchServiceAsyncClient))
def test_batch_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (BatchServiceClient, transports.BatchServiceGrpcTransport, "grpc", grpc_helpers),
    (BatchServiceAsyncClient, transports.BatchServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_batch_service_client_client_options_from_dict():
    with mock.patch('google.cloud.batch_v1alpha.services.batch_service.transports.BatchServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_job(request_type, transport: str = 'grpc'):
    ...
    assert response.scheduling_policy == gcb_job.Job.SchedulingPolicy.AS_SOON_AS_POSSIBLE
...
def test_cancel_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.cancel_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_cancel_job_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == batch.CancelJobRequest(
            name='name_value',
        )
...
async def test_cancel_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.cancel_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.cancel_job] = mock_rpc
...
@pytest.mark.asyncio
async def test_cancel_job_async(transport: str = 'grpc_asyncio', request_type=batch.CancelJobRequest):
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_job_async(transport: str = 'grpc_asyncio', request_type=batch.UpdateJobRequest):
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_resource_allowance(request_type, transport: str = 'grpc'):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_resource_allowance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gcb_resource_allowance.ResourceAllowance(
            name='name_value',
            uid='uid_value',
        )
        response = client.create_resource_allowance(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, gcb_resource_allowance.ResourceAllowance)
    assert response.name == 'name_value'
    assert response.uid == 'uid_value'


def test_create_resource_allowance_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    request = batch.CreateResourceAllowanceRequest(
        parent='parent_value',
        resource_allowance_id='resource_allowance_id_value',
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.create_resource_allowance(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == batch.CreateResourceAllowanceRequest(
            parent='parent_value',
            resource_allowance_id='resource_allowance_id_value',
        )

def test_create_resource_allowance_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.create_resource_allowance in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_resource_allowance] = mock_rpc
        request = {}
        client.create_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_create_resource_allowance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BatchServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_resource_allowance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_resource_allowance] = mock_rpc

        request = {}
        await client.create_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_create_resource_allowance_async(transport: str = 'grpc_asyncio', request_type=batch.CreateResourceAllowanceRequest):
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gcb_resource_allowance.ResourceAllowance(
            name='name_value',
            uid='uid_value',
        ))
        response = await client.create_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_create_resource_allowance_async_from_dict():
    await test_create_resource_allowance_async(request_type=dict)
...
@pytest.mark.asyncio
async def test_create_resource_allowance_field_headers_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_resource_allowance_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_resource_allowance(
            parent='parent_value',
            resource_allowance=gcb_resource_allowance.ResourceAllowance(usage_resource_allowance=gcb_resource_allowance.UsageResourceAllowance(spec=gcb_resource_allowance.UsageResourceAllowanceSpec(type_='type__value'))),
            resource_allowance_id='resource_allowance_id_value',
        )
        ...
        mock_val = 'parent_value'
        assert arg == mock_val
        arg = args[0].resource_allowance
        mock_val = gcb_resource_allowance.ResourceAllowance(usage_resource_allowance=gcb_resource_allowance.UsageResourceAllowance(spec=gcb_resource_allowance.UsageResourceAllowanceSpec(type_='type__value')))
        assert arg == mock_val
        arg = args[0].resource_allowance_id
        mock_val = 'resource_allowance_id_value'
        assert arg == mock_val


def test_create_resource_allowance_flattened_error():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_resource_allowance_flattened_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.create_resource_allowance(
            parent='parent_value',
            resource_allowance=gcb_resource_allowance.ResourceAllowance(usage_resource_allowance=gcb_resource_allowance.UsageResourceAllowance(spec=gcb_resource_allowance.UsageResourceAllowanceSpec(type_='type__value'))),
            resource_allowance_id='resource_allowance_id_value',
        )
...
@pytest.mark.asyncio
async def test_create_resource_allowance_flattened_error_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_resource_allowance(
            batch.CreateResourceAllowanceRequest(),
            parent='parent_value',
            resource_allowance=gcb_resource_allowance.ResourceAllowance(usage_resource_allowance=gcb_resource_allowance.UsageResourceAllowance(spec=gcb_resource_allowance.UsageResourceAllowanceSpec(type_='type__value'))),
            resource_allowance_id='resource_allowance_id_value',
...
def test_get_resource_allowance(request_type, transport: str = 'grpc'):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_resource_allowance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resource_allowance.ResourceAllowance(
            name='name_value',
            uid='uid_value',
        )
        response = client.get_resource_allowance(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, resource_allowance.ResourceAllowance)
    assert response.name == 'name_value'
    assert response.uid == 'uid_value'


def test_get_resource_allowance_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.get_resource_allowance(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == batch.GetResourceAllowanceRequest(
            name='name_value',
        )

def test_get_resource_allowance_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_resource_allowance in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_resource_allowance] = mock_rpc
        request = {}
        client.get_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_get_resource_allowance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BatchServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_resource_allowance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_resource_allowance] = mock_rpc

        request = {}
        await client.get_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_get_resource_allowance_async(transport: str = 'grpc_asyncio', request_type=batch.GetResourceAllowanceRequest):
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resource_allowance.ResourceAllowance(
            name='name_value',
            uid='uid_value',
        ))
        response = await client.get_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_get_resource_allowance_async_from_dict():
    await test_get_resource_allowance_async(request_type=dict)

def test_get_resource_allowance_field_headers():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_resource_allowance_field_headers_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_resource_allowance_flattened():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_resource_allowance_flattened_error():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_resource_allowance_flattened_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_resource_allowance(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_get_resource_allowance_flattened_error_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_resource_allowance(
            batch.GetResourceAllowanceRequest(),
            name='name_value',
        )
...
def test_delete_resource_allowance(request_type, transport: str = 'grpc'):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_resource_allowance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
        response = client.delete_resource_allowance(request)
...
def test_delete_resource_allowance_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.delete_resource_allowance(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == batch.DeleteResourceAllowanceRequest(
            name='name_value',
            reason='reason_value',
        )

def test_delete_resource_allowance_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_resource_allowance in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_resource_allowance] = mock_rpc
        request = {}
        client.delete_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_delete_resource_allowance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BatchServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_resource_allowance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_resource_allowance] = mock_rpc

        request = {}
        await client.delete_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_delete_resource_allowance_async(transport: str = 'grpc_asyncio', request_type=batch.DeleteResourceAllowanceRequest):
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.delete_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_delete_resource_allowance_async_from_dict():
    await test_delete_resource_allowance_async(request_type=dict)

def test_delete_resource_allowance_field_headers():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_resource_allowance_field_headers_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_resource_allowance_flattened():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_resource_allowance_flattened_error():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_resource_allowance_flattened_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_resource_allowance(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_delete_resource_allowance_flattened_error_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_resource_allowance(
            batch.DeleteResourceAllowanceRequest(),
            name='name_value',
        )
...
def test_list_resource_allowances(request_type, transport: str = 'grpc'):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_resource_allowances),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListResourceAllowancesPager)
    assert response.next_page_token == 'next_page_token_value'
    assert response.unreachable == ['unreachable_value']


def test_list_resource_allowances_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.list_resource_allowances(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == batch.ListResourceAllowancesRequest(
            parent='parent_value',
            page_token='page_token_value',
        )

def test_list_resource_allowances_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_resource_allowances in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_resource_allowances] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_resource_allowances_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BatchServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_resource_allowances in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_resource_allowances] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_resource_allowances_async(transport: str = 'grpc_asyncio', request_type=batch.ListResourceAllowancesRequest):
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListResourceAllowancesAsyncPager)
    assert response.next_page_token == 'next_page_token_value'
    assert response.unreachable == ['unreachable_value']


@pytest.mark.asyncio
async def test_list_resource_allowances_async_from_dict():
    await test_list_resource_allowances_async(request_type=dict)

def test_list_resource_allowances_field_headers():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_resource_allowances_field_headers_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_resource_allowances_flattened():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_resource_allowances_flattened_error():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_resource_allowances_flattened_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_resource_allowances(
            parent='parent_value',
        )
...
@pytest.mark.asyncio
async def test_list_resource_allowances_flattened_error_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_resource_allowances(
            batch.ListResourceAllowancesRequest(),
            parent='parent_value',
        )


def test_list_resource_allowances_pager(transport_name: str = "grpc"):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pager = client.list_resource_allowances(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resource_allowance.ResourceAllowance)
                   for i in results)
def test_list_resource_allowances_pages(transport_name: str = "grpc"):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_resource_allowances(request={}).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token

@pytest.mark.asyncio
async def test_list_resource_allowances_async_pager():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_resource_allowances_async_pages():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_resource_allowance(request_type, transport: str = 'grpc'):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_resource_allowance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gcb_resource_allowance.ResourceAllowance(
            name='name_value',
        ...
        response = client.update_resource_allowance(request)
...
def test_update_resource_allowance_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.update_resource_allowance(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == batch.UpdateResourceAllowanceRequest(
        )

def test_update_resource_allowance_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.update_resource_allowance in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_resource_allowance] = mock_rpc
        request = {}
        client.update_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_update_resource_allowance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BatchServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_resource_allowance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_resource_allowance] = mock_rpc

        request = {}
        await client.update_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_update_resource_allowance_async(transport: str = 'grpc_asyncio', request_type=batch.UpdateResourceAllowanceRequest):
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.update_resource_allowance(request)
...
@pytest.mark.asyncio
async def test_update_resource_allowance_async_from_dict():
    await test_update_resource_allowance_async(request_type=dict)

def test_update_resource_allowance_field_headers():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    request.resource_allowance.name = 'name_value'
    ...
    assert (
        'x-goog-request-params',
        'resource_allowance.name=name_value',
    ) in kw['metadata']


@pytest.mark.asyncio
async def test_update_resource_allowance_field_headers_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_resource_allowance_flattened():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_resource_allowance_flattened_error():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_resource_allowance_flattened_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.update_resource_allowance(
            resource_allowance=gcb_resource_allowance.ResourceAllowance(usage_resource_allowance=gcb_resource_allowance.UsageResourceAllowance(spec=gcb_resource_allowance.UsageResourceAllowanceSpec(type_='type__value'))),
            update_mask=field_mask_pb2.FieldMask(paths=['paths_value']),
        )
...
@pytest.mark.asyncio
async def test_update_resource_allowance_flattened_error_async():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_resource_allowance(
            batch.UpdateResourceAllowanceRequest(),
            resource_allowance=gcb_resource_allowance.ResourceAllowance(usage_resource_allowance=gcb_resource_allowance.UsageResourceAllowance(spec=gcb_resource_allowance.UsageResourceAllowanceSpec(type_='type__value'))),
            update_mask=field_mask_pb2.FieldMask(paths=['paths_value']),
        )
...
def test_create_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/jobs" % client.transport._host, args[1])
...
def test_get_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/jobs/*}" % client.transport._host, args[1])
...
def test_cancel_job_rest_required_fields(request_type=batch.CancelJobRequest):
    transport_class = transports.BatchServiceRestTransport
...
def test_cancel_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/jobs/*}:cancel" % client.transport._host, args[1])
...
def test_update_job_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("job", "updateMask", )))
...
def test_update_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{job.name=projects/*/locations/*/jobs/*}" % client.transport._host, args[1])
...
def test_get_task_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/jobs/*/taskGroups/*/tasks/*}" % client.transport._host, args[1])
...
def test_list_tasks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/jobs/*/taskGroups/*}/tasks" % client.transport._host, args[1])
...
def test_create_resource_allowance_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchServiceClient(
...
def test_create_resource_allowance_rest_required_fields(request_type=batch.CreateResourceAllowanceRequest):
    transport_class = transports.BatchServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_resource_allowance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_resource_allowance._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("request_id", "resource_allowance_id", ))
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = gcb_resource_allowance.ResourceAllowance()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = gcb_resource_allowance.ResourceAllowance.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_create_resource_allowance_rest_unset_required_fields():
    transport = transports.BatchServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_resource_allowance._get_unset_required_fields({})
    assert set(unset_fields) == (set(("requestId", "resourceAllowanceId", )) & set(("parent", "resourceAllowance", )))


def test_create_resource_allowance_rest_flattened():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.create_resource_allowance(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/resourceAllowances" % client.transport._host, args[1])


def test_create_resource_allowance_rest_flattened_error(transport: str = 'rest'):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_resource_allowance_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchServiceClient(
...
def test_get_resource_allowance_rest_required_fields(request_type=batch.GetResourceAllowanceRequest):
    transport_class = transports.BatchServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_resource_allowance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = resource_allowance.ResourceAllowance()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = resource_allowance.ResourceAllowance.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_resource_allowance_rest_unset_required_fields():
    transport = transports.BatchServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.get_resource_allowance._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))


def test_get_resource_allowance_rest_flattened():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/resourceAllowances/sample3'}
        ...
        client.get_resource_allowance(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/resourceAllowances/*}" % client.transport._host, args[1])


def test_get_resource_allowance_rest_flattened_error(transport: str = 'rest'):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_resource_allowance_rest_required_fields(request_type=batch.DeleteResourceAllowanceRequest):
    transport_class = transports.BatchServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_resource_allowance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_resource_allowance._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("reason", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_delete_resource_allowance_rest_unset_required_fields():
    transport = transports.BatchServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.delete_resource_allowance._get_unset_required_fields({})
    assert set(unset_fields) == (set(("reason", "requestId", )) & set(("name", )))


def test_delete_resource_allowance_rest_flattened():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.delete_resource_allowance(**mock_args)
...
def test_delete_resource_allowance_rest_flattened_error(transport: str = 'rest'):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_resource_allowances_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchServiceClient(
...
def test_list_resource_allowances_rest_required_fields(request_type=batch.ListResourceAllowancesRequest):
    transport_class = transports.BatchServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_resource_allowances._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = batch.ListResourceAllowancesResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = batch.ListResourceAllowancesResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_resource_allowances_rest_unset_required_fields():
    transport = transports.BatchServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.list_resource_allowances._get_unset_required_fields({})
    assert set(unset_fields) == (set(("pageSize", "pageToken", )) & set(("parent", )))


def test_list_resource_allowances_rest_flattened():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.list_resource_allowances(**mock_args)
...
def test_list_resource_allowances_rest_flattened_error(transport: str = 'rest'):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_resource_allowances_rest_pager(transport: str = 'rest'):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(batch.ListResourceAllowancesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.list_resource_allowances(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token


def test_update_resource_allowance_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchServiceClient(
...
def test_update_resource_allowance_rest_required_fields(request_type=batch.UpdateResourceAllowanceRequest):
    transport_class = transports.BatchServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_resource_allowance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_resource_allowance_rest_unset_required_fields():
    transport = transports.BatchServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.update_resource_allowance._get_unset_required_fields({})
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("resourceAllowance", "updateMask", )))


def test_update_resource_allowance_rest_flattened():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'resource_allowance': {'name': 'projects/sample1/locations/sample2/resourceAllowances/sample3'}}
        ...
        client.update_resource_allowance(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{resource_allowance.name=projects/*/locations/*/resourceAllowances/*}" % client.transport._host, args[1])


def test_update_resource_allowance_rest_flattened_error(transport: str = 'rest'):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_job_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = batch.CancelJobRequest()
...
def test_update_job_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = batch.UpdateJobRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_resource_allowance_empty_call_grpc():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = gcb_resource_allowance.ResourceAllowance()
        client.create_resource_allowance(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = batch.CreateResourceAllowanceRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_resource_allowance_empty_call_grpc():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = resource_allowance.ResourceAllowance()
        client.get_resource_allowance(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = batch.GetResourceAllowanceRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_resource_allowance_empty_call_grpc():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_resource_allowance(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = batch.DeleteResourceAllowanceRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_resource_allowances_empty_call_grpc():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = batch.ListResourceAllowancesResponse()
        client.list_resource_allowances(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = batch.ListResourceAllowancesRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_resource_allowance_empty_call_grpc():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = gcb_resource_allowance.ResourceAllowance()
        client.update_resource_allowance(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = batch.UpdateResourceAllowanceRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_resource_allowance_empty_call_grpc_asyncio():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_resource_allowance(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_resource_allowance_empty_call_grpc_asyncio():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_resource_allowance(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_resource_allowance_empty_call_grpc_asyncio():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_resource_allowance(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_resource_allowances_empty_call_grpc_asyncio():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_resource_allowances(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_resource_allowance_empty_call_grpc_asyncio():
    client = BatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_resource_allowance(request=None)
...
def test_create_job_rest_interceptors(null_interceptor):
    transport = transports.BatchServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BatchServiceRestInterceptor(),
        )
    client = BatchServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_create_job") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_create_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_create_job") as pre:
...
def test_get_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_get_job") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_get_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_get_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_delete_job") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_delete_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_delete_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_cancel_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_cancel_job") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_cancel_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_cancel_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_update_job") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_update_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_update_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_list_jobs") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_list_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_list_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_get_task") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_get_task_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_get_task") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_tasks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_list_tasks") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_list_tasks_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_list_tasks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_resource_allowance_rest_bad_request(request_type=batch.CreateResourceAllowanceRequest):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_resource_allowance_rest_call_success(request_type):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["resource_allowance"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["resource_allowance"][field])):
                    del request_init["resource_allowance"][field][i][subfield]
            else:
                del request_init["resource_allowance"][field][subfield]
    request = request_type(**request_init)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_create_resource_allowance_rest_interceptors(null_interceptor):
    transport = transports.BatchServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BatchServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_create_resource_allowance") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_create_resource_allowance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_create_resource_allowance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = batch.CreateResourceAllowanceRequest.pb(batch.CreateResourceAllowanceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcb_resource_allowance.ResourceAllowance.to_json(gcb_resource_allowance.ResourceAllowance())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcb_resource_allowance.ResourceAllowance(), metadata

        client.create_resource_allowance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_resource_allowance_rest_bad_request(request_type=batch.GetResourceAllowanceRequest):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/resourceAllowances/sample3'}
    request = request_type(**request_init)
...
def test_get_resource_allowance_rest_call_success(request_type):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_resource_allowance_rest_interceptors(null_interceptor):
    transport = transports.BatchServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BatchServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_get_resource_allowance") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_get_resource_allowance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_get_resource_allowance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = batch.GetResourceAllowanceRequest.pb(batch.GetResourceAllowanceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = resource_allowance.ResourceAllowance.to_json(resource_allowance.ResourceAllowance())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = resource_allowance.ResourceAllowance(), metadata

        client.get_resource_allowance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_resource_allowance_rest_bad_request(request_type=batch.DeleteResourceAllowanceRequest):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_resource_allowance_rest_call_success(request_type):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_resource_allowance_rest_interceptors(null_interceptor):
    transport = transports.BatchServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BatchServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_delete_resource_allowance") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_delete_resource_allowance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_delete_resource_allowance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = batch.DeleteResourceAllowanceRequest.pb(batch.DeleteResourceAllowanceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_resource_allowance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_resource_allowances_rest_bad_request(request_type=batch.ListResourceAllowancesRequest):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_resource_allowances_rest_call_success(request_type):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_list_resource_allowances_rest_interceptors(null_interceptor):
    transport = transports.BatchServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BatchServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_list_resource_allowances") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_list_resource_allowances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_list_resource_allowances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = batch.ListResourceAllowancesRequest.pb(batch.ListResourceAllowancesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = batch.ListResourceAllowancesResponse.to_json(batch.ListResourceAllowancesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = batch.ListResourceAllowancesResponse(), metadata

        client.list_resource_allowances(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_resource_allowance_rest_bad_request(request_type=batch.UpdateResourceAllowanceRequest):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'resource_allowance': {'name': 'projects/sample1/locations/sample2/resourceAllowances/sample3'}}
    request = request_type(**request_init)
...
def test_update_resource_allowance_rest_call_success(request_type):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'resource_allowance': {'name': 'projects/sample1/locations/sample2/resourceAllowances/sample3'}}
    request_init["resource_allowance"] = {'usage_resource_allowance': {'spec': {'type_': 'type__value', 'limit': {'calendar_period': 1, 'limit': 0.543}}, 'status': {'state': 1, 'limit_status': {'consumption_interval': {'start_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}}, 'limit': 0.543, 'consumed': 0.862}, 'report': {'latest_period_consumptions': {}}}}, 'name': 'projects/sample1/locations/sample2/resourceAllowances/sample3', 'uid': 'uid_value', 'create_time': {}, 'labels': {}, 'notifications': [{'pubsub_topic': 'pubsub_topic_value'}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = batch.UpdateResourceAllowanceRequest.meta.fields["resource_allowance"]
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_resource_allowance_rest_interceptors(null_interceptor):
    transport = transports.BatchServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BatchServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_update_resource_allowance") as post, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "post_update_resource_allowance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchServiceRestInterceptor, "pre_update_resource_allowance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = batch.UpdateResourceAllowanceRequest.pb(batch.UpdateResourceAllowanceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_resource_allowance(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_resource_allowance_empty_call_rest():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_resource_allowance_empty_call_rest():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_resource_allowance_empty_call_rest():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_resource_allowances_empty_call_rest():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_resource_allowance_empty_call_rest():
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_batch_service_base_transport():
    ...
    with mock.patch('google.cloud.batch_v1alpha.services.batch_service.transports.BatchServiceTransport.__init__') as Transport:
...
def test_batch_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.batch_v1alpha.services.batch_service.transports.BatchServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_batch_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.batch_v1alpha.services.batch_service.transports.BatchServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BatchServiceTransport()
        adc.assert_called_once()
...
def test_batch_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_batch_service_host_no_port(transport_name):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='batch.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'batch.googleapis.com:443'
...
def test_batch_service_host_with_port(transport_name):
    client = BatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='batch.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
def test_batch_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.create_resource_allowance._session
    session2 = client2.transport.create_resource_allowance._session
    assert session1 != session2
    session1 = client1.transport.get_resource_allowance._session
    session2 = client2.transport.get_resource_allowance._session
    assert session1 != session2
    session1 = client1.transport.delete_resource_allowance._session
    session2 = client2.transport.delete_resource_allowance._session
    assert session1 != session2
    session1 = client1.transport.list_resource_allowances._session
    session2 = client2.transport.list_resource_allowances._session
    assert session1 != session2
    session1 = client1.transport.update_resource_allowance._session
    session2 = client2.transport.update_resource_allowance._session
    assert session1 != session2
...
@pytest.mark.parametrize("transport_class", [transports.BatchServiceGrpcTransport, transports.BatchServiceGrpcAsyncIOTransport])
def test_batch_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.BatchServiceGrpcTransport, transports.BatchServiceGrpcAsyncIOTransport])
def test_batch_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_resource_allowance_path():
    project = "cuttlefish"
    location = "mussel"
    resource_allowance = "winkle"
    expected = "projects/{project}/locations/{location}/resourceAllowances/{resource_allowance}".format(project=project, location=location, resource_allowance=resource_allowance, )
    actual = BatchServiceClient.resource_allowance_path(project, location, resource_allowance)
    assert expected == actual
...
def test_parse_resource_allowance_path():
    expected = {
        "project": "nautilus",
        "location": "scallop",
        "resource_allowance": "abalone",
    }
    path = BatchServiceClient.resource_allowance_path(**expected)

    # Check that the path construction is reversible.
    actual = BatchServiceClient.parse_resource_allowance_path(path)
    assert expected == actual

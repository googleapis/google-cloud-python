...
#
# Snippet for ListEntitySignalsMappings
...
def sample_list_entity_signals_mappings():
    # Create a client
    client = admanager_v1.EntitySignalsMappingServiceClient()

    # Initialize request argument(s)
    request = admanager_v1.ListEntitySignalsMappingsRequest(
        parent="parent_value",
    )

    # Make the request
    page_result = client.list_entity_signals_mappings(request=request)

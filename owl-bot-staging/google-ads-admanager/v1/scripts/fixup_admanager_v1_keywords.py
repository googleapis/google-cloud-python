...
class admanagerCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        'export_saved_report': ('format_', 'report', 'include_report_properties', 'include_ids', 'include_totals_row', 'file_name', ),
        'get_ad_partner': ('name', ),
        'get_ad_unit': ('name', ),
        'get_company': ('name', ),
        'get_contact': ('name', ),
        ...
        'get_team': ('name', ),
        'get_user': ('name', ),
        'list_ad_partners': ('parent', 'page_size', 'page_token', 'filter', 'order_by', 'skip', ),
        ...
        'list_creatives': ('parent', 'page_size', 'page_token', 'filter', 'order_by', 'skip', ),
        ...
        'list_labels': ('parent', 'page_size', 'page_token', 'filter', 'order_by', 'skip', ),
        ...
        'list_users': ('parent', 'page_size', 'page_token', 'filter', 'order_by', 'skip', ),
    }

...
class CustomFieldServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_custom_field(self, request: custom_field_service.GetCustomFieldRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[custom_field_service.GetCustomFieldRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_custom_fields(self, request: custom_field_service.ListCustomFieldsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[custom_field_service.ListCustomFieldsRequest, Sequence[Tuple[str, str]]]:

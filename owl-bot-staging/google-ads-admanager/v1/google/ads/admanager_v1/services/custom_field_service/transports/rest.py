...
class CustomFieldServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_custom_field(self, request: custom_field_service.GetCustomFieldRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_field_service.GetCustomFieldRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_custom_field_with_metadata(self, response: custom_field_messages.CustomField, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_field_messages.CustomField, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_custom_field
    ...
    def pre_list_custom_fields(self, request: custom_field_service.ListCustomFieldsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_field_service.ListCustomFieldsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_custom_fields_with_metadata(self, response: custom_field_service.ListCustomFieldsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_field_service.ListCustomFieldsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_custom_fields
...
class CustomFieldServiceRestTransport(_BaseCustomFieldServiceRestTransport):
    ...
    class _GetCustomField(_BaseCustomFieldServiceRestTransport._BaseGetCustomField, CustomFieldServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CustomFieldServiceRestTransport._GetCustomField._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListCustomFields(_BaseCustomFieldServiceRestTransport._BaseListCustomFields, CustomFieldServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CustomFieldServiceRestTransport._ListCustomFields._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    @property
    def get_custom_field(self) -> Callable[
    ...
    @property
    def list_custom_fields(self) -> Callable[
    ...
    class _GetOperation(_BaseCustomFieldServiceRestTransport._BaseGetOperation, CustomFieldServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CustomFieldServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
from .base import CustomFieldServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class CustomFieldServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_custom_field(self, response: custom_field_service.CustomField) -> custom_field_service.CustomField:

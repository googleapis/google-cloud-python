...
class TaxonomyCategoryServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_taxonomy_category(self, request: taxonomy_category_service.GetTaxonomyCategoryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[taxonomy_category_service.GetTaxonomyCategoryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_taxonomy_category_with_metadata(self, response: taxonomy_category_messages.TaxonomyCategory, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[taxonomy_category_messages.TaxonomyCategory, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_taxonomy_category
    ...
    def pre_list_taxonomy_categories(self, request: taxonomy_category_service.ListTaxonomyCategoriesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[taxonomy_category_service.ListTaxonomyCategoriesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_taxonomy_categories(self, response: taxonomy_category_service.ListTaxonomyCategoriesResponse) -> taxonomy_category_service.ListTaxonomyCategoriesResponse:
    ...
    def post_list_taxonomy_categories_with_metadata(self, response: taxonomy_category_service.ListTaxonomyCategoriesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[taxonomy_category_service.ListTaxonomyCategoriesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_taxonomy_categories
...
class TaxonomyCategoryServiceRestTransport(_BaseTaxonomyCategoryServiceRestTransport):
    ...
    class _GetTaxonomyCategory(_BaseTaxonomyCategoryServiceRestTransport._BaseGetTaxonomyCategory, TaxonomyCategoryServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TaxonomyCategoryServiceRestTransport._GetTaxonomyCategory._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListTaxonomyCategories(_BaseTaxonomyCategoryServiceRestTransport._BaseListTaxonomyCategories, TaxonomyCategoryServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TaxonomyCategoryServiceRestTransport._ListTaxonomyCategories._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseTaxonomyCategoryServiceRestTransport._BaseGetOperation, TaxonomyCategoryServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TaxonomyCategoryServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class TaxonomyCategoryServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_taxonomy_category(self, request: taxonomy_category_service.GetTaxonomyCategoryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[taxonomy_category_service.GetTaxonomyCategoryRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_taxonomy_categories(self, request: taxonomy_category_service.ListTaxonomyCategoriesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[taxonomy_category_service.ListTaxonomyCategoriesRequest, Sequence[Tuple[str, str]]]:

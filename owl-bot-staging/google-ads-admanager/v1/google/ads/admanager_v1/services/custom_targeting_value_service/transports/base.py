...
class CustomTargetingValueServiceTransport(abc.ABC):
    """Abstract transport class for CustomTargetingValueService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_custom_targeting_value: gapic_v1.method.wrap_method(
                self.get_custom_targeting_value,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_custom_targeting_values: gapic_v1.method.wrap_method(
                self.list_custom_targeting_values,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def get_custom_targeting_value(self) -> Callable[
    ...
    @property
    def list_custom_targeting_values(self) -> Callable[
...
__all__ = (
    'CustomTargetingValueServiceTransport',
)

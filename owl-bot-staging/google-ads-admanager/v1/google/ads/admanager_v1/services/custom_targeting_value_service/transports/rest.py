...
class CustomTargetingValueServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_custom_targeting_value(self, request: custom_targeting_value_service.GetCustomTargetingValueRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_targeting_value_service.GetCustomTargetingValueRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_custom_targeting_value(self, response: custom_targeting_value_messages.CustomTargetingValue) -> custom_targeting_value_messages.CustomTargetingValue:
    ...
    def post_get_custom_targeting_value_with_metadata(self, response: custom_targeting_value_messages.CustomTargetingValue, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_targeting_value_messages.CustomTargetingValue, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_custom_targeting_value
    ...
    def pre_list_custom_targeting_values(self, request: custom_targeting_value_service.ListCustomTargetingValuesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_targeting_value_service.ListCustomTargetingValuesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_custom_targeting_values(self, response: custom_targeting_value_service.ListCustomTargetingValuesResponse) -> custom_targeting_value_service.ListCustomTargetingValuesResponse:
    ...
    def post_list_custom_targeting_values_with_metadata(self, response: custom_targeting_value_service.ListCustomTargetingValuesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_targeting_value_service.ListCustomTargetingValuesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_custom_targeting_values
...
class CustomTargetingValueServiceRestTransport(_BaseCustomTargetingValueServiceRestTransport):
    ...
    class _GetCustomTargetingValue(_BaseCustomTargetingValueServiceRestTransport._BaseGetCustomTargetingValue, CustomTargetingValueServiceRestStub):
        def __hash__(self):
            return hash("CustomTargetingValueServiceRestTransport.GetCustomTargetingValue")
        ...
        value method over HTTP.
            ...
            request, metadata = self._interceptor.pre_get_custom_targeting_value(request, metadata)
            transcoded_request = _BaseCustomTargetingValueServiceRestTransport._BaseGetCustomTargetingValue._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseCustomTargetingValueServiceRestTransport._BaseGetCustomTargetingValue._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CustomTargetingValueServiceRestTransport._GetCustomTargetingValue._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            resp, _ = self._interceptor.post_get_custom_targeting_value_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = custom_targeting_value_messages.CustomTargetingValue.to_json(response)
                except:
    ...
    class _ListCustomTargetingValues(_BaseCustomTargetingValueServiceRestTransport._BaseListCustomTargetingValues, CustomTargetingValueServiceRestStub):
        def __hash__(self):
            return hash("CustomTargetingValueServiceRestTransport.ListCustomTargetingValues")
        ...
        values method over HTTP.
            ...
            request, metadata = self._interceptor.pre_list_custom_targeting_values(request, metadata)
            transcoded_request = _BaseCustomTargetingValueServiceRestTransport._BaseListCustomTargetingValues._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseCustomTargetingValueServiceRestTransport._BaseListCustomTargetingValues._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CustomTargetingValueServiceRestTransport._ListCustomTargetingValues._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            pb_resp = custom_targeting_value_service.ListCustomTargetingValuesResponse.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)

            resp = self._interceptor.post_list_custom_targeting_values(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_custom_targeting_values_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = custom_targeting_value_service.ListCustomTargetingValuesResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    def get_custom_targeting_value(self) -> Callable[
        ...
        return self._GetCustomTargetingValue(self._session, self._host, self._interceptor) # type: ignore
    ...
    def list_custom_targeting_values(self) -> Callable[
        ...
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._ListCustomTargetingValues(self._session, self._host, self._interceptor) # type: ignore

    @property
    def get_operation(self):
        return self._GetOperation(self._session, self._host, self._interceptor) # type: ignore

    class _GetOperation(_BaseCustomTargetingValueServiceRestTransport._BaseGetOperation, CustomTargetingValueServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseCustomTargetingValueServiceRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseCustomTargetingValueServiceRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CustomTargetingValueServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class CustomTargetingValueServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_custom_targeting_value(self, response: custom_targeting_value_service.CustomTargetingValue) -> custom_targeting_value_service.CustomTargetingValue:

...
from .base import CustomTargetingValueServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class CustomTargetingValueServiceRestTransport(CustomTargetingValueServiceTransport):
    ...
    class _GetCustomTargetingValue(CustomTargetingValueServiceRestStub):
        ...
        value method over HTTP.
            ...
            pb_request = custom_targeting_value_service.GetCustomTargetingValueRequest.pb(request)
    ...
    class _ListCustomTargetingValues(CustomTargetingValueServiceRestStub):
        ...
        values method over HTTP.
            ...
            pb_request = custom_targeting_value_service.ListCustomTargetingValuesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)

...
from .base import AdPartnerServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class AdPartnerServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_ad_partner(self, request: ad_partner_service.GetAdPartnerRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ad_partner_service.GetAdPartnerRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_ad_partner(self, response: ad_partner_service.AdPartner) -> ad_partner_service.AdPartner:
        ...
        """
        return response
    def pre_list_ad_partners(self, request: ad_partner_service.ListAdPartnersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ad_partner_service.ListAdPartnersRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_ad_partners(self, response: ad_partner_service.ListAdPartnersResponse) -> ad_partner_service.ListAdPartnersResponse:
...
class AdPartnerServiceRestTransport(AdPartnerServiceTransport):
    ...
    class _ListAdPartners(AdPartnerServiceRestStub):
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_list_ad_partners(request, metadata)
    ...
    @property
    def get_ad_partner(self) -> Callable[
    ...
    @property
    def list_ad_partners(self) -> Callable[

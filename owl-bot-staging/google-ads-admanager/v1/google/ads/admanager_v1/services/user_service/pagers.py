...
class ListUsersPager:
    ...
    :class:`google.ads.admanager_v1.types.ListUsersResponse` object, and
    ...
    All the usual :class:`google.ads.admanager_v1.types.ListUsersResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
            method: Callable[..., user_service.ListUsersResponse],
        ...
        Args:
            ...
            request (google.ads.admanager_v1.types.ListUsersRequest):
                The initial request object.
            response (google.ads.admanager_v1.types.ListUsersResponse):
        ...
        """
        self._method = method
        self._request = user_service.ListUsersRequest(request)
    ...
    @property
    def pages(self) -> Iterator[user_service.ListUsersResponse]:
    ...
    def __iter__(self) -> Iterator[user_service.User]:

...
class UserServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_user(self, request: user_service.GetUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[user_service.GetUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_user(self, response: user_service.User) -> user_service.User:
        ...
        """
        return response
    def pre_list_users(self, request: user_service.ListUsersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[user_service.ListUsersRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_users(self, response: user_service.ListUsersResponse) -> user_service.ListUsersResponse:

...
class UserServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_user(self, request: user_service.GetUserRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user_service.GetUserRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_user_with_metadata(self, response: user_messages.User, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[user_messages.User, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_user
...
class UserServiceRestTransport(_BaseUserServiceRestTransport):
    ...
    class _GetOperation(_BaseUserServiceRestTransport._BaseGetOperation, UserServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = UserServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

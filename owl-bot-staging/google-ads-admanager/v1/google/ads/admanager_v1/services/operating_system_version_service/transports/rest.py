...
class OperatingSystemVersionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_operating_system_version(self, request: operating_system_version_service.GetOperatingSystemVersionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operating_system_version_service.GetOperatingSystemVersionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_operating_system_version(self, response: operating_system_version_messages.OperatingSystemVersion) -> operating_system_version_messages.OperatingSystemVersion:
    ...
    def post_get_operating_system_version_with_metadata(self, response: operating_system_version_messages.OperatingSystemVersion, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operating_system_version_messages.OperatingSystemVersion, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_operating_system_version
    ...
    def pre_list_operating_system_versions(self, request: operating_system_version_service.ListOperatingSystemVersionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operating_system_version_service.ListOperatingSystemVersionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_operating_system_versions(self, response: operating_system_version_service.ListOperatingSystemVersionsResponse) -> operating_system_version_service.ListOperatingSystemVersionsResponse:
    ...
    def post_list_operating_system_versions_with_metadata(self, response: operating_system_version_service.ListOperatingSystemVersionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operating_system_version_service.ListOperatingSystemVersionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_operating_system_versions
...
class OperatingSystemVersionServiceRestTransport(_BaseOperatingSystemVersionServiceRestTransport):
    ...
    class _GetOperatingSystemVersion(_BaseOperatingSystemVersionServiceRestTransport._BaseGetOperatingSystemVersion, OperatingSystemVersionServiceRestStub):
        def __hash__(self):
        ...
        version method over HTTP.
            ...
            transcoded_request = _BaseOperatingSystemVersionServiceRestTransport._BaseGetOperatingSystemVersion._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = OperatingSystemVersionServiceRestTransport._GetOperatingSystemVersion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperatingSystemVersions(_BaseOperatingSystemVersionServiceRestTransport._BaseListOperatingSystemVersions, OperatingSystemVersionServiceRestStub):
        def __hash__(self):
        ...
        versions method over HTTP.
            ...
            transcoded_request = _BaseOperatingSystemVersionServiceRestTransport._BaseListOperatingSystemVersions._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = OperatingSystemVersionServiceRestTransport._ListOperatingSystemVersions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseOperatingSystemVersionServiceRestTransport._BaseGetOperation, OperatingSystemVersionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OperatingSystemVersionServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

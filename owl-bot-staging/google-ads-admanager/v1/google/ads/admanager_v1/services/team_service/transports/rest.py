...
from .base import TeamServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class TeamServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_team(self, request: team_service.GetTeamRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[team_service.GetTeamRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_team(self, response: team_service.Team) -> team_service.Team:
        ...
        """
        return response
    def pre_list_teams(self, request: team_service.ListTeamsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[team_service.ListTeamsRequest, Sequence[Tuple[str, str]]]:
...
class TeamServiceRestTransport(TeamServiceTransport):
    """REST backend transport for TeamService.
    ...
    class _GetTeam(TeamServiceRestStub):
        def __hash__(self):
            return hash("GetTeam")
        ...
        def __call__(self,
            ...
            # Return the response
            resp = team_service.Team()
            pb_resp = team_service.Team.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)
            resp = self._interceptor.post_get_team(resp)
            return resp

    class _ListTeams(TeamServiceRestStub):
        def __hash__(self):
            return hash("ListTeams")
        ...
        def __call__(self,
            ...
            Returns:
                ~.team_service.ListTeamsResponse:
                    Response object for ListTeamsRequest
                containing matching Team resources.
    ...
    class _GetOperation(TeamServiceRestStub):
        def __call__(self,

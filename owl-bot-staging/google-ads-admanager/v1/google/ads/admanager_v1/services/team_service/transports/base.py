...
class TeamServiceTransport(abc.ABC):
    """Abstract transport class for TeamService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_team: gapic_v1.method.wrap_method(
                self.get_team,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_teams: gapic_v1.method.wrap_method(
                self.list_teams,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    @property
    def get_team(self) -> Callable[
            [team_service.GetTeamRequest],
            Union[
                team_service.Team,
                Awaitable[team_service.Team]
            ]]:
        raise NotImplementedError()

    @property
    def list_teams(self) -> Callable[
            [team_service.ListTeamsRequest],
            Union[
                team_service.ListTeamsResponse,
                Awaitable[team_service.ListTeamsResponse]
            ]]:
        raise NotImplementedError()

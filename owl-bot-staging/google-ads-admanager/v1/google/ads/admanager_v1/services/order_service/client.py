...
from .transports.base import OrderServiceTransport, DEFAULT_CLIENT_INFO
...
class OrderServiceClient(metaclass=OrderServiceClientMeta):
    ...
    @staticmethod
    def custom_field_path(network_code: str,custom_field: str,) -> str:
        """Returns a fully-qualified custom_field string."""
        return "networks/{network_code}/customFields/{custom_field}".format(network_code=network_code, custom_field=custom_field, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            OrderServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            OrderServiceClient._get_api_endpoint(

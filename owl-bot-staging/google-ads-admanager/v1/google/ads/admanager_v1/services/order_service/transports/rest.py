...
class OrderServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_order(self, request: order_service.GetOrderRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[order_service.GetOrderRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_order_with_metadata(self, response: order_messages.Order, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[order_messages.Order, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_order
    ...
    def pre_list_orders(self, request: order_service.ListOrdersRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[order_service.ListOrdersRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_orders_with_metadata(self, response: order_service.ListOrdersResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[order_service.ListOrdersResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_orders
...
class OrderServiceRestTransport(_BaseOrderServiceRestTransport):
    ...
    class _GetOrder(_BaseOrderServiceRestTransport._BaseGetOrder, OrderServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OrderServiceRestTransport._GetOrder._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOrders(_BaseOrderServiceRestTransport._BaseListOrders, OrderServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OrderServiceRestTransport._ListOrders._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseOrderServiceRestTransport._BaseGetOperation, OrderServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OrderServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class OrderServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_order(self, request: order_service.GetOrderRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[order_service.GetOrderRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_orders(self, request: order_service.ListOrdersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[order_service.ListOrdersRequest, Sequence[Tuple[str, str]]]:

...
class EntitySignalsMappingServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_create_entity_signals_mappings(self, request: entity_signals_mapping_service.BatchCreateEntitySignalsMappingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_signals_mapping_service.BatchCreateEntitySignalsMappingsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_batch_update_entity_signals_mappings(self, request: entity_signals_mapping_service.BatchUpdateEntitySignalsMappingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_signals_mapping_service.BatchUpdateEntitySignalsMappingsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_entity_signals_mapping(self, request: entity_signals_mapping_service.CreateEntitySignalsMappingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_signals_mapping_service.CreateEntitySignalsMappingRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_entity_signals_mapping(self, request: entity_signals_mapping_service.GetEntitySignalsMappingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_signals_mapping_service.GetEntitySignalsMappingRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_entity_signals_mappings(self, request: entity_signals_mapping_service.ListEntitySignalsMappingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_signals_mapping_service.ListEntitySignalsMappingsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_entity_signals_mapping(self, request: entity_signals_mapping_service.UpdateEntitySignalsMappingRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_signals_mapping_service.UpdateEntitySignalsMappingRequest, Sequence[Tuple[str, str]]]:

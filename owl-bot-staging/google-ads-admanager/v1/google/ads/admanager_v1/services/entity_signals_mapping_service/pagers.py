...
class ListEntitySignalsMappingsPager:
    """A pager for iterating through ``list_entity_signals_mappings`` requests.

    This class thinly wraps an initial
    :class:`google.ads.admanager_v1.types.ListEntitySignalsMappingsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``entity_signals_mappings`` field.

    If there are more pages, the ``__iter__`` method will make additional
    ``ListEntitySignalsMappings`` requests and continue to iterate
    through the ``entity_signals_mappings`` field on the
    corresponding responses.

    All the usual :class:`google.ads.admanager_v1.types.ListEntitySignalsMappingsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.ads.admanager_v1.types.ListEntitySignalsMappingsRequest):
                The initial request object.
            response (google.ads.admanager_v1.types.ListEntitySignalsMappingsResponse):

...
from .base import ContactServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ContactServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_contact(self, request: contact_service.GetContactRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[contact_service.GetContactRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_contact(self, response: contact_service.Contact) -> contact_service.Contact:
        ...
        """
        return response
    def pre_list_contacts(self, request: contact_service.ListContactsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[contact_service.ListContactsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_contacts(self, response: contact_service.ListContactsResponse) -> contact_service.ListContactsResponse:
...
class ContactServiceRestTransport(ContactServiceTransport):
    """REST backend transport for ContactService.
    ...
    class _GetContact(ContactServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Return the response
            resp = contact_service.Contact()
            pb_resp = contact_service.Contact.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)
            resp = self._interceptor.post_get_contact(resp)
            return resp

    class _ListContacts(ContactServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            Args:
                request (~.contact_service.ListContactsRequest):
                    The request object. Request object for ListContacts
                method.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            Returns:
                ~.contact_service.ListContactsResponse:
                    Response object for
                ListContactsRequest containing matching
                Contact resources.
    ...
    class _GetOperation(ContactServiceRestStub):
        def __call__(self,

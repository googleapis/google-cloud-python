...
class ListContactsPager:
    ...
    :class:`google.ads.admanager_v1.types.ListContactsResponse` object, and
    ...
    All the usual :class:`google.ads.admanager_v1.types.ListContactsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
            method: Callable[..., contact_service.ListContactsResponse],
        ...
        Args:
            ...
            request (google.ads.admanager_v1.types.ListContactsRequest):
    ...
    @property
    def pages(self) -> Iterator[contact_service.ListContactsResponse]:

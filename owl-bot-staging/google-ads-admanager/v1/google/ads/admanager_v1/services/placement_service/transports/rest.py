...
class PlacementServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_placement(self, request: placement_service.GetPlacementRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[placement_service.GetPlacementRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_placement_with_metadata(self, response: placement_messages.Placement, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[placement_messages.Placement, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_placement
    ...
    def pre_list_placements(self, request: placement_service.ListPlacementsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[placement_service.ListPlacementsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_placements_with_metadata(self, response: placement_service.ListPlacementsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[placement_service.ListPlacementsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_placements
...
class PlacementServiceRestTransport(_BasePlacementServiceRestTransport):
    ...
    class _GetPlacement(_BasePlacementServiceRestTransport._BaseGetPlacement, PlacementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PlacementServiceRestTransport._GetPlacement._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListPlacements(_BasePlacementServiceRestTransport._BaseListPlacements, PlacementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PlacementServiceRestTransport._ListPlacements._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    @property
    def get_placement(self) -> Callable[
    ...
    @property
    def list_placements(self) -> Callable[
    ...
    class _GetOperation(_BasePlacementServiceRestTransport._BaseGetOperation, PlacementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PlacementServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

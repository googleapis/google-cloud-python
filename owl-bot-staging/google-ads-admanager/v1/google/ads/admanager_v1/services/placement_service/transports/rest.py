...
from .base import PlacementServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class PlacementServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_placement(self, request: placement_service.GetPlacementRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[placement_service.GetPlacementRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_placement(self, response: placement_service.Placement) -> placement_service.Placement:
        ...
        """
        return response
    def pre_list_placements(self, request: placement_service.ListPlacementsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[placement_service.ListPlacementsRequest, Sequence[Tuple[str, str]]]:
...
class PlacementServiceRestTransport(PlacementServiceTransport):
    """REST backend transport for PlacementService.
    ...
    class _GetPlacement(PlacementServiceRestStub):
        def __hash__(self):
            return hash("GetPlacement")
        ...
        def __call__(self,
            ...
            # Return the response
            resp = placement_service.Placement()
            pb_resp = placement_service.Placement.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)
            resp = self._interceptor.post_get_placement(resp)
            return resp

    class _ListPlacements(PlacementServiceRestStub):
        def __hash__(self):
            return hash("ListPlacements")
    ...
    class _GetOperation(PlacementServiceRestStub):
        def __call__(self,

...
class AdUnitServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_ad_unit(self, request: ad_unit_service.GetAdUnitRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ad_unit_service.GetAdUnitRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_ad_units(self, request: ad_unit_service.ListAdUnitsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ad_unit_service.ListAdUnitsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_ad_unit_sizes(self, request: ad_unit_service.ListAdUnitSizesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ad_unit_service.ListAdUnitSizesRequest, Sequence[Tuple[str, str]]]:

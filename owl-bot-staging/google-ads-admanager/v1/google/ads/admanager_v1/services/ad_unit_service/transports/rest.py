...
class AdUnitServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_ad_unit(self, request: ad_unit_service.GetAdUnitRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ad_unit_service.GetAdUnitRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_ad_unit_with_metadata(self, response: ad_unit_messages.AdUnit, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ad_unit_messages.AdUnit, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_ad_unit
    ...
    def pre_list_ad_units(self, request: ad_unit_service.ListAdUnitsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ad_unit_service.ListAdUnitsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_ad_units_with_metadata(self, response: ad_unit_service.ListAdUnitsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ad_unit_service.ListAdUnitsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_ad_units
    ...
    def pre_list_ad_unit_sizes(self, request: ad_unit_service.ListAdUnitSizesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ad_unit_service.ListAdUnitSizesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_ad_unit_sizes_with_metadata(self, response: ad_unit_service.ListAdUnitSizesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[ad_unit_service.ListAdUnitSizesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_ad_unit_sizes
...
class AdUnitServiceRestTransport(_BaseAdUnitServiceRestTransport):
    ...
    class _GetAdUnit(_BaseAdUnitServiceRestTransport._BaseGetAdUnit, AdUnitServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AdUnitServiceRestTransport._GetAdUnit._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListAdUnits(_BaseAdUnitServiceRestTransport._BaseListAdUnits, AdUnitServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AdUnitServiceRestTransport._ListAdUnits._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListAdUnitSizes(_BaseAdUnitServiceRestTransport._BaseListAdUnitSizes, AdUnitServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AdUnitServiceRestTransport._ListAdUnitSizes._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseAdUnitServiceRestTransport._BaseGetOperation, AdUnitServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AdUnitServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

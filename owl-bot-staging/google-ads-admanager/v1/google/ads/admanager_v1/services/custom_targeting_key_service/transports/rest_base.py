...
from .base import CustomTargetingKeyServiceTransport, DEFAULT_CLIENT_INFO
...
class _BaseCustomTargetingKeyServiceRestTransport(CustomTargetingKeyServiceTransport):
    """Base REST backend transport for CustomTargetingKeyService.
    ...
    class _BaseGetCustomTargetingKey:
    ...
    class _BaseListCustomTargetingKeys:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")

...
class CustomTargetingKeyServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_custom_targeting_key(self, request: custom_targeting_key_service.GetCustomTargetingKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[custom_targeting_key_service.GetCustomTargetingKeyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_custom_targeting_keys(self, request: custom_targeting_key_service.ListCustomTargetingKeysRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[custom_targeting_key_service.ListCustomTargetingKeysRequest, Sequence[Tuple[str, str]]]:

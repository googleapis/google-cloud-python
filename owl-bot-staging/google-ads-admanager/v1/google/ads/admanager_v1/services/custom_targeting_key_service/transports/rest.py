...
class CustomTargetingKeyServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_custom_targeting_key(self, request: custom_targeting_key_service.GetCustomTargetingKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_targeting_key_service.GetCustomTargetingKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_custom_targeting_key(self, response: custom_targeting_key_messages.CustomTargetingKey) -> custom_targeting_key_messages.CustomTargetingKey:
    ...
    def post_get_custom_targeting_key_with_metadata(self, response: custom_targeting_key_messages.CustomTargetingKey, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_targeting_key_messages.CustomTargetingKey, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_custom_targeting_key
    ...
    def pre_list_custom_targeting_keys(self, request: custom_targeting_key_service.ListCustomTargetingKeysRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_targeting_key_service.ListCustomTargetingKeysRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_custom_targeting_keys(self, response: custom_targeting_key_service.ListCustomTargetingKeysResponse) -> custom_targeting_key_service.ListCustomTargetingKeysResponse:
    ...
    def post_list_custom_targeting_keys_with_metadata(self, response: custom_targeting_key_service.ListCustomTargetingKeysResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[custom_targeting_key_service.ListCustomTargetingKeysResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_custom_targeting_keys
...
class CustomTargetingKeyServiceRestTransport(_BaseCustomTargetingKeyServiceRestTransport):
    ...
    class _GetCustomTargetingKey(_BaseCustomTargetingKeyServiceRestTransport._BaseGetCustomTargetingKey, CustomTargetingKeyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CustomTargetingKeyServiceRestTransport._GetCustomTargetingKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListCustomTargetingKeys(_BaseCustomTargetingKeyServiceRestTransport._BaseListCustomTargetingKeys, CustomTargetingKeyServiceRestStub):
        ...
        keys method over HTTP.
            ...
            transcoded_request = _BaseCustomTargetingKeyServiceRestTransport._BaseListCustomTargetingKeys._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = CustomTargetingKeyServiceRestTransport._ListCustomTargetingKeys._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    @property
    def get_custom_targeting_key(self) -> Callable[
    ...
    @property
    def list_custom_targeting_keys(self) -> Callable[
    ...
    class _GetOperation(_BaseCustomTargetingKeyServiceRestTransport._BaseGetOperation, CustomTargetingKeyServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CustomTargetingKeyServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

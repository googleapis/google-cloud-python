...
from .base import CustomTargetingKeyServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class CustomTargetingKeyServiceRestTransport(CustomTargetingKeyServiceTransport):
    """REST backend transport for CustomTargetingKeyService.
    ...
    class _GetCustomTargetingKey(CustomTargetingKeyServiceRestStub):
        def __hash__(self):
            return hash("GetCustomTargetingKey")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1/{name=networks/*/customTargetingKeys/*}',
            },
            ]
    ...
    class _ListCustomTargetingKeys(CustomTargetingKeyServiceRestStub):
        def __hash__(self):
            return hash("ListCustomTargetingKeys")
        ...
        keys method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1/{parent=networks/*}/customTargetingKeys',
            },
            ]
    ...
    class _GetOperation(CustomTargetingKeyServiceRestStub):
        def __call__(self,

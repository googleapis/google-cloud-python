...
class CustomTargetingKeyServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_custom_targeting_key: gapic_v1.method.wrap_method(
                self.get_custom_targeting_key,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_custom_targeting_keys: gapic_v1.method.wrap_method(
                self.list_custom_targeting_keys,
                default_timeout=None,
                client_info=client_info,
            ),
         }

...
from .transports.base import CustomTargetingKeyServiceTransport, DEFAULT_CLIENT_INFO
...
class CustomTargetingKeyServiceClient(metaclass=CustomTargetingKeyServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            CustomTargetingKeyServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._client_cert_source = CustomTargetingKeyServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
    ...
    def get_custom_targeting_key(self,
    ...
    def list_custom_targeting_keys(self,

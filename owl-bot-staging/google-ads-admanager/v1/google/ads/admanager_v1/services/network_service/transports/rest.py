...
class NetworkServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_network(self, request: network_service.GetNetworkRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[network_service.GetNetworkRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_network_with_metadata(self, response: network_messages.Network, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[network_messages.Network, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_network
    ...
    def pre_list_networks(self, request: network_service.ListNetworksRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[network_service.ListNetworksRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_networks_with_metadata(self, response: network_service.ListNetworksResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[network_service.ListNetworksResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_networks
...
class NetworkServiceRestTransport(_BaseNetworkServiceRestTransport):
    ...
    class _GetNetwork(_BaseNetworkServiceRestTransport._BaseGetNetwork, NetworkServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = NetworkServiceRestTransport._GetNetwork._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListNetworks(_BaseNetworkServiceRestTransport._BaseListNetworks, NetworkServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = NetworkServiceRestTransport._ListNetworks._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseNetworkServiceRestTransport._BaseGetOperation, NetworkServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = NetworkServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

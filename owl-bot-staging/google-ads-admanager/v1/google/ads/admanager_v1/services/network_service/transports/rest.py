...
class NetworkServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_network(self, request: network_service.GetNetworkRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[network_service.GetNetworkRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_networks(self, request: network_service.ListNetworksRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[network_service.ListNetworksRequest, Sequence[Tuple[str, str]]]:

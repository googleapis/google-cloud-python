...
class RoleServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_role(self, request: role_service.GetRoleRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[role_service.GetRoleRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_roles(self, request: role_service.ListRolesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[role_service.ListRolesRequest, Sequence[Tuple[str, str]]]:

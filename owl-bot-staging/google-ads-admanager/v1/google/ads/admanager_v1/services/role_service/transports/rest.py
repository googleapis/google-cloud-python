...
class RoleServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_role(self, request: role_service.GetRoleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[role_service.GetRoleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_role(self, response: role_messages.Role) -> role_messages.Role:
        ...
        DEPRECATED. Please use the `post_get_role_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the RoleService server but before
        it is returned to user code. This `post_get_role` interceptor runs
        before the `post_get_role_with_metadata` interceptor.
        """
        return response

    def post_get_role_with_metadata(self, response: role_messages.Role, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[role_messages.Role, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_role

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the RoleService server but before it is returned to user code.

        We recommend only using this `post_get_role_with_metadata`
        interceptor in new development instead of the `post_get_role` interceptor.
        When both interceptors are used, this `post_get_role_with_metadata` interceptor runs after the
        `post_get_role` interceptor. The (possibly modified) response returned by
        `post_get_role` will be passed to
        `post_get_role_with_metadata`.
        """
        return response, metadata

    def pre_list_roles(self, request: role_service.ListRolesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[role_service.ListRolesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_roles(self, response: role_service.ListRolesResponse) -> role_service.ListRolesResponse:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the RoleService server but before
        it is returned to user code. This `post_list_roles` interceptor runs
        before the `post_list_roles_with_metadata` interceptor.
        """
        return response

    def post_list_roles_with_metadata(self, response: role_service.ListRolesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[role_service.ListRolesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_roles

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the RoleService server but before it is returned to user code.

        We recommend only using this `post_list_roles_with_metadata`
        interceptor in new development instead of the `post_list_roles` interceptor.
        When both interceptors are used, this `post_list_roles_with_metadata` interceptor runs after the
        `post_list_roles` interceptor. The (possibly modified) response returned by
        `post_list_roles` will be passed to
        `post_list_roles_with_metadata`.
        """
        return response, metadata
    ...
    class _GetRole(_BaseRoleServiceRestTransport._BaseGetRole, RoleServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.RoleServiceClient.GetRole",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.RoleServiceClient.get_role",
                    extra = {
                        "serviceName": "google.ads.admanager.v1.RoleService",
                        "rpcName": "GetRole",
    ...
    class _ListRoles(_BaseRoleServiceRestTransport._BaseListRoles, RoleServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.RoleServiceClient.ListRoles",
                    extra = {
                        "serviceName": "google.ads.admanager.v1.RoleService",
                        "rpcName": "ListRoles",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RoleServiceRestTransport._ListRoles._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.RoleServiceClient.list_roles",
                    extra = {
                        "serviceName": "google.ads.admanager.v1.RoleService",
                        "rpcName": "ListRoles",
                        "metadata": http_response["headers"],
    ...
    class _GetOperation(_BaseRoleServiceRestTransport._BaseGetOperation, RoleServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.RoleServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.ads.admanager.v1.RoleService",
            ...
            # Send the request
            response = RoleServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.RoleServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.ads.admanager.v1.RoleService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,

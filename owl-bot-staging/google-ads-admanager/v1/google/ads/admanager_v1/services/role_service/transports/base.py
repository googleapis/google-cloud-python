...
class RoleServiceTransport(abc.ABC):
    """Abstract transport class for RoleService."""
    ...
    def get_role(self) -> Callable[
            ...
            Union[
                role_messages.Role,
                Awaitable[role_messages.Role]
            ]]:
        raise NotImplementedError()

    @property
    def list_roles(self) -> Callable[
            [role_service.ListRolesRequest],
            Union[
                role_service.ListRolesResponse,
                Awaitable[role_service.ListRolesResponse]
            ]]:
        raise NotImplementedError()

...
from .base import LabelServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class LabelServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_label(self, request: label_service.GetLabelRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[label_service.GetLabelRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_label(self, response: label_service.Label) -> label_service.Label:
        ...
        """
        return response
    def pre_list_labels(self, request: label_service.ListLabelsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[label_service.ListLabelsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_labels(self, response: label_service.ListLabelsResponse) -> label_service.ListLabelsResponse:

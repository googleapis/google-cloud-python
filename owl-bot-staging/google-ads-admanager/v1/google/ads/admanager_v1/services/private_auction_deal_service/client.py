...
from .transports.base import PrivateAuctionDealServiceTransport, DEFAULT_CLIENT_INFO
from .transports.rest import PrivateAuctionDealServiceRestTransport


class PrivateAuctionDealServiceClientMeta(type):
    """Metaclass for the PrivateAuctionDealService client.
...
class PrivateAuctionDealServiceClient(metaclass=PrivateAuctionDealServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            PrivateAuctionDealServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> PrivateAuctionDealServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            PrivateAuctionDealServiceTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def placement_path(network_code: str,placement: str,) -> str:
        """Returns a fully-qualified placement string."""
        return "networks/{network_code}/placements/{placement}".format(network_code=network_code, placement=placement, )
    ...
    @staticmethod
    def private_auction_deal_path(network_code: str,private_auction_deal: str,) -> str:
        """Returns a fully-qualified private_auction_deal string."""
        return "networks/{network_code}/privateAuctionDeals/{private_auction_deal}".format(network_code=network_code, private_auction_deal=private_auction_deal, )
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = PrivateAuctionDealServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
        ...
        """Instantiates the private auction deal service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,PrivateAuctionDealServiceTransport,Callable[..., PrivateAuctionDealServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the PrivateAuctionDealServiceTransport constructor.
        ...
        self._client_cert_source = PrivateAuctionDealServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        ...
        transport_provided = isinstance(transport, PrivateAuctionDealServiceTransport)
    ...
    def get_private_auction_deal(self,
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.GetPrivateAuctionDealRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_private_auction_deal]
    ...
    def list_private_auction_deals(self,
        ...
        .. code-block:: python
            ...
            def sample_list_private_auction_deals():
                # Create a client
                client = admanager_v1.PrivateAuctionDealServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.ListPrivateAuctionDealsRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_private_auction_deals(request=request)
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.ListPrivateAuctionDealsRequest, dict]):
        ...
        Returns:
            google.ads.admanager_v1.services.private_auction_deal_service.pagers.ListPrivateAuctionDealsPager:
        ...
        response = pagers.ListPrivateAuctionDealsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def create_private_auction_deal(self,
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.CreatePrivateAuctionDealRequest, dict]):
            ...
            private_auction_deal (google.ads.admanager_v1.types.PrivateAuctionDeal):
                ...
                This corresponds to the ``private_auction_deal`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        if not isinstance(request, private_auction_deal_service.CreatePrivateAuctionDealRequest):
            ...
            if private_auction_deal is not None:
                request.private_auction_deal = private_auction_deal
    ...
    def update_private_auction_deal(self,
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.UpdatePrivateAuctionDealRequest, dict]):
                The request object. Request object for ``UpdatePrivateAuctionDeal`` method.
            private_auction_deal (google.ads.admanager_v1.types.PrivateAuctionDeal):
                Required. The ``PrivateAuctionDeal`` to update.

                The ``PrivateAuctionDeal``'s ``name`` is used to
                identify the ``PrivateAuctionDeal`` to update.
    ...
    def __enter__(self) -> "PrivateAuctionDealServiceClient":
        return self

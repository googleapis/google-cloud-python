...
from .base import PrivateAuctionDealServiceTransport, DEFAULT_CLIENT_INFO
...
class _BasePrivateAuctionDealServiceRestTransport(PrivateAuctionDealServiceTransport):
    """Base REST backend transport for PrivateAuctionDealService.
    ...
    class _BaseCreatePrivateAuctionDeal:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=networks/*}/privateAuctionDeals',
    ...
    class _BaseGetPrivateAuctionDeal:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1/{name=networks/*/privateAuctionDeals/*}',
            },
            ]
            return http_options
    ...
    class _BaseListPrivateAuctionDeals:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseUpdatePrivateAuctionDeal:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1/{private_auction_deal.name=networks/*/privateAuctionDeals/*}',
                'body': 'private_auction_deal',
            },
            ]
            return http_options

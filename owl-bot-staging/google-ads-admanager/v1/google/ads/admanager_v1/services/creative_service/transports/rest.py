...
from .base import CreativeServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class CreativeServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_creative(self, request: creative_service.GetCreativeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[creative_service.GetCreativeRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_creative(self, response: creative_service.Creative) -> creative_service.Creative:
        ...
        """
        return response
    def pre_list_creatives(self, request: creative_service.ListCreativesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[creative_service.ListCreativesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_creatives(self, response: creative_service.ListCreativesResponse) -> creative_service.ListCreativesResponse:
...
class CreativeServiceRestTransport(CreativeServiceTransport):
    ...
    @property
    def get_creative(self) -> Callable[
    ...
    @property
    def list_creatives(self) -> Callable[

...
class CompanyServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_company_with_metadata(self, response: company_messages.Company, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[company_messages.Company, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_company

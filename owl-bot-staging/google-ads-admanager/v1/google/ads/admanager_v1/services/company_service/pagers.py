...
class ListCompaniesPager:
    ...
    :class:`google.ads.admanager_v1.types.ListCompaniesResponse` object, and
    ...
    All the usual :class:`google.ads.admanager_v1.types.ListCompaniesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.ads.admanager_v1.types.ListCompaniesRequest):
    ...
    def __iter__(self) -> Iterator[company_messages.Company]:

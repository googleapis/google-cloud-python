...
from google.ads.admanager_v1.types import company_credit_status_enum
from google.ads.admanager_v1.types import company_messages
from google.ads.admanager_v1.types import company_service
from google.ads.admanager_v1.types import company_type_enum
...
class CompanyServiceClient(metaclass=CompanyServiceClientMeta):
    ...
    @staticmethod
    def company_path(network_code: str,company: str,) -> str:
        """Returns a fully-qualified company string."""
        return "networks/{network_code}/companies/{company}".format(network_code=network_code, company=company, )

    @staticmethod
    def parse_company_path(path: str) -> Dict[str,str]:
        """Parses a company path into its component segments."""
        m = re.match(r"^networks/(?P<network_code>.+?)/companies/(?P<company>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def contact_path(network_code: str,contact: str,) -> str:
        """Returns a fully-qualified contact string."""
        return "networks/{network_code}/contacts/{contact}".format(network_code=network_code, contact=contact, )

    @staticmethod
    def parse_contact_path(path: str) -> Dict[str,str]:
        """Parses a contact path into its component segments."""
        m = re.match(r"^networks/(?P<network_code>.+?)/contacts/(?P<contact>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def label_path(network_code: str,label: str,) -> str:
        """Returns a fully-qualified label string."""
        return "networks/{network_code}/labels/{label}".format(network_code=network_code, label=label, )
    ...
    @staticmethod
    def team_path(network_code: str,team: str,) -> str:
        """Returns a fully-qualified team string."""
        return "networks/{network_code}/teams/{team}".format(network_code=network_code, team=team, )
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.ads.admanager_v1.CompanyServiceClient`.",
                    extra = {
    ...
    def get_company(self,
        ...
        .. code-block:: python
            ...
            def sample_get_company():
                ...
                request = admanager_v1.GetCompanyRequest(
                    name="name_value",
                )
    ...
    def list_companies(self,
        ...
        .. code-block:: python
            ...
            def sample_list_companies():
                ...
                # Initialize request argument(s)
                request = admanager_v1.ListCompaniesRequest(
                    parent="parent_value",
                )

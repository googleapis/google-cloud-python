...
class OperatingSystemServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_operating_system(self, request: operating_system_service.GetOperatingSystemRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operating_system_service.GetOperatingSystemRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_operating_system_with_metadata(self, response: operating_system_messages.OperatingSystem, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operating_system_messages.OperatingSystem, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_operating_system
    ...
    def pre_list_operating_systems(self, request: operating_system_service.ListOperatingSystemsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operating_system_service.ListOperatingSystemsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_operating_systems(self, response: operating_system_service.ListOperatingSystemsResponse) -> operating_system_service.ListOperatingSystemsResponse:
    ...
    def post_list_operating_systems_with_metadata(self, response: operating_system_service.ListOperatingSystemsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operating_system_service.ListOperatingSystemsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_operating_systems
...
class OperatingSystemServiceRestTransport(_BaseOperatingSystemServiceRestTransport):
    ...
    class _GetOperatingSystem(_BaseOperatingSystemServiceRestTransport._BaseGetOperatingSystem, OperatingSystemServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OperatingSystemServiceRestTransport._GetOperatingSystem._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperatingSystems(_BaseOperatingSystemServiceRestTransport._BaseListOperatingSystems, OperatingSystemServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OperatingSystemServiceRestTransport._ListOperatingSystems._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseOperatingSystemServiceRestTransport._BaseGetOperation, OperatingSystemServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OperatingSystemServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

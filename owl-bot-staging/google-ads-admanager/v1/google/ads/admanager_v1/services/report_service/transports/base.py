...
class ReportServiceTransport(abc.ABC):
    ...
    @property
    def get_report(self) -> Callable[
            [report_service.GetReportRequest],
            Union[
                report_messages.Report,
                Awaitable[report_messages.Report]
            ]]:
        raise NotImplementedError()

    @property
    def list_reports(self) -> Callable[
    ...
    @property
    def create_report(self) -> Callable[
    ...
    @property
    def update_report(self) -> Callable[
    ...
    @property
    def fetch_report_result_rows(self) -> Callable[

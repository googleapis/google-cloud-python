...
class ReportServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_export_saved_report(self, request: report_service.ExportSavedReportRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[report_service.ExportSavedReportRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_export_saved_report(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
...
class ReportServiceRestTransport(ReportServiceTransport):
    ...
    class _ExportSavedReport(ReportServiceRestStub):
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_export_saved_report(request, metadata)

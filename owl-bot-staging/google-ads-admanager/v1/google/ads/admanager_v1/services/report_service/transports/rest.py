...
class ReportServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_report(self, request: report_service.CreateReportRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_service.CreateReportRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_report(self, response: report_service.Report) -> report_service.Report:
    ...
    def post_create_report_with_metadata(self, response: report_service.Report, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_service.Report, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_report
    ...
    def pre_fetch_report_result_rows(self, request: report_service.FetchReportResultRowsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_service.FetchReportResultRowsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_fetch_report_result_rows_with_metadata(self, response: report_service.FetchReportResultRowsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_service.FetchReportResultRowsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for fetch_report_result_rows
    ...
    def pre_get_report(self, request: report_service.GetReportRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_service.GetReportRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_report_with_metadata(self, response: report_service.Report, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_service.Report, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_report
    ...
    def pre_list_reports(self, request: report_service.ListReportsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_service.ListReportsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_reports_with_metadata(self, response: report_service.ListReportsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_service.ListReportsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_reports
    ...
    def pre_run_report(self, request: report_service.RunReportRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_service.RunReportRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_run_report_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for run_report
    ...
    def pre_update_report(self, request: report_service.UpdateReportRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_service.UpdateReportRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_report(self, response: report_service.Report) -> report_service.Report:
    ...
    def post_update_report_with_metadata(self, response: report_service.Report, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_service.Report, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_report
...
class ReportServiceRestTransport(_BaseReportServiceRestTransport):
    ...
    class _CreateReport(_BaseReportServiceRestTransport._BaseCreateReport, ReportServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReportServiceRestTransport._CreateReport._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _FetchReportResultRows(_BaseReportServiceRestTransport._BaseFetchReportResultRows, ReportServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReportServiceRestTransport._FetchReportResultRows._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetReport(_BaseReportServiceRestTransport._BaseGetReport, ReportServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReportServiceRestTransport._GetReport._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListReports(_BaseReportServiceRestTransport._BaseListReports, ReportServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReportServiceRestTransport._ListReports._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RunReport(_BaseReportServiceRestTransport._BaseRunReport, ReportServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReportServiceRestTransport._RunReport._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateReport(_BaseReportServiceRestTransport._BaseUpdateReport, ReportServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReportServiceRestTransport._UpdateReport._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseReportServiceRestTransport._BaseGetOperation, ReportServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ReportServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

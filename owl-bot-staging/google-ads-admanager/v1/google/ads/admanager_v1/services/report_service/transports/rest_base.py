...
class _BaseReportServiceRestTransport(ReportServiceTransport):
    ...
    class _BaseCreateReport:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseReportServiceRestTransport._BaseCreateReport._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseFetchReportResultRows:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseGetReport:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseReportServiceRestTransport._BaseGetReport._get_unset_required_fields(query_params))
    ...
    class _BaseListReports:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseReportServiceRestTransport._BaseListReports._get_unset_required_fields(query_params))
    ...
    class _BaseRunReport:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseReportServiceRestTransport._BaseRunReport._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseUpdateReport:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseReportServiceRestTransport._BaseUpdateReport._get_unset_required_fields(query_params))

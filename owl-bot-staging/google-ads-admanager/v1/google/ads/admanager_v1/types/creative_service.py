...
from google.ads.admanager_v1.types import ad_partner_declaration as gaa_ad_partner_declaration
...
class Creative(proto.Message):
    ...
    ad_partner_declaration: gaa_ad_partner_declaration.AdPartnerDeclaration = proto.Field(
        proto.MESSAGE,
        number=6,

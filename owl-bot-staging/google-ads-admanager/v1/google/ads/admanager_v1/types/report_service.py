...
class FetchReportResultRowsResponse(proto.Message):
    ...
    date_ranges: MutableSequence['Report.DateRange.FixedDateRange'] = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
        message='Report.DateRange.FixedDateRange',
    )
    comparison_date_ranges: MutableSequence['Report.DateRange.FixedDateRange'] = proto.RepeatedField(
        proto.MESSAGE,
        number=4,
        message='Report.DateRange.FixedDateRange',
    )

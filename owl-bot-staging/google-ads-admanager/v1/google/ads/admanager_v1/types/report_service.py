...
class FetchReportResultRowsResponse(proto.Message):
    ...
    date_ranges: MutableSequence[report_messages.Report.DateRange.FixedDateRange] = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
        message=report_messages.Report.DateRange.FixedDateRange,
    )
    comparison_date_ranges: MutableSequence[report_messages.Report.DateRange.FixedDateRange] = proto.RepeatedField(
        proto.MESSAGE,
        number=4,
        message=report_messages.Report.DateRange.FixedDateRange,
    )

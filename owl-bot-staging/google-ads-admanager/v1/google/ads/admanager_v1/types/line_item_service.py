...
class LineItem(proto.Message):
    ...
    delivery_rate_type: line_item_enums.DeliveryRateTypeEnum.DeliveryRateType = proto.Field(
        proto.ENUM,
        number=23,
    ...
    discount_type: line_item_enums.LineItemDiscountTypeEnum.LineItemDiscountType = proto.Field(
        proto.ENUM,
        number=24,
    ...
    reservation_status: line_item_enums.ReservationStatusEnum.ReservationStatus = proto.Field(
        proto.ENUM,
        number=26,
    ...
    creative_placeholders: MutableSequence[creative_placeholder.CreativePlaceholder] = proto.RepeatedField(
        proto.MESSAGE,
        number=27,

...
class Report(proto.Message):
    ...
    class DataTable(proto.Message):
        ...
        class Row(proto.Message):
            ...
            metric_value_groups: MutableSequence['Report.DataTable.MetricValueGroup'] = proto.RepeatedField(
                proto.MESSAGE,
                number=2,
        ...
        class MetricValueGroup(proto.Message):
            ...
            primary_percent_of_total_values: MutableSequence['Report.Value'] = proto.RepeatedField(
                proto.MESSAGE,
                number=2,
                message='Report.Value',
            )
            ...
            comparison_percent_of_total_values: MutableSequence['Report.Value'] = proto.RepeatedField(
                proto.MESSAGE,
                number=4,
                message='Report.Value',
            )
            absolute_change_values: MutableSequence['Report.Value'] = proto.RepeatedField(
                proto.MESSAGE,
                number=5,
                message='Report.Value',
            )
            relative_change_values: MutableSequence['Report.Value'] = proto.RepeatedField(
                proto.MESSAGE,
                number=6,
                message='Report.Value',
            )

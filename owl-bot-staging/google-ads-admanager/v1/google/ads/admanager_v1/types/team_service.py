...
class ListTeamsRequest(proto.Message):
    ...
    Attributes:
        ...
        page_size (int):
            Optional. The maximum number of Teams to
            return. The service may return fewer than this
            value. If unspecified, at most 50 teams will be
...
class ListTeamsResponse(proto.Message):
    r"""Response object for ListTeamsRequest containing matching Team
    resources.
    ...
    Attributes:
        ...
        next_page_token (str):
            ...
            pages.
        total_size (int):
            Total number of Teams. If a filter was included in the
    ...
    teams: MutableSequence['Team'] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message='Team',
    )

...
from google.ads.admanager_v1.services.entity_signals_mapping_service import EntitySignalsMappingServiceClient
from google.ads.admanager_v1.services.entity_signals_mapping_service import pagers
from google.ads.admanager_v1.services.entity_signals_mapping_service import transports
from google.ads.admanager_v1.types import entity_signals_mapping_messages
from google.ads.admanager_v1.types import entity_signals_mapping_service
...
@mock.patch.object(EntitySignalsMappingServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EntitySignalsMappingServiceClient))
def test__get_api_endpoint():
    ...
    assert EntitySignalsMappingServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == EntitySignalsMappingServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EntitySignalsMappingServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert EntitySignalsMappingServiceClient._get_api_endpoint(None, None, default_universe, "always") == EntitySignalsMappingServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EntitySignalsMappingServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EntitySignalsMappingServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_get_entity_signals_mapping_rest_required_fields(request_type=entity_signals_mapping_service.GetEntitySignalsMappingRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_entity_signals_mapping._get_unset_required_fields(jsonified_request)
...
def test_list_entity_signals_mappings_rest_required_fields(request_type=entity_signals_mapping_service.ListEntitySignalsMappingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_entity_signals_mappings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_entity_signals_mappings_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, entity_signals_mapping_messages.EntitySignalsMapping)
                for i in results)
...
def test_create_entity_signals_mapping_rest_required_fields(request_type=entity_signals_mapping_service.CreateEntitySignalsMappingRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_entity_signals_mapping._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_entity_signals_mapping_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "entitySignalsMapping", )))
...
def test_update_entity_signals_mapping_rest_required_fields(request_type=entity_signals_mapping_service.UpdateEntitySignalsMappingRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_entity_signals_mapping._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_entity_signals_mapping_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("entitySignalsMapping", "updateMask", )))
...
def test_batch_create_entity_signals_mappings_rest_required_fields(request_type=entity_signals_mapping_service.BatchCreateEntitySignalsMappingsRequest):
    transport_class = transports.EntitySignalsMappingServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_create_entity_signals_mappings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_entity_signals_mappings_rest_required_fields(request_type=entity_signals_mapping_service.BatchUpdateEntitySignalsMappingsRequest):
    transport_class = transports.EntitySignalsMappingServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_update_entity_signals_mappings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_entity_signals_mappings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            parent='parent_value',
            requests=[entity_signals_mapping_service.UpdateEntitySignalsMappingRequest(entity_signals_mapping=entity_signals_mapping_messages.EntitySignalsMapping(audience_segment_id=1980))],
        )
        mock_args.update(sample_request)
...
def test_get_entity_signals_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_get_entity_signals_mapping") as post, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_get_entity_signals_mapping_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "pre_get_entity_signals_mapping") as pre:
        ...
        client.get_entity_signals_mapping(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_entity_signals_mappings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_list_entity_signals_mappings") as post, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_list_entity_signals_mappings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "pre_list_entity_signals_mappings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = entity_signals_mapping_service.ListEntitySignalsMappingsRequest.pb(entity_signals_mapping_service.ListEntitySignalsMappingsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = entity_signals_mapping_service.ListEntitySignalsMappingsResponse.to_json(entity_signals_mapping_service.ListEntitySignalsMappingsResponse())
        req.return_value.content = return_value
        ...
        client.list_entity_signals_mappings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_entity_signals_mapping_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'networks/sample1'}
    request_init["entity_signals_mapping"] = {'audience_segment_id': 1980, 'content_bundle_id': 1792, 'custom_targeting_value_id': 2663, 'name': 'name_value', 'entity_signals_mapping_id': 2660, 'taxonomy_category_ids': [2268, 2269]}
...
def test_create_entity_signals_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_create_entity_signals_mapping") as post, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_create_entity_signals_mapping_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "pre_create_entity_signals_mapping") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = entity_signals_mapping_service.CreateEntitySignalsMappingRequest.pb(entity_signals_mapping_service.CreateEntitySignalsMappingRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_entity_signals_mapping(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_entity_signals_mapping_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'entity_signals_mapping': {'name': 'networks/sample1/entitySignalsMappings/sample2'}}
    request_init["entity_signals_mapping"] = {'audience_segment_id': 1980, 'content_bundle_id': 1792, 'custom_targeting_value_id': 2663, 'name': 'networks/sample1/entitySignalsMappings/sample2', 'entity_signals_mapping_id': 2660, 'taxonomy_category_ids': [2268, 2269]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_entity_signals_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_update_entity_signals_mapping") as post, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_update_entity_signals_mapping_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "pre_update_entity_signals_mapping") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = entity_signals_mapping_service.UpdateEntitySignalsMappingRequest.pb(entity_signals_mapping_service.UpdateEntitySignalsMappingRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_entity_signals_mapping(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_batch_create_entity_signals_mappings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_batch_create_entity_signals_mappings") as post, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_batch_create_entity_signals_mappings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "pre_batch_create_entity_signals_mappings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = entity_signals_mapping_service.BatchCreateEntitySignalsMappingsRequest.pb(entity_signals_mapping_service.BatchCreateEntitySignalsMappingsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = entity_signals_mapping_service.BatchCreateEntitySignalsMappingsResponse.to_json(entity_signals_mapping_service.BatchCreateEntitySignalsMappingsResponse())
        req.return_value.content = return_value
        ...
        client.batch_create_entity_signals_mappings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_batch_update_entity_signals_mappings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_batch_update_entity_signals_mappings") as post, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "post_batch_update_entity_signals_mappings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EntitySignalsMappingServiceRestInterceptor, "pre_batch_update_entity_signals_mappings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = entity_signals_mapping_service.BatchUpdateEntitySignalsMappingsRequest.pb(entity_signals_mapping_service.BatchUpdateEntitySignalsMappingsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = entity_signals_mapping_service.BatchUpdateEntitySignalsMappingsResponse.to_json(entity_signals_mapping_service.BatchUpdateEntitySignalsMappingsResponse())
        req.return_value.content = return_value
        ...
        client.batch_update_entity_signals_mappings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_entity_signals_mapping_empty_call_rest():
    ...
    with mock.patch.object(
            type(client.transport.get_entity_signals_mapping),
            '__call__') as call:
...
def test_list_entity_signals_mappings_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_entity_signals_mappings),
            '__call__') as call:
...
def test_create_entity_signals_mapping_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.create_entity_signals_mapping),
            '__call__') as call:
...
def test_update_entity_signals_mapping_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.update_entity_signals_mapping),
            '__call__') as call:
...
def test_batch_create_entity_signals_mappings_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_create_entity_signals_mappings),
            '__call__') as call:
...
def test_batch_update_entity_signals_mappings_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_update_entity_signals_mappings),
            '__call__') as call:
...
def test_entity_signals_mapping_service_base_transport():
    ...
    with mock.patch('google.ads.admanager_v1.services.entity_signals_mapping_service.transports.EntitySignalsMappingServiceTransport.__init__') as Transport:
...
def test_entity_signals_mapping_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.admanager_v1.services.entity_signals_mapping_service.transports.EntitySignalsMappingServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_entity_signals_mapping_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.admanager_v1.services.entity_signals_mapping_service.transports.EntitySignalsMappingServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EntitySignalsMappingServiceTransport()
        adc.assert_called_once()
...
def test_entity_signals_mapping_path():
    ...
    expected = "networks/{network_code}/entitySignalsMappings/{entity_signals_mapping}".format(network_code=network_code, entity_signals_mapping=entity_signals_mapping, )

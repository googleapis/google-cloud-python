...
def test_get_entity_signals_mapping_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = entity_signals_mapping_messages.EntitySignalsMapping.to_json(entity_signals_mapping_messages.EntitySignalsMapping())
...
def test_get_entity_signals_mapping_rest_bad_request(transport: str = 'rest', request_type=entity_signals_mapping_service.GetEntitySignalsMappingRequest):
    client = EntitySignalsMappingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_entity_signals_mappings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = entity_signals_mapping_service.ListEntitySignalsMappingsResponse.to_json(entity_signals_mapping_service.ListEntitySignalsMappingsResponse())
...
def test_list_entity_signals_mappings_rest_bad_request(transport: str = 'rest', request_type=entity_signals_mapping_service.ListEntitySignalsMappingsRequest):
    client = EntitySignalsMappingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_entity_signals_mapping_rest_bad_request(transport: str = 'rest', request_type=entity_signals_mapping_service.CreateEntitySignalsMappingRequest):
    client = EntitySignalsMappingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_entity_signals_mapping_rest_bad_request(transport: str = 'rest', request_type=entity_signals_mapping_service.UpdateEntitySignalsMappingRequest):
    client = EntitySignalsMappingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_create_entity_signals_mappings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = entity_signals_mapping_service.BatchCreateEntitySignalsMappingsResponse.to_json(entity_signals_mapping_service.BatchCreateEntitySignalsMappingsResponse())
...
def test_batch_create_entity_signals_mappings_rest_bad_request(transport: str = 'rest', request_type=entity_signals_mapping_service.BatchCreateEntitySignalsMappingsRequest):
    client = EntitySignalsMappingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_update_entity_signals_mappings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = entity_signals_mapping_service.BatchUpdateEntitySignalsMappingsResponse.to_json(entity_signals_mapping_service.BatchUpdateEntitySignalsMappingsResponse())
...
def test_batch_update_entity_signals_mappings_rest_bad_request(transport: str = 'rest', request_type=entity_signals_mapping_service.BatchUpdateEntitySignalsMappingsRequest):
    client = EntitySignalsMappingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

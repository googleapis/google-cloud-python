...
from google.ads.admanager_v1.services.custom_targeting_key_service import CustomTargetingKeyServiceClient
from google.ads.admanager_v1.services.custom_targeting_key_service import pagers
from google.ads.admanager_v1.services.custom_targeting_key_service import transports
...
def test__get_api_endpoint():
    ...
    assert CustomTargetingKeyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CustomTargetingKeyServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CustomTargetingKeyServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CustomTargetingKeyServiceClient._get_api_endpoint(None, None, default_universe, "always") == CustomTargetingKeyServiceClient.DEFAULT_MTLS_ENDPOINT
    assert CustomTargetingKeyServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CustomTargetingKeyServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_get_custom_targeting_key_rest_required_fields(request_type=custom_targeting_key_service.GetCustomTargetingKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_custom_targeting_key._get_unset_required_fields(jsonified_request)
...
def test_get_custom_targeting_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.CustomTargetingKeyServiceRestInterceptor, "post_get_custom_targeting_key") as post, \
         mock.patch.object(transports.CustomTargetingKeyServiceRestInterceptor, "pre_get_custom_targeting_key") as pre:
        ...
        req.return_value._content = custom_targeting_key_messages.CustomTargetingKey.to_json(custom_targeting_key_messages.CustomTargetingKey())
        ...
        client.get_custom_targeting_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_custom_targeting_key_rest_bad_request(transport: str = 'rest', request_type=custom_targeting_key_service.GetCustomTargetingKeyRequest):
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_custom_targeting_keys_rest_required_fields(request_type=custom_targeting_key_service.ListCustomTargetingKeysRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_custom_targeting_keys._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_custom_targeting_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CustomTargetingKeyServiceRestInterceptor, "post_list_custom_targeting_keys") as post, \
         mock.patch.object(transports.CustomTargetingKeyServiceRestInterceptor, "pre_list_custom_targeting_keys") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = custom_targeting_key_service.ListCustomTargetingKeysResponse.to_json(custom_targeting_key_service.ListCustomTargetingKeysResponse())
        ...
        client.list_custom_targeting_keys(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_custom_targeting_keys_rest_bad_request(transport: str = 'rest', request_type=custom_targeting_key_service.ListCustomTargetingKeysRequest):
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_custom_targeting_keys_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, custom_targeting_key_messages.CustomTargetingKey)
                for i in results)
...
def test_custom_targeting_key_service_base_transport():
    ...
    with mock.patch('google.ads.admanager_v1.services.custom_targeting_key_service.transports.CustomTargetingKeyServiceTransport.__init__') as Transport:
...
def test_custom_targeting_key_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.admanager_v1.services.custom_targeting_key_service.transports.CustomTargetingKeyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_custom_targeting_key_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.admanager_v1.services.custom_targeting_key_service.transports.CustomTargetingKeyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CustomTargetingKeyServiceTransport()
        adc.assert_called_once()

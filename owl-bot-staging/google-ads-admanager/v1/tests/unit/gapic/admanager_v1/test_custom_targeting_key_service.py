...
def test_get_custom_targeting_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = custom_targeting_key_service.CustomTargetingKey.to_json(custom_targeting_key_service.CustomTargetingKey())
...
def test_list_custom_targeting_keys_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, custom_targeting_key_service.CustomTargetingKey)
                for i in results)

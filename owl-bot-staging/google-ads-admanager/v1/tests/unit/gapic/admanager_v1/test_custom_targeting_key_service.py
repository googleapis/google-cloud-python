...
def test_get_custom_targeting_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CustomTargetingKeyServiceRestInterceptor, "post_get_custom_targeting_key_with_metadata") as post_with_metadata, \
...
def test_list_custom_targeting_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CustomTargetingKeyServiceRestInterceptor, "post_list_custom_targeting_keys_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = custom_targeting_key_service.ListCustomTargetingKeysResponse.to_json(custom_targeting_key_service.ListCustomTargetingKeysResponse())
        req.return_value.content = return_value
...
def test_get_custom_targeting_key_empty_call_rest():
    ...
    with mock.patch.object(
            type(client.transport.get_custom_targeting_key),
            '__call__') as call:
...
def test_list_custom_targeting_keys_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_custom_targeting_keys),
            '__call__') as call:

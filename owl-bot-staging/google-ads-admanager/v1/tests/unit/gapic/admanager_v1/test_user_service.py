...
def test_get_user_rest_bad_request(request_type=user_service.GetUserRequest):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = user_messages.User.to_json(user_messages.User())
...
def test_get_user_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        request_msg = user_service.GetUserRequest()

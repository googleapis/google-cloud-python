...
from google.ads.admanager_v1.services.ad_unit_service import AdUnitServiceClient
from google.ads.admanager_v1.services.ad_unit_service import pagers
from google.ads.admanager_v1.services.ad_unit_service import transports
...
def test__get_api_endpoint():
    ...
    assert AdUnitServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AdUnitServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_get_ad_unit_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.AdUnitServiceRestInterceptor, "post_get_ad_unit") as post, \
         mock.patch.object(transports.AdUnitServiceRestInterceptor, "pre_get_ad_unit") as pre:
        ...
        req.return_value._content = ad_unit_messages.AdUnit.to_json(ad_unit_messages.AdUnit())
        ...
        client.get_ad_unit(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_ad_unit_rest_bad_request(transport: str = 'rest', request_type=ad_unit_service.GetAdUnitRequest):
    client = AdUnitServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_ad_units_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AdUnitServiceRestInterceptor, "post_list_ad_units") as post, \
         mock.patch.object(transports.AdUnitServiceRestInterceptor, "pre_list_ad_units") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = ad_unit_service.ListAdUnitsResponse.to_json(ad_unit_service.ListAdUnitsResponse())
        ...
        client.list_ad_units(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_ad_units_rest_bad_request(transport: str = 'rest', request_type=ad_unit_service.ListAdUnitsRequest):
    client = AdUnitServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_ad_units_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, ad_unit_messages.AdUnit)
                for i in results)
...
def test_list_ad_unit_sizes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AdUnitServiceRestInterceptor, "post_list_ad_unit_sizes") as post, \
         mock.patch.object(transports.AdUnitServiceRestInterceptor, "pre_list_ad_unit_sizes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = ad_unit_service.ListAdUnitSizesResponse.to_json(ad_unit_service.ListAdUnitSizesResponse())
        ...
        client.list_ad_unit_sizes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_ad_unit_sizes_rest_bad_request(transport: str = 'rest', request_type=ad_unit_service.ListAdUnitSizesRequest):
    client = AdUnitServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_ad_unit_sizes_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, ad_unit_messages.AdUnitSize)
                for i in results)
...
def test_ad_unit_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.admanager_v1.services.ad_unit_service.transports.AdUnitServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_ad_unit_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.admanager_v1.services.ad_unit_service.transports.AdUnitServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AdUnitServiceTransport()
        adc.assert_called_once()

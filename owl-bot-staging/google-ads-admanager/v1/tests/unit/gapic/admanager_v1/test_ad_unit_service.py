...
def test_get_ad_unit_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AdUnitServiceRestInterceptor, "post_get_ad_unit_with_metadata") as post_with_metadata, \
...
def test_list_ad_units_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AdUnitServiceRestInterceptor, "post_list_ad_units_with_metadata") as post_with_metadata, \
...
def test_list_ad_unit_sizes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AdUnitServiceRestInterceptor, "post_list_ad_unit_sizes_with_metadata") as post_with_metadata, \
...
def test_get_ad_unit_empty_call_rest():
    ...
    with mock.patch.object(
            type(client.transport.get_ad_unit),
            '__call__') as call:
...
def test_list_ad_units_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_ad_units),
            '__call__') as call:
...
def test_list_ad_unit_sizes_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_ad_unit_sizes),
            '__call__') as call:

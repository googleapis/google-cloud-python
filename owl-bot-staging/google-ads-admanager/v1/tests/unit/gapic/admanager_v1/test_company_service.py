...
from google.ads.admanager_v1.services.company_service import CompanyServiceClient
from google.ads.admanager_v1.services.company_service import pagers
from google.ads.admanager_v1.services.company_service import transports
...
def test_company_service_client_get_transport_class():
    ...
    assert transport == transports.CompanyServiceRestTransport
...
def test_get_company_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{name=networks/*/companies/*}" % client.transport._host, args[1])
...
def test_list_companies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=networks/*}/companies" % client.transport._host, args[1])
...
def test_list_companies_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, company_messages.Company)
                for i in results)
...
def test_get_company_rest_bad_request(request_type=company_service.GetCompanyRequest):
    ...
    request_init = {'name': 'networks/sample1/companies/sample2'}
    request = request_type(**request_init)
...
def test_get_company_rest_call_success(request_type):
    ...
    assert response.credit_status == company_credit_status_enum.CompanyCreditStatusEnum.CompanyCreditStatus.ACTIVE
...
def test_get_company_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = company_messages.Company.to_json(company_messages.Company())
        ...
        post_with_metadata.return_value = company_messages.Company(), metadata
...
def test_company_service_base_transport():
    ...
    with mock.patch('google.ads.admanager_v1.services.company_service.transports.CompanyServiceTransport.__init__') as Transport:
...
def test_company_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.admanager_v1.services.company_service.transports.CompanyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_company_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.admanager_v1.services.company_service.transports.CompanyServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CompanyServiceTransport()
        adc.assert_called_once()
...
def test_company_path():
    network_code = "squid"
    company = "clam"
    expected = "networks/{network_code}/companies/{company}".format(network_code=network_code, company=company, )
    actual = CompanyServiceClient.company_path(network_code, company)
...
def test_contact_path():
    network_code = "oyster"
    contact = "nudibranch"
    expected = "networks/{network_code}/contacts/{contact}".format(network_code=network_code, contact=contact, )
    actual = CompanyServiceClient.contact_path(network_code, contact)
    assert expected == actual
...
def test_parse_contact_path():
    ...
    path = CompanyServiceClient.contact_path(**expected)

    # Check that the path construction is reversible.
    actual = CompanyServiceClient.parse_contact_path(path)
    assert expected == actual

def test_label_path():
    network_code = "winkle"
    label = "nautilus"
    expected = "networks/{network_code}/labels/{label}".format(network_code=network_code, label=label, )
    actual = CompanyServiceClient.label_path(network_code, label)
    assert expected == actual
...
def test_parse_label_path():
    ...
    path = CompanyServiceClient.label_path(**expected)

    # Check that the path construction is reversible.
    actual = CompanyServiceClient.parse_label_path(path)
    assert expected == actual

def test_network_path():
    network_code = "squid"
    expected = "networks/{network_code}".format(network_code=network_code, )
    actual = CompanyServiceClient.network_path(network_code)
    assert expected == actual
...
def test_parse_network_path():
    ...
    path = CompanyServiceClient.network_path(**expected)

    # Check that the path construction is reversible.
    actual = CompanyServiceClient.parse_network_path(path)
    assert expected == actual

def test_team_path():
    network_code = "whelk"
    team = "octopus"
    expected = "networks/{network_code}/teams/{team}".format(network_code=network_code, team=team, )
    actual = CompanyServiceClient.team_path(network_code, team)
    assert expected == actual
...
def test_parse_team_path():
    ...
    path = CompanyServiceClient.team_path(**expected)

    # Check that the path construction is reversible.
    actual = CompanyServiceClient.parse_team_path(path)
    assert expected == actual
...
@pytest.mark.parametrize("client_class,transport_class", [
    (CompanyServiceClient, transports.CompanyServiceRestTransport),
])

...
def test_get_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = report_service.Report.to_json(report_service.Report())
...
def test_get_report_rest_bad_request(transport: str = 'rest', request_type=report_service.GetReportRequest):
    client = ReportServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_reports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = report_service.ListReportsResponse.to_json(report_service.ListReportsResponse())
...
def test_list_reports_rest_bad_request(transport: str = 'rest', request_type=report_service.ListReportsRequest):
    client = ReportServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_reports_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, report_service.Report)
                for i in results)
...
def test_create_report_rest_bad_request(transport: str = 'rest', request_type=report_service.CreateReportRequest):
    client = ReportServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_report_rest_bad_request(transport: str = 'rest', request_type=report_service.UpdateReportRequest):
    client = ReportServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_run_report_rest_bad_request(transport: str = 'rest', request_type=report_service.RunReportRequest):
    client = ReportServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_report_result_rows_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = report_service.FetchReportResultRowsResponse.to_json(report_service.FetchReportResultRowsResponse())
...
def test_fetch_report_result_rows_rest_bad_request(transport: str = 'rest', request_type=report_service.FetchReportResultRowsRequest):
    client = ReportServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_report_result_rows_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, report_service.Report.DataTable.Row)
                for i in results)

...
from google.ads.admanager_v1.services.private_auction_deal_service import PrivateAuctionDealServiceClient
from google.ads.admanager_v1.services.private_auction_deal_service import pagers
from google.ads.admanager_v1.services.private_auction_deal_service import transports
...
from google.ads.admanager_v1.types import targeting
...
def test__get_api_endpoint():
    ...
    assert PrivateAuctionDealServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == PrivateAuctionDealServiceClient.DEFAULT_MTLS_ENDPOINT
    assert PrivateAuctionDealServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert PrivateAuctionDealServiceClient._get_api_endpoint(None, None, default_universe, "always") == PrivateAuctionDealServiceClient.DEFAULT_MTLS_ENDPOINT
    assert PrivateAuctionDealServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == PrivateAuctionDealServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_get_private_auction_deal_rest_required_fields(request_type=private_auction_deal_service.GetPrivateAuctionDealRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_private_auction_deal._get_unset_required_fields(jsonified_request)
...
def test_list_private_auction_deals_rest_required_fields(request_type=private_auction_deal_service.ListPrivateAuctionDealsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_private_auction_deals._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_private_auction_deals_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, private_auction_deal_messages.PrivateAuctionDeal)
                for i in results)
...
def test_create_private_auction_deal_rest_required_fields(request_type=private_auction_deal_service.CreatePrivateAuctionDealRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_private_auction_deal._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_private_auction_deal_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "privateAuctionDeal", )))
...
def test_update_private_auction_deal_rest_required_fields(request_type=private_auction_deal_service.UpdatePrivateAuctionDealRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_private_auction_deal._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_private_auction_deal_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("privateAuctionDeal", "updateMask", )))
...
def test_get_private_auction_deal_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "post_get_private_auction_deal") as post, \
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "post_get_private_auction_deal_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "pre_get_private_auction_deal") as pre:
        ...
        client.get_private_auction_deal(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_private_auction_deals_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "post_list_private_auction_deals") as post, \
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "post_list_private_auction_deals_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "pre_list_private_auction_deals") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = private_auction_deal_service.ListPrivateAuctionDealsResponse.to_json(private_auction_deal_service.ListPrivateAuctionDealsResponse())
        req.return_value.content = return_value
        ...
        client.list_private_auction_deals(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_private_auction_deal_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'networks/sample1'}
    request_init["private_auction_deal"] = {'name': 'name_value', 'private_auction_deal_id': 2414, 'private_auction_id': 1913, 'private_auction_display_name': 'private_auction_display_name_value', 'buyer_account_id': 1695, 'external_deal_id': 1668, 'targeting': {'geo_targeting': {'targeted_geos': ['targeted_geos_value1', 'targeted_geos_value2'], 'excluded_geos': ['excluded_geos_value1', 'excluded_geos_value2']}, 'technology_targeting': {'bandwidth_targeting': {'targeted_bandwidth_groups': ['targeted_bandwidth_groups_value1', 'targeted_bandwidth_groups_value2'], 'excluded_bandwidth_groups': ['excluded_bandwidth_groups_value1', 'excluded_bandwidth_groups_value2']}, 'device_category_targeting': {'targeted_categories': ['targeted_categories_value1', 'targeted_categories_value2'], 'excluded_categories': ['excluded_categories_value1', 'excluded_categories_value2']}, 'operating_system_targeting': {'targeted_operating_systems': ['targeted_operating_systems_value1', 'targeted_operating_systems_value2'], 'excluded_operating_systems': ['excluded_operating_systems_value1', 'excluded_operating_systems_value2'], 'targeted_operating_system_versions': ['targeted_operating_system_versions_value1', 'targeted_operating_system_versions_value2'], 'excluded_operating_system_versions': ['excluded_operating_system_versions_value1', 'excluded_operating_system_versions_value2']}}, 'inventory_targeting': {'targeted_ad_units': [{'include_descendants': True, 'ad_unit': 'ad_unit_value'}], 'excluded_ad_units': {}, 'targeted_placements': ['targeted_placements_value1', 'targeted_placements_value2']}, 'request_platform_targeting': {'request_platforms': [1]}, 'custom_targeting': {'custom_targeting_clauses': [{'custom_targeting_literals': [{'negative': True, 'custom_targeting_key': 'custom_targeting_key_value', 'custom_targeting_values': ['custom_targeting_values_value1', 'custom_targeting_values_value2']}]}]}, 'user_domain_targeting': {'targeted_user_domains': ['targeted_user_domains_value1', 'targeted_user_domains_value2'], 'excluded_user_domains': ['excluded_user_domains_value1', 'excluded_user_domains_value2']}, 'video_position_targeting': {'video_positions': [{'midroll_index': 1386, 'reverse_midroll_index': 2245, 'pod_position': 1303, 'position_type': 1, 'bumper_type': 1}]}, 'data_segment_targeting': {'has_data_segment_targeting': True}}, 'end_time': {'seconds': 751, 'nanos': 543}, 'floor_price': {'currency_code': 'currency_code_value', 'units': 563, 'nanos': 543}, 'creative_sizes': [{'width': 544, 'height': 633, 'size_type': 1}], 'status': 1, 'auction_priority_enabled': True, 'block_override_enabled': True, 'buyer_permission_type': 1, 'buyer_data': {'buyer_emails': ['buyer_emails_value1', 'buyer_emails_value2']}, 'create_time': {}, 'update_time': {}}
...
def test_create_private_auction_deal_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "post_create_private_auction_deal") as post, \
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "post_create_private_auction_deal_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "pre_create_private_auction_deal") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_private_auction_deal(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_private_auction_deal_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "post_update_private_auction_deal") as post, \
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "post_update_private_auction_deal_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PrivateAuctionDealServiceRestInterceptor, "pre_update_private_auction_deal") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_private_auction_deal(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_private_auction_deal_empty_call_rest():
    ...
    with mock.patch.object(
            type(client.transport.get_private_auction_deal),
            '__call__') as call:
...
def test_list_private_auction_deals_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.list_private_auction_deals),
            '__call__') as call:
...
def test_create_private_auction_deal_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.create_private_auction_deal),
            '__call__') as call:
...
def test_update_private_auction_deal_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
            type(client.transport.update_private_auction_deal),
            '__call__') as call:
...
def test_private_auction_deal_service_base_transport():
    ...
    with mock.patch('google.ads.admanager_v1.services.private_auction_deal_service.transports.PrivateAuctionDealServiceTransport.__init__') as Transport:
...
def test_private_auction_deal_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.admanager_v1.services.private_auction_deal_service.transports.PrivateAuctionDealServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_private_auction_deal_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.admanager_v1.services.private_auction_deal_service.transports.PrivateAuctionDealServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PrivateAuctionDealServiceTransport()
        adc.assert_called_once()
...
def test_private_auction_deal_path():
    ...
    expected = "networks/{network_code}/privateAuctionDeals/{private_auction_deal}".format(network_code=network_code, private_auction_deal=private_auction_deal, )

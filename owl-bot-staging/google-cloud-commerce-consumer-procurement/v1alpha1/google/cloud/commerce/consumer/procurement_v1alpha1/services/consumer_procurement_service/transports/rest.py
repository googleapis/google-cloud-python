...
from .base import ConsumerProcurementServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ConsumerProcurementServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_order(self, request: procurement_service.GetOrderRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[procurement_service.GetOrderRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_order(self, response: order.Order) -> order.Order:
        ...
        """
        return response
    def pre_list_orders(self, request: procurement_service.ListOrdersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[procurement_service.ListOrdersRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_orders(self, response: procurement_service.ListOrdersResponse) -> procurement_service.ListOrdersResponse:
        ...
        """
        return response
    def pre_place_order(self, request: procurement_service.PlaceOrderRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[procurement_service.PlaceOrderRequest, Sequence[Tuple[str, str]]]:

...
class ConsumerProcurementServiceClient(metaclass=ConsumerProcurementServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.commerce.consumer.procurement_v1alpha1.ConsumerProcurementServiceClient`.",
                    extra = {
    ...
    def place_order(self,
        ...
        Args:
            request (Union[google.cloud.commerce_consumer_procurement_v1alpha1.types.PlaceOrderRequest, dict]):
    ...
    def get_order(self,
        ...
        Args:
            request (Union[google.cloud.commerce_consumer_procurement_v1alpha1.types.GetOrderRequest, dict]):
                The request object. Request message for
    ...
    def list_orders(self,
        ...
        Args:
            request (Union[google.cloud.commerce_consumer_procurement_v1alpha1.types.ListOrdersRequest, dict]):
                The request object. Request message for

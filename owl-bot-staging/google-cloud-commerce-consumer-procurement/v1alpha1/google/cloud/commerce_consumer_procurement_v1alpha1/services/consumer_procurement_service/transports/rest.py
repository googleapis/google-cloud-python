...
class ConsumerProcurementServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_order(self, request: procurement_service.GetOrderRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[procurement_service.GetOrderRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_order_with_metadata(self, response: order.Order, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[order.Order, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_order
    ...
    def pre_list_orders(self, request: procurement_service.ListOrdersRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[procurement_service.ListOrdersRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_orders_with_metadata(self, response: procurement_service.ListOrdersResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[procurement_service.ListOrdersResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_orders
    ...
    def pre_place_order(self, request: procurement_service.PlaceOrderRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[procurement_service.PlaceOrderRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_place_order_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for place_order
...
class ConsumerProcurementServiceRestTransport(_BaseConsumerProcurementServiceRestTransport):
    ...
    class _GetOrder(_BaseConsumerProcurementServiceRestTransport._BaseGetOrder, ConsumerProcurementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ConsumerProcurementServiceRestTransport._GetOrder._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOrders(_BaseConsumerProcurementServiceRestTransport._BaseListOrders, ConsumerProcurementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ConsumerProcurementServiceRestTransport._ListOrders._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _PlaceOrder(_BaseConsumerProcurementServiceRestTransport._BasePlaceOrder, ConsumerProcurementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ConsumerProcurementServiceRestTransport._PlaceOrder._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseConsumerProcurementServiceRestTransport._BaseGetOperation, ConsumerProcurementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ConsumerProcurementServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

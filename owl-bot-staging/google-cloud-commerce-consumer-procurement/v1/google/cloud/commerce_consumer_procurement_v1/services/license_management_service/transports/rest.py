...
class LicenseManagementServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_assign(self, request: license_management_service.AssignRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[license_management_service.AssignRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_assign_with_metadata(self, response: license_management_service.AssignResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[license_management_service.AssignResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for assign
    ...
    def pre_enumerate_licensed_users(self, request: license_management_service.EnumerateLicensedUsersRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[license_management_service.EnumerateLicensedUsersRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_enumerate_licensed_users(self, response: license_management_service.EnumerateLicensedUsersResponse) -> license_management_service.EnumerateLicensedUsersResponse:
    ...
    def post_enumerate_licensed_users_with_metadata(self, response: license_management_service.EnumerateLicensedUsersResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[license_management_service.EnumerateLicensedUsersResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for enumerate_licensed_users
    ...
    def pre_get_license_pool(self, request: license_management_service.GetLicensePoolRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[license_management_service.GetLicensePoolRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_license_pool_with_metadata(self, response: license_management_service.LicensePool, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[license_management_service.LicensePool, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_license_pool
    ...
    def pre_unassign(self, request: license_management_service.UnassignRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[license_management_service.UnassignRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_unassign_with_metadata(self, response: license_management_service.UnassignResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[license_management_service.UnassignResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for unassign
    ...
    def pre_update_license_pool(self, request: license_management_service.UpdateLicensePoolRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[license_management_service.UpdateLicensePoolRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_license_pool_with_metadata(self, response: license_management_service.LicensePool, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[license_management_service.LicensePool, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_license_pool
...
class LicenseManagementServiceRestTransport(_BaseLicenseManagementServiceRestTransport):
    ...
    class _Assign(_BaseLicenseManagementServiceRestTransport._BaseAssign, LicenseManagementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LicenseManagementServiceRestTransport._Assign._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _EnumerateLicensedUsers(_BaseLicenseManagementServiceRestTransport._BaseEnumerateLicensedUsers, LicenseManagementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LicenseManagementServiceRestTransport._EnumerateLicensedUsers._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetLicensePool(_BaseLicenseManagementServiceRestTransport._BaseGetLicensePool, LicenseManagementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LicenseManagementServiceRestTransport._GetLicensePool._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Unassign(_BaseLicenseManagementServiceRestTransport._BaseUnassign, LicenseManagementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LicenseManagementServiceRestTransport._Unassign._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateLicensePool(_BaseLicenseManagementServiceRestTransport._BaseUpdateLicensePool, LicenseManagementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LicenseManagementServiceRestTransport._UpdateLicensePool._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def enumerate_licensed_users(self) -> Callable[
    ...
    @property
    def get_license_pool(self) -> Callable[
    ...
    @property
    def update_license_pool(self) -> Callable[
    ...
    class _GetOperation(_BaseLicenseManagementServiceRestTransport._BaseGetOperation, LicenseManagementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LicenseManagementServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
from .base import ConsumerProcurementServiceTransport, DEFAULT_CLIENT_INFO
...
class ConsumerProcurementServiceGrpcTransport(ConsumerProcurementServiceTransport):
    ...
    def place_order(self) -> Callable[
        ...
        if 'place_order' not in self._stubs:
            self._stubs['place_order'] = self._logged_channel.unary_unary(
    ...
    @property
    def modify_order(self) -> Callable[
        ...
        if 'modify_order' not in self._stubs:
            self._stubs['modify_order'] = self._logged_channel.unary_unary(
...
__all__ = (
    'ConsumerProcurementServiceGrpcTransport',
)

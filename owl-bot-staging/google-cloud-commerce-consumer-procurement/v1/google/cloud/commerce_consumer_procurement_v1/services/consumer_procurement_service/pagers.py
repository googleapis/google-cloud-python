...
class ListOrdersPager:
    ...
    :class:`google.cloud.commerce_consumer_procurement_v1.types.ListOrdersResponse` object, and
    ...
    All the usual :class:`google.cloud.commerce_consumer_procurement_v1.types.ListOrdersResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.commerce_consumer_procurement_v1.types.ListOrdersRequest):
                The initial request object.
            response (google.cloud.commerce_consumer_procurement_v1.types.ListOrdersResponse):

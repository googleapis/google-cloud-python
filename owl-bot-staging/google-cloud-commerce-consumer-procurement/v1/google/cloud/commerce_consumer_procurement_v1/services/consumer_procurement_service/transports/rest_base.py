...
class _BaseConsumerProcurementServiceRestTransport(ConsumerProcurementServiceTransport):
    """Base REST backend transport for ConsumerProcurementService.

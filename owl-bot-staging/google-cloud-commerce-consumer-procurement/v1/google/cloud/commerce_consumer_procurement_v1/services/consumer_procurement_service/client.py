...
from google.cloud.commerce_consumer_procurement_v1.services.consumer_procurement_service import pagers
from google.cloud.commerce_consumer_procurement_v1.types import order
from google.cloud.commerce_consumer_procurement_v1.types import procurement_service
from google.longrunning import operations_pb2 # type: ignore
from google.protobuf import timestamp_pb2  # type: ignore
from .transports.base import ConsumerProcurementServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import ConsumerProcurementServiceGrpcTransport
from .transports.grpc_asyncio import ConsumerProcurementServiceGrpcAsyncIOTransport
from .transports.rest import ConsumerProcurementServiceRestTransport


class ConsumerProcurementServiceClientMeta(type):
    """Metaclass for the ConsumerProcurementService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ConsumerProcurementServiceTransport]]
    _transport_registry["grpc"] = ConsumerProcurementServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = ConsumerProcurementServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = ConsumerProcurementServiceRestTransport
...
class ConsumerProcurementServiceClient(metaclass=ConsumerProcurementServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "cloudcommerceconsumerprocurement.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ConsumerProcurementServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ConsumerProcurementServiceTransport:
        ...
        Returns:
            ConsumerProcurementServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def offer_path(service: str,offer: str,) -> str:
        """Returns a fully-qualified offer string."""
        return "services/{service}/standardOffers/{offer}".format(service=service, offer=offer, )

    @staticmethod
    def parse_offer_path(path: str) -> Dict[str,str]:
        """Parses a offer path into its component segments."""
        m = re.match(r"^services/(?P<service>.+?)/standardOffers/(?P<offer>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def order_path(billing_account: str,order: str,) -> str:
        """Returns a fully-qualified order string."""
        return "billingAccounts/{billing_account}/orders/{order}".format(billing_account=billing_account, order=order, )

    @staticmethod
    def parse_order_path(path: str) -> Dict[str,str]:
        """Parses a order path into its component segments."""
        m = re.match(r"^billingAccounts/(?P<billing_account>.+?)/orders/(?P<order>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ConsumerProcurementServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ConsumerProcurementServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ConsumerProcurementServiceClient._DEFAULT_UNIVERSE
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = ConsumerProcurementServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ConsumerProcurementServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ConsumerProcurementServiceTransport, Callable[..., ConsumerProcurementServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ConsumerProcurementServiceClient._read_environment_variables()
        self._client_cert_source = ConsumerProcurementServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ConsumerProcurementServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ConsumerProcurementServiceTransport)
        if transport_provided:
            # transport is a ConsumerProcurementServiceTransport instance.
            ...
            self._transport = cast(ConsumerProcurementServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            ConsumerProcurementServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ConsumerProcurementServiceTransport], Callable[..., ConsumerProcurementServiceTransport]] = (
    ...
    def place_order(self,
        ...
        Args:
            request (Union[google.cloud.commerce_consumer_procurement_v1.types.PlaceOrderRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.place_order]
    ...
    def get_order(self,
        ...
        Args:
            request (Union[google.cloud.commerce_consumer_procurement_v1.types.GetOrderRequest, dict]):
                The request object. Request message for
    ...
    def list_orders(self,
        ...
        Args:
            request (Union[google.cloud.commerce_consumer_procurement_v1.types.ListOrdersRequest, dict]):
                The request object. Request message for

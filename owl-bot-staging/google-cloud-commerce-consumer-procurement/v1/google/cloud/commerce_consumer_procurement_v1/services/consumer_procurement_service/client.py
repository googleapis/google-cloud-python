...
class ConsumerProcurementServiceClient(metaclass=ConsumerProcurementServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ConsumerProcurementServiceTransport]] = None,
    ...
    def place_order(self,
        ...
        # in a procurement_service.PlaceOrderRequest.
    ...
    def get_order(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a procurement_service.GetOrderRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_orders(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a procurement_service.ListOrdersRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

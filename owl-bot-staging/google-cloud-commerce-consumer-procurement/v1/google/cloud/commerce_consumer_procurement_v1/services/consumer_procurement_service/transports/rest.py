...
class ConsumerProcurementServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_cancel_order(self, request: procurement_service.CancelOrderRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[procurement_service.CancelOrderRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_modify_order(self, request: procurement_service.ModifyOrderRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[procurement_service.ModifyOrderRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_modify_order_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for modify_order
...
class ConsumerProcurementServiceRestTransport(_BaseConsumerProcurementServiceRestTransport):
    ...
    class _CancelOrder(_BaseConsumerProcurementServiceRestTransport._BaseCancelOrder, ConsumerProcurementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ConsumerProcurementServiceRestTransport._CancelOrder._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ModifyOrder(_BaseConsumerProcurementServiceRestTransport._BaseModifyOrder, ConsumerProcurementServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ConsumerProcurementServiceRestTransport._ModifyOrder._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class ConsumerProcurementServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_cancel_order(self, request: procurement_service.CancelOrderRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[procurement_service.CancelOrderRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_modify_order(self, request: procurement_service.ModifyOrderRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[procurement_service.ModifyOrderRequest, Sequence[Tuple[str, str]]]:

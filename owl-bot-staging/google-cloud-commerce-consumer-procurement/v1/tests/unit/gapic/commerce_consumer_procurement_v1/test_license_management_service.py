...
def test_update_license_pool_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'license_pool': {'name': 'billingAccounts/sample1/orders/sample2/licensePool'}}
    request_init["license_pool"] = {'name': 'billingAccounts/sample1/orders/sample2/licensePool', 'license_assignment_protocol': {'manual_assignment_type': {}, 'auto_assignment_type': {'inactive_license_ttl': {'seconds': 751, 'nanos': 543}}}, 'available_license_count': 2411, 'total_license_count': 2030}

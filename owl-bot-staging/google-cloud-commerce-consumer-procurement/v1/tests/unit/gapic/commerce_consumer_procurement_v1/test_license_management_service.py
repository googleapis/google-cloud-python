...
def test_get_license_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_get_license_pool_with_metadata") as post_with_metadata, \
...
def test_update_license_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_update_license_pool_with_metadata") as post_with_metadata, \
...
def test_assign_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_assign_with_metadata") as post_with_metadata, \
...
def test_unassign_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_unassign_with_metadata") as post_with_metadata, \
...
def test_enumerate_licensed_users_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_enumerate_licensed_users_with_metadata") as post_with_metadata, \

...
from google.cloud.commerce_consumer_procurement_v1.services.license_management_service import LicenseManagementServiceAsyncClient
from google.cloud.commerce_consumer_procurement_v1.services.license_management_service import LicenseManagementServiceClient
from google.cloud.commerce_consumer_procurement_v1.services.license_management_service import pagers
from google.cloud.commerce_consumer_procurement_v1.services.license_management_service import transports
...
@mock.patch.object(LicenseManagementServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LicenseManagementServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert LicenseManagementServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == LicenseManagementServiceClient.DEFAULT_MTLS_ENDPOINT
    assert LicenseManagementServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert LicenseManagementServiceClient._get_api_endpoint(None, None, default_universe, "always") == LicenseManagementServiceClient.DEFAULT_MTLS_ENDPOINT
    assert LicenseManagementServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == LicenseManagementServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_license_management_service_client_client_options_from_dict():
    with mock.patch('google.cloud.commerce_consumer_procurement_v1.services.license_management_service.transports.LicenseManagementServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_license_pool(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.get_license_pool),
            '__call__') as call:
...
def test_update_license_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_license_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = license_management_service.LicensePool(
            name='name_value',
...
def test_unassign(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.unassign),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_enumerate_licensed_users_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, license_management_service.LicensedUser)
                   for i in results)
...
async def test_enumerate_licensed_users_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.enumerate_licensed_users(request={},)
...
def test_get_license_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_get_license_pool") as post, \
         mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "pre_get_license_pool") as pre:
        ...
        req.return_value._content = license_management_service.LicensePool.to_json(license_management_service.LicensePool())
        ...
        client.get_license_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_license_pool_rest_bad_request(transport: str = 'rest', request_type=license_management_service.GetLicensePoolRequest):
    client = LicenseManagementServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_license_pool_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'license_pool': {'name': 'billingAccounts/sample1/orders/sample2/licensePool/sample3'}}
    request_init["license_pool"] = {'name': 'billingAccounts/sample1/orders/sample2/licensePool/sample3', 'license_assignment_protocol': {'manual_assignment_type': {}, 'auto_assignment_type': {'inactive_license_ttl': {'seconds': 751, 'nanos': 543}}}, 'available_license_count': 2411, 'total_license_count': 2030}
...
def test_update_license_pool_rest_required_fields(request_type=license_management_service.UpdateLicensePoolRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_license_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_license_pool_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("licensePool", "updateMask", )))
...
def test_update_license_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_update_license_pool") as post, \
         mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "pre_update_license_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_license_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_license_pool_rest_bad_request(transport: str = 'rest', request_type=license_management_service.UpdateLicensePoolRequest):
    client = LicenseManagementServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_license_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'license_pool': {'name': 'billingAccounts/sample1/orders/sample2/licensePool/sample3'}}
...
def test_assign_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "usernames", )))
...
def test_assign_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_assign") as post, \
         mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "pre_assign") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = license_management_service.AssignResponse.to_json(license_management_service.AssignResponse())
        ...
        client.assign(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_assign_rest_bad_request(transport: str = 'rest', request_type=license_management_service.AssignRequest):
    client = LicenseManagementServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_unassign_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_unassign") as post, \
         mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "pre_unassign") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = license_management_service.UnassignResponse.to_json(license_management_service.UnassignResponse())
        ...
        client.unassign(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_unassign_rest_bad_request(transport: str = 'rest', request_type=license_management_service.UnassignRequest):
    client = LicenseManagementServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_enumerate_licensed_users_rest_required_fields(request_type=license_management_service.EnumerateLicensedUsersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).enumerate_licensed_users._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_enumerate_licensed_users_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_enumerate_licensed_users") as post, \
         mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "pre_enumerate_licensed_users") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = license_management_service.EnumerateLicensedUsersResponse.to_json(license_management_service.EnumerateLicensedUsersResponse())
        ...
        client.enumerate_licensed_users(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_enumerate_licensed_users_rest_bad_request(transport: str = 'rest', request_type=license_management_service.EnumerateLicensedUsersRequest):
    client = LicenseManagementServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_enumerate_licensed_users_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=billingAccounts/*/orders/*/licensePool}:enumerateLicensedUsers" % client.transport._host, args[1])
...
def test_license_management_service_base_transport():
    ...
    with mock.patch('google.cloud.commerce_consumer_procurement_v1.services.license_management_service.transports.LicenseManagementServiceTransport.__init__') as Transport:
...
def test_license_management_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.commerce_consumer_procurement_v1.services.license_management_service.transports.LicenseManagementServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_license_management_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.commerce_consumer_procurement_v1.services.license_management_service.transports.LicenseManagementServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.LicenseManagementServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.LicenseManagementServiceGrpcTransport, transports.LicenseManagementServiceGrpcAsyncIOTransport])
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.LicenseManagementServiceGrpcTransport, transports.LicenseManagementServiceGrpcAsyncIOTransport])
def test_license_management_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_license_pool_path():
    ...
    order = "clam"
    expected = "billingAccounts/{billing_account}/orders/{order}/licensePool".format(billing_account=billing_account, order=order, )

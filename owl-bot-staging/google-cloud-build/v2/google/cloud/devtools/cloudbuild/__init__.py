...
from google.cloud.devtools.cloudbuild_v2.types.repositories import BitbucketCloudConfig
from google.cloud.devtools.cloudbuild_v2.types.repositories import BitbucketDataCenterConfig

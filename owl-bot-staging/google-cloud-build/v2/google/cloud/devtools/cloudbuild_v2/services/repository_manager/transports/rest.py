...
class RepositoryManagerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_create_repositories(self, request: repositories.BatchCreateRepositoriesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.BatchCreateRepositoriesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_connection(self, request: repositories.CreateConnectionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.CreateConnectionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_repository(self, request: repositories.CreateRepositoryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.CreateRepositoryRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_connection(self, request: repositories.DeleteConnectionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.DeleteConnectionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_repository(self, request: repositories.DeleteRepositoryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.DeleteRepositoryRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_fetch_git_refs(self, request: repositories.FetchGitRefsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.FetchGitRefsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_fetch_linkable_repositories(self, request: repositories.FetchLinkableRepositoriesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.FetchLinkableRepositoriesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_fetch_read_token(self, request: repositories.FetchReadTokenRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.FetchReadTokenRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_fetch_read_write_token(self, request: repositories.FetchReadWriteTokenRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.FetchReadWriteTokenRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_connection(self, request: repositories.GetConnectionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.GetConnectionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_repository(self, request: repositories.GetRepositoryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.GetRepositoryRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_connections(self, request: repositories.ListConnectionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.ListConnectionsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_repositories(self, request: repositories.ListRepositoriesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.ListRepositoriesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_connection(self, request: repositories.UpdateConnectionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[repositories.UpdateConnectionRequest, Sequence[Tuple[str, str]]]:

...
class RepositoryManagerClient(metaclass=RepositoryManagerClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = RepositoryManagerClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = RepositoryManagerClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RepositoryManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RepositoryManagerClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, RepositoryManagerTransport, Callable[..., RepositoryManagerTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RepositoryManagerClient._read_environment_variables()
        self._client_cert_source = RepositoryManagerClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RepositoryManagerClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RepositoryManagerTransport)
        if transport_provided:
            ...
            self._transport = cast(RepositoryManagerTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RepositoryManagerTransport], Callable[..., RepositoryManagerTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.devtools.cloudbuild_v2.RepositoryManagerClient`.",
                    extra = {
    ...
    def create_connection(self,
            ...
            *,
            ...
            connection: Optional[repositories.Connection] = None,
    ...
    def create_repository(self,
            ...
            *,
            parent: Optional[str] = None,
            repository: Optional[repositories.Repository] = None,
        ...
        Args:
            ...
            parent (str):
                ...
                this field should be empty or match the
    ...
    def batch_create_repositories(self,
            request: Optional[Union[repositories.BatchCreateRepositoriesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            requests: Optional[MutableSequence[repositories.CreateRepositoryRequest]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation.Operation:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_create_repositories]
    ...
    def fetch_read_write_token(self,
    ...
    def fetch_linkable_repositories(self,
            request: Optional[Union[repositories.FetchLinkableRepositoriesRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_linkable_repositories]

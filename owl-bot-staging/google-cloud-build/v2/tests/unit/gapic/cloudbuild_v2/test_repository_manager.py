...
def test_create_connection_rest_unset_required_fields():
    transport = transports.RepositoryManagerRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_batch_create_repositories_rest_required_fields(request_type=repositories.BatchCreateRepositoriesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_create_repositories._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_read_write_token_rest_required_fields(request_type=repositories.FetchReadWriteTokenRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).fetch_read_write_token._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_read_token_rest_required_fields(request_type=repositories.FetchReadTokenRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).fetch_read_token._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_linkable_repositories_rest_required_fields(request_type=repositories.FetchLinkableRepositoriesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).fetch_linkable_repositories._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_git_refs_rest_required_fields(request_type=repositories.FetchGitRefsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).fetch_git_refs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

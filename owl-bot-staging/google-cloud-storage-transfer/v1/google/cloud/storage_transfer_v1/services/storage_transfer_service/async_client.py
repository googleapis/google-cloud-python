...
class StorageTransferServiceAsyncClient:
    ...
    async def delete_transfer_job(self,
    ...
    async def update_agent_pool(self,
    ...
    async def list_agent_pools(self,
    ...
    async def delete_agent_pool(self,

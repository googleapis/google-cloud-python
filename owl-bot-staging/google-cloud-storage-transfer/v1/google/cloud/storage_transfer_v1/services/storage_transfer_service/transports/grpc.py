...
class StorageTransferServiceGrpcTransport(StorageTransferServiceTransport):
    ...
    def get_agent_pool(self) -> Callable[
        ...
        if 'get_agent_pool' not in self._stubs:
            self._stubs['get_agent_pool'] = self._logged_channel.unary_unary(
    ...
    def list_agent_pools(self) -> Callable[
        ...
        if 'list_agent_pools' not in self._stubs:
            self._stubs['list_agent_pools'] = self._logged_channel.unary_unary(
    ...
    def delete_agent_pool(self) -> Callable[
        ...
        if 'delete_agent_pool' not in self._stubs:
            self._stubs['delete_agent_pool'] = self._logged_channel.unary_unary(

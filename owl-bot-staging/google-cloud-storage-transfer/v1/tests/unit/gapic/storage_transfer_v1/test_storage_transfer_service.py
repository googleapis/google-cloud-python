...
from google.cloud.storage_transfer_v1.services.storage_transfer_service import StorageTransferServiceAsyncClient
...
from google.cloud.storage_transfer_v1.services.storage_transfer_service import transports
...
def test__get_api_endpoint():
    ...
    assert StorageTransferServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == StorageTransferServiceClient.DEFAULT_MTLS_ENDPOINT
    assert StorageTransferServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert StorageTransferServiceClient._get_api_endpoint(None, None, default_universe, "always") == StorageTransferServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    StorageTransferServiceClient, StorageTransferServiceAsyncClient
])
...
def test_delete_transfer_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_transfer_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_create_agent_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_agent_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_agent_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_agent_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = transfer_types.AgentPool(
            name='name_value',
...
def test_get_agent_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_agent_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = transfer_types.AgentPool(
            name='name_value',
...
def test_list_agent_pools(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_agent_pools),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_agent_pools_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, transfer_types.AgentPool)
                   for i in results)
...
def test_delete_agent_pool(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_agent_pool),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_get_google_service_account_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_get_google_service_account") as post, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_get_google_service_account_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_get_google_service_account") as pre:
...
def test_create_transfer_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_create_transfer_job") as post, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_create_transfer_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_create_transfer_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_transfer_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_update_transfer_job") as post, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_update_transfer_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_update_transfer_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_transfer_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_get_transfer_job") as post, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_get_transfer_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_get_transfer_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_transfer_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_list_transfer_jobs") as post, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_list_transfer_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_list_transfer_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_pause_transfer_operation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_pause_transfer_operation") as pre:
        pre.assert_not_called()
...
def test_resume_transfer_operation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_resume_transfer_operation") as pre:
        pre.assert_not_called()
...
def test_run_transfer_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_run_transfer_job") as post, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_run_transfer_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_run_transfer_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_transfer_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_delete_transfer_job") as pre:
        pre.assert_not_called()
...
def test_create_agent_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_create_agent_pool") as post, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_create_agent_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_create_agent_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_agent_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_update_agent_pool") as post, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_update_agent_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_update_agent_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_agent_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_get_agent_pool") as post, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_get_agent_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_get_agent_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_agent_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_list_agent_pools") as post, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_list_agent_pools_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_list_agent_pools") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_agent_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_delete_agent_pool") as pre:
        pre.assert_not_called()

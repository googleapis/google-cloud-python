...
def test_get_google_service_account_rest_required_fields(request_type=transfer.GetGoogleServiceAccountRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_google_service_account._get_unset_required_fields(jsonified_request)
...
def test_create_transfer_job_rest_required_fields(request_type=transfer.CreateTransferJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_transfer_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_transfer_job_rest_required_fields(request_type=transfer.UpdateTransferJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_transfer_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_transfer_job_rest_required_fields(request_type=transfer.GetTransferJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_transfer_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_transfer_jobs_rest_required_fields(request_type=transfer.ListTransferJobsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_transfer_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_pause_transfer_operation_rest_required_fields(request_type=transfer.PauseTransferOperationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).pause_transfer_operation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_resume_transfer_operation_rest_required_fields(request_type=transfer.ResumeTransferOperationRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).resume_transfer_operation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_run_transfer_job_rest_required_fields(request_type=transfer.RunTransferJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).run_transfer_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_transfer_job_rest_required_fields(request_type=transfer.DeleteTransferJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_transfer_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_agent_pool_rest_required_fields(request_type=transfer.CreateAgentPoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_agent_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_agent_pool_rest_required_fields(request_type=transfer.UpdateAgentPoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_agent_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_agent_pool_rest_required_fields(request_type=transfer.GetAgentPoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_agent_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_agent_pools_rest_required_fields(request_type=transfer.ListAgentPoolsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_agent_pools._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_agent_pool_rest_required_fields(request_type=transfer.DeleteAgentPoolRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_agent_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
from google.shopping.css_v1.services.accounts_service import pagers
...
class AccountsServiceClient(metaclass=AccountsServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AccountsServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AccountsServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Union[str, AccountsServiceTransport]): The
    ...
    def list_child_accounts(self,
            request: Optional[Union[accounts.ListChildAccountsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> pagers.ListChildAccountsPager:
        r"""Lists all the accounts under the specified CSS
        ...
        Args:
            request (Union[google.shopping.css_v1.types.ListChildAccountsRequest, dict]):
                The request object. The request message for the ``ListChildAccounts``
                method.
            parent (str):
                Required. The parent account. Must be
                a CSS group or domain. Format:
                accounts/{account}
        ...
        Returns:
            google.shopping.css_v1.services.accounts_service.pagers.ListChildAccountsPager:
        ...
        # in a accounts.ListChildAccountsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, accounts.ListChildAccountsRequest):
            request = accounts.ListChildAccountsRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_child_accounts]
        ...
        response = pagers.ListChildAccountsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def get_account(self,
        ...
        r"""Retrieves a single CSS/MC account by ID.
        ...
        Returns:
            google.shopping.css_v1.types.Account:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a accounts.GetAccountRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_labels(self,
            request: Optional[Union[accounts.UpdateAccountLabelsRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Updates labels assigned to CSS/MC accounts by a CSS
        domain.
        ...
        .. code-block:: python
            ...
            def sample_update_labels():
                ...
                # Make the request
                response = client.update_labels(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.shopping.css_v1.types.UpdateAccountLabelsRequest, dict]):
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a accounts.UpdateAccountLabelsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, accounts.UpdateAccountLabelsRequest):
            request = accounts.UpdateAccountLabelsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_labels]

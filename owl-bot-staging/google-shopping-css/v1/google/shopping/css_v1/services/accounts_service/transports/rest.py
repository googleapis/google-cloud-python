...
class AccountsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_list_child_accounts(self, request: accounts.ListChildAccountsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.ListChildAccountsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_child_accounts_with_metadata(self, response: accounts.ListChildAccountsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.ListChildAccountsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_child_accounts
    ...
    def pre_update_labels(self, request: accounts.UpdateAccountLabelsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.UpdateAccountLabelsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_labels_with_metadata(self, response: accounts.Account, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accounts.Account, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_labels
...
class AccountsServiceRestTransport(_BaseAccountsServiceRestTransport):
    ...
    class _ListChildAccounts(_BaseAccountsServiceRestTransport._BaseListChildAccounts, AccountsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccountsServiceRestTransport._ListChildAccounts._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateLabels(_BaseAccountsServiceRestTransport._BaseUpdateLabels, AccountsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccountsServiceRestTransport._UpdateLabels._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

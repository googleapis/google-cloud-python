...
class AccountsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_list_child_accounts(self, request: accounts.ListChildAccountsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[accounts.ListChildAccountsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_labels(self, request: accounts.UpdateAccountLabelsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[accounts.UpdateAccountLabelsRequest, Sequence[Tuple[str, str]]]:

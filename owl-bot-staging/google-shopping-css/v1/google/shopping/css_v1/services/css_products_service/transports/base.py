...
class CssProductsServiceTransport(abc.ABC):
    ...
    DEFAULT_HOST: str = 'css.googleapis.com'
    def __init__(
            self, *,
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_css_product: gapic_v1.method.wrap_method(
...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
            ...
            self.list_css_products: gapic_v1.method.wrap_method(

...
from .rest_base import _BaseCssProductsServiceRestTransport
...
class CssProductsServiceRestInterceptor:
    """Interceptor for CssProductsService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the CssProductsServiceRestTransport.

    .. code-block:: python
        class MyCustomCssProductsServiceInterceptor(CssProductsServiceRestInterceptor):
            def pre_get_css_product(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_css_product(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_css_products(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_css_products(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = CssProductsServiceRestTransport(interceptor=MyCustomCssProductsServiceInterceptor())
        client = CssProductsServiceClient(transport=transport)


    """
    def pre_get_css_product(self, request: css_products.GetCssProductRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[css_products.GetCssProductRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for get_css_product

        Override in a subclass to manipulate the request or metadata
        before they are sent to the CssProductsService server.
        """
        return request, metadata
    ...
    def post_get_css_product_with_metadata(self, response: css_products.CssProduct, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[css_products.CssProduct, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_css_product
    ...
    def pre_list_css_products(self, request: css_products.ListCssProductsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[css_products.ListCssProductsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_css_products_with_metadata(self, response: css_products.ListCssProductsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[css_products.ListCssProductsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_css_products
...
class CssProductsServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: CssProductsServiceRestInterceptor


class CssProductsServiceRestTransport(_BaseCssProductsServiceRestTransport):
    """REST backend synchronous transport for CssProductsService.
    ...
    def __init__(self, *,
            ...
            interceptor: Optional[CssProductsServiceRestInterceptor] = None,
    ...
    class _GetCssProduct(_BaseCssProductsServiceRestTransport._BaseGetCssProduct, CssProductsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CssProductsServiceRestTransport._GetCssProduct._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListCssProducts(_BaseCssProductsServiceRestTransport._BaseListCssProducts, CssProductsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CssProductsServiceRestTransport._ListCssProducts._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = css_products.ListCssProductsResponse()
    ...
    @property
    def get_css_product(self) -> Callable[
    ...
    @property
    def list_css_products(self) -> Callable[
...
__all__=(
    'CssProductsServiceRestTransport',
)

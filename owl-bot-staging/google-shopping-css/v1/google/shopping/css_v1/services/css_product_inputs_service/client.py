...
from .transports.base import CssProductInputsServiceTransport, DEFAULT_CLIENT_INFO
...
class CssProductInputsServiceClient(metaclass=CssProductInputsServiceClientMeta):
    ...
    @staticmethod
    def css_product_input_path(account: str,css_product_input: str,) -> str:
        """Returns a fully-qualified css_product_input string."""
        return "accounts/{account}/cssProductInputs/{css_product_input}".format(account=account, css_product_input=css_product_input, )

    @staticmethod
    def parse_css_product_input_path(path: str) -> Dict[str,str]:
        """Parses a css_product_input path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/cssProductInputs/(?P<css_product_input>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CssProductInputsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            CssProductInputsServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CssProductInputsServiceTransport, Callable[..., CssProductInputsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CssProductInputsServiceClient._read_environment_variables()
        self._client_cert_source = CssProductInputsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CssProductInputsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CssProductInputsServiceTransport], Callable[..., CssProductInputsServiceTransport]] = (
    ...
    def insert_css_product_input(self,
    ...
    def delete_css_product_input(self,

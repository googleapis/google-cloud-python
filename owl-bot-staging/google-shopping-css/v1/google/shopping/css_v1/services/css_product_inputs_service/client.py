...
class CssProductInputsServiceClient(metaclass=CssProductInputsServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CssProductInputsServiceTransport]] = None,
    ...
    def insert_css_product_input(self,
        ...
        # in a css_product_inputs.InsertCssProductInputRequest.
    ...
    def delete_css_product_input(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a css_product_inputs.DeleteCssProductInputRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

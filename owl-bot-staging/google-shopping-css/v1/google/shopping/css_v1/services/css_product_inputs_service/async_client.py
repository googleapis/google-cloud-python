...
class CssProductInputsServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(CssProductInputsServiceClient).get_transport_class, type(CssProductInputsServiceClient))
    ...
    async def insert_css_product_input(self,
    ...
    async def delete_css_product_input(self,

...
class CssProductInputsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_css_product_input(self, request: css_product_inputs.DeleteCssProductInputRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[css_product_inputs.DeleteCssProductInputRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert_css_product_input(self, request: css_product_inputs.InsertCssProductInputRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[css_product_inputs.InsertCssProductInputRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_insert_css_product_input_with_metadata(self, response: css_product_inputs.CssProductInput, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[css_product_inputs.CssProductInput, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for insert_css_product_input
    ...
    def pre_update_css_product_input(self, request: css_product_inputs.UpdateCssProductInputRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[css_product_inputs.UpdateCssProductInputRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_css_product_input_with_metadata(self, response: css_product_inputs.CssProductInput, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[css_product_inputs.CssProductInput, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_css_product_input
...
class CssProductInputsServiceRestTransport(_BaseCssProductInputsServiceRestTransport):
    ...
    class _DeleteCssProductInput(_BaseCssProductInputsServiceRestTransport._BaseDeleteCssProductInput, CssProductInputsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CssProductInputsServiceRestTransport._DeleteCssProductInput._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _InsertCssProductInput(_BaseCssProductInputsServiceRestTransport._BaseInsertCssProductInput, CssProductInputsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CssProductInputsServiceRestTransport._InsertCssProductInput._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateCssProductInput(_BaseCssProductInputsServiceRestTransport._BaseUpdateCssProductInput, CssProductInputsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = CssProductInputsServiceRestTransport._UpdateCssProductInput._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

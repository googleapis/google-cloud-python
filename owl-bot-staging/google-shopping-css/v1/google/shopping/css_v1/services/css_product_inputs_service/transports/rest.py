...
class CssProductInputsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_css_product_input(self, request: css_product_inputs.DeleteCssProductInputRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[css_product_inputs.DeleteCssProductInputRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert_css_product_input(self, request: css_product_inputs.InsertCssProductInputRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[css_product_inputs.InsertCssProductInputRequest, Sequence[Tuple[str, str]]]:

...
def test_insert_css_product_input_rest_required_fields(request_type=css_product_inputs.InsertCssProductInputRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).insert_css_product_input._get_unset_required_fields(jsonified_request)
...
def test_insert_css_product_input_rest_unset_required_fields():
    transport = transports.CssProductInputsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_delete_css_product_input_rest_required_fields(request_type=css_product_inputs.DeleteCssProductInputRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_css_product_input._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

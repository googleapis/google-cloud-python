...
async def test_insert_css_product_input_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.insert_css_product_input] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_css_product_input] = mock_object
...
def test_insert_css_product_input_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("feedId", )) & set(("parent", "cssProductInput", "feedId", )))
...
def test_insert_css_product_input_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = css_product_inputs.CssProductInput.to_json(css_product_inputs.CssProductInput())
...
def test_insert_css_product_input_rest_bad_request(transport: str = 'rest', request_type=css_product_inputs.InsertCssProductInputRequest):
    client = CssProductInputsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_css_product_input_rest_bad_request(transport: str = 'rest', request_type=css_product_inputs.DeleteCssProductInputRequest):
    client = CssProductInputsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

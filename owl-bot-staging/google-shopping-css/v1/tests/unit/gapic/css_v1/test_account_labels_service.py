...
from google.shopping.css_v1.services.account_labels_service import AccountLabelsServiceAsyncClient
from google.shopping.css_v1.services.account_labels_service import AccountLabelsServiceClient
from google.shopping.css_v1.services.account_labels_service import pagers
from google.shopping.css_v1.services.account_labels_service import transports
...
def test__get_api_endpoint():
    ...
    assert AccountLabelsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AccountLabelsServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert AccountLabelsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AccountLabelsServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    AccountLabelsServiceClient, AccountLabelsServiceAsyncClient
])
...
async def test_list_account_labels_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.list_account_labels] = mock_object
...
def test_list_account_labels_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, accounts_labels.AccountLabel)
                   for i in results)
...
async def test_list_account_labels_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_account_labels(request={},)
...
def test_create_account_label(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_account_label),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.create_account_label] = mock_object
...
def test_update_account_label(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_account_label),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = accounts_labels.AccountLabel(
            name='name_value',
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_account_label] = mock_object
...
def test_delete_account_label(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_account_label),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_account_label] = mock_object
...
def test_list_account_labels_rest_required_fields(request_type=accounts_labels.ListAccountLabelsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_account_labels._get_unset_required_fields(jsonified_request)
...
def test_list_account_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.AccountLabelsServiceRestInterceptor, "post_list_account_labels") as post, \
         mock.patch.object(transports.AccountLabelsServiceRestInterceptor, "pre_list_account_labels") as pre:
        ...
        req.return_value._content = accounts_labels.ListAccountLabelsResponse.to_json(accounts_labels.ListAccountLabelsResponse())
        ...
        client.list_account_labels(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_account_labels_rest_bad_request(transport: str = 'rest', request_type=accounts_labels.ListAccountLabelsRequest):
    client = AccountLabelsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_account_label_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'accounts/sample1'}
    request_init["account_label"] = {'name': 'name_value', 'label_id': 812, 'account_id': 1049, 'display_name': 'display_name_value', 'description': 'description_value', 'label_type': 1}
...
def test_create_account_label_rest_required_fields(request_type=accounts_labels.CreateAccountLabelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_account_label._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_account_label_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "accountLabel", )))
...
def test_create_account_label_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AccountLabelsServiceRestInterceptor, "post_create_account_label") as post, \
         mock.patch.object(transports.AccountLabelsServiceRestInterceptor, "pre_create_account_label") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = accounts_labels.AccountLabel.to_json(accounts_labels.AccountLabel())
        ...
        client.create_account_label(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_account_label_rest_bad_request(transport: str = 'rest', request_type=accounts_labels.CreateAccountLabelRequest):
    client = AccountLabelsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_account_label_rest(request_type):
    ...
    request_init["account_label"] = {'name': 'accounts/sample1/labels/sample2', 'label_id': 812, 'account_id': 1049, 'display_name': 'display_name_value', 'description': 'description_value', 'label_type': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_account_label_rest_required_fields(request_type=accounts_labels.UpdateAccountLabelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_account_label._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_account_label_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AccountLabelsServiceRestInterceptor, "post_update_account_label") as post, \
         mock.patch.object(transports.AccountLabelsServiceRestInterceptor, "pre_update_account_label") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_account_label(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_account_label_rest_bad_request(transport: str = 'rest', request_type=accounts_labels.UpdateAccountLabelRequest):
    client = AccountLabelsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_account_label_rest_required_fields(request_type=accounts_labels.DeleteAccountLabelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_account_label._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_account_label_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AccountLabelsServiceRestInterceptor, "pre_delete_account_label") as pre:
        pre.assert_not_called()
        ...
        client.delete_account_label(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_account_label_rest_bad_request(transport: str = 'rest', request_type=accounts_labels.DeleteAccountLabelRequest):
    client = AccountLabelsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_account_labels_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.shopping.css_v1.services.account_labels_service.transports.AccountLabelsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_account_labels_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.shopping.css_v1.services.account_labels_service.transports.AccountLabelsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AccountLabelsServiceTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.AccountLabelsServiceGrpcTransport, transports.AccountLabelsServiceGrpcAsyncIOTransport])
def test_account_labels_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_account_label_path():
    account = "squid"
    label = "clam"
    expected = "accounts/{account}/labels/{label}".format(account=account, label=label, )

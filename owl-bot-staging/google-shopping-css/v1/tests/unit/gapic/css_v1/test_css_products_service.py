...
def test_get_css_product_rest_required_fields(request_type=css_products.GetCssProductRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_css_product._get_unset_required_fields(jsonified_request)
...
def test_get_css_product_rest_unset_required_fields():
    transport = transports.CssProductsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_css_products_rest_required_fields(request_type=css_products.ListCssProductsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_css_products._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
class ClientConnectorServicesServiceAsyncClient:
    ...
    get_transport_class = ClientConnectorServicesServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, ClientConnectorServicesServiceTransport, Callable[..., ClientConnectorServicesServiceTransport]]] = "grpc_asyncio",
            client_options: Optional[ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the client connector services service async client.

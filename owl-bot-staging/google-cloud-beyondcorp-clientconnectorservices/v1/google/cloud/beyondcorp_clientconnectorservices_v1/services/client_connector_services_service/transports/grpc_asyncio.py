...
class ClientConnectorServicesServiceGrpcAsyncIOTransport(ClientConnectorServicesServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_client_connector_services: gapic_v1.method_async.wrap_method(
                self.list_client_connector_services,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_client_connector_service: gapic_v1.method_async.wrap_method(
                self.get_client_connector_service,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_client_connector_service: gapic_v1.method_async.wrap_method(
                self.create_client_connector_service,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_client_connector_service: gapic_v1.method_async.wrap_method(
                self.update_client_connector_service,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_client_connector_service: gapic_v1.method_async.wrap_method(

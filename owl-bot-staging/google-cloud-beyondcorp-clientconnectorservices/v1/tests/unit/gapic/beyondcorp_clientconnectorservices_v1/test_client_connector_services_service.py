...
def test__read_environment_variables():
    assert ClientConnectorServicesServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ClientConnectorServicesServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ClientConnectorServicesServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ClientConnectorServicesServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ClientConnectorServicesServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert ClientConnectorServicesServiceClient._get_client_cert_source(None, False) is None
    assert ClientConnectorServicesServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ClientConnectorServicesServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ClientConnectorServicesServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ClientConnectorServicesServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ClientConnectorServicesServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ClientConnectorServicesServiceClient))
@mock.patch.object(ClientConnectorServicesServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ClientConnectorServicesServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ClientConnectorServicesServiceClient._DEFAULT_UNIVERSE
    default_endpoint = ClientConnectorServicesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ClientConnectorServicesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ClientConnectorServicesServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ClientConnectorServicesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ClientConnectorServicesServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ClientConnectorServicesServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ClientConnectorServicesServiceClient._get_api_endpoint(None, None, default_universe, "always") == ClientConnectorServicesServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ClientConnectorServicesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ClientConnectorServicesServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ClientConnectorServicesServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ClientConnectorServicesServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ClientConnectorServicesServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ClientConnectorServicesServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ClientConnectorServicesServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ClientConnectorServicesServiceClient._get_universe_domain(None, None) == ClientConnectorServicesServiceClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        ClientConnectorServicesServiceClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ClientConnectorServicesServiceClient(credentials=cred)
...
@mock.patch.object(ClientConnectorServicesServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ClientConnectorServicesServiceClient))
@mock.patch.object(ClientConnectorServicesServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ClientConnectorServicesServiceAsyncClient))
def test_client_connector_services_service_client_client_api_endpoint(client_class):
...
def test_list_client_connector_services_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        client.list_client_connector_services(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_list_client_connector_services_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_client_connector_services in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_client_connector_services] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_client_connector_services_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_client_connector_services in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_client_connector_services] = mock_rpc
...
def test_list_client_connector_services_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_client_connector_services(request={}, retry=retry, timeout=timeout)
...
def test_get_client_connector_service_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.get_client_connector_service(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_get_client_connector_service_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_client_connector_service in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_client_connector_service] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_client_connector_service_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ClientConnectorServicesServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_client_connector_service in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_client_connector_service] = mock_rpc
...
def test_create_client_connector_service_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.create_client_connector_service(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_create_client_connector_service_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ClientConnectorServicesServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.create_client_connector_service in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_client_connector_service] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_client_connector_service_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ClientConnectorServicesServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_client_connector_service in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_client_connector_service] = mock_rpc
...
def test_update_client_connector_service_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.update_client_connector_service(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_update_client_connector_service_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ClientConnectorServicesServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.update_client_connector_service in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_client_connector_service] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_client_connector_service_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ClientConnectorServicesServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_client_connector_service in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_client_connector_service] = mock_rpc
...
def test_delete_client_connector_service_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.delete_client_connector_service(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_delete_client_connector_service_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ClientConnectorServicesServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_client_connector_service in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_client_connector_service] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_client_connector_service_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ClientConnectorServicesServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_client_connector_service in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_client_connector_service] = mock_rpc
...
def test_get_client_connector_service_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ClientConnectorServicesServiceClient(
...
def test_delete_client_connector_service_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ClientConnectorServicesServiceClient(
...
def test_list_client_connector_services_empty_call_grpc():
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = client_connector_services_service.ListClientConnectorServicesResponse()
        client.list_client_connector_services(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = client_connector_services_service.ListClientConnectorServicesRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_client_connector_service_empty_call_grpc():
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = client_connector_services_service.ClientConnectorService()
        client.get_client_connector_service(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_client_connector_service_empty_call_grpc():
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_client_connector_service(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = client_connector_services_service.CreateClientConnectorServiceRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_client_connector_service_empty_call_grpc():
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_client_connector_service(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = client_connector_services_service.UpdateClientConnectorServiceRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_client_connector_service_empty_call_grpc():
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_client_connector_service(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = client_connector_services_service.DeleteClientConnectorServiceRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = ClientConnectorServicesServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_client_connector_services_empty_call_grpc_asyncio():
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_client_connector_services(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_client_connector_service_empty_call_grpc_asyncio():
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_client_connector_service(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_client_connector_service_empty_call_grpc_asyncio():
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_client_connector_service(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_client_connector_service_empty_call_grpc_asyncio():
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_client_connector_service(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_client_connector_service_empty_call_grpc_asyncio():
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_client_connector_service(request=None)
...
def test_transport_kind_rest():
    transport = ClientConnectorServicesServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_client_connector_services_rest_bad_request(request_type=client_connector_services_service.ListClientConnectorServicesRequest):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_client_connector_services_rest_call_success(request_type):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_client_connector_services_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "post_list_client_connector_services_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = client_connector_services_service.ListClientConnectorServicesResponse.to_json(client_connector_services_service.ListClientConnectorServicesResponse())
        ...
        post_with_metadata.return_value = client_connector_services_service.ListClientConnectorServicesResponse(), metadata
...
def test_get_client_connector_service_rest_bad_request(request_type=client_connector_services_service.GetClientConnectorServiceRequest):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_client_connector_service_rest_call_success(request_type):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "post_get_client_connector_service_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = client_connector_services_service.ClientConnectorService.to_json(client_connector_services_service.ClientConnectorService())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = client_connector_services_service.ClientConnectorService(), metadata
...
def test_create_client_connector_service_rest_bad_request(request_type=client_connector_services_service.CreateClientConnectorServiceRequest):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_client_connector_service_rest_call_success(request_type):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    for field, value in request_init["client_connector_service"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "post_create_client_connector_service_with_metadata") as post_with_metadata, \
...
def test_update_client_connector_service_rest_bad_request(request_type=client_connector_services_service.UpdateClientConnectorServiceRequest):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_client_connector_service_rest_call_success(request_type):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "post_update_client_connector_service_with_metadata") as post_with_metadata, \
...
def test_delete_client_connector_service_rest_bad_request(request_type=client_connector_services_service.DeleteClientConnectorServiceRequest):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_client_connector_service_rest_call_success(request_type):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "post_delete_client_connector_service_with_metadata") as post_with_metadata, \
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_client_connector_services_empty_call_rest():
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_client_connector_service_empty_call_rest():
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_client_connector_service_empty_call_rest():
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_client_connector_service_empty_call_rest():
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_client_connector_service_empty_call_rest():
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

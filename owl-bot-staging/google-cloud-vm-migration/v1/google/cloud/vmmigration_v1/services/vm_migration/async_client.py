...
class VmMigrationAsyncClient:
    ...
    async def fetch_storage_inventory(self,
    ...
    async def extend_migration(self,
    ...
    async def list_image_imports(self,
    ...
    async def get_image_import(self,
    ...
    async def create_image_import(self,
    ...
    async def delete_image_import(self,
    ...
    async def list_image_import_jobs(self,
    ...
    async def get_image_import_job(self,
    ...
    async def cancel_image_import_job(self,
    ...
    async def create_disk_migration_job(self,
    ...
    async def list_disk_migration_jobs(self,
    ...
    async def get_disk_migration_job(self,
    ...
    async def update_disk_migration_job(self,
    ...
    async def delete_disk_migration_job(self,
    ...
    async def run_disk_migration_job(self,
    ...
    async def cancel_disk_migration_job(self,

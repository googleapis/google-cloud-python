...
class VmMigrationClient(metaclass=VmMigrationClientMeta):
    ...
    @staticmethod
    def disk_migration_job_path(project: str,location: str,source: str,disk_migration_job: str,) -> str:
        """Returns a fully-qualified disk_migration_job string."""
        return "projects/{project}/locations/{location}/sources/{source}/diskMigrationJobs/{disk_migration_job}".format(project=project, location=location, source=source, disk_migration_job=disk_migration_job, )

    @staticmethod
    def parse_disk_migration_job_path(path: str) -> Dict[str,str]:
        """Parses a disk_migration_job path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/sources/(?P<source>.+?)/diskMigrationJobs/(?P<disk_migration_job>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def image_path(project: str,image: str,) -> str:
        """Returns a fully-qualified image string."""
        return "projects/{project}/global/images/{image}".format(project=project, image=image, )
    ...
    @staticmethod
    def image_import_path(project: str,location: str,job: str,) -> str:
        """Returns a fully-qualified image_import string."""
        return "projects/{project}/locations/{location}/imageImports/{job}".format(project=project, location=location, job=job, )
    ...
    @staticmethod
    def image_import_job_path(project: str,location: str,job: str,result: str,) -> str:
        """Returns a fully-qualified image_import_job string."""
        return "projects/{project}/locations/{location}/imageImports/{job}/imageImportJobs/{result}".format(project=project, location=location, job=job, result=result, )
    ...
    def fetch_storage_inventory(self,
    ...
    def list_image_import_jobs(self,
    ...
    def cancel_image_import_job(self,
    ...
    def create_disk_migration_job(self,
    ...
    def list_disk_migration_jobs(self,
    ...
    def get_disk_migration_job(self,
    ...
    def update_disk_migration_job(self,
    ...
    def delete_disk_migration_job(self,
    ...
    def run_disk_migration_job(self,
    ...
    def cancel_disk_migration_job(self,

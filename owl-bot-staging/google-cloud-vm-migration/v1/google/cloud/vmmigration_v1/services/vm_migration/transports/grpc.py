...
class VmMigrationGrpcTransport(VmMigrationTransport):
    ...
    @property
    def fetch_storage_inventory(self) -> Callable[
    ...
    @property
    def extend_migration(self) -> Callable[
    ...
    @property
    def list_image_imports(self) -> Callable[
    ...
    @property
    def get_image_import(self) -> Callable[
    ...
    @property
    def create_image_import(self) -> Callable[
    ...
    @property
    def delete_image_import(self) -> Callable[
    ...
    @property
    def list_image_import_jobs(self) -> Callable[
    ...
    @property
    def get_image_import_job(self) -> Callable[
    ...
    @property
    def cancel_image_import_job(self) -> Callable[
    ...
    @property
    def create_disk_migration_job(self) -> Callable[
    ...
    @property
    def list_disk_migration_jobs(self) -> Callable[
    ...
    @property
    def get_disk_migration_job(self) -> Callable[
    ...
    @property
    def update_disk_migration_job(self) -> Callable[
    ...
    @property
    def delete_disk_migration_job(self) -> Callable[
    ...
    @property
    def run_disk_migration_job(self) -> Callable[
    ...
    @property
    def cancel_disk_migration_job(self) -> Callable[

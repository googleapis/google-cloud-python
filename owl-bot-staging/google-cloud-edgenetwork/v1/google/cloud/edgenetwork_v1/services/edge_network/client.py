...
from .transports.base import EdgeNetworkTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import EdgeNetworkGrpcTransport
from .transports.grpc_asyncio import EdgeNetworkGrpcAsyncIOTransport
from .transports.rest import EdgeNetworkRestTransport


class EdgeNetworkClientMeta(type):
    """Metaclass for the EdgeNetwork client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[EdgeNetworkTransport]]
    _transport_registry["grpc"] = EdgeNetworkGrpcTransport
    _transport_registry["grpc_asyncio"] = EdgeNetworkGrpcAsyncIOTransport
    _transport_registry["rest"] = EdgeNetworkRestTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[EdgeNetworkTransport]:
...
class EdgeNetworkClient(metaclass=EdgeNetworkClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "edgenetwork.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            EdgeNetworkClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> EdgeNetworkTransport:
        """Returns the transport used by the client instance.

        Returns:
            EdgeNetworkTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def interconnect_path(project: str,location: str,zone: str,interconnect: str,) -> str:
        """Returns a fully-qualified interconnect string."""
        return "projects/{project}/locations/{location}/zones/{zone}/interconnects/{interconnect}".format(project=project, location=location, zone=zone, interconnect=interconnect, )

    @staticmethod
    def parse_interconnect_path(path: str) -> Dict[str,str]:
        """Parses a interconnect path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/zones/(?P<zone>.+?)/interconnects/(?P<interconnect>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def interconnect_attachment_path(project: str,location: str,zone: str,interconnect_attachment: str,) -> str:
        """Returns a fully-qualified interconnect_attachment string."""
        return "projects/{project}/locations/{location}/zones/{zone}/interconnectAttachments/{interconnect_attachment}".format(project=project, location=location, zone=zone, interconnect_attachment=interconnect_attachment, )
    ...
    def parse_interconnect_attachment_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/zones/(?P<zone>.+?)/interconnectAttachments/(?P<interconnect_attachment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def network_path(project: str,location: str,zone: str,network: str,) -> str:
        """Returns a fully-qualified network string."""
        return "projects/{project}/locations/{location}/zones/{zone}/networks/{network}".format(project=project, location=location, zone=zone, network=network, )

    @staticmethod
    def parse_network_path(path: str) -> Dict[str,str]:
        """Parses a network path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/zones/(?P<zone>.+?)/networks/(?P<network>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def router_path(project: str,location: str,zone: str,router: str,) -> str:
        """Returns a fully-qualified router string."""
        return "projects/{project}/locations/{location}/zones/{zone}/routers/{router}".format(project=project, location=location, zone=zone, router=router, )

    @staticmethod
    def parse_router_path(path: str) -> Dict[str,str]:
        """Parses a router path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/zones/(?P<zone>.+?)/routers/(?P<router>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def subnet_path(project: str,location: str,zone: str,subnet: str,) -> str:
        """Returns a fully-qualified subnet string."""
        return "projects/{project}/locations/{location}/zones/{zone}/subnets/{subnet}".format(project=project, location=location, zone=zone, subnet=subnet, )

    @staticmethod
    def parse_subnet_path(path: str) -> Dict[str,str]:
        """Parses a subnet path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/zones/(?P<zone>.+?)/subnets/(?P<subnet>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = EdgeNetworkClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = EdgeNetworkClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = EdgeNetworkClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = EdgeNetworkClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, EdgeNetworkTransport, Callable[..., EdgeNetworkTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = EdgeNetworkClient._read_environment_variables()
        self._client_cert_source = EdgeNetworkClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = EdgeNetworkClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, EdgeNetworkTransport)
        if transport_provided:
            # transport is a EdgeNetworkTransport instance.
            ...
            self._transport = cast(EdgeNetworkTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[EdgeNetworkTransport], Callable[..., EdgeNetworkTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.edgenetwork_v1.EdgeNetworkClient`.",
                    extra = {
    ...
    def initialize_zone(self,
            request: Optional[Union[service.InitializeZoneRequest, dict]] = None,
            *,
        ...
        r"""InitializeZone will initialize resources for a zone
        in a project.
        ...
        rpc = self._transport._wrapped_methods[self._transport.initialize_zone]
    ...
    def list_zones(self,
        ...
        """
        warnings.warn("EdgeNetworkClient.list_zones is deprecated",
            DeprecationWarning)
    ...
    def get_zone(self,
        ...
        """
        warnings.warn("EdgeNetworkClient.get_zone is deprecated",
            DeprecationWarning)
    ...
    def list_networks(self,
            request: Optional[Union[service.ListNetworksRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_network(self,
            request: Optional[Union[service.GetNetworkRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def diagnose_network(self,
            request: Optional[Union[service.DiagnoseNetworkRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.diagnose_network]
    ...
    def create_network(self,
            request: Optional[Union[service.CreateNetworkRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            network: Optional[resources.Network] = None,
            network_id: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation.Operation:
        r"""Creates a new Network in a given project and
        location.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.edgenetwork_v1.types.Network`
                Message describing Network object
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, network, network_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_network]
    ...
    def delete_network(self,
            request: Optional[Union[service.DeleteNetworkRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_network]
    ...
    def list_subnets(self,
            request: Optional[Union[service.ListSubnetsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_subnet(self,
            request: Optional[Union[service.GetSubnetRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_subnet(self,
            request: Optional[Union[service.CreateSubnetRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            subnet: Optional[resources.Subnet] = None,
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.edgenetwork_v1.types.Subnet`
                Message describing Subnet object
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, subnet, subnet_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_subnet]
    ...
    def update_subnet(self,
            request: Optional[Union[service.UpdateSubnetRequest, dict]] = None,
            *,
            subnet: Optional[resources.Subnet] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [subnet, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def delete_subnet(self,
            request: Optional[Union[service.DeleteSubnetRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_subnet]
    ...
    def list_interconnects(self,
            request: Optional[Union[service.ListInterconnectsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListInterconnectsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_interconnects]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListInterconnectsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_interconnect(self,
            request: Optional[Union[service.GetInterconnectRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_interconnect]
    ...
    def diagnose_interconnect(self,
            request: Optional[Union[service.DiagnoseInterconnectRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Get the diagnostics of a single interconnect
        resource.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.diagnose_interconnect]
    ...
    def list_interconnect_attachments(self,
            request: Optional[Union[service.ListInterconnectAttachmentsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListInterconnectAttachmentsPager:
        r"""Lists InterconnectAttachments in a given project and
        location.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_interconnect_attachments]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListInterconnectAttachmentsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_interconnect_attachment(self,
            request: Optional[Union[service.GetInterconnectAttachmentRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_interconnect_attachment]
    ...
    def create_interconnect_attachment(self,
            request: Optional[Union[service.CreateInterconnectAttachmentRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            interconnect_attachment: Optional[resources.InterconnectAttachment] = None,
            interconnect_attachment_id: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation.Operation:
        r"""Creates a new InterconnectAttachment in a given
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.edgenetwork_v1.types.InterconnectAttachment`
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, interconnect_attachment, interconnect_attachment_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, service.CreateInterconnectAttachmentRequest):
            ...
            if interconnect_attachment_id is not None:
                request.interconnect_attachment_id = interconnect_attachment_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_interconnect_attachment]
    ...
    def delete_interconnect_attachment(self,
            request: Optional[Union[service.DeleteInterconnectAttachmentRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_interconnect_attachment]
    ...
    def list_routers(self,
            request: Optional[Union[service.ListRoutersRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListRoutersPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_routers]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListRoutersPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_router(self,
            request: Optional[Union[service.GetRouterRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_router]
    ...
    def diagnose_router(self,
            request: Optional[Union[service.DiagnoseRouterRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.diagnose_router]
    ...
    def create_router(self,
            request: Optional[Union[service.CreateRouterRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            router: Optional[resources.Router] = None,
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.edgenetwork_v1.types.Router`
                Message describing Router object
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, router, router_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_router]
    ...
    def update_router(self,
            request: Optional[Union[service.UpdateRouterRequest, dict]] = None,
            *,
            router: Optional[resources.Router] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [router, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_router]
    ...
    def delete_router(self,
            request: Optional[Union[service.DeleteRouterRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_router]
    ...
    def __enter__(self) -> "EdgeNetworkClient":
        return self

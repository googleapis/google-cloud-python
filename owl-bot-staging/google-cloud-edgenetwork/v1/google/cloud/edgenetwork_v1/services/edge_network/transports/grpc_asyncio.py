...
from .base import EdgeNetworkTransport, DEFAULT_CLIENT_INFO
...
class EdgeNetworkGrpcAsyncIOTransport(EdgeNetworkTransport):
    ...
    def initialize_zone(self) -> Callable[
            ...
            Awaitable[service.InitializeZoneResponse]]:
    ...
    def list_networks(self) -> Callable[
            ...
            Awaitable[service.ListNetworksResponse]]:
    ...
    def diagnose_network(self) -> Callable[
            ...
            Awaitable[service.DiagnoseNetworkResponse]]:
    ...
    def list_subnets(self) -> Callable[
            ...
            Awaitable[service.ListSubnetsResponse]]:
    ...
    def get_interconnect(self) -> Callable[
            ...
            Awaitable[resources.Interconnect]]:
    ...
    def list_interconnect_attachments(self) -> Callable[
        ...
        if 'list_interconnect_attachments' not in self._stubs:
            self._stubs['list_interconnect_attachments'] = self.grpc_channel.unary_unary(
    ...
    def create_interconnect_attachment(self) -> Callable[
        ...
        if 'create_interconnect_attachment' not in self._stubs:
            self._stubs['create_interconnect_attachment'] = self.grpc_channel.unary_unary(
    ...
    def delete_interconnect_attachment(self) -> Callable[
        ...
        if 'delete_interconnect_attachment' not in self._stubs:
            self._stubs['delete_interconnect_attachment'] = self.grpc_channel.unary_unary(
    ...
    def list_routers(self) -> Callable[
            ...
            Awaitable[service.ListRoutersResponse]]:
    ...
    def diagnose_router(self) -> Callable[
            ...
            Awaitable[service.DiagnoseRouterResponse]]:
...
__all__ = (
    'EdgeNetworkGrpcAsyncIOTransport',
)

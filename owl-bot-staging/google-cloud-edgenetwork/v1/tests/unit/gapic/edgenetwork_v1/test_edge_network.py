...
from google.cloud.edgenetwork_v1.services.edge_network import EdgeNetworkAsyncClient
...
from google.cloud.edgenetwork_v1.services.edge_network import transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert EdgeNetworkClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert EdgeNetworkClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert EdgeNetworkClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert EdgeNetworkClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert EdgeNetworkClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert EdgeNetworkClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(EdgeNetworkClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EdgeNetworkClient))
@mock.patch.object(EdgeNetworkAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EdgeNetworkAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = EdgeNetworkClient._DEFAULT_UNIVERSE
    default_endpoint = EdgeNetworkClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = EdgeNetworkClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert EdgeNetworkClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert EdgeNetworkClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == EdgeNetworkClient.DEFAULT_MTLS_ENDPOINT
    assert EdgeNetworkClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert EdgeNetworkClient._get_api_endpoint(None, None, default_universe, "always") == EdgeNetworkClient.DEFAULT_MTLS_ENDPOINT
    assert EdgeNetworkClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EdgeNetworkClient.DEFAULT_MTLS_ENDPOINT
    assert EdgeNetworkClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert EdgeNetworkClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        EdgeNetworkClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert EdgeNetworkClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert EdgeNetworkClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert EdgeNetworkClient._get_universe_domain(None, None) == EdgeNetworkClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (EdgeNetworkAsyncClient, transports.EdgeNetworkGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (EdgeNetworkAsyncClient, transports.EdgeNetworkGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (EdgeNetworkClient, transports.EdgeNetworkGrpcTransport, "grpc", "false"),
    (EdgeNetworkAsyncClient, transports.EdgeNetworkGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
@pytest.mark.parametrize("client_class", [
    EdgeNetworkClient, EdgeNetworkAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (EdgeNetworkAsyncClient, transports.EdgeNetworkGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_initialize_zone(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.initialize_zone),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_initialize_zone_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.initialize_zone in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.initialize_zone] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_networks_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_networks in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_networks] = mock_rpc
...
def test_list_networks_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Network)
                   for i in results)
...
@pytest.mark.asyncio
async def test_get_network_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_network in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_network] = mock_rpc
...
def test_diagnose_network(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.diagnose_network),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_diagnose_network_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.diagnose_network] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_diagnose_network_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.diagnose_network in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.diagnose_network] = mock_rpc
...
def test_create_network(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_network),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_network_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_network in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_network] = mock_rpc
...
def test_delete_network(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_network),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_network_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_network in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_network] = mock_rpc
...
def test_list_subnets(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_subnets),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_subnets_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_subnets in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_subnets] = mock_rpc
...
def test_list_subnets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Subnet)
                   for i in results)
...
def test_get_subnet(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_subnet),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_get_subnet_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_subnet in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_subnet] = mock_rpc
...
def test_create_subnet(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_subnet),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_subnet_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_subnet in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_subnet] = mock_rpc
...
def test_update_subnet(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_subnet),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_subnet_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_subnet in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_subnet] = mock_rpc
...
def test_delete_subnet(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_subnet),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_subnet_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_subnet in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_subnet] = mock_rpc
...
def test_list_interconnects_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_interconnects in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_interconnects] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_interconnects_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_interconnects in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_interconnects] = mock_rpc
...
def test_list_interconnects_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Interconnect)
                   for i in results)
...
def test_get_interconnect(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_interconnect),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_interconnect_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_interconnect] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_interconnect_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_interconnect in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_interconnect] = mock_rpc
...
def test_diagnose_interconnect(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.diagnose_interconnect),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_diagnose_interconnect_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.diagnose_interconnect in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.diagnose_interconnect] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_diagnose_interconnect_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.diagnose_interconnect in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.diagnose_interconnect] = mock_rpc
...
def test_list_interconnect_attachments_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_interconnect_attachments in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_interconnect_attachments] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_interconnect_attachments_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_interconnect_attachments in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_interconnect_attachments] = mock_rpc
...
def test_list_interconnect_attachments_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_interconnect_attachments(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.InterconnectAttachment)
                   for i in results)
...
def test_get_interconnect_attachment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_interconnect_attachment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_interconnect_attachment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_interconnect_attachment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_interconnect_attachment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_interconnect_attachment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_interconnect_attachment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_interconnect_attachment] = mock_rpc
...
def test_create_interconnect_attachment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_interconnect_attachment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_interconnect_attachment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_interconnect_attachment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_interconnect_attachment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_interconnect_attachment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_interconnect_attachment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_interconnect_attachment] = mock_rpc
...
def test_delete_interconnect_attachment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_interconnect_attachment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_interconnect_attachment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_interconnect_attachment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_interconnect_attachment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_interconnect_attachment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_interconnect_attachment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_interconnect_attachment] = mock_rpc
...
def test_list_routers(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_routers),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_routers_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_routers in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_routers] = mock_rpc
...
def test_list_routers_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Router)
                   for i in results)
...
def test_get_router(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_router),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_get_router_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_router in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_router] = mock_rpc
...
def test_diagnose_router(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.diagnose_router),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_diagnose_router_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.diagnose_router in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.diagnose_router] = mock_rpc
...
def test_create_router(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_router),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_router_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_router in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_router] = mock_rpc
...
def test_update_router(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_router),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_router_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_router in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_router] = mock_rpc
...
def test_delete_router(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_router),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_router_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeNetworkAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_router in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_router] = mock_rpc
...
def test_initialize_zone_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.InitializeZoneResponse()
        client.initialize_zone(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_diagnose_network_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.DiagnoseNetworkResponse()
        client.diagnose_network(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_network_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_network(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_network_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_network(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_subnet_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_subnet(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_subnet_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_subnet(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_interconnects_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.ListInterconnectsResponse()
        client.list_interconnects(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_interconnect_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = resources.Interconnect()
        client.get_interconnect(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_diagnose_interconnect_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.DiagnoseInterconnectResponse()
        client.diagnose_interconnect(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_interconnect_attachments_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.ListInterconnectAttachmentsResponse()
        client.list_interconnect_attachments(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_interconnect_attachment_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = resources.InterconnectAttachment()
        client.get_interconnect_attachment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_interconnect_attachment_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_interconnect_attachment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_interconnect_attachment_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_interconnect_attachment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_routers_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.ListRoutersResponse()
        client.list_routers(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_router_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = resources.Router()
        client.get_router(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_diagnose_router_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = service.DiagnoseRouterResponse()
        client.diagnose_router(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_router_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_router(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_router_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_router(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_router_empty_call_grpc():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_router(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = EdgeNetworkAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_initialize_zone_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.initialize_zone(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_diagnose_network_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.diagnose_network(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_network_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_network(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_network_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_network(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_subnet_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_subnet(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_subnet_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_subnet(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_interconnects_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_interconnects(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_interconnect_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_diagnose_interconnect_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.diagnose_interconnect(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_interconnect_attachments_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_interconnect_attachments(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_interconnect_attachment_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_interconnect_attachment_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_interconnect_attachment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_interconnect_attachment_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_interconnect_attachment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_routers_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_routers(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_router_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_router(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_diagnose_router_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.diagnose_router(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_router_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_router(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_router_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_router(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_router_empty_call_grpc_asyncio():
    client = EdgeNetworkAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_router(request=None)
...
def test_transport_kind_rest():
    transport = EdgeNetworkClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_initialize_zone_rest_bad_request(request_type=service.InitializeZoneRequest):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_initialize_zone_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_initialize_zone_rest_interceptors(null_interceptor):
    transport = transports.EdgeNetworkRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.EdgeNetworkRestInterceptor(),
        )
    client = EdgeNetworkClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_initialize_zone") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_initialize_zone_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_initialize_zone") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.InitializeZoneResponse.to_json(service.InitializeZoneResponse())
...
def test_list_zones_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_zones") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_zones_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_list_zones") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_zone_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_zone") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_zone_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_get_zone") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_networks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_networks") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_networks_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_list_networks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListNetworksResponse.to_json(service.ListNetworksResponse())
        req.return_value.content = return_value
...
def test_get_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_network") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_network_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_get_network") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_diagnose_network_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_diagnose_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_diagnose_network") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_diagnose_network_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_diagnose_network") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.DiagnoseNetworkResponse.to_json(service.DiagnoseNetworkResponse())
        req.return_value.content = return_value
...
def test_create_network_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_create_network") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_create_network_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_create_network") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_network_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_delete_network") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_delete_network_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_delete_network") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_subnets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_subnets") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_subnets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_list_subnets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListSubnetsResponse.to_json(service.ListSubnetsResponse())
        req.return_value.content = return_value
...
def test_get_subnet_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_subnet") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_subnet_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_get_subnet") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_subnet_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/zones/sample3'}
    request_init["subnet"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'description': 'description_value', 'network': 'network_value', 'ipv4_cidr': ['ipv4_cidr_value1', 'ipv4_cidr_value2'], 'ipv6_cidr': ['ipv6_cidr_value1', 'ipv6_cidr_value2'], 'vlan_id': 733, 'bonding_type': 1, 'state': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_subnet_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_create_subnet") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_create_subnet_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_create_subnet") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_subnet_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_update_subnet") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_update_subnet_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_update_subnet") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_subnet_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_subnet_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_delete_subnet") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_delete_subnet_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_delete_subnet") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_interconnects_rest_bad_request(request_type=service.ListInterconnectsRequest):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_interconnects_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_interconnects_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_interconnects") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_interconnects_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_list_interconnects") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListInterconnectsResponse.to_json(service.ListInterconnectsResponse())
        req.return_value.content = return_value
...
def test_get_interconnect_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_interconnect_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_interconnect") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_interconnect_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_get_interconnect") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_diagnose_interconnect_rest_bad_request(request_type=service.DiagnoseInterconnectRequest):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_diagnose_interconnect_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_diagnose_interconnect_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_diagnose_interconnect") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_diagnose_interconnect_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_diagnose_interconnect") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.DiagnoseInterconnectResponse.to_json(service.DiagnoseInterconnectResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.DiagnoseInterconnectResponse(), metadata
...
def test_list_interconnect_attachments_rest_bad_request(request_type=service.ListInterconnectAttachmentsRequest):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_interconnect_attachments_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_interconnect_attachments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_interconnect_attachments") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_interconnect_attachments_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_list_interconnect_attachments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListInterconnectAttachmentsResponse.to_json(service.ListInterconnectAttachmentsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.ListInterconnectAttachmentsResponse(), metadata
...
def test_get_interconnect_attachment_rest_bad_request(request_type=service.GetInterconnectAttachmentRequest):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_interconnect_attachment_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_interconnect_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_interconnect_attachment") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_interconnect_attachment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_get_interconnect_attachment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = resources.InterconnectAttachment.to_json(resources.InterconnectAttachment())
        req.return_value.content = return_value
...
def test_create_interconnect_attachment_rest_bad_request(request_type=service.CreateInterconnectAttachmentRequest):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_interconnect_attachment_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["interconnect_attachment"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_create_interconnect_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_create_interconnect_attachment") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_create_interconnect_attachment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_create_interconnect_attachment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_interconnect_attachment_rest_bad_request(request_type=service.DeleteInterconnectAttachmentRequest):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_interconnect_attachment_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_interconnect_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_delete_interconnect_attachment") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_delete_interconnect_attachment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_delete_interconnect_attachment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_routers_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_routers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_routers") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_routers_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_list_routers") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListRoutersResponse.to_json(service.ListRoutersResponse())
        req.return_value.content = return_value
...
def test_get_router_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_router_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_router") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_router_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_get_router") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_diagnose_router_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_diagnose_router_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_diagnose_router") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_diagnose_router_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_diagnose_router") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.DiagnoseRouterResponse.to_json(service.DiagnoseRouterResponse())
        req.return_value.content = return_value
...
def test_create_router_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_router_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_create_router") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_create_router_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_create_router") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_router_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_router_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_update_router") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_update_router_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_update_router") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_router_rest_call_success(request_type):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_router_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_delete_router") as post, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_delete_router_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EdgeNetworkRestInterceptor, "pre_delete_router") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_initialize_zone_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_diagnose_network_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_network_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_network_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_subnet_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_subnet_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_interconnects_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_interconnect_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_diagnose_interconnect_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_interconnect_attachments_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_interconnect_attachment_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_interconnect_attachment_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_interconnect_attachment_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_routers_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_router_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_router_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_router_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_router_empty_call_rest():
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_edge_network_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_edge_network_host_no_port(transport_name):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='edgenetwork.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'edgenetwork.googleapis.com:443'
...
def test_edge_network_host_with_port(transport_name):
    client = EdgeNetworkClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='edgenetwork.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
@pytest.mark.parametrize("transport_class", [transports.EdgeNetworkGrpcTransport, transports.EdgeNetworkGrpcAsyncIOTransport])
def test_edge_network_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.EdgeNetworkGrpcTransport, transports.EdgeNetworkGrpcAsyncIOTransport])
def test_edge_network_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

...
def test_initialize_zone_rest_required_fields(request_type=service.InitializeZoneRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).initialize_zone._get_unset_required_fields(jsonified_request)
...
def test_initialize_zone_rest_unset_required_fields():
    transport = transports.EdgeNetworkRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_zones_rest_required_fields(request_type=service.ListZonesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_zones._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_zone_rest_required_fields(request_type=service.GetZoneRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_zone._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_networks_rest_required_fields(request_type=service.ListNetworksRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_networks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_network_rest_required_fields(request_type=service.GetNetworkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_network._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_diagnose_network_rest_required_fields(request_type=service.DiagnoseNetworkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).diagnose_network._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_network_rest_required_fields(request_type=service.CreateNetworkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_network._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_network_rest_required_fields(request_type=service.DeleteNetworkRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_network._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_subnets_rest_required_fields(request_type=service.ListSubnetsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_subnets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_subnet_rest_required_fields(request_type=service.GetSubnetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_subnet._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_subnet_rest_required_fields(request_type=service.CreateSubnetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_subnet._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_subnet_rest_required_fields(request_type=service.UpdateSubnetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_subnet._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_subnet_rest_required_fields(request_type=service.DeleteSubnetRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_subnet._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_interconnects_rest_required_fields(request_type=service.ListInterconnectsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_interconnects._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_interconnect_rest_required_fields(request_type=service.GetInterconnectRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_interconnect._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_diagnose_interconnect_rest_required_fields(request_type=service.DiagnoseInterconnectRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).diagnose_interconnect._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_interconnect_attachments_rest_required_fields(request_type=service.ListInterconnectAttachmentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_interconnect_attachments._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_interconnect_attachment_rest_required_fields(request_type=service.GetInterconnectAttachmentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_interconnect_attachment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_interconnect_attachment_rest_required_fields(request_type=service.CreateInterconnectAttachmentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_interconnect_attachment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_interconnect_attachment_rest_required_fields(request_type=service.DeleteInterconnectAttachmentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_interconnect_attachment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_routers_rest_required_fields(request_type=service.ListRoutersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_routers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_router_rest_required_fields(request_type=service.GetRouterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_router._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_diagnose_router_rest_required_fields(request_type=service.DiagnoseRouterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).diagnose_router._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_router_rest_required_fields(request_type=service.CreateRouterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_router._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_router_rest_required_fields(request_type=service.UpdateRouterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_router._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_router_rest_required_fields(request_type=service.DeleteRouterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_router._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

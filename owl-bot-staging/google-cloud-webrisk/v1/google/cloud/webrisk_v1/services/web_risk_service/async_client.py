...
class WebRiskServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = WebRiskServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = WebRiskServiceClient._DEFAULT_UNIVERSE
    ...
    get_transport_class = WebRiskServiceClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, WebRiskServiceTransport, Callable[..., WebRiskServiceTransport]]] = "grpc_asyncio",
        ...
        Args:
            ...
            transport (Optional[Union[str,WebRiskServiceTransport,Callable[..., WebRiskServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the WebRiskServiceTransport constructor.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.webrisk_v1.WebRiskServiceAsyncClient`.",
                extra = {
    ...
    async def compute_threat_list_diff(self,
        ...
        flattened_params = [threat_type, version_token, constraints]
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.compute_threat_list_diff]
    ...
    async def search_uris(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [uri, threat_types]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_uris]
    ...
    async def search_hashes(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [hash_prefix, threat_types]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_hashes]
    ...
    async def create_submission(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_submission]
    ...
    async def submit_uri(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.submit_uri]
